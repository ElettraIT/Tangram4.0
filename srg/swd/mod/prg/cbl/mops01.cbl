      ...
      *                                                                *
      * Interfaccia per : Unix System V, incluso Xenix e Linux         *
      *                                                                *
      * ============================================================== *
      *                                                                *
      ...
      *            *---------------------------------------------------*
               10  z-var-env-tty          pic  x(23) value spaces     .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Variabile V_DKB_GETP, componente PFIX relativa al *
      *            * prefisso unico per files temporanei               *
      *            *---------------------------------------------------*
               10  z-var-env-pfi          pic  x(20) value spaces     .
      *            *---------------------------------------------------*
      *            * Variabile V_DKB_GETP, componente HOID relativa    *
      *            * all' Host-Id                                      *
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  z-var-env-pst          pic  x(512) value spaces    .
      *            *---------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Separazione pathname in basename e filename *
      *                  *---------------------------------------------*
           else if   o-ope                =    "BN"
      ...
      *              * riabile di ambiente V_DKB_GETP.                 *
