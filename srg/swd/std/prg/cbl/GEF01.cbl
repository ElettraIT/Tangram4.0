      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione archivio _________________________ *
      *                                                                *
      *================================================================*
      ...
      *              * ______________                                  *
      *              *-------------------------------------------------*
           perform   vis-___-___-000      thru vis-___-___-999        .
      *              *-------------------------------------------------*
      *              * ______________                                  *
      *              *-------------------------------------------------*
           perform   vis-___-___-000      thru vis-___-___-999        .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per _____________                 *
      *    *-----------------------------------------------------------*
       pmt-___-___-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : ______________                *
      *    *-----------------------------------------------------------*
       acc-___-___-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      ______               to   v-edm                  .
           move      __                   to   v-lin                  .
           move      __                   to   v-pos                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      w-tes-___-___        to   v-___                  .
      ...
      *              *-------------------------------------------------*
           move      v-___                to   w-tes-___-___          .
       acc-___-___-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*

_____________________________ solo per codici alfanumerici _______________

      *                  *---------------------------------------------*
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-___-___ (1)    to   w-all-str-alf          .
...
__________________________________________________________________________
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : ______________             *
      *    *-----------------------------------------------------------*
       vis-___-___-000.
           move      "DS"                 to   v-ope                  .
           move      "_"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : ______________                   *
      *    *-----------------------------------------------------------*
       pmt-___-___-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      __                   to   v-lin                  .
           move      __                   to   v-pos                  .
           move      "_________________"  to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-___-___-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : ______________               *
      *    *-----------------------------------------------------------*
       acc-___-___-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : ______________            *
      *    *-----------------------------------------------------------*
       vis-___-___-000.
           move      "DS"                 to   v-ope                  .
           move      "_"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       cnt-tdo-nok-120.
      *                  *---------------------------------------------*
      *                  * Controllo su ___________                    *
      *                  *---------------------------------------------*
           if        w-tes-___-___ (1)    not  = ______
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      ______               to   w-tes-___-___ (1)      .
           move      ______               to   w-tes-___-___ (1)      .
           move      ______               to   w-tes-___-___ (1)      .
           move      ______               to   w-tes-___-___ (1)      .
       nor-nok-tes-999.
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "__________"         to   f-key                  .
           move      w-tes-___-___        to   rf-___-___-___         .
           move      "pgm/___/fls/ioc/obj/iof___"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [___]                        *
      *                          *-------------------------------------*
           move      rf-___-___-___       to   w-tes-___-___ (1)      .
           move      rf-___-___-___       to   w-tes-___-___ (1)      .
           move      rf-___-___-___       to   w-tes-___-___ (1)      .
           move      rf-___-___-___       to   w-tes-___-___ (1)      .
           move      rf-___-___-___       to   w-tes-___-___ (1)      .
      ...
      *                      * Write record [___]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-___-000      thru wrt-rec-___-999        .
      ...
      *                      * Rewrite record [___]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-___-000      thru rew-rec-___-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [___]                             *
      *              *-------------------------------------------------*
           perform   del-rec-___-000      thru del-rec-___-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [___]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-___-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-___-___ (1)    to   rf-___-___-___         .
           move      w-tes-___-___ (1)    to   rf-___-___-___         .
       cmp-rec-___-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [___]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-___-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-___-000      thru cmp-rec-___-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           move      "P?"                 to   s-ope                  .
           move      "________"           to   s-pro                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     move  "#"            to   w-fnd-arc-___-sel
                     go to  fnd-arc-___-999.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
           move      "select ___"         to   s-var                  .
           move      "+"                  to   s-dop                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  spaces         to   w-fnd-arc-___-sel
                     move  s-___          to   w-fnd-arc-___-___
           else      move  "#"            to   w-fnd-arc-___-sel      .
       fnd-arc-___-999.
           exit.

      *    *===========================================================*
      *    * Insr su archivio [___]                                    *
      *    *-----------------------------------------------------------*
       ins-arc-___-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "P?"                 to   s-ope                  .
           move      "p_______"           to   s-pro                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     go to  ins-arc-___-999.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [___]                         *
      *    *-----------------------------------------------------------*
       let-arc-___-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione marker di uscita                *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-___-flg      .
      *              *-------------------------------------------------*
      *              * Test se codice ___________ a _____              *
      *              *-------------------------------------------------*
           if        w-let-arc-___-cod    =    ____
                     go to let-arc-___-500.
      *              *-------------------------------------------------*
      *              * Lettura per codice                              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "______"             to   f-key                  .
           move      w-let-arc-___-cod    to   rf-___-___-___         .
           move      "pgm/___/fls/ioc/obj/iof___"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           ...
           if        f-sts                not  = e-not-err
                     go to let-arc-___-400.
       let-arc-___-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-___-___-___       to   w-let-arc-___-___      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     let-arc-___-999.
       let-arc-___-400.
      *              *-------------------------------------------------*
      *              * Azioni per record non trovato                   *
      *              *-------------------------------------------------*
           move      "#"                  to   w-let-arc-___-flg      .
           move      all   "."            to   w-let-arc-___-___      .
           go to     let-arc-___-999.
       let-arc-___-500.
      *              *-------------------------------------------------*
      *              * Normalizzazione work area                       *
      *              *-------------------------------------------------*
           move      ____                 to   w-let-arc-___-___      .
       let-arc-___-999.
           exit.
