      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione ____________________________ *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
               10  w-ipc-dlp-___.
      *                *-----------------------------------------------*
      *                * ________________ passato                      *
      *                *-----------------------------------------------*
                   15  w-ipc-dlp-___-___  pic  _(__)                  .
      ...
      *    *-----------------------------------------------------------*
       pre-exe-pgm-000.
      *              *-------------------------------------------------*
      *              * Lettura i.p.c. da livello precedente per ______ *
      *              *-------------------------------------------------*
           perform   ipc-dlp-___-000      thru ipc-dlp-___-999        .
      ...
      *              *-------------------------------------------------*
           move      "_"                  to   w-cnt-fun-snx-cic      .
      *              *-------------------------------------------------*
      *              * Si/No funzionamento automatico                  *
      *              *-------------------------------------------------*
           move      "_"                  to   w-cnt-fun-snx-aut      .
       pre-tip-fun-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           ____      _se e' necessario un sort sopprimere la parte pre-
           ____      _cedente e mantenere quella seguente

           ____      _se il sort non e' necessario sopprimere tutte le
           ____      _istruzioni seguenti
      ...
      *    *-----------------------------------------------------------*
       int-srt-inp-000.
                     ____________ in caso di sort _____________
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun_ __________ entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           return    srt    at end
                     ...
                     ____________ in caso di non-sort _____________
      *              *-------------------------------------------------*
...
___________________________ solo se da fare qui _______________________
      *              *-------------------------------------------------*
      *              * Intestazione pagina                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-___-___-___       to   v-___                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .

_________________ campo con eventuale mark-point _______________________
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-___-___-___       to   v-___                  .
           move      "+"                  to   v-edm                  .
           move      rf-___-___-___       to   w-mpn-___-___          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: '___-___'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
           ...
           move      __                   to   s-car                  .
           move      ____                 to   s-dec                  .
           move      ______               to   s-sgn                  .
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-___-___        to   s-___                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Fincatura   (________eventuale_________)        *
      *              *-------------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      __                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Sottolineatura    (________eventuale_________)  *
      *              *-------------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      __                   to   v-car                  .
      ...
      *    *===========================================================*
      *    * Lettura i.p.c. da livello precedente per ________________ *
      *    *-----------------------------------------------------------*
       ipc-dlp-___-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione iniziale                        *
      *              *-------------------------------------------------*
           move      spaces               to   w-ipc-dlp-___-___      .
      *              *-------------------------------------------------*
      *              * Estrazione della eventuale variabile di i.p.c.  *
      *              * "___-___" per ________________ passato          *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
           move      "___-___"            to   s-var                  .
           move      "-"                  to   s-dop                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                not  = spaces
                     go to ipc-dlp-___-999.
           move      s-___                to   w-ipc-dlp-___-___      .
       ipc-dlp-___-999.
           exit.
