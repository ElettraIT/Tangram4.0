      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa da conversione files                 *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Pathname del file sequenziale da conversione          *
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Work area per la ridefinizione del record da conversione  *
      *    *-----------------------------------------------------------*
       01  w-out.
      *        *-------------------------------------------------------*
...
______*__________________Routines variabili_____________________________
      ...
      *                  *---------------------------------------------*
      *                  * Pathname file in input da conversione       *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Pathname file in input     *
      *    *-----------------------------------------------------------*
       acc-pth-inp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
       ...
       prn-let-seq-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale file in input da conversio- *
      *              * ne                                              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Get Next                                    *
