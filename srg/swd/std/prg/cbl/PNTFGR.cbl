      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa RIPETITIVA_______________            *
      *                                                                *
      *================================================================*
...
_________se intestazione ad inizio ciclo conservare istruzione seguente
      *              *-------------------------------------------------*
      *              * Intestazione foglio                             *
      *              *-------------------------------------------------*
...
_________se totali finali da stampare conservare istruzioni seguenti
_________o simili : questo e' solo un esempio
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      094                  to   p-pos                  .
           move      "G"                  to   p-edm                  .
           move      w-tot-gen-tot-imp    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
...
_________le istruzioni seguenti sono solo un esempio
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      __                   to   p-car                  .
           move      ____                 to   p-dec                  .
           move      ______               to   p-sgn                  .
           move      ______               to   p-edm                  .
           move      p-lnr                to   p-lin                  .
           move      ___                  to   p-pos                  .
           move      ______________       to   p-___                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * ___________                             *
...
_______    EVENTUALE FINCATURA PF PF PF PF
_______                        LF PF PF PF
_______                        LF PF PF PF

_______l'istruzione seguente provoca una interlinea di separazione tra
_______la fincatura ed il resto dello stampato
      *              *-------------------------------------------------*
      *              * Interlinea                                      *
      *              *-------------------------------------------------*
           move      "VP"                 to   p-ope                  .
