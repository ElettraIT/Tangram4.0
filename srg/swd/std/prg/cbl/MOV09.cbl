      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   ___________________________________________ *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-lin-num-lin-vis          pic  9(02)       value __   .
      *        *-------------------------------------------------------*
      *        * Numero linee di display impegnate per ogni riga corpo *
      *        * nell'area di scroll                                   *
      *        *-------------------------------------------------------*
           05  w-lin-num-lin-prc          pic  9(02)       value __   .
      *        *-------------------------------------------------------*
      *        * Prima linea di display utilizzata per le righe corpo  *
      *        * nell'area di scroll                                   *
      *        *-------------------------------------------------------*
           05  w-lin-pri-lin-vid          pic  9(02)       value __   .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-lin-imm-dsp.
                   15  w-lin-imm-dsp-lin occurs __ _di solito occurs 01_
                                          pic  x(80)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : _________________                          *
      *        *-------------------------------------------------------*
           05  w-exp-___-___.
               10  w-exp-___-___-num      pic  9(02)       value __   .
               10  w-exp-___-___-lun      pic  9(02)       value __   .
               10  w-exp-___-___-tbl.
                   15  filler             pic  x(__) value
                            "__________"                              .
                   15  filler             pic  x(__) value
                            "__________"                              .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per Det __________________________________       *
      *        *-------------------------------------------------------*
           05  w-det-___.
               10  w-det-___-___-___      pic  x(01)                  .
               10  w-det-___-___-___      pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-ctl.
      *        *-------------------------------------------------------*
      *        * Work per Ctl __________________________________       *
      *        *-------------------------------------------------------*
           05  w-ctl-___.
               10  w-ctl-___-___-___      pic  x(01)                  .
               10  w-ctl-___-___-___      pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-agg.
      *        *-------------------------------------------------------*
      *        * Work per Agg __________________________________       *
      *        *-------------------------------------------------------*
           05  w-agg-___.
               10  w-agg-___-___-___      pic  x(01)                  .
               10  w-agg-___-___-___      pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-cix.
      *        *-------------------------------------------------------*
      *        * Contatore __________________                          *
      *        *-------------------------------------------------------*
           05  w-cix-ctr-___              pic  9(__)                  .
      *        *-------------------------------------------------------*
      *        * Indice __________________                             *
      *        *-------------------------------------------------------*
           05  w-cix-inx-___              pic  9(__)                  .
      ...
      *                  *---------------------------------------------*
       ...
       exe-acc-cmp-850.
      *              *-------------------------------------------------*
      *              * Set del flag di tasto Prnt ___ se previsto___   *
      *              *-------------------------------------------------*
           if        v-key                not  = "PRNT"
                     go to exe-acc-cmp-900.
      ...
      *              *-------------------------------------------------*
      *              * Altre operazioni pre-esecuzione                 *
      *              *-------------------------------------------------*
           __________
       pre-exe-pgm-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       cnc-sub-cat-000.
           cancel    "___/___/prg/obj/p___nnn2"                       .
       cnc-sub-cat-999.
           exit.
      ...
      *                  *---------------------------------------------*
      *                  * Accettazione _____________________________  *
      *                  *---------------------------------------------*
           perform   acc-___-___-000      thru acc-___-___-999        .
      ...
      *                      *-----------------------------------------*
      *                      * Editing ______________________________  *
      *                      *-----------------------------------------*
           move      w-rig-___-___ (1)    to   w-lin-imm-___-___      .
      *                      *-----------------------------------------*
      *                      * Editing ______________________________  *
      *                      *-----------------------------------------*
           move      w-rig-___-___ (1)    to   w-lin-imm-___-___      .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      *              * Fincatura ____________________________________  *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      __                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
      *              * Campo di accettazione corpo : _________________ *
      *              *-------------------------------------------------*
           perform   vis-___-___-000      thru vis-___-___-999        .
      *              *-------------------------------------------------*
      *              * Campo di accettazione corpo : _________________ *
      ...
      *    *===========================================================*
      *    * Accettazione del primo campo riga corpo espansa : _____   *
      *    *-----------------------------------------------------------*
       acc-___-___-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      w-rig-___-___ (1)    to   w-sav-___-___          .
       acc-___-___-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-sav-___-___        to   w-rig-___-___ (1)      .
      *                  *---------------------------------------------*
      *                  * Parametri generici                          *
      *                  *---------------------------------------------*
           move      "AC"                 to   v-ope                  .
      ...
      *                      * il primo campo ammette il Find _______  *
      *                      *-----------------------------------------*
           if        w-cat-rig-new        not  = spaces
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces
                     go to acc-___-___-400.
      *              *-------------------------------------------------*
      *              * Se Find                                         *
      *              *-------------------------------------------------*
           if        v-key                not  = "FIND"
                     go to acc-___-___-250.
      *                  *---------------------------------------------*
      *                  * Find su _____________                       *
      *                  *---------------------------------------------*
           perform   fnd-___-___-000      thru fnd-___-___-999        .
           if        w-fnd-___-___-sel    not  = spaces
                     go to acc-___-___-100.
           move      w-fnd-___-___-___    to   w-rig-___-___ (1)      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione codice _____________        *
      *                  *---------------------------------------------*
           perform   vis-___-___-000      thru vis-___-___-999        .
           move      spaces               to   v-key                  .
           go to     acc-___-___-425.
       acc-___-___-250.
      *              *-------------------------------------------------*
      *              * Se Slct                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "SLCT"
                     go to acc-___-___-300
           else      go to acc-___-___-350.
       acc-___-___-300.
      *                  *---------------------------------------------*
      *                  * Conversione numero riga impostato in forma- *
      *                  * to numerico ___solo se necessario______     *
      *                  *---------------------------------------------*
       ...
       acc-___-___-310.
           ...
           if        w-cnt-wrk-ctr-001   =    zero
                     go to acc-___-___-320.
           if        w-cnt-slc-rap-chr
                    (w-cnt-wrk-ctr-001)   <    "0"   or
                     w-cnt-slc-rap-chr
                    (w-cnt-wrk-ctr-001)   >    "9"
                     go to acc-___-___-310.
      ...
      *                  *---------------------------------------------*
           move      v-___                to   w-rig-___-___ (1)      .
       acc-___-___-425.
      *                  *---------------------------------------------*
      *                  * Lettura ___________________                 *
      *                  *---------------------------------------------*
           move      w-rig-___-___ (1)    to   w-let-___-___-___      .
           perform   let-___-___-000      thru let-___-___-999        .
           move      w-let-___-___-___    to   w-rig-___-___ (1)      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione _____________   *
      *                  *---------------------------------------------*
           perform   vis-___-___-000      thru vis-___-___-999        .
      *                  *---------------------------------------------*
      *                  * Se _____________ non esistente : messaggio  *
      *                  * d'errore e reimpostazione                   *
      *                  *---------------------------------------------*
           if        w-let-___-___-flg    =    spaces
                     go to acc-___-___-450.
           move      "ME"                 to   v-ope                  .
           move      spaces               to   v-not                  .
           string    "Non esiste un _________ con codice '"
                                delimited by   size
                     w-rig-___-___ (1)
                                delimited by   size
                     "' !"      delimited by   size
      ...
      *                  *---------------------------------------------*
           if        w-rig-___-___ (1)    =    spaces/zero ___
                     if    w-cat-rig-new  not  = spaces and
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : ______________________________    *
      *    *-----------------------------------------------------------*
       vis-___-___-000.
           move      "DS"                 to   v-ope                  .
           move      "_"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione ennesimo campo riga corpo espansa : _____    *
      *    *-----------------------------------------------------------*
       acc-___-___-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
      *              * Test su ____________________________            *
      *              *-------------------------------------------------*
       cnt-tdo-key-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *              * Test che ________________________________       *
      *              *-------------------------------------------------*
       cnt-tdo-nok-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       prg-rig-cor-000.
           move      w-cat-rig-prg        to   w-rig-___-___ (1)      .

           __________________presumibilmente : w-rig-num-prg (1)      .
       prg-rig-cor-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      zero                 to   w-tes-___-___ (1)      .
           move      spaces               to   w-tes-___-___ (1)      .
       nor-nok-tes-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           move      zero                 to   w-rig-___-___ (1)      .
           move      spaces               to   w-rig-___-___ (1)      .
       nor-nok-rig-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *              * Se numero protocollo zero : inserimento         *
      *              *-------------------------------------------------*
           if        w-tes-___-___        =    zero
      ...
      *              *-------------------------------------------------*
           ...
           move      w-___-___-___        to   rf-___-___-___         .
           move      "pgm/___/fls/ioc/obj/iof___"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      "ME"                 to   v-ope                  .
           move      "Registrazione non esistente !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-___-___-___       to   w-tes-___-___          .
           move      rf-___-___-___       to   w-tes-___-___          .
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Anagrafica ___________          *
      *                              *---------------------------------*
           move      w-tes-___-___ (1)    to   w-let-___-___-___      .
           perform   let-___-___-000      thru let-___-___-999        .
           move      w-let-___-___-___    to   w-tes-___-___ (1)      .
      *                      *-----------------------------------------*
      *                      * Completamento visualizzazione chiave    *
      *                      *-----------------------------------------*
           perform   vis-___-___-000      thru vis-___-___-999        .
           perform   vis-___-___-000      thru vis-___-___-999        .
       rou-let-reg-400.
      ...
      *                  *---------------------------------------------*
           if        rf-___-___-___       not  = w-tes-___-___ or
                     rf-___-___-___       not  = w-tes-___-___
                     go to  rou-let-reg-999.
      *                  *---------------------------------------------*
      ...
      *                          * record [___]                        *
      *                          *-------------------------------------*
           move      rf-___-___-___       to   w-rig-___-___ (1)      .
           move      rf-___-___-___       to   w-rig-___-___ (1)      .
      *                          *-------------------------------------*
      *                          * Valori contenuti indirettamente in  *
      *                          * record [___]                        *
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-___-num-prg       to   w-cat-rig-prg          .
           move      w-rig                to   w-cat-rig-buf          .
           perform   cll-sub-cat-000      thru cll-sub-cat-999        .
      *                  *---------------------------------------------*
      *                  * Riciclo a lettura [___] successivo          *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-pre-acc-ins      .
      *              *-------------------------------------------------*
      *              * Attribuzione numero protocollo  ______________  *
      *              *-------------------------------------------------*
           perform   att-prg-___-000      thru att-prg-___-999        .
           move      w-___-___-___        to   w-tes-___-___          .
      *              *-------------------------------------------------*
      *              * Visualizzazione numero protocollo ____________  *
      *              *-------------------------------------------------*
           perform   vis-___-___-000      thru vis-___-___-999        .
       pre-acc-ins-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       pos-exi-ins-000.
      *              *-------------------------------------------------*
      *              * Ripristino numero progressivo se possibile      *
      *              *-------------------------------------------------*
           perform   rip-prg-___-000      thru rip-prg-___-999        .
       pos-exi-ins-999.
           exit.
      ...
      *    *===========================================================*
      *    * Routine di lettura numero protocollo                      *
      *    *-----------------------------------------------------------*
       get-prg-___-000.
       get-prg-___-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-tes-___-___ (1)    not  = w-tes-___-___ (2) or
                     w-tes-___-___ (1)    not  = w-tes-___-___ (2)
                     move  "#"            to   w-cnt-var-tes-cor      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       del-mov-fil-500.
      *              *-------------------------------------------------*
      *              * Cancellazione testata file [___]                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Delete record [___]                         *
      *                  *---------------------------------------------*
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      w-rig-___-___ (1)    to   rf-___-___-___         .
           move      w-rig-___-___ (1)    to   rf-___-___-___         .
       cmp-rec-___-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record righe [___]                              *
      *    *-----------------------------------------------------------*
       wrt-rec-___-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      ...
      *              *-------------------------------------------------*
      *              * Aggiornamento [___] corrispondente              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * In piu'                                     *
      *                  *---------------------------------------------*
           ______    preparazione area aggiornamenti in PIU' ______
           ______    richiamo routine aggiornamenti _______________
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *                  * In meno                                     *
      *                  *---------------------------------------------*
           ______    preparazione area aggiornamenti in MENO ______
           ______    richiamo routine aggiornamenti _______________
      *                  *---------------------------------------------*
      *                  * In piu'                                     *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Cancellazione record righe [___]                          *
      *    *-----------------------------------------------------------*
       del-rec-___-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      ...
      *              *-------------------------------------------------*
           move      w-rig-___-___        to   rf-___-___-___         .
           move      w-rig-___-___        to   rf-___-___-___         .
           move      w-rig-___-___        to   rf-___-___-___         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      ...
      *    *===========================================================*
      *    * Composizione record testata [___]                         *
      *    *-----------------------------------------------------------*
       cmp-rec-___-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione record                          *
      ...
      *    *===========================================================*
      *    * Riscrittura record testata [___]                          *
      *    *-----------------------------------------------------------*
       rew-rec-___-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      ...
      *    *===========================================================*
      *    * Cancellazione record testata [___]                        *
      *    *-----------------------------------------------------------*
       del-rec-___-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
