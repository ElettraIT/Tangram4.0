      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su moduli montati            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   INTERROGAZIONE SU MODULI MONTATI    "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Salvataggi relativi a [pss]                           *
      *        *-------------------------------------------------------*
           05  w-sav-pss.
               10  w-sav-pss-tre          pic  x(04)                  .
               10  w-sav-pss-kre          pic  x(40)                  .
      ...
      *                  * in memoria, con descrizione stampante       *
      *                  *---------------------------------------------*
           add       1                    to   w-mem-num-ele          .
           move      w-stp-cod-stp        to   w-mem-cod-stp
                                              (w-mem-num-ele)         .
           move      w-stp-des-stp        to   w-mem-des-stp
                                              (w-mem-num-ele)         .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       qry-let-seq-200.
      *              *-------------------------------------------------*
      *              * Read su record modulo montato sulla stampante   *
      *              *-------------------------------------------------*
           move      "RD"                 to   j-ope                  .
           move      "MMO "               to   j-tre                  .
           move      w-mem-cod-stp
      ...
      *              *-------------------------------------------------*
       ...
       qry-let-seq-400.
      *              *-------------------------------------------------*
      *              * Record modulo montato in area di lavoro         *
      *              *-------------------------------------------------*
           move      j-dat                to   w-mmo                  .
       qry-let-seq-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mem-cod-stp
                    (w-mem-inx-ele)       to   w-mpn-cod-stp          .
           move      w-mpn                to   v-cnt                  .
           move      w-mem-cod-stp
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      51                   to   v-pos                  .
           if        w-mmo-cod-mod        =    spaces
                     move  "Nessuno "     to   v-alf
           else      move  w-mmo-cod-mod  to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-mmo-cod-mod        =    spaces
                     move  zero           to   v-num
           else      move  w-mmo-amc-prf  to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-mmo-cod-mod        =    spaces
                     move  zero           to   v-num
           else      move  w-mmo-ali-prf  to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
           exit.
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'pss-mmo'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *                  *---------------------------------------------*
           call      "swd/xpg/prg/obj/pxpg4600"                       .
           cancel    "swd/xpg/prg/obj/pxpg4600"                       .
       qry-trt-fun-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "     MODULI MONTATI SULLE STAMPANTI     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "         Codice e descrizione stampante           
      -              " Modulo   Carattere Interlinea"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
