      ...
      *                       Versione attuale:    NdK del 15/07/22    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase xpg900, nella sua globalita', esegue i tipi di opera-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * STFARP      Stampa di un file, gia' in formato ASCII, richie-  *
      *             dendone il pathname completo                       *
      *                                                                *
      * VSFARP      Visualizzazione di un file, gia' in formato ASCII, *
      *             richiedendone il pathname completo                 *
      *                                                                *
      * STTSRP      Stampa di un tracciato stampa, richiedendone il    *
      *             pathname completo                                  *
      *                                                                *
      * STTFEL      Stampa di una fattura elettronica 'XML' ___INIBITO *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     MISCELLANEA DI UTILITIES VARIE     "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'xpg900'           *
      *              *-------------------------------------------------*
           perform   fas-xpg-900-000      thru fas-xpg-900-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              * stazione                                        *
      *              *-------------------------------------------------*
           move      "Stampa di un file ASCII                           
      -              " STFARP     pxpg900a  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Visualizzazione di un file ASCII                  
      -              " VSFARP     pxpg900b  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Stampa di un tracciato stampa                     
      -              " STTSRP     pxpg900c  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
______*    move      "Stampa di una fattura elettronica 'XML'           
______*              " STTFEL     pxpg900d  "
______*                                   to   w-top-ele-wci          .
______*    perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-xpg-900-300
           else if   v-key                =    "PRSC"
                     go to fas-xpg-900-400
           else if   v-key                =    "NXSC"
                     go to fas-xpg-900-450
           else if   v-key                =    "DOWN"
                     go to fas-xpg-900-500
           else if   v-key                =    "EXIT"
                     go to fas-xpg-900-250
           else      go to fas-xpg-900-200.
       fas-xpg-900-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-ope        =    zero
                     go to fas-xpg-900-330.
           move      zero                 to   w-top-ele-inx          .
       fas-xpg-900-322.
           add       1                    to   w-top-ele-inx          .
           if        w-top-ele-inx        >    w-top-ele-nes
                     go to fas-xpg-900-340.
           if        w-top-num-top
                    (w-top-ele-inx)       =    w-key-num-ope
                     go to fas-xpg-900-350
           else      go to fas-xpg-900-322.
       fas-xpg-900-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-xpg-900-630
           else if   v-key                =    "PRSC"
                     go to fas-xpg-900-600
           else if   v-key                =    "NXSC"
                     go to fas-xpg-900-610
           else if   v-key                =    "UP  "
                     go to fas-xpg-900-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-xpg-900-650
           else if   v-key                =    "EXIT"
                     go to fas-xpg-900-660
           else      go to fas-xpg-900-570.
       fas-xpg-900-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-xpg-900-626
           else      go to fas-xpg-900-628.
       fas-xpg-900-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-xpg-900-636
           else      go to fas-xpg-900-638.
       fas-xpg-900-636.
      *                          *-------------------------------------*
