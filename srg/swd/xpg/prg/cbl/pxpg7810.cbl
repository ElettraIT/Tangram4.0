      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su filtri conversione stan-  *
      *                    dard                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE SU FILTRI DI CONVERSIONE "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Codice filtro min, da i.p.c.                          *
      *        *-------------------------------------------------------*
           05  rr-cod-min                 pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Codice filtro max, da i.p.c.                          *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-ipc.
      *        *-------------------------------------------------------*
      *        * Variabile di i.p.c. 'cod-fcs' letta ad inizio pro-    *
      *        * gramma per determinare una eventuale limitazione ai   *
      *        * soli codici filtro con l'iniziale dichiarata          *
      *        *-------------------------------------------------------*
           05  w-ipc-cod-fcs              pic  x(40)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-pre-exe-pgm      .
      *              *-------------------------------------------------*
      *              * Lettura variabile di i.p.c. 'cod-fcs'           *
      *              *-------------------------------------------------*
      ...
      *              * Codice min                                      *
      *              *-------------------------------------------------*
           move      w-ipc-cod-fcs        to   rr-cod-min             .
      *              *-------------------------------------------------*
      *              * Codice max                                      *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun filtro di conversione memorizzato !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      01                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      w-fcs-cod-fcs        to   w-mpn-cod-fcs          .
           move      w-mpn                to   v-cnt                  .
           move      w-fcs-cod-fcs        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Descrizione filtro                          *
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'auc-fcs'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "     FILTRI DI CONVERSIONE STANDARD     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Lettura variabile di i.p.c. 'cod-fcs' per determinare i   *
      *    * caratteri iniziali del codice filtro                      *
      *    *-----------------------------------------------------------*
       ipc-dlp-cdf-000.
           move      "CV"                 to   s-ope                  .
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-ipc-cod-fcs
           else      move  spaces         to   w-ipc-cod-fcs          .
       ipc-dlp-cdf-999.
           exit.
