      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su impegno stampanti         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  INTERROGAZIONE SU IMPEGNO STAMPANTI  "       .
      ...
      *    *===========================================================*
      *    * Work-area per tabella stampanti in memoria                *
      *    *-----------------------------------------------------------*
       01  w-mem.
      *        *-------------------------------------------------------*
      *        * Numero massimo elementi in tabella                    *
      *        *-------------------------------------------------------*
           05  w-mem-max-ele              pic  9(04)       value 400  .
      *        *-------------------------------------------------------*
      *        * Numero elementi effettivamente in tabella             *
      *        *-------------------------------------------------------*
           05  w-mem-num-ele              pic  9(04)                  .
      *        *-------------------------------------------------------*
      *        * Indice di comodo                                      *
      *        *-------------------------------------------------------*
           05  w-mem-inx-ele              pic  9(04)                  .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-mem-ele-mem occurs 400.
      *                *-----------------------------------------------*
      *                * Codice stampante                              *
      *                *-----------------------------------------------*
                   15  w-mem-cod-stp      pic  x(08)                  .
      *                *-----------------------------------------------*
      *                * Canale di uscita associato                    *
      *                *-----------------------------------------------*
                   15  w-mem-can-stp      pic  x(40)                  .
      ...
      *    *-----------------------------------------------------------*
       reg-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Codice stampante min                            *
      *              *-------------------------------------------------*
           move      w-ipc-cod-stp        to   rr-cod-min             .
      *              *-------------------------------------------------*
      *              * Codice stampante max                            *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-200.
      *              *-------------------------------------------------*
      *              * Caricamento in memoria tabella codici stampanti *
      *              *-------------------------------------------------*
       qry-str-ini-300.
      *                  *---------------------------------------------*
      *                  * Numero elementi presenti : zero             *
      *                  *---------------------------------------------*
           move      zero                 to   w-mem-num-ele          .
       qry-str-ini-350.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mppssf"
                                        using  r
                                               j                      .
      *                  *---------------------------------------------*
      *                  * Test se start errata                        *
      *                  *---------------------------------------------*
           if        j-rsc                not  = spaces
                     go to qry-str-ini-600.
       qry-str-ini-400.
      *                  *---------------------------------------------*
      *                  * Read next su codici stampante               *
      *                  *---------------------------------------------*
           move      "RN"                 to   j-ope                  .
           move      "STP "               to   j-tre                  .
      ...
      *                  *---------------------------------------------*
           if        j-rsc                not  = spaces
                     go to qry-str-ini-600.
      *                  *---------------------------------------------*
      *                  * Record codice stampante in area di lavoro   *
      *                  *---------------------------------------------*
           move      j-dat                to   w-stp                  .
       qry-str-ini-425.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       qry-str-ini-450.
      *                  *---------------------------------------------*
      *                  * Se stampante locale : selezione non supera- *
      *                  * ta                                          *
      *                  *---------------------------------------------*
           if        w-stp-cod-stp
                    (01 : 01)             =    "#"
      ...
      *                  *---------------------------------------------*
      *                  * Se canale di stampa 'spool' : selezione non *
      *                  * superata                                    *
      *                  *---------------------------------------------*
           if        w-stp-can-stp
                    (01 : 05)             =    "spool"
                     go to qry-str-ini-400.
      *                  *---------------------------------------------*
      *                  * Se canale di stampa 'rcp' : selezione non   *
      *                  * superata                                    *
      *                  *---------------------------------------------*
           if        w-stp-can-stp
                    (01 : 03)             =    "rcp"
                     go to qry-str-ini-400.
      *                  *---------------------------------------------*
      *                  * Se canale di stampa 'ucp' : selezione non   *
      *                  * superata                                    *
      *                  *---------------------------------------------*
           if        w-stp-can-stp
                    (01 : 03)             =    "ucp"
       ...
       qry-str-ini-500.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione codice stampante in tabella *
      *                  * in memoria                                  *
      *                  *---------------------------------------------*
           add       1                    to   w-mem-num-ele          .
           move      w-stp-cod-stp        to   w-mem-cod-stp
                                              (w-mem-num-ele)         .
           move      w-stp-can-stp        to   w-mem-can-stp
                                              (w-mem-num-ele)         .
      *                  *---------------------------------------------*
      *                  * Test se saturata la tabella                 *
      *                  *---------------------------------------------*
           if        w-mem-num-ele        =    w-mem-max-ele
                     go to qry-str-ini-600.
       qry-str-ini-550.
      *                  *---------------------------------------------*
      *                  * Riciclo a next su codici stampante          *
      *                  *---------------------------------------------*
           go to     qry-str-ini-400.
       qry-str-ini-600.
      *                  *---------------------------------------------*
      *                  * Test se nessun codice stampante memorizzato *
      *                  *---------------------------------------------*
           if        w-mem-num-ele        =    zero
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Incremento indice su tabella in memoria         *
      *              *-------------------------------------------------*
           add       1                    to   w-mem-inx-ele          .
      *              *-------------------------------------------------*
      *              * Test se fine tabella in memoria                 *
      *              *-------------------------------------------------*
           if        w-mem-inx-ele        >    w-mem-num-ele
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-let-seq-999.
       qry-let-seq-200.
      *              *-------------------------------------------------*
      *              * Read su record impegno associato al codice del- *
      *              * la stampante                                    *
      *              *-------------------------------------------------*
           move      "RD"                 to   j-ope                  .
           move      "IMP "               to   j-tre                  .
           move      w-mem-can-stp
                    (w-mem-inx-ele)       to   j-kre                  .
           call      "swd/mod/prg/obj/mppssf"
                                        using  r
                                               j                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mem-can-stp
                    (w-mem-inx-ele)       to   w-mpn-can-stp          .
           move      w-mpn                to   v-cnt                  .
           move      w-mem-cod-stp
                    (w-mem-inx-ele)       to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Tipo impegno                                *
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Test se stampante non impegnata             *
      *                  *---------------------------------------------*
           if        w-imp-sts-imp        =    00
                     go to qry-liv-det-999.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'pss-imp'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *                  *---------------------------------------------*
           call      "swd/xpg/prg/obj/pxpg4500"                       .
           cancel    "swd/xpg/prg/obj/pxpg4500"                       .
       qry-trt-fun-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Stampante Tipo impegno   Az.  Termin.  Utente     
      -              "Applicazione      Data    Ora "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
