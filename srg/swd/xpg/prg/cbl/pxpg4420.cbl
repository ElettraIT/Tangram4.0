      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa Parametri di Stampa Precablati       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Codice fase gestionale                            *
      *            *---------------------------------------------------*
               10  srt-fas-ges            pic  x(06)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Area per ridefinizione parametri stampa           *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA PARAMETRI DI STAMPA PRECABLATI  "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Parametri stampa da stampare               *
      *        *-------------------------------------------------------*
           05  w-exp-tip-stp.
               ...
               10  w-exp-tip-stp-tbl.
                   15  filler             pic  x(40) value
                            "Tutti                                   ".
                   15  filler             pic  x(40) value
                            "Solo quelli per una fase gestionale     ".
      ...
      *    *-----------------------------------------------------------*
       01  w-pss.
      *        *-------------------------------------------------------*
      *        * Work per singolo file di configurazione tipo 'pms'    *
      *        *-------------------------------------------------------*
           05  w-pms.
      *            *---------------------------------------------------*
      *            * Fase gestionale                                   *
      *            *---------------------------------------------------*
               10  w-pms-fas-ges          pic  x(06)                  .
      *            *---------------------------------------------------*
      *            * Codice stampante                                  *
      *            *---------------------------------------------------*
               10  w-pms-cod-stp          pic  x(08)                  .
      *            *---------------------------------------------------*
      *            * Tipo output stampa                                *
      *            *---------------------------------------------------*
               10  w-pms-out-stp          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice modulo                                     *
      *            *---------------------------------------------------*
               10  w-pms-cod-mod          pic  x(08)                  .
      *            *---------------------------------------------------*
      *            * Ampiezza caratteri                                *
      *            *---------------------------------------------------*
               10  w-pms-amp-car          pic  9(02)v9(02)            .
      *            *---------------------------------------------------*
      *            * Ampiezza interlinea                               *
      *            *---------------------------------------------------*
               10  w-pms-alt-int          pic  9(02)v9(02)            .
      ...
      *    *===========================================================*
      *    * Prompt : Parametri stampa da stampare                     *
      *    *-----------------------------------------------------------*
       pmt-tip-stp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Parametri stampa da stampare               *
      *    *-----------------------------------------------------------*
       acc-tip-stp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Parametri stampa da stampare            *
      *    *-----------------------------------------------------------*
       vis-tip-stp-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Codice fase gestionale                     *
      *    *-----------------------------------------------------------*
       acc-fas-ges-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice fase gestionale                  *
      *    *-----------------------------------------------------------*
       vis-fas-ges-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-010.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda dei parametri stampa da    *
      *              * stampare                                        *
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    01
           ...
           move      "Manca la scelta sui parametri stampa da stampare !
      ...
      *                  *---------------------------------------------*
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Se solo una fase gestionale                     *
      *              *-------------------------------------------------*
       tdo-ric-sel-305.
      *                  *---------------------------------------------*
      *                  * Test sul codice fase gestionale             *
      *                  *---------------------------------------------*
           if        rr-fas-ges           not  = spaces
                     go to tdo-ric-sel-310.
           move      "Manca il codice della fase gestionale !           
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
           go to     tdo-ric-sel-999.
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Start su parametri stampa di [pss], se errata : *
      *              * uscita                                          *
      *              *-------------------------------------------------*
           move      "pms "               to   pss-tre                .
           if        rr-tip-stp           =    02
                     move  rr-fas-ges     to   pss-kre
       ...
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Next su parametri stampa di [pss], se fine : u- *
      *              * scita                                           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        rr-fas-ges           =    spaces
                     go to stp-srt-inp-400.
           if        w-pms-fas-ges        not  = rr-fas-ges
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave                                      *
      *                  *---------------------------------------------*
           move      w-pms-fas-ges        to   srt-fas-ges            .
      *                  *---------------------------------------------*
      *                  * Dati                                        *
      *                  *---------------------------------------------*
           move      w-pms                to   srt-dat                .
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun parametro stampa da stampare entro i limiti
      -              " assegnati !"       to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      "PARAMETRI DI STAMPA PRECABLATI"
      ...
      *
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "   Fase     Stampante    Uscita stampa     Modulo 
      -              "    Caratteri    Interlinea   "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       int-pag-sta-400.
