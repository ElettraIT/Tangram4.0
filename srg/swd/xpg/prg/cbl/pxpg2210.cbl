      ...
      *                       Ultima revisione:    NdK del 25/06/19    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su codici utente             *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    INTERROGAZIONE SU CODICI UTENTE     "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Codice utente min, da i.p.c.                          *
      *        *-------------------------------------------------------*
           05  rr-cod-min                 pic  x(08)                  .
      *        *-------------------------------------------------------*
      *        * Codice utente max, da i.p.c.                          *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-ipc.
      *        *-------------------------------------------------------*
      *        * Variabile di i.p.c. 'cod-ute' letta ad inizio pro-    *
      *        * gramma per determinare una eventuale limitazione ai   *
      *        * soli codici utente con l'iniziale dichiarata          *
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-pre-exe-pgm      .
      *              *-------------------------------------------------*
      *              * Lettura variabile di i.p.c. 'cod-ute'           *
      *              *-------------------------------------------------*
           perform   ipc-dlp-cdu-000      thru ipc-dlp-cdu-999        .
       pre-exe-pgm-999.
           exit.
      ...
      *              * Codice min                                      *
      *              *-------------------------------------------------*
           move      w-ipc-cod-ute        to   rr-cod-min             .
      *              *-------------------------------------------------*
      *              * Codice max                                      *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun codice utente memorizzato !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      16                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      w-ute-cod-ute        to   w-mpn-cod-ute          .
           move      w-mpn                to   v-cnt                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Indicazione di Supervisore o Bloccato       *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'auc-ute'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *    *===========================================================*
      *    * Lettura variabile di i.p.c. 'cod-ute' per determinare i   *
      *    * caratteri iniziali del codice utente                      *
      *    *-----------------------------------------------------------*
       ipc-dlp-cdu-000.
           move      "CV"                 to   s-ope                  .
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-ipc-cod-ute
           else      move  spaces         to   w-ipc-cod-ute          .
       ipc-dlp-cdu-999.
           exit.
