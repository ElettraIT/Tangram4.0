      ...
      *                                   Fase:    xpg920              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 14/02/05    *
      *                       Versione attuale:    NdK del 20/02/05    *
      *                    ------------------------------------------- *
      ...
      *        * - 02 : solo sessioni con Errori                       *
      *        * - 03 : solo sessioni non Chiuse                       *
      *        *-------------------------------------------------------*
           ...
           05  w-exp-tip-sel.
               ...
               10  w-exp-tip-sel-tbl.
                   15  filler             pic  x(40) value
                            "Nessuno                                 ".
                   15  filler             pic  x(40) value
                            "solo sessioni con Errori                ".
                   15  filler             pic  x(40) value
                            "solo sessioni non Chiuse                ".
      ...
      *        * Utente                                                *
      *        *-------------------------------------------------------*
           05  w-buf-det-ide-ute          pic  x(08)                  . 
      *        *-------------------------------------------------------*
      *        * Data                                                  *
      *        *-------------------------------------------------------*
           05  w-buf-det-ide-dat          pic  9(07)                  . 
      *        *-------------------------------------------------------*
      *        * Fase                                                  *
      *        *-------------------------------------------------------*
           05  w-buf-det-ide-fas          pic  x(06)                  . 
      *        *-------------------------------------------------------*
      *        * Prefisso unico                                        *
      *        *-------------------------------------------------------*
           05  w-buf-det-ide-ppu          pic  x(20)                  . 
      *        *-------------------------------------------------------*
      *        * Comodo per confronto prefisso unico                   *
      *        *-------------------------------------------------------*
           05  w-buf-ini-ppu-att          pic  x(20)                  . 
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice azienda                       *
      *    *-----------------------------------------------------------*
       acc-cod-azi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo selezione : Codice azienda          *
      *    *-----------------------------------------------------------*
       vis-cod-azi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice fase                          *
      *    *-----------------------------------------------------------*
       acc-cod-fas-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              * Preparazione chiave                             *
      *              *-------------------------------------------------*
           move      rr-dat-min           to   usl-ide-dat-3          .
           move      spaces               to   usl-ide-ppu-3          .
           move      zero                 to   usl-ide-tim-3          .
           move      spaces               to   usl-ide-ute-3          .
           move      spaces               to   usl-ide-azi-3          .
           move      spaces               to   usl-ide-fas-3          .
           move      spaces               to   usl-ide-tfu-3          .
      *              *-------------------------------------------------*
      *              * Start su file [usl]                             *
      *              *-------------------------------------------------*
           start     usl    key not less
                            usl-k03
                            invalid key
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun log utente da stampare entro i limiti asseg
      -              "nati !"             to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [usl]              *
      *              *-------------------------------------------------*
           read      usl    next
                            with no lock
                            at end
      ...
      *              *-------------------------------------------------*
       ...
       prn-tst-max-100.
      *              *-------------------------------------------------*
      *              * Test su data selezione max                      *
      *              *-------------------------------------------------*
           if        rr-dat-max           =    zero
                     go to prn-tst-max-200.
           if        usl-ide-dat          >    rr-dat-max
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              * Livello 1                                       *
      *              *-------------------------------------------------*
           move      usl-ide-ppu          to   w-rot-l01-ide-ppu      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Bufferizzazione prefisso in corso di utilizzo   *
      *              *-------------------------------------------------*
           move      "U?"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-pat                to   w-buf-ini-ppu-att      .
      *              *-------------------------------------------------*
      *              * Trattamento prefisso unico                      *
      *              *-------------------------------------------------*
           move      w-buf-ini-ppu-att    to   w-all-str-alf          .
           move      "."                  to   w-all-str-del          .
           perform   all-str-ext-000      thru all-str-ext-999        .
      *
           move      08                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      w-all-str-cat (2)    to   w-all-str-cat (1)      .
      *
           if        w-all-str-cat (3)    =    spaces
                     move  spaces         to   w-all-str-cat (2)
           else      move  w-all-str-del  to   w-all-str-cat (2)      .
      *
           move      w-all-str-cat (3)    to   w-all-str-cat (3)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   w-buf-ini-ppu-att      .
      *              *-------------------------------------------------*
      *              * Intestazione foglio                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-lr1-100.
      *              *-------------------------------------------------*
      *              * Stampa eventuale avviso                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se selezionata una fase                     *
      *                  *---------------------------------------------*
           if        rr-cod-fas           not  = spaces
                     go to prn-fin-lr1-999.
      *                  *---------------------------------------------*
      *                  * Se solo errori : no avviso                  *
      *                  *---------------------------------------------*
           if        rr-tip-sel           =    02
                     go to prn-fin-lr1-999.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr1-200.
      *                  *---------------------------------------------*
      *                  * Test se avviso da emettere                  *
      *                  *---------------------------------------------*
           if        rr-tip-sel           =    03
                     go to prn-fin-lr1-220
           else      go to prn-fin-lr1-230.
       prn-fin-lr1-220.
      *                      *-----------------------------------------*
      *                      * Test se conclusione corretta            *
      *                      *-----------------------------------------*
           if        w-buf-det-ide-fas    =    "logout"          or
                     w-buf-det-ide-ppu    =    w-buf-ini-ppu-att
                     go to prn-fin-lr1-999.
       prn-fin-lr1-230.
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      ...
      *                      *-----------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "D"                  to   p-tip                  .
           move      w-buf-det-ide-dat    to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Composizione                            *
      *                      *-----------------------------------------*
           ...
           move      "Sessione"           to   w-all-str-cat (1)      .
           move      w-buf-det-ide-ppu    to   w-all-str-cat (2)      .
           move      "- utente ["         to   w-all-str-cat (3)      .
           move      w-buf-det-ide-ute    to   w-all-str-cat (4)      .
           move      "] -"                to   w-all-str-cat (5)      .
           move      p-edt                to   w-all-str-cat (6)      .
           move      ": aperta ..."       to   w-all-str-cat (7)      .
      ...
      *              * Trattamento prefisso unico                      *
      *              *-------------------------------------------------*
           move      usl-ide-ppu          to   w-all-str-alf          .
           move      "."                  to   w-all-str-del          .
           perform   all-str-ext-000      thru all-str-ext-999        .
      *
           move      08                   to   w-all-str-lun          .
      ...
      *
           move      w-all-str-cat (3)    to   w-all-str-cat (3)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   usl-ide-ppu            .
      *              *-------------------------------------------------*
      *              * Bufferizzazione elemento                        *
      *              *-------------------------------------------------*
           move      usl-ide-ute          to   w-buf-det-ide-ute      .
           move      usl-ide-dat          to   w-buf-det-ide-dat      .
           move      usl-ide-fas          to   w-buf-det-ide-fas      .
           move      usl-ide-ppu          to   w-buf-det-ide-ppu      .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Stampa del primo record                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se record da stampare                  *
      *                  *---------------------------------------------*
           if        rr-tip-sel           =    03
      ...
      *              *-------------------------------------------------*
           move      "SESSIONI UTENTE"    to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      " Utente      Data      Ora   Azi      ID       Fas
      -              "e    TF          Note         "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
