      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su codici nodo IP            *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun codice nodo memorizzato !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      01                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      w-nip-cod-nip        to   w-mpn-cod-nip          .
           move      w-mpn                to   v-cnt                  .
      ...
      *
           if        w-nip-tip-nip        =    01
                     move  "Server    "   to   v-alf
           else if   w-nip-tip-nip        =    02
                     move  "Client    "   to   v-alf
           else if   w-nip-tip-nip        =    03
                     move  "Stampante "   to   v-alf
           else if   w-nip-tip-nip        =    04
                     move  "Print-serv"   to   v-alf
           else if   w-nip-tip-nip        =    05
                     move  "Router    "   to   v-alf
           else if   w-nip-tip-nip        =    06
                     move  "Access pt."   to   v-alf
           else if   w-nip-tip-nip        =    07
                     move  "Device pt."   to   v-alf
           else if   w-nip-tip-nip        =    08
                     move  "Webcam    "   to   v-alf
           else if   w-nip-tip-nip        =    09
                     move  "Smart TV  "   to   v-alf
           else if   w-nip-tip-nip        =    10
                     move  "Tablet    "   to   v-alf
           else if   w-nip-tip-nip        =    11
                     move  "Domotica  "   to   v-alf
           else if   w-nip-tip-nip        =    12
                     move  "Server VM "   to   v-alf
           else if   w-nip-tip-nip        =    13
                     move  "Smartphone"   to   v-alf
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'auc-nip'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *                  *---------------------------------------------*
           call      "swd/xpg/prg/obj/pxpg2300"                       .
           cancel    "swd/xpg/prg/obj/pxpg2300"                       .
       qry-trt-fun-999.
           exit.
