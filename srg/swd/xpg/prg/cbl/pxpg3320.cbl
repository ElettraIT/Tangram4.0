      ...
      *                       Ultima revisione:    NdK del 17/03/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa Pathnames Sostitutivi                *
      *                                                                *
      *================================================================*
      ...
      *            * Pathname originale                                *
      *            *---------------------------------------------------*
               10  srt-pat-org            pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Area per ridefinizione pathnames sostitutivi      *
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Pathnames da stampare                      *
      *        *-------------------------------------------------------*
           05  w-exp-tip-stp.
      ...
      *    *===========================================================*
      *    * Accettazione : Pathnames da stampare                      *
      *    *-----------------------------------------------------------*
       acc-tip-stp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Pathnames da stampare                   *
      *    *-----------------------------------------------------------*
       vis-tip-stp-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-010.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo di pathnames da   *
      *              * stampare                                        *
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    01
           ...
           move      "Manca la scelta sui pathnames da stampare !       
      ...
      *                  * Test sul pathname                           *
      *                  *---------------------------------------------*
           if        rr-pat-org           not  = spaces
                     go to tdo-ric-sel-310.
           move      "Manca il pathname da selezionare !                
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
           go to     tdo-ric-sel-999.
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Start su pathnames di [auc], se errata : uscita *
      *              *-------------------------------------------------*
           move      "pnx "               to   auc-tre                .
           if        rr-tip-stp           =    02
                     move  rr-pat-org     to   auc-kre
       ...
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Next su pathnames di [auc], se fine : uscita    *
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Test max su pathnames di [auc], se non superato *
      *              * : uscita                                        *
      *              *-------------------------------------------------*
           if        auc-tre              not  = "pnx "
                     go to stp-srt-inp-900.
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-350.
      *              *-------------------------------------------------*
      *              * Test max per richiesta di singolo pathname      *
      *              *-------------------------------------------------*
           if        rr-tip-stp           not  = 02
                     go to stp-srt-inp-400.
           if        rr-pat-org           =    spaces
                     go to stp-srt-inp-400.
           if        w-pnx-pat-org        not  = rr-pat-org
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave                                      *
      *                  *---------------------------------------------*
           move      w-pnx-pat-org        to   srt-pat-org            .
      *                  *---------------------------------------------*
      *                  * Dati                                        *
      *                  *---------------------------------------------*
           move      w-pnx                to   srt-dat                .
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun pathname da stampare entro i limiti assegna
      -              "ti !"               to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Deduzione status pathname sostitutivo   *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Assemblaggio con status                 *
      *                      *-----------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      w-pnx-pat-sos        to   w-all-str-cat (1)      .
           move      "[INIBITO]"          to   w-all-str-cat (2)      .
