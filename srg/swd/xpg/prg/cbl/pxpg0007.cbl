      ...
      *================================================================*
      *                                                                *
      * Gestione, sotto desk-accessory, dello Screen-Hard-Copy         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA IMMAGINE ATTUALE DELLO SCHERMO  "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Modo di utilizzo attuale del video                    *
      *        *  - "M0" : 80  colonne                                 *
      *        *  - "M1" : 132 colonne                                 *
      *        *-------------------------------------------------------*
           05  rr-mod-scr                 pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Larghezza linea, in funzione del modo di utilizzo     *
      *        *-------------------------------------------------------*
           05  rr-lar-lin                 pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Linea di '='                                          *
      *        *-------------------------------------------------------*
           05  rr-all-ugu                 pic  x(132) value all "="   .
      *        *-------------------------------------------------------*
      *        * Linea di '-'                                          *
      *        *-------------------------------------------------------*
           05  rr-all-men                 pic  x(132) value all "-"   .
      *        *-------------------------------------------------------*
      *        * Immagine attuale del video                            *
      *        *-------------------------------------------------------*
           05  rr-imm-scr.
      *            *---------------------------------------------------*
      *            * Linee dell'immagine                               *
      *            *---------------------------------------------------*
               10  rr-lin-scr      occurs  24.
      *                *-----------------------------------------------*
      *                * Caratteri della linea                         *
      *                *-----------------------------------------------*
                   15  rr-chr-scr  occurs 132
                                          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Indice per scansione linee                            *
      *        *-------------------------------------------------------*
           05  rr-inx-scr                 pic  9(03)                  .
      ...
      *    *-----------------------------------------------------------*
       dic-ini-pgm-000.
      *              *-------------------------------------------------*
      *              * Nessuna dichiarazione di inizio programma       *
      *              *-------------------------------------------------*
           go to     dic-ini-pgm-999.
       dic-ini-pgm-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dic-fin-pgm-000.
      *              *-------------------------------------------------*
      *              * Nessuna dichiarazione di fine programma         *
      *              *-------------------------------------------------*
           go to     dic-fin-pgm-999.
       dic-fin-pgm-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       pre-exe-pgm-100.
      *              *-------------------------------------------------*
      *              * Determinazione modo di utilizzo video           *
      *              *-------------------------------------------------*
           move      "M?"                 to   v-ope                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-ope                to   rr-mod-scr             .
      *              *-------------------------------------------------*
      *              * Determinazione larghezza linea in funzione del  *
      *              * modo di utilizzo video                          *
      *              *-------------------------------------------------*
           if        rr-mod-scr           =    "M1"
                     move  132            to   rr-lar-lin
           else      move  080            to   rr-lar-lin             .
       pre-exe-pgm-200.
      *              *-------------------------------------------------*
      *              * Salvataggio immagine attuale a video            *
      *              *-------------------------------------------------*
       pre-exe-pgm-210.
      *                  *---------------------------------------------*
      *                  * Indice 01..24 : a zero                      *
      *                  *---------------------------------------------*
           move      zero                 to   rr-inx-scr             .
       pre-exe-pgm-220.
      *                  *---------------------------------------------*
      *                  * Incremento indice 01..24                    *
      *                  *---------------------------------------------*
           add       1                    to   rr-inx-scr             .
      *                  *---------------------------------------------*
      *                  * Se oltre 24 : fine salvataggio immagine     *
      *                  *---------------------------------------------*
           if        rr-inx-scr           >    24
                     go to pre-exe-pgm-300.
      *                  *---------------------------------------------*
      *                  * Ottenimento immagine linea attuale da buf-  *
      *                  * fer gestione video, e suo salvataggio       *
      *                  *---------------------------------------------*
           move      "FL"                 to   v-ope                  .
           move      rr-inx-scr           to   v-lin                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-alf                to   rr-lin-scr
                                              (rr-inx-scr)            .
      *                  *---------------------------------------------*
      ...
      *              * Ampiezza linea di stampa in caratteri           *
      *              *                                                 *
      *              * In funzione del modo di utilizzo attuale del    *
      *              * video                                           *
      *              *-------------------------------------------------*
           move      rr-lar-lin           to   w-cnt-stp-amp-lin      .
      *              *-------------------------------------------------*
      *              * Top margin in linee                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-str-ini-100.
      *              *-------------------------------------------------*
      *              * Manipolazione preliminare dell'immagine sullo   *
      *              * schermo                                         *
      *              *-------------------------------------------------*
       prn-str-ini-200.
      *                  *---------------------------------------------*
      *                  * Se non e' vero che :                        *
      *                  *  - La linea 01 e' tutta a '=' e             *
      *                  *  - La linea 03 e' tutta a '='               *
      *                  * non si esegue nessuna manipolazione         *
      *                  *---------------------------------------------*
           if        rr-lin-scr (1)
                    (1 : rr-lar-lin)      not  = rr-all-ugu
                                                (1 : rr-lar-lin) or
                     rr-lin-scr (3)
                    (1 : rr-lar-lin)      not  = rr-all-ugu
                                                (1 : rr-lar-lin)
       ...
       prn-str-ini-300.
      *                  *---------------------------------------------*
      *                  * Se il tipo di stampa selezionato :          *
      *                  *  - I : Immediata                            *
      *                  *  - D : Su disco                             *
      *                  *  - V : A video                              *
      *                  * non e' immediata ne' su disco : nessuna ma- *
      *                  * nipolazione                                 *
      *                  *---------------------------------------------*
       ...
       prn-str-ini-400.
      *                  *---------------------------------------------*
      *                  * Lettura del tipo stampante selezionato per  *
      *                  * poi poterne esaminare la classe di appar-   *
      *                  * tenenza                                     *
      *                  *---------------------------------------------*
       prn-str-ini-410.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           go to     prn-str-ini-430.
       prn-str-ini-420.
      *                      *-----------------------------------------*
      *                      * Se tipo stampante non esistente : nes-  *
      *                      * suna manipolazione                      *
      *                      *-----------------------------------------*
           go to     prn-str-ini-800.
       prn-str-ini-430.
      ...
      *                      * per il tipo stampante                   *
      *                      *-----------------------------------------*
           move      pss-dat              to   w-tst                  .
      *                      *-----------------------------------------*
      *                      * Se la classe stampante :                *
      *                      *  - Spaces : Normale                     *
      *                      *  - PS     : PostScript                  *
      *                      *  - PCL5   : PCL5                        *
      *                      *  - SPPX   : Special Printer             *
      *                      * non e' ne' PostScript ne' PCL5 : nessu- *
      *                      * na manipolazione                        *
      *                      *-----------------------------------------*
       ...
       prn-str-ini-500.
      *                  *---------------------------------------------*
      *                  * Manipolazione : si pone la linea 03 tutta   *
      *                  * a '-'                                       *
      *                  *---------------------------------------------*
           move      rr-all-men
                    (1 : rr-lar-lin)      to   rr-lin-scr (3)
                                              (1 : rr-lar-lin)        .
       prn-str-ini-800.
      *              *-------------------------------------------------*
      *              * Indice per scansione linee dell'immagine video  *
      *              * : a zero                                        *
      *              *-------------------------------------------------*
           move      zero                 to   rr-inx-scr             .
       prn-str-ini-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Incremento indice per scansione linee dell'im-  *
      *              * magine video                                    *
      *              *-------------------------------------------------*
           add       1                    to   rr-inx-scr             .
       prn-let-seq-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Test se indice per scansione linee dell'immagi- *
      *              * ne video oltre il massimo                       *
      *              *-------------------------------------------------*
           if        rr-inx-scr           >    24
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Prima della prima linea da stampare             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rr-inx-scr           not  = 01
      ...
      *                  *---------------------------------------------*
      *                  * Se flag di interruzione forzata : si esce   *
      *                  *---------------------------------------------*
           if        w-cnt-prn-flg-int    not  = spaces
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Stampa della linea da stampare                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Stampa linea, a lunghezza variabile a se-   *
      *                  * conda del modo attuale di utilizzo video    *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      rr-lar-lin           to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      rr-lin-scr
                    (rr-inx-scr)          to   p-alf                  .
       ...
       prn-liv-det-600.
      *              *-------------------------------------------------*
      *              * Dopo l'ultima linea da stampare                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rr-inx-scr           not  = 24
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Se errore grave di i-o su stampa si esce con lo *
      *              * status di errore                                *
      *              *-------------------------------------------------*
           if        p-rsc                not  = spaces
