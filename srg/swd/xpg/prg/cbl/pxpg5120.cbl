      ...
      *                       Ultima revisione:    NdK del 13/05/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa Personalizzazioni                    *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Personalizzazioni da stampare                         *
      *        * - 01 : Tutte                                          *
      *        * - 02 : Solo le personalizzazioni non definite         *
      *        * - 03 : Solo le personalizzazioni definite             *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Work per salvataggio Sistema/Area                     *
      *        *-------------------------------------------------------*
           05  w-sav-sys-are              pic  x(07)                  .
           05  w-sav-sys-arc              pic  x(07)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo personalizzazioni da stampare         *
      *        *-------------------------------------------------------*
           05  w-exp-tip-stp.
               ...
               10  w-exp-tip-stp-tbl.
                   15  filler             pic  x(40) value
                            "Tutte                                   ".
                   15  filler             pic  x(40) value
                            "solo le personalizzazioni Non definite  ".
                   15  filler             pic  x(40) value
                            "solo le personalizzazioni Definite      ".
      ...
      *    *===========================================================*
      *    * Work per livello di dettaglio sui valori                  *
      *    *-----------------------------------------------------------*
       01  w-det-vlr.
      *        *-------------------------------------------------------*
      *        * Tipo, se personalizzazione singola o multipla         *
      *        * - S : Singola                                         *
      *        * - M : Multipla                                        *
      *        *-------------------------------------------------------*
           05  w-det-vlr-sng-mul          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Flag di personalizzazione esistente                   *
      *        * - Spaces : Si                                         *
      *        * - #      : No                                         *
      *        *-------------------------------------------------------*
           05  w-det-vlr-flg-esi          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Numero progressivo, se personalizzazione multipla ed  *
      *        * esistente                                             *
      *        *-------------------------------------------------------*
           05  w-det-vlr-num-prg          pic  9(03)                  .
      ...
      *                  *---------------------------------------------*
      *                  * Tipo personalizzazioni da stampare          *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Tipo di personalizzazione da  *
      *    * stampare                                                  *
      *    *-----------------------------------------------------------*
       pmt-tip-stp-000.
           move      "DS"                 to   v-ope                  .
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Personalizzazioni da stampare   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tip-stp-999.
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Tipo personalizzazioni da  *
      *    *                                stampare                   *
      *    *-----------------------------------------------------------*
       acc-tip-stp-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test che il valore non sia zero             *
      *                  *---------------------------------------------*
           if        rr-tip-stp           =    zero
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Test su tipo personalizzazioni da stampare      *
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    01 or
                     rr-tip-stp           =    02 or
                     rr-tip-stp           =    03
           ...
           move      "ME"                 to   v-ope                  .
           move      "Manca il tipo personalizzazione da stampare !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna personalizzazione da stampare entro i limi
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [prs]              *
      *              *-------------------------------------------------*
           read      auc    next
                            with no lock
                            at end
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-025.
      *              *-------------------------------------------------*
      *              * Memorizzazione se personalizzazione singola o   *
      *              * multipla                                        *
      *              *-------------------------------------------------*
           move      w-dps-som-dps        to   w-det-vlr-sng-mul      .
       prn-sel-rec-050.
      *              *-------------------------------------------------*
      *              * Determinazione se personalizzazione esistente,  *
      *              * e del numero progressivo se multipla            *
      *              *-------------------------------------------------*
       prn-sel-rec-100.
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda se personalizzazione   *
      *                  * singola o multipla                          *
      *                  *---------------------------------------------*
           if        w-det-vlr-sng-mul    =    "M"
                     go to prn-sel-rec-150.
       prn-sel-rec-125.
      *                  *---------------------------------------------*
      *                  * Se personalizzazione singola                *
      *                  *---------------------------------------------*
       prn-sel-rec-130.
      *                      *-----------------------------------------*
      *                      * Lettura valore e deviazione a seconda   *
      ...
      *                          * Flag a : esistente                  *
      *                          *-------------------------------------*
           move      spaces               to   w-det-vlr-flg-esi      .
      *                          *-------------------------------------*
      *                          * Numero progressivo a zero           *
      *                          *-------------------------------------*
           move      zero                 to   w-det-vlr-num-prg      .
      *                          *-------------------------------------*
      *                          * Continuazione                       *
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Flag a : non esistente              *
      *                          *-------------------------------------*
           move      "#"                  to   w-det-vlr-flg-esi      .
      *                          *-------------------------------------*
      *                          * Numero progressivo a zero           *
      *                          *-------------------------------------*
           move      zero                 to   w-det-vlr-num-prg      .
      ...
      *                          *-------------------------------------*
       ...
       prn-sel-rec-150.
      *                  *---------------------------------------------*
      *                  * Se personalizzazione multipla               *
      *                  *---------------------------------------------*
       prn-sel-rec-155.
      *                      *-----------------------------------------*
      *                      * Start, e deviazione a seconda dell'esi- *
      *                      * to dell'operazione                      *
      *                      *-----------------------------------------*
           move      "prs "               to   prs-tre                .
           move      w-dps-cod-dps        to   prs-cod                .
           ...
           start     prs    key not less
                            prs-rck
                            invalid key
                            go to   prn-sel-rec-185.
       prn-sel-rec-160.
      *                      *-----------------------------------------*
      *                      * Read next, e deviazione a seconda del-  *
      *                      * l'esito dell'operazione                 *
      *                      *-----------------------------------------*
           read      prs  next with no lock
                               at end
                               go to   prn-sel-rec-185.
       prn-sel-rec-165.
      *                      *-----------------------------------------*
      *                      * Test max, e deviazione a seconda del-   *
      *                      * l'esito dell'operazione                 *
      *                      *-----------------------------------------*
           if        prs-tre              not  = "prs "
                     go to prn-sel-rec-185.
           if        prs-cod              not  = w-dps-cod-dps
                     go to prn-sel-rec-185.
       prn-sel-rec-170.
      *                      *-----------------------------------------*
      *                      * Selezione, se non superata : ricilo a   *
      *                      * read next                               *
      *                      *-----------------------------------------*
           if        prs-prg              <    000 or
                     prs-prg              >    999
                     go to prn-sel-rec-160.
       prn-sel-rec-175.
      *                      *-----------------------------------------*
      *                      * Se valore esistente                     *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           move      prs-prg              to   w-det-vlr-num-prg      .
      *                          *-------------------------------------*
      *                          * Continuazione                       *
      *                          *-------------------------------------*
           go to     prn-sel-rec-200.
      ...
      *                  *---------------------------------------------*
           ...
           if        prs-cod (01 : 03)    not  = rr-sis-app
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *                  *---------------------------------------------*
           if        rr-are-ges           =    spaces
                     go to prn-sel-rec-225.
           if        prs-cod (05 : 03)    not  = rr-are-ges
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-225.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tip-stp           =    01
                     ...
                     go to prn-sel-rec-275
           else if   rr-tip-stp           =    03
                     go to prn-sel-rec-300.
       prn-sel-rec-250.
      *                  *---------------------------------------------*
      *                  * Se tipo stampa : 01, tutte                  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Uscita sempre per Ok                    *
      *                      *-----------------------------------------*
           go to     prn-sel-rec-999.
       prn-sel-rec-275.
      *                  *---------------------------------------------*
      *                  * Se tipo stampa : 02, solo se non definite   *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        w-det-vlr-flg-esi    =    spaces
                     move  "#"            to   w-cnt-prn-flg-sub      .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
       ...
       prn-sel-rec-300.
      *                  *---------------------------------------------*
      *                  * Se tipo stampa : 03, solo se definite       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        w-det-vlr-flg-esi    not  = spaces
                     move  "#"            to   w-cnt-prn-flg-sub      .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione comodi di salvataggio Sistema/  *
      *              * Area                                            *
      *              *-------------------------------------------------*
           move      spaces               to   w-sav-sys-are          .
           move      spaces               to   w-sav-sys-arc          .
      *              *-------------------------------------------------*
      *              * Intestazione foglio                             *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-244.
      *                      *-----------------------------------------*
      *                      * Test se cambiato Sistema/Area           *
      *                      *-----------------------------------------*
           move      all   "-"            to   p-alf                  .
           move      w-dps-cod-dps        to   w-sav-sys-arc          .
           if        w-sav-sys-arc        =    w-sav-sys-are
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      020                  to   p-pos                  .
           move      w-dps-des-dps        to   p-alf                  .
           if        p-alc (80)           =    "*"
                     move  spaces         to   p-alc (80)             .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-300.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
       prn-liv-det-306.
      *                          *-------------------------------------*
      *                          * Deviazione a seconda se numero pro- *
      *                          * gressivo a zero oppure no           *
      *                          *-------------------------------------*
           if        w-det-vlr-num-prg    =    zero
                     go to prn-liv-det-308
           else      go to prn-liv-det-310.
       prn-liv-det-308.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Valore           :" to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           go to     prn-liv-det-312.
       prn-liv-det-310.
      *                          *-------------------------------------*
      *                          * Se numero progressivo non a zero    *
      *                          *-------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      18                   to   p-car                  .
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Deviazione a seconda se record e-   *
      *                          * sistente oppure no                  *
      *                          *-------------------------------------*
           if        w-det-vlr-flg-esi    =    spaces
                     go to prn-liv-det-314
           else      go to prn-liv-det-326.
       prn-liv-det-314.
      *                          *-------------------------------------*
      *                          * Se record esistente                 *
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      w-dps-car-dps        to   p-car                  .
           if        p-car                >    80
                     move  80             to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      020                  to   p-pos                  .
           move      prs-alf              to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *                              *---------------------------------*
           ...
           move      "N"                  to   p-tip                  .
           move      w-dps-car-dps        to   p-car                  .
           move      w-dps-dec-dps        to   p-dec                  .
           move      w-dps-sgn-dps        to   p-sgn                  .
           move      "9B"                 to   p-edm                  .
           move      p-lnr                to   p-lin                  .
           move      020                  to   p-pos                  .
           move      prs-num              to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           go to     prn-liv-det-400.
       prn-liv-det-322.
      ...
      *                          *-------------------------------------*
       ...
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Aggiornamento comodo di salvataggio Sistema/    *
      *              * Area                                            *
      *              *-------------------------------------------------*
           move      w-dps-cod-dps        to   w-sav-sys-are          .
      *              *-------------------------------------------------*
      *              * Stampa dei records successivi al primo          *
      *              *-------------------------------------------------*
       prn-liv-det-420.
      *                  *---------------------------------------------*
      *                  * Se personalizzazione singola : uscita       *
      *                  *---------------------------------------------*
           if        w-det-vlr-sng-mul    not  = "M"
                     go to prn-liv-det-999.
       prn-liv-det-440.
      *                  *---------------------------------------------*
      *                  * Read next, se fine file : uscita            *
      *                  *---------------------------------------------*
           read      prs  next with no lock
                               at end
                               go to   prn-liv-det-999.
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-480.
      *                  *---------------------------------------------*
      *                  * Selezione, se non superata : ricilo a read  *
      *                  * next                                        *
      *                  *---------------------------------------------*
           if        prs-prg              <    000 or
                     prs-prg              >    999
      ...
      *                          *-------------------------------------*
           if        w-dps-tip-dps        =    "A"
                     go to prn-liv-det-588
           else if   w-dps-tip-dps        =    "N"
                     go to prn-liv-det-590
           else if   w-dps-tip-dps        =    "D"
                     go to prn-liv-det-592
           else if   w-dps-tip-dps        =    "T"
                     go to prn-liv-det-594.
       prn-liv-det-588.
      *                          *-------------------------------------*
      *                          * Se tipo 'A'                         *
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "PERSONALIZZAZIONI"  to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
