      ...
      *                                   Fase:    xpg472              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/12/03    *
      *                       Ultima revisione:    NdK del 23/12/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa catalogo stampe su disco             *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    STAMPA CATALOGO STAMPE SU DISCO     "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Salvataggi relativi a [pfc]                           *
      *        *-------------------------------------------------------*
           05  w-sav-pfc.
               10  w-sav-pfc-pth          pic  x(40)                  .
               10  w-sav-num-prg          pic  9(06)                  .
               10  w-sav-snx-fil          pic  x(02)                  .
           ...
           05  w-exp-tip-stp.
               ...
               10  w-exp-tip-stp-tbl.
                   15  filler             pic  x(40) value
                            "Stampa elenco                           ".
                   15  filler             pic  x(40) value
                            "stampa elenco, con Eliminazione         ".
      ...
      *              *-------------------------------------------------*
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "N.B.: l'eliminazione consiste nella cancellazione 
      -              "delle stampe su disco che non "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "      hanno un corrispondente archivio in catalogo
      -              ".                             "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  * Composizione chiave                         *
      *                  *---------------------------------------------*
           move      rr-cod-azi           to   pfc-cod-azi-003        .
           move      spaces               to   pfc-cod-ute-003        .
           move      1                    to   pfc-num-prg-003        .
      *                  *---------------------------------------------*
      *                  * Operazione di Start                         *
      *                  *---------------------------------------------*
      ...
      *                  * Chiave                                      *
      *                  *---------------------------------------------*
           move      pfc-cod-azi          to   srt-cod-azi            .
      *                  *---------------------------------------------*
      *                  * Dati                                        *
      *                  *---------------------------------------------*
           move      pfc-rec              to   srt-dat                .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun catalogo stampa da stampare entro i limiti 
      -              "assegnati !"        to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      61                   to   p-pos                  .
           move      pfc-dat-icr          to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Numero stampe eseguite                      *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      04                   to   p-car                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      73                   to   p-pos                  .
           move      pfc-num-sef          to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       qry-liv-det-600.
      *                  *---------------------------------------------*
      *                  * Determinazione del pathname di base relati- *
      *                  * vo ai print-files per l'azienda             *
      *                  *---------------------------------------------*
           move      ".P"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-pat                to   w-sav-pfc-pth          .
           move      pfc-num-prg          to   w-sav-num-prg          .
      *                  *---------------------------------------------*
      *                  * Composizione pathname per file [prf]        *
      *                  *---------------------------------------------*
           move      "A0"                 to   o-ope                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
      ...
      *                          * Flag                                *
      *                          *-------------------------------------*
           move      "Si"                 to   w-sav-snx-fil          .
      *                          *-------------------------------------*
      *                          * Oltre                               *
      *                          *-------------------------------------*
           go to     qry-liv-det-660.
       qry-liv-det-640.
      *                      *-----------------------------------------*
      *                      * Se non trovato                          *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    01
                     move  "CATALOGO STAMPE SU DISCO"
                                          to   w-cnt-tit-des-tit
           else      move  "CATALOGO STAMPE SU DISCO - Eliminazione"
                                          to   w-cnt-tit-des-tit      .
      *
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Azi    Utente    Fase   Progressivo   Stampante   
      -              "Modulo   Creazione  Stampe  Fl"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       int-pag-sta-400.
