      ...
      *                                                                *
      *                    Stampa di una fattura elettronica in forma- *
      *                    to 'XML'                                    *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA FATTURA ELETTRONICA : CONTENUTI "       .
      ...
      *    *===========================================================*
      *    * Work area per parsing formato 'xml'                       *
      *    *-----------------------------------------------------------*
       01  w-inp-xml.
      *        *-------------------------------------------------------*
      *        * Comodi di estrazione componenti TAG                   *
      *        *-------------------------------------------------------*
           05  w-inp-xml-str-alf          pic  x(240)                 .
           05  w-inp-xml-str-flg          pic  x(01)                  .
           05  w-inp-xml-str-tip          pic  x(01)                  .
           05  w-inp-xml-str-tag          pic  x(20)                  .
           05  w-inp-xml-str-val          pic  x(40)                  .
           05  w-inp-xml-str-pmt          pic  x(40)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-rot-l05.
               10  w-rot-l05-num-lev      pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * 4. livello di rottura                                 *
      *        *-------------------------------------------------------*
           05  w-rot-l04.
               10  w-rot-l04-num-lev      pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * 3. livello di rottura                                 *
      *        *-------------------------------------------------------*
           05  w-rot-l03.
               10  w-rot-l03-num-lev      pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * 2. livello di rottura                                 *
      *        *-------------------------------------------------------*
           05  w-rot-l02.
               10  w-rot-l02-num-lev      pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * 1. livello di rottura                                 *
      *        *-------------------------------------------------------*
           05  w-rot-l01.
               10  w-rot-l01-num-lev      pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "/abd/tmp/IT0526289001421077_PD6CX.xml"
                                          to   rr-pat-fil.
      ...
      *              *-------------------------------------------------*
      *              * Parsing linea dati XML                          *
      *              *-------------------------------------------------*
           perform   prn-let-seq-xml-000  thru prn-let-seq-xml-999    .
       prn-let-seq-999.
           exit.
      ...
      *    * Ciclo Report Program : Lettura sequenziale                *
      *    *                                                           *
      *    * Subroutine di parsing linea letta                         *
      *    *-----------------------------------------------------------*
       prn-let-seq-xml-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      spaces               to   w-inp-xml-str-flg      .
           move      spaces               to   w-inp-xml-str-tip      .
           move      spaces               to   w-inp-xml-str-tag      .
           move      spaces               to   w-inp-xml-str-val      .
           move      spaces               to   w-inp-xml-str-pmt      .
       prn-let-seq-xml-050.
      *              *-------------------------------------------------*
      *              * Allineamento a sinistra della stringa           *
      *              *-------------------------------------------------*
           move      240                  to   w-all-str-lun          .
           move      seq-rec              to   w-all-str-alf          .
           perform   all-str-asx-000      thru all-str-asx-999        .
           move      w-all-str-alf        to   w-inp-xml-str-alf      .
      *              *-------------------------------------------------*
      *              * Test se TAG di apertura o chiusura livello o di *
      *              * dati                                            *
      *              *-------------------------------------------------*
           move      zero                 to   w-all-str-num          .
           move      "<"                  to   w-all-str-del          .
           inspect   seq-rec          tallying w-all-str-num
                                     for all   w-all-str-del          .
      *
           if        w-all-str-num        >    1
                     move  "V"            to   w-inp-xml-str-tip
                     move  "="            to   w-inp-xml-str-flg
           else      move  "N"            to   w-inp-xml-str-tip      .
       prn-let-seq-xml-100.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo                 *
      *              *-------------------------------------------------*
           if        w-inp-xml-str-tip    =    "V"
                     go to prn-let-seq-xml-200
           else      go to prn-let-seq-xml-400.
       prn-let-seq-xml-200.
      *              *-------------------------------------------------*
      *              * Se Valore                                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Estrazione prima parte                      *
      *                  *---------------------------------------------*
           move      w-inp-xml-str-alf    to   w-all-str-alf          .
           move      ">"                  to   w-all-str-del          .
           perform   all-str-ext-000      thru all-str-ext-999        .
           move      w-all-str-cat (1)    to   w-inp-xml-str-pmt      .
           move      w-all-str-cat (2)    to   w-inp-xml-str-val      .
      *                  *---------------------------------------------*
      *                  * Estrazione prompt                           *
      *                  *---------------------------------------------*
           move      w-inp-xml-str-pmt    to   w-all-str-alf          .
           move      "<"                  to   w-all-str-del          .
           perform   all-str-ext-000      thru all-str-ext-999        .
           move      w-all-str-cat (2)    to   w-inp-xml-str-pmt      .
      *                  *---------------------------------------------*
      *                  * Estrazione valore                           *
      *                  *---------------------------------------------*
           move      w-inp-xml-str-val    to   w-all-str-alf          .
           move      "<"                  to   w-all-str-del          .
           perform   all-str-ext-000      thru all-str-ext-999        .
           move      w-all-str-cat (1)    to   w-inp-xml-str-val      .
      *                  *---------------------------------------------*
      *                  * A determinazione codice TAG                 *
      *                  *---------------------------------------------*
           go to     prn-let-seq-xml-500.
       prn-let-seq-xml-400.
      *              *-------------------------------------------------*
      *              * Se Nodo                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-all-str-alf        to   w-inp-xml-str-alf      .
      *                  *---------------------------------------------*
      *                  * Controllo se presente segnale di chiusura   *
      *                  *---------------------------------------------*
           move      w-inp-xml-str-alf    to   w-all-str-alf          .
           move      "/"                  to   w-all-str-del          .
           ...
           if        w-all-str-num        >    zero
                     move  "-"            to   w-inp-xml-str-flg
           else      move  "+"            to   w-inp-xml-str-flg      .
      *                  *---------------------------------------------*
      *                  * Eliminazione carattere '/'                  *
      *                  *---------------------------------------------*
           inspect   w-inp-xml-str-alf
      ...
      *                  *---------------------------------------------*
           ...
           move      w-inp-xml-str-alf    to   w-all-str-alf          .
           perform   all-str-asx-000      thru all-str-asx-999        .
           move      w-all-str-alf        to   w-inp-xml-str-pmt      .
      *                  *---------------------------------------------*
      *                  * A determinazione codice TAG                 *
      *                  *---------------------------------------------*
           go to     prn-let-seq-xml-500.
       prn-let-seq-xml-500.
      *              *-------------------------------------------------*
      *              * Determinazione codice TAG                       *
      *              *-------------------------------------------------*
           perform   prn-let-seq-tag-000  thru prn-let-seq-tag-999    .
       prn-let-seq-xml-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-let-seq-xml-999.
       prn-let-seq-xml-999.
           exit.
      ...
      *    * Ciclo Report Program : Lettura sequenziale                *
      *    *                                                           *
      *    * Subroutine di determinazione codice TAG                   *
      *    *-----------------------------------------------------------*
       prn-let-seq-tag-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      ...
      *                  *---------------------------------------------*
       ...
       prn-let-seq-tag-300.
      *              *-------------------------------------------------*
      *              * Test max su archivio [ztg]                      *
      *              *-------------------------------------------------*
           if        rf-ztg-des-key       not  = w-all-str-alf
                                                (01 : 40)
                     go to prn-let-seq-tag-900.
       prn-let-seq-tag-500.
      *              *-------------------------------------------------*
      *              * Bufferizzazione codice TAG                      *
      *              *-------------------------------------------------*
           move      rf-ztg-cod-tag       to   w-inp-xml-str-tag      .
       prn-let-seq-tag-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-let-seq-tag-999.
       prn-let-seq-tag-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           perform   all-str-asx-000      thru all-str-asx-999        .
      *              *-------------------------------------------------*
      *              * Selezione su contenuto linea letta              *
      *              *-------------------------------------------------*
           if        w-all-str-alf
                    (01 : 10)             =    spaces       or
                     w-all-str-alf
      ...
      *              * Se primo passaggio                              *
      *              *-------------------------------------------------*
           if        w-inp-xml-str-tag    =    spaces
                     move 1               to   w-rot-l05-num-lev
                     go to prn-cmp-rot-100.
      *              *-------------------------------------------------*
      *              * Test se da eseguire                             *
      *              *-------------------------------------------------*
           if        w-inp-xml-str-flg    =    "-"
                     go to prn-cmp-rot-900.
       prn-cmp-rot-050.
      *              *-------------------------------------------------*
      *              * Estrazione nodi                                 *
      *              *-------------------------------------------------*
           move      w-inp-xml-str-tag    to   w-all-str-alf          .
           move      "."                  to   w-all-str-del          .
           perform   all-str-ext-000      thru all-str-ext-999        .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-rot-l05-num-lev      .
           move      zero                 to   w-rot-l04-num-lev      .
           move      zero                 to   w-rot-l03-num-lev      .
           move      zero                 to   w-rot-l02-num-lev      .
           move      zero                 to   w-rot-l01-num-lev      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     prn-cmp-rot-900.
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-rot-l04-num-lev      .
           move      zero                 to   w-rot-l03-num-lev      .
           move      zero                 to   w-rot-l02-num-lev      .
           move      zero                 to   w-rot-l01-num-lev      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-rot-l03-num-lev      .
           move      zero                 to   w-rot-l02-num-lev      .
           move      zero                 to   w-rot-l01-num-lev      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      ...
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      02                   to   v-car                  .
           move      w-all-str-cat (4)    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-rot-l02-num-lev      .
           move      zero                 to   w-rot-l01-num-lev      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      02                   to   v-car                  .
           move      w-all-str-cat (5)    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-rot-l01-num-lev      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     prn-cmp-rot-900.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Test su valore livello di rottura               *
      *              *-------------------------------------------------*
           if        w-rot-l05-num-lev    =    zero
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      w-rot-l05-num-lev    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr5-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      05                   to   p-pos                  .
           move      w-rot-l04-num-lev    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr4-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      10                   to   p-pos                  .
           move      w-rot-l03-num-lev    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr3-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      15                   to   p-pos                  .
           move      w-rot-l02-num-lev    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr2-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      20                   to   p-pos                  .
           move      w-rot-l01-num-lev    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-999.
           exit.
      ...
      *              * da stampare                                     *
      *              *-------------------------------------------------*
           move      "STAMPA FILE 'XML'"  to   w-cnt-tit-des-tit      .
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      008                  to   p-pos                  .
           move      w-inp-xml-str-tip    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Flag                                            *
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      009                  to   p-pos                  .
           move      w-inp-xml-str-flg    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Codice TAG                                      *
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      010                  to   p-pos                  .
           move      w-inp-xml-str-tag    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Prompt                                          *
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      026                  to   p-pos                  .
           move      w-inp-xml-str-pmt    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Valore                                          *
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      070                  to   p-pos                  .
           move      w-inp-xml-str-val    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-rig-det-999.
           exit.
