      ...
      *                       Ultima revisione:    NdK del 05/12/12    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su parametri stampa          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  INTERROGAZIONE SU PARAMETRI STAMPA   "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Codice fase gestionale min, da i.p.c.                 *
      *        *-------------------------------------------------------*
           05  rr-cod-min                 pic  x(06)                  .
      *        *-------------------------------------------------------*
      *        * Codice fase gestionale max, da i.p.c.                 *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-ipc.
      *        *-------------------------------------------------------*
      *        * Variabile di i.p.c. 'cod-pms' letta ad inizio pro-    *
      *        * gramma per determinare una eventuale limitazione ai   *
      *        * soli codici fase gestionale con l'iniziale dichiarata *
      *        *-------------------------------------------------------*
           05  w-ipc-cod-pms              pic  x(06)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-pre-exe-pgm      .
      *              *-------------------------------------------------*
      *              * Lettura variabile di i.p.c. 'cod-pms'           *
      *              *-------------------------------------------------*
           perform   ipc-dlp-cdf-000      thru ipc-dlp-cdf-999        .
       pre-exe-pgm-999.
           exit.
      ...
      *              * Codice min                                      *
      *              *-------------------------------------------------*
           move      w-ipc-cod-pms        to   rr-cod-min             .
      *              *-------------------------------------------------*
      *              * Codice max                                      *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessuna tabella parametri stampa memorizzata !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      01                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      w-pms-fas-ges        to   w-mpn-fas-ges          .
           move      w-mpn                to   v-cnt                  .
      ...
      *                  *---------------------------------------------*
           ...
           if        w-pms-out-stp        =    "I"
                     ...
                     move  "Su disco  "   to   v-alf
           else if   w-pms-out-stp        =    "S"
                     move  "In spool  "   to   v-alf
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Test se dipendente dal codice Azienda       *
      *                  *---------------------------------------------*
           if        w-pms-cod-mod
                    (01 : 01)             not  = "*"
                     go to qry-liv-det-400.
      *                  *---------------------------------------------*
      *                  * Nota se dipendente dal codice Azienda       *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      38                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'pss-pms'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *                  *---------------------------------------------*
           call      "swd/xpg/prg/obj/pxpg4400"                       .
           cancel    "swd/xpg/prg/obj/pxpg4400"                       .
       qry-trt-fun-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " Fase   Stampante  Tipo uscita   Modulo   Ampiezza
      -              " caratteri  Altezza interlinea"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Lettura variabile di i.p.c. 'cod-pms' per determinare i   *
      *    * caratteri iniziali del codice fase gestionale             *
      *    *-----------------------------------------------------------*
       ipc-dlp-cdf-000.
           move      "CV"                 to   s-ope                  .
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-ipc-cod-pms
           else      move  spaces         to   w-ipc-cod-pms          .
       ipc-dlp-cdf-999.
           exit.
