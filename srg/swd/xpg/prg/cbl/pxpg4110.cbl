      ...
      *                       Versione attuale:    NdK del 16/09/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su tipi stampante            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    INTERROGAZIONE SU TIPI STAMPANTE    "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Codice tipo stampante min, da i.p.c.                  *
      *        *-------------------------------------------------------*
           05  rr-cod-min                 pic  x(08)                  .
      *        *-------------------------------------------------------*
      *        * Codice tipo stampante max, da i.p.c.                  *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-ipc.
      *        *-------------------------------------------------------*
      *        * Variabile di i.p.c. 'cod-tst' letta ad inizio pro-    *
      *        * gramma per determinare una eventuale limitazione ai   *
      *        * soli tipi stampante con l'iniziale dichiarata         *
      *        *-------------------------------------------------------*
           05  w-ipc-cod-tst              pic  x(08)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-pre-exe-pgm      .
      *              *-------------------------------------------------*
      *              * Lettura variabile di i.p.c. 'cod-tst'           *
      *              *-------------------------------------------------*
           perform   ipc-dlp-cdt-000      thru ipc-dlp-cdt-999        .
       pre-exe-pgm-999.
           exit.
      ...
      *              * Codice min                                      *
      *              *-------------------------------------------------*
           move      w-ipc-cod-tst        to   rr-cod-min             .
      *              *-------------------------------------------------*
      *              * Codice max                                      *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun tipo stampante memorizzato !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      07                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      w-tst-cod-tst        to   w-mpn-cod-tst          .
           move      w-mpn                to   v-cnt                  .
      ...
      *
           if        w-tst-sap-app        =    spaces
                     move  "STD"          to   v-alf
           else      move  w-tst-sap-app  to   v-alf                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'pss-tst'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *    *===========================================================*
      *    * Lettura variabile di i.p.c. 'cod-tst' per determinare i   *
      *    * caratteri iniziali del codice tipo stampante              *
      *    *-----------------------------------------------------------*
       ipc-dlp-cdt-000.
           move      "CV"                 to   s-ope                  .
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-ipc-cod-tst
           else      move  spaces         to   w-ipc-cod-tst          .
       ipc-dlp-cdt-999.
           exit.
