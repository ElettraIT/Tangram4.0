      ...
      *                       Ultima revisione:    NdK del 12/03/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su codici procedure di sal-  *
      *                    vataggio.                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE PROCEDURE DI SALVATAGGIO "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Codice procedura min, da i.p.c.                       *
      *        *-------------------------------------------------------*
           05  rr-cod-min                 pic  x(12)                  .
      *        *-------------------------------------------------------*
      *        * Codice procedura max, da i.p.c.                       *
      *        *-------------------------------------------------------*
           05  rr-cod-max                 pic  x(12)                  .

      *    *===========================================================*
      *    * Work-area per ridefinizione contenuto del mark-point      *
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-cod-bak              pic  x(12)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-ipc.
      *        *-------------------------------------------------------*
      *        * Variabile di i.p.c. 'cod-bak' letta ad inizio pro-    *
      *        * gramma per determinare una eventuale limitazione ai   *
      *        * soli codici procedura con l'iniziale dichiarata       *
      *        *-------------------------------------------------------*
           05  w-ipc-cod-bak              pic  x(12)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-pre-exe-pgm      .
      *              *-------------------------------------------------*
      *              * Lettura variabile di i.p.c. 'cod-bak'           *
      *              *-------------------------------------------------*
      ...
      *              * Codice min                                      *
      *              *-------------------------------------------------*
           move      w-ipc-cod-bak        to   rr-cod-min             .
      *              *-------------------------------------------------*
      *              * Codice max                                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-200.
      *              *-------------------------------------------------*
      *              * Lettura record utente da [auc], pre considerare *
      *              * il tipo utente. Se non esistente si pone il ti- *
      *              * po utente a 'Normale'                           *
      *              *-------------------------------------------------*
           move      "RD"                 to   j-ope                  .
           move      "UTE"                to   j-tre                  .
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessuna procedura di salvataggio memorizzata !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
       ...
       qry-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Se l'utente in uso non e' di tipo supervisore   *
      *              * si selezionano solamente le procedure definite  *
      *              * per tutti i tipi utente, e non bloccate         *
      *              *-------------------------------------------------*
           if        w-ute-tip-ute        =    02
      ...
      *                  *---------------------------------------------*
           ...
           move      09                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      w-bak-cod-bak        to   w-mpn-cod-bak          .
           move      w-mpn                to   v-cnt                  .
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'auc-bak'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "    CODICI PROCEDURE DI SALVATAGGIO     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Lettura variabile di i.p.c. 'cod-bak' per determinare i   *
      *    * caratteri iniziali del codice procedura                   *
      *    *-----------------------------------------------------------*
       ipc-dlp-cdb-000.
           move      "CV"                 to   s-ope                  .
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-ipc-cod-bak
           else      move  spaces         to   w-ipc-cod-bak          .
       ipc-dlp-cdb-999.
           exit.
