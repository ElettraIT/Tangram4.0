      ...
      *                                   Fase:    xpg700              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 14/10/05    *
      *                       Ultima revisione:    NdK del 28/11/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su tabella aree              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     INTERROGAZIONE SU TABELLA AREE     "       .
      ...
      *    *===========================================================*
      *    * Work area per tabella aree gestionali                     *
      *    *-----------------------------------------------------------*
       01  w-are.
      *        *-------------------------------------------------------*
      *        * Tabella di decodifica aree                            *
      *        *-------------------------------------------------------*
           05  w-are-gst.
               10  w-are-gst-max          pic  9(02)       value 31   .
               10  w-are-gst-lun          pic  9(02)       value 44   .
               10  w-are-gst-ctr          pic  9(02)                  .
               10  w-are-gst-tbl.
                   15  filler             pic  x(44) value
                       "abi Anagrafiche banche in Italia            " .
                   15  filler             pic  x(44) value
                       "age Gestione Agenti                         " .
                   15  filler             pic  x(44) value
                       "azi Dati generali Azienda                   " .
                   15  filler             pic  x(44) value
                       "bfo Gestione bolle fornitori                " .
                   15  filler             pic  x(44) value
                       "bil Gestione bilanci                        " .
                   15  filler             pic  x(44) value
                       "bol Gestione bolle di vendita               " .
                   15  filler             pic  x(44) value
                       "cdp Gestione commesse di produzione         " .
                   15  filler             pic  x(44) value
                       "cge Contabilita' Generale                   " .
                   15  filler             pic  x(44) value
                       "dcc Dati commerciali Clienti                " .
                   15  filler             pic  x(44) value
                       "dcf Dati commerciali Fornitori              " .
                   15  filler             pic  x(44) value
                       "dcp Dati commerciali Prodotti               " .
                   15  filler             pic  x(44) value
                       "dpm Dati Materie Prime                      " .
                   15  filler             pic  x(44) value
                       "dps Dati Semilavorati                       " .
                   15  filler             pic  x(44) value
                       "dtp Dati Tecnici Produzione e Distinte Base " .
                   15  filler             pic  x(44) value
                       "fab Gestione Fabbisogni                     " .
                   15  filler             pic  x(44) value
                       "fat Gestione Fatturazione                   " .
                   15  filler             pic  x(44) value
                       "ffo Gestione Fatturazione di acquisto       " .
                   15  filler             pic  x(44) value
                       "geo Gestione dati Geografici                " .
                   15  filler             pic  x(44) value
                       "gep Gestione Portafoglio clienti            " .
                   15  filler             pic  x(44) value
                       "iic Gestione Iva Intracomunitaria           " .
                   15  filler             pic  x(44) value
                       "mag Gestione Magazzino                      " .
                   15  filler             pic  x(44) value
                       "mtv Dati Materiali Vari                     " .
                   15  filler             pic  x(44) value
                       "ods Gestione Ordini di Spedizione           " .
                   15  filler             pic  x(44) value
                       "orc Gestione Ordini Clienti                 " .
                   15  filler             pic  x(44) value
                       "orf Gestione Ordini Fornitori               " .
                   15  filler             pic  x(44) value
                       "rda Gestione Ritenuta d'Acconto             " .
                   15  filler             pic  x(44) value
                       "saf Gestione Statistiche di Acquisto        " .
                   15  filler             pic  x(44) value
                       "scf Gestione Scadenze Fornitori             " .
                   15  filler             pic  x(44) value
                       "svf Gestione Statistiche di Vendita         " .
                   15  filler             pic  x(44) value
                       "vdp Gestione Versamenti dalla Produzione    " .
                   15  filler             pic  x(44) value
                       "xpg Gestione dati di sistema                " .
               10  w-are-gst-tbr redefines
                   w-are-gst-tbl.
                   15  w-are-gst-ele occurs 31.
                       20  w-are-gst-atb  pic  x(03)                  .
                       20  filler         pic  x(01)                  .
                       20  w-are-gst-dtb  pic  x(40)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Azzeramento contatore 01..w-are-gst-max         *
      *              *-------------------------------------------------*
           move      zero                 to   w-are-gst-ctr          .
       qry-str-ini-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun elemento in tabella memorizzato !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Incremento contatore 01..w-are-gst-max          *
      *              *-------------------------------------------------*
           add       1                    to   w-are-gst-ctr          .
      *                  *---------------------------------------------*
      *                  * Se fine file                                *
      *                  *---------------------------------------------*
           if        w-are-gst-ctr        >    w-are-gst-max
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-are-gst-atb
                    (w-are-gst-ctr)       to   w-mpn-cod-are          .
           move      w-mpn                to   v-cnt                  .
           move      w-are-gst-dtb
                    (w-are-gst-ctr)       to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-are'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
