      ...
      *                       Ultima revisione:    NdK del 03/03/05    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Flag di cancellazione da effettuare               *
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Comodo per progressivo record                         *
      *        *-------------------------------------------------------*
           05  w-det-prg-rec-prg          pic  9(13)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Cancellazione log fino al  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *
           ...
           move      18                   to   v-lin                  .
           move      09                   to   v-pos                  .
           move      "Il programma cancella in modo irreversibile tutti 
      -              "i LOG utente  "     to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           move      "DS"                 to   v-ope                  .
           ...
           move      19                   to   v-lin                  .
           move      09                   to   v-pos                  .
           move      "fino alla data indicata, senza possibilita' di rec
      -              "upero         "     to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ric-sel-999.
      ...
      *              * Progressivo record                              *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-prg-rec-prg      .
      *              *-------------------------------------------------*
      *              * Preparazione chiave                             *
      *              *-------------------------------------------------*
           move      zero                 to   usl-ide-dat-3          .
      ...
      *                  * Composizione chiave                         *
      *                  *---------------------------------------------*
           move      w-det-prg-rec-prg    to   srt-prg-rec            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
           if        usl-ide-dat          >    rr-dat-max
                     move  spaces         to   srt-flg-pul
           else      move  "#"            to   srt-flg-pul            .
           move      usl-rec              to   srt-rec-usl            .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Copia file [usl] per prudenza                   *
      *              *-------------------------------------------------*
           move      "A0"                 to   o-ope                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/fpx/usl"       to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/fpx/usl.sav"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
           call      "swd/mod/prg/obj/mopsys"
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Recupero record da cancellare                   *
      *              *-------------------------------------------------*
           move      srt-rec-usl          to   usl-rec                .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           delete    usl     invalid key
                             go to   prn-liv-det-999.
       prn-liv-det-999.
           exit.
