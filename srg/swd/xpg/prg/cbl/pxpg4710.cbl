      ...
      *                                   Fase:    xpg471              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 04/10/02    *
      *                       Versione attuale:    NdK del 23/12/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su stampe su disco           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     INTERROGAZIONE STAMPE SU DISCO     "       .
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun catalogo stampa memorizzato !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      39                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      pfc-num-prg          to   w-mpn-num-prg          .
           move      w-mpn                to   v-cnt                  .
      ...
      *                  *---------------------------------------------*
           call      "swd/xpg/prg/obj/pxpg4700"                       .
           cancel    "swd/xpg/prg/obj/pxpg4700"                       .
       qry-trt-fun-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "     INTERROGAZIONE STAMPE SU DISCO     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
