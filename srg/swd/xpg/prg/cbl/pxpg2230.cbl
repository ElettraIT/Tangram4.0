      ...
      *                       Ultima revisione:    NdK del 29/06/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa password Utenti (Solo supervisore)   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Si/no reset data aggiornamento password               *
      *        *                                                       *
      *        * - 01 : No                                             *
      *        * - 02 : Si                                             *
      *        *-------------------------------------------------------*
           05  rr-res-dap                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Si/no reset password precedenti                       *
      *        *                                                       *
      *        * - 01 : No                                             *
      *        * - 02 : Si                                             *
      *        *-------------------------------------------------------*
           05  rr-res-pwp                 pic  9(02)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-det-pwd-ute.
               10  w-det-pwd-ute-flg      pic  x(01)                  .
               10  w-det-pwd-ute-chk      pic  x(01)                  .
               10  w-det-pwd-ute-edt      pic  x(08)                  .
               10  w-det-pwd-ute-ctr      pic  9(01)                  .
               10  w-det-pwd-ute-ct1      pic  9(02)                  .
               10  w-det-pwd-ute-cma      pic  9(01)                  .
               10  w-det-pwd-ute-cmi      pic  9(02)                  .
               10  w-det-pwd-ute-cnu      pic  9(02)                  .
               10  w-det-pwd-ute-ccs      pic  9(02)                  .
      *        *-------------------------------------------------------*
           ...
           05  w-exp-tip-stp.
               ...
               10  w-exp-tip-stp-tbl.
                   ...
                   15  filler             pic  x(40) value
                            "Solo uno                                ".
      *        *-------------------------------------------------------*
      *        * Work per : Reset data aggiornamento password          *
      *        *-------------------------------------------------------*
           05  w-exp-res-dap.
               10  w-exp-res-dap-num      pic  9(02) value 02         .
               10  w-exp-res-dap-lun      pic  9(02) value 02         .
               10  w-exp-res-dap-tbl.
                   15  filler             pic  x(02) value "No"       .
                   15  filler             pic  x(02) value "Si"       .
      *        *-------------------------------------------------------*
      *        * Work per : Reset password precedenti                  *
      *        *-------------------------------------------------------*
           05  w-exp-res-pwp.
               10  w-exp-res-pwp-num      pic  9(02) value 02         .
               10  w-exp-res-pwp-lun      pic  9(02) value 02         .
               10  w-exp-res-pwp-tbl.
                   15  filler             pic  x(02) value "No"       .
                   15  filler             pic  x(02) value "Si"       .
      ...
      *    *        azienda in uso, bensi' la ragione sociale licen-   *
      *    *        ziatario software                                  *
      *    *-----------------------------------------------------------*
       int-pag-std-000.
      *              *-------------------------------------------------*
      ...
      *                  * Si/no reset data aggiornamento password     *
      *                  *---------------------------------------------*
           perform   acc-res-dap-000      thru acc-res-dap-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Si/no reset password precedenti             *
      *                  *---------------------------------------------*
           perform   acc-res-pwp-000      thru acc-res-pwp-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      01                   to   rr-res-dap             .
           move      01                   to   rr-res-pwp             .
       nor-ric-sel-999.
           exit.
      ...
      *              * Si/no reset data aggiornamento password         *
      *              *-------------------------------------------------*
           perform   pmt-res-dap-000      thru pmt-res-dap-999        .
      *              *-------------------------------------------------*
      *              * Si/no reset password precedenti                 *
      *              *-------------------------------------------------*
           perform   pmt-res-pwp-000      thru pmt-res-pwp-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Prompt : Si/no reset password precedenti                  *
      *    *-----------------------------------------------------------*
       pmt-res-dap-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-res-pwp-000.
           ...
           move      15                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Reset password precedenti  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-res-pwp-999.
      ...
      *                      *-----------------------------------------*
           move      01                   to   rr-res-pwp             .
           perform   vis-res-pwp-000      thru vis-res-pwp-999        .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Si/no reset data aggiornamento password    *
      *    *-----------------------------------------------------------*
       acc-res-dap-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-res-dap-lun    to   v-car                  .
           move      w-exp-res-dap-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      "NS#"                to   v-msk                  .
           move      w-exp-res-dap-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      12                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      rr-res-dap           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-res-dap-999.
       acc-res-dap-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-res-dap             .
       acc-res-dap-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Test che il valore sia accettabile          *
      *                  *---------------------------------------------*
           if        rr-res-dap           not  = 01 and
                     rr-res-dap           not  = 02
                     go to acc-res-dap-100.
       acc-res-dap-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/no reset data aggiornamento password *
      *    *-----------------------------------------------------------*
       vis-res-dap-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Si/no reset password precedenti            *
      *    *-----------------------------------------------------------*
       acc-res-pwp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-res-pwp-lun    to   v-car                  .
           move      w-exp-res-pwp-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      "NS#"                to   v-msk                  .
           move      w-exp-res-pwp-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      15                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      rr-res-pwp           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  * Test che il valore sia accettabile          *
      *                  *---------------------------------------------*
           if        rr-res-pwp           not  = 01 and
                     rr-res-pwp           not  = 02
                     go to acc-res-pwp-100.
       acc-res-pwp-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/no reset password precedenti         *
      *    *-----------------------------------------------------------*
       vis-res-pwp-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              * Si/no reset data aggiornamento password         *
      *              *-------------------------------------------------*
           if        rr-res-dap           not  = 02
                     move  01             to   rr-res-dap             .
      *              *-------------------------------------------------*
      *              * Si/no reset password precedenti                 *
      *              *-------------------------------------------------*
           if        rr-res-pwp           not  = 02
                     move  01             to   rr-res-pwp             .
       reg-ric-sel-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      053                  to   p-pos                  .
           move      w-ute-pwd-ute        to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-300.
      *                  *---------------------------------------------*
      *                  * Aggiornamento data aggiornamento password   *
      *                  *---------------------------------------------*
           if        rr-res-dap           not  = 02
      ...
      *
           if        w-ute-dat-agg        not  numeric
                     move  zero           to   p-dat
           else      move  w-ute-dat-agg  to   p-dat                  .
      *
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Controllo formale password                  *
      *                  *---------------------------------------------*
           perform   prn-liv-det-cpw-000  thru prn-liv-det-cpw-999    .
           if        w-det-pwd-ute-flg    =    spaces
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Ciclo di stampa eventuali password precedenti   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se richiesto reset password precedenti *
      *                  *---------------------------------------------*
           if        rr-res-pwp           not  = 02
                     go to prn-liv-det-510.
      *                  *---------------------------------------------*
      *                  * Reset password precedenti                   *
      *                  *---------------------------------------------*
           perform   prn-liv-det-res-000  thru prn-liv-det-res-999    .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     prn-liv-det-510.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-det-pwd-ute-flg      .
           move      zero                 to   w-det-pwd-ute-cma      .
           move      zero                 to   w-det-pwd-ute-cmi      .
           move      zero                 to   w-det-pwd-ute-cnu      .
           move      zero                 to   w-det-pwd-ute-ccs      .
       prn-liv-det-cpw-100.
      *              *-------------------------------------------------*
      *              * Test su personalizzazioni                       *
      *              *-------------------------------------------------*
______*    if        w-prs-ctl-pwd-snb    =    "N"
______*              go to prn-liv-det-cpw-900.
       prn-liv-det-cpw-200.
      *              *-------------------------------------------------*
      *              * Controlli formali                               *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-all-str-flg        =    spaces
                     go to prn-liv-det-cpw-300.
      *                  *---------------------------------------------*
      *                  * Ad uscita per errore                        *
      *                  *---------------------------------------------*
           go to     prn-liv-det-cpw-800.
       prn-liv-det-cpw-300.
      *              *-------------------------------------------------*
      *              * Lunghezza password                              *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-det-pwd-ute-ctr      .
       prn-liv-det-cpw-420.
           add       1                    to   w-det-pwd-ute-ctr      .
           if        w-det-pwd-ute-ctr    >    8
                     go to prn-liv-det-cpw-500.
           move      w-ute-pwd-ute
                    (w-det-pwd-ute-ctr : 1)
                                          to   w-det-pwd-ute-chk      .
      *                  *---------------------------------------------*
      *                  * Controllo                                   *
      *                  *---------------------------------------------*
           perform   prn-liv-det-chk-000  thru prn-liv-det-chk-999    .
      *                  *---------------------------------------------*
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
           go to     prn-liv-det-cpw-420.
       prn-liv-det-cpw-500.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-det-pwd-ute-cma    >   zero and
                     w-det-pwd-ute-cmi    >   zero and
                     w-det-pwd-ute-cnu    >   zero and
                     w-det-pwd-ute-ccs    >   zero
                     go to prn-liv-det-cpw-900.
      *                  *---------------------------------------------*
      *                  * Ad uscita per errore                        *
      *                  *---------------------------------------------*
           go to     prn-liv-det-cpw-800.
      ...
      *                  * Flag di errore                              *
      *                  *---------------------------------------------*
           move      "#"                  to   w-det-pwd-ute-flg      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     prn-liv-det-cpw-999.
       prn-liv-det-cpw-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-chk-120.
           ...
           if        w-all-str-inx        >    26
                     go to prn-liv-det-chk-200.
           if        w-det-pwd-ute-chk    =    w-all-str-upc
                                              (w-all-str-inx)
                     add   1              to   w-det-pwd-ute-cma
                     go to prn-liv-det-chk-200.
           go to     prn-liv-det-chk-120.
       prn-liv-det-chk-200.
      *              *-------------------------------------------------*
      *              * Test su minuscole                               *
      *              *-------------------------------------------------*
       ...
       prn-liv-det-chk-220.
           add       1                    to   w-all-str-inx          .
           if        w-all-str-inx        >    26
                     go to prn-liv-det-chk-400.

           if        w-det-pwd-ute-chk    =    w-all-str-loc
                                              (w-all-str-inx)
                     add   1              to   w-det-pwd-ute-cmi
                     go to prn-liv-det-chk-400.
           go to     prn-liv-det-chk-220.
       prn-liv-det-chk-400.
      *              *-------------------------------------------------*
      *              * Test su numeri                                  *
      *              *-------------------------------------------------*
           if        w-det-pwd-ute-chk    =    "0" or
                     w-det-pwd-ute-chk    =    "1" or
                     w-det-pwd-ute-chk    =    "2" or
                     w-det-pwd-ute-chk    =    "3" or
                     w-det-pwd-ute-chk    =    "4" or
                     w-det-pwd-ute-chk    =    "5" or
                     w-det-pwd-ute-chk    =    "6" or
                     w-det-pwd-ute-chk    =    "7" or
                     w-det-pwd-ute-chk    =    "8" or
                     w-det-pwd-ute-chk    =    "9"
                     add   1              to   w-det-pwd-ute-cnu      .
       prn-liv-det-chk-600.
      *              *-------------------------------------------------*
      *              * Test su caratteri speciali                      *
      *              *-------------------------------------------------*
           if        w-det-pwd-ute-chk    =    "!" or
                     w-det-pwd-ute-chk    =    "£" or
                     w-det-pwd-ute-chk    =    "$" or
                     w-det-pwd-ute-chk    =    "%" or
                     w-det-pwd-ute-chk    =    "&" or
                     w-det-pwd-ute-chk    =    "?" or
                     w-det-pwd-ute-chk    =    "+" or
                     w-det-pwd-ute-chk    =    "-" or
                     w-det-pwd-ute-chk    =    "_" or
                     w-det-pwd-ute-chk    =    "*"
                     add   1              to   w-det-pwd-ute-ccs      .
       prn-liv-det-chk-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-liv-det-chk-999.
       prn-liv-det-chk-999.
           exit.
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine per reset password precedenti                  *
      *    *-----------------------------------------------------------*
       prn-liv-det-res-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione password precedenti             *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-pwd-pre-ctr      .
       prn-liv-det-res-200.
           add       1                    to   w-det-pwd-pre-ctr      .
           if        w-det-pwd-pre-ctr    >    w-det-pwd-pre-max
                     go to prn-liv-det-res-500.
           if        w-ute-pwd-utp
                    (w-det-pwd-pre-ctr)   =    spaces
                     go to prn-liv-det-res-500.
           move      spaces               to   w-ute-pwd-utp
                                              (w-det-pwd-pre-ctr)     .
           move      zero                 to   w-ute-pwd-udp
                                              (w-det-pwd-pre-ctr)     .
           go to     prn-liv-det-res-200.
       prn-liv-det-res-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "UTENTI - PASSWORD"  to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      " Utente                 Descrizione               
      -              "  Password  Aggiorn.    Note  "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
