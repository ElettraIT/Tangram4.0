      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su file [num]                *
      *                                                                *
      *================================================================*
      ...
      *        * Chiave min, da i.p.c.                                 *
      *        *-------------------------------------------------------*
           05  rr-key-min                 pic  x(08)                  .
      *        *-------------------------------------------------------*
      *        * Chiave max, da i.p.c.                                 *
      *        *-------------------------------------------------------*
           05  rr-key-max                 pic  x(08)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-key.
               10  w-mpn-key-fix          pic  x(08)                  .
               10  w-mpn-key-var          pic  x(10)                  .
               10  w-mpn-key-cnf          pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-pre-exe-pgm      .
      *              *-------------------------------------------------*
      *              * Lettura variabile di i.p.c. 'key-fix' prove-    *
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-ipc-dlp-fix
           else      move  spaces         to   w-ipc-dlp-fix          .
       pre-exe-pgm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Preparazione chiave min e max                   *
      *              *-------------------------------------------------*
           move      w-ipc-dlp-fix        to   rr-key-min             .
           move      rr-key-min           to   rr-key-max             .
           inspect   rr-key-max      replacing
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-key-min           to   rf-num-key-fix         .
      ...
      *                  *---------------------------------------------*
           ...
           move      01                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      rf-num-key-fix       to   v-alf                  .
           move      rf-num-key-fix       to   w-mpn-key-fix          .
           move      rf-num-key-var       to   w-mpn-key-var          .
           move      rf-num-key-cnf       to   w-mpn-key-cnf          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'fil-key'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *                  *---------------------------------------------*
           call      "swd/xpg/prg/obj/pxpg6100"                       .
           cancel    "swd/xpg/prg/obj/pxpg6100"                       .
       qry-trt-fun-999.
           exit.
