      ...
      *                       Ultima revisione:    NdK del 22/12/25    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Export dati inventario ELETTRA              *
      *                                                                *
      *                   (/abd/ftx/ele/xxx.txt)                       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " ESPORTAZIONE DATI ELETTRA - INVENTARIO "       .
      ...
      *              *-------------------------------------------------*
           move      "mag "               to   f-xxx-are              .
           move      "miu "               to   f-xxx-nam              .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        f-xxx-sts            not  = "S"
                     go to exe-exp-miu-999.
      *              *-------------------------------------------------*
      *              * Eventuali forzature se esecuzione batch         *
      *              *-------------------------------------------------*
           if        w-exe-flg-btc        =    "S"
                     go to exe-exp-miu-010.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-miu-cod-ubi       to   w-scr-str-ele          .
           move      07                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-miu-flg-rlv       to   w-scr-str-ele          .
           move      07                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      *                  *---------------------------------------------*
           ...
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * Flag di supervisione eseguita               *
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-miu-flg-spv       to   w-scr-str-ele          .
           move      07                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-miu-ide-dat       to   w-scr-dat-dat          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-miu-ide-ute       to   w-scr-str-ele          .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-miu-ide-fas       to   w-scr-str-ele          .
      ...
      *                  *---------------------------------------------*
           ...
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * Annotazioni per la fase di rilevazione      *
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-miu-ann-rlv       to   w-scr-str-ele          .
           move      07                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *              *-------------------------------------------------*
       ...
       exe-exp-miu-750.
      *              *-------------------------------------------------*
      *              * Riciclo a Next su [miu]                         *
      *              *-------------------------------------------------*
           go to     exe-exp-miu-200.
       exe-exp-miu-800.
      *              *-------------------------------------------------*
      *              * Close files                                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "| cat > /abd/asc/log/xpg770.log"
                                          to   w-all-str-cat (5)      .
