      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su codici automatici         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  INTERROGAZIONE SU CODICI AUTOMATICI   "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           05  rr-sgl-min                 pic  x(04)                  .
           05  rr-sgl-max                 pic  x(04)                  .

      *    *===========================================================*
      *    * Work-area per ridefinizione contenuto del mark-point      *
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-sgl-fil              pic  x(04)                  .
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun codice automatico memorizzato !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Selezione su numero progressivo                 *
      *              *-------------------------------------------------*
           if        enc-prg              not  = zero
                     move  "#"            to   w-cnt-qry-flg-sub
      ...
      *                  * matici                                      *
      *                  *---------------------------------------------*
           call      "swd/xpg/prg/obj/pxpg6200"                       .
           cancel    "swd/xpg/prg/obj/pxpg6200"                       .
       qry-trt-fun-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           string    "CODICI AUTOMATICI PER AZIENDA ["
                                delimited by   size
                     s-azi
                                delimited by   spaces
                     "]"
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "                   Sigla del file    Ultimo codice
      -              " utilizzato                   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
