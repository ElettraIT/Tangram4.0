      ...
      *                       Ultima revisione:    NdK del 17/04/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa Aziende                              *
      *                                                                *
      *================================================================*
      ...
      *            * Indirizzo IP                                      *
      *            *---------------------------------------------------*
               10  srt-iip-nip            pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Codice nodo                                       *
      *            *---------------------------------------------------*
               10  srt-cod-nip            pic  x(04)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Area per ridefinizione azienda                    *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    STAMPA TABELLA NODI DI RETE 'IP'    "       .
      ...
      *        *-------------------------------------------------------*
           05  w-cnt-tit.
               ...
               10  w-cnt-tit-des-nip.
                   15  w-cnt-tit-chr-nip  occurs 40
                                          pic  x(01)                  .
               10  w-cnt-tit-ctr-wrk      pic  9(02)                  .
               10  w-cnt-tit-ctr-nip      pic  9(02)                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-alf                to   w-cnt-tit-des-nip      .
           move      40                   to   w-cnt-tit-ctr-nip      .
       int-pag-std-100.
           if        w-cnt-tit-chr-nip
                    (w-cnt-tit-ctr-nip)   =    spaces
                     if     w-cnt-tit-ctr-nip
                                          >    1
                            subtract  1   from w-cnt-tit-ctr-nip
      ...
      *                  *---------------------------------------------*
           move      w-cnt-tit-ctr-nip    to   w-cnt-tit-ctr-wrk      .
      ...
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      w-cnt-tit-ctr-nip    to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      w-cnt-tit-des-nip    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Titolo stampato                             *
      ...
      *    *===========================================================*
      *    * Accettazione : Codici da stampare                         *
      *    *-----------------------------------------------------------*
       acc-tip-stp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codici da stampare                      *
      *    *-----------------------------------------------------------*
       vis-tip-stp-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-010.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo di codici da      *
      *              * stampare                                        *
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    01
           ...
           move      "Manca la scelta sul codice da stampare !          
      ...
      *                  * Test sul codice                             *
      *                  *---------------------------------------------*
           if        rr-cod-nip           not  = spaces
                     go to tdo-ric-sel-310.
           move      "Manca il codice nodo IP !                         
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
           go to     tdo-ric-sel-999.
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Start su aziende di [auc], se errata : uscita   *
      *              *-------------------------------------------------*
           move      "nip "               to   auc-tre                .
           if        rr-tip-stp           =    02
                     move  rr-cod-nip     to   auc-kre
       ...
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Next su aziende di [auc], se fine : uscita      *
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Test max su aziende di [auc], se non superato : *
      *              * uscita                                          *
      *              *-------------------------------------------------*
           if        auc-tre              not  = "nip "
                     go to stp-srt-inp-900.
      ...
      *              *-------------------------------------------------*
           move      auc-dat              to   w-nip                  .
       stp-srt-inp-350.
      *              *-------------------------------------------------*
      *              * Test max per richiesta di singola azienda       *
      *              *-------------------------------------------------*
           if        rr-tip-stp           not  = 02
                     go to stp-srt-inp-400.
           if        rr-cod-nip           =    spaces
                     go to stp-srt-inp-400.
           if        w-nip-cod-nip        not  = rr-cod-nip
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave                                      *
      *                  *---------------------------------------------*
           move      w-nip-cod-nip        to   srt-cod-nip            .
      *                  *---------------------------------------------*
      *                  * Dati                                        *
      *                  *---------------------------------------------*
           move      w-nip                to   srt-dat                .
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun nodo IP da stampare entro i limiti assegnat
      -              "i !"                to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           if        w-nip-sts-nip        not  numeric
                     move  01             to   w-nip-sts-nip          .
      *
           if        w-nip-sts-nip        not  = 02
      ...
      *
           if        w-nip-tip-nip        =    01
                     move  "Server    "   to   p-alf
           else if   w-nip-tip-nip        =    02
                     move  "Client    "   to   p-alf
           else if   w-nip-tip-nip        =    03
                     move  "Stampante "   to   p-alf
           else if   w-nip-tip-nip        =    04
                     move  "Print-serv"   to   p-alf
           else if   w-nip-tip-nip        =    05
                     move  "Router    "   to   p-alf
           else if   w-nip-tip-nip        =    06
                     move  "Access pt."   to   p-alf
           else if   w-nip-tip-nip        =    07
                     move  "Device pt."   to   p-alf
           else if   w-nip-tip-nip        =    08
                     move  "Webcam    "   to   p-alf
           else if   w-nip-tip-nip        =    09
                     move  "Smart TV  "   to   p-alf
           else if   w-nip-tip-nip        =    10
                     move  "Smartphone"   to   p-alf
           else if   w-nip-tip-nip        =    11
                     move  "Domotica  "   to   p-alf
           else if   w-nip-tip-nip        =    12
                     move  "Server VM "   to   p-alf
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      105                  to   p-pos                  .
           move      w-nip-ubi-nip        to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Eventuale linea aggiuntiva                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su matricola dispositivo               *
      *                  *---------------------------------------------*
           if        w-nip-mtr-nip        =    spaces
      ...
      *
      ...
      -              "  Tipo nodo      Indirizzo      Nome HOST    Utent
      -              "e            Ubicazione         "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
