      ...
      *                       Ultima revisione:    NdK del 18/09/17    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Scelta codice azienda e caricamento dati    *
      *                    relativi ad essa                            *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
               10  w-det-daz-cen-asx      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Descrizione azienda allineata al centro           *
      *            *---------------------------------------------------*
               10  w-det-daz-cen-adx      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Work locali                                       *
      *            *---------------------------------------------------*
      ...
      *                  * Eventuale default                           *
      *                  *---------------------------------------------*
           if        w-det-azi-sgr-cod    =    spaces and
                     w-aaz-cod            =    spaces
                     move  w-ute-def-azi  to   w-aaz-cod              .
       acc-cod-azi-140.
      *                  *---------------------------------------------*
      *                  * Accettazione codice                         *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       det-daz-cen-000.
           if        w-det-daz-cen-asx
                    (40 : 01)             =    "*"
                     move  spaces         to   w-det-daz-cen-asx
                                              (40 : 01)               .
       det-daz-cen-050.
           move      spaces               to   w-det-daz-cen-adx      .
           move      40                   to   w-all-str-lun          .
           move      w-det-daz-cen-asx    to   w-all-str-alf          .
           perform   all-str-cen-000      thru all-str-cen-999        .
           move      w-all-str-alf        to   w-det-daz-cen-adx      .
       det-daz-cen-999.
           exit.
