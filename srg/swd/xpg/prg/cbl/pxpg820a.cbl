      ...
      *                       Versione attuale:    NdK del 17/01/06    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Visualizzazione errori in fase di copia     *
      *                    automatica                                  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "VISUALIZZAZIONE ERRORI COPIA AUTOMATICA "       .
      ...
      *
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "N.B.: la seguente stringa NON viene considerata co
      -              "me errore:                    "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      21                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "      'tar: Removing leading `/' from member names
      -              "'                             "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
