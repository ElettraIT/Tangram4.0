      ...
      *                       Ultima revisione:    NdK del 03/09/01    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Riparazione programmi danneggiati           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     RIPARAZIONE ARCHIVI DANNEGGIATI    "       .
      ...
      *                  * Nome archivio                               *
      *                  *---------------------------------------------*
           perform   acc-nom-arc-000      thru acc-nom-arc-999        .
      ...
      *              * Nome archivio                                   *
      *              *-------------------------------------------------*
           perform   pmt-nom-arc-000      thru pmt-nom-arc-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Note : Il presente programma deve essere utilizzat
      -              "o per riparare gli archivi    "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      07                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       danneggiati a seguito di una interruzione a
      -              "ccidentale di TANGRAM.        "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       La riparazione e' relativa solamente al cod
      -              "ice interno di errore : 98,xx "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       dove 'xx' e' la chiave dell'archivio corrot
      -              "ta.                           "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       E' necessario che tutti gli utenti siano sc
      -              "ollegati da Tangram.          "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      14                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       La risposta 'y' alla fine della ricostruzio
      ...
      *                  *---------------------------------------------*
           ...
           move      16                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " * * * SI CONSIGLIA DI ESEGUIRE IL PROGRAMMA SOTTO
      -              " LA SUPERVISIONE DI PERSONALE "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pmt-nom-arc-000.
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Nome archivio danneggiato (da messaggio di errore)
      -              " ..........:"       
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-nom-arc-999.
       acc-nom-arc-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   rr-nom-arc             .
       acc-nom-arc-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Test su : Nome archivio                         *
      *              *-------------------------------------------------*
           if        rr-nom-arc           not  = spaces
                     go to tdo-ric-sel-800.
           move      "Manca il nome archivio da riparare !              
      ...
      *              *-------------------------------------------------*
           perform   exe-reb-arc-000      thru exe-reb-arc-999        .
       prn-fin-cic-999.
           exit.
      ...
      *    *===========================================================*
      *    * Esecuzione riparazione archivio                           *
      *    *-----------------------------------------------------------*
       exe-reb-arc-000.
      *              *-------------------------------------------------*
      *              * Salvataggio immagine video                      *
      ...
      *                  *---------------------------------------------*
           ...
           move      "/abd/run/vutil -rebuild /abd/azi/"
                                          to   w-all-str-cat (1)      .
           move      s-azi                to   w-all-str-cat (2)      .
           move      "/"                  to   w-all-str-cat (3)      .
           move      rr-nom-arc           to   w-all-str-cat (4)      .
