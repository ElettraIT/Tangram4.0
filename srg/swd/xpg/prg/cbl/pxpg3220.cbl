      ...
      *                       Ultima revisione:    NdK del 20/07/99    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa Menu'                                *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
               10  srt-des-cmd            pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Menu' di rientro                                  *
      *            *---------------------------------------------------*
               10  srt-mnu-rie            pic  x(06)                  .
      *            *---------------------------------------------------*
      *            * Password per il comando                           *
      *            *---------------------------------------------------*
               10  srt-pwd-cmd            pic  x(08)                  .
      *            *---------------------------------------------------*
      *            * Tipo di utente che puo' operare il comando        *
      *            *---------------------------------------------------*
               10  srt-tip-ute            pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Livello di protezione del comando                 *
      *            *---------------------------------------------------*
               10  srt-liv-pro            pic  9(06)                  .
      *            *---------------------------------------------------*
      *            * Status comando                                    *
      *            *---------------------------------------------------*
               10  srt-sts-cmd            pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Numero di pagine di cui e' composto il menu'          *
      *        *-------------------------------------------------------*
           05  w-det-num-pdm              pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Tabella pagine di menu'                               *
      *        *-------------------------------------------------------*
           05  w-det-tbl-pdm.
      *            *---------------------------------------------------*
      *            * Singola pagina di menu'                           *
      *            *---------------------------------------------------*
               10  w-det-ele-pdm occurs 10.
      *                *-----------------------------------------------*
      *                * Numero pagina                                 *
      *                *-----------------------------------------------*
                   15  w-det-nrp-pag      pic  9(02)                  .
      *                *-----------------------------------------------*
      *                * Immagine pagina                               *
      *                *-----------------------------------------------*
                   15  w-det-imm-pag.
      ...
      *        * Indici di comodo                                      *
      *        *-------------------------------------------------------*
           05  w-det-inx-001              pic  9(02)                  .
           05  w-det-inx-002              pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Work per literal pagina                               *
      *        *-------------------------------------------------------*
           05  w-det-lit-pag.
               10  w-det-lit-pag-pap      pic  x(01)                  .
               10  w-det-lit-pag-ltp      pic  x(06)                  .
               10  filler                 pic  x(01)                  .
               10  w-det-lit-pag-npg      pic  9(01)                  .
               10  filler                 pic  x(01)                  .
               10  w-det-lit-pag-ltd      pic  x(02)                  .
               10  filler                 pic  x(01)                  .
               10  w-det-lit-pag-npt      pic  9(01)                  .
               10  w-det-lit-pag-pac      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Work per literal titolo pacchetto applicativo         *
      *        *-------------------------------------------------------*
           05  w-det-lit-pac.
      *            *---------------------------------------------------*
      *            * Titolo del pacchetto applicativo                  *
      *            *---------------------------------------------------*
               10  w-det-lit-pac-nps      pic  x(16)                  .
      *            *---------------------------------------------------*
      *            * Indici, contatori, puntatori di comodo            *
      *            *---------------------------------------------------*
               10  w-det-lit-pac-c01      pic  9(02)                  .
               10  w-det-lit-pac-c02      pic  9(02)                  .
               10  w-det-lit-pac-pnt      pic  9(02)                  .
      ...
      *                      *-----------------------------------------*
       ...
       acc-tip-stp-650.
      *                  *---------------------------------------------*
      *                  * Se stampa di solo alcuni si normalizza e si *
      *                  * si visualizza :                             *
      *                  *                                             *
      *                  * - Codice del menu'                          *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       acc-tip-stp-675.
      *                  *---------------------------------------------*
      *                  * Se stampa di un solo menu' si normalizzano  *
      *                  * e si visualizzano :                         *
      *                  * sualizzano :                                *
      *                  *                                             *
      *                  * - Sistema applicativo                       *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Menu' da stampare                       *
      *    *-----------------------------------------------------------*
       vis-tip-stp-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice del menu'                        *
      *    *-----------------------------------------------------------*
       vis-cod-mnu-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-010.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo di menu' da stam- *
      *              * pare                                            *
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    01
           ...
           move      "Manca la scelta sui menu' da stampare !           
      ...
      *              *-------------------------------------------------*
       tdo-ric-sel-305.
      *                  *---------------------------------------------*
      *                  * Test sul codice menu'                       *
      *                  *---------------------------------------------*
           if        rr-cod-mnu           not  = spaces
                     go to tdo-ric-sel-310.
           move      "Manca il codice del menu' !                       
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
           go to     tdo-ric-sel-999.
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-350.
      *              *-------------------------------------------------*
      *              * Test max per richiesta di singolo menu'         *
      *              *-------------------------------------------------*
           if        rr-tip-stp           not  = 03
                     go to stp-srt-inp-400.
           if        rr-cod-mnu           =    spaces
                     go to stp-srt-inp-400.
           if        w-cmd-cod-cmd        not  = rr-cod-mnu
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-410.
      *                  *---------------------------------------------*
      *                  * Se non si tratta di un menu' : selezione    *
      *                  * non superata                                *
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-420.
      *                  *---------------------------------------------*
      *                  * Se tutti i menu' da stampare : selezione    *
      *                  * superata                                    *
      *                  *---------------------------------------------*
           if        rr-tip-stp           =    01
      ...
      *                  * Dati                                        *
      *                  *---------------------------------------------*
           move      w-cmd-des-cmd        to   srt-des-cmd            .
           move      w-cmd-mnu-rie        to   srt-mnu-rie            .
           move      w-cmd-pwd-cmd        to   srt-pwd-cmd            .
           move      w-cmd-tip-ute        to   srt-tip-ute            .
           move      w-cmd-liv-pro        to   srt-liv-pro            .
           move      w-cmd-sts-cmd        to   srt-sts-cmd            .
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun menu' da stampare entro i limiti assegnati 
      -              "!"                  to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Determinazione pagine del menu'                 *
      *              *-------------------------------------------------*
       prn-sel-rec-150.
      *                  *---------------------------------------------*
      *                  * Numero di pagine di cui e' composto il menu'*
      *                  * a zero                                      *
      *                  *---------------------------------------------*
           move      zero                 to   w-det-num-pdm          .
       prn-sel-rec-200.
      *                  *---------------------------------------------*
      *                  * Start su [auc] per il menu', se errore : a  *
      *                  * considerazioni finali                       *
      *                  *---------------------------------------------*
           move      "mnu "               to   auc-tre                .
           move      srt-cod-cmd          to   auc-kre                .
           start     auc    key not less
                            auc-key
                            invalid key
       ...
       prn-sel-rec-250.
      *                  *---------------------------------------------*
      *                  * Next su menu' di [auc], se fine : a consi-  *
      *                  * derazioni finali                            *
      *                  *---------------------------------------------*
           read      auc  next with no lock
                               at end
       ...
       prn-sel-rec-300.
      *                  *---------------------------------------------*
      *                  * Test max su comandi di [auc], se non supe-  *
      *                  * rato : a considerazioni finali              *
      *                  *---------------------------------------------*
           if        auc-tre              not  = "mnu "
                     go to prn-sel-rec-800.
       prn-sel-rec-350.
      ...
      *                  *---------------------------------------------*
       ...
       prn-sel-rec-400.
      *                  *---------------------------------------------*
      *                  * Se non si tratta piu' del menu' in esame  : *
      *                  * a considerazioni finali                     *
      *                  *---------------------------------------------*
           if        w-mnu-cod-mnu        not  = srt-cod-cmd
                     go to prn-sel-rec-800.
       prn-sel-rec-450.
      *                  *---------------------------------------------*
      *                  * Incremento il numero di pagine di cui e'    *
      *                  * composto il menu'                           *
      *                  *---------------------------------------------*
           add       1                    to   w-det-num-pdm          .
       prn-sel-rec-500.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione numero pagina nel menu'     *
      *                  *---------------------------------------------*
           move      w-mnu-npg-mnu        to   w-det-nrp-pag
                                              (w-det-num-pdm)         .
       prn-sel-rec-550.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione immagine pagina di menu'    *
      *                  *---------------------------------------------*
           move      zero                 to   w-det-inx-002          .
       prn-sel-rec-555.
           add       1                    to   w-det-inx-002          .
           if        w-det-inx-002        >    18
                     go to prn-sel-rec-600.
           move      w-mnu-lin-mnu
                    (w-det-inx-002)       to   w-det-lin-pag
                                              (w-det-num-pdm,
                                               w-det-inx-002)         .
           go to     prn-sel-rec-555.
       prn-sel-rec-600.
      *                  *---------------------------------------------*
      *                  * Test se raggiunto il massimo numero di pa-  *
      *                  * gine bufferizzabili                         *
      *                  *---------------------------------------------*
           if        w-det-num-pdm        =    10
                     go to prn-sel-rec-800
           else      go to prn-sel-rec-250.
       prn-sel-rec-800.
      *              *-------------------------------------------------*
      *              * Considerazioni finali                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se non e' stata bufferizzata nessuna pagina *
      *                  * di menu' : selezione non superata           *
      *                  *---------------------------------------------*
           if        w-det-num-pdm        =    zero
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-050.
      *              *-------------------------------------------------*
      *              * Inizializzazione contatore su pagine menu'      *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-inx-001          .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Incremento contatore su pagine menu'            *
      *              *-------------------------------------------------*
           add       1                    to   w-det-inx-001          .
      *              *-------------------------------------------------*
      *              * Se oltre il massimo : uscita                    *
      *              *-------------------------------------------------*
           if        w-det-inx-001        >    w-det-num-pdm
                     go to prn-liv-det-999.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Stampa pagina di menu'                          *
      *              *-------------------------------------------------*
       prn-liv-det-225.
      *                  *---------------------------------------------*
      *                  * Intestazione foglio                         *
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-300.
      *                  *---------------------------------------------*
      *                  * Lineette centrali di separazione            *
      *                  *---------------------------------------------*
           move      "VP"                 to   p-ope                  .
           add       1
                     p-lnr              giving p-lin                  .
      ...
      *
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      srt-cod-cmd          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *
           move      spaces               to   w-det-lit-pac-nps      .
           move      zero                 to   w-det-lit-pac-c01      .
           inspect   a-pac-rel        tallying w-det-lit-pac-c01
                                  for trailing spaces                 .
           move      1                    to   w-det-lit-pac-pnt      .
           add       w-det-lit-pac-c01    to   w-det-lit-pac-pnt      .
           move      16                   to   w-det-lit-pac-c02      .
           subtract  w-det-lit-pac-c01    from w-det-lit-pac-c02      .
           move      a-pac-rel
                    (1 : w-det-lit-pac-c02)
                                          to   w-det-lit-pac-nps
                                              (w-det-lit-pac-pnt :
                                               w-det-lit-pac-c02)     .
      *
           move      "PF"                 to   p-ope                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      065                  to   p-pos                  .
           move      w-det-lit-pac-nps    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-475.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       prn-liv-det-525.
      *                          *-------------------------------------*
      *                          * Inizializzazione contatore 01..18   *
      *                          *-------------------------------------*
           move      zero                 to   w-det-inx-002          .
       prn-liv-det-550.
      *                          *-------------------------------------*
      *                          * Incremento contatore 01..18         *
      *                          *-------------------------------------*
           add       1                    to   w-det-inx-002          .
      *                          *-------------------------------------*
      ...
      *
           move      spaces               to   w-det-lit-pag          .
           move      "["                  to   w-det-lit-pag-pap      .
           move      "Pagina"             to   w-det-lit-pag-ltp      .
           move      w-det-nrp-pag
                    (w-det-inx-001)       to   w-det-lit-pag-npg      .
           move      "di"                 to   w-det-lit-pag-ltd      .
           move      w-det-num-pdm        to   w-det-lit-pag-npt      .
           move      "]"                  to   w-det-lit-pag-pac      .
      *
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      15                   to   p-car                  .
      ...
      *
       ...
       prn-liv-det-750.
      *                  *---------------------------------------------*
      *                  * Se non e' la prima pagina di menu' che si   *
      *                  * stampa : non si stampano i titoli e si ri-  *
      *                  * cicla per la pagina di menu' successiva     *
      *                  *---------------------------------------------*
           if        w-det-inx-001        >    1
      ...
      *
           ...
           move      p-lnr                to   p-lin                  .
           move      038                  to   p-pos                  .
           if        srt-pwd-cmd          =    spaces
                     move  "No      "     to   p-alf
           else      move  "Si'     "     to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Tipo di utente che puo' operare il co-  *
      *                      * mando                                   *
      *                      *-----------------------------------------*
           move      "L+"                 to   p-ope                  .
           move      2                    to   p-lin                  .
      ...
      *
           ...
           if        srt-tip-ute          =    zero
                     move  "Tutti                                   "
                                          to   p-alf
           else      move  "Solo l'utente supervisore               "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Livello di protezione per il comando    *
      *                      *-----------------------------------------*
           move      "L+"                 to   p-ope                  .
           move      2                    to   p-lin                  .
           call      "swd/mod/prg/obj/mprint"
      ...
      *
           ...
           move      038                  to   p-pos                  .
           if        srt-sts-cmd          =    zero
                     move  "Menu' richiamabile                      "
                                          to   p-alf
           else      move  "Menu' bloccato                          "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-900.
      ...
      *
       ...
       prn-liv-det-950.
      *                  *---------------------------------------------*
      *                  * Riciclo per pagina di menu' successiva      *
      *                  *---------------------------------------------*
           go to     prn-liv-det-100.
       prn-liv-det-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "MENU'"              to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
