      ...
      *                       Ultima revisione:    NdK del 20/07/04    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase xpg901, nella sua globalita', esegue i tipi di opera-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * CTGOTO      Stampa di un programma sorgente Cobol, richieden-  *
      *             done il pathname completo, evidenziando errori di  *
      *             GO TO                                              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " UTILITIES VARIE SU PROGRAMMI SORGENTE  "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'xpg901'           *
      *              *-------------------------------------------------*
           perform   fas-xpg-901-000      thru fas-xpg-901-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *
           move      "Stampa programma sorgente con controllo dei GO TO 
      -              " CTGOTO     pxpg901a  "
                                          to   w-top-ele-wci          .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-xpg-901-300
           else if   v-key                =    "PRSC"
                     go to fas-xpg-901-400
           else if   v-key                =    "NXSC"
                     go to fas-xpg-901-450
           else if   v-key                =    "DOWN"
                     go to fas-xpg-901-500
           else if   v-key                =    "EXIT"
                     go to fas-xpg-901-250
           else      go to fas-xpg-901-200.
       fas-xpg-901-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-ope        =    zero
                     go to fas-xpg-901-330.
           move      zero                 to   w-top-ele-inx          .
       fas-xpg-901-322.
           add       1                    to   w-top-ele-inx          .
           if        w-top-ele-inx        >    w-top-ele-nes
                     go to fas-xpg-901-340.
           if        w-top-num-top
                    (w-top-ele-inx)       =    w-key-num-ope
                     go to fas-xpg-901-350
           else      go to fas-xpg-901-322.
       fas-xpg-901-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-xpg-901-630
           else if   v-key                =    "PRSC"
                     go to fas-xpg-901-600
           else if   v-key                =    "NXSC"
                     go to fas-xpg-901-610
           else if   v-key                =    "UP  "
                     go to fas-xpg-901-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-xpg-901-650
           else if   v-key                =    "EXIT"
                     go to fas-xpg-901-660
           else      go to fas-xpg-901-570.
       fas-xpg-901-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-xpg-901-626
           else      go to fas-xpg-901-628.
       fas-xpg-901-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-xpg-901-636
           else      go to fas-xpg-901-638.
       fas-xpg-901-636.
      *                          *-------------------------------------*
