      ...
      *================================================================*
      *                                                                *
      * Gestione catena mov per programma pxpg7800                     *
      *                                                                *
      * ============================================================== *
      * Tipi operazione                                                *
      *                                                                *
      ...
      *        * File name                                             *
      *        *-------------------------------------------------------*
           05  w-fil-nam                  pic  x(04) value "cat "     .
      *        *-------------------------------------------------------*
      *        * File pathname                                         *
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Cache memory per i primi 30 elementi                      *
      *    *-----------------------------------------------------------*
       01  w-chm.
      *        *-------------------------------------------------------*
      *        * Elementi                                              *
      *        *-------------------------------------------------------*
           05  w-chm-tbl occurs 30.
      *            *---------------------------------------------------*
      *            * Elemento                                          *
      *            *---------------------------------------------------*
               10  w-chm-ele.
