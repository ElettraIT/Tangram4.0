      ...
      *                       Ultima revisione:    NdK del 19/04/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento programmi da Internet         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   AGGIORNAMENTO PROGRAMMI DA E-MAIL    "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       dei programmi ricevuti per Posta Elettronic
      -              "a.                            "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           perform   exe-agg-int-000      thru exe-agg-int-999        .
       prn-fin-cic-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "cd /abd/ogt ; tar -xvf /abd/asc/agg/aggint.tar"
                                          to   o-shs                  .
      *              *-------------------------------------------------*
