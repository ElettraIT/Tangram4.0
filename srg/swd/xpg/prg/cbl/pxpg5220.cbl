      ...
      *                       Versione attuale:    NdK del 17/07/01    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa Referenze                            *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Referenze da stampare                                 *
      *        * - 01 : Tutte                                          *
      *        * - 02 : Solo le referenze non definite                 *
      *        * - 03 : Solo le referenze definite                     *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo referenze da stampare                 *
      *        *-------------------------------------------------------*
           05  w-exp-tip-stp.
               ...
               10  w-exp-tip-stp-tbl.
                   15  filler             pic  x(40) value
                            "Tutte                                   ".
                   15  filler             pic  x(40) value
                            "solo le referenze Non definite          ".
                   15  filler             pic  x(40) value
                            "solo le referenze Definite              ".
      ...
      *    *-----------------------------------------------------------*
       01  w-det-vlr.
      *        *-------------------------------------------------------*
      *        * Tipo, se referenza singola o multipla                 *
      *        * - S : Singola                                         *
      *        * - M : Multipla                                        *
      *        *-------------------------------------------------------*
           05  w-det-vlr-sng-mul          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Flag di referenza esistente                           *
      *        * - Spaces : Si                                         *
      *        * - #      : No                                         *
      *        *-------------------------------------------------------*
           05  w-det-vlr-flg-esi          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Numero progressivo, se referenza multipla ed esisten- *
      *        * te                                                    *
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Tipo referenza da stampare    *
      *    *-----------------------------------------------------------*
       pmt-tip-stp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Tipo referenze da stampare *
      *    *-----------------------------------------------------------*
       acc-tip-stp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Test su tipo referenze da stampare              *
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    01 or
                     rr-tip-stp           =    02 or
                     rr-tip-stp           =    03
           ...
           move      "ME"                 to   v-ope                  .
           move      "Manca il tipo referenza da stampare !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna referenza da stampare entro i limiti asseg
      -              "nati !"             to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [ref]              *
      *              *-------------------------------------------------*
           read      auc    next
                            with no lock
                            at end
      ...
      *              *                                                 *
      *              * N.B.: non essendo un campo esplicito della re-  *
      *              *       ferenza, viene dedotto dal pathname       *
      *              *-------------------------------------------------*
           if        rr-sis-app           =    spaces
                     go to prn-sel-rec-025.
           
           if        w-drf-cod-drf (1 : 3)
                                          not  = rr-sis-app
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-025.
      *              *-------------------------------------------------*
      *              * Memorizzazione se referenza singola o multipla  *
      *              *-------------------------------------------------*
           move      w-drf-som-drf        to   w-det-vlr-sng-mul      .
       prn-sel-rec-050.
      *              *-------------------------------------------------*
      *              * Determinazione se referenza esistente, e del    *
      *              * numero progressivo se multipla                  *
      *              *-------------------------------------------------*
       prn-sel-rec-100.
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda se referenza singola o *
      *                  *  multipla                                   *
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      ref-prg              to   w-det-vlr-num-prg      .
      *                          *-------------------------------------*
      *                          * Continuazione                       *
      *                          *-------------------------------------*
           go to     prn-sel-rec-200.
      ...
      *                      *-----------------------------------------*
           move      all   "-"            to   p-alf                  .
           move      w-drf-cod-drf        to   w-sav-sys-arc          .
      ...
      *                              *---------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      w-drf-car-drf        to   p-car                  .
           if        p-car                >    80
                     move  80             to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      020                  to   p-pos                  .
           move      ref-alf              to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *                              *---------------------------------*
           ...
           move      "N"                  to   p-tip                  .
           move      w-drf-car-drf        to   p-car                  .
           move      w-drf-dec-drf        to   p-dec                  .
           move      w-drf-sgn-drf        to   p-sgn                  .
           move      "9B"                 to   p-edm                  .
           move      p-lnr                to   p-lin                  .
           move      020                  to   p-pos                  .
           move      ref-num              to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           go to     prn-liv-det-400.
       prn-liv-det-322.
      ...
      *              * Area                                            *
      *              *-------------------------------------------------*
           move      w-drf-cod-drf        to   w-sav-sys-are          .
      *              *-------------------------------------------------*
      *              * Stampa dei records successivi al primo          *
      *              *-------------------------------------------------*
       prn-liv-det-420.
      *                  *---------------------------------------------*
      *                  * Se referenza singola : uscita               *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "REFERENZE"          to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
