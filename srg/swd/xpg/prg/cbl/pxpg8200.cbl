      ...
      *                                   Fase:    xpg820              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 15/01/06    *
      *                       Versione attuale:    NdK del 15/01/06    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Visualizzazioni di controllo copie (TAR)    *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase xpg820, nella sua globalita', esegue i tipi di opera-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * ERRTAR      Visualizzazione errori in fase di copia automatica *
      *                                                                *
      * OKFTAR      Visualizzazione elenco file copia automatica       *
      *                                                                *
      * OKSTAR      Stampa elenco file copia automatica                *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'xpg820'           *
      *              *-------------------------------------------------*
           perform   fas-xpg-820-000      thru fas-xpg-820-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *
           move      "Visualizzazione errori copie                      
      -              " ERRTAR     pxpg820a  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Visualizzazione elenco archivi copiati            
      -              " OKFTAR     pxpg820b  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Stampa elenco archivi copiati                     
      -              " OKSTAR     pxpg820c  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-top-200.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-xpg-820-300
           else if   v-key                =    "PRSC"
                     go to fas-xpg-820-400
           else if   v-key                =    "NXSC"
                     go to fas-xpg-820-450
           else if   v-key                =    "DOWN"
                     go to fas-xpg-820-500
           else if   v-key                =    "EXIT"
                     go to fas-xpg-820-250
           else      go to fas-xpg-820-200.
       fas-xpg-820-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-ope        =    zero
                     go to fas-xpg-820-330.
           move      zero                 to   w-top-ele-inx          .
       fas-xpg-820-322.
           add       1                    to   w-top-ele-inx          .
           if        w-top-ele-inx        >    w-top-ele-nes
                     go to fas-xpg-820-340.
           if        w-top-num-top
                    (w-top-ele-inx)       =    w-key-num-ope
                     go to fas-xpg-820-350
           else      go to fas-xpg-820-322.
       fas-xpg-820-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-xpg-820-630
           else if   v-key                =    "PRSC"
                     go to fas-xpg-820-600
           else if   v-key                =    "NXSC"
                     go to fas-xpg-820-610
           else if   v-key                =    "UP  "
                     go to fas-xpg-820-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-xpg-820-650
           else if   v-key                =    "EXIT"
                     go to fas-xpg-820-660
           else      go to fas-xpg-820-570.
       fas-xpg-820-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-xpg-820-626
           else      go to fas-xpg-820-628.
       fas-xpg-820-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-xpg-820-636
           else      go to fas-xpg-820-638.
       fas-xpg-820-636.
      *                          *-------------------------------------*
