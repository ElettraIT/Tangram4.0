      ...
      *                                   Fase:    xpg631              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 03/03/03    *
      *                       Ultima revisione:    NdK del 03/03/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su ultimi numeri pagina      *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           05  rr-sgl-min                 pic  x(06)                  .
           05  rr-sgl-max                 pic  x(06)                  .

      *    *===========================================================*
      *    * Work-area per ridefinizione contenuto del mark-point      *
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-sgl-fil              pic  x(06)                  .
           05  w-mpn-num-prg              pic  9(03)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-pre-exe-pgm      .
      *              *-------------------------------------------------*
      *              * Lettura della variabile di i.p.c. che determina *
      *              * la selezione sul codice automatico              *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   rr-sgl-min
           else      move  spaces         to   rr-sgl-min             .
      *              *-------------------------------------------------*
      *              * Regolarizzazione limiti di selezione            *
      *              *-------------------------------------------------*
           move      rr-sgl-min           to   rr-sgl-max             .
           move      rr-sgl-max           to   w-pad-zzz-alf          .
           perform   pad-alf-zzz-000      thru pad-alf-zzz-999        .
           move      w-pad-zzz-alf        to   rr-sgl-max             .
       pre-exe-pgm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "ylp "               to   enc-tre                .
           move      rr-sgl-min           to   enc-cod                .
           move      zero                 to   enc-prg                .
           start     enc   key not less
                           enc-rck
                           invalid key
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun numero pagina memorizzato !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      22                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      enc-cod              to   w-mpn-sgl-fil          .
           move      enc-prg              to   w-mpn-num-prg          .
           move      w-mpn                to   v-cnt                  .
           move      enc-cod              to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Separatore                                  *
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'enc-enc'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Richiamo programma di gestione codici auto- *
      *                  * matici                                      *
      *                  *---------------------------------------------*
           call      "swd/xpg/prg/obj/pxpg6300"                       .
           cancel    "swd/xpg/prg/obj/pxpg6300"                       .
       qry-trt-fun-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           string    "ULTIMI NUMERI PAGINA PER AZIENDA ["
                                delimited by   size
                     s-azi
                                delimited by   spaces
                     "]"
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "                  Fase/anno stampa     Ultimo nume
      -              "ro pagina                     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
