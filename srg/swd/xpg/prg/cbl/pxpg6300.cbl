      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " GESTIONE ULTIMI NUMERI PAGINA STAMPATI "       .
      ...
      *        * Sigla del file                                        *
      *        *-------------------------------------------------------*
           05  w-enc-sgl-fil              pic  x(06)                  .
      *        *-------------------------------------------------------*
      *        * Sigla del file                                        *
      *        *-------------------------------------------------------*
           05  w-enc-num-prg              pic  9(04)                  .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-clo-enc-sgl-fil      pic  x(06)                  .
      *            *---------------------------------------------------*
      *            * Progressivo per salvataggio                       *
      *            *---------------------------------------------------*
               10  w-clo-enc-num-prg      pic  9(03)                  .
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-fnd-enc-enc.
               ...
               10  w-fnd-enc-enc-mpn.
                   15  w-fnd-enc-enc-sgl  pic  x(06)                  .
                   15  w-fnd-enc-enc-saa  pic  9(03)                  .
      ...
      *              *-------------------------------------------------*
      *              * Bufferizzazione dati trovati                    *
      *              *-------------------------------------------------*
           move      w-fnd-enc-enc-sgl    to   w-enc-sgl-fil          .
           move      w-fnd-enc-enc-saa    to   w-enc-num-prg          .
      *              *-------------------------------------------------*
      *              * Visualizzazione dati trovati                    *
      *              *-------------------------------------------------*
           perform   vis-sgl-fil-000      thru vis-sgl-fil-999        .
           perform   vis-num-prg-000      thru vis-num-prg-999        .
           move      spaces               to   v-key                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Pre-trattamento progressivo                 *
      *                  *---------------------------------------------*
           if        w-enc-num-prg        >    zero and
                     w-enc-num-prg        <    1900
                     add  1900            to   w-enc-num-prg          .
       acc-num-prg-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pmt-ult-cod-000.
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Ultimo numero pagina stampato       :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ult-cod-999.
      ...
      *              * Pre-trattamento progressivo                     *
      *              *-------------------------------------------------*
           if        w-enc-num-prg        >    1900
                     subtract  1900       from w-enc-num-prg          .
      *              *-------------------------------------------------*
      *              * Lettura                                         *
      *              *-------------------------------------------------*
           move      "ylp "               to   enc-tre                .
           move      w-enc-sgl-fil        to   enc-cod                .
           move      w-enc-num-prg        to   enc-prg                .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-enc-num-prg        to   w-clo-enc-num-prg      .
           move      w-clo-enc-rec-enc    to   w-enc                  .
           move      w-clo-enc-sgl-fil    to   w-enc-sgl-fil          .
           move      w-clo-enc-num-prg    to   w-enc-num-prg          .
       pre-acc-ins-140.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           call      "swd/xpg/prg/obj/pxpg6310"                       .
           cancel    "swd/xpg/prg/obj/pxpg6310"                       .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        s-ves                not  = spaces
                     move  "#"            to   w-fnd-enc-enc-sel
                     go to fnd-enc-enc-999.
           move      s-num                to   w-fnd-enc-enc-saa      .
       fnd-enc-enc-999.
           exit.
