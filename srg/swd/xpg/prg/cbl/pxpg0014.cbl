      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-gio                to   w-def-gio-cal          .
           move      s-mes                to   w-def-mes-cal          .
           move      s-saa                to   w-def-saa-cal          .
      *
           move      w-def-saa-cal        to   w-def-saa-max          .
           add       010                  to   w-def-saa-max          .
      *
           move      w-def-saa-cal        to   w-def-saa-min          .
           subtract  010                  from w-def-saa-min          .
      *
           move      "GS"                 to   s-ope                  .
           move      01                   to   s-gio                  .
           move      w-def-mes-cal        to   s-mes                  .
           move      w-def-saa-cal        to   s-saa                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-num                to   w-def-gds-pgm          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      46                   to   v-pos                  .
           move      "Lun  Mar  Mer  Gio  Ven  Sab  Dom"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      *              * Giorni della settimana - sottolineatura         *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      33                   to   v-car                  .
