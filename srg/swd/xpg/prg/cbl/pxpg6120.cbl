      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa Numerazioni                          *
      *                                                                *
      *================================================================*
      ...
      *                * Parte fissa                                   *
      *                *-----------------------------------------------*
                   15  srt-key-fix        pic  x(08)                  .
      *                *-----------------------------------------------*
      *                * Parte variabile                               *
      *                *-----------------------------------------------*
                   15  srt-key-var        pic  x(10)                  .
      *                *-----------------------------------------------*
      *                * Numero segmento                               *
      *                *-----------------------------------------------*
                   15  srt-key-cnf        pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Area dati numerazione                             *
      *            *---------------------------------------------------*
               10  srt-dat-num            pic  x(80)                  .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Numerazioni da stampare                               *
      *        * - 01 : Tutte                                          *
      *        * - 02 : Solo una                                       *
      *        *-------------------------------------------------------*
           05  rr-tip-stp                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Parte fissa della chiave                              *
      *        *-------------------------------------------------------*
           05  rr-key-fix                 pic  x(08)                  .
      *        *-------------------------------------------------------*
      *        * Parte variabile della chiave                          *
      *        *-------------------------------------------------------*
           05  rr-key-var                 pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Numero segmento della chiave                          *
      *        *-------------------------------------------------------*
           05  rr-key-cnf                 pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Numerazioni da stampare                    *
      *        *-------------------------------------------------------*
           05  w-exp-tip-stp.
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-500.
      *                  *---------------------------------------------*
      *                  * Chiave, numero segmento                     *
      *                  *---------------------------------------------*
           perform   acc-key-cnf-000      thru acc-key-cnf-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      spaces               to   rr-key-fix             .
           move      spaces               to   rr-key-var             .
           move      zero                 to   rr-key-cnf             .
       nor-ric-sel-999.
           exit.
      ...
      *              * Chiave, titolo                                  *
      *              *-------------------------------------------------*
           perform   pmt-key-tit-000      thru pmt-key-tit-999        .
      *              *-------------------------------------------------*
      *              * Chiave, parte fissa                             *
      *              *-------------------------------------------------*
      ...
      *              * Chiave, numero segmento                         *
      *              *-------------------------------------------------*
           perform   pmt-key-cnf-000      thru pmt-key-cnf-999        .
       pmt-ric-sel-999.
           exit.

      *    *===========================================================*
      *    * Prompt : Numerazioni da stampare                          *
      *    *-----------------------------------------------------------*
       pmt-tip-stp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-key-tit-000.
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Identificazione numerazione "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-key-tit-999.
      ...
      *    *===========================================================*
      *    * Accettazione : Numerazioni da stampare                    *
      *    *-----------------------------------------------------------*
       acc-tip-stp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                      * Chiave, numero segmento                 *
      *                      *-----------------------------------------*
           move      spaces               to   rr-key-cnf             .
           perform   vis-key-cnf-000      thru vis-key-cnf-999        .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Numerazioni da stampare                 *
      *    *-----------------------------------------------------------*
       vis-tip-stp-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Chiave, parte fissa                        *
      *    *-----------------------------------------------------------*
       acc-key-fix-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Chiave, parte fissa                     *
      *    *-----------------------------------------------------------*
       vis-key-fix-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Chiave, parte variabile                    *
      *    *-----------------------------------------------------------*
       acc-key-var-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Chiave, parte variabile                 *
      *    *-----------------------------------------------------------*
       vis-key-var-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Chiave, numero segmento                    *
      *    *-----------------------------------------------------------*
       acc-key-cnf-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-key-cnf-100.
       acc-key-cnf-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Chiave, numero segmento                 *
      *    *-----------------------------------------------------------*
       vis-key-cnf-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           if        rr-tip-stp           =    02
                     move  rr-key-fix     to   rf-num-key-fix
                     move  rr-key-var     to   rf-num-key-var
                     move  rr-key-cnf     to   rf-num-key-cnf
           else      move  spaces         to   rf-num-key-fix
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Test max su parametri stampa di [pss], se non   *
      *              * superato : uscita                               *
      *              *-------------------------------------------------*
           if        rr-tip-stp           not  = 02
                     go to stp-srt-inp-300.
           if        rr-key-fix           =    spaces
                     go to stp-srt-inp-300.
           if        rf-num-key-fix       not  = rr-key-fix
                     go to stp-srt-inp-900.
           if        rr-key-var           =    spaces and
                     rr-key-cnf           =    zero
                     go to stp-srt-inp-300.
           if        rf-num-key-var       =    rr-key-var and
                     rf-num-key-cnf       =    rr-key-cnf
                     go to stp-srt-inp-300
      ...
      *                  * Chiave, parte fissa                         *
      *                  *---------------------------------------------*
           move      rf-num-key-fix       to   srt-key-fix            .
      *                  *---------------------------------------------*
      *                  * Chiave, parte variabile                     *
      *                  *---------------------------------------------*
           move      rf-num-key-var       to   srt-key-var            .
      *                  *---------------------------------------------*
      *                  * Chiave, numero segmento                     *
      *                  *---------------------------------------------*
           move      rf-num-key-cnf       to   srt-key-cnf            .
      *                  *---------------------------------------------*
      *                  * Dati                                        *
      *                  *---------------------------------------------*
           move      rf-num-dat-num       to   srt-dat-num            .
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna numerazione da stampare entro i limiti ass
      -              "egnati !"           to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      srt-key-fix          to   rf-num-key-fix         .
           move      srt-key-var          to   rf-num-key-var         .
           move      srt-key-cnf          to   rf-num-key-cnf         .
           move      srt-dat-num          to   rf-num-dat-num         .
       prn-let-seq-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      021                  to   p-pos                  .
           move      rf-num-key-cnf       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Dati, primi 56 caratteri                    *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      56                   to   p-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "                        123456789 123456789 123456
      -              "789 123456789 123456789 123456"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-600.
      ...
      *              *-------------------------------------------------*
           move      "NUMERAZIONI"        to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
