      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Export dati anagrafici geografici e banche  *
      *                                                                *
      *                   (/abd/ftx/fdb/xxx.txt)                       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  ESPORTAZIONE DATI GEOGRAFICI E BANCHE "       .
      ...
      *                  *---------------------------------------------*
       ...
       exe-exp-fil-500.
      *              *=================================================*
      *              * Esportazioni per [fdb]                          *
      *              *=================================================*
      *                  *---------------------------------------------*
      *                  * Esportazione [gxn]                          *
      *                  *---------------------------------------------*
           perform   exe-exp-gxn-000      thru exe-exp-gxn-999        .
      *                  *---------------------------------------------*
      *                  * Esportazione [gxr]                          *
      *                  *---------------------------------------------*
           perform   exe-exp-gxr-000      thru exe-exp-gxr-999        .
      *                  *---------------------------------------------*
      *                  * Esportazione [gxp]                          *
      *                  *---------------------------------------------*
           perform   exe-exp-gxp-000      thru exe-exp-gxp-999        .
      *                  *---------------------------------------------*
      *                  * Esportazione [gxc]                          *
      *                  *---------------------------------------------*
           perform   exe-exp-gxc-000      thru exe-exp-gxc-999        .
      *                  *---------------------------------------------*
      *                  * Esportazione [gxs]                          *
      *                  *---------------------------------------------*
           perform   exe-exp-gxs-000      thru exe-exp-gxs-999        .
      *                  *---------------------------------------------*
      *                  * Esportazione [axi]                          *
      *                  *---------------------------------------------*
           perform   exe-exp-axi-000      thru exe-exp-axi-999        .
      *                  *---------------------------------------------*
      *                  * Esportazione [axs]                          *
      *                  *---------------------------------------------*
           perform   exe-exp-axs-000      thru exe-exp-axs-999        .
       exe-exp-fil-600.
      *              *-------------------------------------------------*
      *              * Eventuali forzature se esecuzione batch         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "fdb "               to   f-xxx-are              .
           move      "gxn "               to   f-xxx-nam              .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        f-xxx-sts            not  = "S"
                     go to exe-exp-gxn-999.
      *              *-------------------------------------------------*
      *              * Eventuali forzature se esecuzione batch         *
      *              *-------------------------------------------------*
           if        w-exe-flg-btc        =    "S"
                     go to exe-exp-gxn-010.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-gxn-cod-naz       to   w-scr-str-ele          .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxn-des-naz       to   w-scr-str-ele          .
      ...
      *                  *---------------------------------------------*
           ...
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * Codice Stato Estero Agenzia Entrate         *
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxn-cod-ste       to   w-scr-str-ele          .
           move      03                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           ...
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * Si/no preferita (SQL) ELETTRA               *
      *                  *---------------------------------------------*
           move      "N "                 to   w-scr-str-tip          .
      *
           if        rf-gxn-cod-naz       =    "IT " or
                     rf-gxn-cod-naz       =    "MT " or
                     rf-gxn-cod-naz       =    "EL " or
                     rf-gxn-cod-naz       =    "US " or
                     rf-gxn-cod-naz       =    "HR " or
                     rf-gxn-cod-naz       =    "GB " or
                     rf-gxn-cod-naz       =    "DE " or
                     rf-gxn-cod-naz       =    "NG " or
                     rf-gxn-cod-naz       =    "KR " or
                     rf-gxn-cod-naz       =    "FR " or
                     rf-gxn-cod-naz       =    "CL " or
                     rf-gxn-cod-naz       =    "HU " or
                     rf-gxn-cod-naz       =    "SM " or
                     rf-gxn-cod-naz       =    "BH " or
                     rf-gxn-cod-naz       =    "AE "
                     move  "1"            to   w-scr-str-ele
           else      move  "0"            to   w-scr-str-ele          .
      *
      ...
      *              *-------------------------------------------------*
       ...
       exe-exp-gxn-750.
      *              *-------------------------------------------------*
      *              * Riciclo a Next su [gxn]                         *
      *              *-------------------------------------------------*
           go to     exe-exp-gxn-200.
       exe-exp-gxn-800.
      *              *-------------------------------------------------*
      *              * Close files                                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        f-xxx-sts            not  = "S"
                     go to exe-exp-gxr-999.
      *              *-------------------------------------------------*
      *              * Eventuali forzature se esecuzione batch         *
      *              *-------------------------------------------------*
           if        w-exe-flg-btc        =    "S"
                     go to exe-exp-gxr-010.
      *              *-------------------------------------------------*
      *              * Messaggio di programma in esecuzione            *
      *              *-------------------------------------------------*
           move      "PE"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxr-cod-rgn       to   w-scr-str-ele          .
           move      03                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxr-des-rgn       to   w-scr-str-ele          .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxr-cod-ist       to   w-scr-str-ele          .
           move      03                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           ...
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * Ordinamento logico commerciale              *
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      spaces               to   w-scr-str-ele          .
           move      01                   to   w-scr-lun-ele          .
      ...
      *              *-------------------------------------------------*
       ...
       exe-exp-gxr-750.
      *              *-------------------------------------------------*
      *              * Riciclo a Next su [gxr]                         *
      *              *-------------------------------------------------*
           go to     exe-exp-gxr-200.
       exe-exp-gxr-800.
      *              *-------------------------------------------------*
      *              * Close files                                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        f-xxx-sts            not  = "S"
                     go to exe-exp-gxp-999.
      *              *-------------------------------------------------*
      *              * Eventuali forzature se esecuzione batch         *
      *              *-------------------------------------------------*
           if        w-exe-flg-btc        =    "S"
                     go to exe-exp-gxp-010.
      *              *-------------------------------------------------*
      *              * Messaggio di programma in esecuzione            *
      *              *-------------------------------------------------*
           move      "PE"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxp-cod-prv       to   w-scr-str-ele          .
           move      03                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxp-des-prv       to   w-scr-str-ele          .
           move      30                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxp-cod-rgn       to   w-scr-str-ele          .
           move      03                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-gxp-snx-cpl       to   w-scr-str-ele          .
           move      01                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxp-cap-min       to   w-scr-str-ele          .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxp-cap-max       to   w-scr-str-ele          .
           move      05                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxp-cod-ist       to   w-scr-str-ele          .
           move      03                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *              *-------------------------------------------------*
       ...
       exe-exp-gxp-750.
      *              *-------------------------------------------------*
      *              * Riciclo a Next su [gxp]                         *
      *              *-------------------------------------------------*
           go to     exe-exp-gxp-200.
       exe-exp-gxp-800.
      *              *-------------------------------------------------*
      *              * Close files                                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        f-xxx-sts            not  = "S"
                     go to exe-exp-gxc-999.
      *              *-------------------------------------------------*
      *              * Eventuali forzature se esecuzione batch         *
      *              *-------------------------------------------------*
           if        w-exe-flg-btc        =    "S"
                     go to exe-exp-gxc-010.
      *              *-------------------------------------------------*
      *              * Messaggio di programma in esecuzione            *
      *              *-------------------------------------------------*
           move      "PE"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxc-des-cfl       to   w-scr-str-ele          .
           move      30                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxc-cod-prv       to   w-scr-str-ele          .
           move      03                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxc-sgl-std       to   w-scr-str-ele          .
           move      05                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxc-cap-avp       to   w-scr-str-ele          .
           move      05                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxc-pre-tel (1)   to   w-scr-str-ele          .
           move      05                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxc-pre-tel (2)   to   w-scr-str-ele          .
           move      05                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxc-cod-cts       to   w-scr-str-ele          .
           move      05                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *              *-------------------------------------------------*
       ...
       exe-exp-gxc-750.
      *              *-------------------------------------------------*
      *              * Riciclo a Next su [gxc]                         *
      *              *-------------------------------------------------*
           go to     exe-exp-gxc-200.
       exe-exp-gxc-800.
      *              *-------------------------------------------------*
      *              * Close files                                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        f-xxx-sts            not  = "S"
                     go to exe-exp-gxs-999.
      *              *-------------------------------------------------*
      *              * Eventuali forzature se esecuzione batch         *
      *              *-------------------------------------------------*
           if        w-exe-flg-btc        =    "S"
                     go to exe-exp-gxs-010.
      *              *-------------------------------------------------*
      *              * Messaggio di programma in esecuzione            *
      *              *-------------------------------------------------*
           move      "PE"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxs-sgl-std       to   w-scr-str-ele          .
           move      05                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxs-des-key       to   w-scr-str-ele          .
           move      35                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxs-spc-key       to   w-scr-str-ele          .
           move      35                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxs-des-str       to   w-scr-str-ele          .
           move      30                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-gxs-cap-avp       to   w-scr-str-ele          .
           move      05                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *              *-------------------------------------------------*
       ...
       exe-exp-gxs-750.
      *              *-------------------------------------------------*
      *              * Riciclo a Next su [gxs]                         *
      *              *-------------------------------------------------*
           go to     exe-exp-gxs-200.
       exe-exp-gxs-800.
      *              *-------------------------------------------------*
      *              * Close files                                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        f-xxx-sts            not  = "S"
                     go to exe-exp-axi-999.
      *              *-------------------------------------------------*
      *              * Eventuali forzature se esecuzione batch         *
      *              *-------------------------------------------------*
           if        w-exe-flg-btc        =    "S"
                     go to exe-exp-axi-010.
      *              *-------------------------------------------------*
      *              * Messaggio di programma in esecuzione            *
      *              *-------------------------------------------------*
           move      "PE"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-axi-cod-mne       to   w-scr-str-ele          .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-axi-den-abi       to   w-scr-str-ele          .
      ...
      *                  *---------------------------------------------*
           ...
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * Denominazione per la ricerca                *
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-axi-den-ric       to   w-scr-str-ele          .
           move      30                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-axi-cod-bic       to   w-scr-str-ele          .
           move      10                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *              *-------------------------------------------------*
       ...
       exe-exp-axi-750.
      *              *-------------------------------------------------*
      *              * Riciclo a Next su [axi]                         *
      *              *-------------------------------------------------*
           go to     exe-exp-axi-200.
       exe-exp-axi-800.
      *              *-------------------------------------------------*
      *              * Close files                                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        f-xxx-sts            not  = "S"
                     go to exe-exp-axs-999.
      *              *-------------------------------------------------*
      *              * Eventuali forzature se esecuzione batch         *
      *              *-------------------------------------------------*
           if        w-exe-flg-btc        =    "S"
                     go to exe-exp-axs-010.
      *              *-------------------------------------------------*
      *              * Messaggio di programma in esecuzione            *
      *              *-------------------------------------------------*
           move      "PE"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-axs-den-spt       to   w-scr-str-ele          .
           move      40                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-axs-via-spt       to   w-scr-str-ele          .
           move      40                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-axs-loc-spt       to   w-scr-str-ele          .
           move      40                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-axs-den-ric       to   w-scr-str-ele          .
           move      40                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-axs-cod-mne       to   w-scr-str-ele          .
           move      10                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      rf-axs-cod-bic       to   w-scr-str-ele          .
           move      10                   to   w-scr-lun-ele          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      ...
      *              *-------------------------------------------------*
       ...
       exe-exp-axs-750.
      *              *-------------------------------------------------*
      *              * Riciclo a Next su [axs]                         *
      *              *-------------------------------------------------*
           go to     exe-exp-axs-200.
       exe-exp-axs-800.
      *              *-------------------------------------------------*
      *              * Close files                                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "| cat > /abd/asc/log/xpg720.log"
                                          to   w-all-str-cat (5)      .
