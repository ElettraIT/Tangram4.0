      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su codici menu'              *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Codice menu' min, da i.p.c.                           *
      *        *-------------------------------------------------------*
           05  rr-cod-min                 pic  x(08)                  .
      *        *-------------------------------------------------------*
      *        * Codice menu' max, da i.p.c.                           *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-cod-mnu              pic  x(06)                  .
           05  w-mpn-npg-mnu              pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-ipc.
      *        *-------------------------------------------------------*
      *        * Variabile di i.p.c. 'cod-mnu' letta ad inizio pro-    *
      *        * gramma per determinare una eventuale limitazione ai   *
      *        * soli codici menu' con l'iniziale dichiarata           *
      *        *-------------------------------------------------------*
           05  w-ipc-cod-mnu              pic  x(06)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-pre-exe-pgm      .
      *              *-------------------------------------------------*
      *              * Lettura variabile di i.p.c. 'cod-mnu'           *
      *              *-------------------------------------------------*
      ...
      *              * Codice min                                      *
      *              *-------------------------------------------------*
           move      w-ipc-cod-mnu        to   rr-cod-min             .
      *              *-------------------------------------------------*
      *              * Codice max                                      *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun codice menu' memorizzato !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      14                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      w-mnu-cod-mnu        to   w-mpn-cod-mnu          .
           move      w-mnu-npg-mnu        to   w-mpn-npg-mnu          .
           move      w-mpn                to   v-cnt                  .
      ...
      *                  *---------------------------------------------*
       ...
       qry-liv-det-400.
      *                  *---------------------------------------------*
      *                  * Contenuto prima linea piena                 *
      *                  *                                             *
      *                  * Nota : Viene cercata la prima linea diversa *
      *                  *        da spaces, dopo aver preventivamente *
      *                  *        posto a spaces il carattere '*' alla *
      *                  *        posizione 80                         *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
       ...
       qry-liv-det-402.
           ...
           if        w-wrk-ctr-001        >    6
                     ...
                     go to qry-liv-det-403.
           move      w-mnu-lin-mnu
                    (w-wrk-ctr-001)       to   v-alf                  .
           if        v-alc (80)           =    "*"
                     move  spaces         to   v-alc (80)             .
           if        v-alf                =    spaces
                     go to qry-liv-det-402
           else      go to qry-liv-det-403.
       qry-liv-det-403.
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'auc-mnu'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *                  *---------------------------------------------*
           call      "swd/xpg/prg/obj/pxpg3200"                       .
           cancel    "swd/xpg/prg/obj/pxpg3200"                       .
       qry-trt-fun-999.
           exit.
      ...
      *    *===========================================================*
      *    * Lettura variabile di i.p.c. 'cod-mnu' per determinare i   *
      *    * caratteri iniziali del codice menu'                       *
      *    *-----------------------------------------------------------*
       ipc-dlp-cdm-000.
           move      "CV"                 to   s-ope                  .
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-ipc-cod-mnu
           else      move  spaces         to   w-ipc-cod-mnu          .
       ipc-dlp-cdm-999.
           exit.
