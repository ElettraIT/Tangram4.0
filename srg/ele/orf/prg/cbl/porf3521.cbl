      ...
      *                       Ultima revisione:    NdK del 13/11/98    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma orf352   *
      *                                                                *
      ...
      *            * Quantita' ricevuta                                *
      *            *---------------------------------------------------*
               10  srt-qta-ric            pic s9(06)v9(03)            .
      *            *---------------------------------------------------*
      *            * Quantita' residua                                 *
      *            *---------------------------------------------------*
               10  srt-qta-dri            pic s9(06)v9(03)            .
      *            *---------------------------------------------------*
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-ofr-cod-dpz       not  = rr-dpz-inu     or
                     rf-ofr-flg-rch       not  = spaces         or
                     rf-ofr-tip-mag       not  = 01             or
                     rf-ofr-num-mag       not  = rf-dcp-num-pro
                     go to stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Selezione sul record                            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su data consegna minima                *
      *                  *---------------------------------------------*
           if        rr-dcn-min           not  = zero and
                     rf-ofr-dcn-prv       <    rr-dcn-min
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Test su data consegna massima               *
      *                  *---------------------------------------------*
           if        rr-dcn-max           not  = zero and
                     rf-ofr-dcn-prv       >    rr-dcn-max
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rof-ogi-qta-ord    to   srt-qta-ord            .
           move      w-rof-ogi-qta-ric    to   srt-qta-ric            .
           move      w-rof-ogi-qta-dri    to   srt-qta-dri            .
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-150.
      *                  *---------------------------------------------*
      *                  * Eventuale intestazione ordine fornitore     *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      001                  to   p-pos                  .
           move      "                          ITEM                    
      -              "           ORDER      CONFIRM N.  Q. ORDERED   Q. 
      -              "RECEIVED  Q.REMAINING SCHEDULED "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
