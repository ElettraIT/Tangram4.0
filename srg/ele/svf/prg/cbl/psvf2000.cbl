      ...
      *                       Ultima revisione:    NdK del 19/11/25    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf2001:        *
      *                                                                *
      ...
      *                                                                *
      *                    Accettazione 'Dipendenze raggruppate'       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  STATISTICA SUL FATTURATO PER CLIENTE  "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-ipc.
      *        *-------------------------------------------------------*
      *        * Per funzione di generazione file                      *
      *        *-------------------------------------------------------*
           05  w-ipc-gen-fil.
      *            *---------------------------------------------------*
      *            * Valore della variabile di i.p.c. relativa alla    *
      *            * richiesta di generazione file                     *
      *            *                                                   *
      *            * - S : Si, generazione file                        *
      *            * - N : No, nessuna azione                          *
      *            *---------------------------------------------------*
               10  w-ipc-gen-fil-snx      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Per funzione di generazione set                       *
      *        *-------------------------------------------------------*
           05  w-ipc-gen-set.
      *            *---------------------------------------------------*
      *            * Valore della variabile di i.p.c. relativa alla    *
      ...
      *            *                                                   *
      *            * - S : Si, generazione set                         *
      *            * - N : No, nessuna azione                          *
      *            *---------------------------------------------------*
               10  w-ipc-gen-set-snx      pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Raggruppamento dipendenze                             *
      *        *                                                       *
      *        * ELETTRA                                               *
      *        *-------------------------------------------------------*
           05  rr-snx-rdp                 pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Soglia di fatturato in milioni min                    *
      *        *-------------------------------------------------------*
           05  rr-sft-min                 pic  9(13)                  .
      *        *-------------------------------------------------------*
      *        * Soglia di fatturato in milioni max                    *
      *        *-------------------------------------------------------*
           05  rr-sft-max                 pic  9(13)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Si/no raggruppamento dipendenze            *
      *        *-------------------------------------------------------*
           05  w-exp-snx-rdp.
               10  w-exp-snx-rdp-num      pic  9(02)       value 02   .
               10  w-exp-snx-rdp-lun      pic  9(02)       value 02   .
               10  w-exp-snx-rdp-tbl.
           ...
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "con la Lista documenti emessi per ogni cliente    ".
                   15  filler             pic  x(50) value
                  "con i totali Mensili                              ".
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento clienti                   *
      *        *-------------------------------------------------------*
           05  w-exp-tor-cli.
               10  w-exp-tor-cli-num      pic  9(02)       value 5    .
      ...
      *        *-------------------------------------------------------*
      *        * Work per Det literal e tipo range per periodo         *
      *        *-------------------------------------------------------*
           05  w-det-lit-tpr.
      *            *---------------------------------------------------*
      *            * Data iniziale                                     *
      *            *---------------------------------------------------*
               10  w-det-lit-tpr-din.
                   15  w-det-lit-tpr-sin  pic  9(03)                  .
                   15  w-det-lit-tpr-min  pic  9(02)                  .
                   15  w-det-lit-tpr-gin  pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Data finale                                       *
      *            *---------------------------------------------------*
               10  w-det-lit-tpr-dfi.
                   15  w-det-lit-tpr-sfi  pic  9(03)                  .
                   15  w-det-lit-tpr-mfi  pic  9(02)                  .
                   15  w-det-lit-tpr-gfi  pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Valori in output                                  *
      *            *---------------------------------------------------*
               10  w-det-lit-tpr-lit      pic  x(16)                  .
               10  w-det-lit-tpr-tpr.
                   15  w-det-lit-tpr-rng  pic  x(01)                  .
                   15  w-det-lit-tpr-inx  pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Comodi                                            *
      *            *---------------------------------------------------*
               10  w-det-lit-tpr-msw      pic  9(02)                  .
               10  w-det-lit-tpr-lw1      pic  x(02)                  .
               10  w-det-lit-tpr-lw2      pic  x(10)                  .
               10  w-det-lit-tpr-lw3      pic  x(04)                  .
               10  w-det-lit-tpr-ct1      pic  9(02)                  .
      ...
      *              * generazione set                                 *
      *              *-------------------------------------------------*
           perform   ipc-gen-set-000      thru ipc-gen-set-999        .
      *              *-------------------------------------------------*
      *              * Si/no generazione set                           *
      *              *-------------------------------------------------*
           move      w-ipc-gen-set-snx    to   rr-gen-set             .
      *              *-------------------------------------------------*
      *              * Lettura della variabile eventuale di i.p.c. per *
      *              * generazione file                                *
      *              *-------------------------------------------------*
           perform   ipc-gen-fil-000      thru ipc-gen-fil-999        .
      *              *-------------------------------------------------*
      *              * Si/no generazione file                          *
      *              *-------------------------------------------------*
           move      w-ipc-gen-fil-snx    to   rr-gen-fil             .
      *              *-------------------------------------------------*
      *              * Lettura della variabile eventuale di i.p.c. per *
      *              * generazione grafico                             *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       ipc-gen-fil-000.
      *              *-------------------------------------------------*
      *              * Estrazione della variabile 'gen-fil' dal livel- *
      *              * lo precedente                                   *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
           move      "gen-fil"            to   s-var                  .
           move      "-"                  to   s-dop                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to ipc-gen-fil-200
           else      go to ipc-gen-fil-400.
       ipc-gen-fil-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      s-alf                to   w-ipc-gen-fil-snx      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione della variabile             *
      *                  *---------------------------------------------*
           if        w-ipc-gen-fil-snx    not  = "S"
                     move  "N"            to   w-ipc-gen-fil-snx      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ipc-gen-fil-999.
       ipc-gen-fil-400.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       ipc-gen-set-000.
      *              *-------------------------------------------------*
      *              * Estrazione della variabile 'gen-set' dal livel- *
      *              * lo precedente                                   *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
           move      "gen-set"            to   s-var                  .
           move      "-"                  to   s-dop                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to ipc-gen-set-200
           else      go to ipc-gen-set-400.
       ipc-gen-set-200.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
      ...
      *                  * Valore della variabile                      *
      *                  *---------------------------------------------*
           move      s-alf                to   w-ipc-gen-set-snx      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione della variabile             *
      *                  *---------------------------------------------*
           if        w-ipc-gen-set-snx    not  = "S"
                     move  "N"            to   w-ipc-gen-set-snx      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ipc-gen-set-999.
       ipc-gen-set-400.
      *              *-------------------------------------------------*
      *              * Se variabile non esistente                      *
      *              *-------------------------------------------------*
      ...
      *              * Si/No richiesta di selezione stampa             *
      *              *-------------------------------------------------*
           if        w-ipc-gen-set-snx     =    "S" or
                     w-ipc-gen-fil-snx     =    "S" or
                     w-ipc-gen-grf-snx     =    "S"
      ...
      *                  * Raggruppamento dipendenze                   *
      *                  *---------------------------------------------*
           perform   acc-snx-rdp-000      thru acc-snx-rdp-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-225.
      *                  *---------------------------------------------*
      *                  * Selezione su data di acquisizione - min     *
      *                  *---------------------------------------------*
           perform   acc-dac-min-000      thru acc-dac-min-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
       ...
       acc-ric-sel-250.
      *                  *---------------------------------------------*
      *                  * Selezione su data di acquisizione - max     *
      *                  *---------------------------------------------*
           perform   acc-dac-max-000      thru acc-dac-max-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Soglia di fatturato in milioni min          *
      *                  *---------------------------------------------*
           perform   acc-sft-min-000      thru acc-sft-min-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Soglia di fatturato in milioni max          *
      *                  *---------------------------------------------*
           perform   acc-sft-max-000      thru acc-sft-max-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * ELETTRA                                         *
      *              *-------------------------------------------------*
           perform   pmt-snx-rdp-000      thru pmt-snx-rdp-999        .
      *              *-------------------------------------------------*
      *              * Tipo di dettaglio di stampa                     *
      *              *-------------------------------------------------*
      ...
      *              * Selezione su data di acquisizione - min         *
      *              *-------------------------------------------------*
           perform   pmt-dac-min-000      thru pmt-dac-min-999        .
      *              *-------------------------------------------------*
      *              * Selezione su data di acquisizione - max         *
      *              *-------------------------------------------------*
           perform   pmt-dac-max-000      thru pmt-dac-max-999        .
      *              *-------------------------------------------------*
      *              * Numero periodi di riferimento                   *
      *              *-------------------------------------------------*
      ...
      *              * Soglia di fatturato in milioni min              *
      *              *-------------------------------------------------*
           perform   pmt-sft-min-000      thru pmt-sft-min-999        .
      *              *-------------------------------------------------*
      *              * Soglia di fatturato in milioni max              *
      *              *-------------------------------------------------*
           perform   pmt-sft-max-000      thru pmt-sft-max-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Prompt : Raggruppamento dipendenze                        *
      *    *-----------------------------------------------------------*
       pmt-snx-rdp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento per i clienti                *
      *    *-----------------------------------------------------------*
       pmt-tor-cli-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt : Selezione su data di acquisizione - min          *
      *    *-----------------------------------------------------------*
       pmt-dac-min-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt : Selezione su data di acquisizione - max          *
      *    *-----------------------------------------------------------*
       pmt-dac-max-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt : Soglia di fatturato in milioni min               *
      *    *-----------------------------------------------------------*
       pmt-sft-min-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-cod-cli           not  = zero
                     go to pmt-sft-min-900.
      *                  *---------------------------------------------*
      *                  * Test su tipo di dettaglio stampa            *
      *                  *---------------------------------------------*
           if        rr-tip-dts           not  = 01
                     go to pmt-sft-min-900.
      *                  *---------------------------------------------*
      *                  * Test su tipo di ordinamento per clienti     *
      *                  *---------------------------------------------*
           if        rr-tor-cli           not  = 01 and
                     rr-tor-cli           not  = 02
                     go to pmt-sft-min-900.
      *                  *---------------------------------------------*
      *                  * Test su periodi di riferimento              *
      *                  *---------------------------------------------*
           if        rr-num-pdr           not  = 01
                     go to pmt-sft-min-900.
       pmt-sft-min-200.
      *              *-------------------------------------------------*
      *              * Visualizzazione prompt                          *
      *              *-------------------------------------------------*
           ...
           move      21                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su fatturato  da :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     pmt-sft-min-999.
       pmt-sft-min-900.
      *              *-------------------------------------------------*
      *              * Visualizzazione prompt a spaces                 *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
      ...
      *    *===========================================================*
      *    * Prompt : Soglia di fatturato in milioni max               *
      *    *-----------------------------------------------------------*
       pmt-sft-max-000.
      *              *-------------------------------------------------*
      *              * Test se prompt da visualizzare                  *
      ...
      *                  *---------------------------------------------*
           if        rr-cod-cli           =    zero
                     ...
                     move  spaces         to   rr-cod-cli-loc
                                          ...
                                          to   rr-cod-cli-rag
                     move  w-let-arc-dcc-via
                                          to   rr-cod-cli-via
                     move  w-let-arc-dcc-loc
                                          to   rr-cod-cli-loc         .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           perform   vis-cod-cli-rvl-000  thru vis-cod-cli-rvl-999    .
       acc-cod-cli-420.
      *                  *---------------------------------------------*
      ...
      *                  * normalizza il tipo ordinamento clienti ed   *
      *                  * eventuali soglie sul fatturato              *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        rr-cod-cli           =    zero
                     go to acc-cod-cli-650.
      *                      *-----------------------------------------*
      *                      * Normalizzazione tipo ordinamento clien- *
      *                      * ti                                      *
      *                      *-----------------------------------------*
           move      zero                 to   rr-tor-cli             .
      *                      *-----------------------------------------*
      *                      * Visualizzazione tipo ordinamento clien- *
      *                      * ti                                      *
      *                      *-----------------------------------------*
           perform   vis-tor-cli-000      thru vis-tor-cli-999        .
      *                      *-----------------------------------------*
      *                      * Normalizzazione data acquisizione min e *
      *                      * max                                     *
      *                      *-----------------------------------------*
           move      zero                 to   rr-dac-min             .
           move      zero                 to   rr-dac-max             .
      *                      *-----------------------------------------*
      *                      * Visualizzazione data acquisizione min e *
      *                      * max                                     *
      *                      *-----------------------------------------*
           perform   vis-dac-min-000      thru vis-dac-min-999        .
           perform   vis-dac-max-000      thru vis-dac-max-999        .
      *                      *-----------------------------------------*
      *                      * Normalizzazione soglia min e max        *
      *                      *-----------------------------------------*
           move      zero                 to   rr-sft-min             .
           move      zero                 to   rr-sft-max             .
      *                      *-----------------------------------------*
      *                      * Prompt soglia min e max                 *
      *                      *-----------------------------------------*
           perform   pmt-sft-min-000      thru pmt-sft-min-999        .
           perform   pmt-sft-max-000      thru pmt-sft-max-999        .
      *                      *-----------------------------------------*
      *                      * Visualizzazione soglia min e max        *
      *                      *-----------------------------------------*
           perform   vis-sft-min-000      thru vis-sft-min-999        .
           perform   vis-sft-max-000      thru vis-sft-max-999        .
       acc-cod-cli-650.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Ragione sociale cliente completa        *
      *    *-----------------------------------------------------------*
       vis-cod-cli-rvl-000.
      *              *-------------------------------------------------*
      *              * Ragione sociale                                 *
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no raggruppamento dipendenze      *
      *    *                                                           *
      *    * ELETTRA                                                   *
      *    *-----------------------------------------------------------*
       acc-snx-rdp-000.
      ...
      *                  *---------------------------------------------*
           if        rr-cod-cli           =    zero
                     go to  acc-snx-rdp-100.
           if        w-det-snd-dcc-snx    =    "N"
                     move  "S"            to   rr-snx-rdp
                     go to  acc-snx-rdp-999.
           if        rr-snx-rdp           not  = spaces
                     go to  acc-snx-rdp-100.
           move      "S"                  to   rr-snx-rdp             .
       acc-snx-rdp-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-rdp-lun    to   v-car                  .
           move      w-exp-snx-rdp-num    to   v-ldt                  .
           move      "SN#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      08                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-rdp-tbl    to   v-txt                  .
      *
           if        rr-snx-rdp           =    "S"
                     move  01             to   v-num
           else if   rr-snx-rdp           =    "N"
                     move  02             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  "N"            to   rr-snx-rdp
           else      move  spaces         to   rr-snx-rdp             .
       acc-snx-rdp-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Si/no raggruppamento dipendenze   *
      *    *                                                           *
      *    * ELETTRA                                                   *
      *    *-----------------------------------------------------------*
       vis-snx-rdp-000.
      ...
      *                      *-----------------------------------------*
       ...
       acc-tip-dts-650.
      *                  *---------------------------------------------*
      *                  * Se la scelta implica il dettaglio di stampa *
      *                  * mensile si normalizzano e si visualizzano : *
      *                  *  - soglia min e max                         *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      ...
      *              *-------------------------------------------------*
       acc-tor-cli-650.
      *                  *---------------------------------------------*
      *                  * Se la scelta non e' di tipo ABC crescente o *
      *                  * decrescente si normalizzano e si visualiz-  *
      *                  * zano :                                      *
      *                  *  - soglia min e max                         *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Selezione su data di acquisizione - min    *
      *    *-----------------------------------------------------------*
       acc-dac-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se selezionato un solo cliente non si   *
      *                      * accetta il campo                        *
      *                      *-----------------------------------------*
           if        rr-cod-cli           not  = zero
                     go to acc-dac-min-999.
       acc-dac-min-100.
      *              *-------------------------------------------------*
      *              * Note operative                                  *
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Il programma si basa sulla data di acquisizione in
      -              " anagrafica commerciale del   "
                                          to   v-nt1                  .
           move      "cliente."           to   v-nt2                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-dac-min-100.
       acc-dac-min-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Selezione su data di acquisizione - min *
      *    *-----------------------------------------------------------*
       vis-dac-min-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Selezione su data di acquisizione - max    *
      *    *-----------------------------------------------------------*
       acc-dac-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-dac-max-100.
       acc-dac-max-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Selezione su data di acquisizione - max *
      *    *-----------------------------------------------------------*
       vis-dac-max-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *                      *-----------------------------------------*
       ...
       acc-num-pdr-675.
      *                  *---------------------------------------------*
      *                  * Normalizzazione soglie min-max, se neces-   *
      *                  * sario                                       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test su periodi di riferimento          *
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Una data di inizio anno seguita dal tasto 'Selezio
      -              "ne' prepara automaticamente"
                                          to   v-nt1                  .
           move      "la data della fine anno corrispondente"
                                          to   v-nt2                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        v-key                not  = "SLCT"
                     go to acc-p1d-min-400.
      *                  *---------------------------------------------*
      *                  * Rispetto alla data impostata si calcola il  *
      *                  * fine anno e si pone come default per la     *
      *                  * massima                                     *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test preliminari                        *
      *                      *-----------------------------------------*
           ...
           if        rr-p1d-max           not  = zero
                     go to acc-p1d-min-400.
      *                      *-----------------------------------------*
      *                      * Precablaggio data massima               *
      *                      *-----------------------------------------*
           move      rr-p1d-min           to   s-dat                  .
           move      12                   to   s-mes                  .
           move      31                   to   s-gio                  .
           move      s-dat                to   rr-p1d-max             .
      *                      *-----------------------------------------*
      *                      * Visualizzazione data massima            *
      *                      *-----------------------------------------*
           perform   vis-p1d-max-000      thru vis-p1d-max-999        .
       acc-p1d-min-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        v-key                not  = "SLCT"
                     go to acc-p1d-max-400.
      *                  *---------------------------------------------*
      *                  * Rispetto alla data impostata si calcola     *
      *                  * l'inizio anno successivo e si pone come     *
      *                  * default per la minima del periodo successi- *
      *                  * vo                                          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test preliminari                        *
      *                      *-----------------------------------------*
           ...
           if        rr-p2d-min           not  = zero
                     go to acc-p1d-max-400.
      *                      *-----------------------------------------*
      *                      * Precablaggio data minima 2. periodo     *
      *                      *-----------------------------------------*
           move      rr-p1d-max           to   s-dat                  .
           move      01                   to   s-mes                  .
           move      01                   to   s-gio                  .
           add       01                   to   s-saa                  .
           move      s-dat                to   rr-p2d-min             .
      *                      *-----------------------------------------*
      *                      * Visualizzazione data minima 2. periodo  *
      *                      *-----------------------------------------*
           perform   vis-p2d-min-000      thru vis-p2d-min-999        .
       acc-p1d-max-400.
      *              *-------------------------------------------------*
      ...
      *                      * Precablaggio data massima               *
      *                      *-----------------------------------------*
           move      rr-p2d-min           to   s-dat                  .
           move      12                   to   s-mes                  .
           move      31                   to   s-gio                  .
           move      s-dat                to   rr-p2d-max             .
      *                      *-----------------------------------------*
      *                      * Visualizzazione data massima            *
      *                      *-----------------------------------------*
           perform   vis-p2d-max-000      thru vis-p2d-max-999        .
      ...
      *                      *-----------------------------------------*
           ...
           if        rr-p3d-min           not  = zero
                     go to acc-p2d-max-400.
      *                      *-----------------------------------------*
      *                      * Precablaggio data minima 3. periodo     *
      *                      *-----------------------------------------*
           move      rr-p2d-max           to   s-dat                  .
           move      01                   to   s-mes                  .
           move      01                   to   s-gio                  .
           add       01                   to   s-saa                  .
           move      s-dat                to   rr-p3d-min             .
      *                      *-----------------------------------------*
      *                      * Visualizzazione data minima 3. periodo  *
      *                      *-----------------------------------------*
           perform   vis-p3d-min-000      thru vis-p3d-min-999        .
       acc-p2d-max-400.
      *              *-------------------------------------------------*
      ...
      *                      * Precablaggio data massima               *
      *                      *-----------------------------------------*
           move      rr-p3d-min           to   s-dat                  .
           move      12                   to   s-mes                  .
           move      31                   to   s-gio                  .
           move      s-dat                to   rr-p3d-max             .
      *                      *-----------------------------------------*
      *                      * Visualizzazione data massima            *
      *                      *-----------------------------------------*
           perform   vis-p3d-max-000      thru vis-p3d-max-999        .
      ...
      *    *===========================================================*
      *    * Accettazione : Soglia di fatturato in milioni min         *
      *    *-----------------------------------------------------------*
       acc-sft-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-sft-min-100.
       acc-sft-min-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Soglia di fatturato in milioni min      *
      *    *-----------------------------------------------------------*
       vis-sft-min-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Soglia di fatturato in milioni max         *
      *    *-----------------------------------------------------------*
       acc-sft-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-sft-max-100.
       acc-sft-max-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Soglia di fatturato in milioni max      *
      *    *-----------------------------------------------------------*
       vis-sft-max-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-102.
           if        rr-tor-cli           =    01 or
                     ...
                     rr-tor-cli           =    05
                     go to tdo-ric-sel-300.
           move      "Tipo di ordinamento per i clienti errato !        
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "ta iniziale !  "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-450.
      *              *-------------------------------------------------*
      *              * Controllo : 1. periodo di riferimento, tipo     *
      *              *                range e literal                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Determinazione                              *
      *                  *---------------------------------------------*
           move      rr-p1d-min           to   w-det-lit-tpr-din      .
           move      rr-p1d-max           to   w-det-lit-tpr-dfi      .
           perform   det-lit-tpr-000      thru det-lit-tpr-999        .
           move      w-det-lit-tpr-tpr    to   rr-p1d-tpr             .
           move      w-det-lit-tpr-lit    to   rr-p1d-lit             .
      *                  *---------------------------------------------*
      *                  * Eventuali controlli se Totali mensili       *
      *                  *---------------------------------------------*
           if        rr-tip-dts           not  = 03
                     go to tdo-ric-sel-475.
           if        rr-p1d-tpr-rng       not  = spaces
                     go to tdo-ric-sel-475.
           move      "Il 1. periodo di riferim. deve essere un anno o un
      -              "a sua frazione "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-475.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "ta iniziale !  "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-550.
      *              *-------------------------------------------------*
      *              * Controllo : 2. periodo di riferimento, tipo     *
      *              *                range e literal                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Determinazione                              *
      *                  *---------------------------------------------*
           move      rr-p2d-min           to   w-det-lit-tpr-din      .
           move      rr-p2d-max           to   w-det-lit-tpr-dfi      .
           perform   det-lit-tpr-000      thru det-lit-tpr-999        .
           move      w-det-lit-tpr-tpr    to   rr-p2d-tpr             .
           move      w-det-lit-tpr-lit    to   rr-p2d-lit             .
      *                  *---------------------------------------------*
      *                  * Eventuali controlli                         *
      *                  *---------------------------------------------*
           if        rr-tip-dts           not  = 03
                     go to tdo-ric-sel-575.
           if        rr-p2d-tpr-rng       not  = spaces
                     go to tdo-ric-sel-565.
           move      "Il 2. periodo di riferim. deve essere un anno o un
      -              "a sua frazione "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-565.
           if        rr-p1d-tpr           =    rr-p2d-tpr
                     go to tdo-ric-sel-575.
           move      "Il confronto ha senso solo tra periodi di tipo ugu
      ...
      *              *-------------------------------------------------*
      ...
      -              "ta iniziale !  "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-650.
      *              *-------------------------------------------------*
      *              * Controllo : 3. periodo di riferimento, tipo     *
      *              *                range e literal                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Determinazione                              *
      *                  *---------------------------------------------*
           move      rr-p3d-min           to   w-det-lit-tpr-din      .
           move      rr-p3d-max           to   w-det-lit-tpr-dfi      .
           perform   det-lit-tpr-000      thru det-lit-tpr-999        .
           move      w-det-lit-tpr-tpr    to   rr-p3d-tpr             .
           move      w-det-lit-tpr-lit    to   rr-p3d-lit             .
      *                  *---------------------------------------------*
      *                  * Eventuali controlli                         *
      *                  *---------------------------------------------*
           if        rr-tip-dts           not  = 03
                     go to tdo-ric-sel-675.
           if        rr-p3d-tpr-rng       not  = spaces
                     go to tdo-ric-sel-665.
           move      "Il 3. periodo di riferim. deve essere un anno o un
      -              "a sua frazione "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-665.
           if        rr-p2d-tpr           =    rr-p3d-tpr
                     go to tdo-ric-sel-675.
           move      "Il confronto ha senso solo tra periodi di tipo ugu
      -              "ale !          "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
      ...
      *              *-------------------------------------------------*
      ...
      -              " 2. periodo !  "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-750.
      *              *-------------------------------------------------*
      *              * Controllo su soglia min e max                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se campi da controllare                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test su codice cliente                  *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-sft-max           =    zero
                     go to tdo-ric-sel-800.
           if        rr-sft-max           not  < rr-sft-min
                     go to tdo-ric-sel-800.
           move      "La selezione massima non puo' essere inferiore all
      ...
      *              * Soglia min e max                                *
      *              *-------------------------------------------------*
           if        rr-sft-min           =    zero and
                     rr-sft-max           =    zero
                     move   9999999999999 to   rr-sft-max
           else if   rr-sft-min           not  = zero and
                     rr-sft-max           =    zero
                     move  rr-sft-min     to   rr-sft-max             .
      *              *-------------------------------------------------*
      *              * Data acquisizione min - max                     *
      *              *-------------------------------------------------*
           if        rr-dac-max           not  = zero
                     go to reg-ric-sel-200.
           if        rr-dac-min           =    zero
                     move 9999999         to   rr-dac-max
           else      move rr-dac-min      to   rr-dac-max             .
       reg-ric-sel-200.
           if        rr-snx-rdp           not  = "N"
                     move  "S"            to   rr-snx-rdp             .
       reg-ric-sel-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   rr-p1d-tpr-rng         .
           move      zero                 to   rr-p1d-tpr-inx         .
           move      spaces               to   rr-p1d-lit             .
           move      zero                 to   rr-p2d-min             .
           move      zero                 to   rr-p2d-max             .
           move      spaces               to   rr-p2d-tpr-rng         .
           move      zero                 to   rr-p2d-tpr-inx         .
           move      spaces               to   rr-p2d-lit             .
           move      zero                 to   rr-p3d-min             .
           move      zero                 to   rr-p3d-max             .
           move      spaces               to   rr-p3d-tpr-rng         .
           move      zero                 to   rr-p3d-tpr-inx         .
           move      spaces               to   rr-p3d-lit             .
           move      zero                 to   rr-sft-min             .
           move      zero                 to   rr-sft-max             .
       nor-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Subroutine per determinazione literal periodo             *
      *    *-----------------------------------------------------------*
           copy      "pgm/svf/prg/cpy/psvflit0.cpy"                   .
