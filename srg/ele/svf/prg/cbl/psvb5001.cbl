      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvb5001:       *
      *                                                                *
      ...
      *                *-----------------------------------------------*
      *                * Codice prodotto, giacenza                     *
      *                *-----------------------------------------------*
                   15  srt-cod-pro-gia    pic s9(10)v9(03)            .
      *                *-----------------------------------------------*
      *                * Codice prodotto, costo ultimo                 *
      *                *-----------------------------------------------*
                   15  srt-cod-pro-cst    pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Codice cliente                                    *
      *            *---------------------------------------------------*
               10  srt-cod-cli.
      ...
      *        *-------------------------------------------------------*
      *        * Codice del prodotto da esporre in stampa              *
      *        *                                                       *
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-dcp.
               ...
               10  w-let-arc-dcp-tip      pic  9(02)     value zero   .
      ...
      *            * Giacenza                                          *
      *            *---------------------------------------------------*
               10  w-liv-pro-qta-gia      pic s9(10)v9(03)            .
      *            *---------------------------------------------------*
      *            * Costo ultimo                                      *
      *            *---------------------------------------------------*
               10  w-liv-pro-cst-ult      pic  9(11)                  .
      *            *---------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Work per selezione su record [bit] in esame               *
      *    *-----------------------------------------------------------*
       01  w-sel-bit.
      *        *-------------------------------------------------------*
      *        * Flag di uscita                                        *
      ...
      *        *-------------------------------------------------------*
           05  w-sel-bit-flg-exi          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Contatore di comodo su dipendenze selezionate         *
      *        *-------------------------------------------------------*
           05  w-sel-bit-ctr-dpz          pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Codice cliente                                        *
      *        *-------------------------------------------------------*
           05  w-sel-bit-cod-arc          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice dipendenza per il cliente                      *
      *        *-------------------------------------------------------*
           05  w-sel-bit-dpz-arc          pic  x(04)                  .
      *        *-------------------------------------------------------*
      *        * Mnemonico per il cliente                              *
      *        *-------------------------------------------------------*
           05  w-sel-bit-mne-cli          pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Ragione sociale per il cliente                        *
      *        *-------------------------------------------------------*
           05  w-sel-bit-rag-cli          pic  x(40)                  .

      *    *===========================================================*
      *    * Work per selezione su record [bir] in esame               *
      *    *-----------------------------------------------------------*
       01  w-sel-bir.
      *        *-------------------------------------------------------*
      *        * Flag di uscita                                        *
      ...
      *        *   - #      : Selezione non superata                   *
      *        *-------------------------------------------------------*
           05  w-sel-bir-flg-exi          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Codice prodotto numerico                              *
      *        *-------------------------------------------------------*
           05  w-sel-bir-num-pro          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice prodotto alfanumerico                          *
      *        *-------------------------------------------------------*
           05  w-sel-bir-alf-pro          pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione prodotto                                  *
      *        *-------------------------------------------------------*
           05  w-sel-bir-des-pro          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Unita' di misura di vendita per il prodotto           *
      *        *-------------------------------------------------------*
           05  w-sel-bir-umi-pro          pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Numero decimali quantita' per il prodotto             *
      *        *-------------------------------------------------------*
           05  w-sel-bir-dec-pro          pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Classe merceologica del prodotto                      *
      *        *-------------------------------------------------------*
           05  w-sel-bir-cla-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Gruppo merceologico del prodotto                      *
      *        *-------------------------------------------------------*
           05  w-sel-bir-gru-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Sottogruppo merceologico del prodotto                 *
      *        *-------------------------------------------------------*
           05  w-sel-bir-sgr-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Tipo di prodotto                                      *
      *        *-------------------------------------------------------*
           05  w-sel-bir-tip-pro          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Giacenza prodotto                                     *
      *        *-------------------------------------------------------*
           05  w-sel-bir-gia-pro          pic s9(10)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Costo unitario prodotto (Ultimo costo)                *
      *        *-------------------------------------------------------*
           05  w-sel-bir-cst-pro          pic  9(11)                  .
      ...
      *              *-------------------------------------------------*
           move      i-ide-fas            to   w-mod-fat-bir-fas      .
           perform   mod-fat-bir-opn-000  thru mod-fat-bir-opn-999    .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      i-ide-fas            to   w-mod-not-svb-fas      .
           move      rr                   to   w-mod-not-svb-war      .
           if        rr-num-pdr           =    11 or
                     rr-num-pdr           =    12 or
                     rr-num-pdr           =    21 or
                     rr-num-pdr           =    22
                     move  01             to   w-mod-not-svb-npr
           else      move  rr-num-pdr     to   w-mod-not-svb-npr      .
           perform   mod-not-svb-opn-000  thru mod-not-svb-opn-999    .
      *              *-------------------------------------------------*
      *              * [dcp]                                           *
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
      ...
      *              * fatturato da Righe Documenti                    *
      *              *-------------------------------------------------*
           perform   mod-fat-bir-cls-000  thru mod-fat-bir-cls-999    .
      *              *-------------------------------------------------*
      *              * Close modulo per la determinazione del valore   *
      *              * della voce 'Note' da esporre sulle statistiche  *
      *              * di vendita sul fatturato da Testate Documenti   *
      *              *-------------------------------------------------*
           perform   mod-not-svb-cls-000  thru mod-not-svb-cls-999    .
      *              *-------------------------------------------------*
      *              * [dcp]                                           *
      *              *-------------------------------------------------*
           move      "CL"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Lettura codice filtro selezione per determinare *
      *              * se la selezione si riferisce ad un prodotto     *
      *              *-------------------------------------------------*
      ...
      *                  * ra il record                                *
      *                  *---------------------------------------------*
           if        w-mod-fat-bir-pon    not  = "P" and
                     w-mod-fat-bir-pon    not  = "N"
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      ...
      *                  * cord                                        *
      *                  *---------------------------------------------*
           if        w-mod-fat-bir-sn1    not  = "S" and
                     w-mod-fat-bir-sn2    not  = "S" and
                     w-mod-fat-bir-sn3    not  = "S"
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Selezione sul record [bit] in esame         *
      *                  *---------------------------------------------*
      ...
      *                  * record                                      *
      *                  *---------------------------------------------*
           if        w-sel-bit-flg-exi    not  = spaces
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Selezione sul record [bir] in esame         *
      *                  *---------------------------------------------*
      ...
      *                  * record                                      *
      *                  *---------------------------------------------*
           if        w-sel-bir-flg-exi    not  = spaces
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       fil-fir-ing-000.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda se e' stato richiesto un   *
      *              * solo prodotto oppure tutti i prodotti           *
      *              *-------------------------------------------------*
           if        w-cod-zos-dcp-tco    =    1
                     perform fil-fir-ing-cds-000
                                          thru fil-fir-ing-cds-999
           else      perform fil-fir-ing-gts-000
                                          thru fil-fir-ing-gts-999    .
       fil-fir-ing-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       fil-fir-ing-cds-000.
      *              *-------------------------------------------------*
      *              * Richiamo funzione 'CS' del modulo 'mfatbir0'    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione                                *
      *                  *---------------------------------------------*
      ...
      *                      * Codice prodotto                         *
      *                      *-----------------------------------------*
           move      w-cod-zos-dcp-cco    to   w-mod-fat-bir-pro      .
      *                      *-----------------------------------------*
      *                      * Numero periodi di riferimento           *
      *                      *-----------------------------------------*
           if        rr-num-pdr           =    11 or
                     rr-num-pdr           =    12
                     move  02             to   w-mod-fat-bir-npr
           else if   rr-num-pdr           =    21 or
                     rr-num-pdr           =    22
                     move  01             to   w-mod-fat-bir-npr
           else      move  rr-num-pdr     to   w-mod-fat-bir-npr      .
      *                      *-----------------------------------------*
      *                      * Tipo calcolo voce 'Costo del Fatturato' *
      *                      *-----------------------------------------*
           if        rr-num-pdr           =    21
                     move  "P"            to   w-mod-fat-bir-ccf
           else if   rr-num-pdr           =    22
                     move  "U"            to   w-mod-fat-bir-ccf
           else      move  spaces         to   w-mod-fat-bir-ccf      .
      *                      *-----------------------------------------*
      *                      * 1. periodo, data min                    *
      *                      *-----------------------------------------*
           move      rr-p1d-min           to   w-mod-fat-bir-p1i      .
      *                      *-----------------------------------------*
      *                      * 1. periodo, data max                    *
      *                      *-----------------------------------------*
           move      rr-p1d-max           to   w-mod-fat-bir-p1f      .
      *                      *-----------------------------------------*
      *                      * 2. periodo, data min                    *
      *                      *-----------------------------------------*
           move      rr-p2d-min           to   w-mod-fat-bir-p2i      .
      *                      *-----------------------------------------*
      *                      * 2. periodo, data max                    *
      *                      *-----------------------------------------*
           move      rr-p2d-max           to   w-mod-fat-bir-p2f      .
      *                      *-----------------------------------------*
      *                      * 3. periodo, data min                    *
      *                      *-----------------------------------------*
           move      rr-p3d-min           to   w-mod-fat-bir-p3i      .
      *                      *-----------------------------------------*
      *                      * 3. periodo, data max                    *
      *                      *-----------------------------------------*
           move      rr-p3d-max           to   w-mod-fat-bir-p3f      .
      *                  *---------------------------------------------*
      *                  * Chiamata modulo                             *
      *                  *---------------------------------------------*
           perform   mod-fat-bir-cds-000  thru mod-fat-bir-cds-999    .
       fil-fir-ing-cds-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       fil-fir-ing-gts-000.
      *              *-------------------------------------------------*
      *              * Richiamo funzione 'GS' del modulo 'mfatbir0'    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione                                *
      *                  *---------------------------------------------*
      ...
      *                  * Chiamata modulo                             *
      *                  *---------------------------------------------*
           perform   mod-fat-bir-gts-000  thru mod-fat-bir-gts-999    .
       fil-fir-ing-gts-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *              * Deviazione a seconda se e' stato richiesto un   *
      *              * solo prodotto oppure piu' prodotti              *
      *              *-------------------------------------------------*
           if        w-cod-zos-dcp-tco    =    1
                     perform mod-fat-bir-cdg-000
                                          thru mod-fat-bir-cdg-999
           else      perform mod-fat-bir-get-000
                                          thru mod-fat-bir-get-999    .
       fil-fir-get-999.
           exit.

      *    *===========================================================*
      *    * Selezioni su record [bit] in esame                        *
      *    *-----------------------------------------------------------*
       sel-fit-rec-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-sel-bit-ctr-dpz      .
       sel-fit-rec-025.
           add       1                    to   w-sel-bit-ctr-dpz      .
           if        w-sel-bit-ctr-dpz    >    rr-dpz-ctr-sel
                     go to sel-fit-rec-900.
           if        rf-bit-cod-dpz       =    rr-dpz-ele-cod
                                              (w-sel-bit-ctr-dpz)
                     go to sel-fit-rec-100
      ...
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           move      rf-bit-cod-arc       to   w-let-cli-dcc-cli      .
           move      rf-bit-dpz-arc       to   w-let-cli-dcc-dpz      .
      ...
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
           move      w-let-cli-dcc-cli    to   w-sel-bit-cod-arc      .
      *                      *-----------------------------------------*
      *                      * Codice dipendenza per il cliente        *
      *                      *-----------------------------------------*
           move      w-let-cli-dcc-dpz    to   w-sel-bit-dpz-arc      .
      *                      *-----------------------------------------*
      *                      * Ragione sociale per il cliente          *
      *                      *-----------------------------------------*
           move      w-let-cli-dcc-rag    to   w-sel-bit-rag-cli      .
      *                      *-----------------------------------------*
      *                      * Mnemonico per il cliente                *
      *                      *-----------------------------------------*
           move      w-let-cli-dcc-mne    to   w-sel-bit-mne-cli      .
       sel-fit-rec-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      spaces               to   w-sel-bit-flg-exi      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Selezioni su record [bir] in esame                        *
      *    *-----------------------------------------------------------*
       sel-fir-rec-000.
      *              *-------------------------------------------------*
      ...
      *                      * Codice prodotto numerico                *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-cod    to   w-sel-bir-num-pro      .
      *                      *-----------------------------------------*
      *                      * Codice prodotto alfanumerico            *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-alf    to   w-sel-bir-alf-pro      .
      *                      *-----------------------------------------*
      *                      * Descrizione prodotto                    *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-des    to   w-sel-bir-des-pro      .
      *                      *-----------------------------------------*
      *                      * Unita' di misura di vendita per il pro- *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-umi    to   w-sel-bir-umi-pro      .
      *                      *-----------------------------------------*
      *                      * Numero decimali quantita' per il pro-   *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-dec    to   w-sel-bir-dec-pro      .
      *                      *-----------------------------------------*
      *                      * Classe merceologica del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-cla    to   w-sel-bir-cla-pro      .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-gru    to   w-sel-bir-gru-pro      .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico del prodotto   *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-sgr    to   w-sel-bir-sgr-pro      .
      *                      *-----------------------------------------*
      *                      * Tipo di prodotto                        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-tip    to   w-sel-bir-tip-pro      .
       sel-fir-rec-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-sel-bir-cst-pro      .
      *                  *---------------------------------------------*
      *                  * Test su data giacenza                       *
      *                  *---------------------------------------------*
           if        rr-dat-gia           =    zero
                     go to sel-fir-rec-400.
      *                  *---------------------------------------------*
      *                  * Test codice dipendenza                      *
      *                  *---------------------------------------------*
           if        rr-dpz-inu           =    zero
                     go to sel-fir-rec-400.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-dat-gia           to   d-vun-mag-dat-val      .
      ...
      *                  *---------------------------------------------*
           move      d-vun-mag-val-uni    to   w-sel-bir-cst-pro      .
       sel-fir-rec-400.
      *              *-------------------------------------------------*
      *              * Selezione su giacenza prodotto                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * Memorizzazione risultato                    *
      *                  *---------------------------------------------*
           move      d-sld-mag-sld-mag    to   w-sel-bir-gia-pro      .
      *                  *---------------------------------------------*
      *                  * Test di selezione                           *
      *                  *---------------------------------------------*
           if        rr-sel-gia           =    02    and
                     d-sld-mag-sld-mag    >    zero
                     go to sel-fir-rec-800
           else if   rr-sel-gia           =    03    and
      ...
      *                  * Flag di uscita a : selezione superata       *
      *                  *---------------------------------------------*
           move      spaces               to   w-sel-bir-flg-exi      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *                          * zione                               *
      *                          *-------------------------------------*
           if        w-sel-bir-des-pro    not  = spaces
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-bir-des-pro    to   srt-k01-des-pro        .
       cmp-srt-rec-225.
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-bir-alf-pro    to   srt-k01-alf-pro        .
       cmp-srt-rec-235.
      *                      *-----------------------------------------*
      *                      * Codice numerico del prodotto            *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-bir-num-pro    to   srt-k01-num-pro        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per documento                 *
      *                  *---------------------------------------------*
      ...
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-bit-dat-doc       to   srt-k02-dat-doc        .
       cmp-srt-rec-310.
      *                      *-----------------------------------------*
      *                      * Tipo documento                          *
      *                      *-----------------------------------------*
           move      rf-bit-cod-tmb       to   srt-k02-tip-doc        .
       cmp-srt-rec-315.
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      rf-bit-num-doc       to   srt-k02-num-doc        .
       cmp-srt-rec-800.
      *              *-------------------------------------------------*
      *              * Area dati                                       *
      *              *-------------------------------------------------*
      ...
      *                      * Codice numerico del prodotto            *
      *                      *-----------------------------------------*
           move      w-sel-bir-num-pro    to   srt-cod-pro-num        .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico del prodotto        *
      *                      *-----------------------------------------*
           move      w-sel-bir-alf-pro    to   srt-cod-pro-alf        .
      *                      *-----------------------------------------*
      *                      * Descrizione del prodotto                *
      *                      *-----------------------------------------*
           move      w-sel-bir-des-pro    to   srt-cod-pro-des        .
      *                      *-----------------------------------------*
      *                      * Unita' di misura del prodotto           *
      *                      *-----------------------------------------*
           move      w-sel-bir-umi-pro    to   srt-cod-pro-umi        .
      *                      *-----------------------------------------*
      *                      * Numero decimali del prodotto            *
      *                      *-----------------------------------------*
           move      w-sel-bir-dec-pro    to   srt-cod-pro-dec        .
      *                      *-----------------------------------------*
      *                      * Classe merceologica                     *
      *                      *-----------------------------------------*
           move      w-sel-bir-cla-pro    to   srt-cod-pro-cla        .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico                     *
      *                      *-----------------------------------------*
           move      w-sel-bir-gru-pro    to   srt-cod-pro-gru        .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico                *
      *                      *-----------------------------------------*
           move      w-sel-bir-sgr-pro    to   srt-cod-pro-sgr        .
      *                      *-----------------------------------------*
      *                      * Tipo di prodotto                        *
      *                      *-----------------------------------------*
           move      w-sel-bir-tip-pro    to   srt-cod-pro-tip        .
      *                      *-----------------------------------------*
      *                      * Giacenza prodotto                       *
      *                      *-----------------------------------------*
           move      w-sel-bir-gia-pro    to   srt-cod-pro-gia        .
      *                      *-----------------------------------------*
      *                      * Costo prodotto                          *
      *                      *-----------------------------------------*
           move      w-sel-bir-cst-pro    to   srt-cod-pro-cst        .
       cmp-srt-rec-850.
      *                  *---------------------------------------------*
      *                  * Cliente                                     *
      *                  *---------------------------------------------*
      ...
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
           move      w-sel-bit-cod-arc    to   srt-cod-cli-cod        .
      *                      *-----------------------------------------*
      *                      * Codice dipendenza del cliente           *
      *                      *-----------------------------------------*
           move      w-sel-bit-dpz-arc    to   srt-cod-cli-dpz        .
      *                      *-----------------------------------------*
      *                      * Mnemonico del cliente                   *
      *                      *-----------------------------------------*
           move      w-sel-bit-mne-cli    to   srt-cod-cli-mne        .
      *                      *-----------------------------------------*
      *                      * Ragione sociale del cliente             *
      *                      *-----------------------------------------*
           move      w-sel-bit-rag-cli    to   srt-cod-cli-rag        .
       cmp-srt-rec-875.
      *                  *---------------------------------------------*
      *                  * Estremi del documento                       *
      *                  *---------------------------------------------*
      ...
      *                      * Tipo documento                          *
      *                      *-----------------------------------------*
           move      rf-bit-cod-tmb       to   srt-est-doc-tdo        .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-bit-dat-doc       to   srt-est-doc-ddo        .
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      rf-bit-num-doc       to   srt-est-doc-ndo        .
      *                      *-----------------------------------------*
      ...
      *                          * 'mnotsvb0' per la funzione di de-   *
      ...
      *                              * dettaglio                       *
      *                              *---------------------------------*
           move      00                   to   w-mod-not-svb-tdd      .
      *                              *---------------------------------*
      *                              * Numero di caratteri disponibili *
      *                              *---------------------------------*
           move      w-stp-clc-not-lun    to   w-mod-not-svb-ncd      .
      *                              *---------------------------------*
      *                              * 1. quantita'                    *
      *                              *---------------------------------*
           move      w-mod-fat-bir-qta    to   w-mod-not-svb-q01      .
      *                              *---------------------------------*
      *                              * 1. fatturato                    *
      *                              *---------------------------------*
           move      w-mod-fat-bir-val    to   w-mod-not-svb-f01      .
      *                              *---------------------------------*
      *                              * 2. quantita'                    *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-svb-q02      .
      *                              *---------------------------------*
      *                              * 2. fatturato                    *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-svb-f02      .
      *                              *---------------------------------*
      *                              * 1. % di variazione              *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-svb-p01      .
      *                              *---------------------------------*
      *                              * 3. quantita'                    *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-svb-q03      .
      *                              *---------------------------------*
      *                              * 3. fatturato                    *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-svb-f03      .
      *                              *---------------------------------*
      *                              * 2. % di variazione              *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-svb-p02      .
      *                              *---------------------------------*
      *                              * Tipo documento                  *
      *                              *---------------------------------*
______*    move      rf-bit-tip-doc       to   w-mod-not-svb-tdo      .
      *                              *---------------------------------*
      *                              * Data documento                  *
      *                              *---------------------------------*
           move      rf-bit-dat-doc       to   w-mod-not-svb-ddo      .
      *                              *---------------------------------*
      *                              * Numero documento                *
      *                              *---------------------------------*
           move      rf-bit-num-doc       to   w-mod-not-svb-ndo      .
      *                          *-------------------------------------*
      *                          * Richiamo effettivo del modulo       *
      *                          *-------------------------------------*
           perform   mod-not-svb-dvn-000  thru mod-not-svb-dvn-999    .
      *                          *-------------------------------------*
      *                          * Memorizzazione risultato            *
      *                          *-------------------------------------*
           move      w-mod-not-svb-not    to   srt-est-doc-not        .
       cmp-srt-rec-925.
      *                  *---------------------------------------------*
      *                  * Valori statistici                           *
      *                  *---------------------------------------------*
      ...
      *                      * Quantita' fatturata                     *
      *                      *-----------------------------------------*
           move      w-mod-fat-bir-qta    to   srt-val-sta-qta        .
      *                      *-----------------------------------------*
      *                      * Importo fatturato                       *
      *                      *-----------------------------------------*
           move      w-mod-fat-bir-val    to   srt-val-sta-val        .
      *                      *-----------------------------------------*
      *                      * Costo del fatturato                     *
      *                      *-----------------------------------------*
           move      w-mod-fat-bir-cos    to   srt-val-sta-cos        .
      *                      *-----------------------------------------*
      *                      * Incidenza sulla statistica              *
      *                      *-----------------------------------------*
           move      w-mod-fat-bir-pon    to   srt-val-sta-pon        .
      *                      *-----------------------------------------*
      *                      * Incidenza sul 1. periodo di riferimento *
      *                      *-----------------------------------------*
           move      w-mod-fat-bir-sn1    to   srt-val-sta-sn1        .
      *                      *-----------------------------------------*
      *                      * Incidenza sul 2. periodo di riferimento *
      *                      *-----------------------------------------*
           move      w-mod-fat-bir-sn2    to   srt-val-sta-sn2        .
      *                      *-----------------------------------------*
      *                      * Incidenza sul 3. periodo di riferimento *
      *                      *-----------------------------------------*
           move      w-mod-fat-bir-sn3    to   srt-val-sta-sn3        .
       cmp-srt-rec-950.
      *                  *---------------------------------------------*
      *                  * Valori ABC                                  *
      *                  *---------------------------------------------*
           ...
           if        rr-num-pdr           =    02 or
                     ...
                     if    rr-tor-pro     =    02 or
                           ...
                           move   kk0-qta-1op
                                          ...
                                          to   srt-k01-val-abc        .
      *                      *-----------------------------------------*
      *                      * Se ABC decrescente lo si complementa    *
      *                      *-----------------------------------------*
           if        rr-tor-pro           =    01 or
                     rr-tor-pro           =    02 or
                     rr-tor-pro           =    03 or
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Valore costo fatturato 1. periodo           *
      *                  *---------------------------------------------*
           move      "PF"                 to   x-ope                  .
           move      "H"                  to   x-tip                  .
           move      10                   to   x-car                  .
           move      "VAL. COSTO"         to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Valore costo fatturato 2. periodo           *
      *                  *---------------------------------------------*
           move      "PF"                 to   x-ope                  .
           move      "H"                  to   x-tip                  .
           move      10                   to   x-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Valore costo fatturato 3. periodo           *
      *                  *---------------------------------------------*
           move      "PF"                 to   x-ope                  .
           move      "H"                  to   x-tip                  .
           move      10                   to   x-car                  .
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-qta-p1r    to   w-mod-not-svb-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-tot-p1r    to   w-mod-not-svb-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-qta-p2r    to   w-mod-not-svb-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-tot-p2r    to   w-mod-not-svb-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-svb-p01      .
      *                      *-----------------------------------------*
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-qta-p3r    to   w-mod-not-svb-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-tot-p3r    to   w-mod-not-svb-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-svb-p02      .
      *                      *-----------------------------------------*
      *                      * Tipo documento                          *
      *                      *-----------------------------------------*
           move      spaces               to   w-mod-not-svb-tdo      .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      zero                 to   w-mod-not-svb-ddo      .
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      zero                 to   w-mod-not-svb-ndo      .
      *                  *---------------------------------------------*
      *                  * Richiamo effettivo del modulo               *
      *                  *---------------------------------------------*
           perform   mod-not-svb-dvn-000  thru mod-not-svb-dvn-999    .
      ...
      *              *-------------------------------------------------*
      ...
      -              "      "             to   w-stp-sta-tot-lit      .
           ...
           move      w-mod-not-svb-not    to   w-stp-sta-tot-not      .
       prn-fin-cic-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Giacenza per il prodotto                    *
      *                  *---------------------------------------------*
           move      srt-cod-pro-gia      to   w-liv-pro-qta-gia      .
      *                  *---------------------------------------------*
      *                  * Costo per il prodotto                       *
      *                  *---------------------------------------------*
           move      srt-cod-pro-cst      to   w-liv-pro-cst-ult      .
      *                  *---------------------------------------------*
      *                  * Flag di unita' di misura memorizzata        *
      *                  *---------------------------------------------*
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-qta-p1r    to   w-mod-not-svb-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-tot-p1r    to   w-mod-not-svb-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-qta-p2r    to   w-mod-not-svb-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-tot-p2r    to   w-mod-not-svb-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-svb-p01      .
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-qta-p3r    to   w-mod-not-svb-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-tot-p3r    to   w-mod-not-svb-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-svb-p02      .
      ...
      *                  * di misura, Quantita', Fatturato, % e note   *
      *                  *---------------------------------------------*
       prn-fin-lr1-341.
      *                      *-----------------------------------------*
      *                      * Preparazione                            *
      *                      *-----------------------------------------*
           ...
           move      w-mod-not-svb-not    to   w-stp-sta-qfp-not      .
      *                      *-----------------------------------------*
      *                      * Eventuale update per le note            *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Test se necessario                  *
      *                          *-------------------------------------*
           if        rr-dat-gia           =    zero
                     go to prn-fin-lr1-342.
           if        rr-opz-stp-gia       =    spaces and
                     rr-opz-stp-cst       =    spaces
                     go to prn-fin-lr1-342.
      *                          *-------------------------------------*
      *                          * Editing Giacenza                    *
      *                          *-------------------------------------*
           ...
           move      "S"                  to   p-sgn                  .
           move      "<BGD"               to   p-edm                  .
           move      w-liv-pro-qta-gia    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                          *-------------------------------------*
      *                          * Test se dato richiesto              *
      *                          *-------------------------------------*
           if        rr-opz-stp-gia       =    spaces
                     move  spaces         to   w-stp-sta-qfp-not
           else      move  p-edt          to   w-stp-sta-qfp-not      .
      *                          *-------------------------------------*
      *                          * Test se zero                        *
      *                          *-------------------------------------*
           if        w-liv-pro-qta-gia    =    zero
                     move  spaces         to   w-stp-sta-qfp-not      .
      *                          *-------------------------------------*
      *                          * Editing Costo                       *
      *                          *-------------------------------------*
           ...
           move      "S"                  to   p-sgn                  .
           move      "<BGD"               to   p-edm                  .
           move      w-liv-pro-cst-ult    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                          *-------------------------------------*
      *                          * Concatenamento nel campo note       *
      *                          *-------------------------------------*
           move      w-mod-not-svb-ncd    to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           if        rr-opz-stp-cst       =    spaces
      ...
      *                          *-------------------------------------*
      *                          * In campo per le note                *
      *                          *-------------------------------------*
           move      w-all-str-alf        to   w-stp-sta-qfp-not
                                              (14 : 14)               .
       prn-fin-lr1-342.
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      ...
      *                  *---------------------------------------------*
           if        w-cnt-prn-flg-int    not  = spaces
                     go to prn-fin-lr1-999.
      *                  *---------------------------------------------*
      *                  * A stampa totale prodotto, senza eseguire    *
      ...
      *                  *---------------------------------------------*
           ...
           move      02                   to   w-mod-set-tip-arc      .
           move      w-liv-pro-num-pro    to   w-mod-set-cod-arc      .
           move      w-liv-pro-alf-pro    to   w-mod-set-alf-arc      .
      ...
      *                          *-------------------------------------*
       ...
       stp-int-pag-575.
      *                      *-----------------------------------------*
      *                      * Eventuale data giacenza                 *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Se data a zero : nessuna azione     *
      *                          *-------------------------------------*
           if        rr-dat-gia           =    zero
                     go to stp-int-pag-580.
      *                          *-------------------------------------*
      *                          * Interlinea                          *
      *                          *-------------------------------------*
           move      "LF"                 to   p-ope                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Richiesta al modulo delle note, del codice  *
      *                  * prodotto da esporre, in base alle richieste *
      *                  *---------------------------------------------*
           move      rr-tip-cpe           to   w-mod-not-svb-cpe      .
           move      w-stp-ced-pro-num    to   w-mod-not-svb-pro      .
           move      w-stp-ced-pro-alf    to   w-mod-not-svb-alf      .
      *                  *---------------------------------------------*
      *                  * Richiamo effettivo del modulo               *
      *                  *---------------------------------------------*
           perform   mod-not-svb-cpe-000  thru mod-not-svb-cpe-999    .
      *                  *---------------------------------------------*
      *                  * Riassegnazione del codice prodotto          *
      *                  *---------------------------------------------*
           move      w-mod-not-svb-alf    to   w-stp-ced-pro-alf      .
       stp-ced-pro-050.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rr-tip-cpe           to   w-mod-not-svb-cpe      .
           move      w-liv-pro-num-pro    to   w-mod-not-svb-pro      .
           move      w-liv-pro-alf-pro    to   w-mod-not-svb-alf      .
      *                  *---------------------------------------------*
      *                  * Richiamo effettivo del modulo               *
      *                  *---------------------------------------------*
           perform   mod-not-svb-cpe-000  thru mod-not-svb-cpe-999    .
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   x-tip                  .
           move      14                   to   x-car                  .
           move      w-mod-not-svb-alf    to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Descrizione per il prodotto                 *
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   x-tip                  .
           move      40                   to   x-car                  .
           move      w-liv-pro-des-pro    to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Unita' di misura per il prodotto            *
      ...
      *                  *---------------------------------------------*
           ...
           move      "S"                  to   x-sgn                  .
           move      "<BGD"               to   x-edm                  .
           move      w-liv-pro-qta-gia    to   x-num                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Costo ultimo                                *
      ...
      *                  * Editing                                     *
      *                  *---------------------------------------------*
           move      w-liv-pro-cos-p1r    to   w-stp-edt-fat-fat      .
           perform   stp-edt-fat-000      thru stp-edt-fat-999        .
      *                  *---------------------------------------------*
      *                  * In campo di uscita                          *
      *                  *---------------------------------------------*
      ...
      *                  * Editing                                     *
      *                  *---------------------------------------------*
           move      w-liv-pro-vco-p1r    to   w-stp-edt-fat-fat      .
           perform   stp-edt-fat-000      thru stp-edt-fat-999        .
      *                  *---------------------------------------------*
      *                  * In campo di uscita                          *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-num-pdr           <    2
                     go to exe-gen-fil-800.
      *                  *---------------------------------------------*
      *                  * Editing                                     *
      *                  *---------------------------------------------*
           move      w-liv-pro-val-dec    to   w-stp-edt-qta-dec      .
           move      w-liv-pro-qta-p2r    to   w-stp-edt-qta-qta      .
           perform   stp-edt-qta-000      thru stp-edt-qta-999        .
      *                  *---------------------------------------------*
      *                  * In campo di uscita                          *
      *                  *---------------------------------------------*
      ...
      *                  * Editing                                     *
      *                  *---------------------------------------------*
           move      w-liv-pro-tot-p2r    to   w-stp-edt-fat-fat      .
           perform   stp-edt-fat-000      thru stp-edt-fat-999        .
      *                  *---------------------------------------------*
      *                  * In campo di uscita                          *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-liv-pro-val-dec    to   w-stp-edt-qta-dec      .
           move      w-liv-pro-qta-p3r    to   w-stp-edt-qta-qta      .
           perform   stp-edt-qta-000      thru stp-edt-qta-999        .
      *                  *---------------------------------------------*
      *                  * In campo di uscita                          *
      *                  *---------------------------------------------*
      ...
      *                  * Editing                                     *
      *                  *---------------------------------------------*
           move      w-liv-pro-tot-p3r    to   w-stp-edt-fat-fat      .
           perform   stp-edt-fat-000      thru stp-edt-fat-999        .
      *                  *---------------------------------------------*
      *                  * In campo di uscita                          *
      *                  *---------------------------------------------*
      ...
      *    *                                                           *
      *    *   - w-stp-sta-tot-cf1 : Costo del fatturato 1             *
      *    *                                                           *
      *    *   - w-stp-sta-tot-vf1 : Valore del costo del fatturato 1  *
      *    *                                                           *
      ...
      *    * fatturato da Righe Documenti                              *
      *    *-----------------------------------------------------------*
           copy      "ele/svf/prg/cpy/mfatbir0.mds"                   .
      ...
      *    *-----------------------------------------------------------*
           copy      "ele/svf/prg/cpy/mnotsvb0.mds"                   .
