      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf2001:       *
      *                                                                *
      ...
      *            *---------------------------------------------------*
               ...
               10  w-liv-cli-cst-ct1      pic  9(02)                  .
               10  w-liv-cli-cst-min      pic  9(02)                  .
               10  w-liv-cli-cst-max      pic  9(02)                  .
      *            *---------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Link-area per modulo generazione set           'msetsvf0' *
      *    *-----------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-prs.
      *        *-------------------------------------------------------*
      *        * Si/No possibilita' di generazione grafici esterna     *
      *        *-------------------------------------------------------*
           05  w-prs-snx-grf              pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-prs-svf-cli-tco      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Si/No raggruppamento di tutte le eventuali dipen- *
      *            * denze per lo stesso cliente, ove possibile        *
      *            *                                                   *
      *            *   - S : Si, raggruppare ove possibile             *
      *            *   - N : No, tenere sempre distinte le dipendenze  *
      *            *         del cliente                               *
      *            *---------------------------------------------------*
                10  w-prs-svf-cli-rgd     pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Lettura della personalizzazione per eventuale   *
      *              * possibilita' di generazione grafico esterna     *
      *              *-------------------------------------------------*
           perform   prs-snx-grf-000      thru prs-snx-grf-999        .
       pre-exe-pgm-999.
           exit.
      ...
      *    *===========================================================*
      *    * Lettura personalizzazione : Si/No possibilita' di genera- *
      *    *                             zione grafico esterna         *
      *    *-----------------------------------------------------------*
       prs-snx-grf-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/svf[snx-grf]"   to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-prs-snx-grf
           else      move  spaces         to   w-prs-snx-grf          .
      *              *-------------------------------------------------*
      *              * Normalizzazione personalizzazione               *
      *              *-------------------------------------------------*
           if        w-prs-snx-grf        not  = "S"
                     move  "N"            to   w-prs-snx-grf          .
       prs-snx-grf-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Ritaratura personalizzazione raggruppamento     *
      *              * dipendenze clienti                              *
      *              *                                                 *
      *              * ELETTRA                                         *
      *              *-------------------------------------------------*
           move      rr-snx-rdp           to   w-prs-svf-cli-rgd      .
       stp-srt-inp-010.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-dac-max           =    zero
                     go to sel-fit-rec-254
           else      go to sel-fit-rec-256.
       sel-fit-rec-254.
      *                      *-----------------------------------------*
      *                      * Se data max a zero                      *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-lr1-010.
      *              *-------------------------------------------------*
      *              * Test su eventuale soglia di fatturato           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        w-liv-cli-tot-p1r    not  < rr-sft-min and
                     w-liv-cli-tot-p1r    not  > rr-sft-max
                     go to  prn-fin-lr1-100.
      *                  *---------------------------------------------*
      *                  * Se selezione non superata : decremento      *
      *                  * totali generali                             *
      *                  *---------------------------------------------*
           if        w-liv-gen-num-cli    >    zero
                     subtract  1          from w-liv-gen-num-cli      .
           if        w-liv-gen-tot-p1r    >    zero
                     subtract  w-liv-cli-tot-p1r
      ...
      *                          *-------------------------------------*
           move      rr-p1d-max           to   s-dat                  .
           move      s-mes                to   w-liv-cli-cst-max      .
           if        w-liv-cli-cst-ctr    >    w-liv-cli-cst-max or
                     w-liv-cli-cst-ctr    >    12
                     go to prn-fin-lr1-350.
      *                      *-----------------------------------------*
      *                      * Determinazione % di variazione          *
      *                      *-----------------------------------------*
      ...
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   exe-gen-fil-cli-000  thru exe-gen-fil-cli-999    .
       prn-fin-lr1-840.
      *                  *---------------------------------------------*
      *                  * Emissione sequenziale dati per grafico      *
      *                  *---------------------------------------------*
      ...
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   exe-sqz-grf-cli-000  thru exe-sqz-grf-cli-999    .
       prn-fin-lr1-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test su soglia min e max                *
      *                      *-----------------------------------------*
           if        rr-sft-min           =    zero          and
                     rr-sft-max           =    9999999999999
                     go to stp-int-pag-040.
       stp-int-pag-035.
      *                      *-----------------------------------------*
      *                      * Se selezioni su soglia min e max        *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Editing soglia min                  *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
       ...
       stp-int-pag-040.
      *                      *-----------------------------------------*
      *                      * Se non selezioni su soglia min e max    *
      *                      *-----------------------------------------*
           move      "PER CLIENTE                                       
      -              "                              "
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   x-tip                  .
           move      04                   to   x-car                  .
           move      w-liv-cli-dpz-cli    to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Ragione sociale cliente                     *
      ...
      *              *-------------------------------------------------*
           ...
           move      "svf200"             to   m-gen-grf-fil-nam      .
       exe-sqz-grf-200.
      *              *-------------------------------------------------*
      ...
      *    * Emissione sequenziale dati per grafico                    *
      *    *                                                           *
      *    * Ciclo di emissione grafico per un cliente                 *
      *    *-----------------------------------------------------------*
       exe-sqz-grf-cli-000.
      *              *-------------------------------------------------*
      *              * Test se da eseguire                             *
      ...
      *              *-------------------------------------------------*
           move      "EG"                 to   m-gen-grf-tip-ope      .
           move      "C"                  to   m-gen-grf-tip-grf      .
           move      "C"                  to   m-gen-grf-tip-arc      .
           move      rr-cod-cli           to   m-gen-grf-cod-arc      .
           move      spaces               to   m-gen-grf-mne-arc      .
           move      rr-num-pdr           to   m-gen-grf-num-prd      .
      *
           ...
           move      w-liv-cli-rag-cli    to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
      ...
      *                  * Preparazione date periodi                   *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cli-cst-ct1      .
       exe-sqz-grf-cli-300.
           add       1                    to   w-liv-cli-cst-ct1      .
           if        w-liv-cli-cst-ct1    >    rr-num-pdr
                     go to exe-sqz-grf-cli-800.
           if        w-liv-cli-cst-ct1    =    01
                     move  rr-p1d-min     to   m-gen-grf-prd-min
                                              (w-liv-cli-cst-ct1)
                     move  rr-p1d-max     to   m-gen-grf-prd-max
                                              (w-liv-cli-cst-ct1)
           else if   w-liv-cli-cst-ct1    =    02
                     move  rr-p2d-min     to   m-gen-grf-prd-min
                                              (w-liv-cli-cst-ct1)
                     move  rr-p2d-max     to   m-gen-grf-prd-max
                                              (w-liv-cli-cst-ct1)
      ...
      *                  * Riciclo a mese successivo                   *
      *                  *---------------------------------------------*
           go to     exe-sqz-grf-cli-500.
       exe-sqz-grf-cli-600.
      *                  *---------------------------------------------*
      *                  * Riciclo a periodo successivo                *
      *                  *---------------------------------------------*
           go to     exe-sqz-grf-cli-300.
       exe-sqz-grf-cli-800.
      *              *-------------------------------------------------*
      *              * Chiamata modulo generazione grafico             *
      *              *-------------------------------------------------*
