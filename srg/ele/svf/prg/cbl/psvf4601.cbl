      ...
      *                       Ultima revisione:    NdK del 31/01/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf4601:       *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per classe geografica cliente - classe sta- *
      *                    tistica prodotto.                           *
      *                                                                *
      ...
      *                *-----------------------------------------------*
      *                * Tipo record                                   *
      *                *   01 : Totale per classe geografica cliente   *
      *                *   02 : Totale per classe statistica prodotto  *
      *                *-----------------------------------------------*
                   15  kk0-tip-rec        pic  9(02)                  .
      *                *-----------------------------------------------*
      *                * Codice numerico classe geografica cliente     *
      *                *-----------------------------------------------*
                   15  kk0-cod-cgc        pic  9(05)                  .
      *                *-----------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  srt-val-abc.
      *                *-----------------------------------------------*
      *                * Valore ABC per la classe geografica cliente   *
      *                *-----------------------------------------------*
                   15  srt-val-abc-cgc    pic s9(13)v9(03)            .
      *                *-----------------------------------------------*
      *                * Valore ABC per la classe statistica prodotto  *
      *                * nell'ambito della classe geografica cliente   *
      *                *-----------------------------------------------*
      ...
      *            * la classe geografica cliente                      *
      *            *---------------------------------------------------*
               10  w-liv-cgc-num-csp      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *            *---------------------------------------------------*
      *            * Numero di classi geografiche cliente trattate in  *
      *            * totale                                            *
      *            *---------------------------------------------------*
      ...
      *                  * Forzatura fatturato                         *
      *                  *                                             *
      *                  * Modificato da Mario _______________________ *
      *                  *---------------------------------------------*
...
v       cmp-srt-rec-415.
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Valore ABC per la classe geografica del *
      *                      * cliente                                 *
      *                      *-----------------------------------------*
      ...
      *                  * geografica clienti tra i seguenti :         *
      ...
      *                  *---------------------------------------------*
      *                  * Numero di classi geografiche cliente trat-  *
      *                  * tate in totale                              *
      *                  *---------------------------------------------*
      ...
      *              * geografiche cliente : uscita senza alcuna a-    *
      *              * zione                                           *
      *              *-------------------------------------------------*
      ...
      *                  * per la classe geografica cliente            *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cgc-num-csp      .
      *                  *---------------------------------------------*
      *                  * Numero di classi geografiche cliente trat-  *
      *                  * tate in totale                              *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Determinazione valore del campo 'Note' per il   *
      *              * totale classe geografica cliente                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione                                *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-liv-gen-flg-umi    =    spaces
                     ...
                     move  spaces         to   w-liv-gen-val-umi      .
      *                  *---------------------------------------------*
      *                  * Per livello classe geografica cliente       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-250.
      *              *-------------------------------------------------*
      *              * Accumuli per livello classe geografica cliente  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Totali 1. periodo di riferimento            *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-036.
           move      "PER NAZIONE - 1. CODICE STATISTICO PRODOTTO       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-037.
           move      "PER NAZIONE - 2. CODICE STATISTICO PRODOTTO       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-038.
           move      "PER NAZIONE - 3. CODICE STATISTICO PRODOTTO       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-039.
           move      "PER NAZIONE - CLASSE MERCEOLOGICA PRODOTTO        
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-040.
       ...
       stp-int-pag-041.
           move      "PER REGIONE - 1. CODICE STATISTICO PRODOTTO       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-042.
           move      "PER REGIONE - 2. CODICE STATISTICO PRODOTTO       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-043.
           move      "PER REGIONE - 3. CODICE STATISTICO PRODOTTO       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-044.
           move      "PER REGIONE - CLASSE MERCEOLOGICA PRODOTTO        
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-045.
       ...
       stp-int-pag-046.
           move      "PER PROVINCIA - 1. CODICE STATISTICO PRODOTTO     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-047.
           move      "PER PROVINCIA - 2. CODICE STATISTICO PRODOTTO     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-048.
           move      "PER PROVINCIA - 3. CODICE STATISTICO PRODOTTO     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-049.
           move      "PER PROVINCIA - CLASSE MERCEOLOGICA PRODOTTO      
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
