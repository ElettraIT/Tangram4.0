      ...
      *                       Ultima revisione:    NdK del 16/01/11    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf3001:        *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per classificazione statistica cliente.     *
      *                                                                *
      *                    SU MISURA PER ELETTRA - CHIAMATA A 'svf3001'*
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FATTURATO PER CLASSE STATISTICA CLIENTE "       .
      ...
      *        *                                                       *
      *        *  - 01 : Solo totale per codice classe statistica      *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-t02.
                   15  filler             pic  x(50) value
                  "Solo totale per codice categoria                  ".
                   15  filler             pic  x(50) value
                  "Con anche il totale per ogni cliente              ".
                   15  filler             pic  x(50) value
                  "Con la lista documenti emessi per ogni cliente    ".
               10  w-exp-tip-dts-t03.
                   15  filler             pic  x(50) value
                  "Solo totale per codice statistico                 ".
                   15  filler             pic  x(50) value
                  "Con anche il totale per ogni cliente              ".
                   15  filler             pic  x(50) value
                  "Con la lista documenti emessi per ogni cliente    ".
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento per la classe statistica     *
      *    *-----------------------------------------------------------*
       pmt-tor-csc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           if        rr-ccs-cli           =    zero
                     move  "Tutti i codici statistici"
                                          to   rr-ccs-cli-des
           else      move  w-let-arc-zst-des
                                          to   rr-ccs-cli-des         .
      *                  *---------------------------------------------*
      ...
      *                  * classe statistica si normalizza e si vi-    *
      *                  * sualizza :                                  *
      *                  *  - Tipo di ordinamento per clienti          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      * vero solo totale per classe statistica, *
      ...
      *              *-------------------------------------------------*
       tdo-ric-sel-051.
           ...
           move      "Manca il tipo classe statistica !                 
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-052.
           ...
           move      "Tipo classe statistica errato !                   
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-150.
      *              *-------------------------------------------------*
      ...
      -              "ica !          "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-202.
           if        rr-tor-csc           =    01 or
                     ...
                     rr-tor-csc           =    05
                     go to tdo-ric-sel-250.
           move      "Tipo di ordinamento per la classe statistica errat
