      ...
      *                    un solo cliente                             *
      *                                                                *
      *                    Margine su costo medio ponderato            *
      *                                                                *
      *================================================================*
      ...
      *                      * Codice cliente                          *
      *                      *                                         *
      *                      * N.B. Viene utilizzato il campo di link  *
      *                      *      w-mod-fat-fir-pro per passare il   *
      *                      *      codice cliente eventualmente ri-   *
      *                      *      chiesto                            *
      *                      *                                         *
      *                      *      ELETTRA                            *
      *                      *-----------------------------------------*
           if        rr-cod-cli           =    zero
                     move  zero           to   w-mod-fat-fir-pro
           else      move  rr-cod-cli     to   w-mod-fat-fir-pro      .
      *                      *-----------------------------------------*
      *                      * Numero periodi di riferimento           *
      *                      *-----------------------------------------*
           if        rr-num-pdr           =    11 or
      ...
      *                          *-------------------------------------*
           if        w-prs-svf-cli-rgd    =    "S"
                     move  w-sel-fit-dpz-cli
                                          to   srt-k01-dpz-cli
           else      move  spaces         to   srt-k01-dpz-cli        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per prodotto                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           else      move  spaces         to   w-rot-l02-dpz-cli      .
       prn-cmp-rot-999.
           exit.
