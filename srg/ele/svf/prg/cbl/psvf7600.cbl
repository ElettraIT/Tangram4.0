      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf7601:        *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per agente - classe statistica prodotto.    *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " FATTURATO PER AGENTE - CLASSE PRODOTTO "       .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "solo il Totale per ogni classe statistica         ".
                   15  filler             pic  x(50) value
      ...
      *    *-----------------------------------------------------------*
       pmt-tor-csp-000.
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Ordinamento classe statist.:"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tor-csp-999.
      ...
      *                  * cumenti o il grafico a 'torta' si visua-    *
      *                  * lizzano :                                   *
      *                  *  - Numero periodi di riferimento            *
