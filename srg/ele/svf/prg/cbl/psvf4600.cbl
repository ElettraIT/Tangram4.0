      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf4601:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "Solo il totale per ogni classe di prodotto        ".
                   15  filler             pic  x(50) value
                  "Con la lista documenti per ogni classe di prodotto".
                   15  filler             pic  x(50)                  .
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento classe geografica clienti *
      *        *-------------------------------------------------------*
           05  w-exp-tor-cgc.
               10  w-exp-tor-cgc-num      pic  9(02)       value 6    .
               ...
               10  w-exp-tor-cgc-t00.
                  ...
                  "Ordinamento ABC crescente sulla quantita'         ".
                   15  filler             pic  x(50) value
                  "Ordinamento per descrizione classe geografica     ".
                   15  filler             pic  x(50) value
                  "Ordinamento per codice classe geografica          ".
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-250.
      *                  *---------------------------------------------*
      *                  * Tipo di ordinamento per la classe geografi- *
      *                  * ca cliente                                  *
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-300.
      *                  *---------------------------------------------*
      *                  * Tipo di classe statistica prodotto          *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Tipo di ordinamento per la classe geografica    *
      *              * cliente                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Tipo di ordinamento per la classe statistica    *
      *              * prodotto                                        *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento per la classe geografica del *
      *    *          cliente                                          *
      *    *-----------------------------------------------------------*
       pmt-tor-cgc-000.
           move      "DS"                 to   v-ope                  .
           ...
           if        rr-tcg-cli           =    01
                     ...
                     move  "Ordinamento provincia      :"
                                          to   v-alf
           else      move  "Ordinamento classi geogr.  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tor-cgc-999.
      ...
      *    *===========================================================*
      *    * Prompt : Tipo classe statistica prodotto                  *
      *    *-----------------------------------------------------------*
       pmt-tcs-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento per la classe statistica del *
      *    *          prodotto                                         *
      *    *-----------------------------------------------------------*
       pmt-tor-csp-000.
           move      "DS"                 to   v-ope                  .
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipo di ordinamento per la :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *                      *-----------------------------------------*
       ...
       acc-tcg-cli-670.
      *                      *-----------------------------------------*
      *                      * Tipo dettaglio di stampa                *
      *                      *-----------------------------------------*
           perform   vis-tip-dts-000      thru vis-tip-dts-999        .
       acc-tcg-cli-675.
      *                      *-----------------------------------------*
      *                      * Prompt per tipo ordinamento classe geo- *
      *                      * grafica                                 *
      *                      *-----------------------------------------*
           perform   pmt-tor-cgc-000      thru pmt-tor-cgc-999        .
       acc-tcg-cli-680.
      *                      *-----------------------------------------*
      *                      * Tipo ordinamento classe geografica      *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
       ...
       acc-tcs-pro-665.
      *                      *-----------------------------------------*
      *                      * Se il tipo classe statistica precedente *
      *                      * non e' 'Classe merceologica prodotto' : *
      *                      * nessuna dipendenza                      *
      *                      *-----------------------------------------*
           if        w-sav-tcs-pro        not  = 11
                     go to acc-tcs-pro-800.
      *                      *-----------------------------------------*
      *                      * Se il tipo ordinamento classe statisti- *
      *                      * ca prodotti non e' 'Per numero di se-   *
      *                      * quenza della classe' : nessuna dipen-   *
      *                      * denza                                   *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-cmn-zps-001-lin      .
           move      30                   to   w-cmn-zps-001-pos      .
           move      11                   to   w-cmn-zps-001-dln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-cmn-zps-002-lin      .
           move      30                   to   w-cmn-zps-002-pos      .
           move      11                   to   w-cmn-zps-002-dln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-cmn-zps-003-lin      .
           move      30                   to   w-cmn-zps-003-pos      .
           move      11                   to   w-cmn-zps-003-dln      .
      ...
      *              *-------------------------------------------------*
       tdo-ric-sel-051.
           ...
           move      "Manca il tipo classe geografica cliente !         
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-052.
           ...
           move      "Tipo classe geografica cliente errato !           
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-150.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       tdo-ric-sel-201.
           if        rr-ccg-cli           not  = zero
                     go to tdo-ric-sel-250.
           if        rr-tor-cgc           not  = zero
                     go to tdo-ric-sel-202.
           move      "Manca il tipo di ordinamento per la classe geograf
      -              "ica cliente !  "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-202.
           if        rr-tor-cgc           =    01 or
                     ...
                     rr-tor-cgc           =    06
                     go to tdo-ric-sel-250.
           move      "Tipo di ordinamento per la classe geografica clien
      ...
      *              *-------------------------------------------------*
       tdo-ric-sel-251.
           ...
           move      "Manca il tipo classe statistica prodotto !        
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-252.
           if        rr-tcs-pro           =    11 or
           ...
           move      "Tipo classe statistica prodotto errato !          
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-275.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "tto errato !   "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-300.
      *              *-------------------------------------------------*
