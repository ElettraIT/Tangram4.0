      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf7601:       *
      *                                                                *
      ...
      *            *---------------------------------------------------*
      *            * Numero classi trattati per l'agente               *
      *            *---------------------------------------------------*
               10  w-liv-age-num-csp      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Buffer classi trattati per l'agente               *
      *            *---------------------------------------------------*
               10  w-liv-age-buf-csp.
                   15  w-liv-age-buf-ele  occurs 99.
                       20  w-liv-age-buf-cod
                                          pic  9(05)                  .
                       20  w-liv-age-buf-des
                                          pic  x(40)                  .
                       20  w-liv-age-buf-per
                                          pic  9(01)v9(02)            .
                       20  w-liv-age-buf-val
                                          pic s9(13)                  .
                       20  w-liv-age-buf-col
                                          pic  x(11)                  .
      *            *---------------------------------------------------*
      *            * Numero elementi nel buffer                        *
      *            *---------------------------------------------------*
               10  w-liv-age-buf-ctr      pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Max elementi nel buffer                           *
      *            *---------------------------------------------------*
               10  w-liv-age-buf-max      pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Indice elementi nel buffer                        *
      *            *---------------------------------------------------*
               10  w-liv-age-buf-inx      pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione percentuale di incidenza           *
      *        *-------------------------------------------------------*
           05  w-det-per-inc.
      *            *---------------------------------------------------*
      *            * Totale per il calcolo                             *
      *            *---------------------------------------------------*
               10  w-det-per-inc-tot      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Valore per il calcolo                             *
      *            *---------------------------------------------------*
               10  w-det-per-inc-val      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Percentuale determinata                           *
      *            *---------------------------------------------------*
               10  w-det-per-inc-per      pic  9(02)v9(02)            .
               10  w-det-per-inc-pal      pic  x(05)                  .
               10  w-det-per-inc-pds      pic  9(03)                  .
               10  w-det-per-inc-psa      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Residuo percentuale                               *
      *            *---------------------------------------------------*
               10  w-det-per-inc-res      pic  9(03)v9(03)            .
      *            *---------------------------------------------------*
      *            * Segnale di presenza 'altri'                       *
      *            *---------------------------------------------------*
               10  w-det-per-inc-fpa      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Comodi                                            *
      *            *---------------------------------------------------*
               10  w-det-per-inc-s18      pic s9(18)                  .
      ...
      *            *---------------------------------------------------*
               10  w-col-tbl-col-tbl-r redefines
                   w-col-tbl-col-tbl.
                   15  w-col-tbl-col-ele occurs 12.
                       20  w-col-tbl-col-rgb
                                          pic  x(11)                  .
               10  w-col-tbl-col-inx      pic  9(02) value zero       .
               10  w-col-tbl-col-ctr      pic  9(03)                  .
               10  w-col-tbl-col-cod      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Associazione tabella colori                       *
      *            *---------------------------------------------------*
               10  w-col-tbl-col-ass.
                   15  w-col-tbl-col-max  pic  9(03) value 099        .
                   15  w-col-tbl-col-num  pic  9(03)                  .
                   15  w-col-tbl-col-ase occurs 99.
                       20  w-col-tbl-col-asc
                                          pic  9(05)                  .
                       20  w-col-tbl-col-pnt
                                          pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
      *              * Associazione preliminare colori a classificato- *
      *              * ri                                              *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-col-000  thru stp-srt-inp-col-999    .
       stp-srt-inp-050.
      *              *-------------------------------------------------*
      ...
      *    * Input procedure per sort                                  *
      *    *                                                           *
      *    * Subroutine di assegnazione del colore a ciascun elemento  *
      *    * classificatore richiesto                                  *
      *    *-----------------------------------------------------------*
       stp-srt-inp-col-000.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del classificatore       *
      *              *-------------------------------------------------*
           if        rr-tcs-pro           =    11
                     go to stp-srt-inp-col-500
           else      go to stp-srt-inp-col-100.
       stp-srt-inp-col-100.
      *              *-------------------------------------------------*
      *              * Se codici statistici                            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzatore numero elementi              *
      *                  *---------------------------------------------*
           move      zero                 to   w-col-tbl-col-num      .
      *                  *---------------------------------------------*
      *                  * Start per codice                            *
      *                  *---------------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      rr-tcs-pro           to   rf-zps-tip-cls         .
      ...
      *                  * Max su archivio [zps]                       *
      *                  *---------------------------------------------*
           if        rf-zps-tip-cls       not  = rr-tcs-pro
                     go to stp-srt-inp-col-190.
       stp-srt-inp-col-140.
      *                  *---------------------------------------------*
      *                  * Sel su archivio [zps]                       *
      ...
      *                  *---------------------------------------------*
           add       1                    to   w-col-tbl-col-num      .
           if        w-col-tbl-col-num    >    w-col-tbl-col-max
                     move   w-col-tbl-col-max
                                          to   w-col-tbl-col-num      .
       stp-srt-inp-col-160.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione elemento                    *
      *                  *---------------------------------------------*
           move      rf-zps-cod-cls       to   w-col-tbl-col-asc
                                              (w-col-tbl-col-num)     .
      *                  *---------------------------------------------*
      *                  * Assegnazione colore                         *
      *                  *---------------------------------------------*
           add       1                    to   w-col-tbl-col-inx      .
           if        w-col-tbl-col-inx    >    12
                     move  1              to   w-col-tbl-col-inx      .
           move      w-col-tbl-col-inx    to   w-col-tbl-col-pnt
                                              (w-col-tbl-col-num)     .
       stp-srt-inp-col-180.
      *                  *---------------------------------------------*
      *                  * A riciclo                                   *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-col-120.
       stp-srt-inp-col-190.
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-col-900.
       stp-srt-inp-col-500.
      *              *-------------------------------------------------*
      *              * Se codici statistici                            *
      *              *-------------------------------------------------*
      ...
      *                  * Bufferizzazione elemento                    *
      *                  *---------------------------------------------*
           move      rf-zp1-cod-cla       to   w-col-tbl-col-asc
                                              (w-col-tbl-col-num)     .
      *                  *---------------------------------------------*
      *                  * Assegnazione colore                         *
      *                  *---------------------------------------------*
      ...
      *                      * prodotto nell'ambito dell'agente        *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-ini-cic-150.
      *              *-------------------------------------------------*
      *              * Test sul tipo dettaglio di stampa               *
      *              *-------------------------------------------------*
           if        rr-tip-dts           =    03
                     go to prn-ini-cic-500.
       prn-ini-cic-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-cic-050.
      *              *-------------------------------------------------*
      *              * Se non sono state trattati almeno due agenti :  *
      ...
      *                  * Numero classi trattati per l'agente         *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-num-csp      .
      *                  *---------------------------------------------*
      *                  * Numero di agenti trattati in totale         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Normalizzazione buffer per grafico          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Numero elementi nel buffer              *
      *                      *-----------------------------------------*
           move      zero                 to   w-liv-age-buf-ctr      .
      *                      *-----------------------------------------*
      *                      * Max elementi nel buffer                 *
      *                      *-----------------------------------------*
           move      72                   to   w-liv-age-buf-max      .
      *                      *-----------------------------------------*
      *                      * Contatore elementi nel buffer           *
      *                      *-----------------------------------------*
           move      zero                 to   w-liv-age-buf-inx      .
       prn-ini-lr2-152.
           add       1                    to   w-liv-age-buf-inx      .
           if        w-liv-age-buf-inx    >    w-liv-age-buf-max
                     go to prn-ini-lr2-158.
           move      zero                 to   w-liv-age-buf-cod
                                              (w-liv-age-buf-inx)     .
           move      spaces               to   w-liv-age-buf-des
                                              (w-liv-age-buf-inx)     .
           move      zero                 to   w-liv-age-buf-per
                                              (w-liv-age-buf-inx)     .
           move      zero                 to   w-liv-age-buf-val
                                              (w-liv-age-buf-inx)     .
           move      spaces               to   w-liv-age-buf-col
                                              (w-liv-age-buf-inx)     .
           go to     prn-ini-lr2-152.
       prn-ini-lr2-158.
      *                  *---------------------------------------------*
      *                  * Oltre                                       *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       prn-fin-lr2-405.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo dettaglio   *
      *                  * stampa                                      *
      *                  *---------------------------------------------*
           if        rr-tip-dts           =    03
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr2-600.
      *                  *---------------------------------------------*
      *                  * Se stampa grafico tipo 'pie'                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se nessuna classe incontrata in totale  *
      *                      *-----------------------------------------*
           if        w-liv-age-num-csp    =    zero
                     go to prn-fin-lr2-999.
      *                      *-----------------------------------------*
      *                      * Subroutine di preparazione parametri di *
      *                      * stampa per grafico tipo 'pie'           *
      *                      *-----------------------------------------*
           perform   pre-prm-pie-000      thru pre-prm-pie-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     prn-fin-lr2-999.
      ...
      *                  *---------------------------------------------*
      *                  * Numero classi trattate per l'agente         *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-age-num-csp      .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr1-500.
      *              *-------------------------------------------------*
      *              * Se tipo dettaglio stampa 03, grafico tipo 'pie' *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento buffer elementi                  *
      *                  *---------------------------------------------*
           if        w-liv-age-buf-ctr    <    w-liv-age-buf-max
                     add  1               to   w-liv-age-buf-ctr      .
      *                  *---------------------------------------------*
      *                  * Codice per elemento                         *
      *                  *---------------------------------------------*
           move      w-liv-csp-cod-csp    to   w-liv-age-buf-cod
                                              (w-liv-age-buf-ctr)     .
      *                  *---------------------------------------------*
      *                  * Descrizione per elemento                    *
      *                  *---------------------------------------------*
           move      w-liv-csp-des-csp    to   w-liv-age-buf-des
                                              (w-liv-age-buf-ctr)     .
      *                  *---------------------------------------------*
      *                  * Valore per elemento                         *
      *                  *---------------------------------------------*
           move      w-liv-csp-tot-p1r    to   w-liv-age-buf-val
                                              (w-liv-age-buf-ctr)     .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-031.
           move      "PER AGENTE - 1. CODICE STATISTICO PRODOTTO        
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-032.
           move      "PER AGENTE - 2. CODICE STATISTICO PRODOTTO        
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-033.
           move      "PER AGENTE - 3. CODICE STATISTICO PRODOTTO        
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-034.
           move      "PER AGENTE - CLASSE MERCEOLOGICA PRODOTTO         
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
      ...
      *    *===========================================================*
      *    * Preparazione parametri per la stampa grafico tipo 'pie'   *
      *    *-----------------------------------------------------------*
       pre-prm-pie-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<BG"                to   p-edm                  .
           move      w-liv-age-tot-p1r    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Assemblaggio del titolo                     *
      *                  *---------------------------------------------*
      ...
      *
           if        rr-p1d-lit           =    spaces
                     move  w-stp-int-wed-dt0
                                          to   w-all-str-cat (4)
                     move  "-"            to   w-all-str-cat (5)
                     move  w-stp-int-wed-dt9
                                          to   w-all-str-cat (6)
           else      move  rr-p1d-lit     to   w-all-str-cat (4)
                     move  spaces         to   w-all-str-cat (5)
                     move  spaces         to   w-all-str-cat (6)      .
      *
           move      "- ["                to   w-all-str-cat (7)      .
           move      c-sgl                to   w-all-str-cat (8)      .
           move      p-edt                to   w-all-str-cat (9)      .
           move      "] )"                to   w-all-str-cat (10)     .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Assemblaggio nome Azienda                   *
      *                  *---------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      05                   to   w-all-str-num          .
           move      "("                  to   w-all-str-cat (1)      .
           move      w-stp-int-rag-azi    to   w-all-str-cat (2)      .
           move      "-"                  to   w-all-str-cat (3)      .
           move      p-edt                to   w-all-str-cat (4)      .
           move      ") 18 8"             to   w-all-str-cat (5)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       pre-prm-pie-200.
      *              *-------------------------------------------------*
      *              * Ciclo di preparazione linee successive          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Inizio ciclo                                *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-buf-inx      .
           move      zero                 to   w-liv-age-buf-inx      .
           move      1                    to   w-det-per-inc-res      .
           move      spaces               to   w-det-per-inc-fpa      .
       pre-prm-pie-220.
           add       1                    to   w-liv-age-buf-inx      .
           if        w-liv-age-buf-inx    >    w-liv-age-buf-ctr
                     go to pre-prm-pie-800.
           if        w-liv-age-buf-inx    >    w-liv-age-buf-max
                     go to pre-prm-pie-800.
      *                  *---------------------------------------------*
      *                  * Test su contenuto descrizione               *
      *                  *---------------------------------------------*
           if        w-liv-age-buf-des
                    (w-liv-age-buf-inx)   =    spaces
                     go to pre-prm-pie-220.
       pre-prm-pie-240.
      *                  *---------------------------------------------*
      *                  * Calcolo della percentuale di incidenza del  *
      *                  * singolo elemento con eventuale residuo da   *
      *                  * riportare sull'ultimo elemento              *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Totale da sottoporre al calcolo         *
      *                      *-----------------------------------------*
           move      w-liv-age-tot-p1r    to   w-det-per-inc-tot      .
      *                      *-----------------------------------------*
      *                      * Calcolo                                 *
      *                      *-----------------------------------------*
           divide    w-liv-age-buf-val
                    (w-liv-age-buf-inx)   by   w-det-per-inc-tot
                                        giving w-det-per-inc-per
                                        rounded                       .
      *                      *-----------------------------------------*
      *                      * Test se valore percentuale significati- *
      *                      * vo                                      *
      *                      *-----------------------------------------*
           if        w-det-per-inc-per    >    0,009
                     go to pre-prm-pie-250.
      *                           *------------------------------------*
      *                           * Attivazione segnale di 'altri'     *
      *                           *------------------------------------*
           move      "#"                  to   w-det-per-inc-fpa      .
      *                           *------------------------------------*
      *                           * A riciclo                          *
      *                           *------------------------------------*
           go to     pre-prm-pie-220.
      ...
      *                      * Residuo                                 *
      *                      *-----------------------------------------*
           subtract  w-det-per-inc-per    from w-det-per-inc-res      .
      *                      *-----------------------------------------*
      *                      * Percentuale per la stampa               *
      *                      *-----------------------------------------*
           multiply  w-det-per-inc-per    by   100
                                        giving w-det-per-inc-pds      .
       pre-prm-pie-255.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-liv-age-buf-inx    <    w-liv-age-buf-ctr
                     go to pre-prm-pie-260.
      *                          *-------------------------------------*
      *                          * Test su flag di altri elementi      *
      *                          *-------------------------------------*
           if        w-det-per-inc-fpa    not  = spaces
                     go to pre-prm-pie-260.
      *                          *-------------------------------------*
      *                          * Residuo sull'ultimo elemento        *
      *                          *-------------------------------------*
           add       w-det-per-inc-res    to   w-det-per-inc-per      .
       pre-prm-pie-260.
      *                      *-----------------------------------------*
      *                      * Editing percentuale per array           *
      *                      *-----------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      2                    to   p-car                  .
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-det-per-inc-per    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-det-per-inc-pal      .
           inspect   w-det-per-inc-pal
                                     replacing all ","
                                                by "."                .
      *                      *-----------------------------------------*
      *                      * Editing percentuale per la stampa       *
      *                      *-----------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      3                    to   p-car                  .
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-det-per-inc-pds    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-det-per-inc-psa      .
           inspect   w-det-per-inc-psa
                                     replacing all ","
                                                by "."                .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Parentesi di apertura elemento array    *
      *                      *-----------------------------------------*
           move      "[ ("                to   w-all-str-cat (1)      .
      *                      *-----------------------------------------*
      *                      * Descrizione elemento                    *
      *                      *-----------------------------------------*
           move      w-liv-age-buf-des
                    (w-liv-age-buf-inx)   to   w-all-str-cat (2)      .
      *                      *-----------------------------------------*
      *                      * Percentuale per la stampa               *
      *                      *-----------------------------------------*
           move      "~ ["                to   w-all-str-cat (3)      .
           move      w-det-per-inc-psa    to   w-all-str-cat (4)      .
           move      "% ]"                to   w-all-str-cat (5)      .
      *                      *-----------------------------------------*
      *                      * Chiusura descrizione elemento           *
      *                      *-----------------------------------------*
           move      ")"                  to   w-all-str-cat (6)      .
      *                      *-----------------------------------------*
      *                      * Percentuale                             *
      *                      *-----------------------------------------*
           move      w-det-per-inc-pal    to   w-all-str-cat (7)      .
       pre-prm-pie-270.
      *                      *-----------------------------------------*
      *                      * Colore elemento                         *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           move      "1.0 0.0 0.0"        to   w-all-str-cat (8)      .
      *                          *-------------------------------------*
      *                          * Normalizzazioni                     *
      *                          *-------------------------------------*
           move      w-liv-age-buf-cod
                    (w-liv-age-buf-inx)   to   w-col-tbl-col-cod      .
      ...
      *                          *-------------------------------------*
           ...
           if        w-col-tbl-col-ctr    >    w-col-tbl-col-num
                     go to pre-prm-pie-278.
           if        w-col-tbl-col-ctr    >    w-col-tbl-col-max
                     go to pre-prm-pie-278.
           if        w-col-tbl-col-cod    not  = w-col-tbl-col-asc
                                                (w-col-tbl-col-ctr)
                     go to pre-prm-pie-272.
           move      w-col-tbl-col-pnt
                    (w-col-tbl-col-ctr)   to   w-col-tbl-col-inx      .
           move      w-col-tbl-col-rgb
                    (w-col-tbl-col-inx)   to   w-liv-age-buf-col
                                              (w-liv-age-buf-inx)     .
           move      w-liv-age-buf-col
                    (w-liv-age-buf-inx)   to   w-all-str-cat (8)      .
       pre-prm-pie-278.
      *                      *-----------------------------------------*
      *                      * Parentesi di chiusura elemento array    *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       pre-prm-pie-800.
      *              *-------------------------------------------------*
      *              * Fine ciclo di scansione elementi                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su segnali di presenza 'altri'         *
      *                  *---------------------------------------------*
           if        w-det-per-inc-fpa    =    spaces
                     go to pre-prm-pie-880.
      *                  *---------------------------------------------*
      *                  * Test se residuo presente                    *
      *                  *---------------------------------------------*
           if        w-det-per-inc-res    not  > 0,009
                     go to pre-prm-pie-880.
       pre-prm-pie-820.
      *                  *---------------------------------------------*
      *                  * Rilascio elemento 'altri'                   *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Percentuale per la stampa               *
      *                      *-----------------------------------------*
           multiply  w-det-per-inc-res    by   100
                                        giving w-det-per-inc-pds      .
      *                      *-----------------------------------------*
      *                      * Editing percentuale per array           *
      *                      *-----------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-det-per-inc-res    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-det-per-inc-pal      .
           inspect   w-det-per-inc-pal
      ...
      *                      * Forzatura 'grigio'                      *
      *                      *-----------------------------------------*
           move      "0.5 0.5 0.5"        to   w-all-str-cat (8)      .
      *                      *-----------------------------------------*
      *                      * Parentesi di chiusura elemento array    *
      *                      *-----------------------------------------*
           move      "]"                  to   w-all-str-cat (9)      .
