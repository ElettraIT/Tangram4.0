      ...
      *                       Ultima revisione:    NdK del 28/01/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvb5001:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STATISTICA SUL FATTURATO PER PRODOTTO  "       .
      ...
      *        *-------------------------------------------------------*
      *        * Tipo di codice prodotto da esporre in stampa          *
      *        *                                                       *
      *        *  - 01 : Anagrafico del prodotto                       *
      *        *  - 02 : per la casa Produttrice                       *
      *        *  - 03 : per il Fornitore preferenziale                *
      *        *-------------------------------------------------------*
           05  rr-tip-cpe                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Tipo di ordinamento per il prodotto                   *
      *        *                                                       *
      ...
      *        *  - 05 : Ordinamento per descrizione prodotto          *
      *        *  - 06 : Ordinamento per codice prodotto               *
      *        *                                                       *
      *        * Non significativo se selezionato un solo prodotto     *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Selezione su giacenza                                 *
      *        *                                                       *
      *        *  - 01 : Nessuna selezione                             *
      *        *  - 02 : Solo prodotti in giacenza al                  *
      *        *  - 02 : Solo prodotti senza giacenza al               *
      *        *-------------------------------------------------------*
           05  rr-sel-gia                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Data giacenza per selezione                           *
      *        *                                                       *
      *        * Non significativo se selezionate tutte le dipendenze  *
      *        * o se il campo precedente vale '01'                    *
      *        *-------------------------------------------------------*
           05  rr-dat-gia                 pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Opzioni di stampa                                     *
      *        *                                                       *
      *        *  - Spaces : No                                        *
      *        *  - X      : Si                                        *
      *        *                                                       *
      *        * Solo se data giacenza diversa da zero                 *
      *        *-------------------------------------------------------*
           05  rr-opz-stp.
      *            *---------------------------------------------------*
      *            * Giacenza                                          *
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-dcp.
               10  w-let-arc-dcp-num      pic  9(07)     value zero   .
               ...
               10  w-let-arc-dcp-exn      pic  9(07)     value zero   .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo di codice prodotto da esporre         *
      *        *-------------------------------------------------------*
           05  w-exp-tip-cpe.
               10  w-exp-tip-cpe-num      pic  9(02)       value 3    .
               10  w-exp-tip-cpe-lun      pic  9(02)       value 50   .
               10  w-exp-tip-cpe-tbl.
                   15  filler             pic  x(50) value
                  "Anagrafico del prodotto                           ".
                   15  filler             pic  x(50) value
                  "quello assegnato dalla casa Produttrice           ".
                   15  filler             pic  x(50) value
                  "quello assegnato dal Fornitore preferenziale      ".
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                   15  filler             pic  x(50) value
                  "solo il Totale per prodotto                       ".
                   15  filler             pic  x(50) value
                  "con la Lista documenti emessi per prodotto        ".
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-exp-num-pdr-t02.
               10  w-exp-num-pdr-nu2      pic  9(02)       value 6    .
               ...
               10  w-exp-num-pdr-tb2.
                  ...
                  "Due periodi, ma solo se il 2. periodo e' a zero   ".
                   15  filler             pic  x(50) value
                  "Un periodo, con margine su costo medio ponderato  ".
                   15  filler             pic  x(50) value
                  "Un periodo, con margine su ultimo costo d'acquisto".
                   15  filler             pic  x(50) value
                  "                                                  ".
               10  w-exp-num-pdr-tc2.
                   ...
                   15  filler             pic  9(02)       value 21   .
                   15  filler             pic  9(02)       value 22   .
                   15  filler             pic  9(02)       value 00   .
           05  w-exp-num-pdr-t03.
               10  w-exp-num-pdr-nu3      pic  9(02)       value 7    .
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Selezione su giacenza                      *
      *        *-------------------------------------------------------*
           05  w-exp-sel-gia.
               10  w-exp-sel-gia-num      pic  9(02)       value 3    .
               10  w-exp-sel-gia-lun      pic  9(02)       value 20   .
               10  w-exp-sel-gia-tbl.
      ...
      *        *-------------------------------------------------------*
           05  w-exp-opz-stp.
               10  w-exp-opz-stp-num      pic  9(02)       value 02   .
               10  w-exp-opz-stp-lun      pic  9(02)       value 15   .
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-150.
      *                  *---------------------------------------------*
      *                  * Tipo di codice prodotto da esporre          *
      *                  *---------------------------------------------*
           perform   acc-tip-cpe-000      thru acc-tip-cpe-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Selezione su giacenza                       *
      *                  *---------------------------------------------*
           perform   acc-sel-gia-000      thru acc-sel-gia-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Data giacenza                               *
      *                  *---------------------------------------------*
           perform   acc-dat-gia-000      thru acc-dat-gia-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * Tipo di codice prodotto da esporre              *
      *              *-------------------------------------------------*
           perform   pmt-tip-cpe-000      thru pmt-tip-cpe-999        .
      *              *-------------------------------------------------*
      *              * Tipo di dettaglio di stampa                     *
      *              *-------------------------------------------------*
      ...
      *              * Selezione su giacenza                           *
      *              *-------------------------------------------------*
           perform   pmt-sel-gia-000      thru pmt-sel-gia-999        .
      *              *-------------------------------------------------*
      *              * Opzioni di stampa                               *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt : Codice filtro di ordinamento e selezione anagra- *
      *    *          fica prodotti [dcp]                              *
      *    *-----------------------------------------------------------*
       pmt-fso-dcp-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di codice prodotto da esporre               *
      *    *-----------------------------------------------------------*
       pmt-tip-cpe-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Codice prodotto da esporre :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tip-cpe-999.
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento per prodotti                 *
      *    *-----------------------------------------------------------*
       pmt-tor-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt : Data giacenza                                    *
      *    *-----------------------------------------------------------*
       pmt-sel-gia-000.
      *              *-------------------------------------------------*
      *              * Test su dipendenze selezionate                  *
      *              *-------------------------------------------------*
           if        rr-dpz-inu           =    zero
                     go to pmt-sel-gia-999.
      *              *-------------------------------------------------*
      *              * Visualizzazione prompt                          *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Descrizione codice filtro per selezione *
      *    *                   ed ordinamento per il [dcp]             *
      *    *-----------------------------------------------------------*
       vis-des-fso-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo codice prodotto da esporre            *
      *    *-----------------------------------------------------------*
       acc-tip-cpe-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tip-cpe-lun    to   v-car                  .
           move      w-exp-tip-cpe-num    to   v-ldt                  .
           move      "APF#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      08                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-tip-cpe-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      rr-tip-cpe           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-tip-cpe-999.
       acc-tip-cpe-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-tip-cpe             .
       acc-tip-cpe-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-tip-cpe-100.
       acc-tip-cpe-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Tipo codice prodotto da esporre         *
      *    *-----------------------------------------------------------*
       vis-tip-cpe-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       acc-tor-pro-025.
      *                  *---------------------------------------------*
      *                  * Se impostato un codice numerico prodotto    *
      *                  * diverso da zero : nessuna accettazione      *
      *                  *---------------------------------------------*
           if        w-cod-zos-dcp-tco    not  = 1
                     go to acc-tor-pro-100
           else      go to acc-tor-pro-999.
       acc-tor-pro-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Selezione su giacenza                      *
      *    *-----------------------------------------------------------*
       acc-sel-gia-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-gia-lun    to   v-car                  .
           move      w-exp-sel-gia-num    to   v-ldt                  .
           move      "NCS#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      20                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-sel-gia-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      rr-sel-gia           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       acc-sel-gia-620.
      *                  *---------------------------------------------*
      *                  * Se la scelta implica o meno la data e le    *
      *                  * opzioni di stampa                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        rr-sel-gia           not  = 01
                     go to acc-sel-gia-650.
      *                      *-----------------------------------------*
      *                      * Normalizzazione data giacenza           *
      *                      *-----------------------------------------*
           move      zero                 to   rr-dat-gia             .
      *                      *-----------------------------------------*
      *                      * Normalizzazione opzioni di stampa       *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-sel-gia-100.
       acc-sel-gia-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Selezione su giacenza                   *
      *    *-----------------------------------------------------------*
       vis-sel-gia-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test su selezione giacenza              *
      *                      *-----------------------------------------*
           if        rr-sel-gia           =    01
                     go to acc-dat-gia-999.
      *                      *-----------------------------------------*
      *                      * Test su dipendenze selezionate          *
      *                      *-----------------------------------------*
           if        rr-dpz-inu           =    zero
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-dat-gia-100.
       acc-dat-gia-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Data giacenza                           *
      *    *-----------------------------------------------------------*
       vis-dat-gia-000.
      *              *-------------------------------------------------*
      *              * Test su dipendenze selezionate                  *
      ...
      *              *-------------------------------------------------*
      ...
      -              " 2. periodo !  "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-725.
      *              *-------------------------------------------------*
      *              * Controllo data giacenza                         *
      *              *-------------------------------------------------*
           if        rr-sel-gia           =    01
                     go to tdo-ric-sel-750.
           if        rr-dpz-inu           =    zero
                     go to tdo-ric-sel-750.
           if        rr-dat-gia           not  = zero
                     go to tdo-ric-sel-750.
           move      "Manca la data per determinare la giacenza !       
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-750.
      *              *-------------------------------------------------*
      ...
      *              * Tipo di codice prodotto da esporre              *
      *              *-------------------------------------------------*
           if        rr-tip-cpe           not  = 02 and
                     rr-tip-cpe           not  = 03
                     move  01             to   rr-tip-cpe             .
      *              *-------------------------------------------------*
      *              * Selezione su giacenza                           *
      *              *-------------------------------------------------*
           if        rr-sel-gia           not  = 02 and
                     rr-sel-gia           not  = 03
                     move  01             to   rr-sel-gia             .
      *              *-------------------------------------------------*
      *              * Data giacenza                                   *
      *              *-------------------------------------------------*
           if        rr-sel-gia           =    01
      ...
      *              *-------------------------------------------------*
           if        w-let-arc-dcp-num    =    w-let-arc-dcp-exn
      ...
      *              *-------------------------------------------------*
           move      w-let-arc-dcp-num    to   w-let-arc-dcp-exn      .
       let-arc-dcp-999.
           exit.
