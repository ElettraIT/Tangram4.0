      ...
      *                       Ultima revisione:    NdK del 16/09/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf3601:       *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per classe statistica cliente - classe sta- *
      *                    tistica prodotto.                           *
      *                                                                *
      ...
      *                *-----------------------------------------------*
      *                * Tipo record                                   *
      *                *   01 : Totale per classe statistica cliente   *
      *                *   02 : Totale per classe statistica prodotto  *
      *                *-----------------------------------------------*
                   15  kk0-tip-rec        pic  9(02)                  .
      *                *-----------------------------------------------*
      *                * Codice numerico classe statistica cliente     *
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Subchiave 1 : Per classe statistica cliente       *
      *            *---------------------------------------------------*
               10  srt-k01.
      *                *-----------------------------------------------*
      *                * Valore ABC                                    *
      *                *                                               *
      *                * Solo per tipo ordinamento classe statistica : *
      *                *                                               *
      ...
      *                *-----------------------------------------------*
      *                * Descrizione per classe statistica             *
      *                *                                               *
      *                * Solo per tipo ordinamento classe statistica : *
      *                *                                               *
      *                * - ABC decrescente sul fatturato               *
      ...
      *                *-----------------------------------------------*
      *                * Mnemonico per classe statistica               *
      *                *                                               *
      *                * Solo per tipo ordinamento classe statistica : *
      *                *                                               *
      *                * - Per mnemonico                               *
      ...
      *                *-----------------------------------------------*
      *                * Codice classe statistica                      *
      *                *                                               *
      *                * Per tutti i tipi ordinamento classe stati-    *
      *                * stica                                         *
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Codice classe statistica cliente                  *
      *            *---------------------------------------------------*
               10  srt-cod-csc.
      *                *-----------------------------------------------*
      *                * Codice classe statistica cliente, codice      *
      *                *-----------------------------------------------*
                   15  srt-cod-csc-cod    pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica cliente, mnemonico   *
      *                *-----------------------------------------------*
                   15  srt-cod-csc-mne    pic  x(05)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica cliente, descrizione *
      *                *-----------------------------------------------*
                   15  srt-cod-csc-des    pic  x(25)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica cliente, flag di e-  *
      *                * sistenza                                      *
      *                *-----------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  srt-val-abc.
      *                *-----------------------------------------------*
      *                * Valore ABC per la classe statistica cliente   *
      *                *-----------------------------------------------*
                   15  srt-val-abc-csc    pic s9(13)v9(03)            .
      *                *-----------------------------------------------*
      *                * Valore ABC per la classe statistica prodotto  *
      *                * nell'ambito della classe statistica cliente   *
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FATTURATO PER CLASSI CLIENTE E PRODOTTO "       .
      ...
      *        *-------------------------------------------------------*
      *        * Tipo classe statistica cliente selezionata            *
      *        *  - 01 : Zona                                          *
      *        *  - 02 : Categoria                                     *
      *        *  - 03 : Codice statistico 1 libero                    *
      *        *-------------------------------------------------------*
           05  rr-tcs-cli                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Codice classe statistica cliente selezionata          *
      *        *  - Se codice 00000 : Tutti i codici                   *
      *        *-------------------------------------------------------*
           05  rr-ccs-cli                 pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice classe statistica cliente selezionata, descri- *
      *        * zione                                                 *
      *        *  - Se codice 00000 : 'Tutti i codici      '           *
      *        *-------------------------------------------------------*
           05  rr-ccs-cli-des             pic  x(20)                  .
      *        *-------------------------------------------------------*
      *        * Tipo di dettaglio di stampa                           *
      *        *  - 01 : Solo il totale per ogni classe statistica di  *
      *        *         prodotto                                      *
      *        *  - 02 : Con la lista documenti emessi per ogni clas-  *
      *        *         se statistica di prodotto                     *
      *        *-------------------------------------------------------*
           05  rr-tip-dts                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Tipo di ordinamento per la classe statistica cliente  *
      ...
      *        *                                                       *
      *        * Non significativo se codice classe statistica cliente *
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-zst.
               10  w-let-arc-zst-flg      pic  x(01)     value spaces .
               10  w-let-arc-zst-tip      pic  9(02)     value zero   .
               10  w-let-arc-zst-cod      pic  9(05)     value zero   .
               10  w-let-arc-zst-des      pic  x(25)     value spaces .
               10  w-let-arc-zst-mne      pic  x(05)     value spaces .
               10  w-let-arc-zst-ext      pic  9(02)     value zero   .
               10  w-let-arc-zst-exc      pic  9(05)     value zero   .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-rot-l02.
      *            *---------------------------------------------------*
      *            * Codice numerico della classe statistica cliente   *
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Numero documenti trattati per la classe statisti- *
      *            * ca prodotto                                       *
      *            *---------------------------------------------------*
               10  w-liv-csp-num-doc      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Classe statistica cliente                             *
      *        *-------------------------------------------------------*
           05  w-liv-csc.
      *            *---------------------------------------------------*
      *            * Codice classe statistica cliente                  *
      ...
      *            *---------------------------------------------------*
      *            * Flag di esistenza per la classe statistica        *
      *            *---------------------------------------------------*
               10  w-liv-csc-flg-csc      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Flag di unita' di misura memorizzata              *
      *            *---------------------------------------------------*
               10  w-liv-csc-flg-umi      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore dell' unita' di misura memorizzata         *
      *            *---------------------------------------------------*
               10  w-liv-csc-val-umi      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Flag di numero decimali memorizzati               *
      *            *---------------------------------------------------*
               10  w-liv-csc-flg-dec      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore del numero decimali memorizzati            *
      *            *---------------------------------------------------*
               10  w-liv-csc-val-dec      pic  9(01)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' 1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csc-qta-p1r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale fatturato 1. periodo di riferimento        *
      *            *---------------------------------------------------*
      ...
      *            * Totale quantita' 2. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csc-qta-p2r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale fatturato 2. periodo di riferimento        *
      *            *---------------------------------------------------*
      ...
      *            * Totale quantita' 3. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csc-qta-p3r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale fatturato 3. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csc-tot-p3r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Numero classi statistiche prodotto trattati per   *
      *            * la classe statistica cliente                      *
      *            *---------------------------------------------------*
               10  w-liv-csc-num-csp      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *            *---------------------------------------------------*
      *            * Numero di classi statistiche cliente trattate in  *
      *            *  totale                                           *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Codice zona per il cliente                            *
      *        *-------------------------------------------------------*
           05  w-sel-fit-zon-cli          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice categoria per il cliente                       *
      *        *-------------------------------------------------------*
           05  w-sel-fit-cat-cli          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice statistico per il cliente                      *
      *        *-------------------------------------------------------*
           05  w-sel-fit-stt-cli          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice tipo classe statistica cliente                 *
      *        *-------------------------------------------------------*
           05  w-sel-fit-cod-csc          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Mnemonico tipo classe statistica cliente              *
      *        *-------------------------------------------------------*
           05  w-sel-fit-mne-csc          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione tipo classe statistica cliente            *
      *        *-------------------------------------------------------*
           05  w-sel-fit-des-csc          pic  x(25)                  .
      *        *-------------------------------------------------------*
      *        * Flag di tipo classe statistica cliente esistente      *
      *        *-------------------------------------------------------*
           05  w-sel-fit-flg-csc          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Protocollo di rottura relativa a quadro cablato       *
      *        *                                                       *
      *        * ELETTRA                                               *
      *        *-------------------------------------------------------*
           05  w-sel-fit-prt-fqc          pic  9(09)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-sel-fir-s01-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice statistico 2 del prodotto                      *
      *        *-------------------------------------------------------*
           05  w-sel-fir-s02-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice statistico 3 del prodotto                      *
      *        *-------------------------------------------------------*
           05  w-sel-fir-s03-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Classe statistica, codice numerico                    *
      *        *-------------------------------------------------------*
           05  w-sel-fir-cod-csp          pic  9(05)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-sel-fir-mne-csp          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Classe statistica, numero di sequenza                 *
      *        *-------------------------------------------------------*
           05  w-sel-fir-nsq-csp          pic  9(07)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Stampa dei totali per le quantita' non      *
      *                  * omogenee nelle statistiche sul fatturato    *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione protocollo di rottura relativa  *
      *              * a quadro cablato                                *
      *              *                                                 *
      *              * ELETTRA                                         *
      *              *-------------------------------------------------*
           move      zero                 to   w-sel-fit-prt-fqc      .
      *              *-------------------------------------------------*
      ...
      *                      * Codice zona per il cliente              *
      *                      *-----------------------------------------*
           move      w-let-cli-dcc-zon    to   w-sel-fit-zon-cli      .
      *                      *-----------------------------------------*
      *                      * Codice categoria per il cliente         *
      *                      *-----------------------------------------*
           move      w-let-cli-dcc-cat    to   w-sel-fit-cat-cli      .
      *                      *-----------------------------------------*
      *                      * Test se Area Manager diverso            *
      *                      *                                         *
      *                      * ELETTRA                                 *
      *                      *-----------------------------------------*
           if        rf-fit-cod-ime       =    zero
                     go to sel-fit-rec-190.
           move      rf-fit-cod-ime       to   w-sel-fit-cat-cli      .
       sel-fit-rec-190.
      *                      *-----------------------------------------*
      *                      * Codice statistico per il cliente        *
      *                      *-----------------------------------------*
           move      w-let-cli-dcc-stt    to   w-sel-fit-stt-cli      .
       sel-fit-rec-200.
      *              *-------------------------------------------------*
      *              * Selezione su codice classe statistica cliente   *
      *              *-------------------------------------------------*
       sel-fit-rec-225.
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda del tipo di classe     *
      *                  * statistica cliente selezionata              *
      *                  *---------------------------------------------*
           if        rr-tcs-cli           =    01
                     go to sel-fit-rec-250
           else if   rr-tcs-cli           =    02
                     go to sel-fit-rec-275
           else if   rr-tcs-cli           =    03
                     go to sel-fit-rec-300.
       sel-fit-rec-250.
      *                  *---------------------------------------------*
      *                  * Se tipo di classe statistica cliente : 01,  *
      *                  * zona                                        *
      *                  *---------------------------------------------*
       sel-fit-rec-255.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-ccs-cli           not  = zero          and
                     rr-ccs-cli           not  = w-sel-fit-zon-cli
                     go to sel-fit-rec-900.
       sel-fit-rec-260.
      *                      *-----------------------------------------*
      *                      * Lettura [zst] per la zona               *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Lettura                             *
      *                          *-------------------------------------*
           move      01                   to   w-let-arc-zst-tip      .
           move      w-sel-fit-zon-cli    to   w-let-arc-zst-cod      .
      ...
      *                              * Codice zona                     *
      *                              *---------------------------------*
           move      w-let-arc-zst-cod    to   w-sel-fit-cod-csc      .
      *                              *---------------------------------*
      *                              * Descrizione zona                *
      *                              *---------------------------------*
           move      w-let-arc-zst-des    to   w-sel-fit-des-csc      .
      *                              *---------------------------------*
      *                              * Mnemonico zona                  *
      *                              *---------------------------------*
           move      w-let-arc-zst-mne    to   w-sel-fit-mne-csc      .
      *                              *---------------------------------*
      *                              * Flag di zona esistente          *
      *                              *---------------------------------*
           move      w-let-arc-zst-flg    to   w-sel-fit-flg-csc      .
       sel-fit-rec-265.
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
       ...
       sel-fit-rec-275.
      *                  *---------------------------------------------*
      *                  * Se tipo di classe statistica cliente : 02,  *
      *                  * categoria                                   *
      *                  *---------------------------------------------*
       sel-fit-rec-280.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-ccs-cli           not  = zero          and
                     rr-ccs-cli           not  = w-sel-fit-cat-cli
                     go to sel-fit-rec-900.
       sel-fit-rec-285.
      *                      *-----------------------------------------*
      *                      * Lettura [zst] per la categoria          *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Lettura                             *
      *                          *-------------------------------------*
           move      02                   to   w-let-arc-zst-tip      .
           move      w-sel-fit-cat-cli    to   w-let-arc-zst-cod      .
           perform   let-arc-zst-000      thru let-arc-zst-999        .
      *                          *-------------------------------------*
      *                          * Dati letti in area di comodo        *
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       sel-fit-rec-300.
      *                  *---------------------------------------------*
      *                  * Se tipo di classe statistica cliente : 03,  *
      *                  * codice statistico                           *
      *                  *---------------------------------------------*
       sel-fit-rec-305.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-ccs-cli           not  = zero          and
                     rr-ccs-cli           not  = w-sel-fit-stt-cli
                     go to sel-fit-rec-900.
       sel-fit-rec-310.
      *                      *-----------------------------------------*
      *                      * Lettura [zst] per il codice statistico  *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Lettura                             *
      *                          *-------------------------------------*
           move      03                   to   w-let-arc-zst-tip      .
           move      w-sel-fit-stt-cli    to   w-let-arc-zst-cod      .
           perform   let-arc-zst-000      thru let-arc-zst-999        .
      *                          *-------------------------------------*
      *                          * Dati letti in area di comodo        *
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      w-let-arc-zst-des    to   w-sel-fit-des-csc      .
      *                              *---------------------------------*
      *                              * Mnemonico codice statistico     *
      *                              *---------------------------------*
           move      w-let-arc-zst-mne    to   w-sel-fit-mne-csc      .
      *                              *---------------------------------*
      *                              * Flag di codice stat. esistente  *
      *                              *---------------------------------*
           move      w-let-arc-zst-flg    to   w-sel-fit-flg-csc      .
       sel-fit-rec-315.
      *                      *-----------------------------------------*
      ...
      *                      * Classe merceologica del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-cla    to   w-sel-fir-cla-pro      .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-gru    to   w-sel-fir-gru-pro      .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico del prodotto   *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-sgr    to   w-sel-fir-sgr-pro      .
      *                      *-----------------------------------------*
      *                      * Codice statistico 1 del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-s01    to   w-sel-fir-s01-pro      .
      *                      *-----------------------------------------*
      *                      * Codice statistico 2 del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-s02    to   w-sel-fir-s02-pro      .
      *                      *-----------------------------------------*
      *                      * Codice statistico 3 del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-s03    to   w-sel-fir-s03-pro      .
       sel-fir-rec-100.
      *              *-------------------------------------------------*
      *              * Quadri cablati                                  *
      *              *                                                 *
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su tipo ordinamento: solo classe sta-  *
      *                  * tistica 2                                   *
      *                  *---------------------------------------------*
           if        rr-tcs-pro           not  = 2
                     go to sel-fir-rec-200.
      *                  *---------------------------------------------*
      *                  * Test su flag di riga appartenente a quadro  *
      *                  *---------------------------------------------*
           if        rf-fir-bld-rgb       not  = 9
                     go to sel-fir-rec-200.
      *                  *---------------------------------------------*
      *                  * Test di rottura su protocollo fattura       *
      *                  *---------------------------------------------*
           if        w-sel-fit-prt-fqc    =    rf-fit-num-prt
                     go to sel-fir-rec-900.
           if        w-sel-fit-prt-fqc    =    zero
                     move  rf-fit-num-prt to   w-sel-fit-prt-fqc      .
      *                  *---------------------------------------------*
      *                  * Aggiornamento rottura                       *
      *                  *---------------------------------------------*
           move      rf-fit-num-prt       to   w-sel-fit-prt-fqc      .
      *                  *---------------------------------------------*
      *                  * Forzature per codice statistico 2           *
      *                  *---------------------------------------------*
           move      999                  to   w-sel-fir-s02-pro      .
           move      999                  to   w-let-arc-dcp-s02      .
      *                  *---------------------------------------------*
      *                  * Forzatura quantita'                         *
      *                  *---------------------------------------------*
           move      1                    to   w-mod-fat-fir-qta      .
      *                  *---------------------------------------------*
      *                  * Forzatura fatturato                         *
      *                  *---------------------------------------------*
           add       rf-fit-tot-rig (01)
                     rf-fit-tot-rig (02)
                     rf-fit-tot-rig (03)
                     rf-fit-tot-rig (04)
                     rf-fit-tot-rig (05)
                     ...
                     rf-fit-tot-rig (08)
                     rf-fit-tot-rig (09)
                                        giving w-mod-fat-fir-val      .
           subtract  rf-fit-tot-scc       from w-mod-fat-fir-val      .
      *                  *---------------------------------------------*
      *                  * ELETTRA                                     *
      *                  *                                             *
      *                  * Fine                                        *
      ...
      *                      * Classe statistica, codice numerico      *
      *                      *-----------------------------------------*
           move      w-let-arc-csp-cod    to   w-sel-fir-cod-csp      .
      *                      *-----------------------------------------*
      *                      * Classe statistica, descrizione          *
      *                      *-----------------------------------------*
           move      w-let-arc-csp-des    to   w-sel-fir-des-csp      .
      *                      *-----------------------------------------*
      *                      * Classe statistica, mnemonico            *
      *                      *-----------------------------------------*
           move      w-let-arc-csp-mne    to   w-sel-fir-mne-csp      .
      *                      *-----------------------------------------*
      *                      * Classe statistica, numero di sequenza   *
      *                      *-----------------------------------------*
           move      w-let-arc-csp-nsq    to   w-sel-fir-nsq-csp      .
      *                      *-----------------------------------------*
      *                      * Classe statistica, flag di esistenza    *
      *                      *-----------------------------------------*
           move      w-let-arc-csp-flg    to   w-sel-fir-flg-csp      .
       sel-fir-rec-400.
      *              *-------------------------------------------------*
      *              * Uscita per selezione superata                   *
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rr-tor-csc           not  = 01 and
                     ...
                     rr-tor-csc           not  = 04 and
                     rr-tor-csc           not  = 05 and
                     rr-tor-csc           not  = 07
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-des-csp    to   srt-k02-des-csp        .
       cmp-srt-rec-325.
      *                      *-----------------------------------------*
      *                      * Mnemonico per la classe statistica      *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-mne-csp    to   srt-k02-mne-csp        .
       cmp-srt-rec-330.
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-nsq-csp    to   srt-k02-mne-csp        .
       cmp-srt-rec-340.
      *                      *-----------------------------------------*
      *                      * Codice classe statistica prodotto       *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-cod-csp    to   srt-k02-cod-csp        .
       cmp-srt-rec-400.
      *                  *---------------------------------------------*
      *                  * Subchiave 3 : Per documento                 *
      *                  *---------------------------------------------*
      ...
      *                      * Codice numerico                         *
      *                      *-----------------------------------------*
           move      w-sel-fir-cod-csp    to   srt-cod-csp-cod        .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      *                      *-----------------------------------------*
           move      w-sel-fir-des-csp    to   srt-cod-csp-des        .
      *                      *-----------------------------------------*
      *                      * Mnemonico                               *
      *                      *-----------------------------------------*
           move      w-sel-fir-mne-csp    to   srt-cod-csp-mne        .
      *                      *-----------------------------------------*
      *                      * Numero di sequenza                      *
      *                      *-----------------------------------------*
           move      w-sel-fir-nsq-csp    to   srt-cod-csp-nsq        .
      *                      *-----------------------------------------*
      *                      * Flag di esistenza                       *
      *                      *-----------------------------------------*
           move      w-sel-fir-flg-csp    to   srt-cod-csp-flg        .
       cmp-srt-rec-875.
      *                  *---------------------------------------------*
      *                  * Cliente                                     *
      *                  *---------------------------------------------*
      ...
      *                      * Codice statistico 1                     *
      *                      *-----------------------------------------*
           move      w-sel-fir-s01-pro    to   srt-cod-pro-s01        .
      *                      *-----------------------------------------*
      *                      * Codice statistico 2                     *
      *                      *-----------------------------------------*
           move      w-sel-fir-s02-pro    to   srt-cod-pro-s02        .
      *                      *-----------------------------------------*
      *                      * Codice statistico 3                     *
      *                      *-----------------------------------------*
           move      w-sel-fir-s03-pro    to   srt-cod-pro-s03        .
       cmp-srt-rec-925.
      *                  *---------------------------------------------*
      *                  * Estremi del documento                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Valore ABC per la classe statistica del *
      *                      * prodotto nell'ambito della classe       *
      *                      * statistica del cliente                  *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Solo se il tipo di ordinamento per classe   *
      *                  * statistica clienti tra i seguenti :         *
      ...
      *                  *---------------------------------------------*
      *                  * Solo se il tipo di ordinamento per classe   *
      *                  * statistica prodotti tra i seguenti :        *
      *                  *   - 01 : ABC decrescente sul fatturato      *
      *                  *   - 02 : ABC decrescente sulla quantita'    *
      *                  *   - 03 : ABC crescente sul fatturato        *
      *                  *   - 04 : ABC crescente sulla quantita'      *
      ...
      *                  *---------------------------------------------*
      *                  * Solo se il tipo di ordinamento per classe   *
      *                  * statistica prodotto tra i seguenti :        *
      *                  *   - 01 : ABC decrescente sul fatturato      *
      *                  *   - 02 : ABC decrescente sulla quantita'    *
      *                  *   - 03 : ABC crescente sul fatturato        *
      *                  *   - 04 : ABC crescente sulla quantita'      *
      ...
      *                  *---------------------------------------------*
      *                  * Numero di classi statistiche cliente trat-  *
      *                  * tate in totale                              *
      *                  *---------------------------------------------*
      ...
      *              * statistiche cliente : uscita senza alcuna a-    *
      *              * zione                                           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Inizializzazione work area per livello di rot-  *
      *              * tura per codice classe statistica cliente       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice classe statistica                    *
      *                  *---------------------------------------------*
      ...
      *                  * Flag di unita' di misura memorizzata        *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-csc-flg-umi      .
      *                  *---------------------------------------------*
      *                  * Valore dell' unita' di misura memorizzata   *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-csc-val-umi      .
      *                  *---------------------------------------------*
      *                  * Flag di numero decimali memorizzati         *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-csc-flg-dec      .
      *                  *---------------------------------------------*
      *                  * Valore del numero decimali memorizzati      *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csc-val-dec      .
      *                  *---------------------------------------------*
      *                  * Totale quantita' 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csc-qta-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 1. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * Totale quantita' 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csc-qta-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 2. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * Totale quantita' 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csc-qta-p3r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 3. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * tatr per la classe statistica cliente       *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csc-num-csp      .
      *                  *---------------------------------------------*
      *                  * Numero di classi statistiche cliente trat-  *
      *                  * tate in totale                              *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tpc-pdv           =    02
                     move  w-liv-csc-qta-p1r
                                          to   w-stp-clc-pdv-v01
                     move  w-liv-csc-qta-p2r
                                          to   w-stp-clc-pdv-v02
                     move  w-liv-csc-qta-p3r
                                          to   w-stp-clc-pdv-v03
           else      move  w-liv-csc-tot-p1r
                                          to   w-stp-clc-pdv-v01
                     move  w-liv-csc-tot-p2r
                                          to   w-stp-clc-pdv-v02
                     move  w-liv-csc-tot-p3r
                                          to   w-stp-clc-pdv-v03      .
           perform   stp-clc-pdv-000      thru stp-clc-pdv-999        .
       prn-fin-lr2-125.
      *              *-------------------------------------------------*
      *              * Determinazione valore del campo 'Note' per il   *
      *              * totale classe statistica cliente                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione                                *
      *                  *---------------------------------------------*
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-csc-qta-p1r    to   w-mod-not-svf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
      ...
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-csc-qta-p2r    to   w-mod-not-svf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-csc-qta-p3r    to   w-mod-not-svf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr2-420.
      *                  *---------------------------------------------*
      *                  * Stampa totale classe statistica             *
      *                  *---------------------------------------------*
       prn-fin-lr2-430.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      ...
      -              "      "             to   w-stp-sta-tot-lit      .
       ...
       prn-fin-lr2-432.
           move      "Totale categoria :                                
      -              "      "             to   w-stp-sta-tot-lit      .
           go to     prn-fin-lr2-440.
       prn-fin-lr2-433.
           move      "Totale codice statistico :                        
      -              "      "             to   w-stp-sta-tot-lit      .
           go to     prn-fin-lr2-440.
       prn-fin-lr2-440.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-prs-svf-tqn-snx    =    "N"
                     if    w-liv-csc-flg-umi
                                          =    "N"
                           move  "N"      to   w-stp-sta-tot-snq
                     else  move  "S"      to   w-stp-sta-tot-snq
           else      move  "S"            to   w-stp-sta-tot-snq      .
           move      w-liv-csc-val-dec    to   w-stp-sta-tot-dec      .
           move      w-liv-csc-val-umi    to   w-stp-sta-tot-umi      .
           move      w-liv-csc-qta-p1r    to   w-stp-sta-tot-q01      .
           move      w-liv-csc-tot-p1r    to   w-stp-sta-tot-f01      .
           move      w-liv-csc-qta-p2r    to   w-stp-sta-tot-q02      .
           move      w-liv-csc-tot-p2r    to   w-stp-sta-tot-f02      .
           move      w-liv-csc-qta-p3r    to   w-stp-sta-tot-q03      .
      ...
      *                  * per la classe statistica cliente            *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-csc-num-csp      .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-qta-p1r    to   w-mod-not-svf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-tot-p1r    to   w-mod-not-svf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-qta-p2r    to   w-mod-not-svf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-tot-p2r    to   w-mod-not-svf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-svf-p01      .
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-qta-p3r    to   w-mod-not-svf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-tot-p3r    to   w-mod-not-svf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-svf-p02      .
      ...
      *                  *---------------------------------------------*
           if        w-liv-gen-flg-umi    =    spaces
                     ...
                     move  spaces         to   w-liv-gen-val-umi      .
      *                  *---------------------------------------------*
      *                  * Per livello classe statistica cliente       *
      *                  *---------------------------------------------*
           if        w-liv-csc-flg-umi    =    spaces
                     move  "S"            to   w-liv-csc-flg-umi
                     move  srt-cod-pro-umi
                                          to   w-liv-csc-val-umi
           else if   w-liv-csc-val-umi    not  = srt-cod-pro-umi
                     move  "N"            to   w-liv-csc-flg-umi
                     move  spaces         to   w-liv-csc-val-umi      .
      *                  *---------------------------------------------*
      ...
      *                  * Per livello classe statistica cliente       *
      *                  *---------------------------------------------*
           if        w-liv-csc-flg-dec    =    spaces
                     move  "#"            to   w-liv-csc-flg-dec
                     move  srt-cod-pro-dec
                                          to   w-liv-csc-val-dec
           else if   w-liv-csc-val-dec    not  = srt-cod-pro-dec
                     move  9              to   w-liv-csc-val-dec      .
      *                  *---------------------------------------------*
      *                  * Per livello classe statistica prodotto      *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-250.
      *              *-------------------------------------------------*
      *              * Accumuli per livello classe statistica cliente  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Totali 1. periodo di riferimento            *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn1      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-csc-qta-p1r
                           add      srt-val-sta-val
                                          to   w-liv-csc-tot-p1r
                     else  subtract srt-val-sta-qta
                                          from w-liv-csc-qta-p1r
                           subtract srt-val-sta-val
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn2      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-csc-qta-p2r
                           add      srt-val-sta-val
                                          to   w-liv-csc-tot-p2r
                     else  subtract srt-val-sta-qta
                                          from w-liv-csc-qta-p2r
                           subtract srt-val-sta-val
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn3      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-csc-qta-p3r
                           add      srt-val-sta-val
                                          to   w-liv-csc-tot-p3r
                     else  subtract srt-val-sta-qta
                                          from w-liv-csc-qta-p3r
                           subtract srt-val-sta-val
      ...
      *                  *---------------------------------------------*
           if        rr-tcs-cli           =    01
                     go to stp-int-pag-035
           else if   rr-tcs-cli           =    02
                     go to stp-int-pag-040
           else if   rr-tcs-cli           =    03
                     go to stp-int-pag-045.
       stp-int-pag-035.
           if        rr-tcs-pro           =    01
                     go to stp-int-pag-036
           else if   rr-tcs-pro           =    02
                     go to stp-int-pag-037
           else if   rr-tcs-pro           =    03
                     go to stp-int-pag-038
           else      go to stp-int-pag-039.
       stp-int-pag-036.
           move      "PER ZONA DI APPARTENENZA DEI CLIENTI - 1. CODICE S
      -              "TATISTICO PRODOTTO            "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-037.
           move      "PER ZONA DI APPARTENENZA DEI CLIENTI - 2. CODICE S
      -              "TATISTICO PRODOTTO            "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-038.
           move      "PER ZONA DI APPARTENENZA DEI CLIENTI - 3. CODICE S
      -              "TATISTICO PRODOTTO            "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-039.
           move      "PER ZONA DI APPARTENENZA DEI CLIENTI - CLASSE MERC
      -              "EOLOGICA PRODOTTO             "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-040.
           if        rr-tcs-pro           =    01
                     go to stp-int-pag-041
           else if   rr-tcs-pro           =    02
                     go to stp-int-pag-042
           else if   rr-tcs-pro           =    03
                     go to stp-int-pag-043
           else      go to stp-int-pag-044.
       stp-int-pag-041.
           move      "PER CATEGORIA DI CLIENTE - 1. CODICE STATISTICO PR
      -              "ODOTTO                        "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-042.
           move      "PER CATEGORIA DI CLIENTE - 2. CODICE STATISTICO PR
      -              "ODOTTO                        "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-043.
           move      "PER CATEGORIA DI CLIENTE - 3. CODICE STATISTICO PR
      -              "ODOTTO                        "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-044.
           move      "PER CATEGORIA DI CLIENTE - CLASSE MERCEOLOGICA PRO
      -              "DOTTO                         "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-045.
           if        rr-tcs-pro           =    01
                     go to stp-int-pag-046
           else if   rr-tcs-pro           =    02
                     go to stp-int-pag-047
           else if   rr-tcs-pro           =    03
                     go to stp-int-pag-048
           else      go to stp-int-pag-049.
       stp-int-pag-046.
           move      "PER CLASSIFICAZIONE STATISTICA DEI CLIENTI - 1. CO
      -              "DICE STATISTICO PRODOTTO      "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-047.
           move      "PER CLASSIFICAZIONE STATISTICA DEI CLIENTI - 2. CO
      -              "DICE STATISTICO PRODOTTO      "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-048.
           move      "PER CLASSIFICAZIONE STATISTICA DEI CLIENTI - 3. CO
      -              "DICE STATISTICO PRODOTTO      "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-049.
           move      "PER CLASSIFICAZIONE STATISTICA DEI CLIENTI - CLASS
      -              "E MERCEOLOGICA PRODOTTO       "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
      *                  *---------------------------------------------*
      ...
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-sub-cod-num : Valore codice numerico            *
      *    *                                                           *
      *    *   - w-stp-sub-cod-alf : Valore codice alfanumerico        *
      *    *                                                           *
      ...
      *                          * Literal fisso                       *
      *                          *-------------------------------------*
           move      "Clienti non classificati per zona                 
      -              "                      "
      ...
      *                          * Literal fisso                       *
      *                          *-------------------------------------*
           move      "Clienti non classificati per categoria            
      -              "                      "
                                          to   w-stp-sub-ads-asx      .
      *                          *-------------------------------------*
      *                          * Continuazione                       *
      ...
      *                          * Literal fisso                       *
      *                          *-------------------------------------*
           move      "Clienti non classificati per codice statistico    
      -              "                      "
                                          to   w-stp-sub-ads-asx      .
      *                          *-------------------------------------*
      *                          * Continuazione                       *
      ...
      *                          *-------------------------------------*
           if        rr-tcs-pro           =    01 or
                     rr-tcs-pro           =    02 or
                     rr-tcs-pro           =    03
                     move  "Classe statistica prodotto                  
      -                    "            "
                                          to   w-stp-fnc-tit-asx
           else      move  "Classe merceologica prodotto                
      -                    "            "
                                          to   w-stp-fnc-tit-asx      .
      *                          *-------------------------------------*
      *                          * Continuazione                       *
      ...
      *    * del prodotto,del mnemonico della classe, e della descri-  *
      *    * zione                                                     *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
      ...
      *              *-------------------------------------------------*
           if        w-let-arc-zst-tip    =    w-let-arc-zst-ext and
                     w-let-arc-zst-cod    =    w-let-arc-zst-exc
      ...
      *              *-------------------------------------------------*
           move      w-let-arc-zst-tip    to   w-let-arc-zst-ext      .
           move      w-let-arc-zst-cod    to   w-let-arc-zst-exc      .
       let-arc-zst-999.
           exit.
