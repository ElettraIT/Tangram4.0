      ...
      *                       Ultima revisione:    NdK del 18/01/20    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf6001:       *
      *                                                                *
      ...
      *            *---------------------------------------------------*
      *            * Numero di sequenza per la classe                  *
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-liv-csp-cst-max      pic  9(02)     value 36     .
               10  w-liv-csp-cst-ctr      pic  9(02)                  .
               10  w-liv-csp-cst-ct1      pic  9(02)                  .
               10  w-liv-csp-cst-ct2      pic  9(02)                  .
               10  w-liv-csp-cst-ct3      pic  9(02)                  .
               10  w-liv-csp-cst-cst occurs 36.
      *                *-----------------------------------------------*
      *                * Descrizione classificatore                    *
      *                *-----------------------------------------------*
                   15  w-liv-csp-cst-des  pic  x(40)                  .
      *                *-----------------------------------------------*
      *                * Totale fatturato                              *
      *                *-----------------------------------------------*
                   15  w-liv-csp-cst-val  pic s9(13)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *    *===========================================================*
      *    * Work per routine det-vls-fit-000/999                      *
      *    *-----------------------------------------------------------*
       01  w-det-vls-fit.
      *        *-------------------------------------------------------*
      *        * Comodo per totale netto                               *
      *        *-------------------------------------------------------*
           05  w-det-vls-fit-tne          pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per totale cumulativo                          *
      *        *-------------------------------------------------------*
           05  w-det-vls-fit-tcu          pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per totale righe di addebito                   *
      *        *-------------------------------------------------------*
           05  w-det-vls-fit-rda          pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per contatore                                  *
      *        *-------------------------------------------------------*
           05  w-det-vls-fit-ctr          pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per totale imponibile                          *
      *        *-------------------------------------------------------*
           05  w-det-vls-fit-ibl          pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per totale imposta                             *
      *        *-------------------------------------------------------*
           05  w-det-vls-fit-imp          pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per totale documento                           *
      *        *-------------------------------------------------------*
           05  w-det-vls-fit-tot          pic s9(11)                  .
...
______*    perform   det-vls-fit-000      thru det-vls-fit-999        .
______*    move      w-det-vls-fit-tne    to   w-mod-fat-fir-val      .
      *                  *---------------------------------------------*
      *                  * ELETTRA                                     *
      *                  *                                             *
      *                  * Fine                                        *
      ...
      *    *===========================================================*
      *    * Determinazione valore statisstico [fit]                   *
      *    *                                                           *
      *    * Input: record[fit]                                        *
      *    *                                                           *
      *    * Mario: 22.01.20                                           *
      *    *-----------------------------------------------------------*
       det-vls-fit-000.
      *              *-------------------------------------------------*
      *              * Determinazione totale netto documento           *
      *              *                                                 *
      *              * Attenzione:                                     *
      *              * la determinazione del totale netto fattura-     *
      *              * to tiene conto delle attualio personalizza-     *
      *              * zioni per le statistiche; vale a dire:          *
      *              * - detrazione dello sconto in chiusura           *
      *              * - non detrazione dello sconto pagamento         *
      *              * - non detrazione delle spese aggiuntive         *
      *              * - non detrazione delle spese incasso            *
      *              * - non detrazione delle spese bollo              *
      *              * - accumulo delle righe di addebito              *
      *              *-------------------------------------------------*
           add       rf-fit-tot-rig (01)
                     rf-fit-tot-rig (02)
                     rf-fit-tot-rig (03)
                     ...
                     rf-fit-tot-rig (08)
                     rf-fit-tot-rig (09)
                                        giving w-det-vls-fit-tne      .
           subtract  rf-fit-tot-scc       from w-det-vls-fit-tne      .
      *              *-------------------------------------------------*
      *              * Determinazione totale cumulativo documento      *
      *              *-------------------------------------------------*
           move      w-det-vls-fit-tne    to   w-det-vls-fit-tcu      .
           subtract  rf-fit-tot-scp       from w-det-vls-fit-tcu      .
           if        rf-fit-spe-snx (1)   =    1
                     add  rf-fit-spe-imp (1)
                                          to   w-det-vls-fit-tcu      .
           if        rf-fit-spe-snx (2)   =    1
                     add  rf-fit-spe-imp (2)
                                          to   w-det-vls-fit-tcu      .
           if        rf-fit-spe-snx (3)   =    1
                     add  rf-fit-spe-imp (3)
                                          to   w-det-vls-fit-tcu      .
           if        rf-fit-spe-snx (4)   =    1
                     add  rf-fit-spe-imp (4)
                                          to   w-det-vls-fit-tcu      .
           if        rf-fit-spe-snx (5)   =    1
                     add  rf-fit-spe-imp (5)
                                          to   w-det-vls-fit-tcu      .
           if        rf-fit-spe-snx (6)   =    1
                     add  rf-fit-spe-imp (6)
                                          to   w-det-vls-fit-tcu      .
           add       rf-fit-tot-sic       to   w-det-vls-fit-tcu      .
           add       rf-fit-tot-sia       to   w-det-vls-fit-tcu      .
           add       rf-fit-tot-spb       to   w-det-vls-fit-tcu      .
      *              *-------------------------------------------------*
      *              * Determinazione castelletto iva                  *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-vls-fit-ibl      .
           move      zero                 to   w-det-vls-fit-imp      .
           move      zero                 to   w-det-vls-fit-ctr      .
       det-vls-fit-310.
           add       1                    to   w-det-vls-fit-ctr      .
           if        w-det-vls-fit-ctr    >    6
                     go to det-vls-fit-320.
           if        rf-fit-iva-cod
                    (w-det-vls-fit-ctr)   =    zero
                     go to det-vls-fit-310.
           add       rf-fit-iva-ibl
                    (w-det-vls-fit-ctr)   to   w-det-vls-fit-ibl      .
           add       rf-fit-iva-imp
                    (w-det-vls-fit-ctr)   to   w-det-vls-fit-imp      .
           go to     det-vls-fit-310.
       det-vls-fit-320.
           add       w-det-vls-fit-ibl
                     w-det-vls-fit-imp  giving w-det-vls-fit-tot      .
      *              *-------------------------------------------------*
      *              * Determinazione importo righe di addebito quale  *
      *              * differenza tra totale cumulato finora  e totale *
      *              * imponibile                                      *
      *              *-------------------------------------------------*
           subtract  w-det-vls-fit-tcu    from w-det-vls-fit-ibl
                                        giving w-det-vls-fit-rda      .
      *              *-------------------------------------------------*
      *              * Aggiornamento totale netto con totale addebiti  *
      *              *-------------------------------------------------*
           add       w-det-vls-fit-rda    to   w-det-vls-fit-tne      .
       det-vls-fit-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      zero                 to   w-liv-csp-cst-ctr      .
       prn-ini-cic-200.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-gen-grf           not  = "S"
                     go to prn-fin-lr1-390.
      *                      *-----------------------------------------*
      *                      * Incremento contatore                    *
      *                      *-----------------------------------------*
           add       1                    to   w-liv-csp-cst-ctr      .
      *                      *-----------------------------------------*
      *                      * Test se superato l'ultimo elemento      *
      *                      *-----------------------------------------*
           if        w-liv-csp-cst-ctr    >    w-liv-csp-cst-max
                     move  w-liv-csp-cst-max
                                          to   w-liv-csp-cst-ctr
                     move  "(ALTRI)"      to   w-liv-csp-cst-des
                                              (w-liv-csp-cst-max)
                     add   w-liv-csp-tot-p1r
                                          to   w-liv-csp-cst-val
                                              (w-liv-csp-cst-max)
                     go to prn-fin-lr1-390.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      w-liv-csp-des-csp    to   w-liv-csp-cst-des
                                              (w-liv-csp-cst-ctr)     .
           if        w-liv-csp-des-csp    =    spaces
                     move  "(Non Classificati)"
                                          to   w-liv-csp-cst-des
                                              (w-liv-csp-cst-ctr)     .
      *
           move      w-liv-csp-tot-p1r    to   w-liv-csp-cst-val
                                              (w-liv-csp-cst-ctr)     .
       prn-fin-lr1-390.
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-liv-csp-cst-ctr    to   m-gen-grf-num-prd      .
      *
           if        rr-tcs-pro           =    11
                     move  "Statistica per Classe"
                                          to   m-gen-grf-tit-grf
           else if   rr-tcs-pro           =    01
                     move  "Statistica Classificatore 1"
                                          to   m-gen-grf-tit-grf
           else if   rr-tcs-pro           =    02
                     move  "Statistica Classificatore 1"
                                          to   m-gen-grf-tit-grf
                     ...
                     move  "Statistica Classificatore 1"
                                          ...
                                          to   m-gen-grf-tit-grf      .
      *
           move      "svf600"             to   m-gen-grf-fil-nam      .
       exe-sqz-grf-200.
      *              *-------------------------------------------------*
      ...
      *              * Ciclo dati                                      *
      *              *-------------------------------------------------*
           move      zero                 to   w-liv-csp-cst-ct1      .
           move      1                    to   w-liv-csp-cst-ct2      .
           move      zero                 to   w-liv-csp-cst-ct3      .
       exe-sqz-grf-500.
           add       1                    to   w-liv-csp-cst-ct1      .
           add       1                    to   w-liv-csp-cst-ct3      .
           if        w-liv-csp-cst-ct1    >    36
                     go to exe-sqz-grf-800.
           if        w-liv-csp-cst-ct3    >    12
                     add   1              to   w-liv-csp-cst-ct2
                     move  1              to   w-liv-csp-cst-ct3      .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione                             *
      *                  *---------------------------------------------*
           move      w-liv-csp-cst-des
                    (w-liv-csp-cst-ct1)   to   m-gen-grf-mes-des
                                              (w-liv-csp-cst-ct2,
                                               w-liv-csp-cst-ct3)     .
           move      w-liv-csp-cst-val
                    (w-liv-csp-cst-ct1)   to   m-gen-grf-mes-val
                                              (w-liv-csp-cst-ct2,
                                               w-liv-csp-cst-ct3)     .
       exe-sqz-grf-600.
      *                  *---------------------------------------------*
