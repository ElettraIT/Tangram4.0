      ...
      *    *===========================================================*
      *    * Record logico file [hbs]                                  *
      *    *-----------------------------------------------------------*
           copy      "ele/bfo/fls/rec/rfhbs"                          .

      ******************************************************************
       Procedure Division                using f rf-hbs               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-hbs                 .
           move      zero                 to   rf-hbs-num-prt         .
           move      zero                 to   rf-hbs-num-prg         .
           move      zero                 to   rf-hbs-num-dst         .
           move      zero                 to   rf-hbs-num-pro         .
           move      zero                 to   rf-hbs-ide-dat         .
           move      zero                 to   rf-hbs-cod-rsm         .
           move      spaces               to   rf-hbs-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-hbs-num-prt       to   fil-num-prt            .
           move      rf-hbs-num-prg       to   fil-num-prg            .
           move      rf-hbs-num-dst       to   fil-num-dst            .
           move      rf-hbs-num-pro       to   fil-num-pro            .
           move      rf-hbs-ide-dat       to   fil-ide-dat            .
           move      rf-hbs-cod-rsm       to   fil-cod-rsm            .
           move      rf-hbs-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-hbs-num-prt       to   fil-num-prt-1          .
           move      rf-hbs-num-prg       to   fil-num-prg-1          .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-hbs-num-dst       to   fil-num-dst-2          .
           move      rf-hbs-num-prt       to   fil-num-prt-2          .
           move      rf-hbs-num-prg       to   fil-num-prg-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-hbs-num-pro       to   fil-num-pro-3          .
           move      rf-hbs-num-dst       to   fil-num-dst-3          .
           move      rf-hbs-num-prt       to   fil-num-prt-3          .
           move      rf-hbs-num-prg       to   fil-num-prg-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-hbs                 .
           move      fil-num-prt          to   rf-hbs-num-prt         .
           move      fil-num-prg          to   rf-hbs-num-prg         .
           move      fil-num-dst          to   rf-hbs-num-dst         .
           move      fil-num-pro          to   rf-hbs-num-pro         .
           move      fil-ide-dat          to   rf-hbs-ide-dat         .
           move      fil-cod-rsm          to   rf-hbs-cod-rsm         .
           move      fil-alx-exp          to   rf-hbs-alx-exp         .
       dec-fis-log-999.
           exit.
