      ...
      *                       Ultima revisione:    NdK del 03/04/21    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    - per file di esportazione                  *
      *                    - per selezione su protocollo               *
      *                                                                *
      *                    -----------------------------------------   *
      *                                                                *
      *                    File di esportazione :                      *
      *                                                                *
      *                    /abd/asc/tmp/bfo330.txt                     *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
           if        rf-bfr-num-prt       <    rr-npm-min or
                     rf-bfr-num-prt       >    rr-npm-max
                     go to stp-srt-inp-100.
       stp-srt-inp-120.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-bfr-num-mag       to   srt-num-mag            .
           ...
           move      rf-bfr-orf-num       to   srt-orf-num            .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "OO"                 to   g-ope                  .
           move      "seq "               to   g-nam                  .
           move      w-det-pth-fso-pat    to   g-pat                  .
      ...
      *              * Codice prodotto                                 *
      *              *-------------------------------------------------*
           move      srt-alf-mag          to   w-out-alf-mag          .
      *              *-------------------------------------------------*
      *              * Codice prodotto per la casa produttrice         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-aaq-cdp-pdt       to   w-out-cdp-pdt          .
       prn-liv-det-seq-300.
      *              *-------------------------------------------------*
      *              * Quantita'                                       *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<"                  to   p-edm                  .
           move      srt-orf-num          to   w-num-prt-ext          .
           move      w-num-prt-ext-saa    to   w-num-prt-cmp-saa      .
           move      w-num-prt-ext-prg    to   w-num-prt-cmp-prg      .
           move      w-num-prt-cmp        to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-out-orf-num          .
       prn-liv-det-seq-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "/abd/asc/tmp/bfo330.txt"
                                          to   w-det-pth-fso-pat      .
       det-pth-fso-999.
           exit.
