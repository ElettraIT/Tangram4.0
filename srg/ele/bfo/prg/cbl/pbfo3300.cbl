      ...
      *                       Ultima revisione:    NdK del 01/10/20    *
      *                    ------------------------------------------- *
      ...
      *              *-------------------------------------------------*
      *              * Prompt numero protocollo dal al                 *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      45                   to   v-car                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-dtr-min-000.
           ...
           move      13                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Con data registrazione dal :            al :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-dtr-min-999.
      ...
      *    *===========================================================*
      *    * Accettazione campo : Numero protocollo min                *
      *    *-----------------------------------------------------------*
       acc-num-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Accettazione campo : Numero protocollo max                *
      *    *-----------------------------------------------------------*
       acc-num-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
