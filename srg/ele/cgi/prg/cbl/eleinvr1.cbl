      ...
      *                       Ultima revisione:    NdK del 02/02/24    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    VERSIONE IN USO con Simple Color Picker     *
      *                                                                *
      *                    ELETTRA                                     *
      *                                                                *
      *================================================================*
      ...
      *              * Simple color picker                             *
      *              *-------------------------------------------------*
           perform   exe-cph-scp-000      thru exe-cph-scp-999        .
      *              *-------------------------------------------------*
      *              * Interlinee                                      *
      *              *-------------------------------------------------*
           display   "<br>"                                           .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Trattamento parametro 'height'              *
      *                  *---------------------------------------------*
           move      "60"                 to   w-exe-str-tdh          .
      *                  *---------------------------------------------*
      ...
      *    * Estrazione parametri                                      *
      *    *                                                           *
      *    * Subroutine per Simple Color Picker                        *
      *    *-----------------------------------------------------------*
       exe-cph-scp-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "90%>"                                           .
      *              *-------------------------------------------------*
      *              * Apertura cella tavolozza                        *
      *              *-------------------------------------------------*
           display   "<td class='td_nb'>"                             .
      *              *-------------------------------------------------*
      *              * Box tavolozza                                   *
      *              *-------------------------------------------------*
           display   "<div id='scp' name='scp'>"                      .
           display   "</div>"                                         .
      *              *-------------------------------------------------*
      *              * Box elementi bianchi                            *
      *              *-------------------------------------------------*
           display   "<div id='ceb' name='ceb'>"                      .
           display   "</div>"                                         .
      *              *-------------------------------------------------*
      *              * Colore selezionato                              *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-cph-scp-400.
      *              *-------------------------------------------------*
      *              * Apertura cella scelta responsabile              *
      *              *-------------------------------------------------*
           display   "<td id='box_rsp' name='box_rsp' class='td_nb'>" .
      *              *-------------------------------------------------*
