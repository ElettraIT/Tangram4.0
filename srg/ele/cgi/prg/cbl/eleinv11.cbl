      ...
      *                                                                *
      *                    Espansione riga prodotto per ubicazione     *
      *                                                                *
      *                    Richiamato da 'eleinv01' e 'eleinv02'       *
      *                                                                *
      *                    ELETTRA                                     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-exe-tot-qpr              pic s9(11)                  .
           05  w-exe-tot-qrl              pic s9(11)                  .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Trattamento giacenza e totale ubicazioni        *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-exe-tot-qpr          .
           move      zero                 to   w-exe-tot-qrl          .
       emi-cor-ubi-100.
      *              *-------------------------------------------------*
      *              * Start su [miu]                                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           add       rf-miu-qta-rlv       to   w-exe-tot-qrl          .
           add       rf-miu-qta-prs       to   w-exe-tot-qpr          .
       emi-cor-ubi-500.
      *              *-------------------------------------------------*
      *              * Apertura riga                                   *
      *              *-------------------------------------------------*
      ...
      *
           ...
           else      move  rf-miu-qta-prs to   v-num                  .
      *
      ...
      *              *-------------------------------------------------*
       ...
       emi-cor-ubi-800.
      *              *-------------------------------------------------*
      *              * Riciclo a ubicazione successiva                 *
      *              *-------------------------------------------------*
      ...
      *    * Emissione corpo documento                                 *
      *    *                                                           *
      *    * Subroutine per giacenza e totale quantita' rilevate       *
      *    *-----------------------------------------------------------*
       emi-cor-gia-000.
      *              *-------------------------------------------------*
      *              * Apertura riga                                   *
      ...
      *              * Prompt                                          *
      *              *-------------------------------------------------*
           display   "<td class='td_nb' align='right'><b>"            .
      *
           if        w-exe-tip-ope        =    "RL"
                     move  "TOTALE RILEVATA"
                                          to   w-all-str-cat (1)
           else      move  "TOTALE PRESUNTA"
                                          to   w-all-str-cat (1)      .
      *
           display   w-all-str-cat (1)                                .
           display   "<b></td>"                                       .
      *              *-------------------------------------------------*
      *              * Editing                                         *
      *              *-------------------------------------------------*
      ...
      *
           if        w-exe-tip-ope        =    "RL"
                     move w-exe-tot-qrl   to   v-num
           else      move w-exe-tot-qpr   to   v-num                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
