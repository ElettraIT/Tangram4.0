      ...
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Rilevazioni inventariali per ubicazione     *
      *                                                                *
      *                    ELETTRA                                     *
      *                                                                *
      *================================================================*
      ...
      *            * Literal ubicazioni                                *
      *            *---------------------------------------------------*
               10  w-det-qtu-pro-lit      pic  x(240)                 .
      ...
      *                  *---------------------------------------------*
       ...
       exe-cph-300.
      *              *-------------------------------------------------*
      *              * Livello '1': accettazione ubicazione            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Subroutine                                  *
      *                  *---------------------------------------------*
      ...
      *              * Modulo                                          *
      *              *-------------------------------------------------*
           display   "<form name='inv_001' id='inv_001' method='post' ac
      -              "tion=''>"                                       .
       exe-cph-lv0-300.
      *              *-------------------------------------------------*
      *              * Allineamento                                    *
      ...
      *              *-------------------------------------------------*
       ...
       exe-cph-lv1-520.
      *              *-------------------------------------------------*
      *              * Bottone di conferma ubicazione                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Apertura cella                              *
      *                  *---------------------------------------------*
           display   "<td id='cel_fip' name='cel_fip' class='td_nb'>" .
      *                  *---------------------------------------------*
      *                  * Emissione bottone                           *
      *                  *---------------------------------------------*
           move      "BT"                 to   h-ope                  .
           move      "but"                to   h-tip                  .
           move      "but_fip"            to   h-nam                  .
      ...
      *                  * Apertura cella                              *
      *                  *---------------------------------------------*
           display   "<td id='cel_fsu' name='cel_fsu' class='td_nb'>" .
      *                  *---------------------------------------------*
      *                  * Emissione bottone                           *
      *                  *---------------------------------------------*
           move      "BT"                 to   h-ope                  .
           move      "but"                to   h-tip                  .
           move      "but_fsu"            to   h-nam                  .
           move      spaces               to   h-cla                  .
           move      "../../icons/stop.png"
                                          to   h-src                  .
           move      "40"                 to   h-wdt                  .
      ...
      *                  * Messaggio                                   *
      *                  *---------------------------------------------*
           move      "INSERIRE UN CODICE UBICAZIONE!"
                                          to   w-exe-err-msg          .
      ...
      *                  *---------------------------------------------*
       ...
       exe-cph-lv1-new-100.
      *              *-------------------------------------------------*
      *              * Lettura codice ubicazione in input              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       exe-cph-lv1-ele-000.
      *              *-------------------------------------------------*
      *              * Lettura dati relativi all'ubicazione            *
      *              *-------------------------------------------------*
       exe-cph-lv1-ele-050.
      *              *-------------------------------------------------*
      *              * Apertura riga                                   *
      ...
      *                  *---------------------------------------------*
       ...
       exe-cph-lv1-ele-300.
      *              *-------------------------------------------------*
      *              * Quantita' presunta in ubicazione                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Editing                                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       exe-cph-lv1-ele-400.
      *              *-------------------------------------------------*
      *              * Quantita' rilevata in ubicazione                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Editing                                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "Ubicazione :"       to   w-all-str-cat (1)      .
           move      w-exe-cod-ubi        to   w-all-str-cat (2)      .
      ...
      *                  * Apertura cella                              *
      *                  *---------------------------------------------*
           display   "<td id='cel_ref' name='cel_ref' class='td_nb'>" .
      *                  *---------------------------------------------*
      *                  * Apertura bottone                            *
      *                  *---------------------------------------------*
           display   "<button type='button' "                         .
      ...
      *                      *-----------------------------------------*
      *                      * Solo ubicazione a spazi                 *
      *                      *-----------------------------------------*
           if        w-exe-cod-ubi        not  = spaces
                     go to exe-cph-lv2-inp-650.
      *                      *-----------------------------------------*
      *                      * Se giacenza negativa                    *
      *                      *-----------------------------------------*
      ...
      *                      * Codice numerico prodotto                *
      *                      *-----------------------------------------*
           move      rf-miu-num-mag       to   srt-pro-key            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       exe-cph-lv2-out-300.
      *              *-------------------------------------------------*
      *              * Determinazione castelletto ubicazioni           *
      *              *-------------------------------------------------*
      ...
      *    * Subroutine per livello '2'                                *
      *    *                                                           *
      *    * Sub-subroutine di determinazione castelletto ubicazioni   *
      *    *-----------------------------------------------------------*
       exe-cph-lv2-ubi-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione contatori                       *
      ...
      *              *-------------------------------------------------*
           ...
           move      01                   to   rf-miu-cod-dpz         .
           move      01                   to   rf-miu-tip-mag         .
           move      srt-pro-key          to   rf-miu-num-mag         .
      ...
      *                  *---------------------------------------------*
           if        rf-miu-num-mag       not  = srt-pro-key
                     go to  exe-cph-lv2-ubi-900.
       exe-cph-lv2-ubi-400.
      *              *-------------------------------------------------*
      *              * Test se ubicazione in corso di trattamento      *
      *              *-------------------------------------------------*
       exe-cph-lv2-ubi-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-miu-cod-ubi       to   w-exe-buf-ubi
                                              (w-exe-buf-ctr)         .
       exe-cph-lv2-ubi-800.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      ...
      *                  * Lettura prodotto                            *
      *                  *---------------------------------------------*
           move      rf-miu-num-mag       to   w-let-arc-dcp-num      .
      ...
      *                  *---------------------------------------------*
           move      rf-miu-num-mag       to   w-det-qtu-pro-num      .
           move      rf-miu-cod-ubi       to   w-det-qtu-pro-ubi      .
      ...
      *                  *---------------------------------------------*
           move      rf-miu-qta-prs       to   w-det-qtu-pro-res      .
      ...
      *              * Quantita' presunta                              *
      *              *-------------------------------------------------*
           perform   exe-cph-lv2-qpr-000  thru exe-cph-lv2-qpr-999    .
       exe-cph-lv2-rig-425.
      *              *-------------------------------------------------*
      *              * Quantita' rilevata                              *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   exe-cph-lv2-qtu-000  thru exe-cph-lv2-qtu-999    .
       exe-cph-lv2-rig-600.
      *              *-------------------------------------------------*
      *              * Assemblaggio castelletto ubicazioni             *
      *              *-------------------------------------------------*
           move      spaces               to   w-exe-buf-str          .
           move      zero                 to   w-exe-buf-c01          .
       exe-cph-lv2-rig-620.
           add       1                    to   w-exe-buf-c01          .
           if        w-exe-buf-c01        >    w-exe-buf-ctr
                     go to exe-cph-lv2-rig-650.
           if        w-exe-buf-c01        >    w-exe-buf-max
                     go to exe-cph-lv2-rig-650.
      *
           move      80                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      w-exe-buf-str        to   w-all-str-cat (1)      .
           move      w-exe-buf-ubi
                    (w-exe-buf-c01)       to   w-all-str-cat (2)      .
      *
           if        w-exe-buf-ctr        <    2             or
                     w-exe-buf-c01        =    w-exe-buf-ctr or
                     w-exe-buf-ubi
                    (w-exe-buf-c01)       =    spaces
                     move  spaces         to   w-all-str-cat (3)
           else      move  ","            to   w-all-str-cat (3)      .
      *
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   w-exe-buf-str          .
      *
           go to     exe-cph-lv2-rig-620.
       exe-cph-lv2-rig-650.
      *              *-------------------------------------------------*
      *              * Visualizzazione                                 *
      *              *-------------------------------------------------*
      ...
      *                  * Apertura cella                              *
      *                  *---------------------------------------------*
           display   "<td id='lit_ubi' name ='lit_ubi' align='left'><b>
      -              ""                                               .
      *                  *---------------------------------------------*
      *                  * Valore                                      *
      *                  *---------------------------------------------*
           display   w-exe-buf-str                                    .
      *                  *---------------------------------------------*
      *                  * Chiusura cella                              *
      *                  *---------------------------------------------*
           move      "ET"                 to   h-ope                  .
...
______*    else      move  spaces         to   w-exe-str-dsb          .
      ...
      *              *-------------------------------------------------*
           ...
           move      "S"                  to   p-sgn                  .
           move      "<D"                 to   p-edm                  .
           move      w-det-qtu-pro-res    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-all-str-cat (1)      .
      *              *-------------------------------------------------*
      *              * Editing quantita' in giacenza                   *
      *              *-------------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      08                   to   p-car                  .
...
______*    else      move  spaces         to   w-all-str-cat (1)      .
      ...
      *    * Subroutine per livello '2'                                *
      *    *                                                           *
      *    * Subroutine di visualizzazione quantita' presunta          *
      *    *-----------------------------------------------------------*
       exe-cph-lv2-qpr-000.
      *              *-------------------------------------------------*
      *              * Editing                                         *
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRO    "         to   f-key                  .
           move      rf-miu-tip-mag       to   rf-aaq-tip-mag         .
           move      rf-miu-num-mag       to   rf-aaq-num-pro         .
           move      "pgm/dcf/fls/ioc/obj/iofaaq"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      "HT"                 to   h-ope                  .
           move      "INVENTARIO PER UBICAZIONE {ELETTRA}"
                                          to   h-alf                  .
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   w-det-qtu-pro-lit      .
       det-qtu-pro-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [miu]                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      03                   to   w-all-str-num          .
           move      w-det-qtu-pro-lit    to   w-all-str-cat (1)      .
           move      ","                  to   w-all-str-cat (2)      .
      *
           if        w-det-qtu-pro-lit    =    spaces
                     move  spaces         to   w-all-str-cat (2)      .
      *
           move      rf-miu-cod-ubi       to   w-all-str-cat (3)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   w-det-qtu-pro-lit      .
       det-qtu-pro-800.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
