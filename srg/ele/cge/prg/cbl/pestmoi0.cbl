      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Estrazione archivio [moi]                   *
      *                                                                *
      *================================================================*
      ...
      *        * Codice fornitore                                      *
      *        *-------------------------------------------------------*
           05  w-wrk-dat-tgm              pic  9(07)                  .
           05  w-wrk-dat-tgm-r            redefines
               w-wrk-dat-tgm.
               10  w-wrk-dat-tgm-sec      pic  9(01)                  .
               10  w-wrk-dat-tgm-aaa      pic  9(02)                  .
               10  w-wrk-dat-tgm-mmm      pic  9(02)                  .
               10  w-wrk-dat-tgm-ggg      pic  9(02)                  .
           05  w-wrk-dat-xls              pic  x(08)                  .
           05  w-wrk-dat-xls-r            redefines
               w-wrk-dat-xls.
               10  w-wrk-dat-xls-ggg      pic  9(02)                  .
               10  w-wrk-dat-xls-tr1      pic  x(01)                  .
               10  w-wrk-dat-xls-mmm      pic  9(02)                  .
               10  w-wrk-dat-xls-tr2      pic  x(01)                  .
               10  w-wrk-dat-xls-aaa      pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-rgs.
           05  w-rdp.
               10  w-rdp-dat-reg          pic  x(08)                  .  07
               10  w-rdp-fil-001          pic  x(01)                  .  07
               10  w-rdp-prt-iva          pic  9(11)                  .  18
               10  w-rdp-fil-002          pic  x(01)                  .  07
               10  w-rdp-dat-doc          pic  x(08)                  .  25
               10  w-rdp-fil-003          pic  x(01)                  .  07
               10  w-rdp-num-doc          pic  x(10)                  .  35
               10  w-rdp-fil-004          pic  x(01)                  .  07
               10  w-rdp-tip-iva          pic  x(01)                  .  36
               10  w-rdp-fil-005          pic  x(01)                  .  07
               10  w-rdp-ibl-iva          pic +9(11),9(02)            .  48
               10  w-rdp-fil-006          pic  x(01)                  .  07
               10  w-rdp-cod-iva          pic  9(05)                  .  53
               10  w-rdp-fil-007          pic  x(01)                  .  07
               10  w-rdp-imp-iva          pic +9(11),9(02)            .  65
               10  w-rdp-fil-008          pic  x(01)                  .  07
               10  w-rdp-tot-doc          pic +9(11),9(02)            .  77
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Start su archivio [moi]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATDOC    "         to   f-key                  .
           move      "F"                  to   rf-moi-tip-rec         .
           move      1031231              to   rf-moi-dat-reg         .
           move      "pgm/cge/fls/ioc/obj/iofmoi"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale record [moi]                *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/cge/fls/ioc/obj/iofmoi"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-moi-cod-arc       not  = 2092
                     move  "#"            to   w-cnt-prn-flg-sub      .

           if        rf-moi-dat-doc       >    1031231
                     move  "#"            to   w-cnt-prn-flg-sub      .

           if        rf-moi-tip-iva       not  = 5
                     move  "#"            to   w-cnt-prn-flg-sub      .
      ...
      *              *-------------------------------------------------*
      *              * Memorizzazione dati [moi]                       *
      *              *-------------------------------------------------*
           move      rf-moi-dat-reg       to   w-wrk-dat-tgm          .
           move      w-wrk-dat-tgm-ggg    to   w-wrk-dat-xls-ggg      .
           move      "-"                  to   w-wrk-dat-xls-tr1      .
           move      w-wrk-dat-tgm-mmm    to   w-wrk-dat-xls-mmm      .
           move      "-"                  to   w-wrk-dat-xls-tr2      .
           move      w-wrk-dat-tgm-aaa    to   w-wrk-dat-xls-aaa      .
           move      w-wrk-dat-xls        to   w-rdp-dat-reg          .

           move      rf-moi-prt-iva       to   w-rdp-prt-iva          .

           move      rf-moi-dat-doc       to   w-wrk-dat-tgm          .
           move      w-wrk-dat-tgm-ggg    to   w-wrk-dat-xls-ggg      .
           move      "-"                  to   w-wrk-dat-xls-tr1      .
           move      w-wrk-dat-tgm-mmm    to   w-wrk-dat-xls-mmm      .
           move      "-"                  to   w-wrk-dat-xls-tr2      .
           move      w-wrk-dat-tgm-aaa    to   w-wrk-dat-xls-aaa      .
           move      w-wrk-dat-xls        to   w-rdp-dat-doc          .

           move      rf-moi-num-doc       to   w-rdp-num-doc          .
           move      rf-moi-tip-iva       to   w-rdp-tip-iva          .
           divide    100                  into rf-moi-ibl-iva (1)
                                        giving w-rdp-ibl-iva          .

           move      rf-moi-cod-iva (1)   to   w-rdp-cod-iva          .

           divide    100                  into rf-moi-imp-iva (1)
                                        giving w-rdp-imp-iva          .

           divide    100                  into rf-moi-tot-doc
                                        giving w-rdp-tot-doc          .


           move      "_"                  to   w-rdp-fil-001
                                               w-rdp-fil-002
                                               w-rdp-fil-003
                                               w-rdp-fil-004
                                               w-rdp-fil-005
