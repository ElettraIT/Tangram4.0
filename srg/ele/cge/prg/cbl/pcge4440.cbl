      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge4441:        *
      *                                                                *
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Data minima in data massima             *
      *                      *-----------------------------------------*
           move      rr-dat-ini           to   rr-dat-fin             .
      *                      *-----------------------------------------*
      *                      * Gestione giorno                         *
      *                      *-----------------------------------------*
