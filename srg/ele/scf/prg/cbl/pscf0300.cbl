      ...
      *                       Ultima revisione:    NdK del 19/07/01    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  w-tpm-tip-ope-max          pic  9(03)   value 038      .
      *        *-------------------------------------------------------*
      ...
      *
               ...
               10  filler                 pic  x(50) value
                 "Registrazione Fattura Fornitore CEE               " .
               10  filler                 pic  x(04) value
                 "FC  "                                               .
      *
      ...
      *
               ...
               10  filler                 pic  x(50) value
                 "Registrazione Fattura Fornitore Estero            " .
               10  filler                 pic  x(04) value
                 "FE  "                                               .
      *
      ...
      *            * Elementi tabella                                  *
      *            *---------------------------------------------------*
               10  w-tpm-tip-ope-ele occurs 038.
      *                *-----------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-upp.
           05  w-upp-des.
               10  w-upp-chr occurs 50    pic  x(01)                  .
           05  w-ctr                      pic  9(02)                  .
           05  w-upp-car.
      ...
      *                          *-------------------------------------*
           ...
           move      w-tpm-tip-ope-des
                    (w-cix-ctr-001)       to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   w-tes-des-key (1)      .
      ...
      *                  *---------------------------------------------*
           move      w-tes-des-top (1)    to   w-bla-emb-str          .
      ...
      *                  *---------------------------------------------*
           move      w-tes-des-top (1)    to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   w-tes-des-key (1)      .
       acc-des-top-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-mne (1)    to   w-bla-emb-str          .
      ...
      *                          *-------------------------------------*
           ...
           else if   w-tes-cod-top        =    0011 or
                     w-tes-cod-top        =    0022
                     go to acc-cau-cge-516
           else if   w-tes-cod-top        =    0033
