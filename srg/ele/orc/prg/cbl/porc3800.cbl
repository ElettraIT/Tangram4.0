      ...
      *                  * Data ordine min                             *
      *                  *---------------------------------------------*
           perform   acc-dor-min-000      thru acc-dor-min-999        .
      ...
      *                  * Data ordine max                             *
      *                  *---------------------------------------------*
           perform   acc-dor-max-000      thru acc-dor-max-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Data emissione ordine  dal :             al :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Consegna richiesta     dal :             al :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      13                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "----------------------[ SELEZIONI SU DOCUMENTI DI 
      -              "ENTRATA ]---------------------"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      15                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipo movimento di entrata  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-dor-min-999.
       acc-dor-min-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-dor-min             .
       acc-dor-min-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-dor-min-100.
       acc-dor-min-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Data ordine min                         *
      *    *-----------------------------------------------------------*
       vis-dor-min-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-dor-max-999.
       acc-dor-max-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-dor-max             .
       acc-dor-max-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-dor-max-100.
       acc-dor-max-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Data ordine max                         *
      *    *-----------------------------------------------------------*
       vis-dor-max-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      15                   to   w-cod-des-ybf-lin      .
           move      30                   to   w-cod-des-ybf-pos      .
           move      15                   to   w-cod-des-ybf-dln      .
      ...
      *                  *---------------------------------------------*
           ...
           move      "Manca il tipo movimento di entrata !"
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           move      zero                 to   rr-dor-min             .
           move      zero                 to   rr-dor-max             .
