      ...
      *                       Ultima revisione:    NdK del 03/01/25    *
      *                    ------------------------------------------- *
      ...
      *              * Elettra                                         *
      *              *-------------------------------------------------*
           perform   qry-liv-det-cnf-000  thru qry-liv-det-cnf-999    .
      *              *-------------------------------------------------*
      *              * Flag di conferma                                *
      *              *-------------------------------------------------*
           move      "PF"                 to   v-ope                  .
      ...
      *    * Interrogazione : Livello di dettaglio                     *
      *    *                                                           *
      *    * Subroutine per data confermata                            *
      *    *                                                           *
      *    * ELETTRA                                                   *
      *    *-----------------------------------------------------------*
       qry-liv-det-cnf-000.
      ...
      *              * Ad uscita                                       *
      *              *-------------------------------------------------*
           go to     qry-liv-det-cnf-900.
       qry-liv-det-cnf-200.
      *              *-------------------------------------------------*
      *              * Lettura riga ordine fornitore                   *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Richiesta   Prevista   Confermata      Ordine     
      -              "  Da evad  Da ricev  Fabb/Disp"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
