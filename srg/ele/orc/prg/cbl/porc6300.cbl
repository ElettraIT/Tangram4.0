      ...
      *                                   Fase:    orc630              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 18/07/95    *
      *                    ------------------------------------------- *
      *                                 Autore:    Alter s.r.l. - PD   *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma porc6301:        *
      *                                                                *
      *                    Lista assegnazioni ordini per cliente       *
      *                                                                *
      *                    VERSIONE SU MISURA PER ELETTRA PER          *
      *                                                                *
      *                    RICHIAMARE PORC6301 SU MISURA               *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       pmt-dcn-ric-000.
           ...
           move      16                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Fino a consegna richiesta  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-dcn-ric-999.
      ...
      *              *-------------------------------------------------*
       ...
       reg-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Normalizzazione data consegna richiesta max     *
      *              *-------------------------------------------------*
           if        rr-dcn-ric           =    zero
                     move  9999999        to   rr-dcn-ric             .
      *              *-------------------------------------------------*
