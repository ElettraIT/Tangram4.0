      ...
      *                       Ultima revisione:    NdK del 12/07/25    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Diverso trattamento di rf-ocr-flg-cnf       *
      *                                                                *
      *----------------------------------------------------------------*
      *                                                                *
      *                    NOTA IMPORTANTE                             *
      *                    ---------------                             *
      *                    Il programma viene eseguito in 'crontab'    *
      *                    dopo a:                                     *
      *                                                                *
      *                    - 'pagb5500' Chiusura forzata ordini di     *
      *                                 spedizione                     *
      *                                                                *
      *                    - 'pagb5600' Forzatura date di consegna     *
      *                                 righe ordini fornitori [ofr]   *
      *                                                                *
      *================================================================*
      ...
      *            * Protocollo ordine                                 *
      *            *---------------------------------------------------*
               10  kk0-ocr-prt            pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Progressivo riga ordine                           *
      *            *---------------------------------------------------*
               10  kk0-ocr-prg            pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Numero progressivo frammento                      *
      *            *---------------------------------------------------*
               10  kk0-ocr-frm            pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  kk0-dat.
      ...
      *            * Codice cliente                                    *
      *            *---------------------------------------------------*
               10  kk0-ocr-cli            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Codice numerico prodotto                          *
      *            *---------------------------------------------------*
               10  kk0-ocr-pro            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Data consegna richiesta aggiornata                *
      *            *---------------------------------------------------*
               10  kk0-ocr-dca            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Quantita' assegnata al frammento                  *
      *            *---------------------------------------------------*
               10  kk0-qta-ass             pic s9(10)v9(03)           .
      *            *---------------------------------------------------*
      *            * Estremi documento                                 *
      *            *---------------------------------------------------*
               10  kk0-ocr-num            pic  9(11)                  .
               10  kk0-ocr-dat            pic  9(07)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-agg.
      *        *-------------------------------------------------------*
      *        * Per aggiornamento riga ordine cliente                 *
      *        *-------------------------------------------------------*
           05  w-agg-rig-ocr.
      *            *---------------------------------------------------*
      *            * Contatore righe ordine                            *
      *            *---------------------------------------------------*
               10  w-agg-rig-ocr-ctr      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Comodi per distinta                               *
      *            *---------------------------------------------------*
               10  w-agg-rig-ocr-dst      pic  9(09)                  .
               10  w-agg-rig-ocr-dsp      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Estremi riga ordine                               *
      *            *---------------------------------------------------*
               10  w-agg-rig-ocr-prt      pic  9(11)                  .
               10  w-agg-rig-ocr-prg      pic  9(05)                  .
               10  w-agg-rig-ocr-pro      pic  9(07)                  .
               10  w-agg-rig-ocr-dcr      pic  9(07)                  .
               10  w-agg-rig-ocr-dca      pic  9(07)                  .
               10  w-agg-rig-ocr-eml      pic  x(80)                  .
               10  w-agg-rig-ocr-mit      pic  x(40)
                                        value  "documenti@elettra.it" .
      *            *---------------------------------------------------*
      *            * Comodo per messaggio                              *
      *            *---------------------------------------------------*
               10  w-agg-rig-ocr-msg      pic  x(80)                  .
      *            *---------------------------------------------------*
      *            * Comodo per rottura su protocollo ordine           *
      *            *---------------------------------------------------*
               10  w-agg-rig-ocr-rpr      pic  9(11)                  .

      *    *===========================================================*
      *    * Work per subroutines di attribuzione numero distinta      *
      *    *-----------------------------------------------------------*
       01  w-num-dst.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari per aggiornamento   *
      *              *-------------------------------------------------*
           move      zero                 to   w-agg-rig-ocr-ctr      .
       prn-ini-cic-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Creazione distinta a fronte aggiornamento date  *
      *              * di consegna                                     *
      *              *                                                 *
      *              * ELETTRA                                         *
      *              *                                                 *
      *              * ___ ATTUALMENTE INIBITA ___                     *
      *              *-------------------------------------------------*
           perform   prn-fin-cic-kk0-000  thru prn-fin-cic-kk0-999    .
       prn-fin-cic-999.
           exit.
      ...
      *    *                                                           *
      *    * Subroutine di aggiornamento file di appoggio              *
      *    *                                                           *
      *    * ELETTRA                                                   *
      *    *-----------------------------------------------------------*
       prn-fin-cic-kk0-000.
      *              *-------------------------------------------------*
      *              * Test su contatore elementi aggiornati           *
      *              *-------------------------------------------------*
           if        w-agg-rig-ocr-ctr    =    zero
                     go to prn-fin-cic-kk0-900.
       prn-fin-cic-kk0-100.
      *              *-------------------------------------------------*
      *              * Start su file [kk0]                             *
      *              *-------------------------------------------------*
      ...
      *                  * Composizione chiave                         *
      *                  *---------------------------------------------*
           move      zero                 to   kk0-ocr-prt            .
           move      zero                 to   kk0-ocr-prg            .
           move      zero                 to   kk0-ocr-frm            .
      *                  *---------------------------------------------*
      *                  * Operazione di Start                         *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-cic-kk0-300.
      *              *-------------------------------------------------*
      *              * Rottura su protocollo ordine cliente            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione data assegnazione           *
      *                  *---------------------------------------------*
           if        kk0-ocr-dca          =    zero
                     move  rr-dat-ela     to   kk0-ocr-dca            .
       prn-fin-cic-kk0-400.
      *              *-------------------------------------------------*
      *              * Assemblaggio elementi - I parte                 *
      *              *-------------------------------------------------*
           move      240                  to   w-all-str-lun          .
           move      08                   to   w-all-str-num          .
           move      """"                 to   w-all-str-cat (1)      .
           move      rr-dat-ela
                    (01 : 07)             to   w-all-str-cat (2)      .
           move      ";"                  to   w-all-str-cat (3)      .
           move      kk0-ocr-prt
                    (01 : 11)             to   w-all-str-cat (4)      .
           move      ";"                  to   w-all-str-cat (5)      .
           move      kk0-ocr-prg
                    (01 : 05)             to   w-all-str-cat (6)      .
           move      ";"                  to   w-all-str-cat (7)      .
           move      kk0-ocr-frm
                    (01 : 03)             to   w-all-str-cat (8)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
      *              *-------------------------------------------------*
      *              * Assemblaggio elementi - II parte                *
      *              *-------------------------------------------------*
           move      240                  to   w-all-str-lun          .
           ...
           move      kk0-qta-ass
                    (01 : 13)             to   w-all-str-cat (3)      .
           move      ";"                  to   w-all-str-cat (4)      .
           move      kk0-ocr-dca
                    (01 : 07)             to   w-all-str-cat (5)      .
           move      ";"                  to   w-all-str-cat (6)      .
           move      kk0-ocr-pro
                    (01 : 07)             to   w-all-str-cat (7)      .
           move      ";"                  to   w-all-str-cat (8)      .
           move      kk0-ocr-cli
                    (01 : 07)             to   w-all-str-cat (9)      .
           move      ";"                  to   w-all-str-cat (10)     .
           perform   all-str-cat-000      thru all-str-cat-999        .
      *              *-------------------------------------------------*
      *              * Assemblaggio elementi - III parte               *
      *              *-------------------------------------------------*
           move      240                  to   w-all-str-lun          .
           move      10                   to   w-all-str-num          .
           move      w-all-str-alf        to   w-all-str-cat (1)      .
      ...
      *              * Riciclo su [kk0]                                *
      *              *-------------------------------------------------*
           go to     prn-fin-cic-kk0-200.
       prn-fin-cic-kk0-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-fin-cic-kk0-999.
       prn-fin-cic-kk0-999.
           exit.
      ...
      *              * Normalizzazioni preliminari per aggiornamento   *
      *              *-------------------------------------------------*
           move      zero                 to   w-agg-rig-ocr-prt      .
           move      zero                 to   w-agg-rig-ocr-prg      .
           move      zero                 to   w-agg-rig-ocr-pro      .
           move      zero                 to   w-agg-rig-ocr-dcr      .
           move      zero                 to   w-agg-rig-ocr-dca      .
           move      spaces               to   w-agg-rig-ocr-eml      .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Aumento prudenziale di 5 giorni __________  *
      *                  *---------------------------------------------*
           move      w-det-buf-ass-dcp    to   w-det-dat-nrg-dtb      .
           move      5                    to   w-det-dat-nrg-ngi      .
           perform   det-dat-nrg-000      thru det-dat-nrg-999        .
           move      w-det-dat-nrg-dti    to   w-det-buf-ass-dcp      .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           add       1                    to   w-agg-rig-ocr-ctr      .
           move      srt-num-prt          to   w-agg-rig-ocr-prt      .
           move      srt-num-prg          to   w-agg-rig-ocr-prg      .
           move      rf-ocr-num-pro       to   w-agg-rig-ocr-pro      .
           move      rf-ocr-dcn-ric       to   w-agg-rig-ocr-dcr      .
           move      w-det-buf-ass-dcp    to   w-agg-rig-ocr-dca      .
      *                      *-----------------------------------------*
      ...
      *    display srt-num-prg.
      *    display "Prodotto : ".
      *    display rf-ocr-alf-pro.
      *    display "new/old  : ".
      *    display w-det-buf-ass-dcp.
      *    display rf-ocr-dcn-prv.
      *    display "---------------".
      ...
      *                      *-----------------------------------------*
______     move      "S"                  to   rf-ocr-flg-cnf         .
      *                  *---------------------------------------------*
      *                  * Update record [ocr]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Aggiornamento file di appoggio per azioni a fi- *
      *              * ne elaborazione                                 *
      *              *                                                 *
      *              * ELETTRA                                         *
      *              *-------------------------------------------------*
           perform   prn-liv-det-kk0-000  thru prn-liv-det-kk0-999    .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              * Test preliminari                                *
      *              *-------------------------------------------------*
           if        srt-num-prt          =    zero or
                     srt-num-prg          =    zero or
                     w-bas-ctr-001        =    zero
                     go to prn-liv-det-kk0-900.
       prn-liv-det-kk0-100.
      *              *-------------------------------------------------*
      *              * Test se il record è gia' esistente              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Chiave [kk0]                                *
      *                  *---------------------------------------------*
           move      srt-num-prt          to   kk0-ocr-prt            .
           move      srt-num-prg          to   kk0-ocr-prg            .
           move      w-bas-ctr-001        to   kk0-ocr-frm            .
      *                  *---------------------------------------------*
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           read      kk0    invalid key
                            go to   prn-liv-det-kk0-200.
           go to     prn-liv-det-kk0-900.
       prn-liv-det-kk0-200.
      *              *-------------------------------------------------*
      *              * Test se la data aggiornata e' uguale a quella   *
      *              * richiesta                                       *
      *              *-------------------------------------------------*
       prn-liv-det-kk0-300.
      *              *-------------------------------------------------*
      *              * Aggiornamento file [kk0]                        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Chiave [kk0]                                *
      *                  *---------------------------------------------*
      ...
      *                  * Dati [kk0]                                  *
      *                  *---------------------------------------------*
           move      srt-cod-arc          to   kk0-ocr-cli            .
           move      srt-num-mag          to   kk0-ocr-pro            .
           move      w-bas-dat-ass
                    (w-bas-ctr-001)       to   kk0-ocr-dca            .
           move      w-bas-qta-ass
                    (w-bas-ctr-001)       to   kk0-qta-ass            .
           move      srt-num-doc          to   kk0-ocr-num            .
           move      srt-dat-doc          to   kk0-ocr-dat            .
      *                  *---------------------------------------------*
      *                  * Scrittura file [kk0]                        *
      *                  *---------------------------------------------*
           write     kk0-rec                                          .
