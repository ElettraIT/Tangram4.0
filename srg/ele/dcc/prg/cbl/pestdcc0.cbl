      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Estrazione anagrafiche clienti              *
      *                                                                *
      *                    - .................                         *
      *                    - .................                         *
      *                    - .................                         *
      ...
      *    *-----------------------------------------------------------*
       01  w-rgs.
           05  w-rdp.
               10  w-rdp-cod-cli          pic  9(07)                  .
               10  w-rdp-dpz-cli          pic  x(04)                  .
               10  w-rdp-rag-soc          pic  x(40)                  .
               10  w-rdp-cod-age          pic  9(07)                  .
               10  w-rdp-cod-cat          pic  9(05)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale record [dcc]                *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
      *              * Memorizzazione dati [dcc]                       *
      *              *-------------------------------------------------*
           move      rf-dcc-cod-cli       to   w-rdp-cod-cli          .
           move      rf-dcc-dpz-cli       to   w-rdp-dpz-cli          .
           move      rf-dcc-rag-soc       to   w-rdp-rag-soc          .
           move      rf-dcc-cod-age       to   w-rdp-cod-age          .
           move      rf-dcc-cod-cat       to   w-rdp-cod-cat          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "    ESTRAZIONE ANAGRAFICA CLIENTI     "
