      ...
      *                       Ultima revisione:    NdK del 12/06/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Estrazione anagrafiche prodotti             *
      *                                                                *
      *                    - .................                         *
      *                    - .................                         *
      *                    - .................                         *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     ESTRAZIONE ANAGRAFICA PRODOTTI     "       .
      ...
      *        * Codice fornitore                                      *
      *        *-------------------------------------------------------*
           05  w-gen-cod-fnt              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per prezzo di listino                          *
      *        *-------------------------------------------------------*
           05  w-gen-wrk-lst              pic  9(07)v9(02)            .
      *        *-------------------------------------------------------*
      *        * Comodo per prezzo netto                               *
      *        *-------------------------------------------------------*
           05  w-gen-wrk-net              pic  9(07)v9(02)            .
      *        *-------------------------------------------------------*
      *        * Comodo per percentuale                                *
      *        *-------------------------------------------------------*
           05  w-gen-wrk-psr              pic  9(02)v9(03)            .
      ...
      *    *-----------------------------------------------------------*
       01  w-rgs.
           05  w-rdp.
               10  w-rdp-alf-pro          pic  x(14)                  .
               10  w-rdp-pev-001          pic  x(01)                  .
               10  w-rdp-des-pro          pic  x(40)                  .
               10  w-rdp-pev-002          pic  x(01)                  .
               10  w-rdp-cla-pro          pic  9(05)                  .
               10  w-rdp-pev-003          pic  x(01)                  .
               10  w-rdp-gru-pro          pic  9(05)                  .
               10  w-rdp-pev-004          pic  x(01)                  .
               10  w-rdp-sgr-pro          pic  9(05)                  .
               10  w-rdp-pev-005          pic  x(01)                  .
               10  w-rdp-prz-lst          pic  9(09)                  .
               10  w-rdp-pev-006          pic  x(01)                  .
               10  w-rdp-dcf-pfz          pic  9(07)                  .
               10  w-rdp-pev-007          pic  x(01)                  .
               10  w-rdp-cdp-pdt          pic  x(14)                  .
               10  w-rdp-pev-008          pic  x(01)                  .
               10  w-rdp-cop-sfn          pic  x(14)                  .
               10  w-rdp-pev-009          pic  x(01)                  .
               10  w-rdp-sgl-vlt          pic  x(03)                  .
               10  w-rdp-pev-010          pic  x(01)                  .
               10  w-rdp-prz-acq          pic  9(09)                  .
               10  w-rdp-pev-011          pic  x(01)                  .
               10  w-rdp-lst-acq          pic  9(07),9(02)            .
               10  w-rdp-pev-012          pic  x(01)                  .
               10  w-rdp-psr-001          pic  9(02),9(01)            .
               10  w-rdp-pev-013          pic  x(01)                  .
               10  w-rdp-psr-002          pic  9(02),9(01)            .
               10  w-rdp-pev-014          pic  x(01)                  .
               10  w-rdp-psr-003          pic  9(02),9(01)            .
               10  w-rdp-pev-015          pic  x(01)                  .
               10  w-rdp-psr-004          pic  9(02),9(01)            .
               10  w-rdp-pev-016          pic  x(01)                  .
               10  w-rdp-psr-005          pic  9(02),9(01)            .
               10  w-rdp-pev-017          pic  x(01)                  .
               10  w-rdp-net-acq          pic  9(07),9(02)            .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Chiusura file sequenziale in output             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-gen-cod-fnt          .
      *              *-------------------------------------------------*
      *              * Normalizzazione record file sequenziale         *
      *              *-------------------------------------------------*
           move      spaces               to   w-rdp                  .
      *              *-------------------------------------------------*
      *              * Memorizzazione dati [dcp]                       *
      *              *-------------------------------------------------*
           move      rf-dcp-alf-pro       to   w-rdp-alf-pro          .
           move      rf-dcp-des-pro       to   w-rdp-des-pro          .
           move      rf-dcp-cla-pro       to   w-rdp-cla-pro          .
           move      rf-dcp-gru-pro       to   w-rdp-gru-pro          .
           move      rf-dcp-sgr-pro       to   w-rdp-sgr-pro          .
           move      rf-dcp-prz-lst       to   w-rdp-prz-lst          .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Memorizzazione dati [aaq]                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-aaq-dcf-pfz       to   w-gen-cod-fnt          .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati                         *
      *                  *---------------------------------------------*
           move      rf-aaq-dcf-pfz       to   w-rdp-dcf-pfz          .
           move      rf-aaq-cdp-pdt       to   w-rdp-cdp-pdt          .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      ...
      *                  * Memorizzazione dati                         *
      *                  *---------------------------------------------*
           move      rf-aaf-cop-sfn       to   w-rdp-cop-sfn          .
           move      rf-aaf-sgl-vlt       to   w-rdp-sgl-vlt          .
           move      rf-aaf-prz-pes (1)   to   w-rdp-prz-acq          .
           if        rf-aaf-sgl-vlt       =    "EUR"
                     divide 100           into w-rdp-prz-acq
                                        giving w-gen-wrk-lst
           else if   rf-aaf-sgl-vlt       =    "DEM"
                     multiply 0,005113    by   w-rdp-prz-acq
                                        giving w-gen-wrk-lst
           else      move  zero           to   w-gen-wrk-lst          .
           move      w-gen-wrk-lst        to   w-rdp-lst-acq          .
       prn-liv-det-310.
           ...
           move      rf-aaf-psr-pes (1, 5)
                                          to   w-rdp-psr-005          .
       prn-liv-det-320.
           move      w-gen-wrk-lst        to   w-gen-wrk-net          .
       prn-liv-det-321.
           move      w-rdp-psr-001        to   w-gen-wrk-psr          .
           divide    100                  into w-gen-wrk-psr
                                        giving w-gen-wrk-psr          .
           subtract  w-gen-wrk-psr        from 1
                                        giving w-gen-wrk-psr          .
           multiply  w-gen-wrk-psr        by   w-gen-wrk-net
                                        giving w-gen-wrk-net          .
       prn-liv-det-322.
           move      w-rdp-psr-002        to   w-gen-wrk-psr          .
           divide    100                  into w-gen-wrk-psr
                                        giving w-gen-wrk-psr          .
           subtract  w-gen-wrk-psr        from 1
                                        giving w-gen-wrk-psr          .
           multiply  w-gen-wrk-psr        by   w-gen-wrk-net
                                        giving w-gen-wrk-net          .
       prn-liv-det-323.
           move      w-rdp-psr-003        to   w-gen-wrk-psr          .
           divide    100                  into w-gen-wrk-psr
                                        giving w-gen-wrk-psr          .
           subtract  w-gen-wrk-psr        from 1
                                        giving w-gen-wrk-psr          .
           multiply  w-gen-wrk-psr        by   w-gen-wrk-net
                                        giving w-gen-wrk-net          .
       prn-liv-det-324.
           move      w-rdp-psr-004        to   w-gen-wrk-psr          .
           divide    100                  into w-gen-wrk-psr
                                        giving w-gen-wrk-psr          .
           subtract  w-gen-wrk-psr        from 1
                                        giving w-gen-wrk-psr          .
           multiply  w-gen-wrk-psr        by   w-gen-wrk-net
                                        giving w-gen-wrk-net          .
       prn-liv-det-325.
           move      w-rdp-psr-005        to   w-gen-wrk-psr          .
           divide    100                  into w-gen-wrk-psr
                                        giving w-gen-wrk-psr          .
           subtract  w-gen-wrk-psr        from 1
                                        giving w-gen-wrk-psr          .
           multiply  w-gen-wrk-psr        by   w-gen-wrk-net
                                        giving w-gen-wrk-net          .
       prn-liv-det-330.
           move      w-gen-wrk-net        to   w-rdp-net-acq          .
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Completamento con carattere di separazione      *
      *              *-------------------------------------------------*
           move      ";"                  to   w-rdp-pev-001
                                               w-rdp-pev-002
                                               w-rdp-pev-003
                                               w-rdp-pev-004
                                               w-rdp-pev-005
      ...
      *              *-------------------------------------------------*
           move      "    ESTRAZIONE ANAGRAFICA PRODOTTI     "
