      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [dcc] da sequenziale     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   AGGIORNAMENTO [DCC] DA SEQUENZIALE   "       .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Ottenimento record [dcc]                    *
      *                  *---------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODCLI    "         to   f-key                  .
           move      w-rdp-cod-cli        to   rf-dcc-cod-cli         .
           move      w-rdp-dpz-cli        to   rf-dcc-dpz-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
      *                  * Aggiornamento dati record [dcc]             *
      *                  *---------------------------------------------*

           move      w-rdp-cod-agg        to   rf-dcc-cod-cat         .
