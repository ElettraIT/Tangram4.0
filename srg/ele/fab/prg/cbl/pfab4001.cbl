      ...
      *                       Ultima revisione:    NdK del 26/03/24    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Su misura ELETTRA                           *
      *                    - prevede una data consegna prevista per    *
      *                      gli ordini                                *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  rr-coe-msc                 pic  9(02)v9(01)            .
      *        *-------------------------------------------------------*
      *        * Data consegna prevista massima per ordini             *
      *        *-------------------------------------------------------*
           05  rr-dcp-max                 pic  9(07)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qig          pic s9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' correttiva della giacenza          [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qcg          pic s9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' in spedizione                      [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qis          pic s9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' in ordine da clienti               [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qoc          pic s9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' in ordine a fornitori              [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qof          pic s9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' di fabbisogno/disponibilita'       [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qfd          pic s9(08)v9(03)            .
      ...
      *                      *-----------------------------------------*
           if        rf-ocr-dat-doc       >    w-det-qta-fod-dtb
                     go to det-qta-fod-220.
      *                      *-----------------------------------------*
      *                      * Test su data massima consegna prevista  *
      *                      *-----------------------------------------*
______     if        rr-dcp-max           =    zero
                     go to det-qta-fod-230.
           if        rf-ocr-dcn-prv       >    rr-dcp-max
                     go to det-qta-fod-220.
______ det-qta-fod-230.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
______     if        rr-dcp-max           =    zero
                     go to det-qta-fod-330.
           if        rf-ofr-dcn-prv       >    rr-dcp-max
                     go to det-qta-fod-320.
______ det-qta-fod-330.
      *                      *-----------------------------------------*
      *                      * Selezione su tipo riga                  *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
______ int-pag-sta-300.
      *              *-------------------------------------------------*
      *              * Sub-intestazione per data consegna massima      *
      *              *-------------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      085                  to   p-pos                  .
           move      "Data massima consegna prevista ordini :"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
