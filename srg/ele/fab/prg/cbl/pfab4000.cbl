      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pfab4001:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-snx-fab.
               10  w-exp-snx-fab-num      pic  9(02)       value 2    .
               10  w-exp-snx-fab-lun      pic  9(02)       value 02   .
      ...
      *                  *---------------------------------------------*
           perform   acc-coe-msc-000      thru acc-coe-msc-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
       ...
       acc-ric-sel-700.
      *                  *---------------------------------------------*
      *                  * Data consegna prevista massima              *
      *                  *---------------------------------------------*
           perform   acc-dcp-max-000      thru acc-dcp-max-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Coefficiente moltiplicato- :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *                  * Coefficiente moltiplicatore                 *
      *                  *---------------------------------------------*
           move      zero                 to   rr-coe-msc             .
           perform   vis-coe-msc-000      thru vis-coe-msc-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Eventuale normalizzazione coefficiente      *
      *                  * moltiplicatore                              *
      *                  *---------------------------------------------*
           if        rr-tcr-gia           not  = 01
                     go to acc-tcr-gia-800.
      *                  *---------------------------------------------*
      *                  * Normalizzazione                             *
      *                  *---------------------------------------------*
            move     zero                 to   rr-coe-msc             .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Tipo correttivo alla giacenza           *
      *    *-----------------------------------------------------------*
       vis-tcr-gia-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Coefficiente moltiplicatore                *
      *    *-----------------------------------------------------------*
       acc-coe-msc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        rr-tcr-gia           not  = 10
                     go to acc-coe-msc-999.
      *                  *---------------------------------------------*
      *                  * Eventuale default                           *
      *                  *---------------------------------------------*
           if        rr-coe-msc           =    zero
                     move  1              to   rr-coe-msc             .
       acc-coe-msc-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  * sia in Up                                   *
      *                  *---------------------------------------------*
           if        rr-coe-msc           not  = zero
                     go to acc-coe-msc-600.
           if        v-key                =    "UP  "
                     go to acc-coe-msc-600
           else      go to acc-coe-msc-100.
       acc-coe-msc-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Data consegna prevista massima             *
      *    *-----------------------------------------------------------*
       acc-dcp-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-dcp-max-999.
       acc-dcp-max-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-dcp-max             .
       acc-dcp-max-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Test su coefficiente moltiplicatore             *
      *              *-------------------------------------------------*
           if        rr-tcr-gia           not  = 10
                     go to tdo-ric-sel-800.
           if        rr-coe-msc           not  = zero
                     go to tdo-ric-sel-800.
           move      "Manca il coefficiente moltiplicatore !"
                                          to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tcr-gia           =    zero
                     move  01             to   rr-tcr-gia             .
      *              *-------------------------------------------------*
      *              * Normalizzazione coefficiente moltiplicatore     *
      *              *-------------------------------------------------*
           if        rr-tcr-gia           not  = 10
                     move  zero           to   rr-coe-msc             .
       reg-ric-sel-999.
