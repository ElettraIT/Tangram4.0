      ...
      *                       Ultima revisione:    NdK del 29/03/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pfab4301:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Si/no stampa esclusi                       *
      *        *-------------------------------------------------------*
           05  w-exp-snx-ste.
               10  w-exp-snx-ste-num      pic  9(02)       value 2    .
               10  w-exp-snx-ste-lun      pic  9(02)       value 30   .
               10  w-exp-snx-ste-tbl.
                   15  filler             pic  x(30) value
                            "No                            "          .
                   15  filler             pic  x(30) value
                            "Si, stampa prodotti non selez."          .
      ...
      *                  * Si/no stampa esclusi                        *
      *                  *---------------------------------------------*
           perform   acc-snx-ste-000      thru acc-snx-ste-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           ...
           move      14                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Coefficiente di ritaratura :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                  * Si/no stampa esclusi                        *
      *                  *---------------------------------------------*
           move      01                   to   rr-snx-ste             .
           perform   vis-snx-ste-000      thru vis-snx-ste-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *                      *-----------------------------------------*
      ...
      -              "mese           "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                      *-----------------------------------------*
      *                      * Si prosegue comunque (Mario 29/03/23)   *
      *                      *-----------------------------------------*
           go to     acc-dat-fin-600.
       acc-dat-fin-600.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Coefficiente di variazione                 *
      *    *-----------------------------------------------------------*
       acc-pdv-mme-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no stampa esclusi                 *
      *    *-----------------------------------------------------------*
       acc-snx-ste-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-ste-lun    to   v-car                  .
           move      w-exp-snx-ste-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      21                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-ste-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           if        w-cnt-sts-imp-ric    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
           move      rr-snx-ste           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-ste-999.
       acc-snx-ste-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-snx-ste             .
       acc-snx-ste-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * sia in Up                                   *
      *                  *---------------------------------------------*
           if        rr-snx-ste           not  = zero
                     go to acc-snx-ste-600.
           if        v-key                =    "UP  "
                     go to acc-snx-ste-600
           else      go to acc-snx-ste-999.
       acc-snx-ste-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-snx-ste-100.
       acc-snx-ste-999.
           exit.

      *    *===========================================================*
      *    * Visualizzaz. campo : Si/no stampa esclusi                 *
      *    *-----------------------------------------------------------*
       vis-snx-ste-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
