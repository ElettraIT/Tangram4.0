      ...
      *                       Ultima revisione:    NdK del 22/12/10    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Solo aggiornamento listino di vendita       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "CARICAMENTO LISTINO METEL SOLO VENDITA  "       .
      ...
      *    *===========================================================*
      *    * Work-area per prn-sel-rec-000/999                         *
      *    *-----------------------------------------------------------*
       01  w-sel-rec.
           05  w-sel-rec-st1.
               10  w-sel-rec-ch1 occurs 40
                                          pic  x(01)                  .
           05  w-sel-rec-st2.
               10  w-sel-rec-ch2 occurs 40
                                          pic  x(01)                  .
           05  w-sel-rec-ct1              pic  9(02)                  .
           05  w-sel-rec-ct2              pic  9(02)                  .
      ...
      *                  * Eliminazione blanks                         *
      *                  *---------------------------------------------*
           move      w-rdp-cod-pro        to   w-sel-rec-st1          .
           move      spaces               to   w-sel-rec-st2          .
           move      zero                 to   w-sel-rec-ct1          .
           move      zero                 to   w-sel-rec-ct2          .
       prn-sel-rec-120.
           add       1                    to   w-sel-rec-ct1          .
           if        w-sel-rec-ct1        >    40
                     go to prn-sel-rec-140.
           if        w-sel-rec-ch1
                    (w-sel-rec-ct1)       =    spaces
                     go to prn-sel-rec-120.
           add       1                    to   w-sel-rec-ct2          .
           move      w-sel-rec-ch1
                    (w-sel-rec-ct1)       to   w-sel-rec-ch2
                                              (w-sel-rec-ct2)         .
           go to     prn-sel-rec-120.
       prn-sel-rec-140.
           move      w-sel-rec-st2	  to   w-rdp-cod-pro          .
      *                  *---------------------------------------------*
      *                  * Concatenamento                              *
      *                  *---------------------------------------------*
