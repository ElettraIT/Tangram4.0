      ...
      *                                   Fase:    ele102              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 17/04/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Dr. Mario Bellini   *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Generazione archivio listini su floppy      *
      *                                                                *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   GENERAZIONE LISTINI PER FLOPPY DISK  "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-ref.
      *        *-------------------------------------------------------*
      *        * Referenze relative ai listini da considerare          *
      *        *-------------------------------------------------------*
           05  w-ref-lst-cns.
      *            *---------------------------------------------------*
      *            * Numero elementi in tabella listini da considerare *
      *            *---------------------------------------------------*
               10  w-ref-lst-cns-ele      pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Numero massimo elementi in tabella                *
      *            *---------------------------------------------------*
               10  w-ref-lst-cns-max      pic  9(03) value 100        .
      *            *---------------------------------------------------*
      *            * Tabella dipendenze ammesse                        *
      *            *---------------------------------------------------*
               10  w-ref-lst-cns-tbl occurs 100.
      *                *-----------------------------------------------*
      *                * Numero listino                                *
      *                *-----------------------------------------------*
                   15  w-ref-lst-cns-nls  pic  9(02)                  .
      *                *-----------------------------------------------*
      *                * Classe merceologica prodotto                  *
      *                *-----------------------------------------------*
                   15  w-ref-lst-cns-cla  pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Gruppo merceologico prodotto iniziale         *
      *                *-----------------------------------------------*
                   15  w-ref-lst-cns-gri  pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Gruppo merceologico prodotto finale           *
      *                *-----------------------------------------------*
                   15  w-ref-lst-cns-grf  pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Codice famiglia da attribuire                 *
      *                *-----------------------------------------------*
                   15  w-ref-lst-cns-fam  pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Work-area di comodo                               *
      *            *---------------------------------------------------*
               10  w-ref-lst-cns-wst.
                   15  w-ref-lst-cns-wnl  pic  9(02)                  .
                   15  filler             pic  x(01)                  .
                   15  w-ref-lst-cns-wcl  pic  9(05)                  .
                   15  filler             pic  x(01)                  .
                   15  w-ref-lst-cns-wgi  pic  9(05)                  .
                   15  filler             pic  x(01)                  .
                   15  w-ref-lst-cns-wgf  pic  9(05)                  .
                   15  filler             pic  x(01)                  .
                   15  w-ref-lst-cns-wcf  pic  9(09)                  .
      ...
      *        * - 01 : Contattori e ralais termici                    *
      *        * - 02 : Interr. autom. di pot. MC-ME                   *
      *        * - 03 : Interr. autom. serie Elfa                      *
      *        * - 04 : Carpenteria metallica                          *
      *        *-------------------------------------------------------*
           05  rr-tip-lst                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Numero listino                                        *
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Data ultima variazione/immissione                 *
      *            *---------------------------------------------------*
               10  w-rdt-dat-uvi          pic  9(08)                  .
      *            *---------------------------------------------------*
      *            * Descrizione listino                               *
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Quantita' multipla ordinazione                    *
      *            *---------------------------------------------------*
               10  w-rdp-qta-mtp          pic  9(05)                  .
      *            *---------------------------------------------------*
      ...
      *            * Famiglia di sconto                                *
      *            *---------------------------------------------------*
               10  w-rdp-fam-sco          pic  x(18)                  .
      *            *---------------------------------------------------*
      *            * Famiglia statistica                               *
      *            *---------------------------------------------------*
               10  w-rdp-fam-sta          pic  x(18)                  .
      *            *---------------------------------------------------*
      *            * Carattere di fine record                          *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-scr-fso-dat              pic  x(08)                  .
           05  w-scr-fso-dat-r redefines
               w-scr-fso-dat.
               10  w-scr-fso-sec          pic  9(02)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Numero listino                             *
      *        *-------------------------------------------------------*
           05  w-exp-num-lst.
               10  w-exp-num-lst-num      pic  9(02)       value 4    .
               10  w-exp-num-lst-lun      pic  9(02)       value 30   .
               10  w-exp-num-lst-tbl.
                   15  filler             pic  x(30) value
                            "Contattori e relais termici   "          .
                   15  filler             pic  x(30) value
                            "Interr. autom. di pot. MC - ME"          .
                   15  filler             pic  x(30) value
                            "Interr. autom. serie Elfa     "          .
                   15  filler             pic  x(30) value
                            "Carpenteria Metallica         "          .
               10  w-exp-num-lst-tbl-r redefines
                   w-exp-num-lst-tbl.
                   15  w-exp-num-lst-ele occurs 4
                                          pic  x(30)                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Referenze per listini da considerare        *
      *                  *---------------------------------------------*
           perform   ref-lst-cns-000      thru ref-lst-cns-999        .
      *                      *-----------------------------------------*
      *                      * Test su esito lettura                   *
      *                      *-----------------------------------------*
           if        w-ref-lst-cns-ele    >    zero
      ...
      *    *===========================================================*
      *    * Lettura referenza : Listini da considerare                *
      *    *-----------------------------------------------------------*
       ref-lst-cns-000.
      *              *-------------------------------------------------*
      *              * Inizializzazione numero elementi in tabella     *
      *              *-------------------------------------------------*
           move      zero                 to   w-ref-lst-cns-ele      .
      *              *-------------------------------------------------*
      *              * Start per lettura referenza multipla            *
      *              *-------------------------------------------------*
           move      "Rs"                 to   s-ope                  .
           move      "ele/dcp/ele100[lst-cns]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      s-alf                to   w-ref-lst-cns-wst      .
      *              *-------------------------------------------------*
      *              * Test se elementi nulli                          *
      *              *-------------------------------------------------*
           if        w-ref-lst-cns-wnl    =    zero   or
                     w-ref-lst-cns-wcl    =    zero
                     go to ref-lst-cns-100.
       ref-lst-cns-120.
      *              *-------------------------------------------------*
      *              * Test su contatore elementi : se oltre il massi- *
      *              * mo previsto : a fine ciclo                      *
      *              *-------------------------------------------------*
           if        w-ref-lst-cns-ele    not  < w-ref-lst-cns-max
                     go to ref-lst-cns-900.
      *              *-------------------------------------------------*
      *              * Incremento contatore elementi                   *
      *              *-------------------------------------------------*
           add       1                    to   w-ref-lst-cns-ele      .
      *              *-------------------------------------------------*
      *              * Bufferizzazione elemento in tabella             *
      *              *-------------------------------------------------*
           move      w-ref-lst-cns-wnl    to   w-ref-lst-cns-nls
                                              (w-ref-lst-cns-ele)     .
           move      w-ref-lst-cns-wcl    to   w-ref-lst-cns-cla
                                              (w-ref-lst-cns-ele)     .
           move      w-ref-lst-cns-wgi    to   w-ref-lst-cns-gri
                                              (w-ref-lst-cns-ele)     .
           move      w-ref-lst-cns-wgf    to   w-ref-lst-cns-grf
                                              (w-ref-lst-cns-ele)     .
           move      w-ref-lst-cns-wcf    to   w-ref-lst-cns-fam
                                              (w-ref-lst-cns-ele)     .
      *                  *---------------------------------------------*
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-200.
      *                  *---------------------------------------------*
      *                  * Numero listino da generare                  *
      *                  *---------------------------------------------*
           perform   acc-tip-lst-000      thru acc-tip-lst-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-tip-lst-999.
       acc-tip-lst-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-tip-lst             .
       acc-tip-lst-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore di scansione          *
      *              *-------------------------------------------------*
           move      zero                 to   w-prn-ctr-scn          .
       prn-str-ini-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun listino da generare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           if        w-prn-flg-uno        not  = spaces
                     move  spaces         to   w-prn-flg-uno
                     go to prn-let-seq-100
           else      go to prn-let-seq-200.
       prn-let-seq-100.
      *              *-------------------------------------------------*
      *              * Ciclo di scansione su referenza listini da con- *
      *              * siderare                                        *
      *              *-------------------------------------------------*
           add       1                    to   w-prn-ctr-scn          .
      *                  *---------------------------------------------*
      *                  * Test se oltre il massimo                    *
      *                  *---------------------------------------------*
           if        w-prn-ctr-scn        >    w-ref-lst-cns-ele
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-let-seq-999.
      *                  *---------------------------------------------*
      *                  * Test se elemento apprtenente al tipo li-    *
      *                  * stino da trattare                           *
      *                  *---------------------------------------------*
           if        w-ref-lst-cns-nls
                    (w-prn-ctr-scn)       not  = rr-tip-lst
                     go to prn-let-seq-100.
       prn-let-seq-140.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-ref-lst-cns-cla
                    (w-prn-ctr-scn)       to   rf-dcp-cla-pro         .
           move      w-ref-lst-cns-gri
                    (w-prn-ctr-scn)       to   rf-dcp-gru-pro         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-dcp-cla-pro       not  = w-ref-lst-cns-cla
                                                (w-prn-ctr-scn)    or
                     rf-dcp-gru-pro       >    w-ref-lst-cns-grf
                                              (w-prn-ctr-scn)
                     go to prn-let-seq-100.
       prn-let-seq-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
______*              *-------------------------------------------------*
      *              * Test su flag su peculiarita' fisiche            *
      *              *-------------------------------------------------*
           if        rf-dcp-pcl-fis       not  = spaces
                     move  "#"            to   w-cnt-prn-flg-sub      .
       prn-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           string    "AEGELE"   delimited by   size
                     rr-tip-lst delimited by   size
      ...
      *                  *---------------------------------------------*
           ...
           move      s-sec                to   w-scr-fso-sec          .
           add       19                   to   w-scr-fso-sec          .
      ...
      *                  * Data ultima variazione/immissione           *
      *                  *---------------------------------------------*
           move      w-rdt-dec-lst        to   w-rdt-dat-uvi          .
      *                  *---------------------------------------------*
      *                  * Descrizione listino                         *
      *                  *---------------------------------------------*
           move      w-exp-num-lst-ele
                    (rr-tip-lst)          to   w-rdt-des-lst          .
      *                  *---------------------------------------------*
      *                  * Carattere di fine record                    *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-dcp-qta-cfz       =    zero
                     move  1              to   w-rdp-qta-mtp
           else      move  rf-dcp-qta-cfz to   w-rdp-qta-mtp          .
      *                  *---------------------------------------------*
      *                  * Quantita' minima ordinazione                *
      *                  *---------------------------------------------*
           move      1                    to   w-rdp-qta-ord          .
      *                  *---------------------------------------------*
      *                  * Quantita' massima ordinazione               *
      *                  *---------------------------------------------*
           move      999999               to   w-rdp-qta-max          .
      *                  *---------------------------------------------*
      *                  * Lead time                                   *
      *                  *---------------------------------------------*
           move      "5"                  to   w-rdp-lea-tim          .
      *                  *---------------------------------------------*
      *                  * Prezzo grossista                            *
      *                  *---------------------------------------------*
           move      rf-dcp-prz-lst       to   w-rdp-prz-grs          .
      *                  *---------------------------------------------*
      *                  * Prezzo pubblico                             *
      *                  *---------------------------------------------*
           move      rf-dcp-prz-lst       to   w-rdp-prz-pub          .
      *                  *---------------------------------------------*
      *                  * Moltiplicatore prezzo                       *
      *                  *---------------------------------------------*
           move      1                    to   w-rdp-mtp-prz          .
      *                  *---------------------------------------------*
      *                  * Codice valuta                               *
      *                  *---------------------------------------------*
           move      "ITL"                to   w-rdp-cod-vlt          .
      *                  *---------------------------------------------*
      *                  * Unita' di misura                            *
      *                  *---------------------------------------------*
           move      "PCE"                to   w-rdp-uni-mis          .
      *                  *---------------------------------------------*
      *                  * Prodotto composto                           *
      *                  *---------------------------------------------*
           move      0                    to   w-rdp-ptt-cmp          .
      *                  *---------------------------------------------*
      *                  * Stato del prodotto                          *
      *                  *---------------------------------------------*
           if        rf-dcp-sta-tus       =    01
                     move  "3"            to   w-rdp-sts-pro
           else if   rf-dcp-sta-tus       =    11
                     move  "2"            to   w-rdp-sts-pro
           else if   rf-dcp-sta-tus       =    21
                     move  "9"            to   w-rdp-sts-pro
      ...
      *                  *---------------------------------------------*
           ...
           move      s-mes                to   w-scr-fso-mes          .
           move      s-gio                to   w-scr-fso-gio          .
           move      w-scr-fso-dat        to   w-rdp-dat-uvi          .
      *                  *---------------------------------------------*
      *                  * Famiglia di sconto                          *
      *                  *---------------------------------------------*
           move      w-ref-lst-cns-fam
                    (w-prn-ctr-scn)       to   w-rdp-fam-sco          .
      *                  *---------------------------------------------*
      *                  * Famiglia statistica                         *
      *                  *---------------------------------------------*
           move      spaces               to   w-rdp-fam-sta          .
      *                  *---------------------------------------------*
      *                  * Carattere di fine record                    *
      *                  *---------------------------------------------*
