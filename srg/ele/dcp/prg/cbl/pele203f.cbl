      ...
      *                    sequenziale                                 *
      *                                                                *
      *                    Start su codice prodotto numerico           *
      *                    Aggiorna:                                   *
      ...
      *            *---------------------------------------------------*
               10  w-rdp-num-pro          pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Codice prodotto alfanumerico                      *
      *            *---------------------------------------------------*
               10  w-rdp-alf-pro          pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Dexcrizione prodotto in uppercase                 *
      *            *---------------------------------------------------*
               10  w-rdp-des-key          pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Dexcrizione prodotto                              *
      *            *---------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rdp-num-pro        to   rf-dcp-num-pro         .
           move      "pgm/dcp/fls/ioc/obj/iofdcp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rdp-des-key        to   rf-dcp-des-key         .
           move      w-rdp-des-pro        to   rf-dcp-des-pro         .
