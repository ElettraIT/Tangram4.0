      ...
      *            * Codice ubicazione                                 *
      *            *---------------------------------------------------*
               10  w-rdp-cod-ubi          pic  x(07)                  .
      *            *---------------------------------------------------*
      *            * Indice di percorso                                *
      *            *---------------------------------------------------*
               10  w-rdp-inx-per          pic  9(07)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rdp-cod-ubi        to   rf-zub-cod-ubi         .
           move      "pgm/mag/fls/ioc/obj/iofzub"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-zub                 .
      *                  *---------------------------------------------*
      *                  * Se record esistente: ad aggiornamento       *
      *                  *---------------------------------------------*
           if        f-sts                =    e-not-err
                     go to prn-liv-det-200.
      *                  *---------------------------------------------*
      *                  * Normalizzazione record [zub]                *
      *                  *---------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "pgm/mag/fls/ioc/obj/iofzub"
                                          to   s-pat                  .
           ...
           call      s-pat               using f
                                               rf-zub                 .
      *                  *---------------------------------------------*
      *                  * Composizione record vuoto                   *
      *                  *---------------------------------------------*
           move      01                   to   rf-zub-cod-dpz         .
           move      w-rdp-cod-ubi        to   rf-zub-cod-ubi         .
           move      w-rdp-cod-ubi        to   rf-zub-des-ubi         .
           move      w-rdp-cod-ubi        to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   rf-zub-des-key         .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Aggiornamento anagrafica [zub]                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Indice di percorso                          *
      *                  *---------------------------------------------*
           move      w-rdp-inx-per        to   rf-zub-inx-per         .
      *                  *---------------------------------------------*
      *                  * Update record [zub]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
