      ...
      *                                   Fase:    ele200              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 12/09/95    *
      *                    ------------------------------------------- *
      ...
      *    *-----------------------------------------------------------*
       01  w-red.
           05  w-red-cod-fam              pic  9(09)                  .
           05  w-red-cod-fam-r redefines
               w-red-cod-fam.
               10  filler                 pic  9(02)                  .
               10  w-red-cod-fam-das      pic  9(01)                  .
               10  w-red-cod-fam-sgm      pic  9(02)                  .
               10  w-red-cod-fam-fam      pic  9(04)                  .
      ...
      *              *-------------------------------------------------*
______     move      spaces               to   p-alf                  .
______     string    "BM"       delimited by   size
______               w-rdp-cod-pro
______                          delimited by   spaces
______                                    into p-alf                  .
______     move      p-alf                to   w-rdp-cod-pro          .
      *              *-------------------------------------------------*
      ...
      *                  * Lotto di vendita                            *
      *                  *---------------------------------------------*
           move      w-rdp-qta-ord        to   rf-dcp-lot-ven         .
      *                  *---------------------------------------------*
      *                  * Update record [dcp]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
...
______     go to     prn-liv-det-999.
      ...
      *                      *-----------------------------------------*
           ...
           move      w-rdp-des-pro        to   rf-aaf-dep-sfn         .
...
______*    move      w-rdp-cod-fam        to   w-red-cod-fam          .
______*    if        w-red-cod-fam-das    not  = 1
______*              go to prn-liv-det-240.
______*    move      21,5                 to   rf-aaf-psr-pes (1, 1)  .
______*    move      05                   to   rf-aaf-psr-pes (1, 2)  .
______*    if        w-red-cod-fam-fam    =    2131 or
______*              w-red-cod-fam-fam    =    2111
______*              move  03             to   rf-aaf-psr-pes (1, 3)  .

       prn-liv-det-240.

           if        rf-aaf-psr-pes (1, 1)
                                          =    20
                     move  21,5           to   rf-aaf-psr-pes (1, 1)  .


______*    if        rr-tip-lst           =    01
______*              move  w-gen-psr-civ (1)
______*                                   to   rf-aaf-psr-pes (1, 1)
______*              move  w-gen-psr-civ (2)
______*                                   to   rf-aaf-psr-pes (1, 2)
______*    else      move  w-gen-psr-ind (1)
______*                                   to   rf-aaf-psr-pes (1, 1)
______*              move  w-gen-psr-ind (2)
______*                                   to   rf-aaf-psr-pes (1, 2)  .
      *                      *-----------------------------------------*
      *                      * Update record [aaf]                     *
      *                      *-----------------------------------------*
