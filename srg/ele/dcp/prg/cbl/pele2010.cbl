      ...
      *                                   Fase:    ele200              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 11/11/97    *
      *                    ------------------------------------------- *
      *                                 Autore:    Dr. Mario Bellini   *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [dcp] da sequenziale     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     AGGIORNAMENTO ARCHIVIO PRODOTTI    "       .
      ...
      *    *===========================================================*
      *    * Work area per la definizione del record file sequenziale  *
      ...
      *            * E-Number AEG                                      *
      *            *---------------------------------------------------*
               10  w-rdp-enr-aeg          pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Peso unitario                                     *
      *            *---------------------------------------------------*
               10  w-rdp-pes-uni          pic  x(09)                  .
      *            *---------------------------------------------------*
      *            * Nomenclatura combinata                            *
      *            *---------------------------------------------------*
               10  w-rdp-nmc-cmb          pic  x(10)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-prn.
           05  w-prn-pes-uni              pic  9(04)v9(03)            .
           05  w-prn-nmc-cmb              pic  9(08)                  .
      ...
      *              *-------------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      09                   to   v-car                  .
           move      w-rdp-pes-uni        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-prn-pes-uni          .
      *              *-------------------------------------------------*
      *              * Conversione nomenclatura combinata              *
      *              *-------------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      10                   to   v-car                  .
           move      w-rdp-nmc-cmb        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-prn-nmc-cmb          .
      *              *-------------------------------------------------*
      *              * Test se entrambi a zero                         *
      *              *-------------------------------------------------*
           if        w-prn-pes-uni        =    zero and
                     w-prn-nmc-cmb        =    zero
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      ...
      *                  * Peso unitario                               *
      *                  *---------------------------------------------*
           if        w-prn-pes-uni        not  = zero
                     move  w-prn-pes-uni  to   rf-dcp-pes-uni         .
      *                  *---------------------------------------------*
      *                  * Nomenclatura combinata                      *
      *                  *---------------------------------------------*
           if        w-prn-nmc-cmb        not  = zero
                     move  w-prn-nmc-cmb  to   rf-dcp-cdn-cdm         .
      *                  *---------------------------------------------*
      *                  * Update record [dcp]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           move      "AGGIORNAMENTO ARCHIVIO PRODOTTI"
