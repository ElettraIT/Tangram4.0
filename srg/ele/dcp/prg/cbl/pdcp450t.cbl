      ...
      *                                   Fase:    dcp450              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 28/11/97    *
      *                       Ultima revisione:    NdK del 27/02/24    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Manutenzione bar-code prodotti              *
      *                                                                *
      *                    ******************************              *
      *                    N.B.: USO SPERIMENTALE DI SORT              *
      ...
      *            *---------------------------------------------------*
      *            * Codice bar-code prodotto                          *
      *            *---------------------------------------------------*
               10  srt-klb-key            pic  x(14)                  .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-tes-snx-bcd          pic  9(01)                  .
      *            *---------------------------------------------------*
      *            * Data registrazione min - max                      *
      *            *---------------------------------------------------*
               10  w-tes-dtr-min          pic  9(07)                  .
               10  w-tes-dtr-max          pic  9(07)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-klb-pro          pic  x(13)                  .
               10  w-rig-klb-ril          pic  x(13)                  .
           05  w-rig-002.
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Determinazione se barcode rilevato per prodotto       *
      *        *-------------------------------------------------------*
           05  w-det-bcd-ril-pro          pic  9(07)                  .
           05  w-det-bcd-ril-drm          pic  9(07)                  .
           05  w-det-bcd-ril-drx          pic  9(07)                  .
           05  w-det-bcd-ril-klb          pic  x(14)                  .
           05  w-det-bcd-ril-bcx          pic  x(14)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Salvataggio per selettore barcode                     *
      *        *-------------------------------------------------------*
           05  w-sav-snx-bcd              pic  9(07)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Si/no selezione su barcode                 *
      *        *-------------------------------------------------------*
           05  w-exp-snx-bcd.
               10  w-exp-snx-bcd-num      pic  9(02)       value 04   .
               10  w-exp-snx-bcd-lun      pic  9(02)       value 40   .
               10  w-exp-snx-bcd-tbl.
                   15  filler             pic  x(40) value
                            "Nessuna selezione sul barcode           ".
                   15  filler             pic  x(40) value
                            "solo i prodotti Con barcode             ".
                   15  filler             pic  x(40) value
                            "solo i prodotti Senza barcode           ".
                   15  filler             pic  x(40) value
                            "solo i prodotti da Verifiche carichi    ".
      ...
      *    *-----------------------------------------------------------*
       01  w-ctl.
      *        *-------------------------------------------------------*
      *        * Work per Ctl su unicita' codice a barre               *
      *        *-------------------------------------------------------*
           05  w-ctl-uni-klb.
               10  w-ctl-uni-klb-flg      pic  x(01)                  .
               10  w-ctl-uni-klb-alf      pic  x(14)                  .
               10  w-ctl-uni-klb-num      pic  9(07)                  .
               10  w-ctl-uni-klb-ctr      pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Work per Ctl su codici a barre che compaiono piu' di  *
      *        * una volta                                             *
      *        *-------------------------------------------------------*
               10  w-ctl-dop-klb-flg      pic  x(01)                  .
               10  w-ctl-dop-klb-alf      pic  x(13)                  .
               10  w-ctl-dop-klb-rig      pic  9(05)                  .
      ...
      *                  *---------------------------------------------*
       ...
       acc-key-reg-200.
      *                  *---------------------------------------------*
      *                  * Si/no selezioni su barcode                  *
      *                  *---------------------------------------------*
           perform   acc-snx-bcd-000      thru acc-snx-bcd-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Si/no selezioni su barcode                      *
      *              *-------------------------------------------------*
           perform   vis-snx-bcd-000      thru vis-snx-bcd-999        .
      *              *-------------------------------------------------*
      *              * Data registrazione min                          *
      *              *-------------------------------------------------*
           perform   vis-dtr-min-000      thru vis-dtr-min-999        .
      *              *-------------------------------------------------*
      *              * Data registrazione max                          *
      *              *-------------------------------------------------*
      ...
      *              * Si/no selezioni su barcode                      *
      *              *-------------------------------------------------*
           perform   pmt-snx-bcd-000      thru pmt-snx-bcd-999        .
      *              *-------------------------------------------------*
      *              * Data registrazione min                          *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no selezioni su barcode       *
      *    *-----------------------------------------------------------*
       pmt-snx-bcd-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data registrazione min           *
      *    *-----------------------------------------------------------*
       pmt-dtr-min-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data registrazione max           *
      *    *-----------------------------------------------------------*
       pmt-dtr-max-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no selezioni su barcode           *
      *    *-----------------------------------------------------------*
       acc-snx-bcd-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      w-tes-snx-bcd        to   w-sav-snx-bcd          .
       acc-snx-bcd-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-bcd-lun    to   v-car                  .
           move      w-exp-snx-bcd-num    to   v-ldt                  .
           move      "NCSV#"              to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      08                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-bcd-tbl    to   v-txt                  .
           move      w-tes-snx-bcd        to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-snx-bcd-999.
       acc-snx-bcd-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-snx-bcd          .
       acc-snx-bcd-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-snx-bcd        =    w-sav-snx-bcd
                     go to acc-snx-bcd-800.
           if        w-tes-snx-bcd        =    4
                     go to acc-snx-bcd-800.
      *                  *---------------------------------------------*
      *                  * Normalizzazione date registrazione min max  *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-dtr-min          .
           move      zero                 to   w-tes-dtr-max          .
           perform   vis-dtr-min-000      thru vis-dtr-min-999        .
           perform   vis-dtr-max-000      thru vis-dtr-max-999        .
       acc-snx-bcd-800.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Si/no selezioni su barcode        *
      *    *-----------------------------------------------------------*
       vis-snx-bcd-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data registrazione min               *
      *    *-----------------------------------------------------------*
       acc-dtr-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Data registrazione min            *
      *    *-----------------------------------------------------------*
       vis-dtr-min-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data registrazione max               *
      *    *-----------------------------------------------------------*
       acc-dtr-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Data registrazione max            *
      *    *-----------------------------------------------------------*
       vis-dtr-max-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *                  * Bar-code                                    *
      *                  *---------------------------------------------*
           perform   acc-rig-klb-000      thru acc-rig-klb-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * Bar-code prodotto                           *
      *                  *---------------------------------------------*
           move      w-rig-klb-pro        to   w-lin-imm-klb-pro      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              * Bar-code                                        *
      *              *-------------------------------------------------*
           perform   vis-rig-klb-000      thru vis-rig-klb-999        .
      *              *-------------------------------------------------*
      ...
      *              * Bar-code                                        *
      *              *-------------------------------------------------*
           perform   pmt-klb-pro-000      thru pmt-klb-pro-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Bar-code                         *
      *    *-----------------------------------------------------------*
       pmt-klb-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           if        w-tes-snx-bcd        not  = 4
                     go to acc-rig-klb-100.
           if        w-rig-klb-pro        not  = spaces
                     go to acc-rig-klb-100.
           if        w-rig-klb-ril        =    spaces
                     go to acc-rig-klb-100.
           move      w-rig-klb-ril        to   w-rig-klb-pro          .
       acc-rig-klb-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-klb-999.
       acc-rig-klb-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-rig-klb-pro          .
       acc-rig-klb-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Test se a spaces                            *
      *                  *---------------------------------------------*
           if        w-rig-klb-pro        =    spaces
                     go to acc-rig-klb-600.
      *                  *---------------------------------------------*
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-rig-klb-pro        to   w-all-str-alf          .
      ...
      *                  * co in archivio                              *
      *                  *---------------------------------------------*
           move      w-rig-num-pro        to   w-ctl-uni-klb-num      .
           move      w-rig-klb-pro        to   w-ctl-uni-klb-alf      .
           perform   ctl-uni-klb-000      thru ctl-uni-klb-999        .
           if        w-ctl-uni-klb-flg    =    spaces
                     go to acc-rig-klb-600.
      *                  *---------------------------------------------*
      ...
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
           move      "Codice a barre gia' utilizzato !"
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Bar-code                          *
      *    *-----------------------------------------------------------*
       vis-rig-klb-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice numerico prodotto          *
      *    *-----------------------------------------------------------*
       vis-num-pro-000.
      *              *-------------------------------------------------*
      ...
      *                  * Test su valore                              *
      *                  *---------------------------------------------*
           if        w-rig-num-pro        not  = zero
                     go to vis-num-pro-500.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-key-100.
      *              *-------------------------------------------------*
      *              * Test su data registrazione min                  *
      *              *-------------------------------------------------*
           if        w-tes-snx-bcd        not  = 4
                     go to cnt-tdo-key-800.
           if        w-tes-dtr-min        not  = zero
                     go to cnt-tdo-key-200.
           move      "Manca la data registrazione minima!               
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-key-900.
       cnt-tdo-key-200.
      *              *-------------------------------------------------*
      *              * Test su data registrazione max                  *
      *              *-------------------------------------------------*
           if        w-tes-dtr-max        not  = zero
                     go to cnt-tdo-key-300.
           move      "Manca la data registrazione massima!              
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-key-900.
       cnt-tdo-key-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-dtr-min        not  > w-tes-dtr-max
                     go to cnt-tdo-key-800.
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-100.
      *              *-------------------------------------------------*
      *              * Routine di controllo che lo stesso codice a     *
      *              * barre non compaia piu' di una volta             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se da eseguire                         *
      *                  *---------------------------------------------*
      ...
      *                  * Valori in input                             *
      *                  *---------------------------------------------*
           move      w-rig-klb-pro        to   w-ctl-dop-klb-alf      .
           move      w-rlt-sup-prg        to   w-ctl-dop-klb-rig      .
      *                  *---------------------------------------------*
      *                  * Routine di controllo                        *
      *                  *---------------------------------------------*
           perform   ctl-dop-klb-000      thru ctl-dop-klb-999        .
           if        w-ctl-dop-klb-flg    =    spaces
                     go to cnt-tdo-rig-300.
      *                  *---------------------------------------------*
      *                  * String del messaggio di errore              *
      *                  *---------------------------------------------*
           move      spaces               to   w-err-box-err-msg      .
           string    "Il codice a barre "  
                                delimited by size
                     w-rig-klb-pro
                                delimited by spaces
                     " compare in altre righe !"
                                delimited by size
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      spaces               to   w-rig-klb-pro          .
           move      spaces               to   w-rig-klb-ril          .
       nor-nok-rig-999.
           exit.
      ...
      *                      *-----------------------------------------*
       ...
       stp-srt-inp-640.
      *                      *-----------------------------------------*
      *                      * Ordinamento per barcode prodotto        *
      *                      *-----------------------------------------*
           move      zero                 to   srt-prg-key            .
           move      spaces               to   srt-alf-key            .
           move      rf-dcp-klb-pro       to   srt-klb-key            .
           move      spaces               to   srt-des-key            .
      *                      *-----------------------------------------*
      *                      * Oltre                                   *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       sel-rec-dcp-100.
      *              *-------------------------------------------------*
      *              * Si/no selezione su barcode                      *
      *              *-------------------------------------------------*
           if        w-tes-snx-bcd        =    1
                     go to sel-rec-dcp-800.
      *
           if        w-tes-snx-bcd        =    2 and
                     rf-dcp-klb-pro       =    spaces
                     go to sel-rec-dcp-900.
      *
           if        w-tes-snx-bcd        =    3 and
                     rf-dcp-klb-pro       not  = spaces
                     go to sel-rec-dcp-900.
      *              *-------------------------------------------------*
      *              * Si/no selezione su barcode rilevati in spunte   *
      *              *                                                 *
      *              * ELETTRA                                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-dcp-klb-pro       not  = spaces
                     go to sel-rec-dcp-900.
      *                  *---------------------------------------------*
      *                  * Determinazione eventuali barcode rilevati   *
      *                  * per il prodotto in corso di trattamento     *
      *                  *---------------------------------------------*
           move      rf-dcp-num-pro       to   w-det-bcd-ril-pro      .
           move      w-tes-dtr-min        to   w-det-bcd-ril-drm      .
           move      w-tes-dtr-max        to   w-det-bcd-ril-drx      .
           perform   det-bcd-ril-000      thru det-bcd-ril-999        .
      *                  *---------------------------------------------*
      *                  * Test su esito determinazione                *
      *                  *---------------------------------------------*
           if        w-det-bcd-ril-klb    =    spaces
                     go to sel-rec-dcp-900.
      *                  *---------------------------------------------*
      *                  * Barcode determinato                         *
      *                  *---------------------------------------------*
           move      w-det-bcd-ril-klb    to   rf-dcp-klb-pro         .
       sel-rec-dcp-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dcp-klb-pro       to   w-rig-klb-pro          .
      *                  *---------------------------------------------*
      *                  * Se selezione per data di rilevazione        *
      *                  *                                             *
      *                  * ELETTRA                                     *
      *                  *---------------------------------------------*
           if        w-tes-snx-bcd        =    4
                     move  rf-dcp-klb-pro to   w-rig-klb-ril
                     move  spaces         to   w-rig-klb-pro          .
       car-eff-rig-800.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-rig-klb-pro        to   rf-dcp-klb-pro         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Controllo unicita' codice a barre                         *
      *    *-----------------------------------------------------------*
       ctl-uni-klb-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di uscita                  *
      *              *-------------------------------------------------*
           move      spaces               to   w-ctl-uni-klb-flg      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-ctl-uni-klb-ctr      .
      *              *-------------------------------------------------*
      *              * Start su file [dcp]                             *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      w-ctl-uni-klb-alf    to   rf-dcp-klb-pro         .
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-dcp-klb-pro       not  = w-ctl-uni-klb-alf
                     go to ctl-uni-klb-600.
      *              *-------------------------------------------------*
      *              * Se valore numerico letto diverso da quello pas- *
      *              * sato incremento il contatore                    *
      *              *-------------------------------------------------*
           if        rf-dcp-num-pro       not  = w-ctl-uni-klb-num
                     add   1              to   w-ctl-uni-klb-ctr      .
      *              *-------------------------------------------------*
      *              * Riciclo in lettura                              *
      *              *-------------------------------------------------*
           go to     ctl-uni-klb-100.
       ctl-uni-klb-600.
      *              *-------------------------------------------------*
      *              * Trattamento finale                              *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-ctl-uni-klb-ctr    =    zero
                     go to ctl-uni-klb-999.
      *                  *---------------------------------------------*
      *                  * Altrimenti : uscita per errore              *
      *                  *---------------------------------------------*
           move      "#"                  to   w-ctl-uni-klb-flg      .
       ctl-uni-klb-999.
           exit.

      *    *===========================================================*
      *    * Controllo di non esistenza di codici a barre doppi        *
      *    *-----------------------------------------------------------*
       ctl-dop-klb-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni iniziali                        *
      *              *-------------------------------------------------*
           move      spaces               to   w-ctl-dop-klb-flg      .
      *              *-------------------------------------------------*
      *              * Salvataggio catena                              *
      *              *-------------------------------------------------*
           move      w-rig                to   w-rlt-sup-buf          .
      ...
      *              * mento                                           *
      *              *-------------------------------------------------*
           if        w-ctl-dop-klb-rig    =    w-rlt-sup-ctr
                     go to  ctl-dop-klb-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-ctl-dop-klb-alf    =    w-rig-klb-pro
                     move  "#"            to   w-ctl-dop-klb-flg
                     go to ctl-dop-klb-900.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       rou-swc-srt-400.
      *              *-------------------------------------------------*
      *              * Tasto funzione [4] - Barcode                    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su switch attuale                      *
      *                  *---------------------------------------------*
           if        w-cnt-acc-flg-sws    =   "B"
                     go to rou-swc-srt-600.
      *                  *---------------------------------------------*
      *                  * Indicatore tipo ordinamento                 *
      *                  *---------------------------------------------*
           move      "B"                  to  w-cnt-acc-flg-sws       .
      *                  *---------------------------------------------*
      *                  * Indicatore ordinamento                      *
      *                  *---------------------------------------------*
           move      "A"                  to  w-cnt-acc-flg-swo       .
      ...
      *    *===========================================================*
      *    * Determinazione eventuali barcode rilevati per prodotto    *
      *    *-----------------------------------------------------------*
       det-bcd-ril-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      spaces               to   w-det-bcd-ril-klb      .
           move      spaces               to   w-det-bcd-ril-bcx      .
       det-bcd-ril-500.
      *              *-------------------------------------------------*
      *              * Start su record [bfr]                           *
      *              *-------------------------------------------------*
           ...
           move      w-det-bcd-ril-pro    to   rf-bfr-num-mag         .
           move      w-det-bcd-ril-drm    to   rf-bfr-dat-reg         .
      ...
      *              *-------------------------------------------------*
           if        rf-bfr-cod-dpz       not  = 01
                     go to det-bcd-ril-900.
           if        rf-bfr-tip-mag       not  = 01
                     go to det-bcd-ril-900.
           if        rf-bfr-num-mag       not  = w-det-bcd-ril-pro
                     go to det-bcd-ril-900.
           if        rf-bfr-dat-reg       >    w-det-bcd-ril-drx
                     go to det-bcd-ril-900.
       det-bcd-ril-540.
      *              *-------------------------------------------------*
      *              * Selezioni sul record                            *
      ...
      *              *-------------------------------------------------*
           if        rf-bfs-num-prt       not  = rf-bfr-num-prt
                     go to det-bcd-ril-200.
           if        rf-bfs-num-prg       not  = rf-bfr-num-prg
                     go to det-bcd-ril-200.
       det-bcd-ril-640.
      *              *-------------------------------------------------*
      *              * Selezioni su [bfs]                              *
      ...
      *                  *---------------------------------------------*
           if        rf-bfs-ann-spn       =    spaces
                     go to  det-bcd-ril-620.
           if        rf-bfs-ann-spn
                    (01 : 12)             not  = "Rilevato Bar"
                     go to  det-bcd-ril-620.
           move      rf-bfs-ann-spn
                    (20 : 14)             to   w-det-bcd-ril-bcx      .
           if        w-det-bcd-ril-bcx    =    spaces
                     go to  det-bcd-ril-620.
           move      w-det-bcd-ril-bcx    to   w-det-bcd-ril-klb      .
           go to     det-bcd-ril-900.
       det-bcd-ril-680.
      *              *-------------------------------------------------*
      *              * Riciclo su [bfs]                                *
