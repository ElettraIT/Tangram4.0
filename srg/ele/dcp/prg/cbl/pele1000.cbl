      ...
      *                                   Fase:    ele100              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 07/01/94    *
      *                    ------------------------------------------- *
      ...
      *            * Stato del prodotto                                *
      *            *---------------------------------------------------*
               10  w-rdp-sts-pro          pic  x(02)                  .
      *            *---------------------------------------------------*
      *            * Codice famiglia                                   *
      *            *---------------------------------------------------*
               10  w-rdp-cod-fam          pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Carattere di fine record                          *
      *            *---------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-ref-lst-cns-fam
                    (w-prn-ctr-scn)       to   w-rdp-cod-fam          .
      *                  *---------------------------------------------*
      *                  * Carattere di fine record                    *
      *                  *---------------------------------------------*
