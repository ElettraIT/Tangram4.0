      ...
      *            * Ubicazione 1                                      *
      *            *---------------------------------------------------*
               10  w-rdp-ubi-001          pic  x(07)                  .
      *            *---------------------------------------------------*
      *            * Ubicazione 2                                      *
      *            *---------------------------------------------------*
               10  w-rdp-ubi-002          pic  x(07)                  .
      *            *---------------------------------------------------*
      *            * Ubicazione 3                                      *
      *            *---------------------------------------------------*
               10  w-rdp-ubi-003          pic  x(07)                  .
      *            *---------------------------------------------------*
      *            * Ubicazione 4                                      *
      *            *---------------------------------------------------*
               10  w-rdp-ubi-004          pic  x(07)                  .
      ...
      *                  *---------------------------------------------*
           move      w-rdp-ubi-001        to   rf-mau-prm-ubi (1)     .
           move      w-rdp-ubi-002        to   rf-mau-prm-ubi (2)     .
           move      w-rdp-ubi-003        to   rf-mau-prm-ubi (3)     .
           move      w-rdp-ubi-004        to   rf-mau-prm-ubi (4)     .
      *                  *---------------------------------------------*
      *                  * Update record [mau]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
