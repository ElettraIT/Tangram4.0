      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione prodotti da file sequenziale      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " CREAZIONE PRODOTTI DA FILE SEQUENZIALE "       .
      ...
      *            *---------------------------------------------------*
               10  w-rdp-des-pro          pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Classe merceologica                               *
      *            *---------------------------------------------------*
               10  w-rdp-cla-pro          pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Gruppo merceologico                               *
      *            *---------------------------------------------------*
               10  w-rdp-gru-pro          pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Sottogruppo merceologico                          *
      *            *---------------------------------------------------*
               10  w-rdp-sgr-pro          pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Prezzo di listino                                 *
      *            *---------------------------------------------------*
               10  w-rdp-prz-lst          pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Codice statistico 1                               *
      *            *---------------------------------------------------*
               10  w-rdp-cod-s01          pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice prodotto secondo produttore                *
      *            *---------------------------------------------------*
               10  w-rdp-cdp-pdt          pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Prezzo d'acquisto                                 *
      *            *---------------------------------------------------*
               10  w-rdp-prz-acq          pic  9(09)                  .
      ...
      *
           ...
           move      "Trattati nr."       to   w-all-str-cat (1)      .
           move      p-edt                to   w-all-str-cat (2)      .
           move      "record anagrafici prodotti"
                                          to   w-all-str-cat (3)      .
      ...
      *              *-------------------------------------------------*
           move      "  SIMULAZIONE GENERAZIONE ANAGRAFICA PRODOTTI  "
      ...
      *                  * Sinonimo                                    *
      *                  *---------------------------------------------*
           move      w-rdp-cdp-pdt        to   rf-dcp-syn-pro         .
      *                  *---------------------------------------------*
      ...
      *                  * Classe merceologica                         *
      *                  *---------------------------------------------*
           move      w-rdp-cla-pro        to   rf-dcp-cla-pro         .
      *                  *---------------------------------------------*
      *                  * Gruppo merceologica                         *
      *                  *---------------------------------------------*
           move      w-rdp-gru-pro        to   rf-dcp-gru-pro         .
      *                  *---------------------------------------------*
      *                  * Sottogruppo merceologico                    *
      *                  *---------------------------------------------*
           move      w-rdp-sgr-pro        to   rf-dcp-sgr-pro         .
      *                  *---------------------------------------------*
      *                  * Prezzo di listino                           *
      *                  *---------------------------------------------*
           move      w-rdp-prz-lst        to   rf-dcp-prz-lst         .
      *                  *---------------------------------------------*
      *                  * Codice statistico 1                         *
      *                  *---------------------------------------------*
           move      w-rdp-cod-s01        to   rf-dcp-cod-s01         .
       cmp-rec-dcp-700.
      *                  *---------------------------------------------*
      ...
      *                  * Codice prodotto secondo produttore          *
      *                  *---------------------------------------------*
           move      w-rdp-cdp-pdt        to   rf-aaq-cdp-pdt         .
      *                  *---------------------------------------------*
      *                  * Prezzo d'acquisto di riferimento            *
      *                  *---------------------------------------------*
           move      w-rdp-prz-acq        to   rf-aaq-prz-acr         .
      *                  *---------------------------------------------*
      *                  * Data aggiornamento prezzo d'acquisto di     *
      *                  * riferimento                                 *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-rdp-cdp-pdt        to   rf-aaf-cop-sfn         .
      *                  *---------------------------------------------*
      *                  * Prezzo d'acquisto                           *
      *                  *---------------------------------------------*
           move      w-rdp-prz-acq        to   rf-aaf-prz-pes (1)     .
      *                  *---------------------------------------------*
      *                  * Data aggiornamento prezzo d'acquisto        *
      *                  *---------------------------------------------*
