      ...
      *                                                                *
      *                    - Aggiornamento listino di vendita          *
      *                    - Azzeramento listino acquisto              *
      *                    - Forzatura sconti acquisto                 *
      *                                                                *
      *================================================================*
      ...
      *                      * Prezzo d'acquisto                       *
      *                      *-----------------------------------------*
           move      02                   to   rf-aaf-tip-pza         .


           move      zero                 to   rf-aaf-prz-pes (1)     .
           move      35,0                 to   rf-aaf-psr-pes (1, 1)  .
           move      20,0                 to   rf-aaf-psr-pes (1, 2)  .
           move      20,0                 to   rf-aaf-psr-pes (1, 3)  .
      *                  *---------------------------------------------*
      *                  * Test se update da eseguire                  *
      *                  *---------------------------------------------*
           if        rr-tip-exe           not  = 02
      ...
      *              *-------------------------------------------------*
           move      "       CARICAMENTO LISTINO METEL       "
