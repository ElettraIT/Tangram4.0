      ...
      *            *---------------------------------------------------*
      *            * Lotto di acquisto/vendita                         *
      *            *---------------------------------------------------*
               10  w-rdp-lot-acq          pic  9(06)                  .
      *            *---------------------------------------------------*
      *            * Descrizione prodotto secondo fornitore            *
      *            *---------------------------------------------------*
               10  w-rdp-dep-sfn          pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Prezzo d'acquisto                                 *
      *            *---------------------------------------------------*
      ...
      *                  * lotto di vendita                            *
      *                  *---------------------------------------------*
           move      w-rdp-lot-acq        to   rf-dcp-lot-ven         .
      *                  *---------------------------------------------*
      *                  * Codice statistico 1                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-rdp-dep-sfn        to   rf-aaf-dep-sfn         .
      *                  *---------------------------------------------*
      ...
      *                  * Lotto d'acquisto                            *
      *                  *---------------------------------------------*
           move      w-rdp-lot-acq        to   rf-aaf-lot-acq         .
      *                  *---------------------------------------------*
      *                  * Prezzo d'acquisto                           *
      *                  *---------------------------------------------*
