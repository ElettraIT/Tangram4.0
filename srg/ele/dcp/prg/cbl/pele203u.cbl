      ...
      *            * Codice EAN-13                                     *
      *            *---------------------------------------------------*
               10  w-rdp-cod-E13          pic  x(13)                  .
      *            *---------------------------------------------------*
      *            * Tipo aggiornamento                                *
      *            * blank: EAN-13 su [dcp]                            *
      *            * B    : EAN-13 su [pdk] per la confezione          *
      *            * D    : EAN-13 su [pdk] per l'imballo              *
      *            *---------------------------------------------------*
               10  w-rdp-tip-agg          pic  x(01)                  .
      ...
      *                  *---------------------------------------------*
           if        w-rdp-tip-agg        not  = spaces
                     go to prn-liv-det-190.
      *                  *---------------------------------------------*
      *                  * Aggiornamento record [dcp]                  *
      *                  *---------------------------------------------*
           move      w-rdp-cod-E13        to   rf-dcp-klb-pro         .
      *                  *---------------------------------------------*
      *                  * Update record [dcp]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Aggiornamento anagrafica [pdk]                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su tipo aggiornamento                  *
      *                  *---------------------------------------------*
           if        w-rdp-tip-agg        not  = "B" and
                     w-rdp-tip-agg        not  = "D"
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rdp-tip-agg        to   rf-pdk-tip-rec         .
           ...
           call      s-pat               using f
                                               rf-pdk                 .
      *                  *---------------------------------------------*
      *                  * Se record non esistente: creazione record   *
      *                  * vuoto                                       *
      *                  *---------------------------------------------*
           if        f-sts                =    e-not-err
                     go to prn-liv-det-300.
      *                  *---------------------------------------------*
      *                  * Normalizzazione record [pdk]                *
      *                  *---------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "pgm/dcp/fls/ioc/obj/iofpdk"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-300.
      *                  *---------------------------------------------*
      *                  * Aggiornamento record [pdk]                  *
      *                  *---------------------------------------------*
           move      w-rdp-cod-E13        to   rf-pdk-alf-pro         .
      *                  *---------------------------------------------*
      *                  * Update record [pdk]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
