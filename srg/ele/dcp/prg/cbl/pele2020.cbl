      ...
      *                       Ultima revisione:    NdK del 09/01/03    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " CARICAMENTO LISTINO B-TICINO DA FLOPPY "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-gen.
      *        *-------------------------------------------------------*
      *        * Codice del fornitore ____________________________     *
      *        *-------------------------------------------------------*
______     05  w-gen-cod-fnt              pic  9(07) value 0001029    .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-gen-val-ind.
               10  filler                 pic  9(02)v9(01) value 22,0 .
               10  filler                 pic  9(02)v9(01) value  5,0 .
      ...
      *    *===========================================================*
      *    * Work per ridefinizione codice famiglia TICINO             *
      *    *-----------------------------------------------------------*
       01  w-red.
           05  w-red-cod-fam              pic  x(09)                  .
           05  w-red-cod-fam-r redefines
               w-red-cod-fam.
               10  w-red-cod-fam-fam      pic  x(07)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo listino                               *
      *        *-------------------------------------------------------*
           05  w-exp-tip-lst.
               10  w-exp-tip-lst-num      pic  9(02)       value 2    .
               10  w-exp-tip-lst-lun      pic  9(02)       value 25   .
               10  w-exp-tip-lst-tbl.
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Tipo listino               *
      *    *-----------------------------------------------------------*
       acc-tip-lst-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tip-lst-lun    to   v-car                  .
           move      w-exp-tip-lst-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      07                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-tip-lst-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Prefisso per il codice     *
      *    *-----------------------------------------------------------*
       acc-pre-cod-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-all-str-alf        to   w-rdp-cod-pro          .
       prn-sel-rec-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rdp-cod-pro        to   rf-dcp-alf-pro         .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     ...
                     go to prn-sel-rec-999.
      *                  *---------------------------------------------*
      *                  * Ottenimento sequenziale record [dcp]        *
      *                  *---------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "pgm/dcp/fls/ioc/obj/iofdcp"
                                          to   s-pat                  .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-dcp-alf-pro       =    w-rdp-cod-pro
                     go to prn-sel-rec-999.
      *                      *-----------------------------------------*
      *                      * Rilascio record [dcp]                   *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-dcp-dec-prz       =    1
                     multiply 10          by   rf-dcp-prz-lst
           else if   rf-dcp-dec-prz       =    2
                     multiply 100         by   rf-dcp-prz-lst         .
           divide    w-rdp-mtp-prz        into rf-dcp-prz-lst         .
      *                  *---------------------------------------------*
...
______     go to     prn-liv-det-300.
      ...
      *                  *---------------------------------------------*
           ...
           move      w-gen-cod-fnt        to   rf-aaf-cod-dcf         .
      ...
      *                      *-----------------------------------------*
           ...
           multiply  100                  by   w-rdp-prz-grs
                                        giving rf-aaf-prz-pes (1)     .
           if        rf-aaf-dec-prz       =    1
                     multiply 10          by   rf-aaf-prz-pes (1)
           else if   rf-aaf-dec-prz       =    2
                     multiply 100         by   rf-aaf-prz-pes (1)     .
                     
           divide    w-rdp-mtp-prz        into rf-aaf-prz-pes (1)     .
      ...
      *              *-------------------------------------------------*
           move      "AGGIORNAMENTO PRODOTTI TICINO DA FLOPPY"
