      ...
      *            *---------------------------------------------------*
      *            * Work per progressivo                              *
      *            *---------------------------------------------------*
               10  w-det-csm-pnd-wpw      pic s9(11)                  .
      *            *---------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       det-csm-pnd-200.
______*              *-------------------------------------------------*
      *              * Modifica per costo medio ponderato annuo che    *
      *              * tenga conto anche delle giacenze iniziali       *
      *              *-------------------------------------------------*
       det-csm-pnd-300.
      *              *-------------------------------------------------*
      *              * Determinazione giacenza iniziale sulla base     *
      *              * del castelletto L.i.f.o. contenuto nella scheda *
      *              * valore attuale o al massimo in quella dell'anno *
      *              * precedente                                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           multiply  rf-mmv-ump-pre
                    (w-det-csm-pnd-ctr)   by   rf-mmv-rim-pre
                                              (w-det-csm-pnd-ctr)
                                       giving  w-det-csm-pnd-wpw      .
           divide    100                  into w-det-csm-pnd-wpw
                                               rounded                .
                                       
______*    display   w-det-csm-pnd-wpv    line 23 position 01.
______*    display   w-det-csm-pnd-wpw    line 23 position 21.
______*    accept    s-sts                line 24 position 01.
                                       
           add       w-det-csm-pnd-wpw    to   w-det-csm-pnd-wpv      .
       det-csm-pnd-330.
      *                  *---------------------------------------------*
      *                  * Oltre                                       *
      *                  *---------------------------------------------*
      ...
      *                  * tiva all'esercizio precedente : oltre       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
      ...
      *              * calcola il costo medio ponderato                *
      *              *-------------------------------------------------*
           if        w-det-csm-pnd-wpq    =    zero
                     go to det-csm-pnd-820.
      *                  *---------------------------------------------*
