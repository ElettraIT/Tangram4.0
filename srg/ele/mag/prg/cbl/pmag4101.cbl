      ...
      *                                   Fase:    mag410              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/07/96    *
      *                       Ultima revisione:    MrB del 20/02/25    *
      *                    ------------------------------------------- *
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione castelletto ubicazioni             *
      *        *-------------------------------------------------------*
           05  w-det-cst-ubi.
      *            *---------------------------------------------------*
      *            * Comodi per scansione castelletto                  *
      *            *---------------------------------------------------*
               10  w-det-cst-ubi-ctr      pic  9(03)                  .
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine di stampa ubicazioni                           *
      *    *-----------------------------------------------------------*
       prn-liv-det-ubi-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-ubi-100.
      *              *-------------------------------------------------*
      *              * Test su numero ubicazioni determinate           *
      *              *-------------------------------------------------*
           if        d-sld-ubi-num-ele    =    zero
                     go to prn-liv-det-ubi-900
           else if   d-sld-ubi-num-ele    =    1
                     go to prn-liv-det-ubi-200
           else      go to prn-liv-det-ubi-300.
       prn-liv-det-ubi-200.
      *              *-------------------------------------------------*
      *              * Se una sola ubicazione                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice ubicazione                           *
      *                  *---------------------------------------------*
      ...
      *                  * Ciclo di stampa                             *
      *                  *---------------------------------------------*
           move      zero                 to   w-det-cst-ubi-ctr      .
       prn-liv-det-ubi-320.
           add       1                    to   w-det-cst-ubi-ctr      .
           if        w-det-cst-ubi-ctr    >    d-sld-ubi-num-ele
                     go to prn-liv-det-ubi-900.
      *                  *---------------------------------------------*
      *                  * Test su giacenza                            *
      *                  *---------------------------------------------*
           if        d-sld-ubi-qta-gia
                    (w-det-cst-ubi-ctr)       =    zero
                     go to prn-liv-det-ubi-320.
       prn-liv-det-ubi-330.
      *                  *---------------------------------------------*
      *                  * Test se righe residue sufficienti           *
      *                  *---------------------------------------------*
           if        w-det-cst-ubi-ctr    =    1
                     go to prn-liv-det-ubi-350.
           if        p-res                >    2
                     go to prn-liv-det-ubi-340.
      *                  *---------------------------------------------*
      *                  * Intestazione pagina                         *
      *                  *---------------------------------------------*
           perform   int-pag-sta-000      thru int-pag-sta-999        .
      ...
      *                  *---------------------------------------------*
           if        d-sld-ubi-qta-gia
                    (w-det-cst-ubi-ctr)       =    d-sld-mag-sld-mag
                     go to prn-liv-det-ubi-380.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "N"                  to   p-tip                  .
           if        d-sld-ubi-qta-gia
                    (w-det-cst-ubi-ctr)   >    999999  or
                     d-sld-ubi-qta-gia
                    (w-det-cst-ubi-ctr)   <    -999999
                     move  08             to   p-car
                     move  "B"            to   p-edm
                     move  099            to   p-pos
           else      move  06             to   p-car
