      ...
      *                                   Fase:    mag100              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 10/11/92    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    - Forza "M" come tipo ubicazione            *
      *                    - Accetta ubicazioni a spaces oltre la pri- *
      *                      ma                                        *
      *                                                                *
      *                      OBSOLETO (14/09/01 - Mario)               *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Forzatura a valore "M" per Elettra          *
      *                  *---------------------------------------------*
______     move      "M"                  to   v-alf                  .
______     go to     acc-tip-ubi-200.
       acc-tip-ubi-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-prm-ubi (1, 1) to   w-bla-emb-str          .
      ...
      *                  *---------------------------------------------*
           if        w-tes-prm-ubi (1, 1) not  = spaces
                     go to acc-prm-ub1-600.
           if        v-key                =    "UP  "
                     go to acc-prm-ub1-600
           else      go to acc-prm-ub1-100.
       acc-prm-ub1-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-ubi (1, 2) to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Valore a spaces non accettabile             *
      *                  *---------------------------------------------*
______*    if        w-tes-prm-ubi (1, 2) not  = spaces
______*              go to acc-prm-ub2-600.
______*    if        v-key                =    "UP  "
______*              go to acc-prm-ub2-600
______*    else      go to acc-prm-ub2-100.
       acc-prm-ub2-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-ubi (1, 3) to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Valore a spaces non accettabile             *
      *                  *---------------------------------------------*
______*    if        w-tes-prm-ubi (1, 3) not  = spaces
______*              go to acc-prm-ub3-600.
______*    if        v-key                =    "UP  "
______*              go to acc-prm-ub3-600
______*    else      go to acc-prm-ub3-100.
       acc-prm-ub3-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-ubi (1, 4) to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Valore a spaces non accettabile             *
      *                  *---------------------------------------------*
______*    if        w-tes-prm-ubi (1, 4) not  = spaces
______*              go to acc-prm-ub4-600.
______*    if        v-key                =    "UP  "
______*              go to acc-prm-ub4-600
______*    else      go to acc-prm-ub4-100.
       acc-prm-ub4-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Note per l'ubicazione        *
      *    *-----------------------------------------------------------*
       acc-not-ubi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
