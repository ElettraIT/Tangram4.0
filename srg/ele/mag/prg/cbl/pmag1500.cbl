      ...
      *                       Ultima revisione:    NdK del 03/12/97    *
      *                    ------------------------------------------- *
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-prm-ub1  pic  x(07)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-prm-ub2  pic  x(07)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-prm-ub3  pic  x(07)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-prm-ub4  pic  x(07)                  .
      ...
      *                  *---------------------------------------------*
           move      w-tes-prm-ubi (1)    to   w-bla-emb-str          .
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-ubi (2)    to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-ubi (3)    to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-ubi (4)    to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Parametro di ubicazione 1                   *
      *                  *---------------------------------------------*
           move      w-rig-prm-ubi (1)    to   w-lin-imm-prm-ub1      .
       vis-lin-cor-520.
      *                  *---------------------------------------------*
      *                  * Parametro di ubicazione 2                   *
      *                  *---------------------------------------------*
           move      w-rig-prm-ubi (2)    to   w-lin-imm-prm-ub2      .
       vis-lin-cor-540.
      *                  *---------------------------------------------*
      *                  * Parametro di ubicazione 3                   *
      *                  *---------------------------------------------*
           move      w-rig-prm-ubi (3)    to   w-lin-imm-prm-ub3      .
       vis-lin-cor-560.
      *                  *---------------------------------------------*
      *                  * Parametro di ubicazione 4                   *
      *                  *---------------------------------------------*
           move      w-rig-prm-ubi (4)    to   w-lin-imm-prm-ub4      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
...
______     move      "M"                  to   w-rig-tip-ubi          .
______     perform   vis-rig-ubi-000      thru vis-rig-ubi-999        .
______     go to     acc-rig-ubi-200.
       acc-rig-ubi-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-rig-prm-ubi (1)    to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-rig-prm-ubi (2)    to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-rig-prm-ubi (3)    to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-rig-prm-ubi (4)    to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
...
______     go to     cnt-tdo-rig-310.
      ...
      *              *-------------------------------------------------*
           if        w-tes-tip-mag        =    01
                     go to car-fil-rap-110
           else if   w-tes-tip-mag        =    02
                     go to car-fil-rap-120
           else if   w-tes-tip-mag        =    03
                     go to car-fil-rap-130
           else if   w-tes-tip-mag        =    04
      ...
      *              *-------------------------------------------------*
           if        w-tes-tip-mag        =    01
                     go to car-fil-rap-210
           else if   w-tes-tip-mag        =    02
                     go to car-fil-rap-220
           else if   w-tes-tip-mag        =    03
                     go to car-fil-rap-230
           else if   w-tes-tip-mag        =    04
