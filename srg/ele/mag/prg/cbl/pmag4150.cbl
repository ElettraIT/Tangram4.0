      ...
      *                       Ultima revisione:    NdK del 17/10/23    *
      *                    ------------------------------------------- *
      ...
      *                  *---------------------------------------------*
           move      rr-prm-min (1)       to   w-bla-emb-str          .
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      rr-prm-max (1)       to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      rr-prm-min (2)       to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      rr-prm-max (2)       to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      rr-prm-min (3)       to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      rr-prm-max (3)       to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      rr-prm-min (4)       to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      rr-prm-max (4)       to   w-bla-emb-str          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-prm-max (1)       to   w-pad-zzz-alf          .
           perform   pad-alf-zzz-000      thru pad-alf-zzz-999        .
           move      w-pad-zzz-alf        to   rr-prm-max (1)         .
       tdo-ric-sel-520.
      *                  *---------------------------------------------*
      *                  * Parametro 2 - min - max                     *
      *                  *---------------------------------------------*
           ...
           move      rr-prm-max (2)       to   w-pad-zzz-alf          .
           perform   pad-alf-zzz-000      thru pad-alf-zzz-999        .
           move      w-pad-zzz-alf        to   rr-prm-max (2)         .
       tdo-ric-sel-530.
      *                  *---------------------------------------------*
      *                  * Parametro 3 - min - max                     *
      *                  *---------------------------------------------*
           ...
           move      rr-prm-max (3)       to   w-pad-zzz-alf          .
           perform   pad-alf-zzz-000      thru pad-alf-zzz-999        .
           move      w-pad-zzz-alf        to   rr-prm-max (3)         .
       tdo-ric-sel-540.
      *                  *---------------------------------------------*
      *                  * Parametro 4 - min - max                     *
      *                  *---------------------------------------------*
           ...
           move      rr-prm-max (4)       to   w-pad-zzz-alf          .
           perform   pad-alf-zzz-000      thru pad-alf-zzz-999        .
           move      w-pad-zzz-alf        to   rr-prm-max (4)         .
       tdo-ric-sel-800.
      *              *-------------------------------------------------*
