      ...
      *                       Ultima revisione:    NdK del 15/03/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma pmag7301:       *
      *                                                                *
      *                    Stampa valorizzazione L.i.f.o. per          *
      *                    prodotti di vendita                         *
      *                                                                *
      *                    RESO OBSOLETO DA 'mag930' STANDARD          *
      *                                                                *
      *================================================================*
...
______*    move      "A"                  to   p-tip                  .
______*    move      p-sel-als-sel        to   p-car                  .
______*    move      p-lnr                to   p-lin                  .
______*    move      001                  to   p-pos                  .
______*    move      all   "="            to   p-alf                  .
______*    call      "swd/mod/prg/obj/mprint"
______*                                  using p                      .
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
...
______*    move      "PF"                 to   p-ope                  .
______*    move      "A"                  to   p-tip                  .
______*    move      40                   to   p-car                  .
______*    move      p-lnr                to   p-lin                  .
______*    move      001                  to   p-pos                  .
______*    move      w-stp-int-rag-azi    to   p-alf                  .
______*    call      "swd/mod/prg/obj/mprint"
______*                                  using p                      .
      *                      *-----------------------------------------*
      *                      * Literal 'Data :'                        *
...
______     if        rr-ann-ese           =    097
                     move  3521181070     to   w-stp-sta-tot-vlr
           else if   rr-ann-ese           =    098
                     move  3396236968     to   w-stp-sta-tot-vlr
           else if   rr-ann-ese           =    099
                     move  3085781482     to   w-stp-sta-tot-vlr      .
