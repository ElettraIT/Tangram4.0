      ...
      *                                                                *
      *                  ___ OBSOLETO ___                              *
      *                  ___ SOSTITUITO DA 'osd' di ODS ___            *
      *                  ___ 04/10/24                                  *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           ...
           move      zero                 to   rf-hds-num-pro         .
           move      zero                 to   rf-hds-ide-dat         .
           move      zero                 to   rf-hds-cod-rsm         .
      ...
      *              *-------------------------------------------------*
           move      rf-hds-num-prt       to   fil-num-prt            .
           move      rf-hds-num-prg       to   fil-num-prg            .
           move      rf-hds-num-dst       to   fil-num-dst            .
           move      rf-hds-num-pro       to   fil-num-pro            .
           move      rf-hds-ide-dat       to   fil-ide-dat            .
           move      rf-hds-cod-rsm       to   fil-cod-rsm            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-hds-num-prt       to   fil-num-prt-1          .
           move      rf-hds-num-prg       to   fil-num-prg-1          .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-hds-num-prt       to   fil-num-prt-2          .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-hds-num-pro       to   fil-num-pro-3          .
           move      rf-hds-num-dst       to   fil-num-dst-3          .
           move      rf-hds-num-prt       to   fil-num-prt-3          .
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-hds                 .
           move      fil-num-prt          to   rf-hds-num-prt         .
           move      fil-num-prg          to   rf-hds-num-prg         .
           move      fil-num-dst          to   rf-hds-num-dst         .
           move      fil-num-pro          to   rf-hds-num-pro         .
           move      fil-ide-dat          to   rf-hds-ide-dat         .
           move      fil-cod-rsm          to   rf-hds-cod-rsm         .
