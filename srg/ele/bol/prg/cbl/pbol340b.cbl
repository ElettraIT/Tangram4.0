      ...
      *                                                                *
      *                    Sottoprogramma per bolle a fornitori        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA ETICHETTE DI SPEDIZIONE FORNITORI"       .
...
______*        10  w-det-fin-rig-chr      pic  x(01)   value H"0D"    .
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-500.
      *                  *---------------------------------------------*
      *                  * Codice dipendenza fornitore min             *
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-550.
      *                  *---------------------------------------------*
      *                  * Codice dipendenza fornitore max             *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rf-bit-cod-arc       <    rr-fnt-min or
                     rf-bit-cod-arc       >    rr-fnt-max
                     go to prn-sel-rec-900.
       prn-sel-rec-300.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      ...
      *                      *-----------------------------------------*
           move      rf-fnt-rag-soc       to   w-inl-dcm-rs1          .
           move      spaces               to   w-inl-dcm-rs2          .
           move      rf-fnt-via-fnt       to   w-inl-dcm-via          .
           move      rf-fnt-loc-fnt       to   w-inl-dcm-loc          .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Pari al numero colli                        *
      *                  *---------------------------------------------*
           if        rf-bit-num-col       =    zero
                     move  1              to   rf-bit-num-col         .
      *                  *---------------------------------------------*
      *                  * Normalizzazione preliminare                 *
      *                  *---------------------------------------------*
           move      spaces               to   w-out-eti              .
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione codice fornitore comm.     *
      *    *-----------------------------------------------------------*
