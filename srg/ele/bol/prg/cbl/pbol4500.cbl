      ...
      *                  * Codice categoria                            *
      *                  *---------------------------------------------*
           perform   acc-cod-zs2-000      thru acc-cod-zs2-999        .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Codice categoria           *
      *    *-----------------------------------------------------------*
       acc-cod-zs2-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-zs2           to   w-cmn-zst-002-cod      .
           move      05                   to   w-cmn-zst-002-lin      .
           move      30                   to   w-cmn-zst-002-pos      .
           move      05                   to   w-cmn-zst-002-dln      .
       ...
       acc-cod-zs2-110.
           ...
           if        w-cmn-zst-002-ope    =    "F+"
                     go to acc-cod-zs2-115.
           if        w-cmn-zst-002-ope    =    "AC"
                     go to acc-cod-zs2-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-zs2-115.
           perform   cmn-zst-002-foi-000  thru cmn-zst-002-foi-999    .
           go to     acc-cod-zs2-110.
       acc-cod-zs2-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-cod-zs2-999.
       acc-cod-zs2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-cod-zs2             .
       acc-cod-zs2-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-zs2           to   w-let-arc-zst-cod      .
      ...
      *                  *---------------------------------------------*
           perform   vis-des-zs2-000      thru vis-des-zs2-999        .
      *                  *---------------------------------------------*
      *                  * Se codice errato : reimpostazione           *
      *                  *---------------------------------------------*
           if        w-let-arc-zst-flg    not  = spaces
                     go to acc-cod-zs2-100.
       acc-cod-zs2-600.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Codice categoria          *
      *    *-----------------------------------------------------------*
       vis-cod-zs2-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           move      zero                 to   rr-cod-zs2             .
           move      spaces               to   rr-cod-zs2-des         .
       nor-ric-sel-999.
           exit.
