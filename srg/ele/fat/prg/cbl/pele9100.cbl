      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Estrazione fatture di vendita per calcolo   *
      *                    provvigioni aggiuntive R.Rappresentanze     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "ESTRAZIONE RIGHE FATTURE x R.RAPPRES.   "       .
      ...
      *        * Data documento                                        *
      *        *-------------------------------------------------------*
           05  w-gen-dat-doc              pic  9(07)                  .
           05  w-gen-dat-doc-r            redefines
               w-gen-dat-doc.
               10  w-gen-ddo-saa          pic  9(03)                  .
               10  w-gen-ddo-mes          pic  9(02)                  .
               10  w-gen-ddo-gio          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Numero documento                                      *
      *        *-------------------------------------------------------*
           05  w-gen-num-doc              pic  9(11)                  .
           05  w-gen-num-doc-r redefines
               w-gen-num-doc.
               10  w-gen-ndo-saa          pic  9(03)                  .
               10  w-gen-ndo-giv          pic  9(02)                  .
               10  w-gen-ndo-prg          pic  9(06)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-rgs.
           05  w-rdp.
               10  w-rdp-dat-doc	  pic  x(10)                  . 10
               10  w-rdp-dat-doc-r        redefines
           	   w-rdp-dat-doc.
                   15  w-rdp-ddo-gio      pic  9(02)                  .
                   15  w-rdp-ddo-tr1      pic  x(01)                  .
                   15  w-rdp-ddo-mes      pic  9(02)                  .
                   15  w-rdp-ddo-tr2      pic  x(01)                  .
                   15  w-rdp-ddo-ann      pic  9(04)                  .
               10  w-rdp-num-doc	  pic  9(06)	              . 16
               10  w-rdp-alf-pro          pic  x(14)                  . 30
               10  w-rdp-qta-ven          pic  9(06)                  . 36
               10  w-rdp-prz-ven          pic  9(07),9(02)            . 46
               10  w-rdp-per-sc1          pic  9(02)                  . 48
               10  w-rdp-per-sc2          pic  9(02)                  . 50
               10  w-rdp-prz-net          pic  9(07),9(02)            . 60
               10  w-rdp-imp-rig          pic +9(09),9(02)            . 73
...
______     move      1040101              to   rf-fir-dat-doc         .
...
______     if        rf-fir-dat-doc       >    1041231
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-fir-tip-mag       not  = 01
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-let-seq-999.
           if        rf-fir-per-scr (1)   =    50 and
		     rf-fir-per-scr (2)   =    00 and
		     rf-fir-per-scr (3)   =    00 and
		     rf-fir-per-scr (4)   =    00 and
		     rf-fir-per-scr (5)   =    00
      ...
      *              *-------------------------------------------------*
      *              * Memorizzazione dati [fir]                       *
      *              *-------------------------------------------------*
           move      rf-fir-dat-doc       to   w-gen-dat-doc          .
           move      w-gen-ddo-gio        to   w-rdp-ddo-gio          .
           move      "-"	          to   w-rdp-ddo-tr1          .
           move      w-gen-ddo-mes        to   w-rdp-ddo-mes          .
           move      "-"	          to   w-rdp-ddo-tr2          .
           add	     1900 		  to   w-gen-ddo-saa
					giving w-rdp-ddo-ann          .

           move      rf-fir-num-doc       to   w-gen-num-doc          .
           move      w-gen-ndo-prg        to   w-rdp-num-doc	      .

           move      rf-fir-alf-pro       to   w-rdp-alf-pro          .
           move      rf-fir-qta-ven       to   w-rdp-qta-ven          .
           divide    100                  into rf-fir-prz-ven
				        giving w-rdp-prz-ven          .
           move      rf-fir-per-scr (1)   to   w-rdp-per-sc1          .
           move      rf-fir-per-scr (2)   to   w-rdp-per-sc2          .
           divide    100                  into rf-fir-prz-net
				        giving w-rdp-prz-net          .
           divide    100                  into rf-fir-imp-rig
				        giving w-rdp-imp-rig          .
       prn-liv-det-200.
      *              *-------------------------------------------------*
