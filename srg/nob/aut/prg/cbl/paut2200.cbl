      ...
      *                       Ultima revisione:    NdK del 13/03/06    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sequenzializzazione fatture - Conad         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " CREAZIONE SEQUENZIALE FATTURE - CONAD  "       .
      ...
      *            *---------------------------------------------------*
      *            * Codice fornitore                          32, 46  *
      *            *---------------------------------------------------*
               10  w-out-001-cod-fnt      pic  x(15)                  .
      *            *---------------------------------------------------*
      *            * Tipo codice fornitore                     47, 47  *
      *            *---------------------------------------------------*
               10  w-out-001-tip-cfn      pic  x(01)  value spaces    .
      *            *---------------------------------------------------*
      *            * Codice cliente fornitore                  48, 62  *
      *            *---------------------------------------------------*
               10  w-out-001-cod-cli      pic  x(15)  value spaces    .
      *            *---------------------------------------------------*
      *            * Codice cliente cooperativa                63, 77  *
      *            *---------------------------------------------------*
               10  w-out-001-cod-coo      pic  x(15)  value spaces    .
      *            *---------------------------------------------------*
      *            * Codice socio                              78, 92  *
      *            *---------------------------------------------------*
               10  w-out-001-cod-soc      pic  x(15)  value spaces    .
      *            *---------------------------------------------------*
      *            * Tipo codice socio                         93, 93  *
      *            *---------------------------------------------------*
               10  w-out-001-tip-csc      pic  x(01)  value spaces    .
      ...
      *            *---------------------------------------------------*
      *            * Codice articolo                           08, 22  *
      *            *---------------------------------------------------*
               10  w-out-002-cod-art      pic  x(15)                  .
      *            *---------------------------------------------------*
      *            * Descrizione articolo                      23, 52  *
      *            *---------------------------------------------------*
               10  w-out-002-des-art      pic  x(30)                  .
      *            *---------------------------------------------------*
      *            * Unita' di misura                          53, 54  *
      *            *---------------------------------------------------*
      ...
      *            * Numero pezzi                              80, 83  *
      *            *---------------------------------------------------*
               10  w-out-002-num-pzz      pic  x(04) value "0001"     .
      *            *---------------------------------------------------*
      *            * Tipo Iva                                  84, 84  *
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Dati non gestiti                          89, 112 *
      *            *---------------------------------------------------*
               10  w-out-002-fil-ler      pic  x(24) value spaces     .
      ...
      *    *-----------------------------------------------------------*
       01  w-ref.
      *        *-------------------------------------------------------*
      *        * Referenze per sequenziale - Conad                     *
      *        *-------------------------------------------------------*
           05  w-ref-sqz-cnd.
      *            *---------------------------------------------------*
      *            * Codice cliente - Conad                            *
      *            *---------------------------------------------------*
               10  w-ref-sqz-cnd-cod      pic  x(07)                  .
               10  w-ref-sqz-cnd-cod-r    redefines
                   w-ref-sqz-cnd-cod      pic  9(07)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice fornitore - Conad                          *
      *            *---------------------------------------------------*
               10  w-ref-sqz-cnd-fnt      pic  x(15)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Tipo documento                                    *
      *            *---------------------------------------------------*
               10  w-ref-sqz-cnd-tmf      pic  x(05)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Pathname file sequenziale                         *
      *            *---------------------------------------------------*
               10  w-ref-sqz-cnd-pth      pic  x(40)                  .
      ...
      *                  *---------------------------------------------*
           perform   ref-sqz-cnd-000      thru ref-sqz-cnd-999        .
      *                  *---------------------------------------------*
      *                  * Test se referenza letta : si prosegue       *
      *                  *---------------------------------------------*
           if        w-ref-sqz-cnd-cod    not  = zero
      ...
      *              *-------------------------------------------------*
           move      "OO"                 to   g-ope                  .
           move      "seq "               to   g-nam                  .
           move      w-ref-sqz-cnd-pth    to   g-pat                  .
      ...
      *                  *---------------------------------------------*
           if        s-ves                not  = spaces
                     go to ref-sqz-cnd-200.
           move      s-alf                to   w-ref-sqz-cnd          .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     ref-sqz-cnd-999.
       ref-sqz-cnd-200.
      *                  *---------------------------------------------*
      *                  * Se referenza non trovata                    *
      *                  *---------------------------------------------*
           move      spaces               to   w-ref-sqz-cnd-fnt      .
           move      zero                 to   w-ref-sqz-cnd-cod      .
           move      spaces               to   w-ref-sqz-cnd-tmf      .
           move      spaces               to   w-ref-sqz-cnd-pth      .
       ref-sqz-cnd-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        rf-fit-cod-tmo       not  = w-ref-sqz-cnd-tmf
      ...
      *                      *-----------------------------------------*
           move      rf-fir-qta-ven
                    (06 : 05)             to   w-out-002-qta-art
                                              (01 : 05)               .
      *                      *-----------------------------------------*
      *                      * 2 Decimali                              *
      *                      *-----------------------------------------*
           move      rf-fir-qta-ven
                    (11 : 02)             to   w-out-002-qta-art
                                              (06 : 02)               .
      *                  *---------------------------------------------*
      *                  * Prezzo netto (IIIIIIddd)                    *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Adeguamento decimali prezzo             *
      *                      *-----------------------------------------*
           move      rf-fir-prz-net       to   w-cix-prz-art          .
           multiply  10                   by   w-cix-prz-art          .
      *
           if        rf-fir-dec-prz       =    1
                     divide 10            into w-cix-prz-art
           else if   rf-fir-dec-prz       =    2
                     divide 100           into w-cix-prz-art          .
      *                      *-----------------------------------------*
      *                      * 6 Interi                                *
      *                      *-----------------------------------------*
           move      w-cix-prz-art
                    (01 : 06)             to   w-out-002-prz-art
                                              (01 : 06)               .
      *                      *-----------------------------------------*
      *                      * 2 Decimali                              *
      *                      *-----------------------------------------*
           move      w-cix-prz-art
                    (07 : 03)             to   w-out-002-prz-art
                                              (07 : 03)               .
      *                  *---------------------------------------------*
      *                  * Importo in riga (IIIIIIIdd)                 *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * 7 Interi                                *
      *                      *-----------------------------------------*
           move      rf-fir-imp-rig
                    (01 : 07)             to   w-out-002-imp-rig
                                              (01 : 07)               .
      *                      *-----------------------------------------*
      *                      * 2 Decimali                              *
      *                      *-----------------------------------------*
           move      rf-fir-imp-rig
                    (08 : 02)             to   w-out-002-imp-rig
                                              (08 : 02)               .
      *                  *---------------------------------------------*
      *                  * Tipo Iva                                    *
      *                  *---------------------------------------------*
           move      " "                  to   w-out-002-tip-iva      .
      *                  *---------------------------------------------*
      *                  * Aliquota Iva                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                  * Codice fornitore                            *
      *                  *---------------------------------------------*
           move      rf-dcc-noi-fnt       to   w-out-001-cod-fnt      .
      *                  *---------------------------------------------*
      *                  * Fine riga : CR + LF                         *
      *                  *---------------------------------------------*
