      ...
      *                                   Fase:    aut210              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 16/03/20    *
      *                       Ultima revisione:    NdK del 02/04/20    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sequenzializzazione fatture - Ali'          *
      *                                                                *
      *                    Tracciato 16/03/20                          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CREAZIONE SEQUENZIALE FATTURE - ALI'  "       .
      ...
      *            *---------------------------------------------------*
      *            * ID Fornitore (FACOLTATIVO)                        *
      *            *---------------------------------------------------*
               10  w-out-001-idn-for      pic  x(15)                  .
      *            *---------------------------------------------------*
      *            * Tipo Fornitore (FACOLTATIVO)                      *
      *            *---------------------------------------------------*
               10  w-out-001-tip-for      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice cliente (FACOLTATIVO)                      *
      *            *---------------------------------------------------*
               10  w-out-001-cod-cli      pic  x(15)                  .
               10  filler                 pic  x(15)                  .
      *            *---------------------------------------------------*
      *            * Codice destinatario (Punto vendita)               *
      *            *---------------------------------------------------*
               10  w-out-001-cod-dst      pic  x(16)                  .
      *            *---------------------------------------------------*
      *            * Tipo documento                                    *
      *            *---------------------------------------------------*
               10  w-out-001-tip-doc      pic  x(06)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      0000101              to   rf-fit-cod-cli         .
      ...
      *              *-------------------------------------------------*
           if        rf-fit-cod-cli       not  = 0000101 or
      ...
      *              *-------------------------------------------------*
______*    if        rf-fit-cod-tmo       not  = "NFD  "
______*              go to prn-sel-rec-900.
      ...
      *                      * re alla fine i due decimali prezzo      *
      *                      *-----------------------------------------*
           multiply  100                  by   rf-fir-imp-rig         .
      *                      *-----------------------------------------*
      *                      * Editing : il formato di uscita deve     *
      *                      *           essere 'aaaaabb' in cui 'bb'  *
      *                      *           rappresenta i due decimali    *
      ...
      *                          * Risultato in campo di output        *
      *                          *-------------------------------------*
           move      p-edt                to   w-out-002-imp-rig      .
      *                  *---------------------------------------------*
      *                  * Aliquota Iva                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                  * ID Fornitore                                *
      *                  *---------------------------------------------*
           move      spaces               to   w-out-001-idn-for      .
           move      spaces               to   w-out-001-tip-for      .
           move      spaces               to   w-out-001-cod-cli      .
      *                  *---------------------------------------------*
      *                  * Codice destinatario (Punto vendita)         *
      *                  *                                             *
      ...
      *                      *-----------------------------------------*
           ...
           call      s-pat               using f
                                               rf-dcc                 .
      *                      *-----------------------------------------*
      *                      * La ragione sociale ospita il codice     *
      *                      *-----------------------------------------*
           move      rf-dcc-rag-soc
                    (21 : 03)             to   w-out-001-cod-dst      .
      *                  *---------------------------------------------*
      *                  * Tipo documento                              *
      *                  *---------------------------------------------*
