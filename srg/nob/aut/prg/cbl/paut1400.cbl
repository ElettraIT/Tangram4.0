      ...
      *                                   Fase:    aut140              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 07/07/97    *
      *                       Ultima revisione:    NdK del 15/02/16    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma aut140           *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "IMPORTAZIONE FATTURE FORNITORI FattureQ "       .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Nome del file sequenziale sotto /abd/asc        *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Nome dell'archivio dentro  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Data di registrazione per  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Direttorio per sequenziale *
      *    *-----------------------------------------------------------*
       acc-pth-inp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Composizione con il pathname di base        *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           string    s-pat      delimited by   spaces
                     ...
                     rr-pth-acc delimited by   spaces
                                          into rr-pth-inp             .
       acc-pth-inp-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
...
______*              move  02             to   rr-tip-exe             .
      ...
      *              *-------------------------------------------------*
      *              * Controllo su Direttorio per sequenziale         *
      *              *-------------------------------------------------*
           if        rr-pth-inp           not  = spaces
                     go to tdo-ric-sel-200.
           move      "ME"                 to   v-ope                  .
           move      "Manca il direttorio per il file sequenziale !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo su Data di registrazione              *
      *              *-------------------------------------------------*
           go to     tdo-ric-sel-999.
           if        rr-dat-reg           not  = zero
                     go to tdo-ric-sel-999.
           move      "ME"                 to   v-ope                  .
           move      "Manca la data di registrazione per i movimenti !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
