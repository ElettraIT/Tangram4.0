      ...
      *                       Ultima revisione:    NdK del 22/05/17    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    ___ RIMPIAZZATO DALLO STANDARD ___          *
      *                                                                *
      *================================================================*
      ...
      *            * Codice prodotto                                   *
      *            *---------------------------------------------------*
               10  w-out-doc-cod-mag      pic  x(14)                  .
               10  w-out-doc-sep-005      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Descrizione prodotto                              *
      *            *---------------------------------------------------*
               10  w-out-doc-des-mag      pic  x(40)                  .
               10  w-out-doc-sep-006      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Quantita'                                         *
      *            *---------------------------------------------------*
               10  w-out-doc-qta-ven      pic  x(15)                  .
               10  w-out-doc-sep-007      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Unita' di misura                                  *
      *            *---------------------------------------------------*
               10  w-out-doc-uni-mis      pic  x(10)                  .
               10  w-out-doc-sep-008      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Prezzo                                            *
      *            *---------------------------------------------------*
               10  w-out-doc-prz-ven      pic  x(10)                  .
               10  w-out-doc-sep-009      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Sconti                                            *
      *            *---------------------------------------------------*
               10  w-out-doc-per-sc1      pic  x(05)                  .
               10  w-out-doc-sep-010      pic  x(01)                  .
               10  w-out-doc-per-sc2      pic  x(05)                  .
               10  w-out-doc-sep-011      pic  x(01)                  .
               10  w-out-doc-per-sc3      pic  x(05)                  .
               10  w-out-doc-sep-012      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Importo                                           *
      *            *---------------------------------------------------*
               10  w-out-doc-imp-rig      pic  x(20)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-fir-cod-tmo       to   srt-cod-tmb            .
      ...
      *                      *-----------------------------------------*
           ...
           move      srt-cod-tmb          to   w-all-str-cat (2)      .
      ...
      *                              * In campo di uscita              *
      *                              *---------------------------------*
           move      rf-dcc-rag-soc       to   w-out-doc-rag-cli      .
      *                          *-------------------------------------*
      *                          * Documento                           *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-rot-l01-num-prt    to   rf-fit-num-prt         .
           move      "pgm/fat/fls/ioc/obj/ioffit"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                              * In campo di uscita              *
      *                              *---------------------------------*
           move      rf-fit-cod-tmo       to   w-out-doc-tip-doc      .
      *                          *-------------------------------------*
      *                          * Numero documento                    *
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-out-doc-num-doc      .
      *                          *-------------------------------------*
      *                          * Data documento                      *
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
      ...
      *                          * Codice prodotto                     *
      *                          *-------------------------------------*
           move      srt-alf-pro          to   w-out-doc-cod-mag      .
      *                          *-------------------------------------*
      *                          * Descrizione prodotto                *
      *                          *-------------------------------------*
           move      srt-des-rig          to   w-out-doc-des-mag      .
      *                          *-------------------------------------*
      *                          * Quantita'                           *
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-out-doc-qta-ven      .
      *                          *-------------------------------------*
      *                          * Unita' di misura                    *
      *                          *-------------------------------------*
           move      srt-uni-mis          to   w-out-doc-uni-mis      .
      *                          *-------------------------------------*
      *                          * Prezzo unitario                     *
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-out-doc-prz-ven      .
      *                          *-------------------------------------*
      *                          * Percentuale di sconto nr. 1         *
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-out-doc-per-sc1      .
      *                          *-------------------------------------*
      *                          * Percentuale di sconto nr. 2         *
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-out-doc-per-sc2      .
      *                          *-------------------------------------*
      *                          * Percentuale di sconto nr. 3         *
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-out-doc-per-sc3      .
      *                          *-------------------------------------*
      *                          * Importo                             *
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-out-doc-imp-rig      .
      *                          *-------------------------------------*
      *                          * Carattere di fine riga              *
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      zero                 to   rf-pdx-cod-arc         .
           move      rf-dcc-cod-lng       to   rf-pdx-cod-lng         .
           move      rf-fir-num-pro       to   rf-pdx-cod-num         .
           move      spaces               to   rf-pdx-for-mat         .
           move      01                   to   rf-pdx-num-prg         .
           move      "pgm/dcp/fls/ioc/obj/iofpdx"
