      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma orc375   *
      *                                                                *
      *                    Portafoglio ordini per zona                 *
      *                                                                *
      *                    SU MISURA PER NOBILI                        *
      *                                                                *
      *                    Differisce dall'originale (porc3751):       *
      *                                                                *
      *                    - per l'emissione di un file HTML           *
      *                      (/abd/web/htm/orc375.html)                *
      *                                                                *
      *                    ___ NON IMPLEMENTATO ___                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Descrizione zona in Uppercase                     *
      *            *---------------------------------------------------*
               10  srt-zon-key            pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Codice zona                                       *
      *            *---------------------------------------------------*
               10  srt-cod-zon            pic  9(05)                  .
      *            *---------------------------------------------------*
      ...
      *            * Blocchi cliente                                   *
      *            *---------------------------------------------------*
               10  srt-for-blo            pic  9(02)                  .
               10  srt-fco-blo            pic  9(02)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-tot-gen.
               10  w-tot-gen-zon          pic  9(05)                  .
               10  w-tot-gen-tiv          pic s9(11)                  .
               10  w-tot-gen-tot          pic s9(11)                  .
               10  w-tot-gen-vpf          pic  x(03)                  .
               10  w-tot-gen-dpf          pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Work per totale zona                                  *
      *        *-------------------------------------------------------*
           05  w-tot-gen.
               10  w-tot-zon-cli          pic  9(05)                  .
               10  w-tot-zon-tiv          pic s9(11)                  .
               10  w-tot-zon-tot          pic s9(11)                  .
               10  w-tot-zon-vpf          pic  x(03)                  .
               10  w-tot-zon-dpf          pic  9(01)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-dcc-cod-zon       =    zero
                     go to stp-srt-inp-100.
           if        rr-cod-zon           not  = zero   and
                     rf-dcc-cod-zon       not  = rr-cod-zon
                     go to stp-srt-inp-100.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-sts-cli           =    02
                     go to stp-srt-inp-132
           else if   rr-sts-cli           =    03
                     go to stp-srt-inp-133
           else if   rr-sts-cli           =    04
                     go to stp-srt-inp-134
           else if   rr-sts-cli           =    05
                     go to stp-srt-inp-135
           else      go to stp-srt-inp-138.
       stp-srt-inp-132.
      *                  *---------------------------------------------*
      *                  * Con ordini bloccati                         *
      *                  *---------------------------------------------*
           if        rf-dcc-for-blo       not  = 02
                     go to stp-srt-inp-100
           else      go to stp-srt-inp-138.
       stp-srt-inp-133.
      *                  *---------------------------------------------*
      *                  * Con consegne bloccate                       *
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-134.
      *                  *---------------------------------------------*
      *                  * Con ordini e consegne bloccati              *
      *                  *---------------------------------------------*
           if        rf-dcc-for-blo       not  = 02 or
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      rf-zst-des-key       to   srt-zon-key            .
           move      rf-dcc-cod-zon       to   srt-cod-zon            .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-zst-des-cls       to   srt-des-zon            .
      ...
      *                      * Blocchi cliente                         *
      *                      *-----------------------------------------*
           move      rf-dcc-for-blo       to   srt-for-blo            .
           move      rf-dcc-fco-blo       to   srt-fco-blo            .
       stp-srt-inp-380.
      *              *-------------------------------------------------*
      ...
      *              * Zona                                            *
      *              *-------------------------------------------------*
           move      srt-cod-zon          to   w-rot-l03-cod-zon      .
      *              *-------------------------------------------------*
      *              * Cliente                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-zon-cli          .
           move      zero                 to   w-tot-zon-tiv          .
           move      zero                 to   w-tot-zon-tot          .
           move      srt-sgl-vpf          to   w-tot-zon-vpf          .
           move      srt-dec-vpf          to   w-tot-zon-dpf          .
      *              *-------------------------------------------------*
      *              * Intestazione zona                               *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      srt-des-zon          to   w-all-str-cat (3)      .
      ...
      *              *-------------------------------------------------*
           if        w-tot-gen-zon        <    99999
                     add   1              to   w-tot-gen-zon          .
           add       w-tot-zon-tot        to   w-tot-gen-tot          .
           add       w-tot-zon-tiv        to   w-tot-gen-tiv          .
           if        w-tot-zon-vpf        not  = w-tot-gen-vpf
      ...
      *                  * Test se da stampare                         *
      *                  *---------------------------------------------*
           if        w-tot-zon-tot        =    zero
                     go to prn-fin-lr3-999.
           if        w-tot-zon-vpf        not  = c-sgl
                     go to prn-fin-lr3-050.
           if        w-tot-zon-cli        not  > 1
                     go to prn-fin-lr3-999.
       prn-fin-lr3-050.
      *                  *---------------------------------------------*
      *                  * Test se righe residue sufficienti           *
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr3-120.
      *                  *---------------------------------------------*
      *                  * Trattini superiori per totale zona          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *                      * Richiamo routine per stampa valori      *
      *                      *-----------------------------------------*
           move      "Totale zona"        to   w-stp-val-tot-pmt      .
           if        w-tot-zon-vpf        =    spaces
                     move  c-sgl          to   w-stp-val-tot-vlt
           else      move  w-tot-zon-vpf  to   w-stp-val-tot-vlt
                     move  w-tot-zon-dpf  to   w-stp-val-tot-dcv      .
           move      w-tot-zon-tot        to   w-stp-val-tot-tot      .
           move      w-tot-zon-tiv        to   w-stp-val-tot-tiv      .
           perform   stp-val-tot-000      thru stp-val-tot-999        .
      *                  *---------------------------------------------*
      *                  * Trattini inferiori per totale zona          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-fin-lr2-000.
      *              *-------------------------------------------------*
      *              * Aggiornamento totali per zona                   *
      *              *-------------------------------------------------*
           if        w-tot-zon-cli        <    99999
                     add   1              to   w-tot-zon-cli          .
           add       w-tot-cli-tot        to   w-tot-zon-tot          .
           add       w-tot-cli-tiv        to   w-tot-zon-tiv          .
           if        w-tot-cli-vpf        not  = w-tot-zon-vpf
                     move  spaces         to   w-tot-zon-vpf          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           else if   w-det-ele-htm-tip    =    "O"
                     go to exe-exp-res-htm-150
           else if   w-det-ele-htm-tip    =    "B"
                     go to exe-exp-res-htm-300
           else if   w-det-ele-htm-tip    =    "C"
                     go to exe-exp-res-htm-800
           else if   w-det-ele-htm-tip    =    "F"
                     go to exe-exp-res-htm-850
      ...
      *                      * Apertura HTML                           *
      *                      *-----------------------------------------*
           move      "<!DOCTYPE html PUBLIC ""-//W3C//DTD XHTML 1.0 Tran
      -              "sitional//EN"" ""http://www.w3.org/TR/xhtml1/DTD/x
      ...
      *                      * Titolo                                  *
      *                      *-----------------------------------------*
           move      "<TITLE>NOBILI- Residuo ordini</TITLE>"
                                          to   w-out-htm-fil-rec      .
      *
           move      w-out-htm            to   g-rec                  .
           perform   put-nxt-out-000      thru put-nxt-out-999        .
      ...
      *                      * Sequenza                                *
      *                      *-----------------------------------------*
           move      "<TABLE BORDER=1>"   to   w-out-htm-fil-rec      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      srt-tip-mov          to   w-all-str-cat (1)      .
           move      p-edt                to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *                      *-----------------------------------------*
      *                      * Editing data                            *
      ...
      *                      *-----------------------------------------*
           move      spaces               to   w-out-htm-fil-rec      .
      *
           string    "<TH COLSPAN =""1"">"
                                delimited by size
      ...
      *
       ...
       exe-exp-res-htm-200.
      *                  *---------------------------------------------*
      *                  * Sequenze di intestazione nuovo ordine       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Inizio fincatura tabella                *
      *                      *-----------------------------------------*
      ...
      *                      * Quantita' in ordine                     *
      *                      *-----------------------------------------*
           move      "<TH>Ordinato</TH>"  to   w-out-htm-fil-rec      .
      *
           move      w-out-htm            to   g-rec                  .
           perform   put-nxt-out-000      thru put-nxt-out-999        .
      *                      *-----------------------------------------*
      ...
      *                      * Codice Fornitore                        *
      *                      *-----------------------------------------*
           move      "<TH>Codice Fornitore</TH>"
                                          to   w-out-htm-fil-rec      .
      *
           move      w-out-htm            to   g-rec                  .
           perform   put-nxt-out-000      thru put-nxt-out-999        .
      *                      *-----------------------------------------*
      *                      * Chiusura fincatura tabella              *
      *                      *-----------------------------------------*
           move      "</TR>"              to   w-out-htm-fil-rec      .
      *
           move      w-out-htm            to   g-rec                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      srt-alf-pro          to   w-all-str-cat (2)      .
      ...
      *                      *-----------------------------------------*
           ...
           move      03                   to   w-all-str-num          .
           move      "<TD ALIGN=LEFT>"    to   w-all-str-cat (1)      .
           move      srt-des-rig          to   w-all-str-cat (2)      .
           move      "</TD>"              to   w-all-str-cat (3)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
      *
           move      w-all-str-alf        to   w-out-htm-fil-rec      .
