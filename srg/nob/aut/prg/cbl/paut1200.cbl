      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma aut120           *
      *                                                                *
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Controllo su data riferimento iniziale          *
      *              *-------------------------------------------------*
           if        rr-dat-ini           not  = zero
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-120.
      *              *-------------------------------------------------*
      *              * Controllo su data riferimento finale            *
      *              *-------------------------------------------------*
           if        rr-dat-fin           not  = zero
