      ...
      *                       Ultima revisione:    NdK del 29/08/17    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma gep640   *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Chiave di ordinamento zona a seconda del tipo     *
      *            * ordinamento zona richiesto :                      *
      *            * - Se 01, per descrizione : Descrizione zona       *
      *            * - Se 02, per codice      : Spaces                 *
      *            * - Se 03, per mnemonico   : Mnemonico zona         *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-tot-zon.
               10  w-tot-zon-ctr          pic  9(07)                  .
               10  w-tot-zon-tsc          pic s9(11)                  .
               10  w-tot-zon-tin          pic s9(11)                  .
               10  w-tot-zon-tas          pic s9(11)                  .
               10  w-tot-zon-tci          pic s9(11)                  .
               10  w-tot-zon-teg          pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totali per cliente                                    *
      *        *-------------------------------------------------------*
           05  w-tot-cli.
      ...
      *    *-----------------------------------------------------------*
       01  w-buf.
      *        *-------------------------------------------------------*
      *        * Bufferizzazione anagrafica cliente                    *
      *        *-------------------------------------------------------*
           05  w-buf-cli.
               10  w-buf-cli-cod          pic  9(07)                  .
               10  w-buf-cli-dpz          pic  x(04)                  .
               10  w-buf-cli-rag          pic  x(40)                  .
      ...
      *            * Cliente                                           *
      *            *---------------------------------------------------*
               10  w-out-doc-cod-cli      pic  x(07)                  .
               10  w-out-doc-sep-001      pic  x(01)                  .
               10  w-out-doc-dpz-cli      pic  x(04)                  .
               10  w-out-doc-sep-002      pic  x(01)                  .
               10  w-out-doc-rag-cli      pic  x(40)                  .
               10  w-out-doc-sep-003      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Tipo documento                                    *
      *            *---------------------------------------------------*
               10  w-out-doc-tip-doc      pic  x(05)                  .
               10  w-out-doc-sep-004      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Numero documento                                  *
      *            *---------------------------------------------------*
               10  w-out-doc-num-doc      pic  x(09)                  .
      ...
      *                  *---------------------------------------------*
      *                  * Se codice zona associato al cliente a ze-   *
      *                  * ro, si esclude il record                    *
      *                  *---------------------------------------------*
           if        w-let-arc-dcc-zon    =    zero
                     go to stp-srt-inp-120.
      *                  *---------------------------------------------*
      *                  * Se e' stata richiesta la stampa per una so- *
      *                  * la zona : test su codice zona               *
      *                  *---------------------------------------------*
           if        rr-cod-zon           not  = zero   and
                     w-let-arc-dcc-zon    not  = rr-cod-zon
                     go to stp-srt-inp-120.
      *                  *---------------------------------------------*
      *                  * Lettura archivio [zst]                      *
      *                  *---------------------------------------------*
           move      01                   to   w-let-arc-zst-tip      .
           move      w-let-arc-dcc-zon    to   w-let-arc-zst-cod      .
      ...
      *                  *---------------------------------------------*
           if        rr-ord-zon           =    01
                     move  w-let-arc-zst-dsu
                                          to   srt-ord-key
           else if   rr-ord-zon           =    02
                     move  spaces         to   srt-ord-key
           else if   rr-ord-zon           =    03
                     move  w-let-arc-zst-mne
                                          to   srt-ord-key            .
           move      w-let-arc-zst-cod    to   srt-cod-zon            .
           ...
           move      w-let-arc-zst-des    to   srt-des-zon            .
      ...
      *                  *---------------------------------------------*
       ...
       sel-rec-sdb-102.
      *                  *---------------------------------------------*
      *                  * Tipo scadenza : Rim.Dir.,Bonif., Dilazioni  *
      *                  *                 concordate e insoluti       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       sel-rec-sdb-400.
      *                  *---------------------------------------------*
      *                  * Nel caso di scelta incassi elettronici      *
      *                  * insoluti                                    *
      *                  *---------------------------------------------*
           if        rr-tip-scd           not  = 02
                     go to sel-rec-sdb-500.
           if        rf-sdb-tip-sdb       not  = 02 and
                     rf-sdb-tip-sdb       not  = 03 and
                     rf-sdb-tip-sdb       not  = 04 and
                     rf-sdb-tip-sdb       not  = 05 and
      ...
      *              * Codice zona                                     *
      *              *-------------------------------------------------*
           move      srt-cod-zon          to   w-rot-l02-cod-zon      .
      *              *-------------------------------------------------*
      *              * Codice cliente                                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Inizializzazione contatore zone stampate        *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento contatore zone stampate           *
      *              *-------------------------------------------------*
           add       1                    to   w-tot-gen-ctr          .
      *              *-------------------------------------------------*
      *              * Inizializzazione contatore clienti per zona     *
      *              * stampati                                        *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-zon-ctr          .
      *              *-------------------------------------------------*
      *              * Azzeramento totali per zona                     *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-zon-tsc          .
           move      zero                 to   w-tot-zon-tin          .
           move      zero                 to   w-tot-zon-tas          .
           move      zero                 to   w-tot-zon-tci          .
           move      zero                 to   w-tot-zon-teg          .
      *              *-------------------------------------------------*
      *              * Intestazione foglio                             *
      *              *-------------------------------------------------*
           perform   int-pag-sta-000      thru int-pag-sta-999        .
      ...
      *              *-------------------------------------------------*
           add       w-tot-zon-tsc        to   w-tot-gen-tsc          .
           add       w-tot-zon-tin        to   w-tot-gen-tin          .
           add       w-tot-zon-tas        to   w-tot-gen-tas          .
           add       w-tot-zon-tci        to   w-tot-gen-tci          .
           add       w-tot-zon-teg        to   w-tot-gen-teg          .
      *              *-------------------------------------------------*
      *              * Stampa totale zona                              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se totale zona da stampare             *
      *                  *---------------------------------------------*
           if        rr-tip-slp           =    02
      ...
      *                  *---------------------------------------------*
           ...
           if        w-cnt-prn-flg-int    not  = spaces
                     go to prn-fin-lr2-999.
      *                  *---------------------------------------------*
      *                  * Salto trattini per totale zona              *
      *                  *---------------------------------------------*
           go to     prn-fin-lr2-300.
       prn-fin-lr2-200.
      *                  *---------------------------------------------*
      *                  * 1. linea per totale zona                    *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      013                  to   p-pos                  .
           move      "Totali zona     :"  to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Stampa totale scaduto                   *
      *                      *-----------------------------------------*
           move      w-tot-zon-tsc        to   w-stp-imp-vlb-val      .
           move      030                  to   w-stp-imp-vlb-pos      .
           perform   stp-imp-vlb-000      thru stp-imp-vlb-999        .
      *                      *-----------------------------------------*
      *                      * Stampa totale insoluto                  *
      *                      *-----------------------------------------*
           move      w-tot-zon-tin        to   w-stp-imp-vlb-val      .
           move      045                  to   w-stp-imp-vlb-pos      .
           perform   stp-imp-vlb-000      thru stp-imp-vlb-999        .
      *                      *-----------------------------------------*
      *                      * Stampa totale a scadere                 *
      *                      *-----------------------------------------*
           move      w-tot-zon-tas        to   w-stp-imp-vlb-val      .
           move      060                  to   w-stp-imp-vlb-pos      .
           perform   stp-imp-vlb-000      thru stp-imp-vlb-999        .
      *                      *-----------------------------------------*
      *                      * Stampa totale in circolazione           *
      *                      *-----------------------------------------*
           move      w-tot-zon-tci        to   w-stp-imp-vlb-val      .
           move      075                  to   w-stp-imp-vlb-pos      .
           perform   stp-imp-vlb-000      thru stp-imp-vlb-999        .
      *                      *-----------------------------------------*
      *                      * Stampa esposizione globale              *
      ...
      *                          * Valore                              *
      *                          *-------------------------------------*
           move      w-tot-zon-teg        to   w-stp-imp-vlb-val      .
           move      118                  to   w-stp-imp-vlb-pos      .
           perform   stp-imp-vlb-000      thru stp-imp-vlb-999        .
       prn-fin-lr2-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Bufferizzazione dati cliente                    *
      *              *-------------------------------------------------*
           move      srt-cod-cli          to   w-buf-cli-cod          .
           move      srt-dpz-cli          to   w-buf-cli-dpz          .
           move      srt-rag-soc          to   w-buf-cli-rag          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Aggiornamento contatore clienti per zona        *
      *              * stampati                                        *
      *              *-------------------------------------------------*
           add       1                    to   w-tot-zon-ctr          .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento totali zona                       *
      *              *-------------------------------------------------*
           add       w-tot-cli-tsc        to   w-tot-zon-tsc          .
           add       w-tot-cli-tin        to   w-tot-zon-tin          .
           add       w-tot-cli-tas        to   w-tot-zon-tas          .
           add       w-tot-cli-tci        to   w-tot-zon-tci          .
           add       w-tot-cli-teg        to   w-tot-zon-teg          .
      *              *-------------------------------------------------*
      ...
      *                          * Cliente                             *
      *                          *-------------------------------------*
           move      w-buf-cli-cod        to   w-out-doc-cod-cli      .
           move      w-buf-cli-dpz        to   w-out-doc-dpz-cli      .
           move      w-buf-cli-rag        to   w-out-doc-rag-cli      .
      *                          *-------------------------------------*
      *                          * Tipo documento                      *
      *                          *-------------------------------------*
           if        srt-tip-ddr          =    01
                     move  "FT"           to   w-out-doc-tip-doc
           else if   srt-tip-ddr          =    02
                     move  "ND"           to   w-out-doc-tip-doc
           else if   srt-tip-ddr          =    11
                     move  "NC"           to   w-out-doc-tip-doc
           else if   srt-tip-ddr          =    21
                     move  "AC"           to   w-out-doc-tip-doc
           else if   srt-tip-ddr          =    99
                     move  "DD"           to   w-out-doc-tip-doc
           else      move  spaces         to   w-out-doc-tip-doc      .
      *                          *-------------------------------------*
      *                          * Numero documento                    *
      *                          *-------------------------------------*
           move      srt-num-ddr          to   w-out-doc-num-doc      .
      *                          *-------------------------------------*
      *                          * Data documento                      *
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
      ...
      *                          *-------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-out-doc-imp-doc      .
      *                          *-------------------------------------*
      *                          * Carattere di fine riga              *
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           string    "ANALISI DI PORTAFOGLIO CLIENTI PER ZONA AL "
                                delimited by   size
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      "B<"                 to   p-edm                  .
           move      w-rot-l02-cod-zon    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                          *-------------------------------------*
      *                          * String                              *
      ...
      *                          *-------------------------------------*
           move      01                   to   w-let-arc-zst-tip      .
           move      w-rot-l02-cod-zon    to   w-let-arc-zst-cod      .
           perform   let-arc-zst-000      thru let-arc-zst-999        .
      *                          *-------------------------------------*
      *                          * String                              *
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Sottolinetura intestazione zona                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dcc-cod-zon       to   w-let-arc-dcc-zon      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-dcc-520.
           ...
           move      zero                 to   w-let-arc-dcc-zon      .
       let-arc-dcc-999.
           exit.
