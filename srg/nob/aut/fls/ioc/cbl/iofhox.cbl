      ...
      *            *---------------------------------------------------*
      *            * Chiave numero 02 : VETCNS                         *
      *            *---------------------------------------------------*
               10  fil-k02.
                   15  fil-cod-vet        pic  9(07)       comp-3     .
                   15  fil-dat-cns        pic  9(07)       comp-3     .
      ...
      *            *---------------------------------------------------*
               10  pul-k02.
                   ...
                   15  pul-dat-cns        pic  9(07)       comp-3     .
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           ...
           move      zero                 to   rf-hox-cod-vet         .
           move      zero                 to   rf-hox-dat-cns         .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-hox-cod-vet       to   fil-cod-vet            .
           move      rf-hox-dat-cns       to   fil-dat-cns            .
           move      rf-hox-num-prt       to   fil-num-prt-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           ...
           move      fil-cod-vet          to   rf-hox-cod-vet         .
           move      fil-dat-cns          to   rf-hox-dat-cns         .
