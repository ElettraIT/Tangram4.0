      ...
      *                                   Fase:    age460              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 06/10/97    *
      *                       Ultima revisione:    NdK del 10/08/20    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma page4600 *
      *                                                                *
      *                    Stampa situazione maturazioni               *
      *                                                                *
      *                    SU MISURA PER NOBILI - Solo per file di     *
      *                                           esportazione         *
      *                                                                *
      *                    -----------------------------------------   *
      *                                                                *
      ...
      *                                                                *
      *                    /abd/asc/UTENTE/exp/AZI_age460.CSV          *
      *                                                                *
      *                    ___ OBSOLETO, VEDI STANDARD ___             *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Selezione su conteggi                                 *
      *        *  - 01 : Nessuna                                       *
      *        *  - 02 : Solo conteggi con residuo da maturare         *
      *        *-------------------------------------------------------*
           05  rr-sel-ctg                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Selezione su maturazioni                              *
      *        *  - 01 : Nessuna                                       *
      *        *  - 02 : Solo conteggi con maturazioni                 *
      *        *-------------------------------------------------------*
           05  rr-sel-mtz                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Totale importo conteggiato                        *
      *            *---------------------------------------------------*
               10  w-liv-age-tot-ctg      pic s9(11)                  .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Totale imponibile assoluto                        *
      *            *---------------------------------------------------*
               10  w-liv-age-iba-pvg      pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Generale                                              *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *            * Totale importo conteggiato                        *
      *            *---------------------------------------------------*
               10  w-liv-gen-tot-ctg      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * Totale importo maturato                           *
      *            *---------------------------------------------------*
      ...
      *            * Residuo                                           *
      *            *---------------------------------------------------*
               10  w-ass-wrk-res-mtz      pic s9(11)                  .
      ...
      *            * Agente                                            *
      *            *---------------------------------------------------*
               10  w-out-nom-age          pic  x(20)                  .
               10  w-out-sep-001          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice cliente                                    *
      *            *---------------------------------------------------*
               10  w-out-cod-cli          pic  x(12)                  .
               10  w-out-sep-002          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Ragione sociale cliente                           *
      *            *---------------------------------------------------*
               10  w-out-rag-cli          pic  x(40)                  .
               10  w-out-sep-003          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Numero conteggio                                  *
      *            *---------------------------------------------------*
               10  w-out-num-ctg          pic  x(09)                  .
               10  w-out-sep-004          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Riferimenti fattura                               *
      *            *---------------------------------------------------*
               10  w-out-rif-fat          pic  x(40)                  .
               10  w-out-sep-005          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Provvigione conteggiata                           *
      *            *---------------------------------------------------*
               10  w-out-imp-ctg          pic  x(15)                  .
               10  w-out-sep-006          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Provvigione maturata                              *
      *            *---------------------------------------------------*
               10  w-out-imp-mat          pic  x(15)                  .
               10  w-out-sep-007          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Provvigione residua                               *
      *            *---------------------------------------------------*
               10  w-out-imp-res          pic  x(15)                  .
               10  w-out-sep-008          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Ultima maturazione                                *
      *            *---------------------------------------------------*
               10  w-out-ult-mat          pic  x(20)                  .
               10  w-out-sep-009          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Incassato                                         *
      *            *---------------------------------------------------*
               10  w-out-imp-inc          pic  x(15)                  .
               10  w-out-sep-010          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Totale documento                                  *
      *            *---------------------------------------------------*
               10  w-out-tot-doc          pic  x(15)                  .
               10  w-out-sep-011          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Imponibile provvigionale                          *
      *            *---------------------------------------------------*
               10  w-out-ibl-pvg          pic  x(15)                  .
               10  w-out-sep-012          pic  x(01)                  .
      *            *---------------------------------------------------*
      ...
      *                      * zero                                    *
      *                      *-----------------------------------------*
           move      zero                 to   w-det-mep-dat-min      .
      *                      *-----------------------------------------*
      *                      * Data di maturazione massima : pari a    *
      *                      * data situazione                         *
      *                      *-----------------------------------------*
           move      rr-dat-sit           to   w-det-mep-dat-max      .
       stp-srt-inp-310.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       stp-srt-inp-450.
      *                  *---------------------------------------------*
      *                  * Se nessuna maturazione per il conteggio in  *
      *                  * corso di trattamento : ad emissione record  *
      *                  * di sort                                     *
      *                  *---------------------------------------------*
           if        w-det-mep-bum-num    not  = zero
...
______*              go to stp-srt-inp-800.
      ...
      *                  *---------------------------------------------*
      *                  * Si esce con l'ultima maturazione            *
      *                  *---------------------------------------------*
           if        w-det-mep-bum-inx    =    w-det-mep-bum-num
                     go to stp-srt-inp-530.
      *                  *---------------------------------------------*
      ...
      *                      * Importo di provvigione maturato         *
      *                      *-----------------------------------------*
           move      w-det-mep-bum-tot    to   srt-gpm-imp-mtz        .
       stp-srt-inp-760.
      *                      *-----------------------------------------*
      ...
      *                  * Calcolo del residuo                         *
      *                  *---------------------------------------------*
           move      srt-gpc-amm-pvg      to   w-ass-wrk-res-mtz      .
           subtract  srt-gpm-imp-mtz      from w-ass-wrk-res-mtz      .
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-ass-wrk-res-mtz    =    zero
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *                  * Totale importo conteggiato                  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-gen-tot-ctg      .
      *                  *---------------------------------------------*
      *                  * Totale importo maturato                     *
      *                  *---------------------------------------------*
      ...
      *                  * Totale importo conteggiato                  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-tot-ctg      .
      *                  *---------------------------------------------*
      *                  * Totale importo maturato                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Totale imponibile provvigionale assoluto    *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-iba-pvg      .
      *                  *---------------------------------------------*
      *                  * Numero maturazioni trattate per l'agente    *
      *                  *---------------------------------------------*
      ...
      *
       ...
       prn-fin-lr1-530.
      *                  *---------------------------------------------*
      *                  * Totale provvigioni conteggiate              *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      11                   to   p-car                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      058                  to   p-pos                  .
           move      w-liv-age-tot-ctg    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-lr1-540.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      092                  to   p-pos                  .
           move      w-liv-age-tot-ctg    to   p-num                  .
           subtract  w-liv-age-tot-mat    from p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-lr1-560.
      *                  *---------------------------------------------*
      ...
      *
           move      "Imp.in:"            to   w-all-str-cat (01)     .
      *
           move      "ED"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      11                   to   p-car                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      02                   to   w-all-str-num          .
      *
           move      "Imp.pr:"            to   w-all-str-cat (01)     .
      *
           move      "ED"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      11                   to   p-car                  .
           ...
           move      "S"                  to   p-sgn                  .
           move      "G"                  to   p-edm                  .
           move      w-liv-age-iba-pvg    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-all-str-cat (02)     .
      *
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-060.
      *              *-------------------------------------------------*
      *              * Cumulo totale imponibile provvigionale assoluto *
      *              *-------------------------------------------------*
           add       w-ass-ctg-ibl-pvg    to   w-liv-age-iba-pvg      .
       prn-liv-det-070.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Se il tipo maturazione e' a zero significa  *
      *                  * che non c'e maturazione per il conteggio    *
      *                  *---------------------------------------------*
           if        w-ass-mtz-tip-mtz    =    zero
                     move   w-ass-ctg-ibl-pvg
                                          to   w-ass-wrk-ibl-pvg
                     go to prn-liv-det-075.
      *                  *---------------------------------------------*
      *                  * Test sul tipo conteggio                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Applicazione della % determinata all'impo-  *
      *                  * bile provvigionale relativo al conteggio    *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "G"                  to   p-edm                  .
           move      w-ass-ctg-amm-pvg    to   p-num                  .
           subtract  w-ass-mtz-imp-mtz    from p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *                      *-----------------------------------------*
      *                      * Inizializzazione contatore per le righe *
      *                      * effettive presenti nella colonna 6      *
      *                      *-----------------------------------------*
      ...
      *
           ...
           if        p-edt                =    spaces
                     move  spaces         to   w-all-str-cat (02)
                     move  spaces         to   w-all-str-cat (03)
           else      move  spaces         to   w-all-str-cat (02)
                     move  p-edt          to   w-all-str-cat (03)     .
      *
      ...
      *                          * In campo di destinazione            *
      *                          *-------------------------------------*
           move      w-all-str-alf        to   w-stp-det-col-006
                                              (w-stp-det-cco-006)     .
       prn-liv-det-630.
      *                      *-----------------------------------------*
      *                      * Importo incassato                       *
      ...
      *                          *-------------------------------------*
           ...
           move      02                   to   w-all-str-num          .
      *
           move      "Incas.:"            to   w-all-str-cat (01)     .
      *
           move      "ED"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      11                   to   p-car                  .
      ...
      *                          *-------------------------------------*
           ...
           move      02                   to   w-all-str-num          .
      *
           move      "T.Doc.:"            to   w-all-str-cat (01)     .
      *
           move      "ED"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      11                   to   p-car                  .
      ...
      *                              * In campo di destinazione        *
      *                              *---------------------------------*
           move      srt-gpm-not-mtz      to   w-stp-det-col-006
                                              (w-stp-det-cco-006)     .
       prn-liv-det-690.
      *                      *-----------------------------------------*
      *                      * Fine colonna 6                          *
      ...
      *              *-------------------------------------------------*
           perform   prn-liv-det-seq-000  thru prn-liv-det-seq-999    .
       prn-liv-det-705.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   stp-lds-fvp-000      thru stp-lds-fvp-999        .
      *                  *---------------------------------------------*
      *                  * Test se seguito pagina agente               *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test su numero pagina                   *
      *                      *-----------------------------------------*
           if        w-stp-int-num-pag    not  > 1
                     go to prn-liv-det-744.
      *                      *-----------------------------------------*
      *                      * Literal di comodo per 'segue - agente'  *
      *                      *-----------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      "(segue -"           to   w-all-str-cat (01)     .
           move      w-liv-age-nom-age    to   w-all-str-cat (02)     .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      40                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine per emissione sequenziale                      *
      *    *-----------------------------------------------------------*
       prn-liv-det-seq-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tot-gen-ele        >    1
                     go to prn-liv-det-seq-100.
      *              *-------------------------------------------------*
      *              * Separatori per fincatura                        *
      *              *-------------------------------------------------*
           move      ";"                  to   w-out-sep-001
                                               ...
                                               w-out-sep-012          .
      *              *-------------------------------------------------*
      *              * Prompt per fincatura                            *
      *              *-------------------------------------------------*
           move      "Agente"             to   w-out-nom-age          .
           move      "Cod. Cliente"       to   w-out-cod-cli          .
           move      "Ragione sociale Cliente"
                                          to   w-out-rag-cli          .
           move      "Conteggio"          to   w-out-num-ctg          .
           move      "Riferimenti fattura"
                                          to   w-out-rif-fat          .
           move      "Conteggiato"        to   w-out-imp-ctg          .
           move      "Maturato"           to   w-out-imp-mat          .
           move      "Residuo"            to   w-out-imp-res          .
           move      "Ultima mat."        to   w-out-ult-mat          .
           move      "Incassato"          to   w-out-imp-inc          .
           move      "Totale doc."        to   w-out-tot-doc          .
           move      "Imponibile pr"      to   w-out-ibl-pvg          .
      *              *-------------------------------------------------*
      ...
      *              * Agente                                          *
      *              *-------------------------------------------------*
           move      srt-age-nom-age      to   w-out-nom-age          .
       prn-liv-det-seq-150.
      *              *-------------------------------------------------*
      *              * Codice del cliente                              *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        srt-gpc-cod-cli      =    zero
                     move  spaces         to   w-out-cod-cli
                     go to prn-liv-det-seq-200.
      *                  *---------------------------------------------*
      *                  * Editing codice del cliente                  *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
      ...
      *                  * In campo di output                          *
      *                  *---------------------------------------------*
           move      w-all-str-alf        to   w-out-cod-cli          .
       prn-liv-det-seq-200.
      *              *-------------------------------------------------*
      *              * Ragione sociale cliente                         *
      *              *-------------------------------------------------*
           move      srt-cli-rag-cli      to   w-out-rag-cli          .
       prn-liv-det-seq-300.
      *              *-------------------------------------------------*
      *              * Numero conteggio                                *
      *              *-------------------------------------------------*
      ...
      *                  * In campo di output                          *
      *                  *---------------------------------------------*
           move      w-all-str-alf        to   w-out-rif-fat          .
       prn-liv-det-seq-400.
      *              *-------------------------------------------------*
      *              * Provvigione conteggiata                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        srt-gpm-num-mtz      =    zero
                     move  spaces         to   w-out-ult-mat
                     go to prn-liv-det-seq-600.
      *                  *---------------------------------------------*
      *                  * Editing e concatenazione                    *
      *                  *---------------------------------------------*
           move      23                   to   w-all-str-lun          .
      ...
      *                  * In campo di output                          *
      *                  *---------------------------------------------*
           move      w-all-str-alf        to   w-out-ult-mat          .
       prn-liv-det-seq-600.
      *              *-------------------------------------------------*
      *              * Incassato                                       *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "          conteggiata        maturata         Resi
      -              "duo         sulla maturazione   "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-tfv-vrt-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      54                   to   p-pos                  .
           move      w-liv-gen-tot-ctg    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      ...
      *              *-------------------------------------------------*
           if        rf-gpm-dat-mtz       <    w-det-mep-dat-min
                     ...
                     go to det-mep-lmt-325.
______*    if        rf-gpm-dat-mtz       >    w-det-mep-dat-max
______*              add   1              to   w-det-mep-bum-suc
______*              go to det-mep-lmt-325.
      ...
      *    *                               - N : No                    *
      *    *                                                           *
      *    * (*) segnale forzato sempre a 'S' per evitare che nelle    *
      *    *     sommatorie vengono totali incoerenti con i dati       *
      *    *     (Modifica concordata con Mario - 16/04/18)            *
      *    *-----------------------------------------------------------*
       ass-age-mtz-000.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo di conteggio      *
