      ...
      *                       Ultima revisione:    NdK del 17/09/14    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
      *        * Per determinazione data consegna da annotazioni       *
      *        *-------------------------------------------------------*
           05  w-det-des-ant.
               10  w-det-des-ant-des      pic  x(40)                  .
               10  w-det-des-ant-des-r redefines
                   w-det-des-ant-des.
                   15  w-det-des-ant-txt  pic  x(25)                  .
                   15  w-det-des-ant-gio  pic  9(02)                  .
                   15  filler             pic  x(01)                  .
                   15  w-det-des-ant-mes  pic  9(02)                  .
                   15  filler             pic  x(01)                  .
                   15  w-det-des-ant-ann  pic  9(02)                  .
                   15  filler             pic  x(07)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-det-dow.
      *        *-------------------------------------------------------*
      *        * Literal per giorno della settimana                    *
      *        *-------------------------------------------------------*
           05  w-det-dow-lit              pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Numero per giorno della settimana                     *
      *        *-------------------------------------------------------*
           05  w-det-dow-num              pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Giorno per la determinazione                          *
      *        *-------------------------------------------------------*
           05  w-det-dow-dat              pic  9(07)                  .
           05  w-det-dow-dat-r redefines
               w-det-dow-dat.
               10  w-det-dow-saa          pic  9(03)                  .
               10  w-det-dow-mes          pic  9(02)                  .
               10  w-det-dow-gio          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Anno per esteso                                       *
      *        *-------------------------------------------------------*
           05  w-det-dow-aes              pic  9(04)                  .
           05  w-det-dow-aes-r redefines
               w-det-dow-aes.
               10  w-det-dow-sec          pic  9(02)                  .
               10  w-det-dow-ann          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Tabella giorni della settimana                        *
      *        *-------------------------------------------------------*
           05  w-det-dow-tdw.
               ...
               10  filler                 pic  x(10)   value
                                                        ".........."  .
           05  w-det-dow-tdw-r redefines
               w-det-dow-tdw.
               10  w-det-dow-tde occurs 8 pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Variabili                                             *
      *        *-------------------------------------------------------*
           05  w-det-dow-c01              pic  9(02)                  .
           05  w-det-dow-c02              pic  9(02)                  .
           05  w-det-dow-c03              pic  9(02)                  .
           05  w-det-dow-c04              pic  9(02)                  .
           05  w-det-dow-c05              pic  9(02)                  .
           05  w-det-dow-c06              pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Contatori                                             *
      *        *-------------------------------------------------------*
           05  w-det-dow-x01              pic s9(02)                  .
           05  w-det-dow-x02              pic s9(02)                  .
           05  w-det-dow-x03              pic  9(02)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Segnale di si/no bisestile                            *
      *        *-------------------------------------------------------*
           05  w-det-dow-snb              pic  x(01)                  .
      ...
      *                      *-----------------------------------------*
           if        rf-bit-cod-vt2       =    rr-cod-vet
                     move  rf-bit-cod-vt2 to   rf-bit-cod-vet
                     go to stp-srt-inp-320.
      *                      *-----------------------------------------*
      *                      * Test su codice vettore 3                *
      *                      *-----------------------------------------*
           if        rf-bit-cod-vt3       =    rr-cod-vet
                     move  rf-bit-cod-vt3 to   rf-bit-cod-vet
                     go to stp-srt-inp-320.
      *                      *-----------------------------------------*
      ...
      *                          * Sigla numerazione                   *
      *                          *-------------------------------------*
           move      rf-bit-sgl-num       to   srt-sgl-num            .
      *                          *-------------------------------------*
      *                          * Numero protocollo                   *
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      srt-sgl-num          to   w-all-str-cat (1)      .
      ...
      *                          * Test preliminare                    *
      *                          *-------------------------------------*
           if        w-ext-des-ant        =    spaces
                     go to prn-liv-det-520.
      *                          *-------------------------------------*
      *                          * Estrazione data                     *
      *                          *-------------------------------------*
           move      w-ext-des-ant        to   w-det-des-ant-des      .
           move      w-det-des-ant-gio    to   s-gio                  .
           move      w-det-des-ant-mes    to   s-mes                  .
           move      w-det-des-ant-ann    to   s-saa                  .
           add       2000                 to   s-saa                  .
           move      s-dat                to   srt-dat-itr            .
       prn-liv-det-520.
           move      "PF"                 to   p-ope                  .
           move      "D"                  to   p-tip                  .
           move      p-lnr                to   p-lin                  .
