      ...
      *                       Ultima revisione:    NdK del 12/05/23    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    SU MISURA PER NOBILI - Solo per files di    *
      *                                           esportazione         *
      *                                                                *
      *                    -----------------------------------------   *
      *                                                                *
      ...
      *                                                                *
      *                    /abd/asc/UTENTE/exp/AZI_bol302.CSV          *
      *                    /abd/asc/UTENTE/exp/AZI_bol302p.CSV         *
      *                                                                *
      *================================================================*
      ...
      *                          *-------------------------------------*
           move      "CV"                 to   p-ope                  .
           move      03                   to   p-car                  .
           move      rf-bit-voc-des (01)  to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-num                to   srt-num-ban            .
      *                          *-------------------------------------*
      *                          * Peso totale                         *
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-cic-850.
      *              *-------------------------------------------------*
      *              * Per emissione sequenziale statistica peso       *
      *              *-------------------------------------------------*
           perform   prn-fin-cic-pes-000  thru prn-fin-cic-pes-999    .
       prn-fin-cic-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    * Ciclo Report Program : Esecuzione per fine ciclo          *
      *    *                                                           *
      *    * Subroutine di emissione sequenziale statistica peso       *
      *    *-----------------------------------------------------------*
       prn-fin-cic-pes-000.
      *              *-------------------------------------------------*
      *              * Preparazione per file lista                     *
      *              *-------------------------------------------------*
           perform   prn-fin-cic-opl-000  thru prn-fin-cic-opl-999    .
       prn-fin-cic-pes-100.
      *              *-------------------------------------------------*
      *              * Start su file [kk0]                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        kk0-pes-tot          =    zero
                     go to prn-fin-cic-pes-200.
       prn-fin-cic-pes-600.
      *              *-------------------------------------------------*
      *              * Emissione linea per file lista                  *
      *              *-------------------------------------------------*
           perform   prn-fin-cic-ell-000  thru prn-fin-cic-ell-999    .
       prn-fin-cic-pes-700.
      *              *-------------------------------------------------*
      *              * Riciclo su [kk0]                                *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   prn-fin-cic-cll-000  thru prn-fin-cic-cll-999    .
       prn-fin-cic-pes-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-fin-cic-pes-999.
       prn-fin-cic-pes-999.
           exit.
      ...
      *    * Ciclo Report Program : Esecuzione per fine ciclo          *
      *    *                                                           *
      *    * Subroutine di composizione ed emissione linea             *
      *    *-----------------------------------------------------------*
       prn-fin-cic-ell-000.
      *              *-------------------------------------------------*
      *              * Codice vettore                                  *
      ...
      *    * Ciclo Report Program : Esecuzione per fine ciclo          *
      *    *                                                           *
      *    * Subroutine di chiusura file statistico                    *
      *    *-----------------------------------------------------------*
       prn-fin-cic-cll-000.
      *              *-------------------------------------------------*
      *              * Chiusura                                        *
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-010.
      *              *-------------------------------------------------*
      *              * Aggiornamento file di appoggio per peso         *
      *              *-------------------------------------------------*
           perform   prn-liv-det-pes-000  thru prn-liv-det-pes-999    .
       prn-liv-det-020.
      *              *-------------------------------------------------*
      ...
      *                  * Bancali                                     *
      *                  *---------------------------------------------*
           add       srt-num-ban          to   w-tot-gen-ban          .
      *                  *---------------------------------------------*
      *                  * Peso                                        *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-045.
      *              *-------------------------------------------------*
      *              * Test se richiesta stampa per bolle da fatturare *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su tipo stampa                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Subroutine dettaglio per bolle da fatturare *
      *                  *---------------------------------------------*
           perform   prn-liv-det-bdf-000  thru prn-liv-det-bdf-999    .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     prn-liv-det-999.
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine per accumulo peso cliente                      *
      *    *-----------------------------------------------------------*
       prn-liv-det-pes-000.
      *              *-------------------------------------------------*
      *              * Lettura [kk0]                                   *
      ...
      *                  * Preparazione chiave                         *
      *                  *---------------------------------------------*
           move      srt-cod-vet          to   kk0-cod-vet            .
           move      srt-cod-arc          to   kk0-cod-arc            .
      *                  *---------------------------------------------*
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           read      kk0    key is  kk0-key
                            invalid key
                            go to prn-liv-det-pes-300.
       prn-liv-det-pes-100.
      *              *-------------------------------------------------*
      *              * Se record trovato                               *
      *              *-------------------------------------------------*
      ...
      *                  * Accumulo peso                               *
      *                  *---------------------------------------------*
           add       srt-pes-tot          to   kk0-pes-tot            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     prn-liv-det-pes-900.
       prn-liv-det-pes-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      srt-cod-vet          to   kk0-cod-vet            .
           move      srt-cod-arc          to   kk0-cod-arc            .
           move      srt-pes-tot          to   kk0-pes-tot            .
      *                  *---------------------------------------------*
      *                  * Scrittura file [kk0]                        *
      *                  *---------------------------------------------*
           write     kk0-rec                                          .
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine stampa righe bolle da fatturare                *
      *    *-----------------------------------------------------------*
       prn-liv-det-bdf-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore righe                 *
      ...
      *                  *---------------------------------------------*
           if        p-res                >    2
                     go to prn-liv-det-bdf-600.
      *                  *---------------------------------------------*
      *                  * Reintestazione                              *
      *                  *---------------------------------------------*
           perform   int-pag-sta-000      thru int-pag-sta-999        .
           if        w-cnt-prn-flg-int    not  = spaces
                     go to prn-liv-det-bdf-999.
      *                  *---------------------------------------------*
      *                  * Fincatura per dettaglio                     *
      *                  *---------------------------------------------*
           perform   fin-liv-det-000      thru fin-liv-det-999        .
      ...
      *                  *---------------------------------------------*
           ...
           move      "<BD"                to   v-edm                  .
           move      rf-bir-per-scr (1)   to   v-num                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<BD"                to   v-edm                  .
           move      rf-bir-per-scr (2)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<BD"                to   v-edm                  .
           move      rf-bir-per-scr (3)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<BD"                to   v-edm                  .
           move      rf-bir-per-scr (4)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<BD"                to   v-edm                  .
           move      rf-bir-per-scr (5)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
