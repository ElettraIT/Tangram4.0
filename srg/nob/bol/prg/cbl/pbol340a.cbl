      ...
      *                       Ultima revisione:    NdK del 08/11/24    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA ETICHETTE DI SPEDIZIONE A CLIENTI"       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Determinazione numero etichette                       *
      *        *                                                       *
      *        * NOBILI                                                *
      *        *-------------------------------------------------------*
           05  w-det-num-eti-num          pic  9(03)                  .
      *        *-------------------------------------------------------*
...
______*        10  w-det-fin-rig-chr      pic  x(01)   value H"0D"    .
      ...
      *            * - 'pes_tot' : Peso totale                         *
      *            * - 'num_col' : Numero colli                        *
      *            * - 'num_doc' : Numero documento da stampare        *
      *            * - 'dat_doc' : Data documento da stampare          *
      *            *                                                   *
      *            * - 'rag_cli' : Ragione sociale cliente             *
      *            * - 'via_cli' : Indirizzo cliente                   *
      *            * - 'loc_cli' : Localita' cliente                   *
      *            * - 'prv_cli' : Provincia cliente                   *
      *            * - 'cap_cli' : CAP cliente                         *
      *            * - 'naz_cli' : Nazione cliente                     *
      *            *                                                   *
      *            * - 'rag_vet' : Ragione sociale vettore             *
      *            * - 'via_vet' : Indirizzo vettore                   *
      *            * - 'loc_vet' : Localita' vettore                   *
      *            *                                                   *
      ...
      *        * Tipo documento                                        *
      *        *-------------------------------------------------------*
           05  w-def-tip-mov              pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Data documento                                        *
      *        *-------------------------------------------------------*
           05  w-def-dat-mov              pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-def-tip-mov          .
           move      s-dat                to   w-def-dat-mov          .
       pre-exe-pgm-999.
           exit.
      ...
      *              * Numero etichette                                *
      *              *-------------------------------------------------*
______*    move      "DS"                 to   v-ope                  .
______*    move      "A"                  to   v-tip                  .
______*    move      28                   to   v-car                  .
______*    move      11                   to   v-lin                  .
______*    move      01                   to   v-pos                  .
______*    move      "Bancali                    :"
______*                                   to   v-alf                  .
...
______*                                  using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           if        w-def-tip-mov        =    spaces
                     go to acc-tip-mov-100.
           move      w-def-tip-mov        to   rr-tip-mov             .
       acc-tip-mov-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rr-tip-mov           to   w-def-tip-mov          .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-def-dat-mov        =    zero
                     go to acc-dat-min-100.
           move      w-def-dat-mov        to   rr-dat-min             .
       acc-dat-min-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-fnd-arc-bit-tmb    to   rr-tip-mov             .
           move      w-fnd-arc-bit-dat    to   rr-dat-min             .
           move      w-fnd-arc-bit-num    to   w-wrk-nbl-int          .
           move      w-wrk-nbi-saa        to   w-wrk-ndo-saa          .
           move      w-wrk-nbi-npg        to   w-wrk-ndo-npg          .
           move      w-wrk-nbl-acc        to   rr-ndo-min             .
      *                  *---------------------------------------------*
      *                  * A reimpostazione                            *
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      ...
      *                  * Memorizzazione valore di default generale   *
      *                  *---------------------------------------------*
           move      rr-dat-min           to   w-def-dat-mov          .
       acc-dat-min-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-ndo-min           =    zero
                     go to acc-ndo-min-100.
      *                  *---------------------------------------------*
      *                  * Lettura testata bolla per numero bancali    *
      ...
      *    *===========================================================*
      *    * Accettazione campo : Numero etichette                     *
      *    *-----------------------------------------------------------*
       acc-num-eti-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        rf-bit-cod-arc       <    rr-cli-min or
                     rf-bit-cod-arc       >    rr-cli-max
                     go to prn-sel-rec-900.
       prn-sel-rec-300.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      ...
      *              * Stampa etichette                                *
      *              *-------------------------------------------------*
           perform   prn-liv-det-e01-000  thru prn-liv-det-e01-999    .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-cli-cod-cmn       to   w-inl-dcm-cmn          .
           move      rf-cli-cod-naz       to   w-inl-dcm-naz          .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Conversione della voce descrittiva 1 che    *
      *                  * rappresenta il numero bancali               *
      *                  *---------------------------------------------*
           move      "CV"                 to   p-ope                  .
           move      03                   to   p-car                  .
           move      rf-bit-voc-des (1)   to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-num                to   w-det-num-eti-num      .
      *                  *---------------------------------------------*
      *                  * Test su numero etichette                    *
      *                  *---------------------------------------------*
           if        w-det-num-eti-num    =    zero
                     move  1              to   w-det-num-eti-num      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione preliminare                 *
      *                  *---------------------------------------------*
           move      spaces               to   w-out-eti              .
      ...
      *                  *---------------------------------------------*
           ...
           move      "<B"                 to   p-edm                  .
           move      w-det-num-eti-num    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Valore record                               *
      ...
      *                  * Tipo record                                 *
      *                  *---------------------------------------------*
           move      "num_col"            to   w-out-eti-tip-rec      .
      *                  *---------------------------------------------*
      *                  * Separatore                                  *
      *                  *---------------------------------------------*
           move      ";"                  to   w-out-eti-sep-001      .
      ...
      *                  * Tipo record                                 *
      *                  *---------------------------------------------*
           move      "dat_doc"            to   w-out-eti-tip-rec      .
      *                  *---------------------------------------------*
      *                  * Separatore                                  *
      *                  *---------------------------------------------*
           move      ";"                  to   w-out-eti-sep-001      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-eti-420.
      *              *-------------------------------------------------*
      *              * Emissione provincia cliente                     *
      *              *                                                 *
      *              * N.B.: non determinato se indirizzo manuale      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura file [gxc]                          *
      *                  *---------------------------------------------*
      ...
      *                  * Tipo record                                 *
      *                  *---------------------------------------------*
           move      "prv_cli"            to   w-out-eti-tip-rec      .
      *                  *---------------------------------------------*
      *                  * Separatore                                  *
      *                  *---------------------------------------------*
           move      ";"                  to   w-out-eti-sep-001      .
      ...
      *                  * Valore record                               *
      *                  *---------------------------------------------*
           move      w-let-arc-gxc-prv    to   w-out-eti-val-rec      .
      *                  *---------------------------------------------*
      *                  * Carattere di fine riga                      *
      *                  *---------------------------------------------*
           move      w-det-fin-rig-chr    to   w-out-eti-fin-rig      .
      ...
      *                  * Tipo record                                 *
      *                  *---------------------------------------------*
           move      "cap_cli"            to   w-out-eti-tip-rec      .
      *                  *---------------------------------------------*
      *                  * Separatore                                  *
      *                  *---------------------------------------------*
           move      ";"                  to   w-out-eti-sep-001      .
      ...
      *                  * Valore record                               *
      *                  *---------------------------------------------*
           move      w-let-arc-gxc-cap    to   w-out-eti-val-rec      .
      *                  *---------------------------------------------*
      *                  * Carattere di fine riga                      *
      *                  *---------------------------------------------*
           move      w-det-fin-rig-chr    to   w-out-eti-fin-rig      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-eti-440.
      *              *-------------------------------------------------*
      *              * Emissione nazione cliente                       *
      *              *                                                 *
      *              * N.B.: non determinata se indirizzo manuale      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione preliminare                 *
      *                  *---------------------------------------------*
      ...
      *                  * Tipo record                                 *
      *                  *---------------------------------------------*
           move      "naz_cli"            to   w-out-eti-tip-rec      .
      *                  *---------------------------------------------*
      *                  * Separatore                                  *
      *                  *---------------------------------------------*
           move      ";"                  to   w-out-eti-sep-001      .
      ...
      *                  * Valore record                               *
      *                  *---------------------------------------------*
           move      w-inl-dcm-naz        to   w-out-eti-val-rec      .
      *                  *---------------------------------------------*
      *                  * Carattere di fine riga                      *
      *                  *---------------------------------------------*
           move      w-det-fin-rig-chr    to   w-out-eti-fin-rig      .
