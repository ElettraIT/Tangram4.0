      ...
      *                       Ultima revisione:    NdK del 28/08/25    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  w-det-des-rig.
               10  w-det-des-rig-des.
                   15  w-det-des-rig-rgd occurs 10
                                          pic  x(40)                  .
           05  w-det-des-rig-nrd          pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-prn-ini-lr1.
           ...
           05  w-prn-ini-lr1-col          pic  9(05)                  .
           05  w-prn-ini-lr1-pes          pic  9(06)v9(03)            .
           05  w-prn-ini-lr1-tmb          pic  x(05)                  .
           05  w-prn-ini-lr1-num          pic  9(11)                  .
           05  w-prn-ini-lr1-dat          pic  9(08)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-wrk.
           ...
           05  w-wrk-ctr-zgc              pic  9(07)                  .
           05  w-wrk-rag-cli              pic  x(132)                 .
      ...
      *              *-------------------------------------------------*
       ...
       pre-exe-pgm-200.
      *              *-------------------------------------------------*
      *              * Composizione del comando di aggiornamento       *
      *              *                                                 *
      *              * NOBILI                                          *
      *              *-------------------------------------------------*
           move      "/abd/etc/paut8900"  to   o-shs                  .
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Subroutine preliminare per verificare se ci     *
      *              * sono giri clienti per il vettore                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Subroutine                                  *
      *                  *---------------------------------------------*
           perform   stp-srt-inp-zgc-000  thru stp-srt-inp-zgc-999    .
      *                  *---------------------------------------------*
      *                  * Test sul contatore elementi trovati         *
      *                  *---------------------------------------------*
           if        w-wrk-ctr-zgc        >    zero
                     go to stp-srt-inp-010.
      *                  *---------------------------------------------*
      *                  * Se nessun giro clienti riscontrato e se     *
      *                  * vettore STEF                                *
      *                  *---------------------------------------------*
           if        rr-cod-vet           =    0000079
                     perform stp-srt-inp-stf-000
                                          thru stp-srt-inp-stf-999
           else      perform stp-srt-inp-oct-000
                                          thru stp-srt-inp-oct-999    .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-075.
      *              *-------------------------------------------------*
      *              * Determinazione data precedente di 30 giorni     *
      *              *                                                 *
      *              * NOBILI - si presume che gli ordini vengano      *
      *              *          evasi in pochi giorni                  *
      *              *                                                 *
      *              * (Massimiliano - 28/08/25 - 30 gg)               *
      *              *-------------------------------------------------*
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *
           ...
           else      move  rr-dcn-min     to   w-det-nrg-dat-dtb      .
      *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-nrg-dat-dtd    to   rf-oct-dat-doc         .
      ...
      *                  *---------------------------------------------*
           if        rf-oct-dpz-arc       not  = rf-zgc-dpz-cli
      ...
      *    * Input procedure per sort                                  *
      *    *                                                           *
      *    * Subroutine preliminare su giri clienti                    *
      *    *-----------------------------------------------------------*
       stp-srt-inp-zgc-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      zero                 to   w-wrk-ctr-zgc          .
       stp-srt-inp-zgc-100.
      *              *-------------------------------------------------*
      *              * Start su file [zgc]                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           add       1                    to   w-wrk-ctr-zgc          .
       stp-srt-inp-zgc-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-zgc-999.
       stp-srt-inp-zgc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "VETCNS    "         to   f-key                  .
           move      rr-cod-vet           to   rf-hox-cod-vet         .
           move      rr-dcn-min           to   rf-hox-dat-cns         .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale record [hox]                *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "nob/aut/fls/ioc/obj/iofhox"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           if        rf-hox-cod-vet       not  = rr-cod-vet
                     go to stp-srt-inp-stf-900.
      *                  *---------------------------------------------*
      *                  * Test su data consegna                       *
      *                  *---------------------------------------------*
           if        rf-hox-dat-cns       >    rr-dcn-max
                     go to stp-srt-inp-stf-900.
       stp-srt-inp-stf-130.
      *              *-------------------------------------------------*
      *              * Selezione sul record                            *
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      rf-hox-num-prt       to   rf-oct-num-prt         .
           move      "pgm/orc/fls/ioc/obj/iofoct"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
           if        w-stp-srt-inp-wtp    not  = "A"
                     go to stp-srt-inp-stf-233.
      *                              *---------------------------------*
      *                              * Test su status riga di addebito *
      *                              *---------------------------------*
           if        d-qev-roc-sts-rda    not  = 01
                     go to stp-srt-inp-stf-200.
           go to     stp-srt-inp-stf-240.
       stp-srt-inp-stf-233.
      *                          *-------------------------------------*
      *                          * Se quantita' ancora da evadere a    *
      *                          * zero : riciclo                      *
      ...
      *              * Tabella bancali                                 *
      *              *-------------------------------------------------*
           perform   prn-ini-cic-tbc-000  thru prn-ini-cic-tbc-999    .
       prn-ini-cic-999.
           exit.
      ...
      *    * Ciclo Report Program : Esecuzione per inizio ciclo        *
      *    *                                                           *
      *    * Subroutine per tabella bancali                            *
      *    *-----------------------------------------------------------*
       prn-ini-cic-tbc-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "| TOTALE BANCALI EPAL CARICATI           |        
      -              "              | | TOTALE BANCALI EPAL RESI        
      -              "        |                      |"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Totale documenti:"  to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Valore                                  *
      ...
      *                      *-----------------------------------------*
           ...
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   w-wrk-rag-cli          .
      *                      *-----------------------------------------*
      *                      * Stampa                                  *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      w-wrk-rag-cli        to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Sub-intestazione cliente                    *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da eseguire                     *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLI    "         to   f-key                  .
           move      w-rot-l02-cod-cli    to   rf-cli-cod-cli         .
           move      "pgm/cge/fls/ioc/obj/iofcli"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      w-wrk-rag-cli        to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-rot-l01-num-prt    to   rf-oct-num-prt         .
           move      "pgm/orc/fls/ioc/obj/iofoct"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<"                  to   p-edm                  .
           move      rf-oct-num-doc       to   w-wrk-num-011          .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-oct-voc-des (1)   to   w-det-des-zvf-cod      .
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-lr1-050.
      *              *-------------------------------------------------*
      *              * Stampa totale colli e peso                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se da stampare                         *
      *                  *---------------------------------------------*
           if        w-prn-ini-lr1-col    =    zero and
                     w-prn-ini-lr1-pes    =    zero
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      080                  to   p-pos                  .
           move      w-prn-ini-lr1-col    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Peso                                        *
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      086                  to   p-pos                  .
           move      w-prn-ini-lr1-pes    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Estremi bolla                               *
      ...
      *                      *-----------------------------------------*
           ...
           move      w-prn-ini-lr1-tmb    to   w-all-str-cat (1)      .
      ...
      *                  *---------------------------------------------*
           perform   prn-liv-det-gri-000  thru prn-liv-det-gri-999    .
      *                  *---------------------------------------------*
      *                  * Codice prodotto                             *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-300.
      *                  *---------------------------------------------*
      *                  * Determinazione lotto, colli e peso          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Normalizzazioni preliminari             *
      *                      *-----------------------------------------*
           move      spaces               to   w-prn-ini-lr1-vrn      .
           move      zero                 to   w-prn-ini-lr1-col      .
           move      zero                 to   w-prn-ini-lr1-pes      .
           move      spaces               to   w-prn-ini-lr1-tmb      .
           move      zero                 to   w-prn-ini-lr1-num      .
           move      zero                 to   w-prn-ini-lr1-dat      .
      *                      *-----------------------------------------*
      *                      * Lettura [bir]                           *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-600.
      *              *-------------------------------------------------*
      *              * Eventuali linee descrizione successive          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-bit                 .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione colli                       *
      *                  *---------------------------------------------*
           move      rf-bit-num-col       to   w-prn-ini-lr1-col      .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione peso                        *
      *                  *---------------------------------------------*
           move      rf-bit-pes-tot       to   w-prn-ini-lr1-pes      .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione estremi bolla               *
      *                  *---------------------------------------------*
           move      rf-bit-cod-tmb       to   w-prn-ini-lr1-tmb      .
           move      rf-bit-num-doc       to   w-prn-ini-lr1-num      .
           move      rf-bit-dat-doc       to   w-prn-ini-lr1-dat      .
       prn-liv-det-bir-600.
      *              *-------------------------------------------------*
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine per righe di descrizione successive            *
      *    *-----------------------------------------------------------*
       prn-liv-det-des-000.
      *              *-------------------------------------------------*
      *              * Ciclo per 10 righe                              *
      *              *-------------------------------------------------*
           move      1                    to   w-det-des-rig-nrd      .
       prn-liv-det-des-200.
           add       1                    to   w-det-des-rig-nrd      .
           if        w-det-des-rig-nrd    >    10
                     go to prn-liv-det-des-900.
           if        srt-des-rgd
                    (w-det-des-rig-nrd)   =    spaces
                     go to prn-liv-det-des-900.
       prn-liv-det-des-300.
      *              *-------------------------------------------------*
      *              * Test se righe residue sufficienti               *
      ...
      *              *-------------------------------------------------*
      ...
      -              "   |UdM| Ordinato  |  Consegn. |    Colli   |   Lo
      -              "tto   |  Scadenza   | Consegna |"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
