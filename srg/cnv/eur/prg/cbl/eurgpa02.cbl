      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "CONVERSIONE LISTINI FORNITORI EURO -NEG."       .
      ...
      *              *-------------------------------------------------*
      *              * Determinazione storico listini                  *
      *              *-------------------------------------------------*
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *
           ...
           move      spaces               to   w-det-pbs-cod-lst      .
           move      zero                 to   w-det-pbs-cod-cli      .
           move      c-sgl                to   w-det-pbs-sgl-vlt      .
           move      srt-num-mag          to   w-det-pbs-num-pro      .
           move      2                    to   w-det-pbs-max-sto      .
           move      "N"                  to   w-det-pbs-dcp-mem      .
      ...
      *                      *-----------------------------------------*
           ...
           move      srt-sgl-vlt          to   w-coe-cmb-vlt-sdv      .
      ...
      *                  * Sigla valuta                                *
      *                  *---------------------------------------------*
           move      rf-haf-sgl-vlt       to   w-sav-sgl-vlt          .
           move      "EUR"                to   rf-haf-sgl-vlt         .
      *                  *---------------------------------------------*
      *                  * Coefficiente di cambio                      *
      *                  *---------------------------------------------*
           move      1936,27              to   rf-haf-cdc-vlt         .
           move      0990101              to   rf-haf-drf-vlt         .
      *                  *---------------------------------------------*
      *                  * Data di entrata in vigore dati di acquisto  *
      *                  *---------------------------------------------*
______*    move      rr-dat-acq           to   rf-haf-dev-acq         .
      *                  *---------------------------------------------*
      *                  * Data di entrata in vigore dati di vendita   *
      *                  *---------------------------------------------*
______*    move      rr-dat-ven           to   rf-haf-dev-ven         .
       upd-rec-haf-320.
      *                  *---------------------------------------------*
      *                  * Prezzo per 'n' pezzi, acquisto              *
      *                  *                                             *
      *                  * Da record [aaf] gia' convertito             *
      *                  *---------------------------------------------*
           if        srt-snx-tum          not  = "P"
                     move  spaces         to   rf-haf-prz-mgl
                     go to upd-rec-haf-330.
           if        srt-cmo-tum          =    1000
                     move  "K"            to   rf-haf-prz-mgl
           else if   srt-cmo-tum          =    100
                     move  "C"            to   rf-haf-prz-mgl
           else if   srt-cmo-tum          =    10
                     move  "D"            to   rf-haf-prz-mgl
           else      move  spaces         to   rf-haf-prz-mgl         .
       upd-rec-haf-330.
      *                  *---------------------------------------------*
      *                  * Costo lordo                                 *
      *                  *---------------------------------------------*
      ...
      *                      * Eventuale pre-conversione               *
      *                      *-----------------------------------------*
           if        w-sav-sgl-vlt        =    "LIT"
                     go to upd-rec-haf-340.
      *                      *-----------------------------------------*
      *                      * Lettura dati valuta                     *
      *                      *-----------------------------------------*
           move      w-sav-sgl-vlt        to   w-let-arc-zvl-cod      .
           perform   let-arc-zvl-000      thru let-arc-zvl-999        .
           move      w-let-arc-zvl-des    to   rr-sgl-vlt-des         .
           move      w-let-arc-zvl-din    to   rr-sgl-vlt-din         .
           move      w-let-arc-zvl-dec    to   rr-sgl-vlt-dec         .
      ...
      *                      *-----------------------------------------*
           move      "CC"                 to   w-coe-cmb-vlt-ope      .
           move      w-sav-sgl-vlt        to   w-coe-cmb-vlt-sdv      .
           move      w-let-arc-zvl-tdc    to   w-coe-cmb-vlt-tdc      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      ...
      *                      * Conversione in Lire                     *
      *                      *-----------------------------------------*
           move      w-sav-sgl-vlt        to   w-cvs-vlt-sgl          .
           move      w-let-arc-zvl-dec    to   w-cvs-vlt-dec          .
           move      w-let-arc-zvl-tdc    to   w-cvs-vlt-tdc          .
           move      w-coe-cmb-vlt-cdc    to   w-cvs-vlt-cdc          .
           move      rf-haf-cst-lrd       to   w-cvs-vlt-aav          .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-let-arc-zvl-dec    to   d-rcl-haf-dec-vlt      .
           move      w-let-arc-zvl-tdc    to   d-rcl-haf-tdc-vlt      .
           ...
           move      rf-haf-prc-ctt       to   d-rcl-haf-prc-ctt      .
      *                  *---------------------------------------------*
      *                  * Richiamo routine                            *
      *                  *---------------------------------------------*
           move      "fer/gpa/prg/obj/drclhaf0"
