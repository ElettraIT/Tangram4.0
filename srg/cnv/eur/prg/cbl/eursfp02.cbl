      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [sfp] : Standard         *
      *                                                                *
      *                    Update valuta pagamenti fornitori           *
      *                                                                *
      *                    Pagamenti in LIT trasformati in EUR         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento pagamenti fornitori - Euro"       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione pagamenti fornitori         "  .
      ...
      *              *-------------------------------------------------*
           if        rf-sfp-sgl-vlt       not  = "LIT"
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Sigla valuta per il pagamento                   *
      *              *-------------------------------------------------*
           move      "EUR"                to   rf-sfp-sgl-vlt         .
      *              *-------------------------------------------------*
      *              * Numero decimali per la valuta del pagamento     *
      *              *-------------------------------------------------*
           move      2                    to   rf-sfp-dec-vlt         .
      *              *-------------------------------------------------*
      *              * Tipo di cambio : '/' o '*'                      *
      *              *-------------------------------------------------*
           move      "*"                  to   rf-sfp-tdc-vlt         .
      *              *-------------------------------------------------*
      *              * Coefficiente di cambio per la valuta pagamento  *
      *              *-------------------------------------------------*
           move      1                    to   rf-sfp-cdc-pgf         .
      *              *-------------------------------------------------*
      *              * Importo pagamento in valuta, forzato uguale a   *
      *              * importo in valuta base                          *
      *              *-------------------------------------------------*
           move      rf-sfp-imp-pgf       to   rf-sfp-iiv-pgf         .
       prn-liv-det-250.
      *              *-------------------------------------------------*
      *              * Update record [sfp]                             *
      *              *-------------------------------------------------*
