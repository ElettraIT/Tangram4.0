      ...
      *                       Ultima revisione:    NdK del 07/12/01    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "CONVERSIONI PER EURO - Foralberg - Brek "       .
...
______*      "[hwx]      File di controllo transazioni               ".
      ...
      *              *-------------------------------------------------*
           if        lst-cod-cli          not  = 0006003
                     go to exe-cnv-lst-250.
           if        lst-sgl-vlt          not  = "LIT"
                     go to exe-cnv-lst-250.
       exe-cnv-lst-350.
      *              *-------------------------------------------------*
      ...
      *                  * Prezzo                                      *
      *                  *---------------------------------------------*
           move      lst-prz-lst          to   w-cal-imp-eur-imi      .
           move      zero                 to   w-cal-imp-eur-dec      .
           perform   cal-imp-eur-000      thru cal-imp-eur-999        .
           move      w-cal-imp-eur-ime    to   rf-lst-prz-lst         .
       exe-cnv-lst-700.
      *              *-------------------------------------------------*
      *              * Scrittura [new]                                 *
      *              *-------------------------------------------------*
