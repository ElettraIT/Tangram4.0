      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma eurorf11:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-stp-rie.
               10  w-exp-stp-rie-num      pic  9(02)       value 02   .
               10  w-exp-stp-rie-lun      pic  9(02)       value 02   .
               10  w-exp-stp-rie-tbl.
      ...
      *                  * Riepilogo                                   *
      *                  *---------------------------------------------*
           perform   acc-stp-rie-000      thru acc-stp-rie-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
                     go to acc-ric-sel-500.
      ...
      *              * Prompt riepilogo                                *
      *              *-------------------------------------------------*
           perform   pmt-stp-rie-000      thru pmt-stp-rie-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione riepilogo                       *
      *              *-------------------------------------------------*
           perform   vis-stp-rie-000      thru vis-stp-rie-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       pmt-stp-rie-000.
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Stampa riepiloghi mensili  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-stp-rie-999.
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Riepilogo                  *
      *    *-----------------------------------------------------------*
       acc-stp-rie-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-stp-rie-lun    to   v-car                  .
           move      w-exp-stp-rie-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-stp-rie-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      20                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      rr-stp-rie           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-stp-rie-999.
       acc-stp-rie-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-stp-rie             .
       acc-stp-rie-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        rr-stp-rie           not  = zero
                     go to acc-stp-rie-600.
           if        v-key                =    "UP  "
                     go to acc-stp-rie-600.
           go to     acc-stp-rie-100.
       acc-stp-rie-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Normalizzazione riepilogo                       *
      *              *-------------------------------------------------*
           if        rr-stp-rie           =    zero
                     move  01             to   rr-stp-rie             .
       reg-ric-sel-999.
           exit.
