      ...
      *                       Ultima revisione:    NdK del 26/11/01    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Update tipo valuta pagamenti fornitori      *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Trattamento tipo valuta                         *
      *              *-------------------------------------------------*
           if        rf-sfp-mod-pgf       not  = 13
                     move  01             to   rf-sfp-tvl-pgf
                     go to prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Determinazione se fornitore estero              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODFNT    "         to   f-key                  .
           move      rf-sfp-cod-fnt       to   rf-dcf-cod-fnt         .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-180.
      *              *-------------------------------------------------*
      *              * Tipo validita' : estero                         *
      *              *-------------------------------------------------*
           move      02                   to   rf-sfp-tvl-pgf         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Trattamento importo                             *
      *              *-------------------------------------------------*
           ...
           multiply  1936,27              by   rf-sfp-imp-pgf
                                        giving rf-sfp-iiv-pgf
                                       rounded                        .
           divide    100                  into rf-sfp-iiv-pgf         .
       prn-liv-det-250.
      *              *-------------------------------------------------*
      *              * Update record [sfp]                             *
      *              *-------------------------------------------------*
