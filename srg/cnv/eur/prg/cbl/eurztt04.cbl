      ...
      *                       Ultima revisione:    NdK del 02/08/01    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      *                    Ri-assestamento bolle                       *
      *                                                                *
      * {BOL}   [bit] v  Bolle di uscita, testate (incassato)          *
      *                                                                *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      ...
      *              *-------------------------------------------------*
       ...
       exe-cnv-fil-200.
      *              *-------------------------------------------------*
      *              * Assestamento bolle di vendita (incassato)       *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "testate bolle"      to   f-xxx-des              .
      *              *-------------------------------------------------*
      *              * Richiesta di conferma, se manuale               *
      *              *-------------------------------------------------*
           perform   ric-cnf-man-000      thru ric-cnf-man-999        .
      ...
      *                  *---------------------------------------------*
      *                  * Selezione su data movimento                 *
      *                  *---------------------------------------------*
           if        rf-bit-dat-doc       >    1011231
                     go to exe-ass-bol-buf-200.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-wrk-ctr-004          .
           if        w-wrk-ctr-004        >    1011231
                     go to exe-ass-bol-buf-200.
      *                  *---------------------------------------------*
      *                  * Selezione su incasso                        *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      08                   to   v-car                  .
           move      rf-bit-alx-exp
      ...
      *              * Totale incassato                                *
      *              *-------------------------------------------------*
           move      v-num                to   w-cal-imp-eur-imi      .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-cal-imp-eur-ime    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
