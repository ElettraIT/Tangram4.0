      ...
      *                       Ultima revisione:    NdK del 11/07/01    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Conversione in Euro listino '2' in listino  *
      *                    di comodo 'EU2' - ZATTI                     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "CONVERSIONE IN EURO LISTINO '2' - ZATTI "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione % di incremento                    *
      *        *-------------------------------------------------------*
           05  w-det-inc-prz.
      *            *---------------------------------------------------*
      *            * Comodi                                            *
      *            *---------------------------------------------------*
               10  w-det-inc-prz-c01      pic s9(13)v9(05)            .
      ...
      *              *-------------------------------------------------*
      ...
      -              "no di lavoro 'EU2' prendendo  "
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "                 i prezzi contenuti nel listino '2
      -              "'.                            "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  * Tipo record                                 *
      *                  *---------------------------------------------*
           if        rf-lst-tip-rec       not  = 01
                     go to stp-srt-inp-999.
      *                  *---------------------------------------------*
      *                  * Codice listino                              *
      *                  *---------------------------------------------*
           if        rf-lst-cod-lst       not  = "2  "
                     go to stp-srt-inp-999.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun listino da convertire !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Incremento prezzo 11 %                  *
      *                      *-----------------------------------------*
           move      zero                 to   w-det-inc-prz-c01      .
           multiply  11                   by   srt-prz-lst
                                        giving w-det-inc-prz-c01      .
           divide    100                  into w-det-inc-prz-c01
                                       rounded                        .
           add       w-det-inc-prz-c01    to   srt-prz-lst            .
      *                      *-----------------------------------------*
      *                      * Raddoppio prezzo                        *
      *                      *-----------------------------------------*
           add       srt-prz-lst          to   srt-prz-lst            .
      *                      *-----------------------------------------*
      *                      * Conversione prezzo                      *
      *                      *-----------------------------------------*
           move      srt-prz-lst          to   w-cal-imp-eur-imi      .
