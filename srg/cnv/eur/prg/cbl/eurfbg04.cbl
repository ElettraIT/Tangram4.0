      ...
      *                       Ultima revisione:    NdK del 04/02/02    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  kk1-key.
               10  kk1-tip-mag            pic  9(02)                  .
               10  kk1-num-pro            pic  9(07)                  .
               10  kk1-cod-dcf            pic  9(07)                  .
               10  kk1-fda-pif            pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  kk1-dat.
...
______*      "[hwx]      File di controllo transazioni               ".
      ...
      *              * Assestamento [haf]                              *
      *              *-------------------------------------------------*
           perform   exe-ass-haf-000      thru exe-ass-haf-999        .
       exe-cnv-fil-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-ass-haf-150.
      *              *-------------------------------------------------*
      *              * Subroutine di bufferizzazione preliminare       *
      *              *-------------------------------------------------*
           perform   exe-ass-haf-buf-000  thru exe-ass-haf-buf-999    .
       exe-ass-haf-180.
      *              *-------------------------------------------------*
      *              * Start su file [kk1]                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   kk1-tip-mag            .
           move      zero                 to   kk1-num-pro            .
           move      zero                 to   kk1-cod-dcf            .
           move      spaces               to   kk1-fda-pif            .
      *                  *---------------------------------------------*
      *                  * Operazione di Start                         *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-ass-haf-300.
      *              *-------------------------------------------------*
      *              * Assestamento vero e proprio                     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Subroutine                                  *
      *                  *---------------------------------------------*
           perform   exe-ass-haf-rec-000  thru exe-ass-haf-rec-999    .
      *                  *---------------------------------------------*
      *                  * A riciclo                                   *
      *                  *---------------------------------------------*
           go to     exe-ass-haf-700.
       exe-ass-haf-700.
      *              *-------------------------------------------------*
      *              * Riciclo a Next su [kk1]                         *
      *              *-------------------------------------------------*
           go to     exe-ass-haf-200.
       exe-ass-haf-800.
      *              *-------------------------------------------------*
      *              * [kk1]                                           *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-haf-sgl-vlt       not  = "LIT" and
                     rf-haf-sgl-vlt       not  = "DEM" and
                     rf-haf-sgl-vlt       not  = "FRF"
                     go to exe-ass-haf-buf-200.
       exe-ass-haf-buf-600.
      *              *-------------------------------------------------*
      *              * Bufferizzazione                                 *
      *              *-------------------------------------------------*
      ...
      *                  * Testata ordine                              *
      *                  *---------------------------------------------*
           move      rf-haf-tip-mag       to   kk1-tip-mag            .
           move      rf-haf-num-pro       to   kk1-num-pro            .
           move      rf-haf-cod-dcf       to   kk1-cod-dcf            .
           move      rf-haf-fda-pif       to   kk1-fda-pif            .
      *                  *---------------------------------------------*
      *                  * Scrittura                                   *
      *                  *---------------------------------------------*
           write     kk1-rec                                          .
      ...
      *    * Assestamento [haf]                                        *
      *    *                                                           *
      *    * Subroutine di conversione record                          *
      *    *-----------------------------------------------------------*
       exe-ass-haf-rec-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "PRFNFM    "         to   f-key                  .
           move      kk1-tip-mag          to   rf-haf-tip-mag         .
           move      kk1-num-pro          to   rf-haf-num-pro         .
           move      kk1-cod-dcf          to   rf-haf-cod-dcf         .
           move      kk1-fda-pif          to   rf-haf-fda-pif         .
           move      "fbg/gpf/fls/ioc/obj/iofhaf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        rf-haf-sgl-vlt       =    "LIT"
                     go to exe-ass-haf-rec-420
           else if   rf-haf-sgl-vlt       =    "FRF"
                     go to exe-ass-haf-rec-430
           else if   rf-haf-sgl-vlt       =    "DEM"
                     go to exe-ass-haf-rec-440
           else      go to exe-ass-haf-rec-450.
       exe-ass-haf-rec-420.
      *                  *---------------------------------------------*
      *                  * Se Lire                                     *
      *                  *---------------------------------------------*
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           perform   exe-ass-haf-lit-000  thru exe-ass-haf-lit-999    .
      *                      *-----------------------------------------*
      *                      * A fasi comuni                           *
      *                      *-----------------------------------------*
           go to     exe-ass-haf-rec-700.
       exe-ass-haf-rec-430.
      *                  *---------------------------------------------*
      *                  * Se Franchi francesi                         *
      *                  *---------------------------------------------*
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           perform   exe-ass-haf-frf-000  thru exe-ass-haf-frf-999    .
      *                      *-----------------------------------------*
      *                      * A fasi comuni                           *
      *                      *-----------------------------------------*
           go to     exe-ass-haf-rec-700.
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           perform   exe-ass-haf-dem-000  thru exe-ass-haf-dem-999    .
      *                      *-----------------------------------------*
      *                      * A fasi comuni                           *
      *                      *-----------------------------------------*
           go to     exe-ass-haf-rec-700.
      ...
      *    * Subroutine di conversione record                          *
      *    *                                                           *
      *    * Subroutine di conversione record in Lire                  *
      *    *-----------------------------------------------------------*
       exe-ass-haf-lit-000.
      *              *-------------------------------------------------*
      *              * Valuta                                          *
      *              *-------------------------------------------------*
           ...
           move      000001,00000         to   rf-haf-cdc-vlt         .
      *              *-------------------------------------------------*
      *              * Costo lordo                                     *
      *              *-------------------------------------------------*
           move      rf-haf-prz-pes       to   w-cal-imp-eur-imi      .
           move      zero                 to   w-cal-imp-eur-dec      .
           perform   cal-imp-eur-000      thru cal-imp-eur-999        .
           move      w-cal-imp-eur-ime    to   rf-haf-prz-pes         .
      *              *-------------------------------------------------*
      *              * Costo netto                                     *
      *              *-------------------------------------------------*
           move      rf-haf-pzn-vlt       to   w-cal-imp-eur-imi      .
           move      zero                 to   w-cal-imp-eur-dec      .
           perform   cal-imp-eur-000      thru cal-imp-eur-999        .
           move      w-cal-imp-eur-ime    to   rf-haf-pzn-vlt         .
      *              *-------------------------------------------------*
      *              * Data riferimento cambio                         *
      *              *-------------------------------------------------*
      ...
      *    * Subroutine di conversione record                          *
      *    *                                                           *
      *    * Subroutine di conversione record in Franchi Francesi      *
      *    *-----------------------------------------------------------*
       exe-ass-haf-frf-000.
      *              *-------------------------------------------------*
      *              * Valuta                                          *
      ...
      *              * Costo lordo                                     *
      *              *-------------------------------------------------*
           if        rf-haf-prz-pes       not  = zero
                     divide  w-cdc        into rf-haf-prz-pes         .
      *              *-------------------------------------------------*
      *              * Costo netto                                     *
      *              *-------------------------------------------------*
           if        rf-haf-pzn-vlt       not  = zero
                     divide  w-cdc        into rf-haf-pzn-vlt         .
      *              *-------------------------------------------------*
      *              * Data riferimento cambio                         *
      *              *-------------------------------------------------*
           move      0990101              to   rf-haf-drf-vlt         .
      ...
      *    * Subroutine di conversione record                          *
      *    *                                                           *
      *    * Subroutine di conversione record in Marchi Tedeschi       *
      *    *-----------------------------------------------------------*
       exe-ass-haf-dem-000.
      *              *-------------------------------------------------*
      *              * Valuta                                          *
