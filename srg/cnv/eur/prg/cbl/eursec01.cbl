      ...
      *                       Ultima revisione:    NdK del 11/05/01    *
      *                    ------------------------------------------- *
      ...
      *                    Copia archivi                               *
      *                                                                *
      * {tns}   [hab]      Bolle di consegna di tipo 'AB'              *
      * {tns}   [had]      Tabella    CLASSI DI TRASPORTO ADR          *
      * {tns}   [hap]      Anagrafica PARTITE                          *
      * {tns}   [hau]      Anagrafica AUTORIZZAZIONI                   *
      * {tns}   [haz]      Anagrafica AZIENDA                          *
      * {tns}   [hbc]      Movimenti  NOTE DI CONSEGNA                 *
      * {tns}   [hce]      Codici CEE dei rifiuti                      *
      * {tns}   [hcf]      Anagrafica CONFERITORI                      *
      * {tns}   [hcl]      Tabella classificazioni del rifiuto         *
      * {tns}   [hcp]      Tabella classi di pericolosita'             *
      * {tns}   [hdd]      Anagrafica DESTINATARI DIVERSI              *
      * {tns}   [hdl]      Tabella    DISLOCAZIONI                     *
      * {tns}   [hdr]      Tabella classi di trasporto ADR             *
      * {tns}   [hfm]      Movimenti  FORMULARIO DI IDENTIFICAZIONE    *
      * {tns}   [hgx]      Tabella codici ISTAT comuni                 *
      * {tns}   [him]      Anagrafica INTERMEDIARI                     *
      * {tns}   [his]      Tabella    CODICE ISTAT                     *
      * {tns}   [hmg]      Anagrafica CODICI MAGAZZINO                 *
      * {tns}   [hml]      Tabella tipi voci di magazzino              *
      * {tns}   [hmm]      Movimenti  di MAGAZZINO                     *
      * {tns}   [hmr]      Movimenti  di MAGAZZINO : righe             *
      * {tns}   [hni]      Nuovi codici di ISTAT dei processi          *
      * {tns}   [hnu]      Gestione   NUMERAZIONI                      *
      * {tns}   [hpd]      Anagrafica PRODUTTORI                       *
      * {tns}   [hpx]      Dati anagrafici partita : estensione        *
      * {tns}   [hrc]      Anagrafica CLASSI RIFIUTI                   *
      * {tns}   [hrg]      Movimenti  REGISTRO                         *
      * {tns}   [hrr]      Movimenti  REGISTRO : righe                 *
      * {tns}   [hrs]      Anagrafica SOTTOCLASSI RIFIUTI              *
      * {tns}   [hrt]      Anagrafica TIPOLOGIE RIFIUTI                *
      * {tns}   [hru]      Movimenti  REGISTRO Commerciale             *
      * {tns}   [hrv]      Movimenti  REGISTRO Commerciale : righe     *
      * {tns}   [hsd]      Anagrafica STABILIMENTI DESTINATARI         *
      * {tns}   [hse]      Tabella    TIPI SERVIZI                     *
      * {tns}   [hsm]      Anagrafica SMALTITORI                       *
      * {tns}   [hsp]      Anagrafica STABILIMENTI PRODUTTORI          *
      * {tns}   [hss]      Anagrafica STABILIMENTI SMALTITORI          *
      * {tns}   [hti]      Tabella    TIPI IMBALLO                     *
      * {tns}   [htm]      Tabella    TIPI MOVIMENTO                   *
      * {tns}   [htp]      Anagrafica TRASPORTATORI                    *
      * {tns}   [htx]      Estensioni generiche                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      *                    Conversione                                 *
      *                                                                *
      * {tns}   [hoc]      Ordini di conferimento                      *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
           select  optional  hoc   assign to disk           f-hoc-pat
                   ...
                   alternate record key   is hoc-k04
                   alternate record key   is hoc-k05
                   alternate record key   is hoc-k06
                   alternate record key   is hoc-k07
      ...
      *        *-------------------------------------------------------*
           05  hoc-key.
      *            *---------------------------------------------------*
      *            * Chiave numero 01 : NUMCNF                         *
      *            *---------------------------------------------------*
               10  hoc-k01.
                   15  hoc-num-cnf        pic  9(09)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 02 : DATREG                         *
      *            *---------------------------------------------------*
               10  hoc-k02.
                   15  hoc-dat-reg        pic  9(07)       comp-3     .
                   15  hoc-num-cnf-2      pic  9(09)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 03 : CONCNF                         *
      *            *---------------------------------------------------*
               10  hoc-k03.
                   15  hoc-cod-cnf        pic  9(07)       comp-3     .
                   15  hoc-dat-reg-3      pic  9(07)       comp-3     .
                   15  hoc-num-cnf-3      pic  9(09)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 04 : PROCNF                         *
      *            *---------------------------------------------------*
               10  hoc-k04.
                   15  hoc-cod-pdt        pic  9(07)       comp-3     .
                   15  hoc-dat-reg-4      pic  9(07)       comp-3     .
                   15  hoc-num-cnf-4      pic  9(09)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 05 : CONPRO                         *
      *            *---------------------------------------------------*
               10  hoc-k05.
                   15  hoc-cod-cnf-5      pic  9(07)       comp-3     .
                   15  hoc-cod-pdt-5      pic  9(07)       comp-3     .
                   15  hoc-dat-reg-5      pic  9(07)       comp-3     .
                   15  hoc-num-cnf-5      pic  9(09)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 06 : DATSYS                         *
      *            *---------------------------------------------------*
               10  hoc-k06.
                   15  hoc-ide-dat        pic  9(07)       comp-3     .
                   15  hoc-dat-reg-6      pic  9(07)       comp-3     .
                   15  hoc-num-cnf-6      pic  9(09)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 07 : MAGCNF                         *
      *            *---------------------------------------------------*
               10  hoc-k07.
                   15  hoc-cod-mag        pic  x(14)                  .
                   15  hoc-num-cnf-7      pic  9(09)       comp-3     .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  hoc-dat.
               10  hoc-ide-ute            pic  x(08)                  .
               10  hoc-ide-fas            pic  x(06)                  .
               10  hoc-cst-int occurs 03.
                   15  hoc-cod-int        pic  9(07)       comp-3     .
               10  hoc-dat-ulf            pic  9(07)       comp-3     .
               10  hoc-dat-lb1            pic  9(07)       comp-3     .
               10  hoc-dat-lb2            pic  9(07)       comp-3     .
               10  hoc-nom-acc            pic  x(30)                  .
               10  hoc-sts-cnf            pic  9(02)                  .
               10  hoc-not-cnf.
                   15  hoc-ntr-cnf occurs 3
                                          pic  x(40)                  .
               10  hoc-cct-rif            pic  x(05)                  .
               10  hoc-pes-rif            pic s9(10)v9(03) comp-3     .
               10  hoc-vol-rif            pic s9(10)v9(03) comp-3     .
               10  hoc-cod-imb            pic  9(02)                  .
               10  hoc-cod-mod            pic  9(02)                  .
               10  hoc-tip-mod            pic  x(30)                  .
               10  hoc-cst-dat occurs 10.
                   15  hoc-cst-dcf        pic  9(07)       comp-3     .
               10  hoc-cst-tsr.
                   15  hoc-ele-tsr occurs 12.
                       20  hoc-cod-tsr    pic  x(03)                  .
                       20  hoc-prz-tsr    pic  9(11)       comp-3     .
                       20  hoc-com-tsr    pic  x(35)                  .
                       20  hoc-add-tsr    pic  x(01)                  .
                       20  hoc-alx-tsr    pic  x(04)                  .
               10  hoc-flg-ela.
                   15  hoc-flg-blo.
               ...
               10  hoc-cod-cli            pic  9(07)                  .
               10  hoc-dpz-cli            pic  x(04)                  .
               10  hoc-cod-cee            pic  x(14)                  .
               10  hoc-cnf-pdt            pic  x(01)                  .
               10  hoc-alx-exp.
                   15  filler  occurs 04  pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           move      "sec/tns/fls/ioc/obj/iofhoc"
                                          to   f-xxx-obj              .
      *              *-------------------------------------------------*
      *              * Richiesta di conferma, se manuale               *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      hoc-ide-dat          to   rf-hoc-ide-dat         .
           move      hoc-ide-ute          to   rf-hoc-ide-ute         .
           move      hoc-ide-fas          to   rf-hoc-ide-fas         .
           move      hoc-num-cnf          to   rf-hoc-num-cnf         .
           move      hoc-dat-reg          to   rf-hoc-dat-reg         .
           move      hoc-cod-cnf          to   rf-hoc-cod-cnf         .
           move      hoc-cod-pdt          to   rf-hoc-cod-pdt         .
       exe-cnv-hoc-410.
           move      zero                 to   w-inx                  .
       exe-cnv-hoc-420.
           add       1                    to   w-inx                  .
           if        w-inx                >    03
                     go to exe-cnv-hoc-430.
           move      hoc-cod-int (w-inx)  to   rf-hoc-cod-int (w-inx) .
           go to     exe-cnv-hoc-420.
       exe-cnv-hoc-430.
           move      hoc-dat-ulf          to   rf-hoc-dat-ulf         .
           move      hoc-dat-lb1          to   rf-hoc-dat-lb1         .
           move      hoc-dat-lb2          to   rf-hoc-dat-lb2         .
           move      hoc-nom-acc          to   rf-hoc-nom-acc         .
           move      hoc-sts-cnf          to   rf-hoc-sts-cnf         .
           move      hoc-not-cnf          to   rf-hoc-not-cnf         .
           move      hoc-cod-mag          to   rf-hoc-cod-mag         .
           move      hoc-cct-rif          to   rf-hoc-cct-rif         .
           move      hoc-pes-rif          to   rf-hoc-pes-rif         .
           move      hoc-vol-rif          to   rf-hoc-vol-rif         .
           move      hoc-cod-imb          to   rf-hoc-cod-imb         .
           move      hoc-cod-mod          to   rf-hoc-cod-mod         .
           move      hoc-tip-mod          to   rf-hoc-tip-mod         .
       exe-cnv-hoc-440.
           move      zero                 to   w-inx                  .
       exe-cnv-hoc-450.
           add       1                    to   w-inx                  .
           if        w-inx                >    10
                     go to exe-cnv-hoc-460.
           move      hoc-cst-dcf (w-inx)  to   rf-hoc-cst-dcf (w-inx) .
           go to     exe-cnv-hoc-450.
       exe-cnv-hoc-460.
           move      zero                 to   w-inx                  .
       exe-cnv-hoc-470.
           add       1                    to   w-inx                  .
           if        w-inx                >    12
                     go to exe-cnv-hoc-480.
           move      hoc-cod-tsr (w-inx)  to   rf-hoc-cod-tsr (w-inx) .
           move      hoc-prz-tsr (w-inx)  to   rf-hoc-prz-tsr (w-inx) .
           move      hoc-com-tsr (w-inx)  to   rf-hoc-com-tsr (w-inx) .
           move      hoc-add-tsr (w-inx)  to   rf-hoc-add-tsr (w-inx) .
           move      hoc-alx-tsr (w-inx)  to   rf-hoc-alx-tsr (w-inx) .
           go to     exe-cnv-hoc-470.
       exe-cnv-hoc-480.
           move      hoc-flg-ela          to   rf-hoc-flg-ela         .
           move      hoc-flg-pul          to   rf-hoc-flg-pul         .
           move      hoc-cod-cli          to   rf-hoc-cod-cli         .
           move      hoc-dpz-cli          to   rf-hoc-dpz-cli         .
           move      hoc-cod-cee          to   rf-hoc-cod-cee         .
           move      hoc-cnf-pdt          to   rf-hoc-cnf-pdt         .
           move      hoc-alx-exp          to   rf-hoc-alx-exp         .
       exe-cnv-hoc-500.
      *              *-------------------------------------------------*
      *              * Conversioni                                     *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       exe-cnv-hoc-520.
           add       1                    to   w-inx                  .
           if        w-inx                >    12
                     go to exe-cnv-hoc-700.
      *                  *---------------------------------------------*
      *                  * Totale mensile                              *
      *                  *---------------------------------------------*
           move      hoc-prz-tsr (w-inx)  to   w-cal-imp-eur-imi      .
           move      zero                 to   w-cal-imp-eur-dec      .
           perform   cal-imp-eur-000      thru cal-imp-eur-999        .
           move      w-cal-imp-eur-ime    to   rf-hoc-prz-tsr (w-inx) .
      *
           if        w-cal-imp-eur-flg    not  = spaces
                     perform exe-cnv-hoc-msg-000
                                          thru exe-cnv-hoc-msg-999    .
      *                  *---------------------------------------------*
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
           go to     exe-cnv-hoc-520.
       exe-cnv-hoc-700.
      *              *-------------------------------------------------*
      *              * Scrittura [new]                                 *
      *              *-------------------------------------------------*
