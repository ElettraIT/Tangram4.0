      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Update documenti XML caricati per protocol- *
      *                    lo fattura fornitori (Entro 2021)           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento protocollo fatt. fornitore"       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Determinazione protocollo SCF                         *
      *        *-------------------------------------------------------*
           05  w-det-prt-scf-ddo          pic  9(07)                  .
           05  w-det-prt-scf-fnt          pic  9(07)                  .
           05  w-det-prt-scf-tot          pic s9(11)                  .
           05  w-det-prt-scf-prt          pic  9(11)                  .
           05  w-det-prt-scf-reg          pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
      *              * Determinazione eventuale protocollo             *
      *              *-------------------------------------------------*
           move      rf-xft-ddo-ftf       to   w-det-prt-scf-ddo      .
           move      rf-xft-cod-fnt       to   w-det-prt-scf-fnt      .
           move      rf-xft-tot-ftf       to   w-det-prt-scf-tot      .
           perform   det-prt-scf-000      thru det-prt-scf-999        .
           if        w-det-prt-scf-prt    =    zero
                     go to prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Aggiornamento protocollo e data registrazione   *
      *              *-------------------------------------------------*
           move      w-det-prt-scf-reg    to   rf-xft-dat-csg         .
           move      w-det-prt-scf-prt    to   rf-xft-num-ftf         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [xft]                             *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Determinazione protocollo registrazione SCF documento     *
      *    *-----------------------------------------------------------*
       det-prt-scf-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione valori di uscita                *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-prt-scf-prt      .
      *              *-------------------------------------------------*
      *              * Test preliminari                                *
      *              *-------------------------------------------------*
           if        w-det-prt-scf-ddo    =    zero
                     go to det-prt-scf-900.
           if        w-det-prt-scf-fnt    =    zero
                     go to det-prt-scf-900.
       det-prt-scf-100.
      *              *-------------------------------------------------*
      *              * Start su file [sff]                             *
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-det-prt-scf-ddo    to   rf-sff-ddo-ftf         .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale su file [sff]               *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/scf/fls/ioc/obj/iofsff"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su data documento del fornitore        *
      *                  *---------------------------------------------*
           if        rf-sff-ddo-ftf       not  = w-det-prt-scf-ddo
                     go to det-prt-scf-900.
       det-prt-scf-400.
      *              *-------------------------------------------------*
      *              * Selezioni su [sff]                              *
      ...
      *                  *---------------------------------------------*
           if        rf-sff-cod-fnt       not  = w-det-prt-scf-fnt
                     go to det-prt-scf-200.
      *                  *---------------------------------------------*
      *                  * Test su importo fattura                     *
      *                  *---------------------------------------------*
           if        rf-sff-imp-ftf       not  = w-det-prt-scf-tot
                     go to det-prt-scf-200.
       det-prt-scf-600.
      *              *-------------------------------------------------*
      *              * Protocollo determinato                          *
      *              *-------------------------------------------------*
           move      rf-sff-num-ftf       to   w-det-prt-scf-prt      .
      *              *-------------------------------------------------*
      *              * Data registrazione determinata                  *
      *              *-------------------------------------------------*
           move      rf-sff-dtr-ftf       to   w-det-prt-scf-reg      .
       det-prt-scf-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     det-prt-scf-999.
       det-prt-scf-999.
           exit.
