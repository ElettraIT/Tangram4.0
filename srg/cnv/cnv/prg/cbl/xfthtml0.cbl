      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Generazione distinte 'html' da 'xft'        *
      *                                                                *
      *                    STANDARD                                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Creazione distinte 'html' da 'xft'   "       .
      ...
      *
      ...
      -              "ue='"     delimited by   size
       ...
       emi-htm-dst-opl-500.
      *              *-------------------------------------------------*
      *              * Titolo attualmente inibito                      *
      *              *-------------------------------------------------*
           go to     emi-htm-dst-opl-550.
      *              *-------------------------------------------------*
      *              * Editing data distinta                           *
      *              *-------------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "D"                  to   p-tip                  .
           move      w-rot-l01-dat-car    to   p-dat                  .
      *
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   f-xxx-ann              .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   j-rec                  .
      *
           string    "<center><h1>Documenti caricati " 
                                delimited by   size
                     p-edt      delimited by   spaces
                     "</h1></center>"
                                delimited by   size
