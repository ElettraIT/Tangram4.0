      ...
      *                                   Fase:    eleffr              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 04/08/23    *
      *                       Ultima revisione:    NdK del 04/08/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Scansione file [ffr]                        *
      *                                                                *
      *                    Per sistemazione riferimenti bolle - ABB    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Sistemazione legami con bolle - ABB  "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per editing protocollo                                *
      *        *-------------------------------------------------------*
           05  w-det-edt-prt.
               10  w-det-edt-prt-prt      pic  9(11)                  .
               10  w-det-edt-prt-prt-r    redefines
                   w-det-edt-prt-prt                                  .
                   15  w-det-edt-prt-saa  pic  9(03)                  .
                   15  w-det-edt-prt-dpz  pic  9(02)                  .
                   15  w-det-edt-prt-prx  pic  9(06)                  .
      *        *-------------------------------------------------------*
      *        * Per determinazione se bolla fatturata                 *
      *        *-------------------------------------------------------*
           05  w-det-bol-fat.
      *            *---------------------------------------------------*
      *            * Flag di esito                                     *
      *            *---------------------------------------------------*
               10  w-det-bol-fat-flg      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Per determinazione progressivo corretto               *
      *        *-------------------------------------------------------*
           05  w-det-num-prg.
      *            *---------------------------------------------------*
      *            * Flag di esito                                     *
      *            *---------------------------------------------------*
               10  w-det-num-prg-new      pic  9(05)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Work per Vis : Numero protocollo completo             *
      *        *-------------------------------------------------------*
           05  w-vis-cmp-prt.
               10  w-vis-cmp-prt-num      pic  9(11)                  .
               10  w-vis-cmp-prt-num-r    redefines
                   w-vis-cmp-prt-num.
                   15  w-vis-cmp-prt-saa  pic  9(03)                  .
                   15  w-vis-cmp-prt-dpz  pic  9(02)                  .
                   15  w-vis-cmp-prt-prg  pic  9(06)                  .
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-ffr-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [ffr]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "NUMPRT    "         to   f-key                  .
           move      12300000000          to   rf-ffr-num-prt         .
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-ffr-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [ffr]                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su codice fornitore                    *
      *                  *---------------------------------------------*
           if        rf-ffr-cod-arc       not  = 0003239
                     go to stp-srt-inp-ffr-200.
      *                  *---------------------------------------------*
      *                  * Test su protocollo BFO                      *
      *                  *---------------------------------------------*
______*    if        rf-ffr-bfo-prt       not  = zero
______*              go to stp-srt-inp-ffr-200.
       stp-srt-inp-ffr-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione progressivo corretto            *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-num-prg-new      .
       prn-ini-lr1-999.
           exit.
      ...
      *              * Recupero record [ffr]                           *
      *              *-------------------------------------------------*
           move      srt-rec-ffr          to   rf-ffr                 .
      *              *-------------------------------------------------*
      *              * Aggiornamento progressivo corretto              *
      *              *-------------------------------------------------*
           add       100                  to   w-det-num-prg-new      .
       prn-liv-det-050.
      *              *-------------------------------------------------*
      *              * Test su progressivo                             *
      *              *-------------------------------------------------*
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rf-ffr-bfo-prg       =    w-det-num-prg-new
      ...
      *                      *-----------------------------------------*
           ...
           move      001                  to   p-pos                  .
      *
           move      srt-num-prt          to   w-det-edt-prt-prt      .
           move      w-det-edt-prt-saa    to   w-vis-num-prt-saa      .
           move      w-det-edt-prt-prx    to   w-vis-num-prt-prg      .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      011                  to   p-pos                  .
           move      rf-ffr-dat-reg       to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Progressivo riga FFO                    *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      05                   to   p-car                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      033                  to   p-pos                  .
      *
           move      rf-ffr-bfo-prt       to   w-det-edt-prt-prt      .
           move      w-det-edt-prt-saa    to   w-vis-num-prt-saa      .
           move      w-det-edt-prt-prx    to   w-vis-num-prt-prg      .
           move      w-vis-num-prt-num    to   p-num                  .
      *
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      058                  to   p-pos                  .
           move      rf-ffr-bfo-ddo       to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Numero documento BFO                    *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      10                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      067                  to   p-pos                  .
           move      rf-ffr-bfo-ndo       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Aggiornamento riga fattura                      *
      *              *-------------------------------------------------*
           move      w-det-num-prg-new    to   rf-ffr-bfo-prg         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [ffr]                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Righe fatture fornitori [ffr] - ABB"
      ...
      *    *===========================================================*
      *    * Determinazione se bolla fatturata                         *
      *    *-----------------------------------------------------------*
       det-bol-fat-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di uscita                  *
      *              *-------------------------------------------------*
           move      spaces               to   w-det-bol-fat-flg      .
       det-bol-fat-050.
      *              *-------------------------------------------------*
      *              * Lettura record [bfr]                            *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      rf-ffr-bfo-prt       to   rf-bfr-num-prt         .
           move      rf-ffr-bfo-prg       to   rf-bfr-num-prg         .
           move      "pgm/bfo/fls/ioc/obj/iofbfr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     move "?"             to   w-det-bol-fat-flg
                     go to det-bol-fat-900.
       det-bol-fat-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [ffr] per codice alfanumerico *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
