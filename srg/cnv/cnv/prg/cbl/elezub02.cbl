      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento files [zub] : ELETTRA         *
      *                                                                *
      *                    Prefisso 'L' per magazzino di Via Lisbona   *
      *                                                                *
      *                    N.B.: DA ABBINARE A 'elemau02' !!!          *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  srt-dat.
               10  srt-des-ubi            pic  x(30)                  .
               10  srt-des-key            pic  x(30)                  .
               10  srt-inx-per            pic  9(07)                  .
               10  srt-com-ubi            pic  x(40)                  .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale record [zub]                *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/mag/fls/ioc/obj/iofzub"
                                          to   s-pat                  .
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      rf-zub-cod-dpz       to   srt-cod-dpz            .
           move      rf-zub-cod-ubi       to   srt-cod-ubi            .
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      rf-zub-des-ubi       to   srt-des-ubi            .
           move      rf-zub-des-key       to   srt-des-key            .
           move      rf-zub-inx-per       to   srt-inx-per            .
           move      rf-zub-com-ubi       to   srt-com-ubi            .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-800.
      *              *-------------------------------------------------*
      *              * Riciclo su lettura sequenziale record [zub]     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Delete record [zub] precedente                  *
      *              *-------------------------------------------------*
           perform   del-rec-zub-000      thru del-rec-zub-999        .
      *              *-------------------------------------------------*
      *              * Write record [zub] nuovo                        *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Composizione record [zub] precedente                      *
      *    *-----------------------------------------------------------*
       cmp-old-zub-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-cod-ubi          to   rf-zub-cod-ubi         .
       cmp-old-zub-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zub] attuale                         *
      *    *-----------------------------------------------------------*
       cmp-new-zub-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione record                          *
      ...
      *
           ...
           move      srt-cod-ubi          to   w-wrk-ubi-new
                                              (02 : 06)               .
           move      w-wrk-ubi-new        to   rf-zub-cod-ubi         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-wrk-ubi-new        to   rf-zub-des-ubi         .
           move      w-wrk-ubi-new        to   rf-zub-des-key         .
           move      srt-inx-per          to   rf-zub-inx-per         .
           move      srt-com-ubi          to   rf-zub-com-ubi         .
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-old-zub-000      thru cmp-old-zub-999        .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-new-zub-000      thru cmp-new-zub-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
