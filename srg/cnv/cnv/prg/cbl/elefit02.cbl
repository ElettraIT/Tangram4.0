      ...
      *                                   Fase:    elefit              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 31/08/23    *
      *                       Ultima revisione:    NdK del 03/06/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [fit] : Elettra          *
      *                                                                *
      *                    Sistemazione codice intermediario           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Aggiornamento Codice intermediario   "       .
      ...
      *        *-------------------------------------------------------*
      *        * Flags di controllo su status impfitazioni             *
      *        *-------------------------------------------------------*
           05  w-cnt-sts-imp.
      *            *---------------------------------------------------*
      *            * Impfitazione richieste                            *
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Normalizzazione status impfitazione             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione func-key di impfitazione    *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-900.
      *              *-------------------------------------------------*
      *              * Flag di controllo status impfitazioni           *
      *              *-------------------------------------------------*
           move      "#"                  to   w-cnt-sts-imp-ric      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "MX"                 to   v-ope                  .
           move      "U"                  to   v-tip                  .
           move      "Conferma impfitazioni (S/N/E) ?"
                                          to   v-not                  .
           move      "S"                  to   v-alf                  .
           move      "SNE"                to   v-msk                  .
           move      "DO  "               to   v-pfk (05)             .
      ...
      *              *-------------------------------------------------*
       ...
       acc-tip-cnv-200.
      *              *-------------------------------------------------*
      *              * Valore impfitato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-tip-cnv             .
       acc-tip-cnv-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impfitato                      *
      *              *-------------------------------------------------*
           if        rr-tip-cnv           =    zero
                     go to acc-tip-cnv-100.
       acc-tip-cnv-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impfitazione                    *
      *              *-------------------------------------------------*
       acc-tip-cnv-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      ...
      *              *-------------------------------------------------*
           ...
           move      123000001            to   rf-fit-num-prt         .
           move      "pgm/fat/fls/ioc/obj/ioffit"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Test su codice intermediario                    *
      *              *-------------------------------------------------*
           if        rf-fit-cod-ime       =    zero
                     go to prn-liv-det-300.
______*    move      rf-fit-cod-ime       to   rf-fit-pvf-ime         .
