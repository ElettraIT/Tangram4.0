      ...
      *              * Test se 'LCASSOL'                               *
      *              *-------------------------------------------------*
           if        srt-prm-ubi (1)      =    "LCASSOL"
                     go to prn-liv-det-300.
           if        srt-prm-ubi (2)      =    "LCASSOL"
                     go to prn-liv-det-300.
           if        srt-prm-ubi (3)      =    "LCASSOL"
                     go to prn-liv-det-300.
           if        srt-prm-ubi (4)      =    "LCASSOL"
                     go to prn-liv-det-300.
      ...
      *
           if        srt-prm-ubi (1)      =    "LCASSOL"
                     move  "CASSOL"       to   srt-prm-ubi (1)        .
      *
           if        srt-prm-ubi (2)      =    "LCASSOL"
                     move  "CASSOL"       to   srt-prm-ubi (2)        .
      *
           if        srt-prm-ubi (3)      =    "LCASSOL"
                     move  "CASSOL"       to   srt-prm-ubi (3)        .
      *
           if        srt-prm-ubi (4)      =    "LCASSOL"
                     move  "CASSOL"       to   srt-prm-ubi (4)        .
      *
