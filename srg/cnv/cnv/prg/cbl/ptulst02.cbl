      ...
      *                                                                *
      *                    NOTE OPERATIVE                              *
      *                    Recupero da ultima storicizzazione          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Comodo per prezzo precedente                          *
      *        *-------------------------------------------------------*
           05  w-wrk-prz-pre              pic  9(09)                  .
      ...
      *              *-------------------------------------------------*
           if        rf-lsd-tip-rec       >    01
                     go to stp-srt-inp-900.
           if        rf-lsd-cod-lst       not  = "210"
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      *              *-------------------------------------------------*
           if        rf-lsd-dva-fin       not  = 1211231
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-lsd-prz-lst       to   srt-prz-lst            .
      *                  *---------------------------------------------*
      ...
      *              * Update record [lst]                             *
      *              *-------------------------------------------------*
           perform   upd-rec-lst-000      thru upd-rec-lst-999        .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "Prodotto :"         to   w-all-str-cat (1)      .
           move      rf-dcp-alf-pro       to   w-all-str-cat (2)      .
           move      "- Attuale :"        to   w-all-str-cat (3)      .
           move      "- precedente :"     to   w-all-str-cat (5)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-tip-rec          to   rf-lst-tip-rec         .
           move      srt-cod-lst          to   rf-lst-cod-lst         .
           move      srt-cod-cli          to   rf-lst-cod-cli         .
           ...
           call      s-pat               using f
                                               rf-lst                 .
      *              *-------------------------------------------------*
      *              * Memorizzazione prezzo precedente                *
      *              *-------------------------------------------------*
           move      rf-lst-prz-lst       to   w-wrk-prz-pre          .
      *              *-------------------------------------------------*
      *              * Aggiornamento prezzo                            *
      *              *-------------------------------------------------*
           move      srt-prz-lst          to   rf-lst-prz-lst         .
       cmp-rec-lst-999.
           exit.
