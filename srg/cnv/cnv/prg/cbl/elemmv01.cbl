      ...
      *                       Ultima revisione:    NdK del 27/11/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Check file [mmv]                            *
      *                                                                *
      *                    Controllo num-pro                           *
      *                                                                *
      *                    ELETTRA                                     *
      ...
      *            *---------------------------------------------------*
      *            * Codice numerico magazzino editato                 *
      *            *---------------------------------------------------*
               10  srt-edt-mag            pic  x(07)                  .
      *            *---------------------------------------------------*
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Controllo saldi valore 'mmv' ELETTRA    "  .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      rf-mmv-num-mag       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   srt-edt-mag            .   
       stp-srt-inp-mmv-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      srt-num-mag          to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Codice numerico prodotto editato            *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      07                   to   p-car                  .
