      ...
      *                                   Fase:    elemms              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 30/04/25    *
      *                       Ultima revisione:    NdK del 30/04/25    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [mms] : ELETTRA          *
      *                                                                *
      *                    RICOSTRUZIONE SALDI 2025 CANCELLATI DA      *
      *                    PROCEDURA TABLET USANDO DATI INVENTARIO     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Sistemazione saldi ubicazione a zero  "       .
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-wrk-ctr-002              pic  9(09)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per messaggio a video                          *
      *        *-------------------------------------------------------*
           05  w-wrk-msg-pro.
               10  w-wrk-msg-pro-alf      pic  x(14)                  .
               10  filler                 pic  x(03) value " - "      .
               10  w-wrk-msg-pro-ubi      pic  x(07)                  .
               10  filler                 pic  x(03) value " - "      .
               10  w-wrk-msg-pro-gia      pic  x(07)                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Solo dislocazioni (ubicazioni) non a spazi  *
      *                  *---------------------------------------------*
           if        rf-mms-cod-dsl       =    spaces
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Solo prodotti                               *
      *                  *---------------------------------------------*
           if        rf-mms-tip-mag       not  = 01
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Normalizzazione [dcp]                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-mms-ann-ese       to   srt-ann-ese            .
           move      rf-mms-cod-dpz       to   srt-cod-dpz            .
           move      rf-mms-tip-mag       to   srt-tip-mag            .
           move      rf-mms-num-mag       to   srt-num-mag            .
           move      rf-mms-var-mag       to   srt-var-mag            .
           move      rf-mms-cod-dsl       to   srt-cod-dsl            .
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      rf-mms               to   srt-rec-mms            .
      *              *-------------------------------------------------*
      ...
      *              * Fincatura messaggio                             *
      *              *-------------------------------------------------*
           move      "PRODOTTO"           to   w-wrk-msg-pro-alf      .
           move      "UBICAZ."            to   w-wrk-msg-pro-ubi      .
           move      "GIACENZA"           to   w-wrk-msg-pro-gia      .
      *
           move      "WR"                 to   m-ope                  .
           move      w-wrk-msg-pro        to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
      *
           move      "WR"                 to   m-ope                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Recupero record di sort                         *
      *              *-------------------------------------------------*
           move      srt-rec-mms          to   rf-mms                 .
       prn-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione contatori generici              *
      *              *-------------------------------------------------*
      ...
      *
           ...
           string    "Giacenze SENZA scheda 2025 : "
                                delimited by   size
      ...
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      spaces               to   m-msg                  .
           string    "Giacenze con scheda 2025 : "
                                delimited by   size
                     p-edt      delimited by   spaces
                                          into m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Test se codice dislocazione (ubicazione) vuota  *
      *              *-------------------------------------------------*
           if        rf-mms-cod-dsl       =    spaces
                     go to prn-liv-det-900.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Test se la scheda inventario esiste             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-num-mag          to   rf-miu-num-mag         .
           move      srt-cod-dsl          to   rf-miu-cod-ubi         .
           move      "pgm/mag/fls/ioc/obj/iofmiu"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-liv-det-900.
      *                  *---------------------------------------------*
      *                  * Test se giacenza inventariale positiva      *
      *                  *---------------------------------------------*
           if        rf-miu-qta-rlv       not  > zero
                     go to prn-liv-det-900.
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test se la scheda 2025 esiste                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "DPMGDS    "         to   f-key                  .
           move      125                  to   rf-mms-ann-ese         .
           move      srt-cod-dpz          to   rf-mms-cod-dpz         .
           move      srt-tip-mag          to   rf-mms-tip-mag         .
           move      srt-num-mag          to   rf-mms-num-mag         .
           move      srt-var-mag          to   rf-mms-var-mag         .
           move      srt-cod-dsl          to   rf-mms-cod-dsl         .
           move      "pgm/mag/fls/ioc/obj/iofmms"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           else      go to prn-liv-det-500.
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Scheda saldo 2025 NON trovata                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Editing quantita'                           *
      *                  *---------------------------------------------*
      ...
      *                  * Messaggio                                   *
      *                  *---------------------------------------------*
           move      srt-alf-key          to   w-wrk-msg-pro-alf      .
           move      srt-cod-dsl          to   w-wrk-msg-pro-ubi      .
           move      v-edt                to   w-wrk-msg-pro-gia      .
      *
           move      80                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      w-wrk-msg-pro        to   w-all-str-cat (1)      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Scheda saldo 2025 trovata                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se saldo iniziale corrisponde a        *
      *                  * inventario                                  *
      *                  *---------------------------------------------*
           if        rf-mms-qta-ini       =    rf-miu-qta-rlv
                     go to prn-liv-det-900.
      *                  *---------------------------------------------*
      *                  * Test se saldo iniziale diverso da zero      *
      *                  *---------------------------------------------*
           if        rf-miu-qta-rlv       not  = zero
                     go to prn-liv-det-900.
      *                  *---------------------------------------------*
      ...
      *
           ...
           move      02                   to   w-all-str-num          .
           move      w-wrk-msg-pro        to   w-all-str-cat (1)      .
           move      ": con scheda 2025 ma saldo iniziale zero"
                                          to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      "WR"                 to   m-ope                  .
      ...
      *              *-------------------------------------------------*
           move      rf-miu-qta-rlv       to   rf-mms-qta-ini         .
           move      rf-miu-qta-rlv       to   rf-mms-prg-sca (01)    .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
