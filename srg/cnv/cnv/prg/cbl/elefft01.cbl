      ...
      *                                   Fase:    elefft              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 28/04/21    *
      *                       Ultima revisione:    NdK del 05/04/22    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Update riferimenti documento 'xml'          *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento collegamento fatture XML "       .
      ...
      *              *-------------------------------------------------*
           if        rf-fft-num-doc       =    spaces
                     go to prn-liv-det-900.
       prn-liv-det-050.
      *              *-------------------------------------------------*
      *              * Normalizzazione record [sfx]                    *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "pgm/scf/fls/ioc/obj/iofsfx"
                                          to   s-pat                  .
           ...
           call      s-pat               using f
                                               rf-sfx                 .
      *              *-------------------------------------------------*
      *              * Test se esiste gia' collegamento                *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      rf-fft-prt-scf       to   rf-sfx-num-prt         .
           move      "pgm/scf/fls/ioc/obj/iofsfx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [xft] per numero documento    *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "FNTNDO    "         to   f-key                  .
           move      "NL"                 to   f-cfr                  .
           move      rf-fft-cod-arc       to   rf-xft-cod-fnt         .
           move      rf-fft-num-doc       to   rf-xft-ndo-ftf         .
      ...
      *                  *---------------------------------------------*
           if        rf-xft-cod-fnt       not  = rf-fft-cod-arc
                     go to prn-liv-det-900.
      *                  *---------------------------------------------*
      *                  * Test su numero documento                    *
      *                  *---------------------------------------------*
           if        rf-xft-ndo-ftf       not  = rf-fft-num-doc
                     go to prn-liv-det-900.
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Selezioni su [xft]                              *
      ...
      *                  *---------------------------------------------*
           if        rf-xft-ddo-ftf       not  = rf-fft-dat-doc
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-sfx                 .
      *              *-------------------------------------------------*
      *              * Composizione record [sfx]                       *
      *              *-------------------------------------------------*
           move      rf-fft-prt-scf       to   rf-sfx-num-prt         .
           move      rf-xft-nom-xml       to   rf-sfx-nom-fil         .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-sfx-nom-fil       to   rf-xft-nom-xml         .
           move      "pgm/scf/fls/ioc/obj/iofxft"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
      *              * Aggiornamento protocollo fattura                *
      *              *-------------------------------------------------*
           move      rf-fft-prt-scf       to   rf-xft-num-ftf         .
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
