      ...
      *                       Ultima revisione:    NdK del 15/02/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Generazione distinte 'html' da 'ddx' (2022) *
      *                                                                *
      *                    STANDARD                                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Creazione distinte 'html' da 'ddx'   "       .
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-ddx-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [ddx]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "NUMDST    "         to   f-key                  .
           move      w-det-fil-htm-dmn    to   rf-ddx-num-dst         .
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-ddx-num-dst       >    w-det-fil-htm-dmx
                     go to stp-srt-inp-ddx-900.
       stp-srt-inp-ddx-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [ddx]                      *
      *              *-------------------------------------------------*
       stp-srt-inp-ddx-600.
      *              *-------------------------------------------------*
