      ...
      *                                   Fase:    pulocp              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 01/09/25    *
      *                       Ultima revisione:    NdK del 14/09/25    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Pulizia file [ocp]                          *
      *                                                                *
      *                    Da utilizzare anche in Crontab              *
      *                                                                *
      *================================================================*
      ...
      *              * Ciclo per [ocp]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-ocp-000  thru stp-srt-inp-ocp-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-ocp-900.
       stp-srt-inp-ocp-200.
      *              *-------------------------------------------------*
      *              * Test se esecuzione batch                        *
      *              *-------------------------------------------------*
           if        rr-snx-btc           =    "S"
                     go to stp-srt-inp-ocp-210.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      rf-ocp-num-prt       to   rf-oct-num-prt         .
           move      "pgm/orc/fls/ioc/obj/iofoct"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-oct                 .
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-ocp-200.
      *                  *---------------------------------------------*
      *                  * Test su status ordine                       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        d-sts-orc-sts-ord    =    01 or
                     ...
                     go to stp-srt-inp-ocp-600
           else      go to stp-srt-inp-ocp-200.
       stp-srt-inp-ocp-600.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-ocp-num-prt       to   srt-num-prt            .
           move      rf-ocp-num-prg       to   srt-num-prg            .
           move      rf-ocp-prg-frm       to   srt-prg-frm            .
      *                  *---------------------------------------------*
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
       stp-srt-inp-ocp-700.
      ...
      *              *-------------------------------------------------*
           perform   del-rec-ocp-000      thru del-rec-ocp-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
