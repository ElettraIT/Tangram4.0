      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento files [osu] : ELETTRA         *
      *                                                                *
      *                    Clonazione file [hdr] in [osu]              *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "pgm/ods/fls/ioc/obj/iofosu"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   rf-hdr-num-prt         .
           move      zero                 to   rf-hdr-num-prg         .
           move      "ele/ods/fls/ioc/obj/iofhdr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale record [hdr]                *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "ele/ods/fls/ioc/obj/iofhdr"
                                          to   s-pat                  .
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      rf-hdr-num-prt       to   srt-num-prt            .
           move      rf-hdr-num-prg       to   srt-num-prg            .
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      rf-hdr               to   srt-rec-hdr            .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-800.
      *              *-------------------------------------------------*
      *              * Riciclo su lettura sequenziale record [hdr]     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Scrittura record [osu]                          *
      *              *-------------------------------------------------*
           perform   wrt-rec-osu-000      thru wrt-rec-osu-999        .
       prn-liv-det-400.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Composizione record [osu] attuale                         *
      *    *-----------------------------------------------------------*
       cmp-rec-osu-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione record [hdr]                    *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "ele/ods/fls/ioc/obj/iofhdr"
                                          to   s-pat                  .
      ...
      *                  * Campi chiave                                *
      *                  *---------------------------------------------*
           move      srt-num-prt          to   rf-osu-num-prt         .
           move      srt-num-prg          to   rf-osu-num-prg         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      rf-hdr-num-dst       to   rf-osu-num-dst         .
           move      rf-hdr-num-pro       to   rf-osu-num-pro         .
           move      rf-hdr-ide-dat       to   rf-osu-ide-dat         .
           move      rf-hdr-cod-rsm       to   rf-osu-cod-rsm         .
           move      rf-hdr-alx-exp       to   rf-osu-alx-exp         .
       cmp-rec-osu-999.
           exit.
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-osu-000      thru cmp-rec-osu-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
