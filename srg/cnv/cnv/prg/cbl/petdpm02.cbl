      ...
      *                                   Fase:    petdpm              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 28/06/18    *
      *                       Ultima revisione:    NdK del 27/09/20    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Scansione anagrafica prodotti per:          *
      *                                                                *
      *                    - Creazione anagrafiche materie prime       *
      *                      con dati acquisto                         *
      *                                                                *
      *                    - Cambiamento Status prodotti corrisponden- *
      *                      ti                                        *
      *                                                                *
      *                    - Scarico di magazzino prodotti             *
      *                                                                *
      *                    - Carico di magazzino materie prime         *
      *                                                                *
      *                    Versione per data creazione prodotto!       *
      *                                                                *
      *                    PERONTECNICI                                *
      *                                                                *
      *================================================================*
      ...
      *            * Giacenza                                          *
      *            *---------------------------------------------------*
               10  kk0-qta-pro            pic s9(10)v9(03)            .
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Riclassificazione Prodotti - Nuovi   "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione codice numerico materia prima      *
      *        *-------------------------------------------------------*
           05  w-det-num-map.
      *            *---------------------------------------------------*
      *            * Codice numerico                                   *
      *            *---------------------------------------------------*
               10  w-det-num-map-num      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Giacenza                                          *
      *            *---------------------------------------------------*
               10  w-det-num-map-gia      pic s9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Per movimenti di magazzino                            *
      *        *-------------------------------------------------------*
           05  w-det-prt-mag.
      *            *---------------------------------------------------*
      *            * Scarico prodotti                                  *
      *            *---------------------------------------------------*
               10  w-det-prt-mag-sca      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Carico materie prime                              *
      *            *---------------------------------------------------*
               10  w-det-prt-mag-car      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Per determinazione codice fornitore preferenziale     *
      *        *-------------------------------------------------------*
           05  w-det-dcf-pfz.
      *            *---------------------------------------------------*
      *            * Codice numerico                                   *
      *            *---------------------------------------------------*
               10  w-det-dcf-pfz-cod      pic  9(07)                  .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione su misura - PERONTECNICI    "  .
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Test su data codifica prodotto                  *
      *              *-------------------------------------------------*
           if        rf-dcp-dat-icm       <    1200831
      ...
      *              * Scarico prodotti                                *
      *              *-------------------------------------------------*
           perform   prn-fin-cic-sca-000  thru prn-fin-cic-sca-999    .
       prn-fin-cic-200.
      *              *-------------------------------------------------*
      *              * Carico materie prime                            *
      *              *-------------------------------------------------*
           perform   prn-fin-cic-cmp-000  thru prn-fin-cic-cmp-999    .
       prn-fin-cic-200.
      *              *-------------------------------------------------*
      *              * Carico prodotti in negativo                     *
      *              *-------------------------------------------------*
           perform   prn-fin-cic-car-000  thru prn-fin-cic-car-999    .
       prn-fin-cic-800.
      *              *-------------------------------------------------*
      *              * Editing contatore                               *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-fin-cic-sca-000.
      *              *-------------------------------------------------*
      *              * Attribuzione protocollo magazzino per scarico   *
      *              *-------------------------------------------------*
           move      "NP"                 to   l-mag-300-tip-ope      .
           move      w-wrk-dat-exe        to   l-mag-300-dat-reg      .
           ...
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using l-mag-300              .
           move      l-mag-300-num-prt    to   w-det-prt-mag-sca      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using l-mag-300              .
      *              *-------------------------------------------------*
      *              * Scrittura testata per scarico                   *
      *              *-------------------------------------------------*
           move      "WT"                 to   l-mag-300-tip-ope      .
           move      w-wrk-dat-exe        to   l-mag-300-dat-reg      .
           move      01                   to   l-mag-300-cod-dpz      .
           move      zero                 to   l-mag-300-num-prt      .
           move      00710                to   l-mag-300-cod-cau      .
      ...
      *              * Test su giacenza                                *
      *              *-------------------------------------------------*
           if        kk0-qta-pro          not  > zero
                     go to prn-fin-cic-sca-200.
       prn-fin-cic-sca-500.
      *              *-------------------------------------------------*
      *              * Scrittura riga                                  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      kk0-qta-pro          to   l-mag-300-qta-mov      .
           perform   wrt-mov-mag-rig-000  thru wrt-mov-mag-rig-999    .
       prn-fin-cic-sca-800.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using l-mag-300              .
      *              *-------------------------------------------------*
      *              * Scrittura testata per carico                    *
      *              *-------------------------------------------------*
           move      "WT"                 to   l-mag-300-tip-ope      .
           move      w-wrk-dat-exe        to   l-mag-300-dat-reg      .
           move      01                   to   l-mag-300-cod-dpz      .
           move      zero                 to   l-mag-300-num-prt      .
           move      00720                to   l-mag-300-cod-cau      .
           move      spaces               to   l-mag-300-cod-ctm      .
           move      zero                 to   l-mag-300-dat-doc      .
           move      spaces               to   l-mag-300-num-doc      .
           move      spaces               to   l-mag-300-cod-dsl      .
      ...
      *                  *---------------------------------------------*
           ...
           move      kk0-num-map          to   rf-dpm-num-map         .
           move      "pgm/dpm/fls/ioc/obj/iofdpm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Scrittura riga                              *
      *                  *---------------------------------------------*
           move      03                   to   l-mag-300-tip-mag      .
           move      rf-dpm-num-map       to   l-mag-300-num-mag      .
           move      rf-dpm-alf-map       to   l-mag-300-alf-mag      .
           move      rf-dpm-umi-prd       to   l-mag-300-udm-ana      .
           move      rf-dpm-umi-prd       to   l-mag-300-udm-mov      .
           move      kk0-qta-pro          to   l-mag-300-qta-mov      .
           perform   wrt-mov-mag-rig-000  thru wrt-mov-mag-rig-999    .
       prn-fin-cic-cmp-800.
      *              *-------------------------------------------------*
      ...
      *    * Ciclo Report Program : Esecuzione per fine ciclo          *
      *    *                                                           *
      *    * Carico prodotti con giacenza negativa                     *
      *    *-----------------------------------------------------------*
       prn-fin-cic-car-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione testata                         *
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dcp-umi-ven       to   l-mag-300-udm-mov      .
           move      kk0-qta-pro          to   l-mag-300-qta-mov      .
           multiply  -1                   by   l-mag-300-qta-mov      .
           perform   wrt-mov-mag-rig-000  thru wrt-mov-mag-rig-999    .
       prn-fin-cic-car-800.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Selezioni preliminari su prodotti               *
      *              *-------------------------------------------------*
           if        rf-dcp-cla-pro       not  > 00039 or
                     rf-dcp-cla-pro       not  < 00081
                     go to prn-liv-det-800.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Generazione anagrafica [dpm] e [aaq]            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Condizioni generali di acquisto [aaq]       *
      *                  *---------------------------------------------*
           perform   wrt-rec-aaq-000      thru wrt-rec-aaq-999        .
      *                  *---------------------------------------------*
      *                  * Condizioni di acquisto per fornitore [aaf]  *
      *                  *---------------------------------------------*
           perform   wrt-rec-aaf-000      thru wrt-rec-aaf-999        .
      *                  *---------------------------------------------*
      *                  * Eventuale descrizione estesa [dpx]          *
      *                  *                                             *
      *                  * N.B.: non gestita                           *
      *                  *---------------------------------------------*
       prn-liv-det-300.
      ...
      *                  *---------------------------------------------*
           ...
           move      w-wrk-dat-exe        to   d-sld-mag-dat-sld      .
      ...
      *                  * Area dati                                   *
      *                  *---------------------------------------------*
           move      d-sld-mag-sld-mag    to   kk0-qta-pro            .
      ...
      *
       ...
       prn-liv-det-750.
      *              *-------------------------------------------------*
      *              * Aggiornamento status prodotto                   *
      *              *-------------------------------------------------*
           move      51                   to   rf-dcp-sta-tus         .
           move      w-wrk-dat-exe        to   rf-dcp-sta-tud         .
      *              *-------------------------------------------------*
      *              * Update record [dcp]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
           move      w-enc-dpm-val-pos    to   rf-dpm-num-map         .
           move      w-enc-dpm-val-pos    to   w-det-num-map-num      .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      "IG"                 to   s-ope                  .
           ...
           move      rf-dcp-alf-pro       to   rf-dpm-alf-map         .
           move      rf-dcp-syn-pro       to   rf-dpm-syn-map         .
           move      rf-dcp-des-key       to   rf-dpm-des-key         .
           move      rf-dcp-des-pro       to   rf-dpm-des-map         .
           move      rf-dcp-cla-pro       to   rf-dpm-cla-map         .
           move      rf-dcp-gru-pro       to   rf-dpm-gru-map         .
           move      rf-dcp-sgr-pro       to   rf-dpm-sgr-map         .
           move      rf-dcp-tip-pro       to   rf-dpm-tip-map         .
           move      rf-dcp-tip-cfz       to   rf-dpm-tip-cfz         .
           move      rf-dcp-qta-cfz       to   rf-dpm-qta-cfz         .
           move      rf-dcp-pes-uni       to   rf-dpm-pes-uni         .
           move      rf-dcp-pes-tar       to   rf-dpm-pes-tar         .
           move      rf-dcp-vol-uni       to   rf-dpm-vol-uni         .
           move      rf-dcp-dim-lar       to   rf-dpm-dim-lar         .
           move      rf-dcp-dim-alt       to   rf-dpm-dim-alt         .
           move      rf-dcp-dim-prf       to   rf-dpm-dim-prf         .
           move      rf-dcp-pcl-fis       to   rf-dpm-pcl-fis         .
           move      rf-dcp-coe-mol       to   rf-dpm-coe-mol         .
           move      rf-dcp-coe-div       to   rf-dpm-coe-div         .
           move      rf-dcp-umi-ven       to   rf-dpm-umi-prd         .
           move      02                   to   rf-dpm-dec-qta         .
           move      rf-dcp-snx-2qt       to   rf-dpm-snx-2qt         .
           move      rf-dcp-dec-2qt       to   rf-dpm-dec-2qt         .
           move      rf-dcp-snx-3qt       to   rf-dpm-snx-3qt         .
           move      rf-dcp-dec-3qt       to   rf-dpm-dec-3qt         .
           move      rf-dcp-tip-vve       to   rf-dpm-tip-vpr         .
           move      zero                 to   rf-dpm-cod-s01         .
           move      zero                 to   rf-dpm-cod-s02         .
           move      zero                 to   rf-dpm-cod-s03         .
           move      rf-dcp-cla-bdg       to   rf-dpm-cla-bdg         .
           move      rf-dcp-dat-icm       to   rf-dpm-dat-iim         .
           move      rf-dcp-sta-tus       to   rf-dpm-sta-tus         .
           move      rf-dcp-sta-tud       to   rf-dpm-sta-tud         .
           move      rf-dcp-sta-tuc       to   rf-dpm-sta-tuc         .
           move      rf-dcp-sta-tux       to   rf-dpm-sta-tux         .
           move      rf-dcp-alx-exp       to   rf-dpm-alx-exp         .
       cmp-rec-dpm-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       cmp-rec-aaq-100.
      *              *-------------------------------------------------*
      *              * Lettura dati di acquisto legati al prodotto     *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRO    "         to   f-key                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-det-num-map-num    to   rf-aaq-num-pro         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      "IG"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           move      rf-aaq-dcf-pfz       to   w-det-dcf-pfz-cod      .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       wrt-rec-aaf-000.
      *              *-------------------------------------------------*
      *              * Test su codice fornitore preferenziale          *
      *              *-------------------------------------------------*
           if        w-det-dcf-pfz-cod    not  = zero
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-dcf-pfz-cod    to   rf-aaf-cod-dcf         .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-det-num-map-num    to   rf-aaf-num-pro         .
           move      w-det-dcf-pfz-cod    to   rf-aaf-cod-dcf         .
           move      spaces               to   rf-aaf-fda-pif         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
