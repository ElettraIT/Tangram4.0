      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [mgr]                    *
      *                                                                *
      *                    Sistemazione errore post pulizie - NOBILI   *
      *                                                                *
      *                    Recupero riferimenti 'mgr' partite aperte   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Sistemazione Riferimenti Partite    "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Aggiornamento Riferimenti Partite       "  .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "cnv/cnv/fls/ioc/obj/iofwgr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *                  * Record di sort                              *
      *                  *---------------------------------------------*
           move      rf-wgr-dat-reg       to   srt-dat-reg            .
           move      rf-wgr-num-prt       to   srt-num-prt            .
           move      rf-wgr-num-prg       to   srt-num-prg            .
           move      rf-wgr               to   srt-rec-wgr            .
      *                  *---------------------------------------------*
      ...
      *              * Ripresa record                                  *
      *              *-------------------------------------------------*
           move      srt-rec-wgr          to   rf-wgr                 .
      *              *-------------------------------------------------*
      *              * Da [wgr] a [mgr]                                *
      *              *-------------------------------------------------*
           move      spaces               to   rf-mgr                 .
           move      rf-wgr-dat-reg       to   rf-mgr-dat-reg         .
           move      rf-wgr-num-prt       to   rf-mgr-num-prt         .
           move      rf-wgr-num-prg       to   rf-mgr-num-prg         .
           move      rf-wgr-cod-pdc       to   rf-mgr-cod-pdc         .
           move      rf-wgr-tip-arc       to   rf-mgr-tip-arc         .
           move      rf-wgr-cod-arc       to   rf-mgr-cod-arc         .
           move      rf-wgr-cod-cau       to   rf-mgr-cod-cau         .
           move      rf-wgr-snx-mob       to   rf-mgr-snx-mob         .
           move      rf-wgr-tip-iva       to   rf-mgr-tip-iva         .
           move      rf-wgr-com-rig       to   rf-mgr-com-rig         .
           move      rf-wgr-dat-doc       to   rf-mgr-dat-doc         .
           move      rf-wgr-num-doc       to   rf-mgr-num-doc         .
           move      rf-wgr-dat-rif       to   rf-mgr-dat-rif         .
           move      rf-wgr-num-rif       to   rf-mgr-num-rif         .
           move      rf-wgr-dar-ave       to   rf-mgr-dar-ave         .
           move      rf-wgr-imp-mov       to   rf-mgr-imp-mov         .
           move      rf-wgr-flg-pge       to   rf-mgr-flg-pge         .
           move      rf-wgr-flg-pcf       to   rf-mgr-flg-pcf         .
           move      rf-wgr-alx-exp       to   rf-mgr-alx-exp         .
       cmp-rec-mgr-999.
           exit.
