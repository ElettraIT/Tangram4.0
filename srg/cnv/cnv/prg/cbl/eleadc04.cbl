      ...
      *                                   Fase:    eleadc              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 14/05/24    *
      *                       Ultima revisione:    NdK del 06/06/24    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Update per sistemazione del progressivo     *
      *                    utenza                                      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Sistemazione progressivo contatto   "       .
      ...
      *                  *---------------------------------------------*
           if        rf-adc-tip-arc       =    01 or
                     rf-adc-tip-arc       =    02
                     go to stp-srt-inp-adc-600
           else      go to stp-srt-inp-adc-200.
       stp-srt-inp-adc-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione progressivo nuovo               *
      *              *-------------------------------------------------*
           move      zero                 to   w-wrk-new-prg          .
       prn-ini-lr1-999.
           exit.
      ...
      *                  * Incremento                                  *
      *                  *---------------------------------------------*
           add       1                    to   w-wrk-new-prg          .
      *                  *---------------------------------------------*
      *                  * Se uguale a quello attuale: nessuna azione  *
      *                  *---------------------------------------------*
           if        w-wrk-new-prg        =    srt-num-prg
                     go to prn-liv-det-900.
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Cancellazione record attuale                    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Scrittura record con progressivo aggiornato     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione record                      *
      *                  *---------------------------------------------*
      ...
      *                  * Nuovo progressivo                           *
      *                  *---------------------------------------------*
           move      w-wrk-new-prg        to   rf-adc-num-prg         .
      *                  *---------------------------------------------*
      *                  * Put record                                  *
      *                  *---------------------------------------------*
           move      "PT"                 to   f-ope                  .
