      ...
      *                       Ultima revisione:    NdK del 07/08/20    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [bir]                    *
      *                                                                *
      *                    Cancellazione righe senza testata           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Cancellazione righe bolla senza testata "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      12001009642          to   rf-bir-num-prt         .
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-bir-num-prt       not  = 12001009642 and
                     rf-bir-num-prt       not  = 12001009643
                     go to stp-srt-inp-bir-900.
       stp-srt-inp-bir-400.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-bir-600
           else      go to stp-srt-inp-bir-200.
       stp-srt-inp-bir-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-num-prg          to   rf-bir-num-prg         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
