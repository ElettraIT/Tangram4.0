      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Clonazione file [hbr] in [bfu]              *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale record [hbr]                *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "ele/bfo/fls/ioc/obj/iofhbr"
                                          to   s-pat                  .
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      rf-hbr-num-prt       to   srt-num-prt            .
           move      rf-hbr-num-pro       to   srt-num-pro            .
           move      rf-hbr-cod-ubi       to   srt-cod-ubi            .
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      rf-hbr               to   srt-rec-hbr            .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-800.
      *              *-------------------------------------------------*
      *              * Riciclo su lettura sequenziale record [hbr]     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Scrittura record [bfu]                          *
      *              *-------------------------------------------------*
           perform   wrt-rec-bfu-000      thru wrt-rec-bfu-999        .
       prn-liv-det-400.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Composizione record [bfu] attuale                         *
      *    *-----------------------------------------------------------*
       cmp-rec-bfu-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      rf-hbr-qta-ubi       to   rf-bfu-qta-ubi         .
           move      rf-hbr-prt-mag       to   rf-bfu-prt-mag         .
           move      rf-hbr-drg-mag       to   rf-bfu-drg-mag         .
           move      rf-hbr-alx-exp       to   rf-bfu-alx-exp         .
       cmp-rec-bfu-999.
           exit.
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-bfu-000      thru cmp-rec-bfu-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
