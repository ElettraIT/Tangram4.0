      ...
      *                                   Fase:    sirmgi              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 26/09/17    *
      *                       Ultima revisione:    NdK del 18/03/19    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento data di acquisizione          *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      1181201              to   rf-sff-ddo-ftf         .
      ...
      *              *-------------------------------------------------*
           perform   rew-rec-mgi-000      thru rew-rec-mgi-999        .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to rew-rec-mgi-999.
       rew-rec-mgi-200.
      *              *-------------------------------------------------*
      *              * Test su data acquisizione                       *
      *              *-------------------------------------------------*
           if        rf-mgi-dat-acq       not  numeric
                     move  zero           to   rf-mgi-dat-acq         .
           if        rf-mgi-dat-acq       not  = zero
                     go to rew-rec-mgi-999.
           move      rf-sff-dtr-ftf       to   rf-mgi-dat-acq         .
      *              *-------------------------------------------------*
      *              * Force Put record                                *
      *              *-------------------------------------------------*
           move      "FP"                 to   f-ope                  .
