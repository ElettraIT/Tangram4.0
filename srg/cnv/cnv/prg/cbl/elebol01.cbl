      ...
      *                                   Fase:    elebol              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 06/12/24    *
      *                       Ultima revisione:    NdK del 06/12/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Eliminazione "BRVE" [bit][bir]              *
      *                                                                *
      *                    Pulizia bolle per errori generati da agb620 *
      *                                                                *
      *                    ELETTRA                                     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Protocollo bolla da cancellare                    *
      *            *---------------------------------------------------*
               10  srt-prt-bol            pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Progressivo riga bolla da cancellare              *
      *            *---------------------------------------------------*
               10  srt-prg-bol            pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Cancellazione 'BRVE' generate errate  "       .
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Ciclo per [bit] su bolle 15 mesi precedenti     *
      *              *                                                 *
      *              * ELETTRA                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      1231001              to   rf-bit-dat-doc         .
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-bit-num-prt       to   srt-prt-bol            .
           move      zero                 to   srt-prg-bol            .
       stp-srt-inp-bit-700.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-bir                 .
      *                  *---------------------------------------------*
      *                  * Se Start errata : a bolla successiva        *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-bit-200.
       stp-srt-inp-bit-720.
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-bir-num-prt       to   srt-prt-bol            .
           move      rf-bir-num-prg       to   srt-prg-bol            .
       stp-srt-inp-bit-700.
      *                  *---------------------------------------------*
      *                  * Rilascio record al sort                     *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        srt-prg-bol          =    zero
                     perform del-rec-bit-000
                                          thru del-rec-bit-999
           else      perform del-rec-bir-000
                                          thru del-rec-bir-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      srt-prt-bol          to   rf-bit-num-prt         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     del-rec-bit-999.
       del-rec-bit-999.
           exit.

      *    *===========================================================*
      *    * Aggiornamento record [bir]                                *
      *    *-----------------------------------------------------------*
       del-rec-bir-000.
      *              *-------------------------------------------------*
      *              * Composizione chiave primaria                    *
      *              *-------------------------------------------------*
           move      srt-prt-bol          to   rf-bir-num-prt         .
           move      srt-prg-bol          to   rf-bir-num-prg         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
