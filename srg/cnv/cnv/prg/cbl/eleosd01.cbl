      ...
      *                       Ultima revisione:    NdK del 03/10/24    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento files [hds] : ELETTRA         *
      *                                                                *
      *                    Clonazione file [hds] in [osd]              *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale record [hds]                *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "ele/ods/fls/ioc/obj/iofhds"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-800.
      *              *-------------------------------------------------*
      *              * Riciclo su lettura sequenziale record [hds]     *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Composizione record [osd] attuale                         *
      *    *-----------------------------------------------------------*
       cmp-rec-osd-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      rf-hds-num-dst       to   rf-osd-num-dst         .
           move      rf-hds-num-pro       to   rf-osd-num-pro         .
           move      rf-hds-ide-dat       to   rf-osd-ide-dat         .
           move      rf-hds-cod-rsm       to   rf-osd-cod-rsm         .
           move      rf-hds-alx-exp       to   rf-osd-alx-exp         .
       cmp-rec-osd-999.
           exit.
