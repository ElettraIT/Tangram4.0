      ...
      *                       Ultima revisione:    NdK del 11/05/21    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [bfr] : SIRI             *
      *                                                                *
      *                    Cancellazione riga senza testata            *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      12101000660          to   rf-bfr-num-prt         .
      ...
      *              *-------------------------------------------------*
           if        rf-bfr-num-prt       not  = 12101000661
      ...
      *              * Delete record [bfr]                             *
      *              *-------------------------------------------------*
           perform   del-rec-bfr-000      thru del-rec-bfr-999        .
       prn-liv-det-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-num-prg          to   rf-bfr-num-prg         .
       cmp-rec-bfr-999.
           exit.

      *    *===========================================================*
      *    * Cancellazione record [bfr]                                *
      *    *-----------------------------------------------------------*
       del-rec-bfr-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-bfr-000      thru cmp-rec-bfr-999        .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
