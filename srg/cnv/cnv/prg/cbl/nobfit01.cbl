      ...
      *                                   Fase:    nobfit              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 31/07/23    *
      *                       Ultima revisione:    NdK del 04/12/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [fit] : Nobili           *
      *                                                                *
      *                    Azzeramento spese                           *
      *                                                                *
      *================================================================*
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Aggiornamento spese fatture clienti     "  .
      ...
      *              *-------------------------------------------------*
           ...
           move      1241001              to   rf-fit-dat-doc         .
      ...
      *              * Azzeramento spese                               *
      *              *-------------------------------------------------*
           move      zero                 to   rf-fit-spe-snx (1)     .
           move      zero                 to   rf-fit-spe-snx (2)     .
           move      zero                 to   rf-fit-spe-snx (3)     .
           move      zero                 to   rf-fit-spe-snx (4)     .
           move      zero                 to   rf-fit-spe-snx (5)     .
           move      zero                 to   rf-fit-spe-snx (6)     .
           move      zero                 to   rf-fit-spe-per (1)     .
           move      zero                 to   rf-fit-spe-per (2)     .
           move      zero                 to   rf-fit-spe-per (3)     .
           move      zero                 to   rf-fit-spe-per (4)     .
           move      zero                 to   rf-fit-spe-per (5)     .
           move      zero                 to   rf-fit-spe-per (6)     .
           move      zero                 to   rf-fit-spe-imp (1)     .
           move      zero                 to   rf-fit-spe-imp (2)     .
           move      zero                 to   rf-fit-spe-imp (3)     .
           move      zero                 to   rf-fit-spe-imp (4)     .
           move      zero                 to   rf-fit-spe-imp (5)     .
           move      zero                 to   rf-fit-spe-imp (6)     .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [fit]                             *
      *              *-------------------------------------------------*
