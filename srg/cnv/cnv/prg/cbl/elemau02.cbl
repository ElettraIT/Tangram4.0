      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento files [mau] : ELETTRA         *
      *                                                                *
      *                    Prefisso 'L' per magazzino di Via Lisbona   *
      *                                                                *
      *                    N.B.: DA ABBINARE A 'elezub02' !!!          *
      *                                                                *
      *                          't_ele_ubi_png' crea i file PNG       *
      *                          da [zub] sequenzializzato con '.k'    *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-mau-inx-per       to   srt-inx-per            .
      *              *-------------------------------------------------*
      ...
      *
           if        srt-prm-ubi (1)      not  = spaces
                     move  "L"            to   w-wrk-ubi-new
                     move  srt-prm-ubi (1)
                                          to   w-wrk-ubi-new
                                              (02 : 06)
                     move  w-wrk-ubi-new  to   rf-mau-prm-ubi (1)
           else      move  spaces         to   rf-mau-prm-ubi (1)     .
      *
           if        srt-prm-ubi (2)      not  = spaces
                     move  "L"            to   w-wrk-ubi-new
                     move  srt-prm-ubi (2)
                                          to   w-wrk-ubi-new
                                              (02 : 06)
                     move  w-wrk-ubi-new  to   rf-mau-prm-ubi (2)
           else      move  spaces         to   rf-mau-prm-ubi (2)     .
      *
           if        srt-prm-ubi (3)      not  = spaces
                     move  "L"            to   w-wrk-ubi-new
                     move  srt-prm-ubi (3)
                                          to   w-wrk-ubi-new
                                              (02 : 06)
                     move  w-wrk-ubi-new  to   rf-mau-prm-ubi (3)
           else      move  spaces         to   rf-mau-prm-ubi (3)     .
      *
           if        srt-prm-ubi (4)      not  = spaces
                     move  "L"            to   w-wrk-ubi-new
                     move  srt-prm-ubi (4)
                                          to   w-wrk-ubi-new
                                              (02 : 06)
                     move  w-wrk-ubi-new  to   rf-mau-prm-ubi (4)
           else      move  spaces         to   rf-mau-prm-ubi (4)     .
      *
           move      srt-not-ubi          to   rf-mau-not-ubi         .
           move      srt-inx-per          to   rf-mau-inx-per         .
