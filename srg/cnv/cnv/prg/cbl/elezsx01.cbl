      ...
      *                                   Fase:    aggzsx              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 21/06/23    *
      *                       Ultima revisione:    NdK del 28/12/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione [zsx]                              *
      *                                                                *
      *                    ELETTRA                                     *
      *                                                                *
      *================================================================*
      ...
      *            * Codice categoria                                  *
      *            *---------------------------------------------------*
               10  srt-cod-uno            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Codice cliente                                    *
      *            *---------------------------------------------------*
               10  srt-cod-due            pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-cnv.
               10  w-exp-tip-cnv-num      pic  9(02)       value 02   .
               10  w-exp-tip-cnv-lun      pic  9(02)       value 40   .
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Duplicazione categoria sconto in riga   "  .
                   15  filler             pic  x(40) value
                          "Cancellazione categoria sconto in riga  "  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-uno           to   w-cmn-zcs-003-cod      .
           move      07                   to   w-cmn-zcs-003-lin      .
      ...
      *                  * Bufferizzazione descrizione                 *
      *                  *---------------------------------------------*
           move      w-let-arc-zcs-des    to   rr-cod-due-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
      ...
      *              * Ciclo per [zsx]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-zsx-000  thru stp-srt-inp-zsx-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-zsx-tip-inc       not  = 02
                     go to stp-srt-inp-zsx-200.
       stp-srt-inp-zsx-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [zsx]                      *
      *              *-------------------------------------------------*
       stp-srt-inp-zsx-600.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-zsx-cod-uno       to   srt-cod-uno            .
      *                  *---------------------------------------------*
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
           move      rf-zsx               to   srt-rec-zsx            .
       stp-srt-inp-zsx-700.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Riciclo a record [zsx] successivo           *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-zsx-200.
       stp-srt-inp-zsx-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo conversione     *
      *              *-------------------------------------------------*
           if        rr-tip-cnv           =    01
                     perform prn-liv-det-dup-000
                                          thru prn-liv-det-dup-999
           else      perform prn-liv-det-del-000
                                          thru prn-liv-det-del-999    .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
