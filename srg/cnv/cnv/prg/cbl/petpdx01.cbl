      ...
      *                                   Fase:    petpdx              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 08/03/07    *
      *                       Ultima revisione:    NdK del 31/01/20    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [pdx] e[pdk]             *
      *                                                                *
      *                    Update per clonazione codici prodotto da    *
      *                    cliente a cliente                           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento codici prodotto clienti  "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Clonazione codici prodotto clienti      "  .
      ...
      *    *-----------------------------------------------------------*
       01  w-wrk.
      *        *-------------------------------------------------------*
      *        * Comodi per codici cliente                             *
      *        *-------------------------------------------------------*
           05  w-wrk-cli-old              pic  9(07) value 0773050    .
           05  w-wrk-cli-new              pic  9(07) value 0001388    .
      *        *-------------------------------------------------------*
      *        * Contatore generico                                    *
      *        *-------------------------------------------------------*
      ...
      *              * Ciclo per [pdx]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-pdx-000  thru stp-srt-inp-pdx-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-wrk-cli-old        to   rf-pdx-cod-arc         .
      ...
      *                  * Test su tipo record                         *
      *                  *---------------------------------------------*
           if        rf-pdx-tip-rec       not  = 05
                     go to stp-srt-inp-pdx-900.
      *                  *---------------------------------------------*
      *                  * Test su codice cliente                      *
      *                  *---------------------------------------------*
           if        rf-pdx-cod-arc       not  = w-wrk-cli-old
                     go to stp-srt-inp-pdx-900.
       stp-srt-inp-pdx-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [pdx]                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione [dcp]                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-pdx-cod-num       to   rf-dcp-num-pro         .
           move      "pgm/dcp/fls/ioc/obj/iofdcp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-pdx-cod-arc       to   srt-cod-arc            .
           move      rf-pdx-cod-num       to   srt-num-pro            .
           move      rf-pdx-des-pro       to   srt-cli-pro            .
      ...
      *              *-------------------------------------------------*
           ...
           string    "Aggiornati nr. "
                     ...
                     " codici prodotto per il cliente"
                                delimited by   size
                                          into m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
      ...
      *                  *---------------------------------------------*
           move      05                   to   rf-pdx-tip-rec         .
           move      w-wrk-cli-new        to   rf-pdx-cod-arc         .
           move      spaces               to   rf-pdx-cod-lng         .
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      srt-cli-pro          to   rf-pdx-des-pro         .
      *                  *---------------------------------------------*
      *                  * Put record [pdx]                            *
      *                  *---------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-wrk-cli-new        to   rf-pdk-cod-arc         .
           move      srt-num-pro          to   rf-pdk-num-pro         .
           move      srt-cli-pro          to   rf-pdk-alf-pro         .
