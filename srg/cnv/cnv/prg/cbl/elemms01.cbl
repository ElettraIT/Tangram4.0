      ...
      *                                   Fase:    elemms              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 30/12/23    *
      *                       Ultima revisione:    NdK del 30/12/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Lettura file [mms] : ELETTRA                *
      *                                                                *
      *                    Determinazione numero prodotti in giacenza  *
      *                    per ciascuna ubicazione                     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Determinazione prodotti per ubicazione "       .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore record                *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rf-mms-ann-ese       not  = rr-ann-ese
                     go to prn-tst-max-900.
       prn-tst-max-200.
      *              *-------------------------------------------------*
      *              * Test su codice dipendenza                       *
      *              *-------------------------------------------------*
           if        rf-mms-cod-dpz       not  = 01
                     go to prn-tst-max-900.
       prn-tst-max-800.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Selezione su progressivi mensili                *
      *              *-------------------------------------------------*
           if        rf-mms-prg-car (01)  =   zero and
                     rf-mms-prg-car (02)  =   zero and
                     rf-mms-prg-car (03)  =   zero and
                     rf-mms-prg-car (04)  =   zero and
                     rf-mms-prg-car (05)  =   zero and
                     rf-mms-prg-car (06)  =   zero and
                     rf-mms-prg-car (07)  =   zero and
                     rf-mms-prg-car (08)  =   zero and
                     rf-mms-prg-car (09)  =   zero and
                     rf-mms-prg-car (10)  =   zero and
                     rf-mms-prg-car (11)  =   zero and
                     rf-mms-prg-car (12)  =   zero and
      *
                     rf-mms-prg-sca (01)  =   zero and
                     rf-mms-prg-sca (02)  =   zero and
                     rf-mms-prg-sca (03)  =   zero and
                     rf-mms-prg-sca (04)  =   zero and
                     rf-mms-prg-sca (05)  =   zero and
                     rf-mms-prg-sca (06)  =   zero and
                     rf-mms-prg-sca (07)  =   zero and
                     rf-mms-prg-sca (08)  =   zero and
                     rf-mms-prg-sca (09)  =   zero and
                     rf-mms-prg-sca (10)  =   zero and
                     rf-mms-prg-sca (11)  =   zero and
                     rf-mms-prg-sca (12)  =   zero
                     move "#"             to   w-cnt-prn-flg-sub      .
       prn-sel-rec-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-mms-cod-dsl       to   w-rot-l01-cod-dsl      .
       prn-cmp-rot-999.
           exit.
      ...
      *
           if        rf-mms-cod-dsl       =    spaces
                     move "(nnn)"         to   p-alf
           else      move  rf-mms-cod-dsl to   p-alf                  .
      *
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-999.
      ...
      *              *-------------------------------------------------*
           move      "SITUAZIONE GIACENZE DISLOCAZIONI"
