      ...
      *                                   Fase:    elebft              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 10/04/23    *
      *                       Ultima revisione:    NdK del 10/04/23    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Generazione EAN13 da protocolli bfo         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Generazione barcode EAN13 da protocolli "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Generazione EAN13 da protocolli         "  .
      ...
      *              *-------------------------------------------------*
           ...
           move      12301000000          to   rf-bft-num-prt         .
           move      "pgm/bfo/fls/ioc/obj/iofbft"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Assemblaggio con '0' per raggiungere la stringa *
      *              * necessaria a generare un EAN13                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "EAN13STD"           to   d-bar-cod-tip-cod      .
