      ...
      *                       Ultima revisione:    NdK del 28/04/21    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Update righe per contropartita acquisti     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Aggiornamento contropartita acquisti  "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Contropartita acquisti prodotti         "  .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Test su contropartita in testata                *
      *              *-------------------------------------------------*
           if        rf-oft-ctp-acq       =    zero
                     go to prn-liv-det-200.
           if        rf-oft-ctp-acq       =    rf-ofr-ctp-acq
                     go to prn-liv-det-500.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Normalizzazione [aaq]                           *
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Test su contropartita in scheda prodotto        *
      *              *-------------------------------------------------*
           if        rf-aaq-ctp-acq       =    zero
                     go to prn-liv-det-500.
           if        rf-aaq-ctp-acq       =    rf-ofr-ctp-acq
                     go to prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Editing con appoggio a sinistra                 *
      *              *-------------------------------------------------*
           move      2                    to   w-edt-cod-pdc-liv      .
           move      rf-aaq-ctp-acq       to   w-edt-cod-pdc-cod      .
