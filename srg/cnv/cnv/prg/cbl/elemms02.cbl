      ...
      *                                   Fase:    elemms              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 13/09/05    *
      ...
      *                                                                *
      *                    CANCELLAZIONE SCHEDE SALDO PER DISLOCAZIONE *
      *                    A ZERO, PURCHE' NON PRINCIPALE              *
      *                                                                *
      *                    ___ DA COMPLETARE         ___               *
      *                                                                *
      *                    ___ DA METTERE IN CRONTAB ___               *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Cancellazione saldi ubicazione a zero  "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-mms-num-mag       to   rf-mau-num-pro         .
           move      "pgm/mag/fls/ioc/obj/iofmau"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-all-str-alf        to   rf-mau-alf-pro         .
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      rf-mau-alf-pro       to   srt-alf-key            .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/ele/mms"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/ele/mms.SAV"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              * Composizione chiave                             *
      *              *-------------------------------------------------*
           move      srt-ann-ese          to   rf-mms-ann-ese         .
