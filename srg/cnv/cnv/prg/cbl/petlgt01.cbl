      ...
      *                                   Fase:    petlgt              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 10/02/21    *
      *                       Ultima revisione:    NdK del 10/02/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento tempi di lavorazione per      *
      *                    Distinte Base                               *
      *                                                                *
      *                    PERONTECNICI                                *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Aggiornamento tempi di lavorazione   "       .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Spostamento virgola virtuale tempo lavorazione  *
      *              *-------------------------------------------------*
           if        rf-lgt-tmp-lvr       =    zero
                     go to prn-liv-det-050.
           multiply  10                   by   rf-lgt-tmp-lvr         .
       prn-liv-det-050.
      *              *-------------------------------------------------*
      *              * Spostamento virgola virtuale tempo macchina     *
      *              *-------------------------------------------------*
           if        rf-lgt-tmp-mcn       =    zero
                     go to prn-liv-det-100.
           multiply  10                   by   rf-lgt-tmp-mcn         .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Aggiornamento                                   *
      *              *-------------------------------------------------*
