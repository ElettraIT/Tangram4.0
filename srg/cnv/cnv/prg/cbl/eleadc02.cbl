      ...
      *                                                                *
      *                    Update per clonazione indirizzi mail per    *
      *                    gli ordini su indirizzi mail per bolle in   *
      *                    tutte le anagrafiche clienti commerciali    *
      *                                                                *
      *================================================================*
      ...
      *            * Tipo archivio                                     *
      *            *                                                   *
      *            * - 01 : Cliente   contabile                        *
      *            * - 02 : Cliente   commerciale                      *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento e-mail clienti commerc.  "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Clonazione indirizzi e-mail clienti comm"  .
      ...
      *              * Nome contatto                                   *
      *              *-------------------------------------------------*
           move      "<bol=15/05/24>"     to   rf-adc-int-con         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
