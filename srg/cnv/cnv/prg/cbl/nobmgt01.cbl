      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [mgt][mgr][mgi]          *
      *                                                                *
      *                    Sistemazione data registrazione - NOBILI    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     Sistemazione Data Registrazione    "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1170113              to   rf-mgt-dat-reg         .
           move      0000382              to   rf-mgt-num-prt         .
           move      "pgm/cge/fls/ioc/obj/iofmgt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      1170113              to   rf-mgi-dat-reg         .
           move      0000382              to   rf-mgi-num-prt         .
           move      "pgm/cge/fls/ioc/obj/iofmgi"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      "DATREG"             to   f-key                  .
           move      "NL"                 to   f-cfr                  .
           move      1170113              to   rf-mgr-dat-reg         .
           move      0000382              to   rf-mgr-num-prt         .
      ...
      *                  *---------------------------------------------*
           if        rf-mgr-dat-reg       not  = 1170113 or
                     rf-mgr-num-prt       not  = 0000382
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *                  *---------------------------------------------*
      *                  * Record di sort                              *
      ...
      *              *-------------------------------------------------*
           if        srt-tip-rec          =    "T"
                     perform agg-rec-mgt-000
                                          thru agg-rec-mgt-999
           else if   srt-tip-rec          =    "R"
                     perform agg-rec-mgr-000
                                          thru agg-rec-mgr-999
           else if   srt-tip-rec          =    "I"
                     perform agg-rec-mgi-000
                                          thru agg-rec-mgi-999
      ...
      *              *-------------------------------------------------*
           move      1170115              to   rf-mgt-dat-reg         .
       cmp-rec-mgt-999.
           exit.
      ...
      *              * Nuova data registrazione                        *
      *              *-------------------------------------------------*
           move      1170115              to   rf-mgr-dat-reg         .
       cmp-rec-mgr-999.
           exit.
      ...
      *              * Nuova data registrazione                        *
      *              *-------------------------------------------------*
           move      1170115              to   rf-mgi-dat-reg         .
       cmp-rec-mgi-999.
           exit.
