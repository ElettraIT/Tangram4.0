      ...
      *                                   Fase:    nobsdb              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 26/11/15    *
      *                       Ultima revisione:    NdK del 04/12/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sblocco di alcune scadenze (vedi liv-det)   *
      *                                                                *
      *                    NOBILI                                      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento scadenza clienti - NOBILI"       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1240101              to   rf-sdb-dts-sdb         .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Test su numero scadenza                         *
      *              *-------------------------------------------------*
           if        rf-sdb-num-sdb       =    12400004318
                     go to prn-liv-det-100
           else      go to prn-liv-det-300.
           
______*     GIA' TRATTATE ____           
           
           if        rf-sdb-num-sdb       =    12400004191 or
                     rf-sdb-num-sdb       =    12400001354 or
                     rf-sdb-num-sdb       =    12400004299
                     go to prn-liv-det-100
           else      go to prn-liv-det-300.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      ...
      *                  * Distinta                                    *
      *                  *---------------------------------------------*
           move      12400000052          to   rf-sdb-num-ddp         .
      *                  *---------------------------------------------*
