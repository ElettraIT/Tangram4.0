      ...
      *                       Ultima revisione:    NdK del 26/08/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Pulizia [her] - file di appoggio EDI        *
      *                                                                *
      *                    Con aggiornamento MySQL                     *
      *                                                                *
      *                    RICORDARSI rebuil di [her] dopo esecuzione! *
      *                                                                *
      *================================================================*
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Pulizia conferme 'RSP_*' (tabella 'her')"  .
      ...
      *        * Contatore generico                                    *
      *        *-------------------------------------------------------*
           05  w-wrk-ctr-001              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Comodi per anno                                       *
      *        *-------------------------------------------------------*
           05  w-wrk-pth-ann              pic  9(04)                  .
           05  w-wrk-pth-anw              pic  9(04)                  .
      ...
      *              * Anno pathname                                   *
      *              *-------------------------------------------------*
           if        rr-pth-ann           =    spaces
                     move  "2023"         to   rr-pth-ann             .
      *              *-------------------------------------------------*
      *              * Conversione anno pathname                       *
      *              *-------------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      04                   to   v-car                  .
           move      rr-pth-ann           to   v-alf                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-wrk-pth-anw          .
      *
           if        w-wrk-pth-anw        >    w-wrk-pth-ann
      ...
      *              *-------------------------------------------------*
           perform   del-rec-her-000      thru del-rec-her-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           string    "mysql -u root -p"
                     ...
                     w-all-str-cat (1)
                                delimited by   spaces
                     " -e ""DELETE FROM siri.retarus WHERE "
                                delimited by   size
                     "retarus.path = '"
                                delimited by   size
                     srt-pth-edi
