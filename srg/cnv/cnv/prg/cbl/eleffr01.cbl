      ...
      *                                   Fase:    eleffr              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 07/08/20    *
      *                       Ultima revisione:    NdK del 03/08/23    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Per verifica legami con bolle - ABB         *
      *                                                                *
      *================================================================*
...
______*              go to stp-srt-inp-ffr-200.
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Determinazione se riga risulta fatturata        *
      *              *-------------------------------------------------*
           perform   det-bol-fat-000      thru det-bol-fat-999        .
      *              *-------------------------------------------------*
      *              * Stampa del flag                                 *
      *              *-------------------------------------------------*
           move      "PF"                 to   p-ope                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      078                  to   p-pos                  .
           move      w-det-bol-fat-flg    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-900.
      *              *-------------------------------------------------*
