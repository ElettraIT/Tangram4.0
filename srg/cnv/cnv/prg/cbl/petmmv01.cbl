      ...
      *                       Ultima revisione:    NdK del 21/06/23    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Pulizia LIFO fino al 2022                   *
      *                                                                *
      *                    PERONTECNICI - Alice 21/06/23               *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
       ...
       agg-rec-mmv-620.
           ...
           if        w-wrk-ctr-002        >    10
                     go to agg-rec-mmv-700.
           move      zero                 to   rf-mmv-rim-pre
                                              (w-wrk-ctr-002)         .
           move      zero                 to   rf-mmv-ump-pre
                                              (w-wrk-ctr-002)         .
           move      zero                 to   rf-mmv-vnb-pre
                                              (w-wrk-ctr-002)         .
           move      spaces               to   rf-mmv-fdr-pre
                                              (w-wrk-ctr-002)         .
           go to     agg-rec-mmv-620.
       agg-rec-mmv-700.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
