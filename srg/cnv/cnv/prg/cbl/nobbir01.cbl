      ...
      *                       Ultima revisione:    NdK del 11/07/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [bir] : NOBILI           *
      *                                                                *
      *                    Sistemazione prodotti 10 e 13               *
      *                                                                *
      *================================================================*
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione righe bolle - codici 10 e 13"  .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna riga documento entro i limiti assegnati !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
      *              * Se zero aggiornamenti                           *
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      "Nessun documento aggiornato !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rf-bir-alf-pro       not  = "10            " and
                     rf-bir-alf-pro       not  = "13            "
                     go to prn-liv-det-900.
           if        rf-bir-num-pro       not  = 0000209 and
                     rf-bir-num-pro       not  = 0000210
                     go to prn-liv-det-900.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Codice numerico prodotto                        *
      *              *-------------------------------------------------*
           if        rf-bir-alf-pro       =    "10            "
                     move  0000010        to   rf-bir-num-pro
           else if   rf-bir-alf-pro       =    "13            "
                     move  0000013        to   rf-bir-num-pro
