      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Estrazione file prodotti, ultima fattura    *
      *                                                                *
      *                    ELETTRA                                     *
      *                                                                *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Estrazione Prodotto, data ultima fattura"       .
      ...
      *        *-------------------------------------------------------*
      *        * Work per Det ultima data fatturato                    *
      *        *-------------------------------------------------------*
           05  w-det-dat-fir.
               10  w-det-dat-fir-ult      pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Determinazione ultima data fattura              *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-dat-fir-ult      .
           perform   prn-liv-det-udf-000  thru prn-liv-det-udf-999    .
      *              *-------------------------------------------------*
      *              * Sequenzializzazione                             *
      *              *-------------------------------------------------*
           perform   exe-gen-fil-pro-000  thru exe-gen-fil-pro-999    .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine per ultima data fatturato                      *
      *    *-----------------------------------------------------------*
       prn-liv-det-udf-000.
      *              *-------------------------------------------------*
      *              * Start su [fir] per prodotto a ritroso           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NG"                 to   f-cfr                  .
           ...
           move      9999999              to   rf-fir-dat-doc         .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-udf-400.
      *              *-------------------------------------------------*
      *              * Uscita con data determinata                     *
      *              *-------------------------------------------------*
           move      rf-fir-dat-doc       to   w-det-dat-fir-ult      .
       prn-liv-det-udf-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-liv-det-udf-999.
       prn-liv-det-udf-999.
           exit.
      ...
      *    *===========================================================*
      *    * Subroutine per archivio sequenziale per Prodotto          *
      *    *-----------------------------------------------------------*
       exe-gen-fil-pro-000.
       exe-gen-fil-pro-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "PF"                 to   x-ope                  .
           move      "D"                  to   x-tip                  .
           move      w-det-dat-fir-ult    to   x-dat                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
       exe-gen-fil-pro-800.
      *              *-------------------------------------------------*
