      ...
      *                                   Fase:    cnvxfx              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 31/05/21    *
      *                       Ultima revisione:    NdK del 31/05/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione record [xfx] da [xfr]             *
      *                                                                *
      *                    STANDARD                                    *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Test su lunghezza valore [xfr]                  *
      *              *-------------------------------------------------*
           move      rf-xfr-val-ele       to   w-all-str-alf          .
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      rf-xfr-nom-xml       to   rf-xfx-nom-xml         .
           move      rf-xfr-num-prg       to   rf-xfx-num-prg         .
           move      rf-xfr-val-ele       to   rf-xfx-val-ele         .
           move      spaces               to   rf-xfx-alx-exp         .
       cmp-rec-xfx-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record righe [xfx]                              *
      *    *-----------------------------------------------------------*
       wrt-rec-xfx-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-xfx-000      thru cmp-rec-xfx-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
