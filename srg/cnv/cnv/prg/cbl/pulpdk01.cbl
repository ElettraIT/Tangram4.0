      ...
      *                                   Fase:    pulpdk              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 26/01/21    *
      *                       Ultima revisione:    NdK del 26/01/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Pulizia file di chiavi [pdk] per eventuali  *
      ...
      *              * Ciclo per [pdk]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-pdk-000  thru stp-srt-inp-pdk-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-pdk-900.
       stp-srt-inp-pdk-200.
      *              *-------------------------------------------------*
      *              * Read-next su archivio [pdk]                     *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcp/fls/ioc/obj/iofpdk"
                                          to   s-pat                  .
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-pdk-tip-rec       to   srt-tip-rec            .
           move      rf-pdk-num-pro       to   srt-num-pro            .
           move      rf-pdk-cod-arc       to   srt-cod-arc            .
      *                  *---------------------------------------------*
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
       stp-srt-inp-pdk-700.
      ...
      *              *-------------------------------------------------*
           perform   agg-rec-pdk-000      thru agg-rec-pdk-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       agg-rec-pdk-000.
      *              *-------------------------------------------------*
      *              * Composizione chiave [pdk]                       *
      *              *-------------------------------------------------*
           move      srt-tip-rec          to   rf-pdk-tip-rec         .
           move      srt-num-pro          to   rf-pdk-num-pro         .
           move      srt-cod-arc          to   rf-pdk-cod-arc         .
       agg-rec-pdk-100.
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
