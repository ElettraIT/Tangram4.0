      ...
      *                                   Fase:    nobmgt              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 02/05/01    *
      *                       Ultima revisione:    NdK del 16/02/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [mgi]                    *
      *                                                                *
      *                    Sistemazione errore post pulizie - NOBILI   *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "cnv/cnv/fls/ioc/obj/iofwgi"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-mgt-dat-reg       to   rf-wgi-dat-reg         .
           move      rf-mgt-num-prt       to   rf-wgi-num-prt         .
           move      "cnv/cnv/fls/ioc/obj/iofwgi"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-800.
      *              *-------------------------------------------------*
      *              * Riciclo a record [mgt] successivo               *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-200.
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      ...
      *              * Aggiornamento [mgi]                             *
      *              *-------------------------------------------------*
           perform   agg-rec-mgi-000      thru agg-rec-mgi-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              * Ripresa record                                  *
      *              *-------------------------------------------------*
           move      srt-rec-wgi          to   rf-wgi                 .
      *              *-------------------------------------------------*
      *              * Da [wgi] a [mgi]                                *
      *              *-------------------------------------------------*
           move      spaces               to   rf-mgi                 .
           move      rf-wgi-tip-rec       to   rf-mgi-tip-rec         .
           move      rf-wgi-dat-reg       to   rf-mgi-dat-reg         .
           move      rf-wgi-num-prt       to   rf-mgi-num-prt         .
           move      rf-wgi-dat-doc       to   rf-mgi-dat-doc         .
           move      rf-wgi-num-doc       to   rf-mgi-num-doc         .
           move      rf-wgi-cod-num       to   rf-mgi-cod-num         .
           move      rf-wgi-prt-iva       to   rf-mgi-prt-iva         .
           move      rf-wgi-cod-cau       to   rf-mgi-cod-cau         .
           move      rf-wgi-tip-iva       to   rf-mgi-tip-iva         .
      *
           move      rf-wgi-ibl-iva (1)   to   rf-mgi-ibl-iva (1)     .          
           move      rf-wgi-cod-iva (1)   to   rf-mgi-cod-iva (1)     .          
           move      rf-wgi-imp-iva (1)   to   rf-mgi-imp-iva (1)     .          
      *
           move      rf-wgi-ibl-iva (2)   to   rf-mgi-ibl-iva (2)     .          
           move      rf-wgi-cod-iva (2)   to   rf-mgi-cod-iva (2)     .          
           move      rf-wgi-imp-iva (2)   to   rf-mgi-imp-iva (2)     .          
      *
           move      rf-wgi-ibl-iva (3)   to   rf-mgi-ibl-iva (3)     .          
           move      rf-wgi-cod-iva (3)   to   rf-mgi-cod-iva (3)     .          
           move      rf-wgi-imp-iva (3)   to   rf-mgi-imp-iva (3)     .          
      *
           move      rf-wgi-ibl-iva (4)   to   rf-mgi-ibl-iva (4)     .          
           move      rf-wgi-cod-iva (4)   to   rf-mgi-cod-iva (4)     .          
           move      rf-wgi-imp-iva (4)   to   rf-mgi-imp-iva (4)     .          
      *
           move      rf-wgi-ibl-iva (5)   to   rf-mgi-ibl-iva (5)     .          
           move      rf-wgi-cod-iva (5)   to   rf-mgi-cod-iva (5)     .          
           move      rf-wgi-imp-iva (5)   to   rf-mgi-imp-iva (5)     .          
      *
           move      rf-wgi-ibl-iva (6)   to   rf-mgi-ibl-iva (6)     .          
           move      rf-wgi-cod-iva (6)   to   rf-mgi-cod-iva (6)     .          
           move      rf-wgi-imp-iva (6)   to   rf-mgi-imp-iva (6)     .          
      *
           move      rf-wgi-tot-doc       to   rf-mgi-tot-doc         .
           move      rf-wgi-cod-arc       to   rf-mgi-cod-arc         .
           move      rf-wgi-flg-gio       to   rf-mgi-flg-gio         .
           move      rf-wgi-flg-cop       to   rf-mgi-flg-cop         .
           move      rf-wgi-flg-rfp       to   rf-mgi-flg-rfp         .
           move      rf-wgi-cod-fbd       to   rf-mgi-cod-fbd         .
           move      rf-wgi-sgl-num       to   rf-mgi-sgl-num         .
           move      rf-wgi-dat-acq       to   rf-mgi-dat-acq         .
           move      rf-wgi-alx-exp       to   rf-mgi-alx-exp         .
       cmp-rec-mgi-999.
           exit.
