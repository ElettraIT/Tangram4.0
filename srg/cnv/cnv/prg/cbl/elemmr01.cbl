      ...
      *                                   Fase:    elemmr              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 22/06/21    *
      *                       Ultima revisione:    NdK del 22/06/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ricalcolo saldi Maggio 2021 [mmv] : ele     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Ricalcolo saldi Maggio 2021 [mmv] : ele"       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Ricalcolo saldi [mmv] Maggio 2021       "  .
      ...
      *        *-------------------------------------------------------*
      *        * Comodi per totali prodotto                            *
      *        *-------------------------------------------------------*
           05  w-wrk-qtv-mns              pic s9(08)v9(03)            .
           05  w-wrk-vlv-mns              pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Comodi per editing                                    *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna riga magazzino entro i limiti assegnati !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Selezione su data registrazione                 *
      *              *-------------------------------------------------*
           if        rf-mmr-dat-reg       <    1210501
                     go to prn-sel-rec-900.
           if        rf-mmr-dat-reg       >    1210531
                     go to prn-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su causale                            *
      *              *-------------------------------------------------*
           if        rf-mmr-cod-cau       not  = 00100
                     go to prn-sel-rec-900.
       prn-sel-rec-800.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-mmr-tip-mag       to   w-rot-l01-tip-mag      .
           move      rf-mmr-num-mag       to   w-rot-l01-num-mag      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione totali prodotto                 *
      *              *-------------------------------------------------*
           move      zero                 to   w-wrk-qtv-mns          .
           move      zero                 to   w-wrk-vlv-mns          .
       prn-ini-lr1-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      121                  to   rf-mmv-ann-ese         .
           move      w-rot-l01-tip-mag    to   rf-mmv-tip-mag         .
           move      w-rot-l01-num-mag    to   rf-mmv-num-mag         .
           move      "pgm/mag/fls/ioc/obj/iofmmv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      w-wrk-qtv-mns        to   rf-mmv-qtv-mns (05)    .
           move      w-wrk-vlv-mns        to   rf-mmv-vlv-mns (05)    .
      *                  *---------------------------------------------*
      *                  * Update record [mmv]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Accumulo totali prodotto                        *
      *              *-------------------------------------------------*
           add       rf-mmr-qta-mov       to   w-wrk-qtv-mns          .
           add       rf-mmr-val-mov       to   w-wrk-vlv-mns          .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
