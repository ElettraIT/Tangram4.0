      ...
      *                                   Fase:    elexft              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 08/08/20    *
      *                       Ultima revisione:    NdK del 08/08/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento data caricamento file [xfr]   *
      *                                                                *
      *                    STANDARD                                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento data caricamento - [xfr] "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione nome file senza estensione 'p7m'   *
      *        *-------------------------------------------------------*
           05  w-det-nom-xml.
               10  w-det-nom-xml-nom      pic  x(40)                  .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Aggiornamento data caricamento          "  .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-050.
      *              *-------------------------------------------------*
      *              * Nome file con eventuale estenzione '.p7m'       *
      *              *-------------------------------------------------*
           move      rf-xft-nom-xml       to   w-det-nom-xml-nom      .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Ciclo di update [xfr]                           *
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "NOMXML    "         to   f-key                  .
           move      w-det-nom-xml-nom    to   rf-xfr-nom-xml         .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [xfr]              *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "pgm/scf/fls/ioc/obj/iofxfr"
                                          to   s-pat                  .
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rf-xfr-nom-xml       =    w-det-nom-xml-nom
      ...
      *              * Aggiornamento data caricamento                  *
      *              *-------------------------------------------------*
           move      rf-xft-dat-car       to   rf-xfr-dat-car         .
       prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Update record [xfr]                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      12                   to   v-lin                  .
           move      10                   to   v-pos                  .
           move      w-det-nom-xml-nom    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           move      "Righe fatture fornitori [xft] - ABB"
