      ...
      *                                   Fase:    ptulst              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 16/02/21    *
      *                       Ultima revisione:    NdK del 17/11/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [lst]                    *
      *                                                                *
      *                    Ripristino listino 210 - Keestrak - ptu     *
      *                                                                *
      *                    NOTE OPERATIVE                              *
      *                    Per recuperare dati da una copia bisogna    *
      *                    creare un rfw__ e un iofw__ del file ori-   *
      *                    ginale in cnv e copiare il file in AZI con  *
      *                    il nome w__                                 *
      *                                                                *
      *                    NON UTILIZZATO !!!                          *
      *                                                                *
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Ripristino listino 210 - Keestrak       "  .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "cnv/cnv/fls/ioc/obj/iofwst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      01                   to   rf-wst-tip-rec         .
           move      "210"                to   rf-wst-cod-wst         .
      ...
      *              *-------------------------------------------------*
           if        rf-wst-tip-rec       >    01
                     go to stp-srt-inp-900.
           if        rf-wst-cod-wst       not  = "210"
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *                  * Record di sort                              *
      *                  *---------------------------------------------*
           move      rf-wst-tip-rec       to   srt-tip-rec            .
           move      rf-wst-cod-wst       to   srt-cod-wst            .
           move      rf-wst-cod-cli       to   srt-cod-cli            .
           move      rf-wst-sgl-vlt       to   srt-sgl-vlt            .
           move      rf-wst-num-pro       to   srt-num-pro            .
           move      rf-wst               to   srt-rec-wst            .
      *                  *---------------------------------------------*
      ...
      *                  * Campi chiave                                *
      *                  *---------------------------------------------*
           move      rf-wst-tip-rec       to   rf-lst-tip-rec         .
           move      rf-wst-cod-wst       to   rf-lst-cod-lst         .
           move      rf-wst-cod-cli       to   rf-lst-cod-cli         .
           move      "EUR"                to   rf-lst-sgl-vlt         .
           move      rf-wst-num-pro       to   rf-lst-num-pro         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      2                    to   rf-lst-dec-vlt         .
           move      rf-wst-prz-wst       to   rf-lst-prz-lst         .
           move      rf-wst-per-pvg (1)   to   rf-lst-per-pvg (1)     .
           move      rf-wst-per-pvg (2)   to   rf-lst-per-pvg (2)     .
           move      rf-wst-per-pvg (3)   to   rf-lst-per-pvg (3)     .
           move      rf-wst-per-sco (1)   to   rf-lst-per-sco (1)     .
           move      rf-wst-per-sco (2)   to   rf-lst-per-sco (2)     .
           move      rf-wst-per-sco (3)   to   rf-lst-per-sco (3)     .
           move      rf-wst-per-sco (4)   to   rf-lst-per-sco (4)     .
           move      rf-wst-per-sco (5)   to   rf-lst-per-sco (5)     .
           move      rf-wst-snx-prz       to   rf-lst-snx-prz         .
           move      rf-wst-snx-pvg       to   rf-lst-snx-pvg         .
           move      rf-wst-snx-sco       to   rf-lst-snx-sco         .
           move      rf-wst-dva-ini       to   rf-lst-dva-ini         .
           move      rf-wst-dva-fin       to   rf-lst-dva-fin         .
           move      rf-wst-qta-rif       to   rf-lst-qta-rif         .
           move      rf-wst-alx-exp       to   rf-lst-alx-exp         .
       cmp-rec-lst-999.
           exit.
