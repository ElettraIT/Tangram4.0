      ...
      *                                   Fase:    siragb              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/05/23    *
      *                       Ultima revisione:    NdK del 22/09/24    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento files [hox] : SIRI            *
      *                                                                *
      *                    Clonazione file [hox] in [hbc]              *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-wrk.
      *        *-------------------------------------------------------*
      *        * Comodo per composizione nuovo codice ubicazione       *
      *        *-------------------------------------------------------*
           05  w-wrk-ubi-new              pic  x(07)                  .
      *        *-------------------------------------------------------*
      *        * Contatore generico                                    *
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sir/agb/fls/ioc/obj/iofhox"
                                          to   s-pat                  .
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      rf-hox-num-prt       to   srt-num-prt            .
           move      rf-hox-num-pro       to   srt-num-pro            .
           move      rf-hox-num-spl       to   srt-num-spl            .
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      rf-hox-ide-dat       to   srt-ide-dat            .
           move      rf-hox-ide-ute       to   srt-ide-ute            .
           move      rf-hox-ide-fas       to   srt-ide-fas            .
           move      rf-hox-qta-spl       to   srt-qta-spl            .
           move      rf-hox-dat-bcd       to   srt-dat-bcd            .
           move      rf-hox-ann-spl       to   srt-ann-spl            .
           move      rf-hox-pth-img       to   srt-pth-img            .
           move      rf-hox-flg-del       to   srt-flg-del            .
           move      rf-hox-num-bnc       to   srt-num-bnc            .
           move      rf-hox-sgl-bnc       to   srt-sgl-bnc            .
           move      rf-hox-prt-ods       to   srt-prt-ods            .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-800.
      *              *-------------------------------------------------*
      *              * Riciclo su lettura sequenziale record [hox]     *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Composizione record [hbc] attuale                         *
      *    *-----------------------------------------------------------*
       cmp-rec-hbc-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-num-pro          to   rf-hbc-num-pro         .
           move      srt-num-spl          to   rf-hbc-num-spl         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      srt-ide-dat          to   rf-hbc-ide-dat         .
           move      srt-ide-ute          to   rf-hbc-ide-ute         .
           move      srt-ide-fas          to   rf-hbc-ide-fas         .
           move      srt-qta-spl          to   rf-hbc-qta-spl         .
      *
           move      srt-dat-bcd 
                    (01 : 80)             to   rf-hbc-sez-bcd (1)     .
           move      srt-dat-bcd 
                    (81 : 80)             to   rf-hbc-sez-bcd (2)     .
           move      srt-dat-bcd 
                    (161 : 80)            to   rf-hbc-sez-bcd (3)     .
           move      srt-dat-bcd 
                    (241 : 16)            to   rf-hbc-sez-bcd (4)     .
           move      spaces               to   rf-hbc-sez-bcd (5)     .
           move      spaces               to   rf-hbc-sez-bcd (6)     .
      *
           move      srt-ann-spl          to   rf-hbc-ann-spl         .
           move      srt-pth-img          to   rf-hbc-pth-img         .
           move      srt-flg-del          to   rf-hbc-flg-del         .
           move      srt-num-bnc          to   rf-hbc-num-bnc         .
           move      srt-sgl-bnc          to   rf-hbc-sgl-bnc         .
           move      srt-prt-ods          to   rf-hbc-prt-ods         .
           move      srt-alx-exp          to   rf-hbc-alx-exp         .
       cmp-rec-hbc-999.
           exit.
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-hbc-000      thru cmp-rec-hbc-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
