      ...
      *                                   Fase:    elebfr              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 11/04/23    *
      *                       Ultima revisione:    NdK del 11/04/23    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Update righe per flag nbx                   *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      12300000000          to   rf-bfr-num-prt         .
      ...
      *              * Test su flag                                    *
      *              *-------------------------------------------------*
           if        rf-bfr-flg-nbx (03)  =    spaces
                     go to prn-liv-det-500.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Normalizzazione flag                            *
      *              *-------------------------------------------------*
           move      spaces               to   rf-bfr-flg-nbx (03)    .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [bfr]                             *
      *              *-------------------------------------------------*
