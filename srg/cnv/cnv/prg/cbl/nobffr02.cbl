      ...
      *                       Ultima revisione:    NdK del 16/09/19    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Correzione descrizioni in riga - NOBILI     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Correzione righe fattura : NOBILI    "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1190101              to   rf-ffr-dat-reg         .
           move      04                   to   rf-ffr-tip-mag         .
      ...
      *              * Test su tipo riga                               *
      *              *-------------------------------------------------*
           if        rf-ffr-tip-rig       not  = "V    "
                     go to prn-liv-det-320.
      *              *-------------------------------------------------*
      *              * Test su tipo descrizione                        *
      *              *-------------------------------------------------*
           if        rf-ffr-des-ext       not  = 0
                     go to prn-liv-det-320.
      *              *-------------------------------------------------*
      *              * Normalizzazione [mtv]                           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rf-mtv-des-mtv       =    rf-ffr-des-rig
                     go to prn-liv-det-320.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Aggiornamento descrizione                       *
      *              *-------------------------------------------------*
           move      rf-mtv-des-mtv       to   rf-ffr-des-rig         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [ffr]                             *
      *              *-------------------------------------------------*
