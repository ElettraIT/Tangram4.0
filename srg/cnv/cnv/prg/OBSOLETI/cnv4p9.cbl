      ...
      *                                   Fase:    cnv4p9              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/05/18    *
      *                       Ultima revisione:    NdK del 05/05/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Conversione per versione 4.9                *
      *                                                                *
      *                    ------------------------------------------- *
      *                                                                *
      *                    Aggiornamento file [pdx] : aggiunta chiave  *
      *                                                                *
      *                    ___ MAI USATO PER PROBLEMI CON RPRIVILEGI   *
      *                                                                *
      *================================================================*
      ...
      *    * File Control [pdx]                                        *
      *    *-----------------------------------------------------------*
           select  optional  pdx   assign to disk           f-pdx-pat
                             organization is indexed
                             access mode  is dynamic
                             record key   is pdx-k01
                             file status  is                f-pdx-sts .
      ...
      *    *===========================================================*
      *    * File Description [pdx]                                    *
      *    *-----------------------------------------------------------*
       fd  pdx       label record standard                            .
      ...
      *            *---------------------------------------------------*
               10  pdx-k01.
                   15  pdx-tip-rec        pic  9(02)                  .
                   15  pdx-cod-arc        pic  9(07)       comp-3     .
                   15  pdx-cod-lng        pic  x(03)                  .
                   15  pdx-cod-num        pic  9(07)       comp-3     .
                   15  pdx-for-mat        pic  x(14)                  .
                   15  pdx-num-prg        pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  pdx-dat.
               10  pdx-des-pro            pic  x(40)                  .
      ...
      *    *-----------------------------------------------------------*
       01  f-pdx.
           05  f-pdx-nam                  pic  x(04)                  .
           05  f-pdx-pat                  pic  x(40)                  .
           05  f-pdx-sts                  pic  x(02)                  .
      ...
      *              * Conversione [pdx]                               *
      *              *-------------------------------------------------*
           perform   exe-cnv-pdx-000      thru exe-cnv-pdx-999        .
       exe-cnv-fil-800.
      *              *-------------------------------------------------*
      ...
      *              * Start su [old-pdx]                              *
      *              *-------------------------------------------------*
           move      low-values           to   pdx-k01                .
           start     pdx    key not less
                            pdx-k01
                            invalid key
                            go to exe-cnv-pdx-800.
       exe-cnv-pdx-250.
      *              *-------------------------------------------------*
      *              * Next su [old-pdx]                               *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-cnv-pdx-300.
      *              *-------------------------------------------------*
      *              * Normalizzazione preliminare [new-pdx]           *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      f-xxx-obj            to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      pdx-tip-rec          to   rf-pdx-tip-rec         .
           move      pdx-cod-arc          to   rf-pdx-cod-arc         .
           move      pdx-cod-lng          to   rf-pdx-cod-lng         .
           move      pdx-cod-num          to   rf-pdx-cod-num         .
           move      pdx-for-mat          to   rf-pdx-for-mat         .
           move      pdx-num-prg          to   rf-pdx-num-prg         .
           move      pdx-des-pro          to   rf-pdx-des-pro         .
       exe-cnv-pdx-700.
      *              *-------------------------------------------------*
      *              * Scrittura [new-pdx]                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-cnv-pdx-900.
      *              *-------------------------------------------------*
      *              * Delete file [old-pdx] e scrittura rullino       *
      *              * messaggi                                        *
      *              *-------------------------------------------------*
