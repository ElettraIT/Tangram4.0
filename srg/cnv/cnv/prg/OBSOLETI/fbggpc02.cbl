      ...
      *                  *---------------------------------------------*
           ...
           move      w-rot-l01-prt-fcl    to   rf-fit-num-prt         .
           move      "pgm/fat/fls/ioc/obj/ioffit"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-fit                 .
      *                  *---------------------------------------------*
      *                  * Test se record [fit] trovato                *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-ini-lr1-999.
      *                  *---------------------------------------------*
      *                  * Test se record [fit] gia' aggiornato        *
      *                  *---------------------------------------------*
           if        rf-fit-flg-blx (2)   not  = spaces
                     go to prn-ini-lr1-200.
      *                  *---------------------------------------------*
      *                  * Aggiornamento flag provvigioni              *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-fit                 .
      *              *-------------------------------------------------*
      *              * Incremento contatore elementi aggiornati        *
      *              *-------------------------------------------------*
