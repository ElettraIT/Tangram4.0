      ...
      *                       Ultima revisione:    NdK del 24/10/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento nomenclatura combinata        *
      *                                                                *
      *                    Foralberg                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Aggiornamento Nomenclatura Combinata  "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione Nomenclatura Combinata      "  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Test se gia' assegnata la nomenclatura          *
      *              *-------------------------------------------------*
           if        rf-dcp-cdn-cdm       not  = zero
                     go to prn-liv-det-300.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione della classe             *
      *              *-------------------------------------------------*
           if        rf-dcp-cla-pro       =    00001
                     move  69111000       to   rf-dcp-cdn-cdm
           else if   rf-dcp-cla-pro       =    00002
                     move  73239310       to   rf-dcp-cdn-cdm
           else if   rf-dcp-cla-pro       =    00003
                     move  82159990       to   rf-dcp-cdn-cdm
           else if   rf-dcp-cla-pro       =    00004
                     move  70132999       to   rf-dcp-cdn-cdm
           else if   rf-dcp-cla-pro       =    00005
                     move  44190090       to   rf-dcp-cdn-cdm
           else if   rf-dcp-cla-pro       =    00006
                     move  82119180       to   rf-dcp-cdn-cdm
           else if   rf-dcp-cla-pro       =    00007
                     move  73239910       to   rf-dcp-cdn-cdm
           else if   rf-dcp-cla-pro       =    00008
                     move  62113210       to   rf-dcp-cdn-cdm
           else if   rf-dcp-cla-pro       =    00009
      ...
      *              * Classe 9                                        *
      *              *-------------------------------------------------*
           if        rf-dcp-gru-pro       =    00100
                     move  85144000       to   rf-dcp-cdn-cdm
           else if   rf-dcp-gru-pro       =    00110
                     move  85144000       to   rf-dcp-cdn-cdm
           else if   rf-dcp-gru-pro       =    00120
                     move  94036010       to   rf-dcp-cdn-cdm
           else if   rf-dcp-gru-pro       =    00130
                     move  84183099       to   rf-dcp-cdn-cdm
           else if   rf-dcp-gru-pro       =    00140
                     move  39241000       to   rf-dcp-cdn-cdm
           else if   rf-dcp-gru-pro       =    00150
                     move  90160010       to   rf-dcp-cdn-cdm
           else if   rf-dcp-gru-pro       =    00160
                     move  94032099       to   rf-dcp-cdn-cdm
           else      go to prn-liv-det-300.
           go to     prn-liv-det-200.
       prn-liv-det-200.
      *              *-------------------------------------------------*
