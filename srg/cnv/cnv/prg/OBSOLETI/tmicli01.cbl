      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [dcc] e [cli] : TEMI     *
      *                                                                *
      *                    Aggiornamento clienti per nuove provincie   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento file [dcc] - [cli] - TEMI "       .
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-buf-not-g03              pic  x(40)                  .
           05  w-buf-num-tel              pic  x(20)                  .
           05  w-buf-tel-alt              pic  x(20)                  .
           05  w-buf-nom-int              pic  x(30)                  .
           05  w-buf-int-alt              pic  x(30)                  .
           05  w-buf-num-fax              pic  x(20)                  .
           05  w-buf-num-tlx              pic  x(20)                  .
           05  w-buf-num-ptp              pic  x(20)                  .
           05  w-buf-num-ptf              pic  x(20)                  .
           05  w-buf-tel-mdm              pic  x(20)                  .
           05  w-buf-idn-ema              pic  x(20)                  .
           05  w-buf-cod-abi              pic  9(05)                  .
           05  w-buf-cod-cab              pic  9(05)                  .
           05  w-buf-ccc-app              pic  x(12)                  .
           05  w-buf-cod-cin              pic  x(01)                  .
           05  w-buf-nos-bpe              pic  x(10)                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se esistono codici [geo]                    *
      *                  *---------------------------------------------*
           if        rf-dcc-cod-cmn       =    zero
                     go to prn-liv-det-800.
           if        rf-dcc-cod-fzn       not  = zero or
                     rf-dcc-cod-fzn       not  = zero
                     go to prn-liv-det-800.
      *                  *---------------------------------------------*
      *                  * Normalizzazione [gxc]                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-gxc-cod-prv       =    "BI" or
                     rf-gxc-cod-prv       =    "LC" or
                     rf-gxc-cod-prv       =    "LO" or
                     rf-gxc-cod-prv       =    "RN" or
                     rf-gxc-cod-prv       =    "PO" or
                     rf-gxc-cod-prv       =    "KR" or
                     rf-gxc-cod-prv       =    "VV" or
                     rf-gxc-cod-prv       =    "VB"
                     go to prn-liv-det-200
           else      go to prn-liv-det-800.
       prn-liv-det-200.
      *                  *---------------------------------------------*
      *                  * Riassemblaggio localita'                    *
      *                  *---------------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      rf-gxc-cap-avp       to   w-all-str-cat (1)      .
           move      rf-gxc-des-cfl       to   w-all-str-cat (2)      .
           move      rf-gxc-cod-prv       to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Trattamento record [cli]                        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura record                              *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Nuova stringa localita'                     *
      *                  *---------------------------------------------*
           move      w-all-str-alf        to   rf-cli-loc-cli         .
      *                  *---------------------------------------------*
      *                  * Aggiornamento mnemonico                     *
      *                  *---------------------------------------------*
           if        rf-cli-cod-mne (10 : 1)
                                          =    spaces
                     go to prn-liv-det-400.
           if        rf-gxc-cod-prv (1 : 2)
                                          =    spaces
                     go to prn-liv-det-400.
           move      rf-gxc-cod-prv (1 : 2)
                                          to   rf-cli-cod-mne (4 : 2) .
           move      w-all-str-alf        to   rf-cli-loc-cli         .
       prn-liv-det-400.
      *                  *---------------------------------------------*
      *                  * Aggiornamento record file [cli]             *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
           move      "pgm/cge/fls/ioc/obj/iofcli"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Trattamento record [dcc]                        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Nuova stringa localita'                     *
      *                  *---------------------------------------------*
           move      w-all-str-alf        to   rf-dcc-loc-dcc         .
      *                  *---------------------------------------------*
      *                  * Update record [dcc]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
