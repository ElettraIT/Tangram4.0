      ...
      *                                   Fase:    nobsdb              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 22/11/10    *
      *                       Ultima revisione:    NdK del 26/11/15    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Forzatura riscossione per alcune scadenze   *
      *                                                                *
      *                    NOBILI                                      *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      0000115              to   rf-sdb-cod-dbt         .
      ...
      *              *-------------------------------------------------*
           if        rf-sdb-cod-dbt       not  = 0000115
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test su numeri scadenza                         *
      *              *-------------------------------------------------*
           if        rf-sdb-num-sdb       not  = 11400001792 and
                     rf-sdb-num-sdb       not  = 11400002213 and
                     rf-sdb-num-sdb       not  = 11400002690 and
                     rf-sdb-num-sdb       not  = 11400003119 and
                     rf-sdb-num-sdb       not  = 11400003538 and
                     rf-sdb-num-sdb       not  = 11400003935 and
                     rf-sdb-num-sdb       not  = 11400004348 and
                     rf-sdb-num-sdb       not  = 11400004753 and
                     rf-sdb-num-sdb       not  = 11500000080
                     go to prn-liv-det-300.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Forzature                                       *
      *              *-------------------------------------------------*
           move      rf-sdb-dts-sdb       to   rf-sdb-dtr-ris         .
           move      01                   to   rf-sdb-mod-ris         .
           move      11500099999          to   rf-sdb-num-ris         .
           move      rf-sdb-imp-sdb       to   rf-sdb-imp-ris         .
           move      01                   to   rf-sdb-aos-ris         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [sdb]                             *
      *              *-------------------------------------------------*
