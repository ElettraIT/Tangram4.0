      ...
      *                                   Fase:    elemgr              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 02/08/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Contatore righe [mgr] con importi inferiori *
      *                    alla 20 lire                                *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Contatore righe Prima Nota - importi <20"       .
      ...
      *        * Contatori generici                                    *
      *        *-------------------------------------------------------*
           05  w-ctr-tot-rig              pic  9(09)                  .
           05  w-ctr-tot-m20              pic  9(09)                  .
           05  w-ctr-saa-rig              pic  9(09)                  .
           05  w-ctr-saa-m20              pic  9(09)                  .
           05  w-ctr-imp-mgr              pic  9(13)                  .
           05  w-ctr-ann-alf              pic  x(04)                  .
           05  w-ctr-ct1-alf              pic  x(09)                  .
           05  w-ctr-ct2-alf              pic  x(09)                  .
           05  w-ctr-ct3-alf              pic  x(05)                  .
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           ...
           move      s-saa                to   w-rot-l01-saa-reg      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-ctr-tot-rig          .
           move      zero                 to   w-ctr-tot-m20          .
       prn-ini-cic-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-ctr-tot-rig        to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-ctr-ct1-alf          .
      *              *-------------------------------------------------*
      *              * Editing contatore righe < 20                    *
      *              *-------------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      09                   to   p-car                  .
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-ctr-tot-m20        to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-ctr-ct2-alf          .
      *              *-------------------------------------------------*
      *              * Editing %                                       *
      *              *-------------------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           move      "<B"                 to   p-edm                  .
           move      w-ctr-tot-m20        to   p-num                  .
           divide    w-ctr-tot-rig        into p-num                  .
           multiply  100                  by   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-ctr-ct3-alf          .
      *              *-------------------------------------------------*
      *              * Preparazione messaggio                          *
      *              *-------------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      "RIGHE TOTALI [mgr]     :"
                                          to   w-all-str-cat (1)      .
           move      w-ctr-ct1-alf        to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      "RIGHE CON IMPORTO < 20 :"
                                          to   w-all-str-cat (1)      .
           move      w-ctr-ct2-alf        to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *              *-------------------------------------------------*
      *              * Messaggio                                       *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "RAPPORTO %             :"
                                          to   w-all-str-cat (1)      .
           move      w-ctr-ct3-alf        to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *              *-------------------------------------------------*
      *              * Messaggio                                       *
      *              *-------------------------------------------------*
      ...
      *              * Normalizzazione contatori                       *
      *              *-------------------------------------------------*
           move      zero                 to   w-ctr-saa-rig          .
           move      zero                 to   w-ctr-saa-m20          .
      *              *-------------------------------------------------*
      *              * Editing anno in corso trattamento               *
      *              *-------------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      04                   to   p-car                  .
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-rot-l01-saa-reg    to   p-num                  .
           add       1900                 to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-ctr-ann-alf          .
      *              *-------------------------------------------------*
      *              * Preparazione messaggio                          *
      *              *-------------------------------------------------*
           move      80                   to   w-all-str-lun          .
           ...
           move      w-ctr-ann-alf        to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *              *-------------------------------------------------*
      *              * Separatore                                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "<B"                 to   p-edm                  .
           move      w-ctr-saa-m20        to   p-num                  .
           divide    w-ctr-saa-rig        into p-num                  .
           multiply  100                  by   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-ctr-ct3-alf          .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Aggiornamento contatori importi                 *
      *              *-------------------------------------------------*
           move      rf-mgr-imp-mov       to   w-ctr-imp-mgr          .
           if        w-ctr-imp-mgr        not > 20
                     add 1                to   w-ctr-tot-m20
                     add 1                to   w-ctr-saa-m20          .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Aggiornamento contatori righe                   *
      *              *-------------------------------------------------*
           add       1                    to   w-ctr-tot-rig          .
           add       1                    to   w-ctr-saa-rig          .
      *              *-------------------------------------------------*
