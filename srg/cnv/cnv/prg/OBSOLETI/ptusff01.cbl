      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento data registrazione fatture    *
      *                    fornitori                                   *
      *                                                                *
      *                    N.B.: integrare con 'ptusff02'              *
      *                                                                *
      *                    PERONTECNICI                                *
      *                                                                *
      *                    ___ moi --> mgi ___                         *
      ...
      *            *---------------------------------------------------*
               10  srt-drg-cge            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Numero registrazione contabile                    *
      *            *---------------------------------------------------*
               10  srt-npr-cge            pic  9(07)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Aggiornamento Fatture fornitori - ptu "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione progressivo                        *
      *        *-------------------------------------------------------*
           05  w-det-num-prg.
               10  w-det-num-prg-num      pic  9(05)                  .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Aggiornamento data registraz. contabile "  .
      ...
      *              *-------------------------------------------------*
           ...
           move      1180301              to   rf-sff-ide-dat         .
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-sff-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [sff]                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su data registrazione contabile        *
      *                  *---------------------------------------------*
           if        rf-sff-drg-cge       not  = 1180309
      ...
      *                  *---------------------------------------------*
      *                  * Chiave e dati per il sort                   *
      *                  *---------------------------------------------*
           move      rf-sff-num-ftf       to   srt-num-ftf            .
           move      rf-sff-drg-cge       to   srt-drg-cge            .
           move      rf-sff-npr-cge       to   srt-npr-cge            .
       stp-srt-inp-sff-700.
      *                  *---------------------------------------------*
      ...
      *
       ...
       stp-srt-inp-sff-800.
      *                  *---------------------------------------------*
      *                  * Riciclo a record [sff] successivo           *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-sff-200.
       stp-srt-inp-sff-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-srt-num-prg        to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Sopralineatura messaggio di fine esecuzione     *
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      all "-"              to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
      ...
      *              * Aggiornamenti                                   *
      *              *-------------------------------------------------*
           perform   agg-rec-sff-000      thru agg-rec-sff-999        .
           perform   agg-rec-mgt-000      thru agg-rec-mgt-999        .
           perform   agg-rec-mgr-000      thru agg-rec-mgr-999        .
           perform   agg-rec-moi-000      thru agg-rec-moi-999        .
      *              *-------------------------------------------------*
      *              * Editing protocollo                              *
      *              *-------------------------------------------------*
           move      "ED"                 to   p-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-num-ftf          to   rf-sff-num-ftf         .
           move      "pgm/scf/fls/ioc/obj/iofsff"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Data registrazione                          *
      *                  *---------------------------------------------*
           move      1180228              to   rf-sff-dtr-ftf         .
      *                  *---------------------------------------------*
      *                  * Data registrazione contabile                *
      *                  *---------------------------------------------*
           move      1180228              to   rf-sff-drg-cge         .
       agg-rec-sff-400.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-drg-cge          to   rf-mgt-dat-reg         .
           move      srt-npr-cge          to   rf-mgt-num-prt         .
           move      "pgm/cge/fls/ioc/obj/iofmgt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-mgt                 .
           if        f-sts                not  = e-not-err
                     go to agg-rec-mgt-900.
      *              *-------------------------------------------------*
      *              * Nuova data registrazione                        *
      *              *-------------------------------------------------*
           move      1180228              to   rf-mgt-dat-reg         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       agg-rec-mgr-000.
      *              *-------------------------------------------------*
      *              * Ciclo per 'n' progressivi                       *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-num-prg-num      .
       agg-rec-mgr-200.
           add       00100                to   w-det-num-prg-num      .
           if        w-det-num-prg-num    >    00800
                     go to agg-rec-mgr-900.
       agg-rec-mgr-400.
      *              *-------------------------------------------------*
      *              * Normalizzazione record                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "DATREG"             to   f-key                  .
           move      srt-drg-cge          to   rf-mgr-dat-reg         .
           move      srt-npr-cge          to   rf-mgr-num-prt         .
           move      w-det-num-prg-num    to   rf-mgr-num-prg         .
           move      "pgm/cge/fls/ioc/obj/iofmgr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-mgr                 .
           if        f-sts                not  = e-not-err
                     go to agg-rec-mgr-800.
      *              *-------------------------------------------------*
      *              * Nuova data registrazione                        *
      *              *-------------------------------------------------*
           move      1180228              to   rf-mgr-dat-reg         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
       ...
       agg-rec-mgr-800.
      *              *-------------------------------------------------*
      *              * Riciclo su progressivo                          *
      *              *-------------------------------------------------*
           go to     agg-rec-mgr-200.
       agg-rec-mgr-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     agg-rec-mgr-999.
       agg-rec-mgr-999.
           exit.

      *    *===========================================================*
      *    * Aggiornamento record [moi]                                *
      *    *-----------------------------------------------------------*
       agg-rec-moi-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione record                          *
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-drg-cge          to   rf-moi-dat-reg         .
           move      srt-npr-cge          to   rf-moi-num-prt         .
           move      "pgm/cge/fls/ioc/obj/iofmoi"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-moi                 .
           if        f-sts                not  = e-not-err
                     go to agg-rec-moi-900.
      *              *-------------------------------------------------*
      *              * Nuova data registrazione                        *
      *              *-------------------------------------------------*
           move      1180228              to   rf-moi-dat-reg         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
