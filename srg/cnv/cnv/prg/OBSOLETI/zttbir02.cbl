      ...
      *                                   Fase:    zttbir              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 27/07/01    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Individuazione evasione anomala : ZATTI     *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
       ...
       prn-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Test su campi di testata                        *
      *              *-------------------------------------------------*
           if        rf-bit-cod-tmb       =    "BV7  " or
                     rf-bit-cod-tmb       =    "BV8  " or
                     rf-bit-cod-tmb       =    "BV9  "
                     go to prn-sel-rec-999.
           move      "#"                  to   w-cnt-prn-flg-sub      .
       prn-sel-rec-999.
      ...
      *              * Calcolo importo                                 *
      *              *-------------------------------------------------*
           move      zero                 to   w-wrk-imp-rig          .
           multiply  rf-bir-prz-net       by   rf-bir-qta-ven
                                        giving w-wrk-imp-rig          .
           if        rf-bir-imp-rig       =    w-wrk-imp-rig
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      rf-bir-num-doc (6:6) to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-wrk-num-prt          .
      *                  *---------------------------------------------*
      *                  * Editing data registrazione                  *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "D"                  to   p-tip                  .
           move      rf-bir-dat-doc       to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-wrk-dat-reg          .
      *                  *---------------------------------------------*
      *                  * Concatenamento                              *
      *                  *---------------------------------------------*
           ...
           move      w-wrk-num-prt        to   w-all-str-cat (2)      .
           move      "del"                to   w-all-str-cat (3)      .
           move      w-wrk-dat-reg        to   w-all-str-cat (4)      .
           move      ": Prodotto -"       to   w-all-str-cat (5)      .
           move      rf-bir-alf-pro       to   w-all-str-cat (6)      .
           move      "importo da controllare"
                                          to   w-all-str-cat (7)      .
