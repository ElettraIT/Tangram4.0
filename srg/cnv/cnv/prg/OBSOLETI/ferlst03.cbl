      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento listino Negozio Ferramenta"       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Aggiornamento Listino 'N' per Negozio   "  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura per codice del listino "N"              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           ...
           call      s-pat               using f
                                               rf-lst                 .
      *                  *---------------------------------------------*
      *                  * Se record non trovato : selezione superata  *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-haf-prz-imp       to   w-det-prz-lst-prz      .
           if        w-det-prz-lst-prz    =    zero
      ...
      *                  *---------------------------------------------*
           move      spaces               to   m-msg                  .
           string    "Listino acquisto prodotto aggiornato : "
                                delimited by size
                     rf-dcp-alf-pro
                                delimited by spaces
                                          into m-msg                  .
