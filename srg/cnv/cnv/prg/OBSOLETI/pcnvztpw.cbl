      ...
      *                       Ultima revisione:    NdK del 11/05/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Password sito WEB per ZATTI da file         *
      *                    'password.txt' in /abd/asc/tmp/             *
      *                                                                *
      *                    Upgrade per anagradiche 'dcc'               *
      *                    Indice di marketing                         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Password clienti ZATTI da sito WEB   "       .
      ...
      *            * Codice cliente                                    *
      *            *---------------------------------------------------*
               10  w-lds-001-cod-cli      pic  x(07)                  .
      *            *---------------------------------------------------*
      *            * Password                                          *
      *            *---------------------------------------------------*
               10  w-lds-001-pwd-cli      pic  x(09)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      "/abd/asc/tmp/passwords.txt"
                                          to   rr-pth-inp             .
       acc-pth-inp-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      ...
      *                  *---------------------------------------------*
       ...
       xcv-trt-pds-400.
      *                  *---------------------------------------------*
      *                  * Aggiornamento del record [dcc]              *
      *                  *---------------------------------------------*
           perform   wrt-rec-dcc-000      thru wrt-rec-dcc-999        .
      *                  *---------------------------------------------*
      *                  * Incremento numero records scritti [dcc]     *
      *                  *---------------------------------------------*
           add       1                    to   w-pds-dcc              .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lds-001-pwd-cli    to   w-all-str-alf          .
           perform   all-str-asx-000      thru all-str-asx-999        .
           move      w-all-str-alf        to   rf-dcc-ind-mkt         .
       wrt-rec-dcc-300.
      *                  *---------------------------------------------*
      *                  * Aggiornamento record file [dcc]             *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
