      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Conversione ordini clienti inevasi ZATTI"       .
      ...
      *            * Data documento                                    *
      *            *---------------------------------------------------*
               10  w-cmp-rec-oct-dat      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Totale servizi                                    *
      *            *---------------------------------------------------*
               10  w-cmp-rec-oct-tot      pic s9(11)                  .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-cmp-rec-oct-wpa      pic s9(11)                  .
               10  w-cmp-rec-oct-s11      pic s9(11)                  .
               10  w-cmp-rec-oct-wpr      pic s9(11)                  .
               10  w-cmp-rec-oct-prz      pic  9(09)                  .
               10  w-cmp-rec-oct-dec      pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Work di comodo per nuova testata                  *
      *            *---------------------------------------------------*
               10  w-cmp-rec-oct-sdt      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Work per riferimenti                              *
      *            *---------------------------------------------------*
               10  w-cmp-rec-oct-ndo      pic  x(08)                  .
               10  w-cmp-rec-oct-ddo      pic  9(07)                  .
      ...
      *                  *---------------------------------------------*
           ...
           if        w-lds-000 (001:20)   =    "                  CO"
                     go to xcv-trt-pds-900.
           if        w-lds-000 (053:20)   =    "Totale x cliente    "
                     go to xcv-trt-pds-900.
           if        w-lds-000 (001:20)   =    "Ditta :  01   ZATTI "
                     go to xcv-trt-pds-900.
           if        w-lds-000 (043:20)   =    ">>>  LISTA  ORDINI C"
                     go to xcv-trt-pds-900.
      ...
      *                      *-----------------------------------------*
           move      w-lds-000 (019:05)   to   w-ord-cod-cli          .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-lds-000 (001:08)   to   w-cmp-rec-oct-ndo      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      0                    to   s-sec                  .
           move      s-dat                to   w-cmp-rec-oct-ddo      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-ord-cod-cli        to   rf-dcc-cod-cli         .
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   w-cmp-rec-oct-dat      .
      *                      *-----------------------------------------*
      ...
      *                      * Preparazione progressivo riga           *
      *                      *-----------------------------------------*
           move      zero                 to   w-cmp-rec-oct-prg      .
      *                      *-----------------------------------------*
      *                      * A scrittura riga                        *
      *                      *-----------------------------------------*
           go to     xcv-trt-pds-110.
      ...
      *              * Normalizzazione valori di uscita                *
      *              *-------------------------------------------------*
           move      zero                 to   w-cmp-rec-oct-prt      .
           move      zero                 to   w-cmp-rec-oct-doc      .
      *              *-------------------------------------------------*
      *              * Data ordine reale                               *
      *              *-------------------------------------------------*
           move      w-cmp-rec-oct-ddo    to   w-cmp-rec-oct-dat      .
           move      w-cmp-rec-oct-dat    to   s-dat                  .
           if        s-saa                not  = 097
                     go to att-nmz-doc-999.
      *              *-------------------------------------------------*
      *              * Attribuzione numero protocollo ordini clienti   *
      *              *-------------------------------------------------*
           move      w-cmp-rec-oct-dat    to   w-att-orc-prt-dat      .
           move      01                   to   w-att-orc-prt-dpz      .
           perform   att-orc-prt-000      thru att-orc-prt-999        .
      *              *-------------------------------------------------*
      *              * Attribuzione numero documento                   *
      *              *-------------------------------------------------*
           move      097                  to   w-att-orc-ndo-wsa      .
           move      01                   to   w-att-orc-ndo-wdz      .
           move      w-lds-000 (003:06)   to   w-att-orc-ndo-wpr      .
           move      w-att-orc-ndo-wnu    to   w-att-orc-ndo-num      .
      *              *-------------------------------------------------*
      *              * In campi di uscita                              *
      *              *-------------------------------------------------*
           move      w-att-orc-ndo-num    to   w-cmp-rec-oct-doc      .
           move      w-att-orc-prt-num    to   w-cmp-rec-oct-prt      .
       att-nmz-doc-999.
           exit.
      ...
      *              * Test                                            *
      *              *-------------------------------------------------*
           if        w-ord-cod-cli        =    zero
                     go to cmp-rec-oct-999.
      *              *-------------------------------------------------*
      *              * Composizione record [oct]                       *
      *              *-------------------------------------------------*
           move      "IG"                 to   s-ope                  .
           ...
           move      w-cmp-rec-oct-prt    to   rf-oct-num-prt         .
           move      "OC   "              to   rf-oct-tmo-orc         .
           move      01                   to   rf-oct-cod-dpz         .
           move      w-cmp-rec-oct-dat    to   rf-oct-dat-doc         .
           move      w-cmp-rec-oct-doc    to   rf-oct-num-doc         .
           move      s-saa                to   rf-oct-scl-ann         .
           move      spaces               to   rf-oct-sgl-num         .
           move      "C"                  to   rf-oct-tip-arc         .
           move      w-ord-cod-cli        to   rf-oct-cod-arc         .
           move      spaces               to   rf-oct-dpz-arc         .
           move      01                   to   rf-oct-tip-frn         .
           move      w-ord-cod-cli        to   rf-oct-arc-plf         .
           ...
           if        rf-dcc-inl-dcm       =    01
                     ...
                     move  01             to   rf-oct-tip-ids
           else if   rf-dcc-inl-dcm       =    03
                     move  04             to   rf-oct-tip-ids
           else      move  03             to   rf-oct-tip-ids         .
           move      w-cmp-rec-oct-ddo    to   rf-oct-ocl-dat         .
           move      w-cmp-rec-oct-ndo    to   rf-oct-ocl-num         .
           move      spaces               to   rf-oct-ocl-rif         .
           move      zero                 to   rf-oct-cod-rsp         .
           move      w-cmp-rec-oct-dat    to   rf-oct-dat-cns         .
           ...
           move      01                   to   rf-oct-inl-dcm         .
           move      01                   to   rf-oct-inl-pgt         .
           move      spaces               to   rf-oct-cod-lst         .
           move      w-ord-cod-fop        to   rf-oct-cod-fop         .
      ...
      *              *-------------------------------------------------*
           ...
           move      "OC   "              to   rf-ocr-tmo-orc         .
           move      01                   to   rf-ocr-cod-dpz         .
           move      w-cmp-rec-oct-dat    to   rf-ocr-dat-doc         .
           move      w-cmp-rec-oct-doc    to   rf-ocr-num-doc         .
           move      "C"                  to   rf-ocr-tip-arc         .
           move      w-ord-cod-cli        to   rf-ocr-cod-arc         .
           move      spaces               to   rf-ocr-dpz-arc         .
           move      "I  "                to   rf-ocr-cod-lng         .
           ...
           move      w-det-num-pro-alf    to   rf-ocr-alf-pro         .
           move      spaces               to   rf-ocr-sgl-vrn         .
           move      0                    to   rf-ocr-des-ext         .
           move      w-det-rig-ord-des    to   rf-ocr-des-rig         .
           move      1                    to   rf-ocr-tip-pro         .
           move      00020                to   rf-ocr-cod-iva         .
           move      2001001              to   rf-ocr-ctp-ven         .
           move      w-det-rig-ord-umi    to   rf-ocr-umi-ven         .
           move      0                    to   rf-ocr-dec-qta         .
           move      w-det-rig-ord-qta    to   rf-ocr-qta-ord         .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-det-rig-ord-prz    to   rf-ocr-prz-lrs         .
           move      w-det-rig-ord-prz    to   rf-ocr-prz-nts         .
           move      w-det-rig-ord-prz    to   rf-ocr-prz-net         .
           move      w-det-rig-ord-prz    to   rf-ocr-prz-ven         .
           ...
           move      w-det-rig-ord-imp    to   rf-ocr-imp-rig         .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Default per provvigioni in riga : Si    *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-cmp-rec-oct-dat    to   rf-ocr-dcn-prv         .
           move      w-cmp-rec-oct-dat    to   rf-ocr-dcn-ric         .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Valori diretti da rf-oct o rf-ocr             *
      *                  *---------------------------------------------*
           ...
           move      rf-oct-dat-doc       to   d-pvg-age-dat-rif      .
       det-ppv-rig-200.
      *                  *---------------------------------------------*
      *                  * Valori calcolati                            *
      *                  *---------------------------------------------*
