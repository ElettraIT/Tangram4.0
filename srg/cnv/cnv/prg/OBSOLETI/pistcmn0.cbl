      ...
      *                                   Fase:    istcmn              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 11/05/13    *
      *                       Ultima revisione:    NdK del 15/02/16    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Codici ISTAT Comuni e Provincie da file     *
      *                    'ISTAT.CSV' in /abd/asc/ARCHIVI/            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Codici ISTAT Comuni e Provincie da file "       .
      ...
      *        *-------------------------------------------------------*
      *        * Numero di records scritti [dcc]                       *
      *        *-------------------------------------------------------*
           05  w-pds-gxc                  pic  9(06)                  .
      *        *-------------------------------------------------------*
      ...
      *            * Codice Comune                                     *
      *            *---------------------------------------------------*
               10  w-lds-001-cod-cmn      pic  x(05)                  .
               10  w-lds-001-cod-fzn      pic  x(03)                  .
               10  w-lds-001-cod-lct      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Codice ISTAT Provincia                            *
      *            *---------------------------------------------------*
               10  w-lds-001-ist-prv      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Codice ISTAT Comune                               *
      *            *---------------------------------------------------*
               10  w-lds-001-ist-cmn      pic  x(03)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione codice Comune                      *
      *        *-------------------------------------------------------*
           05  w-det-cod-cmn.
      *            *---------------------------------------------------*
      *            * Codice Comune                                     *
      *            *---------------------------------------------------*
               ...
               10  w-det-cod-cmn-fzn      pic  9(03)                  .
               10  w-det-cod-cmn-lct      pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Codice Provincia                                  *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-enc-dcc-val-pre          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Valore post incremento                                *
      *        *-------------------------------------------------------*
           05  w-enc-dcc-val-pos          pic  9(07)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      "/abd/asc/ARCHIVI/ISTAT.CSV"
                                          to   rr-pth-inp             .
       acc-pth-inp-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      ...
      *              *-------------------------------------------------*
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Numero records scritti [dcc]   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Conversione codice Comune                   *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      05                   to   v-car                  .
           move      w-lds-001-cod-cmn    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-cod-cmn-cod      .
      *                  *---------------------------------------------*
      *                  * Conversione codice Frazione                 *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      03                   to   v-car                  .
           move      w-lds-001-cod-fzn    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-cod-cmn-fzn      .
      *                  *---------------------------------------------*
      *                  * Conversione codice Localita'                *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      03                   to   v-car                  .
           move      w-lds-001-cod-lct    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-cod-cmn-lct      .
       xcv-trt-pds-400.
      *                  *---------------------------------------------*
      *                  * Aggiornamento del record [gxc]              *
      *                  *---------------------------------------------*
           perform   wrt-rec-gxc-000      thru wrt-rec-gxc-999        .
      *                  *---------------------------------------------*
      *                  * Aggiornamento del record [gxp]              *
      *                  *---------------------------------------------*
           perform   wrt-rec-gxp-000      thru wrt-rec-gxp-999        .
      *                  *---------------------------------------------*
      *                  * Incremento numero records scritti [gxc]     *
      *                  *---------------------------------------------*
           add       1                    to   w-pds-gxc              .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-cod-cmn-cod    to   rf-gxc-cod-cmn         .
           move      w-det-cod-cmn-fzn    to   rf-gxc-cod-fzn         .
           move      w-det-cod-cmn-lct    to   rf-gxc-cod-lct         .
           move      "pgm/geo/fls/ioc/obj/iofgxc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to wrt-rec-gxc-900.
       wrt-rec-gxc-200.
      *              *-------------------------------------------------*
      *              * Se record trovato                               *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Valori da bufferizzare                      *
      *                  *---------------------------------------------*
           move      rf-gxc-cod-prv       to   w-det-cod-cmn-prv      .
      *                  *---------------------------------------------*
      *                  * Valori da aggiornare                        *
      *                  *---------------------------------------------*
           move      w-lds-001-ist-cmn    to   rf-gxc-cod-ist         .
       wrt-rec-gxc-300.
      *                  *---------------------------------------------*
      *                  * Aggiornamento record file [gxc]             *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
           move      "pgm/geo/fls/ioc/obj/iofgxc"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-cod-cmn-prv    to   rf-gxp-cod-prv         .
           move      "pgm/geo/fls/ioc/obj/iofgxp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Valori da aggiornare                        *
      *                  *---------------------------------------------*
           move      w-lds-001-ist-prv    to   rf-gxp-cod-ist         .
       wrt-rec-gxp-300.
      *                  *---------------------------------------------*
      *                  * Aggiornamento record file [gxp]             *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
           move      "pgm/geo/fls/ioc/obj/iofgxp"
                                          to   s-pat                  .
