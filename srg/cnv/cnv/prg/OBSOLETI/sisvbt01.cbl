      ...
      *                                   Fase:    sisvbt              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 06/10/08    *
      *                       Ultima revisione:    NdK del 06/10/08    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Conversione bilancio al 30/09/08 SIS        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Conversione bilancio 30/09/08 - SIS  "       .
      ...
      *                *-----------------------------------------------*
      *                * Max 170 caratteri per ogni linea di stampa    *
      *                *-----------------------------------------------*
                   15  w-pds-chr occurs 170
                                          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Area per estrazioni                                   *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Work per determinazione codici di bilancio            *
      *        *-------------------------------------------------------*
           05  w-det-vdb.
               10  w-det-vdb-lv1          pic  9(05)                  .
               10  w-det-vdb-lv2          pic  9(05)                  .
               10  w-det-vdb-lv3          pic  9(05)                  .
               10  w-det-vdb-lv4          pic  9(05)                  .
               10  w-det-vdb-lv5          pic  9(05)                  .
               10  w-det-vdb-lv6          pic  9(05)                  .
               10  w-det-mne-con          pic  x(05)                  .
               10  w-det-mne-cod          pic  x(03)                  .

      *    *===========================================================*
      *    * Work area per la definizione record [vbt]                 *
      *    *-----------------------------------------------------------*
       01  w-vbt.
           05  w-vbt-liv-pdc              pic  9(01)                  .
           05  w-vbt-tip-con              pic  x(20)                  .
           05  w-vbt-cod-mas.
               10  w-vbt-cod-mas-001      pic  9(02)                  .
               10  filler                 pic  x(01)                  .
               10  w-vbt-cod-mas-002      pic  9(02)                  .
               10  filler                 pic  x(01)                  .
               10  w-vbt-cod-mas-003      pic  9(02)                  .
           05  w-vbt-cod-con              pic  9(04)                  .
           05  w-vbt-des-con              pic  x(50)                  .
           05  w-vbt-val-con              pic  9(13)v9(02)            .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se intestazione                        *
      *                  *---------------------------------------------*
           if        w-lds-000 (007:20)   =    "desinbilancio       "
      ...
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      06                   to   v-car                  .
           move      w-lds-000 (006:01)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-vbt-liv-pdc          .
      *                  *---------------------------------------------*
      *                  * Tipo conto                                  *
      *                  *---------------------------------------------*
           move      w-lds-000 (007:20)   to   w-vbt-tip-con          .
      *                  *---------------------------------------------*
      *                  * Mastro                                      *
      *                  *---------------------------------------------*
           move      w-lds-000 (027:08)   to   w-vbt-cod-mas          .
      *                  *---------------------------------------------*
      *                  * Conto                                       *
      *                  *---------------------------------------------*
           move      w-lds-000 (061:04)   to   w-vbt-cod-con          .
      *                  *---------------------------------------------*
      *                  * Descrizione conto                           *
      *                  *---------------------------------------------*
           move      w-lds-000 (065:50)   to   w-vbt-des-con          .
      *                  *---------------------------------------------*
      *                  * Valore                                      *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      13                   to   v-car                  .
           move      w-lds-000 (146:13)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-vbt-val-con          .
       xcv-trt-pds-300.
      *              *-------------------------------------------------*
      *              * Trattamento singoli campi                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice 1.                                   *
      *                  *---------------------------------------------*
           if        w-vbt-tip-con        =    "Costi               "
                     move  10             to   w-det-vdb-lv1
           else if   w-vbt-tip-con        =    "Ricavi              "
                     move  20             to   w-det-vdb-lv1
           else if   w-vbt-tip-con        =    "Attivita            "
                     move  30             to   w-det-vdb-lv1
           else if   w-vbt-tip-con        =    "Passivita           "
                     move  40             to   w-det-vdb-lv1          .
      *                  *---------------------------------------------*
      *                  * Codice 2.                                   *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      02                   to   v-car                  .
           move      w-vbt-cod-mas-001    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-vdb-lv2          .
      *                  *---------------------------------------------*
      *                  * Codice 3.                                   *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      02                   to   v-car                  .
           move      w-vbt-cod-mas-002    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-vdb-lv3          .
      *                  *---------------------------------------------*
      *                  * Codice 4.                                   *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      02                   to   v-car                  .
           move      w-vbt-cod-mas-003    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-vdb-lv4          .
      *                  *---------------------------------------------*
      *                  * Codice 5.                                   *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      04                   to   v-car                  .
           move      w-vbt-cod-con        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-vdb-lv5          .
      *                  *---------------------------------------------*
      *                  * Codice 6.                                   *
      *                  *---------------------------------------------*
           move      zero                 to   w-det-vdb-lv6          .
      *                  *---------------------------------------------*
      *                  * Mnemonico                                   *
      *                  *---------------------------------------------*
           move      04                   to   w-all-str-lun          .
           move      w-vbt-cod-con        to   w-all-str-alf          .
           perform   all-str-asx-000      thru all-str-asx-999        .
           move      w-all-str-alf        to   w-det-mne-cod          .
      *
           move      spaces               to   w-det-mne-con          .
           move      05                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      w-vbt-des-con (1:3)  to   w-all-str-cat (1)      .
           move      w-det-mne-cod        to   w-all-str-cat (2)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   w-det-mne-con          .
       xcv-trt-pds-580.
      *              *-------------------------------------------------*
      *              * Scritture                                       *
      *              *-------------------------------------------------*
      ...
      *                  * Write record [vbt]                          *
      *                  *---------------------------------------------*
______*    perform   wrt-rec-vbt-000      thru wrt-rec-vbt-999        .
      *                  *---------------------------------------------*
      *                  * Test se valori                              *
      *                  *---------------------------------------------*
           if        w-vbt-liv-pdc        not  = 4
                     go to xcv-trt-pds-582.
      *                  *---------------------------------------------*
      *                  * Write record [vbv]                          *
      *                  *---------------------------------------------*
           perform   wrt-rec-vbv-000      thru wrt-rec-vbv-999        .
       xcv-trt-pds-582.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "SIS"                to   rf-vbt-tip-bil         .
           move      w-det-vdb-lv1        to   rf-vbt-vdb-lv1         .
           move      w-det-vdb-lv2        to   rf-vbt-vdb-lv2         .
           move      w-det-vdb-lv3        to   rf-vbt-vdb-lv3         .
           move      w-det-vdb-lv4        to   rf-vbt-vdb-lv4         .
           move      w-det-vdb-lv5        to   rf-vbt-vdb-lv5         .
           move      w-det-vdb-lv6        to   rf-vbt-vdb-lv6         .
           move      w-vbt-liv-pdc        to   rf-vbt-liv-vdb         .
           add       1                    to   rf-vbt-liv-vdb         .
           move      w-det-mne-con        to   rf-vbt-mne-vdb         .
           move      w-vbt-des-con        to   rf-vbt-des-vdb         .
      *
           if        w-vbt-liv-pdc        =    4
                     move  02             to   rf-vbt-tip-vdb
           else      move  01             to   rf-vbt-tip-vdb         .
      *
           move      "N"                  to   rf-vbt-snx-isg         .
      *
           if        w-vbt-liv-pdc        =    4
                     move  "N"            to   rf-vbt-snx-tot
           else      move  "S"            to   rf-vbt-snx-tot         .
      *
           move      spaces               to   rf-vbt-dic-tot         .
      *
           if        w-vbt-liv-pdc        =    4
                     move  01             to   rf-vbt-spz-sep
           else      move  03             to   rf-vbt-spz-sep         .
      *
      ...
      *              *-------------------------------------------------*
           ...
           move      "SIS"                to   rf-vbv-tip-bil         .
           move      1080929              to   rf-vbv-dat-bil         .
           move      w-det-vdb-lv1        to   rf-vbv-vdb-lv1         .
           move      w-det-vdb-lv2        to   rf-vbv-vdb-lv2         .
           move      w-det-vdb-lv3        to   rf-vbv-vdb-lv3         .
           move      w-det-vdb-lv4        to   rf-vbv-vdb-lv4         .
           move      w-det-vdb-lv5        to   rf-vbv-vdb-lv5         .
           move      w-det-vdb-lv6        to   rf-vbv-vdb-lv6         .
      *
           multiply  100                  by   w-vbt-val-con          .
           move      w-vbt-val-con        to   rf-vbv-val-vdb         .
      *
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-vbv-000      thru cmp-rec-vbv-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
