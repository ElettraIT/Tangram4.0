      ...
      *                                   Fase:    siraaf              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 14/11/08    *
      *                       Ultima revisione:    NdK del 14/11/08    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Estrazione QUOTA da II riga descrizione     *
      *                    prodotto per riferimento listino in [aaf]   *
      *                                                                *
      *                    SIRI                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Estrazione QUOTA riferimento - SIRI  "       .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Test su presenza descrizione alternativa        *
      *              *-------------------------------------------------*
           if        rf-aaf-xdp-sfn       =    01
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/siri/pdx"  to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/siri/pdx.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-pdx                 .
      *                  *---------------------------------------------*
      *                  * Se record [pdx] non trovato : ad uscita     *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-liv-det-700.
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test se relativo a quota                        *
      *              *-------------------------------------------------*
           if        rf-pdx-des-pro
                    (01 : 06)             not  = "QUOTA " and
                     rf-pdx-des-pro
       ...
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Estrazione riferimento listino                  *
      *              *-------------------------------------------------*
           move      rf-pdx-des-pro
                    (07 : 30)             to   rf-aaf-rif-lst         .      
      *              *-------------------------------------------------*
      *              * Normalizzazioni                                 *
      *              *-------------------------------------------------*
