      ...
      *                    ZATTI - file 'PROLSA.TXT'                   *
      *                                                                *
      *                    Upgrade per dati di acquisto                *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Conversione prodotti ZATTI - acquisto "       .
      ...
      *            *---------------------------------------------------*
               10  w-lds-001-cop-sfn      pic  x(14)                  .
               10  filler                 pic  x(02)                  .
               10  filler                 pic  x(30)                  .
      *            *---------------------------------------------------*
      *            * Prezzo (con 2 decimali)                           *
      *            *---------------------------------------------------*
               10  w-lds-001-prz-acq      pic  x(14)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Sconto 1                                          *
      *            *---------------------------------------------------*
               10  w-lds-001-per-sc1      pic  x(02)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Sconto 2                                          *
      *            *---------------------------------------------------*
               10  w-lds-001-per-sc2      pic  x(02)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice valuta                                     *
      *            *---------------------------------------------------*
               10  w-lds-001-cod-vlt      pic  x(02)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Sigla valuta                                      *
      *            *---------------------------------------------------*
               10  w-lds-001-sgl-vlt      pic  x(04)                  .
               10  filler                 pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Codice fornitore                                  *
      *            *---------------------------------------------------*
               10  w-lds-001-cod-fnt      pic  x(05)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Per determinazione prezzo                             *
      *        *-------------------------------------------------------*
           05  w-det-prz-acq.
      *            *---------------------------------------------------*
      *            * Comodi                                            *
      *            *---------------------------------------------------*
               10  w-det-prz-acq-prz      pic  9(09)v9(02)            .
      *        *-------------------------------------------------------*
      *        * Per determinazione sconti                             *
      *        *-------------------------------------------------------*
           05  w-det-per-sco.
      *            *---------------------------------------------------*
      *            * Comodi                                            *
      *            *---------------------------------------------------*
               10  w-det-per-sco-sc1      pic  9(02)                  .
               10  w-det-per-sco-sc2      pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-lds-000 (001:20)   =    "--------------------"
                     go to xcv-trt-pds-900.
           if        w-lds-000 (001:20)   =    "CODICE     Cod.Acqui"
                     go to xcv-trt-pds-900.
           if        w-lds-000 (001:20)   =    "    DITTA :   1  ZAT"
                     go to xcv-trt-pds-900.
           if        w-lds-000 (054:20)   =    ">>>  LISTINO ACQUIST"
                     go to xcv-trt-pds-900.
           if        w-lds-000 (001:06)   =    spaces
                     go to xcv-trt-pds-900.
           if        w-lds-000 (007:05)   not  = spaces
                     go to xcv-trt-pds-900.
       xcv-trt-pds-200.
      *              *-------------------------------------------------*
      *              * Prodotti normali                                *
      ...
      *                  *---------------------------------------------*
           move      w-lds-001-cod-pro    to   w-det-num-pro-alf      .
      ...
      *                      * Prezzo                                  *
      *                      *-----------------------------------------*
           move      zero                 to   w-det-prz-acq-prz      .
           if        w-lds-001-prz-acq    =    spaces
      ...
      *                          *-------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      14                   to   v-car                  .
           move      w-lds-001-prz-acq    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-prz-acq-prz      .
      *                          *-------------------------------------*
      *                          * Test su codice valuta               *
      *                          *-------------------------------------*
           if        w-lds-001-cod-vlt    =    "10" or
                     w-lds-001-cod-vlt    =    "11" or
                     w-lds-001-cod-vlt    =    "12" or
                     w-lds-001-cod-vlt    =    "13" or
                     w-lds-001-cod-vlt    =    "14" or
                     w-lds-001-cod-vlt    =    "15" or
                     w-lds-001-cod-vlt    =    "16"
                     go to xcv-trt-pds-212
           else      go to xcv-trt-pds-220.
       xcv-trt-pds-212.
      *                          *-------------------------------------*
      *                          * Aggiustamento relativo alla valuta  *
      *                          *-------------------------------------*
           multiply  100                  by   w-det-prz-acq-prz      .
       xcv-trt-pds-220.
      *                      *-----------------------------------------*
      *                      * Sconto 1                                *
      *                      *-----------------------------------------*
           move      zero                 to   w-det-per-sco-sc1      .
           if        w-lds-001-per-sc1    =    spaces
      ...
      *                          *-------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      02                   to   v-car                  .
           move      w-lds-001-per-sc1    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-per-sco-sc1      .
       xcv-trt-pds-240.
      *                      *-----------------------------------------*
      *                      * Sconto 2                                *
      *                      *-----------------------------------------*
           move      zero                 to   w-det-per-sco-sc2      .
           if        w-lds-001-per-sc2    =    spaces
      ...
      *                          *-------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      02                   to   v-car                  .
           move      w-lds-001-per-sc2    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-per-sco-sc2      .
       xcv-trt-pds-260.
      *                      *-----------------------------------------*
      *                      * Codice fornitore                        *
      *                      *                                         *
      *                      * Per ovviare ad un errore della stampa   *
      *                      * dalla quale vengono ricavati i dati,    *
      *                      * il codice del fornitore viene letto da  *
      *                      * 'aaq' precedentemente scritto dalla     *
      *                      * conversione generale prodotti           *
      *                      *-----------------------------------------*
      ...
      *                          * Valore letto                        *
      *                          *-------------------------------------*
           move      rf-aaq-dcf-pfz       to   w-det-cod-dcf-cod      .
       xcv-trt-pds-400.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Incremento numero records scritti [aaf]     *
      *                  *---------------------------------------------*
           add       1                    to   w-pds-aaf              .
      *                  *---------------------------------------------*
      *                  * Visualizzo records scritti                  *
      ...
      *                  *---------------------------------------------*
           ...
           if        w-lds-001-cod-vlt    =    "00"
                     move  c-sgl          to   rf-aaq-sgl-vlt
                     move  zero           to   rf-aaq-dec-vlt
           else if   w-lds-001-cod-vlt    =    "01"
                     move  c-sgl          to   rf-aaq-sgl-vlt
                     move  zero           to   rf-aaq-dec-vlt
           else if   w-lds-001-cod-vlt    =    "10"
                     move  "DEM"          to   rf-aaq-sgl-vlt
                     move  2              to   rf-aaq-dec-vlt
           else if   w-lds-001-cod-vlt    =    "11"
                     move  "NLG"          to   rf-aaq-sgl-vlt
                     move  2              to   rf-aaq-dec-vlt
           else if   w-lds-001-cod-vlt    =    "12"
                     move  "USD"          to   rf-aaq-sgl-vlt
                     move  2              to   rf-aaq-dec-vlt
           else if   w-lds-001-cod-vlt    =    "13"
                     move  "CHF"          to   rf-aaq-sgl-vlt
                     move  2              to   rf-aaq-dec-vlt
           else if   w-lds-001-cod-vlt    =    "14"
                     move  "HKD"          to   rf-aaq-sgl-vlt
                     move  2              to   rf-aaq-dec-vlt
           else if   w-lds-001-cod-vlt    =    "15"
                     move  "ATS"          to   rf-aaq-sgl-vlt
                     move  2              to   rf-aaq-dec-vlt
           else if   w-lds-001-cod-vlt    =    "16"
                     move  "FRF"          to   rf-aaq-sgl-vlt
                     move  2              to   rf-aaq-dec-vlt
           else      move  c-sgl          to   rf-aaq-sgl-vlt
                     move  zero           to   rf-aaq-dec-vlt         .
           move      zero                 to   rf-aaq-dec-prz         .
           move      w-det-prz-acq-prz    to   rf-aaq-prz-acr         .
           move      zero                 to   rf-aaq-uda-par         .
           move      zero                 to   rf-aaq-cod-pdt         .
           if        w-det-cod-dcf-cod    =    zero
                     move  w-lds-001-cop-sfn
                                          to   rf-aaq-cdp-pdt
           else      move  spaces         to   rf-aaq-cdp-pdt         .
       wrt-rec-aaq-300.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-cod-dcf-cod    to   rf-aaf-cod-dcf         .
      ...
      *                  *---------------------------------------------*
           if        w-lds-001-cod-vlt    =    "00"
                     ...
                     move  "DEM"          to   rf-aaf-sgl-vlt
                     move  2              to   rf-aaf-dec-vlt
           else if   w-lds-001-cod-vlt    =    "11"
                     move  "NLG"          to   rf-aaf-sgl-vlt
                     move  2              to   rf-aaf-dec-vlt
           else if   w-lds-001-cod-vlt    =    "12"
                     move  "USD"          to   rf-aaf-sgl-vlt
                     move  2              to   rf-aaf-dec-vlt
           else if   w-lds-001-cod-vlt    =    "13"
                     move  "CHF"          to   rf-aaf-sgl-vlt
                     move  2              to   rf-aaf-dec-vlt
           else if   w-lds-001-cod-vlt    =    "14"
                     move  "HKD"          to   rf-aaf-sgl-vlt
                     move  2              to   rf-aaf-dec-vlt
           else if   w-lds-001-cod-vlt    =    "15"
                     move  "ATS"          to   rf-aaf-sgl-vlt
                     move  2              to   rf-aaf-dec-vlt
           else if   w-lds-001-cod-vlt    =    "16"
                     move  "FRF"          to   rf-aaf-sgl-vlt
                     move  2              to   rf-aaf-dec-vlt
           else      move  c-sgl          to   rf-aaf-sgl-vlt
                     move  zero           to   rf-aaf-dec-vlt         .
           move      w-lds-001-cop-sfn    to   rf-aaf-cop-sfn         .
           move      w-det-prz-acq-prz    to   rf-aaf-prz-pes (1)     .
           move      w-det-per-sco-sc1    to   rf-aaf-psr-pes (1, 1)  .
           move      w-det-per-sco-sc2    to   rf-aaf-psr-pes (1, 2)  .
           move      zero                 to   rf-aaf-psr-pes (1, 3)  .
           move      zero                 to   rf-aaf-psr-pes (1, 4)  .
           move      zero                 to   rf-aaf-psr-pes (1, 5)  .
       wrt-rec-aaf-300.
      *                  *---------------------------------------------*
      *                  * Aggiornamento record file [aaf]             *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
           move      "pgm/dcf/fls/ioc/obj/iofaaf"
                                          to   s-pat                  .
