      ...
      *                                   Fase:    sirofr              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 20/05/03    *
      *                       Ultima revisione:    NdK del 29/05/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Update righe per rif. conferma : SIRI       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Riferimenti conferma riga ordine    "       .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Riferimenti da testata                          *
      *              *-------------------------------------------------*
           if        rf-ofr-flg-cnf       =    spaces or
                     rf-ofr-flg-cnf       =    "?"
                     go to prn-liv-det-200.
           move      rf-oft-cof-dat       to   rf-ofr-cof-dat         .
           move      rf-oft-cof-num       to   rf-ofr-cof-num         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Data consegna confermata                        *
      *              *-------------------------------------------------*
           if        rf-ofr-dcn-prv       >    rf-ofr-dcn-cnf
                     move  rf-ofr-dcn-prv to   rf-ofr-dcn-cnf         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [ofr]                             *
      *              *-------------------------------------------------*
