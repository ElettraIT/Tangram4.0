      ...
      *                       Ultima revisione:    NdK del 13/02/13    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Creazione listino "LIF" generico            *
      *                                                                *
      *                    - Prezzo di partenza : costo LIFO           *
      *                                                                *
      *                    - Prezzo risultante                         *
      *                                in euro  : listino "LIF" [lst]  *
      *                                                                *
      *                    Scrittura di /abd/asc/tmp/LIFO.SQZ          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Creazione listino da LIFO - ZATTI Srl "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Creazione Listino 'LIF' per vendita     "  .
      ...
      *            *---------------------------------------------------*
               ...
               10  filler                 pic  x(01)                  .
               10  w-out-gen-alf-pro      pic  x(14)                  .
               10  filler                 pic  x(01)                  .
               10  w-out-gen-val-lif      pic  x(15)                  .
      *            *---------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      1121231              to   d-sld-mag-dat-sld      .
      ...
      *              *-------------------------------------------------*
           ...
           move      1121231              to   d-vun-mag-dat-val      .
      ...
      *                  *---------------------------------------------*
           move      rf-dcp-alf-pro       to   w-out-gen-alf-pro      .
      *                  *---------------------------------------------*
      *                  * Editing valore LIFO                         *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           move      spaces               to   p-sgn                  .
           move      "<9"                 to   p-edm                  .
           move      d-vun-mag-lif-val    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * In campo di destinazione                    *
      *                  *---------------------------------------------*
           move      p-edt                to   w-out-gen-val-lif      .
      *                  *---------------------------------------------*
      ...
      *                      * Prezzo di listino                       *
      *                      *-----------------------------------------*
           divide    d-vun-mag-gia-prp    into d-vun-mag-lif-val
                                        giving rf-lst-prz-lst         .
      *                      *-----------------------------------------*
