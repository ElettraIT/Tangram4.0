      ...
      *                                   Fase:    zttdcp              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/07/07    *
      *                       Ultima revisione:    NdK del 17/07/07    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione listino NEW con sconto 50+10      *
      *                    sul listino base                            *
      *                                                                *
      *                    ZATTI                                       *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Generazione listino NEW dal Base (50+10)"       .
      ...
      *              *-------------------------------------------------*
           move      rf-dcp-prz-lst       to   w-cal-prz-net-prz      .
           move      50                   to   w-cal-prz-net-psc (1)  .
           move      10                   to   w-cal-prz-net-psc (2)  .
           move      zero                 to   w-cal-prz-net-psc (3)  .
           move      zero                 to   w-cal-prz-net-psc (4)  .
           move      zero                 to   w-cal-prz-net-psc (5)  .
