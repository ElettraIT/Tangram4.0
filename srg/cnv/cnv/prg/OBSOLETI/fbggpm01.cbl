      ...
      *                       Ultima revisione:    Ndk del 31/01/02    *
      *                    ------------------------------------------- *
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Test se esiste il conteggio a cui si riferisce  *
      *              * la maturazione                                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura record [gpc]                        *
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-gpc                 .
      *                  *---------------------------------------------*
      *                  * Test su esito lettura record [gpc]          *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
