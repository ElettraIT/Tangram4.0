      ...
      *                       Ultima revisione:    Ndk del 09/07/01    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento prezzo Euro [haf]             *
      *                                                                *
      *                    FORALBERG                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento prezzi in Euro Foralberg "       .
      ...
      *                  *---------------------------------------------*
           if        rf-haf-prz-ven       =    zero
                     go to prn-liv-det-300.
      *                  *---------------------------------------------*
      *                  * Trattamento prezzo in Euro                  *
      *                  *---------------------------------------------*
           move      rf-haf-prz-ven       to   w-det-prz-eur-prz      .
           divide    100                  into w-det-prz-eur-prz      .
           divide    1936,27              into w-det-prz-eur-prz
                                        rounded                       .
           multiply  100                  by   w-det-prz-eur-prz      .
           move      w-det-prz-eur-prz    to   rf-haf-prz-eur         .
      *                  *---------------------------------------------*
      *                  * Aggiornamento record [lst] EUR              *
      *                  *---------------------------------------------*
           perform   agg-rec-eur-000      thru agg-rec-eur-999        .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [haf]                             *
      *              *-------------------------------------------------*
