      ...
      *                       Ultima revisione:    NdK del 06/11/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Pareggiamento automatico : TEMI             *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  kk0-key.
               ...
               10  kk0-dat-rif            pic  9(07)                  .
               10  kk0-num-rif            pic  x(10)                  .
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-wrk-ctr-006              pic  9(06)                  .
           05  w-wrk-ctr-007              pic  9(06)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-wrk-rif-flg              pic  x(01)                  .
           05  w-wrk-rif-fce              pic  x(01)                  .
           05  w-wrk-rif-tpa              pic  x(01)                  .
           05  w-wrk-rif-tip              pic  9(02)                  .
           05  w-wrk-rif-ct1              pic  9(03)                  .
           05  w-wrk-rif-ct2              pic  9(03)                  .
           05  w-wrk-rif-ct3              pic  9(03)                  .
           05  w-wrk-rif-ct4              pic  9(03)                  .
           05  w-wrk-rif-str              pic  x(10)                  .
           05  w-wrk-rif-num              pic  x(10)                  .
           05  w-wrk-rif-rno              pic  9(07)                  .
           05  w-wrk-rif-dat              pic  9(07)                  .
           05  w-wrk-rif-gio              pic  9(02)                  .
           05  w-wrk-rif-mes              pic  9(02)                  .
           05  w-wrk-rif-ann              pic  9(02)                  .
           05  w-wrk-rif-imp              pic  9(13)                  .
           05  w-wrk-rif-imw              pic  9(13)                  .
           05  w-wrk-rif-ddo              pic  9(07)                  .
           05  w-wrk-rif-saa              pic  9(03)                  .
           05  w-wrk-rif-sdo              pic s9(13)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "FASE 1 - Letture preliminari .....................
      -              ".:"                 to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       stp-srt-inp-050.
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-wrk-ctr-005          .
           move      zero                 to   w-wrk-ctr-007          .
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Eventuale visualizzazione termometro            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su blocco da 225 elementi              *
      *                  *---------------------------------------------*
           if        w-wrk-ctr-003        <    225
                     go to stp-srt-inp-400.
      *                  *---------------------------------------------*
      *                  * Blocco da 225 elementi                      *
      *                  *---------------------------------------------*
           move      1                    to   w-wrk-ctr-003          .
      ...
      *                  *---------------------------------------------*
           if        rf-mgr-cod-cau       not  = 32 and
                     rf-mgr-cod-cau       not  = 12 and
                     rf-mgr-cod-cau       not  = 13 and
                     rf-mgr-cod-cau       not  = 14
                     go to stp-srt-inp-420.
      *                  *---------------------------------------------*
      *                  * Selezione su riferimenti                    *
      *                  *---------------------------------------------*
           if        rf-mgr-num-rif       =    spaces
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-600.
      *                  *---------------------------------------------*
      *                  * Aggiornamento contatore record rilasciati   *
      *                  *---------------------------------------------*
           add       1                    to   w-wrk-ctr-004          .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "FASE 2 - Pareggiamenti clienti ...................
      -              ".:"                 to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Pulizia termometro Fase 1                   *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      80                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
       ...
       prn-ini-lr1-100.
      *              *-------------------------------------------------*
      *              * Visualizzazione cliente in corso di trattamento *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      07                   to   v-car                  .
           ...
           move      10                   to   v-lin                  .
           move      54                   to   v-pos                  .
           move      w-rot-l01-cod-cli    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                  *---------------------------------------------*
      *                  * Editing cliente                             *
      ...
      *                  *---------------------------------------------*
           ...
           move      "verificato"         to   w-all-str-cat (3)      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Test se operazione avvenuta                     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test sul flag                               *
      *                  *---------------------------------------------*
           if        w-wrk-rif-fce        =    spaces
      ...
      *                  *---------------------------------------------*
           ...
           move      "Cliente :"          to   w-all-str-cat (1)      .
           move      v-edt                to   w-all-str-cat (2)      .
           move      "da sistemare !"     to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *                  *---------------------------------------------*
      *                  * Rullino                                     *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           add       1                    to   w-wrk-ctr-003          .
      *              *-------------------------------------------------*
      *              * Eventuale visualizzazione termometro Fase 2     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Determinazione valore blocco                *
      *                  *---------------------------------------------*
           divide    80                   into w-wrk-ctr-004
                                        giving w-wrk-ctr-006          .
      *                  *---------------------------------------------*
      *                  * Test su blocco da 225 elementi              *
      *                  *---------------------------------------------*
           if        w-wrk-ctr-003        <    w-wrk-ctr-006
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Verifica del contenuto del commento             *
      *              *-------------------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo ricerca         *
      *              *-------------------------------------------------*
           if        w-wrk-rif-tip        =    01
                     perform  prn-liv-det-ndr-000
                                          thru prn-liv-det-ndr-999
           else if   w-wrk-rif-tip        =    02
                     perform  prn-liv-det-num-000
                                          thru prn-liv-det-num-999
           else if   w-wrk-rif-tip        =    03
                     perform  prn-liv-det-imp-000
                                          thru prn-liv-det-imp-999
           else      go to prn-liv-det-800.
       prn-liv-det-800.
      *              *-------------------------------------------------*
      *              * Test se operazione avvenuta                     *
      *              *-------------------------------------------------*
      ...
      *                  * Test sul flag                               *
      *                  *---------------------------------------------*
           if        w-wrk-rif-flg        not  = spaces
                     go to prn-liv-det-900.
      *                  *---------------------------------------------*
      *                  * Attivazione segnale di cliente da verifica- *
      *                  * re                                          *
      *                  *---------------------------------------------*
           move      "#"                  to   w-wrk-rif-fce          .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine per estrarre eventuali riferimenti             *
      *    *-----------------------------------------------------------*
       prn-liv-det-ext-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      spaces               to   w-wrk-rif-flg          .
           move      zero                 to   w-wrk-rif-tip          .
           move      spaces               to   w-wrk-rif-str          .
           move      spaces               to   w-wrk-rif-num          .
           move      zero                 to   w-wrk-rif-rno          .
           move      zero                 to   w-wrk-rif-gio          .
           move      zero                 to   w-wrk-rif-mes          .
           move      zero                 to   w-wrk-rif-ann          .
           move      zero                 to   w-wrk-rif-dat          .
           move      zero                 to   w-wrk-rif-imp          .
           move      zero                 to   w-wrk-rif-imw          .
           move      zero                 to   w-wrk-rif-ddo          .
           move      zero                 to   w-wrk-rif-saa          .
       prn-liv-det-ext-005.
      *              *-------------------------------------------------*
      *              * Bufferizzazione importo                         *
      *              *-------------------------------------------------*
           move      rf-mgr-imp-mov       to   w-wrk-rif-imp          .
      *              *-------------------------------------------------*
      *              * Bufferizzazione data documento e secolo/anno    *
      *              *-------------------------------------------------*
           move      rf-mgr-dat-doc       to   w-wrk-rif-ddo          .
           move      rf-mgr-dat-doc       to   s-dat                  .
           move      s-saa                to   w-wrk-rif-saa          .
       prn-liv-det-ext-010.
      *              *-------------------------------------------------*
      *              * Ricerca elemento 'ft.'                          *
      *              *-------------------------------------------------*
      ...
      *                  * Ciclo di ricerca                            *
      *                  *---------------------------------------------*
           move      zero                 to   w-wrk-rif-ct1          .
       prn-liv-det-ext-020.
           add       1                    to   w-wrk-rif-ct1          .
           if        w-wrk-rif-ct1        >    30
                     go to prn-liv-det-ext-200.
           if        rf-mgr-com-rig
                    (w-wrk-rif-ct1 : 3)   not  = "ft."
                     go to prn-liv-det-ext-020.
      *                  *---------------------------------------------*
      *                  * Se individuato 'ft.'                        *
      *                  *---------------------------------------------*
           move      w-wrk-rif-ct1        to   w-wrk-rif-ct2          .
           add       03                   to   w-wrk-rif-ct2          .
           move      rf-mgr-com-rig
                    (w-wrk-rif-ct2 : 5)   to   w-wrk-rif-str          .
      *                  *---------------------------------------------*
      *                  * Estrazione del numero                       *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      10                   to   v-car                  .
           move      w-wrk-rif-str        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-wrk-rif-rno          .
      *                  *---------------------------------------------*
      *                  * Editing del numero                          *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-wrk-rif-rno        to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-wrk-rif-num          .
       prn-liv-det-ext-030.
      *              *-------------------------------------------------*
      *              * Ricerca elemento 'del'                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Ciclo di ricerca                            *
      *                  *---------------------------------------------*
           move      w-wrk-rif-ct2        to   w-wrk-rif-ct3          .
       prn-liv-det-ext-032.
           add       01                   to   w-wrk-rif-ct3          .
           if        w-wrk-rif-ct3        >    30
                     go to prn-liv-det-ext-300.
           if        rf-mgr-com-rig
                    (w-wrk-rif-ct3 : 3)   not  = "del"
                     go to prn-liv-det-ext-032.
      *                  *---------------------------------------------*
      *                  * Se individuato 'del'                        *
      *                  *---------------------------------------------*
           move      spaces               to   w-wrk-rif-str          .
           move      w-wrk-rif-ct3        to   w-wrk-rif-ct4          .
           add       04                   to   w-wrk-rif-ct4          .
           move      rf-mgr-com-rig
                    (w-wrk-rif-ct4 : 2)   to   w-wrk-rif-str          .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-wrk-rif-gio          .
      *                  *---------------------------------------------*
      *                  * Estrazione del mese                         *
      *                  *---------------------------------------------*
           move      spaces               to   w-wrk-rif-str          .
           add       03                   to   w-wrk-rif-ct4          .
           move      rf-mgr-com-rig
                    (w-wrk-rif-ct4 : 2)   to   w-wrk-rif-str          .
      *
           move      "CV"                 to   v-ope                  .
      ...
      *
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-wrk-rif-ann          .
      *                  *---------------------------------------------*
      *                  * Ricomposizione della data                   *
      *                  *---------------------------------------------*
           move      w-wrk-rif-gio        to   s-gio                  .
           move      w-wrk-rif-mes        to   s-mes                  .
           move      w-wrk-rif-ann        to   s-ann                  .
           if        w-wrk-rif-ann        >    80
                     move  0              to   s-sec
           else      move  1              to   s-sec                  .
           move      s-dat                to   w-wrk-rif-dat          .
      *                  *---------------------------------------------*
      *                  * Definizione tipo ricerca                    *
      *                  *---------------------------------------------*
           move      01                   to   w-wrk-rif-tip          .
      *                  *---------------------------------------------*
      *                  * Oltre                                       *
      *                  *---------------------------------------------*
           go to     prn-liv-det-ext-900.
       prn-liv-det-ext-200.
      *              *-------------------------------------------------*
      *              * Se non trovato 'ft.'                            *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-ext-300.
      *              *-------------------------------------------------*
      *              * Se trovato 'ft.' ma non 'del'                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Definizione tipo ricerca                    *
      *                  *---------------------------------------------*
           move      02                   to   w-wrk-rif-tip          .
      *                  *---------------------------------------------*
      *                  * Oltre                                       *
      *                  *---------------------------------------------*
           go to     prn-liv-det-ext-900.
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine per ricerca tramite numero e data              *
      *    *                                                           *
      *    * In input : w-wrk-rif-dat = data riferimento               *
      *    *            w-wrk-rif-num = numero riferimento             *
      *    *-----------------------------------------------------------*
       prn-liv-det-ndr-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [mgr]                         *
      *              *-------------------------------------------------*
           ...
           move      "C"                  to   rf-mgr-tip-arc         .
           move      w-rot-l01-cod-cli    to   rf-mgr-cod-arc         .
           move      w-wrk-rif-dat        to   rf-mgr-dat-rif         .
           move      w-wrk-rif-num        to   rf-mgr-num-rif         .
           move      zero                 to   rf-mgr-dat-reg         .
           move      zero                 to   rf-mgr-num-prt         .
           move      zero                 to   rf-mgr-num-prg         .
           move      "pgm/cge/fls/ioc/obj/iofmgr"
      ...
      *              *-------------------------------------------------*
           if        rf-mgr-tip-arc       not  = "C"               or
                     rf-mgr-cod-arc       not  = w-rot-l01-cod-cli or
                     rf-mgr-dat-rif       not  = w-wrk-rif-dat     or
                     rf-mgr-num-rif       not  = w-wrk-rif-num
                     go to prn-liv-det-ndr-900.
       prn-liv-det-ndr-400.
      *              *-------------------------------------------------*
      *              * Selezioni su [mgr]                              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Selezione su causale : solo fatture         *
      *                  *---------------------------------------------*
           if        rf-mgr-cod-cau       not  = 001
                     go to prn-liv-det-ndr-200.
       prn-liv-det-ndr-600.
      *              *-------------------------------------------------*
      *              * Update [mgr]                                    *
      *              *-------------------------------------------------*
           perform   prn-liv-det-upd-000  thru prn-liv-det-upd-999    .
       prn-liv-det-ndr-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-liv-det-ndr-999.
       prn-liv-det-ndr-999.
           exit.
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine per ricerca tramite numero                     *
      *    *                                                           *
      *    * In input : w-wrk-rif-num = numero riferimento             *
      *    *-----------------------------------------------------------*
       prn-liv-det-num-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [mgr]                         *
      ...
      *              *-------------------------------------------------*
           if        rf-mgr-tip-arc       not  = "C"               or
                     rf-mgr-cod-arc       not  = w-rot-l01-cod-cli
                     go to prn-liv-det-num-900.
       prn-liv-det-num-400.
      *              *-------------------------------------------------*
      *              * Selezioni su [mgr]                              *
      ...
      *                  *---------------------------------------------*
           if        rf-mgr-cod-cau       not  = 001
                     go to prn-liv-det-num-200.
      *                  *---------------------------------------------*
      *                  * Selezione su numero                         *
      *                  *---------------------------------------------*
           if        rf-mgr-num-rif       not  = w-wrk-rif-num
                     go to prn-liv-det-num-200.
       prn-liv-det-num-600.
      *              *-------------------------------------------------*
      *              * Data di riferimento per update                  *
      *              *-------------------------------------------------*
           move      rf-mgr-dat-rif       to   w-wrk-rif-dat          .
      *              *-------------------------------------------------*
      *              * Update [mgr]                                    *
      *              *-------------------------------------------------*
           perform   prn-liv-det-upd-000  thru prn-liv-det-upd-999    .
      ...
      *    * Subroutine per ricerca tramite numero                     *
      *    *                                                           *
      *    * In input : w-wrk-rif-imp = importo movimento              *
      *    *-----------------------------------------------------------*
       prn-liv-det-imp-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [mgr]                         *
      ...
      *                  *---------------------------------------------*
           if        rf-mgr-cod-cau       not  = 001
                     go to prn-liv-det-imp-200.
      *                  *---------------------------------------------*
      *                  * Selezione su importo                        *
      *                  *---------------------------------------------*
           move      rf-mgr-imp-mov       to   w-wrk-rif-imw
           if        w-wrk-rif-imw        not  = w-wrk-rif-imp
                     go to prn-liv-det-imp-200.
      *                  *---------------------------------------------*
      *                  * Test che sia almeno lo stesso anno          *
      *                  *---------------------------------------------*
           move      rf-mgr-dat-doc       to   s-dat                  .
           if        s-saa                not  = w-wrk-rif-saa
                     go to prn-liv-det-imp-200.
       prn-liv-det-imp-600.
      *              *-------------------------------------------------*
      *              * Numero di riferimento per update                *
      *              *-------------------------------------------------*
           move      rf-mgr-num-rif       to   w-wrk-rif-num          .
      *              *-------------------------------------------------*
      *              * Data di riferimento per update                  *
      *              *-------------------------------------------------*
           move      rf-mgr-dat-rif       to   w-wrk-rif-dat          .
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine per Update [mgr]                               *
      *    *-----------------------------------------------------------*
       prn-liv-det-upd-000.
      *              *-------------------------------------------------*
      *              * Test se aggiornamento effettuabile              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su numero riferimento                  *
      *                  *---------------------------------------------*
           if        w-wrk-rif-num        =    spaces
                     go to prn-liv-det-upd-900.
      *                  *---------------------------------------------*
      *                  * Test su data riferimento                    *
      *                  *---------------------------------------------*
           if        w-wrk-rif-dat        =    zero
                     go to prn-liv-det-upd-900.
       prn-liv-det-upd-050.
      *              *-------------------------------------------------*
      *              * Verifica che la partita in corso di trattamento *
      *              * non sia ancora aperta                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Subroutine                                  *
      *                  *---------------------------------------------*
           perform   prn-liv-det-tpa-000  thru prn-liv-det-tpa-999    .
      *                  *---------------------------------------------*
      *                  * Test su data riferimento                    *
      *                  *---------------------------------------------*
           if        w-wrk-rif-tpa        not  = spaces
                     go to prn-liv-det-upd-900.
       prn-liv-det-upd-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-upd-400.
      *              *-------------------------------------------------*
      *              * Flag di operazione avvenuta                     *
      *              *-------------------------------------------------*
           move      "#"                  to   w-wrk-rif-flg          .
      *              *-------------------------------------------------*
      *              * Aggiornamento contatore                         *
      *              *-------------------------------------------------*
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine per verificare se partita aperta               *
      *    *-----------------------------------------------------------*
       prn-liv-det-tpa-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      spaces               to   w-wrk-rif-tpa          .
           move      zero                 to   w-wrk-rif-sdo          .
       prn-liv-det-tpa-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [mgr]                         *
      *              *-------------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     prn-liv-det-tpa-200.
       prn-liv-det-tpa-800.
      *              *-------------------------------------------------*
      *              * Determinazione finale                           *
      *              *-------------------------------------------------*
           if        w-wrk-rif-sdo        =    zero
                     move  "#"            to   w-wrk-rif-tpa          .
       prn-liv-det-tpa-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-liv-det-tpa-999.
       prn-liv-det-tpa-999.
           exit.
