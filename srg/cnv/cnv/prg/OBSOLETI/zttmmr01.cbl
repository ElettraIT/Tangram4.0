      ...
      *                                   Fase:    zttmmr              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 10/06/08    *
      *                       Ultima revisione:    NdK del 10/06/08    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ripristino inventario cannato : ZATTI       *
      *                                                                *
      *                    Scansione di [mmr] per update [mms]         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Sistemazione inventario 2007 : Zatti  "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1071231              to   rf-mmr-dat-reg         .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Selezione su causale di magazzino               *
      *              *-------------------------------------------------*
           if        rf-mmr-cod-cau       =    00900 or
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiustamento saldo di inizio anno per [mms]    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      108                  to   rf-mms-ann-ese         .
           move      rf-mmr-cod-dpz       to   rf-mms-cod-dpz         .
           move      01                   to   rf-mms-tip-mag         .
           move      rf-mmr-num-mag       to   rf-mms-num-mag         .
      ...
      *              *-------------------------------------------------*
      *              * Aggiustamento valore                            *
      *              *-------------------------------------------------*
           if        rf-mmr-cod-cau       =    00901
                     add      rf-mmr-qta-mov
                                          to   rf-mms-qta-ini
