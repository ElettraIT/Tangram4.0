      ...
      *                                   Fase:                        *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 28/04/08    *
      *                       Ultima revisione:    NdK del 31/07/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Forzature note "Mag.8 C+C" a fronte serie   *
      *                    bolle "INV"                                 *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "AGGIORNAMENTO UBICAZIONI DA BOLLE 'INV' "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1130720              to   rf-bit-dat-doc         .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su numeri documento                    *
      *                  *---------------------------------------------*
           if        rf-bit-num-doc       not  = 11301000046 and
                     rf-bit-num-doc       not  = 11301000047 and
                     rf-bit-num-doc       not  = 11301000048 and
                     rf-bit-num-doc       not  = 11301000049 and
                     rf-bit-num-doc       not  = 11301000050 and
                     rf-bit-num-doc       not  = 11301000051 and
                     rf-bit-num-doc       not  = 11301000053 and
                     rf-bit-num-doc       not  = 11301000054 and
                     rf-bit-num-doc       not  = 11301000055 and
                     rf-bit-num-doc       not  = 11301000057 and
                     rf-bit-num-doc       not  = 11301000058 and
                     rf-bit-num-doc       not  = 11301000059 and
                     rf-bit-num-doc       not  = 11301000060 and
                     rf-bit-num-doc       not  = 11301000061 and
                     rf-bit-num-doc       not  = 11301000062 and
                     rf-bit-num-doc       not  = 11301000063 and
                     rf-bit-num-doc       not  = 11301000064 and
                     rf-bit-num-doc       not  = 11301000065 and
                     rf-bit-num-doc       not  = 11301000066 and
                     rf-bit-num-doc       not  = 11301000067 and
                     rf-bit-num-doc       not  = 11301000068 and
                     rf-bit-num-doc       not  = 11301000069 and
                     rf-bit-num-doc       not  = 11301000070 and
                     rf-bit-num-doc       not  = 11301000071 and
                     rf-bit-num-doc       not  = 11301000072 and
                     rf-bit-num-doc       not  = 11301000073 and
                     rf-bit-num-doc       not  = 11301000074 and
                     rf-bit-num-doc       not  = 11301000075 and
                     rf-bit-num-doc       not  = 11301000076 and
                     rf-bit-num-doc       not  = 11301000077
      ...
      *                  * Record [mau]                                *
      *                  *---------------------------------------------*
           perform   exe-gen-rec-mau-000  thru exe-gen-rec-mau-999    .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      kk0-num-pro          to   rf-mau-num-mag         .
      ...
      *                  * Note                                        *
      *                  *---------------------------------------------*
           move      "Mag.8 C+C"          to   rf-mau-not-ubi         .
      *                  *---------------------------------------------*
      *                  * Update record [mau]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
