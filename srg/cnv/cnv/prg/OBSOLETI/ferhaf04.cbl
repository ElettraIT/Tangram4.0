      ...
      *                                   Fase:    ferhaf              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 29/11/99    *
      *                       Ultima revisione:    NdK del 29/04/09    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sistemazione [dcp], no negozio (BETA)       *
      *                                                                *
      *                    FERRAMENTA ITALIANA                         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento record prodotti Ferramenta"       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Aggiornamento record negozio Ferramenta "  .
      ...
      *              * Ciclo per [haf]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-haf-000  thru stp-srt-inp-haf-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      0003432              to   rf-haf-cod-dcf         .
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-haf-cod-dcf       not  = 0003432
                     go to stp-srt-inp-haf-900.
       stp-srt-inp-haf-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [haf]                      *
      *              *-------------------------------------------------*
           if        rf-haf-fda-pif       not  = spaces
                     go to stp-srt-inp-haf-200.
           if        rf-haf-snx-imp       not  = "S"
                     go to stp-srt-inp-haf-200.
           if        rf-haf-prz-imp       not  = zero
                     go to stp-srt-inp-haf-200.
           if        rf-haf-ide-dat       not  > 1020127
                     go to stp-srt-inp-haf-200.
           if        rf-haf-prc-ctt       not  = 0,46
                     go to stp-srt-inp-haf-200.
       stp-srt-inp-haf-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Applicazione decimali prezzo vendita        *
      *                  *---------------------------------------------*
