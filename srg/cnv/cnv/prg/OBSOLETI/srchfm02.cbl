      ...
      *                                   Fase:    srchfm              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 18/01/99    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Update formulari per mnemonico destinatario *
      *                                                                *
      *================================================================*
      ...
      *        * [hpd]                                                 *
      *        *-------------------------------------------------------*
           copy      "sec/tns/fls/rec/rfhpd"                          .
      *        *-------------------------------------------------------*
      *        * [hsm]                                                 *
      *        *-------------------------------------------------------*
           copy      "sec/tns/fls/rec/rfhsm"                          .
      *        *-------------------------------------------------------*
      *        * [hdd]                                                 *
      *        *-------------------------------------------------------*
           copy      "sec/tns/fls/rec/rfhdd"                          .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhpd"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhsm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhdd"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [hfm]              *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhfm"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
      *              * Visualizzazione elemento in trattamento         *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "P"                  to   v-tip                  .
           move      06                   to   v-car                  .
           ...
           move      09                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      rf-hfm-prg-mov       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Mnemonico destinatario                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo destinata-  *
      *                  * rio                                         *
      *                  *---------------------------------------------*
           if        rf-hfm-tip-dsn       =    "S"
                     go to prn-liv-det-120 
           else if   rf-hfm-tip-dsn       =    "D"
                     go to prn-liv-det-140 
           else if   rf-hfm-tip-dsn       =    "P"
      ...
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODSML"             to   f-key                  .
           move      rf-hfm-cod-dsn       to   rf-hsm-cod-sml         .
           move      "sec/tns/fls/ioc/obj/iofhsm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-hsm                 .
      *                      *-----------------------------------------*
      *                      * Aggiornamento mnemonico                 *
      *                      *-----------------------------------------*
           move      rf-hsm-cod-mne       to   rf-hfm-mne-dsn         .
      *                      *-----------------------------------------*
      *                      * Ad aggiornamento                        *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODDDV"             to   f-key                  .
           move      rf-hfm-cod-dsn       to   rf-hdd-cod-ddv         .
           move      "sec/tns/fls/ioc/obj/iofhdd"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Aggiornamento mnemonico                 *
      *                      *-----------------------------------------*
           move      rf-hdd-cod-mne       to   rf-hfm-mne-dsn         .
      *                      *-----------------------------------------*
      *                      * Ad aggiornamento                        *
      *                      *-----------------------------------------*
           go to     prn-liv-det-200.
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-hfm-cod-dsn       to   rf-hpd-cod-pdt         .
           move      "sec/tns/fls/ioc/obj/iofhpd"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Aggiornamento mnemonico                 *
      *                      *-----------------------------------------*
           move      rf-hpd-cod-mne       to   rf-hfm-mne-dsn         .
      *                      *-----------------------------------------*
      *                      * Ad aggiornamento                        *
      *                      *-----------------------------------------*
           go to     prn-liv-det-200.
      ...
      *              *-------------------------------------------------*
           move      rf-hfm-prg-mov       to   rf-hfm-num-bac         .
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
