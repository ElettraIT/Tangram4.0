      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [fir] e [mmr] : FBG      *
      *                                                                *
      *                    Sistemazione articolo 6740333               *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento file [fir-mmr] - Foralberg"       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione per articolo 6740333        "  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-fir-num-pro       to   rf-lst-num-pro         .
           move      "pgm/dcp/fls/ioc/obj/iofdcp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-dcp                 .
           move      rf-lst-prz-lst       to   rf-fir-prz-nts         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [fir]                             *
      *              *-------------------------------------------------*
