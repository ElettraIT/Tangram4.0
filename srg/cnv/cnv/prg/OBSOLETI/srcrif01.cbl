      ...
      *                       Ultima revisione:    NdK del 08/10/98    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [hrr] : Ser.Co.          *
      *                                                                *
      *                    Creazione file riferimenti registro         *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
               10  srt-tbl-rfm.
                   15  srt-ele-rfm occurs 12.
                       20  srt-num-rfm    pic  9(09)                  .
                       20  srt-dat-rfm    pic  9(07)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento dati riferimenti Registro "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-let.
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [hrr]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-hrr.
               10  w-let-arc-hrr-flg      pic  x(01)                  .
               10  w-let-arc-hrr-rec      pic  x(04)                  .
               10  w-let-arc-hrr-key      pic  9(07)                  .
               10  w-let-arc-hrr-de1      pic  x(60)                  .
               10  w-let-arc-hrr-de2      pic  x(60)                  .
               10  w-let-arc-hrr-ag1      pic  9(07)                  .
               10  w-let-arc-hrr-ag2      pic  9(07)                  .
               10  w-let-arc-hrr-zp1      pic  9(05)                  .
               10  w-let-arc-hrr-zp2      pic  9(05)                  .
               10  w-let-arc-hrr-zp3      pic  9(05)                  .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione righe riferimenti Registro  "  .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhrr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-hrg-prg-mov       to   srt-prg-mov            .
      *                  *---------------------------------------------*
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
           move      rf-hrg-tbl-rfm       to   srt-tbl-rfm            .
       stp-srt-inp-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-800.
      *                  *---------------------------------------------*
      *                  * Riciclo a record [hrg] successivo           *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      09                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      rf-hrg-prg-mov       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Scansione su riferimenti                        *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   wrt-rec-hrr-000      thru wrt-rec-hrr-999        .
      *                  *---------------------------------------------*
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
           go to     prn-liv-det-200.
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "PRGMOV    "         to   f-key                  .
           move      srt-prg-mov          to   rf-hrg-prg-mov         .
           move      "sec/tns/fls/ioc/obj/iofhrg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           add       00100                to   w-cix-prg-001          .
           move      srt-prg-mov          to   rf-hrr-num-prt         .
           move      w-cix-prg-001        to   rf-hrr-num-prg         .
           move      rf-hrg-num-ptt       to   rf-hrr-num-ptt         .
           move      srt-num-rfm
                    (w-cix-ctr-001)       to   rf-hrr-num-rfm         .
           move      srt-dat-rfm
                    (w-cix-ctr-001)       to   rf-hrr-dat-rfm         .
           move      spaces               to   rf-hrr-flg-ela         .
           move      spaces               to   rf-hrr-flg-pul         .
           move      spaces               to   rf-hrr-flg-tda         .
