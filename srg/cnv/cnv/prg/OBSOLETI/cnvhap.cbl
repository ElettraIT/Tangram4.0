      ...
      *                                   Fase:    cnvhap              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/01/04    *
      *                       Ultima revisione:    NdK del 26/01/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Conversione file Partita Serco [hap]        *
      *                                                                *
      *================================================================*
      ...
      *        * [hap]                                                 *
      *        *-------------------------------------------------------*
           copy      "sec/tns/fls/rec/rfhap"                          .
      *        *-------------------------------------------------------*
      *        * [hpx]                                                 *
      *        *-------------------------------------------------------*
           copy      "sec/tns/fls/rec/rfhpx"                          .
      *        *-------------------------------------------------------*
      *        * [hpt]                                                 *
      *        *-------------------------------------------------------*
           copy      "sec/tns/fls/rec/rfhpt"                          .
      ...
      *              * Conversione [hap]                               *
      *              *-------------------------------------------------*
           perform   exe-cnv-hap-000      thru exe-cnv-hap-999        .
       exe-cnv-fil-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "hap "               to   f-xxx-nam              .
      *              *-------------------------------------------------*
      *              * Preparazione pathname modulo oggetto            *
      *              *-------------------------------------------------*
           move      "sec/tns/fls/ioc/obj/iofhap"
                                          to   f-xxx-obj              .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "/abd/azi/eco/hap"   to   f-xxx-pat              .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhpx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhpt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "NUMPTT    "         to   f-key                  .
           move      zero                 to   rf-hap-num-ptt         .
           move      "sec/tns/fls/ioc/obj/iofhap"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPTT    "         to   f-key                  .
           move      rf-hap-num-ptt       to   rf-hpx-num-ptt         .
           move      "sec/tns/fls/ioc/obj/iofhpx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-hpx                 .
      *              *-------------------------------------------------*
      *              * Normalizzazione preliminare [hpt]               *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhpt"
                                          to   s-pat                  .
      ...
      *                  * Ripresa record [hap]                        *
      *                  *---------------------------------------------*
           move      rf-hap-num-ptt       to   rf-hpt-num-ptt         .
           move      rf-hap-des-ptt       to   rf-hpt-des-ptt         .
           move      rf-hap-ide-dat       to   rf-hpt-ide-dat         .
           move      rf-hap-ide-ute       to   rf-hpt-ide-ute         .
           move      rf-hap-ide-fas       to   rf-hpt-ide-fas         .
           move      rf-hap-dat-ipt       to   rf-hpt-dat-ipt         .
           move      rf-hap-dat-cpt       to   rf-hpt-dat-cpt         .
           move      rf-hap-num-cnf       to   rf-hpt-num-cnf         .
           move      rf-hap-tip-pro       to   rf-hpt-tip-pro         .
           move      rf-hap-cod-pro       to   rf-hpt-cod-pro         .
           move      rf-hap-cod-spr       to   rf-hpt-cod-spr         .
           move      rf-hap-cod-ist       to   rf-hpt-cod-ist         .
           move      rf-hap-cod-cnf       to   rf-hpt-cod-cnf         .
           move      rf-hap-cod-mag       to   rf-hpt-cod-mag         .
           move      rf-hap-udm-ptt       to   rf-hpt-udm-ptt         .
           move      rf-hap-ccl-rif       to   rf-hpt-ccl-rif         .
           move      rf-hap-cct-rif       to   rf-hpt-cct-rif         .
           move      rf-hap-cna-rif       to   rf-hpt-cna-rif         .
           move      rf-hap-csf-rif       to   rf-hpt-csf-rif         .
           move      rf-hap-dsf-rif       to   rf-hpt-dsf-rif         .
           move      rf-hap-phx-min       to   rf-hpt-phx-min         .
           move      rf-hap-phx-max       to   rf-hpt-phx-max         .
           move      rf-hap-per-h2o       to   rf-hpt-per-h2o         .
           move      rf-hap-cns-oss       to   rf-hpt-cns-oss         .
           move      rf-hap-dns-rif       to   rf-hpt-dns-rif         .
           move      rf-hap-res-105       to   rf-hpt-res-105         .
           move      rf-hap-res-600       to   rf-hpt-res-600         .
           move      rf-hap-mat-sed       to   rf-hpt-mat-sed         .
           move      rf-hap-tbl-915       to   rf-hpt-tbl-915         .
           move      rf-hap-alt-met       to   rf-hpt-alt-met         .
           move      rf-hap-alt-sos       to   rf-hpt-alt-sos         .
           move      rf-hap-cod-imb       to   rf-hpt-cod-imb         .
           move      rf-hap-qta-imb       to   rf-hpt-qta-imb         .
           move      rf-hap-tip-tra       to   rf-hpt-tip-tra         .
           move      rf-hap-cod-tra       to   rf-hpt-cod-tra         .
           move      rf-hap-au1-tra       to   rf-hpt-au1-tra         .
           move      rf-hap-au2-tra       to   rf-hpt-au2-tra         .
           move      rf-hap-tip-ptt       to   rf-hpt-tip-ptt         .
           move      rf-hap-new-ist       to   rf-hpt-new-ist         .
           move      rf-hap-cnf-int       to   rf-hpt-cnf-int         .
           move      rf-hap-snx-adr       to   rf-hpt-snx-adr         .
           move      rf-hap-cla-adr       to   rf-hpt-cla-adr         .
           move      rf-hap-snx-trt       to   rf-hpt-snx-trt         .
           move      rf-hap-cla-ad2       to   rf-hpt-cla-ad2         .
           move      rf-hap-cod-onu       to   rf-hpt-cod-onu         .
           move      rf-hap-num-lot       to   rf-hpt-num-lot         .
           move      rf-hap-cod-tlv       to   rf-hpt-cod-tlv         .
           move      rf-hap-alx-exp       to   rf-hpt-alx-exp         .
      *                  *---------------------------------------------*
      *                  * Ripresa record [hpx]                        *
      *                  *---------------------------------------------*
______*    move      rf-hpx-num-cnf       to   rf-hpt-num-cnf         .
           move      rf-hpx-cod-cee       to   rf-hpt-cod-cee         .
           move      rf-hpx-cod-ddr       to   rf-hpt-cod-ddr         .
           move      rf-hpx-cod-cpe       to   rf-hpt-cod-cpe         .
           move      rf-hpx-cod-cli       to   rf-hpt-cod-cli         .
           move      rf-hpx-dpz-cli       to   rf-hpt-dpz-cli         .
           move      rf-hpx-tip-dsn       to   rf-hpt-tip-dsn         .
           move      rf-hpx-cod-dsn       to   rf-hpt-cod-dsn         .
           move      rf-hpx-cod-sds       to   rf-hpt-cod-sds         .
           move      rf-hpx-aut-sds       to   rf-hpt-aut-sds         .
       exe-cnv-hap-700.
      *              *-------------------------------------------------*
      *              * Scrittura [hpt]                                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-cnv-hap-900.
      *              *-------------------------------------------------*
      *              * Delete file [old-hap] e scrittura rullino       *
      *              * messaggi                                        *
      *              *-------------------------------------------------*
