      ...
      *                                   Fase:    fbgmmv              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 26/06/05    *
      *                       Ultima revisione:    NdK del 29/06/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Pulizia LIFO 2005 e riporto negli esercizi  *
      *                    precedenti                                  *
      *                                                                *
      *                    N.B.: presume prima il lancio di 'mag770' e *
      *                          di 'mag780'                           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   RICOSTRUZIONE LIFO 2005 MAGAZZINO    "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per bufferizzazione LIFO 2005                    *
      *        *-------------------------------------------------------*
           05  w-det-ese-105.
      *            *---------------------------------------------------*
      *            * Castelletto saldi 10 esercizi                     *
      *            *---------------------------------------------------*
               10  w-det-ese-105-cst.
                   15  w-det-ese-105-ele occurs 10.
                       20  w-det-ese-105-rim
                                          pic s9(08)v9(03)            .
                       20  w-det-ese-105-ump
                                          pic  9(11)                  .
                       20  w-det-ese-105-vnb
                                          pic  9(11)                  .
                       20  w-det-ese-105-fdr
                                          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Comodi                                            *
      *            *---------------------------------------------------*
               10  w-det-ese-105-ctr      pic  9(02)                  .
               10  w-det-ese-105-inx      pic  9(02)                  .
               10  w-det-ese-105-scg      pic  9(02)                  .
               10  w-det-ese-105-val      pic  9(11)                  .
...
______*              move  "#"            to   w-cnt-prn-flg-sub      .
      ...
      *
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Rivalutazione scaglioni LIFO esercizio 2005     *
      *              *-------------------------------------------------*
______*    perform   rvl-ese-105-000      thru rvl-ese-105-999        .
       prn-liv-det-150.
      *              *-------------------------------------------------*
      *              * Bufferizzazione scaglioni LIFO esercizio 2005   *
      *              *-------------------------------------------------*
           perform   buf-ese-105-000      thru buf-ese-105-999        .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Determinazione indice di posizionamento     *
      *                  *---------------------------------------------*
           move      zero                 to   w-det-ese-105-inx      .
           subtract  w-wrk-ctr-ese        from 105
                                        giving w-det-ese-105-inx      .
      *                  *---------------------------------------------*
      *                  * Ciclo di aggiornamento                      *
      *                  *---------------------------------------------*
           move      zero                 to   w-det-ese-105-ctr      .
       agg-scg-lif-620.
           add       1                    to   w-det-ese-105-ctr      .
           add       1                    to   w-det-ese-105-inx      .
           if        w-det-ese-105-inx    >    10
                     go to agg-scg-lif-700.
           if        w-det-ese-105-ctr    >    10
                     go to agg-scg-lif-700.
      *
           move      w-det-ese-105-rim
                    (w-det-ese-105-inx)   to   rf-mmv-rim-pre
                                              (w-det-ese-105-ctr)     .
           move      w-det-ese-105-ump
                    (w-det-ese-105-inx)   to   rf-mmv-ump-pre
                                              (w-det-ese-105-ctr)     .
           move      w-det-ese-105-vnb
                    (w-det-ese-105-inx)   to   rf-mmv-vnb-pre
                                              (w-det-ese-105-ctr)     .
           move      w-det-ese-105-fdr
                    (w-det-ese-105-inx)   to   rf-mmv-fdr-pre
                                              (w-det-ese-105-ctr)     .
      *
      ...
      *              *-------------------------------------------------*
       ...
       buf-ese-105-200.
           add       1                    to   w-det-ese-105-ctr      .
           if        w-det-ese-105-ctr    >    10
                     go to buf-ese-105-400.
      *
           move      zero                 to   w-det-ese-105-rim
                                              (w-det-ese-105-ctr)     .
           move      zero                 to   w-det-ese-105-ump
                                              (w-det-ese-105-ctr)     .
           move      zero                 to   w-det-ese-105-vnb
                                              (w-det-ese-105-ctr)     .
           move      spaces               to   w-det-ese-105-fdr
                                              (w-det-ese-105-ctr)     .
      *
           go to     buf-ese-105-200.
       buf-ese-105-400.
      *              *-------------------------------------------------*
      *              * Normalizzazione record [mmv]                    *
      *              *-------------------------------------------------*
      ...
      *
           move      rf-mmv-rim-pre
                    (w-det-ese-105-ctr)   to   w-det-ese-105-rim
                                              (w-det-ese-105-ctr)     .
           move      rf-mmv-ump-pre
                    (w-det-ese-105-ctr)   to   w-det-ese-105-ump
                                              (w-det-ese-105-ctr)     .
           move      rf-mmv-vnb-pre
                    (w-det-ese-105-ctr)   to   w-det-ese-105-vnb
                                              (w-det-ese-105-ctr)     .
           move      rf-mmv-fdr-pre
                    (w-det-ese-105-ctr)   to   w-det-ese-105-fdr
                                              (w-det-ese-105-ctr)     .
      *
           go to     buf-ese-105-620.
       buf-ese-105-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     buf-ese-105-999.
       buf-ese-105-999.
           exit.
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to rvl-ese-105-900.
       rvl-ese-105-200.
      *              *-------------------------------------------------*
      *              * Ciclo di determinazione del valore piu' basso   *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-ese-105-scg      .
           move      zero                 to   w-det-ese-105-val      .
           move      zero                 to   w-det-ese-105-ctr      .
       rvl-ese-105-220.
           add       1                    to   w-det-ese-105-ctr      .
           if        w-det-ese-105-inx    >    10
                     go to rvl-ese-105-700.
           if        rf-mmv-rim-pre
                    (w-det-ese-105-ctr)   <    w-det-ese-105-val
                     move  rf-mmv-rim-pre
                          (w-det-ese-105-ctr)
                                          to   w-det-ese-105-val
                     move  w-det-ese-105-ctr
                                          to   w-det-ese-105-scg      .
      *
           go to     rvl-ese-105-220.
       rvl-ese-105-700.
      *              *-------------------------------------------------*
      *              * Ciclo di rivalutazione                          *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-ese-105-scg      .
           move      zero                 to   w-det-ese-105-val      .
           move      zero                 to   w-det-ese-105-ctr      .
