      ...
      *                                   Fase:    cnvztl              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 26/08/14    *
      *                       Ultima revisione:    NdK del 26/08/14    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Conversione anagraf. listino P ZATTI Srl"       .
      ...
      *            * Codice prodotto                                   *
      *            *---------------------------------------------------*
               10  w-lds-001-cod-pro      pic  x(09)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Listino base lordo                                *
      *            *---------------------------------------------------*
               10  w-lds-001-prz-lsb      pic  x(07)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      "/abd/asc/tmp/listino_new.csv"
                                          to   rr-pth-inp             .
       acc-pth-inp-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      ...
      *                  *---------------------------------------------*
______*    move      w-lds-001-cod-pro    to   w-det-num-pro-alf      .
______*    perform   det-num-pro-000      thru det-num-pro-999        .
      ...
      *                          *-------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      09                   to   v-car                  .
           move      w-lds-001-cod-pro    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *
           ...
           move      rf-dcp-prz-lst       to   w-det-num-pro-prz      .
      ...
      *                  * Prezzo                                      *
      *                  *---------------------------------------------*
           if        w-det-lst-bas-prz    =    zero
                     move  w-det-num-pro-prz
                                          to   rf-lst-prz-lst
           else      move  w-det-lst-bas-prz
                                          to   rf-lst-prz-lst         .
      *                  *---------------------------------------------*
      *                  * % di provvigione                            *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-det-num-pro-prz      .
       det-num-pro-100.
      *              *-------------------------------------------------*
