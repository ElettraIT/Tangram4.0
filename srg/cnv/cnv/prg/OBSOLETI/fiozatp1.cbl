      ...
      *                       Ultima revisione:    NdK del 20/05/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione file per Fiocchi : parte FIOCCHI  *
      *                                                                *
      *                    /abd/asc/exp/AAAAMMGG.SQZ                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Estrazione anafrafiche prodotti da Zatti"       .
      ...
      *            * Area                                              *
      *            *---------------------------------------------------*
               10  w-lds-001-are-ges      pic  x(04)                  .
      *            *---------------------------------------------------*
      *            * Record prodotto                                   *
      *            *---------------------------------------------------*
               10  w-lds-001-are-rec.
                   15  filler occurs 635  pic  x(01)                  .
      ...
      *                  *---------------------------------------------*
           if        w-lds-001-are-ges    =    "dcp "
                     go to xcv-trt-pds-200
           else if   w-lds-001-are-ges    =    "aaq "
                     go to xcv-trt-pds-500
           else if   w-lds-001-are-ges    =    "aaf "
      ...
      *              *-------------------------------------------------*
           move      w-enc-dcp-val-pos    to   w-det-num-pro-num      .
       xcv-trt-pds-400.
      *              *-------------------------------------------------*
      *              * Trattamento record [dcp]                        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * Ripresa del record                          *
      *                  *---------------------------------------------*
           move      w-lds-001-are-rec    to   rf-dcp                 .
      *                  *---------------------------------------------*
      *                  * Chiave primaria                             *
      *                  *---------------------------------------------*
      ...
      *                  * Ripresa del record                          *
      *                  *---------------------------------------------*
           move      w-lds-001-are-rec    to   rf-aaq                 .
      *                  *---------------------------------------------*
      *                  * Chiave primaria                             *
      *                  *---------------------------------------------*
           move      w-det-num-pro-num    to   rf-aaq-num-pro         .
      *                  *---------------------------------------------*
      *                  * Normalizzazione codice casa produttrice     *
      *                  *---------------------------------------------*
      ...
      *                  * Ripresa del record                          *
      *                  *---------------------------------------------*
           move      w-lds-001-are-rec    to   rf-aaf                 .
      *                  *---------------------------------------------*
      *                  * Chiave primaria                             *
      *                  *---------------------------------------------*
      ...
      *
           string    "ncftpget -V -e /abd/asc/log/fiozatp1.log -u master
      -              " -p alter1 100.100.100.1 /abd/asc/exp /abd/asc/exp
      -              "/"        delimited by   size
                     w-det-nom-arc-ann
                                delimited by   size
                     w-det-nom-arc-mes
