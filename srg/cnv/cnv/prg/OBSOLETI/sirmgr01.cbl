      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sistemazione descrizione righe [mgr] : SIRI *
      *                                                                *
      * _____ MAI IMPLEMENTATO _____                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Sistemazione descriz. righe [mgr] - SIRI"       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1101220              to   rf-mgr-dat-reg         .
      ...
      *              *-------------------------------------------------*
           multiply  rf-mgr-qta-mov       by   rf-mgr-cun-mov
                                        giving rf-mgr-val-mov         .
      *              *-------------------------------------------------*
      *              * Applicazione decimali gestione magazzino        *
      *              *-------------------------------------------------*
           divide    100                  into rf-mgr-val-mov         .
      *              *-------------------------------------------------*
      *              * Applicazione costo x 1000                       *
      *              *-------------------------------------------------*
           divide    1000                 into rf-mgr-val-mov         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [mgr]                             *
      *              *-------------------------------------------------*
