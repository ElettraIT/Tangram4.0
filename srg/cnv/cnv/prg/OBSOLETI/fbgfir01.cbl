      ...
      *                                   Fase:    fbgfir              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 07/11/01    *
      *                       Ultima revisione:    NdK del 08/04/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [fir] : FORALBERG        *
      *                                                                *
      *                    Sistemazione totale libero 8 da riga di     *
      *                    addebito con codice 15                      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Assestamento per riga addebito - sconto "       .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Lettura testata fattura, con lock               *
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
      ...
      *                      *-----------------------------------------*
      *                      * Rilascio record testata fattura         *
      *                      *-----------------------------------------*
           move      "RL"                 to   f-ope                  .
           move      "pgm/fat/fls/ioc/obj/ioffit"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Accumulo per totale libero 8                *
      *                  *---------------------------------------------*
           add       rf-fir-imp-rig       to   rf-fit-tot-rig (8)     .
      *                  *---------------------------------------------*
      *                  * Update testata fattura                      *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
           move      "pgm/fat/fls/ioc/obj/ioffit"
                                          to   s-pat                  .
