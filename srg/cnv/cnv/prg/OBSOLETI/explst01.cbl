      ...
      *                       Ultima revisione:    NdK del 26/06/00    *
      *                    ------------------------------------------- *
      ...
      *            *---------------------------------------------------*
               10  w-out-dcp-prg-pid      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Carattere di separazione iniziale                 *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-sin      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Aperte virgolette                                 *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-a01      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Descrizione classe merceologica                   *
      *            *---------------------------------------------------*
               10  w-out-dcp-zp1-des      pic  x(25)                  .
      *            *---------------------------------------------------*
      *            * Chiuse virgolette                                 *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-c01      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Carattere di separazione 0                        *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-s00      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Aperte virgolette                                 *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-a02      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice alfanumerico prodotto                      *
      *            *---------------------------------------------------*
               10  w-out-dcp-alf-pro      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Chiuse virgolette                                 *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-c02      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Carattere di separazione 1                        *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-s01      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Aperte virgolette                                 *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-a03      pic  x(01)                  .
      *            *---------------------------------------------------*
      ...
      *            * Chiuse virgolette                                 *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-c03      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Carattere di separazione 2                        *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-s02      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Lotto di vendita                                  *
      *            *---------------------------------------------------*
               10  w-out-dcp-lot-ven.
                   15  w-out-dcp-lot-vea  pic  x(06)                  .
                   15  w-out-dcp-lot-ves  pic  x(01)                  .
                   15  w-out-dcp-lot-veb  pic  x(02)                  .
      *            *---------------------------------------------------*
      *            * Carattere di separazione 3                        *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-s03      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Aperte virgolette                                 *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-a04      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Unita' di misura                                  *
      *            *---------------------------------------------------*
      ...
      *            * Chiuse virgolette                                 *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-c04      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Carattere di separazione 4                        *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-s04      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Listino base                                      *
      *            *---------------------------------------------------*
      ...
      *            * % sconto 1                                        *
      *            *---------------------------------------------------*
               10  w-out-dcp-per-sc1.
                   15  w-out-dcp-per-sa1  pic  x(02)                  .
                   15  w-out-dcp-per-sv1  pic  x(01)                  .
                   15  w-out-dcp-per-sb1  pic  x(01)                  .
      *            *---------------------------------------------------*
      ...
      *            * % sconto 2                                        *
      *            *---------------------------------------------------*
               10  w-out-dcp-per-sc2.
                   15  w-out-dcp-per-sa2  pic  x(02)                  .
                   15  w-out-dcp-per-sv2  pic  x(01)                  .
                   15  w-out-dcp-per-sb2  pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Carattere di separazione 7                        *
      *            *---------------------------------------------------*
               10  w-out-dcp-chr-s07      pic  x(01)                  .
      *            *---------------------------------------------------*
...
______*        10  w-out-dcp-fin-rig      pic  x(01)                  .
      ...
      *                  *---------------------------------------------*
           move      """"                 to   w-out-dcp-chr-a01      .
           move      """"                 to   w-out-dcp-chr-c01      .
           move      """"                 to   w-out-dcp-chr-a02      .
           move      """"                 to   w-out-dcp-chr-c02      .
           move      """"                 to   w-out-dcp-chr-a03      .
           move      """"                 to   w-out-dcp-chr-c03      .
           move      """"                 to   w-out-dcp-chr-a04      .
           move      """"                 to   w-out-dcp-chr-c04      .
      *                  *---------------------------------------------*
      ...
      *                      * Se 'TAB'                                *
      *                      *-----------------------------------------*
           move      H"09"                to   w-out-dcp-chr-sin      .
           ...
           move      spaces               to   w-out-dcp-chr-s07      .
      *                      *-----------------------------------------*
      *                      * A composizione record in output         *
      *                      *-----------------------------------------*
           go to     exe-exp-dcp-740.
      ...
      *                      *-----------------------------------------*
           move      v-edt                to   w-out-dcp-prg-pid      .
      *                  *---------------------------------------------*
      *                  * Descrizione classe merceologica             *
      *                  *---------------------------------------------*
      ...
      *                  * Lotto di vendita                            *
      *                  *---------------------------------------------*
           move      rf-dcp-lot-ven (1:6) to   w-out-dcp-lot-vea      .
           move      "."                  to   w-out-dcp-lot-ves      .
           move      rf-dcp-lot-ven (7:2) to   w-out-dcp-lot-veb      .
      *                  *---------------------------------------------*
      *                  * Unita' di misura                            *
      *                  *---------------------------------------------*
      ...
      *                  * Sconto 1                                    *
      *                  *---------------------------------------------*
           move      rf-dcp-per-scr (1)   to   w-ass-per-scr          .
           move      w-ass-per-scr (1:2)  to   w-out-dcp-per-sa1      .
           move      ","                  to   w-out-dcp-per-sv1      .
           move      w-ass-per-scr (3:1)  to   w-out-dcp-per-sb1      .
      *                  *---------------------------------------------*
      *                  * Sconto 2                                    *
      *                  *---------------------------------------------*
           move      rf-dcp-per-scr (2)   to   w-ass-per-scr          .
           move      w-ass-per-scr (1:2)  to   w-out-dcp-per-sa2      .
           move      "."                  to   w-out-dcp-per-sv2      .
           move      w-ass-per-scr (3:1)  to   w-out-dcp-per-sb2      .
      *                  *---------------------------------------------*
      *                  * CR + LF                                     *
      *                  *---------------------------------------------*
