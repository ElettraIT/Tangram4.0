      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione file per SCHEMA 2 : parte ZATTI   *
      *                                                                *
      *                    Scrittura di /abd/asc/tmp/ZTTGCZ.SQZ        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Estrazione dati giacenza ZATTI Srl   "       .
      ...
      *            *---------------------------------------------------*
               ...
               10  filler                 pic  x(01)                  .
               10  w-out-gen-gia-d01      pic  x(15)                  .
               10  filler                 pic  x(01)                  .
               10  w-out-gen-gia-d02      pic  x(15)                  .
      *            *---------------------------------------------------*
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Creazione archivio giacenze per SCHEMA 2"  .
      ...
      *                  * In campo di destinazione                    *
      *                  *---------------------------------------------*
           move      p-edt                to   w-out-gen-gia-d01      .
       prn-liv-det-540.
      *                  *---------------------------------------------*
      *                  * Giacenza Verona (dipendenza 02)             *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Parametri                               *
      *                      *-----------------------------------------*
      ...
      *                  * In campo di destinazione                    *
      *                  *---------------------------------------------*
           move      p-edt                to   w-out-gen-gia-d02      .
       prn-liv-det-580.
      *                  *---------------------------------------------*
