      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Conversione file Fornitori (SRC --> SEAV)   *
      *                                                                *
      *                    ___ MAI COMPLETATO ___                      *
      *                                                                *
      *================================================================*
      ...
      *    * File Control [fnt]                                        *
      *    *-----------------------------------------------------------*
           select  optional  fnt   assign to disk           f-fnt-pat
                             organization is indexed
                             access mode  is dynamic
                             record key   is fnt-k01
                   alternate record key   is fnt-k02
                   alternate record key   is fnt-k03
                   alternate record key   is fnt-k04
                   alternate record key   is fnt-k05
                   alternate record key   is fnt-k06
                             file status  is                f-fnt-sts .
      ...
      *    *===========================================================*
      *    * File Description [fnt]                                    *
      *    *-----------------------------------------------------------*
       fd  fnt       label record standard                            .
      ...
      *            *---------------------------------------------------*
               10  fnt-k01.
                   15  fnt-cod-fnt        pic  9(07)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 02 : DATSYS                         *
      *            *---------------------------------------------------*
               10  fnt-k02.
                   15  fnt-ide-dat        pic  9(07)       comp-3     .
                   15  fnt-cod-fnt-2      pic  9(07)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 03 : RAGKEY                         *
      *            *---------------------------------------------------*
               10  fnt-k03.
                   15  fnt-rag-key        pic  x(40)                  .
                   15  fnt-cod-fnt-3      pic  9(07)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 04 : CODMNE                         *
      *            *---------------------------------------------------*
               10  fnt-k04.
                   15  fnt-cod-mne        pic  x(10)                  .
                   15  fnt-cod-fnt-4      pic  9(07)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 05 : PRTIVA                         *
      *            *---------------------------------------------------*
               10  fnt-k05.
                   15  fnt-prt-iva        pic  9(11)       comp-3     .
                   15  fnt-cod-fnt-5      pic  9(07)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 06 : CODFIS                         *
      *            *---------------------------------------------------*
               10  fnt-k06.
                   15  fnt-cod-fis        pic  x(16)                  .
                   15  fnt-cod-fnt-6      pic  9(07)       comp-3     .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  fnt-dat.
               10  fnt-ide-ute            pic  x(08)                  .
               10  fnt-ide-fas            pic  x(06)                  .
               10  fnt-rag-soc            pic  x(40)                  .
               10  fnt-via-fnt            pic  x(40)                  .
               10  fnt-loc-fnt            pic  x(40)                  .
               10  fnt-cod-naz            pic  x(03)                  .
               10  fnt-cod-cmn            pic  9(05)       comp-3     .
               10  fnt-cod-fzn            pic  9(03)       comp-3     .
               10  fnt-cod-lct            pic  9(03)       comp-3     .
               10  fnt-num-tel            pic  x(20)                  .
               10  fnt-num-fax            pic  x(20)                  .
               10  fnt-num-tlx            pic  x(20)                  .
               10  fnt-nom-int            pic  x(30)                  .
               10  fnt-cod-iva            pic  9(05)       comp-3     .
               10  fnt-snx-a13            pic  x(01)                  .
               10  fnt-cod-cge            pic  9(07)       comp-3     .
               10  fnt-alx-exp.
      ...
      *    *-----------------------------------------------------------*
       01  f-fnt.
           05  f-fnt-nam                  pic  x(04)                  .
           05  f-fnt-pat                  pic  x(40)                  .
           05  f-fnt-sts                  pic  x(02)                  .
      ...
      *              * Conversione [fnt]                               *
      *              *-------------------------------------------------*
           perform   exe-cnv-fnt-000      thru exe-cnv-fnt-999        .
       exe-cnv-fil-800.
      *              *-------------------------------------------------*
      ...
      *              * Start su [old-fnt]                              *
      *              *-------------------------------------------------*
           move      8                   to   fnt-cod-fnt             .
           start     fnt    key not less
                            fnt-k01
                            invalid key
                            go to exe-cnv-fnt-800.
       exe-cnv-fnt-250.
      *              *-------------------------------------------------*
      *              * Next su [old-fnt]                               *
      *              *-------------------------------------------------*
           read      fnt    next
                            ...
                            go to exe-cnv-fnt-800.
      *
           if        fnt-cod-fnt         =     0000700 or
                     fnt-cod-fnt         =     0000701 or
                     fnt-cod-fnt         =     0000702 or
                     fnt-cod-fnt         =     0000703 or
                     fnt-cod-fnt         =     0000704 or
                     fnt-cod-fnt         =     0000705 or
                     fnt-cod-fnt         =     0000706 or
                     fnt-cod-fnt         =     0000707
                     go to exe-cnv-fnt-250.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-cnv-fnt-300.
      *              *-------------------------------------------------*
      *              * Normalizzazione preliminare [new-fnt]           *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      f-xxx-obj            to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      fnt-ide-dat          to   rf-fnt-ide-dat         .
           move      fnt-ide-ute          to   rf-fnt-ide-ute         .
           move      fnt-ide-fas          to   rf-fnt-ide-fas         .
           move      fnt-cod-fnt          to   rf-fnt-cod-fnt         .
           move      fnt-cod-mne          to   rf-fnt-cod-mne         .
           move      fnt-rag-key          to   rf-fnt-rag-key         .
           move      fnt-rag-soc          to   rf-fnt-rag-soc         .
           move      fnt-via-fnt          to   rf-fnt-via-fnt         .
           move      fnt-loc-fnt          to   rf-fnt-loc-fnt         .
           move      fnt-cod-naz          to   rf-fnt-cod-naz         .
           move      fnt-cod-cmn          to   rf-fnt-cod-cmn         .
           move      fnt-cod-fzn          to   rf-fnt-cod-fzn         .
           move      fnt-cod-lct          to   rf-fnt-cod-lct         .
           move      fnt-num-tel          to   rf-fnt-num-tel         .
           move      fnt-num-fax          to   rf-fnt-num-fax         .
           move      fnt-num-tlx          to   rf-fnt-num-tlx         .
           move      fnt-nom-int          to   rf-fnt-nom-int         .
           move      fnt-cod-iva          to   rf-fnt-cod-iva         .
           move      fnt-prt-iva          to   rf-fnt-prt-iva         .
           move      fnt-cod-fis          to   rf-fnt-cod-fis         .
           move      fnt-snx-a13          to   rf-fnt-snx-a13         .
           move      fnt-cod-cge          to   rf-fnt-cod-cge         .
           move      fnt-alx-exp          to   rf-fnt-alx-exp         .
       exe-cnv-fnt-700.
      *              *-------------------------------------------------*
      *              * Scrittura [new-fnt]                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-cnv-fnt-900.
      *              *-------------------------------------------------*
      *              * Delete file [old-fnt] e scrittura rullino       *
      *              * messaggi                                        *
      *              *-------------------------------------------------*
      ...
      *              * Copia iniziale                                  *
      *              *-------------------------------------------------*
           move      "cp /abd/azi/src/fnt /abd/azi/seav/fnt"
                                          to   o-shs                  .
      *              *-------------------------------------------------*
