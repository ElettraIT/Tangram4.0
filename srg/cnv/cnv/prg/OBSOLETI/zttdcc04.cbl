      ...
      *                       Ultima revisione:    NdK del 09/05/05    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Aggiornamento spese incasso - Zatti  "       .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Normalizzazione forma di pagamento              *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "pgm/dcc/fls/ioc/obj/iofzfp"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
      *              * Test se codice di pagamento                     *
      *              *-------------------------------------------------*
           if        rf-zfp-cod-pag (1)   =    zero
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Normalizzazione codice di pagamento             *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "pgm/gep/fls/ioc/obj/iofzpg"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zfp-cod-pag (1)   to   rf-zpg-cod-pag         .
           move      "pgm/gep/fls/ioc/obj/iofzpg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test se incasso elettronico, Mav, RiBa          *
      *              *-------------------------------------------------*
           if        rf-zpg-tip-pag       =    01 or
                     rf-zpg-tip-pag       =    04 or
                     rf-zpg-tip-pag       =    06 or
                     rf-zpg-tip-pag       =    07 or
                     rf-zpg-tip-pag       =    08 or
                     rf-zpg-tip-pag       =    09 or
                     rf-zpg-tip-pag       =    10 or
                     rf-zpg-tip-pag       =    11
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Aggiornamento spese incasso                     *
      *              *-------------------------------------------------*
           move      "S  "                to   rf-dcc-add-spi         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [dcc]                             *
      *              *-------------------------------------------------*
