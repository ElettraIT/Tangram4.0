      ...
      *                                   Fase:    cgemgs              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 19/01/06    *
      *                       Ultima revisione:    NdK del 19/01/06    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ricostruzione saldi contabili (BETA)        *
      *                                                                *
      *                    ____ DA IMPLEMENTARE ___ (da cge930)        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " RICOSTRUZIONE SALDI [mgs] DA MOVIMENTI "       .
      ...
      *
           if        w-det-dif-cge-in1    =    01
                     move  "Gennaio  "    to   w-all-str-cat (1)
           else if   w-det-dif-cge-in1    =    02
                     move  "Febbraio "    to   w-all-str-cat (1)
           else if   w-det-dif-cge-in1    =    03
                     move  "Marzo    "    to   w-all-str-cat (1)
           else if   w-det-dif-cge-in1    =    04
                     move  "Aprile   "    to   w-all-str-cat (1)
           else if   w-det-dif-cge-in1    =    05
                     move  "Maggio   "    to   w-all-str-cat (1)
           else if   w-det-dif-cge-in1    =    06
                     move  "Giugno   "    to   w-all-str-cat (1)
           else if   w-det-dif-cge-in1    =    07
                     move  "Luglio   "    to   w-all-str-cat (1)
           else if   w-det-dif-cge-in1    =    08
                     move  "Agosto   "    to   w-all-str-cat (1)
           else if   w-det-dif-cge-in1    =    09
                     move  "Settembre"    to   w-all-str-cat (1)
           else if   w-det-dif-cge-in1    =    10
                     move  "Ottobre  "    to   w-all-str-cat (1)
           else if   w-det-dif-cge-in1    =    11
                     move  "Novembre "    to   w-all-str-cat (1)
           else if   w-det-dif-cge-in1    =    12
                     move  "Dicembre "    to   w-all-str-cat (1)
