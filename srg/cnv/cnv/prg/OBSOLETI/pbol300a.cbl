      ...
      *                       Ultima revisione:    NdK del 29/01/10    *
      *                    ------------------------------------------- *
      ...
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
           move      "Attenzione : superati le 900 righe massime consent
      ...
      *                      * un'esenzione                            *
      *                      *-----------------------------------------*
           if        w-let-arc-cli-ass    >    00300 and
                     w-let-arc-cli-ass    <    00700
      ...
      *                  *---------------------------------------------*
           move      w-acc-tmo-orc        to   w-bla-emb-str          .
           move      05                   to   w-bla-emb-max          .
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-acc-tmo-bol        to   w-bla-emb-str          .
           move      05                   to   w-bla-emb-max          .
           perform   tst-bla-emb-000      thru tst-bla-emb-999        .
           if        w-bla-emb-flg        not  = spaces
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-ocr-sgl-vrn       to   w-det-prm-ubi-var      .
           perform   det-prm-ubi-000      thru det-prm-ubi-999        .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione ubicazione              *
      *                      *-----------------------------------------*
           move      w-det-prm-ubi-lit    to   w-buf-rig-orc-ubi-11
                                              (w-buf-rig-orc-ctr)     .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione codice prodotto         *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "[PF1] - Tasto Funzione 1 per saldo riga ordine con
      ...
      *                          *-------------------------------------*
           if       (w-tes-ass-iva (1)    =    zero    ) and
                    (w-rig-coi-rig (1)    >    00300 and
                     w-rig-coi-rig (1)    <    00700   )
                     go to car-rig-cat-550
           else if  (w-tes-ass-iva (1)    >    zero   ) and
                    (w-rig-coi-rig (1)    <    00300 or
                     w-rig-coi-rig (1)    >    00700  )
