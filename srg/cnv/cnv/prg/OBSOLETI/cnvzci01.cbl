      ...
      *                                   Fase:    cnvzci              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 04/01/00    *
      *                       Ultima revisione:    NdK del 29/05/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Mnemonico codice Iva e aliquota             *
      *                                                                *
      *                    STANDARD (Tangram 4.9)                      *
      *                                                                *
      *                    ___ UTILIZZARE SE CONCLUSA ANALISI          *
      *                    ___ SU CODICI IVA CON DECIMALI              *
      *                                                                *
      *================================================================*
      ...
      *              * Test se > 1000                                  *
      *              *-------------------------------------------------*
           if        rf-zci-cod-iva       >    1000
                     go to prn-liv-det-300.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Assegnazione mnemonico                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
            move     w-all-str-alf        to   rf-zci-cod-mne         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [zci]                             *
      *              *-------------------------------------------------*
