      ...
      *                                                                *
      *                    Update per sistemazione Schede LIFO 2004    *
      *                                                                *
      *                    scaglione 1995 (IX) - FORALBERG             *
      *                                                                *
      *                    Rilettura saldo giacenza al 31/12/95        *
      *                                                                *
      *                    Richiesto da Mirco e Gianni (28/02/05)      *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
      *              * Start su archivio [mmv] per anno 2004           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "ESECOD    "         to   f-key                  .
           move      104                  to   rf-mmv-ann-ese         .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-mmv                 .
      *              *-------------------------------------------------*
      *              * Lettura record [mmv] per anno 2004              *
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "ESECOD    "         to   f-key                  .
      ...
      *              *-------------------------------------------------*
           if        d-sld-mag-sld-mag    =    rf-mmv-rim-pre (09)
                     go to agg-rec-mmv-800.
           if        d-sld-mag-sld-mag    not  < zero and
                     rf-mmv-ump-pre (09)  >    zero
                     move  d-sld-mag-sld-mag
                                          to   rf-mmv-rim-pre (09)    .
       agg-rec-mmv-700.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
