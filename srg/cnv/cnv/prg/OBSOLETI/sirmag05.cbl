      ...
      *              * Ciclo per [bft]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-mmt-000  thru stp-srt-inp-mmt-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      1060515              to   rf-mmt-dat-reg         .
      ...
      *              *-------------------------------------------------*
           if        rf-mmt-cod-cau       not  = 00100
                     go to stp-srt-inp-mmt-200.
       stp-srt-inp-mmt-600.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-mmt-num-prt       to   srt-prt-mag            .
           move      rf-mmt               to   srt-dat-rec            .
       stp-srt-inp-mmt-700.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-mmt-dat-reg       to   rf-bft-dat-reg         .
      ...
      *              * Test max su [bft]                               *
      *              *-------------------------------------------------*
           if        rf-bft-dat-reg       not  = rf-mmt-dat-reg
                     go to prn-liv-det-800.
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Sel su [bft]                                    *
      *              *-------------------------------------------------*
           if        rf-bft-prt-mag       not  = rf-mmt-num-prt
