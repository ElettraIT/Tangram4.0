      ...
      *                                   Fase:    tmimmv              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 02/05/01    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Pulizia costo standard - 2001 - TEMI        *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
      *                  * Data costo standard per tutto l'esercizio   *
      *                  *---------------------------------------------*
           move      zero                 to   rf-mmv-dst-gea         .
      *                  *---------------------------------------------*
      *                  * Costo standard per tutto l'esercizio        *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       agg-rec-mmv-220.
           add       1                    to   w-ctl-utz-num-ctr      .
           if        w-ctl-utz-num-ctr    >    12
                     go to agg-rec-mmv-400.
      *                  *---------------------------------------------*
      *                  * Data costo standard del mese                *
      *                  *---------------------------------------------*
           move      zero                 to   rf-mmv-dst-mns
                                              (w-ctl-utz-num-ctr)     .
      *                  *---------------------------------------------*
      *                  * Costo standard del mese                     *
      *                  *---------------------------------------------*
           move      zero                 to   rf-mmv-ust-mns
                                              (w-ctl-utz-num-ctr)     .
           go to     agg-rec-mmv-220.
       agg-rec-mmv-400.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
