      ...
      *                       Ultima revisione:    NdK del 09/02/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione file per Fiocchi : parte ZATTI    *
      *                                                                *
      *                    in Crontab nel Server ZATTI                 *
      *                                                                *
      *                    Scrittura in /abd/asc/exp/AAAAMMGG.SQZ      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Estrazione anagrafiche prodotti da Zatti"       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Creazione archivio prodotti per Bologna "  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-nrg-dat-dtd    to   rf-dcp-ide-dat         .
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-aaq                 .
      *                  *---------------------------------------------*
      *                  * Se record [aaq] non trovato : ad uscita     *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-liv-det-900.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-aaf                 .
      *                  *---------------------------------------------*
      *                  * Se record [aaf] non trovato : ad uscita     *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-liv-det-900.
       prn-liv-det-250.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se prodotti Florissima                 *
      *                  *---------------------------------------------*
           if        rf-aaq-dcf-pfz       not  = 0080264
                     go to prn-liv-det-900.
       prn-liv-det-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "dcp "               to   w-out-gen-tip-rec      .
           move      rf-dcp               to   w-out-gen-int-rec      .
      ...
      *              * Composizione record in output                   *
      *              *-------------------------------------------------*
           move      "aaf "               to   w-out-gen-tip-rec      .
           move      rf-aaf               to   w-out-gen-int-rec      .
           move      w-det-fin-rig-chr    to   w-out-gen-fin-rig      .
      *              *-------------------------------------------------*
      *              * Scrittura record in output                      *
      *              *-------------------------------------------------*
      ...
      *              * Composizione record in output                   *
      *              *-------------------------------------------------*
           move      "aaq "               to   w-out-gen-tip-rec      .
           move      rf-aaq               to   w-out-gen-int-rec      .
           move      w-det-fin-rig-chr    to   w-out-gen-fin-rig      .
      *              *-------------------------------------------------*
      *              * Scrittura record in output                      *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      spaces               to   w-det-nom-arc-npe      .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-det-nom-arc-mes    to   w-all-str-cat (2)      .
           move      w-det-nom-arc-gio    to   w-all-str-cat (3)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   w-det-nom-arc-npe      .
      *              *-------------------------------------------------*
