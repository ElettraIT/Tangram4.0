      ...
      *                                   Fase:    zttcpv              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 19/07/13    *
      *                       Ultima revisione:    NdK del 19/07/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sistemazione file [cpv] : ZATTI             *
      *                                                                *
      *                    Pulizia catalogo P14 da P15                 *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione presenza prodotto in catalogo      *
      *        *-------------------------------------------------------*
           05  w-det-num-pro.
      *            *---------------------------------------------------*
      *            * Flag di codice trovato                            *
      *            *---------------------------------------------------*
               10  w-det-cpv-pro-flg      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice numerico prodotto                          *
      *            *---------------------------------------------------*
               10  w-det-cpv-pro-num      pic  9(07)                  .
      ...
      *              * Ciclo per [cpv]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-cpv-000  thru stp-srt-inp-cpv-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-cpv-tip-rec       to   srt-tip-rec            .
           move      rf-cpv-cod-cpv       to   srt-cod-cpv            .
           move      rf-cpv-num-pro       to   srt-num-pro            .
           move      rf-cpv-num-prg       to   srt-num-prg            .
      *                  *---------------------------------------------*
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
       stp-srt-inp-cpv-700.
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-cpv-800.
      *                  *---------------------------------------------*
      *                  * Riciclo a record [cpv] successivo           *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-cpv-200.
       stp-srt-inp-cpv-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-cpv-999.
       stp-srt-inp-cpv-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Test su codice prodotto catalogo P15            *
      *              *-------------------------------------------------*
           perform   det-cpv-pro-000      thru det-cpv-pro-999        .
           if        w-det-cpv-pro-flg    =    spaces
      ...
      *              *-------------------------------------------------*
           move      srt-tip-rec          to   rf-cpv-tip-rec         .
           move      srt-cod-cpv          to   rf-cpv-cod-cpv         .
           move      srt-num-pro          to   rf-cpv-num-pro         .
           move      srt-num-prg          to   rf-cpv-num-prg         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *              * Normalizzazione flag di uscita                  *
      *              *-------------------------------------------------*
           move      spaces               to   w-det-cpv-pro-flg      .
       det-cpv-pro-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [cpv] per codice numerico     *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
      ...
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to det-cpv-pro-900.
       det-cpv-pro-200.
      *              *-------------------------------------------------*
      *              * Read-next su archivio [cpv]                     *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcp/fls/ioc/obj/iofcpv"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
       ...
       det-cpv-pro-300.
      *              *-------------------------------------------------*
      *              * Test max su archivio [cpv]                      *
      *              *-------------------------------------------------*
           if        rf-cpv-num-pro       not  = srt-num-pro
                     go to det-cpv-pro-900.
       det-cpv-pro-400.
      *              *-------------------------------------------------*
      *              * Selezione su archivio [cpv]                     *
      *              *-------------------------------------------------*
           if        rf-cpv-cod-cpv       not  = "P15"
                     go to det-cpv-pro-200.
       det-cpv-pro-600.
      *              *-------------------------------------------------*
      *              * Attivazione flag                                *
      *              *-------------------------------------------------*
           move      "#"                  to   w-det-cpv-pro-flg      .
       det-cpv-pro-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     det-cpv-pro-999.
       det-cpv-pro-999.
           exit.
