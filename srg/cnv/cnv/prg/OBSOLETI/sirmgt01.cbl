      ...
      *                                   Fase:    sirmgt              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 03/02/11    *
      *                       Ultima revisione:    NdK del 03/02/11    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sistemazione descrizione causale : SIRI     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Sistemazione descrizione causale - SIRI "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1101220              to   rf-mgt-dat-reg         .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna testata entro i limiti assegnati !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              * Test su causale                                 *
      *              *-------------------------------------------------*
           if        rf-mgt-cod-cau       not  = 00452
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test su descrizione                             *
      *              *-------------------------------------------------*
           if        rf-mgt-des-cau
                    (01 : 32)             not  = "Emissione incasso elet
      -              "tronico al"
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Ricostruzione descrizione                       *
      *              *-------------------------------------------------*
           move      rf-mgt-des-cau
                    (34 : 08)             to   w-wrk-dat-reg          .
           move      spaces               to   rf-mgt-des-cau         .
           move      "Emissione incasso elettr. al"
                                          to   rf-mgt-des-cau
                                              (01 : 28)               .
           move      w-wrk-dat-reg        to   rf-mgt-des-cau
                                              (30 : 08)               .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [mgt]                             *
