      ...
      *                       Ultima revisione:    NdK del 23/11/16    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Forzatura buon esito per alcune RIBA        *
      *                                                                *
      *                    NOBILI                                      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento scadenze clienti - NOBILI"       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1030101              to   rf-sdb-dts-sdb         .
      ...
      *              * Forzature                                       *
      *              *-------------------------------------------------*
           move      rf-sdb-dts-sdb       to   rf-sdb-dtr-sto         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [sdb]                             *
      *              *-------------------------------------------------*
