      ...
      *                                   Fase:    fbgdcp              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 12/11/02    *
      *                       Ultima revisione:    NdK del 12/11/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento Statistico 3 per '5000'       *
      *                                                                *
      *                    Foralberg                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Aggiornamento Statistico 3 per '5000' "       .
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Selezione su classe '50' - negozio              *
      *              *-------------------------------------------------*
           if        rf-dcp-cla-pro       =    00050
                     go to prn-sel-rec-900.
       prn-sel-rec-300.
      *              *-------------------------------------------------*
      *              * Selezione su statistico 3                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           string    "Prodotto : "
                     ...
                     rf-dcp-alf-pro
                                delimited by   spaces
                     " con codice statistico 3 presente"
                                delimited by   size
                                          into m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fbg/dcp"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fbg/dcp.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento statistico 3                      *
      *              *-------------------------------------------------*
           move      00005                to   rf-dcp-cod-s03         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      00005                to   rf-zps-cod-cls         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      "#"                  to   rf-zps-mne-cls         .
           move      "PRODOTTI TIPO 5000  "
                                          to   rf-zps-des-key         .
           move      "Prodotti tipo 5000  "
                                          to   rf-zps-des-cls         .
