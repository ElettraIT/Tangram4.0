      ...
      *                      *-----------------------------------------*
           ...
           move      "senza codice classe Tangram"
                                          to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   m-msg                  .
      *                      *-----------------------------------------*
      *                      * A release con errore                    *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-040.
      *                  *---------------------------------------------*
      *                  * Test di congruenza tra classe Tangram e     *
      *                  * categoria Archimede                         *
      *                  *---------------------------------------------*
           if        rf-dcp-alf-pro (1 : 2)
                                          =    "10" and
                     rf-dcp-cla-pro       =    00900
      ...
      *
           if        rf-dcp-alf-pro (1 : 2)
                                          =    "27" and
                     rf-dcp-cla-pro       =    01700
                     go to prn-liv-det-100.
      *
           if        rf-dcp-alf-pro (1 : 2)
                                          =    "28" and
                     rf-dcp-cla-pro       =    01100
                     go to prn-liv-det-100.
      *
           if        rf-dcp-alf-pro (1 : 2)
                                          =    "29" and
                     rf-dcp-cla-pro       =    00200
                     go to prn-liv-det-100.
      *
           if        rf-dcp-alf-pro (1 : 2)
                                          =    "30" and
      ...
      *
           if        rf-dcp-alf-pro (1 : 2)
                                          =    "31" and
                     rf-dcp-cla-pro       =    01400
                     go to prn-liv-det-100.
      *
           if        rf-dcp-alf-pro (1 : 2)
                                          =    "32" and
                     rf-dcp-cla-pro       =    01300
                     go to prn-liv-det-100.
      *
           if        rf-dcp-alf-pro (1 : 2)
                                          =    "33" and
                     rf-dcp-cla-pro       =    00600
                     go to prn-liv-det-100.
      *
           if        rf-dcp-alf-pro (1 : 2)
                                          =    "34" and
                     rf-dcp-cla-pro       =    00700
                     go to prn-liv-det-100.
      *
           if        rf-dcp-alf-pro (1 : 2)
                                          =    "35" and
                     rf-dcp-cla-pro       =    01500
                     go to prn-liv-det-100.
      *
           if        rf-dcp-alf-pro (1 : 2)
                                          =    "39" and
                     rf-dcp-cla-pro       =    00039
                     go to prn-liv-det-100.
      *                      *-----------------------------------------*
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
           ...
           move      "Articolo :"         to   w-all-str-cat (1)      .
           move      rf-dcp-alf-pro       to   w-all-str-cat (2)      .
           move      "incongruente con classe Archimede o non gestito"
                                          to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   m-msg                  .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Bufferizzazione Meta-articolo           *
      *                      *-----------------------------------------*
           move      w-let-arc-hct-ag1    to   w-det-num-pro-mta      .
      *                      *-----------------------------------------*
      *                      * Test su codice Meta-articolo            *
      *                      *-----------------------------------------*
           if        w-det-num-pro-mta    not  = zero
      ...
      *                      *-----------------------------------------*
           ...
           move      "Articolo :"         to   w-all-str-cat (1)      .
           move      rf-dcp-alf-pro       to   w-all-str-cat (2)      .
           move      "senza codice Meta-articolo"
                                          to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   m-msg                  .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-250.
      *              *-------------------------------------------------*
      *              * Lettura record [hct] per 'MART'                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           move      "MART"               to   w-let-arc-hct-rec      .
           move      w-det-num-pro-mta    to   w-let-arc-hct-key      .
           perform   let-arc-hct-000      thru let-arc-hct-999        .
      *                      *-----------------------------------------*
      *                      * Test su esito lettura                   *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "Articolo :"         to   w-all-str-cat (1)      .
           move      rf-dcp-alf-pro       to   w-all-str-cat (2)      .
           move      "senza scheda Meta-articolo"
                                          to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   m-msg                  .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-270.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione dati Meta-articolo          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Immagine                                *
      *                      *-----------------------------------------*
           move      w-let-arc-hct-ag1    to   w-det-num-pro-imm      .
      *                      *-----------------------------------------*
      *                      * Descrizioni Meta-articolo               *
      *                      *-----------------------------------------*
           move      w-let-arc-hct-de1    to   w-det-num-pro-mt1      .
           move      w-let-arc-hct-de2    to   w-det-num-pro-mt2      .
      *                      *-----------------------------------------*
      *                      * Codici Tangram                          *
      *                      *-----------------------------------------*
           move      w-let-arc-hct-zp1    to   w-det-num-pro-zp1      .
           move      w-let-arc-hct-zp2    to   w-det-num-pro-zp2      .
           move      w-let-arc-hct-zp3    to   w-det-num-pro-zp3      .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Lettura record [hct] per 'ASSO'                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           move      "ASSO"               to   w-let-arc-hct-rec      .
           move      w-det-num-pro-mta    to   w-let-arc-hct-key      .
           perform   let-arc-hct-000      thru let-arc-hct-999        .
      *                      *-----------------------------------------*
      *                      * Test su esito lettura                   *
      ...
      *                      *-----------------------------------------*
      *                      * Flag di associazione non esistente      *
      *                      *-----------------------------------------*
           move      "#"                  to   w-det-num-pro-sgf      .
      *                      *-----------------------------------------*
      *                      * A test sui codici Tangram               *
      *                      *-----------------------------------------*
           go to     prn-liv-det-400.
       prn-liv-det-320.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione dati Associazione           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Codice Sottogruppo                      *
      *                      *-----------------------------------------*
           move      w-let-arc-hct-ag1    to   w-det-num-pro-sgr      .
       prn-liv-det-350.
      *              *-------------------------------------------------*
      *              * Lettura record [hct] per 'SGRU'                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           move      "SGRU"               to   w-let-arc-hct-rec      .
           move      w-det-num-pro-sgr    to   w-let-arc-hct-key      .
           perform   let-arc-hct-000      thru let-arc-hct-999        .
      *                      *-----------------------------------------*
      *                      * Test su esito lettura                   *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-let-arc-hct-de1    to   w-det-num-pro-sg1      .
      *                      *-----------------------------------------*
      *                      * Codici Tangram                          *
      *                      *-----------------------------------------*
           move      w-let-arc-hct-zp1    to   w-det-num-pro-zs1      .
           move      w-let-arc-hct-zp2    to   w-det-num-pro-zs2      .
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Test sui codici Tangram                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-det-num-pro-zp1    =    zero or
                     w-det-num-pro-zp2    =    zero or
                     w-det-num-pro-zp3    =    zero
                     go to prn-liv-det-420.
      *                  *---------------------------------------------*
      *                  * Valori letti da 'MART'                      *
      *                  *---------------------------------------------*
           move      w-det-num-pro-zp1    to   w-det-num-pro-za1      .
           move      w-det-num-pro-zp2    to   w-det-num-pro-za2      .
           move      w-det-num-pro-zp3    to   w-det-num-pro-za3      .
      *                  *---------------------------------------------*
      *                  * Ad aggiornamento prodotto                   *
      *                  *---------------------------------------------*
           go to     prn-liv-det-600.
       prn-liv-det-420.
      *                  *---------------------------------------------*
      *                  * Codice classe da anagrafica prodotto        *
      *                  *---------------------------------------------*
           move      rf-dcp-cla-pro       to   w-det-num-pro-za1      .
      *                  *---------------------------------------------*
      *                  * Creazione 'zp2' per associazione esistente  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test su flag di associazione            *
      *                      *-----------------------------------------*
           if        w-det-num-pro-sgf    not  = spaces
                     go to prn-liv-det-440.
      *                      *-----------------------------------------*
      *                      * Test se necessario                      *
      *                      *-----------------------------------------*
           if        w-det-num-pro-zs1    =    zero
                     go to prn-liv-det-430.
           if        w-det-num-pro-zs2    =    zero
                     go to prn-liv-det-430.
           if        w-det-num-pro-zs1    not  = w-det-num-pro-za1
                     go to prn-liv-det-430.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      w-det-num-pro-zs2    to   w-det-num-pro-za2      .
      *                      *-----------------------------------------*
      *                      * A creazione 'zp3'                       *
      *                      *-----------------------------------------*
       ...
       prn-liv-det-430.
      *                      *-----------------------------------------*
      *                      * Lettura ultimo codice 'zp2'             *
      *                      *-----------------------------------------*
           move      w-det-num-pro-za1    to   w-det-ult-zp2-cla      .
           perform   det-ult-zp2-000      thru det-ult-zp2-999        .
           move      w-det-ult-zp2-ult    to   w-det-num-pro-za2      .
      *                      *-----------------------------------------*
      *                      * Incremento di 100 codice 'zp2'          *
      *                      *-----------------------------------------*
           add       100                  to   w-det-num-pro-za2      .
      *                      *-----------------------------------------*
      *                      * Write record [zp2]                      *
      *                      *-----------------------------------------*
      ...
      *                      * Update [hct] per 'SGRU'                 *
      *                      *-----------------------------------------*
           perform   upd-rec-hct-sgr-000  thru upd-rec-hct-sgr-999    .
      *                      *-----------------------------------------*
      *                      * A creazione 'zp3'                       *
      *                      *-----------------------------------------*
           go to     prn-liv-det-460.
       prn-liv-det-440.
      *                  *---------------------------------------------*
      *                  * Creazione 'zp2' per associazione non esis-  *
      *                  * tente                                       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Forzatura del codice gruppo a 10 : una  *
      *                      * eventuale sovrascrittura non crea pro-  *
      *                      * blemi                                   *
      *                      *-----------------------------------------*
           move      00010                to   w-det-num-pro-za2      .
           move      rf-zp1-des-cla       to   w-det-num-pro-sg1      .
      *                      *-----------------------------------------*
      *                      * Write record [zp2]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zp2-000      thru wrt-rec-zp2-999        .
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Lettura ultimo codice 'zp3'             *
      *                      *-----------------------------------------*
           move      w-det-num-pro-za1    to   w-det-ult-zp3-cla      .
           move      w-det-num-pro-za2    to   w-det-ult-zp3-gru      .
           perform   det-ult-zp3-000      thru det-ult-zp3-999        .
           move      w-det-ult-zp3-ult    to   w-det-num-pro-za3      .
      *                      *-----------------------------------------*
      *                      * Incremento codice 'zp3'                 *
      *                      *-----------------------------------------*
           if        w-det-num-pro-za3    >    90000
                     add  10              to   w-det-num-pro-za3
           else if   w-det-num-pro-za3    >    80000
                     add  50              to   w-det-num-pro-za3
           else      add  100             to   w-det-num-pro-za3      .
       prn-liv-det-470.
      *                      *-----------------------------------------*
      *                      * Write record [zp3]                      *
      *                      *-----------------------------------------*
      ...
      *              * Update [hct] per 'MART'                         *
      *              *-------------------------------------------------*
           perform   upd-rec-hct-mtr-000  thru upd-rec-hct-mtr-999    .
       prn-liv-det-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      w-det-num-pro-za1    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           move      "DS"                 to   v-ope                  .
           ...
           move      11                   to   v-lin                  .
           move      46                   to   v-pos                  .
           move      w-det-num-pro-za2    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           move      "DS"                 to   v-ope                  .
           ...
           move      11                   to   v-lin                  .
           move      56                   to   v-pos                  .
           move      w-det-num-pro-za3    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *                  * Si/no a listino                             *
      *                  *---------------------------------------------*
           move      0                    to   rf-dcp-snx-lst         .
      *                  *---------------------------------------------*
      *                  * Classi merceologiche                        *
      *                  *---------------------------------------------*
           move      w-det-num-pro-za1    to   rf-dcp-cla-pro         .
           move      w-det-num-pro-za2    to   rf-dcp-gru-pro         .
           move      w-det-num-pro-za3    to   rf-dcp-sgr-pro         .
      *                  *---------------------------------------------*
      *                  * Descrizione per il listino                  *
      *                  *---------------------------------------------*
           move      1                    to   rf-dcp-daa-lst         .
      *                  *---------------------------------------------*
