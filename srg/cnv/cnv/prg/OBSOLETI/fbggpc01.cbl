      ...
      *                                   Fase:    gpf998              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 30/10/95    *
      *                    ------------------------------------------- *
      *                                 Autore:    Alter s.r.l. - PD   *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sistemazione provvigioni                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Cancellazione conteggi provvigion. doppi"       .
      ...
      *        *-------------------------------------------------------*
           05  w-stp-srt-inp.
      *            *---------------------------------------------------*
      *            * Elementi riscontrati per cliente : precedenti     *
      *            *---------------------------------------------------*
               10  w-stp-srt-inp-cpr      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Elementi riscontrati per cliente : successivi     *
      *            *---------------------------------------------------*
               10  w-stp-srt-inp-csu      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Elementi riscontrati per cliente : nel periodo    *
      *            *---------------------------------------------------*
               10  w-stp-srt-inp-cpe      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Elementi riscontrati per cliente : contabili      *
      *            *---------------------------------------------------*
               10  w-stp-srt-inp-cco      pic  9(07)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Per salvataggio valori agente a inizio livello 1      *
      *        *-------------------------------------------------------*
           05  w-sav-vna-l01.
      *            *---------------------------------------------------*
      *            * Codice agente                                     *
      *            *---------------------------------------------------*
               10  w-sav-vna-l01-cod      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Nominativo agente                                 *
      *            *---------------------------------------------------*
               10  w-sav-vna-l01-nom      pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Comodo per numero pagina                          *
      *            *---------------------------------------------------*
               10  w-sav-vna-l01-pag      pic  9(07)                  .

      *    *===========================================================*
      *    * Work-area per determinazioni varie                        *
      *    *-----------------------------------------------------------*
       01  w-det.
           05  w-det-ctr-ele              pic  9(03)                  .
           05  w-det-ctr-001              pic  9(06)                  .
           05  w-det-ctr-002              pic  9(06)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      053                  to   p-pos                  .
           move      "CLIENTI CON FATTURATO A ZERO"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   rou-opn-mda-000      thru rou-opn-mda-999        .
      *              *-------------------------------------------------*
      *              * [gpc]                                           *
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           perform   rou-cls-mda-000      thru rou-cls-mda-999        .
      *              *-------------------------------------------------*
      *              * [gpc]                                           *
      *              *-------------------------------------------------*
           move      "CL"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Open moduli di accettazione per richieste                 *
      *    *-----------------------------------------------------------*
       rou-opn-mda-000.
       rou-opn-mda-999.
           exit.
      ...
      *    *===========================================================*
      *    * Close moduli di accettazione per richieste                *
      *    *-----------------------------------------------------------*
       rou-cls-mda-000.
       rou-cls-mda-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      0950401              to   rf-gpc-dat-doc         .
      ...
      *                      * Protocollo fattura                      *
      *                      *-----------------------------------------*
           move      rf-gpc-prt-fcl       to   srt-prt-fcl            .
      *                      *-----------------------------------------*
      *                      * Numero conteggio                        *
      *                      *-----------------------------------------*
           move      rf-gpc-num-ctg       to   srt-num-ctg            .
      *                  *---------------------------------------------*
      *                  * Preparazione dati di sort                   *
      *                  *---------------------------------------------*
       stp-srt-inp-800.
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun conteggio entro i limiti assegnati !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      srt-prt-fcl          to   w-rot-l01-prt-fcl      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           add       1                    to   w-det-ctr-ele          .
      *              *-------------------------------------------------*
      *              * Se e' il primo elemento incontrato : uscita     *
      *              *-------------------------------------------------*
           if        w-det-ctr-ele        =    1
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-gpc                 .
      *              *-------------------------------------------------*
      *              * Incremento contatore elementi deletati          *
      *              *-------------------------------------------------*
           add       1                    to   w-det-ctr-002          .
      *              *-------------------------------------------------*
      *              * Visualizzazione contatore                       *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      srt-num-ctg          to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * String                                          *
      *              *-------------------------------------------------*
           string    "Cancellato conteggio "
                                delimited by size
                     p-edt      delimited by spaces
                                          into m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
      ...
      *    *===========================================================*
      *    * Preparazione titolo di intestazione pagina                *
      *    *-----------------------------------------------------------*
       cat-tit-pag-000.
       cat-tit-pag-999.
           exit.
