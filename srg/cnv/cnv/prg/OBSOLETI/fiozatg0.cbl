      ...
      *                                   Fase:    fiozat              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 15/02/10    *
      *                       Ultima revisione:    NdK del 15/02/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione file per ZATTI : parte Fiocchi    *
      *                                                                *
      *                    in Crontab nel Server Fiocchi - ore 05:10   *
      *                       1>/abd/asc/log/fiozatg0_ok.log           *
      *                       2>/abd/asc/log/fiozatg0_no.log           *
      *                                                                *
      *                    Scrittura di /abd/asc/exp/STORICI.SQZ       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Estrazione dati storici prodotti Fiocchi"       .
      ...
      *    *-----------------------------------------------------------*
       01  f-xxx.
           ...
           05  f-xxx-ag1                  pic  x(03)                  .
           05  f-xxx-zip                  pic  x(12)                  .
           05  f-xxx-apt                  pic  x(40)                  .
      ...
      *            * Contenuto record                                  *
      *            *---------------------------------------------------*
               10  w-out-gen-num-pro      pic  x(07)                  .
               10  filler                 pic  x(01)                  .
               10  w-out-gen-gia-bol      pic  x(15)                  .
               10  filler                 pic  x(01)                  .
               10  w-out-gen-acq-apr      pic  x(15)                  .
               10  filler                 pic  x(01)                  .
               10  w-out-gen-ven-apr      pic  x(15)                  .
               10  filler                 pic  x(01)                  .
               10  w-out-gen-acq-aic      pic  x(15)                  .
               10  filler                 pic  x(01)                  .
               10  w-out-gen-ven-aic      pic  x(15)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per Det : dati statistici prodotto               *
      *        *-------------------------------------------------------*
           05  w-det-dat-ssp.
      *            *---------------------------------------------------*
      *            * Esercizio attuale                                 *
      *            *---------------------------------------------------*
               10  w-det-dat-ssp-esa      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Esercizio precedente                              *
      *            *---------------------------------------------------*
               10  w-det-dat-ssp-esp      pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Per Fine riga                                         *
      *        *-------------------------------------------------------*
           05  w-det-fin-rig.
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Creazione archivio prodotti per Padova  "  .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-dcp                 .
      *              *-------------------------------------------------*
      *              * Open modulo di determinazione dati statistici   *
      *              * prodotto                                        *
      *              *-------------------------------------------------*
           move      "OP"                 to   d-sst-ssp-tip-ope      .
           move      "pgm/sst/prg/obj/dsstssp0"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using d-sst-ssp              .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       rou-cls-fls-800.
      *              *-------------------------------------------------*
      *              * Close modulo di determinazione dati statistici  *
      *              * prodotto                                        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Chiusura modulo                             *
      *                  *---------------------------------------------*
           move      "CL"                 to   d-sst-ssp-tip-ope      .
           move      "pgm/sst/prg/obj/dsstssp0"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      "C?"                 to   d-sst-ssp-tip-ope      .
           move      "pgm/sst/prg/obj/dsstssp0"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using d-sst-ssp              .
           if        d-sst-ssp-exi-sts    not  = spaces
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *              *-------------------------------------------------*
      *              * Decremento per determinare il giorno prima      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Editing codice prodotto numerico            *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      07                   to   p-car                  .
      ...
      *                  *---------------------------------------------*
           move      p-edt                to   w-out-gen-num-pro      .
       prn-liv-det-520.
      *                  *---------------------------------------------*
      *                  * Dati storici anno precedente                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Determinazione data attuale             *
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                      *-----------------------------------------*
      *                      * Determinazione date esercizio           *
      *                      *-----------------------------------------*
           move      s-dat                to   w-det-dat-ssp-esa      .
           subtract  1                    from s-saa                  .
           move      s-dat                to   w-det-dat-ssp-esp      .
      *                      *-----------------------------------------*
      *                      * Determinazione                          *
      *                      *-----------------------------------------*
           move      "DT"                 to   d-sst-ssp-tip-ope      .
           move      01                   to   d-sst-ssp-cod-dpz      .
           move      rf-dcp-num-pro       to   d-sst-ssp-num-pro      .
           move      w-det-dat-ssp-esp    to   d-sst-ssp-dat-rif      .
           move      "pgm/sst/prg/obj/dsstssp0"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      "S"                  to   p-sgn                  .
           move      "<9"                 to   p-edm                  .
           move      d-sst-ssp-tot-qta    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * In campo di destinazione                    *
      *                  *---------------------------------------------*
           move      p-edt                to   w-out-gen-acq-apr      .
      *                  *---------------------------------------------*
      *                  * Editing vendita                             *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           move      "S"                  to   p-sgn                  .
           move      "<9"                 to   p-edm                  .
           move      d-sst-ssp-tot-qtv    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * In campo di destinazione                    *
      *                  *---------------------------------------------*
           move      p-edt                to   w-out-gen-ven-apr      .
       prn-liv-det-540.
      *                  *---------------------------------------------*
      *                  * Dati storici anno in corso                  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Determinazione                          *
      *                      *-----------------------------------------*
           ...
           move      01                   to   d-sst-ssp-cod-dpz      .
           move      rf-dcp-num-pro       to   d-sst-ssp-num-pro      .
           move      w-det-dat-ssp-esa    to   d-sst-ssp-dat-rif      .
           move      "pgm/sst/prg/obj/dsstssp0"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * In campo di destinazione                    *
      *                  *---------------------------------------------*
           move      p-edt                to   w-out-gen-acq-aic      .
      *                  *---------------------------------------------*
      *                  * Editing vendita                             *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
      ...
      *                  * In campo di destinazione                    *
      *                  *---------------------------------------------*
           move      p-edt                to   w-out-gen-ven-aic      .
       prn-liv-det-560.
      *                  *---------------------------------------------*
      *                  * Giacenza                                    *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-det-dat-ssp-esa    to   d-sld-mag-dat-sld      .
      ...
      *                  * In campo di destinazione                    *
      *                  *---------------------------------------------*
           move      p-edt                to   w-out-gen-gia-bol      .
       prn-liv-det-580.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           string    f-xxx-ppb  delimited by   spaces
                     "STORICI"  delimited by   spaces
                     "."        delimited by   size
                     "SQZ"      delimited by   size
                                          into f-xxx-pat              .
      *              *-------------------------------------------------*
