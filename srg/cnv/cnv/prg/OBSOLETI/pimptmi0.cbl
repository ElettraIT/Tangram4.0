      ...
      *                       Ultima revisione:    NdK del 20/12/06    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Test chiavi 'dbsoft' per Sestante           *
      *                                                                *
      *                    TEMI                                        *
      *                                                                *
      *                    Scansione /abd/asc/output.txt generato da   *
      *                    chiave.exe versione dic.2006                *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Numero di records errati                              *
      *        *-------------------------------------------------------*
           05  w-pds-err                  pic  9(06)                  .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               ...
               10  filler                 pic  x(01)                  .
               10  w-lds-001-prc-031      pic  9(01)                  .
               10  filler                 pic  x(01)                  .
               10  w-lds-001-prc-032      pic  9(01)                  .
               10  filler                 pic  x(01)                  .
               10  w-lds-001-prc-033      pic  9(01)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Password                                          *
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Numero di records errati : zero                 *
      *              *-------------------------------------------------*
           move      zero                 to   w-pds-err              .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lds-001-prc-031    to   w-pwx-ele-prc (31)     .
           move      w-lds-001-prc-032    to   w-pwx-ele-prc (32)     .
           move      w-lds-001-prc-033    to   w-pwx-ele-prc (33)     .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
      *                  *---------------------------------------------*
      *                  * Incremento numero records errati            *
      *                  *---------------------------------------------*
           add       1                    to   w-pds-err              .
      *                  *---------------------------------------------*
