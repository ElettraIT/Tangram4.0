      ...
      *                                   Fase:    eledcp              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 14/10/99    *
      *                       Ultima revisione:    NdK del 14/10/99    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Cancellazione file [dcp]                    *
      *                                       [aaq]                    *
      *                                       [aaf] : Elettra          *
      *                                                                *
      *                    Selezione da filtro                         *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     Cancellazione prodotti obsoleti    "       .
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      "dcp"                to   srt-tip-rec            .
           move      rf-dcp-num-pro       to   srt-num-pro            .
           move      zero                 to   srt-cod-dcf            .
           move      spaces               to   srt-fda-pif            .
       stp-srt-inp-dcp-700.
      *                  *---------------------------------------------*
      ...
      *                  * Ciclo per [aaq]                             *
      *                  *---------------------------------------------*
           perform   stp-srt-inp-aaq-000  thru stp-srt-inp-aaq-999    .
      *                  *---------------------------------------------*
      *                  * Ciclo per [aaf]                             *
      *                  *---------------------------------------------*
           perform   stp-srt-inp-aaf-000  thru stp-srt-inp-aaf-999    .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rf-aaq-tip-mag       not  = 01
                     go to stp-srt-inp-aaq-900.
           if        rf-aaq-num-pro       not  = rf-dcp-num-pro
                     go to stp-srt-inp-aaq-900.
       stp-srt-inp-aaq-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [aaq]                      *
      *              *-------------------------------------------------*
       stp-srt-inp-aaq-600.
      *              *-------------------------------------------------*
      *              * Composizione record di sort                     *
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      "aaq"                to   srt-tip-rec            .
           move      rf-aaq-num-pro       to   srt-num-pro            .
           move      zero                 to   srt-cod-dcf            .
           move      spaces               to   srt-fda-pif            .
       stp-srt-inp-aaq-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-aaq-800.
      *                  *---------------------------------------------*
      *                  * Riciclo a record [aaq] successivo           *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-aaq-200.
       stp-srt-inp-aaq-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-aaq-999.
       stp-srt-inp-aaq-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        rf-aaf-tip-mag       not  = 01
                     go to stp-srt-inp-aaf-900.
           if        rf-aaf-num-pro       not  = rf-dcp-num-pro
                     go to stp-srt-inp-aaf-900.
       stp-srt-inp-aaf-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [aaf]                      *
      *              *-------------------------------------------------*
       stp-srt-inp-aaf-600.
      *              *-------------------------------------------------*
      *              * Composizione record di sort                     *
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      "aaf"                to   srt-tip-rec            .
           move      rf-aaf-num-pro       to   srt-num-pro            .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-aaf-800.
      *                  *---------------------------------------------*
      *                  * Riciclo a record [aaf] successivo           *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-aaf-200.
       stp-srt-inp-aaf-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-aaf-999.
       stp-srt-inp-aaf-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           string    "Cancellate nr. "
                     ...
                     " anagrafiche prodotto e schede annesse"
                                delimited by   size
                                          into m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
      ...
      *              *-------------------------------------------------*
           if        srt-tip-rec          =    "dcp"
                     perform  del-rec-dcp-000
                                          thru del-rec-dcp-999
           else if   srt-tip-rec          =    "aaq"
                     perform  del-rec-aaq-000
                                          thru del-rec-aaq-999
           else if   srt-tip-rec          =    "aaf"
                     perform  del-rec-aaf-000
                                          thru del-rec-aaf-999
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-cod-dcf          to   rf-aaf-cod-dcf         .
