      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [mmz] : FORALBERG        *
      *                                                                *
      *                    UPDATE SALDI PER AZZERAMENTO C/MERCE 2005   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Aggiornamento magazzino - FORALBERG   "       .
      ...
      *        *-------------------------------------------------------*
      *        * Flag di prodotto trattato                             *
      *        *-------------------------------------------------------*
           05  w-wrk-pro-trt              pic  x(01)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-mmz-ann-ese       to   srt-ann-ese            .
           move      rf-mmz-cod-dpz       to   srt-cod-dpz            .
           move      rf-mmz-tip-mag       to   srt-tip-mag            .
           move      rf-mmz-num-mag       to   srt-num-mag            .
           move      rf-mmz-var-mag       to   srt-var-mag            .
           move      rf-mmz-tip-ctm       to   srt-tip-ctm            .
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      srt-alf-key          to   w-rot-l01-alf-key      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fbg/mmz"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fbg/mmz.SAV"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di prodotto trattato       *
      *              *-------------------------------------------------*
           move      spaces               to   w-wrk-pro-trt          .
       prn-ini-lr1-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-lr1-100.
      *              *-------------------------------------------------*
      *              * Messaggio per articolo trattato                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su flag di prodotto trattato           *
      *                  *---------------------------------------------*
           if        w-wrk-pro-trt        =    spaces
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Attivazione flag di trattamento prodotto        *
      *              *-------------------------------------------------*
           move      "#"                  to   w-wrk-pro-trt          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "MAGARC    "         to   f-key                  .
           move      srt-ann-ese          to   rf-mmz-ann-ese         .
           move      srt-cod-dpz          to   rf-mmz-cod-dpz         .
           move      srt-tip-mag          to   rf-mmz-tip-mag         .
           move      srt-num-mag          to   rf-mmz-num-mag         .
           move      srt-var-mag          to   rf-mmz-var-mag         .
           move      srt-tip-ctm          to   rf-mmz-tip-ctm         .
           move      srt-cod-ctm          to   rf-mmz-cod-ctm         .
           move      srt-tip-arc          to   rf-mmz-tip-arc         .
           move      srt-cod-arc          to   rf-mmz-cod-arc         .
           move      srt-dpz-arc          to   rf-mmz-dpz-arc         .
           move      "pgm/mag/fls/ioc/obj/iofmmz"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
