      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ripristino riferimenti : TEMI               *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Ripristino riferimenti - automatico TEMI"       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Rirpristino riferimenti riga - TEMI     "  .
      ...
      *                  * Selezione sula data                         *
      *                  *---------------------------------------------*
           if        rf-mgr-dat-rif       >    zero
                     go to stp-srt-inp-420.
      *                  *---------------------------------------------*
      *                  * Selezione su causale                        *
      *                  *---------------------------------------------*
           if        rf-mgr-cod-cau       =    32 or
                     rf-mgr-cod-cau       =    02 or
                     rf-mgr-cod-cau       =    12 or
                     rf-mgr-cod-cau       =    13 or
                     rf-mgr-cod-cau       =    14 or
                     rf-mgr-cod-cau       =    29 or
                     rf-mgr-cod-cau       =    33 or
                     rf-mgr-cod-cau       =    36 or
                     rf-mgr-cod-cau       =    37
      ...
      *              *-------------------------------------------------*
           move      rf-mgr-dat-doc       to   rf-mgr-dat-rif         .
           move      rf-mgr-num-doc       to   rf-mgr-num-rif         .
           if        rf-mgr-dat-rif       =    zero
                     move  rf-mgr-dat-reg to   rf-mgr-dat-rif         .
           if        rf-mgr-num-rif       =    spaces
                     move  "-"            to   rf-mgr-num-rif         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Aggiornamento contatore                         *
      *              *-------------------------------------------------*
