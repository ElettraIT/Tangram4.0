      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione file per ZATTI : parte ZATTI      *
      *                                                                *
      *                    in Crontab nel Server ZATTI - ore 07:30     *
      *                       1>/abd/asc/log/fiozatg1_ok.log           *
      *                       2>/abd/asc/log/fiozatg1_no.log           *
      *                                                                *
      *                    Lettura di /abd/asc/imp/STORICI.SQZ         *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Work area per la definizione chiavi record [hex]          *
      *    *-----------------------------------------------------------*
       01  w-dkr.
      *        *-------------------------------------------------------*
      *        * Record 'gia' : Giacenza veicolo                       *
      *        *-------------------------------------------------------*
           05  w-dkr-gia.
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-lds-001-are-rec.
                   ...
                   15  filler             pic  x(01)                  .
                   15  w-lds-001-gia-bol  pic  x(15)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lds-001-acq-apr  pic  x(15)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lds-001-ven-apr  pic  x(15)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lds-001-acq-aic  pic  x(15)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lds-001-ven-aic  pic  x(15)                  .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "ztt/gtv/fls/ioc/obj/iofhex"
                                          to   s-pat                  .
      ...
      *                      *-----------------------------------------*
           move      "giab"               to   w-let-rec-hex-fil      .
           move      w-lds-001-num-pro    to   w-let-rec-hex-kal      .
      ...
      *                              * Aggiornamento                   *
      *                              *---------------------------------*
           move      "giab"               to   w-cmp-rec-hex-fil      .
           move      w-lds-001-num-pro    to   w-cmp-rec-hex-kal      .
           move      w-lds-001-are-rec    to   w-cmp-rec-hex-rec      .
      ...
      *
           string    "ncftpget -V -e /abd/asc/log/fiozatg1.log -u master
      -              " -p alter1 10.0.3.2 /abd/asc/imp /abd/asc/exp/STOR
      -              "ICI.SQZ"  delimited by   size
                                          into o-shs                  .
       trf-fls-srv-400.
      *              *-------------------------------------------------*
