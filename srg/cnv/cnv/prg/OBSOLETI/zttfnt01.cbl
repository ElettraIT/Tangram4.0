      ...
      *                                   Fase:    zttfnt              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 30/08/95    *
      *                    ------------------------------------------- *
      *                                 Autore:    Alter s.r.l. - PD   *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento files [fnt] : Mecom           *
      *                                                                *
      *================================================================*
      ...
      *              * Update record [fnt]                             *
      *              *-------------------------------------------------*
           perform   upd-rec-fnt-000      thru upd-rec-fnt-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-fnt                 .
           if        f-sts                not  = e-not-err
                     go to upd-rec-fnt-900.
      *              *-------------------------------------------------*
      *              * Aggiornamento contropartita                     *
      *              *-------------------------------------------------*
           move      1405001              to   rf-fnt-cod-cge         .
       upd-rec-fnt-200.
      *              *-------------------------------------------------*
      *              * Update record [fnt]                             *
      *              *-------------------------------------------------*
