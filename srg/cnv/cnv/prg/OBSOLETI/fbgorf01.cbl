      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [ofr] : Foralberg        *
      *                                                                *
      *                    Update righe ordine per forzatura descri-   *
      *                    zione riga da anagrafica prodotti           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Aggiornamento file [ofr] - Foralberg  "       .
      ...
      *              *-------------------------------------------------*
           if        rf-ofr-num-mag       =    zero
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test su codice lingua fornitore                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-ofr-fda-pif       to   rf-aaf-fda-pif         .
           move      "pgm/dcf/fls/ioc/obj/iofaaf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-aaf                 .
      *              *-------------------------------------------------*
      *              * Test su descrizione per il fornitore            *
      *              *-------------------------------------------------*
           if        rf-aaf-dep-sfn       not  = spaces
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test su descrizione estesa                      *
      *              *-------------------------------------------------*
           if        rf-ofr-des-ext       not  = zero
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test su descrizione                             *
      *              *-------------------------------------------------*
           if        rf-ofr-des-rig       =    rf-dcp-des-pro
                     go to prn-liv-det-300.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Aggiornamento riga ordine per descrizione       *
      *              *-------------------------------------------------*
           move      rf-dcp-des-pro       to   rf-ofr-des-rig         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
