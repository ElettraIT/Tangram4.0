      ...
      *                                   Fase:    zttmau              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 18/02/10    *
      *                       Ultima revisione:    NdK del 18/02/10    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [mau] : ZATTI            *
      *                                                                *
      *                    Pulizia ubicazioni                          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-wrk-prm-ubi              pic  x(06)                  .
           05  w-wrk-prm-ubi-r01 redefines
               w-wrk-prm-ubi.
               10  w-wrk-prm-ubi-n06      pic  9(06)                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se stringa non numerica                *
      *                  *---------------------------------------------*
           move      rf-mau-prm-ubi (01)  to   w-wrk-prm-ubi          .
           if        w-wrk-prm-ubi-n06    not  numeric
                     go to stp-srt-inp-600.
      *                  *---------------------------------------------*
      *                  * Determinazione lunghezza parametro          *
      *                  *---------------------------------------------*
           move      rf-mau-prm-ubi (01)  to   w-all-str-alf          .
           perform   all-str-lun-000      thru all-str-lun-999        .
      *                  *---------------------------------------------*
      *                  * Test se da 6 caratteri                      *
      *                  *---------------------------------------------*
           if        w-all-str-lun        =    6
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Recupero del record [mau]                       *
      *              *-------------------------------------------------*
           move      srt-rec-mau          to   rf-mau                 .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Test se da modificare                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su parametri ubicazione                *
      *                  *---------------------------------------------*
