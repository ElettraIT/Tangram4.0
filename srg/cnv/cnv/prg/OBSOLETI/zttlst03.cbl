      ...
      *                                   Fase:    zttdcp              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/07/11    *
      *                       Ultima revisione:    NdK del 17/07/11    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione listino scaglioni quantita' per   *
      *                    fiori sul listino MAG in base ad Inner Box  *
      *                                                                *
      *                    ZATTI                                       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Generazione sconti a scaglioni fiori MAG"       .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Test su classe prodotto: solo Fiori Artificiali *
      *              *-------------------------------------------------*
           if        rf-dcp-cla-pro       not  = 00100
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Test su lotto di vendita: solo maggiore di ___  *
      *              *-------------------------------------------------*
           if        rf-dcp-lot-ven       not  > ___
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Gestione 2 scaglioni listino                    *
      *              *-------------------------------------------------*
           move      zero                 to   w-wrk-ctr-002          .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Incremento scaglione                            *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "MAG"                to   rf-lst-cod-lst         .
           move      w-wrk-ctr-002        to   rf-lst-cod-cli         .
           move      c-sgl                to   rf-lst-sgl-vlt         .
           move      c-dec                to   rf-lst-dec-vlt         .
           move      rf-dcp-num-pro       to   rf-lst-num-pro         .
           move      w-cal-prz-net-prz    to   rf-lst-prz-lst         .
      ...
      *              *-------------------------------------------------*
      *              * Trattamento percentuale 1 di sconto             *
      *              *-------------------------------------------------*
           if        w-wrk-ctr-002        =    2
                     move  ___            to   rf-lst-per-sco (1)     .
      *              *-------------------------------------------------*
      *              * Quantita' di riferimento da innerbox            *
      *              *-------------------------------------------------*
           if        w-wrk-ctr-002        =    1
                     move  rf-dcp-lot-ven to   rf-lst-qta-rif
           else if   w-wrk-ctr-002        =    2
                     move  9999999        to   rf-lst-qta-rif         .
           if        w-wrk-ctr-002        =    1
                     subtract 1           from rf-lst-qta-rif         .
      *              *-------------------------------------------------*
      *              * Force Put su [lst]                              *
      *              *-------------------------------------------------*
           move      "FP"                 to   f-ope                  .
