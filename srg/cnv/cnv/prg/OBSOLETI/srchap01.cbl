      ...
      *                                                                *
      *                    Update partite per codice conferitore       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Aggiornamento Conferitore - Cliente  "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-let.
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [hcf]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-hcf.
               10  w-let-arc-hcf-flg      pic  x(01)                  .
               10  w-let-arc-hcf-rec      pic  x(04)                  .
               10  w-let-arc-hcf-key      pic  9(07)                  .
               10  w-let-arc-hcf-de1      pic  x(60)                  .
               10  w-let-arc-hcf-de2      pic  x(60)                  .
               10  w-let-arc-hcf-ag1      pic  9(07)                  .
               10  w-let-arc-hcf-ag2      pic  9(07)                  .
               10  w-let-arc-hcf-zp1      pic  9(05)                  .
               10  w-let-arc-hcf-zp2      pic  9(05)                  .
               10  w-let-arc-hcf-zp3      pic  9(05)                  .
      ...
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
           move      rf-hap-cod-cnf       to   srt-cod-cnf            .
       stp-srt-inp-700.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-cod-cnf          to   rf-hcf-cod-cnf         .
           move      "sec/tns/fls/ioc/obj/iofhcf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
      *              * Test su codice contabile                        *
      *              *-------------------------------------------------*
           if        rf-hcf-cod-cli       =    zero
                     go to prn-liv-det-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Composizione record [hap]                       *
      *              *-------------------------------------------------*
           move      rf-hcf-cod-cli       to   rf-hpx-cod-cli         .
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   rf-hpx-cod-cee         .
           move      spaces               to   rf-hpx-cod-ddr         .
           move      spaces               to   rf-hpx-cod-cpe         .
           move      rf-hcf-cod-cli       to   rf-hpx-cod-cli         .
           move      spaces               to   rf-hpx-dpz-cli         .
           move      spaces               to   rf-hpx-tip-dsn         .
           move      zero                 to   rf-hpx-cod-dsn         .
           move      zero                 to   rf-hpx-cod-sds         .
           move      zero                 to   rf-hpx-aut-sds         .
