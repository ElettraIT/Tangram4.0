      ...
      *                                   Fase:    tmidcc              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 15/06/98    *
      *                       Ultima revisione:    NdK del 07/08/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [dcc] : Temi             *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento codice zona clienti - Temi"       .
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-150.
      *              *-------------------------------------------------*
      *              * Aggiornamento codice zona                       *
      *              *-------------------------------------------------*
           if        rf-gxc-cod-prv       =    "BI "
                     move  00097          to   rf-dcc-cod-zon
           else if   rf-gxc-cod-prv       =    "KR "
                     move  00100          to   rf-dcc-cod-zon
           else if   rf-gxc-cod-prv       =    "LC "
                     move  00101          to   rf-dcc-cod-zon
           else if   rf-gxc-cod-prv       =    "LO "
                     move  00099          to   rf-dcc-cod-zon
           else if   rf-gxc-cod-prv       =    "PO "
                     move  00102          to   rf-dcc-cod-zon
           else if   rf-gxc-cod-prv       =    "RN "
                     move  00098          to   rf-dcc-cod-zon
           else if   rf-gxc-cod-prv       =    "VB "
                     move  00104          to   rf-dcc-cod-zon
           else if   rf-gxc-cod-prv       =    "VV "
                     move  00103          to   rf-dcc-cod-zon
