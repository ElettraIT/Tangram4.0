      ...
      *                                   Fase:    tpghmc              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 10/07/00    *
      *                       Ultima revisione:    NdK del 10/07/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [hmc] : Rumor            *
      *                                                                *
      *                    Update movimenti per costo ultimo           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Work per Det costo di magazzino                       *
      *        *-------------------------------------------------------*
           05  w-det-val-mag.
      *            *---------------------------------------------------*
      *            * Valore unitario determinato                       *
      *            *---------------------------------------------------*
               10  w-det-val-mag-vun      pic  9(11)                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-hmc                 .
      *              *-------------------------------------------------*
      *              * Open modulo determinazione valore di MAG        *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-hmc                 .
      *              *-------------------------------------------------*
      *              * Close modulo determinazione valore di MAG       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Esecuzione Close                            *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Start su archivio [hmc]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATREG    "         to   f-key                  .
           move      1000615              to   rf-hmc-dat-reg         .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [hmc]              *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "tpg/gct/fls/ioc/obj/iofhmc"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
      *              * Normalizzazione costo di comodo                 *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-val-mag-vun      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-hmc-num-cpm       =    zero
                     go to prn-liv-det-300.
       prn-liv-det-120.
      *              *-------------------------------------------------*
      *              * Determinazione valore di magazzino              *
      *              *-------------------------------------------------*
           move      "VM"                 to   d-vun-mag-tip-ope      .
           move      0002                 to   d-vun-mag-tip-val      .
           move      rf-hmc-dat-reg       to   d-vun-mag-dat-val      .
           move      03                   to   d-vun-mag-tip-mag      .
           move      rf-hmc-num-cpm       to   d-vun-mag-num-mag      .
           move      "pgm/mag/prg/obj/pmag300v"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           divide    100                  into d-vun-mag-val-uni
                                        giving w-det-val-mag-vun      .
       prn-liv-det-140.
      *              *-------------------------------------------------*
      *              * Test su costo                                   *
      *              *-------------------------------------------------*
           if        w-det-val-mag-vun    =    zero
                     go to prn-liv-det-300.
           if        w-det-val-mag-vun    =    rf-hmc-val-eff
                     go to prn-liv-det-300.
       prn-liv-det-160.
      *              *-------------------------------------------------*
      *              * Aggiornamento                                   *
      *              *-------------------------------------------------*
           move      w-det-val-mag-vun    to   rf-hmc-val-mag         .
           move      w-det-val-mag-vun    to   rf-hmc-val-eff         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [hmc]                             *
      *              *-------------------------------------------------*
