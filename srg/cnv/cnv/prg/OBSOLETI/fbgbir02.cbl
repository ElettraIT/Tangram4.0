      ...
      *                                   Fase:    fbgbir              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 11/05/05    *
      *                       Ultima revisione:    NdK del 11/05/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Controllo bolle doppie : Foralberg          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Controllo bolle doppie : Foralberg   "       .
      ...
      *        *-------------------------------------------------------*
      *        * Per determinazione documenti doppi                    *
      *        *-------------------------------------------------------*
           05  w-det-dup-doc.
               10  w-det-dup-doc-ctr      pic  9(11)                  .
               10  w-det-dup-doc-prg      pic  9(05)                  .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna riga entro i limiti assegnati !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-bir-num-pro       to   w-rot-l01-num-pro      .
           move      rf-bir-dat-doc       to   w-rot-l01-dat-doc      .
           move      rf-bir-num-doc       to   w-rot-l01-num-doc      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore prodotti coppi        *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-dup-doc-ctr      .
           move      rf-bir-num-prg       to   w-det-dup-doc-prg      .
       prn-ini-lr1-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "D"                  to   p-tip                  .
           move      w-rot-l01-dat-doc    to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Lettura record [dcp]                            *
      *              *-------------------------------------------------*
           ...
           move      w-rot-l01-num-pro    to   rf-dcp-num-pro         .
           move      "pgm/dcp/fls/ioc/obj/iofdcp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Incremento contatore prodotti coppi             *
      *              *-------------------------------------------------*
           if        w-det-dup-doc-prg    =    rf-bir-num-prg
                     add  1               to   w-det-dup-doc-ctr      .
      *              *-------------------------------------------------*
