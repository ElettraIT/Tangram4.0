      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento numeri di telefono - FBG "       .
      ...
      *        *-------------------------------------------------------*
           05  w-ctl-fax.
               ...
               10  w-ctl-utz-num-pnu redefines
                   w-ctl-utz-num-pre      pic  9(05)                  .
               10  w-ctl-utz-num-utz      pic  x(15)                  .
               10  w-ctl-utz-num-unu redefines
                   w-ctl-utz-num-utz      pic  9(15)                  .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione anagrafiche per Nr. telefono"  .
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      "dcc"                to   srt-tip-rec            .
           move      rf-dcc-cod-cli       to   srt-cod-arc            .
           move      rf-dcc-dpz-cli       to   srt-dpz-arc            .
       stp-srt-inp-dcc-700.
      *                  *---------------------------------------------*
      *                  * Rilascio record 'carico' al sort            *
      *                  *---------------------------------------------*
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      "dcf"                to   srt-tip-rec            .
           move      rf-dcf-cod-fnt       to   srt-cod-arc            .
           move      rf-dcf-dpz-fnt       to   srt-dpz-arc            .
       stp-srt-inp-dcf-700.
      *                  *---------------------------------------------*
      *                  * Rilascio record 'carico' al sort            *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        srt-tip-rec          =    "cli"
                     perform  agg-rec-cli-000
                                          thru agg-rec-cli-999
           else if   srt-tip-rec          =    "dcc"
                     perform  agg-rec-dcc-000
                                          thru agg-rec-dcc-999
           else if   srt-tip-rec          =    "fnt"
                     perform  agg-rec-fnt-000
                                          thru agg-rec-fnt-999
           else if   srt-tip-rec          =    "dcf"
                     perform  agg-rec-dcf-000
                                          thru agg-rec-dcf-999
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODCLI    "         to   f-key                  .
           move      srt-cod-arc          to   rf-cli-cod-cli         .
           move      "pgm/cge/fls/ioc/obj/iofcli"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Test preliminare                            *
      *                  *---------------------------------------------*
           if        rf-cli-num-tel       =    spaces and
                     rf-cli-num-fax       =    spaces
                     go to agg-rec-cli-500.
      *                  *---------------------------------------------*
      *                  * Telefono                                    *
      *                  *---------------------------------------------*
           move      rf-cli-num-tel       to   w-ctl-utz-num-num      .
           perform   ctl-utz-num-000      thru ctl-utz-num-999        .
      *                      *-----------------------------------------*
      *                      * Eventuale messaggio                     *
      *                      *-----------------------------------------*
           if        w-ctl-utz-num-flg    not  = "N"
                     move  w-ctl-utz-num-num
                                          to   rf-cli-num-tel
                     go to agg-rec-cli-300.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      srt-cod-arc          to   w-all-str-cat (2)      .
           move      "- utenza :"         to   w-all-str-cat (3)      .
           move      w-ctl-utz-num-num    to   w-all-str-cat (4)      .
           move      "non aggiornata"     to   w-all-str-cat (5)      .
      ...
      *                  * Fax                                         *
      *                  *---------------------------------------------*
           move      rf-cli-num-fax       to   w-ctl-utz-num-num      .
           perform   ctl-utz-num-000      thru ctl-utz-num-999        .
      *                      *-----------------------------------------*
      *                      * Eventuale messaggio                     *
      *                      *-----------------------------------------*
      ...
      *                  * Test preliminare                            *
      *                  *---------------------------------------------*
           if        rf-dcc-num-tel       =    spaces and
                     rf-dcc-tel-alt       =    spaces and
                     rf-dcc-num-fax       =    spaces
                     go to agg-rec-dcc-500.
      *                  *---------------------------------------------*
      *                  * Telefono                                    *
      *                  *---------------------------------------------*
           move      rf-dcc-num-tel       to   w-ctl-utz-num-num      .
           perform   ctl-utz-num-000      thru ctl-utz-num-999        .
      *                      *-----------------------------------------*
      *                      * Eventuale messaggio                     *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-dcc-tel-alt       to   w-ctl-utz-num-num      .
           perform   ctl-utz-num-000      thru ctl-utz-num-999        .
      *                      *-----------------------------------------*
      *                      * Eventuale messaggio                     *
      *                      *-----------------------------------------*
      ...
      *                  * Fax                                         *
      *                  *---------------------------------------------*
           move      rf-dcc-num-fax       to   w-ctl-utz-num-num      .
           perform   ctl-utz-num-000      thru ctl-utz-num-999        .
      *                      *-----------------------------------------*
      *                      * Eventuale messaggio                     *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "Cliente commerciale :"
                                          to   w-all-str-cat (1)      .
           move      srt-cod-arc          to   w-all-str-cat (2)      .
           move      "- ut. fax :"        to   w-all-str-cat (3)      .
           move      w-ctl-utz-num-num    to   w-all-str-cat (4)      .
           move      "non aggiornata"     to   w-all-str-cat (5)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODFNT    "         to   f-key                  .
           move      srt-cod-arc          to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Test preliminare                            *
      *                  *---------------------------------------------*
           if        rf-fnt-num-tel       =    spaces and
                     rf-fnt-num-fax       =    spaces
                     go to agg-rec-fnt-500.
      *                  *---------------------------------------------*
      *                  * Telefono                                    *
      *                  *---------------------------------------------*
           move      rf-fnt-num-tel       to   w-ctl-utz-num-num      .
           perform   ctl-utz-num-000      thru ctl-utz-num-999        .
      *                      *-----------------------------------------*
      *                      * Eventuale messaggio                     *
      *                      *-----------------------------------------*
      ...
      *                  * Fax                                         *
      *                  *---------------------------------------------*
           move      rf-fnt-num-fax       to   w-ctl-utz-num-num      .
           perform   ctl-utz-num-000      thru ctl-utz-num-999        .
      *                      *-----------------------------------------*
      *                      * Eventuale messaggio                     *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "Fornitore :"        to   w-all-str-cat (1)      .
           move      srt-cod-arc          to   w-all-str-cat (2)      .
           move      "- utenza fax :"     to   w-all-str-cat (3)      .
           move      w-ctl-utz-num-num    to   w-all-str-cat (4)      .
           move      "non aggiornata"     to   w-all-str-cat (5)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
      ...
      *                  * Test preliminare                            *
      *                  *---------------------------------------------*
           if        rf-dcf-num-tel       =    spaces and
                     rf-dcf-num-fax       =    spaces
                     go to agg-rec-dcf-500.
      *                  *---------------------------------------------*
      *                  * Telefono                                    *
      *                  *---------------------------------------------*
           move      rf-dcf-num-tel       to   w-ctl-utz-num-num      .
           perform   ctl-utz-num-000      thru ctl-utz-num-999        .
      *                      *-----------------------------------------*
      *                      * Eventuale messaggio                     *
      *                      *-----------------------------------------*
           if        w-ctl-utz-num-flg    not  = "N"
                     move  w-ctl-utz-num-num
                                          to   rf-dcf-num-tel
                     go to agg-rec-dcf-350.
      *                      *-----------------------------------------*
      *                      * Preparazione messaggio                  *
      *                      *-----------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      05                   to   w-all-str-num          .
           move      "Fornitore comm.:"   to   w-all-str-cat (1)      .
           move      srt-cod-arc          to   w-all-str-cat (2)      .
           move      "- utenza :"         to   w-all-str-cat (3)      .
           move      w-ctl-utz-num-num    to   w-all-str-cat (4)      .
           move      "non aggiornata"     to   w-all-str-cat (5)      .
      ...
      *                  * Fax                                         *
      *                  *---------------------------------------------*
           move      rf-dcf-num-fax       to   w-ctl-utz-num-num      .
           perform   ctl-utz-num-000      thru ctl-utz-num-999        .
      *                      *-----------------------------------------*
      *                      * Eventuale messaggio                     *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       ctl-utz-num-010.
      *              *-------------------------------------------------*
      *              * Test su lunghezza numero : oltre i dodici       *
      *              * caratteri nessuna azione                        *
      *              *-------------------------------------------------*
           if        w-ctl-utz-num-num
                    (13 : 8)              not  = spaces
                     move  "N"            to   w-ctl-utz-num-flg
                     go to ctl-utz-num-900.
      *              *-------------------------------------------------*
      *              * Se a spazi : uscita                             *
      *              *-------------------------------------------------*
           if        w-ctl-utz-num-num    =    spaces
                     move  "B"            to   w-ctl-utz-num-flg
                     go to ctl-utz-num-900.
      *              *-------------------------------------------------*
      *              * Se piu' di un carattere strano : uscita         *
      *              *-------------------------------------------------*
           move      zero                 to   w-ctl-utz-num-ctr      .
           inspect   w-ctl-utz-num-num
                                      tallying w-ctl-utz-num-ctr
                     for    all "/"                                   .
           if        w-ctl-utz-num-ctr    >    01
                     move  "N"            to   w-ctl-utz-num-flg
                     go to ctl-utz-num-900.
      *
           move      zero                 to   w-ctl-utz-num-ctr      .
      ...
      *                  *---------------------------------------------*
       ...
       ctl-utz-num-300.
      *              *-------------------------------------------------*
      *              * Estrazione del prefisso e del numero            *
      *              *-------------------------------------------------*
           move      zero                 to   w-ctl-utz-num-ctr      .
      ...
      *                  *---------------------------------------------*
       ...
       ctl-utz-num-420.
      *                  *---------------------------------------------*
      *                  * Che prefisso e numero siano numerici        *
      *                  *---------------------------------------------*
       ctl-utz-num-500.
      *              *-------------------------------------------------*
      *              * Assemblaggio                                    *
      *              *-------------------------------------------------*
           ...
           move      w-ctl-utz-num-pre    to   w-all-str-cat (1)      .
           move      w-ctl-utz-num-utz    to   w-all-str-cat (2)      .
