      ...
      *                                   Fase:    fbghaf              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 14/01/99    *
      *                       Ultima revisione:    Ndk del 02/02/05    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Collegamento fornitori [haf]                *
      *                                                                *
      *                    FORALBERG                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Collegamento Fornitori Foralberg    "       .
      ...
      *              *-------------------------------------------------*
           ...
           string    "Aggiornate nr. "
                     ...
                     " anagrafiche di acquisto prodotto"
                                delimited by   size
                                          into m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
      ...
      *              *                                                 *
      *              * Aggiornamento 02/02/05 - Gianni                 *
      *              *                                                 *
      *              * 48     ARISTARCO SRL        722                 *
      *              * 361    AVIDUE VETRERIA      440                 *
      *              * 736    BETTINELLI           503                 *
      *              * 151    BIALETTI SPA         281                 *
      *              * 215    BORGONOVO VETRERIA   281                 *
      *              * 021    CACCIATORI SRL       822                 *
      *              * 643    CAMBRO               478                 *
      *              * 169    CERVE SPA            169                 *
      *              * 83     COSI TABELLINI       522                 *
      *              * 563    DA.FI.               818                 *
      *              * 287    DECO SRL             566                 *
      *              * 159    DUDSON               1160                *
      *              * 160    DUDSON               1160                *
      *              * 127    FIDENZA VETRARIA     281                 *
      *              * 010    GERLIN               478                 *
      *              * 447    GLOFIS               186                 *
      *              * 746    GNALI PIERFRANCO     585                 *
      *              * 204    AETERNUM GNUTTI      490                 *
      *              * 287    IL BORGO SRL         334                 *
      *              * 061    IMPERIA TRADING      255                 *
      *              * 496    INOXMACEL SNC        98                  *
      *              * 452    ISACCO SRL           333                 *
      *              * 379    INTERSCAMBI          534                 *
      *              * 464    ITALESSE             476                 *
      *              * 618    JOTA SRL             494                 *
      *              * 047    LILIEN               1047                *
      *              * 271    LILLY CODROIPO       603                 *
      *              * 315    MALAVASI ROBOT       108                 *
      *              * 8      DUROBOR              281                 *
      *              * 8      MEDRI                281                 *
      *              * 127    MEDRI                281                 *
      *              * 113    MEDRI                281                 *
      ...
      *              * 392    MENSCH FRANZ         80                  *
      *              * 426    MISKA                128                 *
      *              * 383    M.S.INTERNATIONAL    823                 *
      *              * 413    OLIS SPA             242                 *
      *              * 345    ORGANIZZAZIONE PREV  225                 *
      *              * 718    PAMI PORCELLANE      37                  *
      *              * 410    PARDINI ORESTE       301                 *
      *              * 019    PIAZZA EFFEPI SRL    282                 *
      *              * 384    RASTAL ITALIA        310                 *
      *              * 207    RIVATEX              33                  *
      *              * 548    ROMAGNA OFFICINE     548                 *
      *              * 093    RONCHI SRL           313                 *
      *              * 516    ROYALE               17                  *
      *              * 167    S.A.V.E. VETRERIA    110                 *
      *              * 208    SASSO TESSITURA      276                 *
      *              * 054    SIAM FINE CHINA      808                 *
      *              * 027    SPRING               604                 *
      *              * 316    SUNNY DAY            554                 *
      *              * 294    TAMWOOD              599                 *
      *              * 208    TESBIELLA            711                 *
      ...
      *              * 47     LILIEN                741                *
      *              * 496    INOXMACEL             881                *
      *              * 301    PARDINI ORESTE         43                *
      *              * 410    PARDINI ORESTE         43                *
      *              * 67     MELCOM                887                *
      *              * 140    VALSODO               863                *
      *              * 725    VILLEROY & BOCH       475                *
      *              * 190    DOMO                  350                *
      *              * 747    GALVANOTECNICA        910                *
      *              * 575    GAM                   911                *
      *              * 60     GENERAL IMPORT        281                *
      *              * 274    CEADO                 868                *
      *              * 811    HATCO                 745                *
      *              * 98     INOXMACEL             881                *
      *              * 200    INOXPRAN              836                *
      *              * 275    ROSSI LITTORIO        514                *
      *              * 54     ROYAL                  54                *
      *              * 174    THERMOHAUSER          375                *
      *              * 162    VEBA GLASS             46                *
      *              * 74     BOTTONIFICIO          650                *
      *              * 54     ROYAL                 857                *
      *              * 856    FORNITURE ALB         858                *
      *              * 894    CATERING              864                *
      *              * 274    CEADO                 868                *
      *              * 450    SOLO PER 4500000      879                *
      *              * 637    PAVONI                893                *
      *              * 463    NERO LAVAGNE          900                *
      *              *-------------------------------------------------*
           if        rf-haf-cod-dcf       =    48
                     move  722            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    361
                     move  440            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    736
                     move  503            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    151
                     move  281            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    215
                     move  281            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    021
                     move  822            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    643
                     move  478            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    169
                     move  169            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    83 
                     move  522            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    563
                     move  818            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    287
                     move  566            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    159
                     move  1160           to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    160
                     move  1160           to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    8  
                     move  281            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    127
                     move  281            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    010
                     move  478            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    447
                     move  186            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    746
                     move  585            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    204
                     move  490            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    287
                     move  334            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    061
                     move  255            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    496
                     move  98             to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    452
                     move  333            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    379
                     move  534            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    464
                     move  476            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    618
                     move  494            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    047
                     move  1047           to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    271
                     move  603            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    315
                     move  108            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    127
                     move  281            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    113
                     move  281            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    151
                     move  281            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    392
                     move  80             to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    426
                     move  128            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    383
                     move  823            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    413
                     move  242            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    345
                     move  225            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    718
                     move  37             to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    410
                     move  301            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    019
                     move  282            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    384
                     move  310            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    207
                     move  33             to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    548
                     move  zero           to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    093
                     move  313            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    516
                     move  17             to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    167
                     move  110            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    208
                     move  276            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    054
                     move  808            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    027
                     move  604            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    316
                     move  554            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    294
                     move  599            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    208
                     move  711            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    450
                     move  645            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    23
                     move  24             to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    167
                     move  157            to   rf-haf-alt-dcf
      *              *-------------------------------------------------*
      *              * Aggiunti 02/02/05                               *
      *              *-------------------------------------------------*
           else if   rf-haf-cod-dcf       =    4
                     move  901            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    48
                     move  zero           to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    466
                     move  755            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    105
                     move  890            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    146
                     move  1148           to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    47
                     move  741            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    496
                     move  881            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    301
                     move  43             to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    410
                     move  43             to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    67
                     move  887            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    140
                     move  863            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    725
                     move  475            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    190
                     move  350            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    747
                     move  910            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    575
                     move  911            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    60
                     move  281            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    274
                     move  868            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    811
                     move  745            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    98
                     move  881            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    200
                     move  836            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    275
                     move  514            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    54
                     move  zero           to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    174
                     move  375            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    162
                     move  46             to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    74
                     move  650            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    54
                     move  857            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    856
                     move  858            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    894
                     move  864            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    274
                     move  868            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    450
                     move  879            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    637
                     move  893            to   rf-haf-alt-dcf
           else if   rf-haf-cod-dcf       =    463
                     move  900            to   rf-haf-alt-dcf
           else      move  zero           to   rf-haf-alt-dcf         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [haf]                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "EL "                to   rf-lst-cod-lst         .
           move      zero                 to   rf-lst-cod-cli         .
           move      "EUR"                to   rf-lst-sgl-vlt         .
           move      rf-haf-num-pro       to   rf-lst-num-pro         .
           move      "pgm/dcp/fls/ioc/obj/ioflst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-haf-prz-eur       to   rf-lst-prz-lst         .
       agg-rec-eur-220.
      *                      *-----------------------------------------*
      *                      * Update del record                       *
      *                      *-----------------------------------------*
