      ...
      *                       Ultima revisione:    NdK del 04/01/10    *
      *                    ------------------------------------------- *
      ...
      *                    ------------------------------------------- *
      *                                                                *
      *                    Aggiornamento file [cli] da [fit]           *
      *                    Aggiornamento file [dcc] da [fit]           *
      *                                                                *
      *================================================================*
      ...
      *              * Lettura [old-cli]                               *
      *              *-------------------------------------------------*
           move      rf-fit-cod-cli       to   cli-cod-cli            .
      ...
      *              * Lettura [old-dcc]                               *
      *              *-------------------------------------------------*
           move      rf-fit-cod-cli       to   dcc-cod-cli            .
           read      dcc    with no lock
                            key  is dcc-k01
                            invalid key
                            go to   exe-cnv-dcc-250.
      *              *-------------------------------------------------*
