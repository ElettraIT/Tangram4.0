      ...
      *                                   Fase:    ivaaaq              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 28/10/97    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento Iva Acquisti                  *
      *                                                                *
      *                    TUTTI                                       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento codici IVA per Acquisto  "       .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-dcp                 .
      *              *-------------------------------------------------*
      *              * Lettura record [dcp] per codice Iva             *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
      ...
      *              * Codice Iva                                      *
      *              *-------------------------------------------------*
           move      rf-dcp-cod-iva       to   rf-aaq-cod-iva         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [aaq]                             *
      *              *-------------------------------------------------*
