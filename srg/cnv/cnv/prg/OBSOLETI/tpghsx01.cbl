      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Approvazione preventivo e generazione       *
      *                    commessa                                    *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Start su archivio [hst]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "NUMPRT    "         to   f-key                  .
           move      zero                 to   rf-hst-prt-cml         .
           move      "tpg/gct/fls/ioc/obj/iofhst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [hst]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "tpg/gct/fls/ioc/obj/iofhst"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Write record [hsx] per fotocomposizione         *
      *              *-------------------------------------------------*
           if        rf-hst-fci-snx       not  = 1
                     go to prn-liv-det-200.
           if        rf-hst-fci-not       =    spaces
                     go to prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      rf-hst-prt-cml       to   rf-hsx-prt-cml         .
           move      08                   to   rf-hsx-tip-rec         .
           move      rf-hst-fci-not       to   rf-hsx-agg-400         .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Write record [hsx] per fotolito interna         *
      *              *-------------------------------------------------*
           if        rf-hst-fli-snx       not  = 1
                     go to prn-liv-det-900.
           if        rf-hst-fli-not       =    spaces
                     go to prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Normalizzazione record                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-hst-prt-cml       to   rf-hsx-prt-cml         .
           move      09                   to   rf-hsx-tip-rec         .
           move      rf-hst-fli-not       to   rf-hsx-agg-400         .
           move      spaces               to   rf-hsx-alx-exp         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
