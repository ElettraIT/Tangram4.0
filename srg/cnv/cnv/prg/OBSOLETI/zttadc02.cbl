      ...
      *                                   Fase:    zttadc              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 04/06/10    *
      *                       Ultima revisione:    NdK del 13/11/10    *
      *                    ------------------------------------------- *
      ...
      *                  *---------------------------------------------*
           if        rf-adc-tip-arc       not  = 01 and
                     rf-adc-tip-arc       not  = 02
                     go to stp-srt-inp-adc-900.
       stp-srt-inp-adc-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Ciclo di 80 caratteri                       *
      *                  *---------------------------------------------*
           move      rf-adc-num-con       to   w-all-str-alf          .
       ...
       prn-liv-det-320.
           ...
           if        w-all-str-alf
                    (w-wrk-ctr-002 : 01)  not  = "+" and
                     w-all-str-alf
                    (w-wrk-ctr-002 : 01)  not  = "0" and
                     w-all-str-alf
                    (w-wrk-ctr-002 : 01)  not  = "1" and
                     w-all-str-alf
                    (w-wrk-ctr-002 : 01)  not  = "2" and
                     w-all-str-alf
                    (w-wrk-ctr-002 : 01)  not  = "3" and
                     w-all-str-alf
                    (w-wrk-ctr-002 : 01)  not  = "4" and
                     w-all-str-alf
                    (w-wrk-ctr-002 : 01)  not  = "5" and
                     w-all-str-alf
                    (w-wrk-ctr-002 : 01)  not  = "6" and
                     w-all-str-alf
                    (w-wrk-ctr-002 : 01)  not  = "7" and
                     w-all-str-alf
                    (w-wrk-ctr-002 : 01)  not  = "8" and
                     w-all-str-alf
                    (w-wrk-ctr-002 : 01)  not  = "9"
                     go to  prn-liv-det-320.
      *
           add       1                    to   w-wrk-ctr-003          .
           move      w-all-str-alf
                    (w-wrk-ctr-002 : 01)  to   rf-adc-num-con
                                              (w-wrk-ctr-003 : 01)    .
           go to     prn-liv-det-320.
       prn-liv-det-600.
      *              *-------------------------------------------------*
