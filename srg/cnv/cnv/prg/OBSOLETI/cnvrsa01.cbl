      ...
      *                                   Fase:    cnvrsa              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 19/07/16    *
      *                       Ultima revisione:    NdK del 19/07/16    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Generazione file di chiavi [rsa]            *
      *                                                                *
      *                    STANDARD                                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Generazione file di chiavi [rsa]    "       .
      ...
      *              *-------------------------------------------------*
           if        rf-rsd-mod-rsd       not  = 02
                     go to prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Test su ABI - CAB                               *
      *              *-------------------------------------------------*
           if        rf-rsd-abi-ass       not  numeric
                     move  zero           to   rf-rsd-abi-ass         .
           if        rf-rsd-abi-ass       =    zero
                     go to prn-liv-det-900.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Composizione record [rsa]                       *
      *              *-------------------------------------------------*
           move      rf-rsd-num-rsd       to   rf-rsa-num-rsd         .
           move      rf-rsd-cbp-ass       to   rf-rsa-cbp-ass         .
           move      rf-rsd-abi-ass       to   rf-rsa-abi-ass         .
           move      rf-rsd-cab-ass       to   rf-rsa-cab-ass         .
           move      rf-rsd-ddo-rsd       to   rf-rsa-ddo-rsd         .
           move      rf-rsd-ndo-rsd       to   rf-rsa-ndo-rsd         .
           move      rf-rsd-alx-exp       to   rf-rsa-alx-exp         .
      *              *-------------------------------------------------*
      *              * Scrittura record [rsa]                          *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
           move      "pgm/gep/fls/ioc/obj/iofrsa"
                                          to   s-pat                  .
