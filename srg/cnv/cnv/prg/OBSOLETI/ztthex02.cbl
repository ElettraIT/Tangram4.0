      ...
      *                                   Fase:    ztthex              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 12/12/12    *
      *                       Ultima revisione:    NdK del 12/12/12    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Pulizia contenuto [hex]                     *
      *                                                                *
      *                    SU MISURA PER ZATTI                         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Scansione record 'hex' per pulizia   "       .
      ...
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
           move      rf-hex-dat-rec       to   srt-rec-hex            .
       stp-srt-inp-hex-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        srt-ide-rec          =    "giab"
                     go to prn-liv-det-300.
      *                  *---------------------------------------------*
      *                  * Se documenti precedenti 2012                *
      *                  *---------------------------------------------*
           if        srt-ide-rec          not  = "doc "
                     go to prn-liv-det-900.
           if        srt-kal-rec (18 : 1) not  = "/"
                     go to prn-liv-det-900.
           if        srt-kal-rec (19 : 2) =    "12" or
                     srt-kal-rec (19 : 2) =    "11"
                     go to prn-liv-det-900.
       prn-liv-det-300.
      *              *-------------------------------------------------*
