      ...
      *                                   Fase:    tpgofr              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/11/05    *
      *                       Ultima revisione:    NdK del 23/11/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Eliminazione righe ordini da protocollo     *
      *                                                                *
      *                    TIPOGRAFIA RUMOR                            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Pulizia righe senza testata - RUMOR  "       .
      ...
      *              * Ciclo per [ofr]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-ofr-000  thru stp-srt-inp-ofr-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      10501000366          to   rf-ofr-num-prt         .
           move      00200                to   rf-ofr-num-prg         .
           move      "pgm/orf/fls/ioc/obj/iofofr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-ofr-900.
       stp-srt-inp-ofr-200.
      *              *-------------------------------------------------*
      *              * Read-next su archivio [ofr]                     *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/orf/fls/ioc/obj/iofofr"
                                          to   s-pat                  .
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-ofr-num-prt       not  = 10501000366
                     go to stp-srt-inp-ofr-900.
       stp-srt-inp-ofr-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           go to     stp-srt-inp-ofr-200.
       stp-srt-inp-ofr-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-ofr-999.
       stp-srt-inp-ofr-999.
           exit.
      ...
      *              *-------------------------------------------------*
           perform   agg-rec-ofr-000      thru agg-rec-ofr-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
