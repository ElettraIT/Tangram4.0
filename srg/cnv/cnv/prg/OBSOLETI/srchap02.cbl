      ...
      *                                   Fase:    srchap              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 19/10/98    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [hap] : Serco            *
      *                                                                *
      *                    Update partite per codice CER               *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Aggiornamento Codice CER - partite   "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-let.
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [hrg]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-hrg.
               10  w-let-arc-hrg-flg      pic  x(01)                  .
               10  w-let-arc-hrg-rec      pic  x(04)                  .
               10  w-let-arc-hrg-key      pic  9(07)                  .
               10  w-let-arc-hrg-de1      pic  x(60)                  .
               10  w-let-arc-hrg-de2      pic  x(60)                  .
               10  w-let-arc-hrg-ag1      pic  9(07)                  .
               10  w-let-arc-hrg-ag2      pic  9(07)                  .
               10  w-let-arc-hrg-zp1      pic  9(05)                  .
               10  w-let-arc-hrg-zp2      pic  9(05)                  .
               10  w-let-arc-hrg-zp3      pic  9(05)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Progressivo generico                                  *
      *        *-------------------------------------------------------*
           05  w-cix-prg-001              pic  9(05)                  .
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [hap]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATPTT    "         to   f-key                  .
           move      0970101              to   rf-hap-dat-ipt         .
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [hap]                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione record [hpx]                *
      *                  *---------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhpx"
                                          to   s-pat                  .
      ...
      *                  * Test su codice CEE                          *
      *                  *---------------------------------------------*
           if        rf-hpx-cod-cee       not  = spaces
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Normalizzazione record [hrg]                *
      *                  *---------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhrg"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "PRGMOV    "         to   f-key                  .
           move      rf-hap-num-ptt       to   rf-hrg-prg-mov         .
           move      "sec/tns/fls/ioc/obj/iofhrg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-hap-num-ptt       to   srt-num-ptt            .
      *                  *---------------------------------------------*
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
           move      rf-hrg-cod-cee       to   srt-cod-cee            .
       stp-srt-inp-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-800.
      *                  *---------------------------------------------*
      *                  * Riciclo a record [hap] successivo           *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-200.
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Registr. in corso di trattamento :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       prn-ini-cic-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione comodo per progressivo          *
      *              *-------------------------------------------------*
           move      zero                 to   w-cix-prg-001          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      09                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      srt-num-ptt          to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Incremento contatore record aggiornati          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMPTT    "         to   f-key                  .
           move      srt-num-ptt          to   rf-hpx-num-ptt         .
           move      "sec/tns/fls/ioc/obj/iofhpx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to agg-rec-hpx-800.
      *              *-------------------------------------------------*
      *              * Aggiornamento record [hpx]                      *
      *              *-------------------------------------------------*
           move      srt-cod-cee          to   rf-hpx-cod-cee         .
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           perform   wrt-rec-hpx-000      thru wrt-rec-hpx-999        .
       agg-rec-hpx-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [hpx]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-hpx-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione record [hap]                    *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhap"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPTT    "         to   f-key                  .
           move      srt-num-ptt          to   rf-hap-num-ptt         .
           move      "sec/tns/fls/ioc/obj/iofhap"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "PRGMOV    "         to   f-key                  .
           move      srt-num-ptt          to   rf-hrg-prg-mov         .
           move      "sec/tns/fls/ioc/obj/iofhrg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      rf-hap-num-cnf       to   rf-hpx-num-cnf         .
           move      srt-cod-cee          to   rf-hpx-cod-cee         .
           move      rf-hrg-cod-ddr       to   rf-hpx-cod-ddr         .
           move      rf-hrg-cod-cpe       to   rf-hpx-cod-cpe         .
           move      rf-hrg-cod-cli       to   rf-hpx-cod-cli         .
           move      rf-hrg-dpz-cli       to   rf-hpx-dpz-cli         .
           move      rf-hrg-tip-dsn       to   rf-hpx-tip-dsn         .
           move      rf-hrg-cod-dsn       to   rf-hpx-cod-dsn         .
           move      rf-hrg-cod-sds       to   rf-hpx-cod-sds         .
           move      rf-hrg-aut-sds       to   rf-hpx-aut-sds         .
           move      spaces               to   rf-hpx-alx-exp         .
       cmp-rec-hpx-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [hpx]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-hpx-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-hpx-000      thru cmp-rec-hpx-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
