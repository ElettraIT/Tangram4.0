      ...
      *                                   Fase:    sirofr              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 28/06/10    *
      *                       Ultima revisione:    NdK del 21/04/17    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Update righe per prezzo ordine 266          *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      11701000270          to   rf-ofr-num-prt         .
      ...
      *              * Test su protocollo                              *
      *              *-------------------------------------------------*
           if        rf-ofr-num-prt       not  = 11701000270
                     go to prn-liv-det-320.
      *              *-------------------------------------------------*
      *              * Test su progressivo                             *
      *              *-------------------------------------------------*
           if        rf-ofr-num-prg       not  = 00602
                     go to prn-liv-det-320.
      *              *-------------------------------------------------*
      *              * Test sul codice prodotto                        *
      *              *-------------------------------------------------*
           if        rf-ofr-alf-mag       not  = "20566         "
                     go to prn-liv-det-320.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Prezzo netto                                    *
      *              *-------------------------------------------------*
           move      rf-ofr-prz-acq       to   rf-ofr-prz-net         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [ofr]                             *
      *              *-------------------------------------------------*
