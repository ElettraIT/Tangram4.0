      ...
      *                                   Fase:    fbgaaf              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/03/02    *
      *                       Ultima revisione:    NdK del 13/03/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Conversione anagrafiche fornitori in Euro   *
      *                    [aaf] e [aaq]                               *
      *                                                                *
      *                    FORALBERG                                   *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Conversione listini acquisto Foralberg "       .
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-c02                      pic  9(03)                  .
           05  w-crc                      pic  9(11)                  .
           05  w-cdc                      pic  9(08)v9(07)            .
           05  w-coc                      pic  9(08)v9(07)            .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fbg/aaf"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fbg/aaf.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fbg/aaq"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fbg/aaq.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              * Trattamento [aaq]                               *
      *              *-------------------------------------------------*
           perform   prn-liv-det-aaq-000  thru prn-liv-det-aaq-999    .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Trattamento [aaf]                               *
      *              *-------------------------------------------------*
           perform   prn-liv-det-aaf-000  thru prn-liv-det-aaf-999    .
       prn-liv-det-800.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-liv-det-aaq-000.
      *              *-------------------------------------------------*
      *              * Ottenimento record [aaq]                        *
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMPRO    "         to   f-key                  .
           move      rf-aaf-tip-mag       to   rf-aaq-tip-mag         .
           move      rf-aaf-num-pro       to   rf-aaq-num-pro         .
           move      "pgm/dcf/fls/ioc/obj/iofaaq"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        rf-aaq-sgl-vlt       =    "EUR"
                     go to prn-liv-det-aaq-800.
       prn-liv-det-aaq-200.
      *              *-------------------------------------------------*
      *              * Conversioni                                     *
      *              *-------------------------------------------------*
      ...
      *                  * fatturazione                                *
      *                  *---------------------------------------------*
           if        rf-aaq-sgl-vlt       =    "LIT" or
                     rf-aaq-sgl-vlt       =    "   "
                     go to prn-liv-det-aaq-420
           else if   rf-aaq-sgl-vlt       =    "FRF"
                     go to prn-liv-det-aaq-430
           else if   rf-aaq-sgl-vlt       =    "DEM"
                     go to prn-liv-det-aaq-440
           else      go to prn-liv-det-aaq-450.
       prn-liv-det-aaq-420.
      *                  *---------------------------------------------*
      *                  * Se Lire                                     *
      *                  *---------------------------------------------*
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           perform   cnv-eur-aaq-lit-000  thru cnv-eur-aaq-lit-999    .
      *                      *-----------------------------------------*
      *                      * A fasi comuni                           *
      *                      *-----------------------------------------*
           go to     prn-liv-det-aaq-700.
       prn-liv-det-aaq-430.
      *                  *---------------------------------------------*
      *                  * Se Franchi francesi                         *
      *                  *---------------------------------------------*
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           perform   cnv-eur-aaq-frf-000  thru cnv-eur-aaq-frf-999    .
      *                      *-----------------------------------------*
      *                      * A fasi comuni                           *
      *                      *-----------------------------------------*
           go to     prn-liv-det-aaq-700.
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           perform   cnv-eur-aaq-dem-000  thru cnv-eur-aaq-dem-999    .
      *                      *-----------------------------------------*
      *                      * A fasi comuni                           *
      *                      *-----------------------------------------*
           go to     prn-liv-det-aaq-700.
      ...
      *    * Trattamento [aaq]                                         *
      *    *                                                           *
      *    * Subroutine di conversione record da Lire                  *
      *    *-----------------------------------------------------------*
       cnv-eur-aaq-lit-000.
      *              *-------------------------------------------------*
      *              * Valuta                                          *
      ...
      *    * Trattamento [aaq]                                         *
      *    *                                                           *
      *    * Subroutine di conversione record da Franchi Francesi      *
      *    *-----------------------------------------------------------*
       cnv-eur-aaq-frf-000.
      *              *-------------------------------------------------*
      *              * Valuta                                          *
      ...
      *              * Prezzo d'acquisto di riferimento                *
      *              *-------------------------------------------------*
           if        rf-aaq-prz-acr       not  = zero
                     divide  w-cdc        into rf-aaq-prz-acr         .
       cnv-eur-aaq-frf-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     cnv-eur-aaq-frf-999.
       cnv-eur-aaq-frf-999.
           exit.
      ...
      *    * Trattamento [aaq]                                         *
      *    *                                                           *
      *    * Subroutine di conversione record da Marchi Tedeschi       *
      *    *-----------------------------------------------------------*
       cnv-eur-aaq-dem-000.
      *              *-------------------------------------------------*
      *              * Valuta                                          *
      ...
      *                  * fatturazione                                *
      *                  *---------------------------------------------*
           if        rf-aaf-sgl-vlt       =    "LIT" or
                     rf-aaf-sgl-vlt       =    "   "
                     go to prn-liv-det-aaf-420
           else if   rf-aaf-sgl-vlt       =    "FRF"
                     go to prn-liv-det-aaf-430
           else if   rf-aaf-sgl-vlt       =    "DEM"
                     go to prn-liv-det-aaf-440
           else      go to prn-liv-det-aaf-450.
       prn-liv-det-aaf-420.
      *                  *---------------------------------------------*
      *                  * Se Lire                                     *
      *                  *---------------------------------------------*
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           perform   cnv-eur-aaf-lit-000  thru cnv-eur-aaf-lit-999    .
      *                      *-----------------------------------------*
      *                      * A fasi comuni                           *
      *                      *-----------------------------------------*
           go to     prn-liv-det-aaf-700.
       prn-liv-det-aaf-430.
      *                  *---------------------------------------------*
      *                  * Se Franchi francesi                         *
      *                  *---------------------------------------------*
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           perform   cnv-eur-aaf-frf-000  thru cnv-eur-aaf-frf-999    .
      *                      *-----------------------------------------*
      *                      * A fasi comuni                           *
      *                      *-----------------------------------------*
           go to     prn-liv-det-aaf-700.
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           perform   cnv-eur-aaf-dem-000  thru cnv-eur-aaf-dem-999    .
      *                      *-----------------------------------------*
      *                      * A fasi comuni                           *
      *                      *-----------------------------------------*
           go to     prn-liv-det-aaf-700.
      ...
      *                  *---------------------------------------------*
       ...
       cnv-eur-aaf-lit-200.
           add       1                    to   w-inx                  .
           if        w-inx                >    6
                     go to cnv-eur-aaf-lit-900.
      *                  *---------------------------------------------*
      *                  * Prezzo unitario                             *
      *                  *---------------------------------------------*
           move      rf-aaf-prz-pes (w-inx)
                                          to   w-cal-imp-eur-imi      .
           move      zero                 to   w-cal-imp-eur-dec      .
           perform   cal-imp-eur-000      thru cal-imp-eur-999        .
           move      w-cal-imp-eur-ime    to   rf-aaf-prz-pes (w-inx) .
      *                  *---------------------------------------------*
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
           go to     cnv-eur-aaf-lit-200.
       cnv-eur-aaf-lit-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     cnv-eur-aaf-lit-999.
       cnv-eur-aaf-lit-999.
           exit.
      ...
      *                  *---------------------------------------------*
       ...
       cnv-eur-aaf-frf-200.
           add       1                    to   w-inx                  .
           if        w-inx                >    6
                     go to cnv-eur-aaf-frf-900.
      *                  *---------------------------------------------*
      *                  * Prezzo unitario                             *
      *                  *---------------------------------------------*
           if        rf-aaf-prz-pes (w-inx)
                                          not  = zero
                     divide  w-cdc        into rf-aaf-prz-pes (w-inx) .
      *                  *---------------------------------------------*
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
           go to     cnv-eur-aaf-frf-200.
       cnv-eur-aaf-frf-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     cnv-eur-aaf-frf-999.
       cnv-eur-aaf-frf-999.
           exit.
      ...
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
           go to     cnv-eur-aaf-dem-200.
       cnv-eur-aaf-dem-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     cnv-eur-aaf-dem-999.
       cnv-eur-aaf-dem-999.
           exit.
