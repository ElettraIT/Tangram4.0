      ...
      *                                   Fase:    ferlfd              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 27/07/05    *
      *                       Ultima revisione:    NdK del 28/07/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento storico per articolo 23349    *
      *                                                                *
      *                    Ferramenta                                  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
               10  srt-key-lfd.
                   ...
                   15  srt-cod-dcf        pic  9(07)                  .
                   15  srt-sgl-vlt        pic  x(03)                  .
                   15  srt-tip-mag        pic  9(02)                  .
                   15  srt-num-mag        pic  9(07)                  .
                   15  srt-fda-pif        pic  x(14)                  .
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [lfd]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "LSTFNTDVF "         to   f-key                  .
           move      01                   to   rf-lfd-tip-rec         .
           move      0003031              to   rf-lfd-cod-dcf         .
           move      "EUR"                to   rf-lfd-sgl-vlt         .
           move      01                   to   rf-lfd-tip-mag         .
           move      0012673              to   rf-lfd-num-mag         .
      ...
      *              *-------------------------------------------------*
           if        rf-lfd-tip-rec       not  = 01      or
                     rf-lfd-cod-dcf       not  = 0003031 or
                     rf-lfd-sgl-vlt       not  = "EUR"   or
                     rf-lfd-tip-mag       not  = 01      or
                     rf-lfd-num-mag       not  = 0012673
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Sel su [lfd]                                    *
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-lfd-tip-rec       to   srt-tip-rec            .
           move      rf-lfd-cod-dcf       to   srt-cod-dcf            .
           move      rf-lfd-sgl-vlt       to   srt-sgl-vlt            .
           move      rf-lfd-tip-mag       to   srt-tip-mag            .
           move      rf-lfd-num-mag       to   srt-num-mag            .
           move      rf-lfd-fda-pif       to   srt-fda-pif            .
           move      rf-lfd-dva-fin       to   srt-dva-fin            .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fer/lfd"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fer/lfd.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "LSTFNTDVF "         to   f-key                  .
           move      srt-tip-rec          to   rf-lfd-tip-rec         .
           move      srt-cod-dcf          to   rf-lfd-cod-dcf         .
           move      srt-sgl-vlt          to   rf-lfd-sgl-vlt         .
           move      srt-tip-mag          to   rf-lfd-tip-mag         .
           move      srt-num-mag          to   rf-lfd-num-mag         .
           move      srt-fda-pif          to   rf-lfd-fda-pif         .
           move      srt-dva-fin          to   rf-lfd-dva-fin         .
           move      "pgm/dcf/fls/ioc/obj/ioflfd"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      1050716              to   rf-lfd-dva-fin         .
      *                  *---------------------------------------------*
      *                  * Aggiornamento data finale in reverse        *
      *                  *---------------------------------------------*
           move      99999999             to   rf-lfd-dvf-rev         .
           if        rf-lfd-dva-fin       not  = zero
                     subtract   19000000  from rf-lfd-dvf-rev
                     subtract   rf-lfd-dva-fin
                                          from rf-lfd-dvf-rev         .
      *                  *---------------------------------------------*
      *                  * A scrittura                                 *
      *                  *---------------------------------------------*
