      ...
      *                       Ultima revisione:    NdK del 20/12/97    *
      *                    ------------------------------------------- *
      ...
      *                    ZATTI                                       *
      *                                                                *
      *                    Listino (1) base prodotti con sconti        *
      *                                                                *
      ...
      *                  * Specifica libera                            *
      *                  *                                             *
      *                  * - Ospita provvisoriamente il campo in-box   *
      *                  *---------------------------------------------*
           move      w-lds-001-inn-box    to   rf-dcp-spc-lib         .
      *                      *-----------------------------------------*
      *                      * Allineamento a sinistra                 *
      *                      *-----------------------------------------*
           move      10                   to   w-all-str-lun          .
           move      rf-dcp-spc-lib       to   w-all-str-alf          .
           perform   all-str-asx-000      thru all-str-asx-999        .
           move      w-all-str-alf        to   rf-dcp-spc-lib         .
      *                  *---------------------------------------------*
      *                  * Coefficienti                                *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      0701004              to   rf-dcp-ctp-ven         .
      *                  *---------------------------------------------*
      *                  * Unita' di misura                            *
      *                  *---------------------------------------------*
      ...
      *                  * Prezzo di listino                           *
      *                  *---------------------------------------------*
           move      w-lds-001-prz-lsb    to   rf-dcp-prz-lst         .
      *                  *---------------------------------------------*
      *                  * Lotto di vendita                            *
      *                  *---------------------------------------------*
