      ...
      *                                   Fase:    edtsdb              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 22/03/10    *
      *                       Ultima revisione:    NdK del 09/03/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento buon esito                    *
      *                                                                *
      *                    EDITEL                                      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Aggiornamento Buon esito - EDITEL   "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      11700000001          to   rf-sdb-num-sdb         .
           move      "pgm/gep/fls/ioc/obj/iofsdb"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           if        rf-sdb-num-ddp       not  = 11700000001
                     go to prn-liv-det-300.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Forzatura data presunto buon esito              *
      *              *-------------------------------------------------*
