      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [bir] : ZATTI            *
      *                                                                *
      ...
      *                          *-------------------------------------*
           ...
           move      rf-bit-psr-aac (1)   to   d-per-scr-psr-cli (1)  .
           move      rf-bit-psr-aac (2)   to   d-per-scr-psr-cli (2)  .
           move      rf-bit-psr-aac (3)   to   d-per-scr-psr-cli (3)  .
           move      rf-bit-psr-aac (4)   to   d-per-scr-psr-cli (4)  .
           move      rf-bit-psr-aac (5)   to   d-per-scr-psr-cli (5)  .
           move      rf-bit-csr-aac       to   d-per-scr-csr-cli      .
           move      rf-bir-cod-arc       to   d-per-scr-cod-cli      .
           move      rf-bit-cod-lst       to   d-per-scr-cod-lst      .
           move      c-sgl                to   d-per-scr-sgl-vpf      .
           move      rf-bir-num-pro       to   d-per-scr-num-pro      .
           move      rf-bir-dat-doc       to   d-per-scr-dat-rif      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-bir-prz-lrs       to   w-det-prz-net-prz      .
      ...
      *                          * Test                                *
      *                          *-------------------------------------*
           if        w-det-prz-net-prz    =    rf-bir-prz-nts
                     go to prn-liv-det-900.
      *                          *-------------------------------------*
      *                          * Nuovo netto standard                *
      *                          *-------------------------------------*
           move      w-det-prz-net-prz    to   rf-bir-prz-nts         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [bir]                             *
      *              *-------------------------------------------------*
