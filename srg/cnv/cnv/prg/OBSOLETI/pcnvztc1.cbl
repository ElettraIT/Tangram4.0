      ...
      *                       Ultima revisione:    NdK del 18/02/14    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento anagrafica clienti            *
      *                                                                *
      *                    ZATTI                                       *
      *                                                                *
      *                    Aggiornamento codice Agente da file.csv     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento anagrafiche clienti ZATTI "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-cli.
           05  w-cli-cod-cli              pic  9(05)                  .
           05  w-cli-cod-age              pic  9(07)                  .
      ...
      *                  * Codice cliente                              *
      *                  *---------------------------------------------*
           move      w-lds-000 (005:05)   to   w-cli-cod-cli          .
           if        w-cli-cod-cli        not  numeric
                     move  zero           to   w-cli-cod-cli          .
      *
           if        w-cli-cod-cli        =    zero
      ...
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      03                   to   v-car                  .
           move      w-lds-000 (031:03)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-cli-cod-age          .
       xcv-trt-pds-500.
      *              *-------------------------------------------------*
      ...
      *                  * Test sul codice                             *
      *                  *---------------------------------------------*
           if        w-cli-cod-age        =    zero
                     go to xcv-trt-pds-600.
      *                  *---------------------------------------------*
      *                  * Rewrite record [dcc]                        *
      *                  *---------------------------------------------*
           perform   rew-rec-dcc-000      thru rew-rec-dcc-999        .
       xcv-trt-pds-586.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cli-cod-cli        to   rf-dcc-cod-cli         .
      ...
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to rew-rec-dcc-999.
      *              *-------------------------------------------------*
      *              * Aggiornamento agente                            *
      *              *-------------------------------------------------*
           move      w-cli-cod-age        to   rf-dcc-cod-age         .
       prn-fin-lr1-200.
      *              *-------------------------------------------------*
      *              * Update record [dcc]                             *
      *              *-------------------------------------------------*
