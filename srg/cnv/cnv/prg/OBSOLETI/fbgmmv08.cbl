      ...
      *                       Ultima revisione:    NdK del 27/06/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Rilevazione schede LIFO 2005 con andamento  *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   RILEVAZIONE DIMIMUZIONI LIFO 2005    "       .
...
______*              move  "#"            to   w-cnt-prn-flg-sub      .
      ...
      *                  *---------------------------------------------*
      *                  * Test se in giacenza al 31/12/04             *
      *                  *---------------------------------------------*
           if        w-det-sld-mms-qta    =    zero
                     go to prn-liv-det-900.
       prn-liv-det-030.
      *              *-------------------------------------------------*
      *              * Determinazione costo medio ponderato 31/12/04   *
      *              *-------------------------------------------------*
           move      "VM"                 to   d-vun-mag-tip-ope      .
           move      0001                 to   d-vun-mag-tip-val      .
           move      1041231              to   d-vun-mag-dat-val      .
      ...
      *                  * Inizio scansione                            *
      *                  *---------------------------------------------*
           move      d-vun-mag-val-uni    to   w-det-ese-105-val      .
       ...
       prn-liv-det-200.
           ...
           if        w-det-ese-105-ctr    >    10
                     go to prn-liv-det-900.
      *                  *---------------------------------------------*
      *                  * Se elemento di confronto a zero             *
      *                  *---------------------------------------------*
           if        w-det-ese-105-val    =    zero
                     move  rf-mmv-ump-pre
                          (w-det-ese-105-ctr)
