      ...
      *                       Ultima revisione:    NdK del 10/05/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [ocf]                    *
      *                                                                *
      *                    Update per pulizia righe forecast           *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
      *            * Numero progressivo nel protocollo ordine cliente  *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     Aggiornamento evasione Forecast    "       .
      ...
      *              * Ciclo per [ocf]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-ocf-000  thru stp-srt-inp-ocf-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-ocf-900.
       stp-srt-inp-ocf-200.
      *              *-------------------------------------------------*
      *              * Read-next su archivio [ocf]                     *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/orc/fls/ioc/obj/iofocf"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-ocf-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [ocf]                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se l'ordine di evasione esiste         *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      rf-ocf-num-prt       to   rf-ocr-num-prt         .
           move      rf-ocf-num-prg       to   rf-ocr-num-prg         .
           move      "pgm/orc/fls/ioc/obj/iofocr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-ocr                 .
      *                      *-----------------------------------------*
      *                      * Se record non trovato : cancellazione   *
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-ocf-600
           else      go to stp-srt-inp-ocf-500.
       stp-srt-inp-ocf-500.
      *                  *---------------------------------------------*
      *                  * Se l'ordine di evasione ha lo stesso pro-   *
      *                  * dotto                                       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Bufferizzazione prodotto da [ocr]       *
      *                      *-----------------------------------------*
           move      rf-ocr-num-pro       to   w-det-num-pro-num      .
      *                      *-----------------------------------------*
      *                      * Normalizzazione record [ocr]            *
      *                      *-----------------------------------------*
           move      "NO"                 to   f-ope                  .
      ...
      *                      *-----------------------------------------*
           ...
           call      s-pat               using f
                                               rf-ocr                 .
      *                      *-----------------------------------------*
      *                      * Se record trovato : confronto           *
      *                      *-----------------------------------------*
           if        rf-ocr-num-pro       =    w-det-num-pro-num
                     go to stp-srt-inp-ocf-500
           else      go to stp-srt-inp-ocf-600.
       stp-srt-inp-ocf-600.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-ocf-num-prt       to   srt-num-prt            .
           move      rf-ocf-num-prg       to   srt-num-prg            .
       stp-srt-inp-ocf-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-ocf-800.
      *                  *---------------------------------------------*
      *                  * Riciclo a record [ocf] successivo           *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-ocf-200.
       stp-srt-inp-ocf-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-ocf-999.
       stp-srt-inp-ocf-999.
           exit.
      ...
      *              * Composizione chiave                             *
      *              *-------------------------------------------------*
           move      srt-num-prt          to   rf-ocf-num-prt         .
           move      srt-num-prg          to   rf-ocf-num-prg         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
