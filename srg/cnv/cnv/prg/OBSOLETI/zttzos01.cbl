      ...
      *                                   Fase:    zttzos              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 03/12/08    *
      *                       Ultima revisione:    NdK del 03/12/08    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione filtri da Cataloghi prodotti      *
      *                                                                *
      *                    ZATTI                                       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Creazione filtri selezione da catalogo "       .
      ...
      *        *-------------------------------------------------------*
      *        * Comodo per codice filtro                              *
      *        *-------------------------------------------------------*
           05  w-wrk-cod-flt              pic  9(07)                  .
           05  w-wrk-mne-flt              pic  x(10)                  .
           05  w-wrk-ele-flt              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Elenco elementi bufferizzati                          *
      *        *-------------------------------------------------------*
           05  w-wrk-ser-els              pic  9(02)                  .
           05  w-wrk-ser-sel.
               10  w-wrk-ser-ele occurs 72.
                   15  w-wrk-ser-sel-num  pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di rottura                 *
      *              *-------------------------------------------------*
           move      spaces               to   w-rot-l01-flg-cpv      .
      *              *-------------------------------------------------*
      *              * Start su file [cpv]                             *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
       ...
       prn-let-seq-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione contatore                       *
      *              *-------------------------------------------------*
           move      w-wrk-ctr-002        to   w-wrk-ele-flt          .
      *              *-------------------------------------------------*
      ...
      *              * Test su contatore                               *
      *              *-------------------------------------------------*
           if        w-wrk-ctr-002        not  > 72
                     go to prn-let-seq-999.
           if        w-rot-l01-flg-cpv    =    spaces
                     move  "#"            to   w-rot-l01-flg-cpv
           else      move  spaces         to   w-rot-l01-flg-cpv      .
           move      1                    to   w-wrk-ctr-002          .
           go to     prn-let-seq-999.
       prn-let-seq-900.
      *              *-------------------------------------------------*
      *              * Se fine file                                    *
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-cpv-cod-cpv       to   w-rot-l01-cod-cpv      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  * Codice numerico prodotto                    *
      *                  *---------------------------------------------*
           move      zero                 to   w-wrk-ser-sel-num
                                              (w-wrk-ctr-003)         .
      *                  *---------------------------------------------*
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
      ...
      *                  * Test se da scrivere                         *
      *                  *---------------------------------------------*
           if        w-wrk-ele-flt        not  > zero
                     go to prn-fin-lr1-999.
                     
           if        w-wrk-ser-sel-num (01)
                                          not  > zero
                     go to prn-fin-lr1-999.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-cpv-num-pro       to   w-wrk-ser-sel-num
                                              (w-wrk-ctr-002)         .
       prn-liv-det-700.
      *              *-------------------------------------------------*
      *              * Aggiornamento contatore                         *
      ...
      *                  *---------------------------------------------*
           ...
           move      w-wrk-cod-flt        to   rf-zos-cod-flt         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      "IG"                 to   s-ope                  .
           ...
           move      w-wrk-mne-flt        to   rf-zos-cod-mne         .
      ...
      *                  *---------------------------------------------*
           ...
           move      "Sequenza catalogo :"
                                          to   w-all-str-cat (1)      .
           move      w-rot-l01-cod-cpv    to   w-all-str-cat (2)      .
      ...
      *                  *---------------------------------------------*
           move      rf-zos-des-flt       to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   rf-zos-des-key         .
       cmp-rec-zos-esl-100.
      *              *-------------------------------------------------*
      *              * Ciclo di scrittura                              *
      *              *-------------------------------------------------*
      ...
      *                  * Codice numerico prodotto                    *
      *                  *---------------------------------------------*
           move      w-wrk-ser-sel-num
                    (w-wrk-ctr-003)       to   w-zos-esl-dcp-num
                                              (w-wrk-ctr-003)         .
           if        w-wrk-ser-sel-num
                    (w-wrk-ctr-003)       not  numeric  
      ...
      *              *-------------------------------------------------*
           ...
           move      w-wrk-ele-flt        to   w-zos-esl-dcp-els      .
