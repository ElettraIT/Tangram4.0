      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Conversione anagrafica prodotti per         *
      *                    ZATTI da file 'LIS1INT.TXT'                 *
      *                                                                *
      *                    N.B.: Inner-box va nel lotto di vendita     *
      *                                                                *
      *                    N.B.: Aggiornamento di 'aaq' e 'mau'        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Conversione anagraf. prodotti ZATTI Srl "       .
      ...
      *              *-------------------------------------------------*
      ...
      _________
      *                  *---------------------------------------------*
      *                  * Il programma scansiona il file sequenziale  *
      *                  * Il programma scansiona il file sequenziale  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-lds-000 (001:20)   =    "         O PORTA    "
                     go to xcv-trt-pds-900.
           if        w-lds-000 (001:20)   =    "--------------------"
                     go to xcv-trt-pds-900.
           if        w-lds-000 (001:20)   =    "CODICE     DESCRIZIO"
                     go to xcv-trt-pds-900.
           if        w-lds-000 (001:20)   =    "Azienda    1  ZATTI "
                     go to xcv-trt-pds-900.
           if        w-lds-000 (051:20)   =    ">>>   ARCHIVIO MAGAZ"
                     go to xcv-trt-pds-900.
       xcv-trt-pds-200.
      *              *-------------------------------------------------*
      *              * Prodotti normali                                *
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Quantita' per confezione e lotto di ven *
      *                      *-----------------------------------------*
           move      zero                 to   w-det-qta-cfz-tip      .
           move      zero                 to   w-det-qta-cfz-qta      .
           move      zero                 to   w-det-qta-cfz-inb      .
           if        w-lds-001-qta-cfz    =    spaces
                     go to xcv-trt-pds-220.
      *                          *-------------------------------------*
      *                          * Conversione                         *
      *                          *-------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      05                   to   v-car                  .
           move      w-lds-001-qta-cfz    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-qta-cfz-qta      .
           move      01                   to   w-det-qta-cfz-tip      .
       xcv-trt-pds-220.
           if        w-lds-001-inn-box    =    spaces
      ...
      *                          *-------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      05                   to   v-car                  .
           move      w-lds-001-inn-box    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-qta-cfz-inb      .
       xcv-trt-pds-230.
      *                      *-----------------------------------------*
      *                      * Prezzo di listino base                  *
      *                      *-----------------------------------------*
           move      zero                 to   w-det-lst-bas-prz      .
           if        w-lds-001-prz-lsb    =    spaces
                     go to xcv-trt-pds-240.
      *                          *-------------------------------------*
      *                          * Conversione                         *
      *                          *-------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      10                   to   v-car                  .
           move      w-lds-001-prz-lsb    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-lst-bas-prz      .
       xcv-trt-pds-240.
      *                      *-----------------------------------------*
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      zero                 to   w-det-cod-dcf-cod      .
           if        w-lds-001-dcf-pfz    =    spaces
      ...
      *                          *-------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      05                   to   v-car                  .
           move      w-lds-001-dcf-pfz    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-cod-dcf-cod      .
       xcv-trt-pds-250.
       xcv-trt-pds-400.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Incremento numero records scritti [aaq]     *
      *                  *---------------------------------------------*
           add       1                    to   w-pds-aaq              .
      *                  *---------------------------------------------*
      *                  * Visualizzo records scritti                  *
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-mau                 .
      *              *-------------------------------------------------*
      *              * Incremento numero records scritti [mau]         *
      *              *-------------------------------------------------*
           add       1                    to   w-pds-mau              .
      *              *-------------------------------------------------*
      *              * Visualizzo records scritti                      *
      ...
      *                  *---------------------------------------------*
           ...
           string    "Codice prodotto non identificato : "
                                delimited by size
                     w-lds-001-cod-pro
                                delimited by spaces
                                          into m-msg                  .
