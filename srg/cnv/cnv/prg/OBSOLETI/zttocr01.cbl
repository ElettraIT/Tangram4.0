      ...
      *                                   Fase:    zttocr              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 28/08/03    *
      *                       Ultima revisione:    NdK del 28/08/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [ocr] : ZATTI            *
      *                                                                *
      *                    Sistemazione agenti 11 e 19 netto standard  *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna fattura entro i limiti assegnati !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
      *              * Test se riga da updatare                        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se riga prodotto                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-oct-cod-age       =    11 or
                     rf-oct-cod-age       =    19
                     go to prn-liv-det-200
           else      go to prn-liv-det-900.
      *                  *---------------------------------------------*
      *                  * Test su data documenti (da 01/07/03)        *
      *                  *---------------------------------------------*
           if        rf-oct-dat-doc       <    1030701
                     go to prn-liv-det-900.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *                          * Test                                *
      *                          *-------------------------------------*
           if        w-det-prz-net-prz    =    rf-ocr-prz-nts
                     go to prn-liv-det-900.
      *                          *-------------------------------------*
      *                          * Nuovo netto standard                *
      *                          *-------------------------------------*
