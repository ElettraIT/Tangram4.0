      ...
      *                                   Fase:    tmihsc              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 28/05/03    *
      *                       Ultima revisione:    NdK del 28/05/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [hsc] : TEMI             *
      *                                                                *
      *                    Aggiunta codice SESTCD3A se SESTCD2A        *
      *                                                                *
      *================================================================*
      ...
      *              * Ciclo per [hsc]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-hsc-000  thru stp-srt-inp-hsc-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-hsc-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [hsc]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "PROCLI    "         to   f-key                  .
           move      0000432              to   rf-hsc-num-pro         .
           move      zero                 to   rf-hsc-num-prg         .
           move      zero                 to   rf-hsc-cod-cli         .
           move      spaces               to   rf-hsc-dpz-cli         .
           move      "tmi/gsc/fls/ioc/obj/iofhsc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-hsc-900.
       stp-srt-inp-hsc-200.
      *              *-------------------------------------------------*
      *              * Read-next su archivio [hsc]                     *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "tmi/gsc/fls/ioc/obj/iofhsc"
                                          to   s-pat                  .
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-hsc-num-pro       not  = 0000432
                     go to stp-srt-inp-hsc-900.
       stp-srt-inp-hsc-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [hsc]                      *
      *              *-------------------------------------------------*
       stp-srt-inp-hsc-600.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-hsc-num-pro       to   srt-num-pro            .
           move      rf-hsc-num-prg       to   srt-num-prg            .
           move      rf-hsc-cod-cli       to   srt-cod-cli            .
           move      rf-hsc-dpz-cli       to   srt-dpz-cli            .
      *                  *---------------------------------------------*
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
           move      rf-hsc               to   srt-rec-hsc            .
       stp-srt-inp-hsc-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-hsc-800.
      *                  *---------------------------------------------*
      *                  * Riciclo a record [hsc] successivo           *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-hsc-200.
       stp-srt-inp-hsc-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-hsc-999.
       stp-srt-inp-hsc-999.
           exit.
      ...
      *              * Nuovo record [hsc]                              *
      *              *-------------------------------------------------*
           perform   new-rec-hsc-000      thru new-rec-hsc-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  * Composizione chiave                         *
      *                  *---------------------------------------------*
           add       00050                to   rf-hsc-num-prg         .
           move      0000445              to   rf-hsc-num-pro         .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
           move      00001                to   rf-hsc-qta-pro         .
           move      zero                 to   rf-hsc-prz-ven         .
           move      1030430              to   rf-hsc-dat-doc         .
           move      "OMAGGIO   "         to   rf-hsc-num-doc         .
           move      "S"                  to   rf-hsc-flg-spd         .
           move      spaces               to   rf-hsc-flg-sna         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
