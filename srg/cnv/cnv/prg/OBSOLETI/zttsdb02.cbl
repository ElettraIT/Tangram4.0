      ...
      *                                   Fase:    zttsdb              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 10/09/12    *
      *                       Ultima revisione:    NdK del 10/09/12    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sistemazione per erroneo lancio di 'gep960' *
      *                                                                *
      *                    ZATTI (Michela e Daniele)                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Ripristino scadenze stornate da 'gep960'"       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1120907              to   rf-sdb-ide-dat         .
      ...
      *              * Test su utente                                  *
      *              *-------------------------------------------------*
           if        rf-sdb-ide-ute       not  = "michela "
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test su data                                    *
      *              *-------------------------------------------------*
           if        rf-sdb-ide-dat       not  = 1120907
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test su fase                                    *
      *              *-------------------------------------------------*
           if        rf-sdb-ide-fas       not  = "gep960"
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test su data storno                             *
      *              *-------------------------------------------------*
           if        rf-sdb-dtr-sto       not  = 1120907
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Test su si/no nuova scadenza a fronte storno    *
      *              *-------------------------------------------------*
           if        rf-sdb-ens-sto       not  = 02
                     go to prn-liv-det-300.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Forzatura dati storno                           *
      *              *-------------------------------------------------*
