      ...
      *                                   Fase:    fbgaaf              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 22/03/91    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento prezzi di acquisto            *
      *                                                                *
      *                    Foralberg                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento prezzi acquisto FORALBERG "       .
      ...
      *        *-------------------------------------------------------*
      *        * Per determinazione costo lordo                        *
      *        *-------------------------------------------------------*
           05  w-det-scs-prz.
      *            *---------------------------------------------------*
      *            * Comodo                                            *
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "PRFNFM    "         to   f-key                  .
           move      rf-aaf-tip-mag       to   rf-haf-tip-mag         .
           move      rf-aaf-num-pro       to   rf-haf-num-pro         .
           move      rf-aaf-cod-dcf       to   rf-haf-cod-dcf         .
           move      rf-aaf-fda-pif       to   rf-haf-fda-pif         .
           move      "fbg/gpf/fls/ioc/obj/iofhaf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Aggiornamento dati di acquisto                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Valuta                                      *
      *                  *---------------------------------------------*
           move      rf-haf-sgl-vlt       to   rf-aaf-sgl-vlt         .
           if        rf-haf-sgl-vlt       =    "LIT"
                     move  0              to   rf-aaf-dec-vlt
           else      move  2              to   rf-aaf-dec-vlt         .
      *                  *---------------------------------------------*
      *                  * Costo lordo                                 *
      *                  *---------------------------------------------*
           move      rf-haf-prz-pes       to   w-det-scs-prz-n11      .
           divide    100                  into w-det-scs-prz-n11      .
           move      w-det-scs-prz-n11    to   rf-aaf-prz-pes (1)     .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [aaf]                             *
      *              *-------------------------------------------------*
