      ...
      *                                   Fase:    srchmr              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 14/01/99    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [hmr] : Serco            *
      *                                                                *
      *                    Update righe movimenti magazzino            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Aggiornamento movimenti - Ser.co.   "       .
      ...
      *        * [hmr]                                                 *
      *        *-------------------------------------------------------*
           copy      "sec/tns/fls/rec/rfhmr"                          .
      *        *-------------------------------------------------------*
      *        * [hmm]                                                 *
      *        *-------------------------------------------------------*
           copy      "sec/tns/fls/rec/rfhmm"                          .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione di Aggiornamento movimenti  "  .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhmr"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhmm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
      *              * Start su archivio [hmr]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "PRTPRG    "         to   f-key                  .
           move      zero                 to   rf-hmr-num-prt         .
           move      zero                 to   rf-hmr-num-prg         .
           move      "sec/tns/fls/ioc/obj/iofhmr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [hmr]              *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhmr"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMMOV    "         to   f-key                  .
           move      rf-hmr-num-prt       to   rf-hmm-num-mov         .
           move      "sec/tns/fls/ioc/obj/iofhmm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-hmm                 .
      *              *-------------------------------------------------*
      *              * Aggiornamento numero partita                    *
      *              *-------------------------------------------------*
           move      rf-hmm-num-ptt       to   rf-hmr-num-ptt         .
      *              *-------------------------------------------------*
      *              * Normalizzazione nuovi campi                     *
      *              *-------------------------------------------------*
           move      zero                 to   rf-hmr-prg-rc4         .
           move      zero                 to   rf-hmr-prg-rc5         .
           move      zero                 to   rf-hmr-prg-rc6         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [hmr]                             *
      *              *-------------------------------------------------*
