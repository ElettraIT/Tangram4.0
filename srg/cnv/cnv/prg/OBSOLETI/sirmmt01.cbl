      ...
      *                                   Fase:    sirmmt              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 06/07/06    *
      *                       Ultima revisione:    NdK del 06/07/06    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Test su protocolli magazzino / BFO : SIRI   *
      *                                                                *
      *                    MAI FINITO ___                              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Test su protocolli magazzino : SIRI  "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1000609              to   rf-mmt-dat-reg         .
           move      10001004472          to   rf-mmt-num-prt         .
           move      zero                 to   rf-mmt-num-prg         .
           move      "pgm/mag/fls/ioc/obj/iofmmt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              * Test                                            *
      *              *-------------------------------------------------*
           if        rf-mmt-dat-reg       =    1000609 and
                     rf-mmt-num-prt       =    10001004472
      ...
      *              * Aggiustamento costo                             *
      *              *-------------------------------------------------*
           divide    1000                 into rf-mmt-cun-mov         .
      *              *-------------------------------------------------*
      *              * Aggiustamento valore                            *
      *              *-------------------------------------------------*
           divide    1000                 into rf-mmt-val-mov         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [mmt]                             *
      *              *-------------------------------------------------*
