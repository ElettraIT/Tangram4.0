      ...
      *                                   Fase:    stddcp              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 29/04/09    *
      *                       Ultima revisione:    NdK del 29/04/09    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Allineamento di [dcp] con [aaq] per il      *
      *                    codice fornitore preferenziale e per il     *
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Recupero del record [aaq]                       *
      *              *-------------------------------------------------*
           move      srt-rec-aaq          to   rf-aaq                 .
       prn-sel-rec-999.
           exit.
      ...
      *              * Aggiornamento record [dcp]                      *
      *              *-------------------------------------------------*
           move      rf-aaq-dcf-pfz       to   rf-dcp-dcf-pfz         .
           move      rf-aaq-cod-pdt       to   rf-dcp-cod-pdt         .
       agg-rec-dcp-400.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
