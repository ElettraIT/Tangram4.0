      ...
      *                                   Fase:    ferlst              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 29/06/99    *
      *                       Ultima revisione:    NdK del 29/06/99    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [lst] : Ferramenta It.   *
      *                                                                *
      *                    Creazione listino negozio                   *
      *                                                                *
      *                    - Prezzo di partenza : costo netto   [haf]  *
      *                                                                *
      *                    - Prezzo risultante                         *
      *                                in lire  : listino "N  " [lst]  *
      *                                                                *
      *                      N.B.: Il prezzo risultante si ottiene     *
      *                            mediante un ricarico variabile in   *
      *                            funzione del fornitore, si aumenta  *
      *                            dell 'Iva, si arrotonda alle 100    *
      *                            lire superiori e si riscorpora      *
      *                            per essere memorizzato              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Creazione listino Negozio Ferramenta  "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Creazione Listino 'N' per Negozio       "  .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dcp-num-pro       to   rf-haf-num-pro         .
           move      rf-aaq-dcf-pfz       to   rf-haf-cod-dcf         .
           ...
           call      s-pat               using f
                                               rf-haf                 .
      *                  *---------------------------------------------*
      *                  * Se record [haf] non trovato : ad anomalie   *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-det-prz-lst-prz      .
           move      zero                 to   w-det-prz-lst-sco      .
      *                  *---------------------------------------------*
      *                  * Eccezioni                                   *
      *                  * ____                                        *
      *                  *---------------------------------------------*
           if        rf-aaq-dcf-pfz       =    0003108
                     move  1,20           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0003023 or
                     rf-aaq-dcf-pfz       =    0003231
                     move  1,30           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0003510
                     move  1,32           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0000035 or
                     rf-aaq-dcf-pfz       =    0003089 or
                     rf-aaq-dcf-pfz       =    0003146 or
                     rf-aaq-dcf-pfz       =    0003365 or
                     rf-aaq-dcf-pfz       =    0003408 or
                     rf-aaq-dcf-pfz       =    0003414 or
                     rf-aaq-dcf-pfz       =    0003436 or
                     rf-aaq-dcf-pfz       =    0003451 or
                     rf-aaq-dcf-pfz       =    0003552
                     move  1,35           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0003565
                     move  1,38           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0003145 or
                     rf-aaq-dcf-pfz       =    0003226 or
                     rf-aaq-dcf-pfz       =    0003490 or
                     rf-aaq-dcf-pfz       =    0003626
                     move  1,40           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0003295 or
                     rf-aaq-dcf-pfz       =    0003341
                     move  1,45           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0000009 or
                     rf-aaq-dcf-pfz       =    0000011 or
                     rf-aaq-dcf-pfz       =    0003002 or
                     rf-aaq-dcf-pfz       =    0003003 or
                     rf-aaq-dcf-pfz       =    0003026 or
                     rf-aaq-dcf-pfz       =    0003101 or
                     rf-aaq-dcf-pfz       =    0003118 or
                     rf-aaq-dcf-pfz       =    0003162 or
                     rf-aaq-dcf-pfz       =    0003188 or
                     rf-aaq-dcf-pfz       =    0003267 or
                     rf-aaq-dcf-pfz       =    0003277 or
                     rf-aaq-dcf-pfz       =    0003627
                     move  1,50           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0003053 or
                     rf-aaq-dcf-pfz       =    0003117 or
                     rf-aaq-dcf-pfz       =    0003175 or
                     rf-aaq-dcf-pfz       =    0003203 or
                     rf-aaq-dcf-pfz       =    0003391
                     move  1,55           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0003001 or
                     rf-aaq-dcf-pfz       =    0003070 or
                     rf-aaq-dcf-pfz       =    0003187 or
                     rf-aaq-dcf-pfz       =    0003197 or
                     rf-aaq-dcf-pfz       =    0003253 or
                     rf-aaq-dcf-pfz       =    0003262 or
                     rf-aaq-dcf-pfz       =    0003282 or
                     rf-aaq-dcf-pfz       =    0003288 or
                     rf-aaq-dcf-pfz       =    0003387 or
                     rf-aaq-dcf-pfz       =    0003266 or
                     rf-aaq-dcf-pfz       =    0003467 or
                     rf-aaq-dcf-pfz       =    0003526 or
                     rf-aaq-dcf-pfz       =    0003533 or
                     rf-aaq-dcf-pfz       =    0003557 or
                     rf-aaq-dcf-pfz       =    0003601
                     move  1,60           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0003200 or
                     rf-aaq-dcf-pfz       =    0003281 or
                     rf-aaq-dcf-pfz       =    0003300 or
                     rf-aaq-dcf-pfz       =    0003904
                     move  1,70           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0000014 or
                     rf-aaq-dcf-pfz       =    0001004 or
                     rf-aaq-dcf-pfz       =    0001032 or
                     rf-aaq-dcf-pfz       =    0003016 or
                     rf-aaq-dcf-pfz       =    0003130 or
                     rf-aaq-dcf-pfz       =    0003034 or
                     rf-aaq-dcf-pfz       =    0003056 or
                     rf-aaq-dcf-pfz       =    0003212 or
                     rf-aaq-dcf-pfz       =    0003227 or
                     rf-aaq-dcf-pfz       =    0003422 or
                     rf-aaq-dcf-pfz       =    0003508 or
                     rf-aaq-dcf-pfz       =    0003544 or
                     rf-aaq-dcf-pfz       =    0003604 or
                     rf-aaq-dcf-pfz       =    0003607
                     move  1,80           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0003021 or
                     rf-aaq-dcf-pfz       =    0003575
                     move  1,90           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0003149 or
                     rf-aaq-dcf-pfz       =    0003206 or
                     rf-aaq-dcf-pfz       =    0003271 or
                     rf-aaq-dcf-pfz       =    0003312 or
                     rf-aaq-dcf-pfz       =    0003379 or
                     rf-aaq-dcf-pfz       =    0003616
                     move  2,20           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0001010 or
                     rf-aaq-dcf-pfz       =    0001014 or
                     rf-aaq-dcf-pfz       =    0003004 or
                     rf-aaq-dcf-pfz       =    0003008 or
                     rf-aaq-dcf-pfz       =    0003019 or
                     rf-aaq-dcf-pfz       =    0003029 or
                     rf-aaq-dcf-pfz       =    0003078 or
                     rf-aaq-dcf-pfz       =    0003137 or
                     rf-aaq-dcf-pfz       =    0003141 or
                     rf-aaq-dcf-pfz       =    0003179 or
                     rf-aaq-dcf-pfz       =    0003219 or
                     rf-aaq-dcf-pfz       =    0003251 or
                     rf-aaq-dcf-pfz       =    0003309 or
                     rf-aaq-dcf-pfz       =    0003350 or
                     rf-aaq-dcf-pfz       =    0003370 or
                     rf-aaq-dcf-pfz       =    0003371 or
                     rf-aaq-dcf-pfz       =    0003390 or
                     rf-aaq-dcf-pfz       =    0003393 or
                     rf-aaq-dcf-pfz       =    0003434 or
                     rf-aaq-dcf-pfz       =    0003474 or
                     rf-aaq-dcf-pfz       =    0003534 or
                     rf-aaq-dcf-pfz       =    0003605 or
                     rf-aaq-dcf-pfz       =    0003622
                     move  3,00           to   rf-haf-prc-ctt
           else if   rf-aaq-dcf-pfz       =    0003055
                     move  4,00           to   rf-haf-prc-ctt
           else      move  2,00           to   rf-haf-prc-ctt         .
       prn-liv-det-310.
      *                  *---------------------------------------------*
      ...
      *
           if        d-rcl-haf-cst-tot    =    zero
                     go to prn-liv-det-600.
           if        rf-haf-prc-ctt       =    zero
                     move  d-rcl-haf-cst-tot
                                          to   w-det-prz-lst-prz
                     go to prn-liv-det-500.
           multiply  rf-haf-prc-ctt       by   d-rcl-haf-cst-tot
                                        giving w-det-prz-lst-prz
                                       rounded                        .
       prn-liv-det-320.
      *                  *---------------------------------------------*
      *                  * Prezzo + IVA                                *
      *                  *---------------------------------------------*
           ...
           move      w-det-prz-lst-prz    to   w-det-prz-iva-s13      .
           ...
           add       w-det-prz-iva-imp    to   w-det-prz-lst-prz      .
       prn-liv-det-400.
      *                  *---------------------------------------------*
      ...
      *                  *        fissi per il prezzo di vendita       *
      *                  * ******************************************  *
      *                  *                                             *
      *                  *---------------------------------------------*
           if        w-det-prz-lst-prz    >    5000000
                     go to prn-liv-det-422
           else if   w-det-prz-lst-prz    >    1000000
                     go to prn-liv-det-424
           else if   w-det-prz-lst-prz    >    10000
                     go to prn-liv-det-426
           else      go to prn-liv-det-428.
       prn-liv-det-422.
      *                  *---------------------------------------------*
      *                  * Oltre 50.000                                *
      *                  *---------------------------------------------*
      ...
      *                      * Analisi del prezzo                      *
      *                      *-----------------------------------------*
           move      w-det-prz-lst-prz
                    (6 : 4)               to   w-rcl-val-wrk-c04      .
           if        w-rcl-val-wrk-c04    =    zero
                     go to prn-liv-det-450.
           subtract  w-rcl-val-wrk-c04    from w-det-prz-lst-prz      .
           add       10000                to   w-det-prz-lst-prz      .
      *                      *-----------------------------------------*
      *                      * Ad uscita                               *
      *                      *-----------------------------------------*
           go to     prn-liv-det-450.
      ...
      *                      *-----------------------------------------*
           move      w-det-prz-lst-prz
                    (7 : 3)               to   w-rcl-val-wrk-c03      .
           if        w-rcl-val-wrk-c03    =    zero
                     go to prn-liv-det-450.
           subtract  w-rcl-val-wrk-c03    from w-det-prz-lst-prz      .
           add       10000                to   w-det-prz-lst-prz      .
      *                      *-----------------------------------------*
      *                      * Ad uscita                               *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           if        w-rcl-val-wrk-c03    =    zero
                     go to prn-liv-det-450.
           if        w-rcl-val-wrk-c03    <    500
                     subtract  w-rcl-val-wrk-c03
                                          from w-det-prz-lst-prz
                     add       5000       to   w-det-prz-lst-prz
                     go to  prn-liv-det-450.
           if        w-rcl-val-wrk-c03    >    500
                     subtract  w-rcl-val-wrk-c03
                                          from w-det-prz-lst-prz
      ...
      *                      *-----------------------------------------*
           move      w-det-prz-lst-prz
                    (8 : 2)               to   w-rcl-val-wrk-c02      .
           if        w-rcl-val-wrk-c02    =    zero
                     go to prn-liv-det-450.
           if        w-rcl-val-wrk-c02    <    50
                     subtract  w-rcl-val-wrk-c02
                                          from w-det-prz-lst-prz
                     go to prn-liv-det-450.
           if        w-rcl-val-wrk-c02    >    50
                     subtract  w-rcl-val-wrk-c02
                                          from w-det-prz-lst-prz
                     add       100        to   w-det-prz-lst-prz
                     go to prn-liv-det-450.
      *                      *-----------------------------------------*
      *                      * Ad uscita                               *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-dcp-cod-iva       to   w-det-prz-iva-cod      .
      *
           move      1                    to   w-det-prz-iva-003      .
      *
           move      zero                 to   w-det-prz-iva-001      .
           move      zero                 to   w-det-prz-iva-002      .
           move      w-det-prz-lst-prz    to   w-det-prz-iva-s13      .
           multiply  100                  by   w-det-prz-iva-s13      .
           divide    w-det-prz-iva-cod    into w-det-prz-iva-s13
                                        giving w-det-prz-lst-prz      .
      *                  *---------------------------------------------*
      ...
      *                  * Write record [haf]                          *
      *                  *---------------------------------------------*
           perform   wrt-rec-haf-000      thru wrt-rec-haf-999        .
      *                  *---------------------------------------------*
      ...
      *                  * Lettura valuta                              *
      *                  *---------------------------------------------*
           move      rf-haf-sgl-vlt       to   w-let-arc-zvl-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-det-prz-lst-prz    to   rf-lst-prz-lst         .
      ...
      *                  * Campi chiave                                *
      *                  *---------------------------------------------*
           move      rf-lst-cod-lst       to   rf-haf-fda-pif         .
       cmp-rec-haf-400.
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-det-prz-lst-prz    to   rf-haf-prz-imp         .
           move      "S"                  to   rf-haf-snx-imp         .
       cmp-rec-haf-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [haf]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-haf-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-haf-000      thru cmp-rec-haf-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
