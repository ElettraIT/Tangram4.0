      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Export quantita' rilevate                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "PREPARAZIONE ARCHIVIO QUANTITA' RILEVATE"       .
      ...
      *    *-----------------------------------------------------------*
       01  w-dkr.
      *        *-------------------------------------------------------*
      *        * Record 'mim' : Testate ordini clienti                 *
      *        *-------------------------------------------------------*
           05  w-dkr-mim.
      *            *---------------------------------------------------*
      *            * Protocollo ordine                                 *
      *            *---------------------------------------------------*
               10  w-dkr-mim-num-prt      pic  9(11)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       exe-exp-mim-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [mim] per data registrazione  *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to exe-exp-mim-800.
       exe-exp-mim-200.
      *              *-------------------------------------------------*
      *              * Read-next su archivio [mim]                     *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/mag/fls/ioc/obj/iofmim"
                                          to   s-pat                  .
      ...
      *                  * Record [mim]                                *
      *                  *---------------------------------------------*
           move      "mim "               to   w-out-gen-tip-rec      .
           move      rf-mim               to   w-out-gen-int-rec      .
      *                  *---------------------------------------------*
      *                  * CR + LF                                     *
      *                  *---------------------------------------------*
