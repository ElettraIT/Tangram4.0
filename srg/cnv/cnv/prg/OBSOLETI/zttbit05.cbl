      ...
      *              *-------------------------------------------------*
           ...
           move      1080101              to   rf-bit-dat-doc         .
      ...
      *              *-------------------------------------------------*
           if        rf-bit-cod-tmb       not  = "NFAFO"
                     go to prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Test su tipo movimento per la fatturazione      *
      *              *-------------------------------------------------*
           if        rf-bit-tmo-ftr       not  = "NFA  "
                     go to prn-liv-det-900.
       prn-liv-det-100.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Aggiornamento tipo movimento per fatturazione   *
      *              *-------------------------------------------------*
           move      "NFAFO"              to   rf-bit-tmo-ftr         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [bit]                             *
      *              *-------------------------------------------------*
