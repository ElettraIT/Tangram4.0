      ...
      *                                   Fase:    zttdcc              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 15/07/03    *
      *                       Ultima revisione:    NdK del 15/07/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [dcc] : zatti            *
      *                                                                *
      *                    Update per categoria da cat. sconti         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Aggiornamento codice listino - Zatti  "       .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Trattamento categorie clienti                   *
      *              *-------------------------------------------------*
           perform   trt-cat-cli-000      thru trt-cat-cli-999        .
       prn-ini-cic-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Aggiornamento codice categoria                  *
      *              *-------------------------------------------------*
           move      rf-dcc-cat-scr       to   rf-dcc-cod-cat         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [dcc]                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-zcs-cod-csc       to   rf-zst-cod-cls         .
           move      "pgm/dcc/fls/ioc/obj/iofzst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-zst                 .
           if        f-sts                not  = e-not-err
                     go to trt-cat-cli-620
           else      go to trt-cat-cli-640.
       trt-cat-cli-620.
      *              *-------------------------------------------------*
      *              * Se categoria [zst] non trovata                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * A nuovo record                              *
      *                  *---------------------------------------------*
           go to     trt-cat-cli-660.
       trt-cat-cli-640.
      *              *-------------------------------------------------*
      *              * Se categoria [zst] trovata                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Cancellazione [zst] precedente              *
      *                  *---------------------------------------------*
           move      "DE"                 to   f-ope                  .
           move      "pgm/dcc/fls/ioc/obj/iofzst"
                                          to   s-pat                  .
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      rf-zcs-mne-csc       to   rf-zst-mne-cls         .
           move      rf-zcs-des-key       to   rf-zst-des-key         .
           move      rf-zcs-des-csc       to   rf-zst-des-cls         .
           move      rf-zcs-alx-exp       to   rf-zst-alx-exp         .
      *                  *---------------------------------------------*
      *                  * Put record                                  *
      *                  *---------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     trt-cat-cli-200.
       trt-cat-cli-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     trt-cat-cli-999.
       trt-cat-cli-999.
           exit.
