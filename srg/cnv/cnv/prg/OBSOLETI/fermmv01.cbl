      ...
      *                                   Fase:    fermmv              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 12/12/08    *
      *                       Ultima revisione:    NdK del 12/12/08    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento costo ultimo [mmv] da [haf]   *
      *                                                                *
      *                    FERRAMENTA ITALIANA                         *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento ultimo costo di magazzino "       .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su data entrata in vigore acquisto     *
      *                  *---------------------------------------------*
           if        rf-haf-dev-acq       =    zero
                     go to stp-srt-inp-200.
           if        rf-haf-dev-acq       <    1080101
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Lettura dati valuta                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Test se presente costo unitario             *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-haf-dec-prz       to   d-rcl-haf-dec-ven      .
