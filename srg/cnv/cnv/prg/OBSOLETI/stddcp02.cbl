      ...
      *                                   Fase:    stddcp              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 25/02/11    *
      *                       Ultima revisione:    NdK del 25/02/11    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Allineamento di [dcp] con [aaf] per il      *
      *                    codice del prodotto per il fornitore        *
      *                    preferenziale                               *
      *                                                                *
      *                    Esecuzione presso          data             *
      *                    -----------------        --------           *
      *                    ZATTI                    25/02/11           *
      *                    SIRI                     02/03/11           *
      *                    ELETTRA                  07/03/11           *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento record prodotti standard "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Aggiornamento standard record prodotti  "  .
      ...
      *                  *---------------------------------------------*
           if        rf-dcp-dcf-pfz       not  numeric
                     go to stp-srt-inp-aaf-200.
           if        rf-dcp-dcf-pfz       =    zero
                     go to stp-srt-inp-aaf-200.
       stp-srt-inp-aaf-500.
      *              *-------------------------------------------------*
      *              * Lettura record [aaf]                            *
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dcp-dcf-pfz       to   rf-aaf-cod-dcf         .
           ...
           call      s-pat               using f
                                               rf-aaf                 .
      *                  *---------------------------------------------*
      *                  * Test su codice prodotto per il fornitore    *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Recupero del record [aaf]                       *
      *              *-------------------------------------------------*
           move      srt-rec-aaf          to   rf-aaf                 .
       prn-sel-rec-999.
           exit.
      ...
      *              * Aggiornamento record [dcp]                      *
      *              *-------------------------------------------------*
           move      rf-aaf-cop-sfn       to   rf-dcp-cop-sfn         .
       agg-rec-dcp-400.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
