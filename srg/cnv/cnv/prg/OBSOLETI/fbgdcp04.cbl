      ...
      *                                   Fase:    fbgdcp              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 18/02/03    *
      *                       Ultima revisione:    NdK del 18/02/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ricerca prodotti cancellati : Foralberg     *
      *                                                                *
      *                    Magazzino (codici 725xxxx)                  *
      *                                                                *
      *================================================================*
      ...
      *            * Codice prodotto                                   *
      *            *---------------------------------------------------*
               10  srt-arc-alf            pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Numero prodotto                                   *
      *            *---------------------------------------------------*
               10  srt-arc-num            pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      ...
      *            *---------------------------------------------------*
               10  srt-arc-des            pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Codice prodotto                                   *
      *            *---------------------------------------------------*
               10  srt-dcp-alf            pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Numero prodotto                                   *
      *            *---------------------------------------------------*
               10  srt-dcp-num            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Descrizione prodotto                              *
      *            *---------------------------------------------------*
               10  srt-dcp-des            pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Archivio                                          *
      *            *---------------------------------------------------*
               10  srt-arc-mag            pic  x(03)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Stampa di controllo prodotti cancellati "       .
      ...
      *        *-------------------------------------------------------*
           05  w-rot-l01.
               10  w-rot-l01-arc-alf      pic  x(14)                  .
               10  w-rot-l01-arc-mag      pic  x(03)                  .
      ...
      *                      *-----------------------------------------*
           ...
           call      s-pat               using f
                                               rf-dcp                 .
      *                      *-----------------------------------------*
      *                      * Se record [dcp] non trovato : oltre     *
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-mmr-600.
      *                      *-----------------------------------------*
      *                      * Confronto tra codici alfanumerici       *
      *                      *-----------------------------------------*
           if        rf-mmr-alf-mag       =    rf-dcp-alf-pro
                     go to stp-srt-inp-mmr-200.
       stp-srt-inp-mmr-600.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-mmr-alf-mag       to   srt-arc-alf            .
           move      rf-mmr-num-mag       to   srt-arc-num            .
      *                  *---------------------------------------------*
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
           move      spaces               to   srt-arc-des            .
           move      rf-dcp-alf-pro       to   srt-dcp-alf            .
           move      rf-dcp-num-pro       to   srt-dcp-num            .
           move      rf-dcp-des-pro       to   srt-dcp-des            .
           move      "mag"                to   srt-arc-mag            .
       stp-srt-inp-mmr-700.
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      srt-arc-alf          to   w-rot-l01-arc-alf      .
           move      srt-arc-mag          to   w-rot-l01-arc-mag      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      031                  to   p-pos                  .
           if        srt-dcp-des          =    spaces
                     move  "[CANCELLATO]" to   p-alf
           else      move  srt-dcp-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "PRODOTTI CANCELLATI O CON CODICE VARIATO"
