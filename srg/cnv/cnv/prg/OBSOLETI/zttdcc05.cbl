      ...
      *                       Ultima revisione:    NdK del 16/08/07    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Update per tipo bolla preferenziale         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento bolla preferenz. - Zatti "       .
      ...
      *              *-------------------------------------------------*
           if        rf-dcc-cat-scr       not  = 00001 and
                     rf-dcc-cat-scr       not  = 00002 and
                     rf-dcc-cat-scr       not  = 00006
                     go to prn-liv-det-300.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Grossisti e Garden Center                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Aggiornamento tipo documento per consegna   *
      *                  *---------------------------------------------*
           move      11                   to   rf-dcc-tdp-plc         .
      *                  *---------------------------------------------*
      *                  * Aggiornamento codice listino                *
      *                  *---------------------------------------------*
           move      "AGE"                to   rf-dcc-cod-lst         .
      *                  *---------------------------------------------*
      *                  * Aggiornamento categoria provvigioni         *
      *                  *---------------------------------------------*
           move      rf-dcc-cat-scr       to   rf-dcc-cat-pvg         .
      *                  *---------------------------------------------*
      *                  * A update                                    *
      *                  *---------------------------------------------*
