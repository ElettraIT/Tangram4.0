      ...
      *                       Ultima revisione:    NdK del 18/10/01    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Conversione referenze da file 'REF.TXT'     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Generazione referenze da file 'REF.TXT' "       .
      ...
      *        *-------------------------------------------------------*
      *        * Numero di records scritti [ref]                       *
      *        *-------------------------------------------------------*
           05  w-pds-rsc                  pic  9(06)                  .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  filler                 pic  x(08)                  .
               10  w-lds-000-tip-rec      pic  x(11)                  .
               10  filler                 pic  x(01)                  .
               10  w-lds-000-prg-ref      pic  x(03)                  .
               10  filler                 pic  x(117)                 .
      *        *-------------------------------------------------------*
      *        * Linea 001                                             *
      *        *-------------------------------------------------------*
      ...
      *        * Tipo referenza                                        *
      *        *-------------------------------------------------------*
           05  w-sav-tip-ref              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Progressivo referenza                                 *
      *        *-------------------------------------------------------*
           05  w-sav-prg-ref              pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Comodi                                                *
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Numero records scritti [ref]   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       xcv-opn-fls-100.
      ...
      *                  *---------------------------------------------*
       ...
       xcv-trt-pds-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione Nome referenza                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Nome personalizzazione                      *
      *                  *---------------------------------------------*
           move      w-lds-001-nom-ref    to   w-sav-nom-ref          .
      *                  *---------------------------------------------*
      *                  * Lettura definizione                         *
      *                  *---------------------------------------------*
           move      "drf "               to   auc-tre                .
           move      w-sav-nom-ref        to   auc-kre                .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-drf-tip-drf        to   w-sav-tip-ref          .
      *                      *-----------------------------------------*
      *                      * Ad uscita                               *
      *                      *-----------------------------------------*
           go to     xcv-trt-pds-900.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Conversione progressivo                     *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      03                   to   v-car                  .
           move      w-lds-000-prg-ref    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-sav-prg-ref          .
      *                  *---------------------------------------------*
      *                  * Subroutine                                  *
      *                  *---------------------------------------------*
           perform   xcv-trt-pds-ref-000  thru xcv-trt-pds-ref-999    .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     xcv-trt-pds-900.
      ...
      *    * Ciclo di conversione : Trattamento pagina di stampa       *
      *    *                                                           *
      *    * Subroutine di trattamento : valore referenza              *
      *    *-----------------------------------------------------------*
       xcv-trt-pds-ref-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       xcv-trt-pds-ref-100.
      *              *-------------------------------------------------*
      *              * Composizione record 'ref'                       *
      *              *-------------------------------------------------*
           move      spaces               to   ref-rec                .
           move      "ref "               to   ref-tre                .
           move      w-sav-nom-ref        to   ref-cod                .
           move      w-sav-prg-ref        to   ref-prg                .
      *
           if        w-sav-tip-ref        =    "A"
                     move  w-lds-002-val-alf
                                          to   ref-alf
           else if   w-sav-tip-ref        =    "T"
                     move  w-lds-002-val-alf
                                          to   ref-txt
           else if   w-sav-tip-ref        =    "N"
                     move  w-sav-val-num  to   ref-num
           else if   w-sav-tip-ref        =    "D"
                     move  w-sav-val-dat  to   ref-dat                .
      *                  *---------------------------------------------*
      *                  * Scrittura record 'ref' di [ref]             *
      *                  *---------------------------------------------*
           write     ref-rec invalid key
                             go to   xcv-trt-pds-ref-900.
       xcv-trt-pds-ref-600.
      *              *-------------------------------------------------*
