      ...
      *                                   Fase:    siroct              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 11/10/01    *
      *                       Ultima revisione:    NdK del 09/02/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Cliente per la fatturazione - SIRI          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Cliente per la fatturazione : ordini  "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1171201              to   rf-oct-dat-doc         .
      ...
      *              *-------------------------------------------------*
           if        rf-oct-cod-arc       not  = 0005046 and
                     rf-oct-cod-arc       not  = 0002481
                     go to prn-liv-det-820.
           if        rf-oct-arc-plf       =    rf-oct-cod-arc
                     go to prn-liv-det-820.
           if        rf-oct-dpz-plf       =    rf-oct-dpz-arc
                     go to prn-liv-det-820.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Aggiornamento                                   *
      *              *-------------------------------------------------*
           move      rf-oct-cod-arc       to   rf-oct-arc-plf         .
           move      rf-oct-dpz-arc       to   rf-oct-dpz-plf         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [oct]                             *
      *              *-------------------------------------------------*
