      ...
      *                                   Fase:    zttcpv              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 06/07/10    *
      *                       Ultima revisione:    NdK del 21/06/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione Catalogo prodotti a f/ordine      *
      *                   (INT 58)                                     *
      *                                                                *
      *                    ZATTI                                       *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      "D"                  to   rf-ocr-tip-arc         .
           move      0000001              to   rf-ocr-cod-arc         .
           move      11301000056          to   rf-ocr-num-doc         .
      ...
      *
           if        rf-ocr-tip-arc       not  = "D"
                     move  "#"            to   w-cnt-prn-flg-sub      .
      *
           if        rf-ocr-cod-arc       not  = 0000001
                     move  "#"            to   w-cnt-prn-flg-sub      .
      *
           if        rf-ocr-num-doc       not  = 11301000056
                     move  "#"            to   w-cnt-prn-flg-sub      .
       prn-tst-max-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Creazione riga catalogo                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento progressivo righe                *
      *                  *---------------------------------------------*
           add       00100                to   w-wrk-ctr-prg          .
      *                  *---------------------------------------------*
      *                  * Write record [cpv]                          *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "PAS"                to   rf-cpv-cod-cpv         .
           move      rf-ocr-num-pro       to   rf-cpv-num-pro         .
           move      w-wrk-ctr-prg        to   rf-cpv-num-prg         .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
           move      "IG"                 to   s-ope                  .
