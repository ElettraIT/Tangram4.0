      ...
      *                       Ultima revisione:    NdK del 01/08/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Bar-code EAN13 - Elettra                    *
      *                                                                *
      *                    Da file 'elebarcode'                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Conversione x ean-code prodotti Elettra "       .
      ...
      *            *---------------------------------------------------*
               10  w-lds-001-num-pro      pic  x(07)                  .
      *            *---------------------------------------------------*
      *            * Codice alfanumerico prodotto                      *
      *            *---------------------------------------------------*
               10  w-lds-001-alf-pro      pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Codice EAN-13 prodotto                            *
      *            *---------------------------------------------------*
               10  w-lds-001-ean-pro      pic  x(13)                  .
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Conversione codice numerico prodotto    *
      *                      *-----------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      07                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMPRO    "         to   f-key                  .
           move      w-det-cod-dcf-cod    to   rf-dcp-num-pro         .
           move      "pgm/dcp/fls/ioc/obj/iofdcp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Test su EAN                             *
      *                      *-----------------------------------------*
           if        w-lds-001-ean-pro    =    spaces
                     go to agg-rec-dcp-230.
      *                      *-----------------------------------------*
      *                      * Confronto con codice alfanumerico       *
      *                      *-----------------------------------------*
           if        rf-dcp-alf-pro       not  = w-lds-001-alf-pro
                     go to agg-rec-dcp-230.
      *                      *-----------------------------------------*
      *                      * Aggiornamento EAN                       *
      *                      *-----------------------------------------*
           move      w-lds-001-ean-pro    to   rf-dcp-klb-pro         .
       agg-rec-dcp-220.
      *                  *---------------------------------------------*
