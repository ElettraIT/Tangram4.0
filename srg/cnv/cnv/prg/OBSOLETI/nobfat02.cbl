      ...
      *                                                                *
      *                    Sostituzione da NCC a NNC (Cl. 4225 e 587)  *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      1180228              to   rf-fir-dat-doc         .
      ...
      *              *-------------------------------------------------*
           if        rf-fir-dat-doc       not  = 1180228
                     go to prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Test su codice cliente                          *
      *              *-------------------------------------------------*
           if        rf-fir-cod-cli       not  = 0004225 and
                     rf-fir-cod-cli       not  = 0000587
                     go to prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Test su tipo documento                          *
      *              *-------------------------------------------------*
           if        rf-fir-cod-tmo       not  = "NCC  "
                     go to prn-liv-det-900.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        f-sts                not  = e-not-err
                     go to prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Modifica tipo documento [fit]                   *
      *              *-------------------------------------------------*
           move      "NNC  "              to   rf-fit-cod-tmo         .
      *              *-------------------------------------------------*
      *              * Force Put record                                *
      *              *-------------------------------------------------*
           move      "FP"                 to   f-ope                  .
       ...
       prn-liv-det-600.
      *              *-------------------------------------------------*
      *              * Modifica tipo documento [fir]                   *
      *              *-------------------------------------------------*
           move      "NNC  "              to   rf-fir-cod-tmo         .
      *              *-------------------------------------------------*
      *              * Update record [fir]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
