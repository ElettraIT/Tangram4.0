      ...
      *                       Ultima revisione:    NdK del 06/06/11    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Forzatura esclusione mesi al 15 settembre e *
      *                    al 15 gennaio per le scadenze di agosto e   *
      *                    dicembre                                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento esclusione mesi Clienti  "       .
      ...
      *              * Correttivo (RUMOR)                              *
      *              *-------------------------------------------------*
           if        rf-dcc-tip-esm       =    03 and
                     rf-dcc-ggg-alt       =    15 and
                     rf-dcc-mmm-e01       =    12 and
                     rf-dcc-mmm-e02       =    zero
                     go to prn-liv-det-150.
      *              *-------------------------------------------------*
      *              * Se gia' impostato : no update                   *
      *              *-------------------------------------------------*
           if        rf-dcc-tip-esm       not  = 01
                     go to prn-liv-det-300.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      ...
      *              *        del mese successivo                      *
      *              *-------------------------------------------------*
           move      03                   to   rf-dcc-tip-esm         .
      *              *-------------------------------------------------*
      *              * Giorno di scadenza fisso nel mese successivo,   *
      *              * se tipo esclusione mese pari a 03               *
      *              *-------------------------------------------------*
           move      15                   to   rf-dcc-ggg-alt         .
       prn-liv-det-150.
      *              *-------------------------------------------------*
      *              * Mese di esclusione per scadenze del cliente 1   *
      *              *-------------------------------------------------*
           move      08                   to   rf-dcc-mmm-e01         .
      *              *-------------------------------------------------*
      *              * Mese di esclusione per scadenze del cliente 2   *
      *              *-------------------------------------------------*
           move      12                   to   rf-dcc-mmm-e02         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [dcc]                             *
      *              *-------------------------------------------------*
