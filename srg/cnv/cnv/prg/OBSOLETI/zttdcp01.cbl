      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento categoria sconto e provvigioni    *
      *              *-------------------------------------------------*
           if        rf-dcp-per-scr (1)   =    33
                     move  00001          to   rf-dcp-cat-scr
                     move  00001          to   rf-dcp-cat-pvg
           else      move  00002          to   rf-dcp-cat-scr
                     move  00002          to   rf-dcp-cat-pvg         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
