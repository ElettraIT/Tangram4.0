      ...
      *                                   Fase:    lstcdc              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 06/05/02    *
      *                       Ultima revisione:    NdK del 06/05/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Caricamento listino da file 'listino.txt'   *
      *                                                                *
      *                    _________ MAI FINITO _____________          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CARICAMENTO LISTINO CDC DA FILE 'TXT' "       .
      ...
      *            *---------------------------------------------------*
               10  w-rdp-prz-lst          pic  x(07)                  .
      *            *---------------------------------------------------*
      *            * Quantita' per confezione                          *
      *            *---------------------------------------------------*
               10  w-rdp-qta-cfz          pic  x(06)                  .
      *            *---------------------------------------------------*
      *            * Quantita' minima ordine                           *
      *            *---------------------------------------------------*
               10  w-rdp-qta-min          pic  x(06)                  .
      *            *---------------------------------------------------*
      *            * Descrizione prodotto per il fornitore             *
      *            *---------------------------------------------------*
               10  w-rdp-des-pro          pic  x(44)                  .
      *            *---------------------------------------------------*
      *            * Campi liberi                                      *
      *            *---------------------------------------------------*
               10  w-rdp-lib.
                   15  w-rdp-lib-001      pic  x(40)                  .
                   15  w-rdp-lib-002      pic  x(40)                  .
                   15  w-rdp-lib-003      pic  x(40)                  .
                   15  w-rdp-lib-004      pic  x(40)                  .
                   15  w-rdp-lib-005      pic  x(40)                  .
                   15  w-rdp-lib-006      pic  x(40)                  .
                   15  w-rdp-lib-007      pic  x(40)                  .
                   15  w-rdp-lib-008      pic  x(40)                  .
                   15  w-rdp-lib-009      pic  x(40)                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-det-lst-str-ext    to   w-rdp-flg-prf          .
      *                      *-----------------------------------------*
      *                      * Estrazione codice                       *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-cod-pro          .
       prn-liv-det-022.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-prz-lst          .
      *                      *-----------------------------------------*
      *                      * Estrazione quantita' per confezione     *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-qta-cfz          .
      *                      *-----------------------------------------*
      *                      * Estrazione quantita' minima ordine      *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-qta-min          .
      *                      *-----------------------------------------*
      *                      * Estrazione descrizione                  *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-des-pro          .
      *                      *-----------------------------------------*
      *                      * Estrazione campo libero 1               *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-lib-001          .
      *                      *-----------------------------------------*
      *                      * Estrazione campo libero 2               *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-lib-002          .
      *                      *-----------------------------------------*
      *                      * Estrazione campo libero 3               *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-lib-003          .
      *                      *-----------------------------------------*
      *                      * Estrazione campo libero 4               *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-lib-004          .
      *                      *-----------------------------------------*
      *                      * Estrazione campo libero 5               *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-lib-005          .
      *                      *-----------------------------------------*
      *                      * Estrazione campo libero 6               *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-lib-006          .
      *                      *-----------------------------------------*
      *                      * Estrazione campo libero 7               *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-lib-007          .
      *                      *-----------------------------------------*
      *                      * Estrazione campo libero 8               *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-lib-008          .
      *                      *-----------------------------------------*
      *                      * Estrazione campo libero 9               *
      *                      *-----------------------------------------*
           perform   prn-liv-det-ext-000  thru prn-liv-det-ext-999    .
           move      w-det-lst-str-ext    to   w-rdp-lib-009          .
       prn-liv-det-050.
      *                  *---------------------------------------------*
      *                  * Codice prodotto per il fornitore            *
      *                  *---------------------------------------------*
      ...
      *              * In campo di comodo                              *
      *              *-------------------------------------------------*
           move      w-rdp-cod-pro        to   w-gen-cop-sfn          .
      *              *-------------------------------------------------*
      *              * Allineamento a sx.                              *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-rdp-des-pro        to   rf-hlf-des-alf         .
      *
           move      w-rdp-des-pro        to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   rf-hlf-des-key         .
      *
      ...
      *
           ...
           move      w-rdp-qta-cfz        to   rf-hlf-qta-cfz         .
           move      w-rdp-qta-min        to   rf-hlf-min-acq         .
      *
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      ...
      *
           move      w-rdp-lib            to   rf-hlf-lib-lst         .
      ...
      *    * 80 caratteri ciascuna con o sacc-enza uno spazio di separa-   *
