      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun listino entro i limiti assegnati !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [lst]              *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "pgm/dcp/fls/ioc/obj/ioflst"
                                          to   s-pat                  .
      ...
      *                  * Test su sconto                              *
      *                  *---------------------------------------------*
           if        rf-dcp-per-scr (1)   =    zero
                     go to prn-liv-det-300.
           if        rf-dcp-per-scr (1)   not  = 33
                     go to prn-liv-det-300.
       prn-liv-det-150.
      *              *-------------------------------------------------*
      *              * Aggiornamento sconto                            *
      *              *-------------------------------------------------*
           move      30                   to   rf-lst-per-sco (1)     .
           move      "S"                  to   rf-lst-snx-sco         .
           move      08                   to   rf-lst-per-pvg (1)     .
