      ...
      *                                   Fase:    nobmms              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 03/02/07    *
      *                       Ultima revisione:    NdK del 25/10/17    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [mms] : Nobili           *
      *                                                                *
      *                    Update saldi magazzino per azzeramento      *
      *                    saldi quantita' cartoni                     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Aggiornamento magazzino - NOBILI    "       .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Test su codice materia prima - NOBILI           *
      *              *-------------------------------------------------*
           if        rf-mms-num-mag       not  = 0000051 and
                     rf-mms-num-mag       not  = 0000052 and
                     rf-mms-num-mag       not  = 0000053 and
                     rf-mms-num-mag       not  = 0000054 and
                     rf-mms-num-mag       not  = 0000055 and
                     rf-mms-num-mag       not  = 0000056 and
                     rf-mms-num-mag       not  = 0000057 and
                     rf-mms-num-mag       not  = 0000058 and
                     rf-mms-num-mag       not  = 0000059 and
                     rf-mms-num-mag       not  = 0000060 and
                     rf-mms-num-mag       not  = 0000061 and
                     rf-mms-num-mag       not  = 0000062 and
                     rf-mms-num-mag       not  = 0000063 and
                     rf-mms-num-mag       not  = 0000064 and
                     rf-mms-num-mag       not  = 0000065 and
                     rf-mms-num-mag       not  = 0000066 and
                     rf-mms-num-mag       not  = 0000067 and
                     rf-mms-num-mag       not  = 0000068 and
                     rf-mms-num-mag       not  = 0000069 and
                     rf-mms-num-mag       not  = 0000237
                     go to prn-liv-det-880.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Azzeramento quantita' iniziale                  *
      *              *-------------------------------------------------*
           move      zero                 to   rf-mms-qta-ini         .
      *              *-------------------------------------------------*
      *              * Azzeramento quantita' mensili                   *
      *              *-------------------------------------------------*
