      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Conversione archivio [cli]                  *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
           select  optional  old   assign to disk           o-pat
                   ...
                   alternate record key   is old-k05
                   alternate record key   is old-k06
      ...
      *            *---------------------------------------------------*
               10  old-k04.
                   ...
                   15  old-cod-cli-4      pic  9(07)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 05 : PRTIVA                         *
      *            *---------------------------------------------------*
               10  old-k05.
                   15  old-prt-iva        pic  9(11)       comp-3     .
                   15  old-cod-cli-5      pic  9(07)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 06 : CODFIS                         *
      *            *---------------------------------------------------*
               10  old-k06.
                   15  old-cod-fis        pic  x(16)                  .
                   15  old-cod-cli-6      pic  9(07)       comp-3     .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  old-dat.
               ...
               10  old-via-cli            pic  x(40)                  .
               10  old-loc-cli            pic  x(40)                  .
               10  old-cod-naz            pic  x(03)                  .
               10  old-cod-cmn            pic  9(05)       comp-3     .
               10  old-cod-fzn            pic  9(03)       comp-3     .
               10  old-cod-lct            pic  9(03)       comp-3     .
               10  old-num-tel            pic  x(20)                  .
               10  old-num-fax            pic  x(20)                  .
               10  old-num-tlx            pic  x(20)                  .
               10  old-nom-int            pic  x(30)                  .
               10  old-cod-iva            pic  9(05)       comp-3     .
      ...
      *        *-------------------------------------------------------*
           05  new-dat.
               ...
               10  new-cod-cmn            pic  9(05)       comp-3     .
               10  new-cod-fzn            pic  9(03)       comp-3     .
               10  new-cod-lct            pic  9(03)       comp-3     .
      ...
      *    *-----------------------------------------------------------*
       01  w-wrk.
           ...
           05  w-wrk-cod-prv              pic  x(02)                  .
           05  w-wrk-loc-cli.
               10  w-wrk-loc-cap          pic  x(05)                  .
               10  w-wrk-loc-fil          pic  x(01)                  .
               10  w-wrk-loc-loc          pic  x(34)                  .
               10  w-wrk-loc-inx          pic  9(02)                  .
               10  w-wrk-loc-pnt          pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
       ...
       exe-cnv-fil-400.
      *              *-------------------------------------------------*
      *              * Composizione nuovo mnemonico per chiave indice  *
      *              * 4                                               *
      *              *-------------------------------------------------*
           move      old-cod-mne          to   w-wrk-cod-mne          .
           if        w-wrk-mne-003        =    "AMC" or
                     w-wrk-mne-003        =    "AMP" or
                     w-wrk-mne-003        =    "AMR" or
                     w-wrk-mne-003        =    "DDS" or
                     w-wrk-mne-003        =    "DIS" or
                     w-wrk-mne-003        =    "ART" or
                     w-wrk-mne-003        =    "MAG" or
                     w-wrk-mne-003        =    "AGR" or
                     w-wrk-mne-003        =    "ALB" or
                     w-wrk-mne-003        =    "COM" or
                     w-wrk-mne-003        =    "FEM" or
                     w-wrk-mne-003        =    "INA" or
                     w-wrk-mne-003        =    "IND" or
                     w-wrk-mne-003        =    "NAU" or
                     w-wrk-mne-003        =    "PER" or
                     w-wrk-mne-003        =    "GEO" or
                     w-wrk-mne-003        =    "TUR" or
                     w-wrk-mne-003        =    "SER" or
                     w-wrk-mne-003        =    "LAS" or
                     w-wrk-mne-003        =    "LCS" or
                     w-wrk-mne-003        =    "LGS" or
                     w-wrk-mne-003        =    "LSS" or
                     w-wrk-mne-003        =    "PRO" or
                     w-wrk-mne-003        =    "SMS" or
                     w-wrk-mne-003        =    "SIS" or
                     w-wrk-mne-003        =    "CGL" or
                     w-wrk-mne-003        =    "SNA" or
                     w-wrk-mne-003        =    "UIL" or
                     w-wrk-mne-003        =    "SIN"
                     go to exe-cnv-fil-420
           else      move  old-cod-mne    to   new-cod-mne
                     go to exe-cnv-fil-500.
       exe-cnv-fil-420.
      *                  *---------------------------------------------*
      *                  * Composizione                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Individuazione della localita'          *
      *                      *-----------------------------------------*
           move      old-loc-cli          to   w-wrk-loc-cli          .
           if        w-wrk-loc-loc        =    spaces
                     move  old-cod-mne    to   new-cod-mne
                     go to exe-cnv-fil-500.
      *                      *-----------------------------------------*
      *                      * Individuazione della provincia          *
      *                      *-----------------------------------------*
           move      spaces               to   w-wrk-cod-prv          .
           move      zero                 to   w-wrk-loc-inx          .
           inspect   w-wrk-loc-loc    tallying w-wrk-loc-inx
                                          for  trailing spaces        .
           move      34                   to   w-wrk-loc-pnt          .
           subtract  w-wrk-loc-inx        from w-wrk-loc-pnt          .
           subtract  1                    from w-wrk-loc-pnt          .
           unstring  w-wrk-loc-loc        into w-wrk-cod-prv
                                  with pointer w-wrk-loc-pnt          .
      *                      *-----------------------------------------*
      *                      * Pulizia del nome del comune da even-    *
      *                      * tuali caratteri strani                  *
      *                      *-----------------------------------------*
           move      w-wrk-loc-loc        to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   w-det-rag-key-str      .
           perform   det-rag-key-000      thru det-rag-key-999        .
           move      w-det-rag-key-nst    to   w-wrk-des-cfl          .
      *                      *-----------------------------------------*
      *                      * Nuova stringa                           *
      *                      *-----------------------------------------*
           move      spaces               to   w-wrk-new-mne          .
           string    w-wrk-mne-003
                                delimited by   spaces
                     w-wrk-cod-prv
                                delimited by   spaces
                     w-wrk-des-cfl
      ...
      *                      * Nuovo mnemonico                         *
      *                      *-----------------------------------------*
           move      w-wrk-new-mne        to   new-cod-mne            .
       exe-cnv-fil-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      old-rag-key          to   new-rag-key            .
      ...
      *              *-------------------------------------------------*
           move      old-prt-iva          to   new-prt-iva            .
           move      old-cod-cli          to   new-cod-cli-5          .
      *              *-------------------------------------------------*
      *              * Composizione chiave indice 6                    *
      *              *-------------------------------------------------*
           move      old-cod-fis          to   new-cod-fis            .
           move      old-cod-cli          to   new-cod-cli-6          .
      *              *-------------------------------------------------*
      *              * Composizione dati                               *
      *              *-------------------------------------------------*
           move      old-ide-ute          to   new-ide-ute            .
           move      old-ide-fas          to   new-ide-fas            .
           move      old-rag-soc          to   new-rag-soc            .
           move      old-via-cli          to   new-via-cli            .
           move      old-loc-cli          to   new-loc-cli            .
           move      old-cod-naz          to   new-cod-naz            .
           move      old-cod-cmn          to   new-cod-cmn            .
           move      old-cod-fzn          to   new-cod-fzn            .
           move      old-cod-lct          to   new-cod-lct            .
           move      old-num-tel          to   new-num-tel            .
           move      old-num-fax          to   new-num-fax            .
           move      old-num-tlx          to   new-num-tlx            .
           move      old-nom-int          to   new-nom-int            .
           move      old-cod-iva          to   new-cod-iva            .
           move      old-snx-a13          to   new-snx-a13            .
           move      old-cod-cge          to   new-cod-cge            .
