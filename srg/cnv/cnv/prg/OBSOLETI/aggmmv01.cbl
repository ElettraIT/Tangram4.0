      ...
      *                                   Fase:    aggmmv              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 12/02/01    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Update per sistemazione CMP - LIFO 2001     *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-mmv-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [mmv] per anno 2000           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "ESECOD    "         to   f-key                  .
           move      100                  to   rf-mmv-ann-ese         .
      ...
      *    *-----------------------------------------------------------*
       agg-rec-mmv-000.
      *              *-------------------------------------------------*
      *              * Lettura record [mmv] anno 2000 per calcolo CMP  *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "ESECOD    "         to   f-key                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-mmv                 .
      *              *-------------------------------------------------*
      *              * Lettura record [mmv] per anno 2001              *
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "ESECOD    "         to   f-key                  .
           move      srt-ann-ese          to   rf-mmv-ann-ese         .
           add       001                  to   rf-mmv-ann-ese         .
           move      srt-tip-mag          to   rf-mmv-tip-mag         .
           move      srt-num-mag          to   rf-mmv-num-mag         .
           move      "pgm/mag/fls/ioc/obj/iofmmv"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Valore LIFO anno precedente                 *
      *                  *---------------------------------------------*
           if        rf-mmv-ump-pre (1)   =    w-det-cmp-fin-cmp
                     go to agg-rec-mmv-500.
      *                  *---------------------------------------------*
      *                  * Valore LIFO anno 2000 in scheda 2001        *
      *                  *---------------------------------------------*
           move      w-det-cmp-fin-cmp    to   rf-mmv-ump-pre (1)     .
       agg-rec-mmv-400.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
