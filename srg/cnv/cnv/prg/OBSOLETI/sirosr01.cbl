      ...
      *                                   Fase:    sirosr              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 10/06/10    *
      *                       Ultima revisione:    NdK del 29/04/16    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione progressivi EPS : SIRI            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     Creazione EPS Progressivi riga     "       .
      ...
      *              * SIRI                                            *
      *              *-------------------------------------------------*
           move      "OP"                 to   d-bar-cod-tip-ope      .
           move      "pgm/dcp/prg/obj/dbarcod0"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using d-bar-cod              .
       rou-opn-fls-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [osr]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/ods/fls/ioc/obj/iofosr"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione della stringa: 999999          *
      *                  *---------------------------------------------*
           move      06                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      "0"                  to   w-all-str-cat (1)      .
           move      rf-osr-num-prg
                    (01 : 05)             to   w-all-str-cat (2)      .
