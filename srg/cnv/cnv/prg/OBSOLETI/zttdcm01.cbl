      ...
      *                                   Fase:    zttdcm              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/08/04    *
      *                       Ultima revisione:    NdK del 23/08/04    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Update per provincia 'FC' clienti marketing *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Aggiornamento clienti marketing     "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione anagrafiche cl. marketing   "  .
      ...
      *              *-------------------------------------------------*
      *              * Start su archivio [dcm]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "CODCLI    "         to   f-key                  .
           move      0007336              to   rf-dcm-cod-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           if        rf-dcm-cod-cli       >    0007540
                     go to prn-liv-det-300.
           if        rf-dcm-cod-cmn       >    zero
                     go to prn-liv-det-300.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Rilevazione comune                              *
      ...
      *                          *-------------------------------------*
           move      rf-dcm-loc-cli
                    (01 : 05)             to   w-det-cap-cfl-cap      .
           move      rf-dcm-loc-cli
                    (07 : 05)             to   w-det-cap-cfl-cfl      .
           move      "FC"                 to   w-det-cap-cfl-prv      .
      *                          *-------------------------------------*
      *                          * Determinazione                      *
      *                          *-------------------------------------*
