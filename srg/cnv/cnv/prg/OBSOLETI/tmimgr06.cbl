      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ricostruzione [mgr] : TEMI                  *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "tmi/tmi/fls/ioc/obj/iofhww"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
      *              * Start su archivio [hww]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "ARCDAT    "         to   f-key                  .
           move      "C"                  to   rf-hww-tip-arc         .
           move      zero                 to   rf-hww-cod-arc         .
           move      zero                 to   rf-hww-dat-reg         .
           move      zero                 to   rf-hww-num-prt         .
           move      zero                 to   rf-hww-num-prg         .
           move      "tmi/tmi/fls/ioc/obj/iofhww"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [hww]              *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "tmi/tmi/fls/ioc/obj/iofhww"
                                          to   s-pat                  .
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-hww-cod-arc       to   w-rot-l01-cod-cli      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "FASE 1 - Pareggiamenti clienti ...................
      -              ".:"                 to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-hww-dat-reg       to   rf-mgt-dat-reg         .
           move      rf-hww-num-prt       to   rf-mgt-num-prt         .
           move      "pgm/cge/fls/ioc/obj/iofmgt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "DATREG    "         to   f-key                  .
           move      rf-hww-dat-reg       to   rf-mgr-dat-reg         .
           move      rf-hww-num-prt       to   rf-mgr-num-prt         .
           move      rf-hww-num-prg       to   rf-mgr-num-prg         .
           move      "pgm/cge/fls/ioc/obj/iofmgr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Confronti con record [hww]                      *
      *              *-------------------------------------------------*
           if        rf-hww-num-rif       =    rf-mgr-num-rif and
                     rf-hww-dat-rif       =    rf-mgr-dat-rif
                     go to prn-liv-det-900.
       prn-liv-det-600.
      *              *-------------------------------------------------*
      *              * Update [mgr]                                    *
      ...
      *              *-------------------------------------------------*
           move      rf-hww-dat-rif       to rf-mgr-dat-rif           .
           move      rf-hww-num-rif       to rf-mgr-num-rif           .
       prn-liv-det-upd-400.
      *              *-------------------------------------------------*
