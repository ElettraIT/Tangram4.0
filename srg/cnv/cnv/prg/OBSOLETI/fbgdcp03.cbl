      ...
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-fir-600.
      *                      *-----------------------------------------*
      *                      * Confronto tra codici alfanumerici       *
      *                      *-----------------------------------------*
           if        rf-fir-alf-pro       =    rf-dcp-alf-pro
                     go to stp-srt-inp-fir-200.
       stp-srt-inp-fir-600.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-fir-alf-pro       to   srt-arc-alf            .
           move      rf-fir-num-pro       to   srt-arc-num            .
      *                  *---------------------------------------------*
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
           move      rf-fir-des-rig       to   srt-arc-des            .
           move      rf-dcp-alf-pro       to   srt-dcp-alf            .
           move      rf-dcp-num-pro       to   srt-dcp-num            .
           move      rf-dcp-des-pro       to   srt-dcp-des            .
           move      "fat"                to   srt-arc-mag            .
       stp-srt-inp-fir-700.
      *                  *---------------------------------------------*
