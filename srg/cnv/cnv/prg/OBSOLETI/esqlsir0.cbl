      ...
      *                                   Fase:    sqlsir              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 22/06/07    *
      *                       Ultima revisione:    NdK del 22/06/07    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Export tabelle area su misura per SIRI      *
      *                                                                *
      *                   (/abd/ftx/sir/xxx.txt)                       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  ESPORTAZIONE TABELLE SU MISURA - SIRI "       .
      ...
      *                  * Esportazione [hed]                          *
      *                  *---------------------------------------------*
           perform   exe-exp-hed-000      thru exe-exp-hed-999        .
       exe-exp-fil-600.
      *              *-------------------------------------------------*
      *              * Eventuali forzature se esecuzione batch         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "sir "               to   f-xxx-are              .
           move      "hed "               to   f-xxx-nam              .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        f-xxx-sts            not  = "S"
                     go to exe-exp-hed-999.
      *              *-------------------------------------------------*
      *              * Eventuali forzature se esecuzione batch         *
      *              *-------------------------------------------------*
           if        w-exe-flg-btc        =    "S"
                     go to exe-exp-hed-010.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-exp-hed-750.
      *              *-------------------------------------------------*
      *              * Riciclo a Next su [hed]                         *
      *              *-------------------------------------------------*
           go to     exe-exp-hed-200.
       exe-exp-hed-800.
      *              *-------------------------------------------------*
      *              * Close files                                     *
      *              *-------------------------------------------------*
