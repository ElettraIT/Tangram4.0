      ...
      *                       Ultima revisione:    NdK del 23/12/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Rilevazione esistenza immagine, spostamento *
      *                    eventuale ed aggiornamento [dcp]            *
      *                                                                *
      *                    ZATTI                                       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Aggiornamento per archivio immagini  "       .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-010.
      *              *-------------------------------------------------*
      *              * Composizione pathname per verifica esistenza    *
      *              * file                                            *
      *              *-------------------------------------------------*
           move      20                   to   w-all-str-lun          .
           move      07                   to   w-all-str-num          .
           move      "p"                  to   w-all-str-cat (1)      .
           move      rf-dcp-alf-pro
                    (01 : 02)             to   w-all-str-cat (2)      .
           move      "/s"                 to   w-all-str-cat (3)      .
           move      rf-dcp-alf-pro
                    (03 : 02)             to   w-all-str-cat (4)      .
           move      "/_"                 to   w-all-str-cat (5)      .
           move      rf-dcp-alf-pro
                    (05 : 02)             to   w-all-str-cat (6)      .
           move      ".jpg"               to   w-all-str-cat (7)      .
      ...
      *                  *---------------------------------------------*
           ...
           move      "/abd/asc/img/"      to   w-all-str-cat (1)      .
      ...
      *                          *-------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Test se indicatore gia' presente                *
      *              *-------------------------------------------------*
           if        rf-dcp-rfl-lst       not  = spaces
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Aggiornamento indicatore per listini            *
      *              *-------------------------------------------------*
           move      rf-dcp-alf-pro       to   rf-dcp-rfl-lst         .
      *              *-------------------------------------------------*
