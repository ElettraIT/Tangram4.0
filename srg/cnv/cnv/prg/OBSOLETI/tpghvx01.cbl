      ...
      *                                   Fase:    gct780              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 24/09/92    *
      *                       Ultima revisione:    NdK del 19/02/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Assestamenti preventivo                     *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-flg.
      *        *-------------------------------------------------------*
      *        * Work per flags di intestazione                        *
      *        *-------------------------------------------------------*
           05  w-flg-int.
      *            *---------------------------------------------------*
      *            * Flag di intestazione tipo voce                    *
      *            *---------------------------------------------------*
               10  w-flg-int-tip-cpm      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Flag di intestazione codice voce                  *
      *            *---------------------------------------------------*
               10  w-flg-int-num-cpm      pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-tot.
      *        *-------------------------------------------------------*
      *        * Work per Totale ricaricato a livello dettaglio        *
      *        *-------------------------------------------------------*
           05  w-tot-ric-det.
      *            *---------------------------------------------------*
      *            * Totale quantita'                                  *
      *            *---------------------------------------------------*
               10  w-tot-ric-det-val      pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Work per Totali per Tipo voce                         *
      *        *-------------------------------------------------------*
           05  w-tot-tip-cpm.
      *            *---------------------------------------------------*
      *            * Totale quantita'                                  *
      *            *---------------------------------------------------*
               10  w-tot-tip-cpm-qta      pic s9(06)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale valore                                     *
      *            *---------------------------------------------------*
               10  w-tot-tip-cpm-val      pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Work per Totali per Codice voce                       *
      *        *-------------------------------------------------------*
           05  w-tot-num-cpm.
      *            *---------------------------------------------------*
      *            * Totale quantita'                                  *
      *            *---------------------------------------------------*
               10  w-tot-num-cpm-qta      pic s9(06)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale valore                                     *
      *            *---------------------------------------------------*
               10  w-tot-num-cpm-val      pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Work per Totali generali                              *
      *        *-------------------------------------------------------*
           05  w-tot-gen.
      *            *---------------------------------------------------*
      *            * Totale quantita' lavorazioni interne              *
      *            *---------------------------------------------------*
               10  w-tot-gen-lai-qta      pic s9(06)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale valore    lavorazioni interne              *
      *            *---------------------------------------------------*
               10  w-tot-gen-lai-val      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' lavorazioni esterne              *
      *            *---------------------------------------------------*
               10  w-tot-gen-lae-qta      pic s9(06)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale valore    lavorazioni esterne              *
      *            *---------------------------------------------------*
               10  w-tot-gen-lae-val      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' materiali                        *
      *            *---------------------------------------------------*
               10  w-tot-gen-mat-qta      pic s9(06)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale valore    materiali                        *
      *            *---------------------------------------------------*
               10  w-tot-gen-mat-val      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' generale                         *
      *            *---------------------------------------------------*
               10  w-tot-gen-tot-qta      pic s9(06)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale valore    generale                         *
      *            *---------------------------------------------------*
               10  w-tot-gen-tot-val      pic s9(11)                  .
      ...
      *            *---------------------------------------------------*
               10  w-det-val-ric-s11      pic s9(11)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-buf.
      *        *-------------------------------------------------------*
      *        * Per bufferizzazione voce a livello 1                  *
      *        *-------------------------------------------------------*
           05  w-buf-l01.
      *            *---------------------------------------------------*
      *            * Codice voce alfanumerico                          *
      *            *---------------------------------------------------*
               10  w-buf-l01-alf-cpm      pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Descrizione voce alfanumerico                     *
      *            *---------------------------------------------------*
               10  w-buf-l01-des-cpm      pic  x(40)                  .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "tpg/gct/fls/ioc/obj/iofhvx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Start su archivio [hvt]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "NUMPRT    "         to   f-key                  .
           move      zero                 to   rf-hvt-prt-prv         .
           move      zero                 to   rf-hvt-ver-prv         .
           move      "tpg/gct/fls/ioc/obj/iofhvt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [hvt]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "tpg/gct/fls/ioc/obj/iofhvt"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Write record [hvx] per fotocomposizione         *
      *              *-------------------------------------------------*
           if        rf-hvt-fci-snx       not  = 1
                     go to prn-liv-det-200.
           if        rf-hvt-fci-not       =    spaces
                     go to prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      rf-hvt-prt-prv       to   rf-hvx-prt-prv         .
           move      08                   to   rf-hvx-tip-rec         .
           move      rf-hvt-fci-not       to   rf-hvx-agg-400         .
           move      spaces               to   rf-hvx-alx-exp         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Write record [hvx] per fotolito interna         *
      *              *-------------------------------------------------*
           if        rf-hvt-fli-snx       not  = 1
                     go to prn-liv-det-900.
           if        rf-hvt-fli-not       =    spaces
                     go to prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Normalizzazione record                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-hvt-prt-prv       to   rf-hvx-prt-prv         .
           move      09                   to   rf-hvx-tip-rec         .
           move      rf-hvt-fli-not       to   rf-hvx-agg-400         .
           move      spaces               to   rf-hvx-alx-exp         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
