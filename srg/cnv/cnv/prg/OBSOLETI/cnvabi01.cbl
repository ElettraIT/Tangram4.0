      ...
      *                       Ultima revisione:    NdK del 04/12/01    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Conversione anagrafica BANCHE               *
      *                    da file 'abi.txt'                           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Generazione anagrafiche Sportelli Banche"       .
      ...
      *        *-------------------------------------------------------*
      *        * Numero di records scritti [axs]                       *
      *        *-------------------------------------------------------*
           05  w-pds-axs                  pic  9(06)                  .
      *        *-------------------------------------------------------*
      *        * Numero di records scritti [axi]                       *
      *        *-------------------------------------------------------*
           05  w-pds-axi                  pic  9(06)                  .
      *        *-------------------------------------------------------*
      ...
      *            * Codice ABI                                        *
      *            *---------------------------------------------------*
               10  w-lds-001-cod-abi      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice CAB                                        *
      *            *---------------------------------------------------*
               10  w-lds-001-cod-cab      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Denominazione ABI                                 *
      *            *---------------------------------------------------*
               10  w-lds-001-den-abi      pic  x(30)                  .
      *            *---------------------------------------------------*
      *            * Denominazione CAB                                 *
      *            *---------------------------------------------------*
               10  w-lds-001-den-cab      pic  x(60)                  .
      *            *---------------------------------------------------*
      *            * Indirizzo CAB                                     *
      *            *---------------------------------------------------*
               10  w-lds-001-via-cab      pic  x(30)                  .
      *            *---------------------------------------------------*
      *            * Cap CAB                                           *
      *            *---------------------------------------------------*
               10  w-lds-001-cap-cab      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Localita' CAB                                     *
      *            *---------------------------------------------------*
               10  w-lds-001-loc-cab      pic  x(30)                  .
      *            *---------------------------------------------------*
      *            * Provincia CAB                                     *
      *            *---------------------------------------------------*
               10  w-lds-001-prv-cab      pic  x(02)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-enc-axs-val-pre          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Valore post incremento                                *
      *        *-------------------------------------------------------*
           05  w-enc-axs-val-pos          pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-pds-axs              .
           move      zero                 to   w-pds-axi              .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Numero records scritti [axs]   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-lds-001-cod-abi    to   rf-axs-cod-abi         .
           move      w-lds-001-cod-cab    to   rf-axs-cod-cab         .
           move      "pgm/abi/fls/ioc/obj/iofaxs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-axs                 .
      *                  *---------------------------------------------*
      *                  * Incremento numero records scritti [axs]     *
      *                  *---------------------------------------------*
           add       1                    to   w-pds-axs              .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      20                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-pds-axs            to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       xcv-trt-pds-500.
      *                  *---------------------------------------------*
      *                  * Aggiornamento del record [axi]              *
      *                  *---------------------------------------------*
      ...
      *                  * Denominazione CAB                           *
      *                  *---------------------------------------------*
           move      w-lds-001-den-cab    to   rf-axs-den-spt         .
           if        rf-axs-den-spt       not  = spaces
                     go to cmp-rec-axs-220.
      *
           move      40                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           if        w-lds-001-loc-cab    =    spaces
                     move  "Agenzia di citta'"
                                          to   w-all-str-cat (1)
           else      move  "AG. di"       to   w-all-str-cat (1)      .
           move      w-lds-001-loc-cab    to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   rf-axs-den-spt         .
       cmp-rec-axs-220.
      *                  *---------------------------------------------*
      *                  * Indirizzo CAB                               *
      *                  *---------------------------------------------*
           move      w-lds-001-via-cab    to   rf-axs-via-spt         .
      *                  *---------------------------------------------*
      *                  * Localita' CAB                               *
      *                  *---------------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      w-lds-001-cap-cab    to   w-all-str-cat (1)      .
           move      w-lds-001-loc-cab    to   w-all-str-cat (2)      .
           move      w-lds-001-prv-cab    to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   rf-axs-loc-spt         .
      *                  *---------------------------------------------*
      *                  * Denominazione di ricerca                    *
      *                  *---------------------------------------------*
           move      w-lds-001-loc-cab    to   rf-axs-den-ric         .
      *                  *---------------------------------------------*
      *                  * Valori normalizzati                         *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-lds-001-cod-abi    to   rf-axi-cod-abi         .
           move      "pgm/abi/fls/ioc/obj/iofaxi"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-axi                 .
      *                  *---------------------------------------------*
      *                  * Incremento numero records scritti [axi]     *
      *                  *---------------------------------------------*
           add       1                    to   w-pds-axi              .
      *                  *---------------------------------------------*
      *                  * Visualizzo records scritti                  *
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lds-001-den-abi    to   rf-axi-den-abi         .
           move      w-lds-001-den-abi    to   rf-axi-den-key         .
           move      w-lds-001-den-abi    to   rf-axi-den-ric         .
