      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento files [bit] e [bir] : NOBILI  *
      *                                                                *
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Aggiornamento bolle - Cliente 6903      "  .
      ...
      *              *-------------------------------------------------*
           ...
           move      11700000000          to   rf-bir-num-prt         .
      ...
      *              *-------------------------------------------------*
           ...
           if        f-sts                not  = e-not-err
                     go to prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Modifica cliente [bit]                          *
      *              *-------------------------------------------------*
           move      0006026              to   rf-bit-cod-arc         .
           move      0006026              to   rf-bit-arc-plf         .
      *              *-------------------------------------------------*
      *              * Force Put record                                *
      *              *-------------------------------------------------*
           move      "FP"                 to   f-ope                  .
       ...
       prn-liv-det-600.
      *              *-------------------------------------------------*
      *              * Modifica cliente [bir]                          *
      *              *-------------------------------------------------*
           move      0006026              to   rf-bir-cod-arc         .
      *              *-------------------------------------------------*
      *              * Update record [bir]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
