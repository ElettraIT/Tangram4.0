      ...
      *                                   Fase:    zttdcp              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/12/02    *
      *                       Ultima revisione:    NdK del 24/02/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Eliminazione sottogruppi e inserimento      *
      *                    codici statistici 1 e 2 [dcp]               *
      *                                                                *
      *                    ZATTI                                       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Aggiornamento classificazione Zatti  "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione classificazione - ZATTI     "  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/zat/dcp"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/zat/dcp.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/zat/zps"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/zat/zps.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/zat/zp1"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/zat/zp1.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "RP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/zat/zp2"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/zat/zp2.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/zat/zp3"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/zat/zp3.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Codice classe in codice statistico 1            *
      *              *-------------------------------------------------*
           move      rf-dcp-cla-pro       to   rf-dcp-cod-s01         .
      *              *-------------------------------------------------*
      *              * Codice gruppo in codice classe                  *
      *              *-------------------------------------------------*
           move      rf-dcp-gru-pro       to   rf-dcp-cla-pro         .
      *              *-------------------------------------------------*
      *              * Codice sottogruppo in codice statistico 2       *
      *              *-------------------------------------------------*
           move      rf-dcp-sgr-pro       to   rf-dcp-cod-s02         .
      *              *-------------------------------------------------*
      *              * Normalizzazione gruppo e sottogruppo            *
      *              *-------------------------------------------------*
      ...
      *    * 80 caratteri ciascuna con o sacc-enza uno spazio di sepa- *
      *    * razione tra una stringa e l'altra                         *
      *    *                                                           *
      *    *                                                           *
      ...
      *    *-----------------------------------------------------------*
       wrt-rec-zps-000.
      *              *-------------------------------------------------*
      *              * Composizione record : Importazione              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      00100                to   rf-zps-cod-cls         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      "IMP  "              to   rf-zps-mne-cls         .
           move      "IMPORTAZIONE"       to   rf-zps-des-key         .
           move      "Importazione"       to   rf-zps-des-cls         .
      ...
      *                  *---------------------------------------------*
           move      01                   to   rf-zps-tip-cls         .
           move      00200                to   rf-zps-cod-cls         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      "CEE  "              to   rf-zps-mne-cls         .
           move      "ACQUISTI CEE"       to   rf-zps-des-key         .
           move      "Acquisti CEE"       to   rf-zps-des-cls         .
           move      spaces               to   rf-zps-alx-exp         .
      *                  *---------------------------------------------*
      *                  * Put record                                  *
      *                  *---------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      "PRI  "              to   rf-zps-mne-cls         .
           move      "PRIMAVERA   "       to   rf-zps-des-key         .
           move      "Primavera   "       to   rf-zps-des-cls         .
           move      spaces               to   rf-zps-alx-exp         .
      *                  *---------------------------------------------*
      *                  * Put record                                  *
      *                  *---------------------------------------------*
       ...
       wrt-rec-zps-300.
      *              *-------------------------------------------------*
      *              * Composizione record : Non Stagionale            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione record                      *
      *                  *---------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      "NST  "              to   rf-zps-mne-cls         .
           move      "NON STAGIONALE"     to   rf-zps-des-key         .
           move      "Non stagionale"     to   rf-zps-des-cls         .
           move      spaces               to   rf-zps-alx-exp         .
      *                  *---------------------------------------------*
      *                  * Put record                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      02                   to   rf-zps-tip-cls         .
           move      00300                to   rf-zps-cod-cls         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      "NAT  "              to   rf-zps-mne-cls         .
           move      "NATALE        "     to   rf-zps-des-key         .
           move      "Natale        "     to   rf-zps-des-cls         .
           move      spaces               to   rf-zps-alx-exp         .
      *                  *---------------------------------------------*
      *                  * Put record                                  *
      *                  *---------------------------------------------*
      ...
      *              * Max su archivio [zp2]                           *
      *              *-------------------------------------------------*
           if        rf-zp2-cod-cla       not  = 00100
                     go to wrt-rec-zp1-999.
       wrt-rec-zp1-400.
      *              *-------------------------------------------------*
      *              * Selezione su archivio [zp2]                     *
      *              *-------------------------------------------------*
       wrt-rec-zp1-600.
      *              *-------------------------------------------------*
      ...
      *                  * Campi chiave                                *
      *                  *---------------------------------------------*
           move      rf-zp2-cod-gru       to   rf-zp1-cod-cla         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      rf-zp2-des-gru       to   rf-zp1-des-cla         .
           move      rf-zp2-mne-gru       to   rf-zp1-mne-cla         .
           move      rf-zp2-des-key       to   rf-zp1-des-key         .
           move      rf-zp2-sqz-num       to   rf-zp1-sqz-num         .
           move      01                   to   rf-zp1-ult-sud         .
           move      rf-zp2-umi-def       to   rf-zp1-umi-def         .
