      ...
      *                       Ultima revisione:    NdK del 22/02/07    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Rilevazioni inventariali da file            *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "AGGIUSTAMENTO INVENTARIO DA SEQUENZIALE "       .
      ...
      *    *===========================================================*
      *    * Record file [mim] File di appoggio per inventario         *
      *    *-----------------------------------------------------------*
      *    *                                                           *
      *    * Indici : "MAGTGC    " = rf-mim-cod-dpz                    *
      *    *                         rf-mim-tip-mag                    *
      *    *                         rf-mim-num-mag                    *
      *    *                         rf-mim-var-mag                    *
      *    *                         rf-mim-tip-gia                    *
      ...
      *    *-----------------------------------------------------------*
       01  rf-wim.
      *        *-------------------------------------------------------*
      *        * Codice nostra dipendenza                              *
      *        *-------------------------------------------------------*
           05  rf-wim-cod-dpz             pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  rf-wim-num-mag             pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Sigla della variante di magazzino                     *
      *        *                                                       *
      *        * N.B. : Questo campo attualmente non e' gestito        *
      *        *-------------------------------------------------------*
           05  rf-wim-var-mag             pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Codice alfanumerico magazzino                         *
      *        *-------------------------------------------------------*
           05  rf-wim-alf-mag             pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione magazzino                                 *
      *        *-------------------------------------------------------*
           05  rf-wim-des-mag             pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Unita' di misura per gestione magazzino               *
      *        *-------------------------------------------------------*
           05  rf-wim-umi-mag             pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Numero decimali quantita' per gestione magazzino      *
      *        *-------------------------------------------------------*
           05  rf-wim-dec-qta             pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Tipo ubicazione                                       *
      *        *-------------------------------------------------------*
           05  rf-wim-tip-ubi             pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Parametri di ubicazione (1..4)                        *
      *        *-------------------------------------------------------*
           05  rf-wim-prm-ubi occurs 4    pic  x(07)                  .
      *        *-------------------------------------------------------*
      *        * Tipo giacenza                                         *
      *        * - 01 : Merci in giacenza, ma al netto delle merci non *
      *        *        di proprieta'                                  *
      *        * - 02 : Merci presso di noi, ma non di ns. proprieta'  *
      *        * - 03 : Merci presso terzi, ma non di loro proprieta'  *
      *        *-------------------------------------------------------*
           05  rf-wim-tip-gia             pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Sigla conto merce                                     *
      *        *                                                       *
      *        * Nota : Significativo solo per tipo giacenza 02 o 03   *
      *        *-------------------------------------------------------*
           05  rf-wim-cod-mic             pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Tipo archivio                                         *
      *        * - Spaces : Non significativo                          *
      *        * - C      : Cliente                                    *
      *        * - F      : Fornitore                                  *
      *        * - A      : Agente (Incaricato alla vendita)           *
      *        *                                                       *
      *        * Nota : Significativo solo per tipo giacenza 02 o 03   *
      *        *-------------------------------------------------------*
           05  rf-wim-tip-arc             pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Codice archivio                                       *
      *        *                                                       *
      *        * Nota : Significativo solo per tipo giacenza 02 o 03   *
      *        *-------------------------------------------------------*
           05  rf-wim-cod-arc             pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Dipendenza archivio                                   *
      *        *                                                       *
      *        * Nota : Significativo solo per tipo giacenza 02 o 03   *
      *        *-------------------------------------------------------*
           05  rf-wim-dpz-arc             pic  x(04)                  .
      *        *-------------------------------------------------------*
      *        * Quantita' presunta, ovvero quella che dovrebbe essere *
      *        * rilevata in assenza di differenze inventariali, rife- *
      *        * rita alla data di inizio inventario                   *
      *        *-------------------------------------------------------*
           05  rf-wim-qta-prs             pic s9(08)v9(03) sign is
                                                           trailing
                                                           separate
                                                           character  .
      *        *-------------------------------------------------------*
      ...
      *        * - #      : Eseguita                                   *
      *        *-------------------------------------------------------*
           05  rf-wim-flg-ril             pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Quantita' rilevata                                    *
      *        *-------------------------------------------------------*
           05  rf-wim-qta-rlv             pic s9(08)v9(03) sign is
                                                           trailing
                                                           separate
                                                           character  .
      *        *-------------------------------------------------------*
      ...
      *
           if        rr-dpz-inu           =    01
                     move  "dkb_sede.csv"
                                          to   rr-pth-fil
           else if   rr-dpz-inu           =    03
                     move  "dkb_vetr.csv"
                                          to   rr-pth-fil
           else if   rr-dpz-inu           =    06
                     move  "dkb_sala.csv"
                                          to   rr-pth-fil
           else if   rr-dpz-inu           =    07
                     move  "dkb_piov.csv"
                                          to   rr-pth-fil
           else      move  "dkb_xxxx.csv" to   rr-pth-fil             .
       acc-pth-fil-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      14                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "FASE 2 - Generazione movimenti ...................
      -              ".:"                 to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       upd-rec-mim-000.
      *              *-------------------------------------------------*
      *              * Recupero record memorizzato                     *
      *              *-------------------------------------------------*
           move      kk0-int-rec          to   rf-wim                 .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-wim-cod-dpz       to   rf-mim-cod-dpz         .
           move      rf-wim-tip-mag       to   rf-mim-tip-mag         .
           move      rf-wim-num-mag       to   rf-mim-num-mag         .
           move      rf-wim-var-mag       to   rf-mim-var-mag         .
           move      rf-wim-tip-gia       to   rf-mim-tip-gia         .
           move      rf-wim-tip-arc       to   rf-mim-tip-arc         .
           move      rf-wim-cod-arc       to   rf-mim-cod-arc         .
           move      rf-wim-dpz-arc       to   rf-mim-dpz-arc         .
           move      rf-wim-cod-mic       to   rf-mim-cod-mic         .
           move      "pgm/mag/fls/ioc/obj/iofmim"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       upd-rec-mim-200.
      *              *-------------------------------------------------*
      *              * Quantita' rilevata (quella rilevata del file di *
      *              * appoggio, se diversa da zero o quella presunta) *
      *              *-------------------------------------------------*
           if        rf-wim-qta-rlv       >    zero
                     move  rf-wim-qta-rlv to   rf-mim-qta-rlv
           else      move  rf-wim-qta-prs to   rf-mim-qta-rlv         .
      *              *-------------------------------------------------*
      *              * Flag di rilevazione                             *
      *              *-------------------------------------------------*
           move      rf-wim-flg-ril       to   rf-mim-flg-ril         .
       upd-rec-mim-400.
      *              *-------------------------------------------------*
      *              * Update record [mim]                             *
      *              *-------------------------------------------------*
