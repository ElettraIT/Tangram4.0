      ...
      *                                   Fase:    fbgbfr              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 12/04/05    *
      *                       Ultima revisione:    NdK del 14/04/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Controllo incongruenze 'bfo' : FORALBERG    *
      *                                                                *
      *                    Con ricostruzione [bft] (2005)              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Ricostruzione testate carichi : bfo  "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Controllo testate /righe / magazzino    "  .
      ...
      *              *-------------------------------------------------*
           ...
           move      10501000000          to   rf-bfr-num-prt         .
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-bfr-num-prt       to   w-rot-l01-num-prt      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-rot-l01-num-prt    to   rf-bft-num-prt         .
           move      "pgm/bfo/fls/ioc/obj/iofbft"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<"                  to   p-edm                  .
           move      w-rot-l01-num-prt    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Messaggio                                   *
      ...
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        w-rot-l01-num-prt    =    10501000662 or
                     w-rot-l01-num-prt    =    10501000665 or
                     w-rot-l01-num-prt    =    10501000670 or
                     w-rot-l01-num-prt    =    10501000676 or
                     w-rot-l01-num-prt    =    10501000678
                     go to prn-ini-lr1-390
           else      go to prn-ini-lr1-400.
       prn-ini-lr1-390.
      *                      *-----------------------------------------*
      *                      * Write record [bft]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-bft-000      thru wrt-rec-bft-999        .
       prn-ini-lr1-400.
      *              *-------------------------------------------------*
      *              * Lettura testata magazzino                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * INIBITO                                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-bft-dat-reg       to   rf-mmt-dat-reg         .
           move      rf-bft-prt-mag       to   rf-mmt-num-prt         .
           move      "pgm/mag/fls/ioc/obj/iofmmt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   m-msg                  .
      *
           string    "Protocollo magazzino non trovato : "
                                delimited by   size
                     p-edt      delimited by   spaces
                                          into m-msg                  .
      *
      ...
      *    *===========================================================*
      *    * Scrittura record testata [bft]                            *
      *    *-----------------------------------------------------------*
       wrt-rec-bft-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-bft-000      thru cmp-rec-bft-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Composizione record testata [bft]                         *
      *    *-----------------------------------------------------------*
       cmp-rec-bft-000.
      *              *-------------------------------------------------*
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      1050411              to   rf-bft-ide-dat         .
           move      "susanna"            to   rf-bft-ide-ute         .
           move      "bfo300"             to   rf-bft-ide-fas         .
           move      w-rot-l01-num-prt    to   rf-bft-num-prt         .
           move      rf-bfr-cod-tmb       to   rf-bft-cod-tmb         .

           if        w-rot-l01-num-prt    =    10501000662
                     move  10501002954    to   rf-bft-prt-mag
           else if   w-rot-l01-num-prt    =    10501000665
                     move  10501002965    to   rf-bft-prt-mag
           else if   w-rot-l01-num-prt    =    10501000670
                     move  10501002972    to   rf-bft-prt-mag
           else if   w-rot-l01-num-prt    =    10501000676
                     move  10501003041    to   rf-bft-prt-mag
           else if   w-rot-l01-num-prt    =    10501000678
                     move  10501003044    to   rf-bft-prt-mag         .
                     
           move      02                   to   rf-bft-int-ftr         .
           move      spaces               to   rf-bft-tmo-ftr         .
           move      01                   to   rf-bft-cod-dpz         .
           move      1050406              to   rf-bft-dat-reg         .
           move      rf-bfr-tip-arc       to   rf-bft-tip-arc         .
           move      rf-bfr-cod-arc       to   rf-bft-cod-arc         .
           move      rf-bfr-dpz-arc       to   rf-bft-dpz-arc         .
           move      zero                 to   rf-bft-arc-plf         .
           move      spaces               to   rf-bft-dpz-plf         .
           move      03                   to   rf-bft-tip-ids         .
           move      rf-bfr-dat-doc       to   rf-bft-dat-doc         .
           move      rf-bfr-num-doc       to   rf-bft-num-doc         .
           move      rf-bfr-cod-lng       to   rf-bft-cod-lng         .
           move      rf-bfr-sgl-vpf       to   rf-bft-sgl-vpf         .
           move      rf-bfr-dec-vpf       to   rf-bft-dec-vpf         .
           move      rf-bfr-tdc-vpf       to   rf-bft-tdc-vpf         .
           move      rf-bfr-cdc-vpf       to   rf-bft-cdc-vpf         .
           move      01                   to   rf-bft-inl-pgt         .
       cmp-rec-bft-999.
           exit.
