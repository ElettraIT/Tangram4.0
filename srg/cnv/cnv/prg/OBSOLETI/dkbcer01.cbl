      ...
      *                                   Fase:    dkbcer              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 06/02/04    *
      *                       Ultima revisione:    NdK del 06/02/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [cer] : DKB              *
      *                                                                *
      *                    Sistemazione flag trattamento               *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [cer]              *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "pgm/cge/fls/ioc/obj/iofcer"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-cer-cod-cau       =    00610
                     move  00220          to   rf-cer-cod-cau         .
           if        rf-cer-cod-cau       =    00600
                     move  00210          to   rf-cer-cod-cau         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Sostituzione flag di trattamento                *
      *              *-------------------------------------------------*
           if        rf-cer-cod-cau       =    00100
                     move  "SSNSNN"       to   rf-cer-flg-trt
           else if   rf-cer-cod-cau       =    00110
                     move  "NSNSSN"       to   rf-cer-flg-trt
           else if   rf-cer-cod-cau       =    00200
                     move  "NSNNNN"       to   rf-cer-flg-trt
           else if   rf-cer-cod-cau       =    00210
                     move  "NSNNNN"       to   rf-cer-flg-trt
           else if   rf-cer-cod-cau       =    00220
                     move  "NSNNNN"       to   rf-cer-flg-trt
           else if   rf-cer-cod-cau       =    00300
                     move  "NNSNNN"       to   rf-cer-flg-trt
           else if   rf-cer-cod-cau       =    00310
                     move  "NNSNNN"       to   rf-cer-flg-trt
           else if   rf-cer-cod-cau       =    00500
                     move  "NNNSNS"       to   rf-cer-flg-trt
           else if   rf-cer-cod-cau       =    00800
                     move  "NNNNNN"       to   rf-cer-flg-trt
           else if   rf-cer-cod-cau       =    00810
                     move  "NNNNNN"       to   rf-cer-flg-trt         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [cer]                             *
