      ...
      *                                   Fase:    zttdcc              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 06/08/07    *
      *                       Ultima revisione:    NdK del 20/10/09    *
      *                    ------------------------------------------- *
      ...
      *              *-------------------------------------------------*
           move      rf-dcc-via-dcc       to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   rf-dcc-via-dcc         .
      *              *-------------------------------------------------*
      *              * Localita' in uppercase                          *
      *              *-------------------------------------------------*
           move      rf-dcc-loc-dcc       to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   rf-dcc-loc-dcc         .
       prn-liv-det-700.
      *              *-------------------------------------------------*
      *              * Update record [dcc]                             *
      *              *-------------------------------------------------*
      ...
      *              * Indirizzo in uppercase                          *
      *              *-------------------------------------------------*
           move      rf-cli-via-cli       to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   rf-cli-via-cli         .
      *              *-------------------------------------------------*
      *              * Localita' in uppercase                          *
      *              *-------------------------------------------------*
           move      rf-cli-loc-cli       to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   rf-cli-loc-cli         .
       agg-rec-cli-400.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
