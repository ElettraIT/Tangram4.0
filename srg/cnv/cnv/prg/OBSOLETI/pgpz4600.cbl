      ...
      *                                   Fase:    gpz460              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/03/98    *
      *                       Ultima revisione:    NdK del 28/12/01    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa listino prodotti di vendita          *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Area per controllo su singoli bollettini                  *
      *    *-----------------------------------------------------------*
       01  w-cnt-eti.
      *        *-------------------------------------------------------*
      ...
      *                  * Correttivo margine inf.  formato 999        *
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Preparazione file di appoggio                   *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-kk0-000  thru stp-srt-inp-kk0-999    .
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Start su file [kk0]                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-zp1                 .
      *                      *-----------------------------------------*
      *                      * Se classe non trovata : a riciclo       *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Codice prodotto in chiave           *
      *                          *-------------------------------------*
           move      rf-dcp-alf-pro       to   srt-key-cod            .
      *                          *-------------------------------------*
      *                          * Descrizione prodotto in chiave      *
      *                          *-------------------------------------*
           move      rf-dcp-des-key       to   srt-key-des            .
      *                      *-----------------------------------------*
      *                      * Dati                                    *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Descrizione classe                  *
      *                          *-------------------------------------*
           if        rf-zp1-cod-cla       =    zero
                     move  "PRODOTTI"     to   srt-des-cla
           else      move  rf-zp1-des-cla to   srt-des-cla            .
      *                          *-------------------------------------*
      *                          * Record [dcp]                        *
      *                          *-------------------------------------*
      ...
      *                      * Area chiave                             *
      *                      *-----------------------------------------*
           move      f-kk0-ctr            to   kk0-key-prg            .
      *                      *-----------------------------------------*
      *                      * Area dati                               *
      *                      *-----------------------------------------*
           move      rf-dcp               to   kk0-rec-dcp            .
      *                      *-----------------------------------------*
      *                      * Scrittura                               *
      *                      *-----------------------------------------*
           write     kk0-rec                                          .
      ...
      *              *-------------------------------------------------*
      *              * Da record di sort a record [dcp]                *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-100.
      *                  *---------------------------------------------*
      *                  * Numero bollettini stampati nella pagina     *
      *                  *---------------------------------------------*
