      ...
      *                                   Fase:    sirbir              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 04/03/05    *
      *                       Ultima revisione:    NdK del 04/03/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [bir] : SIRI             *
      *                                                                *
      *                    Sistemazione Bolle c/deposito (evasione)    *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna bolla entro i limiti assegnati !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           if        rf-bir-cod-arc       not  = 0004039
                     go to prn-liv-det-900.
      *                  *---------------------------------------------*
      *                  * Test su tipo bolla                          *
      *                  *---------------------------------------------*
           if        rf-bir-cod-tmb       not  = "BVMD "
                     go to prn-liv-det-900.
      *                  *---------------------------------------------*
      *                  * Test su data bolla                          *
      *                  *---------------------------------------------*
           if        rf-bir-dat-doc       not  > 1050101
                     go to prn-liv-det-900.
      *                  *---------------------------------------------*
