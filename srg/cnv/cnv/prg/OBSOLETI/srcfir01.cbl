      ...
      *                       Ultima revisione:    NdK del 17/01/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sistemazione file [fit] : Serco             *
      *                                                                *
      * __________ DA FARE __________                                  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     Sistemazione protocolli fatture    "       .
      ...
      *        *-------------------------------------------------------*
           05  w-wrk-rec-fit.
               10  filler  occurs 2024    pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      1000000              to   rf-fit-dat-doc         .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Lettura vecchio record                          *
      *              *-------------------------------------------------*
           perform  let-rec-fit-000       thru let-rec-fit-999        .
      *              *-------------------------------------------------*
      *              * Cancellazione vecchio record                    *
      *              *-------------------------------------------------*
           perform  del-rec-fit-000       thru del-rec-fit-999        .
      *              *-------------------------------------------------*
      *              * Riscrittura record                              *
      *              *-------------------------------------------------*
           perform  put-rec-fit-000       thru put-rec-fit-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-fit                 .
      *              *-------------------------------------------------*
      *              * Bufferizzazione record [fit]                    *
      *              *-------------------------------------------------*
           move      rf-fit               to   w-wrk-rec-fit          .
       let-rec-fit-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     let-rec-fit-999.
       let-rec-fit-999.
           exit.

      *    *===========================================================*
      *    * Cancellazione record [fit]                                *
      *    *-----------------------------------------------------------*
       del-rec-fit-000.
      *              *-------------------------------------------------*
      *              * Composizione chiave                             *
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      w-wrk-rec-fit        to   rf-fit                 .
           if        w-wrk-ctr-001        =    1
                     move 1000001         to   rf-fit-num-prt
           else if   w-wrk-ctr-001        =    2
                     move 1000002         to   rf-fit-num-prt
           else if   w-wrk-ctr-001        =    3
                     move 1000003         to   rf-fit-num-prt
           else if   w-wrk-ctr-001        =    4
                     move 1000004         to   rf-fit-num-prt
           else if   w-wrk-ctr-001        =    5
                     move 1000005         to   rf-fit-num-prt
           else if   w-wrk-ctr-001        =    6
                     move 1000006         to   rf-fit-num-prt
           else if   w-wrk-ctr-001        =    7
                     move 1000007         to   rf-fit-num-prt         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
