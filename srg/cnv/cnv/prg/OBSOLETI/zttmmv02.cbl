      ...
      *                       Ultima revisione:    NdK del 05/09/13    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Aggiornamento decrementale L.I.F.O.   "       .
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-det-cmp-fin-ann          pic  9(04)                  .
           05  w-det-cmp-fin-pxx          pic  x(10)                  .
           05  w-det-cmp-fin-per          pic  9(04)v9(05)            .
      ...
      *    *===========================================================*
      *    * Work per aggiornamento scaglioni                          *
      *    *-----------------------------------------------------------*
       01  w-agg.
      *        *-------------------------------------------------------*
      *        * Tabella di assegnazione aliquote                      *
      *        *-------------------------------------------------------*
           05  w-agg-scg-lif.
      *            *---------------------------------------------------*
      *            * Tabella base                                      *
      *            *                                                   *
      *            * Fornita via mail da Daniele - 04/09/2013          *
      *            *---------------------------------------------------*
               10  w-agg-scg-ctr          pic  9(03)                  .
               10  w-agg-scg-tbl.
                   ...
                   15  filler             pic  x(15) value
                       "2000 0020,00000"                              .
               10  w-agg-scg-tbr redefines
                   w-agg-scg-tbl.
                   15  w-agg-scg-ele occurs 14
                                 indexed       by w-agg-scg-inx       .
                       20  w-agg-scg-ann  pic  9(04)                  .
                       20  fille          pic  x(01)                  .
                       20  w-agg-scg-per  pic  x(10)                  .
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-mmv-ann-ese       not  = rr-ann-ese
                     go to stp-srt-inp-mmv-900.
      ...
      *                  *---------------------------------------------*
       ...
       agg-rec-mmv-200.
      *              *-------------------------------------------------*
      *              * Ciclo di scansione castelletto LIFO             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Inizio ciclo                                *
      *                  *---------------------------------------------*
           move      zero                 to   w-det-cmp-fin-ann      .
           move      spaces               to   w-det-cmp-fin-pxx      .
           move      zero                 to   w-det-cmp-fin-ctr      .
       agg-rec-mmv-220.
           add       1                    to   w-det-cmp-fin-ctr      .
           if        w-det-cmp-fin-ctr    >    10
                     go to agg-rec-mmv-400.
      *                  *---------------------------------------------*
      *                  * Test su costo medio ponderato finale        *
      *                  *---------------------------------------------*
           if        rf-mmv-ump-pre
                    (w-det-cmp-fin-ctr)   =    zero
                     go to agg-rec-mmv-220.
      *                  *---------------------------------------------*
      *                  * Determinazione anno scaglione               *
      *                  *---------------------------------------------*
           move      srt-ann-ese          to   w-det-cmp-fin-ann      .
           add       1900                 to   w-det-cmp-fin-ann      .
           subtract  w-det-cmp-fin-ctr    from w-det-cmp-fin-ann      .
      *                  *---------------------------------------------*
      *                  * Ricerca aliquota scaglione                  *
      *                  *---------------------------------------------*
           set       w-agg-scg-inx        to   1                      .
           search    w-agg-scg-ele
                     when  w-agg-scg-ann
                          (w-agg-scg-inx) =    w-det-cmp-fin-ann
                     move  w-agg-scg-per
                          (w-agg-scg-inx) to   w-det-cmp-fin-pxx      .
      *                  *---------------------------------------------*
      *                  * Estrazione aliquota                         *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      10                   to   v-car                  .
           move      w-det-cmp-fin-pxx    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-cmp-fin-per      .
      *                  *---------------------------------------------*
      *                  * Test su aliquota                            *
      *                  *---------------------------------------------*
           if        w-det-cmp-fin-per    =    zero
                     go to agg-rec-mmv-220.
      *                  *---------------------------------------------*
      *                  * Applicazione aliquota                       *
      *                  *---------------------------------------------*
           divide    w-det-cmp-fin-per    into rf-mmv-ump-pre
                                              (w-det-cmp-fin-ctr)     .
      *                  *---------------------------------------------*
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
