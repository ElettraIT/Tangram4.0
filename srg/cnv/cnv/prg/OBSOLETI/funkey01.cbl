      ...
      *                                   Fase:    funkey              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 25/10/04    *
      *                       Ultima revisione:    NdK del 30/09/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Test su function key                        *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      05                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      rr-tip-cnv           to   v-alf                  .
      *
           move      "[1] "               to   v-pfk (01)             .
           move      "[2] "               to   v-pfk (02)             .
           move      "[3] "               to   v-pfk (03)             .
           move      "[4] "               to   v-pfk (04)             .
           move      "RFSH"               to   v-pfk (05)             .
           move      "COPY"               to   v-pfk (06)             .
           move      "PAST"               to   v-pfk (07)             .
           move      "EXPD"               to   v-pfk (08)             .
           move      "APND"               to   v-pfk (09)             .
           move      "ICHR"               to   v-pfk (10)             .
           move      "DCHR"               to   v-pfk (11)             .
           move      "HELP"               to   v-pfk (12)             .
           move      "DO  "               to   v-pfk (13)             .
           move      "DELT"               to   v-pfk (14)             .
           move      "PRNT"               to   v-pfk (15)             .
           move      "EXIT"               to   v-pfk (16)             .
           move      "FIND"               to   v-pfk (17)             .
           move      "INSR"               to   v-pfk (18)             .
           move      "REMV"               to   v-pfk (19)             .
           move      "SLCT"               to   v-pfk (20)             .
           move      "PRSC"               to   v-pfk (21)             .
           move      "NXSC"               to   v-pfk (22)             .
           move      "UP  "               to   v-pfk (23)             .
           move      "DOWN"               to   v-pfk (24)             .
           move      "RGHT"               to   v-pfk (25)             .
           move      "LEFT"               to   v-pfk (26)             .
           move      "RTRN"               to   v-pfk (27)             .
           move      "TAB "               to   v-pfk (28)             .
           move      "SHCP"               to   v-pfk (29)             .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      v-alf                to   rr-tip-cnv             .
       acc-tip-cnv-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-tip-cnv           =    spaces
                     go to acc-tip-cnv-100.
       acc-tip-cnv-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
           move      v-key                to   w-err-box-err-msg      .
