      ...
      *                                   Fase:    aggmmv              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/05/03    *
      *                       Ultima revisione:    NdK del 20/05/03    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Update per sistemazione CMP - LIFO 2003     *
      *                                                                *
      *                    scaglione 2001 (II) - SIRI                  *
      *                                                                *
      *                    Rilettura righe per calcolo CMP             *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
      *              * Start su archivio [mmv] per anno 2002           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "ESECOD    "         to   f-key                  .
           move      103                  to   rf-mmv-ann-ese         .
      ...
      *              *-------------------------------------------------*
       ...
       agg-rec-mmv-110.
      *              *-------------------------------------------------*
      *              * Scansione movimenti prodotto                    *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "MAGDAT    "         to   f-key                  .
           move      srt-tip-mag          to   rf-mmr-tip-mag         .
           move      srt-num-mag          to   rf-mmr-num-mag         .
           move      1010101              to   rf-mmr-dat-reg         .
      ...
      *              * Max su [mmr]                                    *
      *              *-------------------------------------------------*
           if        rf-mmr-tip-mag       not  = srt-tip-mag or
                     rf-mmr-num-mag       not  = srt-num-mag
                     go to agg-rec-mmv-400.
       agg-rec-mmv-140.
      *              *-------------------------------------------------*
      *              * Sel su [mmr]                                    *
      *              *-------------------------------------------------*
           if        rf-mmr-dat-reg       >    1011231
                     go to agg-rec-mmv-120.
           if        rf-mmr-cod-cau       =    00100 or
                     rf-mmr-cod-cau       =    00880
                     go to agg-rec-mmv-160.
           go to     agg-rec-mmv-120.
       agg-rec-mmv-160.
           if        rf-mmr-qta-mov       =    zero or
                     rf-mmr-val-mov       =    zero
                     go to agg-rec-mmv-120.
       agg-rec-mmv-200.
      *              *-------------------------------------------------*
      *              * Cumulo quantita' e valore                       *
      *              *-------------------------------------------------*
           add       rf-mmr-qta-mov       to   w-det-cmp-fin-wpq      .
           add       rf-mmr-val-mov       to   w-det-cmp-fin-wpv      .
       agg-rec-mmv-300.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
      ...
      *              * Determinazione CMP                              *
      *              *-------------------------------------------------*
           if        w-det-cmp-fin-wpq    =    zero or
                     w-det-cmp-fin-wpv    =    zero
      ...
      *              *-------------------------------------------------*
           divide    w-det-cmp-fin-wpq    into w-det-cmp-fin-wpv
                                        giving w-det-cmp-fin-wcs
                                               rounded                .
      *              *-------------------------------------------------*
      *              * Applicazione decimali gestione magazzino        *
      *              *-------------------------------------------------*
           multiply  100                  by   w-det-cmp-fin-wcs      .
      *              *-------------------------------------------------*
      *              * Test sul valore calcolato                       *
      *              *-------------------------------------------------*
           if        w-det-cmp-fin-wcs    =    zero
                     go to agg-rec-mmv-900.
       agg-rec-mmv-500.
      *              *-------------------------------------------------*
      ...
      *              * Aggiornamento record [mmv]                      *
      *              *-------------------------------------------------*
           if        rf-mmv-ump-pre (2)   not  = zero
                     go to agg-rec-mmv-800.
           if        w-det-cmp-fin-wcs    >    rf-mmv-ump-pre (2)
                     move  w-det-cmp-fin-wcs
                                          to   rf-mmv-ump-pre (2)     .
       agg-rec-mmv-700.
      *              *-------------------------------------------------*
      *              * Update record                                   *
