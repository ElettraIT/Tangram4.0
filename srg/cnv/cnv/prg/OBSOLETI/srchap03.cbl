      ...
      *                                   Fase:    srchap              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 13/02/04    *
      *                       Ultima revisione:    NdK del 13/02/04    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Update partite per codice MAGAZZINO         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Aggiornamento Codice MAGAZZINO - partite"       .
      ...
      *              *-------------------------------------------------*
           ...
           move      1000101              to   rf-hap-dat-ipt         .
      ...
      *                  *---------------------------------------------*
           if        rf-hap-cod-mag       =    "070104        " or
                     rf-hap-cod-mag       =    "190204        " or
                     rf-hap-cod-mag       =    "150103        " or
                     rf-hap-cod-mag       =    "170405        " or
                     rf-hap-cod-mag       =    "070704        " or
                     rf-hap-cod-mag       =    "TRITURATO     " or
                     rf-hap-cod-mag       =    "TRIT/ECOMAR   "
      ...
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
           move      rf-hap-cod-mag       to   srt-cod-mag            .
       stp-srt-inp-700.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hap"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hap.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           perform   agg-rec-hap-000      thru agg-rec-hap-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to agg-rec-hap-900.
      *              *-------------------------------------------------*
      *              * Aggiornamento record [hap]                      *
      *              *-------------------------------------------------*
           if        srt-cod-mag          =    "070104        "
                     move  "ACQUESOLVENTI "
                                          to   rf-hap-cod-mag
           else if   srt-cod-mag          =    "190204        "
                     move  "TRATTPER      "
                                          to   rf-hap-cod-mag
           else if   srt-cod-mag          =    "150103        "
                     move  "LEGNO         "
                                          to   rf-hap-cod-mag
           else if   srt-cod-mag          =    "170405        "
                     move  "FERRO         "
                                          to   rf-hap-cod-mag
           else if   srt-cod-mag          =    "070704        "
                     move  "ACQUEREFLUE   "
                                          to   rf-hap-cod-mag
           else if   srt-cod-mag          =    "TRITURATO     "
                     move  "TERMOSOL      "
                                          to   rf-hap-cod-mag
           else if   srt-cod-mag          =    "TRIT/ECOMAR   "
                     move  "TRATTPER      "
                                          to   rf-hap-cod-mag         .
      *              *-------------------------------------------------*
      *              * Update record                                   *
