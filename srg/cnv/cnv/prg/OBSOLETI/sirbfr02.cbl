      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Controllo incrociato righe mag - bfo        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Controllo incrociato carichi : SIRI  "       .
      ...
      *              *-------------------------------------------------*
      *              * Incremento contatore generico                   *
      *              *-------------------------------------------------*
           add       100                 to   w-wrk-num-prg          .
       prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Tentativo di lettura regord [mmr]               *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-bft-dat-reg       to   rf-mmr-dat-reg         .
           move      rf-bft-prt-mag       to   rf-mmr-num-prt         .
           move      w-wrk-num-prg        to   rf-mmr-num-prg         .
           move      "pgm/mag/fls/ioc/obj/iofmmr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-liv-det-200.
      *                  *---------------------------------------------*
      *                  * Confronto codice prodotto                   *
      *                  *---------------------------------------------*
           if        rf-mmr-num-mag       not  = rf-bfr-num-mag
                     go to prn-liv-det-200.
      *                  *---------------------------------------------*
      *                  * Confronto valore movimento                  *
      *                  *---------------------------------------------*
           if        rf-mmr-cun-mov
                    (01 : 09)             =    rf-bfr-prz-net
                     go to prn-liv-det-200.
       prn-liv-det-600.
      *              *-------------------------------------------------*
      *              * Editing data                                    *
