      ...
      *                       Ultima revisione:    NdK del 27/12/97    *
      *                    ------------------------------------------- *
      ...
      *                    ZATTI                                       *
      *                                                                *
      *                    Listino (2) prodotti con sconti e           *
      *                    provvigioni                                 *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Conversione anagraf. listino 2 ZATTI Srl"       .
      ...
      *        *-------------------------------------------------------*
      *        * Per determinazione sconto                             *
      *        *-------------------------------------------------------*
           05  w-det-per-sco.
      *            *---------------------------------------------------*
      *            * Comodi                                            *
      *            *---------------------------------------------------*
               10  w-det-per-sco-per      pic  9(02)                  .
               10  w-det-per-sco-pvg      pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-lds-000 (001:20)   =    "--------------------"
                     go to xcv-trt-pds-900.
           if        w-lds-000 (001:20)   =    "  CODICE      DESCRI"
                     go to xcv-trt-pds-900.
           if        w-lds-000 (001:20)   =    "    DITTA :   1  ZAT"
                     go to xcv-trt-pds-900.
           if        w-lds-000 (054:20)   =    ">>>  LISTINO  PREZZI"
                     go to xcv-trt-pds-900.
      ...
      *                          *-------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      02                   to   v-car                  .
           move      w-lds-001-per-sco    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-per-sco-per      .
       xcv-trt-pds-220.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * lettura del listino 1 per le provvigioni    *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Normalizzazione [dcp]                   *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      s-pat               using f
                                               rf-dcp                 .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione provvigioni             *
      *                      *-----------------------------------------*
           move      rf-dcp-per-pvg (1)   to   w-det-per-sco-pvg      .
           if        w-det-per-sco-pvg    >    2
                     divide 2             into w-det-per-sco-pvg      .
      *                  *---------------------------------------------*
      *                  * Composizione del record [lst]               *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-det-num-pro-num    to   rf-lst-num-pro         .
       cmp-rec-lst-200.
      *              *-------------------------------------------------*
      *              * Campi non chiave                                *
      *              *-------------------------------------------------*
      ...
      *                  * Prezzo                                      *
      *                  *---------------------------------------------*
           move      w-det-lst-bas-prz    to   rf-lst-prz-lst         .
      *                  *---------------------------------------------*
      *                  * % di provvigione                            *
      *                  *---------------------------------------------*
           move      w-det-per-sco-pvg    to   rf-lst-per-pvg (1)     .
           move      zero                 to   rf-lst-per-pvg (2)     .
           move      zero                 to   rf-lst-per-pvg (3)     .
      *                  *---------------------------------------------*
      *                  * % sconto in riga                            *
      *                  *---------------------------------------------*
           move      w-det-per-sco-per    to   rf-lst-per-sco (1)     .
