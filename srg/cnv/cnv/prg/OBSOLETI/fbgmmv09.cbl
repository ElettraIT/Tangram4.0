      ...
      *                                   Fase:    fbgmmv              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 04/07/05    *
      *                       Ultima revisione:    NdK del 04/07/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Salvataggio e ripristino archivio [mmv]     *
      *                                                                *
      *                    Foralberg                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Salvataggio tabella saldi a valore [mmv]"       .
      ...
      *                  *---------------------------------------------*
           if        rr-tip-cnv           not  = 02
                     go to acc-pth-fil-999.
      *                  *---------------------------------------------*
      *                  * Eventuale default                           *
      *                  *---------------------------------------------*
           if        rr-pth-fil           =    spaces
                     move  "/abd/azi/prv2/mmv."
                                          to   rr-pth-fil             .
       acc-pth-fil-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      ...
      *              *-------------------------------------------------*
           ...
           move      0000005              to   rf-dcp-num-pro         .
           move      "pgm/dcp/fls/ioc/obj/iofdcp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Test se salvataggio o ripristino                *
      *              *-------------------------------------------------*
           if        rr-tip-cnv           =    02
                     go to prn-ini-cic-500.
       prn-ini-cic-100.
      *              *-------------------------------------------------*
      *              * Visualizzazione indicatore per copia            *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      "/abd/azi/prv2/mmv."
                                          to   w-all-str-cat (1)      .
           move      s-sdt (01 : 15)      to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/prv2/mmv"  to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      w-all-str-alf        to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
           call      "swd/mod/prg/obj/mopsys"
      ...
      *              *-------------------------------------------------* 
       ...
       prn-ini-cic-500.
      *              *-------------------------------------------------*
      *              * Visualizzazione indicatore per ripristino       *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
