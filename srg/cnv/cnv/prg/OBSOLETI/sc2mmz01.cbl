      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Import giacenze da ZATTI a SCHEMA 2         *
      *                                                                *
      *                    N.B.: vedi note programma 'zttmmz01'        *
      *                                                                *
      *                   (/abd/asc/tmp/ZATMMZ.SQZ)                    *
      *                                                                *
      *                   ___ MAI UTILIZZATO ___                       *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      ...
      *                  *---------------------------------------------*
           ...
           else if   kk0-tip-rec          =    "mmr "
                     go to exe-gen-rec-500
           else if   kk0-tip-rec          =    "mms "
                     go to exe-gen-rec-550
           else if   kk0-tip-rec          =    "mmv "
                     go to exe-gen-rec-600
           else if   kk0-tip-rec          =    "mmz "
                     go to exe-gen-rec-650
      ...
      *                      * Trattamento record                      *
      *                      *-----------------------------------------*
           perform   exe-gen-rec-mmt-000  thru exe-gen-rec-mmt-999    .
      *                      *-----------------------------------------*
      *                      * A riciclo                               *
      *                      *-----------------------------------------*
      ...
      *                      * Trattamento record                      *
      *                      *-----------------------------------------*
           perform   exe-gen-rec-mmr-000  thru exe-gen-rec-mmr-999    .
      *                      *-----------------------------------------*
      *                      * A riciclo                               *
      *                      *-----------------------------------------*
           go to     exe-gen-rec-800.
      ...
      *                      * Trattamento record                      *
      *                      *-----------------------------------------*
           perform   exe-gen-rec-mms-000  thru exe-gen-rec-mms-999    .
      *                      *-----------------------------------------*
      *                      * A riciclo                               *
      *                      *-----------------------------------------*
           go to     exe-gen-rec-800.
      ...
      *                      * Trattamento record                      *
      *                      *-----------------------------------------*
           perform   exe-gen-rec-mmv-000  thru exe-gen-rec-mmv-999    .
      *                      *-----------------------------------------*
      *                      * A riciclo                               *
      *                      *-----------------------------------------*
           go to     exe-gen-rec-800.
      ...
      *                      * Trattamento record                      *
      *                      *-----------------------------------------*
           perform   exe-gen-rec-mmz-000  thru exe-gen-rec-mmz-999    .
      *                      *-----------------------------------------*
      *                      * A riciclo                               *
      *                      *-----------------------------------------*
           go to     exe-gen-rec-800.
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Composizione record [mmt]               *
      *                      *-----------------------------------------*
           perform   cmp-rec-mmt-000      thru cmp-rec-mmt-999        .
      *                      *-----------------------------------------*
      *                      * Scrittura del record [mmt]              *
      *                      *-----------------------------------------*
      ...
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     exe-gen-rec-mmt-999.
       exe-gen-rec-mmt-999.
           exit.

      *    *===========================================================*
      *    * Composizione record testata [mmt] per ordine cliente      *
      *    *-----------------------------------------------------------*
       cmp-rec-mmt-000.
      *              *-------------------------------------------------*
      ...
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     exe-gen-rec-mmr-999.
       exe-gen-rec-mmr-999.
           exit.

      *    *===========================================================*
      *    * Composizione record riga [mmr] per ordine cliente         *
      *    *-----------------------------------------------------------*
       cmp-rec-mmr-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Composizione record [mms]               *
      *                      *-----------------------------------------*
           perform   cmp-rec-mms-000      thru cmp-rec-mms-999        .
      *                      *-----------------------------------------*
      *                      * Scrittura del record [mms]              *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Composizione record [mmv]               *
      *                      *-----------------------------------------*
           perform   cmp-rec-mmv-000      thru cmp-rec-mmv-999        .
      *                      *-----------------------------------------*
      *                      * Scrittura del record [mmv]              *
      *                      *-----------------------------------------*
