      ...
      *                       Ultima revisione:    NdK del 19/07/06    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Verifica carichi doppi magazzino - SIRI "       .
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-srt-prt-mag              pic  9(11)                  .
           05  w-srt-dat-reg              pic  9(07)                  .
           05  w-srt-num-doc              pic  x(10)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-rot-l01.
               ...
               10  w-rot-l01-num-doc      pic  x(10)                  .
               10  w-rot-l01-dat-doc      pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      1060515              to   rf-bft-dat-reg         .
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-bft-cod-arc       to   w-rot-l01-cod-arc      .
           move      rf-bft-num-doc       to   w-rot-l01-num-doc      .
           move      rf-bft-dat-doc       to   w-rot-l01-dat-doc      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-srt-num-prg          .
           move      zero                 to   w-srt-prt-mag          .
           move      zero                 to   w-srt-dat-reg          .
           move      spaces               to   w-srt-num-doc          .
       prn-ini-lr1-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bft-prt-mag       to   w-srt-prt-mag          .
           move      rf-bft-dat-reg       to   w-srt-dat-reg          .
           move      rf-bft-num-doc       to   w-srt-num-doc          .
