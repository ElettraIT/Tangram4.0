      ...
      *                                   Fase:    fermmz              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 29/01/10    *
      *                       Ultima revisione:    NdK del 29/01/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [mmz] : FERRAMENTA       *
      *                                                                *
      *                    Cancellazione schede di prodotti eliminati  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Aggiornamento c/merce - FERRAMENTA   "       .
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-dcp                 .
      *                      *-----------------------------------------*
      *                      * Se record [dcp] trovato: a riciclo      *
      *                      *-----------------------------------------*
           if        f-sts                =    e-not-err
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun prodotto cancellato da aggiornare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fer/mmz"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fer/mmz.SAV"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
