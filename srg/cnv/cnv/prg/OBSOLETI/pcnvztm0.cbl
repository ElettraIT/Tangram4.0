      ...
      *                       Ultima revisione:    NdK del 13/04/14    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Generazione giacenze ZATTI - file 'inv.csv' *
      *                                                                *
      *                    Upgrade per INVENTARIO MAGGIO 2014          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   CARICAMENTO INVENTARIO MAGGIO 2014   "       .
      ...
      *        *-------------------------------------------------------*
      *        * Per determinazione quantita'                          *
      *        *-------------------------------------------------------*
           05  w-det-qta-inv.
      *            *---------------------------------------------------*
      *            * Comodi                                            *
      *            *---------------------------------------------------*
               10  w-det-qta-inv-qta      pic  9(10)                  .
      ...
      *              *-------------------------------------------------*
      *              * Azzeramento finale [mim]                        *
      *              *-------------------------------------------------*
           perform   exe-azz-mim-000      thru exe-azz-mim-999        .
       xcv-rou-pri-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      10                   to   v-car                  .
           move      w-lds-001-qta-inv    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-qta-inv-qta      .
       xcv-trt-pds-400.
      *                  *---------------------------------------------*
      *                  * Aggiornamento del record [mim]              *
      *                  *---------------------------------------------*
           perform   upd-rec-mim-000      thru upd-rec-mim-999        .
      *                  *---------------------------------------------*
      *                  * Incremento numero records scritti [mim]     *
      *                  *---------------------------------------------*
           add       1                    to   w-pds-mim              .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-num-pro-num    to   rf-mim-num-mag         .
      ...
      *              * Quantità rilevata                               *
      *              *-------------------------------------------------*
           move      w-det-qta-inv-qta    to   rf-mim-qta-rlv         .
      *              *-------------------------------------------------*
      *              * Flag di rilevazione                             *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Ciclo di scansione per azzeramento prodotti non contati   *
      *    *-----------------------------------------------------------*
       exe-azz-mim-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-mim-tip-gia       not  = 01
                     go to exe-azz-mim-800.
      *                  *---------------------------------------------*
      *                  * Test su quantita' rilevata                  *
      *                  *---------------------------------------------*
           if        rf-mim-qta-rlv       not  = zero
                     go to exe-azz-mim-800.
      *                  *---------------------------------------------*
      *                  * Test su flag rilevazione                    *
      *                  *---------------------------------------------*
