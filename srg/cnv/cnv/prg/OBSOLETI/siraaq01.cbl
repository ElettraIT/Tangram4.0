      ...
      *                                   Fase:    siraaq              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 25/03/97    *
      *                    ------------------------------------------- *
      *                                 Autore:    Alter s.r.l. - PD   *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento fornitore preferenziale       *
      *                                                                *
      *                    SIRI                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento fornitore prefer. - SIRI "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione fornitore preferenziale     "  .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Lettura record [dcp] per classificazione        *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-zp2-flg    not  = spaces
                     go to prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Lettura record [zp3] per mnemonico sottogruppo  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-120.
      *              *-------------------------------------------------*
      *              * Codice fornitore preferenziale per classe       *
      *              *-------------------------------------------------*
           if        w-let-arc-zp1-mne    =    "PA   "
                     move  0006002        to   rf-aaq-dcf-pfz
                     go to prn-liv-det-200.
      *              *
           if        w-let-arc-zp1-mne    =    "PP   "
                     move  0006003        to   rf-aaq-dcf-pfz
                     go to prn-liv-det-200.
      *              *
           if        w-let-arc-zp1-mne    =    "PF   "
                     move  0006003        to   rf-aaq-dcf-pfz
                     go to prn-liv-det-200.
      *              *
           if        w-let-arc-zp1-mne    =    "TH   "
                     move  0006017        to   rf-aaq-dcf-pfz
                     go to prn-liv-det-200.
      *              *
           if        w-let-arc-zp1-mne    =    "TB   "
                     move  0006020        to   rf-aaq-dcf-pfz
                     go to prn-liv-det-200.
      *              *
           if        w-let-arc-zp1-mne    =    "DP   "
                     move  0006026        to   rf-aaq-dcf-pfz
                     go to prn-liv-det-200.
      *              *
           if        w-let-arc-zp1-mne    =    "VI   "
                     move  0006001        to   rf-aaq-dcf-pfz
                     go to prn-liv-det-200.
      *              *
           if        w-let-arc-zp1-mne    =    "SF   "
                     move  0006018        to   rf-aaq-dcf-pfz
                     go to prn-liv-det-200.
      *              *
           if        w-let-arc-zp1-mne    =    "SA   "
                     move  0006025        to   rf-aaq-dcf-pfz
                     go to prn-liv-det-200.
      *              *
           if        w-let-arc-zp1-mne    =    "IS   "
                     move  0006004        to   rf-aaq-dcf-pfz
                     go to prn-liv-det-200.
      *              *
           if        w-let-arc-zp1-mne    =    "RB   "
                     move  0006002        to   rf-aaq-dcf-pfz
                     go to prn-liv-det-200.
       prn-liv-det-130.
      *              *-------------------------------------------------*
      *              * Codice fornitore preferenziale per gruppo       *
      *              *-------------------------------------------------*
       prn-liv-det-140.
      *              *-------------------------------------------------*
      *              * Codice fornitore preferenziale per sottogruppo  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * In tutti gli altri casi : a release         *
      *                  *---------------------------------------------*
           go to     prn-liv-det-300.
       prn-liv-det-200.
      *              *-------------------------------------------------*
