      ...
      *                       Ultima revisione:    NdK del 07/06/05    *
      *                    ------------------------------------------- *
      ...
      *              *-------------------------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Normalizzazione saldi : in corso ..."
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       nor-fil-mmv-100.
      ...
      *              *-------------------------------------------------*
       nor-fil-mmv-400.
      *              *-------------------------------------------------*
      *              * Azzeramento rimanenze finali castelletto lifo   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Ciclo di scansione su progressivi mensili   *
      *                  *---------------------------------------------*
           move      zero                 to   w-nor-fil-mmx-inx      .
       nor-fil-mmv-420.
           add       1                    to   w-nor-fil-mmx-inx      .
           if        w-nor-fil-mmx-inx    >    10
                     go to nor-fil-mmv-600.
      *                      *-----------------------------------------*
      *                      * Rimanenza finale dell'esercizio passato *
      *                      *-----------------------------------------*
           move      zero                 to   rf-mmv-rim-pre
                                              (w-nor-fil-mmx-inx)     .
      *                      *-----------------------------------------*
      *                      * Riciclo                                 *
      *                      *-----------------------------------------*
           go to     nor-fil-mmv-420.
       nor-fil-mmv-600.
      *              *-------------------------------------------------*
      *              * Update record [mmv]                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Normalizzazione saldi : effettuata  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       nor-fil-mmv-900.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Ricostruzione saldi [mmv]                       *
      *              *-------------------------------------------------*
           perform   ric-sld-mmv-000      thru ric-sld-mmv-999        .
       prn-fin-cic-999.
           exit.
      ...
      *
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Ciclo di aggiornamento scaglioni LIFO           *
      *              *-------------------------------------------------*
           move      095                  to   w-wrk-ctr-ese          .
       prn-liv-det-200.
           add       001                  to   w-wrk-ctr-ese          .
           if        w-wrk-ctr-ese        >    105
                     go to prn-liv-det-999.
      *              *-------------------------------------------------*
      *              * Aggiornamento scaglioni LIFO                    *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       agg-scg-lif-000.
      *              *-------------------------------------------------*
      *              * Determinazione anno di esercizio relativo al    *
      *              * movimento di magazzino                          *
      *              *-------------------------------------------------*
           move      rf-mmr-dat-reg       to   s-dat                  .
           move      s-saa                to   w-wrk-ctr-esx          .
           
      *
           subtract  w-wrk-ctr-esx        from w-wrk-ctr-ese
                                        giving w-wrk-ctr-esz          .
           if        w-wrk-ctr-esz        not  > zero
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "ESECOD    "         to   f-key                  .
           move      w-wrk-ctr-ese        to   rf-mmv-ann-ese         .
           move      01                   to   rf-mmv-tip-mag         .
           move      rf-mmr-num-mag       to   rf-mmv-num-mag         .
           move      "pgm/mag/fls/ioc/obj/iofmmv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           if        rf-mmr-cod-cau       =    00100
                     add   rf-mmr-qta-mov to   rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00110
                     subtract
                           rf-mmr-qta-mov from rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00200
                     subtract
                           rf-mmr-qta-mov from rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00202
                     subtract
                           rf-mmr-qta-mov from rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00205
                     subtract
                           rf-mmr-qta-mov from rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00207
                     subtract
                           rf-mmr-qta-mov from rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00210
                     add   rf-mmr-qta-mov to   rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00215
                     add   rf-mmr-qta-mov to   rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00710
                     subtract
                           rf-mmr-qta-mov from rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00720
                     add   rf-mmr-qta-mov to   rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00880
                     add   rf-mmr-qta-mov to   rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00900
                     add   rf-mmr-qta-mov to   rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else if   rf-mmr-cod-cau       =    00901
                     subtract
                           rf-mmr-qta-mov from rf-mmv-rim-pre
                                              (w-wrk-ctr-esz)
      *
           else      go to agg-scg-lif-800.
       agg-scg-lif-700.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Ricostruzione rimanenze finali [mmv]                      *
      *    *-----------------------------------------------------------*
       ric-sld-mmv-000.
      *              *-------------------------------------------------*
      *              * Visualizzazione messaggio                       *
      *              *-------------------------------------------------*
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Ricostruzione saldi   : in corso ..."
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       ric-sld-mmv-100.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Ciclo di scansione rovescia                 *
      *                  *---------------------------------------------*
           move      10                   to   w-nor-fil-mmx-inx      .
       ric-sld-mmv-420.
           subtract  1                    from w-nor-fil-mmx-inx      .
           if        w-nor-fil-mmx-inx    =    zero
                     go to ric-sld-mmv-600.
           move      w-nor-fil-mmx-inx    to   w-nor-fil-mmx-in2      .
           add       1                    to   w-nor-fil-mmx-in2      .
           add       rf-mmv-rim-pre
                    (w-nor-fil-mmx-in2)   to   rf-mmv-rim-pre
                                              (w-nor-fil-mmx-inx)     .
      *                      *-----------------------------------------*
      *                      * Riciclo                                 *
      *                      *-----------------------------------------*
           go to     ric-sld-mmv-420.
       ric-sld-mmv-600.
      *              *-------------------------------------------------*
      *              * Update record [mmv]                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Ricostruzione saldi   : effettuata  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       ric-sld-mmv-900.
