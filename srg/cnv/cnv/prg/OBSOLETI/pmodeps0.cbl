      ...
      *                                   Fase:    modeps              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 14/01/13    *
      *                       Ultima revisione:    NdK del 14/01/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Creazione file a indici per moduli EPS      *
      *                                                                *
      *                    ___ SPERIMENTALE ___ (non letto ...)        *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione codice modulo                      *
      *        *-------------------------------------------------------*
           05  w-det-cod-mod.
      *            *---------------------------------------------------*
      *            * Codice modulo                                     *
      *            *---------------------------------------------------*
               10  w-det-cod-mod-cod      pic  x(08)                  .
      ...
      *
           ...
           perform   all-str-ext-000      thru all-str-ext-999        .
      *
           move      w-all-str-cat (1)    to   w-det-cod-mod-cod      .
      *
           if        w-det-cod-mod-cod    =    spaces
                     go to acc-pth-inp-100.
       acc-pth-inp-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      ...
      *              *-------------------------------------------------*
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Numero records scritti [eps]   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       xcv-opn-fls-100.
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "cnv/cnv/fls/ioc/obj/iofeps"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
       ...
       xcv-trt-lds-400.
      *              *-------------------------------------------------*
      *              * Scrittura record [eps]                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione record [eps]                *
      *                  *---------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "cnv/cnv/fls/ioc/obj/iofeps"
                                          to   s-pat                  .
      ...
      *                      * Chiave                                  *
      *                      *-----------------------------------------*
           move      w-det-cod-mod-cod    to   rf-eps-cod-mod         .
      *                      *-----------------------------------------*
      *                      * Dati                                    *
      *                      *-----------------------------------------*
           move      w-pds-dcp            to   rf-eps-prg-rig         .
           move      w-lds-001            to   rf-eps-rig-eps         .
      *                  *---------------------------------------------*
      *                  * Scrittura record [eps]                      *
      *                  *---------------------------------------------*
           move      "PT"                 to   f-ope                  .
