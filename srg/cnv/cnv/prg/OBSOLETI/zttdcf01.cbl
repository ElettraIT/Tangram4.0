      ...
      *                                   Fase:    zttdcf              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 24/02/10    *
      *                       Ultima revisione:    NdK del 24/02/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [dcf] : zatti            *
      *                                                                *
      *                    Update per UPPERCASE indirizzo e localita'  *
      *                    anche per la ragione sociale contabile      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Uppercase Indirizzi e localita' - Zatti "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione anagrafiche fornitori       "  .
      ...
      *    *-----------------------------------------------------------*
       01  w-buf.
      *        *-------------------------------------------------------*
      *        * Bufferizzazioni fornitore principale                  *
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento anagrafica contabile              *
      *              *-------------------------------------------------*
           perform   agg-rec-fnt-000      thru agg-rec-fnt-999        .
      *              *-------------------------------------------------*
      *              * Indirizzo in uppercase                          *
      *              *-------------------------------------------------*
           move      rf-dcf-via-dcf       to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   rf-dcf-via-dcf         .
      *              *-------------------------------------------------*
      *              * Localita' in uppercase                          *
      *              *-------------------------------------------------*
           move      rf-dcf-loc-dcf       to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   rf-dcf-loc-dcf         .
       prn-liv-det-700.
      *              *-------------------------------------------------*
      *              * Update record [dcf]                             *
      *              *-------------------------------------------------*
      ...
      *              * Indirizzo in uppercase                          *
      *              *-------------------------------------------------*
           move      rf-fnt-via-fnt       to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   rf-fnt-via-fnt         .
      *              *-------------------------------------------------*
      *              * Localita' in uppercase                          *
      *              *-------------------------------------------------*
           move      rf-fnt-loc-fnt       to   w-upp-des              .
           perform   trf-des-upp-000      thru trf-des-upp-999        .
           move      w-upp-des            to   rf-fnt-loc-fnt         .
       agg-rec-fnt-400.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
