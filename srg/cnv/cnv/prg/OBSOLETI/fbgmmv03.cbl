      ...
      *                       Ultima revisione:    NdK del 08/03/05    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Rilettura saldo valore al 31/12/95          *
      *                                                                *
      *                    Richiesto da Mirco (08/03/05)               *
      *                                                                *
      *                    ___ MAI USATO ___                           *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       agg-rec-mmv-000.
      *              *-------------------------------------------------*
      *              * Determinazione costo medio ponderato 31/12/95   *
      *              *-------------------------------------------------*
           move      "VM"                 to   d-vun-mag-tip-ope      .
           move      0001                 to   d-vun-mag-tip-val      .
           move      0951231              to   d-vun-mag-dat-val      .
           move      01                   to   d-vun-mag-tip-mag      .
           move      srt-num-mag          to   d-vun-mag-num-mag      .
      *              *-------------------------------------------------*
