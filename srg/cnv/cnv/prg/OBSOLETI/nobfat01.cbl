      ...
      *                                   Fase:    nobfat              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/10/17    *
      *                       Ultima revisione:    NdK del 17/10/17    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento files [fit] e [fir] : NOBILI  *
      *                                                                *
      *                    Sostituzione Cliente da 6903 a 6026         *
      *                                                                *
      *================================================================*
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Aggiornamento fatture - Cliente 6903    "  .
      ...
      *              *-------------------------------------------------*
           ...
           move      1170101              to   rf-fir-dat-doc         .
      ...
      *              *-------------------------------------------------*
           if        rf-fir-dat-doc       not  > 1170101
                     go to prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Test su codice cliente                          *
      *              *-------------------------------------------------*
           if        rf-fir-cod-cli       not  = 0006903
                     go to prn-liv-det-900.
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        f-sts                not  = e-not-err
                     go to prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Modifica cliente [fit]                          *
      *              *-------------------------------------------------*
           move      0006026              to   rf-fit-cod-cli         .
           move      0006026              to   rf-fit-cli-plf         .
      *              *-------------------------------------------------*
      *              * Force Put record                                *
      *              *-------------------------------------------------*
           move      "FP"                 to   f-ope                  .
       ...
       prn-liv-det-600.
      *              *-------------------------------------------------*
      *              * Modifica cliente [fir]                          *
      *              *-------------------------------------------------*
           move      0006026              to   rf-fir-cod-cli         .
           move      0006026              to   rf-fir-cli-pls         .
      *              *-------------------------------------------------*
      *              * Update record [fir]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
