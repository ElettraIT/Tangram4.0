      ...
      *                                   Fase:    agvbir              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 18/09/01    *
      *                       Ultima revisione:    NdK del 18/09/01    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sistemazione rif. ordine righe - AGAVI      *
      *                    solo Cavet                                  *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           if        rf-bir-cod-arc       not  = 0000263
                     go to prn-liv-det-300.
           if        rf-bir-fat-num       not  = zero
                     go to prn-liv-det-300.
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Conversione codice dipendenza cliente           *
      *              *-------------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      04                   to   v-car                  .
           move      rf-bir-dpz-arc       to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           move      v-num                to   w-det-num-pro-num      .
           multiply  10000000             by   w-det-num-pro-num      .
           add       w-det-num-pro-num    to   rf-bir-coc-prt         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [bir]                             *
      *              *-------------------------------------------------*
