      ...
      *                                   Fase:    srchfm              *
      *                    ------------------------------------------- *
      *                       Versione attuale:    001 del 16/11/98    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [hfm] : Serco            *
      *                                                                *
      *                    Update formulari per numero partita         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Aggiornamento formulari - Ser.co.   "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Conversione di Aggiornamento formulari  "  .
      ...
      *        *-------------------------------------------------------*
      *        * Comodo per ridefinizione numero formulario            *
      *        *-------------------------------------------------------*
           05  w-wrk-num-fma              pic  x(10)                  .
           05  w-wrk-num-fms              pic  x(10)                  .
           05  w-wrk-num-fml              pic  9(09)                  .
           05  w-wrk-num-fml-r  redefines
               w-wrk-num-fml.
               10  w-wrk-num-fml-saa      pic  9(03)                  .
               10  w-wrk-num-fml-prg      pic  9(06)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [hrg]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhrg"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione numero di comodo                *
      *              *-------------------------------------------------*
           move      zero                 to   w-wrk-num-fml          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Test su numero formulario                       *
      *              *-------------------------------------------------*
           if        rf-hrg-num-fml       not  = spaces
      ...
      *                  *---------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      spaces               to   m-msg                  .
           string    "Partita / Registro : "
                                delimited by   size
                     p-edt      delimited by   spaces
                     " senza numero formulario."
                                delimited by   size
                                          into m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-150.
      *              *-------------------------------------------------*
      *              * Sostituzione di eventuali punti con barra       *
      *              *-------------------------------------------------*
           inspect   rf-hrg-num-fml   replacing  all  "."
                                                 by   "/"             .
           inspect   rf-hrg-num-fml   replacing  all  ","
                                                 by   "/"             .
           inspect   rf-hrg-num-fml   replacing  all  ";"
           ...
           inspect   rf-hrg-num-fml   replacing  all  ":"
                                                 by   "/"             .
      *              *-------------------------------------------------*
      *              * Test che esista la barra di separazione         *
      *              *-------------------------------------------------*
           move      zero                 to   w-wrk-ctr-002          .
           inspect   rf-hrg-num-fml
                                      tallying w-wrk-ctr-002
                     for    all "/"                                   .
           if        w-wrk-ctr-002        =    zero
                     go to prn-liv-det-220
           else if   w-wrk-ctr-002        =    1
                     go to prn-liv-det-200
           else      go to prn-liv-det-240.
       prn-liv-det-200.
      *                  *---------------------------------------------*
      *                  * Se esiste la barra di separazione           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Estrazione del numero formulario e del  *
      *                      * secolo/anno                             *
      *                      *-----------------------------------------*
           move      zero                 to   w-wrk-ctr-002          .
           move      spaces               to   w-wrk-num-fma          .
           unstring  rf-hrg-num-fml
                                delimited by "/"
                                          into w-wrk-num-fma
                                    count in   w-wrk-ctr-002          .
           add       2                    to   w-wrk-ctr-002          .
           move      spaces               to   w-wrk-num-fms          .
           unstring  rf-hrg-num-fml       into w-wrk-num-fms
                                  with pointer w-wrk-ctr-002          .
      *                      *-----------------------------------------*
      *                      * Conversione                             *
      *                      *-----------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      10                   to   v-car                  .
           move      w-wrk-num-fma        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-wrk-num-fml-prg      .
      *                      *-----------------------------------------*
      *                      * Test su valore convertito               *
      *                      *-----------------------------------------*
           if        w-wrk-num-fml-prg    not  = zero
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-210.
      *                      *-----------------------------------------*
      *                      * Conversione secolo anno                 *
      *                      *-----------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      10                   to   v-car                  .
           move      w-wrk-num-fms        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-wrk-num-fml-saa      .
      *                      *-----------------------------------------*
      *                      * Test su valore convertito               *
      *                      *-----------------------------------------*
           if        w-wrk-num-fml-saa    not  = zero
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-220.
      *                  *---------------------------------------------*
      *                  * Se non esiste la barra di separazione       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Conversione                             *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-230.
      *                  *---------------------------------------------*
      *                  * Completamento con secolo anno               *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Completamento                           *
      *                      *-----------------------------------------*
           move      rf-hrg-prg-mov
                    (1 : 3)               to   w-wrk-num-fml-saa      .
      *                      *-----------------------------------------*
      *                      * Ad aggiornamento                        *
      *                      *-----------------------------------------*
           go to     prn-liv-det-500.
       prn-liv-det-240.
      *                  *---------------------------------------------*
      *                  * Se esiste piu' di una barra di separazione  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Editing progressivo                     *
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Scrittura record [hfm]                                    *
      *    *-----------------------------------------------------------*
       agg-rec-hfm-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione record [hfm]                    *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhfm"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "PRGMOV    "         to   f-key                  .
           move      w-wrk-num-fml        to   rf-hfm-prg-mov         .
           move      "sec/tns/fls/ioc/obj/iofhfm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to agg-rec-hfm-800.
      *              *-------------------------------------------------*
      *              * Aggiornamento record [hap]                      *
      *              *-------------------------------------------------*
           move      rf-hrg-prg-mov       to   rf-hfm-num-bac         .
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
