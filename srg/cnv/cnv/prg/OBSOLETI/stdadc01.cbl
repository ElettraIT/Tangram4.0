      ...
      *                                   Fase:    stdadc              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 18/10/10    *
      *                       Ultima revisione:    NdK del 18/10/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [adc] Standard           *
      *                                                                *
      *                    Update per clonazione indirizzi mail per le *
      *                    fatture PDF da anagrafiche commerciali dei  *
      *                    clienti a indirizzi mail per invio ordini   *
      *                                                                *
      *                    N.B.: salvare [adc] !!!                     *
      *                                                                *
      *================================================================*
      ...
      *            * Interlocutore                                     *
      *            *---------------------------------------------------*
               10  srt-int-con            pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Numero utenza                                     *
      *            *---------------------------------------------------*
               10  srt-num-con            pic  x(80)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Aggiornamento indirizzi e-mail clienti "       .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Clonazione indirizzi e-mail clienti     "  .
      ...
      *                  *---------------------------------------------*
           if        rf-adc-tip-con       not  = "EML"
                     go to stp-srt-inp-adc-200.
      *                  *---------------------------------------------*
      *                  * Test se indirizzo e-mail per la spedizione  *
      *                  * fatture PDF                                 *
      *                  *---------------------------------------------*
           if        rf-adc-int-con
                    (01 : 04)             not  = "<fat"
      ...
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
           move      rf-adc-int-con       to   srt-int-con            .
           move      rf-adc-num-con       to   srt-num-con            .
       stp-srt-inp-adc-700.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Determinazione progressivo                      *
      *              *-------------------------------------------------*
           move      srt-cod-arc          to   w-det-prg-adc-arc      .
           perform   det-prg-adc-000      thru det-prg-adc-999        .
           if        w-det-prg-adc-prg    =    zero
      ...
      *              *-------------------------------------------------*
           move      w-det-prg-adc-prg    to   rf-adc-num-prg         .
      *              *-------------------------------------------------*
      *              * Email per ordini                                *
      *              *-------------------------------------------------*
           move      srt-int-con          to   rf-adc-int-con         .
      *
           move      "ord"                to   rf-adc-int-con
                                              (02 : 03)               .
      *
           move      srt-num-con          to   rf-adc-num-con         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Determinazione del progressivo utenza cliente commerciale *
      *    *-----------------------------------------------------------*
       det-prg-adc-000.
      *              *-------------------------------------------------*
