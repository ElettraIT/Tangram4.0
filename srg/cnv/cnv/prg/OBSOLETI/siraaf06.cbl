      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Normalizzazione decimali acquisti e         *
      *                    legame valutario [aaf] e [aaq]              *
      *                                                                *
      *                    SIRI                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Azzeramento decimali e legame - SIRI  "       .
       ...
       01  w-tab.
           05  w-tab-pae.
               10  w-tab-pae-tbl.
                   ...
                   15  filler             pic  x(12) value
                    "FIM005945730"                                    .
               10  w-tab-pae-tbr redefines
                   w-tab-pae-tbl.
                   15  w-tab-pae-ele occurs 10
                                 indexed  by   w-tab-pae-inx          .
                       20  w-tab-pae-cod  pic  x(03)                  .
                       20  w-tab-pae-cdc  pic  9(03)v9(06)            .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/siri/aaf"  to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/siri/aaf.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/siri/aaq"  to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/siri/aaq.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *                  *---------------------------------------------*
      *                  * Normalizzazione prezzo acquisto riferimento *
      *                  *---------------------------------------------*
           if        rf-aaq-dec-prz       =    2
                     divide   100         into rf-aaq-prz-acr
                                               rounded                .
      *                  *---------------------------------------------*
      *                  * Normalizzazione decimali prezzo acquisto    *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-aaf-sgl-vlt       not  = "EUR"
                     go to prn-liv-det-400.
      *                  *---------------------------------------------*
      *                  * Test su legame valutario                    *
      *                  *---------------------------------------------*
