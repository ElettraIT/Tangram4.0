      ...
      *                                   Fase:    fermms              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/01/01    *
      *                       Ultima revisione:    NdK del 03/02/07    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [mms] : Ferr.It.         *
      *                                                                *
      *                    Update saldi magazzino per 51               *
      *                                                                *
      *                    N.B.: Serve ad azzerare, dopo l'inventario, *
      *                          il saldo iniziale del 51. Ricordarsi  *
      *                          di fare attenzione al secolo/anno.    *
      *                                                                *
      *                          (indicare quello nuovo)               *
      *                                                                *
      *                          SOLO A INVENTARIO CHIUSO !            *
      *                                                                *
      *                          Eseguito : esercizio 2000 (23/01/01)  *
      *                                     esercizio 2001 (10/01/02)  *
      *                                     esercizio 2002 (15/01/03)  *
      *                                     esercizio 2003 (26/01/04)  *
      *                                     esercizio 2004 (21/01/05)  *
      *                                     esercizio 2005 (01/02/06)  *
      *                                     esercizio 2006 (02/02/07)  *
      *                                                                *
      *                    Dal 2007 Graziella e' autonoma con          *
      *                    l'accettazione dell'anno                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Aggiornamento magazzino - Ferramenta  "       .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "fer/fab/fls/ioc/obj/iofhms"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-ann-dic           to   rf-mms-ann-ese         .
           move      51                   to   rf-mms-cod-dpz         .
      ...
      *              *-------------------------------------------------*
           if        rf-mms-ann-ese       not  = rr-ann-dic
                     go to prn-tst-max-900.
       prn-tst-max-200.
      *              *-------------------------------------------------*
      *              * Test su codice dipendenza                       *
      *              *-------------------------------------------------*
           if        rf-mms-cod-dpz       not  = 51
                     go to prn-tst-max-900.
       prn-tst-max-300.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      s-pat               using f
                                               rf-hms                 .
      *                      *-----------------------------------------*
      *                      * Lettura record [hms] con lock           *
      *                      *-----------------------------------------*
           move      "GT"                 to   f-ope                  .
           move      "DPMGDS    "         to   f-key                  .
           move      rf-mms-ann-ese       to   rf-hms-ann-ese         .
           move      rf-mms-cod-dpz       to   rf-hms-cod-dpz         .
           move      rf-mms-tip-mag       to   rf-hms-tip-mag         .
           move      rf-mms-num-mag       to   rf-hms-num-mag         .
           move      rf-mms-var-mag       to   rf-hms-var-mag         .
           move      rf-mms-cod-dsl       to   rf-hms-cod-dsl         .
           move      "fer/fab/fls/ioc/obj/iofhms"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Aggiornamento quantita' iniziale    *
      *                          *-------------------------------------*
           move      rf-mms-qta-ini       to   rf-hms-qta-ini         .
       prn-liv-det-800.
      *              *-------------------------------------------------*
      *              * Aggiornamento quantita' inizio anno             *
      *              *-------------------------------------------------*
