      ...
      *                                   Fase:    zttbit              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 22/11/97    *
      *                       Ultima revisione:    NdK del 05/02/04    *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [bit] : Mecom            *
      *                                                                *
      *                    __________ MAI USATO _____                  *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      1030101              to   rf-mmt-dat-reg         .
      ...
      *              *-------------------------------------------------*
           ...
           move      "<B"                 to   v-edm                  .
           move      rf-bit-pag-act       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   rf-bit-alx-exp         .
      *
