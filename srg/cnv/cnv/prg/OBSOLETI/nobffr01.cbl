      ...
      *                       Ultima revisione:    NdK del 17/10/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Correzione di una riga fattura - NOBILI     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Correzione riga fattura : NOBILI    "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      11801000944          to   rf-ffr-num-prt         .
      ...
      *              * Test su protocollo                              *
      *              *-------------------------------------------------*
           if        rf-ffr-num-prt       not  = 11801000944
                     go to prn-liv-det-320.
      *              *-------------------------------------------------*
      *              * Test su progressivo                             *
      *              *-------------------------------------------------*
           if        rf-ffr-num-prg       not  = 00200
                     go to prn-liv-det-320.
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Lotto                                           *
      *              *-------------------------------------------------*
           move      "2122280103"         to   rf-ffr-lot-sgl         .
           move      "Cagliata 45%"       to   rf-ffr-des-rig         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Update record [ffr]                             *
      *              *-------------------------------------------------*
