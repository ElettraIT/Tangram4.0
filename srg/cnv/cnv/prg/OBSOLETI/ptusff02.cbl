      ...
      *                    fornitori                                   *
      *                                                                *
      *                    Correzione data registrazione scadenze      *
      *                                                                *
      *                    PERONTECNICI                                *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Numero prima scadenza                             *
      *            *---------------------------------------------------*
               10  srt-npr-scf            pic  9(11)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      1180228              to   rf-sff-ide-dat         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-sff-npr-scf       to   srt-npr-scf            .
       stp-srt-inp-sff-700.
      *                  *---------------------------------------------*
      ...
      *              * Aggiornamenti                                   *
      *              *-------------------------------------------------*
           perform   agg-rec-sfs-000      thru agg-rec-sfs-999        .
      *              *-------------------------------------------------*
      *              * Editing protocollo                              *
      *              *-------------------------------------------------*
           move      "ED"                 to   p-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-npr-scf          to   rf-sfs-num-scf         .
           move      "pgm/scf/fls/ioc/obj/iofsfs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Data registrazione                          *
      *                  *---------------------------------------------*
           move      1180228              to   rf-sfs-dtr-rgs         .
       agg-rec-sfs-400.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
