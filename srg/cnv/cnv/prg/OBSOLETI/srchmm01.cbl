      ...
      *                       Ultima revisione:    NdK del 20/04/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [hmm] : Serco            *
      *                                                                *
      *                    Update movimenti per status proprieta'      *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
      *              * Start su archivio [hmm]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATNUM    "         to   f-key                  .
           move      zero                 to   rf-hmm-dat-mov         .
           move      zero                 to   rf-hmm-num-mov         .
           move      "sec/tns/fls/ioc/obj/iofhmm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [hmm]              *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhmm"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      09                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      rf-hmm-num-mov       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Aggiornamento status di proprieta'              *
      *              *-------------------------------------------------*
           move      "N"                  to   rf-hmm-sts-prp         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [hmm]                             *
      *              *-------------------------------------------------*
