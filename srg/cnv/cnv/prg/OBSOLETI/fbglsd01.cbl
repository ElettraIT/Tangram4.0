      ...
      *                                   Fase:    fbglsd              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 09/07/03    *
      *                       Ultima revisione:    NdK del 09/07/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento storico per fornitori 159/160 *
      *                                                                *
      *                    Foralberg                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    Aggiornamento Storico 159 e 160     "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-lsd-num-pro       to   rf-dcp-num-pro         .
           move      "pgm/dcp/fls/ioc/obj/iofdcp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-440.
      *                  *---------------------------------------------*
      *                  * Selezione su date campagna                  *
      *                  *---------------------------------------------*
           if        rf-lsd-dva-ini       =    1030101 or
                     rf-lsd-dva-ini       =    1030601 or
                     rf-lsd-dva-ini       =    1030701
                     go to stp-srt-inp-460
           else      go to stp-srt-inp-200.
       stp-srt-inp-460.
           if        rf-lsd-dva-fin       =    1030630 or
                     rf-lsd-dva-fin       =    1031231
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fbg/lsd"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fbg/lsd.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              * Ripristino [lsd]                                *
      *              *-------------------------------------------------*
           move      w-wrk-sav-lsd        to   rf-lsd                 .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Combinazioni                                    *
      *              *-------------------------------------------------*
           if        rf-lsd-dva-ini       =    1030101 and
                     rf-lsd-dva-fin       =    1030630
                     go to prn-liv-det-110
           else if   rf-lsd-dva-ini       =    1030601 and
                     rf-lsd-dva-fin       =    1030630
                     go to prn-liv-det-120
           else if   rf-lsd-dva-ini       =    1030601 and
                     rf-lsd-dva-fin       =    1031231
                     go to prn-liv-det-130
           else if   rf-lsd-dva-ini       =    1030701 and
                     rf-lsd-dva-fin       =    1031231
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Aggiornamento data finale                   *
      *                  *---------------------------------------------*
           move      1030531              to   rf-lsd-dva-fin         .
      *                  *---------------------------------------------*
      *                  * Aggiornamento data finale in reverse        *
      *                  *---------------------------------------------*
      ...
      *                  * Aggiornamento data finale                   *
      *                  *---------------------------------------------*
           move      1030630              to   rf-lsd-dva-fin         .
      *                  *---------------------------------------------*
      *                  * Aggiornamento data finale in reverse        *
      *                  *---------------------------------------------*
           move      99999999             to   rf-lsd-dvf-rev         .
      ...
      *                  *---------------------------------------------*
           move      1030601              to   rf-lsd-dva-ini         .
      *                  *---------------------------------------------*
      *                  * Aggiornamento data finale                   *
      *                  *---------------------------------------------*
           move      1030630              to   rf-lsd-dva-fin         .
