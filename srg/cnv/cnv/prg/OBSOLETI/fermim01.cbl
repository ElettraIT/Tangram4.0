      ...
      *                                   Fase:    fermim              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 15/01/03    *
      *                       Ultima revisione:    NdK del 15/01/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Giroconto per inventario 51 --> 01          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
               ...
               10  srt-num-mag            pic  9(07)       comp-3     .
               10  srt-var-mag            pic  x(14)                  .
               10  srt-tip-gia            pic  9(02)                  .
      ...
      *        *-------------------------------------------------------*
           05  srt-dat.
               10  srt-qta-prs            pic s9(08)v9(03) comp-3     .
               10  srt-qta-rlv            pic s9(08)v9(03) comp-3     .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    GIROCONTO GIACENZE PER INVENTARIO   "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per trattamento quantita' Sede                        *
      *        *-------------------------------------------------------*
           05  w-det-qta-sed.
               10  w-det-qta-sed-prs      pic s9(08)v9(03)            .
               10  w-det-qta-sed-ril      pic s9(08)v9(03)            .
               10  w-det-qta-sed-flg      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Per trattamento quantita' Dipendenza                  *
      *        *-------------------------------------------------------*
           05  w-det-qta-dpz.
               10  w-det-qta-dpz-prs      pic s9(08)v9(03)            .
               10  w-det-qta-dpz-ril      pic s9(08)v9(03)            .
               10  w-det-qta-dpz-flg      pic  x(01)                  .
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      rf-mim-cod-dpz       to   srt-cod-dpz            .
           move      rf-mim-tip-mag       to   srt-tip-mag            .
           move      rf-mim-num-mag       to   srt-num-mag            .
           move      rf-mim-var-mag       to   srt-var-mag            .
           move      rf-mim-tip-gia       to   srt-tip-gia            .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun prodotto da aggiornare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fer/mim"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/fer/mim.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *
           move      "WR"                 to   m-ope                  .
           move      "... non scherzare con gli astri ..."
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
      *
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-010.
      *              *-------------------------------------------------*
      *              * Lettura corrispondenti valori Sede              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-num-mag          to   rf-mim-num-mag         .
           move      srt-var-mag          to   rf-mim-var-mag         .
           move      srt-tip-gia          to   rf-mim-tip-gia         .
           move      srt-tip-arc          to   rf-mim-tip-arc         .
           move      srt-cod-arc          to   rf-mim-cod-arc         .
           move      srt-dpz-arc          to   rf-mim-dpz-arc         .
           move      srt-cod-mic          to   rf-mim-cod-mic         .
           move      "pgm/mag/fls/ioc/obj/iofmim"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      rf-mim-qta-prs       to   w-det-qta-sed-prs      .
           move      rf-mim-qta-rlv       to   w-det-qta-sed-ril      .
           move      rf-mim-flg-ril       to   w-det-qta-sed-flg      .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Preparazione dati Sede                          *
      *              *-------------------------------------------------*
           move      w-det-qta-sed-prs    to   w-det-qta-sed-ril      .
           add       srt-qta-prs          to   w-det-qta-sed-ril      .
           if        w-det-qta-sed-ril    <    zero
                     move  zero           to   w-det-qta-sed-ril      .
           move      "#"                  to   w-det-qta-sed-flg      .
      *              *-------------------------------------------------*
      *              * Preparazione dati Dipendenza                    *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-qta-dpz-ril      .
           move      "#"                  to   w-det-qta-dpz-flg      .
       prn-liv-det-600.
      *              *-------------------------------------------------*
      *              * Aggiornamenti                                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Aggiornamento [mim] per la Sede             *
      *                  *---------------------------------------------*
           perform   upd-rec-mim-sed-000  thru upd-rec-mim-sed-999    .
      *                  *---------------------------------------------*
      *                  * Aggiornamento [mim] per la Dipendenza       *
      *                  *---------------------------------------------*
           perform   upd-rec-mim-dpz-000  thru upd-rec-mim-dpz-999    .
       prn-liv-det-800.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Aggiornamento record [mim] per la Sede                    *
      *    *-----------------------------------------------------------*
       upd-rec-mim-sed-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        f-sts                =    e-not-err
                     go to upd-rec-mim-sed-250.
       upd-rec-mim-sed-200.
      *              *-------------------------------------------------*
      *              * Se record [mim] non esistente                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     upd-rec-mim-sed-900.
       upd-rec-mim-sed-250.
      *              *-------------------------------------------------*
      *              * Se record [mim] esistente                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Aggiornamento                               *
      *                  *---------------------------------------------*
           move      w-det-qta-sed-ril    to   rf-mim-qta-rlv         .
           move      w-det-qta-sed-flg    to   rf-mim-flg-ril         .
       upd-rec-mim-sed-400.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     upd-rec-mim-sed-999.
       upd-rec-mim-sed-999.
           exit.

      *    *===========================================================*
      *    * Aggiornamento record [mim] per la Dipendenza              *
      *    *-----------------------------------------------------------*
       upd-rec-mim-dpz-000.
      *              *-------------------------------------------------*
      *              * Lettura, con lock, del record                   *
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "MAGTGC    "         to   f-key                  .
           move      srt-cod-dpz          to   rf-mim-cod-dpz         .
           move      01                   to   rf-mim-tip-mag         .
           move      srt-num-mag          to   rf-mim-num-mag         .
           move      srt-var-mag          to   rf-mim-var-mag         .
           move      srt-tip-gia          to   rf-mim-tip-gia         .
      ...
      *                  * Aggiornamento                               *
      *                  *---------------------------------------------*
           move      w-det-qta-dpz-ril    to   rf-mim-qta-rlv         .
           move      w-det-qta-dpz-flg    to   rf-mim-flg-ril         .
       upd-rec-mim-dpz-400.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
