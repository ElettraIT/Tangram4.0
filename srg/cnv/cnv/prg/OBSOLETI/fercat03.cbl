      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test su codice aggiuntivo 2 che ospita  *
      *                      * la posizione nella pagina               *
      *                      *-----------------------------------------*
           if        w-let-arc-hct-ag2    =    zero
                     go to prn-liv-det-800.
      *                      *-----------------------------------------*
      *                      * Editing codice aggiuntivo 2 che ospita  *
      *                      * la posizione nella pagina               *
      *                      *-----------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-let-arc-hct-ag2    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      p-edt                to   rf-dcp-rfl-lst         .
      *                  *---------------------------------------------*
      *                  * Allineamento a dx.                          *
      *                  *---------------------------------------------*
           move      12                   to   w-all-str-lun          .
           move      rf-dcp-rfl-lst       to   w-all-str-alf          .
           perform   all-str-adx-000      thru all-str-adx-999        .
           move      w-all-str-alf        to   rf-dcp-rfl-lst         .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      spaces               to   m-msg                  .
           string    "Aggiornato Codice : "
                                delimited by   size
                     rf-dcp-alf-pro
                                delimited by   spaces
                     " per ordinatore supplementare"
                                delimited by   size
                                          into m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
