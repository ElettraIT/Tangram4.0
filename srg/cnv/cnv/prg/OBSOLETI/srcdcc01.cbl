      ...
      *                                   Fase:    aggdcc              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 03/06/03    *
      *                       Ultima revisione:    NdK del 03/06/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [dcc]                    *
      *                                                                *
      *                    Update per ricodifica clienti SERCO         *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
      *            * Flag record [dcc] letto                           *
      *            *---------------------------------------------------*
               10  srt-flg-dcc            pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " Riclassificazione clienti - Ecoveneta  "       .
      ...
      *        * [hrg]                                                 *
      *        *-------------------------------------------------------*
           copy      "sec/tns/fls/rec/rfhrg"                          .
      *        *-------------------------------------------------------*
      *        * [hru]                                                 *
      *        *-------------------------------------------------------*
           copy      "sec/tns/fls/rec/rfhru"                          .
      *        *-------------------------------------------------------*
      *        * [hfm]                                                 *
      *        *-------------------------------------------------------*
           copy      "sec/tns/fls/rec/rfhfm"                          .
      *        *-------------------------------------------------------*
      *        * [hpx]                                                 *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione castelletto utenze                 *
      *        *-------------------------------------------------------*
           05  w-det-cst-utz.
               10  w-det-cst-utz-ctr      pic  9(07)                  .
               10  w-det-cst-utz-ele      pic  9(07)                  .
               10  w-det-cst-utz-max      pic  9(07) value 3300       .
               10  w-det-cst-utz-sav.
                   15  filler occurs 512  pic  x(01)                  .
               10  w-det-cst-utz-cst occurs 3300.
                   15  w-det-cst-utz-tip  pic  9(02)                  .
                   15  w-det-cst-utz-cod  pic  9(07)                  .
                   15  w-det-cst-utz-dpz  pic  x(04)                  .
                   15  w-det-cst-utz-prg  pic  9(05)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-det-cmp-fin-cmp          pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Work per progressivo quantita'                        *
      *        *-------------------------------------------------------*
           05  w-det-cmp-fin-wpq          pic s9(11)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Work per progressivo valore                           *
      *        *-------------------------------------------------------*
           05  w-det-cmp-fin-wpv          pic s9(13)                  .
      *        *-------------------------------------------------------*
      *        * Work per determinazione costo standard                *
      *        *-------------------------------------------------------*
           05  w-det-cmp-fin-wcs          pic  9(11)v9(02)            .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-ctl.
      *        *-------------------------------------------------------*
      *        * Work per Ctl su utenza                                *
      *        *-------------------------------------------------------*
           05  w-ctl-fax.
               10  w-ctl-utz-num-flg      pic  x(01)                  .
               10  w-ctl-utz-num-num      pic  x(20)                  .
               10  w-ctl-utz-num-pre      pic  x(05)                  .
               10  w-ctl-utz-num-utz      pic  x(15)                  .
               10  w-ctl-utz-num-str.
                   15  w-ctl-utz-num-chr  occurs 20
                                          pic  x(01)                  .
               10  w-ctl-utz-num-ctr      pic  9(03)                  .
      ...
      *        * Flag generico                                         *
      *        *-------------------------------------------------------*
           05  w-wrk-flg-001              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Contatori generici                                    *
      *        *-------------------------------------------------------*
           05  w-wrk-ctr-001              pic  9(06)                  .
           05  w-wrk-cod-cli              pic  9(07)                  .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/cli"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/cli.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/dcc"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/dcc.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hrg"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hrg.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hru"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hru.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hfm"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hfm.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hpx"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hpx.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hoc"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hoc.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hcf"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/azi/eco/hcf.sav"
                                          to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhrg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhru"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhfm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhcf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *
           if        f-sts                =    e-not-err
                     move  spaces         to   w-wrk-flg-001
           else      move  "#"            to   w-wrk-flg-001          .
       stp-srt-inp-cli-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dcc               to   srt-rec-dcc            .
           move      w-wrk-flg-001        to   srt-flg-dcc            .
       stp-srt-inp-cli-700.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-wrk-ctr-001          .
      *              *-------------------------------------------------*
      *              * Normalizzazione del nuovo codice                *
      *              *-------------------------------------------------*
           move      0050000              to   w-wrk-cod-cli          .
       prn-ini-cic-999.
           exit.
      ...
      *              * Aggiornamento [hrg]                             *
      *              *-------------------------------------------------*
           perform   agg-rec-hrg-000      thru agg-rec-hrg-999        .
      *              *-------------------------------------------------*
      *              * Aggiornamento [hru]                             *
      *              *-------------------------------------------------*
           perform   agg-rec-hru-000      thru agg-rec-hru-999        .
      *              *-------------------------------------------------*
      *              * Aggiornamento [hfm]                             *
      *              *-------------------------------------------------*
           perform   agg-rec-hfm-000      thru agg-rec-hfm-999        .
      *              *-------------------------------------------------*
      *              * Aggiornamento [hpx]                             *
      *              *-------------------------------------------------*
           perform   agg-rec-hpx-000      thru agg-rec-hpx-999        .
      *              *-------------------------------------------------*
      *              * Aggiornamento [hoc]                             *
      *              *-------------------------------------------------*
           perform   agg-rec-hoc-000      thru agg-rec-hoc-999        .
      *              *-------------------------------------------------*
      *              * Aggiornamento [hcf]                             *
      *              *-------------------------------------------------*
           perform   agg-rec-hcf-000      thru agg-rec-hcf-999        .
      *              *-------------------------------------------------*
      *              * Aggiornamento [adc] utenze                      *
      *              *-------------------------------------------------*
           perform   agg-rec-adc-000      thru agg-rec-adc-999        .
      *              *-------------------------------------------------*
      *              * Editing contatore                               *
      *              *-------------------------------------------------*
           move      "ED"                 to   p-ope                  .
      ...
      *                  * Area chiave                                 *
      *                  *---------------------------------------------*
           move      w-rot-l01-cod-cli    to   kk0-cod-cli            .
      *                  *---------------------------------------------*
      *                  * Area dati                                   *
      *                  *---------------------------------------------*
           move      w-wrk-cod-cli        to   kk0-new-cli            .
      *                  *---------------------------------------------*
      *                  * Scrittura                                   *
      *                  *---------------------------------------------*
           write     kk0-rec                                          .
      ...
      *              * Aggiornamento [cli]                             *
      *              *-------------------------------------------------*
           perform   agg-rec-cli-000      thru agg-rec-cli-999        .
      *              *-------------------------------------------------*
      *              * Aggiornamento [dcc]                             *
      *              *-------------------------------------------------*
           perform   agg-rec-dcc-000      thru agg-rec-dcc-999        .
      *              *-------------------------------------------------*
      *              * Aggiornamento [dcc] - dipendenza 1              *
      *              *-------------------------------------------------*
           perform   agg-rec-dp1-000      thru agg-rec-dp1-999        .
      *              *-------------------------------------------------*
      *              * Aggiornamento [dcc] - dipendenza 2              *
      *              *-------------------------------------------------*
           perform   agg-rec-dp2-000      thru agg-rec-dp2-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Aggiornamento record [cli]                                *
      *    *-----------------------------------------------------------*
       agg-rec-cli-000.
      *              *-------------------------------------------------*
      *              * Assegnazione del nuovo codice                   *
      *              *-------------------------------------------------*
           add       1                    to   w-wrk-cod-cli          .
       agg-rec-cli-100.
      *              *-------------------------------------------------*
      *              * Delete record [cli] vecchio                     *
      *              *-------------------------------------------------*
           perform   del-rec-cli-000      thru del-rec-cli-999        .
      *              *-------------------------------------------------*
      *              * Scrittura record [cli] nuovo                    *
      *              *-------------------------------------------------*
      ...
      *              * Nuovo codice                                    *
      *              *-------------------------------------------------*
           move      w-wrk-cod-cli        to   rf-cli-cod-cli         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Aggiornamento record [dcc]                                *
      *    *-----------------------------------------------------------*
       agg-rec-dcc-000.
      *              *-------------------------------------------------*
      *              * Test se esistente                               *
      *              *-------------------------------------------------*
           if        srt-flg-dcc          not  = spaces
                     go to agg-rec-dcc-999.
       agg-rec-dcc-100.
      *              *-------------------------------------------------*
      *              * Delete record [dcc] vecchio                     *
      *              *-------------------------------------------------*
           perform   del-rec-dcc-000      thru del-rec-dcc-999        .
      *              *-------------------------------------------------*
      *              * Scrittura record [dcc] nuovo                    *
      *              *-------------------------------------------------*
      ...
      *              * Nuovo codice                                    *
      *              *-------------------------------------------------*
           move      w-wrk-cod-cli        to   rf-dcc-cod-cli         .
      *              *-------------------------------------------------*
      *              * Nuovo pagamento                                 *
      *              *-------------------------------------------------*
           if        rf-dcc-cod-fop       =    0000013
                     move  0000001        to   rf-dcc-cod-fop
           else if   rf-dcc-cod-fop       =    0000004
                     move  0000002        to   rf-dcc-cod-fop
           else if   rf-dcc-cod-fop       =    0000012
                     move  0000003        to   rf-dcc-cod-fop
           else if   rf-dcc-cod-fop       =    0000026
                     move  0000007        to   rf-dcc-cod-fop
           else if   rf-dcc-cod-fop       =    0000016
                     move  0000021        to   rf-dcc-cod-fop
           else if   rf-dcc-cod-fop       =    0000010
                     move  0000022        to   rf-dcc-cod-fop
           else if   rf-dcc-cod-fop       =    0000014
                     move  0000023        to   rf-dcc-cod-fop
           else if   rf-dcc-cod-fop       =    0000030
                     move  0000026        to   rf-dcc-cod-fop
           else if   rf-dcc-cod-fop       =    0000011
                     move  0000031        to   rf-dcc-cod-fop
           else if   rf-dcc-cod-fop       =    0000031
                     move  0000033        to   rf-dcc-cod-fop
           else      move  zero           to   rf-dcc-cod-fop         .
      *              *-------------------------------------------------*
      *              * Editing vecchio codice                          *
      *              *-------------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      07                   to   p-car                  .
      ...
      *    *===========================================================*
      *    * Aggiornamento record [dcc] - dipendenza                   *
      *    *-----------------------------------------------------------*
       agg-rec-dp1-000.
      *              *-------------------------------------------------*
      *              * Test se esistente                               *
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODhcf    "         to   f-key                  .
           move      srt-cod-cli          to   rf-dcc-cod-cli         .
           move      "2   "               to   rf-dcc-dpz-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-det-cst-utz-ele      .
       agg-rec-adc-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to agg-rec-adc-500.
       agg-rec-adc-200.
      *              *-------------------------------------------------*
      *              * Read-next archivio [adc]                        *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/azi/fls/ioc/obj/iofadc"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           add       1                    to   w-det-cst-utz-ele      .
      *              *-------------------------------------------------*
      *              * Bufferizzazione elemento                        *
      *              *-------------------------------------------------*
           move      rf-adc-tip-arc       to   w-det-cst-utz-tip
                                              (w-det-cst-utz-ele)     .
           move      rf-adc-cod-arc       to   w-det-cst-utz-cod
                                              (w-det-cst-utz-ele)     .
           move      rf-adc-dpz-arc       to   w-det-cst-utz-dpz
                                              (w-det-cst-utz-ele)     .
           move      rf-adc-num-prg       to   w-det-cst-utz-prg
                                              (w-det-cst-utz-ele)     .
       agg-rec-adc-480.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     agg-rec-adc-200.
       agg-rec-adc-500.
      *              *-------------------------------------------------*
      *              * Ciclo di aggiornamento                          *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-cst-utz-ctr      .
       agg-rec-adc-520.
           add       1                    to   w-det-cst-utz-ctr      .
           if        w-det-cst-utz-ctr    >    w-det-cst-utz-ele
                     go to agg-rec-adc-900.
           if        w-det-cst-utz-ctr    >    w-det-cst-utz-max
                     go to agg-rec-adc-900.
       agg-rec-adc-600.
      *              *-------------------------------------------------*
      *              * Normalizzazione record                          *
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "ARCCON    "         to   f-key                  .
           move      w-det-cst-utz-tip
                    (w-det-cst-utz-ctr)   to   rf-adc-tip-arc         .
           move      w-det-cst-utz-cod
                    (w-det-cst-utz-ctr)   to   rf-adc-cod-arc         .
           move      w-det-cst-utz-dpz
                    (w-det-cst-utz-ctr)   to   rf-adc-dpz-arc         .
           move      w-det-cst-utz-prg
                    (w-det-cst-utz-ctr)   to   rf-adc-num-prg         .
           move      "pgm/azi/fls/ioc/obj/iofadc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              * Salvataggio record                              *
      *              *-------------------------------------------------*
           move      rf-adc               to   w-det-cst-utz-sav      .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *              * Recupero record                                 *
      *              *-------------------------------------------------*
           move      w-det-cst-utz-sav    to   rf-adc                 .
      *              *-------------------------------------------------*
      *              * Lettura [kk0]                                   *
      *              *-------------------------------------------------*
           move      rf-adc-cod-arc       to   kk0-cod-cli            .
           read      kk0    with no lock
                            invalid key
                            go to   agg-rec-adc-850.
      *              *-------------------------------------------------*
      *              * Aggiornamento codice cliente                    *
      *              *-------------------------------------------------*
           move      kk0-new-cli          to   rf-adc-cod-arc         .
      *              *-------------------------------------------------*
      *              * Scrittura record [adc] nuovo                    *
      *              *-------------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     agg-rec-adc-520.
       agg-rec-adc-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     agg-rec-adc-999.
       agg-rec-adc-999.
           exit.
      ...
      *    *===========================================================*
      *    * Aggiornamento record [hrg]                                *
      *    *-----------------------------------------------------------*
       agg-rec-hrg-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [hrg]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATMOV    "         to   f-key                  .
           move      zero                 to   rf-hrg-dat-mov         .
           move      zero                 to   rf-hrg-prg-mov         .
           move      "sec/tns/fls/ioc/obj/iofhrg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to agg-rec-hrg-900.
       agg-rec-hrg-200.
      *              *-------------------------------------------------*
      *              * Get-next archivio [hrg]                         *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhrg"
                                          to   s-pat                  .
      ...
      *              * Lettura [kk0]                                   *
      *              *-------------------------------------------------*
           move      rf-hrg-cod-cli       to   kk0-cod-cli            .
           read      kk0    with no lock
                            invalid key
                            go to   agg-rec-hrg-750.
       agg-rec-hrg-600.
      *              *-------------------------------------------------*
      *              * Aggiornamento codice cliente                    *
      *              *-------------------------------------------------*
           move      kk0-new-cli          to   rf-hrg-cod-cli         .
       agg-rec-hrg-700.
      *              *-------------------------------------------------*
      *              * Update record [hrg]                             *
      *              *-------------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     agg-rec-hrg-200.
       agg-rec-hrg-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     agg-rec-hrg-999.
       agg-rec-hrg-999.
           exit.

      *    *===========================================================*
      *    * Aggiornamento record [hru]                                *
      *    *-----------------------------------------------------------*
       agg-rec-hru-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [hru]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATMOV    "         to   f-key                  .
           move      zero                 to   rf-hru-dat-mov         .
           move      zero                 to   rf-hru-prg-mov         .
           move      "sec/tns/fls/ioc/obj/iofhru"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to agg-rec-hru-900.
       agg-rec-hru-200.
      *              *-------------------------------------------------*
      *              * Get-next archivio [hru]                         *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhru"
                                          to   s-pat                  .
      ...
      *              * Lettura [kk0]                                   *
      *              *-------------------------------------------------*
           move      rf-hru-cod-cli       to   kk0-cod-cli            .
           read      kk0    with no lock
                            invalid key
                            go to   agg-rec-hru-750.
       agg-rec-hru-600.
      *              *-------------------------------------------------*
      *              * Aggiornamento codice cliente                    *
      *              *-------------------------------------------------*
           move      kk0-new-cli          to   rf-hru-cod-cli         .
       agg-rec-hru-700.
      *              *-------------------------------------------------*
      *              * Update record [hru]                             *
      *              *-------------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     agg-rec-hru-200.
       agg-rec-hru-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     agg-rec-hru-999.
       agg-rec-hru-999.
           exit.

      *    *===========================================================*
      *    * Aggiornamento record [hfm]                                *
      *    *-----------------------------------------------------------*
       agg-rec-hfm-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [hfm]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATMOV    "         to   f-key                  .
           move      zero                 to   rf-hfm-dat-mov         .
           move      zero                 to   rf-hfm-prg-mov         .
           move      "sec/tns/fls/ioc/obj/iofhfm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to agg-rec-hfm-900.
       agg-rec-hfm-200.
      *              *-------------------------------------------------*
      *              * Get-next archivio [hfm]                         *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhfm"
                                          to   s-pat                  .
      ...
      *              * Lettura [kk0]                                   *
      *              *-------------------------------------------------*
           move      rf-hfm-cns-oss       to   kk0-cod-cli            .
           read      kk0    with no lock
                            invalid key
                            go to   agg-rec-hfm-750.
       agg-rec-hfm-600.
      *              *-------------------------------------------------*
      *              * Aggiornamento codice cliente                    *
      *              *-------------------------------------------------*
           move      kk0-new-cli          to   rf-hfm-cns-oss         .
       agg-rec-hfm-700.
      *              *-------------------------------------------------*
      *              * Update record [hfm]                             *
      *              *-------------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     agg-rec-hfm-200.
       agg-rec-hfm-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     agg-rec-hfm-999.
       agg-rec-hfm-999.
           exit.

      *    *===========================================================*
      *    * Aggiornamento record [hpx]                                *
      *    *-----------------------------------------------------------*
       agg-rec-hpx-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [hpx]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "NUMPTT    "         to   f-key                  .
           move      zero                 to   rf-hpx-num-ptt         .
           move      "sec/tns/fls/ioc/obj/iofhpx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to agg-rec-hpx-900.
       agg-rec-hpx-200.
      *              *-------------------------------------------------*
      *              * Get-next archivio [hpx]                         *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhpx"
                                          to   s-pat                  .
      ...
      *              * Lettura [kk0]                                   *
      *              *-------------------------------------------------*
           move      rf-hpx-cod-cli       to   kk0-cod-cli            .
           read      kk0    with no lock
                            invalid key
                            go to   agg-rec-hpx-750.
       agg-rec-hpx-600.
      *              *-------------------------------------------------*
      *              * Aggiornamento codice cliente                    *
      *              *-------------------------------------------------*
           move      kk0-new-cli          to   rf-hpx-cod-cli         .
       agg-rec-hpx-700.
      *              *-------------------------------------------------*
      *              * Update record [hpx]                             *
      *              *-------------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     agg-rec-hpx-200.
       agg-rec-hpx-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     agg-rec-hpx-999.
       agg-rec-hpx-999.
           exit.

      *    *===========================================================*
      *    * Aggiornamento record [hoc]                                *
      *    *-----------------------------------------------------------*
       agg-rec-hoc-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [hoc]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "NUMCNF    "         to   f-key                  .
           move      zero                 to   rf-hoc-num-cnf         .
           move      "sec/tns/fls/ioc/obj/iofhoc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to agg-rec-hoc-900.
       agg-rec-hoc-200.
      *              *-------------------------------------------------*
      *              * Get-next archivio [hoc]                         *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhoc"
                                          to   s-pat                  .
      ...
      *              * Lettura [kk0]                                   *
      *              *-------------------------------------------------*
           move      rf-hoc-cod-cli       to   kk0-cod-cli            .
           read      kk0    with no lock
                            invalid key
                            go to   agg-rec-hoc-750.
       agg-rec-hoc-600.
      *              *-------------------------------------------------*
      *              * Aggiornamento codice cliente                    *
      *              *-------------------------------------------------*
           move      kk0-new-cli          to   rf-hoc-cod-cli         .
       agg-rec-hoc-700.
      *              *-------------------------------------------------*
      *              * Update record [hoc]                             *
      *              *-------------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     agg-rec-hoc-200.
       agg-rec-hoc-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     agg-rec-hoc-999.
       agg-rec-hoc-999.
           exit.

      *    *===========================================================*
      *    * Aggiornamento record [hcf]                                *
      *    *-----------------------------------------------------------*
       agg-rec-hcf-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [hcf]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "CODCNF    "         to   f-key                  .
           move      zero                 to   rf-hcf-cod-cnf         .
           move      "sec/tns/fls/ioc/obj/iofhcf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to agg-rec-hcf-900.
       agg-rec-hcf-200.
      *              *-------------------------------------------------*
      *              * Get-next archivio [hcf]                         *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "sec/tns/fls/ioc/obj/iofhcf"
                                          to   s-pat                  .
      ...
      *              * Lettura [kk0]                                   *
      *              *-------------------------------------------------*
           move      rf-hcf-cod-cli       to   kk0-cod-cli            .
           read      kk0    with no lock
                            invalid key
                            go to   agg-rec-hcf-750.
       agg-rec-hcf-600.
      *              *-------------------------------------------------*
      *              * Aggiornamento codice cliente                    *
      *              *-------------------------------------------------*
           move      kk0-new-cli          to   rf-hcf-cod-cli         .
       agg-rec-hcf-700.
      *              *-------------------------------------------------*
      *              * Update record [hcf]                             *
      *              *-------------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     agg-rec-hcf-200.
       agg-rec-hcf-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     agg-rec-hcf-999.
       agg-rec-hcf-999.
           exit.
