      ...
      *                                                                *
      *                    Pulizia '(' e virgole indirizzo e localita' *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Pulizia indirizzi e localita' - Zatti "       .
      ...
      *              * Pulizia Indirizzo                               *
      *              *-------------------------------------------------*
           inspect   rf-dcc-via-dcc
                                replacing all  ","
                                          by   " "                    .
      *              *-------------------------------------------------*
      *              * Pulizia Localita'                               *
      *              *-------------------------------------------------*
           inspect   rf-dcc-loc-dcc
                                replacing all  "("
                                          by   " "                    .
           inspect   rf-dcc-loc-dcc
                                replacing all  ")"
      ...
      *              * Pulizia Indirizzo                               *
      *              *-------------------------------------------------*
           inspect   rf-cli-via-cli
                                replacing all  ","
                                          by   " "                    .
      *              *-------------------------------------------------*
      *              * Pulizia Localita'                               *
      *              *-------------------------------------------------*
           inspect   rf-cli-loc-cli
                                replacing all  "("
                                          by   " "                    .
           inspect   rf-cli-loc-cli
                                replacing all  ")"
