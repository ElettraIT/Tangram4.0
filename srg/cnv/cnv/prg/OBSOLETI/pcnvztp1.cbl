      ...
      *                    ZATTI - file 'PROVEN.TXT'                   *
      *                                                                *
      *                    Upgrade per sconti e provvigioni            *
      *                    listino base                                *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Conversione prodotti ZATTI Srl - prz/sc."       .
      ...
      *        *-------------------------------------------------------*
      *        * Per determinazione sconti e provvigioni               *
      *        *-------------------------------------------------------*
           05  w-det-per-sep.
      *            *---------------------------------------------------*
      *            * Comodi                                            *
      *            *---------------------------------------------------*
               10  w-det-per-sep-sco      pic  9(02)                  .
               10  w-det-per-sep-pvg      pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *                      * Sconto                                  *
      *                      *-----------------------------------------*
           move      zero                 to   w-det-per-sep-sco      .
      ...
      *                          *-------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-per-sep-sco      .
       xcv-trt-pds-220.
      *                      *-----------------------------------------*
      *                      * Provvigioni                             *
      *                      *-----------------------------------------*
           move      zero                 to   w-det-per-sep-pvg      .
           if        w-lds-001-per-pvg    =    spaces
      ...
      *                          *-------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      02                   to   v-car                  .
           move      w-lds-001-per-pvg    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-per-sep-pvg      .
       xcv-trt-pds-240.
       xcv-trt-pds-400.
      *                  *---------------------------------------------*
      *                  * Aggiornamento del record [dcp]              *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-det-per-sep-sco    to   rf-dcp-cat-scr         .
           move      w-det-per-sep-sco    to   rf-dcp-per-scr (1)     .
      *                      *-----------------------------------------*
      *                      * Aggiornamento provvigioni               *
      *                      *-----------------------------------------*
           move      w-det-per-sep-pvg    to   rf-dcp-cat-pvg         .
           move      w-det-per-sep-pvg    to   rf-dcp-per-pvg (1)     .
       agg-rec-dcp-220.
      *                      *-----------------------------------------*
      *                      * Update del record                       *
      *                      *-----------------------------------------*
