      ...
      *    *===========================================================*
      *    * Record logico file [wgr]                                  *
      *    *-----------------------------------------------------------*
           copy      "cnv/cnv/fls/rec/rfwgr"                          .

      ******************************************************************
       Procedure Division                using f rf-wgr               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-wgr                 .
           move      zero                 to   rf-wgr-dat-reg         .
           move      zero                 to   rf-wgr-num-prt         .
           move      zero                 to   rf-wgr-num-prg         .
           move      zero                 to   rf-wgr-cod-pdc         .
           move      spaces               to   rf-wgr-tip-arc         .
           move      zero                 to   rf-wgr-cod-arc         .
           move      zero                 to   rf-wgr-cod-cau         .
           move      spaces               to   rf-wgr-snx-mob         .
           move      spaces               to   rf-wgr-tip-iva         .
           move      spaces               to   rf-wgr-com-rig         .
           move      zero                 to   rf-wgr-dat-doc         .
           move      spaces               to   rf-wgr-num-doc         .
           move      zero                 to   rf-wgr-dat-rif         .
           move      spaces               to   rf-wgr-num-rif         .
           move      spaces               to   rf-wgr-dar-ave         .
           move      zero                 to   rf-wgr-imp-mov         .
           move      spaces               to   rf-wgr-flg-pge         .
           move      spaces               to   rf-wgr-flg-pcf         .
           move      spaces               to   rf-wgr-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-wgr-cod-cau       to   fil-cod-cau            .
           move      rf-wgr-snx-mob       to   fil-snx-mob            .
           move      rf-wgr-tip-iva       to   fil-tip-iva            .
           move      rf-wgr-com-rig       to   fil-com-rig            .
           move      rf-wgr-dat-doc       to   fil-dat-doc            .
           move      rf-wgr-num-doc       to   fil-num-doc            .
           move      rf-wgr-dar-ave       to   fil-dar-ave            .
           move      rf-wgr-imp-mov       to   fil-imp-mov            .
           move      rf-wgr-flg-pge       to   fil-flg-pge            .
           move      rf-wgr-flg-pcf       to   fil-flg-pcf            .
           move      rf-wgr-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-wgr-dat-reg       to   fil-dat-reg            .
           move      rf-wgr-num-prt       to   fil-num-prt            .
           move      rf-wgr-num-prg       to   fil-num-prg            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-wgr-cod-pdc       to   fil-cod-pdc            .
           move      rf-wgr-dat-reg       to   fil-dat-reg-2          .
           move      rf-wgr-num-prt       to   fil-num-prt-2          .
           move      rf-wgr-num-prg       to   fil-num-prg-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-wgr-tip-arc       to   fil-tip-arc            .
           move      rf-wgr-cod-arc       to   fil-cod-arc            .
           if        rf-wgr-tip-arc       =    "G"
                     move   zero          to   fil-cod-arc            .
           move      rf-wgr-dat-reg       to   fil-dat-reg-3          .
           move      rf-wgr-num-prt       to   fil-num-prt-3          .
           move      rf-wgr-num-prg       to   fil-num-prg-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-wgr-tip-arc       to   fil-tip-arc-4          .
           move      rf-wgr-cod-arc       to   fil-cod-arc-4          .
           if        rf-wgr-tip-arc       =    "G"
                     move   zero          to   fil-cod-arc-4          .
           move      rf-wgr-dat-rif       to   fil-dat-rif            .
           move      rf-wgr-num-rif       to   fil-num-rif            .
           move      rf-wgr-dat-reg       to   fil-dat-reg-4          .
           move      rf-wgr-num-prt       to   fil-num-prt-4          .
           move      rf-wgr-num-prg       to   fil-num-prg-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-wgr-tip-arc       to   fil-tip-arc-5          .
           move      rf-wgr-dat-doc       to   fil-dat-doc-5          .
           move      rf-wgr-num-doc       to   fil-num-doc-5          .
           move      rf-wgr-cod-arc       to   fil-cod-arc-5          .
           if        rf-wgr-tip-arc       =    "G"
                     move   zero          to   fil-cod-arc-5          .
           move      rf-wgr-dat-reg       to   fil-dat-reg-5          .
           move      rf-wgr-num-prt       to   fil-num-prt-5          .
           move      rf-wgr-num-prg       to   fil-num-prg-5          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-wgr                 .
           move      fil-dat-reg          to   rf-wgr-dat-reg         .
           move      fil-num-prt          to   rf-wgr-num-prt         .
           move      fil-num-prg          to   rf-wgr-num-prg         .
           move      fil-cod-pdc          to   rf-wgr-cod-pdc         .
           move      fil-tip-arc          to   rf-wgr-tip-arc         .
           move      fil-cod-arc          to   rf-wgr-cod-arc         .
           move      fil-cod-cau          to   rf-wgr-cod-cau         .
           move      fil-snx-mob          to   rf-wgr-snx-mob         .
           move      fil-tip-iva          to   rf-wgr-tip-iva         .
           move      fil-com-rig          to   rf-wgr-com-rig         .
           move      fil-dat-doc          to   rf-wgr-dat-doc         .
           move      fil-num-doc          to   rf-wgr-num-doc         .
           move      fil-dat-rif          to   rf-wgr-dat-rif         .
           move      fil-num-rif          to   rf-wgr-num-rif         .
           move      fil-dar-ave          to   rf-wgr-dar-ave         .
           move      fil-imp-mov          to   rf-wgr-imp-mov         .
           move      fil-flg-pge          to   rf-wgr-flg-pge         .
           move      fil-flg-pcf          to   rf-wgr-flg-pcf         .
           move      fil-alx-exp          to   rf-wgr-alx-exp         .
       dec-fis-log-999.
           exit.
