      ...
      *              *        bile 'x-env-pfix'                        *
      *              *-------------------------------------------------*
           call      "cnv/wtr/prg/obj/pxpg0001"
                                         using x                      .
           cancel    "cnv/wtr/prg/obj/pxpg0001"                       .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           call      "cnv/wtr/prg/obj/pxpg0002"
                                         using x                      .
           cancel    "cnv/wtr/prg/obj/pxpg0002"                       .
           if        x-sts                not  = spaces
                     go to main-900.
       main-100.
      *              *-------------------------------------------------*
      *              * Presentazione menu'                             *
      *              *-------------------------------------------------*
           call      "cnv/wtr/prg/obj/pxpg0003"
                                         using x                      .
           cancel    "cnv/wtr/prg/obj/pxpg0003"                       .
      *              *-------------------------------------------------*
