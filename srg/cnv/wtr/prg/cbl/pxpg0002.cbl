      ...
      *================================================================*
      *                                                                *
      * Azioni pre-presentazione primo menu'                           *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
______*    perform   msg-prf-pfc-000      thru msg-prf-pfc-999        .
       main-900.
      *              *-------------------------------------------------*
      *              * Chiusura file [pfc]                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Numero di archivi-stampa su disco non ancora effet
      -              "tivamente stampati ... :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       ancora effettivamente stampati per il recup
      -              "ero dello spazio impegnato.   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
