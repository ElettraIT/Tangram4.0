      ...
      *    *===========================================================*
      *    * Record logico file [zp3]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/dcp/fls/rec/rfzp3"                          .

      ******************************************************************
       Procedure Division                using f rf-zp3               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-zp3                 .
           move      zero                 to   rf-zp3-cod-cla         .
           move      zero                 to   rf-zp3-cod-gru         .
           move      zero                 to   rf-zp3-cod-sgr         .
           move      spaces               to   rf-zp3-des-sgr         .
           move      spaces               to   rf-zp3-mne-sgr         .
           move      zero                 to   rf-zp3-sqz-num         .
           move      spaces               to   rf-zp3-des-key         .
           move      zero                 to   rf-zp3-ult-sud         .
           move      spaces               to   rf-zp3-umi-def         .
           move      zero                 to   rf-zp3-ult-cod         .
           move      spaces               to   rf-zp3-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-zp3-des-sgr       to   fil-des-sgr            .
           move      rf-zp3-ult-sud       to   fil-ult-sud            .
           move      rf-zp3-umi-def       to   fil-umi-def            .
           move      rf-zp3-ult-cod       to   fil-ult-cod            .
           move      rf-zp3-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zp3-cod-cla       to   fil-cod-cla            .
           move      rf-zp3-cod-gru       to   fil-cod-gru            .
           move      rf-zp3-cod-sgr       to   fil-cod-sgr            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zp3-cod-cla       to   fil-cod-cla-2          .
           move      rf-zp3-cod-gru       to   fil-cod-gru-2          .
           move      rf-zp3-des-key       to   fil-des-key            .
           move      rf-zp3-cod-sgr       to   fil-cod-sgr-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zp3-cod-cla       to   fil-cod-cla-3          .
           move      rf-zp3-cod-gru       to   fil-cod-gru-3          .
           move      rf-zp3-mne-sgr       to   fil-mne-sgr            .
           move      rf-zp3-cod-sgr       to   fil-cod-sgr-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zp3-cod-cla       to   fil-cod-cla-4          .
           move      rf-zp3-cod-gru       to   fil-cod-gru-4          .
           move      rf-zp3-sqz-num       to   fil-sqz-num            .
           move      rf-zp3-cod-sgr       to   fil-cod-sgr-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-zp3                 .
           move      fil-cod-cla          to   rf-zp3-cod-cla         .
           move      fil-cod-gru          to   rf-zp3-cod-gru         .
           move      fil-cod-sgr          to   rf-zp3-cod-sgr         .
           move      fil-des-sgr          to   rf-zp3-des-sgr         .
           move      fil-mne-sgr          to   rf-zp3-mne-sgr         .
           move      fil-des-key          to   rf-zp3-des-key         .
           move      fil-sqz-num          to   rf-zp3-sqz-num         .
           move      fil-ult-sud          to   rf-zp3-ult-sud         .
           move      fil-umi-def          to   rf-zp3-umi-def         .
           move      fil-ult-cod          to   rf-zp3-ult-cod         .
           move      fil-alx-exp          to   rf-zp3-alx-exp         .
       dec-fis-log-999.
           exit.
