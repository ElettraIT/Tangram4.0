      ...
      *    *===========================================================*
      *    * Record logico file [zp2]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/dcp/fls/rec/rfzp2"                          .

      ******************************************************************
       Procedure Division                using f rf-zp2               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-zp2                 .
           move      zero                 to   rf-zp2-cod-cla         .
           move      zero                 to   rf-zp2-cod-gru         .
           move      spaces               to   rf-zp2-des-gru         .
           move      spaces               to   rf-zp2-mne-gru         .
           move      spaces               to   rf-zp2-des-key         .
           move      zero                 to   rf-zp2-sqz-num         .
           move      zero                 to   rf-zp2-ult-sud         .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-zp2-des-gru       to   fil-des-gru            .
           move      rf-zp2-ult-sud       to   fil-ult-sud            .
           move      rf-zp2-umi-def       to   fil-umi-def            .
           move      rf-zp2-ult-cod       to   fil-ult-cod            .
           move      rf-zp2-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zp2-cod-cla       to   fil-cod-cla            .
           move      rf-zp2-cod-gru       to   fil-cod-gru            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zp2-cod-cla       to   fil-cod-cla-2          .
           move      rf-zp2-des-key       to   fil-des-key            .
           move      rf-zp2-cod-gru       to   fil-cod-gru-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zp2-cod-cla       to   fil-cod-cla-3          .
           move      rf-zp2-mne-gru       to   fil-mne-gru            .
           move      rf-zp2-cod-gru       to   fil-cod-gru-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zp2-cod-cla       to   fil-cod-cla-4          .
           move      rf-zp2-sqz-num       to   fil-sqz-num            .
           move      rf-zp2-cod-gru       to   fil-cod-gru-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-zp2                 .
           move      fil-cod-cla          to   rf-zp2-cod-cla         .
           move      fil-cod-gru          to   rf-zp2-cod-gru         .
           move      fil-des-gru          to   rf-zp2-des-gru         .
           move      fil-mne-gru          to   rf-zp2-mne-gru         .
           move      fil-des-key          to   rf-zp2-des-key         .
           move      fil-sqz-num          to   rf-zp2-sqz-num         .
           move      fil-ult-sud          to   rf-zp2-ult-sud         .
           move      fil-umi-def          to   rf-zp2-umi-def         .
           move      fil-ult-cod          to   rf-zp2-ult-cod         .
           move      fil-alx-exp          to   rf-zp2-alx-exp         .
       dec-fis-log-999.
           exit.
