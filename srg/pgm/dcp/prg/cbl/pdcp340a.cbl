      ...
      *                                                                *
      *                    /abd/asc/UTENTE/exp/AZI_dcp340.csv          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Si/no prodotti con listino a zero                     *
      *        *-------------------------------------------------------*
           05  rr-snx-zer                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Si/no prodotti a listino                              *
      *        *-------------------------------------------------------*
           05  rr-snx-lst                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Tipo descrizione                                      *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Si/no prodotti a listino                   *
      *        *-------------------------------------------------------*
           05  w-exp-snx-lst.
               10  w-exp-snx-lst-num      pic  9(02)       value 2    .
               10  w-exp-snx-lst-lun      pic  9(02)       value 02   .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-des.
               10  w-exp-tip-des-num      pic  9(02)       value 2    .
               10  w-exp-tip-des-lun      pic  9(02)       value 20   .
      ...
      *        *-------------------------------------------------------*
      *        * Work per Det esportazine listino                      *
      *        *-------------------------------------------------------*
           05  w-det-exp-lst.
      *            *---------------------------------------------------*
      *            * Codice listino                                    *
      *            *---------------------------------------------------*
               10  w-det-exp-lst-cod      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Codice valuta                                     *
      *            *---------------------------------------------------*
               10  w-det-exp-lst-vlt      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Decimali valuta                                   *
      *            *---------------------------------------------------*
               10  w-det-exp-lst-dec      pic  9(01)                  .
      *        *-------------------------------------------------------*
      ...
      *
           ...
           move      16                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Stampa anche prezzi a zero :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *              *-------------------------------------------------*
           ...
           move      12                   to   w-cod-zos-dcp-lin      .
           move      30                   to   w-cod-zos-dcp-pos      .
           move      12                   to   w-cod-zos-dcp-dln      .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no prodotti a listino             *
      *    *-----------------------------------------------------------*
       acc-snx-lst-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzaz. campo : Si/no prodotti a listino             *
      *    *-----------------------------------------------------------*
       vis-snx-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Tipo descrizione           *
      *    *-----------------------------------------------------------*
       acc-tip-des-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzaz. campo selezione : Tipo descrizione           *
      *    *-----------------------------------------------------------*
       vis-tip-des-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       reg-ric-sel-300.
      *              *-------------------------------------------------*
      *              * Normalizzazione si/no prodotti a listino        *
      *              *-------------------------------------------------*
           if        rr-snx-lst           not  = zero
                     go to reg-ric-sel-400.
           move      01                   to   rr-snx-lst             .
       reg-ric-sel-400.
      *              *-------------------------------------------------*
      *              * Normalizzazione tipo descrizione                *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-ls1           to   d-prz-ven-cod-lst      .
      ...
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
           if        rf-dcp-epz-ele (03)  not  = "X"
                     go to prn-liv-det-218.
      *                      *-----------------------------------------*
      *                      * Stampa                                  *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
      ...
      *                      *-----------------------------------------*
           perform   det-prz-ven-cll-000  thru det-prz-ven-cll-999    .
      *                      *-----------------------------------------*
      *                      * Lettura caratteristiche listino         *
      *                      *-----------------------------------------*
           move      01                   to   w-let-arc-lst-tip      .
           move      rr-cod-ls1           to   w-let-arc-lst-cod      .
           move      zero                 to   w-let-arc-lst-cli      .
      ...
      *                      *-----------------------------------------*
      *                      * Prezzo di listino determinato           *
      *                      *-----------------------------------------*
           move      d-prz-ven-prz-ven    to   w-det-val-stp-prz      .
       prn-liv-det-220.
      *                      *-----------------------------------------*
      *                      * Stampa prezzo listino 1                 *
      *                      *-----------------------------------------*
           move      w-det-val-stp-prz    to   w-stp-sta-prz-prz      .
           move      w-det-val-lst-dc1    to   w-stp-sta-prz-dec      .
           add       rf-dcp-dec-prz       to   w-stp-sta-prz-dec      .
           move      067                  to   w-stp-sta-prz-pos      .
      ...
      *                      *-----------------------------------------*
           ...
           move      c-dec                to   d-prz-ven-dec-vpp      .
           move      rf-dcp-num-pro       to   d-prz-ven-num-pro      .
           move      rr-cod-ls2           to   d-prz-ven-cod-lst      .
           move      rf-dcp-prz-lst       to   d-prz-ven-prz-lsb      .
           move      c-sgl                to   d-prz-ven-sgl-vlb      .
           move      c-dec                to   d-prz-ven-dec-vlb      .
           move      spaces               to   d-prz-ven-tfu-prz      .
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-240.
      *                      *-----------------------------------------*
      *                      * Stampa prezzo listino 2                 *
      *                      *-----------------------------------------*
           move      w-det-val-stp-prz    to   w-stp-sta-prz-prz      .
           move      w-det-val-lst-dc2    to   w-stp-sta-prz-dec      .
           add       rf-dcp-dec-prz       to   w-stp-sta-prz-dec      .
           move      083                  to   w-stp-sta-prz-pos      .
           perform   stp-sta-prz-000      thru stp-sta-prz-999        .
      *                  *---------------------------------------------*
      *                  * Prezzo di listino 3                         *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      c-dec                to   d-prz-ven-dec-vpp      .
           move      rf-dcp-num-pro       to   d-prz-ven-num-pro      .
           move      rr-cod-ls3           to   d-prz-ven-cod-lst      .
           move      rf-dcp-prz-lst       to   d-prz-ven-prz-lsb      .
           move      c-sgl                to   d-prz-ven-sgl-vlb      .
           move      c-dec                to   d-prz-ven-dec-vlb      .
           move      spaces               to   d-prz-ven-tfu-prz      .
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-260.
      *                      *-----------------------------------------*
      *                      * Stampa prezzo listino 3                 *
      *                      *-----------------------------------------*
           move      w-det-val-stp-prz    to   w-stp-sta-prz-prz      .
           move      w-det-val-lst-dc3    to   w-stp-sta-prz-dec      .
           add       rf-dcp-dec-prz       to   w-stp-sta-prz-dec      .
           move      099                  to   w-stp-sta-prz-pos      .
           perform   stp-sta-prz-000      thru stp-sta-prz-999        .
      *                  *---------------------------------------------*
      *                  * Prezzo di listino 4                         *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      c-dec                to   d-prz-ven-dec-vpp      .
           move      rf-dcp-num-pro       to   d-prz-ven-num-pro      .
           move      rr-cod-ls4           to   d-prz-ven-cod-lst      .
           move      rf-dcp-prz-lst       to   d-prz-ven-prz-lsb      .
           move      c-sgl                to   d-prz-ven-sgl-vlb      .
           move      c-dec                to   d-prz-ven-dec-vlb      .
           move      spaces               to   d-prz-ven-tfu-prz      .
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-280.
      *                      *-----------------------------------------*
      *                      * Stampa prezzo listino 4                 *
      *                      *-----------------------------------------*
           move      w-det-val-stp-prz    to   w-stp-sta-prz-prz      .
           move      w-det-val-lst-dc4    to   w-stp-sta-prz-dec      .
           add       rf-dcp-dec-prz       to   w-stp-sta-prz-dec      .
           move      115                  to   w-stp-sta-prz-pos      .
           perform   stp-sta-prz-000      thru stp-sta-prz-999        .
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Ciclo di stampa delle eventuali altre righe di  *
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           move      rr-cod-ls1           to   w-det-exp-lst-cod      .
           move      w-det-val-lst-vl1    to   w-det-exp-lst-vlt      .
           move      w-det-val-lst-dc1    to   w-det-exp-lst-dec      .
           perform   prn-liv-det-epl-000  thru prn-liv-det-epl-999    .
       prn-liv-det-exp-300.
      *                  *---------------------------------------------*
      *                  * Prezzo di listino 2                         *
      *                  *---------------------------------------------*
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           move      rr-cod-ls2           to   w-det-exp-lst-cod      .
           move      w-det-val-lst-vl2    to   w-det-exp-lst-vlt      .
           move      w-det-val-lst-dc2    to   w-det-exp-lst-dec      .
           perform   prn-liv-det-epl-000  thru prn-liv-det-epl-999    .
       prn-liv-det-exp-400.
      *                  *---------------------------------------------*
      *                  * Prezzo di listino 3                         *
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           move      rr-cod-ls3           to   w-det-exp-lst-cod      .
           move      w-det-val-lst-vl3    to   w-det-exp-lst-vlt      .
           move      w-det-val-lst-dc3    to   w-det-exp-lst-dec      .
           perform   prn-liv-det-epl-000  thru prn-liv-det-epl-999    .
       prn-liv-det-exp-500.
      *                  *---------------------------------------------*
      *                  * Prezzo di listino 4                         *
      ...
      *                      * Subroutine                              *
      *                      *-----------------------------------------*
           move      rr-cod-ls4           to   w-det-exp-lst-cod      .
           move      w-det-val-lst-vl4    to   w-det-exp-lst-vlt      .
           move      w-det-val-lst-dc4    to   w-det-exp-lst-dec      .
           perform   prn-liv-det-epl-000  thru prn-liv-det-epl-999    .
       prn-liv-det-exp-800.
      *              *-------------------------------------------------*
      *              * Emissione riga                                  *
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine per esportazione prezzo di listino             *
      *    *-----------------------------------------------------------*
       prn-liv-det-epl-000.
      *              *-------------------------------------------------*
      *              * Preparazione link-area                          *
      *              *-------------------------------------------------*
           ...
           move      c-dec                to   d-prz-ven-dec-vpp      .
           move      rf-dcp-num-pro       to   d-prz-ven-num-pro      .
           move      w-det-exp-lst-cod    to   d-prz-ven-cod-lst      .
           move      rf-dcp-prz-lst       to   d-prz-ven-prz-lsb      .
           move      c-sgl                to   d-prz-ven-sgl-vlb      .
           move      c-dec                to   d-prz-ven-dec-vlb      .
           move      spaces               to   d-prz-ven-tfu-prz      .
      ...
      *              *-------------------------------------------------*
           move      01                   to   w-let-arc-lst-tip      .
           move      w-det-exp-lst-cod    to   w-let-arc-lst-cod      .
           move      zero                 to   w-let-arc-lst-cli      .
           move      w-det-exp-lst-vlt    to   w-let-arc-lst-vlt      .
           move      rf-dcp-num-pro       to   w-let-arc-lst-pro      .
           perform   let-arc-lst-000      thru let-arc-lst-999        .
           move      w-let-arc-lst-vlt    to   w-det-val-stp-vlt      .
           move      w-let-arc-lst-dec    to   w-det-val-stp-dec      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "V"                  to   p-tip                  .
           move      09                   to   p-car                  .
           move      w-det-exp-lst-dec    to   p-dec                  .
           add       rf-dcp-dec-prz       to   p-dec                  .
           move      spaces               to   p-sgn                  .
           move      "BG"                 to   p-edm                  .
           move      d-prz-ven-prz-ven    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * In campo di output                              *
      ...
      *              *-------------------------------------------------*
           move      "PREZZI DI LISTINO"  to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
       ...
       det-des-stp-200.
      *              *-------------------------------------------------*
      *              * Test preliminare su richieste di selezione      *
      *              *-------------------------------------------------*
           if        rr-tip-des           =    02
