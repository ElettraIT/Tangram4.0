      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella codici listino             *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-lst          pic  x(20)                  .
               10  w-tes-cod-vlt          pic  x(03)                  .
               10  w-tes-cod-vlt-des      pic  x(20)                  .
               10  w-tes-wrk-lst          pic  x(01)                  .
               10  w-tes-drg-lst          pic  x(01)                  .
               10  w-tes-rif-lst          pic  x(03)                  .
               10  w-tes-rif-lst-des      pic  x(20)                  .
               10  w-tes-per-lst occurs 05
                                          pic  9(02)v9(01)            .
               10  w-tes-alx-exp.
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Flag per 'listino di lavoro'               *
      *        *-------------------------------------------------------*
           05  w-exp-wrk-lst.
               10  w-exp-wrk-lst-num      pic  9(02)       value 2    .
               10  w-exp-wrk-lst-lun      pic  9(02)       value 40   .
               10  w-exp-wrk-lst-tbl.
                   15  filler             pic  x(40) value
                       "Normale                                 "     .
                   15  filler             pic  x(40) value
                       "di Lavoro                               "     .
      *        *-------------------------------------------------------*
      *        * Work per : Direttive generali listino                 *
      *        *-------------------------------------------------------*
           05  w-exp-drg-lst.
               10  w-exp-drg-lst-num      pic  9(02)       value 5    .
               10  w-exp-drg-lst-lun      pic  9(02)       value 40   .
               10  w-exp-drg-lst-tbl.
                   15  filler             pic  x(40) value
                       "Nessuna                                 "     .
                   15  filler             pic  x(40) value
                       "prezzi Relativi a 1000 unita'           "     .
                   15  filler             pic  x(40) value
                       "listino di Maggiorazione altro listino  "     .
                   15  filler             pic  x(40) value
                       "listino di Sconto su altro listino      "     .
                   15  filler             pic  x(40) value
                       "listino parziale                        "     .

      *    *===========================================================*
      *    * Work-area per subroutines di Let                          *
      *    *-----------------------------------------------------------*
       01  w-let.
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-edt-per-lst.
               10  w-edt-per-lst-edt.
                   15  w-edt-per-lst-ele occurs 05.
                       20  w-edt-per-lst-per
                                          pic  x(04)                  .
                       20  filler         pic  x(02)                  .
               10  w-edt-per-lst-c01      pic  9(02)                  .
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-lst        to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           perform   acc-wrk-lst-000      thru acc-wrk-lst-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
       ...
       acc-tes-reg-130.
      *                  *---------------------------------------------*
      *                  * Direttive generali listino                  *
      *                  *---------------------------------------------*
           perform   acc-drg-lst-000      thru acc-drg-lst-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  *---------------------------------------------*
       ...
       acc-tes-reg-150.
      *                  *---------------------------------------------*
      *                  * % di sconto o maggiorazione                 *
      *                  *---------------------------------------------*
           perform   acc-per-lst-000      thru acc-per-lst-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Flag per 'listino di lavoro'                    *
      *              *-------------------------------------------------*
           perform   vis-wrk-lst-000      thru vis-wrk-lst-999        .
      *              *-------------------------------------------------*
      *              * Direttive generali listino                      *
      *              *-------------------------------------------------*
           perform   vis-drg-lst-000      thru vis-drg-lst-999        .
      *              *-------------------------------------------------*
      *              * Listino di riferimento                          *
      *              *-------------------------------------------------*
           perform   vis-rif-lst-000      thru vis-rif-lst-999        .
           perform   vis-rif-lst-des-000  thru vis-rif-lst-des-999    .
      *              *-------------------------------------------------*
      *              * % di sconto o maggiorazione                     *
      *              *-------------------------------------------------*
           perform   vis-per-lst-000      thru vis-per-lst-999        .
           go to     vis-tes-reg-999.
       vis-tes-reg-200.
       vis-tes-reg-999.
           exit.
      ...
      *              * Flag per 'listino di lavoro'                    *
      *              *-------------------------------------------------*
           perform   pmt-wrk-lst-000      thru pmt-wrk-lst-999        .
      *              *-------------------------------------------------*
      *              * Direttive generali listino                      *
      *              *-------------------------------------------------*
           perform   pmt-drg-lst-000      thru pmt-drg-lst-999        .
      *              *-------------------------------------------------*
      *              * Listino di riferimento                          *
      *              *-------------------------------------------------*
      ...
      *              * % di sconto o maggiorazione                     *
      *              *-------------------------------------------------*
           perform   pmt-per-lst-000      thru pmt-per-lst-999        .
           go to     pmt-tes-reg-999.
       pmt-tes-reg-200.
       pmt-tes-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione listino              *
      *    *-----------------------------------------------------------*
       pmt-des-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Flag per 'listino di lavoro'     *
      *    *-----------------------------------------------------------*
       pmt-wrk-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Direttive generali listino       *
      *    *-----------------------------------------------------------*
       pmt-drg-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      13                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Direttive generali listino :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-drg-lst-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Listino di riferimento           *
      *    *-----------------------------------------------------------*
       pmt-rif-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : % di sconto o maggiorazione      *
      *    *-----------------------------------------------------------*
       pmt-per-lst-000.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione delle direttive generali *
      *              *-------------------------------------------------*
           if        w-tes-drg-lst (1)    not  = "M" and
                     w-tes-drg-lst (1)    not  = "S"
                     go to pmt-per-lst-200.
       pmt-per-lst-100.
      *              *-------------------------------------------------*
      *              * Se listino di sconto o maggiorazione            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Visualizzazione                             *
      *                  *---------------------------------------------*
           ...
           move      01                   to   v-pos                  .
      *
           if        w-tes-drg-lst (1)    =    "M"
                     move  "% di maggiorazione         :"
                                          to   v-alf
           else      move  "% di sconto                :"
                                          to   v-alf                  .
      *
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione listino          *
      *    *-----------------------------------------------------------*
       acc-des-lst-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-lst (1)    not  = spaces
                     go to acc-des-lst-450.
           if        v-key                =    "UP  "
                     go to acc-des-lst-600
           else      go to acc-des-lst-100.
       acc-des-lst-450.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione listino       *
      *    *-----------------------------------------------------------*
       vis-des-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Codice valuta                *
      *    *-----------------------------------------------------------*
       acc-cod-vlt-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-vlt (1)    not  = spaces
                     go to acc-cod-vlt-100.
           move      c-sgl                to   w-tes-cod-vlt (1)      .
           move      w-tes-cod-vlt (1)    to   w-let-arc-zvl-cod      .
           perform   let-arc-zvl-000      thru let-arc-zvl-999        .
           move      w-let-arc-zvl-des    to   w-tes-cod-vlt-des (1)  .
           perform   vis-des-vlt-000      thru vis-des-vlt-999        .
       acc-cod-vlt-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-vlt (1)    to   w-cod-cod-zvl-cod      .
           move      09                   to   w-cod-cod-zvl-lin      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Codice valuta             *
      *    *-----------------------------------------------------------*
       vis-cod-vlt-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Flag per 'listino di lavoro' *
      *    *-----------------------------------------------------------*
       acc-wrk-lst-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-wrk-lst-lun    to   v-car                  .
           move      w-exp-wrk-lst-num    to   v-ldt                  .
           move      "NL#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      11                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-wrk-lst-tbl    to   v-txt                  .
           if        w-tes-wrk-lst (1)    =    "#"
                     move  02             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    02
                     move  "#"            to   w-tes-wrk-lst (1)
           else      move  spaces         to   w-tes-wrk-lst (1)      .
       acc-wrk-lst-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-wrk-lst-100.
       acc-wrk-lst-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Flag per 'listino di la-  *
      *    *                                 voro'                     *
      *    *-----------------------------------------------------------*
       vis-wrk-lst-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Direttive generali listino   *
      *    *-----------------------------------------------------------*
       acc-drg-lst-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-drg-lst-lun    to   v-car                  .
           move      w-exp-drg-lst-num    to   v-ldt                  .
           move      "NRMSP#"             to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      13                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-drg-lst-tbl    to   v-txt                  .
      *
           if        w-tes-drg-lst (1)    =    " "
                     move  01             to   v-num
           else if   w-tes-drg-lst (1)    =    "K"
                     move  02             to   v-num
           else if   w-tes-drg-lst (1)    =    "M"
                     move  03             to   v-num
           else if   w-tes-drg-lst (1)    =    "S"
                     move  04             to   v-num
           else if   w-tes-drg-lst (1)    =    "P"
                     move  05             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  spaces         to   w-tes-drg-lst (1)
           else if   v-num                =    02
                     move  "K"            to   w-tes-drg-lst (1)
           else if   v-num                =    03
                     move  "M"            to   w-tes-drg-lst (1)
           else if   v-num                =    04
                     move  "S"            to   w-tes-drg-lst (1)
           else if   v-num                =    05
                     move  "P"            to   w-tes-drg-lst (1)
           else      move  spaces         to   w-tes-drg-lst (1)      .
       acc-drg-lst-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-drg-lst (1)    not  = "M" and
                     w-tes-drg-lst (1)    not  = "S" and
                     w-tes-drg-lst (1)    not  = "P"
                     go to acc-drg-lst-600.
      *                  *---------------------------------------------*
      *                  * Se listino base : messaggio, reimpostazione *
      *                  *---------------------------------------------*
           if        w-tes-cod-lst        not  = spaces
                     go to acc-drg-lst-600.
           move      "Opzione non disponibile per il Listino Base !     
      -              "          "         to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
           go to     acc-drg-lst-100.
       acc-drg-lst-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Direttive generali listino        *
      *    *-----------------------------------------------------------*
       vis-drg-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Listino di riferimento       *
      *    *-----------------------------------------------------------*
       acc-rif-lst-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-lst-ope      .
           move      w-tes-rif-lst (1)    to   w-cod-cod-lst-cod      .
           move      15                   to   w-cod-cod-lst-lin      .
           move      30                   to   w-cod-cod-lst-pos      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
       ...
       acc-rif-lst-110.
           perform   cod-cod-zls-cll-000  thru cod-cod-zls-cll-999    .
           if        w-cod-cod-lst-ope    =    "F+"
                     go to acc-rif-lst-115.
           if        w-cod-cod-lst-ope    =    "AC"
                     go to acc-rif-lst-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rif-lst-115.
           perform   cod-cod-zls-foi-000  thru cod-cod-zls-foi-999    .
           go to     acc-rif-lst-110.
       acc-rif-lst-120.
           move      w-cod-cod-lst-cod    to   v-alf                  .
       acc-rif-lst-150.
      *              *-------------------------------------------------*
      ...
      *                  * Lettura tabella                             *
      *                  *---------------------------------------------*
           move      w-tes-rif-lst (1)    to   w-let-arc-zls-cod      .
           perform   let-arc-zls-000      thru let-arc-zls-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-zls-des    to   w-tes-rif-lst-des (1)  .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rif-lst-des-000  thru vis-rif-lst-des-999    .
      ...
      *                  *---------------------------------------------*
      *                  * Se listino di lavoro : messaggio e reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           if        w-let-arc-zls-wrk    =    spaces
                     go to acc-rif-lst-500.
      ...
      -              "oro !     "         to   w-err-box-err-msg      .
       ...
       acc-rif-lst-500.
      *                  *---------------------------------------------*
      *                  * Se listino di sconto o maggiorazione, a sua *
      *                  * volta : messaggio e reimpostazione          *
      *                  *---------------------------------------------*
           if        w-let-arc-zls-drg    not  = "M" and
                     w-let-arc-zls-drg    not  = "S"
                     go to acc-rif-lst-600.
           move      "Codice Listino corrispondente ad un Listino gia' d
      -              "i sconto  "         to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
           go to     acc-rif-lst-100.
       acc-rif-lst-600.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Listino di riferimento            *
      *    *-----------------------------------------------------------*
       vis-rif-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione listino riferimento   *
      *    *-----------------------------------------------------------*
       vis-rif-lst-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : % di sconto o maggiorazione          *
      *    *-----------------------------------------------------------*
       acc-per-lst-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      "<BD"                to   v-edm                  .
           move      17                   to   v-lin                  .
           move      w-edt-per-lst-c01    to   v-pos                  .
           if        w-edt-per-lst-c01    >    5
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "UP  "
                     go to acc-per-lst-650
           else if   v-key                =    "DOWN" or
                     v-key                =    spaces
                     go to acc-per-lst-700
           else if   v-key                =    "TAB "
                     go to acc-per-lst-630
           else if   v-key                =    "DO  "
                     go to acc-per-lst-800
           else if   v-key                =    "PRSC"
                     go to acc-per-lst-999
           else if   v-key                =    "NXSC"
                     go to acc-per-lst-999
           else      go to acc-per-lst-700.
       acc-per-lst-630.
      *              *-------------------------------------------------*
      *              * Se Tab                                          *
      *              *-------------------------------------------------*
           if        w-edt-per-lst-c01    =    05
                     go to acc-per-lst-999.
      *                  *---------------------------------------------*
      *                  * Incremento contatore                        *
      *                  *---------------------------------------------*
           add       1                    to   w-edt-per-lst-c01      .
           go to     acc-per-lst-100.
       acc-per-lst-650.
      *              *-------------------------------------------------*
      *              * Se Up                                           *
      *              *-------------------------------------------------*
           if        w-edt-per-lst-c01    =    1
                     go to acc-per-lst-999.
           subtract  1                    from w-edt-per-lst-c01      .
           go to     acc-per-lst-100.
       acc-per-lst-700.
      *              *-------------------------------------------------*
      *              * Se Down o Return                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : % di sconto o maggiorazione       *
      *    *-----------------------------------------------------------*
       vis-per-lst-000.
      *              *-------------------------------------------------*
      *              * Se cliente principale                           *
      *              *-------------------------------------------------*
           move      spaces               to   w-edt-per-lst-edt      .
           move      zero                 to   w-edt-per-lst-c01      .
       vis-per-lst-200.
           add       1                    to   w-edt-per-lst-c01      .
           if        w-edt-per-lst-c01    >    5
                     go to vis-per-lst-500.
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      02                   to   v-car                  .
           move      01                   to   v-dec                  .
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-edt-per-lst-per
                                              (w-edt-per-lst-c01)     .
           go to     vis-per-lst-200.
       vis-per-lst-500.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-edt-per-lst-edt    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       vis-per-lst-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      "Manca la descrizione per il listino               
      -              "      "             to   w-err-box-err-msg      .
      ...
      *              *-------------------------------------------------*
      ...
      -              "      "             to   w-err-box-err-msg      .
       ...
       cnt-tdo-nok-300.
      *              *-------------------------------------------------*
      *              * Controllo su Listino di riferimento             *
      *              *-------------------------------------------------*
           if        w-tes-drg-lst (1)    not  = "M" and
                     w-tes-drg-lst (1)    not  = "S"
                     go to cnt-tdo-nok-800.
           if        w-tes-rif-lst (1)    not  = w-tes-cod-lst
                     go to cnt-tdo-nok-400.
           move      "Un listino non puo' riferirsi a se stesso !       
      -              "      "             to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-400.
      *              *-------------------------------------------------*
      *              * Controllo su % di sconto o maggiorazione        *
      *              *-------------------------------------------------*
           if        w-tes-per-lst (1, 1) not  = zero
                     go to cnt-tdo-nok-800.
           move      "Manca almeno una % relativa al listino di riferime
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Su flag per 'listino di lavoro'             *
      *                  *---------------------------------------------*
           if        w-tes-wrk-lst (1)    not  = "#"
                     move  spaces         to   w-tes-wrk-lst (1)      .
      *                  *---------------------------------------------*
      *                  * Listino di riferimento e %                  *
      *                  *---------------------------------------------*
           if        w-tes-drg-lst (1)    =    "M" or
                     w-tes-drg-lst (1)    =    "S"
                     go to cnt-tdo-nok-850.
      *                  *---------------------------------------------*
      *                  * Normalizzazione                             *
      *                  *---------------------------------------------*
           move      spaces               to   w-tes-rif-lst (1)      .
           move      spaces               to   w-tes-rif-lst-des (1)  .
           move      zero                 to   w-tes-per-lst (1, 1)   .
           move      zero                 to   w-tes-per-lst (1, 2)   .
           move      zero                 to   w-tes-per-lst (1, 3)   .
           move      zero                 to   w-tes-per-lst (1, 4)   .
           move      zero                 to   w-tes-per-lst (1, 5)   .
       cnt-tdo-nok-850.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-lst (1)      .
           move      spaces               to   w-tes-cod-vlt (1)      .
           move      spaces               to   w-tes-cod-vlt-des (1)  .
           move      spaces               to   w-tes-wrk-lst (1)      .
           move      spaces               to   w-tes-drg-lst (1)      .
           move      spaces               to   w-tes-rif-lst (1)      .
           move      spaces               to   w-tes-rif-lst-des (1)  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-lst        to   rf-zls-cod-lst         .
           move      "pgm/dcp/fls/ioc/obj/iofzls"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-zls-des-lst       to   w-tes-des-lst (1)      .
           move      rf-zls-cod-vlt       to   w-tes-cod-vlt (1)      .
           move      rf-zls-wrk-lst       to   w-tes-wrk-lst (1)      .
           move      rf-zls-drg-lst       to   w-tes-drg-lst (1)      .
           move      rf-zls-rif-lst       to   w-tes-rif-lst (1)      .
           move      rf-zls-per-lst (1)   to   w-tes-per-lst (1, 1)   .
           move      rf-zls-per-lst (2)   to   w-tes-per-lst (1, 2)   .
           move      rf-zls-per-lst (3)   to   w-tes-per-lst (1, 3)   .
           move      rf-zls-per-lst (4)   to   w-tes-per-lst (1, 4)   .
           move      rf-zls-per-lst (5)   to   w-tes-per-lst (1, 5)   .
      *
           if        rf-zls-per-lst (1)   not  numeric
                     move  zero           to   w-tes-per-lst (1, 1)   .
           if        rf-zls-per-lst (2)   not  numeric
                     move  zero           to   w-tes-per-lst (1, 2)   .
           if        rf-zls-per-lst (3)   not  numeric
                     move  zero           to   w-tes-per-lst (1, 3)   .
           if        rf-zls-per-lst (4)   not  numeric
                     move  zero           to   w-tes-per-lst (1, 4)   .
           if        rf-zls-per-lst (5)   not  numeric
                     move  zero           to   w-tes-per-lst (1, 5)   .
      *
           move      rf-zls-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      *                      * Determinazione valori indotti           *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Codice valuta                       *
      *                          *-------------------------------------*
           ...
           move      w-let-arc-zvl-des    to   w-tes-cod-vlt-des (1)  .
      *                          *-------------------------------------*
      *                          * Descrizione per codice listino di   *
      *                          * riferimento                         *
      *                          *-------------------------------------*
           move      w-tes-rif-lst (1)    to   w-let-arc-zls-cod      .
           perform   let-arc-zls-000      thru let-arc-zls-999        .
      ...
      *                  * Descrizione listino                         *
      *                  *---------------------------------------------*
           move      "Listino Base"       to   w-tes-des-lst (1)      .
      *                  *---------------------------------------------*
      *                  * Codice valuta listino                       *
      *                  *---------------------------------------------*
           move      c-sgl                to   w-tes-cod-vlt (1)      .
      *                  *---------------------------------------------*
      *                  * Segnale di listino 'di lavoro'              *
      *                  *---------------------------------------------*
           move      spaces               to   w-tes-wrk-lst (1)      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione dati testata                *
      ...
      *                      * Write record [zls]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zls-000      thru wrt-rec-zls-999        .
      ...
      *                      * Rewrite record [zls]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zls-000      thru rew-rec-zls-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zls]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zls-000      thru del-rec-zls-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zls]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zls-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-lst (1)    to   rf-zls-des-lst         .
           move      w-tes-cod-vlt (1)    to   rf-zls-cod-vlt         .
           move      w-tes-wrk-lst (1)    to   rf-zls-wrk-lst         .
           move      w-tes-drg-lst (1)    to   rf-zls-drg-lst         .
           move      w-tes-rif-lst (1)    to   rf-zls-rif-lst         .
           move      w-tes-per-lst (1, 1) to   rf-zls-per-lst (1)     .
           move      w-tes-per-lst (1, 2) to   rf-zls-per-lst (2)     .
           move      w-tes-per-lst (1, 3) to   rf-zls-per-lst (3)     .
           move      w-tes-per-lst (1, 4) to   rf-zls-per-lst (4)     .
           move      w-tes-per-lst (1, 5) to   rf-zls-per-lst (5)     .
           move      w-tes-alx-exp (1)    to   rf-zls-alx-exp         .
       cmp-rec-zls-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zls]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zls-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zls-000      thru cmp-rec-zls-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
