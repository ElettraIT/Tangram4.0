      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione Classi prodotto              *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-zp1-cla      .
           move      14                   to   w-cod-mne-zp1-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zp1-ope      .
           move      rr-cod-max           to   w-cod-mne-zp1-cla      .
           move      14                   to   w-cod-mne-zp1-lin      .
           move      52                   to   w-cod-mne-zp1-pos      .
           move      zero                 to   w-cod-mne-zp1-dln      .
           move      zero                 to   w-cod-mne-zp1-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zp1-cod-cla         .
           move      "pgm/dcp/fls/ioc/obj/iofzp1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-zp1-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-mne-min           to   rf-zp1-mne-cla         .
           move      zero                 to   rf-zp1-cod-cla         .
           move      "pgm/dcp/fls/ioc/obj/iofzp1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-sqz-min           to   rf-zp1-sqz-num         .
           move      zero                 to   rf-zp1-cod-cla         .
           move      "pgm/dcp/fls/ioc/obj/iofzp1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zp1-cod-cla       <    rr-cod-min or
                     rf-zp1-cod-cla       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zp1-des-key       <    rr-des-min or
                     rf-zp1-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zp1-mne-cla       <    rr-mne-min or
                     rf-zp1-mne-cla       >    rr-mne-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su numero di sequenza                 *
      *              *-------------------------------------------------*
           if        rf-zp1-sqz-num       <    rr-sqz-min or
                     rf-zp1-sqz-num       >    rr-sqz-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-zp1-cod-cla       to   w-mpn-cod-cla          .
           move      rf-zp1-des-cla       to   w-mpn-des-cla          .
           move      rf-zp1-ult-sud       to   w-mpn-ult-sud          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
