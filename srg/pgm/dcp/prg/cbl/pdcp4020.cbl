      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcp4021:        *
      *                                                                *
      *                    Stampa archivio prodotti - rubrica o scheda *
      *                    completa                                    *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-prs.
      *        *-------------------------------------------------------*
      *        * Parametri per le overlay 'pdcp402X', a..z             *
      *        *-------------------------------------------------------*
           05  w-prs-dcp-402.
      *            *---------------------------------------------------*
      *            * Parametri per stampa rubrica                      *
      *            *---------------------------------------------------*
               10  w-prs-dcp-402-sru      pic  x(01)                  .
               10  filler                 pic  x(01)                  .
               10  w-prs-dcp-402-cru      pic  9(03)                  .
               10  filler                 pic  x(01)                  .
               10  w-prs-dcp-402-lru      pic  9(03)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Parametri per stampa scheda completa              *
      *            *---------------------------------------------------*
               10  w-prs-dcp-402-ssc      pic  x(01)                  .
               10  filler                 pic  x(01)                  .
               10  w-prs-dcp-402-csc      pic  9(03)                  .
               10  filler                 pic  x(01)                  .
               10  w-prs-dcp-402-lsc      pic  9(03)                  .
               10  filler                 pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    "E"
                     go to nam-pat-exe-100
           else      go to nam-pat-exe-500.
       nam-pat-exe-100.
      *              *-------------------------------------------------*
      *              * Se stampa semplice elenco                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Name                                        *
      *                  *---------------------------------------------*
           inspect   i-exe-pro replacing  all  "?"
                                          by   w-prs-dcp-402-sru      .
      *                  *---------------------------------------------*
      *                  * Pathname                                    *
      *                  *---------------------------------------------*
      ...
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     nam-pat-exe-999.
       nam-pat-exe-500.
      *              *-------------------------------------------------*
      *              * Se stampa scheda completa                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Name                                        *
      *                  *---------------------------------------------*
           inspect   i-exe-pro replacing  all  "?"
                                          by   w-prs-dcp-402-ssc      .
      *                  *---------------------------------------------*
      *                  * Pathname                                    *
      *                  *---------------------------------------------*
           inspect   i-exe-pat replacing  all  "?"
      ...
      *              *-------------------------------------------------*
           perform   prs-dcp-402-000      thru prs-dcp-402-999        .
       pre-exe-pgm-999.
           exit.

      *    *===========================================================*
      *    * Lettura della personalizzazione per il trattamento delle  *
      *    * overaly del programma 'dcp402'                            *
      *    *-----------------------------------------------------------*
       prs-dcp-402-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "1"                  to   w-prs-dcp-402-sru      .
           move      080                  to   w-prs-dcp-402-cru      .
           move      030                  to   w-prs-dcp-402-lru      .
           move      "2"                  to   w-prs-dcp-402-ssc      .
           move      096                  to   w-prs-dcp-402-csc      .
           move      066                  to   w-prs-dcp-402-lsc      .
       prs-dcp-402-200.
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     prs-dcp-402-900.
       prs-dcp-402-300.
      *              *-------------------------------------------------*
      ...
      *                  * rea di destinazione                         *
      *                  *---------------------------------------------*
           move      s-alf                to   w-prs-dcp-402          .
       prs-dcp-402-400.
      *                  *---------------------------------------------*
      *                  * Controllo parametri                         *
      *                  *---------------------------------------------*
           if        w-prs-dcp-402-sru    <    "a" or
                     w-prs-dcp-402-sru    >    "z"
                     move  "1"            to   w-prs-dcp-402-sru      .
      *
           if        w-prs-dcp-402-cru    <    1   or
                     w-prs-dcp-402-cru    >    220
                     move  080            to   w-prs-dcp-402-cru      .
      *
           if        w-prs-dcp-402-lru    <    1   or
                     w-prs-dcp-402-lru    >    96
                     move  030            to   w-prs-dcp-402-lru      .
      *
           if        w-prs-dcp-402-ssc    <    "a" or
                     w-prs-dcp-402-ssc    >    "z"
                     move  "2"            to   w-prs-dcp-402-ssc      .
      *
           if        w-prs-dcp-402-csc    <    1   or
                     w-prs-dcp-402-csc    >    220
                     move  096            to   w-prs-dcp-402-csc      .
      *
           if        w-prs-dcp-402-lsc    <    1   or
                     w-prs-dcp-402-lsc    >    96
                     move  066            to   w-prs-dcp-402-lsc      .
       prs-dcp-402-450.
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Tipo di stampa             *
      *    *-----------------------------------------------------------*
       acc-tip-stp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    "E"
                     move  w-prs-dcp-402-cru
                                          to   w-cnt-stp-amp-lin
           else      move  w-prs-dcp-402-csc
                                          to   w-cnt-stp-amp-lin      .
      *              *-------------------------------------------------*
      *              * Top margin in linee                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    "E"
                     move  w-prs-dcp-402-lru
                                          to   w-cnt-stp-lin-min
           else      move  w-prs-dcp-402-lsc
                                          to   w-cnt-stp-lin-min      .
      *              *-------------------------------------------------*
      *              * Bottom margin in linee                          *
      *              *-------------------------------------------------*
