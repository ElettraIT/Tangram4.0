      ...
      *                                   Fase:    dcp330              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 04/01/95    *
      *                       Ultima revisione:    NdK del 11/10/07    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase dcp330, nella sua globalita', esegue i tipi di opera-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * DUPLST      Duplicazione prezzi da un listino ad un altro      *
      *                                                                *
      * AGGLST      Aggiornamenti automatici prezzi di listino         *
      *                                                                *
      * AZZLST      Azzeramento prezzi di un listino                   *
      *                                                                *
      * CANLST      Cancellazione prezzi di un listino                 *
      *                                                                *
      * STOLST      Storicizzazione di uno o piu' listini              *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'dcp330'           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Parametri per storicizzazione listino base  *
      *                  *---------------------------------------------*
           perform   ref-psl-bas-000      thru ref-psl-bas-999        .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Lettura delle referenze Parametri per storicizzazione     *
      *    * listino base                                              *
      *    *-----------------------------------------------------------*
       ref-psl-bas-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "R:"                 to   s-ope                  .
           move      "pgm/dcp/lst/dcp330[psl-bas]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-ref-psl-bas
           else      move  spaces         to   w-ref-psl-bas          .
      *              *-------------------------------------------------*
      *              * Normalizzazioni                                 *
      *              *-------------------------------------------------*
           if        w-ref-psl-bas-snp    not  = "N" and
                     w-ref-psl-bas-snp    not  = "S"
                     move  "N"            to   w-ref-psl-bas-snp      .
      *
           if        w-ref-psl-bas-snv    not  = "N" and
                     w-ref-psl-bas-snv    not  = "S"
                     move  "N"            to   w-ref-psl-bas-snv      .
      *
           if        w-ref-psl-bas-sns    not  = "N" and
                     w-ref-psl-bas-sns    not  = "S"
                     move  "N"            to   w-ref-psl-bas-sns      .
       ref-psl-bas-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "Duplicazione prezzi da un listino ad un altro     
      -              " DUPLST     pdcp330a  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Aggiornamenti automatici prezzi di listino        
      -              " AGGLST     pdcp330b  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Azzeramento prezzi di un listino                  
      -              " AZZLST     pdcp330c  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Cancellazione prezzi di un listino                
      -              " CANLST     pdcp330d  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Storicizzazione di uno o piu' listini             
      -              " STOLST     pdcp330h  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
