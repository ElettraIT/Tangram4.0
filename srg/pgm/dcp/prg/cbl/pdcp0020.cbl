      ...
      *                                   Fase:    dcp002              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 31/07/08    *
      *                       Ultima revisione:    NdK del 31/07/08    *
      *                    ------------------------------------------- *
      ...
      *                    ------------------------------------------- *
      *                                                                *
      *                    Richiama il programma pdcp0010 dopo aver    *
      *                    preparato una opportuna variabile di i.p.c. *
      *                                                                *
      *                    N.B.: utilizzato in alternativa al tasto F4 *
      *                          in accettazione ai codici filtro      *
      *                                                                *
      *================================================================*
