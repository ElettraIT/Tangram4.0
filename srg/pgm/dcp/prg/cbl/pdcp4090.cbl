      ...
      *                       Ultima revisione:    NdK del 11/03/03    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase dcp409, nella sua globalita', esegue i tipi di inter-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * CODMAN      Controllo prodotti con codici mancanti             *
      *                                                                *
      * CODERR      Controllo prodotti con codici errati               *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPE DI CONTROLLO ANAGRAFICA PRODOTTI "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'dcp409'           *
      *              *-------------------------------------------------*
           perform   fas-dcp-409-000      thru fas-dcp-409-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              * stazione                                        *
      *              *-------------------------------------------------*
           move      "Controllo prodotti mancanti di codici             
      -              "           CODMAN     pdcp409b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *       
           move      "Controllo prodotti con codici tabelle errati       
      -              "           CODERR     pdcp409c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *       
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-dcp-409-300
           else if   v-key                =    "PRSC"
                     go to fas-dcp-409-400
           else if   v-key                =    "NXSC"
                     go to fas-dcp-409-450
           else if   v-key                =    "DOWN"
                     go to fas-dcp-409-500
           else if   v-key                =    "EXIT"
                     go to fas-dcp-409-250
           else      go to fas-dcp-409-200.
       fas-dcp-409-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-dcp-409-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-dcp-409-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-dcp-409-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-dcp-409-350
           else      go to fas-dcp-409-322.
       fas-dcp-409-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-dcp-409-630
           else if   v-key                =    "PRSC"
                     go to fas-dcp-409-600
           else if   v-key                =    "NXSC"
                     go to fas-dcp-409-610
           else if   v-key                =    "UP  "
                     go to fas-dcp-409-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-dcp-409-650
           else if   v-key                =    "EXIT"
                     go to fas-dcp-409-660
           else      go to fas-dcp-409-570.
       fas-dcp-409-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-dcp-409-626
           else      go to fas-dcp-409-628.
       fas-dcp-409-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-dcp-409-636
           else      go to fas-dcp-409-638.
       fas-dcp-409-636.
      *                          *-------------------------------------*
