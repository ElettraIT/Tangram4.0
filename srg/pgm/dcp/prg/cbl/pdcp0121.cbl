      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcp0120  *
      *                                                                *
      *                    Stampa tipi variante                        *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      "TIPI VARIANTE"      to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
