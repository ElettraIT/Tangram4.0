      ...
      *                                   Fase:    dcp450              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/06/97    *
      ...
      *                                                                *
      *                    Manutenzione dati gestione sottoscorta      *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     " DATI PER GESTIONE SOTTOSCORTA PRODOTTI "       .
      ...
      *            *---------------------------------------------------*
               10  w-tes-sco-min          pic  9(06)v9(03)            .
               10  w-tes-sco-min-sns      pic  9(01)                  .
               10  w-tes-dua-min          pic  9(07)                  .
               10  w-tes-sco-sic          pic  9(06)v9(03)            .
               10  w-tes-sco-sic-sns      pic  9(01)                  .
               10  w-tes-dua-sic          pic  9(07)                  .
               10  w-tes-sco-max          pic  9(06)v9(03)            .
               10  w-tes-sco-max-sns      pic  9(01)                  .
               10  w-tes-dua-max          pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Valori sostitutivi                                *
      *            *---------------------------------------------------*
               10  w-tes-min-sos          pic  9(06)v9(03)            .
               10  w-tes-sic-sos          pic  9(06)v9(03)            .
               10  w-tes-max-sos          pic  9(06)v9(03)            .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-sco-min          pic  9(06)v9(03)            .
               10  w-rig-dua-min          pic  9(07)                  .
               10  w-rig-sco-sic          pic  9(06)v9(03)            .
               10  w-rig-dua-sic          pic  9(07)                  .
               10  w-rig-sco-max          pic  9(06)v9(03)            .
               10  w-rig-dua-max          pic  9(07)                  .
           05  w-rig-002.
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-sco-min  pic  x(11)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-sco-mes  pic  x(02)                  .
                   15  w-lin-imm-sco-bar  pic  x(01)                  .
                   15  w-lin-imm-sco-ann  pic  x(02)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Salvataggio per Scorta minima                         *
      *        *-------------------------------------------------------*
           05  w-sav-sco-min              pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Salvataggio per Scorta di sicurezza                   *
      *        *-------------------------------------------------------*
           05  w-sav-sco-sic              pic  9(06)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Salvataggio per Scorta massima                        *
      *        *-------------------------------------------------------*
           05  w-sav-sco-max              pic  9(06)v9(03)            .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per Det codice dipendenza per la gestione delle  *
      *        * ubicazioni                                            *
      *        *-------------------------------------------------------*
           05  w-det-dpz-ubi.
      *            *---------------------------------------------------*
      *            * Codice della dipendenza proveniente dalla segre-  *
      *            * teria                                             *
      *            *---------------------------------------------------*
               10  w-det-dpz-ubi-cod      pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Si/no possibilita' di gestire le ubicazioni per   *
      *            * il programma                                      *
      *            *---------------------------------------------------*
               10  w-det-dpz-ubi-snu      pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-lpt.
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Scorta minima                   *
      *        *-------------------------------------------------------*
           05  w-lpt-sco-min-lin          pic  9(03)    value 008     .
           05  w-lpt-sco-min-pos          pic  9(03)    value 030     .
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Scorta di sicurezza             *
      *        *-------------------------------------------------------*
           05  w-lpt-sco-sic-lin          pic  9(03)    value 010     .
           05  w-lpt-sco-sic-pos          pic  9(03)    value 030     .
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Scorta massima                  *
      *        *-------------------------------------------------------*
           05  w-lpt-sco-max-lin          pic  9(03)    value 012     .
           05  w-lpt-sco-max-pos          pic  9(03)    value 030     .
      ...
      *              *-------------------------------------------------*
      *              * Determinazione del codice dipendenza in uso per *
      *              * ammettere o meno l'accettabilita' dell'ubica-   *
      *              * zione                                           *
      *              *-------------------------------------------------*
           perform   det-dpz-ubi-000      thru det-dpz-ubi-999        .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Determinazione del codice dipendenza in uso per ammettere *
      *    * o meno l'accettabilita' dell'ubicazione                   *
      *    *-----------------------------------------------------------*
       det-dpz-ubi-000.
      *              *-------------------------------------------------*
      *              * Determinazione del codice dipendenza dalla      *
      *              * segreteria                                      *
      *              *-------------------------------------------------*
           move      "D<"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-num                to   w-det-dpz-ubi-cod      .
           if        w-det-dpz-ubi-cod    =    zero
                     move  01             to   w-det-dpz-ubi-cod      .
           if        w-det-dpz-ubi-cod    =    01
                     move  "S"            to   w-det-dpz-ubi-snu
           else      move  "N"            to   w-det-dpz-ubi-snu      .
       det-dpz-ubi-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       pmt-sco-min-000.
           ...
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-sco-min-lin    to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Scorta minima              :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
      ...
      *    *-----------------------------------------------------------*
       pmt-sco-sic-000.
           ...
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-sco-sic-lin    to   v-lin                  .
           move      01                   to   v-pos                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-sco-max-000.
           ...
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-sco-max-lin    to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Scorta massima             :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
      ...
      *    *===========================================================*
      *    * Accettazione campo : Scorta minima                        *
      *    *-----------------------------------------------------------*
       acc-sco-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      w-tes-sco-min        to   w-sav-sco-min          .
      *                  *---------------------------------------------*
      *                  * Test se richiesta sostituzione              *
      *                  *---------------------------------------------*
           if        w-tes-sco-min-sns    =    zero
      ...
      *              *-------------------------------------------------*
           ...
           move      "<BG"                to   v-edm                  .
           move      w-lpt-sco-min-lin    to   v-lin                  .
           move      w-lpt-sco-min-pos    to   v-pos                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      "[1] "               to   v-pfk (14)             .
           move      w-tes-sco-min        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-sco-min          .
       acc-sco-min-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-sco-min-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-sco-min-sos-000  thru acc-sco-min-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sco-min-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-sco-min-sos-000  thru vis-sco-min-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-sco-min-sns    not  = zero
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Scorta minima                     *
      *    *-----------------------------------------------------------*
       vis-sco-min-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-sco-min-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-sco-min-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-sco-min-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-sco-min-sos-010.
      ...
      *                  *---------------------------------------------*
           perform   vis-sco-min-so1-000  thru vis-sco-min-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-sco-min-so2-000  thru vis-sco-min-so2-999    .
       acc-sco-min-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-sco-min-so1-000  thru acc-sco-min-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sco-min-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-sco-min-sos-600.
       acc-sco-min-sos-300.
      *                  *---------------------------------------------*
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-sco-min-so2-000  thru acc-sco-min-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sco-min-sos-600.
           if        v-key                =    "UP  "
                     go to acc-sco-min-sos-200.
       acc-sco-min-sos-600.
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-sco-min        =    zero  and
                     w-tes-min-sos        =    zero
                     go to acc-sco-min-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-sco-min        not  = w-tes-min-sos
                     go to acc-sco-min-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-min-sos          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-sco-min        not  = zero or
                     w-tes-min-sos        not  = zero
                     move  1              to   w-tes-sco-min-sns      .
       acc-sco-min-sos-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-sco-min-sns    =    zero
                     go to vis-sco-min-sos-100
           else      go to vis-sco-min-sos-500.
       vis-sco-min-sos-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-sco-min-so2-999.
       acc-sco-min-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-min-sos          .
       acc-sco-min-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Scorta di sicurezza                  *
      *    *-----------------------------------------------------------*
       acc-sco-sic-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore attuale                  *
      *                  *---------------------------------------------*
           move      w-tes-sco-sic        to   w-sav-sco-sic          .
      *                  *---------------------------------------------*
      *                  * Test se richiesta sostituzione              *
      *                  *---------------------------------------------*
           if        w-tes-sco-sic-sns    =    zero
      ...
      *              *-------------------------------------------------*
           ...
           move      "<BG"                to   v-edm                  .
           move      w-lpt-sco-sic-lin    to   v-lin                  .
           move      w-lpt-sco-sic-pos    to   v-pos                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      "[1] "               to   v-pfk (14)             .
           move      w-tes-sco-sic        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Cancellazione eventuali note operative          *
      *              *-------------------------------------------------*
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-sco-sic          .
       acc-sco-sic-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-sco-sic-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-sco-sic-sos-000  thru acc-sco-sic-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sco-sic-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-sco-sic-sos-000  thru vis-sco-sic-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-sco-sic-sns    not  = zero
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Scorta di sicurezza               *
      *    *-----------------------------------------------------------*
       vis-sco-sic-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  * Normalizzazione segnale di sostituzione     *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-sco-sic-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-sco-sic-pos    to   v-pos                  .
           subtract  1                    from v-pos                  .
           move      w-lpt-sco-sic-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-sco-sic-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-sco-sic-sos-010.
      ...
      *                  * Visualizzazione valore da sostituire        *
      *                  *---------------------------------------------*
           perform   vis-sco-sic-so1-000  thru vis-sco-sic-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-sco-sic-so2-000  thru vis-sco-sic-so2-999    .
       acc-sco-sic-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-sco-sic-so1-000  thru acc-sco-sic-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sco-sic-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-sco-sic-sos-600.
       acc-sco-sic-sos-300.
      *                  *---------------------------------------------*
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-sco-sic-so2-000  thru acc-sco-sic-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sco-sic-sos-600.
           if        v-key                =    "UP  "
                     go to acc-sco-sic-sos-200.
       acc-sco-sic-sos-600.
      *              *-------------------------------------------------*
      *              * Controlli su valori accettati                   *
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-sco-sic        =    zero  and
                     w-tes-sic-sos        =    zero
                     go to acc-sco-sic-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-sco-sic        not  = w-tes-sic-sos
                     go to acc-sco-sic-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-sic-sos          .
      *                      *-----------------------------------------*
      *                      * Segnale di sostituzione non effettuata  *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-sco-sic-sns      .
      ...
      *                  * Segnale di sostituzione effettuata          *
      *                  *---------------------------------------------*
           if        w-tes-sco-sic        not  = zero or
                     w-tes-sic-sos        not  = zero
                     move  1              to   w-tes-sco-sic-sns      .
       acc-sco-sic-sos-900.
      *              *-------------------------------------------------*
      *              * Normalizzazione stato di uscita                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-sco-sic-sns    =    zero
                     go to vis-sco-sic-sos-100
           else      go to vis-sco-sic-sos-500.
       vis-sco-sic-sos-100.
      *              *-------------------------------------------------*
      *              * Se sostituzione non effettuata                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-sco-sic-so2-999.
       acc-sco-sic-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-sic-sos          .
       acc-sco-sic-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Scorta massima                       *
      *    *-----------------------------------------------------------*
       acc-sco-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore attuale                  *
      *                  *---------------------------------------------*
           move      w-tes-sco-max        to   w-sav-sco-max          .
      *                  *---------------------------------------------*
      *                  * Test se richiesta sostituzione              *
      *                  *---------------------------------------------*
           if        w-tes-sco-max-sns    =    zero
      ...
      *              *-------------------------------------------------*
           ...
           move      "<BG"                to   v-edm                  .
           move      w-lpt-sco-max-lin    to   v-lin                  .
           move      w-lpt-sco-max-pos    to   v-pos                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      "[1] "               to   v-pfk (14)             .
           move      w-tes-sco-max        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Cancellazione eventuali note operative          *
      *              *-------------------------------------------------*
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-sco-max          .
       acc-sco-max-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-sco-max-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-sco-max-sos-000  thru acc-sco-max-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sco-max-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-sco-max-sos-000  thru vis-sco-max-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-sco-max-sns    not  = zero
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Scorta massima                    *
      *    *-----------------------------------------------------------*
       vis-sco-max-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  * Normalizzazione segnale di sostituzione     *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-sco-max-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-sco-max-pos    to   v-pos                  .
           subtract  1                    from v-pos                  .
           move      w-lpt-sco-max-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-sco-max-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-sco-max-sos-010.
      ...
      *                  * Visualizzazione valore da sostituire        *
      *                  *---------------------------------------------*
           perform   vis-sco-max-so1-000  thru vis-sco-max-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-sco-max-so2-000  thru vis-sco-max-so2-999    .
       acc-sco-max-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-sco-max-so1-000  thru acc-sco-max-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sco-max-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-sco-max-sos-600.
       acc-sco-max-sos-300.
      *                  *---------------------------------------------*
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-sco-max-so2-000  thru acc-sco-max-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sco-max-sos-600.
           if        v-key                =    "UP  "
                     go to acc-sco-max-sos-200.
       acc-sco-max-sos-600.
      *              *-------------------------------------------------*
      *              * Controlli su valori accettati                   *
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-sco-max        =    zero  and
                     w-tes-max-sos        =    zero
                     go to acc-sco-max-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-sco-max        not  = w-tes-max-sos
                     go to acc-sco-max-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-max-sos          .
      *                      *-----------------------------------------*
      *                      * Segnale di sostituzione non effettuata  *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-sco-max-sns      .
      ...
      *                  * Segnale di sostituzione effettuata          *
      *                  *---------------------------------------------*
           if        w-tes-sco-max        not  = zero or
                     w-tes-max-sos        not  = zero
                     move  1              to   w-tes-sco-max-sns      .
       acc-sco-max-sos-900.
      *              *-------------------------------------------------*
      *              * Normalizzazione stato di uscita                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-sco-max-sns    =    zero
                     go to vis-sco-max-sos-100
           else      go to vis-sco-max-sos-500.
       vis-sco-max-sos-100.
      *              *-------------------------------------------------*
      *              * Se sostituzione non effettuata                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-sco-max-so2-999.
       acc-sco-max-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-max-sos          .
       acc-sco-max-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Scorta minima                               *
      *                  *---------------------------------------------*
           perform   acc-rig-min-000      thru acc-rig-min-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * Scorta minima, data                         *
      *                  *---------------------------------------------*
           perform   acc-rig-dmi-000      thru acc-rig-dmi-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Scorta di sicurezza                         *
      *                  *---------------------------------------------*
           perform   acc-rig-sic-000      thru acc-rig-sic-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
                     go to acc-cor-reg-200.
       acc-cor-reg-275.
      *                  *---------------------------------------------*
      *                  * Scorta di sicurezza, data                   *
      *                  *---------------------------------------------*
           perform   acc-rig-dsi-000      thru acc-rig-dsi-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Scorta massima                              *
      *                  *---------------------------------------------*
           perform   acc-rig-max-000      thru acc-rig-max-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
                     go to acc-cor-reg-250.
      ...
      *                  * Scorta massima, data                        *
      *                  *---------------------------------------------*
           perform   acc-rig-dma-000      thru acc-rig-dma-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
                     go to acc-cor-reg-250.
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "B"                  to   v-edm                  .
           move      w-rig-sco-min        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * In campo per la visualizzazione         *
      *                      *-----------------------------------------*
           move      v-edt                to   w-lin-imm-sco-min      .
       vis-lin-cor-520.
      *                  *---------------------------------------------*
      *                  * Scorta minima, mese                         *
      *                  *---------------------------------------------*
      ...
      *                      * Test sul valore                         *
      *                      *-----------------------------------------*
           if        w-rig-dua-min        =    zero
                     move  spaces         to   w-lin-imm-sco-mes
                     move  spaces         to   w-lin-imm-sco-mes
                     move  spaces         to   w-lin-imm-sco-mes
      ...
      *                      * In campo per la visualizzazione         *
      *                      *-----------------------------------------*
           move      v-edt                to   w-lin-imm-sco-mes      .
       vis-lin-cor-530.
      *                  *---------------------------------------------*
      *                  * Scorta minima, barra                        *
      *                  *---------------------------------------------*
           move      "/"                  to   w-lin-imm-sco-bar      .
       vis-lin-cor-540.
      *                  *---------------------------------------------*
      *                  * Scorta minima, anno                         *
      *                  *---------------------------------------------*
      ...
      *                      * In campo per la visualizzazione         *
      *                      *-----------------------------------------*
           move      v-edt                to   w-lin-imm-sco-ann      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              * Scorta minima                                   *
      *              *-------------------------------------------------*
           perform   vis-rig-min-000      thru vis-rig-min-999        .
           perform   vis-rig-dmi-000      thru vis-rig-dmi-999        .
      *              *-------------------------------------------------*
      *              * Scorta di sicurezza                             *
      *              *-------------------------------------------------*
           perform   vis-rig-sic-000      thru vis-rig-sic-999        .
           perform   vis-rig-dsi-000      thru vis-rig-dsi-999        .
      *              *-------------------------------------------------*
      *              * Scorta massima                                  *
      *              *-------------------------------------------------*
           perform   vis-rig-max-000      thru vis-rig-max-999        .
           perform   vis-rig-dma-000      thru vis-rig-dma-999        .
       vis-rig-cor-999.
           exit.
      ...
      *              * Scorta minima                                   *
      *              *-------------------------------------------------*
           perform   pmt-rig-min-000      thru pmt-rig-min-999        .
      *              *-------------------------------------------------*
      *              * Scorta di sicurezza                             *
      *              *-------------------------------------------------*
           perform   pmt-rig-sic-000      thru pmt-rig-sic-999        .
      *              *-------------------------------------------------*
      *              * Scorta massima                                  *
      *              *-------------------------------------------------*
           perform   pmt-rig-max-000      thru pmt-rig-max-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-min-999.
       acc-rig-min-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-sco-min          .
       acc-rig-min-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Eventuale aggiornamento data relativa       *
      *                  *---------------------------------------------*
           if        w-rig-sco-min        =    zero
                     go to acc-rig-min-800.
           if        w-rig-dua-min        >    zero
                     go to acc-rig-min-800.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Scorta minima, data                  *
      *    *-----------------------------------------------------------*
       acc-rig-dmi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-dmi-999.
       acc-rig-dmi-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-rig-dua-min          .
       acc-rig-dmi-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-rig-flg
                             ...
                             go to acc-rig-dmi-100.
       acc-rig-dmi-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Scorta minima, data               *
      *    *-----------------------------------------------------------*
       vis-rig-dmi-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-sic-999.
       acc-rig-sic-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-sco-sic          .
       acc-rig-sic-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Scorta di sicurezza, data            *
      *    *-----------------------------------------------------------*
       acc-rig-dsi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-dsi-999.
       acc-rig-dsi-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-rig-dua-sic          .
       acc-rig-dsi-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-rig-flg
                             ...
                             go to acc-rig-dsi-100.
       acc-rig-dsi-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Scorta di sicurezza, data         *
      *    *-----------------------------------------------------------*
       vis-rig-dsi-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-max-999.
       acc-rig-max-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-sco-max          .
       acc-rig-max-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Scorta massima, data                 *
      *    *-----------------------------------------------------------*
       acc-rig-dma-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-dma-999.
       acc-rig-dma-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-rig-dua-max          .
       acc-rig-dma-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-rig-flg
                             ...
                             go to acc-rig-dma-100.
       acc-rig-dma-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Scorta massima, data              *
      *    *-----------------------------------------------------------*
       vis-rig-dma-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tes-sco-min          .
           move      zero                 to   w-tes-sco-min-sns      .
           move      zero                 to   w-tes-dua-min          .
           move      zero                 to   w-tes-sco-sic          .
           move      zero                 to   w-tes-sco-sic-sns      .
           move      zero                 to   w-tes-dua-sic          .
           move      zero                 to   w-tes-sco-max          .
           move      zero                 to   w-tes-sco-max-sns      .
           move      zero                 to   w-tes-dua-max          .
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-sco-min          .
           move      zero                 to   w-rig-dua-min          .
           move      zero                 to   w-rig-sco-sic          .
           move      zero                 to   w-rig-dua-sic          .
           move      zero                 to   w-rig-sco-max          .
           move      zero                 to   w-rig-dua-max          .
       nor-nok-rig-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      w-det-dpz-ubi-cod    to   rf-fbs-cod-dpz         .
           move      "pgm/fab/fls/ioc/obj/ioffbs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              * Scorta minima                                   *
      *              *-------------------------------------------------*
           if        w-tes-sco-min-sns    =    zero and
                     w-tes-sco-min        =    zero
                     go to sel-rec-dcp-200.
           if        rf-fbs-sco-min (1)   not  = w-tes-sco-min
                     go to sel-rec-dcp-900.
       sel-rec-dcp-200.
      *              *-------------------------------------------------*
      *              * Scorta di sicurezza                             *
      *              *-------------------------------------------------*
           if        w-tes-sco-sic-sns    =    zero and
                     w-tes-sco-sic        =    zero
                     go to sel-rec-dcp-300.
           if        rf-fbs-sco-sic (1)   not  = w-tes-sco-sic
                     go to sel-rec-dcp-900.
       sel-rec-dcp-300.
      *              *-------------------------------------------------*
      *              * Scorta massima                                  *
      *              *-------------------------------------------------*
           if        w-tes-sco-max-sns    =    zero and
                     w-tes-sco-max        =    zero
                     go to sel-rec-dcp-800.
           if        rf-fbs-sco-max (1)   not  = w-tes-sco-max
                     go to sel-rec-dcp-900.
       sel-rec-dcp-800.
      *              *-------------------------------------------------*
      ...
      *                      * record [fbs]                            *
      *                      *-----------------------------------------*
           move      rf-fbs-sco-min (1)   to   w-rig-sco-min          .
           move      rf-fbs-dua-min (1)   to   w-rig-dua-min          .
           move      rf-fbs-sco-sic (1)   to   w-rig-sco-sic          .
           move      rf-fbs-dua-sic (1)   to   w-rig-dua-sic          .
           move      rf-fbs-sco-max (1)   to   w-rig-sco-max          .
           move      rf-fbs-dua-max (1)   to   w-rig-dua-max          .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-min-sos        to   w-rig-sco-min          .
           if        w-rig-dua-min        =    zero and
                     w-rig-sco-min        >    zero
                     move  s-dat          to   w-rig-dua-min          .
       car-eff-rig-sos-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-sic-sos        to   w-rig-sco-sic          .
           if        w-rig-dua-sic        =    zero and
                     w-rig-sco-sic        >    zero
                     move  s-dat          to   w-rig-dua-sic          .
       car-eff-rig-sos-300.
      *              *-------------------------------------------------*
      *              * Scorta massima                                  *
      *              *-------------------------------------------------*
           ...
           move      w-tes-max-sos        to   w-rig-sco-max          .
           if        w-rig-dua-max        =    zero and
                     w-rig-sco-max        >    zero
                     move  s-dat          to   w-rig-dua-max          .
       car-eff-rig-sos-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       sca-fil-rap-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore records [fbs] scritti *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-sco-min-sns    not  = zero or
                     w-tes-sco-sic-sns    not  = zero or
                     w-tes-sco-max-sns    not  = zero
      ...
      *              *-------------------------------------------------*
           ...
           move      "MAGDPZ    "         to   f-key                  .
           move      01                   to   rf-fbs-tip-mag         .
           move      w-rig-num-pro        to   rf-fbs-num-mag         .
           move      spaces               to   rf-fbs-var-mag         .
           move      w-det-dpz-ubi-cod    to   rf-fbs-cod-dpz         .
           move      "pgm/fab/fls/ioc/obj/ioffbs"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           move      w-rig-sco-min        to   rf-fbs-sco-min (1)     .
           move      w-rig-dua-min        to   rf-fbs-dua-min (1)     .
           move      w-rig-sco-sic        to   rf-fbs-sco-sic (1)     .
           move      w-rig-dua-sic        to   rf-fbs-dua-sic (1)     .
           move      w-rig-sco-max        to   rf-fbs-sco-max (1)     .
           move      w-rig-dua-max        to   rf-fbs-dua-max (1)     .
       upd-rec-fbs-400.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
