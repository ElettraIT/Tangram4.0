      ...
      *                                                                *
      *                    Manutenzione codici statistici              *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
               ...
               10  w-tes-cod-s01-sns      pic  9(01)                  .
               10  w-tes-cod-s01-des      pic  x(20)                  .
               10  w-tes-cod-s02          pic  9(05)                  .
               10  w-tes-cod-s02-sns      pic  9(01)                  .
               10  w-tes-cod-s02-des      pic  x(20)                  .
               10  w-tes-cod-s03          pic  9(05)                  .
               10  w-tes-cod-s03-sns      pic  9(01)                  .
               10  w-tes-cod-s03-des      pic  x(20)                  .
               10  w-tes-dat-sti          pic  9(07)                  .
               10  w-tes-dat-sti-sns      pic  9(01)                  .
               10  w-tes-dat-stf          pic  9(07)                  .
               10  w-tes-dat-stf-sns      pic  9(01)                  .
               10  w-tes-sel-stg          pic  9(01)                  .
      *            *---------------------------------------------------*
      *            * Valori sostitutivi                                *
      *            *---------------------------------------------------*
               10  w-tes-s01-sos          pic  9(05)                  .
               10  w-tes-s02-sos          pic  9(05)                  .
               10  w-tes-s03-sos          pic  9(05)                  .
               10  w-tes-sti-sos          pic  9(07)                  .
               10  w-tes-stf-sos          pic  9(07)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-cod-s01          pic  9(05)                  .
               10  w-rig-cod-s01-des      pic  x(20)                  .
               10  w-rig-cod-s02          pic  9(05)                  .
               10  w-rig-cod-s02-des      pic  x(20)                  .
               10  w-rig-cod-s03          pic  9(05)                  .
               10  w-rig-cod-s03-des      pic  x(20)                  .
               10  w-rig-dat-sti          pic  9(07)                  .
               10  w-rig-dat-stf          pic  9(07)                  .
           05  w-rig-002.
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-cod-s01  pic  x(05)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-cod-s02  pic  x(05)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-cod-s03  pic  x(05)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Salvataggio per codice filtro di selezione            *
      *        *-------------------------------------------------------*
           05  w-sav-fso-dcp              pic  9(08)                  .
      *        *-------------------------------------------------------*
      *        * Salvataggio per codice statistico 1                   *
      *        *-------------------------------------------------------*
           05  w-sav-cod-s01              pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Salvataggio per codice statistico 2                   *
      *        *-------------------------------------------------------*
           05  w-sav-cod-s02              pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Salvataggio per codice statistico 3                   *
      *        *-------------------------------------------------------*
           05  w-sav-cod-s03              pic  9(05)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Selezione su stagionalita'                 *
      *        *-------------------------------------------------------*
           05  w-exp-sel-stg.
               10  w-exp-sel-stg-num      pic  9(02)       value 02   .
               10  w-exp-sel-stg-lun      pic  9(02)       value 40   .
               10  w-exp-sel-stg-tbl.
                   15  filler             pic  x(40) value
                            "selezione dei prodotti dal Filtro       ".
                   15  filler             pic  x(40) value
                            "selezione dei prodotti dalle Date       ".
      ...
      *    *-----------------------------------------------------------*
       01  w-lpt.
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Codice statistico 1             *
      *        *-------------------------------------------------------*
           05  w-lpt-cod-s01-lin          pic  9(03)    value 008     .
           05  w-lpt-cod-s01-pos          pic  9(03)    value 030     .
           05  w-lpt-cod-s01-ppm          pic  9(03)    value 001     .
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Codice statistico 2             *
      *        *-------------------------------------------------------*
           05  w-lpt-cod-s02-lin          pic  9(03)    value 010     .
           05  w-lpt-cod-s02-pos          pic  9(03)    value 030     .
           05  w-lpt-cod-s02-ppm          pic  9(03)    value 001     .
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Codice statistico 3             *
      *        *-------------------------------------------------------*
           05  w-lpt-cod-s03-lin          pic  9(03)    value 012     .
           05  w-lpt-cod-s03-pos          pic  9(03)    value 030     .
           05  w-lpt-cod-s03-ppm          pic  9(03)    value 001     .
      *        *-------------------------------------------------------*
      *        * Linea e posizione per data stagione inizio            *
      *        *-------------------------------------------------------*
           05  w-lpt-dat-sti-lin          pic  9(03)    value 016     .
           05  w-lpt-dat-sti-pos          pic  9(03)    value 030     .
           05  w-lpt-dat-sti-ppm          pic  9(03)    value 001     .
      *        *-------------------------------------------------------*
      *        * Linea e posizione per data stagione fine              *
      *        *-------------------------------------------------------*
           05  w-lpt-dat-stf-lin          pic  9(03)    value 017     .
           05  w-lpt-dat-stf-pos          pic  9(03)    value 030     .
           05  w-lpt-dat-stf-ppm          pic  9(03)    value 001     .
      ...
      *                  *---------------------------------------------*
       ...
       acc-key-reg-500.
      *                  *---------------------------------------------*
      *                  * Data stagione inizio                        *
      *                  *---------------------------------------------*
           perform   acc-dat-sti-000      thru acc-dat-sti-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *                  * Data stagione fine                          *
      *                  *---------------------------------------------*
           perform   acc-dat-stf-000      thru acc-dat-stf-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
       ...
       acc-key-reg-700.
      *                  *---------------------------------------------*
      *                  * Selezione su stagionalita'                  *
      *                  *---------------------------------------------*
           perform   acc-sel-stg-000      thru acc-sel-stg-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *                  * Data stagione inizio                        *
      *                  *---------------------------------------------*
           perform   pmt-dat-sti-000      thru pmt-dat-sti-999        .
      *                  *---------------------------------------------*
      *                  * Data stagione fine                          *
      *                  *---------------------------------------------*
           perform   pmt-dat-stf-000      thru pmt-dat-stf-999        .
      *                  *---------------------------------------------*
      *                  * Selezione su stagionalita'                  *
      *                  *---------------------------------------------*
           perform   pmt-sel-stg-000      thru pmt-sel-stg-999        .
       pmt-key-reg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       pmt-cod-s01-000.
           ...
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-cod-s01-lin    to   v-lin                  .
           move      w-lpt-cod-s01-ppm    to   v-pos                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-cod-s02-000.
           ...
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-cod-s02-lin    to   v-lin                  .
           move      w-lpt-cod-s02-ppm    to   v-pos                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-cod-s03-000.
           ...
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-cod-s03-lin    to   v-lin                  .
           move      w-lpt-cod-s03-ppm    to   v-pos                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data stagione inizio             *
      *    *-----------------------------------------------------------*
       pmt-dat-sti-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-dat-sti-lin    to   v-lin                  .
           move      w-lpt-dat-sti-ppm    to   v-pos                  .
           move      "Stagionalita'              :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data stagione fine               *
      *    *-----------------------------------------------------------*
       pmt-dat-stf-000.
       pmt-dat-stf-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Selezione su stagionalita'       *
      *    *-----------------------------------------------------------*
       pmt-sel-stg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su stagionalita' :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-sel-stg-999.
      ...
      *                  *---------------------------------------------*
           move      w-tes-fso-dcp        to   w-sav-fso-dcp          .
       acc-fso-dcp-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-fso-dcp        =    w-sav-fso-dcp
                     go to acc-fso-dcp-600.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Bufferizzazione valori letti da filtro      *
      *                  *---------------------------------------------*
           move      w-zos-dcp-cod-s01    to   w-tes-cod-s01          .
           move      w-zos-dcp-cod-s02    to   w-tes-cod-s02          .
           move      w-zos-dcp-cod-s03    to   w-tes-cod-s03          .
      *                  *---------------------------------------------*
      *                  * Descrizione per codice statistico 1         *
      *                  *---------------------------------------------*
           move      01                   to   w-let-arc-zps-tip      .
           move      w-tes-cod-s01        to   w-let-arc-zps-cod      .
           perform   let-arc-zps-000      thru let-arc-zps-999        .
           move      w-let-arc-zps-des    to   w-tes-cod-s01-des      .
      *                  *---------------------------------------------*
      *                  * Descrizione per codice statistico 2         *
      *                  *---------------------------------------------*
           move      02                   to   w-let-arc-zps-tip      .
           move      w-tes-cod-s02        to   w-let-arc-zps-cod      .
           perform   let-arc-zps-000      thru let-arc-zps-999        .
           move      w-let-arc-zps-des    to   w-tes-cod-s02-des      .
      *                  *---------------------------------------------*
      *                  * Descrizione per codice statistico 3         *
      *                  *---------------------------------------------*
           move      03                   to   w-let-arc-zps-tip      .
           move      w-tes-cod-s03        to   w-let-arc-zps-cod      .
           perform   let-arc-zps-000      thru let-arc-zps-999        .
           move      w-let-arc-zps-des    to   w-tes-cod-s03-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valori letti da filtro      *
      *                  *---------------------------------------------*
           perform   vis-cod-s01-000      thru vis-cod-s01-999        .
           perform   vis-cod-s01-des-000  thru vis-cod-s01-des-999    .
           perform   vis-cod-s02-000      thru vis-cod-s02-999        .
           perform   vis-cod-s02-des-000  thru vis-cod-s02-des-999    .
           perform   vis-cod-s03-000      thru vis-cod-s03-999        .
           perform   vis-cod-s03-des-000  thru vis-cod-s03-des-999    .
       acc-fso-dcp-600.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice statistico 1                  *
      *    *-----------------------------------------------------------*
       acc-cod-s01-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore attuale                  *
      *                  *---------------------------------------------*
           move      w-tes-cod-s01        to   w-sav-cod-s01          .
      *                  *---------------------------------------------*
      *                  * Test se richiesta sostituzione              *
      *                  *---------------------------------------------*
           if        w-tes-cod-s01-sns    =    zero
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-s01        to   w-cmn-zps-001-cod      .
           move      w-lpt-cod-s01-lin    to   w-cmn-zps-001-lin      .
           move      w-lpt-cod-s01-pos    to   w-cmn-zps-001-pos      .
           move      w-lpt-cod-s01-lin    to   w-cmn-zps-001-dln      .
           move      w-lpt-cod-s01-pos    to   w-cmn-zps-001-dps      .
           add       07                   to   w-cmn-zps-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cod-s01          .
       acc-cod-s01-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-cod-s01-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-cod-s01-sos-000  thru acc-cod-s01-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-s01-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-cod-s01-sos-000  thru vis-cod-s01-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-cod-s01-sns    not  = zero
                     go to acc-cod-s01-800.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Eventuale ripristino del valore             *
      *                  *---------------------------------------------*
           if        w-tes-cod-s01        =    w-sav-cod-s01
                     go to acc-cod-s01-800.
           if        w-zos-dcp-cod-s01    =    zero
                     go to acc-cod-s01-800.
      *                  *---------------------------------------------*
      *                  * Messaggio di avviso                         *
      *                  *---------------------------------------------*
           move      "Codice Statistico 1 forzato dal filtro di selezion
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice statistico 1               *
      *    *-----------------------------------------------------------*
       vis-cod-s01-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           ...
           move      "<B"                 to   v-edm                  .
           move      w-lpt-cod-s01-lin    to   v-lin                  .
           move      w-lpt-cod-s01-pos    to   v-pos                  .
           move      w-tes-cod-s01        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-s01-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione codice statistico 1   *
      *    *-----------------------------------------------------------*
       vis-cod-s01-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      w-lpt-cod-s01-pos    to   v-pos                  .
           add       07                   to   v-pos                  .
           move      w-tes-cod-s01-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-s01-des-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cod-s01-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-cod-s01-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-cod-s01-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-cod-s01-sos-010.
      ...
      *                  *---------------------------------------------*
           perform   vis-cod-s01-so1-000  thru vis-cod-s01-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-cod-s01-so2-000  thru vis-cod-s01-so2-999    .
       acc-cod-s01-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-cod-s01-so1-000  thru acc-cod-s01-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-s01-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-cod-s01-sos-600.
       acc-cod-s01-sos-300.
      *                  *---------------------------------------------*
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-cod-s01-so2-000  thru acc-cod-s01-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-s01-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-s01-sos-200.
       acc-cod-s01-sos-600.
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-cod-s01        =    zero  and
                     w-tes-s01-sos        =    zero
                     go to acc-cod-s01-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-cod-s01        not  = w-tes-s01-sos
                     go to acc-cod-s01-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-s01-sos          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-s01        not  = zero or
                     w-tes-s01-sos        not  = zero
                     move  1              to   w-tes-cod-s01-sns      .
       acc-cod-s01-sos-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cod-s01-sns    =    zero
                     go to vis-cod-s01-sos-100
           else      go to vis-cod-s01-sos-500.
       vis-cod-s01-sos-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-zos-dcp-cod-s01    =    zero
                     go to acc-cod-s01-so1-100.
           perform   vis-cod-s01-so1-000  thru vis-cod-s01-so1-999    .
           go to     acc-cod-s01-so1-999.
       acc-cod-s01-so1-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
       ...
       acc-cod-s01-so1-110.
           perform   cmn-zps-001-cll-000  thru cmn-zps-001-cll-999    .
           if        w-cmn-zps-001-ope    =    "F+"
                     go to acc-cod-s01-so1-115.
           if        w-cmn-zps-001-ope    =    "AC"
                     go to acc-cod-s01-so1-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-s01-so1-115.
           perform   cmn-zps-001-foi-000  thru cmn-zps-001-foi-999    .
           go to     acc-cod-s01-so1-110.
       acc-cod-s01-so1-120.
           move      w-cmn-zps-001-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zps-001-ope      .
           move      w-tes-s01-sos        to   w-cmn-zps-001-cod      .
           move      w-lpt-cod-s01-lin    to   w-cmn-zps-001-lin      .
           move      w-lpt-cod-s01-pos    to   w-cmn-zps-001-pos      .
           add       35                   to   w-cmn-zps-001-pos      .
           move      zero                 to   w-cmn-zps-001-dln      .
           move      zero                 to   w-cmn-zps-001-dps      .
           move      "<"                  to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
       ...
       acc-cod-s01-so2-110.
           perform   cmn-zps-001-cll-000  thru cmn-zps-001-cll-999    .
           if        w-cmn-zps-001-ope    =    "F+"
                     go to acc-cod-s01-so2-115.
           if        w-cmn-zps-001-ope    =    "AC"
                     go to acc-cod-s01-so2-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-s01-so2-115.
           perform   cmn-zps-001-foi-000  thru cmn-zps-001-foi-999    .
           go to     acc-cod-s01-so2-110.
       acc-cod-s01-so2-120.
           move      w-cmn-zps-001-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-s01-so2-999.
       acc-cod-s01-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-s01-sos          .
       acc-cod-s01-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice statistico 2                  *
      *    *-----------------------------------------------------------*
       acc-cod-s02-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore attuale                  *
      *                  *---------------------------------------------*
           move      w-tes-cod-s02        to   w-sav-cod-s02          .
      *                  *---------------------------------------------*
      *                  * Test se richiesta sostituzione              *
      *                  *---------------------------------------------*
           if        w-tes-cod-s02-sns    =    zero
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-s02        to   w-cmn-zps-002-cod      .
           move      w-lpt-cod-s02-lin    to   w-cmn-zps-002-lin      .
           move      w-lpt-cod-s02-pos    to   w-cmn-zps-002-pos      .
           move      w-lpt-cod-s02-lin    to   w-cmn-zps-002-dln      .
           move      w-lpt-cod-s02-pos    to   w-cmn-zps-002-dps      .
           add       07                   to   w-cmn-zps-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cod-s02          .
       acc-cod-s02-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-cod-s02-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-cod-s02-sos-000  thru acc-cod-s02-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-s02-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-cod-s02-sos-000  thru vis-cod-s02-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-cod-s02-sns    not  = zero
                     go to acc-cod-s02-800.
      *                  *---------------------------------------------*
      *                  * Visualizzazione codice impostato            *
      *                  *---------------------------------------------*
           perform   vis-cod-s02-000      thru vis-cod-s02-999        .
      ...
      *                  * Eventuale ripristino del valore             *
      *                  *---------------------------------------------*
           if        w-tes-cod-s02        =    w-sav-cod-s02
                     go to acc-cod-s02-800.
           if        w-zos-dcp-cod-s02    =    zero
                     go to acc-cod-s02-800.
      *                  *---------------------------------------------*
      *                  * Messaggio di avviso                         *
      *                  *---------------------------------------------*
           move      "Codice Statistico 2 forzato dal filtro di selezion
      -              "e !   "             to   w-box-msg-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione valori letti da filtro      *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice statistico 2               *
      *    *-----------------------------------------------------------*
       vis-cod-s02-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           ...
           move      "<B"                 to   v-edm                  .
           move      w-lpt-cod-s02-lin    to   v-lin                  .
           move      w-lpt-cod-s02-pos    to   v-pos                  .
           move      w-tes-cod-s02        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-s02-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione codice statistico 2   *
      *    *-----------------------------------------------------------*
       vis-cod-s02-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      w-lpt-cod-s02-pos    to   v-pos                  .
           add       07                   to   v-pos                  .
           move      w-tes-cod-s02-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-s02-des-999.
           exit.
      ...
      *                  * Normalizzazione segnale di sostituzione     *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cod-s02-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-cod-s02-pos    to   v-pos                  .
           subtract  1                    from v-pos                  .
           move      w-lpt-cod-s02-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-cod-s02-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-cod-s02-sos-010.
      ...
      *                  * Visualizzazione valore da sostituire        *
      *                  *---------------------------------------------*
           perform   vis-cod-s02-so1-000  thru vis-cod-s02-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-cod-s02-so2-000  thru vis-cod-s02-so2-999    .
       acc-cod-s02-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-cod-s02-so1-000  thru acc-cod-s02-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-s02-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-s02-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-cod-s02-sos-600.
      ...
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-cod-s02-so2-000  thru acc-cod-s02-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-s02-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-s02-sos-200.
       acc-cod-s02-sos-600.
      *              *-------------------------------------------------*
      *              * Controlli su valori accettati                   *
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-cod-s02        =    zero  and
                     w-tes-s02-sos        =    zero
                     go to acc-cod-s02-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-cod-s02        not  = w-tes-s02-sos
                     go to acc-cod-s02-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-s02-sos          .
      *                      *-----------------------------------------*
      *                      * Segnale di sostituzione non effettuata  *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-cod-s02-sns      .
      ...
      *                  * Segnale di sostituzione effettuata          *
      *                  *---------------------------------------------*
           if        w-tes-cod-s02        not  = zero or
                     w-tes-s02-sos        not  = zero
                     move  1              to   w-tes-cod-s02-sns      .
       acc-cod-s02-sos-900.
      *              *-------------------------------------------------*
      *              * Normalizzazione stato di uscita                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cod-s02-sns    =    zero
                     go to vis-cod-s02-sos-100
           else      go to vis-cod-s02-sos-500.
       vis-cod-s02-sos-100.
      *              *-------------------------------------------------*
      *              * Se sostituzione non effettuata                  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-zos-dcp-cod-s02    =    zero
                     go to acc-cod-s02-so1-100.
           perform   vis-cod-s02-so1-000  thru vis-cod-s02-so1-999    .
           go to     acc-cod-s02-so1-999.
       acc-cod-s02-so1-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
       ...
       acc-cod-s02-so1-110.
           perform   cmn-zps-002-cll-000  thru cmn-zps-002-cll-999    .
           if        w-cmn-zps-002-ope    =    "F+"
                     go to acc-cod-s02-so1-115.
           if        w-cmn-zps-002-ope    =    "AC"
                     go to acc-cod-s02-so1-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-s02-so1-115.
           perform   cmn-zps-002-foi-000  thru cmn-zps-002-foi-999    .
           go to     acc-cod-s02-so1-110.
       acc-cod-s02-so1-120.
           move      w-cmn-zps-002-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zps-002-ope      .
           move      w-tes-s02-sos        to   w-cmn-zps-002-cod      .
           move      w-lpt-cod-s02-lin    to   w-cmn-zps-002-lin      .
           move      w-lpt-cod-s02-pos    to   w-cmn-zps-002-pos      .
           add       35                   to   w-cmn-zps-002-pos      .
           move      zero                 to   w-cmn-zps-002-dln      .
           move      zero                 to   w-cmn-zps-002-dps      .
           move      "<"                  to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
       ...
       acc-cod-s02-so2-110.
           perform   cmn-zps-002-cll-000  thru cmn-zps-002-cll-999    .
           if        w-cmn-zps-002-ope    =    "F+"
                     go to acc-cod-s02-so2-115.
           if        w-cmn-zps-002-ope    =    "AC"
                     go to acc-cod-s02-so2-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-s02-so2-115.
           perform   cmn-zps-002-foi-000  thru cmn-zps-002-foi-999    .
           go to     acc-cod-s02-so2-110.
       acc-cod-s02-so2-120.
           move      w-cmn-zps-002-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-s02-so2-999.
       acc-cod-s02-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-s02-sos          .
       acc-cod-s02-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice statistico 3                  *
      *    *-----------------------------------------------------------*
       acc-cod-s03-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore attuale                  *
      *                  *---------------------------------------------*
           move      w-tes-cod-s03        to   w-sav-cod-s03          .
      *                  *---------------------------------------------*
      *                  * Test se richiesta sostituzione              *
      *                  *---------------------------------------------*
           if        w-tes-cod-s03-sns    =    zero
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-s03        to   w-cmn-zps-003-cod      .
           move      w-lpt-cod-s03-lin    to   w-cmn-zps-003-lin      .
           move      w-lpt-cod-s03-pos    to   w-cmn-zps-003-pos      .
           move      w-lpt-cod-s03-lin    to   w-cmn-zps-003-dln      .
           move      w-lpt-cod-s03-pos    to   w-cmn-zps-003-dps      .
           add       07                   to   w-cmn-zps-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cod-s03          .
       acc-cod-s03-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-cod-s03-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-cod-s03-sos-000  thru acc-cod-s03-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-s03-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-cod-s03-sos-000  thru vis-cod-s03-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-cod-s03-sns    not  = zero
                     go to acc-cod-s03-800.
      *                  *---------------------------------------------*
      *                  * Visualizzazione codice impostato            *
      *                  *---------------------------------------------*
           perform   vis-cod-s03-000      thru vis-cod-s03-999        .
      ...
      *                  * Eventuale ripristino del valore             *
      *                  *---------------------------------------------*
           if        w-tes-cod-s03        =    w-sav-cod-s03
                     go to acc-cod-s03-800.
           if        w-zos-dcp-cod-s03    =    zero
                     go to acc-cod-s03-800.
      *                  *---------------------------------------------*
      *                  * Messaggio di avviso                         *
      *                  *---------------------------------------------*
           move      "Codice Statistico 3 forzato dal filtro di selezion
      -              "e !   "             to   w-box-msg-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione valori letti da filtro      *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice statistico 3               *
      *    *-----------------------------------------------------------*
       vis-cod-s03-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           ...
           move      "<B"                 to   v-edm                  .
           move      w-lpt-cod-s03-lin    to   v-lin                  .
           move      w-lpt-cod-s03-pos    to   v-pos                  .
           move      w-tes-cod-s03        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-s03-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione codice statistico 3   *
      *    *-----------------------------------------------------------*
       vis-cod-s03-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      w-lpt-cod-s03-pos    to   v-pos                  .
           add       07                   to   v-pos                  .
           move      w-tes-cod-s03-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-s03-des-999.
           exit.
      ...
      *                  * Normalizzazione segnale di sostituzione     *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cod-s03-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-cod-s03-pos    to   v-pos                  .
           subtract  1                    from v-pos                  .
           move      w-lpt-cod-s03-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-cod-s03-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-cod-s03-sos-010.
      ...
      *                  * Visualizzazione valore da sostituire        *
      *                  *---------------------------------------------*
           perform   vis-cod-s03-so1-000  thru vis-cod-s03-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-cod-s03-so2-000  thru vis-cod-s03-so2-999    .
       acc-cod-s03-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-cod-s03-so1-000  thru acc-cod-s03-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-s03-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-s03-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-cod-s03-sos-600.
      ...
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-cod-s03-so2-000  thru acc-cod-s03-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-s03-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-s03-sos-200.
       acc-cod-s03-sos-600.
      *              *-------------------------------------------------*
      *              * Controlli su valori accettati                   *
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-cod-s03        =    zero  and
                     w-tes-s03-sos        =    zero
                     go to acc-cod-s03-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-cod-s03        not  = w-tes-s03-sos
                     go to acc-cod-s03-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-s03-sos          .
      *                      *-----------------------------------------*
      *                      * Segnale di sostituzione non effettuata  *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-cod-s03-sns      .
      ...
      *                  * Segnale di sostituzione effettuata          *
      *                  *---------------------------------------------*
           if        w-tes-cod-s03        not  = zero or
                     w-tes-s03-sos        not  = zero
                     move  1              to   w-tes-cod-s03-sns      .
       acc-cod-s03-sos-900.
      *              *-------------------------------------------------*
      *              * Normalizzazione stato di uscita                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cod-s03-sns    =    zero
                     go to vis-cod-s03-sos-100
           else      go to vis-cod-s03-sos-500.
       vis-cod-s03-sos-100.
      *              *-------------------------------------------------*
      *              * Se sostituzione non effettuata                  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-zos-dcp-cod-s03    =    zero
                     go to acc-cod-s03-so1-100.
           perform   vis-cod-s03-so1-000  thru vis-cod-s03-so1-999    .
           go to     acc-cod-s03-so1-999.
       acc-cod-s03-so1-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
       ...
       acc-cod-s03-so1-110.
           perform   cmn-zps-003-cll-000  thru cmn-zps-003-cll-999    .
           if        w-cmn-zps-003-ope    =    "F+"
                     go to acc-cod-s03-so1-115.
           if        w-cmn-zps-003-ope    =    "AC"
                     go to acc-cod-s03-so1-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-s03-so1-115.
           perform   cmn-zps-003-foi-000  thru cmn-zps-003-foi-999    .
           go to     acc-cod-s03-so1-110.
       acc-cod-s03-so1-120.
           move      w-cmn-zps-003-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zps-003-ope      .
           move      w-tes-s03-sos        to   w-cmn-zps-003-cod      .
           move      w-lpt-cod-s03-lin    to   w-cmn-zps-003-lin      .
           move      w-lpt-cod-s03-pos    to   w-cmn-zps-003-pos      .
           add       35                   to   w-cmn-zps-003-pos      .
           move      zero                 to   w-cmn-zps-003-dln      .
           move      zero                 to   w-cmn-zps-003-dps      .
           move      "<"                  to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
       ...
       acc-cod-s03-so2-110.
           perform   cmn-zps-003-cll-000  thru cmn-zps-003-cll-999    .
           if        w-cmn-zps-003-ope    =    "F+"
                     go to acc-cod-s03-so2-115.
           if        w-cmn-zps-003-ope    =    "AC"
                     go to acc-cod-s03-so2-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-s03-so2-115.
           perform   cmn-zps-003-foi-000  thru cmn-zps-003-foi-999    .
           go to     acc-cod-s03-so2-110.
       acc-cod-s03-so2-120.
           move      w-cmn-zps-003-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-s03-so2-999.
       acc-cod-s03-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-s03-sos          .
       acc-cod-s03-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data stagione inizio                 *
      *    *-----------------------------------------------------------*
       acc-dat-sti-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Test se richiesta sostituzione              *
      *                  *---------------------------------------------*
           if        w-tes-dat-sti-sns    =    zero
                     go to acc-dat-sti-100.
      *                  *---------------------------------------------*
      *                  * Forzatura del tasto Pf1                     *
      *                  *---------------------------------------------*
           move      "[1] "               to   v-key                  .
      ...
      *                  * A test su Pf1                               *
      *                  *---------------------------------------------*
           go to     acc-dat-sti-300.
       acc-dat-sti-100.
      *              *-------------------------------------------------*
      *              * Note operative                                  *
      *              *-------------------------------------------------*
______*    move      "NT"                 to   v-ope                  .
______*    move      "[F1] per sostituzione"
______*                                   to   v-not                  .
...
______*                                  using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      ">"                  to   v-edm                  .
           move      w-lpt-dat-sti-lin    to   v-lin                  .
           move      w-lpt-dat-sti-pos    to   v-pos                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
______*    move      "[1] "               to   v-pfk (14)             .
           move      w-tes-dat-sti        to   v-dat                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Cancellazione eventuali note operative          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-dat-sti-999.
       acc-dat-sti-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-tes-dat-sti          .
       acc-dat-sti-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-dat-sti-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-dat-sti-sos-000  thru acc-dat-sti-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-dat-sti-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-dat-sti-sos-000  thru vis-dat-sti-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-dat-sti-sns    not  = zero
                     go to acc-dat-sti-800.
      *                  *---------------------------------------------*
      *                  * Visualizzazione codice impostato            *
      *                  *---------------------------------------------*
           perform   vis-dat-sti-000      thru vis-dat-sti-999        .
       acc-dat-sti-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Data stagione inizio              *
      *    *-----------------------------------------------------------*
       vis-dat-sti-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *                  * Normalizzazione segnale di sostituzione     *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-dat-sti-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-dat-sti-pos    to   v-pos                  .
           subtract  1                    from v-pos                  .
           move      w-lpt-dat-sti-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-dat-sti-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-dat-sti-sos-010.
      ...
      *                  * Visualizzazione valore da sostituire        *
      *                  *---------------------------------------------*
           perform   vis-dat-sti-so1-000  thru vis-dat-sti-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-dat-sti-so2-000  thru vis-dat-sti-so2-999    .
       acc-dat-sti-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-dat-sti-so1-000  thru acc-dat-sti-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-dat-sti-sos-600.
           if        v-key                =    "UP  "
                     go to acc-dat-sti-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-dat-sti-sos-600.
      ...
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-dat-sti-so2-000  thru acc-dat-sti-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-dat-sti-sos-600.
           if        v-key                =    "UP  "
                     go to acc-dat-sti-sos-200.
       acc-dat-sti-sos-600.
      *              *-------------------------------------------------*
      *              * Controlli su valori accettati                   *
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-dat-sti        =    zero  and
                     w-tes-sti-sos        =    zero
                     go to acc-dat-sti-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-dat-sti        not  = w-tes-sti-sos
                     go to acc-dat-sti-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-sti-sos          .
      *                      *-----------------------------------------*
      *                      * Segnale di sostituzione non effettuata  *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-dat-sti-sns      .
      ...
      *                  * Segnale di sostituzione effettuata          *
      *                  *---------------------------------------------*
           if        w-tes-dat-sti        not  = zero or
                     w-tes-sti-sos        not  = zero
                     move  1              to   w-tes-dat-sti-sns      .
       acc-dat-sti-sos-900.
      *              *-------------------------------------------------*
      *              * Normalizzazione stato di uscita                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-dat-sti-sns    =    zero
                     go to vis-dat-sti-sos-100
           else      go to vis-dat-sti-sos-500.
       vis-dat-sti-sos-100.
      *              *-------------------------------------------------*
      *              * Se sostituzione non effettuata                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-dat-sti-so2-999.
       acc-dat-sti-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-tes-sti-sos          .
       acc-dat-sti-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data stagione fine                   *
      *    *-----------------------------------------------------------*
       acc-dat-stf-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Test se richiesta sostituzione              *
      *                  *---------------------------------------------*
           if        w-tes-dat-stf-sns    =    zero
                     go to acc-dat-stf-100.
      *                  *---------------------------------------------*
      *                  * Forzatura del tasto Pf1                     *
      *                  *---------------------------------------------*
           move      "[1] "               to   v-key                  .
...
______*                                  using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "D"                  to   v-tip                  .
           move      ">"                  to   v-edm                  .
           move      w-lpt-dat-stf-lin    to   v-lin                  .
           move      w-lpt-dat-stf-pos    to   v-pos                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
______*    move      "[1] "               to   v-pfk (14)             .
           move      w-tes-dat-stf        to   v-dat                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Cancellazione eventuali note operative          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-dat-stf-999.
       acc-dat-stf-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-tes-dat-stf          .
       acc-dat-stf-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-dat-stf-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-dat-stf-sos-000  thru acc-dat-stf-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-dat-stf-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-dat-stf-sos-000  thru vis-dat-stf-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-dat-stf-sns    not  = zero
                     go to acc-dat-stf-800.
      *                  *---------------------------------------------*
      *                  * Visualizzazione codice impostato            *
      *                  *---------------------------------------------*
           perform   vis-dat-stf-000      thru vis-dat-stf-999        .
       acc-dat-stf-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Data stagione fine                *
      *    *-----------------------------------------------------------*
       vis-dat-stf-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *                  * Normalizzazione segnale di sostituzione     *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-dat-stf-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-dat-stf-pos    to   v-pos                  .
           subtract  1                    from v-pos                  .
           move      w-lpt-dat-stf-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-dat-stf-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-dat-stf-sos-010.
      ...
      *                  * Visualizzazione valore da sostituire        *
      *                  *---------------------------------------------*
           perform   vis-dat-stf-so1-000  thru vis-dat-stf-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-dat-stf-so2-000  thru vis-dat-stf-so2-999    .
       acc-dat-stf-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-dat-stf-so1-000  thru acc-dat-stf-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-dat-stf-sos-600.
           if        v-key                =    "UP  "
                     go to acc-dat-stf-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-dat-stf-sos-600.
      ...
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-dat-stf-so2-000  thru acc-dat-stf-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-dat-stf-sos-600.
           if        v-key                =    "UP  "
                     go to acc-dat-stf-sos-200.
       acc-dat-stf-sos-600.
      *              *-------------------------------------------------*
      *              * Controlli su valori accettati                   *
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-dat-stf        =    zero  and
                     w-tes-stf-sos        =    zero
                     go to acc-dat-stf-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-dat-stf        not  = w-tes-stf-sos
                     go to acc-dat-stf-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-stf-sos          .
      *                      *-----------------------------------------*
      *                      * Segnale di sostituzione non effettuata  *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-dat-stf-sns      .
      ...
      *                  * Segnale di sostituzione effettuata          *
      *                  *---------------------------------------------*
           if        w-tes-dat-stf        not  = zero or
                     w-tes-stf-sos        not  = zero
                     move  1              to   w-tes-dat-stf-sns      .
       acc-dat-stf-sos-900.
      *              *-------------------------------------------------*
      *              * Normalizzazione stato di uscita                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-dat-stf-sns    =    zero
                     go to vis-dat-stf-sos-100
           else      go to vis-dat-stf-sos-500.
       vis-dat-stf-sos-100.
      *              *-------------------------------------------------*
      *              * Se sostituzione non effettuata                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-dat-stf-so2-999.
       acc-dat-stf-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-tes-stf-sos          .
       acc-dat-stf-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Trattamento date stagionalita'             *
      *    *-----------------------------------------------------------*
       acc-sel-stg-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-stg-lun    to   v-car                  .
           move      w-exp-sel-stg-num    to   v-ldt                  .
           move      "FD#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-sel-stg-tbl    to   v-txt                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      19                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-tes-sel-stg        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-sel-stg-999.
       acc-sel-stg-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-sel-stg          .
       acc-sel-stg-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Trattamento date stagionalita'          *
      *    *-----------------------------------------------------------*
       vis-sel-stg-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *                  * Codice statistico 1                         *
      *                  *---------------------------------------------*
           perform   acc-rig-s01-000      thru acc-rig-s01-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * Codice statistico 2                         *
      *                  *---------------------------------------------*
           perform   acc-rig-s02-000      thru acc-rig-s02-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Codice statistico 3                         *
      *                  *---------------------------------------------*
           perform   acc-rig-s03-000      thru acc-rig-s03-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Data stagione inizio                        *
      *                  *---------------------------------------------*
           perform   acc-rig-sti-000      thru acc-rig-sti-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Data stagione fine                          *
      *                  *---------------------------------------------*
           perform   acc-rig-stf-000      thru acc-rig-stf-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
                     go to acc-cor-reg-250.
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "B"                  to   v-edm                  .
           move      w-rig-cod-s01        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-cod-s01      .
       vis-lin-cor-490.
      *                  *---------------------------------------------*
      *                  * Editing Codice statistico 2                 *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      05                   to   v-car                  .
           ...
           move      spaces               to   v-sgn                  .
           move      "B"                  to   v-edm                  .
           move      w-rig-cod-s02        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-cod-s02      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Editing Codice statistico 3                 *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      05                   to   v-car                  .
           ...
           move      spaces               to   v-sgn                  .
           move      "B"                  to   v-edm                  .
           move      w-rig-cod-s03        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-cod-s03      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              * Codice statistico 1                             *
      *              *-------------------------------------------------*
           perform   vis-rig-s01-000      thru vis-rig-s01-999        .
           perform   vis-rig-s01-des-000  thru vis-rig-s01-des-999    .
      *              *-------------------------------------------------*
      *              * Codice statistico 2                             *
      *              *-------------------------------------------------*
           perform   vis-rig-s02-000      thru vis-rig-s02-999        .
           perform   vis-rig-s02-des-000  thru vis-rig-s02-des-999    .
      *              *-------------------------------------------------*
      *              * Codice statistico 3                             *
      *              *-------------------------------------------------*
           perform   vis-rig-s03-000      thru vis-rig-s03-999        .
           perform   vis-rig-s03-des-000  thru vis-rig-s03-des-999    .
      *              *-------------------------------------------------*
      *              * Data stagione inizio                            *
      *              *-------------------------------------------------*
           perform   vis-rig-sti-000      thru vis-rig-sti-999        .
      *              *-------------------------------------------------*
      *              * Data stagione fine                              *
      *              *-------------------------------------------------*
           perform   vis-rig-stf-000      thru vis-rig-stf-999        .
       vis-rig-cor-999.
           exit.
      ...
      *              * Codice statistico 1                             *
      *              *-------------------------------------------------*
           perform   pmt-rig-s01-000      thru pmt-rig-s01-999        .
      *              *-------------------------------------------------*
      *              * Codice statistico 2                             *
      *              *-------------------------------------------------*
           perform   pmt-rig-s02-000      thru pmt-rig-s02-999        .
      *              *-------------------------------------------------*
      *              * Codice statistico 3                             *
      *              *-------------------------------------------------*
           perform   pmt-rig-s03-000      thru pmt-rig-s03-999        .
      *              *-------------------------------------------------*
      *              * Data stagione inizio                            *
      *              *-------------------------------------------------*
           perform   pmt-rig-sti-000      thru pmt-rig-sti-999        .
      *              *-------------------------------------------------*
      *              * Data stagione fine                              *
      *              *-------------------------------------------------*
           perform   pmt-rig-stf-000      thru pmt-rig-stf-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zps-001-ope      .
           move      w-rig-cod-s01        to   w-cmn-zps-001-cod      .
           move      18                   to   w-cmn-zps-001-lin      .
           move      22                   to   w-cmn-zps-001-pos      .
           move      18                   to   w-cmn-zps-001-dln      .
           move      33                   to   w-cmn-zps-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "INSR"               to   v-pfk (04)             .
       ...
       acc-rig-s01-110.
           perform   cmn-zps-001-cll-000  thru cmn-zps-001-cll-999    .
           if        w-cmn-zps-001-ope    =    "F+"
                     go to acc-rig-s01-115.
           if        w-cmn-zps-001-ope    =    "AC"
                     go to acc-rig-s01-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-s01-115.
           perform   cmn-zps-001-foi-000  thru cmn-zps-001-foi-999    .
           go to     acc-rig-s01-110.
       acc-rig-s01-120.
           move      w-cmn-zps-001-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-s01-999.
       acc-rig-s01-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-cod-s01          .
       acc-rig-s01-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      01                   to   w-let-arc-zps-tip      .
           move      w-rig-cod-s01        to   w-let-arc-zps-cod      .
           perform   let-arc-zps-000      thru let-arc-zps-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-zps-des    to   w-rig-cod-s01-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-s01-des-000  thru vis-rig-s01-des-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-s01-des-000.
           ...
           move      18                   to   v-lin                  .
           move      33                   to   v-pos                  .
           move      w-rig-cod-s01-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-s01-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zps-002-ope      .
           move      w-rig-cod-s02        to   w-cmn-zps-002-cod      .
           move      19                   to   w-cmn-zps-002-lin      .
           move      22                   to   w-cmn-zps-002-pos      .
           move      19                   to   w-cmn-zps-002-dln      .
           move      33                   to   w-cmn-zps-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-rig-s02-110.
           perform   cmn-zps-002-cll-000  thru cmn-zps-002-cll-999    .
           if        w-cmn-zps-002-ope    =    "F+"
                     go to acc-rig-s02-115.
           if        w-cmn-zps-002-ope    =    "AC"
                     go to acc-rig-s02-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-s02-115.
           perform   cmn-zps-002-foi-000  thru cmn-zps-002-foi-999    .
           go to     acc-rig-s02-110.
       acc-rig-s02-120.
           move      w-cmn-zps-002-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-s02-999.
       acc-rig-s02-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-cod-s02          .
       acc-rig-s02-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      02                   to   w-let-arc-zps-tip      .
           move      w-rig-cod-s02        to   w-let-arc-zps-cod      .
           perform   let-arc-zps-000      thru let-arc-zps-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-zps-des    to   w-rig-cod-s02-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-s02-des-000  thru vis-rig-s02-des-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-s02-des-000.
           ...
           move      19                   to   v-lin                  .
           move      33                   to   v-pos                  .
           move      w-rig-cod-s02-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-s02-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zps-003-ope      .
           move      w-rig-cod-s03        to   w-cmn-zps-003-cod      .
           move      20                   to   w-cmn-zps-003-lin      .
           move      22                   to   w-cmn-zps-003-pos      .
           move      20                   to   w-cmn-zps-003-dln      .
           move      33                   to   w-cmn-zps-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-rig-s03-110.
           perform   cmn-zps-003-cll-000  thru cmn-zps-003-cll-999    .
           if        w-cmn-zps-003-ope    =    "F+"
                     go to acc-rig-s03-115.
           if        w-cmn-zps-003-ope    =    "AC"
                     go to acc-rig-s03-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-s03-115.
           perform   cmn-zps-003-foi-000  thru cmn-zps-003-foi-999    .
           go to     acc-rig-s03-110.
       acc-rig-s03-120.
           move      w-cmn-zps-003-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-s03-999.
       acc-rig-s03-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-cod-s03          .
       acc-rig-s03-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      03                   to   w-let-arc-zps-tip      .
           move      w-rig-cod-s03        to   w-let-arc-zps-cod      .
           perform   let-arc-zps-000      thru let-arc-zps-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-zps-des    to   w-rig-cod-s03-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-s03-des-000  thru vis-rig-s03-des-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-s03-des-000.
           ...
           move      20                   to   v-lin                  .
           move      33                   to   v-pos                  .
           move      w-rig-cod-s03-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-s03-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-sti-999.
       acc-rig-sti-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-rig-dat-sti          .
       acc-rig-sti-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-stf-999.
       acc-rig-stf-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-rig-dat-stf          .
       acc-rig-stf-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-100.
      *              *-------------------------------------------------*
      *              * Controllo su Codice statistico 1                *
      *              *-------------------------------------------------*
           if        w-rig-cod-s01        =    zero
                     go to cnt-tdo-rig-200.
           move      01                   to   w-let-arc-zps-tip      .
           move      w-rig-cod-s01        to   w-let-arc-zps-cod      .
           perform   let-arc-zps-000      thru let-arc-zps-999        .
           if        w-let-arc-zps-flg    =    spaces
                     go to cnt-tdo-rig-200.
           move      "Codice Statistico 1 non esistente !               
      -              "      "             to   w-box-msg-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-200.
      *              *-------------------------------------------------*
      *              * Controllo su Codice statistico 2                *
      *              *-------------------------------------------------*
           if        w-rig-cod-s02        =    zero
           ...
           if        w-let-arc-zps-flg    =    spaces
                     go to cnt-tdo-rig-300.
           move      "Codice Statistico 2 non esistente !               
      -              "      "             to   w-box-msg-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-300.
      *              *-------------------------------------------------*
      *              * Controllo su Codice statistico 3                *
      *              *-------------------------------------------------*
           if        w-rig-cod-s03        =    zero
           ...
           if        w-let-arc-zps-flg    =    spaces
                     go to cnt-tdo-rig-600.
           move      "Codice Statistico 3 non esistente !               
      -              "      "             to   w-box-msg-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tes-cod-s01          .
           move      zero                 to   w-tes-cod-s01-sns      .
           move      spaces               to   w-tes-cod-s01-des      .
           move      zero                 to   w-tes-cod-s02          .
           move      zero                 to   w-tes-cod-s02-sns      .
           move      spaces               to   w-tes-cod-s02-des      .
           move      zero                 to   w-tes-cod-s03          .
           move      zero                 to   w-tes-cod-s03-sns      .
           move      spaces               to   w-tes-cod-s03-des      .
           move      zero                 to   w-tes-dat-sti          .
           move      zero                 to   w-tes-dat-sti-sns      .
           move      zero                 to   w-tes-dat-stf          .
           move      zero                 to   w-tes-dat-stf-sns      .
           move      zero                 to   w-tes-sel-stg          .
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-cod-s01          .
           move      spaces               to   w-rig-cod-s01-des      .
           move      zero                 to   w-rig-cod-s02          .
           move      spaces               to   w-rig-cod-s02-des      .
           move      zero                 to   w-rig-cod-s03          .
           move      spaces               to   w-rig-cod-s03-des      .
           move      zero                 to   w-rig-dat-sti          .
           move      zero                 to   w-rig-dat-stf          .
       nor-nok-rig-999.
           exit.
      ...
      *              * Codice statistico 1                             *
      *              *-------------------------------------------------*
           if        w-tes-cod-s01-sns    =    zero and
                     w-tes-cod-s01        =    zero
                     go to sel-rec-dcp-200.
           if        rf-dcp-cod-s01       not  = w-tes-cod-s01
                     go to sel-rec-dcp-900.
       sel-rec-dcp-200.
      *              *-------------------------------------------------*
      *              * Codice statistico 2                             *
      *              *-------------------------------------------------*
           if        w-tes-cod-s02-sns    =    zero and
                     w-tes-cod-s02        =    zero
                     go to sel-rec-dcp-300.
           if        rf-dcp-cod-s02       not  = w-tes-cod-s02
                     go to sel-rec-dcp-900.
       sel-rec-dcp-300.
      *              *-------------------------------------------------*
      *              * Codice statistico 3                             *
      *              *-------------------------------------------------*
           if        w-tes-cod-s03-sns    =    zero and
                     w-tes-cod-s03        =    zero
                     go to sel-rec-dcp-400.
           if        rf-dcp-cod-s03       not  = w-tes-cod-s03
                     go to sel-rec-dcp-900.
       sel-rec-dcp-400.
      *              *-------------------------------------------------*
      *              * Data stagione inizio                            *
      ...
      *
           if        w-tes-dat-sti-sns    =    zero and
                     w-tes-dat-sti        =    zero
                     go to sel-rec-dcp-500.
           if        rf-dcp-dat-sti       not  numeric
                     move  zero           to   rf-dcp-dat-sti         .
           if        rf-dcp-dat-sti       not  = w-tes-dat-sti
                     go to sel-rec-dcp-900.
       sel-rec-dcp-500.
      *              *-------------------------------------------------*
      *              * Data stagione fine                              *
      *              *-------------------------------------------------*
           if        w-tes-dat-stf-sns    =    zero and
                     w-tes-dat-stf        =    zero
                     go to sel-rec-dcp-800.
           if        rf-dcp-dat-stf       not  numeric
                     move  zero           to   rf-dcp-dat-stf         .
           if        rf-dcp-dat-stf       not  = w-tes-dat-stf
                     go to sel-rec-dcp-900.
       sel-rec-dcp-800.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcp-cod-s01       to   w-rig-cod-s01          .
           move      rf-dcp-cod-s02       to   w-rig-cod-s02          .
           move      rf-dcp-cod-s03       to   w-rig-cod-s03          .
           move      rf-dcp-dat-sti       to   w-rig-dat-sti          .
           move      rf-dcp-dat-stf       to   w-rig-dat-stf          .
      *
           if        rf-dcp-dat-sti       not  numeric
                     move  zero           to   w-rig-dat-sti          .
      *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-s01-sos        to   w-rig-cod-s01          .
       car-eff-rig-sos-200.
      *              *-------------------------------------------------*
      *              * Codice statistico 2                             *
      *              *-------------------------------------------------*
           ...
           move      w-tes-s02-sos        to   w-rig-cod-s02          .
       car-eff-rig-sos-300.
      *              *-------------------------------------------------*
      *              * Codice statistico 3                             *
      *              *-------------------------------------------------*
           ...
           move      w-tes-s03-sos        to   w-rig-cod-s03          .
       car-eff-rig-sos-400.
      *              *-------------------------------------------------*
      *              * Data stagione inizio                            *
      *              *-------------------------------------------------*
           if        w-tes-sel-stg        =    1
                     move  w-tes-dat-sti  to   w-rig-dat-sti
                     go to car-eff-rig-sos-500.
      *
           if        w-tes-dat-sti-sns    =    zero
                     go to car-eff-rig-sos-500.
       car-eff-rig-sos-480.
           move      w-tes-sti-sos        to   w-rig-dat-sti          .
       car-eff-rig-sos-500.
      *              *-------------------------------------------------*
      *              * Data stagione fine                              *
      *              *-------------------------------------------------*
           if        w-tes-sel-stg        =    1
                     move  w-tes-dat-stf  to   w-rig-dat-stf
                     go to car-eff-rig-sos-900.
      *
           if        w-tes-dat-stf-sns    =    zero
                     go to car-eff-rig-sos-900.
           move      w-tes-stf-sos        to   w-rig-dat-stf          .
       car-eff-rig-sos-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-s01-sns    not  = zero or
                     w-tes-cod-s02-sns    not  = zero or
                     w-tes-cod-s03-sns    not  = zero or
                     w-tes-dat-sti-sns    not  = zero or
                     w-tes-dat-stf-sns    not  = zero
                     go to sca-fil-rap-190.
      *                  *---------------------------------------------*
      *                  * Test su selettore stagionalita'             *
      *                  *---------------------------------------------*
           if        w-tes-sel-stg        =    1
                     go to sca-fil-rap-190.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-rig-cod-s01        to   rf-dcp-cod-s01         .
           move      w-rig-cod-s02        to   rf-dcp-cod-s02         .
           move      w-rig-cod-s03        to   rf-dcp-cod-s03         .
           move      w-rig-dat-sti        to   rf-dcp-dat-sti         .
           move      w-rig-dat-stf        to   rf-dcp-dat-stf         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
