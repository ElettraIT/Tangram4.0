      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CONTROLLO CODICI ERRATI NEI PRODOTTI  "       .
      ...
      *        *  - 05 : Codici categoria sonto in riga                *
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-310.
           move      rf-dcp-cla-pro       to   srt-cod-err            .
           go to     stp-srt-inp-400.
       stp-srt-inp-320.
           move      rf-dcp-cod-s01       to   srt-cod-err            .
           go to     stp-srt-inp-400.
       stp-srt-inp-330.
           move      rf-dcp-cod-s02       to   srt-cod-err            .
           go to     stp-srt-inp-400.
       stp-srt-inp-340.
           move      rf-dcp-cod-s03       to   srt-cod-err            .
           go to     stp-srt-inp-400.
       stp-srt-inp-350.
           move      rf-dcp-cat-scr       to   srt-cod-err            .
           go to     stp-srt-inp-400.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun prodotto con codici errati da segnalare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           go to     int-pag-sta-010
                     ...
                     depending   on rr-tip-cod.
       int-pag-sta-010.
           move      "PRODOTTI CON CLASSE MERCEOLOGICA ERRATA"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-020.
           move      "PRODOTTI CON CODICE STATISTICO 1 ERRATO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-030.
           move      "PRODOTTI CON CODICE STATISTICO 2 ERRATO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-040.
           move      "PRODOTTI CON CODICE STATISTICO 3 ERRATO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-050.
           move      "PRODOTTI CON CODICE CATEGORIA SCONTO ERRATA"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-090.
           move      "DT"                 to   s-ope                  .
