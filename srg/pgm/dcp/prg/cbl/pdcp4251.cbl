      ...
      *    *===========================================================*
      *    * Work per routine di 'sel-rec'                             *
      *    *-----------------------------------------------------------*
       01  w-sel-rec.
      *        *-------------------------------------------------------*
      *        * Segnale di record nuovo                               *
      *        *-------------------------------------------------------*
           05  w-sel-rec-new-rec         pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Normalizzazione segnale di record nuovo         *
      *              *-------------------------------------------------*
           move      spaces               to   w-sel-rec-new-rec      .
      *              *-------------------------------------------------*
      *              * Normalizzazione file [pdx]                      *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "pgm/dcp/fls/ioc/obj/iofpdx"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-pdx                 .
      *                  *---------------------------------------------*
      *                  * Se file non trovato : segnale di record     *
      *                  * nuovo                                       *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     move  "#"            to   w-sel-rec-new-rec
                     go to prn-sel-rec-999.
       prn-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Test su selettore di si/no sovrascrittura       *
      *              *-------------------------------------------------*
           if        rr-snx-svs           =    "N"
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      ...
      *                  * Se inserimento                              *
      *                  *---------------------------------------------*
           if        w-sel-rec-new-rec    not  = spaces
