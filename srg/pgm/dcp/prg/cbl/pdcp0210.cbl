      ...
      *                       Ultima revisione:    NdK del 08/11/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella Tipi listino         *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun Tipo listino entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zls]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcp/fls/ioc/obj/iofzls"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      06                   to   v-pos                  .
           move      rf-zls-des-lst       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zls-cod-lst       to   w-mpn-cod-lst          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      33                   to   v-pos                  .
           if        rf-zls-cod-lst       =    spaces
                     move  "(Base)   "    to   v-alf
           else if   rf-zls-wrk-lst       =    "#"
                     move  "Di lavoro"    to   v-alf
      ...
      *
           if        rf-zls-drg-lst       =    "K"
                     move  "Prezzi relativi a 1000 unita'"
                                          to   v-alf
           else if   rf-zls-drg-lst       =    "M"
                     move  "Listino di maggiorazione     "
                                          to   v-alf
           else if   rf-zls-drg-lst       =    "S"
                     move  "Listino di sconto            "
                                          to   v-alf
           else if   rf-zls-drg-lst       =    "P"
                     move  "Listino parziale             "
                                          to   v-alf
           else      move  spaces         to   v-alf                  .
      *
           call      "swd/mod/prg/obj/mvideo"
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-lst'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
