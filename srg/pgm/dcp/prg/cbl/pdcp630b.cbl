      ...
      *                                                                *
      *                    Generazione automatica campagne prodotti    *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "   GENERAZIONE CAMPAGNE PROMOZIONALI    "       .
      ...
      *        *-------------------------------------------------------*
           05  w-rig-val-aep     occurs 2.
               ...
               10  w-rig-snx-mod          pic  x(01)                  .
               10  w-rig-snx-rmv          pic  x(01)                  .
               10  w-rig-alx-exp.
      ...
      *        * cedenti per determinazione della sua significativita' *
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   acc-key-din-000      thru acc-key-din-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           perform   acc-key-dfi-000      thru acc-key-dfi-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
                     go to acc-key-reg-120.
       acc-key-reg-140.
      *                  *---------------------------------------------*
      *                  * Tipo funzionamento                          *
      *                  *---------------------------------------------*
           perform   acc-key-fnz-000      thru acc-key-fnz-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
                     go to acc-key-reg-130.
       acc-key-reg-150.
      *                  *---------------------------------------------*
      *                  * Prezzo di listino                           *
      *                  *---------------------------------------------*
           perform   acc-key-prz-000      thru acc-key-prz-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
                     go to acc-key-reg-140.
       acc-key-reg-160.
      *                  *---------------------------------------------*
      *                  * Categoria di sconto in riga                 *
      *                  *---------------------------------------------*
           perform   acc-key-csc-000      thru acc-key-csc-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *                  * % sconto                                    *
      *                  *---------------------------------------------*
           perform   acc-key-sco-000      thru acc-key-sco-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
                     go to acc-key-reg-160.
       acc-key-reg-180.
      *                  *---------------------------------------------*
      *                  * Categoria provvigioni                       *
      *                  *---------------------------------------------*
           perform   acc-key-cpv-000      thru acc-key-cpv-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
                     go to acc-key-reg-170.
       acc-key-reg-190.
      *                  *---------------------------------------------*
      *                  * % provvigioni                               *
      *                  *---------------------------------------------*
           perform   acc-key-pvg-000      thru acc-key-pvg-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
                     go to acc-key-reg-180.
       acc-key-reg-200.
      *                  *---------------------------------------------*
      ...
      *              * Data inizio campagna promozionale               *
      *              *-------------------------------------------------*
           perform   vis-key-din-000      thru vis-key-din-999        .
      *              *-------------------------------------------------*
      *              * Data fine campagna promozionale                 *
      *              *-------------------------------------------------*
           perform   vis-key-dfi-000      thru vis-key-dfi-999        .
      *              *-------------------------------------------------*
      *              * Tipo funzionamento                              *
      *              *-------------------------------------------------*
           perform   vis-key-fnz-000      thru vis-key-fnz-999        .
      *              *-------------------------------------------------*
      *              * Prezzo di listino                               *
      *              *-------------------------------------------------*
           perform   vis-key-prz-000      thru vis-key-prz-999        .
      *              *-------------------------------------------------*
      *              * Categoria di sconto in riga                     *
      *              *-------------------------------------------------*
           perform   vis-key-csc-000      thru vis-key-csc-999        .
           perform   vis-key-dsc-000      thru vis-key-dsc-999        .
      *              *-------------------------------------------------*
      *              * % sconto                                        *
      *              *-------------------------------------------------*
           perform   vis-key-sco-000      thru vis-key-sco-999        .
      *              *-------------------------------------------------*
      *              * Categoria provvigioni                           *
      *              *-------------------------------------------------*
           perform   vis-key-cpv-000      thru vis-key-cpv-999        .
           perform   vis-key-dpv-000      thru vis-key-dpv-999        .
      *              *-------------------------------------------------*
      *              * % provvigioni                                   *
      *              *-------------------------------------------------*
           perform   vis-key-pvg-000      thru vis-key-pvg-999        .
       vis-key-reg-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "N.B.: Il programma seleziona solo i prodotti per i
      -              " quali non esiste ancora      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "      una campagna di vendita alle date di validit
      -              "a' richieste                  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      *              * Linea di premessa per la generazione            *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      13                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Generazione automatica di  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      *              * Data inizio campagna promozionale               *
      *              *-------------------------------------------------*
           perform   pmt-key-din-000      thru pmt-key-din-999        .
      *              *-------------------------------------------------*
      *              * Data fine campagna promozionale                 *
      *              *-------------------------------------------------*
           perform   pmt-key-dfi-000      thru pmt-key-dfi-999        .
      *              *-------------------------------------------------*
      *              * Tipo funzionamento                              *
      *              *-------------------------------------------------*
           perform   pmt-key-fnz-000      thru pmt-key-fnz-999        .
      *              *-------------------------------------------------*
      *              * Prezzo di listino                               *
      *              *-------------------------------------------------*
           perform   pmt-key-prz-000      thru pmt-key-prz-999        .
      *              *-------------------------------------------------*
      *              * Categoria di sconto in riga                     *
      *              *-------------------------------------------------*
           perform   pmt-key-csc-000      thru pmt-key-csc-999        .
      *              *-------------------------------------------------*
      *              * % sconto                                        *
      *              *-------------------------------------------------*
           perform   pmt-key-sco-000      thru pmt-key-sco-999        .
      *              *-------------------------------------------------*
      *              * Categoria provvigioni                           *
      *              *-------------------------------------------------*
           perform   pmt-key-cpv-000      thru pmt-key-cpv-999        .
      *              *-------------------------------------------------*
      *              * % provvigioni                                   *
      *              *-------------------------------------------------*
           perform   pmt-key-pvg-000      thru pmt-key-pvg-999        .
       pmt-key-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Prompt : Categoria di provvigioni                         *
      *    *-----------------------------------------------------------*
       pmt-key-cpv-000.
      *              *-------------------------------------------------*
      *              * Test se prompt da visualizzare                  *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-key-din-999.
       acc-key-din-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-tes-dva-ini          .
       acc-key-din-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-dva-ini        =    zero
                     go to acc-key-din-100.
       acc-key-din-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-dva-fin        not  = zero
                     go to acc-key-dfi-600.
           if        v-key                =    "UP  "
                     go to acc-key-dfi-600
           else      go to acc-key-dfi-100.
       acc-key-dfi-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-prs-tfu-pcp        =    zero
                     go to acc-key-fnz-999.
       acc-key-fnz-050.
      *                  *---------------------------------------------*
      *                  * Preparazione eventuale default              *
      *                  *---------------------------------------------*
           if        w-tes-tip-fnz        not  = zero
                     go to acc-key-fnz-075.
           move      w-prs-tfu-pcp        to   w-tes-tip-fnz          .
       acc-key-fnz-075.
      *                  *---------------------------------------------*
      *                  * Fine pre-accettazione                       *
      *                  *---------------------------------------------*
           go to     acc-key-fnz-100.
       acc-key-fnz-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-tip-fnz        not  = zero
                     go to acc-key-fnz-500.
           if        v-key                =    "UP  "
                     go to acc-key-fnz-600
           else      go to acc-key-fnz-100.
       acc-key-fnz-500.
      *                  *---------------------------------------------*
      *                  * Controllo se valore non a zero              *
      *                  *---------------------------------------------*
           if        w-tes-tip-fnz        >    w-exp-tip-fun-num
                     go to acc-key-fnz-100.
       acc-key-fnz-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      ...
      *                  *---------------------------------------------*
           if        w-tes-tip-fnz        =    01
                     move  "S"            to   w-tes-snx-prz
                     move  "S"            to   w-tes-snx-sco
                     move  "S"            to   w-tes-snx-pvg
           else if   w-tes-tip-fnz        =    02
                     move  "S"            to   w-tes-snx-prz
                     move  "N"            to   w-tes-snx-sco
                     move  "N"            to   w-tes-snx-pvg
           else if   w-tes-tip-fnz        =    03
                     move  "N"            to   w-tes-snx-prz
                     move  "S"            to   w-tes-snx-sco
                     move  "N"            to   w-tes-snx-pvg
           else if   w-tes-tip-fnz        =    04
                     move  "N"            to   w-tes-snx-prz
                     move  "N"            to   w-tes-snx-sco
                     move  "S"            to   w-tes-snx-pvg
           else if   w-tes-tip-fnz        =    05
                     move  "S"            to   w-tes-snx-prz
                     move  "S"            to   w-tes-snx-sco
                     move  "N"            to   w-tes-snx-pvg
           else if   w-tes-tip-fnz        =    06
                     move  "S"            to   w-tes-snx-prz
                     move  "N"            to   w-tes-snx-sco
                     move  "S"            to   w-tes-snx-pvg
           else if   w-tes-tip-fnz        =    07
                     move  "N"            to   w-tes-snx-prz
                     move  "S"            to   w-tes-snx-sco
                     move  "S"            to   w-tes-snx-pvg
           else      move  "S"            to   w-tes-snx-prz
                     move  "S"            to   w-tes-snx-sco
                     move  "S"            to   w-tes-snx-pvg          .
       acc-key-fnz-700.
      *                  *---------------------------------------------*
      ...
      *                      * Se prezzo a no                          *
      *                      *-----------------------------------------*
           if        w-tes-snx-prz        not  = "N"
                     go to acc-key-fnz-720.
      *                      *-----------------------------------------*
      ...
      *                      * Se sconti a no                          *
      *                      *-----------------------------------------*
           if        w-tes-snx-sco        not  = "N"
                     go to acc-key-fnz-740.
      *                      *-----------------------------------------*
      *                      * Normalizzazione e visualizzazione       *
      *                      * % di sconto                             *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-per-sco (1)      .
           move      zero                 to   w-tes-per-sco (2)      .
           move      zero                 to   w-tes-per-sco (3)      .
           move      zero                 to   w-tes-per-sco (4)      .
           move      zero                 to   w-tes-per-sco (5)      .
           perform   vis-key-sco-000      thru vis-key-sco-999        .
       acc-key-fnz-740.
      *                      *-----------------------------------------*
      *                      * Se provvigioni a no                     *
      *                      *-----------------------------------------*
           if        w-tes-snx-pvg        not  = "N"
                     go to acc-key-fnz-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione e visualizzazione       *
      *                      * % di provvigioni                        *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-prs-tfu-pcp        =    zero
                     go to acc-key-prz-100.
      *                      *-----------------------------------------*
      *                      * Se Tipo funzionamento che non prevede   *
      *                      * il prezzo : uscita                      *
      *                      *-----------------------------------------*
           if        w-tes-snx-prz        not  = "S"
                     go to acc-key-prz-999.
       acc-key-prz-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        w-tes-prz-lst        not  = zero
                     go to acc-key-prz-600.
           if        v-key                =    "UP  "
                     go to acc-key-prz-600
           else      go to acc-key-prz-100.
       acc-key-prz-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cat-sco        to   w-cmn-zcs-003-cod      .
           move      18                   to   w-cmn-zcs-003-lin      .
           move      30                   to   w-cmn-zcs-003-pos      .
           move      18                   to   w-cmn-zcs-003-dln      .
       ...
       acc-key-csc-110.
           ...
           if        w-cmn-zcs-003-ope    =    "F+"
                     go to acc-key-csc-115.
           if        w-cmn-zcs-003-ope    =    "AC"
                     go to acc-key-csc-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-key-csc-115.
           perform   cmn-zcs-003-foi-000  thru cmn-zcs-003-foi-999    .
           go to     acc-key-csc-110.
       acc-key-csc-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-key-csc-999.
       acc-key-csc-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cat-sco          .
       acc-key-csc-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cat-sco        to   w-let-arc-zcs-cod      .
           perform   let-arc-zcs-000      thru let-arc-zcs-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-zcs-des    to   w-tes-cat-sco-des      .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       vis-key-dsc-000.
           ...
           move      18                   to   v-lin                  .
           move      37                   to   v-pos                  .
           move      w-tes-cat-sco-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-key-dsc-999.
           exit.
      ...
      *                      *-----------------------------------------*
           if        w-prs-tfu-pcp        =    zero
                     go to acc-key-sco-050.
      *                      *-----------------------------------------*
      *                      * Se Tipo funzionamento che non prevede   *
      *                      * percentuali di sconto : uscita          *
      *                      *-----------------------------------------*
           if        w-tes-snx-sco        not  = "S"
                     go to acc-key-sco-999.
       acc-key-sco-050.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        v-key                =    "UP  "
                     go to acc-key-sco-660
           else if   v-key                =    "DOWN"
                     go to acc-key-sco-670
           else if   v-key                =    "TAB "
                     go to acc-key-sco-700
           else if   v-key                =    "DO  "
                     go to acc-key-sco-800
           else      go to acc-key-sco-670.
       acc-key-sco-660.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-prs-tfu-pcp        =    zero
                     go to acc-key-cpv-999.
      *                      *-----------------------------------------*
      *                      * Se Tipo funzionamento che non prevede   *
      *                      * percentuali di provvigione : uscita     *
      *                      *-----------------------------------------*
           if        w-tes-snx-pvg        not  = "S"
                     go to acc-key-cpv-999.
       acc-key-cpv-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           ...
           move      20                   to   w-cmn-zpv-002-lin      .
           move      30                   to   w-cmn-zpv-002-pos      .
           move      20                   to   w-cmn-zpv-002-dln      .
       ...
       acc-key-cpv-110.
           ...
           if        w-cmn-zpv-002-ope    =    "F+"
                     go to acc-key-cpv-115.
           if        w-cmn-zpv-002-ope    =    "AC"
                     go to acc-key-cpv-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-key-cpv-115.
           perform   cmn-zpv-002-foi-000  thru cmn-zpv-002-foi-999    .
           go to     acc-key-cpv-110.
       acc-key-cpv-120.
      ...
      *                  *---------------------------------------------*
           if        v-key                =    "UP  "
                     go to acc-key-pvg-660
           else if   v-key                =    "DOWN"
                     go to acc-key-pvg-670
           else if   v-key                =    "TAB "
                     go to acc-key-pvg-700
           else if   v-key                =    "DO  "
                     go to acc-key-pvg-800
           else      go to acc-key-pvg-670.
       acc-key-pvg-660.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       vis-lin-cor-480.
      *                  *---------------------------------------------*
      *                  * Editing si/no annullamento riga             *
      *                  *---------------------------------------------*
           if        w-rig-snx-rmv (1)    =    spaces
                     move  spaces         to   w-lin-imm-snx-rmv
           else      move  "*"            to   w-lin-imm-snx-rmv      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Segnale di annullamento riga                *
      *                  *---------------------------------------------*
           perform   pmt-snx-rmv-000      thru pmt-snx-rmv-999        .
      *                  *---------------------------------------------*
      *                  * Tipo funzionamento                          *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Flag di annullamento             *
      *    * le                                                        *
      *    *-----------------------------------------------------------*
       pmt-snx-rmv-000.
           move      "DS"                 to   v-ope                  .
      ...
      *
           if        w-rig-snx-rmv (1)    =    spaces
                     move  "#"            to   w-rig-snx-rmv (1)
           else      move  spaces         to   w-rig-snx-rmv (1)      .
      *
           perform   pmt-snx-rmv-000      thru pmt-snx-rmv-999        .
           move      spaces               to   v-key                  .
       acc-cod-pro-250.
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           ...
           move      zero                 to   w-tes-dva-ini          .
           move      zero                 to   w-tes-dva-fin          .
           move      zero                 to   w-tes-tip-fnz          .
           move      zero                 to   w-tes-prz-lst          .
           ...
           move      zero                 to   w-tes-per-pvg (2)      .
           move      zero                 to   w-tes-per-pvg (3)      .
           move      zero                 to   w-tes-cat-sco          .
           move      spaces               to   w-tes-cat-sco-des      .
           move      zero                 to   w-tes-per-sco (1)      .
           move      zero                 to   w-tes-per-sco (2)      .
           move      zero                 to   w-tes-per-sco (3)      .
           move      zero                 to   w-tes-per-sco (4)      .
           move      zero                 to   w-tes-per-sco (5)      .
           move      spaces               to   w-tes-snx-prz          .
           move      spaces               to   w-tes-snx-sco          .
           move      spaces               to   w-tes-snx-pvg          .
           move      spaces               to   w-tes-cnf-imp          .
       nor-key-reg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      spaces               to   w-rig-snx-sto (1)      .
           move      spaces               to   w-rig-snx-mod (1)      .
           move      spaces               to   w-rig-snx-rmv (1)      .
      ...
      *                      *-----------------------------------------*
       ...
       car-fil-rap-450.
      *                  *---------------------------------------------*
      *                  * Eventuali valori generati automaticamente   *
      *                  *---------------------------------------------*
           perform   car-fil-rap-gen-000  thru car-fil-rap-gen-999    .
       car-fil-rap-480.
      *                  *---------------------------------------------*
      ...
      *              * Data validita' iniziale                         *
      *              *-------------------------------------------------*
           move      w-tes-dva-ini        to   w-rig-dva-ini (1)      .
      *              *-------------------------------------------------*
      *              * Data validita' finale                           *
      *              *-------------------------------------------------*
           move      w-tes-dva-fin        to   w-rig-dva-fin (1)      .
      *              *-------------------------------------------------*
      *              * Tipo funzionamento                              *
      *              *-------------------------------------------------*
           move      w-tes-tip-fnz        to   w-rig-tip-fnz (1)      .
      *              *-------------------------------------------------*
      *              * Prezzo di listino attuale                       *
      *              *-------------------------------------------------*
           move      w-tes-prz-lst        to   w-rig-prz-lst (1)      .
      *              *-------------------------------------------------*
      *              * Categoria di provvigioni                        *
      *              *-------------------------------------------------*
           move      w-tes-cat-pvg        to   w-rig-cat-pvg (1)      .
           move      w-tes-cat-pvg-des    to   w-rig-cat-pvg-des (1)  .
      *              *-------------------------------------------------*
      *              * % di provvigioni                                *
      *              *-------------------------------------------------*
           move      w-tes-per-pvg (1)    to   w-rig-per-pvg (1, 1)   .
           move      w-tes-per-pvg (2)    to   w-rig-per-pvg (1, 2)   .
           move      w-tes-per-pvg (3)    to   w-rig-per-pvg (1, 3)   .
      *              *-------------------------------------------------*
      *              * Categoria di sconto                             *
      *              *-------------------------------------------------*
           move      w-tes-cat-sco        to   w-rig-cat-sco (1)      .
           move      w-tes-cat-sco-des    to   w-rig-cat-sco-des (1)  .
      *              *-------------------------------------------------*
      *              * % sconto                                        *
      *              *-------------------------------------------------*
           move      w-tes-per-sco (1)    to   w-rig-per-sco (1, 1)   .
           move      w-tes-per-sco (2)    to   w-rig-per-sco (1, 2)   .
           move      w-tes-per-sco (3)    to   w-rig-per-sco (1, 3)   .
           move      w-tes-per-sco (4)    to   w-rig-per-sco (1, 4)   .
           move      w-tes-per-sco (5)    to   w-rig-per-sco (1, 5)   .
      *              *-------------------------------------------------*
      *              * Flags di si/no utilizzo                         *
      *              *-------------------------------------------------*
           move      w-tes-snx-prz        to   w-rig-snx-prz (1)      .
           move      w-tes-snx-pvg        to   w-rig-snx-pvg (1)      .
           move      w-tes-snx-sco        to   w-rig-snx-sco (1)      .
       car-fil-rap-gen-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     car-fil-rap-gen-999.
       car-fil-rap-gen-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *              * Test se riga annullata                          *
      *              *-------------------------------------------------*
           if        w-rig-snx-rmv (1)    not  = spaces
                     go to sca-fil-rap-100.
       sca-fil-rap-200.
      *              *-------------------------------------------------*
