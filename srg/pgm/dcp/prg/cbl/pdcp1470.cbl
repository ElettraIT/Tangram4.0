      ...
      *                                   Fase:    dcp147              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 24/05/95    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcp1471:        *
      *                                                                *
      *                    Stampa codici marketing per classificazioni *
      *                    dati commerciali prodotti                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    STAMPA CODICI MARKETING PRODOTTI    "       .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella codici marketing prodotti  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zkc-003-cod      .
           move      14                   to   w-cmn-zkc-003-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zkc-003-ope      .
           move      rr-cod-max           to   w-cmn-zkc-003-cod      .
           move      14                   to   w-cmn-zkc-003-lin      .
           move      52                   to   w-cmn-zkc-003-pos      .
           move      zero                 to   w-cmn-zkc-003-dln      .
           move      zero                 to   w-cmn-zkc-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
      *              * Forzatura del tipo classificatore a : 03        *
      *              *-------------------------------------------------*
           move      03                   to   rr-tip-clm             .
       reg-ric-sel-999.
           exit.
