      ...
      *                                   Fase:    dcp450              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/01/95    *
      *                       Ultima revisione:    NdK del 26/04/21    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Manutenzione descrizioni prodotti           *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-des-key          pic  x(40)                  .
               10  w-rig-des-int          pic  x(40)                  .
               10  w-rig-des-doc.
                   15  w-rig-ded-rig occurs 10
                                          pic  x(40)                  .
               10  w-rig-des-utc.
                   15  w-rig-det-rig occurs 10
                                          pic  x(40)                  .
               10  w-rig-des-pdx          pic  9(01)                  .
           05  w-rig-002.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Si/no descrizione per ufficio tecnico       *
      *                  *---------------------------------------------*
           perform   prs-snx-dut-000      thru prs-snx-dut-999        .
       pre-exe-pgm-300.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Lettura della personalizzazione per si/no descrizione     *
      *    * per ufficio tecnico                                       *
      *    *-----------------------------------------------------------*
       prs-snx-dut-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-prs-snx-dut          .
      *              *-------------------------------------------------*
      *              * Lettura personalizzazione                       *
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/dcp[snx-dut]"   to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                not  = spaces
                     go to prs-snx-dut-999.
      *              *-------------------------------------------------*
      *              * Valore personalizzazione in work-area           *
      *              *-------------------------------------------------*
           move      s-alf                to   w-prs-snx-dut          .
      *              *-------------------------------------------------*
      *              * Controllo personalizzazione                     *
      *              *-------------------------------------------------*
           if        w-prs-snx-dut        not  = "S"
                     move  "N"            to   w-prs-snx-dut          .
       prs-snx-dut-999.
           exit.
      ...
      *                  * Descrizione interna                         *
      *                  *---------------------------------------------*
           perform   acc-rig-int-000      thru acc-rig-int-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  *---------------------------------------------*
           perform   acc-rig-doc-000      thru acc-rig-doc-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
       ...
       acc-cor-reg-300.
      *                  *---------------------------------------------*
      *                  * Descrizione per ufficio tecnico             *
      *                  *---------------------------------------------*
           perform   acc-rig-dut-000      thru acc-rig-dut-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           move      w-rig-des-int        to   w-lin-imm-des-pro      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              * Descrizione interna                             *
      *              *-------------------------------------------------*
           perform   vis-rig-int-000      thru vis-rig-int-999        .
      *              *-------------------------------------------------*
      *              * Descrizione per documenti                       *
      *              *-------------------------------------------------*
           perform   vis-rig-doc-000      thru vis-rig-doc-999        .
      *              *-------------------------------------------------*
      *              * Descrizione per ufficio tecnico                 *
      *              *-------------------------------------------------*
           perform   vis-rig-dut-000      thru vis-rig-dut-999        .
       vis-rig-cor-999.
           exit.
      ...
      *              * Descrizione interna                             *
      *              *-------------------------------------------------*
           perform   pmt-rig-int-000      thru pmt-rig-int-999        .
      *              *-------------------------------------------------*
      *              * Descrizione per documenti                       *
      *              *-------------------------------------------------*
           perform   pmt-rig-doc-000      thru pmt-rig-doc-999        .
      *              *-------------------------------------------------*
      *              * Descrizione per ufficio tecnico                 *
      *              *-------------------------------------------------*
           perform   pmt-rig-dut-000      thru pmt-rig-dut-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione campo : Descrizione interna                  *
      *    *-----------------------------------------------------------*
       acc-rig-int-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-des-int        to   w-sav-des-int          .
       acc-rig-int-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-int-999.
       acc-rig-int-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-rig-des-int          .
       acc-rig-int-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-des-int        not  = spaces
                     go to acc-rig-int-450.
           if        v-key                =    "UP  "
                     go to acc-rig-int-600
           else      go to acc-rig-int-100.
       acc-rig-int-450.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-rig-des-int        to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-rig-des-key          .
       acc-rig-int-650.
      *                  *---------------------------------------------*
      *                  * Preparazione descrizione per documenti      *
      *                  *---------------------------------------------*
       acc-rig-int-655.
      *                      *-----------------------------------------*
      *                      * Se descrizione ad uso interno a spaces, *
      *                      * si pone a spaces anche quella per docu- *
      *                      * menti                                   *
      *                      *-----------------------------------------*
           if        w-rig-des-int        =    spaces
                     move  spaces         to   w-rig-des-doc    
                     go to acc-rig-int-660.
      *                      *-----------------------------------------*
      *                      * Se descrizione per documenti a spaces,  *
      *                      * la si pone comunque pari a quella per   *
      *                      * uso interno                             *
      *                      *-----------------------------------------*
           if        w-rig-des-doc        =    spaces
                     move  w-rig-des-int    
                                          to   w-rig-des-doc    
                     go to acc-rig-int-660.
      *                      *-----------------------------------------*
      *                      * Se descrizione per documenti e' diversa *
      *                      * da spaces la si pone pari a quella per  *
      *                      * uso interno solamente se prima dell'im- *
      *                      * postazione era pari a quella per uso    *
      *                      * interno                                 *
      *                      *-----------------------------------------*
           if        w-rig-des-doc        =    w-sav-des-int
                     move  w-rig-des-int    
                                          to   w-rig-des-doc    
                     go to acc-rig-int-660.
      *                      *-----------------------------------------*
      *                      * Altrimenti si lascia la descrizione per *
      *                      * documenti inalterata                    *
      *                      *-----------------------------------------*
           go to     acc-rig-int-665.
       acc-rig-int-660.
      *                      *-----------------------------------------*
      *                      * Visualizzazione descrizione per docu-   *
      *                      * menti                                   *
      *                      *-----------------------------------------*
           perform   vis-rig-doc-000      thru vis-rig-doc-999        .
       acc-rig-int-665.
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione interna               *
      *    *-----------------------------------------------------------*
       vis-rig-int-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-doc-999.
       acc-rig-doc-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-txt                to   w-rig-des-doc          .
       acc-rig-doc-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * che non sia su tasto Up                     *
      *                  *---------------------------------------------*
           if        w-rig-des-doc        not  = spaces
                     go to acc-rig-doc-450.
           if        v-key                =    "UP  "
                     go to acc-rig-doc-600
           else      go to acc-rig-doc-100.
       acc-rig-doc-450.
      *                  *---------------------------------------------*
      *                  * Compattamento verso l'alto delle righe di   *
      *                  * descrizione per i documenti                 *
      *                  *---------------------------------------------*
           move      w-rig-des-doc        to   w-cmp-rig-des-des      .
           perform   cmp-rig-des-000      thru cmp-rig-des-999        .
           move      w-cmp-rig-des-des    to   w-rig-des-doc          .
      *                  *---------------------------------------------*
      *                  * Se compattamento avvenuto : reimpostazione  *
      *                  *---------------------------------------------*
           if        w-cmp-rig-des-flg    not  = spaces
                     go to acc-rig-doc-100.
       acc-rig-doc-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-des-doc        =    w-rig-des-int    
                     move  0              to   w-rig-des-pdx    
           else      move  1              to   w-rig-des-pdx          .
       acc-rig-doc-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione per documenti         *
      *    *-----------------------------------------------------------*
       vis-rig-doc-000.
           move      "DS"                 to   v-ope                  .
           move      "T"                  to   v-tip                  .
      ...
      *                  * da spaces                                   *
      *                  *---------------------------------------------*
           if        w-rig-des-utc        =    spaces
                     go to acc-rig-dut-600.
           move      w-rig-des-utc        to   w-cmp-rig-des-des      .
           perform   cmp-rig-des-000      thru cmp-rig-des-999        .
           move      w-cmp-rig-des-des    to   w-rig-des-utc          .
      *                  *---------------------------------------------*
      *                  * Se compattamento avvenuto : reimpostazione  *
      *                  *---------------------------------------------*
           if        w-cmp-rig-des-flg    not  = spaces
                     go to acc-rig-dut-100.
       acc-rig-dut-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-rig-des-doc        not  = spaces
                     go to cnt-tdo-rig-010.
           move      "Manca la descrizione per documenti"
                                          to   w-box-msg-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-010.
      *              *-------------------------------------------------*
      *              * Controllo su descrizione per ufficio tecnico    *
      *              *-------------------------------------------------*
       cnt-tdo-rig-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-des-int        to   w-rig-des-doc          .
       cnt-tdo-rig-800.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      spaces               to   w-rig-des-int          .
           move      spaces               to   w-rig-des-doc          .
           move      spaces               to   w-rig-des-utc          .
           move      zero                 to   w-rig-des-pdx          .
       nor-nok-rig-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcp-des-key       to   w-rig-des-key          .
           move      rf-dcp-des-pro       to   w-rig-des-int          .
           move      rf-dcp-des-pdx       to   w-rig-des-pdx          .
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Test su flag di presenza della  *
      *                              * descrizione estesa : se non     *
      *                              * presente, la descrizione viene  *
      *                              * posta uguale a quella interna   *
      *                              *---------------------------------*
           if        w-rig-des-pdx        =    0
                     move  w-rig-des-int  to   w-rig-des-doc
                     go to car-eff-rig-300.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      w-rig-num-pro        to   w-let-arc-pdx-pro      .
      ...
      *                              * ne letta                        *
      *                              *---------------------------------*
           move      w-let-arc-pdx-des    to   w-rig-des-doc          .
       car-eff-rig-300.
      *                          *-------------------------------------*
      *                          * Descrizione per ufficio tecnico     *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Test se campo gestito           *
      *                              *---------------------------------*
           if        w-prs-snx-dut        not  = "S"
      ...
      *                              * ne letta                        *
      *                              *---------------------------------*
           move      w-let-arc-pdx-des    to   w-rig-des-utc          .
       car-eff-rig-800.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-rig-des-key        to   rf-dcp-des-key         .
           move      w-rig-des-int        to   rf-dcp-des-pro         .
           move      w-rig-des-pdx        to   rf-dcp-des-pdx         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Rewrite record [pdx] per la descrizione *
      *                      * per i documenti                         *
      *                      *-----------------------------------------*
           perform   rew-rec-pdx-doc-000  thru rew-rec-pdx-doc-999    .
      *                      *-----------------------------------------*
      *                      * Rewrite record [pdx] per la descrizione *
      *                      * per ufficio tecnico                     *
      *                      *-----------------------------------------*
           perform   rew-rec-pdx-utc-000  thru rew-rec-pdx-utc-999    .
       sca-fil-rap-600.
      *                  *---------------------------------------------*
      *                  * Riciclo a rilettura riga da file relative   *
      *                  * di supporto                                 *
      ...
      *    *===========================================================*
      *    * Riscrittura record [pdx] per la descrizione per i docu-   *
      *    * menti                                                     *
      *    *-----------------------------------------------------------*
       rew-rec-pdx-doc-000.
      *              *-------------------------------------------------*
      *              * Ciclo per riscrittura fino a 10 righe di des-   *
      *              * crizione prodotto                               *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-rig-des-pdx        =    0
                     go to rew-rec-pdx-doc-520.
       rew-rec-pdx-doc-100.
           add       1                    to   w-cix-ctr-001          .
           if        w-cix-ctr-001        >    10
                     go to rew-rec-pdx-doc-999.
           if        w-rig-ded-rig
                    (w-cix-ctr-001)       =    spaces
                     go to rew-rec-pdx-doc-500.
      *                  *---------------------------------------------*
      *                  * Composizione record [pdx]                   *
      *                  *---------------------------------------------*
           perform   cmp-rec-pdx-doc-000  thru cmp-rec-pdx-doc-999    .
      *                  *---------------------------------------------*
      *                  * Forced put record                           *
      *                  *---------------------------------------------*
           move      "FP"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Composizione record [pdx] per la descrizione per i docu-  *
      *    * menti                                                     *
      *    *-----------------------------------------------------------*
       cmp-rec-pdx-doc-000.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Riscrittura record [pdx] per la descrizione per i listini *
      *    *-----------------------------------------------------------*
       rew-rec-pdx-utc-000.
      *              *-------------------------------------------------*
      *              * Ciclo per riscrittura fino a 10 righe di des-   *
      ...
      *                  * Composizione record [pdx]                   *
      *                  *---------------------------------------------*
           perform   cmp-rec-pdx-utc-000  thru cmp-rec-pdx-utc-999    .
      *                  *---------------------------------------------*
      *                  * Forced put record                           *
      *                  *---------------------------------------------*
           move      "FP"                 to   f-ope                  .
      ...
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
           go to     rew-rec-pdx-utc-100.
       rew-rec-pdx-utc-500.
      *              *-------------------------------------------------*
      *              * Riposizionamento contatore                      *
      *              *-------------------------------------------------*
           if        w-cix-ctr-001        >    zero
                     subtract  1          from w-cix-ctr-001
           else      go to rew-rec-pdx-utc-520.
      *              *-------------------------------------------------*
      *              * Ciclo per cancellazione righe di descrizione    *
      *              * prodotto rimanenti                              *
      *              *-------------------------------------------------*
