      ...
      *                                                                *
      *                    Manutenzione status commerciale prodotti    *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
               ...
               10  w-tes-sta-tus-sns      pic  9(01)                  .
      *            *---------------------------------------------------*
      *            * Valori sostitutivi                                *
      *            *---------------------------------------------------*
               10  w-tes-sta-sos          pic  9(02)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-sta-tus          pic  9(02)                  .
               10  w-rig-sta-tud          pic  9(07)                  .
               10  w-rig-sta-tuc          pic  9(07)                  .
               10  w-rig-sta-tuc-alf      pic  x(14)                  .
               10  w-rig-sta-tuc-des      pic  x(40)                  .
               10  w-rig-sta-tux          pic  9(02)                  .
               10  w-rig-flg-err          pic  x(01)                  .
           05  w-rig-002.
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-flg-err  pic  x(01)                  .
                   15  w-lin-imm-sta-tus  pic  x(17)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Salvataggio per Status                                *
      *        *-------------------------------------------------------*
           05  w-sav-sta-tus              pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Codice prodotto di riferimento                        *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Flag di errori in caricamento                         *
      *        *-------------------------------------------------------*
           05  w-car-eff-rig-err          pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-sta-tux.
               ...
               10  w-exp-sta-tux-tbl.
                   ...
                   15  filler             pic  x(40) value
                           "statistiche Girate sul nuovo prodotto   " .
      ...
      *    *-----------------------------------------------------------*
       01  w-fnd.
      *        *-------------------------------------------------------*
      *        * Work per Find su status                               *
      *        *-------------------------------------------------------*
           05  w-fnd-sta-tus.
               10  w-fnd-sta-tus-sel      pic  x(01)                  .
               10  w-fnd-sta-tus-cod      pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-lpt.
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Status                          *
      *        *-------------------------------------------------------*
           05  w-lpt-sta-tus-lin          pic  9(03)    value 008     .
           05  w-lpt-sta-tus-pos          pic  9(03)    value 030     .
      ...
      *              *-------------------------------------------------*
           ...
           perform   vis-sta-tus-des-000  thru vis-sta-tus-des-999    .
       vis-key-reg-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "N.B. : Le selezioni operate dal filtro influiscono
      -              " nell'estrazione dei dati in  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       quanto nei filtri stessi e' trattato lo sta
      -              "tus prodotto.                 "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *    *-----------------------------------------------------------*
       pmt-sta-tus-000.
           ...
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-sta-tus-lin    to   v-lin                  .
           move      01                   to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           move      w-tes-sta-tus        to   w-sav-sta-tus          .
      *                  *---------------------------------------------*
      *                  * Test se richiesta sostituzione              *
      *                  *---------------------------------------------*
           if        w-tes-sta-tus-sns    =    zero
      ...
      *              *-------------------------------------------------*
           ...
           move      "<B"                 to   v-edm                  .
           move      w-lpt-sta-tus-lin    to   v-lin                  .
           move      w-lpt-sta-tus-pos    to   v-pos                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "DO  "               to   v-pfk (05)             .
           move      "[1] "               to   v-pfk (14)             .
           move      w-tes-sta-tus        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      ...
      *                  * Find su status                              *
      *                  *---------------------------------------------*
           perform   fnd-sta-tus-000      thru fnd-sta-tus-999        .
           if        w-fnd-sta-tus-sel    not  = spaces
                     go to acc-sta-tus-100.
           move      w-fnd-sta-tus-cod    to   w-tes-sta-tus          .
           perform   vis-sta-tus-000      thru vis-sta-tus-999        .
           perform   vis-sta-tus-des-000  thru vis-sta-tus-des-999    .
           move      spaces               to   v-key                  .
           go to     acc-sta-tus-400.
       acc-sta-tus-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
      ...
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-sta-tus-sos-000  thru acc-sta-tus-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sta-tus-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-sta-tus-sos-000  thru vis-sta-tus-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-sta-tus-sns    not  = zero
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione Status                *
      *    *-----------------------------------------------------------*
       vis-sta-tus-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *
           if        w-tes-sta-tus        =    00
                     move  "Tutti                                   "
                                          to   v-alf
           else if   w-tes-sta-tus        =    01
                     move  "Normale                                 "
                                          to   v-alf
           else if   w-tes-sta-tus        =    11
                     move  "Ad esaurimento                          "
                                          to   v-alf
           else if   w-tes-sta-tus        =    21
                     move  "Sostituito da ns. nuovo prodotto        "
                                          to   v-alf
           else if   w-tes-sta-tus        =    51
                     move  "Cessata commercializzazione             "
                                          to   v-alf
           else if   w-tes-sta-tus        =    52
                     move  "Cessata commercializzazione, ma sost.   "
                                          to   v-alf
           else if   w-tes-sta-tus        =    71
                     move  "Obsoleto                                "
                                          to   v-alf
           else if   w-tes-sta-tus        =    72
                     move  "Obsoleto, ma sost. da nuovo prodotto    "
                                          to   v-alf
           else      move  "? (status non codificato)               "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-sta-tus-des-999.
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-sta-tus-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-sta-tus-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-sta-tus-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-sta-tus-sos-010.
      ...
      *                  *---------------------------------------------*
           perform   vis-sta-tus-so1-000  thru vis-sta-tus-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-sta-tus-so2-000  thru vis-sta-tus-so2-999    .
       acc-sta-tus-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-sta-tus-so1-000  thru acc-sta-tus-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sta-tus-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-sta-tus-sos-600.
       acc-sta-tus-sos-300.
      *                  *---------------------------------------------*
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-sta-tus-so2-000  thru acc-sta-tus-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-sta-tus-sos-600.
           if        v-key                =    "UP  "
                     go to acc-sta-tus-sos-200.
       acc-sta-tus-sos-600.
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-sta-tus        =    zero  and
                     w-tes-sta-sos        =    zero
                     go to acc-sta-tus-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-sta-tus        not  = w-tes-sta-sos
                     go to acc-sta-tus-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-sta-sos          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-sta-tus        not  = zero or
                     w-tes-sta-sos        not  = zero
                     move  1              to   w-tes-sta-tus-sns      .
       acc-sta-tus-sos-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-sta-tus-sns    =    zero
                     go to vis-sta-tus-sos-100
           else      go to vis-sta-tus-sos-500.
       vis-sta-tus-sos-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "FIND"
                     go to acc-sta-tus-so1-400.
      *                  *---------------------------------------------*
      *                  * Find su status                              *
      *                  *---------------------------------------------*
           perform   fnd-sta-tus-000      thru fnd-sta-tus-999        .
           if        w-fnd-sta-tus-sel    not  = spaces
                     go to acc-sta-tus-so1-100.
           move      w-fnd-sta-tus-cod    to   w-tes-sta-tus          .
           perform   vis-sta-tus-so1-000  thru vis-sta-tus-so1-999    .
           move      spaces               to   v-key                  .
       acc-sta-tus-so1-400.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-sta-tus-so2-999.
       acc-sta-tus-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-sta-sos          .
       acc-sta-tus-so2-250.
      *              *-------------------------------------------------*
      *              * Se Find                                         *
      *              *-------------------------------------------------*
           if        v-key                not  = "FIND"
                     go to acc-sta-tus-so2-400.
      *                  *---------------------------------------------*
      *                  * Find su status                              *
      *                  *---------------------------------------------*
           perform   fnd-sta-tus-000      thru fnd-sta-tus-999        .
           if        w-fnd-sta-tus-sel    not  = spaces
                     go to acc-sta-tus-so2-100.
           move      w-fnd-sta-tus-cod    to   w-tes-sta-sos          .
           perform   vis-sta-tus-so2-000  thru vis-sta-tus-so2-999    .
           move      spaces               to   v-key                  .
       acc-sta-tus-so2-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-sta-sos        =    01 or
                     ...
                     w-tes-sta-sos        =    71 or
                     w-tes-sta-sos        =    72
                     go to acc-sta-tus-so2-600
           else      go to acc-sta-tus-so2-100.
       acc-sta-tus-so2-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * Status commerciale                          *
      *                  *---------------------------------------------*
           perform   acc-rig-tus-000      thru acc-rig-tus-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * Flag di errore                              *
      *                  *---------------------------------------------*
           move      w-rig-flg-err        to   w-lin-imm-flg-err      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *
           ...
           else if   w-rig-sta-tus        =    11
                     move  "Ad esaurimento   "
                                          to   w-all-str-cat (1)
                     move  spaces         to   w-all-str-cat (2)
           else if   w-rig-sta-tus        =    21
                     move  "Ss:"          to   w-all-str-cat (1)
                     move  w-rig-sta-tuc-alf
                                          to   w-all-str-cat (2)
           else if   w-rig-sta-tus        =    51
                     move  "Cessata comm.    "
                                          to   w-all-str-cat (1)
                     move  spaces         to   w-all-str-cat (2)
           else if   w-rig-sta-tus        =    52
                     move  "Cc:"          to   w-all-str-cat (1)
                     move  w-rig-sta-tuc-alf
                                          to   w-all-str-cat (2)
           else if   w-rig-sta-tus        =    71
                     move  "Obsoleto         "
                                          to   w-all-str-cat (1)
                     move  spaces         to   w-all-str-cat (2)
           else if   w-rig-sta-tus        =    72
                     move  "Ob:"          to   w-all-str-cat (1)
                     move  w-rig-sta-tuc-alf
                                          to   w-all-str-cat (2)
           else      move  "?                "
                                          to   w-all-str-cat (1)
      ...
      *
           ...
           move      w-all-str-alf        to   w-lin-imm-sta-tus      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              * Status                                          *
      *              *-------------------------------------------------*
           perform   vis-rig-tus-000      thru vis-rig-tus-999        .
      *              *-------------------------------------------------*
      *              * Data determinazione status                      *
      *              *-------------------------------------------------*
      ...
      *              * Status                                          *
      *              *-------------------------------------------------*
           perform   pmt-rig-tus-000      thru pmt-rig-tus-999        .
      *              *-------------------------------------------------*
      *              * Data determinazione status                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice prodotto di riferimento   *
      *    *-----------------------------------------------------------*
       pmt-sta-tuc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Modalita' di trattamento         *
      *    *-----------------------------------------------------------*
       pmt-sta-tux-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-sta-tus        to   w-sav-sta-tus          .
       acc-rig-tus-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-tus-999.
       acc-rig-tus-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  01             to   w-rig-sta-tus    
           else if   v-num                =    02
                     move  11             to   w-rig-sta-tus    
           else if   v-num                =    03
                     move  21             to   w-rig-sta-tus    
           else if   v-num                =    04
                     move  51             to   w-rig-sta-tus    
           else if   v-num                =    05
                     move  52             to   w-rig-sta-tus    
           else if   v-num                =    06
                     move  71             to   w-rig-sta-tus    
           else if   v-num                =    07
                     move  72             to   w-rig-sta-tus    
           else      move zero            to   w-rig-sta-tus          .
       acc-rig-tus-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * fosse gia' a zero                           *
      *                  *---------------------------------------------*
           if        w-rig-sta-tus        not  = zero
                     go to acc-rig-tus-600.
           if        v-key                not  = "UP  "
                     go to acc-rig-tus-100.
           if        w-sav-sta-tus        =    zero
                     go to acc-rig-tus-600
           else      go to acc-rig-tus-100.
       acc-rig-tus-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * statistiche                                 *
      *                  *---------------------------------------------*
           if        w-rig-sta-tuc        =    zero
                     go to acc-rig-tus-650.
           if        w-rig-sta-tus        =    w-sav-sta-tus
                     go to acc-rig-tus-650.
           if        w-rig-sta-tus        =    21  or
                     w-rig-sta-tus        =    52  or
                     w-rig-sta-tus        =    72
                     go to acc-rig-tus-650.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-rig-sta-tuc          .
           move      spaces               to   w-rig-sta-tuc-alf      .
           move      spaces               to   w-rig-sta-tuc-des      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione modalita' di trattamento    *
      *                  * per le statistiche                          *
      *                  *---------------------------------------------*
           move      zero                 to   w-rig-sta-tux          .
      *                  *---------------------------------------------*
      ...
      *                  * mento status                                *
      *                  *---------------------------------------------*
           if        w-rig-sta-tud        =    zero
                     go to acc-rig-tus-800.
           if        w-rig-sta-tus        =    w-sav-sta-tus
                     go to acc-rig-tus-800.
           if        w-rig-sta-tus        not  = 01
                     go to acc-rig-tus-800.
      *                  *---------------------------------------------*
      *                  * Normalizzazione data di rilevamento status  *
      *                  *---------------------------------------------*
           move      zero                 to   w-rig-sta-tud          .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Codice prodotto di riferi-   *
      *    *                              mento                        *
      *    *-----------------------------------------------------------*
       acc-sta-tuc-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-sta-tus        not  = 21  and
                     w-rig-sta-tus        not  = 52  and
                     w-rig-sta-tus        not  = 72
                     go to acc-sta-tuc-999.
       acc-sta-tuc-100.
      *              *-------------------------------------------------*
      *              * Salvataggio valore precedente                   *
      *              *-------------------------------------------------*
           move      w-rig-sta-tuc        to   w-sav-sta-tuc          .
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-dcp-ope      .
           move      "A"                  to   w-cod-cod-dcp-tac      .
           move      w-rig-sta-tuc        to   w-cod-cod-dcp-num      .
           move      w-rig-sta-tuc-alf    
                                          to   w-cod-cod-dcp-alf      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-sta-tuc          .
           move      v-alf                to   w-rig-sta-tuc-alf      .
       acc-sta-tuc-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura file [dcp]                          *
      *                  *---------------------------------------------*
           move      w-rig-sta-tuc        to   w-let-arc-dcp-num      .
           perform   let-arc-dcp-000      thru let-arc-dcp-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-dcp-des    to   w-rig-sta-tuc-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-sta-tuc-des-000  thru vis-sta-tuc-des-999    .
      ...
      *                  *---------------------------------------------*
           if        w-rig-sta-tuc        =    w-rig-num-pro
                     go to acc-sta-tuc-100.
       acc-sta-tuc-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      ...
      *                  *---------------------------------------------*
           ...
           if        w-rig-sta-tuc        =    w-sav-sta-tuc
                     go to acc-sta-tuc-800.
           if        w-rig-sta-tux        =    zero
                     go to acc-sta-tuc-800.
      *                  *---------------------------------------------*
      *                  * Normalizzazione modalita' di trattamento    *
      *                  * per le statistiche                          *
      ...
      *                  * Test se campo da accettare                  *
      *                  *                                             *
      *                  * Solo se prodotto di riferimento diverso da  *
      *                  * zero                                        *
      *                  *---------------------------------------------*
           if        w-rig-sta-tuc        =    zero
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-sta-tux        to   w-sav-sta-tux          .
      *                  *---------------------------------------------*
      *                  * Preparazione eventuale default              *
      *                  *---------------------------------------------*
           if        w-rig-sta-tux        not  = zero
                     go to acc-sta-tux-100.
           move      01                   to   w-rig-sta-tux          .
       acc-sta-tux-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-let-arc-dcp-flg    =    spaces
                     go to cnt-tdo-rig-600.
           move      "Codice prodotto di riferimento non esistente !    
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-220.
           move      "Manca il codice prodotto di riferimento !         
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Flag di errore in riga                      *
      *                  *---------------------------------------------*
           move      spaces               to   w-rig-flg-err          .
       cnt-tdo-rig-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Normalizzazione segnale di righe con errori     *
      *              *-------------------------------------------------*
           move      spaces               to   w-car-eff-rig-err      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       car-fil-rap-800.
      *              *-------------------------------------------------*
      *              * Controllo errori in righe caricate              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su flag di uscita                      *
      *                  *---------------------------------------------*
           if        w-car-eff-rig-err    =    spaces
                     go to car-fil-rap-900.
      *                  *---------------------------------------------*
      *                  * Messaggio                                   *
      *                  *---------------------------------------------*
           move      "Attenzione : alcune sostituzioni hanno generato de
      -              "lle situazioni "    to   w-err-box-err-msg      .
           move      "anomale : procedere manualmente al controllo delle
      -              " righe con '*' "    to   w-err-box-err-m02      .
      ...
      *              * Status                                          *
      *              *-------------------------------------------------*
           if        w-tes-sta-tus-sns    =    zero and
                     w-tes-sta-tus        =    zero
                     go to sel-rec-dcp-800.
           if        rf-dcp-sta-tus       not  = w-tes-sta-tus
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcp-sta-tus       to   w-rig-sta-tus          .
           move      rf-dcp-sta-tud       to   w-rig-sta-tud          .
           move      rf-dcp-sta-tuc       to   w-rig-sta-tuc          .
           move      rf-dcp-sta-tux       to   w-rig-sta-tux          .
      *                      *-----------------------------------------*
      *                      * Lettura file [dcp] per codice prodotto  *
      *                      * di riferimento                          *
      *                      *-----------------------------------------*
           move      w-rig-sta-tuc        to   w-let-arc-dcp-num      .
           perform   let-arc-dcp-000      thru let-arc-dcp-999        .
           move      w-let-arc-dcp-des    to   w-rig-sta-tuc-des      .
           move      w-let-arc-dcp-alf    to   w-rig-sta-tuc-alf      .
      *                      *-----------------------------------------*
      ...
      *                  * Sostituzione                                *
      *                  *---------------------------------------------*
           move      w-tes-sta-sos        to   w-rig-sta-tus          .
      *                  *---------------------------------------------*
      *                  * Normalizzazioni                             *
      *                  *---------------------------------------------*
           if        w-rig-sta-tus        =    01
                     ...
                     go to car-eff-rig-sos-900.
      *                  *---------------------------------------------*
      *                  * Default data rilevazione status             *
      *                  *---------------------------------------------*
           if        w-rig-sta-tud        not  = zero
      ...
      *                  * Flags di uscita                             *
      *                  *---------------------------------------------*
           move      "#"                  to   w-car-eff-rig-err      .
           move      "*"                  to   w-rig-flg-err          .
       car-eff-rig-sos-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       sca-fil-rap-185.
      *                  *---------------------------------------------*
      *                  * Test su flag di riga con errori             *
      *                  *---------------------------------------------*
           if        w-rig-flg-err        not  = spaces
      ...
      *                      *-----------------------------------------*
           move      w-rig-sta-tus        to   rf-dcp-sta-tus         .
           move      w-rig-sta-tud        to   rf-dcp-sta-tud         .
           move      w-rig-sta-tuc        to   rf-dcp-sta-tuc         .
           move      w-rig-sta-tux        to   rf-dcp-sta-tux         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *              * Normalizzazione flag di selezione               *
      *              *-------------------------------------------------*
           move      spaces               to   w-fnd-sta-tus-sel      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  01             to   w-fnd-sta-tus-cod
           else if   v-num                =    02
                     move  11             to   w-fnd-sta-tus-cod
           else if   v-num                =    03
                     move  21             to   w-fnd-sta-tus-cod
           else if   v-num                =    04
                     move  51             to   w-fnd-sta-tus-cod
           else if   v-num                =    05
                     move  52             to   w-fnd-sta-tus-cod
           else if   v-num                =    06
                     move  71             to   w-fnd-sta-tus-cod
           else if   v-num                =    07
                     move  72             to   w-fnd-sta-tus-cod
           else      move zero            to   w-fnd-sta-tus-cod      .
      *              *-------------------------------------------------*
      *              * Ripristino immagine video                       *
      *              *-------------------------------------------------*
           move      "RS"                 to   v-ope                  .
