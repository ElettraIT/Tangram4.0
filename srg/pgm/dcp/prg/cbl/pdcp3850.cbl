      ...
      *                                   Fase:    dcp385              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 09/01/03    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Caricamento listino METEL da file           *
      *                                                                *
      *                    Listini con tracciato tipo 'ecofee'         *
      *                                                                *
      *                    /abd/asc/tmp/XXXecofee.TXT                  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Codice alfanumerico prodotto del fornitore        *
      *            *---------------------------------------------------*
               10  srt-cod-pro            pic  x(16)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Codice alfanumerico prodotto normalizzato         *
      *            *---------------------------------------------------*
               10  srt-alf-pro            pic  x(16)                  .
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    CARICAMENTO LISTINO METEL ECOFEE    "       .
      ...
      *        * Codice addebito                                       *
      *        *-------------------------------------------------------*
           05  rr-add-pro                 pic  9(03)                  .
           05  rr-add-pro-des             pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Prefisso per il codice                                *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Per determinazione codice listino                     *
      *        *-------------------------------------------------------*
           05  w-det-cod-lst.
      *            *---------------------------------------------------*
      *            * Codice alfanumerico prodotto                      *
      *            *---------------------------------------------------*
               10  w-det-cod-lst-cod      pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Contatori                                             *
      *        *-------------------------------------------------------*
           05  w-det-ctr-ele-c01          pic  9(11)                  .
           05  w-det-ctr-ele-c02          pic  9(11)                  .
           05  w-det-ctr-ele-c03          pic  9(02)                  .
           05  w-det-ctr-ele-c04          pic  9(01)                  .
      ...
      *            *---------------------------------------------------*
               10  filler                 pic  x(49)                  .
      *        *-------------------------------------------------------*
      *        * Record del prodotto 'ecofee'                          *
      *        *-------------------------------------------------------*
           05  w-rdp.
      *            *---------------------------------------------------*
      *            * Sigla marchio                                     *
      *            *---------------------------------------------------*
               10  w-rdp-sgl-mrc          pic  x(03)                  .
      *            *---------------------------------------------------*
      ...
      *            * Tipo di tassa                                     *
      *            *---------------------------------------------------*
               10  w-rdp-tip-tax          pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Peso netto                                        *
      *            *---------------------------------------------------*
               10  w-rdp-pes-net.
                   15  w-rdp-pes-net-int  pic  9(06)                  .
                   15  w-rdp-pes-net-dec  pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Consorzio                                         *
      *            *---------------------------------------------------*
               10  w-rdp-con-srz          pic  x(30)                  .
      *            *---------------------------------------------------*
      *            * Codice FEE                                        *
      *            *                                                   *
      *            * Tabella                                           *
      ...
      *            * 'NV' : non visibile                               *
      *            * 'L1' : Lampadine                                  *
      *            * 'F1' : peso da 0,1 a 2 Kg.                        *
      *            * 'F2' : peso da 2,1 a 8 Kg.                        *
      *            * 'F3' : peso da 8 Kg.                              *
      *            *---------------------------------------------------*
               10  w-rdp-cod-fee          pic  x(30)                  .
      *            *---------------------------------------------------*
      *            * Descrizione FEE                                   *
      *            *---------------------------------------------------*
               10  w-rdp-des-fee          pic  x(70)                  .
      *            *---------------------------------------------------*
      *            * Quantita' FEE                                     *
      *            *---------------------------------------------------*
               10  w-rdp-qta-fee          pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Importo FEE                                       *
      *            *---------------------------------------------------*
               10  w-rdp-imp-fee          pic  9(08)                  .
      *            *---------------------------------------------------*
      *            * % FEE                                             *
      *            *---------------------------------------------------*
               10  w-rdp-per-fee.
                   15  w-rdp-per-fee-int  pic  9(03)                  .
                   15  w-rdp-per-fee-dec  pic  9(04)                  .
      *            *---------------------------------------------------*
      *            * Codice IVA                                        *
      *            *---------------------------------------------------*
               10  w-rdp-cod-iva          pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Categoria normativa                               *
      *            *---------------------------------------------------*
               10  w-rdp-cat-nor          pic  x(70)                  .
      ...
      *                  * Codice addebito                             *
      *                  *---------------------------------------------*
           perform   acc-add-pro-000      thru acc-add-pro-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Codice addebito associato  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Fare attenzione alla corrispondenza esatta del nom
      -              "e, tra minuscole e maiuscole!"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Prefisso per il codice               *
      *    *-----------------------------------------------------------*
       acc-pre-cod-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice addebito                      *
      *    *                                                           *
      *    * MEMO: migliorare con accettazione da [zac]                *
      *    *-----------------------------------------------------------*
       acc-add-pro-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        rr-tip-exe           not  = 02
                     go to acc-add-pro-999.
       acc-add-pro-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zac-ope      .
           move      01                   to   w-cod-mne-zac-tip      .
           move      rr-add-pro           to   w-cod-mne-zac-cod      .
           move      11                   to   w-cod-mne-zac-lin      .
           move      30                   to   w-cod-mne-zac-pos      .
           move      11                   to   w-cod-mne-zac-dln      .
           move      41                   to   w-cod-mne-zac-dps      .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
       ...
       acc-add-pro-110.
           ...
           if        w-cod-mne-zac-ope    =    "F+"
                     go to acc-add-pro-115.
           if        w-cod-mne-zac-ope    =    "AC"
                     go to acc-add-pro-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-add-pro-115.
           perform   cod-mne-zac-foi-000  thru cod-mne-zac-foi-999    .
           go to     acc-add-pro-110.
       acc-add-pro-120.
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-add-pro           to   w-let-arc-zac-cod      .
           perform   let-arc-zac-000      thru let-arc-zac-999        .
      *                  *---------------------------------------------*
      *                  * Se codice errato                            *
      *                  *---------------------------------------------*
           if        w-let-arc-zac-flg    =    spaces
                     go to acc-add-pro-500.
      *                      *-----------------------------------------*
      *                      * Messaggio                               *
      *                      *-----------------------------------------*
           move      "Codice addebito non esistente !"
      ...
      *                      * A reimpostazione                        *
      *                      *-----------------------------------------*
           go to     acc-add-pro-100.
       acc-add-pro-500.
      *                  *---------------------------------------------*
      *                  * Descrizione addebito                        *
      *                  *---------------------------------------------*
           move      w-let-arc-zac-des    to   rr-add-pro-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-add-pro-des-000  thru vis-add-pro-des-999    .
       acc-add-pro-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Addebito per fatt., descrizione   *
      *    *-----------------------------------------------------------*
       vis-add-pro-des-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "/tmp/"              to   w-all-str-cat (2)      .
           move      rr-pth-acc           to   w-all-str-cat (3)      .
      ...
      *                          *-------------------------------------*
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Test su codice addebito                         *
      *              *-------------------------------------------------*
           if        rr-tip-exe           not  = 02
                     go to tdo-ric-sel-300.
           if        rr-add-pro           not  = zero
                     go to tdo-ric-sel-300.
           move      "Manca il codice addebito !"
                                          to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-300.
       tdo-ric-sel-800.
      ...
      *              * Codice addebito                                 *
      *              *                                                 *
      *              * MEMO: migliorare con referenza per default      *
      *              *-------------------------------------------------*
           if        rr-add-pro           =    zero
                     move  100            to   rr-add-pro             .
       reg-ric-sel-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-det-ctr-ele-c01      .
           move      zero                 to   w-det-ctr-ele-c02      .
      *              *-------------------------------------------------*
      *              * Open file sequenziale in input                  *
      *              *-------------------------------------------------*
           move      "OI"                 to   g-ope                  .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezioni su record file sequenziale in input   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se record di testata                   *
      *                  *---------------------------------------------*
           if        g-rec (01 : 11)      =    "ECOFEEMETEL"
      ...
      *                  *---------------------------------------------*
           move      g-rec                to   w-rdp                  .
      *                  *---------------------------------------------*
      *                  * Test se Non Visibile                        *
      *                  *---------------------------------------------*
           if        w-rdp-cod-fee
                    (01 : 02)             =    "NV" or
                     w-rdp-cod-fee        =    spaces
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Test se fascia di addebito esistente        *
      *                  *---------------------------------------------*
           if        w-rdp-cod-fee
                    (01 : 02)             =    "A1"   or
                     w-rdp-cod-fee
       ...
       stp-srt-inp-440.
      *                  *---------------------------------------------*
      *                  * Se fascia di addebito non riconosciuta      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *
           string    w-rdp-cod-pro
                                delimited by   size
                     " = fascia addebito non riconosciuta : "
                                delimited by   size
                     w-rdp-cod-fee
                                delimited by   size
                                          into m-msg                  .
      ...
      *                      *-----------------------------------------*
       ...
       stp-srt-inp-460.
      *                  *---------------------------------------------*
      *                  * Test che non ci siano blanks embedded nel   *
      *                  * codice prodotto                             *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      ...
      *
           string    w-rdp-cod-pro
                                delimited by   size
                     " = Codice prodotto non identificabile !"
                                delimited by   size
                                          into m-msg                  .
      *
           call      "swd/mod/prg/obj/mmessg"
      ...
      *                      * Codice alfanumerico prodotto            *
      *                      *-----------------------------------------*
           move      w-rdp-cod-pro        to   srt-cod-pro            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico prodotto            *
      *                      *-----------------------------------------*
           move      w-det-num-pro-alf    to   srt-alf-pro            .
      *                      *-----------------------------------------*
      *                      * Codice numerico prodotto                *
      *                      *-----------------------------------------*
      ...
      *                      * Descrizione prodotto                    *
      *                      *-----------------------------------------*
           move      w-det-num-pro-des    to   srt-des-pro            .
      *                      *-----------------------------------------*
      *                      * Record sequenziale                      *
      *                      *-----------------------------------------*
           move      w-rdp                to   srt-rec-rdp            .
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Contatore record scritti                    *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Incremento contatore                    *
      *                      *-----------------------------------------*
           add       1                    to   w-det-ctr-ele-c02      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-det-ctr-ele-c02    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Normalizzazione codice listino                  *
      *              *-------------------------------------------------*
           move      spaces               to   w-det-cod-lst-cod      .
      *              *-------------------------------------------------*
      *              * Preparazione codice listino                     *
      *              *-------------------------------------------------*
           if        w-rdp-cod-fee
                    (01 : 02)             =    "A1"
                     move  "A1 "          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 02)             =    "L1"
                     move  "L1 "          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 02)             =    "L2"
                     move  "L2 "          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 02)             =    "F1"
                     move  "F1 "          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 02)             =    "F2"
                     move  "F2 "          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 02)             =    "F3"
                     move  "F3 "          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 04)             =    "RID1"
                     move  "RD1"          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 04)             =    "RID2"
                     move  "RD2"          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 04)             =    "RID3"
                     move  "RD3"          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 04)             =    "ECO1"
                     move  "EC1"          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 04)             =    "ECO2"
                     move  "EC2"          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 04)             =    "ECO3"
                     move  "EC3"          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 04)             =    "ECO4"
                     move  "EC4"          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 04)             =    "ECO5"
                     move  "EC5"          to   w-det-cod-lst-cod
           else if   w-rdp-cod-fee
                    (01 : 04)             =    "ECO6"
                     move  "EC6"          to   w-det-cod-lst-cod      .
      *              *-------------------------------------------------*
      *              * Aggiornamento anagrafica [lst]                  *
      *              *-------------------------------------------------*
           perform   agg-rec-lst-000      thru agg-rec-lst-999        .
      *              *-------------------------------------------------*
      *              * Aggiornamento anagrafica [dcp]                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Trattamento codice addebito                 *
      *                  *---------------------------------------------*
           move      rr-add-pro           to   rf-dcp-add-pro         .
       agg-rec-dcp-600.
      *              *-------------------------------------------------*
      *              * Update del record                               *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-cod-lst-cod    to   rf-lst-cod-lst         .
      ...
      *                      * Aggiornamento                           *
      *                      *-----------------------------------------*
           move      w-rdp-imp-fee        to   rf-lst-prz-lst         .
           move      w-rdp-qta-fee        to   rf-lst-qta-rif         .
       agg-rec-lst-220.
      *                      *-----------------------------------------*
      *                      * Update del record                       *
      *                      *-----------------------------------------*
      ...
      *              * Incremento                                      *
      *              *-------------------------------------------------*
           add       1                    to   w-det-ctr-ele-c01      .
      *              *-------------------------------------------------*
      *              * Deviazione                                      *
      *              *-------------------------------------------------*
           if        w-det-ctr-ele-c01    >    100
                     go to inc-rec-let-100
           else if   w-det-ctr-ele-c01    >    10
      ...
      *              * Se maggiore di 100                              *
      *              *-------------------------------------------------*
           move      w-det-ctr-ele-c01    to   w-det-ctr-ele-c03      .
           if        w-det-ctr-ele-c03    =    zero
      ...
      *              * Se maggiore di 10                               *
      *              *-------------------------------------------------*
           move      w-det-ctr-ele-c01    to   w-det-ctr-ele-c04      .
           if        w-det-ctr-ele-c04    =    zero
                     go to inc-rec-let-500
           else      go to inc-rec-let-999.
       inc-rec-let-500.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       vis-rec-let-000.
           ...
           move      15                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-det-ctr-ele-c01    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rec-let-999.
           exit.
