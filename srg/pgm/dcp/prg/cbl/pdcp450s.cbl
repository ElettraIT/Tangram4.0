      ...
      *                                                                *
      *                    Manutenzione sinonimi prodotti              *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Si/no selezione su sinonimo                *
      *        *-------------------------------------------------------*
           05  w-exp-snx-syn.
               10  w-exp-snx-syn-num      pic  9(02)       value 03   .
               10  w-exp-snx-syn-lun      pic  9(02)       value 40   .
               10  w-exp-snx-syn-tbl.
                   15  filler             pic  x(40) value
                            "Nessuna selezione sul sinonimo          ".
                   15  filler             pic  x(40) value
                            "solo i prodotti Con sinonimo            ".
                   15  filler             pic  x(40) value
                            "solo i prodotti Senza sinonimo          ".
      ...
      *                  *---------------------------------------------*
       ...
       acc-key-reg-200.
      *                  *---------------------------------------------*
      *                  * Si/no selezioni su sinonimo                 *
      *                  *---------------------------------------------*
           perform   acc-snx-syn-000      thru acc-snx-syn-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Si/no selezioni su sinonimo                     *
      *              *-------------------------------------------------*
           perform   vis-snx-syn-000      thru vis-snx-syn-999        .
       vis-key-reg-999.
           exit.
      ...
      *              * Si/no selezioni su sinonimo                     *
      *              *-------------------------------------------------*
           perform   pmt-snx-syn-000      thru pmt-snx-syn-999        .
       pmt-key-reg-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no selezioni su sinonimo      *
      *    *-----------------------------------------------------------*
       pmt-snx-syn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no selezioni su sinonimo          *
      *    *-----------------------------------------------------------*
       acc-snx-syn-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-syn-lun    to   v-car                  .
           move      w-exp-snx-syn-num    to   v-ldt                  .
           move      "NCS#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      08                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-syn-tbl    to   v-txt                  .
           move      w-tes-snx-syn        to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-snx-syn-999.
       acc-snx-syn-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-snx-syn          .
       acc-snx-syn-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Si/no selezioni su sinonimo       *
      *    *-----------------------------------------------------------*
       vis-snx-syn-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *                  * Sinonimo                                    *
      *                  *---------------------------------------------*
           move      w-rig-syn-pro        to   w-lin-imm-syn-pro      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              * Sinonimo                                        *
      *              *-------------------------------------------------*
           perform   pmt-syn-pro-000      thru pmt-syn-pro-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *                  * Test se a spaces                            *
      *                  *---------------------------------------------*
           if        w-rig-syn-pro        =    spaces
                     go to acc-rig-syn-600.
      *                  *---------------------------------------------*
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-rig-syn-pro        to   w-all-str-alf          .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Sinonimo                          *
      *    *-----------------------------------------------------------*
       vis-rig-syn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tes-snx-syn          .
      *              *-------------------------------------------------*
      *              * Eventuali valori di default                     *
      *              *-------------------------------------------------*
           move      1                    to   w-tes-snx-syn          .
       nor-key-reg-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       sel-rec-dcp-100.
      *              *-------------------------------------------------*
      *              * Si/no selezione su sinonimo                     *
      *              *-------------------------------------------------*
           if        w-tes-snx-syn        =    1
                     go to sel-rec-dcp-800.
      *
           if        w-tes-snx-syn        =    2 and
                     rf-dcp-syn-pro       =    spaces
                     go to sel-rec-dcp-900.
      *
           if        w-tes-snx-syn        =    3 and
                     rf-dcp-syn-pro       not  = spaces
                     go to sel-rec-dcp-900.
       sel-rec-dcp-800.
      *              *-------------------------------------------------*
