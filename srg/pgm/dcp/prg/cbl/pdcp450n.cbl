      ...
      *                                                                *
      *                    Manutenzione nomenclatura combinata CEE     *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "NOMENCLATURE COMBINATE INTRACOMUNITARIE "       .
      ...
      *            *---------------------------------------------------*
               ...
               10  w-tes-cdn-cdm-sns      pic  9(01)                  .
      *            *---------------------------------------------------*
      *            * Valori sostitutivi                                *
      *            *---------------------------------------------------*
               10  w-tes-cdn-sos          pic  9(08)                  .
      *            *---------------------------------------------------*
      *            * Altri valori per la selezione                     *
      *            *---------------------------------------------------*
               10  w-tes-snx-cdn          pic  9(01)                  .
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Salvataggio per Nomenclatura                          *
      *        *-------------------------------------------------------*
           05  w-sav-cdn-cdm              pic  9(08)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Si/no selezione su nomenclatura            *
      *        *-------------------------------------------------------*
           05  w-exp-snx-cdn.
               10  w-exp-snx-cdn-num      pic  9(02)       value 03   .
               10  w-exp-snx-cdn-lun      pic  9(02)       value 40   .
               10  w-exp-snx-cdn-tbl.
                   15  filler             pic  x(40) value
                            "Nessuna selezione sulla nomenclatura    ".
                   15  filler             pic  x(40) value
                            "solo i prodotti Con nomenclatura        ".
                   15  filler             pic  x(40) value
                            "solo i prodotti Senza nomenclatura      ".
      ...
      *                  *---------------------------------------------*
       ...
       acc-key-reg-300.
      *                  *---------------------------------------------*
      *                  * Si/no selezioni su nomenclatura             *
      *                  *---------------------------------------------*
           perform   acc-snx-cdn-000      thru acc-snx-cdn-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Si/no selezioni su nomenclatura                 *
      *              *-------------------------------------------------*
           perform   vis-snx-cdn-000      thru vis-snx-cdn-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Si/no selezioni su nomenclatura             *
      *                  *---------------------------------------------*
           perform   pmt-snx-cdn-000      thru pmt-snx-cdn-999        .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no selezioni su nomenclatura  *
      *    *-----------------------------------------------------------*
       pmt-snx-cdn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      w-tes-cdn-cdm        to   w-sav-cdn-cdm          .
      *                  *---------------------------------------------*
      *                  * Test se richiesta sostituzione              *
      *                  *---------------------------------------------*
           if        w-tes-cdn-cdm-sns    =    zero
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-cdn-cdm-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-cdn-cdm-sos-000  thru acc-cdn-cdm-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cdn-cdm-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-cdn-cdm-sos-000  thru vis-cdn-cdm-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-cdn-cdm-sns    not  = zero
                     go to acc-cdn-cdm-800.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cdn-cdm-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-cdn-cdm-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-cdn-cdm-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-cdn-cdm-sos-010.
      ...
      *                  *---------------------------------------------*
           perform   vis-cdn-cdm-so1-000  thru vis-cdn-cdm-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-cdn-cdm-so2-000  thru vis-cdn-cdm-so2-999    .
       acc-cdn-cdm-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-cdn-cdm-so1-000  thru acc-cdn-cdm-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cdn-cdm-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-cdn-cdm-sos-600.
       acc-cdn-cdm-sos-300.
      *                  *---------------------------------------------*
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-cdn-cdm-so2-000  thru acc-cdn-cdm-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cdn-cdm-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cdn-cdm-sos-200.
       acc-cdn-cdm-sos-600.
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-cdn-cdm        =    zero  and
                     w-tes-cdn-sos        =    zero
                     go to acc-cdn-cdm-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-cdn-cdm        not  = w-tes-cdn-sos
                     go to acc-cdn-cdm-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-cdn-sos          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cdn-cdm        not  = zero or
                     w-tes-cdn-sos        not  = zero
                     move  1              to   w-tes-cdn-cdm-sns      .
       acc-cdn-cdm-sos-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cdn-cdm-sns    =    zero
                     go to vis-cdn-cdm-sos-100
           else      go to vis-cdn-cdm-sos-500.
       vis-cdn-cdm-sos-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cdn-cdm-so2-999.
       acc-cdn-cdm-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cdn-sos          .
       acc-cdn-cdm-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no selezioni su nomenclatura      *
      *    *-----------------------------------------------------------*
       acc-snx-cdn-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-cdn-cdm        not  = zero
                     go to acc-snx-cdn-999.
       acc-snx-cdn-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-cdn-lun    to   v-car                  .
           move      w-exp-snx-cdn-num    to   v-ldt                  .
           move      "NCS#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      11                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-cdn-tbl    to   v-txt                  .
           move      w-tes-snx-cdn        to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Si/no selezioni su nomenclatura   *
      *    *-----------------------------------------------------------*
       vis-snx-cdn-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              * Normalizzazione selettori sui dati              *
      *              *-------------------------------------------------*
           move      zero                 to   w-tes-snx-cdn          .
      *              *-------------------------------------------------*
      *              * Eventuali valori di default                     *
      *              *-------------------------------------------------*
           move      1                    to   w-tes-snx-cdn          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       sel-rec-dcp-200.
      *              *-------------------------------------------------*
      *              * Si/no selezione su nomenclatura                 *
      *              *-------------------------------------------------*
           if        w-tes-snx-cdn        =    1
                     go to sel-rec-dcp-800.
      *
           if        w-tes-snx-cdn        =    2 and
                     rf-dcp-cdn-cdm       =    zero
                     go to sel-rec-dcp-900.
      *
           if        w-tes-snx-cdn        =    3 and
                     rf-dcp-cdn-cdm       not  = zero
                     go to sel-rec-dcp-900.
       sel-rec-dcp-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cdn-sos        to   w-rig-cdn-cdm          .
       car-eff-rig-sos-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
