      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella Unita' di misura           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    GESTIONE TABELLA UNITA' DI MISURA   "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-umi          pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-umi          pic  x(20)                  .
      ...
      *                  * Unita' di misura                            *
      *                  *---------------------------------------------*
           perform   acc-cod-umi-000      thru acc-cod-umi-999        .
      ...
      *              * Unita' di misura                                *
      *              *-------------------------------------------------*
           perform   vis-cod-umi-000      thru vis-cod-umi-999        .
       vis-key-reg-999.
           exit.
      ...
      *              * Unita' di misura                                *
      *              *-------------------------------------------------*
           perform   pmt-cod-umi-000      thru pmt-cod-umi-999        .
      *              *-------------------------------------------------*
      *              * Linea di trattini                               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Unita' di misura              *
      *    *-----------------------------------------------------------*
       pmt-cod-umi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Unita' di misura              *
      *    *-----------------------------------------------------------*
       acc-cod-umi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-umi        to   w-cod-cod-umi-cod      .
           move      04                   to   w-cod-cod-umi-lin      .
       ...
       acc-cod-umi-110.
           ...
           if        w-cod-cod-umi-ope    =    "F+"
                     go to acc-cod-umi-115.
           if        w-cod-cod-umi-ope    =    "AC"
                     go to acc-cod-umi-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-umi-115.
           perform   cod-cod-zum-foi-000  thru cod-cod-zum-foi-999    .
           go to     acc-cod-umi-110.
       acc-cod-umi-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-umi-999.
       acc-cod-umi-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-cod-umi          .
       acc-cod-umi-400.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Unita' di misura           *
      *    *-----------------------------------------------------------*
       vis-cod-umi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           perform   acc-des-umi-000      thru acc-des-umi-999        .
           if        v-key                =    "NXSC"
      ...
      *              * Descrizione unita' di misura                    *
      *              *-------------------------------------------------*
           perform   pmt-des-umi-000      thru pmt-des-umi-999        .
           go to     pmt-tes-reg-999.
       pmt-tes-reg-200.
       pmt-tes-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione unita' di misura     *
      *    *-----------------------------------------------------------*
       pmt-des-umi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione unita' di misura *
      *    *-----------------------------------------------------------*
       acc-des-umi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-umi (1)    not  = spaces
                     go to acc-des-umi-450.
           if        v-key                =    "UP  "
                     go to acc-des-umi-600
           else      go to acc-des-umi-100.
       acc-des-umi-450.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione u.d.m.        *
      *    *-----------------------------------------------------------*
       vis-des-umi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-umi (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-umi        to   rf-zum-cod-umi         .
           move      "pgm/dcp/fls/ioc/obj/iofzum"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-zum-des-umi       to   w-tes-des-umi (1)      .
           move      rf-zum-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zum]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zum-000      thru wrt-rec-zum-999        .
      ...
      *                      * Rewrite record [zum]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zum-000      thru rew-rec-zum-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zum]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zum-000      thru del-rec-zum-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zum]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zum-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-umi (1)    to   rf-zum-des-umi         .
           move      w-tes-alx-exp (1)    to   rf-zum-alx-exp         .
       cmp-rec-zum-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zum]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zum-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zum-000      thru cmp-rec-zum-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
