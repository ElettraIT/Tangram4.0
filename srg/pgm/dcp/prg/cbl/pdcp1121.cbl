      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcp1120  *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           move      "UNITA' DI MISURA"   to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
