      ...
      *                       Ultima revisione:    NdK del 12/11/15    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdcp1220 *
      *                                                                *
      *                    Stampa classificazioni prodotti             *
      *                    - Classi                                    *
      *                    - Gruppi                                    *
      *                    - Sottogruppi                               *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-scs-cgs.
      *        *-------------------------------------------------------*
      *        * Flag di intestazione appena avvenuta                  *
      *        *-------------------------------------------------------*
           05  w-scs-cgs-flg-int          pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *                  * A stampa                                    *
      *                  *---------------------------------------------*
           go to     prn-liv-det-125.
       prn-liv-det-120.
      *                  *---------------------------------------------*
      *                  * Test di intestazione appena avvenuta        *
      *                  *---------------------------------------------*
           if        w-scs-cgs-flg-int    not  = spaces
                     move  spaces         to   w-scs-cgs-flg-int
                     go to prn-liv-det-125.
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Sequenza   Mnem.    Descrizione per classe, gruppo
      -              ", o sottogruppo      Cod. num."
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
