      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice iniziale                  *
      *    *-----------------------------------------------------------*
       pmt-cod-min-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice finale                    *
      *    *-----------------------------------------------------------*
       pmt-cod-max-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-min-num (1)
                                          to   w-cod-cod-dcp-num      .
      ...
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cod-min-num (1)  .
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-min (1)    to   w-det-num-pro-alf      .
           perform   det-num-pro-000      thru det-num-pro-999        .
           move      w-det-num-pro-des    to   w-tes-cod-min-des (1)  .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice min, descrizione                 *
      *    *-----------------------------------------------------------*
       vis-cod-min-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cod-max-num (1)  .
      ...
      *                  * Determinazione codice numerico prodotto     *
      *                  *---------------------------------------------*
           move      w-tes-cod-max (1)    to   w-det-num-pro-alf      .
           perform   det-num-pro-000      thru det-num-pro-999        .
           move      w-det-num-pro-des    to   w-tes-cod-max-des (1)  .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione prodotto        *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice max, descrizione                 *
      *    *-----------------------------------------------------------*
       vis-cod-max-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              * dei codici alfanumerici prodotto min - max      *
      *              *-------------------------------------------------*
           if        w-tes-cod-min (1)    =    spaces and
                     w-tes-cod-max (1)    =    spaces
                     go to cnt-tdo-nok-dfl-100
           else if   w-tes-cod-min (1)    =    spaces and
                     w-tes-cod-max (1)    not  = spaces
                     go to cnt-tdo-nok-dfl-200
           else if   w-tes-cod-min (1)    not  = spaces and
                     w-tes-cod-max (1)    =    spaces
                     go to cnt-tdo-nok-dfl-300
           else      go to cnt-tdo-nok-dfl-400.
       cnt-tdo-nok-dfl-100.
      *              *-------------------------------------------------*
      *              * Se entrambi i codici a spaces                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione literal                        *
      *                  *---------------------------------------------*
           move      "Tutti i codici"     to   w-all-str-alf          .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       cnt-tdo-nok-dfl-200.
      *              *-------------------------------------------------*
      *              * Se codice min a spaces e max a non spaces       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione literal                        *
      *                  *---------------------------------------------*
           ...
           move      "Fino al codice :"   to   w-all-str-cat (1)      .
           move      w-tes-cod-max (1)    to   w-all-str-cat (2)      .
      ...
      *                  *---------------------------------------------*
       ...
       cnt-tdo-nok-dfl-300.
      *              *-------------------------------------------------*
      *              * Se codice min a non spaces e max a spaces       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione literal                        *
      *                  *---------------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      "Con iniziale codice"
                                          to   w-all-str-cat (1)      .
           move      w-tes-cod-min (1)    to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *                  *---------------------------------------------*
      *                  * Allineamento a destra                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       cnt-tdo-nok-dfl-400.
      *              *-------------------------------------------------*
      *              * Se entrambi i codici a non spaces               *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione literal                        *
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-max (1)    to   w-all-str-cat (4)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *                  *---------------------------------------------*
      *                  * Allineamento a destra                       *
      *                  *---------------------------------------------*
