      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CATEGORIE DI SCONTO IN RIGA PRODOTTO  "       .
      ...
      *    *===========================================================*
      *    * Link-area per accettazione categoria sconto in riga prod. *
      *    *-----------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-csc        to   w-cmn-zcs-003-cod      .
           move      04                   to   w-cmn-zcs-003-lin      .
           move      30                   to   w-cmn-zcs-003-pos      .
           move      07                   to   w-cmn-zcs-003-dln      .
           move      30                   to   w-cmn-zcs-003-dps      .
           move      "<B"                 to   v-edm                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zcs] parte 01    *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zcs3"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
