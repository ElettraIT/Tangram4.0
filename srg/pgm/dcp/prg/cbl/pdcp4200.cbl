      ...
      *                                   Fase:    dcp420              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/09/92    *
      *                       Ultima revisione:    NdK del 14/11/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione descrizione prodotti di vendita in *
      *                    lingua straniera                            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "DESCRIZIONE PRODOTTO IN LINGUA STRANIERA"       .
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-lng (1)    not  = spaces
                     go to acc-des-lng-450.
           if        v-key                =    "UP  "
                     go to acc-des-lng-600
           else      go to acc-des-lng-100.
       acc-des-lng-450.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-tip-rec        to   rf-pdx-tip-rec         .
           move      zero                 to   rf-pdx-cod-arc         .
           move      w-tes-cod-lng        to   rf-pdx-cod-lng         .
      ...
      *                                  *-----------------------------*
           if        rf-pdx-tip-rec       not  = 02            or
                     ...
                     rf-pdx-cod-lng       not  = w-tes-cod-lng or
      ...
      *                                  *-----------------------------*
           move      rf-pdx-des-pro       to   w-tes-ded-rig
                                              (1, rf-pdx-num-prg)     .
      *                                  *-----------------------------*
      *                                  * Riciclo su lettura          *
      *                                  *-----------------------------*
