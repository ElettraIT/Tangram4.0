      ...
      *================================================================*
      *                                                                *
      *          Gestione catena mov per programma pdcp2500            *
      *                                                                *
      * ============================================================== *
      * Tipi operazione                                                *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-pnt-max-ele              pic  9(05) value 2000       .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-pnt-num-prg          pic  9(07) comp-3           .
      *            *---------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Cache memory per i primi 99 elementi                      *
      *    *-----------------------------------------------------------*
       01  w-chm.
      *        *-------------------------------------------------------*
      *        * Numero di elementi nella cache memory                 *
      *        *-------------------------------------------------------*
           05  w-chm-max                  pic  9(02)       value 99   .
      *        *-------------------------------------------------------*
      *        * Elementi, tanti quanti definiti nel campo precedente  *
      *        *-------------------------------------------------------*
           05  w-chm-tbl occurs 99.
      *            *---------------------------------------------------*
