      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione Sottogruppi prodotto         *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-cla           to   w-cod-mne-zp3-cla      .
           move      rr-des-cla           to   w-cod-mne-zp3-dcl      .
           move      rr-cod-gru           to   w-cod-mne-zp3-gru      .
           move      rr-des-gru           to   w-cod-mne-zp3-dgr      .
           move      rr-cod-min           to   w-cod-mne-zp3-sgr      .
           move      19                   to   w-cod-mne-zp3-lin      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-gru           to   w-cod-mne-zp3-gru      .
           move      rr-des-gru           to   w-cod-mne-zp3-dgr      .
           move      rr-cod-max           to   w-cod-mne-zp3-sgr      .
           move      19                   to   w-cod-mne-zp3-lin      .
           move      52                   to   w-cod-mne-zp3-pos      .
           move      zero                 to   w-cod-mne-zp3-dln      .
           move      zero                 to   w-cod-mne-zp3-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zp3-cod-cla         .
           move      rr-cod-gru           to   rf-zp3-cod-gru         .
           move      rr-cod-min           to   rf-zp3-cod-sgr         .
           move      "pgm/dcp/fls/ioc/obj/iofzp3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zp3-cod-cla         .
           move      rr-cod-gru           to   rf-zp3-cod-gru         .
           move      rr-des-min           to   rf-zp3-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zp3-cod-cla         .
           move      rr-cod-gru           to   rf-zp3-cod-gru         .
           move      rr-mne-min           to   rf-zp3-mne-sgr         .
           move      zero                 to   rf-zp3-cod-sgr         .
           move      "pgm/dcp/fls/ioc/obj/iofzp3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zp3-cod-cla         .
           move      rr-cod-gru           to   rf-zp3-cod-gru         .
           move      rr-sqz-min           to   rf-zp3-sqz-num         .
           move      zero                 to   rf-zp3-cod-sgr         .
           move      "pgm/dcp/fls/ioc/obj/iofzp3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zp3]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcp/fls/ioc/obj/iofzp3"
                                          to   s-pat                  .
      ...
      *              * Se ordinamento per codice                       *
      *              *-------------------------------------------------*
           if        rf-zp3-cod-cla       not  = rr-cod-cla
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           if        rf-zp3-cod-gru       not  = rr-cod-gru
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           if        rf-zp3-cod-sgr       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           go to     qry-tst-max-999.
       qry-tst-max-400.
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zp3-cod-sgr       <    rr-cod-min or
                     rf-zp3-cod-sgr       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zp3-des-key       <    rr-des-min or
                     rf-zp3-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zp3-mne-sgr       <    rr-mne-min or
                     rf-zp3-mne-sgr       >    rr-mne-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su numero di sequenza                 *
      *              *-------------------------------------------------*
           if        rf-zp3-sqz-num       <    rr-sqz-min or
                     rf-zp3-sqz-num       >    rr-sqz-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-zp3-cod-sgr       to   w-mpn-cod-sgr          .
           move      rf-zp3-des-sgr       to   w-mpn-des-sgr          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
