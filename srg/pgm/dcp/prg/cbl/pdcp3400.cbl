      ...
      *                       Ultima revisione:    NdK del 18/03/99    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase dcp340, nella sua globalita', esegue i tipi di stampa  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * LSTALT      Stampa listini                                     *
      *                                                                *
      * BASSCA      Stampa listino base con sconti anagrafici prodotti *
      *                                                                *
      * LSTIVA      Stampa listini con applicazione aliquota Iva       *
      *                                                                *
      * LSTCLI      Stampa listino di vendita a cliente                *
      *                                                                *
      * LSTSNG      Stampa listino di vendita singolo ___ FINIRE ___   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   STAMPE LISTINI PRODOTTI DI VENDITA   "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'dcp340'           *
      *              *-------------------------------------------------*
           perform   fas-dcp-340-000      thru fas-dcp-340-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *       
           move      "Stampa listino base con sconti anagrafici prodotti
      -              "           BASSCA     pdcp340b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Stampa listini con applicazione aliquota Iva      
      -              "           LSTIVA     pdcp340c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Stampa listino di vendita a cliente               
      -              "           LSTCLI     pdcp340d  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
______*    move      "Stampa listino singolo                            
______*-              "           LSTSNG     pdcp340e  "
______*                                    to   w-tin-ele-wci          .
______*     perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-dcp-340-300
           else if   v-key                =    "PRSC"
                     go to fas-dcp-340-400
           else if   v-key                =    "NXSC"
                     go to fas-dcp-340-450
           else if   v-key                =    "DOWN"
                     go to fas-dcp-340-500
           else if   v-key                =    "EXIT"
                     go to fas-dcp-340-250
           else      go to fas-dcp-340-200.
       fas-dcp-340-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-dcp-340-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-dcp-340-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-dcp-340-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-dcp-340-350
           else      go to fas-dcp-340-322.
       fas-dcp-340-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-dcp-340-630
           else if   v-key                =    "PRSC"
                     go to fas-dcp-340-600
           else if   v-key                =    "NXSC"
                     go to fas-dcp-340-610
           else if   v-key                =    "UP  "
                     go to fas-dcp-340-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-dcp-340-650
           else if   v-key                =    "EXIT"
                     go to fas-dcp-340-660
           else      go to fas-dcp-340-570.
       fas-dcp-340-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-dcp-340-626
           else      go to fas-dcp-340-628.
       fas-dcp-340-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-dcp-340-636
           else      go to fas-dcp-340-638.
       fas-dcp-340-636.
      *                          *-------------------------------------*
