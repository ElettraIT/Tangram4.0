      ...
      *                                   Fase:    dcp152              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 30/05/95    *
      *                       Ultima revisione:    NdK del 08/02/06    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcp152   *
      *                                                                *
      *                    Stampa categorie di sconto in riga prodotto *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA CATEGORIE SCONTO IN RIGA PRODOTTO"       .
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "|      Categoria sconto prodotto     |       Perce
      -              "ntuali di sconto      |"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
