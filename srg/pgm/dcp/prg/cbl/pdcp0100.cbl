      ...
      *                       Ultima revisione:    NdK del 23/01/08    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella tipi variante              *
      *                                                                *
      *                    ___ OBSOLETO ___                            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-tip-var          pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-var          pic  x(10)                  .
               10  w-tes-tip-fun          pic  9(02)                  .
               10  w-tes-prm-lb1          pic  x(03)                  .
               10  w-tes-prm-lb2          pic  x(03)                  .
               10  w-tes-prm-lb3          pic  x(03)                  .
      ...
      *                  * Tipo variante                               *
      *                  *---------------------------------------------*
           perform   acc-tip-var-000      thru acc-tip-var-999        .
      ...
      *              * Tipo variante                                   *
      *              *-------------------------------------------------*
           perform   vis-tip-var-000      thru vis-tip-var-999        .
       vis-key-reg-999.
           exit.
      ...
      *              * Tipo variante                                   *
      *              *-------------------------------------------------*
           perform   pmt-tip-var-000      thru pmt-tip-var-999        .
      *              *-------------------------------------------------*
      *              * Linea di trattini                               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice tipo variante          *
      *    *-----------------------------------------------------------*
       pmt-tip-var-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Tipo variante                 *
      *    *-----------------------------------------------------------*
       acc-tip-var-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-tip-var        to   w-cod-tip-var-cod      .
           move      04                   to   w-cod-tip-var-lin      .
       ...
       acc-tip-var-110.
           ...
           if        w-cod-tip-var-ope    =    "F+"
                     go to acc-tip-var-115.
           if        w-cod-tip-var-ope    =    "AC"
                     go to acc-tip-var-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-tip-var-115.
           perform   cod-cod-ztv-foi-000  thru cod-cod-ztv-foi-999    .
           go to     acc-tip-var-110.
       acc-tip-var-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-tip-var-999.
       acc-tip-var-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-tip-var          .
       acc-tip-var-400.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Tipo variante              *
      *    *-----------------------------------------------------------*
       vis-tip-var-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           perform   acc-des-var-000      thru acc-des-var-999        .
           if        v-key                =    "NXSC"
      ...
      *              * Descrizione variante                            *
      *              *-------------------------------------------------*
           perform   vis-des-var-000      thru vis-des-var-999        .
           go to     vis-tes-reg-999.
       vis-tes-reg-200.
       vis-tes-reg-999.
           exit.
      ...
      *              * Descrizione variante                            *
      *              *-------------------------------------------------*
           perform   pmt-des-var-000      thru pmt-des-var-999        .
           go to     pmt-tes-reg-999.
       pmt-tes-reg-200.
       pmt-tes-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione variante             *
      *    *-----------------------------------------------------------*
       pmt-des-var-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione variante         *
      *    *-----------------------------------------------------------*
       acc-des-var-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-var (1)    not  = spaces
                     go to acc-des-var-450.
           if        v-key                =    "UP  "
                     go to acc-des-var-600
           else      go to acc-des-var-100.
       acc-des-var-450.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "Manca la descrizione per la variante              
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-var (1)      .
           move      zero                 to   w-tes-tip-fun (1)      .
           move      spaces               to   w-tes-prm-lb1 (1)      .
           move      spaces               to   w-tes-prm-lb2 (1)      .
           move      spaces               to   w-tes-prm-lb3 (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-tip-var        to   rf-ztv-tip-var         .
           move      "pgm/dcp/fls/ioc/obj/iofztv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-ztv-des-var       to   w-tes-des-var (1)      .
           move      rf-ztv-tip-fun       to   w-tes-tip-fun (1)      .
           move      rf-ztv-prm-lb1       to   w-tes-prm-lb1 (1)      .
           move      rf-ztv-prm-lb2       to   w-tes-prm-lb2 (1)      .
           move      rf-ztv-prm-lb3       to   w-tes-prm-lb3 (1)      .
           move      rf-ztv-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [ztv]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-ztv-000      thru wrt-rec-ztv-999        .
      ...
      *                      * Rewrite record [ztv]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-ztv-000      thru rew-rec-ztv-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [ztv]                             *
      *              *-------------------------------------------------*
           perform   del-rec-ztv-000      thru del-rec-ztv-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [ztv]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-ztv-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-var (1)    to   rf-ztv-des-var         .
           move      w-tes-tip-fun (1)    to   rf-ztv-tip-fun         .
           move      w-tes-prm-lb1 (1)    to   rf-ztv-prm-lb1         .
           move      w-tes-prm-lb2 (1)    to   rf-ztv-prm-lb2         .
           move      w-tes-prm-lb3 (1)    to   rf-ztv-prm-lb3         .
           move      w-tes-alx-exp (1)    to   rf-ztv-alx-exp         .
       cmp-rec-ztv-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [ztv]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-ztv-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-ztv-000      thru cmp-rec-ztv-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
