      ...
      *                                                                *
      *                    Sottoprogramma per la stampa del listino    *
      *                    per il cliente                              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   STAMPA LISTINO DI VENDITA A CLIENTE  "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           ...
           05  rr-cod-cli-lst             pic  x(03)                  .
           05  rr-cod-cli-lng             pic  x(03)                  .
           05  rr-cod-cli-cat             pic  9(05)                  .
           05  rr-cod-cli-scr occurs 05
                                          pic  9(02)v9(01)            .
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-dcc.
               ...
               10  w-let-arc-dcc-lst      pic  x(03)                  .
               10  w-let-arc-dcc-lng      pic  x(03)                  .
               10  w-let-arc-dcc-cat      pic  9(05)                  .
               10  w-let-arc-dcc-scr occurs 05
                                          pic  9(02)v9(01)            .
      ...
      *    *-----------------------------------------------------------*
       01  w-wrk.
      *        *-------------------------------------------------------*
      *        * Work per editing sconti                               *
      *        *-------------------------------------------------------*
           05  w-wrk-edt-sco.
               10  w-wrk-edt-ele  occurs 05
                                          pic  x(04)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-snx-zer.
               ...
               10  w-exp-snx-zer-lun      pic  9(02)       value 20   .
               10  w-exp-snx-zer-tbl.
                   ...
                   15  filler             pic  x(20) value
                            "solo i Concordati   "                    .
      *        *-------------------------------------------------------*
      *        * Work per : Opzioni prezzo                             *
      *        *-------------------------------------------------------*
           05  w-exp-opz-prz.
               10  w-exp-opz-prz-num      pic  9(02)       value 2    .
               10  w-exp-opz-prz-lun      pic  9(02)       value 20   .
               10  w-exp-opz-prz-tbl.
                   15  filler             pic  x(20) value
                            "prezzi e Sconti     "                    .
                   15  filler             pic  x(20) value
                            "prezzi Netti        "                    .
      ...
      *            *---------------------------------------------------*
      *            * Codice alfanumerico del prodotto per il cliente   *
      *            *---------------------------------------------------*
               10  w-det-des-stp-coc      pic  x(14)                  .
      *        *-------------------------------------------------------*
      ...
      *                  * Opzioni prezzo                              *
      *                  *---------------------------------------------*
           perform   acc-opz-prz-000      thru acc-opz-prz-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           ...
           move      w-let-arc-dcc-lst    to   rr-cod-cli-lst         .
           move      w-let-arc-dcc-lng    to   rr-cod-cli-lng         .
           move      w-let-arc-dcc-cat    to   rr-cod-cli-cat         .
           move      w-let-arc-dcc-scr (1)
                                          to   rr-cod-cli-scr (1)     .
           move      w-let-arc-dcc-scr (2)
                                          to   rr-cod-cli-scr (2)     .
           move      w-let-arc-dcc-scr (3)
                                          to   rr-cod-cli-scr (3)     .
           move      w-let-arc-dcc-scr (4)
                                          to   rr-cod-cli-scr (4)     .
           move      w-let-arc-dcc-scr (5)
                                          to   rr-cod-cli-scr (5)     .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Opzioni prezzo             *
      *    *-----------------------------------------------------------*
       acc-opz-prz-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-opz-prz-lun    to   v-car                  .
           move      w-exp-opz-prz-num    to   v-ldt                  .
           move      "SN#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      12                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-opz-prz-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           if        w-cnt-sts-imp-ric    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
           move      rr-opz-prz           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-opz-prz-999.
       acc-opz-prz-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-opz-prz             .
       acc-opz-prz-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-opz-prz           =    zero
                     go to acc-opz-prz-100.
       acc-opz-prz-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzaz. campo selezione : Opzioni prezzo             *
      *    *-----------------------------------------------------------*
       vis-opz-prz-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      spaces               to   rr-cod-cli-lst         .
           move      spaces               to   rr-cod-cli-lng         .
           move      zero                 to   rr-cod-cli-cat         .
           move      zero                 to   rr-cod-cli-scr (1)     .
           move      zero                 to   rr-cod-cli-scr (2)     .
           move      zero                 to   rr-cod-cli-scr (3)     .
           move      zero                 to   rr-cod-cli-scr (4)     .
           move      zero                 to   rr-cod-cli-scr (5)     .
           move      zero                 to   rr-fso-dcp             .
           move      spaces               to   rr-fso-dcp-des         .
           move      zero                 to   rr-fso-dcp-ord         .
           move      zero                 to   rr-tip-slp             .
           move      zero                 to   rr-opz-prz             .
      ...
      *              *-------------------------------------------------*
       ...
       reg-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Normalizzazione opzioni prezzo                  *
      *              *-------------------------------------------------*
           if        rr-opz-prz           not  = zero
                     go to reg-ric-sel-300.
           move      01                   to   rr-opz-prz             .
       reg-ric-sel-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cli           to   d-prz-ven-cod-cli      .
           move      rr-cod-cli-vlt       to   d-prz-ven-sgl-vpp      .
           move      rf-dcp-dec-prz       to   d-prz-ven-dec-vpp      .
           move      rf-dcp-num-pro       to   d-prz-ven-num-pro      .
           move      rr-cod-cli-lst       to   d-prz-ven-cod-lst      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-sel-rec-150.
      *              *-------------------------------------------------*
      *              * Test su prezzo determinato                      *
      *              *-------------------------------------------------*
           if        rr-snx-zer           not  = 01
                     go to prn-sel-rec-170.
           if        d-prz-ven-prz-ven    =    zero
                     go to prn-sel-rec-900.
       prn-sel-rec-170.
      *                  *---------------------------------------------*
      *                  * Test se solo i netti concordati             *
      *                  *---------------------------------------------*
           if        rr-snx-zer           not  = 03
                     go to prn-sel-rec-200.
           if        d-prz-ven-tip-prd    not  = 02
                     go to prn-sel-rec-900.
       prn-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Determinazione sconti                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione link-area                      *
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cli-scr (1)   to   d-per-scr-psr-cli (1)  .
           move      rr-cod-cli-scr (1)   to   d-per-scr-psr-cli (2)  .
           move      rr-cod-cli-scr (1)   to   d-per-scr-psr-cli (3)  .
           move      rr-cod-cli-scr (1)   to   d-per-scr-psr-cli (4)  .
           move      rr-cod-cli-scr (1)   to   d-per-scr-psr-cli (5)  .
           move      rr-cod-cli-cat       to   d-per-scr-csr-cli      .
           move      rr-cod-cli           to   d-per-scr-cod-cli      .
           move      rr-cod-cli-lst       to   d-per-scr-cod-lst      .
           move      rr-cod-cli-vlt       to   d-per-scr-sgl-vpf      .
           move      rf-dcp-num-pro       to   d-per-scr-num-pro      .
      *
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   d-per-scr-dat-rif      .
      *                  *---------------------------------------------*
      *                  * Richiamo del sottoprogramma                 *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-cli           to   w-det-des-stp-arc      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione eventuale codice prodotto   *
      *                  * per il cliente                              *
      *                  *---------------------------------------------*
           move      spaces               to   w-det-des-stp-coc      .
      *                  *---------------------------------------------*
      *                  * Lettura eventuale codice prodotto per il    *
      *                  * cliente                                     *
      *                  *---------------------------------------------*
           move      05                   to   w-let-arc-pdx-rec      .
      ...
      *                  *---------------------------------------------*
           ...
           if        w-let-arc-pdx-des    =    spaces
                     go to prn-liv-det-205.
      *                  *---------------------------------------------*
      *                  * Memorizzazione eventuale codice prodotto    *
      *                  * per il cliente                              *
      *                  *---------------------------------------------*
           move      w-let-arc-pdx-des    to   w-det-des-stp-coc      .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico prodotto per il cliente *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      14                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      w-det-des-stp-coc    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * A stampa descrizione                        *
      *                  *---------------------------------------------*
      ...
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
           if        rf-dcp-epz-ele (04)  not  = "X"
                     go to prn-liv-det-300.
      *                      *-----------------------------------------*
      *                      * Eventuale accorpamento sconti           *
      *                      *-----------------------------------------*
           if        rr-opz-prz           not  = 02
                     move  d-prz-ven-prz-ven
                                          to   w-det-val-stp-prz
                     go to prn-liv-det-280.
      *                      *-----------------------------------------*
      *                      * Accorpamento                            *
      *                      *-----------------------------------------*
           move      d-prz-ven-prz-ven    to   w-det-prz-net-prz      .
           ...
           move      w-det-prz-net-prz    to   w-det-val-stp-prz      .
       prn-liv-det-280.
      *                      *-----------------------------------------*
      *                      * Stampa                                  *
      *                      *-----------------------------------------*
      ...
      *
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-wrk-edt-ele (5)      .
      *                      *-----------------------------------------*
      *                      * Concatenamento                          *
      *                      *-----------------------------------------*
           move      09                   to   w-all-str-num          .
           move      19                   to   w-all-str-lun          .
           move      w-wrk-edt-ele (1)    to   w-all-str-cat (1)      .
           if        w-wrk-edt-ele (2)    =    spaces
                     move  spaces         to   w-all-str-cat (2)
           else      move  "+"            to   w-all-str-cat (2)      .
           move      w-wrk-edt-ele (2)    to   w-all-str-cat (3)      .
           if        w-wrk-edt-ele (3)    =    spaces
                     move  spaces         to   w-all-str-cat (4)
           else      move  "+"            to   w-all-str-cat (4)      .
           move      w-wrk-edt-ele (3)    to   w-all-str-cat (5)      .
           if        w-wrk-edt-ele (4)    =    spaces
                     move  spaces         to   w-all-str-cat (6)
           else      move  "+"            to   w-all-str-cat (6)      .
           move      w-wrk-edt-ele (4)    to   w-all-str-cat (7)      .
           if        w-wrk-edt-ele (5)    =    spaces
                     move  spaces         to   w-all-str-cat (8)
           else      move  "+"            to   w-all-str-cat (8)      .
           move      w-wrk-edt-ele (5)    to   w-all-str-cat (9)      .
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Eventuale stampa codice del prodotto            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se esiste il codice prodotto per il    *
      *                  * cliente                                     *
      *                  *---------------------------------------------*
           if        w-det-des-stp-coc    =    spaces
                     go to prn-liv-det-410.
      *                  *---------------------------------------------*
      *                  * Test se le opzioni prevedono l'utilizzo     *
      *                  * della colonna per gli sconti                *
      *                  *---------------------------------------------*
           if        rr-opz-prz           not  = 02
                     go to prn-liv-det-410.
      *                  *---------------------------------------------*
      *                  * Ns. codice alfanumerico prodotto            *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      14                   to   p-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      "PREZZI DI VENDITA :"
                                          to   w-all-str-cat (1)      .
           move      rr-cod-cli-rag       to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dcc-cod-lst       to   w-let-arc-dcc-lst      .
           move      rf-dcc-cod-lng       to   w-let-arc-dcc-lng      .
           move      rf-dcc-cat-scr       to   w-let-arc-dcc-cat      .
           move      rf-dcc-per-scr (1)   to   w-let-arc-dcc-scr (1)  .
           move      rf-dcc-per-scr (2)   to   w-let-arc-dcc-scr (2)  .
           move      rf-dcc-per-scr (3)   to   w-let-arc-dcc-scr (3)  .
           move      rf-dcc-per-scr (4)   to   w-let-arc-dcc-scr (4)  .
           move      rf-dcc-per-scr (5)   to   w-let-arc-dcc-scr (5)  .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-dcc-600.
           ...
           move      spaces               to   w-let-arc-dcc-lst      .
           move      spaces               to   w-let-arc-dcc-lng      .
           move      zero                 to   w-let-arc-dcc-cat      .
           move      zero                 to   w-let-arc-dcc-scr (1)  .
           move      zero                 to   w-let-arc-dcc-scr (2)  .
           move      zero                 to   w-let-arc-dcc-scr (3)  .
           move      zero                 to   w-let-arc-dcc-scr (4)  .
           move      zero                 to   w-let-arc-dcc-scr (5)  .
       let-arc-dcc-999.
           exit.
