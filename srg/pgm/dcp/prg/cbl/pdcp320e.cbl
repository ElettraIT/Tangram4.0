      ...
      *        *-------------------------------------------------------*
           05  w-rig-qta-rif              pic  9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' di riferimento pre-impostazione             *
      *        *-------------------------------------------------------*
           05  w-rig-pri-qta              pic  9(08)v9(03)            .
      *        *-------------------------------------------------------*
      ...
      *                *  - 03 : Prezzi per campagne promozionali      *
      *                *  - 11 : Listini contributi ecologici          *
      *                *-----------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Descrizione prodotto in italiano            *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.   Cod. prodotto      Prezzo    Lst          
...
______*    move      "EXPD"               to   v-pfk (15)             .
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        w-rig-qta-rif        not  = zero
                     go to acc-qta-rif-600.
           if        v-key                =    "UP  "
                     go to acc-qta-rif-600
           else      go to acc-qta-rif-100.
       acc-qta-rif-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-qta-rif          .
           move      zero                 to   w-rig-pri-qta          .
      ...
      *                  * Codice listino                              *
      *                  *---------------------------------------------*
           move      rf-lst-cod-lst       to   w-rig-cod-lst          .
      *                  *---------------------------------------------*
      *                  * Codice prodotto numerico                    *
      *                  *---------------------------------------------*
      ...
      *                  * Decimali prezzo                             *
      *                  *                                             *
      *                  * Per convenzione, si forzano sempre a 2      *
      *                  *---------------------------------------------*
           move      2                    to   w-rig-dec-prz          .
      *                  *---------------------------------------------*
      *                  * Prezzo di listino pre-impostazione          *
      *                  *---------------------------------------------*
      ...
      *                  * Quantita' di riferimento                    *
      *                  *---------------------------------------------*
           move      rf-lst-qta-rif       to   w-rig-qta-rif          .
      *                  *---------------------------------------------*
      *                  * Quantita' di riferimento pre-impostazione   *
      *                  *---------------------------------------------*
           move      rf-lst-qta-rif       to   w-rig-pri-qta          .
      *                  *---------------------------------------------*
      *                  * Area libera                                 *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione del record listino          *
      *                  *---------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "pgm/dcp/fls/ioc/obj/ioflst"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      11                   to   rf-lst-tip-rec         .
           move      w-rig-cod-lst        to   rf-lst-cod-lst         .
           move      zero                 to   rf-lst-cod-cli         .
      ...
      *                      *-----------------------------------------*
      *                      * Aggiornamento quantita' di riferimento  *
      *                      *-----------------------------------------*
           move      w-rig-qta-rif        to   rf-lst-qta-rif         .
      *                      *-----------------------------------------*
      *                      * Update record                           *
      *                      *-----------------------------------------*
           move      "UP"                 to   f-ope                  .
