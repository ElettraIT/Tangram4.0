      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione manuale prezzi di listino ecofee   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  GESTIONE LISTINO ECO-CONTRIBUTI RAEE  "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per determinazione se fascia contributiva gia'   *
      *        * presente per il prodotto                              *
      *        *-------------------------------------------------------*
           05  w-det-pro-rae.
      *            *---------------------------------------------------*
      *            * Listino gia' codificato                           *
      *            *---------------------------------------------------*
               10  w-det-pro-rae-lst      pic  x(03)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       acc-tip-rec-000.
      *              *-------------------------------------------------*
      *              * Forzatura a 11 del Tipo record                  *
      *              *-------------------------------------------------*
           move      11                   to   w-tes-tip-rec          .
       acc-tip-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Digitare la fascia contributiva. Esempi:"
                                          to   v-nt1                  .
           move      "L1, F1, F2, F3, EC1, EC2, RD1, RD2, ecc. ecc."
                                          to   v-nt2                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   vis-des-lst-000      thru vis-des-lst-999        .
      *                  *---------------------------------------------*
      *                  * Se codice errato : oltre, comunque          *
      *                  *---------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura tabella [zvl]                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-m02      .
       ...
       acc-cod-pro-580.
      *                  *---------------------------------------------*
      *                  * Controllo di esistenza di un'altra fascia   *
      *                  * contributiva gia' codificata per il prodot- *
      *                  * to                                          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Determinazione                          *
      *                      *-----------------------------------------*
           perform   det-pro-rae-000      thru det-pro-rae-999        .
           if        w-det-pro-rae-lst    =    spaces
                     go to acc-cod-pro-600.
      *                      *-----------------------------------------*
      *                      * Messaggio                               *
      *                      *-----------------------------------------*
           move      spaces               to   w-err-box-err-msg      .
           string    "Esiste gia' la fascia contributiva "
                                delimited by   size
                     w-det-pro-rae-lst
                                delimited by   space
                     " per il prodotto!"
      ...
      *                  * Quantita' di riferimento                    *
      *                  *---------------------------------------------*
           perform   acc-qta-rif-000      thru acc-qta-rif-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Quantita' di riferimento                        *
      *              *-------------------------------------------------*
           perform   vis-qta-rif-000      thru vis-qta-rif-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     vis-tes-reg-999.
      ...
      *              * Quantita' di riferimento                        *
      *              *-------------------------------------------------*
           perform   pmt-qta-rif-000      thru pmt-qta-rif-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     pmt-tes-reg-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Quantita' di riferimento         *
      *    *-----------------------------------------------------------*
       pmt-qta-rif-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Quantita' di riferimento             *
      *    *-----------------------------------------------------------*
       acc-qta-rif-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-qta-rif-100.
       acc-qta-rif-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Quantita' di riferimento          *
      *    *-----------------------------------------------------------*
       vis-qta-rif-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                          * Quantita' di riferimento            *
      *                          *-------------------------------------*
           move      rf-lst-qta-rif       to   w-tes-qta-rif (1)      .
      *                          *-------------------------------------*
      *                          * Area libera per espansioni          *
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-qta-rif (1)    to   rf-lst-qta-rif         .
      ...
      *    *===========================================================*
      *    * Determinazione se fascia contributiva gia' inserita       *
      *    *-----------------------------------------------------------*
       det-pro-rae-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      spaces               to   w-det-pro-rae-lst      .
       det-pro-rae-100.
      *              *-------------------------------------------------*
      *              * Start su listini                                *
      *              *-------------------------------------------------*
      ...
      *              * Max su [lst]                                    *
      *              *-------------------------------------------------*
           if        rf-lst-tip-rec       not  = 11
                     go to det-pro-rae-900.
           if        rf-lst-num-pro       not  = w-tes-num-pro
                     go to det-pro-rae-900.
       det-pro-rae-400.
      *              *-------------------------------------------------*
      *              * Sel su [lst]                                    *
      *              *-------------------------------------------------*
           if        rf-lst-cod-lst       =    w-tes-cod-lst
                     go to det-pro-rae-200.
       det-pro-rae-600.
      *              *-------------------------------------------------*
      *              * Bufferizzazione listino determinato             *
      *              *-------------------------------------------------*
           move      rf-lst-cod-lst       to   w-det-pro-rae-lst      .
       det-pro-rae-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     det-pro-rae-999.
       det-pro-rae-999.
           exit.
