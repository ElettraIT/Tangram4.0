      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella cataloghi prodotti   *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per Det numero prodotti a catalogo               *
      *        *-------------------------------------------------------*
           05  w-det-pro-cpv.
      *            *---------------------------------------------------*
      *            * Codice catalogo                                   *
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Start su archivio [zcp]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "CODTSL    "         to   f-key                  .
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun catalogo entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zcp]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcp/fls/ioc/obj/iofzcp"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      06                   to   v-pos                  .
           move      rf-zcp-des-cpv       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zcp-cod-cpv       to   w-mpn-cod-cpv          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Codice lingua (attualmente inibito)         *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-zcp-cod-lng       to   w-let-arc-zln-cod      .
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      50                   to   v-pos                  .
           move      w-let-arc-zln-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                      * Determinazione                          *
      *                      *-----------------------------------------*
           move      rf-zcp-cod-cpv       to   w-det-pro-cpv-cod      .
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      74                   to   v-pos                  .
           move      w-det-pro-cpv-ctr    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
           exit.
      ...
      *    *===========================================================*
      *    * Determinazione numero prodotti nel catalogo               *
      *    *-----------------------------------------------------------*
       det-pro-cpv-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-pro-cpv-cod    to   rf-cpv-cod-cpv         .
      ...
      *                  *---------------------------------------------*
       ...
       det-pro-cpv-300.
      *              *-------------------------------------------------*
      *              * Max su [cpv], se non superato : a test finale   *
      *              *-------------------------------------------------*
           if        rf-cpv-tip-rec       not  = 01                or
                     rf-cpv-cod-cpv       not  = w-det-pro-cpv-cod
                     go to det-pro-cpv-900.
       det-pro-cpv-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
