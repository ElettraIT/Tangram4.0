      ...
      *                                                                *
      *                    Manutenzione caratteristiche fisiche del    *
      *                    prodotto                                    *
      *                                                                *
      *================================================================*
      ...
      *            * Valori variabili                                  *
      *            *---------------------------------------------------*
               10  w-rig-tip-cfz          pic  9(02)                  .
               10  w-rig-qta-cfz          pic  9(06)v9(03)            .
               10  w-rig-pes-uni          pic  9(06)v9(03)            .
               10  w-rig-pes-tar          pic  9(06)v9(03)            .
               10  w-rig-vol-uni          pic  9(06)v9(03)            .
               10  w-rig-dim-pro.
                   15  w-rig-dim-lar      pic  9(06)v9(03)            .
                   15  w-rig-dim-alt      pic  9(06)v9(03)            .
                   15  w-rig-dim-prf      pic  9(06)v9(03)            .
               10  w-rig-pcl-fis          pic  x(10)                  .
               10  w-rig-coe-mol          pic  9(04)v9(03)            .
               10  w-rig-coe-div          pic  9(04)v9(03)            .
           05  w-rig-002.
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-tip-cfz  pic  x(02)                  .
                   15  filler             pic  x(04)                  .
                   15  w-lin-imm-qta-cfz  pic  x(11)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-lpt.
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Peculiarita' fisiche            *
      *        *-------------------------------------------------------*
           05  w-lpt-pcl-fis-lin          pic  9(03)    value 018     .
           05  w-lpt-pcl-fis-pos          pic  9(03)    value 030     .
           05  w-lpt-pcl-fis-ppm          pic  9(03)    value 001     .
      ...
      *    *-----------------------------------------------------------*
       pmt-pcl-fis-000.
           ...
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-pcl-fis-lin    to   v-lin                  .
           move      w-lpt-pcl-fis-ppm    to   v-pos                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Quantita' per confezione             *
      *    *-----------------------------------------------------------*
       acc-qta-cfz-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Quantita' per confezione          *
      *    *-----------------------------------------------------------*
       vis-qta-cfz-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Peso unitario lordo                  *
      *    *-----------------------------------------------------------*
       acc-pes-uni-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Peso unitario lordo               *
      *    *-----------------------------------------------------------*
       vis-pes-uni-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Peso tara                         *
      *    *-----------------------------------------------------------*
       vis-pes-tar-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Volume unitario                      *
      *    *-----------------------------------------------------------*
       acc-vol-uni-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Volume unitario                   *
      *    *-----------------------------------------------------------*
       vis-vol-uni-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Larghezza                         *
      *    *-----------------------------------------------------------*
       vis-dim-lar-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Profondita'                       *
      *    *-----------------------------------------------------------*
       vis-dim-prf-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Peculiarita' fisiche                 *
      *    *-----------------------------------------------------------*
       acc-pcl-fis-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      10                   to   v-car                  .
           move      w-lpt-pcl-fis-lin    to   v-lin                  .
           move      w-lpt-pcl-fis-pos    to   v-pos                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      "[1] "               to   v-pfk (14)             .
           move      w-tes-pcl-fis        to   v-alf                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-pcl-fis          .
       acc-pcl-fis-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-pcl-fis-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-pcl-fis-sos-000  thru acc-pcl-fis-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-pcl-fis-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-pcl-fis-sos-000  thru vis-pcl-fis-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-pcl-fis-sns    not  = zero
                     go to acc-pcl-fis-800.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Peculiarita' fisiche              *
      *    *-----------------------------------------------------------*
       vis-pcl-fis-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-pcl-fis-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-pcl-fis-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-pcl-fis-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-pcl-fis-sos-010.
      ...
      *                  *---------------------------------------------*
           perform   vis-pcl-fis-so1-000  thru vis-pcl-fis-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-pcl-fis-so2-000  thru vis-pcl-fis-so2-999    .
       acc-pcl-fis-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-pcl-fis-so1-000  thru acc-pcl-fis-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-pcl-fis-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-pcl-fis-sos-600.
       acc-pcl-fis-sos-300.
      *                  *---------------------------------------------*
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-pcl-fis-so2-000  thru acc-pcl-fis-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-pcl-fis-sos-600.
           if        v-key                =    "UP  "
                     go to acc-pcl-fis-sos-200.
       acc-pcl-fis-sos-600.
      *              *-------------------------------------------------*
      ...
      *                  * dalle impostazioni                          *
      *                  *---------------------------------------------*
           if        w-tes-pcl-fis        =    spaces  and
                     w-tes-pcl-sos        =    spaces
                     go to acc-pcl-fis-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-pcl-fis        not  = w-tes-pcl-sos
                     go to acc-pcl-fis-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      spaces               to   w-tes-pcl-sos          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-pcl-fis        not  = spaces or
                     w-tes-pcl-sos        not  = spaces
                     move  1              to   w-tes-pcl-fis-sns      .
       acc-pcl-fis-sos-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-pcl-fis-sns    =    zero
                     go to vis-pcl-fis-sos-100
           else      go to vis-pcl-fis-sos-500.
       vis-pcl-fis-sos-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "( Sostituzione di :"
                                          to   w-all-str-cat (1)      .
           if        w-tes-pcl-fis        =    spaces
                     move  "__________"   to   w-all-str-cat (2)
           else      move  w-tes-pcl-fis  to   w-all-str-cat (2)      .
      ...
      *                  *---------------------------------------------*
           ...
           if        w-tes-pcl-sos        =    spaces
                     move  "__________"   to   w-all-str-cat (2)
           else      move  w-tes-pcl-sos  to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-pcl-fis-so2-999.
       acc-pcl-fis-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-pcl-sos          .
       acc-pcl-fis-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Coefficiente moltiplicatore          *
      *    *-----------------------------------------------------------*
       acc-coe-mol-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Coefficiente moltiplicatore       *
      *    *-----------------------------------------------------------*
       vis-coe-mol-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Coefficiente divisore                *
      *    *-----------------------------------------------------------*
       acc-coe-div-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Coefficiente divisore             *
      *    *-----------------------------------------------------------*
       vis-coe-div-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  * Quantita' per confezione                    *
      *                  *---------------------------------------------*
           perform   acc-rig-qta-000      thru acc-rig-qta-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Peso unitario lordo                         *
      *                  *---------------------------------------------*
           perform   acc-rig-uni-000      thru acc-rig-uni-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Peso tara                                   *
      *                  *---------------------------------------------*
           perform   acc-rig-tar-000      thru acc-rig-tar-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Volume unitario                             *
      *                  *---------------------------------------------*
           perform   acc-rig-vol-000      thru acc-rig-vol-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Larghezza                                   *
      *                  *---------------------------------------------*
           perform   acc-rig-lar-000      thru acc-rig-lar-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Altezza                                     *
      *                  *---------------------------------------------*
           perform   acc-rig-alt-000      thru acc-rig-alt-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Profondita'                                 *
      *                  *---------------------------------------------*
           perform   acc-rig-prf-000      thru acc-rig-prf-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Coefficiente moltiplicatore                 *
      *                  *---------------------------------------------*
           perform   acc-rig-mol-000      thru acc-rig-mol-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Coefficiente divisore                       *
      *                  *---------------------------------------------*
           perform   acc-rig-div-000      thru acc-rig-div-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Tipo confezione                             *
      *                  *---------------------------------------------*
           if        w-rig-tip-cfz        =    zero
                     move  "No"           to   w-lin-imm-tip-cfz
           else      move  "Si"           to   w-lin-imm-tip-cfz      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Editing quantita' per confezione            *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      06                   to   v-car                  .
           ...
           move      spaces               to   v-sgn                  .
           move      "BGD"                to   v-edm                  .
           move      w-rig-qta-cfz        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-qta-cfz      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              * Quantita' per confezione                        *
      *              *-------------------------------------------------*
           perform   vis-rig-qta-000      thru vis-rig-qta-999        .
      *              *-------------------------------------------------*
      *              * Peso unitario lordo                             *
      *              *-------------------------------------------------*
           perform   vis-rig-uni-000      thru vis-rig-uni-999        .
      *              *-------------------------------------------------*
      *              * Peso tara                                       *
      *              *-------------------------------------------------*
           perform   vis-rig-tar-000      thru vis-rig-tar-999        .
      *              *-------------------------------------------------*
      *              * Volume unitario                                 *
      *              *-------------------------------------------------*
           perform   vis-rig-vol-000      thru vis-rig-vol-999        .
      *              *-------------------------------------------------*
      *              * Larghezza                                       *
      *              *-------------------------------------------------*
           perform   vis-rig-lar-000      thru vis-rig-lar-999        .
      *              *-------------------------------------------------*
      *              * Altezza                                         *
      *              *-------------------------------------------------*
           perform   vis-rig-alt-000      thru vis-rig-alt-999        .
      *              *-------------------------------------------------*
      *              * Profondita'                                     *
      *              *-------------------------------------------------*
           perform   vis-rig-prf-000      thru vis-rig-prf-999        .
      *              *-------------------------------------------------*
      *              * Peculiarita' fisiche                            *
      *              *-------------------------------------------------*
      ...
      *              * Coefficiente moltiplicatore                     *
      *              *-------------------------------------------------*
           perform   vis-rig-mol-000      thru vis-rig-mol-999        .
      *              *-------------------------------------------------*
      *              * Coefficiente divisore                           *
      *              *-------------------------------------------------*
           perform   vis-rig-div-000      thru vis-rig-div-999        .
       vis-rig-cor-999.
           exit.
      ...
      *              * Quantita' per confezione                        *
      *              *-------------------------------------------------*
           perform   pmt-rig-qta-000      thru pmt-rig-qta-999        .
      *              *-------------------------------------------------*
      *              * Peso unitario lordo                             *
      *              *-------------------------------------------------*
           perform   pmt-rig-uni-000      thru pmt-rig-uni-999        .
      *              *-------------------------------------------------*
      *              * Peso tara                                       *
      *              *-------------------------------------------------*
           perform   pmt-rig-tar-000      thru pmt-rig-tar-999        .
      *              *-------------------------------------------------*
      *              * Volume unitario                                 *
      *              *-------------------------------------------------*
           perform   pmt-rig-vol-000      thru pmt-rig-vol-999        .
      *              *-------------------------------------------------*
      *              * Larghezza                                       *
      *              *-------------------------------------------------*
           perform   pmt-rig-lar-000      thru pmt-rig-lar-999        .
      *              *-------------------------------------------------*
      *              * Altezza                                         *
      *              *-------------------------------------------------*
           perform   pmt-rig-alt-000      thru pmt-rig-alt-999        .
      *              *-------------------------------------------------*
      *              * Profondita'                                     *
      *              *-------------------------------------------------*
           perform   pmt-rig-prf-000      thru pmt-rig-prf-999        .
      *              *-------------------------------------------------*
      *              * Peculiarita' fisiche                            *
      *              *-------------------------------------------------*
      ...
      *              * Coefficiente moltiplicatore                     *
      *              *-------------------------------------------------*
           perform   pmt-rig-mol-000      thru pmt-rig-mol-999        .
      *              *-------------------------------------------------*
      *              * Coefficiente divisore                           *
      *              *-------------------------------------------------*
           perform   pmt-rig-div-000      thru pmt-rig-div-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Peso unitario lordo              *
      *    *-----------------------------------------------------------*
       pmt-rig-uni-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no in confezione                  *
      *    *-----------------------------------------------------------*
       acc-rig-tip-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  zero           to   w-rig-tip-cfz
           else if   v-num                =    02
                     move  01             to   w-rig-tip-cfz
           else      move  zero           to   w-rig-tip-cfz          .
       acc-rig-tip-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Se 'no' in confezione                       *
      *                  *---------------------------------------------*
           if        w-rig-tip-cfz        not  = zero
                     go to acc-rig-tip-800.
      *                  *---------------------------------------------*
      *                  * Normalizzazione e visualizzazione quantita' *
      *                  *---------------------------------------------*
           move      zero                 to   w-rig-qta-cfz          .
           perform   vis-rig-qta-000      thru vis-rig-qta-999        .
       acc-rig-tip-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Si/no in confezione               *
      *    *-----------------------------------------------------------*
       vis-rig-tip-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-uni-999.
       acc-rig-uni-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-pes-uni          .
       acc-rig-uni-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-tar-999.
       acc-rig-tar-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-pes-tar          .
       acc-rig-tar-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-vol-999.
       acc-rig-vol-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-vol-uni          .
       acc-rig-vol-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-lar-999.
       acc-rig-lar-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-dim-lar          .
       acc-rig-lar-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-alt-999.
       acc-rig-alt-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-dim-alt          .
       acc-rig-alt-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-prf-999.
       acc-rig-prf-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-dim-prf          .
       acc-rig-prf-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-mol-999.
       acc-rig-mol-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-coe-mol          .
       acc-rig-mol-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-div-999.
       acc-rig-div-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-coe-div          .
       acc-rig-div-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tes-qta-cfz          .
           move      zero                 to   w-tes-pes-uni          .
           move      zero                 to   w-tes-pes-tar          .
           move      zero                 to   w-tes-vol-uni          .
           move      zero                 to   w-tes-dim-lar          .
           move      zero                 to   w-tes-dim-alt          .
           move      zero                 to   w-tes-dim-prf          .
           move      spaces               to   w-tes-pcl-fis          .
           move      zero                 to   w-tes-pcl-fis-sns      .
           move      zero                 to   w-tes-coe-mol          .
           move      zero                 to   w-tes-coe-div          .
           move      spaces               to   w-tes-cnf-imp          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-rig-tip-cfz          .
           move      zero                 to   w-rig-qta-cfz          .
           move      zero                 to   w-rig-pes-uni          .
           move      zero                 to   w-rig-pes-tar          .
           move      zero                 to   w-rig-vol-uni          .
           move      zero                 to   w-rig-dim-lar          .
           move      zero                 to   w-rig-dim-alt          .
           move      zero                 to   w-rig-dim-prf          .
           move      spaces               to   w-rig-pcl-fis          .
           move      zero                 to   w-rig-coe-mol          .
           move      zero                 to   w-rig-coe-div          .
       nor-nok-rig-999.
           exit.
      ...
      *              * Quantita' per confezione                        *
      *              *-------------------------------------------------*
           if        w-tes-qta-cfz        =    zero
                     go to sel-rec-dcp-150.
           if        rf-dcp-qta-cfz       not  = w-tes-qta-cfz
                     go to sel-rec-dcp-900.
       sel-rec-dcp-150.
      *              *-------------------------------------------------*
      *              * Peso unitario lordo                             *
      *              *-------------------------------------------------*
           if        w-tes-pes-uni        =    zero
                     go to sel-rec-dcp-200.
           if        rf-dcp-pes-uni       not  = w-tes-pes-uni
                     go to sel-rec-dcp-900.
       sel-rec-dcp-200.
      *              *-------------------------------------------------*
      *              * Peso tara                                       *
      *              *-------------------------------------------------*
           if        w-tes-pes-tar        =    zero
                     go to sel-rec-dcp-250.
           if        rf-dcp-pes-tar       not  = w-tes-pes-tar
                     go to sel-rec-dcp-900.
       sel-rec-dcp-250.
      *              *-------------------------------------------------*
      *              * Volume unitario                                 *
      *              *-------------------------------------------------*
           if        w-tes-vol-uni        =    zero
                     go to sel-rec-dcp-300.
           if        rf-dcp-vol-uni       not  = w-tes-vol-uni
                     go to sel-rec-dcp-900.
       sel-rec-dcp-300.
      *              *-------------------------------------------------*
      *              * Larghezza                                       *
      *              *-------------------------------------------------*
           if        w-tes-dim-lar        =    zero
                     go to sel-rec-dcp-350.
           if        rf-dcp-dim-lar       not  = w-tes-dim-lar
                     go to sel-rec-dcp-900.
       sel-rec-dcp-350.
      *              *-------------------------------------------------*
      *              * Altezza                                         *
      *              *-------------------------------------------------*
           if        w-tes-dim-alt        =    zero
                     go to sel-rec-dcp-400.
           if        rf-dcp-dim-alt       not  = w-tes-dim-alt
                     go to sel-rec-dcp-900.
       sel-rec-dcp-400.
      *              *-------------------------------------------------*
      *              * Profondita'                                     *
      *              *-------------------------------------------------*
           if        w-tes-dim-prf        =    zero
                     go to sel-rec-dcp-450.
           if        rf-dcp-dim-prf       not  = w-tes-dim-prf
                     go to sel-rec-dcp-900.
       sel-rec-dcp-450.
      *              *-------------------------------------------------*
      *              * Peculiarita' fisiche                            *
      *              *-------------------------------------------------*
           ...
           if        rf-dcp-pcl-fis       not  = w-tes-pcl-fis
                     go to sel-rec-dcp-900.
       sel-rec-dcp-500.
      *              *-------------------------------------------------*
      *              * Coefficiente moltiplicatore                     *
      *              *-------------------------------------------------*
           if        w-tes-coe-mol        =    zero
                     go to sel-rec-dcp-550.
           if        rf-dcp-coe-mol       not  = w-tes-coe-mol
                     go to sel-rec-dcp-900.
       sel-rec-dcp-550.
      *              *-------------------------------------------------*
      *              * Coefficiente divisore                           *
      *              *-------------------------------------------------*
           if        w-tes-coe-div        =    zero
                     go to sel-rec-dcp-800.
           if        rf-dcp-coe-div       not  = w-tes-coe-div
                     go to sel-rec-dcp-900.
       sel-rec-dcp-800.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcp-tip-cfz       to   w-rig-tip-cfz          .
           move      rf-dcp-qta-cfz       to   w-rig-qta-cfz          .
           move      rf-dcp-pes-uni       to   w-rig-pes-uni          .
           move      rf-dcp-pes-tar       to   w-rig-pes-tar          .
           move      rf-dcp-vol-uni       to   w-rig-vol-uni          .
           move      rf-dcp-dim-lar       to   w-rig-dim-lar          .
           move      rf-dcp-dim-alt       to   w-rig-dim-alt          .
           move      rf-dcp-dim-prf       to   w-rig-dim-prf          .
           move      rf-dcp-pcl-fis       to   w-rig-pcl-fis          .
           move      rf-dcp-coe-mol       to   w-rig-coe-mol          .
           move      rf-dcp-coe-div       to   w-rig-coe-div          .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-pcl-sos        to   w-rig-pcl-fis          .
       car-eff-rig-sos-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-rig-tip-cfz        to   rf-dcp-tip-cfz         .
           move      w-rig-qta-cfz        to   rf-dcp-qta-cfz         .
           move      w-rig-pes-uni        to   rf-dcp-pes-uni         .
           move      w-rig-pes-tar        to   rf-dcp-pes-tar         .
           move      w-rig-vol-uni        to   rf-dcp-vol-uni         .
           move      w-rig-dim-lar        to   rf-dcp-dim-lar         .
           move      w-rig-dim-alt        to   rf-dcp-dim-alt         .
           move      w-rig-dim-prf        to   rf-dcp-dim-prf         .
           move      w-rig-pcl-fis        to   rf-dcp-pcl-fis         .
           move      w-rig-coe-mol        to   rf-dcp-coe-mol         .
           move      w-rig-coe-div        to   rf-dcp-coe-div         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
