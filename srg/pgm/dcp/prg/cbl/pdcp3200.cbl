      ...
      *                       Ultima revisione:    NdK del 30/11/07    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase dcp320, nella sua globalita', esegue i tipi di manu-   *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * MANPRZ      Manutenzione prezzi di listino            pdcp320a *
      *                                                                *
      * MANPSP      Manutenzione prezzi, sconti e provvigioni pdcp320b *
      *                                                                *
      * MANSTO      Manutenzione prezzi storicizzati          pdcp320d *
      *                                                                *
      * MANECF      Manutenzione listini per eco-fee          pdcp320e *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Link-area comune per programmi della serie pdcp3200       *
      *    *-----------------------------------------------------------*
           copy      "pgm/dcp/prg/cpy/pdcp3200.pgl"                   .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'dcp320'           *
      *              *-------------------------------------------------*
           perform   fas-dcp-320-000      thru fas-dcp-320-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Tipo funzionamento prezzi netti concordati  *
      *                  * per clienti                                 *
      *                  *---------------------------------------------*
           perform   prs-tfu-pnc-000      thru prs-tfu-pnc-999        .
      *                  *---------------------------------------------*
      *                  * Si/no gestione eco-contributi RAEE          *
      *                  *---------------------------------------------*
           perform   prs-snx-rae-000      thru prs-snx-rae-999        .
       pre-exe-pgm-300.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Lettura della personalizzazione per si/no gestione        *
      *    * eco-contributi RAEE                                       *
      *    *-----------------------------------------------------------*
       prs-snx-rae-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione work-area                       *
      *              *-------------------------------------------------*
           move      spaces               to   w-prs-snx-rae          .
      *              *-------------------------------------------------*
      *              * Lettura personalizzazione                       *
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/dcp/lst[snx-rae]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                not  = spaces
                     go to prs-snx-rae-999.
      *              *-------------------------------------------------*
      *              * Valore personalizzazione in work-area           *
      *              *-------------------------------------------------*
           move      s-alf                to   w-prs-snx-rae          .
      *              *-------------------------------------------------*
      *              * Controllo personalizzazione                     *
      *              *-------------------------------------------------*
           if        w-prs-snx-rae        not  = "S"
                     move  "N"            to   w-prs-snx-rae          .
       prs-snx-rae-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *              * Azzeramento preliminare eventuale elemento uni- *
      *              * co                                              *
      *              *-------------------------------------------------*
           move      zero                 to   w-tmn-ele-uni          .
       loa-tbl-tmn-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              " MANPRZ     pdcp320a  "
       ...
       loa-tbl-tmn-120.
           if        w-prs-tfu-pnc-tip    =    00
                     go to loa-tbl-tmn-140.
           move      "Prezzi, sconti e provvigioni                      
      -              " MANPSP     pdcp320b  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
       loa-tbl-tmn-140.
           move      "Prezzi di listino storicizzati                    
      -              " MANSTO     pdcp320d  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tmn-160.
           if        w-prs-snx-rae        not  = "S"
                     go to loa-tbl-tmn-200.
           move      "Listini contributi eco-fee                        
      -              " MANECF     pdcp320e  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tmn-200.
      ...
      *              * zione in codice unico                           *
      *              *-------------------------------------------------*
           move      w-tmn-ele-num        to   w-tmn-ele-uni          .
      *              *-------------------------------------------------*
      *              * Bufferizzazione codice numerico tipo manuten-   *
      *              * zione                                           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Se un solo elemento in tabella ed esiste un     *
      *              * codice dell'unico elemento, si esegue quello    *
      *              * direttamente                                    *
      *              *-------------------------------------------------*
           if        w-tmn-ele-num        >    1
                     go to fas-dcp-320-025.
           if        w-tmn-ele-uni        =    zero
                     go to fas-dcp-320-025.
      *                  *---------------------------------------------*
      *                  * Codice unico in comodo di accettazione      *
      *                  *---------------------------------------------*
           move      w-tmn-ele-uni        to   v-num                  .
           move      "DO  "               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Video in On                                 *
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Ad esecuzione overlay                       *
      *                  *---------------------------------------------*
           go to     fas-dcp-320-220.
       fas-dcp-320-025.
      *              *-------------------------------------------------*
      *              * Visualizzazione titolo programma                *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-dcp-320-300
           else if   v-key                =    "PRSC"
                     go to fas-dcp-320-400
           else if   v-key                =    "NXSC"
                     go to fas-dcp-320-450
           else if   v-key                =    "DOWN"
                     go to fas-dcp-320-500
           else if   v-key                =    "EXIT"
                     go to fas-dcp-320-250
           else      go to fas-dcp-320-200.
       fas-dcp-320-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-man        =    zero
                     go to fas-dcp-320-330.
           move      zero                 to   w-tmn-ele-inx          .
       fas-dcp-320-322.
           add       1                    to   w-tmn-ele-inx          .
           if        w-tmn-ele-inx        >    w-tmn-ele-num
                     go to fas-dcp-320-340.
           if        w-tmn-num-tmn
                    (w-tmn-ele-inx)       =    w-key-num-man
                     go to fas-dcp-320-350
           else      go to fas-dcp-320-322.
       fas-dcp-320-330.
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-tmn-ele-num        >    1
                     go to fas-dcp-320-360.
           if        w-tmn-ele-uni        =    zero
                     go to fas-dcp-320-360.
           go to     fas-dcp-320-380.
       fas-dcp-320-360.
      *                          *-------------------------------------*
      *                          * Visualizzazione                     *
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-dcp-320-630
           else if   v-key                =    "PRSC"
                     go to fas-dcp-320-600
           else if   v-key                =    "NXSC"
                     go to fas-dcp-320-610
           else if   v-key                =    "UP  "
                     go to fas-dcp-320-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-dcp-320-650
           else if   v-key                =    "EXIT"
                     go to fas-dcp-320-660
           else      go to fas-dcp-320-570.
       fas-dcp-320-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-dcp-320-626
           else      go to fas-dcp-320-628.
       fas-dcp-320-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-dcp-320-636
           else      go to fas-dcp-320-638.
       fas-dcp-320-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-dcp-320-725
           else      go to fas-dcp-320-750.
       fas-dcp-320-725.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Se un solo elemento in tabella ed esiste un     *
      *              * codice dell'unico elemento, si esce             *
      *              *-------------------------------------------------*
           if        w-tmn-ele-num        >    1
                     go to fas-dcp-320-760.
           if        w-tmn-ele-uni        =    zero
                     go to fas-dcp-320-760.
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
