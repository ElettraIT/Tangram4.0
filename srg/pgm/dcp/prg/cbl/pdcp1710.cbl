      ...
      *                    co 1 per classificazione prodotti           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE 1. CODICE STAT. PRODOTTI "       .
      ...
      *        *-------------------------------------------------------*
      *        * Area di controllo per start preliminare               *
      *        *-------------------------------------------------------*
           05  w-cnt-str.
               10  w-cnt-str-ctr-rec      pic  9(02)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      40                   to   v-pos                  .
           move      rf-zps-des-cls       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zps-cod-cls       to   w-mpn-cod-cls          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "     1. CODICE STATISTICO PRODOTTI      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
