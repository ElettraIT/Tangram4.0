      ...
      *                                   Fase:    dcp145              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 24/04/95    *
      *                       Ultima revisione:    NdK del 14/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella codici marketing per       *
      *                    classificazioni dati commerciali prodotti.  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   GESTIONE CODICI MARKETING PRODOTTI   "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-clm          pic  9(05)                  .
               10  w-tes-cod-clm-aut      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-mne-clm          pic  x(05)                  .
               10  w-tes-des-key          pic  x(20)                  .
               10  w-tes-des-clm          pic  x(20)                  .
               10  w-tes-alx-exp.
                   15  filler  occurs 40  pic  x(01)                  .

      *    *===========================================================*
      *    * Link-area per accettazione codice marketing prodotti      *
      *    *-----------------------------------------------------------*
           copy      "pgm/dcp/prg/cpy/acmnzkc3.acl"                   .
      ...
      *              *-------------------------------------------------*
      *              * Open modulo accettazione codice marketing pro-  *
      *              * dotti                                           *
      *              *-------------------------------------------------*
           perform   cmn-zkc-003-opn-000  thru cmn-zkc-003-opn-999    .
       pre-exe-pgm-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       pos-exe-pgm-000.
      *              *-------------------------------------------------*
      *              * Close modulo accettazione codice marketing pro- *
      *              * dotti                                           *
      *              *-------------------------------------------------*
           perform   cmn-zkc-003-cls-000  thru cmn-zkc-003-cls-999    .
       pos-exe-pgm-999.
           exit.
      ...
      *                  * Codice marketing                            *
      *                  *---------------------------------------------*
           perform   acc-cod-clm-000      thru acc-cod-clm-999        .
      ...
      *              * Codice marketing                                *
      *              *-------------------------------------------------*
           perform   vis-cod-clm-000      thru vis-cod-clm-999        .
       vis-key-reg-999.
           exit.
      ...
      *              * Codice marketing                                *
      *              *-------------------------------------------------*
           perform   pmt-cod-clm-000      thru pmt-cod-clm-999        .
      *              *-------------------------------------------------*
      *              * Linea di trattini                               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice marketing              *
      *    *-----------------------------------------------------------*
       pmt-cod-clm-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice marketing              *
      *    *-----------------------------------------------------------*
       acc-cod-clm-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zkc-003-ope      .
           move      w-tes-cod-clm        to   w-cmn-zkc-003-cod      .
           move      04                   to   w-cmn-zkc-003-lin      .
           move      30                   to   w-cmn-zkc-003-pos      .
           move      07                   to   w-cmn-zkc-003-dln      .
           move      30                   to   w-cmn-zkc-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "INSR"               to   v-pfk (04)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   cmn-zkc-003-cll-000  thru cmn-zkc-003-cll-999    .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
           perform   cmn-zkc-003-foi-000  thru cmn-zkc-003-foi-999    .
       acc-cod-clm-110.
           perform   cmn-zkc-003-cll-000  thru cmn-zkc-003-cll-999    .
           if        w-cmn-zkc-003-ope    =    "F+"
                     go to acc-cod-clm-115.
           if        w-cmn-zkc-003-ope    =    "AC"
                     go to acc-cod-clm-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-clm-115.
           perform   cmn-zkc-003-foi-000  thru cmn-zkc-003-foi-999    .
           go to     acc-cod-clm-110.
       acc-cod-clm-120.
           move      w-cmn-zkc-003-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-clm-999.
       acc-cod-clm-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cod-clm          .
       acc-cod-clm-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-clm        =    zero
                     go to acc-cod-clm-410
           else      go to acc-cod-clm-450.
       acc-cod-clm-410.
      *                  *---------------------------------------------*
      ...
      *                      * zione                                   *
      *                      *-----------------------------------------*
           move      w-enc-cod-val-pos    to   w-tes-cod-clm          .
      *                      *-----------------------------------------*
      *                      * Segnale di attribuzione codice eseguita *
      *                      * automaticamente                         *
      *                      *-----------------------------------------*
           move      "#"                  to   w-tes-cod-clm-aut      .
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice marketing           *
      *    *-----------------------------------------------------------*
       vis-cod-clm-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Descrizione codice marketing                *
      *                  *---------------------------------------------*
           perform   acc-des-clm-000      thru acc-des-clm-999        .
           if        v-key                =    "NXSC"
       ...
       acc-tes-reg-110.
      *                  *---------------------------------------------*
      *                  * Mnemonico codice marketing                  *
      *                  *---------------------------------------------*
           perform   acc-mne-clm-000      thru acc-mne-clm-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Descrizione codice marketing                    *
      *              *-------------------------------------------------*
           perform   vis-des-clm-000      thru vis-des-clm-999        .
      *              *-------------------------------------------------*
      *              * Mnemonico codice marketing                      *
      *              *-------------------------------------------------*
           perform   vis-mne-clm-000      thru vis-mne-clm-999        .
           go to     vis-tes-reg-999.
       vis-tes-reg-200.
       vis-tes-reg-999.
           exit.
      ...
      *              * Descrizione codice marketing                    *
      *              *-------------------------------------------------*
           perform   pmt-des-clm-000      thru pmt-des-clm-999        .
      *              *-------------------------------------------------*
      *              * Mnemonico codice marketing                      *
      *              *-------------------------------------------------*
           perform   pmt-mne-clm-000      thru pmt-mne-clm-999        .
           go to     pmt-tes-reg-999.
       pmt-tes-reg-200.
       pmt-tes-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione codice marketing     *
      *    *-----------------------------------------------------------*
       pmt-des-clm-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Mnemonico codice marketing       *
      *    *-----------------------------------------------------------*
       pmt-mne-clm-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione codice marketing *
      *    *-----------------------------------------------------------*
       acc-des-clm-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-clm (1)    not  = spaces
                     go to acc-des-clm-450.
           if        v-key                =    "UP  "
                     go to acc-des-clm-600
           else      go to acc-des-clm-100.
       acc-des-clm-450.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-des-clm (1)    to   w-all-str-alf          .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Descrizione codice marketing            *
      *    *-----------------------------------------------------------*
       vis-des-clm-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Mnemonico codice marketing   *
      *    *-----------------------------------------------------------*
       acc-mne-clm-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Mnemonico codice marketing              *
      *    *-----------------------------------------------------------*
       vis-mne-clm-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "Manca la descrizione per il codice marketing      
      -              "      "             to   w-err-box-err-msg      .
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           move      zero                 to   w-tes-cod-clm          .
           move      spaces               to   w-tes-cod-clm-aut      .
       nor-key-reg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-mne-clm (1)      .
           move      spaces               to   w-tes-des-key (1)      .
           move      spaces               to   w-tes-des-clm (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      03                   to   rf-zkc-tip-clm         .
           move      w-tes-cod-clm        to   rf-zkc-cod-clm         .
           move      "pgm/dcc/fls/ioc/obj/iofzkc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-zkc-mne-clm       to   w-tes-mne-clm (1)      .
           move      rf-zkc-des-key       to   w-tes-des-key (1)      .
           move      rf-zkc-des-clm       to   w-tes-des-clm (1)      .
           move      rf-zkc-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zkc]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zkc-000      thru wrt-rec-zkc-999        .
      ...
      *                      * Rewrite record [zkc]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zkc-000      thru rew-rec-zkc-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zkc]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zkc-000      thru del-rec-zkc-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zkc]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zkc-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-mne-clm (1)    to   rf-zkc-mne-clm         .
           move      w-tes-des-key (1)    to   rf-zkc-des-key         .
           move      w-tes-des-clm (1)    to   rf-zkc-des-clm         .
           move      w-tes-alx-exp (1)    to   rf-zkc-alx-exp         .
       cmp-rec-zkc-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zkc]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zkc-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zkc-000      thru cmp-rec-zkc-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zkc] parte 01    *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zkc3"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           ...
           move      "CODCLM    "         to   f-key                  .
           move      03                   to   rf-zkc-tip-clm         .
           move      w-enc-cod-val-pos    to   rf-zkc-cod-clm         .
           move      "pgm/dcc/fls/ioc/obj/iofzkc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       rip-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zkc]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zkc3"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione del codice marketing pro-  *
      *    * dotti                                                     *
      *    *-----------------------------------------------------------*
           copy      "pgm/dcp/prg/cpy/acmnzkc3.acs"                   .
