      ...
      *                                   Fase:    dcp402              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/06/95    *
      *                       Ultima revisione:    NdK del 15/04/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdcp4020 *
      *                                                                *
      *                    Stampa rubrica prodotti personalizzata :    *
      *                                                                *
      *                    Questa overlay e' eseguibile solamente se   *
      *                    attivata da apposita personalizzazione      *
      *                    'pgm/dcp/dcp402[ovy-stp]'                   *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Letture preliminari relative al codice prodotto *
      *              *-------------------------------------------------*
       prn-liv-det-010.
      *                  *---------------------------------------------*
      *                  * Normalizzazione dati generali di acquisto   *
      *                  *---------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "pgm/dcf/fls/ioc/obj/iofaaq"
                                          to   s-pat                  .
           ...
           call      s-pat               using f
                                               rf-aaq                 .
      *                  *---------------------------------------------*
      *                  * Scheda generale di acquisto prodotto        *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
       ...
       prn-liv-det-020.
      *                  *---------------------------------------------*
      *                  * Normalizzazione dati scorta minima          *
      *                  *---------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "pgm/fab/fls/ioc/obj/ioffbs"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se diverso da zero                 *
      *                      *-----------------------------------------*
           if        rf-aaq-tmp-apv       =    zero
      ...
      *                  *---------------------------------------------*
           ...
           move      "V"                  to   p-tip                  .
           move      09                   to   p-car                  .
           move      rf-aaq-dec-prz       to   p-dec                  .
           add       rf-aaq-dec-vlt       to   p-dec                  .
           move      spaces               to   p-sgn                  .
           move      "BG"                 to   p-edm                  .
           move      p-lnr                to   p-lin                  .
           move      115                  to   p-pos                  .
           move      rf-aaq-prz-acr       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-800.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "ARCHIVIO PRODOTTI"  to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Sopralineatura fincatura generica               *
      *              *-------------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      132                  to   p-car                  .
      ...
      *              *-------------------------------------------------*
      ...
      -              "      | Cod.produtt.| Lotto ven.| Lotto acq.|Scort
      -              "a min.| Cons | Prezzo rif.|C.M.|"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
