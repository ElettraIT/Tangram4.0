      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "   DATI GENERALI DI ACQUISTO PRODOTTI   "       .
      ...
      *            *---------------------------------------------------*
               ...
               10  w-tes-cod-pdt-sns      pic  9(01)                  .
               10  w-tes-cdn-cdm          pic  9(08)                  .
      *            *---------------------------------------------------*
      *            * Valori sostitutivi                                *
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-lot-ven          pic  9(06)v9(03)            .
               10  w-rig-dcf-pfz          pic  9(07)                  .
               10  w-rig-dpz-pfz          pic  x(04)                  .
               10  w-rig-dcf-pfz-rag      pic  x(40)                  .
               10  w-rig-cod-pdt          pic  9(07)                  .
               10  w-rig-cod-pdt-rag      pic  x(40)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Salvataggio per Lotto di vendita                      *
      *        *-------------------------------------------------------*
           05  w-sav-lot-ven              pic  9(06)v9(03)            .
      ...
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Lotto di vendita                *
      *        *-------------------------------------------------------*
           05  w-lpt-lot-ven-lin          pic  9(03)    value 014     .
           05  w-lpt-lot-ven-pos          pic  9(03)    value 030     .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Casa produttrice                *
      *        *-------------------------------------------------------*
           05  w-lpt-cod-pdt-lin          pic  9(03)    value 018     .
           05  w-lpt-cod-pdt-pos          pic  9(03)    value 030     .
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Nomenclatura combinata          *
      *        *-------------------------------------------------------*
           05  w-lpt-cdn-cdm-lin          pic  9(03)    value 020     .
      ...
      *                  * Lotto di vendita                            *
      *                  *---------------------------------------------*
           perform   acc-lot-ven-000      thru acc-lot-ven-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *    *-----------------------------------------------------------*
       pmt-lot-ven-000.
           ...
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-lot-ven-lin    to   v-lin                  .
           move      01                   to   v-pos                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-cod-pdt-000.
           ...
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-cod-pdt-lin    to   v-lin                  .
           move      01                   to   v-pos                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Nomenclatura combinata           *
      *    *-----------------------------------------------------------*
       pmt-cdn-cdm-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      w-lpt-cdn-cdm-lin    to   v-lin                  .
           move      01                   to   v-pos                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Lotto di vendita                     *
      *    *-----------------------------------------------------------*
       acc-lot-ven-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore attuale                  *
      *                  *---------------------------------------------*
           move      w-tes-lot-ven        to   w-sav-lot-ven          .
      *                  *---------------------------------------------*
      *                  * Test se richiesta sostituzione              *
      *                  *---------------------------------------------*
           if        w-tes-lot-ven-sns    =    zero
                     go to acc-lot-ven-100.
      *                  *---------------------------------------------*
      *                  * Forzatura del tasto Pf1                     *
      *                  *---------------------------------------------*
           move      "[1] "               to   v-key                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "<B"                 to   v-edm                  .
           move      w-lpt-lot-ven-lin    to   v-lin                  .
           move      w-lpt-lot-ven-pos    to   v-pos                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      "[1] "               to   v-pfk (14)             .
           move      w-tes-lot-ven        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Cancellazione eventuali note operative          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-lot-ven-999.
       acc-lot-ven-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-lot-ven          .
       acc-lot-ven-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-lot-ven-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-lot-ven-sos-000  thru acc-lot-ven-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-lot-ven-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-lot-ven-sos-000  thru vis-lot-ven-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-lot-ven-sns    not  = zero
                     go to acc-lot-ven-800.
      *                  *---------------------------------------------*
      *                  * Visualizzazione codice impostato            *
      *                  *---------------------------------------------*
           perform   vis-lot-ven-000      thru vis-lot-ven-999        .
      ...
      *                  * Normalizzazione segnale di sostituzione     *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-lot-ven-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-lot-ven-pos    to   v-pos                  .
           subtract  1                    from v-pos                  .
           move      w-lpt-lot-ven-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-lot-ven-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-lot-ven-sos-010.
      ...
      *                  * Visualizzazione valore da sostituire        *
      *                  *---------------------------------------------*
           perform   vis-lot-ven-so1-000  thru vis-lot-ven-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-lot-ven-so2-000  thru vis-lot-ven-so2-999    .
       acc-lot-ven-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-lot-ven-so1-000  thru acc-lot-ven-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-lot-ven-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-lot-ven-sos-600.
       acc-lot-ven-sos-300.
      *                  *---------------------------------------------*
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-lot-ven-so2-000  thru acc-lot-ven-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-lot-ven-sos-600.
           if        v-key                =    "UP  "
                     go to acc-lot-ven-sos-200.
       acc-lot-ven-sos-600.
      *              *-------------------------------------------------*
      *              * Controlli su valori accettati                   *
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-lot-ven        =    zero  and
                     w-tes-ven-sos        =    zero
                     go to acc-lot-ven-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-lot-ven        not  = w-tes-ven-sos
                     go to acc-lot-ven-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
      ...
      *                  * Segnale di sostituzione effettuata          *
      *                  *---------------------------------------------*
           if        w-tes-lot-ven        not  = zero or
                     w-tes-ven-sos        not  = zero
                     move  1              to   w-tes-lot-ven-sns      .
       acc-lot-ven-sos-900.
      *              *-------------------------------------------------*
      *              * Normalizzazione stato di uscita                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-lot-ven-sns    =    zero
                     go to vis-lot-ven-sos-100
           else      go to vis-lot-ven-sos-500.
       vis-lot-ven-sos-100.
      *              *-------------------------------------------------*
      *              * Se sostituzione non effettuata                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-lot-ven-so2-999.
       acc-lot-ven-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-ven-sos          .
       acc-lot-ven-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice casa produttrice              *
      *    *-----------------------------------------------------------*
       acc-cod-pdt-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-lpt-cod-pdt-lin    to   w-cod-mne-pdt-lin      .
           move      w-lpt-cod-pdt-pos    to   w-cod-mne-pdt-pos      .
           move      w-lpt-cod-pdt-lin    to   w-cod-mne-pdt-rln      .
           move      w-lpt-cod-pdt-pos    to   w-cod-mne-pdt-rps      .
           add       11                   to   w-cod-mne-pdt-rps      .
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-cod-pdt-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-cod-pdt-sos-000  thru acc-cod-pdt-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-pdt-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-cod-pdt-sos-000  thru vis-cod-pdt-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-cod-pdt-sns    not  = zero
                     go to acc-cod-pdt-800.
      *                  *---------------------------------------------*
      *                  * Visualizzazione codice impostato            *
      *                  *---------------------------------------------*
           perform   vis-cod-pdt-000      thru vis-cod-pdt-999        .
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-pdt        to   w-let-arc-pdt-cod      .
           perform   let-arc-pdt-000      thru let-arc-pdt-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione ragione sociale              *
      *                  *---------------------------------------------*
           move      w-let-arc-pdt-rag    to   w-tes-cod-pdt-rag      .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       vis-cod-pdt-000.
           ...
           move      "<B"                 to   v-edm                  .
           move      w-lpt-cod-pdt-lin    to   v-lin                  .
           move      w-lpt-cod-pdt-pos    to   v-pos                  .
      ...
      *    *-----------------------------------------------------------*
       vis-cod-pdt-rag-000.
           ...
           move      w-lpt-cod-pdt-pos    to   v-pos                  .
           add       11                   to   v-pos                  .
           move      w-tes-cod-pdt-rag    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-pdt-rag-999.
           exit.
      ...
      *                  * Normalizzazione segnale di sostituzione     *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cod-pdt-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-cod-pdt-pos    to   v-pos                  .
           subtract  1                    from v-pos                  .
           move      w-lpt-cod-pdt-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-cod-pdt-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-cod-pdt-sos-010.
      ...
      *                  * Visualizzazione valore da sostituire        *
      *                  *---------------------------------------------*
           perform   vis-cod-pdt-so1-000  thru vis-cod-pdt-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-cod-pdt-so2-000  thru vis-cod-pdt-so2-999    .
       acc-cod-pdt-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-cod-pdt-so1-000  thru acc-cod-pdt-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-pdt-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-pdt-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-cod-pdt-sos-600.
      ...
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-cod-pdt-so2-000  thru acc-cod-pdt-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-pdt-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-pdt-sos-200.
       acc-cod-pdt-sos-600.
      *              *-------------------------------------------------*
      *              * Controlli su valori accettati                   *
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-cod-pdt        =    zero  and
                     w-tes-pdt-sos        =    zero
                     go to acc-cod-pdt-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-cod-pdt        not  = w-tes-pdt-sos
                     go to acc-cod-pdt-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-pdt-sos          .
      *                      *-----------------------------------------*
      *                      * Segnale di sostituzione non effettuata  *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-cod-pdt-sns      .
      ...
      *                  * Segnale di sostituzione effettuata          *
      *                  *---------------------------------------------*
           if        w-tes-cod-pdt        not  = zero or
                     w-tes-pdt-sos        not  = zero
                     move  1              to   w-tes-cod-pdt-sns      .
       acc-cod-pdt-sos-900.
      *              *-------------------------------------------------*
      *              * Normalizzazione stato di uscita                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cod-pdt-sns    =    zero
                     go to vis-cod-pdt-sos-100
           else      go to vis-cod-pdt-sos-500.
       vis-cod-pdt-sos-100.
      *              *-------------------------------------------------*
      *              * Se sostituzione non effettuata                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       acc-cod-pdt-so1-110.
           perform   cod-mne-pdt-cll-000  thru cod-mne-pdt-cll-999    .
           if        w-cod-mne-pdt-ope    =    "F+"
                     go to acc-cod-pdt-so1-115.
           if        w-cod-mne-pdt-ope    =    "AC"
                     go to acc-cod-pdt-so1-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-pdt-so1-115.
           perform   cod-mne-pdt-foi-000  thru cod-mne-pdt-foi-999    .
           go to     acc-cod-pdt-so1-110.
       acc-cod-pdt-so1-120.
           move      w-cod-mne-pdt-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-pdt-ope      .
           move      w-tes-pdt-sos        to   w-cod-mne-pdt-cod      .
           move      w-lpt-cod-pdt-lin    to   w-cod-mne-pdt-lin      .
           move      w-lpt-cod-pdt-pos    to   w-cod-mne-pdt-pos      .
           add       35                   to   w-cod-mne-pdt-pos      .
           move      zero                 to   w-cod-mne-pdt-rln      .
           move      zero                 to   w-cod-mne-pdt-rps      .
           move      zero                 to   w-cod-mne-pdt-vln      .
           move      zero                 to   w-cod-mne-pdt-vps      .
       ...
       acc-cod-pdt-so2-110.
           perform   cod-mne-pdt-cll-000  thru cod-mne-pdt-cll-999    .
           if        w-cod-mne-pdt-ope    =    "F+"
                     go to acc-cod-pdt-so2-115.
           if        w-cod-mne-pdt-ope    =    "AC"
                     go to acc-cod-pdt-so2-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-pdt-so2-115.
           perform   cod-mne-pdt-foi-000  thru cod-mne-pdt-foi-999    .
           go to     acc-cod-pdt-so2-110.
       acc-cod-pdt-so2-120.
           move      w-cod-mne-pdt-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-pdt-so2-999.
       acc-cod-pdt-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-pdt-sos          .
       acc-cod-pdt-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Nomenclatura combinata               *
      *    *-----------------------------------------------------------*
       acc-cdn-cdm-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      "<B"                 to   v-edm                  .
           move      w-lpt-cdn-cdm-lin    to   v-lin                  .
           move      w-lpt-cdn-cdm-pos    to   v-pos                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      w-tes-cdn-cdm        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Nomenclatura combinata            *
      *    *-----------------------------------------------------------*
       vis-cdn-cdm-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  * Lotto di vendita                            *
      *                  *---------------------------------------------*
           perform   acc-rig-ven-000      thru acc-rig-ven-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Codice casa produttrice                     *
      *                  *---------------------------------------------*
           perform   acc-rig-pdt-000      thru acc-rig-pdt-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Nomenclatura combinata                      *
      *                  *---------------------------------------------*
           perform   acc-rig-cdm-000      thru acc-rig-cdm-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *              * Lotto di vendita                                *
      *              *-------------------------------------------------*
           perform   vis-rig-ven-000      thru vis-rig-ven-999        .
      *              *-------------------------------------------------*
      *              * Codice fornitore preferenziale                  *
      *              *-------------------------------------------------*
      ...
      *              * Codice casa produttrice                         *
      *              *-------------------------------------------------*
           perform   vis-rig-pdt-000      thru vis-rig-pdt-999        .
           perform   vis-rig-pdt-rag-000  thru vis-rig-pdt-rag-999    .
      *              *-------------------------------------------------*
      *              * Nomenclatura combinata                          *
      *              *-------------------------------------------------*
           perform   vis-rig-cdm-000      thru vis-rig-cdm-999        .
       vis-rig-cor-999.
           exit.
      ...
      *              * Lotto di vendita                                *
      *              *-------------------------------------------------*
           perform   pmt-rig-ven-000      thru pmt-rig-ven-999        .
      *              *-------------------------------------------------*
      *              * Codice fornitore preferenziale                  *
      *              *-------------------------------------------------*
      ...
      *              * Codice casa produttrice                         *
      *              *-------------------------------------------------*
           perform   pmt-rig-pdt-000      thru pmt-rig-pdt-999        .
      *              *-------------------------------------------------*
      *              * Nomenclatura combinata                          *
      *              *-------------------------------------------------*
           perform   pmt-rig-cdm-000      thru pmt-rig-cdm-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       pmt-rig-ven-000.
           ...
           move      18                   to   v-lin                  .
           move      47                   to   v-pos                  .
           move      "Lotto di vendita :" to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-rig-ven-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-ven-999.
       acc-rig-ven-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-lot-ven          .
       acc-rig-ven-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-pdt-ope      .
           move      w-rig-cod-pdt        to   w-cod-mne-pdt-cod      .
       ...
       acc-rig-pdt-110.
           perform   cod-mne-pdt-cll-000  thru cod-mne-pdt-cll-999    .
           if        w-cod-mne-pdt-ope    =    "F+"
                     go to acc-rig-pdt-115.
           if        w-cod-mne-pdt-ope    =    "AC"
                     go to acc-rig-pdt-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-pdt-115.
           perform   cod-mne-pdt-foi-000  thru cod-mne-pdt-foi-999    .
           go to     acc-rig-pdt-110.
       acc-rig-pdt-120.
           move      w-cod-mne-pdt-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-pdt-999.
       acc-rig-pdt-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-cod-pdt          .
       acc-rig-pdt-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura archivio [pdt]                      *
      *                  *---------------------------------------------*
           move      w-rig-cod-pdt        to   w-let-arc-pdt-cod      .
           perform   let-arc-pdt-000      thru let-arc-pdt-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione ragione sociale              *
      *                  *---------------------------------------------*
           move      w-let-arc-pdt-rag    to   w-rig-cod-pdt-rag      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione ragione sociale             *
      *                  *---------------------------------------------*
           perform   vis-rig-pdt-rag-000  thru vis-rig-pdt-rag-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-pdt-rag-000.
           ...
           move      20                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-pdt-rag    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-pdt-rag-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-cdm-999.
       acc-rig-cdm-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-cdn-cdm          .
       acc-rig-cdm-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   w-tes-cod-pdt-rag      .
           move      zero                 to   w-tes-cod-pdt-sns      .
           move      zero                 to   w-tes-cdn-cdm          .
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-cod-pdt          .
           move      spaces               to   w-rig-cod-pdt-rag      .
           move      zero                 to   w-rig-cdn-cdm          .
       nor-nok-rig-999.
           exit.
      ...
      *              * Lotto di vendita                                *
      *              *-------------------------------------------------*
           if        w-tes-lot-ven-sns    =    zero and
                     w-tes-lot-ven        =    zero
                     go to sel-rec-dcp-400.
           if        rf-dcp-lot-ven       not  = w-tes-lot-ven
                     go to sel-rec-dcp-900.
       sel-rec-dcp-400.
      *              *-------------------------------------------------*
      *              * Fornitore preferenziale                         *
      ...
      *              * Casa produttrice                                *
      *              *-------------------------------------------------*
           if        w-tes-cod-pdt-sns    =    zero and
                     w-tes-cod-pdt        =    zero
                     go to sel-rec-dcp-600.
           if        rf-aaq-cod-pdt       not  = w-tes-cod-pdt
                     go to sel-rec-dcp-900.
       sel-rec-dcp-600.
      *              *-------------------------------------------------*
      *              * Nomenclatura combinata                          *
      *              *-------------------------------------------------*
           if        w-tes-cdn-cdm        =    zero
                     go to sel-rec-dcp-800.
           if        rf-dcp-cdn-cdm       not  = w-tes-cdn-cdm
                     go to sel-rec-dcp-900.
       sel-rec-dcp-800.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcp-cdn-cdm       to   w-rig-cdn-cdm          .
      *                      *-----------------------------------------*
      *                      * Valori determinati direttamente da      *
      *                      * record [aaq]                            *
      *                      *-----------------------------------------*
           ...
           move      rf-aaq-cod-pdt       to   w-rig-cod-pdt          .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-ven-sos        to   w-rig-lot-ven          .
       car-eff-rig-sos-400.
      *              *-------------------------------------------------*
      *              * Fornitore preferenziale                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-pdt-sos        to   w-rig-cod-pdt          .
       car-eff-rig-sos-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-iva-sns    not  = zero or
                     ...
                     w-tes-lot-ven-sns    not  = zero or
                     w-tes-dcf-pfz-sns    not  = zero or
                     w-tes-cod-pdt-sns    not  = zero
      ...
      *                      *-----------------------------------------*
           move      w-rig-lot-ven        to   rf-dcp-lot-ven         .
           move      w-rig-cdn-cdm        to   rf-dcp-cdn-cdm         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "NUMPRO    "         to   f-key                  .
           move      01                   to   rf-aaq-tip-mag         .
           move      w-rig-num-pro        to   rf-aaq-num-pro         .
           move      "pgm/dcf/fls/ioc/obj/iofaaq"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-cod-pdt        to   rf-aaq-cod-pdt         .
       upd-rec-aaq-400.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           string    "Dati generali di acquisto prodotto "
                                delimited by size
                     w-rig-alf-pro
                                delimited by spaces
