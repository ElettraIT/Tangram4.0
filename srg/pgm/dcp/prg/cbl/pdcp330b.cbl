      ...
      *                       Ultima revisione:    NdK del 20/03/21    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Aggiornamenti automatici prezzi di listino  *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "AGGIORNAMENTI AUTOMATICI PREZZI LISTINO "       .
           ...
           05  w-exp-tip-arr.
               ...
               10  w-exp-tip-arr-tbl.
                   ...
                   15  filler             pic  x(20) value
                       "al valore Inferiore "                         .
      *        *-------------------------------------------------------*
      *        * Work per : Solo prodotti a listino                    *
      *        *-------------------------------------------------------*
           05  w-exp-snx-lst.
      ...
      *                  *---------------------------------------------*
       ...
       acc-key-reg-300.
      *                  *---------------------------------------------*
      *                  * Percentuale di aggiornamento da applicare   *
      *                  *---------------------------------------------*
       ...
       acc-key-reg-400.
      *                  *---------------------------------------------*
      *                  * Tipo arrotondamento da applicare            *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt per : Solo prodotti a listino                      *
      *    *-----------------------------------------------------------*
       pmt-snx-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-sgl-vlt-dec    to   w-sav-acc-dec-vlt      .
      *                  *---------------------------------------------*
      *                  * Lettura tabella [zls]                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Se ci sono variazioni rispetto ai valori    *
      *                  * che si riferiscono alla valuta : si nor-    *
      *                  * malizza il valore di arrotondamento         *
      *                  *---------------------------------------------*
           if        w-tes-sgl-vlt        not  = w-sav-acc-sgl-vlt or
                     w-tes-sgl-vlt-dec    not  = w-sav-acc-dec-vlt
      ...
      *                  *---------------------------------------------*
           perform   vis-sgl-vlt-des-000  thru vis-sgl-vlt-des-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore di arrotondamento    *
      *                  *---------------------------------------------*
           perform   vis-val-arr-000      thru vis-val-arr-999        .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se il tipo di aggiornamento indica solo *
      ...
      *    *===========================================================*
      *    * Accettazione : Solo prodotti a listino                    *
      *    *-----------------------------------------------------------*
       acc-snx-lst-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * sia su Up                                   *
      *                  *---------------------------------------------*
           if        w-tes-snx-lst        not  = zero
                     go to acc-snx-lst-500.
           if        v-key                =    "UP  "
                     go to acc-snx-lst-600
           else      go to acc-snx-lst-100.
       acc-snx-lst-500.
       acc-snx-lst-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Solo prodotti a listino                 *
      *    *-----------------------------------------------------------*
       vis-snx-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Accettazione Prezzo di listino              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo riga corpo espansa : Prezzo di listi-  *
      *    *                                         no attuale        *
      *    *-----------------------------------------------------------*
       acc-prz-lst-000.
      *              *-------------------------------------------------*
      ...
      *                  * Prezzo di listino pre-impostazione          *
      *                  *---------------------------------------------*
           move      rf-dcp-prz-lst       to   w-rig-pri-lst          .
      *                  *---------------------------------------------*
      *                  * Prezzo di listino impostato                 *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *
           move      01                   to   w-det-pbs-tip-rec      .
           move      w-tes-cod-lst        to   w-det-pbs-cod-lst      .
           move      zero                 to   w-det-pbs-cod-cli      .
      ...
      *              *-------------------------------------------------*
       car-fil-rap-510.
      *                  *---------------------------------------------*
      *                  * Lettura record su listino alternativo, e    *
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-lst                 .
           if        f-sts                =    e-not-err
                     go to car-fil-rap-530.
       car-fil-rap-520.
      *                  *---------------------------------------------*
      *                  * Se record su listino alternativo non esi-   *
      *                  * stente                                      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se solo prodotti a listino         *
      *                      *-----------------------------------------*
           if        w-tes-snx-lst        =    2
                     go to car-fil-rap-525.
      *                      *-----------------------------------------*
      *                      * A riciclo                               *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcp-num-pro       to   rf-lst-num-pro         .
      *                      *-----------------------------------------*
      *                      * Forzatura numero decimali valuta dal    *
      *                      * listino di testata                      *
      *                      *-----------------------------------------*
           move      w-tes-sgl-vlt-dec    to   rf-lst-dec-vlt         .
      *                      *-----------------------------------------*
      *                      * Forzatura prezzo a zero                 *
      *                      *-----------------------------------------*
           move      zero                 to   rf-lst-prz-lst         .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
           go to     car-fil-rap-550.
       car-fil-rap-530.
      *                  *---------------------------------------------*
      *                  * Se record su listino alternativo esistente  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
      ...
      *                  * % di provvigioni                            *
      *                  *---------------------------------------------*
           move      rf-lst-per-pvg (1)   to   w-rig-per-pvg (1)      .
           move      rf-lst-per-pvg (2)   to   w-rig-per-pvg (2)      .
           move      rf-lst-per-pvg (3)   to   w-rig-per-pvg (3)      .
      *                  *---------------------------------------------*
      *                  * % sconto                                    *
      *                  *---------------------------------------------*
           move      rf-lst-per-sco (1)   to   w-rig-per-sco (1)      .
           move      rf-lst-per-sco (2)   to   w-rig-per-sco (2)      .
           move      rf-lst-per-sco (3)   to   w-rig-per-sco (3)      .
           move      rf-lst-per-sco (4)   to   w-rig-per-sco (4)      .
           move      rf-lst-per-sco (5)   to   w-rig-per-sco (5)      .
      *                  *---------------------------------------------*
      *                  * Flags di si/no utilizzo                     *
      *                  *---------------------------------------------*
           move      rf-lst-snx-prz       to   w-rig-snx-prz          .
           move      rf-lst-snx-pvg       to   w-rig-snx-pvg          .
           move      rf-lst-snx-sco       to   w-rig-snx-sco          .
      *                  *---------------------------------------------*
      *                  * Data di validita' iniziale                  *
      *                  *---------------------------------------------*
      ...
      *                  * Area libera                                 *
      *                  *---------------------------------------------*
           move      rf-lst-alx-exp       to   w-rig-alx-exp          .
      *                  *---------------------------------------------*
      *                  * Prezzo di listino impostato                 *
      *                  *---------------------------------------------*
      ...
      *                  * cambio                                      *
      *                  *---------------------------------------------*
           move      w-rig-prz-lst        to   w-det-new-prz-old      .
           move      w-rig-dec-prz        to   w-det-new-prz-dec      .
      ...
      *              * di listino pre-impostazione : si ignora il re-  *
      *              * cord e si passa a quello successivo             *
      *              *-------------------------------------------------*
           if        w-rig-prz-lst        =    w-rig-pri-lst
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to sca-fil-rap-100.
      *                  *---------------------------------------------*
      *                  * Aggiornamento record con il nuovo prezzo di *
      *                  * listino                                     *
      *                  *---------------------------------------------*
           move      "IG"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
           ...
           move      w-rig-per-sco (1)    to   rf-dcp-per-scr (1)     .
           move      w-rig-per-sco (2)    to   rf-dcp-per-scr (2)     .
           move      w-rig-per-sco (3)    to   rf-dcp-per-scr (3)     .
           move      w-rig-per-sco (4)    to   rf-dcp-per-scr (4)     .
           move      w-rig-per-sco (5)    to   rf-dcp-per-scr (5)     .
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Aggiornamento record con il nuovo prez- *
      *                      * zo di listino, escludendo la composi-   *
      *                      * zione del numero decimali valuta, che   *
      *                      * non puo' essere variata                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-rig-num-pro        to   rf-lst-num-pro         .
      *                          *-------------------------------------*
      *                          * Composizione numero decimali valuta *
      *                          *-------------------------------------*
           move      w-rig-dec-vlt        to   rf-lst-dec-vlt         .
      *                          *-------------------------------------*
      *                          * Scrittura                           *
