      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcp1470: *
      *                                                                *
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-clm           to   rf-zkc-tip-clm         .
           move      rr-cod-min           to   rf-zkc-cod-clm         .
           move      "pgm/dcc/fls/ioc/obj/iofzkc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-clm           to   rf-zkc-tip-clm         .
           move      rr-des-min           to   rf-zkc-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-clm           to   rf-zkc-tip-clm         .
           move      rr-mne-min           to   rf-zkc-mne-clm         .
           move      zero                 to   rf-zkc-cod-clm         .
           move      "pgm/dcc/fls/ioc/obj/iofzkc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun codice marketing entro i limiti assegnati !
      -              " "                  to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zkc]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcc/fls/ioc/obj/iofzkc"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-zkc-tip-clm       not  = rr-tip-clm
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zkc-cod-clm       <    rr-cod-min or
                     rf-zkc-cod-clm       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zkc-des-key       <    rr-des-min or
                     rf-zkc-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zkc-mne-clm       <    rr-mne-min or
                     rf-zkc-mne-clm       >    rr-mne-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "CODICI MARKETING PRODOTTI"
