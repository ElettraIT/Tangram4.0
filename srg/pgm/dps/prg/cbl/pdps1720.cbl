      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdps1721:        *
      *                    Stampa codici statistici 1 semilavorati     *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zss-001-cod      .
           move      14                   to   w-cmn-zss-001-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zss-001-ope      .
           move      rr-cod-max           to   w-cmn-zss-001-cod      .
           move      14                   to   w-cmn-zss-001-lin      .
           move      52                   to   w-cmn-zss-001-pos      .
           move      zero                 to   w-cmn-zss-001-dln      .
           move      zero                 to   w-cmn-zss-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
