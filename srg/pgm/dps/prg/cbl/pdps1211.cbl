      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione Classi semilavorati          *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice classe semilavorati     *
      *    *-----------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-zs1-cla      .
           move      14                   to   w-cod-mne-zs1-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zs1-ope      .
           move      rr-cod-max           to   w-cod-mne-zs1-cla      .
           move      14                   to   w-cod-mne-zs1-lin      .
           move      52                   to   w-cod-mne-zs1-pos      .
           move      zero                 to   w-cod-mne-zs1-dln      .
           move      zero                 to   w-cod-mne-zs1-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zs1-cod-cla         .
           move      "pgm/dps/fls/ioc/obj/iofzs1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-zs1-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-mne-min           to   rf-zs1-mne-cla         .
           move      zero                 to   rf-zs1-cod-cla         .
           move      "pgm/dps/fls/ioc/obj/iofzs1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-sqz-min           to   rf-zs1-sqz-num         .
           move      zero                 to   rf-zs1-cod-cla         .
           move      "pgm/dps/fls/ioc/obj/iofzs1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessuna classe entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zs1]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dps/fls/ioc/obj/iofzs1"
                                          to   s-pat                  .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zs1-cod-cla       <    rr-cod-min or
                     rf-zs1-cod-cla       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zs1-des-key       <    rr-des-min or
                     rf-zs1-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zs1-mne-cla       <    rr-mne-min or
                     rf-zs1-mne-cla       >    rr-mne-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su numero di sequenza                 *
      *              *-------------------------------------------------*
           if        rf-zs1-sqz-num       <    rr-sqz-min or
                     rf-zs1-sqz-num       >    rr-sqz-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-zs1-cod-cla       to   w-mpn-cod-cla          .
           move      rf-zs1-des-cla       to   w-mpn-des-cla          .
           move      rf-zs1-ult-sud       to   w-mpn-ult-sud          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Controllo che la classe sia suddivisa in    *
      *                  * gruppi                                      *
      *                  *---------------------------------------------*
           move      v-cnt                to   w-mpn                  .
           if        w-mpn-ult-sud        =    02
                     go to qry-trt-fun-625.
           move      "La classe non e' suddivisa in gruppi              
      -              "      "             to   w-err-cnt-acc-msg      .
           perform   err-cnt-acc-000      thru err-cnt-acc-999        .
           go to     qry-trt-fun-999.
       qry-trt-fun-625.
      *                  *---------------------------------------------*
      *                  * Richiamo programma di interrogazione gruppi *
      ...
      *                          *-------------------------------------*
           ...
           move      40                   to   s-car                  .
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-des-cla        to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                      *-----------------------------------------*
      *                      * Richiamo effettivo programma            *
      *                      *-----------------------------------------*
           move      "pgm/dps/prg/obj/pdps1212"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat                                            .
      ...
      *                          * di ritorno per il codice classe at- *
      *                          * tuale                               *
      *                          *-------------------------------------*
           move      "PV"                 to   s-ope                  .
           move      "cod-cla"            to   s-var                  .
