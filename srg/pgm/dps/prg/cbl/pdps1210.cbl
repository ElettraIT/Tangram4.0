      ...
      *                    gruppi merceologici per semilavorati        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " INTERROG. CLASSIFICAZIONI SEMILAVORATI "       .
      ...
      *                  * Classe merceologica                         *
      *                  *---------------------------------------------*
           perform   acc-cla-sml-000      thru acc-cla-sml-999        .
      ...
      *                  * Gruppo merceologico                         *
      *                  *---------------------------------------------*
           perform   acc-gru-sml-000      thru acc-gru-sml-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           perform   acc-sgr-sml-000      thru acc-sgr-sml-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Salvataggio codice classe                   *
      *                  *---------------------------------------------*
           move      rr-cla-sml           to   w-sav-cod-cla          .
       acc-cla-sml-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zs1-ope      .
           move      rr-cla-sml           to   w-cod-mne-zs1-cla      .
           move      zero                 to   w-cod-mne-zs1-gru      .
           move      zero                 to   w-cod-mne-zs1-sgr      .
           move      05                   to   w-cod-mne-zs1-lin      .
           move      30                   to   w-cod-mne-zs1-pos      .
           move      05                   to   w-cod-mne-zs1-dln      .
       ...
       acc-cla-sml-110.
           ...
           if        w-cod-mne-zs1-ope    =    "F+"
                     go to acc-cla-sml-115.
           if        w-cod-mne-zs1-ope    =    "AC"
                     go to acc-cla-sml-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cla-sml-115.
           perform   cod-mne-zs1-foi-000  thru cod-mne-zs1-foi-999    .
           go to     acc-cla-sml-110.
       acc-cla-sml-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-cla-sml-999.
       acc-cla-sml-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-cla-sml             .
       acc-cla-sml-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rr-cla-sml           to   w-let-arc-zs1-cla      .
      ...
      *                   * - Numero di sequenza                       *
      *                   *--------------------------------------------*
           move      w-let-arc-zs1-des    to   rr-cla-sml-des         .
           move      w-let-arc-zs1-sud    to   rr-cla-sml-sud         .
           move      w-let-arc-zs1-sqz    to   rr-cla-sml-sqz         .
      *                   *--------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-cla-sml           =    zero
                     go to acc-cla-sml-625
           else      go to acc-cla-sml-650.
       acc-cla-sml-625.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-gru-sml           =    zero
                     go to acc-cla-sml-630.
           move      zero                 to   rr-gru-sml             .
           move      spaces               to   rr-gru-sml-des         .
           move      zero                 to   rr-gru-sml-sud         .
           move      zero                 to   rr-gru-sml-sqz         .
           perform   vis-gru-pro-000      thru vis-gru-pro-999        .
           perform   vis-des-gru-000      thru vis-des-gru-999        .
       acc-cla-sml-630.
           if        rr-sgr-sml           =    zero
                     go to acc-cla-sml-635.
           move      zero                 to   rr-sgr-sml             .
           move      spaces               to   rr-sgr-sml-des         .
           move      zero                 to   rr-sgr-sml-sud         .
           move      zero                 to   rr-sgr-sml-sqz         .
      ...
      *                      * ed il sottogruppo                       *
      *                      *-----------------------------------------*
           if        rr-cla-sml           not  = w-sav-cod-cla
                     go to acc-cla-sml-625.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rr-gru-sml           to   w-sav-cod-gru          .
       acc-gru-sml-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zs2-ope      .
           move      rr-cla-sml           to   w-cod-mne-zs2-cla      .
           move      rr-cla-sml-des       to   w-cod-mne-zs2-dcl      .
           move      rr-gru-sml           to   w-cod-mne-zs2-gru      .
           move      zero                 to   w-cod-mne-zs2-sgr      .
           move      07                   to   w-cod-mne-zs2-lin      .
           move      30                   to   w-cod-mne-zs2-pos      .
           move      07                   to   w-cod-mne-zs2-dln      .
       ...
       acc-gru-sml-110.
           ...
           if        w-cod-mne-zs2-ope    =    "F+"
                     go to acc-gru-sml-115.
           if        w-cod-mne-zs2-ope    =    "AC"
                     go to acc-gru-sml-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-gru-sml-115.
           perform   cod-mne-zs2-foi-000  thru cod-mne-zs2-foi-999    .
           go to     acc-gru-sml-110.
       acc-gru-sml-120.
      ...
      *                  *---------------------------------------------*
           move      rr-cla-sml           to   w-let-arc-zs2-cla      .
           move      rr-gru-sml           to   w-let-arc-zs2-gru      .
      ...
      *                   * - Numero di sequenza                       *
      *                   *--------------------------------------------*
           move      w-let-arc-zs2-des    to   rr-gru-sml-des         .
           move      w-let-arc-zs2-sud    to   rr-gru-sml-sud         .
           move      w-let-arc-zs2-sqz    to   rr-gru-sml-sqz         .
      *                   *--------------------------------------------*
      *                   * Visualizzazione descrizione                *
      *                   *--------------------------------------------*
           perform   vis-des-gru-000      thru vis-des-gru-999        .
      ...
      *                  *---------------------------------------------*
           if        rr-gru-sml           =    zero
                     go to acc-gru-sml-625
           else      go to acc-gru-sml-650.
       acc-gru-sml-625.
      *                  *---------------------------------------------*
      ...
      *                      * gruppo                                  *
      *                      *-----------------------------------------*
           if        rr-gru-sml           not  = w-sav-cod-gru
                     go to acc-gru-sml-625.
      *                      *-----------------------------------------*
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      rr-sgr-sml           to   w-sav-cod-sgr          .
       acc-sgr-sml-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zs3-ope      .
           move      rr-cla-sml           to   w-cod-mne-zs3-cla      .
           move      rr-cla-sml-des       to   w-cod-mne-zs3-dcl      .
           move      rr-gru-sml           to   w-cod-mne-zs3-gru      .
           move      rr-gru-sml-des       to   w-cod-mne-zs3-dgr      .
           move      rr-sgr-sml           to   w-cod-mne-zs3-sgr      .
       ...
       acc-sgr-sml-110.
           ...
           if        w-cod-mne-zs3-ope    =    "F+"
                     go to acc-sgr-sml-115.
           if        w-cod-mne-zs3-ope    =    "AC"
                     go to acc-sgr-sml-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-sgr-sml-115.
           perform   cod-mne-zs3-foi-000  thru cod-mne-zs3-foi-999    .
           go to     acc-sgr-sml-110.
       acc-sgr-sml-120.
      ...
      *                  *---------------------------------------------*
           move      rr-cla-sml           to   w-let-arc-zs3-cla      .
           move      rr-gru-sml           to   w-let-arc-zs3-gru      .
           move      rr-sgr-sml           to   w-let-arc-zs3-sgr      .
      ...
      *                   * - Numero di sequenza                       *
      *                   *--------------------------------------------*
           move      w-let-arc-zs3-des    to   rr-sgr-sml-des         .
           move      w-let-arc-zs3-sud    to   rr-sgr-sml-sud         .
           move      w-let-arc-zs3-sqz    to   rr-sgr-sml-sqz         .
      *                   *--------------------------------------------*
      *                   * Visualizzazione descrizione                *
      *                   *--------------------------------------------*
           perform   vis-des-sgr-000      thru vis-des-sgr-999        .
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           move      zero                 to   rr-cla-sml             .
           move      spaces               to   rr-cla-sml-des         .
           move      zero                 to   rr-cla-sml-sud         .
           move      zero                 to   rr-cla-sml-sqz         .
           move      zero                 to   rr-gru-sml             .
           move      spaces               to   rr-gru-sml-des         .
           move      zero                 to   rr-gru-sml-sud         .
           move      zero                 to   rr-gru-sml-sqz         .
