      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su tabella codice statisti-  *
      *                    co 2 per classificazione semilavorati       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE 2.COD. STAT. SEMILAVORATI"       .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su 2. codice statistico"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      40                   to   v-pos                  .
           move      rf-zss-des-cls       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zss-cod-cls       to   w-mpn-cod-cls          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "   2. CODICE STATISTICO SEMILAVORATI    "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Estrazione della eventuale variabile di i.p.c.  *
      *              * "des-cls" per la ragione sociale                *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
