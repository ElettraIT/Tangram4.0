      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dps192   *
      *                    Stampa codice statistico 3 semilavorati     *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zss-tip-cls         .
           move      rr-cod-min           to   rf-zss-cod-cls         .
           move      "pgm/dps/fls/ioc/obj/iofzss"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zss-tip-cls         .
           move      rr-des-min           to   rf-zss-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zss-tip-cls         .
           move      rr-mne-min           to   rf-zss-mne-cls         .
           move      zero                 to   rf-zss-cod-cls         .
           move      "pgm/dps/fls/ioc/obj/iofzss"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zss]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dps/fls/ioc/obj/iofzss"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-zss-tip-cls       not  = rr-tip-cls
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zss-cod-cls       <    rr-cod-min or
                     rf-zss-cod-cls       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zss-des-key       <    rr-des-min or
                     rf-zss-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zss-mne-cls       <    rr-mne-min or
                     rf-zss-mne-cls       >    rr-mne-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "CODICE STATISTICO 3 SEMILAVORATI"
