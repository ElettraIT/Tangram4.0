      ...
      *                    - Gruppi                                    *
      *                    - Sottogruppi                               *
      *                   per classificazioni gerarchiche semilavorati *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-enc-cod.
      *        *-------------------------------------------------------*
      *        * Per codice classe semilavorato                        *
      *        *-------------------------------------------------------*
           05  w-enc-cod-cla.
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Per codice gruppo semilavorato                        *
      *        *-------------------------------------------------------*
           05  w-enc-cod-gru.
      *            *---------------------------------------------------*
      *            * Codice classe                                     *
      ...
      *        *-------------------------------------------------------*
      *        * Per codice sottogruppo semilavorato                   *
      *        *-------------------------------------------------------*
           05  w-enc-cod-sgr.
      *            *---------------------------------------------------*
      *            * Codice classe                                     *
      ...
      *                          *-------------------------------------*
           move      w-tes-cod-cla        to   w-let-arc-zs1-cla      .
      ...
      *                          *-------------------------------------*
           move      w-let-arc-zs1-mne    to   w-tes-cod-cla-mne      .
           move      w-let-arc-zs1-des    to   w-tes-cod-cla-des      .
           move      w-let-arc-zs1-sud    to   w-tes-cod-cla-sud      .
           move      w-let-arc-zs1-umi    to   w-tes-cod-cla-umi      .
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cla        to   w-cod-mne-zs1-cla      .
           move      zero                 to   w-cod-mne-zs1-gru      .
           move      zero                 to   w-cod-mne-zs1-sgr      .
           move      05                   to   w-cod-mne-zs1-lin      .
           move      30                   to   w-cod-mne-zs1-pos      .
           if        w-tes-tip-ele        =    01
                     move  09             to   w-cod-mne-zs1-dln
                     move  30             to   w-cod-mne-zs1-dps
           else      move  05             to   w-cod-mne-zs1-dln
                     move  39             to   w-cod-mne-zs1-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *                          *-------------------------------------*
           move      w-tes-cod-cla        to   w-let-arc-zs2-cla      .
           move      w-tes-cod-gru        to   w-let-arc-zs2-gru      .
      ...
      *                          * - Unita' di misura da proporre      *
      *                          *-------------------------------------*
           move      w-let-arc-zs2-mne    to   w-tes-cod-gru-mne      .
           move      w-let-arc-zs2-des    to   w-tes-cod-gru-des      .
           move      w-let-arc-zs2-sud    to   w-tes-cod-gru-sud      .
           move      w-let-arc-zs2-umi    to   w-tes-cod-gru-umi      .
      *                          *-------------------------------------*
      *                          * Visualizzazione codice              *
      *                          *-------------------------------------*
           perform   vis-cod-gru-000      thru vis-cod-gru-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cla        to   w-cod-mne-zs2-cla      .
           move      w-tes-cod-cla-des    to   w-cod-mne-zs2-dcl      .
           move      w-tes-cod-gru        to   w-cod-mne-zs2-gru      .
           move      zero                 to   w-cod-mne-zs2-sgr      .
           move      06                   to   w-cod-mne-zs2-lin      .
           move      30                   to   w-cod-mne-zs2-pos      .
           if        w-tes-tip-ele        =    02
                     move  09             to   w-cod-mne-zs2-dln
                     move  30             to   w-cod-mne-zs2-dps
           else      move  06             to   w-cod-mne-zs2-dln
                     move  39             to   w-cod-mne-zs2-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *                          *-------------------------------------*
           move      w-tes-cod-cla        to   w-let-arc-zs3-cla      .
           move      w-tes-cod-gru        to   w-let-arc-zs3-gru      .
           move      w-tes-cod-sgr        to   w-let-arc-zs3-sgr      .
      ...
      *                          * - Unita' di misura da proporre      *
      *                          *-------------------------------------*
           move      w-let-arc-zs3-mne    to   w-tes-cod-sgr-mne      .
           move      w-let-arc-zs3-des    to   w-tes-cod-sgr-des      .
           move      w-let-arc-zs3-sud    to   w-tes-cod-sgr-sud      .
           move      w-let-arc-zs3-umi    to   w-tes-cod-sgr-umi      .
      *                          *-------------------------------------*
      *                          * Visualizzazione codice              *
      *                          *-------------------------------------*
           perform   vis-cod-sgr-000      thru vis-cod-sgr-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cla        to   w-cod-mne-zs3-cla      .
           move      w-tes-cod-cla-des    to   w-cod-mne-zs3-dcl      .
           move      w-tes-cod-gru        to   w-cod-mne-zs3-gru      .
           move      w-tes-cod-gru-des    to   w-cod-mne-zs3-dgr      .
           move      w-tes-cod-sgr        to   w-cod-mne-zs3-sgr      .
           move      07                   to   w-cod-mne-zs3-lin      .
           move      30                   to   w-cod-mne-zs3-pos      .
           move      09                   to   w-cod-mne-zs3-dln      .
           move      30                   to   w-cod-mne-zs3-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *                      *-----------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Unita' di misura da proporre per semilavorati  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-cla        to   rf-zs1-cod-cla         .
           move      "pgm/dps/fls/ioc/obj/iofzs1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Valori diretti                      *
      *                          *-------------------------------------*
           move      rf-zs1-des-cla       to   w-tes-des-cgs (1)      .
           move      rf-zs1-des-key       to   w-tes-des-key (1)      .
           move      rf-zs1-mne-cla       to   w-tes-mne-cgs (1)      .
           move      rf-zs1-sqz-num       to   w-tes-sqz-num (1)      .
           move      rf-zs1-ult-sud       to   w-tes-ult-sud (1)      .
           move      rf-zs1-umi-def       to   w-tes-umi-def (1)      .
           move      rf-zs1-ult-cod       to   w-tes-ult-cod (1)      .
           move      rf-zs1-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      *                          * Valori indiretti                    *
      *                          *-------------------------------------*
           move      w-tes-umi-def (1)    to   w-let-arc-zum-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-cla        to   rf-zs2-cod-cla         .
           move      w-tes-cod-gru        to   rf-zs2-cod-gru         .
           move      "pgm/dps/fls/ioc/obj/iofzs2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Valori diretti                      *
      *                          *-------------------------------------*
           move      rf-zs2-des-gru       to   w-tes-des-cgs (1)      .
           move      rf-zs2-des-key       to   w-tes-des-key (1)      .
           move      rf-zs2-mne-gru       to   w-tes-mne-cgs (1)      .
           move      rf-zs2-sqz-num       to   w-tes-sqz-num (1)      .
           move      rf-zs2-ult-sud       to   w-tes-ult-sud (1)      .
           move      rf-zs2-umi-def       to   w-tes-umi-def (1)      .
           move      rf-zs2-ult-cod       to   w-tes-ult-cod (1)      .
           move      rf-zs2-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      *                          * Valori indiretti                    *
      *                          *-------------------------------------*
           move      w-tes-umi-def (1)    to   w-let-arc-zum-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-cla        to   rf-zs3-cod-cla         .
           move      w-tes-cod-gru        to   rf-zs3-cod-gru         .
           move      w-tes-cod-sgr        to   rf-zs3-cod-sgr         .
           move      "pgm/dps/fls/ioc/obj/iofzs3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Valori diretti                      *
      *                          *-------------------------------------*
           move      rf-zs3-des-sgr       to   w-tes-des-cgs (1)      .
           move      rf-zs3-des-key       to   w-tes-des-key (1)      .
           move      rf-zs3-mne-sgr       to   w-tes-mne-cgs (1)      .
           move      rf-zs3-sqz-num       to   w-tes-sqz-num (1)      .
           move      rf-zs3-ult-sud       to   w-tes-ult-sud (1)      .
           move      rf-zs3-umi-def       to   w-tes-umi-def (1)      .
           move      rf-zs3-ult-cod       to   w-tes-ult-cod (1)      .
           move      rf-zs3-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      *                          * Valori indiretti                    *
      *                          *-------------------------------------*
           move      w-tes-umi-def (1)    to   w-let-arc-zum-cod      .
      ...
      *                      * Write record [zs1]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zs1-000      thru wrt-rec-zs1-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
      ...
      *                      * Rewrite record [zs1]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zs1-000      thru rew-rec-zs1-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Write record [zs2]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zs2-000      thru wrt-rec-zs2-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Rewrite record [zs2]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zs2-000      thru rew-rec-zs2-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Write record [zs3]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zs3-000      thru wrt-rec-zs3-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Rewrite record [zs3]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zs3-000      thru rew-rec-zs3-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                  * Delete record [zs1]                         *
      *                  *---------------------------------------------*
           perform   del-rec-zs1-000      thru del-rec-zs1-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *                  * Delete record [zs2]                         *
      *                  *---------------------------------------------*
           perform   del-rec-zs2-000      thru del-rec-zs2-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     del-mov-fil-999.
      ...
      *                  * Delete record [zs3]                         *
      *                  *---------------------------------------------*
           perform   del-rec-zs3-000      thru del-rec-zs3-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     del-mov-fil-999.
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-cgs (1)    to   rf-zs1-des-cla         .
           move      w-tes-mne-cgs (1)    to   rf-zs1-mne-cla         .
           move      w-tes-des-key (1)    to   rf-zs1-des-key         .
           move      w-tes-sqz-num (1)    to   rf-zs1-sqz-num         .
           move      w-tes-ult-sud (1)    to   rf-zs1-ult-sud         .
           move      w-tes-umi-def (1)    to   rf-zs1-umi-def         .
           move      w-tes-ult-cod (1)    to   rf-zs1-ult-cod         .
           move      w-tes-alx-exp (1)    to   rf-zs1-alx-exp         .
       cmp-rec-zs1-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zs1]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zs1-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zs1-000      thru cmp-rec-zs1-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-cgs (1)    to   rf-zs2-des-gru         .
           move      w-tes-mne-cgs (1)    to   rf-zs2-mne-gru         .
           move      w-tes-des-key (1)    to   rf-zs2-des-key         .
           move      w-tes-sqz-num (1)    to   rf-zs2-sqz-num         .
           move      w-tes-ult-sud (1)    to   rf-zs2-ult-sud         .
           move      w-tes-umi-def (1)    to   rf-zs2-umi-def         .
           move      w-tes-ult-cod (1)    to   rf-zs2-ult-cod         .
           move      w-tes-alx-exp (1)    to   rf-zs2-alx-exp         .
       cmp-rec-zs2-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zs2]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zs2-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zs2-000      thru cmp-rec-zs2-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-cgs (1)    to   rf-zs3-des-sgr         .
           move      w-tes-mne-cgs (1)    to   rf-zs3-mne-sgr         .
           move      w-tes-des-key (1)    to   rf-zs3-des-key         .
           move      w-tes-sqz-num (1)    to   rf-zs3-sqz-num         .
           move      w-tes-ult-sud (1)    to   rf-zs3-ult-sud         .
           move      w-tes-umi-def (1)    to   rf-zs3-umi-def         .
           move      w-tes-ult-cod (1)    to   rf-zs3-ult-cod         .
           move      w-tes-alx-exp (1)    to   rf-zs3-alx-exp         .
       cmp-rec-zs3-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zs3]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zs3-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zs3-000      thru cmp-rec-zs3-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cla-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zs1]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zs1 "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      w-enc-cod-cla-pos    to   rf-zs1-cod-cla         .
           move      "pgm/dps/fls/ioc/obj/iofzs1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      w-enc-cod-gru-cla    to   rf-zs1-cod-cla         .
           move      "pgm/dps/fls/ioc/obj/iofzs1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       att-gru-aut-250.
           ...
           move      "RK"                 to   f-ope                  .
           move      "CODGRU    "         to   f-key                  .
           move      w-enc-cod-gru-cla    to   rf-zs2-cod-cla         .
           move      w-enc-cod-gru-pos    to   rf-zs2-cod-gru         .
           move      "pgm/dps/fls/ioc/obj/iofzs2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Memorizzazione del valore pre incremento    *
      *                  *---------------------------------------------*
           move      rf-zs1-ult-cod       to   w-enc-cod-gru-pre      .
      *                  *---------------------------------------------*
      *                  * Incremento del valore                       *
      *                  *---------------------------------------------*
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-gru-pos    to   rf-zs1-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/dps/fls/ioc/obj/iofzs1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * re post incremento                          *
      *                  *---------------------------------------------*
           if        rf-zs1-ult-cod       =    w-enc-cod-gru-pos
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-gru-pre    to   rf-zs1-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/dps/fls/ioc/obj/iofzs1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODGRU    "         to   f-key                  .
           move      w-enc-cod-sgr-cla    to   rf-zs2-cod-cla         .
           move      w-enc-cod-sgr-gru    to   rf-zs2-cod-gru         .
           move      "pgm/dps/fls/ioc/obj/iofzs2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       att-sgr-aut-250.
           ...
           move      "RK"                 to   f-ope                  .
           move      "CODSGR    "         to   f-key                  .
           move      w-enc-cod-sgr-cla    to   rf-zs3-cod-cla         .
           move      w-enc-cod-sgr-gru    to   rf-zs3-cod-gru         .
           move      w-enc-cod-sgr-pos    to   rf-zs3-cod-sgr         .
           move      "pgm/dps/fls/ioc/obj/iofzs3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Memorizzazione del valore pre incremento    *
      *                  *---------------------------------------------*
           move      rf-zs2-ult-cod       to   w-enc-cod-sgr-pre      .
      *                  *---------------------------------------------*
      *                  * Incremento del valore                       *
      *                  *---------------------------------------------*
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-sgr-pos    to   rf-zs2-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/dps/fls/ioc/obj/iofzs2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * re post incremento                          *
      *                  *---------------------------------------------*
           if        rf-zs2-ult-cod       =    w-enc-cod-sgr-pos
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-sgr-pre    to   rf-zs2-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/dps/fls/ioc/obj/iofzs2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODGRU    "         to   f-key                  .
           move      w-det-gru-cla-cla    to   rf-zs2-cod-cla         .
      ...
      *              *-------------------------------------------------*
           if        rf-zs2-cod-cla       not  = w-det-gru-cla-cla
                     go to det-gru-cla-900.
       det-gru-cla-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODSGR    "         to   f-key                  .
           move      w-det-sgr-gru-cla    to   rf-zs3-cod-cla         .
           move      w-det-sgr-gru-gru    to   rf-zs3-cod-gru         .
      ...
      *              * Max su gruppi della classe                      *
      *              *-------------------------------------------------*
           if        rf-zs3-cod-cla       not  = w-det-sgr-gru-cla or
                     rf-zs3-cod-gru       not  = w-det-sgr-gru-gru
                     go to det-sgr-gru-900.
       det-sgr-gru-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-ctl-uni-nrs-nrs    to   rf-zs1-sqz-num         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-zs1-sqz-num       not  = w-ctl-uni-nrs-nrs
                     go to ctl-uni-nrs-600.
      *                  *---------------------------------------------*
      *                  * Se codice classe letto diverso da quello    *
      *                  * passato incremento il contatore             *
      *                  *---------------------------------------------*
           if        rf-zs1-cod-cla       not  = w-ctl-uni-nrs-cla
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      w-ctl-uni-nrs-cla    to   rf-zs2-cod-cla         .
           move      w-ctl-uni-nrs-nrs    to   rf-zs2-sqz-num         .
           move      zero                 to   rf-zs2-cod-gru         .
           move      "pgm/dps/fls/ioc/obj/iofzs2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-zs2-cod-cla       not  = w-ctl-uni-nrs-cla or
                     rf-zs2-sqz-num       not  = w-ctl-uni-nrs-nrs
                     go to ctl-uni-nrs-600.
      *                  *---------------------------------------------*
      *                  * Se codice gruppo letto diverso da quello    *
      *                  * passato incremento il contatore             *
      *                  *---------------------------------------------*
           if        rf-zs2-cod-gru       not  = w-ctl-uni-nrs-gru
                     add   1              to   w-ctl-uni-nrs-ctr      .
      *                  *---------------------------------------------*
      *                  * Riciclo in lettura                          *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      w-ctl-uni-nrs-cla    to   rf-zs3-cod-cla         .
           move      w-ctl-uni-nrs-gru    to   rf-zs3-cod-gru         .
           move      w-ctl-uni-nrs-nrs    to   rf-zs3-sqz-num         .
           move      zero                 to   rf-zs3-cod-sgr         .
           move      "pgm/dps/fls/ioc/obj/iofzs3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-zs3-cod-cla       not  = w-ctl-uni-nrs-cla or
                     rf-zs3-cod-gru       not  = w-ctl-uni-nrs-gru or
                     rf-zs3-sqz-num       not  = w-ctl-uni-nrs-nrs
                     go to ctl-uni-nrs-600.
      *                  *---------------------------------------------*
      *                  * Se codice sottogruppo letto diverso da quel-*
      *                  * lo passato incremento il contatore          *
      *                  *---------------------------------------------*
           if        rf-zs3-cod-sgr       not  = w-ctl-uni-nrs-sgr
                     add   1              to   w-ctl-uni-nrs-ctr      .
      *                  *---------------------------------------------*
      *                  * Riciclo in lettura                          *
      *                  *---------------------------------------------*
