      ...
      *                                                                *
      *              Input  : w-cmn-zss-003-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cmn-zss-003-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cmn-zss-003-ope : "AC"                 *
      *                                                                *
      *                       w-cmn-zss-003-cod : codice statistico 3  *
      *                                                                *
      *                       w-cmn-zss-003-lin : linea codice         *
      *                                                                *
      *                       w-cmn-zss-003-pos : posizione codice     *
      *                                                                *
      *                       w-cmn-zss-003-dln : linea descrizione    *
      *                                                                *
      *                       w-cmn-zss-003-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cmn-zss-003-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cmn-zss-003-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cmn-zss-003-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cmn-zss-003-cod : codice statistico 3  *
      ...
      ******************************************************************
       Procedure Division                using w-cmn-zss-003
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cmn-zss-003-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cmn-zss-003-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cmn-zss-003-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cmn-zss-003-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cmn-zss-003-ope    =    "A+" or
                     w-cmn-zss-003-ope    =    "I+" or
                     w-cmn-zss-003-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cmn-zss-003-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      w-cmn-zss-003-cod    to   w-cmn-zss-003-num      .
           move      v-edm                to   w-cmn-zss-003-edm      .
           move      v-ufk                to   w-cmn-zss-003-ufk      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cmn-zss-003-edm    to   v-edm                  .
           move      w-cmn-zss-003-num    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-edt                to   w-cmn-zss-003-alf      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cmn-zss-003-ufk    to   v-ufk                  .
           move      w-cmn-zss-003-lin    to   v-lin                  .
           move      w-cmn-zss-003-pos    to   v-pos                  .
           move      w-cmn-zss-003-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cmn-zss-003-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      v-alf                to   w-cmn-zss-003-alf      .
      *              *-------------------------------------------------*
      *              * Test se Exit o Delt                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-cmn-zss-003-num    to   w-cmn-zss-003-cod      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           move      zero                 to   w-cmn-zss-003-dln      .
           move      zero                 to   w-cmn-zss-003-dps      .
           go to     aco-999.
       aco-100.
      *              *-------------------------------------------------*
      *              * Se rientro da Find                              *
      ...
      *                      *-----------------------------------------*
           move      s-num                to   w-cmn-zss-003-num      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-cmn-zss-003-alf    =    spaces
                     move  zero           to   w-cmn-zss-003-num
                     go to aco-075.
           if        w-cmn-zss-003-cha (1)
                                          =    spaces
                     go to aco-025.
      ...
      *              *-------------------------------------------------*
       ...
       aco-181.
           ...
           if        w-cmn-zss-003-cha
                    ...
                    (w-aux-mne-zss-c01)   >    "9"
                     go to aco-225.
           multiply  10                   by   w-cmn-zss-003-num      .
           move      w-cmn-zss-003-cha
                    (w-aux-mne-zss-c01)   to   w-cmn-zss-003-chn (05) .
           go to     aco-181.
       aco-200.
      *              *-------------------------------------------------*
      ...
      *                  * merico : uscita                             *
      *                  *---------------------------------------------*
           if        v-edt                =    w-cmn-zss-003-alf
                     go to aco-075
      *                  *---------------------------------------------*
      *                  * Altrimenti : rivisualizzazione              *
      *                  *---------------------------------------------*
           else      move  v-edt          to   w-cmn-zss-003-alf
                     go to aco-050.
       aco-225.
      *              *-------------------------------------------------*
      ...
      *                  * scrizione                                   *
      *                  *---------------------------------------------*
           if        w-cmn-zss-003-alf    =    "-" and
                     w-cmn-zss-003-dln    not  = zero
                     go to aco-500.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-cmn-zss-003-alf    to   rf-zss-mne-cls         .
      ...
      *                      *-----------------------------------------*
           if        w-aux-mne-zss-m05    not  = w-cmn-zss-003-alf
                     go to aco-250.
      *                      *-----------------------------------------*
      ...
      *                      * non trovato                             *
      *                      *-----------------------------------------*
           if        w-cmn-zss-003-dln    =    zero
                     go to aco-278.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      20                   to   v-car                  .
           move      w-cmn-zss-003-dln    to   v-lin                  .
           move      w-cmn-zss-003-dps    to   v-pos                  .
           move      all   "."            to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-278.
      ...
      *                      *-----------------------------------------*
       ...
       aco-382.
           ...
           move      w-aux-mne-zss-cbu
                    (w-aux-mne-zss-c01)   to   w-cmn-zss-003-num      .
           go to     aco-200.
       aco-384.
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      05                   to   s-car                  .
           move      w-cmn-zss-003-alf    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           go to     aco-125.
       aco-500.
