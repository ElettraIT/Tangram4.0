           ...
           05  w-exp-tip-ord.
               ...
               10  w-exp-tip-ord-tbl.
                   15  filler             pic  x(40) value
                            "Classe, gruppo, sottogr., cod. semilav. ".
                   15  filler             pic  x(40) value
                            "Classe, gruppo, sottogr., desc. semil.. ".
                   15  filler             pic  x(40) value
                            "Codice semilavorato                     ".
                   15  filler             pic  x(40) value
      ...
      *              *-------------------------------------------------*
      *              * Open modulo accettazione codice semilav. 'dps'  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Preparazione tipo record con : 'dps'            *
      *              *-------------------------------------------------*
           move      "dps "               to   w-tes-tip-rec          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Close modulo accettazione codice semilav. 'dps' *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-flt        to   w-cod-zos-dps-cod      .
           move      04                   to   w-cod-zos-dps-lin      .
           move      30                   to   w-cod-zos-dps-pos      .
           move      06                   to   w-cod-zos-dps-dln      .
           move      30                   to   w-cod-zos-dps-dps      .
           move      "<B"                 to   v-edm                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Tipo semilavorato                *
      *    *-----------------------------------------------------------*
       pmt-tip-sem-000.
       pmt-tip-sem-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cla-min (1)    to   w-cod-mne-zs1-cla      .
           move      15                   to   w-cod-mne-zs1-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zs1-ope      .
           move      w-tes-cla-max (1)    to   w-cod-mne-zs1-cla      .
           move      15                   to   w-cod-mne-zs1-lin      .
           move      54                   to   w-cod-mne-zs1-pos      .
           move      zero                 to   w-cod-mne-zs1-dln      .
           move      zero                 to   w-cod-mne-zs1-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cla-min (1)    to   w-cod-mne-zs2-cla      .
           move      w-tes-gru-min (1)    to   w-cod-mne-zs2-gru      .
           move      16                   to   w-cod-mne-zs2-lin      .
           move      30                   to   w-cod-mne-zs2-pos      .
           move      zero                 to   w-cod-mne-zs2-dln      .
           move      zero                 to   w-cod-mne-zs2-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zs2-ope      .
           move      w-tes-cla-max (1)    to   w-cod-mne-zs2-cla      .
           move      w-tes-gru-max (1)    to   w-cod-mne-zs2-gru      .
           move      16                   to   w-cod-mne-zs2-lin      .
           move      54                   to   w-cod-mne-zs2-pos      .
           move      zero                 to   w-cod-mne-zs2-dln      .
           move      zero                 to   w-cod-mne-zs2-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cla-min (1)    to   w-cod-mne-zs3-cla      .
           move      w-tes-gru-min (1)    to   w-cod-mne-zs3-gru      .
           move      w-tes-sgr-min (1)    to   w-cod-mne-zs3-sgr      .
           move      17                   to   w-cod-mne-zs3-lin      .
           move      30                   to   w-cod-mne-zs3-pos      .
           move      zero                 to   w-cod-mne-zs3-dln      .
           move      zero                 to   w-cod-mne-zs3-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zs3-ope      .
           move      w-tes-cla-max (1)    to   w-cod-mne-zs3-cla      .
           move      w-tes-gru-max (1)    to   w-cod-mne-zs3-gru      .
           move      w-tes-sgr-max (1)    to   w-cod-mne-zs3-sgr      .
           move      17                   to   w-cod-mne-zs3-lin      .
           move      54                   to   w-cod-mne-zs3-pos      .
           move      zero                 to   w-cod-mne-zs3-dln      .
           move      zero                 to   w-cod-mne-zs3-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-min (1)    to   w-cod-cod-dps-alf      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "L"                  to   w-cod-cod-dps-tac      .
           move      zero                 to   w-cod-cod-dps-num      .
           move      w-tes-cod-max (1)    to   w-cod-cod-dps-alf      .
           move      19                   to   w-cod-cod-dps-lin      .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Tipo semilavorato            *
      *    *-----------------------------------------------------------*
       acc-tip-sem-000.
       acc-tip-sem-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Tipo semilavorato         *
      *    *-----------------------------------------------------------*
       vis-tip-sem-000.
       vis-tip-sem-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-cmn-zss-001-lin      .
           move      30                   to   w-cmn-zss-001-pos      .
           move      11                   to   w-cmn-zss-001-dln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      15                   to   w-cmn-zss-003-lin      .
           move      30                   to   w-cmn-zss-003-pos      .
           move      15                   to   w-cmn-zss-003-dln      .
      ...
      *              *-------------------------------------------------*
      *              * Normalizzazione dati per area specifica 'dps'   *
      *              *-------------------------------------------------*
           move      zero                 to   w-zos-dps-tip-ord      .
           move      zero                 to   w-zos-dps-cla-min      .
           move      zero                 to   w-zos-dps-cla-max      .
           move      zero                 to   w-zos-dps-gru-min      .
           move      zero                 to   w-zos-dps-gru-max      .
           move      zero                 to   w-zos-dps-sgr-min      .
           move      zero                 to   w-zos-dps-sgr-max      .
           move      spaces               to   w-zos-dps-alf-min      .
           move      spaces               to   w-zos-dps-alf-max      .
           move      spaces               to   w-zos-dps-des-min      .
           move      spaces               to   w-zos-dps-des-max      .
      ...
      *                          *-------------------------------------*
           ...
           move      w-zos-dps-tip-ord    to   w-tes-tip-ord (1)      .
           move      w-zos-dps-cla-min    to   w-tes-cla-min (1)      .
           move      w-zos-dps-cla-max    to   w-tes-cla-max (1)      .
           move      w-zos-dps-gru-min    to   w-tes-gru-min (1)      .
           move      w-zos-dps-gru-max    to   w-tes-gru-max (1)      .
           move      w-zos-dps-sgr-min    to   w-tes-sgr-min (1)      .
           move      w-zos-dps-sgr-max    to   w-tes-sgr-max (1)      .
           move      w-zos-dps-alf-min    to   w-tes-cod-min (1)      .
           move      w-zos-dps-alf-max    to   w-tes-cod-max (1)      .
           move      w-zos-dps-des-min    to   w-tes-des-min (1)      .
           move      w-zos-dps-des-max    to   w-tes-des-max (1)      .
           move      w-zos-dps-tip-sem    to   w-tes-tip-sem (1)      .
           if        w-tes-tip-sem (1)    =    00
                     move  99             to   w-tes-tip-sem (1)      .
           move      w-zos-dps-umi-prd    to   w-tes-umi-prd (1)      .
           move      w-zos-dps-cod-s01    to   w-tes-cod-s01 (1)      .
           move      w-zos-dps-cod-s02    to   w-tes-cod-s02 (1)      .
           move      w-zos-dps-cod-s03    to   w-tes-cod-s03 (1)      .
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   w-zos-dps              .
           move      w-tes-tip-ord (1)    to   w-zos-dps-tip-ord      .
           move      w-tes-cla-min (1)    to   w-zos-dps-cla-min      .
           move      w-tes-cla-max (1)    to   w-zos-dps-cla-max      .
           move      w-tes-gru-min (1)    to   w-zos-dps-gru-min      .
           move      w-tes-gru-max (1)    to   w-zos-dps-gru-max      .
           move      w-tes-sgr-min (1)    to   w-zos-dps-sgr-min      .
           move      w-tes-sgr-max (1)    to   w-zos-dps-sgr-max      .
           move      w-tes-cod-min (1)    to   w-zos-dps-alf-min      .
           move      w-tes-cod-max (1)    to   w-zos-dps-alf-max      .
           move      w-tes-des-min (1)    to   w-zos-dps-des-min      .
           move      w-tes-des-max (1)    to   w-zos-dps-des-max      .
           move      w-tes-tip-sem (1)    to   w-zos-dps-tip-sem      .
           if        w-zos-dps-tip-sem    =    99
                     move  00             to   w-zos-dps-tip-sem      .
           move      w-tes-umi-prd (1)    to   w-zos-dps-umi-prd      .
           move      w-tes-cod-s01 (1)    to   w-zos-dps-cod-s01      .
           move      w-tes-cod-s02 (1)    to   w-zos-dps-cod-s02      .
           move      w-tes-cod-s03 (1)    to   w-zos-dps-cod-s03      .
           move      w-zos-dps            to   rf-zos-dat-flt         .
       cmp-rec-zos-999.
           exit.
