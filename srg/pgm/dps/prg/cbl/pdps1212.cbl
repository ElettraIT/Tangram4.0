      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione Gruppi semilavorati          *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           05  rr-cod-cla                 pic  9(05)                  .
           05  rr-des-cla                 pic  x(40)                  .
           ...
           05  rr-sqz-min                 pic  9(07)                  .
           05  rr-sqz-max                 pic  9(07)                  .
      ...
      *                * Codice classe                                 *
      *                *-----------------------------------------------*
                   15  w-ipc-dlp-tdi-ccl  pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Descrizione classe                            *
      *                *-----------------------------------------------*
                   15  w-ipc-dlp-tdi-dcl  pic  x(40)                  .
      *                *-----------------------------------------------*
      *                * Mnemonico                                     *
      *                *-----------------------------------------------*
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice gruppo semilavorati     *
      *    *-----------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-cod-gru              pic  9(05)                  .
           05  w-mpn-des-gru              pic  x(40)                  .
           05  w-mpn-ult-sud              pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
      *              * Se tipo interrogazione errato : uscita dal pro- *
      *              * gramma                                          *
      *              *-------------------------------------------------*
           if        w-ipc-dlp-tdi-tip    not  = "X" and
                     w-ipc-dlp-tdi-tip    not  = "M" and
                     w-ipc-dlp-tdi-tip    not  = "D"
      ...
      *                  *---------------------------------------------*
           move      w-ipc-dlp-tdi-ccl    to   rr-cod-cla             .
           move      w-ipc-dlp-tdi-dcl    to   rr-des-cla             .
           ...
           move      zero                 to   rr-sqz-min             .
           move      zero                 to   rr-sqz-max             .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *                  * Nr di sequenza min                          *
      *                  *---------------------------------------------*
           perform   acc-sqz-min-000      thru acc-sqz-min-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Nr di sequenza max                          *
      *                  *---------------------------------------------*
           perform   acc-sqz-max-000      thru acc-sqz-max-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-cla           to   w-cod-mne-zs2-cla      .
           move      rr-des-cla           to   w-cod-mne-zs2-dcl      .
           move      rr-cod-min           to   w-cod-mne-zs2-gru      .
           move      17                   to   w-cod-mne-zs2-lin      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-cla           to   w-cod-mne-zs2-cla      .
           move      rr-des-cla           to   w-cod-mne-zs2-dcl      .
           move      rr-cod-max           to   w-cod-mne-zs2-gru      .
           move      17                   to   w-cod-mne-zs2-lin      .
           move      52                   to   w-cod-mne-zs2-pos      .
           move      zero                 to   w-cod-mne-zs2-dln      .
           move      zero                 to   w-cod-mne-zs2-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Numero di sequenza minimo  *
      *    *-----------------------------------------------------------*
       acc-sqz-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-sqz-min-999.
       acc-sqz-min-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-sqz-min             .
       acc-sqz-min-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-sqz-min-100.
       acc-sqz-min-999.
           exit.

      *    *===========================================================*
      *    * Accettazione campo selezione : Numero di sequenza massimo *
      *    *-----------------------------------------------------------*
       acc-sqz-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-sqz-max-999.
       acc-sqz-max-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-sqz-max             .
       acc-sqz-max-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "ice minimo !"       to   v-not                  .
       ...
       tdo-ric-sel-400.
      *              *-------------------------------------------------*
      *              * Controllo su nr di sequenza minimo e massimo    *
      *              *-------------------------------------------------*
           if        rr-sqz-max           =    zero
                     go to tdo-ric-sel-999.
           if        rr-sqz-max           not  < rr-sqz-min
                     go to tdo-ric-sel-999.
           move      "ME"                 to   v-ope                  .
           move      "Il numero di sequenza massimo non puo' essere infe
      -              "riore al minimo !"  to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
           go to     tdo-ric-sel-999.
      ...
      *              *-------------------------------------------------*
       ...
       reg-ric-sel-300.
      *              *-------------------------------------------------*
      *              * Regolarizzazione nr sezuenza min - max          *
      *              *-------------------------------------------------*
           if        rr-sqz-max           not  = zero
                     go to reg-ric-sel-999.
           if        rr-sqz-min           =    zero
                     move  9999999        to   rr-sqz-max
           else      move  rr-sqz-min     to   rr-sqz-max             .
       reg-ric-sel-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zs2-cod-cla         .
           move      rr-cod-min           to   rf-zs2-cod-gru         .
           move      "pgm/dps/fls/ioc/obj/iofzs2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zs2-cod-cla         .
           move      rr-des-min           to   rf-zs2-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zs2-cod-cla         .
           move      rr-mne-min           to   rf-zs2-mne-gru         .
           move      zero                 to   rf-zs2-cod-gru         .
           move      "pgm/dps/fls/ioc/obj/iofzs2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
       ...
       qry-str-ini-800.
      *              *-------------------------------------------------*
      *              * Se ordinamento per numero di sequenza           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Start per numero di sequenza                *
      *                  *---------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      rr-cod-cla           to   rf-zs2-cod-cla         .
           move      rr-sqz-min           to   rf-zs2-sqz-num         .
           move      zero                 to   rf-zs2-cod-gru         .
           move      "pgm/dps/fls/ioc/obj/iofzs2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun gruppo entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zs2]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dps/fls/ioc/obj/iofzs2"
                                          to   s-pat                  .
      ...
      *              * Se ordinamento per codice                       *
      *              *-------------------------------------------------*
           if        rf-zs2-cod-cla       not  = rr-cod-cla
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           if        rf-zs2-cod-gru       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           go to     qry-tst-max-999.
       qry-tst-max-400.
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zs2-cod-gru       <    rr-cod-min or
                     rf-zs2-cod-gru       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zs2-des-key       <    rr-des-min or
                     rf-zs2-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zs2-mne-gru       <    rr-mne-min or
                     rf-zs2-mne-gru       >    rr-mne-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su numero di sequenza                 *
      *              *-------------------------------------------------*
           if        rf-zs2-sqz-num       <    rr-sqz-min or
                     rf-zs2-sqz-num       >    rr-sqz-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-zs2-cod-gru       to   w-mpn-cod-gru          .
           move      rf-zs2-des-gru       to   w-mpn-des-gru          .
           move      rf-zs2-ult-sud       to   w-mpn-ult-sud          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              * Function key Find                               *
      *              *-------------------------------------------------*
           if        w-ipc-dlp-tdi-tip    not  = "X"
                     move  spaces         to   v-pfk(03)
                     go to qry-det-fky-500.
           move      "P?"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-gru'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Controllo che il gruppo sia suddivisa in    *
      *                  * sottogruppi                                 *
      *                  *---------------------------------------------*
           move      v-cnt                to   w-mpn                  .
           if        w-mpn-ult-sud        =    02
                     go to qry-trt-fun-625.
           move      "Il gruppo non e' suddivisa in sottogruppi         
      -              "      "             to   w-err-cnt-acc-msg      .
           perform   err-cnt-acc-000      thru err-cnt-acc-999        .
           go to     qry-trt-fun-999.
       qry-trt-fun-625.
      *                  *---------------------------------------------*
      *                  * Richiamo programma di interrogazione sotto- *
      *                  * gruppi appartenenti al gruppo               *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Preparazione variabili per interroga-   *
      *                      * zione sottogruppi                       *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Tipo interrogazione : 'X'           *
      *                          *-------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *                          *-------------------------------------*
           ...
           move      40                   to   s-car                  .
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-des-gru        to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                      *-----------------------------------------*
      *                      * Richiamo effettivo programma            *
      *                      *-----------------------------------------*
           move      "pgm/dps/prg/obj/pdps1213"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat                                            .
           cancel    s-pat                                            .
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda se il programma di in- *
      *                  * terrogazione ha restituito variabili di se- *
      *                  * lezione effettuata oppure no                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Estrazione i.p.c. di selezione per il   *
      *                      * sottogruppo                             *
      *                      *-----------------------------------------*
           move      "CV"                 to   s-ope                  .
      ...
      *                          * di ritorno per il codice gruppo at- *
      *                          * tuale                               *
      *                          *-------------------------------------*
           move      "PV"                 to   s-ope                  .
           move      "cod-gru"            to   s-var                  .
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                          *-------------------------------------*
      *                          * Segnale di interruzione interroga-  *
      *                          * zione                               *
      *                          *-------------------------------------*
           move      "#"                  to   w-cnt-qry-flg-int      .
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       int-pag-sta-300.
      *              *-------------------------------------------------*
      *              * Test su tipo di interrogazione                  *
      *              *-------------------------------------------------*
           if        w-ipc-dlp-tdi-tip    not  = "X"
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-ipc-dlp-tdi-ccl      .
           move      spaces               to   w-ipc-dlp-tdi-dcl      .
      ...
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del valore della varia-  *
      *              * bile di i.p.c. "tip-int"                        *
      *              *-------------------------------------------------*
           if        s-alf                =    "X"
       ...
       ipc-dlp-tdi-200.
      *              *-------------------------------------------------*
      *              * Se variabile di i.p.c. "tip-int" pari a "X"     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Estrazione della variabile "cod-cla"        *
      *                  *---------------------------------------------*
           move      "CV"                 to   s-ope                  .
           move      "cod-cla"            to   s-var                  .
           move      "-"                  to   s-dop                  .
           ...
           if        s-ves                not  = spaces
                     go to ipc-dlp-tdi-999.
           move      s-num                to   w-ipc-dlp-tdi-ccl      .
           if        w-ipc-dlp-tdi-ccl    =    zero
                     go to ipc-dlp-tdi-999.
      *                  *---------------------------------------------*
      *                  * Estrazione della variabile "des-cla"        *
      *                  *---------------------------------------------*
           move      "CV"                 to   s-ope                  .
           move      "des-cla"            to   s-var                  .
           move      "-"                  to   s-dop                  .
           ...
           move      s-alf                to   w-ipc-dlp-tdi-dcl      .
      *                  *---------------------------------------------*
      *                  * Tipo interrogazione a 'X'                   *
      *                  *---------------------------------------------*
           move      "X"                  to   w-ipc-dlp-tdi-tip      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ipc-dlp-tdi-999.
      ...
      *                  *---------------------------------------------*
           ...
           if        w-ipc-dlp-tdi-ccl    =    zero
                     go to ipc-dlp-tdi-999.
      *                  *---------------------------------------------*
      *                  * Estrazione della variabile "cod-mne"        *
      *                  *---------------------------------------------*
           move      "CV"                 to   s-ope                  .
           ...
           if        w-ipc-dlp-tdi-mne    =    spaces
                     go to ipc-dlp-tdi-999.
      *                  *---------------------------------------------*
      *                  * Tipo interrogazione a 'M'                   *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-ipc-dlp-tdi-des    =    spaces
                     go to ipc-dlp-tdi-999.
      *                  *---------------------------------------------*
      *                  * Tipo interrogazione a 'D'                   *
      *                  *---------------------------------------------*
