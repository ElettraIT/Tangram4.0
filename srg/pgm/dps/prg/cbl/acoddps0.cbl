      ...
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione codice semilavorato     *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-cod-dps-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-dps-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-cod-dps-ope : "AC"                 *
      *                                                                *
      *                       w-cod-cod-dps-tac : Tipo accettazione    *
      *                                           - N : Numerico       *
      *                                           - A : Alfanumerico   *
      *                                           - S : Sinonimo       *
      *                                           - L : Libera, alfa-  *
      ...
      *                                                 controllata    *
      *                                                                *
      *                       w-cod-cod-dps-num : Codice numerico      *
      *                                             Solo se tipo ac-   *
      *                                             cettazione 'N' o   *
      *                                             tipo acc.  'A'     *
      *                                                                *
      *                       w-cod-cod-dps-alf : Codice alfanumerico  *
      *                                             Inutile se tipo    *
      *                                             accettazione 'N'   *
      *                                                                *
      *                       w-cod-cod-dps-lin : linea a video        *
      *                                                                *
      *                       w-cod-cod-dps-pos : posizione a video    *
      *                                                                *
      *                       w-cod-cod-dps-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-cod-dps-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-dps-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-cod-dps-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-dps-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-cod-dps-num : Codice numerico      *
      ...
      *            * - N : Codice semilavorato numerico                *
      *            * - A : Codice semilavorato alfanumerico            *
      *            * - S : Sinonimo                                    *
      ...
      *                *-----------------------------------------------*
      *                * Codice numerico del semilavorato              *
      *                *-----------------------------------------------*
                   15  w-buf-cod-num      pic  9(07)                  .
      *                *-----------------------------------------------*
      *                * Codice alfanumerico del semilavorato          *
      *                *-----------------------------------------------*
                   15  w-buf-cod-alf      pic  x(14)                  .
      *                *-----------------------------------------------*
      *                * Codice sinonimo del semilavorato              *
      *                *-----------------------------------------------*
                   15  w-buf-cod-sin      pic  x(13)                  .
      *                *-----------------------------------------------*
      *                * Descrizione del semilavorato                  *
      *                *-----------------------------------------------*
                   15  w-buf-des-sem      pic  x(40)                  .
      *        *-------------------------------------------------------*
      ...
      ******************************************************************
       Procedure Division                using w-cod-cod-dps
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-cod-dps-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-cod-dps-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-cod-dps-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-cod-dps-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-cod-dps-ope    =    "A+" or
                     w-cod-cod-dps-ope    =    "I+" or
                     w-cod-cod-dps-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-cod-dps-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      spaces               to   w-cod-cod-dps-pf2      .
      *                  *---------------------------------------------*
      *                  * Se tipo accettazione diverso da 'A' : no    *
      *                  *---------------------------------------------*
           if        w-cod-cod-dps-tac    not  = "A"
                     go to acc-200.
      *                  *---------------------------------------------*
      ...
      *                  * Codice numerico                             *
      *                  *---------------------------------------------*
           if        w-cod-cod-dps-tac    =    "N" or
                     w-cod-cod-dps-tac    =    "A"
                     move  w-cod-cod-dps-num
                                          to   w-cod-cod-dps-s01
           else      move  zero           to   w-cod-cod-dps-s01      .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico                         *
      *                  *---------------------------------------------*
           if        w-cod-cod-dps-tac    =    "N"
                     move  spaces         to   w-cod-cod-dps-s02
           else      move  w-cod-cod-dps-alf
                                          to   w-cod-cod-dps-s02      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing v-edm                   *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-cod-dps-s70      .
      *                  *---------------------------------------------*
      *                  * User function-keys eventualmente epurate    *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-cod-dps-s90      .
       acc-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-cod-cod-dps-s01    to   w-edt-num-cod          .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-cod-dps-s90    to   v-ufk                  .
           move      w-cod-cod-dps-lin    to   v-lin                  .
           move      w-cod-cod-dps-pos    to   v-pos                  .
           move      w-edt-num-edt        to   v-alf                  .
      *                  *---------------------------------------------*
      *                  * Tipo operazione a : continuazione           *
      *                  *---------------------------------------------*
           move      "A+"                 to   w-cod-cod-dps-ope      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     acc-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-cod-dps-lin    to   v-lin                  .
           move      w-cod-cod-dps-pos    to   v-pos                  .
           move      w-cod-cod-dps-s02    to   v-alf                  .
      *                  *---------------------------------------------*
      *                  * Tipo operazione a : continuazione           *
      *                  *---------------------------------------------*
           move      "A+"                 to   w-cod-cod-dps-ope      .
      ...
      *              *-------------------------------------------------*
           if        w-cod-cod-dps-ope    =    "A+"
                     go to aco-300
           else if   w-cod-cod-dps-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                          * ta numerica                         *
      *                          *-------------------------------------*
           move      s-num                to   w-cod-cod-dps-num      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-cod-cod-dps-num    to   w-edt-num-cod          .
           perform   edn-000              thru edn-999                .
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Lettura del record 'dps' relativo   *
      ...
      *                              *---------------------------------*
       ...
       aco-260.
      *                          *-------------------------------------*
      *                          * Se record 'dps' esistente           *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Deviazione in funzione del tipo *
      *                              * di accettazione                 *
      *                              *---------------------------------*
           if        w-cod-cod-dps-tac    =    "A"
                     go to aco-280.
       aco-270.
      *                              *---------------------------------*
      ...
      *                                  * uscita                      *
      *                                  *-----------------------------*
           move      rf-dps-num-sem       to   w-cod-cod-dps-num      .
      *                                  *-----------------------------*
      *                                  * Valore alfanumerico conte-  *
      *                                  * nuto nel record in area di  *
      *                                  * uscita                      *
      *                                  *-----------------------------*
           move      rf-dps-alf-sem       to   w-cod-cod-dps-alf      .
      *                                  *-----------------------------*
      ...
      *                          * ta numerica                         *
      *                          *-------------------------------------*
           move      w-man-x14-num        to   w-cod-cod-dps-num      .
      *                          *-------------------------------------*
      *                          * Area di uscita alfanumerica a spa-  *
      *                          * ces                                 *
      *                          *-------------------------------------*
      ...
      *                          * ta alfanumerica                     *
      *                          *-------------------------------------*
           move      w-man-x14-alf        to   w-cod-cod-dps-alf      .
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-man-x14-alf        to   rf-dps-alf-sem         .
      ...
      *                              * esistente                       *
      *                              *---------------------------------*
           if        rf-dps-alf-sem       not  = w-man-x14-alf
                     go to aco-480.
       aco-460.
      *                          *-------------------------------------*
      *                          * Se trovato il record 'dps' cercato  *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      ...
      *                                  *-----------------------------*
           if        w-cod-cod-dps-pf2    not  = spaces
                     move  spaces         to   v-key
                     move  "F+"           to   w-cod-cod-dps-ope
                     go to aco-999.
      *                                  *-----------------------------*
      *                                  * Tipo operazione : non-con-  *
      *                                  * tinuazione                  *
      ...
      *                                  *-----------------------------*
       ...
       aco-480.
      *                          *-------------------------------------*
      *                          * Se record 'dps' relativo al codice  *
      ...
      *                              * per la descrizione              *
      *                              *---------------------------------*
           if        w-cod-cod-dps-dln    =    zero
                     go to aco-482.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
           move      spaces               to   v-edm                  .
           move      w-cod-cod-dps-dln    to   v-lin                  .
           move      w-cod-cod-dps-dps    to   v-pos                  .
           move      all   "."            to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-482.
      ...
      *                      * vato                                    *
      *                      *-----------------------------------------*
           if        w-cod-cod-dps-dln    =    zero or
                     w-cod-cod-dps-dps    =    zero
                     go to aco-340.
       aco-545.
      *                      *-----------------------------------------*
      ...
      *                              *---------------------------------*
           move      w-cod-cod-dps-s01    to   w-cod-cod-dps-num      .
           move      w-cod-cod-dps-s02    to   w-cod-cod-dps-alf      .
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-rbl-sin-min        to   rf-dps-syn-sem         .
           move      zero                 to   rf-dps-num-sem         .
           move      "pgm/dps/fls/ioc/obj/iofdps"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                              *---------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-rbl-des-min        to   rf-dps-des-key         .
           move      zero                 to   rf-dps-num-sem         .
           move      "pgm/dps/fls/ioc/obj/iofdps"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                              * tinua                           *
      *                              *---------------------------------*
           if        rf-dps-syn-sem       >    w-rbl-sin-max
                     go to aco-650
           else      go to aco-625.
       aco-622.
      *                          *-------------------------------------*
      ...
      *                              * tinua                           *
      *                              *---------------------------------*
           if        rf-dps-des-key       >    w-rbl-des-max
                     go to aco-650
           else      go to aco-625.
       aco-625.
      *                      *-----------------------------------------*
      ...
      *                          * Codice numerico del semilavorato    *
      *                          *-------------------------------------*
           move      rf-dps-num-sem       to   w-buf-cod-num
                                              (w-buf-ctr-rec)         .
      *                          *-------------------------------------*
      *                          * Codice alfanumerico del semilavorato*
      *                          *-------------------------------------*
           move      rf-dps-alf-sem       to   w-buf-cod-alf
                                              (w-buf-ctr-rec)         .
      *                          *-------------------------------------*
      *                          * Codice sinonimo del semilavorato    *
      *                          *-------------------------------------*
           move      rf-dps-syn-sem       to   w-buf-cod-sin
                                              (w-buf-ctr-rec)         .
      *                          *-------------------------------------*
      *                          * Descrizione del semilavorato        *
      *                          *-------------------------------------*
           move      rf-dps-des-sem       to   w-buf-des-sem
                                              (w-buf-ctr-rec)         .
       aco-635.
      *                      *-----------------------------------------*
      *                      * Riciclo a Read Next                     *
      ...
      *                                  *-----------------------------*
           move      w-buf-cod-num
                    (w-buf-ctr-ibx)       to   w-cod-cod-dps-num      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           move      w-buf-cod-alf
                    (w-buf-ctr-ibx)       to   w-cod-cod-dps-alf      .
      *                                  *-----------------------------*
      *                                  * Visualizzazione del valore  *
      *                                  * alfanumerico                *
      *                                  *-----------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      05                   to   v-pos                  .
           move      "              Selezionare il codice semilavorato d
      -              "esiderato             "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
       ...
       sac-200.
      *              *-------------------------------------------------*
      *              * Test se codice semilavorato numerico            *
      *              *-------------------------------------------------*
       ...
       sac-300.
      *              *-------------------------------------------------*
      *              * Test se codice semilavorato alfanumerico        *
      *              *-------------------------------------------------*
