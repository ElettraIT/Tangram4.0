      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cls        to   w-cmn-zss-002-cod      .
           move      04                   to   w-cmn-zss-002-lin      .
           move      30                   to   w-cmn-zss-002-pos      .
           move      07                   to   w-cmn-zss-002-dln      .
           move      30                   to   w-cmn-zss-002-dps      .
           move      "<B"                 to   v-edm                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      02                   to   rf-zss-tip-cls         .
           move      w-tes-cod-cls        to   rf-zss-cod-cls         .
           move      "pgm/dps/fls/ioc/obj/iofzss"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-zss-mne-cls       to   w-tes-mne-cls (1)      .
           move      rf-zss-des-key       to   w-tes-des-key (1)      .
           move      rf-zss-des-cls       to   w-tes-des-cls (1)      .
           move      rf-zss-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zss]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zss-000      thru wrt-rec-zss-999        .
      ...
      *                      * Rewrite record [zss]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zss-000      thru rew-rec-zss-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zss]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zss-000      thru del-rec-zss-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zss]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zss-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-mne-cls (1)    to   rf-zss-mne-cls         .
           move      w-tes-des-key (1)    to   rf-zss-des-key         .
           move      w-tes-des-cls (1)    to   rf-zss-des-cls         .
           move      w-tes-alx-exp (1)    to   rf-zss-alx-exp         .
       cmp-rec-zss-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zss]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zss-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zss-000      thru cmp-rec-zss-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zss] parte 01    *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zss2"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           ...
           move      "CODCLS    "         to   f-key                  .
           move      02                   to   rf-zss-tip-cls         .
           move      w-enc-cod-val-pos    to   rf-zss-cod-cls         .
           move      "pgm/dps/fls/ioc/obj/iofzss"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       rip-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zss]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zss2"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
