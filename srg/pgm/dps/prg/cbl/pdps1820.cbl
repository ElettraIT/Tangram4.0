      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdps1821:        *
      *                    Stampa codici statistici 2 semilavorati     *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zss-002-cod      .
           move      14                   to   w-cmn-zss-002-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zss-002-ope      .
           move      rr-cod-max           to   w-cmn-zss-002-cod      .
           move      14                   to   w-cmn-zss-002-lin      .
           move      52                   to   w-cmn-zss-002-pos      .
           move      zero                 to   w-cmn-zss-002-dln      .
           move      zero                 to   w-cmn-zss-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
