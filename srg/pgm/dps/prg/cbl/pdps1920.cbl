      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdps1921:        *
      *                    Stampa codici statistici 3 semilavorati     *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zss-003-cod      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zss-003-ope      .
           move      rr-cod-max           to   w-cmn-zss-003-cod      .
           move      14                   to   w-cmn-zss-003-lin      .
           move      52                   to   w-cmn-zss-003-pos      .
           move      zero                 to   w-cmn-zss-003-dln      .
           move      zero                 to   w-cmn-zss-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
