      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdps1220 *
      *                                                                *
      *                    Stampa classificazioni semilavorati         *
      *                    - Classi                                    *
      *                    - Gruppi                                    *
      *                    - Sottogruppi                               *
      *                                                                *
      ...
      *        * Classe semilavorato                                   *
      *        *-------------------------------------------------------*
           05  rr-cla-sml                 pic  9(05)                  .
           05  rr-cla-sml-des             pic  x(40)                  .
           05  rr-cla-sml-sud             pic  9(02)                  .
           05  rr-cla-sml-sqz             pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Gruppo semilavorato                                   *
      *        *-------------------------------------------------------*
           05  rr-gru-sml                 pic  9(05)                  .
           05  rr-gru-sml-des             pic  x(40)                  .
           05  rr-gru-sml-sud             pic  9(02)                  .
           05  rr-gru-sml-sqz             pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Sottogruppo semilavorato                              *
      *        *-------------------------------------------------------*
           05  rr-sgr-sml                 pic  9(05)                  .
           05  rr-sgr-sml-des             pic  x(40)                  .
           05  rr-sgr-sml-sud             pic  9(02)                  .
           05  rr-sgr-sml-sqz             pic  9(05)                  .
      ...
      *                  *---------------------------------------------*
           ...
           else      move  rr-cla-sml-sqz to   w-scs-cgs-sqz-icl
                     move  rr-cla-sml-sqz to   w-scs-cgs-sqz-fcl      .
       prn-str-ini-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      w-scs-cgs-sqz-icl    to   rf-zs1-sqz-num         .
      ...
      *                          * Test max su classe                  *
      *                          *-------------------------------------*
           if        rf-zs1-sqz-num       >    w-scs-cgs-sqz-fcl
                     go to prn-let-seq-120.
      *                          *-------------------------------------*
      ...
      *                          * Ultimo codice Classe letto          *
      *                          *-------------------------------------*
           move      rf-zs1-cod-cla       to   w-scs-cgs-cod-ucl      .
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           ...
           else      move  rr-gru-sml-sqz to   w-scs-cgs-sqz-igr
                     move  rr-gru-sml-sqz to   w-scs-cgs-sqz-fgr      .
      *                              *---------------------------------*
      *                              * Uscita per Ok                   *
      *                              *---------------------------------*
           go to     prn-let-seq-999.
      ...
      *                      *-----------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      w-scs-cgs-cod-ucl    to   rf-zs2-cod-cla         .
           move      w-scs-cgs-sqz-igr    to   rf-zs2-sqz-num         .
      ...
      *                          * Test max su Classe                  *
      *                          *-------------------------------------*
           if        rf-zs2-cod-cla       not  = w-scs-cgs-cod-ucl
                     go to prn-let-seq-220.
      *                          *-------------------------------------*
      *                          * Test max su Gruppo                  *
      *                          *-------------------------------------*
           if        rf-zs2-sqz-num       >    w-scs-cgs-sqz-fgr
                     go to prn-let-seq-220.
      *                          *-------------------------------------*
      ...
      *                          * Ultimo codice Gruppo letto          *
      *                          *-------------------------------------*
           move      rf-zs2-cod-gru       to   w-scs-cgs-cod-ugr      .
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           ...
           else      move  rr-sgr-sml-sqz to   w-scs-cgs-sqz-isg
                     move  rr-sgr-sml-sqz to   w-scs-cgs-sqz-fsg      .
      *                              *---------------------------------*
      *                              * Uscita per Ok                   *
      *                              *---------------------------------*
           go to     prn-let-seq-999.
      ...
      *                      *-----------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      w-scs-cgs-cod-ucl    to   rf-zs3-cod-cla         .
           move      w-scs-cgs-cod-ugr    to   rf-zs3-cod-gru         .
           move      w-scs-cgs-sqz-isg    to   rf-zs3-sqz-num         .
      ...
      *                          * Test max su Classe                  *
      *                          *-------------------------------------*
           if        rf-zs3-cod-cla       not  = w-scs-cgs-cod-ucl
                     go to prn-let-seq-320.
      *                          *-------------------------------------*
      *                          * Test max su Gruppo                  *
      *                          *-------------------------------------*
           if        rf-zs3-cod-gru       not  = w-scs-cgs-cod-ugr
                     go to prn-let-seq-320.
      *                          *-------------------------------------*
      *                          * Test max su Sottogruppo             *
      *                          *-------------------------------------*
           if        rf-zs3-sqz-num       >    w-scs-cgs-sqz-fsg
                     go to prn-let-seq-320.
      *                          *-------------------------------------*
      ...
      *                          * Ultimo codice Sottogruppo letto     *
      *                          *-------------------------------------*
           move      rf-zs3-cod-sgr       to   w-scs-cgs-cod-usg      .
      *                          *-------------------------------------*
      *                          * Tipo del prossimo elemento da trat- *
      *                          * tare : Sottogruppo                  *
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "CLASSIFICAZIONI SEMILAVORATI"
