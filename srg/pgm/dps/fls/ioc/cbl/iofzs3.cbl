      ...
      *    *===========================================================*
      *    * Record logico file [zs3]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/dps/fls/rec/rfzs3"                          .

      ******************************************************************
       Procedure Division                using f rf-zs3               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-zs3                 .
           move      zero                 to   rf-zs3-cod-cla         .
           move      zero                 to   rf-zs3-cod-gru         .
           move      zero                 to   rf-zs3-cod-sgr         .
           move      spaces               to   rf-zs3-des-sgr         .
           move      spaces               to   rf-zs3-mne-sgr         .
           move      zero                 to   rf-zs3-sqz-num         .
           move      spaces               to   rf-zs3-des-key         .
           move      zero                 to   rf-zs3-ult-sud         .
           move      spaces               to   rf-zs3-umi-def         .
           move      zero                 to   rf-zs3-ult-cod         .
           move      spaces               to   rf-zs3-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-zs3-des-sgr       to   fil-des-sgr            .
           move      rf-zs3-ult-sud       to   fil-ult-sud            .
           move      rf-zs3-umi-def       to   fil-umi-def            .
           move      rf-zs3-ult-cod       to   fil-ult-cod            .
           move      rf-zs3-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zs3-cod-cla       to   fil-cod-cla            .
           move      rf-zs3-cod-gru       to   fil-cod-gru            .
           move      rf-zs3-cod-sgr       to   fil-cod-sgr            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zs3-cod-cla       to   fil-cod-cla-2          .
           move      rf-zs3-cod-gru       to   fil-cod-gru-2          .
           move      rf-zs3-des-key       to   fil-des-key            .
           move      rf-zs3-cod-sgr       to   fil-cod-sgr-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zs3-cod-cla       to   fil-cod-cla-3          .
           move      rf-zs3-cod-gru       to   fil-cod-gru-3          .
           move      rf-zs3-mne-sgr       to   fil-mne-sgr            .
           move      rf-zs3-cod-sgr       to   fil-cod-sgr-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zs3-cod-cla       to   fil-cod-cla-4          .
           move      rf-zs3-cod-gru       to   fil-cod-gru-4          .
           move      rf-zs3-sqz-num       to   fil-sqz-num            .
           move      rf-zs3-cod-sgr       to   fil-cod-sgr-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-zs3                 .
           move      fil-cod-cla          to   rf-zs3-cod-cla         .
           move      fil-cod-gru          to   rf-zs3-cod-gru         .
           move      fil-cod-sgr          to   rf-zs3-cod-sgr         .
           move      fil-des-sgr          to   rf-zs3-des-sgr         .
           move      fil-mne-sgr          to   rf-zs3-mne-sgr         .
           move      fil-des-key          to   rf-zs3-des-key         .
           move      fil-sqz-num          to   rf-zs3-sqz-num         .
           move      fil-ult-sud          to   rf-zs3-ult-sud         .
           move      fil-umi-def          to   rf-zs3-umi-def         .
           move      fil-ult-cod          to   rf-zs3-ult-cod         .
           move      fil-alx-exp          to   rf-zs3-alx-exp         .
       dec-fis-log-999.
           exit.
