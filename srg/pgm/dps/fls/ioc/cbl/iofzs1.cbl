      ...
      *    *===========================================================*
      *    * Record logico file [zs1]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/dps/fls/rec/rfzs1"                          .

      ******************************************************************
       Procedure Division                using f rf-zs1               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-zs1                 .
           move      zero                 to   rf-zs1-cod-cla         .
           move      spaces               to   rf-zs1-des-cla         .
           move      spaces               to   rf-zs1-mne-cla         .
           move      spaces               to   rf-zs1-des-key         .
           move      zero                 to   rf-zs1-sqz-num         .
           move      zero                 to   rf-zs1-ult-sud         .
           move      spaces               to   rf-zs1-umi-def         .
           move      zero                 to   rf-zs1-ult-cod         .
           move      spaces               to   rf-zs1-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-zs1-des-cla       to   fil-des-cla            .
           move      rf-zs1-ult-sud       to   fil-ult-sud            .
           move      rf-zs1-umi-def       to   fil-umi-def            .
           move      rf-zs1-ult-cod       to   fil-ult-cod            .
           move      rf-zs1-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zs1-cod-cla       to   fil-cod-cla            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zs1-des-key       to   fil-des-key            .
           move      rf-zs1-cod-cla       to   fil-cod-cla-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zs1-mne-cla       to   fil-mne-cla            .
           move      rf-zs1-cod-cla       to   fil-cod-cla-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zs1-sqz-num       to   fil-sqz-num            .
           move      rf-zs1-cod-cla       to   fil-cod-cla-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-zs1                 .
           move      fil-cod-cla          to   rf-zs1-cod-cla         .
           move      fil-des-cla          to   rf-zs1-des-cla         .
           move      fil-mne-cla          to   rf-zs1-mne-cla         .
           move      fil-des-key          to   rf-zs1-des-key         .
           move      fil-sqz-num          to   rf-zs1-sqz-num         .
           move      fil-ult-sud          to   rf-zs1-ult-sud         .
           move      fil-umi-def          to   rf-zs1-umi-def         .
           move      fil-ult-cod          to   rf-zs1-ult-cod         .
           move      fil-alx-exp          to   rf-zs1-alx-exp         .
       dec-fis-log-999.
           exit.
