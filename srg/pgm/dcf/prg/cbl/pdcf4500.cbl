      ...
      *                       Ultima revisione:    NdK del 13/02/26    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase dcf450, nella sua globalita', esegue i tipi di manu-   *
      ...
      *                                                                *
      * MANPAG      Manutenzione Condizioni di pagamento               *
      *                                                                *
      * MANSTA      Manutenzione Codici statistici                     *
      *                                                                *
      * MANCGE      Manutenzione dati per la contabilita'              *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'dcf450'           *
      *              *-------------------------------------------------*
           perform   fas-dcf-450-000      thru fas-dcf-450-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-prs-spe-fat-i01    to   rf-ysf-num-spf         .
      ...
      *                          *-------------------------------------*
           move      rf-ysf-des-ves       to   w-prs-spe-fat-dve
                                              (w-prs-spe-fat-nst)     .
      *                          *-------------------------------------*
      *                          * Tipo funzionamento spesa            *
      *                          *-------------------------------------*
           move      rf-ysf-tfu-spe       to   w-prs-spe-fat-tfs
                                              (w-prs-spe-fat-nst)     .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-dcf-450-300
           else if   v-key                =    "PRSC"
                     go to fas-dcf-450-400
           else if   v-key                =    "NXSC"
                     go to fas-dcf-450-450
           else if   v-key                =    "DOWN"
                     go to fas-dcf-450-500
           else if   v-key                =    "EXIT"
                     go to fas-dcf-450-250
           else      go to fas-dcf-450-200.
       fas-dcf-450-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-man        =    zero
                     go to fas-dcf-450-330.
           move      zero                 to   w-tmn-ele-inx          .
       fas-dcf-450-322.
           add       1                    to   w-tmn-ele-inx          .
           if        w-tmn-ele-inx        >    w-tmn-ele-num
                     go to fas-dcf-450-340.
           if        w-tmn-num-tmn
                    (w-tmn-ele-inx)       =    w-key-num-man
                     go to fas-dcf-450-350
           else      go to fas-dcf-450-322.
       fas-dcf-450-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-dcf-450-630
           else if   v-key                =    "PRSC"
                     go to fas-dcf-450-600
           else if   v-key                =    "NXSC"
                     go to fas-dcf-450-610
           else if   v-key                =    "UP  "
                     go to fas-dcf-450-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-dcf-450-650
           else if   v-key                =    "EXIT"
                     go to fas-dcf-450-660
           else      go to fas-dcf-450-570.
       fas-dcf-450-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-dcf-450-626
           else      go to fas-dcf-450-628.
       fas-dcf-450-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-dcf-450-636
           else      go to fas-dcf-450-638.
       fas-dcf-450-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-dcf-450-725
           else      go to fas-dcf-450-750.
       fas-dcf-450-725.
      *              *-------------------------------------------------*
