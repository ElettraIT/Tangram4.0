      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase dcf550, nella sua globalita', esegue i tipi di opera-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * CPLFDF      Copia listino da fornitore a fornitore     dcf550a *
      * CPMFDF      Copia listino materie prime tra fornitori  dcf550b *
      * AZZPLF      Azzeramento prezzi di un listino fornitore dcf550d *
      * CANPLF      Cancellazione prezzi di listino fornitore  dcf550e *
      * MNTCDA      Manutenzione condizioni di acquisto        dcf550g *
      * STOLST      Storicizzazione di un listino fornitore    dcf550h *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'dcf550'           *
      *              *-------------------------------------------------*
           perform   fas-dcf-550-000      thru fas-dcf-550-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Copia listino prodotti da fornitore a fornitore   
      -              " CPLFDF     pdcf550a  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           if        w-prs-dpm-snx        not  = "S"
                     go to loa-tbl-tmn-105.
      *
           move      "Copia listino materie pr. da fornitore a fornitore
      -              " CPMFDF     pdcf550b  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tmn-105.
      *
           move      "Azzeramento prezzi di un listino fornitore        
      -              " AZZPLF     pdcf550d  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Cancellazione prezzi di listino fornitore         
      -              " CANPLF     pdcf550e  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Manutenzione condizioni di acquisto da fornitore  
      -              " MNTCDA     pdcf550g  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Storicizzazione di un listino fornitore           
      -              " STOLST     pdcf550h  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-dcf-550-300
           else if   v-key                =    "PRSC"
                     go to fas-dcf-550-400
           else if   v-key                =    "NXSC"
                     go to fas-dcf-550-450
           else if   v-key                =    "DOWN"
                     go to fas-dcf-550-500
           else if   v-key                =    "EXIT"
                     go to fas-dcf-550-250
           else      go to fas-dcf-550-200.
       fas-dcf-550-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-man        =    zero
                     go to fas-dcf-550-330.
           move      zero                 to   w-tmn-ele-inx          .
       fas-dcf-550-322.
           add       1                    to   w-tmn-ele-inx          .
           if        w-tmn-ele-inx        >    w-tmn-ele-num
                     go to fas-dcf-550-340.
           if        w-tmn-num-tmn
                    (w-tmn-ele-inx)       =    w-key-num-man
                     go to fas-dcf-550-350
           else      go to fas-dcf-550-322.
       fas-dcf-550-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-dcf-550-630
           else if   v-key                =    "PRSC"
                     go to fas-dcf-550-600
           else if   v-key                =    "NXSC"
                     go to fas-dcf-550-610
           else if   v-key                =    "UP  "
                     go to fas-dcf-550-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-dcf-550-650
           else if   v-key                =    "EXIT"
                     go to fas-dcf-550-660
           else      go to fas-dcf-550-570.
       fas-dcf-550-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-dcf-550-626
           else      go to fas-dcf-550-628.
       fas-dcf-550-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-dcf-550-636
           else      go to fas-dcf-550-638.
       fas-dcf-550-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-dcf-550-725
           else      go to fas-dcf-550-750.
       fas-dcf-550-725.
      *              *-------------------------------------------------*
