      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CONTROLLO FORNITORI CON ANNOTAZIONI   "       .
      ...
      *        * Tipo ordinamento                                      *
      *        *  - 01 : Per fornitore                                 *
      *        *  - 02 : Per annotazione generica __ da implementare   *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-ord.
               ...
               10  w-exp-tip-ord-tbl.
                   ...
                   15  filler             pic  x(40) value
                            "per Annotazione generica / fornitore    ".
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Questo programma seleziona e stampa i fornitore pe
      -              "r i quali esistono annotazioni"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Selezione su anagrafica fornitori               *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dfx-cod-fnt       to   rf-dcf-cod-fnt         .
      *
           if        rf-dfx-dpz-fnt       =    "*"
                     move  spaces         to   rf-dcf-dpz-fnt
           else      move  rf-dfx-dpz-fnt to   rf-dcf-dpz-fnt         .
      *
           move      "pgm/dcf/fls/ioc/obj/iofdcf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun fornitore con annotazioni da segnalare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      053                  to   p-pos                  .
           move      srt-dfx-ann-rig (1)  to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * 2.                                          *
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      093                  to   p-pos                  .
           move      srt-dfx-ann-rig (2)  to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      053                  to   p-pos                  .
           move      srt-dfx-ann-rig (3)  to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * 4.                                          *
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      093                  to   p-pos                  .
           move      srt-dfx-ann-rig (4)  to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Interlinea                                      *
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      053                  to   p-pos                  .
           move      srt-dfx-ann-rig (5)  to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * 6.                                          *
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      093                  to   p-pos                  .
           move      srt-dfx-ann-rig (6)  to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Interlinea                                      *
      ...
      *              *-------------------------------------------------*
           move      "FORNITORI CON ANNOTAZIONI"
