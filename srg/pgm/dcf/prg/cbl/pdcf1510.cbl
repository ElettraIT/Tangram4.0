      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [yfp]            *
      *                                                                *
      *                    Anagrafico forme di pagamento fornitori     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE FORME PAGAMENTO FORNITORI"       .
      ...
      *    *-----------------------------------------------------------*
       01  w-rip-str.
      *        *-------------------------------------------------------*
      *        * Work-area per ripristino Start su [yfp]               *
      *        *-------------------------------------------------------*
           05  w-rip-str-yfp.
      *            *---------------------------------------------------*
      *            * Flag di End-of-file                               *
      *            *---------------------------------------------------*
               10  w-rip-str-yfp-eof      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Parametri di Start                                *
      *            *---------------------------------------------------*
               10  w-rip-str-yfp-cod      pic  9(07)                  .
               10  w-rip-str-yfp-des      pic  x(40)                  .
               10  w-rip-str-yfp-mne      pic  x(10)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-rip-str-yfp-eof      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      34                   to   v-pos                  .
           move      rf-yfp-des-fop       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-yfp-cod-fop       to   w-mpn-cod-fop          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "EXPD"
                     go to qry-trt-fun-999.
      *                  *---------------------------------------------*
      *                  * Routine per Expand su record [yfp]          *
      *                  *---------------------------------------------*
           perform   exp-rec-yfp-000      thru exp-rec-yfp-999        .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       exp-rec-yfp-000.
      *              *-------------------------------------------------*
      *              * Salvataggio parametri per Start su [yfp]        *
      *              *-------------------------------------------------*
           if        w-rip-str-yfp-eof    not  = spaces
                     go to exp-rec-yfp-100.
           move      rf-yfp-cod-fop       to   w-rip-str-yfp-cod      .
           move      rf-yfp-des-key       to   w-rip-str-yfp-des      .
           move      rf-yfp-cod-mne       to   w-rip-str-yfp-mne      .
       exp-rec-yfp-100.
      *              *-------------------------------------------------*
      *              * Video in 'OFF'                                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "CODFOP    "         to   f-key                  .
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-cod-fop        to   rf-yfp-cod-fop         .
           move      "pgm/dcf/fls/ioc/obj/iofyfp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Test se a zero                          *
      *                      *-----------------------------------------*
           if        rf-yfp-cod-pag (1)   =    zero
                     go to exp-rec-yfp-720.
      *                      *-----------------------------------------*
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      "DS"                 to   v-ope                  .
           ...
           move      11                   to   v-lin                  .
           move      26                   to   v-pos                  .
           move      rf-yfp-cod-pag (1)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-yfp-tip-amm (1)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Percentuale                             *
      ...
      *                          *-------------------------------------*
           ...
           move      12                   to   v-lin                  .
           move      63                   to   v-pos                  .
           move      rf-yfp-per-toi (1)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       exp-rec-yfp-720.
      *                  *---------------------------------------------*
      ...
      *                      * Test se a zero                          *
      *                      *-----------------------------------------*
           if        rf-yfp-cod-pag (2)   =    zero
                     go to exp-rec-yfp-730.
      *                      *-----------------------------------------*
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      "DS"                 to   v-ope                  .
           ...
           move      14                   to   v-lin                  .
           move      26                   to   v-pos                  .
           move      rf-yfp-cod-pag (2)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      ...
      *                      *-----------------------------------------*
           ...
           move      26                   to   v-pos                  .
           move      w-exp-tip-amm-tbl    to   v-txt                  .
           move      rf-yfp-tip-amm (2)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Percentuale                             *
      ...
      *                          *-------------------------------------*
           ...
           move      15                   to   v-lin                  .
           move      63                   to   v-pos                  .
           move      rf-yfp-per-toi (2)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       exp-rec-yfp-730.
      *                  *---------------------------------------------*
      ...
      *                      * Test se a zero                          *
      *                      *-----------------------------------------*
           if        rf-yfp-cod-pag (3)   =    zero
                     go to exp-rec-yfp-740.
      *                      *-----------------------------------------*
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      "DS"                 to   v-ope                  .
           ...
           move      17                   to   v-lin                  .
           move      26                   to   v-pos                  .
           move      rf-yfp-cod-pag (3)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      ...
      *                      *-----------------------------------------*
           ...
           move      26                   to   v-pos                  .
           move      w-exp-tip-amm-tbl    to   v-txt                  .
           move      rf-yfp-tip-amm (3)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Percentuale                             *
      ...
      *                          *-------------------------------------*
           ...
           move      18                   to   v-lin                  .
           move      63                   to   v-pos                  .
           move      rf-yfp-per-toi (3)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       exp-rec-yfp-740.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-yfp-dim-act (1)   not  = 02 and
                     rf-yfp-dim-act (2)   not  = 02 and
                     rf-yfp-dim-act (3)   not  = 02
                     go to exp-rec-yfp-750.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
           move      20                   to   v-lin                  .
      ...
      *                  *---------------------------------------------*
           if        rf-yfp-ide-dat       =    zero
                     go to exp-rec-yfp-760.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      07                   to   v-lin                  .
           move      69                   to   v-pos                  .
           move      rf-yfp-ide-dat       to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       exp-rec-yfp-760.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-yfp-ide-ute       =    spaces
                     go to exp-rec-yfp-770.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      10                   to   v-car                  .
           move      08                   to   v-lin                  .
      ...
      *                  *---------------------------------------------*
           if        rf-yfp-ide-fas       =    spaces
                     go to exp-rec-yfp-800.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      08                   to   v-car                  .
           move      09                   to   v-lin                  .
      ...
      *                  *---------------------------------------------*
           if        w-rip-str-yfp-eof    not  = spaces
                     go to exp-rec-yfp-999.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo di Start    *
      *                  * attualmente attivo                          *
      *                  *---------------------------------------------*
           if        rr-tip-ord           =    "C"
                     go to exp-rec-yfp-910
           else if   rr-tip-ord           =    "D"
                     go to exp-rec-yfp-920
           else if   rr-tip-ord           =    "M"
                     go to exp-rec-yfp-930.
       exp-rec-yfp-910.
      *                  *---------------------------------------------*
      *                  * Se start per codice                         *
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODFOP    "         to   f-key                  .
           move      w-rip-str-yfp-cod    to   rf-yfp-cod-fop         .
           move      "pgm/dcf/fls/ioc/obj/iofyfp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-yfp                 .
           if        f-sts                not  = e-not-err
                     go to exp-rec-yfp-990.
           go to     exp-rec-yfp-980.
       exp-rec-yfp-920.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "DESKEY    "         to   f-key                  .
           move      w-rip-str-yfp-des    to   rf-yfp-des-key         .
           move      w-rip-str-yfp-cod    to   rf-yfp-cod-fop         .
           move      "pgm/dcf/fls/ioc/obj/iofyfp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODMNE    "         to   f-key                  .
           move      w-rip-str-yfp-mne    to   rf-yfp-cod-mne         .
           move      w-rip-str-yfp-cod    to   rf-yfp-cod-fop         .
           move      "pgm/dcf/fls/ioc/obj/iofyfp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
