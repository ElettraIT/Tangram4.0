      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella codici statistici per      *
      *                    classificazioni dati commerciali fornitori  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  GESTIONE CODICI STATISTICI FORNITORI  "       .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice statistico             *
      *    *-----------------------------------------------------------*
       pmt-cod-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice statistico             *
      *    *-----------------------------------------------------------*
       acc-cod-cls-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cls        to   w-cmn-yst-003-cod      .
           move      04                   to   w-cmn-yst-003-lin      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice statistico          *
      *    *-----------------------------------------------------------*
       vis-cod-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione codice statistico    *
      *    *-----------------------------------------------------------*
       pmt-des-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Mnemonico codice statistico      *
      *    *-----------------------------------------------------------*
       pmt-mne-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione codice statist.  *
      *    *-----------------------------------------------------------*
       acc-des-cls-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione codise stat.  *
      *    *-----------------------------------------------------------*
       vis-des-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Mnemonico codice statistico  *
      *    *-----------------------------------------------------------*
       acc-mne-cls-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Mnemonico codice stat.    *
      *    *-----------------------------------------------------------*
       vis-mne-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cls        to   rf-yst-cod-cls         .
           move      "pgm/dcf/fls/ioc/obj/iofyst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-yst-mne-cls       to   w-tes-mne-cls (1)      .
           move      rf-yst-des-key       to   w-tes-des-key (1)      .
           move      rf-yst-des-cls       to   w-tes-des-cls (1)      .
           move      rf-yst-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [yst]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-yst-000      thru wrt-rec-yst-999        .
      ...
      *                      * Rewrite record [yst]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-yst-000      thru rew-rec-yst-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [yst]                             *
      *              *-------------------------------------------------*
           perform   del-rec-yst-000      thru del-rec-yst-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [yst]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-yst-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-mne-cls (1)    to   rf-yst-mne-cls         .
           move      w-tes-des-key (1)    to   rf-yst-des-key         .
           move      w-tes-des-cls (1)    to   rf-yst-des-cls         .
           move      w-tes-alx-exp (1)    to   rf-yst-alx-exp         .
       cmp-rec-yst-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [yst]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-yst-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-yst-000      thru cmp-rec-yst-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [yst] parte 01    *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "yst3"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           ...
           move      "CODCLS    "         to   f-key                  .
           move      03                   to   rf-yst-tip-cls         .
           move      w-enc-cod-val-pos    to   rf-yst-cod-cls         .
           move      "pgm/dcf/fls/ioc/obj/iofyst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       rip-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [yst]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "yst3"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
