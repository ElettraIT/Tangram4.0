      ...
      *                                                                *
      *                    Azzeramento prezzi prodotti fornitore       *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "      *** Attenzione : L'operazione di azzeramento
      -              " non e' reversibile ***       "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
           perform   azz-prz-fnt-000      thru azz-prz-fnt-999        .
       exe-sub-pgm-999.
           exit.

      *    *===========================================================*
      *    * Azzeramento prezzi fornitore                              *
      *    *-----------------------------------------------------------*
       azz-prz-fnt-000.
      *              *-------------------------------------------------*
      *              * Start su file [aaf]                             *
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to azz-prz-fnt-999.
       azz-prz-fnt-100.
      *              *-------------------------------------------------*
      *              * Ottenimento sequenziale file [aaf]              *
      *              *-------------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "pgm/dcf/fls/ioc/obj/iofaaf"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-aaf-cod-dcf       not  = rr-cod-fnt or
                     ...
                     go to azz-prz-fnt-900.
       azz-prz-fnt-300.
      *              *-------------------------------------------------*
      *              * Aggiornamenti su [aaf]                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
