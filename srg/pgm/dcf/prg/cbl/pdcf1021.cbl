      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcf102   *
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-pdt-cod-pdt         .
           move      "pgm/dcf/fls/ioc/obj/iofpdt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-rag-min           to   rf-pdt-rag-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-mne-min           to   rf-pdt-cod-mne         .
           move      zero                 to   rf-pdt-cod-pdt         .
           move      "pgm/dcf/fls/ioc/obj/iofpdt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-pti-min           to   rf-pdt-prt-iva         .
           move      zero                 to   rf-pdt-cod-pdt         .
           move      "pgm/dcf/fls/ioc/obj/iofpdt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna casa produttrice entro i limiti assegnati 
      -              "!"                  to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [pdt]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcf/fls/ioc/obj/iofpdt"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-pdt-cod-pdt       <    rr-cod-min or
                     rf-pdt-cod-pdt       >    rr-cod-max or
                     rf-pdt-rag-key       <    rr-rag-min or
                     rf-pdt-rag-key       >    rr-rag-max or
                     rf-pdt-cod-mne       <    rr-mne-min or
                     rf-pdt-cod-mne       >    rr-mne-max or
                     rf-pdt-prt-iva       <    rr-pti-min or
                     rf-pdt-prt-iva       >    rr-pti-max
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *                  *---------------------------------------------*
           if        rf-pdt-prt-iva       =    zero
                     go to  prn-sel-rec-999.
           move      rf-pdt-prt-iva       to   w-cnt-piv-piv          .
      ...
      *              *-------------------------------------------------*
           if        rr-tip-ord           =    "R"
                     move  rf-pdt-rag-key to   w-rot-l01-let-ini
                     go to prn-cmp-rot-999.
      *              *-------------------------------------------------*
      *              * Se tipo ordinamento : per mnemonico             *
      *              *-------------------------------------------------*
           if        rr-tip-ord           =    "M"
                     move  rf-pdt-cod-mne to   w-rot-l01-let-ini
                     go to prn-cmp-rot-999.
      *              *-------------------------------------------------*
      *              * Se tipo ordinamento : per codice o partita iva  *
      *              *-------------------------------------------------*
           move      spaces               to   w-rot-l01-let-ini      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Se ordinamento per codice o per partita iva :   *
      *              * nessuna azione                                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "Mnemonico      Codice               Ragione social
      -              "e                          Indirizzo/localita'    
      -              "          Partita iva           "
                                          to   p-alf                  .
           go to     int-pag-sta-110.
       int-pag-sta-100.
           move      "Partita iva    Codice               Ragione social
      -              "e                          Indirizzo/localita'    
      -              "          Mnemonico             "
                                          to   p-alf                  .
       int-pag-sta-110.
