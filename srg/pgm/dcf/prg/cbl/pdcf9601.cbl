      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdcf9600 *
      *                                                                *
      ...
      *            *---------------------------------------------------*
      *            * Numero di righe di descrizione                    *
      *            *---------------------------------------------------*
               10  srt-num-rig            pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Descrizione prodotto per il fornitore             *
      *            *---------------------------------------------------*
               10  srt-des-fnt.
                   15  srt-der-fnt occurs 10
                                          pic  x(40)                  .
      ...
      *                          *-------------------------------------*
       ...
       stp-srt-inp-500.
      *                  *---------------------------------------------*
      *                  * Test su selettore per descrizione           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se tutti                                *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Se solo con descrizione diversa         *
      *                      *-----------------------------------------*
           if        rr-snx-des           =    01 and
                     rf-aaf-dep-sfn       =    spaces
                     go to stp-srt-inp-200.
      *                      *-----------------------------------------*
      *                      * Se solo con descrizione uguale          *
      *                      *-----------------------------------------*
           if        rr-snx-des           =    02 and
                     rf-aaf-dep-sfn       not  = spaces
                     go to stp-srt-inp-200.
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-dcp-des-pro       to   srt-des-fnt            .
      *                              *---------------------------------*
      *                              * Oltre                           *
      *                              *---------------------------------*
      ...
      *                          * Descrizione per il fornitore        *
      *                          *-------------------------------------*
           move      rf-aaf-dep-sfn       to   srt-des-fnt            .
      *                              *---------------------------------*
      *                              * Oltre                           *
      *                              *---------------------------------*
           go to     stp-srt-inp-700.
      ...
      *                          *-------------------------------------*
           ...
           move      13                   to   rf-pdx-cod-arc         .
           move      rf-aaf-cod-dcf       to   rf-pdx-cod-arc         .
           move      spaces               to   rf-pdx-cod-lng         .
           move      rf-aaf-num-pro       to   rf-pdx-cod-num         .
           move      rf-aaf-fda-pif       to   rf-pdx-for-mat         .
           move      w-buf-des-pdx-ctr    to   rf-pdx-num-prg         .
           move      "pgm/dcp/fls/ioc/obj/iofpdx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Lettura archivio [pdx]              *
      *                          *-------------------------------------*
           move      rf-pdx-des-pro       to   srt-der-fnt
                                              (w-buf-des-pdx-ctr)     .
           move      w-buf-des-pdx-ctr    to   srt-num-rig            .
      *                          *-------------------------------------*
      *                          * Riciclo su [pdx]                    *
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      srt-num-rig          to   w-buf-des-pdx-res      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-buf-des-pdx-c01    >    srt-num-rig
                     go to prn-liv-det-999.
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Stampa riga di descrizione per il fornitore *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-rot-l01-cod-dcf    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Lettura record [dcf]                        *
      *                  *---------------------------------------------*
           move      w-rot-l01-cod-dcf    to   w-let-arc-dcf-fnt      .
      ...
      *              *-------------------------------------------------*
      ...
      -              "no          Descrizione per il fornitore      "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
