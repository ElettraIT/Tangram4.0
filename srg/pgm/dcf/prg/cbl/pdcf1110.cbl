      ...
      *                  *---------------------------------------------*
           ...
           move      w-fnd-arc-ydf-def    to   rr-num-def             .
           move      w-fnd-arc-ydf-lng    to   rr-cod-lng             .
      *                  *---------------------------------------------*
      *                  * Visualizzazioni                             *
      *                  *---------------------------------------------*
      ...
      *                  * Lettura tabella [ydf]                       *
      *                  *---------------------------------------------*
           move      rr-num-def           to   w-let-arc-ydf-def      .
           move      rr-cod-lng           to   w-let-arc-ydf-lng      .
           perform   let-arc-ydf-000      thru let-arc-ydf-999        .
           move      w-let-arc-ydf-des    to   rr-num-def-des         .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Start su archivio [yvf]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "CODVDF    "         to   f-key                  .
           move      rr-num-def           to   rf-yvf-num-def         .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [yvf]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcf/fls/ioc/obj/iofyvf"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Test su numero spesa                            *
      *              *-------------------------------------------------*
           if        rr-num-def           =    zero
                     go to qry-tst-max-999.
           if        rf-yvf-num-def       not  = rr-num-def
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
       qry-tst-max-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-yvf-cod-lng       not  = rr-cod-lng
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      31                   to   v-pos                  .
           move      rf-yvf-des-stp       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-yvf-cod-def       to   w-mpn-cod-def          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-num-def           to   rf-ydf-num-def         .
           move      rr-cod-lng           to   rf-ydf-cod-lng         .
           move      "pgm/dcf/fls/ioc/obj/iofydf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      25                   to   v-pos                  .
           move      "Cod   Descrizione per la stampa"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
