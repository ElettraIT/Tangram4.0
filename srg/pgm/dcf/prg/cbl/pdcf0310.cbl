      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      41                   to   v-pos                  .
           move      rf-ysf-des-stp       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-ysf-num-spf       to   w-mpn-num-spf          .
           move      rf-ysf-cod-lng       to   w-mpn-cod-lng          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
