      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [pdt]            *
      *                                                                *
      *                    Anagrafico case produttrici                 *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE ARCHIVIO CASE PRODUTTRICI"       .
           ...
           05  w-exp-tip-ord.
               ...
               10  w-exp-tip-ord-tbl.
                   ...
                   15  filler             pic  x(20) value
                            "Per codice fiscale  "                    .
      *        *-------------------------------------------------------*
      *        * Work per : Si/no in allegato                          *
      *        *-------------------------------------------------------*
           05  w-exp-sna-a13.
               10  w-exp-sna-a13-num      pic  9(02)       value 3    .
               10  w-exp-sna-a13-lun      pic  9(02)       value 40   .
               10  w-exp-sna-a13-tbl.
                   15  filler             pic  x(40) value
                            "Va' in allegato                         ".
                   15  filler             pic  x(40) value
                            "Non va' in allegato                     ".
                   15  filler             pic  x(40) value
                            "Va' in allegato come persona fisica     ".
      ...
      *    *-----------------------------------------------------------*
       01  w-rip-str.
      *        *-------------------------------------------------------*
      *        * Work-area per ripristino Start su [pdt]               *
      *        *-------------------------------------------------------*
           05  w-rip-str-pdt.
      *            *---------------------------------------------------*
      *            * Flag di End-of-file                               *
      *            *---------------------------------------------------*
               10  w-rip-str-pdt-eof      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Parametri di Start                                *
      *            *---------------------------------------------------*
               10  w-rip-str-pdt-cod      pic  9(07)                  .
               10  w-rip-str-pdt-rag      pic  x(40)                  .
               10  w-rip-str-pdt-mne      pic  x(10)                  .
               10  w-rip-str-pdt-piv      pic  9(11)                  .
               10  w-rip-str-pdt-cfi      pic  x(16)                  .

      *    *===========================================================*
      *    * Work-area per ridefinizione contenuto del mark-point      *
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-cod-pdt              pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-rip-str-pdt-eof      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cfi-min           to   rf-pdt-cod-fis         .
           move      zero                 to   rf-pdt-cod-pdt         .
           move      "pgm/dcf/fls/ioc/obj/iofpdt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           if        rf-pdt-cod-pdt       <    rr-cod-min or
                     rf-pdt-cod-pdt       >    rr-cod-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su ragione sociale                    *
      *              *-------------------------------------------------*
           if        rf-pdt-rag-key       <    rr-rag-min or
                     rf-pdt-rag-key       >    rr-rag-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-pdt-cod-mne       <    rr-mne-min or
                     rf-pdt-cod-mne       >    rr-mne-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su partita iva                        *
      *              *-------------------------------------------------*
           if        rf-pdt-prt-iva       <    rr-pti-min or
                     rf-pdt-prt-iva       >    rr-pti-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su codice fiscale                     *
      *              *-------------------------------------------------*
           if        rf-pdt-cod-fis       <    rr-cfi-min or
                     rf-pdt-cod-fis       >    rr-cfi-max
                     go to qry-sel-rec-900.
       qry-sel-rec-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      26                   to   v-pos                  .
           move      rf-pdt-rag-soc       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-pdt-cod-pdt       to   w-mpn-cod-pdt          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "EXPD"
                     go to qry-trt-fun-999.
      *                  *---------------------------------------------*
      *                  * Routine per Expand su record [pdt]          *
      *                  *---------------------------------------------*
           perform   exp-rec-pdt-000      thru exp-rec-pdt-999        .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      33                   to   v-pos                  .
           move      "CASE PRODUTTRICI"   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Interlinea                                      *
      ...
      *    *-----------------------------------------------------------*
       exp-rec-pdt-000.
      *              *-------------------------------------------------*
      *              * Salvataggio parametri per Start su [pdt]        *
      *              *-------------------------------------------------*
           if        w-rip-str-pdt-eof    not  = spaces
                     go to exp-rec-pdt-100.
           move      rf-pdt-cod-pdt       to   w-rip-str-pdt-cod      .
           move      rf-pdt-rag-key       to   w-rip-str-pdt-rag      .
           move      rf-pdt-cod-mne       to   w-rip-str-pdt-mne      .
           move      rf-pdt-prt-iva       to   w-rip-str-pdt-piv      .
           move      rf-pdt-cod-fis       to   w-rip-str-pdt-cfi      .
       exp-rec-pdt-100.
      *              *-------------------------------------------------*
      *              * Video in 'OFF'                                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "CODPDT    "         to   f-key                  .
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-cod-pdt        to   rf-pdt-cod-pdt         .
           move      "pgm/dcf/fls/ioc/obj/iofpdt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        rf-pdt-ide-dat       =    zero
                     go to exp-rec-pdt-760.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      16                   to   v-lin                  .
           move      69                   to   v-pos                  .
           move      rf-pdt-ide-dat       to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       exp-rec-pdt-760.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-pdt-ide-ute       =    spaces
                     go to exp-rec-pdt-770.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      10                   to   v-car                  .
           move      17                   to   v-lin                  .
      ...
      *                  *---------------------------------------------*
           if        rf-pdt-ide-fas       =    spaces
                     go to exp-rec-pdt-800.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      08                   to   v-car                  .
           move      18                   to   v-lin                  .
      ...
      *                  *---------------------------------------------*
           if        w-rip-str-pdt-eof    not  = spaces
                     go to exp-rec-pdt-999.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo di Start    *
      *                  * attualmente attivo                          *
      *                  *---------------------------------------------*
           if        rr-tip-ord           =    "C"
                     go to exp-rec-pdt-910
           else if   rr-tip-ord           =    "R"
                     go to exp-rec-pdt-920
           else if   rr-tip-ord           =    "M"
                     go to exp-rec-pdt-930
           else if   rr-tip-ord           =    "P"
                     go to exp-rec-pdt-940
           else if   rr-tip-ord           =    "F"
                     go to exp-rec-pdt-950.
       exp-rec-pdt-910.
      *                  *---------------------------------------------*
      *                  * Se start per codice                         *
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODPDT    "         to   f-key                  .
           move      w-rip-str-pdt-cod    to   rf-pdt-cod-pdt         .
           move      "pgm/dcf/fls/ioc/obj/iofpdt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-pdt                 .
           if        f-sts                not  = e-not-err
                     go to exp-rec-pdt-990.
           go to     exp-rec-pdt-980.
       exp-rec-pdt-920.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "RAGKEY    "         to   f-key                  .
           move      w-rip-str-pdt-rag    to   rf-pdt-rag-key         .
           move      w-rip-str-pdt-cod    to   rf-pdt-cod-pdt         .
           move      "pgm/dcf/fls/ioc/obj/iofpdt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODMNE    "         to   f-key                  .
           move      w-rip-str-pdt-mne    to   rf-pdt-cod-mne         .
           move      w-rip-str-pdt-cod    to   rf-pdt-cod-pdt         .
           move      "pgm/dcf/fls/ioc/obj/iofpdt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "PRTIVA    "         to   f-key                  .
           move      w-rip-str-pdt-piv    to   rf-pdt-prt-iva         .
           move      w-rip-str-pdt-cod    to   rf-pdt-cod-pdt         .
           move      "pgm/dcf/fls/ioc/obj/iofpdt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODFIS    "         to   f-key                  .
           move      w-rip-str-pdt-cfi    to   rf-pdt-cod-fis         .
           move      w-rip-str-pdt-cod    to   rf-pdt-cod-pdt         .
           move      "pgm/dcf/fls/ioc/obj/iofpdt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
