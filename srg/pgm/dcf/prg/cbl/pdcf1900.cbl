      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella spese incasso fornitori    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "GESTIONE TABELLA SPESE INCASSO FORNITORI"       .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-spi        to   w-cod-cod-yin-cod      .
           move      04                   to   w-cod-cod-yin-lin      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-spi        to   rf-yin-cod-spi         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-yin-des-spi       to   w-tes-des-spi (1)      .
           move      rf-yin-civ-spi       to   w-tes-civ-spi (1)      .
           move      rf-yin-ccp-spi       to   w-tes-ccp-spi (1)      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "CODSPI    "         to   f-key                  .
           move      w-tes-cod-spi        to   rf-yin-cod-spi         .
           move      w-tes-tip-pag        to   rf-yin-tip-pag         .
           move      "pgm/dcf/fls/ioc/obj/iofyin"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
           ...
           move      rf-yin-ccp-spi       to   w-tes-ccp-spi (1)      .
       rou-let-reg-120.
           move      rf-yin-tfu-spi       to   w-tes-tfu-spi (1)      .
           move      rf-yin-amm-spi       to   w-tes-amm-spi (1)      .
           move      rf-yin-per-spi       to   w-tes-per-spi (1)      .
           move      rf-yin-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-yin-cod-spi       not  = w-tes-cod-spi
                     go to pre-snx-del-900.
      *                  *---------------------------------------------*
      ...
      *                      * Write record [yin]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-yin-000      thru wrt-rec-yin-999        .
      ...
      *                      * Rewrite record [yin]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-yin-000      thru rew-rec-yin-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [yin]                             *
      *              *-------------------------------------------------*
           perform   del-rec-yin-000      thru del-rec-yin-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [yin]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-yin-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-spi (1)    to   rf-yin-des-spi         .
           move      w-tes-civ-spi (1)    to   rf-yin-civ-spi         .
           move      w-tes-ccp-spi (1)    to   rf-yin-ccp-spi         .
           move      w-tes-tfu-spi (1)    to   rf-yin-tfu-spi         .
           move      w-tes-amm-spi (1)    to   rf-yin-amm-spi         .
           move      w-tes-per-spi (1)    to   rf-yin-per-spi         .
           move      w-tes-alx-exp (1)    to   rf-yin-alx-exp         .
       cmp-rec-yin-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [yin]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-yin-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-yin-000      thru cmp-rec-yin-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
