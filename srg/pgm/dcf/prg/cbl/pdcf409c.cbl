      ...
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Ragione sociale da [dcf]                          *
      *            *---------------------------------------------------*
               10  srt-dcf-rag-soc        pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Indirizzo da [dcf]                                *
      *            *---------------------------------------------------*
               10  srt-dcf-via-fnt        pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Localita' da [dcf]                                *
      *            *---------------------------------------------------*
               10  srt-dcf-loc-fnt        pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Codici errati                                     *
      *            *---------------------------------------------------*
               10  srt-dcf-cod-er1        pic  9(07)                  .
               10  srt-dcf-cod-er2        pic  9(07)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CONTROLLO CODICI ERRATI IN FORNITORI  "       .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-cod.
               10  w-exp-tip-cod-num      pic  9(02)       value 05   .
      ...
      *
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "di seguito non trova riscontro nella relativa tabe
      -              "lla.                          "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                      * Lettura tabella                         *
      *                      *-----------------------------------------*
           move      rf-dcf-cod-fop       to   w-let-arc-yfp-cod      .
      ...
      *                      *-----------------------------------------*
           move      rf-dcf-cod-abi       to   w-let-arc-axi-cod      .
      ...
      *                      *-----------------------------------------*
           move      rf-dcf-cod-abi       to   w-let-arc-axs-abi      .
           move      rf-dcf-cod-cab       to   w-let-arc-axs-cab      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dcf-cod-fnt       to   srt-cod-fnt            .
           move      rf-dcf-dpz-fnt       to   srt-dpz-fnt            .
           move      rf-dcf-rag-soc       to   srt-dcf-rag-soc        .
           move      rf-dcf-via-dcf       to   srt-dcf-via-fnt        .
           move      rf-dcf-loc-dcf       to   srt-dcf-loc-fnt        .
      *              *-------------------------------------------------*
      *              * Codice errato                                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-310.
           move      rf-dcf-cod-fop       to   srt-dcf-cod-er1        .
           move      zero                 to   srt-dcf-cod-er2        .
           go to     stp-srt-inp-400.
       stp-srt-inp-320.
           move      rf-dcf-cod-abi       to   srt-dcf-cod-er1        .
           move      rf-dcf-cod-cab       to   srt-dcf-cod-er2        .
           go to     stp-srt-inp-400.
       stp-srt-inp-330.
           move      rf-dcf-cod-zon       to   srt-dcf-cod-er1        .
           move      zero                 to   srt-dcf-cod-er2        .
           go to     stp-srt-inp-400.
       stp-srt-inp-340.
           move      rf-dcf-cod-cat       to   srt-dcf-cod-er1        .
           move      zero                 to   srt-dcf-cod-er2        .
           go to     stp-srt-inp-400.
       stp-srt-inp-350.
           move      rf-dcf-cod-stt       to   srt-dcf-cod-er1        .
           move      zero                 to   srt-dcf-cod-er2        .
           go to     stp-srt-inp-400.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      *              * Riciclo a fornitore successivo                  *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-100.
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun fornitore con codici errati da segnalare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-310.
      *              *-------------------------------------------------*
      *              * Fornitori con forma di pagamento errata         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-320.
      *              *-------------------------------------------------*
      *              * Fornitori con codici ABI - CAB errati           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Editing codice errore 1                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-330.
      *              *-------------------------------------------------*
      *              * Fornitori con codice zona errato                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Editing codice errore 1                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-340.
      *              *-------------------------------------------------*
      *              * Fornitori con codice categoria errato           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Editing codice errore 1                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-350.
      *              *-------------------------------------------------*
      *              * Fornitori con codice statistico errato          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Editing codice errore 1                     *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           go to     int-pag-sta-010
                     ...
                     depending   on rr-tip-cod.
       int-pag-sta-010.
           move      "FORNITORI CON FORMA DI PAGAMENTO ERRATA"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-020.
           move      "FORNITORI CON CODICI ABI-CAB ERRATI"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-030.
           move      "FORNITORI CON CODICE ZONA ERRATO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-040.
           move      "FORNITORI CON CODICE CATEGORIA ERRATO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-050.
           move      "FORNITORI CON CODICE STATISTICO ERRATO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-090.
           move      "DT"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "     Codice                Anagrafica fornitore   
      -              "                                            Note  
      -              "                                "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
