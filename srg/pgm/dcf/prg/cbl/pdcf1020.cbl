      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcf1021:        *
      *                    Stampa anagrafica case produttrici          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-sel-pti.
               10  w-exp-sel-pti-num      pic  9(02)       value 2    .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      *              * Prompt 'Selezione su archivio case produttrici' *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      38                   to   v-car                  .
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su archivio case produttrici"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           perform   fnd-arc-pdt-000      thru fnd-arc-pdt-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-pdt-cod      .
           move      15                   to   w-cod-mne-pdt-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-pdt-ope      .
           move      rr-cod-max           to   w-cod-mne-pdt-cod      .
           move      15                   to   w-cod-mne-pdt-lin      .
           move      53                   to   w-cod-mne-pdt-pos      .
           move      zero                 to   w-cod-mne-pdt-rln      .
           move      zero                 to   w-cod-mne-pdt-rps      .
           move      zero                 to   w-cod-mne-pdt-vln      .
           move      zero                 to   w-cod-mne-pdt-vps      .
      ...
      *    *-----------------------------------------------------------*
       reg-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Codice casa produttrice minimo e massimo        *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Tasto funzione "FIND" su archivio case produttrici        *
      *    *-----------------------------------------------------------*
       fnd-arc-pdt-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "P?"                 to   s-ope                  .
           move      "pdcf1010"           to   s-pro                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     go to  fnd-arc-pdt-999.
      *              *-------------------------------------------------*
      *              * Richiamo programma di interrogazione            *
      *              *-------------------------------------------------*
           move      "pgm/dcf/prg/obj/pdcf1010"
                                          to   s-pat                  .
