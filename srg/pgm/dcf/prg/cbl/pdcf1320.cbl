      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcf1321:        *
      *                                                                *
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice categorie fornitori     *
      *    *-----------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella categorie fornitori"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-yst-002-cod      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-002-ope      .
           move      rr-cod-max           to   w-cmn-yst-002-cod      .
           move      14                   to   w-cmn-yst-002-lin      .
           move      52                   to   w-cmn-yst-002-pos      .
           move      zero                 to   w-cmn-yst-002-dln      .
           move      zero                 to   w-cmn-yst-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
