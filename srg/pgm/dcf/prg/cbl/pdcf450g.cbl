      ...
      *                                                                *
      *                    Manutenzione codici statistici fornitori    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Categoria fornitori             *
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-zon        to   w-cmn-yst-001-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-zon        to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   w-tes-cod-zon-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cod-zon-des-000  thru vis-cod-zon-des-999    .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-001-ope      .
           move      w-tes-cod-zon        to   w-cmn-yst-001-cod      .
           move      w-lpt-cod-zon-lin    to   w-cmn-yst-001-lin      .
           move      w-lpt-cod-zon-pos    to   w-cmn-yst-001-pos      .
           add       16                   to   w-cmn-yst-001-pos      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-001-ope      .
           move      w-tes-zon-sos        to   w-cmn-yst-001-cod      .
           move      w-lpt-cod-zon-lin    to   w-cmn-yst-001-lin      .
           move      w-lpt-cod-zon-pos    to   w-cmn-yst-001-pos      .
           add       35                   to   w-cmn-yst-001-pos      .
           move      zero                 to   w-cmn-yst-001-dln      .
           move      zero                 to   w-cmn-yst-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cat        to   w-cmn-yst-002-cod      .
           move      16                   to   w-cmn-yst-002-lin      .
           move      30                   to   w-cmn-yst-002-pos      .
           move      16                   to   w-cmn-yst-002-dln      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-cat        to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   w-tes-cod-cat-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cod-cat-des-000  thru vis-cod-cat-des-999    .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-002-ope      .
           move      w-tes-cod-cat        to   w-cmn-yst-002-cod      .
           move      w-lpt-cod-cat-lin    to   w-cmn-yst-002-lin      .
           move      w-lpt-cod-cat-pos    to   w-cmn-yst-002-pos      .
           add       16                   to   w-cmn-yst-002-pos      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Categoria fornitori               *
      *    *                                                           *
      *    * Subroutine di visualizzazione valore da sostituire        *
      *    *-----------------------------------------------------------*
       vis-cod-cat-so1-000.
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-002-ope      .
           move      w-tes-cat-sos        to   w-cmn-yst-002-cod      .
           move      w-lpt-cod-cat-lin    to   w-cmn-yst-002-lin      .
           move      w-lpt-cod-cat-pos    to   w-cmn-yst-002-pos      .
           add       35                   to   w-cmn-yst-002-pos      .
           move      zero                 to   w-cmn-yst-002-dln      .
           move      zero                 to   w-cmn-yst-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-stt        to   w-cmn-yst-003-cod      .
           move      18                   to   w-cmn-yst-003-lin      .
           move      30                   to   w-cmn-yst-003-pos      .
           move      18                   to   w-cmn-yst-003-dln      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-stt        to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   w-tes-cod-stt-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cod-stt-des-000  thru vis-cod-stt-des-999    .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-003-ope      .
           move      w-tes-cod-stt        to   w-cmn-yst-003-cod      .
           move      w-lpt-cod-stt-lin    to   w-cmn-yst-003-lin      .
           move      w-lpt-cod-stt-pos    to   w-cmn-yst-003-pos      .
           add       16                   to   w-cmn-yst-003-pos      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-003-ope      .
           move      w-tes-stt-sos        to   w-cmn-yst-003-cod      .
           move      w-lpt-cod-stt-lin    to   w-cmn-yst-003-lin      .
           move      w-lpt-cod-stt-pos    to   w-cmn-yst-003-pos      .
           add       35                   to   w-cmn-yst-003-pos      .
           move      zero                 to   w-cmn-yst-003-dln      .
           move      zero                 to   w-cmn-yst-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-001-ope      .
           move      w-rig-cod-zon        to   w-cmn-yst-001-cod      .
           move      19                   to   w-cmn-yst-001-lin      .
           move      22                   to   w-cmn-yst-001-pos      .
           move      19                   to   w-cmn-yst-001-dln      .
           move      41                   to   w-cmn-yst-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *                  *---------------------------------------------*
           move      01                   to   w-let-arc-yst-tip      .
           move      w-rig-cod-zon        to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   w-rig-cod-zon-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-zon-des-000  thru vis-rig-zon-des-999    .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-002-ope      .
           move      w-rig-cod-cat        to   w-cmn-yst-002-cod      .
           move      20                   to   w-cmn-yst-002-lin      .
           move      22                   to   w-cmn-yst-002-pos      .
           move      20                   to   w-cmn-yst-002-dln      .
           move      41                   to   w-cmn-yst-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *                  *---------------------------------------------*
           move      02                   to   w-let-arc-yst-tip      .
           move      w-rig-cod-cat        to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   w-rig-cod-cat-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-cat-des-000  thru vis-rig-cat-des-999    .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-003-ope      .
           move      w-rig-cod-stt        to   w-cmn-yst-003-cod      .
           move      21                   to   w-cmn-yst-003-lin      .
           move      22                   to   w-cmn-yst-003-pos      .
           move      21                   to   w-cmn-yst-003-dln      .
           move      41                   to   w-cmn-yst-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *                  *---------------------------------------------*
           move      03                   to   w-let-arc-yst-tip      .
           move      w-rig-cod-stt        to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   w-rig-cod-stt-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-stt-des-000  thru vis-rig-stt-des-999    .
      ...
      *              *-------------------------------------------------*
      ...
      -              "          "         to   w-err-box-err-msg      .
       ...
       cnt-tdo-rig-420.
      *              *-------------------------------------------------*
      *              * Controllo su Codice categoria fornitore         *
      *              *-------------------------------------------------*
           if        w-rig-dpz-fnt        not  = spaces
           ...
           if        w-let-arc-yst-flg    =    spaces
                     go to cnt-tdo-rig-430.
           move      "Codice Categoria Fornitore non esistente !        
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-430.
      *              *-------------------------------------------------*
      *              * Controllo su Codice statistico fornitore        *
      *              *-------------------------------------------------*
           if        w-rig-dpz-fnt        not  = spaces
           ...
           if        w-let-arc-yst-flg    =    spaces
                     go to cnt-tdo-rig-600.
           move      "Codice Statistico Fornitore non esistente         
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-dcf-cod-vlt       not  = w-tes-cod-vlt
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-dcf-cod-lng       not  = w-tes-cod-lng
                     go to sel-rec-dcf-900.
       sel-rec-dcf-300.
      *                  *---------------------------------------------*
      *                  * Codice zona                                 *
      *                  *---------------------------------------------*
           ...
           if        rf-dcf-cod-zon       not  = w-tes-cod-zon
                     go to sel-rec-dcf-900.
       sel-rec-dcf-400.
      *                  *---------------------------------------------*
      *                  * Codice categoria                            *
      *                  *---------------------------------------------*
           ...
           if        rf-dcf-cod-cat       not  = w-tes-cod-cat
                     go to sel-rec-dcf-900.
       sel-rec-dcf-500.
      *                  *---------------------------------------------*
      *                  * Codice statistico                           *
      *                  *---------------------------------------------*
           ...
           if        rf-dcf-cod-stt       not  = w-tes-cod-stt
                     go to sel-rec-dcf-900.
       sel-rec-dcf-600.
      *                  *---------------------------------------------*
      *                  * Codice classe di budget                     *
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcf-cod-vlt       to   w-rig-cod-vlt          .
           move      rf-dcf-cod-lng       to   w-rig-cod-lng          .
           move      rf-dcf-cod-zon       to   w-rig-cod-zon          .
           move      rf-dcf-cod-cat       to   w-rig-cod-cat          .
           move      rf-dcf-cod-stt       to   w-rig-cod-stt          .
           move      rf-dcf-cla-bdg       to   w-rig-cla-bdg          .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-rig-cod-vlt        to   rf-dcf-cod-vlt         .
           move      w-rig-cod-lng        to   rf-dcf-cod-lng         .
           move      w-rig-cod-zon        to   rf-dcf-cod-zon         .
           move      w-rig-cod-cat        to   rf-dcf-cod-cat         .
           move      w-rig-cod-stt        to   rf-dcf-cod-stt         .
           move      w-rig-cla-bdg        to   rf-dcf-cla-bdg         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
