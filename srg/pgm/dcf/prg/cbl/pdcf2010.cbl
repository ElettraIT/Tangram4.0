      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella Spese bollo per      *
      *                                                                *
      *                    gestione fornitori                          *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-ybo-cod-spb       to   w-rot-l01-cod-spb      .
           move      rf-ybo-des-spb       to   w-wrk-des-spb          .
       qry-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-ybo-tip-pag       =    1
                     move  "Rimessa diretta               "
                                          to   v-alf
           else if   rf-ybo-tip-pag       =    2
                     move  "Incasso elettronico           "
                                          to   v-alf
           else if   rf-ybo-tip-pag       =    3
                     move  "Ri.Ba.                        "
                                          to   v-alf
           else if   rf-ybo-tip-pag       =    4
                     move  "C.d.O. - Conferma d'ordine    "
                                          to   v-alf
           else if   rf-ybo-tip-pag       =    5
                     move  "Mav - Mediante avviso         "
                                          to   v-alf
           else if   rf-ybo-tip-pag       =    6
                     move  "Rid - Accr. preautoriz. in c/ "
                                          to   v-alf
           else if   rf-ybo-tip-pag       =    7
                     move  "Bonifico bancario             "
                                          to   v-alf
           else if   rf-ybo-tip-pag       =    8
                     move  "Conto corrente postale        "
                                          to   v-alf
           else if   rf-ybo-tip-pag       =    9
                     move  "Ricevuta bancaria             "
                                          to   v-alf
           else if   rf-ybo-tip-pag       =    10
                     move  "Tratta                        "
                                          to   v-alf
           else if   rf-ybo-tip-pag       =    10
                     move  "Paghero'                      "
           ...
           move      "+"                  to   v-edm                  .
           move      rf-ybo-cod-spb       to   w-mpn-cod-spb          .
           move      rf-ybo-tip-pag       to   w-mpn-tip-pag          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           else if   rf-ybo-tau-spb       =    2
                     move  "A scaglioni " to   v-alf
           else if   rf-ybo-tau-spb       =    3
