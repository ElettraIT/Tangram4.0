      ...
      *                    per cui esiste una differenza tra la ra-    *
      *                    gione sociale contabile e quella commer-    *
      *                    ciale                                       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Ragione sociale da [fnt]                          *
      *            *---------------------------------------------------*
               10  srt-fnt-rag-soc        pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Indirizzo da [fnt]                                *
      *            *---------------------------------------------------*
               10  srt-fnt-via-fnt        pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Localita' da [fnt]                                *
      *            *---------------------------------------------------*
               10  srt-fnt-loc-fnt        pic  x(40)                  .
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CONTROLLO RAGIONI SOCIALI FORNITORI   "       .
      ...
      *        *-------------------------------------------------------*
      *        * Tipo selezione                                        *
      *        *  - 01 : Solo se anagrafiche commerciali esistenti     *
      *        *  - 02 : Solo se anagrafiche commerciali inesistenti   *
      *        *  - 03 : Nessuna selezione                             *
      *        *-------------------------------------------------------*
           05  rr-tip-sel                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Si/No conferma esecuzione                             *
      *        *-------------------------------------------------------*
           05  rr-cnf-exe                 pic  x(01)                  .
           ...
           05  w-exp-tip-sel.
               ...
               10  w-exp-tip-sel-tbl.
                   15  filler             pic  x(40) value
                            "Solo anagrafiche commerciali Esistenti  ".
                   15  filler             pic  x(40) value
                            "Solo anagrafiche commerciali Inesistenti".
                   15  filler             pic  x(40) value
                            "Nessuna selezione                       ".
      ...
      *    *===========================================================*
      *    * Work area per campi in uppercase                          *
      *    *-----------------------------------------------------------*
       01  w-mai.
      *        *-------------------------------------------------------*
      *        * Ragione sociale da [fnt]                              *
      *        *-------------------------------------------------------*
           05  w-mai-fnt-rag-soc          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Indirizzo da [fnt]                                    *
      *        *-------------------------------------------------------*
           05  w-mai-fnt-via-fnt          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Localita' da [fnt]                                    *
      *        *-------------------------------------------------------*
           05  w-mai-fnt-loc-fnt          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Ragione sociale da [dcf]                              *
      *        *-------------------------------------------------------*
           05  w-mai-dcf-rag-soc          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Indirizzo da [dcf]                                    *
      *        *-------------------------------------------------------*
           05  w-mai-dcf-via-fnt          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Localita' da [dcf]                                    *
      *        *-------------------------------------------------------*
           05  w-mai-dcf-loc-fnt          pic  x(40)                  .
      ...
      *
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "za tra la ragione sociale in anagrafica contabile 
      -              "e la ragione sociale in ana-  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-210.
      *                  *---------------------------------------------*
      *                  * Se solo anagrafiche commerciali esistenti   *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       stp-srt-inp-220.
      *                  *---------------------------------------------*
      *                  * Se solo anagrafiche commerciali inesistenti *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        f-sts                =    e-not-err
                     go to stp-srt-inp-600.
      *                      *-----------------------------------------*
      *                      * Manipolazione ragione sociale           *
      *                      *-----------------------------------------*
           move      "(Scheda commerciale mancante)           "
                                          to   rf-dcf-rag-soc         .
      *                      *-----------------------------------------*
      *                      * Oltre                                   *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       stp-srt-inp-300.
      *              *-------------------------------------------------*
      *              * Trasformazione in uppercase dei valore :        *
      *              *  -  Ragione sociale da [fnt]                    *
      *              *  -  Indirizzo       da [fnt]                    *
      *              *  -  Localita'       da [fnt]                    *
      *              *  -  Ragione sociale da [dcf]                    *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-all-str-alf        to   w-mai-fnt-rag-soc      .
      *
           move      rf-fnt-via-fnt       to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-mai-fnt-via-fnt      .
      *
           move      rf-fnt-loc-fnt       to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-mai-fnt-loc-fnt      .
      *
           move      rf-dcf-rag-soc       to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-mai-dcf-rag-soc      .
      *
           move      rf-dcf-via-dcf       to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-mai-dcf-via-fnt      .
      *
           move      rf-dcf-loc-dcf       to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-mai-dcf-loc-fnt      .
      *              *-------------------------------------------------*
      *              * Se non ci sono differenze tra le due anagrafi-  *
      *              * che : si ignora il fornitore                    *
      *              *-------------------------------------------------*
           if        w-mai-fnt-rag-soc    =    w-mai-dcf-rag-soc and
                     w-mai-fnt-via-fnt    =    w-mai-dcf-via-fnt and
                     w-mai-fnt-loc-fnt    =    w-mai-dcf-loc-fnt
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-fnt-rag-soc       to   srt-fnt-rag-soc        .
           move      rf-fnt-via-fnt       to   srt-fnt-via-fnt        .
           move      rf-fnt-loc-fnt       to   srt-fnt-loc-fnt        .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna differenza tra ragioni sociali da segnalar
      -              "e !"                to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      "CONTROLLO RAGIONI SOCIALI FORNITORI"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "     Codice                Anagrafica contabile   
