      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " CONTROLLO CODICI MANCANTI IN FORNITORI "       .
      ...
      *        *  - 02 : Codice zona                                   *
      *        *  - 03 : Codice categoria                              *
      *        *  - 04 : Codice statistico                             *
      *        *  - 05 : Codici geografici                             *
      *        *  - 06 : Codici categoria sonto in riga                *
      *        *  - 07 : Codici categoria sonto in chiusura            *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-cod.
               10  w-exp-tip-cod-num      pic  9(02)       value 07   .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Deviazione secondo il del tipo codice       *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun fornitore senza codici da segnalare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           go to     int-pag-sta-010
                     ...
                     depending   on rr-tip-cod.
       int-pag-sta-010.
           move      "FORNITORI MANCANTI DELLA FORMA DI PAGAMENTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-020.
           move      "FORNITORI MANCANTI DEL CODICE ZONA"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-030.
           move      "FORNITORI MANCANTI DEL CODICE CATEGORIA"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-040.
           move      "FORNITORI MANCANTI DEL CODICE STATISTICO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-050.
           move      "FORNITORI MANCANTI DEI CODICI GEOGRAFICI"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-060.
           move      "FORNITORI MANCANTI DEI CODICI CATEGORIA SCONTO IN 
      -              "RIGA"               to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-070.
           move      "FORNITORI MANCANTI DEI CODICI CATEGORIA SCONTO IN 
      -              "CHIUSURA"           to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-090.
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
