      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcf0320  *
      *                                                                *
      *                    Stampa tipi spese per fatturazione forni-   *
      *                    tori                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "TIPI DI SPESA PER FATTURAZIONE FORNITORI"       .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [ysf]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcf/fls/ioc/obj/iofysf"
                                          to   s-pat                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      108                  to   p-pos                  .
           move      rf-ysf-ibt-spe       to   p-alf                  .
           if        rf-ysf-ibl-spe       not  = 03
      ...
      *              *-------------------------------------------------*
           move      i-ide-des            to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
