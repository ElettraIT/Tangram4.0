      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella zone per classificazioni   *
      *                    statistiche dati commerciali fornitori      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    GESTIONE TABELLA ZONE FORNITORI     "       .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice zona                   *
      *    *-----------------------------------------------------------*
       pmt-cod-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice zona                   *
      *    *-----------------------------------------------------------*
       acc-cod-cls-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cls        to   w-cmn-yst-001-cod      .
           move      04                   to   w-cmn-yst-001-lin      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice zona                *
      *    *-----------------------------------------------------------*
       vis-cod-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione zona                 *
      *    *-----------------------------------------------------------*
       pmt-des-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Mnemonico zona                   *
      *    *-----------------------------------------------------------*
       pmt-mne-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione zona             *
      *    *-----------------------------------------------------------*
       acc-des-cls-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Mnemonico zona               *
      *    *-----------------------------------------------------------*
       acc-mne-cls-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Mnemonico zona            *
      *    *-----------------------------------------------------------*
       vis-mne-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "Manca la descrizione per la zona                  
      -              "      "             to   w-err-box-err-msg      .
