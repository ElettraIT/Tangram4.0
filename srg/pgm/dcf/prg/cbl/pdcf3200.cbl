      ...
      *                                   Fase:    dcf320              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 08/02/05    *
      *                       Ultima revisione:    NdK del 08/02/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Manutenzione dati generali di acquisto      *
      *                    prodotti                                    *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase dcf320, nella sua globalita', esegue i tipi di opera-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * MNTPRZ      Manutenzione condizioni di acquisto        dcf320a *
      * MNTCGF      Manutenzione condizioni di fornitura       dcf320b *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Link-area comune per programmi della serie pdcf3200       *
      *    *-----------------------------------------------------------*
           copy      "pgm/dcf/prg/cpy/pdcf3200.pgl"                   .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'dcf320'           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Manutenzione condizioni generali di acquisto      
      -              " MNTPRZ     pdcf320a  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Manutenzione condizioni generali di fornitura     
      -              " MNTCGF     pdcf320b  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tmn-200.
