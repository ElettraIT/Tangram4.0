      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE CODICI STATIST. FORNITORI"       .
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice cod. stat. fornitori    *
      *    *-----------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       det-num-rec-300.
      *              *-------------------------------------------------*
      *              * Max su [yst], se non superato : ad uscita       *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       det-num-rec-800.
      *              *-------------------------------------------------*
      *              * Riciclo a record [yst] successivo               *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      40                   to   v-pos                  .
           move      rf-yst-des-cls       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-yst-cod-cls       to   w-mpn-cod-cls          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
