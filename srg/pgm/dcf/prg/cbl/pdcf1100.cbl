      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "VOCI DESCRITTIVE FATTURAZIONE FORNITORI "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-fnd.
      *        *-------------------------------------------------------*
      *        * Work per Find su archivio [ydf]                       *
      *        *-------------------------------------------------------*
           05  w-fnd-arc-ydf.
               10  w-fnd-arc-ydf-sel      pic  x(01)                  .
               10  w-fnd-arc-ydf-def      pic  9(01)                  .
               10  w-fnd-arc-ydf-lng      pic  x(03)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-let.
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [ydf]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-ydf.
               10  w-let-arc-ydf-flg      pic  x(01)                  .
               10  w-let-arc-ydf-def      pic  9(01)                  .
               10  w-let-arc-ydf-lng      pic  x(03)                  .
               10  w-let-arc-ydf-des      pic  x(40)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
           copy      "pgm/dcf/prg/cpy/acodyvf0.acl"                   .
      ...
      *              * giuntiva in fattura                             *
      *              *-------------------------------------------------*
           perform   cod-cod-yvf-opn-000  thru cod-cod-yvf-opn-999    .
      *              *-------------------------------------------------*
      ...
      *              * giuntiva in fattura                             *
      *              *-------------------------------------------------*
           perform   cod-cod-yvf-cls-000  thru cod-cod-yvf-cls-999    .
      *              *-------------------------------------------------*
      ...
      *                  * Find su tabella [ydf]                       *
      *                  *---------------------------------------------*
           perform   fnd-arc-ydf-000      thru fnd-arc-ydf-999        .
           if        w-fnd-arc-ydf-sel    not  = spaces
                     go to acc-num-def-100.
           move      w-fnd-arc-ydf-def    to   w-tes-num-def          .
           move      w-fnd-arc-ydf-lng    to   w-tes-cod-lng          .
      *                  *---------------------------------------------*
      *                  * Visualizzazioni                             *
      *                  *---------------------------------------------*
           perform   vis-num-def-000      thru vis-num-def-999        .
      ...
      *                  * Insr su tabella [ydf]                       *
      *                  *---------------------------------------------*
           perform   ins-arc-ydf-000      thru ins-arc-ydf-999        .
           go to     acc-num-def-100.
       acc-num-def-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-num-def-500.
      *                  *---------------------------------------------*
      *                  * Lettura tabella [ydf] per lingua italiana   *
      *                  *---------------------------------------------*
           move      w-tes-num-def        to   w-let-arc-ydf-def      .
           move      "I  "                to   w-let-arc-ydf-lng      .
           perform   let-arc-ydf-000      thru let-arc-ydf-999        .
           if        w-let-arc-ydf-flg    =    spaces
      ...
      *                          *-------------------------------------*
       ...
       acc-num-def-550.
      *                  *---------------------------------------------*
      *                  * Lettura tabella [ydf] se codice lingua gia' *
      ...
      *                  *---------------------------------------------*
           move      w-tes-num-def        to   w-let-arc-ydf-def      .
           move      w-tes-cod-lng        to   w-let-arc-ydf-lng      .
           perform   let-arc-ydf-000      thru let-arc-ydf-999        .
           move      w-let-arc-ydf-des    to   w-tes-num-def-des      .
      *                  *---------------------------------------------*
      ...
      *                  * Test sul flag                               *
      *                  *---------------------------------------------*
           if        w-let-arc-ydf-flg    not  = spaces
                     go to acc-num-def-100.
       acc-num-def-600.
      *              *-------------------------------------------------*
      ...
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-yvf-ope      .
           move      w-tes-num-def        to   w-cod-cod-yvf-voc      .
           move      w-tes-cod-lng        to   w-cod-cod-yvf-lng      .
           move      w-tes-cod-def        to   w-cod-cod-yvf-cod      .
           move      06                   to   w-cod-cod-yvf-lin      .
           move      34                   to   w-cod-cod-yvf-pos      .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   cod-cod-yvf-cll-000  thru cod-cod-yvf-cll-999    .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
           perform   cod-cod-yvf-foi-000  thru cod-cod-yvf-foi-999    .
       acc-cod-def-110.
           perform   cod-cod-yvf-cll-000  thru cod-cod-yvf-cll-999    .
           if        w-cod-cod-yvf-ope    =    "F+"
                     go to acc-cod-def-115.
           if        w-cod-cod-yvf-ope    =    "AC"
       ...
       acc-cod-def-120.
           move      w-cod-cod-yvf-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-num-def        to   rf-yvf-num-def         .
           move      w-tes-cod-def        to   rf-yvf-cod-def         .
           move      w-tes-cod-lng        to   rf-yvf-cod-lng         .
           move      "pgm/dcf/fls/ioc/obj/iofyvf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [yvf]                        *
      *                          *-------------------------------------*
           move      rf-yvf-des-stp       to   w-tes-des-stp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [yvf]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-yvf-000      thru wrt-rec-yvf-999        .
      ...
      *                      * Rewrite record [yvf]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-yvf-000      thru rew-rec-yvf-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [yvf]                             *
      *              *-------------------------------------------------*
           perform   del-rec-yvf-000      thru del-rec-yvf-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [yvf]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-yvf-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-stp (1)    to   rf-yvf-des-stp         .
       cmp-rec-yvf-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [yvf]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-yvf-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-yvf-000      thru cmp-rec-yvf-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           move      "P?"                 to   s-ope                  .
           move      "pdcf0410"           to   s-pro                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     move  "#"            to   w-fnd-arc-ydf-sel
                     go to  fnd-arc-ydf-999.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  spaces         to   w-fnd-arc-ydf-sel
                     move  s-num          to   w-fnd-arc-ydf-def
           else      move  "#"            to   w-fnd-arc-ydf-sel      .
           move      "CV"                 to   s-ope                  .
           ...
           if        s-ves                =    spaces
                     move  spaces         to   w-fnd-arc-ydf-sel
                     move  s-alf          to   w-fnd-arc-ydf-lng
           else      move  "#"            to   w-fnd-arc-ydf-sel      .
       fnd-arc-ydf-999.
           exit.

      *    *===========================================================*
      *    * Insr su archivio [ydf]                                    *
      *    *-----------------------------------------------------------*
       ins-arc-ydf-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "P?"                 to   s-ope                  .
           move      "pdcf0400"           to   s-pro                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     go to  ins-arc-ydf-999.
      *                  *---------------------------------------------*
      *                  * Richiamo programma di gestione archivio     *
      *                  *---------------------------------------------*
           move      "pgm/dcf/prg/obj/pdcf0400"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat                                            .
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [ydf]                         *
      *    *-----------------------------------------------------------*
       let-arc-ydf-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione marker di uscita                *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-ydf-flg      .
      *              *-------------------------------------------------*
      *              * Test se numero voce a zero                      *
      *              *-------------------------------------------------*
           if        w-let-arc-ydf-def    =    zero
                     go to let-arc-ydf-500.
      *              *-------------------------------------------------*
      *              * Lettura per codice                              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODDEF"             to   f-key                  .
           move      w-let-arc-ydf-def    to   rf-ydf-num-def         .
           move      w-let-arc-ydf-lng    to   rf-ydf-cod-lng         .
           move      "pgm/dcf/fls/ioc/obj/iofydf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           ...
           if        f-sts                not  = e-not-err
                     go to let-arc-ydf-400.
       let-arc-ydf-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-ydf-des-stp       to   w-let-arc-ydf-des      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     let-arc-ydf-999.
       let-arc-ydf-400.
      *              *-------------------------------------------------*
      *              * Azioni per record non trovato                   *
      *              *-------------------------------------------------*
           move      "#"                  to   w-let-arc-ydf-flg      .
           move      all   "."            to   w-let-arc-ydf-des      .
           go to     let-arc-ydf-999.
       let-arc-ydf-500.
      *              *-------------------------------------------------*
      *              * Normalizzazione work area                       *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-ydf-des      .
       let-arc-ydf-999.
           exit.
      ...
      *    * tiva in fattura                                           *
      *    *-----------------------------------------------------------*
           copy      "pgm/dcf/prg/cpy/acodyvf0.acs"                   .
