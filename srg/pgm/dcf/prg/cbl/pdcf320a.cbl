      ...
      *                                                                *
      *                    Manutenzione condizioni generali di         *
      *                    fornitura                                   *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
               10  srt-key-sqc            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Sequenza per gruppo prodotto                      *
      *            *---------------------------------------------------*
               10  srt-key-sqg            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Sequenza per sottogruppo prodotto                 *
      *            *---------------------------------------------------*
               10  srt-key-sqs            pic  9(07)                  .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  srt-pre-acr            pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Prezzo d'acquisto attuale                         *
      *            *---------------------------------------------------*
               10  srt-prz-acr            pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Data aggiornamento                                *
      *            *---------------------------------------------------*
               10  srt-uda-par            pic  9(07)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "CONDIZIONI DI ACQUISTO GENERALI PRODOTTI"       .
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           ...
           05  w-rig-pre-acr              pic  9(09)                  .
           05  w-rig-prz-acr              pic  9(09)                  .
           05  w-rig-uda-par              pic  9(07)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "G"                  to   v-edm                  .
           move      w-rig-prz-acr        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-prz-acr      .
       vis-lin-cor-480.
      *                  *---------------------------------------------*
      *                  * Editing Errore su decimali valuta           *
      *                  *---------------------------------------------*
           move      spaces               to   w-lin-imm-err-dec      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *              * Prezzo d'acquisto precedente                    *
      *              *-------------------------------------------------*
           perform   vis-pre-acr-000      thru vis-pre-acr-999        .
      *              *-------------------------------------------------*
      *              * Data aggiornamento                              *
      *              *-------------------------------------------------*
      ...
      *                  * Prezzo d'acquisto precedente                *
      *                  *---------------------------------------------*
           perform   pmt-pre-acr-000      thru pmt-pre-acr-999        .
      *                  *---------------------------------------------*
      *                  * Data di aggiornamento                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-let-arc-zvl-dec    to   w-rig-dec-vlt          .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-pre-acr          .
           move      zero                 to   w-rig-prz-acr          .
           move      zero                 to   w-rig-uda-par          .
      ...
      *                          * Sigla valuta                        *
      *                          *-------------------------------------*
           move      rf-aaq-sgl-vlt       to   srt-sgl-vlt            .
      *                          *-------------------------------------*
      *                          * Numero decimali valuta              *
      *                          *-------------------------------------*
           move      rf-aaq-dec-vlt       to   srt-dec-vlt            .
      *                          *-------------------------------------*
      *                          * Numero decimali prezzo              *
      *                          *-------------------------------------*
           move      rf-aaq-dec-prz       to   srt-dec-prz            .
      *                          *-------------------------------------*
      *                          * Codice prodotto numerico            *
      *                          *-------------------------------------*
      ...
      *                          * Prezzo d'acquisto precedente        *
      *                          *-------------------------------------*
           move      rf-aaq-prz-acr       to   srt-pre-acr            .
      *                          *-------------------------------------*
      *                          * Prezzo d'acquisto attuale           *
      *                          *-------------------------------------*
           move      rf-aaq-prz-acr       to   srt-prz-acr            .
      *                          *-------------------------------------*
      *                          * Data aggiornamento                  *
      *                          *-------------------------------------*
           move      rf-aaq-uda-par       to   srt-uda-par            .
      *                  *---------------------------------------------*
      *                  * Rilascio record al sort                     *
      *                  *---------------------------------------------*
           release   srt-rec                                          .
      *                  *---------------------------------------------*
      *                  * A riciclo su record [aaq]                   *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-200.
       stp-srt-inp-999.
           exit.
      ...
      *                      * Prezzo d'acquisto precedente            *
      *                      *-----------------------------------------*
           move      srt-prz-acr          to   w-rig-pre-acr          .
      *                      *-----------------------------------------*
      *                      * Prezzo d'acquisto attuale               *
      *                      *-----------------------------------------*
           move      srt-prz-acr          to   w-rig-prz-acr          .
      *                      *-----------------------------------------*
      *                      * Data aggiornamento                      *
      *                      *-----------------------------------------*
           move      srt-uda-par          to   w-rig-uda-par          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-sgl-vlt        to   rf-aaq-sgl-vlt         .
           move      w-rig-dec-vlt        to   rf-aaq-dec-vlt         .
           move      w-rig-uda-par        to   rf-aaq-uda-par         .
           move      w-rig-prz-acr        to   rf-aaq-prz-acr         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
