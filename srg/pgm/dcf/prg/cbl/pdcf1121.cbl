      ...
      *                       Ultima revisione:    NdK del 08/02/99    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcf1120  *
      *                                                                *
      *                    Stampa Voci descrittive fatturazione        *
      *                    fornitori                                   *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-flg.
      *        *-------------------------------------------------------*
      *        * Flag di intestazione Tipo voce                        *
      *        *-------------------------------------------------------*
           05  w-flg-int-tiv              pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-rot-l01.
               10  w-rot-l01-num-def      pic  9(03)                  .
               10  w-rot-l01-cod-lng      pic  x(03)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   rf-yvf-num-def         .
           move      spaces               to   rf-yvf-cod-def         .
           move      spaces               to   rf-yvf-cod-lng         .
           move      "pgm/dcf/fls/ioc/obj/iofyvf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [ydf]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcf/fls/ioc/obj/iofyvf"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Esclusione voci per stampa conferma ordine      *
      *              *-------------------------------------------------*
           if        rf-yvf-num-def       >    900
                     move  "#"            to   w-cnt-prn-flg-sub      .
       prn-tst-max-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-yvf-num-def       to   w-rot-l01-num-def      .
           move      rf-yvf-cod-lng       to   w-rot-l01-cod-lng      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      w-rot-l01-num-def    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Lettura descrizione tipo spesa              *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODDEF    "         to   f-key                  .
           move      w-rot-l01-num-def    to   rf-ydf-num-def         .
           move      w-rot-l01-cod-lng    to   rf-ydf-cod-lng         .
           move      "pgm/dcf/fls/ioc/obj/iofydf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      006                  to   p-pos                  .
           move      rf-ydf-des-stp       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Attivazione flag di intestazione Tipo voce      *
      *              *-------------------------------------------------*
           move      "#"                  to   w-flg-int-tiv          .
       prn-ini-lr1-999.
           exit.
      ...
      *              * zione tipo voce                                 *
      *              *-------------------------------------------------*
           if        w-flg-int-tiv        =    spaces
                     go to prn-liv-det-220.
           move      spaces               to   w-flg-int-tiv          .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-yvf-cod-lng       to   rf-zln-cod-lng         .
           move      "pgm/dcc/fls/ioc/obj/iofzln"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      "VOCI DESCRITTIVE PER FATTURAZIONE FORNITORI"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Tipo voce (Cod. e descrizione)   Voce descrittiva 
      -              "(Cod. e descr)   Lingua (Cod. e descrizione)  "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
