      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-tip-rec        to   rf-yfx-tip-rec         .
           move      w-tes-cod-fop        to   rf-yfx-cod-fop         .
           move      w-tes-cod-lng        to   rf-yfx-cod-lng         .
           move      01                   to   rf-yfx-num-prg         .
           move      "pgm/dcf/fls/ioc/obj/iofyfx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "TRCLNG    "         to   f-key                  .
           move      02                   to   rf-yfx-tip-rec         .
           move      w-tes-cod-fop        to   rf-yfx-cod-fop         .
           move      w-tes-cod-lng        to   rf-yfx-cod-lng         .
           move      zero                 to   rf-yfx-num-prg         .
           move      "pgm/dcf/fls/ioc/obj/iofyfx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                                  * Test sul massimo            *
      *                                  *-----------------------------*
           if        rf-yfx-tip-rec       not  = 02            or
                     rf-yfx-cod-fop       not  = w-tes-cod-fop or
                     rf-yfx-cod-lng       not  = w-tes-cod-lng
                     go to rou-let-reg-340.
      *                                  *-----------------------------*
      *                                  * Bufferizzazione descrizione *
      *                                  *-----------------------------*
           move      rf-yfx-des-alt       to   w-tes-ded-rig
                                              (1, rf-yfx-num-prg)     .
      *                                  *-----------------------------*
      *                                  * Riciclo su lettura          *
      *                                  *-----------------------------*
      ...
      *                      * Write record [yfx]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-yfx-000      thru wrt-rec-yfx-999        .
      ...
      *                      * Rewrite record [yfx]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-yfx-000      thru rew-rec-yfx-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [yfx]                             *
      *              *-------------------------------------------------*
           perform   del-rec-yfx-000      thru del-rec-yfx-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [yfx]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-yfx-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-fop        to   rf-yfx-cod-fop         .
           move      w-tes-cod-lng        to   rf-yfx-cod-lng         .
           move      w-cix-ctr-001        to   rf-yfx-num-prg         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-ded-rig
                    (1, w-cix-ctr-001)    to   rf-yfx-des-alt         .
       cmp-rec-yfx-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [yfx]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-yfx-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       wrt-rec-yfx-100.
           ...
           if        w-cix-ctr-001        >    10
                     go to wrt-rec-yfx-999.
           if        w-tes-ded-rig
                    (1, w-cix-ctr-001)    =    spaces
                     go to wrt-rec-yfx-500.
      *                  *---------------------------------------------*
      *                  * Composizione record [yfx]                   *
      *                  *---------------------------------------------*
           perform   cmp-rec-yfx-000      thru cmp-rec-yfx-999        .
      *                  *---------------------------------------------*
      *                  * Put record                                  *
      *                  *---------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
           go to     wrt-rec-yfx-520.
       wrt-rec-yfx-999.
           exit.

      *    *===========================================================*
      *    * Riscrittura record [yfx]                                  *
      *    *-----------------------------------------------------------*
       rew-rec-yfx-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       rew-rec-yfx-100.
           add       1                    to   w-cix-ctr-001          .
           if        w-cix-ctr-001        >    10
                     go to rew-rec-yfx-999.
           if        w-tes-ded-rig
                    (1, w-cix-ctr-001)    =    spaces
                     go to rew-rec-yfx-500.
      *                  *---------------------------------------------*
      *                  * Composizione record [yfx]                   *
      *                  *---------------------------------------------*
           perform   cmp-rec-yfx-000      thru cmp-rec-yfx-999        .
      ...
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
           go to     rew-rec-yfx-520.
       rew-rec-yfx-999.
           exit.

      *    *===========================================================*
      *    * Cancellazione record [yfx]                                *
      *    *-----------------------------------------------------------*
       del-rec-yfx-000.
      *              *-------------------------------------------------*
