      ...
      *                    portafoglio                                 *
      *                                                                *
      *                    Sottoprogramma per la stampa dei fornitori  *
      *                    con utenze errate :                         *
      *                                                                *
      *                    - Telefono                                  *
      *                    - Fax                                       *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   CONTROLLO UTENZE ERRATE FORNITORI    "       .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-utz.
               10  w-exp-tip-utz-num      pic  9(02)       value 05   .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Questo programma seleziona e stampa i fornitori pe
      -              "r i quali le utenze presentano"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *                  *---------------------------------------------*
           if        rf-adc-tip-arc       =    11
                     perform stp-srt-inp-fnt-000
                                          thru stp-srt-inp-fnt-999
           else if   rf-adc-tip-arc       =    12
                     perform stp-srt-inp-dcf-000
                                          thru stp-srt-inp-dcf-999
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-adc-cod-arc       to   srt-cod-fnt            .
           move      spaces               to   srt-dpz-fnt            .
           move      rf-fnt-rag-soc       to   srt-adc-rag-soc        .
           move      rf-adc-tip-con       to   srt-adc-tip-con        .
           move      rf-adc-num-con       to   srt-adc-num-con        .
           move      "*"                  to   srt-adc-fnt-dcf        .
       stp-srt-inp-fnt-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   srt-rec                .
           move      rf-adc-cod-arc       to   srt-cod-fnt            .
           move      rf-adc-dpz-arc       to   srt-dpz-fnt            .
           move      rf-dcf-rag-soc       to   srt-adc-rag-soc        .
           move      rf-adc-tip-con       to   srt-adc-tip-con        .
           move      rf-adc-num-con       to   srt-adc-num-con        .
           move      " "                  to   srt-adc-fnt-dcf        .
       stp-srt-inp-dcf-900.
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun fornitore con utenze errate da segnalare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           go to     int-pag-sta-010
                     ...
                     depending   on rr-tip-utz.
       int-pag-sta-010.
           move      "FORNITORI CON NUMERO TELEFONO NON CORRETTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-020.
           move      "FORNITORI CON NUMERO FAX NON CORRETTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-030.
           move      "FORNITORI CON NUMERO CELLULARE NON CORRETTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-040.
           move      "FORNITORI CON INDIRIZZO E-MAIL NON CORRETTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-050.
           move      "FORNITORI CON INDIRIZZO WWW NON CORRETTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-090.
           move      "DT"                 to   s-ope                  .
