      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su tabella annotazioni for-  *
      *                    nitori                                      *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
      *                  * Completamento dipendenza fornitore          *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-fnt           to   rf-dfx-cod-fnt         .
           move      rr-dpz-fnt           to   rf-dfx-dpz-fnt         .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [dfx]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcf/fls/ioc/obj/iofdfx"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-dfx-cod-fnt       not  = rr-cod-fnt
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
      *              *-------------------------------------------------*
      *              * Test su Codice dipendenza fornitore             *
      *              *-------------------------------------------------*
           if        rf-dfx-dpz-fnt       not  = rr-dpz-fnt
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
       qry-tst-max-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      07                   to   v-pos                  .
           move      rf-dfx-ann-rig (1)   to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-dfx-cod-ann       to   w-mpn-cod-ann          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Literal per codice dipendenza fornitore     *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Ragione sociale dipendenza del fornitore    *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
