      ...
      *                    prompts in stampa conferma ordini a forni-  *
      *                    tori                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "NOMI CAMPI PER STAMPA ORDINI A FORNITORI"       .
      ...
      *        *-------------------------------------------------------*
           05  w-rig-val-aep     occurs 2.
               ...
               10  w-rig-cod-def          pic  x(03)                  .
               10  w-rig-des-stp          pic  x(40)                  .
               10  w-rig-des-stp-car      pic  9(03)                  .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-des-stp-car (1)  .
      ...
      *                  *---------------------------------------------*
           move      w-pmt-cof-ctr        to   w-rig-num-prg (1)      .
           move      w-pmt-cof-cod
                    (w-pmt-cof-ctr)       to   w-rig-num-def (1)      .
           move      w-pmt-cof-des
                    (w-pmt-cof-ctr)       to   w-rig-num-def-des (1)  .
           move      spaces               to   w-rig-cod-def (1)      .
           move      w-pmt-cof-car
                    (w-pmt-cof-ctr)       to   w-rig-des-stp-car (1)  .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-num-def (1)    to   rf-yvf-num-def         .
           move      w-rig-cod-def (1)    to   rf-yvf-cod-def         .
      ...
      *                      *-----------------------------------------*
           move      w-pmt-cof-des
                    (w-pmt-cof-ctr)       to   w-rig-des-stp (1)      .
      *                          *-------------------------------------*
      ...
      *                      * Se record [yvf] non trovato             *
      *                      *-----------------------------------------*
           move      rf-yvf-des-stp       to   w-rig-des-stp (1)      .
      *                          *-------------------------------------*
      *                          * A valori precedenti                 *
      *                          *-------------------------------------*
           go to     rou-let-reg-600.
      ...
      *                      *-----------------------------------------*
           ...
           move      w-pmt-cof-ctr        to   w-cat-rig-prg          .
           move      w-rig                to   w-cat-rig-buf          .
           perform   cll-sub-cat-000      thru cll-sub-cat-999        .
      *                  *---------------------------------------------*
      *                  * Riciclo                                     *
      ...
      *                  *---------------------------------------------*
       ...
       del-mov-fil-500.
      *              *-------------------------------------------------*
      *              * Cancellazione testata file [yvf]                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Delete record [yvf]                         *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-cod-def (1)    to   rf-yvf-cod-def         .
           move      w-tes-cod-lng        to   rf-yvf-cod-lng         .
           move      w-rig-des-stp (1)    to   rf-yvf-des-stp         .
           move      w-rig-alx-exp (1)    to   rf-yvf-alx-exp         .
       cmp-rec-yvf-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record righe [yvf]                              *
      *    *-----------------------------------------------------------*
       wrt-rec-yvf-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      ...
      *    *===========================================================*
      *    * Cancellazione record righe [yvf]                          *
      *    *-----------------------------------------------------------*
       del-rec-yvf-000.
      *              *-------------------------------------------------*
      *              * Composizione chiave primaria                    *
      *              *-------------------------------------------------*
           move      w-rig-num-def (2)    to   rf-yvf-num-def         .
           move      w-rig-cod-def (2)    to   rf-yvf-cod-def         .
           move      w-tes-cod-lng        to   rf-yvf-cod-lng         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-sub-cat-000.
           cancel    "pgm/dcf/prg/obj/pdcf0902"                       .
       cnc-sub-cat-999.
           exit.
