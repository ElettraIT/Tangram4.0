      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcf512   *
      *                                                                *
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-aaf-tip-mag       not  = 03             or
                     rf-aaf-num-pro       not  = rf-dpm-num-map
                     go to stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Lettura record [dcf]                            *
      *              *-------------------------------------------------*
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      w-stp-srt-inp-ctr    to   srt-ctr-dpm            .
      ...
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      rf-dpm-cla-map       to   srt-cod-cla            .
           move      rf-dpm-gru-map       to   srt-cod-gru            .
           move      rf-dpm-sgr-map       to   srt-cod-sgr            .
           move      rf-dpm-alf-map       to   srt-alf-pro            .
           move      rf-dpm-des-map       to   srt-des-pro            .
           move      rf-dcf-rag-soc       to   srt-rag-soc            .
           move      rf-aaf-cop-sfn       to   srt-cop-sfn            .
           if        rf-aaf-snx-tum       not  = "S"
                     move  rf-dpm-umi-prd to   srt-uni-mis
      ...
      *              * Contatore records [dpm] letti                   *
      *              *-------------------------------------------------*
           move      srt-ctr-dpm          to   w-rot-l02-ctr-dpm      .
      *              *-------------------------------------------------*
      *              * Codice fornitore                                *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      spaces               to   w-prn-ini-lr2-x96      .
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      w-prn-ini-lr2-x96    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "CONDIZIONI D'ACQUISTO MATERIE PRIME"
