      ...
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [yvf]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-yvf.
               10  w-let-arc-yvf-flg      pic  x(01)                  .
               10  w-let-arc-yvf-voc      pic  9(03)                  .
               10  w-let-arc-yvf-lng      pic  x(03)                  .
               10  w-let-arc-yvf-cod      pic  x(03)                  .
               10  w-let-arc-yvf-des      pic  x(25)                  .
      *        *-------------------------------------------------------*
      ...
      *                * - 01 : A percentuale fissa per tutti i forni- *
      *                *        tori cui viene addebitata la spesa     *
      *                * - 02 : A percentuale variabile per ogni for-  *
      *                *        nitore cui viene addebitata la spesa,  *
      *                *        con la percentuale di spesa espressa   *
      *                *        nel record dati commerciali fornitore  *
      *                * - 03 : Ad importo fisso per tutti i fornitori *
      *                *        cui viene addebitata la spesa          *
      *                * - 04 : Ad importo variabile per tutti i for-  *
      *                *        nitori cui viene addebitata la spesa,  *
      *                *        con l'importo della spesa espresso nel *
      *                *        record dati commerciali fornitore      *
      *                * - 05 : A seconda dei fornitori, per ognuno    *
      *                *        dezi quali si esprimera', nel record   *
      *                *        dat commerciali, se la spesa :         *
      *                *        - non va' addebitata                   *
      ...
      *    *===========================================================*
      *    * Work area per bufferizzazione fornitore principale        *
      *    *-----------------------------------------------------------*
       01  w-buf.
      *        *-------------------------------------------------------*
      *        * Scheda completa fornitore                             *
      *        *-------------------------------------------------------*
           05  w-buf-ide-dat              pic  9(07)                  .
           05  w-buf-ide-ute              pic  x(08)                  .
           05  w-buf-ide-fas              pic  x(06)                  .
           05  w-buf-cod-fnt              pic  9(07)                  .
           05  w-buf-dpz-fnt              pic  x(04)                  .
           05  w-buf-rag-key              pic  x(40)                  .
           05  w-buf-rag-soc              pic  x(40)                  .
           05  w-buf-via-dcf              pic  x(40)                  .
           05  w-buf-loc-dcf              pic  x(40)                  .
           ...
           05  w-buf-noi-cli              pic  x(15)                  .
           05  w-buf-ctp-acq              pic  9(07)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Codice fornitore che ha provocato la rottura          *
      *        *-------------------------------------------------------*
           05  w-buf-rot-fnt              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice dipendenza fornitore che ha provocato la rot-  *
      *        * tura                                                  *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-pcl-lit-max              pic  9(03)      value 035   .
           ...
           05  w-pcl-lit-gen.
               ...
               10  filler                 pic  x(50)      value
                  "032 003 Ns. codice come cliente ...:              ".
               10  filler                 pic  x(50)      value
                  "032 003 Sottoconto acquisti .......:              ".
               10  filler                 pic  x(50)      value
                  "032 003 Ordini ....................:              ".
               10  filler                 pic  x(50)      value
                  "046 003 Sconto in riga fattura     - % di sconto :".
               10  filler                 pic  x(50)      value
                  "046 003 Sconto in chiusura fattura - % di sconto :".
               10  filler                 pic  x(50)      value
               ...
               10  filler                 pic  x(50)      value
                  "032 003 Conto corrente fornitore ..:              ".
               10  filler                 pic  x(50)      value
                  "032 003 Addebito spese incasso ....:              ".
               10  filler                 pic  x(50)      value
                  "032 003 Addebito spese bollo ......:              ".
               10  filler                 pic  x(50)      value
                  "032 003 Conto nostra banca ........:              ".
               10  filler                 pic  x(50)      value
                  "032 003 Conto corrente postale ....:              ".
               10  filler                 pic  x(50)      value
      ...
      *              * Codice fornitore                                *
      *              *-------------------------------------------------*
           move      rf-dcf-cod-fnt       to   w-rot-l01-cod-fnt      .
       prn-cmp-rot-999.
           exit.
      ...
      *              * Elementi di rottura                             *
      *              *-------------------------------------------------*
           move      w-rot-l01-cod-fnt    to   w-buf-rot-fnt          .
           move      rf-dcf-dpz-fnt       to   w-buf-rot-dpz          .
       prn-ini-lr1-140.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-ini-lr1-160.
      *              *-------------------------------------------------*
      *              * Lettura record [dcf] per fornitore principale   *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
       ...
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione scheda completa del fornitore   *
      *              * principale                                      *
      *              *-------------------------------------------------*
           move      rf-dcf-cod-fnt       to   w-buf-cod-fnt          .
           move      rf-dcf-dpz-fnt       to   w-buf-dpz-fnt          .
           move      rf-dcf-ide-dat       to   w-buf-ide-dat          .
           move      rf-dcf-ide-ute       to   w-buf-ide-ute          .
           move      rf-dcf-ide-fas       to   w-buf-ide-fas          .
           move      rf-dcf-rag-soc       to   w-buf-rag-soc          .
           move      rf-dcf-via-dcf       to   w-buf-via-dcf          .
           move      rf-dcf-loc-dcf       to   w-buf-loc-dcf          .
           move      rf-dcf-cod-naz       to   w-buf-cod-naz          .
           move      rf-dcf-cod-cmn       to   w-buf-cod-cmn          .
           move      rf-dcf-cod-fzn       to   w-buf-cod-fzn          .
           move      rf-dcf-cod-lct       to   w-buf-cod-lct          .
           move      rf-dcf-rs1-doc       to   w-buf-rs1-doc          .
           move      rf-dcf-rs2-doc       to   w-buf-rs2-doc          .
           move      rf-dcf-inl-dcm       to   w-buf-inl-dcm          .
           move      rf-dcf-inl-pgt       to   w-buf-inl-pgt          .
           move      rf-dcf-noi-cli       to   w-buf-noi-cli          .
           move      rf-dcf-ctp-acq       to   w-buf-ctp-acq          .
           move      rf-dcf-per-fat       to   w-buf-per-fat          .
           move      rf-dcf-rag-bft       to   w-buf-rag-bft          .
           move      rf-dcf-cod-vlt       to   w-buf-cod-vlt          .
           move      rf-dcf-cod-lng       to   w-buf-cod-lng          .
           move      rf-dcf-cod-lst       to   w-buf-cod-lst          .
           move      rf-dcf-cat-scr       to   w-buf-cat-scr          .
           move      rf-dcf-per-scr (1)   to   w-buf-per-scr (1)      .
           move      rf-dcf-per-scr (2)   to   w-buf-per-scr (2)      .
           move      rf-dcf-per-scr (3)   to   w-buf-per-scr (3)      .
           move      rf-dcf-per-scr (4)   to   w-buf-per-scr (4)      .
           move      rf-dcf-per-scr (5)   to   w-buf-per-scr (5)      .
           move      rf-dcf-cat-scc       to   w-buf-cat-scc          .
           move      rf-dcf-per-scc       to   w-buf-per-scc          .
           move      rf-dcf-snm-spe (1)   to   w-buf-snm-spe (1)      .
           move      rf-dcf-snm-spe (2)   to   w-buf-snm-spe (2)      .
           move      rf-dcf-snm-spe (3)   to   w-buf-snm-spe (3)      .
           move      rf-dcf-snm-spe (4)   to   w-buf-snm-spe (4)      .
           move      rf-dcf-snm-spe (5)   to   w-buf-snm-spe (5)      .
           move      rf-dcf-snm-spe (6)   to   w-buf-snm-spe (6)      .
           move      rf-dcf-per-spe (1)   to   w-buf-per-spe (1)      .
           move      rf-dcf-per-spe (2)   to   w-buf-per-spe (2)      .
           move      rf-dcf-per-spe (3)   to   w-buf-per-spe (3)      .
           move      rf-dcf-per-spe (4)   to   w-buf-per-spe (4)      .
           move      rf-dcf-per-spe (5)   to   w-buf-per-spe (5)      .
           move      rf-dcf-per-spe (6)   to   w-buf-per-spe (6)      .
           move      rf-dcf-imp-spe (1)   to   w-buf-imp-spe (1)      .
           move      rf-dcf-imp-spe (2)   to   w-buf-imp-spe (2)      .
           move      rf-dcf-imp-spe (3)   to   w-buf-imp-spe (3)      .
           move      rf-dcf-imp-spe (4)   to   w-buf-imp-spe (4)      .
           move      rf-dcf-imp-spe (5)   to   w-buf-imp-spe (5)      .
           move      rf-dcf-imp-spe (6)   to   w-buf-imp-spe (6)      .
           move      rf-dcf-vde-cod (1)   to   w-buf-vde-cod (1)      .
           move      rf-dcf-vde-cod (2)   to   w-buf-vde-cod (2)      .
           move      rf-dcf-vde-cod (3)   to   w-buf-vde-cod (3)      .
           move      rf-dcf-vde-cod (4)   to   w-buf-vde-cod (4)      .
           move      rf-dcf-vde-cod (5)   to   w-buf-vde-cod (5)      .
           move      rf-dcf-vde-cod (6)   to   w-buf-vde-cod (6)      .
           move      rf-dcf-cod-fop       to   w-buf-cod-fop          .
           move      rf-dcf-tip-esm       to   w-buf-tip-esm          .
           move      rf-dcf-ggg-alt       to   w-buf-ggg-alt          .
           move      rf-dcf-mmm-e01       to   w-buf-mmm-e01          .
           move      rf-dcf-mmm-e02       to   w-buf-mmm-e02          .
           move      rf-dcf-add-spi       to   w-buf-add-spi          .
           move      rf-dcf-add-spb       to   w-buf-add-spb          .
           move      rf-dcf-nos-ban       to   w-buf-nos-ban          .
           move      rf-dcf-ccp-app       to   w-buf-ccp-app          .
           move      rf-dcf-cod-abi       to   w-buf-cod-abi          .
           move      rf-dcf-cod-cab       to   w-buf-cod-cab          .
           move      rf-dcf-ccc-app       to   w-buf-ccc-app          .
           move      rf-dcf-ipr-iel       to   w-buf-ipr-iel          .
           move      rf-dcf-cod-zon       to   w-buf-cod-zon          .
           move      rf-dcf-cod-cat       to   w-buf-cod-cat          .
           move      rf-dcf-cod-stt       to   w-buf-cod-stt          .
           move      rf-dcf-cla-bdg       to   w-buf-cla-bdg          .
           move      rf-dcf-for-blo       to   w-buf-for-blo          .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-ini-lr1-482.
           ...
           move      w-prs-vde-fat-i02    to   w-let-arc-yvf-voc      .
           move      w-buf-cod-lng        to   w-let-arc-yvf-lng      .
           move      w-buf-vde-cod
                    (w-prs-vde-fat-i02)   to   w-let-arc-yvf-cod      .
           perform   let-arc-yvf-000      thru let-arc-yvf-999        .
           move      w-let-arc-yvf-des    to   w-buf-vde-cod-des
                                              (w-prs-vde-fat-i02)     .
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-fnt                 .
      *                  *---------------------------------------------*
      *                  * Lettura record [fnt] per bufferizzazione    *
      *                  * dati contabili                              *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODFNT"             to   f-key                  .
      ...
      *                  *---------------------------------------------*
           move      rf-fnt-prt-iva       to   w-buf-prt-iva          .
           move      rf-fnt-cod-fis       to   w-buf-cod-fis          .
           move      rf-fnt-cod-mne       to   w-buf-cod-mne          .
           move      rf-fnt-cod-cge       to   w-buf-cod-cge          .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODFNT"             to   f-key                  .
           move      w-buf-rot-fnt        to   rf-dcf-cod-fnt         .
           move      w-buf-rot-dpz        to   rf-dcf-dpz-fnt         .
           move      "pgm/dcf/fls/ioc/obj/iofdcf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *                                                 *
      *              * N.B.: Questa selezione si opera solo nel caso   *
      *              *       che sia stata richiesta la stampa di una  *
      *              *       singola scheda dal programma di gestione  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test sul flag di selezione proveniente dal  *
      *                  * programma di gestione                       *
      *                  *---------------------------------------------*
           if        rr-sel-fnt-dpz       =    spaces
                     go to prn-liv-det-080.
           if        rf-dcf-dpz-fnt       not  = rr-sel-fnt-dpz
      ...
      *              *-------------------------------------------------*
      *              * Stampa Scheda completa del fornitore            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-buf-cod-fnt        to   d-con-arc-cod-arc      .
           move      w-buf-dpz-fnt        to   d-con-arc-dpz-arc      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-260.
      *                  *---------------------------------------------*
      *                  * Sottoconto contabile per l'acquisto         *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Literal                                 *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-prs-liv-pdc        to   w-edt-cod-pdc-liv      .
           move      w-buf-ctp-acq        to   w-edt-cod-pdc-cod      .
           move      "B"                  to   w-edt-cod-pdc-edm      .
           perform   edt-pdc-asx-000      thru edt-pdc-asx-999        .
      *                      *-----------------------------------------*
      *                      * Campo                                   *
      ...
      *                          * Lettura file [pdc]                  *
      *                          *-------------------------------------*
           move      w-buf-ctp-acq        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
      *                          *-------------------------------------*
      *                          * Stampa                              *
      *                          *-------------------------------------*
      ...
      *                          * Lettura file [yfp]                  *
      *                          *-------------------------------------*
           move      w-buf-cod-fop        to   w-let-arc-yfp-cod      .
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      044                  to   p-pos                  .
           move      w-let-arc-yfp-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-364.
      *                  *---------------------------------------------*
      ...
      *                          * Lettura file [yin]                  *
      *                          *-------------------------------------*
           move      w-buf-add-spi        to   w-let-arc-yin-cod      .
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      044                  to   p-pos                  .
           move      w-let-arc-yin-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-396.
      *                  *---------------------------------------------*
      ...
      *                          * Lettura file [ybo]                  *
      *                          *-------------------------------------*
           move      w-buf-add-spb        to   w-let-arc-ybo-cod      .
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      044                  to   p-pos                  .
           move      w-let-arc-ybo-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-404.
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-buf-cod-zon        to   w-let-arc-yst-cod      .
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      044                  to   p-pos                  .
           move      w-let-arc-yst-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-452.
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-buf-cod-cat        to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                          *-------------------------------------*
      *                          * Stampa                              *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-buf-cod-stt        to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                          *-------------------------------------*
      *                          * Stampa                              *
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-buf-cod-fnt        to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Prompt                                      *
      *                  *---------------------------------------------*
           string    "Scheda Fornitore : "
                                delimited by   size
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [yvf]                         *
      *    *-----------------------------------------------------------*
       let-arc-yvf-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione marker di uscita                *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-yvf-flg      .
      *              *-------------------------------------------------*
      *              * Test se codice voce descrittiva a spaces        *
      *              *-------------------------------------------------*
           if        w-let-arc-yvf-cod    =    spaces
                     go to let-arc-yvf-500.
      *              *-------------------------------------------------*
      *              * Lettura per codice                              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODVDF    "         to   f-key                  .
           move      w-let-arc-yvf-voc    to   rf-yvf-num-def         .
           move      w-let-arc-yvf-cod    to   rf-yvf-cod-def         .
           move      w-let-arc-yvf-lng    to   rf-yvf-cod-lng         .
           move      "pgm/dcf/fls/ioc/obj/iofyvf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-yvf                 .
           if        f-sts                not  = e-not-err
                     go to let-arc-yvf-400.
       let-arc-yvf-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-yvf-des-stp       to   w-let-arc-yvf-des      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     let-arc-yvf-999.
       let-arc-yvf-400.
      *              *-------------------------------------------------*
      *              * Azioni per record non trovato                   *
      *              *-------------------------------------------------*
           move      "#"                  to   w-let-arc-yvf-flg      .
           move      all   "."            to   w-let-arc-yvf-des      .
           go to     let-arc-yvf-999.
       let-arc-yvf-500.
      *              *-------------------------------------------------*
      *              * Normalizzazione work area                       *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-yvf-des      .
       let-arc-yvf-999.
           exit.
      ...
      *                  * fissa per tutti i fornitori cui viene adde- *
      *                  * bitata la spesa, oppure                     *
      *                  * Se tipo funzionamento : 03, ad importo fis- *
      *                  * so per tutti i fornitori cui viene addebi-  *
      *                  * tata la spesa                               *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                  * variabile per ogni fornitore cui viene ad-  *
      *                  * debitata la spesa, con la percentuale spesa *
      ...
      *                  * riabile per ogni fornitore cui viene adde-  *
      *                  * bitata la spesa, con l'importo spesa        *
      *                  * espresso nel record dati commerciali forni- *
      *                  * tore                                        *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Stampa tipo di addebito                 *
