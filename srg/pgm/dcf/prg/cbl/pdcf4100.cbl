      ...
      *                       Ultima revisione:    NdK del 05/08/99    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcf4101:        *
      *                                                                *
           ...
           05  w-exp-tip-ord.
               ...
               10  w-exp-tip-ord-tbl.
                   ...
                   15  filler             pic  x(40) value
                         "Per zona fornitore                      "   .
                   15  filler             pic  x(40) value
                         "Per categoria fornitore                 "   .
                   15  filler             pic  x(40) value
                         "Per codice statistico fornitore         "   .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Tipo anagrafica fornitore                  *
      *        *-------------------------------------------------------*
           05  w-exp-tip-ana.
               ...
               10  w-exp-tip-ana-tbl.
                   15  filler             pic  x(40) value
                         "Anagrafica commerciale del fornitore    "   .
                   15  filler             pic  x(40) value
                         "Anagrafica contabile del fornitore      "   .
      *        *-------------------------------------------------------*
      ...
      *              * Se tipo di ordinamento 01                       *
      *              *-------------------------------------------------*
           perform   pmt-mmx-fnt-000      thru pmt-mmx-fnt-999        .
           go to     pmt-min-max-999.
       pmt-min-max-200.
      *              *-------------------------------------------------*
      *              * Se tipo di ordinamento 02                       *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-zon-min           to   w-cmn-yst-001-cod      .
           move      14                   to   w-cmn-yst-001-lin      .
           move      30                   to   w-cmn-yst-001-pos      .
           move      14                   to   w-cmn-yst-001-dln      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-zon-min           to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   rr-zon-min-des         .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-001-ope      .
           move      rr-zon-max           to   w-cmn-yst-001-cod      .
           move      15                   to   w-cmn-yst-001-lin      .
           move      30                   to   w-cmn-yst-001-pos      .
           move      15                   to   w-cmn-yst-001-dln      .
           move      41                   to   w-cmn-yst-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *                  *---------------------------------------------*
           move      01                   to   w-let-arc-yst-tip      .
           move      rr-zon-max           to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   rr-zon-max-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cat-min           to   w-cmn-yst-002-cod      .
           move      14                   to   w-cmn-yst-002-lin      .
           move      30                   to   w-cmn-yst-002-pos      .
           move      14                   to   w-cmn-yst-002-dln      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cat-min           to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   rr-cat-min-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-002-ope      .
           move      rr-cat-max           to   w-cmn-yst-002-cod      .
           move      15                   to   w-cmn-yst-002-lin      .
           move      30                   to   w-cmn-yst-002-pos      .
           move      15                   to   w-cmn-yst-002-dln      .
           move      41                   to   w-cmn-yst-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *                  *---------------------------------------------*
           move      02                   to   w-let-arc-yst-tip      .
           move      rr-cat-max           to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   rr-cat-max-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-stt-min           to   w-cmn-yst-003-cod      .
           move      14                   to   w-cmn-yst-003-lin      .
           move      30                   to   w-cmn-yst-003-pos      .
           move      14                   to   w-cmn-yst-003-dln      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-stt-min           to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   rr-stt-min-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-yst-003-ope      .
           move      rr-stt-max           to   w-cmn-yst-003-cod      .
           move      15                   to   w-cmn-yst-003-lin      .
           move      30                   to   w-cmn-yst-003-pos      .
           move      15                   to   w-cmn-yst-003-dln      .
           move      41                   to   w-cmn-yst-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *                  *---------------------------------------------*
           move      03                   to   w-let-arc-yst-tip      .
           move      rr-stt-max           to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yst-des    to   rr-stt-max-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-175.
      *                  *---------------------------------------------*
      *                  * Tipo di anagrafica fornitore                *
      *                  *---------------------------------------------*
           if        rr-tip-ana           not  = zero
                     go to tdo-ric-sel-176.
           move      "Manca il tipo di anagrafica Fornitore !           
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-176.
           if        rr-tip-eti           not  > w-exp-tip-eti-num
                     go to tdo-ric-sel-177.
           move      "Tipo di anagrafica Fornitore errato !             
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-177.
