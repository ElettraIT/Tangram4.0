      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcf1521:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo di ordinamento per stampa             *
      *        *-------------------------------------------------------*
           05  w-exp-tip-ord.
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipo ordinamento per stampa     :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su forme di pagamento :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-yfp-cod      .
           move      14                   to   w-cod-mne-yfp-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-yfp-ope      .
           move      rr-cod-max           to   w-cod-mne-yfp-cod      .
           move      14                   to   w-cod-mne-yfp-lin      .
           move      52                   to   w-cod-mne-yfp-pos      .
           move      zero                 to   w-cod-mne-yfp-dln      .
           move      zero                 to   w-cod-mne-yfp-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
