      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella Tipi Voci descrittive per  *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " TIPI VOCI DESCRITTIVE FATTURE FORNITORI"       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               ...
               10  w-tes-des-stp          pic  x(12)                  .
               10  w-tes-alx-exp          pic  x(60)                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-num-def-000.
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Codice tipo voce descrittiva   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       pmt-num-def-999.
      ...
      *    *-----------------------------------------------------------*
       pmt-des-ves-000.
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Descrizione per video estesa   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-des-ves-999.
      ...
      *    *-----------------------------------------------------------*
       pmt-des-vri-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Descrizione per video ridotta  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-des-vri-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-num-def        to   rf-ydf-num-def         .
           move      w-tes-cod-lng        to   rf-ydf-cod-lng         .
           move      "pgm/dcf/fls/ioc/obj/iofydf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [ydf]                        *
      *                          *-------------------------------------*
           move      rf-ydf-des-ves       to   w-tes-des-ves (1)      .
           move      rf-ydf-des-vri       to   w-tes-des-vri (1)      .
           move      rf-ydf-des-stp       to   w-tes-des-stp (1)      .
           move      rf-ydf-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *              * codice 'I'                                      *
      *              *-------------------------------------------------*
           move      w-tes-num-def        to   w-ric-cod-ita-spf      .
      ...
      *                      * Write record [ydf]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-ydf-000      thru wrt-rec-ydf-999        .
      ...
      *                      * Rewrite record [ydf]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-ydf-000      thru rew-rec-ydf-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [ydf]                             *
      *              *-------------------------------------------------*
           perform   del-rec-ydf-000      thru del-rec-ydf-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [ydf]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-ydf-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-lng        =    "I  "
                     go to cmp-rec-ydf-200.
           move      spaces               to   rf-ydf-des-ves         .
           move      spaces               to   rf-ydf-des-vri         .
           go to     cmp-rec-ydf-500.
       cmp-rec-ydf-200.
           move      w-tes-des-ves (1)    to   rf-ydf-des-ves         .
           move      w-tes-des-vri (1)    to   rf-ydf-des-vri         .
       cmp-rec-ydf-500.
           move      w-tes-des-stp (1)    to   rf-ydf-des-stp         .
           move      w-tes-alx-exp (1)    to   rf-ydf-alx-exp         .
       cmp-rec-ydf-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [ydf]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-ydf-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-ydf-000      thru cmp-rec-ydf-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
      *              * Lettura della tabella [ydf]                     *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODDEF    "         to   f-key                  .
           move      w-ric-cod-ita-spf    to   rf-ydf-num-def         .
      ...
      *                      * da visualizzare                         *
      *                      *-----------------------------------------*
           move      rf-ydf-des-ves       to   w-ric-cod-ita-ves      .
           move      rf-ydf-des-vri       to   w-ric-cod-ita-vri      .
      *                          *-------------------------------------*
      *                          * Uscita                              *
      *                          *-------------------------------------*
           go to     ric-cod-ita-999.
