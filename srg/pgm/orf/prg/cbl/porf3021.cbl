      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma orf302   *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-dat-ini           to   rf-oft-dat-doc         .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-020.
      *              *-------------------------------------------------*
      *              * Start su archivio [oft] per data ultima modifi- *
      *              * ca                                              *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATSYS    "         to   f-key                  .
           move      rr-dat-ini           to   rf-oft-ide-dat         .
      ...
      *                      *-----------------------------------------*
           ...
           if        rf-oft-ide-ute       not  = rr-cod-ute
                     go to stp-srt-inp-100.
       stp-srt-inp-330.
      *                      *-----------------------------------------*
      *                      * Test su codice fase                     *
      *                      *-----------------------------------------*
           ...
           if        rf-oft-ide-fas       not  = rr-cod-fas
                     go to stp-srt-inp-100.
       stp-srt-inp-340.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           if        rf-oft-tmo-orf       not  = rr-cod-toc
                     go to stp-srt-inp-100.
       stp-srt-inp-500.
      *                  *---------------------------------------------*
      ...
      *                          * Data documento                      *
      *                          *-------------------------------------*
           move      rf-oft-dat-doc       to   srt-dat-doc            .
      *                          *-------------------------------------*
      *                          * Numero documento                    *
      *                          *-------------------------------------*
           move      rf-oft-num-doc       to   w-det-num-doc          .
      ...
      *                          * Tipo documento                      *
      *                          *-------------------------------------*
           move      rf-oft-tmo-orf       to   srt-tip-doc            .
      *                          *-------------------------------------*
      *                          * Tipo archivio                       *
      *                          *-------------------------------------*
           move      rf-oft-tip-arc       to   srt-tip-arc            .
      *                          *-------------------------------------*
      *                          * Codice archivio                     *
      *                          *-------------------------------------*
           move      rf-oft-cod-arc       to   srt-cod-arc            .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-oft-sgl-vpf       to   srt-sgl-vpf            .
      *                          *-------------------------------------*
      *                          * Decimali valuta documento           *
      *                          *-------------------------------------*
           move      rf-oft-dec-vpf       to   srt-dec-vpf            .
      *                          *-------------------------------------*
      ...
      *                          * Data ultima modifica                *
      *                          *-------------------------------------*
           move      rf-oft-ide-dat       to   srt-ide-dat            .
      *                          *-------------------------------------*
      *                          * Utente                              *
      *                          *-------------------------------------*
           move      rf-oft-ide-ute       to   srt-ide-ute            .
      *                          *-------------------------------------*
      *                          * Fase                                *
      *                          *-------------------------------------*
           move      rf-oft-ide-fas       to   srt-ide-fas            .
      *                          *-------------------------------------*
      *                          * Data conferma                       *
      *                          *-------------------------------------*
           move      rf-oft-cof-dat       to   srt-cof-dat            .
      *                          *-------------------------------------*
      *                          * Nr. conferma                        *
      *                          *-------------------------------------*
           move      rf-oft-cof-num       to   srt-cof-num            .
       stp-srt-inp-800.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-900.
      *                  *---------------------------------------------*
      *                  * Riciclo a record [oft] successivo           *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-100.
       stp-srt-inp-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "BROGLIACCIO ORDINI FORNITORI"
