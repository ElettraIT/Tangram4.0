      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Pulizia ordini fornitori                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     PULIZIA ORDINI FORNITORI CHIUSI    "       .
      ...
      *    *-----------------------------------------------------------*
       01  f-xxx.
           05  f-xxx-nam                  pic  x(04)   value "oft "   .
      ...
      *    *-----------------------------------------------------------*
       pmt-snx-cnc-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Cancellazione anche di ordini inevasi o non chiusi
      -              " ............... :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *    *-----------------------------------------------------------*
       pmt-not-ben-000.
           ...
           move      14                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "N.B.: Il programma cancella solo gli ordini consol
      -              "idati, cioe' chiusi, fino alla"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
       ...
       pul-let-seq-200.
      *              *-------------------------------------------------*
      *              * Incremento contatore records [oft] letti        *
      *              *-------------------------------------------------*
      ...
      *              * tare                                            *
      *              *-------------------------------------------------*
           if        rf-oft-dat-doc       >    rr-dat-pul
                     go to pul-sel-rec-800.
       pul-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Se pulizia anche di ordini comunque non chiusi, *
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [oft] scritti  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "#"                  to   w-cnt-pul-flg-sub      .
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [oft] elimina- *
      *                  * ti                                          *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione contatore records [ofr]     *
      *                  * scritti                                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-ofr-num-prt       not  = rf-oft-num-prt
                     go to pul-put-app-200.
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [ofr] scritti  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       pul-put-app-200.
      *              *-------------------------------------------------*
      *              * Test su contatore records [ofr] scritti : se a  *
      *              * zero si esce                                    *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       pul-put-app-400.
      *                  *---------------------------------------------*
      *                  * Lettura sequenziale record [ofx]            *
      *                  *---------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/orf/fls/ioc/obj/iofofx"
                                          to   s-pat                  .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-ofx-num-prt       not  = rf-oft-num-prt
                     go to pul-put-app-600.
      *                  *---------------------------------------------*
      *                  * Put record in file di appoggio              *
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-ofx                 .
      *                  *---------------------------------------------*
      *                  * Riciclo su lettura sequenziale record [ofx] *
      *                  *---------------------------------------------*
