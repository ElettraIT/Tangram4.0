      ...
      *                                   Fase:    orf390              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 04/06/93    *
      *                       Ultima revisione:    NdK del 07/06/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Consolidamento ordini fornitori evasi       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CONSOLIDAMENTO ORDINI FORNITORI EVASI "       .
      ...
      *                      *-----------------------------------------*
           ...
           if        s-sts                not  =    spaces
                     ...
                     go to acc-dat-orf-040.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione valore di default       *
      *                      *-----------------------------------------*
           move      s-dat                to   rr-dat-orf             .
       acc-dat-orf-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Determinazione se la riga ordine fornitore e'   *
      *              * completamente evasa entro la data massima ri-   *
      *              * chiesta                                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Determinazione quantita' da ricevere riga   *
      *                  * ordine fornitore                            *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test su quantita' ancora da ricevere    *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        d-qev-rof-tip-urc    not  = 01       or
                     d-qev-rof-drg-urc    >    rr-dat-orf
                     go to stp-srt-inp-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-oft-num-prt       to   srt-prt-orf            .
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun ordine fornitore da consolidare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Consolidamento righe ordine fornitore           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Start su file [ofr]                         *
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "NUMPRT    "         to   f-key                  .
           move      srt-prt-orf          to   rf-ofr-num-prt         .
           move      zero                 to   rf-ofr-num-prg         .
           move      "pgm/orf/fls/ioc/obj/iofofr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-ofr                 .
      *                  *---------------------------------------------*
      *                  * Riciclo su prossimo record [ofr]            *
      *                  *---------------------------------------------*
           go to     prn-liv-det-100.
       prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Consolidamento testata ordine fornitore         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      srt-prt-orf          to   rf-oft-num-prt         .
           move      "pgm/orf/fls/ioc/obj/iofoft"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
