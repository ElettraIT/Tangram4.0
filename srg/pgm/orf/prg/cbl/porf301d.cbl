      ...
      *                                                                *
      *                    Ricerca documenti per materia prima         *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-rip-str.
      *        *-------------------------------------------------------*
      *        * Work-area per ripristino Start su [ofr] per Expand    *
      *        *-------------------------------------------------------*
           05  w-rip-str-ofr.
      *            *---------------------------------------------------*
      *            * Flag di End-of-file                               *
      ...
      *    *-----------------------------------------------------------*
       ipc-cod-map-000.
      *              *-------------------------------------------------*
      *              * Estrazione della variabile 'cod-map' dal livelo *
      ...
      *              *-------------------------------------------------*
      *              * Visualizzazione codice materia prima, descriz.  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su [ofr] per materia prima                *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           ...
           move      rr-cod-map           to   rf-ofr-num-mag         .
      ...
      *              *-------------------------------------------------*
           if        rf-ofr-tip-mag       not  = 03
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           if        rf-ofr-num-mag       not  = rr-cod-map
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
       qry-tst-max-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       int-pag-sta-200.
      *              *-------------------------------------------------*
      *              * Sub-intestazione per la materia prima           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Salvataggio parametri per Start su [ofr]    *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       det-tot-doc-000.
      *              *-------------------------------------------------*
      *              * Si prende quello contenuto nel record [oft]     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura record [oft]                        *
      *                  *---------------------------------------------*
           ...
           move      rf-oft-tot-doc       to   w-det-tot-doc-tot      .
       det-tot-doc-999.
           exit.
