      ...
      *                       Ultima revisione:    NdK del 24/04/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma orf540   *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-num-dst           to   rf-ofe-num-dst         .
      ...
      *              * Test max                                        *
      *              *-------------------------------------------------*
           if        rf-ofe-num-dst       not  = rr-num-dst
                     go to stp-srt-inp-900.
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-ofe-num-dst       to   srt-num-dst            .
           move      rf-ofe-num-prg       to   srt-num-prg            .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Cancellazione record [ofe]                                *
      *    *-----------------------------------------------------------*
       del-rec-dst-000.
      *              *-------------------------------------------------*
      *              * Composizione chiave primaria                    *
      *              *-------------------------------------------------*
           move      srt-num-dst          to   rf-ofe-num-dst         .
           move      srt-num-prg          to   rf-ofe-num-prg         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
