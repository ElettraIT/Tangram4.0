      ...
      *                       Ultima revisione:    NdK del 10/05/20    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione singola riga ordine fornitore      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " GESTIONE SINGOLA RIGA ORDINE FORNITORE "       .
      ...
      *              * Pre-accettazione                                *
      *              *-------------------------------------------------*
           move      w-acc-tmo-orf        to   rf-oft-tmo-orf         .
       acc-tmo-orf-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  * Quantita' ordine                            *
      *                  *---------------------------------------------*
           perform   acc-qta-acq-000      thru acc-qta-acq-999        .
           if        v-key                =    "NXSC"
      ...
      *              * Quantita'                                       *
      *              *-------------------------------------------------*
           perform   vis-qta-acq-000      thru vis-qta-acq-999        .
      *              *-------------------------------------------------*
      *              * Protocollo ordine                               *
      *              *-------------------------------------------------*
      ...
      *              * Quantita'                                       *
      *              *-------------------------------------------------*
           perform   pmt-qta-acq-000      thru pmt-qta-acq-999        .
      *              *-------------------------------------------------*
      *              * Protocollo ordine                               *
      *              *-------------------------------------------------*
      ...
      *              * Test                                            *
      *              *-------------------------------------------------*
           if        rf-oft-tmo-orf       =    spaces and
                     rf-oft-dat-doc       =    zero   and
                     rf-oft-num-doc       =    zero
      ...
      *              *-------------------------------------------------*
           move      rf-oft-dat-doc       to   w-acc-dat-doc          .
           move      rf-oft-tmo-orf       to   w-acc-tmo-orf          .
      *              *-------------------------------------------------*
      *              * Start su file [oft]                             *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           if        rf-oft-dat-doc       not  = w-acc-dat-doc or
                     ...
                     rf-oft-tmo-orf       not  = w-acc-tmo-orf or
      ...
      *                  *---------------------------------------------*
           ...
           move      w-acc-num-prg        to   rf-ofr-num-prg         .
           move      "pgm/orf/fls/ioc/obj/iofofr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           perform   vis-tes-reg-000      thru vis-tes-reg-999        .
      *              *-------------------------------------------------*
      *              * Forzatura flag di almeno una modifica           *
      *              *-------------------------------------------------*
           move      "#"                  to   w-cnt-acc-flg-aum      .
       pre-acc-mod-999.
           exit.
      ...
      *              * Scrittura movimento su files                    *
      *              *-------------------------------------------------*
______*    perform   scr-mov-fil-000      thru scr-mov-fil-999        .
       pos-cnf-mod-999.
           exit.
      ...
      *                      * Write record [ofx]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-ofx-000      thru wrt-rec-ofx-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
      ...
      *                      * Rewrite [ofr]                           *
      *                      *-----------------------------------------*
           perform   rew-rec-ofr-000      thru rew-rec-ofr-999        .
      *                      *-----------------------------------------*
      *                      * Rewrite [ofx]                           *
      *                      *-----------------------------------------*
           perform   rew-rec-ofx-000      thru rew-rec-ofx-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete [ofr]                                    *
      *              *-------------------------------------------------*
           perform   del-rec-ofr-000      thru del-rec-ofr-999        .
      *              *-------------------------------------------------*
      *              * Delete [ofx]                                    *
      *              *-------------------------------------------------*
           perform   del-rec-ofx-000      thru del-rec-ofx-999        .
       del-mov-fil-999.
           exit.
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      w-acc-num-prt        to   rf-ofr-num-prt         .
           move      w-acc-num-prg        to   rf-ofr-num-prg         .
       cmp-rec-ofr-999.
           exit.
      ...
      *    *===========================================================*
      *    * Cancellazione record righe [ofr]                          *
      *    *-----------------------------------------------------------*
       del-rec-ofr-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      w-acc-num-prt        to   rf-ofx-num-prt         .
           move      w-acc-num-prg        to   rf-ofx-num-prg         .
           move      11                   to   rf-ofx-tip-rec         .
       cmp-rec-ofx-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record righe [ofx]                              *
      *    *-----------------------------------------------------------*
       wrt-rec-ofx-000.
       wrt-rec-ofx-999.
           exit.
      ...
      *    *===========================================================*
      *    * Cancellazione record righe [ofx]                          *
      *    *-----------------------------------------------------------*
       del-rec-ofx-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-ofx-000      thru cmp-rec-ofx-999        .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           move      w-fnd-arc-oft-toc    to   rf-oft-tmo-orf         .
           move      w-fnd-arc-oft-dat    to   rf-oft-dat-doc         .
           move      w-fnd-arc-oft-num    to   rf-oft-num-doc         .
