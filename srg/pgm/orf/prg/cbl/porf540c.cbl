      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Incremento contatore records [ofe] aggiornati   *
      *              *-------------------------------------------------*
      ...
      *              * Aggiornamento percorso attachement              *
      *              *-------------------------------------------------*
           move      s-pat                to   rf-ofe-eml-all         .
      *              *-------------------------------------------------*
      *              * Aggiornamento flag distinta                     *
      *              *-------------------------------------------------*
           move      "#"                  to   rf-ofe-flg-apr         .
      *              *-------------------------------------------------*
      *              * Update record [ofe]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *                  * Identificatore fase                         *
      *                  *---------------------------------------------*
           move      "orfpdf"             to   w-inp-mst-fas          .
      *                  *---------------------------------------------*
      *                  * Identificatore documento                    *
      *                  *---------------------------------------------*
           move      rf-ofe-num-doc       to   w-inp-mst-dep          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-ofe-prt-doc       to   w-inp-mst-prt          .
