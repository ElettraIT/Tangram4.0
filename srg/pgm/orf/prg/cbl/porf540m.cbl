      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [ofe]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-ofe.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-ofe-prt      pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Progressivo                                       *
      *            *---------------------------------------------------*
               10  w-cmp-rec-ofe-prg      pic  9(05)                  .
      ...
      *                  *---------------------------------------------*
           move      rf-ofe-num-doc       to   w-all-str-alf          .
      ...
      *
           ...
           else      move  rf-ofe-num-doc to   w-lin-imm-num-doc      .
      *
      ...
      *    *===========================================================*
      *    * Accettazione 1. campo riga corpo espansa : Cod. fornitore *
      *    *-----------------------------------------------------------*
       acc-cod-fnt-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-ofe-tmo-doc       to   w-all-str-cat (1)      .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [ofe]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/orf/fls/ioc/obj/iofofe"
                                          to   s-pat                  .
      ...
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-ofe-dat-doc       to   srt-dat-doc            .
      *                      *-----------------------------------------*
      *                      * Protocollo documento                    *
      *                      *-----------------------------------------*
           move      rf-ofe-prt-doc       to   srt-prt-doc            .
      *                      *-----------------------------------------*
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      rf-ofe-cod-arc       to   srt-cod-fnt            .
      *                  *---------------------------------------------*
      *                  * Record [ofe]                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                  * Record [ofe]                                *
      *                  *---------------------------------------------*
           move      rf-ofe               to   w-rig-rec-ofe          .
           move      rf-ofe-cod-arc       to   w-rig-cod-fnt          .
           move      rf-ofe-dpz-arc       to   w-rig-dpz-fnt          .
      *
           if        rf-ofe-flg-ain       =    spaces
                     move  "S"            to   w-rig-snx-inv
           else      move  "N"            to   w-rig-snx-inv          .
      *
           move      rf-ofe-eml-ind       to   w-rig-ind-eml          .
      *
           if        rf-ofe-eml-ind       =    spaces
                     move  "N"            to   w-rig-snx-inv          .
      *                  *---------------------------------------------*
      *                  * Valori indiretti                            *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           else      move  "#"            to   rf-ofe-flg-ain         .
      *              *-------------------------------------------------*
      *              * Aggiornamento indirizzo mail                    *
      *              *-------------------------------------------------*
           if        w-rig-ind-eml        not  = spaces
                     move  w-rig-ind-eml  to   rf-ofe-eml-ind         .
      *              *-------------------------------------------------*
      *              * Update record [ofe]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Routine per Expand anagrafica commerciale fornitore riga  *
      *    *-----------------------------------------------------------*
       rou-exp-ana-000.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/orf/prg/obj/porf5402"                       .
       cnc-rlt-sup-999.
           exit.
