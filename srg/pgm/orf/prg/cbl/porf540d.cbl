      ...
      *                  *---------------------------------------------*
           move      "morf.txt"           to   f-xxx-msg              .
      *                  *---------------------------------------------*
      *                  * Default nome testo soggetto                 *
      *                  *---------------------------------------------*
           move      "sorf.txt"           to   f-xxx-sgt              .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/orf/ric/orf540[sec-att]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-ofe-prt-doc       to   rf-oft-num-prt         .
           move      "pgm/orf/fls/ioc/obj/iofoft"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * documento                           *
      *                          *-------------------------------------*
           move      rf-oft-num-doc       to   w-det-rec-fil-num      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-ofe-eml-all       to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [ofe] letti    *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-ofe-dat-inv         .
      *              *-------------------------------------------------*
      *              * Aggiornamento ora invio                         *
      *              *-------------------------------------------------*
           move      s-ora                to   rf-ofe-ora-inv         .
           multiply  100                  by   rf-ofe-ora-inv         .
           add       s-min                to   rf-ofe-ora-inv         .
      *              *-------------------------------------------------*
      *              * Update record [ofe]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
