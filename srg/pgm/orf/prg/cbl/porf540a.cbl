      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione overlay per il programma orf540  *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/orf/mov/orc300[snx-oav]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "pgm/orf/num/ioc/obj/innumofe"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-noc-min           to   rf-oft-num-doc         .
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-oft-num-doc       <    rr-noc-min or
      ...
      *                      *-----------------------------------------*
           move      rf-oft-num-prt       to   w-det-dst-num-prt      .
           perform   stp-srt-inp-ofe-000  thru stp-srt-inp-ofe-999    .
      ...
      *
           if        rf-oft-inl-dcm       =    01
                     move  12             to   d-con-arc-tip-arc
                     move  rf-oft-cod-arc to   d-con-arc-cod-arc
                     move  spaces         to   d-con-arc-dpz-arc
           else if   rf-oft-inl-dcm       =    02
                     move  11             to   d-con-arc-tip-arc
                     move  rf-oft-cod-arc to   d-con-arc-cod-arc
                     move  spaces         to   d-con-arc-dpz-arc
           else      move  12             to   d-con-arc-tip-arc
                     move  rf-oft-cod-arc to   d-con-arc-cod-arc
                     move  rf-oft-dpz-arc to   d-con-arc-dpz-arc      .
      *
      ...
      *                      *-----------------------------------------*
           ...
           string    "Ordine senza indirizzo mail : "
                                delimited by   size
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      rf-oft-cod-arc       to   srt-cod-fnt            .
      *                      *-----------------------------------------*
      *                      * Codice dipendenza fornitore             *
      *                      *-----------------------------------------*
           move      rf-oft-dpz-arc       to   srt-dpz-fnt            .
       stp-srt-inp-640.
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-dst-num-prt    to   rf-ofe-prt-doc         .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-ofe-900.
       stp-srt-inp-ofe-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale [ofe]                       *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/orf/fls/ioc/obj/iofofe"
                                          to   s-pat                  .
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-ofe-prt-doc       not  = w-det-dst-num-prt
                     go to stp-srt-inp-ofe-900.
       stp-srt-inp-ofe-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-ofe-200.
       stp-srt-inp-ofe-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-ofe-999.
       stp-srt-inp-ofe-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Preparazione dati per scrittura [ofe]           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<"                  to   p-edm                  .
           move      rf-oft-num-doc       to   w-wrk-nft-int          .
      ...
      *              * zioni [numofe]                                  *
      *              *-------------------------------------------------*
           move      w-num-dst-scl-ann    to   rn-num-ofe-scl-ann     .
      *              *-------------------------------------------------*
      *              * Lettura tabella numerazioni [numofe]            *
      *              *-------------------------------------------------*
           move      "GT"                 to   f-ope                  .
           move      "pgm/orf/num/ioc/obj/innumofe"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           move      rn-num-ofe-num-dst   to   w-num-dst-num-dst      .
      ...
      *                  *---------------------------------------------*
           move      w-num-dst-num-dst    to   rn-num-ofe-num-dst     .
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-ofe-ide-dat         .
           move      s-ute                to   rf-ofe-ide-ute         .
           move      s-fas                to   rf-ofe-ide-fas         .
           move      rr-num-dst           to   rf-ofe-num-dst         .
           move      w-cix-num-ele        to   rf-ofe-num-prg         .
           move      s-dat                to   rf-ofe-dat-reg         .
           move      zero                 to   rf-ofe-tip-dst         .
           move      "C"                  to   rf-ofe-tip-arc         .
           move      srt-cod-fnt          to   rf-ofe-cod-arc         .
           move      srt-dpz-fnt          to   rf-ofe-dpz-arc         .
           move      zero                 to   rf-ofe-tip-ids         .
           move      rr-prm-inv (4)       to   rf-ofe-eml-mit         .
           move      srt-eml-ind          to   rf-ofe-eml-ind         .
           move      spaces               to   rf-ofe-eml-all         .
           move      zero                 to   rf-ofe-tip-doc         .
           move      rf-oft-tmo-orf       to   rf-ofe-tmo-doc         .
           move      rf-oft-dat-doc       to   rf-ofe-dat-doc         .
           move      w-wrk-doc-nda        to   rf-ofe-num-doc         .
           move      rf-oft-num-prt       to   rf-ofe-prt-doc         .
