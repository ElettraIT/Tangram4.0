      ...
      *                                   Fase:    orf500              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 08/08/95    *
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           ...
           05  w-rig-qta-fda              pic s9(08)v9(03)            .
           05  w-rig-qta-ord              pic s9(08)v9(03)            .
                   ...
                   15  w-lin-imm-des-000.
                       ...
                       20  w-lin-imm-des-006 redefines
                           ...
                           25  w-lin-imm-cod-p11
                                          pic  x(14)                  .
                       20  w-lin-imm-des-007 redefines
                           w-lin-imm-des-001.
                           25  filler     pic  x(01)                  .
                           25  w-lin-imm-pfp-p12
                                          pic  x(03)                  .
                           25  w-lin-imm-brv-p12
                                          pic  x(01)                  .
                           25  w-lin-imm-cdf-p12
                                          pic  x(14)                  .
                           25  filler     pic  x(03)                  .
                           25  w-lin-imm-pqs-p12
                                          pic  x(01)                  .
                           25  w-lin-imm-tco-p12
                                          pic  x(01)                  .
                           25  w-lin-imm-pqd-p12
                                          pic  x(01)                  .
                           25  filler     pic  x(01)                  .
                           25  w-lin-imm-cod-p12
                                          pic  x(14)                  .
                       20  w-lin-imm-des-008 redefines
                           w-lin-imm-des-001.
                           25  w-lin-imm-cod-p13
                                          pic  x(14)                  .
                           25  filler     pic  x(04)                  .
                           25  w-lin-imm-pfp-p13
                                          pic  x(03)                  .
                           25  w-lin-imm-brv-p13
                                          pic  x(01)                  .
                           25  w-lin-imm-cdf-p13
                                          pic  x(14)                  .
                           25  filler     pic  x(04)                  .
                       20  w-lin-imm-des-009 redefines
                           w-lin-imm-des-001.
                           25  w-lin-imm-pqs-p14
                                          pic  x(01)                  .
                           25  w-lin-imm-tco-p14
                                          pic  x(01)                  .
                           25  w-lin-imm-pqd-p14
                                          pic  x(01)                  .
                           25  w-lin-imm-brv-p14
                                          pic  x(01)                  .
                           25  w-lin-imm-cod-p14
                                          pic  x(14)                  .
                           25  filler     pic  x(02)                  .
                           25  w-lin-imm-pfp-p14
                                          pic  x(03)                  .
                           25  filler     pic  x(01)                  .
                           25  w-lin-imm-cdf-p14
                                          pic  x(14)                  .
                           25  filler     pic  x(02)                  .
      ...
      *        * Quantita' ordinata                                    *
      *        *-------------------------------------------------------*
           05  w-sav-qta-ord              pic s9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' impostata, comodo per confronti             *
      *        *-------------------------------------------------------*
           05  w-sav-qta-cfr              pic s9(08)v9(03)            .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-def-dcn-flg              pic  x(01)                  .
           05  w-def-dcn-prv              pic  9(07)                  .
      *        *-------------------------------------------------------*
      ...
      *                  * data documento e codice archivio            *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-tes-tmo-orf        to   w-all-str-cat (1)      .
      ...
      *              *-------------------------------------------------*
      *              * Normalizzazione default per data consegna pre-  *
      *              * vista                                           *
      *              *-------------------------------------------------*
           move      spaces               to   w-def-dcn-flg          .
           move      zero                 to   w-def-dcn-prv          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/orf/con/orf500[rig-scr]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-prs-rig-scr-des    =    01 or
                     ...
                     move  "|"            to   w-lin-imm-brv-p11
           else if   w-prs-rig-scr-des    =    12
                     move  "|"            to   w-lin-imm-brv-p12
           else if   w-prs-rig-scr-des    =    13
                     move  "|"            to   w-lin-imm-brv-p13
           else if   w-prs-rig-scr-des    =    14
                     move  "|"            to   w-lin-imm-brv-p14      .
      *                  *---------------------------------------------*
      ...
      *                              *---------------------------------*
           if        w-prs-rig-scr-des    =    00
                     ...
                     go to vis-lin-cor-522
           else if   w-prs-rig-scr-des    =    13
                     go to vis-lin-cor-524
           else if   w-prs-rig-scr-des    =    14
                     go to vis-lin-cor-526
      ...
      *                              *---------------------------------*
      *                                  *-----------------------------*
      *                                  * Editing segnale codice for- *
      *                                  * nitore                      *
      *                                  *-----------------------------*
           move      "[F]"                to   w-lin-imm-pfp-p11      .
      *                                  *-----------------------------*
      *                                  * Editing codice secondo il   *
      *                                  * fornitore                   *
      *                                  *-----------------------------*
           move      w-rig-cop-sfn        to   w-lin-imm-cdf-p11      .
      *                                  *-----------------------------*
      *                                  * Editing codice magazzino    *
      *                                  *-----------------------------*
           move      w-rig-alf-mag        to   w-lin-imm-cod-p11      .
      *                                  *-----------------------------*
      *                                  * Continuazione               *
      *                                  *-----------------------------*
           go to     vis-lin-cor-532.
      ...
      *                                  * nitore                      *
      *                                  *-----------------------------*
           move      "[F]"                to   w-lin-imm-pfp-p12      .
      *                                  *-----------------------------*
      *                                  * Editing codice secondo il   *
      *                                  * fornitore                   *
      *                                  *-----------------------------*
           move      w-rig-cop-sfn        to   w-lin-imm-cdf-p12      .
      *                                  *-----------------------------*
      *                                  * Editing parentesi sinistra  *
      *                                  *-----------------------------*
           move      "["                  to   w-lin-imm-pqs-p12      .
      *                                  *-----------------------------*
      *                                  * Editing tipo codice di ma-  *
      *                                  * gazzino                     *
      *                                  *-----------------------------*
           if        w-rig-tip-mag        =    01
                     move  "P"            to   w-lin-imm-tco-p12
           else if   w-rig-tip-mag        =    02
                     move  "S"            to   w-lin-imm-tco-p12
           else if   w-rig-tip-mag        =    03
                     move  "M"            to   w-lin-imm-tco-p12
           else if   w-rig-tip-mag        =    04
                     move  "V"            to   w-lin-imm-tco-p12
           else      move  "?"            to   w-lin-imm-tco-p12      .
      *                                  *-----------------------------*
      *                                  * Editing parentesi destra    *
      *                                  *-----------------------------*
           move      "]"                  to   w-lin-imm-pqd-p12      .
      *                                  *-----------------------------*
      *                                  * Editing codice magazzino    *
      *                                  *-----------------------------*
           move      w-rig-alf-mag        to   w-lin-imm-cod-p12      .
      *                                  *-----------------------------*
      *                                  * Continuazione               *
      *                                  *-----------------------------*
           go to     vis-lin-cor-532.
      ...
      *                                  * Editing codice magazzino    *
      *                                  *-----------------------------*
           move      w-rig-alf-mag        to   w-lin-imm-cod-p13      .
      *                                  *-----------------------------*
      *                                  * Editing segnale codice for- *
      *                                  * nitore                      *
      *                                  *-----------------------------*
           move      "[F]"                to   w-lin-imm-pfp-p13      .
      *                                  *-----------------------------*
      *                                  * Editing codice secondo il   *
      *                                  * fornitore                   *
      *                                  *-----------------------------*
           move      w-rig-cop-sfn        to   w-lin-imm-cdf-p13      .
      *                                  *-----------------------------*
      *                                  * Continuazione               *
      *                                  *-----------------------------*
           go to     vis-lin-cor-532.
      ...
      *                                  * Editing parentesi sinistra  *
      *                                  *-----------------------------*
           move      "["                  to   w-lin-imm-pqs-p14      .
      *                                  *-----------------------------*
      *                                  * Editing tipo codice di ma-  *
      *                                  * gazzino                     *
      *                                  *-----------------------------*
           if        w-rig-tip-mag        =    01
                     move  "P"            to   w-lin-imm-tco-p14
           else if   w-rig-tip-mag        =    02
                     move  "S"            to   w-lin-imm-tco-p14
           else if   w-rig-tip-mag        =    03
                     move  "M"            to   w-lin-imm-tco-p14
           else if   w-rig-tip-mag        =    04
                     move  "V"            to   w-lin-imm-tco-p14
           else      move  "?"            to   w-lin-imm-tco-p14      .
      *                                  *-----------------------------*
      *                                  * Editing parentesi destra    *
      *                                  *-----------------------------*
           move      "]"                  to   w-lin-imm-pqd-p14      .
      *                                  *-----------------------------*
      *                                  * Editing codice magazzino    *
      *                                  *-----------------------------*
           move      w-rig-alf-mag        to   w-lin-imm-cod-p14      .
      *                                  *-----------------------------*
      *                                  * Editing segnale codice for- *
      *                                  * nitore                      *
      *                                  *-----------------------------*
           move      "[F]"                to   w-lin-imm-pfp-p14      .
      *                                  *-----------------------------*
      *                                  * Editing codice secondo il   *
      *                                  * fornitore                   *
      *                                  *-----------------------------*
           move      w-rig-cop-sfn        to   w-lin-imm-cdf-p14      .
      *                                  *-----------------------------*
      *                                  * Continuazione               *
      *                                  *-----------------------------*
           go to     vis-lin-cor-532.
      ...
      *                      *-----------------------------------------*
           ...
           if        w-rig-snx-tum        =    "P"
                     ...
                     move  w-rig-nde-tum  to   v-dec
           else      move  w-rig-dec-qta  to   v-dec                  .
           move      spaces               to   v-sgn                  .
           move      "G"                  to   v-edm                  .
           if        w-rig-snx-tum        =    "P"
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-qta-ord      .
       vis-lin-cor-560.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-prs-rig-scr-des    =    00
                     ...
                     go to pmt-cor-reg-370
           else if   w-prs-rig-scr-des    =    12
                     go to pmt-cor-reg-380
           else if   w-prs-rig-scr-des    =    13
                     go to pmt-cor-reg-390
           else if   w-prs-rig-scr-des    =    14
      ...
      *                      *-----------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      05                   to   v-pos                  .
           move      "  Codice del fornitore   |    Codice    "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      05                   to   v-pos                  .
           move      "    Codice    |  Codice del fornitore   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      45                   to   v-pos                  .
           move      "|Q. Ordinata|   Prezzo   |C. Prev.|C"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Pf4  : ammesso solo se si e' su di un   *
      *                      *        record New, a meno che non si    *
      *                      *        sia sulla prima riga             *
      *                      *-----------------------------------------*
           if        w-cnt-cor-nrg-dac    not  = 1    and
                     w-def-dcn-prv        not  = zero
                     move  "[4] "         to   v-pfk (17)             .
      *                      *-----------------------------------------*
      ...
      *                  * Data di default                             *
      *                  *---------------------------------------------*
           if        w-def-dcn-prv        =    zero
                     go to acc-qta-ord-300.
           if        w-def-dcn-prv        =    w-rig-dcn-prv
                     go to acc-qta-ord-300.
           move      w-def-dcn-prv        to   w-rig-dcn-prv          .
           move      "#"                  to   w-def-dcn-flg          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione                             *
      *                  *---------------------------------------------*
      ...
      *                  * Flag conferma                               *
      *                  *---------------------------------------------*
           move      "C"                  to   w-rig-flg-cnf          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione                             *
      *                  *---------------------------------------------*
           perform   vis-flg-cnf-000      thru vis-flg-cnf-999        .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su flag di default data consegna pre-  *
      *                  * vista                                       *
      *                  *---------------------------------------------*
           if        w-def-dcn-flg        =    spaces
                     go to acc-prz-acq-050.
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Aggiornamento data di default               *
      *                  *---------------------------------------------*
           move      w-rig-dcn-prv        to   w-def-dcn-prv          .
       acc-dcn-prv-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Flag conferma                     *
      *    *-----------------------------------------------------------*
       vis-flg-cnf-000.
      *              *-------------------------------------------------*
      *              * Pre-visualizzazione                             *
      ...
      *                  *---------------------------------------------*
           ...
           else      move  w-rig-dcn-ric  to   w-rig-dcn-cnf          .
       cnt-tdo-rig-999.
           exit.
