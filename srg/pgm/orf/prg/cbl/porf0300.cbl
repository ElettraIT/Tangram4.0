      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella responsabili ordini a      *
      *                    fornitori                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "TABELLA RESPONSABILI ORDINI A FORNITORI "       .
      ...
      *              *-------------------------------------------------*
           perform   cod-mne-yro-opn-000  thru cod-mne-yro-opn-999    .
       pre-exe-pgm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           perform   cod-mne-yro-cls-000  thru cod-mne-yro-cls-999    .
       pos-exe-pgm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-rsp        to   w-cod-mne-yro-cod      .
           move      04                   to   w-cod-mne-yro-lin      .
           move      30                   to   w-cod-mne-yro-pos      .
           move      07                   to   w-cod-mne-yro-dln      .
           move      30                   to   w-cod-mne-yro-dps      .
           move      "<B"                 to   v-edm                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "INSR"               to   v-pfk (04)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   cod-mne-yro-cll-000  thru cod-mne-yro-cll-999    .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
           perform   cod-mne-yro-foi-000  thru cod-mne-yro-foi-999    .
       acc-cod-rsp-110.
           perform   cod-mne-yro-cll-000  thru cod-mne-yro-cll-999    .
           if        w-cod-mne-yro-ope    =    "F+"
                     go to acc-cod-rsp-115.
           if        w-cod-mne-yro-ope    =    "AC"
       ...
       acc-cod-rsp-120.
           move      w-cod-mne-yro-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-rsp        to   rf-yro-cod-rsp         .
           move      "pgm/orf/fls/ioc/obj/iofyro"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [yro]                        *
      *                          *-------------------------------------*
           move      rf-yro-des-rsp       to   w-tes-des-rsp (1)      .
           move      rf-yro-des-key       to   w-tes-des-key (1)      .
           move      rf-yro-cod-mne       to   w-tes-cod-mne (1)      .
           move      rf-yro-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [yro]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-yro-000      thru wrt-rec-yro-999        .
      ...
      *                      * Rewrite record [yro]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-yro-000      thru rew-rec-yro-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [yro]                             *
      *              *-------------------------------------------------*
           perform   del-rec-yro-000      thru del-rec-yro-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [yro]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-yro-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-rsp (1)    to   rf-yro-des-rsp         .
           move      w-tes-des-key (1)    to   rf-yro-des-key         .
           move      w-tes-cod-mne (1)    to   rf-yro-cod-mne         .
           move      w-tes-alx-exp (1)    to   rf-yro-alx-exp         .
       cmp-rec-yro-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [yro]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-yro-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-yro-000      thru cmp-rec-yro-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [yro] parte 01    *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "yro "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODRSP    "         to   f-key                  .
           move      w-enc-cod-val-pos    to   rf-yro-cod-rsp         .
           move      "pgm/orf/fls/ioc/obj/iofyro"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       rip-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [yro]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "yro "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *    *-----------------------------------------------------------*
           copy      "pgm/orf/prg/cpy/acmnyro0.acs"                   .
