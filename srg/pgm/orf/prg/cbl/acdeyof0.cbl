      ...
      *                                                                *
      *              Input  : w-cod-des-yof-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-yof-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-yof-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-yof-cod : codice tipo movim.   *
      *                                                                *
      *                       w-cod-des-yof-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-yof-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-yof-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-yof-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-yof-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-yof-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-yof-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-yof-cod : codice tipo movim.   *
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-yof
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-yof-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-yof-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-yof-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-yof-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-yof-ope    =    "A+" or
                     w-cod-des-yof-ope    =    "I+" or
                     w-cod-des-yof-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-yof-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-cod-des-yof-cod    to   w-cod-des-yof-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-yof-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-yof-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-yof-s90    to   v-ufk                  .
           move      w-cod-des-yof-lin    to   v-lin                  .
           move      w-cod-des-yof-pos    to   v-pos                  .
           move      w-cod-des-yof-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-yof-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-yof-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-yof-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-yof-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-yof-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-yof-cod    to   w-cod-des-yof-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-yof-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-yof-dln    =    zero or
                     w-cod-des-yof-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      w-cod-des-yof-dln    to   v-lin                  .
           move      w-cod-des-yof-dps    to   v-pos                  .
      ...
      *                          *-------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-toc-dup    to   rf-yof-des-key         .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-yof-des-key       >    w-aux-cde-toc-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      rf-yof-cod-tof       to   w-aux-cde-toc-bco
                                              (w-aux-cde-toc-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione tipo movimento      *
      *                              *---------------------------------*
           move      rf-yof-des-tof       to   w-aux-cde-toc-bde
                                              (w-aux-cde-toc-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      w-aux-cde-toc-bco
                    (w-aux-cde-toc-bix)   to   w-cod-des-yof-cod      .
      *                              *---------------------------------*
