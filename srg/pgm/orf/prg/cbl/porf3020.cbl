      ...
      *                       Ultima revisione:    NdK del 09/03/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma porf3021:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  rr-cod-tof                 pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Tipo movimento da ricercare, descrizione              *
      *        *-------------------------------------------------------*
           05  rr-cod-tof-des             pic  x(30)                  .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-tof           to   w-cod-des-yof-cod      .
           move      13                   to   w-cod-des-yof-lin      .
           move      30                   to   w-cod-des-yof-pos      .
           move      13                   to   w-cod-des-yof-dln      .
      ...
      *                  *---------------------------------------------*
           move      rr-cod-tof           to   w-let-arc-yof-cod      .
           perform   let-arc-yof-000      thru let-arc-yof-999        .
           move      w-let-arc-yof-des    to   rr-cod-tof-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cod-tof-des-000  thru vis-cod-tof-des-999    .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-cod-tof           not  = spaces
                     go to acc-cod-tof-600.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      05                   to   v-car                  .
           move      13                   to   v-lin                  .
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      spaces               to   rr-cod-tof             .
           move      spaces               to   rr-cod-tof-des         .
           move      spaces               to   rr-cod-ute             .
           move      spaces               to   rr-cod-fas             .
       nor-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione tipo movimento ordini for- *
      *    * nitori                                                    *
      *    *-----------------------------------------------------------*
