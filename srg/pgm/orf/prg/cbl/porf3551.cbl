      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma orf355   *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dpm-num-map       to   rf-ofr-num-mag         .
      ...
      *              *-------------------------------------------------*
           if        rf-ofr-cod-dpz       not  = rr-dpz-inu     or
                     ...
                     rf-ofr-num-mag       not  = rf-dpm-num-map
                     go to stp-srt-inp-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-ofr-tmo-orf       to   srt-tip-doc            .
           if        rf-ofr-snx-tum       =    "S"
           ...
           move      d-qev-rof-qta-dri    to   srt-qta-dri            .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "ORDINI FORNITORI INEVASI MATERIE PRIME PER DATA CO
      -              "NSEGNA"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "   Ordine fornitore                           Forn
      -              "itore                     Udm   Ordinato    Ricevu
      -              "to    Residuo   Consegna Conf.  "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
