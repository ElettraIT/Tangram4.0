      ...
      *                       Ultima revisione:    NdK del 22/04/25    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo di espansione dell'ordine per        *
      ...
      *                                                                *
      *              Input  : w-esp-ida-oft-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-esp-ida-oft-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "ES"  Espansione                                               *
      *                                                                *
      *              Input  : w-esp-ida-oft-ope : "ES"                 *
      *                                                                *
      *                       w-esp-ida-oft-prt : protocollo ordine    *
      *                       w-esp-ida-oft-num : numero documento     *
      *                       w-esp-ida-oft-dat : data documento       *
      *                       w-esp-ida-oft-tmo : tipo documento       *
      *                                                                *
      *              Output : nessuno                                  *
      *                                                                *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux.
      *        *-------------------------------------------------------*
      *        * Work per espansione record righe ordine               *
      *        *-------------------------------------------------------*
           05  w-aux-rec-ocr.
               10  w-aux-rec-ocr-rtr      pic  x(01)                  .
               10  w-aux-rec-ocr-c01      pic  9(05)                  .
               10  w-aux-rec-ocr-c02      pic  9(03)                  .
               10  w-aux-rec-ocr-c03      pic  9(05)                  .
               10  w-aux-rec-ocr-c04      pic  9(05)                  .
               10  w-aux-rec-ocr-c05      pic  9(05)                  .
               10  w-aux-rec-ocr-c06      pic  9(05)                  .
               10  w-aux-rec-ocr-cix      pic  9(03)                  .
               10  w-aux-rec-ocr-nli      pic  9(05)                  .
               10  w-aux-rec-ocr-crb      pic  9(05)                  .
               10  w-aux-rec-ocr-max      pic  9(05) value 300        .
               10  w-aux-rec-ocr-cpb      pic  9(05)                  .
               10  w-aux-rec-ocr-cpa      pic  9(05)                  .
               10  w-aux-rec-ocr-buf
                               occurs 300.
                   15  w-aux-rec-ocr-tip  pic  9(02)                  .
                   15  w-aux-rec-ocr-tmo  pic  x(05)                  .
                   15  w-aux-rec-ocr-prt  pic  9(11)                  .
                   15  w-aux-rec-ocr-num  pic  9(11)                  .
                   15  w-aux-rec-ocr-dat  pic  9(07)                  .
                   15  w-aux-rec-ocr-sts  pic  x(20)                  .
      ...
      ******************************************************************
       Procedure Division                using w-esp-ida-oft          .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-esp-ida-oft-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-esp-ida-oft-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-esp-ida-oft-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-esp-ida-oft-ope    =    "ES"
      ...
      *                  * correlati                                   *
      *                  *---------------------------------------------*
           perform   det-ird-acq-opn-000  thru det-ird-acq-opn-999    .
       opn-999.
           exit.
      ...
      *                  * correlati                                   *
      *                  *---------------------------------------------*
           perform   det-ird-acq-cls-000  thru det-ird-acq-cls-999    .
       cls-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-esp-ida-oft-ope      .
       tcm-999.
           exit.

      *    *===========================================================*
      *    * Routine di Expand su ordine                               *
      *    *-----------------------------------------------------------*
       esp-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore righe                 *
      *              *-------------------------------------------------*
           move      zero                 to   w-aux-rec-ocr-crb      .
      *              *-------------------------------------------------*
      ...
      *              * Lettura buffer [ida]                            *
      *              *-------------------------------------------------*
           move      "D>"                 to   d-ird-acq-tip-ope      .
           move      01                   to   d-ird-acq-tip-dsr      .
           move      w-esp-ida-oft-prt    to   d-ird-acq-prt-dsr      .
           perform   det-ird-acq-cll-000  thru det-ird-acq-cll-999    .
       esp-200.
      *              *-------------------------------------------------*
      *              * Incremento numero records nel buffer            *
      *              *-------------------------------------------------*
           add       1                    to   w-aux-rec-ocr-crb      .
      *              *-------------------------------------------------*
      *              * Test su numero documenti correlati              *
      *              *-------------------------------------------------*
           if        w-aux-rec-ocr-crb    >    d-ird-acq-num-ele
                     move  d-ird-acq-num-ele
                                          to   w-aux-rec-ocr-crb
                     go to esp-500.
      *              *-------------------------------------------------*
      *              * Test se buffer oltre il numero previsto         *
      *              *-------------------------------------------------*
           if        w-aux-rec-ocr-crb    >    w-aux-rec-ocr-max
                     go to esp-500.
       esp-420.
      *              *-------------------------------------------------*
      *              * Bufferizzazione riga in corso di trattamento    *
      *              *-------------------------------------------------*
           move      d-ird-acq-tip-dtr
                    (w-aux-rec-ocr-crb)   to   w-aux-rec-ocr-tip
                                              (w-aux-rec-ocr-crb)     .
           move      d-ird-acq-tmo-dtr
                    (w-aux-rec-ocr-crb)   to   w-aux-rec-ocr-tmo
                                              (w-aux-rec-ocr-crb)     .
           move      d-ird-acq-prt-dtr
                    (w-aux-rec-ocr-crb)   to   w-aux-rec-ocr-prt
                                              (w-aux-rec-ocr-crb)     .
           move      d-ird-acq-num-dtr
                    (w-aux-rec-ocr-crb)   to   w-aux-rec-ocr-num
                                              (w-aux-rec-ocr-crb)     .
           move      d-ird-acq-dat-dtr
                    (w-aux-rec-ocr-crb)   to   w-aux-rec-ocr-dat
                                              (w-aux-rec-ocr-crb)     .
           move      d-ird-acq-sts-dtr
                    (w-aux-rec-ocr-crb)   to   w-aux-rec-ocr-sts
                                              (w-aux-rec-ocr-crb)     .
       esp-430.
      *              *-------------------------------------------------*
      *              * Riciclo a lettura                               *
      ...
      *              * valore                                          *
      *              *-------------------------------------------------*
           if        w-aux-rec-ocr-crb    =    zero
                     go to esp-999.
      *                  *---------------------------------------------*
      *                  * Determinazione numero pagine nel buffer     *
      *                  *---------------------------------------------*
           move      w-aux-rec-ocr-crb    to   w-aux-rec-ocr-cpb      .
           subtract  1                    from w-aux-rec-ocr-cpb      .
           divide    6                    into w-aux-rec-ocr-cpb      .
           add       1                    to   w-aux-rec-ocr-cpb      .
      *                  *---------------------------------------------*
      *                  * Inizializzazione numero record nel buffer   *
      *                  * attualmente trattato                        *
      *                  *---------------------------------------------*
           move      1                    to   w-aux-rec-ocr-c01      .
       esp-520.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-aux-rec-ocr-c01    to   w-aux-rec-ocr-nli      .
       esp-555.
           if        w-aux-rec-ocr-nli    >    6
                     subtract  6          from w-aux-rec-ocr-nli
                     go to esp-555.
      *                  *---------------------------------------------*
      *                  * Incremento numero linea a video per posi-   *
      *                  * zionamento verticale                        *
      *                  *---------------------------------------------*
           add       09                   to   w-aux-rec-ocr-nli      .
       esp-560.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-aux-rec-ocr-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-rec-ocr-c01    <    w-aux-rec-ocr-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           if        w-aux-rec-ocr-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-rec-ocr-cpa    <    w-aux-rec-ocr-cpb
           ...
           move      w-aux-rec-ocr-nli    to   v-lin                  .
           move      17                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       esp-580.
      ...
      *                  *---------------------------------------------*
           subtract  1                    from w-aux-rec-ocr-c01      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           subtract  1                    from w-aux-rec-ocr-cpa      .
      *                  *---------------------------------------------*
      *                  * A trattamento contatore per le pagine       *
      *                  *---------------------------------------------*
           go to     esp-596.
      ...
      *              *-------------------------------------------------*
           move      w-aux-rec-ocr-cpa    to   w-aux-rec-ocr-c01      .
           multiply  6                    by   w-aux-rec-ocr-c01      .
           subtract  5                    from w-aux-rec-ocr-c01      .
           go to     esp-590.
       esp-598.
      *              *-------------------------------------------------*
      *              * Se Back                                         *
      *              *-------------------------------------------------*
           move      1                    to   w-aux-rec-ocr-cpa      .
           go to     esp-596.
       esp-600.
      *              *-------------------------------------------------*
      *              * Se Tab                                          *
      *              *-------------------------------------------------*
           move      w-aux-rec-ocr-cpb    to   w-aux-rec-ocr-cpa      .
           go to     esp-596.
       esp-602.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *              *-------------------------------------------------*
           move      w-aux-rec-ocr-c01    to   w-aux-rec-ocr-c02      .
           add       5                    to   w-aux-rec-ocr-c02      .
           divide    6                    into w-aux-rec-ocr-c02      .
           move      w-aux-rec-ocr-c02    to   w-aux-rec-ocr-cpa      .
           subtract  1                    from w-aux-rec-ocr-c02      .
           multiply  6                    by   w-aux-rec-ocr-c02      .
           add       1                    to   w-aux-rec-ocr-c02      .
           add       5
                     w-aux-rec-ocr-c02  giving w-aux-rec-ocr-c03      .
           move      w-aux-rec-ocr-c03    to   w-aux-rec-ocr-c04      .
           if        w-aux-rec-ocr-c03    >    w-aux-rec-ocr-crb
                     move  w-aux-rec-ocr-crb
                                          to   w-aux-rec-ocr-c03      .
      *                  *---------------------------------------------*
      *                  * Posizionamento iniziale                     *
      *                  *---------------------------------------------*
           move      10                   to   w-aux-rec-ocr-c05      .
       esp-940.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      78                   to   v-car                  .
           move      w-aux-rec-ocr-c05    to   v-lin                  .
           move      02                   to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           add       1                    to   w-aux-rec-ocr-c02      .
           add       1                    to   w-aux-rec-ocr-c05      .
           if        w-aux-rec-ocr-c02    not  > w-aux-rec-ocr-c03
                     go to esp-940.
       esp-957.
           if        w-aux-rec-ocr-c02    >    w-aux-rec-ocr-c04
                     go to esp-958.
           if        w-aux-rec-ocr-crb    not  > 6
                     go to esp-958.
      *                  *---------------------------------------------*
      ...
      *
           if        w-aux-rec-ocr-tip
                    (w-aux-rec-ocr-c02)   =    11
                     move  spaces         to   w-all-str-cat (1)
           else if   w-aux-rec-ocr-tip
                    (w-aux-rec-ocr-c02)   =    21
                     move  "..."          to   w-all-str-cat (1)
           else      move  "......."      to   w-all-str-cat (1)      .
      *
           move      w-aux-rec-ocr-tmo
                    (w-aux-rec-ocr-c02)   to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "<B"                 to   v-edm                  .
           move      w-aux-rec-ocr-num
                    (w-aux-rec-ocr-c02)   to   w-wrk-num-doc          .
      ...
      *              *-------------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      w-aux-rec-ocr-dat
                    (w-aux-rec-ocr-c02)   to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              * Status documento                                *
      *              *-------------------------------------------------*
           move      w-aux-rec-ocr-sts
                    (w-aux-rec-ocr-c02)   to   w-lin-imm-sts-doc      .
      *              *-------------------------------------------------*
      *              * Separatori                                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-esp-ida-oft-num    to   w-wrk-num-doc          .
           move      w-wrk-ndo-prg        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      w-esp-ida-oft-dat    to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-esp-ida-oft-tmo    to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-aux-rec-ocr-cpa    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-aux-rec-ocr-cpb    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-all-str-cat (4)      .
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
           copy      "pgm/ffo/prg/cpy/dirdacq0.dts"                   .
