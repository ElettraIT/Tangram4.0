      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma orf320   *
      *                                                                *
      ...
      *            *---------------------------------------------------*
      *            * Tipo indirizzo di spedizione richiesta            *
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-stp-srt-inp.
           05  w-stp-srt-inp-wtr.
               ...
               10  filler                 pic  x(03)                  .
           05  w-stp-srt-inp-prz          pic  9(11)                  .
           05  w-stp-srt-inp-ppi          pic  9(09)v9(09)            .
           05  w-stp-srt-inp-ipr          pic s9(13)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Work per totale nazione                               *
      *        *-------------------------------------------------------*
           05  w-tot-naz.
               10  w-tot-naz-ord          pic  9(05)                  .
               10  w-tot-naz-tiv          pic s9(11)                  .
               10  w-tot-naz-tot          pic s9(11)                  .
               10  w-tot-naz-vpf          pic  x(03)                  .
               10  w-tot-naz-dpf          pic  9(01)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Test su data ordine minima                  *
      *                  *---------------------------------------------*
           if        rf-oft-dat-doc       <    rr-dat-min
                     go to stp-srt-inp-100.
      *                  *---------------------------------------------*
      *                  * Test su data ordine massima                 *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rf-ofr-sdr-ccs       not  = spaces
                     go to stp-srt-inp-200.
           go to     stp-srt-inp-228.
       stp-srt-inp-222.
      *                      *-----------------------------------------*
      *                      * Se solo ordini gia' evasi               *
      *                      *-----------------------------------------*
           if        rf-ofr-sdr-ccs       =    spaces
                     go to stp-srt-inp-200.
           go to     stp-srt-inp-228.
       stp-srt-inp-223.
      *                      *-----------------------------------------*
      ...
      *                  * record                                      *
      *                  *---------------------------------------------*
           move      rf-ofr-prz-net       to   w-stp-srt-inp-prz      .
       stp-srt-inp-320.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-stp-srt-inp-wtp    =    "A"
                     move  rf-ofr-imp-rig to   w-stp-srt-inp-ipr
                     go to stp-srt-inp-335.
      *                  *---------------------------------------------*
      *                  * Se altro tipo riga                          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rf-ofr-snx-tum       =    "P"
                     go to stp-srt-inp-322.
      *                          *-------------------------------------*
      *                          * Prezzo unitario pari a quello appe- *
      *                          * na calcolato                        *
      *                          *-------------------------------------*
           move      w-stp-srt-inp-prz    to   w-stp-srt-inp-ppi      .
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * (q.ta' da evadere x prezzo)         *
      *                          *-------------------------------------*
           multiply  d-qev-rof-qta-dri    by   w-stp-srt-inp-ppi
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * (q.ta' ricevuta x prezzo)           *
      *                          *-------------------------------------*
           multiply  d-qev-rof-qta-ric    by   w-stp-srt-inp-ppi
                                        giving w-stp-srt-inp-ipr      .
           go to     stp-srt-inp-335.
       stp-srt-inp-333.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * (q.ta' ordinata x prezzo), ovvero   *
      *                          * l'importo in riga                   *
      *                          *-------------------------------------*
           move      rf-ofr-imp-rig       to   w-stp-srt-inp-ipr      .
           go to     stp-srt-inp-338.
       stp-srt-inp-335.
      *                      *-----------------------------------------*
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      rf-dcf-cod-naz       to   srt-cod-naz            .
      ...
      *              * Codice nazione                                  *
      *              *-------------------------------------------------*
           move      srt-cod-naz          to   w-rot-l02-cod-naz      .
      *              *-------------------------------------------------*
      *              * Protocollo documento                            *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Inizializzazione work totali generali           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Inizializzazione work totali nazione            *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-naz-ord          .
           move      zero                 to   w-tot-naz-tiv          .
           move      zero                 to   w-tot-naz-tot          .
           move      srt-sgl-vpf          to   w-tot-naz-vpf          .
           move      srt-dec-vpf          to   w-tot-naz-dpf          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-lr2-050.
      *              *-------------------------------------------------*
      *              * Stampa totale nazione                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se da stampare                         *
      *                  *---------------------------------------------*
           if        w-tot-naz-ord        not  > 1
      ...
      *                      *-----------------------------------------*
           ...
           move      w-rot-l02-cod-naz    to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      w-all-str-alf        to   w-stp-val-tot-pmt      .
           if        w-tot-naz-vpf        =    spaces
                     move  c-sgl          to   w-stp-val-tot-vlt
           else      move  w-tot-naz-vpf  to   w-stp-val-tot-vlt
                     move  w-tot-naz-dpf  to   w-stp-val-tot-dcv      .
           move      w-tot-naz-tot        to   w-stp-val-tot-tot      .
           move      w-tot-naz-tiv        to   w-stp-val-tot-tiv      .
           perform   stp-val-tot-000      thru stp-val-tot-999        .
       prn-fin-lr2-999.
           exit.
      ...
      *                      *-----------------------------------------*
       ...
       prn-ini-lr1-300.
      *                  *---------------------------------------------*
      *                  * Eventuale emittente ordine                  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
           if        srt-tip-ids          not  = 03
      ...
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      srt-num-prt          to   rf-ofx-num-prt         .
      ...
      *                      *-----------------------------------------*
           ...
           move      "Destinazione :"
                                          to   w-all-str-cat (1)      .
           move      rf-ofx-rag-ids       to   w-all-str-cat (2)      .
           move      rf-ofx-via-ids       to   w-all-str-cat (3)      .
           move      rf-ofx-loc-ids       to   w-all-str-cat (4)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *                      *-----------------------------------------*
      *                      * Stampa                                  *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Aggiornamento totali nazione                    *
      *              *-------------------------------------------------*
           if        w-tot-naz-ord        <    99999
                     add   1              to   w-tot-naz-ord          .
           add       w-tot-ord-tiv        to   w-tot-naz-tiv          .
           add       w-tot-ord-tot        to   w-tot-naz-tot          .
           if        w-tot-ord-vpf        not  = w-tot-naz-vpf
                     move  spaces         to   w-tot-naz-vpf          .
      *              *-------------------------------------------------*
      ...
      *
           string    "PORTAFOGLIO ORDINI FORNITORI"
                                delimited by   size
