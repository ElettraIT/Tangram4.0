      ...
      *                                   Fase:    orf355              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 30/07/92    *
      *                       Ultima revisione:    NdK del 01/10/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma porf3551:        *
      *                                                                *
      *                    Ordini fornitori inevasi materie prime      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Valori associati al filtro di ordinamento [dpm]       *
      *        *-------------------------------------------------------*
