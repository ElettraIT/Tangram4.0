      ...
      *                                   Fase:    dpm402              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/03/92    *
      *                       Ultima revisione:    NdK del 07/04/17    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdpm4021:        *
      *                                                                *
      *                    Stampa archivio materie prime (rubrica)     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-stp.
               ...
               10  w-exp-tip-stp-lun      pic  9(02)       value 25   .
               10  w-exp-tip-stp-tbl.
                   15  filler             pic  x(25) value
                            "Rubrica materie prime    "               .
                   15  filler             pic  x(25) value
                            "Scheda completa          "               .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    "E"
                     move  "pgm/dpm/prg/obj/pdpm4021  "
                                          to   i-exe-pat
           else      move  "pgm/dpm/prg/obj/pdpm4022  "
                                          to   i-exe-pat              .
           call      i-exe-pat                                        .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    "E"
                     move  "pdpm4021  "   to   i-exe-pro
           else      move  "pdpm4022  "   to   i-exe-pro              .
           if        rr-tip-stp           =    "E"
                     move  "pgm/dpm/prg/obj/pdpm4021  "
                                          to   i-exe-pat
           else      move  "pgm/dpm/prg/obj/pdpm4022  "
      ...
      *              *-------------------------------------------------*
           ...
           else      move  66             to   w-cnt-stp-lin-min      .
      *              *-------------------------------------------------*
      *              * Bottom margin in linee                          *
      *              *-------------------------------------------------*
