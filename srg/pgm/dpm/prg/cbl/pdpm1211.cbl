      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione Classi materie prime         *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice classe materie prime    *
      *    *-----------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-zm1-cla      .
           move      14                   to   w-cod-mne-zm1-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zm1-ope      .
           move      rr-cod-max           to   w-cod-mne-zm1-cla      .
           move      14                   to   w-cod-mne-zm1-lin      .
           move      52                   to   w-cod-mne-zm1-pos      .
           move      zero                 to   w-cod-mne-zm1-dln      .
           move      zero                 to   w-cod-mne-zm1-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zm1-cod-cla         .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-zm1-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-mne-min           to   rf-zm1-mne-cla         .
           move      zero                 to   rf-zm1-cod-cla         .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-sqz-min           to   rf-zm1-sqz-num         .
           move      zero                 to   rf-zm1-cod-cla         .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zm1]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zm1-cod-cla       <    rr-cod-min or
                     rf-zm1-cod-cla       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zm1-des-key       <    rr-des-min or
                     rf-zm1-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zm1-mne-cla       <    rr-mne-min or
                     rf-zm1-mne-cla       >    rr-mne-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su numero di sequenza                 *
      *              *-------------------------------------------------*
           if        rf-zm1-sqz-num       <    rr-sqz-min or
                     rf-zm1-sqz-num       >    rr-sqz-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-zm1-cod-cla       to   w-mpn-cod-cla          .
           move      rf-zm1-des-cla       to   w-mpn-des-cla          .
           move      rf-zm1-ult-sud       to   w-mpn-ult-sud          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
