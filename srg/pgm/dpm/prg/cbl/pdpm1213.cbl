      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione Sottogruppi materie prime    *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           ...
           05  rr-cod-gru                 pic  9(05)                  .
           05  rr-des-gru                 pic  x(40)                  .
      ...
      *                * Codice gruppo                                 *
      *                *-----------------------------------------------*
                   15  w-ipc-dlp-tdi-cgr  pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Descrizione gruppo                            *
      *                *-----------------------------------------------*
                   15  w-ipc-dlp-tdi-dgr  pic  x(40)                  .
      *                *-----------------------------------------------*
      *                * Mnemonico                                     *
      *                *-----------------------------------------------*
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice sottogruppo mat. prime  *
      *    *-----------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-cod-sgr              pic  9(05)                  .
           05  w-mpn-des-sgr              pic  x(40)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-ipc-dlp-tdi-cgr    to   rr-cod-gru             .
           move      w-ipc-dlp-tdi-dgr    to   rr-des-gru             .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-cla           to   w-cod-mne-zm3-cla      .
           move      rr-des-cla           to   w-cod-mne-zm3-dcl      .
           move      rr-cod-gru           to   w-cod-mne-zm3-gru      .
           move      rr-des-gru           to   w-cod-mne-zm3-dgr      .
           move      rr-cod-min           to   w-cod-mne-zm3-sgr      .
           move      19                   to   w-cod-mne-zm3-lin      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-gru           to   w-cod-mne-zm3-gru      .
           move      rr-des-gru           to   w-cod-mne-zm3-dgr      .
           move      rr-cod-max           to   w-cod-mne-zm3-sgr      .
           move      19                   to   w-cod-mne-zm3-lin      .
           move      52                   to   w-cod-mne-zm3-pos      .
           move      zero                 to   w-cod-mne-zm3-dln      .
           move      zero                 to   w-cod-mne-zm3-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zm3-cod-cla         .
           move      rr-cod-gru           to   rf-zm3-cod-gru         .
           move      rr-cod-min           to   rf-zm3-cod-sgr         .
           move      "pgm/dpm/fls/ioc/obj/iofzm3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zm3-cod-cla         .
           move      rr-cod-gru           to   rf-zm3-cod-gru         .
           move      rr-des-min           to   rf-zm3-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zm3-cod-cla         .
           move      rr-cod-gru           to   rf-zm3-cod-gru         .
           move      rr-mne-min           to   rf-zm3-mne-sgr         .
           move      zero                 to   rf-zm3-cod-sgr         .
           move      "pgm/dpm/fls/ioc/obj/iofzm3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zm3-cod-cla         .
           move      rr-cod-gru           to   rf-zm3-cod-gru         .
           move      rr-sqz-min           to   rf-zm3-sqz-num         .
           move      zero                 to   rf-zm3-cod-sgr         .
           move      "pgm/dpm/fls/ioc/obj/iofzm3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun sottogruppo entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zm3]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dpm/fls/ioc/obj/iofzm3"
                                          to   s-pat                  .
      ...
      *              * Se ordinamento per codice                       *
      *              *-------------------------------------------------*
           if        rf-zm3-cod-cla       not  = rr-cod-cla
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           if        rf-zm3-cod-gru       not  = rr-cod-gru
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           if        rf-zm3-cod-sgr       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           go to     qry-tst-max-999.
       qry-tst-max-400.
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zm3-cod-sgr       <    rr-cod-min or
                     rf-zm3-cod-sgr       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zm3-des-key       <    rr-des-min or
                     rf-zm3-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zm3-mne-sgr       <    rr-mne-min or
                     rf-zm3-mne-sgr       >    rr-mne-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su numero di sequenza                 *
      *              *-------------------------------------------------*
           if        rf-zm3-sqz-num       <    rr-sqz-min or
                     rf-zm3-sqz-num       >    rr-sqz-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-zm3-cod-sgr       to   w-mpn-cod-sgr          .
           move      rf-zm3-des-sgr       to   w-mpn-des-sgr          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-sgr'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-ipc-dlp-tdi-cgr      .
           move      spaces               to   w-ipc-dlp-tdi-dgr      .
      ...
      *                  *---------------------------------------------*
      *                  * Estrazione della variabile "cod-gru"        *
      *                  *---------------------------------------------*
           move      "CV"                 to   s-ope                  .
           ...
           if        s-ves                not  = spaces
                     go to ipc-dlp-tdi-999.
           move      s-num                to   w-ipc-dlp-tdi-cgr      .
           if        w-ipc-dlp-tdi-cgr    =    zero
                     go to ipc-dlp-tdi-999.
      *                  *---------------------------------------------*
      *                  * Estrazione della variabile "des-gru"        *
      *                  *---------------------------------------------*
           move      "CV"                 to   s-ope                  .
           ...
           if        s-ves                not  = spaces
                     move  spaces         to   s-alf                  .
           move      s-alf                to   w-ipc-dlp-tdi-dgr      .
      *                  *---------------------------------------------*
