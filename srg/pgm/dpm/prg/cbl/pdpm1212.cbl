      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione Gruppi materie prime         *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice gruppo materie prime    *
      *    *-----------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-cla           to   w-cod-mne-zm2-cla      .
           move      rr-des-cla           to   w-cod-mne-zm2-dcl      .
           move      rr-cod-min           to   w-cod-mne-zm2-gru      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-cla           to   w-cod-mne-zm2-cla      .
           move      rr-des-cla           to   w-cod-mne-zm2-dcl      .
           move      rr-cod-max           to   w-cod-mne-zm2-gru      .
           move      17                   to   w-cod-mne-zm2-lin      .
           move      52                   to   w-cod-mne-zm2-pos      .
           move      zero                 to   w-cod-mne-zm2-dln      .
           move      zero                 to   w-cod-mne-zm2-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zm2-cod-cla         .
           move      rr-cod-min           to   rf-zm2-cod-gru         .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zm2-cod-cla         .
           move      rr-des-min           to   rf-zm2-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zm2-cod-cla         .
           move      rr-mne-min           to   rf-zm2-mne-gru         .
           move      zero                 to   rf-zm2-cod-gru         .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zm2-cod-cla         .
           move      rr-sqz-min           to   rf-zm2-sqz-num         .
           move      zero                 to   rf-zm2-cod-gru         .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zm2]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
      ...
      *              * Se ordinamento per codice                       *
      *              *-------------------------------------------------*
           if        rf-zm2-cod-cla       not  = rr-cod-cla
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           if        rf-zm2-cod-gru       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           go to     qry-tst-max-999.
       qry-tst-max-400.
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zm2-cod-gru       <    rr-cod-min or
                     rf-zm2-cod-gru       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zm2-des-key       <    rr-des-min or
                     rf-zm2-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zm2-mne-gru       <    rr-mne-min or
                     rf-zm2-mne-gru       >    rr-mne-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su numero di sequenza                 *
      *              *-------------------------------------------------*
           if        rf-zm2-sqz-num       <    rr-sqz-min or
                     rf-zm2-sqz-num       >    rr-sqz-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-zm2-cod-gru       to   w-mpn-cod-gru          .
           move      rf-zm2-des-gru       to   w-mpn-des-gru          .
           move      rf-zm2-ult-sud       to   w-mpn-ult-sud          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
