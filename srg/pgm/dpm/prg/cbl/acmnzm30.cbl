      ...
      *                    classificazioni gerarchiche materie prime   *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-mne-zm3-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-mne-zm3-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-mne-zm3-ope : "AC"                 *
      *                                                                *
      *                       w-cod-mne-zm3-cla : codice classe        *
      *                                                                *
      *                       w-cod-mne-zm3-dcl : descr. classe        *
      *                                                                *
      *                       w-cod-mne-zm3-gru : codice gruppo        *
      *                                                                *
      *                       w-cod-mne-zm3-dgr : descr. gruppo        *
      *                                                                *
      *                       w-cod-mne-zm3-sgr : codice sottogruppo   *
      *                                                                *
      *                       w-cod-mne-zm3-lin : linea codice         *
      *                                                                *
      *                       w-cod-mne-zm3-pos : posizione codice     *
      *                                                                *
      *                       w-cod-mne-zm3-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-mne-zm3-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-mne-zm3-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-mne-zm3-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-mne-zm3-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-mne-zm3-cla : codice classe        *
      ...
      ******************************************************************
       Procedure Division                using w-cod-mne-zm3
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-mne-zm3-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-mne-zm3-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-mne-zm3-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-mne-zm3-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-mne-zm3-ope    =    "A+" or
                     w-cod-mne-zm3-ope    =    "I+" or
                     w-cod-mne-zm3-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-mne-zm3-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      w-cod-mne-zm3-sgr    to   w-cod-mne-zm3-num      .
           move      v-edm                to   w-cod-mne-zm3-edm      .
           move      v-ufk                to   w-cod-mne-zm3-ufk      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-mne-zm3-edm    to   v-edm                  .
           move      w-cod-mne-zm3-num    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-edt                to   w-cod-mne-zm3-alf      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-mne-zm3-ufk    to   v-ufk                  .
           move      w-cod-mne-zm3-lin    to   v-lin                  .
           move      w-cod-mne-zm3-pos    to   v-pos                  .
           move      w-cod-mne-zm3-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-mne-zm3-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      v-alf                to   w-cod-mne-zm3-alf      .
      *              *-------------------------------------------------*
      *              * Test se Exit o Delt                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-cod-mne-zm3-num    to   w-cod-mne-zm3-sgr      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-num                to   w-cod-mne-zm3-num      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-cod-mne-zm3-alf    =    spaces
                     move  zero           to   w-cod-mne-zm3-num
                     go to aco-075.
           if        w-cod-mne-zm3-cha (1)
                                          =    spaces
                     go to aco-025.
      ...
      *              *-------------------------------------------------*
       ...
       aco-181.
           ...
           if        w-cod-mne-zm3-cha
                    ...
                    (w-aux-mne-sgr-c01)   >    "9"
                     go to aco-225.
           multiply  10                   by   w-cod-mne-zm3-num      .
           move      w-cod-mne-zm3-cha
                    (w-aux-mne-sgr-c01)   to   w-cod-mne-zm3-chn (05) .
           go to     aco-181.
       aco-200.
      *              *-------------------------------------------------*
      ...
      *                  * merico : uscita                             *
      *                  *---------------------------------------------*
           if        v-edt                =    w-cod-mne-zm3-alf
                     go to aco-075
      *                  *---------------------------------------------*
      *                  * Altrimenti : rivisualizzazione              *
      *                  *---------------------------------------------*
           else      move  v-edt          to   w-cod-mne-zm3-alf
                     go to aco-050.
       aco-225.
      *              *-------------------------------------------------*
      ...
      *                  * scrizione                                   *
      *                  *---------------------------------------------*
           if        w-cod-mne-zm3-alf    =    "-" and
                     w-cod-mne-zm3-dln    not  = zero
                     go to aco-500.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-cod-mne-zm3-cla    to   rf-zm3-cod-cla         .
           move      w-cod-mne-zm3-gru    to   rf-zm3-cod-gru         .
           move      w-cod-mne-zm3-alf    to   rf-zm3-mne-sgr         .
      ...
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to aco-250.
           if        rf-zm3-cod-cla       not  = w-cod-mne-zm3-cla
                     go to aco-250.
           if        rf-zm3-cod-gru       not  = w-cod-mne-zm3-gru
                     go to aco-250.
      *                      *-----------------------------------------*
      *                      * Mnemonico letto in area di lavoro di 5  *
      *                      * caratteri                               *
      *                      *-----------------------------------------*
           move      rf-zm3-mne-sgr       to   w-aux-mne-sgr-m05      .
      *                      *-----------------------------------------*
      *                      * Test se oltre il max                    *
      *                      *-----------------------------------------*
           if        w-aux-mne-sgr-m05    not  = w-cod-mne-zm3-alf
                     go to aco-250.
      *                      *-----------------------------------------*
      ...
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      rf-zm3-cod-sgr       to   w-aux-mne-sgr-cbu
                                              (w-aux-mne-sgr-crb)     .
           move      rf-zm3-mne-sgr       to   w-aux-mne-sgr-mbu
                                              (w-aux-mne-sgr-crb)     .
           move      rf-zm3-des-sgr       to   w-aux-mne-sgr-dbu
                                              (w-aux-mne-sgr-crb)     .
      *                      *-----------------------------------------*
      *                      * Riciclo a lettura                       *
      *                      *-----------------------------------------*
      ...
      *                      * non trovato                             *
      *                      *-----------------------------------------*
           if        w-cod-mne-zm3-dln    =    zero
                     go to aco-278.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
           move      w-cod-mne-zm3-dln    to   v-lin                  .
           move      w-cod-mne-zm3-dps    to   v-pos                  .
           move      all   "."            to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-278.
      ...
      *                      *-----------------------------------------*
       ...
       aco-382.
           ...
           move      w-aux-mne-sgr-cbu
                    (w-aux-mne-sgr-c01)   to   w-cod-mne-zm3-num      .
           go to     aco-200.
       aco-384.
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      05                   to   s-car                  .
           move      w-cod-mne-zm3-alf    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      "PV"                 to   s-ope                  .
           ...
           move      w-cod-mne-zm3-cla    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      "PV"                 to   s-ope                  .
           ...
           move      zero                 to   s-dec                  .
           move      spaces               to   s-sgn                  .
           move      w-cod-mne-zm3-gru    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           go to     aco-125.
       aco-500.
      ...
      *                      *-----------------------------------------*
           ...
           move      w-cod-mne-zm3-cla    to   rf-zm3-cod-cla         .
           move      w-cod-mne-zm3-gru    to   rf-zm3-cod-gru         .
           move      w-aux-mne-sgr-dup    to   rf-zm3-des-key         .
           move      zero                 to   rf-zm3-cod-sgr         .
           move      "pgm/dpm/fls/ioc/obj/iofzm3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                      * Test se oltre il max                    *
      *                      *-----------------------------------------*
           if        rf-zm3-des-key       >    w-aux-mne-sgr-rmx
                     go to aco-250.
      *                      *-----------------------------------------*
      *                      * Incremento numero records nel buffer    *
      *                      *-----------------------------------------*
