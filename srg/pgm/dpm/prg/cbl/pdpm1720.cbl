      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdpm1721:        *
      *                    Stampa codici statistici 1 materie prime    *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zms-001-cod      .
           move      14                   to   w-cmn-zms-001-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zms-001-ope      .
           move      rr-cod-max           to   w-cmn-zms-001-cod      .
           move      14                   to   w-cmn-zms-001-lin      .
           move      52                   to   w-cmn-zms-001-pos      .
           move      zero                 to   w-cmn-zms-001-dln      .
           move      zero                 to   w-cmn-zms-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
