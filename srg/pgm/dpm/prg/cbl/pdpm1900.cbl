      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cls        to   w-cmn-zms-003-cod      .
           move      04                   to   w-cmn-zms-003-lin      .
           move      30                   to   w-cmn-zms-003-pos      .
           move      07                   to   w-cmn-zms-003-dln      .
           move      30                   to   w-cmn-zms-003-dps      .
           move      "<B"                 to   v-edm                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      03                   to   rf-zms-tip-cls         .
           move      w-tes-cod-cls        to   rf-zms-cod-cls         .
           move      "pgm/dpm/fls/ioc/obj/iofzms"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-zms-mne-cls       to   w-tes-mne-cls (1)      .
           move      rf-zms-des-key       to   w-tes-des-key (1)      .
           move      rf-zms-des-cls       to   w-tes-des-cls (1)      .
           move      rf-zms-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zms]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zms-000      thru wrt-rec-zms-999        .
      ...
      *                      * Rewrite record [zms]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zms-000      thru rew-rec-zms-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zms]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zms-000      thru del-rec-zms-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zms]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zms-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-mne-cls (1)    to   rf-zms-mne-cls         .
           move      w-tes-des-key (1)    to   rf-zms-des-key         .
           move      w-tes-des-cls (1)    to   rf-zms-des-cls         .
           move      w-tes-alx-exp (1)    to   rf-zms-alx-exp         .
       cmp-rec-zms-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zms]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zms-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zms-000      thru cmp-rec-zms-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zms] parte 01    *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zms3"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           ...
           move      "CODCLS    "         to   f-key                  .
           move      03                   to   rf-zms-tip-cls         .
           move      w-enc-cod-val-pos    to   rf-zms-cod-cls         .
           move      "pgm/dpm/fls/ioc/obj/iofzms"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       rip-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zms]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zms3"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
