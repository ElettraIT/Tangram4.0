      ...
      *                                   Fase:    dpm402              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 09/04/93    *
      *                       Ultima revisione:    NdK del 02/08/99    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dpm402   *
      *                                                                *
      *                    Stampa anagrafiche materie prime : Scheda   *
      *                    completa                                    *
      *                                                                *
      *================================================================*
      ...
      *        *        ma                                             *
      *        *-------------------------------------------------------*
           05  w-pcl-lit-max              pic  9(03)      value 027   .
           ...
           05  w-pcl-lit-gen.
               ...
               10  filler                 pic  x(50)      value
                  "032 003 Materia prima in confezione:              ".
               10  filler                 pic  x(50)      value
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Stampa Scheda completa materia prima            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Intestazione foglio                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-128.
      *                  *---------------------------------------------*
      *                  * Tipo materia prima : non gestito            *
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      044                  to   p-pos                  .
           move      w-let-arc-zm1-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-148.
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      044                  to   p-pos                  .
           move      w-let-arc-zm2-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-156.
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      044                  to   p-pos                  .
           move      w-let-arc-zm3-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-164.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-172.
      *                  *---------------------------------------------*
      *                  * Si/no materia prima in confezione           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Literal                                 *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-pcl-ele-pcp
                    (w-pcl-lit-inx)       to   p-pos                  .
           if        rf-dpm-tip-cfz       =    zero
                     move  "No"           to   p-alf
           else if   rf-dpm-tip-cfz       =    01
                     move  "Si"           to   p-alf
           else      move  "? "           to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *                          *-------------------------------------*
           move      rf-dpm-umi-prd       to   w-let-arc-zum-cod      .
      ...
      *                          *-------------------------------------*
           ...
           move      rf-dpm-cod-s01       to   w-let-arc-zms-cod      .
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      044                  to   p-pos                  .
           move      w-let-arc-zms-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-344.
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      rf-dpm-cod-s02       to   w-let-arc-zms-cod      .
           perform   let-arc-zms-000      thru let-arc-zms-999        .
      *                          *-------------------------------------*
      *                          * Stampa                              *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      rf-dpm-cod-s03       to   w-let-arc-zms-cod      .
           perform   let-arc-zms-000      thru let-arc-zms-999        .
      *                          *-------------------------------------*
      *                          * Stampa                              *
      *                          *-------------------------------------*
