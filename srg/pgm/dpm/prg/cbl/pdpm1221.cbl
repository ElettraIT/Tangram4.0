      ...
      *                                   Fase:    dpm122              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 08/06/91    *
      *                       Ultima revisione:    NdK del 12/11/15    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdpm1220 *
      *                                                                *
      *                    Stampa classificazioni materie prime        *
      *                    - Classi                                    *
      *                    - Gruppi                                    *
      *                    - Sottogruppi                               *
      *                                                                *
