      ...
      *                       Ultima revisione:    Ndk del 07/04/17    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo per la selezione secondo il filtro   *
      *                    di ordinamento e selezione per file [dpm]   *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : f-ope  : "TO"                            *
      *                       f-key  : codice del filtro [dpm]         *
      *                                                                *
      *                                                                *
      *              Output : f-sts  : "01" : Per classe, gruppo, sot- *
      *                                       togruppo, codice materia *
      *                                       prima                    *
      *                                "02" : Per classe, gruppo, sot- *
      *                                       togruppo, descr. materia *
      *                                       prima                    *
      *                                "03" : Per codice materia p.    *
      *                                "04" : Per descrizione mat. p.  *
      *                                "05" : Per sinonimo materia p.  *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *    *===========================================================*
      *    * Work file per uscita da sort di [dpm]                     *
      *    *-----------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Codice materia prima alfanumerico min-max         *
      *            *---------------------------------------------------*
               10  w-let-flt-alf-min      pic  x(14)                  .
               10  w-let-flt-alf-max      pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Descrizione materia prima, uppercase, min-max     *
      *            *---------------------------------------------------*
      ...
      *            * Tipo materia prima                                *
      *            *---------------------------------------------------*
               10  w-let-flt-tip-map      pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Unita' di misura materia prima                    *
      *            *---------------------------------------------------*
               10  w-let-flt-umi-prd      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Codice statistico 1 materia prima                 *
      *            *---------------------------------------------------*
               10  w-let-flt-cod-s01      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice statistico 2 materia prima                 *
      *            *---------------------------------------------------*
               10  w-let-flt-cod-s02      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice statistico 3 materia prima                 *
      *            *---------------------------------------------------*
               10  w-let-flt-cod-s03      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice sinonimo min-max                           *
      *            *---------------------------------------------------*
               10  w-let-flt-syn-min      pic  x(13)                  .
               10  w-let-flt-syn-max      pic  x(13)                  .
      ...
      *              *-------------------------------------------------*
           perform   let-cod-flt-000      thru let-cod-flt-999        .
      *              *-------------------------------------------------*
      *              * Ordinamento e selezione [dpm] su filtro         *
      *              *-------------------------------------------------*
      ...
      *    * dell'area libera per il filtro 'dpm'                      *
      *    *-----------------------------------------------------------*
       nor-zos-dpm-000.
      *              *-------------------------------------------------*
      ...
      *              *                        gruppo, codice m.p.      *
      *              *-------------------------------------------------*
           move      01                   to   w-zos-dpm-tip-ord      .
      *              *-------------------------------------------------*
      *              * Classe merceologica min-max                     *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-dpm-cla-min      .
           move      99999                to   w-zos-dpm-cla-max      .
      *              *-------------------------------------------------*
      *              * Gruppo merceologico min-max                     *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-dpm-gru-min      .
           move      99999                to   w-zos-dpm-gru-max      .
      *              *-------------------------------------------------*
      *              * Sottogruppo merceologico min-max                *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-dpm-sgr-min      .
           move      99999                to   w-zos-dpm-sgr-max      .
      *              *-------------------------------------------------*
      *              * Codice materia prima alfanumerico min e max     *
      *              *-------------------------------------------------*
           move      spaces               to   w-zos-dpm-alf-min      .
           move      all   "z"            to   w-zos-dpm-alf-max      .
      *              *-------------------------------------------------*
      *              * Descrizione materia prima uppercase min-max     *
      *              *-------------------------------------------------*
           move      spaces               to   w-zos-dpm-des-min      .
           move      all   "z"            to   w-zos-dpm-des-max      .
      *              *-------------------------------------------------*
      *              * Sinonimo, min e max                             *
      *              *-------------------------------------------------*
           move      spaces               to   w-zos-dpm-syn-min      .
           move      all   "z"            to   w-zos-dpm-syn-max      .
      *              *-------------------------------------------------*
      *              * Tipo materia prima                              *
      *              *-------------------------------------------------*
           move      00                   to   w-zos-dpm-tip-map      .
      *              *-------------------------------------------------*
      *              * Unita' di misura materia prima                  *
      *              *-------------------------------------------------*
           move      spaces               to   w-zos-dpm-umi-prd      .
      *              *-------------------------------------------------*
      *              * Codice statistico 1 materia prima               *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-dpm-cod-s01      .
      *              *-------------------------------------------------*
      *              * Codice statistico 2 materia prima               *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-dpm-cod-s02      .
      *              *-------------------------------------------------*
      *              * Codice statistico 3 materia prima               *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-dpm-cod-s03      .
       nor-zos-dpm-999.
           exit.
      ...
      *                      *-----------------------------------------*
           if        w-zos-dpm-tip-ord    <    01 or
                     w-zos-dpm-tip-ord    >    05
                     go to let-cod-flt-150.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-zos-dpm-tip-ord    to   w-let-flt-tip-ord      .
       let-cod-flt-350.
      *                  *---------------------------------------------*
      ...
      *                          * Codice classe min                   *
      *                          *-------------------------------------*
           move      w-zos-dpm-cla-min    to   w-let-flt-cla-min      .
      *                          *-------------------------------------*
      *                          * Codice classe max                   *
      *                          *-------------------------------------*
           move      w-zos-dpm-cla-max    to   w-let-flt-cla-max      .
      *                          *-------------------------------------*
      ...
      *                          * Codice gruppo min                   *
      *                          *-------------------------------------*
           move      w-zos-dpm-gru-min    to   w-let-flt-gru-min      .
      *                          *-------------------------------------*
      *                          * Codice gruppo max                   *
      *                          *-------------------------------------*
           move      w-zos-dpm-gru-max    to   w-let-flt-gru-max      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-zos-dpm-sgr-min    to   w-let-flt-sgr-min      .
      *                          *-------------------------------------*
      *                          * Codice sottogruppo max              *
      *                          *-------------------------------------*
           move      w-zos-dpm-sgr-max    to   w-let-flt-sgr-max      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-let-flt-cla-min    to   rf-zm1-cod-cla         .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-zm1                 .
           if        f-sts                not  = e-not-err
                     move  zero           to   rf-zm1-sqz-num         .
           move      rf-zm1-sqz-num       to   w-let-flt-nsc-min      .
           move      rf-zm1-sqz-num       to   w-let-flt-nsc-max      .
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      w-let-flt-cla-min    to   rf-zm2-cod-cla         .
           move      w-let-flt-gru-min    to   rf-zm2-cod-gru         .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-zm2                 .
           if        f-sts                not  = e-not-err
                     move  zero           to   rf-zm2-sqz-num         .
           move      rf-zm2-sqz-num       to   w-let-flt-nsg-min      .
           move      rf-zm2-sqz-num       to   w-let-flt-nsg-max      .
      *                              *---------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      w-let-flt-cla-min    to   rf-zm3-cod-cla         .
           move      w-let-flt-gru-min    to   rf-zm3-cod-gru         .
           move      w-let-flt-sgr-min    to   rf-zm3-cod-sgr         .
           move      "pgm/dpm/fls/ioc/obj/iofzm3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-zm3                 .
           if        f-sts                not  = e-not-err
                     move  zero           to   rf-zm3-sqz-num         .
           move      rf-zm3-sqz-num       to   w-let-flt-nss-min      .
           move      rf-zm3-sqz-num       to   w-let-flt-nss-max      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      w-let-flt-cla-min    to   rf-zm3-cod-cla         .
           move      w-let-flt-gru-min    to   rf-zm3-cod-gru         .
           move      w-let-flt-sgr-max    to   rf-zm3-cod-sgr         .
           move      "pgm/dpm/fls/ioc/obj/iofzm3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                              *---------------------------------*
           ...
           move      "CODGRU    "         to   f-key                  .
           move      w-let-flt-cla-min    to   rf-zm2-cod-cla         .
           move      w-let-flt-gru-max    to   rf-zm2-cod-gru         .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
           ...
           move      "RK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      w-let-flt-cla-max    to   rf-zm1-cod-cla         .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
       ...
       let-cod-flt-500.
      *                  *---------------------------------------------*
      *                  * Codice m.p. min : semplice spostamento      *
      *                  *---------------------------------------------*
           move      w-zos-dpm-alf-min    to   w-let-flt-alf-min      .
       let-cod-flt-510.
      *                  *---------------------------------------------*
      *                  * Codice m.p. max : semplice spostamento      *
      *                  *---------------------------------------------*
           move      w-zos-dpm-alf-max    to   w-let-flt-alf-max      .
       let-cod-flt-520.
      *                  *---------------------------------------------*
      *                  * Codice m.p. min-max                         *
      *                  *---------------------------------------------*
       ...
       let-cod-flt-530.
      *                  *---------------------------------------------*
      *                  * Descrizione m.p. min : semplice spostamento *
      *                  *---------------------------------------------*
           move      w-zos-dpm-des-min    to   w-let-flt-des-min      .
       let-cod-flt-540.
      *                  *---------------------------------------------*
      *                  * Descrizione m.p. max : semplice spostamento *
      *                  *---------------------------------------------*
           move      w-zos-dpm-des-max    to   w-let-flt-des-max      .
       let-cod-flt-550.
      *                  *---------------------------------------------*
      *                  * Descrizione materia prima min-max           *
      *                  *---------------------------------------------*
       ...
       let-cod-flt-560.
      *                  *---------------------------------------------*
      *                  * Tipo materia prima : semplice spostamento   *
      *                  *---------------------------------------------*
           move      w-zos-dpm-tip-map    to   w-let-flt-tip-map      .
       let-cod-flt-590.
      *                  *---------------------------------------------*
      *                  * Unita' di misura m.p. : semplice spostamen- *
      *                  * to                                          *
      *                  *---------------------------------------------*
           move      w-zos-dpm-umi-prd    to   w-let-flt-umi-prd      .
       let-cod-flt-600.
      *                  *---------------------------------------------*
      *                  * Codice statistico 1 m.p. : semplice sposta- *
      *                  * mento                                       *
      *                  *---------------------------------------------*
           move      w-zos-dpm-cod-s01    to   w-let-flt-cod-s01      .
       let-cod-flt-610.
      *                  *---------------------------------------------*
      *                  * Codice statistico 2 m.p. : semplice sposta- *
      *                  * mento                                       *
      *                  *---------------------------------------------*
           move      w-zos-dpm-cod-s02    to   w-let-flt-cod-s02      .
       let-cod-flt-620.
      *                  *---------------------------------------------*
      *                  * Codice statistico 3 m.p. : semplice sposta- *
      *                  * mento                                       *
      *                  *---------------------------------------------*
           move      w-zos-dpm-cod-s03    to   w-let-flt-cod-s03      .
       let-cod-flt-630.
      *                  *---------------------------------------------*
      *                  * Codice sinonimo min m.p. : semplice sposta- *
      *                  * mento                                       *
      *                  *---------------------------------------------*
           move      w-zos-dpm-syn-min    to   w-let-flt-syn-min      .
       let-cod-flt-640.
      *                  *---------------------------------------------*
      *                  * Codice sinonimo max m.p. : semplice sposta- *
      *                  * mento                                       *
      *                  *---------------------------------------------*
           move      w-zos-dpm-syn-max    to   w-let-flt-syn-max      .
       let-cod-flt-650.
      *                  *---------------------------------------------*
      *                  * Codice sinonimo max m.p. : normalizzazione  *
      *                  *---------------------------------------------*
           if        w-let-flt-syn-max    =    spaces
                     if    w-let-flt-syn-min
                                          =    spaces
                           move  all "z"  to   w-let-flt-syn-max
                     else  move  w-let-flt-syn-min
                                          to   w-let-flt-syn-max      .
       let-cod-flt-680.
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       let-cod-flt-740.
      *                  *---------------------------------------------*
      *                  * Se tipo di codice anagrafico : [dpm]        *
      *                  *---------------------------------------------*
       let-cod-flt-742.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-let-flt-cod-cco    to   rf-dpm-num-map of
                                               rf-dpm                 .
           move      "pgm/dpm/fls/ioc/obj/iofdpm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
           ...
           call      s-pat               using f
                                               rf-dpm                 .
           if        f-sts                not  = e-not-err
                     move  spaces         to   rf-dpm-alf-map of
                                               rf-dpm                 .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      03                   to   w-zos-dpm-tip-ord      .
      *                      *-----------------------------------------*
      *                      * Classe merceologica min e max           *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-dpm-cla-min      .
           move      99999                to   w-zos-dpm-cla-max      .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico min e max           *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-dpm-gru-min      .
           move      99999                to   w-zos-dpm-gru-max      .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico min e max      *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-dpm-sgr-min      .
           move      99999                to   w-zos-dpm-sgr-max      .
      *                      *-----------------------------------------*
      *                      * Codice materia prima alfanumerico min e *
      *                      * max                                     *
      *                      *-----------------------------------------*
           move      rf-dpm-alf-map of
                     rf-dpm               to   w-zos-dpm-alf-min      .
           move      rf-dpm-alf-map of
                     rf-dpm               to   w-zos-dpm-alf-max      .
      *                      *-----------------------------------------*
      ...
      *                      * Tipo materia prima                      *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-dpm-tip-map      .
      *                      *-----------------------------------------*
      *                      * Unita' di misura                        *
      *                      *-----------------------------------------*
           move      spaces               to   w-zos-dpm-umi-prd      .
      ...
      *                      * Codice statistico 1 materia prima       *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-dpm-cod-s01      .
      *                      *-----------------------------------------*
      *                      * Codice statistico 2 materia prima       *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-dpm-cod-s02      .
      *                      *-----------------------------------------*
      *                      * Codice statistico 3 materia prima       *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-dpm-cod-s03      .
       let-cod-flt-746.
      *                      *-----------------------------------------*
      *                      * Area di lettura                         *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       let-cod-flt-760.
      *                  *---------------------------------------------*
      *                  * Se tipo di codice anagrafico : [zm1]        *
      *                  *---------------------------------------------*
       let-cod-flt-762.
      *                      *-----------------------------------------*
      *                      * Lettura codice [zm1]                    *
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      w-let-flt-cod-cco    to   rf-zm1-cod-cla         .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Classe merceologica min e max           *
      *                      *-----------------------------------------*
           move      rf-zm1-cod-cla       to   w-zos-dpm-cla-min      .
           move      rf-zm1-cod-cla       to   w-zos-dpm-cla-max      .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico min e max           *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-dpm-gru-min      .
      ...
      *                  *---------------------------------------------*
           if        w-let-flt-nss-max    <    w-let-flt-nss-min
                     go to ord-sel-flt-999.
      *                  *---------------------------------------------*
      *                  * Test su codice alfanumerico della materia   *
      *                  * prima min-max                               *
      *                  *---------------------------------------------*
           if        w-let-flt-alf-max    <    w-let-flt-alf-min
                     go to ord-sel-flt-999.
      *                  *---------------------------------------------*
      *                  * Test su descrizione della materia prima     *
      *                  * min-max                                     *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ord-sel-flt-055.
      *                  *---------------------------------------------*
      *                  * Se il codice alfanumerico della m.p. min    *
      *                  * e' diverso dal codice alfanumerico dela     *
      *                  * m.p. max non si puo' avere questa certezza  *
      ...
      *                  *---------------------------------------------*
      *                  * Se il codice alfanumerico della m.p. min e' *
      *                  * a spaces ed anche il codice alfanumerico    *
      *                  * della m.p. max e' a spaces non si puo' a-   *
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Start per codice alfanumerico su [dpm]  *
      *                      *-----------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "ALFMAP    "         to   f-key                  .
           move      w-let-flt-alf-min    to   rf-dpm-alf-map of
                                               rf-dpm                 .
           move      zero                 to   rf-dpm-num-map of
                                               rf-dpm                 .
           move      "pgm/dpm/fls/ioc/obj/iofdpm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
       ...
       ord-sel-flt-530.
      *              *-------------------------------------------------*
      *              * Se tipo ordinamento : 03 : Codice m.p.          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Esecuzione                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       ord-sel-flt-540.
      *              *-------------------------------------------------*
      *              * Se tipo ordinamento : 04 : Descrizione m.p.     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Esecuzione                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       ord-sel-flt-550.
      *              *-------------------------------------------------*
      *              * Se tipo ordinamento : 05 : Sinonimo m.p.        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Esecuzione                                  *
      *                  *---------------------------------------------*
           perform   ord-sel-005-000      thru ord-sel-005-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ord-sel-flt-999.
      ...
      *    *===========================================================*
      *    * Ordinamento e selezione [dpm]     Tipo ordinamento  01    *
      *    *                                                           *
      *    * Classe, gruppo, sottogruppo, codice materia prima         *
      *    *-----------------------------------------------------------*
       ord-sel-001-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       ord-sel-001-100.
      *              *-------------------------------------------------*
      *              * Start su [zm1] per numero di sequenza           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      w-let-flt-nsc-min    to   rf-zm1-sqz-num         .
      ...
      *              *-------------------------------------------------*
           if        rf-zm1-sqz-num       >    w-let-flt-nsc-max
                     go to ord-sel-001-900.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       ord-sel-001-150.
      *              *-------------------------------------------------*
      *              * Start su [zm2] per numero di sequenza           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      rf-zm1-cod-cla       to   rf-zm2-cod-cla         .
           move      w-let-flt-nsg-min    to   rf-zm2-sqz-num         .
      ...
      *              *-------------------------------------------------*
           if        rf-zm2-cod-cla       not  = rf-zm1-cod-cla
                     go to ord-sel-001-125.
           if        rf-zm2-sqz-num       >    w-let-flt-nsg-max
                     go to ord-sel-001-125.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       ord-sel-001-200.
      *              *-------------------------------------------------*
      *              * Start su [zm3] per numero di sequenza           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      rf-zm1-cod-cla       to   rf-zm3-cod-cla         .
           move      rf-zm2-cod-gru       to   rf-zm3-cod-gru         .
           move      w-let-flt-nss-min    to   rf-zm3-sqz-num         .
      ...
      *              *-------------------------------------------------*
           if        rf-zm3-cod-cla       not  = rf-zm1-cod-cla
                     go to ord-sel-001-175.
           if        rf-zm3-cod-gru       not  = rf-zm2-cod-gru
                     go to ord-sel-001-175.
           if        rf-zm3-sqz-num       >    w-let-flt-nss-max
                     go to ord-sel-001-175.
      *              *-------------------------------------------------*
      *              * A trattamento materia prima                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rf-zm1-ult-sud       not  = 02
                     go to ord-sel-001-125
           else if   rf-zm2-ult-sud       not  = 02
                     go to ord-sel-001-175
           else      go to ord-sel-001-225.
       ord-sel-001-275.
      *              *-------------------------------------------------*
      *              * Start su [dpm] per Classe, gruppo, sottogruppo  *
      *              *                  e codice materia prima         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "CGSALF    "         to   f-key                  .
           move      rf-zm1-cod-cla       to   rf-dpm-cla-map of
                                               rf-dpm                 .
           if        rf-zm1-ult-sud       not  = 02
                     move  zero           to   rf-dpm-gru-map of
                                               rf-dpm
                     move  zero           to   rf-dpm-sgr-map of
                                               rf-dpm
                     go to ord-sel-001-280.
           move      rf-zm2-cod-gru       to   rf-dpm-gru-map of
                                               rf-dpm                 .
           if        rf-zm2-ult-sud       not  = 02
                     move  zero           to   rf-dpm-sgr-map of
                                               rf-dpm
                     go to ord-sel-001-280.
           move      rf-zm3-cod-sgr       to   rf-dpm-sgr-map of
                                               rf-dpm                 .
       ord-sel-001-280.
           move      w-let-flt-alf-min    to   rf-dpm-alf-map of
                                               rf-dpm                 .
      ...
      *              *-------------------------------------------------*
           if        rf-dpm-cla-map of
                     rf-dpm               not  = rf-zm1-cod-cla
                     go to ord-sel-001-250.
           if        rf-zm1-ult-sud       not  = 02
                     go to ord-sel-001-327.
           if        rf-dpm-gru-map of
                     rf-dpm               not  = rf-zm2-cod-gru
                     go to ord-sel-001-250.
           if        rf-zm2-ult-sud       not  =  02
                     go to ord-sel-001-327.
           if        rf-dpm-sgr-map of
                     rf-dpm               not  = rf-zm3-cod-sgr
                     go to ord-sel-001-250.
       ord-sel-001-327.
           if        rf-dpm-alf-map of
                     rf-dpm               >    w-let-flt-alf-max
                     go to ord-sel-001-250.
       ord-sel-001-400.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Ordinamento e selezione [dpm]     Tipo ordinamento  02    *
      *    *                                                           *
      *    * Classe, gruppo, sottogruppo, descrizione materia prima    *
      *    *-----------------------------------------------------------*
       ord-sel-002-000.
      *              *-------------------------------------------------*
      *              * Open output file [ttt]                          *
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zm3-cod-sgr       to   rf-dpm-sgr-map of
                                               rf-dpm                 .
       ord-sel-002-280.
           move      w-let-flt-des-min    to   rf-dpm-des-key of
                                               rf-dpm                 .
           move      zero                 to   rf-dpm-num-map of
                                               rf-dpm                 .
           move      "pgm/dpm/fls/ioc/obj/iofdpm"
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-dpm-sgr-map of
                     ...
                     go to ord-sel-002-250.
       ord-sel-002-327.
           if        rf-dpm-des-key of
                     rf-dpm               >    w-let-flt-des-max
                     go to ord-sel-002-250.
       ord-sel-002-400.
      *              *-------------------------------------------------*
      *              * Selezione, mediante il filtro, del record let-  *
      ...
      *    *===========================================================*
      *    * Ordinamento e selezione [dpm]     Tipo ordinamento  03    *
      *    *                                                           *
      ...
      *              *-------------------------------------------------*
       ...
       ord-sel-003-100.
      *              *-------------------------------------------------*
      *              * Start su [dpm] per codice alfanumerico          *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "ALFMAP    "         to   f-key                  .
      ...
      *    *===========================================================*
      *    * Ordinamento e selezione [dpm]     Tipo ordinamento  04    *
      *    *                                                           *
      ...
      *              *-------------------------------------------------*
       ...
       ord-sel-004-100.
      *              *-------------------------------------------------*
      *              * Start su [dpm] per descrizione in uppercase     *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
      ...
      *    *===========================================================*
      *    * Ordinamento e selezione [dpm]     Tipo ordinamento  05    *
      *    *                                                           *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-let-flt-syn-min    to   rf-dpm-syn-map of
                                               rf-dpm                 .
           move      spaces               to   rf-dpm-alf-map of
                                               rf-dpm                 .
           move      zero                 to   rf-dpm-num-map of
      ...
      *              * Test Max, se non superato : ad uscita           *
      *              *-------------------------------------------------*
           if        rf-dpm-syn-map of
                     rf-dpm               >    w-let-flt-syn-max
                     go to ord-sel-005-900.
       ord-sel-005-400.
      *              *-------------------------------------------------*
      *              * Selezione, mediante il filtro, del record let-  *
      ...
      *    *===========================================================*
      *    * Selezione, mediante il filtro, del record in 'rf-dpm'     *
      *    *-----------------------------------------------------------*
       sel-rec-flt-000.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      rf-dpm-cla-map of
                     rf-dpm               to   rf-zm1-cod-cla         .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           if        rf-zm1-sqz-num       <    w-let-flt-nsc-min or
                     rf-zm1-sqz-num       >    w-let-flt-nsc-max
      ...
      *                      *-----------------------------------------*
           ...
           move      "CODGRU    "         to   f-key                  .
           move      rf-dpm-cla-map of
                     rf-dpm               to   rf-zm2-cod-cla         .
           move      rf-dpm-gru-map of
                     rf-dpm               to   rf-zm2-cod-gru         .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * selezione si considera fallita          *
      *                      *-----------------------------------------*
           if        rf-zm2-sqz-num       <    w-let-flt-nsg-min or
                     rf-zm2-sqz-num       >    w-let-flt-nsg-max
                     go to sel-rec-flt-900.
       sel-rec-flt-075.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "CODSGR    "         to   f-key                  .
           move      rf-dpm-cla-map of
                     rf-dpm               to   rf-zm3-cod-cla         .
           move      rf-dpm-gru-map of
                     rf-dpm               to   rf-zm3-cod-gru         .
           move      rf-dpm-sgr-map of
                     rf-dpm               to   rf-zm3-cod-sgr         .
           move      "pgm/dpm/fls/ioc/obj/iofzm3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * lita                                    *
      *                      *-----------------------------------------*
           if        rf-zm3-sqz-num       <    w-let-flt-nss-min or
                     rf-zm3-sqz-num       >    w-let-flt-nss-max
                     go to sel-rec-flt-900.
       sel-rec-flt-150.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-dpm-des-key of
                     rf-dpm               <    w-let-flt-des-min or
                     rf-dpm-des-key of
                     rf-dpm               >    w-let-flt-des-max
                     go to sel-rec-flt-900.
       sel-rec-flt-250.
      *              *-------------------------------------------------*
      *              * Selezione su tipo materia prima                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se tipo m.p. a zero : no selezione          *
      *                  *---------------------------------------------*
           if        w-let-flt-tip-map    =    zero
                     go to sel-rec-flt-300.
      *                  *---------------------------------------------*
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-dpm-tip-map of
                     rf-dpm               not  = w-let-flt-tip-map
                     go to sel-rec-flt-900.
       sel-rec-flt-300.
      *              *-------------------------------------------------*
      *              * Selezione su unita' di misura materia prima     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-dpm-umi-prd of
                     rf-dpm               not  = w-let-flt-umi-prd
                     go to sel-rec-flt-900.
       sel-rec-flt-450.
      *              *-------------------------------------------------*
      *              * Selezione su codice statistico 1 materia prima  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-dpm-cod-s01 of
                     rf-dpm               not  = w-let-flt-cod-s01
                     go to sel-rec-flt-900.
       sel-rec-flt-500.
      *              *-------------------------------------------------*
      *              * Selezione su codice statistico 2 materia prima  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-dpm-cod-s02 of
                     rf-dpm               not  = w-let-flt-cod-s02
                     go to sel-rec-flt-900.
       sel-rec-flt-550.
      *              *-------------------------------------------------*
      *              * Selezione su codice statistico 3 materia prima  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-dpm-cod-s03 of
                     rf-dpm               not  = w-let-flt-cod-s03
                     go to sel-rec-flt-900.
       sel-rec-flt-600.
      *              *-------------------------------------------------*
      *              * Selezione su sinonimo materia prima             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se tipo ordinamento per classe, gruppo, e   *
      *                  * sottogruppo : no selezione                  *
      ...
      *                  *---------------------------------------------*
      *                  * Se tipo ordinamento per sinonimo materia p. *
      *                  * : no selezione                              *
      *                  *---------------------------------------------*
           if        w-let-flt-tip-ord    =    05
                     go to sel-rec-flt-800.
      *                  *---------------------------------------------*
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-dpm-syn-map of
                     rf-dpm               <    w-let-flt-syn-min or
                     rf-dpm-syn-map of
                     rf-dpm               >    w-let-flt-syn-max
                     go to sel-rec-flt-900.
       sel-rec-flt-800.
      ...
      *                  *---------------------------------------------*
           if        rf-dpm-cla-map of
                     rf-dpm               <    w-let-flt-cla-min or
                     rf-dpm-cla-map of
                     rf-dpm               >    w-let-flt-cla-max
      ...
      *                  *---------------------------------------------*
           if        rf-dpm-gru-map of
                     rf-dpm               <    w-let-flt-gru-min or
                     rf-dpm-gru-map of
                     rf-dpm               >    w-let-flt-gru-max
                     go to sel-rec-sel-900.
       sel-rec-sel-100.
      *                  *---------------------------------------------*
      *                  * Selezione su sottogruppo                    *
      *                  *---------------------------------------------*
           if        rf-dpm-sgr-map of
                     rf-dpm               <    w-let-flt-sgr-min or
                     rf-dpm-sgr-map of
                     rf-dpm               >    w-let-flt-sgr-max
                     go to sel-rec-sel-900.
       sel-rec-sel-150.
      *              *-------------------------------------------------*
      *              * Selezione su codice alfanumerico min-max        *
      ...
      *                      *-----------------------------------------*
           if        rf-dpm-num-map of
                     rf-dpm               =    w-let-flt-cod-cco
                     go to sel-rec-sel-800
