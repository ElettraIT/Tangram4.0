      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdpm1821:        *
      *                    Stampa codici statistici 2 materie prime    *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zms-002-cod      .
           move      14                   to   w-cmn-zms-002-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zms-002-ope      .
           move      rr-cod-max           to   w-cmn-zms-002-cod      .
           move      14                   to   w-cmn-zms-002-lin      .
           move      52                   to   w-cmn-zms-002-pos      .
           move      zero                 to   w-cmn-zms-002-dln      .
           move      zero                 to   w-cmn-zms-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
