      ...
      *                    co 2 per classificazione materie prime      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE 2. COD. STAT. MAT. PRIME "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      40                   to   v-pos                  .
           move      rf-zms-des-cls       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zms-cod-cls       to   w-mpn-cod-cls          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "   2. CODICE STATISTICO MATERIE PRIME   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
