      ...
      *                       Ultima revisione:    Ndk del 17/08/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione codice materia prima    *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-cod-dpm-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-dpm-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-cod-dpm-ope : "AC"                 *
      *                                                                *
      *                       w-cod-cod-dpm-tac : Tipo accettazione    *
      *                                           - N : Numerico       *
      *                                           - A : Alfanumerico   *
      *                                           - S : Sinonimo       *
      *                                           - L : Libera, alfa-  *
      ...
      *                                                 controllata    *
      *                                                                *
      *                       w-cod-cod-dpm-num : Codice numerico      *
      *                                             Solo se tipo ac-   *
      *                                             cettazione 'N' o   *
      *                                             tipo acc.  'A'     *
      *                                                                *
      *                       w-cod-cod-dpm-alf : Codice alfanumerico  *
      *                                             Inutile se tipo    *
      *                                             accettazione 'N'   *
      *                                                                *
      *                       w-cod-cod-dpm-lin : linea a video        *
      *                                                                *
      *                       w-cod-cod-dpm-pos : posizione a video    *
      *                                                                *
      *                       w-cod-cod-dpm-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-cod-dpm-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-dpm-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-cod-dpm-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-dpm-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-cod-dpm-num : Codice numerico      *
      ...
      *            * - N : Codice materia prima numerico               *
      *            * - A : Codice materia prima alfanumerico           *
      *            * - S : Sinonimo                                    *
      ...
      *        * Tipo di ricerca                                       *
      *        * - S : Su sinonimo                                     *
      *        * - D : Su descrizione materia prima                    *
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-cod-cod-dpm-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-cod-dpm-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-cod-dpm-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-cod-dpm-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-cod-dpm-ope    =    "A+" or
                     w-cod-cod-dpm-ope    =    "I+" or
                     w-cod-cod-dpm-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-cod-dpm-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      spaces               to   w-cod-cod-dpm-pf2      .
      *                  *---------------------------------------------*
      *                  * Se tipo accettazione diverso da 'A' : no    *
      *                  *---------------------------------------------*
           if        w-cod-cod-dpm-tac    not  = "A"
                     go to acc-200.
      *                  *---------------------------------------------*
      ...
      *                  * Codice numerico                             *
      *                  *---------------------------------------------*
           if        w-cod-cod-dpm-tac    =    "N" or
                     w-cod-cod-dpm-tac    =    "A"
                     move  w-cod-cod-dpm-num
                                          to   w-cod-cod-dpm-s01
           else      move  zero           to   w-cod-cod-dpm-s01      .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico                         *
      *                  *---------------------------------------------*
           if        w-cod-cod-dpm-tac    =    "N"
                     move  spaces         to   w-cod-cod-dpm-s02
           else      move  w-cod-cod-dpm-alf
                                          to   w-cod-cod-dpm-s02      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing v-edm                   *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-cod-dpm-s70      .
      *                  *---------------------------------------------*
      *                  * User function-keys eventualmente epurate    *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-cod-dpm-s90      .
       acc-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-cod-cod-dpm-s01    to   w-edt-num-cod          .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-cod-dpm-s90    to   v-ufk                  .
           move      w-cod-cod-dpm-lin    to   v-lin                  .
           move      w-cod-cod-dpm-pos    to   v-pos                  .
           move      w-edt-num-edt        to   v-alf                  .
      *                  *---------------------------------------------*
      *                  * Tipo operazione a : continuazione           *
      *                  *---------------------------------------------*
           move      "A+"                 to   w-cod-cod-dpm-ope      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     acc-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-cod-dpm-lin    to   v-lin                  .
           move      w-cod-cod-dpm-pos    to   v-pos                  .
           move      w-cod-cod-dpm-s02    to   v-alf                  .
      *                  *---------------------------------------------*
      *                  * Tipo operazione a : continuazione           *
      *                  *---------------------------------------------*
           move      "A+"                 to   w-cod-cod-dpm-ope      .
      ...
      *              *-------------------------------------------------*
           if        w-cod-cod-dpm-ope    =    "A+"
                     go to aco-300
           else if   w-cod-cod-dpm-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                          * ta numerica                         *
      *                          *-------------------------------------*
           move      s-num                to   w-cod-cod-dpm-num      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-cod-cod-dpm-num    to   w-edt-num-cod          .
           perform   edn-000              thru edn-999                .
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Lettura del record 'dpm' relativo   *
      ...
      *                              *---------------------------------*
       ...
       aco-260.
      *                          *-------------------------------------*
      *                          * Se record 'dpm' esistente           *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Deviazione in funzione del tipo *
      *                              * di accettazione                 *
      *                              *---------------------------------*
           if        w-cod-cod-dpm-tac    =    "A"
                     go to aco-280.
       aco-270.
      *                              *---------------------------------*
      ...
      *                                  * uscita                      *
      *                                  *-----------------------------*
           move      rf-dpm-num-map       to   w-cod-cod-dpm-num      .
      *                                  *-----------------------------*
      *                                  * Valore alfanumerico conte-  *
      *                                  * nuto nel record in area di  *
      *                                  * uscita                      *
      *                                  *-----------------------------*
           move      rf-dpm-alf-map       to   w-cod-cod-dpm-alf      .
      *                                  *-----------------------------*
      ...
      *                          * ta numerica                         *
      *                          *-------------------------------------*
           move      w-man-x14-num        to   w-cod-cod-dpm-num      .
      *                          *-------------------------------------*
      *                          * Area di uscita alfanumerica a spa-  *
      *                          * ces                                 *
      *                          *-------------------------------------*
      ...
      *                          * ta alfanumerica                     *
      *                          *-------------------------------------*
           move      w-man-x14-alf        to   w-cod-cod-dpm-alf      .
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
       ...
       aco-460.
      *                          *-------------------------------------*
      *                          * Se trovato il record 'dpm' cercato  *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      ...
      *                                  *-----------------------------*
           if        w-cod-cod-dpm-pf2    not  = spaces
                     move  spaces         to   v-key
                     move  "F+"           to   w-cod-cod-dpm-ope
                     go to aco-999.
      *                                  *-----------------------------*
      *                                  * Tipo operazione : non-con-  *
      *                                  * tinuazione                  *
      ...
      *                                  *-----------------------------*
       ...
       aco-480.
      *                          *-------------------------------------*
      *                          * Se record 'dpm' relativo al codice  *
      ...
      *                              * per la descrizione              *
      *                              *---------------------------------*
           if        w-cod-cod-dpm-dln    =    zero
                     go to aco-482.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
           move      spaces               to   v-edm                  .
           move      w-cod-cod-dpm-dln    to   v-lin                  .
           move      w-cod-cod-dpm-dps    to   v-pos                  .
           move      all   "."            to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-482.
      ...
      *                      * vato                                    *
      *                      *-----------------------------------------*
           if        w-cod-cod-dpm-dln    =    zero or
                     w-cod-cod-dpm-dps    =    zero
                     go to aco-340.
       aco-545.
      *                      *-----------------------------------------*
      ...
      *                              *---------------------------------*
           move      w-cod-cod-dpm-s01    to   w-cod-cod-dpm-num      .
           move      w-cod-cod-dpm-s02    to   w-cod-cod-dpm-alf      .
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      "ALFMAP    "         to   f-key                  .
           move      "NL"                 to   f-cfr                  .
           move      w-rbl-des-min        to   rf-dpm-alf-map         .
           move      zero                 to   rf-dpm-num-map         .
           move      "pgm/dpm/fls/ioc/obj/iofdpm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                              * tinua                           *
      *                              *---------------------------------*
           if        rf-dpm-alf-map       >    w-rbl-des-max
                     go to aco-650
           else      go to aco-625.
       aco-623.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
       ...
       aco-625.
      *                      *-----------------------------------------*
      *                      * Test su status materia prima            *
      *                      *-----------------------------------------*
           if        rf-dpm-sta-tus       not  numeric
                     move  01             to   rf-dpm-sta-tus         .
           if        rf-dpm-sta-tus       not  = 01
                     go to aco-615.
       aco-628.
      *                      *-----------------------------------------*
      ...
      *                          * Descrizione della materia prima     *
      *                          *-------------------------------------*
           move      rf-dpm-des-map       to   w-buf-des-map
                                              (w-buf-ctr-rec)         .
       aco-635.
      *                      *-----------------------------------------*
      *                      * Riciclo a Read Next                     *
      ...
      *                                  *-----------------------------*
           move      w-buf-cod-num
                    (w-buf-ctr-ibx)       to   w-cod-cod-dpm-num      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           move      w-buf-cod-alf
                    (w-buf-ctr-ibx)       to   w-cod-cod-dpm-alf      .
      *                                  *-----------------------------*
      *                                  * Visualizzazione del valore  *
      *                                  * alfanumerico                *
      *                                  *-----------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      05                   to   v-pos                  .
           move      "             Selezionare il codice materia prima d
      -              "esiderato             "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
       ...
       sac-200.
      *              *-------------------------------------------------*
      *              * Test se codice materia prima numerico           *
      *              *-------------------------------------------------*
       ...
       sac-300.
      *              *-------------------------------------------------*
      *              * Test se codice materia prima alfanumerico       *
      *              *-------------------------------------------------*
