      ...
      *                                                                *
      *              Input  : w-cmn-zms-002-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cmn-zms-002-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cmn-zms-002-ope : "AC"                 *
      *                                                                *
      *                       w-cmn-zms-002-cod : codice statistico 2  *
      *                                                                *
      *                       w-cmn-zms-002-lin : linea codice         *
      *                                                                *
      *                       w-cmn-zms-002-pos : posizione codice     *
      *                                                                *
      *                       w-cmn-zms-002-dln : linea descrizione    *
      *                                                                *
      *                       w-cmn-zms-002-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cmn-zms-002-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cmn-zms-002-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cmn-zms-002-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cmn-zms-002-cod : codice statistico 2  *
      ...
      ******************************************************************
       Procedure Division                using w-cmn-zms-002
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cmn-zms-002-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cmn-zms-002-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cmn-zms-002-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cmn-zms-002-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cmn-zms-002-ope    =    "A+" or
                     w-cmn-zms-002-ope    =    "I+" or
                     w-cmn-zms-002-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cmn-zms-002-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      w-cmn-zms-002-cod    to   w-cmn-zms-002-num      .
           move      v-edm                to   w-cmn-zms-002-edm      .
           move      v-ufk                to   w-cmn-zms-002-ufk      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cmn-zms-002-edm    to   v-edm                  .
           move      w-cmn-zms-002-num    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-edt                to   w-cmn-zms-002-alf      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cmn-zms-002-ufk    to   v-ufk                  .
           move      w-cmn-zms-002-lin    to   v-lin                  .
           move      w-cmn-zms-002-pos    to   v-pos                  .
           move      w-cmn-zms-002-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cmn-zms-002-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      v-alf                to   w-cmn-zms-002-alf      .
      *              *-------------------------------------------------*
      *              * Test se Exit o Delt                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-cmn-zms-002-num    to   w-cmn-zms-002-cod      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           move      zero                 to   w-cmn-zms-002-dln      .
           move      zero                 to   w-cmn-zms-002-dps      .
           go to     aco-999.
       aco-100.
      *              *-------------------------------------------------*
      *              * Se rientro da Find                              *
      ...
      *                      *-----------------------------------------*
           move      s-num                to   w-cmn-zms-002-num      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-cmn-zms-002-alf    =    spaces
                     move  zero           to   w-cmn-zms-002-num
                     go to aco-075.
           if        w-cmn-zms-002-cha (1)
                                          =    spaces
                     go to aco-025.
      ...
      *              *-------------------------------------------------*
       ...
       aco-181.
           ...
           if        w-cmn-zms-002-cha
                    ...
                    (w-aux-mne-zms-c01)   >    "9"
                     go to aco-225.
           multiply  10                   by   w-cmn-zms-002-num      .
           move      w-cmn-zms-002-cha
                    (w-aux-mne-zms-c01)   to   w-cmn-zms-002-chn (05) .
           go to     aco-181.
       aco-200.
      *              *-------------------------------------------------*
      ...
      *                  * merico : uscita                             *
      *                  *---------------------------------------------*
           if        v-edt                =    w-cmn-zms-002-alf
                     go to aco-075
      *                  *---------------------------------------------*
      *                  * Altrimenti : rivisualizzazione              *
      *                  *---------------------------------------------*
           else      move  v-edt          to   w-cmn-zms-002-alf
                     go to aco-050.
       aco-225.
      *              *-------------------------------------------------*
      ...
      *                  * scrizione                                   *
      *                  *---------------------------------------------*
           if        w-cmn-zms-002-alf    =    "-" and
                     w-cmn-zms-002-dln    not  = zero
                     go to aco-500.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-cmn-zms-002-alf    to   rf-zms-mne-cls         .
      ...
      *                      *-----------------------------------------*
           if        w-aux-mne-zms-m05    not  = w-cmn-zms-002-alf
                     go to aco-250.
      *                      *-----------------------------------------*
      ...
      *                      * non trovato                             *
      *                      *-----------------------------------------*
           if        w-cmn-zms-002-dln    =    zero
                     go to aco-278.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      20                   to   v-car                  .
           move      w-cmn-zms-002-dln    to   v-lin                  .
           move      w-cmn-zms-002-dps    to   v-pos                  .
           move      all   "."            to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-278.
      ...
      *                      *-----------------------------------------*
       ...
       aco-382.
           ...
           move      w-aux-mne-zms-cbu
                    (w-aux-mne-zms-c01)   to   w-cmn-zms-002-num      .
           go to     aco-200.
       aco-384.
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      05                   to   s-car                  .
           move      w-cmn-zms-002-alf    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           go to     aco-125.
       aco-500.
