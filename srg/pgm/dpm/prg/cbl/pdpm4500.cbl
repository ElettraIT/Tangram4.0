      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase dpm450, nella sua globalita', esegue i tipi di manu-   *
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'dpm450'           *
      *              *-------------------------------------------------*
           perform   fas-dpm-450-000      thru fas-dpm-450-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-dpm-450-300
           else if   v-key                =    "PRSC"
                     go to fas-dpm-450-400
           else if   v-key                =    "NXSC"
                     go to fas-dpm-450-450
           else if   v-key                =    "DOWN"
                     go to fas-dpm-450-500
           else if   v-key                =    "EXIT"
                     go to fas-dpm-450-250
           else      go to fas-dpm-450-200.
       fas-dpm-450-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-man        =    zero
                     go to fas-dpm-450-330.
           move      zero                 to   w-tmn-ele-inx          .
       fas-dpm-450-322.
           add       1                    to   w-tmn-ele-inx          .
           if        w-tmn-ele-inx        >    w-tmn-ele-num
                     go to fas-dpm-450-340.
           if        w-tmn-num-tmn
                    (w-tmn-ele-inx)       =    w-key-num-man
                     go to fas-dpm-450-350
           else      go to fas-dpm-450-322.
       fas-dpm-450-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-dpm-450-630
           else if   v-key                =    "PRSC"
                     go to fas-dpm-450-600
           else if   v-key                =    "NXSC"
                     go to fas-dpm-450-610
           else if   v-key                =    "UP  "
                     go to fas-dpm-450-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-dpm-450-650
           else if   v-key                =    "EXIT"
                     go to fas-dpm-450-660
           else      go to fas-dpm-450-570.
       fas-dpm-450-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-dpm-450-626
           else      go to fas-dpm-450-628.
       fas-dpm-450-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-dpm-450-636
           else      go to fas-dpm-450-638.
       fas-dpm-450-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-dpm-450-725
           else      go to fas-dpm-450-750.
       fas-dpm-450-725.
      *              *-------------------------------------------------*
