      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dpm172   *
      *                                                                *
      *                    Stampa codice statistico 1 materie prime    *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zms-tip-cls         .
           move      rr-cod-min           to   rf-zms-cod-cls         .
           move      "pgm/dpm/fls/ioc/obj/iofzms"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zms-tip-cls         .
           move      rr-des-min           to   rf-zms-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zms-tip-cls         .
           move      rr-mne-min           to   rf-zms-mne-cls         .
           move      zero                 to   rf-zms-cod-cls         .
           move      "pgm/dpm/fls/ioc/obj/iofzms"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zms]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dpm/fls/ioc/obj/iofzms"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-zms-tip-cls       not  = rr-tip-cls
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zms-cod-cls       <    rr-cod-min or
                     rf-zms-cod-cls       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zms-des-key       <    rr-des-min or
                     rf-zms-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zms-mne-cls       <    rr-mne-min or
                     rf-zms-mne-cls       >    rr-mne-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "CODICE STATISTICO 1 MATERIE PRIME"
