      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdpm1921:        *
      *                    Stampa codici statistici 3 materie prime    *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zms-003-cod      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zms-003-ope      .
           move      rr-cod-max           to   w-cmn-zms-003-cod      .
           move      14                   to   w-cmn-zms-003-lin      .
           move      52                   to   w-cmn-zms-003-pos      .
           move      zero                 to   w-cmn-zms-003-dln      .
           move      zero                 to   w-cmn-zms-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
