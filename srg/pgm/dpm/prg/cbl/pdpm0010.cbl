      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               ...
               10  w-tes-dat-dpm.
                   ...
                   15  w-tes-tip-map      pic  9(02)                  .
                   15  w-tes-umi-prd      pic  x(03)                  .
                   15  w-tes-cod-s01      pic  9(05)                  .
                   15  w-tes-cod-s02      pic  9(05)                  .
                   15  w-tes-cod-s03      pic  9(05)                  .
                   15  w-tes-syn-min      pic  x(13)                  .
                   15  w-tes-syn-max      pic  x(13)                  .
               10  w-tes-des-dat.
                   15  w-tes-umi-prd-des  pic  x(20)                  .
           ...
           05  w-exp-tip-ord.
               ...
               10  w-exp-tip-ord-tbl.
                   15  filler             pic  x(40) value
                            "Classe, gruppo, sottogr., cod. mat. p.  ".
                   15  filler             pic  x(40) value
                            "Classe, gruppo, sottogr., desc. mat. p. ".
                   15  filler             pic  x(40) value
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice filtro                  *
      *    *-----------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Open modulo accettazione codice mat. p. 'dpm'   *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Preparazione tipo record con : 'dpm'            *
      *              *-------------------------------------------------*
           move      "dpm "               to   w-tes-tip-rec          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Close modulo accettazione codice mat. p. 'dpm'  *
      *              *-------------------------------------------------*
      ...
      *                  * Sinonimo min                                *
      *                  *---------------------------------------------*
           perform   acc-syn-min-000      thru acc-syn-min-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  * Sinonimo max                                *
      *                  *---------------------------------------------*
           perform   acc-syn-max-000      thru acc-syn-max-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  * Tipo materia prima                          *
      *                  *---------------------------------------------*
           perform   acc-tip-map-000      thru acc-tip-map-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        v-key                =    "PRSC"
                     move  "-"            to   w-cnt-tus-acc-tes      .
      ...
      *              * Sinonimo min                                    *
      *              *-------------------------------------------------*
           perform   vis-syn-min-000      thru vis-syn-min-999        .
      *              *-------------------------------------------------*
      *              * Sinonimo max                                    *
      *              *-------------------------------------------------*
           perform   vis-syn-max-000      thru vis-syn-max-999        .
           go to     vis-tes-reg-999.
       vis-tes-reg-200.
      *              *-------------------------------------------------*
      *              * Tipo materia prima                              *
      *              *-------------------------------------------------*
           perform   vis-tip-map-000      thru vis-tip-map-999        .
      *              *-------------------------------------------------*
      *              * Unita' di misura                                *
      *              *-------------------------------------------------*
      ...
      *              * Tipo materia prima                              *
      *              *-------------------------------------------------*
           perform   pmt-tip-map-000      thru pmt-tip-map-999        .
      *              *-------------------------------------------------*
      *              * Unita' di misura                                *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cla-min (1)    to   w-cod-mne-zm1-cla      .
           move      15                   to   w-cod-mne-zm1-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zm1-ope      .
           move      w-tes-cla-max (1)    to   w-cod-mne-zm1-cla      .
           move      15                   to   w-cod-mne-zm1-lin      .
           move      54                   to   w-cod-mne-zm1-pos      .
           move      zero                 to   w-cod-mne-zm1-dln      .
           move      zero                 to   w-cod-mne-zm1-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cla-min (1)    to   w-cod-mne-zm2-cla      .
           move      w-tes-gru-min (1)    to   w-cod-mne-zm2-gru      .
           move      16                   to   w-cod-mne-zm2-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zm2-ope      .
           move      w-tes-cla-max (1)    to   w-cod-mne-zm2-cla      .
           move      w-tes-gru-max (1)    to   w-cod-mne-zm2-gru      .
           move      16                   to   w-cod-mne-zm2-lin      .
           move      54                   to   w-cod-mne-zm2-pos      .
           move      zero                 to   w-cod-mne-zm2-dln      .
           move      zero                 to   w-cod-mne-zm2-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cla-min (1)    to   w-cod-mne-zm3-cla      .
           move      w-tes-gru-min (1)    to   w-cod-mne-zm3-gru      .
           move      w-tes-sgr-min (1)    to   w-cod-mne-zm3-sgr      .
           move      17                   to   w-cod-mne-zm3-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zm3-ope      .
           move      w-tes-cla-max (1)    to   w-cod-mne-zm3-cla      .
           move      w-tes-gru-max (1)    to   w-cod-mne-zm3-gru      .
           move      w-tes-sgr-max (1)    to   w-cod-mne-zm3-sgr      .
           move      17                   to   w-cod-mne-zm3-lin      .
           move      54                   to   w-cod-mne-zm3-pos      .
           move      zero                 to   w-cod-mne-zm3-dln      .
           move      zero                 to   w-cod-mne-zm3-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-min (1)    to   w-cod-cod-dpm-alf      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "L"                  to   w-cod-cod-dpm-tac      .
           move      zero                 to   w-cod-cod-dpm-num      .
           move      w-tes-cod-max (1)    to   w-cod-cod-dpm-alf      .
           move      19                   to   w-cod-cod-dpm-lin      .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Sinonimo min               *
      *    *-----------------------------------------------------------*
       acc-syn-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-syn-min-100.
       acc-syn-min-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Sinonimo min              *
      *    *-----------------------------------------------------------*
       vis-syn-min-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Sinonimo max               *
      *    *-----------------------------------------------------------*
       acc-syn-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-syn-max-100.
       acc-syn-max-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Sinonimo max              *
      *    *-----------------------------------------------------------*
       vis-syn-max-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Tipo materia prima           *
      *    *-----------------------------------------------------------*
       acc-tip-map-000.
       acc-tip-map-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Tipo materia prima        *
      *    *-----------------------------------------------------------*
       vis-tip-map-000.
       vis-tip-map-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-cmn-zms-001-lin      .
           move      30                   to   w-cmn-zms-001-pos      .
           move      11                   to   w-cmn-zms-001-dln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      15                   to   w-cmn-zms-003-lin      .
           move      30                   to   w-cmn-zms-003-pos      .
           move      15                   to   w-cmn-zms-003-dln      .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-tes-des-max (1)    not  < w-tes-des-min (1)
                     go to cnt-tdo-nok-500.
           move      "Errore tra i valori minimo e massimo descrizione"
                                          to   w-err-tdo-nok-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-syn-max (1)    =    spaces
                     go to cnt-tdo-nok-800.
           if        w-tes-syn-max (1)    not  < w-tes-syn-min (1)
                     go to cnt-tdo-nok-800.
           move      "Errore tra i valori minimo e massimo in sinonimo"
                                          to   w-err-tdo-nok-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   w-tes-syn-min (1)      .
           move      spaces               to   w-tes-syn-max (1)      .
      ...
      *              *-------------------------------------------------*
      *              * Normalizzazione dati per area specifica 'dpm'   *
      *              *-------------------------------------------------*
           move      zero                 to   w-zos-dpm-tip-ord      .
           move      zero                 to   w-zos-dpm-cla-min      .
           move      zero                 to   w-zos-dpm-cla-max      .
           move      zero                 to   w-zos-dpm-gru-min      .
           move      zero                 to   w-zos-dpm-gru-max      .
           move      zero                 to   w-zos-dpm-sgr-min      .
           move      zero                 to   w-zos-dpm-sgr-max      .
           move      spaces               to   w-zos-dpm-alf-min      .
           move      spaces               to   w-zos-dpm-alf-max      .
           move      spaces               to   w-zos-dpm-des-min      .
           move      spaces               to   w-zos-dpm-des-max      .
      ...
      *                          *-------------------------------------*
           ...
           move      w-zos-dpm-tip-ord    to   w-tes-tip-ord (1)      .
           move      w-zos-dpm-cla-min    to   w-tes-cla-min (1)      .
           move      w-zos-dpm-cla-max    to   w-tes-cla-max (1)      .
           move      w-zos-dpm-gru-min    to   w-tes-gru-min (1)      .
           move      w-zos-dpm-gru-max    to   w-tes-gru-max (1)      .
           move      w-zos-dpm-sgr-min    to   w-tes-sgr-min (1)      .
           move      w-zos-dpm-sgr-max    to   w-tes-sgr-max (1)      .
           move      w-zos-dpm-alf-min    to   w-tes-cod-min (1)      .
           move      w-zos-dpm-alf-max    to   w-tes-cod-max (1)      .
           move      w-zos-dpm-des-min    to   w-tes-des-min (1)      .
           move      w-zos-dpm-des-max    to   w-tes-des-max (1)      .
           move      w-zos-dpm-tip-map    to   w-tes-tip-map (1)      .
           if        w-tes-tip-map (1)    =    00
                     move  99             to   w-tes-tip-map (1)      .
           move      w-zos-dpm-umi-prd    to   w-tes-umi-prd (1)      .
           move      w-zos-dpm-cod-s01    to   w-tes-cod-s01 (1)      .
           move      w-zos-dpm-cod-s02    to   w-tes-cod-s02 (1)      .
           move      w-zos-dpm-cod-s03    to   w-tes-cod-s03 (1)      .
           move      w-zos-dpm-syn-min    to   w-tes-syn-min (1)      .
           move      w-zos-dpm-syn-max    to   w-tes-syn-max (1)      .
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   w-zos-dpm              .
           move      w-tes-tip-ord (1)    to   w-zos-dpm-tip-ord      .
           move      w-tes-cla-min (1)    to   w-zos-dpm-cla-min      .
           move      w-tes-cla-max (1)    to   w-zos-dpm-cla-max      .
           move      w-tes-gru-min (1)    to   w-zos-dpm-gru-min      .
           move      w-tes-gru-max (1)    to   w-zos-dpm-gru-max      .
           move      w-tes-sgr-min (1)    to   w-zos-dpm-sgr-min      .
           move      w-tes-sgr-max (1)    to   w-zos-dpm-sgr-max      .
           move      w-tes-cod-min (1)    to   w-zos-dpm-alf-min      .
           move      w-tes-cod-max (1)    to   w-zos-dpm-alf-max      .
           move      w-tes-des-min (1)    to   w-zos-dpm-des-min      .
           move      w-tes-des-max (1)    to   w-zos-dpm-des-max      .
           move      w-tes-tip-map (1)    to   w-zos-dpm-tip-map      .
           if        w-zos-dpm-tip-map    =    99
                     move  00             to   w-zos-dpm-tip-map      .
           move      w-tes-umi-prd (1)    to   w-zos-dpm-umi-prd      .
           move      w-tes-cod-s01 (1)    to   w-zos-dpm-cod-s01      .
           move      w-tes-cod-s02 (1)    to   w-zos-dpm-cod-s02      .
           move      w-tes-cod-s03 (1)    to   w-zos-dpm-cod-s03      .
           move      w-tes-syn-min (1)    to   w-zos-dpm-syn-min      .
           move      w-tes-syn-max (1)    to   w-zos-dpm-syn-max      .
           move      w-zos-dpm            to   rf-zos-dat-flt         .
       cmp-rec-zos-999.
           exit.
