      ...
      *    *-----------------------------------------------------------*
       01  w-enc-cod.
      *        *-------------------------------------------------------*
      *        * Per codice classe materia prima                       *
      *        *-------------------------------------------------------*
           05  w-enc-cod-cla.
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Per codice gruppo materia prima                       *
      *        *-------------------------------------------------------*
           05  w-enc-cod-gru.
      *            *---------------------------------------------------*
      *            * Codice classe                                     *
      ...
      *        *-------------------------------------------------------*
      *        * Per codice sottogruppo materia prima                  *
      *        *-------------------------------------------------------*
           05  w-enc-cod-sgr.
      *            *---------------------------------------------------*
      *            * Codice classe                                     *
      ...
      *                          *-------------------------------------*
           move      w-tes-cod-cla        to   w-let-arc-zm1-cla      .
      ...
      *                          *-------------------------------------*
           move      w-let-arc-zm1-mne    to   w-tes-cod-cla-mne      .
           move      w-let-arc-zm1-des    to   w-tes-cod-cla-des      .
           move      w-let-arc-zm1-sud    to   w-tes-cod-cla-sud      .
           move      w-let-arc-zm1-umi    to   w-tes-cod-cla-umi      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-tes-cod-cla        to   w-let-arc-zm2-cla      .
           move      w-tes-cod-gru        to   w-let-arc-zm2-gru      .
      ...
      *                          * - Unita' di misura da proporre      *
      *                          *-------------------------------------*
           move      w-let-arc-zm2-mne    to   w-tes-cod-gru-mne      .
           move      w-let-arc-zm2-des    to   w-tes-cod-gru-des      .
           move      w-let-arc-zm2-sud    to   w-tes-cod-gru-sud      .
           move      w-let-arc-zm2-umi    to   w-tes-cod-gru-umi      .
      *                          *-------------------------------------*
      *                          * Visualizzazione codice              *
      *                          *-------------------------------------*
           perform   vis-cod-gru-000      thru vis-cod-gru-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cla        to   w-cod-mne-zm2-cla      .
           move      w-tes-cod-cla-des    to   w-cod-mne-zm2-dcl      .
           move      w-tes-cod-gru        to   w-cod-mne-zm2-gru      .
           move      zero                 to   w-cod-mne-zm2-sgr      .
           move      06                   to   w-cod-mne-zm2-lin      .
           move      30                   to   w-cod-mne-zm2-pos      .
           if        w-tes-tip-ele        =    02
                     move  09             to   w-cod-mne-zm2-dln
                     move  30             to   w-cod-mne-zm2-dps
           else      move  06             to   w-cod-mne-zm2-dln
                     move  39             to   w-cod-mne-zm2-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *                          *-------------------------------------*
           move      w-tes-cod-cla        to   w-let-arc-zm3-cla      .
           move      w-tes-cod-gru        to   w-let-arc-zm3-gru      .
           move      w-tes-cod-sgr        to   w-let-arc-zm3-sgr      .
      ...
      *                          * - Unita' di misura da proporre      *
      *                          *-------------------------------------*
           move      w-let-arc-zm3-mne    to   w-tes-cod-sgr-mne      .
           move      w-let-arc-zm3-des    to   w-tes-cod-sgr-des      .
           move      w-let-arc-zm3-sud    to   w-tes-cod-sgr-sud      .
           move      w-let-arc-zm3-umi    to   w-tes-cod-sgr-umi      .
      *                          *-------------------------------------*
      *                          * Visualizzazione codice              *
      *                          *-------------------------------------*
           perform   vis-cod-sgr-000      thru vis-cod-sgr-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cla        to   w-cod-mne-zm3-cla      .
           move      w-tes-cod-cla-des    to   w-cod-mne-zm3-dcl      .
           move      w-tes-cod-gru        to   w-cod-mne-zm3-gru      .
           move      w-tes-cod-gru-des    to   w-cod-mne-zm3-dgr      .
           move      w-tes-cod-sgr        to   w-cod-mne-zm3-sgr      .
           move      07                   to   w-cod-mne-zm3-lin      .
      ...
      *                      *-----------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Unita' di misura da proporre per le materie    :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "         prime appartenenti a questa classe     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "         prime appartenenti a questo gruppo     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "    prime appartenenti a questo sottogruppo     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-cla        to   rf-zm1-cod-cla         .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Valori diretti                      *
      *                          *-------------------------------------*
           move      rf-zm1-des-cla       to   w-tes-des-cgs (1)      .
           move      rf-zm1-des-key       to   w-tes-des-key (1)      .
           move      rf-zm1-mne-cla       to   w-tes-mne-cgs (1)      .
           move      rf-zm1-sqz-num       to   w-tes-sqz-num (1)      .
           move      rf-zm1-ult-sud       to   w-tes-ult-sud (1)      .
           move      rf-zm1-umi-def       to   w-tes-umi-def (1)      .
           move      rf-zm1-ult-cod       to   w-tes-ult-cod (1)      .
           move      rf-zm1-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      *                          * Valori indiretti                    *
      *                          *-------------------------------------*
           move      w-tes-umi-def (1)    to   w-let-arc-zum-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-cla        to   rf-zm2-cod-cla         .
           move      w-tes-cod-gru        to   rf-zm2-cod-gru         .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Valori diretti                      *
      *                          *-------------------------------------*
           move      rf-zm2-des-gru       to   w-tes-des-cgs (1)      .
           move      rf-zm2-des-key       to   w-tes-des-key (1)      .
           move      rf-zm2-mne-gru       to   w-tes-mne-cgs (1)      .
           move      rf-zm2-sqz-num       to   w-tes-sqz-num (1)      .
           move      rf-zm2-ult-sud       to   w-tes-ult-sud (1)      .
           move      rf-zm2-umi-def       to   w-tes-umi-def (1)      .
           move      rf-zm2-ult-cod       to   w-tes-ult-cod (1)      .
           move      rf-zm2-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      *                          * Valori indiretti                    *
      *                          *-------------------------------------*
           move      w-tes-umi-def (1)    to   w-let-arc-zum-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-cla        to   rf-zm3-cod-cla         .
           move      w-tes-cod-gru        to   rf-zm3-cod-gru         .
           move      w-tes-cod-sgr        to   rf-zm3-cod-sgr         .
           move      "pgm/dpm/fls/ioc/obj/iofzm3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Valori diretti                      *
      *                          *-------------------------------------*
           move      rf-zm3-des-sgr       to   w-tes-des-cgs (1)      .
           move      rf-zm3-des-key       to   w-tes-des-key (1)      .
           move      rf-zm3-mne-sgr       to   w-tes-mne-cgs (1)      .
           move      rf-zm3-sqz-num       to   w-tes-sqz-num (1)      .
           move      rf-zm3-ult-sud       to   w-tes-ult-sud (1)      .
           move      rf-zm3-umi-def       to   w-tes-umi-def (1)      .
           move      rf-zm3-ult-cod       to   w-tes-ult-cod (1)      .
           move      rf-zm3-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      *                          * Valori indiretti                    *
      *                          *-------------------------------------*
           move      w-tes-umi-def (1)    to   w-let-arc-zum-cod      .
      ...
      *                      * Write record [zm1]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zm1-000      thru wrt-rec-zm1-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
      ...
      *                      * Rewrite record [zm1]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zm1-000      thru rew-rec-zm1-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Write record [zm2]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zm2-000      thru wrt-rec-zm2-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Rewrite record [zm2]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zm2-000      thru rew-rec-zm2-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Write record [zm3]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zm3-000      thru wrt-rec-zm3-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Rewrite record [zm3]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zm3-000      thru rew-rec-zm3-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                  * Delete record [zm1]                         *
      *                  *---------------------------------------------*
           perform   del-rec-zm1-000      thru del-rec-zm1-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *                  * Delete record [zm2]                         *
      *                  *---------------------------------------------*
           perform   del-rec-zm2-000      thru del-rec-zm2-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     del-mov-fil-999.
      ...
      *                  * Delete record [zm3]                         *
      *                  *---------------------------------------------*
           perform   del-rec-zm3-000      thru del-rec-zm3-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     del-mov-fil-999.
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-cgs (1)    to   rf-zm1-des-cla         .
           move      w-tes-mne-cgs (1)    to   rf-zm1-mne-cla         .
           move      w-tes-des-key (1)    to   rf-zm1-des-key         .
           move      w-tes-sqz-num (1)    to   rf-zm1-sqz-num         .
           move      w-tes-ult-sud (1)    to   rf-zm1-ult-sud         .
           move      w-tes-umi-def (1)    to   rf-zm1-umi-def         .
           move      w-tes-ult-cod (1)    to   rf-zm1-ult-cod         .
           move      w-tes-alx-exp (1)    to   rf-zm1-alx-exp         .
       cmp-rec-zm1-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zm1]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zm1-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zm1-000      thru cmp-rec-zm1-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-cgs (1)    to   rf-zm2-des-gru         .
           move      w-tes-mne-cgs (1)    to   rf-zm2-mne-gru         .
           move      w-tes-des-key (1)    to   rf-zm2-des-key         .
           move      w-tes-sqz-num (1)    to   rf-zm2-sqz-num         .
           move      w-tes-ult-sud (1)    to   rf-zm2-ult-sud         .
           move      w-tes-umi-def (1)    to   rf-zm2-umi-def         .
           move      w-tes-ult-cod (1)    to   rf-zm2-ult-cod         .
           move      w-tes-alx-exp (1)    to   rf-zm2-alx-exp         .
       cmp-rec-zm2-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zm2]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zm2-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zm2-000      thru cmp-rec-zm2-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-cgs (1)    to   rf-zm3-des-sgr         .
           move      w-tes-mne-cgs (1)    to   rf-zm3-mne-sgr         .
           move      w-tes-des-key (1)    to   rf-zm3-des-key         .
           move      w-tes-sqz-num (1)    to   rf-zm3-sqz-num         .
           move      w-tes-ult-sud (1)    to   rf-zm3-ult-sud         .
           move      w-tes-umi-def (1)    to   rf-zm3-umi-def         .
           move      w-tes-ult-cod (1)    to   rf-zm3-ult-cod         .
           move      w-tes-alx-exp (1)    to   rf-zm3-alx-exp         .
       cmp-rec-zm3-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zm3]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zm3-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zm3-000      thru cmp-rec-zm3-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cla-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zm1]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zm1 "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      w-enc-cod-cla-pos    to   rf-zm1-cod-cla         .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      w-enc-cod-gru-cla    to   rf-zm1-cod-cla         .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       att-gru-aut-250.
           ...
           move      "RK"                 to   f-ope                  .
           move      "CODGRU    "         to   f-key                  .
           move      w-enc-cod-gru-cla    to   rf-zm2-cod-cla         .
           move      w-enc-cod-gru-pos    to   rf-zm2-cod-gru         .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Memorizzazione del valore pre incremento    *
      *                  *---------------------------------------------*
           move      rf-zm1-ult-cod       to   w-enc-cod-gru-pre      .
      *                  *---------------------------------------------*
      *                  * Incremento del valore                       *
      *                  *---------------------------------------------*
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-gru-pos    to   rf-zm1-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * re post incremento                          *
      *                  *---------------------------------------------*
           if        rf-zm1-ult-cod       =    w-enc-cod-gru-pos
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-gru-pre    to   rf-zm1-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/dpm/fls/ioc/obj/iofzm1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODGRU    "         to   f-key                  .
           move      w-enc-cod-sgr-cla    to   rf-zm2-cod-cla         .
           move      w-enc-cod-sgr-gru    to   rf-zm2-cod-gru         .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       att-sgr-aut-250.
           ...
           move      "RK"                 to   f-ope                  .
           move      "CODSGR    "         to   f-key                  .
           move      w-enc-cod-sgr-cla    to   rf-zm3-cod-cla         .
           move      w-enc-cod-sgr-gru    to   rf-zm3-cod-gru         .
           move      w-enc-cod-sgr-pos    to   rf-zm3-cod-sgr         .
           move      "pgm/dpm/fls/ioc/obj/iofzm3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Memorizzazione del valore pre incremento    *
      *                  *---------------------------------------------*
           move      rf-zm2-ult-cod       to   w-enc-cod-sgr-pre      .
      *                  *---------------------------------------------*
      *                  * Incremento del valore                       *
      *                  *---------------------------------------------*
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-sgr-pos    to   rf-zm2-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * re post incremento                          *
      *                  *---------------------------------------------*
           if        rf-zm2-ult-cod       =    w-enc-cod-sgr-pos
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-sgr-pre    to   rf-zm2-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODGRU    "         to   f-key                  .
           move      w-det-gru-cla-cla    to   rf-zm2-cod-cla         .
      ...
      *              *-------------------------------------------------*
           if        rf-zm2-cod-cla       not  = w-det-gru-cla-cla
                     go to det-gru-cla-900.
       det-gru-cla-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODSGR    "         to   f-key                  .
           move      w-det-sgr-gru-cla    to   rf-zm3-cod-cla         .
           move      w-det-sgr-gru-gru    to   rf-zm3-cod-gru         .
      ...
      *              * Max su gruppi della classe                      *
      *              *-------------------------------------------------*
           if        rf-zm3-cod-cla       not  = w-det-sgr-gru-cla or
                     rf-zm3-cod-gru       not  = w-det-sgr-gru-gru
                     go to det-sgr-gru-900.
       det-sgr-gru-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-ctl-uni-nrs-nrs    to   rf-zm1-sqz-num         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-zm1-sqz-num       not  = w-ctl-uni-nrs-nrs
                     go to ctl-uni-nrs-600.
      *                  *---------------------------------------------*
      *                  * Se codice classe letto diverso da quello    *
      *                  * passato incremento il contatore             *
      *                  *---------------------------------------------*
           if        rf-zm1-cod-cla       not  = w-ctl-uni-nrs-cla
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      w-ctl-uni-nrs-cla    to   rf-zm2-cod-cla         .
           move      w-ctl-uni-nrs-nrs    to   rf-zm2-sqz-num         .
           move      zero                 to   rf-zm2-cod-gru         .
           move      "pgm/dpm/fls/ioc/obj/iofzm2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-zm2-cod-cla       not  = w-ctl-uni-nrs-cla or
                     rf-zm2-sqz-num       not  = w-ctl-uni-nrs-nrs
                     go to ctl-uni-nrs-600.
      *                  *---------------------------------------------*
      *                  * Se codice gruppo letto diverso da quello    *
      *                  * passato incremento il contatore             *
      *                  *---------------------------------------------*
           if        rf-zm2-cod-gru       not  = w-ctl-uni-nrs-gru
                     add   1              to   w-ctl-uni-nrs-ctr      .
      *                  *---------------------------------------------*
      *                  * Riciclo in lettura                          *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      w-ctl-uni-nrs-cla    to   rf-zm3-cod-cla         .
           move      w-ctl-uni-nrs-gru    to   rf-zm3-cod-gru         .
           move      w-ctl-uni-nrs-nrs    to   rf-zm3-sqz-num         .
           move      zero                 to   rf-zm3-cod-sgr         .
           move      "pgm/dpm/fls/ioc/obj/iofzm3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-zm3-cod-cla       not  = w-ctl-uni-nrs-cla or
                     rf-zm3-cod-gru       not  = w-ctl-uni-nrs-gru or
                     rf-zm3-sqz-num       not  = w-ctl-uni-nrs-nrs
                     go to ctl-uni-nrs-600.
      *                  *---------------------------------------------*
      *                  * Se codice sottogruppo letto diverso da quel-*
      *                  * lo passato incremento il contatore          *
      *                  *---------------------------------------------*
           if        rf-zm3-cod-sgr       not  = w-ctl-uni-nrs-sgr
                     add   1              to   w-ctl-uni-nrs-ctr      .
      *                  *---------------------------------------------*
      *                  * Riciclo in lettura                          *
      *                  *---------------------------------------------*
