      ...
      *    *===========================================================*
      *    * Record logico file [zm1]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/dpm/fls/rec/rfzm1"                          .

      ******************************************************************
       Procedure Division                using f rf-zm1               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-zm1                 .
           move      zero                 to   rf-zm1-cod-cla         .
           move      spaces               to   rf-zm1-des-cla         .
           move      spaces               to   rf-zm1-mne-cla         .
           move      spaces               to   rf-zm1-des-key         .
           move      zero                 to   rf-zm1-sqz-num         .
           move      zero                 to   rf-zm1-ult-sud         .
           move      spaces               to   rf-zm1-umi-def         .
           move      zero                 to   rf-zm1-ult-cod         .
           move      spaces               to   rf-zm1-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-zm1-des-cla       to   fil-des-cla            .
           move      rf-zm1-ult-sud       to   fil-ult-sud            .
           move      rf-zm1-umi-def       to   fil-umi-def            .
           move      rf-zm1-ult-cod       to   fil-ult-cod            .
           move      rf-zm1-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zm1-cod-cla       to   fil-cod-cla            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zm1-des-key       to   fil-des-key            .
           move      rf-zm1-cod-cla       to   fil-cod-cla-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zm1-mne-cla       to   fil-mne-cla            .
           move      rf-zm1-cod-cla       to   fil-cod-cla-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zm1-sqz-num       to   fil-sqz-num            .
           move      rf-zm1-cod-cla       to   fil-cod-cla-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-zm1                 .
           move      fil-cod-cla          to   rf-zm1-cod-cla         .
           move      fil-des-cla          to   rf-zm1-des-cla         .
           move      fil-mne-cla          to   rf-zm1-mne-cla         .
           move      fil-des-key          to   rf-zm1-des-key         .
           move      fil-sqz-num          to   rf-zm1-sqz-num         .
           move      fil-ult-sud          to   rf-zm1-ult-sud         .
           move      fil-umi-def          to   rf-zm1-umi-def         .
           move      fil-ult-cod          to   rf-zm1-ult-cod         .
           move      fil-alx-exp          to   rf-zm1-alx-exp         .
       dec-fis-log-999.
           exit.
