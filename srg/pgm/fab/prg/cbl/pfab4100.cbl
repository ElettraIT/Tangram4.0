      ...
      *                       Ultima revisione:    NdK del 16/05/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pfab4101:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-snx-fab.
               10  w-exp-snx-fab-num      pic  9(02)       value 3    .
               10  w-exp-snx-fab-lun      pic  9(02)       value 40   .
               10  w-exp-snx-fab-tbl.
                   15  filler             pic  x(40) value
                            "si, solo con fabbisogno per Data        ".
                   15  filler             pic  x(40) value
                            "si, solo con fabbisogno Assoluto        ".
                   15  filler             pic  x(40) value
                            "no, Tutti i prodotti                    ".
      *        *-------------------------------------------------------*
      *        * Work per : Tipo di correttivo alla giacenza da con-   *
      *        *            siderare                                   *
      *        *-------------------------------------------------------*
           05  w-exp-tcr-gia.
               10  w-exp-tcr-gia-num      pic  9(02)       value 2    .
               10  w-exp-tcr-gia-lun      pic  9(02)       value 20   .
               10  w-exp-tcr-gia-tbl.
                   15  filler             pic  x(20) value
                            "Nessuno             "                    .
                   15  filler             pic  x(20) value
                            "Scorta minima       "                    .
      *        *-------------------------------------------------------*
      *        * Work per : Si/no solo prodotti con scorta minima      *
      *        *-------------------------------------------------------*
           05  w-exp-snx-spc.
               10  w-exp-snx-spc-num      pic  9(02)       value 2    .
               10  w-exp-snx-spc-lun      pic  9(02)       value 40   .
               10  w-exp-snx-spc-tbl.
                   15  filler             pic  x(40) value
                            "Nessuna                                 ".
                   15  filler             pic  x(40) value
                            "Solo prodotti con scorta minima         ".
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-400.
      *                  *---------------------------------------------*
      *                  * Si/No solo fabbisogni                       *
      *                  *---------------------------------------------*
           perform   acc-snx-fab-000      thru acc-snx-fab-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
       ...
       acc-ric-sel-500.
      *                  *---------------------------------------------*
      *                  * Tipo correttivo alla giacenza               *
      *                  *---------------------------------------------*
           perform   acc-tcr-gia-000      thru acc-tcr-gia-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su scorta minima :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *                  * Si/No solo fabbisogni                       *
      *                  *---------------------------------------------*
           move      "D"                  to   rr-snx-fab             .
           perform   vis-snx-fab-000      thru vis-snx-fab-999        .
      *                  *---------------------------------------------*
      *                  * Tipo correttivo alla giacenza               *
      *                  *---------------------------------------------*
           move      01                   to   rr-tcr-gia             .
           perform   vis-tcr-gia-000      thru vis-tcr-gia-999        .
      *                  *---------------------------------------------*
      *                  * Si/no solo prodotti con scorta minima       *
      *                  *---------------------------------------------*
           move      01                   to   rr-snx-spc             .
           perform   vis-snx-spc-000      thru vis-snx-spc-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione : Si/No solo prodotti con fabbisogno         *
      *    *-----------------------------------------------------------*
       acc-snx-fab-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-fab-lun    to   v-car                  .
           move      w-exp-snx-fab-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      "DAT#"               to   v-msk                  .
           move      13                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-fab-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        rr-snx-fab           =    "D"
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  "A"            to   rr-snx-fab
           else if   v-num                =    03
                     move  "T"            to   rr-snx-fab
           else      move  spaces         to   rr-snx-fab             .
       acc-snx-fab-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        rr-snx-fab           not  = spaces
                     go to acc-snx-fab-500.
           if        v-key                =    "UP  "
                     go to acc-snx-fab-600
           else      go to acc-snx-fab-999.
       acc-snx-fab-500.
      *                  *---------------------------------------------*
      *                  * Test se valore ammesso                      *
      *                  *---------------------------------------------*
           if        rr-snx-fab           not  = "D" and
                     rr-snx-fab           not  = "A" and
                     rr-snx-fab           not  = "T"
                     go to acc-snx-fab-100.
       acc-snx-fab-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/No solo prodotti con fabbisogno      *
      *    *-----------------------------------------------------------*
       vis-snx-fab-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo correttivo alla giacenza              *
      *    *-----------------------------------------------------------*
       acc-tcr-gia-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tcr-gia-lun    to   v-car                  .
           move      w-exp-tcr-gia-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      16                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-tcr-gia-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        rr-tcr-gia           =    01
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  10             to   rr-tcr-gia
           else      move  zero           to   rr-tcr-gia             .
       acc-tcr-gia-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        rr-tcr-gia           not  = zero
                     go to acc-tcr-gia-500.
           if        v-key                =    "UP  "
                     go to acc-tcr-gia-600
           else      go to acc-tcr-gia-999.
       acc-tcr-gia-500.
      *                  *---------------------------------------------*
      *                  * Test se valore ammesso                      *
      *                  *---------------------------------------------*
           if        rr-tcr-gia           not  = 01 and
                     rr-tcr-gia           not  = 10
                     go to acc-tcr-gia-100.
       acc-tcr-gia-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/No analisi con sottoscorta           *
      *    *-----------------------------------------------------------*
       vis-tcr-gia-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Si/no solo prodotti con scorta minima      *
      *    *-----------------------------------------------------------*
       acc-snx-spc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/no solo prodotti con scorta minima   *
      *    *-----------------------------------------------------------*
       vis-snx-spc-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "Manca la data elaborazione !"
      ...
      *              *-------------------------------------------------*
           if        rr-tip-slp           =    zero
                     move  01             to   rr-tip-slp             .
      *              *-------------------------------------------------*
      *              * Normalizzazione Si/No solo fabbisogni           *
      *              *-------------------------------------------------*
           if        rr-snx-fab           =    spaces
                     move  "D"            to   rr-snx-fab             .
      *              *-------------------------------------------------*
      *              * Normalizzazione tipo correttivo alla giacenza   *
      *              *-------------------------------------------------*
           if        rr-tcr-gia           =    zero
                     move  01             to   rr-tcr-gia             .
      *              *-------------------------------------------------*
      *              * Normalizzazione Si/no solo prodotti con scorta  *
      *              *-------------------------------------------------*
           if        rr-snx-spc           =    zero
                     move  01             to   rr-snx-spc             .
       reg-ric-sel-999.
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      spaces               to   rr-snx-fab             .
           move      zero                 to   rr-tcr-gia             .
