      ...
      *                                   Fase:    fab400              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/05/95    *
      *                       Ultima revisione:    NdK del 07/06/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma fab400   *
      *                                                                *
      *                    Stampa fabbisogni assoluti prodotti di      *
      *                    vendita                                     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FABBISOGNI ASSOLUTI PRODOTTI DI VENDITA "       .
      ...
      *        * - 01 : Si                                             *
      *        * - 02 : No                                             *
      *        * - 03 : si, solo prodotti con scorta minima            *
      *        *-------------------------------------------------------*
           05  rr-snx-fab                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Coefficiente moltiplicatore scorta minima             *
      *        * - 1..9                                                *
      *        *                                                       *
      *        * N.B.: Solo se tipo correttivo alla giacenza pari a 10 *
      *        *-------------------------------------------------------*
           05  rr-coe-msc                 pic  9(01)v9(01)            .
      ...
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-dtb          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice dipendenza in uso                      [Input] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-dpz          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Tipo codice di magazzino                      [Input] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-tpm          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Codice numerico di magazzino                  [Input] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-cnm          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Work per ridefinizione tipo riga               [Work] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-wtr.
               10  w-det-qta-fod-wtp      pic  x(01)                  .
               10  w-det-qta-fod-wtf      pic  x(01)                  .
               10  filler                 pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Quantita' in giacenza                        [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qig          pic s9(06)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' correttiva della giacenza          [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qcg          pic s9(06)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' in spedizione                      [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qis          pic s9(06)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' in ordine da clienti               [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qoc          pic s9(06)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' in ordine a fornitori              [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qof          pic s9(06)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' di fabbisogno/disponibilita'       [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-fod-qfd          pic s9(06)v9(03)            .
      ...
      *        *-------------------------------------------------------*
           05  w-prn-qta-gia              pic s9(06)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' correttiva della giacenza                   *
      *        *-------------------------------------------------------*
           05  w-prn-qta-crg              pic s9(06)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' in corso di spedizione                      *
      *        *-------------------------------------------------------*
           05  w-prn-qta-ics              pic s9(06)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' in ordine da clienti                        *
      *        *-------------------------------------------------------*
           05  w-prn-qta-orc              pic s9(06)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' in ordine a fornitori                       *
      *        *-------------------------------------------------------*
           05  w-prn-qta-orf              pic s9(06)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' di fabbisogno/disponibilita'                *
      *        *-------------------------------------------------------*
           05  w-prn-qta-fod              pic s9(06)v9(03)            .
      ...
      *    *-----------------------------------------------------------*
       01  w-edt.
      *        *-------------------------------------------------------*
      *        * Comodo per editing coefficiente moltiplicatore        *
      *        *-------------------------------------------------------*
           05  w-edt-coe-msc              pic  x(03)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-det-qta-fod-dtb    to   d-sld-mag-dat-sld      .
           move      "U"                  to   d-sld-mag-uot-dpz      .
           move      w-det-qta-fod-dpz    to   d-sld-mag-cod-dpz      .
           move      w-det-qta-fod-tpm    to   d-sld-mag-tip-mag      .
           move      w-det-qta-fod-cnm    to   d-sld-mag-num-mag      .
      ...
      *                  * Bufferizzazione                             *
      *                  *---------------------------------------------*
           move      d-sld-mag-sld-mag    to   w-det-qta-fod-qig      .
       det-qta-fod-100.
      *              *-------------------------------------------------*
      *              * Determinazione quantita' di correttivo giacenza *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-det-qta-fod-qcg      .
      ...
      *                  *                                             *
      *                  * IMPORTANTE !!!                              *
      *                  * La scorta minima attualmente viene rilevata *
      *                  * con il codice dipendenza = 01               *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se dipendenza '01'                 *
      *                      *-----------------------------------------*
           if        w-det-qta-fod-dpz    not  = 01
                     move  zero           to   w-det-qta-fod-qcg
                     go to det-qta-fod-200.
      *                      *-----------------------------------------*
      *                      * Lettura record [fbs]                    *
      *                      *-----------------------------------------*
           ...
           move      w-det-qta-fod-tpm    to   rf-fbs-tip-mag         .
           move      w-det-qta-fod-cnm    to   rf-fbs-num-mag         .
           move      spaces               to   rf-fbs-var-mag         .
           move      w-det-qta-fod-dpz    to   rf-fbs-cod-dpz         .
           move      "pgm/fab/fls/ioc/obj/ioffbs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-fbs-sco-min (1)   to   w-det-qta-fod-qcg      .
      *                      *-----------------------------------------*
      *                      * Eventuale coefficiente moltiplicatore   *
      *                      *-----------------------------------------*
           multiply  rr-coe-msc           by   w-det-qta-fod-qcg      .
      *                      *-----------------------------------------*
      *                      * A determinazione successiva             *
      *                      *-----------------------------------------*
           go to     det-qta-fod-200.
       det-qta-fod-200.
      *              *-------------------------------------------------*
      *              * Determinazione quantita' in spedizione e ordi-  *
      *              * nata da clienti                                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione quantita' in spedizione     *
      *                  *---------------------------------------------*
           move      zero                 to   w-det-qta-fod-qis      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione quantita' ordinata da cli-  *
      *                  * enti                                        *
      *                  *---------------------------------------------*
           move      zero                 to   w-det-qta-fod-qoc      .
      *                  *---------------------------------------------*
      *                  * Start su file [ocr]                         *
      *                  *---------------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      w-det-qta-fod-dpz    to   rf-ocr-cod-dpz         .
           move      spaces               to   rf-ocr-flg-rch         .
           move      w-det-qta-fod-tpm    to   rf-ocr-tip-mag         .
           move      w-det-qta-fod-cnm    to   rf-ocr-num-pro         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-ocr-cod-dpz       not  = w-det-qta-fod-dpz or
                     rf-ocr-flg-rch       not  = spaces            or
                     rf-ocr-tip-mag       not  = w-det-qta-fod-tpm or
                     rf-ocr-num-pro       not  = w-det-qta-fod-cnm
                     go to det-qta-fod-300.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rf-ocr-tip-ord       =    "P"
                     go to det-qta-fod-220.
      *                      *-----------------------------------------*
      *                      * Test su data documento                  *
      *                      *-----------------------------------------*
           if        rf-ocr-dat-doc       >    w-det-qta-fod-dtb
                     go to det-qta-fod-220.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-ocr-tip-rig       to   w-det-qta-fod-wtr      .
      *                          *-------------------------------------*
      *                          * Test su tipo funzionamento          *
      *                          *-------------------------------------*
           if        w-det-qta-fod-wtf    not  = spaces
                     go to det-qta-fod-220.
      *                      *-----------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           add       d-qev-roc-qta-ics    to   w-det-qta-fod-qis      .
      *                  *---------------------------------------------*
      *                  * Aggiornamento quantita' ordinata da clienti *
      *                  *---------------------------------------------*
           add       d-qev-roc-qta-dev    to   w-det-qta-fod-qoc      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione quantita' ordinata a forni- *
      *                  * tori                                        *
      *                  *---------------------------------------------*
           move      zero                 to   w-det-qta-fod-qof      .
      *                  *---------------------------------------------*
      *                  * Start su file [ofr]                         *
      *                  *---------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "RCHMAG    "         to   f-key                  .
           move      w-det-qta-fod-dpz    to   rf-ofr-cod-dpz         .
           move      spaces               to   rf-ofr-flg-rch         .
           move      w-det-qta-fod-tpm    to   rf-ofr-tip-mag         .
           move      w-det-qta-fod-cnm    to   rf-ofr-num-mag         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-ofr-cod-dpz       not  = w-det-qta-fod-dpz  or
                     rf-ofr-flg-rch       not  = spaces             or
                     rf-ofr-tip-mag       not  = w-det-qta-fod-tpm  or
                     rf-ofr-num-mag       not  = w-det-qta-fod-cnm
                     go to det-qta-fod-400.
      *                  *---------------------------------------------*
      *                  * Selezione sul record                        *
      *                  *---------------------------------------------*
      ...
      *                      * Test su data documento                  *
      *                      *-----------------------------------------*
           if        rf-ofr-dat-doc       >    w-det-qta-fod-dtb
                     go to det-qta-fod-320.
      *                      *-----------------------------------------*
      *                      * Selezione su tipo riga                  *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Tipo riga in comodo ridefinito      *
      *                          *-------------------------------------*
           move      rf-ofr-tip-rig       to   w-det-qta-fod-wtr      .
      *                          *-------------------------------------*
      *                          * Test su tipo funzionamento          *
      *                          *-------------------------------------*
           if        w-det-qta-fod-wtf    not  = spaces
      ...
      *                  * ri                                          *
      *                  *---------------------------------------------*
           add       d-qev-rof-qta-dri    to   w-det-qta-fod-qof      .
      *                  *---------------------------------------------*
      ...
      *              * bilita'                                         *
      *              *-------------------------------------------------*
           move      w-det-qta-fod-qig    to   w-det-qta-fod-qfd      .
           subtract  w-det-qta-fod-qcg    from w-det-qta-fod-qfd      .
           subtract  w-det-qta-fod-qis    from w-det-qta-fod-qfd      .
           subtract  w-det-qta-fod-qoc    from w-det-qta-fod-qfd      .
           add       w-det-qta-fod-qof    to   w-det-qta-fod-qfd      .
       det-qta-fod-999.
           exit.
      ...
      *                  *---------------------------------------------*
       ...
       prn-sel-rec-050.
      *              *-------------------------------------------------*
      *              * Normalizzazione campi per la stampa             *
      *              *-------------------------------------------------*
           move      zero                 to   w-prn-qta-gia          .
           move      zero                 to   w-prn-qta-crg          .
           move      zero                 to   w-prn-qta-ics          .
           move      zero                 to   w-prn-qta-orc          .
           move      zero                 to   w-prn-qta-orf          .
           move      zero                 to   w-prn-qta-fod          .
       prn-sel-rec-080.
      *              *-------------------------------------------------*
      *              * Ciclo su codici dipendenza richiesti            *
      *              *-------------------------------------------------*
           if        rr-dpz-inu           not  = zero
                     go to prn-sel-rec-500.
       prn-sel-rec-100.
      *                  *---------------------------------------------*
      *                  * Determinazione quantita' di fabbisogno/     *
      *                  * disponibilita' per le dipendenze richieste  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Inizio scansione                        *
      *                      *-----------------------------------------*
       ...
       prn-sel-rec-110.
           ...
           if        w-cix-ctr-001        >    rr-dpz-ctr-sel
                     go to prn-sel-rec-200.
       prn-sel-rec-120.
      *                      *-----------------------------------------*
      *                      * Determinazione                          *
      *                      *-----------------------------------------*
           move      rr-dat-ela           to   w-det-qta-fod-dtb      .
           move      rr-dpz-ele-cod
                    (w-cix-ctr-001)       to   w-det-qta-fod-dpz      .
           move      01                   to   w-det-qta-fod-tpm      .
           move      rf-dcp-num-pro       to   w-det-qta-fod-cnm      .
           perform   det-qta-fod-000      thru det-qta-fod-999        .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione elementi di stampa      *
      *                      *-----------------------------------------*
           add       w-det-qta-fod-qig    to   w-prn-qta-gia          .
           add       w-det-qta-fod-qcg    to   w-prn-qta-crg          .
           add       w-det-qta-fod-qis    to   w-prn-qta-ics          .
           add       w-det-qta-fod-qoc    to   w-prn-qta-orc          .
           add       w-det-qta-fod-qof    to   w-prn-qta-orf          .
           add       w-det-qta-fod-qfd    to   w-prn-qta-fod          .
      *                      *-----------------------------------------*
      *                      * Riciclo                                 *
      *                      *-----------------------------------------*
       ...
       prn-sel-rec-200.
      *                      *-----------------------------------------*
      *                      * Se non esistono fabbisogni per il pro-  *
      *                      * dotto in esame e richiesta stampa dei   *
      *                      * soli fabbisogni : selezione non supera- *
      *                      * ta                                      *
      *                      *-----------------------------------------*
           if        w-prn-qta-fod        not  < zero and
                    (rr-snx-fab           =    01     or
                     rr-snx-fab           =    03)
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      ...
      *                  *---------------------------------------------*
      *                  * Determinazione quantita' di fabbisogno/     *
      *                  * disponibilita' per la dipendenza richiesta  *
      *                  * solo se unica                               *
      *                  *---------------------------------------------*
           move      rr-dat-ela           to   w-det-qta-fod-dtb      .
           move      rr-dpz-inu           to   w-det-qta-fod-dpz      .
           move      01                   to   w-det-qta-fod-tpm      .
           move      rf-dcp-num-pro       to   w-det-qta-fod-cnm      .
           perform   det-qta-fod-000      thru det-qta-fod-999        .
      *                      *-----------------------------------------*
      ...
      *                      * ta                                      *
      *                      *-----------------------------------------*
           if        w-det-qta-fod-qfd    not  < zero and
                    (rr-snx-fab           =    01     or
                     rr-snx-fab           =    03)
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      ...
      *                      * Bufferizzazione elementi di stampa      *
      *                      *-----------------------------------------*
           move      w-det-qta-fod-qig    to   w-prn-qta-gia          .
           move      w-det-qta-fod-qcg    to   w-prn-qta-crg          .
           move      w-det-qta-fod-qis    to   w-prn-qta-ics          .
           move      w-det-qta-fod-qoc    to   w-prn-qta-orc          .
           move      w-det-qta-fod-qof    to   w-prn-qta-orf          .
           move      w-det-qta-fod-qfd    to   w-prn-qta-fod          .
       prn-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      073                  to   p-pos                  .
           move      w-prn-qta-ics        to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Quantita' correttiva di giacenza            *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
      ...
      *                      * String                                  *
      *                      *-----------------------------------------*
           string    "LISTA FABBISOGNI ASSOLUTI PRODOTTI DI VENDITA AL "
                                delimited by   size
                     p-edt
                                delimited by   spaces
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo correttivo alla   *
      *              * giacenza da considerare                         *
      *              *-------------------------------------------------*
           if        rr-tcr-gia           =    01
      ...
      *                  *---------------------------------------------*
      ...
      -              "      U.M.   Giacenza   Spedizione               C
      -              "lienti    Fornitori  Fabb./Disp."
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       int-fin-det-200.
      *              *-------------------------------------------------*
      *              * Tipo correttivo alla giacenza : Scorta minima   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Prima linea di fincatura                    *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Editing coefficiente moltiplicatore         *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      01                   to   p-car                  .
           ...
           move      spaces               to   p-sgn                  .
           move      "<BD"                to   p-edm                  .
           move      rr-coe-msc           to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-edt-coe-msc          .
      *                  *---------------------------------------------*
      *                  * Seconda linea di fincatura                  *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           ...
           move      001                  to   p-pos                  .
           move      "    Codice                    Descrizione         
      -              "      U.M.   Giacenza   Spedizione    Minima     C
      -              "lienti    Fornitori  Fabb./Disp."
                                          to   p-alf                  .
       int-fin-det-210.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-coe-msc           =    1
                     go to int-fin-det-220.
      *                          *-------------------------------------*
      *                          * Preparazione literal                *
      *                          *-------------------------------------*
           move      11                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      "Min. x"             to   w-all-str-cat (1)      .
           move      w-edt-coe-msc        to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           perform   all-str-cen-000      thru all-str-cen-999        .
      *                          *-------------------------------------*
      *                          * Update campo di stampa              *
      *                          *-------------------------------------*
           move      w-all-str-alf        to   p-alf (86 : 11)        .
       int-fin-det-220.
      *                      *-----------------------------------------*
