      ...
      *                       Ultima revisione:    NdK del 03/09/99    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pfab4201:        *
      *                                                                *
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-300.
      *                  *---------------------------------------------*
      *                  * Percentuale di maggiorazione impegno mensi- *
      *                  * le                                          *
      *                  *---------------------------------------------*
           perform   acc-pdm-imm-000      thru acc-pdm-imm-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *    *===========================================================*
      *    * Accettazione : Percentuale di maggiorazione impegno men-  *
      *    * sile                                                      *
      *    *-----------------------------------------------------------*
       acc-pdm-imm-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-pdm-imm-999.
       acc-pdm-imm-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-pdm-imm             .
       acc-pdm-imm-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-pdm-imm-100.
       acc-pdm-imm-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Percentuale di maggiorazione impegno    *
      *    * mensile                                                   *
      *    *-----------------------------------------------------------*
       vis-pdm-imm-000.
           move      "DS"                 to   v-ope                  .
