      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Cancellazione valori di bilancio            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    CANCELLAZIONE VALORI DI BILANCIO    "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Cancellazione dei valori al  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ric-sel-999.
      ...
      *                  * Test su data                                *
      *                  *---------------------------------------------*
           if        rf-vbv-dat-bil       not  = rr-dat-bil
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezioni su [vbv]                              *
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun valore da cancellare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      "Cancellazione eseguita con successo !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-fin-cic-999.
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-vbv                 .
      *                  *---------------------------------------------*
      *                  * Composizione chiave record [vbv]            *
      *                  *---------------------------------------------*
           move      rr-tip-bil           to   rf-vbv-tip-bil         .
           move      rr-dat-bil           to   rf-vbv-dat-bil         .
