      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella tipi di bilancio           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   GESTIONE TABELLA TIPI DI BILANCIO    "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-tpb          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-tpb          pic  x(30)                  .
               10  w-tes-des-key          pic  x(30)                  .
               10  w-tes-snx-vaz          pic  x(01)                  .
               10  w-tes-alx-exp.
      ...
      *              *-------------------------------------------------*
      *              * Open modulo accettazione tipo di bilancio       *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pos-exe-pgm-000.
      *              *-------------------------------------------------*
      *              * Close modulo accettazione tipo di bilancio      *
      *              *-------------------------------------------------*
      ...
      *              * Codice tipo di bilancio                         *
      *              *-------------------------------------------------*
           perform   vis-cod-tpb-000      thru vis-cod-tpb-999        .
       vis-key-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice tipo di bilancio       *
      *    *-----------------------------------------------------------*
       acc-cod-tpb-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-tpb        to   w-cod-cod-ztb-cod      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice tipo di bilancio    *
      *    *-----------------------------------------------------------*
       vis-cod-tpb-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Descrizione                                 *
      *                  *---------------------------------------------*
           perform   acc-des-tpb-000      thru acc-des-tpb-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
       acc-tes-reg-200.
      *                  *---------------------------------------------*
      *                  * Si/No esposizione anche delle voci a zero   *
      *                  *---------------------------------------------*
           perform   acc-snx-vaz-000      thru acc-snx-vaz-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Descrizione                                     *
      *              *-------------------------------------------------*
           perform   vis-des-tpb-000      thru vis-des-tpb-999        .
      *              *-------------------------------------------------*
      *              * Si/No esposizione anche delle voci a zero       *
      *              *-------------------------------------------------*
           perform   vis-snx-vaz-000      thru vis-snx-vaz-999        .
       vis-tes-reg-999.
           exit.
      ...
      *              * Descrizione                                     *
      *              *-------------------------------------------------*
           perform   pmt-des-tpb-000      thru pmt-des-tpb-999        .
      *              *-------------------------------------------------*
      *              * Si/No esposizione anche delle voci a zero       *
      *              *-------------------------------------------------*
           perform   pmt-snx-vaz-000      thru pmt-snx-vaz-999        .
       pmt-tes-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/No esposizione anche delle    *
      *    *                          voci a zero                      *
      *    *-----------------------------------------------------------*
       pmt-snx-vaz-000.
           move      "DS"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-tpb (1)    =    spaces
                     go to acc-des-tpb-100.
       acc-des-tpb-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-des-tpb (1)    to   w-all-str-alf          .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/No esposizione anche delle voci a *
      *    *                      zero                                 *
      *    *-----------------------------------------------------------*
       acc-snx-vaz-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-sts-imp-tes    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
           if        w-tes-snx-vaz (1)    =    "S"
                     move  01             to   v-num
           else if   w-tes-snx-vaz (1)    =    "N"
                     move  02             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "S"            to   w-tes-snx-vaz (1)
           else if   v-num                =    02
                     move  "N"            to   w-tes-snx-vaz (1)
           else      move  spaces         to   w-tes-snx-vaz (1)      .
       acc-snx-vaz-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-snx-vaz (1)    not  = spaces
                     go to acc-snx-vaz-600.
           if        v-key                =    "UP  "
                     go to acc-snx-vaz-600
           else      go to acc-snx-vaz-100.
       acc-snx-vaz-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-snx-vaz-100.
       acc-snx-vaz-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Si/No esposizione anche delle     *
      *    *                         voci a zero                       *
      *    *-----------------------------------------------------------*
       vis-snx-vaz-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-tpb (1)      .
           move      spaces               to   w-tes-des-key (1)      .
           move      spaces               to   w-tes-snx-vaz (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-tpb        to   rf-ztb-cod-tpb         .
           move      "pgm/bil/fls/ioc/obj/iofztb"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [ztb]                        *
      *                          *-------------------------------------*
           move      rf-ztb-des-tpb       to   w-tes-des-tpb (1)      .
           move      rf-ztb-des-key       to   w-tes-des-key (1)      .
           move      rf-ztb-snx-vaz       to   w-tes-snx-vaz (1)      .
           move      rf-ztb-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [ztb]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-ztb-000      thru wrt-rec-ztb-999        .
      ...
      *                      * Rewrite record [ztb]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-ztb-000      thru rew-rec-ztb-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [ztb]                             *
      *              *-------------------------------------------------*
           perform   del-rec-ztb-000      thru del-rec-ztb-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [ztb]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-ztb-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-tpb (1)    to   rf-ztb-des-tpb         .
           move      w-tes-des-key (1)    to   rf-ztb-des-key         .
           move      w-tes-snx-vaz (1)    to   rf-ztb-snx-vaz         .
           move      w-tes-alx-exp (1)    to   rf-ztb-alx-exp         .
       cmp-rec-ztb-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [ztb]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-ztb-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-ztb-000      thru cmp-rec-ztb-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
