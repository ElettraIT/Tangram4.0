      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Copia valori di bilancio                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
               ...
               10  srt-dat-bil            pic  9(07)                  .
               10  srt-vdb-lv1            pic  9(05)                  .
               10  srt-vdb-lv2            pic  9(05)                  .
               10  srt-vdb-lv3            pic  9(05)                  .
               10  srt-vdb-lv4            pic  9(05)                  .
               10  srt-vdb-lv5            pic  9(05)                  .
               10  srt-vdb-lv6            pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
               10  srt-val-vdb            pic s9(13)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " COPIA VALORI DI BILANCIO GIA' INSERITI "       .
      ...
      *                  * Data da cui copiare                         *
      *                  *---------------------------------------------*
           perform   acc-dat-cop-000      thru acc-dat-cop-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Data da cui copiare i valori :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Inserimento nuovi valori al  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ric-sel-999.
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Data da copiare            *
      *    *-----------------------------------------------------------*
       acc-dat-cop-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-dat-cop-999.
       acc-dat-cop-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-dat-cop             .
       acc-dat-cop-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        rr-dat-cop           not  = zero
                     go to acc-dat-cop-600.
           if        v-key                =    "UP  "
                     go to acc-dat-cop-600
           else      go to acc-dat-cop-100.
       acc-dat-cop-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo : Data da cui copiare                 *
      *              *-------------------------------------------------*
           if        rr-dat-cop           not  = zero
                     go to tdo-ric-sel-250.
           move      "Manca la data da cui copiare i valori di bilancio 
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-250.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
      ...
      -              "ti alla data impostata. "
           ...
           move      14                   to   v-lin                  .
           move      04                   to   v-pos                  .
           move      "Si vuole comunque procedere nell'operazione cancel
      -              "lando i dati preceden-  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [vbv]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATVDB    "         to   f-key                  .
           move      rr-tip-bil           to   rf-vbv-tip-bil         .
           move      rr-dat-cop           to   rf-vbv-dat-bil         .
           move      zero                 to   rf-vbv-vdb-lv1         .
           move      zero                 to   rf-vbv-vdb-lv2         .
           move      zero                 to   rf-vbv-vdb-lv3         .
           move      zero                 to   rf-vbv-vdb-lv4         .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [vbv]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/bil/fls/ioc/obj/iofvbv"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           if        rf-vbv-tip-bil       not  = rr-tip-bil
                     go to stp-srt-inp-900.
      *                  *---------------------------------------------*
      *                  * Test su data da copiare                     *
      *                  *---------------------------------------------*
           if        rf-vbv-dat-bil       not  = rr-dat-cop
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezioni su [vbv]                              *
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      rf-vbv-tip-bil       to   srt-tip-bil            .
           move      rf-vbv-dat-bil       to   srt-dat-bil            .
           move      rf-vbv-vdb-lv1       to   srt-vdb-lv1            .
           move      rf-vbv-vdb-lv2       to   srt-vdb-lv2            .
           move      rf-vbv-vdb-lv3       to   srt-vdb-lv3            .
           move      rf-vbv-vdb-lv4       to   srt-vdb-lv4            .
           move      rf-vbv-vdb-lv5       to   srt-vdb-lv5            .
           move      rf-vbv-vdb-lv6       to   srt-vdb-lv6            .
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      rf-vbv-val-vdb       to   srt-val-vdb            .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-bil           to   rf-vbv-tip-bil         .
           move      rr-dat-bil           to   rf-vbv-dat-bil         .
           move      srt-vdb-lv1          to   rf-vbv-vdb-lv1         .
           move      srt-vdb-lv2          to   rf-vbv-vdb-lv2         .
           move      srt-vdb-lv3          to   rf-vbv-vdb-lv3         .
           move      srt-vdb-lv4          to   rf-vbv-vdb-lv4         .
           move      srt-vdb-lv5          to   rf-vbv-vdb-lv5         .
           move      srt-vdb-lv6          to   rf-vbv-vdb-lv6         .
           move      srt-val-vdb          to   rf-vbv-val-vdb         .
