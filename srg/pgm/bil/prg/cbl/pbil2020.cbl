      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pbil2021:        *
      *                                                                *
      ...
      *                  * Si/no voci con anomalie                     *
      *                  *---------------------------------------------*
           perform   acc-snx-anm-000      thru acc-snx-anm-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * Codice tipo di bilancio                         *
      *              *-------------------------------------------------*
           perform   pmt-cod-tpb-000      thru pmt-cod-tpb-999        .
      *              *-------------------------------------------------*
      *              * Si/no voci con anomalie                         *
      *              *-------------------------------------------------*
           perform   pmt-snx-anm-000      thru pmt-snx-anm-999        .
       pmt-ric-sel-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione prompts per Codice tipo di bilancio       *
      *    *-----------------------------------------------------------*
       pmt-cod-tpb-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Si/no voci con anomalie       *
      *    *-----------------------------------------------------------*
       pmt-snx-anm-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/No solo voci con anomalie         *
      *    *-----------------------------------------------------------*
       acc-snx-anm-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-anm-999.
       acc-snx-anm-300.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   rr-snx-anm
           else if   v-num                =    02
                     move  "S"            to   rr-snx-anm
           else      move  spaces         to   rr-snx-anm             .
       acc-snx-anm-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       reg-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione Si/no solo voci con anomalie    *
      *              *-------------------------------------------------*
           if        rr-snx-anm           =    spaces
                     move  "N"            to   rr-snx-anm             .
       reg-ric-sel-999.
           exit.
