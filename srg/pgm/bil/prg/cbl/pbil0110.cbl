      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [ztb]            *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun tipo bilancio entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [ztb]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/bil/fls/ioc/obj/iofztb"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      30                   to   v-pos                  .
           move      rf-ztb-des-tpb       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-ztb-cod-tpb       to   w-mpn-cod-tpb          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-tpb'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
