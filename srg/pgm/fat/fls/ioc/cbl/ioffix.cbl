      ...
      *    *===========================================================*
      *    * Record logico file [fix]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/fat/fls/rec/rffix"                          .

      ******************************************************************
       Procedure Division                using f rf-fix               .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           move      rf-fix-des-400       to   fil-des-400            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-fix-num-prt       to   fil-num-prt            .
           move      rf-fix-num-prg       to   fil-num-prg            .
           move      rf-fix-tip-rec       to   fil-tip-rec            .
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-fix                 .
           move      fil-num-prt          to   rf-fix-num-prt         .
           move      fil-num-prg          to   rf-fix-num-prg         .
           move      fil-tip-rec          to   rf-fix-tip-rec         .
           move      fil-des-400          to   rf-fix-des-400         .
       dec-fis-log-999.
           exit.
