      ...
      *                       Ultima revisione:    NdK del 05/03/18    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " INTERROGAZIONE SU DISTINTE FATTURE PDF "       .
      ...
      *                  *---------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [dde]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "NUMDST    "         to   f-key                  .
           move      "DATSYS    "         to   f-key                  .
           move      w-det-nrg-dat-dtd    to   rf-dde-ide-dat         .
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-dde-num-dst       to   w-rot-l01-num-dst      .
       qry-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-dde-num-dst       to   w-buf-l01-num-dst      .
           move      rf-dde-dat-reg       to   w-buf-l01-dat-reg      .
      ...
      *              *-------------------------------------------------*
           ...
           else if   rf-dde-flg-apr       not  = spaces
