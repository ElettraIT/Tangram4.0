      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampe di controllo per la fatturazione     *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase fat910, nella sua globalita', esegue i tipi di stampa  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * PRGNUM      Progressione numerica fatture             pfat910a *
      * COLBEF      Verifica collegamento tra bolle e fatture pfat910b *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPE DI CONTROLLO PER LA FATTURAZIONE "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'fat910'           *
      *              *-------------------------------------------------*
           perform   fas-fat-910-000      thru fas-fat-910-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Progressione numerica fatture di vendita          
      -              " PRGNUM     pfat910a  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Verifica collegamento tra bolle e fatture         
      -              " COLBEF     pfat910b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-200.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-fat-910-300
           else if   v-key                =    "PRSC"
                     go to fas-fat-910-400
           else if   v-key                =    "NXSC"
                     go to fas-fat-910-450
           else if   v-key                =    "DOWN"
                     go to fas-fat-910-500
           else if   v-key                =    "EXIT"
                     go to fas-fat-910-250
           else      go to fas-fat-910-200.
       fas-fat-910-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-fat-910-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-fat-910-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-fat-910-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-fat-910-350
           else      go to fas-fat-910-322.
       fas-fat-910-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-fat-910-630
           else if   v-key                =    "PRSC"
                     go to fas-fat-910-600
           else if   v-key                =    "NXSC"
                     go to fas-fat-910-610
           else if   v-key                =    "UP  "
                     go to fas-fat-910-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-fat-910-650
           else if   v-key                =    "EXIT"
                     go to fas-fat-910-660
           else      go to fas-fat-910-570.
       fas-fat-910-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-fat-910-626
           else      go to fas-fat-910-628.
       fas-fat-910-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-fat-910-636
           else      go to fas-fat-910-638.
       fas-fat-910-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-fat-910-725
           else      go to fas-fat-910-750.
       fas-fat-910-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
