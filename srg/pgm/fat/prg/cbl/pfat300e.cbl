      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Duplicazione righe da altra fattura         *
      *                                                                *
      *                    Richiamata in fat300 da funzione 'PF3'      *
      *                                                                *
      *================================================================*
      *                                                                *
      * Tipi operazione                                                *
      ...
      *                                                                *
      *        Input  : l-dup-rdf-tip-ope = "OP"                       *
      *                 l-dup-rdf-cod-dpz = codice dipendenza in uso   *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      * "CL" - Close, fine utilizzo                                    *
      *                                                                *
      *        Input  : l-dup-rdf-tip-ope = "CL"                       *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      * "C?" - Test se modulo cancellabile                             *
      *                                                                *
      *        Input  : l-dup-rdf-tip-ope = "C?"                       *
      *                                                                *
      *        Output : l-dup-rdf-exi-sts = spaces: Si                 *
      *                                     #     : No                 *
      *                                                                *
      * "RB" - Accettazione dati identificativi fattura                *
      *                                                                *
      *        Input  : l-dup-rdf-tip-ope = "RB"                       *
      *                 l-dup-rdf-cod-tmf = codice tipo movimento fat- *
      *                                     tura da proporre come de-  *
      *                                     fault                      *
      *                                                                *
      *        Output : l-dup-rdf-exi-sts = spaces: Accettazione ese-  *
      *                                             guita con successo *
      *                                     #     : Uscita per Exit    *
      *                                                                *
      * "SC" - Saldaconto per selezione righe                          *
      *                                                                *
      *        Input  : l-dup-rdf-tip-ope = "SC"                       *
      *                                                                *
      *        Output : l-dup-rdf-exi-sts = spaces: Tutto Ok           *
      *                                     #     : Uscita per Exit    *
      *                                                                *
      * "CC" - Caricamento righe fattura selezionate in catena         *
      *                                                                *
      *        Input  : l-dup-rdf-tip-ope = "CC"                       *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Numero protocollo fattura in corso di trattamento     *
      *        *-------------------------------------------------------*
           05  w-gen-prt-fat              pic  9(11)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Tipo movimento fatture clienti                        *
      *        *-------------------------------------------------------*
           05  w-acc-cod-tmf              pic  x(05)                  .
           05  w-acc-cod-tmf-des          pic  x(30)                  .
           05  w-acc-cod-tmf-sgl          pic  x(03)                  .
           05  w-acc-cod-tmf-ngi          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Data documento                                        *
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Work-area per bufferizzazione righe fattura da duplicare  *
      *    *-----------------------------------------------------------*
       01  w-brf.
      *        *-------------------------------------------------------*
      *        * Numero elementi in tabella                            *
      *        *-------------------------------------------------------*
           05  w-brf-num-ele              pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Numero massimo elementi in tabella                    *
      *        *-------------------------------------------------------*
           05  w-brf-max-ele              pic  9(05) value 900        .
      *        *-------------------------------------------------------*
      *        * Tabella elementi                                      *
      *        *-------------------------------------------------------*
           05  w-brf-tbl.
               10  w-brf-sng-ele occurs 900.
                   15  w-brf-num-prg      pic  9(05)       comp-3     .
                   15  w-brf-tip-rig      pic  x(01)                  .
                   15  w-brf-dec-qta      pic  9(01)                  .
                   15  w-brf-des-rig      pic  x(40)                  .
                   15  w-brf-qta-fat      pic s9(10)v9(03) comp-3     .
                   15  w-brf-qta-dup      pic s9(10)v9(03) comp-3     .
                   15  w-brf-snx-aoc      pic  x(01)                  .
      ...
      *    *===========================================================*
      *    * Work-area per routine buf-rig-fat-000/999                 *
      *    *-----------------------------------------------------------*
       01  w-buf-rig-fat.
      *        *-------------------------------------------------------*
      *        * Flag di uscita                                        *
      *        *-------------------------------------------------------*
           05  w-buf-rig-fat-flg          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Numero protocollo fattura                             *
      *        *-------------------------------------------------------*
           05  w-buf-rig-fat-prt          pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per ridefinizione tipo riga                    *
      *        *-------------------------------------------------------*
           05  w-buf-rig-fat-wtr.
               10  w-buf-rig-fat-wtp      pic  x(01)                  .
               10  w-buf-rig-fat-wtf      pic  x(01)                  .
               10  filler                 pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione in riga                                   *
      *        *-------------------------------------------------------*
           05  w-buf-rig-fat-wde          pic  x(40)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-fnd.
      *        *-------------------------------------------------------*
      *        * Work per Find su archivio [fit]                       *
      *        *-------------------------------------------------------*
           05  w-fnd-arc-fit.
               10  w-fnd-arc-fit-sel      pic  x(01)                  .
               10  w-fnd-arc-fit-tmo      pic  x(05)                  .
               10  w-fnd-arc-fit-dat      pic  9(07)                  .
               10  w-fnd-arc-fit-num      pic  9(11)                  .
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice tipo movimento fattura  *
      *    *-----------------------------------------------------------*
      ...
      *        * Tipo operazione                                       *
      *        *-------------------------------------------------------*
           05  l-dup-rdf-tip-ope          pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Return status code                                    *
      *        * - Spaces : operazione eseguita                        *
      *        * - #      : errore di esecuzione                       *
      *        *-------------------------------------------------------*
           05  l-dup-rdf-exi-sts          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Codice dipendenza in uso                              *
      *        *-------------------------------------------------------*
           05  l-dup-rdf-cod-dpz          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Default per codice tipo movimento fattura             *
      *        *-------------------------------------------------------*
           05  l-dup-rdf-cod-tmf          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Flag di trattamento fattura                           *
      *        *-------------------------------------------------------*
           05  l-dup-rdf-flg-fat          pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      ******************************************************************
       Procedure Division                using l-dup-rdf
                                               w-prs
                                               w-tes
                                               w-pie
                                               w-rig
      ...
      *              *-------------------------------------------------*
           move      spaces               to   l-dup-rdf-exi-sts      .
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo operazione      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Accettazione dati identificativi fattura    *
      *                  *---------------------------------------------*
           if        l-dup-rdf-tip-ope    =    "RB"
                     perform acc-dti-fat-000
                                          thru acc-dti-fat-999
      *                  *---------------------------------------------*
      *                  * Saldaconto per selezione righe fattura      *
      *                  *---------------------------------------------*
           else if   l-dup-rdf-tip-ope    =    "SC"
                     perform sdc-sel-fat-000
                                          thru sdc-sel-fat-999
      *                  *---------------------------------------------*
      *                  * Caricamento righe fattura in catena         *
      *                  *---------------------------------------------*
           else if   l-dup-rdf-tip-ope    =    "CC"
                     perform car-rig-cat-000
                                          thru car-rig-cat-999
      *                  *---------------------------------------------*
      *                  * Open                                        *
      *                  *---------------------------------------------*
           else if   l-dup-rdf-tip-ope    =    "OP"
                     perform exe-fun-opn-000
                                          thru exe-fun-opn-999
      *                  *---------------------------------------------*
      *                  * Close                                       *
      *                  *---------------------------------------------*
           else if   l-dup-rdf-tip-ope    =    "CL"
                     perform exe-fun-cls-000
                                          thru exe-fun-cls-999
      *                  *---------------------------------------------*
      *                  * Test cancellabilita' modulo                 *
      *                  *---------------------------------------------*
           else if   l-dup-rdf-tip-ope    =    "C?"
      ...
      *              *-------------------------------------------------*
           move      l-dup-rdf-cod-dpz    to   w-acc-cod-dpz          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-gen-ctr-opn        =    zero
                     move  spaces         to   l-dup-rdf-exi-sts
           else      move  "#"            to   l-dup-rdf-exi-sts      .
       tst-cnc-mod-999.
           exit.

      *    *===========================================================*
      *    * Accettazione dati identificativi fattura cliente          *
      *    *-----------------------------------------------------------*
       acc-dti-fat-000.
      *              *-------------------------------------------------*
      *              * Video in Off                                    *
      ...
      *                  *---------------------------------------------*
           ...
           move      12                   to   v-lin                  .
           move      22                   to   v-pos                  .
           move      "DUPLICAZIONE RIGHE DA ALTRO DOCUMENTO"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              * mento fattura                                   *
      *              *-------------------------------------------------*
           move      l-dup-rdf-cod-tmf    to   w-acc-cod-tmf          .
           if        w-acc-cod-tmf        =    spaces
                     go to acc-dti-fat-100.
      *                  *---------------------------------------------*
      *                  * Lettura archivio [zfi] generale             *
      *                  *---------------------------------------------*
           move      w-acc-cod-tmf        to   w-let-arc-zfi-cod      .
           move      zero                 to   w-let-arc-zfi-dpz      .
           perform   let-arc-zfi-000      thru let-arc-zfi-999        .
           move      w-let-arc-zfi-des    to   w-acc-cod-tmf-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione codice                      *
      *                  *---------------------------------------------*
           perform   vis-cod-tmf-000      thru vis-cod-tmf-999        .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cod-tmf-des-000  thru vis-cod-tmf-des-999    .
      *                  *---------------------------------------------*
      *                  * Ad accettazione data documento              *
      *                  *---------------------------------------------*
           go to     acc-dti-fat-200.
       acc-dti-fat-100.
      *              *-------------------------------------------------*
      *              * Accettazione dati identificativi fattura        *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   acc-cod-tmf-000      thru acc-cod-tmf-999        .
           if        v-key                =    "EXIT"
                     go to acc-dti-fat-800.
           if        v-key                =    "DO  "
                     go to acc-dti-fat-400.
       acc-dti-fat-200.
      *                  *---------------------------------------------*
      *                  * Data documento                              *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        v-key                =    "DO  "
                     go to acc-dti-fat-400.
           if        v-key                =    "UP  "
                     go to acc-dti-fat-300.
       acc-dti-fat-400.
      *              *-------------------------------------------------*
      *              * Controllo che esistano tutti i valori di iden-  *
      *              * tificazione della fattura                       *
      *              *-------------------------------------------------*
           if        w-acc-cod-tmf        =    spaces or
      ...
      *                  * Numero giornale Iva                         *
      *                  *---------------------------------------------*
           move      w-acc-cod-tmf-ngi    to   w-acc-num-doc-ngi      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-fit-num-prt       to   w-acc-num-prt          .
       acc-dti-fat-500.
      *              *-------------------------------------------------*
      *              * Bufferizzazione righe fattura da trattare       *
      *              *-------------------------------------------------*
           move      w-acc-num-prt        to   w-buf-rig-fat-prt      .
           perform   buf-rig-fat-000      thru buf-rig-fat-999        .
      *                  *---------------------------------------------*
      *                  * Test su esito operazione                    *
      *                  *---------------------------------------------*
           if        w-buf-rig-fat-flg    =    spaces
                     go to acc-dti-fat-620.
      *                      *-----------------------------------------*
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
           move      "Nessuna riga fattura da duplicare !                 
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                      *-----------------------------------------*
      *                      * A reimpostazione                        *
      *                      *-----------------------------------------*
       ...
       acc-dti-fat-620.
      *              *-------------------------------------------------*
      *              * Aggiornamento protocollo fattura in corso di    *
      *              * trattamento                                     *
      *              *-------------------------------------------------*
           move      w-acc-num-prt        to   w-gen-prt-fat          .
      *              *-------------------------------------------------*
      *              * A uscita                                        *
      *              *-------------------------------------------------*
           go to     acc-dti-fat-900.
       acc-dti-fat-800.
      *              *-------------------------------------------------*
      *              * Se uscita per Exit                              *
      *              *-------------------------------------------------*
           move      "#"                  to   l-dup-rdf-exi-sts      .
       acc-dti-fat-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     acc-dti-fat-999.
       acc-dti-fat-999.
           exit.

      *    *===========================================================*
      *    * Accettazione campo : Tipo movimento per fatturazione      *
      *    *-----------------------------------------------------------*
       acc-cod-tmf-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-acc-cod-tmf        to   w-cod-des-zfi-cod      .
           move      14                   to   w-cod-des-zfi-lin      .
           move      09                   to   w-cod-des-zfi-pos      .
           move      14                   to   w-cod-des-zfi-dln      .
           move      15                   to   w-cod-des-zfi-dps      .
       ...
       acc-cod-tmf-110.
           ...
           if        w-cod-des-zfi-ope    =    "F+"
                     go to acc-cod-tmf-115.
           if        w-cod-des-zfi-ope    =    "AC"
                     go to acc-cod-tmf-120.
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       acc-cod-tmf-115.
           perform   cod-des-zfi-foi-000  thru cod-des-zfi-foi-999    .
           go to     acc-cod-tmf-110.
       acc-cod-tmf-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     go to acc-cod-tmf-999.
       acc-cod-tmf-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-acc-cod-tmf          .
       acc-cod-tmf-400.
      *              *-------------------------------------------------*
      ...
      *                  * movimento                                   *
      *                  *---------------------------------------------*
           move      w-let-arc-zfi-sgl    to   w-acc-cod-tmf-sgl      .
           move      w-let-arc-zfi-ngi    to   w-acc-cod-tmf-ngi      .
       acc-cod-tmf-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-acc-cod-tmf        to   l-dup-rdf-cod-tmf      .
       acc-cod-tmf-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Tipo movimento per fatturazione   *
      *    *-----------------------------------------------------------*
       vis-cod-tmf-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       vis-cod-tmf-des-000.
           ...
           move      14                   to   v-lin                  .
           move      15                   to   v-pos                  .
           move      w-acc-cod-tmf-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-tmf-des-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           if        w-fnd-arc-fit-sel    not  = spaces
      ...
      *              * Tipo movimento per fatturazione                 *
      *              *-------------------------------------------------*
           move      spaces               to   w-acc-cod-tmf-des      .
           move      spaces               to   w-acc-cod-tmf-sgl      .
           move      zero                 to   w-acc-cod-tmf-ngi      .
      *              *-------------------------------------------------*
      *              * Numero documento                                *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "#"                  to   w-buf-rig-fat-flg      .
      *              *-------------------------------------------------*
      *              * Azzeramento numero righe nel buffer             *
      *              *-------------------------------------------------*
           move      zero                 to   w-brf-num-ele          .
      *              *-------------------------------------------------*
      *              * Start su file [fir]                             *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      w-buf-rig-fat-prt    to   rf-fir-num-prt         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-fir-num-prt       not  = w-buf-rig-fat-prt
                     go to buf-rig-fat-500.
      *                  *---------------------------------------------*
      *                  * Test sul contatore elementi nel buffer      *
      *                  *---------------------------------------------*
           if        w-brf-num-ele        not  < w-brf-max-ele
                     go to buf-rig-fat-500.
       buf-rig-fat-210.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-fir-tip-rig       to   w-buf-rig-fat-wtr      .
       buf-rig-fat-220.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-buf-rig-fat-flg      .
       buf-rig-fat-250.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-brf-num-ele        <    w-brf-max-ele
                     add   1              to   w-brf-num-ele          .
      *                  *---------------------------------------------*
      *                  * Progressivo riga                            *
      *                  *---------------------------------------------*
           move      rf-fir-num-prg       to   w-brf-num-prg
                                              (w-brf-num-ele)         .
      *                  *---------------------------------------------*
      *                  * Tipo riga                                   *
      *                  *---------------------------------------------*
           move      w-buf-rig-fat-wtp    to   w-brf-tip-rig
                                              (w-brf-num-ele)         .
       buf-rig-fat-300.
      *                  *---------------------------------------------*
      ...
      *                  *     to                                      *
      *                  *---------------------------------------------*
           if        w-buf-rig-fat-wtp    =    "A"     or
                     w-buf-rig-fat-wtp    =    "C"     or
                    (w-buf-rig-fat-wtp    =    "P" and
                     w-buf-rig-fat-wtf    =    "N"   ) or
                     w-buf-rig-fat-wtp    =    "M"     or
                     w-buf-rig-fat-wtp    =    "S"
                     go to buf-rig-fat-320
           else if   w-buf-rig-fat-wtp    =    "P" and
                     w-buf-rig-fat-wtf    =    " "
                     go to buf-rig-fat-340
           else      go to buf-rig-fat-320.
       buf-rig-fat-320.
      *                      *-----------------------------------------*
      *                      * Se tipo riga 'A', 'C', 'PN', 'M' o 'S'  *
      *                      *-----------------------------------------*
      ...
      *
           if        w-let-arc-fix-flg    not  = spaces
                     go to buf-rig-fat-321.
      *
           move      w-let-arc-fix-des    to   w-buf-rig-fat-wde      .
      *
           go to     buf-rig-fat-350.
       buf-rig-fat-321.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rf-fir-des-ext       =    0
                     go to buf-rig-fat-322
           else if   rf-fir-des-ext       =    1
                     go to buf-rig-fat-324
           else if   rf-fir-des-ext       =    2
                     go to buf-rig-fat-326.
       buf-rig-fat-322.
      ...
      *                          * [fir]                               *
      *                          *-------------------------------------*
           move      rf-fir-des-rig       to   w-buf-rig-fat-wde      .
           go to     buf-rig-fat-350.
       buf-rig-fat-324.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      w-let-dcp-pdx-des    to   w-buf-rig-fat-wde      .
           go to     buf-rig-fat-350.
       buf-rig-fat-340.
      *                      *-----------------------------------------*
      *                      * Se tipo riga 'P'                        *
      ...
      *                          * codice lingua                       *
      *                          *-------------------------------------*
           if        rf-fir-cod-cli       =    w-tes-cod-cli (1) and
                     rf-fir-cod-lng       =    w-tes-cod-lng (1)
                     go to buf-rig-fat-320.
      *                          *-------------------------------------*
      ...
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      w-buf-rig-fat-wde    to   w-brf-des-rig
                                              (w-brf-num-ele)         .
       buf-rig-fat-356.
      *                  *---------------------------------------------*
      *                  * Numero decimali quantita'                   *
      *                  *---------------------------------------------*
           move      rf-fir-dec-qta       to   w-brf-dec-qta
                                              (w-brf-num-ele)         .
      *                  *---------------------------------------------*
      *                  * Quantita' in fattura                        *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-buf-rig-fat-wtp    =    "C" or
                     w-buf-rig-fat-wtp    =    "A"
                     move  zero           to   w-brf-qta-fat
                                              (w-brf-num-ele)
                     go to buf-rig-fat-360.
      *                      *-----------------------------------------*
      *                      * Altrimenti                              *
      *                      *-----------------------------------------*
           move      rf-fir-qta-ven       to   w-brf-qta-fat
                                              (w-brf-num-ele)         .
       buf-rig-fat-360.
      *                  *---------------------------------------------*
      *                  * Quantita' da duplicare a zero               *
      *                  *---------------------------------------------*
           move      zero                 to   w-brf-qta-dup
                                              (w-brf-num-ele)         .
      *                  *---------------------------------------------*
      *                  * Si/No addebito o commento                   *
      *                  *---------------------------------------------*
           move      "S"                  to   w-brf-snx-aoc
                                              (w-brf-num-ele)         .
       buf-rig-fat-400.
      *              *-------------------------------------------------*
      *              * Riciclo su lettura sequenziale file [fir]       *
      *              *-------------------------------------------------*
           go to     buf-rig-fat-200.
       buf-rig-fat-500.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     buf-rig-fat-999.
       buf-rig-fat-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if       (w-buf-rig-fat-wtp    =    "P" or
                     w-buf-rig-fat-wtp    =    "S" or
                     w-buf-rig-fat-wtp    =    "M"  ) and
                     w-buf-rig-fat-wtf    =    spaces
      ...
      *                      *-----------------------------------------*
           move      w-buf-rig-fat-wde    to   w-des-scr-000-d40      .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-buf-rig-fat-wde    to   w-des-scr-001-d25      .
      *                      *-----------------------------------------*
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      rf-fir-alf-pro       to   w-des-scr-001-cod      .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
           go to     cpz-des-rgs-700.
      ...
      *                      *-----------------------------------------*
           move      w-buf-rig-fat-wde    to   w-des-scr-002-d21      .
      *                      *-----------------------------------------*
      ...
      *                      * Tipo codice                             *
      *                      *-----------------------------------------*
           move      w-buf-rig-fat-wtp    to   w-des-scr-002-tco      .
      *                      *-----------------------------------------*
      ...
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      rf-fir-alf-pro       to   w-des-scr-002-cod      .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
           go to     cpz-des-rgs-700.
      ...
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      rf-fir-alf-pro       to   w-des-scr-003-cod      .
      *                      *-----------------------------------------*
      *                      * Descrizione di 25 caratteri             *
      *                      *-----------------------------------------*
           move      w-buf-rig-fat-wde    to   w-des-scr-003-d25      .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
           go to     cpz-des-rgs-700.
      ...
      *                      * Tipo codice                             *
      *                      *-----------------------------------------*
           move      w-buf-rig-fat-wtp    to   w-des-scr-004-tco      .
      *                      *-----------------------------------------*
      *                      * Parentesi quadra destra                 *
      *                      *-----------------------------------------*
      ...
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      rf-fir-alf-pro       to   w-des-scr-004-cod      .
      *                      *-----------------------------------------*
      *                      * Descrizione di 21 caratteri             *
      *                      *-----------------------------------------*
           move      w-buf-rig-fat-wde    to   w-des-scr-004-d21      .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
           go to     cpz-des-rgs-700.
      ...
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      rf-fir-alf-pro       to   w-des-scr-005-cod      .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
           go to     cpz-des-rgs-700.
      ...
      *                      * Tipo codice                             *
      *                      *-----------------------------------------*
           move      w-buf-rig-fat-wtp    to   w-des-scr-006-tco      .
      *                      *-----------------------------------------*
      *                      * Parentesi quadra destra                 *
      *                      *-----------------------------------------*
      ...
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      rf-fir-alf-pro       to   w-des-scr-006-cod      .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
           go to     cpz-des-rgs-700.
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      w-des-scr-000        to   w-buf-rig-fat-wde      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     cpz-des-rgs-999.
      ...
      *    *===========================================================*
      *    * Saldaconto per selezione righe fattura da duplicare       *
      *    *-----------------------------------------------------------*
       sdc-sel-fat-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-brf-num-ele        to   w-sdc-npg-max          .
      ...
      *              *-------------------------------------------------*
       ...
       acc-fun-sdc-200.
           ...
           if        w-sdc-ctr-rig        >    w-brf-num-ele
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "TAB "
                     move   w-brf-num-ele to   w-sdc-ctr-rig
                     go to  acc-fun-sdc-300.
      *                      *-----------------------------------------*
      *                      * Se Back                                 *
      *                      *-----------------------------------------*
      ...
      *                  * ta o piena                                  *
      *                  *---------------------------------------------*
           if        w-sdc-wrk-rig        >    w-brf-num-ele
      ...
      *                  * da duplicare e segno quantita' in fattura   *
      *                  *---------------------------------------------*
           if        w-brf-qta-fat
      ...
      *                  *---------------------------------------------*
           ...
           if        w-brf-qta-dup
                    (w-sdc-ctr-rig)       not  = w-sav-qta-dup
                     move  w-sav-qta-dup  to   w-brf-qta-dup
                                              (w-sdc-ctr-rig)
                     go to acc-qta-dup-100.
       acc-qta-dup-600.
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-brf-qta-fat
                    (w-sdc-ctr-rig)       to   w-brf-qta-dup
                                              (w-sdc-ctr-rig)         .
           go to     acc-qta-dup-700.
       acc-qta-dup-620.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-brf-snx-aoc
                    (w-sdc-ctr-rig)       not  = w-sav-snx-aoc
                     move   w-sav-snx-aoc to   w-brf-snx-aoc
                                              (w-sdc-ctr-rig)
      ...
      *                  *---------------------------------------------*
           if        w-brf-snx-aoc
                    (w-sdc-ctr-rig)       not  = spaces
                     move  spaces         to   w-brf-snx-aoc
                                              (w-sdc-ctr-rig)
           else      move  "S"            to   w-brf-snx-aoc
                                              (w-sdc-ctr-rig)         .
       acc-snx-aoc-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      ...
      *              *-------------------------------------------------*
           ...
           move      s-adx (21 : 20)      to   c-din                  .
      *              *-------------------------------------------------*
      *              * Ciclo di scansione buffer righe fattura         *
      *              *-------------------------------------------------*
           move      zero                 to   w-car-rig-cat-ctr      .
       car-rig-cat-100.
           add       1                    to   w-car-rig-cat-ctr      .
           if        w-car-rig-cat-ctr    >    w-brf-num-ele
                     go to car-rig-cat-900.
      *                  *---------------------------------------------*
      *                  * Selezione su righe fattura nel buffer       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Deviazione in funzione del tipo riga    *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-gen-prt-fat        to   rf-fir-num-prt         .
           move      w-brf-num-prg
                    (w-car-rig-cat-ctr)   to   rf-fir-num-prg         .
           move      "pgm/fat/fls/ioc/obj/ioffir"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Tipo riga                               *
      *                      *-----------------------------------------*
           move      rf-fir-tip-rig       to   w-rig-tip-rig (1)      .
      ...
      *                          * Bufferizzazione                     *
      *                          *-------------------------------------*
           move      rf-fir-num-pro       to   w-rig-num-pro (1)      .
       car-rig-cat-350.
      *                      *-----------------------------------------*
      ...
      *                          * Bufferizzazione                     *
      *                          *-------------------------------------*
           move      rf-fir-alf-pro       to   w-rig-alf-pro (1)      .
       car-rig-cat-360.
      *                      *-----------------------------------------*
      ...
      *                          * testata                             *
      *                          *-------------------------------------*
           if        rf-fir-cod-cli       =    w-tes-cod-cli (1)
      ...
      *
           move      w-let-arc-fix-des    to   w-rig-des-rig (1)      .
      *
      ...
      *                              *---------------------------------*
           if        w-coe-cmb-vlt-ope    not  = "CC"
                     move  rf-fir-cdc-vps to   w-coe-cmb-vlt-cdc      .
      *                              *---------------------------------*
      *                              * Bufferizzazione                 *
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-tes-tip-frn (1)    =    11
                     move  w-tes-cod-cli (1)
                                          to   d-prz-ven-cod-cli
           else      move  w-tes-cli-plf (1)
                                          to   d-prz-ven-cod-cli      .
           move      w-rig-sgl-vps (1)    to   d-prz-ven-sgl-vpp      .
           move      w-rig-dec-vps (1)    to   d-prz-ven-dec-vpp      .
           move      w-rig-num-pro (1)    to   d-prz-ven-num-pro      .
           move      w-tes-cod-lst (1)    to   d-prz-ven-cod-lst      .
           move      w-let-dcp-pdx-plb    to   d-prz-ven-prz-lsb      .
           move      w-let-dcp-pdx-vlb    to   d-prz-ven-sgl-vlb      .
           move      w-let-dcp-pdx-dlb    to   d-prz-ven-dec-vlb      .
           move      spaces               to   d-prz-ven-tfu-prz      .
           move      w-tes-dat-doc        to   d-prz-ven-dat-rfp      .
           move      w-rig-qta-ven (1)    to   d-prz-ven-qta-rif      .
      *                              *---------------------------------*
      ...
      *                              * nato                            *
      *                              *---------------------------------*
           move      d-prz-ven-prz-ven    to   w-rig-prz-lrs (1)      .
      *                              *---------------------------------*
      *                              * Oltre                           *
      *                              *---------------------------------*
           go to     car-rig-cat-520.
      ...
      *                              *---------------------------------*
           ...
           move      w-tes-dec-vpf (1)    to   w-coe-cmb-vlt-tdc      .
           move      w-tes-dat-doc        to   w-coe-cmb-vlt-drc      .
           move      00                   to   w-coe-cmb-vlt-quc      .
           perform   coe-cmb-vlt-cll-000  thru coe-cmb-vlt-cll-999    .
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           if        w-coe-cmb-vlt-ope    not  = "CC"
                     move  rf-fir-cdc-vpp to   w-coe-cmb-vlt-cdc      .
      *                              *---------------------------------*
      *                              * Bufferizzazione                 *
      *                              *---------------------------------*
______*    move      w-coe-cmb-vlt-cdc    to   w-rig-cdc-vpp (1)      .
      *                              *---------------------------------*
      *                              * Oltre                           *
      *                              *---------------------------------*
           go to     car-rig-cat-540.
      ...
      *                              *---------------------------------*
______*    move      w-tes-sgl-vpf (1)    to   w-rig-sgl-vpp (1)      .
______*    move      w-tes-dec-vpf (1)    to   w-rig-dec-vpp (1)      .
______*    move      w-tes-tdc-vpf (1)    to   w-rig-tdc-vpp (1)      .
______*    move      w-tes-cdc-vpf (1)    to   w-rig-cdc-vpp (1)      .
      *                              *---------------------------------*
      *                              * Oltre                           *
      *                              *---------------------------------*
           go to     car-rig-cat-540.
      ...
      *                              * Bufferizzazione                 *
      *                              *---------------------------------*
           move      w-rig-prz-lrs (1)    to   w-rig-prz-ven (1)      .
      *                              *---------------------------------*
      *                              * Oltre                           *
      *                              *---------------------------------*
           go to     car-rig-cat-550.
      ...
      *                          * rio da record [fir], escluso coef-  *
      *                          * ficiente di cambio effettivo        *
      *                          *-------------------------------------*
           move      rf-fir-sgl-vpl       to   w-rig-sgl-vpl (1)      .
           move      rf-fir-dec-vpl       to   w-rig-dec-vpl (1)      .
           move      rf-fir-tdc-vpl       to   w-rig-tdc-vpl (1)      .
           move      rf-fir-prz-vpl       to   w-rig-prz-vpl (1)      .
           move      rf-fir-ccr-vpl       to   w-rig-ccr-vpl (1)      .
           move      rf-fir-plm-vpl       to   w-rig-plm-vpl (1)      .
           move      rf-fir-tlm-vpl       to   w-rig-tlm-vpl (1)      .
           move      rf-fir-map-vpl       to   w-rig-map-vpl (1)      .
      *                          *-------------------------------------*
      *                          * Deviazione a seconda del tipo ri-   *
      *                          * calcolo sul prezzo richiesto        *
      *                          *-------------------------------------*
           if        w-acc-tip-rcl-prz    =    spaces
                     go to car-rig-cat-562
           else if   w-acc-tip-rcl-prz    =    "X"
                     go to car-rig-cat-566.
       car-rig-cat-562.
      *                          *-------------------------------------*
      *                          * Se ricalcolo sul prezzo : No        *
      *                          *-------------------------------------*
      ...
      *                              * da applicare o no               *
      *                              *---------------------------------*
           if        w-tes-mac-lvl (1)    =    11
                     go to car-rig-cat-563
           else      go to car-rig-cat-564.
       car-rig-cat-563.
      *                              *---------------------------------*
      *                              * Se cambio da applicare          *
      *                              *---------------------------------*
      *                                  *-----------------------------*
      *                                  * Poiche' non e' stata ri-    *
      *                                  * chiesto il ricalcolo sul    *
      *                                  * prezzo, si bufferizza il    *
      *                                  * coefficiente di cambio ef-  *
      *                                  * fettivo contenuto nel re-   *
      *                                  * cord [fir]                  *
      *                                  *-----------------------------*
           move      rf-fir-cdc-vpl       to   w-rig-cdc-vpl (1)      .
      *                                  *-----------------------------*
      *                                  * Oltre                       *
      *                                  *-----------------------------*
           go to     car-rig-cat-570.
      ...
      *                                  *-----------------------------*
           ...
           perform   coe-cmb-vlt-cll-000  thru coe-cmb-vlt-cll-999    .
      *                                  *-----------------------------*
      *                                  * Se cambio indeterminato :   *
      *                                  * forzatura di quello conte-  *
      *                                  * nuto nel record [fir]       *
      *                                  *-----------------------------*
           if        w-coe-cmb-vlt-ope    not  = "CC"
                     move  rf-fir-cdc-vpl to   w-coe-cmb-vlt-cdc      .
      *                                  *-----------------------------*
      *                                  * Bufferizzazione             *
      *                                  *-----------------------------*
      ...
      *                              *---------------------------------*
      *                              * Determinazione coefficiente di  *
      *                              * cambio effettivo per legame va- *
      *                              * lutario                         *
      *                              *---------------------------------*
           move      "CC"                 to   w-coe-cmb-vlt-ope      .
           move      w-rig-sgl-vpl (1)    to   w-coe-cmb-vlt-sdv      .
      ...
      *                              *---------------------------------*
           if        w-tes-mac-lvl (1)    =    11
                     go to car-rig-cat-567
           else      go to car-rig-cat-568.
       car-rig-cat-567.
      *                              *---------------------------------*
      *                              * Se cambio da applicare          *
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      w-rig-psr-aap (1, 1) to   d-per-scr-psr-pro (1)  .
           move      w-rig-psr-aap (1, 2) to   d-per-scr-psr-pro (2)  .
           move      w-rig-psr-aap (1, 3) to   d-per-scr-psr-pro (3)  .
           move      w-rig-psr-aap (1, 4) to   d-per-scr-psr-pro (4)  .
           move      w-rig-psr-aap (1, 5) to   d-per-scr-psr-pro (5)  .
           move      w-rig-csr-aap (1)    to   d-per-scr-csr-pro      .
           move      w-tes-psr-aac (1, 1) to   d-per-scr-psr-cli (1)  .
           move      w-tes-psr-aac (1, 2) to   d-per-scr-psr-cli (2)  .
           move      w-tes-psr-aac (1, 3) to   d-per-scr-psr-cli (3)  .
           move      w-tes-psr-aac (1, 4) to   d-per-scr-psr-cli (4)  .
           move      w-tes-psr-aac (1, 5) to   d-per-scr-psr-cli (5)  .
           move      w-tes-csr-aac (1)    to   d-per-scr-csr-cli      .
           if        w-tes-tip-frn (1)    =    11
                     move  w-tes-cod-cli (1)
                                          to   d-per-scr-cod-cli
           else      move  w-tes-cli-plf (1)
                                          to   d-per-scr-cod-cli      .
           move      w-tes-cod-lst (1)    to   d-per-scr-cod-lst      .
           move      w-tes-sgl-vpf (1)    to   d-per-scr-sgl-vpf      .
           move      w-rig-num-pro (1)    to   d-per-scr-num-pro      .
           move      w-tes-dat-doc        to   d-per-scr-dat-rif      .
      *                              *---------------------------------*
      *                              * Richiamo del sottoprogramma     *
      *                              *---------------------------------*
           perform   det-per-scr-cll-000  thru det-per-scr-cll-999    .
      *                              *---------------------------------*
      *                              * Memorizzazione valori determi-  *
      *                              * nati                            *
      *                              *---------------------------------*
      ...
      *                          * Bufferizzazione                     *
      *                          *-------------------------------------*
           move      rf-fir-imp-rig       to   w-rig-imp-rig (1)      .
       car-rig-cat-635.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
      *                          * Deviazione a seconda del tipo ri-   *
      *                          * calcolo provvigioni richiesto       *
      *                          *-------------------------------------*
           if        w-acc-tip-rcl-pvg    =    spaces
                     go to car-rig-cat-642
           else if   w-acc-tip-rcl-pvg    =    "X"
                     go to car-rig-cat-644.
       car-rig-cat-642.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
       ...
       car-rig-cat-644.
      *                          *-------------------------------------*
      *                          * Se ricalcolo provvigioni : Si       *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Bufferizzazione valori contenu- *
      *                              * ti nel record [dcp]             *
      *                              *---------------------------------*
           move      rf-dcp-cat-pvg       to   w-rig-cpv-aap (1)      .
           move      rf-dcp-per-pvg (1)   to   w-rig-ppv-aap (1, 1)   .
           move      rf-dcp-per-pvg (2)   to   w-rig-ppv-aap (1, 2)   .
           move      rf-dcp-per-pvg (3)   to   w-rig-ppv-aap (1, 3)   .
      *                              *---------------------------------*
      *                              * Oltre                           *
      *                              *---------------------------------*
           go to     car-rig-cat-650.
      ...
      *                          *-------------------------------------*
           if        w-acc-tip-rcl-pvg    =    spaces
                     go to car-rig-cat-652
           else if   w-acc-tip-rcl-pvg    =    "X"
                     go to car-rig-cat-654.
       car-rig-cat-652.
      *                          *-------------------------------------*
      *                          * Se ricalcolo provvigioni : No       *
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           if        w-rig-tip-rig-tfu (1)
                     ...
                     go to car-rig-cat-660.
      *                              *---------------------------------*
      *                              * Default per provvigioni in ri-  *
      *                              * ga: Si                          *
      *                              *---------------------------------*
           move      01                   to   w-rig-fsp-rig (1)      .
      *                              *---------------------------------*
      *                              * Oltre                           *
      *                              *---------------------------------*
           go to     car-rig-cat-660.
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Se documento 'Fattura Pro-Forma' :  *
      *                          * oltre                               *
      *                          *-------------------------------------*
           if        w-tes-tip-mov-tdo    =    04
      ...
      *                          *-------------------------------------*
           if        w-acc-tip-rcl-pvg    =    spaces
                     go to car-rig-cat-672
           else if   w-acc-tip-rcl-pvg    =    "X"
                     go to car-rig-cat-674.
       car-rig-cat-672.
      *                          *-------------------------------------*
      *                          * Se ricalcolo provvigioni : No       *
      *                          *-------------------------------------*
      ...
      *                              * Determinazione                  *
      *                              *---------------------------------*
           move      w-rig-prz-lrs (1)    to   w-cal-prz-net-prz      .
           ...
           move      w-cal-prz-net-prz    to   w-rig-prz-nts (1)      .
      *                              *---------------------------------*
      *                              * Oltre                           *
      *                              *---------------------------------*
           go to     car-rig-cat-830.
      ...
      *                  *---------------------------------------------*
           ...
           perform   cll-sub-cat-000      thru cll-sub-cat-999        .
      *              *-------------------------------------------------*
      *              * Riciclo su riga fattura successiva              *
      *              *-------------------------------------------------*
           go to     car-rig-cat-100.
       car-rig-cat-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-fir-tip-rig       to    w-dec-tip-rig-str     .
      *              *-------------------------------------------------*
      ...
      *              * Normalizzazione status di uscita                *
      *              *-------------------------------------------------*
           move      spaces               to   w-fnd-arc-fit-sel      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        s-ves                not  = spaces
                     move  "#"            to   w-fnd-arc-fit-sel
                     go to fnd-arc-fit-999.
           move      s-alf                to   w-fnd-arc-fit-tmo      .
      *                  *---------------------------------------------*
      *                  * Data documento                              *
      *                  *---------------------------------------------*
           move      "CV"                 to   s-ope                  .
           ...
           if        s-ves                not  = spaces
                     move  "#"            to   w-fnd-arc-fit-sel
                     go to fnd-arc-fit-999.
           move      s-dat                to   w-fnd-arc-fit-dat      .
      *                  *---------------------------------------------*
      *                  * Numero documento                            *
      *                  *---------------------------------------------*
           move      "CV"                 to   s-ope                  .
           ...
           if        s-ves                not  = spaces
                     move  "#"            to   w-fnd-arc-fit-sel
                     go to fnd-arc-fit-999.
           move      s-num                to   w-fnd-arc-fit-num      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-fnd-arc-fit-tmo    to   w-acc-cod-tmf          .
           move      w-fnd-arc-fit-dat    to   w-acc-dat-doc          .
           move      w-fnd-arc-fit-num    to   w-acc-num-doc          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-acc-dat-doc        to   rf-fit-dat-doc         .
           move      w-acc-cod-dpz        to   rf-fit-cod-dpz         .
           move      w-acc-num-doc        to   rf-fit-num-doc         .
      ...
      *              *-------------------------------------------------*
           if        rf-fit-cod-tmo       =    w-acc-cod-tmf
      ...
      *                  * successivo                                  *
      *                  *---------------------------------------------*
           if        rf-fit-sgl-num       not  = w-acc-cod-tmf-sgl
      ...
      *                  *---------------------------------------------*
           move      rf-fit-cod-tmo       to   w-det-doc-ges-tmt      .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione tipo movimento fattura     *
      *    *-----------------------------------------------------------*
