      ...
      *                                                                *
      *              Input  : w-cod-des-zfi-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zfi-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-zfi-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-zfi-cod : codice tipo movim.   *
      *                                                                *
      *                       w-cod-des-zfi-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-zfi-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-zfi-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-zfi-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zfi-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-zfi-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zfi-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-zfi-cod : codice tipo movim.   *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-tmo.
           05  w-aux-cde-tmo-nli          pic  9(02)                  .
           05  w-aux-cde-tmo-crb          pic  9(02)                  .
           05  w-aux-cde-tmo-cpb          pic  9(02)                  .
           05  w-aux-cde-tmo-cpa          pic  9(02)                  .
           05  w-aux-cde-tmo-bix          pic  9(02)                  .
           05  w-aux-cde-tmo-buf
                               occurs 30.
               10  w-aux-cde-tmo-bco      pic  x(05)                  .
               10  w-aux-cde-tmo-bde      pic  x(30)                  .
           05  w-aux-cde-tmo-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-tmo-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-tmo-lt2      pic  9(01)                  .
           05  w-aux-cde-tmo-dup          pic  x(30)                  .
           05  w-aux-cde-tmo-dmx.
               10  w-aux-cde-tmo-dch
                               occurs 30  pic  x(01)                  .
           05  w-aux-cde-tmo-c01          pic  9(02)                  .
           05  w-aux-cde-tmo-c02          pic  9(02)                  .
           05  w-aux-cde-tmo-c03          pic  9(02)                  .
           05  w-aux-cde-tmo-c04          pic  9(02)                  .
           05  w-aux-cde-tmo-c05          pic  9(02)                  .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-zfi
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zfi-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-zfi-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-zfi-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-zfi-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-zfi-ope    =    "A+" or
                     w-cod-des-zfi-ope    =    "I+" or
                     w-cod-des-zfi-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-zfi-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-cod-des-zfi-cod    to   w-cod-des-zfi-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-zfi-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-zfi-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-zfi-s90    to   v-ufk                  .
           move      w-cod-des-zfi-lin    to   v-lin                  .
           move      w-cod-des-zfi-pos    to   v-pos                  .
           move      w-cod-des-zfi-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-zfi-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zfi-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-zfi-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-zfi-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-zfi-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-zfi-cod    to   w-cod-des-zfi-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-zfi-alf    to   w-all-str-alf          .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-zfi-dln    =    zero or
                     w-cod-des-zfi-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-tmo-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      w-cod-des-zfi-dln    to   v-lin                  .
           move      w-cod-des-zfi-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-zfi-dln    to   v-lin                  .
           move      w-cod-des-zfi-dps    to   v-pos                  .
           move      w-aux-cde-tmo-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-tmo-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-tmo-dup    to   w-aux-cde-tmo-dmx      .
           move      30                   to   w-aux-cde-tmo-c01      .
       aco-680.
           if        w-aux-cde-tmo-c01    >    zero
                     if    w-aux-cde-tmo-dch
                          (w-aux-cde-tmo-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-tmo-dch
                                              (w-aux-cde-tmo-c01)
                           subtract 1     from w-aux-cde-tmo-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-tmo-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-tmo-dup    to   rf-zfi-des-key         .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-zfi-des-key       >    w-aux-cde-tmo-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-tmo-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-tmo-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      rf-zfi-cod-tmo       to   w-aux-cde-tmo-bco
                                              (w-aux-cde-tmo-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione tipo movimento      *
      *                              *---------------------------------*
           move      rf-zfi-des-tmo       to   w-aux-cde-tmo-bde
                                              (w-aux-cde-tmo-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-tmo-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-tmo-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-tmo-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      30                   to   s-car                  .
           move      w-aux-cde-tmo-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-tmo-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-tmo-bco
                    (w-aux-cde-tmo-bix)   to   w-cod-des-zfi-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-tmo-crb    to   w-aux-cde-tmo-cpb      .
           subtract  1                    from w-aux-cde-tmo-cpb      .
           divide    6                    into w-aux-cde-tmo-cpb      .
           add       1                    to   w-aux-cde-tmo-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-tmo-c01      .
      *                              *---------------------------------*
      ...
      *                              * di indice (w-aux-cde-tmo-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-tmo-c01    to   w-aux-cde-tmo-nli      .
       aco-865.
           if        w-aux-cde-tmo-nli    >    6
                     subtract  6          from w-aux-cde-tmo-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-tmo-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-tmo-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-tmo-c01    <    w-aux-cde-tmo-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-tmo-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-tmo-cpa    <    w-aux-cde-tmo-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-tmo-nli    to   v-lin                  .
           move      23                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-tmo-c01    to   w-aux-cde-tmo-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-tmo-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-tmo-cpa    to   w-aux-cde-tmo-c01      .
           multiply  6                    by   w-aux-cde-tmo-c01      .
           subtract  5                    from w-aux-cde-tmo-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-tmo-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-tmo-c01    to   w-aux-cde-tmo-c02      .
           add       5                    to   w-aux-cde-tmo-c02      .
           divide    6                    into w-aux-cde-tmo-c02      .
           move      w-aux-cde-tmo-c02    to   w-aux-cde-tmo-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-tmo-c02      .
           multiply  6                    by   w-aux-cde-tmo-c02      .
           add       1                    to   w-aux-cde-tmo-c02      .
           add       5
                     w-aux-cde-tmo-c02  giving w-aux-cde-tmo-c03      .
           move      w-aux-cde-tmo-c03    to   w-aux-cde-tmo-c04      .
           if        w-aux-cde-tmo-c03    >    w-aux-cde-tmo-crb
                     move  w-aux-cde-tmo-crb
                                          to   w-aux-cde-tmo-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-tmo-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      05                   to   v-car                  .
           move      w-aux-cde-tmo-c05    to   v-lin                  .
           move      23                   to   v-pos                  .
           move      w-aux-cde-tmo-bco
                    (w-aux-cde-tmo-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-tmo-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-tmo-c02    not  > w-aux-cde-tmo-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-tmo-c02    >    w-aux-cde-tmo-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-tmo-cpa    to   w-aux-cde-tmo-lt1      .
           move      w-aux-cde-tmo-cpb    to   w-aux-cde-tmo-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-tmo-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
