      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pfat3021:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-inv.
               10  w-exp-tip-inv-num      pic  9(02)       value 6    .
               10  w-exp-tip-inv-lun      pic  9(02)       value 40   .
               10  w-exp-tip-inv-tbl.
                   ...
                   15  filler             pic  x(40) value
                            "tramite SDI                             ".
                   15  filler             pic  x(40) value
                            "tramite SDI, senza Registrazione esito  ".
      *        *-------------------------------------------------------*
      *        * Work per : Si/no documenti pro-forma                  *
      *        *-------------------------------------------------------*
           05  w-exp-snx-pfm.
               10  w-exp-snx-pfm-num      pic  9(02)       value 3    .
               10  w-exp-snx-pfm-lun      pic  9(02)       value 40   .
               10  w-exp-snx-pfm-tbl.
                   15  filler             pic  x(40) value
                            "Esclusi                                 ".
                   15  filler             pic  x(40) value
                            "Inclusi                                 ".
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-600.
      *                  *---------------------------------------------*
      *                  * Si/no documenti pro-forma                   *
      *                  *---------------------------------------------*
           perform   acc-snx-pfm-000      thru acc-snx-pfm-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * Si/no documenti pro-forma                       *
      *              *-------------------------------------------------*
           perform   pmt-snx-pfm-000      thru pmt-snx-pfm-999        .
      *              *-------------------------------------------------*
      *              * Codice utente                                   *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt per Si/no documenti pro-forma                      *
      *    *-----------------------------------------------------------*
       pmt-snx-pfm-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no documenti pro-forma            *
      *    *-----------------------------------------------------------*
       acc-snx-pfm-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-pfm-lun    to   v-car                  .
           move      w-exp-snx-pfm-num    to   v-ldt                  .
           move      "EIS#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      15                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-pfm-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           if        w-cnt-sts-imp-ric    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
           move      rr-snx-pfm           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-pfm-999.
       acc-snx-pfm-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-snx-pfm             .
       acc-snx-pfm-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-snx-pfm           =    zero
                     go to acc-snx-pfm-100.
       acc-snx-pfm-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       reg-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Regolarizzazione tipo invio                     *
      *              *-------------------------------------------------*
           if        rr-tip-inv           =    zero
                     move  01             to   rr-tip-inv             .
      *              *-------------------------------------------------*
      *              * Regolarizzazione si/no documenti pro-forma      *
      *              *-------------------------------------------------*
           if        rr-snx-pfm           =    zero
                     move  01             to   rr-snx-pfm             .
       reg-ric-sel-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      zero                 to   rr-tip-inv             .
           move      zero                 to   rr-snx-pfm             .
           move      spaces               to   rr-cod-ute             .
           move      spaces               to   rr-cod-fas             .
       nor-ric-sel-999.
           exit.
