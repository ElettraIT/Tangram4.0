      ...
      *              *-------------------------------------------------*
           ...
           move      16                   to   w-cod-cod-dcc-lin      .
           move      30                   to   w-cod-cod-dcc-pos      .
           move      16                   to   w-cod-cod-dcc-rln      .
           move      41                   to   w-cod-cod-dcc-rps      .
           move      17                   to   w-cod-cod-dcc-vln      .
           move      41                   to   w-cod-cod-dcc-vps      .
           move      18                   to   w-cod-cod-dcc-lln      .
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su [fir] per prodotto                     *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "PRODAT    "         to   f-key                  .
           move      01                   to   rf-fir-tip-mag         .
           move      rr-cod-pro           to   rf-fir-num-pro         .
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-fir-num-pro       not  = rr-cod-pro
                     go to qry-tst-max-900.
       qry-tst-max-200.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rr-alf-pro           to   w-esp-rig-fir-pro      .
      *                      *-----------------------------------------*
      *                      * Chiamata del modulo                     *
      *                      *-----------------------------------------*
