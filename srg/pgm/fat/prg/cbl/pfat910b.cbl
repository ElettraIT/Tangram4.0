      ...
      *                       Ultima revisione:    NdK del 04/07/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa eventuali incongruenze tra bolle e   *
      *                    relativi riferimenti in fattura             *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "   VERIFICA COLLEGAMENTO BOLLE FATTURE  "       .
           ...
           05  w-exp-tip-exe.
               ...
               10  w-exp-tip-exe-tbl.
                   15  filler             pic  x(40) value
                            "Stampa di controllo                     ".
                   15  filler             pic  x(40) value
                            "Riparazione delle anomalie riscontrate  ".
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione incongruenza fattura - bolla       *
      *        *-------------------------------------------------------*
           05  w-det-fat-bol.
               10  w-det-fat-bol-fir      pic  x(01)                  .
               10  w-det-fat-bol-bit      pic  x(01)                  .
               10  w-det-fat-bol-tmb      pic  x(05)                  .
               10  w-det-fat-bol-dat      pic  9(07)                  .
               10  w-det-fat-bol-num      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Per scomposizione numero protocollo                   *
      *        *-------------------------------------------------------*
           05  w-det-num-prt.
               10  w-det-num-prt-num      pic  9(09)                  .
               10  w-det-num-prt-num-r    redefines
                   w-det-num-prt-num.
                   15  w-det-num-prt-saa  pic  9(03)                  .
                   15  w-det-num-prt-prg  pic  9(06)                  .
      *        *-------------------------------------------------------*
      *        * Per scomposizione numero protocollo completo          *
      *        *-------------------------------------------------------*
           05  w-det-cmp-prt.
               10  w-det-cmp-prt-num      pic  9(11)                  .
               10  w-det-cmp-prt-num-r    redefines
                   w-det-cmp-prt-num.
                   15  w-det-cmp-prt-saa  pic  9(03)                  .
                   15  w-det-cmp-prt-dpz  pic  9(02)                  .
                   15  w-det-cmp-prt-prg  pic  9(06)                  .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      *              * Ciclo di scansione bolle per eventuali incon-   *
      *              * gruenze                                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Subroutine                                  *
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      w-det-fat-bol-tmb    to   srt-tip-doc            .
           move      w-det-fat-bol-dat    to   srt-dat-doc            .
           move      w-det-fat-bol-num    to   srt-num-doc            .
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      rf-fit-cod-cli       to   srt-cod-cli            .
           move      rf-fit-dpz-cli       to   srt-dpz-cli            .
           move      rf-fit-cod-tmo       to   srt-tip-fat            .
           move      rf-fit-num-doc       to   srt-num-fat            .
           move      rf-fit-dat-doc       to   srt-dat-fat            .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-det-fat-bol-fir      .
       stp-srt-inp-fir-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su riferimenti bolla                   *
      *                  *---------------------------------------------*
           if        rf-fir-bcc-tip       =    spaces or
                     rf-fir-bcc-dat       =    zero   or
                     rf-fir-bcc-num       =    zero
                     go to  stp-srt-inp-fir-200.
       stp-srt-inp-fir-500.
      *              *-------------------------------------------------*
      *              * Test se bolla esistente e con riferimenti a     *
      *              * fattura coerenti                                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Subroutine                                  *
      ...
      *                  * Test su esito scansione                     *
      *                  *---------------------------------------------*
           if        w-det-fat-bol-bit    =    spaces
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Flag di test non superato                   *
      *                  *---------------------------------------------*
           move      "#"                  to   w-det-fat-bol-fir      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-fir-900.
      ...
      *    * Input procedure per sort                                  *
      *    *                                                           *
      *    * Subroutine di scansione record [bit]                      *
      *    *-----------------------------------------------------------*
       stp-srt-inp-bit-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      spaces               to   w-det-fat-bol-bit      .
           move      spaces               to   w-det-fat-bol-tmb      .
           move      zero                 to   w-det-fat-bol-dat      .
           move      zero                 to   w-det-fat-bol-num      .
       stp-srt-inp-bit-100.
      *              *-------------------------------------------------*
      *              * Start                                           *
      *              *-------------------------------------------------*
           ...
           move      "IDEDOC    "         to   f-key                  .
           move      "NL"                 to   f-cfr                  .
           move      rf-fir-bcc-dat       to   rf-bit-dat-doc         .
           move      rf-fir-cod-dpz       to   rf-bit-cod-dpz         .
           move      rf-fir-bcc-num       to   rf-bit-num-doc         .
           move      rf-fir-bcc-tip       to   rf-bit-cod-tmb         .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su componenti chiave                   *
      *                  *---------------------------------------------*
           if        rf-bit-dat-doc       not  = rf-fir-bcc-dat or
                     rf-bit-cod-dpz       not  = rf-fir-cod-dpz or
                     rf-bit-num-doc       not  = rf-fir-bcc-num or
                     rf-bit-cod-tmb       not  = rf-fir-bcc-tip
                     go to  stp-srt-inp-bit-900.
       stp-srt-inp-bit-400.
      *              *-------------------------------------------------*
      *              * Selezioni su [bit]                              *
      ...
      *                  *---------------------------------------------*
           if        rf-bit-fat-dat       =    rf-fir-dat-doc or
                     rf-bit-fat-num       =    rf-fir-num-doc or
      ...
      *                  * Estremi documento                           *
      *                  *---------------------------------------------*
           move      rf-bit-cod-tmb       to   w-det-fat-bol-tmb      .
           move      rf-bit-dat-doc       to   w-det-fat-bol-dat      .
           move      rf-bit-num-doc       to   w-det-fat-bol-num      .
      *                  *---------------------------------------------*
      *                  * Flag di uscita                              *
      *                  *---------------------------------------------*
           move      "#"                  to   w-det-fat-bol-bit      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-bit-900.
      ...
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      srt-num-doc          to   w-det-cmp-prt-num      .
           move      w-det-cmp-prt-saa    to   w-det-num-prt-saa      .
           move      w-det-cmp-prt-prg    to   w-det-num-prt-prg      .
      *
           move      "PF"                 to   p-ope                  .
           move      "P"                  to   p-tip                  .
           move      06                   to   p-car                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      018                  to   p-pos                  .
           move      w-det-num-prt-num    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Codice archivio                         *
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      098                  to   p-pos                  .
           move      srt-dat-fat          to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Numero fattura                          *
      *                      *-----------------------------------------*
           move      srt-num-fat          to   w-det-cmp-prt-num      .
           move      w-det-cmp-prt-saa    to   w-det-num-prt-saa      .
           move      w-det-cmp-prt-prg    to   w-det-num-prt-prg      .
      *
           move      "PF"                 to   p-ope                  .
      ...
      *              *-------------------------------------------------*
           perform   stp-stl-det-000      thru stp-stl-det-999        .
       prn-liv-det-800.
      *              *-------------------------------------------------*
      *              * Eventuale riparazione bolla                     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *    * dati relativi alla fattura differita                      *
      *    *-----------------------------------------------------------*
       wrt-rec-bol-000.
      *              *-------------------------------------------------*
      *              * Test se estremi fattura esistenti               *
      *              *-------------------------------------------------*
           if        srt-tip-fat          =    spaces or
                     srt-dat-fat          =    zero   or
                     srt-num-fat          =    zero
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "IDEDOC    "         to   f-key                  .
           move      srt-dat-doc          to   rf-bit-dat-doc         .
           move      rr-dpz-inu           to   rf-bit-cod-dpz         .
           move      srt-num-doc          to   rf-bit-num-doc         .
           move      srt-tip-doc          to   rf-bit-cod-tmb         .
           move      zero                 to   rf-bit-num-prt         .
           move      "pgm/bol/fls/ioc/obj/iofbit"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           if        rf-bit-dat-doc       not  = srt-dat-doc or
                     rf-bit-cod-dpz       not  = rr-dpz-inu  or
                     rf-bit-num-doc       not  = srt-num-doc or
                     rf-bit-cod-tmb       not  = srt-tip-doc
                     go to wrt-rec-bol-100.
      *                  *---------------------------------------------*
      *                  * Aggiornamento record con dati fattura       *
      *                  *---------------------------------------------*
           move      srt-dat-fat          to   rf-bit-fat-dat         .
           move      srt-num-fat          to   rf-bit-fat-num         .
           move      001                  to   rf-bit-fat-npb         .
      *                  *---------------------------------------------*
      *                  * Update record [bit]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *                  * Aggiornamento record con dati fattura       *
      *                  *---------------------------------------------*
           move      srt-dat-fat          to   rf-bir-fat-dat         .
           move      srt-num-fat          to   rf-bir-fat-num         .
           move      001                  to   rf-bir-fat-npb         .
      *                  *---------------------------------------------*
      *                  * Update record [bir]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "| Tipo    Data     Numero  |          Codice e Rag
      -              "ione sociale intestatario         | Fattura colleg
      -              "ata al documento di trasporto  |"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
