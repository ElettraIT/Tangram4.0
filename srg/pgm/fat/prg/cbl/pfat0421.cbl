      ...
      *                                   Fase:    fat042              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 22/05/91    *
      *                       Ultima revisione:    NdK del 13/04/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma fat0420  *
      *                                                                *
      *                    Stampa Tag per fatturazione elettronica     *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
      *            * Codice Tag scomposto                              *
      *            *---------------------------------------------------*
               10  srt-cod-tg1            pic  9(02)                  .
               10  srt-cod-tg2            pic  9(02)                  .
               10  srt-cod-tg3            pic  9(02)                  .
               10  srt-cod-tg4            pic  9(02)                  .
               10  srt-cod-tg5            pic  9(02)                  .
               10  srt-cod-tg6            pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [ztg]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/fat/fls/ioc/obj/iofztg"
                                          to   s-pat                  .
      ...
      *
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-num                to   srt-cod-tg2            .
      *
           move      "CV"                 to   p-ope                  .
           move      02                   to   p-car                  .
           move      w-all-str-cat (3)    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-num                to   srt-cod-tg3            .
      *
           move      "CV"                 to   p-ope                  .
           move      02                   to   p-car                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-num                to   srt-cod-tg4            .
      *
           move      "CV"                 to   p-ope                  .
           move      02                   to   p-car                  .
           move      w-all-str-cat (5)    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-num                to   srt-cod-tg5            .
      *
           move      "CV"                 to   p-ope                  .
           move      02                   to   p-car                  .
           move      w-all-str-cat (6)    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-num                to   srt-cod-tg6            .
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      rf-ztg               to   srt-rec-ztg            .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun 'Tag' entro i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      srt-cod-tg1          to   w-rot-l01-cod-tag      .
       prn-cmp-rot-999.
           exit.
      ...
      *              * Legenda a piede                                 *
      *              *-------------------------------------------------*
           perform   fin-pag-sta-000      thru fin-pag-sta-999        .
       prn-fin-cic-999.
           exit.
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Indentazione eventuale                  *
      *                      *-----------------------------------------*
           move      rf-ztg-cod-tag       to   w-all-str-alf          .
           move      "."                  to   w-all-str-del          .
           perform   all-str-ext-000      thru all-str-ext-999        .
           move      zero                 to   w-all-str-i01          .
           subtract  1                    from w-all-str-num          .
           if        w-all-str-num        not  > zero
                     go to prn-liv-det-250.
           multiply  2                    by   w-all-str-num
                                        giving w-all-str-i01          .
       prn-liv-det-250.
      *                      *-----------------------------------------*
      *                      * Stampa                                  *
      *                      *-----------------------------------------*
           ...
           move      "A"                  to   p-tip                  .
           move      21                   to   p-car                  .
           subtract  w-all-str-i01        from p-car                  .
           move      p-lnr                to   p-lin                  .
           move      03                   to   p-pos                  .
           add       w-all-str-i01        to   p-pos                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-ztg-des-tag       to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
           move      "TAG PER FATTURAZIONE PER FATTURA ELETTRONICA"
