      ...
      *                       Ultima revisione:    NdK del 20/02/19    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma di stampa fat320 *
      *                    Stampa distinte di invio                    *
      *                                                                *
      *                    Le overlay eseguono le seguenti funzioni :  *
      *                    ------------------------------------------  *
      *                    pfat3200 - Main                             *
      *                    pfat320a - Creazione Distinta di invio      *
      *                    pfat320b - Stampa Distinta                  *
      *                    pfat320m - Manutenzione distinta            *
      *                    pfat320c - Generazione documenti PDF        *
      *                    pfat320d - Invio o re-invio documenti PDF   *
      *                    pfat320e - Cancellazione Distinta           *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           if        rr-tip-ope           =    01
                     move  "pgm/fat/prg/obj/pfat320a                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    02
                     move  "pgm/fat/prg/obj/pfat320b                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    03
                     move  "pgm/fat/prg/obj/pfat320m                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    04
                     move  "pgm/fat/prg/obj/pfat320c                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    05
                     move  "pgm/fat/prg/obj/pfat320d                "
                                          to   i-exe-pat
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [dde]                         *
      *    *-----------------------------------------------------------*
       let-arc-dst-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-let-arc-dst-prt    to   rf-dde-num-dst         .
           move      "pgm/fat/fls/ioc/obj/iofdde"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       let-arc-dst-300.
      *              *-------------------------------------------------*
      *              * Max su [dde], se non superato : ad uscita       *
      *              *-------------------------------------------------*
           if        rf-dde-num-dst       not  = w-let-arc-dst-prt
                     go to let-arc-dst-900.
       let-arc-dst-400.
      *              *-------------------------------------------------*
      *              * Preparazione flag di uscita                     *
