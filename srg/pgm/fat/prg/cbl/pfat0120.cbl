      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pfat0121:        *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-des-zfi-cod      .
           move      14                   to   w-cod-des-zfi-lin      .
           move      19                   to   w-cod-des-zfi-pos      .
           move      zero                 to   w-cod-des-zfi-dln      .
           move      zero                 to   w-cod-des-zfi-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
       ...
       acc-cod-min-120.
           move      w-cod-des-zfi-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-zfi-ope      .
           move      rr-cod-max           to   w-cod-des-zfi-cod      .
           move      14                   to   w-cod-des-zfi-lin      .
           move      51                   to   w-cod-des-zfi-pos      .
           move      zero                 to   w-cod-des-zfi-dln      .
           move      zero                 to   w-cod-des-zfi-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
