      ...
      *                       Ultima revisione:    NdK del 18/09/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma di stampa fat420 *
      *                    Stampa distinte di invio                    *
      *                                                                *
      *                    Le overlay eseguono le seguenti funzioni :  *
      *                    ------------------------------------------  *
      *                    pfat4200 - Main                             *
      *                    pfat420a - Creazione Distinta di invio      *
      *                    pfat420b - Stampa Distinta                  *
      *                    pfat420m - Manutenzione distinta            *
      *                    pfat420c - Generazione documenti XML        *
      *                                                                *
      *                    pfat420d - Invio o re-invio documenti XML   *
      *                                                                *
      *                    pfat420z - Invio o re-invio documenti XML   *
      *                              (in alternativa, un unico invio)  *
      *                                                                *
      *                    pfat420e - Cancellazione Distinta           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-doc.
               10  w-exp-tip-doc-num      pic  9(02)       value 5    .
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Inclusione clienti esteri                  *
      *        *-------------------------------------------------------*
           05  w-exp-sne-cle.
               10  w-exp-sne-cle-num      pic  9(02)       value 3    .
               10  w-exp-sne-cle-lun      pic  9(02)       value 06   .
               10  w-exp-sne-cle-tbl.
                   15  filler             pic  x(06) value "Italia"   .
                   15  filler             pic  x(06) value "Estero"   .
                   15  filler             pic  x(06) value "Tutti "   .
      *        *-------------------------------------------------------*
      *        * Work per : Documenti da verificare                    *
      *        *-------------------------------------------------------*
           05  w-exp-snx-fav.
               10  w-exp-snx-fav-num      pic  9(02)       value 2    .
               10  w-exp-snx-fav-lun      pic  9(02)       value 2    .
               10  w-exp-snx-fav-tbl.
                   15  filler             pic  x(02) value "Si"       .
                   15  filler             pic  x(02) value "No"       .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "pgm/fat/prg/obj/"   to   w-all-str-cat (1)      .
      ...
      *                  *---------------------------------------------*
           perform   acc-snx-fav-000      thru acc-snx-fav-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           perform   acc-sne-cle-000      thru acc-sne-cle-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-cod-des-zfi-lin      .
           move      30                   to   w-cod-des-zfi-pos      .
           move      11                   to   w-cod-des-zfi-dln      .
      ...
      *                  *---------------------------------------------*
           if        rr-cod-cli           not  = zero and
                     ...
                     go to acc-cod-cli-800.
      *                  *---------------------------------------------*
      *                  * Normalizzazione si/no clienti estero        *
      *                  *---------------------------------------------*
           if        rr-cod-cli           not  = zero
                     move  03             to   rr-sne-cle             .
       acc-cod-cli-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-fav-lun    to   v-car                  .
           move      w-exp-snx-fav-num    to   v-ldt                  .
           move      "SN#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      20                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-fav-tbl    to   v-txt                  .
           move      rr-snx-fav           to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *                  * Se zero : reimpostazione                    *
      *                  *---------------------------------------------*
           if        rr-snx-fav           not  = zero
                     go to acc-snx-fav-600.
           if        v-key                =    "UP  "
                     go to acc-snx-fav-600
           else      go to acc-snx-fav-100.
       acc-snx-fav-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-snx-fav-100.
       acc-snx-fav-999.
           exit.

      *    *===========================================================*
      *    * Accettazione campo : Inclusione clienti esteri            *
      *    *-----------------------------------------------------------*
       acc-sne-cle-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Eventuale default                           *
      *                  *---------------------------------------------*
           if        rr-sne-cle           not  = zero
                     go to acc-sne-cle-100.
           move      01                   to   rr-sne-cle             .
       acc-sne-cle-100.
      *              *-------------------------------------------------*
      *              * Note operative                                  *
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "I clienti Italia comprendono eventuali clienti di 
      -              "San Marino                    "
                                          to   v-nt1                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sne-cle-lun    to   v-car                  .
           move      w-exp-sne-cle-num    to   v-ldt                  .
           move      "IET#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      20                   to   v-lin                  .
           move      72                   to   v-pos                  .
           move      w-exp-sne-cle-tbl    to   v-txt                  .
           move      rr-sne-cle           to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *                  *---------------------------------------------*
           if        rr-sne-cle           not  = zero
                     go to acc-sne-cle-600.
           if        v-key                =    "UP  "
                     go to acc-sne-cle-600
           else      go to acc-sne-cle-100.
       acc-sne-cle-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [ddx]                         *
      *    *-----------------------------------------------------------*
       let-arc-dst-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-let-arc-dst-prt    to   rf-ddx-num-dst         .
           move      "pgm/fat/fls/ioc/obj/iofddx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       let-arc-dst-300.
      *              *-------------------------------------------------*
      *              * Max su [ddx], se non superato : ad uscita       *
      *              *-------------------------------------------------*
           if        rf-ddx-num-dst       not  = w-let-arc-dst-prt
                     go to let-arc-dst-900.
       let-arc-dst-400.
      *              *-------------------------------------------------*
      *              * Preparazione flag di uscita                     *
