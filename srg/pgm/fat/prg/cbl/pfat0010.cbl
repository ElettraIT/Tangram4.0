      ...
      *                                   Fase:    fat001              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/03/19    *
      ...
      * ----  ----------  -------------------------------------------- *
      *                                                                *
      *  01   fat320      Parametri di invio via mail fatture PDF      *
      *                                                                *
      *  01   fat420      Parametri di invio via mail fatture XML      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   PERSONALIZZAZIONI PER INVIO FATTURE  "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
      *            *---------------------------------------------------*
      *            * Tipo record in archivio [fat]                     *
      *            *---------------------------------------------------*
               10  w-tes-tip-rec          pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Codice record in archivio [fat]                   *
      *            *---------------------------------------------------*
      ...
      *                *                                               *
      *                * N.B.: solo se tipo record 'fat420'            *
      *                *-----------------------------------------------*
      ...
      *                * Tipo invio                                    *
      *                *                                               *
      *                * N.B.: solo se tipo record 'fat320'            *
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-cod-rec.
               10  w-exp-cod-rec-num      pic  9(02)       value 02   .
               10  w-exp-cod-rec-lun      pic  9(02)       value 20   .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-inv.
               10  w-exp-tip-inv-num      pic  9(02)       value 02   .
               10  w-exp-tip-inv-lun      pic  9(02)       value 03   .
               10  w-exp-tip-inv-tbl.
                   15  filler             pic  x(03) value "eml"      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "DO  "               to   v-pfk (05)             .
      *
           if        w-tes-cod-rec        =    "fat320              "
                     move  01             to   v-num
           else if   w-tes-cod-rec        =    "fat420              "
                     move  02             to   v-num
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Solo se codice record 'fat420'              *
      *                  *---------------------------------------------*
           if        w-tes-cod-rec        not  = "fat420"
      ...
      *              * Test su tipo record                             *
      *              *-------------------------------------------------*
           if        w-tes-cod-rec        =    "fat320              " or
                     w-tes-cod-rec        =    "fat420              "
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-tip-rec        to   rf-fat-tip-rec         .
           move      w-tes-cod-rec        to   rf-fat-cod-rec         .
           move      "pgm/fat/fls/ioc/obj/ioffat"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [fat]                        *
      *                          *-------------------------------------*
           move      rf-fat-dat-rec       to   w-tes-dat-rec (1)      .
       rou-let-reg-500.
      *                      *-----------------------------------------*
      ...
      *                      * Write record [fat]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-fat-000      thru wrt-rec-fat-999        .
      ...
      *                      * Rewrite record [fat]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-fat-000      thru rew-rec-fat-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [fat]                             *
      *              *-------------------------------------------------*
           perform   del-rec-fat-000      thru del-rec-fat-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [fat]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-fat-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-fat-ide-dat         .
           move      s-ute                to   rf-fat-ide-ute         .
           move      s-fas                to   rf-fat-ide-fas         .
           move      w-tes-dat-rec (1)    to   rf-fat-dat-rec         .
       cmp-rec-fat-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [fat]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-fat-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-fat-000      thru cmp-rec-fat-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
