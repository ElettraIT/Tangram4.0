      ...
      *                       Ultima revisione:    NdK del 07/03/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma fat320   *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-dde-num-dst       not  = rr-num-dst
                     move  "#"            to   w-cnt-prn-flg-sub      .
       prn-tst-max-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dde-cod-arc       to   rf-dcc-cod-cli         .
           move      rf-dde-dpz-arc       to   rf-dcc-dpz-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      098                  to   p-pos                  .
           move      rf-dde-num-doc       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Eventuale data invio                    *
      *                      *-----------------------------------------*
           if        rf-dde-dat-inv       =    zero
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      105                  to   p-pos                  .
           move      rf-dde-dat-doc       to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Eventuale segnale di blocco             *
      *                      *-----------------------------------------*
           if        rf-dde-flg-ain       =    spaces
      ...
      *              *-------------------------------------------------*
           ...
           move      "DISTINTA DI INVIO FATTURE 'PDF' NR."
                                          to   w-all-str-cat (1)      .
           move      p-edt                to   w-all-str-cat (2)      .
