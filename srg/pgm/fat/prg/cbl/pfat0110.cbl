      ...
      *                                   Fase:    fat011              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 09/08/91    *
      *                       Ultima revisione:    NdK del 20/03/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione Tipi movimento per la fat-   *
      *                    turazione                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   TIPI MOVIMENTO PER LA FATTURAZIONE   "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      10                   to   v-pos                  .
           move      rf-zfi-des-tmo       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zfi-cod-tmo       to   w-mpn-cod-tmo          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-zfi-tip-doc       =    1
                     move  "Fattura             "
                                          to   v-alf
           else if   rf-zfi-tip-doc       =    2
                     move  "Nota di addebito    "
                                          to   v-alf
           else if   rf-zfi-tip-doc       =    3
                     move  "Nota di credito     "
                                          to   v-alf
           else if   rf-zfi-tip-doc       =    4
                     move  "Fattura Pro-Forma   "
                                          to   v-alf
           else if   rf-zfi-tip-doc       =    5
                     move  "Autofattura         "
                                          to   v-alf
           else if   rf-zfi-tip-doc       =    6
                     move  "Acconto su fattura  "
                                          to   v-alf
           else      move  all "."        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Codice Tipo fattura elettronica             *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      04                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-tmo'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      24                   to   v-pos                  .
           move      "TIPI MOVIMENTO PER LA FATTURAZIONE"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Codice            Descrizione                Tipo 
      -              "documento      'sdi'   modulo "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
