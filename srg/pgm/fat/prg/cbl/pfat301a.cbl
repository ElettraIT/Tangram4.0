      ...
      *            *---------------------------------------------------*
      *            * Numero distinta in chiave                         *
      *            *---------------------------------------------------*
               10  srt-dst-key            pic  9(06)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      ...
      *            *---------------------------------------------------*
               10  w-tot-cli-nfs          pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Numero di fatture selezionate con sigla valuta    *
      *            * non base                                          *
      *            *---------------------------------------------------*
               10  w-tot-cli-nfn          pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Totale cliente in valuta base                     *
      *            *---------------------------------------------------*
               10  w-tot-cli-vlb          pic s9(13)                  .
      ...
      *              *-------------------------------------------------*
           perform   esp-idv-fit-opn-000  thru esp-idv-fit-opn-999    .
      *              *-------------------------------------------------*
      *              * [ddx]                                           *
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           perform   esp-idv-fit-cls-000  thru esp-idv-fit-cls-999    .
      *              *-------------------------------------------------*
      *              * [ddx]                                           *
      *              *-------------------------------------------------*
           move      "CL"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
       ...
       int-srt-inp-310.
      *                  *---------------------------------------------*
      *                  * Test su data documento min e max            *
      *                  *---------------------------------------------*
           if        rr-dem-max           =    zero
      ...
      *                  *---------------------------------------------*
       ...
       int-srt-inp-340.
      *                  *---------------------------------------------*
      *                  * Se data documento massima non zero          *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Determinazione distinta di invio                *
      *              *-------------------------------------------------*
           move      rf-fit-num-prt       to   w-det-dst-num-prt      .
           perform   int-srt-inp-ddx-000  thru int-srt-inp-ddx-999    .
       int-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-fit-cod-tmo       to   srt-num-key            .
           move      rf-fit-dpz-cli       to   srt-dpz-arc            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
      ...
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      rf-fit-dat-doc       to   srt-dat-key            .
           move      rf-fit-num-doc
      ...
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      w-det-dst-num-dst    to   srt-dst-key            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
      ...
      *    * Input procedure per sort                                  *
      *    *                                                           *
      *    * Subroutine di determinazione se fattura in distinta       *
      *    *-----------------------------------------------------------*
       int-srt-inp-ddx-000.
      *              *-------------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     int-srt-inp-ddx-200.
       int-srt-inp-ddx-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     int-srt-inp-ddx-999.
       int-srt-inp-ddx-999.
           exit.
...
______*    DA IMPLEMENTARE
      ...
      *              *-------------------------------------------------*
           ...
           move      16                   to   w-cod-des-zfi-lin      .
           move      30                   to   w-cod-des-zfi-pos      .
           move      16                   to   w-cod-des-zfi-dln      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione totale cliente in valuta base   *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-cli-nfs          .
           move      zero                 to   w-tot-cli-nfn          .
           move      zero                 to   w-tot-cli-vlb          .
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-tot-cli-vlb        to   w-stp-imp-rig-imp      .
           move      c-dec                to   w-stp-imp-rig-dcv      .
           move      v-lnr                to   w-stp-imp-rig-lin      .
           move      41                   to   w-stp-imp-rig-pos      .
           move      "+"                  to   w-stp-imp-rig-sgn      .
      ...
      *              *-------------------------------------------------*
           move      srt-tot-doc          to   w-agg-tot-cli-tot      .
           perform   agg-tot-cli-vlb-000  thru agg-tot-cli-vlb-999    .
           add       1                    to   w-tot-cli-nfs          .
           if        rf-fit-sgl-vpf       not  = c-sgl
                     add   1              to   w-tot-cli-nfn          .
      *              *-------------------------------------------------*
      *              * Test se fattura o nota accredito                *
      *              *-------------------------------------------------*
           if        rf-fit-tip-doc       =    03
                     subtract w-agg-tot-cli-vlb
                                          from w-tot-cli-vlb
           else      add      w-agg-tot-cli-vlb
                                          to   w-tot-cli-vlb          .
      *              *-------------------------------------------------*
      *              * Test se numero linee residue sufficienti        *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      14                   to   v-pos                  .
           move      rf-fit-num-doc       to   w-num-num-doc          .
      ...
      *                  * Importo fattura                             *
      *                  *---------------------------------------------*
           move      srt-tot-doc          to   w-stp-imp-rig-imp      .
           move      rf-fit-dec-vpf       to   w-stp-imp-rig-dcv      .
           move      v-lnr                to   w-stp-imp-rig-lin      .
           move      41                   to   w-stp-imp-rig-pos      .
           if        rf-fit-tip-doc       =    03
                     move  "-"            to   w-stp-imp-rig-sgn
           else      move  "+"            to   w-stp-imp-rig-sgn      .
           perform   stp-imp-rig-000      thru stp-imp-rig-999        .
       qry-liv-det-600.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-agg-tot-cli-tot    to   w-agg-tot-cli-vlb      .
       agg-tot-cli-vlb-100.
      *              *-------------------------------------------------*
      *              * Test su sigla valuta per la fatturazione        *
      *              *-------------------------------------------------*
           if        rf-fit-sgl-vpf       =    c-sgl
                     go to agg-tot-cli-vlb-900.
       agg-tot-cli-vlb-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-agg-tot-cli-tot    to   w-cvs-vlt-aav          .
           perform   cvs-alt-vlb-000      thru cvs-alt-vlb-999        .
           move      w-cvs-vlt-avb        to   w-agg-tot-cli-vlb      .
       agg-tot-cli-vlb-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     agg-tot-cli-vlb-999.
       agg-tot-cli-vlb-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "      Tipo   Numero    Data    Dpz    Totale docum
      -              "ento   Righe   Distinta       "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
       ...
       qry-trt-fun-200.
      *              *=================================================*
      *              * Se function-key F1: inversione ordinamento sort *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       qry-trt-fun-300.
      *              *=================================================*
      *              * Se function-key LEFT: spostamento a colonna     *
      *              *                       precedente                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Tipo ordinamento                            *
      ...
      *                  *---------------------------------------------*
       ...
       qry-trt-fun-400.
      *              *=================================================*
      *              * Se function-key RGHT: spostamento a colonna     *
      *              *                       successiva                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Tipo ordinamento                            *
      ...
      *                  *---------------------------------------------*
       ...
       qry-trt-fun-500.
      *              *=================================================*
      *              * Se function-key SLCT: selezione elemento        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Subroutine                                  *
      *                  *---------------------------------------------*
           perform   qry-trt-fun-slc-000  thru qry-trt-fun-slc-999    .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     qry-trt-fun-999.
       qry-trt-fun-600.
      *              *=================================================*
      *              * Se function-key EXPD: espansione elemento       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Subroutine                                  *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-dat-doc        to   w-esp-idv-fit-dat      .
           move      w-mpn-num-doc        to   w-esp-idv-fit-num      .
           move      w-mpn-cod-tmo        to   w-esp-idv-fit-tmo      .
           move      w-mpn-num-prt        to   w-esp-idv-fit-prt      .
      *                      *-----------------------------------------*
      *                      * Chiamata del modulo                     *
      *                      *-----------------------------------------*
           perform   esp-idv-fit-esp-000  thru esp-idv-fit-esp-999    .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     qry-trt-fun-999.
      ...
      *    * Interrogazione : Trattamento Function-key selezionata     *
      *    *                                                           *
      *    * Subroutine di trattamento 'EXPD'                          *
      *    *-----------------------------------------------------------*
       qry-trt-fun-exp-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione function key                    *
      ...
      *              *-------------------------------------------------*
           if        w-rip-str-fit-eof    not  = spaces
                     go to qry-trt-fun-exp-200.
           move      rf-fit-cod-cli       to   w-rip-str-fit-cli      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se flag di fine file in On : ad uscita      *
      *                  *---------------------------------------------*
           if        w-rip-str-fit-eof    not  = spaces
                     go to qry-trt-fun-exp-900.
       qry-trt-fun-exp-400.
      *                  *---------------------------------------------*
      *                  * Start per prodotto                          *
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CLIDAT    "         to   f-key                  .
           move      w-rip-str-fit-cli    to   rf-fit-cod-cli         .
      ...
      *    * Interrogazione : Trattamento Function-key selezionata     *
      *    *                                                           *
      *    * Subroutine di trattamento 'SLCT'                          *
      *    *-----------------------------------------------------------*
       qry-trt-fun-slc-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione function key                    *
      ...
      *    *-----------------------------------------------------------*
           ...
           copy      "pgm/fat/prg/cpy/pfat301y.pgs"                   .
