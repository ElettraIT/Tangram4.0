      ...
      *                       Ultima revisione:    NdK del 09/11/18    *
      *                    ------------------------------------------- *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-nrg-dat-dtd    to   rf-ddx-ide-dat         .
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-ddx-num-dst       to   w-rot-l01-num-dst      .
       qry-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-ddx-num-dst       to   w-buf-l01-num-dst      .
           move      rf-ddx-dat-reg       to   w-buf-l01-dat-reg      .
      ...
      *              *-------------------------------------------------*
           ...
           else if   rf-ddx-flg-apr       not  = spaces
