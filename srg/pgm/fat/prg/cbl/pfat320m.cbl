      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [dde]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-dde.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-dde-prt      pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Progressivo                                       *
      *            *---------------------------------------------------*
               10  w-cmp-rec-dde-prg      pic  9(05)                  .
      ...
      *                  *---------------------------------------------*
           move      rf-dde-num-doc       to   w-all-str-alf          .
      ...
      *
           ...
           else      move  rf-dde-num-doc to   w-lin-imm-num-doc      .
      *
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dde-tmo-doc       to   w-all-str-cat (1)      .
           move      rf-dde-num-doc       to   w-all-str-cat (2)      .
...
______*              go to rou-let-reg-999.
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [dde]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/fat/fls/ioc/obj/iofdde"
                                          to   s-pat                  .
      ...
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
           move      rf-dde-cod-arc       to   srt-cod-cli            .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-dde-dat-doc       to   srt-dat-doc            .
      *                  *---------------------------------------------*
      *                  * Record [dde]                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                  * Record [dde]                                *
      *                  *---------------------------------------------*
           move      rf-dde               to   w-rig-rec-dde          .
           move      rf-dde-cod-arc       to   w-rig-cod-cli          .
           move      rf-dde-dpz-arc       to   w-rig-dpz-cli          .
      *
           if        rf-dde-flg-ain       =    spaces
                     move  "N"            to   w-rig-snx-inv
           else      move  "S"            to   w-rig-snx-inv          .
      *
           if        rf-dde-flg-esi       =    spaces
                     move  "N"            to   w-rig-snx-esi
           else      move  "S"            to   w-rig-snx-esi          .
      *
           move      rf-dde-eml-ind       to   w-rig-ind-eml          .
      *                  *---------------------------------------------*
      *                  * Valori indiretti                            *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     go to  fnd-arc-dde-999.
      *              *-------------------------------------------------*
      *              * Richiamo programma di interrogazione            *
      *              *-------------------------------------------------*
           move      "pgm/fat/prg/obj/pbol3010"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat                                            .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/fat/prg/obj/pfat3202"                       .
       cnc-rlt-sup-999.
           exit.
