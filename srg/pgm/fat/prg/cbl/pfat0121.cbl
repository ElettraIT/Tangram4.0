      ...
      *                       Ultima revisione:    NdK del 18/03/20    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma fat012   *
      *                                                                *
      *                    Stampa tipo movimento per la fatturazione   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA TIPI MOVIMENTO DI FATTURAZIONE  "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zfi-cod-tmo         .
           move      "pgm/fat/fls/ioc/obj/iofzfi"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-zfi-des-key         .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zfi-cod-tmo       <    rr-cod-min or
                     rf-zfi-cod-tmo       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zfi-des-key       <    rr-des-min or
                     rf-zfi-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *                      * Test se a zero                          *
      *                      *-----------------------------------------*
           if        rf-zfi-ctp-ven       =    zero
                     go to prn-liv-det-500.
      *                      *-----------------------------------------*
      *                      * Editing con appoggio a sinistra         *
      *                      *-----------------------------------------*
           move      w-prs-liv-pdc        to   w-edt-cod-pdc-liv      .
           move      rf-zfi-ctp-ven       to   w-edt-cod-pdc-cod      .
           move      spaces               to   w-edt-cod-pdc-edm      .
           perform   edt-pdc-asx-000      thru edt-pdc-asx-999        .
      *                      *-----------------------------------------*
      *                      * Stampa                                  *
      ...
      *                  *---------------------------------------------*
           ...
           move      78                   to   p-pos                  .
      *
           if        rf-zfi-tip-doc       =    01
                     move  "FT"           to   p-alf
           else if   rf-zfi-tip-doc       =    02
                     move  "ND"           to   p-alf
           else if   rf-zfi-tip-doc       =    03
                     move  "NC"           to   p-alf
           else if   rf-zfi-tip-doc       =    04
                     move  "PF"           to   p-alf
           else if   rf-zfi-tip-doc       =    05
                     move  "AF"           to   p-alf
           else if   rf-zfi-tip-doc       =    06
                     move  "AC"           to   p-alf
           else      move  ".."           to   p-alf                  .
      *
           call      "swd/mod/prg/obj/mprint"
      ...
      *              *-------------------------------------------------*
           move      "TIPI MOVIMENTO DI FATTURAZIONE"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "| Cod.|         Descrizione          |Sigla|gi|Cau
      -              "| Sottoc. | Controp.|'sdi'|Td|"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
