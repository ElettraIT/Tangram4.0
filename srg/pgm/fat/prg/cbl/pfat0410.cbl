      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella Tag                  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " INTERROGAZIONE TAG FATTURA ELETTRONICA "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           ...
           05  rr-cod-min                 pic  x(20)                  .
           05  rr-cod-max                 pic  x(20)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-des-ztg-cod      .
           move      12                   to   w-cod-des-ztg-lin      .
           move      18                   to   w-cod-des-ztg-pos      .
           move      zero                 to   w-cod-des-ztg-dln      .
           move      zero                 to   w-cod-des-ztg-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-ztg-ope      .
           move      rr-cod-max           to   w-cod-des-ztg-cod      .
           move      12                   to   w-cod-des-ztg-lin      .
           move      51                   to   w-cod-des-ztg-pos      .
           move      zero                 to   w-cod-des-ztg-dln      .
           move      zero                 to   w-cod-des-ztg-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-ztg-cod-tag         .
           move      "pgm/fat/fls/ioc/obj/iofztg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-ztg-des-key         .
      ...
      *              * Se ordinamento per codice                       *
      *              *-------------------------------------------------*
           if        rf-ztg-cod-tag       >    rr-cod-max
                     go to int-srt-inp-900
           else      go to int-srt-inp-400.
       int-srt-inp-340.
      *              *-------------------------------------------------*
      *              * Se ordinamento per descrizione                  *
      *              *-------------------------------------------------*
           if        rf-ztg-des-key       >    rr-des-max
                     go to int-srt-inp-900
           else      go to int-srt-inp-400.
       int-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-ztg-cod-tag       <    rr-cod-min or
                     rf-ztg-cod-tag       >    rr-cod-max
                     go to int-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-ztg-des-key       <    rr-des-min or
                     rf-ztg-des-key       >    rr-des-max
                     go to int-srt-inp-200.
       int-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           else      move  rf-ztg-des-key to   srt-des-key            .
      *                  *---------------------------------------------*
      *                  * Codice Tag                                  *
      *                  *---------------------------------------------*
      ...
      *
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   srt-cod-tg5            .
      *
           move      "CV"                 to   v-ope                  .
           move      02                   to   v-car                  .
           move      w-all-str-cat (6)    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   srt-cod-tg6            .
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      21                   to   v-car                  .
           subtract  w-all-str-i01        from v-car                  .
           move      v-lnr                to   v-lin                  .
           move      03                   to   v-pos                  .
           add       w-all-str-i01        to   v-pos                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-all-str-alf        to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-ztg-cod-tag       to   w-mpn-cod-tag          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-tag'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
