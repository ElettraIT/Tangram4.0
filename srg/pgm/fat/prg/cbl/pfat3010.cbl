      ...
      *                       Ultima revisione:    NdK del 12/07/10    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase fat301, nella sua globalita', esegue i tipi di inter-  *
      ...
      * INTDTR      Ricerca documenti per data registrazione      301d *
      ...
      * INTDUL      Ricerca ultimi documenti emessi per tipo  (*) 301i *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    RICERCA FATTURE E NOTE ACCREDITO     "      .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'fat301'           *
      *              *-------------------------------------------------*
           perform   fas-fat-301-000      thru fas-fat-301-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              * Attualmente inibito                             *
      *              *-------------------------------------------------*
           go to     loa-tbl-tin-112.
      *
           move      "ultimi numeri emessi per tipo                     
      -              " INTDUL     pfat301i  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      *    *===========================================================*
      *    * Esecuzione ciclo per la fase 'fat300'                     *
      *    *-----------------------------------------------------------*
       fas-fat-301-000.
      *              *-------------------------------------------------*
      *              * Video in Off                                    *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-fat-301-300
           else if   v-key                =    "PRSC"
                     go to fas-fat-301-400
           else if   v-key                =    "NXSC"
                     go to fas-fat-301-450
           else if   v-key                =    "DOWN"
                     go to fas-fat-301-500
           else if   v-key                =    "EXIT"
                     go to fas-fat-301-250
           else      go to fas-fat-301-200.
       fas-fat-301-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-fat-301-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-fat-301-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-fat-301-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-fat-301-350
           else      go to fas-fat-301-322.
       fas-fat-301-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-fat-301-630
           else if   v-key                =    "PRSC"
                     go to fas-fat-301-600
           else if   v-key                =    "NXSC"
                     go to fas-fat-301-610
           else if   v-key                =    "UP  "
                     go to fas-fat-301-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-fat-301-650
           else if   v-key                =    "EXIT"
                     go to fas-fat-301-660
           else      go to fas-fat-301-570.
       fas-fat-301-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-fat-301-626
           else      go to fas-fat-301-628.
       fas-fat-301-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-fat-301-636
           else      go to fas-fat-301-638.
       fas-fat-301-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-fat-301-725
           else      go to fas-fat-301-750.
       fas-fat-301-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
