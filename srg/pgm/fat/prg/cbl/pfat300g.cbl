      ...
      *                                                                *
      *        Input  : l-fat-pfs-tip-ope = "OP"                       *
      *                 l-fat-pfs-cod-dpz = codice dipendenza in uso   *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      * "CL" - Close, fine utilizzo                                    *
      *                                                                *
      *        Input  : l-fat-pfs-tip-ope = "CL"                       *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      * "C?" - Test se modulo cancellabile                             *
      *                                                                *
      *        Input  : l-fat-pfs-tip-ope = "C?"                       *
      *                                                                *
      *        Output : l-fat-pfs-exi-sts = spaces: Si                 *
      *                                     #     : No                 *
      *                                                                *
      * "DI" - Dichiarazione di inizio fatturazione differita          *
      *                                                                *
      *        Input  : l-fat-pfs-tip-ope = "DI"                       *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      * "OS" - Accettazione dati identificativi ordine di spedizione   *
      *                                                                *
      *        Input  : l-fat-pfs-tip-ope = "BC"                       *
      *                 l-fat-pfs-tmo-orc = codice tipo movimento      *
      *                                     gestione ordini da pro-    *
      *                                     porre come default         *
      *                                                                *
      *        Output : l-fat-pfs-exi-sts = spaces: Accettazione ese-  *
      *                                             guita con successo *
      *                                     #     : Uscita per Exit    *
      *                                                                *
      * "T1" - Bufferizzazione testata primo ordine cliente richiamato *
      *                                                                *
      *        Input  : l-fat-pfs-tip-ope = "T1"                       *
      *                                                                *
      *        Output : l-fat-pfs-exi-sts = spaces: Tutto Ok           *
      *                                     #     : Uscita con errore  *
      *                                                                *
      * "T+" - Confronto dati testata ordine cliente in esame con dati *
      *        di testata del documento                                *
      *                                                                *
      *        Input  : l-fat-pfs-tip-ope = "T+"                       *
      *                                                                *
      *        Output : l-fat-pfs-exi-sts = spaces: Tutto Ok           *
      *                                     #     : Uscita con errore  *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-bro-tbl.
               10  w-bro-sng-ele occurs 900.
                   ...
                   15  w-bro-qta-fat      pic s9(10)v9(03) comp-3     .
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-zsc.
               ...
               10  w-let-arc-zsc-ord      pic  9(02)                  .
               10  w-let-arc-zsc-sgl      pic  x(03)                  .
               10  w-let-arc-zsc-dpz      pic  9(02)                  .
               10  w-let-arc-zsc-tvd      pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *        * Tipo operazione                                       *
      *        *-------------------------------------------------------*
           05  l-fat-pfs-tip-ope          pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Return status code                                    *
      *        * - Spaces : operazione eseguita                        *
      *        * - #      : errore di esecuzione                       *
      *        *-------------------------------------------------------*
           05  l-fat-pfs-exi-sts          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Codice dipendenza in uso                              *
      *        *-------------------------------------------------------*
           05  l-fat-pfs-cod-dpz          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Default per codice tipo movimento ordini clienti      *
      *        *-------------------------------------------------------*
           05  l-fat-pfs-tmo-orc          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Flag di trattamento ordine cliente                    *
      *        *-------------------------------------------------------*
           05  l-fat-pfs-flg-orc          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Flag di function-key Tab in corso                     *
      *        *-------------------------------------------------------*
           05  l-fat-pfs-fky-tab          pic  x(01)                  .
      ...
      ******************************************************************
       Procedure Division                using l-fat-pfs
                                               w-prs
                                               w-tes
                                               w-pie
                                               w-rig
      ...
      *              *-------------------------------------------------*
           move      spaces               to   l-fat-pfs-exi-sts      .
      *              *-------------------------------------------------*
      ...
      *                  * record [fir]                                *
      *                  *---------------------------------------------*
           else if   l-fat-pfs-tip-ope    =    "WR"
                     perform wrt-rec-ods-000
                                          thru wrt-rec-ods-999
      *                  *---------------------------------------------*
      *                  * Aggiornamento records ordine per quanto ri- *
      *                  * guarda i dati relativi alla fattura diffe-  *
      ...
      *                  * [fir]                                       *
      *                  *---------------------------------------------*
           else if   l-fat-pfs-tip-ope    =    "RW"
                     perform rew-rec-ods-000
                                          thru rew-rec-ods-999
      *                  *---------------------------------------------*
      *                  * Aggiornamento records ordine per quanto ri- *
      *                  * guarda i dati relativi alla fattura diffe-  *
      ...
      *                  * record [fir]                                *
      *                  *---------------------------------------------*
           else if   l-fat-pfs-tip-ope    =    "DE"
                     perform del-rec-ods-000
                                          thru del-rec-ods-999
      *                  *---------------------------------------------*
      *                  * Open                                        *
      *                  *---------------------------------------------*
           else if   l-fat-pfs-tip-ope    =    "OP"
                     perform exe-fun-opn-000
                                          thru exe-fun-opn-999
      *                  *---------------------------------------------*
      *                  * Close                                       *
      *                  *---------------------------------------------*
           else if   l-fat-pfs-tip-ope    =    "CL"
                     perform exe-fun-cls-000
                                          thru exe-fun-cls-999
      *                  *---------------------------------------------*
      *                  * Test cancellabilita' modulo                 *
      *                  *---------------------------------------------*
           else if   l-fat-pfs-tip-ope    =    "C?"
      ...
      *              *-------------------------------------------------*
           move      l-fat-pfs-cod-dpz    to   w-acc-cod-dpz          .
       exe-fun-opn-100.
      *              *-------------------------------------------------*
      *              * Apertura files                                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-gen-ctr-opn        =    zero
                     move  spaces         to   l-fat-pfs-exi-sts
           else      move  "#"            to   l-fat-pfs-exi-sts      .
       tst-cnc-mod-999.
           exit.
      ...
      *              * corso                                           *
      *              *-------------------------------------------------*
           move      spaces               to   l-fat-pfs-fky-tab      .
       dic-ini-cic-999.
           exit.
      ...
      *              * trattare                                        *
      *              *-------------------------------------------------*
           move      w-acc-num-prt        to   w-buf-rig-ods-pos      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-buf-rig-ods-pos    to   rf-osr-num-prt         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-osr-num-prt       not  = w-buf-rig-ods-pos
                     go to buf-rig-ods-500.
       buf-rig-ods-210.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       buf-rig-ods-300.
      *              *-------------------------------------------------*
      *              * Bufferizzazione riga ordine di spedizione       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                      * descrizione contenuta nel record [osr]  *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-bro-qta-dsp
                    (w-bro-num-ele)       to   w-bro-qta-fat
                                              (w-bro-num-ele)         .
      *                  *---------------------------------------------*
      ...
      *              * Test su data ordine                             *
      *              *-------------------------------------------------*
           if        rf-ost-dat-doc       not  > w-tes-dat-doc
                     go to buf-tes-ods-100.
      *                  *---------------------------------------------*
      *                  * Composizione messaggio di errore            *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-ost-cod-arc       to   w-tes-cod-cli (1)      .
           move      rf-ost-dpz-arc       to   w-tes-dpz-cli (1)      .
           move      rf-ost-cod-lng       to   w-tes-cod-lng (1)      .
       buf-tes-ods-300.
      *              *-------------------------------------------------*
      *              * Prelievo elementi testata da record [ost]       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-ost-arc-plf       to   w-tes-cli-plf (1)      .
           move      rf-ost-dpz-plf       to   w-tes-dpc-plf (1)      .
           ...
           else if   rf-ost-fat-sep       =    "O"
                     move  "O"            to   w-gen-fat-sep
                     move  w-buf-rig-ods-pos
                                          to   w-gen-coc-prt          .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-ost-tot-scc       to   w-pie-tot-scc (1)      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-ost-arc-plf       to   w-ags-ass-iva-cli      .
           move      rf-ost-dat-doc       to   w-ags-ass-iva-dat      .
           perform   ags-ass-iva-000      thru ags-ass-iva-999        .
      *                  *---------------------------------------------*
      *                  * Test su esito operazione                    *
      *                  *---------------------------------------------*
           if        w-ags-ass-iva-flg    not  = spaces
                     go to buf-tes-ods-950.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione                             *
      *                  *---------------------------------------------*
      ...
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
           if        rf-ost-cod-arc       =    w-tes-cod-cli (1)
      ...
      *                          * Richiamo routine                    *
      *                          *-------------------------------------*
           move      rf-ost-ass-iva       to   w-ags-ass-iva-aii      .
           move      rf-ost-arc-plf       to   w-ags-ass-iva-cli      .
           move      rf-ost-dat-doc       to   w-ags-ass-iva-dat      .
           perform   ags-ass-iva-000      thru ags-ass-iva-999        .
      *                          *-------------------------------------*
      ...
      *                          * Bufferizzazione                     *
      *                          *-------------------------------------*
           move      w-ags-ass-iva-aio    to   rf-ost-ass-iva         .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           if        rf-ost-spe-snx (1)   =    w-pie-spe-snx (1, 1) and
                     rf-ost-spe-snx (2)   =    w-pie-spe-snx (1, 2) and
                     rf-ost-spe-snx (3)   =    w-pie-spe-snx (1, 3) and
                     rf-ost-spe-snx (4)   =    w-pie-spe-snx (1, 4) and
                     rf-ost-spe-snx (5)   =    w-pie-spe-snx (1, 5) and
                     rf-ost-spe-snx (6)   =    w-pie-spe-snx (1, 6)
                     go to cnf-tes-doc-066.
      ...
      *                  *---------------------------------------------*
           if        rf-ost-dpz-arc       =    w-tes-dpz-cli (1)
      ...
      *                      * razione                                 *
      *                      *-----------------------------------------*
           if        rf-ost-dpz-plf       =    w-tes-dpc-plf (1)
      ...
      *                  *---------------------------------------------*
           add       rf-ost-tot-scc       to   w-pie-tot-scc (1)      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-bro-qta-fat
                    (w-sdc-ctr-rig)       not  = w-sav-qta-fat
                     move   w-sav-qta-fat to   w-bro-qta-fat
                                              (w-sdc-ctr-rig)
                     go to  acc-qta-fat-100.
       acc-qta-fat-600.
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-bro-qta-dsp
                    (w-sdc-ctr-rig)       to   w-bro-qta-fat
                                              (w-sdc-ctr-rig)         .
           move      w-bro-qta-dsp
                    (w-sdc-ctr-rig)       to   w-qss-qta-fat          .
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-osr-cdc-vpl       to   w-rig-cdc-vpl (1)      .
      ...
      *                              * Se estensione nel file [osx]    *
      *                              *---------------------------------*
           move      w-gen-prt-ods        to   w-let-arc-bix-prt      .
           move      w-bro-num-prg
      ...
      *    *===========================================================*
      *    * Aggiornamento records [ost] e [osr] per quanto riguarda i *
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-let-arc-bix-prt    to   rf-osx-num-prt         .
           move      w-let-arc-bix-prg    to   rf-osx-num-prg         .
           move      w-let-arc-bix-trc    to   rf-osx-tip-rec         .
           move      "pgm/ods/fls/ioc/obj/iofosx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-osx-des-400       to   w-let-arc-bix-des      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
