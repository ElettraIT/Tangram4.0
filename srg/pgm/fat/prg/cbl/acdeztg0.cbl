      ...
      *                       Ultima revisione:    NdK del 22/01/19    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione codice Tag              *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-des-ztg-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-ztg-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-ztg-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-ztg-cod : codice Tag           *
      *                                                                *
      *                       w-cod-des-ztg-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-ztg-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-ztg-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-ztg-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-ztg-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-ztg-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-ztg-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-ztg-cod : codice Tag           *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-ztg.
           05  w-aux-cde-ztg-nli          pic  9(02)                  .
           05  w-aux-cde-ztg-crb          pic  9(02)                  .
           05  w-aux-cde-ztg-cpb          pic  9(02)                  .
           05  w-aux-cde-ztg-cpa          pic  9(02)                  .
           05  w-aux-cde-ztg-bix          pic  9(02)                  .
           05  w-aux-cde-ztg-buf
                               occurs 30.
               10  w-aux-cde-ztg-bco      pic  x(20)                  .
               10  w-aux-cde-ztg-bde      pic  x(30)                  .
           05  w-aux-cde-ztg-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-ztg-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-ztg-lt2      pic  9(01)                  .
           05  w-aux-cde-ztg-dup          pic  x(30)                  .
           05  w-aux-cde-ztg-dmx.
               10  w-aux-cde-ztg-dch
                               occurs 30  pic  x(01)                  .
           05  w-aux-cde-ztg-c01          pic  9(02)                  .
           05  w-aux-cde-ztg-c02          pic  9(02)                  .
           05  w-aux-cde-ztg-c03          pic  9(02)                  .
           05  w-aux-cde-ztg-c04          pic  9(02)                  .
           05  w-aux-cde-ztg-c05          pic  9(02)                  .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-ztg
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-ztg-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-ztg-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-ztg-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-ztg-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-ztg-ope    =    "A+" or
                     w-cod-des-ztg-ope    =    "I+" or
                     w-cod-des-ztg-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-ztg-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-cod-des-ztg-cod    to   w-cod-des-ztg-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-ztg-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-ztg-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-ztg-s90    to   v-ufk                  .
           move      w-cod-des-ztg-lin    to   v-lin                  .
           move      w-cod-des-ztg-pos    to   v-pos                  .
           move      w-cod-des-ztg-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-ztg-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-ztg-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-ztg-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-ztg-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-ztg-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-ztg-cod    to   w-cod-des-ztg-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-ztg-alf    to   w-all-str-alf          .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-ztg-dln    =    zero or
                     w-cod-des-ztg-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-ztg-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      w-cod-des-ztg-dln    to   v-lin                  .
           move      w-cod-des-ztg-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-ztg-dln    to   v-lin                  .
           move      w-cod-des-ztg-dps    to   v-pos                  .
           move      w-aux-cde-ztg-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-ztg-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-ztg-dup    to   w-aux-cde-ztg-dmx      .
           move      30                   to   w-aux-cde-ztg-c01      .
       aco-680.
           if        w-aux-cde-ztg-c01    >    zero
                     if    w-aux-cde-ztg-dch
                          (w-aux-cde-ztg-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-ztg-dch
                                              (w-aux-cde-ztg-c01)
                           subtract 1     from w-aux-cde-ztg-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-ztg-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-ztg-dup    to   rf-ztg-des-key         .
           move      spaces               to   rf-ztg-cod-tag         .
           move      "pgm/fat/fls/ioc/obj/iofztg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-ztg-des-key       >    w-aux-cde-ztg-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-ztg-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-ztg-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              * Codice dislocazione             *
      *                              *---------------------------------*
           move      rf-ztg-cod-tag       to   w-aux-cde-ztg-bco
                                              (w-aux-cde-ztg-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione dislocazione        *
      *                              *---------------------------------*
           move      rf-ztg-des-tag       to   w-aux-cde-ztg-bde
                                              (w-aux-cde-ztg-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-ztg-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-ztg-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-ztg-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      30                   to   s-car                  .
           move      w-aux-cde-ztg-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-ztg-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-ztg-bco
                    (w-aux-cde-ztg-bix)   to   w-cod-des-ztg-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-ztg-crb    to   w-aux-cde-ztg-cpb      .
           subtract  1                    from w-aux-cde-ztg-cpb      .
           divide    6                    into w-aux-cde-ztg-cpb      .
           add       1                    to   w-aux-cde-ztg-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-ztg-c01      .
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      17                   to   v-pos                  .
           move      "      Selezionare il codice Tag desiderato     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                              * di indice (w-aux-cde-ztg-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-ztg-c01    to   w-aux-cde-ztg-nli      .
       aco-865.
           if        w-aux-cde-ztg-nli    >    6
                     subtract  6          from w-aux-cde-ztg-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-ztg-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-ztg-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-ztg-c01    <    w-aux-cde-ztg-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-ztg-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-ztg-cpa    <    w-aux-cde-ztg-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-ztg-nli    to   v-lin                  .
           move      39                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-ztg-c01    to   w-aux-cde-ztg-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-ztg-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-ztg-cpa    to   w-aux-cde-ztg-c01      .
           multiply  6                    by   w-aux-cde-ztg-c01      .
           subtract  5                    from w-aux-cde-ztg-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-ztg-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-ztg-c01    to   w-aux-cde-ztg-c02      .
           add       5                    to   w-aux-cde-ztg-c02      .
           divide    6                    into w-aux-cde-ztg-c02      .
           move      w-aux-cde-ztg-c02    to   w-aux-cde-ztg-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-ztg-c02      .
           multiply  6                    by   w-aux-cde-ztg-c02      .
           add       1                    to   w-aux-cde-ztg-c02      .
           add       5
                     w-aux-cde-ztg-c02  giving w-aux-cde-ztg-c03      .
           move      w-aux-cde-ztg-c03    to   w-aux-cde-ztg-c04      .
           if        w-aux-cde-ztg-c03    >    w-aux-cde-ztg-crb
                     move  w-aux-cde-ztg-crb
                                          to   w-aux-cde-ztg-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-ztg-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      20                   to   v-car                  .
           move      w-aux-cde-ztg-c05    to   v-lin                  .
           move      17                   to   v-pos                  .
           move      w-aux-cde-ztg-bco
                    (w-aux-cde-ztg-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      *                                      * Descrizione dislocazione*
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-ztg-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-ztg-c02    not  > w-aux-cde-ztg-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-ztg-c02    >    w-aux-cde-ztg-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-ztg-cpa    to   w-aux-cde-ztg-lt1      .
           move      w-aux-cde-ztg-cpb    to   w-aux-cde-ztg-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-ztg-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
