      ...
      *                  *---------------------------------------------*
           move      rf-dde-num-dst       to   srt-num-dst            .
           move      rf-dde-num-prg       to   srt-num-prg            .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Cancellazione record [dde]                                *
      *    *-----------------------------------------------------------*
       del-rec-dst-000.
      *              *-------------------------------------------------*
      *              * Composizione chiave primaria                    *
      *              *-------------------------------------------------*
           move      srt-num-dst          to   rf-dde-num-dst         .
           move      srt-num-prg          to   rf-dde-num-prg         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
