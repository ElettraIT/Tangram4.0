      ...
      *                       Ultima revisione:    NdK del 14/04/25    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *              Input  : w-esp-idv-fit-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-esp-idv-fit-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "ES"  Espansione                                               *
      *                                                                *
      *              Input  : w-esp-idv-fit-ope : "ES"                 *
      *                                                                *
      *                       w-esp-idv-fit-prt : protocollo fattura   *
      *                       w-esp-idv-fit-num : numero documento     *
      *                       w-esp-idv-fit-dat : data documento       *
      *                       w-esp-idv-fit-tmo : tipo documento       *
      *                                                                *
      *              Output : nessuno                                  *
      *                                                                *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-aux-rec-fir.
               10  w-aux-rec-fir-rtr      pic  x(01)                  .
               10  w-aux-rec-fir-c01      pic  9(05)                  .
               10  w-aux-rec-fir-c02      pic  9(03)                  .
               10  w-aux-rec-fir-c03      pic  9(05)                  .
               10  w-aux-rec-fir-c04      pic  9(05)                  .
               10  w-aux-rec-fir-c05      pic  9(05)                  .
               10  w-aux-rec-fir-c06      pic  9(05)                  .
               10  w-aux-rec-fir-cix      pic  9(03)                  .
               10  w-aux-rec-fir-nli      pic  9(05)                  .
               10  w-aux-rec-fir-crb      pic  9(05)                  .
               10  w-aux-rec-fir-max      pic  9(05) value 300        .
               10  w-aux-rec-fir-cpb      pic  9(05)                  .
               10  w-aux-rec-fir-cpa      pic  9(05)                  .
               10  w-aux-rec-fir-buf
                               occurs 300.
                   15  w-aux-rec-fir-tip  pic  9(02)                  .
                   15  w-aux-rec-fir-tmo  pic  x(05)                  .
                   15  w-aux-rec-fir-prt  pic  9(11)                  .
                   15  w-aux-rec-fir-num  pic  9(11)                  .
                   15  w-aux-rec-fir-dat  pic  9(07)                  .
                   15  w-aux-rec-fir-sts  pic  x(20)                  .
      ...
      *    *-----------------------------------------------------------*
           copy      "pgm/fat/prg/cpy/pfat301y.pgl"                   .

      ******************************************************************
       Procedure Division                using w-esp-idv-fit          .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-esp-idv-fit-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-esp-idv-fit-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-esp-idv-fit-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-esp-idv-fit-ope    =    "ES"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-esp-idv-fit-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-aux-rec-fir-crb      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      31                   to   d-ird-ven-tip-dsr      .
           move      w-esp-idv-fit-prt    to   d-ird-ven-prt-dsr      .
           perform   det-ird-ven-cll-000  thru det-ird-ven-cll-999    .
       esp-200.
      *              *-------------------------------------------------*
      *              * Incremento numero records nel buffer            *
      *              *-------------------------------------------------*
           add       1                    to   w-aux-rec-fir-crb      .
      *              *-------------------------------------------------*
      *              * Test su numero documenti correlati              *
      *              *-------------------------------------------------*
           if        w-aux-rec-fir-crb    >    d-ird-ven-num-ele
                     move  d-ird-ven-num-ele
                                          to   w-aux-rec-fir-crb
                     go to esp-500.
      *              *-------------------------------------------------*
      *              * Test se buffer oltre il numero previsto         *
      *              *-------------------------------------------------*
           if        w-aux-rec-fir-crb    >    w-aux-rec-fir-max
                     go to esp-500.
       esp-420.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      d-ird-ven-tip-dtr
                    (w-aux-rec-fir-crb)   to   w-aux-rec-fir-tip
                                              (w-aux-rec-fir-crb)     .
           move      d-ird-ven-tmo-dtr
                    (w-aux-rec-fir-crb)   to   w-aux-rec-fir-tmo
                                              (w-aux-rec-fir-crb)     .
           move      d-ird-ven-prt-dtr
                    (w-aux-rec-fir-crb)   to   w-aux-rec-fir-prt
                                              (w-aux-rec-fir-crb)     .
           move      d-ird-ven-num-dtr
                    (w-aux-rec-fir-crb)   to   w-aux-rec-fir-num
                                              (w-aux-rec-fir-crb)     .
           move      d-ird-ven-dat-dtr
                    (w-aux-rec-fir-crb)   to   w-aux-rec-fir-dat
                                              (w-aux-rec-fir-crb)     .
           move      d-ird-ven-sts-dtr
                    (w-aux-rec-fir-crb)   to   w-aux-rec-fir-sts
                                              (w-aux-rec-fir-crb)     .
       esp-430.
      *              *-------------------------------------------------*
      *              * Riciclo a lettura                               *
      ...
      *              * valore                                          *
      *              *-------------------------------------------------*
           if        w-aux-rec-fir-crb    =    zero
                     go to esp-999.
      *                  *---------------------------------------------*
      *                  * Determinazione numero pagine nel buffer     *
      *                  *---------------------------------------------*
           move      w-aux-rec-fir-crb    to   w-aux-rec-fir-cpb      .
           subtract  1                    from w-aux-rec-fir-cpb      .
           divide    6                    into w-aux-rec-fir-cpb      .
           add       1                    to   w-aux-rec-fir-cpb      .
      *                  *---------------------------------------------*
      *                  * Inizializzazione numero record nel buffer   *
      *                  * attualmente trattato                        *
      *                  *---------------------------------------------*
           move      1                    to   w-aux-rec-fir-c01      .
       esp-520.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-aux-rec-fir-c01    to   w-aux-rec-fir-nli      .
       esp-555.
           if        w-aux-rec-fir-nli    >    6
                     subtract  6          from w-aux-rec-fir-nli
                     go to esp-555.
      *                  *---------------------------------------------*
      *                  * Incremento numero linea a video per posi-   *
      *                  * zionamento verticale                        *
      *                  *---------------------------------------------*
           add       09                   to   w-aux-rec-fir-nli      .
       esp-560.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-aux-rec-fir-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-rec-fir-c01    <    w-aux-rec-fir-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           if        w-aux-rec-fir-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-rec-fir-cpa    <    w-aux-rec-fir-cpb
           ...
           move      w-aux-rec-fir-nli    to   v-lin                  .
           move      17                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       esp-580.
      ...
      *                  *---------------------------------------------*
           subtract  1                    from w-aux-rec-fir-c01      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           subtract  1                    from w-aux-rec-fir-cpa      .
      *                  *---------------------------------------------*
      *                  * A trattamento contatore per le pagine       *
      *                  *---------------------------------------------*
           go to     esp-596.
      ...
      *              *-------------------------------------------------*
           move      w-aux-rec-fir-cpa    to   w-aux-rec-fir-c01      .
           multiply  6                    by   w-aux-rec-fir-c01      .
           subtract  5                    from w-aux-rec-fir-c01      .
           go to     esp-590.
       esp-598.
      *              *-------------------------------------------------*
      *              * Se Back                                         *
      *              *-------------------------------------------------*
           move      1                    to   w-aux-rec-fir-cpa      .
           go to     esp-596.
       esp-600.
      *              *-------------------------------------------------*
      *              * Se Tab                                          *
      *              *-------------------------------------------------*
           move      w-aux-rec-fir-cpb    to   w-aux-rec-fir-cpa      .
           go to     esp-596.
       esp-602.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *              *-------------------------------------------------*
           move      w-aux-rec-fir-c01    to   w-aux-rec-fir-c02      .
           add       5                    to   w-aux-rec-fir-c02      .
           divide    6                    into w-aux-rec-fir-c02      .
           move      w-aux-rec-fir-c02    to   w-aux-rec-fir-cpa      .
           subtract  1                    from w-aux-rec-fir-c02      .
           multiply  6                    by   w-aux-rec-fir-c02      .
           add       1                    to   w-aux-rec-fir-c02      .
           add       5
                     w-aux-rec-fir-c02  giving w-aux-rec-fir-c03      .
           move      w-aux-rec-fir-c03    to   w-aux-rec-fir-c04      .
           if        w-aux-rec-fir-c03    >    w-aux-rec-fir-crb
                     move  w-aux-rec-fir-crb
                                          to   w-aux-rec-fir-c03      .
      *                  *---------------------------------------------*
      *                  * Posizionamento iniziale                     *
      *                  *---------------------------------------------*
           move      10                   to   w-aux-rec-fir-c05      .
       esp-940.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      78                   to   v-car                  .
           move      w-aux-rec-fir-c05    to   v-lin                  .
           move      02                   to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           add       1                    to   w-aux-rec-fir-c02      .
           add       1                    to   w-aux-rec-fir-c05      .
           if        w-aux-rec-fir-c02    not  > w-aux-rec-fir-c03
                     go to esp-940.
       esp-957.
           if        w-aux-rec-fir-c02    >    w-aux-rec-fir-c04
                     go to esp-958.
           if        w-aux-rec-fir-crb    not  > 6
                     go to esp-958.
      *                  *---------------------------------------------*
      ...
      *
           if        w-aux-rec-fir-tip
                    (w-aux-rec-fir-c02)   =    21
                     move  spaces         to   w-all-str-cat (1)
           else if   w-aux-rec-fir-tip
                    (w-aux-rec-fir-c02)   =    11
                     move  "..."          to   w-all-str-cat (1)
           else      move  "......."      to   w-all-str-cat (1)      .
      *
           move      w-aux-rec-fir-tmo
                    (w-aux-rec-fir-c02)   to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "<B"                 to   v-edm                  .
           move      w-aux-rec-fir-num
                    (w-aux-rec-fir-c02)   to   w-wrk-num-doc          .
      ...
      *              *-------------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      w-aux-rec-fir-dat
                    (w-aux-rec-fir-c02)   to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              * Status documento                                *
      *              *-------------------------------------------------*
           move      w-aux-rec-fir-sts
                    (w-aux-rec-fir-c02)   to   w-lin-imm-sts-doc      .
      *              *-------------------------------------------------*
      *              * Separatori                                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-esp-idv-fit-num    to   w-wrk-num-doc          .
           move      w-wrk-ndo-prg        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      w-esp-idv-fit-dat    to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-esp-idv-fit-tmo    to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-aux-rec-fir-cpa    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-aux-rec-fir-cpb    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-all-str-cat (4)      .
      *              *-------------------------------------------------*
