      ...
      *                                   Fase:    fat920              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 08/06/01    *
      *                       Ultima revisione:    NdK del 12/05/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Caricamento esiti da 'SDI' con file 'csv'   *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      *                    ********************************            *
      *                    NOTE IMPORTANTI A LINEA 3727 !!!            *
      *                    ********************************            *
      *                                                                *
      * Note           :   il file deve essere posizionato nella       *
      *                    cartella 'sdi' nell'area 'asc/{AZI}'        *
      *                                                                *
      *                    ------------------------------------------- *
      *                    Formato AdE attuale (12/05/22)              *
      *                    ------------------------------------------- *
      *                    Per le fatture di Vendita Italia:           *
      *                                                                *
      *                    - Tipo fattura                              *
      *                    - Tipo documento                            *
      ...
      *            *---------------------------------------------------*
               10  srt-prg-inp            pic  9(09)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Per ospitare un intero record [inp]               *
      *            *---------------------------------------------------*
               10  srt-rec-inp.
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "CARICAMENTO ARCHIVIO 'SDI' DA FILE 'csv'"       .
      ...
      *        *-------------------------------------------------------*
           ...
           05  rr-pth-inp                 pic  x(80)                  .
      *        *-------------------------------------------------------*
      *        * Tipo documenti                                        *
      *        *                                                       *
      *        * - 01 : Fatture di vendita                             *
      *        * - 02 : Fatture CEE                                    *
      *        *-------------------------------------------------------*
           05  rr-tip-doc                 pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo documenti                             *
      *        *-------------------------------------------------------*
           05  w-exp-tip-doc.
               10  w-exp-tip-doc-num      pic  9(02)       value 2    .
               10  w-exp-tip-doc-lun      pic  9(02)       value 40   .
               10  w-exp-tip-doc-tbl.
                   15  filler             pic  x(40) value
                            "Fatture di vendita Italia               ".
                   15  filler             pic  x(40) value
                            "Fatture CEE                             ".

      *    *===========================================================*
      *    * Work area per la definizione del record in input          *
      *    *-----------------------------------------------------------*
       01  w-inp.
      *        *-------------------------------------------------------*
      *        * Record documento vendita Italia                       *
      *        *-------------------------------------------------------*
           05  w-inp-ven.
      *            *---------------------------------------------------*
      *            * Tipo fattura                                      *
      *            *---------------------------------------------------*
               10  w-inp-ven-tip-fat      pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Tipo documento                                    *
      *            *---------------------------------------------------*
               10  w-inp-ven-tip-doc      pic  x(25)                  .
      *            *---------------------------------------------------*
      *            * Numero fattura / Documento                        *
      *            *---------------------------------------------------*
               10  w-inp-ven-num-doc      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Data emissione                                    *
      *            *---------------------------------------------------*
               10  w-inp-ven-dat-doc      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Codice fiscale fornitore                          *
      *            *---------------------------------------------------*
               10  w-inp-ven-cfi-fnt      pic  x(16)                  .
      *            *---------------------------------------------------*
      *            * Partita IVA fornitore                             *
      *            *---------------------------------------------------*
               10  w-inp-ven-piv-fnt      pic  x(16)                  .
      *            *---------------------------------------------------*
      *            * Denominazione fornitore                           *
      *            *---------------------------------------------------*
               10  w-inp-ven-rag-fnt      pic  x(80)                  .
      *            *---------------------------------------------------*
      *            * Codice fiscale cliente                            *
      *            *---------------------------------------------------*
               10  w-inp-ven-cfi-cli      pic  x(16)                  .
      *            *---------------------------------------------------*
      *            * Partita IVA cliente                               *
      *            *---------------------------------------------------*
               10  w-inp-ven-piv-cli      pic  x(16)                  .
      *            *---------------------------------------------------*
      *            * Denominazione cliente                             *
      *            *---------------------------------------------------*
               10  w-inp-ven-rag-cli      pic  x(80)                  .
      *            *---------------------------------------------------*
      *            * Imponibile/Importo (totale in euro)               *
      *            *---------------------------------------------------*
               10  w-inp-ven-tot-ibl      pic  x(15)                  .
      *            *---------------------------------------------------*
      *            * Imposta (totale in euro)                          *
      *            *---------------------------------------------------*
               10  w-inp-ven-tot-imp      pic  x(15)                  .
      *            *---------------------------------------------------*
      *            * Sdi/file                                          *
      *            *---------------------------------------------------*
               10  w-inp-ven-sdi-fil      pic  x(15)                  .
      *            *---------------------------------------------------*
      *            * Fatture consegnate                                *
      *            *---------------------------------------------------*
               10  w-inp-ven-sdi-esi      pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Data consegna                                     *
      *            *---------------------------------------------------*
               10  w-inp-ven-sdi-dat      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Bollo virtuale                                    *
      *            *---------------------------------------------------*
               10  w-inp-ven-bol-vrt      pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Record documento vendita CEE                          *
      *        *-------------------------------------------------------*
           05  w-inp-cee.
      *            *---------------------------------------------------*
      *            * Codice fiscale fornitore                          *
      *            *---------------------------------------------------*
               10  w-inp-cee-cfi-fnt      pic  x(16)                  .
      *            *---------------------------------------------------*
      *            * Partita Iva fornitore                             *
      *            *---------------------------------------------------*
               10  w-inp-cee-piv-fnt      pic  x(16)                  .
      *            *---------------------------------------------------*
      *            * Denominazione fornitore                           *
      *            *---------------------------------------------------*
               10  w-inp-cee-rag-fnt      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Tipo fattura                                      *
      *            *---------------------------------------------------*
               10  w-inp-cee-tip-fat      pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Numero fattura / Documento                        *
      *            *---------------------------------------------------*
               10  w-inp-cee-num-doc      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Data emissione                                    *
      *            *---------------------------------------------------*
               10  w-inp-cee-dat-doc      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Codice fiscale cliente estero                     *
      *            *---------------------------------------------------*
               10  w-inp-cee-cfi-cli      pic  x(16)                  .
      *            *---------------------------------------------------*
      *            * Paese cliente estero                              *
      *            *---------------------------------------------------*
               10  w-inp-cee-naz-cli      pic  x(02)                  .
      *            *---------------------------------------------------*
      *            * Partita IVA cliente estero                        *
      *            *---------------------------------------------------*
               10  w-inp-cee-piv-cli      pic  x(16)                  .
      *            *---------------------------------------------------*
      *            * Denominazione cliente estero                      *
      *            *---------------------------------------------------*
               10  w-inp-cee-rag-cli      pic  x(80)                  .
      *            *---------------------------------------------------*
      *            * Imponibile/Importo (totale in euro)               *
      *            *---------------------------------------------------*
               10  w-inp-cee-tot-ibl      pic  x(15)                  .
      *            *---------------------------------------------------*
      *            * Imposta (totale in euro)                          *
      *            *---------------------------------------------------*
               10  w-inp-cee-tot-imp      pic  x(15)                  .
      *            *---------------------------------------------------*
      *            * Trasmessa da                                      *
      *            *---------------------------------------------------*
               10  w-inp-cee-trs-frm      pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Stato                                             *
      *            *---------------------------------------------------*
               10  w-inp-cee-sdi-sts      pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Sdi/file                                          *
      *            *---------------------------------------------------*
               10  w-inp-cee-sdi-fil      pic  x(15)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Comodi per aggiornamento record 'ddx'                 *
      *        *-------------------------------------------------------*
           05  w-gen-agg-ddx.
               10  w-gen-agg-ddx-dat      pic  x(10)                  .
               10  w-gen-agg-ddx-sts      pic  x(20)                  .
               10  w-gen-agg-ddx-sdi      pic  x(40)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per Det tipo file                                *
      *        *-------------------------------------------------------*
           05  w-det-tip-fil.
               10  w-det-tip-fil-tip      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Work per Det di estrazione elementi da stringa        *
      *        *-------------------------------------------------------*
           05  w-det-lst.
               10  w-det-ext-num-ctr      pic  9(03)                  .
               10  w-det-ext-num-mis      pic  9(03) value 01         .
               10  w-det-ext-num-mas      pic  9(03) value 14         .
               10  w-det-ext-str-alf      pic  x(180)                 .
               10  w-det-ext-str-al1      pic  x(180)                 .
               10  w-det-ext-str-al2      pic  x(180)                 .
               10  w-det-ext-str-ext      pic  x(100)                 .
      *        *-------------------------------------------------------*
      *        * Work per Det protocollo documento                     *
      *        *-------------------------------------------------------*
           05  w-det-prt-fit.
               10  w-det-prt-fit-ndo      pic  x(10)                  .
               10  w-det-prt-fit-ddo      pic  x(10)                  .
               10  w-det-prt-fit-prt      pic  9(09)                  .
               10  w-det-prt-fit-dpz      pic  9(02)                  .
               10  w-det-prt-fit-ddc      pic  9(07)                  .
               10  w-det-prt-fit-num      pic  9(06)                  .
               10  w-det-prt-fit-nmw      pic  9(06)                  .
      *        *-------------------------------------------------------*
      *        * Determinazione se documento gia' in distinta          *
      *        *-------------------------------------------------------*
           05  w-det-dst-num.
               10  w-det-dst-num-prt      pic  9(09)                  .
               10  w-det-dst-num-dst      pic  9(09)                  .
               10  w-det-dst-num-prg      pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Per determinazione buchi numerazione                  *
      *        *-------------------------------------------------------*
           05  w-det-buc-num.
               10  w-det-buc-num-num      pic  9(06)                  .
               10  w-det-buc-num-pre      pic  9(06)                  .
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "N.B.: Indicare il nome SENZA il suffisso '.csv'"
                                          to   v-nt1                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Tipo documenti             *
      *    *-----------------------------------------------------------*
       acc-tip-doc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                      *-----------------------------------------*
           ...
           move      s-azi                to   w-all-str-cat (2)      .
           move      "/sdi/"              to   w-all-str-cat (3)      .
           move      rr-pth-acc           to   w-all-str-cat (4)      .
      ...
      *                          *-------------------------------------*
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo su tipo documenti                     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Che non sia a zero                          *
      *                  *---------------------------------------------*
           if        rr-tip-doc           not  = zero
                     go to tdo-ric-sel-800.
      *                  *---------------------------------------------*
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Indicare il tipo di documenti!                    
      -              "       "            to   w-err-box-err-msg      .
      *                  *---------------------------------------------*
      *                  * Ad errore                                   *
      *                  *---------------------------------------------*
      ...
      *              * Tipo documenti                                  *
      *              *-------------------------------------------------*
           if        rr-tip-doc           not  = 02
                     move  01             to   rr-tip-doc             .
       reg-ric-sel-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *              * Tipo documenti da richieste                     *
      *              *-------------------------------------------------*
           if        rr-tip-doc           =    02
                     move  "E"            to   w-det-tip-fil-tip
           else      move  "V"            to   w-det-tip-fil-tip      .
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Open file sequenziale in input                  *
      *              *-------------------------------------------------*
      ...
      *                  * Test se fincatura                           *
      *                  *---------------------------------------------*
           if        g-rec (1 : 12)       =    "Tipo fattura" or
                     g-rec (1 : 12)       =    "Partita IVA "
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo file deter- *
      *                  * minato                                      *
      *                  *---------------------------------------------*
           if        w-det-tip-fil-tip    =    "E"
                     perform stp-srt-inp-cee-000
                                          thru stp-srt-inp-cee-999
           else      perform stp-srt-inp-ven-000
                                          thru stp-srt-inp-ven-999    .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *    * Input procedure per sort                                  *
      *    *                                                           *
      *    * Subroutine per fatture di vendita Italia                  *
      *    *-----------------------------------------------------------*
       stp-srt-inp-ven-000.
      *              *-------------------------------------------------*
      *              * Trattamento record                              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Estrazione degli 11 campi che compongono il *
      *                  * record                                      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Normalizzazione preliminare record      *
      *                      *-----------------------------------------*
           move      spaces               to   w-inp-ven              .
      *                      *-----------------------------------------*
      *                      * Record in comodo di trattamento         *
      *                      *-----------------------------------------*
           move      spaces               to   w-det-ext-str-alf      .
           move      g-rec                to   w-det-ext-str-alf      .
       stp-srt-inp-ven-200.
      *                      *-----------------------------------------*
      *                      * Tipo fattura                            *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-tip-fat      .
      *                      *-----------------------------------------*
      *                      * Tipo documento                          *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-tip-doc      .
      *                      *-----------------------------------------*
      *                      * Numero fattura / Documento              *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-num-doc      .
      *                      *-----------------------------------------*
      *                      * Data emissione                          *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-dat-doc      .
      *                      *-----------------------------------------*
      *                      * Codice fiscale fornitore                *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-cfi-fnt      .
      *                      *-----------------------------------------*
      *                      * Partita IVA fornitore                   *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-piv-fnt      .
      *                      *-----------------------------------------*
      *                      * Denominazione fornitore                 *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-rag-fnt      .
      *                      *-----------------------------------------*
      *                      * Codice fiscale cliente                  *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-cfi-cli      .
      *                      *-----------------------------------------*
      *                      * Partita IVA cliente                     *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-piv-cli      .
      *                      *-----------------------------------------*
      *                      * Denominazione cliente                   *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-rag-cli      .
      *                      *-----------------------------------------*
      *                      * Imponibile/Importo (totale in euro)     *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-tot-ibl      .
      *                      *-----------------------------------------*
      *                      * Imposta (totale in euro)                *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-tot-imp      .
      *                      *-----------------------------------------*
      *                      * Sdi/file                                *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-sdi-fil      .
      *                      *-----------------------------------------*
      *                      * Fatture consegnate                      *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-sdi-esi      .
      *                      *-----------------------------------------*
      *                      * Data consegna                           *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-sdi-dat      .
      *                      *-----------------------------------------*
      *                      * Bollo virtuale                          *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-ven-bol-vrt      .
       stp-srt-inp-ven-600.
      *              *-------------------------------------------------*
      ...
      *                      * Tipo record                             *
      *                      *-----------------------------------------*
           move      w-det-tip-fil-tip    to   srt-fil-tip            .
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      10                   to   v-car                  .
           move      w-inp-ven-num-doc    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   srt-num-key            .
      *                      *-----------------------------------------*
      *                      * Progressivo di rilascio                 *
      *                      *-----------------------------------------*
           move      w-gen-ele-let        to   srt-prg-inp            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Record [hpo]                            *
      *                      *-----------------------------------------*
           move      w-inp-ven            to   srt-rec-inp            .
       stp-srt-inp-ven-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-ven-999.
       stp-srt-inp-ven-999.
           exit.
      ...
      *    * Input procedure per sort                                  *
      *    *                                                           *
      *    * Subroutine per fatture di vendita CEE                     *
      *    *-----------------------------------------------------------*
       stp-srt-inp-cee-000.
      *              *-------------------------------------------------*
      *              * Trattamento record                              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Estrazione dei campi che compongono il re-  *
      *                  * cord                                        *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Normalizzazione preliminare record      *
      *                      *-----------------------------------------*
           move      spaces               to   w-inp-cee              .
      *                      *-----------------------------------------*
      *                      * Record in comodo di trattamento         *
      *                      *-----------------------------------------*
           move      spaces               to   w-det-ext-str-alf      .
      ...
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-cfi-fnt      .
      *                      *-----------------------------------------*
      *                      * Partita Iva fornitore                   *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-piv-fnt      .
      *                      *-----------------------------------------*
      *                      * Denominazione fornitore                 *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-rag-fnt      .
      *                      *-----------------------------------------*
      *                      * Tipo fattura                            *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-tip-fat      .
      *                      *-----------------------------------------*
      *                      * Numero fattura / Documento              *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-num-doc      .
      *                      *-----------------------------------------*
      *                      * Data emissione                          *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-dat-doc      .
      *                      *-----------------------------------------*
      *                      * Codice fiscale cliente estero           *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-cfi-cli      .
      *                      *-----------------------------------------*
      *                      * Paese cliente estero                    *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-naz-cli      .
      *                      *-----------------------------------------*
      *                      * Partita IVA cliente estero              *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-piv-cli      .
      *                      *-----------------------------------------*
      *                      * Denominazione cliente estero            *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-rag-cli      .
      *                      *-----------------------------------------*
      *                      * Imponibile/Importo (totale in euro)     *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-tot-ibl      .
      *                      *-----------------------------------------*
      *                      * Imposta (totale in euro)                *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-tot-imp      .
      *                      *-----------------------------------------*
      *                      * Trasmessa da                            *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-trs-frm      .
      *                      *-----------------------------------------*
      *                      * Stato                                   *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-sdi-sts      .
      *                      *-----------------------------------------*
      *                      * Sdi/file                                *
      *                      *-----------------------------------------*
           perform   stp-srt-inp-ext-000  thru stp-srt-inp-ext-999    .
           move      w-det-ext-str-ext    to   w-inp-cee-sdi-fil      .
       stp-srt-inp-cee-600.
      *              *-------------------------------------------------*
      *              * Preparazione record di sort                     *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      10                   to   v-car                  .
           move      w-inp-cee-num-doc    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   srt-num-key            .
      *                      *-----------------------------------------*
      ...
      *                      * Record [hpo]                            *
      *                      *-----------------------------------------*
           move      w-inp-cee            to   srt-rec-inp            .
       stp-srt-inp-cee-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-cee-999.
       stp-srt-inp-cee-999.
           exit.
      ...
      *    * Input procedure per sort                                  *
      *    *                                                           *
      *    * Subroutine di estrazione campi                            *
      *    *-----------------------------------------------------------*
       stp-srt-inp-ext-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-ext-num-ctr      .
           move      spaces               to   w-det-ext-str-al1      .
           move      spaces               to   w-det-ext-str-al2      .
           move      spaces               to   w-det-ext-str-ext      .
      *              *-------------------------------------------------*
      *              * Test preliminare                                *
      *              *-------------------------------------------------*
           inspect   w-det-ext-str-alf
                                      tallying w-det-ext-num-ctr
                     for    all ";"                                   .
           if        w-det-ext-num-ctr    =    zero
                     move  w-det-ext-str-alf
                                          to   w-det-ext-str-ext
                     go to stp-srt-inp-ext-999.
      *              *-------------------------------------------------*
      *              * Estrazione                                      *
      *              *-------------------------------------------------*
           unstring  w-det-ext-str-alf
                                delimited by ";"
                                          into w-det-ext-str-al1
                                    count in   w-det-ext-num-ctr      .
           add       2                    to   w-det-ext-num-ctr      .
      *              *-------------------------------------------------*
      *              * Estrazione stringa rimanente                    *
      *              *-------------------------------------------------*
           unstring  w-det-ext-str-alf    into w-det-ext-str-al2
                                  with pointer w-det-ext-num-ctr      .
      *              *-------------------------------------------------*
      *              * Valori estratti                                 *
      *              *-------------------------------------------------*
           move      w-det-ext-str-al1    to   w-det-ext-str-ext      .
           move      w-det-ext-str-al2    to   w-det-ext-str-alf      .
      *              *-------------------------------------------------*
      *              * Pulizia da eventuali ''                         *
      *              *-------------------------------------------------*
           inspect   w-det-ext-str-ext
                                replacing all  "'"
                                          by   " "                    .
           move      80                   to   w-all-str-lun          .
           move      w-det-ext-str-ext    to   w-all-str-alf          .
           perform   all-str-asx-000      thru all-str-asx-999        .
           move      w-all-str-alf        to   w-det-ext-str-ext      .
      *              *-------------------------------------------------*
      *              * Pulizia da eventuali '"'                        *
      *              *-------------------------------------------------*
           inspect   w-det-ext-str-ext
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore elementi aggiornati   *
      *              *-------------------------------------------------*
           move      zero                 to   w-gen-ele-agg          .
      *              *-------------------------------------------------*
      *              * Normalizzazione comodo per determinazione se    *
      *              * presenti buchi nella numerazione                *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-buc-num-num      .
       prn-ini-cic-999.
           exit.
      ...
      *                      * Per un elemento                         *
      *                      *-----------------------------------------*
           move      "Aggiornato regolarmente un documento in distinta"
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo file            *
      *              *-------------------------------------------------*
           if        srt-fil-tip          =    "E"
                     perform prn-liv-det-cee-000
                                          thru prn-liv-det-cee-999
           else      perform prn-liv-det-ven-000
                                          thru prn-liv-det-ven-999    .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-liv-det-ven-000.
      *              *-------------------------------------------------*
      *              * Recupero del record 'inp'                       *
      *              *-------------------------------------------------*
           move      srt-rec-inp          to   w-inp-ven              .
       prn-liv-det-ven-200.
      *              *-------------------------------------------------*
      *              * Determinazione protocollo documento             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test preliminari                            *
      *                  *---------------------------------------------*
           if        w-inp-ven-dat-doc    =    spaces or
                     w-inp-ven-num-doc    =    spaces
                     go to prn-liv-det-ven-320.
      *                  *---------------------------------------------*
      *                  * Subroutine                                  *
      *                  *---------------------------------------------*
           move      w-inp-ven-num-doc    to   w-det-prt-fit-ndo      .
           move      w-inp-ven-dat-doc    to   w-det-prt-fit-ddo      .
           perform   det-prt-fit-000      thru det-prt-fit-999        .
      *                  *---------------------------------------------*
      *                  * Test su esito determinazione                *
      *                  *---------------------------------------------*
           if        w-det-prt-fit-prt    not  = zero
                     go to prn-liv-det-ven-400.
       prn-liv-det-ven-320.
      *                  *---------------------------------------------*
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           ...
           move      w-inp-ven-num-doc    to   w-all-str-cat (2)      .
           move      "del"                to   w-all-str-cat (3)      .
           move      w-inp-ven-dat-doc    to   w-all-str-cat (4)      .
      ...
      *                  * Subroutine                                  *
      *                  *---------------------------------------------*
           move      w-det-prt-fit-prt    to   w-det-dst-num-prt      .
           perform   det-dst-num-000      thru det-dst-num-999        .
      *                  *---------------------------------------------*
      *                  * Test su esito determinazione                *
      *                  *---------------------------------------------*
           if        w-det-dst-num-dst    not  = zero
                     go to prn-liv-det-ven-500.
      *                  *---------------------------------------------*
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      80                   to   w-all-str-lun          .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-ven-500.
      *              *-------------------------------------------------*
      *              * Determinazione se documento in progressione     *
      *              * numerica                                        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se comodo a zero                            *
      *                  *---------------------------------------------*
           if        w-det-buc-num-num    =    zero
                     move  w-det-prt-fit-num
                                          to   w-det-buc-num-num
                     go to prn-liv-det-ven-800.
      *                  *---------------------------------------------*
      *                  * Se appena avvenuta la rottura               *
      *                  *---------------------------------------------*
           if        w-det-buc-num-num    =    w-det-prt-fit-num
                     go to prn-liv-det-ven-800.
      *                  *---------------------------------------------*
      *                  * Incremento numero documento                 *
      *                  *---------------------------------------------*
           add       1                    to   w-det-buc-num-num      .
           move      w-det-buc-num-num    to   w-det-buc-num-pre      .
      *                  *---------------------------------------------*
      *                  * Test di confronto                           *
      *                  *---------------------------------------------*
           if        w-det-buc-num-num    =    w-det-prt-fit-num
      ...
      *                  *---------------------------------------------*
           move      w-det-prt-fit-num    to   w-det-buc-num-num      .
      *                  *---------------------------------------------*
      *                  * Editing numero previsto                     *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      06                   to   p-car                  .
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-det-buc-num-pre    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                        using  p                      .
      *                  *---------------------------------------------*
      *                  * Messaggio di avviso                         *
      *                  *---------------------------------------------*
           ...
           move      "del"                to   w-all-str-cat (3)      .
           move      w-inp-ven-dat-doc    to   w-all-str-cat (4)      .
           move      "non in sequenza numerica: previsto:"
                                          to   w-all-str-cat (5)      .
      ...
      *
           ...
           perform   wrt-msg-err-000      thru wrt-msg-err-999        .
      *                  *---------------------------------------------*
      *                  * Ad aggiornamento [ddx]                      *
      *                  *---------------------------------------------*
           go to     prn-liv-det-ven-800.
       prn-liv-det-ven-800.
      *              *-------------------------------------------------*
      *              * Aggiornamento archivio [ddx]                    *
      *              *-------------------------------------------------*
           move      w-inp-ven-dat-doc    to   w-gen-agg-ddx-dat      .
           move      w-inp-ven-sdi-esi    to   w-gen-agg-ddx-sts      .
           move      w-inp-ven-sdi-fil    to   w-gen-agg-ddx-sdi      .
           perform   upd-rec-ddx-000      thru upd-rec-ddx-999        .
       prn-liv-det-ven-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-liv-det-ven-999.
       prn-liv-det-ven-999.
           exit.
      ...
      *                  * Test preliminari                            *
      *                  *---------------------------------------------*
           if        w-inp-cee-dat-doc    =    spaces or
                     w-inp-cee-num-doc    =    spaces
                     go to prn-liv-det-cee-320.
      *                  *---------------------------------------------*
      *                  * Subroutine                                  *
      *                  *---------------------------------------------*
           move      w-inp-cee-num-doc    to   w-det-prt-fit-ndo      .
           move      w-inp-cee-dat-doc    to   w-det-prt-fit-ddo      .
           perform   det-prt-fit-000      thru det-prt-fit-999        .
      *                  *---------------------------------------------*
      *                  * Test su esito determinazione                *
      *                  *---------------------------------------------*
           if        w-det-prt-fit-prt    not  = zero
                     go to prn-liv-det-cee-400.
       prn-liv-det-cee-320.
      *                  *---------------------------------------------*
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           ...
           move      05                   to   w-all-str-num          .
           move      "Documento nr. "     to   w-all-str-cat (1)      .
           move      w-inp-cee-num-doc    to   w-all-str-cat (2)      .
           move      "del"                to   w-all-str-cat (3)      .
           move      w-inp-cee-dat-doc    to   w-all-str-cat (4)      .
           move      "non trovato in archivio !"
                                          to   w-all-str-cat (5)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
      ...
      *              * Aggiornamento archivio [ddx]                    *
      *              *-------------------------------------------------*
           move      w-inp-cee-dat-doc    to   w-gen-agg-ddx-dat      .
           move      w-inp-cee-sdi-sts    to   w-gen-agg-ddx-sts      .
           move      w-inp-cee-sdi-fil    to   w-gen-agg-ddx-sdi      .
           perform   upd-rec-ddx-000      thru upd-rec-ddx-999        .
       prn-liv-det-cee-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-liv-det-cee-999.
       prn-liv-det-cee-999.
           exit.
      ...
      *    * ---------------                                           *
      *    *                                                           *
      *    * - Per le numerazioni con separatori o sigle potrebbe NON  *
      *    *   essere rilevato il protocollo corretto                  *
      *    *                                                           *
      *    * - Se esistono numeri fattura uguali in virtu' della sigla *
      *    *   numerazione, a parita' di data, il protocollo non puo'  *
      *    *   essere rilevato                                         *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       det-prt-fit-000.
      ...
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      10                   to   v-car                  .
           move      w-det-prt-fit-ndo    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-det-prt-fit-num      .
      *                  *---------------------------------------------*
      *                  * Data documento (da GG/MM/AAAA)              *
      *                  *---------------------------------------------*
           move      w-det-prt-fit-ddo
                    (01 : 02)             to   s-gio                  .
           move      w-det-prt-fit-ddo
                    (04 : 02)             to   s-mes                  .
           move      w-det-prt-fit-ddo
           ...
           move      1                    to   s-sec                  .
      *
           move      s-dat                to   w-det-prt-fit-ddc      .
      *                  *---------------------------------------------*
      *                  * Codice dipendenza                           *
      *                  *---------------------------------------------*
           move      01                   to   w-det-prt-fit-dpz      .
       det-prt-fit-100.
      *              *-------------------------------------------------*
      *              * Start su file [fit]                             *
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-det-prt-fit-ddc    to   rf-fit-dat-doc         .
           move      w-det-prt-fit-dpz    to   rf-fit-cod-dpz         .
           move      spaces               to   rf-fit-num-doc         .
      ...
      *              *-------------------------------------------------*
           if        rf-fit-dat-doc       not  = w-det-prt-fit-ddc or
                     rf-fit-cod-dpz       not  = w-det-prt-fit-dpz
                     go to det-prt-fit-500.
       det-prt-fit-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-fit-num-doc
                    (06 : 06)             to   w-det-prt-fit-nmw      .
           if        w-det-prt-fit-nmw    =    w-det-prt-fit-num
                     go to det-prt-fit-500
           else      go to det-prt-fit-200.
       det-prt-fit-500.
      *              *-------------------------------------------------*
      *              * Bufferizzazione                                 *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Determinazione numero distinta                            *
      *    *-----------------------------------------------------------*
       det-dst-num-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-det-dst-num-prg      .
       det-dst-num-100.
      *              *-------------------------------------------------*
      *              * Start su [ddx]                                  *
      *              *-------------------------------------------------*
      ...
      *                  * Progressivo                                 *
      *                  *---------------------------------------------*
           move      rf-ddx-num-prg       to   w-det-dst-num-prg      .
       det-dst-num-800.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "DOCDST"             to   f-key                  .
           move      w-det-prt-fit-prt    to   rf-ddx-prt-doc         .
           move      w-det-dst-num-dst    to   rf-ddx-num-dst         .
           move      w-det-dst-num-prg    to   rf-ddx-num-prg         .
           move      "pgm/fat/fls/ioc/obj/iofddx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                =    e-not-err
                     go to upd-rec-ddx-200.
      *                  *---------------------------------------------*
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Aggiornamento distinta non riuscito!"
                                          to   w-wrt-msg-err-msg      .
           perform   wrt-msg-err-000      thru wrt-msg-err-999        .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     upd-rec-ddx-900.
       upd-rec-ddx-200.
      *              *-------------------------------------------------*
      *              * Se record esistente                             *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      1                    to   s-sec                  .
      *
           move      s-dat                to   rf-ddx-dat-sdi         . 
      *                      *-----------------------------------------*
      *                      * ID consegna a SDI                       *
      *                      *-----------------------------------------*
           move      w-gen-agg-ddx-sdi    to   rf-ddx-ide-sdi         . 
      *                      *-----------------------------------------*
      *                      * Esito consegna a SDI                    *
      *                      *-----------------------------------------*
           move      w-gen-agg-ddx-sts    to   rf-ddx-esi-sdi         . 
       upd-rec-ddx-300.
      *                  *---------------------------------------------*
      *                  * Update record [ddx]                         *
      *                  *---------------------------------------------*
