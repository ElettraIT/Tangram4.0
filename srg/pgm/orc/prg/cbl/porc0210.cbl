      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella condizioni di ven-   *
      *                    dita                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " INTERROGAZIONE SU CONDIZIONI DI VENDITA"       .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella condizioni di vendita"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-zcv-cod      .
           move      12                   to   w-cod-mne-zcv-lin      .
       ...
       acc-cod-min-120.
           move      w-cod-mne-zcv-cod    to   v-alf                  .
       acc-cod-min-150.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zcv-ope      .
           move      rr-cod-max           to   w-cod-mne-zcv-cod      .
           move      12                   to   w-cod-mne-zcv-lin      .
           move      52                   to   w-cod-mne-zcv-pos      .
           move      zero                 to   w-cod-mne-zcv-dln      .
           move      zero                 to   w-cod-mne-zcv-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zcv-cod-cdv         .
           move      "pgm/orc/fls/ioc/obj/iofzcv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-zcv-des-key         .
           move      spaces               to   rf-zcv-cod-cdv         .
           move      "pgm/orc/fls/ioc/obj/iofzcv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zcv]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/orc/fls/ioc/obj/iofzcv"
                                          to   s-pat                  .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zcv-cod-cdv       <    rr-cod-min or
                     rf-zcv-cod-cdv       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zcv-des-key       <    rr-des-min or
                     rf-zcv-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        rf-zcv-rig-cdv (2)   =    spaces
                     move   1             to   w-wrk-res-des
           else if   rf-zcv-rig-cdv (3)   =    spaces
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      22                   to   v-pos                  .
           move      rf-zcv-rig-cdv (1)   to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zcv-cod-cdv       to   w-mpn-cod-cdv          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      22                   to   v-pos                  .
           move      rf-zcv-rig-cdv (2)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           if        rf-zcv-rig-cdv (3)   =    spaces
                     go to qry-liv-det-999.
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      22                   to   v-pos                  .
           move      rf-zcv-rig-cdv (3)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-cdv'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
