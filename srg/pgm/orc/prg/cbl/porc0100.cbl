      ...
      *                       Ultima revisione:    NdK del 05/11/12    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione Tipi movimento ordini clienti      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   TIPI MOVIMENTO PER ORDINI CLIENTI    "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-toc          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-key          pic  x(30)                  .
               10  w-tes-des-toc          pic  x(30)                  .
               10  w-tes-pwd-toc          pic  x(08)                  .
           ...
           05  w-exp-tip-ord.
               ...
               10  w-exp-tip-ord-tbl.
                   15  filler             pic  x(40) value
                            "Normale                                 ".
                   15  filler             pic  x(40) value
                            "Pro-forma (non impegna il magazzino)    ".
                   15  filler             pic  x(40) value
                            "Forecast  (previsionale)                ".
                   15  filler             pic  x(40) value
                            "Contratto (non impegna il magazzino)    ".
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-org-doc.
               ...
               10  w-exp-org-doc-lun      pic  9(02)       value 30   .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-def-tar.
               10  w-exp-def-tar-num      pic  9(02)       value 2    .
               10  w-exp-def-tar-lun      pic  9(02)       value 30   .
               10  w-exp-def-tar-tbl.
                   ...
                   15  filler             pic  x(30) value
                            "Dipendenze                    "          .
      *        *-------------------------------------------------------*
      *        * Work per : Si/No stampa totale ordine                 *
      *        *-------------------------------------------------------*
           05  w-exp-snx-sto.
               10  w-exp-snx-sto-num      pic  9(02)       value 4    .
               10  w-exp-snx-sto-lun      pic  9(02)       value 40   .
               10  w-exp-snx-sto-tbl.
                   15  filler             pic  x(40) value
                            "si, totale Merce                        ".
                   15  filler             pic  x(40) value
                            "si, totale merce, Sconto e netto        ".
                   15  filler             pic  x(40) value
                            "si, totale Imponibile                   ".
                   15  filler             pic  x(40) value
                            "No                                      ".
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-snx-age.
               ...
               10  w-exp-snx-age-lun      pic  9(02)       value 30   .
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Formato di stampa data consegna            *
      *        *-------------------------------------------------------*
           05  w-exp-def-fds.
               10  w-exp-def-fds-num      pic  9(02)       value 5    .
               10  w-exp-def-fds-lun      pic  9(02)       value 30   .
               10  w-exp-def-fds-tbl.
                   15  filler             pic  x(30) value
                            "nessun Default                "          .
                   15  filler             pic  x(30) value
                            "formato GG/MM/AA              "          .
      ...
      *              * Codice tipo movimento                           *
      *              *-------------------------------------------------*
           perform   vis-cod-toc-000      thru vis-cod-toc-999        .
       vis-key-reg-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-toc        to   w-cod-des-zoc-cod      .
           move      04                   to   w-cod-des-zoc-lin      .
           move      30                   to   w-cod-des-zoc-pos      .
           move      06                   to   w-cod-des-zoc-dln      .
           move      30                   to   w-cod-des-zoc-dps      .
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-toc        to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           perform   acc-des-toc-000      thru acc-des-toc-999        .
           if        v-key                =    "NXSC"
      ...
      *                  *---------------------------------------------*
           perform   acc-pwd-toc-000      thru acc-pwd-toc-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  *---------------------------------------------*
       ...
       acc-tes-reg-230.
      *                  *---------------------------------------------*
      *                  * Default per accettazione formato data       *
      *                  *---------------------------------------------*
           perform   acc-def-fds-000      thru acc-def-fds-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        v-key                =    "PRSC"
                     move  "-"            to   w-cnt-tus-acc-tes      .
      ...
      *              * Descrizione tipo movimento                      *
      *              *-------------------------------------------------*
           perform   vis-des-toc-000      thru vis-des-toc-999        .
      *              *-------------------------------------------------*
      *              * Descrizione per la stampa                       *
      *              *-------------------------------------------------*
      ...
      *              * Password per il movimento                       *
      *              *-------------------------------------------------*
           perform   vis-pwd-toc-000      thru vis-pwd-toc-999        .
      *              *-------------------------------------------------*
      *              * Tipo ordine                                     *
      *              *-------------------------------------------------*
      ...
      *              * Default per accettazione formato data           *
      *              *-------------------------------------------------*
           perform   vis-def-fds-000      thru vis-def-fds-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     vis-tes-reg-999.
      ...
      *              * Descrizione tipo movimento                      *
      *              *-------------------------------------------------*
           perform   pmt-des-toc-000      thru pmt-des-toc-999        .
      *              *-------------------------------------------------*
      *              * Descrizione per la stampa                       *
      *              *-------------------------------------------------*
      ...
      *              * Password per il movimento                       *
      *              *-------------------------------------------------*
           perform   pmt-pwd-toc-000      thru pmt-pwd-toc-999        .
      *              *-------------------------------------------------*
      *              * Tipo ordine                                     *
      *              *-------------------------------------------------*
      ...
      *              * Default per accettazione formato data           *
      *              *-------------------------------------------------*
           perform   pmt-def-fds-000      thru pmt-def-fds-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     pmt-tes-reg-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Default per accettazione formato *
      *    *                          data consegna                    *
      *    *-----------------------------------------------------------*
       pmt-def-fds-000.
           move      "DS"                 to   v-ope                  .
           ...
           move      17                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipo stampa data proposto  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-def-fds-999.
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-toc (1)    =    spaces
                     go to acc-des-toc-100.
       acc-des-toc-450.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-des-toc (1)    to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-des-toc (1)    to   w-tes-des-stp (1)      .
       acc-des-stp-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           go to     acc-pwd-toc-999.
       acc-pwd-toc-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Password tipo movimento   *
      *    *-----------------------------------------------------------*
       vis-pwd-toc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *
           if        w-tes-tip-ord (1)    =    spaces
                     move  01             to   v-num
           else if   w-tes-tip-ord (1)    =    "P"
                     move  02             to   v-num
           else if   w-tes-tip-ord (1)    =    "F"
                     move  03             to   v-num
           else if   w-tes-tip-ord (1)    =    "C"
                     move  04             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  "P"            to   w-tes-tip-ord (1)
           else if   v-num                =    03
                     move  "F"            to   w-tes-tip-ord (1)
           else if   v-num                =    04
                     move  "C"            to   w-tes-tip-ord (1)
      ...
      *                  *---------------------------------------------*
           if        w-cnt-mfu-tip-fun    =    "I"    and
                     w-tes-tip-ord (1)    =    "P"    and
                     w-tes-sgl-num (1)    =    spaces
                     move  "OFF"          to   w-tes-sgl-num (1)      .
           if        w-cnt-mfu-tip-fun    =    "I"    and
                     w-tes-tip-ord (1)    =    "F"    and
                     w-tes-sgl-num (1)    =    spaces
                     move  "FOR"          to   w-tes-sgl-num (1)      .
           if        w-cnt-mfu-tip-fun    =    "I"    and
                     w-tes-tip-ord (1)    =    "C"    and
                     w-tes-sgl-num (1)    =    spaces
                     move  "CON"          to   w-tes-sgl-num (1)      .
       acc-sgl-num-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *
           if        w-tes-snx-sto (1)    =    "S"
                     move  01             to   v-num
           else if   w-tes-snx-sto (1)    =    "X"
                     move  02             to   v-num
           else if   w-tes-snx-sto (1)    =    "I"
                     move  03             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  "X"            to   w-tes-snx-sto (1)
           else if   v-num                =    03
                     move  "I"            to   w-tes-snx-sto (1)
           else if   v-num                =    04
      ...
      *    *===========================================================*
      *    * Accettazione campo : Default formato di stampa data cons. *
      *    *-----------------------------------------------------------*
       acc-def-fds-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-def-fds-lun    to   v-car                  .
           move      w-exp-def-fds-num    to   v-ldt                  .
           move      "DGMNS#"             to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      17                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-def-fds-tbl    to   v-txt                  .
      *
           add       1                    to   w-tes-def-fds (1)
                                        giving v-num                  .
      *
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-def-fds-100.
       acc-def-fds-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Default formato di stampa data    *
      *    *                         consegna                          *
      *    *-----------------------------------------------------------*
       vis-def-fds-000.
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-nok-100.
      *              *-------------------------------------------------*
      *              * Controllo default tipo riga                     *
      *              *-------------------------------------------------*
           if        w-tes-def-tpr (1)    =    spaces or
                     w-tes-def-tpr (1)    =    "P    "
                     go to cnt-tdo-nok-600.
           move      "Tipo riga proposto incorretto !                   
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           ...
           move      spaces               to   w-tes-des-toc (1)      .
           move      spaces               to   w-tes-pwd-toc (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-toc        to   rf-zoc-cod-toc         .
           move      "pgm/orc/fls/ioc/obj/iofzoc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zoc]                        *
      *                          *-------------------------------------*
           move      rf-zoc-des-key       to   w-tes-des-key (1)      .
           move      rf-zoc-des-toc       to   w-tes-des-toc (1)      .
           move      rf-zoc-pwd-toc       to   w-tes-pwd-toc (1)      .
           move      rf-zoc-vld-dpz       to   w-tes-vld-dpz (1)      .
           move      rf-zoc-cod-dpz       to   w-tes-cod-dpz (1)      .
           move      rf-zoc-org-doc       to   w-tes-org-doc (1)      .
           move      rf-zoc-prv-doc       to   w-tes-prv-doc (1)      .
           move      rf-zoc-sgl-num       to   w-tes-sgl-num (1)      .
           move      rf-zoc-des-stp       to   w-tes-des-stp (1)      .
           move      rf-zoc-snx-prz       to   w-tes-snx-prz (1)      .
           move      rf-zoc-snx-sco       to   w-tes-snx-sco (1)      .
           move      rf-zoc-snx-dtc       to   w-tes-snx-dtc (1)      .
           move      rf-zoc-snx-sto       to   w-tes-snx-sto (1)      .
           move      rf-zoc-def-tpr       to   w-tes-def-tpr (1)      .
           move      rf-zoc-snx-age       to   w-tes-snx-age (1)      .
           move      rf-zoc-tip-ord       to   w-tes-tip-ord (1)      .
      *
           move      rf-zoc-def-fds       to   w-tes-def-fds (1)      .
           if        w-tes-def-fds (1)    not  numeric
                     move  zero           to   w-tes-def-fds (1)      .
      *
           move      rf-zoc-def-tar       to   w-tes-def-tar (1)      .
           if        w-tes-def-tar (1)    =    spaces
                     move  "C"            to   w-tes-def-tar (1)      .
      *
           move      rf-zoc-alx-exp       to   w-tes-alx-exp (1)      .
      *                              *---------------------------------*
      *                              * Lettura archivio [ada]          *
      *                              *---------------------------------*
           move      w-tes-cod-dpz (1)    to   w-let-arc-ada-cod      .
      ...
      *                      * Write record [zoc]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zoc-000      thru wrt-rec-zoc-999        .
      ...
      *                      * Rewrite record [zoc]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zoc-000      thru rew-rec-zoc-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zoc]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zoc-000      thru del-rec-zoc-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zoc]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zoc-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-key (1)    to   rf-zoc-des-key         .
           move      w-tes-des-toc (1)    to   rf-zoc-des-toc         .
           move      w-tes-pwd-toc (1)    to   rf-zoc-pwd-toc         .
           move      w-tes-vld-dpz (1)    to   rf-zoc-vld-dpz         .
           move      w-tes-cod-dpz (1)    to   rf-zoc-cod-dpz         .
           move      w-tes-org-doc (1)    to   rf-zoc-org-doc         .
           move      w-tes-prv-doc (1)    to   rf-zoc-prv-doc         .
           move      w-tes-sgl-num (1)    to   rf-zoc-sgl-num         .
           move      w-tes-des-stp (1)    to   rf-zoc-des-stp         .
           move      w-tes-snx-prz (1)    to   rf-zoc-snx-prz         .
           move      w-tes-snx-sco (1)    to   rf-zoc-snx-sco         .
           move      w-tes-snx-dtc (1)    to   rf-zoc-snx-dtc         .
           move      w-tes-snx-sto (1)    to   rf-zoc-snx-sto         .
           move      w-tes-def-tpr (1)    to   rf-zoc-def-tpr         .
           move      w-tes-snx-age (1)    to   rf-zoc-snx-age         .
           move      w-tes-tip-ord (1)    to   rf-zoc-tip-ord         .
           move      w-tes-def-fds (1)    to   rf-zoc-def-fds         .
           move      w-tes-def-tar (1)    to   rf-zoc-def-tar         .
           move      w-tes-alx-exp (1)    to   rf-zoc-alx-exp         .
       cmp-rec-zoc-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zoc]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zoc-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zoc-000      thru cmp-rec-zoc-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
