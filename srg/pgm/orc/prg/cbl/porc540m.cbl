      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione overlay per il programma orc540  *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [oce]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-oce.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-oce-prt      pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Progressivo                                       *
      *            *---------------------------------------------------*
               10  w-cmp-rec-oce-prg      pic  9(05)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "GESTIONE DISTINTA"  to   w-all-str-cat (1)      .
           move      v-edt                to   w-all-str-cat (2)      .
           move      "INVIO ORDINI"       to   w-all-str-cat (3)      .
      ...
      *                  *---------------------------------------------*
           move      rf-oce-num-doc       to   w-all-str-alf          .
           move      "_"                  to   w-all-str-del          .
           perform   all-str-ext-000      thru all-str-ext-999        .
      *
           if        w-all-str-num        =    3
                     move  w-all-str-cat (3)
                                          to   w-lin-imm-num-doc
           else      move  rf-oce-num-doc to   w-lin-imm-num-doc      .
      *
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Scorporo numero documento                   *
      *                  *---------------------------------------------*
           move      rf-oce-num-doc       to   w-all-str-alf          .
           move      "_"                  to   w-all-str-del          .
           perform   all-str-ext-000      thru all-str-ext-999        .
      *
           move      w-all-str-cat (3)    to   w-all-str-cat (2)      .
      *                  *---------------------------------------------*
      *                  * Assemblaggio                                *
      *                  *---------------------------------------------*
           move      50                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      rf-oce-tmo-doc       to   w-all-str-cat (1)      .
      ...
      *                  *---------------------------------------------*
       ...
       vis-est-doc-500.
      *              *-------------------------------------------------*
      *              * Eventuale codice EDI                            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su codice EDI                          *
      *                  *---------------------------------------------*
           if        rf-oce-cod-edi       =    spaces
                     go to vis-est-doc-900.
      *                  *---------------------------------------------*
      *                  * Assemblaggio                                *
      *                  *---------------------------------------------*
           move      20                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      "{EDI="              to   w-all-str-cat (01)     .
           move      rf-oce-cod-edi       to   w-all-str-cat (02)     .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [oce]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/orc/fls/ioc/obj/iofoce"
                                          to   s-pat                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-oce-dat-doc       to   srt-dat-key            .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-oce-cod-arc       to   srt-cod-key            .
           move      spaces               to   srt-rag-key            .
      *                      *-----------------------------------------*
      *                      * Oltre                                   *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      zero                 to   srt-cod-key            .
      *
           move      rf-oce-cod-arc       to   w-let-arc-dcc-cli      .
           move      rf-oce-dpz-arc       to   w-let-arc-dcc-dpz      .
      ...
      *                      *-----------------------------------------*
           move      rf-oce-prt-doc       to   srt-prt-key            .
           move      zero                 to   srt-dat-key            .
           move      zero                 to   srt-cod-key            .
           move      spaces               to   srt-rag-key            .
      *                      *-----------------------------------------*
      ...
      *                  * Record [oce]                                *
      *                  *---------------------------------------------*
           move      rf-oce               to   w-rig-rec-oce          .
           move      rf-oce-cod-arc       to   w-rig-cod-cli          .
           move      rf-oce-dpz-arc       to   w-rig-dpz-cli          .
      *
           if        rf-oce-flg-ain       =    spaces
                     move  "S"            to   w-rig-snx-inv
           else      move  "N"            to   w-rig-snx-inv          .
      *
           move      rf-oce-eml-ind       to   w-rig-ind-eml          .
      *
           if        rf-oce-eml-ind       =    spaces
                     move  "N"            to   w-rig-snx-inv          .
      *                  *---------------------------------------------*
      *                  * Valori indiretti                            *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           else      move  "#"            to   rf-oce-flg-ain         .
      *              *-------------------------------------------------*
      *              * Aggiornamento indirizzo mail                    *
      *              *-------------------------------------------------*
           if        w-rig-ind-eml        not  = spaces
                     move  w-rig-ind-eml  to   rf-oce-eml-ind         .
      *              *-------------------------------------------------*
      *              * Update record [oce]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/orc/prg/obj/porc5402"                       .
       cnc-rlt-sup-999.
           exit.
