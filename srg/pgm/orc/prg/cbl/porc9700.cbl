      ...
      *                                   Fase:    orc970              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 25/01/01    *
      *                       Ultima revisione:    NdK del 07/06/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Convalida ordine pro-forma                  *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-pre-acc-mod      .
      *              *-------------------------------------------------*
      *              * Default per cliente subentrante                 *
      *              *-------------------------------------------------*
           move      w-tes-cli-org (1)    to   w-tes-cli-sbt (1)      .
           move      w-tes-cli-org-rag (1)
                                          to   w-tes-cli-sbt-rag (1)  .
           move      w-tes-cli-org-via (1)
                                          to   w-tes-cli-sbt-via (1)  .
           move      w-tes-cli-org-loc (1)
                                          to   w-tes-cli-sbt-loc (1)  .
      *              *-------------------------------------------------*
      *              * Codice cliente subentrante                      *
      *              *-------------------------------------------------*
           perform   vis-cli-sbt-000      thru vis-cli-sbt-999        .
      ...
      *                  * Sigla numerazione                           *
      *                  *---------------------------------------------*
           move      w-tes-tmo-orc-sgl    to   rf-oct-sgl-num         .
      *                  *---------------------------------------------*
      *                  * Codice archivio                             *
      *                  *---------------------------------------------*
