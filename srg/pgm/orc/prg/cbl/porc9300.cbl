      ...
      *                                   Fase:    orc930              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 29/09/97    *
      ...
      *                    fica prodotto                               *
      *                                                                *
      *                    N.B.: implementazione parziale              *
      *                                                                *
      *                    Vedi 'pagb1200' e riposizionare in 'orc530' *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      "Nessuna riga ordine aggiornata!"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
      *
      ...
      *                          * Test se diverso                     *
      *                          *-------------------------------------*
           if        rf-ocr-cod-iva       =    rf-dcp-cod-iva
                     go to prn-liv-det-820.
      *                          *-------------------------------------*
      *                          * Aggiornamento                       *
      *                          *-------------------------------------*
