      ...
      *                                   Fase:    orc300g             *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 07/01/09    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Generazione righe ordine da filtro prodotti *
      *                                                                *
      *                    Richiamata in orc300 da funzione 'PF1'      *
      *                                                                *
      *                    ___ **************** ___                    *
      *                    ___ MAI IMPLEMENTATO ___                    *
      *                    ___ **************** ___                    *
      *                                                                *
      *================================================================*
      *                                                                *
      ...
      *                                     #     : No                 *
      *                                                                *
      * "CF" - Accettazione dati identificativi filtro                 *
      *                                                                *
      *        Input  : l-dup-rdo-tip-ope = "CF"                       *
      *                 l-dup-rdo-tmo-orc = codice tipo movimento or-  *
      ...
      *        *-------------------------------------------------------*
           05  l-dup-rdo-tmo-orc          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Flag di trattamento ordine                            *
      *        *-------------------------------------------------------*
           05  l-dup-rdo-flg-orc          pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *              * mento ordine                                    *
      *              *-------------------------------------------------*
           move      l-dup-rdo-tmo-orc    to   w-acc-tmo-orc          .
      ...
      *                  *---------------------------------------------*
           move      w-acc-tmo-orc        to   l-dup-rdo-tmo-orc      .
       acc-tmo-orc-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Conversione da altra valuta a valuta base                 *
      *    *-----------------------------------------------------------*
