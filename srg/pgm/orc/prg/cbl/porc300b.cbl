      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Duplicazione righe da ordine a Fornitore    *
      *                                                                *
      *                    Richiamata in orc300 con 'F1'               *
      *                                                                *
      *================================================================*
      *                                                                *
      * Tipi operazione                                                *
      ...
      *                                                                *
      *        Input  : l-dup-rof-tip-ope = "OP"                       *
      *                 l-dup-rof-cod-dpz = codice dipendenza in uso   *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      * "CL" - Close, fine utilizzo                                    *
      *                                                                *
      *        Input  : l-dup-rof-tip-ope = "CL"                       *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      * "C?" - Test se modulo cancellabile                             *
      *                                                                *
      *        Input  : l-dup-rof-tip-ope = "C?"                       *
      *                                                                *
      *        Output : l-dup-rof-exi-sts = spaces: Si                 *
      *                                     #     : No                 *
      *                                                                *
      * "RO" - Accettazione dati identificativi ordine                 *
      *                                                                *
      *        Input  : l-dup-rof-tip-ope = "RO"                       *
      *                 l-dup-rof-tmo-orf = codice tipo movimento or-  *
      *                                     dine da proporre come de-  *
      *                                     fault                      *
      *                                                                *
      *        Output : l-dup-rof-exi-sts = spaces: Accettazione ese-  *
      *                                             guita con successo *
      *                                     #     : Uscita per Exit    *
      *                                                                *
      * "SC" - Saldaconto per selezione righe ordine                   *
      *                                                                *
      *        Input  : l-dup-rof-tip-ope = "SC"                       *
      *                                                                *
      *        Output : l-dup-rof-exi-sts = spaces: Tutto Ok           *
      *                                     #     : Uscita per Exit    *
      *                                                                *
      * "CC" - Caricamento righe ordine selezionate in catena          *
      *                                                                *
      *        Input  : l-dup-rof-tip-ope = "CC"                       *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      *================================================================*
      ...
      *    * da ordine a fornitore                                     *
      *    *-----------------------------------------------------------*
       01  l-dup-rof.
      *        *-------------------------------------------------------*
      *        * Tipo operazione                                       *
      *        *-------------------------------------------------------*
           05  l-dup-rof-tip-ope          pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Return status code                                    *
      *        * - Spaces : operazione eseguita                        *
      *        * - #      : errore di esecuzione                       *
      *        *-------------------------------------------------------*
           05  l-dup-rof-exi-sts          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Codice dipendenza in uso                              *
      *        *-------------------------------------------------------*
           05  l-dup-rof-cod-dpz          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Default per codice tipo movimento ordine              *
      *        *-------------------------------------------------------*
           05  l-dup-rof-tmo-orf          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Flag di trattamento ordine                            *
      *        *-------------------------------------------------------*
           05  l-dup-rof-flg-orf          pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      ******************************************************************
       Procedure Division                using l-dup-rof
                                               w-prs
                                               w-tes
                                               w-pie
                                               w-rig
      ...
      *              *-------------------------------------------------*
           move      spaces               to   l-dup-rof-exi-sts      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      l-dup-rof-cod-dpz    to   w-acc-cod-dpz          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-gen-ctr-opn        =    zero
                     move  spaces         to   l-dup-rof-exi-sts
           else      move  "#"            to   l-dup-rof-exi-sts      .
       tst-cnc-mod-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      12                   to   v-lin                  .
           move      22                   to   v-pos                  .
           move      "DUPLICAZIONE RIGHE DA ORDINE FORNITORE"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              * mento ordine                                    *
      *              *-------------------------------------------------*
           move      l-dup-rof-tmo-orf    to   w-acc-tmo-orf          .
      ...
      *                  *---------------------------------------------*
           move      w-acc-tmo-orf        to   l-dup-rof-tmo-orf      .
       acc-tmo-orf-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *                          * Bufferizzazione                     *
      *                          *-------------------------------------*
           move      rf-ofr-num-mag       to   w-rig-num-pro (1)      .
       car-rig-cat-350.
      *                      *-----------------------------------------*
      ...
      *                          * Bufferizzazione                     *
      *                          *-------------------------------------*
           move      rf-ofr-alf-mag       to   w-rig-alf-pro (1)      .
       car-rig-cat-360.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-bro-qta-dup
                    (w-car-rig-cat-ctr)   to   w-rig-qta-ord (1)      .
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-tes-ocl-dat (1)    not  = zero
                     move  w-tes-ocl-dat (1)
                                          to   d-prz-ven-dat-rfp
           else      move  w-tes-dat-doc  to   d-prz-ven-dat-rfp      .
           move      w-rig-qta-ord (1)    to   d-prz-ven-qta-rif      .
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-tes-ocl-dat (1)    not  = zero
                     move  w-tes-ocl-dat (1)
                                          to   d-per-scr-dat-rif
           else      move  w-tes-dat-doc  to   d-per-scr-dat-rif      .
      *                              *---------------------------------*
      *                              * Richiamo del sottoprogramma     *
      *                              *---------------------------------*
