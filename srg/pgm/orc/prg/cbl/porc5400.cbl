      ...
      *                       Ultima revisione:    NdK del 10/06/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma di stampa orc540 *
      *                    Stampa distinte di invio                    *
      *                                                                *
      *                    Le overlay eseguono le seguenti funzioni :  *
      *                    ------------------------------------------  *
      *                    porc5400 - Main                             *
      *                    porc540a - Creazione Distinta di invio      *
      *                    porc540b - Stampa Distinta                  *
      *                    porc540m - Manutenzione distinta            *
      *                    porc540c - Generazione documenti PDF        *
      *                    porc540d - Invio o re-invio documenti PDF   *
      *                    porc540e - Cancellazione Distinta           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [zro]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-zro.
               10  w-let-arc-zro-flg      pic  x(01)                  .
               10  w-let-arc-zro-cod      pic  9(05)                  .
               10  w-let-arc-zro-des      pic  x(40)                  .
           ...
           05  w-exp-tip-ope.
               ...
               10  w-exp-tip-ope-tbl.
                   15  filler             pic  x(40) value
                            "1. Creazione distinta conferme ordine   ".
                   15  filler             pic  x(40) value
                            "2. Stampa distinta                      ".
                   15  filler             pic  x(40) value
                            "3. Manutenzione distinta                ".
                   15  filler             pic  x(40) value
                            "4. Generazione documenti da inviare     ".
                   15  filler             pic  x(40) value
                            "5. Invio conferme ordine                ".
                   15  filler             pic  x(40) value
                            "6. Re-invio conferme ordine             ".
                   15  filler             pic  x(40) value
      ...
      *        *-------------------------------------------------------*
           05  w-exp-snx-oav.
               ...
               10  w-exp-snx-oav-tbl.
                   ...
                   15  filler             pic  x(02) value "No"       .
      *        *-------------------------------------------------------*
      *        * Work per : Selezione su stampa prezzi                 *
      *        *-------------------------------------------------------*
           05  w-exp-snx-nsp.
               10  w-exp-snx-nsp-num      pic  9(02)       value 2    .
               10  w-exp-snx-nsp-lun      pic  9(02)       value 40   .
               10  w-exp-snx-nsp-tbl.
                   15  filler             pic  x(40) value
                            "Solo ordini con SI in stampa prezzi     ".
                   15  filler             pic  x(40) value
                            "Nessuna selezione                       ".
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice responsabile ordine     *
      *    *-----------------------------------------------------------*
           copy      "pgm/orc/prg/cpy/acmnzro0.acl"                   .
      ...
      *              *-------------------------------------------------*
           if        rr-tip-ope           =    01
                     move  "pgm/orc/prg/obj/porc540a                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    02
                     move  "pgm/orc/prg/obj/porc540b                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    03
                     move  "pgm/orc/prg/obj/porc540m                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    04
                     move  "pgm/orc/prg/obj/porc540c                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    05
                     move  "pgm/orc/prg/obj/porc540d                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    06
                     move  "pgm/orc/prg/obj/porc540d                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    07
                     move  "pgm/orc/prg/obj/porc540e                "
                                          to   i-exe-pat              .
           call      i-exe-pat                                        .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Si/no accettazione codice responsabile      *
      *                  *---------------------------------------------*
           perform   prs-snx-rsp-000      thru prs-snx-rsp-999        .
      *                  *---------------------------------------------*
      *                  * Si/no selezione su stampa prezzi            *
      *                  *---------------------------------------------*
           perform   prs-snx-nsp-000      thru prs-snx-nsp-999        .
       pre-exe-pgm-820.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Lettura personalizzazione : Si/no accettazione codice     *
      *    *                             responsabile                  *
      *    *-----------------------------------------------------------*
       prs-snx-rsp-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/orc/ric/orc540[snx-rsp]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-prs-snx-rsp
           else      move  spaces         to   w-prs-snx-rsp          .
      *              *-------------------------------------------------*
      *              * Normalizzazione personalizzazione               *
      *              *-------------------------------------------------*
           if        w-prs-snx-rsp        not  = "S"
                     move  "N"            to   w-prs-snx-rsp          .
       prs-snx-rsp-999.
           exit.

      *    *===========================================================*
      *    * Lettura personalizzazione : Si/no selezione su stampa     *
      *    *                             prezzi                        *
      *    *-----------------------------------------------------------*
       prs-snx-nsp-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/orc/ric/orc540[snx-nsp]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-prs-snx-nsp
           else      move  spaces         to   w-prs-snx-nsp          .
      *              *-------------------------------------------------*
      *              * Normalizzazione personalizzazione               *
      *              *-------------------------------------------------*
           if        w-prs-snx-nsp        not  = "S"
                     move  "N"            to   w-prs-snx-nsp          .
       prs-snx-nsp-999.
           exit.
      ...
      *              * ordine                                          *
      *              *-------------------------------------------------*
           perform   cod-mne-zro-opn-000  thru cod-mne-zro-opn-999    .
      *              *-------------------------------------------------*
      *              * [oce]                                           *
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
      ...
      *              * ordine                                          *
      *              *-------------------------------------------------*
           perform   cod-mne-zro-cls-000  thru cod-mne-zro-cls-999    .
      *              *-------------------------------------------------*
      *              * [oce]                                           *
      *              *-------------------------------------------------*
           move      "CL"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-700.
      *                  *---------------------------------------------*
      *                  * Selezione su stampa prezzi                  *
      *                  *---------------------------------------------*
           perform   acc-snx-nsp-000      thru acc-snx-nsp-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           ...
           move      21                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su stampa prezzi :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ric-sel-900.
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-cod-des-zoc-lin      .
           move      30                   to   w-cod-des-zoc-pos      .
           move      11                   to   w-cod-des-zoc-dln      .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice responsabile                  *
      *    *-----------------------------------------------------------*
       acc-cod-rsp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zro-ope      .
           move      rr-cod-rsp           to   w-cod-mne-zro-cod      .
           move      17                   to   w-cod-mne-zro-lin      .
           move      30                   to   w-cod-mne-zro-pos      .
           move      17                   to   w-cod-mne-zro-dln      .
           move      41                   to   w-cod-mne-zro-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           ...
           if        w-cnt-sts-imp-ric    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
           perform   cod-mne-zro-cll-000  thru cod-mne-zro-cll-999    .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
           perform   cod-mne-zro-foi-000  thru cod-mne-zro-foi-999    .
       acc-cod-rsp-110.
           perform   cod-mne-zro-cll-000  thru cod-mne-zro-cll-999    .
           if        w-cod-mne-zro-ope    =    "F+"
                     go to acc-cod-rsp-115.
           if        w-cod-mne-zro-ope    =    "AC"
       ...
       acc-cod-rsp-120.
           move      w-cod-mne-zro-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
      ...
      *                  * Lettura file [zro]                          *
      *                  *---------------------------------------------*
           move      rr-cod-rsp           to   w-let-arc-zro-cod      .
           perform   let-arc-zro-000      thru let-arc-zro-999        .
           move      w-let-arc-zro-des    to   rr-cod-rsp-den         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione denominazione responsabile  *
      *                  *---------------------------------------------*
           perform   vis-cod-rsp-den-000  thru vis-cod-rsp-den-999    .
      *                  *---------------------------------------------*
      *                  * Se valore non esistente : reimpostazione    *
      *                  *---------------------------------------------*
           if        w-let-arc-zro-flg    not  = spaces
                     go to acc-cod-rsp-100.
      *                  *---------------------------------------------*
      *                  * Se valore zero                              *
      *                  *---------------------------------------------*
           if        rr-cod-rsp           not  = zero
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice responsabile                     *
      *    *-----------------------------------------------------------*
       vis-cod-rsp-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Selezione su stampa prezzi           *
      *    *-----------------------------------------------------------*
       acc-snx-nsp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-nsp-lun    to   v-car                  .
           move      w-exp-snx-nsp-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      21                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-nsp-tbl    to   v-txt                  .
           move      rr-snx-nsp           to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *                  * Se zero : reimpostazione                    *
      *                  *---------------------------------------------*
           if        rr-snx-nsp           not  = zero
                     go to acc-snx-nsp-600.
           if        v-key                =    "UP  "
                     go to acc-snx-nsp-600
           else      go to acc-snx-nsp-100.
       acc-snx-nsp-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      zero                 to   rr-cod-rsp             .
           move      spaces               to   rr-cod-rsp-den         .
      ...
      *              *-------------------------------------------------*
           ...
           move      999999999            to   rf-oce-num-dst         .
           move      99999                to   rf-oce-num-prg         .
           move      "pgm/orc/fls/ioc/obj/iofoce"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              * Valore determinato                              *
      *              *-------------------------------------------------*
           move      rf-oce-num-dst       to   w-det-ult-num-dst      .
       det-ult-num-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [oce]                         *
      *    *-----------------------------------------------------------*
       let-arc-dst-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "NUMDST    "         to   f-key                  .
           move      w-let-arc-dst-prt    to   rf-oce-num-dst         .
           move      "pgm/orc/fls/ioc/obj/iofoce"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       let-arc-dst-300.
      *              *-------------------------------------------------*
      *              * Max su [oce], se non superato : ad uscita       *
      *              *-------------------------------------------------*
           if        rf-oce-num-dst       not  = w-let-arc-dst-prt
                     go to let-arc-dst-900.
       let-arc-dst-400.
      *              *-------------------------------------------------*
      *              * Preparazione flag di uscita                     *
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [zro]                         *
      *    *-----------------------------------------------------------*
       let-arc-zro-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione marker di uscita                *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-zro-flg      .
      *              *-------------------------------------------------*
      *              * Test se codice a zero                           *
      *              *-------------------------------------------------*
           if        w-let-arc-zro-cod    =    zero
                     go to let-arc-zro-500.
      *              *-------------------------------------------------*
      *              * Lettura per codice                              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODRSP"             to   f-key                  .
           move      w-let-arc-zro-cod    to   rf-zro-cod-rsp         .
           move      "pgm/orc/fls/ioc/obj/iofzro"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-zro                 .
           if        f-sts                not  = e-not-err
                     go to let-arc-zro-400.
       let-arc-zro-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-zro-des-rsp       to   w-let-arc-zro-des      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     let-arc-zro-999.
       let-arc-zro-400.
      *              *-------------------------------------------------*
      *              * Azioni per record non trovato                   *
      *              *-------------------------------------------------*
           move      "#"                  to   w-let-arc-zro-flg      .
           move      all   "."            to   w-let-arc-zro-des      .
           go to     let-arc-zro-999.
       let-arc-zro-500.
      *              *-------------------------------------------------*
      *              * Normalizzazione work area                       *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-zro-des      .
       let-arc-zro-999.
           exit.
      ...
      *    * ordine                                                    *
      *    *-----------------------------------------------------------*
           copy      "pgm/orc/prg/cpy/acmnzro0.acs"                   .
