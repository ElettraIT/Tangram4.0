      ...
      *                                   Fase:    orc995              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 21/05/96    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione frammentazione ordini clienti      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " GESTIONE FRAMMENTAZIONE ORDINI CLIENTI "       .
      ...
      *                  * Numero frammento                            *
      *                  *---------------------------------------------*
           perform   acc-prg-frm-000      thru acc-prg-frm-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Numero frammento                                *
      *              *-------------------------------------------------*
           perform   vis-prg-frm-000      thru vis-prg-frm-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Numero frammento                            *
      *                  *---------------------------------------------*
           perform   pmt-prg-frm-000      thru pmt-prg-frm-999        .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per numero riga                   *
      *    *-----------------------------------------------------------*
       pmt-num-rig-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per numero frammento              *
      *    *-----------------------------------------------------------*
       pmt-prg-frm-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : tipo movimento             *
      *    *-----------------------------------------------------------*
       vis-tmo-orc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      w-acc-num-acc-prg    to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-acc-num-acc-prg      .
       acc-num-doc-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-acc-cod-dpz        to   w-acc-num-acc-dpz      .
           move      rf-oct-dat-doc       to   s-dat                  .
           move      s-saa                to   w-acc-num-acc-saa      .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Numero riga                   *
      *    *-----------------------------------------------------------*
       acc-num-rig-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Numero riga                *
      *    *-----------------------------------------------------------*
       vis-num-rig-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Numero frammento              *
      *    *-----------------------------------------------------------*
       acc-prg-frm-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-prg-frm-999.
       acc-prg-frm-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-acc-prg-frm          .
       acc-prg-frm-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Numero frammento           *
      *    *-----------------------------------------------------------*
       vis-prg-frm-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  * Data assegnata                              *
      *                  *---------------------------------------------*
           perform   acc-dat-ass-000      thru acc-dat-ass-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  *---------------------------------------------*
           perform   acc-prt-orf-000      thru acc-prt-orf-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  *---------------------------------------------*
           perform   acc-prg-orf-000      thru acc-prg-orf-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Data assegnata                                  *
      *              *-------------------------------------------------*
           perform   vis-dat-ass-000      thru vis-dat-ass-999        .
      *              *-------------------------------------------------*
      *              * Protocollo ordine fornitore                     *
      *              *-------------------------------------------------*
           perform   vis-prt-orf-000      thru vis-prt-orf-999        .
      *              *-------------------------------------------------*
      *              * Estremi ordine fornitore                        *
      *              *-------------------------------------------------*
           perform   vis-est-orf-000      thru vis-est-orf-999        .
      *              *-------------------------------------------------*
      *              * Progressivo riga ordine fornitore               *
      *              *-------------------------------------------------*
           perform   vis-prg-orf-000      thru vis-prg-orf-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     vis-tes-reg-999.
      ...
      *              * Quantita' assegnata                             *
      *              *-------------------------------------------------*
           perform   pmt-qta-ass-000      thru pmt-qta-ass-999        .
      *              *-------------------------------------------------*
      *              * Data assegnata                                  *
      *              *-------------------------------------------------*
           perform   pmt-dat-ass-000      thru pmt-dat-ass-999        .
      *              *-------------------------------------------------*
      *              * Protocollo ordine fornitore                     *
      *              *-------------------------------------------------*
           perform   pmt-prt-orf-000      thru pmt-prt-orf-999        .
      *              *-------------------------------------------------*
      *              * Progressivo riga ordine fornitore               *
      *              *-------------------------------------------------*
           perform   pmt-prg-orf-000      thru pmt-prg-orf-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     pmt-tes-reg-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Quantita' assegnata           *
      *    *-----------------------------------------------------------*
       pmt-qta-ass-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Data assegnata                *
      *    *-----------------------------------------------------------*
       pmt-dat-ass-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Protocollo ordine fornitore   *
      *    *-----------------------------------------------------------*
       pmt-prt-orf-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Progressivo ordine fornitore  *
      *    *-----------------------------------------------------------*
       pmt-prg-orf-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      14                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Progressivo ordine fornit. :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-prg-orf-999.
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Quantita' assegnata          *
      *    *-----------------------------------------------------------*
       acc-qta-ass-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Quantita' assegnata       *
      *    *-----------------------------------------------------------*
       vis-qta-ass-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-dat-ass-100.
       acc-dat-ass-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Data assegnata            *
      *    *-----------------------------------------------------------*
       vis-dat-ass-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Numero protocollo            *
      *    *-----------------------------------------------------------*
       acc-prt-orf-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-prt-orf-100.
       acc-prt-orf-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Numero protocollo         *
      *    *-----------------------------------------------------------*
       vis-prt-orf-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Estremi ordine            *
      *    *-----------------------------------------------------------*
       vis-est-orf-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Numero progressivo           *
      *    *-----------------------------------------------------------*
       acc-prg-orf-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-prg-orf-100.
       acc-prg-orf-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Numero progressivo        *
      *    *-----------------------------------------------------------*
       vis-prg-orf-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *              * Test                                            *
      *              *-------------------------------------------------*
           if        rf-oct-tmo-orc       =    spaces or
                     rf-oct-dat-doc       =    zero   or
                     rf-oct-num-doc       =    zero   or
                     w-acc-num-prg        =    zero   or
                     w-acc-prg-frm        =    zero
      ...
      *              * Test                                            *
      *              *-------------------------------------------------*
           if        rf-oct-tmo-orc       =    spaces and
                     rf-oct-dat-doc       =    zero   and
                     rf-oct-num-doc       =    zero   and
                     w-acc-num-prg        =    zero   and
                     w-acc-prg-frm        =    zero
      ...
      *              *-------------------------------------------------*
           move      rf-oct-dat-doc       to   w-acc-dat-doc          .
           move      rf-oct-tmo-orc       to   w-acc-tmo-orc          .
      *              *-------------------------------------------------*
      *              * Start su file [oct]                             *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           if        rf-oct-dat-doc       not  = w-acc-dat-doc or
                     ...
                     rf-oct-tmo-orc       not  = w-acc-tmo-orc or
      ...
      *                  *---------------------------------------------*
           ...
           move      w-acc-num-prg        to   rf-ocp-num-prg         .
           move      w-acc-prg-frm        to   rf-ocp-prg-frm         .
           move      "pgm/orc/fls/ioc/obj/iofocp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     ...
                     go to rou-let-reg-999.
      *                  *---------------------------------------------*
      *                  * Lettura ordine fornitore                    *
      *                  *---------------------------------------------*
           if        rf-ocp-prt-orf       =    zero
                     move  spaces         to   w-acc-est-orf
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      rf-ocp-prt-orf       to   rf-oft-num-prt         .
           move      "pgm/orf/fls/ioc/obj/iofoft"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                  *---------------------------------------------*
      *                  * Composizione estremi ordine fornitore       *
      *                  *---------------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      05                   to   w-all-str-num          .
           move      "("                  to   w-all-str-cat (1)      .
           move      rf-oft-tmo-orf       to   w-all-str-cat (2)      .
      ...
      *                  *---------------------------------------------*
           ...
           move      ")"                  to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   w-acc-est-orf          .
       rou-let-reg-900.
      *                  *---------------------------------------------*
      ...
      *                      * Rewrite record [ocp]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-ocp-000      thru rew-rec-ocp-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      w-fnd-arc-oct-toc    to   rf-oct-tmo-orc         .
           move      w-fnd-arc-oct-dat    to   rf-oct-dat-doc         .
           move      w-fnd-arc-oct-num    to   rf-oct-num-doc         .
