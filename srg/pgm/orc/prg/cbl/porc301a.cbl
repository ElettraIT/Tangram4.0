      ...
      *                                                                *
      *                    [F6] : espansione ordine                    *
      *                    [F4] : gerarchia di evasione                *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
      *            * Numero riferimento del cliente                    *
      *            *---------------------------------------------------*
               10  srt-ocl-num            pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Data riferimento del cliente                      *
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Imponibile residuo documento                      *
      *            *---------------------------------------------------*
               10  srt-res-doc            pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * Status ordine                                     *
      *            *---------------------------------------------------*
      ...
      *        * Data ordine cliente                                   *
      *        *-------------------------------------------------------*
           05  rr-ocl-dat                 pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Numero ordine cliente                                 *
      *        *-------------------------------------------------------*
           05  rr-ocl-num                 pic  x(10)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Work per Det totale residuo documento                 *
      *        *-------------------------------------------------------*
           05  w-det-tot-res.
               10  w-det-tot-res-tot      pic s9(11)                  .
      ...
      *    *===========================================================*
      *    * Work per funzioni di Edt                                  *
      *    *-----------------------------------------------------------*
       01  w-edt.
      *        *-------------------------------------------------------*
      *        * Per editing numero ordine cliente                     *
      *        *-------------------------------------------------------*
           05  w-edt-ocl-num.
      *            *---------------------------------------------------*
      *            * Numero ordine cliente cosi' come memorizzato      *
      *            *---------------------------------------------------*
               10  w-edt-ocl-num-mem      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Numero ordine cliente allineato a destra          *
      *            *---------------------------------------------------*
               10  w-edt-ocl-num-adx      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Numero trailing spaces                            *
      *            *---------------------------------------------------*
               10  w-edt-ocl-num-nts      pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Numero leading non-spaces                         *
      *            *---------------------------------------------------*
               10  w-edt-ocl-num-nln      pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Indice carattere di destinazione                  *
      *            *---------------------------------------------------*
               10  w-edt-ocl-num-icd      pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
           perform   esp-idv-oct-opn-000  thru esp-idv-oct-opn-999    .
      *              *-------------------------------------------------*
      *              * Open file [oct]                                 *
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           perform   esp-idv-oct-cls-000  thru esp-idv-oct-cls-999    .
      *              *-------------------------------------------------*
      *              * Close file [oct]                                *
      *              *-------------------------------------------------*
           move      "CL"                 to   f-ope                  .
      ...
      *                      *-----------------------------------------*
       ...
       int-srt-inp-440.
      *                  *---------------------------------------------*
      *                  * Selezione su data ordine cliente            *
      *                  *---------------------------------------------*
           if        rr-ocl-dat           =    zero
                     go to int-srt-inp-450.
           if        rf-oct-ocl-dat       not  = rr-ocl-dat
                     go to int-srt-inp-200.
       int-srt-inp-450.
      *                  *---------------------------------------------*
      *                  * Selezione su numero ordine cliente          *
      *                  *---------------------------------------------*
           if        rr-ocl-num           =    spaces
                     go to int-srt-inp-500.
           if        rf-oct-ocl-num       not  = rr-ocl-num
                     go to int-srt-inp-200.
       int-srt-inp-500.
      *              *-------------------------------------------------*
      *              * Determinazione residuo ordine                   *
      *              *-------------------------------------------------*
           perform   det-tot-res-000      thru det-tot-res-999        .
      *              *-------------------------------------------------*
...
______*    perform   int-srt-inp-rig-000  thru int-srt-inp-rig-999    .
      ...
      *                      * Imponibile residuo documento            *
      *                      *-----------------------------------------*
           move      w-det-tot-res-tot    to   srt-res-doc            .
      *                      *-----------------------------------------*
      *                      * Status ordine                           *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   srt-ocl-num            .
           move      zero                 to   srt-ocl-dat            .
           move      spaces               to   srt-dpz-arc            .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-oct-dpz-arc       to   srt-dpz-arc            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       int-srt-inp-key-300.
      *              *-------------------------------------------------*
      *              * 3. per numero riferimento cliente               *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       int-srt-inp-key-400.
      *              *-------------------------------------------------*
      *              * 4. per data riferimento cliente                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       int-srt-inp-key-600.
      *              *-------------------------------------------------*
      *              * 6. per residuo documento                        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      w-det-tot-res-tot    to   srt-tot-key            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
      ...
      *    *-----------------------------------------------------------*
       pmt-ocl-dat-000.
           ...
           move      17                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezioni su riferimenti del cliente"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Data ordine cliente                        *
      *    *-----------------------------------------------------------*
       acc-ocl-dat-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Accettazione : Numero ordine cliente                      *
      *    *-----------------------------------------------------------*
       acc-ocl-num-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Data ordine cliente                         *
      *                  *---------------------------------------------*
           move      zero                 to   rr-ocl-dat             .
      *                  *---------------------------------------------*
      *                  * Numero ordine cliente                       *
      *                  *---------------------------------------------*
           move      spaces               to   rr-ocl-num             .
       nor-ric-sel-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-oct-com-rig (3)   not  = spaces
                     add    1             to   w-tst-lin-res-num      .
      *              *-------------------------------------------------*
      *              * Correttivo per residuo ordine                   *
      *              *-------------------------------------------------*
           if        srt-res-doc          =    zero
                     go to qry-liv-det-040.
           if        srt-sts-ord          not  = 02
                     go to qry-liv-det-040.
           if        srt-res-doc          not  < srt-tot-doc
                     go to qry-liv-det-040.
           add       1                    to   w-tst-lin-res-num      .
       qry-liv-det-040.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      rf-oct-num-doc       to   w-wrk-num-doc          .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Indicatori di tipo ordine                   *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da evidenziare                  *
      *                      *-----------------------------------------*
           if        rf-oct-tip-ord       =    spaces
      ...
      *                      *-----------------------------------------*
           move      rf-oct-ocl-num       to   w-edt-ocl-num-mem      .
           move      spaces               to   w-edt-ocl-num-adx      .
           move      zero                 to   w-edt-ocl-num-nts      .
           inspect   w-edt-ocl-num-mem
                                      tallying w-edt-ocl-num-nts
                                          for  trailing  spaces       .
           move      10                   to   w-edt-ocl-num-nln      .
           subtract  w-edt-ocl-num-nts    from w-edt-ocl-num-nln      .
           move      10                   to   w-edt-ocl-num-icd      .
           subtract  w-edt-ocl-num-nln    from w-edt-ocl-num-icd      .
           add       1                    to   w-edt-ocl-num-icd      .
           if        w-edt-ocl-num-icd    not  > 10
                     move  w-edt-ocl-num-mem
                          (1 : w-edt-ocl-num-nln)
                                          to   w-edt-ocl-num-adx
                                              (w-edt-ocl-num-icd :
                                               w-edt-ocl-num-nln )    .
      *                      *-----------------------------------------*
      *                      * Stampa                                  *
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      17                   to   v-pos                  .
           move      w-edt-ocl-num-adx    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       qry-liv-det-220.
      *                  *---------------------------------------------*
      *                  * Eventuale codice dipendenza del cliente, se *
      *                  * il codice valuta non e' il base             *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
           if        srt-res-doc          >    999999999 or
                     srt-res-doc          <   -999999999
                     move  11             to   v-car
                     move  "B "           to   v-edm
      ...
      *
           if        rr-dpz-cli           =    spaces or
                     ...
                     move  rr-cod-cli-rag to   w-all-str-cat (5)
           else      move  "-"            to   w-all-str-cat (3)
                     move  rr-dpz-cli     to   w-all-str-cat (4)
                     move  rr-dpz-cli-rag to   w-all-str-cat (5)      .
      *
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Numero   Data      Rif. Cliente            Residuo
      -              "            Annotazioni       "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                      *-----------------------------------------*
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-dat-doc        to   w-esp-idv-oct-dat      .
           move      w-mpn-num-doc        to   w-esp-idv-oct-num      .
           move      w-mpn-tmo-orc        to   w-esp-idv-oct-tmo      .
           move      w-mpn-num-prt        to   w-esp-idv-oct-prt      .
      *                      *-----------------------------------------*
      *                      * Chiamata del modulo                     *
      *                      *-----------------------------------------*
           perform   esp-idv-oct-esp-000  thru esp-idv-oct-esp-999    .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     qry-trt-fun-999.
      ...
      *              * dulo                                            *
      *              *-------------------------------------------------*
           move      d-sts-orc-tot-ord    to   w-det-tot-res-tot      .
       det-tot-doc-999.
           exit.

      *    *===========================================================*
      *    * Determinazione totale residuo documento, in valuta        *
      *    *-----------------------------------------------------------*
       det-tot-res-000.
      *              *-------------------------------------------------*
      *              * Si prende quello determinato dall'apposito mo-  *
      *              * dulo                                            *
      *              *-------------------------------------------------*
           move      d-sts-orc-imp-res    to   w-det-tot-res-tot      .
       det-tot-res-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
           ...
           copy      "pgm/orc/prg/cpy/porc301y.pgs"                   .
