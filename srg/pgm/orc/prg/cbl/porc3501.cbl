      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma orc350   *
      *                                                                *
      *                    Portafoglio ordini per data consegna        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tot-gen.
               10  w-tot-gen-ndc          pic  9(05)                  .
               10  w-tot-gen-tiv          pic s9(11)                  .
               10  w-tot-gen-tot          pic s9(11)                  .
               10  w-tot-gen-vpf          pic  x(03)                  .
               10  w-tot-gen-dpf          pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Work per totale data consegna                         *
      *        *-------------------------------------------------------*
           05  w-tot-dcn.
               10  w-tot-dcn-cli          pic  9(05)                  .
               10  w-tot-dcn-tiv          pic s9(11)                  .
               10  w-tot-dcn-tot          pic s9(11)                  .
               10  w-tot-dcn-vpf          pic  x(03)                  .
               10  w-tot-dcn-dpf          pic  9(01)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-dpz-cli           =    "*   "
                     go to stp-srt-inp-140.
           if        rf-oct-dpz-arc       not  = rr-dpz-cli
                     go to stp-srt-inp-100.
       stp-srt-inp-140.
      *              *-------------------------------------------------*
      ...
      *              * Data consegna prevista                          *
      *              *-------------------------------------------------*
           move      srt-dcn-prv          to   w-rot-l03-dcn-prv      .
      *              *-------------------------------------------------*
      *              * Cliente                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-dcn-cli          .
           move      zero                 to   w-tot-dcn-tiv          .
           move      zero                 to   w-tot-dcn-tot          .
           move      srt-sgl-vpf          to   w-tot-dcn-vpf          .
           move      srt-dec-vpf          to   w-tot-dcn-dpf          .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-ini-lr3-100.
      *                  *---------------------------------------------*
      *                  * 1. linea per intestazione data consegna     *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * 2. linea per intestazione data consegna     *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * 3. linea per intestazione data consegna     *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tot-gen-ndc        <    99999
                     add   1              to   w-tot-gen-ndc          .
           add       w-tot-dcn-tot        to   w-tot-gen-tot          .
           add       w-tot-dcn-tiv        to   w-tot-gen-tiv          .
           if        w-tot-dcn-vpf        not  = w-tot-gen-vpf
                     move  spaces         to   w-tot-gen-vpf          .
      *              *-------------------------------------------------*
      *              * Stampa totale data consegna                     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se da stampare                         *
      *                  *---------------------------------------------*
           if        w-tot-dcn-tot        =    zero
                     go to prn-fin-lr3-999.
           if        w-tot-dcn-vpf        not  = c-sgl
                     go to prn-fin-lr3-050.
           if        w-tot-dcn-cli        not  > 1
                     go to prn-fin-lr3-999.
       prn-fin-lr3-050.
      *                  *---------------------------------------------*
      *                  * Test se righe residue sufficienti           *
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr3-120.
      *                  *---------------------------------------------*
      *                  * Trattini superiori per totale per data      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *                      * Richiamo routine per stampa valori      *
      *                      *-----------------------------------------*
           move      "Totale alla data  " to   w-stp-val-tot-pmt      .
           if        w-tot-dcn-vpf        =    spaces
                     move  c-sgl          to   w-stp-val-tot-vlt
           else      move  w-tot-dcn-vpf  to   w-stp-val-tot-vlt
                     move  w-tot-dcn-dpf  to   w-stp-val-tot-dcv      .
           move      w-tot-dcn-tot        to   w-stp-val-tot-tot      .
           move      w-tot-dcn-tiv        to   w-stp-val-tot-tiv      .
           perform   stp-val-tot-000      thru stp-val-tot-999        .
      *                  *---------------------------------------------*
      *                  * Trattini inferiori per totale per data      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento totali per data consegna          *
      *              *-------------------------------------------------*
           if        w-tot-dcn-cli        <    99999
                     add   1              to   w-tot-dcn-cli          .
           add       w-tot-cli-tot        to   w-tot-dcn-tot          .
           add       w-tot-cli-tiv        to   w-tot-dcn-tiv          .
           if        w-tot-cli-vpf        not  = w-tot-dcn-vpf
                     move  spaces         to   w-tot-dcn-vpf          .
      *              *-------------------------------------------------*
