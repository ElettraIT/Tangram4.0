      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma orc370   *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Nominativo responsabile in Uppercase              *
      *            *---------------------------------------------------*
               10  srt-rsp-key            pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Codice responsabile                               *
      *            *---------------------------------------------------*
               10  srt-cod-rsp            pic  9(07)                  .
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-tot-gen.
               10  w-tot-gen-rsp          pic  9(05)                  .
               10  w-tot-gen-tiv          pic s9(11)                  .
               10  w-tot-gen-tot          pic s9(11)                  .
               10  w-tot-gen-vpf          pic  x(03)                  .
               10  w-tot-gen-dpf          pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Work per totale responsabile                          *
      *        *-------------------------------------------------------*
           05  w-tot-gen.
               10  w-tot-rsp-cli          pic  9(05)                  .
               10  w-tot-rsp-tiv          pic s9(11)                  .
               10  w-tot-rsp-tot          pic s9(11)                  .
               10  w-tot-rsp-vpf          pic  x(03)                  .
               10  w-tot-rsp-dpf          pic  9(01)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-oct-cod-rsp       =    zero
                     go to stp-srt-inp-100.
           if        rr-cod-rsp           not  = zero   and
                     rf-oct-cod-rsp       not  = rr-cod-rsp
                     go to stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Normalizzazione record [zro]                    *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "pgm/orc/fls/ioc/obj/iofzro"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-oct-cod-rsp       to   rf-zro-cod-rsp         .
           move      "pgm/orc/fls/ioc/obj/iofzro"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      rf-zro-des-key       to   srt-rsp-key            .
           move      rf-oct-cod-rsp       to   srt-cod-rsp            .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-zro-des-rsp       to   srt-des-rsp            .
      ...
      *              * Responsabile                                    *
      *              *-------------------------------------------------*
           move      srt-cod-rsp          to   w-rot-l03-cod-rsp      .
      *              *-------------------------------------------------*
      *              * Cliente                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-rsp-cli          .
           move      zero                 to   w-tot-rsp-tiv          .
           move      zero                 to   w-tot-rsp-tot          .
           move      srt-sgl-vpf          to   w-tot-rsp-vpf          .
           move      srt-dec-vpf          to   w-tot-rsp-dpf          .
      *              *-------------------------------------------------*
      *              * Intestazione responsabile                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-ini-lr3-100.
      *                  *---------------------------------------------*
      *                  * 1. linea per intestazione responsabile      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * 2. linea per intestazione responsabile      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "Responsabile :"     to   w-all-str-cat (1)      .
           move      p-edt                to   w-all-str-cat (2)      .
           move      srt-des-rsp          to   w-all-str-cat (3)      .
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * 3. linea per intestazione responsabile      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tot-gen-rsp        <    99999
                     add   1              to   w-tot-gen-rsp          .
           add       w-tot-rsp-tot        to   w-tot-gen-tot          .
           add       w-tot-rsp-tiv        to   w-tot-gen-tiv          .
           if        w-tot-rsp-vpf        not  = w-tot-gen-vpf
                     move  spaces         to   w-tot-gen-vpf          .
      *              *-------------------------------------------------*
      *              * Stampa totale responsabile                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se da stampare                         *
      *                  *---------------------------------------------*
           if        w-tot-rsp-tot        =    zero
                     go to prn-fin-lr3-999.
           if        w-tot-rsp-vpf        not  = c-sgl
                     go to prn-fin-lr3-050.
           if        w-tot-rsp-cli        not  > 1
                     go to prn-fin-lr3-999.
       prn-fin-lr3-050.
      *                  *---------------------------------------------*
      *                  * Test se righe residue sufficienti           *
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr3-120.
      *                  *---------------------------------------------*
      *                  * Trattini superiori per totale responsabile  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *                      * Richiamo routine per stampa valori      *
      *                      *-----------------------------------------*
           move      "Totale responsabile"
                                          to   w-stp-val-tot-pmt      .
           if        w-tot-rsp-vpf        =    spaces
                     move  c-sgl          to   w-stp-val-tot-vlt
           else      move  w-tot-rsp-vpf  to   w-stp-val-tot-vlt
                     move  w-tot-rsp-dpf  to   w-stp-val-tot-dcv      .
           move      w-tot-rsp-tot        to   w-stp-val-tot-tot      .
           move      w-tot-rsp-tiv        to   w-stp-val-tot-tiv      .
           perform   stp-val-tot-000      thru stp-val-tot-999        .
      *                  *---------------------------------------------*
      *                  * Trattini inferiori per totale responsabile  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-fin-lr2-000.
      *              *-------------------------------------------------*
      *              * Aggiornamento totali per responsabile           *
      *              *-------------------------------------------------*
           if        w-tot-rsp-cli        <    99999
                     add   1              to   w-tot-rsp-cli          .
           add       w-tot-cli-tot        to   w-tot-rsp-tot          .
           add       w-tot-cli-tiv        to   w-tot-rsp-tiv          .
           if        w-tot-cli-vpf        not  = w-tot-rsp-vpf
                     move  spaces         to   w-tot-rsp-vpf          .
      *              *-------------------------------------------------*
