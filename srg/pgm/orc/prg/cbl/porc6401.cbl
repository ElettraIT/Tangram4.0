      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma orc640   *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-tot-pro.
      *            *---------------------------------------------------*
      *            * Contatore elementi per prodotto                   *
      *            *---------------------------------------------------*
               10  w-tot-pro-ctr          pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Totale ordinato                                   *
      *            *---------------------------------------------------*
      ...
      *            * Totale assegnato                                  *
      *            *---------------------------------------------------*
               10  w-tot-pro-ass          pic s9(08)v9(03)            .
      *            *---------------------------------------------------*
      *            * Comodo per giacenza                               *
      *            *---------------------------------------------------*
               10  w-tot-pro-gia          pic s9(08)v9(03)            .
      *            *---------------------------------------------------*
      *            * Comodo per 'in corso di spedizione'               *
      *            *---------------------------------------------------*
               10  w-tot-pro-ccs          pic s9(08)v9(03)            .
      *            *---------------------------------------------------*
      *            * Comodo per disponibilita'                         *
      *            *---------------------------------------------------*
               10  w-tot-pro-dsp          pic s9(08)v9(03)            .
      ...
      *                  *---------------------------------------------*
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      *              * Letture per completamento record di Sort        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura record [dcc]                        *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-tot-pro-ass          .
           move      zero                 to   w-tot-pro-gia          .
           move      zero                 to   w-tot-pro-dsp          .
           move      zero                 to   w-tot-pro-ccs          .
       prn-ini-lr2-020.
      *              *-------------------------------------------------*
      *              * Determinazione della giacenza del prodotto al-  *
      *              * la data attuale                                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Bufferizzazione giacenza determinata        *
      *                  *---------------------------------------------*
           move      d-sld-mag-sld-mag    to   w-tot-pro-gia          .
       prn-ini-lr2-030.
      *              *-------------------------------------------------*
      *              * Determinazione della disponibilita' globale del *
      *              * prodotto                                        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Start su file [osr]                         *
      *                  *---------------------------------------------*
           ...
           move      srt-num-pro          to   rf-osr-num-pro         .
      ...
      *                      *-----------------------------------------*
           if        rf-osr-cod-dpz       not  = rr-dpz-inu         or
                     ...
                     rf-osr-num-pro       not  = srt-num-pro
                     go to prn-ini-lr2-045.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           add       d-qds-ros-qta-dsp    to   w-tot-pro-ccs          .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       prn-ini-lr2-045.
      *                  *---------------------------------------------*
      *                  * Disponibilita' data da giacenza meno ordini *
      *                  * di spedizione in essere                     *
      *                  *---------------------------------------------*
           move      w-tot-pro-gia        to   w-tot-pro-dsp          .
           subtract  w-tot-pro-ccs        from w-tot-pro-dsp          .
       prn-ini-lr2-050.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Totale quantita' assegnata              *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           if        w-tot-pro-ass        >    99999 or
                     w-tot-pro-ass        <   -99999
                     move  05             to   p-car
                     move  "BD"           to   p-edm
           else      move  06             to   p-car
      ...
      *              *-------------------------------------------------*
           ...
           add       srt-qta-ass          to   w-tot-pro-ass          .
           subtract  srt-qta-ass          from w-tot-pro-dsp          .
       prn-liv-det-050.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "LISTA ASSEGNAZIONI ORDINI EFFETTUATE PER PRODOTTO"
      ...
      *              *-------------------------------------------------*
      ...
      -              "ente                       Ordinato    Inevaso   A
      -              "ssegnato  Disponib.   C. Prev.  "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
