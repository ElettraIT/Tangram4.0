      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella responsabili ordini        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  TABELLA RESPONSABILI ORDINI CLIENTI   "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-rsp        to   w-cod-mne-zro-cod      .
           move      04                   to   w-cod-mne-zro-lin      .
           move      30                   to   w-cod-mne-zro-pos      .
           move      07                   to   w-cod-mne-zro-dln      .
           move      30                   to   w-cod-mne-zro-dps      .
           move      "<B"                 to   v-edm                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-rsp        to   rf-zro-cod-rsp         .
           move      "pgm/orc/fls/ioc/obj/iofzro"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zro]                        *
      *                          *-------------------------------------*
           move      rf-zro-des-rsp       to   w-tes-des-rsp (1)      .
           move      rf-zro-des-key       to   w-tes-des-key (1)      .
           move      rf-zro-cod-mne       to   w-tes-cod-mne (1)      .
           move      rf-zro-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zro]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zro-000      thru wrt-rec-zro-999        .
      ...
      *                      * Rewrite record [zro]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zro-000      thru rew-rec-zro-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zro]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zro-000      thru del-rec-zro-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zro]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zro-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-rsp (1)    to   rf-zro-des-rsp         .
           move      w-tes-des-key (1)    to   rf-zro-des-key         .
           move      w-tes-cod-mne (1)    to   rf-zro-cod-mne         .
           move      w-tes-alx-exp (1)    to   rf-zro-alx-exp         .
       cmp-rec-zro-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zro]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zro-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zro-000      thru cmp-rec-zro-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zro] parte 01    *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zro "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODRSP    "         to   f-key                  .
           move      w-enc-cod-val-pos    to   rf-zro-cod-rsp         .
           move      "pgm/orc/fls/ioc/obj/iofzro"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       rip-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zro]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zro "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
