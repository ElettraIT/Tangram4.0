      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma orc302   *
      *                                                                *
      ...
      *            *---------------------------------------------------*
      *            * Elementi in distinta mail                         *
      *            *---------------------------------------------------*
               10  srt-eml-ele            pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-010.
      *              *-------------------------------------------------*
      *              * Start su archivio [oct] per data registrazione  *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "IDEDOC    "         to   f-key                  .
           move      rr-dat-ini           to   rf-oct-dat-doc         .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-020.
      *              *-------------------------------------------------*
      *              * Start su archivio [oct] per data ultima modifi- *
      *              * ca                                              *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATSYS    "         to   f-key                  .
           move      rr-dat-ini           to   rf-oct-ide-dat         .
      ...
      *                      *-----------------------------------------*
           ...
           if        rf-oct-ide-ute       not  = rr-cod-ute
                     go to stp-srt-inp-100.
       stp-srt-inp-330.
      *                      *-----------------------------------------*
      *                      * Test su codice fase                     *
      *                      *-----------------------------------------*
           ...
           if        rf-oct-ide-fas       not  = rr-cod-fas
                     go to stp-srt-inp-100.
       stp-srt-inp-340.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       stp-srt-inp-400.
      *                      *-----------------------------------------*
      *                      * Test su presenza in distinta di invio   *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Test se determinazione da eseguire  *
      *                          *-------------------------------------*
           if        rr-sel-eml           =    01
                     go to stp-srt-inp-500.
      *                          *-------------------------------------*
      *                          * Determinazione presenza distinta    *
      *                          *-------------------------------------*
           move      rf-oct-num-prt       to   w-det-prt-eml-prt      .
           perform   det-prt-eml-000      thru det-prt-eml-999        .
      *                          *-------------------------------------*
      *                          * Se solo documenti Inviati           *
      *                          *-------------------------------------*
           if        rr-sel-eml           =    03
      ...
      *                          * Numero documento                    *
      *                          *-------------------------------------*
           move      rf-oct-num-doc       to   w-det-num-doc          .
      ...
      *                          * Tipo archivio                       *
      *                          *-------------------------------------*
           move      rf-oct-tip-arc       to   srt-tip-arc            .
      *                          *-------------------------------------*
      *                          * Codice archivio                     *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-oct-sgl-vpf       to   srt-sgl-vpf            .
      *                          *-------------------------------------*
      *                          * Decimali valuta documento           *
      *                          *-------------------------------------*
           move      rf-oct-dec-vpf       to   srt-dec-vpf            .
      *                          *-------------------------------------*
      ...
      *                          * Data ultima modifica                *
      *                          *-------------------------------------*
           move      rf-oct-ide-dat       to   srt-ide-dat            .
      *                          *-------------------------------------*
      *                          * Utente                              *
      *                          *-------------------------------------*
           move      rf-oct-ide-ute       to   srt-ide-ute            .
      *                          *-------------------------------------*
      *                          * Fase                                *
      *                          *-------------------------------------*
           move      rf-oct-ide-fas       to   srt-ide-fas            .
      *                          *-------------------------------------*
      *                          * Elementi in distinta email          *
      *                          *-------------------------------------*
           move      w-det-prt-eml-ele    to   srt-eml-ele            .
       stp-srt-inp-800.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Test se selezione su invio documenti    *
      *                      *-----------------------------------------*
           if        rr-sel-eml           =    01
                     go to prn-liv-det-650.
      *                      *-----------------------------------------*
      *                      * Stampa status dell'invio                *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      28                   to   p-car                  .
      ...
      *
           if        srt-eml-ele          =    zero
                     move  "Non inviato"  to   p-alf
           else      move  "Inviato    "  to   p-alf                  .
      *
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      104                  to   p-pos                  .
           move      d-sts-orc-sts-lit    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Oltre                                   *
      *                      *-----------------------------------------*
       ...
       prn-liv-det-800.
      *                  *---------------------------------------------*
      *                  * Eventuale stampa documenti di evasione      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
           if        rr-snx-dev           not  = 02
                     go to prn-liv-det-900.
      *                      *-----------------------------------------*
      *                      * Subroutine di scansione e stampa        *
      *                      *-----------------------------------------*
           perform   prn-liv-det-dev-000  thru prn-liv-det-dev-999    .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Interlinea                                      *
      *              *-------------------------------------------------*
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine di scansione righe ordine per la stampa dei    *
      *    * documenti di evasione eventuali                           *
      *    *-----------------------------------------------------------*
       prn-liv-det-dev-000.
      *              *-------------------------------------------------*
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-ocr-num-prt       not  = srt-num-prt
                     go to prn-liv-det-dev-900.
       prn-liv-det-dev-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-ocr-tip-rig
                    (1 : 1)               =    "C"
                     go to prn-liv-det-dev-200.
       prn-liv-det-dev-500.
      *              *-------------------------------------------------*
      *              * Lettura eventuali [bir]                         *
      *              *-------------------------------------------------*
           perform   prn-liv-det-bir-000  thru prn-liv-det-bir-999    .
       prn-liv-det-dev-600.
      *              *-------------------------------------------------*
      *              * Lettura eventuali [osr]                         *
      *              *-------------------------------------------------*
           perform   prn-liv-det-osr-000  thru prn-liv-det-osr-999    .
       prn-liv-det-dev-800.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rf-bir-cod-tmb       =    w-det-cst-doc-tdo
                     ...
                     rf-bir-num-doc       =    w-det-cst-doc-ndo
                                              (w-det-cst-doc-ctr)
                     go to prn-liv-det-bir-800.
       prn-liv-det-bir-430.
      *                      *-----------------------------------------*
      *                      * Riciclo                                 *
      *                      *-----------------------------------------*
           go to     prn-liv-det-bir-420.
       prn-liv-det-bir-440.
      *                      *-----------------------------------------*
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine di scansione righe ordine spedizione           *
      *    *-----------------------------------------------------------*
       prn-liv-det-osr-000.
      *              *-------------------------------------------------*
      *              * Start su [osr]                                  *
      ...
      *                      * Confronto                               *
      *                      *-----------------------------------------*
           if        rf-osr-cod-tms       =    w-det-cst-doc-tdo
                                              (w-det-cst-doc-ctr) and
                     rf-osr-dat-doc       =    w-det-cst-doc-ddo
                                              (w-det-cst-doc-ctr) and
                     rf-osr-num-prt       =    w-det-cst-doc-ndo
                                              (w-det-cst-doc-ctr)
                     go to prn-liv-det-osr-800.
       prn-liv-det-osr-430.
      *                      *-----------------------------------------*
      *                      * Riciclo                                 *
      *                      *-----------------------------------------*
           go to     prn-liv-det-osr-420.
       prn-liv-det-osr-440.
      *                      *-----------------------------------------*
      *                      * Incremento contatore                    *
      *                      *-----------------------------------------*
      ...
      *                      * Bufferizzazione elemento                *
      *                      *-----------------------------------------*
           move      rf-osr-cod-tms       to   w-det-cst-doc-tdo
                                              (w-det-cst-doc-ele)     .
           move      rf-osr-dat-doc       to   w-det-cst-doc-ddo
                                              (w-det-cst-doc-ele)     .
           move      rf-osr-num-prt       to   w-det-cst-doc-ndo
                                              (w-det-cst-doc-ele)     .
       prn-liv-det-osr-600.
      *              *-------------------------------------------------*
      *              * Stampa                                          *
      ...
      *                      *-----------------------------------------*
           ...
           move      w-det-cst-doc-tdo
                    (w-det-cst-doc-ele)   to   w-all-str-alf          .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      009                  to   p-pos                  .
           move      w-det-cst-doc-ddo
                    (w-det-cst-doc-ele)   to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      ...
      *              *-------------------------------------------------*
           move      "BROGLIACCIO ORDINI CLIENTI"
      ...
      *              * si sta esaminando.                              *
      *              *-------------------------------------------------*
           if        rf-bir-bld-flb       not  = rf-ocr-bld-flb
                     go to sel-bir-ocr-900.
       sel-bir-ocr-100.
      *              *-------------------------------------------------*
