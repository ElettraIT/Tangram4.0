      ...
      *                                   Fase:    orc520              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 06/05/96    *
      *                       Ultima revisione:    NdK del 13/05/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione verifica ordini clienti            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  GESTIONE ORDINI CLIENTI DA VERIFICARE "       .
      ...
      *        *-------------------------------------------------------*
           05  w-rig-snx-oav              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Totale documento                                      *
      *        *-------------------------------------------------------*
           05  w-rig-tot-doc              pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Un intero record [oct]                                *
      *        *-------------------------------------------------------*
           05  w-rig-rec-oct.
      ...
      *        *-------------------------------------------------------*
           05  w-exp-sel-oav.
               10  w-exp-sel-oav-num      pic  9(02)       value 02   .
               10  w-exp-sel-oav-lun      pic  9(02)       value 40   .
               10  w-exp-sel-oav-tbl.
                   15  filler             pic  x(40) value
                            "solo quelli da Verificare               ".
                   15  filler             pic  x(40) value
                            "Tutti gli ordini inevasi                ".
      *        *-------------------------------------------------------*
      *        * Work per : Si/no ordine da verificare                 *
      *        *-------------------------------------------------------*
           05  w-exp-rig-oav.
               10  w-exp-snx-oav-num      pic  9(02)       value 2    .
               10  w-exp-snx-oav-lun      pic  9(02)       value 02   .
      ...
      *                  *---------------------------------------------*
           perform   acc-sel-oav-000      thru acc-sel-oav-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Si/no solo sospesi                              *
      *              *-------------------------------------------------*
           perform   vis-sel-oav-000      thru vis-sel-oav-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Si/no solo sospesi                          *
      *                  *---------------------------------------------*
           perform   pmt-sel-oav-000      thru pmt-sel-oav-999        .
       pmt-key-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per : Numero ordine min           *
      *    *-----------------------------------------------------------*
       pmt-num-min-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per : Numero ordine max           *
      *    *-----------------------------------------------------------*
       pmt-num-max-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-oav-lun    to   v-car                  .
           move      w-exp-sel-oav-num    to   v-ldt                  .
           move      "VT#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-sel-oav-tbl    to   v-txt                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      11                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-tes-snx-oav        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-sel-oav-999.
       acc-sel-oav-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-snx-oav          .
       acc-sel-oav-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-snx-oav        not  = 01 and
                     w-tes-snx-oav        not  = 02
                     go to acc-sel-oav-100.
       acc-sel-oav-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-snx-oav        =    spaces
                     move  spaces         to   w-lin-imm-snx-oav
           else      move  "*"            to   w-lin-imm-snx-oav      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *              * Esclusione da statistiche                       *
      *              *-------------------------------------------------*
           perform   vis-snx-oav-000      thru vis-snx-oav-999        .
      *              *-------------------------------------------------*
      *              * Estremi documento                               *
      *              *-------------------------------------------------*
      ...
      *              * Esclusione da statistiche                       *
      *              *-------------------------------------------------*
           perform   pmt-snx-oav-000      thru pmt-snx-oav-999        .
      *              *-------------------------------------------------*
      *              * Estremi documento                               *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-num                =    1
                     move  "#"            to   w-rig-snx-oav
           else if   v-num                =    2
                     move  spaces         to   w-rig-snx-oav
           else      move  spaces         to   w-rig-snx-oav          .
       acc-snx-oav-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       cnt-tdo-key-520.
      *                  *---------------------------------------------*
      *                  * Regolarizzazione numero ordine interno min  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Regolarizzazione numero ordine interno max  *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-dpz-inu        to   rf-oct-cod-dpz         .
      ...
      *                  *---------------------------------------------*
           if        rf-oct-cod-dpz       not  = w-tes-dpz-inu
                     go to stp-srt-inp-999.
      *                  *---------------------------------------------*
      *                  * Se ordini chiusi : a fine ciclo             *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-oct-cod-arc       not  = w-tes-cod-cli
                     go to stp-srt-inp-200.
       stp-srt-inp-460.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-oct-tmo-orc       not  = w-tes-tip-mov
                     go to stp-srt-inp-200.
       stp-srt-inp-470.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-oct-cod-age       not  = w-tes-cod-age
                     go to stp-srt-inp-200.
       stp-srt-inp-480.
      *                  *---------------------------------------------*
      *                  * Test su numero ordine                       *
      *                  *---------------------------------------------*
           if        rf-oct-num-doc       <    w-tes-noc-min or
                     rf-oct-num-doc       >    w-tes-noc-max
                     go to stp-srt-inp-200.
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-oct-dat-doc       to   srt-dat-doc            .
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      rf-oct-num-doc       to   srt-num-doc            .
      *                      *-----------------------------------------*
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-oct               to   w-rig-rec-oct          .
           move      rf-oct-cod-arc       to   w-rig-cod-cli          .
           move      rf-oct-dpz-arc       to   w-rig-dpz-cli          .
           move      rf-oct-flg-nbx (1)   to   w-rig-snx-oav          .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           if        w-acc-noc-npg        =    999999
                     go to car-fil-rap-620.
           if        rf-oct-num-doc       not  < w-tes-noc-min and
                     rf-oct-num-doc       not  > w-tes-noc-max
                     move  spaces         to   w-rig-snx-oav          .
       car-fil-rap-620.
      *                      *-----------------------------------------*
      *                      * Anagrafica cliente                      *
      ...
      *              *-------------------------------------------------*
           move      w-rig-rec-oct        to   rf-oct                 .
           move      rf-oct-num-prt       to   w-cmp-rec-oct-prt      .
       sca-fil-rap-500.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-snx-oav        not  = rf-oct-flg-nbx (1)
      ...
      *                  *---------------------------------------------*
           move      w-rig-snx-oav        to   rf-oct-flg-nbx (1)     .
       sca-fil-rap-600.
      *                  *---------------------------------------------*
      *                  * Update record [oct]                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-ocr-num-prt       =    w-cmp-rec-oct-prt
      ...
      *                  * Aggiornamento segnale di verifica           *
      *                  *---------------------------------------------*
           move      w-rig-snx-oav        to   rf-ocr-flg-nbx (1)     .
      *                  *---------------------------------------------*
      *                  * Update record [ocr]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/orc/prg/obj/porc5202"                       .
       cnc-rlt-sup-999.
           exit.
