      ...
      *                                                                *
      *              Input  : w-esp-idv-oct-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-esp-idv-oct-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "ES"  Espansione                                               *
      *                                                                *
      *              Input  : w-esp-idv-oct-ope : "ES"                 *
      *                                                                *
      *                       w-esp-idv-oct-prt : protocollo ordine    *
      *                       w-esp-idv-oct-num : numero documento     *
      *                       w-esp-idv-oct-dat : data documento       *
      *                       w-esp-idv-oct-tmo : tipo documento       *
      *                                                                *
      *              Output : nessuno                                  *
      *                                                                *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
           copy      "pgm/orc/prg/cpy/porc301y.pgl"                   .

      ******************************************************************
       Procedure Division                using w-esp-idv-oct          .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-esp-idv-oct-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-esp-idv-oct-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-esp-idv-oct-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-esp-idv-oct-ope    =    "ES"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-esp-idv-oct-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      01                   to   d-ird-ven-tip-dsr      .
           move      w-esp-idv-oct-prt    to   d-ird-ven-prt-dsr      .
      ...
      *              *-------------------------------------------------*
           if        w-aux-rec-ocr-crb    >    d-ird-ven-num-ele
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-esp-idv-oct-num    to   w-wrk-num-doc          .
           move      w-wrk-ndo-prg        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      w-esp-idv-oct-dat    to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-esp-idv-oct-tmo    to   w-all-str-cat (2)      .
