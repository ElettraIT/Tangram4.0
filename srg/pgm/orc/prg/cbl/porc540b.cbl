      ...
      *                       Ultima revisione:    NdK del 10/11/10    *
      *                    ------------------------------------------- *
      ...
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-oce-dat-doc       to   srt-dat-doc            .
      *                      *-----------------------------------------*
      *                      * Protocollo documento                    *
      *                      *-----------------------------------------*
           move      rf-oce-prt-doc       to   srt-prt-doc            .
      *                      *-----------------------------------------*
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
           move      rf-oce-cod-arc       to   srt-cod-cli            .
      *                      *-----------------------------------------*
      *                      * Progressivo                             *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-oce-cod-arc       to   rf-dcc-cod-cli         .
           move      rf-oce-dpz-arc       to   rf-dcc-dpz-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
