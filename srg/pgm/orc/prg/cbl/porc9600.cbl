      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Subentro di altro cliente su residuo ordine *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   SUBENTRO DI ALTRO CLIENTE IN ORDINE  "       .
      ...
      *            *---------------------------------------------------*
      *            * Codice cliente subentrante                        *
      *            *---------------------------------------------------*
               10  w-tes-cli-sbt          pic  9(07)                  .
               10  w-tes-cli-sbt-rag      pic  x(40)                  .
               10  w-tes-cli-sbt-via      pic  x(40)                  .
               10  w-tes-cli-sbt-loc      pic  x(40)                  .
               10  w-tes-cli-sbt-stc      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Tipo movimento ordini clienti                     *
      *            *---------------------------------------------------*
               10  w-tes-tmo-new          pic  x(05)                  .
               10  w-tes-tmo-new-des      pic  x(30)                  .
               10  w-tes-tmo-new-vld      pic  9(02)                  .
               10  w-tes-tmo-new-dpz      pic  9(02)                  .
               10  w-tes-tmo-new-ord      pic  9(02)                  .
               10  w-tes-tmo-new-prd      pic  9(02)                  .
               10  w-tes-tmo-new-sgl      pic  x(03)                  .
               10  w-tes-tmo-new-dtr      pic  x(05)                  .
               10  w-tes-tmo-new-tip      pic  x(01)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-ctl.
      *        *-------------------------------------------------------*
      *        * Work per Ctl codice cliente                           *
      *        *-------------------------------------------------------*
           05  w-ctl-cod-cli.
      *            *---------------------------------------------------*
      *            * Flag di errore                                    *
      *            *---------------------------------------------------*
               10  w-ctl-cod-cli-flg      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Flag di 'exit'                                    *
      *            *---------------------------------------------------*
               10  w-ctl-cod-cli-ext      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice cliente                                    *
      *            *---------------------------------------------------*
               10  w-ctl-cod-cli-cod      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Segnale di documento che interessa la fatturazio- *
      *            * ne                                                *
      *            *---------------------------------------------------*
               10  w-ctl-cod-cli-ftr      pic  9(02)                  .
      ...
      *                  * Codice cliente subentrante                  *
      *                  *---------------------------------------------*
           perform   acc-cli-sbt-000      thru acc-cli-sbt-999        .
           if        v-key                =    "NXSC"
       ...
       acc-tes-reg-200.
      *                  *---------------------------------------------*
      *                  * Tipo ordine da emettere                     *
      *                  *---------------------------------------------*
           perform   acc-tmo-new-000      thru acc-tmo-new-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
                     move  spaces         to   v-key
      ...
      *              * Codice cliente subentrante                      *
      *              *-------------------------------------------------*
           perform   vis-cli-sbt-000      thru vis-cli-sbt-999        .
           perform   vis-cli-sbt-des-000  thru vis-cli-sbt-des-999    .
      *              *-------------------------------------------------*
      *              * Tipo ordine da emettere                         *
      *              *-------------------------------------------------*
           perform   vis-tmo-new-000      thru vis-tmo-new-999        .
           perform   vis-tmo-new-des-000  thru vis-tmo-new-des-999    .
           go to     vis-tes-reg-999.
       vis-tes-reg-999.
           exit.
      ...
      *              * Codice cliente subentrante                      *
      *              *-------------------------------------------------*
           perform   pmt-cli-sbt-000      thru pmt-cli-sbt-999        .
      *              *-------------------------------------------------*
      *              * Tipo ordine da emettere                         *
      *              *-------------------------------------------------*
           perform   pmt-tmo-new-000      thru pmt-tmo-new-999        .
           go to     pmt-tes-reg-999.
       pmt-tes-reg-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione prompt : Codice cliente originale         *
      *    *-----------------------------------------------------------*
       pmt-cli-org-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice cliente subentrante       *
      *    *-----------------------------------------------------------*
       pmt-cli-sbt-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Tipo ordine da emettere          *
      *    *-----------------------------------------------------------*
       pmt-tmo-new-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Codice cliente originale  *
      *    *-----------------------------------------------------------*
       vis-cli-org-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione cliente ori-  *
      *    * ginale                                                    *
      *    *-----------------------------------------------------------*
       vis-cli-org-des-000.
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cli-sbt (1)    to   w-cod-mne-dcc-cod      .
           move      12                   to   w-cod-mne-dcc-lin      .
           move      27                   to   w-cod-mne-dcc-pos      .
           move      12                   to   w-cod-mne-dcc-rln      .
           move      41                   to   w-cod-mne-dcc-rps      .
           move      13                   to   w-cod-mne-dcc-vln      .
           move      41                   to   w-cod-mne-dcc-vps      .
           move      14                   to   w-cod-mne-dcc-lln      .
       ...
       acc-cli-sbt-110.
           ...
           if        w-cod-mne-dcc-ope    =    "F+"
                     go to acc-cli-sbt-115.
           if        w-cod-mne-dcc-ope    =    "AC"
                     go to acc-cli-sbt-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cli-sbt-115.
           perform   cod-mne-dcc-foi-000  thru cod-mne-dcc-foi-999    .
           go to     acc-cli-sbt-110.
       acc-cli-sbt-120.
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cli-sbt (1)      .
       acc-cli-sbt-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Subroutine per controlli su cliente         *
      *                  *---------------------------------------------*
           move      w-tes-cli-sbt (1)    to   w-ctl-cod-cli-cod      .
           perform   acc-cli-sbt-ctl-000  thru acc-cli-sbt-ctl-999    .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione cliente          *
      *                  *---------------------------------------------*
           move      w-let-arc-dcc-rag    to   w-tes-cli-sbt-rag (1)  .
           move      w-let-arc-dcc-via    to   w-tes-cli-sbt-via (1)  .
           move      w-let-arc-dcc-loc    to   w-tes-cli-sbt-loc (1)  .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-ctl-cod-cli-ext    not  = spaces
                     go to acc-cli-sbt-999.
      *                  *---------------------------------------------*
      *                  * Controllo su flag di errore                 *
      *                  *---------------------------------------------*
           if        w-ctl-cod-cli-flg    not  = spaces
                     go to acc-cli-sbt-100.
       acc-cli-sbt-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-ctl-cod-cli-flg      .
           move      spaces               to   w-ctl-cod-cli-ext      .
       acc-cli-sbt-ctl-100.
      *              *-------------------------------------------------*
      *              * Lettura file [cli]                              *
      *              *-------------------------------------------------*
           move      w-ctl-cod-cli-cod    to   w-let-arc-cli-cod      .
           perform   let-arc-cli-000      thru let-arc-cli-999        .
           move      w-let-arc-cli-rag    to   w-tes-cli-sbt-rag (1)  .
           move      w-let-arc-cli-via    to   w-tes-cli-sbt-via (1)  .
           move      w-let-arc-cli-loc    to   w-tes-cli-sbt-loc (1)  .
           move      w-let-arc-cli-stc    to   w-tes-cli-sbt-stc (1)  .
      *                  *---------------------------------------------*
      *                  * Se valore non ammesso : ad uscita per con-  *
      *                  * trollo non superato senza messaggio di er-  *
      *                  * rore                                        *
      *                  *---------------------------------------------*
           if        w-let-arc-cli-flg    not  = spaces or
                     w-ctl-cod-cli-cod    =    zero
                     go to acc-cli-sbt-ctl-930.
      *                  *---------------------------------------------*
      *                  * Test su codice sottoconto associato al      *
      *                  * cliente                                     *
      *                  *---------------------------------------------*
           if        w-tes-cli-sbt-stc (1)
                                          not  = zero
                     go to acc-cli-sbt-ctl-200.
      *                      *-----------------------------------------*
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           go to     acc-cli-sbt-ctl-920.
       acc-cli-sbt-ctl-200.
      *                  *---------------------------------------------*
      *                  * Lettura record [dcc] principale             *
      *                  *---------------------------------------------*
           move      w-ctl-cod-cli-cod    to   w-let-arc-dcc-cli      .
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-dcc-obl    not  = 02
                     go to acc-cli-sbt-ctl-500.
      *                      *-----------------------------------------*
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
           move      "ATTENZIONE : Cliente con ordini bloccati !        
      -              "               "    to   w-err-box-err-msg      .
      *                      *-----------------------------------------*
      *                      * A seconda della personalizzazione rela- *
      *                      * tiva alla modalita' di blocco del cli-  *
      *                      * ente si prosegue, oppure si esce simu-  *
      *                      * lando il tasto Exit                     *
      *                      *-----------------------------------------*
           if        w-prs-blo-cli-t01    =    "B"
                     move  "E"            to   w-cnt-tus-acc-tes
                     move  "#"            to   w-ctl-cod-cli-ext
                     go to acc-cli-sbt-ctl-800
           else      go to acc-cli-sbt-ctl-910.
       acc-cli-sbt-ctl-500.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           perform   acc-cli-sbt-bsc-000  thru acc-cli-sbt-bsc-999    .
      *                      *-----------------------------------------*
      *                      * Tipo di uscita a seconda della persona- *
      *                      * lizzazione                              *
      *                      *-----------------------------------------*
           if        w-prs-ttd-sts-dcc    =    "B"
                     go to acc-cli-sbt-ctl-930
           else      go to acc-cli-sbt-ctl-800.
       acc-cli-sbt-ctl-800.
      *              *-------------------------------------------------*
      *              * Uscita per controlli superati                   *
      *              *-------------------------------------------------*
           go to     acc-cli-sbt-ctl-999.
       acc-cli-sbt-ctl-900.
      *              *-------------------------------------------------*
      ...
      *                          * alternativo                         *
      *                          *-------------------------------------*
           move      w-let-arc-dcc-tuc    to   w-let-arc-cli-cod      .
           perform   let-arc-cli-000      thru let-arc-cli-999        .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Codice cliente subentran- *
      *    * te                                                        *
      *    *-----------------------------------------------------------*
       vis-cli-sbt-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione cliente su-   *
      *    * bentrante                                                 *
      *    *-----------------------------------------------------------*
       vis-cli-sbt-des-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Tipo movimento da emettere           *
      *    *-----------------------------------------------------------*
       acc-tmo-new-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Preparazione valore di default              *
      *                  *---------------------------------------------*
           move      w-tes-tmo-orc        to   w-tes-tmo-new (1)      .
       acc-tmo-new-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-zoc-ope      .
           move      w-tes-tmo-new (1)    to   w-cod-des-zoc-cod      .
           move      16                   to   w-cod-des-zoc-lin      .
           move      27                   to   w-cod-des-zoc-pos      .
           move      16                   to   w-cod-des-zoc-dln      .
       ...
       acc-tmo-new-110.
           perform   cod-des-zoc-cll-000  thru cod-des-zoc-cll-999    .
           if        w-cod-des-zoc-ope    =    "F+"
                     go to acc-tmo-new-115.
           if        w-cod-des-zoc-ope    =    "AC"
                     go to acc-tmo-new-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-tmo-new-115.
           perform   cod-des-zoc-foi-000  thru cod-des-zoc-foi-999    .
           go to     acc-tmo-new-110.
       acc-tmo-new-120.
           move      w-cod-des-zoc-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-tmo-new (1)    to   w-all-str-alf          .
           move      05                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        not  = spaces
                     go to acc-tmo-new-100.
      *                  *---------------------------------------------*
      *                  * Lettura archivio [zoc]                      *
      *                  *---------------------------------------------*
           move      w-tes-tmo-new (1)    to   w-let-arc-zoc-cod      .
           perform   let-arc-zoc-000      thru let-arc-zoc-999        .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione valori associati al tipo    *
      *                  * movimento ordini clienti                    *
      *                  *---------------------------------------------*
           move      w-let-arc-zoc-des    to   w-tes-tmo-new-des (1)  .
           move      w-let-arc-zoc-vld    to   w-tes-tmo-new-vld (1)  .
           move      w-let-arc-zoc-dpz    to   w-tes-tmo-new-dpz (1)  .
           move      w-let-arc-zoc-ord    to   w-tes-tmo-new-ord (1)  .
           move      w-let-arc-zoc-prd    to   w-tes-tmo-new-prd (1)  .
           move      w-let-arc-zoc-sgl    to   w-tes-tmo-new-sgl (1)  .
           move      w-let-arc-zoc-dtr    to   w-tes-tmo-new-dtr (1)  .
           move      w-let-arc-zoc-tip    to   w-tes-tmo-new-tip (1)  .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-tmo-new-des-000  thru vis-tmo-new-des-999    .
      ...
      *                  * Se a spaces : oltre                         *
      *                  *---------------------------------------------*
           if        w-tes-tmo-new (1)    =    spaces
                     go to acc-tmo-new-600.
      *                  *---------------------------------------------*
      *                  * Test su codice dipendenza                   *
      *                  *---------------------------------------------*
           if        w-tes-tmo-new-vld (1)
                                          not  = 02
                     go to acc-tmo-new-420.
           if        w-tes-cod-dpz        =    w-tes-tmo-new-dpz (1)
                     go to acc-tmo-new-420.
      *                      *-----------------------------------------*
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-nok-100.
      *              *-------------------------------------------------*
      *              * Test su tipo movimento da emettere              *
      *              *-------------------------------------------------*
           if        w-tes-tmo-new (1)    not  = spaces
                     go to cnt-tdo-nok-800.
           move      "Manca il tipo nuovo movimento !                   
      -              "               "    to   w-err-box-err-msg      .
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           ...
           move      spaces               to   w-tes-tmo-orc-dtr      .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           ...
           move      zero                 to   w-tes-cli-sbt (1)      .
           move      spaces               to   w-tes-cli-sbt-rag (1)  .
           move      spaces               to   w-tes-cli-sbt-via (1)  .
           move      spaces               to   w-tes-cli-sbt-loc (1)  .
           move      zero                 to   w-tes-cli-sbt-stc (1)  .
           move      spaces               to   w-tes-tmo-new (1)      .
           move      spaces               to   w-tes-tmo-new-des (1)  .
           move      zero                 to   w-tes-tmo-new-vld (1)  .
           move      zero                 to   w-tes-tmo-new-dpz (1)  .
           move      zero                 to   w-tes-tmo-new-ord (1)  .
           move      zero                 to   w-tes-tmo-new-prd (1)  .
           move      spaces               to   w-tes-tmo-new-sgl (1)  .
           move      spaces               to   w-tes-tmo-new-dtr (1)  .
           move      spaces               to   w-tes-tmo-new-tip (1)  .
      ...
      *                          * Messaggio di errore                 *
      *                          *-------------------------------------*
           move      "Ordine cliente completamente evaso !              
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                          *-------------------------------------*
      *                          * Flag di uscita ad errore            *
      ...
      *                      *-----------------------------------------*
           move      rf-ocr-tip-rig       to   w-scr-mov-fil-wtr      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-dpz        to   w-att-orc-prt-dpz      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-tmo-new-sgl (1)
                                          to   w-att-orc-ndo-sgl      .
      ...
      *                      * Quantita' in ordine                     *
      *                      *-----------------------------------------*
           subtract  d-qev-roc-qta-dev    from d-qev-roc-qta-ord
                                        giving rf-ocr-qta-ord         .
      *                      *-----------------------------------------*
      *                      * Importo in riga                         *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-tes-tmo-new (1)    to   rf-ocr-tmo-orc         .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
      ...
      *                      * Codice archivio                         *
      *                      *-----------------------------------------*
           move      w-tes-cli-sbt (1)    to   rf-ocr-cod-arc         .
      *                      *-----------------------------------------*
      ...
      *                      * Quantita' ordinata                      *
      *                      *-----------------------------------------*
           move      d-qev-roc-qta-dev    to   rf-ocr-qta-ord         .
      *                      *-----------------------------------------*
      *                      * Importo in riga                         *
      *                      *-----------------------------------------*
           perform   det-imp-rig-000      thru det-imp-rig-999        .
      ...
      *                  *---------------------------------------------*
       ...
       scr-mov-fil-600.
      *              *-------------------------------------------------*
      *              * Scrittura record [oct] subentrante              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * Tipo movimento                              *
      *                  *---------------------------------------------*
           move      w-tes-tmo-new (1)    to   rf-oct-tmo-orc         .
      *                  *---------------------------------------------*
      *                  * Data documento                              *
      *                  *---------------------------------------------*
      ...
      *                  * Codice archivio                             *
      *                  *---------------------------------------------*
           move      w-tes-cli-sbt (1)    to   rf-oct-cod-arc         .
      *                  *---------------------------------------------*
      *                  * Codice dipendenza dell'archivio             *
      *                  *---------------------------------------------*
______*    move      spaces               to   rf-oct-dpz-arc         .
      *                  *---------------------------------------------*
      *                  * Codice archivio per la fatturazione         *
      *                  *---------------------------------------------*
           move      w-tes-cli-sbt (1)    to   rf-oct-arc-plf         .
      *                  *---------------------------------------------*
      *                  * Codice dipendenza dell'archivio per la      *
      *                  * fatturazione                                *
      *                  *---------------------------------------------*
______*    move      spaces               to  rf-oct-dpz-plf          .
      *                  *---------------------------------------------*
