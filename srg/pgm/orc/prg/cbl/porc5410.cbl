      ...
      *                       Ultima revisione:    NdK del 18/10/23    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   INTERROGAZIONE SU DISTINTE DI INVIO  "       .
      ...
      *                  *---------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [oce]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATSYS    "         to   f-key                  .
           move      w-det-nrg-dat-dtd    to   rf-oce-ide-dat         .
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-oce-num-dst       to   w-rot-l01-num-dst      .
       qry-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-oce-num-dst       to   w-buf-l01-num-dst      .
           move      rf-oce-dat-reg       to   w-buf-l01-dat-reg      .
      ...
      *
           if        w-buf-l01-ctr-ann    =    zero
                     ...
                     move  "invio ANNULLATO"
                                          to   w-all-str-cat (4)
           else      move  "-"            to   w-all-str-cat (2)
                     move  v-edt          to   w-all-str-cat (3)
                     move  "invii ANNULLATI"
                                          to   w-all-str-cat (4)      .
      *
      ...
      *              *-------------------------------------------------*
           ...
           else if   rf-oce-flg-apr       not  = spaces
                     move  "Documenti preparati"
                                          to   w-buf-l01-sts-dst
           else      move  "Distinta generata"
                                          to   w-buf-l01-sts-dst      .
      *              *-------------------------------------------------*
      *              * Se generata automaticamente                     *
      *              *-------------------------------------------------*
           if        rf-oce-tip-dst       =    02
                     move  "Distinta automatica"
                                          to   w-buf-l01-sts-dst      .
       qry-liv-det-999.
           exit.
