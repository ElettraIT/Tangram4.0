      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "pgm/orc/num/ioc/obj/innumoce"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
      ...
      *                      *-----------------------------------------*
           ...
           move      "Ordine n."          to   w-all-str-cat (1)      .
           move      "CHIUSO!"            to   w-all-str-cat (3)      .
      ...
      *                  *---------------------------------------------*
       stp-srt-inp-500.
      *                  *---------------------------------------------*
      *                  * Test se ordine gia' presente in distinta    *
      *                  * di spedizione                               *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-oct-num-prt       to   w-det-dst-num-prt      .
           perform   stp-srt-inp-oce-000  thru stp-srt-inp-oce-999    .
      ...
      *
           ...
           move      rf-oct-cod-age       to   d-con-arc-cod-arc      .
      ...
      *                      *-----------------------------------------*
       ...
       stp-srt-inp-575.
      *                  *---------------------------------------------*
      *                  * Se conferma ordine senza indirizzo mail     *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Editing numero documento                *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      04                   to   w-all-str-num          .
           move      "Ordine n."          to   w-all-str-cat (1)      .
           move      "senza mail per la"  to   w-all-str-cat (3)      .
      *
           if        rf-oct-inl-dcm       =    01
                     move  "Sede"         to   w-all-str-cat (4)
           else if   rf-oct-inl-dcm       =    02
                     move  "Sede Legale"  to   w-all-str-cat (4)
           else      move  "Dipendenza"   to   w-all-str-cat (4)      .
      *
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   m-msg                  .
      *                      *-----------------------------------------*
      ...
      *                      * Normalizzazioni                         *
      *                      *-----------------------------------------*
           move      01                   to   d-con-arc-num-ele      .
           move      spaces               to   d-con-arc-num-con (1)  .
      *                      *-----------------------------------------*
      *                      * Test se ordini senza mail selezionati   *
      *                      *-----------------------------------------*
           if        rr-sne-eml           not  = 02
                     go to stp-srt-inp-200.
       stp-srt-inp-580.
      *                  *---------------------------------------------*
      ...
      *
           move      w-all-str-alf        to   d-con-arc-num-con (1)  .
       stp-srt-inp-585.
      *                  *---------------------------------------------*
      *                  * Ciclo per indirizzi multipli                *
      *                  *---------------------------------------------*
           move      zero                 to   w-wrk-ctr-001          .
       stp-srt-inp-590.
           add       1                    to   w-wrk-ctr-001          .
           if        w-wrk-ctr-001        >    d-con-arc-num-ele
                     go to stp-srt-inp-200.
           if        w-wrk-ctr-001        >    d-con-arc-num-edr
                     go to stp-srt-inp-200.
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-oct-dpz-arc       to   srt-dpz-cli            .
       stp-srt-inp-640.
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           call      s-pat               using f
                                               rf-dcc                 .
      *                          *-------------------------------------*
      *                          * Memorizzazione codice EDI           *
      *                          *-------------------------------------*
           move      rf-dcc-idn-ema       to   srt-cod-edi            .
      *                      *-----------------------------------------*
      *                      * Record [oct]                            *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-800.
      *              *-------------------------------------------------*
      *              * Riciclo a indirizzo mail successivo             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-dst-num-prt    to   rf-oce-prt-doc         .
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-oce-prt-doc       not  = w-det-dst-num-prt
                     go to stp-srt-inp-oce-900.
       stp-srt-inp-oce-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-oce-200.
       stp-srt-inp-oce-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-oce-999.
       stp-srt-inp-oce-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Preparazione dati per scrittura [oce]           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "9"                  to   p-edm                  .
           move      rf-oct-cod-dpz       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-wrk-doc-dpz          .
      *                      *-----------------------------------------*
      *                      * Editing numero documento                *
      *                      *-----------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           move      spaces               to   p-sgn                  .
           move      "<"                  to   p-edm                  .
           move      rf-oct-num-doc       to   w-wrk-nft-int          .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-wrk-doc-aae        to   w-all-str-cat (3)      .
      *
           if        rf-oct-cod-dpz       =    zero or
                     rf-oct-cod-dpz       =    01
                     move  spaces         to   w-all-str-cat (4)
                     move  spaces         to   w-all-str-cat (5)
           else      move  "-"            to   w-all-str-cat (4)
                     move  w-wrk-doc-dpz  to   w-all-str-cat (5)      .
      *
           move      "_"                  to   w-all-str-cat (6)      .
           move      w-wrk-doc-nde        to   w-all-str-cat (7)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
      *                  *---------------------------------------------*
      ...
      *              * zioni [numoce]                                  *
      *              *-------------------------------------------------*
           move      w-num-dst-scl-ann    to   rn-num-oce-scl-ann     .
      *              *-------------------------------------------------*
      *              * Lettura tabella numerazioni [numoce]            *
      *              *-------------------------------------------------*
           move      "GT"                 to   f-ope                  .
           move      "pgm/orc/num/ioc/obj/innumoce"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           move      rn-num-oce-num-dst   to   w-num-dst-num-dst      .
      ...
      *                  *---------------------------------------------*
           move      w-num-dst-num-dst    to   rn-num-oce-num-dst     .
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-oce-ide-dat         .
           move      s-ute                to   rf-oce-ide-ute         .
           move      s-fas                to   rf-oce-ide-fas         .
           move      rr-num-dst           to   rf-oce-num-dst         .
           move      w-cix-num-ele        to   rf-oce-num-prg         .
           move      s-dat                to   rf-oce-dat-reg         .
           move      01                   to   rf-oce-tip-dst         .
           move      "C"                  to   rf-oce-tip-arc         .
           move      srt-cod-cli          to   rf-oce-cod-arc         .
           move      srt-dpz-cli          to   rf-oce-dpz-arc         .
           move      zero                 to   rf-oce-tip-ids         .
           move      rr-prm-inv (4)       to   rf-oce-eml-mit         .
           move      srt-eml-ind          to   rf-oce-eml-ind         .
           move      spaces               to   rf-oce-eml-all         .
           move      zero                 to   rf-oce-tip-doc         .
           move      rf-oct-tmo-orc       to   rf-oce-tmo-doc         .
           move      rf-oct-dat-doc       to   rf-oce-dat-doc         .
           move      w-wrk-doc-nda        to   rf-oce-num-doc         .
           move      rf-oct-num-prt       to   rf-oce-prt-doc         .
           ...
           move      srt-cod-edi          to   rf-oce-cod-edi         .
