      ...
      *                       Ultima revisione:    NdK del 20/03/26    *
      *                    ------------------------------------------- *
      ...
      *                    del file 'orc' gestito da 'orc001'          *
      *                                                                *
      *                    N.B.: implementare flag no-reply (ELETTRA)  *
      *                          in orc001 [orc] e t_sender            *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  f-xxx.
           05  f-xxx-usp                  pic  x(40)                  .
           05  f-xxx-psp                  pic  x(12)                  .
      ...
      *                  *---------------------------------------------*
           move      "morc.txt"           to   f-xxx-msg              .
      *                  *---------------------------------------------*
      *                  * Default nome testo soggetto                 *
      *                  *---------------------------------------------*
           move      "sorc.txt"           to   f-xxx-sgt              .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-oce-flg-apr       =    spaces
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Controllo su percorso archivio attachement  *
      *                  *---------------------------------------------*
           if        rf-oce-eml-all       =    spaces
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Controllo su indirizzo mail destinatario    *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * CONTROLLO PROVVISORIAMENTE INIBITO  *
      *                          * E DA PERFEZIONARE PER /abd/tmp      *
      *                          *-------------------------------------*
      ...
      *                          * documento                           *
      *                          *-------------------------------------*
           move      rf-oct-num-doc       to   w-det-rec-fil-num      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      06                   to   v-car                  .
      *
           if        w-all-str-cat (4)    =    spaces
                     move  w-all-str-cat (3)
                                          to   v-alf
           else      move  w-all-str-cat (4)
                                          to   v-alf                  .
      *
      ...
      *                  *---------------------------------------------*
           if        w-det-sec-att-ctr    >    w-prs-sec-att-inv
                     go to  prn-fin-cic-snd-400.
      *                  *---------------------------------------------*
      *                  * 1 secondo di attesa                         *
      *                  *---------------------------------------------*
      ...
      *              *   - flag no-reply (opzionale, default '')       *
      *              *     (ELETTRA)                                   *
      *              *-------------------------------------------------*
...
______*              "NR,"      delimited by   size
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Eventuale invio file EDI                        *
      *              *-------------------------------------------------*
______*    perform   prn-liv-det-edi-000  thru prn-liv-det-edi-999    .
       prn-liv-det-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-oce-dat-inv         .
      *              *-------------------------------------------------*
      *              * Aggiornamento ora invio                         *
      *              *-------------------------------------------------*
           move      s-ora                to   rf-oce-ora-inv         .
           multiply  100                  by   rf-oce-ora-inv         .
           add       s-min                to   rf-oce-ora-inv         .
      *              *-------------------------------------------------*
      *              * Update record [oce]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine di eventuale invio file EDI                    *
      *    *-----------------------------------------------------------*
       prn-liv-det-edi-000.
      *              *-------------------------------------------------*
      *              * Test se Cliente con EDI                         *
      *              *-------------------------------------------------*
           if        rf-oce-cod-edi       =    spaces or
                     rf-oce-fil-edi       =    spaces
                     go to prn-liv-det-edi-900.
       prn-liv-det-edi-100.
      *              *-------------------------------------------------*
