      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Pulizia ordini clienti                      *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  f-xxx.
           05  f-xxx-nam                  pic  x(04)   value "oct "   .
      ...
      *    *-----------------------------------------------------------*
      ...
      -              "idati, cioe' chiusi, fino alla"
           ...
           move      15                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "      data richiesta e gli ordini pro-forma, anche
      -              " se non chiusi.               "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
       ...
       pul-let-seq-200.
      *              *-------------------------------------------------*
      *              * Incremento contatore records [oct] letti        *
      *              *-------------------------------------------------*
      ...
      *              * tare                                            *
      *              *-------------------------------------------------*
           if        rf-oct-dat-doc       >    rr-dat-pul
                     go to pul-sel-rec-800.
       pul-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Se pro-forma, da eliminare                      *
      *              *-------------------------------------------------*
           if        rf-oct-tip-ord       =    "P"
      ...
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [oct] scritti  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "#"                  to   w-cnt-pul-flg-sub      .
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [oct] elimina- *
      *                  * ti                                          *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione contatore records [ocr]     *
      *                  * scritti                                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-ocr-num-prt       not  = rf-oct-num-prt
                     go to pul-put-app-200.
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [ocr] scritti  *
      *                  *---------------------------------------------*
           add       1                    to   w-pul-put-app-ctr      .
      *                  *---------------------------------------------*
      *                  * Sub-ciclo per file [ocp]                    *
      *                  *---------------------------------------------*
           perform   pul-put-app-ocp-000  thru pul-put-app-ocp-999    .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       pul-put-app-200.
      *              *-------------------------------------------------*
      *              * Test su contatore records [ocr] scritti : se a  *
      *              * zero si esce                                    *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       pul-put-app-400.
      *                  *---------------------------------------------*
      *                  * Lettura sequenziale record [ocx]            *
      *                  *---------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/orc/fls/ioc/obj/iofocx"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-ocx                 .
      *                  *---------------------------------------------*
      *                  * Riciclo su lettura sequenziale record [ocx] *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       pul-put-app-ocp-800.
      *              *-------------------------------------------------*
      *              * Riciclo su lettura sequenziale record [ocp]     *
      *              *-------------------------------------------------*
           go to     pul-put-app-ocp-200.
       pul-put-app-ocp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     pul-put-app-ocp-999.
       pul-put-app-ocp-999.
           exit.
