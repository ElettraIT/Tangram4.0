      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Chiusura o riapertura ordine cliente        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CHIUSURA - RIAPERTURA ORDINE CLIENTE  "       .
      ...
      *                          *-------------------------------------*
           ...
           move      rf-oct-flg-och       to   w-tes-flg-och (1)      .
      *                          *-------------------------------------*
      ...
      *                      * Flag di riga chiusa                     *
      *                      *-----------------------------------------*
           move      w-tes-flg-och (1)    to   rf-ocr-flg-rch         .
      *                      *-----------------------------------------*
      *                      * Update record [ocr]                     *
      *                      *-----------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *                  * Flag di ordine chiuso                       *
      *                  *---------------------------------------------*
           move      w-tes-flg-och (1)    to   rf-oct-flg-och         .
      *                  *---------------------------------------------*
      *                  * Update record [oct]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
