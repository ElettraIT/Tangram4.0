      ...
      *                                   Fase:    orc990              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 24/09/98    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione dati di testata ordini clienti     *
      *                                                                *
      *                    N.B.: manca la pulizia di [ocp]             *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "Gestione dati di testata ordini clienti "       .
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Formato di accettazione saa.dd.nnnnnn"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *                  * Data ordine cliente                         *
      *                  *---------------------------------------------*
           perform   acc-ocl-dat-000      thru acc-ocl-dat-999        .
           if        v-key                =    "NXSC"
      ...
      *                  *---------------------------------------------*
           perform   acc-ocl-num-000      thru acc-ocl-num-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Data ordine cliente                             *
      *              *-------------------------------------------------*
           perform   vis-ocl-dat-000      thru vis-ocl-dat-999        .
      *              *-------------------------------------------------*
      *              * Numero ordine cliente                           *
      *              *-------------------------------------------------*
           perform   vis-ocl-num-000      thru vis-ocl-num-999        .
      *              *-------------------------------------------------*
      ...
      *              * Data ordine cliente                             *
      *              *-------------------------------------------------*
           perform   pmt-ocl-dat-000      thru pmt-ocl-dat-999        .
      *              *-------------------------------------------------*
      *              * Numero ordine cliente                           *
      *              *-------------------------------------------------*
           perform   pmt-ocl-num-000      thru pmt-ocl-num-999        .
      *              *-------------------------------------------------*
      *              * Data ultima modifica                            *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Data ordine cliente           *
      *    *-----------------------------------------------------------*
       pmt-ocl-dat-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Numero ordine cliente         *
      *    *-----------------------------------------------------------*
       pmt-ocl-num-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Data ordine cliente          *
      *    *-----------------------------------------------------------*
       acc-ocl-dat-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-ocl-dat-100.
       acc-ocl-dat-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Data ordine cliente       *
      *    *-----------------------------------------------------------*
       vis-ocl-dat-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Numero ordine cliente        *
      *    *-----------------------------------------------------------*
       acc-ocl-num-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-ocl-num-100.
       acc-ocl-num-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Numero ordine cliente     *
      *    *-----------------------------------------------------------*
       vis-ocl-num-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              * Test                                            *
      *              *-------------------------------------------------*
______*    if        rf-oct-tmo-orc       =    spaces or
______*              rf-oct-dat-doc       =    zero   or
______*              rf-oct-num-doc       =    zero
______*              move  "#"            to   w-cnt-tdo-key-flg      .
       cnt-tdo-key-999.
           exit.
      ...
      *                      * Rewrite record [oct]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-oct-000      thru rew-rec-oct-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-oct-num-prt       to   w-rig-num-prt          .
      *              *-------------------------------------------------*
      ...
      *                  * Delete record [oct]                         *
      *                  *---------------------------------------------*
           perform   del-rec-oct-000      thru del-rec-oct-999        .
       del-mov-fil-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              * Preparazione chiave                             *
      *              *-------------------------------------------------*
           move      rf-ocr-num-prg       to   w-rig-key-prg
                                              (w-rig-num-ele)         .
       del-mov-fil-pcr-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Delete record file righe [ocr]              *
      *                  *---------------------------------------------*
           perform   del-rec-ocr-000      thru del-rec-ocr-999        .
      *                  *---------------------------------------------*
      *                  * Delete record file righe [ocx]              *
      *                  *---------------------------------------------*
           perform   del-rec-ocx-000      thru del-rec-ocx-999        .
       del-mov-fil-crg-600.
      *              *-------------------------------------------------*
      *              * Riciclo a riga successiva                       *
      *              *-------------------------------------------------*
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      w-rig-num-prt        to   rf-oct-num-prt         .
       cmp-rec-oct-999.
           exit.

      *    *===========================================================*
      *    * Cancellazione record righe [ocr]                          *
      *    *-----------------------------------------------------------*
       del-rec-ocr-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      ...
      *    *===========================================================*
      *    * Cancellazione record righe [ocx]                          *
      *    *-----------------------------------------------------------*
       del-rec-ocx-000.
      *              *-------------------------------------------------*
      *              * Tipo record 01                                  *
      ...
      *                  * Composizione record                         *
      *                  *---------------------------------------------*
           move      w-rig-num-prt        to   rf-ocx-num-prt         .
           move      w-rig-key-prg
                    (w-rig-ctr-ele)       to   rf-ocx-num-prg         .
      ...
      *    *===========================================================*
      *    * Cancellazione record testata [oct]                        *
      *    *-----------------------------------------------------------*
       del-rec-oct-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
