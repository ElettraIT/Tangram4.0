      ...
      *                                                                *
      *              Input  : w-cod-des-zoc-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zoc-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-zoc-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-zoc-cod : codice tipo movim.   *
      *                                                                *
      *                       w-cod-des-zoc-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-zoc-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-zoc-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-zoc-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zoc-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-zoc-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zoc-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-zoc-cod : codice tipo movim.   *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-toc.
           05  w-aux-cde-toc-nli          pic  9(02)                  .
           05  w-aux-cde-toc-crb          pic  9(02)                  .
           05  w-aux-cde-toc-cpb          pic  9(02)                  .
           05  w-aux-cde-toc-cpa          pic  9(02)                  .
           05  w-aux-cde-toc-bix          pic  9(02)                  .
           05  w-aux-cde-toc-buf
                               occurs 30.
               10  w-aux-cde-toc-bco      pic  x(05)                  .
               10  w-aux-cde-toc-bde      pic  x(30)                  .
           05  w-aux-cde-toc-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-toc-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-toc-lt2      pic  9(01)                  .
           05  w-aux-cde-toc-dup          pic  x(30)                  .
           05  w-aux-cde-toc-dmx.
               10  w-aux-cde-toc-dch
                               occurs 30  pic  x(01)                  .
           05  w-aux-cde-toc-c01          pic  9(02)                  .
           05  w-aux-cde-toc-c02          pic  9(02)                  .
           05  w-aux-cde-toc-c03          pic  9(02)                  .
           05  w-aux-cde-toc-c04          pic  9(02)                  .
           05  w-aux-cde-toc-c05          pic  9(02)                  .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-zoc
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zoc-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-zoc-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-zoc-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-zoc-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-zoc-ope    =    "A+" or
                     w-cod-des-zoc-ope    =    "I+" or
                     w-cod-des-zoc-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-zoc-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-cod-des-zoc-cod    to   w-cod-des-zoc-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-zoc-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-zoc-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-zoc-s90    to   v-ufk                  .
           move      w-cod-des-zoc-lin    to   v-lin                  .
           move      w-cod-des-zoc-pos    to   v-pos                  .
           move      w-cod-des-zoc-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-zoc-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zoc-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-zoc-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-zoc-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-zoc-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-zoc-cod    to   w-cod-des-zoc-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-zoc-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-zoc-dln    =    zero or
                     w-cod-des-zoc-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-toc-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      w-cod-des-zoc-dln    to   v-lin                  .
           move      w-cod-des-zoc-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-zoc-dln    to   v-lin                  .
           move      w-cod-des-zoc-dps    to   v-pos                  .
           move      w-aux-cde-toc-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-toc-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-toc-dup    to   w-aux-cde-toc-dmx      .
           move      30                   to   w-aux-cde-toc-c01      .
       aco-680.
           if        w-aux-cde-toc-c01    >    zero
                     if    w-aux-cde-toc-dch
                          (w-aux-cde-toc-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-toc-dch
                                              (w-aux-cde-toc-c01)
                           subtract 1     from w-aux-cde-toc-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-toc-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-toc-dup    to   rf-zoc-des-key         .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-zoc-des-key       >    w-aux-cde-toc-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-toc-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-toc-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      rf-zoc-cod-toc       to   w-aux-cde-toc-bco
                                              (w-aux-cde-toc-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione tipo movimento      *
      *                              *---------------------------------*
           move      rf-zoc-des-toc       to   w-aux-cde-toc-bde
                                              (w-aux-cde-toc-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-toc-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-toc-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-toc-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      30                   to   s-car                  .
           move      w-aux-cde-toc-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-toc-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-toc-bco
                    (w-aux-cde-toc-bix)   to   w-cod-des-zoc-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-toc-crb    to   w-aux-cde-toc-cpb      .
           subtract  1                    from w-aux-cde-toc-cpb      .
           divide    6                    into w-aux-cde-toc-cpb      .
           add       1                    to   w-aux-cde-toc-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-toc-c01      .
      *                              *---------------------------------*
      ...
      *                              * di indice (w-aux-cde-toc-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-toc-c01    to   w-aux-cde-toc-nli      .
       aco-865.
           if        w-aux-cde-toc-nli    >    6
                     subtract  6          from w-aux-cde-toc-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-toc-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-toc-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-toc-c01    <    w-aux-cde-toc-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-toc-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-toc-cpa    <    w-aux-cde-toc-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-toc-nli    to   v-lin                  .
           move      30                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-toc-c01    to   w-aux-cde-toc-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-toc-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-toc-cpa    to   w-aux-cde-toc-c01      .
           multiply  6                    by   w-aux-cde-toc-c01      .
           subtract  5                    from w-aux-cde-toc-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-toc-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-toc-c01    to   w-aux-cde-toc-c02      .
           add       5                    to   w-aux-cde-toc-c02      .
           divide    6                    into w-aux-cde-toc-c02      .
           move      w-aux-cde-toc-c02    to   w-aux-cde-toc-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-toc-c02      .
           multiply  6                    by   w-aux-cde-toc-c02      .
           add       1                    to   w-aux-cde-toc-c02      .
           add       5
                     w-aux-cde-toc-c02  giving w-aux-cde-toc-c03      .
           move      w-aux-cde-toc-c03    to   w-aux-cde-toc-c04      .
           if        w-aux-cde-toc-c03    >    w-aux-cde-toc-crb
                     move  w-aux-cde-toc-crb
                                          to   w-aux-cde-toc-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-toc-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      05                   to   v-car                  .
           move      w-aux-cde-toc-c05    to   v-lin                  .
           move      23                   to   v-pos                  .
           move      w-aux-cde-toc-bco
                    (w-aux-cde-toc-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-toc-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-toc-c02    not  > w-aux-cde-toc-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-toc-c02    >    w-aux-cde-toc-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-toc-cpa    to   w-aux-cde-toc-lt1      .
           move      w-aux-cde-toc-cpb    to   w-aux-cde-toc-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-toc-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
