      ...
      *                       Ultima revisione:    NdK del 04/05/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma porc3701:        *
      *                                                                *
      *                    Portafoglio ordini per responsabile         *
      *                                                                *
      *================================================================*
      ...
      *        * Codice responsabile                                   *
      *        *-------------------------------------------------------*
           05  rr-cod-rsp                 pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice responsabile, denominazione                    *
      *        *-------------------------------------------------------*
           05  rr-cod-rsp-den             pic  x(40)                  .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      05                   to   w-cod-mne-zro-lin      .
           move      30                   to   w-cod-mne-zro-pos      .
           move      05                   to   w-cod-mne-zro-dln      .
