      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf5701:        *
      *                                                                *
      ...
      *        *  - 02 : Solo servizi                                  *
      *        *  - 03 : Solo imballi                                  *
      *        *  - 04 : Solo prodotti 'tipo 4'                        *
      *        *  - 05 : Solo prodotti 'tipo 5'                        *
      *        *  - 06 : Solo prodotti 'tipo 6'                        *
      *        *  - 07 : Solo prodotti 'tipo 7'                        *
      *        *  - 08 : Solo prodotti 'tipo 8'                        *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-pro.
               10  w-exp-tip-pro-num      pic  9(02)       value 10   .
               ...
               10  w-exp-tip-pro-tbl.
                   ...
                   15  filler             pic  x(35) value
                            "Solo imballi                       "     .
                   15  filler             pic  x(35) value
                            "Solo prodotti 'tipo 4'             "     .
                   15  filler             pic  x(35) value
                            "Solo prodotti 'tipo 5'             "     .
                   15  filler             pic  x(35) value
                            "Solo prodotti 'tipo 6'             "     .
                   15  filler             pic  x(35) value
                            "Solo prodotti 'tipo 7'             "     .
                   15  filler             pic  x(35) value
                            "Solo prodotti 'tipo 8'             "     .
                   15  filler             pic  x(35) value
      ...
      *              *-------------------------------------------------*
           ...
           if        rr-tip-pro           =    99
                     ...
                     move  06             to   v-num
           else if   rr-tip-pro           =    06
                     move  07             to   v-num
           else if   rr-tip-pro           =    07
                     move  08             to   v-num
           else if   rr-tip-pro           =    08
                     move  09             to   v-num
           else if   rr-tip-pro           =    09
                     move  10             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  04             to   rr-tip-pro
           else if   v-num                =    06
                     move  05             to   rr-tip-pro
           else if   v-num                =    07
                     move  06             to   rr-tip-pro
           else if   v-num                =    08
                     move  07             to   rr-tip-pro
           else if   v-num                =    09
                     move  08             to   rr-tip-pro
           else if   v-num                =    10
      ...
      *                  *---------------------------------------------*
           if        rr-tip-pro           not  = 99 and
                     rr-tip-pro           not  = 01 and
                     rr-tip-pro           not  = 02 and
                     rr-tip-pro           not  = 03 and
                     rr-tip-pro           not  = 04 and
                     rr-tip-pro           not  = 05 and
                     rr-tip-pro           not  = 06 and
                     rr-tip-pro           not  = 07 and
                     rr-tip-pro           not  = 08 and
                     rr-tip-pro           not  = 09
