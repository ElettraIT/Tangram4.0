      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf5801:        *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per fornitore preferenziale prodotto.       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " FATTURATO PER FORNITORE PREFERENZIALE  "       .
      ...
      *        *-------------------------------------------------------*
      *        * Tipo di ordinamento per il fornitore                  *
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento fornitore                 *
      *        *-------------------------------------------------------*
           05  w-exp-tor-fnt.
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-250.
      *                  *---------------------------------------------*
      *                  * Tipo di ordinamento per fornitore           *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento fornitore prodotti           *
      *    *-----------------------------------------------------------*
       pmt-tor-fnt-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * normalizza il tipo ordinamento fornitori ed *
      ...
      *                      *-----------------------------------------*
      *                      * Normalizzazione tipo ordinamento forni- *
      *                      * tori                                    *
      *                      *-----------------------------------------*
           move      zero                 to   rr-tor-fnt             .
      *                      *-----------------------------------------*
      *                      * Visualizzazione tipo ordinamento forni- *
      *                      * tori                                    *
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo ordinamento per fornitore             *
      *    *                prodotti                                   *
      *    *-----------------------------------------------------------*
       acc-tor-fnt-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       acc-tor-fnt-025.
      *                  *---------------------------------------------*
      *                  * Se impostato un codice fornitore diverso da *
      *                  * zero : nessuna                              *
      *                  *---------------------------------------------*
           if        rr-cod-fnt           =    zero
                     go to acc-tor-fnt-100
           else      go to acc-tor-fnt-999.
       acc-tor-fnt-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Tipo ordinamento fornitore              *
      *    *-----------------------------------------------------------*
       vis-tor-fnt-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-150.
      *              *-------------------------------------------------*
      *              * Controllo : Tipo di ordinamento per fornitore   *
      *              *-------------------------------------------------*
       tdo-ric-sel-151.
           ...
           move      "Manca il tipo di ordinamento per il fornitore!   
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-152.
           if        rr-tor-fnt           =    01 or
