      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf7401:       *
      *                                                                *
      ...
      *            *---------------------------------------------------*
      *            * Nr. documenti trattati per la classe geografica   *
      *            *---------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       sel-fit-rec-700.
      *              *-------------------------------------------------*
      *              * Selezione su categoria sconto in riga clienti   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rr-ccs-cli           not  = zero          and
                     rr-ccs-cli           not  = rf-fit-csr-aac
                     go to sel-fit-rec-900.
       sel-fit-rec-800.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       agg-abc-kk0-500.
      *              *-------------------------------------------------*
      *              * Valore ABC per codice classe geografica cliente *
      *              *-------------------------------------------------*
       agg-abc-kk0-525.
      *                  *---------------------------------------------*
      *                  * Se la statistica e' sul nuovo fatturato o   *
      ...
      *                  *---------------------------------------------*
      *                  * Solo se tipo ordinamento classe geografica  *
      *                  *   - 01 : Ordinamento ABC decrescente        *
      *                  *   - 02 : Ordinamento ABC crescente          *
      *                  * Altrimenti nessuna azione                   *
      *                  *---------------------------------------------*
      ...
      *                  * tate per l'agente                           *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-num-cgc      .
      *                  *---------------------------------------------*
      *                  * Numero di agenti trattati                   *
      *                  *---------------------------------------------*
      ...
      *                  * geografica cliente e della descrizione      *
      *                  *---------------------------------------------*
       prn-fin-lr1-331.
      *                      *-----------------------------------------*
      *                      * Preparazione                            *
      ...
      *              * documenti per ogni classe geografica cliente    *
      *              *-------------------------------------------------*
       prn-fin-lr1-420.
      *                  *---------------------------------------------*
      *                  * Test se linee residue sufficienti           *
      ...
      *                  * senza eseguire l'interlinea di separazione  *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-tcg-cli           =    01
                     go to prn-fin-lr2-451
           else if   rr-tcg-cli           =    02
                     go to prn-fin-lr2-452
           else if   rr-tcg-cli           =    03
                     go to prn-fin-lr2-453.
       prn-fin-lr2-451.
           move      "Totale nazione :                                  
      -              "      "             to   w-stp-sta-tot-lit      .
           go to     prn-fin-lr2-460.
       prn-fin-lr2-452.
           move      "Totale regione :                                  
      -              "      "             to   w-stp-sta-tot-lit      .
           go to     prn-fin-lr2-460.
      ...
      *                      *-----------------------------------------*
       ...
       prn-fin-lr2-470.
      *                      *-----------------------------------------*
      *                      * Richiamo routine di stampa totali       *
      *                      *-----------------------------------------*
           perform   stp-sta-tot-000      thru stp-sta-tot-999        .
       prn-fin-lr2-480.
      *                  *---------------------------------------------*
      ...
      *                      * classe geografica clientee della de-    *
      *                      * scrizione                               *
      *                      *-----------------------------------------*
       prn-fin-lr1-651.
      *                          *-------------------------------------*
      ...
      *                  * la classe geografica cliente, bensi' uno    *
      *                  * successivo                                  *
      *                  *---------------------------------------------*
       prn-liv-det-680.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-031.
           move      "PER AGENTE - NAZIONE                              
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-032.
           move      "PER AGENTE - REGIONE                              
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-033.
           move      "PER AGENTE - PROVINCIA                            
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
