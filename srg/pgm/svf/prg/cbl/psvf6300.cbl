      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf6301:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Tipo classe statistica prodotto                       *
      *        *-------------------------------------------------------*
           05  w-sav-tcs-pro              pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Tipo classe statistica cliente                        *
      *        *-------------------------------------------------------*
           05  w-sav-tcs-cli              pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo classe statistica prodoto             *
      *        *-------------------------------------------------------*
           05  w-exp-tcs-pro.
               10  w-exp-tcs-pro-num      pic  9(02)       value 4    .
               10  w-exp-tcs-pro-lun      pic  9(02)       value 30   .
               10  w-exp-tcs-pro-tbl.
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "Solo il totale per ogni classe di cliente         ".
                   15  filler             pic  x(50) value
                  "Con la lista documenti per ogni classe di cliente ".
                   15  filler             pic  x(50)                  .
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento classe statistica prodot- *
      *        *            ti                                         *
      *        *-------------------------------------------------------*
           05  w-exp-tor-csp.
               10  w-exp-tor-csp-num      pic  9(02)       value 8    .
               ...
               10  w-exp-tor-csp-tbl.
                  ...
                  "Ordinamento ABC crescente sulla quantita'         ".
                   15  filler             pic  x(50) value
                  "Ordinamento per descrizione classe                ".
                   15  filler             pic  x(50) value
                  "Ordinamento per codice classe                     ".
                   15  filler             pic  x(50) value
                  "Ordinamento per mnemonico classe                  ".
                   15  filler             pic  x(50) value
                  "Ordinamento per numero di sequenza classe         ".
      *        *-------------------------------------------------------*
      *        * Work per : Tipo classe statistica cliente             *
      *        *-------------------------------------------------------*
           05  w-exp-tcs-cli.
               10  w-exp-tcs-cli-num      pic  9(02)       value 3    .
               10  w-exp-tcs-cli-lun      pic  9(02)       value 30   .
               10  w-exp-tcs-cli-tbl.
                   15  filler             pic  x(30) value
                            "Zona                          "          .
                   15  filler             pic  x(30) value
                            "Categoria                     "          .
                   15  filler             pic  x(30) value
                            "Codice statistico             "          .
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento classe statistica clienti *
      *        *-------------------------------------------------------*
           05  w-exp-tor-csc.
               10  w-exp-tor-csc-num      pic  9(02)       value 7    .
               10  w-exp-tor-csc-lun      pic  9(02)       value 50   .
               ...
               10  w-exp-tor-csc-t00.
                  ...
                  "Ordinamento per codice statistico                 ".
                   15  filler             pic  x(50) value
                  "Ordinamento per mnemonico del codice statistico   ".
               10  w-exp-tor-csc-t01.
                   15  filler             pic  x(50) value
                  "Ordinamento ABC decrescente sul fatturato         ".
                   15  filler             pic  x(50) value
                  "Ordinamento ABC decrescente sulla quantita'       ".
                  ...
                  "Ordinamento ABC crescente sulla quantita'         ".
                   15  filler             pic  x(50) value
                  "Ordinamento per descrizione zona                  ".
                   15  filler             pic  x(50) value
                  "Ordinamento per codice zona                       ".
                   15  filler             pic  x(50) value
                  "Ordinamento per mnemonico zona                    ".
               10  w-exp-tor-csc-t02.
                   15  filler             pic  x(50) value
                  "Ordinamento ABC decrescente sul fatturato         ".
                   15  filler             pic  x(50) value
                  "Ordinamento ABC decrescente sulla quantita'       ".
                  ...
                  "Ordinamento ABC crescente sulla quantita'         ".
                   15  filler             pic  x(50) value
                  "Ordinamento per descrizione categoria             ".
                   15  filler             pic  x(50) value
                  "Ordinamento per codice categoria                  ".
                   15  filler             pic  x(50) value
                  "Ordinamento per mnemonico categoria               ".
               10  w-exp-tor-csc-t03.
                   15  filler             pic  x(50) value
                  "Ordinamento ABC decrescente sul fatturato         ".
                   15  filler             pic  x(50) value
                  "Ordinamento ABC decrescente sulla quantita'       ".
      ...
      *                  * Tipo classe statistica prodotto             *
      *                  *---------------------------------------------*
           perform   acc-tcs-pro-000      thru acc-tcs-pro-999        .
      ...
      *                  * Tipo classe statistica cliente              *
      *                  *---------------------------------------------*
           perform   acc-tcs-cli-000      thru acc-tcs-cli-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * Tipo classe statistica prodotto                 *
      *              *-------------------------------------------------*
           perform   pmt-tcs-pro-000      thru pmt-tcs-pro-999        .
      *              *-------------------------------------------------*
      *              * Codice classe statistica prodotto               *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Tipo di ordinamento per classe statistica pro-  *
      *              * dotti                                           *
      *              *-------------------------------------------------*
      ...
      *              * Tipo classe statistica cliente                  *
      *              *-------------------------------------------------*
           perform   pmt-tcs-cli-000      thru pmt-tcs-cli-999        .
      *              *-------------------------------------------------*
      *              * Tipo di ordinamento per classe statistica cli-  *
      *              * ente                                            *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt : Tipo classe statistica prodotti                  *
      *    *-----------------------------------------------------------*
       pmt-tcs-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt : Codice classe statistica prodotti                *
      *    *-----------------------------------------------------------*
       pmt-cod-csp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           if        rr-tcs-pro           =    01
                     ...
                     move  "Codice classe merceologica :"
                                          to   v-alf
           else      move  "Codice classe statistica   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-cod-csp-999.
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento per classe statistica pro-   *
      *    *          dotti                                            *
      *    *-----------------------------------------------------------*
       pmt-tor-csp-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Prompt : Tipo classe statistica cliente                   *
      *    *-----------------------------------------------------------*
       pmt-tcs-cli-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Classe statistica cliente  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tcs-cli-999.
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento per classe statistica cli-   *
      *    *          ente                                             *
      *    *-----------------------------------------------------------*
       pmt-tor-csc-000.
           move      "DS"                 to   v-ope                  .
           ...
           if        rr-tcs-cli           =    01
                     ...
                     move  "Tipo ordinamento cod. stat.:"
                                          to   v-alf
           else      move  "Tipo ordinamento classi    :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tor-csc-999.
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo classe statistica prodotti            *
      *    *-----------------------------------------------------------*
       acc-tcs-pro-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      rr-tcs-pro           to   w-sav-tcs-pro          .
       acc-tcs-pro-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tcs-pro-lun    to   v-car                  .
           move      w-exp-tcs-pro-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      04                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-tcs-pro-tbl    to   v-txt                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        rr-tcs-pro           =    11
                     move  01             to   v-num
           else if   rr-tcs-pro           =    01
                     move  02             to   v-num
           else if   rr-tcs-pro           =    02
                     move  03             to   v-num
           else if   rr-tcs-pro           =    03
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-tcs-pro-999.
       acc-tcs-pro-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  11             to   rr-tcs-pro
           else if   v-num                =    02
                     move  01             to   rr-tcs-pro
           else if   v-num                =    03
                     move  02             to   rr-tcs-pro
           else if   v-num                =    04
                     move  03             to   rr-tcs-pro
           else      move  zero           to   rr-tcs-pro             .
       acc-tcs-pro-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tcs-pro           not  = 11 and
                     rr-tcs-pro           not  = 01 and
                     rr-tcs-pro           not  = 02 and
                     rr-tcs-pro           not  = 03
                     go to acc-tcs-pro-100.
       acc-tcs-pro-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tcs-pro           =    w-sav-tcs-pro
                     go to acc-tcs-pro-800.
       acc-tcs-pro-650.
      *                  *---------------------------------------------*
      *                  * Se valore cambiato                          *
      *                  *---------------------------------------------*
       acc-tcs-pro-655.
      *                      *-----------------------------------------*
      *                      * Prompt per codice classe statistica     *
      *                      * prodotto                                *
      *                      *-----------------------------------------*
           perform   pmt-cod-csp-000      thru pmt-cod-csp-999        .
       acc-tcs-pro-660.
      *                      *-----------------------------------------*
      *                      * Valore per codice classe statistica     *
      *                      * prodotto                                *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Normalizzazione                     *
      *                          *-------------------------------------*
           move      zero                 to   rr-cod-csp             .
           move      spaces               to   rr-cod-csp-des         .
      *                          *-------------------------------------*
      *                          * Visualizzazione                     *
      *                          *-------------------------------------*
           perform   vis-cod-csp-000      thru vis-cod-csp-999        .
           perform   vis-cod-csp-des-000  thru vis-cod-csp-des-999    .
       acc-tcs-pro-665.
      *                      *-----------------------------------------*
      *                      * Tipo di ordinamento per classe stati-   *
      *                      * stica prodotto                          *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Se il tipo classe statistica prece- *
      *                          * dente non e' ''Classe merceologica  *
      *                          * prodotto' : nessuna dipendenza  da  *
      *                          * impostazione                        *
      *                          *-------------------------------------*
           if        w-sav-tcs-pro        not  = 11
                     go to acc-tcs-pro-700.
      *                          *-------------------------------------*
      *                          * Se il tipo ordinamento classe sta-  *
      *                          * tistica prodotti non e' 'Per nume-  *
      *                          * ro di sequenza' : nessuna dipenden- *
      *                          * za da impostazione                  *
      *                          *-------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Tipo di classe statistica prodotti      *
      *    *-----------------------------------------------------------*
       vis-tcs-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Codice classe statistica prodotto          *
      *    *-----------------------------------------------------------*
       acc-cod-csp-000.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo di classe sta-  *
      *              * tistica prodotto                                *
      *              *-------------------------------------------------*
           if        rr-tcs-pro           =    01
                     go to acc-cod-csp-100
           else if   rr-tcs-pro           =    02
                     go to acc-cod-csp-200
           else if   rr-tcs-pro           =    03
                     go to acc-cod-csp-300
           else      go to acc-cod-csp-500.
       acc-cod-csp-100.
      *              *-------------------------------------------------*
      *              * Se tipo classe statistica 01                    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Accettazione codice statistico 1            *
      *                  *---------------------------------------------*
           perform   acc-cod-csp-s01-000  thru acc-cod-csp-s01-999    .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
       ...
       acc-cod-csp-200.
      *              *-------------------------------------------------*
      *              * Se tipo classe statistica 02                    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Accettazione codice statistico 2            *
      *                  *---------------------------------------------*
           perform   acc-cod-csp-s02-000  thru acc-cod-csp-s02-999    .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     acc-cod-csp-999.
       acc-cod-csp-300.
      *              *-------------------------------------------------*
      *              * Se tipo classe statistica 03                    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Accettazione codice statistico 3            *
      *                  *---------------------------------------------*
           perform   acc-cod-csp-s03-000  thru acc-cod-csp-s03-999    .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     acc-cod-csp-999.
       acc-cod-csp-500.
      *              *-------------------------------------------------*
      *              * Se tipo classe statistica 11                    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Accettazione codice classe merceologica     *
      *                  *---------------------------------------------*
           perform   acc-cod-csp-cla-000  thru acc-cod-csp-cla-999    .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     acc-cod-csp-999.
      ...
      *    *===========================================================*
      *    * Accettazione : Codice classe statistica 1 prodotto        *
      *    *-----------------------------------------------------------*
       acc-cod-csp-s01-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-csp           to   w-cmn-zps-001-cod      .
           move      05                   to   w-cmn-zps-001-lin      .
           move      30                   to   w-cmn-zps-001-pos      .
           move      05                   to   w-cmn-zps-001-dln      .
           move      37                   to   w-cmn-zps-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
       ...
       acc-cod-csp-s01-110.
           ...
           if        w-cmn-zps-001-ope    =    "F+"
                     go to acc-cod-csp-s01-115.
           if        w-cmn-zps-001-ope    =    "AC"
                     go to acc-cod-csp-s01-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-csp-s01-115.
           perform   cmn-zps-001-foi-000  thru cmn-zps-001-foi-999    .
           go to     acc-cod-csp-s01-110.
       acc-cod-csp-s01-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-cod-csp-s01-999.
       acc-cod-csp-s01-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-cod-csp             .
       acc-cod-csp-s01-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura classe statistica prodotto          *
      *                  *---------------------------------------------*
           move      01                   to   w-let-arc-csp-tip      .
           move      rr-cod-csp           to   w-let-arc-csp-cod      .
           perform   let-arc-csp-000      thru let-arc-csp-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           if        rr-cod-csp           =    zero
                     move  "Tutti i codici della classe statistica 1"
                                          to   rr-cod-csp-des
           else      move  w-let-arc-csp-des
                                          to   rr-cod-csp-des         .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-csp-flg    not  = spaces
                     go to acc-cod-csp-s01-100.
       acc-cod-csp-s01-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * normalizza il tipo ordinamento per classe   *
      *                  * statistica prodotto                         *
      *                  *---------------------------------------------*
           if        rr-cod-csp           =    zero
                     go to acc-cod-csp-s01-650.
           move      zero                 to   rr-tor-csp             .
           perform   vis-tor-csp-000      thru vis-tor-csp-999        .
       acc-cod-csp-s01-650.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Codice classe statistica 2 prodotto        *
      *    *-----------------------------------------------------------*
       acc-cod-csp-s02-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-csp           to   w-cmn-zps-002-cod      .
           move      05                   to   w-cmn-zps-002-lin      .
           move      30                   to   w-cmn-zps-002-pos      .
           move      05                   to   w-cmn-zps-002-dln      .
           move      37                   to   w-cmn-zps-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-cod-csp-s02-110.
           ...
           if        w-cmn-zps-002-ope    =    "F+"
                     go to acc-cod-csp-s02-115.
           if        w-cmn-zps-002-ope    =    "AC"
                     go to acc-cod-csp-s02-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-csp-s02-115.
           perform   cmn-zps-002-foi-000  thru cmn-zps-002-foi-999    .
           go to     acc-cod-csp-s02-110.
       acc-cod-csp-s02-120.
      ...
      *                  *---------------------------------------------*
           if        rr-cod-csp           =    zero
                     move  "Tutti i codici della classe statistica 2"
                                          to   rr-cod-csp-des
           else      move  w-let-arc-csp-des
                                          to   rr-cod-csp-des         .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Codice classe statistica 3 prodotto        *
      *    *-----------------------------------------------------------*
       acc-cod-csp-s03-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-csp           to   w-cmn-zps-003-cod      .
           move      05                   to   w-cmn-zps-003-lin      .
           move      30                   to   w-cmn-zps-003-pos      .
           move      05                   to   w-cmn-zps-003-dln      .
           move      37                   to   w-cmn-zps-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-cod-csp-s03-110.
           ...
           if        w-cmn-zps-003-ope    =    "F+"
                     go to acc-cod-csp-s03-115.
           if        w-cmn-zps-003-ope    =    "AC"
                     go to acc-cod-csp-s03-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-csp-s03-115.
           perform   cmn-zps-003-foi-000  thru cmn-zps-003-foi-999    .
           go to     acc-cod-csp-s03-110.
       acc-cod-csp-s03-120.
      ...
      *                  *---------------------------------------------*
           if        rr-cod-csp           =    zero
                     move  "Tutti i codici della classe statistica 3"
                                          to   rr-cod-csp-des
           else      move  w-let-arc-csp-des
                                          to   rr-cod-csp-des         .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Codice classe merceologica prodotto        *
      *    *-----------------------------------------------------------*
       acc-cod-csp-cla-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-csp           to   w-cod-mne-zp1-cla      .
       ...
       acc-cod-csp-cla-110.
           ...
           if        w-cod-mne-zp1-ope    =    "F+"
                     go to acc-cod-csp-cla-115.
           if        w-cod-mne-zp1-ope    =    "AC"
                     go to acc-cod-csp-cla-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-csp-cla-115.
           perform   cod-mne-zp1-foi-000  thru cod-mne-zp1-foi-999    .
           go to     acc-cod-csp-cla-110.
       acc-cod-csp-cla-120.
      ...
      *                  *---------------------------------------------*
           if        rr-cod-csp           =    zero
                     move  "Tutte le classi merceologiche           "
                                          to   rr-cod-csp-des
           else      move  w-let-arc-csp-des
                                          to   rr-cod-csp-des         .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice classe statistica prodotto       *
      *    *-----------------------------------------------------------*
       vis-cod-csp-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Descrizione classe statistica prodotto  *
      *    *-----------------------------------------------------------*
       vis-cod-csp-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo ordinamento per classe statistica     *
      *    *                prodotti                                   *
      *    *-----------------------------------------------------------*
       acc-tor-csp-000.
      *              *-------------------------------------------------*
      ...
      *                  * tistica prodotto diverso da zero : nessuna  *
      *                  * accettazione                                *
      *                  *---------------------------------------------*
           if        rr-cod-csp           =    zero
      ...
      *              *-------------------------------------------------*
           if        rr-tcs-pro           =    01 or
                     rr-tcs-pro           =    02 or
                     rr-tcs-pro           =    03
                     move  7              to   w-exp-tor-csp-num
           else      move  8              to   w-exp-tor-csp-num      .
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Tipo ordinamento per classe statistica  *
      *    *                   prodotti                                *
      *    *-----------------------------------------------------------*
       vis-tor-csp-000.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo classe statistica clienti             *
      *    *-----------------------------------------------------------*
       acc-tcs-cli-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      rr-tcs-cli           to   w-sav-tcs-cli          .
       acc-tcs-cli-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tcs-cli-lun    to   v-car                  .
           move      w-exp-tcs-cli-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      11                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-tcs-cli-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      rr-tcs-cli           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-tcs-cli-999.
       acc-tcs-cli-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-tcs-cli             .
       acc-tcs-cli-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Che sia un valore consentito                *
      *                  *---------------------------------------------*
           if        rr-tcs-cli           =    zero           or
                     rr-tcs-cli           >    w-exp-tcs-cli-num
                     go to acc-tcs-cli-100.
       acc-tcs-cli-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * Se valore inalterato : nessuna dipendenza   *
      *                  *---------------------------------------------*
           if        rr-tcs-cli           =    w-sav-tcs-cli
                     go to acc-tcs-cli-800.
       acc-tcs-cli-650.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       acc-tcs-cli-660.
      *                      *-----------------------------------------*
      *                      * Tipo ordinamento classe statistica cli- *
      *                      * enti                                    *
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo ordinamento per codice classe stati-  *
      *    *                stica cliente                              *
      *    *-----------------------------------------------------------*
       acc-tor-csc-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tcs-cli           =    01
                     move  w-exp-tor-csc-t01
                                          to   w-exp-tor-csc-tbl
           else if   rr-tcs-cli           =    02
                     move  w-exp-tor-csc-t02
                                          to   w-exp-tor-csc-tbl
           else if   rr-tcs-cli           =    03
                     move  w-exp-tor-csc-t03
                                          to   w-exp-tor-csc-tbl
           else      move  w-exp-tor-csc-t00
                                          to   w-exp-tor-csc-tbl      .
       acc-tor-csc-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      ...
      *                  * Che sia un valore consentito                *
      *                  *---------------------------------------------*
           if        rr-tor-csc           =    zero           or
                     rr-tor-csc           >    w-exp-tor-csc-num
      ...
      *    *===========================================================*
      *    * Visualizzazione : Tipo ordinamento per codice classe sta- *
      *    *                   tistica cliente                         *
      *    *-----------------------------------------------------------*
       vis-tor-csc-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-050.
      *              *-------------------------------------------------*
      *              * Controllo : Tipo classe statistica prodotti     *
      *              *-------------------------------------------------*
       tdo-ric-sel-051.
           if        rr-tcs-pro           not  = zero
                     go to tdo-ric-sel-052.
           move      "Manca il tipo classe statistica prodotti !        
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-052.
           ...
           move      "Tipo classe statistica prodotti errato !          
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      ...
      -              "ica prodotti ! "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-152.
           if        rr-tor-csp           =    01 or
                     ...
                     rr-tor-csp           =    07
                     go to tdo-ric-sel-200.
           if        rr-tor-csp           =    08 and
                     rr-tcs-pro           =    11
                     go to tdo-ric-sel-200.
           move      "Tipo di ordinamento per la classe statistica prodo
      -              "tti errato !   "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo : Tipo classe statistica cliente      *
      *              *-------------------------------------------------*
       tdo-ric-sel-201.
           if        rr-tcs-cli           not  = zero
                     go to tdo-ric-sel-202.
           move      "Manca il tipo classe statistica cliente !         
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-202.
           if        rr-tcs-cli           =    01 or
           ...
           move      "Tipo classe statistica cliente errato !           
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-250.
      *              *-------------------------------------------------*
      *              * Controllo : Tipo di ordinamento per classe sta- *
      *              *             tistica cliente                     *
      *              *-------------------------------------------------*
       tdo-ric-sel-251.
           if        rr-tor-csc           not  = zero
                     go to tdo-ric-sel-252.
           move      "Manca il tipo di ordinamento per la classe statist
      -              "ica cliente    "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-252.
           if        rr-tor-csc           =    01 or
                     rr-tor-csc           =    02 or
           ...
           move      "Tipo di ordinamento per la classe statistica clien
      -              "te errato !    "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   rr-tcs-pro             .
           move      zero                 to   rr-cod-csp             .
           move      spaces               to   rr-cod-csp-des         .
           move      zero                 to   rr-tip-dts             .
           move      zero                 to   rr-tor-csp             .
           move      zero                 to   rr-tcs-cli             .
           move      zero                 to   rr-tor-csc             .
