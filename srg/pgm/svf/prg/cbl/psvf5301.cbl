      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf5301:       *
      *                                                                *
      ...
      *            *---------------------------------------------------*
      *            * Numero classi statistiche cliente trattate per il *
      *            * prodotto                                          *
      *            *---------------------------------------------------*
               10  w-liv-pro-num-csc      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *                      * Tipo di prodotto                        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-tip    to   w-sel-fir-tip-pro      .
       sel-fir-rec-300.
      *              *-------------------------------------------------*
      ...
      *                      * zione non superata                      *
      *                      *-----------------------------------------*
           if        w-sel-fir-num-pro    =    rr-num-pro
      ...
      *                  *---------------------------------------------*
       sel-fir-rec-380.
      *                      *-----------------------------------------*
      *                      * Se sono stati richiesti anche tutti i   *
      *                      * tipi di prodotto si esce per selezione  *
      *                      * superata                                *
      *                      *-----------------------------------------*
           if        rr-tip-pro           =    99
                     go to sel-fir-rec-400.
       sel-fir-rec-385.
      *                      *-----------------------------------------*
      *                      * Se il prodotto in esame e' del tipo ri- *
      *                      * chiesto si esce per selezione superata, *
      *                      * altrimenti si esce per selezione non    *
      *                      * superata                                *
      *                      *-----------------------------------------*
           if        w-sel-fir-tip-pro    =    rr-tip-pro
                     go to sel-fir-rec-400
           else      go to sel-fir-rec-900.
       sel-fir-rec-400.
      *              *-------------------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-des-pro    to   srt-k01-des-pro        .
       cmp-srt-rec-225.
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-alf-pro    to   srt-k01-alf-pro        .
       cmp-srt-rec-235.
      *                      *-----------------------------------------*
      *                      * Codice numerico del prodotto            *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-num-pro    to   srt-k01-num-pro        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per classe statistica cliente *
      *                  *---------------------------------------------*
      ...
      *                      * cliente nell'ambito del prodotto        *
      *                      *-----------------------------------------*
      ...
      *                  *  per il prodotto                            *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-pro-num-csc      .
      *                  *---------------------------------------------*
      ...
      *                  * tate per il prodotto                        *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-pro-num-csc      .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-031.
           move      "PER PRODOTTO - ZONA DI APPARTENENZA DEI CLIENTI   
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-032.
           move      "PER PRODOTTO - CATEGORIA DI CLIENTE               
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-033.
           move      "PER PRODOTTO - CLASSIFICAZIONE STATISTICA DEI CLIE
      -              "NTI                           "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
