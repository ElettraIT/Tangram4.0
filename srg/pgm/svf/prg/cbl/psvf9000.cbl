      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Generazione archivi esportabili da stampe   *
      *                    statistiche sul fatturato di vendita        *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase svf900, nella sua globalita', esegue i tipi di gene-   *
      * razione elencati nella tabella seguente :                      *
      *                                                                *
      *   Codice                                                       *
      *    fase                                                        *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * SVF200      Statistica per cliente                             *
      * SVF250      Statistica per cliente - prodotto                  *
      * SVF350      Statistica per classe cliente - prodotto           *
      * SVF370      Statistica per forma di pagamento - cliente        *
      * SVF425      Statistica per classe geografica-cliente-prodotto  *
      * SVF500      Statistica per selezione su prodotti               *
      * SVF720      Statistica per agente - cliente                    *
      * SVF750      Statistica per agente - prodotto                   *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   ARCHIVI ESPORTABILI DA STATISTICHE   "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'svf900'           *
      *              *-------------------------------------------------*
           perform   fas-svf-900-000      thru fas-svf-900-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       pre-exe-pgm-200.
      *              *-------------------------------------------------*
      *              * Se esiste piu' di un elemento selezionabile     *
      *              *-------------------------------------------------*
           if        w-tin-ele-nes        =    1
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Forzatura indice elemento selezionato a : 1 *
      *                  *---------------------------------------------*
      ...
      *                  * svf200                                      *
      *                  *---------------------------------------------*
           move      "Statistica per cliente                    (svf200)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "SVF200    "         to   w-tin-ele-wci-alf      .
           move      "pgm/svf/prg/obj/psvf2000                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * svf250                                      *
      *                  *---------------------------------------------*
           move      "Statistica per cliente - prodotto         (svf250)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "SVF250    "         to   w-tin-ele-wci-alf      .
           move      "pgm/svf/prg/obj/psvf2500                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * svf350                                      *
      *                  *---------------------------------------------*
           move      "Statistica per classe cliente - prodotto  (svf350)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "SVF350    "         to   w-tin-ele-wci-alf      .
           move      "pgm/svf/prg/obj/psvf3500                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * svf370                                      *
      *                  *---------------------------------------------*
           move      "Statistica per forma di pagam. - cliente  (svf370)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "SVF370    "         to   w-tin-ele-wci-alf      .
           move      "pgm/svf/prg/obj/psvf3700                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * svf425                                      *
      *                  *---------------------------------------------*
           move      "Stat. classe geografica-cliente-prodotto  (svf425)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "SVF425    "         to   w-tin-ele-wci-alf      .
           move      "pgm/svf/prg/obj/psvf4250                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * svf500                                      *
      *                  *---------------------------------------------*
           move      "Statistica per selezione su prodotti      (svf500)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "SVF500    "         to   w-tin-ele-wci-alf      .
           move      "pgm/svf/prg/obj/psvf5000                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * svf720                                      *
      *                  *---------------------------------------------*
           move      "Statistica per agente - cliente           (svf720)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "SVF720    "         to   w-tin-ele-wci-alf      .
           move      "pgm/svf/prg/obj/psvf7200                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * svf750                                      *
      *                  *---------------------------------------------*
           move      "Statistica per agente - prodotto          (svf750)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "SVF750    "         to   w-tin-ele-wci-alf      .
           move      "pgm/svf/prg/obj/psvf7500                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-svf-900-300
           else if   v-key                =    "PRSC"
                     go to fas-svf-900-400
           else if   v-key                =    "NXSC"
                     go to fas-svf-900-450
           else if   v-key                =    "DOWN"
                     go to fas-svf-900-500
           else if   v-key                =    "EXIT"
                     go to fas-svf-900-250
           else      go to fas-svf-900-200.
       fas-svf-900-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-svf-900-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-svf-900-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-svf-900-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-svf-900-350
           else      go to fas-svf-900-322.
       fas-svf-900-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-svf-900-630
           else if   v-key                =    "PRSC"
                     go to fas-svf-900-600
           else if   v-key                =    "NXSC"
                     go to fas-svf-900-610
           else if   v-key                =    "UP  "
                     go to fas-svf-900-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-svf-900-650
           else if   v-key                =    "EXIT"
                     go to fas-svf-900-660
           else      go to fas-svf-900-570.
       fas-svf-900-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-svf-900-626
           else      go to fas-svf-900-628.
       fas-svf-900-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-svf-900-636
           else      go to fas-svf-900-638.
       fas-svf-900-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-svf-900-725
           else      go to fas-svf-900-750.
       fas-svf-900-725.
      *              *-------------------------------------------------*
      ...
      *              * tire, nel programma richiamato, la funzione di  *
      *              * generazione set                                 *
      *              *-------------------------------------------------*
           move      "PV"                 to   s-ope                  .
