      ...
      *                       Ultima revisione:    NdK del 21/06/99    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf4501:       *
      *                                                                *
      ...
      *            *---------------------------------------------------*
      *            * Numero prodotti trattati per la classe geografica *
      *            *---------------------------------------------------*
               10  w-liv-cgc-num-pro      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *                  *---------------------------------------------*
      *                  * Numero di classi geografiche trattate in    *
      *                  * totale                                      *
      *                  *---------------------------------------------*
      ...
      *                  * geografica                                  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cgc-num-pro      .
      *                  *---------------------------------------------*
      *                  * Numero di classi geografiche trattate in    *
      *                  * totale                                      *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-031.
           move      "PER NAZIONE - PRODOTTO                            
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-032.
           move      "PER REGIONE - PRODOTTO                            
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-033.
           move      "PER PROVINCIA - PRODOTTO                          
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
