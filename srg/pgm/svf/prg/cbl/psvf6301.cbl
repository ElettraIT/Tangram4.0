      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf6301:       *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per classe statistica prodotto - classe     *
      *                    statistica cliente                          *
      *                                                                *
      *================================================================*
      ...
      *                *   02 : Totale per classe statistica cliente   *
      *                *-----------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Subchiave 2 : Per classe statistica cliente       *
      *            *---------------------------------------------------*
               10  srt-k02.
      *                *-----------------------------------------------*
      *                * Valore ABC                                    *
      ...
      *                * nell'ambito della classe statistica prodotto  *
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FATTURATO PER CLASSI PRODOTTO E CLIENTE "       .
      ...
      *        *  - 01 : Solo il totale per ogni classe statistica     *
      *        *         cliente                                       *
      ...
      *        * la lista documenti emessi per ogni classe statistica  *
      *        * cliente                                               *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-liv.
      *        *-------------------------------------------------------*
      *        * Codice classe statistica per il cliente               *
      *        *-------------------------------------------------------*
           05  w-liv-csc.
      *            *---------------------------------------------------*
      *            * Codice classe statistica                          *
      ...
      *            *---------------------------------------------------*
      *            * Numero classi statistiche cliente trattate per la *
      *            * classe statistica prodotto                        *
      *            *---------------------------------------------------*
               10  w-liv-csp-num-csc      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per stampa del codice classe statistica cli- *
      ...
      *                      *-----------------------------------------*
       ...
       sel-fit-rec-200.
      *              *-------------------------------------------------*
      *              * Lettura classe statistica cliente               *
      *              *-------------------------------------------------*
       sel-fit-rec-225.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-cod-csp           not  = zero   and
                     w-sel-fir-cod-csp    not  = rr-cod-csp
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-mne-csp    to   srt-k01-mne-csp        .
       cmp-srt-rec-230.
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-nsq-csp    to   srt-k01-mne-csp        .
       cmp-srt-rec-240.
      *                      *-----------------------------------------*
      *                      * Codice classe statistica prodotto       *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-cod-csp    to   srt-k01-cod-csp        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per classe statistica cliente *
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rr-tor-csc           not  = 01 and
                     ...
                     rr-tor-csc           not  = 04 and
                     rr-tor-csc           not  = 05
                     move  spaces         to   srt-k02-des-csc
                     go to cmp-srt-rec-325.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fit-des-csc    to   srt-k02-des-csc        .
       cmp-srt-rec-325.
      *                      *-----------------------------------------*
      *                      * Mnemonico per classe statistica         *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rr-tor-csc           not  = 07
                     move  spaces         to   srt-k02-mne-csc
                     go to cmp-srt-rec-330.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fit-mne-csc    to   srt-k02-mne-csc        .
       cmp-srt-rec-330.
      *                      *-----------------------------------------*
      *                      * Flag di codice a zero o diverso da zero *
      *                      *-----------------------------------------*
      ...
      *                      * Codice classe statistica                *
      *                      *-----------------------------------------*
           move      w-sel-fit-cod-csc    to   srt-k02-cod-csc        .
       cmp-srt-rec-400.
      *                  *---------------------------------------------*
      *                  * Subchiave 3 : Per documento                 *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Valore ABC per la classe statistica del *
      *                      * cliente nell'ambito della classe sta-   *
      *                      * tistica del prodotto                    *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       agg-abc-kk0-500.
      *              *-------------------------------------------------*
      *              * Valore ABC per classe statistica cliente        *
      *              *-------------------------------------------------*
       agg-abc-kk0-525.
      *                  *---------------------------------------------*
      *                  * Se la statistica e' sul nuovo fatturato o   *
      ...
      *                          * Memorizzazione in area specifica    *
      *                          *-------------------------------------*
           move      srt-k02-val-abc      to   srt-val-abc-csc        .
       agg-abc-sqz-650.
      *                      *-----------------------------------------*
      *                      * Eventuale aggiornamento del flag per    *
      *                      * record da non selezionare               *
      ...
      *                  * cliente                                     *
      *                  *---------------------------------------------*
           move      srt-cod-csc-cod      to   w-rot-l01-cod-csc      .
      *              *-------------------------------------------------*
      *              * 2. livello di rottura                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * tate per la classe statistica del prodotto  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-num-csc      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Inizializzazione work area per livello di rot-  *
      *              * tura per classe statistica cliente              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice classe statistica                    *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Numero documenti trattati per l'agente      *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csc-num-doc      .
      *                  *---------------------------------------------*
      *                  * Numero di classi statistiche cliente trat-  *
      *                  * tate per la classe statistica del prodotto  *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-csp-num-csc      .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              * per ogni classe statistica cliente              *
      *              *-------------------------------------------------*
       prn-fin-lr1-310.
      *                  *---------------------------------------------*
      *                  * Test se linee residue sufficienti           *
      ...
      *                  * statistica cliente, del mnemonico, e della  *
      *                  * descrizione                                 *
      *                  *---------------------------------------------*
       prn-fin-lr1-331.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-liv-csc-val-umi    to   w-stp-sta-qfp-umi      .
           move      w-liv-csc-val-dec    to   w-stp-sta-qfp-dec      .
           move      w-liv-csc-qta-p1r    to   w-stp-sta-qfp-q01      .
           move      w-liv-csc-tot-p1r    to   w-stp-sta-qfp-f01      .
           move      w-liv-csc-qta-p2r    to   w-stp-sta-qfp-q02      .
           move      w-liv-csc-tot-p2r    to   w-stp-sta-qfp-f02      .
           move      w-liv-csc-qta-p3r    to   w-stp-sta-qfp-q03      .
           move      w-liv-csc-tot-p3r    to   w-stp-sta-qfp-f03      .
      ...
      *                  *---------------------------------------------*
           if        w-cnt-prn-flg-int    not  = spaces
                     go to prn-fin-lr1-999.
      *                  *---------------------------------------------*
      *                  * A stampa totale classe statistica cliente   *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr1-440.
      *                  *---------------------------------------------*
      *                  * Stampa totale classe statistica cliente     *
      *                  *---------------------------------------------*
       prn-fin-lr1-450.
      *                      *-----------------------------------------*
      *                      * Preparazione literal per il totale      *
      *                      *-----------------------------------------*
      ...
      -              "      "             to   w-stp-sta-tot-lit      .
           go to     prn-fin-lr1-460.
       prn-fin-lr1-453.
           move      "Totale codice statistico cliente :                
      -              "      "             to   w-stp-sta-tot-lit      .
           go to     prn-fin-lr1-460.
       prn-fin-lr1-460.
      *                      *-----------------------------------------*
      ...
      *                  * mento trattato per la classe statistica     *
      *                  * cliente oppure no                           *
      *                  *---------------------------------------------*
           if        w-liv-csc-num-doc    =    1
                     go to prn-liv-det-620
           else      go to prn-liv-det-670.
       prn-liv-det-620.
      *                  *---------------------------------------------*
      *                  * Se e' il primo documento trattato           *
      *                  *---------------------------------------------*
       prn-liv-det-630.
      *                      *-----------------------------------------*
      *                      * Test se linee residue sufficienti       *
      ...
      *                      * classe statistica cliente, del mne-     *
      *                      * monico, e della descrizione             *
      *                      *-----------------------------------------*
       prn-liv-det-651.
      *                          *-------------------------------------*
      *                          * Preparazione                        *
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-670.
      *                  *---------------------------------------------*
      *                  * Se non e' il primo documento trattato, ben- *
      *                  * si' uno successivo                          *
      *                  *---------------------------------------------*
       prn-liv-det-680.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-033.
           move      "PER 1. CODICE STATISTICO PRODOTTO - ZONA DI APPART
      -              "ENENZA DEI CLIENTI            "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-034.
           move      "PER 1. CODICE STATISTICO PRODOTTO - CATEGORIA DI C
      -              "LIENTE                        "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-035.
           move      "PER 1. CODICE STATISTICO PRODOTTO - CLASSIFICAZION
      -              "E STATISTICA DEI CLIENTI      "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-036.
           if        rr-tcs-cli           =    01
                     ...
                     go to stp-int-pag-039.
       stp-int-pag-037.
           move      "PER 2. CODICE STATISTICO PRODOTTO - ZONA DI APPART
      -              "ENENZA DEI CLIENTI            "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-038.
           move      "PER 2. CODICE STATISTICO PRODOTTO - CATEGORIA DI C
      -              "LIENTE                        "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-039.
           move      "PER 2. CODICE STATISTICO PRODOTTO - CLASSIFICAZION
      -              "E STATISTICA DEI CLIENTI      "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-040.
       ...
       stp-int-pag-041.
           move      "PER 3. CODICE STATISTICO PRODOTTO - ZONA DI APPART
      -              "ENENZA DEI CLIENTI            "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-042.
           move      "PER 3. CODICE STATISTICO PRODOTTO - CATEGORIA DI C
      -              "LIENTE                        "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-043.
           move      "PER 3. CODICE STATISTICO PRODOTTO - CLASSIFICAZION
      -              "E STATISTICA DEI CLIENTI      "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-044.
       ...
       stp-int-pag-045.
           move      "PER CLASSE MERCEOLOGICA PRODOTTO - ZONA DI APPARTE
      -              "NENZA DEI CLIENTI             "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-046.
           move      "PER CLASSE MERCEOLOGICA PRODOTTO - CATEGORIA DI CL
      -              "IENTE                         "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-047.
           move      "PER CLASSE MERCEOLOGICA PRODOTTO - CLASSIFICAZIONE
      -              " STATISTICA DEI CLIENTI       "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
      *                  *---------------------------------------------*
      ...
      *                          * classe statistica cliente selezio-  *
      *                          * nata                                *
      *                          *-------------------------------------*
           if        rr-tcs-cli           =    01
      ...
      *                          * Classe 03                           *
      *                          *-------------------------------------*
           move      "Classificazione statistica cliente                
      -              "      "             to   w-stp-fnc-tit-asx      .
           go to     stp-fnc-vrt-030.
       stp-fnc-vrt-030.
      *                          *-------------------------------------*
      ...
      *    * della descrizione, della classe statistica del cliente    *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-cmd-csc-cod : Codice numerico della classe      *
      *    *                                                           *
      *    *   - w-stp-cmd-csc-mne : Mnemonico per la classe           *
      *    *                                                           *
      *    *   - w-stp-cmd-csc-des : Descrizione per la classe         *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       stp-cmd-csc-000.
      *              *-------------------------------------------------*
