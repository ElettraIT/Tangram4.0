      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf3701:       *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-zfp.
               10  w-let-arc-zfp-flg      pic  x(01)     value spaces .
               10  w-let-arc-zfp-cod      pic  9(07)     value zero   .
               10  w-let-arc-zfp-des      pic  x(40)     value spaces .
               10  w-let-arc-zfp-mne      pic  x(10)     value spaces .
               10  w-let-arc-zfp-exc      pic  9(07)     value zero   .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-rot-l02.
      *            *---------------------------------------------------*
      *            * Codice forma pagamento  cliente                   *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Codice forma pagamento  per il cliente                *
      *        *-------------------------------------------------------*
           05  w-liv-fop.
      *            *---------------------------------------------------*
      *            * Codice forma pagamento                            *
      ...
      *            *---------------------------------------------------*
      *            * Numero clienti trattati per la forma pagamento    *
      *            *---------------------------------------------------*
               10  w-liv-fop-num-cli      pic  9(11)                  .
      *            *---------------------------------------------------*
      ...
      *        * Codice forma pagamento                                *
      *        *-------------------------------------------------------*
           05  w-sel-fit-cod-fop          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Mnemonico forma pagamento                             *
      *        *-------------------------------------------------------*
           05  w-sel-fit-mne-fop          pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione forma pagamento                           *
      *        *-------------------------------------------------------*
           05  w-sel-fit-des-fop          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Flag di forma pagamento esistente                     *
      *        *-------------------------------------------------------*
           05  w-sel-fit-flg-fop          pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per stampa del codice forma pagamento  cli-  *
      ...
      *            *---------------------------------------------------*
               10  w-stp-sdb-num-scd      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Contatore di comodo                               *
      *            *---------------------------------------------------*
               10  w-stp-sdb-ctr-001      pic  9(03)                  .
      ...
      *                      * Codice forma pagamento                  *
      *                      *-----------------------------------------*
           move      rf-fit-cod-fop       to   w-sel-fit-cod-fop      .
       sel-fit-rec-200.
      *              *-------------------------------------------------*
      *              * Selezione su codice forma pagamento  cliente    *
      *              *-------------------------------------------------*
           if        rr-cod-fop           not  = zero          and
                     rr-cod-fop           not  = w-sel-fit-cod-fop
                     go to sel-fit-rec-900.
       sel-fit-rec-260.
      *                      *-----------------------------------------*
      *                      * Lettura [zfp]                           *
      ...
      *                          * Lettura                             *
      *                          *-------------------------------------*
           move      w-sel-fit-cod-fop    to   w-let-arc-zfp-cod      .
      ...
      *                              * Codice                          *
      *                              *---------------------------------*
           move      w-let-arc-zfp-cod    to   w-sel-fit-cod-fop      .
      *                              *---------------------------------*
      *                              * Descrizione                     *
      *                              *---------------------------------*
           move      w-let-arc-zfp-des    to   w-sel-fit-des-fop      .
      *                              *---------------------------------*
      *                              * Mnemonico                       *
      *                              *---------------------------------*
           move      w-let-arc-zfp-mne    to   w-sel-fit-mne-fop      .
      *                              *---------------------------------*
      *                              * Flag di codice esistente        *
      *                              *---------------------------------*
           move      w-let-arc-zfp-flg    to   w-sel-fit-flg-fop      .
       sel-fit-rec-265.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-fit-nps-sdb       to   w-stp-sdb-num-scd      .
           subtract  1                    from w-stp-sdb-num-scd      .
      *                          *-------------------------------------*
      *                          * Ciclo di scansione scadenze         *
      *                          *-------------------------------------*
           move      zero                 to   w-stp-sdb-ctr-001      .
       sel-fit-rec-320.
           add       1                    to   w-stp-sdb-ctr-001      .
      *
           if        w-stp-sdb-ctr-001    >    rf-fit-ctr-sdb
                     go to sel-fit-rec-900.
           if        w-stp-sdb-ctr-001    >    96
                     go to sel-fit-rec-900.
      *                          *-------------------------------------*
      *                          * Incremento work numero scadenza     *
      *                          *-------------------------------------*
           add       1                    to   w-stp-sdb-num-scd      .
      *                          *-------------------------------------*
      *                          * Lettura record [sdb]                *
      *                          *-------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMSDB    "         to   f-key                  .
           move      w-stp-sdb-num-scd    to   rf-sdb-num-sdb         .
           move      "pgm/gep/fls/ioc/obj/iofsdb"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
       cmp-srt-rec-200.
      *                  *---------------------------------------------*
      *                  * Subchiave 1 : Per forma pagamento  cliente  *
      *                  *---------------------------------------------*
       cmp-srt-rec-210.
      *                      *-----------------------------------------*
      *                      * Valore ABC                              *
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fit-des-fop    to   srt-k01-des-fop        .
       cmp-srt-rec-225.
      *                      *-----------------------------------------*
      *                      * Mnemonico per forma pagamento           *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fit-mne-fop    to   srt-k01-mne-fop        .
       cmp-srt-rec-230.
      *                      *-----------------------------------------*
      *                      * Flag di codice a zero o diverso da zero *
      *                      *-----------------------------------------*
      ...
      *                      * Codice forma pagamento                  *
      *                      *-----------------------------------------*
           move      w-sel-fit-cod-fop    to   srt-k01-cod-fop        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per cliente                   *
      *                  *---------------------------------------------*
      ...
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      w-sel-fit-cod-fop    to   srt-cod-fop-cod        .
      *                      *-----------------------------------------*
      *                      * Mnemonico                               *
      *                      *-----------------------------------------*
           move      w-sel-fit-mne-fop    to   srt-cod-fop-mne        .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      *                      *-----------------------------------------*
           move      w-sel-fit-des-fop    to   srt-cod-fop-des        .
      *                      *-----------------------------------------*
      *                      * Flag di esistenza                       *
      *                      *-----------------------------------------*
           move      w-sel-fit-flg-fop    to   srt-cod-fop-flg        .
       cmp-srt-rec-850.
      *                  *---------------------------------------------*
      *                  * Cliente                                     *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       agg-abc-kk0-000.
      *              *-------------------------------------------------*
      *              * Valore ABC per forma pagamento  cliente         *
      *              *-------------------------------------------------*
       agg-abc-kk0-025.
      *                  *---------------------------------------------*
...
______*    COMPLETARE ____


           go to     prn-ini-cic-gen-300.
      ...
      *                  *---------------------------------------------*
      *                  * Numero di clienti trattati per il pagamento *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fop-num-cli      .
      *                  *---------------------------------------------*
      *                  * Numero di categorie sconto trattate         *
      *                  *---------------------------------------------*
      ...
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-fop-tot-p1r    to   w-mod-not-svf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      zero                 to   w-mod-not-svf-q02      .
      ...
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-fop-tot-p2r    to   w-mod-not-svf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-svf-p01      .
      ...
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-fop-tot-p3r    to   w-mod-not-svf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-svf-p02      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr2-800.
      *              *-------------------------------------------------*
      *              * Subroutine per l'emissione archivio sequenziale *
      *              *-------------------------------------------------*
           perform   exe-gen-fil-fop-000  thru exe-gen-fil-fop-999    .
       prn-fin-lr2-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                      * Literal                                 *
      *                      *-----------------------------------------*
           move      "Clienti non classificati per forma di pagamento   
      -              "                      "
      ...
      *              *-------------------------------------------------*
           if        w-let-arc-zfp-cod    =    w-let-arc-zfp-exc
      ...
      *              *-------------------------------------------------*
           move      w-let-arc-zfp-cod    to   w-let-arc-zfp-exc      .
       let-arc-zfp-999.
           exit.
      ...
      *                  *---------------------------------------------*
      *                  * Codice forma pagamento  in chiusura         *
      *                  *---------------------------------------------*
           move      zero                 to   w-let-cli-dcc-scc      .
      *                  *---------------------------------------------*
      *                  * Codice forma pagamento  in riga             *
      *                  *---------------------------------------------*
      ...
      *                  *  - forma pagamento  in chiusura             *
      *                  *  - forma pagamento  in riga                 *
      *                  *---------------------------------------------*
           if        f-sts                =    e-not-err
      ...
      *              *-------------------------------------------------*
           ...
           move      "Statistica per Pagamento"
                                          to   m-gen-grf-tit-grf      .
           move      "svf370"             to   m-gen-grf-fil-nam      .
       exe-sqz-grf-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "<B"                 to   x-edm                  .
           move      w-liv-fop-cod-fop    to   x-num                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Descrizione per la forma pagamento          *
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   x-tip                  .
           move      40                   to   x-car                  .
           move      w-liv-fop-des-fop    to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
