      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf6401:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tor-cgc.
               ...
               10  w-exp-tor-cgc-t00.
                  ...
                  "Ordinamento ABC crescente sulla quantita'         ".
                   15  filler             pic  x(50) value
                  "Ordinamento per descrizione del codice geografico ".
                   15  filler             pic  x(50) value
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento per classe geografica cli-   *
      *    *          ente                                             *
      *    *-----------------------------------------------------------*
       pmt-tor-cgc-000.
           move      "DS"                 to   v-ope                  .
           ...
           move      01                   to   v-pos                  .
           if        rr-tcg-cli           =    01
                     move  "Tipo ordinamento nazioni   :"
                                          to   v-alf
           else if   rr-tcg-cli           =    02
                     move  "Tipo ordinamento regioni   :"
                                          to   v-alf
           else if   rr-tcg-cli           =    03
                     move  "Tipo ordinamento provincie :"
                                          to   v-alf
