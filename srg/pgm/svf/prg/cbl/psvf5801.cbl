      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf5801:       *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Subchiave 1 : Per fornitore prodotto              *
      *            *---------------------------------------------------*
               10  srt-k01.
      *                *-----------------------------------------------*
      *                * Valore ABC                                    *
      ...
      *                *-----------------------------------------------*
      *                * Flag di codice fornitore diverso da zero ma   *
      *                * non trovato in archivio fornitori             *
      *                *                                               *
      *                *   - 1 : Esistente                             *
      *                *   - 5 : Non esistente                         *
      *                *   - 9 : Codice a zero                         *
      ...
      *                * - Per mnemonico                               *
      *                *-----------------------------------------------*
                   15  srt-k01-mne-fnt    pic  x(05)                  .
      *                *-----------------------------------------------*
      *                * Flag di codice fornitore a zero o diverso da  *
      *                * zero                                          *
      *                *                                               *
      ...
      *                *-----------------------------------------------*
      *                * Codice fornitore, flag di esistenza           *
      *                *-----------------------------------------------*
                   15  srt-cod-fnt-flg    pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice prodotto                                   *
      *            *---------------------------------------------------*
               10  srt-cod-pro.
      ...
      *        *-------------------------------------------------------*
      *        * Fornitore, codice numerico                            *
      *        *-------------------------------------------------------*
           05  w-sel-fir-cod-fnt          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Fornitore, ragione sociale                            *
      *        *-------------------------------------------------------*
           05  w-sel-fir-rag-fnt          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Fornitore, mnemonico                                  *
      *        *-------------------------------------------------------*
           05  w-sel-fir-mne-fnt          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Fornitore, flag di esistenza                          *
      *        *-------------------------------------------------------*
           05  w-sel-fir-flg-fnt          pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per stampa del fornitore                     *
      *        *-------------------------------------------------------*
           05  w-stp-cmd-fnt.
      *            *---------------------------------------------------*
      *            * Codice numerico fornitore                         *
      *            *---------------------------------------------------*
               10  w-stp-cmd-fnt-cod      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Mnemonico fornitore                               *
      *            *---------------------------------------------------*
               10  w-stp-cmd-fnt-mne      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Ragione sociale fornitore                         *
      *            *---------------------------------------------------*
               10  w-stp-cmd-fnt-rag      pic  x(40)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-aaq                 .
      *                  *---------------------------------------------*
      *                  * Lettura anagrafica di acquisto prodotto     *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
           move      rf-aaq-dcf-pfz       to   w-let-arc-fnt-cod      .
           perform   let-arc-fnt-000      thru let-arc-fnt-999        .
      *                  *---------------------------------------------*
      *                  * Lettura archivio [dcf]                      *
      *                  *---------------------------------------------*
           move      rf-aaq-dcf-pfz       to   w-let-arc-dcf-cod      .
      ...
      *                      * Fornitore, codice numerico              *
      *                      *-----------------------------------------*
           move      rf-aaq-dcf-pfz       to   w-sel-fir-cod-fnt      .
      *                      *-----------------------------------------*
      *                      * Fornitore, ragione sociale              *
      *                      *-----------------------------------------*
           move      w-let-arc-dcf-rag    to   w-sel-fir-rag-fnt      .
      *                      *-----------------------------------------*
      *                      * Fornitore, mnemonico                    *
      *                      *-----------------------------------------*
           move      w-let-arc-fnt-mne    to   w-sel-fir-mne-fnt      .
      *                      *-----------------------------------------*
      *                      * Fornitore, flag di esistenza            *
      *                      *-----------------------------------------*
           move      w-let-arc-fnt-flg    to   w-sel-fir-flg-fnt      .
       sel-fir-rec-300.
      *              *-------------------------------------------------*
      *              * Selezione su fornitore                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se un solo fornitore prodotto da seleziona- *
      *                  * re e il fornitore prodotto non corrisponde  *
      *                  * a quella da selezionare : uscita per sele-  *
      *                  * zione non superata                          *
      *                  *---------------------------------------------*
           if        rr-cod-fnt           not  = zero   and
                     w-sel-fir-cod-fnt    not  = rr-cod-fnt
      ...
      *                          * zione                               *
      *                          *-------------------------------------*
           if        w-sel-fir-rag-fnt    not  = spaces
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-rag-fnt    to   srt-k01-rag-fnt        .
       cmp-srt-rec-225.
      *                      *-----------------------------------------*
      *                      * Mnemonico fornitore                     *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-mne-fnt    to   srt-k01-mne-fnt        .
       cmp-srt-rec-230.
      *                      *-----------------------------------------*
      *                      * Flag di codice fornitore a zero         *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Solo se tipo ordinamento :          *
      *                          *  - Per codice                       *
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-cod-fnt    to   srt-k01-cod-fnt        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per documento                 *
      *                  *---------------------------------------------*
      ...
      *                      * Codice numerico                         *
      *                      *-----------------------------------------*
           move      w-sel-fir-cod-fnt    to   srt-cod-fnt-cod        .
      *                      *-----------------------------------------*
      *                      * Ragione sociale                         *
      *                      *-----------------------------------------*
           move      w-sel-fir-rag-fnt    to   srt-cod-fnt-rag        .
      *                      *-----------------------------------------*
      *                      * Mnemonico                               *
      *                      *-----------------------------------------*
           move      w-sel-fir-mne-fnt    to   srt-cod-fnt-mne        .
      *                      *-----------------------------------------*
      *                      * Flag di esistenza                       *
      *                      *-----------------------------------------*
           move      w-sel-fir-flg-fnt    to   srt-cod-fnt-flg        .
       cmp-srt-rec-850.
      *                  *---------------------------------------------*
      *                  * Codice prodotto                             *
      *                  *---------------------------------------------*
      ...
      *              * prodotto : uscita senza alcuna azione           *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Numero documenti trattati per fornitore     *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fnt-num-doc      .
      *                  *---------------------------------------------*
      *                  * Numero fornitori trattati in totale         *
      *                  *---------------------------------------------*
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-qta-p1r    to   w-mod-not-svf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-tot-p1r    to   w-mod-not-svf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-qta-p2r    to   w-mod-not-svf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-tot-p2r    to   w-mod-not-svf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-svf-p01      .
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-qta-p3r    to   w-mod-not-svf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-tot-p3r    to   w-mod-not-svf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-svf-p02      .
      ...
      *                  * tore, del mnemonico, e della ragione socia- *
      *                  * le                                          *
      *                  *---------------------------------------------*
       prn-fin-lr1-330.
      *                      *-----------------------------------------*
      ...
      *                          * Codice numerico                     *
      *                          *-------------------------------------*
           move      w-liv-fnt-cod-fnt    to   w-stp-cmd-fnt-cod      .
      *                          *-------------------------------------*
      *                          * Mnemonico                           *
      *                          *-------------------------------------*
           move      w-liv-fnt-mne-fnt    to   w-stp-cmd-fnt-mne      .
      *                          *-------------------------------------*
      *                          * Ragione sociale                     *
      *                          *-------------------------------------*
           move      w-liv-fnt-rag-fnt    to   w-stp-cmd-fnt-rag      .
       prn-fin-lr1-332.
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   stp-cmd-fnt-000      thru stp-cmd-fnt-999        .
       prn-fin-lr1-340.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "Totale fornitore preferenziale prodotto :         
      -              "      "             to   w-stp-sta-tot-lit      .
       prn-fin-lr1-460.
      *                      *-----------------------------------------*
      ...
      *                  * mento trattato per la fornitore oppure no   *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-650.
      *                      *-----------------------------------------*
      *                      * Subroutine per la stampa del fornitore  *
      *                      *-----------------------------------------*
       prn-liv-det-651.
      *                          *-------------------------------------*
      *                          * Preparazione                        *
      ...
      *                      *-----------------------------------------*
           move      "STATISTICA DI VENDITA SUL FATTURATO               
      -              "                              "
      ...
      *                  * lineato a sinistra                          *
      *                  *---------------------------------------------*
           move      "PER FORNITORE PREFERENZIALE PRODOTTO              
      -              "                              "
      ...
      *                          * Literal                             *
      *                          *-------------------------------------*
           move      "Fornitore"          to   w-stp-fnc-tit-asx      .
      *                          *-------------------------------------*
      *                          * Continuazione                       *
      *                          *-------------------------------------*
      ...
      *              * lista documenti emessi per ogni fornitore       *
      *              *-------------------------------------------------*
       stp-fds-tot-605.
      *                  *---------------------------------------------*
      *                  * Titolo di sinistra                          *
      ...
      *    *===========================================================*
      *    * Subroutine per la stampa del codice fornitore, del mne-   *
      *    * monico e della ragione sociale                            *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-cmd-fnt-cod : Codice numerico                   *
      *    *                                                           *
      *    *   - w-stp-cmd-fnt-mne : Mnemonico                         *
      *    *                                                           *
      *    *   - w-stp-cmd-fnt-rag : Ragione sociale                   *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       stp-cmd-fnt-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-stp-cmd-fnt-cod    =    zero
                     go to stp-cmd-fnt-300
           else      go to stp-cmd-fnt-600.
       stp-cmd-fnt-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      016                  to   p-pos                  .
           move      "Prodotti con fornitore non determinato  "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cmd-fnt-500.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      002                  to   p-pos                  .
           move      w-stp-cmd-fnt-cod    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Oltre                                   *
      *                      *-----------------------------------------*
           go to     stp-cmd-fnt-750.
       stp-cmd-fnt-700.
      *                  *---------------------------------------------*
      *                  * Mnemonico                                   *
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      002                  to   p-pos                  .
           move      w-stp-cmd-fnt-mne    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cmd-fnt-750.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      016                  to   p-pos                  .
           move      w-stp-cmd-fnt-rag    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cmd-fnt-800.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-fnt-cod-mne       to   w-let-arc-fnt-mne      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-fnt-520.
           ...
           move      spaces               to   w-let-arc-fnt-mne      .
       let-arc-fnt-999.
           exit.
