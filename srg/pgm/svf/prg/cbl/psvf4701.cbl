      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf4701:       *
      *                                                                *
      ...
      *                *-----------------------------------------------*
      *                * Descrizione classe statistica cliente         *
      *                *                                               *
      *                * Solo per tipo ordinamento classe :            *
      *                *                                               *
      *                * - ABC decrescente sul fatturato               *
      ...
      *                * - Per descrizione classe                      *
      *                *-----------------------------------------------*
                   15  srt-k02-des-csc    pic  x(40)                  .
      *                *-----------------------------------------------*
      *                * Mnemonico per classe statistica cliente       *
      *                *                                               *
      *                * Solo per tipo ordinamento classe :            *
      *                *                                               *
      *                * - Per mnemonico                               *
      ...
      *        *-------------------------------------------------------*
      *        * Work per Let su classificatori statistici cliente     *
      *        *-------------------------------------------------------*
           05  w-let-arc-csc.
               10  w-let-arc-csc-tip      pic  9(02)     value zero   .
               10  w-let-arc-csc-cod      pic  9(05)     value zero   .
               10  w-let-arc-csc-flg      pic  x(01)     value spaces .
               10  w-let-arc-csc-des      pic  x(40)     value spaces .
               10  w-let-arc-csc-mne      pic  x(05)     value spaces .
               10  w-let-arc-csc-nsq      pic  9(07)     value zero   .
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [zst], tipo record 01        *
      *        *-------------------------------------------------------*
           05  w-let-arc-s01.
      ...
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [zst], tipo record 02        *
      *        *-------------------------------------------------------*
           05  w-let-arc-s02.
      ...
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [zst], tipo record 03        *
      *        *-------------------------------------------------------*
           05  w-let-arc-s03.
      ...
      *            *---------------------------------------------------*
      *            * Numero classi statistiche cliente  trattati per   *
      *            * la classe geografica cliente                      *
      *            *---------------------------------------------------*
               10  w-liv-cgc-num-csc      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *        *-------------------------------------------------------*
      *        * Codice zona del cliente                               *
      *        *-------------------------------------------------------*
           05  w-sel-fit-zon-cli          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice categoria del cliente                          *
      *        *-------------------------------------------------------*
           05  w-sel-fit-cat-cli          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice statistico del cliente                         *
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tcs-cli           =    01
                     move  01             to   w-let-arc-csc-tip
                     move  w-let-cli-dcc-zon
                                          to   w-let-arc-csc-cod
           else if   rr-tcs-cli           =    02
                     move  02             to   w-let-arc-csc-tip
                     move  w-let-cli-dcc-cat
                                          to   w-let-arc-csc-cod
           else      move  03             to   w-let-arc-csc-tip
                     move  w-let-cli-dcc-stt
                                          to   w-let-arc-csc-cod      .
           perform   let-arc-csc-000      thru let-arc-csc-999        .
      *                  *---------------------------------------------*
      *                  * Dati letti in area di comodo                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Classe statistica, codice numerico      *
      *                      *-----------------------------------------*
           move      w-let-arc-csc-cod    to   w-sel-fit-cod-csc      .
      *                      *-----------------------------------------*
      *                      * Classe statistica, descrizione          *
      *                      *-----------------------------------------*
           move      w-let-arc-csc-des    to   w-sel-fit-des-csc      .
      *                      *-----------------------------------------*
      *                      * Classe statistica, mnemonico            *
      *                      *-----------------------------------------*
           move      w-let-arc-csc-mne    to   w-sel-fit-mne-csc      .
      *                      *-----------------------------------------*
      *                      * Classe statistica, flag di esistenza    *
      *                      *-----------------------------------------*
           move      w-let-arc-csc-flg    to   w-sel-fit-flg-csc      .
       sel-fit-rec-200.
      *              *-------------------------------------------------*
      ...
      *                          * zione                               *
      *                          *-------------------------------------*
           if        w-sel-fit-des-csc    not  = spaces
...
v       cmp-srt-rec-415.
      ...
      *                      * cliente  nell'ambito della classe       *
      ...
      *                  *   - 02 : ABC crescente sul fatturato        *
      ...
      *                          *-------------------------------------*
           if        rr-num-pdr           =    02 or
                     rr-num-pdr           =    11
                     move   kk0-fat-2op   to   srt-k01-val-abc
           else if   rr-num-pdr           =    03
                     move   kk0-fat-3op   to   srt-k01-val-abc
           else      move   kk0-fat-1op   to   srt-k01-val-abc        .
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Solo se il tipo di ordinamento per classe   *
      *                  * statistica cliente  tra i seguenti :        *
      *                  *   - 01 : ABC decrescente sul fatturato      *
      *                  *   - 02 : ABC crescente sul fatturato        *
      *                  * Altrimenti nessuna azione                   *
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rr-num-pdr           =    02 or
                     rr-num-pdr           =    11
                     move   kk0-fat-2op   to   srt-k02-val-abc
           else if   rr-num-pdr           =    03
                     move   kk0-fat-3op   to   srt-k02-val-abc
           else      move   kk0-fat-1op   to   srt-k02-val-abc        .
      *                          *-------------------------------------*
      *                          * Se ABC decrescente si complementa   *
      *                          *-------------------------------------*
           if        rr-tor-csc           =    01
      ...
      *                  *---------------------------------------------*
      *                  * Numero classi statistiche cliente  trattate *
      *                  * per la classe geografica cliente            *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cgc-num-csc      .
      *                  *---------------------------------------------*
      *                  * Numero di classi geografiche cliente trat-  *
      *                  * tate in totale                              *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Mnemonico per la classe statistica cliente  *
      *                  *---------------------------------------------*
      ...
      *                  * statistica cliente , del mnemonico della    *
      ...
      *                      * della classe statistica del cliente ,   *
      ...
      *                  * la classe statistica del cliente , bensi'   *
      *                  * uno successivo                              *
      *                  *---------------------------------------------*
       prn-liv-det-680.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-036.
           move      "PER NAZIONE - ZONA CLIENTE                        
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-037.
           move      "PER NAZIONE - CATEGORIA CLIENTE                   
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-038.
           move      "PER NAZIONE - CODICE STATISTICO CLIENTE           
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
           go to     stp-int-pag-050.
       ...
       stp-int-pag-041.
           move      "PER REGIONE - ZONA CLIENTE                        
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-042.
           move      "PER REGIONE - CATEGORIA CLIENTE                   
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-043.
           move      "PER REGIONE - CODICE STATISTICO CLIENTE           
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-044.
           move      "PER REGIONE - CLASSE MERCEOLOGICA cliente         
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-045.
       ...
       stp-int-pag-046.
           move      "PER PROVINCIA - ZONA CLIENTE                      
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-047.
           move      "PER PROVINCIA - CATEGORIA CLIENTE                 
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-048.
           move      "PER PROVINCIA - CODICE STATISTICO CLIENTE         
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-049.
           move      "PER PROVINCIA - CLASSE MERCEOLOGICA cliente       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
      ...
      *    * del cliente ,del mnemonico della classe, e della descri-  *
      *    * zione                                                     *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
      ...
      *    *===========================================================*
      *    * Routine di lettura classificatori statistici cliente      *
      *    *-----------------------------------------------------------*
       let-arc-csc-000.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo di classificatore *
      *              * statistico cliente  da leggere                  *
      *              *-------------------------------------------------*
           if        w-let-arc-csc-tip    =    01
                     go to let-arc-csc-100
           else if   w-let-arc-csc-tip    =    02
                     go to let-arc-csc-200
           else if   w-let-arc-csc-tip    =    03
                     go to let-arc-csc-300
           else      go to let-arc-csc-900.
       let-arc-csc-100.
      *              *-------------------------------------------------*
      *              * Se codice zona                                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura archivio [zst] tipo record 01       *
      *                  *---------------------------------------------*
           move      w-let-arc-csc-cod    to   w-let-arc-s01-cod      .
           perform   let-arc-s01-000      thru let-arc-s01-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione valori                       *
      *                  *---------------------------------------------*
           move      w-let-arc-s01-flg    to   w-let-arc-csc-flg      .
           move      w-let-arc-s01-des    to   w-let-arc-csc-des      .
           move      w-let-arc-s01-mne    to   w-let-arc-csc-mne      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione numero di sequenza          *
      *                  *---------------------------------------------*
           move      zero                 to   w-let-arc-csc-nsq      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     let-arc-csc-999.
       let-arc-csc-200.
      *              *-------------------------------------------------*
      *              * Se codice categoria                             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura archivio [zst] tipo record 02       *
      *                  *---------------------------------------------*
           move      w-let-arc-csc-cod    to   w-let-arc-s02-cod      .
           perform   let-arc-s02-000      thru let-arc-s02-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione valori                       *
      *                  *---------------------------------------------*
           move      w-let-arc-s02-flg    to   w-let-arc-csc-flg      .
           move      w-let-arc-s02-des    to   w-let-arc-csc-des      .
           move      w-let-arc-s02-mne    to   w-let-arc-csc-mne      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione numero di sequenza          *
      *                  *---------------------------------------------*
           move      zero                 to   w-let-arc-csc-nsq      .
      ...
      *                  *---------------------------------------------*
       ...
       let-arc-csc-300.
      *              *-------------------------------------------------*
      *              * Se codice statistico                            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura archivio [zst] tipo record 03       *
      *                  *---------------------------------------------*
           move      w-let-arc-csc-cod    to   w-let-arc-s03-cod      .
           perform   let-arc-s03-000      thru let-arc-s03-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione valori                       *
      *                  *---------------------------------------------*
           move      w-let-arc-s03-flg    to   w-let-arc-csc-flg      .
           move      w-let-arc-s03-des    to   w-let-arc-csc-des      .
           move      w-let-arc-s03-mne    to   w-let-arc-csc-mne      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione numero di sequenza          *
      *                  *---------------------------------------------*
           move      zero                 to   w-let-arc-csc-nsq      .
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [zst], tipo record 01         *
      *    *-----------------------------------------------------------*
       let-arc-s01-000.
      *              *-------------------------------------------------*
      *              * Test se codice pari al valore precedente        *
      ...
      *                  *---------------------------------------------*
       ...
       let-arc-s01-200.
      *              *-------------------------------------------------*
      *              * Lettura da archivio [zst]                       *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLS    "         to   f-key                  .
           move      01                   to   rf-zst-tip-cls         .
           move      w-let-arc-s01-cod    to   rf-zst-cod-cls         .
           move      "pgm/dcc/fls/ioc/obj/iofzst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-s01-300.
      *              *-------------------------------------------------*
      *              * Se record esistente in archivio [zst]           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Flag di uscita a spaces                     *
      *                  *---------------------------------------------*
      ...
      *                  * Memorizzazione valori                       *
      *                  *---------------------------------------------*
           move      rf-zst-des-cls       to   w-let-arc-s01-des      .
           move      rf-zst-mne-cls       to   w-let-arc-s01-mne      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-s01-900.
       let-arc-s01-400.
      *              *-------------------------------------------------*
      *              * Se record non esistente in archivio [zst]       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Flag di uscita a '#'                        *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [zst], tipo record 02         *
      *    *-----------------------------------------------------------*
       let-arc-s02-000.
      *              *-------------------------------------------------*
      *              * Test se codice pari al valore precedente        *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-let-arc-s02-cod    to   rf-zst-cod-cls         .
           move      "pgm/dcc/fls/ioc/obj/iofzst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Memorizzazione valori                       *
      *                  *---------------------------------------------*
           move      rf-zst-des-cls       to   w-let-arc-s02-des      .
           move      rf-zst-mne-cls       to   w-let-arc-s02-mne      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-s02-900.
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [zst], tipo record 03         *
      *    *-----------------------------------------------------------*
       let-arc-s03-000.
      *              *-------------------------------------------------*
      *              * Test se codice pari al valore precedente        *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-let-arc-s03-cod    to   rf-zst-cod-cls         .
           move      "pgm/dcc/fls/ioc/obj/iofzst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Memorizzazione valori                       *
      *                  *---------------------------------------------*
           move      rf-zst-des-cls       to   w-let-arc-s03-des      .
           move      rf-zst-mne-cls       to   w-let-arc-s03-mne      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-s03-900.
