      ...
      *                       Ultima revisione:    NdK del 04/09/19    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf8001:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       pmt-tip-scd-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tipi scadenza :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tip-scd-999.
      ...
      *                  * 06 - Fattura di Acconto                     *
      *                  *---------------------------------------------*
           if        w-let-arc-zfi-tdo    not  = 01 and
                     w-let-arc-zfi-tdo    not  = 02 and
                     w-let-arc-zfi-tdo    not  = 03 and
                     w-let-arc-zfi-tdo    not  = 06
      ...
      *                  * tipo movimento si normalizza e si visualiz- *
      *                  * za :                                        *
      *                  *  - Tipo di ordinamento per clienti          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * A fine dipendenze dall'impostazione     *
      *                      *-----------------------------------------*
      ...
      *                      * vero solo totale per tipo movimento,    *
