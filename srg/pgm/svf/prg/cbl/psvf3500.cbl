      ...
      *                       Ultima revisione:    NdK del 17/05/17    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf3501:        *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per classe statistica cliente - prodotto.   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FATTURATO PER CLASSE CLIENTE - PRODOTTO "       .
      ...
      *        *  - 01 : Solo il totale per ogni prodotto              *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "solo il Totale per ogni prodotto                  ".
                   15  filler             pic  x(50) value
                  "con la Lista documenti emessi per ogni prodotto   ".
                   15  filler             pic  x(50)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tor-csc.
               ...
               10  w-exp-tor-csc-t03.
                  ...
                  "Ordinamento per mnemonico del codice statistico   ".
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento prodotti                  *
      *        *-------------------------------------------------------*
           05  w-exp-tor-pro.
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento per i prodotti               *
      *    *-----------------------------------------------------------*
       pmt-tor-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo ordinamento per prodotti              *
      *    *-----------------------------------------------------------*
       acc-tor-pro-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Tipo ordinamento per prodotti           *
      *    *-----------------------------------------------------------*
       vis-tor-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      ...
      -              "o !            "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-250.
      *              *-------------------------------------------------*
      *              * Controllo : Tipo di ordinamento per prodotti    *
      *              *-------------------------------------------------*
       tdo-ric-sel-251.
           if        rr-tor-pro           not  = zero
                     go to tdo-ric-sel-252.
           move      "Manca il tipo di ordinamento per i prodotti !     
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-252.
           if        rr-tor-pro           =    01 or
           ...
           move      "Tipo di ordinamento per i prodotti errato !       
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-300.
      *              *-------------------------------------------------*
