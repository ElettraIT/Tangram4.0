      ...
      *                       Ultima revisione:    NdK del 02/02/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Generazione set da stampe statistiche sul   *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase svf950, nella sua globalita', esegue i tipi di gene-   *
      ...
      * SVF290      Statistica per cliente - non fatturato             *
      * SVF500      Statistica per prodotto                            *
      * SVF720      Statistica per agente - cliente                    *
      * SVF800      Statistica per tipo movimento - cliente            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  GENERAZIONE SELEZIONI DA STATISTICHE  "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'svf950'           *
      *              *-------------------------------------------------*
      ...
      *                  * svf290                                      *
      *                  *---------------------------------------------*
           move      "Statistica per Cliente - non fatturato    (svf290)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "SVF290    "         to   w-tin-ele-wci-alf      .
           move      "pgm/svf/prg/obj/psvf2900                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * svf500                                      *
      *                  *---------------------------------------------*
           move      "Statistica per Prodotto                   (svf500)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
      ...
      *                  * svf800                                      *
      *                  *---------------------------------------------*
           move      "Statistica per tipo movimento - Cliente   (svf800)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
