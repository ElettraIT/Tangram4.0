      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf6701:        *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per classe statistica prodotto - agente.    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " FATTURATO PER CLASSE PRODOTTO - AGENTE "       .
      ...
      *        *  - 02 : Con lista documenti emessi per ogni agente    *
      *        *-------------------------------------------------------*
      ...
      *        *  - 03 : Ordinamento ABC crescente sul fatturato       *
      *        *  - 04 : Ordinamento ABC crescente sulla quantita'     *
      *        *  - 05 : Ordinamento per nominativo agente             *
      *        *  - 06 : Ordinamento per codice agente                 *
      *        *  - 07 : Ordinamento per mnemonico agente              *
      *        *-------------------------------------------------------*
      ...
      *        * la lista documenti emessi per ogni agente             *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "Solo il totale per ogni agente                    ".
                   15  filler             pic  x(50) value
                  "Con la lista documenti emessi per ogni agente     ".
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tor-age.
               10  w-exp-tor-age-num      pic  9(02)       value 7    .
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-202.
           ...
           move      "Tipo di ordinamento per agenti errato !           
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-300.
      *              *-------------------------------------------------*
