      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf6401:       *
      *                                                                *
      ...
      *                *   02 : Totale per classe geografica cliente   *
      *                *-----------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Subchiave 2 : Per classe geografica cliente       *
      *            *---------------------------------------------------*
               10  srt-k02.
      *                *-----------------------------------------------*
      *                * Valore ABC                                    *
      ...
      *                * - Per codice                                  *
      *                *-----------------------------------------------*
                   15  srt-k02-flg-sod    pic  9(01)                  .
      *                *-----------------------------------------------*
      *                * Codice classe geografica                      *
      *                *                                               *
      *                * Per tutti i tipi ordinamento classe geografi- *
      *                * ca                                            *
      *                *-----------------------------------------------*
                   15  srt-k02-cod-cgc    pic  x(03)                  .
      *            *---------------------------------------------------*
      ...
      *        * la lista documenti emessi per ogni classe geografica  *
      *        * cliente                                               *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-rot-l01.
      *            *---------------------------------------------------*
      *            * Codice della classe geografica cliente            *
      *            *---------------------------------------------------*
               10  w-rot-l01-cod-cgc      pic  x(03)                  .
      ...
      *            *---------------------------------------------------*
      *            * Numero documenti trattati per la classe geografi- *
      *            * ca cliente                                        *
      *            *---------------------------------------------------*
               10  w-liv-cgc-num-doc      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Codice classe statistica prodotto                     *
      *        *-------------------------------------------------------*
           05  w-liv-csp.
      ...
      *            *---------------------------------------------------*
      *            * Numero classi geografiche cliente trattate per la *
      *            * classe statistica prodotto                        *
      *            *---------------------------------------------------*
               10  w-liv-csp-num-cgc      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per stampa del codice classe geografica cli- *
      *        * ente e della descrizione della classe                 *
      *        *-------------------------------------------------------*
           05  w-stp-cde-cgc.
      *            *---------------------------------------------------*
      *            * Codice della classe geografica prodotto           *
      *            *---------------------------------------------------*
               10  w-stp-cde-cgc-cod      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Descrizione per la classe                         *
      *            *---------------------------------------------------*
               10  w-stp-cde-cgc-des      pic  x(25)                  .
      *        *-------------------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       sel-fit-rec-200.
      *              *-------------------------------------------------*
      *              * Lettura classe geografica cliente               *
      *              *-------------------------------------------------*
       sel-fit-rec-225.
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rr-tor-cgc           not  = 01 and
                     ...
                     rr-tor-cgc           not  = 04 and
                     rr-tor-cgc           not  = 05
                     move  spaces         to   srt-k02-des-cgc
                     go to cmp-srt-rec-325.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fit-des-cgc    to   srt-k02-des-cgc        .
       cmp-srt-rec-325.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rr-tor-cgc           not  = 06
                     move  zero           to   srt-k02-flg-sod
                     go to cmp-srt-rec-330.
      *                          *-------------------------------------*
      *                          * Memorizzazione con test             *
      *                          *-------------------------------------*
           if        w-sel-fit-cod-cgc    =    spaces
                     move  9              to   srt-k02-flg-sod
           else      move  1              to   srt-k02-flg-sod        .
       cmp-srt-rec-330.
      *                      *-----------------------------------------*
      *                      * Codice classe geografica                *
      *                      *-----------------------------------------*
           move      w-sel-fit-cod-cgc    to   srt-k02-cod-cgc        .
       cmp-srt-rec-400.
      *                  *---------------------------------------------*
      *                  * Subchiave 3 : Per documento                 *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Solo se tipo ordinamento per classe geo-    *
      *                  * grafica cliente :                           *
      *                  *   - 01 : ABC decrescente sul fatturato      *
      *                  *   - 02 : ABC decrescente sulla quantita'    *
      *                  *   - 03 : ABC crescente sul fatturato        *
      ...
      *                          * Memorizzazione in area specifica    *
      *                          *-------------------------------------*
           move      srt-k02-val-abc      to   srt-val-abc-cgc        .
       agg-abc-sqz-650.
      *                      *-----------------------------------------*
      *                      * Eventuale aggiornamento del flag per    *
      *                      * record da non selezionare               *
      ...
      *                  * Codice della classe geografica cliente      *
      *                  *---------------------------------------------*
           move      srt-cod-cgc-cod      to   w-rot-l01-cod-cgc      .
      *              *-------------------------------------------------*
      *              * 2. livello di rottura                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-num-cgc      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Inizializzazione work area per livello di rot-  *
      *              * tura per classe geografica cliente              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice classe geografica                    *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cgc-num-doc      .
      *                  *---------------------------------------------*
      *                  * Numero di classi geografiche cliente trat-  *
      *                  * tate per la classe statistica del prodotto  *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-csp-num-cgc      .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              * per ogni classe geografica cliente              *
      *              *-------------------------------------------------*
       prn-fin-lr1-310.
      *                  *---------------------------------------------*
      *                  * Test se linee residue sufficienti           *
      ...
      *                  * geografica cliente e della sua descrizione  *
      *                  *---------------------------------------------*
       prn-fin-lr1-331.
      *                      *-----------------------------------------*
      *                      * Preparazione                            *
      ...
      *                          * Codice classe geografica cliente    *
      *                          *-------------------------------------*
           move      w-liv-cgc-cod-cgc    to   w-stp-cde-cgc-cod      .
      *                          *-------------------------------------*
      *                          * Descrizione classe                  *
      *                          *-------------------------------------*
           move      w-liv-cgc-des-cgc    to   w-stp-cde-cgc-des      .
       prn-fin-lr1-332.
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   stp-cde-cgc-000      thru stp-cde-cgc-999        .
       prn-fin-lr1-340.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-liv-cgc-val-umi    to   w-stp-sta-qfp-umi      .
           move      w-liv-cgc-val-dec    to   w-stp-sta-qfp-dec      .
           move      w-liv-cgc-qta-p1r    to   w-stp-sta-qfp-q01      .
           move      w-liv-cgc-tot-p1r    to   w-stp-sta-qfp-f01      .
           move      w-liv-cgc-qta-p2r    to   w-stp-sta-qfp-q02      .
           move      w-liv-cgc-tot-p2r    to   w-stp-sta-qfp-f02      .
           move      w-liv-cgc-qta-p3r    to   w-stp-sta-qfp-q03      .
           move      w-liv-cgc-tot-p3r    to   w-stp-sta-qfp-f03      .
      ...
      *                  *---------------------------------------------*
           if        w-cnt-prn-flg-int    not  = spaces
                     go to prn-fin-lr1-999.
      *                  *---------------------------------------------*
      *                  * A stampa totale classe geografica cliente   *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr1-440.
      *                  *---------------------------------------------*
      *                  * Stampa totale classe geografica cliente     *
      *                  *---------------------------------------------*
       prn-fin-lr1-450.
      *                      *-----------------------------------------*
      *                      * Preparazione literal per il totale      *
      ...
      *                  * mento trattato per la classe geografica     *
      *                  * cliente oppure no                           *
      *                  *---------------------------------------------*
           if        w-liv-cgc-num-doc    =    1
      ...
      *                      * classe geografica cliente e della sua   *
      *                      * descrizione                             *
      *                      *-----------------------------------------*
       prn-liv-det-651.
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-033.
           move      "PER 1. CODICE STATISTICO PRODOTTO - NAZIONE       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-034.
           move      "PER 1. CODICE STATISTICO PRODOTTO - REGIONE       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-035.
           move      "PER 1. CODICE STATISTICO PRODOTTO - PROVINCIA     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-036.
       ...
       stp-int-pag-037.
           move      "PER 2. CODICE STATISTICO PRODOTTO - NAZIONE       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-038.
           move      "PER 2. CODICE STATISTICO PRODOTTO - REGIONE       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-039.
           move      "PER 2. CODICE STATISTICO PRODOTTO - PROVINCIA     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-040.
       ...
       stp-int-pag-041.
           move      "PER 3. CODICE STATISTICO PRODOTTO - NAZIONE       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-042.
           move      "PER 3. CODICE STATISTICO PRODOTTO - REGIONE       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-043.
           move      "PER 3. CODICE STATISTICO PRODOTTO - PROVINCIA     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-044.
       ...
       stp-int-pag-045.
           move      "PER CLASSE MERCEOLOGICA PRODOTTO - NAZIONE        
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-046.
           move      "PER CLASSE MERCEOLOGICA PRODOTTO - REGIONE        
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-047.
           move      "PER CLASSE MERCEOLOGICA PRODOTTO - PROVINCIA      
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
      ...
      *    * della classe geografica del cliente                       *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-cde-cgc-cod : Codice della classe               *
      *    *                                                           *
      *    *   - w-stp-cde-cgc-des : Descrizione per la classe         *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       stp-cde-cgc-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-stp-cde-cgc-cod    =    spaces
                     go to stp-cde-cgc-300
           else      go to stp-cde-cgc-600.
       stp-cde-cgc-300.
      *              *-------------------------------------------------*
      *              * Se codice pari a spaces                         *
      *              *-------------------------------------------------*
       stp-cde-cgc-350.
      *                  *---------------------------------------------*
      *                  * Codice della classe                         *
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      016                  to   p-pos                  .
           move      w-stp-cde-cgc-cod    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cde-cgc-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      023                  to   p-pos                  .
           move      w-stp-cde-cgc-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cde-cgc-750.
      *                  *---------------------------------------------*
