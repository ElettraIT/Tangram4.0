      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf5001:       *
      *                                                                *
      ...
      *        * Giacenza prodotto                                     *
      *        *-------------------------------------------------------*
           05  w-sel-fir-gia-pro          pic s9(10)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Costo unitario prodotto (Ultimo costo)                *
      *        *-------------------------------------------------------*
           05  w-sel-fir-cst-pro          pic  9(11)                  .
      ...
      *                      * Codice prodotto                         *
      *                      *-----------------------------------------*
           move      w-cod-zos-dcp-cco    to   w-mod-fat-fir-pro      .
      *                      *-----------------------------------------*
      *                      * Numero periodi di riferimento           *
      *                      *-----------------------------------------*
           if        rr-num-pdr           =    11 or
      ...
      *              *-------------------------------------------------*
           if        w-cod-zos-dcp-tco    =    1
                     perform mod-fat-fir-cdg-000
                                          thru mod-fat-fir-cdg-999
           else      perform mod-fat-fir-get-000
                                          thru mod-fat-fir-get-999    .
       fil-fir-get-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-sel-fir-cst-pro      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      d-vun-mag-val-uni    to   w-sel-fir-cst-pro      .
       sel-fir-rec-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-fir-num-pro       to   d-sld-mag-num-mag      .
      ...
      *                  * Memorizzazione risultato                    *
      *                  *---------------------------------------------*
           move      d-sld-mag-sld-mag    to   w-sel-fir-gia-pro      .
      *                  *---------------------------------------------*
      *                  * Test di selezione                           *
      *                  *---------------------------------------------*
      ...
      *                      * Giacenza prodotto                       *
      *                      *-----------------------------------------*
           move      w-sel-fir-gia-pro    to   srt-cod-pro-gia        .
      *                      *-----------------------------------------*
      *                      * Costo prodotto                          *
      *                      *-----------------------------------------*
           move      w-sel-fir-cst-pro    to   srt-cod-pro-cst        .
       cmp-srt-rec-850.
      *                  *---------------------------------------------*
      *                  * Cliente                                     *
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-mod-not-svf-ncd    to   w-all-str-lun          .
      ...
      *                  *---------------------------------------------*
           move      rr-tip-cpe           to   w-mod-not-svf-cpe      .
           move      w-stp-ced-pro-num    to   w-mod-not-svf-pro      .
           move      w-stp-ced-pro-alf    to   w-mod-not-svf-alf      .
      *                  *---------------------------------------------*
      *                  * Richiamo effettivo del modulo               *
      *                  *---------------------------------------------*
           perform   mod-not-svf-cpe-000  thru mod-not-svf-cpe-999    .
      *                  *---------------------------------------------*
      *                  * Riassegnazione del codice prodotto          *
      *                  *---------------------------------------------*
           move      w-mod-not-svf-alf    to   w-stp-ced-pro-alf      .
       stp-ced-pro-050.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rr-tip-cpe           to   w-mod-not-svf-cpe      .
           move      w-liv-pro-num-pro    to   w-mod-not-svf-pro      .
           move      w-liv-pro-alf-pro    to   w-mod-not-svf-alf      .
      *                  *---------------------------------------------*
      *                  * Richiamo effettivo del modulo               *
      *                  *---------------------------------------------*
           perform   mod-not-svf-cpe-000  thru mod-not-svf-cpe-999    .
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   x-tip                  .
           move      14                   to   x-car                  .
           move      w-mod-not-svf-alf    to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Descrizione per il prodotto                 *
