      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf7251:       *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per agente - cliente - prodotto.            *
      *                                                                *
      *================================================================*
      ...
      *                *-----------------------------------------------*
                   15  srt-val-abc-age    pic s9(13)v9(03)            .
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " FATTURATO PER AGENTE-CLIENTE-PRODOTTO  "       .
      ...
      *            * Flag di unita' di misura memorizzata              *
      *            *---------------------------------------------------*
               10  w-liv-age-flg-umi      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore dell' unita' di misura memorizzata         *
      *            *---------------------------------------------------*
               10  w-liv-age-val-umi      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Flag di numero decimali memorizzati               *
      *            *---------------------------------------------------*
               10  w-liv-age-flg-dec      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore del numero decimali memorizzati            *
      *            *---------------------------------------------------*
               10  w-liv-age-val-dec      pic  9(01)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' 1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-age-qta-p1r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale fatturato 1. periodo di riferimento        *
      *            *---------------------------------------------------*
      ...
      *            * Totale quantita' 2. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-age-qta-p2r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale fatturato 2. periodo di riferimento        *
      *            *---------------------------------------------------*
      ...
      *            * Totale quantita' 3. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-age-qta-p3r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale fatturato 3. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-age-tot-p3r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Numero elementi trattati per l'agente             *
      *            *---------------------------------------------------*
               10  w-liv-age-num-ele      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *                          *-------------------------------------*
           if        rr-tor-age           not  = 01 and
                     ...
                     rr-tor-age           not  = 04 and
                     rr-tor-age           not  = 05 and
                     rr-tor-age           not  = 07
      ...
      *                  * Codice agente                               *
      *                  *---------------------------------------------*
           move      srt-cod-age-cod      to   w-rot-l06-cod-age      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  * Flag di unita' di misura memorizzata        *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-age-flg-umi      .
      *                  *---------------------------------------------*
      *                  * Valore dell' unita' di misura memorizzata   *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-age-val-umi      .
      *                  *---------------------------------------------*
      *                  * Flag di numero decimali memorizzati         *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-age-flg-dec      .
      *                  *---------------------------------------------*
      *                  * Valore del numero decimali memorizzati      *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-val-dec      .
      *                  *---------------------------------------------*
      *                  * Totale quantita' 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-qta-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 1. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * Totale quantita' 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-qta-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 2. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * Totale quantita' 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-qta-p3r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 3. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * Numero elementi trattati per l'agente       *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-num-ele      .
       prn-ini-lr6-150.
      *              *-------------------------------------------------*
      *              * Incrementi per il livello successivo            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Numero di agenti trattati per il totale ge- *
      *                  * nerale                                      *
      *                  *---------------------------------------------*
      ...
      *                      * Valore appendice al codice              *
      *                      *-----------------------------------------*
           move      spaces               to   w-stp-sub-app-cod      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tpc-pdv           =    02
                     move  w-liv-age-qta-p1r
                                          to   w-stp-clc-pdv-v01
                     move  w-liv-age-qta-p2r
                                          to   w-stp-clc-pdv-v02
                     move  w-liv-age-qta-p3r
                                          to   w-stp-clc-pdv-v03
           else      move  w-liv-age-tot-p1r
                                          to   w-stp-clc-pdv-v01
                     move  w-liv-age-tot-p2r
                                          to   w-stp-clc-pdv-v02
                     move  w-liv-age-tot-p3r
                                          to   w-stp-clc-pdv-v03      .
           perform   stp-clc-pdv-000      thru stp-clc-pdv-999        .
       prn-fin-lr6-125.
      *              *-------------------------------------------------*
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-age-qta-p1r    to   w-mod-not-svf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
      ...
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-age-qta-p2r    to   w-mod-not-svf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-age-qta-p3r    to   w-mod-not-svf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      spaces               to   w-stp-sta-tot-ldc      .
           if        w-prs-svf-tqn-snx    =    "N"
                     if    w-liv-age-flg-umi
                                          =    "N"
                           move  "N"      to   w-stp-sta-tot-snq
                     else  move  "S"      to   w-stp-sta-tot-snq
           else      move  "S"            to   w-stp-sta-tot-snq      .
           move      w-liv-age-val-dec    to   w-stp-sta-tot-dec      .
           move      w-liv-age-val-umi    to   w-stp-sta-tot-umi      .
           move      w-liv-age-qta-p1r    to   w-stp-sta-tot-q01      .
           move      w-liv-age-tot-p1r    to   w-stp-sta-tot-f01      .
           move      w-liv-age-qta-p2r    to   w-stp-sta-tot-q02      .
           move      w-liv-age-tot-p2r    to   w-stp-sta-tot-f02      .
           move      w-liv-age-qta-p3r    to   w-stp-sta-tot-q03      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Numero di clienti trattati per il totale    *
      *                  * agente                                      *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-age-num-ele      .
       prn-ini-lr5-500.
      *              *-------------------------------------------------*
      ...
      *                  * Per livello agente                          *
      *                  *---------------------------------------------*
           if        w-liv-age-flg-umi    =    spaces
                     move  "S"            to   w-liv-age-flg-umi
                     move  srt-cod-pro-umi
                                          to   w-liv-age-val-umi
           else if   w-liv-age-val-umi    not  = srt-cod-pro-umi
                     move  "N"            to   w-liv-age-flg-umi
                     move  spaces         to   w-liv-age-val-umi      .
      *                  *---------------------------------------------*
      *                  * Per livello cliente                         *
      *                  *---------------------------------------------*
      ...
      *                  * Per livello agente                          *
      *                  *---------------------------------------------*
           if        w-liv-age-flg-dec    =    spaces
                     move  "#"            to   w-liv-age-flg-dec
                     move  srt-cod-pro-dec
                                          to   w-liv-age-val-dec
           else if   w-liv-age-val-dec    not  = srt-cod-pro-dec
                     move  9              to   w-liv-age-val-dec      .
      *                  *---------------------------------------------*
      *                  * Per livello cliente                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn1      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-age-qta-p1r
                           add      srt-val-sta-val
                                          to   w-liv-age-tot-p1r
                     else  subtract srt-val-sta-qta
                                          from w-liv-age-qta-p1r
                           subtract srt-val-sta-val
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn2      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-age-qta-p2r
                           add      srt-val-sta-val
                                          to   w-liv-age-tot-p2r
                     else  subtract srt-val-sta-qta
                                          from w-liv-age-qta-p2r
                           subtract srt-val-sta-val
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn3      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-age-qta-p3r
                           add      srt-val-sta-val
                                          to   w-liv-age-tot-p3r
                     else  subtract srt-val-sta-qta
                                          from w-liv-age-qta-p3r
                           subtract srt-val-sta-val
      ...
      *                  * lineato a sinistra                          *
      *                  *---------------------------------------------*
           move      "PER AGENTE - CLIENTE - PRODOTTO                   
      -              "                              "
