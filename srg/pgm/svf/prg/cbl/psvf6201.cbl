      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf6201:       *
      *                                                                *
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-num-cli      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Numero clienti trattati per la classe sta-  *
      *                  * tistica prodotto                            *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-csp-num-cli      .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-liv-cli-val-umi    to   w-stp-sta-qfp-umi      .
           move      w-liv-cli-val-dec    to   w-stp-sta-qfp-dec      .
           move      w-liv-cli-qta-p1r    to   w-stp-sta-qfp-q01      .
           move      w-liv-cli-tot-p1r    to   w-stp-sta-qfp-f01      .
           move      w-liv-cli-qta-p2r    to   w-stp-sta-qfp-q02      .
           move      w-liv-cli-tot-p2r    to   w-stp-sta-qfp-f02      .
           move      w-liv-cli-qta-p3r    to   w-stp-sta-qfp-q03      .
           move      w-liv-cli-tot-p3r    to   w-stp-sta-qfp-f03      .
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-031.
           move      "PER 1. CODICE STATISTICO PRODOTTO - CLIENTE       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-032.
           move      "PER 2. CODICE STATISTICO PRODOTTO - CLIENTE       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-033.
           move      "PER 3. CODICE STATISTICO PRODOTTO - CLIENTE       
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-034.
           move      "PER CLASSE MERCEOLOGICA PRODOTTO - CLIENTE        
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
