      ...
      *                       Ultima revisione:    NdK del 09/06/17    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf2501:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    FATTURATO PER CLIENTE - PRODOTTO    "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      10                   to   w-cod-zos-dcp-lin      .
           move      30                   to   w-cod-zos-dcp-pos      .
           move      10                   to   w-cod-zos-dcp-dln      .
      ...
      *                  * mento prodotti in caso di filtro di sele-   *
      *                  * zione indicante un solo codice prodotto     *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
      ...
      *                  * prodotti [dcp] indica la selezione di un    *
      *                  * solo prodotto : no accettazione             *
      *                  *---------------------------------------------*
      ...
      *                  * Se il filtro di selezione sull'anagrafica   *
      *                  * prodotti [dcp] indica la selezione di un    *
      *                  * solo prodotto : si regolarizza a 05 il ti-  *
      *                  * po ordinamento prodotti, per codice         *
      *                  *---------------------------------------------*
           if        rr-fso-dcp           not  < 10000000 and
                     rr-fso-dcp           not  > 19999999
