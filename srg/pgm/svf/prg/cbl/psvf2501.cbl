      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf2501:       *
      *                                                                *
      ...
      *            * Costo fatturato  1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-cli-cos-p1r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Valore del costo 1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-cli-vco-p1r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' 2. periodo di riferimento        *
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Numero prodotti trattati per il cliente           *
      *            *---------------------------------------------------*
               10  w-liv-cli-num-pro      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *                  * Costo fatturato  1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cli-cos-p1r      .
      *                  *---------------------------------------------*
      *                  * Valore del costo 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cli-vco-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale quantita' 2. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * Numero prodotti trattati per il cliente     *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cli-num-pro      .
      *                  *---------------------------------------------*
      *                  * Numero di clienti trattati in totale        *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-liv-cli-cos-p1r    to   w-stp-sta-tot-cf1      .
           move      w-liv-cli-vco-p1r    to   w-stp-sta-tot-vf1      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-261.
           add       srt-val-sta-qta      to   w-liv-cli-qta-p1r      .
           add       srt-val-sta-val      to   w-liv-cli-tot-p1r      .
           if        srt-val-sta-cos      not  = zero
                     add      srt-val-sta-cos
                                          to   w-liv-cli-cos-p1r
                     add      srt-val-sta-val
                                          to   w-liv-cli-vco-p1r      .
           go to     prn-liv-det-263.
       prn-liv-det-262.
           subtract  srt-val-sta-qta      from w-liv-cli-qta-p1r      .
           subtract  srt-val-sta-val      from w-liv-cli-tot-p1r      .
           if        srt-val-sta-cos      not  = zero
                     subtract srt-val-sta-cos
                                          from w-liv-cli-cos-p1r
                     subtract srt-val-sta-val
                                          from w-liv-cli-vco-p1r      .
           go to     prn-liv-det-263.
       prn-liv-det-263.
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-271.
           add       srt-val-sta-qta      to   w-liv-cli-qta-p2r      .
           add       srt-val-sta-val      to   w-liv-cli-tot-p2r      .
           go to     prn-liv-det-273.
       prn-liv-det-272.
           subtract  srt-val-sta-qta      from w-liv-cli-qta-p2r      .
           subtract  srt-val-sta-val      from w-liv-cli-tot-p2r      .
           go to     prn-liv-det-273.
       prn-liv-det-273.
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-281.
           add       srt-val-sta-qta      to   w-liv-cli-qta-p3r      .
           add       srt-val-sta-val      to   w-liv-cli-tot-p3r      .
           go to     prn-liv-det-283.
       prn-liv-det-282.
           subtract  srt-val-sta-qta      from w-liv-cli-qta-p3r      .
           subtract  srt-val-sta-val      from w-liv-cli-tot-p3r      .
           go to     prn-liv-det-283.
       prn-liv-det-283.
      ...
      *                          *-------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                          *-------------------------------------*
      *                          * Eventuale literal per tipo confron- *
      *                          * to fatturati                        *
      *                          *-------------------------------------*
      ...
      *
           ...
           move      050                  to   p-pos                  .
           if        rr-tpc-pdv           =    01
                     move  "Per confronto tra i fatturati           "
                                          to   p-alf
           else      move  "Per confronto tra le quantita'          "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-int-pag-550.
