      ...
      *                                   Fase:    svf470              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/09/03    *
      *                       Ultima revisione:    NdK del 23/09/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf4701:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FATTURATO CLASSI GEOGRAFICA E STATISTICA"       .
      ...
      *        *   - P : Si, ma solo in statistiche sui clienti        *
      *        *-------------------------------------------------------*
      ...
      *        * la lista documenti emessi per ogni classe cliente     *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "solo il Totale per ogni classe cliente            ".
                   15  filler             pic  x(50) value
                  "con la Lista documenti per ogni classe cliente    ".
                   15  filler             pic  x(50)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-300.
      *                  *---------------------------------------------*
      *                  * Tipo di classe statistica cliente           *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pmt-tor-csc-000.
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Ordinamento classe cliente :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tor-csc-999.
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo classe statistica cliente             *
      *    *-----------------------------------------------------------*
       acc-tcs-cli-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Tipo di classe statistica clienti       *
      *    *-----------------------------------------------------------*
       vis-tcs-cli-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      ...
      -              "te errato !    "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-250.
      *              *-------------------------------------------------*
      *              * Controllo : Tipo classe statistica clienti      *
      *              *-------------------------------------------------*
       tdo-ric-sel-251.
