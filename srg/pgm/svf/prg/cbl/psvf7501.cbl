      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf7501:       *
      *                                                                *
      ...
      * --------------------------                                     *
      *                                                                *
      * Fatturato - Costo del fatturato = Differenza                   *
      * Differenza * 100                                               *
      * Fatturato / (Differenza * 100)                                 *
      *================================================================*
      ...
      *            * Costo fatturato  1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-age-cos-p1r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Valore del costo 1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-age-vco-p1r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' 2. periodo di riferimento        *
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Numero prodotti trattati per l'agente             *
      *            *---------------------------------------------------*
               10  w-liv-age-num-pro      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Totale margini prodotto per l'agente              *
      *            *---------------------------------------------------*
               10  w-liv-age-mrg-tot      pic s9(15)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *            *---------------------------------------------------*
      *            * Totale margini prodotto in totale                 *
      *            *---------------------------------------------------*
               10  w-liv-gen-mrg-tot      pic s9(15)v9(03)            .
      *            *---------------------------------------------------*
      ...
      *            * Margine                                           *
      *            *---------------------------------------------------*
               10  w-stp-sta-tot-rmr      pic  9(09)                  .
               10  w-stp-sta-tot-tmr      pic s9(15)v9(03)            .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-stp-edt-mrg-edt      pic  x(09)                  .
      *            *---------------------------------------------------*
      *            * Tipo di margine                                   *
      *            *---------------------------------------------------*
               10  w-stp-edt-mrg-tip      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Work per calcolo del margine                      *
      *            *---------------------------------------------------*
               10  w-stp-edt-mrg-wcm      pic s9(13)v9(02)            .
      *        *-------------------------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-des-pro    to   srt-k02-des-pro        .
       cmp-srt-rec-325.
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-alf-pro    to   srt-k02-alf-pro        .
       cmp-srt-rec-335.
      *                      *-----------------------------------------*
      *                      * Codice numerico prodotto                *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fir-num-pro    to   srt-k02-num-pro        .
       cmp-srt-rec-400.
      *                  *---------------------------------------------*
      *                  * Subchiave 3 : Per documento                 *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Totale margini trattati                     *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-gen-mrg-tot      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "      "             to   w-stp-sta-tot-lit      .
           ...
           move      w-liv-gen-num-pro    to   w-stp-sta-tot-rmr      .
           move      w-liv-gen-mrg-tot    to   w-stp-sta-tot-tmr      .
      ...
      *                  * Costo fatturato  1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-cos-p1r      .
      *                  *---------------------------------------------*
      *                  * Valore del costo 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-vco-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale quantita' 2. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * Numero prodotti trattati per l'agente       *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-num-pro      .
      *                  *---------------------------------------------*
      *                  * Totale margini prodotto per l'agente        *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-mrg-tot      .
      *                  *---------------------------------------------*
      *                  * Numero di agenti trattati in totale         *
      *                  *---------------------------------------------*
      ...
      *                      * agente con indicazione del numero di    *
      *                      * prodotti estratti                       *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Editing numero prodotti trattati    *
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      11                   to   p-car                  .
           ...
           move      "<BG"                to   p-edm                  .
           move      w-liv-age-num-pro    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                          *-------------------------------------*
      *                          * Concatenazione                      *
      *                          *-------------------------------------*
           ...
           move      "Totale agente"      to   w-all-str-cat (1)      .
           move      w-liv-age-nom-age    to   w-all-str-cat (2)      .
      *
           if        w-liv-age-num-pro    not  > 1
                     ...
                     move  "prodotti ):"  to   w-all-str-cat (5)      .
      *
      ...
      *                      *-----------------------------------------*
           ...
           move      w-liv-age-cos-p1r    to   w-stp-sta-tot-cf1      .
           move      w-liv-age-vco-p1r    to   w-stp-sta-tot-vf1      .
           ...
           move      w-stp-clc-pdv-p01    to   w-stp-sta-tot-p01      .
           move      w-stp-clc-pdv-p02    to   w-stp-sta-tot-p02      .
           move      w-liv-age-num-pro    to   w-stp-sta-tot-rmr      .
           move      w-liv-age-mrg-tot    to   w-stp-sta-tot-tmr      .
           move      w-mod-not-svf-not    to   w-stp-sta-tot-not      .
       prn-fin-lr2-450.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-261.
           add       srt-val-sta-qta      to   w-liv-age-qta-p1r      .
           add       srt-val-sta-val      to   w-liv-age-tot-p1r      .
           if        srt-val-sta-cos      not  = zero
                     add      srt-val-sta-cos
                                          to   w-liv-age-cos-p1r
                     add      srt-val-sta-val
                                          to   w-liv-age-vco-p1r      .
           go to     prn-liv-det-263.
       prn-liv-det-262.
           subtract  srt-val-sta-qta      from w-liv-age-qta-p1r      .
           subtract  srt-val-sta-val      from w-liv-age-tot-p1r      .
           if        srt-val-sta-cos      not  = zero
                     subtract srt-val-sta-cos
                                          from w-liv-age-cos-p1r
                     subtract srt-val-sta-val
                                          from w-liv-age-vco-p1r      .
           go to     prn-liv-det-263.
       prn-liv-det-263.
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-271.
           add       srt-val-sta-qta      to   w-liv-age-qta-p2r      .
           add       srt-val-sta-val      to   w-liv-age-tot-p2r      .
           go to     prn-liv-det-273.
       prn-liv-det-272.
           subtract  srt-val-sta-qta      from w-liv-age-qta-p2r      .
           subtract  srt-val-sta-val      from w-liv-age-tot-p2r      .
           go to     prn-liv-det-273.
       prn-liv-det-273.
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-281.
           add       srt-val-sta-qta      to   w-liv-age-qta-p3r      .
           add       srt-val-sta-val      to   w-liv-age-tot-p3r      .
           go to     prn-liv-det-283.
       prn-liv-det-282.
           subtract  srt-val-sta-qta      from w-liv-age-qta-p3r      .
           subtract  srt-val-sta-val      from w-liv-age-tot-p3r      .
           go to     prn-liv-det-283.
       prn-liv-det-283.
      ...
      *                      *-----------------------------------------*
       ...
       stp-int-pag-600.
      *              *-------------------------------------------------*
      *              * Eventuale indicazione clienti selezionati       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se un solo cliente                     *
      *                  *---------------------------------------------*
           if        rr-cod-cli           =    zero
                     go to stp-int-pag-700.
      *                  *---------------------------------------------*
      *                  * Literal 'Cliente selezionato    :'          *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      24                   to   p-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Ragione sociale Cliente selezionato         *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
      ...
      *                  * A post-intestazione                         *
      *                  *---------------------------------------------*
           go to     stp-int-pag-800.
       stp-int-pag-700.
      *                  *---------------------------------------------*
      *                  * Test se una selezione di clienti            *
      *                  *---------------------------------------------*
           if        rr-cod-cli-sns       =    zero
                     go to stp-int-pag-800.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-720.
           ...
           if        rr-cod-cli-eco
                    (w-sel-fit-ctr-cli)   =    zero
                     go to stp-int-pag-720.
      *                  *---------------------------------------------*
      *                  * Test se primo elemento                      *
      *                  *---------------------------------------------*
           if        w-sel-fit-ctr-cli    >    1
                     go to stp-int-pag-740.
      *                  *---------------------------------------------*
      *                  * Literal 'Clienti selezionati    :'          *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      24                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Clienti selezionati    :"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *
           go to     stp-int-pag-760.
       stp-int-pag-740.
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-stp-edt-mrg-wcm      .
      *              *-------------------------------------------------*
      *              * Se la subroutine riguarda i totali, il margine  *
      *              * medio viene ricalcolato come media dei margini  *
      *              * esposti in dettaglio                            *
      *              *-------------------------------------------------*
           if        w-stp-edt-mrg-tip    =    "D"
                     go to stp-edt-mrg-400.
       stp-edt-mrg-200.
      *              *-------------------------------------------------*
      *              * Se margine relativo al totale                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Determinazione margine come media dei mar-  *
      *                  * gini in riga                                *
      *                  *---------------------------------------------*
           divide    w-stp-sta-tot-rmr    into w-stp-sta-tot-tmr
                                        giving w-stp-edt-mrg-wcm      .
      *                  *---------------------------------------------*
      *                  * A editing                                   *
      *                  *---------------------------------------------*
           go to     stp-edt-mrg-800.
       stp-edt-mrg-400.
      *              *-------------------------------------------------*
      *              * Se margine relativo al dettaglio                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se entrambi i valori a zero : uscita con    *
      *                  * spaces                                      *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Se uno solo dei due valori e' a zero :      *
      *                  * uscita con dicitura 'Non determinabile'     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           divide    w-stp-edt-mrg-fat    into w-stp-edt-mrg-wcm
                                                         rounded      .
      *                  *---------------------------------------------*
      *                  * Aggiornamento margine determinato           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Agente                                  *
      *                      *-----------------------------------------*
           add       w-stp-edt-mrg-wcm    to   w-liv-age-mrg-tot      .
      *                      *-----------------------------------------*
      *                      * Totale                                  *
      *                      *-----------------------------------------*
           add       w-stp-edt-mrg-wcm    to   w-liv-gen-mrg-tot      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-stp-edt-mrg-wcm    =    zero
                     ...
                     go to stp-edt-mrg-999.
      *                  *---------------------------------------------*
      *                  * Se margine maggiore del massimo : uscita    *
      *                  * con il massimo editato                      *
      *                  *---------------------------------------------*
...
1       exe-gen-fil-age-500.
      ...
      *                  *---------------------------------------------*
           move      w-stp-sta-qfp-dec    to   w-stp-edt-qta-dec      .
           move      w-stp-sta-qfp-cf1    to   w-stp-edt-qta-qta      .
           perform   stp-edt-qta-000      thru stp-edt-qta-999        .
      *                  *---------------------------------------------*
      *                  * In campo di uscita                          *
      *                  *---------------------------------------------*
       ...
       exe-gen-fil-age-700.
      *              *-------------------------------------------------*
      *              * Mnemonici classificazione merceologica prodotto *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura dati classe, gruppo, sottogruppo    *
      *                  *---------------------------------------------*
           move      w-liv-pro-cod-num    to   w-let-arc-dcp-cod      .
           perform   let-arc-dcp-000      thru let-arc-dcp-999        .
      *
           move      w-let-arc-dcp-cla    to   w-let-arc-zp1-cla      .
           perform   let-arc-zp1-000      thru let-arc-zp1-999        .
      *
           move      w-let-arc-dcp-cla    to   w-let-arc-zp2-cla      .
           move      w-let-arc-dcp-gru    to   w-let-arc-zp2-gru      .
           perform   let-arc-zp2-000      thru let-arc-zp2-999        .
      *
           move      w-let-arc-dcp-cla    to   w-let-arc-zp3-cla      .
           move      w-let-arc-dcp-gru    to   w-let-arc-zp3-gru      .
           move      w-let-arc-dcp-sgr    to   w-let-arc-zp3-sgr      .
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   x-tip                  .
           move      05                   to   x-car                  .
           move      w-let-arc-zp1-mne    to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Mnemonico gruppo                            *
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   x-tip                  .
           move      05                   to   x-car                  .
           move      w-let-arc-zp2-mne    to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   x-tip                  .
           move      05                   to   x-car                  .
           move      w-let-arc-zp3-mne    to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
       exe-gen-fil-age-800.
      *              *-------------------------------------------------*
