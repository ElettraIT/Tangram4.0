      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf3501:       *
      *                                                                *
      ...
      *                *-----------------------------------------------*
      *                * Tipo record                                   *
      *                *   01 : Totale per classe statistica clienti   *
      *                *   02 : Totale per prodotto                    *
      *                *-----------------------------------------------*
                   15  kk0-tip-rec        pic  9(02)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica clienti              *
      *                *-----------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Numero prodotti trattati per la classe statistica *
      *            *---------------------------------------------------*
               10  w-liv-csc-num-pro      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *                              * Codice prodotto                 *
      *                              *---------------------------------*
           move      w-sel-fir-num-pro    to   w-mod-not-svf-pro      .
      *                              *---------------------------------*
      *                              * Sconti in riga                  *
      *                              *---------------------------------*
           move      rf-fir-per-scr (1)   to   w-mod-not-svf-scr (1)  .
           move      rf-fir-per-scr (2)   to   w-mod-not-svf-scr (2)  .
           move      rf-fir-per-scr (3)   to   w-mod-not-svf-scr (3)  .
           move      rf-fir-per-scr (4)   to   w-mod-not-svf-scr (4)  .
           move      rf-fir-per-scr (5)   to   w-mod-not-svf-scr (5)  .
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Numero di classi statistiche trattate in    *
      *                  * totale                                      *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Numero prodotti trattati per la classe      *
      *                  * statistica                                  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csc-num-pro      .
      *                  *---------------------------------------------*
      *                  * Numero di classi statistiche trattate in    *
      *                  * totale                                      *
      *                  *---------------------------------------------*
      ...
      *                      * Codice prodotto                         *
      *                      *-----------------------------------------*
           move      w-liv-pro-cod-num    to   w-mod-not-svf-pro      .
      *                  *---------------------------------------------*
      *                  * Richiamo effettivo del modulo               *
      *                  *---------------------------------------------*
           perform   mod-not-svf-dvn-000  thru mod-not-svf-dvn-999    .
      ...
      *              *-------------------------------------------------*
       prn-fin-lr1-420.
      *                  *---------------------------------------------*
      *                  * Test sul numero di documenti trattati per   *
      *                  * il prodotto                                 *
      *                  *---------------------------------------------*
           if        w-liv-pro-num-doc    not  > 1
                     go to prn-fin-lr1-490.
      *                  *---------------------------------------------*
      *                  * Test se linee residue sufficienti           *
      *                  *---------------------------------------------*
           if        p-res                >    2
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-250.
      *              *-------------------------------------------------*
      *              * Accumuli per livello classe statistica          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Totali 1. periodo di riferimento            *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-031.
           move      "PER ZONA DI APPARTENENZA DEI CLIENTI - PRODOTTO   
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-032.
           move      "PER CATEGORIA DI CLIENTE - PRODOTTO               
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-033.
           move      "PER CLASSIFICAZIONE STATISTICA DEI CLIENTI - PRODO
      -              "TTO                           "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
      ...
      *                  *---------------------------------------------*
           ...
           move      "<B"                 to   x-edm                  .
           move      w-liv-csc-cod-csc    to   x-num                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Descrizione per la classe statistica        *
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   x-tip                  .
           move      40                   to   x-car                  .
           move      w-liv-csc-des-csc    to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico del prodotto            *
