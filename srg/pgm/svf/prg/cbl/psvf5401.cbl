      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf5401:       *
      *                                                                *
      ...
      *            *---------------------------------------------------*
      *            * Numero classi geografiche cliente trattate per il *
      *            * prodotto                                          *
      *            *---------------------------------------------------*
               10  w-liv-pro-num-cgc      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *                  *---------------------------------------------*
      *                  * Numero classi geografiche cliente trattate  *
      *                  *  per il prodotto                            *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-pro-num-cgc      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-031.
           move      "PER PRODOTTO - NAZIONE                            
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-032.
           move      "PER PRODOTTO - REGIONE                            
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-033.
           move      "PER PRODOTTO - PROVINCIA                          
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
