      ...
      * "OP"  Open modulo                                              *
      *                                                                *
      *              Input  : w-mod-not-svf-ope : "OP"                 *
      *                                                                *
      *                       w-mod-not-svf-fas : Sigla fase gestiona- *
      *                                           le del programma che *
      *                                           invoca il modulo     *
      *                                                                *
      *                       w-mod-not-svf-war : Copia di lavoro del- *
      *                                           l'area di richieste  *
      *                                           del programma chia-  *
      *                                           mante                *
      *                                                                *
      *                       w-mod-not-svf-npr : Numero periodi di    *
      *                                           riferimento per la   *
      *                                           statistica           *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-mod-not-svf-ope : "VN"                 *
      *                                                                *
      *                       w-mod-not-svf-tdd : Tipo di determina-   *
      *                                           zione, che varia da  *
      *                                           una fase gestionale  *
      *                                           all'altra            *
      *                                                                *
      *                       w-mod-not-svf-ncd : Numero di caratteri  *
      *                                           disponibili per il   *
      *                                           valore del campo di  *
      *                                           'Note' da determina- *
      *                                           re                   *
      *                                                                *
      *                       w-mod-not-svf-q01 : 1. quantita'         *
      *                       w-mod-not-svf-f01 : 1. fatturato         *
      *                       w-mod-not-svf-q02 : 2. quantita'         *
      *                       w-mod-not-svf-f02 : 2. fatturato         *
      *                       w-mod-not-svf-p01 : 1. % di variazione   *
      *                       w-mod-not-svf-q03 : 3. quantita'         *
      *                       w-mod-not-svf-f03 : 3. fatturato         *
      *                       w-mod-not-svf-p02 : 2. % di variazione   *
      *                       w-mod-not-svf-tdo : Tipo documento       *
      *                       w-mod-not-svf-ddo : Data documento       *
      *                       w-mod-not-svf-ndo : Nr.  documento       *
      *                       w-mod-not-svf-cli : Codice cliente       *
      *                       w-mod-not-svf-dpc : Dipendenza cliente   *
      *                       w-mod-not-svf-pro : Codice prodotto      *
      *                                                                *
      ...
      *                                                                *
      *                                                                *
      *              Output : w-mod-not-svf-not : Valore determinato   *
      *                                           del campo 'Note'     *
      *                                           da esporre           *
      *                                                                *
      *       -------------------------------------------------------- *
      ...
      *                                                                *
      *              Input  : w-mod-not-svf-ope : "CP"                 *
      *                                                                *
      *                       w-mod-not-svf-cpe : tipo di codice da    *
      *                                           esporre              *
      *                                                                *
      *                       w-mod-not-svf-pro : codice numerico del  *
      *                                           prodotto da stampare *
      *                                                                *
      *                       w-mod-not-svf-alf : codice alfanumerico  *
      *                                           prodotto da stampare *
      *                                                                *
      *                                                                *
      *              Output : w-mod-not-svf-alf : Valore determinato   *
      *                                           del campo 'Note'     *
      *                                           da esporre           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-aux-not-svf-not          pic  x(80)                  .
      *        *-------------------------------------------------------*
      *        * Comodi                                                *
      *        *-------------------------------------------------------*
           05  w-aux-not-svf-wk1          pic  9(09)                  .
      ...
      ******************************************************************
       Procedure Division                using w-mod-not-svf
                                               rf-fit
                                               rf-fir                 .
      ******************************************************************
      ...
      *              * zione passato                                   *
      *              *-------------------------------------------------*
           if        w-mod-not-svf-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-mod-not-svf-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-mod-not-svf-ope    =    "VN"
                     perform   dvn-000    thru dvn-999
           else if   w-mod-not-svf-ope    =    "CP"
      ...
      *    *                                                           *
      *    * - w-mod-not-svf-fas : Sigla fase gestionale del programma *
      *    *                       chiamante                           *
      *    *                                                           *
      *    * - w-mod-not-svf-war : Copia di lavoro dell'area richieste *
      *    *                       del programma chiamante             *
      *    *                                                           *
      *    * - w-mod-not-svf-npr : Numero periodi di riferimento per   *
      *    *                       la statistica                       *
      *    *                                                           *
      *    *                                                           *
      *    *   Dati a disposizione dalla funzione 'VN'                 *
      *    *                                                           *
      *    * - w-mod-not-svf-tdd : Tipo di determinazione che deve es- *
      *    *                       sere eseguita, che varia per ogni   *
      *    *                       fase gestionale chiamante           *
      *    *                                                           *
      *    * - w-mod-not-svf-ncd : Numero di caratteri disponibili per *
      ...
      *              * al chiamante                                    *
      *              *-------------------------------------------------*
           move      w-aux-not-svf-not    to   w-mod-not-svf-not      .
       dvn-999.
           exit.
      ...
      *                  *---------------------------------------------*
           divide    w-mod-not-svf-q01    into w-mod-not-svf-f01
                                        giving w-aux-not-svf-wk1      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "<BG"                to   p-edm                  .
           move      w-aux-not-svf-wk1    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Valore unitario editato in campo note       *
      *                  *---------------------------------------------*
           move      p-edt                to   w-aux-not-svf-not      .
       dvn-svf-250-190.
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
      ...
      *    * Input  :                                                  *
      *    *                                                           *
      *    * Output : - w-aux-not-svf-not = Valore del campo 'Note'    *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       dvn-svf-gen-000.
       dvn-svf-gen-999.
      ...
      *              *-------------------------------------------------*
           if        w-mod-not-svf-cpe    =    01
                     go to cpe-100
           else if   w-mod-not-svf-cpe    =    02
                     go to cpe-300
           else if   w-mod-not-svf-cpe    =    03
                     go to cpe-500
           else      go to cpe-100.
       cpe-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-mod-not-svf-pro    to   rf-aaq-num-pro         .
           move      "pgm/dcf/fls/ioc/obj/iofaaq"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        rf-aaq-cdp-pdt       not  = spaces
                     move  rf-aaq-cdp-pdt to   w-mod-not-svf-alf      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     cpe-900.
      ...
      *                  *---------------------------------------------*
           move      rf-aaq-dcf-pfz       to   w-aux-not-svf-wk1      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione [aaf]                       *
      *                  *---------------------------------------------*
           move      "NO"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-mod-not-svf-pro    to   rf-aaf-num-pro         .
           move      w-aux-not-svf-wk1    to   rf-aaf-cod-dcf         .
      ...
      *                  *---------------------------------------------*
           if        rf-aaf-cop-sfn       not  = spaces
                     move  rf-aaf-cop-sfn to   w-mod-not-svf-alf      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     cpe-900.
