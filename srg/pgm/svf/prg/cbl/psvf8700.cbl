      ...
      *                       Ultima revisione:    NdK del 30/09/99    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf8701:        *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per listino prodotti - cliente              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FATTURATO PER LISTINO PRODOTTI - CLIENTE"       .
      ...
      *        *-------------------------------------------------------*
      *        * Codice listino selezionato, descrizione               *
      *        *  - Se codice '*  ' : 'Tutti i codici      '           *
      *        *-------------------------------------------------------*
           05  rr-cod-lst-des             pic  x(25)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "Solo totale per codice listino                    ".
                   15  filler             pic  x(50) value
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "'*' per selezionare tutti i listini"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *                  * codice listino si normalizza e si visualiz- *
      *                  * za :                                        *
      *                  *  - Tipo di ordinamento per clienti          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      * vero solo totale per codice listino,    *
