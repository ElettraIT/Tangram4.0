      ...
      *                       Ultima revisione:    NdK del 26/09/12    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf6001:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FATTURATO PER CLASSE STATISTICA PRODOTTO"       .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "Solo il totale per ogni classe                    ".
                   15  filler             pic  x(50) value
      ...
      *    *-----------------------------------------------------------*
       pmt-tcs-pro-000.
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipo di classe statistica  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tcs-pro-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   w-cmn-zps-001-lin      .
           move      30                   to   w-cmn-zps-001-pos      .
           move      07                   to   w-cmn-zps-001-dln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   w-cmn-zps-002-lin      .
           move      30                   to   w-cmn-zps-002-pos      .
           move      07                   to   w-cmn-zps-002-dln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   w-cmn-zps-003-lin      .
           move      30                   to   w-cmn-zps-003-pos      .
           move      07                   to   w-cmn-zps-003-dln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   w-cod-mne-zp1-lin      .
           move      30                   to   w-cod-mne-zp1-pos      .
           move      07                   to   w-cod-mne-zp1-dln      .
      ...
      *                  *---------------------------------------------*
           if        rr-gen-grf           not  = "S"
                     go to acc-tor-csp-025.
      *                  *---------------------------------------------*
      *                  * Ordinamento ABC decrescente                 *
      *                  *---------------------------------------------*
           move      01                   to   rr-tor-csp             .
           perform   vis-tor-csp-000      thru vis-tor-csp-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
