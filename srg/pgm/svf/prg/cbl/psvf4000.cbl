      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf4001:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tcg-cli.
               10  w-exp-tcg-cli-num      pic  9(02)       value 4    .
           ...
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-t03.
                  ...
                  "Con anche il totale per ogni cliente              ".
                   15  filler             pic  x(50) value
                  "Con la lista documenti emessi per ogni cliente    ".
               10  w-exp-tip-dts-t04.
                   15  filler             pic  x(50) value
                  "Solo totale per codice comune                     ".
                   15  filler             pic  x(50) value
                  "Con anche il totale per ogni cliente              ".
                   15  filler             pic  x(50) value
                  "Con la lista documenti emessi per ogni cliente    ".
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tor-cgc.
               ...
               10  w-exp-tor-cgc-t04.
                   15  filler             pic  x(50) value
                  "Ordinamento ABC decrescente                       ".
                   15  filler             pic  x(50) value
                  "Ordinamento ABC crescente                         ".
                   15  filler             pic  x(50) value
                  "Ordinamento per descrizione comune                ".
                   15  filler             pic  x(50) value
                  "Ordinamento per codice comune                     ".
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Se ordinamento per Regione, Provincia o Comune, si
      -              " escludono i Clienti Esteri   "
                                          to   v-nt1                  .
      ...
      *              *-------------------------------------------------*
       ...
       acc-ccg-cli-400.
      *              *-------------------------------------------------*
      *              * Se classe geografica 04 : Comune                *
      *              *-------------------------------------------------*
           perform   acc-ccg-cli-cmn-000  thru acc-ccg-cli-cmn-999    .
           go to     acc-ccg-cli-999.
       acc-ccg-cli-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-ccg-num           to   w-cod-com-geo-cmn      .
           move      07                   to   w-cod-com-geo-lin      .
           move      30                   to   w-cod-com-geo-pos      .
           move      07                   to   w-cod-com-geo-dln      .
       ...
       acc-ccg-cli-cmn-110.
           ...
           if        w-cod-com-geo-ope    =    "F+"
                     go to acc-ccg-cli-cmn-115.
           if        w-cod-com-geo-ope    =    "AC"
                     go to acc-ccg-cli-cmn-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-ccg-cli-cmn-115.
           perform   cod-com-geo-foi-000  thru cod-com-geo-foi-999    .
           go to     acc-ccg-cli-cmn-110.
       acc-ccg-cli-cmn-120.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-ccg-cli-cmn-999.
       acc-ccg-cli-cmn-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cod-com-geo-cmn    to   rr-ccg-num             .
       acc-ccg-cli-cmn-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-ccg-num           to   w-let-arc-gxc-cmn      .
      ...
      *    *-----------------------------------------------------------*
       vis-ccg-cli-000.
      *              *-------------------------------------------------*
      *              * Trattamento codice numerico                     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se presente codice alfanumerico        *
      *                  *---------------------------------------------*
           if        rr-ccg-cli           not = spaces
                     go to vis-ccg-cli-100.
      *                  *---------------------------------------------*
      *                  * Test se a zero                              *
      *                  *---------------------------------------------*
           if        rr-ccg-num           =    zero
      ...
      *                  *---------------------------------------------*
           ...
           move      "<B"                 to   v-edm                  .
           move      rr-ccg-num           to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   rr-ccg-cli             .
       vis-ccg-cli-100.
      *              *-------------------------------------------------*
      *              * Visualizzazione                                 *
      *              *-------------------------------------------------*
      ...
      *                  * classe geografica si normalizza e si vi-    *
      *                  * sualizza :                                  *
      *                  *  - Tipo di ordinamento per clienti          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-gen-grf           not  = "S"
                     go to acc-tor-cgc-025.
      *                  *---------------------------------------------*
      *                  * Ordinamento ABC decrescente                 *
      *                  *---------------------------------------------*
           move      01                   to   rr-tor-cgc             .
           perform   vis-tor-cgc-000      thru vis-tor-cgc-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *                      * vero solo totale per classe geografica, *
