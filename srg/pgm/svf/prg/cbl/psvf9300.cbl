      ...
      *        *-------------------------------------------------------*
           05  w-exp-svf-snx.
               10  w-exp-svf-snx-num      pic  9(02)       value 2    .
               10  w-exp-svf-snx-lun      pic  9(02)       value 02   .
               10  w-exp-svf-snx-tbl.
      ...
      *                  *---------------------------------------------*
           if        w-tes-svf-snx        not  = 01 and
                     w-tes-svf-snx        not  = 02
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-svf-snx-lun    to   v-car                  .
           move      w-exp-svf-snx-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      19                   to   v-lin                  .
           move      22                   to   v-pos                  .
           move      w-exp-svf-snx-tbl    to   v-txt                  .
      *
           if        w-rig-svf-snx        =    spaces
                     move  1              to   v-num
           else if   w-rig-svf-snx        =    "#"
                     move  2              to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    1
                     move  spaces         to   w-rig-svf-snx
           else if   v-num                =    2
                     move  "#"            to   w-rig-svf-snx
           else      move  spaces         to   w-rig-svf-snx          .
       acc-svf-snx-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-tes-svf-snx        not  = 02
                     go to stp-srt-inp-440.
           if        rf-fit-flg-nbx (1)   =    spaces
                     go to stp-srt-inp-200.
       stp-srt-inp-440.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-fit-flg-nbx (1)   to   w-rig-svf-snx          .
      *                      *-----------------------------------------*
      *                      * Anagrafica cliente                      *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-svf-snx        =    rf-fit-flg-nbx (1)
      ...
      *                  *---------------------------------------------*
           move      w-rig-svf-snx        to   rf-fit-flg-nbx (1)     .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [fit]                         *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/svf/prg/obj/psvf9302"                       .
       cnc-rlt-sup-999.
           exit.
