      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf5021:        *
      *                                                                *
      ...
      *                  * Data campagna di vendita                    *
      *                  *---------------------------------------------*
           perform   acc-dat-cdv-000      thru acc-dat-cdv-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
                     go to acc-ric-sel-150.
      ...
      *              * Data campagna di vendita                        *
      *              *-------------------------------------------------*
           perform   pmt-dat-cdv-000      thru pmt-dat-cdv-999        .
      *              *-------------------------------------------------*
      *              * Numero periodi di riferimento                   *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt : Data campagna di vendita                         *
      *    *-----------------------------------------------------------*
       pmt-dat-cdv-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt : Data valorizzazione                              *
      *    *-----------------------------------------------------------*
       pmt-dat-val-000.
      *              *-------------------------------------------------*
      *              * Test se prompt da visualizzare                  *
      *              *-------------------------------------------------*
           if        rr-num-pdr           not  = 21 and
                     rr-num-pdr           not  = 22
                     go to pmt-dat-val-200.
       pmt-dat-val-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      58                   to   v-pos                  .
           move      "Valorizz. al :"     to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           go to     pmt-dat-val-999.
       pmt-dat-val-200.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data campagna di vendita             *
      *    *-----------------------------------------------------------*
       acc-dat-cdv-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-dat-cdv-999.
       acc-dat-cdv-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-dat-cdv             .
       acc-dat-cdv-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-dat-cdv-100.
       acc-dat-cdv-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Data campagna di vendita          *
      *    *-----------------------------------------------------------*
       vis-dat-cdv-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Prompt per data valorizzazione              *
      *                  *---------------------------------------------*
           perform   pmt-dat-val-000      thru pmt-dat-val-999        .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Se data valorizzazione a zero, si utilizza la data
      -              " del documento come data di"
                                          to   v-nt1                  .
           move      "riferimento per la determinazione del costo unitar
      -              "io"                 to   v-nt2                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
