      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf8701:       *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per cliente - listino prodotti              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Subchiave 1 : Per codice listino                  *
      *            *                                                   *
      ...
      *                * - Per descrizione                             *
      *                *-----------------------------------------------*
                   15  srt-k01-des-lst    pic  x(25)                  .
      *                *-----------------------------------------------*
      *                * Mnemonico per codice listino                  *
      *                *                                               *
      *                * N.B.: non gestito                             *
      *                *-----------------------------------------------*
                   15  srt-k01-mne-lst    pic  x(05)                  .
      *                *-----------------------------------------------*
      ...
      *                *   - 9 : Codice a spaces                       *
      *                *                                               *
      *                * Solo per tipo ordinamento codice listino :    *
      *                *                                               *
      *                * - Per codice                                  *
      *                *-----------------------------------------------*
                   15  srt-k01-flg-zod    pic  9(01)                  .
      *                *-----------------------------------------------*
      *                * Codice codice listino                         *
      *                *-----------------------------------------------*
                   15  srt-k01-cod-lst    pic  x(03)                  .
      *            *---------------------------------------------------*
      ...
      *                * Codice listino                                *
      *                *-----------------------------------------------*
                   15  srt-cod-lst-cod    pic  x(03)                  .
      *                *-----------------------------------------------*
      *                * Codice listino, mnemonico                     *
      *                *-----------------------------------------------*
                   15  srt-cod-lst-mne    pic  x(05)                  .
      *                *-----------------------------------------------*
      *                * Codice listino, descrizione                   *
      *                *-----------------------------------------------*
                   15  srt-cod-lst-des    pic  x(25)                  .
      *                *-----------------------------------------------*
      *                * Codice listino, flag di esistenza             *
      *                *-----------------------------------------------*
                   15  srt-cod-lst-flg    pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice cliente                                    *
      *            *---------------------------------------------------*
               10  srt-cod-cli.
      ...
      *            *---------------------------------------------------*
               10  srt-val-abc.
      *                *-----------------------------------------------*
      *                * Valore ABC per codice listino                 *
      *                *-----------------------------------------------*
                   15  srt-val-abc-lst    pic s9(13)                  .
      *                *-----------------------------------------------*
      ...
      *            * Codice codice listino                             *
      *            *---------------------------------------------------*
               10  w-liv-lst-cod-lst      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Descrizione codice listino                        *
      *            *---------------------------------------------------*
               10  w-liv-lst-des-lst      pic  x(25)                  .
      *            *---------------------------------------------------*
      *            * Mnemonico codice listino                          *
      *            *---------------------------------------------------*
               10  w-liv-lst-mne-lst      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Flag di esistenza per codice listino              *
      *            *---------------------------------------------------*
               10  w-liv-lst-flg-lst      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Totale fatturato 1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-lst-tot-p1r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Totale fatturato 2. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-lst-tot-p2r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Totale fatturato 3. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-lst-tot-p3r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Numero clienti trattati per codice listino        *
      *            *---------------------------------------------------*
               10  w-liv-lst-num-cli      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *        * Codice listino                                        *
      *        *-------------------------------------------------------*
           05  w-sel-fit-cod-lst          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione codice listino                            *
      *        *-------------------------------------------------------*
           05  w-sel-fit-des-lst          pic  x(25)                  .
      *        *-------------------------------------------------------*
      *        * Flag di codice listino esistente                      *
      *        *-------------------------------------------------------*
           05  w-sel-fit-flg-lst          pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per stampa del codice listino e della sua    *
      *        * descrizione                                           *
      *        *-------------------------------------------------------*
           05  w-stp-ced-lst.
      *            *---------------------------------------------------*
      *            * Codice alfanumerico                               *
      *            *---------------------------------------------------*
               10  w-stp-ced-lst-cod      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Descrizione                                       *
      *            *---------------------------------------------------*
               10  w-stp-ced-lst-des      pic  x(25)                  .
      *        *-------------------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       sel-fit-rec-200.
      *              *-------------------------------------------------*
      *              * Selezione su codice listino per fatturazione    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rr-cod-lst           =    "*  "
                     go to sel-fit-rec-220.
           if        rr-cod-lst           not  = rf-fit-cod-lst
                     go to sel-fit-rec-900.
       sel-fit-rec-220.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione codice                      *
      *                  *---------------------------------------------*
           move      rf-fit-cod-lst       to   w-sel-fit-cod-lst      .
      *                  *---------------------------------------------*
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           move      rf-fit-cod-lst       to   w-let-arc-zls-cod      .
      ...
      *                      * Descrizione                             *
      *                      *-----------------------------------------*
           move      w-let-arc-zls-des    to   w-sel-fit-des-lst      .
      *                      *-----------------------------------------*
      *                      * Flag di codice esistente                *
      *                      *-----------------------------------------*
           move      w-let-arc-zls-flg    to   w-sel-fit-flg-lst      .
       sel-fit-rec-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-cod-age           not  = rf-fit-cod-age
                     go to sel-fit-rec-900.
       sel-fit-rec-400.
      *              *-------------------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fit-des-lst    to   srt-k01-des-lst        .
       cmp-srt-rec-225.
      *                      *-----------------------------------------*
      *                      * Mnemonico per codice listino            *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      spaces               to   srt-k01-mne-lst        .
       cmp-srt-rec-230.
      *                      *-----------------------------------------*
      ...
      *                      * Codice listino                          *
      *                      *-----------------------------------------*
           move      w-sel-fit-cod-lst    to   srt-k01-cod-lst        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per cliente                   *
      *                  *---------------------------------------------*
      ...
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      w-sel-fit-cod-lst    to   srt-cod-lst-cod        .
      *                      *-----------------------------------------*
      *                      * Mnemonico                               *
      *                      *-----------------------------------------*
           move      spaces               to   srt-cod-lst-mne        .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      *                      *-----------------------------------------*
           move      w-sel-fit-des-lst    to   srt-cod-lst-des        .
      *                      *-----------------------------------------*
      *                      * Flag di esistenza                       *
      *                      *-----------------------------------------*
           move      w-sel-fit-flg-lst    to   srt-cod-lst-flg        .
       cmp-srt-rec-850.
      *                  *---------------------------------------------*
      *                  * Cliente                                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Valore ABC per listino                  *
      *                      *-----------------------------------------*
           move      zero                 to   srt-val-abc-lst        .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-cod-lst-cod      to   kk0-cod-lst            .
      ...
      *                  * Codice listino                              *
      *                  *---------------------------------------------*
           move      srt-cod-lst-cod      to   w-rot-l02-cod-lst      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
      *                  * Numero di listini trattati                  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-gen-num-lst      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Inizializzazione work area per livello di rot-  *
      *              * tura per codice listino                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice listino                              *
      *                  *---------------------------------------------*
           move      srt-cod-lst-cod      to   w-liv-lst-cod-lst      .
      *                  *---------------------------------------------*
      *                  * Descrizione listino                         *
      *                  *---------------------------------------------*
           move      srt-cod-lst-des      to   w-liv-lst-des-lst      .
      *                  *---------------------------------------------*
      *                  * Flag di esistenza per listino               *
      *                  *---------------------------------------------*
           move      srt-cod-lst-flg      to   w-liv-lst-flg-lst      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-lst-tot-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-lst-tot-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-lst-tot-p3r      .
      *                  *---------------------------------------------*
      *                  * Numero di clienti trattati per la tipo      *
      *                  * movimento                                   *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-lst-num-cli      .
      *                  *---------------------------------------------*
      *                  * Numero di tipi movimento trattati           *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-gen-num-lst      .
       prn-ini-lr2-200.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo dettaglio stampa  *
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-liv-lst-cod-lst    to   w-stp-sub-cod-alf      .
      *                          *-------------------------------------*
      *                          * Descrizione per il codice           *
      *                          *-------------------------------------*
           move      w-liv-lst-des-lst    to   w-stp-sub-cod-des      .
       prn-ini-lr2-550.
      *                      *-----------------------------------------*
      ...
      *              * Determinazione % di variazione                  *
      *              *-------------------------------------------------*
           move      w-liv-lst-tot-p1r    to   w-stp-clc-pdv-v01      .
           move      w-liv-lst-tot-p2r    to   w-stp-clc-pdv-v02      .
           move      w-liv-lst-tot-p3r    to   w-stp-clc-pdv-v03      .
           perform   stp-clc-pdv-000      thru stp-clc-pdv-999        .
       prn-fin-lr2-125.
      *              *-------------------------------------------------*
      *              * Determinazione valore del campo 'Note' per il   *
      ...
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-lst-tot-p1r    to   w-mod-not-svf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      zero                 to   w-mod-not-svf-q02      .
      ...
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-lst-tot-p2r    to   w-mod-not-svf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-svf-p01      .
      ...
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-lst-tot-p3r    to   w-mod-not-svf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-svf-p02      .
      ...
      *                          * Codice listino                      *
      *                          *-------------------------------------*
           move      w-liv-lst-cod-lst    to   w-stp-ced-lst-cod      .
      *                          *-------------------------------------*
      *                          * Descrizione                         *
      *                          *-------------------------------------*
           move      w-liv-lst-des-lst    to   w-stp-ced-lst-des      .
       prn-fin-lr2-332.
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   stp-ced-lst-000      thru stp-ced-lst-999        .
       prn-fin-lr2-340.
      *                  *---------------------------------------------*
      ...
      *                      * Preparazione                            *
      *                      *-----------------------------------------*
           move      w-liv-lst-tot-p1r    to   w-stp-sta-fep-f01      .
           move      w-liv-lst-tot-p2r    to   w-stp-sta-fep-f02      .
           move      w-liv-lst-tot-p3r    to   w-stp-sta-fep-f03      .
      ...
      *                      *-----------------------------------------*
           move      w-liv-lst-tot-p1r    to   w-stp-sta-tot-f01      .
           move      w-liv-lst-tot-p2r    to   w-stp-sta-tot-f02      .
           move      w-liv-lst-tot-p3r    to   w-stp-sta-tot-f03      .
           move      w-stp-clc-pdv-p01    to   w-stp-sta-tot-p01      .
           move      w-mod-not-svf-not    to   w-stp-sta-tot-not      .
           move      w-stp-clc-pdv-p02    to   w-stp-sta-tot-p02      .
       prn-fin-lr2-450.
      ...
      *                  *---------------------------------------------*
      *                  * Numero di clienti trattati per listino      *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-lst-num-cli      .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn1      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-val
                                          to   w-liv-lst-tot-p1r
                     else  subtract srt-val-sta-val
                                          from w-liv-lst-tot-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn2      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-val
                                          to   w-liv-lst-tot-p2r
                     else  subtract srt-val-sta-val
                                          from w-liv-lst-tot-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn3      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-val
                                          to   w-liv-lst-tot-p3r
                     else  subtract srt-val-sta-val
                                          from w-liv-lst-tot-p3r      .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se selezionato un agente           *
      *                      *-----------------------------------------*
           if        rr-cod-age           =    zero
                     go to stp-int-pag-040.
           if        rr-cod-age-nom       =    spaces
                     go to stp-int-pag-040.
      *                      *-----------------------------------------*
      *                      * Assemblaggio con nominativo agente      *
      *                      *-----------------------------------------*
           move      spaces               to   w-stp-int-ti2-stp      .
           string    "PER LISTINO - CLIENTE - SELEZIONE SU AGENTE : "
                                delimited by   size
                     rr-cod-age-nom
                                delimited by   size
                                          into w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-040.
           move      "PER LISTINO PRODOTTI DI VENDITA - CLIENTE         
      -              "                              "
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Comunque a preparazione stringa         *
      *                      *-----------------------------------------*
      ...
      *                          * Literal fisso                       *
      *                          *-------------------------------------*
           move      "Clienti non classificati per listino              
      -              "                      "
      ...
      *              *   - 01 : Solo totale per codice listino         *
      *              *   - 02 : Con anche il totale per ogni cliente   *
      *              *-------------------------------------------------*
       stp-fds-tot-405.
      *                  *---------------------------------------------*
      ...
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-ced-lst-cod : Codice                            *
      *    *                                                           *
      *    *   - w-stp-ced-lst-des : Descrizione                       *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       stp-ced-lst-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-stp-ced-lst-cod    =    spaces
                     go to stp-ced-lst-300
           else      go to stp-ced-lst-600.
       stp-ced-lst-300.
      *              *-------------------------------------------------*
      *              * Se codice a spaces                              *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      009                  to   p-pos                  .
           move      w-stp-ced-lst-cod    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-ced-lst-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      023                  to   p-pos                  .
           move      w-stp-ced-lst-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-ced-lst-800.
      *                  *---------------------------------------------*
