      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf3701:        *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per forma di pagamento cliente.             *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FATTURATO PER FORMA DI PAGAMENTO CLIENTE"       .
      ...
      *        *-------------------------------------------------------*
      *        * Codice forma di pagamento cliente selezionata         *
      *        *  - Se codice 0000000 : Tutti i codici                 *
      *        *-------------------------------------------------------*
           05  rr-cod-fop                 pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice forma pagamento cliente selezionata, descri-   *
      *        * zione                                                 *
      *        *  - Se codice 0000000 : Tutti i codici                 *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Tipo di ordinamento per la forma pagamento cliente    *
      *        *                                                       *
      ...
      *        *                                                       *
      *        * Non significativo se codice forma pagamento cliente   *
           ...
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "con anche il totale per ogni Cliente   "           .
                   15  filler             pic  x(39) value
                  "con la Lista documenti per ogni cliente"           .
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento forma pagamento clienti   *
      *        *-------------------------------------------------------*
           05  w-exp-tor-csc.
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tor-cli.
               ...
               10  w-exp-tor-cli-lun      pic  9(02)       value 39   .
      ...
      *                  *---------------------------------------------*
       ...
       acc-tor-csc-025.
      *                  *---------------------------------------------*
      *                  * Se impostato un codice pagamento clienti    *
