      ...
      *                       Ultima revisione:    NdK del 06/10/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psvf8601:       *
      *                                                                *
      ...
      *                *-----------------------------------------------*
      *                * Flag di codice diverso da spazi ma non tro-   *
      *                * vato in archivio                              *
      *                *                                               *
      *                *   - 1 : Esistente                             *
      *                *   - 5 : Non esistente                         *
      ...
      *                *-----------------------------------------------*
      *                * Flag di codice a spazi o diverso da spazi     *
      *                *                                               *
      ...
      *            *---------------------------------------------------*
               10  srt-val-abc.
      *                *-----------------------------------------------*
      *                * Valore ABC per il tipo movimento              *
      *                *-----------------------------------------------*
                   15  srt-val-abc-tmo    pic s9(13)v9(03)            .
      *                *-----------------------------------------------*
      *                * Valore ABC per la classe statistica prodotto  *
      *                * nell'ambito del tipo movimento                *
      *                *-----------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-liv-tmo-flg-umi      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore dell' unita' di misura memorizzata         *
      *            *---------------------------------------------------*
               10  w-liv-tmo-val-umi      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Flag di numero decimali memorizzati               *
      *            *---------------------------------------------------*
               10  w-liv-tmo-flg-dec      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore del numero decimali memorizzati            *
      *            *---------------------------------------------------*
               10  w-liv-tmo-val-dec      pic  9(01)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' 1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-tmo-qta-p1r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-liv-tmo-qta-p2r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-liv-tmo-qta-p3r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale fatturato 3. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-tmo-tot-p3r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Numero classi trattate per tipo movimento         *
      *            *---------------------------------------------------*
               10  w-liv-tmo-num-csp      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Codice classe statistica prodotto                     *
      *        *-------------------------------------------------------*
           05  w-liv-csp.
      ...
      *            *---------------------------------------------------*
      *            * Numero di tipi movimento trattati in totale       *
      *            *---------------------------------------------------*
      ...
      *                          *-------------------------------------*
       ...
       cmp-srt-rec-215.
      *                      *-----------------------------------------*
      *                      * Flag di codice diverso da spazi ma non  *
      *                      * trovato in archivio tipi movimento      *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Solo se tipo ordinamento :          *
      *                          *                                     *
      *                          *  - ABC decrescente sul fatturato    *
      *                          *  - ABC decrescente sulla quantita'  *
      *                          *  - ABC crescente sul fatturato      *
      ...
      *                          *-------------------------------------*
           if        rr-tor-tmo           not  = 01 and
                     rr-tor-tmo           not  = 02 and
                     rr-tor-tmo           not  = 03 and
                     rr-tor-tmo           not  = 04 and
                     rr-tor-tmo           not  = 05 and
                     rr-tor-tmo           not  = 06
      ...
      *                          *-------------------------------------*
            if       w-sel-fit-cod-tmo    =    spaces
                     ...
                     go to cmp-srt-rec-220.
      *                          *-------------------------------------*
      *                          * Se codice diverso da spazi : si po- *
      *                          * ne a seconda del valore della       *
      *                          * descrizione                         *
      *                          *-------------------------------------*
           if        w-sel-fit-des-tmo    not  = spaces
      ...
      *                          *-------------------------------------*
           if        rr-tor-tmo           not  = 01 and
                     ...
                     rr-tor-tmo           not  = 04 and
                     rr-tor-tmo           not  = 05
                     move  spaces         to   srt-k01-des-tmo
      ...
      *                      * prodotto nell'ambito del tipo movimento *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           move      srt-k01-val-abc      to   srt-val-abc-tmo        .
       agg-abc-sqz-150.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Numero tipi movimento trattati in totale    *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-cic-050.
      *              *-------------------------------------------------*
      *              * Se non sono state trattati almeno due tipi :    *
      ...
      *                  * Flag di unita' di misura memorizzata        *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-tmo-flg-umi      .
      *                  *---------------------------------------------*
      *                  * Valore dell' unita' di misura memorizzata   *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-tmo-val-umi      .
      *                  *---------------------------------------------*
      *                  * Flag di numero decimali memorizzati         *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-tmo-flg-dec      .
      *                  *---------------------------------------------*
      *                  * Valore del numero decimali memorizzati      *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-tmo-val-dec      .
      *                  *---------------------------------------------*
      *                  * Totale quantita' 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-tmo-qta-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 1. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * Totale quantita' 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-tmo-qta-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 2. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * Totale quantita' 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-tmo-qta-p3r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-tmo-tot-p3r      .
      *                  *---------------------------------------------*
      *                  * Numero classi trattate per il tipo movim.   *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-tmo-num-csp      .
      *                  *---------------------------------------------*
      *                  * Numero di classi trattate in totale         *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tpc-pdv           =    02
                     move  w-liv-tmo-qta-p1r
                                          to   w-stp-clc-pdv-v01
                     move  w-liv-tmo-qta-p2r
                                          to   w-stp-clc-pdv-v02
                     move  w-liv-tmo-qta-p3r
                                          to   w-stp-clc-pdv-v03
           else      move  w-liv-tmo-tot-p1r
                                          to   w-stp-clc-pdv-v01
                     move  w-liv-tmo-tot-p2r
                                          to   w-stp-clc-pdv-v02
                     move  w-liv-tmo-tot-p3r
                                          to   w-stp-clc-pdv-v03      .
           perform   stp-clc-pdv-000      thru stp-clc-pdv-999        .
       prn-fin-lr2-125.
      *              *-------------------------------------------------*
      *              * Determinazione valore del campo 'Note' per il   *
      *              * totale tipo movimento                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione                                *
      *                  *---------------------------------------------*
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-tmo-qta-p1r    to   w-mod-not-svf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
      ...
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-tmo-qta-p2r    to   w-mod-not-svf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-tmo-qta-p3r    to   w-mod-not-svf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-liv-tmo-cod-tmo    to   w-all-str-cat (3)      .
      ...
      *                      *-----------------------------------------*
           if        w-prs-svf-tqn-snx    =    "N"
                     if    w-liv-tmo-flg-umi
                                          =    "N"
                           move  "N"      to   w-stp-sta-tot-snq
                     else  move  "S"      to   w-stp-sta-tot-snq
           else      move  "S"            to   w-stp-sta-tot-snq      .
           move      w-liv-tmo-val-dec    to   w-stp-sta-tot-dec      .
           move      w-liv-tmo-val-umi    to   w-stp-sta-tot-umi      .
           move      w-liv-tmo-qta-p1r    to   w-stp-sta-tot-q01      .
           move      w-liv-tmo-tot-p1r    to   w-stp-sta-tot-f01      .
           move      w-liv-tmo-qta-p2r    to   w-stp-sta-tot-q02      .
           move      w-liv-tmo-tot-p2r    to   w-stp-sta-tot-f02      .
           move      w-liv-tmo-qta-p3r    to   w-stp-sta-tot-q03      .
      ...
      *                  *---------------------------------------------*
           if        w-liv-gen-flg-umi    =    spaces
                     ...
                     move  spaces         to   w-liv-gen-val-umi      .
      *                  *---------------------------------------------*
      *                  * Per livello tipo movimento                  *
      *                  *---------------------------------------------*
           if        w-liv-tmo-flg-umi    =    spaces
                     move  "S"            to   w-liv-tmo-flg-umi
                     move  srt-cod-pro-umi
                                          to   w-liv-tmo-val-umi
           else if   w-liv-tmo-val-umi    not  = srt-cod-pro-umi
                     move  "N"            to   w-liv-tmo-flg-umi
                     move  spaces         to   w-liv-tmo-val-umi      .
      *                  *---------------------------------------------*
      ...
      *                  * Per livello tipo movimento                  *
      *                  *---------------------------------------------*
           if        w-liv-tmo-flg-dec    =    spaces
                     move  "#"            to   w-liv-tmo-flg-dec
                     move  srt-cod-pro-dec
                                          to   w-liv-tmo-val-dec
           else if   w-liv-tmo-val-dec    not  = srt-cod-pro-dec
                     move  9              to   w-liv-tmo-val-dec      .
      *                  *---------------------------------------------*
      *                  * Per livello classe statistica prodotto      *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn1      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-tmo-qta-p1r
                           add      srt-val-sta-val
                                          to   w-liv-tmo-tot-p1r
                     else  subtract srt-val-sta-qta
                                          from w-liv-tmo-qta-p1r
                           subtract srt-val-sta-val
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn2      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-tmo-qta-p2r
                           add      srt-val-sta-val
                                          to   w-liv-tmo-tot-p2r
                     else  subtract srt-val-sta-qta
                                          from w-liv-tmo-qta-p2r
                           subtract srt-val-sta-val
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn3      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-tmo-qta-p3r
                           add      srt-val-sta-val
                                          to   w-liv-tmo-tot-p3r
                     else  subtract srt-val-sta-qta
                                          from w-liv-tmo-qta-p3r
                           subtract srt-val-sta-val
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-031.
           move      "PER TIPO MOVIMENTO - 1. CODICE STATISTICO PRODOTTO
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-032.
           move      "PER TIPO MOVIMENTO - 2. CODICE STATISTICO PRODOTTO
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-033.
           move      "PER TIPO MOVIMENTO - 3. CODICE STATISTICO PRODOTTO
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-034.
           move      "PER TIPO MOVIMENTO - CLASSE MERCEOLOGICA PRODOTTO 
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
      ...
      *                      *-----------------------------------------*
           move      "Vendite non attribuite ad alcun tipo movimento    
      -              "                      "
