      ...
      *                       Ultima revisione:    NdK del 06/08/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psvf3801:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo categoria sconto cliente              *
      *        *-------------------------------------------------------*
           05  w-exp-tcs-cli.
               10  w-exp-tcs-cli-num      pic  9(02)       value 2    .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "solo Totale per categoria sconto                  ".
                   15  filler             pic  x(50) value
                  "con anche il totale per ogni Cliente              ".
                   15  filler             pic  x(50) value
                  "con la Lista documenti emessi per ogni cliente    ".
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento categoria sconto clienti  *
      *        *-------------------------------------------------------*
           05  w-exp-tor-csc.
               ...
               10  w-exp-tor-csc-tbl.
                  ...
                  "Ordinamento ABC crescente                         ".
                   15  filler             pic  x(50) value
                  "Ordinamento per descrizione categoria sconto      ".
                   15  filler             pic  x(50) value
                  "Ordinamento per codice categoria sconto           ".
                   15  filler             pic  x(50) value
                  "Ordinamento per mnemonico categoria sconto        ".
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Open modulo accettazione codice sconto a piede  *
      *              *-------------------------------------------------*
           perform   cmn-zcs-001-opn-000  thru cmn-zcs-001-opn-999    .
       rou-opn-fls-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *              * Close modulo accettazione codice sconto a piede *
      *              *-------------------------------------------------*
           perform   cmn-zcs-001-cls-000  thru cmn-zcs-001-cls-999    .
       rou-cls-fls-999.
           exit.
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-250.
      *                  *---------------------------------------------*
      *                  * Tipo di ordinamento per la categoria sconto *
      *                  * cliente                                     *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt : Tipo categoria sconto cliente                    *
      *    *-----------------------------------------------------------*
       pmt-tcs-cli-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento per la categoria sconto      *
      *    *-----------------------------------------------------------*
       pmt-tor-csc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo categoria sconto clienti              *
      *    *-----------------------------------------------------------*
       acc-tcs-cli-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
       acc-tcs-cli-655.
      *                      *-----------------------------------------*
      *                      * Prompt per codice categoria sconto      *
      *                      *-----------------------------------------*
           perform   pmt-ccs-cli-000      thru pmt-ccs-cli-999        .
       acc-tcs-cli-660.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       acc-tcs-cli-665.
      *                      *-----------------------------------------*
      *                      * Codice categoria sconto, descrizione    *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       acc-tcs-cli-675.
      *                      *-----------------------------------------*
      *                      * Prompt per tipo ordinamento categoria   *
      *                      * sconto                                  *
      *                      *-----------------------------------------*
           perform   pmt-tor-csc-000      thru pmt-tor-csc-999        .
       acc-tcs-cli-680.
      *                      *-----------------------------------------*
      *                      * Tipo ordinamento categoria sconto       *
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Codice categoria sconto clienti            *
      *    *-----------------------------------------------------------*
       acc-ccs-cli-000.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo categoria scon- *
      *              * to cliente                                      *
      *              *-------------------------------------------------*
           if        rr-tcs-cli           =    01
       ...
       acc-ccs-cli-100.
      *              *-------------------------------------------------*
      *              * Se categoria sconto 01 : in chiusura            *
      *              *-------------------------------------------------*
           perform   acc-ccs-cli-csc-000  thru acc-ccs-cli-csc-999    .
           go to     acc-ccs-cli-999.
       acc-ccs-cli-200.
      *              *-------------------------------------------------*
      *              * Se categoria sconto 02 : in riga                *
      *              *-------------------------------------------------*
           perform   acc-ccs-cli-csr-000  thru acc-ccs-cli-csr-999    .
           go to     acc-ccs-cli-999.
       acc-ccs-cli-999.
           exit.

      *    *===========================================================*
      *    * Accettazione : Codice sconto in chiusura                  *
      *    *-----------------------------------------------------------*
       acc-ccs-cli-csc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-ccs-cli           to   w-cmn-zcs-001-cod      .
           move      07                   to   w-cmn-zcs-001-lin      .
           move      30                   to   w-cmn-zcs-001-pos      .
           move      07                   to   w-cmn-zcs-001-dln      .
           move      41                   to   w-cmn-zcs-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           ...
           move      "DO  "               to   v-pfk (05)             .
           perform   cmn-zcs-001-cll-000  thru cmn-zcs-001-cll-999    .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
           perform   cmn-zcs-001-foi-000  thru cmn-zcs-001-foi-999    .
       acc-ccs-cli-csc-110.
           perform   cmn-zcs-001-cll-000  thru cmn-zcs-001-cll-999    .
           if        w-cmn-zcs-001-ope    =    "F+"
                     go to acc-ccs-cli-csc-115.
           if        w-cmn-zcs-001-ope    =    "AC"
                     go to acc-ccs-cli-csc-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-ccs-cli-csc-115.
           perform   cmn-zcs-001-foi-000  thru cmn-zcs-001-foi-999    .
           go to     acc-ccs-cli-csc-110.
       acc-ccs-cli-csc-120.
           move      w-cmn-zcs-001-cod    to   v-num                  .
       acc-ccs-cli-csc-150.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   w-cmn-zcs-002-lin      .
           move      30                   to   w-cmn-zcs-002-pos      .
           move      07                   to   w-cmn-zcs-002-dln      .
       ...
       acc-ccs-cli-csr-110.
           ...
           if        w-cmn-zcs-002-ope    =    "F+"
                     go to acc-ccs-cli-csr-115.
           if        w-cmn-zcs-002-ope    =    "AC"
                     go to acc-ccs-cli-csr-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-ccs-cli-csr-115.
           perform   cmn-zcs-002-foi-000  thru cmn-zcs-002-foi-999    .
           go to     acc-ccs-cli-csr-110.
       acc-ccs-cli-csr-120.
      ...
      *                  * categoria sconto si normalizza e si vi-     *
      *                  * sualizza :                                  *
      *                  *  - Tipo di ordinamento per clienti          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo ordinamento per codice categoria      *
      *    *                sconto                                     *
      *    *-----------------------------------------------------------*
       acc-tor-csc-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       acc-tor-csc-025.
      *                  *---------------------------------------------*
      *                  * Se impostato un codice categoria di sconto  *
      *                  * clienti diverso da zero : no accettazione   *
      *                  *---------------------------------------------*
           if        rr-ccs-cli           =    zero
      ...
      *    *===========================================================*
      *    * Visualizzazione : Tipo ordinamento per codice categoria   *
      *    *                   sconto                                  *
      *    *-----------------------------------------------------------*
       vis-tor-csc-000.
      *              *-------------------------------------------------*
      ...
      *                      * vero solo totale per categoria sconto,  *
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-050.
      *              *-------------------------------------------------*
      *              * Controllo : Tipo categoria sconto cliente      *
      *              *-------------------------------------------------*
       tdo-ric-sel-051.
           if        rr-tcs-cli           not  = zero
                     go to tdo-ric-sel-052.
           move      "Manca il tipo categoria sconto !                 
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-052.
           ...
           move      "Tipo categoria sconto errato !                   
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-150.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo : Tipo di ordinamento per categoria   *
      *              *             sconto cliente                      *
      *              *-------------------------------------------------*
       tdo-ric-sel-201.
           ...
           move      "Manca il tipo di ordinamento per la categoria scon
      -              "to !           "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-202.
           if        rr-tor-csc           =    01 or
                     ...
                     rr-tor-csc           =    05
                     go to tdo-ric-sel-250.
           move      "Tipo di ordinamento per la categoria sconto errato
      -              " !             "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-250.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione del codice sconto piede    *
      *    *-----------------------------------------------------------*
           copy      "pgm/dcc/prg/cpy/acmnzcs1.acs"                   .
