      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma bol270   *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zgc-cod-cli       to   rf-bit-cod-arc         .
      ...
      *              *-------------------------------------------------*
           if        rf-bit-cod-dpz       not  = rr-dpz-inu or
                     ...
                     rf-bit-cod-arc       not  = rf-zgc-cod-cli
                     go to stp-srt-inp-700.
       stp-srt-inp-130.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-bir-tip-rig       to   w-stp-srt-inp-wtr      .
      *                      *-----------------------------------------*
      ...
      *                  * record                                      *
      *                  *---------------------------------------------*
           move      rf-bir-prz-net       to   w-stp-srt-inp-prz      .
       stp-srt-inp-320.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-stp-srt-inp-wtp    =    "A"
                     move  rf-bir-imp-rig to   w-stp-srt-inp-ipr
      ...
      *                          * Test se necessario                  *
      *                          *-------------------------------------*
           if        rf-bir-sgl-vpp       =    rf-bir-sgl-vpf
                     go to stp-srt-inp-340.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      "CC"                 to   w-coe-cmb-vlt-ope      .
           move      rf-bir-sgl-vpf       to   w-coe-cmb-vlt-sdv      .
           move      rf-bir-tdc-vpf       to   w-coe-cmb-vlt-tdc      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   w-coe-cmb-vlt-drc      .
      ...
      *                          *-------------------------------------*
           if        w-coe-cmb-vlt-ope    not  = "CC"
                     move  rf-bir-cdc-vpf to   w-coe-cmb-vlt-cdc      .
      *                          *-------------------------------------*
      *                          * Conversione importo da valuta base  *
      *                          * a valuta per fatturazione           *
      *                          *-------------------------------------*
           move      rf-bir-sgl-vpf       to   w-cvs-vlt-sgl          .
           move      rf-bir-dec-vpf       to   w-cvs-vlt-dec          .
           move      rf-bir-tdc-vpf       to   w-cvs-vlt-tdc          .
           move      w-coe-cmb-vlt-cdc    to   w-cvs-vlt-cdc          .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-bir-cod-arc       to   srt-cod-cli            .
           move      rf-bir-dpz-arc       to   srt-dpz-cli            .
           move      rf-bir-dat-doc       to   srt-dat-doc            .
           move      rf-bir-num-doc       to   srt-num-doc            .
           move      rf-bir-num-prt       to   srt-num-prt            .
           move      rf-bir-num-prg       to   srt-num-prg            .
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      rf-bit-voc-des (1)   to   srt-voc-des            .
      ...
      *
           move      rf-bir-ocl-dat       to   srt-ocl-dat            .
           move      rf-bir-ocl-num       to   srt-ocl-num            .
           move      rf-bir-dat-doc       to   srt-dcn-prv            .
           move      rf-bir-alf-pro       to   srt-alf-pro            .
           if        w-stp-srt-inp-wtf    =    "N"
                     move  spaces         to   srt-alf-pro            .
           move      w-det-des-rig-des    to   srt-des-rig            .
           move      rf-bir-umi-ven       to   srt-umi-ven            .
           move      rf-bir-cod-tmb       to   srt-tip-mov            .
           move      rf-bir-sgl-vpp       to   srt-sgl-vpp            .
           move      rf-bir-dec-vpp       to   srt-dec-vpp            .
           move      rf-bir-dec-prz       to   srt-dec-prz            .
      ...
      *                      *-----------------------------------------*
           move      rf-bix-via-ids       to   srt-ind-spd            .
           move      rf-bix-loc-ids       to   srt-loc-spd            .
      *                      *-----------------------------------------*
      *                      * A stampa                                *
      *                      *-----------------------------------------*
           go to     stp-srt-inp-ids-350.
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-dcn-min           to   rf-bit-dat-doc         .
           move      rr-dpz-inu           to   rf-bit-cod-dpz         .
           move      zero                 to   rf-bit-num-doc         .
      ...
      *    * Input  :                                                  *
      *    *                                                           *
      *    *    - Record di [bir] relativo alla riga ordine cliente a  *
      ...
      *
           move      rf-bix-des-400       to   w-det-des-rig-des      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *              * zione contenuta nel record [bir]                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Descrizione                                 *
      *                  *---------------------------------------------*
           move      rf-bir-des-rig       to   w-det-des-rig-des      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     det-des-rig-999.
      ...
      *                      *-----------------------------------------*
           ...
           move      zero                 to   rf-pdx-cod-arc         .
           move      rf-bir-cod-lng       to   rf-pdx-cod-lng         .
           move      rf-bir-num-pro       to   rf-pdx-cod-num         .
           move      spaces               to   rf-pdx-for-mat         .
           move      01                   to   rf-pdx-num-prg         .
           move      "pgm/dcp/fls/ioc/obj/iofpdx"
