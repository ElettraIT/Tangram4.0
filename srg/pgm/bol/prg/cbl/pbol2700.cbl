      ...
      *                       Ultima revisione:    NdK del 04/05/16    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pbol2701:        *
      *                                                                *
      *                    Piano consegne per vettore                  *
      *                                                                *
      *                    ___ RICAVATO DA orc270 : migliorare         *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Viene letto il Vettore abituale '1' in anagrafica 
      -              "del cliente o quello alterna- "
                                          to   v-nt1                  .
           move      "tivo eventualmente indicato in ordine"
                                          to   v-nt2                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      05                   to   w-cod-mne-vet-lin      .
           move      30                   to   w-cod-mne-vet-pos      .
           move      05                   to   w-cod-mne-vet-rln      .
      ...
      *                  * Giro clienti                                *
      *                  *---------------------------------------------*
           move      1                    to   rr-cod-grc             .
      *                  *---------------------------------------------*
      *                  * Numero giorno                               *
      *                  *---------------------------------------------*
           move      1                    to   rr-num-grc             .
      *                  *---------------------------------------------*
      *                  * Data consegna  minima da ricercare          *
      *                  *---------------------------------------------*
