      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su distinte di spedizione    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " INTERROGAZIONE SU DISTINTE BOLLE 'PDF' "       .
      ...
      *            * Protocollo distinta                               *
      *            *---------------------------------------------------*
               10  w-buf-l01-num-dst      pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Data distinta                                     *
      *            *---------------------------------------------------*
               10  w-buf-l01-dat-reg      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Numero documenti                                  *
      *            *---------------------------------------------------*
               10  w-buf-l01-ctr-ele      pic  9(05)                  .
               10  w-buf-l01-ctr-ann      pic  9(05)                  .
               10  w-buf-l01-ctr-esi      pic  9(05)                  .
               10  w-buf-l01-edt-ann      pic  x(06)                  .
               10  w-buf-l01-edt-esi      pic  x(06)                  .
      *            *---------------------------------------------------*
      *            * Status distinta                                   *
      *            *---------------------------------------------------*
               10  w-buf-l01-sts-dst      pic  x(50)                  .
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-010.
      *              *-------------------------------------------------*
      *              * Determinazione data iniziale: 30 giorni prima   *
      *              * della data attuale                              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [dbe]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "NUMDST    "         to   f-key                  .
           move      "DATSYS    "         to   f-key                  .
           move      w-det-nrg-dat-dtd    to   rf-dbe-ide-dat         .
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessuna Distinta entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-dbe-num-dst       to   w-rot-l01-num-dst      .
       qry-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-dbe-num-dst       to   w-buf-l01-num-dst      .
           move      rf-dbe-dat-reg       to   w-buf-l01-dat-reg      .
           move      zero                 to   w-buf-l01-ctr-ele      .
           move      zero                 to   w-buf-l01-ctr-ann      .
           move      zero                 to   w-buf-l01-ctr-esi      .
       qry-ini-lr1-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      w-buf-l01-num-dst    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Data distinta                               *
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      12                   to   v-pos                  .
           move      w-buf-l01-dat-reg    to   v-dat                  .
           move      "+"                  to   v-edm                  .
           move      w-buf-l01-num-dst    to   w-mpn-num-prt          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      25                   to   v-pos                  .
           move      w-buf-l01-ctr-ele    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Editing eventuali documenti annullati       *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      05                   to   v-car                  .
           ...
           move      w-buf-l01-ctr-ann    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-buf-l01-edt-ann      .
      *                  *---------------------------------------------*
      *                  * Editing eventuali documenti esito negativo  *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      05                   to   v-car                  .
           ...
           move      spaces               to   v-sgn                  .
           move      spaces               to   v-edm                  .
           move      w-buf-l01-ctr-esi    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-buf-l01-edt-esi      .
      *                  *---------------------------------------------*
      *                  * Assemblaggio                                *
      *                  *---------------------------------------------*
           move      48                   to   w-all-str-lun          .
           move      07                   to   w-all-str-num          .
           move      w-buf-l01-sts-dst    to   w-all-str-cat (1)      .
      *
           if        w-buf-l01-ctr-ann    =    zero
                     move  spaces         to   w-all-str-cat (2)
                     move  spaces         to   w-all-str-cat (3)
                     move  spaces         to   w-all-str-cat (4)
           else if   w-buf-l01-ctr-ann    =    00001
                     move  "-"            to   w-all-str-cat (2)
                     move  w-buf-l01-edt-ann
                                          to   w-all-str-cat (3)
                     move  "BLOCCATO"     to   w-all-str-cat (4)
           else      move  "-"            to   w-all-str-cat (2)
                     move  w-buf-l01-edt-ann
                                          to   w-all-str-cat (3)
                     move  "BLOCCATI"     to   w-all-str-cat (4)      .
      *
           if        w-buf-l01-ctr-esi    =    zero
                     move  spaces         to   w-all-str-cat (5)
                     move  spaces         to   w-all-str-cat (6)
                     move  spaces         to   w-all-str-cat (7)
           else if   w-buf-l01-ctr-esi    =    00001
                     move  "-"            to   w-all-str-cat (5)
                     move  w-buf-l01-edt-esi
                                          to   w-all-str-cat (6)
                     move  "NEGATIVO"     to   w-all-str-cat (7)
           else      move  "-"            to   w-all-str-cat (5)
                     move  w-buf-l01-edt-esi
                                          to   w-all-str-cat (6)
                     move  "NEGATIVI"     to   w-all-str-cat (7)      .
      *
      ...
      *
           if        rf-dbe-flg-ain       not  = spaces
                     add  1               to   w-buf-l01-ctr-ann      .
      *
           if        rf-dbe-flg-esi       not  = spaces
                     add  1               to   w-buf-l01-ctr-esi      .
      *              *-------------------------------------------------*
      *              * Determinazione status distinta                  *
      *              *-------------------------------------------------*
           if        rf-dbe-dat-inv       not  = zero
                     move  "Documenti inviati"
                                          to   w-buf-l01-sts-dst
           else if   rf-dbe-flg-apr       not  = spaces
                     move  "Documenti preparati"
                                          to   w-buf-l01-sts-dst
           else      move  "Distinta generata"
                                          to   w-buf-l01-sts-dst      .
       qry-liv-det-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "   INTERROGAZIONE SU DISTINTE DI INVIO  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
