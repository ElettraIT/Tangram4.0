      ...
      *                  *---------------------------------------------*
           move      "MX"                 to   v-ope                  .
           move      "U"                  to   v-tip                  .
           move      "Conferma esecuzione stampa bolle (S/N/E) ?"
                                          to   v-not                  .
           move      "S"                  to   v-alf                  .
           move      "SNE"                to   v-msk                  .
           move      "DO  "               to   v-pfk (05)             .
      ...
      *              *-------------------------------------------------*
           ...
           move      18                   to   w-cod-des-zbi-lin      .
           move      30                   to   w-cod-des-zbi-pos      .
           move      18                   to   w-cod-des-zbi-dln      .
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-460.
      *              *-------------------------------------------------*
      *              * Selezione su tipo movimento da stampare         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se tipo movimento da stampare a spaces :    *
      *                  * nessuna selezione                           *
      *                  *---------------------------------------------*
