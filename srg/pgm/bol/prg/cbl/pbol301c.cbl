      ...
      *                                                                *
      *                    Ricerca documenti intestati ad una dipen-   *
      *                    denza                                       *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "    RICERCA DOCUMENTI PER DIPENDENZA    "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      12                   to   w-cod-des-zbi-lin      .
           move      30                   to   w-cod-des-zbi-pos      .
           move      12                   to   w-cod-des-zbi-dln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "D"                  to   rf-bit-tip-arc         .
           move      rr-cod-dpz           to   rf-bit-cod-arc         .
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      20                   to   v-pos                  .
           move      w-let-arc-zbi-des    to   v-alf                  .
           move      "+"                  to   v-edm                  .
