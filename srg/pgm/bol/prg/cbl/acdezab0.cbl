      ...
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione codice aspetto esterio- *
      *                    re dei beni per la bollettazione            *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-des-zab-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zab-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-zab-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-zab-cod : codice aspetto       *
      *                                                                *
      *                       w-cod-des-zab-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-zab-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-zab-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-zab-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zab-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-zab-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zab-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-zab-cod : codice aspetto       *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-zab.
           05  w-aux-cde-zab-nli          pic  9(02)                  .
           05  w-aux-cde-zab-crb          pic  9(02)                  .
           05  w-aux-cde-zab-cpb          pic  9(02)                  .
           05  w-aux-cde-zab-cpa          pic  9(02)                  .
           05  w-aux-cde-zab-bix          pic  9(02)                  .
           05  w-aux-cde-zab-buf
                               occurs 30.
               10  w-aux-cde-zab-bco      pic  x(03)                  .
               10  w-aux-cde-zab-bde      pic  x(20)                  .
           05  w-aux-cde-zab-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-zab-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-zab-lt2      pic  9(01)                  .
           05  w-aux-cde-zab-dup          pic  x(20)                  .
           05  w-aux-cde-zab-dmx.
               10  w-aux-cde-zab-dch
                               occurs 20  pic  x(01)                  .
           05  w-aux-cde-zab-c01          pic  9(02)                  .
           05  w-aux-cde-zab-c02          pic  9(02)                  .
           05  w-aux-cde-zab-c03          pic  9(02)                  .
           05  w-aux-cde-zab-c04          pic  9(02)                  .
           05  w-aux-cde-zab-c05          pic  9(02)                  .
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice aspetto esteriore beni  *
      *    *-----------------------------------------------------------*
           copy      "pgm/bol/prg/cpy/acdezab0.acl"                   .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-zab
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zab-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-zab-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-zab-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-zab-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-zab-ope    =    "A+" or
                     w-cod-des-zab-ope    =    "I+" or
                     w-cod-des-zab-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-zab-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice aspetto di default                   *
      *                  *---------------------------------------------*
           move      w-cod-des-zab-cod    to   w-cod-des-zab-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-zab-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-zab-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-zab-s90    to   v-ufk                  .
           move      w-cod-des-zab-lin    to   v-lin                  .
           move      w-cod-des-zab-pos    to   v-pos                  .
           move      w-cod-des-zab-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-zab-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zab-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-zab-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-zab-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-zab-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-zab-cod    to   w-cod-des-zab-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-zab-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-zab-dln    =    zero or
                     w-cod-des-zab-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-zab-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      20                   to   v-car                  .
           move      w-cod-des-zab-dln    to   v-lin                  .
           move      w-cod-des-zab-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-zab-dln    to   v-lin                  .
           move      w-cod-des-zab-dps    to   v-pos                  .
           move      w-aux-cde-zab-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-zab-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-zab-dup    to   w-aux-cde-zab-dmx      .
           move      20                   to   w-aux-cde-zab-c01      .
       aco-680.
           if        w-aux-cde-zab-c01    >    zero
                     if    w-aux-cde-zab-dch
                          (w-aux-cde-zab-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-zab-dch
                                              (w-aux-cde-zab-c01)
                           subtract 1     from w-aux-cde-zab-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-zab-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-zab-dup    to   rf-zab-des-key         .
           move      spaces               to   rf-zab-cod-aeb         .
           move      "pgm/bol/fls/ioc/obj/iofzab"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-zab-des-key       >    w-aux-cde-zab-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-zab-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-zab-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              * Codice aspetto                  *
      *                              *---------------------------------*
           move      rf-zab-cod-aeb       to   w-aux-cde-zab-bco
                                              (w-aux-cde-zab-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione aspetto             *
      *                              *---------------------------------*
           move      rf-zab-des-aeb       to   w-aux-cde-zab-bde
                                              (w-aux-cde-zab-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-zab-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-zab-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-zab-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      20                   to   s-car                  .
           move      w-aux-cde-zab-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-zab-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-zab-bco
                    (w-aux-cde-zab-bix)   to   w-cod-des-zab-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-zab-crb    to   w-aux-cde-zab-cpb      .
           subtract  1                    from w-aux-cde-zab-cpb      .
           divide    6                    into w-aux-cde-zab-cpb      .
           add       1                    to   w-aux-cde-zab-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-zab-c01      .
      *                              *---------------------------------*
      ...
      *                              * di indice (w-aux-cde-zab-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-zab-c01    to   w-aux-cde-zab-nli      .
       aco-865.
           if        w-aux-cde-zab-nli    >    6
                     subtract  6          from w-aux-cde-zab-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-zab-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-zab-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-zab-c01    <    w-aux-cde-zab-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-zab-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-zab-cpa    <    w-aux-cde-zab-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-zab-nli    to   v-lin                  .
           move      24                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-zab-c01    to   w-aux-cde-zab-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-zab-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-zab-cpa    to   w-aux-cde-zab-c01      .
           multiply  6                    by   w-aux-cde-zab-c01      .
           subtract  5                    from w-aux-cde-zab-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-zab-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-zab-c01    to   w-aux-cde-zab-c02      .
           add       5                    to   w-aux-cde-zab-c02      .
           divide    6                    into w-aux-cde-zab-c02      .
           move      w-aux-cde-zab-c02    to   w-aux-cde-zab-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-zab-c02      .
           multiply  6                    by   w-aux-cde-zab-c02      .
           add       1                    to   w-aux-cde-zab-c02      .
           add       5
                     w-aux-cde-zab-c02  giving w-aux-cde-zab-c03      .
           move      w-aux-cde-zab-c03    to   w-aux-cde-zab-c04      .
           if        w-aux-cde-zab-c03    >    w-aux-cde-zab-crb
                     move  w-aux-cde-zab-crb
                                          to   w-aux-cde-zab-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-zab-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      03                   to   v-car                  .
           move      w-aux-cde-zab-c05    to   v-lin                  .
           move      19                   to   v-pos                  .
           move      w-aux-cde-zab-bco
                    (w-aux-cde-zab-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      *                                      * Descrizione aspetto     *
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-zab-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-zab-c02    not  > w-aux-cde-zab-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-zab-c02    >    w-aux-cde-zab-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-zab-cpa    to   w-aux-cde-zab-lt1      .
           move      w-aux-cde-zab-cpb    to   w-aux-cde-zab-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-zab-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
