      ...
      *                                   Fase:    bol310              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 10/01/04    *
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Con data di emissione  dal :             al :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      08                   to   w-cod-des-zbi-lin      .
           move      30                   to   w-cod-des-zbi-pos      .
           move      08                   to   w-cod-des-zbi-dln      .
      ...
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           move      "Tutti"              to   rr-tip-mov-des         .
           perform   vis-tip-mov-des-000  thru vis-tip-mov-des-999    .
      *                  *---------------------------------------------*
      *                  * Normalizzazione numeri documento            *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      16                   to   w-cod-mne-age-lin      .
           move      30                   to   w-cod-mne-age-pos      .
           move      16                   to   w-cod-mne-age-nln      .
      ...
      *              *-------------------------------------------------*
      ...
      -              "ne  minima     "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-130.
      *              *-------------------------------------------------*
      *              * Test su numero bolla minimo e massimo           *
      *              *-------------------------------------------------*
           ...
           if        rr-nfa-min           not  > rr-nfa-max
                     go to tdo-ric-sel-200.
           move      "Numero documento iniziale maggiore di quella final
      ...
      *              *-------------------------------------------------*
      *              * Regolarizzazione si/no documenti senza codice   *
      *              * agente                                          *
      *              *-------------------------------------------------*
           if        rr-snx-fsa           =    zero
      ...
      *                  *---------------------------------------------*
      *                  * Si/no documenti senza codice agente         *
      *                  *---------------------------------------------*
           move      zero                 to   rr-snx-fsa             .
      *                  *---------------------------------------------*
      *                  * Si/no documenti accompagnatori              *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-dat-max           =    9999999
                     move  zero           to   rr-dat-max             .
      *                  *---------------------------------------------*
      *                  * Numero documento per accettazione max       *
      *                  *---------------------------------------------*
           if        rr-nfa-max           =    999999999
                     move  zero           to   rr-nfa-max             .
      *                  *---------------------------------------------*
      *                  * Numero documento interno max                *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           else      move  rr-nfi-min     to   rf-bit-num-doc         .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su si/no documento senza codice agente *
      *                  *---------------------------------------------*
           if        rr-snx-fsa           not  = 1
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-bit-num-doc       <    rr-nfi-min or
                     rf-bit-num-doc       >    rr-nfi-max
                     go to stp-srt-inp-200.
       stp-srt-inp-460.
      *                  *---------------------------------------------*
      ...
      *                      * Codice dipendenza                       *
      *                      *-----------------------------------------*
           move      rf-bit-cod-dpz       to   srt-cod-dpz            .
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
      ...
      *                      * Tipo documento                          *
      *                      *-----------------------------------------*
           move      rf-bit-cod-tmb       to   srt-cod-tmo            .
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
