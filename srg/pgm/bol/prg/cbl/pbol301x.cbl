      ...
      *                                                                *
      *              Input  : w-esp-rig-bir-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-esp-rig-bir-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "ES"  Espansione                                               *
      *                                                                *
      *              Input  : w-esp-rig-bir-ope : "ES"                 *
      *                                                                *
      *                       w-esp-rig-bir-prt : protocollo bolla     *
      *                       w-esp-rig-bir-num : numero documento     *
      *                       w-esp-rig-bir-dat : data documento       *
      *                       w-esp-rig-bir-tmo : tipo documento       *
      *                       w-esp-rig-bir-pro : codice alfanumerico  *
      *                                           prodotto (opzionale) *
      *                                                                *
      *              Output : nessuno                                  *
      *                                                                *
      ...
      *             sulle righe bolla nel caso in cui venga effet-     *
      *             tuata una interrogazione sulle righe [bir]         *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      *================================================================*
      ...
      ******************************************************************
       Procedure Division                using w-esp-rig-bir          .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-esp-rig-bir-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-esp-rig-bir-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-esp-rig-bir-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-esp-rig-bir-ope    =    "ES"
      ...
      *                      *-----------------------------------------*
      *                      * Si/No gestione ordini di spedizione     *
      *                      * attiva                                  *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-esp-rig-bir-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-esp-rig-bir-prt    to   rf-bit-num-prt         .
           move      "pgm/bol/fls/ioc/obj/iofbit"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      "NUMPRT    "         to   f-key                  .
           move      "NL"                 to   f-cfr                  .
           move      w-esp-rig-bir-prt    to   rf-bir-num-prt         .
      ...
      *              *-------------------------------------------------*
           if        rf-bir-num-prt       not  = w-esp-rig-bir-prt
                     go to esp-500.
       esp-320.
      *              *-------------------------------------------------*
      ...
      *                  * Numero protocollo                           *
      *                  *---------------------------------------------*
           move      rf-bir-num-prt       to   w-aux-rec-rig-prt
                                              (w-aux-rec-rig-crb)     .
      *                  *---------------------------------------------*
      *                  * Numero progressivo                          *
      *                  *---------------------------------------------*
           move      rf-bir-num-prg       to   w-aux-rec-rig-prg
                                              (w-aux-rec-rig-crb)     .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico  prodotto               *
      *                  *---------------------------------------------*
           if        rf-bir-tip-rig       =    "P    "
                     move  rf-bir-alf-pro to   w-aux-rec-rig-alf
                                              (w-aux-rec-rig-crb)
      ...
      *                  *---------------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      50                   to   v-pos                  .
           move      w-esp-rig-bir-tmo    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                  *---------------------------------------------*
      *                  * Literal 'nr.'                               *
      ...
      *                  *---------------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      60                   to   v-pos                  .
           move      w-esp-rig-bir-num    to   w-num-prt-num-num      .
      ...
      *                  *---------------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      71                   to   v-pos                  .
           move      w-esp-rig-bir-dat    to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       esp-540.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-esp-rig-bir-pro    to   w-wrk-fnd-pro-alf      .
      *                      *-----------------------------------------*
      *                      * A 'find'                                *
      *                      *-----------------------------------------*
           go to     esp-620.
      ...
      *                  * Incremento deviatore per il 'find'          *
      *                  *---------------------------------------------*
           if        w-esp-rig-bir-pro    not  = spaces
                     add   1              to   w-cnt-swc-fnd-pro      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-aux-rec-rig-prt
                    (w-aux-rec-rig-c02)   to   rf-bir-num-prt         .
           move      w-aux-rec-rig-prg
                    (w-aux-rec-rig-c02)   to   rf-bir-num-prg         .
           move      "pgm/bol/fls/ioc/obj/iofbir"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *
           if        w-ctl-tip-rig-chr (1)
                     ...
                     move  rf-bir-alf-pro to   w-all-str-cat (3)
      ...
      *
           if        w-let-arc-bix-flg    not  = spaces
                     go to esp-vis-310.
      *
           move      w-let-arc-bix-des    to   w-lin-imm-des-rig      .
      *
           go to     esp-vis-400.
       esp-vis-310.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-bir-des-rig       to   w-lin-imm-des-rig      .
      *                          *-------------------------------------*
      *                          * Oltre                               *
      *                          *-------------------------------------*
           go to     esp-vis-400.
      ...
      *                          *-------------------------------------*
           ...
           move      rf-bir-tip-arc       to   w-let-dcp-pdx-tar      .
      ...
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
           if        rf-bir-imp-rig       >    999999999 or
                     rf-bir-imp-rig       <   -999999999
                     move  11             to   v-car
           else      move  09             to   v-car                  .
           move      rf-bir-dec-vpf       to   v-dec                  .
           move      "S"                  to   v-sgn                  .
           if        rf-bir-imp-rig       >    999999999 or
                     rf-bir-imp-rig       <   -999999999
                     move  "B"            to   v-edm
           else      move  "GB"           to   v-edm                  .
           move      rf-bir-imp-rig       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           if        w-aux-rec-rig-tor    =    "R"
                     move  rf-bir-num-prg to   w-aux-rec-rig-kpg
                                              (w-aux-rec-rig-crb)     .
      *              *-------------------------------------------------*
      *              * Codice alfanumerico prodotto                    *
      *              *-------------------------------------------------*
           if        w-aux-rec-rig-tor    =    "P"
                     move  rf-bir-alf-pro to   w-aux-rec-rig-kal
                                              (w-aux-rec-rig-crb)     .
      *              *-------------------------------------------------*
      *              * Descrizione prodotto                            *
      *              *-------------------------------------------------*
           if        w-aux-rec-rig-tor    =    "D"
                     move  rf-bir-des-rig to   w-aux-rec-rig-kde
                                              (w-aux-rec-rig-crb)     .
      *              *-------------------------------------------------*
      *              * Quantita' prodotto                              *
      *              *-------------------------------------------------*
           if        w-aux-rec-rig-tor    =    "Q"
                     move  rf-bir-qta-ven to   w-aux-rec-rig-kqt
                                              (w-aux-rec-rig-crb)     .
      *              *-------------------------------------------------*
      *              * Importo in riga                                 *
      *              *-------------------------------------------------*
           if        w-aux-rec-rig-tor    =    "I"
                     move  rf-bir-imp-rig to   w-aux-rec-rig-kim
                                              (w-aux-rec-rig-crb)     .
       esp-key-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      "NUMPRT    "         to   f-key                  .
           move      w-aux-rec-rig-prt
                    (w-aux-rec-rig-c01)   to   rf-bir-num-prt         .
           move      w-aux-rec-rig-prg
                    (w-aux-rec-rig-c01)   to   rf-bir-num-prg         .
           move      "pgm/bol/fls/ioc/obj/iofbir"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           if        rf-bir-sgl-vpl       =    spaces
                     go to esp-rig-210.
      *                      *-----------------------------------------*
      *                      * Deviazione a seconda del momento di ap- *
      *                      * plicazione cambio                       *
      *                      *-----------------------------------------*
           if       (rf-bit-int-ftr       =    02  and
                     ...
                     rf-bit-int-ftr       =    03
                     go to esp-rig-202
           else      go to esp-rig-204.
       esp-rig-202.
      *                      *-----------------------------------------*
      *                      * Momento di applicazione cambio : Alla   *
      *                      * bolla                                   *
      *                      *-----------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                  *---------------------------------------------*
      *                  * Se e' prevista la visualizzazione delle no- *
      *                  * te in riga con i riferimenti ai numeri di   *
      *                  * ordine (tipo '11'), si salta la visualiz-   *
      *                  * zazione che segue                           *
      *                  *---------------------------------------------*
           if        w-prs-tvn-rgd        =    11
                     go to esp-rig-250.
      ...
      *                  *---------------------------------------------*
           ...
           move      "V"                  to   v-tip                  .
           move      09                   to   v-car                  .
           move      rf-bir-dec-vpp       to   v-dec                  .
           add       rf-bir-dec-prz       to   v-dec                  .
           move      spaces               to   v-sgn                  .
           move      "<BG"                to   v-edm                  .
           move      10                   to   v-lin                  .
           move      23                   to   v-pos                  .
           move      rf-bir-prz-ven       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Legame valutario                            *
      ...
      *                      *-----------------------------------------*
           ...
           if       (rf-bit-int-ftr       =    02  and
                     ...
                     rf-bit-int-ftr       =    03
                     move  45             to   v-pos
           else      move  52             to   v-pos                  .
           move      rf-bir-ccr-vpl       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Cambio effettivo                        *
      ...
      *                      *-----------------------------------------*
           ...
           if       (rf-bit-int-ftr       =    02  and
                     ...
                     rf-bit-int-ftr       =    03
                     move  75             to   v-pos
           else      move  69             to   v-pos                  .
           move      rf-bir-plm-vpl       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Tipo di limitazione                     *
      *                      *-----------------------------------------*
           ...
           if       (rf-bit-int-ftr       =    02  and
                     ...
                     rf-bit-int-ftr       =    03
                     move  79             to   v-pos
           else      move  74             to   v-pos                  .
           move      rf-bir-tlm-vpl       to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       esp-rig-540.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-bir-ctp-ven       to   w-edt-cod-pdc-cod      .
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Se e' prevista la visualizzazione delle *
      *                      * note in riga con i riferimenti ai nume- *
      *                      * ri ordine (tipo '11'), si salta la      *
      *                      * visualizzazione che segue               *
      *                      *-----------------------------------------*
           if        w-prs-tvn-rgd        =    11
                     go to esp-rig-600.
      *                      *-----------------------------------------*
      ...
      *
           if        rf-bir-ocl-dat       =    zero
                     move  spaces         to   w-all-str-cat (1)      .
      *
           move      rf-bir-ocl-num       to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   w-wrk-str-x80          .   
      *                          *-------------------------------------*
      *                          * Estremi conferma ordine cliente     *
      *                          *-------------------------------------*
           if        rf-bir-coc-tip       =    spaces and
                     rf-bir-coc-num       =    zero   and
                     rf-bir-coc-dat       =    zero
                     go to esp-rig-594.
      *                          *-------------------------------------*
      *                          * Composizione stringa                *
      *                          *-------------------------------------*
           ...
           move      w-wrk-str-x80        to   w-all-str-cat (1)      .
           move      "("                  to   w-all-str-cat (2)      .
           move      rf-bir-coc-tip       to   w-all-str-cat (3)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
      *                          *-------------------------------------*
      *                          * Editing numero conferma ordine      *
      *                          *-------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      06                   to   v-car                  .
           ...
           move      spaces               to   v-sgn                  .
           move      "<"                  to   v-edm                  .
           move      rf-bir-coc-num       to   w-num-prt-num-num      .
           move      w-num-prt-num-prg    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Lettura preliminare record [bix]                *
      *              *-------------------------------------------------*
           move      rf-bir-num-prt       to   w-let-arc-bix-prt      .
           move      rf-bir-num-prg       to   w-let-arc-bix-prg      .
           move      11                   to   w-let-arc-bix-trc      .
      ...
      *
           move      w-let-arc-bix-des    to   w-wrk-des-rig          .
      *
      ...
      *
           if        w-ctl-tip-rig-chr (1)
                     ...
                     move  w-ctl-tip-rig-aoc
                                          to   v-alf
           else      move  rf-bir-alf-pro to   v-alf                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-pro-999.
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/bol/mov/bol300[tvn-rgd]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
      ...
      *                                      * Test                    *
      *                                      *-------------------------*
           if        rf-bir-sgl-vps       =    rf-bir-sgl-vpp
                     go to vis-not-rgd-247.
      *                                      *-------------------------*
      *                                      * String                  *
      *                                      *-------------------------*
           string    rf-bir-sgl-vps
                                delimited by   size
                                          into w-vis-not-rgd-x80
                                  with pointer w-vis-not-rgd-pnt      .
       vis-not-rgd-247.
      ...
      *                          *-------------------------------------*
      *                          * Eventuali riferimenti ad ordine di  *
      *                          * spedizione                          *
      *                          *-------------------------------------*
           if        w-prs-ods-snx        not  = "S"
                     go to vis-not-rgd-262.
      *                          *-------------------------------------*
      *                          * Prompt per numero ordine di spedi-  *
      *                          * zione                               *
      *                          *-------------------------------------*
           move      "Ordine di spediz.:" to   w-vis-not-rgd-a77
                                              (49:18)                 .
       vis-not-rgd-262.
      *                      *-----------------------------------------*
      *                      * Composizione seconda riga               *
      ...
      *                                  * work di lavoro              *
      *                                  *-----------------------------*
           move      rf-bir-prz-lrs       to   w-vis-not-rgd-pvp      .
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           move      rf-bir-sgl-vps       to   w-cvs-vlt-sgl          .
           move      rf-bir-dec-vps       to   w-cvs-vlt-dec          .
           move      rf-bir-tdc-vps       to   w-cvs-vlt-tdc          .
           move      rf-bir-cdc-vps       to   w-cvs-vlt-cdc          .
      ...
      *                                          * lore scostamento    *
      *                                          *---------------------*
           subtract  rf-bir-prz-net       from w-vis-not-rgd-pvp
      ...
      *                                  *-----------------------------*
           ...
           move      "V"                  to   v-tip                  .
           move      09                   to   v-car                  .
           move      rf-bir-dec-vps       to   v-dec                  .
           add       rf-bir-dec-prz       to   v-dec                  .
           move      spaces               to   v-sgn                  .
           move      "<BG"                to   v-edm                  .
           move      rf-bir-prz-lrs       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                                  *-----------------------------*
      *                                  * String                      *
      ...
      *                                  * work di lavoro              *
      *                                  *-----------------------------*
           move      rf-bir-prz-nts       to   w-vis-not-rgd-pvp      .
      *                                  *-----------------------------*
      ...
      *                                          * lore scostamento    *
      *                                          *---------------------*
           subtract  w-vis-not-rgd-pvp    from rf-bir-prz-net
                                        giving w-vis-not-rgd-vsc      .
      *                                          *---------------------*
      *                                          * Determinazione per- *
      *                                          * centuale scostamen- *
      ...
      *                      * Test preliminare                        *
      *                      *-----------------------------------------*
           if        rf-bir-coc-num       =    zero   and
                     rf-bir-coc-dat       =    zero   and
                     rf-bir-ocl-num       =    spaces and
                     rf-bir-ocl-dat       =    zero
                     move  spaces         to   w-vis-not-rgd-a77
                     move  spaces         to   w-vis-not-rgd-b77
                     go to vis-not-rgd-800.
      ...
      *                      *-----------------------------------------*
      *                      * Eventuali riferimenti ad ordine di spe- *
      *                      * dizione                                 *
      *                      *-----------------------------------------*
           if        w-prs-ods-snx        not  = "S"
                     go to vis-not-rgd-715.
      *                          *-------------------------------------*
      *                          * Prompt per numero ordine di spedi-  *
      *                          * zione                               *
      *                          *-------------------------------------*
           move      "Ordine di spediz.:" to   w-vis-not-rgd-a77
                                              (49:18)                 .
      *                          *-------------------------------------*
      *                          * Ns. numero ordine di spedizione in  *
      *                          * campo di comodo                     *
      *                          *-------------------------------------*
           move      rf-bir-ods-prt       to   w-num-prt-num-num      .
           move      w-num-prt-num-saa    to   w-num-prt-prg-saa      .
           move      w-num-prt-num-prg    to   w-num-prt-prg-prg      .
      *                          *-------------------------------------*
      *                          * Editing ns. numero ordine di spedi- *
      *                          * zione                               *
      *                          *-------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "P"                  to   v-tip                  .
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-num-prt-prg-num    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                          *-------------------------------------*
      *                          * Numero ordine di spedizione         *
      *                          *-------------------------------------*
           move      v-edt                to   w-vis-not-rgd-a77
                                              (68:09)                 .
       vis-not-rgd-715.
      *                      *-----------------------------------------*
