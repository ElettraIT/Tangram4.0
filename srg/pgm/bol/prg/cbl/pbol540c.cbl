      ...
      *                       Ultima revisione:    NdK del 14/05/24    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Preparazione documenti per archiviazione in *
      *                                                                *
      ...
      *                    'bolpdf' con il relativo modulo grafico     *
      *                                                                *
      ...
      *                  *---------------------------------------------*
______*    if        rf-dbe-flg-ain       not  = spaces
______*              go to stp-srt-inp-200.
      ...
      *              * Aggiornamento percorso attachement              *
      *              *-------------------------------------------------*
           move      s-pat                to   rf-dbe-eml-all         .
      *              *-------------------------------------------------*
      *              * Aggiornamento flag distinta                     *
      *              *-------------------------------------------------*
           move      "#"                  to   rf-dbe-flg-apr         .
      *              *-------------------------------------------------*
      *              * Update record [dbe]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *                  * Identificatore fase                         *
      *                  *---------------------------------------------*
           move      "bolpdf"             to   w-inp-mst-fas          .
      *                  *---------------------------------------------*
      *                  * Identificatore documento                    *
      *                  *---------------------------------------------*
           move      rf-dbe-num-doc       to   w-inp-mst-dep          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dbe-prt-doc       to   w-inp-mst-prt          .
           move      01                   to   w-inp-mst-ncs          .
           move      01                   to   w-inp-mst-ctr          .
