      ...
      *                                   Fase:    bol540              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 07/03/18    *
      *                       Ultima revisione:    NdK del 22/10/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma bol540   *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  GESTIONE INVIO BOLLE - FORMATO 'PDF'  "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-num-dst           to   rf-dbe-num-dst         .
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-dbe-num-dst       not  = rr-num-dst
                     move  "#"            to   w-cnt-prn-flg-sub      .
       prn-tst-max-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dbe-cod-arc       to   rf-dcc-cod-cli         .
           move      rf-dbe-dpz-arc       to   rf-dcc-dpz-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      098                  to   p-pos                  .
           move      rf-dbe-num-doc       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Eventuale data invio                    *
      *                      *-----------------------------------------*
           if        rf-dbe-dat-inv       =    zero
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      105                  to   p-pos                  .
           move      rf-dbe-dat-doc       to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Eventuale segnale di blocco             *
      *                      *-----------------------------------------*
           if        rf-dbe-flg-ain       =    spaces
      ...
      *              *-------------------------------------------------*
           ...
           move      "DISTINTA DI INVIO BOLLE 'PDF' NR."
                                          to   w-all-str-cat (1)      .
           move      p-edt                to   w-all-str-cat (2)      .
