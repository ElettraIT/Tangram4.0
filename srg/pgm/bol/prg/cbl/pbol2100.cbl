      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pbol2101:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento vettori                   *
      *        *-------------------------------------------------------*
           05  w-exp-tip-orv.
               10  w-exp-tip-orv-num      pic  9(02)       value 3    .
               10  w-exp-tip-orv-lun      pic  9(02)       value 20   .
               10  w-exp-tip-orv-tbl.
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-orc.
               10  w-exp-tip-orc-num      pic  9(02)       value 3    .
               10  w-exp-tip-orc-lun      pic  9(02)       value 20   .
               10  w-exp-tip-orc-tbl.
                   15  filler             pic  x(20) value
                            "per Codice          "                    .
                   15  filler             pic  x(20) value
                            "per Ragione sociale "                    .
      ...
      *                  * Tipo ordinamento vettori                    *
      *                  *---------------------------------------------*
           perform   acc-tip-orv-000      thru acc-tip-orv-999        .
      ...
      *                  * Tipo ordinamento clienti                    *
      *                  *---------------------------------------------*
           perform   acc-tip-orc-000      thru acc-tip-orc-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Tipo ordinamento vettori   *
      *    *-----------------------------------------------------------*
       acc-tip-orv-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tip-orv-lun    to   v-car                  .
           move      w-exp-tip-orv-num    to   v-ldt                  .
           move      "CRM#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      05                   to   v-lin                  .
           move      33                   to   v-pos                  .
           move      w-exp-tip-orv-tbl    to   v-txt                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      rr-tip-orv           to   v-num                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-tip-orv-999.
       acc-tip-orv-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-tip-orv             .
       acc-tip-orv-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-tip-orv           =    zero
                     go to acc-tip-orv-100.
       acc-tip-orv-600.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Tipo ordinamento clienti   *
      *    *-----------------------------------------------------------*
       acc-tip-orc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tip-orc-lun    to   v-car                  .
           move      w-exp-tip-orc-num    to   v-ldt                  .
           move      "CRM#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-tip-orc-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      07                   to   v-lin                  .
           move      33                   to   v-pos                  .
           move      rr-tip-orc           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-tip-orc-999.
       acc-tip-orc-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-tip-orc             .
       acc-tip-orc-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-tip-orc           =    zero
                     go to acc-tip-orc-100.
       acc-tip-orc-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           move      zero                 to   rr-tip-orv             .
           move      zero                 to   rr-tip-orc             .
      ...
      *              *-------------------------------------------------*
      *              * Controllo su tipo ordinamento vettori           *
      *              *-------------------------------------------------*
           if        rr-tip-orv           not  > 3
