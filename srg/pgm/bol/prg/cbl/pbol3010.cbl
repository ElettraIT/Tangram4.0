      ...
      *                       Ultima revisione:    NdK del 31/03/10    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase bol301, nella sua globalita', esegue i tipi di inter-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * INTDIC      Ricerca documenti intestati ad un cliente     301a *
      * INTDIF      Ricerca documenti intestati ad un fornitore   301b *
      * INTDID      Ricerca documenti intestati ad una dipendenza 301c *
      * INTDIA      Ricerca documenti intestati ad un agente      301t *
      * INTDTM      Ricerca documenti per tipo movimento          301d *
      * INTDAF      Ricerca documenti in attesa di fatturazione   301e *
      * INTDPV      Ricerca documenti per prodotti di vendita     301f *
      * INTDSM      Ricerca documenti per semilavorati            301g *
      * INTDMP      Ricerca documenti per materie prime           301h *
      * INTROC      Ricerca documenti relativi ad un ordine       301o *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONI SU DOCUMENTI DI TRASPORTO"       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'bol301'           *
      *              *-------------------------------------------------*
           perform   fas-bol-301-000      thru fas-bol-301-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *
      ...
      -              " INTDTM     pbol301d  "
           ...
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "in  attesa di Fatturazione                        
      -              " INTDAF     pbol301e  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      *    *===========================================================*
      *    * Esecuzione ciclo per la fase 'bol300'                     *
      *    *-----------------------------------------------------------*
       fas-bol-301-000.
      *              *-------------------------------------------------*
      *              * Video in Off                                    *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-bol-301-300
           else if   v-key                =    "PRSC"
                     go to fas-bol-301-400
           else if   v-key                =    "NXSC"
                     go to fas-bol-301-450
           else if   v-key                =    "DOWN"
                     go to fas-bol-301-500
           else if   v-key                =    "EXIT"
                     go to fas-bol-301-250
           else      go to fas-bol-301-200.
       fas-bol-301-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-bol-301-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-bol-301-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-bol-301-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-bol-301-350
           else      go to fas-bol-301-322.
       fas-bol-301-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-bol-301-630
           else if   v-key                =    "PRSC"
                     go to fas-bol-301-600
           else if   v-key                =    "NXSC"
                     go to fas-bol-301-610
           else if   v-key                =    "UP  "
                     go to fas-bol-301-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-bol-301-650
           else if   v-key                =    "EXIT"
                     go to fas-bol-301-660
           else      go to fas-bol-301-570.
       fas-bol-301-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-bol-301-626
           else      go to fas-bol-301-628.
       fas-bol-301-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-bol-301-636
           else      go to fas-bol-301-638.
       fas-bol-301-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-bol-301-725
           else      go to fas-bol-301-750.
       fas-bol-301-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
