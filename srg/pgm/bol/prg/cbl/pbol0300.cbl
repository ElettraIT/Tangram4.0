      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella aspetto esteriore dei beni *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-aeb          pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-aeb          pic  x(20)                  .
               10  w-tes-des-key          pic  x(20)                  .
               10  w-tes-des-ags          pic  x(20)                  .
      ...
      *              *-------------------------------------------------*
      *              * Open modulo accettazione codice aspetto este-   *
      *              * riore dei beni                                  *
      *              *-------------------------------------------------*
           perform   cod-des-zab-opn-000  thru cod-des-zab-opn-999    .
       pre-exe-pgm-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       pos-exe-pgm-000.
      *              *-------------------------------------------------*
      *              * Close modulo accettazione codice aspetto este-  *
      *              * riore dei beni                                  *
      *              *-------------------------------------------------*
           perform   cod-des-zab-cls-000  thru cod-des-zab-cls-999    .
       pos-exe-pgm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           perform   acc-cod-aeb-000      thru acc-cod-aeb-999        .
      ...
      *              * Codice aspetto esteriore dei beni               *
      *              *-------------------------------------------------*
           perform   vis-cod-aeb-000      thru vis-cod-aeb-999        .
       vis-key-reg-999.
           exit.
      ...
      *              * Codice aspetto esteriore dei beni               *
      *              *-------------------------------------------------*
           perform   pmt-cod-aeb-000      thru pmt-cod-aeb-999        .
      *              *-------------------------------------------------*
      *              * Linea di trattini                               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice aspetto esteriore beni *
      *    *-----------------------------------------------------------*
       pmt-cod-aeb-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice aspetto esteriore beni *
      *    *-----------------------------------------------------------*
       acc-cod-aeb-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-aeb        to   w-cod-des-zab-cod      .
           move      04                   to   w-cod-des-zab-lin      .
           move      30                   to   w-cod-des-zab-pos      .
           move      07                   to   w-cod-des-zab-dln      .
           move      30                   to   w-cod-des-zab-dps      .
           move      spaces               to   v-edm                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "INSR"               to   v-pfk (04)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   cod-des-zab-cll-000  thru cod-des-zab-cll-999    .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
           perform   cod-des-zab-foi-000  thru cod-des-zab-foi-999    .
       acc-cod-aeb-110.
           perform   cod-des-zab-cll-000  thru cod-des-zab-cll-999    .
           if        w-cod-des-zab-ope    =    "F+"
                     go to acc-cod-aeb-115.
           if        w-cod-des-zab-ope    =    "AC"
                     go to acc-cod-aeb-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-aeb-115.
           perform   cod-des-zab-foi-000  thru cod-des-zab-foi-999    .
           go to     acc-cod-aeb-110.
       acc-cod-aeb-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-aeb-999.
       acc-cod-aeb-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-cod-aeb          .
       acc-cod-aeb-400.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice aspetto esteriore   *
      *    *-----------------------------------------------------------*
       vis-cod-aeb-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Descrizione aspetto esteriore dei beni      *
      *                  *---------------------------------------------*
           perform   acc-des-aeb-000      thru acc-des-aeb-999        .
           if        v-key                =    "NXSC"
      ...
      *                  *---------------------------------------------*
           perform   acc-des-ags-000      thru acc-des-ags-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Descrizione aspetto esteriore dei beni          *
      *              *-------------------------------------------------*
           perform   vis-des-aeb-000      thru vis-des-aeb-999        .
      *              *-------------------------------------------------*
      *              * Descrizione aggiuntiva                          *
      *              *-------------------------------------------------*
           perform   vis-des-ags-000      thru vis-des-ags-999        .
           go to     vis-tes-reg-999.
       vis-tes-reg-999.
           exit.
      ...
      *              * Descrizione aspetto esteriore dei beni          *
      *              *-------------------------------------------------*
           perform   pmt-des-aeb-000      thru pmt-des-aeb-999        .
      *              *-------------------------------------------------*
      *              * Descrizione aggiuntiva                          *
      *              *-------------------------------------------------*
           perform   pmt-des-ags-000      thru pmt-des-ags-999        .
           go to     pmt-tes-reg-999.
       pmt-tes-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione aggiuntiva           *
      *    *-----------------------------------------------------------*
       pmt-des-ags-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Descrizione aggiuntiva per :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-aeb (1)    =    spaces
                     go to acc-des-aeb-100.
      *                  *---------------------------------------------*
      ...
      *                  * l'ordinamento                               *
      *                  *---------------------------------------------*
           move      w-tes-des-aeb (1)    to   w-all-str-alf          .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione aggiuntiva       *
      *    *-----------------------------------------------------------*
       acc-des-ags-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-des-ags-100.
       acc-des-ags-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione aggiuntiva    *
      *    *-----------------------------------------------------------*
       vis-des-ags-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-aeb (1)      .
           move      spaces               to   w-tes-des-ags (1)      .
       nor-nok-tes-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-aeb        to   rf-zab-cod-aeb         .
           move      "pgm/bol/fls/ioc/obj/iofzab"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zab]                        *
      *                          *-------------------------------------*
           move      rf-zab-des-aeb       to   w-tes-des-aeb (1)      .
           move      rf-zab-des-key       to   w-tes-des-key (1)      .
           move      rf-zab-des-ags       to   w-tes-des-ags (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zab]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zab-000      thru wrt-rec-zab-999        .
      ...
      *                      * Rewrite record [zab]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zab-000      thru rew-rec-zab-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zab]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zab-000      thru del-rec-zab-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zab]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zab-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-aeb (1)    to   rf-zab-des-aeb         .
           move      w-tes-des-key (1)    to   rf-zab-des-key         .
           move      w-tes-des-ags (1)    to   rf-zab-des-ags         .
       cmp-rec-zab-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zab]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zab-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zab-000      thru cmp-rec-zab-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione del codice aspetto este-   *
      *    * riore dei beni                                            *
      *    *-----------------------------------------------------------*
           copy      "pgm/bol/prg/cpy/acdezab0.acs"                   .
