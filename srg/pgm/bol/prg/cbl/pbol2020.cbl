      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pbol2021:        *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-sel-pti.
               ...
               10  w-exp-sel-pti-tbl.
                   ...
                   15  filler             pic  x(40) value
                            "Solo se non entrano in allegato 13^ iva ".
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipo di vettori               :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      *              * Prompt 'Selezione su archivio vettori'          *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      31                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
           ...
           perform   fnd-arc-vet-000      thru fnd-arc-vet-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      15                   to   w-cod-mne-vet-lin      .
           move      33                   to   w-cod-mne-vet-pos      .
      ...
      *    *-----------------------------------------------------------*
       reg-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Codice vettore minimo e massimo                 *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Tasto funzione "FIND" su archivio vettori                 *
      *    *-----------------------------------------------------------*
       fnd-arc-vet-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     go to  fnd-arc-vet-999.
      *              *-------------------------------------------------*
      *              * Richiamo programma di interrogazione            *
      *              *-------------------------------------------------*
           move      "pgm/bol/prg/obj/pbol2010"
                                          to   s-pat                  .
