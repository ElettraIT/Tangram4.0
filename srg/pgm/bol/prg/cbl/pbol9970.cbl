      ...
      *                                   Fase:    bol997              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 09/05/05    *
      *                       Ultima revisione:    NdK del 14/11/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione evasioni bolle da bolle            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " GESTIONE EVASIONI BOLLE DA ALTRE BOLLE "       .
      ...
      *              * Pre-accettazione                                *
      *              *-------------------------------------------------*
           move      w-acc-cod-tmb        to   rf-bit-cod-tmb         .
       acc-cod-tmb-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  * Quantita' assegnata                         *
      *                  *---------------------------------------------*
           perform   acc-qta-eva-000      thru acc-qta-eva-999        .
           if        v-key                =    "NXSC"
      ...
      *                  *---------------------------------------------*
           perform   acc-prt-frc-000      thru acc-prt-frc-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  *---------------------------------------------*
           perform   acc-prg-frc-000      thru acc-prg-frc-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Quantita' assegnata                             *
      *              *-------------------------------------------------*
           perform   vis-qta-eva-000      thru vis-qta-eva-999        .
      *              *-------------------------------------------------*
      *              * Protocollo di riferimento                       *
      *              *-------------------------------------------------*
           perform   vis-prt-frc-000      thru vis-prt-frc-999        .
      *              *-------------------------------------------------*
      *              * Progressivo riga di riferimento                 *
      *              *-------------------------------------------------*
           perform   vis-prg-frc-000      thru vis-prg-frc-999        .
      *              *-------------------------------------------------*
      *              * Prodotto                                        *
      *              *-------------------------------------------------*
      ...
      *              * Quantita' evasa                                 *
      *              *-------------------------------------------------*
           perform   pmt-qta-eva-000      thru pmt-qta-eva-999        .
      *              *-------------------------------------------------*
      *              * Protocollo di riferimento                       *
      *              *-------------------------------------------------*
           perform   pmt-prt-frc-000      thru pmt-prt-frc-999        .
      *              *-------------------------------------------------*
      *              * Progressivo riga di riferimento                 *
      *              *-------------------------------------------------*
           perform   pmt-prg-frc-000      thru pmt-prg-frc-999        .
      *              *-------------------------------------------------*
      *              * Prodotto                                        *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Quantita' evasa               *
      *    *-----------------------------------------------------------*
       pmt-qta-eva-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Protocollo di riferimento     *
      *    *-----------------------------------------------------------*
       pmt-prt-frc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Protocollo di riferimento  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-prt-frc-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Progressivo di riferimento    *
      *    *-----------------------------------------------------------*
       pmt-prg-frc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Progressivo di riferimento :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-prg-frc-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Prodotto                      *
      *    *-----------------------------------------------------------*
       pmt-num-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Quantita' evasa              *
      *    *-----------------------------------------------------------*
       acc-qta-eva-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-qta-eva-100.
       acc-qta-eva-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Quantita'                         *
      *    *-----------------------------------------------------------*
       vis-qta-eva-000.
      *              *-------------------------------------------------*
      *              * Quantita' evasa                                 *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Prodotto                          *
      *    *-----------------------------------------------------------*
       vis-num-pro-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      14                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      rf-bir-alf-pro       to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Visualizzazione prompt codice numerico          *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      09                   to   v-car                  .
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Visualizzazione codice numerico                 *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      07                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-acc-num-prg        to   rf-bir-num-prg         .
           move      "pgm/bol/fls/ioc/obj/iofbir"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      rf-bit-num-prt       to   rf-bie-num-prt         .
           move      w-acc-num-prg        to   rf-bie-num-prg         .
           move      "pgm/bol/fls/ioc/obj/iofbie"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Write record [bie]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-bie-000      thru wrt-rec-bie-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
      ...
      *                      * Rewrite record [bie]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-bie-000      thru rew-rec-bie-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [bie]                             *
      *              *-------------------------------------------------*
           perform   del-rec-bie-000      thru del-rec-bie-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Cancellazione record righe [bie]                          *
      *    *-----------------------------------------------------------*
       del-rec-bie-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-bie-000      thru cmp-rec-bie-999        .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Composizione record righe [bie]                           *
      *    *-----------------------------------------------------------*
       cmp-rec-bie-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      w-acc-num-prt        to   rf-bie-num-prt         .
           move      w-acc-num-prg        to   rf-bie-num-prg         .
           move      w-acc-cod-tmb        to   rf-bie-cod-tmb         .
           move      w-acc-cod-dpz        to   rf-bie-cod-dpz         .
           move      w-acc-dat-doc        to   rf-bie-dat-doc         .
           move      w-acc-num-doc        to   rf-bie-num-doc         .
           move      spaces               to   rf-bie-alx-exp         .
       cmp-rec-bie-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record righe [bie]                              *
      *    *-----------------------------------------------------------*
       wrt-rec-bie-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      ...
      *                  *---------------------------------------------*
           ...
           if        s-ves                not  = spaces
                     move  "#"            to   w-fnd-arc-bit-sel
                     go to fnd-arc-bit-999.
           move      s-alf                to   w-fnd-arc-bit-toc      .
      *                  *---------------------------------------------*
      *                  * Data documento                              *
      *                  *---------------------------------------------*
           move      "CV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           move      w-fnd-arc-bit-toc    to   rf-bit-cod-tmb         .
           move      w-fnd-arc-bit-dat    to   rf-bit-dat-doc         .
           move      w-fnd-arc-bit-num    to   rf-bit-num-doc         .
