      ...
      *                                   Fase:    bol360              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 30/06/03    *
      *                       Ultima revisione:    NdK del 07/06/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma bol360   *
      *                                                                *
      *                    Documenti di trasporto per prodotto         *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-stp-srt-inp.
           ...
           05  w-stp-srt-inp-c01          pic  9(02)                  .
           05  w-stp-srt-inp-dpz          pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      *              * Ciclo per dipendenze                            *
      *              *-------------------------------------------------*
           if        rr-dpz-inu           not  = zero
                     move    rr-dpz-inu   to   w-stp-srt-inp-dpz
                     perform stp-srt-inp-bir-000
                                          thru stp-srt-inp-bir-999
                     go to stp-srt-inp-800.
       stp-srt-inp-510.
           move      zero                 to   w-stp-srt-inp-c01      .
       stp-srt-inp-520.
           add       1                    to   w-stp-srt-inp-c01      .
           if        w-stp-srt-inp-c01    >    rr-dpz-ctr-sel or
                     w-stp-srt-inp-c01    >    99
                     go to stp-srt-inp-800.
           move      rr-dpz-ele-cod
                    (w-stp-srt-inp-c01)   to   w-stp-srt-inp-dpz      .
       stp-srt-inp-540.
      *              *-------------------------------------------------*
      *              * Trattamento record [bir]                        *
      *              *-------------------------------------------------*
      ...
      *    * Input procedure per sort                                  *
      *    *                                                           *
      *    * Subroutine per scansione righe                            *
      *    *-----------------------------------------------------------*
       stp-srt-inp-bir-000.
      *              *-------------------------------------------------*
      *              * Start su file [bir]                             *
      *              *-------------------------------------------------*
           ...
           move      w-stp-srt-inp-dpz    to   rf-bir-cod-dpz         .
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-bir-cod-dpz       not  = w-stp-srt-inp-dpz or
                     rf-bir-tip-mag       not  = 01                or
                     rf-bir-num-pro       not  = rf-dcp-num-pro
                     go to stp-srt-inp-bir-900.
       stp-srt-inp-bir-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-dat-min           not  = zero and
                     rf-bir-dat-doc       <    rr-dat-min
                     go to stp-srt-inp-bir-200.
      *                  *---------------------------------------------*
      *                  * Test su data max                            *
      *                  *---------------------------------------------*
           if        rr-dat-max           not  = zero and
                     rf-bir-dat-doc       >    rr-dat-max
                     go to stp-srt-inp-bir-200.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-bir-cod-dpz       to   srt-cod-dpz            .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-bir-cod-tmb       to   srt-tip-doc            .
      ...
      *              *-------------------------------------------------*
           move      "DOCUMENTI DI TRASPORTO PER PRODOTTO"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Documento di trasporto                         Cli
      -              "ente                           Quantita'      "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
