      ...
      *                                   Fase:    bol540              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/03/18    *
      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [dbe]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-dbe.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-dbe-prt      pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Progressivo                                       *
      *            *---------------------------------------------------*
               10  w-cmp-rec-dbe-prg      pic  9(05)                  .
      ...
      *                  *---------------------------------------------*
           move      rf-dbe-num-doc       to   w-all-str-alf          .
      ...
      *
           ...
           else      move  rf-dbe-num-doc to   w-lin-imm-num-doc      .
      *
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dbe-tmo-doc       to   w-all-str-cat (1)      .
           move      rf-dbe-num-doc       to   w-all-str-cat (2)      .
...
______*              go to rou-let-reg-999.
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [dbe]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/bol/fls/ioc/obj/iofdbe"
                                          to   s-pat                  .
      ...
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
           move      rf-dbe-cod-arc       to   srt-cod-cli            .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-dbe-dat-doc       to   srt-dat-doc            .
      *                  *---------------------------------------------*
      *                  * Record [dbe]                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                  * Record [dbe]                                *
      *                  *---------------------------------------------*
           move      rf-dbe               to   w-rig-rec-dbe          .
           move      rf-dbe-cod-arc       to   w-rig-cod-cli          .
           move      rf-dbe-dpz-arc       to   w-rig-dpz-cli          .
      *
      ...
      *
           move      rf-dbe-eml-ind       to   w-rig-ind-eml          .
      *                  *---------------------------------------------*
      *                  * Valori indiretti                            *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/bol/prg/obj/pbol5402"                       .
       cnc-rlt-sup-999.
           exit.
