      ...
      *                                   Fase:    bol902              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/01/97    *
      *                       Ultima revisione:    NdK del 15/01/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma bol902   *
      *                                                                *
      *                    Controllo progressione numerica documenti   *
      *                                                                *
      *================================================================*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Si/No movimento che interessa la    *
      *                          * fatturazione                        *
      *                          *-------------------------------------*
           if        rf-bit-int-ftr       =    01
                     move  01             to   srt-int-ftr
           else if   rf-bit-int-ftr       =    02
                     move  01             to   srt-int-ftr
           else      move  02             to   srt-int-ftr            .
      *                          *-------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      srt-int-ftr          to   w-rot-l01-int-ftr      .
      ...
      *              *-------------------------------------------------*
           move      "CONTROLLO PROGRESSIONE DOCUMENTI DI TRASPORTO"
