      ...
      *                       Ultima revisione:    NdK del 04/10/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma bol012   *
      *                                                                *
      *                    Stampa tipo movimento per la bollettazione  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA TIPI MOVIMENTO DI BOLLETTAZIONE "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           ...
           05  rr-cod-min                 pic  x(05)                  .
           05  rr-cod-max                 pic  x(05)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zbi-cod-tmb         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-zbi-des-key         .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun tipo movimento entro i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zbi]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/bol/fls/ioc/obj/iofzbi"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Solo con codice dipendenza a zero               *
      *              *-------------------------------------------------*
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zbi-cod-tmb       <    rr-cod-min or
                     rf-zbi-cod-tmb       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zbi-des-key       <    rr-des-min or
                     rf-zbi-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      085                  to   p-pos                  .
      *
           if        rf-zbi-pos-sql       =    01
                     move  "D"            to   p-alf
           else if   rf-zbi-pos-sql       =    02
                     move  "I"            to   p-alf
           else      move  "N"            to   p-alf                  .
      *
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Default accettazione tipo riga corpo    *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      02                   to   p-car                  .
      ...
      *              *-------------------------------------------------*
           move      "TIPI MOVIMENTO DI BOLLETTAZIONE"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "Cod.             Descrizione           Fatt.  Caus
      -              "ali magazzino  TA  Num  A fronte  TV  TR  Nr.S"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Salvataggio posizionamento verticale attuale    *
      *              *-------------------------------------------------*
           move      "LS"                 to   p-ope                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Posizionamento verticale fisso per legenda  *
      *                  *---------------------------------------------*
           move      "VP"                 to   p-ope                  .
           subtract  07                   from p-sel-efc-sel
                                        giving p-lin                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "TV   = Tipo vendita per l'agente"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "TR   = Tipo riga da proporre"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Ripristino posizionamento verticale salvato     *
      *              *-------------------------------------------------*
           move      "LR"                 to   p-ope                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
