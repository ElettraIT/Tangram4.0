      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Personalizzazioni di invio bolle            *
      *                                                                *
      *                   (Solo SUPERVISORE)                           *
      *                                                                *
      ...
      * ----  ----------  -------------------------------------------- *
      *                                                                *
      *  01   bol540      Parametri di invio via mail documenti        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " PERSONALIZZAZIONI INVIO BOLLE CLIENTI  "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
      *            *---------------------------------------------------*
      *            * Tipo record in archivio [bol]                     *
      *            *---------------------------------------------------*
               10  w-tes-tip-rec          pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Codice record in archivio [bol]                   *
      *            *---------------------------------------------------*
...
______*    perform   pmt-dst-sdi-000      thru pmt-dst-sdi-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-tip-rec        to   rf-bol-tip-rec         .
           move      w-tes-cod-rec        to   rf-bol-cod-rec         .
           move      "pgm/bol/fls/ioc/obj/iofbol"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [bol]                        *
      *                          *-------------------------------------*
           move      rf-bol-dat-rec       to   w-tes-dat-rec (1)      .
       rou-let-reg-500.
      *                      *-----------------------------------------*
      ...
      *                      * Write record [bol]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-bol-000      thru wrt-rec-bol-999        .
      ...
      *                      * Rewrite record [bol]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-bol-000      thru rew-rec-bol-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [bol]                             *
      *              *-------------------------------------------------*
           perform   del-rec-bol-000      thru del-rec-bol-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [bol]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-bol-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-bol-ide-dat         .
           move      s-ute                to   rf-bol-ide-ute         .
           move      s-fas                to   rf-bol-ide-fas         .
           move      w-tes-dat-rec (1)    to   rf-bol-dat-rec         .
       cmp-rec-bol-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [bol]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-bol-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-bol-000      thru cmp-rec-bol-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
