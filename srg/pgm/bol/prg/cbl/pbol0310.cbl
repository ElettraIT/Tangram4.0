      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella aspetto esteriore    *
      *                    dei beni                                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " INTERROGAZIONE TABELLA ESTERIORE BENI  "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-des-zab-cod      .
           move      12                   to   w-cod-des-zab-lin      .
           move      30                   to   w-cod-des-zab-pos      .
           move      zero                 to   w-cod-des-zab-dln      .
           move      zero                 to   w-cod-des-zab-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-zab-ope      .
           move      rr-cod-max           to   w-cod-des-zab-cod      .
           move      12                   to   w-cod-des-zab-lin      .
           move      52                   to   w-cod-des-zab-pos      .
           move      zero                 to   w-cod-des-zab-dln      .
           move      zero                 to   w-cod-des-zab-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zab-cod-aeb         .
           move      "pgm/bol/fls/ioc/obj/iofzab"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-zab-des-key         .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zab]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/bol/fls/ioc/obj/iofzab"
                                          to   s-pat                  .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zab-cod-aeb       <    rr-cod-min or
                     rf-zab-cod-aeb       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zab-des-key       <    rr-des-min or
                     rf-zab-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      35                   to   v-pos                  .
           move      rf-zab-des-aeb       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zab-cod-aeb       to   w-mpn-cod-aeb          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-aeb'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      24                   to   v-pos                  .
           move      "TABELLA ASPETTO ESTERIORE DEI BENI"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
