      ...
      *                                                                *
      *                    N.B.: l'ubicazione viene determinata per la *
      *                          sede                                  *
      *                                                                *
      *================================================================*
      *                                                                *
      ...
      *        fase di Inserimento di un nuovo record [bir]            *
      *                                                                *
      ...
      *        gnale di riga ordine comunque considerata saldata in    *
      *        fase di Modifica di un record [bir]                     *
      *                                                                *
      ...
      *        gnale di riga ordine comunque considerata saldata in    *
      *        fase di Cancellazione di un record [bir]                *
      *                                                                *
      *        Input  : l-eva-orc-tip-ope = "DE"                       *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      * "CS" - Controllo dello sconto in chiusura per scansione delle  *
      *        righe appartenenti agli ordini                          *
      *                                                                *
      *        Input  : l-eva-orc-tip-ope = "CS"                       *
      *                                                                *
      *        Output : il totale ricalcolato in w-pie-rcl-scc (1)     *
      *                                                                *
      *================================================================*
      ...
      *        * Documento bolla                                       *
      *        *-------------------------------------------------------*
           05  w-acc-prt-bol              pic  9(11)                  .
           05  w-acc-tmo-bol              pic  x(05)                  .
           05  w-acc-tmo-bol-des          pic  x(30)                  .
           05  w-acc-tmo-bol-sgl          pic  x(03)                  .
           05  w-acc-dat-bol              pic  9(07)                  .
           05  w-acc-num-bol              pic  9(11)                  .
           05  w-acc-num-bol-r redefines
               w-acc-num-bol.
               10  w-acc-num-bol-saa      pic  9(03)                  .
               10  w-acc-num-bol-dpz      pic  9(02)                  .
               10  w-acc-num-bol-prg      pic  9(06)                  .
      ...
      *            *---------------------------------------------------*
               ...
               10  w-slc-num-oct-mxp      pic  9(02) value  5         .
      ...
      *        * Numero massimo elementi in tabella                    *
      *        *-------------------------------------------------------*
           05  w-bro-max-ele              pic  9(05) value 901        .
      *        *-------------------------------------------------------*
      *        * Tabella elementi                                      *
      *        *-------------------------------------------------------*
           05  w-bro-tbl.
               10  w-bro-sng-ele occurs 901.
      ...
      *        *-------------------------------------------------------*
      *        * Work per ridefinizione c/c del cliente                *
      *        *-------------------------------------------------------*
           05  w-buf-tes-orc-wcc          pic  x(12)                  .
           05  w-buf-tes-orc-wcc-r        redefines
               w-buf-tes-orc-wcc.
               10  w-buf-tes-orc-wid      pic  x(02)                  .
               10  w-buf-tes-orc-wcn      pic  x(10)                  .
      ...
      *                        * Codice alfanumerico prodotto          *
      *                        *---------------------------------------*
                           25  w-buf-rig-orc-alf-11
                                          pic  x(14)                  .
      *                        *---------------------------------------*
      *                        * Numero progressivo riga               *
      *                        *---------------------------------------*
                           25  w-buf-rig-orc-prg-11
                                          pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Dati del buffer                               *
      *                *-----------------------------------------------*
      ...
      *        * Numero elementi in tabella                            *
      *        *-------------------------------------------------------*
           05  w-buf-rig-bol-ctr          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Numero elementi non corrispondenti con l'ordine       *
      *        *-------------------------------------------------------*
           05  w-buf-rig-bol-nco          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Numero elementi non corrispondenti con la bolla       *
      *        *-------------------------------------------------------*
           05  w-buf-rig-bol-ncb          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Numero massimo elementi in tabella                    *
      *        *-------------------------------------------------------*
           05  w-buf-rig-bol-max          pic  9(05) value 901        .
      *        *-------------------------------------------------------*
      *        * Contatore di comodo                                   *
      *        *-------------------------------------------------------*
           05  w-buf-rig-bol-c01          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Tabella elementi                                      *
      *        *-------------------------------------------------------*
           05  w-buf-rig-bol-tbl.
               10  w-buf-rig-bol-ele occurs 901
                                 indexed  by   w-buf-rig-bol-inx      .
                   15  w-buf-rig-bol-num  pic  9(07)                  .
                   15  w-buf-rig-bol-qta  pic s9(10)v9(03)            .
      ...
      *        *-------------------------------------------------------*
      *        * Work per Det documento bolla gia' esistente oppure no *
      *        *-------------------------------------------------------*
           05  w-det-bol-ges.
      *            *---------------------------------------------------*
      *            * Esito della determinazione                        *
      ...
      *            *       vimento da quello cercato                   *
      *            *---------------------------------------------------*
               10  w-det-bol-ges-snx      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Tipo movimento trovato per valore precedente de-  *
      *            * terminato a 'X'                                   *
      *            *---------------------------------------------------*
               10  w-det-bol-ges-tmt      pic  x(05)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Work per Det quantita' evasa riga ordine              *
      *        *-------------------------------------------------------*
           05  w-det-qev-roc.
               10  w-det-qev-roc-dpz      pic  9(02)                  .
               10  w-det-qev-roc-prt      pic  9(11)                  .
               10  w-det-qev-roc-prg      pic  9(05)                  .
               10  w-det-qev-roc-qev      pic s9(10)v9(03)            .
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Work per routine rcl-per-scc-000/999                      *
      *    *-----------------------------------------------------------*
       01  w-rcl-per-scc.
      *        *-------------------------------------------------------*
      *        * Valore di comodo per il calcolo in riga               *
      *        *-------------------------------------------------------*
           05  w-rcl-per-scc-rig          pic s9(11)                  .
      ...
      *                  *---------------------------------------------*
      *                  * Controllo ed eventuale ricalcolo sconto     *
      *                  * in chiusura                                 *
      *                  *---------------------------------------------*
           else if   l-eva-orc-tip-ope    =    "CS"
                     perform rcl-per-scc-000
                                          thru rcl-per-scc-999
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-dti-orc-375.
      *                  *---------------------------------------------*
      *                  * Accettazione dati bolla                     *
      *                  *---------------------------------------------*
           perform   acc-dti-bol-000      thru acc-dti-bol-999        .
           if        v-key                =    "EXIT"
                     go to acc-dti-orc-800.
           if        v-key                =    "DO  "
                     go to acc-dti-orc-400.
           if        v-key                =    "UP  "
                     go to acc-dti-orc-350.
       acc-dti-orc-390.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-dti-orc-460.
      *              *-------------------------------------------------*
      *              * Test su eventuale lista di controllo            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se da effettuare                       *
      *                  *---------------------------------------------*
           if        w-acc-tip-ord        not  = 04
                     go to acc-dti-orc-480.
      *                  *---------------------------------------------*
      *                  * Tipo e codice archivio                      *
      *                  *---------------------------------------------*
           if        rf-bit-tip-arc       =    rf-oct-tip-arc and
                     rf-bit-cod-arc       =    rf-oct-cod-arc
                     go to acc-dti-orc-480.
      *                  *---------------------------------------------*
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Codice cliente diverso da quello in ordine !      
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                  *---------------------------------------------*
      *                  * A reimpostazione                            *
      ...
      *                      *-----------------------------------------*
       ...
       acc-dti-orc-620.
      *                  *---------------------------------------------*
      *                  * Test se superato il massimo numero di       *
      *                  * elementi                                    *
      *                  *---------------------------------------------*
           if        w-buf-rig-orc-sme    =    spaces
                     go to acc-dti-orc-622.
      *                      *-----------------------------------------*
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
           move      "Attenzione : superate le 900 righe massime consent
      -              "ite !          "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                      *-----------------------------------------*
      *                      * A reimpostazione                        *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-oct-arc-plf       to   w-let-arc-dcc-cli      .
      ...
      *                  * Lettura record [lic]                        *
      *                  *---------------------------------------------*
           move      rf-oct-arc-plf       to   w-let-arc-lic-cod      .
      ...
      *                  *---------------------------------------------*
           if        w-tes-dat-doc        <    w-let-arc-lic-dri or
                     ...
                     go to acc-dti-orc-625
           else      go to acc-dti-orc-630.
       acc-dti-orc-625.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rf-oct-ass-iva       not  = zero
                     go to acc-dti-orc-640.
      *                      *-----------------------------------------*
      *                      * Lettura file [cli]                      *
      *                      *-----------------------------------------*
           move      rf-oct-arc-plf       to   w-let-arc-cli-cod      .
      ...
      *                      *-----------------------------------------*
           move      w-let-arc-cli-ass    to   rf-oct-ass-iva         .
           go to     acc-dti-orc-640.
       acc-dti-orc-640.
      *              *-------------------------------------------------*
      *              * Test se in lista prodotti sono presenti codici  *
      *              * non in ordine                                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-acc-tip-ord        not  = 04
                     go to acc-dti-orc-700.
           if        w-buf-rig-bol-nco    =    zero
                     go to acc-dti-orc-700.
      *                  *---------------------------------------------*
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Attenzione : in ordine sono presenti codici non in
      -              " lista !       "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                  *---------------------------------------------*
      ...
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
           move      "Attenzione: ordine pro-forma !                    
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
       acc-tmo-orc-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-buf-rig-bol-nco      .
       acc-dti-bol-010.
      *              *-------------------------------------------------*
      *              * Visualizzazione prompts                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   acc-tmo-bol-000      thru acc-tmo-bol-999        .
           if        v-key                =    "EXIT"
      ...
      *                  * Data documento                              *
      *                  *---------------------------------------------*
           perform   acc-dat-bol-000      thru acc-dat-bol-999        .
           if        v-key                =    "EXIT"
                     go to acc-dti-bol-800.
           if        v-key                =    "DO  "
                     go to acc-dti-bol-400.
      ...
      *                  * Numero documento                            *
      *                  *---------------------------------------------*
           perform   acc-num-bol-000      thru acc-num-bol-999        .
           if        v-key                =    "EXIT"
                     go to acc-dti-bol-800.
           if        v-key                =    "DO  "
                     go to acc-dti-bol-400.
      ...
      *              *-------------------------------------------------*
           if        w-acc-tmo-bol        =    spaces or
                     w-acc-dat-bol        =    zero   or
                     w-acc-num-bol        =    zero
                     go to acc-dti-bol-100.
      *              *-------------------------------------------------*
      *              * Completamento numero documento                  *
      ...
      *                  * Secolo/Anno                                 *
      *                  *---------------------------------------------*
           move      w-acc-dat-bol        to   s-dat                  .
           move      s-saa                to   w-acc-num-bol-saa      .
      *                  *---------------------------------------------*
      *                  * Codice dipendenza o numero giornale Iva     *
      *                  *---------------------------------------------*
           move      w-acc-cod-dpz        to   w-acc-num-bol-dpz      .
      *                  *---------------------------------------------*
      *                  * Determinazione se documento esistente       *
      *                  *---------------------------------------------*
           perform   det-bol-ges-000      thru det-bol-ges-999        .
      *                      *-----------------------------------------*
      *                      * Se documento non esistente              *
      *                      *-----------------------------------------*
           if        w-det-bol-ges-snx    not  = "N"
      ...
      *              * Bufferizzazione numero protocollo               *
      *              *-------------------------------------------------*
           move      rf-bit-num-prt       to   w-acc-prt-bol          .
      *              *-------------------------------------------------*
      *              * A uscita                                        *
      *              *-------------------------------------------------*
           go to     acc-dti-bol-900.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-acc-tmo-bol        to   w-cod-des-zbi-cod      .
           move      17                   to   w-cod-des-zbi-lin      .
           move      09                   to   w-cod-des-zbi-pos      .
           move      17                   to   w-cod-des-zbi-dln      .
       ...
       acc-tmo-bol-110.
           ...
           if        w-cod-des-zbi-ope    =    "F+"
                     go to acc-tmo-bol-115.
           if        w-cod-des-zbi-ope    =    "AC"
                     go to acc-tmo-bol-120.
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       acc-tmo-bol-115.
           perform   cod-des-zbi-foi-000  thru cod-des-zbi-foi-999    .
           go to     acc-tmo-bol-110.
       acc-tmo-bol-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     go to acc-tmo-bol-999.
       acc-tmo-bol-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-acc-tmo-bol          .
       acc-tmo-bol-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-acc-tmo-bol        to   w-all-str-alf          .
           move      05                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        not  = spaces
                     go to acc-tmo-bol-100.
      *                  *---------------------------------------------*
      *                  * Lettura archivio [zbi] generale             *
      *                  *---------------------------------------------*
           move      w-acc-tmo-bol        to   w-let-arc-zbi-cod      .
           move      zero                 to   w-let-arc-zbi-dpz      .
           perform   let-arc-zbi-000      thru let-arc-zbi-999        .
           move      w-let-arc-zbi-des    to   w-acc-tmo-bol-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-tmo-bol-des-000  thru vis-tmo-bol-des-999    .
      *                  *---------------------------------------------*
      *                  * Se codice errato : reimpostazione           *
      *                  *---------------------------------------------*
      ...
      *                  * Se a spaces : reimpostazione                *
      *                  *---------------------------------------------*
           if        w-acc-tmo-bol        =    spaces
                     go to acc-tmo-bol-100.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione valori associati al tipo    *
      *                  * movimento                                   *
      *                  *---------------------------------------------*
           move      w-let-arc-zbi-sgl    to   w-acc-tmo-bol-sgl      .
       acc-tmo-bol-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       vis-tmo-bol-des-000.
           ...
           move      17                   to   v-lin                  .
           move      15                   to   v-pos                  .
           move      w-acc-tmo-bol-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-tmo-bol-des-999.
           exit.
      ...
      *                  * Eventuale default                           *
      *                  *---------------------------------------------*
           if        w-acc-dat-bol        not  = zero
                     go to acc-dat-bol-100.
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   w-acc-dat-bol          .
       acc-dat-bol-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     go to acc-dat-bol-999.
       acc-dat-bol-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-acc-dat-bol          .
      *              *-------------------------------------------------*
      *              * Se Find                                         *
      *              *-------------------------------------------------*
           if        v-key                not  = "FIND"
                     go to acc-dat-bol-400.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-acc-dat-bol        not  = zero
                     go to acc-dat-bol-600.
           if        v-key                =    "UP  "
                     go to acc-dat-bol-600
           else      go to acc-dat-bol-100.
       acc-dat-bol-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "DO  "               to   v-pfk (05)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-acc-num-bol-prg    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     go to acc-num-bol-999.
       acc-num-bol-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-acc-num-bol-prg      .
      *              *-------------------------------------------------*
      *              * Se Find                                         *
      *              *-------------------------------------------------*
           if        v-key                not  = "FIND"
                     go to acc-num-bol-400.
      *                  *---------------------------------------------*
      *                  * Find su archivio [bit]                      *
      *                  *---------------------------------------------*
           perform   fnd-arc-bit-000      thru fnd-arc-bit-999        .
           if        w-fnd-arc-bit-sel    not  = spaces
                     go to acc-num-bol-100.
      *                  *---------------------------------------------*
      *                  * Normalizzazione function-key                *
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      ...
      *              *-------------------------------------------------*
           move      w-fnd-arc-bit-tmb    to   w-acc-tmo-bol          .
           move      w-fnd-arc-bit-dat    to   w-acc-dat-bol          .
           move      w-fnd-arc-bit-num    to   w-acc-num-bol          .
       fnd-arc-bit-400.
      *              *-------------------------------------------------*
      ...
      *              * tazione                                         *
      *              *-------------------------------------------------*
           perform   vis-tmo-bol-000      thru vis-tmo-bol-999        .
           perform   vis-tmo-bol-des-000  thru vis-tmo-bol-des-999    .
           perform   vis-dat-bol-000      thru vis-dat-bol-999        .
           perform   vis-num-bol-000      thru vis-num-bol-999        .
      *              *-------------------------------------------------*
      *              * Uscita con successo                             *
      *              *-------------------------------------------------*
           go to     fnd-arc-bit-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-det-bol-ges-tmt      .
      *              *-------------------------------------------------*
      *              * Start su file [bit]                             *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      w-acc-dat-bol        to   rf-bit-dat-doc         .
           move      w-acc-cod-dpz        to   rf-bit-cod-dpz         .
           move      w-acc-num-bol        to   rf-bit-num-doc         .
      ...
      *              *-------------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to det-bol-ges-800.
      *              *-------------------------------------------------*
      *              * Max su [bit], se non superato : a determinazio- *
      *              * ne finale                                       *
      *              *-------------------------------------------------*
           if        rf-bit-dat-doc       not  = w-acc-dat-bol or
                     rf-bit-cod-dpz       not  = w-acc-cod-dpz or
                     rf-bit-num-doc       not  = w-acc-num-bol
                     go to det-bol-ges-800.
       det-bol-ges-200.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo movimento letto   *
      *              *-------------------------------------------------*
           if        rf-bit-cod-tmb       =    w-acc-tmo-bol
                     go to det-bol-ges-300
           else      go to det-bol-ges-400.
       det-bol-ges-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "S"                  to   w-det-bol-ges-snx      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     det-bol-ges-999.
       det-bol-ges-400.
      *              *-------------------------------------------------*
      ...
      *                  * successivo                                  *
      *                  *---------------------------------------------*
           if        rf-bit-sgl-num       not  = w-acc-tmo-bol-sgl
                     go to det-bol-ges-100.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-bit-cod-tmb       to   w-det-bol-ges-tmt      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-det-bol-ges-tmt    not  = spaces
                     move  "X"            to   w-det-bol-ges-snx
                     go to det-bol-ges-999
           else      go to det-bol-ges-900.
       det-bol-ges-900.
      *              *-------------------------------------------------*
      *              * Uscita per documento non trovato                *
      *              *-------------------------------------------------*
           move      "N"                  to   w-det-bol-ges-snx      .
       det-bol-ges-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-wrk-acc-000.
           ...
           move      zero                 to   w-acc-prt-bol          .
           move      spaces               to   w-acc-tmo-bol          .
           move      spaces               to   w-acc-tmo-bol-des      .
           move      spaces               to   w-acc-tmo-bol-sgl      .
           move      zero                 to   w-acc-dat-bol          .
           move      zero                 to   w-acc-num-bol          .
       nor-wrk-acc-999.
           exit.
      ...
      *                      *-----------------------------------------*
           move      zero                 to   w-bro-qta-bol
                                              (w-bro-num-ele)         .
      *                      *-----------------------------------------*
      *                      * Eventuale default da righe bolla lette  *
      *                      *-----------------------------------------*
           perform   buf-rig-orc-dqt-000  thru buf-rig-orc-dqt-999    .
       buf-rig-orc-380.
      *                  *---------------------------------------------*
      ...
      *                  * vadere meno una eventuale quantita' di      *
      *                  * default                                     *
      *                  *---------------------------------------------*
           move      w-bro-qta-dev
      ...
      *
           subtract  w-bro-qta-bol
                    (w-bro-num-ele)       from w-bro-qta-res
                                              (w-bro-num-ele)         .
      *                  *---------------------------------------------*
      ...
      *                      * Bufferizzazione codice prodotto         *
      *                      *-----------------------------------------*
           move      rf-ocr-alf-pro       to   w-buf-rig-orc-alf-11
                                              (w-buf-rig-orc-ctr)     .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione progressivo riga        *
      *                      *-----------------------------------------*
           move      rf-ocr-num-prg       to   w-buf-rig-orc-prg-11
                                              (w-buf-rig-orc-ctr)     .
      *                      *-----------------------------------------*
      *                      * Ad uscita                               *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       buf-rig-orc-obr-300.
           ...
           move      w-buf-rig-orc-ele
                    (w-buf-rig-orc-c03)   to   w-buf-rig-orc-ele
                                              (w-buf-rig-orc-max)     .
           move      w-buf-rig-orc-ele
                    (w-buf-rig-orc-c04)   to   w-buf-rig-orc-ele
                                              (w-buf-rig-orc-c03)     .
           move      w-buf-rig-orc-ele
                    (w-buf-rig-orc-max)   to   w-buf-rig-orc-ele
                                              (w-buf-rig-orc-c04)     .
           go to     buf-rig-orc-obr-100.
       buf-rig-orc-obr-999.
           exit.
      ...
      *    * Bufferizzazione righe ordine da trattare                  *
      *    *                                                           *
      *    * Subroutine di preparazione default da lista prodotti      *
      *    *-----------------------------------------------------------*
       buf-rig-orc-dqt-000.
      *              *-------------------------------------------------*
      *              * Test se ricerca da effettuare                   *
      *              *-------------------------------------------------*
           if        w-acc-tip-ord        not  = 04
                     go to buf-rig-orc-dqt-900.
           if        w-acc-prt-bol        =    zero
                     go to buf-rig-orc-dqt-900.
           if        w-buf-rig-bol-ctr    =    zero
                     go to buf-rig-orc-dqt-900.
           if        rf-ocr-num-pro       =    zero
                     go to buf-rig-orc-dqt-900.
       buf-rig-orc-dqt-100.
      *              *-------------------------------------------------*
      *              * Ricerca se il codice numerico prodotto e' gia'  *
      *              * stato bufferizzato                              *
      *              *-------------------------------------------------*
           set       w-buf-rig-bol-inx    to   1                      .
           search    w-buf-rig-bol-ele
                     when    w-buf-rig-bol-num
                            (w-buf-rig-bol-inx)
                                          =    rf-ocr-num-pro
                     go to   buf-rig-orc-dqt-300.
           go to     buf-rig-orc-dqt-500.
       buf-rig-orc-dqt-300.
      *              *-------------------------------------------------*
      *              * Upgrade quantita'                               *
      *              *-------------------------------------------------*
      ...
      *                  * Incremento quantita'                        *
      *                  *---------------------------------------------*
           move      w-buf-rig-bol-qta
                    (w-buf-rig-bol-inx)   to   w-bro-qta-bol
                                              (w-bro-num-ele)         .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
       ...
       buf-rig-orc-dqt-500.
      *              *-------------------------------------------------*
      *              * Incremento contatore prodotti senza corrispon-  *
      *              * denza in lista                                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento                                  *
      *                  *---------------------------------------------*
           add       1                    to   w-buf-rig-bol-nco      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     buf-rig-orc-dqt-900.
      ...
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      zero                 to   w-buf-rig-bol-ctr      .
           move      zero                 to   w-buf-rig-bol-c01      .
       buf-rig-bol-052.
           add       1                    to   w-buf-rig-bol-c01      .
           if        w-buf-rig-bol-c01    >    w-buf-rig-bol-max
                     go to buf-rig-bol-100.
      *
           move      zero                 to   w-buf-rig-bol-num
                                              (w-buf-rig-bol-c01)     .
           move      zero                 to   w-buf-rig-bol-qta
                                              (w-buf-rig-bol-c01)     .
      *
           go to     buf-rig-bol-052.
       buf-rig-bol-100.
      *              *-------------------------------------------------*
      *              * Start su file [bir]                             *
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-acc-prt-bol        to   rf-bir-num-prt         .
      ...
      *              * Max su [bir]                                    *
      *              *-------------------------------------------------*
           if        rf-bir-num-prt       not  = w-acc-prt-bol
                     go to buf-rig-bol-900.
       buf-rig-bol-400.
      *              *-------------------------------------------------*
      *              * Sel su [bir]                                    *
      *              *-------------------------------------------------*
       ...
       buf-rig-bol-500.
      *              *-------------------------------------------------*
      *              * Ricerca se il codice numerico prodotto e' pre-  *
      *              * sente nell'ordine                               *
      *              *-------------------------------------------------*
           perform   buf-rig-bol-ocr-000  thru buf-rig-bol-ocr-999    .
       buf-rig-bol-550.
      *              *-------------------------------------------------*
      *              * Ricerca se il codice numerico prodotto e' gia'  *
      *              * stato bufferizzato                              *
      *              *-------------------------------------------------*
           ...
           search    w-buf-rig-bol-ele
                     when    w-buf-rig-bol-num
                            (w-buf-rig-bol-inx)
                                          =    rf-bir-num-pro
                     go to   buf-rig-bol-600.
           go to     buf-rig-bol-700.
       buf-rig-bol-600.
      *              *-------------------------------------------------*
      *              * Upgrade elemento esistente                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento quantita'                        *
      *                  *---------------------------------------------*
           add       rf-bir-qta-ven       to   w-buf-rig-bol-qta
                                              (w-buf-rig-bol-inx)     .
      *                  *---------------------------------------------*
      *                  * A riciclo                                   *
      *                  *---------------------------------------------*
           go to     buf-rig-bol-800.
       buf-rig-bol-700.
      *              *-------------------------------------------------*
      ...
      *                  * Incremento contatore                        *
      *                  *---------------------------------------------*
           if        w-buf-rig-bol-ctr    not  > w-buf-rig-bol-max
                     add  1               to   w-buf-rig-bol-ctr      .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione                             *
      *                  *---------------------------------------------*
           move      rf-bir-num-pro       to   w-buf-rig-bol-num
                                              (w-buf-rig-bol-ctr)     .
           move      rf-bir-qta-ven       to   w-buf-rig-bol-qta
                                              (w-buf-rig-bol-ctr)     .
      *                  *---------------------------------------------*
      *                  * A riciclo                                   *
      *                  *---------------------------------------------*
      ...
      *    * Bufferizzazione righe bolla da trattare                   *
      *    *                                                           *
      *    * Subroutine di ricerca prodotti in bolla non in ordine     *
      *    *-----------------------------------------------------------*
       buf-rig-bol-ocr-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore elementi              *
      *              *-------------------------------------------------*
           move      zero                 to   w-buf-rig-bol-ncb      .
       buf-rig-bol-ocr-100.
      *              *-------------------------------------------------*
      *              * Start su file [ocr]                             *
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-acc-num-prt        to   rf-ocr-num-prt         .
           move      zero                 to   rf-ocr-num-prg         .
           move      "pgm/orc/fls/ioc/obj/iofocr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-ocr-num-prt       not  = w-acc-num-prt
                     go to buf-rig-bol-ocr-900.
       buf-rig-bol-ocr-400.
      *              *-------------------------------------------------*
      *              * Selezione su codice numerico del prodotto       *
      *              *-------------------------------------------------*
           if        rf-ocr-num-pro       =    rf-bir-num-pro
                     go to buf-rig-bol-ocr-500
           else      go to buf-rig-bol-ocr-200.
       buf-rig-bol-ocr-500.
      *              *-------------------------------------------------*
      *              * Incremento contatore                            *
      *              *-------------------------------------------------*
           add       1                    to   w-buf-rig-bol-ncb      .
       buf-rig-bol-ocr-800.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     buf-rig-bol-ocr-200.
       buf-rig-bol-ocr-900.
      *              *-------------------------------------------------*
      *              * Test sul contatore                              *
      *              *-------------------------------------------------*
           if        w-buf-rig-bol-ncb    >    zero
                     go to buf-rig-bol-ocr-999.
       buf-rig-bol-ocr-920.
      *              *-------------------------------------------------*
      *              * Editing quantita'                               *
      *              *-------------------------------------------------*
      ...
      *              * Messaggio di errore                             *
      *              *                                                 *
      *              * N.B.: migliorare con elenco prodotti trovati    *
      *              *-------------------------------------------------*
           move      spaces               to   w-err-box-err-msg      .
      *
      ...
      *                      *                                         *
      *                      * Spostato tra controlli non bloccanti    *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           if        rf-oct-pvf-age       =    w-tes-pvf-age (1)
                     go to cnf-tes-doc-176.
      *                          *-------------------------------------*
      *                          * Messaggio all'operatore             *
      *                          *-------------------------------------*
      ...
      *                      * Test su trattamento provvigioni         *
      *                      *                                         *
      *                      * Spostato da controlli bloccanti         *
      *                      *-----------------------------------------*
           if        rf-oct-fsp-doc       =    w-tes-fsp-doc (1)
                     go to cnf-tes-doc-178.
           move      "Trattamento provvigionale diverso da quello impost
      -              "ato !          "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
       cnf-tes-doc-178.
      *                      *-----------------------------------------*
      *                      * Test su % sconto incondizionato         *
      *                      *-----------------------------------------*
           if        w-pie-per-scc (1)    =    zero
                     go to cnf-tes-doc-180.
           if        rf-oct-per-scc       =    w-pie-per-scc (1)
                     go to cnf-tes-doc-180.
      *                          *-------------------------------------*
      *                          * Messaggio all'operatore             *
      *                          *-------------------------------------*
           move      "Sconto incondizionato ordine diverso da quello gia
      ...
      *                          *-------------------------------------*
           if        w-qss-qta-bol        <    w-qss-qta-dev
                     go to  acc-qta-bol-630.
           move      spaces               to   w-bro-flg-fzs
                                              (w-sdc-ctr-rig)         .
           go to     acc-qta-bol-700.
       acc-qta-bol-630.
      ...
      *                              *---------------------------------*
      *                              * Eventuale contropartita vendite *
      *                              * da testata                      *
      *                              *---------------------------------*
           if        w-tes-ctp-ven (1)    not  = zero and
                     w-tes-ctp-ven (1)    not  = w-rig-ctv-rig (1)
      ...
      *                  *---------------------------------------------*
           move      "AG"                 to   w-edt-qta-inc-ope      .
           move      w-rig-qta-ven (1)    to   w-edt-qta-inc-qta      .
           move      w-rig-dec-qta (1)    to   w-edt-qta-inc-dec      .
           perform   edt-qta-inc-000      thru edt-qta-inc-999        .
           move      w-edt-qta-inc-din    to   w-tes-dec-qta          .
       car-rig-cat-690.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Controllo ed eventuale ricalcolo sconto in chiusura       *
      *    *-----------------------------------------------------------*
       rcl-per-scc-000.
      *              *-------------------------------------------------*
      *              * Test se da eseguire                             *
      ...
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      zero                 to   w-pie-rcl-scc (1)      .
           move      zero                 to   w-rcl-per-scc-rig      .
       rcl-per-scc-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       rcl-per-scc-420.
      *              *-------------------------------------------------*
      *              * Selezione se riga a fronte ordine               *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su protocollo ordine                   *
      *                  *---------------------------------------------*
           if        w-rig-coc-prt (1)    =    zero
                     go to rcl-per-scc-200.
       rcl-per-scc-500.
      *              *-------------------------------------------------*
      *              * Determinazione sconto in chiusura relativo alle *
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-rig-coc-prt (1)    to   rf-oct-num-prt         .
           move      "pgm/orc/fls/ioc/obj/iofoct"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        w-orc-tot-lor        =    zero
                     go to rcl-per-scc-200.
      *                  *---------------------------------------------*
      *                  * Se importo in riga a zero : a riciclo       *
      *                  *---------------------------------------------*
           if        w-rig-imp-rig (1)    =    zero
                     go to rcl-per-scc-200.
      *                  *---------------------------------------------*
      *                  * Se importo in riga pari al totale lordo     *
      *                  * intero ordine : sconto in chiusura pari a   *
      *                  * quello dell'intero ordine                   *
      *                  *---------------------------------------------*
           if        w-rig-imp-rig (1)    =    w-orc-tot-lor
                     move  w-orc-tot-scc  to   w-rcl-per-scc-rig
                     go to rcl-per-scc-600.
      *                  *---------------------------------------------*
      *                  * Calcolo                                     *
      *                  *---------------------------------------------*
           multiply  w-orc-tot-scc        by   w-rig-imp-rig (1)
                                        giving w-eoc-num-s18          .
           divide    w-orc-tot-lor        into w-eoc-num-s18
                                               rounded                .
      *                  *---------------------------------------------*
      ...
      *                  * Aggiornamento sconto in chiusura            *
      *                  *---------------------------------------------*
           move      w-eoc-num-s18        to   w-rcl-per-scc-rig      .
       rcl-per-scc-600.
      *              *-------------------------------------------------*
      *              * Incremento totale                               *
      *              *-------------------------------------------------*
           add       w-rcl-per-scc-rig    to   w-pie-rcl-scc (1)      .
       rcl-per-scc-700.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to wrt-rec-ocr-999.
      *              *-------------------------------------------------*
      *              * Aggiornamento flag di riga chiusa               *
      *              *-------------------------------------------------*
      ...
      *
           if        w-slc-num-oct-cpb    >    w-slc-num-oct-mxp
                     move  w-slc-num-oct-mxp
                                          to   w-slc-num-oct-cpb      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Eventuale vettore alternativo           *
      *                      *-----------------------------------------*
           if        rf-oct-cod-vet       not  numeric
                     move  zero           to   rf-oct-cod-vet         .
      *                      *-----------------------------------------*
      *                      * Vettore alternativo da ordine           *
      *                      *-----------------------------------------*
           if        rf-oct-cod-vet       not  = zero
                     move  rf-oct-cod-vet to   w-pie-vet-aac (1)
           else      move  rf-dcc-cod-vet to   w-pie-vet-aac (1)      .
      *                      *-----------------------------------------*
      *                      * Lettura                                 *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       det-vlt-dcc-100.
      *                  *---------------------------------------------*
      *                  * Preparazione del default per il trasporto a *
      *                  * cura                                        *
      *                  *---------------------------------------------*
           if        w-pie-tra-cur (1)    not  = zero
                     go to det-vlt-dcc-900.
           if        rf-dcc-dtt-acu       =    01
                     go to det-vlt-dcc-900.
           if        rf-dcc-dtt-acu       =    10 or
                     ...
                     rf-dcc-dtt-acu       =    14
                     move  10             to   w-pie-tra-cur (1)
           else if   rf-dcc-dtt-acu       =    20
                     move  20             to   w-pie-tra-cur (1)
           else if   rf-dcc-dtt-acu       =    30 or
                     rf-dcc-dtt-acu       =    31 or
                     rf-dcc-dtt-acu       =    32 or
                     rf-dcc-dtt-acu       =    33 or
                     rf-dcc-dtt-acu       =    34
                     move  30             to   w-pie-tra-cur (1)
           else      move  zero           to   w-pie-tra-cur (1)      .
       det-vlt-dcc-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     det-vlt-dcc-999.
       det-vlt-dcc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-pie-cod-vet (1)    not  = zero or
                     ...
                     go to det-vlp-vet-999.
      *              *-------------------------------------------------*
      *              * Se dipendenza esistente : si assumono quelli    *
      *              * della dipendenza, purche' i relativi codici     *
      *              * vettore non siano zero                          *
      *              *-------------------------------------------------*
           if        w-tes-dpz-arc (1)    =    spaces
      ...
      *                  *---------------------------------------------*
      *                  * Test su codice utente se previsto da ap-    *
      *                  * posita personalizzazione                    *
      *                  *---------------------------------------------*
           if        w-prs-snx-buf-doc    =    "N"
                     go to buf-doc-mvm-405.
      ...
      *
           if        w-prs-snx-buf-doc    =    "N"
                     move "TUTTI"         to   w-all-str-cat (2)
           else      move w-buf-doc-mvm-ute
                                          to   w-all-str-cat (2)      .
      *
