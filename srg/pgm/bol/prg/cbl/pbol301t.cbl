      ...
      *                       Ultima revisione:    NdK del 27/09/23    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Ricerca documenti intestati ad un agente    *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su [bit] per agente                       *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DPZARCDAT "         to   f-key                  .
           move      rr-dpz-inu           to   rf-bit-cod-dpz         .
           move      "A"                  to   rf-bit-tip-arc         .
           move      rr-cod-age           to   rf-bit-cod-arc         .
      ...
      *              *-------------------------------------------------*
           if        rf-bit-tip-arc       not  = "A"
                     go to qry-tst-max-900.
           if        rf-bit-cod-arc       not  = rr-cod-age
                     go to qry-tst-max-900.
       qry-tst-max-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Sottolineatura fincatura agente             *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      80                   to   v-car                  .
