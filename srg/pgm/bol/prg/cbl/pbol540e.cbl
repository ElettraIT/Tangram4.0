      ...
      *                  *---------------------------------------------*
           move      rf-dbe-num-dst       to   srt-num-dst            .
           move      rf-dbe-num-prg       to   srt-num-prg            .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Cancellazione record [dbe]                                *
      *    *-----------------------------------------------------------*
       del-rec-dst-000.
      *              *-------------------------------------------------*
      *              * Composizione chiave primaria                    *
      *              *-------------------------------------------------*
           move      srt-num-dst          to   rf-dbe-num-dst         .
           move      srt-num-prg          to   rf-dbe-num-prg         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
