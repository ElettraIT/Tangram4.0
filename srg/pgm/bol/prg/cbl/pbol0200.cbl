      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella causali del trasporto      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-ctr          pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-ctr          pic  x(20)                  .
      ...
      *                  * Codice causale                              *
      *                  *---------------------------------------------*
           perform   acc-cod-ctr-000      thru acc-cod-ctr-999        .
      ...
      *              * Codice causale                                  *
      *              *-------------------------------------------------*
           perform   vis-cod-ctr-000      thru vis-cod-ctr-999        .
       vis-key-reg-999.
           exit.
      ...
      *              * Codice causale                                  *
      *              *-------------------------------------------------*
           perform   pmt-cod-ctr-000      thru pmt-cod-ctr-999        .
      *              *-------------------------------------------------*
      *              * Linea di trattini                               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-ctr        to   w-cod-des-zct-cod      .
           move      04                   to   w-cod-des-zct-lin      .
           move      30                   to   w-cod-des-zct-pos      .
           move      07                   to   w-cod-des-zct-dln      .
           move      30                   to   w-cod-des-zct-dps      .
       ...
       acc-cod-ctr-110.
           ...
           if        w-cod-des-zct-ope    =    "F+"
                     go to acc-cod-ctr-115.
           if        w-cod-des-zct-ope    =    "AC"
                     go to acc-cod-ctr-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-ctr-115.
           perform   cod-des-zct-foi-000  thru cod-des-zct-foi-999    .
           go to     acc-cod-ctr-110.
       acc-cod-ctr-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-ctr-999.
       acc-cod-ctr-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-cod-ctr          .
       acc-cod-ctr-400.
      *              *-------------------------------------------------*
      ...
      *                  * Descrizione causale                         *
      *                  *---------------------------------------------*
           perform   acc-des-ctr-000      thru acc-des-ctr-999        .
           if        v-key                =    "NXSC"
      ...
      *              * Descrizione causale                             *
      *              *-------------------------------------------------*
           perform   vis-des-ctr-000      thru vis-des-ctr-999        .
           go to     vis-tes-reg-999.
       vis-tes-reg-999.
           exit.
      ...
      *              * Descrizione causale                             *
      *              *-------------------------------------------------*
           perform   pmt-des-ctr-000      thru pmt-des-ctr-999        .
           go to     pmt-tes-reg-999.
       pmt-tes-reg-999.
           exit.
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-ctr (1)    =    spaces
                     go to acc-des-ctr-100.
      *                  *---------------------------------------------*
      ...
      *                  * l'ordinamento                               *
      *                  *---------------------------------------------*
           move      w-tes-des-ctr (1)    to   w-all-str-alf          .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-ctr (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-ctr        to   rf-zct-cod-ctr         .
           move      "pgm/bol/fls/ioc/obj/iofzct"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zct]                        *
      *                          *-------------------------------------*
           move      rf-zct-des-ctr       to   w-tes-des-ctr (1)      .
           move      rf-zct-des-key       to   w-tes-des-key (1)      .
           move      rf-zct-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zct]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zct-000      thru wrt-rec-zct-999        .
      ...
      *                      * Rewrite record [zct]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zct-000      thru rew-rec-zct-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zct]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zct-000      thru del-rec-zct-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zct]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zct-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-ctr (1)    to   rf-zct-des-ctr         .
           move      w-tes-des-key (1)    to   rf-zct-des-key         .
           move      w-tes-alx-exp (1)    to   rf-zct-alx-exp         .
       cmp-rec-zct-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zct]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zct-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zct-000      thru cmp-rec-zct-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
