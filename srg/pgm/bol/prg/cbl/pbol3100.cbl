      ...
      *                       Ultima revisione:    NdK del 10/10/10    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase bol310, nella sua globalita', esegue i tipi di stampa  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * STADIC      Stampa documenti intestati ad un cliente           *
      *                                                                *
      * STADIF      Stampa documenti intestati ad un fornitore         *
      *                                                                *
      * STADID      Stampa documenti intestati ad una dipendenza       *
      *                                                                *
      * STADAG      Stampa documenti per agente                        *
      *                                                                *
      * STADTM      Stampa documenti per tipo movimento                *
      *                                                                *
      * STADNU      Stampa documenti per numero                        *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'bol310'           *
      *              *-------------------------------------------------*
           perform   fas-bol-310-000      thru fas-bol-310-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-bol-310-300
           else if   v-key                =    "PRSC"
                     go to fas-bol-310-400
           else if   v-key                =    "NXSC"
                     go to fas-bol-310-450
           else if   v-key                =    "DOWN"
                     go to fas-bol-310-500
           else if   v-key                =    "EXIT"
                     go to fas-bol-310-250
           else      go to fas-bol-310-200.
       fas-bol-310-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-bol-310-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-bol-310-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-bol-310-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-bol-310-350
           else      go to fas-bol-310-322.
       fas-bol-310-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-bol-310-630
           else if   v-key                =    "PRSC"
                     go to fas-bol-310-600
           else if   v-key                =    "NXSC"
                     go to fas-bol-310-610
           else if   v-key                =    "UP  "
                     go to fas-bol-310-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-bol-310-650
           else if   v-key                =    "EXIT"
                     go to fas-bol-310-660
           else      go to fas-bol-310-570.
       fas-bol-310-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-bol-310-626
           else      go to fas-bol-310-628.
       fas-bol-310-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-bol-310-636
           else      go to fas-bol-310-638.
       fas-bol-310-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-bol-310-725
           else      go to fas-bol-310-750.
       fas-bol-310-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
