      ...
      *                       Ultima revisione:    NdK del 25/11/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione archivio vettori                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               ...
               10  w-tes-via-vet          pic  x(40)                  .
               10  w-tes-loc-vet          pic  x(40)                  .
      ...
      *            *---------------------------------------------------*
               ...
               10  w-tes-tip-vet          pic  x(01)                  .
               10  w-tes-trg-aut          pic  x(09)                  .
               10  w-tes-alx-exp.
                   15  filler  occurs 70  pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-prs.
      *        *-------------------------------------------------------*
      *        * Personalizzazioni relative al record vettore          *
      *        *-------------------------------------------------------*
           05  w-prs-rec-vet.
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-vet.
               10  w-exp-tip-vet-num      pic  9(02)       value 3    .
               10  w-exp-tip-vet-lun      pic  9(02)       value 30   .
               10  w-exp-tip-vet-tbl.
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Si/No stampa copia bolla                   *
      *        *-------------------------------------------------------*
           05  w-exp-snx-scp.
               10  w-exp-snx-scp-num      pic  9(02)       value 2    .
               10  w-exp-snx-scp-lun      pic  9(02)       value 02   .
               10  w-exp-snx-scp-tbl.
      ...
      *        *-------------------------------------------------------*
           05  w-enc-vet-val-max          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Valore pre incremento                                 *
      *        *-------------------------------------------------------*
           05  w-enc-vet-val-pre          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Valore post incremento                                *
      *        *-------------------------------------------------------*
           05  w-enc-vet-val-pos          pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/bol[rec-vet]"   to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-prs-rec-vet
           else      move  spaces         to   w-prs-rec-vet          .
           if        w-prs-rec-vet-mco    not  numeric
                     move  zero           to   w-prs-rec-vet-mco      .
           if        w-prs-rec-vet-mco    =    zero
                     move  9999999        to   w-prs-rec-vet-mco      .
           if        w-prs-rec-vet-fco    not  = "A"
                     move  "M"            to   w-prs-rec-vet-fco      .
           if        w-prs-rec-vet-omn    not  = "O"
                     move  "N"            to   w-prs-rec-vet-omn      .
           if        w-prs-rec-vet-umn    not  = "U"
                     move  "N"            to   w-prs-rec-vet-umn      .
           if        w-prs-rec-vet-mmn    not  = "N"
                     move  "M"            to   w-prs-rec-vet-mmn      .
           if        w-prs-rec-vet-osc    not  = "N"
                     move  "N"            to   w-prs-rec-vet-osc      .
           if        w-prs-rec-vet-msc    not  = "N"
                     move  "M"            to   w-prs-rec-vet-msc      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      08                   to   w-cod-mne-vet-rln      .
           move      30                   to   w-cod-mne-vet-rps      .
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-vet        =    zero
                     go to acc-cod-vet-410
           else      go to acc-cod-vet-450.
       acc-cod-vet-410.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-prs-rec-vet-fco    not  = "A"
                     go to acc-cod-vet-415
           else      go to acc-cod-vet-420.
       acc-cod-vet-415.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-prs-rec-vet-mco    =    zero or
                     w-prs-rec-vet-mco    =    9999999
                     go to acc-cod-vet-600.
      *                      *-----------------------------------------*
      ...
      *                      * trollo e' superato                      *
      *                      *-----------------------------------------*
           if        w-tes-cod-vet        not  > w-prs-rec-vet-mco
                     go to acc-cod-vet-600.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      13                   to   v-lin                  .
           move      12                   to   v-pos                  .
           move      "Il codice vettore non puo' essere superiore a"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      58                   to   v-pos                  .
           move      "<"                  to   v-edm                  .
           move      w-prs-rec-vet-mco    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Tipo di vettore                             *
      *                  *---------------------------------------------*
           perform   acc-tip-vet-000      thru acc-tip-vet-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  *---------------------------------------------*
       ...
       acc-tes-reg-115.
      *                  *---------------------------------------------*
      *                  * A fine pagina se vettore interno            *
      *                  *---------------------------------------------*
           if        w-tes-tip-vet (1)    not  = "C"
                     go to acc-tes-reg-190.
       acc-tes-reg-120.
      *                  *---------------------------------------------*
      *                  * Indirizzo                                   *
      *                  *---------------------------------------------*
           perform   acc-via-vet-000      thru acc-via-vet-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  * C.a.p. e citta'                             *
      *                  *---------------------------------------------*
           perform   acc-loc-vet-000      thru acc-loc-vet-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  * Targa automezzo                             *
      *                  *---------------------------------------------*
           perform   acc-trg-aut-000      thru acc-trg-aut-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  * Si/no stampa copia bolla                    *
      *                  *---------------------------------------------*
           perform   acc-snx-scp-000      thru acc-snx-scp-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  * Nr. iscrizione                              *
      *                  *---------------------------------------------*
           perform   acc-num-isc-000      thru acc-num-isc-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Tipo di vettore                                 *
      *              *-------------------------------------------------*
           perform   vis-tip-vet-000      thru vis-tip-vet-999        .
      *              *-------------------------------------------------*
      *              * Ragione sociale                                 *
      *              *-------------------------------------------------*
      ...
      *              * Indirizzo                                       *
      *              *-------------------------------------------------*
           perform   vis-via-vet-000      thru vis-via-vet-999        .
      *              *-------------------------------------------------*
      *              * C.a.p. e citta'                                 *
      *              *-------------------------------------------------*
           perform   vis-loc-vet-000      thru vis-loc-vet-999        .
      *              *-------------------------------------------------*
      *              * Codice comune                                   *
      *              *-------------------------------------------------*
      ...
      *              * Targa automezzo                                 *
      *              *-------------------------------------------------*
           perform   vis-trg-aut-000      thru vis-trg-aut-999        .
      *              *-------------------------------------------------*
      *              * Si/no stampa copia bolla                        *
      *              *-------------------------------------------------*
           perform   vis-snx-scp-000      thru vis-snx-scp-999        .
      *              *-------------------------------------------------*
      *              * Nr. iscrizione                                  *
      *              *-------------------------------------------------*
           perform   vis-num-isc-000      thru vis-num-isc-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     vis-tes-reg-999.
      ...
      *              * Tipo di vettore                                 *
      *              *-------------------------------------------------*
           perform   pmt-tip-vet-000      thru pmt-tip-vet-999        .
      *              *-------------------------------------------------*
      *              * Ragione sociale                                 *
      *              *-------------------------------------------------*
           perform   pmt-rag-vet-000      thru pmt-rag-vet-999        .
      *              *-------------------------------------------------*
      *              * Indirizzo                                       *
      *              *-------------------------------------------------*
           perform   pmt-via-vet-000      thru pmt-via-vet-999        .
      *              *-------------------------------------------------*
      *              * C.a.p. e citta'                                 *
      *              *-------------------------------------------------*
           perform   pmt-loc-vet-000      thru pmt-loc-vet-999        .
      *              *-------------------------------------------------*
      *              * Codice comune                                   *
      *              *-------------------------------------------------*
      ...
      *              * Targa automezzo                                 *
      *              *-------------------------------------------------*
           perform   pmt-trg-aut-000      thru pmt-trg-aut-999        .
      *              *-------------------------------------------------*
      *              * Si/no stampa copia bolla                        *
      *              *-------------------------------------------------*
           perform   pmt-snx-scp-000      thru pmt-snx-scp-999        .
      *              *-------------------------------------------------*
      *              * Nr. iscrizione                                  *
      *              *-------------------------------------------------*
           perform   pmt-num-isc-000      thru pmt-num-isc-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     pmt-tes-reg-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Tipo di vettore                  *
      *    *-----------------------------------------------------------*
       pmt-tip-vet-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Targa automezzo                  *
      *    *-----------------------------------------------------------*
       pmt-trg-aut-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no stampa copia bolla         *
      *    *-----------------------------------------------------------*
       pmt-snx-scp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Nr. iscrizione                   *
      *    *-----------------------------------------------------------*
       pmt-num-isc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Tipo di vettore              *
      *    *-----------------------------------------------------------*
       acc-tip-vet-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tip-vet-lun    to   v-car                  .
           move      w-exp-tip-vet-num    to   v-ldt                  .
           move      "CIV#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      08                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-tip-vet-tbl    to   v-txt                  .
           if        w-tes-tip-vet (1)    =    "C"
                     move  01             to   v-num
           else if   w-tes-tip-vet (1)    =    "I"
                     move  02             to   v-num
           else if   w-tes-tip-vet (1)    =    "V"
                     move  03             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "C"            to   w-tes-tip-vet (1)
           else if   v-num                =    02
                     move  "I"            to   w-tes-tip-vet (1)
           else if   v-num                =    03
                     move  "V"            to   w-tes-tip-vet (1)
           else      move  zero           to   w-tes-tip-vet (1)      .
       acc-tip-vet-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-tip-vet (1)    not  = spaces
                     go to acc-tip-vet-600.
           if        v-key                =    "UP  "
                     go to acc-tip-vet-600
           else      go to acc-tip-vet-100.
       acc-tip-vet-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-tip-vet-100.
       acc-tip-vet-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Tipo di vettore           *
      *    *-----------------------------------------------------------*
       vis-tip-vet-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-via-vet (1)    to   w-ind-cec-geo-ind      .
           move      11                   to   w-ind-cec-geo-lin      .
           move      30                   to   w-ind-cec-geo-pos      .
           move      w-tes-loc-vet (1)    to   w-ind-cec-geo-cec      .
       ...
       acc-via-vet-110.
           ...
           if        w-ind-cec-geo-ope    =    "F+"
                     go to acc-via-vet-115.
           if        w-ind-cec-geo-ope    =    "AC"
                     go to acc-via-vet-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-via-vet-115.
           perform   ind-cec-geo-foi-000  thru ind-cec-geo-foi-999    .
           go to     acc-via-vet-110.
       acc-via-vet-120.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-ind-cec-geo-ind    to   w-tes-via-vet (1)      .
      *              *-------------------------------------------------*
      *              * Altri valori se automatismo eseguito            *
      *              *-------------------------------------------------*
           if        w-ind-cec-geo-aut    =    spaces
                     go to acc-via-vet-400.
      *                  *---------------------------------------------*
      *                  * C.a.p. e citta'                             *
      *                  *---------------------------------------------*
           move      w-ind-cec-geo-cec    to   w-tes-loc-vet (1)      .
           perform   vis-loc-vet-000      thru vis-loc-vet-999        .
      *                  *---------------------------------------------*
      *                  * Comune                                      *
      *                  *---------------------------------------------*
      ...
      *                  * non deve essere a spaces                    *
      *                  *---------------------------------------------*
           if        w-tes-via-vet (1)    =    spaces
                     go to acc-via-vet-600.
      *
           if        w-tes-via-vet (1)
                    (01 : 01)             =    spaces
                     go to acc-via-vet-100.
       acc-via-vet-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-loc-vet (1)    to   w-cap-cit-geo-cec      .
       ...
       acc-loc-vet-110.
           ...
           if        w-cap-cit-geo-ope    =    "F+"
                     go to acc-loc-vet-115.
           if        w-cap-cit-geo-ope    =    "AC"
                     go to acc-loc-vet-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-loc-vet-115.
           perform   cap-cit-geo-foi-000  thru cap-cit-geo-foi-999    .
           go to     acc-loc-vet-110.
       acc-loc-vet-120.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cap-cit-geo-cec    to   w-tes-loc-vet (1)      .
      *              *-------------------------------------------------*
      *              * Altri valori se automatismo eseguito            *
      *              *-------------------------------------------------*
           if        w-cap-cit-geo-aut    =    spaces
                     go to acc-loc-vet-400.
       acc-loc-vet-300.
      *                  *---------------------------------------------*
      ...
      *                  * non deve essere a spaces                    *
      *                  *---------------------------------------------*
           if        w-tes-loc-vet (1)    =    spaces
                     go to acc-loc-vet-600.
      *
           if        w-tes-loc-vet (1)
                    (01 : 01)             =    spaces
                     go to acc-loc-vet-100.
       acc-loc-vet-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se il vettore e' estero non si esegue il    *
      *                  * controllo                                   *
      *                  *---------------------------------------------*
           if        w-tes-cod-naz (1)    not  = "IT "
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Targa automezzo              *
      *    *-----------------------------------------------------------*
       acc-trg-aut-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-trg-aut-100.
       acc-trg-aut-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Targa automezzo           *
      *    *-----------------------------------------------------------*
       vis-trg-aut-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no stampa copia bolla             *
      *    *-----------------------------------------------------------*
       acc-snx-scp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-scp-lun    to   v-car                  .
           move      w-exp-snx-scp-num    to   v-ldt                  .
           move      "SN#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      20                   to   v-lin                  .
           move      61                   to   v-pos                  .
           move      w-exp-snx-scp-tbl    to   v-txt                  .
      *
           if        w-tes-num-fax (1)    =    spaces
                     move  01             to   v-num
           else if   w-tes-num-fax (1)    =    "S"
                     move  01             to   v-num
           else if   w-tes-num-fax (1)    =    "N"
                     move  02             to   v-num
           else      move  zero           to   v-num                  .
      *
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "S"            to   w-tes-num-fax (1)
           else      move  "N"            to   w-tes-num-fax (1)      .
       acc-snx-scp-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-snx-scp-100.
       acc-snx-scp-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Si/no stampa copia bolla          *
      *    *-----------------------------------------------------------*
       vis-snx-scp-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Nr. iscrizione               *
      *    *-----------------------------------------------------------*
       acc-num-isc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-num-isc-100.
       acc-num-isc-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Nr. iscrizione            *
      *    *-----------------------------------------------------------*
       vis-num-isc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-nok-205.
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-tes-cod-mne (1)    to   rf-vet-cod-mne         .
       ...
       cnt-tdo-nok-210.
           ...
           if        f-sts                not  = e-not-err
                     go to cnt-tdo-nok-250.
           if        rf-vet-cod-mne       not  = w-tes-cod-mne (1)
                     go to cnt-tdo-nok-250.
           if        rf-vet-cod-vet       =    w-tes-cod-vet
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           ...
           move      spaces               to   w-tes-cod-vet-aut      .
       nor-key-reg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           ...
           move      spaces               to   w-tes-via-vet (1)      .
           move      spaces               to   w-tes-loc-vet (1)      .
           ...
           move      spaces               to   w-tes-tip-vet (1)      .
           move      spaces               to   w-tes-trg-aut (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-vet        to   rf-vet-cod-vet         .
           move      "pgm/bol/fls/ioc/obj/iofvet"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-vet-ide-dat       to   w-tes-ide-dat (1)      .
           move      rf-vet-ide-ute       to   w-tes-ide-ute (1)      .
           move      rf-vet-ide-fas       to   w-tes-ide-fas (1)      .
           move      rf-vet-cod-mne       to   w-tes-cod-mne (1)      .
           move      rf-vet-rag-key       to   w-tes-rag-key (1)      .
           move      rf-vet-rag-soc       to   w-tes-rag-soc (1)      .
           move      rf-vet-via-vet       to   w-tes-via-vet (1)      .
           move      rf-vet-loc-vet       to   w-tes-loc-vet (1)      .
           move      rf-vet-cod-naz       to   w-tes-cod-naz (1)      .
           move      rf-vet-cod-cmn       to   w-tes-cod-cmn (1)      .
           move      rf-vet-cod-fzn       to   w-tes-cod-fzn (1)      .
           move      rf-vet-cod-lct       to   w-tes-cod-lct (1)      .
           move      rf-vet-num-tel       to   w-tes-num-tel (1)      .
           move      rf-vet-num-fax       to   w-tes-num-fax (1)      .
           move      rf-vet-num-tlx       to   w-tes-num-tlx (1)      .
           move      rf-vet-nom-int       to   w-tes-nom-int (1)      .
           move      rf-vet-prt-iva       to   w-tes-prt-iva (1)      .
           move      rf-vet-cod-fis       to   w-tes-cod-fis (1)      .
           move      rf-vet-tip-vet       to   w-tes-tip-vet (1)      .
           move      rf-vet-trg-aut       to   w-tes-trg-aut (1)      .
           move      rf-vet-alx-exp       to   w-tes-alx-exp (1)      .
       rou-let-reg-200.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-vet        to   d-con-arc-cod-arc      .
      ...
      *                      * Write record [vet]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-vet-000      thru wrt-rec-vet-999        .
      *                      *-----------------------------------------*
      *                      * Write record [adc]                      *
      *                      *-----------------------------------------*
      ...
      *                      * Rewrite record [vet]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-vet-000      thru rew-rec-vet-999        .
      *                      *-----------------------------------------*
      *                      * Rewrite record [adc]                    *
      *                      *-----------------------------------------*
      ...
      *              * Delete record [vet]                             *
      *              *-------------------------------------------------*
           perform   del-rec-vet-000      thru del-rec-vet-999        .
      *              *-------------------------------------------------*
      *              * Delete record [adc]                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-vet-ide-dat         .
           move      s-ute                to   rf-vet-ide-ute         .
           move      s-fas                to   rf-vet-ide-fas         .
           move      w-tes-cod-mne (1)    to   rf-vet-cod-mne         .
           move      w-tes-rag-key (1)    to   rf-vet-rag-key         .
           move      w-tes-rag-soc (1)    to   rf-vet-rag-soc         .
           move      w-tes-via-vet (1)    to   rf-vet-via-vet         .
           move      w-tes-loc-vet (1)    to   rf-vet-loc-vet         .
           move      w-tes-cod-naz (1)    to   rf-vet-cod-naz         .
           move      w-tes-cod-cmn (1)    to   rf-vet-cod-cmn         .
           move      w-tes-cod-fzn (1)    to   rf-vet-cod-fzn         .
           move      w-tes-cod-lct (1)    to   rf-vet-cod-lct         .
           move      w-tes-num-tel (1)    to   rf-vet-num-tel         .
           move      w-tes-num-fax (1)    to   rf-vet-num-fax         .
           move      w-tes-num-tlx (1)    to   rf-vet-num-tlx         .
           move      w-tes-nom-int (1)    to   rf-vet-nom-int         .
           move      w-tes-prt-iva (1)    to   rf-vet-prt-iva         .
           move      w-tes-cod-fis (1)    to   rf-vet-cod-fis         .
           move      w-tes-tip-vet (1)    to   rf-vet-tip-vet         .
           move      w-tes-trg-aut (1)    to   rf-vet-trg-aut         .
           move      w-tes-alx-exp (1)    to   rf-vet-alx-exp         .
       cmp-rec-vet-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [vet]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-vet-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-vet-000      thru cmp-rec-vet-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      41                   to   rf-adc-tip-arc         .
           move      w-tes-cod-vet        to   rf-adc-cod-arc         .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [vet]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "vet "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           move      s-num                to   w-enc-vet-val-pre      .
      *                  *---------------------------------------------*
      *                  * Incremento del valore                       *
      *                  *---------------------------------------------*
           move      w-enc-vet-val-pre    to   w-enc-vet-val-pos      .
           add       1                    to   w-enc-vet-val-pos      .
       att-cod-aut-500.
      *                  *---------------------------------------------*
      *                  * Se l'incremento porta a zero si forza il    *
      *                  * valore a 1                                  *
      *                  *---------------------------------------------*
           if        w-enc-vet-val-pos    =    zero
                     move  1              to   w-enc-vet-val-pos      .
      *                  *---------------------------------------------*
      *                  * Se raggiunto il massimo valore impostabile  *
      *                  * si ricicla da 1                             *
      *                  *---------------------------------------------*
           if        w-enc-vet-val-pos    >    w-enc-vet-val-max
                     move  1              to   w-enc-vet-val-pos      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODVET    "         to   f-key                  .
           move      w-enc-vet-val-pos    to   rf-vet-cod-vet         .
           move      "pgm/bol/fls/ioc/obj/iofvet"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      "Eu"                 to   s-ope                  .
           move      "vet "               to   s-nam                  .
           move      w-enc-vet-val-pos    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "Eu"                 to   s-ope                  .
           move      "vet "               to   s-nam                  .
           move      w-enc-vet-val-pre    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                      *-----------------------------------------*
      *                      * Se errori ripete l'intera operazione di *
