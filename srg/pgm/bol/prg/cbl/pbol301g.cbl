      ...
      *                                                                *
      *                    Ricerca documenti per semilavorati          *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
      *              * Visualizzazione codice semilavorato, descr.     *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-alf-pro           to   w-let-arc-dps-alf      .
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su [bir] per semilavorato                 *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "MAGDAT    "         to   f-key                  .
           move      rr-dpz-inu           to   rf-bir-cod-dpz         .
           move      02                   to   rf-bir-tip-mag         .
           move      rr-cod-sem           to   rf-bir-num-pro         .
      ...
      *              *-------------------------------------------------*
           if        rf-bir-tip-mag       not  = 02
                     go to qry-tst-max-900.
           if        rf-bir-num-pro       not  = rr-cod-sem
                     go to qry-tst-max-900.
       qry-tst-max-200.
      *              *-------------------------------------------------*
