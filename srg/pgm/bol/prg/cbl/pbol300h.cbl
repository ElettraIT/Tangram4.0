      ...
      *                                                                *
      *                    Richiamata in bol300 da funzione 'PF2'      *
      *                                                                *
      *                    ___ IN DISUSO ___                           *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se la personalizzazione lo precede *
      *                      *-----------------------------------------*
           if        w-prs-ttd-sts-dcp    =    "N"
                     go to acc-cod-dcp-600.
      *                      *-----------------------------------------*
      *                      * Se status normale : ad uscita           *
      *                      *-----------------------------------------*
           if        w-let-dcp-pdx-tus    =    01
                     go to acc-cod-dcp-600.
      *                      *-----------------------------------------*
      *                      * Se status non normale : box specifico   *
      *                      * per lo status commerciale               *
      *                      *-----------------------------------------*
           perform   acc-cod-dcp-bsp-000  thru acc-cod-dcp-bsp-999    .
      *                      *-----------------------------------------*
      *                      * Tipo di uscita a seconda della persona- *
      *                      * lizzazione                              *
      *                      *-----------------------------------------*
           if        w-prs-ttd-sts-dcp    =    "B"
                     go to acc-cod-dcp-100
           else      go to acc-cod-dcp-600.
       acc-cod-dcp-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Si trattano i campi seguenti solo se il     *
      *                  * documento interessa la fatturazione         *
      *                  *---------------------------------------------*
           if        w-tes-int-ftr        =    01
                     go to acc-cod-dcp-780.
      *                  *---------------------------------------------*
      *                  * Decimali prezzo                             *
      *                  *---------------------------------------------*
           move      w-let-dcp-pdx-dep    to   w-brb-dec-prz
                                              (w-sdc-ctr-rig)         .
      *                  *---------------------------------------------*
      *                  * Sigla valuta per il prezzo di vendita       *
      *                  *---------------------------------------------*
       acc-cod-dcp-662.
      *                  *---------------------------------------------*
      *                  * Prezzo di vendita                           *
      ...
      *                          *-------------------------------------*
           ...
           if        w-tes-tip-frn (1)    =    11
                     move  w-tes-cod-arc (1)
                                          ...
                                          to   d-prz-ven-cod-cli      .
           move      w-rig-sgl-vpp (1)    to   d-prz-ven-sgl-vpp      .
           move      w-rig-dec-vpp (1)    to   d-prz-ven-dec-vpp      .
      ...
      *                          *-------------------------------------*
           move      d-prz-ven-prz-ven    to   w-brb-prz-uni
                                              (w-sdc-ctr-rig)         .
      *                      *-----------------------------------------*
      *                      * Eventuale applicazione del legame valu- *
      *                      * tario                                   *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Prezzo di vendita pari a quello per *
      *                          * accettazione                        *
      *                          *-------------------------------------*
           move      w-rig-prz-acc (1)    to   w-rig-prz-ven (1)      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if       (w-tes-int-ftr        =    02 and
                    ...
                    (w-tes-int-ftr        =    03   )
                     go to acc-cod-dcp-663
           else      go to acc-cod-dcp-664.
       acc-cod-dcp-663.
      *                          *-------------------------------------*
      *                          * Parametri in input                  *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
       ...
       acc-cod-dcp-664.
      *                  *---------------------------------------------*
      *                  * Sigla valuta per i prezzi standard          *
      *                  *---------------------------------------------*
       acc-cod-dcp-666.
      *                  *---------------------------------------------*
