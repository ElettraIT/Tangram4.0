      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Duplicazione righe da altra bolla           *
      *                                                                *
      *                    Richiamata in bol300 da funzione 'PF3'      *
      *                                                                *
      *================================================================*
      *                                                                *
      * Tipi operazione                                                *
      ...
      *                                                                *
      *        Input  : l-dup-rdb-tip-ope = "OP"                       *
      *                 l-dup-rdb-cod-dpz = codice dipendenza in uso   *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      * "CL" - Close, fine utilizzo                                    *
      *                                                                *
      *        Input  : l-dup-rdb-tip-ope = "CL"                       *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      * "C?" - Test se modulo cancellabile                             *
      *                                                                *
      *        Input  : l-dup-rdb-tip-ope = "C?"                       *
      *                                                                *
      *        Output : l-dup-rdb-exi-sts = spaces: Si                 *
      *                                     #     : No                 *
      *                                                                *
      * "RB" - Accettazione dati identificativi bolla                  *
      *                                                                *
      *        Input  : l-dup-rdb-tip-ope = "RB"                       *
      *                 l-dup-rdb-cod-tmb = codice tipo movimento bol- *
      *                                     la da proporre come de-    *
      *                                     fault                      *
      *                                                                *
      *        Output : l-dup-rdb-exi-sts = spaces: Accettazione ese-  *
      *                                             guita con successo *
      *                                     #     : Uscita per Exit    *
      *                                                                *
      * "SC" - Saldaconto per selezione righe                          *
      *                                                                *
      *        Input  : l-dup-rdb-tip-ope = "SC"                       *
      *                                                                *
      *        Output : l-dup-rdb-exi-sts = spaces: Tutto Ok           *
      *                                     #     : Uscita per Exit    *
      *                                                                *
      * "CC" - Caricamento righe bolla selezionate in catena           *
      *                                                                *
      *        Input  : l-dup-rdb-tip-ope = "CC"                       *
      *                                                                *
      *        Output : nessuno                                        *
      *                                                                *
      *================================================================*
      ...
      *        * Tipo operazione                                       *
      *        *-------------------------------------------------------*
           05  l-dup-rdb-tip-ope          pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Return status code                                    *
      *        * - Spaces : operazione eseguita                        *
      *        * - #      : errore di esecuzione                       *
      *        *-------------------------------------------------------*
           05  l-dup-rdb-exi-sts          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Codice dipendenza in uso                              *
      *        *-------------------------------------------------------*
           05  l-dup-rdb-cod-dpz          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Default per codice tipo movimento bolla               *
      *        *-------------------------------------------------------*
           05  l-dup-rdb-cod-tmb          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Flag di trattamento bolla                             *
      *        *-------------------------------------------------------*
           05  l-dup-rdb-flg-bol          pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      ******************************************************************
       Procedure Division                using l-dup-rdb
                                               w-prs
                                               w-tes
                                               w-pie
                                               w-rig
      ...
      *              *-------------------------------------------------*
           move      spaces               to   l-dup-rdb-exi-sts      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      l-dup-rdb-cod-dpz    to   w-acc-cod-dpz          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-gen-ctr-opn        =    zero
                     move  spaces         to   l-dup-rdb-exi-sts
           else      move  "#"            to   l-dup-rdb-exi-sts      .
       tst-cnc-mod-999.
           exit.
      ...
      *              * mento bolla                                     *
      *              *-------------------------------------------------*
           move      l-dup-rdb-cod-tmb    to   w-acc-cod-tmb          .
      ...
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
           move      "Nessuna riga bolla da duplicare !                 
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                      *-----------------------------------------*
      *                      * A reimpostazione                        *
      ...
      *                  *---------------------------------------------*
           move      w-acc-cod-tmb        to   l-dup-rdb-cod-tmb      .
       acc-cod-tmb-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-buf-rig-bol-wtp    =    "A"     or
                    ...
                    (w-buf-rig-bol-wtp    =    "P" and
                     ...
                     w-buf-rig-bol-wtf    =    " "
                     go to buf-rig-bol-340
           else      go to buf-rig-bol-320.
       buf-rig-bol-320.
      *                      *-----------------------------------------*
      *                      * Se tipo riga 'A', 'C', 'PN', 'M' o 'S'  *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rf-bir-des-ext       =    0
                     go to buf-rig-bol-322
           else if   rf-bir-des-ext       =    1
                     go to buf-rig-bol-324
           else if   rf-bir-des-ext       =    2
                     go to buf-rig-bol-326.
       buf-rig-bol-322.
      ...
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Se non richiesto il ricalcolo   *
      *                              * della descrizione               *
      *                              *---------------------------------*
           if        w-acc-tip-rcl-des    =    spaces
                     go to car-rig-cat-371.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           if        w-coe-cmb-vlt-ope    not  = "CC"
                     move  rf-bir-cdc-vps to   w-coe-cmb-vlt-cdc      .
      *                              *---------------------------------*
      *                              * Bufferizzazione                 *
      *                              *---------------------------------*
      ...
      *                              * prezzo da record [bir]          *
      *                              *---------------------------------*
           move      rf-bir-sgl-vpp       to   w-rig-sgl-vpp (1)      .
           move      rf-bir-dec-vpp       to   w-rig-dec-vpp (1)      .
           move      rf-bir-tdc-vpp       to   w-rig-tdc-vpp (1)      .
      *                              *---------------------------------*
      *                              * Determinazione coefficiente di  *
      ...
      *                          * rio da record [bir], escluso coef-  *
      ...
      *                              *---------------------------------*
           ...
           move      w-rig-sgl-vpp (1)    to   d-per-scr-sgl-vpf      .
