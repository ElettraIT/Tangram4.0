      ...
      *                                                                *
      *              Input  : w-cod-des-zbi-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zbi-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-zbi-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-zbi-cod : codice tipo movim.   *
      *                                                                *
      *                       w-cod-des-zbi-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-zbi-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-zbi-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-zbi-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zbi-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-zbi-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zbi-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-zbi-cod : codice tipo movim.   *
      ...
      *    *===========================================================*
      *    * Link-area per accettazione tipo movimento per bolla       *
      *    *-----------------------------------------------------------*
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-zbi
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zbi-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-zbi-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-zbi-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-zbi-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-zbi-ope    =    "A+" or
                     w-cod-des-zbi-ope    =    "I+" or
                     w-cod-des-zbi-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-zbi-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-cod-des-zbi-cod    to   w-cod-des-zbi-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-zbi-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-zbi-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-zbi-s90    to   v-ufk                  .
           move      w-cod-des-zbi-lin    to   v-lin                  .
           move      w-cod-des-zbi-pos    to   v-pos                  .
           move      w-cod-des-zbi-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-zbi-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zbi-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-zbi-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-zbi-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-zbi-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-zbi-cod    to   w-cod-des-zbi-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-zbi-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-zbi-dln    =    zero or
                     w-cod-des-zbi-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      w-cod-des-zbi-dln    to   v-lin                  .
           move      w-cod-des-zbi-dps    to   v-pos                  .
      ...
      *                          *-------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-tmb-dup    to   rf-zbi-des-key         .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-zbi-des-key       >    w-aux-cde-tmb-dmx
                     go to aco-800.
      *                          *-------------------------------------*
      *                          * Selezione sul record : solo records *
      *                          * con codice dipendenza a zero        *
      *                          *-------------------------------------*
           if        rf-zbi-cod-dpz       not  = zero
                     go to aco-710.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      rf-zbi-cod-tmb       to   w-aux-cde-tmb-bco
                                              (w-aux-cde-tmb-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione tipo movimento      *
      *                              *---------------------------------*
           move      rf-zbi-des-tmb       to   w-aux-cde-tmb-bde
                                              (w-aux-cde-tmb-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      w-aux-cde-tmb-bco
                    (w-aux-cde-tmb-bix)   to   w-cod-des-zbi-cod      .
      *                              *---------------------------------*
