      ...
      *                                   Fase:    bol220              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 03/04/07    *
      *                       Ultima revisione:    NdK del 07/06/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa giro clienti - richiamato da bol220  *
      *                                                                *
      *                    -----------------------------------------   *
      *                                                                *
      *                    File di esportazione :                      *
      *                                                                *
      *                    /abd/asc/UTENTE/exp/AZI_bol220.csv          *
      *                                                                *
      *================================================================*
      ...
      *                * Codice agente                                 *
      *                *-----------------------------------------------*
                   15  w-ipc-dlp-cod-arc  pic  9(07)                  .
      *                *-----------------------------------------------*
      *                * Giro                                          *
      *                *-----------------------------------------------*
                   15  w-ipc-dlp-cod-grc  pic  9(03)                  .
      *                *-----------------------------------------------*
      *                * Giorno                                        *
      *                *-----------------------------------------------*
                   15  w-ipc-dlp-num-grc  pic  9(03)                  .
      ...
      *    * cliente da programma di gestione                          *
      *    *-----------------------------------------------------------*
       ipc-dlp-tdi-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione iniziale                        *
      *              *-------------------------------------------------*
           move      zero                 to   w-ipc-dlp-cod-arc      .
           move      zero                 to   w-ipc-dlp-cod-grc      .
           move      zero                 to   w-ipc-dlp-num-grc      .
      *              *-------------------------------------------------*
      *              * Estrazione della eventuale variabile di i.p.c.  *
      *              * "cod-arc" per il codice vettore                 *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
           ...
           if        s-num                =    zero
                     go to ipc-dlp-tdi-999.
           move      s-num                to   w-ipc-dlp-cod-arc      .
       ipc-dlp-tdi-300.
      *              *-------------------------------------------------*
      *              * Estrazione della eventuale variabile di i.p.c.  *
      *              * "cod-grc" per il giro                           *
      *              *-------------------------------------------------*
           ...
           if        s-num                =    zero
                     go to ipc-dlp-tdi-999.
           move      s-num                to   w-ipc-dlp-cod-grc      .
       ipc-dlp-tdi-600.
      *              *-------------------------------------------------*
      *              * Estrazione della eventuale variabile di i.p.c.  *
      *              * "num-grc" per il giorno                         *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
           ...
           if        s-num                =    zero
                     go to ipc-dlp-tdi-999.
           move      s-num                to   w-ipc-dlp-num-grc      .
           go to     ipc-dlp-tdi-999.
       ipc-dlp-tdi-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-ipc-dlp-cod-arc    =    zero
                     go to pre-tip-fun-200.
       pre-tip-fun-100.
      *              *-------------------------------------------------*
      *              * Se variabile di i.p.c. per codice cliente       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-ipc-dlp-cod-arc    to   rr-cod-arc             .
           move      w-ipc-dlp-cod-grc    to   rr-cod-grc             .
           move      w-ipc-dlp-num-grc    to   rr-num-grc             .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      zero                 to   rr-cod-grc             .
           move      zero                 to   rr-num-grc             .
       nor-ric-sel-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-arc           to   rf-zgc-cod-arc         .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun codice cliente entro i limiti assegnati !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zgc]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/bol/fls/ioc/obj/iofzgc"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-zgc-tip-arc       not  = "V"        or
                     rf-zgc-cod-arc       not  = rr-cod-arc or
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-zgc-num-grc       to   w-rot-l01-num-grc      .
       prn-cmp-rot-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      005                  to   p-pos                  .
           move      w-rot-l01-num-grc    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Literal '**'                            *
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-zgc-cod-cli       to   rf-dcc-cod-cli         .
           move      rf-zgc-dpz-cli       to   rf-dcc-dpz-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-320.
      *                  *---------------------------------------------*
      *                  * Determinazione forma di pagamento           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Normalizzazione [zfp]                   *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Determinazione categoria merceologica       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Normalizzazione [zst]                   *
      *                      *-----------------------------------------*
      ...
      *                  * Sottolineatura                              *
      *                  *---------------------------------------------*
           perform   prn-fin-rig-000      thru prn-fin-rig-999        .
       prn-liv-det-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "GIRO"               to   w-all-str-cat (1)      .
           move      "- GIORNO "          to   w-all-str-cat (3)      .
           move      "- VETTORE"          to   w-all-str-cat (5)      .
