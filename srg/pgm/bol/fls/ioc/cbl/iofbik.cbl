      ...
      *    *===========================================================*
      *    * Record logico file [bik]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/bol/fls/rec/rfbik"                          .

      ******************************************************************
       Procedure Division                using f rf-bik               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-bik                 .
           move      zero                 to   rf-bik-num-prt         .
           move      zero                 to   rf-bik-num-prg         .
           move      zero                 to   rf-bik-num-prc         .
           move      spaces               to   rf-bik-cts-prc         .
           move      zero                 to   rf-bik-qta-prc         .
           move      zero                 to   rf-bik-num-mag         .
           move      spaces               to   rf-bik-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-bik-qta-prc       to   fil-qta-prc            .
           move      rf-bik-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bik-num-prt       to   fil-num-prt            .
           move      rf-bik-num-prg       to   fil-num-prg            .
           move      rf-bik-num-prc       to   fil-num-prc            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bik-num-prt       to   fil-num-prt-2          .
           move      rf-bik-num-prc       to   fil-num-prc-2          .
           move      rf-bik-num-prg       to   fil-num-prg-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bik-cts-prc       to   fil-cts-prc            .
           move      rf-bik-num-prt       to   fil-num-prt-3          .
           move      rf-bik-num-prc       to   fil-num-prc-3          .
           move      rf-bik-num-prg       to   fil-num-prg-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bik-num-mag       to   fil-num-mag            .
           move      rf-bik-cts-prc       to   fil-cts-prc-4          .
           move      rf-bik-num-prt       to   fil-num-prt-4          .
           move      rf-bik-num-prc       to   fil-num-prc-4          .
           move      rf-bik-num-prg       to   fil-num-prg-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-bik                 .
           move      fil-num-prt          to   rf-bik-num-prt         .
           move      fil-num-prg          to   rf-bik-num-prg         .
           move      fil-num-prc          to   rf-bik-num-prc         .
           move      fil-cts-prc          to   rf-bik-cts-prc         .
           move      fil-qta-prc          to   rf-bik-qta-prc         .
           move      fil-num-mag          to   rf-bik-num-mag         .
           move      fil-alx-exp          to   rf-bik-alx-exp         .
       dec-fis-log-999.
           exit.
