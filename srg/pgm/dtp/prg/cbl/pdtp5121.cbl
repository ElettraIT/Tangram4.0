      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdtp5120 *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dps-num-sem       to   rf-lgr-nrm-cpt         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-lgr-tpm-cpt       not  = 02          or
                     rf-lgr-nrm-cpt       not  = rf-dps-num-sem
                     go to prn-let-seq-200.
       prn-let-seq-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      rf-dps-cla-sem       to   w-rot-l04-cod-cla      .
      *                  *---------------------------------------------*
      *                  * Composizione area per rottura gruppo        *
      *                  *---------------------------------------------*
           move      rf-dps-gru-sem       to   w-rot-l03-cod-gru      .
      *                  *---------------------------------------------*
      *                  * Composizione area per rottura sottogruppo   *
      *                  *---------------------------------------------*
           move      rf-dps-sgr-sem       to   w-rot-l02-cod-sgr      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-cmp-rot-800.
      *              *-------------------------------------------------*
      *              * Codice numerico semilavorato                    *
      *              *-------------------------------------------------*
           move      rf-dps-num-sem       to   w-rot-l01-num-pro      .
       prn-cmp-rot-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      016                  to   p-pos                  .
           move      w-let-arc-dps-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-200.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "UTILIZZO SEMILAVORATI IN DISTINTE BASE"
