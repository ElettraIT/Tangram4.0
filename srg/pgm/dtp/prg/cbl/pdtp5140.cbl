      ...
      *                                   Fase:    dtp514              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 29/09/92    *
      *                       Ultima revisione:    NdK del 08/02/06    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdtp5141:        *
      *                                                                *
      *                    Stampa utilizzi materie prime in distinte   *
      *                    base                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " UTILIZZI MATERIE PRIME IN DISTINTE BASE"       .
