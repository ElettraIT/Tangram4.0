      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdtp3810 *
      *                                                                *
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-050.
      *              *-------------------------------------------------*
      *              * Test su tipo prodotto di vendita : si prendono  *
      *              * in considerazione solo 'merci'                  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           else      go to prn-sel-rec-140.
       prn-sel-rec-120.
      *                  *---------------------------------------------*
      *                  * Se solo prodotti con distinta base          *
      *                  *---------------------------------------------*
           if        f-sts                =    e-not-err
                     go to prn-sel-rec-999
       ...
       prn-sel-rec-140.
      *                  *---------------------------------------------*
      *                  * Se solo prodotti senza distinta base        *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-sel-rec-999
           else      move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              *-------------------------------------------------*
           if        rr-sel-dst           =    01
                     move  "PRODOTTI FINITI CON DISTINTA BASE"
                                          to   w-cnt-tit-des-tit
           else      move  "PRODOTTI FINITI SENZA DISTINTA BASE"
                                          to   w-cnt-tit-des-tit      .
      *
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
