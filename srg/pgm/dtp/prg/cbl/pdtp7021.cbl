      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdtp7020 *
      *                                                                *
      ...
      *            * Codice classe                                     *
      *            *---------------------------------------------------*
               10  srt-cla-mag            pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice gruppo                                     *
      *            *---------------------------------------------------*
               10  srt-gru-mag            pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice sottogruppo                                *
      *            *---------------------------------------------------*
               10  srt-sgr-mag            pic  9(05)                  .
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dps-cla-sem       to   srt-cla-mag            .
           move      rf-dps-gru-sem       to   srt-gru-mag            .
           move      rf-dps-sgr-sem       to   srt-sgr-mag            .
           move      02                   to   srt-tip-mag            .
           move      rf-dps-num-sem       to   srt-num-mag            .
           move      rf-dps-alf-sem       to   srt-alf-mag            .
           move      rf-dps-des-sem       to   srt-des-mag            .
           move      rf-dps-umi-prd       to   srt-umi-mag            .
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      srt-cla-mag          to   w-rot-l03-cod-cla      .
      *                  *---------------------------------------------*
      *                  * Composizione area per rottura gruppo        *
      *                  *---------------------------------------------*
           move      srt-gru-mag          to   w-rot-l02-cod-gru      .
      *                  *---------------------------------------------*
      *                  * Composizione area per rottura sottogruppo   *
      *                  *---------------------------------------------*
           move      srt-sgr-mag          to   w-rot-l01-cod-sgr      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           string    "VALORIZZAZIONE UNITARIA SEMILAVORATI SU DISTINTA B
      -              "ASE AL "
                                delimited by   size
