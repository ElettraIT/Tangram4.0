      ...
      *                                                                *
      *                    Implosione riepilogata per una materia pri- *
      *                    ma                                          *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "  IMPLOSIONE RIEPILOGATA MATERIA PRIMA  "       .
      ...
      *                      *-----------------------------------------*
           ...
           move      "<"                  to   v-edm                  .
           move      w-let-arc-dpm-num    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           string    "Anagrafica materia prima codice ("
                                delimited by   size
                     v-edt
                                delimited by   spaces
      ...
      *                  *---------------------------------------------*
           ...
           string    "la materia prima con codice "
                                delimited by   size
                     rr-alf-com
                                delimited by   spaces
                     " !"
