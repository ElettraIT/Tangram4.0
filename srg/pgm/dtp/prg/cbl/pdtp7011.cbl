      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdtp7010 *
      *                                                                *
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dcp-num-pro       to   rf-lgt-nrm-ass         .
           move      "pgm/dtp/fls/ioc/obj/ioflgt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dcp-cla-pro       to   srt-cla-mag            .
           move      rf-dcp-gru-pro       to   srt-gru-mag            .
           move      rf-dcp-sgr-pro       to   srt-sgr-mag            .
           move      01                   to   srt-tip-mag            .
           move      rf-dcp-num-pro       to   srt-num-mag            .
           move      rf-dcp-alf-pro       to   srt-alf-mag            .
           move      rf-dcp-des-pro       to   srt-des-mag            .
           move      rf-dcp-umi-ven       to   srt-umi-mag            .
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           string    "VALORIZZAZIONE UNITARIA PRODOTTI DI VENDITA SU DIS
      -              "TINTA BASE AL "
                                delimited by   size
