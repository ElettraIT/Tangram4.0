      ...
      *                                                                *
      *                    Esplosione scalare distinta base per una    *
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "ESPLOSIONE SCALARE SUB-DISTINTA VIRTUALE"       .
      ...
      *        *-------------------------------------------------------*
      *        * Per codice numerico dell'assieme di tipo sub-distinta *
      *        * virtuale                                              *
      *        *-------------------------------------------------------*
           05  w-ipc-num-ass.
      *            *---------------------------------------------------*
      *            * Si/No variabile di i.p.c. relativa al codice nu-  *
      *            * merico dell'assieme di tipo sub-distinta virtuale *
      *            *---------------------------------------------------*
               10  w-ipc-num-ass-snx      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore della variabile di i.p.c. relativa al co-  *
      *            * dice numerico dell'assieme di tipo sub-distinta   *
      *            * virtuale                                          *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Codice alfanumerico per l'assieme di tipo sub-distin- *
      *        * ta virtuale                                           *
      *        *-------------------------------------------------------*
           05  rr-alf-ass                 pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione per l'assieme di tipo sub-distinta virtu- *
      *        * ale                                                   *
      *        *-------------------------------------------------------*
           05  rr-des-ass                 pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Unita' di misura per l'assieme di tipo sub-distinta   *
      *        * virtuale                                              *
      *        *-------------------------------------------------------*
           05  rr-umi-ass                 pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Numero decimali quantita' per l'assieme di tipo sub-  *
      *        * distinta virtuale                                     *
      *        *-------------------------------------------------------*
           05  rr-deq-ass                 pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Quantita' da esplodere per l'assieme di tipo sub-     *
      *        * distinta virtuale                                     *
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Lettura della variabile eventuale di i.p.c. per *
      *              * il codice numerico dell'assieme di sub-distinta *
      *              * virtuale                                        *
      *              *-------------------------------------------------*
      ...
      *    * numerico dell'assieme di tipo sub-distinta virtuale       *
      *    *-----------------------------------------------------------*
       ipc-num-ass-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-ipc-num-ass-val    to   w-let-arc-lgv-num      .
      ...
      *                          * Codice numerico                     *
      *                          *-------------------------------------*
           move      w-let-arc-lgv-num    to   rr-num-ass             .
      *                          *-------------------------------------*
      *                          * Codice alfanumerico                 *
      *                          *-------------------------------------*
           move      w-let-arc-lgv-alf    to   rr-alf-ass             .
      *                          *-------------------------------------*
      *                          * Descrizione                         *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-let-arc-lgv-deq    to   rr-deq-ass             .
       pre-tip-fun-420.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       pre-tip-fun-440.
      *                      *-----------------------------------------*
      *                      * Lettura archivio [lgt] per la sub-      *
      *                      * distinta virtuale                       *
      *                      *-----------------------------------------*
           move      99                   to   w-let-arc-lgt-tip      .
      ...
      *                      *-----------------------------------------*
           move      spaces               to   w-err-box-err-msg      .
           string    "Anagrafica sub-distinta ("
                                delimited by   size
                     v-edt
                                delimited by   spaces
      ...
      *    *===========================================================*
      *    * Accettazione : Codice assieme di tipo sub-distinta virtu- *
      *    *                ale                                        *
      *    *-----------------------------------------------------------*
       acc-cod-ass-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-cod-ass-440.
      *                  *---------------------------------------------*
      *                  * Test che la distinta base per la sub-       *
      *                  * distinta virtuale esista in archivio [lgt]  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
