      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdtp5140 *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Codice filtro di selezione-ordinamento [dpm]          *
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dpm-num-map       to   rf-lgr-nrm-cpt         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-lgr-tpm-cpt       not  = 03          or
                     rf-lgr-nrm-cpt       not  = rf-dpm-num-map
                     go to prn-let-seq-200.
       prn-let-seq-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      rf-dpm-cla-map       to   w-rot-l04-cod-cla      .
      *                  *---------------------------------------------*
      *                  * Composizione area per rottura gruppo        *
      *                  *---------------------------------------------*
           move      rf-dpm-gru-map       to   w-rot-l03-cod-gru      .
      *                  *---------------------------------------------*
      *                  * Composizione area per rottura sottogruppo   *
      *                  *---------------------------------------------*
           move      rf-dpm-sgr-map       to   w-rot-l02-cod-sgr      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-dpm-num-map       to   w-rot-l01-num-pro      .
       prn-cmp-rot-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      016                  to   p-pos                  .
           move      w-let-arc-dpm-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-200.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "UTILIZZO MATERIE PRIME IN DISTINTE BASE"
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edm                to   w-let-arc-zm1-mne      .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edm                to   w-let-arc-zm2-mne      .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edm                to   w-let-arc-zm3-mne      .
