      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "    IMPLOSIONE SCALARE MATERIA PRIMA    "       .
      ...
      *                  *---------------------------------------------*
           move      w-ipc-num-com-val    to   w-let-arc-dpm-num      .
      ...
      *                  *---------------------------------------------*
       ...
       pre-tip-fun-340.
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda se record [dpm] esi-   *
      *                  * stente oppure no                            *
      *                  *---------------------------------------------*
      ...
      *                      * grafica materia prima                   *
      *                      *-----------------------------------------*
       pre-tip-fun-411.
      *                          *-------------------------------------*
      *                          * Codice numerico                     *
      *                          *-------------------------------------*
           move      w-let-arc-dpm-num    to   rr-num-com             .
      *                          *-------------------------------------*
      *                          * Codice alfanumerico                 *
      *                          *-------------------------------------*
           move      w-let-arc-dpm-alf    to   rr-alf-com             .
      *                          *-------------------------------------*
      *                          * Descrizione                         *
      *                          *-------------------------------------*
           move      w-let-arc-dpm-des    to   rr-des-com             .
      *                          *-------------------------------------*
      *                          * Unita' di misura                    *
      *                          *-------------------------------------*
           move      w-let-arc-dpm-umi    to   rr-umi-com             .
      *                          *-------------------------------------*
      *                          * Numero decimali quantita'           *
      *                          *-------------------------------------*
           move      w-let-arc-dpm-deq    to   rr-deq-com             .
       pre-tip-fun-420.
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-num-com           to   w-cod-cod-dpm-num      .
           move      rr-alf-com           to   w-cod-cod-dpm-alf      .
      ...
      *                  * Lettura archivio [dpm]                      *
      *                  *---------------------------------------------*
           move      rr-num-com           to   w-let-arc-dpm-num      .
           perform   let-arc-dpm-000      thru let-arc-dpm-999        .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "Manca il codice della materia prima               
      ...
      *                  *---------------------------------------------*
           ...
           string    "per la materia prima con codice "
                                delimited by   size
                     rr-alf-com
                                delimited by   spaces
                     " !"
