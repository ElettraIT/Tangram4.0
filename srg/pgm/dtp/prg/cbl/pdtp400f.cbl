      ...
      *                                                                *
      *                    Esplosione riepilogata distinta base per    *
      *                    una sub-distinta virtuale                   *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
      *            * Unita' di misura per la materia prima             *
      *            *---------------------------------------------------*
               10  srt-umi-map            pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Numero decimali quantita' per la materia prima    *
      *            *---------------------------------------------------*
               10  srt-deq-map            pic  9(01)                  .
      *            *---------------------------------------------------*
      *            * Quantita' esplosa per la materia prima            *
      *            *---------------------------------------------------*
               10  srt-qta-esp            pic  9(08)v9(03)            .
      ...
      *        * Codice numerico della materia prima                   *
      *        *-------------------------------------------------------*
           05  rel-num-map                pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice alfanumerico della materia prima               *
      *        *-------------------------------------------------------*
           05  rel-alf-map                pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione della materia prima                       *
      *        *-------------------------------------------------------*
           05  rel-des-map                pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Unita' di misura per la materia prima                 *
      *        *-------------------------------------------------------*
           05  rel-umi-map                pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Numero decimali quantita' per la materia prima        *
      *        *-------------------------------------------------------*
           05  rel-deq-map                pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Quantita' totale esplosa per la materia prima         *
      *        *-------------------------------------------------------*
           05  rel-qtt-esp                pic  9(08)v9(03)            .
      ...
      *            *---------------------------------------------------*
               05  f-rel-chm-buf.
                   10  f-rel-chm-rec occurs 400.
                       15  f-rel-num-map  pic  9(07)                  .
                       15  f-rel-alf-map  pic  x(14)                  .
                       15  f-rel-des-map  pic  x(40)                  .
                       15  f-rel-umi-map  pic  x(03)                  .
                       15  f-rel-deq-map  pic  9(01)                  .
                       15  f-rel-qtt-esp  pic  9(08)v9(03)            .

      *    *===========================================================*
      *    * Descrizione tipo interrogazione per l'overlay             *
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "  ESPLOSIONE RIEPILOGATA SUB-DISTINTA   "       .
      ...
      *        *-------------------------------------------------------*
      *        * Per codice numerico dell'assieme                      *
      *        *-------------------------------------------------------*
           05  w-ipc-num-ass.
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Lettura della variabile eventuale di i.p.c. per *
      *              * il codice numerico dell'assieme                 *
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           string    "Distinta base per sub-distinta "
                                delimited by   size
                     rr-alf-ass
                                delimited by   spaces
                     " non esistente !"
      ...
      *                  *---------------------------------------------*
           move      "MX"                 to   v-ope                  .
           move      "U"                  to   v-tip                  .
           move      "Conferma esecuzione esplosione riepilogata (S/N/E)
      -              " ?"                 to   v-not                  .
           move      "S"                  to   v-alf                  .
           move      "SNE"                to   v-msk                  .
           move      "DO  "               to   v-pfk (05)             .
      ...
      *              *-------------------------------------------------*
      *              * Esecuzione sort per :                           *
      *              *  - Esplosione vera e propria, considerando le   *
      *              *    sole materie prime                           *
      *              *  - Ordinamento per codice materia prima         *
      *              *  - Compattamento a parita' di materia prima     *
      ...
      *    *  - Esplosione vera e propria, considerando le sole mate-  *
      *    *    rie prime                                              *
      *    *  - Ordinamento per codice materia prima                   *
      *    *-----------------------------------------------------------*
       qry-srt-inp-000.
      ...
      *              *-------------------------------------------------*
       ...
       qry-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Lettura elemento successivo da esplosione sca-  *
      *              * lare distinta base                              *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       qry-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Se non si tratta di una materia prima : si i-   *
      *              * gnora l'elemento                                *
      *              *-------------------------------------------------*
           if        w-esp-scl-dtp-tip    not  = 03
      ...
      *                  * Codice numerico della materia prima         *
      *                  *---------------------------------------------*
           move      w-esp-scl-dtp-num    to   srt-num-map            .
       qry-srt-inp-360.
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico della materia prima     *
      *                  *---------------------------------------------*
           move      w-esp-scl-dtp-alf    to   srt-alf-map            .
       qry-srt-inp-380.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-esp-scl-dtp-des    to   srt-des-map            .
       qry-srt-inp-420.
      *                  *---------------------------------------------*
      *                  * Unita' di misura per la materia prima       *
      *                  *---------------------------------------------*
           move      w-esp-scl-dtp-umi    to   srt-umi-map            .
       qry-srt-inp-440.
      *                  *---------------------------------------------*
      *                  * Numero decimali quantita' per la materia    *
      *                  * prima                                       *
      *                  *---------------------------------------------*
           move      w-esp-scl-dtp-dec    to   srt-deq-map            .
       qry-srt-inp-460.
      *                  *---------------------------------------------*
      *                  * Quantita' esplosa per la materia prima      *
      *                  *---------------------------------------------*
           move      w-esp-scl-dtp-qta    to   srt-qta-esp            .
       qry-srt-inp-500.
      *              *-------------------------------------------------*
      ...
      *                  * Codice numerico della materia prima         *
      *                  *---------------------------------------------*
           move      srt-num-map          to   rel-num-map            .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico della materia prima     *
      *                  *---------------------------------------------*
           move      srt-alf-map          to   rel-alf-map            .
      *                  *---------------------------------------------*
      *                  * Descrizione della materia prima             *
      *                  *---------------------------------------------*
           move      srt-des-map          to   rel-des-map            .
      *                  *---------------------------------------------*
      *                  * Unita' di misura per la materia prima       *
      *                  *---------------------------------------------*
           move      srt-umi-map          to   rel-umi-map            .
      *                  *---------------------------------------------*
      *                  * Numero decimali quantita' per la materia    *
      *                  * prima                                       *
      *                  *---------------------------------------------*
           move      srt-deq-map          to   rel-deq-map            .
      *                  *---------------------------------------------*
      *                  * Quantita' totale esplosa per la materia     *
      *                  * prima                                       *
      *                  *---------------------------------------------*
           move      zero                 to   rel-qtt-esp            .
       qry-srt-out-400.
      *              *-------------------------------------------------*
      *              * Accumulo per il record compattato               *
      *              *-------------------------------------------------*
           add       srt-qta-esp          to   rel-qtt-esp            .
       qry-srt-out-450.
      *              *-------------------------------------------------*
      *              * Flag di primo passaggio per output procedure in *
      *              * Off                                             *
      ...
      *                  * Composizione 1. riga                        *
      *                  *---------------------------------------------*
           move      "Non esiste alcuna materia prima da visualizzare   
      -              "               "    to   w-err-box-err-msg      .
      *                  *---------------------------------------------*
      *                  * Composizione 2. riga                        *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      14                   to   v-car                  .
           move      "+"                  to   v-edm                  .
           move      rel-num-map          to   w-mpn-num-map          .
           move      w-mpn                to   v-cnt                  .
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      rel-alf-map          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-300.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "    Codice          Descrizione della materia prim
      -              "a       Udm   Quantita' totale"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-int-pag-500.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se programma di implosione scalare materie  *
      *                  * prime gia' attivo : no function key Expd    *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se programma di implosione riepilogata ma-  *
      *                  * terie prime gia' attivo : no function key   *
      *                  * Find                                        *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se programma di implosione ad un livello    *
      *                  * materie prime gia' attivo : no function key *
      *                  * Pf1                                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       qry-trt-fun-225.
      *                  *---------------------------------------------*
      *                  * Scrittura variabile di i.p.c. 'num-com' per *
      *                  * lo stesso livello di profondita' applicati- *
      *                  * va per il codice numerico del componente di *
      *                  * tipo materia prima da implodere             *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *                  *---------------------------------------------*
      *                  * Se programma di implosione ad un livello    *
      *                  * materie prime gia' attivo : uscita          *
      *                  *---------------------------------------------*
           move      "IULMAP    "         to   w-spg-alf-gat          .
           perform   tst-spg-gat-000      thru tst-spg-gat-999        .
           if        w-spg-snx-gat        not  = spaces
