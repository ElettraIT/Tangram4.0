      ...
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione codice sub-distinta     *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-cod-lgv-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-lgv-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-cod-lgv-ope : "AC"                 *
      *                                                                *
      *                       w-cod-cod-lgv-tac : Tipo accettazione    *
      *                                           - N : Numerico       *
      *                                           - A : Alfanumerico   *
      *                                           - S : Sinonimo       *
      *                                           - L : Libera, alfa-  *
      ...
      *                                                 controllata    *
      *                                                                *
      *                       w-cod-cod-lgv-num : Codice numerico      *
      *                                             Solo se tipo ac-   *
      *                                             cettazione 'N' o   *
      *                                             tipo acc.  'A'     *
      *                                                                *
      *                       w-cod-cod-lgv-alf : Codice alfanumerico  *
      *                                             Inutile se tipo    *
      *                                             accettazione 'N'   *
      *                                                                *
      *                       w-cod-cod-lgv-lin : linea a video        *
      *                                                                *
      *                       w-cod-cod-lgv-pos : posizione a video    *
      *                                                                *
      *                       w-cod-cod-lgv-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-cod-lgv-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-lgv-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-cod-lgv-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-lgv-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-cod-lgv-num : Codice numerico      *
      ...
      *            * - N : Codice sub-distinta  numerico               *
      *            * - A : Codice sub-distinta  alfanumerico           *
      *            * - S : Sinonimo                                    *
      ...
      *                *-----------------------------------------------*
      *                * Codice numerico della sub-distinta            *
      *                *-----------------------------------------------*
                   15  w-buf-cod-num      pic  9(07)                  .
      *                *-----------------------------------------------*
      *                * Codice alfanumerico della sub-distinta        *
      *                *-----------------------------------------------*
                   15  w-buf-cod-alf      pic  x(14)                  .
      *                *-----------------------------------------------*
      *                * Codice sinonimo della sub-distinta            *
      *                *-----------------------------------------------*
                   15  w-buf-cod-sin      pic  x(13)                  .
      *                *-----------------------------------------------*
      *                * Descrizione della sub-distinta virtuale       *
      *                *-----------------------------------------------*
                   15  w-buf-des-lgv      pic  x(40)                  .
      *        *-------------------------------------------------------*
      ...
      ******************************************************************
       Procedure Division                using w-cod-cod-lgv
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-cod-lgv-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-cod-lgv-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-cod-lgv-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-cod-lgv-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-cod-lgv-ope    =    "A+" or
                     w-cod-cod-lgv-ope    =    "I+" or
                     w-cod-cod-lgv-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-cod-lgv-ope      .
       tcm-999.
           exit.
      ...
      *                  * Codice numerico                             *
      *                  *---------------------------------------------*
           if        w-cod-cod-lgv-tac    =    "N" or
                     w-cod-cod-lgv-tac    =    "A"
                     move  w-cod-cod-lgv-num
                                          to   w-cod-cod-lgv-s01
           else      move  zero           to   w-cod-cod-lgv-s01      .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico                         *
      *                  *---------------------------------------------*
           if        w-cod-cod-lgv-tac    =    "N"
                     move  spaces         to   w-cod-cod-lgv-s02
           else      move  w-cod-cod-lgv-alf
                                          to   w-cod-cod-lgv-s02      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing v-edm                   *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-cod-lgv-s70      .
      *                  *---------------------------------------------*
      *                  * User function-keys eventualmente epurate    *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-cod-lgv-s90      .
       acc-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-cod-cod-lgv-s01    to   w-edt-num-cod          .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-cod-lgv-s90    to   v-ufk                  .
           move      w-cod-cod-lgv-lin    to   v-lin                  .
           move      w-cod-cod-lgv-pos    to   v-pos                  .
           move      w-edt-num-edt        to   v-alf                  .
      *                  *---------------------------------------------*
      *                  * Tipo operazione a : continuazione           *
      *                  *---------------------------------------------*
           move      "A+"                 to   w-cod-cod-lgv-ope      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     acc-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-cod-lgv-lin    to   v-lin                  .
           move      w-cod-cod-lgv-pos    to   v-pos                  .
           move      w-cod-cod-lgv-s02    to   v-alf                  .
      *                  *---------------------------------------------*
      *                  * Tipo operazione a : continuazione           *
      *                  *---------------------------------------------*
           move      "A+"                 to   w-cod-cod-lgv-ope      .
      ...
      *              *-------------------------------------------------*
           if        w-cod-cod-lgv-ope    =    "A+"
                     go to aco-300
           else if   w-cod-cod-lgv-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                          * ta numerica                         *
      *                          *-------------------------------------*
           move      s-num                to   w-cod-cod-lgv-num      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-cod-cod-lgv-num    to   w-edt-num-cod          .
           perform   edn-000              thru edn-999                .
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Lettura del record 'lgv' relativo   *
      ...
      *                                  * uscita                      *
      *                                  *-----------------------------*
           move      rf-lgv-num-lgv       to   w-cod-cod-lgv-num      .
      *                                  *-----------------------------*
      *                                  * Valore alfanumerico conte-  *
      *                                  * nuto nel record in area di  *
      *                                  * uscita                      *
      *                                  *-----------------------------*
           move      rf-lgv-alf-lgv       to   w-cod-cod-lgv-alf      .
      *                                  *-----------------------------*
      ...
      *                          * ta numerica                         *
      *                          *-------------------------------------*
           move      w-man-x14-num        to   w-cod-cod-lgv-num      .
      *                          *-------------------------------------*
      *                          * Area di uscita alfanumerica a spa-  *
      *                          * ces                                 *
      *                          *-------------------------------------*
      ...
      *                          * ta alfanumerica                     *
      *                          *-------------------------------------*
           move      w-man-x14-alf        to   w-cod-cod-lgv-alf      .
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-man-x14-alf        to   rf-lgv-alf-lgv         .
      ...
      *                              * esistente                       *
      *                              *---------------------------------*
           if        rf-lgv-alf-lgv       not  = w-man-x14-alf
                     go to aco-480.
       aco-460.
      *                          *-------------------------------------*
      *                          * Se trovato il record 'lgv' cercato  *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           move      w-man-x14-alf        to   w-cod-cod-lgv-alf      .
      *                              *---------------------------------*
      *                              * Codice sub-distinta numerico    *
      *                              * contenuto in record 'lgv' in    *
      *                              * area di uscita numerica         *
      *                              *---------------------------------*
           move      rf-lgv-num-lgv       to   w-cod-cod-lgv-num      .
       aco-465.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
      *                              *---------------------------------*
      *                              * Editing del valore numerico in  *
      *                              * uscita                          *
      *                              *---------------------------------*
           move      w-cod-cod-lgv-num    to   w-edt-num-cod          .
           perform   edn-000              thru edn-999                .
      *                              *---------------------------------*
      *                              * Visualizzazione del valore nu-  *
      *                              * merico in uscita editato        *
      *                              *---------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      14                   to   v-car                  .
      ...
      *                                  *-----------------------------*
       ...
       aco-480.
      *                          *-------------------------------------*
      *                          * Se record 'lgv' relativo al codice  *
      ...
      *                              * per la descrizione              *
      *                              *---------------------------------*
           if        w-cod-cod-lgv-dln    =    zero
                     go to aco-482.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
           move      spaces               to   v-edm                  .
           move      w-cod-cod-lgv-dln    to   v-lin                  .
           move      w-cod-cod-lgv-dps    to   v-pos                  .
           move      all   "."            to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-482.
      ...
      *                      * vato                                    *
      *                      *-----------------------------------------*
           if        w-cod-cod-lgv-dln    =    zero or
                     w-cod-cod-lgv-dps    =    zero
                     go to aco-340.
       aco-545.
      *                      *-----------------------------------------*
      ...
      *                              *---------------------------------*
           move      w-cod-cod-lgv-s01    to   w-cod-cod-lgv-num      .
           move      w-cod-cod-lgv-s02    to   w-cod-cod-lgv-alf      .
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-rbl-sin-min        to   rf-lgv-syn-lgv         .
           move      zero                 to   rf-lgv-num-lgv         .
           move      "pgm/dtp/fls/ioc/obj/ioflgv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                              *---------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-rbl-des-min        to   rf-lgv-des-key         .
           move      zero                 to   rf-lgv-num-lgv         .
           move      "pgm/dtp/fls/ioc/obj/ioflgv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                              * tinua                           *
      *                              *---------------------------------*
           if        rf-lgv-syn-lgv       >    w-rbl-sin-max
                     go to aco-650
           else      go to aco-625.
       aco-622.
      *                          *-------------------------------------*
      *                          * Se tipo ricerca per Desceizione     *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Esecuzione Test : se non supe-  *
      *                              * rato si va' a trattamento per   *
      ...
      *                              * tinua                           *
      *                              *---------------------------------*
           if        rf-lgv-des-key       >    w-rbl-des-max
                     go to aco-650
           else      go to aco-625.
       aco-625.
      *                      *-----------------------------------------*
      ...
      *                          * Codice numerico della sub-distinta  *
      *                          *-------------------------------------*
           move      rf-lgv-num-lgv       to   w-buf-cod-num
                                              (w-buf-ctr-rec)         .
      *                          *-------------------------------------*
      *                          * Codice alfanumerico della sub-di-   *
      *                          * stinta                              *
      *                          *-------------------------------------*
           move      rf-lgv-alf-lgv       to   w-buf-cod-alf
                                              (w-buf-ctr-rec)         .
      *                          *-------------------------------------*
      *                          * Codice sinonimo della sub-distinta  *
      *                          *-------------------------------------*
           move      rf-lgv-syn-lgv       to   w-buf-cod-sin
                                              (w-buf-ctr-rec)         .
      *                          *-------------------------------------*
      *                          * Descrizione della sub-distinta      *
      *                          *-------------------------------------*
           move      rf-lgv-des-lgv       to   w-buf-des-lgv
                                              (w-buf-ctr-rec)         .
       aco-635.
      *                      *-----------------------------------------*
      *                      * Riciclo a Read Next                     *
      ...
      *                                  *-----------------------------*
           move      w-buf-cod-num
                    (w-buf-ctr-ibx)       to   w-cod-cod-lgv-num      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           move      w-buf-cod-alf
                    (w-buf-ctr-ibx)       to   w-cod-cod-lgv-alf      .
      *                                  *-----------------------------*
      *                                  * Visualizzazione del valore  *
      *                                  * alfanumerico                *
      *                                  *-----------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      05                   to   v-pos                  .
           move      "         Selezionare il codice sub-distinta virtua
      -              "le desiderato         "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
       vpg-125.
      *                  *---------------------------------------------*
      *                  * Codice sub-distinta  alfanumerico           *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      14                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
       ...
       vpg-175.
      *                  *---------------------------------------------*
      *                  * Codice sub-distinta  sinonimo               *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se a Spaces : nessuna visualizzazione   *
      *                      *-----------------------------------------*
           if        w-buf-cod-sin
      ...
      *              *-------------------------------------------------*
       ...
       sac-200.
      *              *-------------------------------------------------*
      *              * Test se codice sub-distinta  numerico           *
      *              *-------------------------------------------------*
       ...
       sac-300.
      *              *-------------------------------------------------*
      *              * Test se codice sub-distinta  alfanumerico       *
      *              *-------------------------------------------------*
