      ...
      *                                                                *
      *                    Sostituzione di un componente con un altro  *
      *                    componente in tutte le distinte base in cui *
      *                    il componente da sostituire compare         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "SOSTITUZIONE COMPONENTI IN DISTINTE BASE"       .
      ...
      *        *-------------------------------------------------------*
      *        * Componente da sostituire, tipo                        *
      *        *  - M : Materia prima                                  *
      *        *  - S : Semilavorato                                   *
      *        *  - D : Subdistinta virtuale                           *
      *        *-------------------------------------------------------*
           05  w-tes-cds-tip              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Componente da sostituire, codice numerico             *
      *        *-------------------------------------------------------*
           05  w-tes-cds-num              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Componente da sostituire, codice alfanumerico         *
      *        *-------------------------------------------------------*
           05  w-tes-cds-alf              pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Componente da sostituire, descrizione                 *
      *        *-------------------------------------------------------*
           05  w-tes-cds-des              pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Componente da sostituire, unita' di misura            *
      *        *-------------------------------------------------------*
           05  w-tes-cds-umi              pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Componente da sostituire, decimali quantita'          *
      *        *-------------------------------------------------------*
           05  w-tes-cds-dec              pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Componente che sostituisce, tipo                      *
      *        *  - M : Materia prima                                  *
      *        *  - S : Semilavorato                                   *
      *        *  - D : Subdistinta virtuale                           *
      *        *-------------------------------------------------------*
           05  w-tes-ccs-tip              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Componente che sostituisce, codice numerico           *
      *        *-------------------------------------------------------*
           05  w-tes-ccs-num              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Componente che sostituisce, codice alfanumerico       *
      *        *-------------------------------------------------------*
           05  w-tes-ccs-alf              pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Componente che sostituisce, descrizione               *
      *        *-------------------------------------------------------*
           05  w-tes-ccs-des              pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Componente che sostituisce, unita' di misura          *
      *        *-------------------------------------------------------*
           05  w-tes-ccs-umi              pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Componente che sostituisce, decimali quantita'        *
      *        *-------------------------------------------------------*
           05  w-tes-ccs-dec              pic  9(01)                  .
      ...
      *            *  - N : No                                         *
      *            *---------------------------------------------------*
               10  w-rig-acc-snx-sos      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Si/No sostituzione modificabile                   *
      *            *  - S : Si                                         *
      *            *  - N : No                                         *
      *            *---------------------------------------------------*
               10  w-rig-acc-snx-smo      pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Salvataggio per tipo componente da sostituire         *
      *        *-------------------------------------------------------*
           05  w-sav-cds-tip              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Salvataggio per tipo componente che sostituisce       *
      *        *-------------------------------------------------------*
           05  w-sav-ccs-tip              pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo tipo componente da sostituire         *
      *        *-------------------------------------------------------*
           05  w-exp-cds-tip.
               10  w-exp-cds-tip-num      pic  9(02)       value 3    .
               10  w-exp-cds-tip-lun      pic  9(02)       value 40   .
               10  w-exp-cds-tip-tbl.
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Tipo tipo componente che sostituisce       *
      *        *-------------------------------------------------------*
           05  w-exp-ccs-tip.
               10  w-exp-ccs-tip-num      pic  9(02)       value 3    .
               10  w-exp-ccs-tip-lun      pic  9(02)       value 40   .
               10  w-exp-ccs-tip-tbl.
                   15  filler             pic  x(40) value
                            "Materia prima                           ".
                   15  filler             pic  x(40) value
                            "Semilavorato                            ".
      ...
      *        * cui eseguire il controllo di non-involuzione          *
      *        *-------------------------------------------------------*
           05  w-ctl-nib.
      *            *---------------------------------------------------*
      ...
      *                  * Componente da sostituire, tipo              *
      *                  *---------------------------------------------*
           perform   acc-cds-tip-000      thru acc-cds-tip-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
       acc-tes-reg-110.
      *                  *---------------------------------------------*
      *                  * Componente da sostituire, codice            *
      *                  *---------------------------------------------*
           perform   acc-cds-cod-000      thru acc-cds-cod-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
                     go to acc-tes-reg-100.
      ...
      *                  * Componente che sostituisce, tipo            *
      *                  *---------------------------------------------*
           perform   acc-ccs-tip-000      thru acc-ccs-tip-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
       ...
       acc-tes-reg-130.
      *                  *---------------------------------------------*
      *                  * Componente che sostituisce, codice          *
      *                  *---------------------------------------------*
           perform   acc-ccs-cod-000      thru acc-ccs-cod-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
      ...
      *                  * Componente da sostituire, tipo              *
      *                  *---------------------------------------------*
           perform   vis-cds-tip-000      thru vis-cds-tip-999        .
      *                  *---------------------------------------------*
      *                  * Componente da sostituire, codice            *
      *                  *---------------------------------------------*
           perform   vis-cds-cod-000      thru vis-cds-cod-999        .
      *                  *---------------------------------------------*
      *                  * Componente che sostituisce, tipo            *
      *                  *---------------------------------------------*
           perform   vis-ccs-tip-000      thru vis-ccs-tip-999        .
      *                  *---------------------------------------------*
      *                  * Componente che sostituisce, codice          *
      *                  *---------------------------------------------*
           perform   vis-ccs-cod-000      thru vis-ccs-cod-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     vis-tes-reg-999.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Componente da sostituire, titolo            *
      *                  *---------------------------------------------*
           perform   pmt-cds-tit-000      thru pmt-cds-tit-999        .
      *                  *---------------------------------------------*
      *                  * Componente da sostituire, tipo              *
      *                  *---------------------------------------------*
           perform   pmt-cds-tip-000      thru pmt-cds-tip-999        .
      *                  *---------------------------------------------*
      *                  * Componente da sostituire, codice            *
      *                  *---------------------------------------------*
           perform   pmt-cds-cod-000      thru pmt-cds-cod-999        .
      *                  *---------------------------------------------*
      *                  * Componente che sostituisce, titolo          *
      *                  *---------------------------------------------*
           perform   pmt-ccs-tit-000      thru pmt-ccs-tit-999        .
      *                  *---------------------------------------------*
      *                  * Componente che sostituisce, tipo            *
      *                  *---------------------------------------------*
           perform   pmt-ccs-tip-000      thru pmt-ccs-tip-999        .
      *                  *---------------------------------------------*
      *                  * Componente che sostituisce, codice          *
      *                  *---------------------------------------------*
           perform   pmt-ccs-cod-000      thru pmt-ccs-cod-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     pmt-tes-reg-999.
      ...
      *    *===========================================================*
      *    * Prompt per componente da sostituire, titolo               *
      *    *-----------------------------------------------------------*
       pmt-cds-tit-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "                     Componente che deve essere so
      -              "stituito                      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *    *===========================================================*
      *    * Prompt per componente da sostituire, tipo                 *
      *    *-----------------------------------------------------------*
       pmt-cds-tip-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt per componente da sostituire, codice               *
      *    *-----------------------------------------------------------*
       pmt-cds-cod-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           if        w-tes-cds-tip        =    "M"
                     move  "Codice materia prima   :"
                                          to   v-alf
           else if   w-tes-cds-tip        =    "S"
                     move  "Codice semilavorato    :"
                                          to   v-alf
           else if   w-tes-cds-tip        =    "D"
      ...
      *    *===========================================================*
      *    * Prompt per componente che sostituisce, titolo             *
      *    *-----------------------------------------------------------*
       pmt-ccs-tit-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *
           ...
           move      15                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "                       Componente che va' in sosti
      -              "tuzione                       "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *    *===========================================================*
      *    * Prompt per componente che sostituisce, tipo               *
      *    *-----------------------------------------------------------*
       pmt-ccs-tip-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt per componente che sostituisce, codice             *
      *    *-----------------------------------------------------------*
       pmt-ccs-cod-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           if        w-tes-ccs-tip        =    "M"
                     move  "Codice materia prima   :"
                                          to   v-alf
           else if   w-tes-ccs-tip        =    "S"
                     move  "Codice semilavorato    :"
                                          to   v-alf
           else if   w-tes-ccs-tip        =    "D"
                     move  "Codice sub-distinta    :"
                                          to   v-alf
           else      move  "Codice                 :"
                                          to   v-alf                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Componente da sostituire, tipo             *
      *    *-----------------------------------------------------------*
       acc-cds-tip-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      w-tes-cds-tip        to   w-sav-cds-tip          .
       acc-cds-tip-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-cds-tip-lun    to   v-car                  .
           move      w-exp-cds-tip-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      09                   to   v-lin                  .
           move      26                   to   v-pos                  .
           move      w-exp-cds-tip-tbl    to   v-txt                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     ...
                     go to acc-cds-tip-999.
       acc-cds-tip-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "M"            to   w-tes-cds-tip
           else if   v-num                =    02
                     move  "S"            to   w-tes-cds-tip
           else if   v-num                =    03
                     move  "D"            to   w-tes-cds-tip
           else      move  spaces         to   w-tes-cds-tip          .
       acc-cds-tip-400.
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        w-tes-cds-tip        not  = spaces
                     go to acc-cds-tip-450.
           if        v-key                =    "UP  "
                     go to acc-cds-tip-450
           else      go to acc-cds-tip-600.
       acc-cds-tip-450.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
           go to     acc-cds-tip-600.
       acc-cds-tip-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cds-tip        =    w-sav-cds-tip
                     go to acc-cds-tip-800.
       acc-cds-tip-640.
      *                  *---------------------------------------------*
      ...
      *                  * nente                                       *
      *                  *---------------------------------------------*
           if        w-sav-cds-tip        not  = spaces
                     go to acc-cds-tip-660.
           perform   pmt-cds-cod-000      thru pmt-cds-cod-999        .
           go to     acc-cds-tip-800.
       acc-cds-tip-660.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cds-num          .
           move      spaces               to   w-tes-cds-alf          .
           move      spaces               to   w-tes-cds-des          .
           move      spaces               to   w-tes-cds-umi          .
           move      zero                 to   w-tes-cds-dec          .
      *                  *---------------------------------------------*
      *                  * Video in Off                                *
      *                  *---------------------------------------------*
           move      "OF"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazzione : Componente da sostituire, tipo         *
      *    *-----------------------------------------------------------*
       vis-cds-tip-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Componente da sostituire, codice           *
      *    *-----------------------------------------------------------*
       acc-cds-cod-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cds-tip        =    "M"
                     go to acc-cds-cod-100
           else if   w-tes-cds-tip        =    "S"
                     go to acc-cds-cod-200
           else if   w-tes-cds-tip        =    "D"
                     go to acc-cds-cod-300
           else      go to acc-cds-cod-900.
       acc-cds-cod-100.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Materia prima              *
      *              *-------------------------------------------------*
           perform   acc-cds-dpm-000      thru acc-cds-dpm-999        .
           go to     acc-cds-cod-999.
       acc-cds-cod-200.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Semilavorato               *
      *              *-------------------------------------------------*
           perform   acc-cds-dps-000      thru acc-cds-dps-999        .
           go to     acc-cds-cod-999.
       acc-cds-cod-300.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Subdistinta virtuale       *
      *              *-------------------------------------------------*
           perform   acc-cds-lgv-000      thru acc-cds-lgv-999        .
           go to     acc-cds-cod-999.
       acc-cds-cod-900.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Componente da sostituire, codice materia   *
      *    *                prima                                      *
      *    *-----------------------------------------------------------*
       acc-cds-dpm-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cds-num        to   w-cod-cod-dpm-num      .
           move      w-tes-cds-alf        to   w-cod-cod-dpm-alf      .
       ...
       acc-cds-dpm-110.
           ...
           if        w-cod-cod-dpm-ope    =    "F+"
                     go to acc-cds-dpm-115.
           if        w-cod-cod-dpm-ope    =    "AC"
                     go to acc-cds-dpm-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cds-dpm-115.
           perform   cod-cod-dpm-foi-000  thru cod-cod-dpm-foi-999    .
           go to     acc-cds-dpm-110.
       acc-cds-dpm-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-tes
                     go to acc-cds-dpm-999.
       acc-cds-dpm-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cds-num          .
           move      v-alf                to   w-tes-cds-alf          .
       acc-cds-dpm-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-cds-num        to   w-let-arc-dpm-num      .
      ...
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-dpm-des    to   w-tes-cds-des          .
           move      w-let-arc-dpm-umi    to   w-tes-cds-umi          .
           move      w-let-arc-dpm-deq    to   w-tes-cds-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cds-des-000      thru vis-cds-des-999        .
      *                  *---------------------------------------------*
      *                  * Se valore non trovato : reimpostazione      *
      *                  *---------------------------------------------*
           if        w-let-arc-dpm-flg    not  = spaces
                     go to acc-cds-dpm-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-cds-alf        not  = spaces
                     go to acc-cds-dpm-440.
           if        v-key                =    "UP  "
                     go to acc-cds-dpm-600
           else      go to acc-cds-dpm-100.
       acc-cds-dpm-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Componente da sostituire, codice semila-   *
      *    *                vorato                                     *
      *    *-----------------------------------------------------------*
       acc-cds-dps-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cds-num        to   w-cod-cod-dps-num      .
           move      w-tes-cds-alf        to   w-cod-cod-dps-alf      .
       ...
       acc-cds-dps-110.
           ...
           if        w-cod-cod-dps-ope    =    "F+"
                     go to acc-cds-dps-115.
           if        w-cod-cod-dps-ope    =    "AC"
                     go to acc-cds-dps-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cds-dps-115.
           perform   cod-cod-dps-foi-000  thru cod-cod-dps-foi-999    .
           go to     acc-cds-dps-110.
       acc-cds-dps-120.
      ...
      *                  *---------------------------------------------*
           move      w-tes-cds-num        to   w-let-arc-dps-num      .
      ...
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-dps-des    to   w-tes-cds-des          .
           move      w-let-arc-dps-umi    to   w-tes-cds-umi          .
           move      w-let-arc-dps-deq    to   w-tes-cds-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cds-des-000      thru vis-cds-des-999        .
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-dps-flg    not  = spaces
                     go to acc-cds-dps-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-cds-alf        not  = spaces
                     go to acc-cds-dps-440.
           if        v-key                =    "UP  "
                     go to acc-cds-dps-600
           else      go to acc-cds-dps-100.
       acc-cds-dps-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Componente da sostituire, codice sub-      *
      *    *                distinta virtuale                          *
      *    *-----------------------------------------------------------*
       acc-cds-lgv-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cds-num        to   w-cod-cod-lgv-num      .
           move      w-tes-cds-alf        to   w-cod-cod-lgv-alf      .
       ...
       acc-cds-lgv-110.
           ...
           if        w-cod-cod-lgv-ope    =    "F+"
                     go to acc-cds-lgv-115.
           if        w-cod-cod-lgv-ope    =    "AC"
                     go to acc-cds-lgv-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cds-lgv-115.
           perform   cod-cod-lgv-foi-000  thru cod-cod-lgv-foi-999    .
           go to     acc-cds-lgv-110.
       acc-cds-lgv-120.
      ...
      *                  *---------------------------------------------*
           move      w-tes-cds-num        to   w-let-arc-lgv-num      .
      ...
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-lgv-des    to   w-tes-cds-des          .
           move      w-let-arc-lgv-umi    to   w-tes-cds-umi          .
           move      w-let-arc-lgv-deq    to   w-tes-cds-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cds-des-000      thru vis-cds-des-999        .
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-lgv-flg    not  = spaces
                     go to acc-cds-lgv-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-cds-alf        not  = spaces
                     go to acc-cds-lgv-440.
           if        v-key                =    "UP  "
                     go to acc-cds-lgv-600
           else      go to acc-cds-lgv-100.
       acc-cds-lgv-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente da sostituire, codice compo- *
      *    *                   nente                                   *
      *    *-----------------------------------------------------------*
       vis-cds-cod-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   vis-cds-alf-000      thru vis-cds-alf-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione descrizione                     *
      *              *-------------------------------------------------*
           perform   vis-cds-des-000      thru vis-cds-des-999        .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente da sostituire, codice alfa-  *
      *    *                   numerico                                *
      *    *-----------------------------------------------------------*
       vis-cds-alf-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente da sostituire, descrizione   *
      *    *-----------------------------------------------------------*
       vis-cds-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Componente che sostituisce, tipo           *
      *    *-----------------------------------------------------------*
       acc-ccs-tip-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-tes-ccs-tip        to   w-sav-ccs-tip          .
       acc-ccs-tip-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-ccs-tip-lun    to   v-car                  .
           move      w-exp-ccs-tip-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      18                   to   v-lin                  .
           move      26                   to   v-pos                  .
           move      w-exp-ccs-tip-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           if        w-tes-ccs-tip        =    "M"
                     move  01             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-tes
                     go to acc-ccs-tip-999.
       acc-ccs-tip-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "M"            to   w-tes-ccs-tip
           else if   v-num                =    02
                     move  "S"            to   w-tes-ccs-tip
           else if   v-num                =    03
                     move  "D"            to   w-tes-ccs-tip
           else      move  spaces         to   w-tes-ccs-tip          .
       acc-ccs-tip-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        w-tes-ccs-tip        not  = spaces
                     go to acc-ccs-tip-450.
           if        v-key                =    "UP  "
                     go to acc-ccs-tip-450
           else      go to acc-ccs-tip-600.
       acc-ccs-tip-450.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
           go to     acc-ccs-tip-600.
       acc-ccs-tip-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * cedente : nessuna dipendenza                *
      *                  *---------------------------------------------*
           if        w-tes-ccs-tip        =    w-sav-ccs-tip
                     go to acc-ccs-tip-800.
       acc-ccs-tip-640.
      *                  *---------------------------------------------*
      *                  * Se valore precedente indeterminato : solo   *
      *                  * visualizzazione prompt per codice compo-    *
      *                  * nente                                       *
      *                  *---------------------------------------------*
           if        w-sav-ccs-tip        not  = spaces
                     go to acc-ccs-tip-660.
           perform   pmt-ccs-cod-000      thru pmt-ccs-cod-999        .
           go to     acc-ccs-tip-800.
       acc-ccs-tip-660.
      *                  *---------------------------------------------*
      *                  * Normalizzazione per codice componente       *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-ccs-num          .
           move      spaces               to   w-tes-ccs-alf          .
           move      spaces               to   w-tes-ccs-des          .
           move      spaces               to   w-tes-ccs-umi          .
           move      zero                 to   w-tes-ccs-dec          .
      *                  *---------------------------------------------*
      *                  * Video in Off                                *
      *                  *---------------------------------------------*
           move      "OF"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazzione : Componente che sostituisce, tipo       *
      *    *-----------------------------------------------------------*
       vis-ccs-tip-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Componente che sostituisce, codice         *
      *    *-----------------------------------------------------------*
       acc-ccs-cod-000.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo componente        *
      *              *-------------------------------------------------*
           if        w-tes-ccs-tip        =    "M"
                     go to acc-ccs-cod-100
           else if   w-tes-ccs-tip        =    "S"
                     go to acc-ccs-cod-200
           else if   w-tes-ccs-tip        =    "D"
                     go to acc-ccs-cod-300
           else      go to acc-ccs-cod-900.
       acc-ccs-cod-100.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Materia prima              *
      *              *-------------------------------------------------*
           perform   acc-ccs-dpm-000      thru acc-ccs-dpm-999        .
           go to     acc-ccs-cod-999.
       acc-ccs-cod-200.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Semilavorato               *
      *              *-------------------------------------------------*
           perform   acc-ccs-dps-000      thru acc-ccs-dps-999        .
           go to     acc-ccs-cod-999.
       acc-ccs-cod-300.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Subdistinta virtuale       *
      *              *-------------------------------------------------*
           perform   acc-ccs-lgv-000      thru acc-ccs-lgv-999        .
           go to     acc-ccs-cod-999.
       acc-ccs-cod-900.
      *              *-------------------------------------------------*
      *              * Se tipo distinta indeterminato                  *
      ...
      *    *===========================================================*
      *    * Accettazione : Componente che sostituisce, codice materia *
      *    *                prima                                      *
      *    *-----------------------------------------------------------*
       acc-ccs-dpm-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-dpm-ope      .
           move      "A"                  to   w-cod-cod-dpm-tac      .
           move      w-tes-ccs-num        to   w-cod-cod-dpm-num      .
           move      w-tes-ccs-alf        to   w-cod-cod-dpm-alf      .
       ...
       acc-ccs-dpm-110.
           perform   cod-cod-dpm-cll-000  thru cod-cod-dpm-cll-999    .
           if        w-cod-cod-dpm-ope    =    "F+"
                     go to acc-ccs-dpm-115.
           if        w-cod-cod-dpm-ope    =    "AC"
                     go to acc-ccs-dpm-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-ccs-dpm-115.
           perform   cod-cod-dpm-foi-000  thru cod-cod-dpm-foi-999    .
           go to     acc-ccs-dpm-110.
       acc-ccs-dpm-120.
           move      w-cod-cod-dpm-num    to   v-num                  .
           move      w-cod-cod-dpm-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-tes
                     go to acc-ccs-dpm-999.
       acc-ccs-dpm-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-ccs-num          .
           move      v-alf                to   w-tes-ccs-alf          .
       acc-ccs-dpm-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura archivio [dpm]                      *
      *                  *---------------------------------------------*
           move      w-tes-ccs-num        to   w-let-arc-dpm-num      .
           perform   let-arc-dpm-000      thru let-arc-dpm-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione, unita' di mi-   *
      *                  * sura, e decimali quantita', relativi al     *
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-dpm-des    to   w-tes-ccs-des          .
           move      w-let-arc-dpm-umi    to   w-tes-ccs-umi          .
           move      w-let-arc-dpm-deq    to   w-tes-ccs-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-ccs-des-000      thru vis-ccs-des-999        .
      *                  *---------------------------------------------*
      *                  * Se valore non trovato : reimpostazione      *
      *                  *---------------------------------------------*
           if        w-let-arc-dpm-flg    not  = spaces
                     go to acc-ccs-dpm-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-ccs-alf        not  = spaces
                     go to acc-ccs-dpm-440.
           if        v-key                =    "UP  "
                     go to acc-ccs-dpm-600
           else      go to acc-ccs-dpm-100.
       acc-ccs-dpm-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Componente che sostituisce, codice semila- *
      *    *                vorato                                     *
      *    *-----------------------------------------------------------*
       acc-ccs-dps-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-dps-ope      .
           move      "A"                  to   w-cod-cod-dps-tac      .
           move      w-tes-ccs-num        to   w-cod-cod-dps-num      .
           move      w-tes-ccs-alf        to   w-cod-cod-dps-alf      .
           move      20                   to   w-cod-cod-dps-lin      .
           move      26                   to   w-cod-cod-dps-pos      .
           move      20                   to   w-cod-cod-dps-dln      .
           move      41                   to   w-cod-cod-dps-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
       ...
       acc-ccs-dps-110.
           perform   cod-cod-dps-cll-000  thru cod-cod-dps-cll-999    .
           if        w-cod-cod-dps-ope    =    "F+"
                     go to acc-ccs-dps-115.
           if        w-cod-cod-dps-ope    =    "AC"
                     go to acc-ccs-dps-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-ccs-dps-115.
           perform   cod-cod-dps-foi-000  thru cod-cod-dps-foi-999    .
           go to     acc-ccs-dps-110.
       acc-ccs-dps-120.
           move      w-cod-cod-dps-num    to   v-num                  .
           move      w-cod-cod-dps-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      ...
      *                  * Lettura archivio [dps]                      *
      *                  *---------------------------------------------*
           move      w-tes-ccs-num        to   w-let-arc-dps-num      .
           perform   let-arc-dps-000      thru let-arc-dps-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione, unita' di mi-   *
      *                  * sura, e decimali quantita', relativi al     *
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-dps-des    to   w-tes-ccs-des          .
           move      w-let-arc-dps-umi    to   w-tes-ccs-umi          .
           move      w-let-arc-dps-deq    to   w-tes-ccs-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-ccs-des-000      thru vis-ccs-des-999        .
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-dps-flg    not  = spaces
                     go to acc-ccs-dps-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-ccs-alf        not  = spaces
                     go to acc-ccs-dps-440.
           if        v-key                =    "UP  "
                     go to acc-ccs-dps-600
           else      go to acc-ccs-dps-100.
       acc-ccs-dps-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Componente che sostituisce, codice sub-    *
      *    *                distinta virtuale                          *
      *    *-----------------------------------------------------------*
       acc-ccs-lgv-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-lgv-ope      .
           move      "A"                  to   w-cod-cod-lgv-tac      .
           move      w-tes-ccs-num        to   w-cod-cod-lgv-num      .
           move      w-tes-ccs-alf        to   w-cod-cod-lgv-alf      .
           move      20                   to   w-cod-cod-lgv-lin      .
           move      26                   to   w-cod-cod-lgv-pos      .
           move      20                   to   w-cod-cod-lgv-dln      .
           move      41                   to   w-cod-cod-lgv-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
       ...
       acc-ccs-lgv-110.
           perform   cod-cod-lgv-cll-000  thru cod-cod-lgv-cll-999    .
           if        w-cod-cod-lgv-ope    =    "F+"
                     go to acc-ccs-lgv-115.
           if        w-cod-cod-lgv-ope    =    "AC"
                     go to acc-ccs-lgv-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-ccs-lgv-115.
           perform   cod-cod-lgv-foi-000  thru cod-cod-lgv-foi-999    .
           go to     acc-ccs-lgv-110.
       acc-ccs-lgv-120.
           move      w-cod-cod-lgv-num    to   v-num                  .
           move      w-cod-cod-lgv-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      ...
      *                  * Lettura archivio [lgv]                      *
      *                  *---------------------------------------------*
           move      w-tes-ccs-num        to   w-let-arc-lgv-num      .
           perform   let-arc-lgv-000      thru let-arc-lgv-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione, unita' di mi-   *
      *                  * sura, e decimali quantita', relativi al     *
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-lgv-des    to   w-tes-ccs-des          .
           move      w-let-arc-lgv-umi    to   w-tes-ccs-umi          .
           move      w-let-arc-lgv-deq    to   w-tes-ccs-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-ccs-des-000      thru vis-ccs-des-999        .
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-lgv-flg    not  = spaces
                     go to acc-ccs-lgv-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-ccs-alf        not  = spaces
                     go to acc-ccs-lgv-440.
           if        v-key                =    "UP  "
                     go to acc-ccs-lgv-600
           else      go to acc-ccs-lgv-100.
       acc-ccs-lgv-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente che sostituisce, codice com- *
      *    *                   ponente                                 *
      *    *-----------------------------------------------------------*
       vis-ccs-cod-000.
      *              *-------------------------------------------------*
      *              * Visualizzazione codice alfanumerico             *
      *              *-------------------------------------------------*
           perform   vis-ccs-alf-000      thru vis-ccs-alf-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione descrizione                     *
      *              *-------------------------------------------------*
           perform   vis-ccs-des-000      thru vis-ccs-des-999        .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente che sostituisce, codice al-  *
      *    *                   fanumerico                              *
      *    *-----------------------------------------------------------*
       vis-ccs-alf-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente che sostituisce, descrizione *
      *    *-----------------------------------------------------------*
       vis-ccs-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
      *                  * Accettazione Si/No sostituzione             *
      *                  *---------------------------------------------*
      ...
      *                      * Si/No sostituzione                      *
      *                      *-----------------------------------------*
           if        w-rig-acc-snx-sos    =    "N"
                     go to vis-lin-cor-544.
       vis-lin-cor-542.
           if        w-rig-acc-snx-smo    =    "N"
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       Distinte base in cui il componente da sosti
      -              "tuire viene utilizzato        "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *
      ...
      *
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Note : Tasto funzione [1] = Si sostituzione    Ret
      -              "urn = Criterio di sostituzione"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *
           ...
           move      21                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       Tasto funzione [2] = No sostituzione       
      -              "      inalterato              "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *    *===========================================================*
      *    * Accettazione : Si/No sostituzione componente              *
      *    *-----------------------------------------------------------*
       acc-snx-sos-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        v-key                =    spaces
                     go to acc-snx-sos-425
           else if   v-key                =    "[1] "
                     go to acc-snx-sos-450
           else if   v-key                =    "[2] "
                     go to acc-snx-sos-475
           else      go to acc-snx-sos-100.
       acc-snx-sos-425.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/No sostituzione componente           *
      *    *-----------------------------------------------------------*
       vis-snx-sos-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      72                   to   v-pos                  .
           if        w-rig-acc-snx-sos    =    "N"
                     if    w-rig-acc-snx-smo
                                          =    "N"
                           move  "   *** No"
                                          to   w-lin-imm-lit-snx
                     else  move  "       No"
                                          to   w-lin-imm-lit-snx
           else      if    w-rig-acc-snx-smo
                                          =    "N"
                           move  "Si ***   "
                                          to   w-lin-imm-lit-snx
                     else  move  "Si       "
      ...
      *              *-------------------------------------------------*
       cnt-tdo-nok-125.
      *                  *---------------------------------------------*
      *                  * Controllo su tipo componente da sostituire  *
      *                  *---------------------------------------------*
           if        w-tes-cds-tip        =    "M" or
                     w-tes-cds-tip        =    "S" or
                     w-tes-cds-tip        =    "D"
                     go to cnt-tdo-nok-150
           else if   w-tes-cds-tip        =    spaces
                     go to cnt-tdo-nok-127.
       cnt-tdo-nok-126.
           move      "Tipo componente da sostituire errato !            
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       cnt-tdo-nok-150.
      *                  *---------------------------------------------*
      *                  * Controllo su codice componente da sostitu-  *
      *                  * ire                                         *
      *                  *---------------------------------------------*
           if        w-tes-cds-num        not  = zero
                     go to cnt-tdo-nok-175.
       cnt-tdo-nok-151.
           move      "Manca il codice componente da sostituire !        
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-175.
      *                  *---------------------------------------------*
      *                  * Controllo su tipo componente che sostitui-  *
      *                  * sce                                         *
      *                  *---------------------------------------------*
           if        w-tes-ccs-tip        =    "M" or
                     w-tes-ccs-tip        =    "S" or
                     w-tes-ccs-tip        =    "D"
                     go to cnt-tdo-nok-200
           else if   w-tes-ccs-tip        =    spaces
                     go to cnt-tdo-nok-177.
       cnt-tdo-nok-176.
           move      "Tipo componente che sostituisce errato !          
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-177.
           move      "Manca il tipo componente che sostituisce !        
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-200.
      *                  *---------------------------------------------*
      ...
      *                  * nenti                                       *
      *                  *---------------------------------------------*
           if        w-tes-cds-tip        not  = w-tes-ccs-tip or
                     w-tes-cds-num        not  = w-tes-ccs-num
                     go to cnt-tdo-nok-225.
       cnt-tdo-nok-201.
           move      "Il componente che va' in sostituzione deve essere 
      -              "diverso        "    to   w-err-box-err-msg      .
           move      "dal componente che deve essere sostituito !       
      -              "               "    to   w-err-box-err-m02      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-225.
      *                  *---------------------------------------------*
      *                  * Eventuale messaggio di unita' di misura in- *
      *                  * congruente                                  *
      *                  *---------------------------------------------*
           if        w-tes-cds-umi        =    w-tes-ccs-umi
                     go to cnt-tdo-nok-250.
           move      "Attenzione : I due componenti hanno unita' di misu
      -              "ra diverse !   "    to   w-err-box-err-msg      .
      ...
      *                  * congruente                                  *
      *                  *---------------------------------------------*
           if        w-tes-cds-dec        =    w-tes-ccs-dec
                     go to cnt-tdo-nok-275.
           move      "Attenzione : I due componenti hanno numero decimal
      -              "i diversi !    "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
       cnt-tdo-nok-275.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-tes-cds-dec          .
      *              *-------------------------------------------------*
      *              * Componente che sostituisce                      *
      *              *-------------------------------------------------*
           move      spaces               to   w-tes-ccs-tip          .
           move      zero                 to   w-tes-ccs-num          .
           move      spaces               to   w-tes-ccs-alf          .
           move      spaces               to   w-tes-ccs-des          .
           move      spaces               to   w-tes-ccs-umi          .
      ...
      *              * Dati da accettazione                            *
      *              *-------------------------------------------------*
           move      spaces               to   w-rig-acc-snx-sos      .
           move      spaces               to   w-rig-acc-snx-smo      .
       nor-nok-rig-999.
           exit.
      ...
      *                      * Visualizzazione messaggio di errore     *
      *                      *-----------------------------------------*
           move      "Il componente da sostituire non e' mai utilizzato 
      -              "               "    to   w-err-box-err-msg      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cds-num        to   w-imp-scl-dtp-ndi      .
      ...
      *              *-------------------------------------------------*
       rou-sca-fin-310.
      *                  *---------------------------------------------*
      *                  * Caricamento del buffer, preliminare al con- *
      *                  * trollo di non involuzione vero e proprio    *
      *                  *---------------------------------------------*
           perform   buf-per-cni-000      thru buf-per-cni-999        .
      *                  *---------------------------------------------*
      *                  * Esecuzione del controllo di non involuzione *
      *                  * vero e proprio, sul buffer caricato         *
      *                  *---------------------------------------------*
      ...
      *
           ...
           move      11                   to   v-lin                  .
           move      07                   to   v-pos                  .
           move      " La sostituzione del componente [X] xxxxxxxxxxxxxx
      -              "                  " to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *
           ...
           move      12                   to   v-lin                  .
           move      07                   to   v-pos                  .
           move      "              con il componente [X] xxxxxxxxxxxxxx
      -              "                  " to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *              *-------------------------------------------------*
       ...
       rou-sca-fin-500.
      *              *-------------------------------------------------*
      *              * Aggiornamento del record con il nuovo componen- *
      *              * te, quello che va' in sostituzione              *
      *              *-------------------------------------------------*
       rou-sca-fin-510.
      *                  *---------------------------------------------*
      *                  * Tipo magazzino del nuovo componente         *
      *                  *---------------------------------------------*
           if        w-tes-ccs-tip        =    "M"
       ...
       rou-sca-fin-520.
      *                  *---------------------------------------------*
      *                  * Codice numerico del nuovo componente        *
      *                  *---------------------------------------------*
           move      w-tes-ccs-num        to   rf-lgr-nrm-cpt         .
       rou-sca-fin-530.
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico del nuovo componente    *
      *                  *---------------------------------------------*
           move      w-tes-ccs-alf        to   rf-lgr-afm-cpt         .
       rou-sca-fin-540.
      *                  *---------------------------------------------*
      *                  * Numero decimali per la quantita del nuovo   *
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-tes-ccs-dec        to   rf-lgr-dec-qta         .
       rou-sca-fin-600.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-lgr                 .
      *              *-------------------------------------------------*
      *              * Se errore in update : si ignora il record e     *
      *              * si ricicla per il trattamento del record suc-   *
      *              * cessivo                                         *
      *              *-------------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to rou-sca-fin-700.
       rou-sca-fin-700.
      *              *-------------------------------------------------*
      *              * Rilascio del lock del record                    *
      *              *-------------------------------------------------*
           move      "RL"                 to   f-ope                  .
           move      "pgm/dtp/fls/ioc/obj/ioflgr"
                                          to   s-pat                  .
      ...
      *    *        base, ma filtrando il componente da sostituire,    *
      *    *        sostituendolo con il componente che va' in sosti-  *
      *    *        tuzione                                            *
      *    *-----------------------------------------------------------*
       buf-per-cni-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       buf-per-cni-500.
      *              *-------------------------------------------------*
      *              * Bufferizzazione vera e propria di :             *
      *              *  - Numero progressivo del componente all'inter- *
      *              *    no della distinta                            *
      *              *  - Tipo magazzino del componente                *
      *              *  - Codice numerico magazzino del componente     *
      *              *  - Codice alfanumerico magazzino del componente *
      *              *-------------------------------------------------*
       buf-per-cni-510.
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda se il componente in e- *
      *                  * same corrisponde a quello da sostituire op- *
      *                  * pure no                                     *
      *                  *---------------------------------------------*
           if        rf-lgr-tpm-cpt       =    01
                     if    w-tes-cds-tip  =    "P"       and
                           w-tes-cds-num  =    rf-lgr-nrm-cpt
                           go to buf-per-cni-530
                     else  go to buf-per-cni-550.
           if        rf-lgr-tpm-cpt       =    02
                     if    w-tes-cds-tip  =    "S"       and
                           w-tes-cds-num  =    rf-lgr-nrm-cpt
                           go to buf-per-cni-530
                     else  go to buf-per-cni-550.
           if        rf-lgr-tpm-cpt       =    03
                     if    w-tes-cds-tip  =    "M"       and
                           w-tes-cds-num  =    rf-lgr-nrm-cpt
                           go to buf-per-cni-530
                     else  go to buf-per-cni-550.
           if        rf-lgr-tpm-cpt       =    99
                     if    w-tes-cds-tip  =    "D"       and
                           w-tes-cds-num  =    rf-lgr-nrm-cpt
                           go to buf-per-cni-530
                     else  go to buf-per-cni-550.
           go to     buf-per-cni-550.
       buf-per-cni-530.
      *                  *---------------------------------------------*
      *                  * Se il componente in esame corrisponde a     *
      ...
      *                          *-------------------------------------*
           if        w-tes-ccs-tip        =    "P"
                     move  01             to   w-ctl-nib-tpm-cpt
                                              (w-ctl-nib-num-cpt)
           else if   w-tes-ccs-tip        =    "S"
                     move  02             to   w-ctl-nib-tpm-cpt
                                              (w-ctl-nib-num-cpt)
           else if   w-tes-ccs-tip        =    "M"
      ...
      *                          * Codice numerico componente          *
      *                          *-------------------------------------*
           move      w-tes-ccs-num        to   w-ctl-nib-nrm-cpt
                                              (w-ctl-nib-num-cpt)     .
      *                          *-------------------------------------*
      *                          * Codice alfanumerico componente      *
      *                          *-------------------------------------*
           move      w-tes-ccs-alf        to   w-ctl-nib-afm-cpt
                                              (w-ctl-nib-num-cpt)     .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-ctl-nib-num-cpt    not  < w-ctl-nib-max-ele
                     go to buf-per-cni-900
           else      go to buf-per-cni-200.
       buf-per-cni-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
