      ...
      *                                                                *
      *                    Implosione scalare distinta base per una    *
      ...
      *        *-------------------------------------------------------*
           05  rel-tip-ass                pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Codice numerico dell'assieme                          *
      *        *-------------------------------------------------------*
           05  rel-num-ass                pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice alfanumerico dell'assieme                      *
      *        *-------------------------------------------------------*
           05  rel-alf-ass                pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione dell'assieme                              *
      *        *-------------------------------------------------------*
           05  rel-des-ass                pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Unita' di misura dell'assieme                         *
      *        *-------------------------------------------------------*
           05  rel-umi-ass                pic  x(03)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  rel-ipm-ass                pic  9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' di impiego, divisore                        *
      *        *-------------------------------------------------------*
           05  rel-ipd-ass                pic  9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' producibile                                 *
      *        *-------------------------------------------------------*
           05  rel-qtt-ass                pic  9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Annotazioni sull'impiego                              *
      *        *-------------------------------------------------------*
           05  rel-not-ass                pic  x(40)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "IMPLOSIONE SCALARE SUB-DISTINTA VIRTUALE"       .
      ...
      *        * Tipo di assieme                                       *
      *        *-------------------------------------------------------*
           05  w-mpn-tip-ass              pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Codice numerico dell'assieme                          *
      *        *-------------------------------------------------------*
           05  w-mpn-num-ass              pic  9(07)                  .
      ...
      *              * lativa al codice numerico del componente        *
      *              * esistente oppure no                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "MX"                 to   v-ope                  .
           move      "U"                  to   v-tip                  .
           move      "Conferma esecuzione implosione scalare (S/N/E) ?"
                                          to   v-not                  .
           move      "S"                  to   v-alf                  .
           move      "SNE"                to   v-msk                  .
           move      "DO  "               to   v-pfk (05)             .
      ...
      *                  * Composizione 1. riga                        *
      *                  *---------------------------------------------*
           move      "Non esiste alcun utilizzo in distinta da visualizz
      -              "are            "    to   w-err-box-err-msg      .
      *                  *---------------------------------------------*
      *                  * Composizione 2. riga                        *
      *                  *---------------------------------------------*
           move      spaces               to   w-err-box-err-m02      .
           string    "per la sub-distinta con codice "
                                delimited by   size
                     rr-alf-com
                                delimited by   spaces
                     " !"
      ...
      *              *-------------------------------------------------*
       ...
       qry-let-seq-100.
      *                  *---------------------------------------------*
      *                  * Lettura elemento successivo da implosione   *
      ...
      *                      * Tipo assieme                            *
      *                      *-----------------------------------------*
           move      w-imp-scl-dtp-tas    to   rel-tip-ass            .
           if        rel-tip-ass          not  = 01    and
                     rel-tip-ass          not  = 02    and
                     rel-tip-ass          not  = 03    and
                     rel-tip-ass          not  = 99
                     move  zero           to   rel-tip-ass            .
       qry-liv-det-140.
      *                      *-----------------------------------------*
      *                      * Codice numerico assieme                 *
      *                      *-----------------------------------------*
           if        rel-tip-ass          =    zero
                     move  zero           to   rel-num-ass
           else      move  w-imp-scl-dtp-nas
                                          to   rel-num-ass            .
       qry-liv-det-145.
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico assieme             *
      *                      *-----------------------------------------*
           if        rel-tip-ass          =    zero  or
                     w-imp-scl-dtp-ana    not  = spaces
                     move  spaces         to   rel-alf-ass
                     go to qry-liv-det-150.
           if        rel-tip-ass          =    01
                     move  rf-dcp-alf-pro to   rel-alf-ass
           else if   rel-tip-ass          =    02
                     move  rf-dps-alf-sem to   rel-alf-ass
           else if   rel-tip-ass          =    03
                     move  rf-dpm-alf-map to   rel-alf-ass
           else if   rel-tip-ass          =    99
                     move  rf-lgv-alf-lgv to   rel-alf-ass
           else      move  spaces         to   rel-alf-ass            .
       qry-liv-det-150.
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico assieme             *
      *                      *-----------------------------------------*
           if        rel-tip-ass          =    zero  or
                     w-imp-scl-dtp-ana    not  = spaces
                     move  spaces         to   rel-des-ass
                     go to qry-liv-det-155.
           if        rel-tip-ass          =    01
                     move  rf-dcp-des-pro to   rel-des-ass
           else if   rel-tip-ass          =    02
                     move  rf-dps-des-sem to   rel-des-ass
           else if   rel-tip-ass          =    03
                     move  rf-dpm-des-map to   rel-des-ass
           else if   rel-tip-ass          =    99
                     move  rf-lgv-des-lgv to   rel-des-ass
           else      move  spaces         to   rel-des-ass            .
       qry-liv-det-155.
      *                      *-----------------------------------------*
      *                      * Unita' di misura dell'assieme           *
      *                      *-----------------------------------------*
           if        rel-tip-ass          =    zero  or
                     w-imp-scl-dtp-ana    not  = spaces
                     move  spaces         to   rel-umi-ass
                     go to qry-liv-det-160.
           if        rel-tip-ass          =    01
                     move  rf-dcp-umi-ven to   rel-umi-ass
           else if   rel-tip-ass          =    02
                     move  rf-dps-umi-prd to   rel-umi-ass
           else if   rel-tip-ass          =    03
                     move  rf-dpm-umi-prd to   rel-umi-ass
           else if   rel-tip-ass          =    99
                     move  rf-lgv-umi-prd to   rel-umi-ass
           else      move  spaces         to   rel-umi-ass            .
       qry-liv-det-160.
      *                      *-----------------------------------------*
      *                      * Unita' di misura del componente         *
      *                      *-----------------------------------------*
           move      w-imp-scl-dtp-cum    to   rel-umi-com            .
       qry-liv-det-165.
      *                      *-----------------------------------------*
      *                      * Numero decimali quantita' del componen- *
      *                      * te                                      *
      *                      *-----------------------------------------*
           move      w-imp-scl-dtp-cnd    to   rel-deq-com            .
       qry-liv-det-170.
      *                      *-----------------------------------------*
      *                      * Quantita' di impiego, moltiplicatore    *
      *                      *-----------------------------------------*
           move      w-imp-scl-dtp-cmu    to   rel-ipm-ass            .
       qry-liv-det-175.
      *                      *-----------------------------------------*
      *                      * Quantita' di impiego, divisore          *
      *                      *-----------------------------------------*
           move      w-imp-scl-dtp-cdu    to   rel-ipd-ass            .
       qry-liv-det-180.
      *                      *-----------------------------------------*
      *                      * Quantita' producibile                   *
      *                      *-----------------------------------------*
           if        rel-tip-ass          =    zero
                     move  zero           to   rel-qtt-ass
           else      move  w-imp-scl-dtp-qta
                                          to   rel-qtt-ass            .
       qry-liv-det-185.
      *                      *-----------------------------------------*
      *                      * Annotazioni sull'impiego                *
      *                      *-----------------------------------------*
           if        rel-tip-ass          =    zero
                     move  spaces         to   rel-not-ass
           else      move  rf-lgr-not-cpt to   rel-not-ass            .
       qry-liv-det-200.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-imp-scl-dtp-liv    to   w-vis-dsp-vis          .
           if        w-vis-dsp-vis        >    07
      ...
      *                  *---------------------------------------------*
           ...
           move      w-imp-scl-dtp-liv    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-475.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       qry-liv-det-576.
      *                      *-----------------------------------------*
      *                      * Se esiste l'anagrafica dell'assieme si  *
      *                      * prepara il codice alfanumerico nel-     *
      *                      * l'area editata da visualizzare          *
      *                      *-----------------------------------------*
           if        w-imp-scl-dtp-ana    not  = spaces
                     go to qry-liv-det-577.
           if        w-imp-scl-dtp-tas    =    01
                     move  rf-dcp-alf-pro to   w-vis-edt-cod
           else if   w-imp-scl-dtp-tas    =    02
                     move  rf-dps-alf-sem to   w-vis-edt-cod
           else if   w-imp-scl-dtp-tas    =    03
                     move  rf-dpm-alf-map to   w-vis-edt-cod
           else if   w-imp-scl-dtp-tas    =    99
                     move  rf-lgv-alf-lgv to   w-vis-edt-cod
           else      go to qry-liv-det-577.
           go to     qry-liv-det-578.
       qry-liv-det-577.
      *                      *-----------------------------------------*
      *                      * Altrimenti si prepara il codice nume-   *
      *                      * rico                                    *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Editing                             *
      *                          *-------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<"                  to   v-edm                  .
           move      w-imp-scl-dtp-nas    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                          *-------------------------------------*
      *                          * Composizione                        *
      ...
      *                      *-----------------------------------------*
           ...
           if        w-imp-scl-dtp-tas    =    01 or
                     w-imp-scl-dtp-tas    =    02 or
                     w-imp-scl-dtp-tas    =    99
                     move  w-imp-scl-dtp-tas
                                          to   w-mpn-tip-ass
                     move  w-imp-scl-dtp-nas
                                          to   w-mpn-num-ass
           else      move  zero           to   w-mpn-tip-ass
                     move  zero           to   w-mpn-num-ass          .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-edt-cod        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-600.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "         Livello - Tipo assieme - Codice assieme -
      -              " Descrizione assieme          "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           else if   w-mpn-tip-ass        =    02
                     go to qry-trt-fun-530
           else if   w-mpn-tip-ass        =    99
      ...
      *                  *---------------------------------------------*
       qry-trt-fun-512.
      *                      *-----------------------------------------*
      *                      * Se programma di esplosione scalare pro- *
      *                      * dotto di vendita gia' attivo : uscita   *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       qry-trt-fun-518.
      *                      *-----------------------------------------*
      *                      * Scrittura variabile di i.p.c. 'num-ass' *
      *                      * per lo stesso livello di profondita'    *
      *                      * applicativa per il codice numerico del- *
      *                      * l'assieme di tipo prodotto di vendita   *
      *                      * da esplodere                            *
      *                      *-----------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *                  *---------------------------------------------*
       qry-trt-fun-532.
      *                      *-----------------------------------------*
      *                      * Se programma di esplosione scalare se-  *
      *                      * milavorato gia' attivo : uscita         *
      *                      *-----------------------------------------*
           move      "ESCSEM    "         to   w-spg-alf-gat          .
           perform   tst-spg-gat-000      thru tst-spg-gat-999        .
           if        w-spg-snx-gat        not  = spaces
                     go to qry-trt-fun-999.
       qry-trt-fun-534.
      ...
      *                      * per lo stesso livello di profondita'    *
      *                      * applicativa per il codice numerico del- *
      *                      * l'assieme di tipo semilavorato da e-    *
      *                      * splodere                                *
      *                      *-----------------------------------------*
           move      "PV"                 to   s-ope                  .
           move      "num-ass"            to   s-var                  .
      ...
      *                  *---------------------------------------------*
       qry-trt-fun-552.
      *                      *-----------------------------------------*
      *                      * Se programma di esplosione scalare sub- *
      *                      * distinta virtuale gia' attivo : uscita  *
      *                      *-----------------------------------------*
           move      "ESCSDV    "         to   w-spg-alf-gat          .
           perform   tst-spg-gat-000      thru tst-spg-gat-999        .
           if        w-spg-snx-gat        not  = spaces
                     go to qry-trt-fun-999.
       qry-trt-fun-554.
      ...
      *                      * per lo stesso livello di profondita'    *
      *                      * applicativa per il codice numerico del- *
      *                      * l'assieme di tipo sub-distinta virtuale *
      *                      * da esplodere                            *
      *                      *-----------------------------------------*
           move      "PV"                 to   s-ope                  .
           move      "num-ass"            to   s-var                  .
      ...
      *                  *---------------------------------------------*
       qry-trt-fun-612.
      *                      *-----------------------------------------*
      *                      * Se programma di esplosione riepilogata  *
      *                      * prodotto di vendita gia' attivo : usci- *
      *                      * ta                                      *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       qry-trt-fun-712.
      *                      *-----------------------------------------*
      *                      * Se programma di esplosione ad un livel- *
      *                      * lo prodotto di vendita gia' attivo : u- *
      *                      * scita                                   *
      *                      *-----------------------------------------*
