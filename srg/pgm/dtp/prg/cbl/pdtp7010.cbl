      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdtp7011:        *
      *                                                                *
      *                    Stampa valorizzazione unitaria su distinta  *
      *                    base per prodotti di vendita                *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  VALORIZZAZIONE PRODOTTI SU DISTINTA   "       .
      ...
      *        *-------------------------------------------------------*
      *        * Codice filtro di selezione per anagrafica prodotti    *
      *        *-------------------------------------------------------*
      ...
      *    *                    ne ed ordinamento anagrafica prodotti  *
      *    *-----------------------------------------------------------*
       vis-des-fso-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           if        rr-fso-dcp-ord       not  = 01 and
                     rr-fso-dcp-ord       not  = 02
