      ...
      *                                                                *
      *                    Implosione scalare distinta base per un     *
      *                    semilavorato                                *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "    IMPLOSIONE SCALARE SEMILAVORATO     "       .
      ...
      *                  *---------------------------------------------*
           move      w-ipc-num-com-val    to   w-let-arc-dps-num      .
      ...
      *                  *---------------------------------------------*
       ...
       pre-tip-fun-340.
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda se record [dps] esi-   *
      *                  * stente oppure no                            *
      *                  *---------------------------------------------*
      ...
      *                      * grafica semilavorato                    *
      *                      *-----------------------------------------*
       pre-tip-fun-411.
      *                          *-------------------------------------*
      *                          * Codice numerico                     *
      *                          *-------------------------------------*
           move      w-let-arc-dps-num    to   rr-num-com             .
      *                          *-------------------------------------*
      *                          * Codice alfanumerico                 *
      *                          *-------------------------------------*
           move      w-let-arc-dps-alf    to   rr-alf-com             .
      *                          *-------------------------------------*
      *                          * Descrizione                         *
      *                          *-------------------------------------*
           move      w-let-arc-dps-des    to   rr-des-com             .
      *                          *-------------------------------------*
      *                          * Unita' di misura                    *
      *                          *-------------------------------------*
           move      w-let-arc-dps-umi    to   rr-umi-com             .
      *                          *-------------------------------------*
      *                          * Numero decimali quantita'           *
      *                          *-------------------------------------*
           move      w-let-arc-dps-deq    to   rr-deq-com             .
       pre-tip-fun-420.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "<"                  to   v-edm                  .
           move      w-let-arc-dps-num    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-num-com           to   w-cod-cod-dps-num      .
           move      rr-alf-com           to   w-cod-cod-dps-alf      .
      ...
      *                  * Lettura archivio [dps]                      *
      *                  *---------------------------------------------*
           move      rr-num-com           to   w-let-arc-dps-num      .
           perform   let-arc-dps-000      thru let-arc-dps-999        .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           string    "per il semilavorato con codice "
                                delimited by   size
                     rr-alf-com
                                delimited by   spaces
                     " !"
