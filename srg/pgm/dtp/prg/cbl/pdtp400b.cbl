      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "    ESPLOSIONE SCALARE SEMILAVORATO     "       .
      ...
      *        *-------------------------------------------------------*
      *        * Per codice numerico dell'assieme di tipo semilavorato *
      *        *-------------------------------------------------------*
           05  w-ipc-num-ass.
      *            *---------------------------------------------------*
      *            * Si/No variabile di i.p.c. relativa al codice nu-  *
      *            * merico dell'assieme di tipo semilavorato          *
      *            *---------------------------------------------------*
               10  w-ipc-num-ass-snx      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore della variabile di i.p.c. relativa al co-  *
      *            * dice numerico dell'assieme di tipo semilavorato   *
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Codice numerico per l'assieme di tipo semilavorato    *
      *        *-------------------------------------------------------*
           05  rr-num-ass                 pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice alfanumerico per l'assieme di tipo semilavora- *
      *        * to                                                    *
      *        *-------------------------------------------------------*
           05  rr-alf-ass                 pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione per l'assieme di tipo semilavorato        *
      *        *-------------------------------------------------------*
           05  rr-des-ass                 pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Unita' di misura per l'assieme di tipo prsemilavorato *
      *        *-------------------------------------------------------*
           05  rr-umi-ass                 pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Numero decimali quantita' per l'assieme di tipo se-   *
      *        * milavorato                                            *
      *        *-------------------------------------------------------*
           05  rr-deq-ass                 pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Quantita' da esplodere per l'assieme di tipo semila-  *
      *        * vorato                                                *
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Lettura della variabile eventuale di i.p.c. per *
      *              * il codice numerico dell'assieme di semilavorato *
      *              *-------------------------------------------------*
      ...
      *    * numerico dell'assieme di tipo semilavorato                *
      *    *-----------------------------------------------------------*
       ipc-num-ass-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-ipc-num-ass-val    to   w-let-arc-dps-num      .
      ...
      *                          * Codice numerico                     *
      *                          *-------------------------------------*
           move      w-let-arc-dps-num    to   rr-num-ass             .
      *                          *-------------------------------------*
      *                          * Codice alfanumerico                 *
      *                          *-------------------------------------*
           move      w-let-arc-dps-alf    to   rr-alf-ass             .
      *                          *-------------------------------------*
      *                          * Descrizione                         *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-let-arc-dps-deq    to   rr-deq-ass             .
       pre-tip-fun-420.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       pre-tip-fun-440.
      *                      *-----------------------------------------*
      *                      * Lettura archivio [lgt] per il semilavo- *
      *                      * rato                                    *
      *                      *-----------------------------------------*
           move      02                   to   w-let-arc-lgt-tip      .
      ...
      *                          *-------------------------------------*
           ...
           string    "Distinta base per semilavorato "
                                delimited by   size
                     rr-alf-ass
                                delimited by   spaces
                     " non esistente !"
      ...
      *                      *-----------------------------------------*
           move      spaces               to   w-err-box-err-msg      .
           string    "Anagrafica semilavorato codice ("
                                delimited by   size
                     v-edt
                                delimited by   spaces
      ...
      *    *===========================================================*
      *    * Accettazione : Codice assieme di tipo semilavorato        *
      *    *-----------------------------------------------------------*
       acc-cod-ass-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
