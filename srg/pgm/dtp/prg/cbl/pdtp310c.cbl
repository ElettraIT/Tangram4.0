      ...
      *                                                                *
      *                    Affiancamento di un componente ad un altro  *
      *                    componente in tutte le distinte base in cui *
      *                    il componente cui affiancare compare        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " AFFIANCAMENTO COMPONENTI DISTINTE BASE "       .
      ...
      *        *-------------------------------------------------------*
      *        * Componente cui affiancare, tipo                       *
      *        *  - M : Materia prima                                  *
      *        *  - S : Semilavorato                                   *
      *        *  - D : Subdistinta virtuale                           *
      *        *-------------------------------------------------------*
           05  w-tes-cca-tip              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Componente cui affiancare, codice numerico            *
      *        *-------------------------------------------------------*
           05  w-tes-cca-num              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Componente cui affiancare, codice alfanumerico        *
      *        *-------------------------------------------------------*
           05  w-tes-cca-alf              pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Componente cui affiancare, descrizione                *
      *        *-------------------------------------------------------*
           05  w-tes-cca-des              pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Componente cui affiancare, unita' di misura           *
      *        *-------------------------------------------------------*
           05  w-tes-cca-umi              pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Componente cui affiancare, decimali quantita'         *
      *        *-------------------------------------------------------*
           05  w-tes-cca-dec              pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Componente in affiancamento, tipo                     *
      *        *  - M : Materia prima                                  *
      *        *  - S : Semilavorato                                   *
      *        *  - D : Subdistinta virtuale                           *
      *        *-------------------------------------------------------*
           05  w-tes-cia-tip              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Componente in affiancamento, codice numerico          *
      *        *-------------------------------------------------------*
           05  w-tes-cia-num              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Componente in affiancamento, codice alfanumerico      *
      *        *-------------------------------------------------------*
           05  w-tes-cia-alf              pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Componente in affiancamento, descrizione              *
      *        *-------------------------------------------------------*
           05  w-tes-cia-des              pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Componente in affiancamento, unita' di misura         *
      *        *-------------------------------------------------------*
           05  w-tes-cia-umi              pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Componente in affiancamento, decimali quantita'       *
      *        *-------------------------------------------------------*
           05  w-tes-cia-dec              pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Componente in affiancamento, quantita' di impiego,    *
      *        * moltiplicatore                                        *
      *        *-------------------------------------------------------*
           05  w-tes-cia-qim              pic  9(06)v9(03)            .
      ...
      *            *  - N : No                                         *
      *            *---------------------------------------------------*
               10  w-rig-acc-snx-aff      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Si/No affiancamento modificabile                  *
      *            *  - S : Si                                         *
      *            *  - N : No                                         *
      *            *---------------------------------------------------*
               10  w-rig-acc-snx-amo      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Quantita' di impiego, moltiplicatore              *
      *            *---------------------------------------------------*
               10  w-rig-acc-qta-ipm      pic  9(06)v9(03)            .
      *            *---------------------------------------------------*
      *            * Quantita' di impiego, divisore                    *
      *            *---------------------------------------------------*
               10  w-rig-acc-qta-ipd      pic  9(06)v9(03)            .
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Salvataggio per tipo componente cui affiancare        *
      *        *-------------------------------------------------------*
           05  w-sav-cca-tip              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Salvataggio per tipo componente in affiancamento      *
      *        *-------------------------------------------------------*
           05  w-sav-cia-tip              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Salvataggio per codice componente in affiancamento    *
      *        *-------------------------------------------------------*
           05  w-sav-cia-num              pic  9(07)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo componente cui affiancare             *
      *        *-------------------------------------------------------*
           05  w-exp-cca-tip.
               10  w-exp-cca-tip-num      pic  9(02)       value 3    .
               10  w-exp-cca-tip-lun      pic  9(02)       value 40   .
               10  w-exp-cca-tip-tbl.
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Tipo componente in affiancamento           *
      *        *-------------------------------------------------------*
           05  w-exp-cia-tip.
               10  w-exp-cia-tip-num      pic  9(02)       value 3    .
               10  w-exp-cia-tip-lun      pic  9(02)       value 40   .
               10  w-exp-cia-tip-tbl.
                   15  filler             pic  x(40) value
                            "Materia prima                           ".
                   15  filler             pic  x(40) value
                            "Semilavorato                            ".
      ...
      *        * cui eseguire il controllo di non-involuzione, ed i-   *
      *        * noltre per aggiunta finale del componente in affian-  *
      *        * camento                                               *
      *        *-------------------------------------------------------*
           05  w-ctl-nib.
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-ctl-nib-tpm-ass      pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Codice numerico magazzino dell'assieme da con-    *
      *            * trollare                                          *
      *            *---------------------------------------------------*
               10  w-ctl-nib-nrm-ass      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Codice alfanumerico magazzino dell'assieme da     *
      *            * controllare                                       *
      *            *---------------------------------------------------*
               10  w-ctl-nib-afm-ass      pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Numero di elementi caricati nel buffer, cioe' nu- *
      *            * mero di componenti della distinta base            *
      *            *---------------------------------------------------*
               10  w-ctl-nib-num-cpt      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Flag di aggiunta finale avvenuta                  *
      *            *  - Spaces : Si                                    *
      *            *  - #      : No per mancanza di spazio disponibile *
      *            *             come numero progressivo               *
      *            *  - N      : No in quanto il componente cui af-    *
      *            *             fiancare non fa' parte della distinta *
      *            *             base esaminata                        *
      *            *---------------------------------------------------*
               10  w-ctl-nib-flg-afa      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Numero progressivo riga nella distinta assegnato  *
      *            * in fase di aggiunta finale, se avvenuta           *
      *            *---------------------------------------------------*
               10  w-ctl-nib-flg-paf      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Salvataggio indice relativo al componente cui af- *
      *            * fiancare                                          *
      *            *---------------------------------------------------*
               10  w-ctl-nib-inx-001      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Comodo per indice relativo al componente cui af-  *
      *            * fiancare aumentato di 1                           *
      *            *---------------------------------------------------*
               10  w-ctl-nib-inx-002      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Comodo per numero progressivo precedente a quello *
      *            * di inserimento                                    *
      *            *---------------------------------------------------*
               10  w-ctl-nib-pro-001      pic  9(06)                  .
      *            *---------------------------------------------------*
      *            * Comodo per numero progressivo successivo a quello *
      *            * di inserimento                                    *
      *            *---------------------------------------------------*
               10  w-ctl-nib-pro-002      pic  9(06)                  .
      *            *---------------------------------------------------*
      *            * Comodo per numero progressivo di inserimento      *
      *            *---------------------------------------------------*
               10  w-ctl-nib-pro-ins      pic  9(06)                  .
      *            *---------------------------------------------------*
      *            * Indice per la scansione degli  elementi caricati  *
      *            * nel buffer, cioe' per la scansione dei componenti *
      *            *---------------------------------------------------*
               10  w-ctl-nib-inx-cpt      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Buffer per gli elementi caricati nel buffer, cioe'*
      *            * buffer per i componenti della distinta base       *
      *            *---------------------------------------------------*
               10  w-ctl-nib-buf-cpt.
      *                *-----------------------------------------------*
      *                * Massimo numero di elementi caricabili         *
      *                *-----------------------------------------------*
                   15  w-ctl-nib-max-ele  pic  9(05)       value 999  .
      *                *-----------------------------------------------*
      *                * Elementi nel buffer                           *
      *                *-----------------------------------------------*
                   15  w-ctl-nib-buf-ele  occurs 999.
      *                    *-------------------------------------------*
      *                    * Numero progressivo del componente all'in- *
      *                    * terno della distinta                      *
      *                    *-------------------------------------------*
                       20  w-ctl-nib-prg-cpt
                                          pic  9(05)                  .
      *                    *-------------------------------------------*
      *                    * Tipo magazzino del componente             *
      *                    *-------------------------------------------*
                       20  w-ctl-nib-tpm-cpt
                                          pic  9(02)                  .
      *                    *-------------------------------------------*
      *                    * Codice numerico magazzino del componente  *
      *                    *-------------------------------------------*
                       20  w-ctl-nib-nrm-cpt
                                          pic  9(07)                  .
      *                    *-------------------------------------------*
      *                    * Codice alfanumerico magazzino del compo-  *
      *                    * nente                                     *
      *                    *-------------------------------------------*
                       20  w-ctl-nib-afm-cpt
                                          pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Work-area per controllo di non-involuzione della di-  *
      *        * stinta base caricata nel buffer                       *
      *        *-------------------------------------------------------*
           05  w-ctl-nid.
      *            *---------------------------------------------------*
      *            * Flag di uscita                                    *
      ...
      *                  * Componente cui affiancare, tipo             *
      *                  *---------------------------------------------*
           perform   acc-cca-tip-000      thru acc-cca-tip-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
       acc-tes-reg-110.
      *                  *---------------------------------------------*
      *                  * Componente cui affiancare, codice           *
      *                  *---------------------------------------------*
           perform   acc-cca-cod-000      thru acc-cca-cod-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
                     go to acc-tes-reg-100.
      ...
      *                  * Componente in affiancamento, tipo           *
      *                  *---------------------------------------------*
           perform   acc-cia-tip-000      thru acc-cia-tip-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
       ...
       acc-tes-reg-130.
      *                  *---------------------------------------------*
      *                  * Componente in affiancamento, codice         *
      *                  *---------------------------------------------*
           perform   acc-cia-cod-000      thru acc-cia-cod-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
       ...
       acc-tes-reg-140.
      *                  *---------------------------------------------*
      *                  * Componente in affiancamento, quantita di    *
      *                  * impiego, moltiplicatore                     *
      *                  *---------------------------------------------*
           perform   acc-cia-qim-000      thru acc-cia-qim-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
      ...
      *                  * Componente cui affiancare, tipo             *
      *                  *---------------------------------------------*
           perform   vis-cca-tip-000      thru vis-cca-tip-999        .
      *                  *---------------------------------------------*
      *                  * Componente cui affiancare, codice           *
      *                  *---------------------------------------------*
           perform   vis-cca-cod-000      thru vis-cca-cod-999        .
      *                  *---------------------------------------------*
      *                  * Componente in affiancamento, tipo           *
      *                  *---------------------------------------------*
           perform   vis-cia-tip-000      thru vis-cia-tip-999        .
      *                  *---------------------------------------------*
      *                  * Componente in affiancamento, codice         *
      *                  *---------------------------------------------*
           perform   vis-cia-cod-000      thru vis-cia-cod-999        .
      *                  *---------------------------------------------*
      *                  * Componente in affiancamento, quantita' di   *
      *                  * impiego, moltiplicatore                     *
      *                  *---------------------------------------------*
           perform   vis-cia-qim-000      thru vis-cia-qim-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     vis-tes-reg-999.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Componente cui affiancare, titolo           *
      *                  *---------------------------------------------*
           perform   pmt-cca-tit-000      thru pmt-cca-tit-999        .
      *                  *---------------------------------------------*
      *                  * Componente cui affiancare, tipo             *
      *                  *---------------------------------------------*
           perform   pmt-cca-tip-000      thru pmt-cca-tip-999        .
      *                  *---------------------------------------------*
      *                  * Componente cui affiancare, codice           *
      *                  *---------------------------------------------*
           perform   pmt-cca-cod-000      thru pmt-cca-cod-999        .
      *                  *---------------------------------------------*
      *                  * Componente in affiancamento, titolo         *
      *                  *---------------------------------------------*
           perform   pmt-cia-tit-000      thru pmt-cia-tit-999        .
      *                  *---------------------------------------------*
      *                  * Componente in affiancamento, tipo           *
      *                  *---------------------------------------------*
           perform   pmt-cia-tip-000      thru pmt-cia-tip-999        .
      *                  *---------------------------------------------*
      *                  * Componente in affiancamento, codice         *
      *                  *---------------------------------------------*
           perform   pmt-cia-cod-000      thru pmt-cia-cod-999        .
      *                  *---------------------------------------------*
      *                  * Componente in affiancamento, quantita' di   *
      *                  * impiego, moltiplicatore                     *
      *                  *---------------------------------------------*
           perform   pmt-cia-qim-000      thru pmt-cia-qim-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     pmt-tes-reg-999.
      ...
      *    *===========================================================*
      *    * Prompt per componente cui affiancare, titolo              *
      *    *-----------------------------------------------------------*
       pmt-cca-tit-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "               Componente cui affiancare un ulteri
      -              "ore componente                "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *    *===========================================================*
      *    * Prompt per componente cui affiancare, tipo                *
      *    *-----------------------------------------------------------*
       pmt-cca-tip-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt per componente cui affiancare, codice              *
      *    *-----------------------------------------------------------*
       pmt-cca-cod-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           if        w-tes-cca-tip        =    "M"
                     move  "Codice materia prima   :"
                                          to   v-alf
           else if   w-tes-cca-tip        =    "S"
                     move  "Codice semilavorato    :"
                                          to   v-alf
           else if   w-tes-cca-tip        =    "D"
      ...
      *    *===========================================================*
      *    * Prompt per componente in affiancamento, titolo            *
      *    *-----------------------------------------------------------*
       pmt-cia-tit-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *
           ...
           move      14                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "                  Componente che si aggiunge in af
      -              "fiancamento                   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *    *===========================================================*
      *    * Prompt per componente in affiancamento, tipo              *
      *    *-----------------------------------------------------------*
       pmt-cia-tip-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt per componente in affiancamento, codice            *
      *    *-----------------------------------------------------------*
       pmt-cia-cod-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           if        w-tes-cia-tip        =    "M"
                     move  "Codice materia prima   :"
                                          to   v-alf
           else if   w-tes-cia-tip        =    "S"
                     move  "Codice semilavorato    :"
                                          to   v-alf
           else if   w-tes-cia-tip        =    "D"
                     move  "Codice sub-distinta    :"
                                          to   v-alf
           else      move  "Codice                 :"
                                          to   v-alf                  .
      ...
      *    *===========================================================*
      *    * Prompt per componente in affiancamento, quantita' di im-  *
      *    * piego, moltiplicatore                                     *
      *    *-----------------------------------------------------------*
       pmt-cia-qim-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Componente cui affiancare, tipo            *
      *    *-----------------------------------------------------------*
       acc-cca-tip-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      w-tes-cca-tip        to   w-sav-cca-tip          .
       acc-cca-tip-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-cca-tip-lun    to   v-car                  .
           move      w-exp-cca-tip-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      09                   to   v-lin                  .
           move      26                   to   v-pos                  .
           move      w-exp-cca-tip-tbl    to   v-txt                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     ...
                     go to acc-cca-tip-999.
       acc-cca-tip-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "M"            to   w-tes-cca-tip
           else if   v-num                =    02
                     move  "S"            to   w-tes-cca-tip
           else if   v-num                =    03
                     move  "D"            to   w-tes-cca-tip
           else      move  spaces         to   w-tes-cca-tip          .
       acc-cca-tip-400.
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        w-tes-cca-tip        not  = spaces
                     go to acc-cca-tip-450.
           if        v-key                =    "UP  "
                     go to acc-cca-tip-450
           else      go to acc-cca-tip-600.
       acc-cca-tip-450.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
           go to     acc-cca-tip-600.
       acc-cca-tip-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cca-tip        =    w-sav-cca-tip
                     go to acc-cca-tip-800.
       acc-cca-tip-640.
      *                  *---------------------------------------------*
      ...
      *                  * nente                                       *
      *                  *---------------------------------------------*
           if        w-sav-cca-tip        not  = spaces
                     go to acc-cca-tip-660.
           perform   pmt-cca-cod-000      thru pmt-cca-cod-999        .
           go to     acc-cca-tip-800.
       acc-cca-tip-660.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cca-num          .
           move      spaces               to   w-tes-cca-alf          .
           move      spaces               to   w-tes-cca-des          .
           move      spaces               to   w-tes-cca-umi          .
           move      zero                 to   w-tes-cca-dec          .
      *                  *---------------------------------------------*
      *                  * Video in Off                                *
      *                  *---------------------------------------------*
           move      "OF"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazzione : Componente cui affiancare, tipo        *
      *    *-----------------------------------------------------------*
       vis-cca-tip-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Componente cui affiancare, codice          *
      *    *-----------------------------------------------------------*
       acc-cca-cod-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cca-tip        =    "M"
                     go to acc-cca-cod-100
           else if   w-tes-cca-tip        =    "S"
                     go to acc-cca-cod-200
           else if   w-tes-cca-tip        =    "D"
                     go to acc-cca-cod-300
           else      go to acc-cca-cod-900.
       acc-cca-cod-100.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Materia prima              *
      *              *-------------------------------------------------*
           perform   acc-cca-dpm-000      thru acc-cca-dpm-999        .
           go to     acc-cca-cod-999.
       acc-cca-cod-200.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Semilavorato               *
      *              *-------------------------------------------------*
           perform   acc-cca-dps-000      thru acc-cca-dps-999        .
           go to     acc-cca-cod-999.
       acc-cca-cod-300.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Subdistinta virtuale       *
      *              *-------------------------------------------------*
           perform   acc-cca-lgv-000      thru acc-cca-lgv-999        .
           go to     acc-cca-cod-999.
       acc-cca-cod-900.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Componente cui affiancare, codice materia  *
      *    *                prima                                      *
      *    *-----------------------------------------------------------*
       acc-cca-dpm-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cca-num        to   w-cod-cod-dpm-num      .
           move      w-tes-cca-alf        to   w-cod-cod-dpm-alf      .
           move      10                   to   w-cod-cod-dpm-lin      .
           move      26                   to   w-cod-cod-dpm-pos      .
           move      10                   to   w-cod-cod-dpm-dln      .
       ...
       acc-cca-dpm-110.
           ...
           if        w-cod-cod-dpm-ope    =    "F+"
                     go to acc-cca-dpm-115.
           if        w-cod-cod-dpm-ope    =    "AC"
                     go to acc-cca-dpm-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cca-dpm-115.
           perform   cod-cod-dpm-foi-000  thru cod-cod-dpm-foi-999    .
           go to     acc-cca-dpm-110.
       acc-cca-dpm-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-tes
                     go to acc-cca-dpm-999.
       acc-cca-dpm-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cca-num          .
           move      v-alf                to   w-tes-cca-alf          .
       acc-cca-dpm-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-cca-num        to   w-let-arc-dpm-num      .
      ...
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-dpm-des    to   w-tes-cca-des          .
           move      w-let-arc-dpm-umi    to   w-tes-cca-umi          .
           move      w-let-arc-dpm-deq    to   w-tes-cca-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cca-des-000      thru vis-cca-des-999        .
      *                  *---------------------------------------------*
      *                  * Se valore non trovato : reimpostazione      *
      *                  *---------------------------------------------*
           if        w-let-arc-dpm-flg    not  = spaces
                     go to acc-cca-dpm-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-cca-alf        not  = spaces
                     go to acc-cca-dpm-440.
           if        v-key                =    "UP  "
                     go to acc-cca-dpm-600
           else      go to acc-cca-dpm-100.
       acc-cca-dpm-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Componente cui affiancare, codice semila-  *
      *    *                vorato                                     *
      *    *-----------------------------------------------------------*
       acc-cca-dps-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cca-num        to   w-cod-cod-dps-num      .
           move      w-tes-cca-alf        to   w-cod-cod-dps-alf      .
       ...
       acc-cca-dps-110.
           ...
           if        w-cod-cod-dps-ope    =    "F+"
                     go to acc-cca-dps-115.
           if        w-cod-cod-dps-ope    =    "AC"
                     go to acc-cca-dps-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cca-dps-115.
           perform   cod-cod-dps-foi-000  thru cod-cod-dps-foi-999    .
           go to     acc-cca-dps-110.
       acc-cca-dps-120.
      ...
      *                  *---------------------------------------------*
           move      w-tes-cca-num        to   w-let-arc-dps-num      .
      ...
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-dps-des    to   w-tes-cca-des          .
           move      w-let-arc-dps-umi    to   w-tes-cca-umi          .
           move      w-let-arc-dps-deq    to   w-tes-cca-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cca-des-000      thru vis-cca-des-999        .
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-dps-flg    not  = spaces
                     go to acc-cca-dps-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-cca-alf        not  = spaces
                     go to acc-cca-dps-440.
           if        v-key                =    "UP  "
                     go to acc-cca-dps-600
           else      go to acc-cca-dps-100.
       acc-cca-dps-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Componente cui affiancare, codice sub-     *
      *    *                distinta virtuale                          *
      *    *-----------------------------------------------------------*
       acc-cca-lgv-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cca-num        to   w-cod-cod-lgv-num      .
           move      w-tes-cca-alf        to   w-cod-cod-lgv-alf      .
           move      10                   to   w-cod-cod-lgv-lin      .
           move      26                   to   w-cod-cod-lgv-pos      .
           move      10                   to   w-cod-cod-lgv-dln      .
       ...
       acc-cca-lgv-110.
           ...
           if        w-cod-cod-lgv-ope    =    "F+"
                     go to acc-cca-lgv-115.
           if        w-cod-cod-lgv-ope    =    "AC"
                     go to acc-cca-lgv-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cca-lgv-115.
           perform   cod-cod-lgv-foi-000  thru cod-cod-lgv-foi-999    .
           go to     acc-cca-lgv-110.
       acc-cca-lgv-120.
      ...
      *                  *---------------------------------------------*
           move      w-tes-cca-num        to   w-let-arc-lgv-num      .
      ...
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-lgv-des    to   w-tes-cca-des          .
           move      w-let-arc-lgv-umi    to   w-tes-cca-umi          .
           move      w-let-arc-lgv-deq    to   w-tes-cca-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cca-des-000      thru vis-cca-des-999        .
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-lgv-flg    not  = spaces
                     go to acc-cca-lgv-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-cca-alf        not  = spaces
                     go to acc-cca-lgv-440.
           if        v-key                =    "UP  "
                     go to acc-cca-lgv-600
           else      go to acc-cca-lgv-100.
       acc-cca-lgv-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente cui affiancare, codice       *
      *    *                   componente                              *
      *    *-----------------------------------------------------------*
       vis-cca-cod-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   vis-cca-alf-000      thru vis-cca-alf-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione descrizione                     *
      *              *-------------------------------------------------*
           perform   vis-cca-des-000      thru vis-cca-des-999        .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente cui affiancare, codice alfa- *
      *    *                   numerico                                *
      *    *-----------------------------------------------------------*
       vis-cca-alf-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente cui affiancare, descrizione  *
      *    *-----------------------------------------------------------*
       vis-cca-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Componente in affiancamento, tipo          *
      *    *-----------------------------------------------------------*
       acc-cia-tip-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-tes-cia-tip        to   w-sav-cia-tip          .
       acc-cia-tip-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-cia-tip-lun    to   v-car                  .
           move      w-exp-cia-tip-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      17                   to   v-lin                  .
           move      26                   to   v-pos                  .
           move      w-exp-cia-tip-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           if        w-tes-cia-tip        =    "M"
                     move  01             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-tes
                     go to acc-cia-tip-999.
       acc-cia-tip-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "M"            to   w-tes-cia-tip
           else if   v-num                =    02
                     move  "S"            to   w-tes-cia-tip
           else if   v-num                =    03
                     move  "D"            to   w-tes-cia-tip
           else      move  spaces         to   w-tes-cia-tip          .
       acc-cia-tip-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        w-tes-cia-tip        not  = spaces
                     go to acc-cia-tip-450.
           if        v-key                =    "UP  "
                     go to acc-cia-tip-450
           else      go to acc-cia-tip-600.
       acc-cia-tip-450.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
           go to     acc-cia-tip-600.
       acc-cia-tip-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * cedente : nessuna dipendenza                *
      *                  *---------------------------------------------*
           if        w-tes-cia-tip        =    w-sav-cia-tip
                     go to acc-cia-tip-800.
       acc-cia-tip-640.
      *                  *---------------------------------------------*
      *                  * Se valore precedente indeterminato : solo   *
      *                  * visualizzazione prompt per codice compo-    *
      *                  * nente                                       *
      *                  *---------------------------------------------*
           if        w-sav-cia-tip        not  = spaces
                     go to acc-cia-tip-660.
           perform   pmt-cia-cod-000      thru pmt-cia-cod-999        .
           go to     acc-cia-tip-800.
       acc-cia-tip-660.
      *                  *---------------------------------------------*
      *                  * Normalizzazione per codice componente       *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cia-num          .
           move      spaces               to   w-tes-cia-alf          .
           move      spaces               to   w-tes-cia-des          .
           move      spaces               to   w-tes-cia-umi          .
           move      zero                 to   w-tes-cia-dec          .
           move      zero                 to   w-tes-cia-qim          .
      *                  *---------------------------------------------*
      *                  * Video in Off                                *
      *                  *---------------------------------------------*
           move      "OF"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           perform   vis-cia-cod-000      thru vis-cia-cod-999        .
      *                  *---------------------------------------------*
      *                  * Visualizzazione quantita' di impiego, mol-  *
      *                  * tiplicatore                                 *
      *                  *---------------------------------------------*
           perform   vis-cia-qim-000      thru vis-cia-qim-999        .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazzione : Componente in affiancamento, tipo      *
      *    *-----------------------------------------------------------*
       vis-cia-tip-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Componente in affiancamento, codice        *
      *    *-----------------------------------------------------------*
       acc-cia-cod-000.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo componente        *
      *              *-------------------------------------------------*
           if        w-tes-cia-tip        =    "M"
                     go to acc-cia-cod-100
           else if   w-tes-cia-tip        =    "S"
                     go to acc-cia-cod-200
           else if   w-tes-cia-tip        =    "D"
                     go to acc-cia-cod-300
           else      go to acc-cia-cod-900.
       acc-cia-cod-100.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Materia prima              *
      *              *-------------------------------------------------*
           perform   acc-cia-dpm-000      thru acc-cia-dpm-999        .
           go to     acc-cia-cod-999.
       acc-cia-cod-200.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Semilavorato               *
      *              *-------------------------------------------------*
           perform   acc-cia-dps-000      thru acc-cia-dps-999        .
           go to     acc-cia-cod-999.
       acc-cia-cod-300.
      *              *-------------------------------------------------*
      *              * Se tipo componente : Subdistinta virtuale       *
      *              *-------------------------------------------------*
           perform   acc-cia-lgv-000      thru acc-cia-lgv-999        .
           go to     acc-cia-cod-999.
       acc-cia-cod-900.
      *              *-------------------------------------------------*
      *              * Se tipo distinta indeterminato                  *
      ...
      *    *===========================================================*
      *    * Accettazione : Componente in affiancamento, codice mate-  *
      *    *                ria prima                                  *
      *    *-----------------------------------------------------------*
       acc-cia-dpm-000.
      *              *-------------------------------------------------*
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-tes-cia-num        to   w-sav-cia-num          .
       acc-cia-dpm-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-dpm-ope      .
           move      "A"                  to   w-cod-cod-dpm-tac      .
           move      w-tes-cia-num        to   w-cod-cod-dpm-num      .
           move      w-tes-cia-alf        to   w-cod-cod-dpm-alf      .
       ...
       acc-cia-dpm-110.
           perform   cod-cod-dpm-cll-000  thru cod-cod-dpm-cll-999    .
           if        w-cod-cod-dpm-ope    =    "F+"
                     go to acc-cia-dpm-115.
           if        w-cod-cod-dpm-ope    =    "AC"
                     go to acc-cia-dpm-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cia-dpm-115.
           perform   cod-cod-dpm-foi-000  thru cod-cod-dpm-foi-999    .
           go to     acc-cia-dpm-110.
       acc-cia-dpm-120.
           move      w-cod-cod-dpm-num    to   v-num                  .
           move      w-cod-cod-dpm-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-tes
                     go to acc-cia-dpm-999.
       acc-cia-dpm-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cia-num          .
           move      v-alf                to   w-tes-cia-alf          .
       acc-cia-dpm-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura archivio [dpm]                      *
      *                  *---------------------------------------------*
           move      w-tes-cia-num        to   w-let-arc-dpm-num      .
           perform   let-arc-dpm-000      thru let-arc-dpm-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione, unita' di mi-   *
      *                  * sura, e decimali quantita', relativi al     *
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-dpm-des    to   w-tes-cia-des          .
           move      w-let-arc-dpm-umi    to   w-tes-cia-umi          .
           move      w-let-arc-dpm-deq    to   w-tes-cia-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cia-des-000      thru vis-cia-des-999        .
      *                  *---------------------------------------------*
      *                  * Se valore non trovato : reimpostazione      *
      *                  *---------------------------------------------*
           if        w-let-arc-dpm-flg    not  = spaces
                     go to acc-cia-dpm-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-cia-alf        not  = spaces
                     go to acc-cia-dpm-440.
           if        v-key                =    "UP  "
                     go to acc-cia-dpm-600
           else      go to acc-cia-dpm-100.
       acc-cia-dpm-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *                  * cedente : nessuna dipendenza                *
      *                  *---------------------------------------------*
           if        w-tes-cia-num        =    w-sav-cia-num
                     go to acc-cia-dpm-800.
      *                  *---------------------------------------------*
      *                  * Se valore precedente indeterminato : nes-   *
      *                  * suna azione                                 *
      *                  * nente                                       *
      *                  *---------------------------------------------*
           if        w-sav-cia-num        =    zero
                     go to acc-cia-dpm-800.
      *                  *---------------------------------------------*
      *                  * Normalizzazione per quantita' di impiego,   *
      *                  * moltiplicatore                              *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cia-qim          .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Componente in affiancamento, codice semi-  *
      *    *                lavorato                                   *
      *    *-----------------------------------------------------------*
       acc-cia-dps-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-dps-ope      .
           move      "A"                  to   w-cod-cod-dps-tac      .
           move      w-tes-cia-num        to   w-cod-cod-dps-num      .
           move      w-tes-cia-alf        to   w-cod-cod-dps-alf      .
       ...
       acc-cia-dps-110.
           perform   cod-cod-dps-cll-000  thru cod-cod-dps-cll-999    .
           if        w-cod-cod-dps-ope    =    "F+"
                     go to acc-cia-dps-115.
           if        w-cod-cod-dps-ope    =    "AC"
                     go to acc-cia-dps-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cia-dps-115.
           perform   cod-cod-dps-foi-000  thru cod-cod-dps-foi-999    .
           go to     acc-cia-dps-110.
       acc-cia-dps-120.
           move      w-cod-cod-dps-num    to   v-num                  .
           move      w-cod-cod-dps-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      ...
      *                  * Lettura archivio [dps]                      *
      *                  *---------------------------------------------*
           move      w-tes-cia-num        to   w-let-arc-dps-num      .
           perform   let-arc-dps-000      thru let-arc-dps-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione, unita' di mi-   *
      *                  * sura, e decimali quantita', relativi al     *
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-dps-des    to   w-tes-cia-des          .
           move      w-let-arc-dps-umi    to   w-tes-cia-umi          .
           move      w-let-arc-dps-deq    to   w-tes-cia-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cia-des-000      thru vis-cia-des-999        .
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-dps-flg    not  = spaces
                     go to acc-cia-dps-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-cia-alf        not  = spaces
                     go to acc-cia-dps-440.
           if        v-key                =    "UP  "
                     go to acc-cia-dps-600
           else      go to acc-cia-dps-100.
       acc-cia-dps-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Componente in affiancamento, codice sub-   *
      *    *                distinta virtuale                          *
      *    *-----------------------------------------------------------*
       acc-cia-lgv-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-lgv-ope      .
           move      "A"                  to   w-cod-cod-lgv-tac      .
           move      w-tes-cia-num        to   w-cod-cod-lgv-num      .
           move      w-tes-cia-alf        to   w-cod-cod-lgv-alf      .
       ...
       acc-cia-lgv-110.
           perform   cod-cod-lgv-cll-000  thru cod-cod-lgv-cll-999    .
           if        w-cod-cod-lgv-ope    =    "F+"
                     go to acc-cia-lgv-115.
           if        w-cod-cod-lgv-ope    =    "AC"
                     go to acc-cia-lgv-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cia-lgv-115.
           perform   cod-cod-lgv-foi-000  thru cod-cod-lgv-foi-999    .
           go to     acc-cia-lgv-110.
       acc-cia-lgv-120.
           move      w-cod-cod-lgv-num    to   v-num                  .
           move      w-cod-cod-lgv-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      ...
      *                  * Lettura archivio [lgv]                      *
      *                  *---------------------------------------------*
           move      w-tes-cia-num        to   w-let-arc-lgv-num      .
           perform   let-arc-lgv-000      thru let-arc-lgv-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione, unita' di mi-   *
      *                  * sura, e decimali quantita', relativi al     *
      *                  * componente                                  *
      *                  *---------------------------------------------*
           move      w-let-arc-lgv-des    to   w-tes-cia-des          .
           move      w-let-arc-lgv-umi    to   w-tes-cia-umi          .
           move      w-let-arc-lgv-deq    to   w-tes-cia-dec          .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cia-des-000      thru vis-cia-des-999        .
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-lgv-flg    not  = spaces
                     go to acc-cia-lgv-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : reimpostazione a meno  *
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-cia-alf        not  = spaces
                     go to acc-cia-lgv-440.
           if        v-key                =    "UP  "
                     go to acc-cia-lgv-600
           else      go to acc-cia-lgv-100.
       acc-cia-lgv-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente in affiancamento, codice     *
      *    *                   componente                              *
      *    *-----------------------------------------------------------*
       vis-cia-cod-000.
      *              *-------------------------------------------------*
      *              * Visualizzazione codice alfanumerico             *
      *              *-------------------------------------------------*
           perform   vis-cia-alf-000      thru vis-cia-alf-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione descrizione                     *
      *              *-------------------------------------------------*
           perform   vis-cia-des-000      thru vis-cia-des-999        .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente in affiancamento, codice al- *
      *    *                   fanumerico                              *
      *    *-----------------------------------------------------------*
       vis-cia-alf-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente in affiancamento, descri-    *
      *    *                   zione                                   *
      *    *-----------------------------------------------------------*
       vis-cia-des-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Componente in affiancamento, quantita' di  *
      *    *                impiego, moltiplicatore                    *
      *    *-----------------------------------------------------------*
       acc-cia-qim-000.
      *              *-------------------------------------------------*
      ...
      *                  * fault                                       *
      *                  *---------------------------------------------*
           if        w-tes-cia-qim        =    zero
                     move  1,000          to   w-tes-cia-qim          .
       acc-cia-qim-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-tes
                     go to acc-cia-qim-999.
       acc-cia-qim-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cia-qim          .
       acc-cia-qim-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * che non sia stato premuto 'Up'              *
      *                  *---------------------------------------------*
           if        w-tes-cia-qim        not  = zero
                     go to acc-cia-qim-440.
           if        v-key                =    "UP  "
                     go to acc-cia-qim-600
           else      go to acc-cia-qim-100.
       acc-cia-qim-440.
      *                  *---------------------------------------------*
      *                  * Fine controlli                              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Componente in affiancamento, quantita'  *
      *    *                   di impiego, moltiplicatore              *
      *    *-----------------------------------------------------------*
       vis-cia-qim-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
      *                  * Accettazione Si/No affiancamento            *
      *                  *---------------------------------------------*
           perform   acc-snx-aff-000      thru acc-snx-aff-999        .
      ...
      *                      * Si/No affiancamento                     *
      *                      *-----------------------------------------*
           if        w-rig-acc-snx-aff    =    "N"
                     go to vis-lin-cor-544.
       vis-lin-cor-542.
           if        w-rig-acc-snx-amo    =    "N"
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       Distinte base in cui il componente cui affi
      -              "ancare viene utilizzato       "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *
      ...
      *
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Note : Tasto funzione [1] = Si affiancamento  Retu
      -              "rn = Criterio di affiancamento"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *
           ...
           move      21                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       Tasto funzione [2] = No affiancamento      
      -              "     inalterato               "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *    *===========================================================*
      *    * Accettazione : Si/No affiancamento componente             *
      *    *-----------------------------------------------------------*
       acc-snx-aff-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "[1] " or
                     v-key                =    "[2] "
                     go to acc-snx-aff-400.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-snx-aff-999.
      *              *-------------------------------------------------*
      *              * Se Up                                           *
      *              *-------------------------------------------------*
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           if        v-key                =    spaces
                     go to acc-snx-aff-425
           else if   v-key                =    "[1] "
                     go to acc-snx-aff-450
           else if   v-key                =    "[2] "
                     go to acc-snx-aff-475
           else      go to acc-snx-aff-100.
       acc-snx-aff-425.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/No affiancamento componente          *
      *    *-----------------------------------------------------------*
       vis-snx-aff-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      72                   to   v-pos                  .
           if        w-rig-acc-snx-aff    =    "N"
                     if    w-rig-acc-snx-amo
                                          =    "N"
                           move  "   *** No"
                                          to   w-lin-imm-lit-snx
                     else  move  "       No"
                                          to   w-lin-imm-lit-snx
           else      if    w-rig-acc-snx-amo
                                          =    "N"
                           move  "Si ***   "
                                          to   w-lin-imm-lit-snx
                     else  move  "Si       "
      ...
      *              *-------------------------------------------------*
       cnt-tdo-nok-125.
      *                  *---------------------------------------------*
      *                  * Controllo su tipo componente cui affiancare *
      *                  *---------------------------------------------*
           if        w-tes-cca-tip        =    "M" or
                     w-tes-cca-tip        =    "S" or
                     w-tes-cca-tip        =    "D"
                     go to cnt-tdo-nok-150
           else if   w-tes-cca-tip        =    spaces
                     go to cnt-tdo-nok-127.
       cnt-tdo-nok-126.
           move      "Tipo componente cui affiancare errato !           
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-127.
           move      "Manca il tipo componente da sostituire !          
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-150.
      *                  *---------------------------------------------*
      *                  * Controllo su codice componente cui affian-  *
      *                  * care                                        *
      *                  *---------------------------------------------*
           if        w-tes-cca-num        not  = zero
                     go to cnt-tdo-nok-175.
       cnt-tdo-nok-151.
           move      "Manca il codice componente cui affiancare !       
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-175.
      *                  *---------------------------------------------*
      *                  * Controllo su tipo componente in affianca-   *
      *                  * mento                                       *
      *                  *---------------------------------------------*
           if        w-tes-cia-tip        =    "M" or
                     w-tes-cia-tip        =    "S" or
                     w-tes-cia-tip        =    "D"
                     go to cnt-tdo-nok-200
           else if   w-tes-cia-tip        =    spaces
                     go to cnt-tdo-nok-177.
       cnt-tdo-nok-176.
           move      "Tipo componente in affiancamento errato !         
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-177.
           move      "Manca il tipo componente in affiancamento !       
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-200.
      *                  *---------------------------------------------*
      *                  * Controllo di non identita' tra i due compo- *
      *                  * nenti                                       *
      *                  *---------------------------------------------*
           if        w-tes-cca-tip        not  = w-tes-cia-tip or
                     w-tes-cca-num        not  = w-tes-cia-num
                     go to cnt-tdo-nok-225.
       cnt-tdo-nok-201.
           move      "Il componente che va' in affiancamento deve essere
      -              " diverso       "    to   w-err-box-err-msg      .
           move      "dal componente cui affiancare !                   
      -              "               "    to   w-err-box-err-m02      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-225.
      *                  *---------------------------------------------*
      *                  * Controllo sul componente in affiancamento,  *
      *                  * per quanto riguarda la quantita' di impie-  *
      *                  * go, moltiplicatore                          *
      *                  *---------------------------------------------*
           if        w-tes-cia-qim        not  = zero
                     go to cnt-tdo-nok-250.
       cnt-tdo-nok-226.
           move      "Manca la quantita' di impiego per il componente in
      -              " affiancamento!"    to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-250.
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
      *              *-------------------------------------------------*
      *              * Componente cui affiancare                       *
      *              *-------------------------------------------------*
           move      spaces               to   w-tes-cca-tip          .
           move      zero                 to   w-tes-cca-num          .
           move      spaces               to   w-tes-cca-alf          .
           move      spaces               to   w-tes-cca-des          .
           move      spaces               to   w-tes-cca-umi          .
           move      zero                 to   w-tes-cca-dec          .
      *              *-------------------------------------------------*
      *              * Componente in affiancamento                     *
      *              *-------------------------------------------------*
           move      spaces               to   w-tes-cia-tip          .
           move      zero                 to   w-tes-cia-num          .
           move      spaces               to   w-tes-cia-alf          .
           move      spaces               to   w-tes-cia-des          .
           move      spaces               to   w-tes-cia-umi          .
      ...
      *              * Dati da accettazione                            *
      *              *-------------------------------------------------*
           move      spaces               to   w-rig-acc-snx-aff      .
           move      spaces               to   w-rig-acc-snx-amo      .
           move      zero                 to   w-rig-acc-qta-ipm      .
           move      zero                 to   w-rig-acc-qta-ipd      .
       nor-nok-rig-999.
           exit.
      ...
      *                      * Visualizzazione messaggio di errore     *
      *                      *-----------------------------------------*
           move      "Il componente cui affiancare non e' mai utilizzato
      -              "               "    to   w-err-box-err-msg      .
           move      "in alcuna distinta !                              
      -              "               "    to   w-err-box-err-m02      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cca-num        to   w-imp-scl-dtp-ndi      .
      ...
      *                  *---------------------------------------------*
       ...
       srt-out-prc-285.
      *                  *---------------------------------------------*
      *                  * Si/No sostituzione da effettuare            *
      *                  *---------------------------------------------*
           move      "S"                  to   w-rig-acc-snx-aff      .
       srt-out-prc-290.
      *                  *---------------------------------------------*
      *                  * Si/No sostituzione modificabile             *
      *                  *---------------------------------------------*
           move      "S"                  to   w-rig-acc-snx-amo      .
       srt-out-prc-295.
      *                  *---------------------------------------------*
      *                  * Quantita' di impiego, moltiplicatore        *
      *                  *---------------------------------------------*
           move      w-tes-cia-qim        to   w-rig-acc-qta-ipm      .
       srt-out-prc-300.
      *                  *---------------------------------------------*
      *                  * Quantita' di impiego, divisore              *
      *                  *---------------------------------------------*
           move      1                    to   w-rig-acc-qta-ipd      .
       srt-out-prc-400.
      *              *-------------------------------------------------*
      ...
      *              * successivo                                      *
      *              *-------------------------------------------------*
           if        w-rig-acc-snx-aff    not  = "S"
                     go to rou-sca-fin-800.
       rou-sca-fin-200.
      *              *-------------------------------------------------*
      *              * Caricamento del buffer, preliminare al control- *
      *              * lo di non involuzione vero e proprio, con ag-   *
      *              * giunta finale del componente in affiancamento,  *
      *              * ed uscita con flag di avvenuta aggiunta         *
      *              *-------------------------------------------------*
           perform   buf-per-cni-000      thru buf-per-cni-999        .
      *              *-------------------------------------------------*
      *              * Se aggiunta finale del componente in affianca-  *
      *              * mento regolarmente avvenuta : continuazione per *
      *              * controllo di non involuzione                    *
      *              *-------------------------------------------------*
           if        w-ctl-nib-flg-afa    =    spaces
                     go to rou-sca-fin-300.
      *              *-------------------------------------------------*
      *              * Se aggiunta finale del componente in affianca-  *
      *              * mento non avvenuta perche' il componente cui    *
      *              * affiancare non fa' parte della distinta base e- *
      *              * saminata : si ignora il record e si ricicla per *
      *              * il trattamento del record successivo            *
      *              *-------------------------------------------------*
           if        w-ctl-nib-flg-afa    =    "N"
                     go to rou-sca-fin-800.
       rou-sca-fin-250.
      *              *-------------------------------------------------*
      *              * Altrimenti l'aggiunta finale del componente non *
      *              * e' avvenuta per mancanza di spazio per quanto   *
      *              * riguarda il numero progressivo riga; in questo  *
      *              * caso si emette un messaggio di errore e poi si  *
      *              * ignora il record e si ricicla per il trattamen- *
      *              * to del record successivo                        *
      *              *-------------------------------------------------*
       rou-sca-fin-255.
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      ...
      *
           ...
           move      11                   to   v-lin                  .
           move      07                   to   v-pos                  .
           move      " L'affiancamento al componente [X] xxxxxxxxxxxxxx 
      -              "                  " to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *
           ...
           move      12                   to   v-lin                  .
           move      07                   to   v-pos                  .
           move      "                del componente [X] xxxxxxxxxxxxxx 
      -              "                  " to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *
           ...
           move      15                   to   v-lin                  .
           move      07                   to   v-pos                  .
           move      "    in quanto manca lo spazio di numerazione per l
      -              "'inserimento.     " to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           move      "DS"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
       ...
       rou-sca-fin-300.
      *              *-------------------------------------------------*
      *              * Controllo di non involuzione della distinta ba- *
      *              * se                                              *
      *              *-------------------------------------------------*
           perform   ctl-nid-buf-000      thru ctl-nid-buf-999        .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       rou-sca-fin-330.
      *                  *---------------------------------------------*
      *                  * Messaggio di errore per involuzione         *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Salvataggio immagine video              *
      *                      *-----------------------------------------*
      ...
      *
           ...
           move      15                   to   v-lin                  .
           move      07                   to   v-pos                  .
           move      "    in quanto cio' provocherebbe un ciclo involuti
      -              "vo senza fine.    " to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           move      "DS"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
       ...
       rou-sca-fin-400.
      *              *-------------------------------------------------*
      *              * Composizione della riga di distinta base        *
      *              *-------------------------------------------------*
       rou-sca-fin-405.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       rou-sca-fin-420.
      *                  *---------------------------------------------*
      *                  * Numero progressivo riga nella distinta      *
      *                  *---------------------------------------------*
           move      w-ctl-nib-flg-paf    to   rf-lgr-num-prg         .
       rou-sca-fin-425.
      *                  *---------------------------------------------*
      *                  * Tipo magazzino per il componente            *
      *                  *---------------------------------------------*
           if        w-tes-cia-tip        =    "P"
                     move  01             to   rf-lgr-tpm-cpt
           else if   w-tes-cia-tip        =    "S"
                     move  02             to   rf-lgr-tpm-cpt
           else if   w-tes-cia-tip        =    "M"
                     move  03             to   rf-lgr-tpm-cpt
           else if   w-tes-cia-tip        =    "D"
                     move  99             to   rf-lgr-tpm-cpt
           else      move  03             to   rf-lgr-tpm-cpt         .
       rou-sca-fin-430.
      *                  *---------------------------------------------*
      *                  * Codice numerico magazzino per il componente *
      *                  *---------------------------------------------*
           move      w-tes-cia-num        to   rf-lgr-nrm-cpt         .
       rou-sca-fin-435.
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico magazzino per il compo- *
      *                  * nente                                       *
      *                  *---------------------------------------------*
           move      w-tes-cia-alf        to   rf-lgr-afm-cpt         .
       rou-sca-fin-440.
      *                  *---------------------------------------------*
      ...
      *                  * Numero decimali per la quantita' di impiego *
      *                  *---------------------------------------------*
           move      w-tes-cia-dec        to   rf-lgr-dec-qta         .
       rou-sca-fin-450.
      *                  *---------------------------------------------*
      *                  * Quantita' di impiego, moltiplicatore        *
      *                  *---------------------------------------------*
           move      w-rig-acc-qta-ipm    to   rf-lgr-qta-ipm         .
       rou-sca-fin-455.
      *                  *---------------------------------------------*
      *                  * Quantita' di impiego, divisore              *
      *                  *---------------------------------------------*
           move      w-rig-acc-qta-ipd    to   rf-lgr-qta-ipd         .
       rou-sca-fin-460.
      *                  *---------------------------------------------*
      *                  * Note relative al componente                 *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       rou-sca-fin-500.
      *              *-------------------------------------------------*
      *              * Scrittura della riga di distinta base           *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
           move      "pgm/dtp/fls/ioc/obj/ioflgr"
                                          to   s-pat                  .
           ...
           call      s-pat               using f
                                               rf-lgr                 .
      *              *-------------------------------------------------*
      *              * Se record gia' esistente : si ignora il record  *
      *              * e si ricicla per il trattamento del record suc- *
      *              * cessivo                                         *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Caricamento del buffer preliminare al controllo di non    *
      *    * involuzione                                               *
      *    *                                                           *
      *    * Nota : Il caricamento avviene per lettura della distinta  *
      *    *        base, aggiungendo alla fine un elemento per il     *
      *    *        componente da affiancare, con preparazione di un   *
      *    *        flag per aggiunta finale avvenuta correttamente e  *
      *    *        del numero progressivo riga di inserimento         *
      *    *-----------------------------------------------------------*
       buf-per-cni-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-rig-lgr-tpm-ass    to   w-ctl-nib-tpm-ass      .
      *                  *---------------------------------------------*
      *                  * Codice numerico magazzino dell'assieme      *
      *                  *---------------------------------------------*
           move      w-rig-lgr-nrm-ass    to   w-ctl-nib-nrm-ass      .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico magazzino dell'assieme  *
      *                  *---------------------------------------------*
           move      w-rig-ass-afm-ass    to   w-ctl-nib-afm-ass      .
       buf-per-cni-020.
      *                  *---------------------------------------------*
      *                  * Numero componenti caricati a zero           *
      *                  *---------------------------------------------*
           move      zero                 to   w-ctl-nib-num-cpt      .
      *                  *---------------------------------------------*
      *                  * Flag di uscita a spaces                     *
      *                  *---------------------------------------------*
           move      spaces               to   w-ctl-nib-flg-afa      .
      *                  *---------------------------------------------*
      *                  * Numero progressivo assegnato a zero         *
      *                  *---------------------------------------------*
           move      zero                 to   w-ctl-nib-flg-paf      .
      *                  *---------------------------------------------*
      *                  * Salvataggio indice corrispondente al compo- *
      *                  * nente cui affiancare a zero                 *
      *                  *---------------------------------------------*
           move      zero                 to   w-ctl-nib-inx-001      .
       buf-per-cni-100.
      *              *-------------------------------------------------*
      *              * Start su [lgr]                                  *
      *              *-------------------------------------------------*
           ...
           move      "TNMASS"             to   f-key                  .
           move      "NL"                 to   f-cfr                  .
           move      w-ctl-nib-tpm-ass    to   rf-lgr-tpm-ass         .
           move      w-ctl-nib-nrm-ass    to   rf-lgr-nrm-ass         .
      ...
      *              * camento                                         *
      *              *-------------------------------------------------*
           if        rf-lgr-tpm-ass       not  = w-ctl-nib-tpm-ass or
                     rf-lgr-nrm-ass       not  = w-ctl-nib-nrm-ass
                     go buf-per-cni-600.
       buf-per-cni-300.
      *              *-------------------------------------------------*
      *              * Incremento numero elementi presenti nel buffer  *
      *              *-------------------------------------------------*
           add       1                    to   w-ctl-nib-num-cpt      .
       buf-per-cni-350.
      *              *-------------------------------------------------*
      ...
      *                  * Numero progressivo                          *
      *                  *---------------------------------------------*
           move      rf-lgr-num-prg       to   w-ctl-nib-prg-cpt
                                              (w-ctl-nib-num-cpt)     .
      *                  *---------------------------------------------*
      *                  * Tipo componente                             *
      *                  *---------------------------------------------*
           move      rf-lgr-tpm-cpt       to   w-ctl-nib-tpm-cpt
                                              (w-ctl-nib-num-cpt)     .
      *                  *---------------------------------------------*
      *                  * Codice numerico componente                  *
      *                  *---------------------------------------------*
           move      rf-lgr-nrm-cpt       to   w-ctl-nib-nrm-cpt
                                              (w-ctl-nib-num-cpt)     .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico componente              *
      *                  *---------------------------------------------*
           move      rf-lgr-afm-cpt       to   w-ctl-nib-afm-cpt
                                              (w-ctl-nib-num-cpt)     .
       buf-per-cni-400.
      *              *-------------------------------------------------*
      *              * Se il componente letto corrisponde a quello cui *
      *              * affiancare, si memorizza il suo indice in ta-   *
      *              * bella, altrimenti si prosegue normalmente       *
      *              *-------------------------------------------------*
           if        rf-lgr-tpm-cpt       =    01
                     if    w-tes-cca-tip  =    "P"       and
                           w-tes-cca-num  =    rf-lgr-nrm-cpt
                           go to buf-per-cni-450
                     else  go to buf-per-cni-500.
           if        rf-lgr-tpm-cpt       =    02
                     if    w-tes-cca-tip  =    "S"       and
                           w-tes-cca-num  =    rf-lgr-nrm-cpt
                           go to buf-per-cni-450
                     else  go to buf-per-cni-500.
           if        rf-lgr-tpm-cpt       =    03
                     if    w-tes-cca-tip  =    "M"       and
                           w-tes-cca-num  =    rf-lgr-nrm-cpt
                           go to buf-per-cni-450
                     else  go to buf-per-cni-500.
           if        rf-lgr-tpm-cpt       =    99
                     if    w-tes-cca-tip  =    "D"       and
                           w-tes-cca-num  =    rf-lgr-nrm-cpt
                           go to buf-per-cni-450
                     else  go to buf-per-cni-500.
           go to     buf-per-cni-500.
       buf-per-cni-450.
      *              *-------------------------------------------------*
      *              * Memorizzazione dell'indice in tabella relativo  *
      *              * al componente cui affiancare                    *
      *              * bella, altrimenti si prosegue normalmente       *
      *              *-------------------------------------------------*
           move      w-ctl-nib-num-cpt    to   w-ctl-nib-inx-001      .
       buf-per-cni-500.
      *              *-------------------------------------------------*
      *              * Se e' stato raggiunto il massimo numero di ele- *
      *              * menti caricabili nel buffer si esce, con segna- *
      *              * le di aggiunta non possibile per mancanza di    *
      *              * spazio di inserimento                           *
      *              *-------------------------------------------------*
           if        w-ctl-nib-num-cpt    not  < w-ctl-nib-max-ele
                     move  "#"            to   w-ctl-nib-flg-afa
                     go to buf-per-cni-999.
      *              *-------------------------------------------------*
      *              * Altrimenti si ricicla a trattare il componente  *
      *              * successivo                                      *
      *              *-------------------------------------------------*
           go to     buf-per-cni-200.
       buf-per-cni-600.
      *              *-------------------------------------------------*
      *              * Fine caricamento buffer da righe distinta       *
      *              *-------------------------------------------------*
       buf-per-cni-650.
      *                  *---------------------------------------------*
      *                  * Se caricati zero elementi : uscita con il   *
      *                  * flag che indica la mancanza del componente  *
      *                  * cui affiancare in distinta esaminata        *
      *                  *---------------------------------------------*
           if        w-ctl-nib-num-cpt    =    zero
                     move  "N"            to   w-ctl-nib-flg-afa
                     go to buf-per-cni-999.
      *                  *---------------------------------------------*
      *                  * Se non e' stato incontrato nella scansione  *
      *                  * l'elemento corrispondente al componente cui *
      *                  * affiancare : uscita con il flag che indica  *
      *                  * la mancanza del componente cui affiancare   *
      *                  * in distinta esaminata                       *
      *                  *---------------------------------------------*
           if        w-ctl-nib-inx-001    =    zero
                     move  "N"            to   w-ctl-nib-flg-afa
                     go to buf-per-cni-999.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           add       1                    to   w-ctl-nib-num-cpt      .
      *                  *---------------------------------------------*
      *                  * Se cosi' si raggiunge il massimo numero di  *
      *                  * elementi caricabili nel buffer si esce, con *
      *                  * segnalele di aggiunta non possibile per     *
      *                  * mancanza di spazio di inserimento           *
      *                  *---------------------------------------------*
           if        w-ctl-nib-num-cpt    not  < w-ctl-nib-max-ele
                     move  "#"            to   w-ctl-nib-flg-afa
                     go to buf-per-cni-999.
      *                  *---------------------------------------------*
      *                  * Preparazione indice pari a quello relativo  *
      *                  * al componente cui affiancare, aumentato di  *
      *                  * 1                                           *
      *                  *---------------------------------------------*
           move      w-ctl-nib-inx-001    to   w-ctl-nib-inx-002      .
           add       1                    to   w-ctl-nib-inx-002      .
       buf-per-cni-700.
      *                  *---------------------------------------------*
      *                  * Controllo se inserimento possibile, e de-   *
      *                  * terminazione del numero progressivo di in-  *
      *                  * serimento                                   *
      *                  *---------------------------------------------*
       buf-per-cni-710.
      *                      *-----------------------------------------*
      *                      * Deviazione a seconda se l'aggiunta deve *
      *                      * essere eseguita in coda oppure no       *
      *                      *-----------------------------------------*
           if        w-ctl-nib-inx-002    =    w-ctl-nib-num-cpt
                     go to buf-per-cni-740.
       buf-per-cni-720.
      *                      *-----------------------------------------*
      *                      * Se l'aggiunta deve avvenire tra due e-  *
      *                      * lementi                                 *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Determinazione del numero progres-  *
      *                          * sivo riga precedente                *
      *                          *-------------------------------------*
           move      w-ctl-nib-prg-cpt
                    (w-ctl-nib-inx-001)   to   w-ctl-nib-pro-001      .
      *                          *-------------------------------------*
      *                          * Determinazione del numero progres-  *
      *                          * sivo riga successivo                *
      *                          *-------------------------------------*
           move      w-ctl-nib-prg-cpt
                    (w-ctl-nib-inx-002)   to   w-ctl-nib-pro-002      .
      *                          *-------------------------------------*
      *                          * Determinazione del numero progres-  *
      *                          * sivo riga di inserimento            *
      *                          *-------------------------------------*
           move      w-ctl-nib-pro-002    to   w-ctl-nib-pro-ins      .
           subtract  w-ctl-nib-pro-001    from w-ctl-nib-pro-ins      .
           divide    2                    into w-ctl-nib-pro-ins      .
           add       w-ctl-nib-pro-001    to   w-ctl-nib-pro-ins      .
      *                          *-------------------------------------*
      *                          * Se il numero progressivo riga di    *
      *                          * inserimento non e' accettabile : u- *
      *                          * scita con apposito segnale, altri-  *
      *                          * menti continuazione                 *
      *                          *-------------------------------------*
           if        w-ctl-nib-pro-ins    >    w-ctl-nib-pro-001 and
                     w-ctl-nib-pro-ins    <    w-ctl-nib-pro-002
                     go to buf-per-cni-800
           else      move  "#"            to   w-ctl-nib-flg-afa
                     go to buf-per-cni-999.
       buf-per-cni-740.
      *                      *-----------------------------------------*
      *                      * Se l'aggiunta deve avvenire in coda     *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Determinazione del numero progres-  *
      *                          * sivo riga precedente                *
      ...
      *                          * sivo riga di inserimento            *
      *                          *-------------------------------------*
           move      w-ctl-nib-pro-001    to   w-ctl-nib-pro-ins      .
           add       100                  to   w-ctl-nib-pro-ins      .
           divide    100                  into w-ctl-nib-pro-ins      .
           multiply  100                  by   w-ctl-nib-pro-ins      .
      *                          *-------------------------------------*
      *                          * Se il numero progressivo riga di    *
      *                          * inserimento non e' accettabile : u- *
      *                          * scita con apposito segnale, altri-  *
      *                          * menti continuazione                 *
      *                          *-------------------------------------*
           if        w-ctl-nib-pro-ins    >    w-ctl-nib-pro-001
                     go to buf-per-cni-800
           else      move  "#"            to   w-ctl-nib-flg-afa
                     go to buf-per-cni-999.
       buf-per-cni-800.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione componente aggiunto         *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Numero progressivo                      *
      *                      *-----------------------------------------*
           move      w-ctl-nib-pro-ins    to   w-ctl-nib-prg-cpt
                                              (w-ctl-nib-num-cpt)     .
      *                      *-----------------------------------------*
      *                      * Tipo componente                         *
      *                      *-----------------------------------------*
           if        w-tes-cia-tip        =    "M"
                     move  03             to   w-ctl-nib-tpm-cpt
                                              (w-ctl-nib-num-cpt)
           else if   w-tes-cia-tip        =    "S"
                     move  03             to   w-ctl-nib-tpm-cpt
                                              (w-ctl-nib-num-cpt)
           else if   w-tes-cia-tip        =    "D"
                     move  99             to   w-ctl-nib-tpm-cpt
                                              (w-ctl-nib-num-cpt)
           else      move  03             to   w-ctl-nib-tpm-cpt
                                              (w-ctl-nib-num-cpt)     .
      *                      *-----------------------------------------*
      *                      * Codice numerico componente              *
      *                      *-----------------------------------------*
           move      w-tes-cia-num        to   w-ctl-nib-nrm-cpt
                                              (w-ctl-nib-num-cpt)     .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico componente          *
      *                      *-----------------------------------------*
           move      w-tes-cia-alf        to   w-ctl-nib-afm-cpt
                                              (w-ctl-nib-num-cpt)     .
       buf-per-cni-850.
      *                  *---------------------------------------------*
      *                  * Numero progressivo assegnato in uscita      *
      *                  *---------------------------------------------*
           move      w-ctl-nib-pro-ins    to   w-ctl-nib-flg-paf      .
       buf-per-cni-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    * trova depositata nel buffer 'w-ctl-nib-buf-cpt'           *
      *    *                                                           *
      *    * --------------------------------------------------------- *
      *    *                                                           *
      *    * Si presume che in precedenza sia stato caricato il buffer *
      *    * in questione, e che di conseguenza siano stati fissati i  *
      *    * seguenti valori :                                         *
      *    *                                                           *
      *    * - w-ctl-nib-tpm-ass = Tipo magazzino relativo all'assieme *
      *    *                                                           *
      *    * - w-ctl-nib-nrm-ass = Codice numerico di magazzino rela-  *
      *    *                       tivo all'assieme                    *
      *    *                                                           *
      *    * - w-ctl-nib-afm-ass = Codice alfanumerico di magazzino    *
      *    *                       relativo all'assieme                *
      *    *                                                           *
      *    * - w-ctl-nib-num-cpt = Numero di componenti per l'assieme  *
      *    *                                                           *
      *    * - Inoltre, per ogni componente:                           *
      *    *                                                           *
      *    *   - w-ctl-nib-prg-cpt = Numero progressivo del componente *
      *    *                         all'interno della distinta        *
      *    *                                                           *
      *    *   - w-ctl-nib-tpm-cpt = Tipo magazzino relativo al compo- *
      *    *                         nente                             *
      *    *                                                           *
      *    *   - w-ctl-nib-nrm-cpt = Codice numerico di magazzino re-  *
      *    *                         lativo al componente              *
      *    *                                                           *
      *    *   - w-ctl-nib-afm-cpt = Codice alfanumerico di magazzino  *
      *    *                         relativo al componente            *
      *    *                                                           *
      *    * --------------------------------------------------------- *
      *    *                                                           *
      *    * Input  : Nessuno, in quanto tutti i parametri sono rica-  *
      *    *          vati dalla routine di caricamento che si presu-  *
      *    *          me essere stata eseguita per il caricamento del  *
      *    *          buffer dei componenti.                           *
      *    *                                                           *
      *    *                                                           *
      ...
      *                  *---------------------------------------------*
           move      w-ctl-nib-tpm-ass    to   w-ctl-nid-buf-tma (1)  .
      *                  *---------------------------------------------*
      *                  * Codice numerico magazzino per l'assieme in  *
      *                  * esame                                       *
      *                  *---------------------------------------------*
           move      w-ctl-nib-nrm-ass    to   w-ctl-nid-buf-nma (1)  .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico magazzino per l'assieme *
      *                  * in esame                                    *
      *                  *---------------------------------------------*
           move      w-ctl-nib-afm-ass    to   w-ctl-nid-buf-ama (1)  .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-ctl-nid-liv-att    =    01
                     go to ctl-nid-buf-120
           else      go to ctl-nid-buf-160.
       ctl-nid-buf-120.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-ctl-nid-buf-prg (1)
                                          =    zero
                     go to ctl-nid-buf-130
           else      go to ctl-nid-buf-140.
       ctl-nid-buf-130.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Operazione di Start sul buffer com- *
      *                          * ponenti                             *
      *                          *-------------------------------------*
           move      zero                 to   w-ctl-nib-inx-cpt      .
      *                          *-------------------------------------*
      *                          * Deviazione a seconda dell'esito     *
      *                          * della Start                         *
      *                          * - Se Ok : a Read Next               *
      ...
      *                          *-------------------------------------*
           if        w-ctl-nib-inx-cpt    <    w-ctl-nib-num-cpt
                     go to ctl-nid-buf-300
           else      go to ctl-nid-buf-200.
       ctl-nid-buf-140.
      *                      *-----------------------------------------*
      *                      * Se l'attuale numero progressivo elemen- *
      *                      * to in esame maggiore di zero            *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-ctl-nid-liv-att    =    zero
                     go to ctl-nid-buf-900
           else      go to ctl-nid-buf-100.
       ctl-nid-buf-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-ctl-nid-liv-att    =    01
                     go to ctl-nid-buf-320
           else      go to ctl-nid-buf-360.
       ctl-nid-buf-320.
      *                  *---------------------------------------------*
      *                  * Se livello di profondita' attuale = 01      *
      *                  *---------------------------------------------*
      ...
      *                      * - Se Ko : a Decremento di livello       *
      *                      *-----------------------------------------*
           if        w-ctl-nib-inx-cpt    not  > w-ctl-nib-num-cpt
                     go to ctl-nid-buf-400
           else      go to ctl-nid-buf-200.
       ctl-nid-buf-360.
      *                  *---------------------------------------------*
      *                  * Se livello di profondita' attuale > 01      *
      ...
      *                  *---------------------------------------------*
           if        w-ctl-nid-liv-att    =    01
                     go to ctl-nid-buf-420
           else      go to ctl-nid-buf-460.
       ctl-nid-buf-420.
      *                  *---------------------------------------------*
      *                  * Se livello di profondita' attuale = 01      *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-ctl-nid-liv-att    =    01
                     go to ctl-nid-buf-520
           else      go to ctl-nid-buf-560.
       ctl-nid-buf-520.
      *                  *---------------------------------------------*
      *                  * Se livello di profondita' attuale = 01      *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       ctl-nid-buf-526.
           ...
           if        w-ctl-nid-liv-inx    >    w-ctl-nid-liv-att
                     go to ctl-nid-buf-530.
           if        w-ctl-nid-buf-tma
                    (w-ctl-nid-liv-inx)   =    w-ctl-nib-tpm-cpt
                                              (w-ctl-nib-inx-cpt) and
                     w-ctl-nid-buf-nma
                    (w-ctl-nid-liv-inx)   =    w-ctl-nib-nrm-cpt
                                              (w-ctl-nib-inx-cpt)
                     go to ctl-nid-buf-527
           else      go to ctl-nid-buf-526.
       ctl-nid-buf-527.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-ctl-nib-prg-cpt
                    (w-ctl-nib-inx-cpt)   to   w-ctl-nid-buf-prg
                                              (w-ctl-nid-liv-att)     .
      *                          *-------------------------------------*
      *                          * Tipo magazzino componente           *
      *                          *-------------------------------------*
           move      w-ctl-nib-tpm-cpt
                    (w-ctl-nib-inx-cpt)   to   w-ctl-nid-buf-tmc
                                              (w-ctl-nid-liv-att)     .
      *                          *-------------------------------------*
      *                          * Codice numerico magazzino componen- *
      *                          * te                                  *
      *                          *-------------------------------------*
           move      w-ctl-nib-nrm-cpt
                    (w-ctl-nib-inx-cpt)   to   w-ctl-nid-buf-nmc
                                              (w-ctl-nid-liv-att)     .
      *                          *-------------------------------------*
      *                          * Codice alfanumerico magazzino com-  *
      *                          * ponente                             *
      *                          *-------------------------------------*
           move      w-ctl-nib-afm-cpt
                    (w-ctl-nib-inx-cpt)   to   w-ctl-nid-buf-amc
                                              (w-ctl-nid-liv-att)     .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-ctl-nid-buf-tmc
                    (w-ctl-nid-liv-att)   =    02 or
                     w-ctl-nid-buf-tmc
                    (w-ctl-nid-liv-att)   =    99
                     go to ctl-nid-buf-600
           else      go to ctl-nid-buf-300.
       ctl-nid-buf-560.
      *                  *---------------------------------------------*
      *                  * Se livello di profondita' attuale > 01      *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       ctl-nid-buf-566.
           add       1                    to   w-ctl-nid-liv-inx       .
           if        w-ctl-nid-liv-inx    >    w-ctl-nid-liv-att
                     go to ctl-nid-buf-570.
           if        w-ctl-nid-buf-tma
                    (w-ctl-nid-liv-inx)   =    rf-lgr-tpm-cpt and
                     w-ctl-nid-buf-nma
                    (w-ctl-nid-liv-inx)   =    rf-lgr-nrm-cpt
                     go to ctl-nid-buf-567
           else      go to ctl-nid-buf-566.
       ctl-nid-buf-567.
      *                      *-----------------------------------------*
      *                      * Uscita per involuzione                  *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-ctl-nid-liv-att    >    w-ctl-nid-max-liv
                     go to ctl-nid-buf-620
           else      go to ctl-nid-buf-660.
       ctl-nid-buf-620.
      *                  *---------------------------------------------*
      ...
      *                      * profondita                              *
      *                      *-----------------------------------------*
           go to     ctl-nid-buf-100.
       ctl-nid-buf-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     ctl-nid-buf-999.
       ctl-nid-buf-999.
           exit.
