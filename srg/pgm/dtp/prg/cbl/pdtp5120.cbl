      ...
      *                                   Fase:    dtp512              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 02/10/92    *
      *                       Ultima revisione:    NdK del 08/02/06    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdtp5121:        *
      *                                                                *
      *                    Stampa utilizzi semilavorati in distinte    *
      *                    base                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " UTILIZZI SEMILAVORATI IN DISTINTE BASE "       .
