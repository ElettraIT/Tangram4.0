      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdtp5021:        *
      *                                                                *
      ...
      *                                                                *
      * - Se stampa ad un livello : pdtp5021                           *
      * - Se stampa scalare       : pdtp5022                           *
      * - Se stampa riepilogata   : pdtp5023                           *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      08                   to   w-cod-zos-dps-lin      .
           move      30                   to   w-cod-zos-dps-pos      .
           move      08                   to   w-cod-zos-dps-dln      .
      ...
      *              *-------------------------------------------------*
           move      "pdtp5021"           to   i-exe-pro              .
           move      "pgm/dtp/prg/obj/pdtp5021"
                                          to   i-exe-pat              .
      ...
      *              * Tipo stampa : Scalare                           *
      *              *-------------------------------------------------*
           move      "pdtp5022"           to   i-exe-pro              .
           move      "pgm/dtp/prg/obj/pdtp5022"
                                          to   i-exe-pat              .
           go to     reg-ric-sel-999.
       reg-ric-sel-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "pdtp5023"           to   i-exe-pro              .
           move      "pgm/dtp/prg/obj/pdtp5023"
                                          to   i-exe-pat              .
           go to     reg-ric-sel-999.
       reg-ric-sel-999.
           exit.
