      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdtp3830 *
      *                                                                *
      *                    Stampa sub-distinte base senza distinta ba- *
      *                    se                                          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA SUB-DISTINTE SENZA DISTINTA BASE "       .
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Lettura record [lgt] per controllo di esistenza *
      *              * della distinta base                             *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           ...
           call      s-pat               using f
                                               rf-lgt                 .
      *                  *---------------------------------------------*
      *                  * Se record trovato : selezione non superata  *
      *                  *---------------------------------------------*
           if        f-sts                =    e-not-err
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              *-------------------------------------------------*
           move      "SUB-DISTINTE VIRTUALI SENZA DISTINTA BASE"
