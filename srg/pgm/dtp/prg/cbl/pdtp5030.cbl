      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdtp5031:        *
      *                                                                *
      *                    Stampa sub-distinte base virtuali           *
      *                                                                *
      * Il presente programma di richieste stampa richiama uno dei se- *
      * guenti sottoprogrammi di stampa a seconda del valore del campo *
      * di selezione tipo stampa richiesto :                           *
      *                                                                *
      * - Se stampa ad un livello : pdtp5031                           *
      * - Se stampa scalare       : pdtp5032                           *
      * - Se stampa riepilogata   : pdtp5033                           *
      *                                                                *
      *================================================================*
      ...
      *    *                                                           *
      *    * N.B.: i seguenti parametri non sono fissi come nella gene-*
      *    *       ralita' dei programmi di stampa, bensi' saranno va- *
      *    *       lorizzati nella routine reg-ric-sel-000/999 una vol-*
      *    *       ta che l'utente avra' scelto il tipo stampa da ese- *
      *    *       guire                                               *
      *    *-----------------------------------------------------------*
       01  i-exe.
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-stp.
               ...
               10  w-exp-tip-stp-lun      pic  9(02)       value 15   .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min-num       to   w-cod-cod-lgv-num      .
           move      rr-cod-min-alf       to   w-cod-cod-lgv-alf      .
           move      16                   to   w-cod-cod-lgv-lin      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-cod-min-num         .
           move      v-alf                to   rr-cod-min-alf         .
       acc-cod-min-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rr-cod-min-alf       to   w-all-str-alf          .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-lgv-ope      .
           move      "L"                  to   w-cod-cod-lgv-tac      .
           move      rr-cod-max-num       to   w-cod-cod-lgv-num      .
           move      rr-cod-max-alf       to   w-cod-cod-lgv-alf      .
           move      16                   to   w-cod-cod-lgv-lin      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-cod-max-num         .
           move      v-alf                to   rr-cod-max-alf         .
       acc-cod-max-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Test che non ci siano blank-embedded        *
      *                  *---------------------------------------------*
           move      rr-cod-max-alf       to   w-all-str-alf          .
           move      14                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        not  = spaces
      ...
      *                  *---------------------------------------------*
           ...
           move      "Manca il tipo ordinamento !"
                                          to   w-err-tdo-nok-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-200.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-cod-max-alf       =    spaces
                     go to tdo-ric-sel-400.
           if        rr-cod-max-alf       not  < rr-cod-min-alf
                     go to tdo-ric-sel-400.
      ...
      *              *-------------------------------------------------*
           if        rr-cod-max-alf       =    spaces
                     move  rr-cod-min-alf to   rr-cod-max-alf         .
           move      rr-cod-max-alf       to   w-all-str-alf          .
           move      14                   to   w-all-str-lun          .
           perform   all-str-pad-000      thru all-str-pad-999        .
           move      w-all-str-alf        to   rr-cod-max-alf         .
      *              *-------------------------------------------------*
      *              * Composizione area per programma di esecuzione a *
      *              * seconda del tipo stampa richiesto               *
      *              *-------------------------------------------------*
       ...
       reg-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Tipo stampa : Ad un livello                     *
      *              *-------------------------------------------------*
           move      "pdtp5031"           to   i-exe-pro              .
           move      "pgm/dtp/prg/obj/pdtp5031"
                                          to   i-exe-pat              .
      ...
      *              * Tipo stampa : Scalare                           *
      *              *-------------------------------------------------*
           move      "pdtp5032"           to   i-exe-pro              .
           move      "pgm/dtp/prg/obj/pdtp5032"
                                          to   i-exe-pat              .
           go to     reg-ric-sel-999.
       reg-ric-sel-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "pdtp5033"           to   i-exe-pro              .
           move      "pgm/dtp/prg/obj/pdtp5033"
                                          to   i-exe-pat              .
           go to     reg-ric-sel-999.
       reg-ric-sel-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      zero                 to   rr-cod-min-num         .
           move      spaces               to   rr-cod-min-alf         .
           move      zero                 to   rr-cod-max-num         .
           move      spaces               to   rr-cod-max-alf         .
       nor-ric-sel-999.
           exit.
