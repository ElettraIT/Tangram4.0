      ...
      *                                   Fase:    age950              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/01/95    *
      *                       Ultima revisione:    NdK del 29/07/99    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Cancellazione conteggi provvigionali        *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
               10  srt-key-dat-doc        pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Numero documento fattura, allineato a destra      *
      *            *---------------------------------------------------*
               10  srt-key-num-doc        pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Numero protocollo fattura                         *
      *            *---------------------------------------------------*
               10  srt-key-prt-fcl        pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Numero conteggio                                  *
      *            *---------------------------------------------------*
               10  srt-key-num-ctg        pic  9(09)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CANCELLAZIONE CONTEGGI PROVVIGIONALI  "       .
      ...
      *        *-------------------------------------------------------*
      *        * Per update record [fit]                               *
      *        *-------------------------------------------------------*
           05  w-exe-upd-fit.
      *            *---------------------------------------------------*
      *            * Flag di record trovato                            *
      *            *  - Spaces : No                                    *
      *            *  - S      : Si                                    *
      *            *---------------------------------------------------*
               10  w-exe-upd-fit-flg      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Salvataggio record [fit] trovato                  *
      *            *---------------------------------------------------*
               10  w-exe-upd-fit-rec.
                   15  filler occurs 2048
                                          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Per delete record [gpc]                               *
      *        *-------------------------------------------------------*
           05  w-exe-del-gpc.
      *            *---------------------------------------------------*
      *            * Flag di record trovato                            *
      ...
      *            *  - S      : Si                                    *
      *            *---------------------------------------------------*
               10  w-exe-del-gpc-flg      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Salvataggio record [fit] trovato                  *
      *            *---------------------------------------------------*
               10  w-exe-del-gpc-rec.
                   15  filler occurs 2048
                                          pic  x(01)                  .

      *    *===========================================================*
      *    * Work-area per buffer fatture con conteggi gia' sottoposti *
      *    * a maturazione                                             *
      *    *-----------------------------------------------------------*
       01  w-buf-fat.
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-buf-fat-num-ele          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Indice su elementi memorizzati                        *
      *        *-------------------------------------------------------*
           05  w-buf-fat-inx-ele          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Max numero di elementi memorizzabili                  *
      *        *-------------------------------------------------------*
           05  w-buf-fat-max-ele          pic  9(05) value 10000      .
      *        *-------------------------------------------------------*
      *        * Elementi memorizzati                                  *
      *        *-------------------------------------------------------*
           05  w-buf-fat-ele-mem occurs 10000.
      *            *---------------------------------------------------*
      *            * Numero protocollo movimento di fatture clienti    *
      *            *---------------------------------------------------*
               10  w-buf-fat-prt-fcl      pic  9(09)       comp-3     .
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Data minima dei documenti relativi ai documenti *
      *              * fattura per cui eseguire le cancellazioni       *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pmt-not-ope-000.
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Vengono cancellati conteggi provvigionali preceden
      -              "temente generati con il       "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "programma 'age300' eseguito in modalita' definitiv
      -              "a.                            "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Vengono esaminati a ritroso tutti i documenti fatt
      -              "ura fino alla data indicata.  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Per ogni documento con data uguale o superiore all
      -              "a data indicata verra'        "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "cancellato il conteggio provvigionale precedenteme
      -              "nte generato.                 "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      13                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Nota: Eventuali conteggi gia' sottoposti alla proc
      -              "edura di maturazione non      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      14                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "      verranno cancellati, in quanto considerati o
      -              "rmai bloccati.                "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *    *===========================================================*
      *    * Prompts : Data minima dei documenti relativi ai documenti *
      *    *           fattura per cui eseguire le cancellazioni       *
      *    *-----------------------------------------------------------*
       pmt-dat-min-000.
           move      "DS"                 to   v-ope                  .
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Data documento minima  delle fatture di cui cancel
      -              "lare i conteggi :             "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
       tdo-ric-sel-105.
           ...
           move      "Manca la data minima documenti !                  
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Numero elementi memorizzati in work-area per    *
      *              * buffer fatture con conteggi gia' sottoposti     *
      *              * a maturazione : a zero                          *
      *              *-------------------------------------------------*
           move      zero                 to   w-buf-fat-num-ele      .
      *              *-------------------------------------------------*
      *              * Start su [gpc] per numero conteggio             *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Next su [gpc] per numero conteggio              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/age/fls/ioc/obj/iofgpc"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Se il numero protocollo movimento di fatture    *
      *              * clienti e' a zero                               * 
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rf-gpc-prt-fcl       not  = zero
                     go to stp-srt-inp-250.
      *                  *---------------------------------------------*
      *                  * Si ignora il conteggio                      *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-100.
       stp-srt-inp-250.
      *              *-------------------------------------------------*
      *              * Se la fattura relativa al protocollo non esiste *
      *              * piu'                                            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-gpc-prt-fcl       to   rf-fit-num-prt         .
           move      "pgm/fat/fls/ioc/obj/ioffit"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-300.
      *              *-------------------------------------------------*
      *              * Se la fattura relativa al protocollo ha una da- *
      *              * ta documento inferiore alla data indicata       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rf-fit-dat-doc       not  < rr-dat-min
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Se a fronte del conteggio provvigionale sono    *
      *              * gia' state eseguite maturazioni                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      s-pat               using f
                                               rf-gpm                 .
      *                      *-----------------------------------------*
      *                      * Se Start errata : test superato         *
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-500.
      *                      *-----------------------------------------*
      *                      * Read next su [gpm] per numero conteggio *
      *                      *-----------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/age/fls/ioc/obj/iofgpm"
                                          to   s-pat                  .
           ...
           call      s-pat               using f
                                               rf-gpm                 .
      *                      *-----------------------------------------*
      *                      * Se At end : test superato               *
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-500.
      *                      *-----------------------------------------*
      *                      * Test max su [gpm] per numero conteggio  *
      *                      *-----------------------------------------*
           if        rf-gpm-num-ctg       not  = rf-gpc-num-ctg
                     go to stp-srt-inp-500.
      *                  *---------------------------------------------*
      *                  * Si memorizza il protocollo della fattura    *
      *                  * nell'apposito buffer                        *
      *                  *---------------------------------------------*
           if        w-buf-fat-num-ele    <    w-buf-fat-max-ele
                     add   1              to   w-buf-fat-num-ele
                     move  rf-gpc-prt-fcl to   w-buf-fat-prt-fcl
                                              (w-buf-fat-num-ele)     .
      *                  *---------------------------------------------*
      *                  * Si ignora il conteggio                      *
      *                  *---------------------------------------------*
      ...
      *                  * Data documento fattura                      *
      *                  *---------------------------------------------*
           move      rf-gpc-dat-doc       to   srt-key-dat-doc        .
      *                  *---------------------------------------------*
      *                  * Data documento fattura                      *
      *                  *---------------------------------------------*
           move      rf-gpc-num-doc       to   srt-key-num-doc        .
      *                  *---------------------------------------------*
      *                  * Numero protocollo fattura                   *
      *                  *---------------------------------------------*
           move      rf-gpc-prt-fcl       to   srt-key-prt-fcl        .
      *                  *---------------------------------------------*
      *                  * Numero conteggio                            *
      *                  *---------------------------------------------*
           move      rf-gpc-num-ctg       to   srt-key-num-ctg        .
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-let-seq-500.
      *              *-------------------------------------------------*
      *              * Se fine lettura : si spazzolano tutti i docu-   *
      *              * menti fattura per porre comunque il flag per    *
      *              * elaborazione agenti a Spaces, per ripristinare  *
      *              * anche le fatture che non avevano generato un    *
      *              * conteggio, ma per le quali comunque il flag di  *
      *              * elaborazione agenti era stato posto in On       *
      *              *-------------------------------------------------*
       prn-let-seq-510.
      *                  *---------------------------------------------*
      *                  * Start su [fit] per data documento           *
      *                  *---------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-let-seq-790.
       prn-let-seq-520.
      *                  *---------------------------------------------*
      *                  * Get next, con lock, su [fit] per data do-   *
      *                  * cumento                                     *
      *                  *---------------------------------------------*
           move      "GN"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           ...
           call      s-pat               using f
                                               rf-fit                 .
      *                  *---------------------------------------------*
      *                  * Se At end : ad unlock ed uscita             *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to prn-let-seq-780.
      *                  *---------------------------------------------*
      *                  * Se il flag di elaborazione agenti e' gia'   *
      *                  * a Spaces : ad unlock e riciclo              *
      *                  *---------------------------------------------*
           if        rf-fit-flg-blx (2)   =    spaces
                     go to prn-let-seq-760.
       prn-let-seq-600.
      *                  *---------------------------------------------*
      *                  * Se la fattura e' una di quelle con conteg-  *
      *                  * gi gia' sottoposti a maturazione : ad un-   *
      *                  * lock e riciclo                              * 
      *                  *---------------------------------------------*
       prn-let-seq-605.
           move      zero                 to   w-buf-fat-inx-ele      .
       prn-let-seq-610.
           add       1                    to   w-buf-fat-inx-ele      .
           if        w-buf-fat-inx-ele    >    w-buf-fat-num-ele
                     go to prn-let-seq-730.
           if        w-buf-fat-prt-fcl
                    (w-buf-fat-inx-ele)   not  = rf-fit-num-prt
                     go to prn-let-seq-610.
           go to     prn-let-seq-760.
       prn-let-seq-730.
      *                  *---------------------------------------------*
      *                  * Flag elaborazione agenti a Spaces           *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Update record [fit] per ripristino a Spaces del *
      *              * flag di elaborazione agenti                     *
      *              *-------------------------------------------------*
       prn-liv-det-110.
      *                  *---------------------------------------------*
      *                  * Segnale di record [fit] non trovato         *
      *                  *---------------------------------------------*
           move      spaces               to   w-exe-upd-fit-flg      .
      *                  *---------------------------------------------*
      *                  * Salvataggio record [fit] a spaces           *
      *                  *---------------------------------------------*
           move      spaces               to   w-exe-upd-fit-rec      .
       prn-liv-det-120.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMPRT"             to   f-key                  .
           move      srt-key-prt-fcl      to   rf-fit-num-prt         .
           move      "pgm/fat/fls/ioc/obj/ioffit"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
      *                  * Segnale di record [fit] trovato             *
      *                  *---------------------------------------------*
           move      "S"                  to   w-exe-upd-fit-flg      .
      *                  *---------------------------------------------*
      *                  * Salvataggio record [fit] trovato            *
      *                  *---------------------------------------------*
           move      rf-fit               to   w-exe-upd-fit-rec      .
       prn-liv-det-130.
      *                  *---------------------------------------------*
      *                  * Se il flag di elaborazione agenti e' gia'   *
      *                  * a Spaces : ad unlock                        *
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-170.
      *                  *---------------------------------------------*
      *                  * Se record [fit] trovato, lo si ripristina   *
      *                  *---------------------------------------------*
           if        w-exe-upd-fit-flg    =    "S"
                     move  w-exe-upd-fit-rec
                                          to   rf-fit                 .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Delete record [gpc] relativo al conteggio prov- *
      *              * vigionale                                       *
      *              *-------------------------------------------------*
       prn-liv-det-210.
      *                  *---------------------------------------------*
      *                  * Segnale di record [gpc] non trovato         *
      *                  *---------------------------------------------*
           move      spaces               to   w-exe-del-gpc-flg      .
      *                  *---------------------------------------------*
      *                  * Salvataggio record [gpc] a spaces           *
      *                  *---------------------------------------------*
           move      spaces               to   w-exe-del-gpc-rec      .
       prn-liv-det-220.
      *                  *---------------------------------------------*
      *                  * Lettura record [gpc], con lock              *
      *                  *---------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMCTG"             to   f-key                  .
           move      srt-key-num-ctg      to   rf-gpc-num-ctg         .
           move      "pgm/age/fls/ioc/obj/iofgpc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
      *                  * Segnale di record [gpc] trovato             *
      *                  *---------------------------------------------*
           move      "S"                  to   w-exe-del-gpc-flg      .
      *                  *---------------------------------------------*
      *                  * Salvataggio record [gpc] trovato            *
      *                  *---------------------------------------------*
           move      rf-gpc               to   w-exe-del-gpc-rec      .
       prn-liv-det-230.
      *                  *---------------------------------------------*
      *                  * Delete record [gpc]                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-250.
      *                  *---------------------------------------------*
      *                  * Se record [gpc] trovato, lo si ripristina   *
      *                  *---------------------------------------------*
           if        w-exe-del-gpc-flg    =    "S"
                     move  w-exe-del-gpc-rec
                                          to   rf-gpc                 .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Se il record [gpc] relativo al conteggio prov-  *
      *              * vigionale non e' stato trovato, quindi non e'   *
      *              * stato cancellato : ad uscita                    *
      *              *-------------------------------------------------*
           if        w-exe-del-gpc-flg    not  = "S"
      ...
      *              *-------------------------------------------------*
           move      "CANCELLAZIONE CONTEGGI PROVVIGIONALI"
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se non c'e' agente : no stampa              *
      *                  *---------------------------------------------*
           if        rf-gpc-cod-age       =    zero
                     go to stp-rig-det-700.
      *                  *---------------------------------------------*
      *                  * Lettura anagrafica                          *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODAGE"             to   f-key                  .
           move      rf-gpc-cod-age       to   rf-age-cod-age         .
           move      "pgm/age/fls/ioc/obj/iofage"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-age                 .
      *                  *---------------------------------------------*
      *                  * Se anagrafica non esistente : no stampa     *
      *                  *---------------------------------------------*
           if        f-sts                not = e-not-err
                     go to stp-rig-det-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-rig-det-700.
      *              *-------------------------------------------------*
      *              * Nominativo subagente                            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se non c'e' subagente : no stampa           *
      *                  *---------------------------------------------*
           if        rf-gpc-cod-ags       =    zero
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODAGE"             to   f-key                  .
           move      rf-gpc-cod-ags       to   rf-age-cod-age         .
           move      "pgm/age/fls/ioc/obj/iofage"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
