      ...
      *                                   Fase:    age390              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 20/05/13    *
      *                       Ultima revisione:    NdK del 06/06/14    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione saldaconto conteggi aperti         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   SALDACONTO CONTEGGI APERTI CLIENTE   "       .
      ...
      *            *---------------------------------------------------*
               10  w-tes-mat-man          pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Note per conteggi generati                        *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Importo totale conteggio                              *
      *        *-------------------------------------------------------*
           05  w-rig-tot-ctg              pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Importo residuo maturazione conteggio                 *
      *        *-------------------------------------------------------*
           05  w-rig-mtz-ctg              pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Importo maturazione manuale                           *
      *        *-------------------------------------------------------*
           05  w-rig-mtz-man              pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale documento                                      *
      *        *-------------------------------------------------------*
           05  w-rig-tot-doc              pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Un intero record [gpc]                                *
      *        *-------------------------------------------------------*
           05  w-rig-rec-gpc.
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-num-ctg  pic  x(09)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-dat-doc  pic  x(08)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-res-pvg  pic  x(09)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-mat-man  pic  x(09)                  .
           ...
           05  w-exp-snx-sos.
               ...
               10  w-exp-snx-sos-tbl.
                   15  filler             pic  x(40) value
                            "Tutti i conteggi da maturare            ".
                   15  filler             pic  x(40) value
                            "solo quelli gia' Parzialmente maturati  ".
      ...
      *            * - A      : Conteggio totalmente aperto            *
      *            * - P      : Conteggio parzialmente maturato        *
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per : Selezione su conteggi       *
      *    *-----------------------------------------------------------*
       pmt-snx-sos-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per : Nota su conteggi generati   *
      *    *-----------------------------------------------------------*
       pmt-not-ctg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      13                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Nota per conteggi generati :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       pmt-not-ctg-999.
      ...
      *                  *---------------------------------------------*
           if        w-tes-mat-man        not  = 01 and
                     w-tes-mat-man        not  = 02
      ...
      *    *===========================================================*
      *    * Visualizzazione : Selezione su conteggi                   *
      *    *-----------------------------------------------------------*
       vis-snx-sos-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Nota per conteggi generati                 *
      *    *-----------------------------------------------------------*
       acc-not-ctg-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Nota per conteggi generati              *
      *    *-----------------------------------------------------------*
       vis-not-ctg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Importo maturazione manuale                 *
      *                  *---------------------------------------------*
           perform   acc-mat-man-000      thru acc-mat-man-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-num-ctg      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       vis-lin-cor-510.
      *                  *---------------------------------------------*
      *                  * Editing imponibile provvigionale residuo    *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
           move      07                   to   v-car                  .
           ...
           move      "S"                  to   v-sgn                  .
           move      "B"                  to   v-edm                  .
           move      w-rig-tot-ctg        to   v-num                  .
           subtract  w-rig-mtz-ctg        from v-num                  .
           subtract  w-rig-mtz-man        from v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-res-pvg      .
       vis-lin-cor-520.
      *                  *---------------------------------------------*
      *                  * Editing maturazione manuale                 *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
           move      06                   to   v-car                  .
           ...
           move      "S"                  to   v-sgn                  .
           move      "B"                  to   v-edm                  .
           move      w-rig-mtz-man        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-mat-man      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.               Cliente                    Con
      -              "teggio      Residuo   Detraz. "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *              * Importo maturazione manuale                     *
      *              *-------------------------------------------------*
           perform   vis-mat-man-000      thru vis-mat-man-999        .
      *              *-------------------------------------------------*
      *              * Numero conteggio                                *
      *              *-------------------------------------------------*
      ...
      *              * Totale conteggio                                *
      *              *-------------------------------------------------*
           perform   vis-tot-ctg-000      thru vis-tot-ctg-999        .
      *              *-------------------------------------------------*
      *              * Totale documento                                *
      *              *-------------------------------------------------*
      ...
      *              * Residuo conteggio                               *
      *              *-------------------------------------------------*
           perform   vis-res-ctg-000      thru vis-res-ctg-999        .
       vis-rig-cor-999.
           exit.
      ...
      *              * Importo maturazione manuale                     *
      *              *-------------------------------------------------*
           perform   pmt-mat-man-000      thru pmt-mat-man-999        .
      *              *-------------------------------------------------*
      *              * Numero conteggio                                *
      *              *-------------------------------------------------*
      ...
      *              * Totale conteggio                                *
      *              *-------------------------------------------------*
           perform   pmt-tot-ctg-000      thru pmt-tot-ctg-999        .
      *              *-------------------------------------------------*
      *              * Totale documento                                *
      *              *-------------------------------------------------*
      ...
      *              * Residuo conteggio                               *
      *              *-------------------------------------------------*
           perform   pmt-res-ctg-000      thru pmt-res-ctg-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Importo maturazione manuale      *
      *    *-----------------------------------------------------------*
       pmt-mat-man-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Numero conteggio                 *
      *    *-----------------------------------------------------------*
       pmt-num-ctg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Totale conteggio                 *
      *    *-----------------------------------------------------------*
       pmt-tot-ctg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Residuo conteggio                *
      *    *-----------------------------------------------------------*
       pmt-res-ctg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Importo maturazione manuale          *
      *    *-----------------------------------------------------------*
       acc-mat-man-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-mat-man-999.
       acc-mat-man-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-mtz-man          .
       acc-mat-man-300.
      *              *-------------------------------------------------*
      *              * Se Select                                       *
      *              *-------------------------------------------------*
           if        v-key                not  = "SLCT"
                     go to acc-mat-man-400.
           move      w-rig-tot-ctg        to   w-rig-mtz-man          .
           subtract  w-rig-mtz-ctg        from w-rig-mtz-man          .
           perform   vis-mat-man-000      thru vis-mat-man-999        .
       acc-mat-man-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-rig-flg
                             ...
                             go to acc-mat-man-100.
       acc-mat-man-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Importo maturazione manuale       *
      *    *-----------------------------------------------------------*
       vis-mat-man-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Numero conteggio                  *
      *    *-----------------------------------------------------------*
       vis-num-ctg-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *
           move      rf-gpc-num-doc       to   w-all-str-cat (2)      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Totale conteggio                  *
      *    *-----------------------------------------------------------*
       vis-tot-ctg-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Residuo conteggio                 *
      *    *-----------------------------------------------------------*
       vis-res-ctg-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           ...
           move      zero                 to   w-tes-mat-man          .
           move      spaces               to   w-tes-not-ctg          .
           move      spaces               to   w-tes-cnf-imp          .
       nor-key-reg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-tot-ctg          .
           move      zero                 to   w-rig-mtz-ctg          .
           move      zero                 to   w-rig-mtz-man          .
      ...
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Nessun conteggio da elaborare !                   
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      24                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "               --- Caricamento conteggi emessi in 
      -              "esecuzione ---                "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Start su [gpc] per data agente                  *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "ADNDOC    "         to   f-key                  .
           move      w-tes-cod-age        to   rf-gpc-cod-age         .
           move      w-tes-dat-min        to   rf-gpc-dat-doc         .
           move      zero                 to   rf-gpc-num-doc         .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [gpc]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/age/fls/ioc/obj/iofgpc"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-age        not  = rf-gpc-cod-age
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-gpc-dat-doc       >    w-tes-dat-min
                     go to stp-srt-inp-900.
           go to     stp-srt-inp-400.
       stp-srt-inp-340.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-gpc-dat-doc       >    w-tes-dat-max
                     go to stp-srt-inp-900.
           go to     stp-srt-inp-400.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-gpc-cod-cli       not  = w-tes-cod-cli
                     go to stp-srt-inp-200.
       stp-srt-inp-420.
      *                  *---------------------------------------------*
      *                  * Selezione su tipo conteggio                 *
      *                  *---------------------------------------------*
           if        rf-gpc-tip-ctg       =    11
                     go to stp-srt-inp-200.
       stp-srt-inp-440.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Selezione su status conteggio           *
      *                      *-----------------------------------------*
           if        w-tes-mat-man        =    01 and
                    (w-det-sts-ctg-sts    =    "A" or
                     w-det-sts-ctg-sts    =    "P")
                     go to stp-srt-inp-600.
           if        w-tes-mat-man        =    02 and
                     w-det-sts-ctg-sts    =    "P"
                     go to stp-srt-inp-600.
      *                      *-----------------------------------------*
      ...
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
           move      rf-gpc-cod-cli       to   srt-cod-cli            .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-gpc-dat-doc       to   srt-dat-doc            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Importo maturato                        *
      *                      *-----------------------------------------*
           move      w-det-sts-ctg-mtz    to   srt-mtz-ctg            .
      *                      *-----------------------------------------*
      *                      * Record [gpc]                            *
      *                      *-----------------------------------------*
           move      rf-gpc               to   srt-rec-gpc            .
       stp-srt-inp-800.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-gpc               to   w-rig-rec-gpc          .
           move      rf-gpc-cod-cli       to   w-rig-cod-cli          .
           move      rf-gpc-dpz-cli       to   w-rig-dpz-cli          .
      *                      *-----------------------------------------*
      *                      * Valori conteggio                        *
      *                      *-----------------------------------------*
           move      zero                 to   w-rig-mtz-man          .
           move      srt-mtz-ctg          to   w-rig-mtz-ctg          .
           move      rf-gpc-amm-pvg       to   w-rig-tot-ctg          .
      *
           if        rf-gpc-tip-ctg       =    03 or
                     rf-gpc-tip-ctg       =    11
                     multiply  -1         by   w-rig-tot-ctg          .
      *
           move      rf-gpc-ibl-pvg       to   w-rig-tot-doc          .
      *                      *-----------------------------------------*
      *                      * Anagrafica cliente                      *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Forzatura tipo di conteggio             *
      *                      *                                         *
      *                      * 11 : Conteggio a fronte fattura, ma in  *
      *                      *      detrazione                         *
      *                      *-----------------------------------------*
           move      11                   to   rf-gpc-tip-ctg         .
      *                      *-----------------------------------------*
      *                      * Forzatura tipo di maturazione           *
      *                      *                                         *
      *                      * 01 : Maturazione immediata              *
      *                      *-----------------------------------------*
           move      01                   to   rf-gpc-tip-mat         .
      *                      *-----------------------------------------*
      *                      * Forzatura importo conteggio             *
      *                      *-----------------------------------------*
           move      w-rig-mtz-man        to   rf-gpc-amm-pvg         .
      *                      *-----------------------------------------*
      *                      * Calcolo % conteggio                     *
      *                      *-----------------------------------------*
           perform   det-per-amm-000      thru det-per-amm-999        .
           move      w-det-per-amm-s21    to   rf-gpc-per-pvg         .
      *                      *-----------------------------------------*
      *                      * Note conteggio                          *
      *                      *-----------------------------------------*
           move      w-tes-not-ctg        to   rf-gpc-not-ctg         .
       cmp-rec-gpc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        rf-gpc-ibl-pvg       =    zero
                     go to det-per-amm-999.
      *              *-------------------------------------------------*
      *              * Se ammontare a zero : uscita con zero           *
      *              *-------------------------------------------------*
           if        rf-gpc-amm-pvg       =    zero
                     go to det-per-amm-999.
      *              *-------------------------------------------------*
      *              * Se ammontare > di imponibile : uscita con zero  *
      *              *-------------------------------------------------*
           if        rf-gpc-amm-pvg       >    rf-gpc-ibl-pvg
                     go to det-per-amm-999.
      *              *-------------------------------------------------*
      *              * Calcolo della percentuale                       *
      *              *-------------------------------------------------*
           move      rf-gpc-amm-pvg       to   w-det-per-amm-s13      .
           multiply  100                  by   w-det-per-amm-s13      .
           divide    rf-gpc-ibl-pvg       into w-det-per-amm-s13
      ...
      *    *===========================================================*
      *    * Tasto funzione "FIND" su conteggi                         *
      *    *-----------------------------------------------------------*
       fnd-arc-gpc-000.
      *              *-------------------------------------------------*
      ...
      *
       ...
       det-sts-ctg-950.
      *              *-------------------------------------------------*
      *              * Uscita per status a 'aperto' o 'parzialmente    *
      *              * maturato'                                       *
      *              *-------------------------------------------------*
           if        w-det-sts-ctg-mtz    =    zero
                     move  "A"            to   w-det-sts-ctg-sts
           else      move  "P"            to   w-det-sts-ctg-sts      .
      *
           go to     det-sts-ctg-999.
       det-sts-ctg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/age/prg/obj/page3902"                       .
       cnc-rlt-sup-999.
           exit.
