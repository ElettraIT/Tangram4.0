      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma page3501:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tor-cli.
               10  w-exp-tor-cli-num      pic  9(02)       value 03   .
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-cod-mne-dcc-vln      .
           move      41                   to   w-cod-mne-dcc-vps      .
           move      12                   to   w-cod-mne-dcc-lln      .
      ...
      *    *-----------------------------------------------------------*
       reg-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Se selezionato un solo cliente si forza il tipo *
      *              * ordinamento clienti per codice                  *
      *              *-------------------------------------------------*
           if        rr-cod-cli           not  = zero
                     move  02             to   rr-tor-cli             .
       reg-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Se tipo ordinamento clienti a zero : si forza a *
      *              * ordinamento clienti per codice                  *
      *              *-------------------------------------------------*
           if        rr-tor-cli           =    zero
                     move  02             to   rr-tor-cli             .
