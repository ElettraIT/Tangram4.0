      ...
      *                       Ultima revisione:    NdK del 06/12/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma page3400 *
      *                                                                *
      ...
      *            *---------------------------------------------------*
      *            * Totale imponibile provvigionale                   *
      *            *---------------------------------------------------*
               10  w-liv-age-tot-ibl      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * Totale importo provvigioni                        *
      *            *---------------------------------------------------*
               10  w-liv-age-tot-pvg      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * % media di provvigione                            *
      *            *---------------------------------------------------*
               10  w-liv-age-per-mdp      pic  9(02)v9(01)            .
      *            *---------------------------------------------------*
      *            * Numero conteggi trattati per l'agente             *
      *            *---------------------------------------------------*
               10  w-liv-age-num-ctg      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Castelletto riepilogativo                         *
      *            *---------------------------------------------------*
               10  w-liv-age-cst.
      *                *-----------------------------------------------*
      *                * Numero elementi letti                         *
      *                *-----------------------------------------------*
                   15  w-liv-age-cst-ele  pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Max elementi                                  *
      *                *-----------------------------------------------*
                   15  w-liv-age-cst-max  pic  9(05)  value 999       .
      *                *-----------------------------------------------*
      *                * Campi di comodo                               *
      *                *-----------------------------------------------*
                   15  w-liv-age-cst-ct0  pic  9(05)                  .
                   15  w-liv-age-cst-wms  pic  9(02)                  .
                   15  w-liv-age-cst-wsa  pic  9(03)                  .
                   15  w-liv-age-cst-wtc  pic s9(11)                  .
                   15  w-liv-age-cst-wdt  pic s9(11)                  .
      *                *-----------------------------------------------*
      *                * Castelletto                                   *
      *                *-----------------------------------------------*
                   15  w-liv-age-cst-cst.
                       20  w-liv-age-cst-sne occurs 999
                                  indexed by   w-liv-age-cst-inx      .
                           25  w-liv-age-cst-mes
                                          pic  9(02)                  .
                           25  w-liv-age-cst-saa
                                          pic  9(03)                  .
                           25  w-liv-age-cst-tcg
                                          pic s9(11)                  .
                           25  w-liv-age-cst-tdt
                                          pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Generale                                              *
      *        *-------------------------------------------------------*
      ...
      *            * Totale imponibile provvigionale                   *
      *            *---------------------------------------------------*
               10  w-liv-gen-tot-ibl      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * Totale importo provvigioni                        *
      *            *---------------------------------------------------*
               10  w-liv-gen-tot-pvg      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * % media di provvigione                            *
      *            *---------------------------------------------------*
               10  w-liv-gen-per-mdp      pic  9(02)v9(01)            .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Per determinazione % media di sconto o provvigione    *
      *        *-------------------------------------------------------*
           05  w-det-pme-sop.
      *            *---------------------------------------------------*
      *            * Imponibile                                        *
      *            *---------------------------------------------------*
               10  w-det-pme-sop-ibl      pic  s9(13)                 .
      *            *---------------------------------------------------*
      *            * Ammontare                                         *
      *            *---------------------------------------------------*
               10  w-det-pme-sop-amm      pic  s9(13)                 .
      *            *---------------------------------------------------*
      *            * % media calcolata                                 *
      *            *---------------------------------------------------*
               10  w-det-pme-sop-per      pic   9(02)v9(01)           .
      ...
      *              * mento del codice agente nella gestione provvi-  *
      *              * gioni ed agenti                                 *
      *              *-------------------------------------------------*
           perform   prs-age-age-000      thru prs-age-age-999        .
      *              *-------------------------------------------------*
      *              * Lettura della personalizzazione per il tratta-  *
      *              * mento del codice cliente nella gestione provvi- *
      *              * gioni ed agenti                                 *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-gpc-cod-cli       not  = rr-cod-cli
                     go to stp-srt-inp-100.
       stp-srt-inp-350.
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun conteggio da stampare entro le date imposta
      -              "te !                          "
                                          to   m-msg                  .
      ...
      *                  * Totale imponibile provvigionale             *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-gen-tot-ibl      .
      *                  *---------------------------------------------*
      *                  * Totale importo provvigioni                  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-gen-tot-pvg      .
      *                  *---------------------------------------------*
      *                  * % media di provvigione                      *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-gen-per-mdp      .
      *                  *---------------------------------------------*
      ...
      *                  * Totale imponibile provvigionale             *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-tot-ibl      .
      *                  *---------------------------------------------*
      *                  * Totale importo provvigioni                  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-tot-pvg      .
      *                  *---------------------------------------------*
      *                  * % media di provvigione                      *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-per-mdp      .
      *                  *---------------------------------------------*
      *                  * Numero conteggi trattati per l'agente       *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-num-ctg      .
      *                  *---------------------------------------------*
      *                  * Castelletto di riepilogo                    *
      *                  *---------------------------------------------*
           perform   prn-ini-lr1-ncr-000  thru prn-ini-lr1-ncr-999    .
      *                  *---------------------------------------------*
      ...
      *    * Ciclo Report Program : Inizio 1. livello di rottura       *
      *    *                                                           *
      *    * Subroutine di normalizzazione castelletto di riepilogo    *
      *    *-----------------------------------------------------------*
       prn-ini-lr1-ncr-000.
      *              *-------------------------------------------------*
      *              * Numero elementi                                 *
      *              *-------------------------------------------------*
           move      zero                 to   w-liv-age-cst-ele      .
      *              *-------------------------------------------------*
      *              * Ciclo di normalizzazione                        *
      *              *-------------------------------------------------*
           move      zero                 to   w-liv-age-cst-ct0      .
       prn-ini-lr1-ncr-200.
           add       1                    to   w-liv-age-cst-ct0      .
           if        w-liv-age-cst-ct0    >    w-liv-age-cst-max
                     go to prn-ini-lr1-ncr-900.
           move      zero                 to   w-liv-age-cst-mes
                                              (w-liv-age-cst-ct0)     .
           move      zero                 to   w-liv-age-cst-saa
                                              (w-liv-age-cst-ct0)     .
           move      zero                 to   w-liv-age-cst-tcg
                                              (w-liv-age-cst-ct0)     .
           move      zero                 to   w-liv-age-cst-tdt
                                              (w-liv-age-cst-ct0)     .
           go to     prn-ini-lr1-ncr-200.
       prn-ini-lr1-ncr-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-ini-lr1-ncr-999.
       prn-ini-lr1-ncr-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           if        w-liv-age-tot-ibl    >    999999999 or
                     w-liv-age-tot-ibl    <   -999999999
                     move  11             to   p-car
           ...
           move      p-lnr                to   p-lin                  .
           move      59                   to   p-pos                  .
           move      w-liv-age-tot-ibl    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Determinazione della % media di provvigione *
      *                  *---------------------------------------------*
           move      w-liv-age-tot-ibl    to   w-det-pme-sop-ibl      .
           move      w-liv-age-tot-pvg    to   w-det-pme-sop-amm      .
           perform   det-pme-sop-000      thru det-pme-sop-999        .
      *                  *---------------------------------------------*
      *                  * % media di provvigione                      *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           move      "DB"                 to   p-edm                  .
           move      w-det-pme-sop-per    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *
      ...
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           if        w-liv-age-tot-pvg    >    999999999 or
                     w-liv-age-tot-pvg    <   -999999999
                     move  11             to   p-car
           else      move  09             to   p-car                  .
           move      c-dec                to   p-dec                  .
           move      "S"                  to   p-sgn                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      78                   to   p-pos                  .
           move      w-liv-age-tot-pvg    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-lr1-800.
      *              *-------------------------------------------------*
      *              * Castelletto di riepilogo                        *
      *              *-------------------------------------------------*
           perform   prn-fin-lr1-scr-000  thru prn-fin-lr1-scr-999    .
       prn-fin-lr1-999.
           exit.
      ...
      *    * Ciclo Report Program : Fine 1. livello di rottura         *
      *    *                                                           *
      *    * Subroutine di stampa castelletto di riepilogo             *
      *    *-----------------------------------------------------------*
       prn-fin-lr1-scr-000.
      *              *-------------------------------------------------*
      *              * Test su numero elementi                         *
      *              *-------------------------------------------------*
           if        w-liv-age-cst-ele    =    zero
                     go to prn-fin-lr1-scr-999.
           if        w-liv-age-num-ctg    <    2
                     go to prn-fin-lr1-scr-999.
       prn-fin-lr1-scr-100.
      *              *-------------------------------------------------*
      *              * Stampa fincatura iniziale                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Intestazione pagina                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-cst-wtc      .
           move      zero                 to   w-liv-age-cst-wdt      .
       prn-fin-lr1-scr-200.
      *              *-------------------------------------------------*
      *              * Stampa fincatura iniziale                       *
      *              *-------------------------------------------------*
      ...
      *                  * Test su contatore                           *
      *                  *---------------------------------------------*
           if        w-liv-age-cst-ct0    >    w-liv-age-cst-max or
                     w-liv-age-cst-ct0    >    w-liv-age-cst-ele
                     go to prn-fin-lr1-scr-800.
       prn-fin-lr1-scr-220.
      *                  *---------------------------------------------*
      *                  * Test se linee residue sufficienti           *
      *                  *---------------------------------------------*
           if        p-res                >    4
                     go to prn-fin-lr1-scr-300.
      *                  *---------------------------------------------*
      *                  * Intestazione pagina                         *
      *                  *---------------------------------------------*
           perform   stp-int-pag-000      thru stp-int-pag-999        .
      ...
      *                      *-----------------------------------------*
           ...
           move      "LM"                 to   s-ope                  .
           move      "E"                  to   s-tip                  .
           move      w-liv-age-cst-mes
                    (w-liv-age-cst-ct0)   to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                      *-----------------------------------------*
      *                      * Stampa literal                          *
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      15                   to   p-pos                  .
           move      w-liv-age-cst-saa
                    (w-liv-age-cst-ct0)   to   p-num                  .
           add       1900                 to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-liv-age-cst-tcg
                    (w-liv-age-cst-ct0)   to   p-num                  .
           add       w-liv-age-cst-tdt
                    (w-liv-age-cst-ct0)   to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Incremento totalizzatori                    *
      *                  *---------------------------------------------*
           add       w-liv-age-cst-tcg
                    (w-liv-age-cst-ct0)   to   w-liv-age-cst-wtc      .
           add       w-liv-age-cst-tdt
                    (w-liv-age-cst-ct0)   to   w-liv-age-cst-wdt      .
       prn-fin-lr1-scr-700.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     prn-fin-lr1-scr-200.
       prn-fin-lr1-scr-800.
      *              *-------------------------------------------------*
      *              * Totali                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      24                   to   p-pos                  .
           move      w-liv-age-cst-wtc    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Totale detratto                             *
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      45                   to   p-pos                  .
           move      w-liv-age-cst-wdt    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Totale generale                             *
      *                  *---------------------------------------------*
           ...
           move      66                   to   p-pos                  .
           move      w-liv-age-cst-wtc    to   p-num                  .
           add       w-liv-age-cst-wdt    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-025.
      *              *-------------------------------------------------*
      *              * Numero di conteggi trattati per l'agente        *
      *              *-------------------------------------------------*
           add       1                    to   w-liv-age-num-ctg      .
       prn-liv-det-050.
      *              *-------------------------------------------------*
      *              * Assestamento preliminare, in area di comodo,    *
      *              * degli importi relativi al conteggio             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Conteggio                                   *
      *                  *---------------------------------------------*
       ...
       prn-liv-det-075.
      *              *-------------------------------------------------*
      *              * Incremento totale imponibile provvigionale per  *
      *              * l'agente                                        *
      *              *-------------------------------------------------*
           if        w-ass-ctg-ibl-pvg    not  = zero and
                     w-ass-ctg-amm-pvg    not  = zero
                     add   w-ass-ctg-ibl-pvg
                                          to   w-liv-age-tot-ibl      .
      *              *-------------------------------------------------*
      *              * Incremento totale ammontare provvigioni per     *
      *              * l'agente                                        *
      *              *-------------------------------------------------*
           if        w-ass-ctg-ibl-pvg    not  = zero and
                     w-ass-ctg-amm-pvg    not  = zero
                     add   w-ass-ctg-amm-pvg
                                          to   w-liv-age-tot-pvg      .
      *              *-------------------------------------------------*
      *              * Incremento totale imponibile provvigionale per  *
      *              * il totale generale                              *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-ass-ctg-ibl-pvg    not  = zero and
                     w-ass-ctg-amm-pvg    not  = zero
                     add   w-ass-ctg-amm-pvg
                                          to   w-liv-gen-tot-pvg      .
      *              *-------------------------------------------------*
      *              * Incremento castelletto di riepilogo             *
      *              *-------------------------------------------------*
           perform   prn-liv-det-icr-000  thru prn-liv-det-icr-999    .
       prn-liv-det-100.
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           if        w-ass-ctg-ibl-pvg    >    999999999 or
                     w-ass-ctg-ibl-pvg    <   -999999999
                     move  11             to   p-car
           else      move  09             to   p-car                  .
           move      c-dec                to   p-dec                  .
           move      "S"                  to   p-sgn                  .
      ...
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      w-all-str-alf        to   w-stp-det-col-004 (1)  .
       prn-liv-det-470.
      *                  *---------------------------------------------*
      *                  * Colonna 5                                   *
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           if        w-ass-ctg-amm-pvg    >    999999999 or
                     w-ass-ctg-amm-pvg    <   -999999999
                     move  11             to   p-car
           else      move  09             to   p-car                  .
           move      c-dec                to   p-dec                  .
           move      "S"                  to   p-sgn                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                          *-------------------------------------*
      *                          * Assestamento per conteggio senza    *
      *                          * provvigione                         *
      *                          *-------------------------------------*
           if        srt-gpc-per-pvg      =    zero and
                     w-ass-ctg-amm-pvg    =    zero
                     move  "          No" to   p-edt                  .
      *                          *-------------------------------------*
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      p-edt                to   w-stp-det-col-005 (1)  .
       prn-liv-det-500.
      *                  *---------------------------------------------*
      *                  * Colonna 6                                   *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        srt-gpc-tip-vpa      =    02
                     move  "Indiretta "   to   w-stp-det-col-006 (1)
                                              (01 : 10)
           else      move  spaces         to   w-stp-det-col-006 (1)  .
       prn-liv-det-550.
      *                      *-----------------------------------------*
      *                      * Fine colonna 6                          *
      *                      *-----------------------------------------*
      ...
      *    * Ciclo Report Program : Livello di dettaglio               *
      *    *                                                           *
      *    * Subroutine di incremento castelletto di riepilogo         *
      *    *-----------------------------------------------------------*
       prn-liv-det-icr-000.
      *              *-------------------------------------------------*
      *              * Determinazione mese e anno per la ricerca       *
      *              *-------------------------------------------------*
           move      srt-gpc-dat-doc      to   s-dat                  .
           move      s-mes                to   w-liv-age-cst-wms      .
           move      s-saa                to   w-liv-age-cst-wsa      .
       prn-liv-det-icr-100.
      *              *-------------------------------------------------*
      *              * Ricerca elemento                                *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           set       w-liv-age-cst-inx    to   1                      .
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           search    w-liv-age-cst-sne
                     when    w-liv-age-cst-mes
                            (w-liv-age-cst-inx)
                                          =    w-liv-age-cst-wms and
                             w-liv-age-cst-saa
                            (w-liv-age-cst-inx)
                                          =    w-liv-age-cst-wsa
                             go to   prn-liv-det-icr-300.
      *                  *---------------------------------------------*
      *                  * A elemento non trovato                      *
      *                  *---------------------------------------------*
           go to     prn-liv-det-icr-500.
       prn-liv-det-icr-300.
      *              *-------------------------------------------------*
      *              * Se elemento trovato                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        srt-gpc-tip-ctg      =    01 or
                     srt-gpc-tip-ctg      =    02
                     go to prn-liv-det-icr-320
           else      go to prn-liv-det-icr-340.
       prn-liv-det-icr-320.
      *                  *---------------------------------------------*
      *                  * Conteggiato                                 *
      *                  *---------------------------------------------*
      ...
      *                      * Valore                                  *
      *                      *-----------------------------------------*
           add       w-ass-ctg-amm-pvg    to   w-liv-age-cst-tcg
                                              (w-liv-age-cst-ele)     .
      *                      *-----------------------------------------*
      *                      * Ad uscita                               *
      *                      *-----------------------------------------*
           go to     prn-liv-det-icr-900.
       prn-liv-det-icr-340.
      *                  *---------------------------------------------*
      *                  * Detratto                                    *
      *                  *---------------------------------------------*
      ...
      *                      * Valore                                  *
      *                      *-----------------------------------------*
           add       w-ass-ctg-amm-pvg    to   w-liv-age-cst-tdt
                                              (w-liv-age-cst-ele)     .
      *                      *-----------------------------------------*
      *                      * Ad uscita                               *
      *                      *-----------------------------------------*
      ...
      *                  * Nuovo elemento                              *
      *                  *---------------------------------------------*
           if        w-liv-age-cst-ele    <    w-liv-age-cst-max
                     add  1               to   w-liv-age-cst-ele      .
      *                  *---------------------------------------------*
      *                  * Mese e anno                                 *
      *                  *---------------------------------------------*
           move      w-liv-age-cst-wms    to   w-liv-age-cst-mes
                                              (w-liv-age-cst-ele)     .
           move      w-liv-age-cst-wsa    to   w-liv-age-cst-saa
                                              (w-liv-age-cst-ele)     .
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo conteggio   *
      *                  *---------------------------------------------*
           if        srt-gpc-tip-ctg      =    01 or
                     srt-gpc-tip-ctg      =    02
                     go to prn-liv-det-icr-520
           else      go to prn-liv-det-icr-540.
       prn-liv-det-icr-520.
      *                  *---------------------------------------------*
      *                  * Conteggiato                                 *
      *                  *---------------------------------------------*
      ...
      *                      * Valore                                  *
      *                      *-----------------------------------------*
           move      w-ass-ctg-amm-pvg    to   w-liv-age-cst-tcg
                                              (w-liv-age-cst-ele)     .
      *                      *-----------------------------------------*
      *                      * Ad uscita                               *
      *                      *-----------------------------------------*
      ...
      *                      * Valore                                  *
      *                      *-----------------------------------------*
           move      w-ass-ctg-amm-pvg    to   w-liv-age-cst-tdt
                                              (w-liv-age-cst-ele)     .
      *                      *-----------------------------------------*
      *                      * Ad uscita                               *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           string    "ELENCO DELLE PROVVIGIONI CONTEGGIATE DAL "
                                delimited by   size
                     w-stp-int-wed-dt0
                                delimited by   size
                     " AL "
      ...
      *              *-------------------------------------------------*
       ...
       stp-tot-gen-100.
      *              *-------------------------------------------------*
      *              * Stampa del totale imponibile provvigionale      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Literal                                     *
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "Totale imponibile provvigionale ..................
      -              " :"                 to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      54                   to   p-pos                  .
           move      w-liv-gen-tot-ibl    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-tot-gen-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "Totale provvigioni conteggiate ...................
      -              " :"                 to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      54                   to   p-pos                  .
           move      w-liv-gen-tot-pvg    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-tot-gen-400.
      *              *-------------------------------------------------*
      ...
      *              * Determinazione della % media di provvigione     *
      *              *-------------------------------------------------*
           move      w-liv-gen-tot-ibl    to   w-det-pme-sop-ibl      .
           move      w-liv-gen-tot-pvg    to   w-det-pme-sop-amm      .
           perform   det-pme-sop-000      thru det-pme-sop-999        .
      *              *-------------------------------------------------*
      *              * Stampa della % media di provvigione             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Literal                                     *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Determinazione della % media di provvigione in base a :   *
      *    * - Imponibile provvigionale                                *
      *    * - Importo    provvigione                                  *
      *    *-----------------------------------------------------------*
       det-pme-sop-000.
      ...
      *              *-------------------------------------------------*
           if        w-det-pme-sop-ibl    =    zero
                     move  zero           to   w-det-pme-sop-per
                     go to det-pme-sop-999.
      *              *-------------------------------------------------*
      *              * Se importo provvigione a zero : uscita con zero *
      *              *-------------------------------------------------*
           if        w-det-pme-sop-amm    =    zero
                     move  zero           to   w-det-pme-sop-per
                     go to det-pme-sop-999.
      *              *-------------------------------------------------*
      *              * Se importo provvigione maggiore dell' imponibi- *
      *              * le : uscita con zero                            *
      *              *-------------------------------------------------*
           if        w-det-pme-sop-amm    >    w-det-pme-sop-ibl
                     move  zero           to   w-det-pme-sop-per
                     go to det-pme-sop-999.
      *              *-------------------------------------------------*
      *              * Calcolo della percentuale                       *
      *              *-------------------------------------------------*
           multiply  100                  by   w-det-pme-sop-amm      .
           divide    w-det-pme-sop-ibl    into w-det-pme-sop-amm
                                        giving w-det-pme-sop-per
                                                         rounded      .
       det-pme-sop-999.
           exit.
