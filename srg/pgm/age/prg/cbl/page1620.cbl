      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma page1621:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA CAT. PROVV. PER CLIENTE-PRODOTTO "       .
      ...
      *        *  - C : Per cliente/prodotto                           *
      *        *  - P : Per prodotto/cliente                           *
      *        *-------------------------------------------------------*
           ...
           05  w-exp-tor-tbl.
               ...
               10  w-exp-tor-tbl-tbl.
                   15  filler             pic  x(40) value
                          "Per categorie cliente/prodotto          "  .
                   15  filler             pic  x(40) value
                          "Per categorie prodotto/cliente          "  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-300.
      *                  *---------------------------------------------*
      *                  * Categoria di provvigione per prodotto       *
      *                  *---------------------------------------------*
           perform   acc-cat-pro-000      thru acc-cat-pro-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
      *              * Categoria di provvigioni per prodotto           *
      *              *-------------------------------------------------*
           perform   pmt-cat-pro-000      thru pmt-cat-pro-999        .
      *              *-------------------------------------------------*
      *              * Si/No salto pagina                              *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt : Categoria provvigioni prodotto                   *
      *    *-----------------------------------------------------------*
       pmt-cat-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-cmn-zpv-003-lin      .
           move      30                   to   w-cmn-zpv-003-pos      .
           move      11                   to   w-cmn-zpv-003-dln      .
      ...
      *    *===========================================================*
      *    * Accettazione : Categoria di provvigione prodotto          *
      *    *-----------------------------------------------------------*
       acc-cat-pro-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cat-pro           to   w-cmn-zpv-002-cod      .
           move      14                   to   w-cmn-zpv-002-lin      .
           move      30                   to   w-cmn-zpv-002-pos      .
           move      14                   to   w-cmn-zpv-002-dln      .
       ...
       acc-cat-pro-110.
           ...
           if        w-cmn-zpv-002-ope    =    "F+"
                     go to acc-cat-pro-115.
           if        w-cmn-zpv-002-ope    =    "AC"
                     go to acc-cat-pro-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cat-pro-115.
           perform   cmn-zpv-002-foi-000  thru cmn-zpv-002-foi-999    .
           go to     acc-cat-pro-110.
       acc-cat-pro-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-cat-pro-999.
       acc-cat-pro-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-cat-pro             .
       acc-cat-pro-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cat-pro           to   w-let-arc-zpv-cod      .
           perform   let-arc-zpv-000      thru let-arc-zpv-999        .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione descrizione                 *
      *                  *---------------------------------------------*
           if        rr-cat-pro           =    zero
                     move  "Tutte"        to   rr-cat-pro-des
           else      move  w-let-arc-zpv-des
                                          to   rr-cat-pro-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cat-pro-des-000  thru vis-cat-pro-des-999    .
      *                  *---------------------------------------------*
      *                  * Se codice errato : reimpostazione           *
      *                  *---------------------------------------------*
           if        w-let-arc-zpv-flg    not  = spaces
                     go to acc-cat-pro-100.
       acc-cat-pro-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Categoria di provvigione prodotto, de-  *
      *    *                   scrizione                               *
      *    *-----------------------------------------------------------*
       vis-cat-pro-des-000.
           move      "DS"                 to   v-ope                  .
      ...
      *              * Codice categoria provvigione prodotto           *
      *              *-------------------------------------------------*
           move      zero                 to   rr-cat-pro             .
      *              *-------------------------------------------------*
      *              * Codice categoria provvigione prodotto, descri-  *
      *              * zione                                           *
      *              *-------------------------------------------------*
           move      spaces               to   rr-cat-pro-des         .
      *              *-------------------------------------------------*
      *              * Si/No salto pagina                              *
      *              *-------------------------------------------------*
