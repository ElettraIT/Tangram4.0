      ...
      *                                                                *
      *                    Analisi globale maturazioni per agente      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-ana-age-tts.
      *            *---------------------------------------------------*
      *            * 04 elementi, per ogni tipo conteggio              *
      *            *  - 01 : Provvigione a fronte fattura              *
      *            *  - 02 : Provvigione a fronte nota addebito        *
      *            *  - 03 : Detrazione  a fronte nota accredito       *
      *            *  - 04 : Detrazione  a fronte fattura              *
      *            *---------------------------------------------------*
               10  w-ana-age-tts-ele  occurs 04.
      *                *-----------------------------------------------*
      *                * Totale importo                                *
      *                *-----------------------------------------------*
      ...
      *            * Comodi per calcolo                                *
      *            *---------------------------------------------------*
               10  w-ana-age-tts-s03      pic s9(11)                  .
               10  w-ana-age-tts-ssv      pic s9(11)                  .
      ...
      *                  *---------------------------------------------*
      *                  * Inizializzazione totali per tipo conteggio  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "         Tipo conteggio            Conteggiato    
      -              "   Maturato        Residuo    "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           go to     vis-tot-tts-510
                     ...
                     vis-tot-tts-530
                     vis-tot-tts-540
                     depending            on   w-ana-age-tts-i01      .
           go to     vis-tot-tts-700.
       vis-tot-tts-510.
      *                  *---------------------------------------------*
      *                  * Tipo conteggio 01 : Provvigione a fronte    *
      *                  *                     fattura                 *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      "Provvigioni a fronte Fattura   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       vis-tot-tts-520.
      *                  *---------------------------------------------*
      *                  * Tipo conteggio 02 : Provvigione a fronte    *
      *                  *                     nota di addebito        *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Preparazione mark-point                 *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      "Provvigioni a fronte Nota Add. :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       vis-tot-tts-530.
      *                  *---------------------------------------------*
      *                  * Tipo conteggio 03 : Detrazione a fronte     *
      *                  *                     nota di accredito       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Preparazione mark-point                 *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      "Detrazioni a fronte Nota Accr. :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       vis-tot-tts-540.
      *                  *---------------------------------------------*
      *                  * Tipo conteggio 11 : Detrazione a fronte     *
      *                  *                     fattura                 *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Preparazione mark-point                 *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      "Detrazioni a fronte Fattura    :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       vis-tot-tts-700.
      *                  *---------------------------------------------*
      *                  * Riciclo a tipo conteggio successivo         *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      zero                 to   w-ana-age-tts-s03      .
           move      zero                 to   w-ana-age-tts-i01      .
       vis-tot-tts-832.
           add       1                    to   w-ana-age-tts-i01      .
           if        w-ana-age-tts-i01    >    04
           ...
           add       w-ana-age-tts-ctg
                    (w-ana-age-tts-i01)   to   w-ana-age-tts-s03      .
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      34                   to   v-pos                  .
           move      w-ana-age-tts-s03    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Salvataggio del totale stampato         *
      *                      *-----------------------------------------*
           move      w-ana-age-tts-s03    to   w-ana-age-tts-ssv      .
       vis-tot-tts-840.
      *                  *---------------------------------------------*
      *                  * Totale 'Maturato'                           *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      66                   to   v-pos                  .
           move      w-ana-age-tts-ssv    to   v-num                  .
           subtract  w-ana-age-tts-s03    from v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-tot-tts-860.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "ANALISI GLOBALE MATURAZIONI AL"
                                          to   w-all-str-cat (1)      .
      ...
      *    *===========================================================*
      *    * Aggiornamento totali per tipo conteggio                   *
      *    *-----------------------------------------------------------*
       tot-tts-agg-000.
      *              *-------------------------------------------------*
      *              * Preparazione indice per tipo conteggio          *
      *              *-------------------------------------------------*
           if        rf-gpc-tip-ctg       =    01
                     move  01             to   w-ana-age-tts-i01
           else if   rf-gpc-tip-ctg       =    02
                     move  02             to   w-ana-age-tts-i01
           else if   rf-gpc-tip-ctg       =    03
                     move  03             to   w-ana-age-tts-i01
           else if   rf-gpc-tip-ctg       =    11
                     move  04             to   w-ana-age-tts-i01      .
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo conteggio       *
      *              *-------------------------------------------------*
       ...
       tot-tts-agg-100.
      *              *-------------------------------------------------*
      *              * Se tipo conteggio 01 : Provvigione a fronte     *
      *              *                        fattura                  *
      *              *-------------------------------------------------*
      *                   *--------------------------------------------*
      ...
      *                   * Ad uscita                                  *
      *                   *--------------------------------------------*
           go to     tot-tts-agg-900.
       tot-tts-agg-200.
      *              *-------------------------------------------------*
      *              * Se tipo conteggio 02 : Provvigione a fronte     *
      *              *                        nota di addebito         *
      *              *-------------------------------------------------*
      *                   *--------------------------------------------*
      *                   * Aggiornamento totale importo               *
      ...
      *                   *--------------------------------------------*
       ...
       tot-tts-agg-300.
      *              *-------------------------------------------------*
      *              * Se tipo conteggio 03 : Detrazione a fronte      *
      *              *                        nota di accredito        *
      *              *-------------------------------------------------*
      *                   *--------------------------------------------*
      *                   * Aggiornamento totale importo               *
      *                   *--------------------------------------------*
           subtract  rf-gpc-amm-pvg       from w-ana-age-tts-tot
                                              (w-ana-age-tts-i01)     .
      *                   *--------------------------------------------*
      *                   * Aggiornamento totale numero conteggi       *
      *                   *--------------------------------------------*
      ...
      *                   *--------------------------------------------*
       ...
       tot-tts-agg-400.
      *              *-------------------------------------------------*
      *              * Se tipo conteggio 11 : Detrazione a fronte      *
      *              *                        fattura                  *
      *              *-------------------------------------------------*
      *                   *--------------------------------------------*
      *                   * Aggiornamento totale importo               *
