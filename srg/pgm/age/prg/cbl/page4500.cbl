      ...
      *                       Ultima revisione:    NdK del 03/10/17    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Manutenzione data maturazione               *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    MANUTENZIONE DATA DI MATURAZIONE    "       .
      ...
      *            *---------------------------------------------------*
      *            * Selezioni su conteggi                             *
      *            *---------------------------------------------------*
               10  w-tes-tip-mtz          pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Eventuali forzature                               *
      *            *---------------------------------------------------*
               10  w-tes-for-mtz          pic  9(07)                  .
      *            *---------------------------------------------------*
      ...
      *        * Data maturazione                                      *
      *        *-------------------------------------------------------*
           05  w-rig-dat-mtz              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Numero conteggio                                      *
      *        *-------------------------------------------------------*
           05  w-rig-num-ctg              pic  9(09)                  .
      *        *-------------------------------------------------------*
      *        * Numero maturazione                                    *
      *        *-------------------------------------------------------*
           05  w-rig-num-mtz              pic  9(09)                  .
      *        *-------------------------------------------------------*
      *        * Estremi documento                                     *
      *        *-------------------------------------------------------*
           05  w-rig-num-doc              pic  x(10)                  .
           05  w-rig-dat-doc              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Un intero record [gpm]                                *
      *        *-------------------------------------------------------*
           05  w-rig-rec-gpm.
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Selezione su tipo maturazione              *
      *        *-------------------------------------------------------*
           05  w-exp-tip-mat.
               10  w-exp-tip-mat-num      pic  9(02)       value 03   .
               10  w-exp-tip-mat-lun      pic  9(02)       value 40   .
               10  w-exp-tip-mat-tbl.
                   15  filler             pic  x(40) value
                            "Tutti i conteggi                        ".
                   15  filler             pic  x(40) value
                            "solo con maturazione Immediata          ".
                   15  filler             pic  x(40) value
                            "solo con maturazione a Fronte incasso   ".
      *        *-------------------------------------------------------*
      *        * Work per : Tipo di maturazione                        *
      *        *-------------------------------------------------------*
           05  w-exp-sel-mtz.
               10  w-exp-sel-mtz-num      pic  9(02)       value 02   .
               10  w-exp-sel-mtz-lun      pic  9(02)       value 40   .
      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [gpm]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-gpm.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-gpm-prt      pic  9(09)                  .
      ...
      *                  * Eventuali forzature                         *
      *                  *---------------------------------------------*
           perform   acc-for-mtz-000      thru acc-for-mtz-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Eventuali forzature                             *
      *              *-------------------------------------------------*
           perform   vis-for-mtz-000      thru vis-for-mtz-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Eventuali forzature                         *
      *                  *---------------------------------------------*
           perform   pmt-for-mtz-000      thru pmt-for-mtz-999        .
       pmt-key-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per : Eventuali forzature         *
      *    *-----------------------------------------------------------*
       pmt-for-mtz-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Selezioni su conteggi                      *
      *    *-----------------------------------------------------------*
       acc-tip-mat-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Selezioni su conteggi                   *
      *    *-----------------------------------------------------------*
       vis-tip-mat-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Eventuali forzature                        *
      *    *-----------------------------------------------------------*
       acc-for-mtz-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-for-mtz-999.
       acc-for-mtz-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-tes-for-mtz          .
       acc-for-mtz-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Eventuali forzature                     *
      *    *-----------------------------------------------------------*
       vis-for-mtz-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *                  * Data maturazione                            *
      *                  *---------------------------------------------*
           if        w-rig-dat-mtz        =    rf-gpm-dat-mtz
                     move  spaces         to   w-lin-imm-snx-svf
           else      move  "*"            to   w-lin-imm-snx-svf      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Numero documento                            *
      *                  *---------------------------------------------*
           move      w-rig-num-doc
                    (05 : 06)             to   w-lin-imm-num-doc      .
       vis-lin-cor-540.
      *                  *---------------------------------------------*
      ...
      *              * Data maturazione                                *
      *              *-------------------------------------------------*
           perform   vis-sel-mtz-000      thru vis-sel-mtz-999        .
      *              *-------------------------------------------------*
      *              * Numero conteggio                                *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data maturazione                 *
      *    *-----------------------------------------------------------*
       pmt-sel-mtz-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Numero maturazione               *
      *    *-----------------------------------------------------------*
       pmt-num-mtz-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Numero maturazione                *
      *    *-----------------------------------------------------------*
       vis-num-mtz-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-num-doc        to   w-all-str-cat (1)      .
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           ...
           move      zero                 to   w-tes-tip-mtz          .
           move      zero                 to   w-tes-for-mtz          .
           move      spaces               to   w-tes-cnf-imp          .
       nor-key-reg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-dat-mtz          .
           move      zero                 to   w-rig-num-ctg          .
           move      zero                 to   w-rig-num-mtz          .
           move      spaces               to   w-rig-num-doc          .
      ...
      *                  *---------------------------------------------*
      ...
      -              " esecuzione ---               "
       ...
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Start su [gpc] per data registrazione           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-410.
      *                  *---------------------------------------------*
      *                  * Selezione su conteggi maturati              *
      *                  *                                             *
      *                  * Da implementare                             *
      *                  *---------------------------------------------*
       stp-srt-inp-420.
      *                  *---------------------------------------------*
      *                  * Selezione con maturazione Immediata         *
      *                  *---------------------------------------------*
           if        w-tes-tip-mtz        =    01
                     go to stp-srt-inp-430
           else if   w-tes-tip-mtz        =    02
                     go to stp-srt-inp-422
           else if   w-tes-tip-mtz        =    03
                     go to stp-srt-inp-424
           else      go to stp-srt-inp-430.
       stp-srt-inp-422.
      *                      *-----------------------------------------*
      *                      * Test se con maturazione immediata       *
      *                      *-----------------------------------------*
           if        rf-gpc-tip-mat      not  = 01
                     go to stp-srt-inp-200.
           go to     stp-srt-inp-430.
       stp-srt-inp-424.
      *                      *-----------------------------------------*
      *                      * Test se con maturazione fronte incasso  *
      *                      *-----------------------------------------*
           if        rf-gpc-tip-mat      not  = 02
                     go to stp-srt-inp-200.
           go to     stp-srt-inp-430.
       stp-srt-inp-430.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-gpc-cod-age       not  = w-tes-cod-age
                     go to stp-srt-inp-200.
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      *              * Start su [gpm]                                  *
      *              *-------------------------------------------------*
           ...
           move      rf-gpc-num-ctg       to   rf-gpm-num-ctg         .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-520.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [gpm]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/age/fls/ioc/obj/iofgpm"
                                          to   s-pat                  .
      ...
      *              * Test max su [gpm]                               *
      *              *-------------------------------------------------*
           if        rf-gpm-num-ctg       not  = rf-gpc-num-ctg
                     go to stp-srt-inp-900.
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      rf-gpc-num-doc       to   srt-num-doc            .
      *                      *-----------------------------------------*
      *                      * Record [gpc]                            *
      *                      *-----------------------------------------*
      ...
      *              * Ripresa record [gpm]                            *
      *              *-------------------------------------------------*
           move      srt-rec-gpm          to   rf-gpm                 .
       car-fil-rap-500.
      *              *-------------------------------------------------*
      *              * Caricamento dati conteggio                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione dati non chiave riga corpo  *
      *                  *---------------------------------------------*
      ...
      *                      * Numero conteggio                        *
      *                      *-----------------------------------------*
           move      rf-gpc-num-ctg       to   w-rig-num-ctg          .
      *                      *-----------------------------------------*
      *                      * Estremi documento                       *
      *                      *-----------------------------------------*
           move      rf-gpc-dat-doc       to   w-rig-dat-doc          .
           move      rf-gpc-num-doc       to   w-rig-num-doc          .
      *                  *---------------------------------------------*
      *                  * Record [gpm]                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Numero maturazione                      *
      *                      *-----------------------------------------*
           move      rf-gpm               to   w-rig-rec-gpm          .
           move      rf-gpm-num-mtz       to   w-rig-num-mtz          .
      *                      *-----------------------------------------*
      *                      * Data maturazione                        *
      *                      *-----------------------------------------*
           move      rf-gpm-dat-mtz       to   w-rig-dat-mtz          .
      *                      *-----------------------------------------*
      *                      * Eventuale forzatura tipo maturazione    *
      *                      *-----------------------------------------*
           if        w-tes-for-mtz        =    zero
                     go to car-fil-rap-800.
           move      w-tes-for-mtz        to   w-rig-dat-mtz          .
       car-fil-rap-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      24                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "                  --- Aggiornamento conteggi in es
      -              "ecuzione ---                  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           move      w-rig-rec-gpm        to   rf-gpm                 .
           move      rf-gpm-num-mtz       to   w-cmp-rec-gpm-prt      .
       sca-fil-rap-500.
      *              *-------------------------------------------------*
      *              * Aggiornamento documenti                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Ottenimento record [gpm]                    *
      *                  *---------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMMTZ    "         to   f-key                  .
           move      w-cmp-rec-gpm-prt    to   rf-gpm-num-mtz         .
           move      "pgm/age/fls/ioc/obj/iofgpm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
      *                  * Aggiornamento tipo maturazione              *
      *                  *---------------------------------------------*
           move      w-rig-dat-mtz        to   rf-gpm-dat-mtz         .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [gpm]                         *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/age/prg/obj/page4502"                       .
       cnc-rlt-sup-999.
           exit.
