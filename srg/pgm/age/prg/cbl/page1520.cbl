      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma page1521:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA CAT. PROVV. PER AGENTE-CLIENTE  "       .
      ...
      *        *  - A : Per agente/cliente                             *
      *        *  - P : Per cliente/agente                             *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Codice categoria provvigione cliente                  *
      *        *-------------------------------------------------------*
           05  rr-cat-cli                 pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice categoria provvigione cliente, descrizione     *
      *        *-------------------------------------------------------*
           05  rr-cat-cli-des             pic  x(20)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento tabelle                   *
      *        *-------------------------------------------------------*
           05  w-exp-tor-tbl.
               10  w-exp-tor-tbl-num      pic  9(02)       value 02   .
               10  w-exp-tor-tbl-lun      pic  9(02)       value 40   .
               10  w-exp-tor-tbl-tbl.
                   15  filler             pic  x(40) value
                          "Per categorie agente/cliente            "  .
                   15  filler             pic  x(40) value
                          "Per categorie cliente/agente            "  .
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento elementi delle tabelle    *
      *        *-------------------------------------------------------*
           05  w-exp-tor-ele.
               10  w-exp-tor-ele-num      pic  9(02)       value 03   .
               10  w-exp-tor-ele-lun      pic  9(02)       value 20   .
               10  w-exp-tor-ele-tbl.
      ...
      *              * legate al cliente                               *
      *              *-------------------------------------------------*
           perform   cmn-zpv-003-opn-000  thru cmn-zpv-003-opn-999    .
       rou-opn-fls-999.
           exit.
      ...
      *              * legate al cliente                               *
      *              *-------------------------------------------------*
           perform   cmn-zpv-003-cls-000  thru cmn-zpv-003-cls-999    .
       rou-cls-fls-999.
           exit.
      ...
      *                  * Tipo ordinamento tabelle                    *
      *                  *---------------------------------------------*
           perform   acc-tor-tbl-000      thru acc-tor-tbl-999        .
      ...
      *                  * Tipo ordinamento elementi nelle tabelle     *
      *                  *---------------------------------------------*
           perform   acc-tor-ele-000      thru acc-tor-ele-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
       ...
       acc-ric-sel-250.
      *                  *---------------------------------------------*
      *                  * Categoria di provvigione per agente         *
      *                  *---------------------------------------------*
           perform   acc-cat-age-000      thru acc-cat-age-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
       ...
       acc-ric-sel-300.
      *                  *---------------------------------------------*
      *                  * Categoria di provvigione per cliente        *
      *                  *---------------------------------------------*
           perform   acc-cat-cli-000      thru acc-cat-cli-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * Tipo ordinamento tabelle                        *
      *              *-------------------------------------------------*
           perform   pmt-tor-tbl-000      thru pmt-tor-tbl-999        .
      *              *-------------------------------------------------*
      *              * Tipo ordinamento elementi nelle tabelle         *
      *              *-------------------------------------------------*
           perform   pmt-tor-ele-000      thru pmt-tor-ele-999        .
      *              *-------------------------------------------------*
      *              * Categoria di provvigioni per agente             *
      *              *-------------------------------------------------*
           perform   pmt-cat-age-000      thru pmt-cat-age-999        .
      *              *-------------------------------------------------*
      *              * Categoria di provvigioni per cliente            *
      *              *-------------------------------------------------*
           perform   pmt-cat-cli-000      thru pmt-cat-cli-999        .
      *              *-------------------------------------------------*
      *              * Si/No salto pagina                              *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt : Tipo ordinamento tabelle                         *
      *    *-----------------------------------------------------------*
       pmt-tor-tbl-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt : Tipo ordinamento elementi nelle tabelle          *
      *    *-----------------------------------------------------------*
       pmt-tor-ele-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      07                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipo ordinamento elementi  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *    *===========================================================*
      *    * Prompt : Categoria provvigioni agente                     *
      *    *-----------------------------------------------------------*
       pmt-cat-age-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt : Categoria provvigioni cliente                    *
      *    *-----------------------------------------------------------*
       pmt-cat-cli-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-snx-slp-000.
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Si/No salto pagina ad ogni :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo ordinamento tabelle                   *
      *    *-----------------------------------------------------------*
       acc-tor-tbl-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tor-tbl-lun    to   v-car                  .
           move      w-exp-tor-tbl-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      w-exp-tor-tbl-tbl    to   v-txt                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-tor-tbl-999.
       acc-tor-tbl-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "A"            to   rr-tor-tbl
           else if   v-num                =    02
                     move  "C"            to   rr-tor-tbl
           else      move  spaces         to   rr-tor-tbl             .
       acc-tor-tbl-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-tor-tbl           =    spaces
                     go to acc-tor-tbl-100.
       acc-tor-tbl-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       acc-tor-tbl-625.
      *                  *---------------------------------------------*
      *                  * Visualizzazione prompt relativo al campo    *
      *                  * Si/No salto pagina                          *
      *                  *---------------------------------------------*
           perform   pmt-snx-slp-000      thru pmt-snx-slp-999        .
       acc-tor-tbl-800.
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo ordinamento elementi nelle tabelle    *
      *    *-----------------------------------------------------------*
       acc-tor-ele-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tor-ele-lun    to   v-car                  .
           move      w-exp-tor-ele-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      w-exp-tor-ele-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      07                   to   v-lin                  .
           ...
           if        rr-tor-ele           =    "C"
                     move  01             to   v-num
           else if   rr-tor-ele           =    "M"
                     move  02             to   v-num
           else if   rr-tor-ele           =    "D"
                     move  03             to   v-num
           else      move  zero           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-tor-ele-999.
       acc-tor-ele-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "C"            to   rr-tor-ele
           else if   v-num                =    02
                     move  "M"            to   rr-tor-ele
           else if   v-num                =    03
                     move  "D"            to   rr-tor-ele
           else      move  spaces         to   rr-tor-ele             .
       acc-tor-ele-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-tor-ele           =    spaces
                     go to acc-tor-ele-100.
       acc-tor-ele-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Categoria di provvigione agente            *
      *    *-----------------------------------------------------------*
       acc-cat-age-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cat-age           to   w-cmn-zpv-001-cod      .
           move      11                   to   w-cmn-zpv-001-lin      .
           move      30                   to   w-cmn-zpv-001-pos      .
           move      11                   to   w-cmn-zpv-001-dln      .
           move      37                   to   w-cmn-zpv-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
       ...
       acc-cat-age-110.
           ...
           if        w-cmn-zpv-001-ope    =    "F+"
                     go to acc-cat-age-115.
           if        w-cmn-zpv-001-ope    =    "AC"
                     go to acc-cat-age-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cat-age-115.
           perform   cmn-zpv-001-foi-000  thru cmn-zpv-001-foi-999    .
           go to     acc-cat-age-110.
       acc-cat-age-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-cat-age-999.
       acc-cat-age-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-cat-age             .
       acc-cat-age-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cat-age           to   w-let-arc-zpv-cod      .
           perform   let-arc-zpv-000      thru let-arc-zpv-999        .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione descrizione                 *
      *                  *---------------------------------------------*
           if        rr-cat-age           =    zero
                     move  "Tutte"        to   rr-cat-age-des
           else      move  w-let-arc-zpv-des
                                          to   rr-cat-age-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cat-age-des-000  thru vis-cat-age-des-999    .
      *                  *---------------------------------------------*
      *                  * Se codice errato : reimpostazione           *
      *                  *---------------------------------------------*
           if        w-let-arc-zpv-flg    not  = spaces
                     go to acc-cat-age-100.
       acc-cat-age-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Categoria di provvigione agente, de-    *
      *    *                   scrizione                               *
      *    *-----------------------------------------------------------*
       vis-cat-age-des-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Categoria di provvigione cliente           *
      *    *-----------------------------------------------------------*
       acc-cat-cli-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cat-cli           to   w-cmn-zpv-003-cod      .
           move      14                   to   w-cmn-zpv-003-lin      .
           move      30                   to   w-cmn-zpv-003-pos      .
           move      14                   to   w-cmn-zpv-003-dln      .
           move      37                   to   w-cmn-zpv-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "INSR"               to   v-pfk (04)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   cmn-zpv-003-cll-000  thru cmn-zpv-003-cll-999    .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
           perform   cmn-zpv-003-foi-000  thru cmn-zpv-003-foi-999    .
       acc-cat-cli-110.
           perform   cmn-zpv-003-cll-000  thru cmn-zpv-003-cll-999    .
           if        w-cmn-zpv-003-ope    =    "F+"
                     go to acc-cat-cli-115.
           if        w-cmn-zpv-003-ope    =    "AC"
                     go to acc-cat-cli-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cat-cli-115.
           perform   cmn-zpv-003-foi-000  thru cmn-zpv-003-foi-999    .
           go to     acc-cat-cli-110.
       acc-cat-cli-120.
           move      w-cmn-zpv-003-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-cat-cli-999.
       acc-cat-cli-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-cat-cli             .
       acc-cat-cli-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cat-cli           to   w-let-arc-zpv-cod      .
           perform   let-arc-zpv-000      thru let-arc-zpv-999        .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione descrizione                 *
      *                  *---------------------------------------------*
           if        rr-cat-cli           =    zero
                     move  "Tutte"        to   rr-cat-cli-des
           else      move  w-let-arc-zpv-des
                                          to   rr-cat-cli-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cat-cli-des-000  thru vis-cat-cli-des-999    .
      *                  *---------------------------------------------*
      *                  * Se codice errato : reimpostazione           *
      *                  *---------------------------------------------*
           if        w-let-arc-zpv-flg    not  = spaces
                     go to acc-cat-cli-100.
       acc-cat-cli-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Categoria di provvigione cliente, de-   *
      *    *                   scrizione                               *
      *    *-----------------------------------------------------------*
       vis-cat-cli-des-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Si/No salto pagina                         *
      *    *-----------------------------------------------------------*
       acc-snx-slp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Controllo su tipo ordinamento tabelle           *
      *              *-------------------------------------------------*
           if        rr-tor-tbl           not  = spaces
                     go to tdo-ric-sel-102.
           move      "Manca il tipo di ordinamento per le tabelle !     
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-102.
           ...
           move      "Tipo di ordinamento per le tabelle errato !       
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo su tipo ordinamento elementi          *
      *              *-------------------------------------------------*
           if        rr-tor-ele           not  = spaces
                     go to tdo-ric-sel-202.
           move      "Manca il tipo di ordinamento per gli elementi dell
      -              "e tabelle !    "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-202.
           if        rr-tor-ele           =    "C" or
                     rr-tor-ele           =    "M" or
           ...
           move      "Tipo di ordinamento per gli elementi delle tabelle
      -              " errato !      "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-300.
      *              *-------------------------------------------------*
      *              * Controlli superati                              *
      ...
      *              * Tipo ordinamento elementi nelle tabelle         *
      *              *-------------------------------------------------*
           if        rr-tor-ele           not  = "C" and
                     rr-tor-ele           not  = "M" and
                     rr-tor-ele           not  = "D"
                     move  "C"            to   rr-tor-ele             .
       reg-ric-sel-200.
      *              *-------------------------------------------------*
      ...
      *              * Tipo ordinamento tabelle                        *
      *              *-------------------------------------------------*
           move      spaces               to   rr-tor-tbl             .
      *              *-------------------------------------------------*
      *              * Tipo ordinamento elementi nelle tabelle         *
      *              *-------------------------------------------------*
           move      spaces               to   rr-tor-ele             .
      *              *-------------------------------------------------*
      *              * Codice categoria provvigione agente             *
      *              *-------------------------------------------------*
           move      zero                 to   rr-cat-age             .
      *              *-------------------------------------------------*
      *              * Codice categoria provvigione agente, descri-    *
      *              * zione                                           *
      *              *-------------------------------------------------*
           move      spaces               to   rr-cat-age-des         .
      *              *-------------------------------------------------*
      *              * Codice categoria provvigione cliente            *
      *              *-------------------------------------------------*
           move      zero                 to   rr-cat-cli             .
      *              *-------------------------------------------------*
      *              * Codice categoria provvigione cliente, descri-   *
      *              * zione                                           *
      *              *-------------------------------------------------*
           move      spaces               to   rr-cat-cli-des         .
      *              *-------------------------------------------------*
      *              * Si/No salto pagina                              *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Test se codice categoria a zero                 *
      *              *-------------------------------------------------*
      ...
      *    * vigioni legato all'agente                                 *
      *    *-----------------------------------------------------------*
           copy      "pgm/age/prg/cpy/acmnzpv1.acs"                   .

      *    *===========================================================*
      *    * Subroutines per l'accettazione del codice categoria prov- *
      *    * vigioni legato al cliente                                 *
      *    *-----------------------------------------------------------*
           copy      "pgm/age/prg/cpy/acmnzpv3.acs"                   .
