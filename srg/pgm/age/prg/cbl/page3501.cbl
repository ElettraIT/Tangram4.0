      ...
      *                                   Fase:    age350              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 27/09/94    *
      *                       Ultima revisione:    NdK del 06/12/01    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma page3500 *
      *                                                                *
      *                    Stampa elenco delle provvigioni conteggiate *
      *                    di un periodo, per cliente                  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA DI RIEPILOGO CONTEGGI PER CLIENTE"       .
      ...
      *        *  - 01 : Ordinamento per ragione sociale cliente       *
      *        *  - 02 : Ordinamento per codice cliente                *
      *        *  - 03 : Ordinamento per mnemonico cliente             *
      *        *                                                       *
      ...
      *            *---------------------------------------------------*
               10  w-liv-cli-tot-ibl      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * Totale importo provvigioni                        *
      *            *---------------------------------------------------*
               10  w-liv-cli-tot-pvg      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * % media di provvigione                            *
      *            *---------------------------------------------------*
               10  w-liv-cli-per-mdp      pic  9(02)v9(01)            .
      *            *---------------------------------------------------*
      *            * Numero conteggi trattati per il cliente           *
      *            *---------------------------------------------------*
               10  w-liv-cli-num-ctg      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Generale                                              *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *            *---------------------------------------------------*
      *            * Numero clienti trattati in totale                 *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per intestazione cliente                     *
      *        *-------------------------------------------------------*
           05  w-stp-cli.
      *            *---------------------------------------------------*
      *            * Numero totale di intestazioni cliente stampate    *
      *            *---------------------------------------------------*
               10  w-stp-cli-num-int      pic  9(05)       value zero .
      *            *---------------------------------------------------*
      *            * Area da stampare, centrata sulla pagina, allinea- *
      *            * ta a sinistra                                     *
      *            *---------------------------------------------------*
               10  w-stp-cli-ads-asx      pic  x(72)                  .
      *            *---------------------------------------------------*
      *            * Area da stampare, centrata sulla pagina, allinea- *
      *            * ta al centro                                      *
      *            *---------------------------------------------------*
               10  w-stp-cli-ads-sub      pic  x(72)                  .
      *            *---------------------------------------------------*
      *            * Lunghezza area da stampare                        *
      *            *---------------------------------------------------*
               10  w-stp-cli-ads-lng      pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Posizione di stampa iniziale, centrata sulla pa-  *
      *            * gina                                              *
      *            *---------------------------------------------------*
               10  w-stp-cli-pos-dsi      pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Literal per intestazione                          *
      *            *---------------------------------------------------*
               10  w-stp-cli-lit-int      pic  x(30)                  .
      *            *---------------------------------------------------*
      *            * Tipo di intestazione                              *
      *            *   - C : Relativa ad un codice cliente             *
      *            *   - T : Relativa al totale generale               *
      *            *---------------------------------------------------*
               10  w-stp-cli-tip-int      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore codice numerico                            *
      *            *---------------------------------------------------*
               10  w-stp-cli-cod-num      pic  9(13)                  .
      *            *---------------------------------------------------*
      *            * Valore descrizione                                *
      *            *---------------------------------------------------*
               10  w-stp-cli-cod-des      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Valore codice numerico editato                    *
      *            *---------------------------------------------------*
               10  w-stp-cli-cod-ned      pic  x(13)                  .
      *            *---------------------------------------------------*
      *            * Contatori di comodo                               *
      *            *---------------------------------------------------*
               10  w-stp-cli-wct-c01      pic  9(03)                  .
               10  w-stp-cli-wct-c02      pic  9(03)                  .
      *        *-------------------------------------------------------*
      ...
      *                  * un solo cliente o tutti i clienti           *
      *                  *---------------------------------------------*
           if        rr-cod-cli           =    zero
      ...
      *                  *---------------------------------------------*
       stp-srt-inp-022.
      *                      *-----------------------------------------*
      *                      * Start per cliente e data documento      *
      *                      *-----------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "CDNDOC    "         to   f-key                  .
           move      rr-cod-cli           to   rf-gpc-cod-cli         .
      ...
      *                      *-----------------------------------------*
       ...
       stp-srt-inp-230.
      *                  *---------------------------------------------*
      *                  * Se richiesti tutti gli clienti              *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test su data documento                  *
      *                      *-----------------------------------------*
      ...
      *                  * relativa alla subchiave 1 : per cliente     *
      *                  *---------------------------------------------*
       stp-srt-inp-552.
      *                      *-----------------------------------------*
      *                      * Flag di codice diverso da zero ma non   *
      *                      * trovato in archivio clienti             *
      *                      *                                         *
      *                      * Se ordinamento clienti per codice viene *
      *                      * forzato a zero                          *
      *                      *                                         *
      *                      * Se ordinamento clienti per ragione so-  *
      *                      * ciale o per mnemonico viene posto a se- *
      *                      * seconda del valore del codice cliente e *
      *                      * dell'esistenza o meno dell'anagrafica   *
      *                      *-----------------------------------------*
           if        rr-tor-cli           =    02
                     move  zero           to   srt-k01-flg-eon
           else if   rf-gpc-cod-cli       =    zero
                     move  9              to   srt-k01-flg-eon
           else if   w-let-cli-dcc-flg    =    spaces
      ...
      *                      *                                         *
      *                      * Se ordinamento clienti per codice o per *
      *                      * mnemonico viene forzato a spaces        *
      *                      *                                         *
      *                      * Se ordinamento clienti per ragione so-  *
      *                      * ciale viene posto al valore proveniente *
      *                      * dall'anagrafica cliente                 *
      *                      *-----------------------------------------*
           if        rr-tor-cli           =    02 or
                     rr-tor-cli           =    03
                     move  spaces         to   srt-k01-rsc-cli
           else      move  w-let-cli-dcc-rag
                                          to   srt-k01-rsc-cli        .
       stp-srt-inp-556.
      *                      *-----------------------------------------*
      *                      * Mnemonico per il cliente                *
      *                      *                                         *
      *                      * Se ordinamento clienti per codice o per *
      *                      * ragione sociale viene forzato a spaces  *
      *                      *                                         *
      *                      * Se ordinamento clienti per mnemonico,   *
      ...
      *                      *                                         *
      *                      * Se ordinamento clienti per ragione so-  *
      *                      * ciale o per mnemonico viene forzato a   *
      *                      * zero                                    *
      *                      *                                         *
      *                      * Se ordinamento clienti per codice, vie- *
      *                      * ne posto a seconda del valore del codi- *
      *                      * ce                                      *
      *                      *-----------------------------------------*
           if        rr-tor-cli           =    01 or
                     rr-tor-cli           =    03
      ...
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
           move      rf-gpc-cod-cli       to   srt-k01-cod-cli        .
       stp-srt-inp-570.
      *                  *---------------------------------------------*
      *                  * Composizione dell'area del record di sort   *
      ...
      *                      *-----------------------------------------*
       ...
       stp-srt-inp-630.
      *                      *-----------------------------------------*
      *                      * Codice dipendenza del cliente per la fa *
      *                      * tturazione                              *
      *                      *-----------------------------------------*
      ...
      *                  * Codice cliente                              *
      *                  *---------------------------------------------*
           move      srt-gpc-cod-cli      to   w-rot-l01-cod-cli      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-cic-200.
      *              *-------------------------------------------------*
      *              * Se non sono stati trattati almeno due clienti : *
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-cic-400.
      *              *-------------------------------------------------*
      *              * Intestazione cliente per totale generale        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                      * rale                                    *
      *                      *-----------------------------------------*
           move      "T"                  to   w-stp-cli-tip-int      .
      *                      *-----------------------------------------*
      *                      * Valore numerico per il codice cliente : *
      *                      * non significativo                       *
      *                      *-----------------------------------------*
           move      zero                 to   w-stp-cli-cod-num      .
      *                      *-----------------------------------------*
      *                      * Descrizione per il codice cliente : non *
      *                      * significativa                           *
      *                      *-----------------------------------------*
           move      spaces               to   w-stp-cli-cod-des      .
      *                  *---------------------------------------------*
      *                  * Richiamo subroutine                         *
      *                  *---------------------------------------------*
           perform   stp-int-cli-000      thru stp-int-cli-999        .
       prn-fin-cic-500.
      *              *-------------------------------------------------*
      ...
      *                  * Codice cliente                              *
      *                  *---------------------------------------------*
           move      srt-gpc-cod-cli      to   w-liv-cli-cod-cli      .
      *                  *---------------------------------------------*
      *                  * Ragione sociale per il cliente              *
      *                  *---------------------------------------------*
           move      srt-cli-rag-cli      to   w-liv-cli-rag-cli      .
      *                  *---------------------------------------------*
      *                  * Totale imponibile provvigionale             *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cli-tot-ibl      .
      *                  *---------------------------------------------*
      *                  * Totale importo provvigioni                  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cli-tot-pvg      .
      *                  *---------------------------------------------*
      *                  * % media di provvigione                      *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cli-per-mdp      .
      *                  *---------------------------------------------*
      *                  * Numero conteggi trattati il cliente         *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-cli-num-ctg      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Tipo intestazione : per un codice cli-  *
      *                      * ente                                    *
      *                      *-----------------------------------------*
           move      "C"                  to   w-stp-cli-tip-int      .
      *                      *-----------------------------------------*
      *                      * Valore numerico per il codice cliente   *
      *                      *-----------------------------------------*
           move      w-liv-cli-cod-cli    to   w-stp-cli-cod-num      .
      *                      *-----------------------------------------*
      *                      * Descrizione per il codice cliente       *
      *                      *-----------------------------------------*
           move      w-liv-cli-rag-cli    to   w-stp-cli-cod-des      .
      *                  *---------------------------------------------*
      *                  * Richiamo subroutine                         *
      *                  *---------------------------------------------*
           perform   stp-int-cli-000      thru stp-int-cli-999        .
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-lr1-500.
      *              *-------------------------------------------------*
      *              * Stampa totali relativi al cliente               *
      *              *-------------------------------------------------*
       prn-fin-lr1-520.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "Totali relativi al cliente :"
                                          to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           if        w-liv-cli-tot-ibl    >    999999999 or
                     w-liv-cli-tot-ibl    <   -999999999
                     move  11             to   p-car
           ...
           move      p-lnr                to   p-lin                  .
           move      59                   to   p-pos                  .
           move      w-liv-cli-tot-ibl    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Determinazione della % media di provvigione *
      *                  *---------------------------------------------*
           move      w-liv-cli-tot-ibl    to   w-det-pme-sop-ibl      .
           move      w-liv-cli-tot-pvg    to   w-det-pme-sop-amm      .
      ...
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           if        w-liv-cli-tot-pvg    >    999999999 or
                     w-liv-cli-tot-pvg    <   -999999999
                     move  11             to   p-car
           else      move  09             to   p-car                  .
           move      c-dec                to   p-dec                  .
           move      "S"                  to   p-sgn                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      78                   to   p-pos                  .
           move      w-liv-cli-tot-pvg    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-lr1-999.
           exit.
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-075.
      *              *-------------------------------------------------*
      *              * Incremento totale imponibile provvigionale      *
      *              *-------------------------------------------------*
           if        w-ass-ctg-ibl-pvg    not  = zero and
                     w-ass-ctg-amm-pvg    not  = zero
                     add   w-ass-ctg-ibl-pvg
                                          to   w-liv-cli-tot-ibl      .
      *              *-------------------------------------------------*
      *              * Incremento totale ammontare provvigioni         *
      *              *-------------------------------------------------*
           if        w-ass-ctg-ibl-pvg    not  = zero and
                     w-ass-ctg-amm-pvg    not  = zero
                     add   w-ass-ctg-amm-pvg
                                          to   w-liv-cli-tot-pvg      .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Subroutine per l'intestazione cliente                     *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-cli-cod-num : Valore codice, se numerico        *
      *    *                                                           *
      *    *   - w-stp-cli-cod-des : Descrizione per il codice         *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       stp-int-cli-000.
      *              *-------------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           if        w-stp-cli-num-int    >    zero
                     go to stp-int-cli-200.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "Cliente :                     "
                                          to   w-stp-cli-lit-int      .
       stp-int-cli-030.
      *                  *---------------------------------------------*
      *                  * Determinazione lunghezza area di intesta-   *
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-stp-cli-ads-asx      .
           move      zero                 to   w-stp-cli-ads-lng      .
           inspect   w-stp-cli-ads-asx
                                      tallying w-stp-cli-ads-lng
                                          for  all   spaces           .
       stp-int-cli-040.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      p-sel-als-sel        to   w-stp-cli-pos-dsi      .
           subtract  w-stp-cli-ads-lng    from w-stp-cli-pos-dsi      .
           divide    2                    into w-stp-cli-pos-dsi      .
           add       1                    to   w-stp-cli-pos-dsi      .
       stp-int-cli-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      w-stp-cli-ads-lng    to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      w-stp-cli-pos-dsi    to   p-pos                  .
           move      all   "="            to   w-stp-cli-ads-sub      .
           move      w-stp-cli-ads-sub    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Interlinea                                      *
      *              *-------------------------------------------------*
       ...
       stp-int-cli-400.
      *              *-------------------------------------------------*
      *              * Linea centrale di intestazione cliente          *
      *              *-------------------------------------------------*
       stp-int-cli-410.
      *                  *---------------------------------------------*
      ...
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        w-stp-cli-tip-int    not  = "T"
                     go to stp-int-cli-420.
      *                      *-----------------------------------------*
      *                      * Literal fisso                           *
      *                      *-----------------------------------------*
           move      "TOTALE GENERALE                                   
      -              "                      "
                                          to   w-stp-cli-ads-asx      .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
           go to     stp-int-cli-500.
       stp-int-cli-420.
      *                  *---------------------------------------------*
      ...
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        w-stp-cli-cod-num    not  = zero
                     go to stp-int-cli-450.
      *                      *-----------------------------------------*
      *                      * Literal fisso                           *
      *                      *-----------------------------------------*
           move      "Conteggi provvigionali non attribuiti ad alcun cli
      -              "ente                  "
                                          to   w-stp-cli-ads-asx      .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      ...
      *                          * Concatenamento                      *
      *                          *-------------------------------------*
           move      w-stp-cli-lit-int    to   w-stp-cli-ads-asx      .
      *                          *-------------------------------------*
      *                          * Primo non-blank utile in coda       *
      *                          *-------------------------------------*
           move      zero                 to   w-stp-cli-wct-c02      .
           inspect   w-stp-cli-ads-asx
                                      tallying w-stp-cli-wct-c02
                                  for trailing spaces                 .
           move      w-stp-cli-ads-lng    to   w-stp-cli-wct-c01      .
           subtract  w-stp-cli-wct-c02    from w-stp-cli-wct-c01      .
           add       1                    to   w-stp-cli-wct-c01      .
       stp-int-cli-460.
      *                      *-----------------------------------------*
      *                      * Codice                                  *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<"                  to   p-edm                  .
           move      w-stp-cli-cod-num    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-stp-cli-cod-ned      .
      *                          *-------------------------------------*
      *                          * Concatenamento                      *
      *                          *-------------------------------------*
           add       1                    to   w-stp-cli-wct-c01      .
           move      w-stp-cli-cod-ned    to   w-stp-cli-ads-asx
                                              (w-stp-cli-wct-c01 :)   .
      *                          *-------------------------------------*
      *                          * Primo non-blank utile in coda       *
      *                          *-------------------------------------*
      ...
      *                          * Concatenamento                      *
      *                          *-------------------------------------*
           add       2                    to   w-stp-cli-wct-c01      .
           move      w-stp-cli-cod-des    to   w-stp-cli-ads-asx
                                              (w-stp-cli-wct-c01 :)   .
       stp-int-cli-500.
      *                  *---------------------------------------------*
      *                  * Preparazione stringa di intestazione, alli- *
      ...
      *                      * al centro                               *
      *                      *-----------------------------------------*
           move      spaces               to   w-stp-cli-ads-sub      .
      *                      *-----------------------------------------*
      *                      * Determinazione posizione iniziale per   *
      *                      * l'area allineata al centro              *
      *                      *-----------------------------------------*
           move      zero                 to   w-stp-cli-wct-c01      .
           inspect   w-stp-cli-ads-asx
                                      tallying w-stp-cli-wct-c01
                                  for trailing spaces                 .
           divide    2                    into w-stp-cli-wct-c01      .
           add       1                    to   w-stp-cli-wct-c01      .
      *                      *-----------------------------------------*
      *                      * Spostamento area allineata a sinistra   *
      *                      * in area allineata al centro             *
      *                      *-----------------------------------------*
           move      w-stp-cli-ads-asx    to   w-stp-cli-ads-sub
                                              (w-stp-cli-wct-c01 :)   .
       stp-int-cli-550.
      *                  *---------------------------------------------*
      *                  * Stampa                                      *
      ...
      *              *-------------------------------------------------*
       ...
       stp-int-cli-900.
      *              *-------------------------------------------------*
      *              * Post-intestazione-cliente                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento numero totale sub-intestazioni   *
      *                  * stampate                                    *
      *                  *---------------------------------------------*
           add       1                    to   w-stp-cli-num-int      .
       stp-int-cli-999.
           exit.
      ...
      *                      *-----------------------------------------*
       ...
       let-cli-dcc-250.
      *                  *---------------------------------------------*
      *                  * Lettura anagrafica [cli] per codice mnemo-  *
      *                  * nico                                        *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLI"             to   f-key                  .
           ...
           call      s-pat               using f
                                               rf-cli                 .
           if        f-sts                =    e-not-err
                     go to let-cli-dcc-260
           else      go to let-cli-dcc-330.
       let-cli-dcc-260.
      *                      *-----------------------------------------*
      *                      * Codice mnemonico                        *
      *                      *-----------------------------------------*
