      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma age152   *
      *                                                                *
      ...
      *                      *-----------------------------------------*
           ...
           move      rr-cat-cli           to   rf-zpx-cod-due         .
           move      "pgm/age/fls/ioc/obj/iofzpx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-340.
      *                  *---------------------------------------------*
      *                  * Se : per cliente/agente                     *
      *                  *---------------------------------------------*
           if        rr-cat-cli           =    zero
                     go to stp-srt-inp-400.
           if        rf-zpx-cod-due       >    rr-cat-cli
                     go to stp-srt-inp-800
           else      go to stp-srt-inp-400.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       stp-int-pag-022.
           move      "CATEGORIE PROVVIGIONI INCROCIATE PER AGENTE-CLIENT
      -              "E"                  to   w-stp-int-tit-stp      .
           go to     stp-int-pag-025.
       stp-int-pag-023.
           move      "CATEGORIE PROVVIGIONI INCROCIATE PER CLIENTE-AGENT
      -              "E"                  to   w-stp-int-tit-stp      .
           go to     stp-int-pag-025.
       stp-int-pag-025.
      *                      *-----------------------------------------*
