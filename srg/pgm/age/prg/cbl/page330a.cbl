      ...
      *                                                                *
      *                    Analisi globale conteggi per agente         *
      *                                                                *
      *================================================================*
      ...
      *            * Imponibile                                        *
      *            *---------------------------------------------------*
               10  w-det-pme-sop-ibl      pic   9(13)                 .
      *            *---------------------------------------------------*
      *            * Ammontare                                         *
      *            *---------------------------------------------------*
               10  w-det-pme-sop-amm      pic   9(13)                 .
      *            *---------------------------------------------------*
      *            * % media calcolata                                 *
      *            *---------------------------------------------------*
      ...
      *            *  - 11 : Detrazione  a fronte fattura              *
      *            *---------------------------------------------------*
      ...
      *                * Totale 'Imponibile'                           *
      *                *-----------------------------------------------*
                   15  w-ana-age-tts-ibl  pic s9(11)                  .
      *                *-----------------------------------------------*
      *                * Totale 'Conteggiato'                          *
      *                *-----------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "          Tipo conteggio               provvigiona
      -              "le    conteggiate       media "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      38                   to   v-pos                  .
           move      w-ana-age-tts-ibl (01)
                                          to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Provvigioni conteggiate                 *
      *                      *-----------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
           move      11                   to   v-car                  .
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Determinazione % media di provvigioni   *
      *                      *-----------------------------------------*
           move      w-ana-age-tts-ibl (01)
                                          to   w-det-pme-sop-ibl      .
           move      w-ana-age-tts-ctg (01)
                                          to   w-det-pme-sop-amm      .
           perform   det-pme-sop-000      thru det-pme-sop-999        .
      *                      *-----------------------------------------*
      *                      * % media di provvigioni                  *
      *                      *-----------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      02                   to   v-car                  .
           ...
           move      v-lnr                to   v-lin                  .
           move      76                   to   v-pos                  .
           move      w-det-pme-sop-per    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      "Provvigioni a fronte Nota Addebito :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      "Detrazioni a fronte Nota Accredito :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Preparazione per la determinazione      *
      *                      * della % media provvigioni               *
      *                      *-----------------------------------------*
           move      w-ana-age-tts-s03    to   w-det-pme-sop-ibl      .
       vis-tot-tts-840.
      *                  *---------------------------------------------*
      *                  * Totale 'Conteggiato'                        *
      *                  *---------------------------------------------*
      ...
      *                      * della % media provvigioni               *
      *                      *-----------------------------------------*
           move      w-ana-age-tts-s03    to   w-det-pme-sop-amm      .
       vis-tot-tts-850.
      *                  *---------------------------------------------*
      *                  * Totale '% media'                            *
      *                  *---------------------------------------------*
       vis-tot-tts-851.
      *                      *-----------------------------------------*
      *                      * Determinazione della % media di provvi- *
      *                      * gione                                   *
      *                      *-----------------------------------------*
           perform   det-pme-sop-000      thru det-pme-sop-999        .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "ANALISI GLOBALE CONTEGGI AL"
                                          to   w-all-str-cat (1)      .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-ana-age-tts-num
                                              (w-ana-age-tts-i01)     .
      *              *-------------------------------------------------*
      *              * Azzeramento totale 'Imponibile'                 *
      *              *-------------------------------------------------*
           move      zero                 to   w-ana-age-tts-ibl
                                              (w-ana-age-tts-i01)     .
      *              *-------------------------------------------------*
      ...
      *                   *--------------------------------------------*
           add       rf-gpc-ibl-pvg       to   w-ana-age-tts-ibl
                                              (w-ana-age-tts-i01)     .
      *                   *--------------------------------------------*
      ...
      *                   * Aggiornamento 'Imponibile'                 *
      *                   *--------------------------------------------*
           subtract  rf-gpc-ibl-pvg       from w-ana-age-tts-ibl
                                              (w-ana-age-tts-i01)     .
      *                   *--------------------------------------------*
      *                   * Aggiornamento 'Conteggiato'                *
      *                   *--------------------------------------------*
