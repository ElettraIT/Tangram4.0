...
______*              go to stp-srt-inp-800.
      ...
      *    *===========================================================*
      *    * Subroutine per archivio sequenziale per Cliente           *
      *    *-----------------------------------------------------------*
       exe-gen-fil-age-000.
      *              *-------------------------------------------------*
      *              * Test se da eseguire                             *
