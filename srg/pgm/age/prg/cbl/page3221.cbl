      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma page3220 *
      *                                                                *
      *                    Stampa elenco delle provvigioni conteggiate *
      *                    di un periodo, per data                     *
      *                                                                *
      *================================================================*
      ...
      *                *  - 11 : Conteggio a fronte fattura, ma in     *
      *                *         detrazione                            *
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA CONTEGGI PROVVIGIONALI PER DATA "       .
      ...
      *
           ...
           perform   all-str-adx-000      thru all-str-adx-999        .
           move      w-all-str-alf        to   w-stp-det-col-001 (1)  .
       prn-liv-det-250.
      *                  *---------------------------------------------*
      *                  * Colonna 2                                   *
      *                  *---------------------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<"                  to   p-edm                  .
           move      srt-gpc-cod-age      to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                              *---------------------------------*
      *                              * In area di stampa               *
      *                              *---------------------------------*
           if        srt-age-nom-age      =    spaces
                     move  "Agente: "     to   w-stp-det-col-006 (1)
                                              (01 : 08)
                     move  p-edt (1 : 7)  to   w-stp-det-col-006 (1)
                                              (09 : 07)
           else      move  srt-age-nom-age
                                          to   w-stp-det-col-006 (1)
                                              (01 : 20)               .
       prn-liv-det-520.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Se codice agente a zero : no stampa *
      *                          *-------------------------------------*
           if        srt-gpc-cod-age      =    zero
                     go to prn-liv-det-550.
      *                          *-------------------------------------*
      *                          * Se non e' una vendita indiretta :   *
      *                          * no stampa                           *
      *                          *-------------------------------------*
           if        srt-gpc-tip-vpa      not  = 02
                     go to prn-liv-det-550.
       prn-liv-det-522.
      *                              *---------------------------------*
      *                              * In area di stampa               *
      ...
      *                  *---------------------------------------------*
           move      spaces               to   w-stp-int-sbt-stp      .
      *                  *---------------------------------------------*
