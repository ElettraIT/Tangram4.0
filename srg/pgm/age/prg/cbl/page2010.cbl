      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [age]            *
      *                                                                *
      *                    Anagrafico Agenti                           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   INTERROGAZIONE ANAGRAFICA AGENTI    "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-rip-str.
      *        *-------------------------------------------------------*
      *        * Work-area per ripristino Start su [age]               *
      *        *-------------------------------------------------------*
           05  w-rip-str-age.
      *            *---------------------------------------------------*
      *            * Flag di End-of-file                               *
      *            *---------------------------------------------------*
               10  w-rip-str-age-eof      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Parametri di Start                                *
      *            *---------------------------------------------------*
               10  w-rip-str-age-cod      pic  9(07)                  .
               10  w-rip-str-age-nom      pic  x(20)                  .
               10  w-rip-str-age-rag      pic  x(40)                  .
               10  w-rip-str-age-mne      pic  x(10)                  .

      *    *===========================================================*
      *    * Work-area per ridefinizione contenuto del mark-point      *
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-cod-age              pic  9(07)                  .
           05  w-mpn-sup-age              pic  9(07)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-ipc-dlp-tdi-nom    to   rr-nom-min             .
           move      w-ipc-dlp-tdi-nom    to   rr-nom-max             .
      ...
      *              * al ripristino Start                             *
      *              *-------------------------------------------------*
           move      spaces               to   w-rip-str-age-eof      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-rag-min           to   rf-age-rag-key         .
      ...
      *              *-------------------------------------------------*
           if        rf-age-cod-age       <    rr-cod-min or
                     rf-age-cod-age       >    rr-cod-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su ragione sociale                    *
      *              *-------------------------------------------------*
           if        rf-age-rag-key       <    rr-rag-min or
                     rf-age-rag-key       >    rr-rag-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-age-cod-mne       <    rr-mne-min or
                     rf-age-cod-mne       >    rr-mne-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su nominativo                         *
      *              *-------------------------------------------------*
           if        rf-age-nom-key       <    rr-nom-min or
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-age-cod-age       to   w-mpn-cod-age          .
           move      rf-age-sup-age       to   w-mpn-sup-age          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *
           if        rf-age-sta-tus       =    01
                     move  "(normale)     "
                                          to   v-alf
           else if   rf-age-sta-tus       =    11
                     move  "Esauriti rapp."
                                          to   v-alf
           else if   rf-age-sta-tus       =    21
                     move  "Sostituito    "
                                          to   v-alf
           else if   rf-age-sta-tus       =    51
                     move  "Cessata attiv."
                                          to   v-alf
           else if   rf-age-sta-tus       =    52
                     move  "Cessata attiv."
                                          to   v-alf
           else if   rf-age-sta-tus       =    61
                     move  "In contenzioso"
                                          to   v-alf
           else if   rf-age-sta-tus       =    62
                     move  "In contenzioso"
                                          to   v-alf
           else if   rf-age-sta-tus       =    71
                     move  "Fallito       "
                                          to   v-alf
           else if   rf-age-sta-tus       =    72
                     move  "Fallito (sost)"
                                          to   v-alf
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "EXPD"
                     go to qry-trt-fun-999.
      *                  *---------------------------------------------*
      *                  * Routine per Expand su record [age]          *
      *                  *---------------------------------------------*
           perform   exp-rec-age-000      thru exp-rec-age-999        .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   w-ipc-dlp-tdi-nom      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        s-alf                =    spaces
                     go to ipc-dlp-tdi-999.
           move      "N"                  to   w-ipc-dlp-tdi-tip      .
           move      s-alf                to   w-ipc-dlp-tdi-nom      .
           go to     ipc-dlp-tdi-999.
       ipc-dlp-tdi-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       exp-rec-age-000.
      *              *-------------------------------------------------*
      *              * Salvataggio parametri per Start su [age]        *
      *              *-------------------------------------------------*
           if        w-rip-str-age-eof    not  = spaces
                     go to exp-rec-age-100.
           move      rf-age-cod-age       to   w-rip-str-age-cod      .
           move      rf-age-rag-key       to   w-rip-str-age-rag      .
           move      rf-age-cod-mne       to   w-rip-str-age-mne      .
           move      rf-age-nom-key       to   w-rip-str-age-nom      .
       exp-rec-age-100.
      *              *-------------------------------------------------*
      *              * Video in 'OFF'                                  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per Agente a cui fa capo             *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      22                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      14                   to   v-lin                  .
           move      03                   to   v-pos                  .
           move      "Cat. di provvigioni  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per % di provvigione                 *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      22                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
       ...
       exp-rec-age-400.
      *              *-------------------------------------------------*
      *              * Lettura codice agente a cui fa capo             *
      *              *-------------------------------------------------*
           move      v-cnt                to   w-mpn                  .
           if        w-mpn-sup-age        =    zero
                     move  spaces         to   w-let-arc-age-nom
                     go to exp-rec-age-500.
           move      w-mpn-sup-age        to   w-let-arc-age-cod      .
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODAGE    "         to   f-key                  .
           move      w-mpn-cod-age        to   rf-age-cod-age         .
           move      "pgm/age/fls/ioc/obj/iofage"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura codice categoria provvigioni        *
      *                  *---------------------------------------------*
           move      01                   to   w-let-arc-zpv-tip      .
           move      rf-age-cat-pvg       to   w-let-arc-zpv-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      11                   to   v-lin                  .
           move      26                   to   v-pos                  .
           move      rf-age-cod-fis       to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       exp-rec-age-710.
      *                  *---------------------------------------------*
      *                  * Agente a cui fa capo                        *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se a zero : no visualizzazione          *
      *                      *-----------------------------------------*
           if        rf-age-sup-age       =    zero
                     go to exp-rec-age-720.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      15                   to   v-lin                  .
           move      26                   to   v-pos                  .
           move      rf-age-per-pvg (1)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Numero di telefono                          *
      ...
      *                  *---------------------------------------------*
           if        rf-age-ide-dat       =    zero
                     go to exp-rec-age-760.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      17                   to   v-lin                  .
           move      69                   to   v-pos                  .
           move      rf-age-ide-dat       to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       exp-rec-age-760.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-age-ide-ute       =    spaces
                     go to exp-rec-age-770.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      10                   to   v-car                  .
           move      18                   to   v-lin                  .
      ...
      *                  *---------------------------------------------*
           if        rf-age-ide-fas       =    spaces
                     go to exp-rec-age-800.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      08                   to   v-car                  .
           move      19                   to   v-lin                  .
      ...
      *                  *---------------------------------------------*
           if        w-rip-str-age-eof    not  = spaces
                     go to exp-rec-age-999.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo di Start    *
      *                  * attualmente attivo                          *
      *                  *---------------------------------------------*
           if        rr-tip-ord           =    "C"
                     go to exp-rec-age-910
           else if   rr-tip-ord           =    "R"
                     go to exp-rec-age-920
           else if   rr-tip-ord           =    "M"
                     go to exp-rec-age-930
           else if   rr-tip-ord           =    "N"
                     go to exp-rec-age-940.
       exp-rec-age-910.
      *                  *---------------------------------------------*
      *                  * Se start per codice                         *
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODAGE    "         to   f-key                  .
           move      w-rip-str-age-cod    to   rf-age-cod-age         .
           move      "pgm/age/fls/ioc/obj/iofage"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-age                 .
           if        f-sts                not  = e-not-err
                     go to exp-rec-age-990.
           go to     exp-rec-age-980.
       exp-rec-age-920.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "RAGKEY    "         to   f-key                  .
           move      w-rip-str-age-rag    to   rf-age-rag-key         .
           move      w-rip-str-age-cod    to   rf-age-cod-age         .
           move      "pgm/age/fls/ioc/obj/iofage"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODMNE    "         to   f-key                  .
           move      w-rip-str-age-mne    to   rf-age-cod-mne         .
           move      w-rip-str-age-cod    to   rf-age-cod-age         .
           move      "pgm/age/fls/ioc/obj/iofage"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
       ...
       exp-rec-age-940.
      *                  *---------------------------------------------*
      *                  * Se start per nominativo                     *
      *                  *---------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "NOMKEY    "         to   f-key                  .
           move      w-rip-str-age-nom    to   rf-age-nom-key         .
           move      w-rip-str-age-cod    to   rf-age-cod-age         .
           move      "pgm/age/fls/ioc/obj/iofage"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
