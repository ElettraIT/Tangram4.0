      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma page1121:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA CATEGORIE PROVVIGIONI PER AGENTE "       .
      ...
      *    *-----------------------------------------------------------*
       pmt-tit-sel-000.
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezioni su categorie provvigioni per agente     
      -              "                              "
                                   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zpv-001-cod      .
           move      14                   to   w-cmn-zpv-001-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zpv-001-ope      .
           move      rr-cod-max           to   w-cmn-zpv-001-cod      .
           move      14                   to   w-cmn-zpv-001-lin      .
           move      52                   to   w-cmn-zpv-001-pos      .
           move      zero                 to   w-cmn-zpv-001-dln      .
           move      zero                 to   w-cmn-zpv-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
