      ...
      *                                   Fase:    age240              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 25/09/97    *
      *                       Ultima revisione:    NdK del 22/03/19    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma page2401:       *
      *                                                                *
      ...
      *            * Imponibile                                        *
      *            *---------------------------------------------------*
               10  w-det-amm-per-ibl      pic s9(13)v9(01)            .
      *            *---------------------------------------------------*
      *            * %                                                 *
      *            *---------------------------------------------------*
               10  w-det-amm-per-per      pic  9(02)v9(01)            .
      *            *---------------------------------------------------*
      *            * Comodo di transito                                *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [zpf]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-zpf.
               10  w-let-arc-zpf-age      pic  9(07)                  .
               10  w-let-arc-zpf-cli      pic  9(07)                  .
               10  w-let-arc-zpf-flg      pic  x(01)                  .
               10  w-let-arc-zpf-tbf.
                   15  w-let-arc-zpf-tbe occurs 6.
                       20  w-let-arc-zpf-tot
                                          pic  9(11)                  .
                       20  w-let-arc-zpf-per
                                          pic  9(02)v9(01)            .
      *    *===========================================================*
      ...
      *            *---------------------------------------------------*
               10  w-liv-age-tot-pvg      pic s9(13)v9(02)            .
      *            *---------------------------------------------------*
      *            * Comodi per scansione castelletto mesi             *
      *            *---------------------------------------------------*
               10  w-liv-age-cst-ctr      pic  9(02)                  .
               10  w-liv-age-cst-ct1      pic  9(02)                  .
               10  w-liv-age-cst-min      pic  9(02)                  .
               10  w-liv-age-cst-max      pic  9(02)                  .
               10  w-liv-age-cst-val      pic s9(13)v9(02)            .
               10  w-liv-age-cst-dmi      pic  9(07)                  .
               10  w-liv-age-cst-per      pic s9(13)v9(01)            .
               10  w-liv-age-cst-tot      pic s9(13)v9(02)            .
               10  w-liv-age-cst-tit      pic  x(40)                  .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               ...
               10  w-liv-gen-cst-val      pic s9(13)v9(02)            .
               10  w-liv-gen-cst-dmi      pic  9(07)                  .
               10  w-liv-gen-cst-per      pic s9(13)v9(01)            .
               10  w-liv-gen-cst-tot      pic s9(13)v9(02)            .
               10  w-liv-gen-cst-tit      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Castelletto per 12 mesi                           *
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-stp-cen-age-cod      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Mnemonico dell'agente                             *
      *            *---------------------------------------------------*
               10  w-stp-cen-age-mne      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Nominativo dell'agente                            *
      *            *---------------------------------------------------*
               10  w-stp-cen-age-nom      pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Ragione sociale dell'agente                       *
      *            *---------------------------------------------------*
               10  w-stp-cen-age-rag      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Contatori di comodo                               *
      *            *---------------------------------------------------*
               10  w-stp-cen-age-c01      pic  9(03)                  .
               10  w-stp-cen-age-c02      pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Area editata di comodo                            *
      *            *---------------------------------------------------*
               10  w-stp-cen-age-e10      pic  x(10)                  .
      *        *-------------------------------------------------------*
      ...
      *            * Campo di comodo                                   *
      *            *---------------------------------------------------*
               10  w-stp-clc-pdv-c01      pic s9(13)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per stampa scaglioni di provvogioni          *
      *        *-------------------------------------------------------*
           05  w-stp-cst-scp.
      *            *---------------------------------------------------*
      *            * Comodi per ammontare imponibile provvigionale     *
      *            *---------------------------------------------------*
               10  w-stp-cst-scp-ibp      pic s9(11)                  .
               10  w-stp-cst-scp-scw      pic s9(11)                  .
               10  w-stp-cst-scp-scp      pic s9(11)                  .
               10  w-stp-cst-scp-tpv      pic s9(11)                  .
               10  w-stp-cst-scp-flg      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Contatori di comodo                               *
      *            *---------------------------------------------------*
               10  w-stp-cst-scp-ctr      pic  9(01)                  .
               10  w-stp-cst-scp-ctw      pic  9(01)                  .
      ...
      *                  *---------------------------------------------*
      *                  * Solo se tipo ordinamento per agente :       *
      *                  *   - 01 : Ordinamento ABC decrescente        *
      *                  *   - 02 : Ordinamento ABC crescente          *
      ...
      *              *-------------------------------------------------*
      *              * Lettura % provvigioni a scaglioni               *
      *              *-------------------------------------------------*
           move      rr-cod-age           to     w-let-arc-zpf-age    .
           move      rr-p1d-min           to     s-dat                .
           move      s-saa                to     w-let-arc-zpf-cli    .
           perform   let-arc-zpf-000      thru   let-arc-zpf-999      .
       prn-ini-cic-050.
      *              *-------------------------------------------------*
      ...
      *                          * Codice agente                       *
      *                          *-------------------------------------*
           move      w-liv-age-cod-age    to   w-stp-cen-age-cod      .
      *                          *-------------------------------------*
      *                          * Mnemonico dell'agente               *
      *                          *-------------------------------------*
           move      w-liv-age-mne-age    to   w-stp-cen-age-mne      .
      *                          *-------------------------------------*
      *                          * Nominativo dell'agente              *
      *                          *-------------------------------------*
           move      w-liv-age-nom-age    to   w-stp-cen-age-nom      .
      *                          *-------------------------------------*
      *                          * Ragione sociale dell'agente         *
      *                          *-------------------------------------*
           move      w-liv-age-rag-age    to   w-stp-cen-age-rag      .
       prn-fin-lr1-332.
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   stp-cen-age-000      thru stp-cen-age-999        .
       prn-fin-lr1-340.
      *                  *---------------------------------------------*
      *                  * Subroutine per la stampa delle voci 'Fattu- *
      *                  * rato' e '%'                                 *
      ...
      *                      * Preparazione                            *
      *                      *-----------------------------------------*
           move      w-liv-age-tot-p1r    to   w-stp-sta-fep-f01      .
           move      w-liv-age-tot-p2r    to   w-stp-sta-fep-f02      .
           move      w-liv-age-tot-p3r    to   w-stp-sta-fep-f03      .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-mod-not-svf-not    to   w-stp-sta-tot-not      .
      *                      *-----------------------------------------*
      *                      * Editing primo scaglione provvigioni     *
      *                      *-----------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      02                   to   p-car                  .
           ...
           move      "<B"                 to   p-edm                  .
           move      w-let-arc-zpf-per (1)
                                          to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-all-str-cat (2)      .
      *                      *-----------------------------------------*
      *                      * Calcolo provvigione su base mensile     *
      *                      *-----------------------------------------*
           move      w-stp-sta-tot-f01    to   w-det-amm-per-ibl      .
           move      w-let-arc-zpf-per (1)
                                          to   w-det-amm-per-per      .
           perform   det-amm-per-000      thru det-amm-per-999        .
      *                      *-----------------------------------------*
      *                      * Editing provvigione mensile             *
      *                      *-----------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      11                   to   p-car                  .
           ...
           move      "S"                  to   p-sgn                  .
           move      "<BGD"               to   p-edm                  .
           move      w-det-amm-per-s11    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      "Provvigione"        to   w-all-str-cat (1)      .
           move      "% :"                to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   w-stp-sta-tot-not      .
      *
           if        w-let-arc-zpf-per (1)
                                          =    zero
           move      "(Provvigione non impostata)"
                                          to   w-stp-sta-tot-not      .
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   stp-sta-tot-000      thru stp-sta-tot-999        .
      ...
      *                      *-----------------------------------------*
       ...
       prn-fin-lr1-350.
      *                  *---------------------------------------------*
      *                  * Castelletto riepilogo scaglioni provvigioni *
      *                  *---------------------------------------------*
           perform   stp-cst-scp-000      thru stp-cst-scp-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-cnt-prn-flg-int    not  = spaces
                     go to prn-fin-lr1-999.
      *                  *---------------------------------------------*
      *                  * A stampa totale agente, senza eseguire una  *
      *                  * interlinea di separazione                   *
      *                  *---------------------------------------------*
      ...
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   exe-sqz-grf-age-000  thru exe-sqz-grf-age-999    .
       prn-fin-lr1-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-620.
      *                  *---------------------------------------------*
      *                  * Se e' il primo documento trattato per       *
      *                  * l'agente                                    *
      *                  *---------------------------------------------*
       prn-liv-det-630.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "PROVVIGIONI SUL FATTURATO                         
      -              "                              "
      ...
      *              * sta documenti emessi per ogni agente            *
      *              *-------------------------------------------------*
       stp-fnc-vrt-405.
      *                  *---------------------------------------------*
      ...
      *              *   - 01 : Solo totale per codice agente          *
      *              *   - 03 : Mensile                                *
      *              *-------------------------------------------------*
       stp-fds-tot-405.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Subroutine per la stampa del codice agente e del suo      *
      *    * nominativo                                                *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-cen-age-cod : Codice agente                     *
      *    *                                                           *
      *    *   - w-stp-cen-age-mne : Mnemonico dell'agente             *
      *    *                                                           *
      *    *   - w-stp-cen-age-nom : Nominativo dell'agente            *
      *    *                                                           *
      *    *   - w-stp-cen-age-rag : Ragione sociale dell'agente       *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       stp-cen-age-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       stp-cen-age-110.
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda se codice numerico a   *
      *                  * zero oppure no                              *
      *                  *---------------------------------------------*
           if        w-stp-cen-age-cod    =    zero
                     go to stp-cen-age-120
           else      go to stp-cen-age-130.
       stp-cen-age-120.
      *                  *---------------------------------------------*
      *                  * Se codice numerico a zero                   *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Editing '-' in area di comodo           *
      *                      *-----------------------------------------*
           move      "      -   "         to   w-stp-cen-age-e10      .
      *                      *-----------------------------------------*
      *                      * A trattamento codice editato            *
      *                      *-----------------------------------------*
           go to     stp-cen-age-300.
       stp-cen-age-130.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      spaces               to   p-edm                  .
           move      w-stp-cen-age-cod    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Codice numerico editato in area editata *
      *                      * di comodo                               *
      *                      *-----------------------------------------*
           move      p-edt                to   w-stp-cen-age-e10      .
      *                      *-----------------------------------------*
      *                      * A trattamento codice editato            *
      *                      *-----------------------------------------*
           go to     stp-cen-age-300.
      ...
      *                  *---------------------------------------------*
           if        w-stp-cen-age-cod    =    zero
                     go to stp-cen-age-220
           else      go to stp-cen-age-230.
       stp-cen-age-220.
      *                  *---------------------------------------------*
      *                  * Se codice numerico a zero                   *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       stp-cen-age-240.
      *                      *-----------------------------------------*
      *                      * Deviazione a seconda se mnemonico a     *
      *                      * spaces oppure no                        *
      *                      *-----------------------------------------*
           if        w-stp-cen-age-mne    =    spaces
                     go to stp-cen-age-260.
       stp-cen-age-250.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-stp-cen-age-mne    to   w-stp-cen-age-e10      .
      *                          *-------------------------------------*
      *                          * A trattamento codice editato        *
      *                          *-------------------------------------*
           go to     stp-cen-age-300.
      ...
      *                          *-------------------------------------*
           move      spaces               to   w-stp-cen-age-e10      .
           string    "("        delimited by   size
                     p-edt      delimited by spaces
                     ")"        delimited by size
                                          into w-stp-cen-age-e10      .
      *                          *-------------------------------------*
      *                          * A trattamento codice editato        *
      *                          *-------------------------------------*
           go to     stp-cen-age-300.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      w-stp-cen-age-e10    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cen-age-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-stp-cen-age-cod    =    zero
                     go to stp-cen-age-420
           else      go to stp-cen-age-430.
       stp-cen-age-420.
      *                  *---------------------------------------------*
      *                  * Se codice numerico a zero                   *
      *                  *---------------------------------------------*
      ...
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     stp-cen-age-999.
       stp-cen-age-430.
      *                  *---------------------------------------------*
      *                  * Se codice numerico diverso da zero          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Nominativo di 20 caratteri oppure ra-   *
      *                      * gione sociale di 40 caratteri a secon-  *
      *                      * da delle personalizzazioni              *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
           ...
           move      017                  to   p-pos                  .
           if        w-prs-svf-age-ron    =    "R"
                     move  w-stp-cen-age-rag
                                          to   p-alf
           else      move  w-stp-cen-age-nom
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                  * Calcolo provvigione su base mensile         *
      *                  *---------------------------------------------*
           move      w-stp-sta-fep-f01    to   w-det-amm-per-ibl      .
           move      w-let-arc-zpf-per (1)
                                          to   w-det-amm-per-per      .
           perform   det-amm-per-000      thru det-amm-per-999        .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-edt                to   w-all-str-cat (4)      .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione provvigioni agente          *
      *                  *---------------------------------------------*
           move      w-det-amm-per-s11    to   w-liv-age-tot-pvg      .
      *                  *---------------------------------------------*
      *                  * Assemblaggio note                           *
      *                  *---------------------------------------------*
           move      80                   to   w-all-str-lun          .
           ...
           move      "% :"                to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   w-stp-sta-fep-not      .
      *
           if        w-let-arc-zpf-per (1)
                                          =    zero
           move      "(Provvigione non impostata)"
                                          to   w-stp-sta-fep-not      .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Subroutine di stampa castelletto scaglioni provvigioni a  *
      *    * fine ciclo                                                *
      *    *-----------------------------------------------------------*
       stp-cst-scp-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Ciclo per 6 scaglioni                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-stp-cst-scp-flg      .
           move      zero                 to   w-stp-cst-scp-scw      .
           move      zero                 to   w-stp-cst-scp-tpv      .
           move      zero                 to   w-stp-cst-scp-ctr      .
       stp-cst-scp-220.
           add       1                    to   w-stp-cst-scp-ctr      .
           if        w-stp-cst-scp-ctr    >    6
                     go to stp-cst-scp-800.
           if        w-let-arc-zpf-tot
                    (w-stp-cst-scp-ctr)   =    zero
                     go to stp-cst-scp-800.
           if        w-let-arc-zpf-per
                    (w-stp-cst-scp-ctr)   =    zero
                     go to stp-cst-scp-800.
           if        w-stp-cst-scp-flg    not  = spaces
                     go to stp-cst-scp-800.
      *                  *---------------------------------------------*
      *                  * Test se lo scaglione in corso di trattamen- *
      *                  * to e' superio o no rispetto al totale fat-  *
      *                  * turato                                      *
      *                  *---------------------------------------------*
           if        w-let-arc-zpf-tot
                    (w-stp-cst-scp-ctr)   >    w-liv-age-tot-p1r
                     go to stp-cst-scp-300.
      *                  *---------------------------------------------*
      *                  * Se scaglione inferiore o uguale             *
      *                  *---------------------------------------------*
           move      w-let-arc-zpf-tot
                    (w-stp-cst-scp-ctr)   to   w-stp-cst-scp-ibp      .
           subtract  w-stp-cst-scp-scw    from w-stp-cst-scp-ibp      .
           move      w-let-arc-zpf-tot
                    (w-stp-cst-scp-ctr)   to   w-stp-cst-scp-scp      .
      *                  *---------------------------------------------*
      *                  * A stampa                                    *
      *                  *---------------------------------------------*
           go to     stp-cst-scp-400.
       stp-cst-scp-300.
      *                  *---------------------------------------------*
      *                  * Se scaglione superiore                      *
      *                  *---------------------------------------------*
           move      w-liv-age-tot-p1r    to   w-stp-cst-scp-ibp      .
           move      w-liv-age-tot-p1r    to   w-stp-cst-scp-scp      .
           subtract  w-stp-cst-scp-scw    from w-stp-cst-scp-ibp      .
           move      "#"                  to   w-stp-cst-scp-flg      .
      *                  *---------------------------------------------*
      *                  * A stampa                                    *
      *                  *---------------------------------------------*
           go to     stp-cst-scp-400.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      010                  to   p-pos                  .
           move      w-stp-cst-scp-scp    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * % scaglione                                 *
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      024                  to   p-pos                  .
           move      w-let-arc-zpf-per
                    (w-stp-cst-scp-ctr)   to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Calcolo provvigione scaglione               *
      *                  *---------------------------------------------*
           move      w-stp-cst-scp-ibp    to   w-det-amm-per-ibl      .
           move      w-let-arc-zpf-per
                    (w-stp-cst-scp-ctr)   to   w-det-amm-per-per      .
           perform   det-amm-per-000      thru det-amm-per-999        .
      *                  *---------------------------------------------*
      *                  * Provvigione                                 *
      *                  *---------------------------------------------*
      ...
      *              * Cumulo provvigione                              *
      *              *-------------------------------------------------*
           add       w-det-amm-per-s11    to   w-stp-cst-scp-tpv      .
      *              *-------------------------------------------------*
      *              * Bufferizzazione valore scaglione attuale        *
      *              *-------------------------------------------------*
           move      w-let-arc-zpf-tot
                    (w-stp-cst-scp-ctr)   to   w-stp-cst-scp-scw      .
       stp-cst-scp-600.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     stp-cst-scp-220.
       stp-cst-scp-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      031                  to   p-pos                  .
           move      w-stp-cst-scp-tpv    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "| Provvigione minima        |            |"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Provvigione totale a scaglione minimo       *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      08                   to   p-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      031                  to   p-pos                  .
           move      w-liv-age-tot-pvg    to   p-num                  .
           subtract  w-stp-cst-scp-tpv    from p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [zpf]                         *
      *    *-----------------------------------------------------------*
       let-arc-zpf-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione marker di uscita                *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-zpf-flg      .
      *              *-------------------------------------------------*
      *              * Normalizzazione [zpf]                           *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           if        w-let-arc-zpf-age    =    zero
                     go to let-arc-zpf-500.
      *              *-------------------------------------------------*
      *              * Lettura per codice                              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "AGECLI    "         to   f-key                  .
           move      w-let-arc-zpf-age    to   rf-zpf-cod-age         .
           move      w-let-arc-zpf-cli    to   rf-zpf-cod-cli         .
           move      "pgm/age/fls/ioc/obj/iofzpf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           ...
           if        f-sts                not  = e-not-err
                     go to let-arc-zpf-400.
       let-arc-zpf-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-zpf-scp-tot (1)   to   w-let-arc-zpf-tot (1)  .
           move      rf-zpf-scp-per (1)   to   w-let-arc-zpf-per (1)  .
           move      rf-zpf-scp-tot (2)   to   w-let-arc-zpf-tot (2)  .
           move      rf-zpf-scp-per (2)   to   w-let-arc-zpf-per (2)  .
           move      rf-zpf-scp-tot (3)   to   w-let-arc-zpf-tot (3)  .
           move      rf-zpf-scp-per (3)   to   w-let-arc-zpf-per (3)  .
           move      rf-zpf-scp-tot (4)   to   w-let-arc-zpf-tot (4)  .
           move      rf-zpf-scp-per (4)   to   w-let-arc-zpf-per (4)  .
           move      rf-zpf-scp-tot (5)   to   w-let-arc-zpf-tot (5)  .
           move      rf-zpf-scp-per (5)   to   w-let-arc-zpf-per (5)  .
           move      rf-zpf-scp-tot (6)   to   w-let-arc-zpf-tot (6)  .
           move      rf-zpf-scp-per (6)   to   w-let-arc-zpf-per (6)  .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     let-arc-zpf-999.
       let-arc-zpf-400.
      *              *-------------------------------------------------*
      *              * Azioni per record non trovato                   *
      *              *-------------------------------------------------*
           move      "#"                  to   w-let-arc-zpf-flg      .
           move      all  zero            to   w-let-arc-zpf-tbf      .
           go to     let-arc-zpf-999.
       let-arc-zpf-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "Statistica Agenti"
                                          to   m-gen-grf-tit-grf      .
           move      "age240"             to   m-gen-grf-fil-nam      .
       exe-sqz-grf-200.
      *              *-------------------------------------------------*
      ...
      *    * Emissione sequenziale dati per grafico                    *
      *    *                                                           *
      *    * Ciclo di emissione grafcio per un cliente                 *
      *    *-----------------------------------------------------------*
       exe-sqz-grf-age-000.
      *              *-------------------------------------------------*
      *              * Test se da eseguire                             *
      ...
      *              *-------------------------------------------------*
           move      "EG"                 to   m-gen-grf-tip-ope      .
           move      "C"                  to   m-gen-grf-tip-grf      .
           move      "A"                  to   m-gen-grf-tip-arc      .
           move      rr-cod-age           to   m-gen-grf-cod-arc      .
           move      rr-num-pdr           to   m-gen-grf-num-prd      .
      *
           move      40                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      "Agente :"           to   w-all-str-cat (1)      .
           move      rr-cod-age-nom       to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
      ...
      *                  * Preparazione date periodi                   *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-age-cst-ct1      .
       exe-sqz-grf-age-300.
           add       1                    to   w-liv-age-cst-ct1      .
           if        w-liv-age-cst-ct1    >    rr-num-pdr
                     go to exe-sqz-grf-age-800.
           if        w-liv-age-cst-ct1    =    01
                     move  rr-p1d-min     to   m-gen-grf-prd-min
                                              (w-liv-age-cst-ct1)
                     move  rr-p1d-max     to   m-gen-grf-prd-max
                                              (w-liv-age-cst-ct1)
           else if   w-liv-age-cst-ct1    =    02
                     move  rr-p2d-min     to   m-gen-grf-prd-min
                                              (w-liv-age-cst-ct1)
                     move  rr-p2d-max     to   m-gen-grf-prd-max
                                              (w-liv-age-cst-ct1)
      ...
      *                  * Riciclo a mese successivo                   *
      *                  *---------------------------------------------*
           go to     exe-sqz-grf-age-500.
       exe-sqz-grf-age-600.
      *                  *---------------------------------------------*
      *                  * Riciclo a periodo successivo                *
      *                  *---------------------------------------------*
           go to     exe-sqz-grf-age-300.
       exe-sqz-grf-age-800.
      *              *-------------------------------------------------*
      *              * Chiamata modulo generazione grafico             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-det-amm-per-ibl    =    zero
                     go to det-amm-per-999.
      *              *-------------------------------------------------*
      *              * Se % a zero : uscita con zero                   *
      *              *-------------------------------------------------*
           if        w-det-amm-per-per    =    zero
                     go to det-amm-per-999.
      *              *-------------------------------------------------*
      *              * Calcolo dell'ammontare                          *
      *              *-------------------------------------------------*
           move      w-det-amm-per-ibl    to   w-det-amm-per-s13      .
           multiply  w-det-amm-per-per    by   w-det-amm-per-s13      .
