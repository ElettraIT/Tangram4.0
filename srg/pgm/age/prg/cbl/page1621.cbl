      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma age162   *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-zpv.
      *        *-------------------------------------------------------*
      *        * Per record categoria cliente                          *
      *        *-------------------------------------------------------*
           05  w-zpv-cli.
      *            *---------------------------------------------------*
      *            * Flag di esistenza record                          *
      *            *---------------------------------------------------*
               10  w-zpv-cli-flg          pic  x(01)                  .
      *            *---------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-120.
      *                  *---------------------------------------------*
      *                  * Se ordinamento : cliente/prodotto           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Start                                   *
      *                      *-----------------------------------------*
           ...
           move      rr-cat-cli           to   rf-zpx-cod-uno         .
      ...
      *                      *-----------------------------------------*
       ...
       stp-srt-inp-140.
      *                  *---------------------------------------------*
      *                  * Se ordinamento : prodotto/cliente           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Start                                   *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-320.
      *                  *---------------------------------------------*
      *                  * Se : per cliente/prodotto                   *
      *                  *---------------------------------------------*
           if        rr-cat-cli           =    zero
                     go to stp-srt-inp-400.
           if        rf-zpx-cod-uno       >    rr-cat-cli
                     go to stp-srt-inp-800
           else      go to stp-srt-inp-400.
       stp-srt-inp-340.
      *                  *---------------------------------------------*
      *                  * Se : per prodotto/cliente                   *
      *                  *---------------------------------------------*
           if        rr-cat-pro           =    zero
                     go to stp-srt-inp-400.
      ...
      *
           if        f-sts                =    e-not-err
                     move  spaces         to   w-zpv-cli-flg
                     move  rf-zpv         to   w-zpv-cli-rec
           else      move  "#"            to   w-zpv-cli-flg
                     move  spaces         to   w-zpv-cli-rec          .
       stp-srt-inp-410.
      *                  *---------------------------------------------*
      *                  * Lettura e bufferizzazione record categoria  *
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Ripresa record [zpv] per cliente    *
      *                          *-------------------------------------*
           move      w-zpv-cli-rec        to   rf-zpv                 .
      *                          *-------------------------------------*
      *                          * Mnemonico                           *
      *                          *-------------------------------------*
           if        w-zpv-cli-flg        =    spaces and
                     rr-tor-ele           =    "M"
      ...
      *                      *-----------------------------------------*
       ...
       stp-int-pag-022.
           move      "CATEGORIE PROVVIGIONI INCROCIATE PER CLIENTE-PRODO
      -              "TTO"                to   w-stp-int-tit-stp      .
           go to     stp-int-pag-025.
       stp-int-pag-023.
           move      "CATEGORIE PROVVIGIONI INCROCIATE PER PRODOTTO-CLIE
      -              "NTE"                to   w-stp-int-tit-stp      .
           go to     stp-int-pag-025.
       stp-int-pag-025.
      *                      *-----------------------------------------*
      *                      * 2. linea titolo                         *
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "|  Categoria di provvigione cliente  |   % sconto 
      -              "...     |  % provvigione ... |"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
