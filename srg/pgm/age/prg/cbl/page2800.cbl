      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ricalcolo provvigioni in riga ordine sped.  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "RICALCOLO PROVVIGIONI IN ORDINI DI SPED."       .
      ...
      *    *===========================================================*
      *    * Accettazione : Data ordini minima                         *
      *    *-----------------------------------------------------------*
       acc-dat-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Accettazione : Data ordini massima                        *
      *    *-----------------------------------------------------------*
       acc-dat-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Controllo su data ordini minima e massima       *
      *              *-------------------------------------------------*
           ...
           if        rr-dat-min           not  > rr-dat-max
                     go to tdo-ric-sel-200.
           move      "Data emissione ordini minima inferiore a quella ma
      -              "ssima !        "    to   w-err-box-err-msg      .
      ...
      *              * Test su data ordini                             *
      *              *-------------------------------------------------*
           if        rf-ost-dat-doc       >    rr-dat-max or
                     rf-ost-dat-doc       <    rr-dat-min
                     go to prn-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Test su flag di emissione conteggio             *
      *              *-------------------------------------------------*
           if        rf-ost-flg-blx (2)   not  = spaces
                     go to prn-sel-rec-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-cod-age           not  = zero   and
                     rf-ost-cod-age       not  = rr-cod-age
                     go to prn-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Test su flag significativita' provvigioni       *
      *              *-------------------------------------------------*
           if        rf-ost-fsp-doc       not  = 01
                     go to prn-sel-rec-900.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-ost-num-prt       to   w-rot-l01-num-prt      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           else      move  rf-ost-cod-arc to   rf-dcc-cod-cli         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-ost-cod-age       to   d-pvg-age-cod-age      .
           move      rf-ost-tip-vpa       to   d-pvg-age-tip-vpa      .
           ...
           move      rf-osr-tip-mag       to   d-pvg-age-tip-mag      .
           move      rf-osr-num-pro       to   d-pvg-age-num-mag      .
           move      rf-ost-cod-lst       to   d-pvg-age-cod-lst      .
      ...
      *
           if        rf-ost-tip-frn       =    11
                     move  rf-ost-cod-arc to   d-pvg-age-cod-cli
           else      move  rf-ost-arc-plf to   d-pvg-age-cod-cli      .
      *
           ...
           move      rf-ost-sgl-vpf       to   d-pvg-age-sgl-vpp      .
           move      rf-osr-per-scr (1)   to   d-pvg-age-per-scr (1)  .
           move      rf-osr-per-scr (2)   to   d-pvg-age-per-scr (2)  .
           move      rf-osr-per-scr (3)   to   d-pvg-age-per-scr (3)  .
           move      rf-osr-per-scr (4)   to   d-pvg-age-per-scr (4)  .
           move      rf-osr-per-scr (5)   to   d-pvg-age-per-scr (5)  .
      *
           if        rf-osr-ocl-dat       not  = zero
                     move  rf-osr-ocl-dat to   d-pvg-age-dat-rif
           else      move  rf-ost-dat-doc to   d-pvg-age-dat-rif      .
      *
           move      rf-osr-prz-lrs       to   d-pvg-age-prz-lrs      .
           move      rf-osr-prz-nts       to   d-pvg-age-prz-nts      .
           move      rf-osr-prz-net       to   d-pvg-age-prz-net      .
