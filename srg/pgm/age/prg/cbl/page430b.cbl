      ...
      *                                                                *
      *                    Analisi mensile maturazioni per agente      *
      *                                                                *
      *================================================================*
      ...
      *                * Totale 'Maturato'                             *
      *                *-----------------------------------------------*
                   15  w-ana-age-tts-mtz  pic s9(11)                  .
      *                *-----------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "ANALISI MENSILE MATURAZIONI AL"
                                          to   w-all-str-cat (1)      .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-ana-age-tts-ctg
                                              (w-ana-age-tts-i01)     .
      *              *-------------------------------------------------*
      *              * Azzeramento totale 'Maturato'                   *
      *              *-------------------------------------------------*
           move      zero                 to   w-ana-age-tts-mtz
                                              (w-ana-age-tts-i01)     .
      *              *-------------------------------------------------*
      ...
      *                           *------------------------------------*
           subtract rf-gpc-amm-pvg        from w-ana-age-tts-ctg
                                              (w-ana-age-tts-i01)     .
      *                           *------------------------------------*
      *                           * Determinazione maturazioni a fron- *
      *                           * te del conteggio                   *
      *                           *------------------------------------*
           move      rf-gpc-num-ctg       to   w-det-mtz-ctg-ctg      .
           move      rf-gpc-amm-pvg       to   w-det-mtz-ctg-vct      .
           perform   det-mtz-ctg-000      thru det-mtz-ctg-999        .
      *                           *------------------------------------*
      *                           * Aggiornamento 'Maturato'           *
      *                           *------------------------------------*
           subtract  w-det-mtz-ctg-vmt    from w-ana-age-tts-mtz
                                              (w-ana-age-tts-i01)     .
      *                           *------------------------------------*
      ...
      *                           *------------------------------------*
           subtract rf-gpc-amm-pvg        from w-ana-age-tts-tme
                                              (w-ana-age-tts-i01)     .
           add      w-det-mtz-ctg-vmt     to   w-ana-age-tts-tme
                                              (w-ana-age-tts-i01)     .
      *                           *------------------------------------*
      *                           * Uscita                             *
      *                           *------------------------------------*
      ...
      *                           * Aggiornamento 'Maturato'           *
      *                           *------------------------------------*
           add      w-det-mtz-ctg-vmt     to   w-ana-age-tts-mtz
                                              (w-ana-age-tts-i01)     .
      *                           *------------------------------------*
      *                           * Aggiornamento 'Totale mensile'     *
      *                           *------------------------------------*
           add      rf-gpc-amm-pvg        to   w-ana-age-tts-tme
                                              (w-ana-age-tts-i01)     .
           subtract w-det-mtz-ctg-vmt     from w-ana-age-tts-tme
                                              (w-ana-age-tts-i01)     .
      *                           *------------------------------------*
      *                           * Uscita                             *
      *                           *------------------------------------*
