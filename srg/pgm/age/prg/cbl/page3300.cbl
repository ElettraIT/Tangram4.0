      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Situazione conteggi per agente              *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase age330, nella sua globalita', esegue i tipi di inter-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * ACTGLO      Analisi globale conteggi per agente                *
      *                                                                *
      * ACTMES      Analisi mensile conteggi per agente                *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     SITUAZIONE CONTEGGI PER AGENTE     "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'age330'           *
      *              *-------------------------------------------------*
           perform   fas-age-330-000      thru fas-age-330-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Analisi globale conteggi per agente               
      -              " ACTGLO     page330a  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Analisi mensile conteggi per agente               
      -              " ACTMES     page330b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-age-330-300
           else if   v-key                =    "PRSC"
                     go to fas-age-330-400
           else if   v-key                =    "NXSC"
                     go to fas-age-330-450
           else if   v-key                =    "DOWN"
                     go to fas-age-330-500
           else if   v-key                =    "EXIT"
                     go to fas-age-330-250
           else      go to fas-age-330-200.
       fas-age-330-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-age-330-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-age-330-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-age-330-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-age-330-350
           else      go to fas-age-330-322.
       fas-age-330-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-age-330-630
           else if   v-key                =    "PRSC"
                     go to fas-age-330-600
           else if   v-key                =    "NXSC"
                     go to fas-age-330-610
           else if   v-key                =    "UP  "
                     go to fas-age-330-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-age-330-650
           else if   v-key                =    "EXIT"
                     go to fas-age-330-660
           else      go to fas-age-330-570.
       fas-age-330-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-age-330-626
           else      go to fas-age-330-628.
       fas-age-330-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-age-330-636
           else      go to fas-age-330-638.
       fas-age-330-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-age-330-725
           else      go to fas-age-330-750.
       fas-age-330-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
