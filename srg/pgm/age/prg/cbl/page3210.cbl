      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazioni su conteggi provvigionali    *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase age321, nella sua globalita', esegue i tipi di inter-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * INTCIA      Ricerca conteggi intestati ad un agente            *
      * INTCIC      Ricerca conteggi intestati ad un cliente           *
      * INTCDD      Ricerca conteggi per data documento                *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONI SU CONTEGGI PROVVIGIONALI"       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'age321'           *
      *              *-------------------------------------------------*
           perform   fas-age-321-000      thru fas-age-321-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-age-321-300
           else if   v-key                =    "PRSC"
                     go to fas-age-321-400
           else if   v-key                =    "NXSC"
                     go to fas-age-321-450
           else if   v-key                =    "DOWN"
                     go to fas-age-321-500
           else if   v-key                =    "EXIT"
                     go to fas-age-321-250
           else      go to fas-age-321-200.
       fas-age-321-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-age-321-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-age-321-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-age-321-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-age-321-350
           else      go to fas-age-321-322.
       fas-age-321-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-age-321-630
           else if   v-key                =    "PRSC"
                     go to fas-age-321-600
           else if   v-key                =    "NXSC"
                     go to fas-age-321-610
           else if   v-key                =    "UP  "
                     go to fas-age-321-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-age-321-650
           else if   v-key                =    "EXIT"
                     go to fas-age-321-660
           else      go to fas-age-321-570.
       fas-age-321-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-age-321-626
           else      go to fas-age-321-628.
       fas-age-321-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-age-321-636
           else      go to fas-age-321-638.
       fas-age-321-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-age-321-725
           else      go to fas-age-321-750.
       fas-age-321-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
