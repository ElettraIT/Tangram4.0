      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Manutenzione maturazione immediata conteggi *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  GESTIONE SEGNALE MATURAZIONE CONTEGGI "       .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-for-mtz.
               10  w-exp-for-mtz-num      pic  9(02)       value 03   .
               10  w-exp-for-mtz-lun      pic  9(02)       value 40   .
               10  w-exp-for-mtz-tbl.
                   15  filler             pic  x(40) value
                            "Nessuna forzatura                       ".
                   15  filler             pic  x(40) value
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-for-mtz-lun    to   v-car                  .
           move      w-exp-for-mtz-num    to   v-ldt                  .
           move      "NIF#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-for-mtz-tbl    to   v-txt                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      13                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-tes-for-mtz        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-gpc-tip-mat       to   w-rig-tip-mat          .
      *                      *-----------------------------------------*
      *                      * Anagrafica cliente                      *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           else if   w-tes-for-mtz        =    02
                     move  01             to   w-rig-tip-mat
           else if   w-tes-for-mtz        =    03
                     move  02             to   w-rig-tip-mat
      ...
      *                  *---------------------------------------------*
           if        w-rig-tip-mat        =    rf-gpc-tip-mat
      ...
      *                  *---------------------------------------------*
           move      w-rig-tip-mat        to   rf-gpc-tip-mat         .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [gpc]                         *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/age/prg/obj/page9402"                       .
       cnc-rlt-sup-999.
           exit.
