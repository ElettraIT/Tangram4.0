      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ricalcolo provvigioni in riga ordine        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  RICALCOLO DATI PROVVIGIONALI ORDINI   "       .
      ...
      *              *-------------------------------------------------*
           if        rf-oct-flg-blx (2)   not  = spaces
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-oct-num-prt       to   w-rot-l01-num-prt      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           else      move  rf-oct-cod-arc to   rf-dcc-cod-cli         .
      ...
      *                  *---------------------------------------------*
           ...
           else      move  rf-oct-arc-plf to   d-pvg-age-cod-cli      .
