      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma page1221:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA CATEG. PROVVIGIONI PER PRODOTTO "       .
      ...
      *    *-----------------------------------------------------------*
       pmt-tit-sel-000.
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezioni su categorie provvigioni per prodotto   
      -              "                              "
                                   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *    *-----------------------------------------------------------*
       acc-tip-cpv-000.
      *              *-------------------------------------------------*
      *              * Tipo : 02 = Per prodotto                        *
      *              *-------------------------------------------------*
           move      02                   to   rr-tip-cpv             .
       acc-tip-cpv-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zpv-002-cod      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zpv-002-ope      .
           move      rr-cod-max           to   w-cmn-zpv-002-cod      .
           move      14                   to   w-cmn-zpv-002-lin      .
           move      52                   to   w-cmn-zpv-002-pos      .
           move      zero                 to   w-cmn-zpv-002-dln      .
           move      zero                 to   w-cmn-zpv-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
