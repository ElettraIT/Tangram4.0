      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma page2401:        *
      *                                                                *
      *                    Stampa provvigioni sul fatturato per agente *
      *                                                                *
      *                    N.B.: interamente ricavato da 'svf700'      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  PROVVIGIONI SUL FATTURATO PER AGENTE  "       .
      ...
      *              *-------------------------------------------------*
       tdo-ric-sel-351.
           ...
           move      "Manca la data iniziale per il periodo di riferimen
      ...
      *              *-------------------------------------------------*
       tdo-ric-sel-401.
           ...
           move      "Manca la data finale per il periodo di riferimento
      -              " !          "       to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-402.
           if        rr-p1d-max           not  < rr-p1d-min
                     go to tdo-ric-sel-450.
           move      "La data finale del periodo e' inferiore alla data 
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-p1d-tpr-rng       not  = spaces
                     go to tdo-ric-sel-475.
           move      "Il periodo di riferimento deve essere un anno o un
