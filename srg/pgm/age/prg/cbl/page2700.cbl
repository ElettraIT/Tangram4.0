      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ricalcolo provvigioni in riga bolle         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "RICALCOLO PROVV. IN DOCUMENTI TRASPORTO "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        rr-dat-min           not  > rr-dat-max
                     go to tdo-ric-sel-200.
           move      "Data emissione bolle minima inferiore a quella mas
      -              "sima !         "    to   w-err-box-err-msg      .
      ...
      *              *-------------------------------------------------*
           if        rf-bit-flg-blx (2)   not  = spaces
      ...
      *              *-------------------------------------------------*
           if        rr-cod-age           not  = zero   and
                     rf-bit-cod-age       not  = rr-cod-age
                     go to prn-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Test su flag significativita' provvigioni       *
      *              *-------------------------------------------------*
           if        rf-bit-fsp-doc       not  = 01
                     go to prn-sel-rec-900.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-bit-num-prt       to   w-rot-l01-num-prt      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           else      move  rf-bit-cod-arc to   rf-dcc-cod-cli         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-bir-tip-mag       to   d-pvg-age-tip-mag      .
           ...
           if        rf-bit-tip-frn       =    11
                     move  rf-bit-cod-arc to   d-pvg-age-cod-cli
           else      move  rf-bit-arc-plf to   d-pvg-age-cod-cli      .
           ...
           move      rf-bit-sgl-vpf       to   d-pvg-age-sgl-vpp      .
           ...
           move      rf-bit-dat-doc       to   d-pvg-age-dat-rif      .
