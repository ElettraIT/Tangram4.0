      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(05)                  .
                   15  w-lin-imm-snx-ddi  pic  x(02)                  .
                   15  filler             pic  x(07)                  .
                   15  w-lin-imm-snx-esi  pic  x(02)                  .
                   15  filler             pic  x(03)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [dea]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-dea.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-dea-prt      pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Progressivo                                       *
      *            *---------------------------------------------------*
               10  w-cmp-rec-dea-prg      pic  9(05)                  .
      ...
      *                  *---------------------------------------------*
           if        w-rig-snx-inv        =    "S"
                     move  "Si"           to   w-lin-imm-snx-ddi
           else      move  "NO"           to   w-lin-imm-snx-ddi      .
      *                  *---------------------------------------------*
      *                  * Si/no esito negativo                        *
      *                  *---------------------------------------------*
           if        w-rig-snx-esi        =    "S"
                     move  "SI"           to   w-lin-imm-snx-esi
           else      move  "No"           to   w-lin-imm-snx-esi      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dea-tmo-doc       to   w-all-str-cat (1)      .
           move      rf-dea-num-doc       to   w-all-str-cat (2)      .
...
______*              go to rou-let-reg-999.
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [dea]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/azi/fls/ioc/obj/iofdea"
                                          to   s-pat                  .
      ...
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
           move      rf-dea-cod-arc       to   srt-cod-cli            .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-dea-dat-doc       to   srt-dat-doc            .
      *                  *---------------------------------------------*
      *                  * Record [dea]                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                  * Record [dea]                                *
      *                  *---------------------------------------------*
           move      rf-dea               to   w-rig-rec-dea          .
           move      rf-dea-cod-arc       to   w-rig-cod-cli          .
           move      rf-dea-dpz-arc       to   w-rig-dpz-cli          .
      *
      ...
      *
           move      rf-dea-eml-ind       to   w-rig-ind-eml          .
      *                  *---------------------------------------------*
      *                  * Valori indiretti                            *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     go to  fnd-arc-dea-999.
      *              *-------------------------------------------------*
      *              * Richiamo programma di interrogazione            *
      *              *-------------------------------------------------*
           move      "pgm/azi/prg/obj/pbol3010"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat                                            .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/azi/prg/obj/pazi5402"                       .
       cnc-rlt-sup-999.
           exit.
