      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "pgm/fat/fls/ioc/obj/iofdea"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           move      rf-dea-num-dst       to   srt-num-dst            .
           move      rf-dea-num-prg       to   srt-num-prg            .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Cancellazione record [dea]                                *
      *    *-----------------------------------------------------------*
       del-rec-dst-000.
      *              *-------------------------------------------------*
      *              * Composizione chiave primaria                    *
      *              *-------------------------------------------------*
           move      srt-num-dst          to   rf-dea-num-dst         .
           move      srt-num-prg          to   rf-dea-num-prg         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
