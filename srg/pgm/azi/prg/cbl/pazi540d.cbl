      ...
      *                    normale (t_sender) o con autenticazione     *
      *                    semplice (t_sender_aut) o autenticazione    *
      *                    SSl per messaggi PEC (t_sender_ssl).        *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/fat/mov/fat320[sec-att]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dde-prt-doc       to   rf-fit-num-prt         .
           move      "pgm/fat/fls/ioc/obj/ioffit"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [dde] letti    *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Incremento contatore records [dde] aggiornati   *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-dde-dat-inv         .
      *              *-------------------------------------------------*
      *              * Aggiornamento ora invio                         *
      *              *-------------------------------------------------*
           move      s-ora                to   rf-dde-ora-inv         .
           multiply  100                  by   rf-dde-ora-inv         .
           add       s-min                to   rf-dde-ora-inv         .
      *              *-------------------------------------------------*
      *              * Update record [dde]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
