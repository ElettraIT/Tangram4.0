      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma azi540   *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-dea-num-dst       not  = rr-num-dst
                     move  "#"            to   w-cnt-prn-flg-sub      .
       prn-tst-max-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dea-cod-arc       to   rf-dcc-cod-cli         .
           move      rf-dea-dpz-arc       to   rf-dcc-dpz-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      098                  to   p-pos                  .
           move      rf-dea-num-doc       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Eventuale data invio                    *
      *                      *-----------------------------------------*
           if        rf-dea-dat-inv       =    zero
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      105                  to   p-pos                  .
           move      rf-dea-dat-doc       to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Eventuale segnale di blocco             *
      *                      *-----------------------------------------*
           if        rf-dea-flg-ain       =    spaces
      ...
      *              *-------------------------------------------------*
           ...
           move      "DISTINTA DI INVIO CIRCOLARE NR."
                                          to   w-all-str-cat (1)      .
           move      p-edt                to   w-all-str-cat (2)      .
