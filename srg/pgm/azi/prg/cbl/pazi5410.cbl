      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  INTERROGAZIONE SU DISTINTE CIRCOLARI  "       .
      ...
      *                  *---------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [dea]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "NUMDST    "         to   f-key                  .
           move      "DATSYS    "         to   f-key                  .
           move      w-det-nrg-dat-dtd    to   rf-dea-ide-dat         .
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-dea-num-dst       to   w-rot-l01-num-dst      .
       qry-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-dea-num-dst       to   w-buf-l01-num-dst      .
           move      rf-dea-dat-reg       to   w-buf-l01-dat-reg      .
      ...
      *
           if        rf-dea-flg-ain       not  = spaces
                     add  1               to   w-buf-l01-ctr-ann      .
      *
           if        rf-dea-flg-esi       not  = spaces
      ...
      *              *-------------------------------------------------*
           ...
           else if   rf-dea-flg-apr       not  = spaces
