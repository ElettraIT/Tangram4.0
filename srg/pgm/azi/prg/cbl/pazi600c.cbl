      ...
      *                       Ultima revisione:    NdK del 01/07/24    *
      *                    ------------------------------------------- *
      ...
      *            * Tipo documento                                    *
      *            *---------------------------------------------------*
               10  srt-tip-doc            pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Flag di bollo virtuale                            *
      *            *---------------------------------------------------*
               10  srt-flg-bvt            pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Flag di documento XML inviato                     *
      *            *---------------------------------------------------*
               10  srt-flg-xmi            pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Flag di documento XML scartato                    *
      *            *---------------------------------------------------*
               10  srt-flg-xms            pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA CONTATORI STATISTICI SU FATTURE "       .
      ...
      *            *---------------------------------------------------*
      *            * Numero documenti con bollo virtuale               *
      *            *---------------------------------------------------*
               10  rr-tip-ril-bvt         pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-ril.
               ...
               10  w-exp-tip-ril-tbl.
                   ...
                   15  filler             pic  x(40) value
                            "[ ] Numero di documenti con bollo virt. ".
      ...
      *            * Parametro 1                                       *
      *            *---------------------------------------------------*
               10  w-det-per-var-v01      pic  9(13)                  .
      *            *---------------------------------------------------*
      *            * Parametro 2                                       *
      *            *---------------------------------------------------*
               10  w-det-per-var-v02      pic  9(13)                  .
      *            *---------------------------------------------------*
      *            * % di variazione 1                                 *
      *            *---------------------------------------------------*
               10  w-det-per-var-per      pic  9(05)v9(05)            .
      ...
      *            *---------------------------------------------------*
      *            * Contatore fatture con bollo virtuale              *
      *            *---------------------------------------------------*
               10  w-stp-ctr-ril-bvt      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Contatore Note Accredito                          *
      *            *---------------------------------------------------*
               10  w-stp-ctr-ril-nac      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Contatori righe                                   *
      *            *---------------------------------------------------*
               10  w-stp-ctr-ril-rig      pic  9(13)                  .
               10  w-stp-ctr-ril-rdc      pic  9(05)                  .
               10  w-stp-ctr-ril-max      pic  9(05)                  .
               10  w-stp-ctr-ril-min      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Media righe calcolata                             *
      *            *---------------------------------------------------*
               10  w-stp-ctr-ril-mri      pic  9(05)v9(02)            .
      *            *---------------------------------------------------*
      *            * Contatore fatture XML inviate                     *
      *            *---------------------------------------------------*
               10  w-stp-ctr-ril-xmi      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Contatore fatture XML scartate                    *
      *            *---------------------------------------------------*
               10  w-stp-ctr-ril-xms      pic  9(11)                  .
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Test su secolo anno data iniziale e finale      *
      *              *-------------------------------------------------*
      ...
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      rf-fit-tip-doc       to   srt-tip-doc            .
           move      rf-fit-flg-nbx (3)   to   srt-flg-bvt            .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   srt-flg-xmi            .
           move      spaces               to   srt-flg-xms            .
       stp-srt-inp-ddx-100.
      *              *-------------------------------------------------*
      *              * Start su [ddx]                                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-ddx-600.
      *              *-------------------------------------------------*
      *              * Se documento inviato                            *
      *              *-------------------------------------------------*
           if        rf-ddx-dat-inv       not  =  zero
                     move  "#"            to   srt-flg-xmi            .
      *              *-------------------------------------------------*
      *              * Se documento scartato                           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-stp-ctr-ril-bvt      .
           move      zero                 to   w-stp-ctr-ril-nac      .
           move      zero                 to   w-stp-ctr-ril-rig      .
           move      zero                 to   w-stp-ctr-ril-rdc      .
           move      zero                 to   w-stp-ctr-ril-max      .
           move      00001                to   w-stp-ctr-ril-min      .
           move      zero                 to   w-stp-ctr-ril-mri      .
           move      zero                 to   w-stp-ctr-ril-xmi      .
           move      zero                 to   w-stp-ctr-ril-xms      .
       prn-ini-cic-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Numero di giorni della rilevazione          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Determinazione                          *
      *                      *-----------------------------------------*
           move      rr-dat-min           to   w-det-dif-dat-min      .
           move      rr-dat-max           to   w-det-dif-dat-max      .
           perform   det-dif-dat-000      thru det-dif-dat-999        .
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
           move      "LF"                 to   p-ope                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Numero giorni selezionati ...................:"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      048                  to   p-pos                  .
           move      w-det-dif-dat-gio    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-cic-120.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Numero di fatture rilevate ..................:"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Media giornaliera documenti             *
      *                      *-----------------------------------------*
           if        w-det-dif-dat-gio    <    2
                     go to prn-fin-cic-150.
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Numero medio di fatture giornaliere .........:"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      048                  to   p-pos                  .
           divide    w-stp-ctr-ril-doc    by   w-det-dif-dat-gio
                                        giving p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-cic-150.
      *                  *---------------------------------------------*
      *                  * Numero documenti - Note Accredito           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Numero note accredito rilevate ..............:"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      048                  to   p-pos                  .
           move      w-stp-ctr-ril-nac    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Prompt per %                            *
      ...
      *                      *-----------------------------------------*
           move      w-stp-ctr-ril-doc    to   w-det-per-var-v01      .
           move      w-stp-ctr-ril-nac    to   w-det-per-var-v02      .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Numero medio di righe per fattura ...........:"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      063                  to   p-pos                  .
           move      w-stp-ctr-ril-min    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Prompt per max                          *
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      075                  to   p-pos                  .
           move      w-stp-ctr-ril-max    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-cic-180.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Numero fatture con bollo virtuale rilevate ..:"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      048                  to   p-pos                  .
           move      w-stp-ctr-ril-bvt    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-cic-200.
      *                  *---------------------------------------------*
      *                  * Numero documenti XML inviati                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
           if        w-stp-ctr-ril-xmi    =    zero
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Numero documenti XML inviati ................:"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      048                  to   p-pos                  .
           move      w-stp-ctr-ril-xmi    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-cic-220.
      *                  *---------------------------------------------*
      *                  * Numero documenti XML scartati               *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
           if        w-stp-ctr-ril-xms    =    zero
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Numero documenti XML scartati da SDI ........:"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      048                  to   p-pos                  .
           move      w-stp-ctr-ril-xms    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-cic-900.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        srt-tip-doc          =    01 or
                     srt-tip-doc          =    02
                     add   1              to   w-stp-ctr-ril-doc
           else if   srt-tip-doc          =    03
                     add   1              to   w-stp-ctr-ril-nac      .
       prn-ini-lr1-150.
      *              *-------------------------------------------------*
      *              * Incremento contatore documenti bollo virtuale   *
      *              *-------------------------------------------------*
           if        srt-flg-bvt          not  = spaces
                     add   1              to   w-stp-ctr-ril-bvt      .
      *              *-------------------------------------------------*
      *              * Incremento contatore documenti XML inviati      *
      *              *-------------------------------------------------*
           if        srt-flg-xmi          not  = spaces
                     add   1              to   w-stp-ctr-ril-xmi      .
      *              *-------------------------------------------------*
      *              * Incremento contatore documenti XML scartati     *
      *              *-------------------------------------------------*
           if        srt-flg-xms          not  = spaces
                     add   1              to   w-stp-ctr-ril-xms      .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Conteggio righe documento per calcolo media     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se da eseguire                         *
      *                  *---------------------------------------------*
       ...
       prn-ini-lr1-300.
      *                  *---------------------------------------------*
      *                  * Normalizzazione contatore righe documento   *
      *                  *---------------------------------------------*
           move      zero                 to   w-stp-ctr-ril-rdc      .
      *                  *---------------------------------------------*
      *                  * Start su righe                              *
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-rot-l01-num-prt    to   rf-fir-num-prt         .
      ...
      *                  *---------------------------------------------*
           if        rf-fir-num-prt       not  = w-rot-l01-num-prt
                     go to prn-ini-lr1-999.
       prn-ini-lr1-340.
      *                  *---------------------------------------------*
      *                  * Selezioni su file [fir]                     *
      *                  *---------------------------------------------*
           if        rf-fir-tip-rig
                    (01 : 01)             not  = "P"
       ...
       prn-ini-lr1-350.
      *                  *---------------------------------------------*
      *                  * Incremento contatori righe                  *
      *                  *---------------------------------------------*
           add       1                    to   w-stp-ctr-ril-rig      .
           add       1                    to   w-stp-ctr-ril-rdc      .
      *                  *---------------------------------------------*
      *                  * Aggiornamento contatori righe min e max     *
      *                  *---------------------------------------------*
           if        w-stp-ctr-ril-min    >    w-stp-ctr-ril-rdc
                     move  w-stp-ctr-ril-rdc
                                          to   w-stp-ctr-ril-min      .
           if        w-stp-ctr-ril-max    <    w-stp-ctr-ril-rdc
                     move  w-stp-ctr-ril-rdc
                                          to   w-stp-ctr-ril-max      .
       prn-ini-lr1-360.
      *                  *---------------------------------------------*
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "CONTATORI STATISTICI SU FATTURE REGISTRATE DAL"
                                          to   w-all-str-cat (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-det-per-var-v01    <    w-det-per-var-v02
                     go to det-per-var-900.
       det-per-var-200.
      *              *-------------------------------------------------*
      *              * Calcolo                                         *
      *              *-------------------------------------------------*
           divide    w-det-per-var-v02    by   w-det-per-var-v01
      ...
      *    * 'det-dif-dat-000/999'                                     *
      *    *                                                           *
      *    * Routines per la determinazione della differenza in giorni *
      *    * tra due date                                              *
      *    *                                                           *
      *    * Input  : w-det-dif-dat-min = Data minima                  *
      *    *                                                           *
      *    *          w-det-dif-dat-max = Data massima                 *
      *    *                                                           *
      *    *                                                           *
      *    * Output : w-det-dif-dat-gio = nr. giorni di differenza     *
      *    *                                                           *
      *    *-----------------------------------------------------------*
