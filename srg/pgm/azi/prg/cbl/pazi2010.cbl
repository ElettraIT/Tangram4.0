      ...
      *                                   Fase:    azi201              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 26/11/02    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [gva]            *
      *                                                                *
      *                    Anagrafica veicoli                          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   INTERROGAZIONE ANAGRAFICA VEICOLI   "       .
           ...
           05  w-exp-tip-ord.
               ...
               10  w-exp-tip-ord-tbl.
                   ...
                   15  filler             pic  x(20) value
                            "per Mnemonico       "                    .
      *        *-------------------------------------------------------*
      *        * Work per : Tipo di veicolo                            *
      *        *-------------------------------------------------------*
           05  w-exp-sel-vei.
               10  w-exp-sel-vei-num      pic  9(02)       value 8    .
               10  w-exp-sel-vei-lun      pic  9(02)       value 30   .
               10  w-exp-sel-vei-tbl.
                   15  filler             pic  x(30) value
                            "Tutti                         "          .
                   15  filler             pic  x(30) value
                            "Solo autoveicoli              "          .
                   15  filler             pic  x(30) value
                            "Solo veicoli commerciali      "          .
                   15  filler             pic  x(30) value
                            "Solo autocarri                "          .
                   15  filler             pic  x(30) value
                            "Solo carrelli elevatori       "          .
                   15  filler             pic  x(30) value
                            "Solo motocarri                "          .
                   15  filler             pic  x(30) value
                            "Solo ciclomotori              "          .
      ...
      *    *-----------------------------------------------------------*
       01  w-rip-str.
      *        *-------------------------------------------------------*
      *        * Work-area per ripristino Start su [gva]               *
      *        *-------------------------------------------------------*
           05  w-rip-str-gva.
      *            *---------------------------------------------------*
      *            * Flag di End-of-file                               *
      *            *---------------------------------------------------*
               10  w-rip-str-gva-eof      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Parametri di Start                                *
      *            *---------------------------------------------------*
               10  w-rip-str-gva-cod      pic  9(07)                  .
               10  w-rip-str-gva-rag      pic  x(40)                  .
               10  w-rip-str-gva-mne      pic  x(10)                  .
               10  w-rip-str-gva-piv      pic  9(11)                  .
               10  w-rip-str-gva-cfi      pic  x(16)                  .

      *    *===========================================================*
      *    * Work-area per ridefinizione contenuto del mark-point      *
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-cod-vei              pic  9(07)                  .
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-150.
      *                  *---------------------------------------------*
      *                  * Selezione su tipo veicolo                   *
      *                  *---------------------------------------------*
           perform   acc-sel-vei-000      thru acc-sel-vei-999        .
           if        w-cnt-tus-acc-ric    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Selezione su tipo veicolo  *
      *    *-----------------------------------------------------------*
       acc-sel-vei-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-vei-lun    to   v-car                  .
           move      w-exp-sel-vei-num    to   v-ldt                  .
           move      spaces               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-sel-vei-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      07                   to   v-lin                  .
           move      20                   to   v-pos                  .
           move      rr-sel-vei           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-ric
                     go to acc-sel-vei-999.
       acc-sel-vei-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-sel-vei             .
       acc-sel-vei-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-sel-vei           =    zero
                     go to acc-sel-vei-100.
       acc-sel-vei-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-gva-cod      .
           move      14                   to   w-cod-mne-gva-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-gva-ope      .
           move      rr-cod-max           to   w-cod-mne-gva-cod      .
           move      14                   to   w-cod-mne-gva-lin      .
           move      52                   to   w-cod-mne-gva-pos      .
           move      zero                 to   w-cod-mne-gva-dln      .
           move      zero                 to   w-cod-mne-gva-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
       ...
       cnt-tdo-ric-600.
      *                  *---------------------------------------------*
      *                  * Regolarizzazione Tipo di veicolo            *
      *                  *---------------------------------------------*
           if        rr-sel-vei           =    zero
                     move  1              to   rr-sel-vei             .
       cnt-tdo-ric-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-rip-str-gva-eof      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-gva-cod-vei         .
           move      "pgm/azi/fls/ioc/obj/iofgva"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-gva-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-mne-min           to   rf-gva-cod-mne         .
           move      zero                 to   rf-gva-cod-vei         .
           move      "pgm/azi/fls/ioc/obj/iofgva"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun veicolo entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [gva]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/azi/fls/ioc/obj/iofgva"
                                          to   s-pat                  .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-gva-cod-vei       <    rr-cod-min or
                     rf-gva-cod-vei       >    rr-cod-max
                     go to qry-sel-rec-900.
       qry-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-gva-des-key       <    rr-des-min or
                     rf-gva-des-key       >    rr-des-max
                     go to qry-sel-rec-900.
       qry-sel-rec-300.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-gva-cod-mne       <    rr-mne-min or
                     rf-gva-cod-mne       >    rr-mne-max
                     go to qry-sel-rec-900.
       qry-sel-rec-600.
      *              *-------------------------------------------------*
      *              * Selezione su tipo di veicolo                    *
      *              *-------------------------------------------------*
           if        rr-sel-vei           =    1
                     go to qry-sel-rec-800
           else if   rr-sel-vei           =    2
                     go to qry-sel-rec-620
           else if   rr-sel-vei           =    3
                     go to qry-sel-rec-630
           else if   rr-sel-vei           =    4
                     go to qry-sel-rec-640
           else if   rr-sel-vei           =    5
                     go to qry-sel-rec-650
           else if   rr-sel-vei           =    6
                     go to qry-sel-rec-660
           else if   rr-sel-vei           =    7
                     go to qry-sel-rec-670
           else if   rr-sel-vei           =    8
                     go to qry-sel-rec-680
           else      go to qry-sel-rec-800.
       qry-sel-rec-620.
      *                  *---------------------------------------------*
      *                  * Solo autoveicoli                            *
      *                  *---------------------------------------------*
           if        rf-gva-tip-vei       not  = 01
                     go to qry-sel-rec-900
           else      go to qry-sel-rec-800.
       qry-sel-rec-630.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      26                   to   v-pos                  .
           move      rf-gva-des-vei       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-gva-cod-vei       to   w-mpn-cod-vei          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      70                   to   v-pos                  .
           move      rf-gva-sgl-trg (1)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
           exit.
