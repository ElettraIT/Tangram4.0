      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [rtanadpz]       *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-wrk.
      *        *-------------------------------------------------------*
      *        * Comodo per ragione sociale azienda                    *
      *        *-------------------------------------------------------*
           05  w-wrk-rag-azi              pic  x(40)                  .

      *    *===========================================================*
      *    * Work-area per ridefinizione contenuto del mark-point      *
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-cod-dpz              pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-pre-exe-pgm      .
      *              *-------------------------------------------------*
      *              * Rchiesta anagrafica azienda a segretario        *
      *              *-------------------------------------------------*
           move      "IA"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-asx                to   w-wrk-rag-azi          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Rchiesta numero e tabella dipendenze abilitate  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "ME"                 to   v-ope                  .
           move      "Nessuna dipendenza memorizzata per l'azienda"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [rtanadpz]         *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/azi/fls/ioc/obj/iofada"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
       ...
       qry-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Se esiste la gestione dipendenze parallele, si  *
      *              * esclude la visualizzazione delle dipendenze con *
      *              * codice maggiore di 50                           *
      *              *-------------------------------------------------*
           if        w-prs-snx-gdp-snx    not  = "S"
                     go to qry-sel-rec-400.
           if        rf-ada-cod-dpz       not  < 50
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-400.
      *              *-------------------------------------------------*
      *              * Se esiste un limite sulle dipendenze abilitate  *
      *              * si controlla che la dipendenza appartenga alla  *
      *              * tabella delle dipendenze abilitate              *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-ada-cod-dpz       to   w-mpn-cod-dpz          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Nr     Denominazione              Indirizzo       
      -              "             Localita'"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
