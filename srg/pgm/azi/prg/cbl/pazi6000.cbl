      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampe contatori statistici su documenti    *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase azi600, nella sua globalita', esegue i tipi di inter-  *
      * rogazione elencati nella tabella seguente :                    *
      *                                                                *
      *                                                                *
      *   Codice                                                       *
      *    tipo                                                        *
      *   stampa          Descrizione per il tipo di stampa            *
      * ----------  -------------------------------------------------- *
      *                                                                *
      * SCSORC      Stampa contatori statistici su ordini              *
      *                                                                *
      * SCSODS      Stampa contatori statistici su spedizioni          *
      *             ___ DA IMPLEMENTARE ___                            *
      *                                                                *
      * SCSBOL      Stampa contatori statistici su bolle               *
      *                                                                *
      * SCSFAT      Stampa contatori statistici su fatture             *
      *                                                                *
      * SCSCLI      Stampa contatori statistici su clienti             *
      *                                                                *
      * SCSRSM      Stampa contatori statistici su responsabili mag.   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPE CONTATORI STATISTICI SU DOCUMENTI"       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per Det se presenti responsabili di magazzino    *
      *        *-------------------------------------------------------*
           05  w-det-snx-rsm.
      *            *---------------------------------------------------*
      *            * Contatore elementi rilevati                       *
      *            *---------------------------------------------------*
               10  w-det-snx-rsm-ctr      pic  9(05)                  .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'azi600'           *
      *              *-------------------------------------------------*
           perform   fas-azi-250-000      thru fas-azi-250-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              * stazione                                        *
      *              *-------------------------------------------------*
           move      "relativa a Ordini Clienti                         
      -              "           SCSORC     pazi600a  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-120.
      *                      DA IMPLEMENTARE _______
           go to     loa-tbl-tin-140.
           if        w-prs-ods-snx        not  = "S"
                     go to loa-tbl-tin-140.
           move      "relativa a Ordini di Spedizione                   
      -              "           SCSORC     pazi600f  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                      DA IMPLEMENTARE _______
       loa-tbl-tin-140.
           move      "relativa a Documenti di Trasporto                 
      -              "           SCSBOL     pazi600b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "relativa a Fatture di vendita                     
      -              "           SCSFAT     pazi600c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "relativa a Clienti                                
      -              "           SCSCLI     pazi600e  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-160.
           perform   det-snx-rsm-000      thru det-snx-rsm-999        .
           if        w-det-snx-rsm-ctr    =    zero
                     go to loa-tbl-tin-200.
      *
           move      "relativa a Responsabili di magazzino              
      -              "           SCSRSM     pazi600r  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-200.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-azi-250-300
           else if   v-key                =    "PRSC"
                     go to fas-azi-250-400
           else if   v-key                =    "NXSC"
                     go to fas-azi-250-450
           else if   v-key                =    "DOWN"
                     go to fas-azi-250-500
           else if   v-key                =    "EXIT"
                     go to fas-azi-250-250
           else      go to fas-azi-250-200.
       fas-azi-250-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-azi-250-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-azi-250-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-azi-250-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-azi-250-350
           else      go to fas-azi-250-322.
       fas-azi-250-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-azi-250-630
           else if   v-key                =    "PRSC"
                     go to fas-azi-250-600
           else if   v-key                =    "NXSC"
                     go to fas-azi-250-610
           else if   v-key                =    "UP  "
                     go to fas-azi-250-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-azi-250-650
           else if   v-key                =    "EXIT"
                     go to fas-azi-250-660
           else      go to fas-azi-250-570.
       fas-azi-250-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-azi-250-626
           else      go to fas-azi-250-628.
       fas-azi-250-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-azi-250-636
           else      go to fas-azi-250-638.
       fas-azi-250-636.
      *                          *-------------------------------------*
      ...
      *    *===========================================================*
      *    * Determinazione se presenti responsabili di magazzino      *
      *    *-----------------------------------------------------------*
       det-snx-rsm-000.
      *              *-------------------------------------------------*
      *              * [zrm]                                           *
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-det-snx-rsm-ctr      .
       det-snx-rsm-100.
      *              *-------------------------------------------------*
      *              * Start su file [zrm]                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           add       1                    to   w-det-snx-rsm-ctr      .
       det-snx-rsm-600.
      *              *-------------------------------------------------*
      *              * Riciclo a record [zrm] successivo               *
      *              *-------------------------------------------------*
           go to     det-snx-rsm-200.
       det-snx-rsm-900.
      *              *-------------------------------------------------*
      *              * [zrm]                                           *
      *              *-------------------------------------------------*
