      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma pmag7221:       *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           move      rr-fso-dpm-ord       to   w-tip-ord-tip-ord      .
       prn-opn-fls-999.
           exit.
      ...
      *                      * Codice numerico                         *
      *                      *-----------------------------------------*
           move      rf-dpm-num-map       to   srt-cod-mag-num        .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico                     *
      *                      *-----------------------------------------*
           move      rf-dpm-alf-map       to   srt-cod-mag-alf        .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      *                      *-----------------------------------------*
           move      rf-dpm-des-map       to   srt-cod-mag-des        .
      *                      *-----------------------------------------*
      *                      * Unita' di misura                        *
      *                      *-----------------------------------------*
           move      rf-dpm-umi-prd       to   srt-cod-mag-umi        .
      *                      *-----------------------------------------*
      *                      * Numero decimali quantita'               *
      *                      *-----------------------------------------*
           move      rf-dpm-dec-qta       to   srt-cod-mag-dec       .
      *                      *-----------------------------------------*
      *                      * Classe merceologica                     *
      *                      *-----------------------------------------*
           move      rf-dpm-cla-map       to   srt-cod-mag-cla       .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico                     *
      *                      *-----------------------------------------*
           move      rf-dpm-gru-map       to   srt-cod-mag-gru        .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico                *
      *                      *-----------------------------------------*
           move      rf-dpm-sgr-map       to   srt-cod-mag-sgr        .
       cmp-srt-rec-700.
      *                  *---------------------------------------------*
      *                  * Valori L.i.f.o.                             *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna materia prima da valorizzare !"
                                          to   m-msg                  .
