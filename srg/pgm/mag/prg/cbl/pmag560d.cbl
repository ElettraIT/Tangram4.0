      ...
      *                  *---------------------------------------------*
           move      rr-num-pro           to   w-let-arc-dpm-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-mmz-num-mag       to   rf-dpm-num-map         .
           move      "pgm/dpm/fls/ioc/obj/iofdpm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
