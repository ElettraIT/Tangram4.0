      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa situazioni semilavorati conto merce  *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase mag530, nella sua globalita', esegue i tipi di stampa  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * STA530   a  Situazione semilavorati presso clienti per semil.  *
      * STA532   b  Situazione semilavorati presso clienti per cliente *
      *                                                                *
      * STA535   c  Situazione semilavorati presso fornitori per sem.  *
      * STA537   d  Situazione semilavorati presso fornitori per forn. *
      *                                                                *
      * STA540   e  Situazione semilavorati di clienti per articolo    *
      * STA542   f  Situazione semilavorati di clienti per cliente     *
      *                                                                *
      * STA545   g  Situazione semilavorati di fornitori per articolo  *
      * STA547   h  Situazione semilavorati di fornitori per fornitore *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'mag530'           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "presso Clienti per semilavorato                   
      -              " STA530     pmag530a  "
                                          to   w-tin-ele-wci          .
      ...
      *
      ...
      -              " STA532     pmag530b  "
           ...
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "presso Fornitori per semilavorato                 
      -              " STA535     pmag530c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      -              " STA537     pmag530d  "
           ...
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "di Clienti per semilavorato                       
      -              " STA540     pmag530e  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      -              " STA542     pmag530f  "
           ...
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "di Fornitori per semilavorato                     
      -              " STA545     pmag530g  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
