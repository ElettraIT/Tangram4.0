      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma pmag7261:       *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           move      rr-fso-mtv-ord       to   w-tip-ord-tip-ord      .
       prn-opn-fls-999.
           exit.
      ...
      *                      * Codice numerico                         *
      *                      *-----------------------------------------*
           move      rf-mtv-num-mtv       to   srt-cod-mag-num        .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico                     *
      *                      *-----------------------------------------*
           move      rf-mtv-alf-mtv       to   srt-cod-mag-alf        .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      *                      *-----------------------------------------*
           move      rf-mtv-des-mtv       to   srt-cod-mag-des        .
      *                      *-----------------------------------------*
      *                      * Unita' di misura                        *
      *                      *-----------------------------------------*
           move      rf-mtv-umi-gst       to   srt-cod-mag-umi        .
      *                      *-----------------------------------------*
      *                      * Numero decimali quantita'               *
      *                      *-----------------------------------------*
           move      rf-mtv-dec-qta       to   srt-cod-mag-dec       .
      *                      *-----------------------------------------*
      *                      * Classe merceologica                     *
      *                      *-----------------------------------------*
           move      rf-mtv-cla-mtv       to   srt-cod-mag-cla       .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico                     *
      *                      *-----------------------------------------*
           move      rf-mtv-gru-mtv       to   srt-cod-mag-gru        .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico                *
      *                      *-----------------------------------------*
           move      rf-mtv-sgr-mtv       to   srt-cod-mag-sgr        .
       cmp-srt-rec-700.
      *                  *---------------------------------------------*
      *                  * Valori L.i.f.o.                             *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun materiale vario da valorizzare !"
                                          to   m-msg                  .
      ...
      *                  * Lettura dati classe                         *
      *                  *---------------------------------------------*
           move      w-rot-l04-cod-cla    to   w-let-arc-zv1-cla      .
      ...
      *                  * Lettura dati gruppo                         *
      *                  *---------------------------------------------*
           move      w-rot-l04-cod-cla    to   w-let-arc-zv2-cla      .
           move      w-rot-l03-cod-gru    to   w-let-arc-zv2-gru      .
      ...
      *                  *---------------------------------------------*
           move      w-rot-l04-cod-cla    to   w-let-arc-zv3-cla      .
           move      w-rot-l03-cod-gru    to   w-let-arc-zv3-gru      .
           move      w-rot-l02-cod-sgr    to   w-let-arc-zv3-sgr      .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-let-arc-zv1-mne      .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-let-arc-zv2-mne      .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-let-arc-zv3-mne      .
