      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag0221:        *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-des-zmm-cod      .
           move      12                   to   w-cod-des-zmm-lin      .
           move      30                   to   w-cod-des-zmm-pos      .
           move      zero                 to   w-cod-des-zmm-dln      .
           move      zero                 to   w-cod-des-zmm-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-zmm-ope      .
           move      rr-cod-max           to   w-cod-des-zmm-cod      .
           move      12                   to   w-cod-des-zmm-lin      .
           move      52                   to   w-cod-des-zmm-pos      .
           move      zero                 to   w-cod-des-zmm-dln      .
           move      zero                 to   w-cod-des-zmm-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
