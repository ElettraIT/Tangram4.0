      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Situazione materie prime presso clienti per *
      *                    materia prima                               *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
               10  kk0-cod-cla            pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice gruppo merceologico                        *
      *            *---------------------------------------------------*
               10  kk0-cod-gru            pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice sottogruppo merceologico                   *
      *            *---------------------------------------------------*
               10  kk0-cod-sgr            pic  9(05)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "   LISTA MATERIE PRIME PRESSO CLIENTI   "       .
      ...
      *        * - 01 : Per classe, gruppo, sottogruppo, codice ma-    *
      *        *        gazzino                                        *
      *        * - 02 : Per classe, gruppo, sottogruppo, descrizione   *
      *        *        magazzino                                      *
      *        * - 03 : Per codice magazzino                           *
      *        * - 04 : Per descrizione magazzino                      *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-tot-art.
      *            *---------------------------------------------------*
      *            * Totale quantita' articolo                         *
      *            *---------------------------------------------------*
               10  w-tot-art-tot-qta      pic s9(08)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale elementi per articolo                      *
      *            *---------------------------------------------------*
               10  w-tot-art-tot-ele      pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Totali per conto merce                                *
      *        *-------------------------------------------------------*
           05  w-tot-ctm.
      *            *---------------------------------------------------*
      *            * Totale quantita' per conto merce                  *
      *            *---------------------------------------------------*
               10  w-tot-ctm-tot-qta      pic s9(08)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale elementi  per conto merce                  *
      *            *---------------------------------------------------*
               10  w-tot-ctm-tot-ele      pic  9(05)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-prn.
           05  w-prn-int-art              pic  x(01)                  .
           05  w-prn-int-ctm              pic  x(01)                  .
           05  w-prn-dec-qta              pic  9(01)                  .
           05  w-prn-des-ctm              pic  x(20)                  .

      *    *===========================================================*
      *    * Work-area per routine cmp-fil-app-000/999                 *
      *    *-----------------------------------------------------------*
       01  w-cmp-fil-app.
           05  w-cmp-fil-app-ctr          pic  9(08)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-rot-l02.
      *            *---------------------------------------------------*
      *            * Contatore records [dpm] letti                     *
      *            *---------------------------------------------------*
               10  w-rot-l02-ctr-dpm      pic  9(08)                  .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-cmp-fil-app-ctr      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to cmp-fil-app-999.
      *              *-------------------------------------------------*
      *              * Incremento contatore records [dpm] letti        *
      *              *-------------------------------------------------*
           add       1                    to   w-cmp-fil-app-ctr      .
       cmp-fil-app-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       cmp-fil-app-480.
      *              *-------------------------------------------------*
      *              * Riciclo su lettura filtro ordinamento [dpm]     *
      *              *-------------------------------------------------*
           go to     cmp-fil-app-100.
       cmp-fil-app-500.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      03                   to   rf-mmz-tip-mag         .
           move      rf-dpm-num-map       to   rf-mmz-num-mag         .
      ...
      *                  *---------------------------------------------*
           if        rf-mmz-ann-ese       not  = w-cmp-fil-app-wes or
                     ...
                     rf-mmz-tip-mag       not  = 03                or
                     rf-mmz-num-mag       not  = rf-dpm-num-map
                     go to cmp-fil-app-599.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           if        rf-mmz-cod-ctm       not  = rr-cod-mic
                     go to cmp-fil-app-520.
       cmp-fil-app-540.
      *                  *---------------------------------------------*
      *                  * Lettura record [dcc]                        *
      *                  *---------------------------------------------*
           ...
           move      rf-mmz-cod-arc       to   rf-dcc-cod-cli         .
           move      rf-mmz-dpz-arc       to   rf-dcc-dpz-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Composizione chiave                     *
      *                      *-----------------------------------------*
           move      w-cmp-fil-app-ctr    to   kk0-ctr-dpm            .
           move      rf-mmz-cod-ctm       to   kk0-cod-ctm            .
           move      rf-dcc-rag-key       to   kk0-rag-key            .
      ...
      *                          *-------------------------------------*
           ...
           move      rf-dpm-cla-map       to   kk0-cod-cla            .
           move      rf-dpm-gru-map       to   kk0-cod-gru            .
           move      rf-dpm-sgr-map       to   kk0-cod-sgr            .
           move      03                   to   kk0-tip-mag            .
           move      rf-dpm-num-map       to   kk0-num-mag            .
           move      rf-dpm-alf-map       to   kk0-alf-mag            .
           move      rf-dpm-des-map       to   kk0-des-mag            .
           move      rf-dpm-dec-qta       to   kk0-dec-qta            .
           move      "C"                  to   kk0-tip-arc            .
           move      rf-dcc-rag-soc       to   kk0-rag-soc            .
           move      rf-dpm-umi-prd       to   kk0-uni-mis            .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      kk0-cod-cla          to   w-rot-l05-cod-cla      .
      *                  *---------------------------------------------*
      *                  * Composizione area per rottura gruppo        *
      *                  *---------------------------------------------*
           move      kk0-cod-gru          to   w-rot-l04-cod-gru      .
      *                  *---------------------------------------------*
      *                  * Composizione area per rottura sottogruppo   *
      *                  *---------------------------------------------*
           move      kk0-cod-sgr          to   w-rot-l03-cod-sgr      .
      *                  *---------------------------------------------*
      ...
      *              * Contatore records [dpm] letti                   *
      *              *-------------------------------------------------*
           move      kk0-ctr-dpm          to   w-rot-l02-ctr-dpm      .
      *              *-------------------------------------------------*
      *              * Codice conto merce                              *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura dati classe                         *
      *                  *---------------------------------------------*
           move      w-rot-l05-cod-cla    to   w-let-arc-zm1-cla      .
      ...
      *                  * Lettura dati gruppo                         *
      *                  *---------------------------------------------*
           move      w-rot-l05-cod-cla    to   w-let-arc-zm2-cla      .
           move      w-rot-l04-cod-gru    to   w-let-arc-zm2-gru      .
      ...
      *                  *---------------------------------------------*
           move      w-rot-l05-cod-cla    to   w-let-arc-zm3-cla      .
           move      w-rot-l04-cod-gru    to   w-let-arc-zm3-gru      .
           move      w-rot-l03-cod-sgr    to   w-let-arc-zm3-sgr      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione totale per articolo             *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-art-tot-qta      .
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore elementi per articolo *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-art-tot-ele      .
      *              *-------------------------------------------------*
      *              * Bufferizzazione numero decimali quantita'       *
      *              *-------------------------------------------------*
           move      kk0-dec-qta          to   w-prn-dec-qta          .
      *              *-------------------------------------------------*
      *              * Flag di intestazione articolo                   *
      *              *-------------------------------------------------*
           move      "#"                  to   w-prn-int-art          .
       prn-ini-lr2-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-tot-art-tot-ele    not  > 1
                     go to prn-fin-lr2-999.
      *              *-------------------------------------------------*
      *              * Stampa totale articolo                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr2-200.
      *              *-------------------------------------------------*
      *              * Doppi trattini per totale articolo              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "N"                  to   p-tip                  .
           move      08                   to   p-car                  .
           move      w-prn-dec-qta        to   p-dec                  .
           move      "S"                  to   p-sgn                  .
           move      p-lnr                to   p-lin                  .
           move      118                  to   p-pos                  .
           move      "G"                  to   p-edm                  .
           move      w-tot-art-tot-qta    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-lr2-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione totale per conto merce          *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-ctm-tot-qta      .
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore elementi conto merce  *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-ctm-tot-ele      .
      *              *-------------------------------------------------*
      *              * Bufferizzazione descrizione conto merce         *
      *              *-------------------------------------------------*
           move      kk0-des-ctm          to   w-prn-des-ctm          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento totali articolo                   *
      *              *-------------------------------------------------*
           if        w-tot-art-tot-ele    <    99999
                     add   1              to   w-tot-art-tot-ele      .
           add       w-tot-ctm-tot-qta    to   w-tot-art-tot-qta      .
      *              *-------------------------------------------------*
      *              * Test su numero elementi                         *
      *              *-------------------------------------------------*
           if        w-tot-ctm-tot-ele    not  > 1
                     go to prn-fin-lr1-999.
      *              *-------------------------------------------------*
      *              * Stampa totale c/merce                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se righe residue sufficienti           *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      118                  to   p-pos                  .
           move      "G"                  to   p-edm                  .
           move      w-tot-ctm-tot-qta    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-lr1-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento totali conto merce                *
      *              *-------------------------------------------------*
           if        w-tot-ctm-tot-ele    <    99999
                     add   1              to   w-tot-ctm-tot-ele      .
           add       w-sdp-tot-dpz        to   w-tot-ctm-tot-qta      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-prn-int-art        =    spaces
                     go to prn-liv-det-200.
           move      spaces               to   w-prn-int-art          .
      *                      *-----------------------------------------*
      *                      * Interlinea ulteriore                    *
      *                      *-----------------------------------------*
           move      "LF"                 to   p-ope                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *              *-------------------------------------------------*
           ...
           string    "SITUAZIONE MATERIE PRIME PRESSO CLIENTI PER ARTICO
      -              "LO AL "
                                delimited by   size
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "               Codice e descrizione articolo      
      -              "      Udm C/M                        Cliente      
      -              "                     Quantita'  "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
