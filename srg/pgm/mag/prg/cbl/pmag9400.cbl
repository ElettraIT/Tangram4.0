      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag9401:        *
      *                                                                *
      ...
      *                  *---------------------------------------------*
           perform   vis-mes-ini-000      thru vis-mes-ini-999        .
       acc-mes-ini-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Mese iniziale                     *
      *    *-----------------------------------------------------------*
       vis-mes-ini-000.
      *              *-------------------------------------------------*
      *              * Valore numerico                                 *
      ...
      *                  * Visualizzazione literal                     *
      *                  *---------------------------------------------*
           perform   vis-mes-fin-000      thru vis-mes-fin-999        .
       acc-mes-fin-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Mese finale                       *
      *    *-----------------------------------------------------------*
       vis-mes-fin-000.
      *              *-------------------------------------------------*
      *              * Valore numerico                                 *
