      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa situazioni materie prime conto merce *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase mag560, nella sua globalita', esegue i tipi di stampa  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * STA560   a  Situazione materie prime presso clienti per mat.   *
      * STA562   b  Situazione materie prime presso clienti x cliente  *
      *                                                                *
      * STA565   c  Situazione materie prime presso fornitori per mat. *
      * STA567   d  Situazione materie prime presso fornitori x forn.  *
      *                                                                *
      * STA570   e  Situazione materie prime di clienti per materia p. *
      * STA572   f  Situazione materie prime di clienti per cliente    *
      *                                                                *
      * STA575   g  Situazione materie prime di fornitori per materia  *
      * STA577   h  Situazione materie prime di fornitori x fornitore  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "SITUAZIONI MERCI IN CONTO - SEMILAVORATI"       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'mag560'           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "presso Clienti per materia prima                  
      -              " STA560     pmag560a  "
                                          to   w-tin-ele-wci          .
      ...
      *
      ...
      -              " STA562     pmag560b  "
           ...
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "presso Fornitori per materia prima                
      -              " STA565     pmag560c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      -              " STA567     pmag560d  "
           ...
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "di Clienti per materia prima                      
      -              " STA570     pmag560e  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      -              " STA572     pmag560f  "
           ...
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "di Fornitori per materia prima                    
      -              " STA575     pmag560g  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
