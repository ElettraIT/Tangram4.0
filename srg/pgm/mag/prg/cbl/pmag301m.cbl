      ...
      *                       Ultima revisione:    NdK del 11/11/24    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Disponibilita' prodotto di vendita          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-ipc-dat-dsp.
      *            *---------------------------------------------------*
      *            * Si/No variabile di i.p.c. relativa alla data      *
      *            * disponibilita'                                    *
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-pro           to   w-det-qta-gcf-cod      .
           move      rr-dat-dsp           to   w-det-qta-gcf-dat      .
           perform   det-qta-gcf-000      thru det-qta-gcf-999        .
      *              *-------------------------------------------------*
      *              * Determinazione quantita' presso ns. dipendenze  *
      *              *-------------------------------------------------*
           move      rr-dpz-inu           to   w-det-qta-dpz-dpz      .
           move      rr-cod-pro           to   w-det-qta-dpz-cod      .
           move      rr-dat-dsp           to   w-det-qta-dpz-dat      .
           perform   det-qta-dpz-000      thru det-qta-dpz-999        .
      *              *-------------------------------------------------*
      *              * Determinazione quantita' presso terzi per la    *
      *              * dipendenza in uso                               *
      *              *-------------------------------------------------*
           move      rr-dpz-inu           to   w-det-qta-ptz-dpz      .
           move      rr-cod-pro           to   w-det-qta-ptz-cod      .
           move      rr-dat-dsp           to   w-det-qta-ptz-dat      .
           perform   det-qta-ptz-000      thru det-qta-ptz-999        .
      *              *-------------------------------------------------*
      *              * Determinazione quantita' di terzi per la        *
      *              * dipendenza in uso                               *
      *              *-------------------------------------------------*
           move      rr-dpz-inu           to   w-det-qta-dtz-dpz      .
           move      rr-cod-pro           to   w-det-qta-dtz-cod      .
           move      rr-dat-dsp           to   w-det-qta-dtz-dat      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-pro           to   w-det-qta-orc-cod      .
           move      rr-dat-dsp           to   w-det-qta-orc-dat      .
           perform   det-qta-orc-000      thru det-qta-orc-999        .
      *              *-------------------------------------------------*
      *              * Determinazione quantita' in spedizione          *
      *              *-------------------------------------------------*
           move      rr-dpz-inu           to   w-det-qta-ods-dpz      .
           move      rr-cod-pro           to   w-det-qta-ods-cod      .
           move      rr-dat-dsp           to   w-det-qta-ods-dat      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-pro           to   w-det-qta-orf-cod      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-pro           to   w-det-qta-orp-cod      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-dat-dsp           to   d-sld-ubi-dat-ela      .
           move      rr-dpz-inu           to   d-sld-ubi-cod-dpz      .
           move      01                   to   d-sld-ubi-tip-mag      .
           move      rr-cod-pro           to   d-sld-ubi-num-mag      .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-mpn                to   v-cnt                  .
           move      "Q.ta' in corso di spedizione  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-mpn                to   v-cnt                  .
           move      "Q.ta' in ordine da clienti    :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      72                   to   v-pos                  .
           move      w-det-qta-orc-dpo    to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-350.
      *                  *---------------------------------------------*
      *                  * Quantita' in ordine da dipendenze           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "orc"                to   w-mpn-tip-det          .
           move      w-mpn                to   v-cnt                  .
           move      "Q.ta' in ordine da dipendenze :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      45                   to   v-pos                  .
           move      w-det-qta-orc-qod    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-400.
      *                  *---------------------------------------------*
      ...
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
           if        w-prs-ods-snx        not  = "S" and
                     w-prs-orc-snx        not  = "S" and
                     w-prs-orf-snx        not  = "S" and
                     w-prs-cdp-snx        not  = "S"
      ...
      *                                  *-----------------------------*
       ...
       qry-liv-det-620.
      *                          *-------------------------------------*
      *                          * Determinazione in campo di comodo   *
      *                          *-------------------------------------*
           ...
           add       w-det-qta-orp-qcp    to   w-det-qta-dsp-qds      .
      *                          *-------------------------------------*
      *                          * Stampa                              *
      *                          *-------------------------------------*
           move      "PF"                 to   v-ope                  .
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Test se esistono quantita' successive   *
      *                      *-----------------------------------------*
           if        w-dpz-ctr-dpz        >    1    and
                     w-det-qta-dpz-qta    not  = zero
                     go to qry-liv-det-680.
           if        w-det-qta-ptz-qta    not  = zero
                     go to qry-liv-det-680.
           if        w-det-qta-dtz-qta    not  = zero
                     go to qry-liv-det-680.
      ...
      *                  *---------------------------------------------*
      ...
      -              "------ -----------------------"
       ...
       qry-liv-det-700.
      *                  *---------------------------------------------*
      *                  * Quantita' presso ns. dipendenze             *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
           if        w-dpz-ctr-dpz        not  > 1    and
                     w-det-qta-dpz-qta    =    zero
      ...
      *                      *-----------------------------------------*
           ...
           move      01                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      "dpz"                to   w-mpn-tip-det          .
           move      w-mpn                to   v-cnt                  .
           move      "Q.ta' presso ns. dipendenze   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      33                   to   v-pos                  .
           move      w-det-qta-dpz-qta    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-800.
      *                  *---------------------------------------------*
      *                  * Quantita' presso terzi per la dipendenza in *
      *                  * uso                                         *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
           if        w-det-qta-ptz-qta    =    zero
                     go to qry-liv-det-850.
      *                      *-----------------------------------------*
      *                      * Interlinea vuota                        *
      *                      *-----------------------------------------*
           move      "LF"                 to   v-ope                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      01                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      "ptz"                to   w-mpn-tip-det          .
           move      w-mpn                to   v-cnt                  .
           move      "Q.ta' presso terzi            :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       qry-liv-det-850.
      *                  *---------------------------------------------*
      *                  * Quantita' di terzi per la dipendenza in uso *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
           if        w-det-qta-dtz-qta    =    zero
                     go to qry-liv-det-900.
      *                      *-----------------------------------------*
      *                      * Test se righe residue sufficienti       *
      *                      *-----------------------------------------*
           if        v-res                >    1
                     go to qry-liv-det-852.
      *                      *-----------------------------------------*
      *                      * Intestazione pagina                     *
      *                      *-----------------------------------------*
           perform   int-pag-sta-000      thru int-pag-sta-999        .
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      45                   to   v-pos                  .
           move      w-det-qta-dtz-qta    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   qry-liv-det-ubi-000  thru qry-liv-det-ubi-999    .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     qry-liv-det-999.
      ...
      *    *===========================================================*
      *    * Routine di Det : Giacenza presso ns. dipendenze           *
      *    *-----------------------------------------------------------*
       det-qta-dpz-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preiliminari                    *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-qta-dpz-qta      .
      *              *-------------------------------------------------*
      *              * Test sul numero di dipendenze rilevate          *
      *              *-------------------------------------------------*
           if        w-dpz-ctr-dpz        not  > 1
                     go to det-qta-dpz-900.
       det-qta-dpz-100.
      *              *-------------------------------------------------*
      *              * Ciclo di scansione tabella dipendenze           *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-qta-dpz-ctr      .
       det-qta-dpz-200.
           add       1                    to   w-det-qta-dpz-ctr      .
      *                  *---------------------------------------------*
      *                  * Test su contatore dipendenze                *
      *                  *---------------------------------------------*
           if        w-det-qta-dpz-ctr    >    w-dpz-ctr-dpz
                     go to det-qta-dpz-900.
      *                  *---------------------------------------------*
      *                  * Test se dipendenza esiste                   *
      *                  *---------------------------------------------*
           if        w-dpz-ele-flg
                    (w-det-qta-dpz-ctr)   =    spaces
                     go to det-qta-dpz-200.
      *                  *---------------------------------------------*
      *                  * Test se dipendenza in uso                   *
      *                  *---------------------------------------------*
           if        w-det-qta-dpz-ctr    =    w-det-qta-dpz-dpz
                     go to det-qta-dpz-200.
      *                  *---------------------------------------------*
      *                  * Preparazione link-area                      *
      *                  *---------------------------------------------*
           move      "SL"                 to   d-sld-mag-tip-ope      .
           move      0000                 to   d-sld-mag-tip-sld      .
           move      w-det-qta-dpz-dat    to   d-sld-mag-dat-sld      .
           move      "U"                  to   d-sld-mag-uot-dpz      .
           move      w-det-qta-dpz-ctr    to   d-sld-mag-cod-dpz      .
           move      01                   to   d-sld-mag-tip-mag      .
           move      w-det-qta-dpz-cod    to   d-sld-mag-num-mag      .
           move      "T"                  to   d-sld-mag-uot-var      .
           move      spaces               to   d-sld-mag-var-mag      .
           move      "T"                  to   d-sld-mag-uot-dsl      .
           move      spaces               to   d-sld-mag-cod-dsl      .
      ...
      *                  * Memorizzazione risultato                    *
      *                  *---------------------------------------------*
           add       d-sld-mag-sld-mag    to   w-det-qta-dpz-qta      .
      *                  *---------------------------------------------*
      *                  * A riciclo su dipendenza successiva          *
      *                  *---------------------------------------------*
           go to     det-qta-dpz-200.
       det-qta-dpz-900.
      *              *-------------------------------------------------*
      ...
      *                  * mark-point                                  *
      *                  *---------------------------------------------*
           if        w-mpn-tip-det        =    "ods"
                     go to qry-trt-fun-310
           else if   w-mpn-tip-det        =    "orc"
                     go to qry-trt-fun-320
           else if   w-mpn-tip-det        =    "orf"
                     go to qry-trt-fun-330
           else if   w-mpn-tip-det        =    "cdp"
                     go to qry-trt-fun-340
           else if   w-mpn-tip-det        =    "dpz"
                     go to qry-trt-fun-350
           else if   w-mpn-tip-det        =    "ptz"
                     go to qry-trt-fun-360
           else if   w-mpn-tip-det        =    "dtz"
                     go to qry-trt-fun-370
           else if   w-mpn-tip-det        =    "ubi"
                     go to qry-trt-fun-380
           else      go to qry-trt-fun-999.
       qry-trt-fun-310.
      *                  *---------------------------------------------*
      *                  * Se selezionato dettaglio : q.ta' in corso   *
      *                  * di spedizione                               *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       qry-trt-fun-320.
      *                  *---------------------------------------------*
      *                  * Se selezionato dettaglio : q.ta' in ordine  *
      *                  * da clienti                                  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se programma di interrogazione su  *
      *                      * ordini clienti gia' attivo              *
      *                      *-----------------------------------------*
           move      "P?"                 to   s-ope                  .
      ...
      *                  *---------------------------------------------*
       ...
       qry-trt-fun-350.
      *                  *---------------------------------------------*
      *                  * Se selezionato dettaglio : q.ta' presso ns. *
      *                  * dipendenze                                  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se programma di interrogazione su  *
      ...
      *                  *---------------------------------------------*
       ...
       qry-trt-fun-360.
      *                  *---------------------------------------------*
      *                  * Se selezionato dettaglio : q.ta' presso     *
      *                  * terzi                                       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se programma di interrogazione su  *
      ...
      *                  *---------------------------------------------*
       ...
       qry-trt-fun-370.
      *                  *---------------------------------------------*
      *                  * Se selezionato dettaglio : q.ta' di terzi   *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se programma di interrogazione su  *
      *                      * giacenze gia' attivo                    *
      ...
      *                  *---------------------------------------------*
           move      10                   to   w-det-gia-ubi-lin      .
           add       w-det-gia-ubi-ctr    to   w-det-gia-ubi-lin      .
      *                  *---------------------------------------------*
      *                  * Ubicazione                                  *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      07                   to   v-car                  .
           move      w-det-gia-ubi-lin    to   v-lin                  .
           move      24                   to   v-pos                  .
