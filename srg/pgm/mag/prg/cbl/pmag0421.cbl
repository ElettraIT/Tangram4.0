      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma mag042   *
      *                                                                *
      *                    Stampa tabella Tipi ubicazione di amgazzino *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA TABELLA TIPI UBICAZIONE MAGAZZINO"       .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zmu-tip-ubi         .
           move      "pgm/mag/fls/ioc/obj/iofzmu"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-dpz-inu           to   rf-zmu-cod-dpz         .
           move      rr-des-min           to   rf-zmu-des-key         .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun Tipo ubicazione entro i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zmu]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/mag/fls/ioc/obj/iofzmu"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-zmu-cod-dpz       not  = rr-dpz-inu
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zmu-tip-ubi       <    rr-cod-min or
                     rf-zmu-tip-ubi       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zmu-des-key       <    rr-des-min or
                     rf-zmu-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Stampa commento all'ubicazione se esistente     *
      *              *-------------------------------------------------*
           if        rf-zmu-com-ubi       =    spaces
                     go to prn-liv-det-999.
      *                  *---------------------------------------------*
      *                  * Test se righe residue sufficienti           *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Stampa commento all'ubicazione              *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
      ...
      *              *-------------------------------------------------*
           move      "TABELLA TIPI DI UBICAZIONE DI MAGAZZINO"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "Cod.   Descrizione     Param. 1   Param. 2   Param
      -              ". 3   Param. 4                "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
