      ...
      *                                                                *
      *                    Ricerca movimenti per materia prima         *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-mag           to   w-cod-cod-dpm-num      .
           move      rr-alf-mag           to   w-cod-cod-dpm-alf      .
      ...
      *                  *---------------------------------------------*
           move      rr-cod-mag           to   w-let-arc-dpm-num      .
           move      rr-alf-mag           to   w-let-arc-dpm-alf      .
           perform   let-arc-dpm-000      thru let-arc-dpm-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione magazzino        *
      *                  *---------------------------------------------*
           move      w-let-arc-dpm-des    to   rr-cod-mag-des         .
      *                  *---------------------------------------------*
      *                  * Memorizzazione unita' di misura             *
      *                  *---------------------------------------------*
           move      w-let-arc-dpm-umi    to   rr-cod-mag-umi         .
      *                  *---------------------------------------------*
      *                  * Memorizzazione numero decimali quantita'    *
      *                  *---------------------------------------------*
           move      w-let-arc-dpm-ndq    to   rr-cod-mag-ndq         .
       acc-cod-mag-420.
      *                  *---------------------------------------------*
