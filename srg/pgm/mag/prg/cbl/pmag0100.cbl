      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella dislocazioni per le        *
      *                    dipendenze                                  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-dsl          pic  x(30)                  .
               10  w-tes-des-key          pic  x(30)                  .
               10  w-tes-com-dsl          pic  x(40)                  .
               10  w-tes-alx-exp.
      ...
      *              * Codice dislocazione                             *
      *              *-------------------------------------------------*
           perform   pmt-cod-dsl-000      thru pmt-cod-dsl-999        .
      *              *-------------------------------------------------*
      *              * Linea di trattini                               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice dislocazione           *
      *    *-----------------------------------------------------------*
       pmt-cod-dsl-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice dislocazione           *
      *    *-----------------------------------------------------------*
       acc-cod-dsl-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-dpz        to   w-cod-des-zmd-dpz      .
           move      w-tes-cod-dsl        to   w-cod-des-zmd-cod      .
           move      04                   to   w-cod-des-zmd-lin      .
           move      30                   to   w-cod-des-zmd-pos      .
           move      07                   to   w-cod-des-zmd-dln      .
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-dsl        to   w-all-str-alf          .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice dislocazione        *
      *    *-----------------------------------------------------------*
       vis-cod-dsl-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           perform   acc-des-dsl-000      thru acc-des-dsl-999        .
      ...
      *                  * Commento                                    *
      *                  *---------------------------------------------*
           perform   acc-com-dsl-000      thru acc-com-dsl-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Descrizione dislocazione                        *
      *              *-------------------------------------------------*
           perform   vis-des-dsl-000      thru vis-des-dsl-999        .
      *              *-------------------------------------------------*
      *              * Commento                                        *
      *              *-------------------------------------------------*
           perform   vis-com-dsl-000      thru vis-com-dsl-999        .
       vis-tes-reg-999.
           exit.
      ...
      *              * Descrizione dislocazione                        *
      *              *-------------------------------------------------*
           perform   pmt-des-dsl-000      thru pmt-des-dsl-999        .
      *              *-------------------------------------------------*
      *              * Commento                                        *
      *              *-------------------------------------------------*
           perform   pmt-com-dsl-000      thru pmt-com-dsl-999        .
       pmt-tes-reg-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione dislocazione         *
      *    *-----------------------------------------------------------*
       pmt-des-dsl-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione dislocazione     *
      *    *-----------------------------------------------------------*
       acc-des-dsl-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-dsl (1)    =    spaces
                     go to acc-des-dsl-100.
       acc-des-dsl-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-des-dsl (1)    to   w-all-str-alf          .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione dislocazione  *
      *    *-----------------------------------------------------------*
       vis-des-dsl-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-dsl (1)      .
           move      spaces               to   w-tes-des-key (1)      .
           move      spaces               to   w-tes-com-dsl (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-dpz        to   rf-zmd-cod-dpz         .
           move      w-tes-cod-dsl        to   rf-zmd-cod-dsl         .
           move      "pgm/mag/fls/ioc/obj/iofzmd"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zmd]                        *
      *                          *-------------------------------------*
           move      rf-zmd-des-dsl       to   w-tes-des-dsl (1)      .
           move      rf-zmd-des-key       to   w-tes-des-key (1)      .
           move      rf-zmd-com-dsl       to   w-tes-com-dsl (1)      .
           move      rf-zmd-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zmd]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zmd-000      thru wrt-rec-zmd-999        .
      ...
      *                      * Rewrite record [zmd]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zmd-000      thru rew-rec-zmd-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zmd]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zmd-000      thru del-rec-zmd-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zmd]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zmd-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-dsl (1)    to   rf-zmd-des-dsl         .
           move      w-tes-des-key (1)    to   rf-zmd-des-key         .
           move      w-tes-com-dsl (1)    to   rf-zmd-com-dsl         .
           move      w-tes-alx-exp (1)    to   rf-zmd-alx-exp         .
       cmp-rec-zmd-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zmd]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zmd-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zmd-000      thru cmp-rec-zmd-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
