      ...
      *                                   Fase:                        *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 31/12/02    *
      *                       Ultima revisione:    NdK del 08/12/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione codice ubicazione       *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-des-zub-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zub-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-zub-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-zub-cod : codice dislocazione  *
      *                                                                *
      *                       w-cod-des-zub-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-zub-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-zub-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-zub-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zub-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-zub-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zub-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-zub-cod : codice dislocazione  *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-zub.
           05  w-aux-cde-zub-nli          pic  9(02)                  .
           05  w-aux-cde-zub-crb          pic  9(02)                  .
           05  w-aux-cde-zub-cpb          pic  9(02)                  .
           05  w-aux-cde-zub-cpa          pic  9(02)                  .
           05  w-aux-cde-zub-bix          pic  9(02)                  .
           05  w-aux-cde-zub-buf
                               occurs 30.
               10  w-aux-cde-zub-bco      pic  x(07)                  .
               10  w-aux-cde-zub-bde      pic  x(30)                  .
           05  w-aux-cde-zub-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-zub-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-zub-lt2      pic  9(01)                  .
           05  w-aux-cde-zub-dup          pic  x(30)                  .
           05  w-aux-cde-zub-dmx.
               10  w-aux-cde-zub-dch
                               occurs 30  pic  x(01)                  .
           05  w-aux-cde-zub-c01          pic  9(02)                  .
           05  w-aux-cde-zub-c02          pic  9(02)                  .
           05  w-aux-cde-zub-c03          pic  9(02)                  .
           05  w-aux-cde-zub-c04          pic  9(02)                  .
           05  w-aux-cde-zub-c05          pic  9(02)                  .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-zub
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zub-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-zub-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-zub-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-zub-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-zub-ope    =    "A+" or
                     w-cod-des-zub-ope    =    "I+" or
                     w-cod-des-zub-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-zub-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-cod-des-zub-dpz    to   w-cod-des-zub-s02      .
      *                  *---------------------------------------------*
      *                  * Codice dislocazione di default              *
      *                  *---------------------------------------------*
           move      w-cod-des-zub-cod    to   w-cod-des-zub-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-zub-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-zub-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-zub-s90    to   v-ufk                  .
           move      w-cod-des-zub-lin    to   v-lin                  .
           move      w-cod-des-zub-pos    to   v-pos                  .
           move      w-cod-des-zub-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-zub-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zub-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-zub-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-zub-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-zub-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-zub-cod    to   w-cod-des-zub-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-zub-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-zub-dln    =    zero or
                     w-cod-des-zub-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-zub-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      w-cod-des-zub-dln    to   v-lin                  .
           move      w-cod-des-zub-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-zub-dln    to   v-lin                  .
           move      w-cod-des-zub-dps    to   v-pos                  .
           move      w-aux-cde-zub-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-zub-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-zub-dup    to   w-aux-cde-zub-dmx      .
           move      30                   to   w-aux-cde-zub-c01      .
       aco-680.
           if        w-aux-cde-zub-c01    >    zero
                     if    w-aux-cde-zub-dch
                          (w-aux-cde-zub-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-zub-dch
                                              (w-aux-cde-zub-c01)
                           subtract 1     from w-aux-cde-zub-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-zub-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-cod-des-zub-dpz    to   rf-zub-cod-dpz         .
           move      w-aux-cde-zub-dup    to   rf-zub-des-key         .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-zub-cod-dpz       not  = w-cod-des-zub-dpz
                     go to aco-800.
           if        rf-zub-des-key       >    w-aux-cde-zub-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-zub-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-zub-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              * Codice dislocazione             *
      *                              *---------------------------------*
           move      rf-zub-cod-ubi       to   w-aux-cde-zub-bco
                                              (w-aux-cde-zub-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione dislocazione        *
      *                              *---------------------------------*
           move      rf-zub-des-ubi       to   w-aux-cde-zub-bde
                                              (w-aux-cde-zub-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-zub-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-zub-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-zub-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      w-cod-des-zub-dpz    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                                  *-----------------------------*
      *                                  * Descrizione di base         *
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      30                   to   s-car                  .
           move      w-aux-cde-zub-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-zub-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-zub-bco
                    (w-aux-cde-zub-bix)   to   w-cod-des-zub-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-zub-crb    to   w-aux-cde-zub-cpb      .
           subtract  1                    from w-aux-cde-zub-cpb      .
           divide    6                    into w-aux-cde-zub-cpb      .
           add       1                    to   w-aux-cde-zub-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-zub-c01      .
      *                              *---------------------------------*
      ...
      *                              * di indice (w-aux-cde-zub-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-zub-c01    to   w-aux-cde-zub-nli      .
       aco-865.
           if        w-aux-cde-zub-nli    >    6
                     subtract  6          from w-aux-cde-zub-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-zub-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-zub-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-zub-c01    <    w-aux-cde-zub-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-zub-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-zub-cpa    <    w-aux-cde-zub-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-zub-nli    to   v-lin                  .
           move      30                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-zub-c01    to   w-aux-cde-zub-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-zub-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-zub-cpa    to   w-aux-cde-zub-c01      .
           multiply  6                    by   w-aux-cde-zub-c01      .
           subtract  5                    from w-aux-cde-zub-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-zub-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-zub-c01    to   w-aux-cde-zub-c02      .
           add       5                    to   w-aux-cde-zub-c02      .
           divide    6                    into w-aux-cde-zub-c02      .
           move      w-aux-cde-zub-c02    to   w-aux-cde-zub-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-zub-c02      .
           multiply  6                    by   w-aux-cde-zub-c02      .
           add       1                    to   w-aux-cde-zub-c02      .
           add       5
                     w-aux-cde-zub-c02  giving w-aux-cde-zub-c03      .
           move      w-aux-cde-zub-c03    to   w-aux-cde-zub-c04      .
           if        w-aux-cde-zub-c03    >    w-aux-cde-zub-crb
                     move  w-aux-cde-zub-crb
                                          to   w-aux-cde-zub-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-zub-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      07                   to   v-car                  .
           move      w-aux-cde-zub-c05    to   v-lin                  .
           move      21                   to   v-pos                  .
           move      w-aux-cde-zub-bco
                    (w-aux-cde-zub-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      *                                      * Descrizione dislocazione*
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-zub-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-zub-c02    not  > w-aux-cde-zub-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-zub-c02    >    w-aux-cde-zub-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-zub-cpa    to   w-aux-cde-zub-lt1      .
           move      w-aux-cde-zub-cpb    to   w-aux-cde-zub-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-zub-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
