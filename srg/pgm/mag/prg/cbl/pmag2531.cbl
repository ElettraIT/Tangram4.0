      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pmag2530 *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work-area per determinazione costo unitario           *
      *        *-------------------------------------------------------*
           05  w-det-cos-uni-ct1          pic  9(02)                  .
           05  w-det-cos-uni-ct2          pic  9(02)                  .
           05  w-det-cos-uni occurs 12.
      *            *---------------------------------------------------*
      *            * Costo unitario                                    *
      *            *---------------------------------------------------*
               10  w-det-cos-uni-cos      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Data riferimento                                  *
      *            *---------------------------------------------------*
               10  w-det-cos-uni-dat      pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Normalizzazione campo di comodo per il costo    *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-cos-uni-ct1      .
       prn-sel-rec-020.
           add       1                    to   w-det-cos-uni-ct1      .
           if        w-det-cos-uni-ct1    >    12
                     go to prn-sel-rec-100.
           move      zero                 to   w-det-cos-uni-cos
                                              (w-det-cos-uni-ct1)     .
           move      zero                 to   w-det-cos-uni-dat
                                              (w-det-cos-uni-ct1)     .
           go to     prn-sel-rec-020.
       prn-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Determinazione costo                            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura scheda valori di magazzino          *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "ESECOD    "         to   f-key                  .
           move      rr-ann-rif           to   rf-mmv-ann-ese         .
           ...
           call      s-pat               using f
                                               rf-mmv                 .
      *                      *-----------------------------------------*
      *                      * Se scheda non trovata : a selezione su  *
      *                      * costo determinato                       *
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
      ...
      *                      *-----------------------------------------*
       ...
       prn-sel-rec-312.
           add       1                    to   w-det-cos-uni-ct1      .
           if        w-det-cos-uni-ct1    >    12
                     go to prn-sel-rec-318.
           move      rf-mmv-ust-mns
                    (w-det-cos-uni-ct1)   to   w-det-cos-uni-cos
                                              (w-det-cos-uni-ct1)     .
           move      rf-mmv-dst-mns
                    (w-det-cos-uni-ct1)   to   w-det-cos-uni-dat
                                              (w-det-cos-uni-ct1)     .
           go to     prn-sel-rec-312.
       prn-sel-rec-318.
      *                          *-------------------------------------*
      *                          * A selezioni                         *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
       ...
       prn-sel-rec-500.
      *              *-------------------------------------------------*
      *              * Selezione su Si/no costo a zero                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione della richiesta      *
      *                  *---------------------------------------------*
           if        rr-snx-zer           =    01
                     go to prn-sel-rec-510
           else if   rr-snx-zer           =    02
                     go to prn-sel-rec-520
           else if   rr-snx-zer           =    03
                     go to prn-sel-rec-530
           else      go to prn-sel-rec-800.
       prn-sel-rec-510.
      *                  *---------------------------------------------*
      *                  * Solo materie prime con costo diverso da ze- *
      *                  * ro                                          *
      *                  *---------------------------------------------*
           if        rr-mes-rif           =    zero
                     go to prn-sel-rec-515.
           if        w-det-cos-uni-cos
                    (rr-mes-rif)          =    zero
                     go to prn-sel-rec-900
           else      go to prn-sel-rec-800.
       prn-sel-rec-515.
           if        w-det-cos-uni-cos (01)
                                          =    zero and
                     w-det-cos-uni-cos (02)
                                          =    zero and
                     w-det-cos-uni-cos (03)
                                          =    zero and
                     w-det-cos-uni-cos (04)
                                          =    zero and
                     w-det-cos-uni-cos (05)
                                          =    zero and
                     w-det-cos-uni-cos (06)
                                          =    zero and
                     w-det-cos-uni-cos (07)
                                          =    zero and
                     w-det-cos-uni-cos (08)
                                          =    zero and
                     w-det-cos-uni-cos (09)
                                          =    zero and
                     w-det-cos-uni-cos (10)
                                          =    zero and
                     w-det-cos-uni-cos (11)
                                          =    zero and
                     w-det-cos-uni-cos (12)
                                          =    zero
                     go to prn-sel-rec-900.
      *                      *-----------------------------------------*
      *                      * Ad altre selezioni                      *
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test su mese di riferimento             *
      *                      *-----------------------------------------*
           if        rr-mes-rif           =    zero
                     go to prn-liv-det-500.
      *                      *-----------------------------------------*
      *                      * Se un solo mese di riferimento          *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Costo                               *
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Ciclo di stampa per 12 mesi         *
      *                          *-------------------------------------*
           move      zero                 to   w-det-cos-uni-ct1      .
           move      zero                 to   w-det-cos-uni-ct2      .
       prn-liv-det-520.
           add       1                    to   w-det-cos-uni-ct1      .
           if        w-det-cos-uni-ct1    >    12
                     go to prn-liv-det-999.
      ...
      *                          *-------------------------------------*
           if        rr-snx-zer           =    02
                     go to prn-liv-det-525.
           if        w-det-cos-uni-cos
                    (w-det-cos-uni-ct1)   =    zero
                     go to prn-liv-det-520.
       prn-liv-det-525.
      *                          *-------------------------------------*
      *                          * Incremento contatore di comodo      *
      *                          *-------------------------------------*
           add       1                    to   w-det-cos-uni-ct2      .
      *                          *-------------------------------------*
      *                          * Test se primo elemento              *
      *                          *-------------------------------------*
           if        w-det-cos-uni-ct2    =    1
      ...
      *                      * Se costo standard                       *
      *                      *-----------------------------------------*
           string    "COSTO STANDARD UNITARIO PER MATERIE PRIME - ANNO "
                                delimited by   size
                     p-edt      delimited by   spaces
                                          into w-cnt-tit-des-tit      .
      *                          *-------------------------------------*
      *                          * A intestazione standard             *
      *                          *-------------------------------------*
      ...
      *                      * Se costo ultimo                         *
      *                      *-----------------------------------------*
           string    "COSTO ULTIMO UNITARIO PER MATERIE PRIME - ANNO "
                                delimited by   size
                     p-edt      delimited by   spaces
                                          into w-cnt-tit-des-tit      .
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Routine di intestazione standard                *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "          Udm   Costo unitario   Data riferim."
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
