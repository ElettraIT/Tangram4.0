      ...
      *                       Ultima revisione:    NdK del 12/09/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella parametri di ubicazione    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " PARAMETRI DI UBICAZIONE DEL MAGAZZINO  "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-ubi          pic  x(30)                  .
               10  w-tes-des-key          pic  x(30)                  .
               10  w-tes-inx-per          pic  9(07)                  .
               10  w-tes-com-ubi          pic  x(40)                  .
               10  w-tes-tip-ubi          pic  x(01)                  .
               10  w-tes-alx-exp.
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ubicazione                            *
      *        *-------------------------------------------------------*
           05  w-exp-tip-ubi.
               10  w-exp-tip-ubi-num      pic  9(02)       value 3    .
               10  w-exp-tip-ubi-lun      pic  9(02)       value 30   .
               10  w-exp-tip-ubi-tbl.
                   15  filler             pic  x(30) value
                            "Normale                       "          .
                   15  filler             pic  x(30) value
                            "ubicazione di Transito        "          .
                   15  filler             pic  x(30) value
                            "ubicazione presso Corriere    "          .
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   w-cod-des-zub-lin      .
           move      30                   to   w-cod-des-zub-pos      .
           move      07                   to   w-cod-des-zub-dln      .
      ...
      *                  * Indice di percorso                          *
      *                  *---------------------------------------------*
           perform   acc-inx-per-000      thru acc-inx-per-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
      ...
      *                  * Commento                                    *
      *                  *---------------------------------------------*
           perform   acc-com-ubi-000      thru acc-com-ubi-999        .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Commento                                        *
      *              *-------------------------------------------------*
           perform   vis-com-ubi-000      thru vis-com-ubi-999        .
      *              *-------------------------------------------------*
      *              * Tipo ubicazione                                 *
      *              *-------------------------------------------------*
      ...
      *              * Commento                                        *
      *              *-------------------------------------------------*
           perform   pmt-com-ubi-000      thru pmt-com-ubi-999        .
      *              *-------------------------------------------------*
      *              * Tipo ubicazione                                 *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione ubicazione           *
      *    *-----------------------------------------------------------*
       pmt-des-ubi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Descrizione ubicazione               *
      *    *-----------------------------------------------------------*
       acc-des-ubi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-com-ubi-100.
       acc-com-ubi-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Commento                          *
      *    *-----------------------------------------------------------*
       vis-com-ubi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Tipo ubicazione                      *
      *    *-----------------------------------------------------------*
       acc-tip-ubi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tip-ubi-lun    to   v-car                  .
           move      w-exp-tip-ubi-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      "NTC#"               to   v-msk                  .
           move      13                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-tip-ubi-tbl    to   v-txt                  .
      *
           if        w-tes-tip-ubi (1)    =    "N"
                     move  01             to   v-num
           else if   w-tes-tip-ubi (1)    =    "T"
                     move  02             to   v-num
           else if   w-tes-tip-ubi (1)    =    "C"
                     move  03             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   w-tes-tip-ubi (1)
           else if   v-num                =    02
                     move  "T"            to   w-tes-tip-ubi (1)
           else if   v-num                =    03
                     move  "C"            to   w-tes-tip-ubi (1)
           else      move  "N"            to   w-tes-tip-ubi (1)      .
       acc-tip-ubi-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       cnt-tdo-nok-120.
      *                  *---------------------------------------------*
      *                  * Controllo su descrizione ubicazione         *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           ...
           move      spaces               to   w-tes-com-ubi (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-dpz        to   rf-zub-cod-dpz         .
           move      w-tes-cod-ubi        to   rf-zub-cod-ubi         .
           move      "pgm/mag/fls/ioc/obj/iofzub"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zub]                        *
      *                          *-------------------------------------*
           move      rf-zub-des-ubi       to   w-tes-des-ubi (1)      .
           move      rf-zub-des-key       to   w-tes-des-key (1)      .
           move      rf-zub-inx-per       to   w-tes-inx-per (1)      .
           move      rf-zub-com-ubi       to   w-tes-com-ubi (1)      .
           move      rf-zub-tip-ubi       to   w-tes-tip-ubi (1)      .
           move      rf-zub-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Rewrite record [zub]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zub-000      thru rew-rec-zub-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zub]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zub-000      thru del-rec-zub-999        .
       del-mov-fil-999.
           exit.
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-ubi (1)    to   rf-zub-des-ubi         .
           move      w-tes-des-key (1)    to   rf-zub-des-key         .
           move      w-tes-inx-per (1)    to   rf-zub-inx-per         .
           move      w-tes-com-ubi (1)    to   rf-zub-com-ubi         .
           move      w-tes-tip-ubi (1)    to   rf-zub-tip-ubi         .
           move      w-tes-alx-exp (1)    to   rf-zub-alx-exp         .
       cmp-rec-zub-999.
           exit.
