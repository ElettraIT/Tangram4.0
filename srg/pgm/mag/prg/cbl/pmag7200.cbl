      ...
      *                       Ultima revisione:    NdK del 22/01/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag7201:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Si/no stampa riepilogo                     *
      *        *-------------------------------------------------------*
           05  w-exp-snx-rie.
      ...
      *                  *---------------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Stampa riepilogo esercizi  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *                  * Si/no stampa riepilogo                      *
      *                  *---------------------------------------------*
           move      02                   to   rr-snx-rie             .
           perform   vis-snx-rie-000      thru vis-snx-rie-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione : Si/No stampa riepilogo                     *
      *    *-----------------------------------------------------------*
       acc-snx-rie-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * sia in Up                                   *
      *                  *---------------------------------------------*
           if        rr-snx-rie           not  = zero
                     go to acc-snx-rie-600.
           if        v-key                =    "UP  "
                     go to acc-snx-rie-600
           else      go to acc-snx-rie-999.
       acc-snx-rie-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/No stampa riepilogo                  *
      *    *-----------------------------------------------------------*
       vis-snx-rie-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           if        rr-snx-zer           =    zero
                     move  01             to   rr-snx-zer             .
      *              *-------------------------------------------------*
      *              * Normalizzazione Si/No stampa riepilogo          *
      *              *-------------------------------------------------*
           if        rr-snx-rie           =    zero
