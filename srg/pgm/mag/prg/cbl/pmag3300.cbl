      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag3301:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-snx-aum.
               10  w-exp-snx-aum-num      pic  9(02)       value 4    .
               10  w-exp-snx-aum-lun      pic  9(02)       value 47   .
               10  w-exp-snx-aum-tbl.
                   15  filler             pic  x(47) value
                     "stampa solo prodotti Movimentati               ".
                   15  filler             pic  x(47) value
                     "stampa prodotti movimentati o con sola Giacenza".
                   15  filler             pic  x(47) value
                     "stampa prodotti movimentati ma non In negativo ".
                   15  filler             pic  x(47) value
                     "Nessuna selezione su quantita'                 ".
      *        *-------------------------------------------------------*
      *        * Work per : Si/no c/merce evidenziati                  *
      *        *-------------------------------------------------------*
           05  w-exp-snx-cme.
               10  w-exp-snx-cme-num      pic  9(02)       value 2    .
               10  w-exp-snx-cme-lun      pic  9(02)       value 47   .
               10  w-exp-snx-cme-tbl.
                   15  filler             pic  x(47) value
                     "Evidenziati                                    ".
                   15  filler             pic  x(47) value
                     "Non evidenziati                                ".
      *        *-------------------------------------------------------*
      *        * Work per : Si/no riepiloghi                           *
      *        *-------------------------------------------------------*
           05  w-exp-snx-rie.
      ...
      *                  * Si/No c/merce evidenziati                   *
      *                  *---------------------------------------------*
           perform   acc-snx-cme-000      thru acc-snx-cme-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           ...
           move      16                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Stampa totali di riepilogo :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ric-sel-999.
      ...
      *    *===========================================================*
      *    * Accettazione : Si/No c/merce evidenziati                  *
      *    *-----------------------------------------------------------*
       acc-snx-cme-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-cme-lun    to   v-car                  .
           move      w-exp-snx-cme-num    to   v-ldt                  .
           move      "EN#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      14                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-cme-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      rr-snx-cme           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-cme-999.
       acc-snx-cme-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-snx-cme             .
       acc-snx-cme-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * sia in Up                                   *
      *                  *---------------------------------------------*
           if        rr-snx-cme           not  = zero
                     go to acc-snx-cme-600.
           if        v-key                =    "UP  "
                     go to acc-snx-cme-600
           else      go to acc-snx-cme-999.
       acc-snx-cme-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-snx-cme-100.
       acc-snx-cme-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Si/No c/merce evidenziati               *
      *    *-----------------------------------------------------------*
       vis-snx-cme-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/No riepiloghi                        *
      *    *-----------------------------------------------------------*
       vis-snx-rie-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "Manca la selezione su 'Selezioni su quantita'' !  
      -              "          "         to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-255.
           if        rr-snx-aum           =    01 or
           ...
           move      "Selezione su 'Selezioni su quantita'' errata !    
      -              "          "         to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-300.
       tdo-ric-sel-350.
      ...
      *              *-------------------------------------------------*
           if        rr-snx-rie           =    zero
                     move  1              to   rr-snx-rie             .
      *              *-------------------------------------------------*
      *              * Si/no c/merce evidenziati                       *
      *              *-------------------------------------------------*
           if        rr-snx-cme           =    zero
                     move  1              to   rr-snx-cme             .
       reg-ric-sel-999.
           exit.
