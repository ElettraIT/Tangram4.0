      ...
      *                                   Fase:                        *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 11/09/91    *
      *                       Ultima revisione:    NdK del 31/12/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione codice conto merce      *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-des-zmm-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zmm-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-zmm-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-zmm-cod : conto merce          *
      *                                                                *
      *                       w-cod-des-zmm-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-zmm-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-zmm-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-zmm-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zmm-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-zmm-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zmm-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-zmm-cod : conto merce          *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-zmm.
           05  w-aux-cde-zmm-nli          pic  9(02)                  .
           05  w-aux-cde-zmm-crb          pic  9(02)                  .
           05  w-aux-cde-zmm-cpb          pic  9(02)                  .
           05  w-aux-cde-zmm-cpa          pic  9(02)                  .
           05  w-aux-cde-zmm-bix          pic  9(02)                  .
           05  w-aux-cde-zmm-buf
                               occurs 30.
               10  w-aux-cde-zmm-bco      pic  x(03)                  .
               10  w-aux-cde-zmm-bde      pic  x(20)                  .
           05  w-aux-cde-zmm-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-zmm-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-zmm-lt2      pic  9(01)                  .
           05  w-aux-cde-zmm-dup          pic  x(20)                  .
           05  w-aux-cde-zmm-dmx.
               10  w-aux-cde-zmm-dch
                               occurs 20  pic  x(01)                  .
           05  w-aux-cde-zmm-c01          pic  9(02)                  .
           05  w-aux-cde-zmm-c02          pic  9(02)                  .
           05  w-aux-cde-zmm-c03          pic  9(02)                  .
           05  w-aux-cde-zmm-c04          pic  9(02)                  .
           05  w-aux-cde-zmm-c05          pic  9(02)                  .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-zmm
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zmm-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-zmm-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-zmm-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-zmm-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-zmm-ope    =    "A+" or
                     w-cod-des-zmm-ope    =    "I+" or
                     w-cod-des-zmm-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-zmm-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice conto merce di default               *
      *                  *---------------------------------------------*
           move      w-cod-des-zmm-cod    to   w-cod-des-zmm-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-zmm-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-zmm-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-zmm-s90    to   v-ufk                  .
           move      w-cod-des-zmm-lin    to   v-lin                  .
           move      w-cod-des-zmm-pos    to   v-pos                  .
           move      w-cod-des-zmm-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-zmm-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zmm-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-zmm-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-zmm-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-zmm-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-zmm-cod    to   w-cod-des-zmm-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-zmm-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-zmm-dln    =    zero or
                     w-cod-des-zmm-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-zmm-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      20                   to   v-car                  .
           move      w-cod-des-zmm-dln    to   v-lin                  .
           move      w-cod-des-zmm-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-zmm-dln    to   v-lin                  .
           move      w-cod-des-zmm-dps    to   v-pos                  .
           move      w-aux-cde-zmm-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-zmm-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-zmm-dup    to   w-aux-cde-zmm-dmx      .
           move      20                   to   w-aux-cde-zmm-c01      .
       aco-680.
           if        w-aux-cde-zmm-c01    >    zero
                     if    w-aux-cde-zmm-dch
                          (w-aux-cde-zmm-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-zmm-dch
                                              (w-aux-cde-zmm-c01)
                           subtract 1     from w-aux-cde-zmm-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-zmm-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-zmm-dup    to   rf-zmm-des-key         .
           move      spaces               to   rf-zmm-cod-ctm         .
           move      "pgm/mag/fls/ioc/obj/iofzmm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-zmm-des-key       >    w-aux-cde-zmm-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-zmm-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-zmm-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              * Codice conto merce              *
      *                              *---------------------------------*
           move      rf-zmm-cod-ctm       to   w-aux-cde-zmm-bco
                                              (w-aux-cde-zmm-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione conto merce         *
      *                              *---------------------------------*
           move      rf-zmm-des-ctm       to   w-aux-cde-zmm-bde
                                              (w-aux-cde-zmm-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-zmm-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-zmm-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-zmm-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      20                   to   s-car                  .
           move      w-aux-cde-zmm-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-zmm-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-zmm-bco
                    (w-aux-cde-zmm-bix)   to   w-cod-des-zmm-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-zmm-crb    to   w-aux-cde-zmm-cpb      .
           subtract  1                    from w-aux-cde-zmm-cpb      .
           divide    6                    into w-aux-cde-zmm-cpb      .
           add       1                    to   w-aux-cde-zmm-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-zmm-c01      .
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      17                   to   v-pos                  .
           move      "     Selezionare il conto merce desiderato     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                              * di indice (w-aux-cde-zmm-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-zmm-c01    to   w-aux-cde-zmm-nli      .
       aco-865.
           if        w-aux-cde-zmm-nli    >    6
                     subtract  6          from w-aux-cde-zmm-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-zmm-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-zmm-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-zmm-c01    <    w-aux-cde-zmm-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-zmm-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-zmm-cpa    <    w-aux-cde-zmm-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-zmm-nli    to   v-lin                  .
           move      24                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-zmm-c01    to   w-aux-cde-zmm-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-zmm-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-zmm-cpa    to   w-aux-cde-zmm-c01      .
           multiply  6                    by   w-aux-cde-zmm-c01      .
           subtract  5                    from w-aux-cde-zmm-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-zmm-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-zmm-c01    to   w-aux-cde-zmm-c02      .
           add       5                    to   w-aux-cde-zmm-c02      .
           divide    6                    into w-aux-cde-zmm-c02      .
           move      w-aux-cde-zmm-c02    to   w-aux-cde-zmm-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-zmm-c02      .
           multiply  6                    by   w-aux-cde-zmm-c02      .
           add       1                    to   w-aux-cde-zmm-c02      .
           add       5
                     w-aux-cde-zmm-c02  giving w-aux-cde-zmm-c03      .
           move      w-aux-cde-zmm-c03    to   w-aux-cde-zmm-c04      .
           if        w-aux-cde-zmm-c03    >    w-aux-cde-zmm-crb
                     move  w-aux-cde-zmm-crb
                                          to   w-aux-cde-zmm-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-zmm-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      03                   to   v-car                  .
           move      w-aux-cde-zmm-c05    to   v-lin                  .
           move      19                   to   v-pos                  .
           move      w-aux-cde-zmm-bco
                    (w-aux-cde-zmm-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      *                                      * Descrizione conto merce *
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-zmm-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-zmm-c02    not  > w-aux-cde-zmm-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-zmm-c02    >    w-aux-cde-zmm-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-zmm-cpa    to   w-aux-cde-zmm-lt1      .
           move      w-aux-cde-zmm-cpb    to   w-aux-cde-zmm-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-zmm-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
