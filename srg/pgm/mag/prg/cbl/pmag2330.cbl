      ...
      *                                   Fase:    mag233              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 08/09/93    *
      *                       Ultima revisione:    NdK del 14/11/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione costo unitario per piu' materie    *
      *                    prime                                       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  GESTIONE COSTO UNITARIO MATERIE PRIME "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   w-cod-zos-dpm-lin      .
           move      30                   to   w-cod-zos-dpm-pos      .
           move      07                   to   w-cod-zos-dpm-dln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.  Cod. mat. prima  Costo standard         Des
      ...
      *              *-------------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.   Cod. mat. prima    Costo ultimo        Des
      -              "crizione materia prima        "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
           perform   vis-des-map-000      thru vis-des-map-999        .
      *              *-------------------------------------------------*
      *              * Unita' di misura                                *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice materia prima alfanumeri- *
      *    *                          co                               *
      *    *-----------------------------------------------------------*
       pmt-cod-map-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice alfanumerico materia prima *
      *    *-----------------------------------------------------------*
       vis-cod-map-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                      *-----------------------------------------*
           move      rf-dpm-des-map       to   w-rig-des-map          .
      *                      *-----------------------------------------*
      *                      * Unita' di misura                        *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-num-map        to   rf-mmv-num-mag         .
           move      "pgm/mag/fls/ioc/obj/iofmmv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/mag/prg/obj/pmag2332"                       .
       cnc-rlt-sup-999.
           exit.
