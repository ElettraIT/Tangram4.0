      ...
      *                                   Fase:    mag110              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/04/09    *
      *                       Ultima revisione:    NdK del 16/07/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa ubicazioni di magazzino              *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase mag110, nella sua globalita', esegue i tipi di stampa  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * UBI110      Stampa ubicazioni Prodotti di vendita     pmag110a *
      *                                                                *
      * UBI120      Stampa ubicazioni Materie Prime           pmag110b *
      *                                                                *
      * UBI130      Stampa ubicazioni Semilavorati            pmag110c *
      *                                                                *
      * UBI140      Stampa ubicazioni Materiali Vari          pmag110d *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     STAMPA UBICAZIONI DI MAGAZZINO     "       .
      ...
      *        *-------------------------------------------------------*
           05  w-prs-arg-dps.
      *            *---------------------------------------------------*
      *            * Si/No area gestionale [dps] attiva                *
      *            * - N : No                                          *
      *            * - S : Si                                          *
      *            *---------------------------------------------------*
               10  w-prs-arg-dps-snx      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Area gestionale [dpm]                                 *
      *        *-------------------------------------------------------*
           05  w-prs-arg-dpm.
      *            *---------------------------------------------------*
      *            * Si/No area gestionale [dpm] attiva                *
      *            * - N : No                                          *
      *            * - S : Si                                          *
      *            *---------------------------------------------------*
               10  w-prs-arg-dpm-snx      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Area gestionale [mtv]                                 *
      *        *-------------------------------------------------------*
           05  w-prs-arg-mtv.
      *            *---------------------------------------------------*
      *            * Si/No area gestionale [mtv] attiva                *
      *            * - N : No                                          *
      *            * - S : Si                                          *
      *            *---------------------------------------------------*
               10  w-prs-arg-mtv-snx      pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'mag110'           *
      *              *-------------------------------------------------*
           perform   fas-mag-110-000      thru fas-mag-110-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-prs-arg-dps-snx
           else      move  spaces         to   w-prs-arg-dps-snx      .
      *              *-------------------------------------------------*
      *              * Normalizzazione personalizzazione               *
      *              *-------------------------------------------------*
           if        w-prs-arg-dps-snx    =    "S" or
                     w-prs-arg-dps-snx    =    "N"
                     go to prs-dps-snx-999.
           move      "N"                  to   w-prs-arg-dps-snx      .
       prs-dps-snx-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-prs-arg-dpm-snx
           else      move  spaces         to   w-prs-arg-dpm-snx      .
      *              *-------------------------------------------------*
      *              * Normalizzazione personalizzazione               *
      *              *-------------------------------------------------*
           if        w-prs-arg-dpm-snx    =    "S" or
                     w-prs-arg-dpm-snx    =    "N"
                     go to prs-dpm-snx-999.
           move      "N"                  to   w-prs-arg-dpm-snx      .
       prs-dpm-snx-999.
           exit.

      *    *===========================================================*
      *    * Lettura personalizzazione : Si/No gestione materiale va-  *
      *    *                             rio attiva                    *
      *    *-----------------------------------------------------------*
       prs-mtv-snx-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-prs-arg-mtv-snx
           else      move  spaces         to   w-prs-arg-mtv-snx      .
      *              *-------------------------------------------------*
      *              * Normalizzazione personalizzazione               *
      *              *-------------------------------------------------*
           if        w-prs-arg-mtv-snx    =    "S" or
                     w-prs-arg-mtv-snx    =    "N"
                     go to prs-mtv-snx-999.
           move      "N"                  to   w-prs-arg-mtv-snx      .
       prs-mtv-snx-999.
           exit.
      ...
      *              *-------------------------------------------------*
       loa-tbl-tin-110.
      *                  *---------------------------------------------*
      *                  * Ubicazioni Prodotti di vendita              *
      *                  *---------------------------------------------*
           move      "Ubicazioni Prodotti di vendita                    
      -              " UBI110     pmag110a  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-120.
      *                  *---------------------------------------------*
      *                  * Ubicazioni Materie prime                    *
      *                  *---------------------------------------------*
           if        w-prs-arg-dpm-snx    not  = "S"
                     go to loa-tbl-tin-130.
      *
           move      "Ubicazioni Materie prime                          
      -              " UBI120     pmag110b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-130.
      *                  *---------------------------------------------*
      *                  * Ubicazioni Semilavorati                     *
      *                  *---------------------------------------------*
           if        w-prs-arg-dps-snx    not  = "S"
                     go to loa-tbl-tin-140.
      *
           move      "Ubicazioni Semilavorati                           
      -              " UBI130     pmag110c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-140.
      *                  *---------------------------------------------*
      *                  * Ubicazioni Materiali Vari                   *
      *                  *---------------------------------------------*
           if        w-prs-arg-mtv-snx    not  = "S"
                     go to loa-tbl-tin-200.
      *
           move      "Ubicazioni Materiali Vari                         
      -              " UBI130     pmag110d  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-200.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-mag-110-300
           else if   v-key                =    "PRSC"
                     go to fas-mag-110-400
           else if   v-key                =    "NXSC"
                     go to fas-mag-110-450
           else if   v-key                =    "DOWN"
                     go to fas-mag-110-500
           else if   v-key                =    "EXIT"
                     go to fas-mag-110-250
           else      go to fas-mag-110-200.
       fas-mag-110-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-mag-110-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-mag-110-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-mag-110-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-mag-110-350
           else      go to fas-mag-110-322.
       fas-mag-110-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-mag-110-630
           else if   v-key                =    "PRSC"
                     go to fas-mag-110-600
           else if   v-key                =    "NXSC"
                     go to fas-mag-110-610
           else if   v-key                =    "UP  "
                     go to fas-mag-110-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-mag-110-650
           else if   v-key                =    "EXIT"
                     go to fas-mag-110-660
           else      go to fas-mag-110-570.
       fas-mag-110-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-mag-110-626
           else      go to fas-mag-110-628.
       fas-mag-110-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-mag-110-636
           else      go to fas-mag-110-638.
       fas-mag-110-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-mag-110-725
           else      go to fas-mag-110-750.
       fas-mag-110-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
