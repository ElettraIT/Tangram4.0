      ...
      *                                   Fase:    mag301              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 21/11/97    *
      *                       Ultima revisione:    NdK del 27/08/01    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Ricerca movimenti intestati ad un agente    *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      "A"                  to   rf-mmt-tip-arc         .
           move      rr-cod-age           to   rf-mmt-cod-arc         .
      ...
      *                  * Su codice agente                            *
      *                  *---------------------------------------------*
           if        rf-mmt-tip-arc       not  = "A"
                     go to qry-let-seq-900.
           if        rf-mmt-cod-arc       not  = rr-cod-age
                     go to qry-let-seq-900.
       qry-let-seq-210.
      *                  *---------------------------------------------*
