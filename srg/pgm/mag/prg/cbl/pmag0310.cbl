      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella causali di magazzino *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE TABELLA CAUSALI MAGAZZINO"       .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      14                   to   v-pos                  .
           move      rf-zmc-cod-cau       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Segnale di trattamento valore di fine eser- *
      *                  * cizio                                       *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      22                   to   v-pos                  .
           move      rf-zmc-des-cau       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zmc-cod-cau       to   w-mpn-cod-cau          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      14                   to   v-pos                  .
           move      "Codice            Descrizione           Mnem.  TM 
      -              " C/M"               to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
