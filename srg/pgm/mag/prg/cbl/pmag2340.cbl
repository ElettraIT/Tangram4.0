      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione costo unitario per piu' materiali  *
      *                    vari                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " GESTIONE COSTO UNITARIO MATERIALI VARI "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           ...
           05  w-rig-num-mtv              pic  9(07)                  .
           05  w-rig-alf-mtv              pic  x(14)                  .
           05  w-rig-des-mtv              pic  x(40)                  .
           05  w-rig-umi-gst              pic  x(03)                  .
      ...
      *                *-----------------------------------------------*
                   15  filler             pic  x(03)                  .
                   15  w-lin-imm-alf-mtv  pic  x(14)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-att-cos  pic  x(14)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-des-mtv  pic  x(40)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   w-cod-zos-mtv-lin      .
           move      30                   to   w-cod-zos-mtv-pos      .
           move      07                   to   w-cod-zos-mtv-dln      .
      ...
      *                      *-----------------------------------------*
           perform   vis-tip-cos-000      thru vis-tip-cos-999        .
           perform   vis-dat-val-000      thru vis-dat-val-999        .
           perform   vis-fso-mtv-000      thru vis-fso-mtv-999        .
      ...
      *                  *---------------------------------------------*
      *                  * Accettazione Codice materia varia           *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       vis-lin-cor-440.
      *                  *---------------------------------------------*
      *                  * Editing Codice materia varia                *
      *                  *---------------------------------------------*
           move      w-rig-alf-mtv        to   w-lin-imm-alf-mtv      .
       vis-lin-cor-460.
      *                  *---------------------------------------------*
      ...
      *                  * Editing Descrizione                         *
      *                  *---------------------------------------------*
           move      w-rig-des-mtv        to   w-lin-imm-des-mtv      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.  Cod. mat. vario  Costo standard        Desc
      -              "rizione materiale vario       "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.  Cod. mat. vario   Costo ultimo         Desc
      -              "rizione materiale vario       "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
           perform   vis-des-mtv-000      thru vis-des-mtv-999        .
      *              *-------------------------------------------------*
      *              * Unita' di misura                                *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice materia varia alfanumeri- *
      *    *                          co                               *
      *    *-----------------------------------------------------------*
       pmt-cod-mtv-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione 1. campo riga corpo espansa : Codice materia *
      *    *                                            prima alfanu-  *
      *    *                                            merico         *
      *    *-----------------------------------------------------------*
       acc-cod-mtv-000.
      ...
      *                  *---------------------------------------------*
           move      w-rig-alf-mtv        to   w-sav-alf-mtv          .
       acc-cod-mtv-100.
      *              *-------------------------------------------------*
      *              * Ripristino valore precedente                    *
      *              *-------------------------------------------------*
           move      w-sav-alf-mtv        to   w-rig-alf-mtv          .
       acc-cod-mtv-125.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-num-mtv        to   w-cod-cod-mtv-num      .
           move      w-rig-alf-mtv        to   w-cod-cod-mtv-alf      .
           move      19                   to   w-cod-cod-mtv-lin      .
           move      21                   to   w-cod-cod-mtv-pos      .
      ...
      *                  *---------------------------------------------*
       ...
       acc-cod-mtv-152.
           ...
           if        w-cod-cod-mtv-ope    =    "F+"
                     go to acc-cod-mtv-154.
           if        w-cod-cod-mtv-ope    =    "AC"
                     go to acc-cod-mtv-156.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-mtv-154.
           perform   cod-cod-mtv-foi-000  thru cod-cod-mtv-foi-999    .
           go to     acc-cod-mtv-152.
       acc-cod-mtv-156.
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice alfanumerico materia varia *
      *    *-----------------------------------------------------------*
       vis-cod-mtv-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione materia varia         *
      *    *-----------------------------------------------------------*
       vis-des-mtv-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-num-mtv          .
           move      spaces               to   w-rig-alf-mtv          .
           move      spaces               to   w-rig-des-mtv          .
           move      spaces               to   w-rig-umi-gst          .
      ...
      *                      *-----------------------------------------*
      *                      * Codice numerico materia varia           *
      *                      *-----------------------------------------*
           move      rf-mtv-num-mtv       to   w-rig-num-mtv          .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico materia varia       *
      *                      *-----------------------------------------*
           move      rf-mtv-alf-mtv       to   w-rig-alf-mtv          .
      *                      *-----------------------------------------*
      *                      * Descrizione in lingua italiana          *
      *                      *-----------------------------------------*
           move      rf-mtv-des-mtv       to   w-rig-des-mtv          .
      *                      *-----------------------------------------*
      *                      * Unita' di misura                        *
      *                      *-----------------------------------------*
           move      rf-mtv-umi-gst       to   w-rig-umi-gst          .
       car-fil-rap-500.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-num-mtv        to   rf-mmv-num-mag         .
           move      "pgm/mag/fls/ioc/obj/iofmmv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/mag/prg/obj/pmag2342"                       .
       cnc-rlt-sup-999.
           exit.
