      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella conti merce          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   INTERROGAZIONE TABELLA CONTI MERCE   "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      34                   to   v-pos                  .
           move      rf-zmm-des-ctm       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zmm-cod-ctm       to   w-mpn-cod-ctm          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-ctm'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
