      ...
      *                       Ultima revisione:    NdK del 20/10/11    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Manutenzione singolo scaglione prodotto     *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "  SINGOLO SCAGLIONE L.I.F.O. PRODOTTO   "       .
      ...
      *            *---------------------------------------------------*
               10  w-cnt-cor-nrg-dac      pic  9(06)                  .
      *            *---------------------------------------------------*
      *            * Numero riga da visualizzare                       *
      *            *---------------------------------------------------*
               10  w-cnt-cor-nrg-dav      pic  9(06)                  .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               ...
               10  w-tes-ann-scg          pic  9(03)                  .
               10  w-tes-inx-scg          pic  9(02)                  .
               10  w-tes-per-rtr          pic s9(04)v9(02)            .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-rim-pre          pic s9(08)v9(03)            .
               10  w-rig-ump-pre          pic  9(11)                  .
               10  w-rig-vnb-pre          pic  9(11)                  .
               10  w-rig-fdr-pre          pic  x(01)                  .
           05  w-rig-002.
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-vnb-pre  pic  x(14)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-fdr-pre  pic  x(01)                  .
      ...
      *    *===========================================================*
      *    * Work-area per selezioni sul record [mmv]                  *
      *    *-----------------------------------------------------------*
       01  w-sel-rec-mmv.
      *        *-------------------------------------------------------*
      *        * Flag di selezione superata                            *
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      spaces               to   v-edm                  .
           move      w-tes-ann-scg        to   v-num                  .
           add       1900                 to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-acc-ann-est-ed2      .
      *                  *---------------------------------------------*
      *                  * Assemblaggio                                *
      *                  *---------------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      04                   to   w-all-str-num          .
           move      "SCAGLIONE L.I.F.O. ESERCIZIO"
                                          to   w-all-str-cat (1)      .
           move      w-acc-ann-est-ed1    to   w-all-str-cat (2)      .
           move      "-"                  to   w-all-str-cat (3)      .
           move      w-acc-ann-est-ed2    to   w-all-str-cat (4)      .
      ...
      *                  * Anno scaglione                              *
      *                  *---------------------------------------------*
           perform   acc-ann-scg-000      thru acc-ann-scg-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *                  * % ritaratura                                *
      *                  *---------------------------------------------*
           perform   acc-per-rtr-000      thru acc-per-rtr-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Anno scaglione                                  *
      *              *-------------------------------------------------*
           perform   vis-ann-scg-000      thru vis-ann-scg-999        .
      *              *-------------------------------------------------*
      *              * % ritaratura                                    *
      *              *-------------------------------------------------*
           perform   vis-per-rtr-000      thru vis-per-rtr-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Anno scaglione                              *
      *                  *---------------------------------------------*
           perform   pmt-ann-scg-000      thru pmt-ann-scg-999        .
      *                  *---------------------------------------------*
      *                  * % ritaratura                                *
      *                  *---------------------------------------------*
           perform   pmt-per-rtr-000      thru pmt-per-rtr-999        .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Anno scaglione                   *
      *    *-----------------------------------------------------------*
       pmt-ann-scg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : % ritaratura                     *
      *    *-----------------------------------------------------------*
       pmt-per-rtr-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Percentuale di ritaratura  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *              * Preparazione campo di accettazione              *
      *              *-------------------------------------------------*
           move      w-tes-ann-scg        to   w-acc-ann-est-ann      .
           if        w-acc-ann-est-ann    =    zero
                     go to acc-ann-scg-120.
           add       1900                 to   w-acc-ann-est-ann      .
       acc-ann-scg-120.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "UP  "
                     go to acc-ann-scg-800
           else      go to acc-ann-scg-100.
       acc-ann-scg-420.
      *                  *---------------------------------------------*
      *                  * Anno inferiore al 1911 : non accettabile    *
      *                  *---------------------------------------------*
           if        w-acc-ann-est-ann    >    1911
                     go to acc-ann-scg-450.
      *                      *-----------------------------------------*
      *                      * Preparazione messaggio di errore        *
      *                      *-----------------------------------------*
           move      "Anno scaglione non accettabile !           "
                                          to   w-err-box-err-msg      .
      *                      *-----------------------------------------*
      *                      * Box di errore                           *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           subtract  1900                 from w-acc-ann-est-ann
                                        giving w-tes-ann-scg          .
           if        w-tes-ann-scg        <    w-tes-ann-ese
                     go to acc-ann-scg-600.
      *                      *-----------------------------------------*
      *                      * Preparazione messaggio di errore        *
      *                      *-----------------------------------------*
           move      "Anno scaglione non accettabile !           "
      ...
      *                  *---------------------------------------------*
           subtract  1900                 from w-acc-ann-est-ann      .
           move      w-acc-ann-est-ann    to   w-tes-ann-scg          .
       acc-ann-scg-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-per-rtr-999.
       acc-per-rtr-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-per-rtr          .
       acc-per-rtr-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : % ritaratura                      *
      *    *-----------------------------------------------------------*
       vis-per-rtr-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "GD"                 to   v-edm                  .
           move      w-rig-vnb-pre        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * In campo per la visualizzazione         *
      *                      *-----------------------------------------*
           move      v-edt                to   w-lin-imm-vnb-pre      .
       vis-lin-cor-520.
      *                  *---------------------------------------------*
      *                  * Flag di rivalutazione                       *
      *                  *---------------------------------------------*
           move      w-rig-fdr-pre        to   w-lin-imm-fdr-pre      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              * Costo medio ponderato                           *
      *              *-------------------------------------------------*
           perform   pmt-ump-pre-000      thru pmt-ump-pre-999        .
      *              *-------------------------------------------------*
      *              * Rimanenza                                       *
      *              *-------------------------------------------------*
           perform   pmt-rim-pre-000      thru pmt-rim-pre-999        .
      *              *-------------------------------------------------*
      *              * Valore normale bene                             *
      *              *-------------------------------------------------*
           perform   pmt-vnb-pre-000      thru pmt-vnb-pre-999        .
      *              *-------------------------------------------------*
      *              * Flag di rivalutazione                           *
      *              *-------------------------------------------------*
           perform   pmt-fdr-pre-000      thru pmt-fdr-pre-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Costo medio ponderato            *
      *    *-----------------------------------------------------------*
       pmt-ump-pre-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Rimanenza                        *
      *    *-----------------------------------------------------------*
       pmt-rim-pre-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Valore normale bene              *
      *    *-----------------------------------------------------------*
       pmt-vnb-pre-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Flag di rivalutazione            *
      *    *-----------------------------------------------------------*
       pmt-fdr-pre-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Rimanenza                         *
      *    *-----------------------------------------------------------*
       vis-rim-pre-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Costo medio ponderato                *
      *    *-----------------------------------------------------------*
       acc-ump-pre-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Costo medio ponderato             *
      *    *-----------------------------------------------------------*
       vis-ump-pre-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Valore normale bene                  *
      *    *-----------------------------------------------------------*
       acc-vnb-pre-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Valore normale bene               *
      *    *-----------------------------------------------------------*
       vis-vnb-pre-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Flag di rivalutazione                *
      *    *-----------------------------------------------------------*
       acc-fdr-pre-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Flag di rivalutazione             *
      *    *-----------------------------------------------------------*
       vis-fdr-pre-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       cnt-tdo-key-100.
      *              *-------------------------------------------------*
      *              * Test su anno scaglione                          *
      *              *-------------------------------------------------*
           if        w-tes-ann-scg        not  = zero
                     go to cnt-tdo-key-200.
           move      "Manca l'anno per lo scaglione !                   
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-key-900.
       cnt-tdo-key-200.
      *              *-------------------------------------------------*
      *              * Determinazione indice di scaglione              *
      *              *-------------------------------------------------*
           subtract  w-tes-ann-scg        from w-tes-ann-ese
                                        giving w-tes-inx-scg          .
       cnt-tdo-key-300.
      *              *-------------------------------------------------*
      *              * Test su indice di scaglione                     *
      *              *-------------------------------------------------*
           if        w-tes-inx-scg        >    zero and
                     w-tes-inx-scg        <    11
                     go to cnt-tdo-key-800.
           move      "Anno per lo scaglione fuori L.I.F.O !             
      -              "               "    to   w-err-box-err-msg      .
           go to     cnt-tdo-key-900.
       cnt-tdo-key-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tes-ann-ese          .
           move      zero                 to   w-tes-ann-scg          .
           move      zero                 to   w-tes-inx-scg          .
           move      zero                 to   w-tes-per-rtr          .
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-rim-pre          .
           move      zero                 to   w-rig-ump-pre          .
           move      zero                 to   w-rig-vnb-pre          .
           move      spaces               to   w-rig-fdr-pre          .
       nor-nok-rig-999.
           exit.
      ...
      *              *-------------------------------------------------*
           perform   sel-rec-mmv-000      thru sel-rec-mmv-999        .
      *                  *---------------------------------------------*
      *                  * Test su flag di selezione                   *
      *                  *---------------------------------------------*
           if        w-sel-rec-mmv-flg    not  = spaces
                     go to car-fil-rap-200.
       car-fil-rap-500.
      *              *-------------------------------------------------*
      ...
      *              * Normalizzazione flag di selezione               *
      *              *-------------------------------------------------*
           move      spaces               to   w-sel-rec-mmv-flg      .
      *              *-------------------------------------------------*
      *              * Normalizzazione [mmv]                           *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-mmv                 .
           if        f-sts                not  = e-not-err
                     go to sel-rec-mmv-900.
       sel-rec-mmv-800.
      *              *-------------------------------------------------*
      *              * Uscita per selezione superata                   *
      *              *-------------------------------------------------*
           go to     sel-rec-mmv-999.
       sel-rec-mmv-900.
      *              *-------------------------------------------------*
      *              * Se selezione non superata                       *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-mmv-ump-pre
                    (w-tes-inx-scg)       to   w-rig-ump-pre          .
           move      rf-mmv-rim-pre
                    (w-tes-inx-scg)       to   w-rig-rim-pre          .
           move      rf-mmv-vnb-pre
                    (w-tes-inx-scg)       to   w-rig-vnb-pre          .
           move      rf-mmv-fdr-pre
                    (w-tes-inx-scg)       to   w-rig-fdr-pre          .
       car-eff-rig-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-per-rtr        =    zero
                     go to car-eff-rig-sos-900.
      *              *-------------------------------------------------*
      *              * Determinazione                                  *
      *              *-------------------------------------------------*
           move      w-rig-ump-pre        to   w-rig-vnb-pre          .
           move      w-rig-ump-pre        to   w-det-val-ric-val      .
           move      w-tes-per-rtr        to   w-det-val-ric-per      .
           perform   det-val-ric-000      thru det-val-ric-999        .
           add       w-det-val-ric-tot    to   w-rig-vnb-pre          .
       car-eff-rig-sos-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      24                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "               --- Aggiornamento schede L.I.F.O in
      -              " esecuzione ---               "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           move      w-rig-ump-pre        to   rf-mmv-ump-pre
                                              (w-tes-inx-scg)         .
           move      w-rig-vnb-pre        to   rf-mmv-vnb-pre
                                              (w-tes-inx-scg)         .
           move      w-rig-fdr-pre        to   rf-mmv-fdr-pre
                                              (w-tes-inx-scg)         .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-ann-ese        to   rf-mmv-ann-ese         .
           move      01                   to   rf-mmv-tip-mag         .
           move      w-rig-num-pro        to   rf-mmv-num-mag         .
           move      "pgm/mag/fls/ioc/obj/iofmmv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   v-lin                  .
           move      17                   to   v-pos                  .
           move      "quello gestibile dal programma (99.999).        "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
