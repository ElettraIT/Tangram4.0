      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pmag4150 *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/mag/sit/mag415[num-inl]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-mau-tip-ubi       not  = rr-tip-ubi
                     go to stp-srt-inp-200.
       prn-tst-max-410.
      *                  *---------------------------------------------*
      *                  * Test su parametro ubicazione 1              *
      *                  *---------------------------------------------*
           if        rf-mau-prm-ubi (1)   <    rr-prm-min (1) or
                     rf-mau-prm-ubi (1)   >    rr-prm-max (1)
                     go to stp-srt-inp-200.
       prn-tst-max-420.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tip-ubi-pdu       not  > 1
                     go to stp-srt-inp-500.
           if        rf-mau-prm-ubi (2)   <    rr-prm-min (2) or
                     rf-mau-prm-ubi (2)   >    rr-prm-max (2)
                     go to stp-srt-inp-200.
       prn-tst-max-430.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tip-ubi-pdu       not  > 2
                     go to stp-srt-inp-500.
           if        rf-mau-prm-ubi (3)   <    rr-prm-min (3) or
                     rf-mau-prm-ubi (3)   >    rr-prm-max (3)
                     go to stp-srt-inp-200.
       prn-tst-max-440.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tip-ubi-pdu       not  > 3
                     go to stp-srt-inp-500.
           if        rf-mau-prm-ubi (4)   <    rr-prm-min (4) or
                     rf-mau-prm-ubi (4)   >    rr-prm-max (4)
                     go to stp-srt-inp-200.
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      *              * Altri test                                      *
      ...
      *                      *-----------------------------------------*
           ...
           if        rf-mau-prm-ubi (2)   =    spaces
                     move  spaces         to   w-all-str-cat (2)
           else      move  ":"            to   w-all-str-cat (2)      .
           move      rf-mau-prm-ubi (2)   to   w-all-str-cat (3)      .
           if        rf-mau-prm-ubi (3)   =    spaces
                     move  spaces         to   w-all-str-cat (4)
           else      move  ":"            to   w-all-str-cat (4)      .
           move      rf-mau-prm-ubi (3)   to   w-all-str-cat (5)      .
           if        rf-mau-prm-ubi (4)   =    spaces
                     move  spaces         to   w-all-str-cat (6)
           else      move  ":"            to   w-all-str-cat (6)      .
           move      rf-mau-prm-ubi (4)   to   w-all-str-cat (7)      .
