      ...
      *                       Ultima revisione:    NdK del 18/12/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma mag304   *
      *                                                                *
      ...
      *                  * mento non trovata : selezione non superata  *
      *                  *---------------------------------------------*
           if        w-let-arc-zmc-flg    not  = spaces
                     go to prn-let-seq-200.
      *                  *---------------------------------------------*
      *                  * Se causale di magazzino che non richiede un *
      *                  * valore : selezione non superata             *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se causale di magazzino richiesta pa-   *
      *                      * ri a zero : selezione superata          *
      *                      *-----------------------------------------*
           if        rr-cau-mag           =    zero
      ...
      *              *-------------------------------------------------*
           if        rf-mmr-dat-reg       not  = rf-mmt-dat-reg or
                     ...
                     go to prn-let-seq-200.
      *              *-------------------------------------------------*
      *              * Selezione sul valore globale movimento          *
      *              *-------------------------------------------------*
