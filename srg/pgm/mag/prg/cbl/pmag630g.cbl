      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pmag6300 *
      *                                                                *
      *                    Prospetto rilevazioni materiali vari        *
      *                                                                *
      *================================================================*
      ...
      *        * - 01 : Per classe, gruppo, sottogruppo, codice magaz- *
      *        *        zino                                           *
      ...
      *    *-----------------------------------------------------------*
       01  w-prn-liv-det.
           ...
           05  w-prn-liv-det-wpd          pic s9(08)v9(03)            .
      ...
      *                      *-----------------------------------------*
      *                      * Test su elementi da stampare            *
      *                      *-----------------------------------------*
           if        rr-elm-das           =    01
                     go to prn-let-seq-999
           else if   rr-elm-das           =    02
                     if    rf-mim-flg-ril =    spaces
                           go to prn-let-seq-400
                     else  go to prn-let-seq-999
           else if   rr-elm-das           =    03
                     if    rf-mim-flg-ril not  = spaces
                           go to prn-let-seq-400
                     else  go to prn-let-seq-999                      .
       prn-let-seq-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-mim-dec-qta       to   p-dec                  .
           move      "S"                  to   p-sgn                  .
           if        rf-mim-qta-rlv       =    zero
                     move  "GD"           to   p-edm
           else      move  "G"            to   p-edm                  .
           move      p-lnr                to   p-lin                  .
           move      079                  to   p-pos                  .
           move      rf-mim-qta-rlv       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-210.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-mim-dec-qta       to   p-dec                  .
           move      "S"                  to   p-sgn                  .
           if        w-prn-liv-det-wpd    =    zero
                     move  "GD"           to   p-edm
           else      move  "G"            to   p-edm                  .
           move      p-lnr                to   p-lin                  .
           move      095                  to   p-pos                  .
           move      w-prn-liv-det-wpd    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-220.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-elm-das           =    01 or
                     rr-elm-das           =    02
                     move  "PROSPETTO DELLE RILEVAZIONE INVENTARIALI ESE
      -                    "GUITE PER I MATERIALI VARI"
                                          to   w-cnt-tit-des-tit
           else      move  "PROSPETTO DELLE RILEVAZIONE INVENTARIALI DA 
      -                    "ESEGUIRE PER I MATERIALI VARI"
                                          to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
      ...
      -              "        Udm  Q.ta' presunta  Q.ta' rilevata    Dif
      -              "ferenza            Note         "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
