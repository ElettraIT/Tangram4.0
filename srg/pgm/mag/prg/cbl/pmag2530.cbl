      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag2531:        *
      *                                                                *
      *                    Stampa costi unitari materie prime          *
      *                                                                *
      *================================================================*
      ...
      *        * - 02 : Costo ultimo                                   *
      *        *-------------------------------------------------------*
           05  rr-tip-cos                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Anno di riferimento                                   *
      *        *-------------------------------------------------------*
           05  rr-ann-rif                 pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Mese di riferimento                                   *
      *        *-------------------------------------------------------*
           05  rr-mes-rif                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Si/No solo se costo diverso da zero                   *
      *        * - 01 : Solo materie prime con costo diverso da zero   *
      *        * - 02 : Solo materie prime con costo a zero            *
      *        * - 03 : Tutte le materie prime                         *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-snx-zer.
               ...
               10  w-exp-snx-zer-lun      pic  9(02)       value 45   .
               10  w-exp-snx-zer-tbl.
                   15  filler             pic  x(45)       value
                       "solo materie prime con costo Diverso da zero ".
                   15  filler             pic  x(45)       value
                       "solo materie prime con costo a Zero          ".
                   15  filler             pic  x(45)       value
      ...
      *                  * Anno di riferimento                         *
      *                  *---------------------------------------------*
           perform   acc-ann-rif-000      thru acc-ann-rif-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Mese di riferimento                         *
      *                  *---------------------------------------------*
           perform   acc-mes-rif-000      thru acc-mes-rif-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-500.
      *                  *---------------------------------------------*
      *                  * Si/no solo se valore diverso da zero        *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Anno di riferimento costo  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Mese di riferimento costo  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *                  * Tipo di costo                               *
      *                  *---------------------------------------------*
           move      01                   to   rr-tip-cos             .
           perform   vis-tip-cos-000      thru vis-tip-cos-999        .
      *                  *---------------------------------------------*
      *                  * Anno di riferimento                         *
      *                  *---------------------------------------------*
           move      w-gen-dat-att        to   s-dat                  .
           move      s-saa                to   rr-ann-rif             .
           perform   vis-ann-rif-000      thru vis-ann-rif-999        .
      *                  *---------------------------------------------*
      *                  * Mese di riferimento                         *
      *                  *---------------------------------------------*
           move      w-gen-dat-att        to   s-dat                  .
           move      s-mes                to   rr-mes-rif             .
           perform   vis-mes-rif-000      thru vis-mes-rif-999        .
      *                  *---------------------------------------------*
      *                  * Tipo salto pagina                           *
      *                  *---------------------------------------------*
      ...
      *                  * sia in Up                                   *
      *                  *---------------------------------------------*
           if        rr-tip-cos           not  = zero
                     go to acc-tip-cos-600.
           if        v-key                =    "UP  "
                     go to acc-tip-cos-600
           else      go to acc-tip-cos-999.
       acc-tip-cos-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-ann-rif-999.
       acc-ann-rif-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-ann-rif             .
       acc-ann-rif-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        rr-ann-rif           not  = zero
                     go to acc-ann-rif-500.
           if        v-key                =    "UP  "
                     go to acc-ann-rif-600
           else      go to acc-ann-rif-100.
       acc-ann-rif-500.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   vis-ann-rif-ext-000  thru vis-ann-rif-ext-999    .
       acc-ann-rif-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-mes-rif-999.
       acc-mes-rif-300.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-mes-rif             .
       acc-mes-rif-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              * Test se zero                                    *
      *              *-------------------------------------------------*
           if        rr-mes-rif           not  = zero
                     go to vis-mes-rif-200.
       vis-mes-rif-100.
      *              *-------------------------------------------------*
      *              * Literal 'Tutti'                                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-cod-zos-dpm-lin      .
           move      30                   to   w-cod-zos-dpm-pos      .
           move      11                   to   w-cod-zos-dpm-dln      .
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           move      zero                 to   rr-tip-cos             .
           move      zero                 to   rr-ann-rif             .
           move      zero                 to   rr-mes-rif             .
