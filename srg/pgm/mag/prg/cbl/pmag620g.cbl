      ...
      *                                                                *
      *                    Rilevazione giacenza fisica materiali vari  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               ...
               10  w-tes-fso-mtv          pic  9(08)                  .
               10  w-tes-fso-mtv-alf redefines
                   w-tes-fso-mtv          pic  x(08)                  .
               10  w-tes-fso-mtv-des      pic  x(40)                  .
               10  w-tes-fso-mtv-ord      pic  9(02)                  .
      ...
      *                  * per file [mtv]                              *
      *                  *---------------------------------------------*
           perform   pmt-fso-mtv-000      thru pmt-fso-mtv-999        .
       pmt-key-reg-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-fso-mtv        to   w-cod-zos-mtv-cod      .
      ...
      *                  * mento per file [mtv]                        *
      *                  *---------------------------------------------*
           move      w-tes-fso-mtv        to   w-let-fso-mtv-cod      .
           perform   let-fso-mtv-000      thru let-fso-mtv-999        .
           move      w-let-fso-mtv-des    to   w-tes-fso-mtv-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione codice filtro di selezione  *
      *                  * per file [mtv], descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-fso-mtv-des-000  thru vis-fso-mtv-des-999    .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "TO"                 to   f-ope                  .
           move      w-tes-fso-mtv-alf    to   f-key                  .
           ...
           call      s-pat               using f
                                               rf-mtv                 .
           if        f-sts                =    "01"
                     move  01             to   w-tes-fso-mtv-ord
           else if   f-sts                =    "02"
                     move  02             to   w-tes-fso-mtv-ord
           else if   f-sts                =    "03"
                     move  03             to   w-tes-fso-mtv-ord
           else if   f-sts                =    "04"
                     move  04             to   w-tes-fso-mtv-ord
           else      move  01             to   w-tes-fso-mtv-ord      .
       acc-fso-mtv-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       vis-fso-mtv-des-000.
           ...
           move      09                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-fso-mtv-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-fso-mtv-des-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-let-arc-mtv-num    to   w-rig-num-mag          .
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           move      zero                 to   w-tes-fso-mtv          .
           move      spaces               to   w-tes-fso-mtv-des      .
           move      zero                 to   w-tes-fso-mtv-ord      .
           move      spaces               to   w-tes-cnf-imp          .
       nor-key-reg-999.
           exit.
      ...
      *                  *---------------------------------------------*
           if        rf-mim-cod-dpz       not  = w-tes-dpz-inu or
                     rf-mim-tip-mag       not  = 04            or
                     rf-mim-num-mag       not  = rf-mtv-num-mtv
                     go to rou-let-reg-100.
      *                  *---------------------------------------------*
...
.       rou-let-reg-230.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-let-arc-mtv-alf    to   rf-mtv-alf-mtv         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-mtv-alf-mtv       not  = w-let-arc-mtv-alf
                     go to let-arc-mtv-400.
       let-arc-mtv-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-mtv-num-mtv       to   w-let-arc-mtv-num      .
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-mtv-600.
           move      zero                 to   w-let-arc-mtv-num      .
