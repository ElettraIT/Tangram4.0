      ...
      *                                                                *
      *                    Ricerca movimenti intestati ad un fornitore *
      *                                                                *
      *================================================================*
      ...
      *                      *-----------------------------------------*
           if        rr-cod-fnt           =    w-sav-cod-fnt or
                     w-sav-cod-fnt        =    zero
      ...
      *              *-------------------------------------------------*
           ...
           else      move  rr-dpz-fnt     to   rf-mmt-dpz-arc         .
      ...
      *                  *---------------------------------------------*
           if        rf-mmt-cod-dpz       not  = rr-dpz-inu
                     go to qry-let-seq-900.
      *                  *---------------------------------------------*
      *                  * Su codice e dipendenza fornitore            *
      *                  *---------------------------------------------*
           ...
           if        rf-mmt-dpz-arc       not  = rr-dpz-fnt
                     go to qry-let-seq-900.
       qry-let-seq-210.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       int-pag-sta-324.
           ...
           string    v-edt      delimited by   spaces
                     "-"        delimited by   size
                     rr-dpz-fnt delimited by   spaces
                                          into v-alf                  .
           go to     int-pag-sta-326.
       int-pag-sta-326.
           move      "PF"                 to   v-ope                  .
