      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag3261:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-arg-snx-mtv.
      *            *---------------------------------------------------*
      *            * Si/No area [mtv] attiva                           *
      *            * - S : Si'                                         *
      *            * - N : No                                          *
      *            *---------------------------------------------------*
               10  w-arg-snx-mtv-snx      pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
      *              * Test se area [mtv] attiva                       *
      *              *-------------------------------------------------*
           perform   arg-mtv-snx-000      thru arg-mtv-snx-999        .
           if        w-arg-snx-mtv-snx    =    "S"
                     go to pre-exe-pgm-100.
           perform   arg-mtv-err-000      thru arg-mtv-err-999        .
      ...
      *              *-------------------------------------------------*
           move      s-alf                to   w-arg-snx-mtv-snx      .
       arg-mtv-snx-999.
           exit.

      *    *===========================================================*
      *    * Errore per area [mtv] non attiva                          *
      *    *-----------------------------------------------------------*
       arg-mtv-err-000.
      *              *-------------------------------------------------*
      *              * Video in Off                                    *
      ...
      *
           ...
           move      11                   to   v-lin                  .
           move      03                   to   v-pos                  .
           move      "             Non e' prevista la gestione dei mater
      -              "iali vari.                "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " finale per ogni materiale  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
