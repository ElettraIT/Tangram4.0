      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione costo unitario per singolo semi-   *
      *                    lavorato                                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-sem                  pic  x(10) value
                     "pmag2120"                                       .
      *        *-------------------------------------------------------*
      *        * Descrizione del programma                             *
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "GESTIONE COSTO UNITARIO PER SEMILAVORATO"       .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice semilavorato           *
      *    *-----------------------------------------------------------*
       pmt-cod-sem-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-alf-mag        to   w-cod-cod-dps-alf      .
      ...
      *                  *---------------------------------------------*
           move      w-tes-num-mag        to   w-let-arc-dps-cod      .
