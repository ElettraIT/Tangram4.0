      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ubicazioni Materie Varie                    *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "    STAMPA UBICAZIONI MATERIALI VARI    "       .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-snx-ubi.
               ...
               10  w-exp-snx-ubi-tbl.
                   ...
                   15  filler             pic  x(40)       value
                            "solo materiali vari con Ubicazione      ".
                   15  filler             pic  x(40)       value
                            "solo materiali vari Senza ubicazione    ".
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna materiale vario da stampare entro i limiti
      -              " assegnati !"       to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Se richiesti tutti le materie varie             *
      *              *-------------------------------------------------*
           if        rr-snx-ubi           =    01
                     go to prn-sel-rec-999.
       prn-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Se richiesti solo le materie varie con ubica-   *
      *              * zione                                           *
      *              *-------------------------------------------------*
           if        rr-snx-ubi           =    03
       ...
       prn-sel-rec-300.
      *              *-------------------------------------------------*
      *              * Se richiesti solo le materie varie senza ubica- *
      *              * zione                                           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "UBICAZIONI DI MAGAZZINO MATERIALI VARI"
