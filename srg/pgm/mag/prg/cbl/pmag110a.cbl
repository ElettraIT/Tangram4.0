      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ubicazioni prodotti di vendita              *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "STAMPA UBICAZIONI DI MAGAZZINO PRODOTTI "       .
      ...
      *        * - 03 : Solo quelli senza ubicazione                   *
      *        *-------------------------------------------------------*
      ...
      *        *                                                       *
      *        * - 01 : Per filtro di selezione                        *
      *        * - 02 : Perp indice di percorso                        *
      *        *-------------------------------------------------------*
           ...
           05  w-exp-snx-ubi.
               ...
               10  w-exp-snx-ubi-tbl.
                   15  filler             pic  x(40)       value
                            "Tutti i prodotti                        ".
                   15  filler             pic  x(40)       value
                            "solo prodotti con Ubicazione            ".
                   15  filler             pic  x(40)       value
                            "solo prodotti Senza ubicazione          ".
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-mau                 .
      *                  *---------------------------------------------*
      *                  * Flag di ubicazione trovata                  *
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     move  "N"            to   w-sel-ubi-snx
           else      move  "S"            to   w-sel-ubi-snx          .
      *                  *---------------------------------------------*
      *                  * Test su selezioni su ubicazioni             *
      *                  *---------------------------------------------*
           if        rr-snx-ubi           =    01
                     go to stp-srt-inp-500.
           if        rr-snx-ubi           =    02 and
                     w-sel-ubi-snx        not  = "S"
                     go to stp-srt-inp-200.
           if        rr-snx-ubi           =    03 and
                     w-sel-ubi-snx        not  = "N"
                     go to stp-srt-inp-200.
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-tip-ord           =    01  or
                     w-sel-ubi-snx        =    "N"
                     move  spaces         to   srt-tip-ubi
                     move  zero           to   srt-key-inx
                     move  spaces         to   srt-prm-ubi (1)
                     move  spaces         to   srt-prm-ubi (2)
                     move  spaces         to   srt-prm-ubi (3)
                     move  spaces         to   srt-prm-ubi (4)
      ...
      *                      * al sort                                 *
      *                      *-----------------------------------------*
           move      zero                 to   srt-num-dop            .
       stp-srt-inp-650.
      *                  *---------------------------------------------*
      *                  * Dati di sort                                *
      *                  *---------------------------------------------*
           move      w-sel-ubi-snx        to   srt-sel-ubi            .
      *                      *-----------------------------------------*
      *                      * Record [mau]                            *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      124                  to   p-pos                  .
           move      rf-mau-inx-per       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * I campi successivi attualmente non si stam- *
      *                  * pano                                        *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "UBICAZIONI DI MAGAZZINO PRODOTTI DI VENDITA"
