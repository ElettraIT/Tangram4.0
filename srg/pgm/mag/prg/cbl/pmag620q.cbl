      ...
      *                                                                *
      *                    Rilevazione giacenza merci presso clienti   *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
           ...
           move      "C"                  to   rf-mim-tip-arc         .
           move      w-tes-cod-cli        to   rf-mim-cod-arc         .
           move      w-tes-dpz-cli        to   rf-mim-dpz-arc         .
      ...
      *              *-------------------------------------------------*
           if        rf-mim-cod-dpz       not  = w-tes-dpz-inu or
                     ...
                     rf-mim-tip-arc       not  = "C"           or
                     rf-mim-cod-arc       not  = w-tes-cod-cli or
                     rf-mim-dpz-arc       not  = w-tes-dpz-cli
                     go to rou-let-reg-300.
      *              *-------------------------------------------------*
