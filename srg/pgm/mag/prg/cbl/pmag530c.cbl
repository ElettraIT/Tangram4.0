      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Situazione semilavorati presso fornitori    *
      *                    per semilavorato                            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  kk0-key.
      *            *---------------------------------------------------*
      *            * Numero progressivo record [dps] letto             *
      *            *---------------------------------------------------*
               10  kk0-ctr-dps            pic  9(08)                  .
      *            *---------------------------------------------------*
      *            * Codice conto merce                                *
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "  LISTA SEMILAVORATI PRESSO FORNITORI   "       .
      ...
      *        *-------------------------------------------------------*
           05  w-rot-l02.
      *            *---------------------------------------------------*
      *            * Contatore records [dps] letti                     *
      *            *---------------------------------------------------*
               10  w-rot-l02-ctr-dps      pic  9(08)                  .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Inizializzazione contatore records [dps] letti  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to cmp-fil-app-999.
      *              *-------------------------------------------------*
      *              * Incremento contatore records [dps] letti        *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       cmp-fil-app-480.
      *              *-------------------------------------------------*
      *              * Riciclo su lettura filtro ordinamento [dps]     *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      02                   to   rf-mmz-tip-mag         .
           move      rf-dps-num-sem       to   rf-mmz-num-mag         .
      ...
      *                  *---------------------------------------------*
           if        rf-mmz-ann-ese       not  = w-cmp-fil-app-wes or
                     ...
                     rf-mmz-tip-mag       not  = 02                or
                     rf-mmz-num-mag       not  = rf-dps-num-sem
                     go to cmp-fil-app-599.
      *                  *---------------------------------------------*
      ...
      *                      * Composizione chiave                     *
      *                      *-----------------------------------------*
           move      w-cmp-fil-app-ctr    to   kk0-ctr-dps            .
      ...
      *                          *-------------------------------------*
           ...
           move      rf-dps-cla-sem       to   kk0-cod-cla            .
           move      rf-dps-gru-sem       to   kk0-cod-gru            .
           move      rf-dps-sgr-sem       to   kk0-cod-sgr            .
           move      02                   to   kk0-tip-mag            .
           move      rf-dps-num-sem       to   kk0-num-mag            .
           move      rf-dps-alf-sem       to   kk0-alf-mag            .
           move      rf-dps-des-sem       to   kk0-des-mag            .
           move      rf-dps-dec-qta       to   kk0-dec-qta            .
           move      "F"                  to   kk0-tip-arc            .
           move      rf-dcf-rag-soc       to   kk0-rag-soc            .
           move      rf-dps-umi-prd       to   kk0-uni-mis            .
      *                      *-----------------------------------------*
      ...
      *              * Contatore records [dps] letti                   *
      *              *-------------------------------------------------*
           move      kk0-ctr-dps          to   w-rot-l02-ctr-dps      .
      *              *-------------------------------------------------*
      *              * Codice conto merce                              *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura dati classe                         *
      *                  *---------------------------------------------*
           move      w-rot-l05-cod-cla    to   w-let-arc-zs1-cla      .
      ...
      *                  * Lettura dati gruppo                         *
      *                  *---------------------------------------------*
           move      w-rot-l05-cod-cla    to   w-let-arc-zs2-cla      .
           move      w-rot-l04-cod-gru    to   w-let-arc-zs2-gru      .
      ...
      *                  *---------------------------------------------*
           move      w-rot-l05-cod-cla    to   w-let-arc-zs3-cla      .
           move      w-rot-l04-cod-gru    to   w-let-arc-zs3-gru      .
           move      w-rot-l03-cod-sgr    to   w-let-arc-zs3-sgr      .
      ...
      *              *-------------------------------------------------*
           ...
           string    "SITUAZIONE SEMILAVORATI PRESSO FORNITORI PER ARTIC
      -              "OLO AL "
                                delimited by   size
