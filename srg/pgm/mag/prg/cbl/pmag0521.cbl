      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma mag052   *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-zub                 .
      *              *-------------------------------------------------*
      *              * Apertura modulo intestazione per dipendenze     *
      *              *-------------------------------------------------*
           move      "pgm/azi/prg/obj/mintdpz0"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           move      "OP"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-zub                 .
      *              *-------------------------------------------------*
      *              * Chiusura modulo intestazione per dipendenze con *
      *              * cancellazione del modulo, se possibile          *
      *              *-------------------------------------------------*
           move      "pgm/azi/prg/obj/mintdpz0"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-dpz           to   rf-zub-cod-dpz         .
           move      rr-cod-min           to   rf-zub-cod-ubi         .
           move      "pgm/mag/fls/ioc/obj/iofzub"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-dpz           to   rf-zub-cod-dpz         .
           move      rr-des-min           to   rf-zub-des-key         .
      ...
      *                      *-----------------------------------------*
       ...
       prn-str-ini-600.
      *              *-------------------------------------------------*
      *              * Se ordinamento per indice di percorso           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Start per descrizione in uppercase          *
      *                  *---------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "INXCOD    "         to   f-key                  .
           move      rr-cod-dpz           to   rf-zub-cod-dpz         .
           move      rr-inx-min           to   rf-zub-inx-per         .
           move      spaces               to   rf-zub-cod-ubi         .
           move      "pgm/mag/fls/ioc/obj/iofzub"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna ubicazione entro i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           if        rf-zub-cod-dpz       not  = rr-cod-dpz
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zub-cod-ubi       <    rr-cod-min or
                     rf-zub-cod-ubi       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zub-des-key       <    rr-des-min or
                     rf-zub-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su indice di percorso                 *
      *              *-------------------------------------------------*
           if        rf-zub-inx-per       <    rr-inx-min or
                     rf-zub-inx-per       >    rr-inx-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "Codice             Descrizione           Indice   
      -              "          Commento           T"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
