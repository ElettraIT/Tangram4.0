      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pmag2540 *
      *                                                                *
      ...
      *        *        materiale vario                                *
      *        * - 03 : Per materiale vario                            *
      *        * - 04 : Per descrizione materiale vario                *
      *        *-------------------------------------------------------*
      ...
      *              *   -  Mese di esercizio                          *
      *              *-------------------------------------------------*
           move      rr-dat-val           to   w-det-aem-ese-dat      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-det-aem-ese-ann    to   rf-mmv-ann-ese         .
      ...
      *                      *-----------------------------------------*
           move      rf-mmv-ust-mns
                     (w-det-aem-ese-mes)  to   w-det-cos-uni-cos      .
           move      rf-mmv-ust-mns
                     (w-det-aem-ese-mes)  to   w-det-cos-uni-cos      .
      *                          *-------------------------------------*
      *                          * A selezioni                         *
      ...
      *                  *---------------------------------------------*
       ...
       prn-sel-rec-510.
      *                  *---------------------------------------------*
      *                  * Solo materiali vari con costo diverso da    *
      *                  * zero                                        *
      *                  *---------------------------------------------*
           if        w-det-cos-uni-cos    =    zero
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      067                  to   p-pos                  .
           move      w-det-cos-uni-cos    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-999.
           exit.
      ...
      *                      * Se costo standard                       *
      *                      *-----------------------------------------*
           string    "COSTO STANDARD UNITARIO PER MATERIALI VARI AL "
                                delimited by   size
      ...
      *                      * Se costo ultimo                         *
      *                      *-----------------------------------------*
           string    "COSTO ULTIMO UNITARIO PER MATERIALI VARI AL "
                                delimited by   size
                     p-edt      delimited by   spaces
                                          into w-cnt-tit-des-tit      .
      *                          *-------------------------------------*
