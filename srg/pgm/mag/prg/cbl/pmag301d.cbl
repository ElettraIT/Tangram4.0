      ...
      *                                                                *
      *                    Ricerca movimenti per data di registrazione *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "RICERCA MOVIMENTI PER DATA REGISTRAZIONE"       .
      ...
      *        *-------------------------------------------------------*
           05  rr-cod-cau-trv             pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Selezione sul valore del movimento                    *
      *        * - 01 : Tutti i movimenti                              *
      *        * - 02 : Solo i movimenti mancanti del valore           *
      *        *                                                       *
      *        * N.B. : Impostazione richiesta solamente se causale di *
      *        *        magazzino diversa da zero, e che prevede una   *
      *        *        impostazione del valore                        *
      *        *-------------------------------------------------------*
           05  rr-sel-val                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Si/no righe espanse                                   *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Selezione sul valore del movimento         *
      *        *-------------------------------------------------------*
           05  w-exp-sel-val.
               10  w-exp-sel-val-num      pic  9(02)       value 2    .
               10  w-exp-sel-val-lun      pic  9(02)       value 40   .
               10  w-exp-sel-val-tbl.
                   15  filler             pic  x(40) value
                            "Tutti i movimenti                       ".
                   15  filler             pic  x(40) value
                            "Solo i movimenti che mancano del valore ".
      *        *-------------------------------------------------------*
      ...
      *                  * Selezione sul valore del movimento          *
      *                  *---------------------------------------------*
           perform   acc-sel-val-000      thru acc-sel-val-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
      *              * Prompt per la selezione sul valore del movimen- *
      *              * to                                              *
      *              *-------------------------------------------------*
           perform   pmt-sel-val-000      thru pmt-sel-val-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione selezione sul valore del movi-  *
      *              * mento                                           *
      *              *-------------------------------------------------*
           perform   vis-sel-val-000      thru vis-sel-val-999        .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt per la selezione sul valore del movimento          *
      *    *-----------------------------------------------------------*
       pmt-sel-val-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      08                   to   w-cod-mne-zmc-lin      .
           move      30                   to   w-cod-mne-zmc-pos      .
           move      08                   to   w-cod-mne-zmc-dln      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-let-arc-zmc-trv    to   rr-cod-cau-trv         .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       acc-cod-cau-625.
      *                  *---------------------------------------------*
      *                  * Se codice causale pari a zero : normalizza- *
      *                  * zione e visualizzazione del campo di sele-  *
      *                  * zione sul valore del movimento              *
      *                  *---------------------------------------------*
           if        rr-cod-cau           =    zero
                     go to acc-cod-cau-650.
      *                  *---------------------------------------------*
      *                  * Se causale che non interessa il valore del  *
      *                  * movimento : normalizzazione e visualizza-   *
      *                  * zione del campo di selezione sul valore del *
      *                  * movimento                                   *
      *                  *---------------------------------------------*
           if        rr-cod-cau-trv       not  = "I" and
                     rr-cod-cau-trv       not  = "C" and
                     rr-cod-cau-trv       not  = "X" and
                     rr-cod-cau-trv       not  = "R" and
                     rr-cod-cau-trv       not  = "Y"
                     go to acc-cod-cau-650.
      *                  *---------------------------------------------*
      *                  * Altrimenti : a controllo tasto Do           *
      *                  *---------------------------------------------*
           go to     acc-cod-cau-800.
       acc-cod-cau-650.
      *                  *---------------------------------------------*
      *                  * Normalizzazione e visualizzazione del campo *
      *                  * di selezione sul valore del movimento       *
      *                  *---------------------------------------------*
           move      zero                 to   rr-sel-val             .
           perform   vis-sel-val-000      thru vis-sel-val-999        .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Selezione sul valore del movimento         *
      *    *-----------------------------------------------------------*
       acc-sel-val-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se codice causale pari a zero : no ac-  *
      *                      * cettazione                              *
      *                      *-----------------------------------------*
           if        rr-cod-cau           =    zero
                     go to acc-sel-val-999.
      *                      *-----------------------------------------*
      *                      * Se causale che non interessa il valore  *
      *                      * del movimento : no accettazione         *
      *                      *-----------------------------------------*
           if        rr-cod-cau-trv       not  = "I" and
                     rr-cod-cau-trv       not  = "C" and
                     rr-cod-cau-trv       not  = "X" and
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-val-lun    to   v-car                  .
           move      w-exp-sel-val-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      15                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-sel-val-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      rr-sel-val           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-sel-val-100.
       acc-sel-val-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Selezione sul valore del movimento      *
      *    *-----------------------------------------------------------*
       vis-sel-val-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      ...
      -              "ma             "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Normalizzazione selezione sul valore            *
      *              *-------------------------------------------------*
           if        rr-sel-val           not  = 01 and
                     rr-sel-val           not  = 02
                     move  zero           to   rr-sel-val             .
       tdo-ric-sel-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Codice causale da ricercare, tipo tratta-   *
      *                  * mento del valore                            *
      *                  *---------------------------------------------*
           move      spaces               to   rr-cod-cau-trv         .
      *                  *---------------------------------------------*
      *                  * Selezione sul valore del movimento          *
      *                  *---------------------------------------------*
           move      zero                 to   rr-sel-val             .
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Test se minima a zero               *
      *                          *-------------------------------------*
           if        rr-drg-min           =    zero
                     go to qry-let-seq-260.
      *                          *-------------------------------------*
      *                          * Se minima non a zero, si pone come  *
      *                          * massima                             *
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
       qry-let-seq-265.
      *                  *---------------------------------------------*
      *                  * Se causale di magazzino richiesta diversa   *
      *                  * da zero e codice causale del movimento di-  *
      *                  * versa da quella richiesta : selezione non   *
      *                  * superata                                    *
      *                  *---------------------------------------------*
           if        rr-cod-cau           not  = zero   and
                     rf-mmt-cod-cau       not  = rr-cod-cau
                     go to qry-let-seq-200.
       qry-let-seq-270.
      *                  *---------------------------------------------*
      *                  * Lettura causale di magazzino relativa al    *
      *                  * movimento                                   *
      *                  *---------------------------------------------*
       ...
       qry-let-seq-275.
      *                  *---------------------------------------------*
      *                  * Se causale di magazzino relativa al movi-   *
      *                  * mento non trovata e selezione sul valore    *
      *                  * attiva : selezione non superata             *
      *                  *---------------------------------------------*
           if        w-let-arc-zmc-flg    not  = spaces and
                     rr-sel-val           =    02
                     go to qry-let-seq-200.
       qry-let-seq-280.
      *                  *---------------------------------------------*
      *                  * Se causale di magazzino che non riguarda il *
      *                  * valore del movimento e selezione sul valore *
      *                  * attiva : selezione non superata             *
      *                  *---------------------------------------------*
           if        rr-sel-val           not  = 02
                     go to qry-let-seq-300.
           if        w-let-arc-zmc-trv    not  = "I" and
                     w-let-arc-zmc-trv    not  = "C" and
                     w-let-arc-zmc-trv    not  = "X" and
                     w-let-arc-zmc-trv    not  = "R" and
                     w-let-arc-zmc-trv    not  = "Y"
                     go to qry-let-seq-200.
       qry-let-seq-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       qry-let-seq-500.
      *              *-------------------------------------------------*
      *              * Selezione sulla riga per il valore movimento    *
      *              *-------------------------------------------------*
           if        rr-sel-val           not  = 02
                     go to qry-let-seq-800.
           if        rf-mmr-val-mov       not  = zero
                     go to qry-let-seq-400.
       qry-let-seq-800.
      *              *-------------------------------------------------*
      *              * Se lettura OK                                   *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-mmt-tip-arc       =    spaces or
                     rf-mmt-tip-arc       =    "N"    or
                     rf-mmt-cod-arc       =    zero
                     go to qry-ini-lr1-600.
      *                  *---------------------------------------------*
      *                  * Test se interlinea gia' eseguita            *
      *                  *---------------------------------------------*
           if        w-qry-ini-lr1-fie    not  = spaces
                     move  spaces         to   w-qry-ini-lr1-fie
                     go to qry-ini-lr1-530.
      *                  *---------------------------------------------*
      *                  * Test se numero linee residue sufficienti    *
      *                  *---------------------------------------------*
           if        v-res                >    1
      ...
      *                      *-----------------------------------------*
           if        rf-mmt-tip-arc       =    "C"
                     go to qry-ini-lr1-542
           else if   rf-mmt-tip-arc       =    "F"
                     go to qry-ini-lr1-544
           else if   rf-mmt-tip-arc       =    "D"
                     go to qry-ini-lr1-546
           else if   rf-mmt-tip-arc       =    "A"
                     go to qry-ini-lr1-548.
       qry-ini-lr1-542.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-let-arc-cli-rag    to   w-qry-ini-lr1-x40      .
           go to     qry-ini-lr1-560.
       qry-ini-lr1-544.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-let-arc-fnt-rag    to   w-qry-ini-lr1-x40      .
           go to     qry-ini-lr1-560.
       qry-ini-lr1-546.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-let-arc-ada-den    to   w-qry-ini-lr1-x40      .
           go to     qry-ini-lr1-560.
       qry-ini-lr1-548.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-let-arc-age-nom    to   w-qry-ini-lr1-x40      .
           go to     qry-ini-lr1-560.
       qry-ini-lr1-560.
      *                      *-----------------------------------------*
      *                      * Stampa                                  *
      ...
      *                  * Test se da stampare                         *
      *                  *---------------------------------------------*
           if        rf-mmt-tip-arc       not  = "C" and
                     rf-mmt-tip-arc       not  = "F"
                     go to qry-ini-lr1-700.
           if        rf-mmt-cod-arc       =    spaces
                     go to qry-ini-lr1-700.
      ...
      *                  *---------------------------------------------*
           if        w-qry-ini-lr1-fie    not  = spaces
                     move  spaces         to   w-qry-ini-lr1-fie
                     go to qry-ini-lr1-630.
      *                  *---------------------------------------------*
      *                  * Test se numero linee residue sufficienti    *
      *                  *---------------------------------------------*
           if        v-res                >    1
                     go to qry-ini-lr1-620.
      *                      *-----------------------------------------*
      *                      * Intestazione pagina                     *
      *                      *-----------------------------------------*
           perform   int-pag-sta-000      thru int-pag-sta-999        .
      ...
      *                      *-----------------------------------------*
           if        rf-mmt-tip-arc       =    "C"
                     go to qry-ini-lr1-642
           else if   rf-mmt-tip-arc       =    "F"
                     go to qry-ini-lr1-644.
       qry-ini-lr1-642.
      *                      *-----------------------------------------*
      *                      * Tipo archivio : Clienti                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-let-arc-dcc-rag    to   w-qry-ini-lr1-x40      .
           go to     qry-ini-lr1-660.
       qry-ini-lr1-644.
      *                      *-----------------------------------------*
      *                      * Tipo archivio : Fornitori               *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-let-arc-dcf-rag    to   w-qry-ini-lr1-x40      .
           go to     qry-ini-lr1-660.
       qry-ini-lr1-660.
      *                      *-----------------------------------------*
      *                      * Stampa                                  *
