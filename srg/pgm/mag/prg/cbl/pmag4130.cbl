      ...
      *                                   Fase:    mag413              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 26/08/23    *
      *                       Ultima revisione:    NdK del 30/12/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag4131:        *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-dpz-inu           to   w-cod-des-zub-dpz      .
           move      rr-cod-ubi           to   w-cod-des-zub-cod      .
           move      08                   to   w-cod-des-zub-lin      .
           move      30                   to   w-cod-des-zub-pos      .
           move      08                   to   w-cod-des-zub-dln      .
      ...
      *                  *---------------------------------------------*
           move      rr-dpz-inu           to   w-let-arc-zub-dpz      .
           move      rr-cod-ubi           to   w-let-arc-zub-cod      .
           perform   let-arc-zub-000      thru let-arc-zub-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione valori                       *
      *                  *---------------------------------------------*
           if        rr-cod-ubi           =    spaces
                     move  "Tutte          "
                                          to   rr-cod-ubi-des
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      spaces               to   rr-cod-ubi             .
           move      spaces               to   rr-cod-ubi-des         .
