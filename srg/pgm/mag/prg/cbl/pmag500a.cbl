      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "LISTA PRODOTTI DI VENDITA PRESSO CLIENTI"       .
      ...
      *                  *---------------------------------------------*
       ...
       cmp-fil-app-480.
      *              *-------------------------------------------------*
      *              * Riciclo su lettura filtro ordinamento [dcp]     *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dcp-num-pro       to   rf-mmz-num-mag         .
      ...
      *                  *---------------------------------------------*
           if        rf-mmz-ann-ese       not  = w-cmp-fil-app-wes or
                     ...
                     rf-mmz-num-mag       not  = rf-dcp-num-pro
                     go to cmp-fil-app-599.
      *                  *---------------------------------------------*
      ...
      *                      * Composizione chiave                     *
      *                      *-----------------------------------------*
           move      w-cmp-fil-app-ctr    to   kk0-ctr-dcp            .
      ...
      *                          *-------------------------------------*
           ...
           move      rf-dcp-cla-pro       to   kk0-cod-cla            .
           move      rf-dcp-gru-pro       to   kk0-cod-gru            .
           move      rf-dcp-sgr-pro       to   kk0-cod-sgr            .
      ...
      *              * Contatore records [dcp] letti                   *
      *              *-------------------------------------------------*
           move      kk0-ctr-dcp          to   w-rot-l02-ctr-dcp      .
      *              *-------------------------------------------------*
      *              * Codice conto merce                              *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           string    "SITUAZIONE PRODOTTI DI VENDITA PRESSO CLIENTI PER 
      -              "ARTICOLO AL "
                                delimited by   size
