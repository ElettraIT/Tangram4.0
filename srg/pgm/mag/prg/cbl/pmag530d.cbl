      ...
      *              *-------------------------------------------------*
           ...
           move      rr-num-pro           to   w-cod-cod-dps-num      .
           move      rr-alf-pro           to   w-cod-cod-dps-alf      .
           move      15                   to   w-cod-cod-dps-lin      .
           move      22                   to   w-cod-cod-dps-pos      .
      ...
      *                  *---------------------------------------------*
           move      rr-num-pro           to   w-let-arc-dps-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           else      move  rr-dpz-fnt     to   rf-mmz-dpz-arc         .
      ...
      *                  *---------------------------------------------*
           if        rf-mmz-ann-ese       not  = w-cmp-fil-app-wes or
                     ...
                     rf-mmz-tip-arc       not  = "F"               or
                    (rr-cod-fnt           not  = zero    and
                     rf-mmz-cod-arc       not  = rr-cod-fnt)
                     go to cmp-fil-app-599.
       cmp-fil-app-530.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           if        rf-mmz-dpz-arc       not  = rr-dpz-fnt
                     go to cmp-fil-app-520.
       cmp-fil-app-540.
      *                      *-----------------------------------------*
      *                      * Test su tipo codice di magazzino        *
      *                      *-----------------------------------------*
           if        rf-mmz-tip-mag       not  = 02
                     go to cmp-fil-app-520.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-mmz-num-mag       to   rf-dps-num-sem         .
           move      "pgm/dps/fls/ioc/obj/iofdps"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      kk0-dpz-arc          to   w-rot-l02-dpz-arc      .
      *              *-------------------------------------------------*
      *              * Codice conto merce                              *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tip-slp           =    02 and
                     w-rot-l02-dpz-arc    =    spaces
      ...
      *              *-------------------------------------------------*
           ...
           string    "SITUAZIONE SEMILAVORATI PRESSO FORNITORI PER FORNI
      -              "TORE AL "
                                delimited by   size
