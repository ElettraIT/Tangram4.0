      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella parametri di         *
      *                    ubicazione                                  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " INTERROGAZIONE PARAMETRI DI UBICAZIONE "       .
      ...
      *              *-------------------------------------------------*
      *              * Test se dipendenza passata come variabile da    *
      *              * livello precedente                              *
      *              *-------------------------------------------------*
           move      w-ipc-dlp-tdi-dpz    to   rr-cod-dpz             .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-des-zub-cod      .
           move      12                   to   w-cod-des-zub-lin      .
           move      18                   to   w-cod-des-zub-pos      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-zub-ope      .
           move      rr-cod-max           to   w-cod-des-zub-cod      .
           move      12                   to   w-cod-des-zub-lin      .
           move      51                   to   w-cod-des-zub-pos      .
           move      zero                 to   w-cod-des-zub-dln      .
           move      zero                 to   w-cod-des-zub-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      10                   to   v-pos                  .
           move      rf-zub-des-ubi       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zub-cod-ubi       to   w-mpn-cod-ubi          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "PARAMETRI DI UBICAZIONE DEL MAGAZZINO  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        s-num                =    zero
                     go to ipc-dlp-tdi-200.
           move      s-num                to   w-ipc-dlp-tdi-dpz      .
       ipc-dlp-tdi-200.
      *              *-------------------------------------------------*
      *              * Estrazione della eventuale variabile di i.p.c.  *
