      ...
      *                                   Fase:    mag750              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 08/05/03    *
      *                       Ultima revisione:    NdK del 26/11/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Manutenzioni schede L.I.F.O.                *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase mag750, nella sua globalita', esegue i tipi di manu-   *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * MANSPR      Manutenzione singolo scaglione prodotto       750a *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Link-area comune per programmi della serie pmag7500       *
      *    *-----------------------------------------------------------*
           copy      "pgm/mag/prg/cpy/pmag7500.pgl"                   .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'mag750'           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Manutenzione singolo scaglione prodotto           
      -              " MANSPR     pmag750a  "
                                          to   w-tmn-ele-wci          .
