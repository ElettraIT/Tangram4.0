      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Situazione materie prime presso fornitori   *
      *                    per materia prima                           *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "  LISTA MATERIE PRIME PRESSO FORNITORI  "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-mmz-cod-arc       to   rf-dcf-cod-fnt         .
           move      rf-mmz-dpz-arc       to   rf-dcf-dpz-fnt         .
           move      "pgm/dcf/fls/ioc/obj/iofdcf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcf-rag-key       to   kk0-rag-key            .
      ...
      *                          *-------------------------------------*
           ...
           move      "F"                  to   kk0-tip-arc            .
           move      rf-dcf-rag-soc       to   kk0-rag-soc            .
      ...
      *              *-------------------------------------------------*
           ...
           string    "SITUAZIONE MATERIE PRIME PRESSO FORNITORI PER ARTI
      -              "COLO AL "
                                delimited by   size
