      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               ...
               10  w-tes-prm-min     occurs 4
                                          pic  x(07)                  .
               10  w-tes-prm-max     occurs 4
                                          pic  x(07)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           ...
           05  w-rig-tip-ubi              pic  x(03)                  .
           05  w-rig-prm-ubi     occurs 4
                                          pic  x(07)                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   w-tes-prm-min (1)      .
           move      spaces               to   w-tes-prm-min (2)      .
           move      spaces               to   w-tes-prm-min (3)      .
           move      spaces               to   w-tes-prm-min (4)      .
           move      spaces               to   w-tes-prm-max (1)      .
           move      spaces               to   w-tes-prm-max (2)      .
           move      spaces               to   w-tes-prm-max (3)      .
           move      spaces               to   w-tes-prm-max (4)      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-dpz-inu        to   w-cod-des-zmu-dpz      .
           move      w-tes-tip-ubi        to   w-cod-des-zmu-cod      .
           move      14                   to   w-cod-des-zmu-lin      .
           move      30                   to   w-cod-des-zmu-pos      .
           move      14                   to   w-cod-des-zmu-dln      .
      ...
      *                  *---------------------------------------------*
           move      w-tes-dpz-inu        to   w-let-arc-zmu-dpz      .
      ...
      *                  *---------------------------------------------*
           if        w-tes-tip-ubi        =    "?  "
                     move  "Senza ubicaz.  "
                                          to   w-tes-tip-ubi-des
           else if   w-tes-tip-ubi        =    spaces
                     move  "Tutti          "
                                          to   w-tes-tip-ubi-des
      ...
      *                  *---------------------------------------------*
           move      w-tes-prm-min (1)    to   w-all-str-alf          .
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-max (1)    to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-min (2)    to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-max (2)    to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-min (3)    to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-max (3)    to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-min (4)    to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        not  = spaces
      ...
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-prm-max (4)    to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        not  = spaces
      ...
      *              * Ubicazione                                      *
      *              *-------------------------------------------------*
           perform   vis-mag-ubi-000      thru vis-mag-ubi-999        .
       vis-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Ubicazione prodotto               *
      *    *-----------------------------------------------------------*
       vis-mag-ubi-000.
      *              *-------------------------------------------------*
      *              * Test se da visualizzare                         *
      *              *-------------------------------------------------*
           if        w-tes-prc-ril        =    01
                     go to vis-mag-ubi-900.
       vis-mag-ubi-100.
      *              *-------------------------------------------------*
      *              * Test su Tipo ubicazione                         *
      *              *-------------------------------------------------*
           if        w-rig-tip-ubi        not  = spaces
                     go to vis-mag-ubi-300.
       vis-mag-ubi-200.
      *                  *---------------------------------------------*
      *                  * Se Tipo ubicazione a spaces                 *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Linea 1 a spaces                        *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      20                   to   v-lin                  .
           move      62                   to   v-pos                  .
           if        w-let-arc-zmu-pdu    <    2
                     move  spaces         to   v-alf
           else      move  w-let-arc-zmu-dpu (2)
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *                          *-------------------------------------*
           ...
           move      21                   to   v-lin                  .
           move      41                   to   v-pos                  .
           if        w-let-arc-zmu-pdu    <    3
                     move  spaces         to   v-alf
           else      move  w-let-arc-zmu-dpu (3)
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *                          *-------------------------------------*
           ...
           move      21                   to   v-lin                  .
           move      62                   to   v-pos                  .
           if        w-let-arc-zmu-pdu    <    4
                     move  spaces         to   v-alf
           else      move  w-let-arc-zmu-dpu (4)
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *                  * Parametro 1 - min - max                     *
      *                  *---------------------------------------------*
           if        w-tes-prm-max (1)    =    spaces
                     go to cnt-tdo-key-220.
           if        w-tes-prm-max (1)    not  < w-tes-prm-min (1)
                     go to cnt-tdo-key-220.
      ...
      *                  * Parametro 2 - min - max                     *
      *                  *---------------------------------------------*
           if        w-tes-prm-max (2)    =    spaces
                     go to cnt-tdo-key-230.
           if        w-tes-prm-max (2)    not  < w-tes-prm-min (2)
                     go to cnt-tdo-key-230.
      ...
      *                  * Parametro 3 - min - max                     *
      *                  *---------------------------------------------*
           if        w-tes-prm-max (3)    =    spaces
                     go to cnt-tdo-key-240.
           if        w-tes-prm-max (3)    not  < w-tes-prm-min (3)
                     go to cnt-tdo-key-240.
      ...
      *                  * Parametro 4 - min - max                     *
      *                  *---------------------------------------------*
           if        w-tes-prm-max (4)    =    spaces
                     go to cnt-tdo-key-500.
           if        w-tes-prm-max (4)    not  < w-tes-prm-min (4)
                     go to cnt-tdo-key-500.
      ...
      *                  *---------------------------------------------*
           if        w-tes-prm-max (1)    =    spaces
                     move  w-tes-prm-min (1)
                                          to   w-tes-prm-max (1)      .
           move      w-tes-prm-max (1)    to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-pad-000      thru all-str-pad-999        .
           move      w-all-str-alf        to   w-tes-prm-max (1)      .
       cnt-tdo-key-520.
      *                  *---------------------------------------------*
      *                  * Parametro 2 - min - max                     *
      *                  *---------------------------------------------*
           if        w-tes-prm-max (2)    =    spaces
                     move  w-tes-prm-min (2)
                                          to   w-tes-prm-max (2)      .
           move      w-tes-prm-max (2)    to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-pad-000      thru all-str-pad-999        .
           move      w-all-str-alf        to   w-tes-prm-max (2)      .
       cnt-tdo-key-530.
      *                  *---------------------------------------------*
      *                  * Parametro 3 - min - max                     *
      *                  *---------------------------------------------*
           if        w-tes-prm-max (3)    =    spaces
                     move  w-tes-prm-min (3)
                                          to   w-tes-prm-max (3)      .
           move      w-tes-prm-max (3)    to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-pad-000      thru all-str-pad-999        .
           move      w-all-str-alf        to   w-tes-prm-max (3)      .
       cnt-tdo-key-540.
      *                  *---------------------------------------------*
      *                  * Parametro 4 - min - max                     *
      *                  *---------------------------------------------*
           if        w-tes-prm-max (4)    =    spaces
                     move  w-tes-prm-min (4)
                                          to   w-tes-prm-max (4)      .
           move      w-tes-prm-max (4)    to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-pad-000      thru all-str-pad-999        .
           move      w-all-str-alf        to   w-tes-prm-max (4)      .
       cnt-tdo-key-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-mim-tip-ubi       to   w-rig-tip-ubi          .
           move      rf-mim-prm-ubi (1)   to   w-rig-prm-ubi (1)      .
           move      rf-mim-prm-ubi (2)   to   w-rig-prm-ubi (2)      .
           move      rf-mim-prm-ubi (3)   to   w-rig-prm-ubi (3)      .
           move      rf-mim-prm-ubi (4)   to   w-rig-prm-ubi (4)      .
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-rig-tip-arc        =    "C"
                     go to  rou-let-reg-zos-222
           else if   w-rig-tip-arc        =    "F"
                     go to  rou-let-reg-zos-224.
       rou-let-reg-zos-222.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           else      move  w-tes-tip-ubi  to   rf-mim-tip-ubi         .
           move      w-tes-prm-min (1)    to   rf-mim-prm-ubi (1)     .
           move      w-tes-prm-min (2)    to   rf-mim-prm-ubi (2)     .
           move      w-tes-prm-min (3)    to   rf-mim-prm-ubi (3)     .
           move      w-tes-prm-min (4)    to   rf-mim-prm-ubi (4)     .
           move      01                   to   rf-mim-tip-mag         .
      ...
      *                  *---------------------------------------------*
           if        rf-mim-cod-dpz       not  = w-tes-dpz-inu
                     go to rou-let-reg-ubi-900.
      *                  *---------------------------------------------*
      *                  * Test su tipo ubicazione                     *
      *                  *---------------------------------------------*
           if        w-tes-tip-ubi        =    spaces
                     go to rou-let-reg-ubi-400.
           if        w-tes-tip-ubi        not  = "?  "
                     go to rou-let-reg-ubi-305.
           if        rf-mim-tip-ubi       not  = spaces
                     go to rou-let-reg-ubi-900.
           go to     rou-let-reg-ubi-400.
       rou-let-reg-ubi-305.
           if        rf-mim-tip-ubi       not  = w-tes-tip-ubi
                     go to rou-let-reg-ubi-900.
       rou-let-reg-ubi-310.
      *                  *---------------------------------------------*
      *                  * Test su parametro ubicazione 1              *
      *                  *---------------------------------------------*
           if        rf-mim-prm-ubi (1)   >    w-tes-prm-max (1)
                     go to rou-let-reg-ubi-900.
       rou-let-reg-ubi-320.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-tip-ubi-pdu    not  > 1
                     go to rou-let-reg-ubi-400.
           if        rf-mim-prm-ubi (2)   >    w-tes-prm-max (2)
                     go to rou-let-reg-ubi-900.
       rou-let-reg-ubi-330.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-tip-ubi-pdu    not  > 2
                     go to rou-let-reg-ubi-400.
           if        rf-mim-prm-ubi (3)   >    w-tes-prm-max (3)
                     go to rou-let-reg-ubi-900.
       rou-let-reg-ubi-310.
      *                  *---------------------------------------------*
      *                  * Test su parametro ubicazione 1              *
      *                  *---------------------------------------------*
           if        w-tes-tip-ubi-pdu    not  > 3
                     go to rou-let-reg-ubi-400.
           if        rf-mim-prm-ubi (4)   >    w-tes-prm-max (4)
                     go to rou-let-reg-ubi-900.
       rou-let-reg-ubi-400.
      *              *-------------------------------------------------*
      *              * Selezione sul record                            *
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Deviazione in funzione del tipo archiv- *
      *                      * vio                                     *
      *                      *-----------------------------------------*
           if        w-rig-tip-arc        =    "C"
                     go to  rou-let-reg-ubi-622
           else if   w-rig-tip-arc        =    "F"
                     go to  rou-let-reg-ubi-624.
       rou-let-reg-ubi-622.
      *                          *-------------------------------------*
      *                          * Tipo archivio : Clienti             *
      *                          *-------------------------------------*
