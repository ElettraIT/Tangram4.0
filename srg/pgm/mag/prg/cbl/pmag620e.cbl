      ...
      *                                                                *
      *                    Rilevazione giacenza fisica materie prime   *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipo rilevazione           : Giacenza fisica mater
      -              "ie prime                      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      17                   to   w-cod-cod-dpm-lin      .
           move      19                   to   w-cod-cod-dpm-pos      .
           move      17                   to   w-cod-cod-dpm-dln      .
      ...
      *                  *---------------------------------------------*
           move      w-let-arc-dpm-num    to   w-rig-num-mag          .
      ...
      *                  *---------------------------------------------*
           if        rf-mim-cod-dpz       not  = w-tes-dpz-inu or
                     rf-mim-tip-mag       not  = 03            or
                     rf-mim-num-mag       not  = rf-dpm-num-map
                     go to rou-let-reg-100.
      *                  *---------------------------------------------*
...
.       rou-let-reg-230.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-let-arc-dpm-alf    to   rf-dpm-alf-map         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-dpm-alf-map       not  = w-let-arc-dpm-alf
                     go to let-arc-dpm-400.
       let-arc-dpm-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-dpm-num-map       to   w-let-arc-dpm-num      .
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-dpm-600.
           move      zero                 to   w-let-arc-dpm-num      .
