      ...
      *                       Ultima revisione:    NdK del 26/08/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella dislocazioni         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE DISLOCAZIONI DI MAGAZZINO"       .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      30                   to   v-pos                  .
           move      rf-zmd-des-dsl       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zmd-cod-dsl       to   w-mpn-cod-dsl          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-dsl'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
