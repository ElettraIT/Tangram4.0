      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag3041:        *
      *                                                                *
      *                    Stampa brogliaccio movimenti di magazzino   *
      *                    mancanti del costo unitario.                *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA MOVIMENTI MAGAZZINO SENZA COSTO "       .
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Controllo che il tipo trattamento del   *
      *                      * valore della causale indichi una im-    *
      *                      * postazione diretta                      *
      *                      *-----------------------------------------*
           if        w-let-arc-zmc-trv    =    "I" or
                     w-let-arc-zmc-trv    =    "C" or
                     w-let-arc-zmc-trv    =    "X" or
                     w-let-arc-zmc-trv    =    "R" or
                     w-let-arc-zmc-trv    =    "Y"
                     go to acc-cau-mag-600.
      *                      *-----------------------------------------*
      *                      * Se cosi' non e' si emette un messaggio  *
      *                      * di errore e si torna a reimpostare      *
      *                      *-----------------------------------------*
           move      "La causale non richiede l'impostazione del valore 
