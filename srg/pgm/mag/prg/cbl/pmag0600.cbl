      ...
      *                       Ultima revisione:    NdK del 21/11/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella responsabili di magazzino  *
      *                                                                *
      *                    IL CAMPO 'alx-exp' OSPITA PROVVISORIAMENTE  *
      *                    IL COLORE ASSOCIATO AL RESPONSABILE PER LA  *
      *                    GESTIONE INVENTARIO (GRAFICO)               *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   TABELLA RESPONSABILI DI MAGAZZINO    "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-rsp          pic  9(05)                  .
               10  w-tes-cod-rsp-aut      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-rsp          pic  x(40)                  .
               10  w-tes-des-key          pic  x(40)                  .
               10  w-tes-cod-mne          pic  x(05)                  .
               10  w-tes-flg-spn          pic  x(03)                  .
               10  w-tes-cod-adr          pic  9(03)                  .
               10  w-tes-alx-exp.
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Ambito di responsabilita'                  *
      *        *-------------------------------------------------------*
           05  w-exp-cod-adr.
               10  w-exp-cod-adr-num      pic  9(02)       value 3    .
               10  w-exp-cod-adr-lun      pic  9(02)       value 40   .
               10  w-exp-cod-adr-tbl.
                   15  filler             pic  x(40) value
                            "puo' operare in Tutte le fasi           ".
                   15  filler             pic  x(40) value
                            "addetto alla Ricezione del materiale    ".
                   15  filler             pic  x(40) value
                            "addetto alla Spedizione del materiale   ".
      ...
      *                  * Codice responsabile                         *
      *                  *---------------------------------------------*
           perform   acc-cod-rsp-000      thru acc-cod-rsp-999        .
      ...
      *              * Codice responsabile                             *
      *              *-------------------------------------------------*
           perform   vis-cod-rsp-000      thru vis-cod-rsp-999        .
       vis-key-reg-999.
           exit.
      ...
      *              * Codice responsabile                             *
      *              *-------------------------------------------------*
           perform   pmt-cod-rsp-000      thru pmt-cod-rsp-999        .
      *              *-------------------------------------------------*
      *              * Linea di trattini                               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice responsabile           *
      *    *-----------------------------------------------------------*
       pmt-cod-rsp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice responsabile           *
      *    *-----------------------------------------------------------*
       acc-cod-rsp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-rsp        to   w-cod-mne-zrm-cod      .
           move      04                   to   w-cod-mne-zrm-lin      .
           move      30                   to   w-cod-mne-zrm-pos      .
           move      07                   to   w-cod-mne-zrm-dln      .
           move      30                   to   w-cod-mne-zrm-dps      .
           move      "<B"                 to   v-edm                  .
       ...
       acc-cod-rsp-110.
           ...
           if        w-cod-mne-zrm-ope    =    "F+"
                     go to acc-cod-rsp-115.
           if        w-cod-mne-zrm-ope    =    "AC"
                     go to acc-cod-rsp-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-rsp-115.
           perform   cod-mne-zrm-foi-000  thru cod-mne-zrm-foi-999    .
           go to     acc-cod-rsp-110.
       acc-cod-rsp-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-rsp-999.
       acc-cod-rsp-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cod-rsp          .
       acc-cod-rsp-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-rsp        =    zero
                     go to acc-cod-rsp-410
           else      go to acc-cod-rsp-450.
       acc-cod-rsp-410.
      *                  *---------------------------------------------*
      ...
      *                      * zione                                   *
      *                      *-----------------------------------------*
           move      w-enc-cod-val-pos    to   w-tes-cod-rsp          .
      *                      *-----------------------------------------*
      *                      * Segnale di attribuzione codice eseguita *
      *                      * automaticamente                         *
      *                      *-----------------------------------------*
           move      "#"                  to   w-tes-cod-rsp-aut      .
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice responsabile        *
      *    *-----------------------------------------------------------*
       vis-cod-rsp-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           perform   acc-des-rsp-000      thru acc-des-rsp-999        .
           if        v-key                =    "NXSC"
      ...
      *                  * Codice di spunta                            *
      *                  *---------------------------------------------*
           perform   acc-flg-spn-000      thru acc-flg-spn-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  *---------------------------------------------*
           perform   acc-cod-adr-000      thru acc-cod-adr-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Nominativo responsabile                         *
      *              *-------------------------------------------------*
           perform   vis-des-rsp-000      thru vis-des-rsp-999        .
      *              *-------------------------------------------------*
      *              * Codice mnemonico                                *
      *              *-------------------------------------------------*
      ...
      *              * Codice di spunta                                *
      *              *-------------------------------------------------*
           perform   vis-flg-spn-000      thru vis-flg-spn-999        .
      *              *-------------------------------------------------*
      *              * Ambito di responsabilita'                       *
      *              *-------------------------------------------------*
           perform   vis-cod-adr-000      thru vis-cod-adr-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     vis-tes-reg-999.
      ...
      *              * Nominativo responsabile                         *
      *              *-------------------------------------------------*
           perform   pmt-des-rsp-000      thru pmt-des-rsp-999        .
      *              *-------------------------------------------------*
      *              * Codice mnemonico                                *
      *              *-------------------------------------------------*
      ...
      *              * Codice di spunta                                *
      *              *-------------------------------------------------*
           perform   pmt-flg-spn-000      thru pmt-flg-spn-999        .
      *              *-------------------------------------------------*
      *              * Ambito di responsabilita'                       *
      *              *-------------------------------------------------*
           perform   pmt-cod-adr-000      thru pmt-cod-adr-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     pmt-tes-reg-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Nominativo responsabile          *
      *    *-----------------------------------------------------------*
       pmt-des-rsp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice di spunta                 *
      *    *-----------------------------------------------------------*
       pmt-flg-spn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Ambito di responsabilita'        *
      *    *-----------------------------------------------------------*
       pmt-cod-adr-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Nominativo responsabile      *
      *    *-----------------------------------------------------------*
       acc-des-rsp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-rsp (1)    =    spaces
                     go to acc-des-rsp-100.
       acc-des-rsp-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * l'ordinamento                               *
      *                  *---------------------------------------------*
           move      w-tes-des-rsp (1)    to   w-all-str-alf          .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Nominativo responsabile   *
      *    *-----------------------------------------------------------*
       vis-des-rsp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice di spunta                     *
      *    *-----------------------------------------------------------*
       acc-flg-spn-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-flg-spn-100.
       acc-flg-spn-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Codice di spunta                  *
      *    *-----------------------------------------------------------*
       vis-flg-spn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Ambito di responsabilita'            *
      *    *-----------------------------------------------------------*
       acc-cod-adr-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-cod-adr-lun    to   v-car                  .
           move      w-exp-cod-adr-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      "TRS#"               to   v-msk                  .
           move      13                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-cod-adr-tbl    to   v-txt                  .
           move      w-tes-cod-adr (1)    to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-cod-adr-100.
       acc-cod-adr-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Ambito di responsabilita'         *
      *    *-----------------------------------------------------------*
       vis-cod-adr-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       cnt-tdo-nok-120.
      *                  *---------------------------------------------*
      *                  * Controllo su nominativo responsabile        *
      *                  *---------------------------------------------*
           if        w-tes-des-rsp (1)    not  = spaces
                     go to cnt-tdo-nok-500.
           move      "Manca il nominativo del responsabile !          "
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           move      zero                 to   w-tes-cod-rsp          .
           move      spaces               to   w-tes-cod-rsp-aut      .
       nor-key-reg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-rsp (1)      .
           move      spaces               to   w-tes-des-key (1)      .
           move      spaces               to   w-tes-cod-mne (1)      .
           move      spaces               to   w-tes-flg-spn (1)      .
           move      zero                 to   w-tes-cod-adr (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-rsp        to   rf-zrm-cod-rsp         .
           move      "pgm/mag/fls/ioc/obj/iofzrm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zrm]                        *
      *                          *-------------------------------------*
           move      rf-zrm-des-rsp       to   w-tes-des-rsp (1)      .
           move      rf-zrm-des-key       to   w-tes-des-key (1)      .
           move      rf-zrm-cod-mne       to   w-tes-cod-mne (1)      .
           move      rf-zrm-flg-spn       to   w-tes-flg-spn (1)      .
           move      rf-zrm-cod-adr       to   w-tes-cod-adr (1)      .
           move      rf-zrm-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zrm]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zrm-000      thru wrt-rec-zrm-999        .
      ...
      *                      * Rewrite record [zrm]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zrm-000      thru rew-rec-zrm-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zrm]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zrm-000      thru del-rec-zrm-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zrm]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zrm-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-rsp (1)    to   rf-zrm-des-rsp         .
           move      w-tes-des-key (1)    to   rf-zrm-des-key         .
           move      w-tes-cod-mne (1)    to   rf-zrm-cod-mne         .
           move      w-tes-flg-spn (1)    to   rf-zrm-flg-spn         .
           move      w-tes-cod-adr (1)    to   rf-zrm-cod-adr         .
           move      w-tes-alx-exp (1)    to   rf-zrm-alx-exp         .
      *                  *---------------------------------------------*
      *                  * IL CAMPO 'alx-exp' OSPITA PROVVISORIAMENTE  *
      *                  * IL COLORE ASSOCIATO AL RESPONSABILE PER LA  *
      *                  * GESTIONE INVENTARIO (GRAFICO)               *
      *                  *---------------------------------------------*
           if        rf-zrm-cod-rsp       =    001
                     move  "orange"       to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    002
                     move  "brown"        to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    003
                     move  "red"          to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    004
                     move  "green"        to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    005
                     move  "purple"       to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    006
                     move  "yellow"       to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    007
                     move  "blue"         to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    008
                     move  "lime"         to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    009
                     move  "lightblue"    to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    010
                     move  "white"        to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    011
                     move  "magenta"      to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    012
                     move  "aquamarine"   to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    013
                     move  "maroon"       to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    014
                     move  "#FBB117"      to   rf-zrm-alx-exp
           else if   rf-zrm-cod-rsp       =    015
                     move  "#EDE6D6"      to   rf-zrm-alx-exp
           else      move  "grey"         to   rf-zrm-alx-exp         .
       cmp-rec-zrm-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zrm]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zrm-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zrm-000      thru cmp-rec-zrm-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zrm] parte 01    *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zrm "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODRSP    "         to   f-key                  .
           move      w-enc-cod-val-pos    to   rf-zrm-cod-rsp         .
           move      "pgm/mag/fls/ioc/obj/iofzrm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       rip-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zrm]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zrm "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
