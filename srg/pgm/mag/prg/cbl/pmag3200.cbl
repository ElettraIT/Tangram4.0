      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag3201:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-arg-snx-dcp.
      *            *---------------------------------------------------*
      *            * Si/No area [dcp] attiva                           *
      *            * - S : Si'                                         *
      *            * - N : No                                          *
      *            *---------------------------------------------------*
               10  w-arg-snx-dcp-snx      pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
      *              * Test se area [dcp] attiva                       *
      *              *-------------------------------------------------*
           perform   arg-dcp-snx-000      thru arg-dcp-snx-999        .
           if        w-arg-snx-dcp-snx    =    "S"
                     go to pre-exe-pgm-100.
           perform   arg-dcp-err-000      thru arg-dcp-err-999        .
      ...
      *              *-------------------------------------------------*
           move      s-alf                to   w-arg-snx-dcp-snx      .
       arg-dcp-snx-999.
           exit.

      *    *===========================================================*
      *    * Errore per area [dcp] non attiva                          *
      *    *-----------------------------------------------------------*
       arg-dcp-err-000.
      *              *-------------------------------------------------*
      *              * Video in Off                                    *
      ...
      *
           ...
           move      11                   to   v-lin                  .
           move      03                   to   v-pos                  .
           move      "             Non e' prevista la gestione dei prodo
      -              "tti di vendita.           "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
