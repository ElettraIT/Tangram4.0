      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione costo unitario per singolo prodot- *
      *                    to                                          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  GESTIONE COSTO UNITARIO PER PRODOTTO  "       .
      ...
      *            *---------------------------------------------------*
               ...
               10  w-det-cst-mes-ctx      pic  9(02)                  .
               10  w-det-cst-mes-cty      pic  9(02)                  .
               10  w-det-cst-mes-ct1      pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Castelletto nomi dei mesi                         *
      *            *---------------------------------------------------*
               10  w-det-cst-mes-tbl.
                   ...
                   15  filler             pic  x(11) value
                            "Dicembre   "                              .
               10  w-det-cst-mes-tbl-r redefines
                   w-det-cst-mes-tbl.
                   15  w-det-cst-mes-cst occurs 13.
                       20  w-det-cst-mes-nom
                                          pic  x(11)                  .
      ...
      *    *-----------------------------------------------------------*
       vis-uni-mis-000.
           ...
           move      07                   to   v-lin                  .
           move      77                   to   v-pos                  .
           move      w-tes-num-mag-udm    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-uni-mis-999.
           exit.
      ...
      *                  *---------------------------------------------*
       ...
       acc-tes-reg-140.
      *                      *-----------------------------------------*
      *                      * Data riferimento costo ultimo           *
      *                      *-----------------------------------------*
           perform   acc-dcu-mns-000      thru acc-dcu-mns-999        .
           if        v-key                =    "NXSC"
      ...
      *                      * Costo ultimo                            *
      *                      *-----------------------------------------*
           perform   acc-ucu-mns-000      thru acc-ucu-mns-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
       ...
       acc-tes-reg-144.
      *                      *-----------------------------------------*
      *                      * Data riferimento costo standard         *
      *                      *-----------------------------------------*
           perform   acc-dst-mns-000      thru acc-dst-mns-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                      * Costo standard                          *
      *                      *-----------------------------------------*
           perform   acc-ust-mns-000      thru acc-ust-mns-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                      * Data riferimento costo ultimo           *
      *                      *-----------------------------------------*
           perform   vis-dcu-mns-000      thru vis-dcu-mns-999        .
      *                      *-----------------------------------------*
      *                      * Costo ultimo                            *
      *                      *-----------------------------------------*
           perform   vis-ucu-mns-000      thru vis-ucu-mns-999        .
      *                      *-----------------------------------------*
      *                      * Data riferimento costo standard         *
      *                      *-----------------------------------------*
           perform   vis-dst-mns-000      thru vis-dst-mns-999        .
      *                      *-----------------------------------------*
      *                      * Costo standard                          *
      *                      *-----------------------------------------*
           perform   vis-ust-mns-000      thru vis-ust-mns-999        .
       vis-tes-reg-180.
      *                      *-----------------------------------------*
      *                      * Riciclo                                 *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      07                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Mese          | Data rif.  Costo ultimo   | Data r
      -              "if.  Costo standard |Udm:     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       pmt-fin-tes-120.
           ...
           move      "A"                  to   v-tip                  .
           move      01                   to   v-car                  .
           move      w-det-cst-mes-ctr    to   v-lin                  .
           add       08                   to   v-lin                  .
           move      15                   to   v-pos                  .
           move      "|"                  to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
      ...
      *                  *---------------------------------------------*
           ...
           move      01                   to   v-pos                  .
           move      w-det-cst-mes-nom
                    (w-det-cst-mes-ctr)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Riciclo                                     *
      ...
      *    *===========================================================*
      *    * Accettazione campo : Mese di esercizio - Data riferimento *
      *    *                      costo ultimo                         *
      *    *-----------------------------------------------------------*
       acc-dcu-mns-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Controllo di congruenza con l'anno di rife- *
      *                  * rimento                                     *
      *                  *---------------------------------------------*
           if        w-det-cst-mes-ctr    =    01
                     go to acc-dcu-mns-500.
           if        w-tes-dcu-mns
                    (1, w-det-cst-mes-ctr)
                                          =    zero
                     go to acc-dcu-mns-600.
           move      w-tes-dcu-mns
                    (1, w-det-cst-mes-ctr)
                                          to   s-dat                  .
      *                  *---------------------------------------------*
      *                  * Controllo su anno                           *
      *                  *---------------------------------------------*
           if        s-saa                =    w-tes-ann-ese
                     go to acc-dcu-mns-500.
      *                  *---------------------------------------------*
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Incongruenza con l'anno di riferimento !        "
                                          to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                  *---------------------------------------------*
      *                  * A reimpostazione                            *
      *                  *---------------------------------------------*
           go to     acc-dcu-mns-100.
       acc-dcu-mns-500.
      *                  *---------------------------------------------*
      *                  * Controllo su mese                           *
      *                  *---------------------------------------------*
           if        w-det-cst-mes-ctr    =    01
                     go to acc-dcu-mns-600.
           move      w-det-cst-mes-ctr    to   w-det-cst-mes-cty      .
           subtract  1                    from w-det-cst-mes-cty      .
           if        s-mes                =    w-det-cst-mes-cty
                     go to acc-dcu-mns-600.
      *                  *---------------------------------------------*
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Incongruenza con il mese di riferimento !       "
                                          to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                  *---------------------------------------------*
      *                  * A reimpostazione                            *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Mese di esercizio - Data riferi-  *
      *    *                         mento costo ultimo                *
      *    *-----------------------------------------------------------*
       vis-dcu-mns-000.
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Mese di esercizio - Costo ultimo     *
      *    *-----------------------------------------------------------*
       acc-ucu-mns-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-ucu-mns-100.
       acc-ucu-mns-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Mese di esercizio - Costo ultimo  *
      *    *-----------------------------------------------------------*
       vis-ucu-mns-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           if        w-det-cst-mes-ctr    =    01
                     go to acc-dst-mns-500.
           if        w-tes-dst-mns
                    (1, w-det-cst-mes-ctr)
                                          =    zero
                     go to acc-dst-mns-600.
           move      w-tes-dst-mns
                    (1, w-det-cst-mes-ctr)
                                          to   s-dat                  .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Mese di esercizio - Costo standard   *
      *    *-----------------------------------------------------------*
       acc-ust-mns-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-ust-mns-100.
       acc-ust-mns-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Mese esercizio - Costo standard   *
      *    *-----------------------------------------------------------*
       vis-ust-mns-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           string    w-det-cst-mes-nom
                    (w-det-cst-mes-ct1)
                                delimited by   spaces
                     " : Manca la data di rif. costo ultimo !"
                                delimited by   size
       ...
       cnt-tdo-nok-130.
           ...
           string    w-det-cst-mes-nom
                    (w-det-cst-mes-ct1)
                                delimited by   spaces
                     " : Manca il costo ultimo !"
                                delimited by   size
                                          into w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-160.
      *                  *---------------------------------------------*
      *                  * Controllo su data / costo standard          *
      *                  *---------------------------------------------*
           if        w-tes-ust-mns
                    (1, w-det-cst-mes-ct1)
                                          =    zero
           ...
           string    w-det-cst-mes-nom
                    (w-det-cst-mes-ct1)
                                delimited by   spaces
                     " : Manca la data di rif. costo standard !"
                                delimited by   size
                                          into w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-170.
      ...
      *                              *---------------------------------*
           move      rf-mmv-dcu-ies       to   w-tes-dcu-mns
                                              (1, 1)                  .
           move      rf-mmv-ucu-ies       to   w-tes-ucu-mns
                                              (1, 1)                  .
           move      rf-mmv-dst-ies       to   w-tes-dst-mns
                                              (1, 1)                  .
           move      rf-mmv-ust-ies       to   w-tes-ust-mns
                                              (1, 1)                  .
      *
           move      zero                 to   w-det-cst-mes-ctr      .
           move      1                    to   w-det-cst-mes-ctx      .
       rou-let-reg-260.
           add       1                    to   w-det-cst-mes-ctr      .
           add       1                    to   w-det-cst-mes-ctx      .
           if        w-det-cst-mes-ctx    >    13
      ...
      *              *-------------------------------------------------*
           move      w-tes-dcu-mns
                    (1, 1)                to   rf-mmv-dcu-ies         .
           move      w-tes-ucu-mns
                    (1, 1)                to   rf-mmv-ucu-ies         .
           move      w-tes-dst-mns
                    (1, 1)                to   rf-mmv-dst-ies         .
           move      w-tes-ust-mns
                    (1, 1)                to   rf-mmv-ust-ies         .
      *              *-------------------------------------------------*
      *              * Mesi                                            *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-cst-mes-ctr      .
