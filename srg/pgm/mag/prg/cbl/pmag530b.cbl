      ...
      *                  *---------------------------------------------*
           ...
           else      move  rr-dpz-cli     to   rf-mmz-dpz-arc         .
      ...
      *                  *---------------------------------------------*
           if        rf-mmz-ann-ese       not  = w-cmp-fil-app-wes or
                     ...
                     rf-mmz-tip-arc       not  = "C"               or
                    (rr-cod-cli           not  = zero    and
                     rf-mmz-cod-arc       not  = rr-cod-cli)
                     go to cmp-fil-app-599.
       cmp-fil-app-530.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           if        rf-mmz-dpz-arc       not  = rr-dpz-cli
      ...
      *              *-------------------------------------------------*
           ...
           string    "SITUAZIONE SEMILAVORATI PRESSO CLIENTI PER CLIENTE
      -              " AL "
                                delimited by   size
