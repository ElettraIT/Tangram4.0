      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag0321:        *
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella causali"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-zmc-cod      .
           move      15                   to   w-cod-mne-zmc-lin      .
           move      19                   to   w-cod-mne-zmc-pos      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zmc-ope      .
           move      rr-cod-max           to   w-cod-mne-zmc-cod      .
           move      15                   to   w-cod-mne-zmc-lin      .
           move      51                   to   w-cod-mne-zmc-pos      .
           move      zero                 to   w-cod-mne-zmc-dln      .
           move      zero                 to   w-cod-mne-zmc-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
      ...
      -              "quella minima !"    to   v-not                  .
       ...
       tdo-ric-sel-400.
      *              *-------------------------------------------------*
      *              * Controllo su mnemonico min e max                *
      *              *-------------------------------------------------*
