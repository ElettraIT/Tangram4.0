      ...
      *                       Ultima revisione:    NdK del 15/07/00    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag7261:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   VALORIZZAZIONE LIFO MATERIALI VARI   "       .
      ...
      *                  *---------------------------------------------*
       ...
       pre-exe-pgm-120.
      *                  *---------------------------------------------*
      *                  * Se la personalizzazione non prevede la ge-  *
      *                  * stione dei materiali vari : messaggio ed    *
      *                  * uscita dal programma                        *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Preparazione messaggio                  *
      *                      *-----------------------------------------*
           move      "Le personalizzazioni non consentono l'utilizzo del
      -              " programma !   "    to   w-err-box-err-msg      .
      *                      *-----------------------------------------*
      *                      * Visualizzazione messaggio               *
      *                      *-----------------------------------------*
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                      *-----------------------------------------*
      *                      * Uscita con flag di interruzione del     *
      *                      * programma                               *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Valorizzazione L.i.f.o. al :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-052.
           ...
           move      "Data per la valorizzazione non accettabile !"
                                          to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
