      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag0421:        *
      *                                                                *
      *                    Stampa tabella Tipi ubicazione di magazzino *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           ...
           05  rr-des-min                 pic  x(15)                  .
           05  rr-des-max                 pic  x(15)                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella tipi ubicazione"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-des-zmu-cod      .
           move      12                   to   w-cod-des-zmu-lin      .
           move      32                   to   w-cod-des-zmu-pos      .
           move      zero                 to   w-cod-des-zmu-dln      .
           move      zero                 to   w-cod-des-zmu-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-zmu-ope      .
           move      rr-dpz-inu           to   w-cod-des-zmu-dpz      .
           move      rr-cod-max           to   w-cod-des-zmu-cod      .
           move      12                   to   w-cod-des-zmu-lin      .
           move      54                   to   w-cod-des-zmu-pos      .
           move      zero                 to   w-cod-des-zmu-dln      .
           move      zero                 to   w-cod-des-zmu-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
