      ...
      *                                                                *
      *                    Ricerca movimenti per semilavorato          *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-mag           to   w-cod-cod-dps-num      .
           move      rr-alf-mag           to   w-cod-cod-dps-alf      .
      ...
      *                  *---------------------------------------------*
           move      rr-cod-mag           to   w-let-arc-dps-num      .
           move      rr-alf-mag           to   w-let-arc-dps-alf      .
           perform   let-arc-dps-000      thru let-arc-dps-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione magazzino        *
      *                  *---------------------------------------------*
           move      w-let-arc-dps-des    to   rr-cod-mag-des         .
      *                  *---------------------------------------------*
      *                  * Memorizzazione unita' di misura             *
      *                  *---------------------------------------------*
           move      w-let-arc-dps-umi    to   rr-cod-mag-umi         .
      *                  *---------------------------------------------*
      *                  * Memorizzazione numero decimali quantita'    *
      *                  *---------------------------------------------*
           move      w-let-arc-dps-ndq    to   rr-cod-mag-ndq         .
       acc-cod-mag-420.
      *                  *---------------------------------------------*
