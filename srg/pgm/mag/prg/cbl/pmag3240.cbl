      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag3241:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-arg-snx-dpm.
      *            *---------------------------------------------------*
      *            * Si/No area [dpm] attiva                           *
      *            * - S : Si'                                         *
      *            * - N : No                                          *
      *            *---------------------------------------------------*
               10  w-arg-snx-dpm-snx      pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
      *              * Test se area [dpm] attiva                       *
      *              *-------------------------------------------------*
           perform   arg-dpm-snx-000      thru arg-dpm-snx-999        .
           if        w-arg-snx-dpm-snx    =    "S"
                     go to pre-exe-pgm-100.
           perform   arg-dpm-err-000      thru arg-dpm-err-999        .
      ...
      *              *-------------------------------------------------*
           move      s-alf                to   w-arg-snx-dpm-snx      .
       arg-dpm-snx-999.
           exit.

      *    *===========================================================*
      *    * Errore per area [dpm] non attiva                          *
      *    *-----------------------------------------------------------*
       arg-dpm-err-000.
      *              *-------------------------------------------------*
      *              * Video in Off                                    *
      ...
      *
           ...
           move      11                   to   v-lin                  .
           move      03                   to   v-pos                  .
           move      "             Non e' prevista la gestione delle mat
      -              "erie prime.               "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
