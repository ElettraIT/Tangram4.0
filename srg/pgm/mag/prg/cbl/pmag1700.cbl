      ...
      *                       Ultima revisione:    NdK del 11/12/25    *
      *                    ------------------------------------------- *
      ...
      *            *---------------------------------------------------*
               10  srt-qta-ubi            pic s9(08)v9(03)            .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   SPOSTAMENTO PRODOTTI DA UBICAZIONI   "       .
      ...
      *            *---------------------------------------------------*
               10  w-tes-ubi-ori          pic  x(07)                  .
               10  w-tes-ubi-ori-des      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Ubicazione di destinazione                        *
      *            *---------------------------------------------------*
               10  w-tes-ubi-dst          pic  x(07)                  .
               10  w-tes-ubi-dst-des      pic  x(40)                  .
      *            *---------------------------------------------------*
      ...
      *            * Ubicazione originale                              *
      *            *---------------------------------------------------*
               10  w-rig-ubi-ori          pic  x(07)                  .
               10  w-rig-ubi-ori-des      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Ubicazione di destinazione                        *
      *            *---------------------------------------------------*
               10  w-rig-ubi-dst          pic  x(07)                  .
               10  w-rig-ubi-dst-des      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Giacenza prodotto                                 *
      *            *---------------------------------------------------*
               10  w-rig-gia-pro          pic s9(08)v9(03)            .
           05  w-rig-002.
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-ubi-dst  pic  x(07)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-gia-pro  pic  x(07)                  .
      ...
      *                  *---------------------------------------------*
           perform   acc-ubi-ori-000      thru acc-ubi-ori-999        .
      ...
      *                  * Ubicazione di destinazione                  *
      *                  *---------------------------------------------*
           perform   acc-ubi-dst-000      thru acc-ubi-dst-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Ubicazione di origine                           *
      *              *-------------------------------------------------*
           perform   vis-ubi-ori-000      thru vis-ubi-ori-999        .
      *              *-------------------------------------------------*
      *               * Ubicazione di destinazione                     *
      *              *-------------------------------------------------*
           perform   vis-ubi-dst-000      thru vis-ubi-dst-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Ubicazione di origine                       *
      *                  *---------------------------------------------*
           perform   pmt-ubi-ori-000      thru pmt-ubi-ori-999        .
      *                  *---------------------------------------------*
      ...
      *              * Ubicazione di origine                           *
      *              *-------------------------------------------------*
           perform   pmt-ubi-dst-000      thru pmt-ubi-dst-999        .
       pmt-key-reg-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione prompt : Ubicazione di origine            *
      *    *-----------------------------------------------------------*
       pmt-ubi-ori-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Codice ubicazione attuale  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ubi-ori-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Ubicazione di destinazione       *
      *    *-----------------------------------------------------------*
       pmt-ubi-dst-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice ubicazione di origine         *
      *    *-----------------------------------------------------------*
       acc-ubi-ori-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-ubi-ori        to   w-cod-des-zub-cod      .
       ...
       acc-ubi-ori-110.
           ...
           if        w-cod-des-zub-ope    =    "F+"
                     go to acc-ubi-ori-115.
           if        w-cod-des-zub-ope    =    "AC"
                     go to acc-ubi-ori-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-ubi-ori-115.
           perform   cod-des-zub-foi-000  thru cod-des-zub-foi-999    .
           go to     acc-ubi-ori-110.
       acc-ubi-ori-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-ubi-ori-999.
       acc-ubi-ori-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-ubi-ori          .
       acc-ubi-ori-400.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice ubicazione di origine      *
      *    *-----------------------------------------------------------*
       vis-ubi-ori-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice ubicazione di destinazione    *
      *    *-----------------------------------------------------------*
       acc-ubi-dst-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-zub-ope      .
           move      w-tes-cod-dpz        to   w-cod-des-zub-dpz      .
           move      w-tes-ubi-dst        to   w-cod-des-zub-cod      .
           move      07                   to   w-cod-des-zub-lin      .
           move      30                   to   w-cod-des-zub-pos      .
           move      zero                 to   w-cod-des-zub-dln      .
           move      zero                 to   w-cod-des-zub-dps      .
           move      spaces               to   v-edm                  .
       ...
       acc-ubi-dst-110.
           perform   cod-des-zub-cll-000  thru cod-des-zub-cll-999    .
           if        w-cod-des-zub-ope    =    "F+"
                     go to acc-ubi-dst-115.
           if        w-cod-des-zub-ope    =    "AC"
                     go to acc-ubi-dst-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-ubi-dst-115.
           perform   cod-des-zub-foi-000  thru cod-des-zub-foi-999    .
           go to     acc-ubi-dst-110.
       acc-ubi-dst-120.
           move      w-cod-des-zub-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-ubi-dst-999.
       acc-ubi-dst-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-ubi-dst          .
       acc-ubi-dst-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-dpz        to   w-let-arc-zub-dpz      .
           move      w-tes-ubi-dst        to   w-let-arc-zub-cod      .
           perform   let-arc-zub-000      thru let-arc-zub-999        .
      *                  *---------------------------------------------*
      *                  * Test su esito lettura                       *
      *                  *---------------------------------------------*
           if        w-let-arc-zub-flg    =    spaces
                     go to acc-ubi-dst-600.
      *                  *---------------------------------------------*
      *                  * Se ubicazione non trovata                   *
      *                  *---------------------------------------------*
           move      "Ubicazione non trovata!                        
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice ubicazione di destinazione *
      *    *-----------------------------------------------------------*
       vis-ubi-dst-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Ubicazione di destinazione                  *
      *                  *---------------------------------------------*
           perform   acc-rig-ubd-000      thru acc-rig-ubd-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * Ubicazione di destinazione                  *
      *                  *---------------------------------------------*
           move      w-rig-ubi-dst        to   w-lin-imm-ubi-dst      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Giacenza prodotto                           *
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "B"                  to   v-edm                  .
           move      w-rig-gia-pro        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-gia-pro      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.  Codice e descrizione prodotti              
      -              "               Ubicaz.  Giac. "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              * Ubicazione di destinazione                      *
      *              *-------------------------------------------------*
           perform   vis-rig-ubd-000      thru vis-rig-ubd-999        .
      *              *-------------------------------------------------*
      *              * Giacenza                                        *
      *              *-------------------------------------------------*
           perform   vis-gia-pro-000      thru vis-gia-pro-999        .
       vis-rig-cor-999.
           exit.
      ...
      *              * Ubicazione di destinazione                      *
      *              *-------------------------------------------------*
           perform   pmt-rig-ubd-000      thru pmt-rig-ubd-999        .
      *              *-------------------------------------------------*
      *              * Giacenza                                        *
      *              *-------------------------------------------------*
           perform   pmt-gia-pro-000      thru pmt-gia-pro-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Giacenza prodotto                *
      *    *-----------------------------------------------------------*
       pmt-gia-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-zub-ope      .
           move      w-tes-cod-dpz        to   w-cod-des-zub-dpz      .
           move      w-rig-ubi-dst        to   w-cod-des-zub-cod      .
       ...
       acc-rig-ubd-110.
           perform   cod-des-zub-cll-000  thru cod-des-zub-cll-999    .
           if        w-cod-des-zub-ope    =    "F+"
                     go to acc-rig-ubd-115.
           if        w-cod-des-zub-ope    =    "AC"
                     go to acc-rig-ubd-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-ubd-115.
           perform   cod-des-zub-foi-000  thru cod-des-zub-foi-999    .
           go to     acc-rig-ubd-110.
       acc-rig-ubd-120.
           move      w-cod-des-zub-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-ubd-999.
       acc-rig-ubd-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-rig-ubi-dst          .
       acc-rig-ubd-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Giacenza prodotto                 *
      *    *-----------------------------------------------------------*
       vis-gia-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-key-100.
      *              *-------------------------------------------------*
      *              * Test su codice ubicazione di origine            *
      *              *-------------------------------------------------*
           if        w-tes-ubi-ori        not  = spaces
                     go to cnt-tdo-key-200.
           move      "Manca il codice ubicazione di origine             
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
       ...
       cnt-tdo-key-200.
      *              *-------------------------------------------------*
      *              * Test su codice ubicazione di destinazione       *
      *              *-------------------------------------------------*
           if        w-tes-ubi-dst        not  = spaces
                     go to cnt-tdo-key-300.
           move      "Manca il codice ubicazione di destinazione        
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
           move      "#"                  to   w-cnt-tdo-key-flg      .
           go to     cnt-tdo-key-999.
       cnt-tdo-key-300.
      *              *-------------------------------------------------*
      *              * Test su codici ubicazione                       *
      *              *-------------------------------------------------*
           if        w-tes-ubi-ori        not  = w-tes-ubi-dst
                     go to cnt-tdo-key-500.
           move      "Codici ubicazione uguali!                         
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
           move      "#"                  to   w-cnt-tdo-key-flg      .
           go to     cnt-tdo-key-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-tes-ubi-ori          .
           move      spaces               to   w-tes-ubi-ori-des      .
      *              *-------------------------------------------------*
      *              * Normalizzazione selettori sui dati              *
      *              *-------------------------------------------------*
           move      spaces               to   w-tes-ubi-dst          .
           move      spaces               to   w-tes-ubi-dst-des      .
       nor-key-reg-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-rig-ubi-ori          .
           move      spaces               to   w-rig-ubi-ori-des      .
           move      spaces               to   w-rig-ubi-dst          .
           move      spaces               to   w-rig-ubi-dst-des      .
           move      zero                 to   w-rig-gia-pro          .
       nor-nok-rig-999.
           exit.
      ...
      *              * Caricamento                                     *
      *              *-------------------------------------------------*
           perform   car-fil-rap-ubi-000  thru car-fil-rap-ubi-999    .
       car-fil-rap-999.
           exit.
      ...
      *                      * Ubicazione originale                    *
      *                      *-----------------------------------------*
           move      w-tes-ubi-ori        to   srt-cod-ubi            .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-des-pro          to   w-rig-alf-pro-des      .
       car-eff-rig-200.
           move      w-tes-ubi-ori        to   w-rig-ubi-ori          .
           move      w-tes-ubi-dst        to   w-rig-ubi-dst          .
           move      srt-qta-ubi          to   w-rig-gia-pro          .
       car-eff-rig-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Giroconti di magazzino                      *
      *                  *---------------------------------------------*
           perform   sca-fil-rap-mag-000  thru sca-fil-rap-mag-999    .
       sca-fil-rap-400.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-num-pro        =    zero
                     go to sca-fil-rap-mag-900.
           if        w-rig-gia-pro        =    zero
                     go to sca-fil-rap-mag-900.
           if        w-rig-ubi-ori        =    spaces
                     go to sca-fil-rap-mag-900.
           if        w-rig-ubi-dst        =    spaces
                     go to sca-fil-rap-mag-900.
           if        w-rig-ubi-ori        =    w-rig-ubi-dst
                     go to sca-fil-rap-mag-900.
       sca-fil-rap-mag-100.
      *              *-------------------------------------------------*
      *              * Trattamento testata                             *
      ...
      *                  *---------------------------------------------*
           ...
           move      w-det-gia-ubi-dat    to   l-mag-300-dat-reg      .
           move      zero                 to   l-mag-300-num-prt      .
           move      01                   to   l-mag-300-cod-dpz      .
           move      00059                to   l-mag-300-cod-cau      .
           move      spaces               to   l-mag-300-cod-ctm      .
           move      w-det-gia-ubi-dat    to   l-mag-300-dat-doc      .
      *                  *---------------------------------------------*
      *                  * Responsabile (utente)                       *
      *                  *---------------------------------------------*
           move      "IG"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-ute                to   l-mag-300-num-doc      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-gia-pro        to   l-mag-300-qta-mov      .
           move      w-rig-ubi-ori        to   l-mag-300-cod-dsl      .
           move      w-rig-ubi-dst        to   l-mag-300-cod-dsd      .
           perform   mdl-agg-mag-cll-000  thru mdl-agg-mag-cll-999    .
       sca-fil-rap-mag-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     sca-fil-rap-mag-999.
       sca-fil-rap-mag-999.
           exit.
