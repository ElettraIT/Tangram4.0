      ...
      *================================================================*
      *                                                                *
      * Gestione file relative di supporto per programma pmag6200      *
      *                                                                *
      * ============================================================== *
      * Tipi operazione                                                *
      *                                                                *
      ...
      *                      w-rlt-sup-prg = zero                      *
      *                      w-rlt-sup-app = spaces                    *
      *                      w-rlt-sup-new = spaces                    *
      ...
      *                      w-rlt-sup-app = invariato                 *
      *                      w-rlt-sup-new = invariato                 *
      *                      w-rlt-sup-lst = invariato                 *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-pnt.
      *        *-------------------------------------------------------*
      *        * Massimo numero elementi gestiti nella catena          *
      *        *-------------------------------------------------------*
           05  w-pnt-max-ele              pic  9(05) value 99999      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-rlt-sup-app          .
      *              *-------------------------------------------------*
      *              * Flag di record New : No                         *
      *              *-------------------------------------------------*
           move      spaces               to   w-rlt-sup-new          .
      *              *-------------------------------------------------*
      *              * Flag di record Last : No                        *
      *              *-------------------------------------------------*
           move      spaces               to   w-rlt-sup-lst          .
       beg-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      "#"                  to   w-rlt-sup-new          .
      *                  *---------------------------------------------*
      *                  * Flag di record Last : Si                    *
      *                  *---------------------------------------------*
           move      "#"                  to   w-rlt-sup-lst          .
      *                  *---------------------------------------------*
      *                  * Buffer in uscita : spaces                   *
      *                  *---------------------------------------------*
           move      spaces               to   w-rlt-sup-buf          .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     rea-999.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento numero progressivo ultimo ele-   *
      *                  * mento                                       *
      *                  *---------------------------------------------*
           add       1                    to   w-rlt-sup-max          .
      *                  *---------------------------------------------*
      *                  * Preparazione numero progressivo per scrit-  *
      *                  * tura                                        *
      *                  *---------------------------------------------*
      ...
      *              * Flag di append                                  *
      *              *-------------------------------------------------*
           if        w-rlt-sup-max        not  < w-pnt-max-ele
                     move  "#"            to   w-rlt-sup-app
           else      move  spaces         to   w-rlt-sup-app          .
      *              *-------------------------------------------------*
      *              * Flag di record Last                             *
      *              *-------------------------------------------------*
           if        w-rlt-sup-prg        =    w-rlt-sup-max
                     move  "#"            to   w-rlt-sup-lst
           else      move  spaces         to   w-rlt-sup-lst          .
       dpf-999.
           exit.
