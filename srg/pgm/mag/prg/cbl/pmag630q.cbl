      ...
      *            *---------------------------------------------------*
      *            * Flag di rilevazione effettuata                    *
      *            *---------------------------------------------------*
               10  srt-flg-ril            pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Quantita' rilevata                                *
      *            *---------------------------------------------------*
               10  srt-qta-rlv            pic s9(08)v9(03)            .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-mim-flg-ril       to   srt-flg-ril            .
           move      rf-mim-qta-rlv       to   srt-qta-rlv            .
      *              *-------------------------------------------------*
      ...
      *                      * Determinazione                          *
      *                      *-----------------------------------------*
           subtract  srt-qta-prs          from srt-qta-rlv
      ...
      *              *-------------------------------------------------*
      ...
      -              "            Udm  Q.ta' presunta  Q.ta' rilevata   
      -              " Differenza           Note      "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
