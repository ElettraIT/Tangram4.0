      ...
      *                       Ultima revisione:    NdK del 21/11/97    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Prospetto inventariale materiali vari       *
      *                                                                *
      *================================================================*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Valore primo parametro di ubicazione    *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      07                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      098                  to   p-pos                  .
           move      rf-mim-prm-ubi (1)   to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           go to     prn-liv-det-300.
       prn-liv-det-240.
      ...
      *              *-------------------------------------------------*
           move      "PROSPETTO PER LA RILEVAZIONE DELL'INVENTARIO DEI M
      -              "ATERIALI VARI"      to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
