      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione costo unitario per piu' prodotti   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  GESTIONE COSTO UNITARIO PER PRODOTTI  "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.   Cod. prodotto   Costo standard           D
      -              "escrizione prodotto           "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.   Cod. prodotto    Costo ultimo            D
      -              "escrizione prodotto           "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Unita' di misura di vendita       *
      *    *-----------------------------------------------------------*
       vis-umi-ven-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/mag/prg/obj/pmag2312"                       .
       cnc-rlt-sup-999.
           exit.
