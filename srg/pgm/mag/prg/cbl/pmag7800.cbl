      ...
      *                                   Fase:    mag780              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 11/02/00    *
      *                       Ultima revisione:    NdK del 26/11/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag7801:        *
      *                                                                *
      *                    Aggiornamento schede L.I.F.O. prodotti      *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      13                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Il programma, in presenza di scaglioni con rimanen
      -              "za finale ma privi di costo   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *
           ...
           move      14                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "medio ponderato, aggiorna lo scaglione privo di va
      -              "lore unitario con il costo    "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *
           ...
           move      15                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "medio ponderato dello scaglione precedente o dell'
      -              "ultimo valorizzato.           "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
