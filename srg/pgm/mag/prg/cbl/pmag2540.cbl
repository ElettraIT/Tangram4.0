      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag2541:        *
      *                                                                *
      *                    Stampa costi unitari materiali vari         *
      *                                                                *
      *================================================================*
      ...
      *        * - 01 : Solo materiali vari con costo diverso da zero  *
      *        * - 02 : Solo materiali vari con costo a zero           *
      *        * - 03 : Tutti i materiali vari                         *
      *        *-------------------------------------------------------*
           ...
           05  w-exp-snx-zer.
               ...
               10  w-exp-snx-zer-tbl.
                   15  filler             pic  x(45)       value
                       "Solo materiali vari con costo diverso da zero".
                   15  filler             pic  x(45)       value
                       "Solo materiali vari con costo a zero         ".
                   15  filler             pic  x(45)       value
                       "Tutti i materiali vari                       ".
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-fso-mtv           to   w-cod-zos-mtv-cod      .
      ...
      *                  * mento per file [mtv]                        *
      *                  *---------------------------------------------*
           move      rr-fso-mtv           to   w-let-fso-mtv-cod      .
           perform   let-fso-mtv-000      thru let-fso-mtv-999        .
           move      w-let-fso-mtv-des    to   rr-fso-mtv-des         .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      s-pat               using f
                                               rf-mtv                 .
           if        f-sts                =    "01"
                     move  01             to   rr-fso-mtv-ord
           else if   f-sts                =    "02"
                     move  02             to   rr-fso-mtv-ord
           else if   f-sts                =    "03"
                     move  03             to   rr-fso-mtv-ord
           else if   f-sts                =    "04"
                     move  04             to   rr-fso-mtv-ord
           else      move  01             to   rr-fso-mtv-ord         .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      zero                 to   rr-fso-mtv             .
           move      spaces               to   rr-fso-mtv-des         .
           move      zero                 to   rr-fso-mtv-ord         .
