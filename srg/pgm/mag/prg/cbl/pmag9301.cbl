      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma pmag9301:       *
      *                                                                *
      *                    Stampa valorizzazione L.i.f.o. per          *
      *                    prodotti di vendita                         *
      *                    (Da scheda esercizio attuale)               *
      *                                                                *
      *                    N.B.: Differisce dal '730' solo per la      *
      *                          richiesta del totale                  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Si/No stampa intestazione                             *
      *        * - 01 : Si                                             *
      *        * - 02 : No                                             *
      *        *-------------------------------------------------------*
           05  rr-snx-int                 pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Totale da esporre                                     *
      *        *-------------------------------------------------------*
           05  rr-tot-esp                 pic  9(13)                  .
      *        *-------------------------------------------------------*
      *        * Data da esporre                                       *
      *        *-------------------------------------------------------*
           05  rr-dat-esp                 pic  9(07)                  .
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-stp-srt-inx-i1i          pic  9(02)                  .
           05  w-stp-srt-inx-s04          pic  9(04)                  .
           05  w-stp-srt-inx-saa          pic  9(03)                  .
           05  w-stp-srt-inx-sat          pic  9(04)                  .
           05  w-stp-srt-inx-sar          pic  9(04)                  .
      ...
      *              *-------------------------------------------------*
      *              * Ritaratura fase gestionale                      *
      *              *-------------------------------------------------*
           move      "mag730"             to   p-sel-fas-ges          .
       let-sel-stp-999.
           exit.
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-310.
      *                  *---------------------------------------------*
      *                  * Determinazione costo L.i.f.o. su scheda re- *
      *                  * lativa all'esercizio in corso               *
      *                  *---------------------------------------------*
           move      "VM"                 to   d-vun-mag-tip-ope      .
           move      0014                 to   d-vun-mag-tip-val      .
      *
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-saa                to   w-stp-srt-inx-saa      .
           move      s-saa                to   w-stp-srt-inx-sat      .
           add       1900                 to   w-stp-srt-inx-sat      .
      *                  *---------------------------------------------*
      *                  * Anno di esercizio richiesto, di 4 cifre     *
      *                  *---------------------------------------------*
           move      rr-ann-ese           to   w-stp-srt-inx-sar      .
           add       1900                 to   w-stp-srt-inx-sar      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-stp-srt-inx-saa    to   rf-mmv-ann-ese         .
      ...
      *                      *-----------------------------------------*
      *                      * Se scheda non trovata : a riciclo       *
      *                      *-----------------------------------------*
           go to     stp-srt-inp-800.
       stp-srt-inp-450.
      *              *-------------------------------------------------*
      ...
      *                          * Indice                              *
      *                          *-------------------------------------*
           move      zero                 to   w-stp-srt-inx-s04      .
           move      zero                 to   w-stp-srt-inx-i1i      .
       cmp-srt-rec-705.
           add       1                    to   w-stp-srt-inx-i1i      .
           if        w-stp-srt-inx-i1i    >    09
                     go to cmp-srt-rec-710.
           subtract  w-stp-srt-inx-i1i    from w-stp-srt-inx-sat
                                        giving w-stp-srt-inx-s04      .
           if        w-stp-srt-inx-s04    =    w-stp-srt-inx-sar
                     go to cmp-srt-rec-710.
           go to     cmp-srt-rec-705.
       cmp-srt-rec-710.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-mmv-rim-pre
                    (w-stp-srt-inx-i1i)   to   srt-val-lif-rim        .
      *                      *-----------------------------------------*
      *                      * Valore della rimanenza finale           *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rr-ann-ese           to   w-rie-ese-ann-att      .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-stp-int-wed-ae0      .
      *
      ...
      *                  *---------------------------------------------*
           ...
           else      move  rr-dat-esp     to   w-stp-int-dat-stp      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      076                  to   p-pos                  .
           if        rr-tot-esp           =    zero
                     move  w-stp-sta-tot-vlr
                                          to   p-num
           else      move  rr-tot-esp     to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-sta-tot-999.
           exit.
