      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma pmag7241:       *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           move      rr-fso-dps-ord       to   w-tip-ord-tip-ord      .
       prn-opn-fls-999.
           exit.
      ...
      *                      * Codice numerico                         *
      *                      *-----------------------------------------*
           move      rf-dps-num-sem       to   srt-cod-mag-num        .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico                     *
      *                      *-----------------------------------------*
           move      rf-dps-alf-sem       to   srt-cod-mag-alf        .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      *                      *-----------------------------------------*
           move      rf-dps-des-sem       to   srt-cod-mag-des        .
      *                      *-----------------------------------------*
      *                      * Unita' di misura                        *
      *                      *-----------------------------------------*
           move      rf-dps-umi-prd       to   srt-cod-mag-umi        .
      *                      *-----------------------------------------*
      *                      * Numero decimali quantita'               *
      *                      *-----------------------------------------*
           move      rf-dps-dec-qta       to   srt-cod-mag-dec       .
      *                      *-----------------------------------------*
      *                      * Classe merceologica                     *
      *                      *-----------------------------------------*
           move      rf-dps-cla-sem       to   srt-cod-mag-cla       .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico                     *
      *                      *-----------------------------------------*
           move      rf-dps-gru-sem       to   srt-cod-mag-gru        .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico                *
      *                      *-----------------------------------------*
           move      rf-dps-sgr-sem       to   srt-cod-mag-sgr        .
       cmp-srt-rec-700.
      *                  *---------------------------------------------*
      *                  * Valori L.i.f.o.                             *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun semilavorato da valorizzare !"
                                          to   m-msg                  .
      ...
      *                  * Lettura dati classe                         *
      *                  *---------------------------------------------*
           move      w-rot-l04-cod-cla    to   w-let-arc-zs1-cla      .
      ...
      *                  * Lettura dati gruppo                         *
      *                  *---------------------------------------------*
           move      w-rot-l04-cod-cla    to   w-let-arc-zs2-cla      .
           move      w-rot-l03-cod-gru    to   w-let-arc-zs2-gru      .
      ...
      *                  *---------------------------------------------*
           move      w-rot-l04-cod-cla    to   w-let-arc-zs3-cla      .
           move      w-rot-l03-cod-gru    to   w-let-arc-zs3-gru      .
           move      w-rot-l02-cod-sgr    to   w-let-arc-zs3-sgr      .
