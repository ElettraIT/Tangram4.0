      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pmag7100 *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
      *        * Segnale di almeno una rivalutazione incontrata        *
      *        *-------------------------------------------------------*
           05  w-stp-sch-lif-rv1          pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-020.
      *              *-------------------------------------------------*
      *              * Normalizzazione segnale di almeno una rivaluta- *
      *              * zione incontrata                                *
      *              *-------------------------------------------------*
           move      spaces               to   w-stp-sch-lif-rv1      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Segnale di almeno una rivalutazione         *
      *                  *---------------------------------------------*
           if        rf-mmv-fdr-gea       not  = spaces
                     move "#"             to   w-stp-sch-lif-rv1      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-sel-rec-260.
      *                  *---------------------------------------------*
      *                  * Se solo le schede con rivalutazioni         *
      *                  *---------------------------------------------*
           if        w-stp-sch-lif-rv1    not  = spaces
                     go to prn-sel-rec-800
           else      go to prn-sel-rec-900.
       prn-sel-rec-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           string    "SCHEDE L.I.F.O. PRODOTTI DI VENDITA RELATIVE AL "
                                delimited by   size
