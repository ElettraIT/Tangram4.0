      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma mag012   *
      *                    Stampa dislocazioni di magazzino            *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-dpz           to   rf-zmd-cod-dpz         .
           move      rr-cod-min           to   rf-zmd-cod-dsl         .
           move      "pgm/mag/fls/ioc/obj/iofzmd"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-dpz           to   rf-zmd-cod-dpz         .
           move      rr-des-min           to   rf-zmd-des-key         .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna dislocazione entro i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zmd]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/mag/fls/ioc/obj/iofzmd"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-zmd-cod-dpz       not  = rr-cod-dpz
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zmd-cod-dsl       <    rr-cod-min or
                     rf-zmd-cod-dsl       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zmd-des-key       <    rr-des-min or
                     rf-zmd-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "DISLOCAZIONI DI MAGAZZINO"
