      ...
      *                       Ultima revisione:    NdK del 23/03/05    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase mag450, nella sua globalita', esegue i tipi di manu-   *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * MANQIE      Manutenzione quantita' inizio esercizio       455a *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'mag450'           *
      *              *-------------------------------------------------*
           perform   fas-mag-450-000      thru fas-mag-450-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Manutenzione quantita' inizio esercizio           
      -              " MANQIE     pmag450a  "
                                          to   w-tmn-ele-wci          .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-mag-450-300
           else if   v-key                =    "PRSC"
                     go to fas-mag-450-400
           else if   v-key                =    "NXSC"
                     go to fas-mag-450-450
           else if   v-key                =    "DOWN"
                     go to fas-mag-450-500
           else if   v-key                =    "EXIT"
                     go to fas-mag-450-250
           else      go to fas-mag-450-200.
       fas-mag-450-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-man        =    zero
                     go to fas-mag-450-330.
           move      zero                 to   w-tmn-ele-inx          .
       fas-mag-450-322.
           add       1                    to   w-tmn-ele-inx          .
           if        w-tmn-ele-inx        >    w-tmn-ele-num
                     go to fas-mag-450-340.
           if        w-tmn-num-tmn
                    (w-tmn-ele-inx)       =    w-key-num-man
                     go to fas-mag-450-350
           else      go to fas-mag-450-322.
       fas-mag-450-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-mag-450-630
           else if   v-key                =    "PRSC"
                     go to fas-mag-450-600
           else if   v-key                =    "NXSC"
                     go to fas-mag-450-610
           else if   v-key                =    "UP  "
                     go to fas-mag-450-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-mag-450-650
           else if   v-key                =    "EXIT"
                     go to fas-mag-450-660
           else      go to fas-mag-450-570.
       fas-mag-450-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-mag-450-626
           else      go to fas-mag-450-628.
       fas-mag-450-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-mag-450-636
           else      go to fas-mag-450-638.
       fas-mag-450-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-mag-450-725
           else      go to fas-mag-450-455.
       fas-mag-450-725.
      *              *-------------------------------------------------*
