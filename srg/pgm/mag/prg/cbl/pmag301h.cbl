      ...
      *                                                                *
      *                    Ricerca movimenti per materiale vario       *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-mag           to   w-cod-cod-mtv-num      .
           move      rr-alf-mag           to   w-cod-cod-mtv-alf      .
      ...
      *                  *---------------------------------------------*
           move      rr-cod-mag           to   w-let-arc-mtv-num      .
           move      rr-alf-mag           to   w-let-arc-mtv-alf      .
           perform   let-arc-mtv-000      thru let-arc-mtv-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione magazzino        *
      *                  *---------------------------------------------*
           move      w-let-arc-mtv-des    to   rr-cod-mag-des         .
      *                  *---------------------------------------------*
      *                  * Memorizzazione unita' di misura             *
      *                  *---------------------------------------------*
           move      w-let-arc-mtv-umi    to   rr-cod-mag-umi         .
      *                  *---------------------------------------------*
      *                  * Memorizzazione numero decimali quantita'    *
      *                  *---------------------------------------------*
           move      w-let-arc-mtv-ndq    to   rr-cod-mag-ndq         .
       acc-cod-mag-420.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "Manca il codice materiale vario !                 
      ...
      *                          *-------------------------------------*
           move      w-sav-cod-dpz        to   w-let-arc-zmd-dpz      .
           move      w-sav-cod-dsl        to   w-let-arc-zmd-cod      .
      ...
      *                          *-------------------------------------*
           move      w-sav-cod-dpz        to   w-let-arc-zmd-dpz      .
           move      w-sav-cod-dsd        to   w-let-arc-zmd-cod      .
           perform   let-arc-zmd-000      thru let-arc-zmd-999        .
      *                          *-------------------------------------*
      *                          * Stampa                              *
      *                          *-------------------------------------*
