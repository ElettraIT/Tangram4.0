      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmag9301:        *
      *                                                                *
      ...
      *                  * Totale da esporre                           *
      *                  *---------------------------------------------*
           perform   acc-tot-esp-000      thru acc-tot-esp-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Data da esporre                             *
      *                  *---------------------------------------------*
           perform   acc-dat-esp-000      thru acc-dat-esp-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
                     go to acc-ric-sel-500.
      ...
      *                  *---------------------------------------------*
           ...
           perform   vis-snx-int-000      thru vis-snx-int-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/No intestazione                      *
      *    *-----------------------------------------------------------*
       vis-snx-int-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Totale da esporre                          *
      *    *-----------------------------------------------------------*
       acc-tot-esp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-tot-esp-999.
       acc-tot-esp-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-tot-esp             .
       acc-tot-esp-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-tot-esp-100.
       acc-tot-esp-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Totale da esporre                       *
      *    *-----------------------------------------------------------*
       vis-tot-esp-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-dat-esp-100.
       acc-dat-esp-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Data da esporre                         *
      *    *-----------------------------------------------------------*
       vis-dat-esp-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      *              * Normalizzazione Si/No intestazione              *
      *              *-------------------------------------------------*
           if        rr-snx-int           =    zero
                     move  01             to   rr-snx-int             .
       reg-ric-sel-999.
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      zero                 to   rr-tot-esp             .
           move      zero                 to   rr-dat-esp             .
       nor-ric-sel-999.
           exit.
