      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione costo saldo quantita' per singola  *
      *                    materia prima                               *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  SCHEDE SALDO QUANTITA' MATERIE PRIME  "       .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice materia prima          *
      *    *-----------------------------------------------------------*
       pmt-cod-map-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-let-arc-dpm-udm    to   w-tes-num-mag-udm      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dpm-umi-prd       to   w-let-arc-dpm-udm      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-dpm-600.
           move      spaces               to   w-let-arc-dpm-udm      .
       let-arc-dpm-999.
           exit.
