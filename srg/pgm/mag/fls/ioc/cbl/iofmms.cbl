      ...
      *        *-------------------------------------------------------*
           05  fil-dat.
               ...
               10  fil-prg-mes occurs 12.
                   15  fil-prg-car        pic s9(08)v9(03) comp-3     .
                   15  fil-prg-sca        pic s9(08)v9(03) comp-3     .
               10  fil-dip-ife            pic s9(08)v9(03) comp-3     .
               10  fil-din-ife            pic s9(08)v9(03) comp-3     .
               10  fil-flg-zer            pic  x(01)                  .
               10  fil-alx-exp.
      ...
      *        *-------------------------------------------------------*
           05  pul-dat.
               ...
               10  pul-prg-mes occurs 12.
                   15  pul-prg-car        pic s9(08)v9(03) comp-3     .
                   15  pul-prg-sca        pic s9(08)v9(03) comp-3     .
               10  pul-dip-ife            pic s9(08)v9(03) comp-3     .
               10  pul-din-ife            pic s9(08)v9(03) comp-3     .
               10  pul-flg-zer            pic  x(01)                  .
               10  pul-alx-exp.
                   15  filler  occurs 19  pic  x(01)                  .
      ...
      *    *===========================================================*
      *    * Record logico file [mms]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/mag/fls/rec/rfmms"                          .

      ******************************************************************
       Procedure Division                using f rf-mms               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       ...
       nor-rec-log-400.
           move      zero                 to   rf-mms-dip-ife         .
           move      zero                 to   rf-mms-din-ife         .
           move      spaces               to   rf-mms-flg-zer         .
           move      spaces               to   rf-mms-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-mms-qta-ini       to   fil-qta-ini            .
           move      zero                 to   w-cix-ctr-001          .
       cmp-log-fis-200.
           add       1                    to   w-cix-ctr-001          .
           if        w-cix-ctr-001        >    12
           ...
           move      rf-mms-prg-car
                    (w-cix-ctr-001)       to   fil-prg-car
                                              (w-cix-ctr-001)         .
           move      rf-mms-prg-sca
                    (w-cix-ctr-001)       to   fil-prg-sca
                                              (w-cix-ctr-001)         .
           go to     cmp-log-fis-200.
       cmp-log-fis-400.
           move      rf-mms-dip-ife       to   fil-dip-ife            .
           move      rf-mms-din-ife       to   fil-din-ife            .
           move      rf-mms-flg-zer       to   fil-flg-zer            .
           move      rf-mms-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-mms-ann-ese       to   fil-ann-ese            .
           move      rf-mms-cod-dpz       to   fil-cod-dpz            .
           move      rf-mms-cod-dsl       to   fil-cod-dsl            .
           move      rf-mms-tip-mag       to   fil-tip-mag            .
           move      rf-mms-num-mag       to   fil-num-mag            .
           move      rf-mms-var-mag       to   fil-var-mag            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-mms-ann-ese       to   fil-ann-ese-2          .
           move      rf-mms-cod-dpz       to   fil-cod-dpz-2          .
           move      rf-mms-tip-mag       to   fil-tip-mag-2          .
           move      rf-mms-num-mag       to   fil-num-mag-2          .
           move      rf-mms-var-mag       to   fil-var-mag-2          .
           move      rf-mms-cod-dsl       to   fil-cod-dsl-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-mms-ann-ese       to   fil-ann-ese-3          .
           move      rf-mms-tip-mag       to   fil-tip-mag-3          .
           move      rf-mms-num-mag       to   fil-num-mag-3          .
           move      rf-mms-var-mag       to   fil-var-mag-3          .
           move      rf-mms-cod-dpz       to   fil-cod-dpz-3          .
           move      rf-mms-cod-dsl       to   fil-cod-dsl-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-mms                 .
           move      fil-ann-ese          to   rf-mms-ann-ese         .
           move      fil-cod-dpz          to   rf-mms-cod-dpz         .
           move      fil-cod-dsl          to   rf-mms-cod-dsl         .
           move      fil-tip-mag          to   rf-mms-tip-mag         .
           move      fil-num-mag          to   rf-mms-num-mag         .
           move      fil-var-mag          to   rf-mms-var-mag         .
           move      fil-qta-ini          to   rf-mms-qta-ini         .
           move      zero                 to   w-cix-ctr-001          .
       dec-fis-log-200.
           add       1                    to   w-cix-ctr-001          .
           if        w-cix-ctr-001        >    12
       ...
       dec-fis-log-400.
           move      fil-dip-ife          to   rf-mms-dip-ife         .
           move      fil-din-ife          to   rf-mms-din-ife         .
           move      fil-flg-zer          to   rf-mms-flg-zer         .
           move      fil-alx-exp          to   rf-mms-alx-exp         .
       dec-fis-log-999.
           exit.
