      ...
      *                                   Fase:    abi200              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 02/04/91    *
      *                       Ultima revisione:    NdK del 14/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione archivio Sportelli bancari (CAB)   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " GESTIONE SPORTELLI ISTITUTI DI CREDITO "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-den-spt          pic  x(40)                  .
               10  w-tes-via-spt          pic  x(40)                  .
               10  w-tes-loc-spt          pic  x(40)                  .
               ...
               10  w-tes-den-ric          pic  x(40)                  .
               10  w-tes-cod-mne          pic  x(10)                  .
               10  w-tes-cod-bic          pic  x(11)                  .
               10  w-tes-alx-exp          pic  x(09)                  .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-ipc-dlp-cod-abi      .
       ipc-dlp-100.
      *              *-------------------------------------------------*
      *              * Estrazione Codice ABI                           *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           move      s-num                to   w-ipc-dlp-cod-abi      .
       ipc-dlp-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice istituto ABI           *
      *    *-----------------------------------------------------------*
       pmt-cod-abi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice sportello CAB          *
      *    *-----------------------------------------------------------*
       pmt-cod-cab-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Eventuale default da ipc                    *
      *                  *---------------------------------------------*
           if        w-ipc-dlp-cod-abi    not  = zero
                     move  w-ipc-dlp-cod-abi
                                          to   w-tes-cod-abi
                     perform vis-cod-abi-000
                                          thru vis-cod-abi-999        .
       acc-cod-abi-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice sportello CAB          *
      *    *-----------------------------------------------------------*
       acc-cod-cab-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      05                   to   w-cod-mne-cab-lin      .
           move      30                   to   w-cod-mne-cab-pos      .
           move      10                   to   w-cod-mne-cab-dln      .
           move      30                   to   w-cod-mne-cab-dps      .
           move      "9B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice sportello CAB       *
      *    *-----------------------------------------------------------*
       vis-cod-cab-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           perform   acc-den-spt-000      thru acc-den-spt-999        .
           if        v-key                =    "NXSC"
      ...
      *                  * Indirizzo sportello                         *
      *                  *---------------------------------------------*
           perform   acc-via-spt-000      thru acc-via-spt-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  * Localita' sportello                         *
      *                  *---------------------------------------------*
           perform   acc-loc-spt-000      thru acc-loc-spt-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Denominazione sportello                         *
      *              *-------------------------------------------------*
           perform   vis-den-spt-000      thru vis-den-spt-999        .
      *              *-------------------------------------------------*
      *              * Denominazione di ricerca                        *
      *              *-------------------------------------------------*
      ...
      *              * Indirizzo sportello                             *
      *              *-------------------------------------------------*
           perform   vis-via-spt-000      thru vis-via-spt-999        .
      *              *-------------------------------------------------*
      *              * Localita' sportello                             *
      *              *-------------------------------------------------*
           perform   vis-loc-spt-000      thru vis-loc-spt-999        .
      *              *-------------------------------------------------*
      *              * Codice mnemonico                                *
      *              *-------------------------------------------------*
      ...
      *              * Denominazione sportello                         *
      *              *-------------------------------------------------*
           perform   pmt-den-spt-000      thru pmt-den-spt-999        .
      *              *-------------------------------------------------*
      *              * Denominazione di ricerca                        *
      *              *-------------------------------------------------*
      ...
      *              * Indirizzo sportello                             *
      *              *-------------------------------------------------*
           perform   pmt-via-spt-000      thru pmt-via-spt-999        .
      *              *-------------------------------------------------*
      *              * Localita' sportello                             *
      *              *-------------------------------------------------*
           perform   pmt-loc-spt-000      thru pmt-loc-spt-999        .
      *              *-------------------------------------------------*
      *              * Codice mnemonico                                *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-den-spt (1)    =    spaces
                     go to acc-den-spt-100.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-via-spt (1)    to   w-ind-cec-geo-ind      .
           move      12                   to   w-ind-cec-geo-lin      .
           move      30                   to   w-ind-cec-geo-pos      .
           move      w-tes-loc-spt (1)    to   w-ind-cec-geo-cec      .
       ...
       acc-via-spt-110.
           ...
           if        w-ind-cec-geo-ope    =    "F+"
                     go to acc-via-spt-115.
           if        w-ind-cec-geo-ope    =    "AC"
                     go to acc-via-spt-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-via-spt-115.
           perform   ind-cec-geo-foi-000  thru ind-cec-geo-foi-999    .
           go to     acc-via-spt-110.
       acc-via-spt-120.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-ind-cec-geo-ind    to   w-tes-via-spt (1)      .
      *              *-------------------------------------------------*
      *              * Altri valori se automatismo eseguito            *
      *              *-------------------------------------------------*
           if        w-ind-cec-geo-aut    =    spaces
                     go to acc-via-spt-400.
      *                  *---------------------------------------------*
      *                  * C.a.p. e citta'                             *
      *                  *---------------------------------------------*
           move      w-ind-cec-geo-cec    to   w-tes-loc-spt (1)      .
           perform   vis-loc-spt-000      thru vis-loc-spt-999        .
      *                  *---------------------------------------------*
      *                  * Comune                                      *
      *                  *---------------------------------------------*
      ...
      *                  * non deve essere a spaces                    *
      *                  *---------------------------------------------*
           if        w-tes-via-spt (1)    =    spaces
                     go to acc-via-spt-600.
      *
           if        w-tes-via-spt (1)
                    (01 : 01)             =    spaces
                     go to acc-via-spt-100.
       acc-via-spt-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-loc-spt (1)    to   w-cap-cit-geo-cec      .
           move      14                   to   w-cap-cit-geo-lin      .
       ...
       acc-loc-spt-110.
           ...
           if        w-cap-cit-geo-ope    =    "F+"
                     go to acc-loc-spt-115.
           if        w-cap-cit-geo-ope    =    "AC"
                     go to acc-loc-spt-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-loc-spt-115.
           perform   cap-cit-geo-foi-000  thru cap-cit-geo-foi-999    .
           go to     acc-loc-spt-110.
       acc-loc-spt-120.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cap-cit-geo-cec    to   w-tes-loc-spt (1)      .
      *              *-------------------------------------------------*
      *              * Altri valori se automatismo eseguito            *
      *              *-------------------------------------------------*
           if        w-cap-cit-geo-aut    =    spaces
                     go to acc-loc-spt-400.
       acc-loc-spt-300.
      *                  *---------------------------------------------*
      ...
      *                  * non deve essere a spaces                    *
      *                  *---------------------------------------------*
           if        w-tes-loc-spt (1)    =    spaces
                     go to acc-loc-spt-600.
      *
           if        w-tes-loc-spt (1)
                    (01 : 01)             =    spaces
                     go to acc-loc-spt-100.
       acc-loc-spt-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-den-spt (1)      .
           move      spaces               to   w-tes-via-spt (1)      .
           move      spaces               to   w-tes-loc-spt (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cab        to   rf-axs-cod-cab         .
           move      "pgm/abi/fls/ioc/obj/iofaxs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [axs]                        *
      *                          *-------------------------------------*
           move      rf-axs-den-spt       to   w-tes-den-spt (1)      .
           move      rf-axs-via-spt       to   w-tes-via-spt (1)      .
           move      rf-axs-loc-spt       to   w-tes-loc-spt (1)      .
           move      rf-axs-den-ric       to   w-tes-den-ric (1)      .
           move      rf-axs-cod-mne       to   w-tes-cod-mne (1)      .
           move      rf-axs-cod-bic       to   w-tes-cod-bic (1)      .
           move      rf-axs-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Rewrite record [axs]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-axs-000      thru rew-rec-axs-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [axs]                             *
      *              *-------------------------------------------------*
           perform   del-rec-axs-000      thru del-rec-axs-999        .
       del-mov-fil-999.
           exit.
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-den-spt (1)    to   rf-axs-den-spt         .
           move      w-tes-via-spt (1)    to   rf-axs-via-spt         .
           move      w-tes-loc-spt (1)    to   rf-axs-loc-spt         .
           move      w-tes-den-ric (1)    to   rf-axs-den-ric         .
           move      w-tes-cod-mne (1)    to   rf-axs-cod-mne         .
           move      w-tes-cod-bic (1)    to   rf-axs-cod-bic         .
           move      w-tes-alx-exp (1)    to   rf-axs-alx-exp         .
       cmp-rec-axs-999.
           exit.
