      ...
      *                                   Fase:    abi940              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 30/10/06    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento anagrafiche Banche da file    *
      *                                                                *
      *                    Il file e' stato ricavato dagli archivi     *
      *                    della Banca d'Italia con il nome originale  *
      *                    'SU060630.TXT', ripulito e rinominato.      *
      *                                                                *
      *                    Il nome attuale e': 'ABI_CAB.CSV'           *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "AGGIORNAMENTO DATI SPORTELLI CAB DA FILE"       .
      ...
      *        * Data 1                                                *
      *        *-------------------------------------------------------*
           05  w-abi-dat-001              pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Data 2                                                *
      *        *-------------------------------------------------------*
           05  w-abi-dat-002              pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Comodo                                                *
      *        *-------------------------------------------------------*
           05  w-abi-flr-001              pic  x(09)                  .
      *        *-------------------------------------------------------*
      *        * Codice ABI                                            *
      *        *-------------------------------------------------------*
           05  w-abi-cod-abi.
               10  w-abi-cod-abi-cod      pic  9(05)                  .
               10  w-abi-cod-abi-ext      pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione ABI                                       *
      *        *-------------------------------------------------------*
           05  w-abi-des-abi              pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Codice succursale                                     *
      *        *-------------------------------------------------------*
           05  w-abi-cod-suc              pic  x(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice CAB                                            *
      *        *-------------------------------------------------------*
           05  w-abi-cod-cab              pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Indirizzo sportello                                   *
      *        *-------------------------------------------------------*
           05  w-abi-via-cab              pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * CAP sportello                                         *
      *        *-------------------------------------------------------*
           05  w-abi-cap-cab              pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per campi non utilizzati                       *
      *        *-------------------------------------------------------*
           05  w-abi-flr-002              pic  x(99)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-det-abi.
               10  w-det-abi-num-ctr      pic  9(03)                  .
               10  w-det-abi-num-mis      pic  9(03) value 01         .
               10  w-det-abi-num-mas      pic  9(03) value 17         .
               10  w-det-abi-str-alf      pic  x(256)                 .
               10  w-det-abi-str-al1      pic  x(256)                 .
               10  w-det-abi-str-al2      pic  x(256)                 .
               10  w-det-abi-str-ext      pic  x(100)                 .
      ...
      *                  *---------------------------------------------*
           if        rr-pth-acc           =    spaces
                     move  "ABI_CAB.CSV"  to   rr-pth-acc             .
       acc-pth-inp-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        g-rec (01 : 09)      =    ";;;;;;;;;"
                     move  "#"            to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Normalizzazione primo ';'                       *
      *              *-------------------------------------------------*
           move      spaces               to   g-rec (01 : 01)        .
       prn-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Trattamento record                              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Estrazione dei campi che compongono la      *
      *                  * tabella                                     *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Normalizzazione preliminare record      *
      *                      *-----------------------------------------*
           move      spaces               to   w-abi                  .
      *                      *-----------------------------------------*
      *                      * Record in comodo di trattamento         *
      *                      *-----------------------------------------*
           move      spaces               to   w-det-abi-str-alf      .
           move      g-rec                to   w-det-abi-str-alf      .
      *                      *-----------------------------------------*
      *                      * Test che esistano solo 'n' separatori   *
      *                      *-----------------------------------------*
           move      zero                 to   w-det-abi-num-ctr      .
           inspect   w-det-abi-str-alf
                                      tallying w-det-abi-num-ctr
                     for    all ";"                                   .
           if        w-det-abi-num-ctr    not  > w-det-abi-num-mas and
                     w-det-abi-num-ctr    not  < w-det-abi-num-mis
      ...
      *                          *-------------------------------------*
           ...
           move      "Codice ABI"         to   w-all-str-cat (1)      .
           move      w-det-abi-str-alf
                     (33 : 05)            to   w-all-str-cat (2)      .
      ...
      *                      * Data 1                                  *
      *                      *-----------------------------------------*
           perform   prn-sel-rec-ext-000  thru prn-sel-rec-ext-999    .
           move      w-det-abi-str-ext    to   w-abi-dat-001          .
      *                      *-----------------------------------------*
      *                      * Data 2                                  *
      *                      *-----------------------------------------*
           perform   prn-sel-rec-ext-000  thru prn-sel-rec-ext-999    .
           move      w-det-abi-str-ext    to   w-abi-dat-002          .
      *                      *-----------------------------------------*
      *                      * Comodo                                  *
      *                      *-----------------------------------------*
           perform   prn-sel-rec-ext-000  thru prn-sel-rec-ext-999    .
           move      w-det-abi-str-ext    to   w-abi-flr-001          .
      *                      *-----------------------------------------*
      *                      * Codice ABI                              *
      *                      *-----------------------------------------*
           perform   prn-sel-rec-ext-000  thru prn-sel-rec-ext-999    .
           move      w-det-abi-str-ext    to   w-abi-cod-abi          .
      *                      *-----------------------------------------*
      *                      * Descrizione ABI                         *
      *                      *-----------------------------------------*
           perform   prn-sel-rec-ext-000  thru prn-sel-rec-ext-999    .
           move      w-det-abi-str-ext    to   w-abi-des-abi          .
      *                      *-----------------------------------------*
      *                      * Codice succursale                       *
      *                      *-----------------------------------------*
           perform   prn-sel-rec-ext-000  thru prn-sel-rec-ext-999    .
           move      w-det-abi-str-ext    to   w-abi-cod-suc          .
      *                      *-----------------------------------------*
      *                      * Codice CAB                              *
      *                      *-----------------------------------------*
           perform   prn-sel-rec-ext-000  thru prn-sel-rec-ext-999    .
           move      w-det-abi-str-ext    to   w-abi-cod-cab          .
      *                      *-----------------------------------------*
      *                      * Indirizzo sportello                     *
      *                      *-----------------------------------------*
           perform   prn-sel-rec-ext-000  thru prn-sel-rec-ext-999    .
           move      w-det-abi-str-ext    to   w-abi-via-cab          .
      *                      *-----------------------------------------*
      *                      * CAP sportello                           *
      *                      *-----------------------------------------*
           perform   prn-sel-rec-ext-000  thru prn-sel-rec-ext-999    .
           move      w-det-abi-str-ext    to   w-abi-cap-cab          .
      *                      *-----------------------------------------*
      *                      * Comodo per campi non utilizzati         *
      *                      *-----------------------------------------*
           perform   prn-sel-rec-ext-000  thru prn-sel-rec-ext-999    .
           move      w-det-abi-str-ext    to   w-abi-flr-002          .
       prn-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-det-abi-num-ctr      .
           move      spaces               to   w-det-abi-str-al1      .
           move      spaces               to   w-det-abi-str-al2      .
           move      spaces               to   w-det-abi-str-ext      .
      *              *-------------------------------------------------*
      *              * Test preliminare                                *
      *              *-------------------------------------------------*
           inspect   w-det-abi-str-alf
                                      tallying w-det-abi-num-ctr
                     for    all ";"                                   .
           if        w-det-abi-num-ctr    =    zero
                     move  w-det-abi-str-alf
                                          to   w-det-abi-str-ext
                     go to prn-sel-rec-ext-999.
      *              *-------------------------------------------------*
      *              * Estrazione                                      *
      *              *-------------------------------------------------*
           unstring  w-det-abi-str-alf
                                delimited by ";"
                                          into w-det-abi-str-al1
                                    count in   w-det-abi-num-ctr      .
           add       2                    to   w-det-abi-num-ctr      .
      *              *-------------------------------------------------*
      *              * Estrazione stringa rimanente                    *
      *              *-------------------------------------------------*
           unstring  w-det-abi-str-alf    into w-det-abi-str-al2
                                  with pointer w-det-abi-num-ctr      .
      *              *-------------------------------------------------*
      *              * Valori estratti                                 *
      *              *-------------------------------------------------*
           move      w-det-abi-str-al1    to   w-det-abi-str-ext      .
           move      w-det-abi-str-al2    to   w-det-abi-str-alf      .
       prn-sel-rec-ext-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      w-abi-cod-abi-cod    to   w-rot-l01-cod-abi      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/fdb/axs"       to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/fdb/axs.sav"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
           call      "swd/mod/prg/obj/mopsys"
      ...
      *              * Trattamento ABI                                 *
      *              *-------------------------------------------------*
           perform   rou-trt-cod-abi-000  thru rou-trt-cod-abi-999    .
       prn-ini-lr1-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Trattamento codice CAB                          *
      *              *-------------------------------------------------*
           perform   rou-trt-cod-cab-000  thru rou-trt-cod-cab-999    .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       rou-trt-cod-abi-000.
      *              *-------------------------------------------------*
      *              * Test se codice ABI a zero                       *
      *              *-------------------------------------------------*
           if        w-abi-cod-abi-cod    =    zero
                     go to rou-trt-cod-abi-900.
       rou-trt-cod-abi-050.
      *              *-------------------------------------------------*
      *              * Normalizzazione [axi]                           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rot-l01-cod-abi    to   rf-axi-cod-abi         .
           move      "pgm/abi/fls/ioc/obj/iofaxi"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-abi-des-abi        to   rf-axi-den-abi         .
           move      w-abi-des-abi        to   rf-axi-den-key         .
           move      w-abi-des-abi        to   rf-axi-den-ric         .
           move      spaces               to   rf-axi-cod-cib (1)     .
           move      spaces               to   rf-axi-cod-cib (2)     .
           move      spaces               to   rf-axi-cod-cib (3)     .
           move      spaces               to   rf-axi-cod-cib (4)     .
           move      spaces               to   rf-axi-cod-cib (5)     .
      ...
      *              *-------------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      "Nuovo ABI :"        to   w-all-str-cat (1)      .
           move      w-abi-cod-abi-cod    to   w-all-str-cat (2)      .
           move      w-abi-des-abi        to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      w-all-str-alf        to   w-wrt-msg-err-msg      .
           perform   wrt-msg-err-000      thru wrt-msg-err-999        .
      ...
      *              *-------------------------------------------------*
           if        w-abi-cod-abi-cod    =    zero
                     go to rou-trt-cod-cab-900.
      *              *-------------------------------------------------*
      *              * Test se codice CAB a zero                       *
      *              *-------------------------------------------------*
           if        w-abi-cod-cab        =    zero
                     go to rou-trt-cod-cab-900.
       rou-trt-cod-cab-050.
      *              *-------------------------------------------------*
      *              * Lettura per codice                              *
      *              *-------------------------------------------------*
           ...
           move      w-abi-cod-abi-cod    to   rf-axs-cod-abi         .
           move      w-abi-cod-cab        to   rf-axs-cod-cab         .
           move      "pgm/abi/fls/ioc/obj/iofaxs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Campi non chiave                        *
      *                      *-----------------------------------------*
           move      w-abi-via-cab        to   rf-axs-den-spt         .
           move      w-abi-via-cab        to   rf-axs-via-spt         .
           move      w-abi-cap-cab        to   rf-axs-loc-spt         .
           move      w-abi-via-cab        to   rf-axs-den-ric         .
      ...
      *              *-------------------------------------------------*
           ...
           move      "Nuovo CAB :"        to   w-all-str-cat (1)      .
           move      w-abi-cod-abi-cod    to   w-all-str-cat (2)      .
           move      "-"                  to   w-all-str-cat (3)      .
           move      w-abi-cod-cab        to   w-all-str-cat (4)      .
           move      w-abi-via-cab        to   w-all-str-cat (5)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      w-all-str-alf        to   w-wrt-msg-err-msg      .
           perform   wrt-msg-err-000      thru wrt-msg-err-999        .
