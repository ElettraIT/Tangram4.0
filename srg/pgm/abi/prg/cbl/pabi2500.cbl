      ...
      *                       Ultima revisione:    NdK del 23/11/04    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase abi250, nella sua globalita', esegue i tipi di manu-   *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * MANDAS      Manutenzione Dati anagrafici Sportelli             *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'abi250'           *
      *              *-------------------------------------------------*
           perform   fas-abi-250-000      thru fas-abi-250-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Dati anagrafici Sportelli                         
      -              " MANDAS     pabi250a  "
                                          to   w-tmn-ele-wci          .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-abi-250-300
           else if   v-key                =    "PRSC"
                     go to fas-abi-250-400
           else if   v-key                =    "NXSC"
                     go to fas-abi-250-450
           else if   v-key                =    "DOWN"
                     go to fas-abi-250-500
           else if   v-key                =    "EXIT"
                     go to fas-abi-250-250
           else      go to fas-abi-250-200.
       fas-abi-250-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-man        =    zero
                     go to fas-abi-250-330.
           move      zero                 to   w-tmn-ele-inx          .
       fas-abi-250-322.
           add       1                    to   w-tmn-ele-inx          .
           if        w-tmn-ele-inx        >    w-tmn-ele-num
                     go to fas-abi-250-340.
           if        w-tmn-num-tmn
                    (w-tmn-ele-inx)       =    w-key-num-man
                     go to fas-abi-250-350
           else      go to fas-abi-250-322.
       fas-abi-250-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-abi-250-630
           else if   v-key                =    "PRSC"
                     go to fas-abi-250-600
           else if   v-key                =    "NXSC"
                     go to fas-abi-250-610
           else if   v-key                =    "UP  "
                     go to fas-abi-250-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-abi-250-650
           else if   v-key                =    "EXIT"
                     go to fas-abi-250-660
           else      go to fas-abi-250-570.
       fas-abi-250-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-abi-250-626
           else      go to fas-abi-250-628.
       fas-abi-250-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-abi-250-636
           else      go to fas-abi-250-638.
       fas-abi-250-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-abi-250-725
           else      go to fas-abi-250-750.
       fas-abi-250-725.
      *              *-------------------------------------------------*
