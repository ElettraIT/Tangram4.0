      ...
      *                       Ultima revisione:    NdK del 03/12/01    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione codice circuito inter-  *
      *                    bancario                                    *
      *                                                                *
      * ============================================================== *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-axc-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-axc-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-axc-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-axc-cod : codice circuito      *
      *                                                                *
      *                       w-cod-des-axc-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-axc-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-axc-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-axc-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-axc-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-axc-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-axc-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-axc-cod : codice circuito      *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-axc.
           05  w-aux-cde-axc-nli          pic  9(02)                  .
           05  w-aux-cde-axc-crb          pic  9(02)                  .
           05  w-aux-cde-axc-cpb          pic  9(02)                  .
           05  w-aux-cde-axc-cpa          pic  9(02)                  .
           05  w-aux-cde-axc-bix          pic  9(02)                  .
           05  w-aux-cde-axc-buf
                               occurs 30.
               10  w-aux-cde-axc-bco      pic  x(02)                  .
               10  w-aux-cde-axc-bde      pic  x(20)                  .
           05  w-aux-cde-axc-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-axc-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-axc-lt2      pic  9(01)                  .
           05  w-aux-cde-axc-dup          pic  x(25)                  .
           05  w-aux-cde-axc-dmx.
               10  w-aux-cde-axc-dch
                               occurs 25  pic  x(01)                  .
           05  w-aux-cde-axc-c01          pic  9(02)                  .
           05  w-aux-cde-axc-c02          pic  9(02)                  .
           05  w-aux-cde-axc-c03          pic  9(02)                  .
           05  w-aux-cde-axc-c04          pic  9(02)                  .
           05  w-aux-cde-axc-c05          pic  9(02)                  .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-axc
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-axc-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-axc-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-axc-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-axc-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-axc-ope    =    "A+" or
                     w-cod-des-axc-ope    =    "I+" or
                     w-cod-des-axc-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-axc-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice circuito di default                  *
      *                  *---------------------------------------------*
           move      w-cod-des-axc-cod    to   w-cod-des-axc-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-axc-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-axc-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-axc-s90    to   v-ufk                  .
           move      w-cod-des-axc-lin    to   v-lin                  .
           move      w-cod-des-axc-pos    to   v-pos                  .
           move      w-cod-des-axc-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-axc-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-axc-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-axc-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-axc-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-axc-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-axc-cod    to   w-cod-des-axc-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-axc-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-axc-dln    =    zero or
                     w-cod-des-axc-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-axc-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      20                   to   v-car                  .
           move      w-cod-des-axc-dln    to   v-lin                  .
           move      w-cod-des-axc-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-axc-dln    to   v-lin                  .
           move      w-cod-des-axc-dps    to   v-pos                  .
           move      w-aux-cde-axc-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-axc-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-axc-dup    to   w-aux-cde-axc-dmx      .
           move      25                   to   w-aux-cde-axc-c01      .
       aco-680.
           if        w-aux-cde-axc-c01    >    zero
                     if    w-aux-cde-axc-dch
                          (w-aux-cde-axc-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-axc-dch
                                              (w-aux-cde-axc-c01)
                           subtract 1     from w-aux-cde-axc-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-axc-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-axc-dup    to   rf-axc-des-key         .
           move      spaces               to   rf-axc-cod-cib         .
           move      "pgm/abi/fls/ioc/obj/iofaxc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-axc-des-key       >    w-aux-cde-axc-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-axc-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-axc-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              * Codice circuito                 *
      *                              *---------------------------------*
           move      rf-axc-cod-cib       to   w-aux-cde-axc-bco
                                              (w-aux-cde-axc-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione circuito            *
      *                              *---------------------------------*
           move      rf-axc-des-cib       to   w-aux-cde-axc-bde
                                              (w-aux-cde-axc-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-axc-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-axc-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-axc-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      20                   to   s-car                  .
           move      w-aux-cde-axc-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-axc-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-axc-bco
                    (w-aux-cde-axc-bix)   to   w-cod-des-axc-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-axc-crb    to   w-aux-cde-axc-cpb      .
           subtract  1                    from w-aux-cde-axc-cpb      .
           divide    6                    into w-aux-cde-axc-cpb      .
           add       1                    to   w-aux-cde-axc-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-axc-c01      .
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      17                   to   v-pos                  .
           move      "       Selezionare il circuito desiderato      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                              * di indice (w-aux-cde-axc-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-axc-c01    to   w-aux-cde-axc-nli      .
       aco-865.
           if        w-aux-cde-axc-nli    >    6
                     subtract  6          from w-aux-cde-axc-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-axc-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-axc-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-axc-c01    <    w-aux-cde-axc-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-axc-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-axc-cpa    <    w-aux-cde-axc-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-axc-nli    to   v-lin                  .
           move      24                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-axc-c01    to   w-aux-cde-axc-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-axc-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-axc-cpa    to   w-aux-cde-axc-c01      .
           multiply  6                    by   w-aux-cde-axc-c01      .
           subtract  5                    from w-aux-cde-axc-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-axc-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-axc-c01    to   w-aux-cde-axc-c02      .
           add       5                    to   w-aux-cde-axc-c02      .
           divide    6                    into w-aux-cde-axc-c02      .
           move      w-aux-cde-axc-c02    to   w-aux-cde-axc-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-axc-c02      .
           multiply  6                    by   w-aux-cde-axc-c02      .
           add       1                    to   w-aux-cde-axc-c02      .
           add       5
                     w-aux-cde-axc-c02  giving w-aux-cde-axc-c03      .
           move      w-aux-cde-axc-c03    to   w-aux-cde-axc-c04      .
           if        w-aux-cde-axc-c03    >    w-aux-cde-axc-crb
                     move  w-aux-cde-axc-crb
                                          to   w-aux-cde-axc-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-axc-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      02                   to   v-car                  .
           move      w-aux-cde-axc-c05    to   v-lin                  .
           move      19                   to   v-pos                  .
           move      w-aux-cde-axc-bco
                    (w-aux-cde-axc-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      *                                      * Descrizione circuito    *
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-axc-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-axc-c02    not  > w-aux-cde-axc-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-axc-c02    >    w-aux-cde-axc-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-axc-cpa    to   w-aux-cde-axc-lt1      .
           move      w-aux-cde-axc-cpb    to   w-aux-cde-axc-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-axc-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
