      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella circuiti interbancari      *
      *                                                                *
      *                    N.B.: ___ OBSOLETO ___                      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-cib          pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-cib          pic  x(20)                  .
               10  w-tes-des-key          pic  x(20)                  .
               10  w-tes-com-cib          pic  x(50)                  .
      ...
      *                  * Codice circuito                             *
      *                  *---------------------------------------------*
           perform   acc-cod-cib-000      thru acc-cod-cib-999        .
      ...
      *              * Codice circuito                                 *
      *              *-------------------------------------------------*
           perform   vis-cod-cib-000      thru vis-cod-cib-999        .
       vis-key-reg-999.
           exit.
      ...
      *              * Codice circuito                                 *
      *              *-------------------------------------------------*
           perform   pmt-cod-cib-000      thru pmt-cod-cib-999        .
      *              *-------------------------------------------------*
      *              * Linea di trattini                               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice circuito               *
      *    *-----------------------------------------------------------*
       pmt-cod-cib-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice circuito               *
      *    *-----------------------------------------------------------*
       acc-cod-cib-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cib        to   w-cod-des-axc-cod      .
           move      04                   to   w-cod-des-axc-lin      .
           move      30                   to   w-cod-des-axc-pos      .
           move      07                   to   w-cod-des-axc-dln      .
           move      30                   to   w-cod-des-axc-dps      .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-cib-999.
       acc-cod-cib-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-cod-cib          .
       acc-cod-cib-400.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice circuito            *
      *    *-----------------------------------------------------------*
       vis-cod-cib-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           perform   acc-des-cib-000      thru acc-des-cib-999        .
           if        v-key                =    "NXSC"
       ...
       acc-tes-reg-110.
      *                  *---------------------------------------------*
      *                  * Commento al circuito                        *
      *                  *---------------------------------------------*
           perform   acc-com-cib-000      thru acc-com-cib-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        v-key                =    "UP  "
                     go to acc-tes-reg-100.
      ...
      *              * Descrizione circuito                            *
      *              *-------------------------------------------------*
           perform   vis-des-cib-000      thru vis-des-cib-999        .
      *              *-------------------------------------------------*
      *              * Commento al circuito                            *
      *              *-------------------------------------------------*
           perform   vis-com-cib-000      thru vis-com-cib-999        .
           go to     vis-tes-reg-999.
       vis-tes-reg-999.
           exit.
      ...
      *              * Descrizione circuito                            *
      *              *-------------------------------------------------*
           perform   pmt-des-cib-000      thru pmt-des-cib-999        .
      *              *-------------------------------------------------*
      *              * Commento al circuito                            *
      *              *-------------------------------------------------*
           perform   pmt-com-cib-000      thru pmt-com-cib-999        .
           go to     pmt-tes-reg-999.
       pmt-tes-reg-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione circuito             *
      *    *-----------------------------------------------------------*
       pmt-des-cib-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione circuito         *
      *    *-----------------------------------------------------------*
       acc-des-cib-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * l'ordinamento                               *
      *                  *---------------------------------------------*
           move      w-tes-des-cib (1)    to   w-all-str-alf          .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-des-cib-100.
       acc-des-cib-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione circuito      *
      *    *-----------------------------------------------------------*
       vis-des-cib-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Commento al circuito         *
      *    *-----------------------------------------------------------*
       acc-com-cib-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-com-cib-100.
       acc-com-cib-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Commento al circuito      *
      *    *-----------------------------------------------------------*
       vis-com-cib-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-cib (1)      .
           move      spaces               to   w-tes-des-key (1)      .
           move      spaces               to   w-tes-com-cib (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cib        to   rf-axc-cod-cib         .
           move      "pgm/abi/fls/ioc/obj/iofaxc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [axc]                        *
      *                          *-------------------------------------*
           move      rf-axc-des-cib       to   w-tes-des-cib (1)      .
           move      rf-axc-des-key       to   w-tes-des-key (1)      .
           move      rf-axc-com-cib       to   w-tes-com-cib (1)      .
           move      rf-axc-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [axc]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-axc-000      thru wrt-rec-axc-999        .
      ...
      *                      * Rewrite record [axc]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-axc-000      thru rew-rec-axc-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [axc]                             *
      *              *-------------------------------------------------*
           perform   del-rec-axc-000      thru del-rec-axc-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [axc]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-axc-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-cib (1)    to   rf-axc-des-cib         .
           move      w-tes-des-key (1)    to   rf-axc-des-key         .
           move      w-tes-com-cib (1)    to   rf-axc-com-cib         .
           move      w-tes-alx-exp (1)    to   rf-axc-alx-exp         .
       cmp-rec-axc-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [axc]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-axc-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-axc-000      thru cmp-rec-axc-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
