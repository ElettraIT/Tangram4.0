      ...
      *                                   Fase:    geo302              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 10/04/91    *
      *                       Ultima revisione:    NdK del 26/11/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma geo302   *
      *                                                                *
      *                    Stampa tabella Provincie                    *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           ...
           05  rr-cod-rgn                 pic  x(03)                  .
           05  rr-cod-rgn-des             pic  x(25)                  .
           05  rr-snx-cpl                 pic  x(01)                  .
           05  rr-cod-min                 pic  x(03)                  .
           05  rr-cod-max                 pic  x(03)                  .
           05  rr-des-min                 pic  x(25)                  .
           05  rr-des-max                 pic  x(25)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-flg.
      *        *-------------------------------------------------------*
      *        * Flag di intestazione regione                          *
      *        *-------------------------------------------------------*
           05  w-flg-int-rgn              pic  x(01)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-gxp-cod-prv         .
           move      "pgm/geo/fls/ioc/obj/iofgxp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-gxp-des-upp         .
      ...
      *                      *-----------------------------------------*
       ...
       prn-str-ini-600.
      *              *-------------------------------------------------*
      *              * Se ordinamento per regione                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Start per codice regione                    *
      *                  *---------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "RGNPRV    "         to   f-key                  .
           move      rr-cod-rgn           to   rf-gxp-cod-rgn         .
           move      spaces               to   rf-gxp-cod-prv         .
           move      "pgm/geo/fls/ioc/obj/iofgxp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna Provincia entro i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [gxp]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/geo/fls/ioc/obj/iofgxp"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           ...
           else      go to prn-tst-max-600.
       prn-tst-max-200.
      *              *-------------------------------------------------*
      *              * Se ordinamento per codice                       *
      *              *-------------------------------------------------*
           if        rf-gxp-cod-prv       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub      .
      ...
      *              *-------------------------------------------------*
           if        rr-cod-rgn           =    spaces
                     go to prn-tst-max-999.
           if        rf-gxp-cod-rgn       not  = rr-cod-rgn
                     move  "#"            to   w-cnt-prn-flg-sub      .
       prn-tst-max-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Selezione su si/no capoluogo                    *
      *              *-------------------------------------------------*
           if        rr-snx-cpl           =    "N"
                     go to prn-sel-rec-200.
           if        rf-gxp-snx-cpl       not  = "S"
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-gxp-cod-prv       <    rr-cod-min or
                     rf-gxp-cod-prv       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-gxp-des-upp       <    rr-des-min or
                     rf-gxp-des-upp       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           ...
           move      rf-gxp-cod-rgn       to   w-rot-l01-cod-rgn      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      w-rot-l01-cod-rgn    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Lettura descrizione regione                 *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODRGN"             to   f-key                  .
           move      w-rot-l01-cod-rgn    to   rf-gxr-cod-rgn         .
           move      "pgm/geo/fls/ioc/obj/iofgxr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      06                   to   p-pos                  .
           move      rf-gxr-des-rgn       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Attivazione flag di intestazione regione        *
      *              *-------------------------------------------------*
           move      "#"                  to   w-flg-int-rgn          .
       prn-ini-lr1-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           if        w-flg-int-rgn        =    spaces
                     go to prn-liv-det-220.
           move      spaces               to   w-flg-int-rgn          .
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-tip-ord           =    "R"
                     move  35             to   p-pos
           else      move  03             to   p-pos                  .             
           move      rf-gxp-cod-prv       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-tip-ord           =    "R"
                     move  42             to   p-pos
           else      move  10             to   p-pos                  .             
           move      rf-gxp-des-prv       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Dati regione se da stampare                 *
      *                  *---------------------------------------------*
           if        rr-tip-ord           =    "R"
      ...
      *              *-------------------------------------------------*
           move      "TABELLA PROVINCIE"  to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           if        rr-tip-ord           =    "R"
                     move  01             to   p-pos
           else      move  37             to   p-pos                  .             
           move      " Codice e descrizione regione "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      "PF"                 to   p-ope                  .
