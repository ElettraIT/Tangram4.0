      ...
      *                    Stampa tabella Stradari con descrittivo     *
      *                    della frazione o localita'                  *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Eventuale codice frazione                   *
      *                  *---------------------------------------------*
           if        w-buf-cod-fzn        =    zero  and
                     w-buf-cod-lct        =    zero
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Lettura descrittivo per frazione o localita'*
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCFL    "         to   f-key                  .
           move      w-buf-cod-cmn        to   rf-gxc-cod-cmn         .
           move      w-buf-cod-fzn        to   rf-gxc-cod-fzn         .
           move      w-buf-cod-lct        to   rf-gxc-cod-lct         .
           move      "pgm/geo/fls/ioc/obj/iofgxc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
      *                  * Stampa descrittivo per frazione o localita' *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      30                   to   p-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-gxs-cod-cmn       to   w-buf-cod-cmn          .
           move      rf-gxs-cod-fzn       to   w-buf-cod-fzn          .
           move      rf-gxs-cod-lct       to   w-buf-cod-lct          .
      *                  *---------------------------------------------*
      *                  * Lettura comune in corso di trattamento per  *
      *                  * bufferizzazione CAP                         *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCFL    "         to   f-key                  .
      ...
      *                  *---------------------------------------------*
      *                  * Test di congruenza tra il CAP stradario ed  *
      *                  * il CAP del comune di appartenenza           *
      *                  *---------------------------------------------*
           if        rf-gxc-cap-avp       =    spaces
                     go to prn-liv-det-920.
           move      w-buf-cap-avp        to   w-wrk-cap-str          .
           move      rf-gxc-cap-avp       to   w-wrk-cap-cmn          .
           if        w-wrk-str-002        =    w-wrk-cmn-002
                     go to prn-liv-det-920.
      *                  *---------------------------------------------*
      *                  * Errore nel rullino messaggi                 *
      *                  *---------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      spaces               to   m-msg                  .
           string    "Incongruenza di C.A.P. : "
                                delimited by   size
                     w-buf-des-str
                                delimited by   size
                                          into m-msg                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "     Chiave di ricerca            CAP            N
      -              "ome esteso                        Frazione o local
      -              "ita'          "     to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
