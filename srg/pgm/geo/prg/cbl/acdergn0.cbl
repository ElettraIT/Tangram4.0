      ...
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione codice regione          *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-des-rgn-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-rgn-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-rgn-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-rgn-cod : codice regione       *
      *                                                                *
      *                       w-cod-des-rgn-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-rgn-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-rgn-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-rgn-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-rgn-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-rgn-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-rgn-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-rgn-cod : codice regione       *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-rgn.
           05  w-aux-cde-rgn-nli          pic  9(02)                  .
           05  w-aux-cde-rgn-crb          pic  9(02)                  .
           05  w-aux-cde-rgn-cpb          pic  9(02)                  .
           05  w-aux-cde-rgn-cpa          pic  9(02)                  .
           05  w-aux-cde-rgn-bix          pic  9(02)                  .
           05  w-aux-cde-rgn-buf
                               occurs 30.
               10  w-aux-cde-rgn-bco      pic  x(03)                  .
               10  w-aux-cde-rgn-bde      pic  x(25)                  .
           05  w-aux-cde-rgn-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-rgn-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-rgn-lt2      pic  9(01)                  .
           05  w-aux-cde-rgn-dup          pic  x(25)                  .
           05  w-aux-cde-rgn-dmx.
               10  w-aux-cde-rgn-dch
                               occurs 25  pic  x(01)                  .
           05  w-aux-cde-rgn-c01          pic  9(02)                  .
           05  w-aux-cde-rgn-c02          pic  9(02)                  .
           05  w-aux-cde-rgn-c03          pic  9(02)                  .
           05  w-aux-cde-rgn-c04          pic  9(02)                  .
           05  w-aux-cde-rgn-c05          pic  9(02)                  .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-rgn
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-rgn-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-rgn-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-rgn-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-rgn-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-rgn-ope    =    "A+" or
                     w-cod-des-rgn-ope    =    "I+" or
                     w-cod-des-rgn-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-rgn-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice regione di default                   *
      *                  *---------------------------------------------*
           move      w-cod-des-rgn-cod    to   w-cod-des-rgn-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-rgn-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-rgn-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-rgn-s90    to   v-ufk                  .
           move      w-cod-des-rgn-lin    to   v-lin                  .
           move      w-cod-des-rgn-pos    to   v-pos                  .
           move      w-cod-des-rgn-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-rgn-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-rgn-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-rgn-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-rgn-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-rgn-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-rgn-cod    to   w-cod-des-rgn-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-rgn-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-rgn-dln    =    zero or
                     w-cod-des-rgn-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-rgn-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      25                   to   v-car                  .
           move      w-cod-des-rgn-dln    to   v-lin                  .
           move      w-cod-des-rgn-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-rgn-dln    to   v-lin                  .
           move      w-cod-des-rgn-dps    to   v-pos                  .
           move      w-aux-cde-rgn-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-rgn-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-rgn-dup    to   w-aux-cde-rgn-dmx      .
           move      25                   to   w-aux-cde-rgn-c01      .
       aco-680.
           if        w-aux-cde-rgn-c01    >    zero
                     if    w-aux-cde-rgn-dch
                          (w-aux-cde-rgn-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-rgn-dch
                                              (w-aux-cde-rgn-c01)
                           subtract 1     from w-aux-cde-rgn-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-rgn-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-rgn-dup    to   rf-gxr-des-upp         .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-gxr-des-upp       >    w-aux-cde-rgn-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-rgn-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-rgn-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              * Codice regione                  *
      *                              *---------------------------------*
           move      rf-gxr-cod-rgn       to   w-aux-cde-rgn-bco
                                              (w-aux-cde-rgn-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione regione             *
      *                              *---------------------------------*
           move      rf-gxr-des-rgn       to   w-aux-cde-rgn-bde
                                              (w-aux-cde-rgn-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-rgn-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-rgn-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-rgn-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      25                   to   s-car                  .
           move      w-aux-cde-rgn-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-rgn-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-rgn-bco
                    (w-aux-cde-rgn-bix)   to   w-cod-des-rgn-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-rgn-crb    to   w-aux-cde-rgn-cpb      .
           subtract  1                    from w-aux-cde-rgn-cpb      .
           divide    6                    into w-aux-cde-rgn-cpb      .
           add       1                    to   w-aux-cde-rgn-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-rgn-c01      .
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      17                   to   v-pos                  .
           move      "       Selezionare la regione desiderata       "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                              * di indice (w-aux-cde-rgn-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-rgn-c01    to   w-aux-cde-rgn-nli      .
       aco-865.
           if        w-aux-cde-rgn-nli    >    6
                     subtract  6          from w-aux-cde-rgn-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-rgn-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-rgn-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-rgn-c01    <    w-aux-cde-rgn-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-rgn-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-rgn-cpa    <    w-aux-cde-rgn-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-rgn-nli    to   v-lin                  .
           move      24                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-rgn-c01    to   w-aux-cde-rgn-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-rgn-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-rgn-cpa    to   w-aux-cde-rgn-c01      .
           multiply  6                    by   w-aux-cde-rgn-c01      .
           subtract  5                    from w-aux-cde-rgn-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-rgn-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-rgn-c01    to   w-aux-cde-rgn-c02      .
           add       5                    to   w-aux-cde-rgn-c02      .
           divide    6                    into w-aux-cde-rgn-c02      .
           move      w-aux-cde-rgn-c02    to   w-aux-cde-rgn-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-rgn-c02      .
           multiply  6                    by   w-aux-cde-rgn-c02      .
           add       1                    to   w-aux-cde-rgn-c02      .
           add       5
                     w-aux-cde-rgn-c02  giving w-aux-cde-rgn-c03      .
           move      w-aux-cde-rgn-c03    to   w-aux-cde-rgn-c04      .
           if        w-aux-cde-rgn-c03    >    w-aux-cde-rgn-crb
                     move  w-aux-cde-rgn-crb
                                          to   w-aux-cde-rgn-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-rgn-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      03                   to   v-car                  .
           move      w-aux-cde-rgn-c05    to   v-lin                  .
           move      19                   to   v-pos                  .
           move      w-aux-cde-rgn-bco
                    (w-aux-cde-rgn-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      *                                      * Descrizione regione     *
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-rgn-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-rgn-c02    not  > w-aux-cde-rgn-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-rgn-c02    >    w-aux-cde-rgn-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-rgn-cpa    to   w-aux-cde-rgn-lt1      .
           move      w-aux-cde-rgn-cpb    to   w-aux-cde-rgn-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-rgn-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
