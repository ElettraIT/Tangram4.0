      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pgeo5021:        *
      ...
      *    *-----------------------------------------------------------*
       01  w-let.
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [gxs]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-gxs.
               10  w-let-arc-gxs-flg      pic  x(01)                  .
               10  w-let-arc-gxs-sgl      pic  x(05)                  .
               10  w-let-arc-gxs-des      pic  x(30)                  .
      ...
      *              *-------------------------------------------------*
           if        rr-tip-stp           =    "S"
                     move  "pgm/geo/prg/obj/pgeo5021                "
                                          to   i-exe-pat
           else      move  "pgm/geo/prg/obj/pgeo5022                "
                                          to   i-exe-pat              .
           call      i-exe-pat                                        .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "B+"                 to   s-ope                  .
           if        rr-tip-stp           =    "S"
                     move  "pgeo5021  "   to   i-exe-pro
           else      move  "pgeo5022  "   to   i-exe-pro              .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella stradari"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Sigla stradario            *
      *    *-----------------------------------------------------------*
       acc-sgl-std-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        rr-sgl-std           =    spaces
                     go to acc-sgl-std-100.
      *                  *---------------------------------------------*
      *                  * Lettura di controllo                        *
      *                  *---------------------------------------------*
           move      rr-sgl-std           to   w-let-arc-gxs-sgl      .
           perform   let-arc-gxs-000      thru let-arc-gxs-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati letti                   *
      *                  *---------------------------------------------*
           move      w-let-arc-gxs-des    to   rr-sgl-std-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-des-sgl-000      thru vis-des-sgl-999        .
       acc-sgl-std-600.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo selezione : Descrizione stradario   *
      *    *-----------------------------------------------------------*
       vis-des-sgl-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           move      spaces               to   rr-sgl-std             .
           move      spaces               to   rr-sgl-std-des         .
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Controllo su Sigla stradario                    *
      *              *-------------------------------------------------*
           if        rr-sgl-std           not  = spaces
                     go to tdo-ric-sel-200.
           move      "Manca la Sigla per lo stradario !               "
      ...
      *              *-------------------------------------------------*
      *              * Regolarizzazione tipo di stampa                 *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [gxs]                         *
      *    *-----------------------------------------------------------*
       let-arc-gxs-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione marker di uscita                *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-gxs-flg      .
      *              *-------------------------------------------------*
      *              * Test se sigla stradario a spaces                *
      *              *-------------------------------------------------*
           if        w-let-arc-gxs-sgl    =    spaces
                     go to let-arc-gxs-500.
      *              *-------------------------------------------------*
      *              * Lettura per sigla                               *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "SGLDES    "         to   f-key                  .
           move      w-let-arc-gxs-sgl    to   rf-gxs-sgl-std         .
           ...
           if        f-sts                not  = e-not-err
                     go to let-arc-gxs-400.
       let-arc-gxs-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-gxs-des-str       to   w-let-arc-gxs-des      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     let-arc-gxs-999.
       let-arc-gxs-400.
      *              *-------------------------------------------------*
      *              * Azioni per record non trovato                   *
      *              *-------------------------------------------------*
           move      "#"                  to   w-let-arc-gxs-flg      .
           move      spaces               to   w-let-arc-gxs-des      .
           go to     let-arc-gxs-999.
       let-arc-gxs-500.
      *              *-------------------------------------------------*
