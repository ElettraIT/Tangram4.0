      ...
      *                                   Fase:    geo520              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/09/94    *
      *                       Ultima revisione:    NdK del 14/11/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione di un intero stradario             *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    GESTIONE DI UN INTERO STRADARIO     "       .
      ...
      *            * Sigla stradario                                   *
      *            *---------------------------------------------------*
               10  w-tes-sgl-std          pic  x(03)                  .
               10  w-tes-sgl-std-des      pic  x(30)                  .
      *            *---------------------------------------------------*
      *            * Descrizione minima per la selezione               *
      *            *---------------------------------------------------*
               10  w-tes-des-min          pic  x(30)                  .
      *            *---------------------------------------------------*
      *            * Descrizione massima per la selezione              *
      *            *---------------------------------------------------*
               10  w-tes-des-max          pic  x(30)                  .
      *            *---------------------------------------------------*
      *            * Codice Comune per la selezione                    *
      *            *---------------------------------------------------*
               10  w-tes-cod-cmn          pic  9(05)                  .
               10  w-tes-cod-cmn-des      pic  x(20)                  .
               10  w-tes-cod-cmn-sns      pic  9(01)                  .
      *            *---------------------------------------------------*
      *            * Valori sostitutivi                                *
      *            *---------------------------------------------------*
               10  w-tes-cmn-sos          pic  9(05)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-spc-key          pic  x(30)                  .
               10  w-rig-des-key          pic  x(30)                  .
               10  w-rig-des-str          pic  x(30)                  .
               10  w-rig-cap-avp          pic  x(05)                  .
               10  w-rig-cod-cmn          pic  9(05)                  .
               10  w-rig-cod-cmn-des      pic  x(30)                  .
               10  w-rig-cod-cmn-prv      pic  x(02)                  .
               10  w-rig-cod-cmn-cap      pic  x(05)                  .
      ...
      *                *-----------------------------------------------*
                   15  filler             pic  x(03)                  .
                   15  w-lin-imm-des-key  pic  x(30)                  .
                   15  filler             pic  x(03)                  .
                   15  w-lin-imm-des-str  pic  x(30)                  .
                   15  filler             pic  x(03)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-lpt.
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Codice Comune                   *
      *        *-------------------------------------------------------*
           05  w-lpt-cod-cmn-lin          pic  9(03)    value 018     .
           05  w-lpt-cod-cmn-pos          pic  9(03)    value 019     .
      ...
      *              *-------------------------------------------------*
           ...
           perform   vis-sgl-std-des-000  thru vis-sgl-std-des-999    .
      *              *-------------------------------------------------*
      *              * Descrizione minima                              *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   pmt-des-mem-000      thru pmt-des-mem-999        .
      *                  *---------------------------------------------*
      *                  * Codice Comune                               *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per : Sigla stradario             *
      *    *-----------------------------------------------------------*
       pmt-sgl-std-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per : Descrizione min e max       *
      *    *-----------------------------------------------------------*
       pmt-des-mem-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Sigla stradario                      *
      *    *-----------------------------------------------------------*
       acc-sgl-std-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      w-tes-sgl-std        to   w-let-arc-gxs-sgl      .
           perform   let-arc-gxs-000      thru let-arc-gxs-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati letti                   *
      *                  *---------------------------------------------*
           move      w-let-arc-gxs-des    to   w-tes-sgl-std-des      .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Sigla stradario                   *
      *    *-----------------------------------------------------------*
       vis-sgl-std-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione stradario             *
      *    *-----------------------------------------------------------*
       vis-sgl-std-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      04                   to   v-lin                  .
           move      38                   to   v-pos                  .
           move      w-tes-sgl-std-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-sgl-std-des-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione campo : Descrizione min                      *
      *    *-----------------------------------------------------------*
       acc-des-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione min                   *
      *    *-----------------------------------------------------------*
       vis-des-min-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-lpt-cod-cmn-lin    to   w-cod-com-geo-lin      .
           move      w-lpt-cod-cmn-pos    to   w-cod-com-geo-pos      .
           move      w-lpt-cod-cmn-lin    to   w-cod-com-geo-dln      .
           move      w-lpt-cod-cmn-pos    to   w-cod-com-geo-dps      .
           add       11                   to   w-cod-com-geo-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cod-cmn          .
       acc-cod-cmn-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-cod-cmn-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-cod-cmn-sos-000  thru acc-cod-cmn-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-cmn-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-cod-cmn-sos-000  thru vis-cod-cmn-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-cod-cmn-sns    not  = zero
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cod-cmn-sns      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "BX"                 to   v-ope                  .
           move      w-lpt-cod-cmn-lin    to   v-lin                  .
           subtract  1                    from v-lin                  .
           move      w-lpt-cod-cmn-pos    to   v-pos                  .
           subtract  1                    from v-pos                  .
           move      w-lpt-cod-cmn-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-cod-cmn-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-cod-cmn-sos-010.
      ...
      *                  *---------------------------------------------*
           perform   vis-cod-cmn-so1-000  thru vis-cod-cmn-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-cod-cmn-so2-000  thru vis-cod-cmn-so2-999    .
       acc-cod-cmn-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-cod-cmn-so1-000  thru acc-cod-cmn-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-cmn-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-cmn-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-cod-cmn-sos-600.
      ...
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-cod-cmn-so2-000  thru acc-cod-cmn-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-cmn-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-cmn-sos-200.
       acc-cod-cmn-sos-600.
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-cod-cmn        =    zero  and
                     w-tes-cmn-sos        =    zero
                     go to acc-cod-cmn-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-cod-cmn        not  = w-tes-cmn-sos
                     go to acc-cod-cmn-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-cmn-sos          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-cmn        not  = zero or
                     w-tes-cmn-sos        not  = zero
                     move  1              to   w-tes-cod-cmn-sns      .
       acc-cod-cmn-sos-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cod-cmn-sns    =    zero
                     go to vis-cod-cmn-sos-100
           else      go to vis-cod-cmn-sos-500.
       vis-cod-cmn-sos-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-lpt-cod-cmn-lin    to   w-cod-com-geo-lin      .
           move      w-lpt-cod-cmn-pos    to   w-cod-com-geo-pos      .
           add       16                   to   w-cod-com-geo-pos      .
           move      zero                 to   w-cod-com-geo-dln      .
           move      zero                 to   w-cod-com-geo-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-cod-cmn-so1-110.
           perform   cod-com-geo-cll-000  thru cod-com-geo-cll-999    .
           if        w-cod-com-geo-ope    =    "F+"
                     go to acc-cod-cmn-so1-115.
           if        w-cod-com-geo-ope    =    "AC"
                     go to acc-cod-cmn-so1-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-cmn-so1-115.
           perform   cod-com-geo-foi-000  thru cod-com-geo-foi-999    .
           go to     acc-cod-cmn-so1-110.
       acc-cod-cmn-so1-120.
           move      w-cod-com-geo-cmn    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-com-geo-ope      .
           move      w-tes-cmn-sos        to   w-cod-com-geo-cmn      .
           move      w-lpt-cod-cmn-lin    to   w-cod-com-geo-lin      .
           move      w-lpt-cod-cmn-pos    to   w-cod-com-geo-pos      .
           add       35                   to   w-cod-com-geo-pos      .
           move      zero                 to   w-cod-com-geo-dln      .
           move      zero                 to   w-cod-com-geo-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
       ...
       acc-cod-cmn-so2-110.
           perform   cod-com-geo-cll-000  thru cod-com-geo-cll-999    .
           if        w-cod-com-geo-ope    =    "F+"
                     go to acc-cod-cmn-so2-115.
           if        w-cod-com-geo-ope    =    "AC"
                     go to acc-cod-cmn-so2-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-cmn-so2-115.
           perform   cod-com-geo-foi-000  thru cod-com-geo-foi-999    .
           go to     acc-cod-cmn-so2-110.
       acc-cod-cmn-so2-120.
           move      w-cod-com-geo-cmn    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-cmn-so2-999.
       acc-cod-cmn-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cmn-sos          .
       acc-cod-cmn-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Descrizione in chiave                       *
      *                  *---------------------------------------------*
           move      w-rig-des-key        to   w-lin-imm-des-key      .
       vis-lin-cor-460.
      *                  *---------------------------------------------*
      *                  * Descrizione stradario                       *
      *                  *---------------------------------------------*
           move      w-rig-des-str        to   w-lin-imm-des-str      .
       vis-lin-cor-480.
      *                  *---------------------------------------------*
      *                  * CAP                                         *
      *                  *---------------------------------------------*
           move      w-rig-cap-avp        to   w-lin-imm-cap-avp      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pmt-cor-reg-000.
      *              *-------------------------------------------------*
      *              * Descrizione del programma con nome dello stra-  *
      *              * dario                                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Composizione titolo                         *
      *                  *---------------------------------------------*
           ...
           move      "STRADARIO DI"       to   w-all-str-cat (1)      .
           move      w-tes-sgl-std-des    to   w-all-str-cat (2)      .
      *                  *---------------------------------------------*
      *                  * Concatenamento                              *
      *                  *---------------------------------------------*
           perform   all-str-csb-000      thru all-str-csb-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.        Chiave per la ricerca        Nome est
      -              "eso per lo stradario     CAP  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione in chiave            *
      *    *-----------------------------------------------------------*
       pmt-des-key-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Specifica per lo stradario       *
      *    *-----------------------------------------------------------*
       pmt-spc-key-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione per lo stradario     *
      *    *-----------------------------------------------------------*
       pmt-des-str-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Descrizione in chiave                *
      *    *-----------------------------------------------------------*
       acc-des-key-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      w-rig-des-key        to   w-sav-des-key          .
       acc-des-key-100.
      *              *-------------------------------------------------*
      *              * Ripristino valore precedente                    *
      *              *-------------------------------------------------*
           move      w-sav-des-key        to   w-rig-des-key          .
       acc-des-key-125.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "INSR"
                     go to acc-des-key-250.
      *                  *---------------------------------------------*
      *                  * Insert su archivio [gxs]                    *
      *                  *---------------------------------------------*
           perform   ins-arc-gxs-000      thru ins-arc-gxs-999        .
      *                  *---------------------------------------------*
      *                  * Normalizzazione function-key                *
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione in chiave             *
      *    *-----------------------------------------------------------*
       vis-des-key-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Specifica per lo stradario        *
      *    *-----------------------------------------------------------*
       vis-spc-key-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Descrizione per lo stradario         *
      *    *-----------------------------------------------------------*
       acc-des-str-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione per lo stradario      *
      *    *-----------------------------------------------------------*
       vis-des-str-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           if        w-rig-cap-avp        =    spaces
                     go to acc-cap-avp-100.
      *                  *---------------------------------------------*
      *                  * Test che il CAP sia numerico                *
      *                  *---------------------------------------------*
           move      w-rig-cap-avp        to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           if        w-rig-cap-avp        =    "00000"
                     go to acc-cap-avp-100.
       acc-cap-avp-460.
      *                  *---------------------------------------------*
      *                  * Controllo con il C.a.p. letto dal comune    *
      *                  *---------------------------------------------*
           if        w-rig-cod-cmn-cap    =    spaces
                     go to acc-cap-avp-600.
           move      w-rig-cap-avp        to   w-wrk-cap-str          .
           move      w-rig-cod-cmn-cap    to   w-wrk-cap-cmn          .
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-cod-cmn        to   w-sav-cod-cmn          .
       acc-rig-cmn-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-com-geo-ope      .
           move      w-rig-cod-cmn        to   w-cod-com-geo-cmn      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cod-com-geo-cmn    to   w-rig-cod-cmn          .
       acc-rig-cmn-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "C"                  to   w-let-arc-gxc-tip      .
           move      w-rig-cod-cmn        to   w-let-arc-gxc-cmn      .
           move      zero                 to   w-let-arc-gxc-fzn      .
           move      zero                 to   w-let-arc-gxc-lct      .
           perform   let-arc-gxc-000      thru let-arc-gxc-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati letti                   *
      *                  *---------------------------------------------*
           move      w-let-arc-gxc-des    to   w-rig-cod-cmn-des      .
           move      w-let-arc-gxc-prv    to   w-rig-cod-cmn-prv      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-cmn-des-000  thru vis-rig-cmn-des-999    .
      ...
      *                  *---------------------------------------------*
           if        w-rig-cod-cmn        =    w-sav-cod-cmn
      ...
      *    *-----------------------------------------------------------*
       vis-rig-cmn-des-000.
           ...
           move      19                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-cmn-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-cmn-des-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       vis-rig-cmn-prv-000.
           ...
           move      19                   to   v-lin                  .
           move      75                   to   v-pos                  .
           move      w-rig-cod-cmn-prv    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-cmn-prv-999.
           exit.
      ...
      *                  *---------------------------------------------*
           if        w-rig-cod-cmn        =    zero
                     go to acc-rig-fzn-999.
       acc-rig-fzn-050.
      *                  *---------------------------------------------*
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-cod-fzn        to   w-sav-cod-fzn          .
       acc-rig-fzn-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-fra-geo-ope      .
           move      w-rig-cod-cmn        to   w-cod-fra-geo-cmn      .
           move      w-rig-cod-fzn        to   w-cod-fra-geo-fzn      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cod-fra-geo-fzn    to   w-rig-cod-fzn          .
       acc-rig-fzn-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-cod-cmn        to   w-let-arc-gxc-cmn      .
           move      w-rig-cod-fzn        to   w-let-arc-gxc-fzn      .
           move      zero                 to   w-let-arc-gxc-lct      .
           perform   let-arc-gxc-000      thru let-arc-gxc-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati letti                   *
      *                  *---------------------------------------------*
           move      w-let-arc-gxc-des    to   w-rig-cod-fzn-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-fzn-des-000  thru vis-rig-fzn-des-999    .
      ...
      *                  * Test se valore cambiato oppure no           *
      *                  *---------------------------------------------*
           if        w-rig-cod-fzn        =    w-sav-cod-fzn
      ...
      *    *-----------------------------------------------------------*
       vis-rig-fzn-des-000.
           ...
           move      20                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-fzn-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-fzn-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-cod-cmn        to   w-cod-loc-geo-cmn      .
           move      w-rig-cod-fzn        to   w-cod-loc-geo-fzn      .
           move      w-rig-cod-lct        to   w-cod-loc-geo-lct      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cod-loc-geo-lct    to   w-rig-cod-lct          .
       acc-rig-lct-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-cod-cmn        to   w-let-arc-gxc-cmn      .
           move      w-rig-cod-fzn        to   w-let-arc-gxc-fzn      .
           move      w-rig-cod-lct        to   w-let-arc-gxc-lct      .
           perform   let-arc-gxc-000      thru let-arc-gxc-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati letti                   *
      *                  *---------------------------------------------*
           move      w-let-arc-gxc-des    to   w-rig-cod-lct-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-lct-des-000  thru vis-rig-lct-des-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-lct-des-000.
           ...
           move      21                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-lct-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-lct-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-tes-des-max        =    spaces
                     go to cnt-tdo-key-500.
           if        w-tes-des-max        not  < w-tes-des-min
                     go to cnt-tdo-key-500.
      ...
      *              *-------------------------------------------------*
           if        w-tes-des-max        =    spaces
                     move  w-tes-des-min  to   w-tes-des-max          .
      *
           move      w-tes-des-max        to   w-all-str-alf          .
           move      30                   to   w-all-str-lun          .
           perform   all-str-pad-000      thru all-str-pad-999        .
           move      w-all-str-alf        to   w-tes-des-max          .
       cnt-tdo-key-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-100.
      *              *-------------------------------------------------*
      *              * Controllo su descrizione per stradario          *
      *              *-------------------------------------------------*
           if        w-rig-des-str        not  = spaces
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           move      spaces               to   w-tes-sgl-std          .
           move      spaces               to   w-tes-sgl-std-des      .
           move      spaces               to   w-tes-des-min          .
           move      spaces               to   w-tes-des-max          .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      spaces               to   w-rig-spc-key          .
           move      spaces               to   w-rig-des-key          .
           move      spaces               to   w-rig-des-str          .
           move      spaces               to   w-rig-cap-avp          .
      ...
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Nessuno stradario da trattare !                   
      -              "      "             to   w-box-msg-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Flag di visualizzazione dati chiave gia'    *
      *                  * effettuato                                  *
      *                  *---------------------------------------------*
           move      "#"                  to   w-cnt-sts-vis-key      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      24                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "                   --- Caricamento stradari in ese
      -              "cuzione ---                   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-des-min        to   rf-gxs-des-key         .
      ...
      *                  *---------------------------------------------*
           if        rf-gxs-sgl-std       not  = w-tes-sgl-std
                     go to car-fil-rap-900.
      *                  *---------------------------------------------*
      *                  * Test su Descrizione                         *
      *                  *---------------------------------------------*
           if        rf-gxs-des-key       >    w-tes-des-max
                     go to car-fil-rap-900.
       car-fil-rap-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-cmn-sns    =    zero and
                     w-tes-cod-cmn        =    zero
                     go to car-fil-rap-500.
           if        rf-gxs-cod-cmn       not  = w-tes-cod-cmn
                     go to car-fil-rap-200.
       car-fil-rap-500.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Valori contenuti direttamente in [gxs]      *
      *                  *---------------------------------------------*
           move      rf-gxs-spc-key       to   w-rig-spc-key          .
           move      rf-gxs-des-key       to   w-rig-des-key          .
           move      rf-gxs-des-str       to   w-rig-des-str          .
           move      rf-gxs-cap-avp       to   w-rig-cap-avp          .
           move      rf-gxs-cod-cmn       to   w-rig-cod-cmn          .
           move      rf-gxs-cod-fzn       to   w-rig-cod-fzn          .
           move      rf-gxs-cod-lct       to   w-rig-cod-lct          .
           move      rf-gxs-alx-exp       to   w-rig-alx-exp          .
      *                  *---------------------------------------------*
      *                  * Eventuali sostituzioni                      *
      *                  *---------------------------------------------*
           perform   car-fil-rap-sos-000  thru car-fil-rap-sos-999    .
      *                  *---------------------------------------------*
      *                  * Valori contenuti indirettamente in [gxs]    *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Lettura tabella [gxc] per il codice     *
      *                      * comune o frazione                       *
      *                      *-----------------------------------------*
           move      "C"                  to   w-let-arc-gxc-tip      .
           move      w-rig-cod-cmn        to   w-let-arc-gxc-cmn      .
           ...
           move      w-let-arc-gxc-des    to   w-rig-cod-cmn-des      .
           move      w-let-arc-gxc-prv    to   w-rig-cod-cmn-prv      .
           move      w-let-arc-gxc-cap    to   w-rig-cod-cmn-cap      .
      *                      *-----------------------------------------*
      *                      * Lettura tabella [gxc] per il codice     *
      *                      * frazione                                *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cod-cmn-sns    =    zero
                     go to car-fil-rap-sos-100.
           move      w-tes-cmn-sos        to   w-rig-cod-cmn          .
       car-fil-rap-sos-100.
       car-fil-rap-sos-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     car-fil-rap-sos-999.
       car-fil-rap-sos-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      24                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "                  --- Aggiornamento stradari in es
      -              "ecuzione ---                  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "SGLDES    "         to   f-key                  .
           move      w-tes-sgl-std        to   rf-gxs-sgl-std         .
           move      w-rig-des-key        to   rf-gxs-des-key         .
           move      w-rig-spc-key        to   rf-gxs-spc-key         .
           move      "pgm/geo/fls/ioc/obj/iofgxs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      w-rig-des-str        to   rf-gxs-des-str         .
           move      w-rig-cap-avp        to   rf-gxs-cap-avp         .
           move      w-rig-cod-cmn        to   rf-gxs-cod-cmn         .
           move      w-rig-cod-fzn        to   rf-gxs-cod-fzn         .
           move      w-rig-cod-lct        to   rf-gxs-cod-lct         .
           move      w-rig-alx-exp        to   rf-gxs-alx-exp         .
       sca-fil-rap-600.
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     go to  ins-arc-gxs-999.
      *              *-------------------------------------------------*
      *              * Richiamo programma di gestione                  *
      *              *-------------------------------------------------*
           move      "pgm/geo/prg/obj/pgeo5000"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat                                            .
      ...
      *              *-------------------------------------------------*
           ...
           move      12                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-rig-cod-cmn-cap    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/geo/prg/obj/pgeo5202"                       .
       cnc-rlt-sup-999.
           exit.
