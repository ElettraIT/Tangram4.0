      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento anagrafiche comuni per        *
      *                    modifica codice provincia                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "CAMBIAMENTO AUTOMATICO CODICI PROVINCIA "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Codice provincia attuale                              *
      *        *-------------------------------------------------------*
           05  rr-cod-prv                 pic  x(03)                  .
           05  rr-cod-prv-des             pic  x(25)                  .
      *        *-------------------------------------------------------*
      *        * Codice provincia nuovo                                *
      *        *-------------------------------------------------------*
           05  rr-new-prv                 pic  x(03)                  .
           05  rr-new-prv-des             pic  x(25)                  .
      *        *-------------------------------------------------------*
      *        * Tipo esecuzione                                       *
      *        * - 01 : Prova                                          *
      *        * - 02 : Definitivo                                     *
      ...
      *                  * Codice provincia nuovo                      *
      *                  *---------------------------------------------*
           perform   acc-new-prv-000      thru acc-new-prv-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      spaces               to   rr-new-prv             .
           move      spaces               to   rr-new-prv-des         .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Codice provincia attuale   *
      *    *-----------------------------------------------------------*
       acc-cod-prv-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           perform   vis-cod-prv-des-000  thru vis-cod-prv-des-999    .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice provincia attuale          *
      *    *-----------------------------------------------------------*
       vis-cod-prv-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione provincia attuale     *
      *    *-----------------------------------------------------------*
       vis-cod-prv-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Codice provincia nuovo     *
      *    *-----------------------------------------------------------*
       acc-new-prv-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-prv-ope      .
           move      rr-new-prv           to   w-cod-des-prv-cod      .
       ...
       acc-new-prv-110.
           perform   cod-des-prv-cll-000  thru cod-des-prv-cll-999    .
           if        w-cod-des-prv-ope    =    "F+"
                     go to acc-new-prv-115.
           if        w-cod-des-prv-ope    =    "AC"
                     go to acc-new-prv-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-new-prv-115.
           perform   cod-des-prv-foi-000  thru cod-des-prv-foi-999    .
           go to     acc-new-prv-110.
       acc-new-prv-120.
           move      w-cod-des-prv-cod    to   v-alf                  .
       acc-new-prv-150.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-new-prv-999.
       acc-new-prv-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   rr-new-prv             .
       acc-new-prv-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura tabella                             *
      *                  *---------------------------------------------*
           move      rr-new-prv           to   w-let-arc-gxp-cod      .
           perform   let-arc-gxp-000      thru let-arc-gxp-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-gxp-des    to   rr-new-prv-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-new-prv-des-000  thru vis-new-prv-des-999    .
      *                  *---------------------------------------------*
      *                  * Se codice errato : reimpostazione           *
      *                  *---------------------------------------------*
           if        w-let-arc-gxp-flg    not  = spaces
                     go to acc-new-prv-100.
      *                  *---------------------------------------------*
      *                  * Se a spaces : reimpostazione                *
      *                  *---------------------------------------------*
           if        rr-new-prv           not  = spaces
                     go to acc-new-prv-500.
           if        v-key                =    "UP  "
                     go to acc-new-prv-500
           else      go to acc-new-prv-100.
       acc-new-prv-500.
      *                  *---------------------------------------------*
      *                  * Se uguale ad attuale : reimpostazione       *
      *                  *---------------------------------------------*
           if        rr-new-prv           not  = rr-cod-prv
                     go to acc-new-prv-600
           else      go to acc-new-prv-100.
       acc-new-prv-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice provincia nuovo            *
      *    *-----------------------------------------------------------*
       vis-new-prv-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione provincia nuovo       *
      *    *-----------------------------------------------------------*
       vis-new-prv-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Controllo su codice provincia attuale           *
      *              *-------------------------------------------------*
           if        rr-cod-prv           not  = spaces
                     go to tdo-ric-sel-200.
           move      "Manca il codice provincia attuale !               
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo su codice provincia nuovo             *
      *              *-------------------------------------------------*
           if        rr-new-prv           not  = spaces
                     go to tdo-ric-sel-800.
           move      "Manca il codice provincia nuovo !                 
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-800.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun codice comune da aggiornare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *                      *-----------------------------------------*
           ...
           else      go to prn-fin-cic-350.
       prn-fin-cic-300.
      *                      *-----------------------------------------*
      *                      * Per nessun elemento                     *
      *                      *-----------------------------------------*
           move      "Nessun elemento da aggiornare"
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Selezione su codice provincia attuale           *
      *              *-------------------------------------------------*
      ...
      *              * Codice provincia nuovo                          *
      *              *-------------------------------------------------*
           move      rr-new-prv           to   rf-gxc-cod-prv         .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Rullino                                         *
      *              *-------------------------------------------------*
           ...
           move      rf-gxc-cod-prv       to   w-all-str-cat (4)      .
