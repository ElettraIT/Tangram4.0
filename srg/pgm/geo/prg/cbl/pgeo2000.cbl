      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella Regioni                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-rgn          pic  x(25)                  .
               10  w-tes-des-upp          pic  x(25)                  .
               10  w-tes-pos-geo          pic  9(01)                  .
               10  w-tes-cod-ist          pic  x(02)                  .
               10  w-tes-alx-exp.
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Posizione geografica                       *
      *        *-------------------------------------------------------*
           05  w-exp-pos-geo.
               10  w-exp-pos-geo-num      pic  9(02)       value 06   .
               10  w-exp-pos-geo-lun      pic  9(02)       value 25   .
               10  w-exp-pos-geo-tbl.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice regione                *
      *    *-----------------------------------------------------------*
       pmt-cod-rgn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice regione                *
      *    *-----------------------------------------------------------*
       acc-cod-rgn-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-rgn        to   w-cod-des-rgn-cod      .
           move      04                   to   w-cod-des-rgn-lin      .
           move      30                   to   w-cod-des-rgn-pos      .
           move      07                   to   w-cod-des-rgn-dln      .
           move      30                   to   w-cod-des-rgn-dps      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice regione             *
      *    *-----------------------------------------------------------*
       vis-cod-rgn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Descrizione regione                         *
      *                  *---------------------------------------------*
           perform   acc-des-rgn-000      thru acc-des-rgn-999        .
           if        v-key                =    "NXSC"
      ...
      *                  *---------------------------------------------*
           perform   acc-pos-geo-000      thru acc-pos-geo-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Posizione geografica                            *
      *              *-------------------------------------------------*
           perform   vis-pos-geo-000      thru vis-pos-geo-999        .
      *              *-------------------------------------------------*
      *              * Codice ISTAT                                    *
      *              *-------------------------------------------------*
      ...
      *              * Descrizione regione                             *
      *              *-------------------------------------------------*
           perform   pmt-des-rgn-000      thru pmt-des-rgn-999        .
      *              *-------------------------------------------------*
      *              * Posizione geografica                            *
      *              *-------------------------------------------------*
           perform   pmt-pos-geo-000      thru pmt-pos-geo-999        .
      *              *-------------------------------------------------*
      *              * Codice ISTAT                                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione regione              *
      *    *-----------------------------------------------------------*
       pmt-des-rgn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Posizione geografica             *
      *    *-----------------------------------------------------------*
       pmt-pos-geo-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione regione          *
      *    *-----------------------------------------------------------*
       acc-des-rgn-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * l'ordinamento                               *
      *                  *---------------------------------------------*
           move      w-tes-des-rgn (1)    to   w-all-str-alf          .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-des-rgn-100.
       acc-des-rgn-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione regione               *
      *    *-----------------------------------------------------------*
       vis-des-rgn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Posizione geografica                 *
      *    *-----------------------------------------------------------*
       acc-pos-geo-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-pos-geo-lun    to   v-car                  .
           move      w-exp-pos-geo-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      09                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-pos-geo-tbl    to   v-txt                  .
           move      w-tes-pos-geo (1)    to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           if        w-cnt-sts-imp-tes    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-pos-geo-100.
       acc-pos-geo-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Posizione geografica              *
      *    *-----------------------------------------------------------*
       vis-pos-geo-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-rgn (1)      .
           move      zero                 to   w-tes-pos-geo (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-rgn        to   rf-gxr-cod-rgn         .
           move      "pgm/geo/fls/ioc/obj/iofgxr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [gxr]                        *
      *                          *-------------------------------------*
           move      rf-gxr-des-rgn       to   w-tes-des-rgn (1)      .
           move      rf-gxr-des-upp       to   w-tes-des-upp (1)      .
           move      rf-gxr-pos-geo       to   w-tes-pos-geo (1)      .
           move      rf-gxr-cod-ist       to   w-tes-cod-ist (1)      .
           move      rf-gxr-alx-exp       to   w-tes-alx-exp (1)      .
      *
      ...
      *                      * Write record [gxr]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-gxr-000      thru wrt-rec-gxr-999        .
      ...
      *                      * Rewrite record [gxr]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-gxr-000      thru rew-rec-gxr-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [gxr]                             *
      *              *-------------------------------------------------*
           perform   del-rec-gxr-000      thru del-rec-gxr-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [gxr]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-gxr-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-rgn (1)    to   rf-gxr-des-rgn         .
           move      w-tes-des-upp (1)    to   rf-gxr-des-upp         .
           move      w-tes-pos-geo (1)    to   rf-gxr-pos-geo         .
           move      w-tes-cod-ist (1)    to   rf-gxr-cod-ist         .
           move      w-tes-alx-exp (1)    to   rf-gxr-alx-exp         .
       cmp-rec-gxr-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [gxr]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-gxr-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-gxr-000      thru cmp-rec-gxr-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
