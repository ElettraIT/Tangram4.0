      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma geo402   *
      *                                                                *
      *                    Stampa tabella Comuni                       *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-flg.
      *        *-------------------------------------------------------*
      *        * Flag di intestazione provincia                        *
      *        *-------------------------------------------------------*
           05  w-flg-int-prv              pic  x(01)                  .
      ...
      *                  *---------------------------------------------*
           ...
           else if   rf-gxc-cod-lct       =    zero
                     go to prn-sel-rec-330
           else      go to prn-sel-rec-340.
       prn-sel-rec-320.
      *                  *---------------------------------------------*
      *                  * Se comune                                   *
      *                  *---------------------------------------------*
           if        rr-sel-ele           =    zero or 
                     rr-sel-ele           =    01   or 
                     rr-sel-ele           =    02   or 
                     rr-sel-ele           =    05   or 
                     rr-sel-ele           =    06
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           ...
           move      rf-gxc-cod-prv       to   w-rot-l01-cod-prv      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura descrizione provincia               *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODPRV"             to   f-key                  .
           move      w-rot-l01-cod-prv    to   rf-gxp-cod-prv         .
           move      "pgm/geo/fls/ioc/obj/iofgxp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      rf-gxp-des-prv       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Attivazione flag di intestazione provincia      *
      *              *-------------------------------------------------*
           move      "#"                  to   w-flg-int-prv          .
       prn-ini-lr1-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Eventuale salto interlinea se avvenuta intesta- *
      *              * zione provincia                                 *
      *              *-------------------------------------------------*
           if        rr-tip-ord           not  = "P"
                     go to prn-liv-det-220.
           if        w-flg-int-prv        =    spaces
                     go to prn-liv-det-220.
           move      spaces               to   w-flg-int-prv          .
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-tip-ord           =    "P"
                     move  28             to   p-pos
           else      move  01             to   p-pos                  .
           move      rf-gxc-cod-cmn       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Codice frazione                             *
      *                  *---------------------------------------------*
           ...
           if        rr-tip-ord           =    "P"
                     move  34             to   p-pos
           else      move  07             to   p-pos                  .
           move      rf-gxc-cod-fzn       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Codice localita'                            *
      *                  *---------------------------------------------*
           ...
           if        rr-tip-ord           =    "P"
                     move  38             to   p-pos
           else      move  11             to   p-pos                  .
           move      rf-gxc-cod-lct       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * CAP                                         *
      *                  *---------------------------------------------*
           ...
           if        rr-tip-ord           =    "P"
                     move  43             to   p-pos
           else      move  16             to   p-pos                  .
           move      rf-gxc-cap-avp       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-tip-ord           =    "P"
                     move  51             to   p-pos
           else      move  24             to   p-pos                  .
           move      rf-gxc-des-cfl       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Dati provincia se da stampare               *
      *                  *---------------------------------------------*
           if        rr-tip-ord           =    "P"
                     go to prn-liv-det-999.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      64                   to   p-pos                  .
           move      rf-gxc-pre-tel (1)   to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Prefisso telefonico 2                       *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      05                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      70                   to   p-pos                  .
           move      rf-gxc-pre-tel (2)   to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Codice catastale                            *
      ...
      *              *-------------------------------------------------*
           ...
           move      01                   to   p-pos                  .
           if        rr-tip-ord           =    "P"
                     move  "  Descrizione provincia        Codice     C.
      -                    "A.P             Descrizione         "
                                          to   p-alf
