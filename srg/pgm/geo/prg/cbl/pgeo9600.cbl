      ...
      *                                   Fase:    geo960              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 26/03/04    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento localita' anagrafiche archivi *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " AGGIORNAMENTO LOCALITA' IN ANAGRAFICHE"       .
      ...
      *                  *---------------------------------------------*
           move      rf-cli-loc-cli       to   w-det-cod-prv-loc      .
           perform   det-cod-prv-000      thru det-cod-prv-999        .
           if        w-det-cod-prv-cod    =    spaces
                     go to exe-agg-cli-690.
      *                  *---------------------------------------------*
      *                  * Confronto del codice provincia              *
      *                  *---------------------------------------------*
           if        rf-gxc-cod-prv       =    w-det-cod-prv-cod
                     go to exe-agg-cli-690.
      *                  *---------------------------------------------*
      *                  * Aggiornamento codice provincia              *
      *                  *---------------------------------------------*
           move      rf-cli-loc-cli       to   w-wrk-sav-loc          .
           move      rf-gxc-cod-prv       to   rf-cli-loc-cli
      ...
      *                          *-------------------------------------*
           ...
           move      w-det-cap-cfl-prv    to   w-det-cap-cfl-wpr      .
           if        w-det-cap-cfl-prv    =    spaces
                     go to exe-agg-cli-690.
      *                          *-------------------------------------*
      *                          * Determinazione CAP                  *
      *                          *-------------------------------------*
           move      rf-cli-loc-cli       to   w-det-cap-cfl-cap      .
      *                          *-------------------------------------*
      ...
      *
           move      w-det-cap-cfl-cfl    to   w-all-str-alf          .
           move      30                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-det-cap-cfl-cfl      .
      *                          *-------------------------------------*
      *                          * Determinazione                      *
      *                          *-------------------------------------*
      ...
      *                          * Confronto del codice provincia      *
      *                          *-------------------------------------*
           if        w-det-cap-cfl-prv    =    w-det-cap-cfl-wpr
                     go to exe-agg-cli-690.
      *                          *-------------------------------------*
      *                          * Aggiornamento codice provincia      *
      *                          *-------------------------------------*
           move      rf-cli-loc-cli       to   w-wrk-sav-loc          .
           move      w-det-cap-cfl-prv    to   rf-cli-loc-cli
                                              (w-wrk-ctr-005 : 02)    .
      *                          *-------------------------------------*
      *                          * A update                            *
      *                          *-------------------------------------*
      ...
      *              * Messaggio                                       *
      *              *-------------------------------------------------*
           perform   exe-agg-cli-msg-000  thru exe-agg-cli-msg-999    .
       exe-agg-cli-690.
      *              *-------------------------------------------------*
      *              * Rilascio del record                             *
      *              *-------------------------------------------------*
      ...
      *                  * Individuazione codice provincia             *
      *                  *---------------------------------------------*
           move      rf-dcc-loc-dcc       to   w-det-cod-prv-loc      .
           perform   det-cod-prv-000      thru det-cod-prv-999        .
           if        w-det-cod-prv-cod    =    spaces
                     go to exe-agg-dcc-690.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-gxc-cod-prv       to   rf-dcc-loc-dcc
                                              (w-det-cod-prv-pos : 02).
      *                  *---------------------------------------------*
      *                  * A update                                    *
      *                  *---------------------------------------------*
      ...
      *                          * Determinazione CAP                  *
      *                          *-------------------------------------*
           move      rf-dcc-loc-dcc       to   w-det-cap-cfl-cap      .
      *                          *-------------------------------------*
      *                          * Determinazione localita'            *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-dcc-loc-dcc       to   w-wrk-sav-loc          .
           move      w-det-cap-cfl-prv    to   rf-dcc-loc-dcc
                                              (w-wrk-ctr-005 : 02)    .
      *                          *-------------------------------------*
      *                          * A update                            *
      *                          *-------------------------------------*
      ...
      *              * Messaggio                                       *
      *              *-------------------------------------------------*
           perform   exe-agg-dcc-msg-000  thru exe-agg-dcc-msg-999    .
       exe-agg-dcc-690.
      *              *-------------------------------------------------*
      *              * Rilascio del record                             *
      *              *-------------------------------------------------*
      ...
      *                  * Individuazione codice provincia             *
      *                  *---------------------------------------------*
           move      rf-dcm-loc-cli       to   w-det-cod-prv-loc      .
           perform   det-cod-prv-000      thru det-cod-prv-999        .
           if        w-det-cod-prv-cod    =    spaces
                     go to exe-agg-dcm-690.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-gxc-cod-prv       to   rf-dcm-loc-cli
                                              (w-det-cod-prv-pos : 02).
      *                  *---------------------------------------------*
      *                  * A update                                    *
      *                  *---------------------------------------------*
      ...
      *                          * Determinazione CAP                  *
      *                          *-------------------------------------*
           move      rf-dcm-loc-cli       to   w-det-cap-cfl-cap      .
      *                          *-------------------------------------*
      *                          * Determinazione localita'            *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-dcm-loc-cli       to   w-wrk-sav-loc          .
           move      w-det-cap-cfl-prv    to   rf-dcm-loc-cli
                                              (w-wrk-ctr-005 : 02)    .
      *                          *-------------------------------------*
      *                          * A update                            *
      *                          *-------------------------------------*
      ...
      *              * Messaggio                                       *
      *              *-------------------------------------------------*
           perform   exe-agg-dcm-msg-000  thru exe-agg-dcm-msg-999    .
       exe-agg-dcm-690.
      *              *-------------------------------------------------*
      *              * Rilascio del record                             *
      *              *-------------------------------------------------*
      ...
      *                  * Individuazione codice provincia             *
      *                  *---------------------------------------------*
           move      rf-fnt-loc-fnt       to   w-det-cod-prv-loc      .
           perform   det-cod-prv-000      thru det-cod-prv-999        .
           if        w-det-cod-prv-cod    =    spaces
                     go to exe-agg-fnt-690.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-gxc-cod-prv       to   rf-fnt-loc-fnt
                                              (w-det-cod-prv-pos : 02).
      *                  *---------------------------------------------*
      *                  * A update                                    *
      *                  *---------------------------------------------*
      ...
      *                          * Determinazione CAP                  *
      *                          *-------------------------------------*
           move      rf-fnt-loc-fnt       to   w-det-cap-cfl-cap      .
      *                          *-------------------------------------*
      *                          * Determinazione localita'            *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-fnt-loc-fnt       to   w-wrk-sav-loc          .
           move      w-det-cap-cfl-prv    to   rf-fnt-loc-fnt
                                              (w-wrk-ctr-005 : 02)    .
      *                          *-------------------------------------*
      *                          * A update                            *
      *                          *-------------------------------------*
      ...
      *              * Messaggio                                       *
      *              *-------------------------------------------------*
           perform   exe-agg-fnt-msg-000  thru exe-agg-fnt-msg-999    .
       exe-agg-fnt-690.
      *              *-------------------------------------------------*
      *              * Rilascio del record                             *
      *              *-------------------------------------------------*
      ...
      *                  * Individuazione codice provincia             *
      *                  *---------------------------------------------*
           move      rf-dcf-loc-dcf       to   w-det-cod-prv-loc      .
           perform   det-cod-prv-000      thru det-cod-prv-999        .
           if        w-det-cod-prv-cod    =    spaces
                     go to exe-agg-dcf-690.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-gxc-cod-prv       to   rf-dcf-loc-dcf
                                              (w-det-cod-prv-pos : 02).
      *                  *---------------------------------------------*
      *                  * A update                                    *
      *                  *---------------------------------------------*
      ...
      *                          * Determinazione CAP                  *
      *                          *-------------------------------------*
           move      rf-dcf-loc-dcf       to   w-det-cap-cfl-cap      .
      *                          *-------------------------------------*
      *                          * Determinazione localita'            *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-dcf-loc-dcf       to   w-wrk-sav-loc          .
           move      w-det-cap-cfl-prv    to   rf-dcf-loc-dcf
                                              (w-wrk-ctr-005 : 02)    .
      *                          *-------------------------------------*
      *                          * A update                            *
      *                          *-------------------------------------*
      ...
      *              * Messaggio                                       *
      *              *-------------------------------------------------*
           perform   exe-agg-dcf-msg-000  thru exe-agg-dcf-msg-999    .
       exe-agg-dcf-690.
      *              *-------------------------------------------------*
      *              * Rilascio del record                             *
      *              *-------------------------------------------------*
      ...
      *                  * Individuazione codice provincia             *
      *                  *---------------------------------------------*
           move      rf-age-loc-age       to   w-det-cod-prv-loc      .
           perform   det-cod-prv-000      thru det-cod-prv-999        .
           if        w-det-cod-prv-cod    =    spaces
                     go to exe-agg-age-690.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-gxc-cod-prv       to   rf-age-loc-age
                                              (w-det-cod-prv-pos : 02).
      *                  *---------------------------------------------*
      *                  * A update                                    *
      *                  *---------------------------------------------*
      ...
      *                          * Determinazione CAP                  *
      *                          *-------------------------------------*
           move      rf-age-loc-age       to   w-det-cap-cfl-cap      .
      *                          *-------------------------------------*
      *                          * Determinazione localita'            *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-age-loc-age       to   w-wrk-sav-loc          .
           move      w-det-cap-cfl-prv    to   rf-age-loc-age
                                              (w-wrk-ctr-005 : 02)    .
      *                          *-------------------------------------*
      *                          * A update                            *
      *                          *-------------------------------------*
      ...
      *              * Messaggio                                       *
      *              *-------------------------------------------------*
           perform   exe-agg-age-msg-000  thru exe-agg-age-msg-999    .
       exe-agg-age-690.
      *              *-------------------------------------------------*
      *              * Rilascio del record                             *
      *              *-------------------------------------------------*
      ...
      *                  * Individuazione codice provincia             *
      *                  *---------------------------------------------*
           move      rf-vet-loc-vet       to   w-det-cod-prv-loc      .
           perform   det-cod-prv-000      thru det-cod-prv-999        .
           if        w-det-cod-prv-cod    =    spaces
                     go to exe-agg-vet-690.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-gxc-cod-prv       to   rf-vet-loc-vet
                                              (w-det-cod-prv-pos : 02).
      *                  *---------------------------------------------*
      *                  * A update                                    *
      *                  *---------------------------------------------*
      ...
      *                          * Determinazione CAP                  *
      *                          *-------------------------------------*
           move      rf-vet-loc-vet       to   w-det-cap-cfl-cap      .
      *                          *-------------------------------------*
      *                          * Determinazione localita'            *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-vet-loc-vet       to   w-wrk-sav-loc          .
           move      w-det-cap-cfl-prv    to   rf-vet-loc-vet
                                              (w-wrk-ctr-005 : 02)    .
      *                          *-------------------------------------*
      *                          * A update                            *
      *                          *-------------------------------------*
      ...
      *              * Messaggio                                       *
      *              *-------------------------------------------------*
           perform   exe-agg-vet-msg-000  thru exe-agg-vet-msg-999    .
       exe-agg-vet-690.
      *              *-------------------------------------------------*
      *              * Rilascio del record                             *
      *              *-------------------------------------------------*
