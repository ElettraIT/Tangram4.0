      ...
      *                       Ultima revisione:    NdK del 20/05/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione codice provincia        *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-des-prv-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-prv-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-prv-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-prv-cod : codice provincia     *
      *                                                                *
      *                       w-cod-des-prv-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-prv-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-prv-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-prv-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-prv-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-prv-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-prv-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-prv-cod : codice provincia     *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-prv.
           05  w-aux-cde-prv-nli          pic  9(02)                  .
           05  w-aux-cde-prv-crb          pic  9(02)                  .
           05  w-aux-cde-prv-cpb          pic  9(02)                  .
           05  w-aux-cde-prv-cpa          pic  9(02)                  .
           05  w-aux-cde-prv-bix          pic  9(02)                  .
           05  w-aux-cde-prv-buf
                               occurs 30.
               10  w-aux-cde-prv-bco      pic  x(02)                  .
               10  w-aux-cde-prv-bde      pic  x(25)                  .
           05  w-aux-cde-prv-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-prv-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-prv-lt2      pic  9(01)                  .
           05  w-aux-cde-prv-dup          pic  x(25)                  .
           05  w-aux-cde-prv-dmx.
               10  w-aux-cde-prv-dch
                               occurs 25  pic  x(01)                  .
           05  w-aux-cde-prv-c01          pic  9(02)                  .
           05  w-aux-cde-prv-c02          pic  9(02)                  .
           05  w-aux-cde-prv-c03          pic  9(02)                  .
           05  w-aux-cde-prv-c04          pic  9(02)                  .
           05  w-aux-cde-prv-c05          pic  9(02)                  .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-prv
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-prv-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-prv-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-prv-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-prv-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-prv-ope    =    "A+" or
                     w-cod-des-prv-ope    =    "I+" or
                     w-cod-des-prv-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-prv-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice provincia di default                 *
      *                  *---------------------------------------------*
           move      w-cod-des-prv-cod    to   w-cod-des-prv-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-prv-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-prv-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-prv-s90    to   v-ufk                  .
           move      w-cod-des-prv-lin    to   v-lin                  .
           move      w-cod-des-prv-pos    to   v-pos                  .
           move      w-cod-des-prv-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-prv-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-prv-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-prv-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-prv-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-prv-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-prv-cod    to   w-cod-des-prv-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-prv-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-prv-dln    =    zero or
                     w-cod-des-prv-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-prv-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      25                   to   v-car                  .
           move      w-cod-des-prv-dln    to   v-lin                  .
           move      w-cod-des-prv-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-prv-dln    to   v-lin                  .
           move      w-cod-des-prv-dps    to   v-pos                  .
           move      w-aux-cde-prv-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-prv-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-prv-dup    to   w-aux-cde-prv-dmx      .
           move      25                   to   w-aux-cde-prv-c01      .
       aco-680.
           if        w-aux-cde-prv-c01    >    zero
                     if    w-aux-cde-prv-dch
                          (w-aux-cde-prv-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-prv-dch
                                              (w-aux-cde-prv-c01)
                           subtract 1     from w-aux-cde-prv-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-prv-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-prv-dup    to   rf-gxp-des-upp         .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-gxp-des-upp       >    w-aux-cde-prv-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-prv-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-prv-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              * Codice provincia                *
      *                              *---------------------------------*
           move      rf-gxp-cod-prv       to   w-aux-cde-prv-bco
                                              (w-aux-cde-prv-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione provincia           *
      *                              *---------------------------------*
           move      rf-gxp-des-prv       to   w-aux-cde-prv-bde
                                              (w-aux-cde-prv-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-prv-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-prv-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-prv-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           move      "PV"                 to   s-ope                  .
           move      "des-upp"            to   s-var                  .
           move      "+"                  to   s-dop                  .
           move      "A"                  to   s-tip                  .
           move      25                   to   s-car                  .
           move      w-aux-cde-prv-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-prv-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-prv-bco
                    (w-aux-cde-prv-bix)   to   w-cod-des-prv-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-prv-crb    to   w-aux-cde-prv-cpb      .
           subtract  1                    from w-aux-cde-prv-cpb      .
           divide    6                    into w-aux-cde-prv-cpb      .
           add       1                    to   w-aux-cde-prv-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-prv-c01      .
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      17                   to   v-pos                  .
           move      "       Selezionare la provincia desiderata     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                              * di indice (w-aux-cde-prv-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-prv-c01    to   w-aux-cde-prv-nli      .
       aco-865.
           if        w-aux-cde-prv-nli    >    6
                     subtract  6          from w-aux-cde-prv-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-prv-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-prv-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-prv-c01    <    w-aux-cde-prv-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-prv-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-prv-cpa    <    w-aux-cde-prv-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-prv-nli    to   v-lin                  .
           move      24                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-prv-c01    to   w-aux-cde-prv-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-prv-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-prv-cpa    to   w-aux-cde-prv-c01      .
           multiply  6                    by   w-aux-cde-prv-c01      .
           subtract  5                    from w-aux-cde-prv-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-prv-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-prv-c01    to   w-aux-cde-prv-c02      .
           add       5                    to   w-aux-cde-prv-c02      .
           divide    6                    into w-aux-cde-prv-c02      .
           move      w-aux-cde-prv-c02    to   w-aux-cde-prv-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-prv-c02      .
           multiply  6                    by   w-aux-cde-prv-c02      .
           add       1                    to   w-aux-cde-prv-c02      .
           add       5
                     w-aux-cde-prv-c02  giving w-aux-cde-prv-c03      .
           move      w-aux-cde-prv-c03    to   w-aux-cde-prv-c04      .
           if        w-aux-cde-prv-c03    >    w-aux-cde-prv-crb
                     move  w-aux-cde-prv-crb
                                          to   w-aux-cde-prv-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-prv-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      02                   to   v-car                  .
           move      w-aux-cde-prv-c05    to   v-lin                  .
           move      19                   to   v-pos                  .
           move      w-aux-cde-prv-bco
                    (w-aux-cde-prv-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      *                                      * Descrizione provincia   *
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-prv-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-prv-c02    not  > w-aux-cde-prv-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-prv-c02    >    w-aux-cde-prv-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-prv-cpa    to   w-aux-cde-prv-lt1      .
           move      w-aux-cde-prv-cpb    to   w-aux-cde-prv-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-prv-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
