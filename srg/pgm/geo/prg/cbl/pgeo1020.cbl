      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pgeo1021:        *
      *                                                                *
      *                    Stampa tabella Nazioni                      *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella nazioni :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      15                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Solo appartenenti alla CEE :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ric-sel-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-des-naz-cod      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-naz-ope      .
           move      rr-cod-max           to   w-cod-des-naz-cod      .
           move      12                   to   w-cod-des-naz-lin      .
           move      52                   to   w-cod-des-naz-pos      .
           move      zero                 to   w-cod-des-naz-dln      .
           move      zero                 to   w-cod-des-naz-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   rr-snx-cee
           else if   v-num                =    02
                     move  "S"            to   rr-snx-cee
           else      move  spaces         to   rr-snx-cee             .
       acc-snx-cee-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-snx-cee           =    spaces
