      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " AGGIORNAMENTO CODICE 'CATASTO' COMUNI  "       .
      ...
      *    *===========================================================*
      *    * Work area per la definizione dei record CATASTO           *
      *    *-----------------------------------------------------------*
       01  w-cts.
      *        *-------------------------------------------------------*
      *        * Codice Catasto                                        *
      *        *-------------------------------------------------------*
           05  w-cts-cod-cts              pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione comune                                    *
      *        *-------------------------------------------------------*
           05  w-cts-des-cmn              pic  x(45)                  .
      *        *-------------------------------------------------------*
      *        * Sigla provincia                                       *
      *        *-------------------------------------------------------*
           05  w-cts-cod-prv              pic  x(02)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-det-cap-cfl.
               ...
               10  w-det-cap-cfl-tel occurs 02
                                          pic  x(05)                  .
               10  w-det-cap-cfl-cts      pic  x(05)                  .
      ...
      *                  *---------------------------------------------*
           if        rr-pth-acc           =    spaces
                     move  "CATASTO.CSV"  to   rr-pth-acc             .
       acc-pth-inp-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Eventuale estrazione descrizione separata   *
      *                  * da '.' (Comuni di Bolzano / Trento)         *
      *                  *---------------------------------------------*
           move      w-cts-des-cmn        to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cts-des-cmn        to   w-det-cap-cfl-cfl      .
           move      w-cts-cod-prv        to   w-det-cap-cfl-prv      .
      ...
      *                  *---------------------------------------------*
           if        w-cts-cod-cts        =    w-det-cap-cfl-cts
                     go to prn-liv-det-900.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-cts-cod-cts        to   rf-gxc-cod-cts         .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "Nuovo Codice Catastale :"
                                          to   w-all-str-cat (1)      .
           move      w-cts-des-cmn        to   w-all-str-cat (2)      .
           move      "-"                  to   w-all-str-cat (3)      .
           move      w-cts-cod-cts        to   w-all-str-cat (4)      .
           move      "{"                  to   w-all-str-cat (5)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      w-all-str-alf        to   w-all-str-cat (1)      .
           move      w-det-cap-cfl-cts    to   w-all-str-cat (2)      .
           move      "}-("                to   w-all-str-cat (3)      .
           move      w-cts-cod-prv        to   w-all-str-cat (4)      .
           move      ")"                  to   w-all-str-cat (5)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
      *
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   w-det-cap-cfl-cts      .
       det-cap-cfl-100.
      *              *-------------------------------------------------*
      *              * Start su file [gxc]                             *
      *              *-------------------------------------------------*
      ...
      *
           ...
           move      rf-gxc-cod-cts       to   w-det-cap-cfl-cts      .
       det-cap-cfl-800.
      *              *-------------------------------------------------*
