      ...
      *                       Ultima revisione:    NdK del 30/12/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma geo202   *
      *                                                                *
      *                    Stampa tabella Regioni                      *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-gxr-cod-rgn         .
           move      "pgm/geo/fls/ioc/obj/iofgxr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-gxr-des-rgn         .
           move      rr-cod-min           to   rf-gxr-cod-rgn         .
           move      "pgm/geo/fls/ioc/obj/iofgxr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna Regione entro i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [gxr]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/geo/fls/ioc/obj/iofgxr"
                                          to   s-pat                  .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-gxr-cod-rgn       <    rr-cod-min or
                     rf-gxr-cod-rgn       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-gxr-des-upp       <    rr-des-min or
                     rf-gxr-des-upp       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *
           if        rf-gxr-pos-geo       =    1
                     move  "Nord       "  to   p-alf
           else if   rf-gxr-pos-geo       =    2
                     move  "Centro Nord"  to   p-alf
           else if   rf-gxr-pos-geo       =    3
                     move  "Centro     "  to   p-alf
           else if   rf-gxr-pos-geo       =    4
                     move  "Centro Sud "  to   p-alf
           else if   rf-gxr-pos-geo       =    5
                     move  "Sud        "  to   p-alf
           else if   rf-gxr-pos-geo       =    6
                     move  "Isole      "  to   p-alf
      ...
      *              *-------------------------------------------------*
           move      "TABELLA REGIONI"    to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
