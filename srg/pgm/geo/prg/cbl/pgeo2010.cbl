      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella Regioni              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     INTERROGAZIONE TABELLA REGIONI     "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-gxr-des-upp         .
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-gxr-cod-rgn       to   w-mpn-cod-rgn          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *
           if        rf-gxr-pos-geo       =    1
                     ...
                     move  "Centro Nord"  to   v-alf
           else if   rf-gxr-pos-geo       =    3
                     move  "Centro     "  to   v-alf
           else if   rf-gxr-pos-geo       =    4
                     move  "Centro Sud "  to   v-alf
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-rgn'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
