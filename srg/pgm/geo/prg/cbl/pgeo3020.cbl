      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pgeo3021:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Work per salvataggio codice regione                   *
      *        *-------------------------------------------------------*
           05  w-sav-cod-rgn              pic  x(03)                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      07                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su codice regione    :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Solo i capoluoghi di regione   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella provincie  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Codice regione             *
      *    *-----------------------------------------------------------*
       acc-cod-rgn-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-rgn           to   w-cod-des-rgn-cod      .
           move      07                   to   w-cod-des-rgn-lin      .
           move      34                   to   w-cod-des-rgn-pos      .
           move      07                   to   w-cod-des-rgn-dln      .
           move      39                   to   w-cod-des-rgn-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Si/no capoluogo            *
      *    *-----------------------------------------------------------*
       acc-snx-cpl-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   rr-snx-cpl
           else if   v-num                =    02
                     move  "S"            to   rr-snx-cpl
           else      move  spaces         to   rr-snx-cpl             .
       acc-snx-cpl-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-snx-cpl           =    spaces
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-des-prv-cod      .
           move      15                   to   w-cod-des-prv-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-prv-ope      .
           move      rr-cod-max           to   w-cod-des-prv-cod      .
           move      15                   to   w-cod-des-prv-lin      .
           move      52                   to   w-cod-des-prv-pos      .
           move      zero                 to   w-cod-des-prv-dln      .
           move      zero                 to   w-cod-des-prv-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           if        rr-tip-ord           =    spaces
                     move  "D"            to   rr-tip-ord             .
      *              *-------------------------------------------------*
      *              * Regolarizzazione si/no capoluoghi               *
      *              *-------------------------------------------------*
           if        rr-snx-cpl           =    spaces
                     move  "N"            to   rr-snx-cpl             .
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      spaces               to   rr-cod-rgn             .
           move      spaces               to   rr-cod-rgn-des         .
           move      spaces               to   rr-snx-cpl             .
