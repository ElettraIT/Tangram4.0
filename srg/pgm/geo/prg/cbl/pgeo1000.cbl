      ...
      *                       Ultima revisione:    NdK del 16/03/16    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella Nazioni                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-naz          pic  x(20)                  .
               10  w-tes-des-upp          pic  x(20)                  .
               10  w-tes-not-naz          pic  x(30)                  .
               10  w-tes-snx-cee          pic  x(01)                  .
               10  w-tes-cod-ste          pic  x(03)                  .
               10  w-tes-snx-blk          pic  x(01)                  .
               10  w-tes-alx-exp.
                   15  filler occurs 45   pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Si/no appartenenza alla CEE                *
      *        *-------------------------------------------------------*
           05  w-exp-snx-cee.
               10  w-exp-snx-cee-num      pic  9(02)       value 02   .
               10  w-exp-snx-cee-lun      pic  9(02)       value 02   .
               10  w-exp-snx-cee-tbl.
                   15  filler             pic  x(02)       value "No" .
                   15  filler             pic  x(02)       value "Si" .
      *        *-------------------------------------------------------*
      *        * Work per : Si/no Black List                           *
      *        *-------------------------------------------------------*
           05  w-exp-snx-blk.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice nazione                *
      *    *-----------------------------------------------------------*
       pmt-cod-naz-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice nazione                *
      *    *-----------------------------------------------------------*
       acc-cod-naz-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Codice consigliato : ISO 3166 - formato a 2 caratt
      -              "eri"                to   v-nt1                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   w-cod-des-naz-lin      .
           move      30                   to   w-cod-des-naz-pos      .
           move      07                   to   w-cod-des-naz-dln      .
           move      30                   to   w-cod-des-naz-dps      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice nazione             *
      *    *-----------------------------------------------------------*
       vis-cod-naz-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Descrizione nazione                         *
      *                  *---------------------------------------------*
           perform   acc-des-naz-000      thru acc-des-naz-999        .
           if        v-key                =    "NXSC"
      ...
      *                  * Annotazioni                                 *
      *                  *---------------------------------------------*
           perform   acc-not-naz-000      thru acc-not-naz-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
       ...
       acc-tes-reg-120.
      *                  *---------------------------------------------*
      *                  * Si/no appartenenza alla CEE                 *
      *                  *---------------------------------------------*
           perform   acc-snx-cee-000      thru acc-snx-cee-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  * Codice stato estero                         *
      *                  *---------------------------------------------*
           perform   acc-cod-ste-000      thru acc-cod-ste-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Annotazioni                                     *
      *              *-------------------------------------------------*
           perform   vis-not-naz-000      thru vis-not-naz-999        .
      *              *-------------------------------------------------*
      *              * Si/no appartenenza alla CEE                     *
      *              *-------------------------------------------------*
           perform   vis-snx-cee-000      thru vis-snx-cee-999        .
      *              *-------------------------------------------------*
      *              * Codice stato estero                             *
      *              *-------------------------------------------------*
           perform   vis-cod-ste-000      thru vis-cod-ste-999        .
      *              *-------------------------------------------------*
      *              * Si/no Black List                                *
      *              *-------------------------------------------------*
      ...
      *              * Descrizione nazione                             *
      *              *-------------------------------------------------*
           perform   pmt-des-naz-000      thru pmt-des-naz-999        .
      *              *-------------------------------------------------*
      *              * Annotazioni                                     *
      *              *-------------------------------------------------*
           perform   pmt-not-naz-000      thru pmt-not-naz-999        .
      *              *-------------------------------------------------*
      *              * Si/no appartenenza alla CEE                     *
      *              *-------------------------------------------------*
           perform   pmt-snx-cee-000      thru pmt-snx-cee-999        .
      *              *-------------------------------------------------*
      *              * Codice stato estero                             *
      *              *-------------------------------------------------*
           perform   pmt-cod-ste-000      thru pmt-cod-ste-999        .
      *              *-------------------------------------------------*
      *              * Si/no Black List                                *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione nazione              *
      *    *-----------------------------------------------------------*
       pmt-des-naz-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no appartenenza alla CEE      *
      *    *-----------------------------------------------------------*
       pmt-snx-cee-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice stato estero              *
      *    *-----------------------------------------------------------*
       pmt-cod-ste-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no Black List                 *
      *    *-----------------------------------------------------------*
       pmt-snx-blk-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione nazione          *
      *    *-----------------------------------------------------------*
       acc-des-naz-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * l'ordinamento                               *
      *                  *---------------------------------------------*
           move      w-tes-des-naz (1)    to   w-all-str-alf          .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no appartenenza alla CEE          *
      *    *-----------------------------------------------------------*
       acc-snx-cee-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-snx-cee (1)    not  = spaces
                     go to  acc-snx-cee-100.
           move      "N"                  to   w-tes-snx-cee (1)      .
       acc-snx-cee-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-cee-lun    to   v-car                  .
           move      w-exp-snx-cee-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      11                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-cee-tbl    to   v-txt                  .
      *
           if        w-tes-snx-cee (1)    =    "N"
                     move  01             to   v-num
           else if   w-tes-snx-cee (1)    =    "S"
                     move  02             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  "S"            to   w-tes-snx-cee (1)
           else      move  spaces         to   w-tes-snx-cee (1)      .
       acc-snx-cee-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-snx-cee (1)    not  = spaces
                     go to acc-snx-cee-600.
           if        v-key                not  = "UP  "
                     go to acc-snx-cee-100.
           if        w-cnt-sts-imp-tes    =    spaces
                     go to acc-snx-cee-600
           else      go to acc-snx-cee-100.
       acc-snx-cee-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Si/no appartenenza alla CEE       *
      *    *-----------------------------------------------------------*
       vis-snx-cee-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice stato estero                  *
      *    *-----------------------------------------------------------*
       acc-cod-ste-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Codifica per l'Agenzia delle Entrate (numerico di 
      -              "3 cifre)"           to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-cod-ste-100.
       acc-cod-ste-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Codice stato estero               *
      *    *-----------------------------------------------------------*
       vis-cod-ste-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no Black List                     *
      *    *-----------------------------------------------------------*
       acc-snx-blk-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Preparazione valore di default              *
      *                  *---------------------------------------------*
           if        w-tes-snx-blk (1)    not  = spaces
                     go to  acc-snx-blk-100.
           move      "N"                  to   w-tes-snx-blk (1)      .
       acc-snx-blk-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *
           if        w-tes-snx-blk (1)    =    "N" or
                     w-tes-snx-blk (1)    =    spaces
                     move  01             to   v-num
           else if   w-tes-snx-blk (1)    =    "S"
                     move  02             to   v-num
           else      move  zero           to   v-num                  .
      *
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  "S"            to   w-tes-snx-blk (1)
           else      move  spaces         to   w-tes-snx-blk (1)      .
       acc-snx-blk-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-snx-blk (1)    not  = spaces
                     go to acc-snx-blk-600.
           if        v-key                not  = "UP  "
                     go to acc-snx-blk-100.
           if        w-cnt-sts-imp-tes    =    spaces
                     go to acc-snx-blk-600
           else      go to acc-snx-blk-100.
       acc-snx-blk-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Si/no Black List                  *
      *    *-----------------------------------------------------------*
       vis-snx-blk-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-all-str-alf        to   w-tes-des-upp (1)      .
      *              *-------------------------------------------------*
      *              * Normalizzazione : Si/no appartenenza alla CEE   *
      *              *-------------------------------------------------*
           if        w-tes-snx-cee (1)    not  = "S"
                     move  "N"            to   w-tes-snx-cee (1)      .
      *              *-------------------------------------------------*
      *              * Normalizzazione : Si/no Black List              *
      *              *-------------------------------------------------*
           if        w-tes-snx-blk (1)    not  = "S"
                     move  "N"            to   w-tes-snx-blk (1)      .
       cnt-tdo-nok-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-naz (1)      .
           move      spaces               to   w-tes-des-upp (1)      .
           move      spaces               to   w-tes-not-naz (1)      .
           move      spaces               to   w-tes-snx-cee (1)      .
           move      spaces               to   w-tes-cod-ste (1)      .
           move      spaces               to   w-tes-snx-blk (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-naz        to   rf-gxn-cod-naz         .
           move      "pgm/geo/fls/ioc/obj/iofgxn"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [gxn]                        *
      *                          *-------------------------------------*
           move      rf-gxn-des-naz       to   w-tes-des-naz (1)      .
           move      rf-gxn-des-upp       to   w-tes-des-upp (1)      .
           move      rf-gxn-not-naz       to   w-tes-not-naz (1)      .
           move      rf-gxn-snx-cee       to   w-tes-snx-cee (1)      .
           move      rf-gxn-cod-ste       to   w-tes-cod-ste (1)      .
           move      rf-gxn-snx-blk       to   w-tes-snx-blk (1)      .
           move      rf-gxn-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [gxn]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-gxn-000      thru wrt-rec-gxn-999        .
      ...
      *                      * Rewrite record [gxn]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-gxn-000      thru rew-rec-gxn-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [gxn]                             *
      *              *-------------------------------------------------*
           perform   del-rec-gxn-000      thru del-rec-gxn-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [gxn]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-gxn-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-naz (1)    to   rf-gxn-des-naz         .
           move      w-tes-des-upp (1)    to   rf-gxn-des-upp         .
           move      w-tes-not-naz (1)    to   rf-gxn-not-naz         .
           move      w-tes-snx-cee (1)    to   rf-gxn-snx-cee         .
           move      w-tes-cod-ste (1)    to   rf-gxn-cod-ste         .
           move      w-tes-snx-blk (1)    to   rf-gxn-snx-blk         .
           move      w-tes-alx-exp (1)    to   rf-gxn-alx-exp         .
       cmp-rec-gxn-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [gxn]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-gxn-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-gxn-000      thru cmp-rec-gxn-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
