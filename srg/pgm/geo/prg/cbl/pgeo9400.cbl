      ...
      *                                   Fase:    geo940              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 29/07/02    *
      ...
      *                                                                *
      *                    Il nome attuale e': 'CAP.CSV'               *
      *                                                                *
      *                    Posizione attuale : '/asc'                  *
      *                                                                *
      * N.B.: questo programma tratta unicamente i CAP delle localita' *
      *       e non gli stradari, gestiti da un apposito modulo        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "AGGIORNAMENTO DATI COMUNI DA FILE 'CAP' "       .
      ...
      *        *-------------------------------------------------------*
           05  w-det-cap-cfl.
               ...
               10  w-det-cap-cfl-tel occurs 03
                                          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Work per determinazione localita' in base al comune   *
      *        *-------------------------------------------------------*
           05  w-det-cod-lct.
               10  w-det-cod-lct-cmn      pic  9(05)                  .
               10  w-det-cod-lct-lct      pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Work per determinazione frazione in base al comune    *
      *        *-------------------------------------------------------*
           05  w-det-cod-fzn.
               10  w-det-cod-fzn-cmn      pic  9(05)                  .
               10  w-det-cod-fzn-fzn      pic  9(05)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-wrt-rec-gxc.
               10  w-wrt-rec-gxc-cmn      pic  9(05)                  .
               10  w-wrt-rec-gxc-fzn      pic  9(05)                  .
               10  w-wrt-rec-gxc-lct      pic  9(05)                  .
               10  w-wrt-rec-gxc-tel occurs 03
                                          pic  x(05)                  .
               10  w-wrt-rec-gxc-des      pic  x(40)                  .
               10  w-wrt-rec-gxc-prv      pic  x(03)                  .
               10  w-wrt-rec-gxc-cap      pic  x(05)                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/fdb/gxc"       to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "A5"                 to   o-ope                  .
           move      "/abd/fdb/gxc.sav"   to   o-com                  .
           call      "swd/mod/prg/obj/mopsys"
                                         using o                      .
           move      "CP"                 to   o-ope                  .
           call      "swd/mod/prg/obj/mopsys"
      ...
      *                          *-------------------------------------*
           ...
           move      "- riga anomala (tracciato difforme) !"
                                          to   w-all-str-cat (3)      .
      ...
      *                          *-------------------------------------*
       ...
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Test sul tipo elemento in corso di trattamento  *
      *              *-------------------------------------------------*
           if        w-det-cap-str-inx    =    zero
      ...
      *                  * Trattamento                                 *
      *                  *---------------------------------------------*
           perform   prn-liv-det-cmn-000  thru prn-liv-det-cmn-999    .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     prn-liv-det-900.
      ...
      *                  * Trattamento                                 *
      *                  *---------------------------------------------*
           perform   prn-liv-det-frz-000  thru prn-liv-det-frz-999    .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     prn-liv-det-900.
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Incremento indice di elemento principale        *
      *              *-------------------------------------------------*
           add       1                    to   w-det-cap-str-inx      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-liv-det-cmn-000.
      *              *-------------------------------------------------*
      *              * Tentativo di lettura tramite descrizione e pro- *
      *              * vincia                                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Determinazione                              *
      *                  *---------------------------------------------*
           move      "C"                  to   w-det-cap-cfl-tip      .
           move      w-cap-des-cmn        to   w-det-cap-cfl-cfl      .
           move      w-cap-cod-prv        to   w-det-cap-cfl-prv      .
           perform   det-cap-cfl-000      thru det-cap-cfl-999        .
      *                  *---------------------------------------------*
      *                  * Test su esito della lettura                 *
      *                  *---------------------------------------------*
           if        w-det-cap-cfl-flg    not  = spaces
                     go to prn-liv-det-cmn-300.
       prn-liv-det-cmn-200.
      *                  *---------------------------------------------*
      *                  * Se record trovato                           *
      *                  *---------------------------------------------*
      ...
      *                      * Confronto di CAP                        *
      *                      *-----------------------------------------*
           if        w-cap-num-cap        not  = w-det-cap-cfl-cap
                     go to prn-liv-det-cmn-260.
      *                      *-----------------------------------------*
      *                      * Se CAP uguale                           *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           perform   upd-rec-gxc-000      thru upd-rec-gxc-999        .
      *                          *-------------------------------------*
      *                          * Ad uscita                           *
      *                          *-------------------------------------*
           go to     prn-liv-det-cmn-900.
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Intestazione nuovo Comune               *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Attribuzione codice comune          *
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      w-enc-gxc-val-pos    to   w-wrt-rec-gxc-cmn      .
           move      zero                 to   w-wrt-rec-gxc-fzn      .
           move      zero                 to   w-wrt-rec-gxc-lct      .
           move      spaces               to   w-wrt-rec-gxc-tel (1)  .
           move      spaces               to   w-wrt-rec-gxc-tel (2)  .
           move      spaces               to   w-wrt-rec-gxc-tel (3)  .
      *
           if        w-cap-des-cm2        =    spaces
                     move  w-cap-des-cmn  to   w-wrt-rec-gxc-des
           else      move  w-cap-des-cm2  to   w-wrt-rec-gxc-des      .
      *
           move      w-cap-cod-prv        to   w-wrt-rec-gxc-prv      .
           move      w-cap-num-cap        to   w-wrt-rec-gxc-cap      .
      *                          *-------------------------------------*
      *                          * Scrittura                           *
      *                          *-------------------------------------*
      ...
      *                  * Determinazione                              *
      *                  *---------------------------------------------*
           move      "F"                  to   w-det-cap-cfl-tip      .
           move      w-cap-des-frz        to   w-det-cap-cfl-cfl      .
           move      w-cap-cod-prv        to   w-det-cap-cfl-prv      .
           perform   det-cap-cfl-000      thru det-cap-cfl-999        .
      *                  *---------------------------------------------*
      *                  * Test su esito della lettura                 *
      ...
      *                              * Test su esito della lettura     *
      *                              *---------------------------------*
           if        w-det-cap-cfl-flg    not  = spaces or
                     w-det-cap-cfl-ele    not  = "C"
                     go to prn-liv-det-frz-540.
      *                              *---------------------------------*
      *                              * Bufferizzazione valori          *
      *                              *---------------------------------*
           move      w-det-cap-cfl-cmn    to   w-wrt-rec-gxc-cmn      .
           move      w-det-cap-cfl-tel (1)
                                          to   w-wrt-rec-gxc-tel (1)  .
           move      w-det-cap-cfl-tel (2)
                                          to   w-wrt-rec-gxc-tel (2)  .
           move      w-det-cap-cfl-tel (3)
                                          to   w-wrt-rec-gxc-tel (3)  .
      *                              *---------------------------------*
      *                              * Oltre                           *
      *                              *---------------------------------*
           go to     prn-liv-det-frz-560.
       prn-liv-det-frz-540.
      *                          *-------------------------------------*
      *                          * Attribuzione codice comune          *
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
       ...
       prn-liv-det-frz-560.
      *                          *-------------------------------------*
      *                          * Determinazione del codice frazione  *
      *                          *-------------------------------------*
           move      w-wrt-rec-gxc-cmn    to   w-det-cod-fzn-cmn      .
           perform   det-cod-fzn-000      thru det-cod-fzn-999        .
           move      w-det-cod-fzn-fzn    to   w-wrt-rec-gxc-fzn      .
      *                          *-------------------------------------*
      *                          * Normalizzazione codice localita'    *
      *                          *-------------------------------------*
           move      zero                 to   w-wrt-rec-gxc-lct      .
      *                          *-------------------------------------*
      *                          * Altri valori                        *
      *                          *-------------------------------------*
           if        w-cap-des-fr2        =    spaces
                     move  w-cap-des-frz  to   w-wrt-rec-gxc-des
           else      move  w-cap-des-fr2  to   w-wrt-rec-gxc-des      .
      *
           move      w-cap-cod-prv        to   w-wrt-rec-gxc-prv      .
           move      w-cap-num-cap        to   w-wrt-rec-gxc-cap      .
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-cap-cfl-cmn    to   rf-gxc-cod-cmn         .
           move      w-det-cap-cfl-fzn    to   rf-gxc-cod-fzn         .
           move      w-det-cap-cfl-lct    to   rf-gxc-cod-lct         .
           move      "pgm/geo/fls/ioc/obj/iofgxc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-gxc                 .
      *                  *---------------------------------------------*
      *                  * Se record non esistente : ad uscita         *
      *                  *---------------------------------------------*
           if        f-sts                =    e-not-err
                     go to upd-rec-gxc-200.
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     upd-rec-gxc-900.
       upd-rec-gxc-200.
      *              *-------------------------------------------------*
      *              * Se record esistente                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-cap-num-cap        to   rf-gxc-cap-avp         .
      *                  *---------------------------------------------*
      *                  * Test se update da eseguire                  *
      *                  *---------------------------------------------*
           if        rr-tip-exe           not  = 02
                     go to upd-rec-gxc-400.
      *                  *---------------------------------------------*
      *                  * Update record [gxc]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "Nuovo CAP :"        to   w-all-str-cat (1)      .
      *
           if        w-cap-des-frz        not  = spaces
                     move  w-cap-des-frz  to   w-all-str-cat (2)
           else      move  w-cap-des-cmn  to   w-all-str-cat (2)      .
      *
           move      "-"                  to   w-all-str-cat (3)      .
           move      w-cap-num-cap        to   w-all-str-cat (4)      .
           move      "{"                  to   w-all-str-cat (5)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      w-all-str-alf        to   w-all-str-cat (1)      .
           move      w-det-cap-cfl-cap    to   w-all-str-cat (2)      .
           move      "}-("                to   w-all-str-cat (3)      .
      ...
      *                  * Campi chiave                                *
      *                  *---------------------------------------------*
           move      w-wrt-rec-gxc-cmn    to   rf-gxc-cod-cmn         .
           move      w-wrt-rec-gxc-fzn    to   rf-gxc-cod-fzn         .
           move      w-wrt-rec-gxc-lct    to   rf-gxc-cod-lct         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-wrt-rec-gxc-des    to   rf-gxc-des-cfl         .
      *
           move      rf-gxc-des-cfl       to   w-all-str-alf          .
           move      30                   to   w-all-str-lun          .
           perform   all-str-cpt-000      thru all-str-cpt-999        .
           move      w-all-str-alf        to   rf-gxc-des-cfl         .
      *
           move      w-wrt-rec-gxc-des    to   rf-gxc-des-ord         .
      *
           move      rf-gxc-des-cfl       to   w-cap-des-cmn          .
      *
           move      w-wrt-rec-gxc-prv    to   rf-gxc-cod-prv         .
           move      "N"                  to   rf-gxc-snx-cpp         .
           move      w-wrt-rec-gxc-cap    to   rf-gxc-cap-avp         .
           move      spaces               to   rf-gxc-sgl-std         .
           move      w-wrt-rec-gxc-tel (1)
                                          to   rf-gxc-pre-tel (1)     .
           move      w-wrt-rec-gxc-tel (2)
                                          to   rf-gxc-pre-tel (2)     .
      ...
      *              *-------------------------------------------------*
      *              * Test se write da eseguire                       *
      *              *-------------------------------------------------*
           if        w-wrt-rec-gxc-cmn    =    zero   or
                     w-cap-des-cmn        =    spaces or
                     w-cap-num-cap        =    spaces
                     go to wrt-rec-gxc-999.
           if        rr-tip-exe           not  = 02
                     go to wrt-rec-gxc-400.
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           if        w-wrt-rec-gxc-lct    not  = zero
                     move  "Nuova localita' :"
                                          to   w-all-str-cat (1)
           else if   w-wrt-rec-gxc-fzn    not  = zero
                     move  "Nuova frazione :"
                                          to   w-all-str-cat (1)
           else      move  "Nuovo comune :"
                                          to   w-all-str-cat (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   w-det-cap-cfl-tel (1)  .
           move      spaces               to   w-det-cap-cfl-tel (2)  .
           move      spaces               to   w-det-cap-cfl-tel (3)  .
       det-cap-cfl-100.
      *              *-------------------------------------------------*
      *              * Start su file [gxc]                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Selezione su tipo elemento 'C'              *
      *                  *---------------------------------------------*
           if        w-det-cap-cfl-prv    not  = "C"
                     go to det-cap-cfl-420.
           if        rf-gxc-cod-fzn       not  = zero or
                     rf-gxc-cod-lct       not  = zero
                     go to det-cap-cfl-200.
       det-cap-cfl-420.
      *                  *---------------------------------------------*
      *                  * Selezione su tipo elemento 'F'              *
      *                  *---------------------------------------------*
           if        w-det-cap-cfl-prv    not  = "F"
                     go to det-cap-cfl-600.
      ...
      *
           move      rf-gxc-pre-tel (1)   to   w-det-cap-cfl-tel (1)  .
           move      rf-gxc-pre-tel (2)   to   w-det-cap-cfl-tel (2)  .
       det-cap-cfl-800.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Determinazione codice localita' di un comune              *
      *    *-----------------------------------------------------------*
       det-cod-lct-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione valori di uscita                *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-cod-lct-lct      .
       det-cod-lct-100.
      *              *-------------------------------------------------*
      *              * Start su file [gxc]                             *
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODCFL    "         to   f-key                  .
           move      w-det-cod-lct-cmn    to   rf-gxc-cod-cmn         .
           move      zero                 to   rf-gxc-cod-fzn         .
           move      zero                 to   rf-gxc-cod-lct         .
           move      "pgm/geo/fls/ioc/obj/iofgxc"
                                          to   s-pat                  .
      ...
      *              * Max su [gxc], se non superato : ad uscita       *
      *              *-------------------------------------------------*
           if        rf-gxc-cod-cmn       not  = w-det-cod-lct-cmn or
      ...
      *              * Bufferizzazione dell'elemento letto             *
      *              *-------------------------------------------------*
           move      rf-gxc-cod-lct       to   w-det-cod-lct-lct      .
       det-cod-lct-800.
      *              *-------------------------------------------------*
      *              * Riciclo a record [gxc] successivo               *
      *              *-------------------------------------------------*
           go to     det-cod-lct-200.
       det-cod-lct-900.
      *              *-------------------------------------------------*
      *              * Test in uscita                                  *
      *              *-------------------------------------------------*
           add       010                  to   w-det-cod-lct-lct      .
       det-cod-lct-999.
           exit.

      *    *===========================================================*
      *    * Determinazione codice localita' di una frazione           *
      *    *-----------------------------------------------------------*
       det-cod-fzn-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione valori di uscita                *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-cod-fzn-fzn      .
       det-cod-fzn-100.
      *              *-------------------------------------------------*
      *              * Start su file [gxc]                             *
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODCFL    "         to   f-key                  .
           move      w-det-cod-fzn-cmn    to   rf-gxc-cod-cmn         .
           move      zero                 to   rf-gxc-cod-fzn         .
           move      zero                 to   rf-gxc-cod-lct         .
           move      "pgm/geo/fls/ioc/obj/iofgxc"
                                          to   s-pat                  .
      ...
      *              * Max su [gxc], se non superato : ad uscita       *
      *              *-------------------------------------------------*
           if        rf-gxc-cod-cmn       not  = w-det-cod-fzn-cmn
                     go to det-cod-fzn-900.
       det-cod-fzn-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rf-gxc-cod-lct       not  = zero
                     go to det-cod-fzn-200.
       det-cod-fzn-600.
      *              *-------------------------------------------------*
      *              * Bufferizzazione dell'elemento letto             *
      *              *-------------------------------------------------*
           move      rf-gxc-cod-fzn       to   w-det-cod-fzn-fzn      .
       det-cod-fzn-800.
      *              *-------------------------------------------------*
      *              * Riciclo a record [gxc] successivo               *
      *              *-------------------------------------------------*
