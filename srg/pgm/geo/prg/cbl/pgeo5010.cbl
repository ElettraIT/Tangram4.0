      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [gxs]            *
      *                    Tabella Stradari                            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     INTERROGAZIONE TABELLA STRADARI    "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-sgl-std              pic  x(05)                  .
           05  w-mpn-des-key              pic  x(30)                  .
           05  w-mpn-spc-key              pic  x(30)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-cix.
      *        *-------------------------------------------------------*
      *        * Contatore per linee di dettaglio                      *
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-ipc-dlp-tdi-sgl    to   rr-sgl-std             .
      ...
      *                  *---------------------------------------------*
           ...
           move      07                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      w-buf-sgl-std        to   w-mpn-sgl-std          .
           move      w-buf-des-key        to   w-mpn-des-key          .
           move      w-buf-spc-key        to   w-mpn-spc-key          .
           move      w-mpn                to   v-cnt                  .
           move      w-buf-cap-avp        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'sgl-std'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
           ...
           move      05                   to   s-car                  .
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-sgl-std        to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'des-key'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
           ...
           move      30                   to   s-car                  .
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-des-key        to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'spc-key'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      07                   to   v-pos                  .
           move      "  Cap e descrizione di ordinamento           Descr
      -              "izione estesa      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   w-ipc-dlp-tdi-sgl      .
      ...
      *                  *---------------------------------------------*
           ...
           if        s-alf                =    spaces
                     go to ipc-dlp-tdi-999.
           move      s-alf                to   w-ipc-dlp-tdi-sgl      .
      *                  *---------------------------------------------*
      *                  * Descrizione in chiave                       *
      *                  *---------------------------------------------*
           move      "CV"                 to   s-ope                  .
