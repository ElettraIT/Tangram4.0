      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pgeo2021:        *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-des-rgn-cod      .
           move      12                   to   w-cod-des-rgn-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-rgn-ope      .
           move      rr-cod-max           to   w-cod-des-rgn-cod      .
           move      12                   to   w-cod-des-rgn-lin      .
           move      52                   to   w-cod-des-rgn-pos      .
           move      zero                 to   w-cod-des-rgn-dln      .
           move      zero                 to   w-cod-des-rgn-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
