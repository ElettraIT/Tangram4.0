      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella Provincie                  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-prv          pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-upp          pic  x(25)                  .
               10  w-tes-des-prv          pic  x(25)                  .
               10  w-tes-cod-rgn          pic  x(03)                  .
               10  w-tes-cod-rgn-des      pic  x(25)                  .
               10  w-tes-snx-cpl          pic  x(01)                  .
               10  w-tes-cap-min          pic  x(05)                  .
               10  w-tes-cap-max          pic  x(05)                  .
               10  w-tes-cod-ist          pic  x(03)                  .
               10  w-tes-alx-exp.
                   15  filler occurs 77   pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-snx-cpl.
               10  w-exp-snx-cpl-num      pic  9(02)       value 02   .
               10  w-exp-snx-cpl-lun      pic  9(02)       value 02   .
               10  w-exp-snx-cpl-tbl.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice provincia              *
      *    *-----------------------------------------------------------*
       pmt-cod-prv-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice provincia              *
      *    *-----------------------------------------------------------*
       acc-cod-prv-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-prv        to   w-cod-des-prv-cod      .
           move      04                   to   w-cod-des-prv-lin      .
           move      30                   to   w-cod-des-prv-pos      .
           move      07                   to   w-cod-des-prv-dln      .
           move      30                   to   w-cod-des-prv-dps      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice provincia           *
      *    *-----------------------------------------------------------*
       vis-cod-prv-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           perform   acc-des-prv-000      thru acc-des-prv-999        .
           if        v-key                =    "NXSC"
      ...
      *                  * Codice regione                              *
      *                  *---------------------------------------------*
           perform   acc-cod-rgn-000      thru acc-cod-rgn-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  * Si/no capoluogo                             *
      *                  *---------------------------------------------*
           perform   acc-snx-cpl-000      thru acc-snx-cpl-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Codice regione                                  *
      *              *-------------------------------------------------*
           perform   vis-cod-rgn-000      thru vis-cod-rgn-999        .
      *              *-------------------------------------------------*
      *              * Descrizione regione                             *
      *              *-------------------------------------------------*
           perform   vis-des-rgn-000      thru vis-des-rgn-999        .
      *              *-------------------------------------------------*
      *              * Si/no capoluogo                                 *
      *              *-------------------------------------------------*
           perform   vis-snx-cpl-000      thru vis-snx-cpl-999        .
      *              *-------------------------------------------------*
      *              * CAP iniziale                                    *
      *              *-------------------------------------------------*
      ...
      *              * Descrizione provincia                           *
      *              *-------------------------------------------------*
           perform   pmt-des-prv-000      thru pmt-des-prv-999        .
      *              *-------------------------------------------------*
      *              * Codice regione                                  *
      *              *-------------------------------------------------*
           perform   pmt-cod-rgn-000      thru pmt-cod-rgn-999        .
      *              *-------------------------------------------------*
      *              * Si/no capoluogo                                 *
      *              *-------------------------------------------------*
           perform   pmt-snx-cpl-000      thru pmt-snx-cpl-999        .
      *              *-------------------------------------------------*
      *              * CAP iniziale                                    *
      *              *-------------------------------------------------*
           perform   pmt-cap-min-000      thru pmt-cap-min-999        .
      *              *-------------------------------------------------*
      *              * CAP finale                                      *
      *              *-------------------------------------------------*
           perform   pmt-cap-max-000      thru pmt-cap-max-999        .
      *              *-------------------------------------------------*
      *              * Codice ISTAT                                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione provincia            *
      *    *-----------------------------------------------------------*
       pmt-des-prv-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice regione                   *
      *    *-----------------------------------------------------------*
       pmt-cod-rgn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : CAP iniziale                     *
      *    *-----------------------------------------------------------*
       pmt-cap-min-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : CAP finale                       *
      *    *-----------------------------------------------------------*
       pmt-cap-max-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione provincia        *
      *    *-----------------------------------------------------------*
       acc-des-prv-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * l'ordinamento                               *
      *                  *---------------------------------------------*
           move      w-tes-des-prv (1)    to   w-all-str-alf          .
           move      25                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-tes-des-upp (1)      .
       acc-des-prv-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Codice regione               *
      *    *-----------------------------------------------------------*
       acc-cod-rgn-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-rgn (1)    to   w-cod-des-rgn-cod      .
           move      09                   to   w-cod-des-rgn-lin      .
           move      30                   to   w-cod-des-rgn-pos      .
           move      09                   to   w-cod-des-rgn-dln      .
           move      35                   to   w-cod-des-rgn-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-cod-rgn-110.
           ...
           if        w-cod-des-rgn-ope    =    "F+"
                     go to acc-cod-rgn-115.
           if        w-cod-des-rgn-ope    =    "AC"
                     go to acc-cod-rgn-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-rgn-115.
           perform   cod-des-rgn-foi-000  thru cod-des-rgn-foi-999    .
           go to     acc-cod-rgn-110.
       acc-cod-rgn-120.
      ...
      *                  * Lettura tabella                             *
      *                  *---------------------------------------------*
           move      w-tes-cod-rgn (1)    to   w-let-arc-gxr-cod      .
           perform   let-arc-gxr-000      thru let-arc-gxr-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-gxr-des    to   w-tes-cod-rgn-des (1)  .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-gxr-flg    not  = spaces
                     go to acc-cod-rgn-100.
      *                  *---------------------------------------------*
      *                  * Se spaces : reimpostazione                  *
      *                  *---------------------------------------------*
           if        w-tes-cod-rgn (1)    not  = spaces
                     go to acc-cod-rgn-600.
           if        v-key                not  = "UP  "
                     go to acc-cod-rgn-100.
           if        w-cnt-sts-imp-tes    =    spaces
                     go to acc-cod-rgn-600
           else      go to acc-cod-rgn-100.
       acc-cod-rgn-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Codice regione            *
      *    *-----------------------------------------------------------*
       vis-cod-rgn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione regione       *
      *    *-----------------------------------------------------------*
       vis-des-rgn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Si/no capoluogo              *
      *    *-----------------------------------------------------------*
       acc-snx-cpl-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-snx-cpl (1)    not  = spaces
                     go to  acc-snx-cpl-100.
           move      "N"                  to   w-tes-snx-cpl (1)      .
       acc-snx-cpl-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-cpl-lun    to   v-car                  .
           move      w-exp-snx-cpl-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      11                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-cpl-tbl    to   v-txt                  .
           if        w-tes-snx-cpl (1)    =    "S"
                     move  01             to   v-num
           else if   w-tes-snx-cpl (1)    =    "N"
                     move  02             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "S"            to   w-tes-snx-cpl (1)
           else if   v-num                =    02
                     move  "N"            to   w-tes-snx-cpl (1)
           else      move  spaces         to   w-tes-snx-cpl (1)      .
       acc-snx-cpl-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-snx-cpl (1)    not  = spaces
                     go to acc-snx-cpl-600.
           if        v-key                not  = "UP  "
                     go to acc-snx-cpl-100.
           if        w-cnt-sts-imp-tes    =    spaces
                     go to acc-snx-cpl-600
           else      go to acc-snx-cpl-100.
       acc-snx-cpl-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Si/no capoluogo           *
      *    *-----------------------------------------------------------*
       vis-snx-cpl-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : CAP iniziale                 *
      *    *-----------------------------------------------------------*
       acc-cap-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-cap-min (1)    =    spaces
                     go to acc-cap-min-600.
      *                  *---------------------------------------------*
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-cap-min (1)    to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           move      w-tes-cap-min (1)    to   w-ctl-cap-avp-alf      .
           if        w-ctl-cap-avp-alf    not  numeric
                     go to acc-cap-min-100.
      *                  *---------------------------------------------*
      *                  * Test che il CAP non sia a '00000'           *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : CAP iniziale              *
      *    *-----------------------------------------------------------*
       vis-cap-min-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : CAP finale                   *
      *    *-----------------------------------------------------------*
       acc-cap-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
       acc-cap-max-425.
      *                  *---------------------------------------------*
      *                  * Se a spaces : no controlli                  *
      *                  *---------------------------------------------*
           if        w-tes-cap-max (1)    =    spaces
                     go to acc-cap-max-600.
       acc-cap-max-450.
      *                  *---------------------------------------------*
      *                  * Test che non ci siano blanks embedded       *
      *                  *---------------------------------------------*
           move      w-tes-cap-max (1)    to   w-all-str-alf          .
           move      05                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        not  = spaces
      ...
      *                  * Test che il CAP sia numerico                *
      *                  *---------------------------------------------*
           move      w-tes-cap-max (1)    to   w-ctl-cap-avp-alf      .
           if        w-ctl-cap-avp-num    not  numeric
                     go to acc-cap-max-100.
       acc-cap-max-500.
      *                  *---------------------------------------------*
      *                  * Test che il CAP non sia '00000'             *
      *                  *---------------------------------------------*
           if        w-ctl-cap-avp-alf    =    "00000"
                     go to acc-cap-max-100.
       acc-cap-max-525.
      ...
      *                  *---------------------------------------------*
           if        w-tes-cap-max (1)    not  < w-tes-cap-min (1)
                     go to acc-cap-max-600.
           move      "ME"                 to   v-ope                  .
           move      "Il CAP finale non puo' essere inferiore al CAP ini
      -              "ziale !"            to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           go to     acc-cap-max-100.
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : CAP finale                *
      *    *-----------------------------------------------------------*
       vis-cap-max-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       cnt-tdo-nok-125.
      *                  *---------------------------------------------*
      *                  * Test su codice regione                      *
      *                  *---------------------------------------------*
           if        w-tes-cod-rgn (1)    not  = spaces
                     go to cnt-tdo-nok-150.
           move      "ME"                 to   v-ope                  .
           move      "Manca la regione di appartenenza !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  * Controllo su CAP min e max                  *
      *                  *---------------------------------------------*
           if        w-tes-cap-min (1)    =    zero
                     go to cnt-tdo-nok-500.
           if        w-tes-cap-max (1)    not  = zero
                     go to cnt-tdo-nok-155.
           move      "ME"                 to   v-ope                  .
           move      "Manca il CAP finale !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "#"                  to   w-cnt-tdo-nok-flg      .
      ...
      *              *-------------------------------------------------*
       cnt-tdo-nok-525.
      *                  *---------------------------------------------*
      *                  * Controllo su : CAP finale                   *
      *                  *---------------------------------------------*
           if        w-tes-cap-min (1)    not  = zero
                     go to cnt-tdo-nok-550.
           move      zero                 to   w-tes-cap-max (1)      .
       cnt-tdo-nok-550.
      *                  *---------------------------------------------*
      *                  * Controllo su : Si/no capoluogo              *
      *                  *---------------------------------------------*
           if        w-tes-snx-cpl (1)    not  = "S"
                     move  "N"            to   w-tes-snx-cpl (1)      .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-prv (1)      .
           move      spaces               to   w-tes-des-upp (1)      .
           move      spaces               to   w-tes-cod-rgn (1)      .
           move      spaces               to   w-tes-cod-rgn-des (1)  .
           move      spaces               to   w-tes-snx-cpl (1)      .
           move      spaces               to   w-tes-cap-min (1)      .
           move      spaces               to   w-tes-cap-max (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-prv        to   rf-gxp-cod-prv         .
           move      "pgm/geo/fls/ioc/obj/iofgxp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [gxp]                        *
      *                          *-------------------------------------*
           move      rf-gxp-des-prv       to   w-tes-des-prv (1)      .
           move      rf-gxp-des-upp       to   w-tes-des-upp (1)      .
           move      rf-gxp-cod-rgn       to   w-tes-cod-rgn (1)      .
           move      rf-gxp-snx-cpl       to   w-tes-snx-cpl (1)      .
           move      rf-gxp-cap-min       to   w-tes-cap-min (1)      .
           move      rf-gxp-cap-max       to   w-tes-cap-max (1)      .
           move      rf-gxp-cod-ist       to   w-tes-cod-ist (1)      .
           move      rf-gxp-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      ...
      *                      * Write record [gxp]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-gxp-000      thru wrt-rec-gxp-999        .
      ...
      *                      * Rewrite record [gxp]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-gxp-000      thru rew-rec-gxp-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [gxp]                             *
      *              *-------------------------------------------------*
           perform   del-rec-gxp-000      thru del-rec-gxp-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [gxp]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-gxp-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-upp (1)    to   rf-gxp-des-upp         .
           move      w-tes-des-prv (1)    to   rf-gxp-des-prv         .
           move      w-tes-cod-rgn (1)    to   rf-gxp-cod-rgn         .
           move      w-tes-snx-cpl (1)    to   rf-gxp-snx-cpl         .
           move      w-tes-cap-min (1)    to   rf-gxp-cap-min         .
           move      w-tes-cap-max (1)    to   rf-gxp-cap-max         .
           move      w-tes-cod-ist (1)    to   rf-gxp-cod-ist         .
           move      w-tes-alx-exp (1)    to   rf-gxp-alx-exp         .
       cmp-rec-gxp-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [gxp]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-gxp-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-gxp-000      thru cmp-rec-gxp-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
