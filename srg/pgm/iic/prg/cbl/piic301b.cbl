      ...
      *                       Ultima revisione:    NdK del 26/01/06    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Interrogazione movimenti per tipo opera-    *
      *                    zione                                       *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     " RICERCA MOVIMENTI PER TIPO OPERAZIONE  "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per determinazione ragione sociale cliente/for-  *
      *        * nitore relativa alla testata movimento Iva intraco-   *
      *        * munitaria in esame                                    *
      *        *-------------------------------------------------------*
           05  w-det-rag-cof.
      *            *---------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Se tipo operazione zero : reimpostazione    *
      *                  *---------------------------------------------*
           if        rr-top-iic           =    zero
                     go to acc-top-iic-100.
       acc-top-iic-600.
      ...
      *              *-------------------------------------------------*
           if        rr-top-iic           not  = zero
                     go to tdo-ric-sel-200.
           move      "Manca il tipo operazione da ricercare !           
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su [iit] per tipo operazione              *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "TOPDAT    "         to   f-key                  .
           move      "NL"                 to   f-cfr                  .
           move      rr-top-iic           to   rf-iit-top-iic         .
      ...
      *              *-------------------------------------------------*
       ...
       qry-let-seq-100.
      *              *-------------------------------------------------*
      *              * Next su [iit] per tipo operazione               *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/iic/fls/ioc/obj/iofiit"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
       ...
       qry-tst-max-100.
      *              *-------------------------------------------------*
      *              * Se oltre tipo operazione : superamento          *
      *              *-------------------------------------------------*
      ...
      *                  * care e' pari a spazi : nessuna selezione    *
      *                  *---------------------------------------------*
           if        rr-iso-cee           =    spaces
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-int      .
      *              *-------------------------------------------------*
      *              * Determinazione ragione sociale cliente/fornito- *
      *              * relativa alla testata movimento Iva intracomu-  *
      *              * nitaria in esame                                *
      *              *-------------------------------------------------*
           perform   det-rag-cof-000      thru det-rag-cof-999        .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      16                   to   v-pos                  .
           if        rf-iit-tip-arc       =    spaces or
                     rf-iit-tip-arc       =    "N"
                     move  spaces         to   v-alf
           else if   rf-iit-tip-arc       =    "C"
                     move  "[C]"          to   v-alf
           else if   rf-iit-tip-arc       =    "F"
                     move  "[F]"          to   v-alf
           else      move  rf-iit-tip-arc to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-300.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      20                   to   v-pos                  .
           move      w-det-rag-cof-rag    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-325.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "  Data   Tipo      Ragione sociale fornitore o cli
      -              "ente           Ammontare      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *    *===========================================================*
      *    * Determinazione ragione sociale cliente/fornitore relativa *
      *    * alla testata movimento Iva intracomunitaria in esame      *
      *    *-----------------------------------------------------------*
       det-rag-cof-000.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo archivio per    *
      *              * trattare un cliente o un fornitore              *
      *              *-------------------------------------------------*
           if        rf-iit-tip-arc       =    spaces or
                     rf-iit-tip-arc       =    "N"
                     go to det-rag-cof-100
           else if   rf-iit-tip-arc       =    "C"
                     go to det-rag-cof-200
           else if   rf-iit-tip-arc       =    "F"
                     go to det-rag-cof-300
           else      go to det-rag-cof-400.
       det-rag-cof-100.
      *              *-------------------------------------------------*
      *              * Se no tipo archivio                             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Forzatura literal a spaces                  *
      *                  *---------------------------------------------*
           move      spaces               to   w-det-rag-cof-rag      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     det-rag-cof-999.
       det-rag-cof-200.
      *              *-------------------------------------------------*
      *              * Se cliente                                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-let-arc-cli-rag    to   w-det-rag-cof-rag      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     det-rag-cof-999.
      ...
      *                  * Memorizzazione ragione sociale              *
      *                  *---------------------------------------------*
           move      w-let-arc-fnt-rag    to   w-det-rag-cof-rag      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     det-rag-cof-999.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Forzatura literal di errore                 *
      *                  *---------------------------------------------*
           move      all   "."            to   w-det-rag-cof-rag      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     det-rag-cof-999.
