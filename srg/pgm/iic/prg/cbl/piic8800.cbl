      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Generazione archivio sequenziale prodotti   *
      *                    con nomenclatura combinata                  *
      *                                                                *
      *                    Per procedura INSTAT - IDEP (v.7.2.3-P-IT)  *
      *                                                                *
      *                    ------------------------------------------- *
      *                                                                *
      *                    File esp. : /abd/asc/UTENTE/exp/iic880.TXT  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "ESPORTAZIONE ANAGRAFICA PRODOTTI - IDEP "       .
      ...
      *        *-------------------------------------------------------*
           05  w-rdp.
      *            *---------------------------------------------------*
      *            * Codice prodotto alfanumerica                      *
      *            *---------------------------------------------------*
               10  w-rdp-alf-pro          pic  x(25)                  .
               10  w-rdp-sep-001          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice nomenclatura combinata                     *
      *            *---------------------------------------------------*
               10  w-rdp-cdn-cdm          pic  9(08)                  .
               10  w-rdp-sep-002          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Descrizione in uppercase                          *
      *            *---------------------------------------------------*
               10  w-rdp-des-key          pic  x(140)                 .
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Test su codice nomenclatura combinata           *
      *              *-------------------------------------------------*
      ...
      *                  * Codice nomenclatura combinata               *
      *                  *---------------------------------------------*
           move      rf-dcp-cdn-cdm       to   w-rdp-cdn-cdm          .
           move      ","                  to   w-rdp-sep-002          .
      *                  *---------------------------------------------*
      *                  * Descrizione in uppercase                    *
      *                  *---------------------------------------------*
           move      rf-dcp-des-key       to   w-rdp-des-key          .
      *                  *---------------------------------------------*
      *                  * Carattere di fine record                    *
      *                  *---------------------------------------------*
