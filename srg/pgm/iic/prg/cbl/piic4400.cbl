      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma piic4401:        *
      *                                                                *
      ...
      *                  * Visualizzazione messaggio di errore         *
      *                  *---------------------------------------------*
           perform   pre-exe-pgm-err-000  thru pre-exe-pgm-err-999    .
      *                  *---------------------------------------------*
      *                  * Uscita con errore                           *
      *                  *---------------------------------------------*
           move      "#"                  to   w-cnt-pre-exe-pgm      .
      ...
      *                          *-------------------------------------*
           move      "Non e' ancora possibile stampare la dichiarazione 
      -              "iva annuale.   "    to   w-err-box-err-msg      .
      *                          *-------------------------------------*
      *                          * Composizione messaggio - riga 2     *
      *                          *-------------------------------------*
           move      65                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      "Devono essere ancora stampati tutti i giornali iva
      -              " dell'anno"         to   w-all-str-cat (1)      .
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se dichiarazione annuale : controllo    *
      *                      * gia' effettuato                         *
      *                      *-----------------------------------------*
           if        rr-tip-dic           =    "A"
