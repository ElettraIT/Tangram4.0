      ...
      *                    fornitori                                   *
      *                                                                *
      *                    Per procedura INSTAT - IDEP (v.7.2.3-P-IT)  *
      *                                                                *
      *                    ------------------------------------------- *
      *                                                                *
      *                    File esp. : /abd/asc/UTENTE/exp/iic890.TXT  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "ESPORTAZIONE ANAGRAFICHE PARTNERS - IDEP"       .
      ...
      *    * archivio sequenziale - INSTAT - IDEP                      *
      *    *-----------------------------------------------------------*
       01  w-rgs.
      *        *-------------------------------------------------------*
      *        * Record del partner                                    *
      ...
      *            * Codice fiscale                                    *
      *            *---------------------------------------------------*
               10  w-rdp-cod-fis          pic  x(20)                  .
               10  w-rdp-sep-001          pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Ragione sociale in uppercase                      *
      *            *---------------------------------------------------*
               10  w-rdp-rag-key          pic  x(35)                  .
      *            *---------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-cli-cod-naz       to   rf-gxn-cod-naz         .
           move      "pgm/geo/fls/ioc/obj/iofgxn"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-cli-200.
      *                          *-------------------------------------*
      *                          * Test su segnale di appartenenza CEE *
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODNAZ    "         to   f-key                  .
           move      rf-fnt-cod-naz       to   rf-gxn-cod-naz         .
           move      "pgm/geo/fls/ioc/obj/iofgxn"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      "SIMULAZIONE GENERAZIONE ARCHIVIO IDEP"
      ...
      *                  * Codice fiscale                              *
      *                  *---------------------------------------------*
           move      srt-cod-fis          to   w-rdp-cod-fis          .
           move      ","                  to   w-rdp-sep-001          .
      *                  *---------------------------------------------*
      *                  * Ragione sociale in uppercase                *
      *                  *---------------------------------------------*
           move      srt-rag-key          to   w-rdp-rag-key          .
      *                  *---------------------------------------------*
      *                  * Carattere di fine record                    *
      *                  *---------------------------------------------*
