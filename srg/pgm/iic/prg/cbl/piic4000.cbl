      ...
      *                       Ultima revisione:    NdK del 19/11/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma piic4001:        *
      *                                                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts : Tipo stampa                     *
      *    *-----------------------------------------------------------*
       pmt-tip-stp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-dic-tit-000.
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Dicitura per titolo stampa :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-dic-tit-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      w-ref-giv-ven-des    to   rr-dic-tit             .
      ...
      *              *-------------------------------------------------*
           ...
           move      "ME"                 to   v-ope                  .
           move      "Tipo di stampa indefinito"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           if        rr-dic-tit           not  = spaces
                     go to tdo-ric-sel-500.
           move      "ME"                 to   v-ope                  .
           move      "Manca il titolo per la stampa!                    
      -              "        "           to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
