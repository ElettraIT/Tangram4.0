      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "  RICERCA MOVIMENTI CONTABILI CLIENTE   "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Codice cliente da ricercare                           *
      *        *-------------------------------------------------------*
           05  rr-cod-cli                 pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice cliente da ricercare, ragione sociale          *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
      ...
      -              " le registrazioni contabili   "
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       relative al cliente con causale di moviment
      -              "azione con tipo movimento     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      26                   to   w-cod-mne-cli-pos      .
           move      05                   to   w-cod-mne-cli-rln      .
           move      38                   to   w-cod-mne-cli-rps      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "Manca il codice cliente da ricercare !            
      ...
      *                  * Numerazione massima                         *
      *                  *---------------------------------------------*
           if        w-prs-mul-giv-snx    =    "S"
                     move  w-prs-mul-giv-max
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-mgr-num-prt       to   w-rot-l01-num-prt      .
           move      rf-mgr-dat-reg       to   w-rot-l01-dat-reg      .
       qry-cmp-rot-999.
           exit.
      ...
      *                  * Ragione sociale                             *
      *                  *---------------------------------------------*
           move      rr-cod-cli-rag       to   w-edt-sbt-edt-rag      .
       sub-edt-sbt-100.
      *              *-------------------------------------------------*
