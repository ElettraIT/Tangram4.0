      ...
      *                       Ultima revisione:    NdK del 19/01/93    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase iic301, nella sua globalita', esegue i tipi di inter-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * IMODAT      Interrogazione movimenti per data                  *
      *                                                                *
      * IMOTOP      Interrogazione movimenti per tipo operazione       *
      *                                                                *
      * IMOFNT      Interrogazione movimenti per fornitore             *
      *                                                                *
      * IMOCLI      Interrogazione movimenti per cliente               *
      *                                                                *
      * RRCIIM      Ricerca registrazioni contabili relative ad Iva    *
      *             intracomunitaria, sia fornitori che clienti,       *
      *             mancanti della corrispondente registrazione di     *
      *             Iva intracomunitaria                               *
      *                                                                *
      * RRCIIF      Ricerca registrazioni contabili relative ad Iva    *
      *             intracomunitaria per fornitore                     *
      *             (non selezionabile per impostazione)               *
      *                                                                *
      * RRCIIC      Ricerca registrazioni contabili relative ad Iva    *
      *             intracomunitaria per cliente                       *
      *             (non selezionabile per impostazione)               *
      *                                                                *
      * ESPIIT      Espansione testata movimento                       *
      *             (non selezionabile per impostazione)               *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   RICERCHE PER IVA INTRACOMUNITARIA   "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'iic301'           *
      *              *-------------------------------------------------*
           perform   fas-iic-301-000      thru fas-iic-301-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *
           move      "Interrogazione movimenti per data                 
      -              " IMODAT     piic301a  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Interrogazione movimenti per tipo operazione      
      -              " IMOTOP     piic301b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Interrogazione movimenti per fornitore            
      -              " IMOFNT     piic301c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Interrogazione movimenti per cliente              
      -              " IMOCLI     piic301d  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Controllo incrociato con registrazioni I.v.a.     
      -              " RRCIIM     piic301l  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Ricerca registrazioni contabili per fornitore     
      -              "*RRCIIF     piic301m  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Ricerca registrazioni contabili per cliente       
      -              "*RRCIIC     piic301n  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Espansione testata movimento Iva intracomunitaria 
      -              "*ESPIIT     piic301x  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *       
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-iic-301-300
           else if   v-key                =    "PRSC"
                     go to fas-iic-301-400
           else if   v-key                =    "NXSC"
                     go to fas-iic-301-450
           else if   v-key                =    "DOWN"
                     go to fas-iic-301-500
           else if   v-key                =    "EXIT"
                     go to fas-iic-301-250
           else      go to fas-iic-301-200.
       fas-iic-301-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-iic-301-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-iic-301-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-iic-301-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-iic-301-350
           else      go to fas-iic-301-322.
       fas-iic-301-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-iic-301-630
           else if   v-key                =    "PRSC"
                     go to fas-iic-301-600
           else if   v-key                =    "NXSC"
                     go to fas-iic-301-610
           else if   v-key                =    "UP  "
                     go to fas-iic-301-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-iic-301-650
           else if   v-key                =    "EXIT"
                     go to fas-iic-301-660
           else      go to fas-iic-301-570.
       fas-iic-301-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-iic-301-626
           else      go to fas-iic-301-628.
       fas-iic-301-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-iic-301-636
           else      go to fas-iic-301-638.
       fas-iic-301-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-iic-301-725
           else      go to fas-iic-301-750.
       fas-iic-301-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
