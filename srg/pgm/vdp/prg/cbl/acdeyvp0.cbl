      ...
      *                                                                *
      *              Input  : w-cod-des-yvp-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-yvp-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-yvp-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-yvp-cod : codice tipo movim.   *
      *                                                                *
      *                       w-cod-des-yvp-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-yvp-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-yvp-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-yvp-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-yvp-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-yvp-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-yvp-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-yvp-cod : codice tipo movim.   *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-yvp.
           05  w-aux-cde-yvp-nli          pic  9(02)                  .
           05  w-aux-cde-yvp-crb          pic  9(02)                  .
           05  w-aux-cde-yvp-cpb          pic  9(02)                  .
           05  w-aux-cde-yvp-cpa          pic  9(02)                  .
           05  w-aux-cde-yvp-bix          pic  9(02)                  .
           05  w-aux-cde-yvp-buf
                               occurs 30.
               10  w-aux-cde-yvp-bco      pic  x(05)                  .
               10  w-aux-cde-yvp-bde      pic  x(30)                  .
           05  w-aux-cde-yvp-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-yvp-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-yvp-lt2      pic  9(01)                  .
           05  w-aux-cde-yvp-dup          pic  x(30)                  .
           05  w-aux-cde-yvp-dmx.
               10  w-aux-cde-yvp-dch
                               occurs 30  pic  x(01)                  .
           05  w-aux-cde-yvp-c01          pic  9(02)                  .
           05  w-aux-cde-yvp-c02          pic  9(02)                  .
           05  w-aux-cde-yvp-c03          pic  9(02)                  .
           05  w-aux-cde-yvp-c04          pic  9(02)                  .
           05  w-aux-cde-yvp-c05          pic  9(02)                  .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-yvp
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-yvp-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-yvp-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-yvp-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-yvp-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-yvp-ope    =    "A+" or
                     w-cod-des-yvp-ope    =    "I+" or
                     w-cod-des-yvp-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-yvp-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-cod-des-yvp-cod    to   w-cod-des-yvp-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-yvp-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-yvp-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-yvp-s90    to   v-ufk                  .
           move      w-cod-des-yvp-lin    to   v-lin                  .
           move      w-cod-des-yvp-pos    to   v-pos                  .
           move      w-cod-des-yvp-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-yvp-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-yvp-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-yvp-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-yvp-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-yvp-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-yvp-cod    to   w-cod-des-yvp-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-yvp-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-yvp-dln    =    zero or
                     w-cod-des-yvp-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-yvp-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      w-cod-des-yvp-dln    to   v-lin                  .
           move      w-cod-des-yvp-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-yvp-dln    to   v-lin                  .
           move      w-cod-des-yvp-dps    to   v-pos                  .
           move      w-aux-cde-yvp-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-yvp-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-yvp-dup    to   w-aux-cde-yvp-dmx      .
           move      30                   to   w-aux-cde-yvp-c01      .
       aco-680.
           if        w-aux-cde-yvp-c01    >    zero
                     if    w-aux-cde-yvp-dch
                          (w-aux-cde-yvp-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-yvp-dch
                                              (w-aux-cde-yvp-c01)
                           subtract 1     from w-aux-cde-yvp-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-yvp-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      w-aux-cde-yvp-dup    to   rf-yvp-des-key         .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-yvp-des-key       >    w-aux-cde-yvp-dmx
                     go to aco-800.
      *                          *-------------------------------------*
      *                          * Selezione sul record                *
      *                          *-------------------------------------*
           if        rf-yvp-cod-dpz       not  = zero
                     go to aco-710.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-yvp-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-yvp-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      rf-yvp-cod-tmv       to   w-aux-cde-yvp-bco
                                              (w-aux-cde-yvp-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione tipo movimento      *
      *                              *---------------------------------*
           move      rf-yvp-des-tmv       to   w-aux-cde-yvp-bde
                                              (w-aux-cde-yvp-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-yvp-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-yvp-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-yvp-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      30                   to   s-car                  .
           move      w-aux-cde-yvp-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-yvp-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-yvp-bco
                    (w-aux-cde-yvp-bix)   to   w-cod-des-yvp-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-yvp-crb    to   w-aux-cde-yvp-cpb      .
           subtract  1                    from w-aux-cde-yvp-cpb      .
           divide    6                    into w-aux-cde-yvp-cpb      .
           add       1                    to   w-aux-cde-yvp-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-yvp-c01      .
      *                              *---------------------------------*
      ...
      *                              * di indice (w-aux-cde-yvp-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-yvp-c01    to   w-aux-cde-yvp-nli      .
       aco-865.
           if        w-aux-cde-yvp-nli    >    6
                     subtract  6          from w-aux-cde-yvp-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-yvp-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-yvp-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-yvp-c01    <    w-aux-cde-yvp-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-yvp-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-yvp-cpa    <    w-aux-cde-yvp-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-yvp-nli    to   v-lin                  .
           move      30                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-yvp-c01    to   w-aux-cde-yvp-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-yvp-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-yvp-cpa    to   w-aux-cde-yvp-c01      .
           multiply  6                    by   w-aux-cde-yvp-c01      .
           subtract  5                    from w-aux-cde-yvp-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-yvp-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-yvp-c01    to   w-aux-cde-yvp-c02      .
           add       5                    to   w-aux-cde-yvp-c02      .
           divide    6                    into w-aux-cde-yvp-c02      .
           move      w-aux-cde-yvp-c02    to   w-aux-cde-yvp-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-yvp-c02      .
           multiply  6                    by   w-aux-cde-yvp-c02      .
           add       1                    to   w-aux-cde-yvp-c02      .
           add       5
                     w-aux-cde-yvp-c02  giving w-aux-cde-yvp-c03      .
           move      w-aux-cde-yvp-c03    to   w-aux-cde-yvp-c04      .
           if        w-aux-cde-yvp-c03    >    w-aux-cde-yvp-crb
                     move  w-aux-cde-yvp-crb
                                          to   w-aux-cde-yvp-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-yvp-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      05                   to   v-car                  .
           move      w-aux-cde-yvp-c05    to   v-lin                  .
           move      23                   to   v-pos                  .
           move      w-aux-cde-yvp-bco
                    (w-aux-cde-yvp-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-yvp-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-yvp-c02    not  > w-aux-cde-yvp-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-yvp-c02    >    w-aux-cde-yvp-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-yvp-cpa    to   w-aux-cde-yvp-lt1      .
           move      w-aux-cde-yvp-cpb    to   w-aux-cde-yvp-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-yvp-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
