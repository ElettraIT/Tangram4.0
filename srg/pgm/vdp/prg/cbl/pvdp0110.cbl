      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tipi movimento per versa-    *
      *                    menti da produzione                         *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-mpn.
      *        *-------------------------------------------------------*
      *        * Codice tipo movimento versamento da produzione        *
      *        *-------------------------------------------------------*
           05  w-mpn-cod-tmv              pic  x(05)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [yvp]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/vdp/fls/ioc/obj/iofyvp"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      30                   to   v-pos                  .
           move      rf-yvp-des-tmv       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-yvp-cod-tmv       to   w-mpn-cod-tmv          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-tmv'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      " TIPI MOVIMENTO VERSAMENTI DA PRODUZIONE"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
