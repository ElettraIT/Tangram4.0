      ...
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Ragione sociale da [cli]                          *
      *            *---------------------------------------------------*
               10  srt-cli-rag-soc        pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Indirizzo da [cli]                                *
      *            *---------------------------------------------------*
               10  srt-cli-via-cli        pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Localita' da [cli]                                *
      *            *---------------------------------------------------*
               10  srt-cli-loc-cli        pic  x(40)                  .
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   CONTROLLO RAGIONI SOCIALI CLIENTI    "       .
      ...
      *        * Ragione sociale da [cli]                              *
      *        *-------------------------------------------------------*
           05  w-mai-cli-rag-soc          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Indirizzo da [cli]                                    *
      *        *-------------------------------------------------------*
           05  w-mai-cli-via-cli          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Localita' da [cli]                                    *
      *        *-------------------------------------------------------*
           05  w-mai-cli-loc-cli          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Ragione sociale da [dcc]                              *
      *        *-------------------------------------------------------*
           05  w-mai-dcc-rag-soc          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Indirizzo da [dcc]                                    *
      *        *-------------------------------------------------------*
           05  w-mai-dcc-via-cli          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Localita' da [dcc]                                    *
      *        *-------------------------------------------------------*
           05  w-mai-dcc-loc-cli          pic  x(40)                  .
      ...
      *
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "tra la ragione sociale in anagrafica contabile e l
      -              "a ragione sociale in anagrafi-"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-all-str-alf        to   w-mai-cli-rag-soc      .
      *
           move      rf-cli-via-cli       to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-mai-cli-via-cli      .
      *
           move      rf-cli-loc-cli       to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-mai-cli-loc-cli      .
      *
           move      rf-dcc-rag-soc       to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-mai-dcc-rag-soc      .
      *
           move      rf-dcc-via-dcc       to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-mai-dcc-via-cli      .
      *
           move      rf-dcc-loc-dcc       to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   w-mai-dcc-loc-cli      .
      *              *-------------------------------------------------*
      *              * Se non ci sono differenze tra le due anagrafi-  *
      *              * che : si ignora il cliente                      *
      *              *-------------------------------------------------*
           if        w-mai-cli-rag-soc    =    w-mai-dcc-rag-soc and
                     w-mai-cli-via-cli    =    w-mai-dcc-via-cli and
                     w-mai-cli-loc-cli    =    w-mai-dcc-loc-cli
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cli-rag-soc       to   srt-cli-rag-soc        .
           move      rf-cli-via-cli       to   srt-cli-via-cli        .
           move      rf-cli-loc-cli       to   srt-cli-loc-cli        .
      ...
      *              *-------------------------------------------------*
           move      "CONTROLLO RAGIONI SOCIALI CLIENTI"
