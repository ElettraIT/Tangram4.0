      ...
      *                                                                *
      *                    Manutenzione modalita' di consegna clienti  *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
               10  w-tes-fco-blo          pic  9(02)                  .
               10  w-tes-cod-vet          pic  9(07)                  .
               10  w-tes-cod-vet-rag      pic  x(40)                  .
               10  w-tes-cod-vet-via      pic  x(40)                  .
               10  w-tes-cod-vet-loc      pic  x(40)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-fco-blo          pic  9(02)                  .
               10  w-rig-cod-vet          pic  9(07)                  .
               10  w-rig-cod-vet-rag      pic  x(40)                  .
               10  w-rig-cod-vet-via      pic  x(40)                  .
               10  w-rig-cod-vet-loc      pic  x(40)                  .
               10  w-rig-cod-vet-mne      pic  x(40)                  .
           05  w-rig-002.
      ...
      *                *-----------------------------------------------*
                   ...
                   15  w-lin-imm-rag-cli.
                       ...
                       20  w-lin-imm-rag-dpz
                                          pic  x(04)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-fco-blo  pic  x(10)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-mne-vet  pic  x(10)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Flag di consegne bloccate                  *
      *        *-------------------------------------------------------*
           05  w-exp-fco-blo.
               10  w-exp-fco-blo-num      pic  9(02)       value 3    .
               10  w-exp-fco-blo-lun      pic  9(02)       value 25   .
               10  w-exp-fco-blo-tbl.
                   15  filler             pic  x(25) value
                            "Tutti i clienti          "               .
                   15  filler             pic  x(25) value
                            "Con consegne effettuabili"               .
                   15  filler             pic  x(25) value
                            "Con consegne bloccate    "               .
      *        *-------------------------------------------------------*
      *        * Work per : Flag di consegne bloccate per le righe     *
      *        *-------------------------------------------------------*
           05  w-exp-rig-blo.
               10  w-exp-rig-blo-num      pic  9(02)       value 2    .
               10  w-exp-rig-blo-lun      pic  9(02)       value 25   .
               10  w-exp-rig-blo-tbl.
                   15  filler             pic  x(25) value
                            "Consegne effettuabili    "               .
                   15  filler             pic  x(25) value
                            "Consegne bloccate        "               .
      ...
      *                  * Consegne bloccate                           *
      *                  *---------------------------------------------*
           perform   acc-fco-blo-000      thru acc-fco-blo-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Consegne bloccate                               *
      *              *-------------------------------------------------*
           perform   vis-fco-blo-000      thru vis-fco-blo-999        .
      *              *-------------------------------------------------*
      *              * Codice vettore abituale                         *
      *              *-------------------------------------------------*
      ...
      *                  * Consegne bloccate                           *
      *                  *---------------------------------------------*
           perform   pmt-fco-blo-000      thru pmt-fco-blo-999        .
      *                  *---------------------------------------------*
      *                  * Codice vettore abituale                     *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Consegne bloccate                *
      *    *-----------------------------------------------------------*
       pmt-fco-blo-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Si/no consegne bloccate      *
      *    *-----------------------------------------------------------*
       acc-fco-blo-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-fco-blo-lun    to   v-car                  .
           move      w-exp-fco-blo-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      10                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-fco-blo-tbl    to   v-txt                  .
           move      w-tes-fco-blo        to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-fco-blo-999.
       acc-fco-blo-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-fco-blo          .
       acc-fco-blo-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Si/no consegne bloccate   *
      *    *-----------------------------------------------------------*
       vis-fco-blo-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Codice vettore abituale      *
      *    *-----------------------------------------------------------*
       acc-cod-vet-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      13                   to   w-cod-mne-vet-vln      .
           move      41                   to   w-cod-mne-vet-vps      .
           move      14                   to   w-cod-mne-vet-lln      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura archivio vettori                    *
      *                  *---------------------------------------------*
           move      w-tes-cod-vet        to   w-let-arc-vet-cod      .
           perform   let-arc-vet-000      thru let-arc-vet-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione ragione sociale vettore      *
      *                  *---------------------------------------------*
           move      w-let-arc-vet-rag    to   w-tes-cod-vet-rag      .
           move      w-let-arc-vet-via    to   w-tes-cod-vet-via      .
           move      w-let-arc-vet-loc    to   w-tes-cod-vet-loc      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      13                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-cod-vet-via    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      14                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-cod-vet-loc    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-vet-rag-999.
           exit.
      ...
      *                  * Consegne bloccate                           *
      *                  *---------------------------------------------*
           perform   acc-rig-blo-000      thru acc-rig-blo-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * Codice vettore                              *
      *                  *---------------------------------------------*
           perform   acc-rig-vet-000      thru acc-rig-vet-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                      *-----------------------------------------*
       ...
       vis-lin-cor-480.
      *                  *---------------------------------------------*
      *                  * Editing Consegne bloccate                   *
      *                  *---------------------------------------------*
           if        w-rig-fco-blo        =    01
                     move  "Ok        "   to   w-lin-imm-fco-blo
           else if   w-rig-fco-blo        =    02
                     move  "Bloccate  "   to   w-lin-imm-fco-blo
           else      move  spaces         to   w-lin-imm-fco-blo      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Editing Mnemonico vettore                   *
      *                  *---------------------------------------------*
           move      w-rig-cod-vet-mne    to   w-lin-imm-mne-vet      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              * Consegne bloccate                               *
      *              *-------------------------------------------------*
           perform   vis-rig-blo-000      thru vis-rig-blo-999        .
      *              *-------------------------------------------------*
      *              * Codice vettore                                  *
      *              *-------------------------------------------------*
           perform   vis-rig-vet-000      thru vis-rig-vet-999        .
           perform   vis-rig-vet-rag-000  thru vis-rig-vet-rag-999    .
       vis-rig-cor-999.
           exit.
      ...
      *                  * Consegne bloccate                           *
      *                  *---------------------------------------------*
           perform   pmt-rig-blo-000      thru pmt-rig-blo-999        .
      *                  *---------------------------------------------*
      *                  * Codice vettore                              *
      *                  *---------------------------------------------*
           perform   pmt-rig-vet-000      thru pmt-rig-vet-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice vettore                   *
      *    *-----------------------------------------------------------*
       pmt-rig-vet-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no consegne bloccate              *
      *    *-----------------------------------------------------------*
       acc-rig-blo-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-rig-blo-lun    to   v-car                  .
           move      w-exp-rig-blo-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      18                   to   v-lin                  .
           move      22                   to   v-pos                  .
           move      w-exp-rig-blo-tbl    to   v-txt                  .
           move      w-rig-fco-blo        to   v-num                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-prs-bol-snx        not  = "S"
                     go to acc-rig-vet-999.
       acc-rig-vet-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-vet-ope      .
           move      w-rig-cod-vet        to   w-cod-mne-vet-cod      .
           move      19                   to   w-cod-mne-vet-lin      .
           move      22                   to   w-cod-mne-vet-pos      .
           move      19                   to   w-cod-mne-vet-rln      .
           move      41                   to   w-cod-mne-vet-rps      .
           move      20                   to   w-cod-mne-vet-vln      .
           move      41                   to   w-cod-mne-vet-vps      .
           move      21                   to   w-cod-mne-vet-lln      .
           move      41                   to   w-cod-mne-vet-lps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
       ...
       acc-rig-vet-110.
           perform   cod-mne-vet-cll-000  thru cod-mne-vet-cll-999    .
           if        w-cod-mne-vet-ope    =    "F+"
                     go to acc-rig-vet-115.
           if        w-cod-mne-vet-ope    =    "AC"
                     go to acc-rig-vet-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-vet-115.
           perform   cod-mne-vet-foi-000  thru cod-mne-vet-foi-999    .
           go to     acc-rig-vet-110.
       acc-rig-vet-120.
           move      w-cod-mne-vet-cod    to   v-num                  .
       acc-rig-vet-150.
      *              *-------------------------------------------------*
      ...
      *                  * Memorizzazione ragione sociale vettore      *
      *                  *---------------------------------------------*
           move      w-let-arc-vet-rag    to   w-rig-cod-vet-rag      .
           move      w-let-arc-vet-via    to   w-rig-cod-vet-via      .
           move      w-let-arc-vet-loc    to   w-rig-cod-vet-loc      .
           move      w-let-arc-vet-mne    to   w-rig-cod-vet-mne      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione ragione sociale vettore     *
      *                  *---------------------------------------------*
           perform   vis-rig-vet-rag-000  thru vis-rig-vet-rag-999    .
      ...
      *              *-------------------------------------------------*
           ...
           move      19                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-vet-rag    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Visualizzazione indirizzo                       *
      *              *-------------------------------------------------*
           ...
           move      20                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-vet-via    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Visualizzazione localita'                       *
      *              *-------------------------------------------------*
           ...
           move      21                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-vet-loc    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-vet-rag-999.
           exit.
      ...
      *                  * Consegne bloccate                           *
      *                  *---------------------------------------------*
           if        w-tes-fco-blo        =    zero
                     move  01             to   w-tes-fco-blo          .
           subtract  1                    from w-tes-fco-blo          .
       cnt-tdo-key-510.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo ordinamento *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-440.
      *              *-------------------------------------------------*
      *              * Controllo su Fatturazione Bloccata              *
      *              *-------------------------------------------------*
           if        w-rig-dpz-cli        not  = spaces
                     go to cnt-tdo-rig-450.
           if        w-rig-fco-blo        =    zero
                     go to cnt-tdo-rig-450.
           if        w-rig-fco-blo        not  > 02
                     go to cnt-tdo-rig-450.
           move      "Segnale per Consegne Bloccate errato              
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-450.
      *              *-------------------------------------------------*
      *              * Controllo su Codice vettore abituale            *
      *              *-------------------------------------------------*
           if        w-prs-bol-snx        not  = "S"
                     go to cnt-tdo-rig-600.
           if        w-rig-cod-vet        =    zero
                     go to cnt-tdo-rig-600.
           move      w-rig-cod-vet        to   w-let-arc-vet-cod      .
           perform   let-arc-vet-000      thru let-arc-vet-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   w-tes-cod-vet-via      .
           move      spaces               to   w-tes-cod-vet-loc      .
       nor-key-reg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-fco-blo          .
           move      zero                 to   w-rig-cod-vet          .
           move      spaces               to   w-rig-cod-vet-rag      .
           move      spaces               to   w-rig-cod-vet-via      .
           move      spaces               to   w-rig-cod-vet-loc      .
           move      spaces               to   w-rig-cod-vet-mne      .
       nor-nok-rig-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-dcc-fco-blo       not  = w-tes-fco-blo
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-dcc-cod-vet       not  = w-tes-cod-vet
                     go to sel-rec-dcc-900.
       sel-rec-dcc-800.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcc-fco-blo       to   w-rig-fco-blo          .
           move      rf-dcc-cod-vet       to   w-rig-cod-vet          .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-rig-fco-blo        to   rf-dcc-fco-blo         .
           move      w-rig-cod-vet        to   rf-dcc-cod-vet         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
