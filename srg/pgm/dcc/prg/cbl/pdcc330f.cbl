      ...
      *                                                                *
      *                    Aggiornamenti automatici prezzi clienti     *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "AGGIORNAMENTI PREZZI NETTI PIU' CLIENTI "       .
      ...
      *            * Codice listino                                    *
      *            *---------------------------------------------------*
               10  w-tes-cod-lst          pic  x(03) value spaces     .
      *            *---------------------------------------------------*
      *            * Codice agente                                     *
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.  Cod. prodotto         Descrizione prodotto 
      -              "      Cliente       Prezzo    "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              * Codice cliente                                  *
      *              *-------------------------------------------------*
           perform   vis-rig-cli-000      thru vis-rig-cli-999        .
           perform   vis-rig-cli-rag-000  thru vis-rig-cli-rag-999    .
      *              *-------------------------------------------------*
      *              * Data di validita' finale                        *
      *              *-------------------------------------------------*
      ...
      *              * Codice cliente                                  *
      *              *-------------------------------------------------*
           perform   pmt-rig-cli-000      thru pmt-rig-cli-999        .
      *              *-------------------------------------------------*
      *              * Data validita'                                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-rig-cod-cli-rag      .
      *              *-------------------------------------------------*
      *              * Decimali prezzo                                 *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-tip-apr        =    01
                     ...
                     go to stp-srt-inp-lst-430
           else      go to stp-srt-inp-lst-420.
       stp-srt-inp-lst-410.
      *                  *---------------------------------------------*
      *                  * Se tutti i prezzi                           *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rf-lst-dva-fin       <    s-dat
                     go to stp-srt-inp-lst-600
           else      go to stp-srt-inp-lst-450.
       stp-srt-inp-lst-430.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           else      go to stp-srt-inp-lst-600.
       stp-srt-inp-lst-460.
      *                  *---------------------------------------------*
      ...
      *              * Recupero dei record                             *
      *              *-------------------------------------------------*
           move      srt-rec-lst          to   rf-lst                 .
           move      srt-rec-dcp          to   rf-dcp                 .
       car-fil-rap-400.
      *              *-------------------------------------------------*
      *              * Test preliminari                                *
      *              *-------------------------------------------------*
           if        srt-alf-pro          =    spaces
      ...
      *
           ...
           move      srt-cod-cli          to   w-det-pbs-cod-cli      .
