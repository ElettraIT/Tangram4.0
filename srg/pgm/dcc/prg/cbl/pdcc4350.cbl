      ...
      *                                   Fase:    dcc435              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/05/96    *
      *                       Ultima revisione:    NdK del 16/07/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcc4351:        *
      *                                                                *
      *                    Stampa codici prodotti per un cliente       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   STAMPA CODICI PRODOTTI PER CLIENTE   "       .
           ...
           05  w-exp-tip-slp.
               ...
               10  w-exp-tip-slp-tbl.
                   ...
                   15  filler             pic  x(20) value
                            "ad ogni Sottogruppo "                    .
      *        *-------------------------------------------------------*
      *        * Work per : Si/no stampa codici nulli                  *
      *        *-------------------------------------------------------*
           05  w-exp-snx-cod.
               10  w-exp-snx-cod-num      pic  9(02)       value 4    .
               10  w-exp-snx-cod-lun      pic  9(02)       value 40   .
               10  w-exp-snx-cod-tbl.
                   ...
                   15  filler             pic  x(40) value
                            "solo Senza codici                       ".
                   15  filler             pic  x(40) value
                            "solo Difformi da ordini inevasi         ".
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-450.
      *                  *---------------------------------------------*
      *                  * Si/no stampa codici nulli                   *
      *                  *---------------------------------------------*
           perform   acc-snx-cod-000      thru acc-snx-cod-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * Si/no stampa codici nulli                       *
      *              *-------------------------------------------------*
           perform   pmt-snx-cod-000      thru pmt-snx-cod-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Prompt : Si/no stampa codici nulli                        *
      *    *-----------------------------------------------------------*
       pmt-snx-cod-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       acc-tip-rec-000.
      *              *-------------------------------------------------*
      *              * Forzatura a 05 del Tipo record                  *
      *              *-------------------------------------------------*
           move      05                   to   rr-tip-rec             .
       acc-tip-rec-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione : Si/no stampa codici nulli                  *
      *    *-----------------------------------------------------------*
       acc-snx-cod-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-cod-lun    to   v-car                  .
           move      w-exp-snx-cod-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      "NESD#"              to   v-msk                  .
           move      12                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-cod-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           if        w-cnt-sts-imp-ric    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
           move      rr-snx-cod           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-cod-999.
       acc-snx-cod-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-snx-cod             .
       acc-snx-cod-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       reg-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Normalizzazione Si/no stampa codici nulli       *
      *              *-------------------------------------------------*
           if        rr-snx-cod           not  = zero
                     go to reg-ric-sel-999.
           move      02                   to   rr-snx-cod             .
       reg-ric-sel-999.
           exit.
