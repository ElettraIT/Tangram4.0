      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pdcc0520 *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-cli           to   rf-cse-cod-cli         .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun tag da stampare entro i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-cse-cod-cli       not  = rr-cod-cli
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-tst-max-999.
       prn-tst-max-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-cse-cod-cli       to   w-rot-l01-cod-cli      .
           move      rf-cse-dpz-cli       to   w-rot-l01-dpz-cli      .
       prn-cmp-rot-999.
           exit.
      ...
      *                          *-------------------------------------*
           ...
           move      rf-cse-cod-cli       to   rf-dcc-cod-cli         .
           move      rf-cse-dpz-cli       to   rf-dcc-dpz-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
           ...
           move      rf-cse-cod-tag       to   rf-ztg-cod-tag         .
           move      "pgm/fat/fls/ioc/obj/iofztg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
           if        rf-ztg-sns-tag       =    "S"
                     move "(Tag con sotto elementi)"
                                          to   w-all-str-alf
           else      move  rf-cse-pma-alf to   w-all-str-alf          .
      *                          *-------------------------------------*
      *                          * Stampa                              *
      *                          *-------------------------------------*
           move      "PF"                 to   p-ope                  .
      ...
      *              *-------------------------------------------------*
           move      "TAG PER FATTURE 'XML' CLIENTI"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "     Tag                      Descrizione         
      -              "          Valore da esporre per il cliente     "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
