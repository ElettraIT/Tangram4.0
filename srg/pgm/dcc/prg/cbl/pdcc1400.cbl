      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   GESTIONE CODICI STATISTICI CLIENTI   "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cls        to   w-cmn-zst-003-cod      .
           move      04                   to   w-cmn-zst-003-lin      .
           move      30                   to   w-cmn-zst-003-pos      .
           move      07                   to   w-cmn-zst-003-dln      .
           move      30                   to   w-cmn-zst-003-dps      .
           move      "<B"                 to   v-edm                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cls        to   rf-zst-cod-cls         .
           move      "pgm/dcc/fls/ioc/obj/iofzst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-zst-mne-cls       to   w-tes-mne-cls (1)      .
           move      rf-zst-des-key       to   w-tes-des-key (1)      .
           move      rf-zst-des-cls       to   w-tes-des-cls (1)      .
           move      rf-zst-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zst]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zst-000      thru wrt-rec-zst-999        .
      ...
      *                      * Rewrite record [zst]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zst-000      thru rew-rec-zst-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zst]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zst-000      thru del-rec-zst-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zst]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zst-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-mne-cls (1)    to   rf-zst-mne-cls         .
           move      w-tes-des-key (1)    to   rf-zst-des-key         .
           move      w-tes-des-cls (1)    to   rf-zst-des-cls         .
           move      w-tes-alx-exp (1)    to   rf-zst-alx-exp         .
       cmp-rec-zst-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zst]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zst-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zst-000      thru cmp-rec-zst-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zst] parte 01    *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zst3"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           ...
           move      "CODCLS    "         to   f-key                  .
           move      03                   to   rf-zst-tip-cls         .
           move      w-enc-cod-val-pos    to   rf-zst-cod-cls         .
           move      "pgm/dcc/fls/ioc/obj/iofzst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       rip-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zst]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zst3"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
