      ...
      *                    con blocco consegne e/o ordini              *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
      *            * Flag di blocco consegne                           *
      *            *---------------------------------------------------*
               10  srt-dcc-fco-blo        pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Data di blocco consegne                           *
      *            *---------------------------------------------------*
               10  srt-dcc-dco-blo        pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Flag di blocco ordini                             *
      *            *---------------------------------------------------*
               10  srt-dcc-for-blo        pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Data di blocco ordini                             *
      *            *---------------------------------------------------*
               10  srt-dcc-dor-blo        pic  9(07)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   CLIENTI CON BLOCCO CONSEGNE/ORDINI   "       .
           ...
           05  w-exp-tip-ord.
               ...
               10  w-exp-tip-ord-tbl.
                   15  filler             pic  x(40) value
                            "Per codice cliente                      ".
                   15  filler             pic  x(40) value
                            "Per codice agente / codice cliente      ".
      ...
      *                  *---------------------------------------------*
       ...
       int-pag-std-900.
      *              *-------------------------------------------------*
      *              * Stampa eventuale dell'intestazione per agente   *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
      ...
      -              "i quali esiste un blocco delle"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "consegne e/o degli ordini.                        
      -              "                              "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Selezione su anagrafica clienti                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Non si considerano le dipendenze            *
      *                  *---------------------------------------------*
           if        rf-dcc-dpz-cli       not  = spaces
                     go to stp-srt-inp-100.
      *                  *---------------------------------------------*
      *                  * Test su flags di blocco consegne / ordini   *
      *                  *---------------------------------------------*
           if        rf-dcc-fco-blo       =    01 and
                     rf-dcc-for-blo       =    01
                     go to stp-srt-inp-100.
       stp-srt-inp-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           else      move  rf-dcc-cod-age to   srt-cod-age            .
           ...
           move      rf-dcc-fco-blo       to   srt-dcc-fco-blo        .
           move      rf-dcc-dco-blo       to   srt-dcc-dco-blo        .
           move      rf-dcc-for-blo       to   srt-dcc-for-blo        .
           move      rf-dcc-dor-blo       to   srt-dcc-dor-blo        .
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun cliente con blocchi da segnalare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           if        rr-tip-ord           =    01
                     move  zero           to   w-rot-l01-cod-age
           else      move  srt-cod-age    to   w-rot-l01-cod-age      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test sul tipo ordinamento stampa            *
      *                  *---------------------------------------------*
           if        rr-tip-ord           not  = 02
      ...
      *                  * Se codice a zero                            *
      *                  *---------------------------------------------*
           if        w-rot-l01-cod-age    =    zero
                     move  "(Senza cod. agente) "
                                          to   w-stp-int-age-nom
                     go to prn-ini-lr1-400.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rot-l01-cod-age    to   rf-age-cod-age         .
           move      "pgm/age/fls/ioc/obj/iofage"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      w-rot-l01-cod-age    to   w-stp-int-age-cod      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "CLIENTI CON CONSEGNE E/O ORDINI BLOCCATI"
