      ...
      *                    netti concordati per un prodotto            *
      *                                                                *
      *================================================================*
      ...
      *            * % di sconto                                       *
      *            *---------------------------------------------------*
               10  srt-per-sco occurs 5   pic  9(02)v9(01)            .
      *            *---------------------------------------------------*
      *            * % di provvigioni                                  *
      *            *---------------------------------------------------*
               10  srt-per-pvg occurs 3   pic  9(02)v9(01)            .
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA PREZZI NETTI CONCORDATI PRODOTTO "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-num-pro           to   rf-lst-num-pro         .
      ...
      *                  * Test su tipo record                         *
      *                  *---------------------------------------------*
           if        rf-lst-tip-rec       not  = 02
                     go to stp-srt-inp-999.
      *                  *---------------------------------------------*
      *                  * Test su codice prodotto                     *
      *                  *---------------------------------------------*
           if        rf-lst-num-pro       not  = rr-num-pro
                     go to stp-srt-inp-999.
      *                  *---------------------------------------------*
      *                  * Test su codice listino                      *
      *                  *---------------------------------------------*
           if        rf-lst-cod-lst       not  = spaces
                     go to stp-srt-inp-999.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *                      * Codice prodotto                         *
      *                      *-----------------------------------------*
           move      rf-lst-num-pro       to   srt-num-pro            .
      *                      *-----------------------------------------*
      *                      * Ragione sociale del cliente             *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-lst-cod-cli       to   w-let-arc-dcc-cli      .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun cliente da stampare entro i limiti assegnat
      -              "i !"                to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           ...
           string    "PREZZI NETTI PRODOTTO : "
                                delimited by size
                     rr-num-pro-alf
                                delimited by spaces
                                          into w-cnt-tit-des-tit      .
      *              *-------------------------------------------------*
      *              * Concatenazione titolo e prodotto                *
      *              *-------------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      "PREZZI NETTI PRODOTTO :"
                                          to   w-all-str-cat (1)      .
           move      rr-num-pro-alf       to   w-all-str-cat (2)      .
           move      rr-num-pro-des       to   w-all-str-cat (3)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "         Codice e ragione sociale cliente         
      -              "   Prezzo netto              % sconto          % p
      -              "rovvigioni   TF  Scadenza       "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
