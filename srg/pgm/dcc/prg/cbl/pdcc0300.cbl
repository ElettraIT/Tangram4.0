      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " GESTIONE TIPI DI SPESA PER FATTURAZIONE"       .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-fnd-arc-zsf-spf    to   w-tes-num-spf          .
           move      w-fnd-arc-zsf-lng    to   w-tes-cod-lng          .
      *                  *---------------------------------------------*
      *                  * Lettura tabella [zln]                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-des-ves (1)    to   w-tes-des-vri (1)      .
       acc-des-vri-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Codice Iva a zero per distribuire la spesa sulle a
      -              "liquote del documento"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Sottoconto a zero per distribuire la spesa sulle c
      -              "ontropartite del documento"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-num-spf        to   rf-zsf-num-spf         .
