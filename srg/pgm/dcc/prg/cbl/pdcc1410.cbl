      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su tabella Codici statistici *
      *                    clienti per fatturazione                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE CODICI STATISTICI CLIENTI"       .
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice cod. stat. clienti      *
      *    *-----------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per Det numero di record                         *
      *        *-------------------------------------------------------*
           05  w-det-num-rec.
      *            *---------------------------------------------------*
      *            * Contatore record                                  *
      *            *---------------------------------------------------*
               10  w-det-num-rec-ctr      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Max record (corrispondente a 3 videate da 16)     *
      *            *---------------------------------------------------*
               10  w-det-num-rec-max      pic  9(02) value 48         .

      *    *===========================================================*
      *    * Work-area per ridefinizione contenuto del mark-point      *
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-cod-cls              pic  9(05)                  .
      ...
      *                  *---------------------------------------------*
           perform   det-num-rec-000      thru det-num-rec-999        .
           if        w-det-num-rec-ctr    >    w-det-num-rec-max
                     go to pre-tip-fun-800.
      *                  *---------------------------------------------*
      *                  * No richieste ad utente                      *
      *                  *---------------------------------------------*
           move      "N"                  to   w-cnt-fun-snx-ric      .
      ...
      *                  *---------------------------------------------*
       ...
       pre-tip-fun-800.
      *              *-------------------------------------------------*
      *              * Se nessuna determinazione effettuata            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Determinazione numero di record nella tabella trattata    *
      *    *-----------------------------------------------------------*
       det-num-rec-000.
      *              *-------------------------------------------------*
      *              * [zst]                                           *
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-det-num-rec-ctr      .
       det-num-rec-100.
      *              *-------------------------------------------------*
      *              * Start su [zst]                                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           add       1                    to   w-det-num-rec-ctr      .
           if        w-det-num-rec-ctr    >    w-det-num-rec-max
                     go to det-num-rec-900.
       det-num-rec-800.
      *              *-------------------------------------------------*
      *              * Riciclo a record [zst] successivo               *
      *              *-------------------------------------------------*
           go to     det-num-rec-200.
       det-num-rec-900.
      *              *-------------------------------------------------*
      *              * [zst]                                           *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      40                   to   v-pos                  .
           move      rf-zst-des-cls       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zst-cod-cls       to   w-mpn-cod-cls          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-cls'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
