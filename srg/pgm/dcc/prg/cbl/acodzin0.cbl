      ...
      *                                   Fase:                        *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 09/07/91    *
      ...
      *                                                                *
      *              Input  : w-cod-cod-zin-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-zin-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-cod-zin-ope : "AC"                 *
      *                                                                *
      *                       w-cod-cod-zin-cod : spese incasso        *
      *                                                                *
      *                       w-cod-cod-zin-lin : linea                *
      *                                                                *
      *                       w-cod-cod-zin-pos : posizione            *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-zin-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-cod-zin-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-zin-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-cod-zin-cod : spese incasso        *
      ...
      ******************************************************************
       Procedure Division                using w-cod-cod-zin
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-cod-zin-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-cod-zin-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-cod-zin-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-cod-zin-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-cod-zin-ope    =    "A+" or
                     w-cod-cod-zin-ope    =    "I+" or
                     w-cod-cod-zin-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-cod-zin-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      w-cod-cod-zin-cod    to   w-cod-cod-zin-alf      .
           move      v-edm                to   w-cod-cod-zin-edm      .
           move      v-ufk                to   w-cod-cod-zin-ufk      .
      *              *-------------------------------------------------*
      *              * Accettazione                                    *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           ...
           move      w-cod-cod-zin-ufk    to   v-ufk                  .
           move      w-cod-cod-zin-lin    to   v-lin                  .
           move      w-cod-cod-zin-pos    to   v-pos                  .
           move      w-cod-cod-zin-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-cod-zin-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      v-alf                to   w-cod-cod-zin-alf      .
      *              *-------------------------------------------------*
      *              * Test se Exit o Delt                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-cod-cod-zin-alf    to   w-cod-cod-zin-cod      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     aco-999.
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-cod-zin-alf      .
      *                      *-----------------------------------------*
      *                      * Normalizzazione function-key            *
      *                      *-----------------------------------------*
           move      spaces               to   v-key                  .
      ...
      *              *-------------------------------------------------*
           if        w-cod-cod-zin-alf    =    spaces
                     go to aco-400.
           if        w-cod-cod-zin-cha (1)
                                          =    spaces
                     go to aco-100.
           move      1                    to   w-aux-cod-zin-c01      .
       aco-800.
           add       1                    to   w-aux-cod-zin-c01      .
           if        w-aux-cod-zin-c01    >    03
                     go to aco-400.
           if        w-cod-cod-zin-cha
                    (w-aux-cod-zin-c01)   not  = spaces
                     go to aco-800.
       aco-900.
           add       1                    to   w-aux-cod-zin-c01      .
           if        w-aux-cod-zin-c01    >    03
