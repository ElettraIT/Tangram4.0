      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma pdcc4100:       *
      *                                                                *
      ...
      *            * - Se ordinamento 02 : Codice agente               *
      ...
      *            * Se tipo record 02 : Ragione sociale cliente       *
      *            *---------------------------------------------------*
               10  srt-rag-soc            pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Se tipo record 01 : Descrizione per il codice     *
      *            * Se tipo record 02 : Indirizzo cliente             *
      *            *---------------------------------------------------*
               10  srt-via-cli            pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Se tipo record 01 : Asterischi                    *
      *            * Se tipo record 02 : Localita' cliente             *
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Se anagrafica commerciale cliente               *
      *              *-------------------------------------------------*
       stp-srt-inp-125.
      *                  *---------------------------------------------*
      *                  * Start su [dcc]                              *
      *                  *---------------------------------------------*
           ...
           else      move  spaces         to   rf-dcc-rag-key         .
      ...
      *                      *-----------------------------------------*
           if        rf-dcc-cod-age       =    zero
                     go to stp-srt-inp-150.
           if        rf-dcc-cod-age       <    rr-age-min or
                     rf-dcc-cod-age       >    rr-age-max
                     go to stp-srt-inp-150.
           go to     stp-srt-inp-225.
       stp-srt-inp-210.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rf-dcc-cod-zon       =    zero
                     go to stp-srt-inp-150.
           if        rf-dcc-cod-zon       <    rr-zon-min or
                     rf-dcc-cod-zon       >    rr-zon-max
                     go to stp-srt-inp-150.
           go to     stp-srt-inp-225.
       stp-srt-inp-212.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rf-dcc-cod-cat       =    zero
                     go to stp-srt-inp-150.
           if        rf-dcc-cod-cat       <    rr-cat-min or
                     rf-dcc-cod-cat       >    rr-cat-max
                     go to stp-srt-inp-150.
           go to     stp-srt-inp-225.
       stp-srt-inp-214.
      *                      *-----------------------------------------*
      *                      * Tipo di ordinamento stampa : 05         *
      *                      *-----------------------------------------*
           if        rf-dcc-cod-stt       =    zero
                     go to stp-srt-inp-150.
           if        rf-dcc-cod-stt       <    rr-stt-min or
                     rf-dcc-cod-stt       >    rr-stt-max
                     go to stp-srt-inp-150.
           go to     stp-srt-inp-225.
       stp-srt-inp-225.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-250.
      *                  *---------------------------------------------*
      *                  * Rilascio del record cliente                 *
      *                  *---------------------------------------------*
           move      spaces               to   srt-rec                .
           if        rr-tip-ord           =    02
                     move  rf-dcc-cod-age to   srt-cod-ord
           else if   rr-tip-ord           =    03
                     move  rf-dcc-cod-zon to   srt-cod-ord
           else if   rr-tip-ord           =    04
                     move  rf-dcc-cod-cat to   srt-cod-ord
           else if   rr-tip-ord           =    05
                     move  rf-dcc-cod-stt to   srt-cod-ord
      ...
      *
           ...
           move      rf-dcc-via-dcc       to   srt-via-cli            .
           move      rf-dcc-loc-dcc       to   srt-loc-cli            .
      *                      *-----------------------------------------*
      *                      * Rilascio                                *
      *                      *-----------------------------------------*
           release   srt-rec                                          .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      *              * Se anagrafica contabile cliente                 *
      *              *-------------------------------------------------*
       stp-srt-inp-525.
      *                  *---------------------------------------------*
      *                  * Start su [cli]                              *
      *                  *---------------------------------------------*
           ...
           else      move  spaces         to   rf-cli-rag-key         .
      ...
      *                  *---------------------------------------------*
       stp-srt-inp-602.
      *                      *-----------------------------------------*
      *                      * Lettura [dcc] se necessario             *
      *                      *-----------------------------------------*
           if        rr-tip-ord           not  = 02 and
                     rr-tip-ord           not  = 03 and
                     rr-tip-ord           not  = 04 and
                     rr-tip-ord           not  = 05
      ...
      *
           ...
           move      rf-cli-via-cli       to   srt-via-cli            .
           move      rf-cli-loc-cli       to   srt-loc-cli            .
      *
           release   srt-rec                                          .
       stp-srt-inp-675.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       ril-rec-tst-200.
      *              *-------------------------------------------------*
      *              * Se tipo di ordinamento di stampa 02             *
      *              *-------------------------------------------------*
       ril-rec-tst-210.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       ril-rec-tst-221.
           ...
           if        w-srt-buf-tst-inx    >    w-srt-buf-tst-num
                     go to ril-rec-tst-230.
           if        w-srt-buf-tst-cod
                    (w-srt-buf-tst-inx)   =    rf-dcc-cod-age
                     go to ril-rec-tst-999.
           go to     ril-rec-tst-221.
       ril-rec-tst-230.
      *                  *---------------------------------------------*
      *                  * Memorizzazione codice agente                *
      *                  *---------------------------------------------*
           add       1                    to   w-srt-buf-tst-num      .
           move      rf-dcc-cod-age       to   w-srt-buf-tst-cod
                                              (w-srt-buf-tst-num)     .
      *                  *---------------------------------------------*
      *                  * Lettura codice agente                       *
      *                  *---------------------------------------------*
           move      rf-dcc-cod-age       to   w-let-arc-age-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-let-arc-age-nom    to   srt-via-cli            .
           move      all   "*"            to   srt-loc-cli            .
       ril-rec-tst-250.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       ril-rec-tst-321.
           ...
           if        w-srt-buf-tst-cod
                    (w-srt-buf-tst-inx)   =    rf-dcc-cod-zon
                     go to ril-rec-tst-999.
      ...
      *                  *---------------------------------------------*
           add       1                    to   w-srt-buf-tst-num      .
           move      rf-dcc-cod-zon       to   w-srt-buf-tst-cod
                                              (w-srt-buf-tst-num)     .
      *                  *---------------------------------------------*
      *                  * Lettura codice zona                         *
      *                  *---------------------------------------------*
           move      01                   to   w-let-arc-zst-tip      .
           move      rf-dcc-cod-zon       to   w-let-arc-zst-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   srt-dic-int            .
           move      all   "*"            to   srt-rag-soc            .
           move      w-let-arc-zst-des    to   srt-via-cli            .
           move      all   "*"            to   srt-loc-cli            .
       ril-rec-tst-350.
      *                  *---------------------------------------------*
      *                  * Rilascio record testatina                   *
      ...
      *                  *---------------------------------------------*
       ...
       ril-rec-tst-421.
           ...
           if        w-srt-buf-tst-cod
                    (w-srt-buf-tst-inx)   =    rf-dcc-cod-cat
                     go to ril-rec-tst-999.
      ...
      *                  *---------------------------------------------*
           add       1                    to   w-srt-buf-tst-num      .
           move      rf-dcc-cod-cat       to   w-srt-buf-tst-cod
                                              (w-srt-buf-tst-num)     .
      *                  *---------------------------------------------*
      *                  * Lettura codice categoria                    *
      *                  *---------------------------------------------*
           move      02                   to   w-let-arc-zst-tip      .
           move      rf-dcc-cod-cat       to   w-let-arc-zst-cod      .
           perform   let-arc-zst-000      thru let-arc-zst-999        .
       ril-rec-tst-440.
      *                  *---------------------------------------------*
      *                  * Composizione record testatina               *
      ...
      *                  *---------------------------------------------*
       ...
       ril-rec-tst-521.
           ...
           if        w-srt-buf-tst-cod
                    (w-srt-buf-tst-inx)   =    rf-dcc-cod-stt
                     go to ril-rec-tst-999.
      ...
      *                  *---------------------------------------------*
           add       1                    to   w-srt-buf-tst-num      .
           move      rf-dcc-cod-stt       to   w-srt-buf-tst-cod
                                              (w-srt-buf-tst-num)     .
      *                  *---------------------------------------------*
      *                  * Lettura codice statistico                   *
      *                  *---------------------------------------------*
           move      03                   to   w-let-arc-zst-tip      .
           move      rf-dcc-cod-stt       to   w-let-arc-zst-cod      .
           perform   let-arc-zst-000      thru let-arc-zst-999        .
       ril-rec-tst-540.
      *                  *---------------------------------------------*
      *                  * Composizione record testatina               *
      ...
      *                  *---------------------------------------------*
           ...
           move      "<"                  to   p-edm                  .
           move      w-let-arc-age-cod    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<"                  to   p-edm                  .
           move      w-let-arc-zst-cod    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       let-arc-zst-420.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-let-arc-zst-tip    =    01
                     go to let-arc-zst-421
           else if   w-let-arc-zst-tip    =    02
                     go to let-arc-zst-422
           else if   w-let-arc-zst-tip    =    03
                     go to let-arc-zst-423.
       let-arc-zst-421.
           string    "ZONA "    delimited by   size
                     p-edt      delimited by   spaces
                                          into w-let-arc-zst-des      .
           go to     let-arc-zst-430.
       let-arc-zst-422.
           string    "CATEGORIA "
                                delimited by   size
                     p-edt      delimited by   spaces
