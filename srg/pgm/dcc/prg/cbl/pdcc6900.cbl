      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Caricamento clienti marketing da file SEAT  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " IMPORTAZIONE CLIENTI MARKETING - SEAT  "       .
      ...
      *        * - 01 : Con separatori                                 *
      *        * - 02 : Senza separatori                               *
      *        * - 03 : Con separatori senza utenza                    *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rgs.
      *        *-------------------------------------------------------*
      *        * Record del cliente marketing - versione 1             *
      *        *                                                       *
      *        * Tracciato SEAT : Con numero utenza - L455             *
      *        *                  Con separatori                       *
      *        *-------------------------------------------------------*
           05  w-dcm-001.
      *            *---------------------------------------------------*
      *            * Codice Regione ISTAT                  Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-001-cod-reg      pic  x(02)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice Provincia ISTAT                Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-001-cod-prv      pic  x(03)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice Comune ISTAT                   Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-001-cod-cmn      pic  x(03)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice Strada                         Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-001-cod-str      pic  x(05)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Sigla provincia                                   *
      *            *---------------------------------------------------*
               10  w-dcm-001-sgl-prv      pic  x(03)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Descrizione localita'                             *
      *            *---------------------------------------------------*
               10  w-dcm-001-loc-cli      pic  x(35)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Indirizzo                                         *
      *            *---------------------------------------------------*
               10  w-dcm-001-via-cli      pic  x(50)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Nr. civico                                        *
      *            *---------------------------------------------------*
               10  w-dcm-001-num-civ      pic  x(15)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * CAP                                               *
      *            *---------------------------------------------------*
               10  w-dcm-001-cap-cli      pic  x(10)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Ragione sociale                                   *
      *            *---------------------------------------------------*
               10  w-dcm-001-rag-soc.
                   15  w-dcm-001-rs1-cli  pic  x(40)                  .
                   15  w-dcm-001-rs2-cli  pic  x(40)                  .
                   15  w-dcm-001-rag-fil  pic  x(20)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Forma giuridica                                   *
      *            *---------------------------------------------------*
               10  w-dcm-001-frm-grd      pic  x(10)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice statistico                                 *
      *            *---------------------------------------------------*
               10  w-dcm-001-cod-stt      pic  x(07)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Prefisso telefonico                               *
      *            *---------------------------------------------------*
               10  w-dcm-001-pre-tel      pic  x(04)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Numero telefonico                                 *
      *            *---------------------------------------------------*
               10  w-dcm-001-num-tel      pic  x(09)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Filler in corrispondenza di codici non gestiti    *
      *            *---------------------------------------------------*
               10  w-dcm-001-fil-001      pic  x(03)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Categoria SEAT                                    *
      *            *---------------------------------------------------*
               10  w-dcm-001-cat-sea      pic  x(04)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Filler in corrispondenza di codici non gestiti    *
      *            *---------------------------------------------------*
               10  w-dcm-001-fil-002      pic  x(154)                 .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice SEAT                                       *
      *            *---------------------------------------------------*
               10  w-dcm-001-cod-sea      pic  x(09)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Filler in corrispondenza di codici non gestiti    *
      *            *---------------------------------------------------*
               10  w-dcm-001-fil-003      pic  x(10)                  .
               10  filler                 pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Record del cliente marketing - versione 2             *
      *        *                                                       *
      *        * Tracciato SEAT : Con numero utenza - L430             *
      *        *                  Senza separatori                     *
      *        *-------------------------------------------------------*
           05  w-dcm-002.
      *            *---------------------------------------------------*
      *            * Codice Regione ISTAT                  Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-002-cod-reg      pic  x(02)                  .
      *            *---------------------------------------------------*
      *            * Codice Provincia ISTAT                Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-002-cod-prv      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Codice Comune ISTAT                   Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-002-cod-cmn      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Codice Strada                         Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-002-cod-str      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Sigla provincia                                   *
      *            *---------------------------------------------------*
               10  w-dcm-002-sgl-prv      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Descrizione localita'                             *
      *            *---------------------------------------------------*
               10  w-dcm-002-loc-cli      pic  x(35)                  .
      *            *---------------------------------------------------*
      *            * Indirizzo                                         *
      *            *---------------------------------------------------*
               10  w-dcm-002-via-cli      pic  x(50)                  .
      *            *---------------------------------------------------*
      *            * Nr. civico                                        *
      *            *---------------------------------------------------*
               10  w-dcm-002-num-civ      pic  x(15)                  .
      *            *---------------------------------------------------*
      *            * CAP                                               *
      *            *---------------------------------------------------*
               10  w-dcm-002-cap-cli      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Ragione sociale                                   *
      *            *---------------------------------------------------*
               10  w-dcm-002-rag-soc.
                   15  w-dcm-002-rs1-cli  pic  x(40)                  .
                   15  w-dcm-002-rs2-cli  pic  x(40)                  .
                   15  w-dcm-002-rag-fil  pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Forma giuridica                                   *
      *            *---------------------------------------------------*
               10  w-dcm-002-frm-grd      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Codice statistico                                 *
      *            *---------------------------------------------------*
               10  w-dcm-002-cod-stt      pic  x(07)                  .
      *            *---------------------------------------------------*
      *            * Prefisso telefonico                               *
      *            *---------------------------------------------------*
               10  w-dcm-002-pre-tel      pic  x(04)                  .
      *            *---------------------------------------------------*
      *            * Numero telefonico                                 *
      *            *---------------------------------------------------*
               10  w-dcm-002-num-tel      pic  x(09)                  .
      *            *---------------------------------------------------*
      *            * Filler in corrispondenza di codici non gestiti    *
      *            *---------------------------------------------------*
               10  w-dcm-002-fil-001      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Categoria SEAT                                    *
      *            *---------------------------------------------------*
               10  w-dcm-002-cat-sea      pic  x(04)                  .
      *            *---------------------------------------------------*
      *            * Filler in corrispondenza di codici non gestiti    *
      *            *---------------------------------------------------*
               10  w-dcm-002-fil-002      pic  x(148)                 .
      *            *---------------------------------------------------*
      *            * Codice SEAT                                       *
      *            *---------------------------------------------------*
               10  w-dcm-002-cod-sea      pic  x(09)                  .
      *            *---------------------------------------------------*
      *            * Filler in corrispondenza di codici non gestiti    *
      *            *---------------------------------------------------*
               10  w-dcm-002-fil-003      pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Record del cliente marketing - versione 3             *
      *        *                                                       *
      *        * Tracciato SEAT : Senza numero utenza - L280           *
      *        *                  Con separatori                       *
      *        *-------------------------------------------------------*
           05  w-dcm-003.
      *            *---------------------------------------------------*
      *            * Codice Regione ISTAT                  Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-003-cod-reg      pic  x(02)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice Provincia ISTAT                Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-003-cod-prv      pic  x(03)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice Comune ISTAT                   Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-003-cod-cmn      pic  x(03)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice Strada                         Non gestito *
      *            *---------------------------------------------------*
               10  w-dcm-003-cod-str      pic  x(05)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Sigla provincia                                   *
      *            *---------------------------------------------------*
               10  w-dcm-003-sgl-prv      pic  x(03)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Descrizione localita'                             *
      *            *---------------------------------------------------*
               10  w-dcm-003-loc-cli      pic  x(35)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Indirizzo                                         *
      *            *---------------------------------------------------*
               10  w-dcm-003-via-cli      pic  x(50)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Nr. civico                                        *
      *            *---------------------------------------------------*
               10  w-dcm-003-num-civ      pic  x(15)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * CAP                                               *
      *            *---------------------------------------------------*
               10  w-dcm-003-cap-cli      pic  x(10)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Ragione sociale                                   *
      *            *---------------------------------------------------*
               10  w-dcm-003-rag-soc.
                   15  w-dcm-003-rs1-cli  pic  x(40)                  .
                   15  w-dcm-003-rs2-cli  pic  x(40)                  .
                   15  w-dcm-003-rag-fil  pic  x(20)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Forma giuridica                                   *
      *            *---------------------------------------------------*
               10  w-dcm-003-frm-grd      pic  x(10)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice statistico                                 *
      *            *---------------------------------------------------*
               10  w-dcm-003-cod-stt      pic  x(07)                  .
               10  filler                 pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Filler in corrispondenza di codici non gestiti    *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Comodo per controllo se cliente gia' codificato       *
      *        *-------------------------------------------------------*
           05  w-gen-cod-sea              pic  9(09)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-rec.
               ...
               10  w-exp-tip-rec-lun      pic  9(02)       value 30   .
               10  w-exp-tip-rec-tbl.
                   15  filler             pic  x(30) value
                            "Con separatori   [SEAT - 455] "          .
                   15  filler             pic  x(30) value
                            "Senza separatori [SEAT - 430] "          .
                   15  filler             pic  x(30) value
                            "senza Utenze     [SEAT - 280] "          .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Work per determinazione se cliente codificato         *
      *        *-------------------------------------------------------*
           05  w-det-dcm-cod.
               10  w-det-dcm-cod-ctr      pic  9(05)                  .
      ...
      *
           string    "Caricate regolarmente "
                                delimited by   size
                     p-edt      delimited by   spaces
                     " anagrafiche marketing "
                                delimited by   size
                     w-wrt-msg-err-alf
                                delimited by   spaces
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Estrazione dei campi utilizzati             *
      *                  *---------------------------------------------*
           if        rr-tip-rec           =    01
                     move  spaces         to   w-dcm-001
                     move  g-rec          to   w-dcm-001
           else if   rr-tip-rec           =    02
                     move  spaces         to   w-dcm-002
                     move  g-rec          to   w-dcm-002
           else if   rr-tip-rec           =    03
                     move  spaces         to   w-dcm-003
                     move  g-rec          to   w-dcm-003
           else      move  spaces         to   w-dcm-001
                     move  g-rec          to   w-dcm-001              .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *
           if        rr-tip-rec           =    01
                     move  w-dcm-001-cod-sea
                                          to   v-alf
           else if   rr-tip-rec           =    02
                     move  w-dcm-002-cod-sea
                                          to   v-alf
           else if   rr-tip-rec           =    03
                     move  w-dcm-003-cod-sea
                                          to   v-alf
           else      move  w-dcm-001-cod-sea
                                          to   v-alf                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-gen-cod-sea          .
      *                  *---------------------------------------------*
      *                  * Determinazione                              *
      *                  *---------------------------------------------*
           perform   det-dcm-cod-000      thru det-dcm-cod-999        .
      *                  *---------------------------------------------*
      ...
      *
           if        w-det-dcm-cod-ctr    =    zero
                     move  "Nuovo :"      to   w-all-str-cat (1)
           else      move  "Gia' inserito :"
                                          to   w-all-str-cat (1)      .
      *
           if        rr-tip-rec           =    01
                     move  w-dcm-001-rag-soc
                                          to   w-all-str-cat (2)
           else if   rr-tip-rec           =    02
                     move  w-dcm-002-rag-soc
                                          to   w-all-str-cat (2)
           else if   rr-tip-rec           =    03
                     move  w-dcm-003-rag-soc
                                          to   w-all-str-cat (2)
           else      move  w-dcm-001-rag-soc
                                          to   w-all-str-cat (2)      .
      *
           move      "-"                  to   w-all-str-cat (3)      .
      *
           if        rr-tip-rec           =    01
                     move  w-dcm-001-loc-cli
                                          to   w-all-str-cat (4)
           else if   rr-tip-rec           =    02
                     move  w-dcm-002-loc-cli
                                          to   w-all-str-cat (4)
           else if   rr-tip-rec           =    03
                     move  w-dcm-003-loc-cli
                                          to   w-all-str-cat (4)
           else      move  w-dcm-001-loc-cli
                                          to   w-all-str-cat (4)      .
      *
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Scrittura anagrafica [dcm]                      *
      *              *-------------------------------------------------*
           perform   wrt-rec-dcm-000      thru wrt-rec-dcm-999        .
      *              *-------------------------------------------------*
      *              * Scrittura contatti [adc]                        *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "SIMULAZIONE GENERAZIONE ANAGRAFICHE"
      ...
      *              *-------------------------------------------------*
           if        rr-tip-rec           =    01
                     perform cmp-rec-dcm-001-000
                                          thru cmp-rec-dcm-001-999
           else if   rr-tip-rec           =    02
                     perform cmp-rec-dcm-002-000
                                          thru cmp-rec-dcm-002-999
           else if   rr-tip-rec           =    03
                     perform cmp-rec-dcm-003-000
                                          thru cmp-rec-dcm-003-999
           else      perform cmp-rec-dcm-001-000
                                          thru cmp-rec-dcm-001-999    .
       cmp-rec-dcm-999.
           exit.
      ...
      *    * Composizione record [dcm]                                 *
      *    *                                                           *
      *    * Seat L455 : Con utenza, con separatori                    *
      *    *-----------------------------------------------------------*
       cmp-rec-dcm-001-000.
      *              *-------------------------------------------------*
      *              * Test preliminare se cliente gia' codificato     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice SEAT                                 *
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      09                   to   v-car                  .
           move      w-dcm-001-cod-sea    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-gen-cod-sea          .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-dcm-001-rag-soc    to   w-all-str-cat (2)      .
           move      "- Gia' codificato"  to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      w-all-str-alf        to   w-wrt-msg-err-msg      .
           perform   wrt-msg-err-000      thru wrt-msg-err-999        .
      ...
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     cmp-rec-dcm-001-999.
       cmp-rec-dcm-001-040.
      *              *-------------------------------------------------*
      *              * Assegnazione nuovo codice                       *
      *              *-------------------------------------------------*
           move      9999999              to   w-enc-dcm-val-max      .
      ...
      *                          *-------------------------------------*
           move      w-dcm-001-rag-soc    to   rf-dcm-rs1-cli         .
           move      w-dcm-001-rag-soc
                    (41 : 40)             to   rf-dcm-rs2-cli         .
      *                          *-------------------------------------*
      *                          * Per ordinamento                     *
      *                          *-------------------------------------*
           move      w-dcm-001-rag-soc    to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   rf-dcm-rag-key         .
      *                      *-----------------------------------------*
      *                      * Indirizzo                               *
      *                      *-----------------------------------------*
           move      60                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      w-dcm-001-via-cli    to   w-all-str-cat (1)      .
      *
           if        w-dcm-001-num-civ    =    spaces or
                     w-dcm-001-via-cli    =    spaces
                     move  spaces         to   w-all-str-cat (2)
           else      move  ","            to   w-all-str-cat (2)      .
      *
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   w-all-str-cat (1)      .
           move      w-dcm-001-num-civ    to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   rf-dcm-via-cli         .
      *                      *-----------------------------------------*
      *                      * Localita'                               *
      *                      *-----------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      w-dcm-001-cap-cli    to   w-all-str-cat (1)      .
           move      w-dcm-001-loc-cli    to   w-all-str-cat (2)      .
           move      w-dcm-001-sgl-prv    to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   rf-dcm-loc-cli         .
      *                      *-----------------------------------------*
      *                      * Nazione                                 *
      *                      *-----------------------------------------*
           move      "IT "                to   rf-dcm-cod-naz         .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Preparazione parametri di ricerca   *
      *                          *-------------------------------------*
           move      w-dcm-001-loc-cli    to   w-det-cap-cfl-cfl      .
           move      w-dcm-001-cap-cli    to   w-det-cap-cfl-cap      .
           move      w-dcm-001-sgl-prv    to   w-det-cap-cfl-prv      .
      *                          *-------------------------------------*
      *                          * Determinazione                      *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-det-cap-cfl-flg    not  = spaces
                     go to cmp-rec-dcm-001-250.
       cmp-rec-dcm-001-200.
      *                          *-------------------------------------*
      *                          * Se trovato                          *
      *                          *-------------------------------------*
           move      w-det-cap-cfl-cmn    to   rf-dcm-cod-cmn         .
           move      w-det-cap-cfl-fzn    to   rf-dcm-cod-fzn         .
           move      w-det-cap-cfl-lct    to   rf-dcm-cod-lct         .
      *                              *---------------------------------*
      *                              * Oltre                           *
      *                              *---------------------------------*
           go to     cmp-rec-dcm-001-300.
       cmp-rec-dcm-001-250.
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      02                   to   w-all-str-num          .
           move      w-dcm-001-pre-tel    to   w-all-str-cat (1)      .
           move      w-dcm-001-num-tel    to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   rf-dcm-num-tel         .
      *                      *-----------------------------------------*
      *                      * Campi normalizzati                      *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Codice statistico SEAT                  *
      *                      *-----------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      07                   to   v-car                  .
           move      w-dcm-001-cod-stt    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   rf-dcm-cod-stt         .
      *                      *-----------------------------------------*
      *                      * Campi normalizzati                      *
      *                      *-----------------------------------------*
      ...
      *                      * Codice SEAT                             *
      *                      *-----------------------------------------*
           move      w-gen-cod-sea        to   rf-dcm-cod-afs         .
      *                      *-----------------------------------------*
      *                      * Categoria SEAT                          *
      *                      *-----------------------------------------*
           move      w-dcm-001-cat-sea    to   rf-dcm-cat-sea         .
      *                      *-----------------------------------------*
      *                      * Area libera                             *
      *                      *-----------------------------------------*
      ...
      *    * Composizione record [dcm]                                 *
      *    *                                                           *
      *    * Seat L430 : Con utenza, senza separatori                  *
      *    *-----------------------------------------------------------*
       cmp-rec-dcm-002-000.
      *              *-------------------------------------------------*
      *              * Test preliminare se cliente gia' codificato     *
      ...
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      09                   to   v-car                  .
           move      w-dcm-002-cod-sea    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-gen-cod-sea          .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      03                   to   w-all-str-num          .
           move      "Cliente :"          to   w-all-str-cat (1)      .
           move      w-dcm-002-rag-soc    to   w-all-str-cat (2)      .
           move      "- Gia' codificato"  to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      w-all-str-alf        to   w-wrt-msg-err-msg      .
      ...
      *                          * Ragione sociale estesa              *
      *                          *-------------------------------------*
           move      w-dcm-002-rag-soc    to   rf-dcm-rs1-cli         .
           move      w-dcm-002-rag-soc
                    (41 : 40)             to   rf-dcm-rs2-cli         .
      *                          *-------------------------------------*
      *                          * Per ordinamento                     *
      *                          *-------------------------------------*
           move      w-dcm-002-rag-soc    to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   rf-dcm-rag-key         .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      60                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      w-dcm-002-via-cli    to   w-all-str-cat (1)      .
      *
           if        w-dcm-002-num-civ    =    spaces or
                     w-dcm-002-via-cli    =    spaces
                     move  spaces         to   w-all-str-cat (2)
           else      move  ","            to   w-all-str-cat (2)      .
      *
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   w-all-str-cat (1)      .
           move      w-dcm-002-num-civ    to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   rf-dcm-via-cli         .
      *                      *-----------------------------------------*
      *                      * Localita'                               *
      *                      *-----------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      w-dcm-002-cap-cli    to   w-all-str-cat (1)      .
           move      w-dcm-002-loc-cli    to   w-all-str-cat (2)      .
           move      w-dcm-002-sgl-prv    to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   rf-dcm-loc-cli         .
      *                      *-----------------------------------------*
      *                      * Nazione                                 *
      ...
      *                          * Preparazione parametri di ricerca   *
      *                          *-------------------------------------*
           move      w-dcm-002-loc-cli    to   w-det-cap-cfl-cfl      .
           move      w-dcm-002-cap-cli    to   w-det-cap-cfl-cap      .
           move      w-dcm-002-sgl-prv    to   w-det-cap-cfl-prv      .
      *                          *-------------------------------------*
      *                          * Determinazione                      *
      *                          *-------------------------------------*
           perform   det-cap-cfl-000      thru det-cap-cfl-999        .
      ...
      *                      *-----------------------------------------*
           move      20                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      w-dcm-002-pre-tel    to   w-all-str-cat (1)      .
           move      w-dcm-002-num-tel    to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   rf-dcm-num-tel         .
      *                      *-----------------------------------------*
      *                      * Campi normalizzati                      *
      ...
      *                      *-----------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      07                   to   v-car                  .
           move      w-dcm-002-cod-stt    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   rf-dcm-cod-stt         .
      *                      *-----------------------------------------*
      ...
      *                      * Categoria SEAT                          *
      *                      *-----------------------------------------*
           move      w-dcm-002-cat-sea    to   rf-dcm-cat-sea         .
      *                      *-----------------------------------------*
      *                      * Area libera                             *
      *                      *-----------------------------------------*
           move      spaces               to   rf-dcm-alx-exp         .
      ...
      *    * Composizione record [dcm]                                 *
      *    *                                                           *
      *    * Seat L280 : Senza utenza, con separatori                  *
      *    *-----------------------------------------------------------*
       cmp-rec-dcm-003-000.
      *              *-------------------------------------------------*
      *              * Test preliminare se cliente gia' codificato     *
      ...
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      09                   to   v-car                  .
           move      w-dcm-003-cod-sea    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-gen-cod-sea          .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      03                   to   w-all-str-num          .
           move      "Cliente :"          to   w-all-str-cat (1)      .
           move      w-dcm-003-rag-soc    to   w-all-str-cat (2)      .
           move      "- Gia' codificato"  to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      w-all-str-alf        to   w-wrt-msg-err-msg      .
      ...
      *                          * Ragione sociale estesa              *
      *                          *-------------------------------------*
           move      w-dcm-003-rag-soc    to   rf-dcm-rs1-cli         .
           move      w-dcm-003-rag-soc
                    (41 : 40)             to   rf-dcm-rs2-cli         .
      *                          *-------------------------------------*
      *                          * Per ordinamento                     *
      *                          *-------------------------------------*
           move      w-dcm-003-rag-soc    to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   rf-dcm-rag-key         .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      60                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      w-dcm-003-via-cli    to   w-all-str-cat (1)      .
      *
           if        w-dcm-003-num-civ    =    spaces or
                     w-dcm-003-via-cli    =    spaces
                     move  spaces         to   w-all-str-cat (2)
           else      move  ","            to   w-all-str-cat (2)      .
      *
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   w-all-str-cat (1)      .
           move      w-dcm-003-num-civ    to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   rf-dcm-via-cli         .
      *                      *-----------------------------------------*
      *                      * Localita'                               *
      *                      *-----------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      w-dcm-003-cap-cli    to   w-all-str-cat (1)      .
           move      w-dcm-003-loc-cli    to   w-all-str-cat (2)      .
           move      w-dcm-003-sgl-prv    to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   rf-dcm-loc-cli         .
      *                      *-----------------------------------------*
      *                      * Nazione                                 *
      ...
      *                          * Preparazione parametri di ricerca   *
      *                          *-------------------------------------*
           move      w-dcm-003-loc-cli    to   w-det-cap-cfl-cfl      .
           move      w-dcm-003-cap-cli    to   w-det-cap-cfl-cap      .
           move      w-dcm-003-sgl-prv    to   w-det-cap-cfl-prv      .
      *                          *-------------------------------------*
      *                          * Determinazione                      *
      *                          *-------------------------------------*
           perform   det-cap-cfl-000      thru det-cap-cfl-999        .
      ...
      *                      *-----------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      07                   to   v-car                  .
           move      w-dcm-003-cod-stt    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   rf-dcm-cod-stt         .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      03                   to   rf-adc-tip-arc         .
           move      w-enc-dcm-val-pos    to   rf-adc-cod-arc         .
      ...
      *
           ...
           move      w-dcm-001-num-tel    to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   rf-adc-num-con         .
      ...
      *    *===========================================================*
      *    * Determinazione se cliente gia' codificato                 *
      *    *-----------------------------------------------------------*
       det-dcm-cod-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore elementi letti        *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-dcm-cod-ctr      .
       det-dcm-cod-100.
      *              *-------------------------------------------------*
      *              * Start su file [dcm]                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       det-dcm-cod-300.
      *              *-------------------------------------------------*
      *              * Max su [dcm], se non superato : ad uscita       *
      *              *-------------------------------------------------*
           if        rf-dcm-cod-afs       not  = w-gen-cod-sea
                     go to det-dcm-cod-900.
       det-dcm-cod-400.
      *              *-------------------------------------------------*
      *              * Incremento contatore elementi letti             *
      *              *-------------------------------------------------*
           add       1                    to   w-det-dcm-cod-ctr      .
       det-dcm-cod-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     det-dcm-cod-999.
       det-dcm-cod-999.
           exit.
