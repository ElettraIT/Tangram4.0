      ...
      *                       Ultima revisione:    NdK del 01/07/20    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
      *        * Work per Det su tipi pagamento coinvolti nella forma  *
      *        * di pagamento                                          *
      *        *-------------------------------------------------------*
           05  w-det-tip-pag.
               10  w-det-tip-pag-tip      pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Si/no scadenze manuali                     *
      *        *-------------------------------------------------------*
           05  w-exp-snx-ims.
               10  w-exp-snx-ims-num      pic  9(02)       value 02   .
               10  w-exp-snx-ims-lun      pic  9(02)       value 02   .
               10  w-exp-snx-ims-tbl.
      ...
      *        *-------------------------------------------------------*
           05  w-enc-zfp-val-max          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Valore pre incremento                                 *
      *        *-------------------------------------------------------*
           05  w-enc-zfp-val-pre          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Valore post incremento                                *
      *        *-------------------------------------------------------*
           05  w-enc-zfp-val-pos          pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/dcc[rec-zfp]"   to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-prs-rec-zfp
           else      move  spaces         to   w-prs-rec-zfp          .
           if        w-prs-rec-zfp-mco    not  numeric
                     move  zero           to   w-prs-rec-zfp-mco      .
           if        w-prs-rec-zfp-mco    =    zero
                     move  9999999        to   w-prs-rec-zfp-mco      .
           if        w-prs-rec-zfp-fco    not  = "A"
                     move  "M"            to   w-prs-rec-zfp-fco      .
           if        w-prs-rec-zfp-omn    not  = "O"
                     move  "N"            to   w-prs-rec-zfp-omn      .
           if        w-prs-rec-zfp-umn    not  = "U"
                     move  "N"            to   w-prs-rec-zfp-umn      .
           if        w-prs-rec-zfp-mmn    not  = "N"
                     move  "M"            to   w-prs-rec-zfp-mmn      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   w-cod-mne-zfp-lin      .
           move      30                   to   w-cod-mne-zfp-pos      .
           move      06                   to   w-cod-mne-zfp-dln      .
           move      30                   to   w-cod-mne-zfp-dps      .
           move      "<B"                 to   v-edm                  .
      ...
      *                          * gressivo                            *
      *                          *-------------------------------------*
           move      w-prs-rec-zfp-mco    to   w-enc-zfp-val-max      .
           perform   att-cod-aut-000      thru att-cod-aut-999        .
      *                          *-------------------------------------*
      *                          * Codice automatico in campo di de-   *
      *                          * stinazione                          *
      *                          *-------------------------------------*
           move      w-enc-zfp-val-pos    to   w-tes-cod-fop          .
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-prs-rec-zfp-mco    =    zero or
                     w-prs-rec-zfp-mco    =    9999999
                     go to acc-cod-fop-600.
      *                      *-----------------------------------------*
      ...
      *                      * trollo e' superato                      *
      *                      *-----------------------------------------*
           if        w-tes-cod-fop        not  > w-prs-rec-zfp-mco
                     go to acc-cod-fop-600.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
      ...
      -              "iore a "            to   v-alf                  .
           ...
           move      63                   to   v-pos                  .
           move      "<"                  to   v-edm                  .
           move      w-prs-rec-zfp-mco    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
       ...
       acc-tes-reg-130.
      *                  *---------------------------------------------*
      *                  * Si/no scadenze manuali                      *
      *                  *---------------------------------------------*
           perform   acc-snx-ims-000      thru acc-snx-ims-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  * Si/no contrassegno                          *
      *                  *---------------------------------------------*
           perform   acc-snx-cts-000      thru acc-snx-cts-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Si/no scadenze manuali                          *
      *              *-------------------------------------------------*
           perform   vis-snx-ims-000      thru vis-snx-ims-999        .
      *              *-------------------------------------------------*
      *              * Si/no contrassegno                              *
      *              *-------------------------------------------------*
           perform   vis-snx-cts-000      thru vis-snx-cts-999        .
      *              *-------------------------------------------------*
      *              * 1. codice di pagamento                          *
      *              *-------------------------------------------------*
           move      01                   to   w-tes-inx-pag          .
      ...
      *              * Si/no scadenze manuali                          *
      *              *-------------------------------------------------*
           perform   pmt-snx-ims-000      thru pmt-snx-ims-999        .
      *              *-------------------------------------------------*
      *              * Si/no contrassegno                              *
      *              *-------------------------------------------------*
           perform   pmt-snx-cts-000      thru pmt-snx-cts-999        .
      *              *-------------------------------------------------*
      *              * 1. codice di pagamento                          *
      *              *-------------------------------------------------*
           move      01                   to   w-tes-inx-pag          .
      ...
      *    *-----------------------------------------------------------*
       pmt-sco-fat-000.
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Sconto legato al pagamento :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-sco-fat-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no scadenze manuali           *
      *    *-----------------------------------------------------------*
       pmt-snx-ims-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no contrassegno               *
      *    *-----------------------------------------------------------*
       pmt-snx-cts-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no scadenze manuali               *
      *    *-----------------------------------------------------------*
       acc-snx-ims-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-ims-lun    to   v-car                  .
           move      w-exp-snx-ims-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      09                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-ims-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
      *
           if        w-tes-snx-ims (1)    =    " "
                     move  01             to   v-num
           else if   w-tes-snx-ims (1)    =    "N"
                     move  01             to   v-num
           else if   w-tes-snx-ims (1)    =    "S"
                     move  02             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   w-tes-snx-ims (1)
           else if   v-num                =    02
                     move  "S"            to   w-tes-snx-ims (1)
           else      move  spaces         to   w-tes-snx-ims (1)      .
       acc-snx-ims-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-snx-ims-100.
       acc-snx-ims-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Si/no scadenze manuali            *
      *    *-----------------------------------------------------------*
       vis-snx-ims-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no contrassegno                   *
      *    *-----------------------------------------------------------*
       acc-snx-cts-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *
           if        w-tes-snx-cts (1)    =    " "
                     move  01             to   v-num
           else if   w-tes-snx-cts (1)    =    "N"
                     move  01             to   v-num
           else if   w-tes-snx-cts (1)    =    "S"
                     move  02             to   v-num
           else      move  zero           to   v-num                  .
      *
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   w-tes-snx-cts (1)
           else if   v-num                =    02
                     move  "S"            to   w-tes-snx-cts (1)
           else      move  spaces         to   w-tes-snx-cts (1)      .
       acc-snx-cts-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-snx-cts-100.
       acc-snx-cts-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Si/no contrassegno                *
      *    *-----------------------------------------------------------*
       vis-snx-cts-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-pag-tip
                    (1, w-tes-inx-pag)    to   w-sav-cod-pag-tip      .
      ...
      *                  *---------------------------------------------*
           move      w-let-arc-zpg-des    to   w-tes-cod-pag-des
                                              (1, w-tes-inx-pag)      .
           move      w-let-arc-zpg-tip    to   w-tes-cod-pag-tip
                                              (1, w-tes-inx-pag)      .
      ...
      *                      *-----------------------------------------*
           move      spaces               to   w-tes-cod-pag-des
                                              (1, w-tes-inx-pag)      .
           move      zero                 to   w-tes-cod-pag-tip
                                              (1, w-tes-inx-pag)      .
      ...
      *              *-------------------------------------------------*
           if        w-tes-inx-pag        =    03
                     move   19            to   w-tes-lin-pag
           else if   w-tes-inx-pag        =    02
                     move   15            to   w-tes-lin-pag
           else      move   11            to   w-tes-lin-pag          .
       det-lin-pag-999.
           exit.
      ...
      *                  *---------------------------------------------*
      ...
      -              "anuale"             to   w-err-box-err-msg      .
       ...
       cnt-tdo-nok-560.
      *              *-------------------------------------------------*
      *              * Controllo, in caso di piu' codici di pagamento  *
      *              * coinvolti, che essi siano compatibili, ovvero   *
      *              * che siano tutti dello stesso tipo pagamento, o  *
      *              * almeno che ci sia sempre lo stesso tipo di pa-  *
      *              * gamento con in piu' rimesse dirette             *
      *              *                                                 *
      *              * Non se scadenze manuali                         *
      *              *                                                 *
      *              * CONTROLLO NON BLOCCANTE                         *
      *              *-------------------------------------------------*
           if        w-tes-snx-ims (1)    =    "S"
                     go to cnt-tdo-nok-575.
       cnt-tdo-nok-561.
           move      zero                 to   w-det-tip-pag-tip      .
       cnt-tdo-nok-562.
           if        w-tes-cod-pag (1, 1) =    zero
                     go to cnt-tdo-nok-563.
           if        w-tes-cod-pag-tip
                    (1, 1)                =    01
                     go to cnt-tdo-nok-563.
           if        w-det-tip-pag-tip    =    zero
                     move  w-tes-cod-pag-tip
                          (1, 1)          to   w-det-tip-pag-tip
                     go to cnt-tdo-nok-563.
           if        w-tes-cod-pag-tip
                    (1, 1)                =    w-det-tip-pag-tip
                     go to cnt-tdo-nok-563
           else      go to cnt-tdo-nok-566.
       cnt-tdo-nok-563.
           if        w-tes-cod-pag (1, 2) =    zero
                     go to cnt-tdo-nok-564.
           if        w-tes-cod-pag-tip
                    (1, 2)                =    01
                     go to cnt-tdo-nok-564.
           if        w-det-tip-pag-tip    =    zero
                     move  w-tes-cod-pag-tip
                          (1, 2)          to   w-det-tip-pag-tip
                     go to cnt-tdo-nok-564.
           if        w-tes-cod-pag-tip
                    (1, 2)                =    w-det-tip-pag-tip
                     go to cnt-tdo-nok-564
           else      go to cnt-tdo-nok-566.
       cnt-tdo-nok-564.
           if        w-tes-cod-pag (1, 3) =    zero
                     go to cnt-tdo-nok-565.
           if        w-tes-cod-pag-tip
                    (1, 3)                =    01
                     go to cnt-tdo-nok-565.
           if        w-det-tip-pag-tip    =    zero
                     move  w-tes-cod-pag-tip
                          (1, 3)          to   w-det-tip-pag-tip
                     go to cnt-tdo-nok-565.
           if        w-tes-cod-pag-tip
                    (1, 3)                =    w-det-tip-pag-tip
                     go to cnt-tdo-nok-565
           else      go to cnt-tdo-nok-566.
       cnt-tdo-nok-565.
           go to     cnt-tdo-nok-575.
       cnt-tdo-nok-566.
           move      "Codici pagamento incompatibili per il tipo di paga
      -              "mento "             to   w-err-box-err-msg      .
______*    go to     cnt-tdo-nok-900.
       cnt-tdo-nok-575.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-nok-579.
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-tes-cod-mne (1)    to   rf-zfp-cod-mne         .
       ...
       cnt-tdo-nok-581.
           ...
           if        f-sts                not  = e-not-err
                     go to cnt-tdo-nok-583.
           if        rf-zfp-cod-mne       not  = w-tes-cod-mne (1)
                     go to cnt-tdo-nok-583.
           if        rf-zfp-cod-fop       =    w-tes-cod-fop
      ...
      *              *-------------------------------------------------*
      ...
      -              "      "             to   w-err-box-err-msg      .
       ...
       cnt-tdo-nok-590.
      *              *-------------------------------------------------*
      *              * Controllo su indicatore di scadenze manuali     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-tes-snx-ims (1)    not  = "S"
                     go to cnt-tdo-nok-595.
      *                  *---------------------------------------------*
      *                  * Controllo che esista solo un codice di pa-  *
      *                  * gamento e che sia di tipo 'rimessa diretta' *
      *                  *---------------------------------------------*
           if        w-tes-cod-pag
                    (1, 2)                =   zero and
                     w-tes-cod-pag
                    (1, 3)                =   zero
                     go to cnt-tdo-nok-595.
           move      "Codici di pagamento non accettabili per scadenze m
      -              "anuali!"            to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-595.
      *              *-------------------------------------------------*
      *              * Controllo su indicatore di contrassegno         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-tes-snx-cts (1)    not  = "S"
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-pag-tip
                    ...
                    (1, 3)                =   zero
                     go to cnt-tdo-nok-600.
           move      "Codici di pagamento non accettabili per il contras
      -              "segno!"             to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-600.
      *              *-------------------------------------------------*
      *              * Normalizzazioni                                 *
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           ...
           move      zero                 to   w-tes-per-toi (1, 3)   .
           move      zero                 to   w-tes-dim-act (1, 3)   .
           move      spaces               to   w-tes-snx-ims (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-fop        to   rf-zfp-cod-fop         .
           move      "pgm/dcc/fls/ioc/obj/iofzfp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-zfp-ide-dat       to   w-tes-ide-dat (1)      .
           move      rf-zfp-ide-ute       to   w-tes-ide-ute (1)      .
           move      rf-zfp-ide-fas       to   w-tes-ide-fas (1)      .
           move      rf-zfp-cod-mne       to   w-tes-cod-mne (1)      .
           move      rf-zfp-des-key       to   w-tes-des-key (1)      .
           move      rf-zfp-des-fop       to   w-tes-des-fop (1)      .
           move      rf-zfp-sco-fat       to   w-tes-sco-fat (1)      .
           move      rf-zfp-cod-pag (1)   to   w-tes-cod-pag (1, 1)   .
           move      rf-zfp-tip-amm (1)   to   w-tes-tip-amm (1, 1)   .
           move      rf-zfp-per-toi (1)   to   w-tes-per-toi (1, 1)   .
           move      rf-zfp-dim-act (1)   to   w-tes-dim-act (1, 1)   .
           move      rf-zfp-cod-pag (2)   to   w-tes-cod-pag (1, 2)   .
           move      rf-zfp-tip-amm (2)   to   w-tes-tip-amm (1, 2)   .
           move      rf-zfp-per-toi (2)   to   w-tes-per-toi (1, 2)   .
           move      rf-zfp-dim-act (2)   to   w-tes-dim-act (1, 2)   .
           move      rf-zfp-cod-pag (3)   to   w-tes-cod-pag (1, 3)   .
           move      rf-zfp-tip-amm (3)   to   w-tes-tip-amm (1, 3)   .
           move      rf-zfp-per-toi (3)   to   w-tes-per-toi (1, 3)   .
           move      rf-zfp-dim-act (3)   to   w-tes-dim-act (1, 3)   .
           move      rf-zfp-snx-ims       to   w-tes-snx-ims (1)      .
           move      rf-zfp-snx-cts       to   w-tes-snx-cts (1)      .
           move      rf-zfp-alx-exp       to   w-tes-alx-exp (1)      .
       rou-let-reg-200.
      *                          *-------------------------------------*
      ...
      *                      * Write record [zfp]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zfp-000      thru wrt-rec-zfp-999        .
      ...
      *                      * Rewrite record [zfp]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zfp-000      thru rew-rec-zfp-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zfp]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zfp-000      thru del-rec-zfp-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zfp]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zfp-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-zfp-ide-dat         .
           move      s-ute                to   rf-zfp-ide-ute         .
           move      s-fas                to   rf-zfp-ide-fas         .
           move      w-tes-cod-mne (1)    to   rf-zfp-cod-mne         .
           move      w-tes-des-key (1)    to   rf-zfp-des-key         .
           move      w-tes-des-fop (1)    to   rf-zfp-des-fop         .
           move      w-tes-sco-fat (1)    to   rf-zfp-sco-fat         .
           move      w-tes-cod-pag (1, 1) to   rf-zfp-cod-pag (1)     .
           move      w-tes-tip-amm (1, 1) to   rf-zfp-tip-amm (1)     .
           move      w-tes-per-toi (1, 1) to   rf-zfp-per-toi (1)     .
           move      w-tes-dim-act (1, 1) to   rf-zfp-dim-act (1)     .
           move      w-tes-cod-pag (1, 2) to   rf-zfp-cod-pag (2)     .
           move      w-tes-tip-amm (1, 2) to   rf-zfp-tip-amm (2)     .
           move      w-tes-per-toi (1, 2) to   rf-zfp-per-toi (2)     .
           move      w-tes-dim-act (1, 2) to   rf-zfp-dim-act (2)     .
           move      w-tes-cod-pag (1, 3) to   rf-zfp-cod-pag (3)     .
           move      w-tes-tip-amm (1, 3) to   rf-zfp-tip-amm (3)     .
           move      w-tes-per-toi (1, 3) to   rf-zfp-per-toi (3)     .
           move      w-tes-dim-act (1, 3) to   rf-zfp-dim-act (3)     .
           move      w-tes-snx-ims (1)    to   rf-zfp-snx-ims         .
           move      w-tes-snx-cts (1)    to   rf-zfp-snx-cts         .
           move      w-tes-alx-exp (1)    to   rf-zfp-alx-exp         .
       cmp-rec-zfp-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zfp]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zfp-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zfp-000      thru cmp-rec-zfp-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zpg-tip-pag       to   w-let-arc-zpg-tip      .
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-zpg-600.
           move      zero                 to   w-let-arc-zpg-tip      .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zfp]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zfp "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           move      s-num                to   w-enc-zfp-val-pre      .
      *                  *---------------------------------------------*
      *                  * Incremento del valore                       *
      *                  *---------------------------------------------*
           move      w-enc-zfp-val-pre    to   w-enc-zfp-val-pos      .
           add       1                    to   w-enc-zfp-val-pos      .
       att-cod-aut-500.
      *                  *---------------------------------------------*
      *                  * Se l'incremento porta a zero si forza il    *
      *                  * valore a 1                                  *
      *                  *---------------------------------------------*
           if        w-enc-zfp-val-pos    =    zero
                     move  1              to   w-enc-zfp-val-pos      .
      *                  *---------------------------------------------*
      *                  * Se raggiunto il massimo valore impostabile  *
      *                  * si ricicla da 1                             *
      *                  *---------------------------------------------*
           if        w-enc-zfp-val-pos    >    w-enc-zfp-val-max
                     move  1              to   w-enc-zfp-val-pos      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODFOP    "         to   f-key                  .
           move      w-enc-zfp-val-pos    to   rf-zfp-cod-fop         .
           move      "pgm/dcc/fls/ioc/obj/iofzfp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      "Eu"                 to   s-ope                  .
           move      "zfp "               to   s-nam                  .
           move      w-enc-zfp-val-pos    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "Eu"                 to   s-ope                  .
           move      "zfp "               to   s-nam                  .
           move      w-enc-zfp-val-pre    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                      *-----------------------------------------*
      *                      * Se errori ripete l'intera operazione di *
