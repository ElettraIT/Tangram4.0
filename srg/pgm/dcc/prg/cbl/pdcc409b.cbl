      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CONTROLLO CODICI MANCANTI IN CLIENTI  "       .
      ...
      *        *  - 03 : Codice zona                                   *
      *        *  - 04 : Codice categoria                              *
      *        *  - 05 : Codice statistico                             *
      *        *  - 06 : Codici geografici                             *
      *        *  - 07 : Codici categoria sonto in riga                *
      *        *  - 08 : Codici categoria sonto in chiusura            *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-cod.
               10  w-exp-tip-cod-num      pic  9(02)       value 08   .
      ...
      *                  * Codici geografici                           *
      *                  *---------------------------------------------*
           if        rf-dcc-cod-naz       =    spaces
                     go to stp-srt-inp-300
           else if   rf-dcc-cod-naz       not  = "IT "
                     go to stp-srt-inp-100
           else if   rf-dcc-cod-cmn       =    zero
                     go to stp-srt-inp-300
           else      go to stp-srt-inp-100.
       stp-srt-inp-270.
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun cliente con codici mancanti da segnalare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           go to     int-pag-sta-010
                     ...
                     depending   on rr-tip-cod.
       int-pag-sta-010.
           move      "CLIENTI MANCANTI DELLA FORMA DI PAGAMENTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-020.
           move      "CLIENTI MANCANTI DEL CODICE AGENTE"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-030.
           move      "CLIENTI MANCANTI DEL CODICE ZONA"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-040.
           move      "CLIENTI MANCANTI DEL CODICE CATEGORIA"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-050.
           move      "CLIENTI MANCANTI DEL CODICE STATISTICO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-060.
           move      "CLIENTI MANCANTI DEI CODICI GEOGRAFICI"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-070.
           move      "CLIENTI MANCANTI DEI CODICI CATEGORIA SCONTO IN RI
      -              "GA"                 to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-080.
           move      "CLIENTI MANCANTI DEI CODICI CATEGORIA SCONTO IN CH
      -              "IUSURA"             to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-090.
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
