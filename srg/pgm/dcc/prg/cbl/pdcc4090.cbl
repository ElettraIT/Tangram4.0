      ...
      *                                   Fase:    dcc409              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 22/08/95    *
      *                       Ultima revisione:    NdK del 06/10/03    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase dcc409, nella sua globalita', esegue i tipi di inter-  *
      ...
      *                                                                *
      * CODMAN      Controllo clienti con codici mancanti              *
      *                                                                *
      * CODERR      Controllo clienti con codici errati                *
      *                                                                *
      * CEOBLO      Controllo clienti con blocco consegne / ordini     *
      *                                                                *
      * UTZERR      Controllo clienti con utenze errate                *
      *                                                                *
      * ANNCLI      Controllo clienti con annotazioni                  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPE DI CONTROLLO ANAGRAFICA CLIENTI "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'dcc409'           *
      *              *-------------------------------------------------*
           perform   fas-dcc-409-000      thru fas-dcc-409-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *
           move      "Controllo clienti mancanti di codici              
      -              "           CODMAN     pdcc409b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Controllo clienti con codici tabelle errati       
      -              "           CODERR     pdcc409c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Controllo clienti con blocco consegne / ordini    
      -              "           CEOBLO     pdcc409d  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *       
           move      "Controllo clienti con utenze errate               
      -              "           UTZERR     pdcc409e  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *       
           move      "Controllo clienti con annotazioni                 
      -              "           ANNCLI     pdcc409f  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-200.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-dcc-409-300
           else if   v-key                =    "PRSC"
                     go to fas-dcc-409-400
           else if   v-key                =    "NXSC"
                     go to fas-dcc-409-450
           else if   v-key                =    "DOWN"
                     go to fas-dcc-409-500
           else if   v-key                =    "EXIT"
                     go to fas-dcc-409-250
           else      go to fas-dcc-409-200.
       fas-dcc-409-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-dcc-409-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-dcc-409-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-dcc-409-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-dcc-409-350
           else      go to fas-dcc-409-322.
       fas-dcc-409-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-dcc-409-630
           else if   v-key                =    "PRSC"
                     go to fas-dcc-409-600
           else if   v-key                =    "NXSC"
                     go to fas-dcc-409-610
           else if   v-key                =    "UP  "
                     go to fas-dcc-409-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-dcc-409-650
           else if   v-key                =    "EXIT"
                     go to fas-dcc-409-660
           else      go to fas-dcc-409-570.
       fas-dcc-409-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-dcc-409-626
           else      go to fas-dcc-409-628.
       fas-dcc-409-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-dcc-409-636
           else      go to fas-dcc-409-638.
       fas-dcc-409-636.
      *                          *-------------------------------------*
