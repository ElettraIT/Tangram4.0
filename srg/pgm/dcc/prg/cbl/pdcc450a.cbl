      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-via-dcc          pic  x(40)                  .
               10  w-rig-loc-dcc          pic  x(40)                  .
               10  w-rig-naz-dcc          pic  x(03)                  .
               10  w-rig-naz-dcc-des      pic  x(20)                  .
               10  w-rig-cmn-dcc          pic  9(05)                  .
               10  w-rig-cmn-dcc-des      pic  x(30)                  .
               10  w-rig-cmn-dcc-prv      pic  x(02)                  .
               10  w-rig-fzn-dcc          pic  9(03)                  .
               10  w-rig-fzn-dcc-des      pic  x(30)                  .
               10  w-rig-lct-dcc          pic  9(03)                  .
               10  w-rig-lct-dcc-des      pic  x(30)                  .
           05  w-rig-002.
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-com-naz  pic  x(15)                  .
                   15  w-lin-imm-dcc-cfl redefines
                       w-lin-imm-com-naz.
                       20  w-lin-imm-cod-cmn  
                                          pic  x(05)                  .
                       20  filler         pic  x(02)                  .
                       20  w-lin-imm-cod-fzn
                                          pic  x(03)                  .
                       20  filler         pic  x(02)                  .
                       20  w-lin-imm-cod-lct
                                          pic  x(03)                  .
                   15  w-lin-imm-dcc-naz redefines
                       w-lin-imm-com-naz.
                       20  w-lin-imm-cod-naz  
                                          pic  x(03)                  .
                       20  filler         pic  x(01)                  .
                       20  w-lin-imm-des-naz
                                          pic  x(11)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Si/no senza codici geografici              *
      *        *-------------------------------------------------------*
           05  w-exp-snx-scg.
               10  w-exp-snx-scg-num      pic  9(02)       value 2    .
               10  w-exp-snx-scg-lun      pic  9(02)       value 02   .
               10  w-exp-snx-scg-tbl.
      ...
      *                  *---------------------------------------------*
       ...
       acc-key-reg-450.
      *                  *---------------------------------------------*
      *                  * Si/no senza codici geografici               *
      *                  *---------------------------------------------*
           perform   acc-snx-scg-000      thru acc-snx-scg-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Si/no senza codici geografici                   *
      *              *-------------------------------------------------*
           perform   vis-snx-scg-000      thru vis-snx-scg-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Si/no senza codici geografici               *
      *                  *---------------------------------------------*
           perform   pmt-snx-scg-000      thru pmt-snx-scg-999        .
       pmt-key-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no senza codici geografici    *
      *    *-----------------------------------------------------------*
       pmt-snx-scg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Solo clienti senza codici  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no senza codici geografici        *
      *    *-----------------------------------------------------------*
       acc-snx-scg-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Test se campo da accettare                  *
      *                  *---------------------------------------------*
           if        w-tes-cap-avp        not  = spaces or
                     w-tes-cod-cmn        not  = zero   or
                     w-tes-cod-fzn        not  = zero   or
                     w-tes-cod-lct        not  = zero
                     go to acc-snx-scg-999.
       acc-snx-scg-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-scg-lun    to   v-car                  .
           move      w-exp-snx-scg-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      20                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-scg-tbl    to   v-txt                  .
           move      w-tes-snx-scg        to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Si/no senza codici geografici     *
      *    *-----------------------------------------------------------*
       vis-snx-scg-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *                  * Indirizzo                                   *
      *                  *---------------------------------------------*
           perform   acc-via-dcc-000      thru acc-via-dcc-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * C.a.p. e citta'                             *
      *                  *---------------------------------------------*
           perform   acc-loc-dcc-000      thru acc-loc-dcc-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Editing Cap                                 *
      *                  *---------------------------------------------*
           move      w-rig-loc-dcc        to   w-lin-imm-cap-avp      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-naz-dcc        to   w-lin-imm-cod-naz      .
           move      w-rig-naz-dcc-des    to   w-lin-imm-des-naz      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-naz-dcc        to   w-ind-cec-geo-naz      .
           move      w-rig-via-dcc        to   w-ind-cec-geo-ind      .
           move      16                   to   w-ind-cec-geo-lin      .
           move      22                   to   w-ind-cec-geo-pos      .
           move      w-rig-loc-dcc        to   w-ind-cec-geo-cec      .
           move      w-rig-cmn-dcc        to   w-ind-cec-geo-cmn      .
           move      w-rig-cmn-dcc-des    to   w-ind-cec-geo-dco      .
           move      w-rig-cmn-dcc-prv    to   w-ind-cec-geo-prv      .
           move      w-rig-fzn-dcc        to   w-ind-cec-geo-fzn      .
           move      w-rig-fzn-dcc-des    to   w-ind-cec-geo-dfr      .
           move      w-rig-lct-dcc        to   w-ind-cec-geo-lct      .
           move      w-rig-lct-dcc-des    to   w-ind-cec-geo-dlo      .
           move      spaces               to   v-edm                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "INSR"               to   v-pfk (04)             .
       ...
       acc-via-dcc-110.
           ...
           if        w-ind-cec-geo-ope    =    "F+"
                     go to acc-via-dcc-115.
           if        w-ind-cec-geo-ope    =    "AC"
                     go to acc-via-dcc-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-via-dcc-115.
           perform   ind-cec-geo-foi-000  thru ind-cec-geo-foi-999    .
           go to     acc-via-dcc-110.
       acc-via-dcc-120.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-via-dcc-999.
       acc-via-dcc-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-ind-cec-geo-ind    to   w-rig-via-dcc          .
      *              *-------------------------------------------------*
      *              * Altri valori se automatismo eseguito            *
      *              *-------------------------------------------------*
           if        w-ind-cec-geo-aut    =    spaces
                     go to acc-via-dcc-400.
      *                  *---------------------------------------------*
      *                  * C.a.p. e citta'                             *
      *                  *---------------------------------------------*
           move      w-ind-cec-geo-cec    to   w-rig-loc-dcc          .
           perform   vis-loc-dcc-000      thru vis-loc-dcc-999        .
      *                  *---------------------------------------------*
      *                  * Comune                                      *
      *                  *---------------------------------------------*
           move      w-ind-cec-geo-cmn    to   w-rig-cmn-dcc          .
           move      w-ind-cec-geo-dco    to   w-rig-cmn-dcc-des      .
           move      w-ind-cec-geo-prv    to   w-rig-cmn-dcc-prv      .
           perform   vis-rig-cmn-000      thru vis-rig-cmn-999        .
           perform   vis-rig-cmn-des-000  thru vis-rig-cmn-des-999    .
           perform   vis-rig-cmn-prv-000  thru vis-rig-cmn-prv-999    .
      *                  *---------------------------------------------*
      *                  * Frazione                                    *
      *                  *---------------------------------------------*
           move      w-ind-cec-geo-fzn    to   w-rig-fzn-dcc          .
           move      w-ind-cec-geo-dfr    to   w-rig-fzn-dcc-des      .
           perform   vis-rig-fzn-000      thru vis-rig-fzn-999        .
           perform   vis-rig-fzn-des-000  thru vis-rig-fzn-des-999    .
      *                  *---------------------------------------------*
      *                  * Localita'                                   *
      *                  *---------------------------------------------*
           move      w-ind-cec-geo-lct    to   w-rig-lct-dcc          .
           move      w-ind-cec-geo-dlo    to   w-rig-lct-dcc-des      .
           perform   vis-rig-lct-000      thru vis-rig-lct-999        .
           perform   vis-rig-lct-des-000  thru vis-rig-lct-des-999    .
       acc-via-dcc-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-via-dcc        =    spaces
                     go to acc-via-dcc-600.
      *
           if        w-rig-via-dcc
                    (01 : 01)             =    spaces
                     go to acc-via-dcc-100.
       acc-via-dcc-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-naz-dcc        to   w-cap-cit-geo-naz      .
           move      w-rig-loc-dcc        to   w-cap-cit-geo-cec      .
           move      17                   to   w-cap-cit-geo-lin      .
           move      22                   to   w-cap-cit-geo-pos      .
           move      w-rig-cmn-dcc        to   w-cap-cit-geo-cmn      .
           move      w-rig-cmn-dcc-des    to   w-cap-cit-geo-dco      .
           move      w-rig-cmn-dcc-prv    to   w-cap-cit-geo-prv      .
           move      w-rig-fzn-dcc        to   w-cap-cit-geo-fzn      .
           move      w-rig-fzn-dcc-des    to   w-cap-cit-geo-dfr      .
           move      w-rig-lct-dcc        to   w-cap-cit-geo-lct      .
           move      w-rig-lct-dcc-des    to   w-cap-cit-geo-dlo      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-loc-dcc-110.
           ...
           if        w-cap-cit-geo-ope    =    "F+"
                     go to acc-loc-dcc-115.
           if        w-cap-cit-geo-ope    =    "AC"
                     go to acc-loc-dcc-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-loc-dcc-115.
           perform   cap-cit-geo-foi-000  thru cap-cit-geo-foi-999    .
           go to     acc-loc-dcc-110.
       acc-loc-dcc-120.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-loc-dcc-999.
       acc-loc-dcc-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cap-cit-geo-cec    to   w-rig-loc-dcc          .
      *              *-------------------------------------------------*
      *              * Altri valori se automatismo eseguito            *
      *              *-------------------------------------------------*
           if        w-cap-cit-geo-aut    =    spaces
                     go to acc-loc-dcc-400.
       acc-loc-dcc-300.
      *                  *---------------------------------------------*
      ...
      *                  * Comune                                      *
      *                  *---------------------------------------------*
           move      w-cap-cit-geo-cmn    to   w-rig-cmn-dcc          .
           move      w-cap-cit-geo-dco    to   w-rig-cmn-dcc-des      .
           move      w-cap-cit-geo-prv    to   w-rig-cmn-dcc-prv      .
           perform   vis-rig-cmn-000      thru vis-rig-cmn-999        .
           perform   vis-rig-cmn-des-000  thru vis-rig-cmn-des-999    .
           perform   vis-rig-cmn-prv-000  thru vis-rig-cmn-prv-999    .
      *                  *---------------------------------------------*
      *                  * Frazione                                    *
      *                  *---------------------------------------------*
           move      w-cap-cit-geo-fzn    to   w-rig-fzn-dcc          .
           move      w-cap-cit-geo-dfr    to   w-rig-fzn-dcc-des      .
           perform   vis-rig-fzn-000      thru vis-rig-fzn-999        .
           perform   vis-rig-fzn-des-000  thru vis-rig-fzn-des-999    .
      *                  *---------------------------------------------*
      *                  * Localita'                                   *
      *                  *---------------------------------------------*
           move      w-cap-cit-geo-lct    to   w-rig-lct-dcc          .
           move      w-cap-cit-geo-dlo    to   w-rig-lct-dcc-des      .
           perform   vis-rig-lct-000      thru vis-rig-lct-999        .
           perform   vis-rig-lct-des-000  thru vis-rig-lct-des-999    .
       acc-loc-dcc-400.
      *              *-------------------------------------------------*
      ...
      *                  * non deve essere a spaces                    *
      *                  *---------------------------------------------*
           if        w-rig-loc-dcc        =    spaces
                     go to acc-loc-dcc-600.
      *
           if        w-rig-loc-dcc
                    (01 : 01)             =    spaces
                     go to acc-loc-dcc-100.
       acc-loc-dcc-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-naz-ope      .
           move      w-rig-naz-dcc        to   w-cod-des-naz-cod      .
      ...
      *                  * Lettura tabella                             *
      *                  *---------------------------------------------*
           move      w-rig-naz-dcc        to   w-let-arc-gxn-cod      .
           perform   let-arc-gxn-000      thru let-arc-gxn-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-gxn-des    to   w-rig-naz-dcc-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-naz-des-000  thru vis-rig-naz-des-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-naz-des-000.
           ...
           move      18                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      w-rig-naz-dcc-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-naz-des-999.
           exit.
      ...
      *                  * Test se campo da accettare                  *
      *                  *---------------------------------------------*
           if        w-rig-naz-dcc        not  = "IT "
                     go to acc-rig-cmn-999.
       acc-rig-cmn-050.
      *                  *---------------------------------------------*
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-cmn-dcc        to   w-sav-cod-cmn          .
       acc-rig-cmn-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-com-geo-ope      .
           move      w-rig-cmn-dcc        to   w-cod-com-geo-cmn      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cod-com-geo-cmn    to   w-rig-cmn-dcc          .
       acc-rig-cmn-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "C"                  to   w-let-arc-gxc-tip      .
           move      w-rig-cmn-dcc        to   w-let-arc-gxc-cmn      .
           move      zero                 to   w-let-arc-gxc-fzn      .
           move      zero                 to   w-let-arc-gxc-lct      .
           perform   let-arc-gxc-000      thru let-arc-gxc-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati letti                   *
      *                  *---------------------------------------------*
           move      w-let-arc-gxc-des    to   w-rig-cmn-dcc-des      .
           move      w-let-arc-gxc-prv    to   w-rig-cmn-dcc-prv      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-cmn-des-000  thru vis-rig-cmn-des-999    .
      ...
      *                  * Test se valore cambiato oppure no           *
      *                  *---------------------------------------------*
           if        w-rig-cmn-dcc        =    w-sav-cod-cmn
      ...
      *                          * Frazione                            *
      *                          *-------------------------------------*
           if        w-rig-fzn-dcc        =    zero
                     go to acc-rig-cmn-654.
           move      zero                 to   w-rig-fzn-dcc          .
           move      spaces               to   w-rig-fzn-dcc-des      .
           perform   vis-rig-fzn-000      thru vis-rig-fzn-999        .
           perform   vis-rig-fzn-des-000  thru vis-rig-fzn-des-999    .
       acc-rig-cmn-654.
      *                          *-------------------------------------*
      *                          * Localita'                           *
      *                          *-------------------------------------*
           if        w-rig-lct-dcc        =    zero
                     go to acc-rig-cmn-656.
           move      zero                 to   w-rig-lct-dcc          .
           move      spaces               to   w-rig-lct-dcc-des      .
           perform   vis-rig-lct-000      thru vis-rig-lct-999        .
           perform   vis-rig-lct-des-000  thru vis-rig-lct-des-999    .
       acc-rig-cmn-656.
      *                      *-----------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       vis-rig-cmn-des-000.
           ...
           move      19                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      w-rig-cmn-dcc-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-cmn-des-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       vis-rig-cmn-prv-000.
           ...
           move      19                   to   v-lin                  .
           move      69                   to   v-pos                  .
           move      w-rig-cmn-dcc-prv    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-cmn-prv-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           if        w-rig-cmn-dcc        =    zero
                     go to acc-rig-fzn-999.
       acc-rig-fzn-050.
      *                  *---------------------------------------------*
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-fzn-dcc        to   w-sav-cod-fzn          .
       acc-rig-fzn-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-fra-geo-ope      .
           move      w-rig-cmn-dcc        to   w-cod-fra-geo-cmn      .
           move      w-rig-fzn-dcc        to   w-cod-fra-geo-fzn      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cod-fra-geo-fzn    to   w-rig-fzn-dcc          .
       acc-rig-fzn-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "F"                  to   w-let-arc-gxc-tip      .
           move      w-rig-cmn-dcc        to   w-let-arc-gxc-cmn      .
           move      w-rig-fzn-dcc        to   w-let-arc-gxc-fzn      .
           move      zero                 to   w-let-arc-gxc-lct      .
           perform   let-arc-gxc-000      thru let-arc-gxc-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati letti                   *
      *                  *---------------------------------------------*
           move      w-let-arc-gxc-des    to   w-rig-fzn-dcc-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-fzn-des-000  thru vis-rig-fzn-des-999    .
      ...
      *                  * Test se valore cambiato oppure no           *
      *                  *---------------------------------------------*
           if        w-rig-fzn-dcc        =    w-sav-cod-fzn
      ...
      *    *-----------------------------------------------------------*
       vis-rig-fzn-des-000.
           ...
           move      20                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      w-rig-fzn-dcc-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-fzn-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-loc-geo-ope      .
           move      w-rig-cmn-dcc        to   w-cod-loc-geo-cmn      .
           move      w-rig-fzn-dcc        to   w-cod-loc-geo-fzn      .
           move      w-rig-lct-dcc        to   w-cod-loc-geo-lct      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cod-loc-geo-lct    to   w-rig-lct-dcc          .
       acc-rig-lct-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-cmn-dcc        to   w-let-arc-gxc-cmn      .
           move      w-rig-fzn-dcc        to   w-let-arc-gxc-fzn      .
           move      w-rig-lct-dcc        to   w-let-arc-gxc-lct      .
           perform   let-arc-gxc-000      thru let-arc-gxc-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati letti                   *
      *                  *---------------------------------------------*
           move      w-let-arc-gxc-des    to   w-rig-lct-dcc-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-lct-des-000  thru vis-rig-lct-des-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-lct-des-000.
           ...
           move      21                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      w-rig-lct-dcc-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-lct-des-999.
           exit.
      ...
      *                  * Si/no senza codici geografici               *
      *                  *---------------------------------------------*
           if        w-tes-snx-scg        not  = 02
                     move  01             to   w-tes-snx-scg          .
       cnt-tdo-key-800.
      *              *-------------------------------------------------*
      ...
      *                      * Codice comune                           *
      *                      *-----------------------------------------*
           if        w-rig-naz-dcc        =    spaces
                     move  zero           to   w-rig-cmn-dcc          .
      *                      *-----------------------------------------*
      *                      * Codice frazione                         *
      *                      *-----------------------------------------*
           if        w-rig-cmn-dcc        =    zero
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-rig-via-dcc          .
           move      spaces               to   w-rig-loc-dcc          .
           move      spaces               to   w-rig-naz-dcc          .
           move      spaces               to   w-rig-naz-dcc-des      .
           move      zero                 to   w-rig-cmn-dcc          .
           move      spaces               to   w-rig-cmn-dcc-des      .
           move      spaces               to   w-rig-cmn-dcc-prv      .
           move      zero                 to   w-rig-fzn-dcc          .
           move      spaces               to   w-rig-fzn-dcc-des      .
           move      zero                 to   w-rig-lct-dcc          .
           move      spaces               to   w-rig-lct-dcc-des      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test preliminare su clienti senza codici    *
      *                  *---------------------------------------------*
           if        w-tes-snx-scg        not  = 02
                     go to sel-rec-dcc-150.
           if        rf-dcc-cod-cmn       =    zero
                     go to sel-rec-dcc-800
           else      go to sel-rec-dcc-900.
       sel-rec-dcc-150.
      *                  *---------------------------------------------*
      *                  * Codice nazione                              *
      *                  *---------------------------------------------*
           ...
           if        rf-dcc-cod-naz       not  = w-tes-cod-naz
      ...
      *                      *-----------------------------------------*
           move      rf-dcc-loc-dcc       to   w-sel-rec-dcc-cap      .
           if        w-sel-rec-dcc-cap    not  = w-tes-cap-avp
                     go to sel-rec-dcc-900.
       sel-rec-dcc-300.
      *                  *---------------------------------------------*
      *                  * Codice comune                               *
      *                  *---------------------------------------------*
           if        w-tes-cod-cmn        =    zero
                     go to sel-rec-dcc-800.
           if        rf-dcc-cod-cmn       not  = w-tes-cod-cmn
                     go to sel-rec-dcc-900.
       sel-rec-dcc-400.
      *                  *---------------------------------------------*
      *                  * Codice frazione                             *
      *                  *---------------------------------------------*
           ...
           if        rf-dcc-cod-fzn       not  = w-tes-cod-fzn
                     go to sel-rec-dcc-900.
       sel-rec-dcc-500.
      *                  *---------------------------------------------*
      *                  * Codice localita'                            *
      *                  *---------------------------------------------*
           if        w-tes-cod-lct        =    zero
                     go to sel-rec-dcc-800.
           if        rf-dcc-cod-lct       not  = w-tes-cod-lct
                     go to sel-rec-dcc-900.
       sel-rec-dcc-800.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcc-via-dcc       to   w-rig-via-dcc          .
           move      rf-dcc-loc-dcc       to   w-rig-loc-dcc          .
           move      rf-dcc-cod-naz       to   w-rig-naz-dcc          .
      *                          *-------------------------------------*
      ...
      *                          * cliente principale per avere il co- *
      *                          * dice nazione reale della dipendenza *
      *                          *-------------------------------------*
           if        rf-dcc-dpz-cli       not  = spaces and
                     rf-dcc-cod-cmn       not  = zero
                     move  "IT "          to   w-rig-naz-dcc          .
           move      rf-dcc-cod-cmn       to   w-rig-cmn-dcc          .
           move      rf-dcc-cod-fzn       to   w-rig-fzn-dcc          .
           move      rf-dcc-cod-lct       to   w-rig-lct-dcc          .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-rig-via-dcc        to   rf-dcc-via-dcc         .
           move      w-rig-loc-dcc        to   rf-dcc-loc-dcc         .
           move      w-rig-naz-dcc        to   rf-dcc-cod-naz         .
      *                          *-------------------------------------*
      *                          * In caso di dipendenza il codice     *
      *                          * nazione si normalizza in quanto e'  *
      *                          * contenuto nel record del cliente    *
      *                          * principale                          *
      *                          *-------------------------------------*
           if        rf-dcc-dpz-cli       not  = spaces
                     move  spaces         to   rf-dcc-cod-naz         .
           move      w-rig-cmn-dcc        to   rf-dcc-cod-cmn         .
           move      w-rig-fzn-dcc        to   rf-dcc-cod-fzn         .
           move      w-rig-lct-dcc        to   rf-dcc-cod-lct         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
