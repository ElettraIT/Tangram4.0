      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcc1621:        *
      *                                                                *
      *                    Stampa categorie sconto a piede documento   *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Link-area per accettazione categorie sconto a piede doc.  *
      *    *-----------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Open modulo accettazione cat. sc. a piede doc.  *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       rou-cls-fls-000.
      *              *-------------------------------------------------*
      *              * Close modulo accettazione cat. sc. a piede doc. *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella sconti a piede documento"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zcs-001-cod      .
           move      14                   to   w-cmn-zcs-001-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zcs-001-ope      .
           move      rr-cod-max           to   w-cmn-zcs-001-cod      .
           move      14                   to   w-cmn-zcs-001-lin      .
           move      52                   to   w-cmn-zcs-001-pos      .
           move      zero                 to   w-cmn-zcs-001-dln      .
           move      zero                 to   w-cmn-zcs-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione del codice cat. sconto     *
      *    *-----------------------------------------------------------*
