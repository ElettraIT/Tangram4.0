      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      41                   to   v-pos                  .
           move      rf-zdf-des-stp       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zdf-num-def       to   w-mpn-num-def          .
           move      rf-zdf-cod-lng       to   w-mpn-cod-lng          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
