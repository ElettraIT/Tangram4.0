      ...
      *                       Ultima revisione:    NdK del 24/07/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella categorie di sconto in     *
      *                    riga documento                              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CATEGORIE DI SCONTO IN RIGA DOCUMENTO "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-csc          pic  9(05)                  .
               10  w-tes-cod-csc-aut      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-mne-csc          pic  x(05)                  .
               10  w-tes-des-key          pic  x(20)                  .
               10  w-tes-des-csc          pic  x(20)                  .
               10  w-tes-per-sco occurs 05
                                          pic  9(02)v9(01)            .
               10  w-tes-alx-exp          pic  x(80)                  .

      *    *===========================================================*
      *    * Work-area per subroutines di editing                      *
      *    *-----------------------------------------------------------*
       01  w-edt.
      *        *-------------------------------------------------------*
      *        * Contatori per percentuali di sconto                   *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-edt-per-sco.
               10  w-edt-cst-sco occurs 5.
                   15  w-edt-cst-ele      pic  x(04)                  .
                   15  filler             pic  x(02)                  .

      *    *===========================================================*
      *    * Link-area per accettazione categoria sconto in riga doc.  *
      *    *-----------------------------------------------------------*
      ...
      *                  * Codice sconto                               *
      *                  *---------------------------------------------*
           perform   acc-cod-csc-000      thru acc-cod-csc-999        .
      ...
      *              * Codice sconto                                   *
      *              *-------------------------------------------------*
           perform   vis-cod-csc-000      thru vis-cod-csc-999        .
       vis-key-reg-999.
           exit.
      ...
      *              * Codice sconto                                   *
      *              *-------------------------------------------------*
           perform   pmt-cod-csc-000      thru pmt-cod-csc-999        .
      *              *-------------------------------------------------*
      *              * Linea di trattini                               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice sconto                 *
      *    *-----------------------------------------------------------*
       pmt-cod-csc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice sconto                 *
      *    *-----------------------------------------------------------*
       acc-cod-csc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-csc        to   w-cmn-zcs-002-cod      .
           move      04                   to   w-cmn-zcs-002-lin      .
           move      30                   to   w-cmn-zcs-002-pos      .
           move      07                   to   w-cmn-zcs-002-dln      .
           move      30                   to   w-cmn-zcs-002-dps      .
           move      "<B"                 to   v-edm                  .
       ...
       acc-cod-csc-110.
           ...
           if        w-cmn-zcs-002-ope    =    "F+"
                     go to acc-cod-csc-115.
           if        w-cmn-zcs-002-ope    =    "AC"
                     go to acc-cod-csc-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-csc-115.
           perform   cmn-zcs-002-foi-000  thru cmn-zcs-002-foi-999    .
           go to     acc-cod-csc-110.
       acc-cod-csc-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-csc-999.
       acc-cod-csc-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cod-csc          .
       acc-cod-csc-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-csc        =    zero
                     go to acc-cod-csc-410
           else      go to acc-cod-csc-450.
       acc-cod-csc-410.
      *                  *---------------------------------------------*
      ...
      *                      * zione                                   *
      *                      *-----------------------------------------*
           move      w-enc-cod-val-pos    to   w-tes-cod-csc          .
      *                      *-----------------------------------------*
      *                      * Segnale di attribuzione codice eseguita *
      *                      * automaticamente                         *
      *                      *-----------------------------------------*
           move      "#"                  to   w-tes-cod-csc-aut      .
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice sconto              *
      *    *-----------------------------------------------------------*
       vis-cod-csc-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  * Descrizione sconto                          *
      *                  *---------------------------------------------*
           perform   acc-des-csc-000      thru acc-des-csc-999        .
           if        v-key                =    "NXSC"
      ...
      *                  * Mnemonico sconto                            *
      *                  *---------------------------------------------*
           perform   acc-mne-csc-000      thru acc-mne-csc-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Descrizione sconto                              *
      *              *-------------------------------------------------*
           perform   vis-des-csc-000      thru vis-des-csc-999        .
      *              *-------------------------------------------------*
      *              * Mnemonico sconto                                *
      *              *-------------------------------------------------*
           perform   vis-mne-csc-000      thru vis-mne-csc-999        .
      *              *-------------------------------------------------*
      *              * Percentuali di sconto                           *
      *              *-------------------------------------------------*
      ...
      *              * Descrizione sconto                              *
      *              *-------------------------------------------------*
           perform   pmt-des-csc-000      thru pmt-des-csc-999        .
      *              *-------------------------------------------------*
      *              * Mnemonico sconto                                *
      *              *-------------------------------------------------*
           perform   pmt-mne-csc-000      thru pmt-mne-csc-999        .
      *              *-------------------------------------------------*
      *              * Percentuali di sconto                           *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione sconto               *
      *    *-----------------------------------------------------------*
       pmt-des-csc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Mnemonico sconto                 *
      *    *-----------------------------------------------------------*
       pmt-mne-csc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione sconto           *
      *    *-----------------------------------------------------------*
       acc-des-csc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-csc (1)    not  = spaces
                     go to acc-des-csc-450.
           if        v-key                =    "UP  "
                     go to acc-des-csc-600
           else      go to acc-des-csc-100.
       acc-des-csc-450.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-des-csc (1)    to   w-all-str-alf          .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione sconto        *
      *    *-----------------------------------------------------------*
       vis-des-csc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Mnemonico sconto             *
      *    *-----------------------------------------------------------*
       acc-mne-csc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Mnemonico sconto          *
      *    *-----------------------------------------------------------*
       vis-mne-csc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Percentuali di sconto                *
      *    *-----------------------------------------------------------*
       acc-per-sco-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Percentuali di sconto             *
      *    *-----------------------------------------------------------*
       vis-per-sco-000.
      ...
      *              *-------------------------------------------------*
           ...
           move      "Manca la descrizione per la categoria di sconto   
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           move      zero                 to   w-tes-cod-csc          .
           move      spaces               to   w-tes-cod-csc-aut      .
       nor-key-reg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-mne-csc (1)      .
           move      spaces               to   w-tes-des-key (1)      .
           move      spaces               to   w-tes-des-csc (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-csc        to   rf-zcs-cod-csc         .
           move      "pgm/dcc/fls/ioc/obj/iofzcs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-zcs-mne-csc       to   w-tes-mne-csc (1)      .
           move      rf-zcs-des-key       to   w-tes-des-key (1)      .
           move      rf-zcs-des-csc       to   w-tes-des-csc (1)      .
           move      rf-zcs-per-sco (1)   to   w-tes-per-sco (1, 1)   .
           move      rf-zcs-per-sco (2)   to   w-tes-per-sco (1, 2)   .
           move      rf-zcs-per-sco (3)   to   w-tes-per-sco (1, 3)   .
           move      rf-zcs-per-sco (4)   to   w-tes-per-sco (1, 4)   .
           move      rf-zcs-per-sco (5)   to   w-tes-per-sco (1, 5)   .
           move      rf-zcs-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zcs]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zcs-000      thru wrt-rec-zcs-999        .
      ...
      *                      * Rewrite record [zcs]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zcs-000      thru rew-rec-zcs-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zcs]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zcs-000      thru del-rec-zcs-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zcs]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zcs-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-mne-csc (1)    to   rf-zcs-mne-csc         .
           move      w-tes-des-key (1)    to   rf-zcs-des-key         .
           move      w-tes-des-csc (1)    to   rf-zcs-des-csc         .
           move      w-tes-per-sco (1, 1) to   rf-zcs-per-sco (1)     .
           move      w-tes-per-sco (1, 2) to   rf-zcs-per-sco (2)     .
           move      w-tes-per-sco (1, 3) to   rf-zcs-per-sco (3)     .
           move      w-tes-per-sco (1, 4) to   rf-zcs-per-sco (4)     .
           move      w-tes-per-sco (1, 5) to   rf-zcs-per-sco (5)     .
           move      w-tes-alx-exp (1)    to   rf-zcs-alx-exp         .
       cmp-rec-zcs-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zcs]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zcs-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zcs-000      thru cmp-rec-zcs-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zcs] parte 02    *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zcs2"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           ...
           move      "CODCSC    "         to   f-key                  .
           move      02                   to   rf-zcs-tip-csc         .
           move      w-enc-cod-val-pos    to   rf-zcs-cod-csc         .
           move      "pgm/dcc/fls/ioc/obj/iofzcs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       rip-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zcs]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zcs2"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione del codice sconto          *
      *    *-----------------------------------------------------------*
