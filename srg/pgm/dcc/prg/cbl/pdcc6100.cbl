      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcc6101:        *
      *                                                                *
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice cliente per marketing   *
      *    *-----------------------------------------------------------*
           ...
           05  w-exp-tip-stp.
               ...
               10  w-exp-tip-stp-tbl.
                   15  filler             pic  x(40) value
                            "Etichette laser - A4 (3 x 8) 24 x foglio".
                   15  filler             pic  x(40) value
                            "Etichette modulo continuo (1 x 8)       ".
                   15  filler             pic  x(40) value
      ...
      *                  * Categoria SEAT                              *
      *                  *---------------------------------------------*
           perform   acc-cat-sea-000      thru acc-cat-sea-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      *              * Prompt 'Selezione su codice provincia :'        *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      31                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su categoria SEAT   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           perform   fnd-arc-dcm-000      thru fnd-arc-dcm-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-dcm-cod      .
           move      14                   to   w-cod-mne-dcm-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-dcm-ope      .
           move      rr-cod-max           to   w-cod-mne-dcm-cod      .
           move      14                   to   w-cod-mne-dcm-lin      .
           move      53                   to   w-cod-mne-dcm-pos      .
           move      zero                 to   w-cod-mne-dcm-rln      .
           move      zero                 to   w-cod-mne-dcm-rps      .
           move      zero                 to   w-cod-mne-dcm-vln      .
           move      zero                 to   w-cod-mne-dcm-vps      .
      ...
      *              *-------------------------------------------------*
           ...
           move      33                   to   w-cod-des-prv-pos      .
           move      18                   to   w-cod-des-prv-dln      .
           move      46                   to   w-cod-des-prv-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Categoria SEAT             *
      *    *-----------------------------------------------------------*
       acc-cat-sea-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-cat-sea-999.
       acc-cat-sea-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   rr-cat-sea             .
       acc-cat-sea-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Tasto funzione "FIND" su archivio clienti marketing       *
      *    *-----------------------------------------------------------*
       fnd-arc-dcm-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "P?"                 to   s-ope                  .
           move      "pdcc6010"           to   s-pro                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     go to  fnd-arc-dcm-999.
      *              *-------------------------------------------------*
      *              * Richiamo programma di interrogazione            *
      *              *-------------------------------------------------*
           move      "pgm/dcc/prg/obj/pdcc6010"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat                                            .
