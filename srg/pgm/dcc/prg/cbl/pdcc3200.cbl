      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione di un intero listino per cliente   *
      *                                                                *
      *================================================================*
      ...
      *        *                                                       *
      *        * - 00 : Nessuna preferenza, solo utilizzo di prezzo e  *
      *        *        sconti                                         *
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Forzatura per consentire l'accettazione     *
      *                  * delle date di validita'                     *
      *                  *---------------------------------------------*
           go to     prs-tfu-pnc-650.
       prs-tfu-pnc-550.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       vis-lin-cor-440.
      *                  *---------------------------------------------*
      *                  * Editing si/no cancellazione                 *
      *                  *---------------------------------------------*
           move      w-rig-flg-del        to   w-lin-imm-snx-del      .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice prodotto, u.m. per la vendita    *
      *    *-----------------------------------------------------------*
       vis-cod-pro-umv-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "[F2] per cancellare le condizioni nette concordate
      -              " per il prodotto"   to   v-nt1                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      ...
      *                  *---------------------------------------------*
           if        v-key                not  = "[2] "
                     go to acc-tip-fnz-400.
      *                  *---------------------------------------------*
      *                  * Switching flag di cancellazione             *
      *                  *---------------------------------------------*
           if        w-rig-flg-del        =    spaces
                     move "#"             to   w-rig-flg-del
           else      move spaces          to   w-rig-flg-del          .
      *                  *---------------------------------------------*
      *                  * Forzatura per uscita                        *
      *                  *---------------------------------------------*
           move      "S"                  to   w-cnt-tus-acc-rig      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      ...
      *                  *---------------------------------------------*
           ...
           add       2                    to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "{IN CANCELLAZIONE}" to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      ...
      *                      * Unita' di misura di vendita             *
      *                      *-----------------------------------------*
           move      srt-umi-ven          to   w-rig-umi-ven          .
       car-fil-rap-435.
      *                      *-----------------------------------------*
      *                      * Prezzo di listino precedente            *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       sca-fil-rap-175.
      *              *-------------------------------------------------*
      *              * Test se richiesta cancellazione condizioni net- *
      *              * te concordate                                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su flag di cancellazione               *
