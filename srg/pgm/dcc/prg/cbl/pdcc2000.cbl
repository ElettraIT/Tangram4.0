      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella spese bollo                *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-spb        to   w-cod-cod-zbo-cod      .
           move      04                   to   w-cod-cod-zbo-lin      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-spb        to   rf-zbo-cod-spb         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-zbo-des-spb       to   w-tes-des-spb (1)      .
           move      rf-zbo-civ-spb       to   w-tes-civ-spb (1)      .
           move      rf-zbo-ccp-spb       to   w-tes-ccp-spb (1)      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "CODSPB    "         to   f-key                  .
           move      w-tes-cod-spb        to   rf-zbo-cod-spb         .
           move      w-tes-tip-pag        to   rf-zbo-tip-pag         .
           move      "pgm/dcc/fls/ioc/obj/iofzbo"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
           ...
           move      rf-zbo-ccp-spb       to   w-tes-ccp-spb (1)      .
       rou-let-reg-120.
           move      rf-zbo-tau-spb       to   w-tes-tau-spb (1)      .
           move      rf-zbo-per-spb       to   w-tes-per-spb (1)      .
           move      zero                 to   w-cix-gen-001          .
       rou-let-reg-200.
           add       1                    to   w-cix-gen-001          .
           if        w-cix-gen-001        >    10
       ...
       rou-let-reg-220.
           move      rf-zbo-tet-spb       to   w-tes-tet-spb (1)      .
           move      rf-zbo-min-spb       to   w-tes-min-spb (1)      .
           move      rf-zbo-max-spb       to   w-tes-max-spb (1)      .
           move      rf-zbo-tar-spb       to   w-tes-tar-spb (1)      .
           move      rf-zbo-var-spb       to   w-tes-var-spb (1)      .
           move      rf-zbo-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       pre-snx-del-200.
      *                  *---------------------------------------------*
      *                  * Lettura sequenziale archivio [zbo]          *
      *                  *---------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcc/fls/ioc/obj/iofzbo"
                                          to   s-pat                  .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-zbo-cod-spb       not  = w-tes-cod-spb
                     go to pre-snx-del-900.
      *                  *---------------------------------------------*
      *                  * Incremento contatore                        *
      *                  *---------------------------------------------*
      ...
      *                      * Write record [zbo]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zbo-000      thru wrt-rec-zbo-999        .
      ...
      *                      * Rewrite record [zbo]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zbo-000      thru rew-rec-zbo-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zbo]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zbo-000      thru del-rec-zbo-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zbo]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zbo-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-spb (1)    to   rf-zbo-des-spb         .
           move      w-tes-civ-spb (1)    to   rf-zbo-civ-spb         .
           move      w-tes-ccp-spb (1)    to   rf-zbo-ccp-spb         .
           move      w-tes-tau-spb (1)    to   rf-zbo-tau-spb         .
           move      w-tes-per-spb (1)    to   rf-zbo-per-spb         .
           move      zero                 to   w-cix-gen-001          .
       cmp-rec-zbo-100.
           add       1                    to   w-cix-gen-001          .
           if        w-cix-gen-001        >    10
                     go to cmp-rec-zbo-120.
           move      w-tes-tbe-scg
                    (1, w-cix-gen-001)    to   rf-zbo-tbe-scg
                                              (w-cix-gen-001)         .
           move      w-tes-tbe-asc
                    (1, w-cix-gen-001)    to   rf-zbo-tbe-asc
                                              (w-cix-gen-001)         .
           move      w-tes-tbe-psc
                    (1, w-cix-gen-001)    to   rf-zbo-tbe-psc
                                              (w-cix-gen-001)         .
           go to     cmp-rec-zbo-100.
       cmp-rec-zbo-120.
           move      w-tes-tet-spb (1)    to   rf-zbo-tet-spb         .
           move      w-tes-min-spb (1)    to   rf-zbo-min-spb         .
           move      w-tes-max-spb (1)    to   rf-zbo-max-spb         .
           move      w-tes-tar-spb (1)    to   rf-zbo-tar-spb         .
           move      w-tes-var-spb (1)    to   rf-zbo-var-spb         .
           move      w-tes-alx-exp (1)    to   rf-zbo-alx-exp         .
       cmp-rec-zbo-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zbo]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zbo-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zbo-000      thru cmp-rec-zbo-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
