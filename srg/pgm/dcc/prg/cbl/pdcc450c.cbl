      ...
      *                                                                *
      *                    Manutenzione Condizioni di vendita clienti  *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
               ...
               10  w-tes-cod-lst-sns      pic  9(01)                  .
               10  w-tes-cat-scr          pic  9(05)                  .
               10  w-tes-cat-scr-des      pic  x(20)                  .
               10  w-tes-per-scr occurs 05
                                          pic  9(02)v9(01)            .
               10  w-tes-cat-scc          pic  9(05)                  .
               10  w-tes-cat-scc-des      pic  x(20)                  .
               10  w-tes-per-scc          pic  9(02)v9(01)            .
               10  w-tes-cod-age          pic  9(07)                  .
               10  w-tes-cod-age-sns      pic  9(01)                  .
      ...
      *            * Valori sostitutivi                                *
      *            *---------------------------------------------------*
               10  w-tes-age-sos          pic  9(07)                  .
               10  w-tes-lst-sos          pic  x(03)                  .
               10  w-tes-pvg-sos          pic  9(05)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-cod-lst          pic  x(03)                  .
               10  w-rig-cod-lst-des      pic  x(20)                  .
               10  w-rig-cat-scr          pic  9(05)                  .
               10  w-rig-cat-scr-des      pic  x(20)                  .
               10  w-rig-per-scr occurs 05
                                          pic  9(02)v9(01)            .
               10  w-rig-cat-scc          pic  9(05)                  .
               10  w-rig-cat-scc-des      pic  x(20)                  .
               10  w-rig-per-scc          pic  9(02)v9(01)            .
               10  w-rig-cod-age          pic  9(07)                  .
               10  w-rig-cod-age-nom      pic  x(20)                  .
               10  w-rig-cod-age-mne      pic  x(10)                  .
      ...
      *                *-----------------------------------------------*
                   ...
                   15  w-lin-imm-rag-cli.
                       ...
                       20  w-lin-imm-rag-dpz
                                          pic  x(04)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-cod-lst  pic  x(03)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-mne-age  pic  x(10)                  .
                   15  filler             pic  x(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-lpt.
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Codice listino                  *
      *        *-------------------------------------------------------*
           05  w-lpt-cod-lst-lin          pic  9(03)    value 010     .
           05  w-lpt-cod-lst-pos          pic  9(03)    value 030     .
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Codice agente                   *
      *        *-------------------------------------------------------*
           05  w-lpt-cod-age-lin          pic  9(03)    value 019     .
           05  w-lpt-cod-age-pos          pic  9(03)    value 030     .
      *        *-------------------------------------------------------*
      *        * Linea e posizione per Codice categoria provvigionale  *
      *        *-------------------------------------------------------*
           05  w-lpt-cat-pvg-lin          pic  9(03)    value 020     .
      ...
      *                  *---------------------------------------------*
       ...
       acc-key-reg-300.
      *                  *---------------------------------------------*
      *                  * Percentuali sconto in riga fattura          *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   acc-cat-scc-000      thru acc-cat-scc-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
       ...
       acc-key-reg-400.
      *                  *---------------------------------------------*
      *                  * Percentuale sconto in chiusura fattura      *
      *                  *---------------------------------------------*
           perform   acc-per-scc-000      thru acc-per-scc-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
      *              * Codice categoria sconto in riga fattura         *
      *              *-------------------------------------------------*
           perform   vis-cat-scr-000      thru vis-cat-scr-999        .
           perform   vis-cat-scr-des-000  thru vis-cat-scr-des-999    .
      *              *-------------------------------------------------*
      *              * Percentuali sconto in riga fattura              *
      *              *-------------------------------------------------*
           perform   vis-per-scr-000      thru vis-per-scr-999        .
      *              *-------------------------------------------------*
      *              * Codice categoria sconto in chiusura fattura     *
      *              *-------------------------------------------------*
           perform   vis-cat-scc-000      thru vis-cat-scc-999        .
           perform   vis-cat-scc-des-000  thru vis-cat-scc-des-999    .
      *              *-------------------------------------------------*
      *              * Percentuali sconto in chiusura fattura          *
      *              *-------------------------------------------------*
           perform   vis-per-scc-000      thru vis-per-scc-999        .
      *              *-------------------------------------------------*
      *              * Codice agente                                   *
      *              *-------------------------------------------------*
      ...
      *                  * Codice categoria sconto in chiusura fattura *
      *                  *---------------------------------------------*
           perform   pmt-cat-scc-000      thru pmt-cat-scc-999        .
      *                  *---------------------------------------------*
      *                  * Percentuali sconto in chiusura fattura      *
      *                  *---------------------------------------------*
           perform   pmt-per-scc-000      thru pmt-per-scc-999        .
      *                  *---------------------------------------------*
      *                  * Codice agente                               *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice listino                   *
      *    *-----------------------------------------------------------*
       pmt-cod-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice sconto in riga fattura    *
      *    *-----------------------------------------------------------*
       pmt-cat-scr-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Sconto in riga documenti di vendita"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Percentuali sconto in riga       *
      *    *-----------------------------------------------------------*
       pmt-per-scr-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice sconto in chiusura fattura*
      *    *-----------------------------------------------------------*
       pmt-cat-scc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      15                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Sconto in chiusura documenti di vendita"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Percentuali sconto in chiusura   *
      *    *-----------------------------------------------------------*
       pmt-per-scc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Categoria provvigioni            *
      *    *-----------------------------------------------------------*
       pmt-cat-pvg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-lpt-cod-lst-lin    to   w-cod-cod-lst-lin      .
           move      w-lpt-cod-lst-pos    to   w-cod-cod-lst-pos      .
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-cod-lst-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-cod-lst-sos-000  thru acc-cod-lst-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-lst-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-cod-lst-sos-000  thru vis-cod-lst-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-cod-lst-sns    not  = zero
                     go to acc-cod-lst-800.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice listino                    *
      *    *-----------------------------------------------------------*
       vis-cod-lst-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cod-lst-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           move      "BX"                 to   v-ope                  .
           move      w-lpt-cod-lst-lin    to   v-lin                  .
           subtract  1                    from v-lin                  .
           move      w-lpt-cod-lst-pos    to   v-pos                  .
           subtract  1                    from v-pos                  .
           move      w-lpt-cod-lst-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-cod-lst-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-cod-lst-sos-010.
      ...
      *                  *---------------------------------------------*
           perform   vis-cod-lst-so1-000  thru vis-cod-lst-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-cod-lst-so2-000  thru vis-cod-lst-so2-999    .
       acc-cod-lst-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-cod-lst-so1-000  thru acc-cod-lst-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-lst-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-lst-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-cod-lst-sos-600.
      ...
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-cod-lst-so2-000  thru acc-cod-lst-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-lst-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-lst-sos-200.
       acc-cod-lst-sos-600.
      *              *-------------------------------------------------*
      ...
      *                  * dalle impostazioni                          *
      *                  *---------------------------------------------*
           if        w-tes-cod-lst        =    spaces  and
                     w-tes-lst-sos        =    spaces
                     go to acc-cod-lst-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-cod-lst        not  = w-tes-lst-sos
                     go to acc-cod-lst-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      spaces               to   w-tes-lst-sos          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-lst        not  = spaces or
                     w-tes-lst-sos        not  = spaces
                     move  1              to   w-tes-cod-lst-sns      .
       acc-cod-lst-sos-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cod-lst-sns    =    zero
                     go to vis-cod-lst-sos-100
           else      go to vis-cod-lst-sos-500.
       vis-cod-lst-sos-100.
      *              *-------------------------------------------------*
      ...
      *
           ...
           else      move  w-tes-cod-lst  to   w-all-str-cat (2)      .
      *
      ...
      *
           if        w-tes-lst-sos        =    spaces
                     move  "[BASE]"       to   w-all-str-cat (2)
           else      move  w-tes-lst-sos  to   w-all-str-cat (2)      .
      *
           move      ")"                  to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   w-vis-lit-sos          .
      ...
      *              *-------------------------------------------------*
       ...
       acc-cod-lst-so1-110.
           perform   cod-cod-zls-cll-000  thru cod-cod-zls-cll-999    .
           if        w-cod-cod-lst-ope    =    "F+"
                     go to acc-cod-lst-so1-115.
           if        w-cod-cod-lst-ope    =    "AC"
                     go to acc-cod-lst-so1-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-lst-so1-115.
           perform   cod-cod-zls-foi-000  thru cod-cod-zls-foi-999    .
           go to     acc-cod-lst-so1-110.
       acc-cod-lst-so1-120.
           move      w-cod-cod-lst-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-lst-ope      .
           move      w-tes-lst-sos        to   w-cod-cod-lst-cod      .
           move      w-lpt-cod-lst-lin    to   w-cod-cod-lst-lin      .
           move      w-lpt-cod-lst-pos    to   w-cod-cod-lst-pos      .
           add       35                   to   w-cod-cod-lst-pos      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-cod-lst-so2-110.
           perform   cod-cod-zls-cll-000  thru cod-cod-zls-cll-999    .
           if        w-cod-cod-lst-ope    =    "F+"
                     go to acc-cod-lst-so2-115.
           if        w-cod-cod-lst-ope    =    "AC"
                     go to acc-cod-lst-so2-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-lst-so2-115.
           perform   cod-cod-zls-foi-000  thru cod-cod-zls-foi-999    .
           go to     acc-cod-lst-so2-110.
       acc-cod-lst-so2-120.
           move      w-cod-cod-lst-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-lst-so2-999.
       acc-cod-lst-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-lst-sos          .
       acc-cod-lst-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cat-scr        to   w-cmn-zcs-002-cod      .
           move      13                   to   w-cmn-zcs-002-lin      .
           move      30                   to   w-cmn-zcs-002-pos      .
           move      13                   to   w-cmn-zcs-002-dln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "BD"                 to   v-edm                  .
           move      14                   to   v-lin                  .
           move      w-edt-per-sco-c01    to   v-pos                  .
           if        w-edt-per-sco-c01    >    5
      ...
      *              * Se Up                                           *
      *              *-------------------------------------------------*
           if        w-edt-per-sco-c01    =    1
                     go to acc-per-scr-999.
           subtract  1                    from w-edt-per-sco-c01      .
      ...
      *              * Se Tab                                          *
      *              *-------------------------------------------------*
           if        w-edt-per-sco-c01    =    05
                     go to acc-per-scr-999.
      *                  *---------------------------------------------*
      *                  * Incremento contatore                        *
      *                  *---------------------------------------------*
           add       1                    to   w-edt-per-sco-c01      .
           go to     acc-per-scr-100.
       acc-per-scr-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      ...
      *    *-----------------------------------------------------------*
       vis-per-scr-000.
           move      spaces               to   w-edt-per-sco-edt      .
           move      zero                 to   w-edt-per-sco-c01      .
       vis-per-scr-200.
           add       1                    to   w-edt-per-sco-c01      .
           if        w-edt-per-sco-c01    >    5
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-edt-per-sco-per
                                              (w-edt-per-sco-c01)     .
       ...
       vis-per-scr-500.
           ...
           move      14                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-edt-per-sco-edt    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       vis-per-scr-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione campo : Categoria sconto in chiusura         *
      *    *-----------------------------------------------------------*
       acc-cat-scc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cat-scc        to   w-cmn-zcs-001-cod      .
           move      16                   to   w-cmn-zcs-001-lin      .
           move      30                   to   w-cmn-zcs-001-pos      .
           move      16                   to   w-cmn-zcs-001-dln      .
       ...
       acc-cat-scc-110.
           ...
           if        w-cmn-zcs-001-ope    =    "F+"
                     go to acc-cat-scc-115.
           if        w-cmn-zcs-001-ope    =    "AC"
                     go to acc-cat-scc-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cat-scc-115.
           perform   cmn-zcs-001-foi-000  thru cmn-zcs-001-foi-999    .
           go to     acc-cat-scc-110.
       acc-cat-scc-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cat-scc-999.
       acc-cat-scc-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cat-scc          .
       acc-cat-scc-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cat-scc        to   w-let-arc-zcs-cod      .
           perform   let-arc-zcs-000      thru let-arc-zcs-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-zcs-des    to   w-tes-cat-scc-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cat-scc-des-000  thru vis-cat-scc-des-999    .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Categoria sconto chiusura         *
      *    *-----------------------------------------------------------*
       vis-cat-scc-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       vis-cat-scc-des-000.
           ...
           move      16                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-cat-scc-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cat-scc-des-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione campo : Percentuale sconto chiusura          *
      *    *-----------------------------------------------------------*
       acc-per-scc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-per-scc-999.
       acc-per-scc-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-per-scc          .
       acc-per-scc-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Percentuale sc. chiusura          *
      *    *-----------------------------------------------------------*
       vis-per-scc-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-cod-age-sos-000  thru acc-cod-age-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-age-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-cod-age-sos-000  thru vis-cod-age-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-cod-age-sns    not  = zero
      ...
      *                  * Normalizzazione segnale di sostituzione     *
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cod-age-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           move      "BX"                 to   v-ope                  .
           move      w-lpt-cod-age-lin    to   v-lin                  .
           subtract  1                    from v-lin                  .
           move      w-lpt-cod-age-pos    to   v-pos                  .
           subtract  1                    from v-pos                  .
           move      w-lpt-cod-age-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-cod-age-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-cod-age-sos-010.
      ...
      *                  * Visualizzazione valore da sostituire        *
      *                  *---------------------------------------------*
           perform   vis-cod-age-so1-000  thru vis-cod-age-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-cod-age-so2-000  thru vis-cod-age-so2-999    .
       acc-cod-age-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-cod-age-so1-000  thru acc-cod-age-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-age-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-age-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-cod-age-sos-600.
      ...
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-cod-age-so2-000  thru acc-cod-age-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-age-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-age-sos-200.
       acc-cod-age-sos-600.
      *              *-------------------------------------------------*
      *              * Controlli su valori accettati                   *
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-cod-age        =    zero  and
                     w-tes-age-sos        =    zero
                     go to acc-cod-age-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-cod-age        not  = w-tes-age-sos
                     go to acc-cod-age-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-age-sos          .
      *                      *-----------------------------------------*
      *                      * Segnale di sostituzione non effettuata  *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-cod-age-sns      .
      ...
      *                  * Segnale di sostituzione effettuata          *
      *                  *---------------------------------------------*
           if        w-tes-cod-age        not  = zero or
                     w-tes-age-sos        not  = zero
                     move  1              to   w-tes-cod-age-sns      .
       acc-cod-age-sos-900.
      *              *-------------------------------------------------*
      *              * Normalizzazione stato di uscita                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cod-age-sns    =    zero
                     go to vis-cod-age-sos-100
           else      go to vis-cod-age-sos-500.
       vis-cod-age-sos-100.
      *              *-------------------------------------------------*
      *              * Se sostituzione non effettuata                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-age-ope      .
           move      w-tes-cod-age        to   w-cod-mne-age-cod      .
           move      w-lpt-cod-age-lin    to   w-cod-mne-age-lin      .
           move      w-lpt-cod-age-pos    to   w-cod-mne-age-pos      .
           add       16                   to   w-cod-mne-age-pos      .
       ...
       acc-cod-age-so1-110.
           perform   cod-mne-age-cll-000  thru cod-mne-age-cll-999    .
           if        w-cod-mne-age-ope    =    "F+"
                     go to acc-cod-age-so1-115.
           if        w-cod-mne-age-ope    =    "AC"
                     go to acc-cod-age-so1-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-age-so1-115.
           perform   cod-mne-age-foi-000  thru cod-mne-age-foi-999    .
           go to     acc-cod-age-so1-110.
       acc-cod-age-so1-120.
           move      w-cod-mne-age-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-age-ope      .
           move      w-tes-age-sos        to   w-cod-mne-age-cod      .
           move      w-lpt-cod-age-lin    to   w-cod-mne-age-lin      .
           move      w-lpt-cod-age-pos    to   w-cod-mne-age-pos      .
           add       35                   to   w-cod-mne-age-pos      .
           move      zero                 to   w-cod-mne-age-nln      .
           move      zero                 to   w-cod-mne-age-nps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
       ...
       acc-cod-age-so2-110.
           perform   cod-mne-age-cll-000  thru cod-mne-age-cll-999    .
           if        w-cod-mne-age-ope    =    "F+"
                     go to acc-cod-age-so2-115.
           if        w-cod-mne-age-ope    =    "AC"
                     go to acc-cod-age-so2-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-age-so2-115.
           perform   cod-mne-age-foi-000  thru cod-mne-age-foi-999    .
           go to     acc-cod-age-so2-110.
       acc-cod-age-so2-120.
           move      w-cod-mne-age-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-age-so2-999.
       acc-cod-age-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-age-sos          .
       acc-cod-age-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Categoria provvigioni legate al      *
      *    *                      cliente                              *
      *    *-----------------------------------------------------------*
       acc-cat-pvg-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cat-pvg        to   w-cmn-zpv-003-cod      .
           move      20                   to   w-cmn-zpv-003-lin      .
           move      30                   to   w-cmn-zpv-003-pos      .
           move      20                   to   w-cmn-zpv-003-dln      .
           move      41                   to   w-cmn-zpv-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-cat-pvg        not  = w-tes-pvg-sos
                     go to acc-cat-pvg-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-pvg-sos          .
      *                      *-----------------------------------------*
      *                      * Segnale di sostituzione non effettuata  *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-cat-pvg-sns      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zpv-003-ope      .
           move      w-tes-cat-pvg        to   w-cmn-zpv-003-cod      .
           move      w-lpt-cat-pvg-lin    to   w-cmn-zpv-003-lin      .
           move      w-lpt-cat-pvg-pos    to   w-cmn-zpv-003-pos      .
           add       16                   to   w-cmn-zpv-003-pos      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zpv-003-ope      .
           move      w-tes-pvg-sos        to   w-cmn-zpv-003-cod      .
           move      w-lpt-cat-pvg-lin    to   w-cmn-zpv-003-lin      .
           move      w-lpt-cat-pvg-pos    to   w-cmn-zpv-003-pos      .
           add       35                   to   w-cmn-zpv-003-pos      .
           move      zero                 to   w-cmn-zpv-003-dln      .
           move      zero                 to   w-cmn-zpv-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Percentuali di provvigione legate al *
      *    *                      cliente                              *
      *    *-----------------------------------------------------------*
       acc-per-pvg-000.
      *              *-------------------------------------------------*
      ...
      *                  * Codice listino                              *
      *                  *---------------------------------------------*
           perform   acc-rig-lst-000      thru acc-rig-lst-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * Categoria sconto in riga fattura            *
      *                  *---------------------------------------------*
           perform   acc-rig-scr-000      thru acc-rig-scr-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Categoria sconto in chiusura fattura        *
      *                  *---------------------------------------------*
           perform   acc-rig-scc-000      thru acc-rig-scc-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Percentuale sconto in chiusura fattura      *
      *                  *---------------------------------------------*
           perform   acc-rig-psc-000      thru acc-rig-psc-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Codice agente                               *
      *                  *---------------------------------------------*
           perform   acc-rig-age-000      thru acc-rig-age-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Categoria provvigioni                       *
      *                  *---------------------------------------------*
           perform   acc-rig-pvg-000      thru acc-rig-pvg-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-lst        to   w-lin-imm-cod-lst      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Editing Mnemonico agente                    *
      *                  *---------------------------------------------*
           move      w-rig-cod-age-mne    to   w-lin-imm-mne-age      .
       vis-lin-cor-520.
      *                  *---------------------------------------------*
      *                  * Editing Codice categoria provvigioni        *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      05                   to   v-car                  .
      ...
      *              * Codice listino                                  *
      *              *-------------------------------------------------*
           perform   vis-rig-lst-000      thru vis-rig-lst-999        .
           perform   vis-rig-lst-des-000  thru vis-rig-lst-des-999    .
      *              *-------------------------------------------------*
      *              * Codice categoria sconto in riga fattura         *
      *              *-------------------------------------------------*
           perform   vis-rig-scr-000      thru vis-rig-scr-999        .
           perform   vis-rig-scr-des-000  thru vis-rig-scr-des-999    .
      *              *-------------------------------------------------*
      *              * Percentuali sconto in riga fattura              *
      *              *-------------------------------------------------*
      ...
      *              * Codice categoria sconto in chiusura fattura     *
      *              *-------------------------------------------------*
           perform   vis-rig-scc-000      thru vis-rig-scc-999        .
           perform   vis-rig-scc-des-000  thru vis-rig-scc-des-999    .
      *              *-------------------------------------------------*
      *              * Percentuali sconto in chiusura fattura          *
      *              *-------------------------------------------------*
           perform   vis-rig-psc-000      thru vis-rig-psc-999        .
      *              *-------------------------------------------------*
      *              * Codice agente                                   *
      *              *-------------------------------------------------*
           perform   vis-rig-age-000      thru vis-rig-age-999        .
           perform   vis-rig-age-nom-000  thru vis-rig-age-nom-999    .
      *              *-------------------------------------------------*
      *              * Categoria provvigioni                           *
      *              *-------------------------------------------------*
           perform   vis-rig-pvg-000      thru vis-rig-pvg-999        .
           perform   vis-rig-pvg-des-000  thru vis-rig-pvg-des-999    .
      *              *-------------------------------------------------*
      *              * Percentuali di provvigioni                      *
      *              *-------------------------------------------------*
      ...
      *                  * Codice listino                              *
      *                  *---------------------------------------------*
           perform   pmt-rig-lst-000      thru pmt-rig-lst-999        .
      *                  *---------------------------------------------*
      *                  * Codice categoria sconto in riga fattura     *
      *                  *---------------------------------------------*
           perform   pmt-rig-scr-000      thru pmt-rig-scr-999        .
      *                  *---------------------------------------------*
      *                  * Percentuali sconto in riga fattura          *
      *                  *---------------------------------------------*
      ...
      *                  * Codice categoria sconto in chiusura fattura *
      *                  *---------------------------------------------*
           perform   pmt-rig-scc-000      thru pmt-rig-scc-999        .
      *                  *---------------------------------------------*
      *                  * Percentuali sconto in chiusura fattura      *
      *                  *---------------------------------------------*
           perform   pmt-rig-psc-000      thru pmt-rig-psc-999        .
      *                  *---------------------------------------------*
      *                  * Codice agente                               *
      *                  *---------------------------------------------*
           perform   pmt-rig-age-000      thru pmt-rig-age-999        .
      *                  *---------------------------------------------*
      *                  * Categoria provvigioni                       *
      *                  *---------------------------------------------*
           perform   pmt-rig-pvg-000      thru pmt-rig-pvg-999        .
      *                  *---------------------------------------------*
      *                  * Percentuali di provvigioni                  *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Percentuali di provvigioni       *
      *    *-----------------------------------------------------------*
       pmt-rig-ppv-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           if        w-rig-dpz-cli        not  = spaces
                     go to acc-rig-lst-999.
       acc-rig-lst-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-cod-lst-ope      .
           move      w-rig-cod-lst        to   w-cod-cod-lst-cod      .
           move      15                   to   w-cod-cod-lst-lin      .
           move      22                   to   w-cod-cod-lst-pos      .
           move      spaces               to   v-edm                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "INSR"               to   v-pfk (04)             .
       ...
       acc-rig-lst-110.
           perform   cod-cod-zls-cll-000  thru cod-cod-zls-cll-999    .
           if        w-cod-cod-lst-ope    =    "F+"
                     go to acc-rig-lst-115.
           if        w-cod-cod-lst-ope    =    "AC"
                     go to acc-rig-lst-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-lst-115.
           perform   cod-cod-zls-foi-000  thru cod-cod-zls-foi-999    .
           go to     acc-rig-lst-110.
       acc-rig-lst-120.
           move      w-cod-cod-lst-cod    to   v-alf                  .
       acc-rig-lst-150.
      *              *-------------------------------------------------*
      ...
      *                  * Lettura tabella                             *
      *                  *---------------------------------------------*
           move      w-rig-cod-lst        to   w-let-arc-zls-cod      .
           perform   let-arc-zls-000      thru let-arc-zls-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-zls-des    to   w-rig-cod-lst-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-lst-des-000  thru vis-rig-lst-des-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-lst-des-000.
           ...
           move      15                   to   v-lin                  .
           move      33                   to   v-pos                  .
           move      w-rig-cod-lst-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-lst-des-999.
           exit.
      ...
      *                  *---------------------------------------------*
           if        w-rig-dpz-cli        not  = spaces
                     go to acc-rig-scr-999.
       acc-rig-scr-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zcs-002-ope      .
           move      w-rig-cat-scr        to   w-cmn-zcs-002-cod      .
           move      16                   to   w-cmn-zcs-002-lin      .
           move      22                   to   w-cmn-zcs-002-pos      .
           move      16                   to   w-cmn-zcs-002-dln      .
           move      33                   to   w-cmn-zcs-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-rig-scr-110.
           perform   cmn-zcs-002-cll-000  thru cmn-zcs-002-cll-999    .
           if        w-cmn-zcs-002-ope    =    "F+"
                     go to acc-rig-scr-115.
           if        w-cmn-zcs-002-ope    =    "AC"
                     go to acc-rig-scr-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-scr-115.
           perform   cmn-zcs-002-foi-000  thru cmn-zcs-002-foi-999    .
           go to     acc-rig-scr-110.
       acc-rig-scr-120.
           move      w-cmn-zcs-002-cod    to   v-num                  .
       acc-rig-scr-150.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-dpz-cli        not  = spaces
                     go to acc-rig-scc-999.
       acc-rig-scc-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zcs-001-ope      .
           move      w-rig-cat-scc        to   w-cmn-zcs-001-cod      .
           move      18                   to   w-cmn-zcs-001-lin      .
           move      22                   to   w-cmn-zcs-001-pos      .
           move      18                   to   w-cmn-zcs-001-dln      .
           move      33                   to   w-cmn-zcs-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-rig-scc-110.
           perform   cmn-zcs-001-cll-000  thru cmn-zcs-001-cll-999    .
           if        w-cmn-zcs-001-ope    =    "F+"
                     go to acc-rig-scc-115.
           if        w-cmn-zcs-001-ope    =    "AC"
                     go to acc-rig-scc-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-scc-115.
           perform   cmn-zcs-001-foi-000  thru cmn-zcs-001-foi-999    .
           go to     acc-rig-scc-110.
       acc-rig-scc-120.
           move      w-cmn-zcs-001-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *                  *---------------------------------------------*
           move      01                   to   w-let-arc-zcs-tip      .
           move      w-rig-cat-scc        to   w-let-arc-zcs-cod      .
           perform   let-arc-zcs-000      thru let-arc-zcs-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-zcs-des    to   w-rig-cat-scc-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-scc-des-000  thru vis-rig-scc-des-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-scc-des-000.
           ...
           move      18                   to   v-lin                  .
           move      33                   to   v-pos                  .
           move      w-rig-cat-scc-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-scc-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-age-ope      .
           move      w-rig-cod-age        to   w-cod-mne-age-cod      .
           move      20                   to   w-cod-mne-age-lin      .
           move      22                   to   w-cod-mne-age-pos      .
           move      20                   to   w-cod-mne-age-nln      .
           move      33                   to   w-cod-mne-age-nps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-rig-age-110.
           perform   cod-mne-age-cll-000  thru cod-mne-age-cll-999    .
           if        w-cod-mne-age-ope    =    "F+"
                     go to acc-rig-age-115.
           if        w-cod-mne-age-ope    =    "AC"
                     go to acc-rig-age-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-age-115.
           perform   cod-mne-age-foi-000  thru cod-mne-age-foi-999    .
           go to     acc-rig-age-110.
       acc-rig-age-120.
           move      w-cod-mne-age-cod    to   v-num                  .
       acc-rig-age-150.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-age-999.
       acc-rig-age-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-cod-age          .
       acc-rig-age-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura archivio agenti                     *
      *                  *---------------------------------------------*
           move      w-rig-cod-age        to   w-let-arc-age-cod      .
           perform   let-arc-age-000      thru let-arc-age-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione nome agente                  *
      *                  *---------------------------------------------*
           move      w-let-arc-age-nom    to   w-rig-cod-age-nom      .
           move      w-let-arc-age-mne    to   w-rig-cod-age-mne      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-age-nom-000  thru vis-rig-age-nom-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-age-nom-000.
           ...
           move      20                   to   v-lin                  .
           move      33                   to   v-pos                  .
           move      w-rig-cod-age-nom    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-age-nom-999.
           exit.
      ...
      *                  *---------------------------------------------*
           if        w-rig-dpz-cli        not  = spaces
                     go to acc-rig-pvg-999.
       acc-rig-pvg-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zpv-003-ope      .
           move      w-rig-cat-pvg        to   w-cmn-zpv-003-cod      .
           move      21                   to   w-cmn-zpv-003-lin      .
           move      22                   to   w-cmn-zpv-003-pos      .
           move      21                   to   w-cmn-zpv-003-dln      .
           move      33                   to   w-cmn-zpv-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-rig-pvg-110.
           perform   cmn-zpv-003-cll-000  thru cmn-zpv-003-cll-999    .
           if        w-cmn-zpv-003-ope    =    "F+"
                     go to acc-rig-pvg-115.
           if        w-cmn-zpv-003-ope    =    "AC"
                     go to acc-rig-pvg-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-pvg-115.
           perform   cmn-zpv-003-foi-000  thru cmn-zpv-003-foi-999    .
           go to     acc-rig-pvg-110.
       acc-rig-pvg-120.
           move      w-cmn-zpv-003-cod    to   v-num                  .
       acc-rig-pvg-150.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-160.
      *              *-------------------------------------------------*
      *              * Controllo su Codice listino                     *
      *              *-------------------------------------------------*
           if        w-rig-dpz-cli        not  = spaces
                     go to cnt-tdo-rig-170.
           if        w-rig-cod-lst        =    spaces
                     go to cnt-tdo-rig-170.
           move      w-rig-cod-lst        to   w-let-arc-zls-cod      .
           perform   let-arc-zls-000      thru let-arc-zls-999        .
           if        w-let-arc-zls-flg    =    spaces
                     go to cnt-tdo-rig-170.
           move      "Codice Listino non esistente                      
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-170.
      *              *-------------------------------------------------*
      *              * Controllo su Categoria sconto in riga           *
      *              *-------------------------------------------------*
           if        w-rig-dpz-cli        not  = spaces
                     go to cnt-tdo-rig-180.
           if        w-rig-cat-scr        =    zero
                     go to cnt-tdo-rig-180.
           move      02                   to   w-let-arc-zcs-tip      .
           move      w-rig-cat-scr        to   w-let-arc-zcs-cod      .
           perform   let-arc-zcs-000      thru let-arc-zcs-999        .
           if        w-let-arc-zcs-flg    =    spaces
                     go to cnt-tdo-rig-180.
           move      "Categoria Sconto in Riga non esistente            
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-180.
      *              *-------------------------------------------------*
      *              * Controllo su Categoria sconto in chiusura       *
      *              *-------------------------------------------------*
           if        w-rig-dpz-cli        not  = spaces
                     go to cnt-tdo-rig-300.
           if        w-rig-cat-scc        =    zero
                     go to cnt-tdo-rig-300.
           move      01                   to   w-let-arc-zcs-tip      .
           move      w-rig-cat-scc        to   w-let-arc-zcs-cod      .
           perform   let-arc-zcs-000      thru let-arc-zcs-999        .
           if        w-let-arc-zcs-flg    =    spaces
                     go to cnt-tdo-rig-300.
           move      "Categoria Sconto in Chiusura non esistente        
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-rig-cod-age        =    zero
                     go to cnt-tdo-rig-400.
           move      w-rig-cod-age        to   w-let-arc-age-cod      .
           perform   let-arc-age-000      thru let-arc-age-999        .
           if        w-let-arc-age-flg    =    spaces
                     go to cnt-tdo-rig-400.
           move      "Codice Agente non esistente                       
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-400.
      *              *-------------------------------------------------*
      *              * Controllo su Categoria provvigioni legata al    *
      *              * cliente                                         *
      *              *-------------------------------------------------*
           if        w-rig-dpz-cli        not  = spaces
                     go to cnt-tdo-rig-600.
           if        w-rig-cat-pvg        =    zero
                     go to cnt-tdo-rig-600.
           move      03                   to   w-let-arc-zpv-tip      .
           move      w-rig-cat-pvg        to   w-let-arc-zpv-cod      .
           perform   let-arc-zpv-000      thru let-arc-zpv-999        .
           if        w-let-arc-zpv-flg    =    spaces
                     go to cnt-tdo-rig-600.
           move      "Codice Categoria Provvigioni non esistente        
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-600.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      zero                 to   w-rig-cat-scc          .
           move      zero                 to   w-rig-per-scc          .
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-tes-cat-scc          .
           move      spaces               to   w-tes-cat-scc-des      .
           move      zero                 to   w-tes-per-scc          .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      spaces               to   w-rig-cod-lst          .
           move      spaces               to   w-rig-cod-lst-des      .
           move      zero                 to   w-rig-cat-scr          .
           ...
           move      zero                 to   w-rig-per-scr (5)      .
           move      zero                 to   w-rig-cat-scc          .
           move      spaces               to   w-rig-cat-scc-des      .
           move      zero                 to   w-rig-per-scc          .
           move      zero                 to   w-rig-cod-age          .
           move      spaces               to   w-rig-cod-age-nom      .
           move      spaces               to   w-rig-cod-age-mne      .
           move      zero                 to   w-rig-cat-pvg          .
      ...
      *                  * Codice listino                              *
      *                  *---------------------------------------------*
           if        rf-dcc-cod-lst       not  = w-tes-cod-lst
                     go to sel-rec-dcc-900.
       sel-rec-dcc-200.
      *                  *---------------------------------------------*
      *                  * Categoria sconto in riga fattura            *
      *                  *---------------------------------------------*
           if        w-tes-cat-scr        =    zero
                     go to sel-rec-dcc-300.
           if        rf-dcc-cat-scr       not  = w-tes-cat-scr
                     go to sel-rec-dcc-900.
       sel-rec-dcc-300.
      *                  *---------------------------------------------*
      *                  * Percentuali sconto in riga fattura          *
      *                  *---------------------------------------------*
           ...
           if        rf-dcc-per-scr (1)   not  = w-tes-per-scr (1) or
                     rf-dcc-per-scr (2)   not  = w-tes-per-scr (2) or
                     rf-dcc-per-scr (3)   not  = w-tes-per-scr (3) or
                     rf-dcc-per-scr (4)   not  = w-tes-per-scr (4) or
                     rf-dcc-per-scr (5)   not  = w-tes-per-scr (5)
                     go to sel-rec-dcc-900.
       sel-rec-dcc-400.
      *                  *---------------------------------------------*
      *                  * Categoria sconto in chiusura fattura        *
      *                  *---------------------------------------------*
           if        w-tes-cat-scc        =    zero
                     go to sel-rec-dcc-500.
           if        rf-dcc-cat-scc       not  = w-tes-cat-scc
                     go to sel-rec-dcc-900.
       sel-rec-dcc-500.
      *                  *---------------------------------------------*
      *                  * Percentuale sconto in chiusura fattura      *
      *                  *---------------------------------------------*
           if        w-tes-per-scc        =    zero
                     go to sel-rec-dcc-600.
           if        rf-dcc-per-scc       not  = w-tes-per-scc
                     go to sel-rec-dcc-900.
       sel-rec-dcc-600.
      *                  *---------------------------------------------*
      *                  * Codice agente                               *
      *                  *---------------------------------------------*
           if        w-tes-cod-age-sns    =    zero and
                     w-tes-cod-age        =    zero
                     go to sel-rec-dcc-700.
      ...
      *                  *---------------------------------------------*
           if        w-tes-cat-pvg-sns    =    zero and
                     w-tes-cat-pvg        =    zero
                     go to sel-rec-dcc-750.
           if        rf-dcc-cat-pvg       not  = w-tes-cat-pvg
                     go to sel-rec-dcc-900.
       sel-rec-dcc-750.
      *                  *---------------------------------------------*
      *                  * Percentuali di provvigioni                  *
      *                  *---------------------------------------------*
           ...
           if        rf-dcc-per-pvg (1)   not  = w-tes-per-pvg (1) or
                     rf-dcc-per-pvg (2)   not  = w-tes-per-pvg (2) or
                     rf-dcc-per-pvg (3)   not  = w-tes-per-pvg (3)
                     go to sel-rec-dcc-900.
       sel-rec-dcc-800.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcc-cod-lst       to   w-rig-cod-lst          .
           move      rf-dcc-cat-scr       to   w-rig-cat-scr          .
           move      rf-dcc-per-scr (1)   to   w-rig-per-scr (1)      .
           move      rf-dcc-per-scr (2)   to   w-rig-per-scr (2)      .
           move      rf-dcc-per-scr (3)   to   w-rig-per-scr (3)      .
           move      rf-dcc-per-scr (4)   to   w-rig-per-scr (4)      .
           move      rf-dcc-per-scr (5)   to   w-rig-per-scr (5)      .
           move      rf-dcc-cat-scc       to   w-rig-cat-scc          .
           move      rf-dcc-per-scc       to   w-rig-per-scc          .
           move      rf-dcc-cod-age       to   w-rig-cod-age          .
           move      rf-dcc-cat-pvg       to   w-rig-cat-pvg          .
           move      rf-dcc-per-pvg (1)   to   w-rig-per-pvg (1)      .
           move      rf-dcc-per-pvg (2)   to   w-rig-per-pvg (2)      .
           move      rf-dcc-per-pvg (3)   to   w-rig-per-pvg (3)      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Descrizione per codice listino      *
      *                          *-------------------------------------*
           move      w-rig-cod-lst        to   w-let-arc-zls-cod      .
           perform   let-arc-zls-000      thru let-arc-zls-999        .
           move      w-let-arc-zls-des    to   w-rig-cod-lst-des      .
      *                          *-------------------------------------*
      *                          * Descrizione per codice categoria di *
      *                          * sconto in riga                      *
      *                          *-------------------------------------*
           move      02                   to   w-let-arc-zcs-tip      .
           move      w-rig-cat-scr        to   w-let-arc-zcs-cod      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-lst-sos        to   w-rig-cod-lst          .
       car-eff-rig-sos-200.
      *              *-------------------------------------------------*
      *              * Codice agente                                   *
      *              *-------------------------------------------------*
           ...
           move      w-tes-age-sos        to   w-rig-cod-age          .
       car-eff-rig-sos-300.
      *              *-------------------------------------------------*
      *              * Catergoria proviggionale                        *
      *              *-------------------------------------------------*
           if        w-tes-cat-pvg-sns    =    zero
                     go to car-eff-rig-sos-900.
           move      w-tes-pvg-sos        to   w-rig-cat-pvg          .
       car-eff-rig-sos-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-lst-sns    not  = zero or
                     w-tes-cod-age-sns    not  = zero or
                     w-tes-cat-pvg-sns    not  = zero
      ...
      *                      *-----------------------------------------*
           move      w-rig-cod-lst        to   rf-dcc-cod-lst         .
           move      w-rig-cat-scr        to   rf-dcc-cat-scr         .
           move      w-rig-per-scr (1)    to   rf-dcc-per-scr (1)     .
           move      w-rig-per-scr (2)    to   rf-dcc-per-scr (2)     .
           move      w-rig-per-scr (3)    to   rf-dcc-per-scr (3)     .
           move      w-rig-per-scr (4)    to   rf-dcc-per-scr (4)     .
           move      w-rig-per-scr (5)    to   rf-dcc-per-scr (5)     .
           move      w-rig-cat-scc        to   rf-dcc-cat-scc         .
           move      w-rig-per-scc        to   rf-dcc-per-scc         .
           move      w-rig-cod-age        to   rf-dcc-cod-age         .
           move      w-rig-cat-pvg        to   rf-dcc-cat-pvg         .
           move      w-rig-per-pvg (1)    to   rf-dcc-per-pvg (1)     .
           move      w-rig-per-pvg (2)    to   rf-dcc-per-pvg (2)     .
           move      w-rig-per-pvg (3)    to   rf-dcc-per-pvg (3)     .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione della cat. provv. cliente  *
      *    *-----------------------------------------------------------*
