      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcc1521:        *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-zfp-cod      .
           move      14                   to   w-cod-mne-zfp-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zfp-ope      .
           move      rr-cod-max           to   w-cod-mne-zfp-cod      .
           move      14                   to   w-cod-mne-zfp-lin      .
           move      52                   to   w-cod-mne-zfp-pos      .
           move      zero                 to   w-cod-mne-zfp-dln      .
           move      zero                 to   w-cod-mne-zfp-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
