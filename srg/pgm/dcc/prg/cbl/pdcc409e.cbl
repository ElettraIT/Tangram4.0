      ...
      *                       Ultima revisione:    NdK del 27/06/22    *
      *                    ------------------------------------------- *
      ...
      *                    portafoglio                                 *
      *                                                                *
      *                    Sottoprogramma per la stampa dei clienti    *
      *                    con utenze errate :                         *
      *                                                                *
      *                    - Telefono                                  *
      *                    - Fax                                       *
      ...
      *            *---------------------------------------------------*
               10  srt-adc-rag-soc        pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Tipo utenza                                       *
      *            *---------------------------------------------------*
               10  srt-adc-tip-con        pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Utenza                                            *
      *            *---------------------------------------------------*
               10  srt-adc-num-con        pic  x(80)                  .
      *            *---------------------------------------------------*
      *            * Segnale [cli] o [dcc]                             *
      *            *---------------------------------------------------*
               10  srt-adc-cli-dcc        pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     CONTROLLO UTENZE ERRATE CLIENTI    "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Tipo utenza da controllare                            *
      *        *-------------------------------------------------------*
           05  rr-tip-utz                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Tipo separatore                                       *
      *        *-------------------------------------------------------*
           05  rr-tip-sep                 pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo utenza                                *
      *        *-------------------------------------------------------*
           05  w-exp-tip-utz.
               10  w-exp-tip-utz-num      pic  9(02)       value 06   .
               10  w-exp-tip-utz-lun      pic  9(02)       value 40   .
           ...
           05  w-exp-tip-sep.
               ...
               10  w-exp-tip-sep-tbl.
                   15  filler             pic  x(40) value
                            "Con separatore '/'                      ".
                   15  filler             pic  x(40) value
                            "Con uno spazio separatore               ".
                   15  filler             pic  x(40) value
                            "Senza alcun separatore                  ".

      *    *===========================================================*
      *    * Work per routine di sort                                  *
      *    *-----------------------------------------------------------*
       01  w-stp-srt-inp.
      *        *-------------------------------------------------------*
      *        * Flag di uscita da controllo formale utenza            *
      *        *-------------------------------------------------------*
           05  w-stp-srt-inp-flg          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Comodi                                                *
      *        *-------------------------------------------------------*
           05  w-stp-srt-inp-utz          pic  x(80)                  .
           05  w-stp-srt-inp-ctr          pic  9(05)                  .
           05  w-stp-srt-inp-pre          pic  x(05)                  .
           05  w-stp-srt-inp-num          pic  x(10)                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Questo programma seleziona e stampa i clienti per 
      -              "i quali le utenze presentano  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "N.B.: l'asterisco in stampa indica le anagrafiche 
      -              "contabili                     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Tipo utenza                          *
      *    *-----------------------------------------------------------*
       acc-tip-utz-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Eventuale pulizia video                     *
      *                  *---------------------------------------------*
           if        rr-tip-utz           =    01 or
                     rr-tip-utz           =    02 or
                     rr-tip-utz           =    03
                     go to acc-tip-utz-800.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Tipo separatore                      *
      *    *-----------------------------------------------------------*
       acc-tip-sep-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        rr-tip-utz           not  = 01 and
                     rr-tip-utz           not  = 02 and
                     rr-tip-utz           not  = 03
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           move      zero                 to   rr-tip-utz             .
           move      zero                 to   rr-tip-sep             .
       nor-ric-sel-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezione in funzione del tipo utenza           *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-adc-num-con       =    spaces
                     go to stp-srt-inp-200.
           move      rf-adc-num-con       to   w-stp-srt-inp-utz      .
           perform   stp-srt-inp-tel-000  thru stp-srt-inp-tel-999    .
           if        w-stp-srt-inp-flg    =    spaces
                     go to stp-srt-inp-200
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-adc-num-con       =    spaces
                     go to stp-srt-inp-200.
           move      rf-adc-num-con       to   w-stp-srt-inp-utz      .
           perform   stp-srt-inp-eml-000  thru stp-srt-inp-eml-999    .
           if        w-stp-srt-inp-flg    =    spaces
                     go to stp-srt-inp-200
           else      go to stp-srt-inp-600.
       stp-srt-inp-450.
      ...
      *                  * www                                         *
      *                  *---------------------------------------------*
           if        rf-adc-tip-con       not  = "WWW"
                     go to stp-srt-inp-200.
           if        rf-adc-num-con       =    spaces
                     go to stp-srt-inp-200.
           move      rf-adc-num-con       to   w-stp-srt-inp-utz      .
           perform   stp-srt-inp-www-000  thru stp-srt-inp-www-999    .
           if        w-stp-srt-inp-flg    =    spaces
                     go to stp-srt-inp-200
           else      go to stp-srt-inp-600.
       stp-srt-inp-600.
      ...
      *                  *---------------------------------------------*
           if        rf-adc-tip-arc       =    01
                     perform stp-srt-inp-cli-000
                                          thru stp-srt-inp-cli-999
           else if   rf-adc-tip-arc       =    02
                     perform stp-srt-inp-dcc-000
                                          thru stp-srt-inp-dcc-999
      ...
      *    * Input procedure per sort                                  *
      *    *                                                           *
      *    * Controllo formale utenza telefonica, fax e cellulare      *
      *    *-----------------------------------------------------------*
       stp-srt-inp-tel-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di uscita                  *
      *              *-------------------------------------------------*
           move      spaces               to   w-stp-srt-inp-flg      .
       stp-srt-inp-tel-200.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo separatore      *
      *              *-------------------------------------------------*
           if        rr-tip-sep           =    01
                     go to stp-srt-inp-tel-300
           else if   rr-tip-sep           =    02
                     go to stp-srt-inp-tel-400
           else if   rr-tip-sep           =    03
                     go to stp-srt-inp-tel-500
           else      go to stp-srt-inp-tel-800.
       stp-srt-inp-tel-300.
      *              *-------------------------------------------------*
      *              * Con separatore '/'                              *
      *              *-------------------------------------------------*
           move      zero                 to   w-stp-srt-inp-ctr      .
           inspect   w-stp-srt-inp-utz
                                    tallying   w-stp-srt-inp-ctr
                                          for  all "/"                .
           if        w-stp-srt-inp-ctr    =    1
                     go to stp-srt-inp-tel-800
           else      go to stp-srt-inp-tel-900.
       stp-srt-inp-tel-400.
      *              *-------------------------------------------------*
      *              * Con separatore ' '                              *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-stp-srt-inp-ctr      .
           move      spaces               to   w-stp-srt-inp-pre      .
           unstring  w-stp-srt-inp-utz
                                delimited by " "
                                          into w-stp-srt-inp-pre
                                    count in   w-stp-srt-inp-ctr      .
           add       2                    to   w-stp-srt-inp-ctr      .
           move      spaces               to   w-stp-srt-inp-num      .
           unstring  w-stp-srt-inp-utz    into w-stp-srt-inp-num
                                  with pointer w-stp-srt-inp-ctr      .
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-stp-srt-inp-pre    not  = spaces and
                     w-stp-srt-inp-pre    not  = spaces
                     go to stp-srt-inp-tel-800
           else      go to stp-srt-inp-tel-900.
       stp-srt-inp-tel-500.
      *              *-------------------------------------------------*
      *              * Senza separatore                                *
      *              *-------------------------------------------------*
           move      w-stp-srt-inp-utz    to   w-all-str-alf          .
      ...
      *    * Input procedure per sort                                  *
      *    *                                                           *
      *    * Controllo formale indirizzo e-mail                        *
      *    *-----------------------------------------------------------*
       stp-srt-inp-eml-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di uscita                  *
      ...
      *              *-------------------------------------------------*
           ...
           inspect   w-stp-srt-inp-utz
                                    tallying   w-stp-srt-inp-ctr
                                          for  all "@"                .
           if        w-stp-srt-inp-ctr    =    1
                     go to stp-srt-inp-eml-200
           else      go to stp-srt-inp-eml-900.
       stp-srt-inp-eml-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           inspect   w-stp-srt-inp-utz
                                    tallying   w-stp-srt-inp-ctr
                                          for  all "."                .
           if        w-stp-srt-inp-ctr    >    zero
                     go to stp-srt-inp-eml-300
           else      go to stp-srt-inp-eml-900.
       stp-srt-inp-eml-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        =    spaces
                     go to stp-srt-inp-eml-800
           else      go to stp-srt-inp-eml-900.
       stp-srt-inp-eml-800.
      *              *-------------------------------------------------*
      *              * Uscita per selezione superata                   *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-eml-999.
       stp-srt-inp-eml-900.
      *              *-------------------------------------------------*
      *              * Uscita per selezione superata                   *
      *              *-------------------------------------------------*
      ...
      *    * Input procedure per sort                                  *
      *    *                                                           *
      *    * Controllo formale indirizzo www                           *
      *    *-----------------------------------------------------------*
       stp-srt-inp-www-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di uscita                  *
      ...
      *              *-------------------------------------------------*
           ...
           inspect   w-stp-srt-inp-utz
                                    tallying   w-stp-srt-inp-ctr
                                          for  all "@"                .
           if        w-stp-srt-inp-ctr    =    zero
                     go to stp-srt-inp-www-200
           else      go to stp-srt-inp-www-900.
       stp-srt-inp-www-200.
      *              *-------------------------------------------------*
      *              * Che contenga almeno 2 '.'                       *
      *              *-------------------------------------------------*
           move      zero                 to   w-stp-srt-inp-ctr      .
           inspect   w-stp-srt-inp-utz
                                    tallying   w-stp-srt-inp-ctr
      ...
      *              *-------------------------------------------------*
           ...
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        =    spaces
                     go to stp-srt-inp-www-800
           else      go to stp-srt-inp-www-900.
       stp-srt-inp-www-800.
      *              *-------------------------------------------------*
      *              * Uscita per selezione superata                   *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-www-999.
       stp-srt-inp-www-900.
      *              *-------------------------------------------------*
      *              * Uscita per selezione superata                   *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-adc-cod-arc       to   srt-cod-cli            .
           move      spaces               to   srt-dpz-cli            .
           move      rf-cli-rag-soc       to   srt-adc-rag-soc        .
           move      rf-adc-tip-con       to   srt-adc-tip-con        .
           move      rf-adc-num-con       to   srt-adc-num-con        .
           move      "*"                  to   srt-adc-cli-dcc        .
       stp-srt-inp-cli-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   srt-rec                .
           move      rf-adc-cod-arc       to   srt-cod-cli            .
           move      rf-adc-dpz-arc       to   srt-dpz-cli            .
           move      rf-dcc-rag-soc       to   srt-adc-rag-soc        .
           move      rf-adc-tip-con       to   srt-adc-tip-con        .
           move      rf-adc-num-con       to   srt-adc-num-con        .
           move      " "                  to   srt-adc-cli-dcc        .
       stp-srt-inp-dcc-900.
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun cliente con utenze errate da segnalare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      057                  to   p-pos                  .
           move      srt-adc-num-con      to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-400.
      *              *-------------------------------------------------*
      *              * Eventuale seguito utenza                        *
      *              *-------------------------------------------------*
           if        srt-adc-num-con
                    (41 : 40)             =    spaces
                     go to prn-liv-det-999.
      ...
      *              *-------------------------------------------------*
           go to     int-pag-sta-010
                     ...
                     depending   on rr-tip-utz.
       int-pag-sta-010.
           move      "CLIENTI CON NUMERO TELEFONO NON CORRETTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-020.
           move      "CLIENTI CON NUMERO FAX NON CORRETTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-030.
           move      "CLIENTI CON NUMERO CELLULARE NON CORRETTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-040.
           move      "CLIENTI CON INDIRIZZO E-MAIL NON CORRETTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-050.
           move      "CLIENTI CON INDIRIZZO PEC NON CORRETTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-060.
           move      "CLIENTI CON INDIRIZZO WWW NON CORRETTO"
                                          to   w-cnt-tit-des-tit      .
           go to     int-pag-sta-090.
       int-pag-sta-090.
           move      "DT"                 to   s-ope                  .
