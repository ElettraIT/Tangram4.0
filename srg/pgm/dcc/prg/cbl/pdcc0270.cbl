      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcc0271:        *
      *                                                                *
      *                    Stampa cambi valute                         *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
      *            * Per routine cnf-exe-pgm-000                       *
      *            *---------------------------------------------------*
               10  w-cnt-cnf-exe-pgm      pic  x(01)                  .
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * A test su flag di Si/no stampa                  *
      *              *-------------------------------------------------*
           go to     main-350.
       main-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   cnf-exe-pgm-000      thru cnf-exe-pgm-999        .
      *                  *---------------------------------------------*
      *                  * Se Exit da conferma esecuzione programma    *
      *                  *---------------------------------------------*
           if        w-cnt-cnf-exe-pgm    not  = spaces
                     go to main-750.
       main-350.
      *              *-------------------------------------------------*
      ...
      *              * Normalizzazione status di uscita                *
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-cnf-exe-pgm      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "MX"                 to   v-ope                  .
           move      "U"                  to   v-tip                  .
           move      "Conferma esecuzione programma (S/E) ?"
                                          to   v-not                  .
           move      "S"                  to   v-alf                  .
           move      "SE"                 to   v-msk                  .
           move      "DO  "               to   v-pfk (05)             .
      ...
      *                  *---------------------------------------------*
           if        v-key                =    "DO  "
                     go to cnf-exe-pgm-300
           else if   v-key                =    "EXIT"
                     go to cnf-exe-pgm-400
           else      go to cnf-exe-pgm-100.
       cnf-exe-pgm-300.
      *                  *---------------------------------------------*
      *                  * Se Do                                       *
      *                  *---------------------------------------------*
           go to     cnf-exe-pgm-999.
       cnf-exe-pgm-400.
      *                  *---------------------------------------------*
      *                  * Se Exit                                     *
      *                  *---------------------------------------------*
           move      "#"                  to   w-cnt-cnf-exe-pgm      .
           go to     cnf-exe-pgm-999.
       cnf-exe-pgm-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data rilevamento                     *
      *    *-----------------------------------------------------------*
       acc-dat-vlt-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      rr-dat-vlt           to   w-def-dat-vlt          .
       acc-dat-vlt-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Data rilevamento                  *
      *    *-----------------------------------------------------------*
       vis-dat-vlt-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-sgl-vlt           =    spaces
                     move  "Tutte"        to   rr-sgl-vlt-des
           else      move  w-let-arc-zvl-des
                                          to   rr-sgl-vlt-des         .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Se valuta base : reimpostazione             *
      *                  *---------------------------------------------*
           if        rr-sgl-vlt           =    spaces
                     go to acc-sgl-vlt-600.
           if        rr-sgl-vlt           not  = c-sgl
                     go to acc-sgl-vlt-600.
      *                      *-----------------------------------------*
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
           move      "Valuta base non trattata dal programma !        "
