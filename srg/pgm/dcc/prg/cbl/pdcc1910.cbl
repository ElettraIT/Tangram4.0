      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella spese incasso        *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-zin-cod-spi       to   w-rot-l01-cod-spi      .
           move      rf-zin-des-spi       to   w-wrk-des-spi          .
       qry-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-zin-tip-pag       =    1
                     move  "Rimessa diretta               "
                                          to   v-alf
           else if   rf-zin-tip-pag       =    2
                     move  "Incasso elettronico           "
                                          to   v-alf
           else if   rf-zin-tip-pag       =    3
                     move  "Ri.Ba.                        "
                                          to   v-alf
           else if   rf-zin-tip-pag       =    4
                     move  "C.d.O. - Conferma d'ordine    "
                                          to   v-alf
           else if   rf-zin-tip-pag       =    5
                     move  "Mav - Mediante avviso         "
                                          to   v-alf
           else if   rf-zin-tip-pag       =    6
                     move  "Rid - Accr. preautoriz. in c/ "
                                          to   v-alf
           else if   rf-zin-tip-pag       =    7
                     move  "Bonifico bancario             "
                                          to   v-alf
           else if   rf-zin-tip-pag       =    8
                     move  "Conto corrente postale        "
                                          to   v-alf
           else if   rf-zin-tip-pag       =    9
                     move  "Ricevuta bancaria             "
                                          to   v-alf
           else if   rf-zin-tip-pag       =    10
                     move  "Tratta                        "
                                          to   v-alf
           else if   rf-zin-tip-pag       =    11
                     move  "Paghero'                      "
                                          to   v-alf
           else      move  all "."        to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zin-cod-spi       to   w-mpn-cod-spi          .
           move      rf-zin-tip-pag       to   w-mpn-tip-pag          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
