      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcc1471:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella codici marketing clienti   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zkc-001-cod      .
           move      14                   to   w-cmn-zkc-001-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zkc-001-ope      .
           move      rr-cod-max           to   w-cmn-zkc-001-cod      .
           move      14                   to   w-cmn-zkc-001-lin      .
           move      52                   to   w-cmn-zkc-001-pos      .
           move      zero                 to   w-cmn-zkc-001-dln      .
           move      zero                 to   w-cmn-zkc-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
