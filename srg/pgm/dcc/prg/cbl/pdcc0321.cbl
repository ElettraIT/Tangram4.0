      ...
      *                       Ultima revisione:    NdK del 13/11/07    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcc0320  *
      *                                                                *
      *                    Stampa tipi spese per fatturazione          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     TIPI DI SPESA PER FATTURAZIONE     "       .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun tipo spesa entro i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zsf]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcc/fls/ioc/obj/iofzsf"
                                          to   s-pat                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      108                  to   p-pos                  .
           move      rf-zsf-ibt-spe       to   p-alf                  .
           if        rf-zsf-ibl-spe       not  = 03
      ...
      *              *-------------------------------------------------*
           move      "TIPI DI SPESA PER FATTURAZIONE"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "N.  Lng     Descrizione estesa     Descriz. ridott
      -              "a           Descrizione per stampa           F   %
      -              "    Imponibile      Importo     "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "F = Tipo funzionamento spesa  1 = A percentuale fi
      -              "ssa             I = Imponibile per % spesa   01 = 
      -              "Totale lordo                    "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
