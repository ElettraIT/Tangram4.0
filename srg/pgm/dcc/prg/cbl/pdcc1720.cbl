      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcc1721:        *
      *                                                                *
      *                    Stampa categorie sconto in riga documento   *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Link-area per accettazione categorie sconto in riga doc.  *
      *    *-----------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Open modulo accettazione cat. sc. in riga doc.  *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       rou-cls-fls-000.
      *              *-------------------------------------------------*
      *              * Close modulo accettazione cat. sc. in riga doc. *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella sconti in riga documento"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zcs-002-cod      .
           move      14                   to   w-cmn-zcs-002-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zcs-002-ope      .
           move      rr-cod-max           to   w-cmn-zcs-002-cod      .
           move      14                   to   w-cmn-zcs-002-lin      .
           move      52                   to   w-cmn-zcs-002-pos      .
           move      zero                 to   w-cmn-zcs-002-dln      .
           move      zero                 to   w-cmn-zcs-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
      *              * Forzatura del tipo classificatore a : 02        *
      *              *-------------------------------------------------*
           move      02                   to   rr-tip-csc             .
       reg-ric-sel-999.
           exit.
