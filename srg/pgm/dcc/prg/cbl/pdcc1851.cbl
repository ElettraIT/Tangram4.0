      ...
      *                       Ultima revisione:    NdK del 02/02/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcc185   *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Descrizione prima categoria di sconto             *
      *            *---------------------------------------------------*
               10  srt-des-1cs            pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Codice prima categoria di sconto                  *
      *            *---------------------------------------------------*
               10  srt-cod-1cs            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Descrizione seconda categoria di sconto           *
      *            *---------------------------------------------------*
               10  srt-des-2cs            pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Codice seconda categoria di sconto                *
      *            *---------------------------------------------------*
               10  srt-cod-2cs            pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      ...
      *              *-------------------------------------------------*
           if        rr-tip-ord           =    "C"
                     move  w-let-arc-dcc-rag
                                          to   srt-des-1cs
                     move  rf-zsx-cod-uno to   srt-cod-1cs
______*              move  w-let-arc-zcs-des
                     move  spaces         to   srt-des-2cs
                     move  rf-zsx-cod-due to   srt-cod-2cs
______*    else      move  w-let-arc-zcs-des
           else      move  spaces         to   srt-des-1cs
                     move  rf-zsx-cod-due to   srt-cod-1cs

                     move  w-let-arc-dcc-rag
                                          to   srt-des-2cs
                     move  rf-zsx-cod-uno to   srt-cod-2cs            .
           move      w-let-arc-dcc-rag    to   srt-rag-cli            .
           move      w-let-arc-zcs-des    to   srt-des-csc            .
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      srt-cod-1cs          to   w-rot-l01-cod-1cs      .
       prn-cmp-rot-999.
           exit.
      ...
      *                          *-------------------------------------*
       ...
       prn-ini-lr1-600.
      *                      *-----------------------------------------*
      *                      * Tipo ordinamento : per categoria pro-   *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * 1. linea                            *
      ...
      *              *-------------------------------------------------*
           if        rr-tip-ord           =    "C"
                     move  "SCONTI INCROCIATI IN RIGA FATTURA PER CLIENT
      -                    "E/CATEGORIA PRODOTTO"
                                          to   w-cnt-tit-des-tit
           else      move  "SCONTI INCROCIATI IN RIGA FATTURA PER CATEGO
      -                    "RIA PRODOTTO/CLIENTE"
                                          to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
