      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella Tipi spese per fat-  *
      *                    turazione                                   *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun Codice tipo spesa entro i limiti assegnati 
      -              "!"                  to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      41                   to   v-pos                  .
           move      rf-zsf-des-stp       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zsf-num-spf       to   w-mpn-num-spf          .
           move      rf-zsf-cod-lng       to   w-mpn-cod-lng          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'num-spf'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
