      ...
      *                                   Fase:    dcc450              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 24/01/01    *
      ...
      *            *---------------------------------------------------*
               ...
               10  w-tes-sta-tuc-rag      pic  x(40)                  .
               10  w-tes-sta-tuc-via      pic  x(40)                  .
               10  w-tes-sta-tuc-loc      pic  x(40)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-sta-tuc-rag      pic  x(40)                  .
               10  w-rig-sta-tuc-via      pic  x(40)                  .
               10  w-rig-sta-tuc-loc      pic  x(40)                  .
      ...
      *        * Status commerciale                                    *
      *        *-------------------------------------------------------*
           05  w-sav-rig-tus              pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Codice cliente di riferimento                         *
      *        *-------------------------------------------------------*
           05  w-sav-rig-tuc              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Modalita' di trattamento nelle ststistiche per i      *
      *        * documenti relativi al nuovo status                    *
      *        *-------------------------------------------------------*
           05  w-sav-rig-tux              pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Status commerciale del cliente selezione   *
      *        *-------------------------------------------------------*
           05  w-exp-sta-tus.
               10  w-exp-sta-tus-num      pic  9(02)       value 11   .
               ...
               10  w-exp-sta-tus-tbl.
                   ...
                   15  filler             pic  x(40) value
                           "Normale                                 " .
                   15  filler             pic  x(40) value
                           "Normale, ma non entra in statistiche    " .
                   15  filler             pic  x(40) value
                   ...
                   15  filler             pic  x(40) value
                           "Cessata attivita'                       " .
                   15  filler             pic  x(40) value
                           "Cessata attivita, ma sost. da nuovo cli." .
                   15  filler             pic  x(40) value
                           "In contenzioso                          " .
                   15  filler             pic  x(40) value
                           "In contenzioso, ma sost. da nuovo cli.  " .
                   15  filler             pic  x(40) value
                           "Fallito                                 " .
                   15  filler             pic  x(40) value
                           "Fallito, ma sostituito da nuovo cliente " .
      *        *-------------------------------------------------------*
      *        * Work per : Status commerciale del cliente per righe   *
      *        *-------------------------------------------------------*
           05  w-exp-rig-tus.
               10  w-exp-rig-tus-num      pic  9(02)       value 10   .
               10  w-exp-rig-tus-lun      pic  9(02)       value 40   .
               10  w-exp-rig-tus-tbl.
                   15  filler             pic  x(40) value
                           "Normale                                 " .
                   15  filler             pic  x(40) value
                           "Normale, ma non entra in statistiche    " .
                   ...
                   15  filler             pic  x(40) value
                           "Fallito, ma sostituito da nuovo cliente " .
      *        *-------------------------------------------------------*
      *        * Work per : Modalita' di trattamento nelle statistiche *
      *        *            per la selezione                           *
      *        *-------------------------------------------------------*
           05  w-exp-sta-tux.
               10  w-exp-sta-tux-num      pic  9(02)       value 4    .
               ...
               10  w-exp-sta-tux-tbl.
                   ...
                   15  filler             pic  x(40) value
                           "Statistiche girate sul ns. nuovo cliente" .
                   15  filler             pic  x(40) value
                           "Statistiche su nuovo cliente con dipend." .
      *        *-------------------------------------------------------*
      *        * Work per : Modalita' di trattamento nelle statistiche *
      *        *-------------------------------------------------------*
           05  w-exp-rig-tux.
               10  w-exp-rig-tux-num      pic  9(02)       value 3    .
               10  w-exp-rig-tux-lun      pic  9(02)       value 40   .
               10  w-exp-rig-tux-tbl.
                   15  filler             pic  x(40) value
                           "Statistiche distinte                    " .
                   15  filler             pic  x(40) value
                           "Statistiche girate sul ns. nuovo cliente" .
      ...
      *              *-------------------------------------------------*
           ...
           perform   vis-sta-tuc-rag-000  thru vis-sta-tuc-rag-999    .
      *              *-------------------------------------------------*
      *              * Modalita' di trattamento statistiche            *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice cliente di riferimento    *
      *    *-----------------------------------------------------------*
       pmt-sta-tuc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Eventuale default                           *
      *                  *---------------------------------------------*
           if        w-tes-sta-tus        =    zero
                     move  99             to   w-tes-sta-tus          .
       acc-sta-tus-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *
           if        w-tes-sta-tus        =    99
                     ...
                     move  07             to   v-num
           else if   w-tes-sta-tus        =    61
                     move  08             to   v-num
           else if   w-tes-sta-tus        =    62
                     move  09             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  01             to   w-tes-sta-tus
           else if   v-num                =    03
                     move  09             to   w-tes-sta-tus
           else if   v-num                =    04
                     move  11             to   w-tes-sta-tus
           else if   v-num                =    05
                     move  21             to   w-tes-sta-tus
           else if   v-num                =    06
                     move  51             to   w-tes-sta-tus
           else if   v-num                =    07
                     move  52             to   w-tes-sta-tus
           else if   v-num                =    08
                     move  61             to   w-tes-sta-tus
           else if   v-num                =    09
                     move  62             to   w-tes-sta-tus
           else if   v-num                =    10
                     move  71             to   w-tes-sta-tus
           else if   v-num                =    11
                     move  72             to   w-tes-sta-tus
           else      move zero            to   w-tes-sta-tus          .
       acc-sta-tus-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Codice cliente di riferi-    *
      *    *                              mento                        *
      *    *-----------------------------------------------------------*
       acc-sta-tuc-000.
      *              *-------------------------------------------------*
      ...
      *                  * Lettura file [cli]                          *
      *                  *---------------------------------------------*
           move      w-tes-sta-tuc        to   w-let-arc-cli-cod      .
           perform   let-arc-cli-000      thru let-arc-cli-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione ragione sociale              *
      *                  *---------------------------------------------*
           move      w-let-arc-cli-rag    to   w-tes-sta-tuc-rag      .
           move      w-let-arc-cli-via    to   w-tes-sta-tuc-via      .
           move      w-let-arc-cli-loc    to   w-tes-sta-tuc-loc      .
       acc-sta-tuc-420.
      *                  *---------------------------------------------*
      ...
      *                  * Se codice a zero                            *
      *                  *---------------------------------------------*
           if        w-tes-sta-tuc        not  = zero
                     go to acc-sta-tuc-450.
       acc-sta-tuc-444.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-tes-sta-tuc        =    w-sav-sta-tuc
                     go to acc-sta-tuc-455
           else      go to acc-sta-tuc-480.
       acc-sta-tuc-455.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-tes-sta-tuc        to   w-let-arc-dcc-cod      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Codice cliente di riferi- *
      *    *                                 mento                     *
      *    *-----------------------------------------------------------*
       vis-sta-tuc-000.
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      14                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-sta-tuc-rag    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Indirizzo                                       *
      *              *-------------------------------------------------*
           ...
           move      15                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-sta-tuc-via    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Localita'                                       *
      *              *-------------------------------------------------*
           ...
           move      16                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-sta-tuc-loc    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-sta-tuc-rag-999.
           exit.
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-tes-sta-tux        to   w-sav-sta-tux          .
      *                  *---------------------------------------------*
      *                  * Preparazione eventuale default              *
      *                  *---------------------------------------------*
           if        w-tes-sta-tux        not  = zero
                     go to acc-sta-tux-100.
           move      99                   to   w-tes-sta-tux          .
       acc-sta-tux-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *
           if        w-tes-sta-tux        =    99
                     move  01             to   v-num
           else if   w-tes-sta-tux        =    01
                     move  02             to   v-num
           else if   w-tes-sta-tux        =    02
                     move  03             to   v-num
           else if   w-tes-sta-tux        =    03
                     move  04             to   v-num
           else      move  zero           to   v-num                  .
      *
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  01             to   w-tes-sta-tux
           else if   v-num                =    03
                     move  02             to   w-tes-sta-tux
           else if   v-num                =    04
                     move  03             to   w-tes-sta-tux
           else      move  99             to   w-tes-sta-tux          .
       acc-sta-tux-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Data determinazione status                  *
      *                  *---------------------------------------------*
           perform   acc-rig-tud-000      thru acc-rig-tud-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Codice cliente di riferimento               *
      *                  *---------------------------------------------*
           perform   acc-rig-tuc-000      thru acc-rig-tuc-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Modalita' di trattamento statistiche        *
      *                  *---------------------------------------------*
           perform   acc-rig-tux-000      thru acc-rig-tux-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                      *-----------------------------------------*
       ...
       vis-lin-cor-480.
      *                  *---------------------------------------------*
      *                  * Editing status cliente                      *
      *                  *---------------------------------------------*
           if        w-rig-sta-tus        =    01
                     move  "Normale               "
                                          to   w-lin-imm-sta-tus
           else if   w-rig-sta-tus        =    09
                     move  "Normale (no SVF)      "
                                          to   w-lin-imm-sta-tus
           else if   w-rig-sta-tus        =    11
                     move  "Esauriti i rapporti   "
                                          to   w-lin-imm-sta-tus
           else if   w-rig-sta-tus        =    21
                     move  "Sostituito da cliente "
                                          to   w-lin-imm-sta-tus
           else if   w-rig-sta-tus        =    51
                     move  "Cessata attivita'     "
                                          to   w-lin-imm-sta-tus
           else if   w-rig-sta-tus        =    52
                     move  "Cessata attiv. - sost."
                                          to   w-lin-imm-sta-tus
           else if   w-rig-sta-tus        =    61
                     move  "In contenzioso        "
                                          to   w-lin-imm-sta-tus
           else if   w-rig-sta-tus        =    62
                     move  "In contenzioso - sost."
                                          to   w-lin-imm-sta-tus
      ...
      *                  * Data determinazione status                  *
      *                  *---------------------------------------------*
           perform   vis-rig-tud-000      thru vis-rig-tud-999        .
      *                  *---------------------------------------------*
      *                  * Codice cliente di riferimento               *
      *                  *---------------------------------------------*
           perform   vis-rig-tuc-000      thru vis-rig-tuc-999        .
           perform   vis-rig-tuc-rag-000  thru vis-rig-tuc-rag-999    .
      *                  *---------------------------------------------*
      *                  * Modalita' di trattamento statistiche        *
      *                  *---------------------------------------------*
           perform   vis-rig-tux-000      thru vis-rig-tux-999        .
       vis-rig-cor-999.
           exit.
      ...
      *                  * Data determinazione status                  *
      *                  *---------------------------------------------*
           perform   pmt-rig-tud-000      thru pmt-rig-tud-999        .
      *                  *---------------------------------------------*
      *                  * Codice cliente di riferimento               *
      *                  *---------------------------------------------*
           perform   pmt-rig-tuc-000      thru pmt-rig-tuc-999        .
      *                  *---------------------------------------------*
      *                  * Modalita' di trattamento statistiche        *
      *                  *---------------------------------------------*
           perform   pmt-rig-tux-000      thru pmt-rig-tux-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Modalita' trattam. statistiche   *
      *    *-----------------------------------------------------------*
       pmt-rig-tux-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-sta-tus        to   w-sav-rig-tus          .
       acc-rig-tus-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-rig-tus-lun    to   v-car                  .
           move      w-exp-rig-tus-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      18                   to   v-lin                  .
           move      22                   to   v-pos                  .
           move      w-exp-rig-tus-tbl    to   v-txt                  .
      *
           if        w-rig-sta-tus        =    01
                     move  01             to   v-num
           else if   w-rig-sta-tus        =    09
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  61             to   w-rig-sta-tus    
           else if   v-num                =    08
                     move  62             to   w-rig-sta-tus    
           else if   v-num                =    09
      ...
      *                  *---------------------------------------------*
           ...
           if        w-rig-sta-tus        =    21  or
                     ...
                     go to acc-rig-tus-650.
      *                  *---------------------------------------------*
      *                  * Normalizzazione cliente di riferimento      *
      *                  *---------------------------------------------*
           move      zero                 to   w-rig-sta-tuc          .
           move      spaces               to   w-rig-sta-tuc-rag      .
           move      spaces               to   w-rig-sta-tuc-via      .
           move      spaces               to   w-rig-sta-tuc-loc      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Visualizzazione cliente di riferimento      *
      *                  *---------------------------------------------*
           perform   vis-rig-tuc-000      thru vis-rig-tuc-999        .
           perform   vis-rig-tuc-rag-000  thru vis-rig-tuc-rag-999    .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-sta-tus        =    01
                     go to acc-rig-tud-999.
      *                  *---------------------------------------------*
      *                  * Preparazione eventuale default              *
      *                  *---------------------------------------------*
           if        w-rig-sta-tud        not  = zero
                     go to acc-rig-tud-100.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-sta-tus        not  = 21  and
                     ...
                     w-rig-sta-tus        not  = 62  and
                     w-rig-sta-tus        not  = 72
                     go to acc-rig-tuc-999.
       acc-rig-tuc-100.
      *              *-------------------------------------------------*
      *              * Salvataggio valore precedente                   *
      *              *-------------------------------------------------*
           move      w-rig-sta-tuc        to   w-sav-rig-tuc          .
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-dcc-ope      .
           move      w-rig-sta-tuc        to   w-cod-mne-dcc-cod      .
       ...
       acc-rig-tuc-110.
           perform   cod-mne-dcc-cll-000  thru cod-mne-dcc-cll-999    .
           if        w-cod-mne-dcc-ope    =    "F+"
                     go to acc-rig-tuc-115.
           if        w-cod-mne-dcc-ope    =    "AC"
                     go to acc-rig-tuc-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-tuc-115.
           perform   cod-mne-dcc-foi-000  thru cod-mne-dcc-foi-999    .
           go to     acc-rig-tuc-110.
       acc-rig-tuc-120.
           move      w-cod-mne-dcc-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *                  * Lettura file [cli]                          *
      *                  *---------------------------------------------*
           move      w-rig-sta-tuc        to   w-let-arc-cli-cod      .
           perform   let-arc-cli-000      thru let-arc-cli-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione ragione sociale              *
      *                  *---------------------------------------------*
           move      w-let-arc-cli-rag    to   w-rig-sta-tuc-rag      .
           move      w-let-arc-cli-via    to   w-rig-sta-tuc-via      .
           move      w-let-arc-cli-loc    to   w-rig-sta-tuc-loc      .
       acc-rig-tuc-420.
      *                  *---------------------------------------------*
      *                  * Visualizzazione ragione sociale da anagra-  *
      *                  * fica contabile                              *
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-cli-flg    =    spaces
                     go to acc-rig-tuc-440.
       acc-rig-tuc-434.
      *                      *-----------------------------------------*
      *                      * A reimpostazione                        *
      *                      *-----------------------------------------*
           go to     acc-rig-tuc-100.
       acc-rig-tuc-440.
      *                  *---------------------------------------------*
      *                  * Se codice a zero                            *
      *                  *---------------------------------------------*
           if        w-rig-sta-tuc        not  = zero
                     go to acc-rig-tuc-450.
       acc-rig-tuc-444.
      *                      *-----------------------------------------*
      *                      * A dipendenze dall'impostazione          *
      *                      *-----------------------------------------*
           go to     acc-rig-tuc-600.
       acc-rig-tuc-450.
      *                  *---------------------------------------------*
      *                  * Se codice diverso da zero                   *
      *                  *---------------------------------------------*
      ...
      *                      * il valore precedente                    *
      *                      *-----------------------------------------*
           if        w-rig-sta-tuc        =    w-sav-rig-tuc
                     go to acc-rig-tuc-455
           else      go to acc-rig-tuc-480.
       acc-rig-tuc-455.
      *                      *-----------------------------------------*
      *                      * Se valore impostato pari al valore pre- *
      *                      * cedente                                 *
      ...
      *                          *-------------------------------------*
           move      "C"                  to   w-let-arc-dcc-tle      .
           move      w-rig-sta-tuc        to   w-let-arc-dcc-cod      .
           move      spaces               to   w-let-arc-dcc-dpz      .
           perform   let-arc-dcc-000      thru let-arc-dcc-999        .
      *                          *-------------------------------------*
      *                          * Deviazione a seconda dell'esito     *
      ...
      *                              * Riaggancio                      *
      *                              *---------------------------------*
           go to     acc-rig-tuc-457.
       acc-rig-tuc-500.
      *                      *-----------------------------------------*
      *                      * Controllo che il codice cliente impo-   *
      *                      * stato non sia pari a quello di testata  *
      *                      *-----------------------------------------*
           if        w-rig-sta-tuc        =    w-rig-cod-cli
                     go to acc-rig-tuc-100.
       acc-rig-tuc-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      ...
      *                  * Test se campo da accettare                  *
      *                  *                                             *
      *                  * Solo se cliente di riferimento diverso da   *
      *                  * zero                                        *
      *                  *---------------------------------------------*
           if        w-rig-sta-tuc        =    zero
                     go to acc-rig-tux-999.
      *                  *---------------------------------------------*
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-sta-tux        to   w-sav-rig-tux          .
      *                  *---------------------------------------------*
      *                  * Preparazione eventuale default              *
      *                  *---------------------------------------------*
           if        w-rig-sta-tux        not  = zero
                     go to acc-rig-tux-100.
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-rig-tux-lun    to   v-car                  .
           move      w-exp-rig-tux-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      21                   to   v-lin                  .
           move      22                   to   v-pos                  .
           move      w-exp-rig-tux-tbl    to   v-txt                  .
      ...
      *                  *---------------------------------------------*
           if        w-rig-sta-tux        not  = zero
                     go to acc-rig-tux-600.
           if        v-key                not  = "UP  "
                     go to acc-rig-tux-100.
           if        w-sav-rig-tux        =    zero
                     go to acc-rig-tux-600
           else      go to acc-rig-tux-100.
       acc-rig-tux-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-sta-tus        =    zero
                     move  99             to   w-tes-sta-tus          .
      *                  *---------------------------------------------*
      *                  * Tratamento statistiche                      *
      *                  *---------------------------------------------*
           if        w-tes-sta-tux        =    zero
                     move  99             to   w-tes-sta-tux          .
       cnt-tdo-key-510.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo ordinamento *
      ...
      *              *-------------------------------------------------*
      ...
      -              "          "         to   w-err-box-err-msg      .
       ...
       cnt-tdo-rig-434.
      *              *-------------------------------------------------*
      *              * Controllo su Codice cliente di riferimento      *
      *              *-------------------------------------------------*
           if        w-rig-sta-tus        not  = 21  and
                     w-rig-sta-tus        not  = 52  and
                     w-rig-sta-tus        not  = 62  and
                     w-rig-sta-tus        not  = 72
                     go to cnt-tdo-rig-440.
           if        w-rig-sta-tuc        =    zero
                     go to cnt-tdo-rig-436.
           move      "C"                  to   w-let-arc-dcc-tle      .
           move      w-rig-sta-tuc        to   w-let-arc-dcc-cod      .
           move      spaces               to   w-let-arc-dcc-dpz      .
           perform   let-arc-dcc-000      thru let-arc-dcc-999        .
           if        w-let-arc-dcc-flg    =    spaces
                     go to cnt-tdo-rig-440.
           move      "Codice Cliente di riferimento non esistente !     
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-436.
           move      "Manca il codice Cliente di riferimento !          
      -              "          "         to   w-err-box-err-msg      .
           go to     cnt-tdo-rig-900.
       cnt-tdo-rig-440.
       cnt-tdo-rig-600.
      ...
      *    *-----------------------------------------------------------*
       pre-rig-cor-000.
      *              *-------------------------------------------------*
      *              * Lettura eventuale anagrafica cliente di riferi- *
      *              * mento                                           *
      *              *-------------------------------------------------*
           if        w-rig-sta-tuc        =    zero
                     go to pre-rig-cor-999.
           move      w-rig-sta-tuc        to   w-let-arc-dcc-cod      .
           perform   let-arc-dcc-000      thru let-arc-dcc-999        .
           move      w-let-arc-dcc-rag    to   w-rig-sta-tuc-rag      .
           move      w-let-arc-dcc-via    to   w-rig-sta-tuc-via      .
           move      w-let-arc-dcc-loc    to   w-rig-sta-tuc-loc      .
       pre-rig-cor-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tes-sta-tus          .
           move      zero                 to   w-tes-sta-tud          .
           move      zero                 to   w-tes-sta-tuc          .
           move      spaces               to   w-tes-sta-tuc-rag      .
           move      spaces               to   w-tes-sta-tuc-via      .
           move      spaces               to   w-tes-sta-tuc-loc      .
           move      zero                 to   w-tes-sta-tux          .
       nor-key-reg-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-dcc-sta-tus       not  = w-tes-sta-tus
                     go to sel-rec-dcc-900.
       sel-rec-dcc-200.
      *                  *---------------------------------------------*
      *                  * Data rilevazione status                     *
      *                  *---------------------------------------------*
           if        w-tes-sta-tud        =    zero
                     go to sel-rec-dcc-300.
           if        rf-dcc-sta-tud       not  = w-tes-sta-tud
                     go to sel-rec-dcc-900.
       sel-rec-dcc-300.
      *                  *---------------------------------------------*
      *                  * Codice cliente di riferimento               *
      *                  *---------------------------------------------*
           if        w-tes-sta-tuc        =    zero
                     go to sel-rec-dcc-400.
           if        rf-dcc-sta-tuc       not  = w-tes-sta-tuc
                     go to sel-rec-dcc-900.
       sel-rec-dcc-400.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-dcc-sta-tux       not  = w-tes-sta-tux
                     go to sel-rec-dcc-900.
       sel-rec-dcc-800.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-dcc-sta-tus       to   w-rig-sta-tus          .
           move      rf-dcc-sta-tud       to   w-rig-sta-tud          .
           move      rf-dcc-sta-tuc       to   w-rig-sta-tuc          .
           move      rf-dcc-sta-tux       to   w-rig-sta-tux          .
      *                      *-----------------------------------------*
      *                      * Valori determinati indirettamente da    *
      *                      * record [dcc]                            *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Ragione sociale cliente riferimento *
      *                          *                                     *
      *                          * N.B.: viene letta prima del trat-   *
      *                          *       tamento della riga per non    *
      *                          *       alterare la start su [dcc]    *
      *                          *-------------------------------------*
       car-eff-rig-800.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-rig-sta-tus        to   rf-dcc-sta-tus         .
           move      w-rig-sta-tud        to   rf-dcc-sta-tud         .
           move      w-rig-sta-tuc        to   rf-dcc-sta-tuc         .
           move      w-rig-sta-tux        to   rf-dcc-sta-tux         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
