      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcc172   *
      *                                                                *
      *                    Stampa categorie di sconto in riga docum.   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA CATEGORIE SCONTO RIGA DOCUMENTO "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-csc           to   rf-zcs-tip-csc         .
           move      rr-cod-min           to   rf-zcs-cod-csc         .
           move      "pgm/dcc/fls/ioc/obj/iofzcs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-csc           to   rf-zcs-tip-csc         .
           move      rr-des-min           to   rf-zcs-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-csc           to   rf-zcs-tip-csc         .
           move      rr-mne-min           to   rf-zcs-mne-csc         .
           move      zero                 to   rf-zcs-cod-csc         .
           move      "pgm/dcc/fls/ioc/obj/iofzcs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Test su Tipo classificatore                     *
      *              *-------------------------------------------------*
           if        rf-zcs-tip-csc       not  = rr-tip-csc
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zcs-cod-csc       <    rr-cod-min or
                     rf-zcs-cod-csc       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zcs-des-key       <    rr-des-min or
                     rf-zcs-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zcs-mne-csc       <    rr-mne-min or
                     rf-zcs-mne-csc       >    rr-mne-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      40                   to   p-pos                  .
           move      rf-zcs-per-sco (1)   to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Barra di suddivisione                   *
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      47                   to   p-pos                  .
           move      rf-zcs-per-sco (2)   to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Barra di suddivisione                   *
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      54                   to   p-pos                  .
           move      rf-zcs-per-sco (3)   to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Barra di suddivisione                   *
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      61                   to   p-pos                  .
           move      rf-zcs-per-sco (4)   to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Barra di suddivisione                   *
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      68                   to   p-pos                  .
           move      rf-zcs-per-sco (5)   to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Barra di suddivisione                   *
      ...
      *              *-------------------------------------------------*
           move      "CATEGORIE SCONTO IN RIGA DOCUMENTO PER CLIENTI"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "|      Categoria sconto cliente      |       Perce
      -              "ntuali di sconto      |"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
