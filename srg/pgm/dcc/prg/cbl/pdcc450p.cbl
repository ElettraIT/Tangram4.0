      ...
      *                                                                *
      *                    Manutenzione codici Destinatario SDI e PEC  *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "     DESTINATARI SDI E INDIRIZZI PEC    "       .
      ...
      *            *---------------------------------------------------*
               10  w-tes-sel-sdi          pic  9(02)                  .
               10  w-tes-sel-pec          pic  9(02)                  .
               10  w-tes-cod-sdi          pic  x(20)                  .
               10  w-tes-sne-cle          pic  9(02)                  .
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-rag-cli  pic  x(30)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-cod-sdi  pic  x(08)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-num-con  pic  x(23)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Selezione su codice destinatario           *
      *        *-------------------------------------------------------*
           05  w-exp-sel-sdi.
               10  w-exp-sel-sdi-num      pic  9(02)       value 3    .
               10  w-exp-sel-sdi-lun      pic  9(02)       value 40   .
               10  w-exp-sel-sdi-tbl.
                   15  filler             pic  x(40) value
                            "Nessuna selezione                       ".
                   15  filler             pic  x(40) value
                            "solo senza codice Destinatario SDI      ".
                   15  filler             pic  x(40) value
                            "solo Con codice destinatario SDI        ".
      *        *-------------------------------------------------------*
      *        * Work per : Selezione su PEC                           *
      *        *-------------------------------------------------------*
           05  w-exp-sel-pec.
               10  w-exp-sel-pec-num      pic  9(02)       value 4    .
               10  w-exp-sel-pec-lun      pic  9(02)       value 40   .
               10  w-exp-sel-pec-tbl.
                   15  filler             pic  x(40) value
                            "Nessuna selezione                       ".
                   15  filler             pic  x(40) value
                            "solo Senza indirizzo PEC                ".
                   15  filler             pic  x(40) value
                            "solo Con indirizzo PEC                  ".
                   15  filler             pic  x(40) value
                            "solo con indirizzo PEC per le Fatture   ".
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-key-reg-150.
      *                  *---------------------------------------------*
      *                  * Selezione su destinatario                   *
      *                  *---------------------------------------------*
           perform   acc-sel-sdi-000      thru acc-sel-sdi-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *                  * Selezione su PEC                            *
      *                  *---------------------------------------------*
           perform   acc-sel-pec-000      thru acc-sel-pec-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Selezione su destinatario                       *
      *              *-------------------------------------------------*
           perform   vis-sel-sdi-000      thru vis-sel-sdi-999        .
      *              *-------------------------------------------------*
      *              * Selezione su PEC                                *
      *              *-------------------------------------------------*
           perform   vis-sel-pec-000      thru vis-sel-pec-999        .
      *              *-------------------------------------------------*
      *              * Codice destinatario                             *
      *              *-------------------------------------------------*
      ...
      *              * Inclusione clienti esteri                       *
      *              *-------------------------------------------------*
           perform   vis-sne-cle-000      thru vis-sne-cle-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Selezione su destinatario                   *
      *                  *---------------------------------------------*
           perform   pmt-sel-sdi-000      thru pmt-sel-sdi-999        .
      *                  *---------------------------------------------*
      *                  * Selezione su PEC                            *
      *                  *---------------------------------------------*
           perform   pmt-sel-pec-000      thru pmt-sel-pec-999        .
      *                  *---------------------------------------------*
      *                  * Codice destinatario                         *
      *                  *---------------------------------------------*
      ...
      *                  * Inclusione clienti esteri                   *
      *                  *---------------------------------------------*
           perform   pmt-sne-cle-000      thru pmt-sne-cle-999        .
       pmt-key-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Selezione su destinatario        *
      *    *-----------------------------------------------------------*
       pmt-sel-sdi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Selezione su PEC                 *
      *    *-----------------------------------------------------------*
       pmt-sel-pec-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice destinatario              *
      *    *-----------------------------------------------------------*
       pmt-cod-sdi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Inclusione clienti esteri        *
      *    *-----------------------------------------------------------*
       pmt-sne-cle-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Selezione su destinatario            *
      *    *-----------------------------------------------------------*
       acc-sel-sdi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-sdi-lun    to   v-car                  .
           move      w-exp-sel-sdi-num    to   v-ldt                  .
           move      "NDC#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      10                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-sel-sdi-tbl    to   v-txt                  .
           move      w-tes-sel-sdi        to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-sel-sdi-999.
       acc-sel-sdi-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-sel-sdi          .
       acc-sel-sdi-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Selezione su destinatario         *
      *    *-----------------------------------------------------------*
       vis-sel-sdi-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Selezione su PEC                     *
      *    *-----------------------------------------------------------*
       acc-sel-pec-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-pec-lun    to   v-car                  .
           move      w-exp-sel-pec-num    to   v-ldt                  .
           move      "NSCF#"              to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      12                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-sel-pec-tbl    to   v-txt                  .
           move      w-tes-sel-pec        to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-sel-pec-999.
       acc-sel-pec-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-sel-pec          .
       acc-sel-pec-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Selezione su PEC                  *
      *    *-----------------------------------------------------------*
       vis-sel-pec-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice destinatario                  *
      *    *-----------------------------------------------------------*
       acc-cod-sdi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice destinatario               *
      *    *-----------------------------------------------------------*
       vis-cod-sdi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Eventuale default                           *
      *                  *---------------------------------------------*
           if        w-tes-sne-cle        not  = zero
                     go to acc-sne-cle-100.
           move      01                   to   w-tes-sne-cle          .
       acc-sne-cle-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  * Codice destinatario                         *
      *                  *---------------------------------------------*
           perform   acc-rig-sdi-000      thru acc-rig-sdi-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   w-lin-imm-rag-cli
                                              (26 : 01)               .
           move      w-rig-dpz-cli        to   w-lin-imm-rag-cli
                                              (27 : 04)               .
       vis-lin-cor-480.
      *                  *---------------------------------------------*
      *                  * Editing codice destinatario                 *
      *                  *---------------------------------------------*
           move      w-rig-cod-sdi        to   w-lin-imm-cod-sdi      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *              * Codice destinatario                             *
      *              *-------------------------------------------------*
           perform   vis-rig-sdi-000      thru vis-rig-sdi-999        .
      *              *-------------------------------------------------*
      *              * Data aggiornamento                              *
      *              *-------------------------------------------------*
      ...
      *                  * Codice destinatario                         *
      *                  *---------------------------------------------*
           perform   pmt-rig-sdi-000      thru pmt-rig-sdi-999        .
      *                  *---------------------------------------------*
      *                  * Data aggiornamento                          *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Numero di utenza PEC                 *
      *    *-----------------------------------------------------------*
       acc-num-con-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Test se a spaces                            *
      *                  *---------------------------------------------*
           if        w-rig-num-con        =    spaces
                     go to acc-num-con-600.
      *                  *---------------------------------------------*
      *                  * Controllo che contenga solo 1 '@'           *
      *                  *---------------------------------------------*
           move      w-rig-num-con        to   w-all-str-alf          .
           move      "@"                  to   w-all-str-del          .
           perform   all-str-chr-000      thru all-str-chr-999        .
           if        w-all-str-num        =    1
                     go to acc-num-con-420.
      *
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Tasto Selezione per valori proposti               
      -              "   "                to   v-nt1                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        v-key                not  = "SLCT"
                     go to acc-int-con-400.
           if        w-rig-int-con        not  = spaces
                     go to acc-int-con-400.
      *                  *---------------------------------------------*
      *                  * Test se l'indirizzo PEC e' stato inserito   *
      *                  *---------------------------------------------*
           if        w-rig-num-con        =    spaces
                     go to acc-int-con-400.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-edt                to   w-all-str-cat (2)      .
      *                  *---------------------------------------------*
      *                  * Precablaggio eventuale                      *
      *                  *---------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      "<fat="              to   w-all-str-cat (1)      .
           move      ">"                  to   w-all-str-cat (3)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   w-rig-int-con          .
           perform   vis-int-con-000      thru vis-int-con-999        .
      *                  *---------------------------------------------*
      *                  * Data aggiornamento                          *
      *                  *---------------------------------------------*
           move      s-dat                to   w-rig-dat-agg          .
           perform   vis-dat-agg-000      thru vis-dat-agg-999        .
       acc-int-con-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      ...
      *                  *---------------------------------------------*
           if        w-rig-cod-sdi        not  = spaces
                     go to acc-rig-sdi-100.
           if        w-rig-num-con        =    spaces
                     go to acc-rig-sdi-100.
           if        w-rig-int-con        =    spaces
                     go to acc-rig-sdi-100.
           move      "0000000"            to   w-rig-cod-sdi          .
           perform   vis-rig-sdi-000      thru vis-rig-sdi-999        .
       acc-rig-sdi-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tes-sel-sdi          .
           move      zero                 to   w-tes-sel-pec          .
           move      zero                 to   w-tes-sne-cle          .
           move      spaces               to   w-tes-cod-sdi          .
       nor-key-reg-999.
           exit.
      ...
      *              *-------------------------------------------------*
       sel-rec-dcc-100.
      *                  *---------------------------------------------*
      *                  * Selezioni su codice destinatario            *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da eseguire                     *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Solo senza codice Destinatario          *
      *                      *-----------------------------------------*
           if        w-tes-sel-sdi        =    02 and
                     rf-dcc-idn-em2       not  = spaces
                     go to sel-rec-dcc-900.
      *                      *-----------------------------------------*
      *                      * Solo con codice Destinatario            *
      *                      *-----------------------------------------*
           if        w-tes-sel-sdi        =    03 and
                     rf-dcc-idn-em2       =    spaces
                     go to sel-rec-dcc-900.
       sel-rec-dcc-200.
      *                  *---------------------------------------------*
      *                  * Selezioni su PEC                            *
      ...
      *                      * Solo con PEC                            *
      *                      *-----------------------------------------*
           if        w-tes-sel-pec        =    03 and
                     d-con-arc-num-con (1)
                                          =    spaces
                     go to sel-rec-dcc-900.
      *                      *-----------------------------------------*
      *                      * Solo con PEC per fatture                *
      *                      *-----------------------------------------*
           if        w-tes-sel-pec        =    04 and
                     d-con-arc-num-con (1)
                                          =    spaces
                     go to sel-rec-dcc-900.
           if        w-tes-sel-pec        =    04 and
      ...
      *                      *-----------------------------------------*
           if        w-tes-cod-sdi        =    spaces
                     go to sel-rec-dcc-400.
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        rf-dcc-idn-em2       not  = w-tes-cod-sdi
                     go to sel-rec-dcc-900.
       sel-rec-dcc-400.
      *                  *---------------------------------------------*
      *                  * Selezioni su inclusione clienti esteri      *
      *                  *---------------------------------------------*
           if        w-tes-sne-cle        =    01
                     go to sel-rec-dcc-800.
           if        w-tes-sne-cle        =    02 and
                     rf-dcc-cod-naz       not  = "IT "
                     go to sel-rec-dcc-900.
           if        w-tes-sne-cle        =    03 and
                     rf-dcc-cod-naz       =    "IT "
                     go to sel-rec-dcc-900.
       sel-rec-dcc-800.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dcc-idn-em2       to   w-rig-cod-sdi          .
      *                  *---------------------------------------------*
      *                  * Valori determinati direttamente da record   *
      *                  * [adc]                                       *
      *                  *---------------------------------------------*
      ...
      *
           ...
           move      d-con-arc-int-con (1)
                                          to   w-rig-int-con          .
           move      d-con-arc-uni-prg    to   w-rig-prg-con          .
           move      d-con-arc-uni-agg    to   w-rig-dat-agg          .
       car-eff-rig-700.
      *              *-------------------------------------------------*
      ...
      *              * Aggiornamento [dcc]                             *
      *              *-------------------------------------------------*
           perform   sca-fil-rap-dcc-000  thru sca-fil-rap-dcc-999    .
       sca-fil-rap-300.
      *              *-------------------------------------------------*
      *              * Aggiornamento [adc]                             *
      *              *-------------------------------------------------*
           perform   sca-fil-rap-adc-000  thru sca-fil-rap-adc-999    .
       sca-fil-rap-400.
      *              *-------------------------------------------------*
      *              * Riciclo a rilettura riga da file relative di    *
      *              * supporto                                        *
      *              *-------------------------------------------------*
           go to     sca-fil-rap-100.
       sca-fil-rap-900.
      ...
      *              *-------------------------------------------------*
           if        w-rig-cod-sdi
                    (08 : 01)             =    "N"
                     go to sca-fil-rap-dcc-220.
           move      spaces               to   w-rig-cod-sdi
                                              (08 : 22)               .
       sca-fil-rap-dcc-220.
           move      w-rig-cod-sdi        to   rf-dcc-idn-em2         .
      *              *-------------------------------------------------*
      *              * Forced put record                               *
      *              *-------------------------------------------------*
           move      "FP"                 to   f-ope                  .
      ...
      *    * Esecuzione scaricamento da file relative di appoggio      *
      *    *                                                           *
      *    * Aggiornamento anagrafica [adc]                            *
      *    *-----------------------------------------------------------*
       sca-fil-rap-adc-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione record adc]                     *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-cod-cli        to   rf-adc-cod-arc         .
           move      w-rig-dpz-cli        to   rf-adc-dpz-arc         .
      ...
      *              *-------------------------------------------------*
           if        f-sts                =    e-not-err
                     go to sca-fil-rap-adc-400.
       sca-fil-rap-adc-200.
      *              *-------------------------------------------------*
      *              * Se record [adc] non esistente                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se esiste almeno un valore             *
      *                  *---------------------------------------------*
           if        w-rig-num-con        =    spaces and
                     w-rig-int-con        =    spaces and
                     w-rig-dat-agg        =    zero
                     go to sca-fil-rap-adc-900.
      *                  *---------------------------------------------*
      *                  * Composizione record                         *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se record vuoto                        *
      *                  *---------------------------------------------*
           if        w-rig-num-con        not  = spaces or
                     w-rig-int-con        not  = spaces or
                     w-rig-dat-agg        not  = zero
                     go to sca-fil-rap-adc-420.
      *                  *---------------------------------------------*
      *                  * Unlock record                               *
      *                  *---------------------------------------------*
           move      "RL"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-dpz-cli        to   rf-adc-dpz-arc         .
      *
           move      w-rig-cod-cli-rag    to   w-all-str-alf          .
           move      40                   to   w-all-str-lun          .
           perform   all-str-upp-000      thru all-str-upp-999        .
           move      w-all-str-alf        to   rf-adc-des-key         .
      *
           move      "PEC"                to   rf-adc-tip-con         .
           move      d-con-arc-num-prg    to   rf-adc-num-prg         .
           move      w-rig-int-con        to   rf-adc-int-con         .
