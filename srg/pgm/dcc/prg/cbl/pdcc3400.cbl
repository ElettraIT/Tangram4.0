      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase dcc340, nella sua globalita', esegue i tipi di stampa  *
      * elencati nella tabella seguente :                              *
      *                                                                *
      *   Codice                                                       *
      *    tipo                                                        *
      *   stampa          Descrizione per il tipo interrogazione       *
      * ----------  -------------------------------------------------- *
      *                                                                *
      * PNCCLI      Stampa prezzi netti concordati per un cliente      *
      * PNCPRO      Stampa prezzi netti concordati per un prodotto     *
      * PNCSEL      Stampa prezzi netti concordati per clienti         *
      * PNCCNF      Stampa prezzi netti concordati per confronti       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPE PREZZI NETTI CONCORDATI CLIENTE "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'dcc340'           *
      *              *-------------------------------------------------*
           perform   fas-dcc-340-000      thru fas-dcc-340-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              * stazione                                        *
      *              *-------------------------------------------------*
           move      "Prezzi relativi ad un cliente                     
      -              "           PNCCLI     pdcc340a  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *       
           move      "Prezzi relativi ad un prodotto                    
      -              "           PNCPRO     pdcc340b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Prezzi netti concordati per clienti               
      -              "           PNCSEL     pdcc340c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Confronto con listini                             
      -              "           PNCCNF     pdcc340d  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-200.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-dcc-340-300
           else if   v-key                =    "PRSC"
                     go to fas-dcc-340-400
           else if   v-key                =    "NXSC"
                     go to fas-dcc-340-450
           else if   v-key                =    "DOWN"
                     go to fas-dcc-340-500
           else if   v-key                =    "EXIT"
                     go to fas-dcc-340-250
           else      go to fas-dcc-340-200.
       fas-dcc-340-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-dcc-340-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-dcc-340-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-dcc-340-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-dcc-340-350
           else      go to fas-dcc-340-322.
       fas-dcc-340-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-dcc-340-630
           else if   v-key                =    "PRSC"
                     go to fas-dcc-340-600
           else if   v-key                =    "NXSC"
                     go to fas-dcc-340-610
           else if   v-key                =    "UP  "
                     go to fas-dcc-340-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-dcc-340-650
           else if   v-key                =    "EXIT"
                     go to fas-dcc-340-660
           else      go to fas-dcc-340-570.
       fas-dcc-340-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-dcc-340-626
           else      go to fas-dcc-340-628.
       fas-dcc-340-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-dcc-340-636
           else      go to fas-dcc-340-638.
       fas-dcc-340-636.
      *                          *-------------------------------------*
