      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " TIPI VOCI DESCRITTIVE PER FATTURAZIONE "       .
      ...
      *                  * Preparazione eventuale default              *
      *                  *---------------------------------------------*
           if        w-tes-des-vri (1)    =    spaces
                     move  w-tes-des-ves (1)
                                          to   w-tes-des-vri (1)      .
       acc-des-vri-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-num-def        to   rf-zdf-num-def         .
           move      w-tes-cod-lng        to   rf-zdf-cod-lng         .
           move      "pgm/dcc/fls/ioc/obj/iofzdf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zdf]                        *
      *                          *-------------------------------------*
           move      rf-zdf-des-ves       to   w-tes-des-ves (1)      .
           move      rf-zdf-des-vri       to   w-tes-des-vri (1)      .
           move      rf-zdf-des-stp       to   w-tes-des-stp (1)      .
           move      rf-zdf-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zdf]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zdf-000      thru wrt-rec-zdf-999        .
      ...
      *                      * Rewrite record [zdf]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zdf-000      thru rew-rec-zdf-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zdf]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zdf-000      thru del-rec-zdf-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zdf]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zdf-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-lng        =    "I  "
                     go to cmp-rec-zdf-200.
           move      spaces               to   rf-zdf-des-ves         .
           move      spaces               to   rf-zdf-des-vri         .
           go to     cmp-rec-zdf-500.
       cmp-rec-zdf-200.
           move      w-tes-des-ves (1)    to   rf-zdf-des-ves         .
           move      w-tes-des-vri (1)    to   rf-zdf-des-vri         .
       cmp-rec-zdf-500.
           move      w-tes-des-stp (1)    to   rf-zdf-des-stp         .
           move      w-tes-alx-exp (1)    to   rf-zdf-alx-exp         .
       cmp-rec-zdf-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zdf]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zdf-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zdf-000      thru cmp-rec-zdf-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
      *              * Lettura della tabella [zdf]                     *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODDEF    "         to   f-key                  .
           move      w-ric-cod-ita-spf    to   rf-zdf-num-def         .
      ...
      *                      * da visualizzare                         *
      *                      *-----------------------------------------*
           move      rf-zdf-des-ves       to   w-ric-cod-ita-ves      .
           move      rf-zdf-des-vri       to   w-ric-cod-ita-vri      .
      *                          *-------------------------------------*
      *                          * Uscita                              *
      *                          *-------------------------------------*
           go to     ric-cod-ita-999.
