      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcc142   *
      *                                                                *
      *                    Stampa codici statistici clienti            *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zst-tip-cls         .
           move      rr-cod-min           to   rf-zst-cod-cls         .
           move      "pgm/dcc/fls/ioc/obj/iofzst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zst-tip-cls         .
           move      rr-des-min           to   rf-zst-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zst-tip-cls         .
           move      rr-mne-min           to   rf-zst-mne-cls         .
           move      zero                 to   rf-zst-cod-cls         .
           move      "pgm/dcc/fls/ioc/obj/iofzst"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zst]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/dcc/fls/ioc/obj/iofzst"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-zst-tip-cls       not  = rr-tip-cls
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zst-cod-cls       <    rr-cod-min or
                     rf-zst-cod-cls       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zst-des-key       <    rr-des-min or
                     rf-zst-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zst-mne-cls       <    rr-mne-min or
                     rf-zst-mne-cls       >    rr-mne-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "CODICI STATISTICI CLIENTI"
