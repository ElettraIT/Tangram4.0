      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcc408   *
      ...
      *              *-------------------------------------------------*
           ...
           else      move  rf-dcc-rag-key to   w-rot-l01-let-ini      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Determinazione numero di telefono 2         *
      *                  *---------------------------------------------*
           move      "DT"                 to   d-con-arc-tip-ope      .
           move      02                   to   d-con-arc-tip-arc      .
           move      rf-dcc-cod-cli       to   d-con-arc-cod-arc      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-340.
      *                  *---------------------------------------------*
      *                  * Determinazione numero di cellulare 1        *
      *                  *---------------------------------------------*
           move      "DT"                 to   d-con-arc-tip-ope      .
           move      02                   to   d-con-arc-tip-arc      .
           move      rf-dcc-cod-cli       to   d-con-arc-cod-arc      .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Determinazione numero di telefono 3         *
      *                  *---------------------------------------------*
           move      "DT"                 to   d-con-arc-tip-ope      .
           move      02                   to   d-con-arc-tip-arc      .
           move      rf-dcc-cod-cli       to   d-con-arc-cod-arc      .
      ...
      *              *-------------------------------------------------*
           move      "RUBRICA TELEFONICA CLIENTI COMMERCIALI"
