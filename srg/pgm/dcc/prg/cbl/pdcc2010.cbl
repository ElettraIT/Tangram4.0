      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella Spese bollo          *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-wrk.
      *        *-------------------------------------------------------*
      *        * Comodo per descrizione spese bollo                    *
      *        *-------------------------------------------------------*
           05  w-wrk-des-spb              pic  x(40)                  .

      *    *===========================================================*
      *    * Work-area per ridefinizione contenuto del mark-point      *
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-cod-spb              pic  x(03)                  .
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessuna spesa bollo entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-zbo-cod-spb       to   w-rot-l01-cod-spb      .
           move      rf-zbo-des-spb       to   w-wrk-des-spb          .
       qry-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      w-rot-l01-cod-spb    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Descrizione spesa                           *
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-zbo-tip-pag       =    1
                     move  "Rimessa diretta               "
                                          to   v-alf
           else if   rf-zbo-tip-pag       =    2
                     move  "Incasso elettronico           "
                                          to   v-alf
           else if   rf-zbo-tip-pag       =    3
                     move  "Ri.Ba.                        "
                                          to   v-alf
           else if   rf-zbo-tip-pag       =    4
                     move  "C.d.O. - Conferma d'ordine    "
                                          to   v-alf
           else if   rf-zbo-tip-pag       =    5
                     move  "Mav - Mediante avviso         "
                                          to   v-alf
           else if   rf-zbo-tip-pag       =    6
                     move  "Rid - Accr. preautoriz. in c/ "
                                          to   v-alf
           else if   rf-zbo-tip-pag       =    7
                     move  "Bonifico bancario             "
                                          to   v-alf
           else if   rf-zbo-tip-pag       =    8
                     move  "Conto corrente postale        "
                                          to   v-alf
           else if   rf-zbo-tip-pag       =    9
                     move  "Ricevuta bancaria             "
                                          to   v-alf
           else if   rf-zbo-tip-pag       =    10
                     move  "Tratta                        "
                                          to   v-alf
           else if   rf-zbo-tip-pag       =    11
                     move  "Paghero'                      "
                                          to   v-alf
           else      move  all "."        to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zbo-cod-spb       to   w-mpn-cod-spb          .
           move      rf-zbo-tip-pag       to   w-mpn-tip-pag          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      69                   to   v-pos                  .
           if        rf-zbo-tau-spb       =    1
                     move  "A percent.  " to   v-alf
           else if   rf-zbo-tau-spb       =    2
                     move  "A scaglioni " to   v-alf
           else if   rf-zbo-tau-spb       =    3
                     move  "Scaglioni  %" to   v-alf
           else      move  all "."        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-spb'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
