      ...
      *                       Ultima revisione:    NdK del 21/05/24    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-utz.
               10  w-exp-tip-utz-num      pic  9(02)       value 8    .
      ...
      *              *-------------------------------------------------*
           ...
           move      10                   to   w-cmn-zst-002-lin      .
           move      30                   to   w-cmn-zst-002-pos      .
           move      10                   to   w-cmn-zst-002-dln      .
      ...
      *                  *---------------------------------------------*
           perform   vis-des-cat-000      thru vis-des-cat-999        .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dcc-cod-cli       to   rf-adc-cod-arc         .
           move      rf-dcc-dpz-cli       to   rf-adc-dpz-arc         .
      ...
      *                  * Test sulla chiave                           *
      *                  *---------------------------------------------*
           if        rf-adc-tip-arc       not  = 02             or
                     rf-adc-cod-arc       not  = rf-dcc-cod-cli or
                     rf-adc-dpz-arc       not  = rf-dcc-dpz-cli
                     go to car-eff-rig-900.
       car-eff-rig-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
