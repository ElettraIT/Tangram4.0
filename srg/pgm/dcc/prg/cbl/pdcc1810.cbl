      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su tabella sconti incrociati *
      *                    in riga fattura Cliente/Prodotto            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE SCONTI INCROCIATI IN RIGA"       .
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo su tipo ordinamento tabella           *
      *              *-------------------------------------------------*
           if        rr-tip-ord           =    "C" or
                     rr-tip-ord           =    "P"
       ...
       tdo-ric-sel-300.
      *              *-------------------------------------------------*
      *              * Controllo su codice sconto cliente              *
      *              *-------------------------------------------------*
           if        rr-tip-ord           not  = "C"
           ...
           if        rr-cod-uno           not  = zero
                     go to tdo-ric-sel-999.
           move      "ME"                 to   v-ope                  .
           move      "Manca il codice sconto cliente !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
      ...
      *              *-------------------------------------------------*
       ...
       qry-tst-max-200.
      *              *-------------------------------------------------*
      *              * Se ordinamento per codice sconto cliente        *
      *              *-------------------------------------------------*
       ...
       qry-tst-max-400.
      *              *-------------------------------------------------*
      *              * Se ordinamento per codice sconto prodotto       *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           else      move  rr-cod-due     to   rf-zsx-cod-uno         .
           move      rf-zcs-cod-csc       to   rf-zsx-cod-due         .
           move      "pgm/dcc/fls/ioc/obj/iofzsx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      22                   to   v-pos                  .
           move      rf-zcs-des-csc       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           if        rr-tip-ord           =    "C"
                     move  rr-cod-uno     to   w-mpn-cod-uno
                     move  rf-zcs-cod-csc to   w-mpn-cod-due
           else      move  rr-cod-due     to   w-mpn-cod-uno
                     move  rf-zcs-cod-csc to   w-mpn-cod-due          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      45                   to   v-pos                  .
           move      rf-zsx-per-sco (1)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      52                   to   v-pos                  .
           move      rf-zsx-per-sco (2)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      59                   to   v-pos                  .
           move      rf-zsx-per-sco (3)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      66                   to   v-pos                  .
           move      rf-zsx-per-sco (4)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      73                   to   v-pos                  .
           move      rf-zsx-per-sco (5)   to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-tip-ord           =    "C"
                     move  rr-cod-uno-des to   v-alf
           else      move  rr-cod-due-des to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      05                   to   v-pos                  .
           move      "Mnem.   Codice       Descrizione             Perce
      -              "ntuali di sconto      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
