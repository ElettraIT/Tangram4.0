      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [dcm]            *
      *                                                                *
      *                    Anagrafica clienti per il marketing         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "INTERROGAZIONE SU CLIENTI PER MARKETING "       .
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice cliente marketing       *
      *    *-----------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rip-str.
      *        *-------------------------------------------------------*
      *        * Work-area per ripristino Start su [dcm]               *
      *        *-------------------------------------------------------*
           05  w-rip-str-dcm.
      *            *---------------------------------------------------*
      *            * Flag di End-of-file                               *
      *            *---------------------------------------------------*
               10  w-rip-str-dcm-eof      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Parametri di Start                                *
      *            *---------------------------------------------------*
               10  w-rip-str-dcm-cod      pic  9(07)                  .
               10  w-rip-str-dcm-rag      pic  x(40)                  .
               10  w-rip-str-dcm-mne      pic  x(10)                  .
               10  w-rip-str-dcm-piv      pic  9(11)                  .
               10  w-rip-str-dcm-cfi      pic  x(16)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp-rec.
           05  w-exp-rec-dcm-lin          pic  9(02) value 13         .
           05  w-exp-rec-dcm-ctr          pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-rip-str-dcm-eof      .
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo ordinamento     *
      *              *-------------------------------------------------*
           if        rr-tip-ord           =    "C"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cfi-min           to   rf-dcm-cod-fis         .
           move      zero                 to   rf-dcm-cod-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           if        rf-dcm-cod-cli       <    rr-cod-min or
                     rf-dcm-cod-cli       >    rr-cod-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su ragione sociale                    *
      *              *-------------------------------------------------*
           if        rf-dcm-rag-key       <    rr-rag-min or
                     rf-dcm-rag-key       >    rr-rag-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-dcm-cod-mne       <    rr-mne-min or
                     rf-dcm-cod-mne       >    rr-mne-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su partita iva                        *
      *              *-------------------------------------------------*
           if        rf-dcm-prt-iva       <    rr-pti-min or
                     rf-dcm-prt-iva       >    rr-pti-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su codice fiscale                     *
      *              *-------------------------------------------------*
           if        rf-dcm-cod-fis       <    rr-cfi-min or
                     rf-dcm-cod-fis       >    rr-cfi-max
                     go to qry-sel-rec-900.
       qry-sel-rec-800.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-dcm-rs1-cli       to   w-rot-l01-rag-soc      .
       qry-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      rf-dcm-cod-mne       to   w-buf-cod-mne          .
           move      rf-dcm-cod-cli       to   w-buf-cod-cli          .
           move      rf-dcm-rs1-cli       to   w-buf-rag-soc          .
           move      rf-dcm-via-cli       to   w-buf-via-cli          .
           move      rf-dcm-loc-cli       to   w-buf-loc-cli          .
           move      rf-dcm-prt-iva       to   w-buf-prt-iva          .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "EXPD"
                     go to qry-trt-fun-999.
      *                  *---------------------------------------------*
      *                  * Routine per Expand su record [dcm]          *
      *                  *---------------------------------------------*
           perform   exp-rec-dcm-000      thru exp-rec-dcm-999        .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       exp-rec-dcm-000.
      *              *-------------------------------------------------*
      *              * Salvataggio parametri per Start su [dcm]        *
      *              *-------------------------------------------------*
           if        w-rip-str-dcm-eof    not  = spaces
                     go to exp-rec-dcm-100.
           move      rf-dcm-cod-cli       to   w-rip-str-dcm-cod      .
           move      rf-dcm-rag-key       to   w-rip-str-dcm-rag      .
           move      rf-dcm-cod-mne       to   w-rip-str-dcm-mne      .
           move      rf-dcm-prt-iva       to   w-rip-str-dcm-piv      .
           move      rf-dcm-cod-fis       to   w-rip-str-dcm-cfi      .
       exp-rec-dcm-100.
      *              *-------------------------------------------------*
      *              * Video in 'OFF'                                  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per Codice cliente assegnato         *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      22                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "CODCLI    "         to   f-key                  .
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-cod-cli        to   rf-dcm-cod-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Cliente assegnato                           *
      *                  *---------------------------------------------*
           move      rf-dcm-cod-cge       to   w-let-arc-cli-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dcm-cod-cli       to   d-con-arc-cod-arc      .
      ...
      *                  *---------------------------------------------*
           ...
           move      12                   to   v-lin                  .
           move      26                   to   v-pos                  .
           move      rf-dcm-cod-cge       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Ragione sociale cliente assegnato           *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
      ...
      *                      * Ciclo 1..5                              *
      *                      *-----------------------------------------*
           move      zero                 to   w-exp-rec-dcm-ctr      .
       exp-rec-dcc-730.
           add       1                    to   w-exp-rec-dcm-ctr      .
           if        w-exp-rec-dcm-ctr    >    05                or
                     w-exp-rec-dcm-ctr    >    d-con-arc-num-ele
      ...
      *                      *-----------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      03                   to   v-car                  .
           move      w-exp-rec-dcm-lin    to   v-lin                  .
           add       w-exp-rec-dcm-ctr    to   v-lin                  .
           move      03                   to   v-pos                  .
      *
           if        d-con-arc-tip-con
                    (w-exp-rec-dcm-ctr)   =    "SEP"
                     move  all "-"        to   v-alf
      ...
      *
           ...
           move      rf-dcm-ide-ute       to   w-all-str-cat (2)      .
      ...
      *
           move      03                   to   w-all-str-num          .
           move      w-all-str-alf        to   w-all-str-cat (1)      .
           move      rf-dcm-ide-fas       to   w-all-str-cat (2)      .
           move      "]"                  to   w-all-str-cat (3)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
      *                      *-----------------------------------------*
      *                      * Visualizzazione                         *
      ...
      *                  *---------------------------------------------*
           if        w-rip-str-dcm-eof    not  = spaces
                     go to exp-rec-dcm-999.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo di Start    *
      *                  * attualmente attivo                          *
      *                  *---------------------------------------------*
           if        rr-tip-ord           =    "C"
                     go to exp-rec-dcm-910
           else if   rr-tip-ord           =    "R"
                     go to exp-rec-dcm-920
           else if   rr-tip-ord           =    "M"
                     go to exp-rec-dcm-930
           else if   rr-tip-ord           =    "P"
                     go to exp-rec-dcm-940
           else if   rr-tip-ord           =    "F"
                     go to exp-rec-dcm-950.
       exp-rec-dcm-910.
      *                  *---------------------------------------------*
      *                  * Se start per codice                         *
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODCLI    "         to   f-key                  .
           move      w-rip-str-dcm-cod    to   rf-dcm-cod-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-dcm                 .
           if        f-sts                not  = e-not-err
                     go to exp-rec-dcm-990.
           go to     exp-rec-dcm-980.
       exp-rec-dcm-920.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "RAGKEY    "         to   f-key                  .
           move      w-rip-str-dcm-rag    to   rf-dcm-rag-key         .
           move      w-rip-str-dcm-cod    to   rf-dcm-cod-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODMNE    "         to   f-key                  .
           move      w-rip-str-dcm-mne    to   rf-dcm-cod-mne         .
           move      w-rip-str-dcm-cod    to   rf-dcm-cod-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "PRTIVA    "         to   f-key                  .
           move      w-rip-str-dcm-piv    to   rf-dcm-prt-iva         .
           move      w-rip-str-dcm-cod    to   rf-dcm-cod-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODFIS    "         to   f-key                  .
           move      w-rip-str-dcm-cfi    to   rf-dcm-cod-fis         .
           move      w-rip-str-dcm-cod    to   rf-dcm-cod-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcm"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
