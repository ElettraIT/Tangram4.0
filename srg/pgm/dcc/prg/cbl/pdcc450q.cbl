      ...
      *                                                                *
      *                    Manutenzione codici per documenti EDI       *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "CODICI PER GESTIONE FLUSSI DOCUMENTI EDI"       .
      ...
      *            *---------------------------------------------------*
               10  w-tes-sel-edi          pic  9(02)                  .
               10  w-tes-cod-edi          pic  x(20)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-cod-cli-via      pic  x(40)                  .
               10  w-rig-cod-cli-loc      pic  x(40)                  .
               10  w-rig-cod-cli-mne      pic  x(10)                  .
               10  w-rig-cod-edi          pic  x(30)                  .
           05  w-rig-002.
      ...
      *        *-------------------------------------------------------*
           05  w-exp-sel-sdi.
               10  w-exp-sel-edi-num      pic  9(02)       value 3    .
               10  w-exp-sel-edi-lun      pic  9(02)       value 40   .
               10  w-exp-sel-edi-tbl.
                   15  filler             pic  x(40) value
                            "Nessuna selezione                       ".
                   15  filler             pic  x(40) value
                            "solo Senza codice EDI                   ".
                   15  filler             pic  x(40) value
                            "solo Con codice EDI                     ".
      ...
      *                  *---------------------------------------------*
       ...
       acc-key-reg-150.
      *                  *---------------------------------------------*
      *                  * Selezione su codice EDI                     *
      *                  *---------------------------------------------*
           perform   acc-sel-edi-000      thru acc-sel-edi-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *                  * Codice EDI                                  *
      *                  *---------------------------------------------*
           perform   acc-cod-edi-000      thru acc-cod-edi-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Selezione su codice EDI                         *
      *              *-------------------------------------------------*
           perform   vis-sel-edi-000      thru vis-sel-edi-999        .
      *              *-------------------------------------------------*
      *              * Codice EDI                                      *
      *              *-------------------------------------------------*
           perform   vis-cod-edi-000      thru vis-cod-edi-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Selezione su codice EDI                     *
      *                  *---------------------------------------------*
           perform   pmt-sel-edi-000      thru pmt-sel-edi-999        .
      *                  *---------------------------------------------*
      *                  * Codice EDI                                  *
      *                  *---------------------------------------------*
           perform   pmt-cod-edi-000      thru pmt-cod-edi-999        .
       pmt-key-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Selezione su codice EDI          *
      *    *-----------------------------------------------------------*
       pmt-sel-edi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice EDI                       *
      *    *-----------------------------------------------------------*
       pmt-cod-edi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Selezione su codice EDI              *
      *    *-----------------------------------------------------------*
       acc-sel-edi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-edi-lun    to   v-car                  .
           move      w-exp-sel-edi-num    to   v-ldt                  .
           move      "NSC#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      10                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-sel-edi-tbl    to   v-txt                  .
           move      w-tes-sel-edi        to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-sel-edi-999.
       acc-sel-edi-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-sel-edi          .
       acc-sel-edi-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Selezione su codice EDI           *
      *    *-----------------------------------------------------------*
       vis-sel-edi-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           if        w-tes-sel-edi        =    02
                     move  spaces         to   w-tes-cod-edi
                     go to acc-cod-edi-999.
       acc-cod-edi-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice EDI                        *
      *    *-----------------------------------------------------------*
       vis-cod-edi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Codice EDI                                  *
      *                  *---------------------------------------------*
           perform   acc-rig-edi-000      thru acc-rig-edi-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * Codice EDI                                  *
      *                  *---------------------------------------------*
           move      w-rig-cod-edi        to   w-lin-imm-cod-edi      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              * Codice EDI                                      *
      *              *-------------------------------------------------*
           perform   vis-rig-edi-000      thru vis-rig-edi-999        .
       vis-rig-cor-999.
           exit.
      ...
      *                  * Codice EDI                                  *
      *                  *---------------------------------------------*
           perform   pmt-rig-edi-000      thru pmt-rig-edi-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *
           move      41                   to   v-pos                  .
           move      w-rig-cod-cli-via    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Localita'                                       *
      ...
      *                  *---------------------------------------------*
           if        w-rig-dpz-cli        not  = spaces
                     go to acc-rig-edi-120.
      *                  *---------------------------------------------*
      *                  * Note operative                              *
      *                  *---------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "[F1] per generare il codice automaticamente"
                                          to   v-nt1                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       acc-rig-edi-120.
      ...
      *
           if        w-rig-dpz-cli        =    spaces
                     move  "[1] "         to   v-pfk (14) 
           else      move  spaces         to   v-pfk (14)             .
      *
           move      w-rig-cod-edi        to   v-alf                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Cancellazione note operative attuali            *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-edi-999.
       acc-rig-edi-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-rig-cod-edi          .
       acc-rig-edi-300.
      *              *-------------------------------------------------*
      *              * Se F1                                           *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-rig-edi-400.
      *                  *---------------------------------------------*
      *                  * Lettura file [cli]                          *
      *                  *---------------------------------------------*
           move      w-rig-cod-cli        to   w-let-arc-cli-cod      .
           perform   let-arc-cli-000      thru let-arc-cli-999        .
           if        w-let-arc-cli-piv    =    zero
                     go to acc-rig-edi-400.
      *                  *---------------------------------------------*
      *                  * Assemblaggio con partita Iva                *
      *                  *---------------------------------------------*
           move      16                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      w-let-arc-cli-piv
                    (01 : 11)             to   w-all-str-cat (01)     .
           move      "W:ZZ"               to   w-all-str-cat (02)     .
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   w-rig-cod-edi          .   
      *                  *---------------------------------------------*
      *                  * Visualizzazione                             *
      *                  *---------------------------------------------*
           perform   vis-rig-edi-000      thru vis-rig-edi-999        .
      ...
      *              *-------------------------------------------------*
       sel-rec-dcc-100.
      *                  *---------------------------------------------*
      *                  * Selezioni su presenza codice EDI            *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da eseguire                     *
      *                      *-----------------------------------------*
      ...
      *                      * Solo senza codice EDI                   *
      *                      *-----------------------------------------*
           if        w-tes-sel-edi        =    02 and
                     rf-dcc-idn-ema       not  = spaces
                     go to sel-rec-dcc-900.
      *                      *-----------------------------------------*
      *                      * Solo con codice EDI                     *
      *                      *-----------------------------------------*
           if        w-tes-sel-edi        =    03 and
                     rf-dcc-idn-ema       =    spaces
                     go to sel-rec-dcc-900.
       sel-rec-dcc-200.
      *                  *---------------------------------------------*
      *                  * Selezione su codice EDI                     *
      *                  *---------------------------------------------*
           if        w-tes-cod-edi        =    spaces
                     go to sel-rec-dcc-800.
           if        rf-dcc-idn-ema       not  = w-tes-cod-edi
                     go to sel-rec-dcc-900.
       sel-rec-dcc-800.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dcc-via-dcc       to   w-rig-cod-cli-via      .
           move      rf-dcc-loc-dcc       to   w-rig-cod-cli-loc      .
           move      rf-dcc-idn-ema       to   w-rig-cod-edi          .
       car-eff-rig-700.
      *              *-------------------------------------------------*
      ...
      *              * Codice EDI                                      *
      *              *-------------------------------------------------*
           move      w-rig-cod-edi        to   rf-dcc-idn-ema         .
      *              *-------------------------------------------------*
      *              * Forced put record                               *
      *              *-------------------------------------------------*
           move      "FP"                 to   f-ope                  .
