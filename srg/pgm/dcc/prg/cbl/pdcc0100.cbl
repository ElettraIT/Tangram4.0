      ...
      *                       Ultima revisione:    NdK del 27/05/25    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella Codici lingue              *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Utilizzare ISO 639-1 (codici a due lettere) o ISO 
      -              "639-3 (codici a tre lettere)  "
                                          to   v-nt1                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-lng        to   w-all-str-alf          .
      ...
      *                  * Descrizione lingua                          *
      *                  *---------------------------------------------*
           perform   acc-des-lng-000      thru acc-des-lng-999        .
      ...
      *              * Descrizione lingua                              *
      *              *-------------------------------------------------*
           perform   pmt-des-lng-000      thru pmt-des-lng-999        .
       pmt-tes-reg-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione lingua               *
      *    *-----------------------------------------------------------*
       pmt-des-lng-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione lingua           *
      *    *-----------------------------------------------------------*
       acc-des-lng-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-lng (1)    =    spaces
                     go to acc-des-lng-100.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-nok-100.
      *              *-------------------------------------------------*
      *              * Controllo su Descrizione lingua                 *
      *              *-------------------------------------------------*
           if        w-tes-des-lng (1)    not  = spaces
                     go to cnt-tdo-nok-800.
           move      "Manca la descrizione per il codice lingua       "
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-lng (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-lng        to   rf-zln-cod-lng         .
           move      "pgm/dcc/fls/ioc/obj/iofzln"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zln]                        *
      *                          *-------------------------------------*
           move      rf-zln-des-lng       to   w-tes-des-lng (1)      .
           move      rf-zln-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zln]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zln-000      thru wrt-rec-zln-999        .
      ...
      *                      * Rewrite record [zln]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zln-000      thru rew-rec-zln-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zln]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zln-000      thru del-rec-zln-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zln]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zln-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-lng (1)    to   rf-zln-des-lng         .
           move      w-tes-alx-exp (1)    to   rf-zln-alx-exp         .
       cmp-rec-zln-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zln]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zln-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zln-000      thru cmp-rec-zln-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
