      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per i programmi pdcc9001/2 :      *
      *                                                                *
      *                    Cancellazione anagrafiche commerciali       *
      *                    clienti                                     *
      *                                                                *
      *                    - pdcc9001 : Stampa di controllo            *
      *                    - pdcc9002 : Cancellazione vera e propria   *
      *                                                                *
      *================================================================*
           ...
           05  w-exp-tip-ope.
               ...
               10  w-exp-tip-ope-tbl.
                   15  filler             pic  x(45) value
                      "Stampa di controllo                          " .
                   15  filler             pic  x(45) value
                      "Cancellazione anagrafiche commerciali clienti" .
      ...
      *              *-------------------------------------------------*
           if        rr-tip-ope           =    01
                     move  "pgm/dcc/prg/obj/pdcc9001  "
                                          to   i-exe-pat
           else      move  "pgm/dcc/prg/obj/pdcc9002  "
                                          to   i-exe-pat              .
           call      i-exe-pat                                        .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tip-ope           =    01
                     move  "pdcc9001  "   to   i-exe-pro
           else      move  "pdcc9002  "   to   i-exe-pro              .
           if        rr-tip-ope           =    01
                     move  "pgm/dcc/prg/obj/pdcc9001  "
                                          to   i-exe-pat
           else      move  "pgm/dcc/prg/obj/pdcc9002  "
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "   - N.B.: Il programma cancella tutte le anagrafi
      -              "che commerciali dei clienti   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "           per le quali non trova le corrispondent
      -              "i anagrafiche contabili.      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       pmt-ric-sel-999.
      ...
      *              *-------------------------------------------------*
      *              * Rettifica della richiesta di selezione stampa   *
      *              *-------------------------------------------------*
           if        rr-tip-ope           =    01
