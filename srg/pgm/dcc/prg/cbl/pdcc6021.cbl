      ...
      *                       Ultima revisione:    NdK del 15/06/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma dcc602   *
      *                                                                *
      *                    Stampa anagrafica clienti per il marketing  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA ANAGRAFICHE CLIENTI PER MARKETING"       .
      ...
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      rf-dcm-cod-mne       to   w-stp-t01-col-001
                                              (w-stp-t01-cco-001)     .
      *                          *-------------------------------------*
      *                          * A fine colonna                      *
      *                          *-------------------------------------*
      ...
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      rf-dcm-rs1-cli       to   w-stp-t01-col-002
                                              (w-stp-t01-cco-002)     .
       prn-liv-det-p01-220.
      *                      *-----------------------------------------*
      *                      * Ragione sociale 2                       *
      ...
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      rf-dcm-rs2-cli       to   w-stp-t01-col-002
                                              (w-stp-t01-cco-002)     .
       prn-liv-det-p01-290.
      *                      *-----------------------------------------*
      *                      * Fine colonna 2                          *
      ...
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      rf-dcm-loc-cli       to   w-stp-t01-col-003
                                              (w-stp-t01-cco-003)     .
       prn-liv-det-p01-320.
      *                      *-----------------------------------------*
      *                      * Indirizzo                               *
      ...
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      rf-dcm-via-cli       to   w-stp-t01-col-003
                                              (w-stp-t01-cco-003)     .
       prn-liv-det-p01-390.
      *                      *-----------------------------------------*
      *                      * Fine colonna 3                          *
      ...
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      rf-dcm-cod-mne       to   w-stp-t01-col-004
                                              (w-stp-t01-cco-004)     .
      *                          *-------------------------------------*
      *                          * A fine colonna                      *
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "ELENCO ANAGRAFICHE CLIENTI PER MARKETING"
