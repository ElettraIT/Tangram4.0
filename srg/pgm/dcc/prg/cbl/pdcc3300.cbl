      ...
      *                       Ultima revisione:    NdK del 04/10/21    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase dcc330, nella sua globalita', esegue i tipi di opera-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * DUPCLI      Duplicazione prezzi da un cliente ad un altro      *
      * DUPLST      Duplicazione prezzi da un listino ad un cliente    *
      * AGGPNC      Aggiornamenti automatici prezzi netti cliente      *
      * AGGPNP      Aggiornamenti automatici prezzi piu' clienti       *
      * AZZPNC      Azzeramento prezzi netti per un cliente            *
      * CANPNC      Cancellazione prezzi netti per un cliente          *
      * STOPNC      Storicizzazione prezzi netti di uno o piu' clienti *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'dcc330'           *
      *              *-------------------------------------------------*
           perform   fas-dcc-330-000      thru fas-dcc-330-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Duplicazione prezzi da un cliente ad un altro     
      -              " DUPCLI     pdcc330a  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Duplicazione prezzi da un listino ad un cliente   
      -              " DUPLST     pdcc330b  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Aggiornamenti automatici prezzi netti cliente     
      -              " AGGPNC     pdcc330c  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Aggiornamenti prezzi netti per piu' clienti       
      -              " AGGPNP     pdcc330f  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Azzeramento prezzi netti per un cliente           
      -              " AZZPNC     pdcc330d  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Cancellazione prezzi netti per un cliente         
      -              " CANPNC     pdcc330e  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Storicizzazione prezzi netti di uno o piu' clienti
      -              " STOPNC     pdcc330h  "
                                          to   w-top-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-top-200.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-dcc-330-300
           else if   v-key                =    "PRSC"
                     go to fas-dcc-330-400
           else if   v-key                =    "NXSC"
                     go to fas-dcc-330-450
           else if   v-key                =    "DOWN"
                     go to fas-dcc-330-500
           else if   v-key                =    "EXIT"
                     go to fas-dcc-330-250
           else      go to fas-dcc-330-200.
       fas-dcc-330-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-ope        =    zero
                     go to fas-dcc-330-330.
           move      zero                 to   w-top-ele-inx          .
       fas-dcc-330-322.
           add       1                    to   w-top-ele-inx          .
           if        w-top-ele-inx        >    w-top-ele-num
                     go to fas-dcc-330-340.
           if        w-top-num-top
                    (w-top-ele-inx)       =    w-key-num-ope
                     go to fas-dcc-330-350
           else      go to fas-dcc-330-322.
       fas-dcc-330-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-dcc-330-630
           else if   v-key                =    "PRSC"
                     go to fas-dcc-330-600
           else if   v-key                =    "NXSC"
                     go to fas-dcc-330-610
           else if   v-key                =    "UP  "
                     go to fas-dcc-330-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-dcc-330-650
           else if   v-key                =    "EXIT"
                     go to fas-dcc-330-660
           else      go to fas-dcc-330-570.
       fas-dcc-330-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-dcc-330-626
           else      go to fas-dcc-330-628.
       fas-dcc-330-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-dcc-330-636
           else      go to fas-dcc-330-638.
       fas-dcc-330-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-dcc-330-725
           else      go to fas-dcc-330-750.
       fas-dcc-330-725.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           move      s-pat                to   w-ovy-exe-pat          .
      *              *-------------------------------------------------*
      *              * Chiamata pathname dell'overlay di esecuzione    *
      *              *-------------------------------------------------*
