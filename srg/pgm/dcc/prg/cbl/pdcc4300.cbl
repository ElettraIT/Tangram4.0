      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pdcc4301:        *
      *                                                                *
      *                    Stampa descrizioni prodotti per un cliente  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA DESCRIZIONE PRODOTTI PER CLIENTE "       .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-snx-des.
               10  w-exp-snx-des-num      pic  9(02)       value 3    .
               10  w-exp-snx-des-lun      pic  9(02)       value 30   .
               10  w-exp-snx-des-tbl.
                   15  filler             pic  x(30) value
                            "Nessuna                       "          .
                   15  filler             pic  x(30) value
                            "Solo descrizioni esistenti    "          .
                   15  filler             pic  x(30) value
                            "Solo senza descrizioni        "          .
      ...
      *                  *---------------------------------------------*
           perform   acc-snx-des-000      thru acc-snx-des-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * Si/no stampa descrizioni nulle                  *
      *              *-------------------------------------------------*
           perform   pmt-snx-des-000      thru pmt-snx-des-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Prompt : Si/no stampa descrizioni nulle                   *
      *    *-----------------------------------------------------------*
       pmt-snx-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Si/no stampa descrizioni nulle             *
      *    *-----------------------------------------------------------*
       acc-snx-des-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        rr-snx-des           not  = zero
                     go to acc-snx-des-100.
           move      02                   to   rr-snx-des             .
       acc-snx-des-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-des-lun    to   v-car                  .
           move      w-exp-snx-des-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      12                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-des-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           if        w-cnt-sts-imp-ric    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
           move      rr-snx-des           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-des-999.
       acc-snx-des-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-snx-des             .
       acc-snx-des-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
