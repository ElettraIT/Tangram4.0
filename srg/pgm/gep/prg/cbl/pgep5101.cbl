      ...
      *                                   Fase:    gep510              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 21/04/94    *
      *                       Ultima revisione:    NdK del 26/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma gep510   *
      *                                                                *
      *                    Lista scadenze in circolazione per data     *
      *                                                                *
      *================================================================*
      ...
      *        * - 04 : Ricevute banc. e Tratte                        *
      *        * - 05 : Solo Incassi elettronici                       *
      *        * - 06 : Solo Ri.Ba.                                    *
      *        * - 07 : Solo Conferme d'Ordine                         *
      *        * - 08 : Solo M.Av.                                     *
      *        * - 09 : Solo R.I.D.                                    *
      *        * - 10 : Solo Ricevute bancarie                         *
      *        * - 11 : Solo Tratte                                    *
      *        * - 12 : Solo Paghero' cambiari                         *
      *        *-------------------------------------------------------*
      ...
      *        * - 02 : Ri.Ba.                                         *
      *        * - 03 : Conferme d'Ordine                              *
      *        * - 04 : M.Av.                                          *
      *        * - 05 : R.I.D.                                         *
      *        * - 06 : Ricevute bancarie                              *
      *        * - 07 : Tratte                                         *
      *        * - 08 : Paghero' cambiari                              *
      *        *-------------------------------------------------------*
           05  rr-sce-tsc.
               10  rr-snx-tsc occurs 08   pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Codice ns. banca nel caso di scadenza in circola- *
      *            * zione                                             *
      *            *---------------------------------------------------*
               10  w-det-srd-sdb-cbp      pic  x(10)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-tbl-tpg.
               10  w-tbl-tpg-001.
                   15  filler             pic  x(04) value "RD  "     .
                   15  filler             pic  x(04) value "IE  "     .
                   15  filler             pic  x(04) value "RIBA"     .
                   15  filler             pic  x(04) value "CDO "     .
                   15  filler             pic  x(04) value "MAV "     .
                   15  filler             pic  x(04) value "RID "     .
                   15  filler             pic  x(04) value "BB  "     .
                   15  filler             pic  x(04) value "CCP "     .
                   15  filler             pic  x(04) value "RB  "     .
                   15  filler             pic  x(04) value "TR  "     .
                   15  filler             pic  x(04) value "PC  "     .
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Su codice banca se necessario       *
      *                          *-------------------------------------*
           if        rr-cod-cbp           =    spaces
                     go to stp-srt-inp-160.
           if        w-det-srd-sdb-cbp    not  = rr-cod-cbp
                     go to stp-srt-inp-120.
       stp-srt-inp-160.
      *                          *-------------------------------------*
      *                          * Su status scadenza                  *
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "  Numero        Tipo      Data      Importo   Codi
      -              "ce  Dip.              Ragione sociale             
      -              "  Numero     Data      Importo  "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *                  *---------------------------------------------*
      *                  * Normalizzazione iniziale ns. banca          *
      *                  *---------------------------------------------*
           move      spaces               to   w-det-srd-sdb-cbp      .
       det-srd-sdb-050.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       det-srd-sdb-625.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione codice ns. banca solo   *
      *                      * se scadenza in circolazione             *
      *                      *-----------------------------------------*
           if        w-det-srd-sdb-suo    not  = "PRE" and
                     w-det-srd-sdb-suo    not  = "ACT" and
                     w-det-srd-sdb-suo    not  = "ACD"
                     go to det-srd-sdb-650.
           move      rf-ddp-cod-cbp       to   w-det-srd-sdb-cbp      .
       det-srd-sdb-650.
      *                      *-----------------------------------------*
