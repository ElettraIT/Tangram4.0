      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [zpg]            *
      *                                                                *
      *                    Anagrafico codici di pagamento              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   INTERROGAZIONE CODICI DI PAGAMENTO   "       .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-scm.
               10  w-exp-tip-scm-num      pic  9(02)       value 3    .
      ...
      *        *       cine                                            *
      *        *-------------------------------------------------------*
           05  w-vis-nnn-gio              pic  9(04)                  .
           05  w-vis-nnn-gio-r redefines
               w-vis-nnn-gio.
               10  w-vis-nnn-gio-mes      pic  9(02)                  .
               10  w-vis-nnn-gio-gio      pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-rip-str.
      *        *-------------------------------------------------------*
      *        * Work-area per ripristino Start su [zpg]               *
      *        *-------------------------------------------------------*
           05  w-rip-str-zpg.
      *            *---------------------------------------------------*
      *            * Flag di End-of-file                               *
      *            *---------------------------------------------------*
               10  w-rip-str-zpg-eof      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Parametri di Start                                *
      *            *---------------------------------------------------*
               10  w-rip-str-zpg-cod      pic  9(07)                  .
               10  w-rip-str-zpg-des      pic  x(40)                  .
               10  w-rip-str-zpg-mne      pic  x(10)                  .

      *    *===========================================================*
      *    * Work-area per ridefinizione contenuto del mark-point      *
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-cod-pag              pic  9(07)                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su codici di pagamento :      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-zpg-cod      .
           move      14                   to   w-cod-mne-zpg-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zpg-ope      .
           move      rr-cod-max           to   w-cod-mne-zpg-cod      .
           move      14                   to   w-cod-mne-zpg-lin      .
           move      52                   to   w-cod-mne-zpg-pos      .
           move      zero                 to   w-cod-mne-zpg-dln      .
           move      zero                 to   w-cod-mne-zpg-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-rip-str-zpg-eof      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zpg-cod-pag         .
           move      "pgm/gep/fls/ioc/obj/iofzpg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-zpg-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-mne-min           to   rf-zpg-cod-mne         .
           move      zero                 to   rf-zpg-cod-pag         .
           move      "pgm/gep/fls/ioc/obj/iofzpg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun codice di pagamento entro i limiti assegnat
      -              "i !"                to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zpg]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/gep/fls/ioc/obj/iofzpg"
                                          to   s-pat                  .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zpg-cod-pag       <    rr-cod-min or
                     rf-zpg-cod-pag       >    rr-cod-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zpg-des-key       <    rr-des-min or
                     rf-zpg-des-key       >    rr-des-max
                     go to qry-sel-rec-900.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zpg-cod-mne       <    rr-mne-min or
                     rf-zpg-cod-mne       >    rr-mne-max
                     go to qry-sel-rec-900.
       qry-sel-rec-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      34                   to   v-pos                  .
           move      rf-zpg-des-pag       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zpg-cod-pag       to   w-mpn-cod-pag          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "EXPD"
                     go to qry-trt-fun-999.
      *                  *---------------------------------------------*
      *                  * Routine per Expand su record [zpg]          *
      *                  *---------------------------------------------*
           perform   exp-rec-zpg-000      thru exp-rec-zpg-999        .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       exp-rec-zpg-000.
      *              *-------------------------------------------------*
      *              * Salvataggio parametri per Start su [zpg]        *
      *              *-------------------------------------------------*
           if        w-rip-str-zpg-eof    not  = spaces
                     go to exp-rec-zpg-100.
           move      rf-zpg-cod-pag       to   w-rip-str-zpg-cod      .
           move      rf-zpg-des-key       to   w-rip-str-zpg-des      .
           move      rf-zpg-cod-mne       to   w-rip-str-zpg-mne      .
       exp-rec-zpg-100.
      *              *-------------------------------------------------*
      *              * Video in 'OFF'                                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Prompt per Codice di pagamento              *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      22                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per Decorrenza prima scadenza        *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      22                   to   v-car                  .
           move      12                   to   v-lin                  .
           move      03                   to   v-pos                  .
           move      "Decorrenza 1^ scad.  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per Giorni di intervallo             *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      22                   to   v-car                  .
           move      13                   to   v-lin                  .
           move      03                   to   v-pos                  .
           move      "Giorni di intervallo :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per Scadenza nel mese                *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      22                   to   v-car                  .
           move      15                   to   v-lin                  .
           move      03                   to   v-pos                  .
           move      "Scadenza nel mese    :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per Giorno fisso                     *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      22                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per Utente ultimo aggiornamento      *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      20                   to   v-car                  .
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per Programma ultimo aggiornamento   *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      20                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "CODPAG    "         to   f-key                  .
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-cod-pag        to   rf-zpg-cod-pag         .
           move      "pgm/gep/fls/ioc/obj/iofzpg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-zpg-tip-pag       to   v-num                  .
           if        v-num                =    99
                     move  w-exp-tip-pag-num
                                          to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                      * Test se a 'n' giorni                    *
      *                      *-----------------------------------------*
           if        rf-zpg-dec-prs       not  = 12
                     go to exp-rec-zpg-710.
      *                      *-----------------------------------------*
      *                      * Recupero 'n' giorni                     *
      *                      *-----------------------------------------*
           move      rf-zpg-dap-mes       to   w-vis-nnn-gio-mes      .
           move      rf-zpg-dap-gio       to   w-vis-nnn-gio-gio      .
      *                      *-----------------------------------------*
      *                      * Editing 'n' giorni                      *
      *                      *-----------------------------------------*
           move      "ED"                 to   v-ope                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-zpg-dec-prs       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       exp-rec-zpg-720.
      *                  *---------------------------------------------*
      *                  * Giorno e mese di scadenza fissa             *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se significativo                   *
      *                      *-----------------------------------------*
           if        rf-zpg-dec-prs       not  = 02
                     go to exp-rec-zpg-730.
      *                      *-----------------------------------------*
      *                      * Due punti di prompt                     *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-zpg-tip-scm       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Giorno fisso di scadenza nel mese           *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      02                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
           if        rf-zpg-ide-dat       =    zero
                     go to exp-rec-zpg-760.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      16                   to   v-lin                  .
           move      69                   to   v-pos                  .
           move      rf-zpg-ide-dat       to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       exp-rec-zpg-760.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-zpg-ide-ute       =    spaces
                     go to exp-rec-zpg-770.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      10                   to   v-car                  .
           move      17                   to   v-lin                  .
      ...
      *                  *---------------------------------------------*
           if        rf-zpg-ide-fas       =    spaces
                     go to exp-rec-zpg-800.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      08                   to   v-car                  .
           move      18                   to   v-lin                  .
      ...
      *                  *---------------------------------------------*
           if        w-rip-str-zpg-eof    not  = spaces
                     go to exp-rec-zpg-999.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo di Start    *
      *                  * attualmente attivo                          *
      *                  *---------------------------------------------*
           if        rr-tip-ord           =    "C"
                     go to exp-rec-zpg-910
           else if   rr-tip-ord           =    "D"
                     go to exp-rec-zpg-920
           else if   rr-tip-ord           =    "M"
                     go to exp-rec-zpg-930.
       exp-rec-zpg-910.
      *                  *---------------------------------------------*
      *                  * Se start per codice                         *
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODPAG    "         to   f-key                  .
           move      w-rip-str-zpg-cod    to   rf-zpg-cod-pag         .
           move      "pgm/gep/fls/ioc/obj/iofzpg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-zpg                 .
           if        f-sts                not  = e-not-err
                     go to exp-rec-zpg-990.
           go to     exp-rec-zpg-980.
       exp-rec-zpg-920.
      *                  *---------------------------------------------*
      *                  * Se start per descrizione                    *
      *                  *---------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DESKEY    "         to   f-key                  .
           move      w-rip-str-zpg-des    to   rf-zpg-des-key         .
           move      w-rip-str-zpg-cod    to   rf-zpg-cod-pag         .
           move      "pgm/gep/fls/ioc/obj/iofzpg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODMNE    "         to   f-key                  .
           move      w-rip-str-zpg-mne    to   rf-zpg-cod-mne         .
           move      w-rip-str-zpg-cod    to   rf-zpg-cod-pag         .
           move      "pgm/gep/fls/ioc/obj/iofzpg"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
