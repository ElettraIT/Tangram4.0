      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Cliente corrispondente                            *
      *            *---------------------------------------------------*
               10  srt-cor-cli            pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " CORRISPONDENTI ITALIANI CLIENTI ESTERI "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-cnt.
      *        *-------------------------------------------------------*
      *        * Flcei di controllo uscita da routines fondamentali    *
      *        *-------------------------------------------------------*
           05  w-cnt-flg.
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Flcei di tipo uscita da routines di accettazione      *
      *        *-------------------------------------------------------*
           05  w-cnt-tus.
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Flcei di uscita da controlli su tasto Do              *
      *        *-------------------------------------------------------*
           05  w-cnt-tdo.
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Flcei di controllo su modalita' di funzionamento      *
      *        *-------------------------------------------------------*
           05  w-cnt-mfu.
      *            *---------------------------------------------------*
      *            * Tipo impostazione                                 *
      ...
      *        *-------------------------------------------------------*
      *        * Flcei di controllo su status impostazioni             *
      *        *-------------------------------------------------------*
           05  w-cnt-sts-imp.
      *            *---------------------------------------------------*
      *            * Impostazione chiave                               *
      ...
      *        *-------------------------------------------------------*
      *        * Flcei di controllo su status visualizzazione prompts  *
      *        *-------------------------------------------------------*
           05  w-cnt-sts-pmt.
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Flcei di controllo su status visualizzazione dati     *
      *        *-------------------------------------------------------*
           05  w-cnt-sts-vis.
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-rig-val-aep     occurs 2.
               ...
               10  w-rig-cor-cli          pic  9(07)                  .
               10  w-rig-cor-cli-rag      pic  x(20)                  .
      ...
      *                *-----------------------------------------------*
                   15  filler             pic  x(03)                  .
                   15  w-lin-imm-cor-cli  pic  x(07)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-cor-rag  pic  x(40)                  .
                   15  filler             pic  x(25)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Work per Ctl di non involuzione su codice cliente     *
      *        *-------------------------------------------------------*
           05  w-ctl-non-inv.
               10  w-ctl-non-inv-flg      pic  x(01)                  .
               10  w-ctl-non-inv-mer      pic  x(65)                  .
               10  w-ctl-non-inv-cli      pic  9(07)                  .
               10  w-ctl-non-inv-cor      pic  9(07)                  .
      ...
      *    *===========================================================*
      *    * Work per scrittura record [cei]                           *
      *    *-----------------------------------------------------------*
       01  w-scr-rec-cei.
      *        *-------------------------------------------------------*
      *        * Comodo per assegnazione progressivo                   *
      *        *-------------------------------------------------------*
           05  w-scr-rec-cei-prg          pic  9(05)                  .
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "pgm/gep/fls/ioc/obj/iofcei"
                                          to   s-pat                  .
      ...
      *    *-----------------------------------------------------------*
       cnc-sub-cat-000.
           cancel    "pgm/gep/prg/obj/pgep2202"                       .
       cnc-sub-cat-999.
           exit.
      ...
      *              * Nominativo agente                               *
      *              *-------------------------------------------------*
           perform   vis-cod-cli-nom-000  thru vis-cod-cli-nom-999    .
       vis-key-reg-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Assestamento flcei di controllo visualizza- *
      ...
      *                  * Codice super-agente                         *
      *                  *---------------------------------------------*
           perform   acc-cor-cli-000      thru acc-cor-cli-999        .
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-rig-cor-cli (1)    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-cor-cli      .
      *                      *-----------------------------------------*
      *                      * Ragione sociale corrispondente          *
      *                      *-----------------------------------------*
           if        w-rig-cor-cli (1)    =    zero
                     move  "(nessun cliente)  "
                                          to   w-lin-imm-cor-rag
           else      move  w-rig-cor-cli-rag (1)
                                          to   w-lin-imm-cor-rag      .
       vis-lin-cor-800.
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Nr.       Cliente italiano corrispondente per paga
      -              "menti                        "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              * Codice corrispondente                           *
      *              *-------------------------------------------------*
           perform   vis-cor-cli-000      thru vis-cor-cli-999        .
           perform   vis-cor-cli-rag-000  thru vis-cor-cli-rag-999    .
       vis-rig-cor-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-rig-cor-cli (1)    to   w-sav-cor-cli          .
       acc-cor-cli-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-sav-cor-cli        to   w-rig-cor-cli (1)      .
       acc-cor-cli-105.
      *                  *---------------------------------------------*
      *                  * Parametri generici                          *
      *                  *---------------------------------------------*
           move      "AC"                 to   w-cod-mne-cli-ope      .
           move      w-rig-cor-cli (1)    to   w-cod-mne-cli-cod      .
           move      19                   to   w-cod-mne-cli-lin      .
           move      30                   to   w-cod-mne-cli-pos      .
           move      19                   to   w-cod-mne-cli-rln      .
           move      41                   to   w-cod-mne-cli-rps      .
           move      "<B"                 to   v-edm                  .
      *                  *---------------------------------------------*
      *                  * Tasti funzione                              *
      ...
      *                  *---------------------------------------------*
       ...
       acc-cor-cli-110.
           perform   cod-mne-cli-cll-000  thru cod-mne-cli-cll-999    .
           if        w-cod-mne-cli-ope    =    "F+"
                     go to acc-cor-cli-115.
           if        w-cod-mne-cli-ope    =    "AC"
                     go to acc-cor-cli-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cor-cli-115.
           perform   cod-mne-cli-foi-000  thru cod-mne-cli-foi-999    .
           go to     acc-cor-cli-110.
       acc-cor-cli-120.
           move      w-cod-mne-cli-cod    to   v-num                  .
       acc-cor-cli-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces
                     go to acc-cor-cli-400.
       acc-cor-cli-250.
      *              *-------------------------------------------------*
      *              * Se Slct                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "SLCT"
                     go to acc-cor-cli-300
           else      go to acc-cor-cli-350.
       acc-cor-cli-300.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-cor-cli-310.
           ...
           if        w-cnt-wrk-ctr-001   =    zero
                     go to acc-cor-cli-320.
           if        w-cnt-slc-rap-chr
                    (w-cnt-wrk-ctr-001)   <    "0"   or
                     w-cnt-slc-rap-chr
                    (w-cnt-wrk-ctr-001)   >    "9"
                     go to acc-cor-cli-310.
      ...
      *                  *---------------------------------------------*
           move      v-num                to   w-rig-cor-cli (1)      .
      *                  *---------------------------------------------*
      *                  * Lettura archivio [age]                      *
      *                  *---------------------------------------------*
           move      w-rig-cor-cli (1)    to   w-let-arc-cli-cod      .
           perform   let-arc-cli-000      thru let-arc-cli-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati agente                  *
      *                  *---------------------------------------------*
           move      w-let-arc-cli-rag    to   w-rig-cor-cli-rag (1)  .
      *                  *---------------------------------------------*
      *                  * Visualizzazione dati agente                 *
      *                  *---------------------------------------------*
           perform   vis-cor-cli-rag-000  thru vis-cor-cli-rag-999    .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice cliente corrispondente     *
      *    *-----------------------------------------------------------*
       vis-cor-cli-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Cliente corrispondente, ragione   *
      *    *                         sociale                           *
      *    *-----------------------------------------------------------*
       vis-cor-cli-rag-000.
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "CLICOR    "         to   f-key                  .
           move      "NL"                 to   f-cfr                  .
           move      w-tes-cod-cli        to   rf-cei-cod-cli         .
      ...
      *                  *---------------------------------------------*
           if        rf-cei-cod-cli       not  = w-tes-cod-cli
                     go to  rou-let-reg-900.
      *                  *---------------------------------------------*
      ...
      *                          * record [cei]                        *
      *                          *-------------------------------------*
           move      rf-cei-num-prg       to   w-rig-num-prg (1)      .
           move      rf-cei-cor-cli       to   w-rig-cor-cli (1)      .
           move      rf-cei-ide-dat       to   w-rig-ide-dat (1)      .
           move      rf-cei-ide-ute       to   w-rig-ide-ute (1)      .
           move      rf-cei-ide-fas       to   w-rig-ide-fas (1)      .
           move      rf-cei-alx-exp       to   w-rig-alx-exp (1)      .
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-cei-num-prg       to   w-cat-rig-prg          .
           move      w-rig                to   w-cat-rig-buf          .
           perform   cll-sub-cat-000      thru cll-sub-cat-999        .
      *                  *---------------------------------------------*
      *                  * Riciclo a lettura [cei] successivo          *
      *                  *---------------------------------------------*
           go to     rou-let-reg-200.
       rou-let-reg-900.
      *              *-------------------------------------------------*
      ...
      *              * Delete [cei]                                    *
      *              *-------------------------------------------------*
           perform   del-rec-cei-000      thru del-rec-cei-999        .
      *              *-------------------------------------------------*
      ...
      *              * dei records [cei] ordinati per data validita'   *
      *              *-------------------------------------------------*
           sort      srt                  on   ascending srt-key
                     input  procedure     is   stp-srt-inp-000
                                          thru stp-srt-inp-999
                     output procedure     is   scr-rec-cei-000
                                          thru scr-rec-cei-999        .
       scr-mov-fil-300.
       scr-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [cei]                                    *
      *    *-----------------------------------------------------------*
       scr-rec-cei-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione progressivo                     *
      *              *-------------------------------------------------*
           move      zero                 to   w-scr-rec-cei-prg      .
      *              *-------------------------------------------------*
      *              * Se modifica                                     *
      *              *-------------------------------------------------*
           if        w-cnt-mfu-tip-fun    not  = "M"
                     go to scr-rec-cei-200.
       scr-rec-cei-100.
      *              *-------------------------------------------------*
      *              * Delete record file righe [cei]                  *
      *              *-------------------------------------------------*
           perform   del-mov-fil-000      thru del-mov-fil-999        .
       scr-rec-cei-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           return    srt    at end
                            go to scr-rec-cei-900                     .
       scr-rec-cei-400.
      *              *-------------------------------------------------*
      *              * Incremento progressivo                          *
      *              *-------------------------------------------------*
           add       100                  to   w-scr-rec-cei-prg      .
      *              *-------------------------------------------------*
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-cei-000      thru cmp-rec-cei-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *                      * Data di validita'                       *
      *                      *-----------------------------------------*
           move      w-rig-cor-cli (1)    to   srt-cor-cli            .
       stp-srt-inp-440.
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-cei-ide-dat         .
           move      s-ute                to   rf-cei-ide-ute         .
           move      s-fas                to   rf-cei-ide-fas         .
           move      w-tes-cod-cli        to   rf-cei-cod-cli         .
           move      w-scr-rec-cei-prg    to   rf-cei-num-prg         .
           move      w-rig-cor-cli (1)    to   rf-cei-cor-cli         .
           move      w-rig-alx-exp (1)    to   rf-cei-alx-exp         .
       cmp-rec-cei-999.
           exit.

      *    *===========================================================*
      *    * Cancellazione record righe [cei]                          *
      *    *-----------------------------------------------------------*
       del-rec-cei-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-tes-cod-cli        to   rf-cei-cod-cli         .
           move      w-rig-num-prg (2)    to   rf-cei-num-prg         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione codice cliente             *
      *    *-----------------------------------------------------------*
