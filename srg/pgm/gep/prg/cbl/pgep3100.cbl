      ...
      *                                   Fase:    gep310              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 26/04/95    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pgep3101:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       pmt-lit-not-000.
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Per ogni cliente questo programma mette a confront
      -              "o:                            "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       - Il saldo che si desume dall'analisi di po
      -              "rtafoglio                     "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *
           ...
           move      13                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Lo stampato evidenziera' solamente i clienti per c
      -              "ui c'e' una discordanza,      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *
           ...
           move      16                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       - Identificazione del cliente              
      -              "                              "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
