      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pgep5501:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-tbl.
      *        *-------------------------------------------------------*
      *        * Tabella prpmts per selezione tipi pagamento           *
      *        *-------------------------------------------------------*
           05  w-tbl-tpg.
               10  w-tbl-tpg-001.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per selezione status scadenze     *
      *    *-----------------------------------------------------------*
       pmt-sts-scd-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per selezione status effetti      *
      *    *-----------------------------------------------------------*
       pmt-sts-eff-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per tipo evidenziazione           *
      *    *-----------------------------------------------------------*
       pmt-tip-evd-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo scadenza da *
      *                  * includere scelto                            *
      *                  *---------------------------------------------*
