      ...
      *                                                                *
      *                    Interrogazione su pagamenti a cliente       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Modalita' di pagamento da ricercare                   *
      *        * - 00 : Tutti                                          *
      *        * - 21 : Per Contanti                                   *
      *        * - 22 : Con Assegno                                    *
      *        * - 23 : Per Bonifico Bancario                          *
      *        * - 24 : Per C/C Postale                                *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Modalita' di pagamento da ricercare        *
      *        *-------------------------------------------------------*
           05  w-exp-mod-rsd.
      ...
      *              *-------------------------------------------------*
      *              * Prompt modalita' pagamento da ricercare         *
      *              *-------------------------------------------------*
           perform   pmt-mod-rsd-000      thru pmt-mod-rsd-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione modalita' pagamento da ricer-   *
      *              * care                                            *
      *              *-------------------------------------------------*
       ...
       pmt-cod-cbp-000.
           ...
           if        rr-mod-rsd           =    21
                     move  "Su codice nostra Cassa     :"
                                          to   v-alf
           else if   rr-mod-rsd           =    22 or
                     rr-mod-rsd           =    23
                     move  "Su codice nostra Banca     :"
                                          to   v-alf
           else if   rr-mod-rsd           =    24
      ...
      *    *===========================================================*
      *    * Accettazione : Modalita' pagamento da ricercare           *
      *    *-----------------------------------------------------------*
       acc-mod-rsd-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           if        rr-mod-rsd           =    00
                     move  01             to   v-num
           else if   rr-mod-rsd           =    21
                     move  02             to   v-num
           else if   rr-mod-rsd           =    22
                     move  03             to   v-num
           else if   rr-mod-rsd           =    23
                     move  04             to   v-num
           else if   rr-mod-rsd           =    24
                     move  05             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  21             to   rr-mod-rsd
           else if   v-num                =    03
                     move  22             to   rr-mod-rsd
           else if   v-num                =    04
                     move  23             to   rr-mod-rsd
           else if   v-num                =    05
                     move  24             to   rr-mod-rsd
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo su modalita' pagamento da ricercare   *
      *              *-------------------------------------------------*
           if        rr-mod-rsd           =    zero or
                     rr-mod-rsd           =    21   or
                     rr-mod-rsd           =    22   or
                     rr-mod-rsd           =    23   or
                     rr-mod-rsd           =    24
                     go to tdo-ric-sel-300.
           move      "Modalita' di pagamento da ricercare errato        
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
           go to     tdo-ric-sel-999.
      ...
      *                  *---------------------------------------------*
           move      spaces               to   rr-dpz-cli-loc         .
      *                  *---------------------------------------------*
      *                  * Modalita' pagamento da ricercare            *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Se non esiste una variabile di i.p.c.   *
      *                      * relativa alla modalita' pagamento :     *
      ...
      *                      *-----------------------------------------*
           if        w-ipc-mod-rsd-val    <    21 or
                     w-ipc-mod-rsd-val    >    24
                     go to nor-ric-sel-460.
      *                      *-----------------------------------------*
      ...
      *              * Messaggio di errore                             *
      *              *-------------------------------------------------*
           move      "Nessun pagamento entro i limiti assegnati !       
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
       qry-nes-ela-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       qry-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Selezione su modalita' pagamento                *
      *              *-------------------------------------------------*
           if        rr-mod-rsd           not  = zero
                     go to qry-sel-rec-210.
           if        rf-rsd-mod-rsd       =    21 or
                     rf-rsd-mod-rsd       =    22 or
                     rf-rsd-mod-rsd       =    23 or
                     rf-rsd-mod-rsd       =    24
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      24                   to   v-pos                  .
           if        rf-rsd-mod-rsd       =    21
                     move  "Contanti          "
                                          to   v-alf
           else if   rf-rsd-mod-rsd       =    22
                     move  "Assegno           "
                                          to   v-alf
           else if   rf-rsd-mod-rsd       =    23
                     move  "Bonifico Bancario "
                                          to   v-alf
           else if   rf-rsd-mod-rsd       =    24
                     move  "C/C Postale       "
                                          to   v-alf
           else      move  spaces         to   v-alf                  .
           move      "+"                  to   v-edm                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "   Numero    Data Reg.   Tipo pagamento        Imp
      -              "orto      Numero e Data Docum."
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
