      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pgep5701:        *
      *                                                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Data sollecito iniziale       *
      *    *-----------------------------------------------------------*
       pmt-dat-sci-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Data sollecito finale         *
      *    *-----------------------------------------------------------*
       pmt-dat-scf-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Data sollecito iniziale    *
      *    *-----------------------------------------------------------*
       acc-dat-sci-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Data sollecito finale      *
      *    *-----------------------------------------------------------*
       acc-dat-scf-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
      ...
      -              "ile !"
       ...
       tdo-ric-sel-030.
      *              *-------------------------------------------------*
      *              * Test su data sollecito iniziale e finale        *
      *              *-------------------------------------------------*
           if        rr-dat-scf           =    zero
                     go to tdo-ric-sel-040.
           if        rr-dat-sci           not  > rr-dat-scf
                     go to tdo-ric-sel-040.
           move      "Data sollecito finale inferiore a quella iniziale 
      -              "!"                  to   w-box-msg-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-040.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       reg-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Data sollecito iniziale e finale                *
      *              *-------------------------------------------------*
