      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pgep6801:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-ord-vet.
               10  w-exp-ord-vet-num      pic  9(02)       value 03   .
               10  w-exp-ord-vet-lun      pic  9(02)       value 20   .
               10  w-exp-ord-vet-tbl.
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-scd.
               10  w-exp-tip-scd-num      pic  9(02)       value 01   .
      ...
      *                  *---------------------------------------------*
           perform   acc-ord-vet-000      thru acc-ord-vet-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * Tipo ordinamento vettori                        *
      *              *-------------------------------------------------*
           perform   pmt-ord-vet-000      thru pmt-ord-vet-999        .
      *              *-------------------------------------------------*
      *              * Tipi scadenza da includere                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Tipo ordinamento vettori      *
      *    *-----------------------------------------------------------*
       pmt-ord-vet-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo ordinamento per vettori               *
      *    *-----------------------------------------------------------*
       acc-ord-vet-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-ord-vet-lun    to   v-car                  .
           move      w-exp-ord-vet-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      09                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-ord-vet-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      rr-ord-vet           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        rr-ord-vet           not  = zero
                     go to acc-ord-vet-500.
           if        v-key                =    "UP  "
                     go to acc-ord-vet-600
           else      go to acc-ord-vet-100.
       acc-ord-vet-500.
      *                  *---------------------------------------------*
      *                  * Se valore non a zero                        *
      *                  *---------------------------------------------*
           if        rr-ord-vet           >    w-exp-ord-vet-num
                     go to acc-ord-vet-100.
       acc-ord-vet-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Tipo ordinamento per vettori            *
      *    *-----------------------------------------------------------*
       vis-ord-vet-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       ...
       reg-ric-sel-025.
      *              *-------------------------------------------------*
      *              * Regolarizzazione codice vettore                 *
      *              *-------------------------------------------------*
