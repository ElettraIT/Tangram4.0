      ...
      *                       Ultima revisione:    NdK del 09/04/26    *
      *                    ------------------------------------------- *
      ...
      *            *---------------------------------------------------*
      *            * Prompt tipi scadenza                              *
      *            *---------------------------------------------------*
               10  w-vis-imp-vlb-pmt.
                   15  w-vis-imp-vlb-rdx  pic  x(17) value
                                "RD              :"                   .
                   15  w-vis-imp-vlb-dcx  pic  x(17) value
                                "DC              :"                   .
                   15  w-vis-imp-vlb-iex  pic  x(17) value
                                "IE              :"                   .
                   15  w-vis-imp-vlb-rib  pic  x(17) value
                                "RIBA            :"                   .
                   15  w-vis-imp-vlb-cdo  pic  x(17) value
                                "CDO             :"                   .
                   15  w-vis-imp-vlb-mav  pic  x(17) value
                                "MAV             :"                   .
                   15  w-vis-imp-vlb-rid  pic  x(17) value
                                "RID             :"                   .
                   15  w-vis-imp-vlb-bbx  pic  x(17) value
                                "BB              :"                   .
                   15  w-vis-imp-vlb-ccp  pic  x(17) value
                                "CCP             :"                   .
                   15  w-vis-imp-vlb-rbx  pic  x(17) value
                                "RB              :"                   .
                   15  w-vis-imp-vlb-trx  pic  x(17) value
                                "TR              :"                   .
                   15  w-vis-imp-vlb-pcx  pic  x(17) value
                                "PC              :"                   .
      ...
      *                      *-----------------------------------------*
       ...
       qry-liv-det-320.
      *                  *---------------------------------------------*
      *                  * Test se scadenza insoluta                   *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        srt-suo-sdb          not  = "ISP"
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-rdx    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * A scadere                               *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-dcx    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * A scadere                               *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-iex    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Insoluto                                *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-rib    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Insoluto                                *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-cdo    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Insoluto                                *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-mav    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Insoluto                                *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-rid    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Insoluto                                *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-bbx    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * A scadere                               *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-ccp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * A scadere                               *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-rbx    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Insoluto                                *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-trx    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Insoluto                                *
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-mpn                to   v-cnt                  .
           move      w-vis-imp-vlb-pcx    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Insoluto                                *
