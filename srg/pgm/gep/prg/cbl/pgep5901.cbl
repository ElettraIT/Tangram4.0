      ...
      *                       Ultima revisione:    NdK del 27/11/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma gep590   *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per determinazione data scadenza                 *
      *        *-------------------------------------------------------*
           05  w-det-dat-sdb.
      *            *---------------------------------------------------*
      *            * Data scadenza di comodo                           *
      *            *---------------------------------------------------*
               10  w-det-dat-sdb-dat      pic  9(07)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Forzatura data scadenza a vista         *
      *                      *-----------------------------------------*
           move      rf-sdb-dts-sdb       to   w-det-dat-sdb-dat      .
           if        w-det-dat-sdb-dat    =    zero
                     move  rf-sdb-dtr-emi to   w-det-dat-sdb-dat      .
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        w-det-dat-sdb-dat    <    rr-dat-sci or
                     w-det-dat-sdb-dat    >    rr-dat-scf
                     go to stp-srt-inp-200.
      ...
      *                  *---------------------------------------------*
           ...
           string    "SITUAZIONE SCADENZE RISCOSSE AL "
                                delimited by   size
