      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma gep630   *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-tot-age.
               10  w-tot-age-ctr          pic  9(07)                  .
               10  w-tot-age-tsc          pic s9(11)                  .
               10  w-tot-age-tin          pic s9(11)                  .
               10  w-tot-age-tas          pic s9(11)                  .
               10  w-tot-age-tci          pic s9(11)                  .
               10  w-tot-age-teg          pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totali per cliente                                    *
      *        *-------------------------------------------------------*
           05  w-tot-cli.
      ...
      *                  *---------------------------------------------*
      *                  * Se codice agente relativo alla scadenza a   *
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-130.
      *                  *---------------------------------------------*
      *                  * Selezione su codici agente                  *
      *                  *---------------------------------------------*
           if        rr-cod-age-sns       =    zero
                     go to stp-srt-inp-132
           else      go to stp-srt-inp-134.
       stp-srt-inp-132.
           if        rr-cod-age           not  = zero   and
                     rf-sdb-cod-age       not  = rr-cod-age
                     go to stp-srt-inp-120
       ...
       stp-srt-inp-136.
           ...
           if        rr-cod-age-eco
                    (w-wrk-ctr-001)       =    zero
                     go to stp-srt-inp-120.
           if        rr-cod-age-eco
                    (w-wrk-ctr-001)       =    rf-sdb-cod-age
                     go to stp-srt-inp-138
           else      go to stp-srt-inp-136.
       stp-srt-inp-138.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Inizializzazione contatore agenti stampati      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento contatore agenti stampati         *
      *              *-------------------------------------------------*
      ...
      *              * stampati                                        *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-age-ctr          .
      *              *-------------------------------------------------*
      *              * Azzeramento totali per agente                   *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-age-tsc          .
           move      zero                 to   w-tot-age-tin          .
           move      zero                 to   w-tot-age-tas          .
           move      zero                 to   w-tot-age-tci          .
           move      zero                 to   w-tot-age-teg          .
      *              *-------------------------------------------------*
      *              * Intestazione foglio                             *
      *              *-------------------------------------------------*
           perform   int-pag-sta-000      thru int-pag-sta-999        .
      ...
      *              *-------------------------------------------------*
           add       w-tot-age-tsc        to   w-tot-gen-tsc          .
           add       w-tot-age-tin        to   w-tot-gen-tin          .
           add       w-tot-age-tas        to   w-tot-gen-tas          .
           add       w-tot-age-tci        to   w-tot-gen-tci          .
           add       w-tot-age-teg        to   w-tot-gen-teg          .
      *              *-------------------------------------------------*
      *              * Stampa totale agente                            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se totale agente da stampare           *
      *                  *---------------------------------------------*
           if        rr-tip-slp           =    02
      ...
      *                  *---------------------------------------------*
           ...
           if        w-cnt-prn-flg-int    not  = spaces
                     go to prn-fin-lr2-999.
      *                  *---------------------------------------------*
      *                  * Salto trattini per totale agente            *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      013                  to   p-pos                  .
           move      "Totali agente   :"  to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Stampa totale scaduto                   *
      *                      *-----------------------------------------*
           move      w-tot-age-tsc        to   w-stp-imp-vlb-val      .
           move      030                  to   w-stp-imp-vlb-pos      .
           perform   stp-imp-vlb-000      thru stp-imp-vlb-999        .
      *                      *-----------------------------------------*
      *                      * Stampa totale insoluto                  *
      *                      *-----------------------------------------*
           move      w-tot-age-tin        to   w-stp-imp-vlb-val      .
           move      045                  to   w-stp-imp-vlb-pos      .
           perform   stp-imp-vlb-000      thru stp-imp-vlb-999        .
      *                      *-----------------------------------------*
      *                      * Stampa totale a scadere                 *
      *                      *-----------------------------------------*
           move      w-tot-age-tas        to   w-stp-imp-vlb-val      .
           move      060                  to   w-stp-imp-vlb-pos      .
           perform   stp-imp-vlb-000      thru stp-imp-vlb-999        .
      *                      *-----------------------------------------*
      *                      * Stampa totale in circolazione           *
      *                      *-----------------------------------------*
           move      w-tot-age-tci        to   w-stp-imp-vlb-val      .
           move      075                  to   w-stp-imp-vlb-pos      .
           perform   stp-imp-vlb-000      thru stp-imp-vlb-999        .
      *                      *-----------------------------------------*
      *                      * Stampa esposizione globale              *
      ...
      *                          * Valore                              *
      *                          *-------------------------------------*
           move      w-tot-age-teg        to   w-stp-imp-vlb-val      .
           move      118                  to   w-stp-imp-vlb-pos      .
           perform   stp-imp-vlb-000      thru stp-imp-vlb-999        .
       prn-fin-lr2-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *              * Aggiornamento contatore clienti per agente      *
      *              * stampati                                        *
      *              *-------------------------------------------------*
           add       1                    to   w-tot-age-ctr          .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento totali agente                     *
      *              *-------------------------------------------------*
           add       w-tot-cli-tsc        to   w-tot-age-tsc          .
           add       w-tot-cli-tin        to   w-tot-age-tin          .
           add       w-tot-cli-tas        to   w-tot-age-tas          .
           add       w-tot-cli-tci        to   w-tot-age-tci          .
           add       w-tot-cli-teg        to   w-tot-age-teg          .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           string    "ANALISI DI PORTAFOGLIO CLIENTI PER AGENTE AL "
                                delimited by   size
      ...
      *                          *-------------------------------------*
           move      w-rot-l02-cod-age    to   w-let-arc-age-cod      .
           perform   let-arc-age-000      thru let-arc-age-999        .
      *                          *-------------------------------------*
      *                          * String                              *
      *                          *-------------------------------------*
