      ...
      *                                   Fase:    gep301              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 08/04/94    *
      ...
      *            * su distinte                                       *
      *            *---------------------------------------------------*
               10  w-ipc-sel-ddp-snx      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore della variabile di i.p.c. relativa alla    *
      *            * selezione su distinte                             *
      *            *---------------------------------------------------*
               10  w-ipc-sel-ddp-val      pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
      *        *-------------------------------------------------------*
      *        * Tipi di distinta da ricercare                         *
      *        * - 00 : Tutti                                          *
      *        * - 01 : Distinte Incassi Elettronici                   *
      *        * - 02 : Distinte Effetti                               *
      *        * - 03 : Distinte Paghero' Cambiari                     *
      *        * - 04 : Distinte Cessioni                              *
      *        *-------------------------------------------------------*
           05  rr-tip-ddp                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Data composizione minima da ricercare                 *
      *        *-------------------------------------------------------*
           05  rr-dtc-min                 pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Data composizione massima da ricercare                *
      *        *-------------------------------------------------------*
           05  rr-dtc-max                 pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Importo da ricercare                                  *
      *        *-------------------------------------------------------*
           05  rr-imp-ddp                 pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Selezione distinte per                                *
      *        * - 01 : Nessuna selezione                              *
      *        * - 02 : Presentazione                                  *
      *        * - 03 : Preparazione archivi di supporto               *
      *        * - 04 : Stampa per presentazione                       *
      *        * - 05 : Accettazione                                   *
      *        * - 06 : Riscontro tipo avviso                          *
      *        * - 07 : Accredito                                      *
      *        *-------------------------------------------------------*
           05  rr-sel-ddp                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per determinazione status distinta               *
      *        *-------------------------------------------------------*
           05  w-det-sts-ddp.
      *            *---------------------------------------------------*
      *            * Status determinato                                *
      *            * - Spaces : Status non determinabile               *
      *            * - A      : Distinta ancora aperta                 *
      *            * - C      : Distinta ormai chiusa                  *
      *            *---------------------------------------------------*
               10  w-det-sts-ddp-sts      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Sigla ultima operazione eseguita sulla distinta   *
      *            * - Spaces : Nessuna                                *
      *            * - COM    : Composizione                           *
      *            * - PRE    : Presentazione                          *
      *            * - ACT    : Accettazione                           *
      *            * - ACD    : Accredito in c/c                       *
      *            *---------------------------------------------------*
               10  w-det-sts-ddp-suo      pic  x(03)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipi distinta da ricercare                 *
      *        *-------------------------------------------------------*
           05  w-exp-tip-ddp.
               10  w-exp-tip-ddp-num      pic  9(02)       value 05   .
               10  w-exp-tip-ddp-lun      pic  9(02)       value 40   .
               10  w-exp-tip-ddp-tbl.
                   15  filler             pic  x(40) value
                            "Tutti                                   ".
                   15  filler             pic  x(40) value
                            "distinte Incassi elettronici            ".
                   15  filler             pic  x(40) value
                            "distinte Effetti                        ".
                   15  filler             pic  x(40) value
                            "distinte Paghero' cambiari              ".
                   15  filler             pic  x(40) value
                            "cistinte Cessioni                       ".
      *        *-------------------------------------------------------*
      *        * Work per : Selezione su distinte                      *
      *        *-------------------------------------------------------*
           05  w-exp-sel-ddp.
               10  w-exp-sel-ddp-num      pic  9(02)       value 07   .
               10  w-exp-sel-ddp-lun      pic  9(02)       value 35   .
               10  w-exp-sel-ddp-tbl.
                   15  filler             pic  x(35) value
                            "Nessuna selezione sulle distinte   "     .
                   15  filler             pic  x(35) value
                            "presentazione Distinta             "     .
                   15  filler             pic  x(35) value
                            "Preparazione archivi di supporto   "     .
                   15  filler             pic  x(35) value
                            "Stampa per presentazione           "     .
                   15  filler             pic  x(35) value
      ...
      *              * selezione su distinte                           *
      *              *-------------------------------------------------*
           perform   ipc-sel-ddp-000      thru ipc-sel-ddp-999        .
      *              *-------------------------------------------------*
      *              * Memorizzazione sottoprogramma in attivita'      *
      *              *-------------------------------------------------*
           move      "INTDDP    "         to   w-spg-alf-gat          .
      ...
      *    *-----------------------------------------------------------*
       ipc-sel-ddp-000.
      *              *-------------------------------------------------*
      *              * Estrazione della variabile 'sel-ddp' dal livel- *
      *              * lo di profondita' precedente o dallo stesso li- *
      *              * vello di profondita' applicativa a seconda se   *
      *              * il sottoprogramma e' stato richiamato dal main  *
      *              * oppure da un sottoprogramma dello stesso livel- *
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to ipc-sel-ddp-200
           else      go to ipc-sel-ddp-400.
       ipc-sel-ddp-200.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
      ...
      *                  * Segnale di variabile esistente              *
      *                  *---------------------------------------------*
           move      "S"                  to   w-ipc-sel-ddp-snx      .
      *                  *---------------------------------------------*
      *                  * Valore della variabile                      *
      *                  *---------------------------------------------*
           move      s-num                to   w-ipc-sel-ddp-val      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ipc-sel-ddp-999.
       ipc-sel-ddp-400.
      *              *-------------------------------------------------*
      *              * Se variabile non esistente                      *
      *              *-------------------------------------------------*
      ...
      *                  * Segnale di variabile non esistente          *
      *                  *---------------------------------------------*
           move      "N"                  to   w-ipc-sel-ddp-snx      .
      *                  *---------------------------------------------*
      *                  * Valore della variabile a zero               *
      *                  *---------------------------------------------*
           move      zero                 to   w-ipc-sel-ddp-val      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ipc-sel-ddp-999.
      ...
      *                  * Data composizione minima da ricercare       *
      *                  *---------------------------------------------*
           perform   acc-dtc-min-000      thru acc-dtc-min-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Data composizione massima da ricercare      *
      *                  *---------------------------------------------*
           perform   acc-dtc-max-000      thru acc-dtc-max-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Importo da ricercare                        *
      *                  *---------------------------------------------*
           perform   acc-imp-ddp-000      thru acc-imp-ddp-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Selezione su distinte                       *
      *                  *---------------------------------------------*
           perform   acc-sel-ddp-000      thru acc-sel-ddp-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           move      "MX"                 to   v-ope                  .
           move      "U"                  to   v-tip                  .
           move      "Conferma esecuzione ricerca distinte (S/N/E) ?"
                                          to   v-not                  .
           move      "S"                  to   v-alf                  .
           move      "SNE"                to   v-msk                  .
           move      "DO  "               to   v-pfk (05)             .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Prompt tipi distinta da ricercare               *
      *              *-------------------------------------------------*
           perform   pmt-tip-ddp-000      thru pmt-tip-ddp-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione tipi distinta da ricercare      *
      *              *-------------------------------------------------*
           perform   vis-tip-ddp-000      thru vis-tip-ddp-999        .
      *              *-------------------------------------------------*
      *              * Prompt data composizione minima da ricercare    *
      *              *-------------------------------------------------*
           perform   pmt-dtc-min-000      thru pmt-dtc-min-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione data composizione minima da ri- *
      *              * cercare                                         *
      *              *-------------------------------------------------*
           perform   vis-dtc-min-000      thru vis-dtc-min-999        .
      *              *-------------------------------------------------*
      *              * Prompt data composizione massima da ricercare   *
      *              *-------------------------------------------------*
           perform   pmt-dtc-max-000      thru pmt-dtc-max-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione data composizione massima da    *
      *              * ricercare                                       *
      *              *-------------------------------------------------*
           perform   vis-dtc-max-000      thru vis-dtc-max-999        .
      *              *-------------------------------------------------*
      *              * Prompt importo distinta da ricercare            *
      *              *-------------------------------------------------*
           perform   pmt-imp-ddp-000      thru pmt-imp-ddp-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione importo distinta da ricercare   *
      *              *-------------------------------------------------*
           perform   vis-imp-ddp-000      thru vis-imp-ddp-999        .
      *              *-------------------------------------------------*
      *              * Prompt selezione su distinte                    *
      *              *-------------------------------------------------*
           perform   pmt-sel-ddp-000      thru pmt-sel-ddp-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione selezione su distinte           *
      *              *-------------------------------------------------*
           perform   vis-sel-ddp-000      thru vis-sel-ddp-999        .
      *              *-------------------------------------------------*
      *              * Prompt codice nostra banca per la presentazione *
      *              *-------------------------------------------------*
           perform   pmt-cod-cbp-000      thru pmt-cod-cbp-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione codice nostra banca per la pre- *
      *              * sentazione                                      *
      *              *-------------------------------------------------*
           perform   vis-cod-cbp-000      thru vis-cod-cbp-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione codice nostra banca per la pre- *
      *              * sentazione, descrizione                         *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pmt-tip-ddp-000.
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipi distinta da ricercare :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tip-ddp-999.
      ...
      *    *-----------------------------------------------------------*
       pmt-dtc-min-000.
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Con data composizione dal  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-dtc-min-999.
      ...
      *    *-----------------------------------------------------------*
       pmt-cod-cbp-000.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda della selezione su distin- *
      *              * te                                              *
      *              *-------------------------------------------------*
           if        rr-sel-ddp           =    02
                     go to pmt-cod-cbp-100
           else      go to pmt-cod-cbp-200.
       pmt-cod-cbp-100.
      *              *-------------------------------------------------*
      *              * Se selezione su distinte indica solo operazioni *
      *              * pre-presentazione : prompt a spaces             *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Tipi distinta da ricercare                 *
      *    *-----------------------------------------------------------*
       acc-tip-ddp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  00             to   rr-tip-ddp
           else if   v-num                =    02
                     move  01             to   rr-tip-ddp
           else if   v-num                =    03
                     move  02             to   rr-tip-ddp
           else if   v-num                =    04
                     move  03             to   rr-tip-ddp
           else if   v-num                =    05
                     move  04             to   rr-tip-ddp
           else      move  zero           to   rr-tip-ddp             .
       acc-tip-ddp-400.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Data composizione minima da ricercare      *
      *    *-----------------------------------------------------------*
       acc-dtc-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-dtc-min-999.
       acc-dtc-min-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-dtc-min             .
       acc-dtc-min-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-dtc-min-100.
       acc-dtc-min-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Data composizione minima da ricercare   *
      *    *-----------------------------------------------------------*
       vis-dtc-min-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Data composizione massima da ricercare     *
      *    *-----------------------------------------------------------*
       acc-dtc-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-dtc-max-999.
       acc-dtc-max-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-dtc-max             .
       acc-dtc-max-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-dtc-max-100.
       acc-dtc-max-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Data composizione massima da ricercare  *
      *    *-----------------------------------------------------------*
       vis-dtc-max-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Importo distinta da ricercare              *
      *    *-----------------------------------------------------------*
       acc-imp-ddp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-imp-ddp-999.
       acc-imp-ddp-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-imp-ddp             .
       acc-imp-ddp-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Selezione su distinte                      *
      *    *-----------------------------------------------------------*
       acc-sel-ddp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-ddp-lun    to   v-car                  .
           move      w-exp-sel-ddp-num    to   v-ldt                  .
           move      "NDPSARC#"           to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-sel-ddp-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      15                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      rr-sel-ddp           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-sel-ddp-150.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-sel-ddp-999.
       acc-sel-ddp-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-sel-ddp             .
       acc-sel-ddp-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        rr-sel-ddp           not  = zero
                     go to acc-sel-ddp-600.
           if        v-key                =    "UP  "
                     go to acc-sel-ddp-600
           else      go to acc-sel-ddp-100.
       acc-sel-ddp-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Prompt per codice banca                     *
      *                  *---------------------------------------------*
           perform   pmt-cod-cbp-000      thru pmt-cod-cbp-999        .
      *                  *---------------------------------------------*
      *                  * Trattamento codice banca                    *
      *                  *---------------------------------------------*
           if        rr-sel-ddp           not  = 02
                     go to acc-sel-ddp-800.
      ...
      *    *===========================================================*
      *    * Accettazione : Codice nostra banca per la presentazione   *
      *    *-----------------------------------------------------------*
       acc-cod-cbp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice nostra banca per la presentazio- *
      *    *                   ne                                      *
      *    *-----------------------------------------------------------*
       vis-cod-cbp-000.
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Controllo su tipo distinta da ricercare         *
      *              *-------------------------------------------------*
           if        rr-tip-ddp           =    00 or
                     rr-tip-ddp           =    01 or
                     rr-tip-ddp           =    02 or
           ...
           move      "Tipo distinta da ricercare errato                 
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo su data composizione minima e massima *
      *              *-------------------------------------------------*
           if        rr-dtc-min           =    zero or
                     rr-dtc-max           =    zero
                     go to tdo-ric-sel-300.
           if        rr-dtc-max           not  < rr-dtc-min
                     go to tdo-ric-sel-300.
           move      "La data di composizione massima e' inferiore a que
      -              "lla minima     "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-300.
      *              *-------------------------------------------------*
      *              * Controllo su selezione su distinte              *
      *              *-------------------------------------------------*
       tdo-ric-sel-400.
      *              *-------------------------------------------------*
      *              * Controllo su nostra banca di presentazione      *
      *              *-------------------------------------------------*
       tdo-ric-sel-900.
      *              *-------------------------------------------------*
      *              * Fine controlli                                  *
      ...
      *                  * Data composizione minima da ricercare       *
      *                  *---------------------------------------------*
           move      zero                 to   rr-dtc-min             .
      *                  *---------------------------------------------*
      *                  * Data composizione massima da ricercare      *
      *                  *---------------------------------------------*
           move      zero                 to   rr-dtc-max             .
      *                  *---------------------------------------------*
      *                  * Importo da ricercare                        *
      *                  *---------------------------------------------*
           move      zero                 to   rr-imp-ddp             .
      *                  *---------------------------------------------*
      *                  * Selezione su distinte                       *
      *                  *---------------------------------------------*
           move      zero                 to   rr-sel-ddp             .
      *                  *---------------------------------------------*
      *                  * Codice nostra banca per la presentazione    *
      *                  *---------------------------------------------*
           move      spaces               to   rr-cod-cbp             .
      ...
      *                      * relativa al tipo distinta : no prepa-   *
      *                      * razione default                         *
      *                      *-----------------------------------------*
           if        w-ipc-tip-ddp-snx    not  = "S"
      ...
      *                      *-----------------------------------------*
      *                      * Se non esiste una variabile di i.p.c.   *
      *                      * relativa alla selezione su distinta: no *
      *                      * preparazione default                    *
      *                      * razione default                         *
      *                      *-----------------------------------------*
           if        w-ipc-sel-ddp-snx    not  = "S"
                     go to nor-ric-sel-700.
      *                      *-----------------------------------------*
      *                      * Se la variabile di i.p.c. ha un valore  *
      *                      * non ammesso : no preparazione default   *
      *                      *-----------------------------------------*
           if        w-ipc-sel-ddp-val    <    01 or
                     w-ipc-sel-ddp-val    >    07
                     go to nor-ric-sel-700.
      *                      *-----------------------------------------*
      *                      * Preparazione default                    *
      *                      *-----------------------------------------*
           move      w-ipc-sel-ddp-val    to   rr-sel-ddp             .
       nor-ric-sel-700.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su [ddp] per numero distinta              *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
      ...
      *              * Messaggio di errore                             *
      *              *-------------------------------------------------*
           move      "Nessuna distinta da visualizzare entro i limiti as
      ...
      *              *-------------------------------------------------*
       ...
       qry-let-seq-100.
      *              *-------------------------------------------------*
      *              * Next su [ddp] per numero distinta               *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/gep/fls/ioc/obj/iofddp"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
       ...
       qry-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Selezione su tipo distinta                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se tipo distinta da ricercare pari a zero : *
      *                  * nessuna selezione sul tipo distinta         *
      *                  *---------------------------------------------*
           if        rr-tip-ddp           =    zero
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rf-ddp-tip-ddp       =    rr-tip-ddp
                     go to qry-sel-rec-200
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Selezione su data composizione minima           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se data composizione minima da ricercare    *
      *                  * pari a zero : nessuna selezione sulla data  *
      *                  * composizione minima                         *
      *                  *---------------------------------------------*
           if        rr-dtc-min           =    zero
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rf-ddp-dtr-com       not  < rr-dtc-min
                     go to qry-sel-rec-300
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-300.
      *              *-------------------------------------------------*
      *              * Selezione su data composizione massima          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se data composizione massima da ricercare   *
      *                  * pari a zero : nessuna selezione sulla data  *
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rf-ddp-dtr-com       not  > rr-dtc-max
                     go to qry-sel-rec-400
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-400.
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rf-ddp-imp-ddp       =    rr-imp-ddp
                     go to qry-sel-rec-500
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-500.
      *              *-------------------------------------------------*
      *              * Selezione su status distinta                    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Determinazione status distinta              *
      *                  *---------------------------------------------*
           perform   det-sts-ddp-000      thru det-sts-ddp-999        .
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda della selezione su di- *
      *                  * stinta                                      *
      *                  *---------------------------------------------*
           go to     qry-sel-rec-510
                     ...
                     qry-sel-rec-560
                     qry-sel-rec-570
                     depending            on  rr-sel-ddp              .
       qry-sel-rec-510.
      *                  *---------------------------------------------*
      *                  * Selezione su distinte per : Nessuna         *
      *                  *---------------------------------------------*
           go to     qry-sel-rec-600.
       qry-sel-rec-520.
      *                  *---------------------------------------------*
      *                  * Selezione su distinte per : Presentazione   *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test che la distinta sia ancora aperta, *
      *                      * e che l'ultimo movimento eseguito sulla *
      *                      * distinta sia quello di composizione     *
      *                      *-----------------------------------------*
           if        w-det-sts-ddp-sts    =    "A"   and
                     w-det-sts-ddp-suo    =    "COM"
                     go to qry-sel-rec-600
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-530.
      *                  *---------------------------------------------*
      *                  * Selezione su distinte per : Preparazione    *
      *                  * archivi di supporto                         *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test che la distinta sia ancora aperta, *
      *                      * e che l'ultimo movimento eseguito sulla *
      *                      * distinta sia quello di presentazione    *
      *                      *-----------------------------------------*
           if        w-det-sts-ddp-sts    =    "A"   and
                     w-det-sts-ddp-suo    =    "PRE"
                     go to qry-sel-rec-532
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-532.
      *                      *-----------------------------------------*
      *                      * Selezione su solamente distinte per cui *
      *                      * sia stata prevista la preparazione del- *
      *                      * l'archivio di supporto                  *
      *                      *-----------------------------------------*
           if        rf-ddp-snx-ads       =    "S"
                     go to qry-sel-rec-534
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-534.
      *                      *-----------------------------------------*
      *                      * Selezione su solamente distinte per cui *
      *                      * la preparazione dell'archivio di sup-   *
      *                      * porto non sia ancora stata effettuata   *
      *                      *-----------------------------------------*
       ...
       qry-sel-rec-540.
      *                  *---------------------------------------------*
      *                  * Selezione su distinte per : Stampa per pre- *
      *                  * sentazione                                  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test che la distinta sia ancora aperta, *
      ...
      *                      *-----------------------------------------*
      *                      * Selezione su solamente distinte per cui *
      *                      * sia stata prevista la stampa della di-  *
      *                      * stinta                                  *
      *                      *-----------------------------------------*
           if        rf-ddp-snx-stp       =    "S"
                     go to qry-sel-rec-544
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-544.
      *                      *-----------------------------------------*
      *                      * Selezione su solamente distinte per cui *
      *                      * la stampa della distinta non sia ancora *
      *                      * stata effettuata                        *
      *                      *-----------------------------------------*
       ...
       qry-sel-rec-550.
      *                  *---------------------------------------------*
      *                  * Selezione su distinte per : Accettazione    *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test che la distinta sia ancora aperta, *
      *                      * e che l'ultimo movimento eseguito sulla *
      ...
      *                      *-----------------------------------------*
       ...
       qry-sel-rec-560.
      *                  *---------------------------------------------*
      *                  * Selezione su distinte per : Riscontro tipo  *
      *                  * avviso                                      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test che la distinta sia ancora aperta, *
      *                      * e che l'ultimo movimento eseguito sulla *
      *                      * distinta sia quello di presentazione    *
      *                      * oppure di accettazione                  *
      *                      *-----------------------------------------*
           if        w-det-sts-ddp-sts    =    "A"      and
                    (w-det-sts-ddp-suo    =    "PRE" or
                     w-det-sts-ddp-suo    =    "ACT"  )
                     go to qry-sel-rec-600
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-570.
      *                  *---------------------------------------------*
      *                  * Selezione su distinte per : Accredito       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test che la distinta sia ancora aperta, *
      *                      * e che l'ultimo movimento eseguito sulla *
      *                      * distinta sia quello di accettazione     *
      *                      *-----------------------------------------*
           if        w-det-sts-ddp-sts    =    "A"   and
                     w-det-sts-ddp-suo    =    "ACT"
                     go to qry-sel-rec-572
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-572.
      *                       *----------------------------------------*
      *                       * Se la distinta non e' stata presentata *
      *                       * al SBF a maturazione di valuta : non   *
      *                       * puo' essere soggetta al movimento di   *
      *                       * accredito distinta in c/c              *
      *                       *----------------------------------------*
           if        rf-ddp-tip-pre       =    01
                     go to qry-sel-rec-600
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-600.
      *              *-------------------------------------------------*
      *              * Selezione su codice nostra banca per la presen- *
      *              * tazione                                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se codice nostra banca per la presentazione *
      *                  * da ricercare pari a spaces : nessuna sele-  *
      *                  * zione sul codice nostra banca per la pre-   *
      *                  * sentazione                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      24                   to   v-pos                  .
           move      "+"                  to   v-edm                  .
           move      rf-ddp-num-ddp       to   w-mpn-num-ddp          .
           move      w-mpn                to   v-cnt                  .
           if        rf-ddp-tip-ddp       =    01
                     move  "Inc.Elett."   to   v-alf
           else if   rf-ddp-tip-ddp       =    02
                     move  "Effetti   "   to   v-alf
           else if   rf-ddp-tip-ddp       =    03
                     move  "Paghero'  "   to   v-alf
           else if   rf-ddp-tip-ddp       =    04
                     move  "Cessioni  "   to   v-alf
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      52                   to   v-pos                  .
           if        w-det-sts-ddp-suo    =    "COM"
                     move  "Composta         "
                                          to   v-alf
           else if   w-det-sts-ddp-suo    =    "PRE"
                     move  "Presentata       "
                                          to   v-alf
           else if   w-det-sts-ddp-suo    =    "ACT"
                     move  "Accettata        "
                                          to   v-alf
           else if   w-det-sts-ddp-suo    =    "ACD"
                     move  "Accreditata      "
                                          to   v-alf
           else      move  spaces         to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se programma di espansione distinte gia'    *
      ...
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Scrittura della variabile 'num-ddp' per il  *
      ...
      *                  *---------------------------------------------*
       ...
       qry-trt-fun-325.
      *                  *---------------------------------------------*
      *                  * Scrittura variabile di i.p.c. 'num-ddp' per *
      *                  * lo stesso livello di profondita' applicati- *
      *                  * va per il numero distinta da espandere      *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
           move      "num-ddp"            to   s-var                  .
           move      "="                  to   s-dop                  .
      ...
      *    *===========================================================*
      *    * Detyerminazione status distinta                           *
      *    *-----------------------------------------------------------*
       det-sts-ddp-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      spaces               to   w-det-sts-ddp-suo      .
       det-sts-ddp-050.
      *                  *---------------------------------------------*
      *                  * Composizione                                *
      *                  *---------------------------------------------*
           if        rf-ddp-dtr-com       not  = zero
                     move  "COM"          to   w-det-sts-ddp-suo      .
       det-sts-ddp-075.
      *                  *---------------------------------------------*
      *                  * Presentazione                               *
      *                  *---------------------------------------------*
           if        rf-ddp-dtr-pre       not  = zero
                     move  "PRE"          to   w-det-sts-ddp-suo      .
       det-sts-ddp-100.
      *                  *---------------------------------------------*
      *                  * Accettazione                                *
      *                  *---------------------------------------------*
           if        rf-ddp-dtr-act       not  = zero
                     move  "ACT"          to   w-det-sts-ddp-suo      .
       det-sts-ddp-125.
      *                  *---------------------------------------------*
      *                  * Accredito in c/c                            *
      *                  *---------------------------------------------*
           if        rf-ddp-dtr-acd       not  = zero
                     move  "ACD"          to   w-det-sts-ddp-suo      .
       det-sts-ddp-500.
      *              *-------------------------------------------------*
      *              * Determinazione dello status della distinta      *
      *              *-------------------------------------------------*
       det-sts-ddp-550.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione della sigla dell'ul- *
      *                  * tima operazione eseguita sulla distinta     *
      *                  *---------------------------------------------*
           if        w-det-sts-ddp-suo    =    "COM"
                     go to det-sts-ddp-600
           else if   w-det-sts-ddp-suo    =    "PRE"
                     go to det-sts-ddp-650
           else if   w-det-sts-ddp-suo    =    "ACT"
                     go to det-sts-ddp-700
           else if   w-det-sts-ddp-suo    =    "ACD"
                     go to det-sts-ddp-750
           else      go to det-sts-ddp-800.
       det-sts-ddp-600.
      *                  *---------------------------------------------*
      *                  * Se l'ultima operazione eseguita sulla di-   *
      *                  * stinta e' la composizione distinta          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Status distinta : Aperta                *
      *                      *-----------------------------------------*
           move      "A"                  to   w-det-sts-ddp-sts      .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     det-sts-ddp-999.
       det-sts-ddp-650.
      *                  *---------------------------------------------*
      *                  * Se l'ultima operazione eseguita sulla di-   *
      *                  * stinta e' la presentazione distinta         *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Status distinta : Aperta                *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Se l'ultima operazione eseguita sulla di-   *
      *                  * stinta e' l'accettazione distinta           *
      *                  *---------------------------------------------*
       det-sts-ddp-705.
      *                      *-----------------------------------------*
      *                      * Deviazione in funzione del tipo di pre- *
      *                      * sentazione distinta                     *
      *                      *-----------------------------------------*
           if        rf-ddp-tip-pre       =    03
                     go to det-sts-ddp-710
           else      go to det-sts-ddp-715.
       det-sts-ddp-710.
      *                      *-----------------------------------------*
      *                      * Se presentazione al dopo incasso        *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Status distinta : Chiusa            *
      *                          *-------------------------------------*
           move      "C"                  to   w-det-sts-ddp-sts      .
      *                          *-------------------------------------*
      *                          * Uscita                              *
      *                          *-------------------------------------*
           go to     det-sts-ddp-999.
       det-sts-ddp-715.
      *                      *-----------------------------------------*
      *                      * Se presentazione non al dopo incasso    *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Status distinta : Aperta            *
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Se l'ultima operazione eseguita sulla di-   *
      *                  * stinta e' di tipo non riconosciuto          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Status distinta : Aperta                *
      *                      *-----------------------------------------*
