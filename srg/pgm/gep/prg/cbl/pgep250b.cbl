      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-snx-acr          pic  x(01)                  .
               10  w-rig-imp-acr          pic  9(13)                  .
               10  w-rig-dat-acr          pic  9(07)                  .
               10  w-rig-scd-acr          pic  9(07)                  .
           05  w-rig-002.
               10  w-rig-num-prg-2        pic  9(05)                  .
               10  w-rig-ide-dat-2        pic  9(07)                  .
               10  w-rig-ide-ute-2        pic  x(08)                  .
               10  w-rig-ide-fas-2        pic  x(06)                  .
               10  w-rig-cod-cli-2        pic  9(07)                  .
               10  w-rig-cod-cli-rag-2    pic  x(40)                  .
               10  w-rig-cod-cli-naz-2    pic  x(03)                  .
               10  w-rig-snx-acr-2        pic  x(01)                  .
               10  w-rig-imp-acr-2        pic  9(13)                  .
               10  w-rig-dat-acr-2        pic  9(07)                  .
               10  w-rig-scd-acr-2        pic  9(07)                  .
      ...
      *                *-----------------------------------------------*
                   ...
                   15  w-lin-imm-rag-cli.
                       20  w-lin-imm-rag-rag
                                          pic  x(40)                  .
                   15  w-lin-imm-imp-acr  pic  x(14)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-scd-acr  pic  x(08)                  .
      ...
      *                  * Importo assicurato                          *
      *                  *---------------------------------------------*
           perform   acc-key-imp-000      thru acc-key-imp-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Importo assicurato                              *
      *              *-------------------------------------------------*
           perform   vis-key-imp-000      thru vis-key-imp-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Importo assicurato                          *
      *                  *---------------------------------------------*
           perform   pmt-key-imp-000      thru pmt-key-imp-999        .
       pmt-key-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Importo assicurato               *
      *    *-----------------------------------------------------------*
       pmt-key-imp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Importo assicurato                   *
      *    *-----------------------------------------------------------*
       acc-key-imp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Importo assicurato                *
      *    *-----------------------------------------------------------*
       vis-key-imp-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
       ...
       vis-lin-cor-480.
      *                  *---------------------------------------------*
      *                  * Editing Importo assicurato                  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se valore a zero                        *
      *                      *-----------------------------------------*
           if        w-rig-snx-acr        =    spaces and
                     w-rig-imp-acr        =    zero   and
                     w-rig-scd-acr        =    zero
                     move  "            --"
                                          to   w-lin-imm-imp-acr
                     go to vis-lin-cor-500
           else if   w-rig-imp-acr        =    zero and
                     w-rig-snx-acr        =    "N"
                     move  "     Rifiutata"
                                          to   w-lin-imm-imp-acr
                     go to vis-lin-cor-500
           else      go to vis-lin-cor-485.
       vis-lin-cor-485.
      *                      *-----------------------------------------*
      *                      * Editing                                 *
      *                      *-----------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "BG"                 to   v-edm                  .
           move      w-rig-imp-acr        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-imp-acr      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      w-rig-scd-acr        to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-scd-acr      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no assicurazione              *
      *    *-----------------------------------------------------------*
       pmt-snx-acr-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data scadenza                    *
      *    *-----------------------------------------------------------*
       pmt-scd-acr-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-snx-acr        to   w-sav-snx-acr          .
       acc-snx-acr-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *
           if        w-rig-snx-acr        =    spaces
                     move  01             to   v-num
           else if   w-rig-snx-acr        =    "S"
                     move  02             to   v-num
           else if   w-rig-snx-acr        =    "N"
                     move  03             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  spaces         to   w-rig-snx-acr
           else if   v-num                =    02
                     move  "S"            to   w-rig-snx-acr
           else if   v-num                =    03
                     move  "N"            to   w-rig-snx-acr
           else      move  spaces         to   w-rig-snx-acr          .
       acc-snx-acr-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-snx-acr        =    w-sav-snx-acr
                     go to acc-snx-acr-800.
      *                  *---------------------------------------------*
      *                  * Normalizzazioni eventuali                   *
      *                  *---------------------------------------------*
           if        w-rig-snx-acr        =    spaces
                     move  zero           to   w-rig-imp-acr
                     move  zero           to   w-rig-scd-acr
                     move  zero           to   w-rig-dat-acr
           else if   w-rig-snx-acr        =    "N"
                     move  zero           to   w-rig-imp-acr
                     move  zero           to   w-rig-scd-acr          .
      *                  *---------------------------------------------*
      ...
      *              * Se valore a zero                                *
      *              *-------------------------------------------------*
           if        w-rig-scd-acr        =    zero
                     go to vis-imp-acr-200.
           if        w-rig-imp-acr        not  = zero
                     go to vis-imp-acr-200.
      *                  *---------------------------------------------*
      *                  * Literal 'Garantito'                         *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-rig-ide-dat        =    zero   and
                     w-rig-ide-ute        =    spaces and
                     w-rig-ide-fas        =    spaces
                     go to vis-ide-duf-999.
      *              *-------------------------------------------------*
      *              * Editing data ultima modifica                    *
      *              *-------------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      w-rig-ide-dat        to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-ide-ute        to   w-all-str-cat (4)      .
           move      "]["                 to   w-all-str-cat (5)      .
           move      w-rig-ide-fas        to   w-all-str-cat (6)      .
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-200.
      *              *-------------------------------------------------*
      *              * Controllo su data scadenza                      *
      *              *-------------------------------------------------*
           if        w-rig-imp-acr        =    zero
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-ide-dat          .
           move      spaces               to   w-rig-ide-ute          .
           move      spaces               to   w-rig-ide-fas          .
      ...
      *                  * Importo assicurato                          *
      *                  *---------------------------------------------*
           if        w-tes-imp-acr        =    zero
                     go to sel-rec-cli-800.
           if        rf-ccc-imp-acr       not  = w-tes-imp-acr
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Valori da anagrafica parallela      *
      *                          *-------------------------------------*
           move      rf-ccc-ide-dat       to   w-rig-ide-dat          .
           move      rf-ccc-ide-ute       to   w-rig-ide-ute          .
           move      rf-ccc-ide-fas       to   w-rig-ide-fas          .
           move      rf-ccc-snx-acr       to   w-rig-snx-acr          .
           move      rf-ccc-imp-acr       to   w-rig-imp-acr          .
           move      rf-ccc-dat-acr       to   w-rig-dat-acr          .
           move      rf-ccc-scd-acr       to   w-rig-scd-acr          .
       car-eff-rig-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      24                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "          --- Aggiornamento anagrafiche di control
      -              "lo in esecuzione ---          "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
      *                  * Confronto tra valore attuale e valore pre-  *
      *                  * cedente Importo assicurato                  *
      *                  *---------------------------------------------*
           if        w-rig-snx-acr        =    spaces and
                     w-rig-imp-acr        =    zero   and
                     w-rig-dat-acr        =    zero   and
                     w-rig-scd-acr        =    zero   and
                     w-rig-snx-acr-2      =    spaces and
                     w-rig-imp-acr-2      =    zero   and
                     w-rig-dat-acr-2      =    zero   and
                     w-rig-scd-acr-2      =    zero
                     go to sca-fil-rap-100.
       sca-fil-rap-190.
      *              *-------------------------------------------------*
      *              * Lettura, con lock, del record [ccc]             *
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODCLI    "         to   f-key                  .
           move      w-rig-cod-cli        to   rf-ccc-cod-cli         .
           move      "pgm/gep/fls/ioc/obj/iofccc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test sul valore dei campi da aggiornare     *
      *                  *---------------------------------------------*
           if        w-rig-snx-acr        =    spaces and
                     w-rig-imp-acr        =    zero   and
                     w-rig-dat-acr        =    zero   and
      ...
      *                      *-----------------------------------------*
           move      w-rig-snx-acr        to   rf-ccc-snx-acr         .
           move      w-rig-imp-acr        to   rf-ccc-imp-acr         .
           move      w-rig-dat-acr        to   rf-ccc-dat-acr         .
           move      w-rig-scd-acr        to   rf-ccc-scd-acr         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/gep/prg/obj/pgep2502"                       .
       cnc-rlt-sup-999.
           exit.
