      ...
      *                      *-----------------------------------------*
           ...
           move      16                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      "| Imp. assic.   :"  to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Scadenza copertura assicurativa         *
      *                      *-----------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      17                   to   v-car                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      59                   to   v-pos                  .
      *
           if        d-esp-cec-snx-acr    =    spaces
                     move  "Non richiesta"
                                          to   v-alf
           else if   d-esp-cec-snx-acr    =    "N"
                     move  "Rifiutata    "
                                          to   v-alf
           else if   d-esp-cec-snx-acr    =    "S"
                     move  "Accordata    "
                                          to   v-alf
           else      move  "Non richiesta"
                                          to   v-alf                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      59                   to   v-pos                  .
           move      d-esp-cec-scd-acr    to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Totale                                  *
