      ...
      *                                   Fase:    gep017              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/11/99    *
      *                       Ultima revisione:    NdK del 11/12/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma pgep0170 *
      *                                                                *
      *                    Stampa anagrafica nostre banche             *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna banca entro i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      054                  to   p-pos                  .
           move      w-cod-cod-cin-edt    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "NOSTRE BANCHE"      to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
