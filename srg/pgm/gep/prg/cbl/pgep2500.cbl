      ...
      *                                   Fase:    gep250              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 02/08/96    *
      *                       Ultima revisione:    NdK del 07/02/14    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Manutenzioni anagrafiche di controllo cre-  *
      *                    dito clienti                                *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase gep250, nella sua globalita', esegue i tipi di manu-   *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * MANFID      Manutenzione Affidamento per controllo esposizione *
      *                                                                *
      * MANACR      Manutenzione Copertura assicurativa del credito    *
      *                                                                *
      * MANMES      Manutenzione Modalita' di emissione solleciti a    *
      *             clienti ___ da implementare ___                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "MANUTENZIONE ANAGR. DI CONTROLLO CREDITI"       .
      ...
      *    *===========================================================*
      *    * Work-area per tipi manutenzione                           *
      *    *-----------------------------------------------------------*
       01  w-tmn.
      *        *-------------------------------------------------------*
      *        * Tabella tipi manutenzione e dati ad essi associati    *
      *        *-------------------------------------------------------*
           05  w-tmn-tbl-tmn.
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-tmn-ele-inx          pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Comodo per caricamento iniziale elementi          *
      *            *---------------------------------------------------*
               10  w-tmn-ele-wci.
                   15  w-tmn-ele-wci-des  pic  x(50)                  .
                   15  filler             pic  x(01)                  .
                   15  w-tmn-ele-wci-alf  pic  x(10)                  .
                   15  filler             pic  x(01)                  .
                   15  w-tmn-ele-wci-ovy  pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Numero effettivo di elementi in tabella           *
      *            *---------------------------------------------------*
               10  w-tmn-ele-num          pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Numero di elementi per pagina                     *
      *            *---------------------------------------------------*
               10  w-tmn-ele-nep          pic  9(03)       value 14   .
      *            *---------------------------------------------------*
      *            * Numero di pagine totali                           *
      *            *---------------------------------------------------*
               10  w-tmn-ele-npt          pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Numero pagina attualmente visualizzata            *
      *            *---------------------------------------------------*
               10  w-tmn-ele-pag          pic  9(03)                  .
      *            *---------------------------------------------------*
      *            * Max numero di elementi in tabella                 *
      *            *---------------------------------------------------*
               10  w-tmn-ele-max          pic  9(03)       value 50   .
      *            *---------------------------------------------------*
      *            * Elementi per tipi manutenzione                    *
      *            *---------------------------------------------------*
               10  w-tmn-ele-tmn occurs 50.
      *                *-----------------------------------------------*
      *                * Codice numerico tipo manutenzione             *
      *                *-----------------------------------------------*
                   15  w-tmn-num-tmn      pic  9(04)                  .
      *                *-----------------------------------------------*
      *                * Sigla alfanumerica tipo manutenzione          *
      *                *-----------------------------------------------*
                   15  w-tmn-alf-tmn      pic  x(10)                  .
      *                *-----------------------------------------------*
      *                * Descrizione tipo manutenzione                 *
      *                *-----------------------------------------------*
                   15  w-tmn-des-tmn      pic  x(50)                  .
      *                *-----------------------------------------------*
      *                * Overlay da richiamare per il tipo di manuten- *
      *                * zione                                         *
      *                *-----------------------------------------------*
                   15  w-tmn-ovy-tmn      pic  x(10)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Salvataggio visualizzazione forzata da segreteria     *
      *        *-------------------------------------------------------*
           05  w-ovy-exe-vis              pic  x(01)                  .
      ...
      *        * alfanumerico del tipo di manutenzione                 *
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'gep250'           *
      *              *-------------------------------------------------*
           perform   fas-gep-250-000      thru fas-gep-250-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/cge/cli/cge450[tip-ord]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Affidamento per controllo esposizione             
      -              " MANFID     pgep250a  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Gestione copertura assicurativa                   
      -              " MANACR     pgep250b  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-gep-250-300
           else if   v-key                =    "PRSC"
                     go to fas-gep-250-400
           else if   v-key                =    "NXSC"
                     go to fas-gep-250-450
           else if   v-key                =    "DOWN"
                     go to fas-gep-250-500
           else if   v-key                =    "EXIT"
                     go to fas-gep-250-250
           else      go to fas-gep-250-200.
       fas-gep-250-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-man        =    zero
                     go to fas-gep-250-330.
           move      zero                 to   w-tmn-ele-inx          .
       fas-gep-250-322.
           add       1                    to   w-tmn-ele-inx          .
           if        w-tmn-ele-inx        >    w-tmn-ele-num
                     go to fas-gep-250-340.
           if        w-tmn-num-tmn
                    (w-tmn-ele-inx)       =    w-key-num-man
                     go to fas-gep-250-350
           else      go to fas-gep-250-322.
       fas-gep-250-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-gep-250-630
           else if   v-key                =    "PRSC"
                     go to fas-gep-250-600
           else if   v-key                =    "NXSC"
                     go to fas-gep-250-610
           else if   v-key                =    "UP  "
                     go to fas-gep-250-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-gep-250-650
           else if   v-key                =    "EXIT"
                     go to fas-gep-250-660
           else      go to fas-gep-250-570.
       fas-gep-250-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-gep-250-626
           else      go to fas-gep-250-628.
       fas-gep-250-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-gep-250-636
           else      go to fas-gep-250-638.
       fas-gep-250-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-gep-250-725
           else      go to fas-gep-250-750.
       fas-gep-250-725.
      *              *-------------------------------------------------*
