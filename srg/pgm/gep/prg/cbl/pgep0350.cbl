      ...
      *                                   Fase:    gep035              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 24/10/94    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Manutenzione Tipi operazione per gestione   *
      *                    portafoglio                                 *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "MANUTENZIONE TIPI OPERAZIONE PORTAFOGLIO"       .
      ...
      *                *-----------------------------------------------*
               10  w-tes-cod-min          pic  9(04)                  .
               10  w-tes-cod-min-des      pic  x(50)                  .
      *                *-----------------------------------------------*
      *                * Codice massimo per la selezione               *
      *                *-----------------------------------------------*
               10  w-tes-cod-max          pic  9(04)                  .
               10  w-tes-cod-max-des      pic  x(50)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-cod-top          pic  9(04)                  .
               10  w-rig-cod-top-des      pic  x(50)                  .
               10  w-rig-cod-mne          pic  x(04)                  .
               10  w-rig-cau-cge          pic  9(03)                  .
               10  w-rig-cau-cge-des      pic  x(40)                  .
               10  w-rig-stc-cge          pic  9(07)                  .
               10  w-rig-stc-cge-des      pic  x(40)                  .
               10  w-rig-ctp-cge          pic  9(07)                  .
               10  w-rig-ctp-cge-des      pic  x(40)                  .
           05  w-rig-002.
      ...
      *                *-----------------------------------------------*
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-cod-top  pic  x(04)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-des-top  pic  x(40)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-cau-cge  pic  x(03)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-stc-cge  pic  x(09)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-ctp-cge  pic  x(09)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Salvataggio per codice tipo operazione                *
      *        *-------------------------------------------------------*
           05  w-sav-cod-top              pic  9(04)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-pmt-cau-001              pic  x(22)                  .
           05  w-pmt-cau-002              pic  x(22)                  .
      *        *-------------------------------------------------------*
      *        * Per prompt sottoconto contabile                       *
      *        *-------------------------------------------------------*
           05  w-pmt-stc-001              pic  x(22)                  .
           05  w-pmt-stc-002              pic  x(22)                  .
      *        *-------------------------------------------------------*
      *        * Per prompt contropartita contabile                    *
      *        *-------------------------------------------------------*
           05  w-pmt-ctp-001              pic  x(22)                  .
           05  w-pmt-ctp-002              pic  x(22)                  .

      *    *===========================================================*
      *    * Work-area per selezioni sul record [zop]                  *
      *    *-----------------------------------------------------------*
       01  w-sel-rec-zop.
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-let.
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [zop]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-zop.
               10  w-let-arc-zop-flg      pic  x(01)                  .
               10  w-let-arc-zop-cod      pic  9(04)                  .
               10  w-let-arc-zop-des      pic  x(50)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-tpm-tip-ope-max          pic  9(03)   value 043      .
      *        *-------------------------------------------------------*
      ...
      *            * Elementi tabella                                  *
      *            *---------------------------------------------------*
               10  w-tpm-tip-ope-ele occurs 043.
      *                *-----------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           perform   vis-stc-cge-des-000  thru vis-stc-cge-des-999    .
      *              *-------------------------------------------------*
      *              * Contropartita contabile                         *
      *              *-------------------------------------------------*
           perform   vis-ctp-cge-000      thru vis-ctp-cge-999        .
           perform   vis-ctp-cge-des-000  thru vis-ctp-cge-des-999    .
       vis-key-reg-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-min        to   w-let-arc-zop-cod      .
           perform   let-arc-zop-000      thru let-arc-zop-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione tipo operazione  *
      *                  *---------------------------------------------*
           move      w-let-arc-zop-des    to   w-tes-cod-min-des      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zop-ope      .
           move      w-tes-cod-max        to   w-cod-mne-zop-cod      .
           move      06                   to   w-cod-mne-zop-lin      .
           move      30                   to   w-cod-mne-zop-pos      .
      ...
      *                  * Lettura codice tipo operazione              *
      *                  *---------------------------------------------*
           move      w-tes-cod-max        to   w-let-arc-zop-cod      .
           perform   let-arc-zop-000      thru let-arc-zop-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione tipo operazione  *
      *                  *---------------------------------------------*
           move      w-let-arc-zop-des    to   w-tes-cod-max-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione tipo operazione *
      *                  *---------------------------------------------*
           perform   vis-cod-max-des-000  thru vis-cod-max-des-999    .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cau-cge        to   w-cod-mne-zcc-cod      .
           move      11                   to   w-cod-mne-zcc-lin      .
           move      30                   to   w-cod-mne-zcc-pos      .
           move      11                   to   w-cod-mne-zcc-dln      .
      ...
      *                  *---------------------------------------------*
           move      w-tes-cau-cge        to   w-let-arc-zcc-cod      .
           perform   let-arc-zcc-000      thru let-arc-zcc-999        .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione descrizione causale         *
      *                  *---------------------------------------------*
           move      w-let-arc-zcc-des    to   w-tes-cau-cge-des      .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       vis-cau-cge-des-000.
           ...
           move      11                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-cau-cge-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       vis-cau-cge-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-stc-cge        to   w-cod-mne-pdc-cod      .
      ...
      *                  *---------------------------------------------*
           move      w-tes-stc-cge        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-tes-stc-cge-des      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-stc-cge        to   w-edt-cod-pdc-cod      .
      ...
      *    *-----------------------------------------------------------*
       vis-stc-cge-des-000.
           ...
           move      14                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-stc-cge-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-stc-cge-des-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione campo : Contropartita contabile              *
      *    *-----------------------------------------------------------*
       acc-ctp-cge-000.
      *              *-------------------------------------------------*
      *              * Pre accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-pdc-ope      .
           move      w-prs-liv-pdc        to   w-cod-mne-pdc-liv      .
           move      w-tes-ctp-cge        to   w-cod-mne-pdc-cod      .
      ...
      *                  * Lettura archivio piano dei conti            *
      *                  *---------------------------------------------*
           move      w-tes-ctp-cge        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-tes-ctp-cge-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione sottoconto      *
      *                  *---------------------------------------------*
           perform   vis-ctp-cge-des-000  thru vis-ctp-cge-des-999    .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Contropartita contabile           *
      *    *-----------------------------------------------------------*
       vis-ctp-cge-000.
      *              *-------------------------------------------------*
      *              * Editing con appoggio a sinistra                 *
      *              *-------------------------------------------------*
           move      w-prs-liv-pdc        to   w-edt-cod-pdc-liv      .
           move      w-tes-ctp-cge        to   w-edt-cod-pdc-cod      .
           move      "B"                  to   w-edt-cod-pdc-edm      .
           perform   edt-pdc-asx-000      thru edt-pdc-asx-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione                                 *
      ...
      *    *-----------------------------------------------------------*
       vis-ctp-cge-des-000.
           ...
           move      17                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-ctp-cge-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-ctp-cge-des-999.
           exit.
      ...
      *                  * Causale contabile                           *
      *                  *---------------------------------------------*
           perform   acc-rig-cau-000      thru acc-rig-cau-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * Sottoconto contabile                        *
      *                  *---------------------------------------------*
           perform   acc-rig-stc-000      thru acc-rig-stc-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Editing Codice tipo operazione          *
      *                      *-----------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      04                   to   v-car                  .
           ...
           move      spaces               to   v-sgn                  .
           move      "B"                  to   v-edm                  .
           move      w-rig-cod-top        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-cod-top      .
       vis-lin-cor-460.
      *                  *---------------------------------------------*
      *                  * Descrizione tipo operazione                 *
      *                  *---------------------------------------------*
           move      w-rig-cod-top-des    to   w-lin-imm-des-top      .
       vis-lin-cor-480.
      *                  *---------------------------------------------*
      *                  * Codice causale                              *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * In base al test di accettabilita' si    *
      *                      * visualizza il segnale di campo da non   *
      *                      * accettare                               *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Test su codice tipo operazione      *
      *                          *-------------------------------------*
           if        w-rig-cod-top        =    0101 or
                     w-rig-cod-top        =    0401 or
                     w-rig-cod-top        =    0402 or
                     w-rig-cod-top        =    0403 or
                     w-rig-cod-top        =    0404 or
                     w-rig-cod-top        =    0415 or
                     w-rig-cod-top        =    0510 or
                     w-rig-cod-top        =    0515 or
                     w-rig-cod-top        =    0516 or
                     w-rig-cod-top        =    0520 or
                     w-rig-cod-top        =    0741
      ...
      *                          *-------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "B"                  to   v-edm                  .
           move      w-rig-cau-cge        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-cau-cge      .
      *                              *---------------------------------*
      *                              * A trattamento codice sottoconto *
      *                              *---------------------------------*
           go to     vis-lin-cor-500.
       vis-lin-cor-490.
      *                          *-------------------------------------*
      *                          * Segnale di campo da non accettare   *
      *                          *-------------------------------------*
           move      "  -"                to   w-lin-imm-cau-cge      .
      *                              *---------------------------------*
      *                              * A trattamento codice sottoconto *
      *                              *---------------------------------*
           go to     vis-lin-cor-500.
      ...
      *                          *-------------------------------------*
           if        w-rig-cod-top        =    0101 or
                     w-rig-cod-top        =    0200 or
                     w-rig-cod-top        =    0401 or
                     w-rig-cod-top        =    0402 or
                     w-rig-cod-top        =    0403 or
                     w-rig-cod-top        =    0404 or
                     w-rig-cod-top        =    0415 or
                     w-rig-cod-top        =    0501 or
                     w-rig-cod-top        =    0502 or
                     w-rig-cod-top        =    0503 or
                     w-rig-cod-top        =    0504 or
                     w-rig-cod-top        =    0510 or
                     w-rig-cod-top        =    0515 or
                     w-rig-cod-top        =    0516 or
                     w-rig-cod-top        =    0520 or
                     w-rig-cod-top        =    0540 or
                     w-rig-cod-top        =    0560 or
                     w-rig-cod-top        =    0700 or
                     w-rig-cod-top        =    0720 or
                     w-rig-cod-top        =    0740 or
                     w-rig-cod-top        =    0741
      ...
      *                          *-------------------------------------*
           move      w-prs-liv-pdc        to   w-edt-cod-pdc-liv      .
           move      w-rig-stc-cge        to   w-edt-cod-pdc-cod      .
           move      "B"                  to   w-edt-cod-pdc-edm      .
           perform   edt-pdc-adx-000      thru edt-pdc-adx-999        .
           move      w-edt-cod-pdc-edt    to   w-lin-imm-stc-cge      .
      *                              *---------------------------------*
      *                              * A trattamento codice contropar- *
      *                              * tita                            *
      *                              *---------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-rig-cod-top        =    0101 or
                     w-rig-cod-top        =    0107 or
                     w-rig-cod-top        =    0108 or
                     w-rig-cod-top        =    0200 or
                     w-rig-cod-top        =    0401 or
                     w-rig-cod-top        =    0402 or
                     w-rig-cod-top        =    0403 or
                     ...
                     w-rig-cod-top        =    0540 or
                     w-rig-cod-top        =    0560 or
                     w-rig-cod-top        =    0600 or
                     w-rig-cod-top        =    0620 or
                     w-rig-cod-top        =    0700 or
                     w-rig-cod-top        =    0720 or
                     w-rig-cod-top        =    0740 or
                     w-rig-cod-top        =    0741
      ...
      *                          *-------------------------------------*
           move      w-prs-liv-pdc        to   w-edt-cod-pdc-liv      .
           move      w-rig-ctp-cge        to   w-edt-cod-pdc-cod      .
           move      "B"                  to   w-edt-cod-pdc-edm      .
           perform   edt-pdc-adx-000      thru edt-pdc-adx-999        .
           move      w-edt-cod-pdc-edt    to   w-lin-imm-ctp-cge      .
      *                              *---------------------------------*
      *                              * A trattamento Parametri per la  *
      *                              * visualizzazione                 *
      *                              *---------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.       Codice e descrizione tipo operazione  
      -              "     Cau  Sottoc.c.  Controp.c"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *              * Causale contabile                               *
      *              *-------------------------------------------------*
           perform   vis-rig-cau-000      thru vis-rig-cau-999        .
           perform   vis-rig-cau-des-000  thru vis-rig-cau-des-999    .
      *              *-------------------------------------------------*
      *              * Sottoconto contabile                            *
      *              *-------------------------------------------------*
           perform   vis-rig-stc-000      thru vis-rig-stc-999        .
           perform   vis-rig-stc-des-000  thru vis-rig-stc-des-999    .
      *              *-------------------------------------------------*
      *              * Contropartita contabile                         *
      *              *-------------------------------------------------*
      ...
      *                  * Causale contabile                           *
      *                  *---------------------------------------------*
           perform   pmt-rig-cau-000      thru pmt-rig-cau-999        .
      *                  *---------------------------------------------*
      *                  * Sottoconto contabile                        *
      *                  *---------------------------------------------*
           perform   pmt-rig-stc-000      thru pmt-rig-stc-999        .
      *                  *---------------------------------------------*
      *                  * Contropartita contabile                     *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice tipo operazione           *
      *    *-----------------------------------------------------------*
       pmt-cod-top-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt specifico per l'accettazione :     *
      *    * Causale contabile                                         *
      *    *-----------------------------------------------------------*
       pmt-rix-cau-000.
      *              *-------------------------------------------------*
      *              * Test su codice tipo operazione                  *
      *              *-------------------------------------------------*
           if        w-rig-cod-top        =    zero
                     go to pmt-rix-cau-010
           else if   w-rig-cod-top        =    0102 or
                     w-rig-cod-top        =    0103 or
                     w-rig-cod-top        =    0104 or
                     w-rig-cod-top        =    0105 or
                     w-rig-cod-top        =    0106 or
                     w-rig-cod-top        =    0107 or
                     w-rig-cod-top        =    0108 or
                     w-rig-cod-top        =    0109 or
                     w-rig-cod-top        =    0110 or
                     w-rig-cod-top        =    0111
                     go to pmt-rix-cau-100
           else if   w-rig-cod-top        =    0161
                     go to pmt-rix-cau-160
           else if   w-rig-cod-top        =    0200
                     go to pmt-rix-cau-200
           else if   w-rig-cod-top        =    0301 or
                     w-rig-cod-top        =    0302 or
                     w-rig-cod-top        =    0303 or
                     w-rig-cod-top        =    0304
                     go to pmt-rix-cau-300
           else if   w-rig-cod-top        =    0321 or
                     w-rig-cod-top        =    0322 or
                     w-rig-cod-top        =    0323 or
                     w-rig-cod-top        =    0324
                     go to pmt-rix-cau-320
           else if   w-rig-cod-top        =    0350
                     go to pmt-rix-cau-350
           else if   w-rig-cod-top        =    0401 or
                     w-rig-cod-top        =    0402 or
                     w-rig-cod-top        =    0403 or
                     w-rig-cod-top        =    0404
                     go to pmt-rix-cau-400
           else if   w-rig-cod-top        =    0415
                     go to pmt-rix-cau-415
           else if   w-rig-cod-top        =    0501 or
                     w-rig-cod-top        =    0502 or
                     w-rig-cod-top        =    0503 or
                     w-rig-cod-top        =    0504
                     go to pmt-rix-cau-500
           else if   w-rig-cod-top        =    0510 or
                     w-rig-cod-top        =    0515 or
                     w-rig-cod-top        =    0516
                     go to pmt-rix-cau-510
           else if   w-rig-cod-top        =    0520
                     go to pmt-rix-cau-520
           else if   w-rig-cod-top        =    0540
                     go to pmt-rix-cau-540
           else if   w-rig-cod-top        =    0560
                     go to pmt-rix-cau-560
           else if   w-rig-cod-top        =    0600
                     go to pmt-rix-cau-600
           else if   w-rig-cod-top        =    0620
                     go to pmt-rix-cau-620
           else if   w-rig-cod-top        =    0700
                     go to pmt-rix-cau-700
           else if   w-rig-cod-top        =    0720
                     go to pmt-rix-cau-720
           else if   w-rig-cod-top        =    0740
                     go to pmt-rix-cau-740
           else      go to pmt-rix-cau-999.
       pmt-rix-cau-010.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           go to     pmt-rix-cau-900.
       pmt-rix-cau-100.
      *              *-------------------------------------------------*
      *              * Preparazione prompt per causali 0101..0111      *
      *              *-------------------------------------------------*
           move      "Causale contabile per "
                                          to   w-pmt-cau-001          .
      ...
      *              *-------------------------------------------------*
           if        w-rig-cod-top        =    zero
                     ...
                     w-rig-cod-top        =    0110 or
                     w-rig-cod-top        =    0111
                     go to pmt-rix-stc-100
           else if   w-rig-cod-top        =    0161
                     go to pmt-rix-stc-160
           else if   w-rig-cod-top        =    0200
                     go to pmt-rix-stc-200
           else if   w-rig-cod-top        =    0301 or
                     w-rig-cod-top        =    0302 or
                     w-rig-cod-top        =    0303 or
                     w-rig-cod-top        =    0304
                     go to pmt-rix-stc-300
           else if   w-rig-cod-top        =    0321 or
                     w-rig-cod-top        =    0322 or
                     w-rig-cod-top        =    0323 or
                     w-rig-cod-top        =    0324
                     go to pmt-rix-stc-320
           else if   w-rig-cod-top        =    0350
                     go to pmt-rix-stc-350
           else if   w-rig-cod-top        =    0401 or
                     w-rig-cod-top        =    0402 or
                     w-rig-cod-top        =    0403 or
                     w-rig-cod-top        =    0404
                     go to pmt-rix-stc-400
           else if   w-rig-cod-top        =    0415
                     go to pmt-rix-stc-415
           else if   w-rig-cod-top        =    0501 or
                     w-rig-cod-top        =    0502 or
                     w-rig-cod-top        =    0503 or
                     w-rig-cod-top        =    0504
                     go to pmt-rix-stc-500
           else if   w-rig-cod-top        =    0510 or
                     w-rig-cod-top        =    0515 or
                     w-rig-cod-top        =    0516
                     go to pmt-rix-stc-510
           else if   w-rig-cod-top        =    0520
                     go to pmt-rix-stc-520
           else if   w-rig-cod-top        =    0540
                     go to pmt-rix-stc-540
           else if   w-rig-cod-top        =    0560
                     go to pmt-rix-stc-560
           else if   w-rig-cod-top        =    0600
                     go to pmt-rix-stc-600
           else if   w-rig-cod-top        =    0620
                     go to pmt-rix-stc-620
           else if   w-rig-cod-top        =    0700
                     go to pmt-rix-stc-700
           else if   w-rig-cod-top        =    0720
                     go to pmt-rix-stc-720
           else if   w-rig-cod-top        =    0740
                     go to pmt-rix-stc-740
           else      go to pmt-rix-stc-999.
       pmt-rix-stc-010.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-rig-cod-top        =    zero
                     ...
                     w-rig-cod-top        =    0109 or
                     w-rig-cod-top        =    0110 or
                     w-rig-cod-top        =    0111 or
                     w-rig-cod-top        =    0161
                     go to pmt-rix-ctp-100
           else if   w-rig-cod-top        =    0301 or
                     w-rig-cod-top        =    0302 or
                     w-rig-cod-top        =    0303 or
                     w-rig-cod-top        =    0304
                     go to pmt-rix-ctp-300
           else if   w-rig-cod-top        =    0321 or
                     w-rig-cod-top        =    0322 or
                     w-rig-cod-top        =    0323 or
                     w-rig-cod-top        =    0324
                     go to pmt-rix-ctp-320
           else if   w-rig-cod-top        =    0350
                     go to pmt-rix-ctp-350
           else      go to pmt-rix-ctp-800.
       pmt-rix-ctp-010.
      *              *-------------------------------------------------*
      *              * Preparazione prompt per tipo operazione a zero  *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione 1. campo riga corpo : Codice tipo operazione *
      *    *-----------------------------------------------------------*
       acc-cod-top-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-top        to   w-sav-cod-top          .
       acc-cod-top-100.
      *              *-------------------------------------------------*
      *              * Ripristino valore precedente                    *
      *              *-------------------------------------------------*
           move      w-sav-cod-top        to   w-rig-cod-top          .
       acc-cod-top-125.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "AC"                 to   w-cod-mne-zop-ope      .
           move      w-rig-cod-top        to   w-cod-mne-zop-cod      .
           move      17                   to   w-cod-mne-zop-lin      .
           move      25                   to   w-cod-mne-zop-pos      .
      ...
      *                  *---------------------------------------------*
       ...
       acc-cod-top-152.
           perform   cod-mne-zop-cll-000  thru cod-mne-zop-cll-999    .
           if        w-cod-mne-zop-ope    =    "F+"
                     go to acc-cod-top-154.
           if        w-cod-mne-zop-ope    =    "AC"
                     go to acc-cod-top-156.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-top-154.
           perform   cod-mne-zop-foi-000  thru cod-mne-zop-foi-999    .
           go to     acc-cod-top-152.
       acc-cod-top-156.
           move      w-cod-mne-zop-cod    to   v-num                  .
       acc-cod-top-200.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice tipo operazione, descrizione     *
      *    *-----------------------------------------------------------*
       vis-cod-top-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      17                   to   v-lin                  .
           move      31                   to   v-pos                  .
           move      w-rig-cod-top-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-top-des-999.
           exit.
      ...
      *                  *---------------------------------------------*
           if        w-rig-cod-top        =    0101 or
                     ...
                     w-rig-cod-top        =    0520 or
                     w-rig-cod-top        =    0741
                     go to acc-rig-cau-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione prompt specifico            *
      *                  *---------------------------------------------*
           perform   pmt-rix-cau-000      thru pmt-rix-cau-999        .
       acc-rig-cau-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zcc-ope      .
           move      w-rig-cau-cge        to   w-cod-mne-zcc-cod      .
       ...
       acc-rig-cau-110.
           perform   cod-mne-zcc-cll-000  thru cod-mne-zcc-cll-999    .
           if        w-cod-mne-zcc-ope    =    "F+"
                     go to acc-rig-cau-115.
           if        w-cod-mne-zcc-ope    =    "AC"
                     go to acc-rig-cau-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-cau-115.
           perform   cod-mne-zcc-foi-000  thru cod-mne-zcc-foi-999    .
           go to     acc-rig-cau-110.
       acc-rig-cau-120.
           move      w-cod-mne-zcc-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *                  * Lettura tabella causali                     *
      *                  *---------------------------------------------*
           move      w-rig-cau-cge        to   w-let-arc-zcc-cod      .
           perform   let-arc-zcc-000      thru let-arc-zcc-999        .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione descrizione causale         *
      *                  *---------------------------------------------*
           move      w-let-arc-zcc-des    to   w-rig-cau-cge-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione causale         *
      *                  *---------------------------------------------*
           perform   vis-rig-cau-des-000  thru vis-rig-cau-des-999    .
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-zcc-flg    not  = spaces
                     go to acc-rig-cau-100.
      *                  *---------------------------------------------*
      *                  * Se causale a zero : continuazione           *
      *                  *---------------------------------------------*
           if        w-rig-cau-cge        =    zero
                     go to acc-rig-cau-600.
       acc-rig-cau-450.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   pmt-rig-cor-000      thru pmt-rig-cor-999        .
      *                  *---------------------------------------------*
      *                  * Visualizzazione dati riga d'accettazione    *
      *                  *---------------------------------------------*
           perform   vis-rig-cor-000      thru vis-rig-cor-999        .
      *                  *---------------------------------------------*
      *                  * Video in On                                 *
      ...
      *                  *---------------------------------------------*
           if        w-rig-cod-top        =    0101 or
                     ...
                     w-rig-cod-top        =    0740 or
                     w-rig-cod-top        =    0741
                     go to acc-rig-stc-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione prompt specifico            *
      *                  *---------------------------------------------*
           perform   pmt-rix-stc-000      thru pmt-rix-stc-999        .
       acc-rig-stc-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-pdc-ope      .
           move      w-prs-liv-pdc        to   w-cod-mne-pdc-liv      .
           move      w-rig-stc-cge        to   w-cod-mne-pdc-cod      .
           move      19                   to   w-cod-mne-pdc-lin      .
           move      25                   to   w-cod-mne-pdc-pos      .
       ...
       acc-rig-stc-110.
           perform   cod-mne-pdc-cll-000  thru cod-mne-pdc-cll-999    .
           if        w-cod-mne-pdc-ope    =    "F+"
                     go to acc-rig-stc-115.
           if        w-cod-mne-pdc-ope    =    "AC"
                     go to acc-rig-stc-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-stc-115.
           perform   cod-mne-pdc-foi-000  thru cod-mne-pdc-foi-999    .
           go to     acc-rig-stc-110.
       acc-rig-stc-120.
           move      w-cod-mne-pdc-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *                  * Lettura archivio piano dei conti            *
      *                  *---------------------------------------------*
           move      w-rig-stc-cge        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-rig-stc-cge-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione sottoconto      *
      *                  *---------------------------------------------*
           perform   vis-rig-stc-des-000  thru vis-rig-stc-des-999    .
      ...
      *                  * Visualizzazione prompt specifico            *
      *                  *---------------------------------------------*
           perform   pmt-rix-ctp-000      thru pmt-rix-ctp-999        .
       acc-rig-ctp-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-pdc-ope      .
           move      w-prs-liv-pdc        to   w-cod-mne-pdc-liv      .
           move      w-rig-ctp-cge        to   w-cod-mne-pdc-cod      .
      ...
      *                  * Lettura archivio piano dei conti            *
      *                  *---------------------------------------------*
           move      w-rig-ctp-cge        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-rig-ctp-cge-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione sottoconto      *
      *                  *---------------------------------------------*
           perform   vis-rig-ctp-des-000  thru vis-rig-ctp-des-999    .
      ...
      *                  *---------------------------------------------*
           perform   vis-rig-cor-000      thru vis-rig-cor-999        .
      *                  *---------------------------------------------*
      *                  * Ripristino trattini a linea 22              *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      80                   to   v-car                  .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-ctp-des-000.
           ...
           move      20                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-ctp-cge-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-ctp-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-101.
           if        w-rig-cod-top        =    zero
                     go to cnt-tdo-rig-150.
           if        w-rig-cod-top        =    0600 or
                     w-rig-cod-top        =    0620
                     go to cnt-tdo-rig-150.
           if        w-rig-cod-top        not  < 0101 and
                     w-rig-cod-top        not  > 0111
                     go to cnt-tdo-rig-105
           else if   w-rig-cod-top        not  < 0301 and
                     w-rig-cod-top        not  > 0304
                     go to cnt-tdo-rig-105
           else if   w-rig-cod-top        =    0161
                     go to cnt-tdo-rig-105
           else      go to cnt-tdo-rig-150.
       cnt-tdo-rig-105.
           if        w-rig-cau-cge        =    zero
                     go to cnt-tdo-rig-150.
           if        w-rig-stc-cge        not  = zero
                     go to cnt-tdo-rig-150.
           if        w-rig-cod-top        not  < 0301 and
                     w-rig-cod-top        not  > 0304
                     go to cnt-tdo-rig-110
           else      go to cnt-tdo-rig-115.
       cnt-tdo-rig-110.
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-151.
           ...
           if        w-rig-cod-top        not  < 0301 and
                     w-rig-cod-top        not  > 0304
                     go to cnt-tdo-rig-155
           else      go to cnt-tdo-rig-200.
       cnt-tdo-rig-155.
           if        w-rig-cau-cge        =    zero
                     go to cnt-tdo-rig-200.
           if        w-rig-ctp-cge        not  = zero
                     go to cnt-tdo-rig-200.
           if        w-rig-cod-top        not  < 0301 and
                     w-rig-cod-top        not  > 0304
                     go to cnt-tdo-rig-160
           else      go to cnt-tdo-rig-165.
       cnt-tdo-rig-160.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tes-cau-cge          .
           move      spaces               to   w-tes-cau-cge-des      .
           move      zero                 to   w-tes-stc-cge          .
           move      spaces               to   w-tes-stc-cge-des      .
           move      zero                 to   w-tes-ctp-cge          .
           move      spaces               to   w-tes-ctp-cge-des      .
       nor-key-reg-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-rig-cod-top          .
           move      spaces               to   w-rig-cod-top-des      .
      *              *-------------------------------------------------*
      *              * Normalizzazione dati da modificare              *
      *              *-------------------------------------------------*
           move      spaces               to   w-rig-cod-mne          .
           move      zero                 to   w-rig-cau-cge          .
           move      spaces               to   w-rig-cau-cge-des      .
           move      zero                 to   w-rig-stc-cge          .
           move      spaces               to   w-rig-stc-cge-des      .
           move      zero                 to   w-rig-ctp-cge          .
           move      spaces               to   w-rig-ctp-cge-des      .
       nor-nok-rig-999.
           exit.
      ...
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Nessun tipo operazione da trattare !              
      -              "          "         to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-min        to   rf-zop-cod-top         .
           move      "pgm/gep/fls/ioc/obj/iofzop"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Ordinamento per Codice                      *
      *                  *---------------------------------------------*
           if        rf-zop-cod-top       >    w-tes-cod-max
                     go to car-fil-rap-900.
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   sel-rec-zop-000      thru sel-rec-zop-999        .
      *                  *---------------------------------------------*
      *                  * Test su flag di selezione                   *
      *                  *---------------------------------------------*
           if        w-sel-rec-zop-flg    not  = spaces
                     go to car-fil-rap-200.
       car-fil-rap-500.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Selezioni sul record [zop]                                *
      *    *-----------------------------------------------------------*
       sel-rec-zop-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di selezione               *
      *              *-------------------------------------------------*
           move      spaces               to   w-sel-rec-zop-flg      .
       sel-rec-zop-010.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Non si considera il tipo operazione 'zero'  *
      *                  *---------------------------------------------*
           if        rf-zop-cod-top       =    zero
                     go to sel-rec-zop-900.
       sel-rec-zop-100.
      *                  *---------------------------------------------*
      *                  * Causale contabile                           *
      *                  *---------------------------------------------*
           if        w-tes-cau-cge        =    zero
                     go to sel-rec-zop-200.
           if        rf-zop-cau-cge       not  = w-tes-cau-cge
                     go to sel-rec-zop-900.
       sel-rec-zop-200.
      *                  *---------------------------------------------*
      *                  * Sottoconto contabile                        *
      *                  *---------------------------------------------*
           if        w-tes-stc-cge        =    zero
                     go to sel-rec-zop-300.
           if        rf-zop-stc-cge       not  = w-tes-stc-cge
                     go to sel-rec-zop-900.
       sel-rec-zop-300.
      *                  *---------------------------------------------*
      *                  * Contropartita contabile                     *
      *                  *---------------------------------------------*
           if        w-tes-ctp-cge        =    zero
                     go to sel-rec-zop-800.
           if        rf-zop-ctp-cge       not  = w-tes-ctp-cge
                     go to sel-rec-zop-900.
       sel-rec-zop-800.
      *                  *---------------------------------------------*
      *                  * Uscita per selezione superata               *
      *                  *---------------------------------------------*
           go to     sel-rec-zop-999.
       sel-rec-zop-900.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Codice e descrizione tipo operazio- *
      *                          * ne                                  *
      *                          *-------------------------------------*
           move      rf-zop-cod-top       to   w-rig-cod-top          .
           move      rf-zop-des-top       to   w-rig-cod-top-des      .
      *                          *-------------------------------------*
      *                          * Codice mnemonico                    *
      *                          *-------------------------------------*
           move      rf-zop-cod-mne       to   w-rig-cod-mne          .
      *                          *-------------------------------------*
      *                          * Causale contabile                   *
      *                          *-------------------------------------*
           move      rf-zop-cau-cge       to   w-rig-cau-cge          .
      *                          *-------------------------------------*
      *                          * Sottoconto contabile                *
      *                          *-------------------------------------*
           move      rf-zop-stc-cge       to   w-rig-stc-cge          .
      *                          *-------------------------------------*
      *                          * Contropartita contabile             *
      *                          *-------------------------------------*
           move      rf-zop-ctp-cge       to   w-rig-ctp-cge          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      24                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "             --- Aggiornamento dei tipi operazione
      -              " in esecuzione ---            "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
      *              * Lettura, con lock, del record [zop]             *
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODTOP    "         to   f-key                  .
           move      w-rig-cod-top        to   rf-zop-cod-top         .
           move      "pgm/gep/fls/ioc/obj/iofzop"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Causale contabile                   *
      *                          *-------------------------------------*
           move      w-rig-cau-cge        to   rf-zop-cau-cge         .
      *                          *-------------------------------------*
      *                          * Sottoconto contabile                *
      *                          *-------------------------------------*
           move      w-rig-stc-cge        to   rf-zop-stc-cge         .
      *                          *-------------------------------------*
      *                          * Contropartita contabile             *
      *                          *-------------------------------------*
           move      w-rig-ctp-cge        to   rf-zop-ctp-cge         .
      *                          *-------------------------------------*
      *                          * Codice mnemonico                    *
      *                          *-------------------------------------*
           move      w-rig-cod-mne        to   rf-zop-cod-mne         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-zop-flg      .
      *              *-------------------------------------------------*
      *              * Test se codice a zero                           *
      *              *-------------------------------------------------*
           if        w-let-arc-zop-cod    =    zero
                     go to let-arc-zop-500.
      *              *-------------------------------------------------*
      *              * Lettura per codice                              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODTOP    "         to   f-key                  .
           move      w-let-arc-zop-cod    to   rf-zop-cod-top         .
           move      "pgm/gep/fls/ioc/obj/iofzop"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-zop                 .
           if        f-sts                not  = e-not-err
                     go to let-arc-zop-400.
       let-arc-zop-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-zop-des-top       to   w-let-arc-zop-des      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     let-arc-zop-999.
       let-arc-zop-400.
      *              *-------------------------------------------------*
      *              * Azioni per record non trovato                   *
      *              *-------------------------------------------------*
           move      "#"                  to   w-let-arc-zop-flg      .
           move      all   "."            to   w-let-arc-zop-des      .
           go to     let-arc-zop-600.
       let-arc-zop-500.
      *              *-------------------------------------------------*
      *              * Normalizzazione work area                       *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-zop-des      .
       let-arc-zop-600.
       let-arc-zop-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-tpm-tip-ope-cod
                    (w-cix-ctr-001)       to   rf-zop-cod-top         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      "IG"                 to   s-ope                  .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/gep/prg/obj/pgep0352"                       .
       cnc-rlt-sup-999.
           exit.
