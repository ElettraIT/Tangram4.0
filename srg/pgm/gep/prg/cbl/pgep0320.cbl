      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pgep0321:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tipi operazione"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-zop-cod      .
           move      13                   to   w-cod-mne-zop-lin      .
           move      19                   to   w-cod-mne-zop-pos      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zop-ope      .
           move      rr-cod-max           to   w-cod-mne-zop-cod      .
           move      13                   to   w-cod-mne-zop-lin      .
           move      51                   to   w-cod-mne-zop-pos      .
           move      zero                 to   w-cod-mne-zop-dln      .
           move      zero                 to   w-cod-mne-zop-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
