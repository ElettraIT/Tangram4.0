      ...
      *                                   Fase:    gep301              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 09/04/94    *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase gep301, nella sua globalita', esegue i tipi di inter-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * INTSDB      Interrogazione su scadenze cliente        pgep301a *
      *                                                                *
      * INTRSD      Interrogazione su riscossioni cliente     pgep301b *
      *                                                                *
      * INTPGD      Interrogazione su pagamenti a cliente     pgep301c *
      *                                                                *
      * INTCMD      Interrogazione su compensazioni scadenze  pgep301d *
      *                                                                *
      * INTDDP      Interrogazione su distinte di present.    pgep301e *
      *                                                                *
      * INTRSA      Interrogazione su assegni riscossi        pgep301f *
      *                                                                *
      * INTIID      Ricerca scadenze per inclusione in dist.  pgep3014 *
      *             (non selezionabile per impostazione)               *
      *                                                                *
      * ESPSDB      Espansione movimenti effettuati su di     pgep301x *
      *             una scadenza                                       *
      *             (non selezionabile per impostazione)               *
      *                                                                *
      * ESPDDP      Espansione movimenti effettuati su di     pgep301y *
      *             una distinta                                       *
      *             (non selezionabile per impostazione)               *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   RICERCHE PER MOVIMENTI PORTAFOGLIO   "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'gep301'           *
      *              *-------------------------------------------------*
           perform   fas-gep-301-000      thru fas-gep-301-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *
      ...
      -              " INTPGD     pgep301c  "
           ...
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Compensazioni scadenze                            
      -              " INTCMD     pgep301d  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Distinte di presentazione                         
      -              " INTDDP     pgep301e  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Ricerca assegni riscossi                          
      -              " INTRSA     pgep301f  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Scadenze per inclusione in distinta               
      -              "*INTIID     pgep3014  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *       
           move      "Espansione movimenti effettuati su di una scadenza
      -              "*ESPSDB     pgep301x  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *       
           move      "Espansione movimenti effettuati su di una distinta
      -              "*ESPDDP     pgep301y  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *       
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-gep-301-300
           else if   v-key                =    "PRSC"
                     go to fas-gep-301-400
           else if   v-key                =    "NXSC"
                     go to fas-gep-301-450
           else if   v-key                =    "DOWN"
                     go to fas-gep-301-500
           else if   v-key                =    "EXIT"
                     go to fas-gep-301-250
           else      go to fas-gep-301-200.
       fas-gep-301-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-gep-301-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-gep-301-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-gep-301-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-gep-301-350
           else      go to fas-gep-301-322.
       fas-gep-301-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-gep-301-630
           else if   v-key                =    "PRSC"
                     go to fas-gep-301-600
           else if   v-key                =    "NXSC"
                     go to fas-gep-301-610
           else if   v-key                =    "UP  "
                     go to fas-gep-301-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-gep-301-650
           else if   v-key                =    "EXIT"
                     go to fas-gep-301-660
           else      go to fas-gep-301-570.
       fas-gep-301-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-gep-301-626
           else      go to fas-gep-301-628.
       fas-gep-301-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-gep-301-636
           else      go to fas-gep-301-638.
       fas-gep-301-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-gep-301-725
           else      go to fas-gep-301-750.
       fas-gep-301-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
