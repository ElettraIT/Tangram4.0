      ...
      *                                   Fase:    gep830              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 14/10/03    *
      *                       Ultima revisione:    NdK del 28/06/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione lista clienti con solleciti        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " GESTIONE LISTA CLIENTI DA SOLLECITARE  "       .
      ...
      *                  *---------------------------------------------*
           if        w-rig-inl-slc        =    01
                     move  "Sede"         to   w-lin-imm-inl-slc
           else if   w-rig-inl-slc        =    02
                     move  "sLeg"         to   w-lin-imm-inl-slc
           else if   w-rig-inl-slc        =    03
                     move  "Dipz"         to   w-lin-imm-inl-slc
           else      move  spaces         to   w-lin-imm-inl-slc      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Livello sollecito                    *
      *    *-----------------------------------------------------------*
       acc-liv-slc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-liv-slc        to   w-sav-liv-slc          .
       acc-liv-slc-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   ges-sca-slc-000      thru ges-sca-slc-999        .
      *                  *---------------------------------------------*
      *                  * Update dati da gep840                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-liv-slc        >    w-prs-max-liv
                     go to acc-liv-slc-100.
      *                  *---------------------------------------------*
      *                  * Test su valore massimo per il cliente       *
      *                  *---------------------------------------------*
           if        w-rig-ems-aac        =    zero
                     go to acc-liv-slc-600.
           if        w-rig-liv-slc        not  > w-rig-ems-aac
                     go to acc-liv-slc-600.
      ...
      *                  *---------------------------------------------*
           if        w-rig-liv-slc        =    w-sav-liv-slc
      ...
      *                      *-----------------------------------------*
           if        w-rig-tts-aac        =    zero
                     go to acc-liv-slc-610
           else if   w-rig-tts-aac        =    01
                     go to acc-liv-slc-620
           else if   w-rig-tts-aac        =    02
                     go to acc-liv-slc-630
           else if   w-rig-tts-aac        =    03
                     go to acc-liv-slc-640
           else if   w-rig-tts-aac        =    99
      ...
      *                      *-----------------------------------------*
           if        w-rig-liv-slc        =    01
                     move  w-ref-tso-std-l01
                                          to   w-rig-cod-tso
           else if   w-rig-liv-slc        =    02
                     move  w-ref-tso-std-l02
                                          to   w-rig-cod-tso
           else if   w-rig-liv-slc        =    03
      ...
      *                      * 1                                       *
      *                      *-----------------------------------------*
           move      w-ref-tso-std-l01    to   w-rig-cod-tso          .
           go to     acc-liv-slc-700.
       acc-liv-slc-630.
      *                      *-----------------------------------------*
      *                      * Tipo di testo : Sempre testo di livello *
      *                      * 2                                       *
      *                      *-----------------------------------------*
           move      w-ref-tso-std-l02    to   w-rig-cod-tso          .
           go to     acc-liv-slc-700.
       acc-liv-slc-640.
      *                      *-----------------------------------------*
      *                      * Tipo di testo : Sempre testo di livello *
      *                      * 3                                       *
      *                      *-----------------------------------------*
           move      w-ref-tso-std-l03    to   w-rig-cod-tso          .
           go to     acc-liv-slc-700.
       acc-liv-slc-650.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-det-num-sca-tot    to   w-rig-num-sel          .
           perform   vis-num-sca-000      thru vis-num-sca-999        .
       acc-liv-slc-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-cod-tso        to   w-cod-mne-zso-cod      .
           move      20                   to   w-cod-mne-zso-lin      .
           move      22                   to   w-cod-mne-zso-pos      .
           move      20                   to   w-cod-mne-zso-dln      .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Numero scadenze                      *
      *    *-----------------------------------------------------------*
       acc-num-sca-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-num-sca        to   w-sav-num-sca          .
       acc-num-sca-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  * Ripristino valore precedente                *
      *                  *---------------------------------------------*
           move      w-sav-num-sca        to   w-rig-num-sca          .
       acc-num-sca-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      24                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "           --- Caricamento scadenze da sollecitare
      -              " in esecuzione ---            "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      24                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "          --- Aggiornamento scadenze da sollecitar
      -              "e in esecuzione ---           "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           if        w-rig-liv-slc        =    rf-sct-liv-slc and
                     w-rig-cod-tso        =    rf-sct-cod-tso
      ...
      *                  *---------------------------------------------*
      *                  * Aggiornamento livello sollecito             *
      *                  *---------------------------------------------*
           move      w-rig-liv-slc        to   rf-sct-liv-slc         .
      *                  *---------------------------------------------*
      *                  * Aggiornamento tipo sollecito                *
      *                  *---------------------------------------------*
           move      w-rig-cod-tso        to   rf-sct-cod-tso         .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [sct]                         *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Gestione scadenze da sollecitare                          *
      *    *-----------------------------------------------------------*
       ges-sca-slc-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     go to ges-sca-slc-999.
       ges-sca-slc-200.
      *              *-------------------------------------------------*
      *              * Preparazione variabili di i.p.c. per l'inseri-  *
      *              * mento                                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice cliente                              *
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/gep/prg/obj/pgep8302"                       .
       cnc-rlt-sup-999.
           exit.
