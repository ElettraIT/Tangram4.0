      ...
      *                                                                *
      *                    Affidamento per controllo esposizione       *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-max-fid          pic  9(13)                  .
               10  w-rig-dat-fid          pic  9(07)                  .
           05  w-rig-002.
               ...
               10  w-rig-max-fid-2        pic  9(13)                  .
               10  w-rig-dat-fid-2        pic  9(07)                  .
      ...
      *                *-----------------------------------------------*
                   ...
                   15  w-lin-imm-rag-cli.
                       20  w-lin-imm-rag-rag
                                          pic  x(40)                  .
                   15  w-lin-imm-inl-fid  pic  x(14)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-inl-dfi  pic  x(08)                  .
      ...
      *                  * Fido massimo                                *
      *                  *---------------------------------------------*
           perform   acc-key-fid-000      thru acc-key-fid-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Fido massimo                                    *
      *              *-------------------------------------------------*
           perform   vis-key-fid-000      thru vis-key-fid-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Fido massimo                                *
      *                  *---------------------------------------------*
           perform   pmt-key-fid-000      thru pmt-key-fid-999        .
       pmt-key-reg-999.
           exit.
      ...
      *                  *---------------------------------------------*
       ...
       vis-lin-cor-480.
      *                  *---------------------------------------------*
      *                  * Editing Fido massimo                        *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se valore a zero                        *
      *                      *-----------------------------------------*
           if        w-rig-max-fid        =    zero and
                     w-rig-dat-fid        =    zero
                     move  "            --"
                                          to   w-lin-imm-inl-fid
                     go to vis-lin-cor-500
           else if   w-rig-max-fid        =    zero and
                     w-rig-dat-fid        not  = zero
                     move  "     Garantito"
                                          to   w-lin-imm-inl-fid
                     go to vis-lin-cor-500
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "BG"                 to   v-edm                  .
           move      w-rig-max-fid        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-inl-fid      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Editing data di riferimento fido            *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      w-rig-dat-fid        to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-inl-dfi      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data riferimento fido massimo    *
      *    *-----------------------------------------------------------*
       pmt-dat-fid-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              * Se valore a zero                                *
      *              *-------------------------------------------------*
           if        w-rig-dat-fid        =    zero
                     go to vis-max-fid-200.
           if        w-rig-max-fid        not  = zero
                     go to vis-max-fid-200.
      *                  *---------------------------------------------*
      *                  * Literal 'Garantito'                         *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-200.
      *              *-------------------------------------------------*
      *              * Controllo su data riferimento fido              *
      *              *-------------------------------------------------*
           if        w-rig-max-fid        =    zero
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-max-fid          .
           move      zero                 to   w-rig-dat-fid          .
       nor-nok-rig-999.
           exit.
      ...
      *                  * Fido massimo                                *
      *                  *---------------------------------------------*
           if        w-tes-max-fid        =    zero
                     go to sel-rec-cli-800.
           if        rf-ccc-max-fid       not  = w-tes-max-fid
      ...
      *                          *-------------------------------------*
           ...
           move      rf-ccc-max-fid       to   w-rig-max-fid          .
           move      rf-ccc-dat-fid       to   w-rig-dat-fid          .
       car-eff-rig-800.
      *              *-------------------------------------------------*
      ...
      *                  * cedente Fido massimo                        *
      *                  *---------------------------------------------*
           if        w-rig-max-fid        =    zero and
                     w-rig-dat-fid        =    zero and
                     w-rig-max-fid-2      =    zero and
                     w-rig-dat-fid-2      =    zero
      ...
      *                      *-----------------------------------------*
           move      w-rig-max-fid        to   rf-ccc-max-fid         .
           move      w-rig-dat-fid        to   rf-ccc-dat-fid         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
