      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase gep400, nella sua globalita', esegue i tipi di inter-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * APGRSP      Riepilogo situazione di portafoglio globale        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "     ANALISI DI PORTAFOGLIO GLOBALE     "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'gep400'           *
      *              *-------------------------------------------------*
           perform   fas-gep-400-000      thru fas-gep-400-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *
           move      "Riepilogo situazione globale di portafoglio       
      -              " APGRSP     pgep400a  "
                                          to   w-tin-ele-wci          .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-gep-400-300
           else if   v-key                =    "PRSC"
                     go to fas-gep-400-400
           else if   v-key                =    "NXSC"
                     go to fas-gep-400-450
           else if   v-key                =    "DOWN"
                     go to fas-gep-400-500
           else if   v-key                =    "EXIT"
                     go to fas-gep-400-250
           else      go to fas-gep-400-200.
       fas-gep-400-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-gep-400-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-gep-400-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-gep-400-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-gep-400-350
           else      go to fas-gep-400-322.
       fas-gep-400-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DOWN"
                     go to fas-gep-400-630
           else if   v-key                =    "PRSC"
                     go to fas-gep-400-600
           else if   v-key                =    "NXSC"
                     go to fas-gep-400-610
           else if   v-key                =    "UP  "
                     go to fas-gep-400-620
           else if   v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-gep-400-650
           else if   v-key                =    "EXIT"
                     go to fas-gep-400-660
           else      go to fas-gep-400-570.
       fas-gep-400-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-gep-400-626
           else      go to fas-gep-400-628.
       fas-gep-400-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-gep-400-636
           else      go to fas-gep-400-638.
       fas-gep-400-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-gep-400-725
           else      go to fas-gep-400-750.
       fas-gep-400-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
