      ...
      *                       Ultima revisione:    NdK del 16/09/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma gep310   *
      *                                                                *
      ...
      *            *---------------------------------------------------*
               10  srt-key-rsc-upp        pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Codice cliente                                    *
      *            *---------------------------------------------------*
               10  srt-key-cod-cli        pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      ...
      *            *---------------------------------------------------*
               10  srt-sdo-cge            pic s9(13)       trailing
                                                           separate
                                                           character  .
      *            *---------------------------------------------------*
      *            * Saldo da gestione portafoglio                     *
      *            *---------------------------------------------------*
               10  srt-sdo-gep            pic s9(13)       trailing
                                                           separate
                                                           character  .
      *            *---------------------------------------------------*
      ...
      *            * gestione portafoglio                              *
      *            *---------------------------------------------------*
               10  srt-sdo-dif            pic s9(13)       trailing
                                                           separate
                                                           character  .
      ...
      *        *-------------------------------------------------------*
      *        * Anno di esercizio relativo alla data attuale          *
      *        *-------------------------------------------------------*
           05  w-ese-cge-esa              pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Mese di esercizio relativo alla data attuale          *
      *        *-------------------------------------------------------*
           05  w-ese-cge-esm              pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Anno di esercizio precedente rispetto a quello della  *
      *        * data attuale                                          *
      *        *-------------------------------------------------------*
           05  w-ese-cge-epa              pic  9(03)                  .

      *    *===========================================================*
      *    * Work-area per determinazione saldo contabile              *
      *    *-----------------------------------------------------------*
       01  w-dsc.
      *        *-------------------------------------------------------*
      *        * Anno di esercizio per lettura scheda                  *
      *        *-------------------------------------------------------*
           05  w-dsc-ann-let              pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Indice di comodo 01..12                               *
      *        *-------------------------------------------------------*
           05  w-dsc-inx-112              pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Saldo iniziale                                        *
      *        *-------------------------------------------------------*
           05  w-dsc-sdo-ini              pic s9(13)                  .
      *        *-------------------------------------------------------*
      *        * Saldo finale                                          *
      *        *-------------------------------------------------------*
           05  w-dsc-sdo-fin              pic s9(13)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per determinazione se la scadenza aveva o no,    *
      *        * al momento dell'emissione, aggiornato la contabi-     *
      *        * lita'                                                 *
      *        *-------------------------------------------------------*
           05  w-det-agg-cge.
      *            *---------------------------------------------------*
      *            * Status determinato                                *
      *            *  - S : Si', aveva aggiornato                      *
      *            *  - N : No, non aveva aggiornato                   *
      *            *---------------------------------------------------*
               10  w-det-agg-cge-snx      pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-cli                 .
      *              *-------------------------------------------------*
      *              * Se start errata : a fine della input procedure  *
      *              * del sort                                        *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-cli                 .
      *              *-------------------------------------------------*
      *              * Se at end : a fine della input procedure del    *
      *              * sort                                            *
      *              *-------------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-800.
       stp-srt-inp-300.
      *              *-------------------------------------------------*
      *              * Inizializzazione del record di sort             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Globale preliminare                         *
      *                  *---------------------------------------------*
      ...
      *                  * Chiave                                      *
      *                  *---------------------------------------------*
           move      spaces               to   srt-key-rsc-upp        .
           move      zero                 to   srt-key-cod-cli        .
      *                  *---------------------------------------------*
      *                  * Dati                                        *
      *                  *---------------------------------------------*
           move      zero                 to   srt-cod-cli            .
           move      spaces               to   srt-rag-soc            .
           move      zero                 to   srt-sdo-cge            .
           move      zero                 to   srt-sdo-gep            .
           move      zero                 to   srt-sdo-dif            .
       stp-srt-inp-350.
      *              *-------------------------------------------------*
      *              * Preparazione dati del record di sort da anagra- *
      *              * fica contabile del cliente                      *
      *              *-------------------------------------------------*
           move      rf-cli-rag-key       to   srt-key-rsc-upp        .
           move      rf-cli-cod-cli       to   srt-key-cod-cli        .
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-450.
      *              *-------------------------------------------------*
      *              * Preparazione saldo da gestione portafoglio per  *
      *              * lettura di tutte le scadenze relative al clien- *
      *              * te contabile in esame                           *
      *              *-------------------------------------------------*
           perform   det-sdo-gep-000      thru det-sdo-gep-999        .
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      *              * Preparazione differenza tra i due saldi         *
      *              *-------------------------------------------------*
           move      srt-sdo-cge          to   srt-sdo-dif            .
           subtract  srt-sdo-gep          from srt-sdo-dif            .
       stp-srt-inp-550.
      *              *-------------------------------------------------*
      *              * Se la differenza tra i due saldi e' a zero non  *
      *              * si rilascia il record al sort                   *
      *              *-------------------------------------------------*
           if        srt-sdo-dif          =    zero
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   w-ese-cge-dtr          .
      *              *-------------------------------------------------*
      *              * Determinazione mese e anno di esercizio relati- *
      *              * vo alla data attuale                            *
      *              *-------------------------------------------------*
           perform   det-ese-cge-000      thru det-ese-cge-999        .
      *              *-------------------------------------------------*
      *              * Determinazione anno di esercizio precedente ri- *
      *              * spetto a quello della data attuale              *
      *              *-------------------------------------------------*
           move      zero                 to   s-dat                  .
      ...
      *                  *---------------------------------------------*
           if        rn-dat-bil-ese-bil   =    zero
                     move  w-ese-cge-epa  to   w-dsc-ann-let
                     go to det-sdo-cge-010
           else if   w-ese-cge-esa        not  > rn-dat-bil-ese-bil
                     go to det-sdo-cge-100
           else if   rn-dat-bil-flg-bil   not  = spaces
                     move  rn-dat-bil-ese-bil
                                          to   w-dsc-ann-let
                     go to det-sdo-cge-010
           else if   w-ese-cge-epa        =    rn-dat-bil-ese-bil
                     go to det-sdo-cge-100
           else      move  w-ese-cge-epa  to   w-dsc-ann-let
                     go to det-sdo-cge-010.
       det-sdo-cge-010.
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-dsc-ann-let        to   rf-mgs-ann-ese         .
      ...
      *                          * zio di bilancio                     *
      *                          *-------------------------------------*
           move      rf-mgs-sdo-ini       to   w-dsc-sdo-ini          .
           move      zero                 to   w-dsc-inx-112          .
       det-sdo-cge-020.
           add       1                    to   w-dsc-inx-112          .
           if        w-dsc-inx-112        >    12
                     go to  det-sdo-cge-040.
           add       rf-mgs-dar-mes
                    (w-dsc-inx-112)       to   w-dsc-sdo-ini          .
           subtract  rf-mgs-ave-mes
                    (w-dsc-inx-112)       from w-dsc-sdo-ini          .
           go to     det-sdo-cge-020.
       det-sdo-cge-040.
           add       rf-mgs-dar-bil       to   w-dsc-sdo-ini          .
           subtract  rf-mgs-ave-bil       from w-dsc-sdo-ini          .
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-ese-cge-esa        to   rf-mgs-ann-ese         .
           move      "C"                  to   rf-mgs-tip-rec         .
           move      rf-cli-cod-cli       to   rf-mgs-cod-con         .
      *                          *-------------------------------------*
      *                          * Lettura file [mgs]                  *
      ...
      *                      *-----------------------------------------*
       ...
       det-sdo-cge-200.
      *              *-------------------------------------------------*
      *              * Determinazione saldo finale                     *
      *              *-------------------------------------------------*
           move      w-dsc-sdo-ini        to   w-dsc-sdo-fin          .
           move      zero                 to   w-dsc-inx-112          .
       det-sdo-cge-220.
           add       1                    to   w-dsc-inx-112          .
           if        w-dsc-inx-112        >    12
                     go to  det-sdo-cge-300.
           add       rf-mgs-dar-mes
                    (w-dsc-inx-112)       to   w-dsc-sdo-fin          .
           subtract  rf-mgs-ave-mes
                    (w-dsc-inx-112)       from w-dsc-sdo-fin          .
           go to     det-sdo-cge-220.
       det-sdo-cge-300.
      *              *-------------------------------------------------*
      *              * Saldo finale in campo di destinazione           *
      *              *-------------------------------------------------*
           move      w-dsc-sdo-fin        to   srt-sdo-cge            .
       det-sdo-cge-999.
           exit.

      *    *===========================================================*
      *    * Preparazione saldo da gestione portafoglio                *
      *    *-----------------------------------------------------------*
       det-sdo-gep-000.
      *              *-------------------------------------------------*
      *              * Start su file [sdb] per cliente                 *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
      ...
      *                  *---------------------------------------------*
       ...
       det-sdo-gep-100.
      *              *-------------------------------------------------*
      *              * Read next da file [sdb] per cliente             *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/gep/fls/ioc/obj/iofsdb"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
       ...
       det-sdo-gep-200.
      *              *-------------------------------------------------*
      *              * Test max su file [sdb] per cliente              *
      *              *-------------------------------------------------*
       ...
       det-sdo-gep-250.
      *              *-------------------------------------------------*
      *              * Determinazione se la scadenza aveva o no, al    *
      *              * momento dell'emissione, aggiornato la contabi-  *
      *              * lita'                                           *
      *              *-------------------------------------------------*
           if        rf-sdb-drc-emi       not  = zero
                     move  "S"            to   w-det-agg-cge-snx
                     go to det-sdo-gep-300.
           if        rf-sdb-dtr-emi       >    w-prs-gep-952-dmx
                     move  "N"            to   w-det-agg-cge-snx
                     go to det-sdo-gep-300.
           if       (rf-sdb-tip-sdb       =    02 or
                    ...
                    (w-prs-gep-952-tac    =    01  )
                     move  "S"            to   w-det-agg-cge-snx
                     go to det-sdo-gep-300.
           move      "N"                  to   w-det-agg-cge-snx      .
       det-sdo-gep-300.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda dell'ultima operazione e-  *
      *              * seguita sulla scadenza                          *
      *              *-------------------------------------------------*
           if        rf-sdb-dtr-isp       not  = zero
                     go to det-sdo-gep-600
           else if   rf-sdb-dtr-pbe       not  = zero
                     go to det-sdo-gep-500
           else if   rf-sdb-dtr-nbe       not  = zero
                     go to det-sdo-gep-500
           else if   rf-sdb-dtr-acs       not  = zero
                     go to det-sdo-gep-500
           else if   rf-sdb-dtr-rsp       not  = zero
                     go to det-sdo-gep-500
           else if   rf-sdb-dtr-ris       not  = zero
                     go to det-sdo-gep-500
           else if   rf-sdb-dtr-sto       not  = zero
                     go to det-sdo-gep-500
           else      go to det-sdo-gep-400.
       det-sdo-gep-400.
      *              *-------------------------------------------------*
      *              * Se ultima operazione eseguita sulla scadenza:   *
      *              *  - Emissione                                    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Si incrementa il saldo contabile dedotto    *
      *                  * dalla gestione portafoglio, ma solo se la   *
      *                  * scadenza al momento dell'emissione non a-   *
      *                  * veva aggiornato la contabilita'             *
      *                  *---------------------------------------------*
           if        w-det-agg-cge-snx    =    "S"
                     go to det-sdo-gep-700.
      *                  *---------------------------------------------*
      *                  * Test se inversione del segno necessaria     *
      *                  *---------------------------------------------*
           if        rf-sdb-imp-sdb       <    zero
                     ...
                     go to det-sdo-gep-700.
      *                  *---------------------------------------------*
      *                  * Inversione del segno se nota di accredito   *
      *                  *---------------------------------------------*
           if        rf-sdb-tip-ddr       =    11 or
                     rf-sdb-tip-ddr       =    21
                     subtract rf-sdb-imp-sdb
                                          from srt-sdo-gep
           else      add      rf-sdb-imp-sdb
                                          to   srt-sdo-gep            .
           go to     det-sdo-gep-700.
       det-sdo-gep-500.
      *              *-------------------------------------------------*
      ...
      *              *  - Storno                                       *
      *              *  - Riscossione                                  *
      *              *  - Richiamo scadenza presentata                 *
      *              *  - Accredito scadenza al dopo incasso           *
      *              *  - Notizia di buon esito                        *
      *              *  - Presunto buon esito                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Nessun incremento del saldo contabile de-   *
      *                  * dotto dalla gestione portafoglio            *
      *                  *---------------------------------------------*
           go to     det-sdo-gep-700.
       det-sdo-gep-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se sull'insoluto e' stata eseguita una suc- *
      *                  * cessiva operazione : non si accumula        *
      *                  *---------------------------------------------*
           if        rf-sdb-dtr-pbe       not  = zero or
                     ...
                     go to det-sdo-gep-700.
      *                  *---------------------------------------------*
      *                  * Se l'insoluto non ha riaperto il cliente :  *
      *                  * non si accumula                             *
      *                  *---------------------------------------------*
           if        rf-sdb-drc-isp       =    zero
                     go to det-sdo-gep-700.
      *                  *---------------------------------------------*
      *                  * Se a fronte dell'insoluto c'e' stata una    *
      *                  * riemissione : non si accumula               *
      *                  *---------------------------------------------*
           if        rf-sdb-ens-isp       =    01
                     go to det-sdo-gep-700.
      *                  *---------------------------------------------*
      *                  * Altrimenti si accumula per la determinazio- *
      *                  * ne del saldo del cliente                    *
      *                  *---------------------------------------------*
           add       rf-sdb-imp-sdb       to   srt-sdo-gep            .
       det-sdo-gep-700.
      *              *-------------------------------------------------*
      *              * Riciclo per Read Next scadenza successiva       *
      *              *-------------------------------------------------*
           go to     det-sdo-gep-100.
       det-sdo-gep-900.
      *                  *---------------------------------------------*
      *                  * Fine determinazione                         *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun cliente con differenza saldi !"
                                          to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      "CONTROLLO INCROCIATO TRA CONTABILITA' E GESTIONE P
      -              "ORTAFOGLIO"         to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "      Codice e ragione sociale del cliente        
      -              "    contabile     portafoglio      Differenza "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
