      ...
      *                                   Fase:    gep590              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 07/07/03    *
      *                       Ultima revisione:    NdK del 29/08/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pgep5901:        *
      *                                                                *
      *                    Lista scadenze riscosse                     *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "L'ordinamento per Ragione sociale cliente, prevede
      -              " la totalizzazione dei giorni"
                                          to   v-nt1                  .
           move      "di ritardo medio."  to   v-nt2                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
