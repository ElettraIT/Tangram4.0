      ...
      *                                                                *
      *                    Riscontro Tipo Avviso a Debitori per Incas- *
      *                    si Elettronici                              *
      *                                                                *
      *================================================================*
      ...
      *              *                                                 *
      *              * N.B. : Questa e' una modifica rispetto al nor-  *
      *              *        male funzionamento che sia ha per questi *
      *              *        tipi di programma.                       *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      01                   to   w-fnd-arc-ddp-tip      .
           move      06                   to   w-fnd-arc-ddp-sld      .
      ...
      *    *===========================================================*
      *    * Prompt per : Selezione su circuiti interbancari           *
      *    *-----------------------------------------------------------*
       pmt-cir-itb-000.
      *              *-------------------------------------------------*
      *              * Test se prompt da visualizzare                  *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Circuiti interbancari             *
      *    *-----------------------------------------------------------*
       vis-cir-itb-000.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo di distinta     *
      ...
      *                  *---------------------------------------------*
       ...
       vis-cir-itb-120.
           ...
           if        w-vis-cir-itb-inx    >    5
                     go to vis-cir-itb-130.
           move      w-tes-cod-cib
                    (1, w-vis-cir-itb-inx)
                                          to   w-vis-cir-itb-edx
                                              (w-vis-cir-itb-inx)     .
           go to     vis-cir-itb-120.
       vis-cir-itb-130.
      *                  *---------------------------------------------*
      *                  * Visualizzazione                             *
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-tav-ott      .
       vis-lin-cor-550.
      *                          *-------------------------------------*
      *                          * Codice debitore, ragione sociale    *
      *                          *-------------------------------------*
      ...
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Manca il numero distinta da trattare              
      ...
      *                      *-----------------------------------------*
      *                      * Valori attuali su precedenti            *
      *                      *-----------------------------------------*
           move      w-tes-val-aep (1)    to   w-tes-val-aep (2)      .
       rou-let-reg-125.
      *                      *-----------------------------------------*
      *                      * Controllo che il tipo di distinta am-   *
      *                      * metta il riscontro del tipo di avviso   *
      *                      * per incassi elettronici. In caso di a-  *
      *                      * nomalia :                               *
      *                      * - Messaggio di errore                   *
      *                      * - Forzatura di solo Visualizzazione     *
      *                      * - Esclusione dei controlli successivi e *
      *                      *   aggancio al caricamento righe corpo   *
      *                      *-----------------------------------------*
           if        w-tes-tip-ddp (1)    =    01
                     go to rou-let-reg-130
           else if   w-tes-tip-ddp (1)    =    02
                     go to rou-let-reg-145
           else if   w-tes-tip-ddp (1)    =    03
                     go to rou-let-reg-150
           else if   w-tes-tip-ddp (1)    =    04
                     go to rou-let-reg-155
           else      go to rou-let-reg-160.
       rou-let-reg-130.
           if        w-tes-tav-ric (1)    =    01
                     ...
                     go to rou-let-reg-135
           else      go to rou-let-reg-140.
       rou-let-reg-135.
           move      "Attenzione : Riscontro tipo avviso ottenuto non am
      -              "messo per      "    to   w-err-box-err-msg      .
           move      "             la presentazione di R.I.D.
      -              "               "    to   w-err-box-err-m02      .
           perform   box-msg-e02-000      thru box-msg-e02-999        .
           go to     rou-let-reg-170.
       rou-let-reg-140.
           move      "Attenzione : Riscontro tipo avviso ottenuto non am
      -              "messo per      "    to   w-err-box-err-msg      .
           move      "             la presentazione con questo avviso ri
      -              "chiesto        "    to   w-err-box-err-m02      .
           perform   box-msg-e02-000      thru box-msg-e02-999        .
           go to     rou-let-reg-170.
       rou-let-reg-145.
           move      "Attenzione : Riscontro tipo avviso ottenuto non am
      -              "messo per      "    to   w-err-box-err-msg      .
           move      "             le distinte di effetti.              
      -              "               "    to   w-err-box-err-m02      .
           perform   box-msg-e02-000      thru box-msg-e02-999        .
           go to     rou-let-reg-170.
       rou-let-reg-150.
           move      "Attenzione : Riscontro tipo avviso ottenuto non am
      -              "messo per      "    to   w-err-box-err-msg      .
           move      "             le distinte di paghero' cambiari.    
      -              "               "    to   w-err-box-err-m02      .
           perform   box-msg-e02-000      thru box-msg-e02-999        .
           go to     rou-let-reg-170.
       rou-let-reg-155.
      ...
      -              "               "    to   w-err-box-err-m02      .
       ...
       rou-let-reg-160.
           move      "Attenzione : Riscontro tipo avviso ottenuto non am
      -              "messo per      "    to   w-err-box-err-msg      .
           move      "             il tipo di distinta richiamato.      
      -              "               "    to   w-err-box-err-m02      .
           perform   box-msg-e02-000      thru box-msg-e02-999        .
           go to     rou-let-reg-170.
       rou-let-reg-170.
       ...
       rou-let-reg-200.
      *                      *-----------------------------------------*
      *                      * Controllo su operazione di presentazio- *
      *                      * ne distinta                             *
      *                      *-----------------------------------------*
           if        w-tes-dtr-pre (1)    =    zero
                     go to rou-let-reg-210
           else      go to rou-let-reg-250.
       rou-let-reg-210.
           move      "Attenzione : La distinta non e' ancora stata prese
      -              "ntata, pertan- "    to   w-err-box-err-msg      .
           move      "             to non e' possibile riscontrare i tip
      -              "i avviso.      "    to   w-err-box-err-m02      .
           perform   box-msg-e02-000      thru box-msg-e02-999        .
           move      "V"                  to   w-cnt-mfu-tip-fun      .
           go to     rou-let-reg-500.
       rou-let-reg-250.
      ...
      *                      *-----------------------------------------*
      ...
      -              "aborazioni     "    to   w-err-box-err-msg      .
       ...
       rou-let-reg-300.
      *                      *-----------------------------------------*
      *                      * Controllo su flags di sottoponibilita'  *
      *                      * a pulizia                               *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
       ...
       rou-let-reg-525.
      *                      *-----------------------------------------*
      *                      * Assestamenti post-caricamento distinta  *
      *                      *-----------------------------------------*
       rou-let-reg-535.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Se il tipo avviso ottenuto e' diverso da zero   *
      *              * zero, e si e' in Inserimento, si pone il tipo   *
      *              * funzionamento a modifica                        *
      *              *-------------------------------------------------*
           if        srt-tav-ott          not  = zero and
                     w-cnt-mfu-tip-fun    =    "I"
      ...
      *              *-------------------------------------------------*
       ...
       pos-cnf-ins-050.
      *              *-------------------------------------------------*
      *              * Scrittura del tipo avviso ottenuto sulle sca-   *
      *              * denze per cui e' stato variato                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-ddp-cir-itb       to   w-tes-cir-itb (1)      .
