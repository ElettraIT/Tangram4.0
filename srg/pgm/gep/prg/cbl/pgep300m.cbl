      ...
      *                                                                *
      *                    Accettazione distinte da parte della Banca  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Si/No operazione di accredito distinta connessa alla  *
      *        * operazione di accettazione distinta                   *
      *        *-------------------------------------------------------*
           05  w-det-snx-acd              pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-mod.
      *        *-------------------------------------------------------*
      *        * Per modifiche su operazioni di accettazione distinta  *
      *        *-------------------------------------------------------*
           05  w-mod-act.
      *            *---------------------------------------------------*
      ...
      *    * foglio per i movimenti di accettazione distinta           *
      *    *-----------------------------------------------------------*
       01  w-cge-gep.
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-cge-gep-act-snx          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Indice di comodo per il tipo operazione di accredito  *
      *        * distinta                                              *
      *        *-------------------------------------------------------*
           05  w-cge-gep-act-inx          pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *    * nerale a fronte del movimento di accettazione distinta    *
      *    *-----------------------------------------------------------*
       01  w-mov-cge.
      *        *-------------------------------------------------------*
      ...
      *                      * mento di accettazione distinta da parte *
      *                      * della banca                             *
      *                      *-----------------------------------------*
           perform   acc-dcb-act-000      thru acc-dcb-act-999        .
           if        v-key                =    "PRSC"
                     move  "-"            to   w-cnt-tus-acc-tes      .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
      ...
      *                      * della banca                             *
      *                      *-----------------------------------------*
           perform   acc-ncb-act-000      thru acc-ncb-act-999        .
           if        v-key                =    "PRSC"
                     move  "-"            to   w-cnt-tus-acc-tes      .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
      ...
      *                      * momento dell'accettazione distinta da   *
      *                      * parte della banca                       *
      *                      *-----------------------------------------*
           perform   acc-spe-act-000      thru acc-spe-act-999        .
           if        v-key                =    "PRSC"
                     move  "-"            to   w-cnt-tus-acc-tes      .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
      ...
      *                      * ca al momento dell'accettazione distin- *
      *                      * ta da parte della banca                 *
      *                      *-----------------------------------------*
           perform   acc-int-act-000      thru acc-int-act-999        .
           if        v-key                =    "PRSC"
                     move  "-"            to   w-cnt-tus-acc-tes      .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
      ...
      *              *-------------------------------------------------*
           perform   vis-tot-act-000      thru vis-tot-act-999        .
       vis-tes-003-999.
           exit.
      ...
      *              * Importo totale accreditato                      *
      *              *-------------------------------------------------*
           perform   pmt-tot-act-000      thru pmt-tot-act-999        .
           perform   vis-tot-act-000      thru vis-tot-act-999        .
       pmt-tes-003-999.
           exit.
      ...
      *    *===========================================================*
      *    * Prompt per : Data contabile bancaria                      *
      *    *-----------------------------------------------------------*
       pmt-dcb-act-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt per : Numero contabile bancaria                    *
      *    *-----------------------------------------------------------*
       pmt-ncb-act-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt per : Importo spese addebitate                     *
      *    *-----------------------------------------------------------*
       pmt-spe-act-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt per : Importo interessi addebitati                 *
      *    *-----------------------------------------------------------*
       pmt-int-act-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt per : Importo totale accreditato                   *
      *    *-----------------------------------------------------------*
       pmt-tot-act-000.
      *              *-------------------------------------------------*
      *              * Test se prompt da visualizzare                  *
      *              *-------------------------------------------------*
       pmt-tot-act-005.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo di presen-  *
      *                  * tazione distinta                            *
      *                  *---------------------------------------------*
           if        w-tes-tip-pre (1)    =    01
                     go to pmt-tot-act-010
           else if   w-tes-tip-pre (1)    =    02
                     go to pmt-tot-act-015
           else if   w-tes-tip-pre (1)    =    03
                     go to pmt-tot-act-020
           else if   w-tes-tip-pre (1)    =    04
                     go to pmt-tot-act-025
           else      go to pmt-tot-act-030.
       pmt-tot-act-010.
      *                  *---------------------------------------------*
      *                  * Se tipo presentazione 01 : SBF a maturazio- *
      *                  * ne di valuta                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * No visualizzazione                      *
      *                      *-----------------------------------------*
           go to     pmt-tot-act-999.
       pmt-tot-act-015.
      *                  *---------------------------------------------*
      *                  * Se tipo presentazione 02 : SBF con accredi- *
      *                  * to immediato                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Si' visualizzazione                     *
      *                      *-----------------------------------------*
           go to     pmt-tot-act-100.
       pmt-tot-act-020.
      *                  *---------------------------------------------*
      *                  * Se tipo presentazione 03 : Al dopo incasso  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * No visualizzazione                      *
      *                      *-----------------------------------------*
       ...
       pmt-tot-act-025.
      *                  *---------------------------------------------*
      *                  * Se tipo presentazione 04 : Allo sconto      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Si' visualizzazione                     *
      *                      *-----------------------------------------*
       ...
       pmt-tot-act-030.
      *                  *---------------------------------------------*
      *                  * Se tipo presentazione non riconosciuto      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * No visualizzazione                      *
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data contabile bancaria              *
      *    *-----------------------------------------------------------*
       acc-dcb-act-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * contabile bancaria                          *
      *                  *---------------------------------------------*
           if        w-tes-dcb-act (1)    not  = zero
                     go to acc-dcb-act-650.
           if        w-tes-ncb-act (1)    =    spaces
                     go to acc-dcb-act-650.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-dcb-act-100.
       acc-dcb-act-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Data contabile bancaria           *
      *    *-----------------------------------------------------------*
       vis-dcb-act-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Numero contabile bancaria            *
      *    *-----------------------------------------------------------*
       acc-ncb-act-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-dcb-act (1)    =    zero
                     go to acc-ncb-act-999.
       acc-ncb-act-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Numero contabile bancaria         *
      *    *-----------------------------------------------------------*
       vis-ncb-act-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Importo spese addebitate             *
      *    *-----------------------------------------------------------*
       acc-spe-act-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
       acc-spe-act-625.
      *                  *---------------------------------------------*
      *                  * Visualizzazione importo accreditato         *
      *                  *---------------------------------------------*
           perform   vis-tot-act-000      thru vis-tot-act-999        .
       acc-spe-act-650.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-spe-act-100.
       acc-spe-act-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Importo spese addebitate          *
      *    *-----------------------------------------------------------*
       vis-spe-act-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Importo interessi addebitati         *
      *    *-----------------------------------------------------------*
       acc-int-act-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-int-act-100.
       acc-int-act-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Importo interessi addebitati      *
      *    *-----------------------------------------------------------*
       vis-int-act-000.
           move      "DS"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Importo totale accreditato        *
      *    *-----------------------------------------------------------*
       vis-tot-act-000.
      *              *-------------------------------------------------*
      *              * Test Visualizzazione da eseguire                *
      *              *-------------------------------------------------*
       vis-tot-act-005.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo di presen-  *
      ...
      *                  *---------------------------------------------*
           if        w-tes-tip-pre (1)    =    01
                     go to vis-tot-act-010
           else if   w-tes-tip-pre (1)    =    02
                     go to vis-tot-act-015
           else if   w-tes-tip-pre (1)    =    03
                     go to vis-tot-act-020
           else if   w-tes-tip-pre (1)    =    04
                     go to vis-tot-act-025
           else      go to vis-tot-act-030.
       vis-tot-act-010.
      *                  *---------------------------------------------*
      *                  * Se tipo presentazione 01 : SBF a maturazio- *
      *                  * ne di valuta                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      21                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-tes-imp-ddp (1)    to   w-det-tot-act          .
           subtract  w-tes-spe-act (1)    from w-det-tot-act          .
           subtract  w-tes-int-act (1)    from w-det-tot-act          .
           move      w-det-tot-act        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-tot-act-999.
           exit.
      ...
      *                  *---------------------------------------------*
       ...
       cnt-tdo-nok-160.
           ...
           subtract  w-tes-spe-act (1)    from w-det-tot-act          .
           subtract  w-tes-int-act (1)    from w-det-tot-act          .
           if        w-det-tot-act        =    zero
                     go to cnt-tdo-nok-170
           else if   w-det-tot-act        <    zero
      ...
      *                      *-----------------------------------------*
      *                      * Determinazione Si/No operazione di ac-  *
      *                      * credito distinta connessa all'operazio- *
      *                      * ne di accettazione distinta             *
      *                      *-----------------------------------------*
           perform   det-snx-acd-000      thru det-snx-acd-999        .
      *                      *-----------------------------------------*
      ...
      *                      * meno dell'operazione di accettazione    *
      ...
      *                      * ne gia' l'operazione di accettazione    *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      ...
      *                              * per il movimento di accettazio- *
      *                              * ne distinta                     *
      *                              *---------------------------------*
           perform   cge-gep-act-snx-000  thru cge-gep-act-snx-999    .
      *                              *---------------------------------*
      *                              * Se no aggiornamento : nessun    *
      *                              * controllo                       *
      *                              *---------------------------------*
           if        w-cge-gep-act-snx    =    "N"
      ...
      *                              * di accettazione distinta        *
      *                              *---------------------------------*
           move      w-tes-dat-reg        to   w-tes-dtr-act (1)      .
       rou-let-reg-275.
      *                          *-------------------------------------*
      ...
      *                      * gia' l'operazione di accettazione di-   *
      *                      * stinta                                  *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      ...
      *                          * della stessa                        *
      *                          *-------------------------------------*
           move      w-tes-dtr-act (1)    to   w-tes-dat-reg          .
           perform   vis-dat-reg-000      thru vis-dat-reg-999        .
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
       rou-let-reg-425.
      *                          *-------------------------------------*
      *                          * Controllo che la distinta sia gia'  *
      *                          * stata presentata; se cosi' non e' : *
      *                          * messaggio d'errore ed uscita        *
      *                          *-------------------------------------*
      ...
      -              "ntata.         "    to   w-err-box-err-msg      .
           move      "             Pertanto l'accettazione non e' per or
      -              "a ammessa.     "    to   w-err-box-err-m02      .
      ...
      *                          * non il movimento di presentazione,  *
      *                          * ed il movimento stesso di accetta-  *
      *                          * zione per il caso della modifica.   *
      *                          * In caso di incompatibilita' si e-   *
      *                          * mette un messaggio di errore e si   *
      ...
      *                              * successivi a quello di accetta- *
      *                              * zione distinta                  *
      *                              *---------------------------------*
      ...
      *                          * accettazione distinta, per il caso  *
      *                          * della modifica. Se il controllo non *
      *                          * e' superato si forza la sola visua- *
      *                          * lizzazione.                         *
      *                          *-------------------------------------*
           if        w-tes-drc-act (1)    =    zero or
                     w-tes-npc-act (1)    =    zero
                     go to rou-let-reg-625.
      *                              *---------------------------------*
      *                              * Richiamo modulo                 *
      *                              *---------------------------------*
           move      "TM"                 to   l-cge-300-tip-ope      .
           move      w-tes-drc-act (1)    to   l-cge-300-dat-reg      .
           move      w-tes-npc-act (1)    to   l-cge-300-num-prt      .
      ...
      *                              *---------------------------------*
      *                              * Deviazione a seconda se l'ag-   *
      *                              * giornamento prevede anche l'o-  *
      *                              * perazione di accredito distin-  *
      *                              * ta oppure no                    *
      *                              *---------------------------------*
           if        w-det-snx-acd        =    "S"
       ...
       rou-let-reg-630.
      *                              *---------------------------------*
      *                              * Se l'aggiornamento prevede an-  *
      *                              * che l'operazione di accredito   *
      *                              * distinta                        *
      *                              *---------------------------------*
       rou-let-reg-632.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
       ...
       rou-let-reg-650.
      *                              *---------------------------------*
      *                              * Se l'aggiornamento non prevede  *
      *                              * l'operazione di accredito di-   *
      *                              * stinta                          *
      *                              *---------------------------------*
       rou-let-reg-652.
      *                                  *-----------------------------*
      ...
      *                              *---------------------------------*
           if        w-tes-dtr-pre (1)    not  > w-tes-dat-reg
                     go to rou-let-reg-690.
           move      "Data di registrazione inferiore a quella della pre
      -              "sentazione !   "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
           move      "#"                  to   w-cnt-rou-let-reg      .
           go to     rou-let-reg-999.
       rou-let-reg-690.
      ...
      *    *===========================================================*
      *    * Determinazione Si/No operazione di accredito distinta     *
      *    * connessa all'operazione di accettazione distinta          *
      *    *-----------------------------------------------------------*
       det-snx-acd-000.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo di presentazione  *
      *              *-------------------------------------------------*
           if        w-tes-tip-pre (1)    =    01
                     go to det-snx-acd-100
           else if   w-tes-tip-pre (1)    =    02
                     go to det-snx-acd-200
           else if   w-tes-tip-pre (1)    =    03
                     go to det-snx-acd-300
           else if   w-tes-tip-pre (1)    =    04
                     go to det-snx-acd-400
           else      go to det-snx-acd-500.
       det-snx-acd-100.
      *                  *---------------------------------------------*
      *                  * Se tipo presentazione 01 : Accredito SBF a  *
      *                  * maturazione di valuta                       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * No operazione di accredito distinta     *
      *                      *-----------------------------------------*
           move      "N"                  to   w-det-snx-acd          .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     det-snx-acd-999.
       det-snx-acd-200.
      *                  *---------------------------------------------*
      *                  * Se tipo presentazione 02 : Accredito SBF    *
      *                  * con accredito immediato                     *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Si' operazione di accredito distinta    *
      *                      *-----------------------------------------*
           move      "S"                  to   w-det-snx-acd          .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     det-snx-acd-999.
       det-snx-acd-300.
      *                  *---------------------------------------------*
      *                  * Se tipo presentazione 03 : Accredito al do- *
      *                  * po incasso                                  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * No operazione di accredito distinta     *
      ...
      *    * l'operazione di accettazione della distinta               *
      *    *-----------------------------------------------------------*
       det-cau-cge-000.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda se l'operazione di accet-  *
      *              * tazione distinta comporta anche quella di ac-   *
      *              * credito distinta                                *
      *              *-------------------------------------------------*
           if        w-det-snx-acd        =    "S"
                     go to det-cau-cge-200
           else      go to det-cau-cge-600.
       det-cau-cge-200.
      *              *-------------------------------------------------*
      *              * Se l'operazione di accettazione distinta com-   *
      *              * porta anche quella di accredito distinta        *
      *              *-------------------------------------------------*
       det-cau-cge-225.
      *                  *---------------------------------------------*
      *                  * Si pone come causale di aggiornamento con-  *
      *                  * tabile quella associata all'operazione di   *
      *                  * accredito distinta                          *
      *                  *---------------------------------------------*
       det-cau-cge-250.
      *                      *-----------------------------------------*
      *                      * Determinazione indice su tabella tipi   *
      *                      * operazione relativo al tipo operazione  *
      *                      * di accredito distinta. Se elemento non  *
      *                      * trovato si pone come causale di aggior- *
      *                      * namento contabile quella associata al-  *
      *                      * l'operazione di accettazione distinta.  *
      *                      *-----------------------------------------*
           move      zero                 to   w-cge-gep-act-inx      .
       det-cau-cge-255.
           add       1                    to   w-cge-gep-act-inx      .
           if        w-cge-gep-act-inx    >    w-top-ele-num
                     go to det-cau-cge-600.
           if        w-top-cod-top
                    (w-cge-gep-act-inx)   not  = 0560
                     go to det-cau-cge-255.
       det-cau-cge-275.
      *                      *-----------------------------------------*
      *                      * Memorizzazione codice causale associato *
      *                      * all'operazione di accredito distinta    *
      *                      *-----------------------------------------*
           move      w-top-cau-cge
                    (w-cge-gep-act-inx)   to   w-det-cau-cge          .
       det-cau-cge-300.
      *                  *---------------------------------------------*
      *                  * Se questa e' diversa da zero si esce, al-   *
      *                  * trimenti si pone come causale di aggiorna-  *
      *                  * mento contabile quella associata all'ope-   *
      *                  * razione di accettazione distinta            *
      *                  *---------------------------------------------*
           if        w-det-cau-cge        not  = zero
                     go to det-cau-cge-999
           else      go to det-cau-cge-600.
       det-cau-cge-600.
      *              *-------------------------------------------------*
      *              * Se l'operazione di accettazione distinta non    *
      *              * comporta quella di accredito distinta           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Si pone come causale di aggiornamento con-  *
      *                  * tabile quella associata all'operazione di   *
      ...
      *                                  *-----------------------------*
      ...
      -              "iamata.        "    to   w-err-box-err-m02      .
           perform   box-msg-e02-000      thru box-msg-e02-999        .
      *                                  *-----------------------------*
      *                                  * Se in Inserimento, flag di  *
      *                                  * errore ed uscita, altrimen- *
      *                                  * ti sola Visualizzazione     *
      *                                  *-----------------------------*
           if        w-cnt-mfu-tip-fun    =    "I"
                     move  "#"            to   w-cnt-rou-let-reg
                     go to srt-out-prc-999
      ...
      *                              * e' superato                     *
      *                              *---------------------------------*
           if        srt-flg-blo          =    spaces
                     go to srt-out-prc-685.
      *                              *---------------------------------*
      *                              * Altrimenti                      *
      *                              *---------------------------------*
      *                                  *-----------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-ddp-dtr-com       not  = w-tes-dtr-com (1) or
                     ...
                     rf-ddp-dtr-act       not  = zero              or
                     rf-ddp-drc-act       not  = zero              or
                     rf-ddp-npc-act       not  = zero              or
      ...
      *                  * di accettazione distinta                    *
      *                  *---------------------------------------------*
           perform   cge-gep-act-000      thru cge-gep-act-999        .
       pos-cnf-ins-350.
      *                  *---------------------------------------------*
      *                  * Completamento del record distinte con i da- *
      *                  * ti relativi alla accettazione distinta      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Data registrazione movimento di accet-  *
      *                      * tazione distinta                        *
      *                      *-----------------------------------------*
           move      w-tes-dat-reg        to   rf-ddp-dtr-act         .
      *                      *-----------------------------------------*
      *                      * Data registrazione movimento di conta-  *
      *                      * bilita' a fronte del movimento di ac-   *
      *                      * cettazione distinta                     *
      *                      *-----------------------------------------*
           move      l-cge-300-dat-reg    to   rf-ddp-drc-act         .
      *                      *-----------------------------------------*
      *                      * Numero protocollo movimento di conta-   *
      *                      * bilita' a fronte del movimento di ac-   *
      *                      * cettazione distinta                     *
      *                      *-----------------------------------------*
           move      l-cge-300-num-prt    to   rf-ddp-npc-act         .
      *                      *-----------------------------------------*
      *                      * Data contabile bancaria per il movi-    *
      *                      * mento di accettazione distinta          *
      *                      *-----------------------------------------*
           move      w-tes-dcb-act (1)    to   rf-ddp-dcb-act         .
      *                      *-----------------------------------------*
      *                      * Numero contabile bancaria per il movi-  *
      *                      * mento di accettazione distinta          *
      *                      *-----------------------------------------*
           move      w-tes-ncb-act (1)    to   rf-ddp-ncb-act         .
      *                      *-----------------------------------------*
      *                      * Importo spese addebitate dalla banca    *
      *                      * al momento della accettazione distinta  *
      *                      *-----------------------------------------*
           move      w-tes-spe-act (1)    to   rf-ddp-spe-act         .
      *                      *-----------------------------------------*
      *                      * Importo interessi addebitati dalla ban- *
      *                      * ca al momento della accettazione della  *
      *                      * distinta                                *
      *                      *-----------------------------------------*
           move      w-tes-int-act (1)    to   rf-ddp-int-act         .
       pos-cnf-ins-400.
      *                  *---------------------------------------------*
      *                  * Update record [ddp]                         *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      12                   to   v-lin                  .
           move      16                   to   v-pos                  .
           move      "L'operazione di accettazione non viene pertanto es
      -              "eguita.      "      to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              * nell'operazione di accettazione distinta e dei  *
      *              * relativi flags indicatori                       *
      *              *-------------------------------------------------*
           perform   det-mod-act-000      thru det-mod-act-999        .
      *              *-------------------------------------------------*
      *              * Se il tipo di modifica non comporta alcuna va-  *
      *              * riazione : alla sola riscrittura dei tipi avvi- *
      *              * so ottenuti                                     *
      *              *-------------------------------------------------*
           if        w-mod-act-rec-ddp    =    spaces and
                     w-mod-act-cge-gep    =    spaces
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-ddp-drc-act       not  = w-tes-drc-act (2) or
                     rf-ddp-npc-act       not  = w-tes-npc-act (2) or
                     rf-ddp-dcb-act       not  = w-tes-dcb-act (2) or
                     rf-ddp-ncb-act       not  = w-tes-ncb-act (2) or
                     rf-ddp-spe-act       not  = w-tes-spe-act (2) or
                     rf-ddp-int-act       not  = w-tes-int-act (2)
                     go to pos-cnf-mod-275.
      ...
      *                      *-----------------------------------------*
           if        w-mod-act-cge-gep    =    spaces
                     go to pos-cnf-mod-350.
      *                      *-----------------------------------------*
      *                      * Altrimenti : esecuzione                 *
      *                      *-----------------------------------------*
           move      w-tes-drc-act (2)    to    w-cge-gep-drc-del     .
           move      w-tes-npc-act (2)    to    w-cge-gep-npc-del     .
      ...
      *              * Flags a Spaces                                  *
      *              *-------------------------------------------------*
           move      spaces               to   w-mod-act-rec-ddp      .
           move      spaces               to   w-mod-act-cge-gep      .
       det-mod-act-100.
      *              *-------------------------------------------------*
      ...
      *                  * accettazione distinta                       *
      *                  *---------------------------------------------*
           if        w-tes-dcb-act (1)    not  = w-tes-dcb-act (2)
                     move  "#"            to   w-mod-act-rec-ddp
                     move  "#"            to   w-mod-act-cge-gep      .
      *                  *---------------------------------------------*
      *                  * Numero contabile bancaria per il movimento  *
      *                  * di accettazione distinta                    *
      *                  *---------------------------------------------*
           if        w-tes-ncb-act (1)    not  = w-tes-ncb-act (2)
                     move  "#"            to   w-mod-act-rec-ddp
                     move  "#"            to   w-mod-act-cge-gep      .
      *                  *---------------------------------------------*
      *                  * Importo spese addebitate dalla banca al mo- *
      *                  * mento della accettazione distinta           *
      *                  *---------------------------------------------*
           if        w-tes-spe-act (1)    not  = w-tes-spe-act (2)
                     move  "#"            to   w-mod-act-rec-ddp
                     move  "#"            to   w-mod-act-cge-gep      .
      *                  *---------------------------------------------*
      *                  * Importo interessi addebitati dalla banca al *
      *                  * momento della accettazione distinta         *
      *                  *---------------------------------------------*
           if        w-tes-int-act (1)    not  = w-tes-int-act (2)
                     move  "#"            to   w-mod-act-rec-ddp
                     move  "#"            to   w-mod-act-cge-gep      .
       det-mod-act-999.
           exit.
      ...
      *                  * dati relativi alla accettazione distinta    *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Data di sistema di ultimo inserimento o *
      *                      * modifica, utente, fase                  *
      ...
      *    * glio per i movimenti di accettazione distinta             *
      *    *-----------------------------------------------------------*
       cge-gep-act-snx-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-prs-gep-snx-cge    =    "N"
                     move  "N"            to   w-cge-gep-act-snx
                     go to cge-gep-act-snx-999.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "S"                  to   w-cge-gep-act-snx      .
       cge-gep-act-snx-999.
           exit.

      *    *===========================================================*
      *    * Aggiornamenti contabili generati dalla gestione  portafo- *
      *    * glio a fronte del movimento di accettazione distinta      *
      *    *                                                           *
      ...
      *              *-------------------------------------------------*
           if       (w-cnt-mfu-tip-fun    =    "M"   ) and
                    (w-tes-drc-act (1)    =    zero or
                     w-tes-npc-act (1)    =    zero  )
                     go to cge-gep-act-100.
       cge-gep-act-025.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-cge-gep-act-snx    not  = "S"
                     go to cge-gep-act-100.
       cge-gep-act-050.
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda se l'aggiornamento     *
      *                  * comporta anche l'operazione di accredito    *
      *                  * distinta oppure no                          *
      *                  *---------------------------------------------*
           if        w-det-snx-acd        =    "S"
                     go to cge-gep-act-060
           else      go to cge-gep-act-070.
       cge-gep-act-060.
      *                  *---------------------------------------------*
      *                  * Se l'aggiornamento comporta anche l'opera-  *
      *                  * zione di accredito distinta                 *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se importo totale della distinta a zero *
      *                      * e importo delle spese bancarie a zero e *
      *                      * importo interessi bancari a zero non si *
      *                      * esegue l'aggiornamento, altrimenti lo   *
      *                      * si esegue                               *
      *                      *-----------------------------------------*
           if        w-tes-imp-ddp (1)    =    zero and
                     w-tes-spe-act (1)    =    zero and
                     w-tes-int-act (1)    =    zero
                     go to cge-gep-act-100
           else      go to cge-gep-act-200.
       cge-gep-act-070.
      *                  *---------------------------------------------*
      *                  * Se l'aggiornamento non comporta l'operazio- *
      *                  * ne di accredito distinta                    *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se importo spese bancarie a zero e im-  *
      *                      * porto interessi bancari a zero non si   *
      *                      * esegue l'aggiornamento, altrimenti lo   *
      *                      * si esegue                               *
      *                      *-----------------------------------------*
           if        w-tes-spe-act (1)    =    zero and
                     w-tes-int-act (1)    =    zero
                     go to cge-gep-act-100
           else      go to cge-gep-act-200.
       cge-gep-act-100.
      ...
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     cge-gep-act-999.
       cge-gep-act-200.
      *              *-------------------------------------------------*
      *              * Preparazione per esecuzione aggiornamento con-  *
      *              * tabile                                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda se l'aggiornamento     *
      ...
      *                  *---------------------------------------------*
           if        w-det-snx-acd        =    "S"
                     go to cge-gep-act-300
           else      go to cge-gep-act-500.
       cge-gep-act-300.
      *                  *---------------------------------------------*
      *                  * Se l'aggiornamento comporta anche l'opera-  *
      *                  * zione di accredito distinta                 *
      ...
      *                      *-----------------------------------------*
       ...
       cge-gep-act-334.
           ...
           move      zero                 to   w-mov-cge-imp-rig
                                              (w-mov-cge-inx-001)     .
       cge-gep-act-336.
           add       w-tes-spe-act (1)    to   w-mov-cge-imp-rig
                                              (w-mov-cge-inx-001)     .
       cge-gep-act-340.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-tes-int-act (1)    =    zero
                     go to cge-gep-act-350.
           move      zero                 to   w-mov-cge-inx-001      .
       cge-gep-act-342.
           add       1                    to   w-mov-cge-inx-001      .
           if        w-mov-cge-inx-001    >    w-mov-cge-ctr-rig
                     go to cge-gep-act-344.
           if        w-mov-cge-cod-stc
                    (w-mov-cge-inx-001)   =    w-tes-cod-cbp-inb (1)
                     go to cge-gep-act-346
           else      go to cge-gep-act-342.
       cge-gep-act-344.
           move      w-mov-cge-inx-001    to   w-mov-cge-ctr-rig      .
           ...
           move      zero                 to   w-mov-cge-imp-rig
                                              (w-mov-cge-inx-001)     .
       cge-gep-act-346.
           add       w-tes-int-act (1)    to   w-mov-cge-imp-rig
                                              (w-mov-cge-inx-001)     .
       cge-gep-act-350.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-tes-spe-act (1)    to   w-mov-cge-wim-rig      .
           add       w-tes-int-act (1)    to   w-mov-cge-wim-rig      .
           if        w-mov-cge-wim-rig    =    zero
                     go to cge-gep-act-360.
           move      zero                 to   w-mov-cge-inx-001      .
       cge-gep-act-352.
           add       1                    to   w-mov-cge-inx-001      .
           if        w-mov-cge-inx-001    >    w-mov-cge-ctr-rig
                     go to cge-gep-act-354.
           if        w-mov-cge-cod-stc
                    (w-mov-cge-inx-001)   =    w-tes-cod-cbp-cco (1)
                     go to cge-gep-act-356
           else      go to cge-gep-act-352.
       cge-gep-act-354.
           move      w-mov-cge-inx-001    to   w-mov-cge-ctr-rig      .
      ...
      *                      *-----------------------------------------*
           if        w-tes-imp-ddp (1)    =    zero
                     go to cge-gep-act-370.
           move      zero                 to   w-mov-cge-inx-001      .
       cge-gep-act-362.
           add       1                    to   w-mov-cge-inx-001      .
           if        w-mov-cge-inx-001    >    w-mov-cge-ctr-rig
                     go to cge-gep-act-364.
           if        w-mov-cge-cod-stc
                    (w-mov-cge-inx-001)   =    w-tes-cod-cbp-cco (1)
                     go to cge-gep-act-366
           else      go to cge-gep-act-362.
       cge-gep-act-364.
           move      w-mov-cge-inx-001    to   w-mov-cge-ctr-rig      .
           move      w-tes-cod-cbp-cco (1)
                                          to   w-mov-cge-cod-stc
      ...
      *                      *-----------------------------------------*
           if        w-tes-imp-ddp (1)    =    zero
                     go to cge-gep-act-380.
           move      zero                 to   w-mov-cge-inx-001      .
       cge-gep-act-372.
           add       1                    to   w-mov-cge-inx-001      .
           if        w-mov-cge-inx-001    >    w-mov-cge-ctr-rig
                     go to cge-gep-act-374.
           if        w-mov-cge-cod-stc
                    (w-mov-cge-inx-001)   =    w-tes-cod-cbp-pre (1)
                     go to cge-gep-act-376
           else      go to cge-gep-act-372.
       cge-gep-act-374.
           move      w-mov-cge-inx-001    to   w-mov-cge-ctr-rig      .
      ...
      *                      *-----------------------------------------*
           if        w-tes-spe-act (1)    =    zero
                     go to cge-gep-act-540.
           move      zero                 to   w-mov-cge-inx-001      .
       cge-gep-act-532.
           add       1                    to   w-mov-cge-inx-001      .
           if        w-mov-cge-inx-001    >    w-mov-cge-ctr-rig
                     go to cge-gep-act-534.
           if        w-mov-cge-cod-stc
                    (w-mov-cge-inx-001)   =    w-tes-cod-cbp-onb (1)
                     go to cge-gep-act-536
           else      go to cge-gep-act-532.
       cge-gep-act-534.
           move      w-mov-cge-inx-001    to   w-mov-cge-ctr-rig      .
           move      w-tes-cod-cbp-onb (1)
                                          to   w-mov-cge-cod-stc
      ...
      *                      *-----------------------------------------*
           if        w-tes-int-act (1)    =    zero
                     go to cge-gep-act-550.
           move      zero                 to   w-mov-cge-inx-001      .
       cge-gep-act-542.
           add       1                    to   w-mov-cge-inx-001      .
           if        w-mov-cge-inx-001    >    w-mov-cge-ctr-rig
                     go to cge-gep-act-544.
           if        w-mov-cge-cod-stc
                    (w-mov-cge-inx-001)   =    w-tes-cod-cbp-inb (1)
                     go to cge-gep-act-546
           else      go to cge-gep-act-542.
       cge-gep-act-544.
           move      w-mov-cge-inx-001    to   w-mov-cge-ctr-rig      .
           move      w-tes-cod-cbp-inb (1)
                                          to   w-mov-cge-cod-stc
      ...
      *                      *-----------------------------------------*
           ...
           add       w-tes-int-act (1)    to   w-mov-cge-wim-rig      .
           if        w-mov-cge-wim-rig    =    zero
                     go to cge-gep-act-560.
           move      zero                 to   w-mov-cge-inx-001      .
       cge-gep-act-552.
           add       1                    to   w-mov-cge-inx-001      .
           if        w-mov-cge-inx-001    >    w-mov-cge-ctr-rig
                     go to cge-gep-act-554.
           if        w-mov-cge-cod-stc
                    (w-mov-cge-inx-001)   =    w-tes-cod-cbp-cco (1)
                     go to cge-gep-act-556
           else      go to cge-gep-act-552.
       cge-gep-act-554.
           move      w-mov-cge-inx-001    to   w-mov-cge-ctr-rig      .
           move      w-tes-cod-cbp-cco (1)
                                          to   w-mov-cge-cod-stc
      ...
      *                      *-----------------------------------------*
       ...
       cge-gep-act-700.
      *              *-------------------------------------------------*
      *              * Esecuzione effettiva degli aggiornamenti con-   *
      *              * tabili in base alla tabella caricata            *
      *              *-------------------------------------------------*
       cge-gep-act-705.
      *                  *---------------------------------------------*
      *                  * Se zero elementi nella tabella : a No ag-   *
      *                  * giornamento                                 *
      *                  *---------------------------------------------*
       ...
       cge-gep-act-710.
      *                  *---------------------------------------------*
      *                  * Se gli elementi della tabella hanno tutti   *
      *                  * l'importo a zero : a No aggiornamento       *
      *                  *---------------------------------------------*
           move      zero                 to   w-mov-cge-inx-001      .
       cge-gep-act-712.
           add       1                    to   w-mov-cge-inx-001      .
           ...
           if        w-mov-cge-imp-rig
                    (w-mov-cge-inx-001)   =    zero
                     go to cge-gep-act-712.
       cge-gep-act-725.
      *                  *---------------------------------------------*
      *                  * Ricerca della prima riga in Dare, se non    *
      *                  * trovata : a No aggiornamento                *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           else if   w-tes-drc-act (2)    not  = zero
                     move  w-tes-drc-act (2)
      ...
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      w-tes-dcb-act (1)    to   l-cge-300-dat-doc      .
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      w-tes-ncb-act (1)    to   l-cge-300-num-doc      .
      *                      *-----------------------------------------*
      *                      * Codice sottoconto                       *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Ricerca della prossima riga in Dare; se *
      *                      * non trovata : a righe in Avere          *
      *                      *-----------------------------------------*
           add       1                    to   w-mov-cge-inx-rig      .
           if        w-mov-cge-inx-rig    >    w-mov-cge-ctr-rig
                     go to cge-gep-act-775.
           if        w-mov-cge-imp-rig
                    (w-mov-cge-inx-rig)   not  > zero
                     go to cge-gep-act-750.
      *                      *-----------------------------------------*
      *                      * Normalizzazione work-area riga movimen- *
      *                      * to per aggiornamenti contabili          *
      *                      *-----------------------------------------*
           move      "N+"                 to   l-cge-300-tip-ope      .
           perform   mdl-agg-cge-cll-000  thru mdl-agg-cge-cll-999    .
      *                      *-----------------------------------------*
      *                      * Preparazione link-area per riga movi-   *
      *                      * mento successiva alla prima             *
      *                      *                                         *
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Re-inizializzazione indice per scansio- *
      *                      * ne sulle righe                          *
      *                      *-----------------------------------------*
           move      zero                 to   w-mov-cge-inx-rig      .
       cge-gep-act-780.
      *                      *-----------------------------------------*
      *                      * Ricerca della prossima riga in Avere;   *
      *                      * se non trovata : fine aggiornamento     *
      *                      *-----------------------------------------*
           add       1                    to   w-mov-cge-inx-rig      .
           if        w-mov-cge-inx-rig    >    w-mov-cge-ctr-rig
                     go to cge-gep-act-999.
