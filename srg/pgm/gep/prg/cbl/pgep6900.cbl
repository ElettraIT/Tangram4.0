      ...
      *                       Ultima revisione:    NdK del 06/06/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pgep6901:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-ord.
               ...
               10  w-exp-tip-ord-tbl.
                   ...
                   15  filler             pic  x(40) value
                            "per Giorni di ritardo (ord. decrescente)".
      *        *-------------------------------------------------------*
      *        * Work per : Tipi riscossione                           *
      *        *-------------------------------------------------------*
           05  w-exp-mod-rsd.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Tipo ordinamento stampa       *
      *    *-----------------------------------------------------------*
       pmt-tip-ord-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      15                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipo ordinamento scadenze  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tip-ord-999.
      ...
      *                  *---------------------------------------------*
           if        rr-cod-cli           =    zero
                     move  "Tutti"        to   rr-cod-cli-rag
                                          ...
                                          to   rr-cod-cli-rag         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione anagrafica contabile        *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Modalita' riscossione                      *
      *    *-----------------------------------------------------------*
       acc-mod-rsd-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Accettazione : Data registrazione minima                  *
      *    *-----------------------------------------------------------*
       acc-drg-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Accettazione : Data registrazione massima                 *
      *    *-----------------------------------------------------------*
       acc-drg-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
      ...
      -              ""
       ...
       tdo-ric-sel-040.
      *              *-------------------------------------------------*
      *              * Test su data registrazione iniziale e finale    *
      *              *-------------------------------------------------*
           if        rr-drg-min           =    zero
                     go to tdo-ric-sel-800.
           if        rr-drg-min           not  > rr-drg-max
                     go to tdo-ric-sel-800.
           move      "Data riscossione finale inferiore a quella inizial
      ...
      *              * Modalita' di riscossione                        *
      *              *-------------------------------------------------*
______*    if        rr-mod-rsd           =    zero
______*              move  01             to   rr-mod-rsd             .
      *              *-------------------------------------------------*
      *              * Data riscossione iniziale e finale              *
      *              *-------------------------------------------------*
