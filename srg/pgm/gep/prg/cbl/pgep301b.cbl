      ...
      *                                   Fase:    gep301              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 19/04/94    *
      ...
      *        *-------------------------------------------------------*
      *        * Tipi di riscossione da ricercare                      *
      *        * - 00 : Tutti                                          *
      *        * - 01 : Per Contanti                                   *
      *        * - 02 : Con Assegno                                    *
      ...
      *        *-------------------------------------------------------*
      *        * Importo riscossione da ricercare                      *
      *        *-------------------------------------------------------*
           05  rr-imp-rsd                 pic s9(11)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipi riscossione da ricercare              *
      *        *-------------------------------------------------------*
           05  w-exp-mod-rsd.
               10  w-exp-mod-rsd-num      pic  9(02)       value 05   .
               10  w-exp-mod-rsd-lun      pic  9(02)       value 25   .
               10  w-exp-mod-rsd-tbl.
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-200.
      *                  *---------------------------------------------*
      *                  * Modalita' di riscossione da ricercare       *
      *                  *---------------------------------------------*
           perform   acc-mod-rsd-000      thru acc-mod-rsd-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           perform   acc-imp-rsd-000      thru acc-imp-rsd-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
      *              * Prompt modalita' riscossione da ricercare       *
      *              *-------------------------------------------------*
           perform   pmt-mod-rsd-000      thru pmt-mod-rsd-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione modalita' riscossione da ricer- *
      *              * care                                            *
      *              *-------------------------------------------------*
           perform   vis-mod-rsd-000      thru vis-mod-rsd-999        .
      *              *-------------------------------------------------*
      *              * Prompt per codice ns. cassa, banca o c/c posta- *
      *              * le                                              *
      *              *-------------------------------------------------*
           perform   pmt-cod-cbp-000      thru pmt-cod-cbp-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione per codice ns. cassa, banca o   *
      *              * c/c postale                                     *
      *              *-------------------------------------------------*
           perform   vis-cod-cbp-000      thru vis-cod-cbp-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione per codice ns. cassa, banca o   *
      *              * c/c postale, descrizione                        *
      *              *-------------------------------------------------*
       ...
       pmt-cod-cbp-000.
           ...
           if        rr-mod-rsd           =    01 or
                     ...
                     move  "Su codice nostra Cassa     :"
                                          to   v-alf
           else if   rr-mod-rsd           =    03
                     move  "Su codice nostra Banca     :"
                                          to   v-alf
           else if   rr-mod-rsd           =    04
      ...
      *    *===========================================================*
      *    * Accettazione : Modalita' riscossione da ricercare         *
      *    *-----------------------------------------------------------*
       acc-mod-rsd-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      rr-mod-rsd           to   w-sav-mod-rsd          .
       acc-mod-rsd-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-mod-rsd-lun    to   v-car                  .
           move      w-exp-mod-rsd-num    to   v-ldt                  .
           move      "TCABP#"             to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-mod-rsd-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      13                   to   v-lin                  .
      ...
      *
           if        rr-mod-rsd           =    00
                     move  01             to   v-num
           else if   rr-mod-rsd           =    01
                     move  02             to   v-num
           else if   rr-mod-rsd           =    02
                     move  03             to   v-num
           else if   rr-mod-rsd           =    03
                     move  04             to   v-num
           else if   rr-mod-rsd           =    04
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-mod-rsd-999.
       acc-mod-rsd-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  00             to   rr-mod-rsd
           else if   v-num                =    02
                     move  01             to   rr-mod-rsd
           else if   v-num                =    03
                     move  02             to   rr-mod-rsd
           else if   v-num                =    04
                     move  03             to   rr-mod-rsd
           else if   v-num                =    05
                     move  04             to   rr-mod-rsd
           else      move  zero           to   rr-mod-rsd             .
       acc-mod-rsd-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-mod-rsd           =    w-sav-mod-rsd
                     go to acc-mod-rsd-800.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-mod-rsd           =    zero
                     go to acc-mod-rsd-700.
           if       (rr-mod-rsd           =    01  or
                     rr-mod-rsd           =    02  ) and
                    (rr-cod-cbp-trc       =    01  )
                     go to acc-mod-rsd-800.
           if       (rr-mod-rsd           =    03  ) and
                    (rr-cod-cbp-trc       =    02  )
                     go to acc-mod-rsd-800.
           if       (rr-mod-rsd           =    04  ) and
                    (rr-cod-cbp-trc       =    03  )
                     go to acc-mod-rsd-800.
       acc-mod-rsd-700.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-mod-rsd-100.
       acc-mod-rsd-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Modalita' riscossione da ricercare      *
      *    *-----------------------------------------------------------*
       vis-mod-rsd-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Importo riscossione da ricercare           *
      *    *-----------------------------------------------------------*
       acc-imp-rsd-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-imp-rsd-999.
       acc-imp-rsd-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-imp-rsd             .
       acc-imp-rsd-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo su modalita' riscossione da ricercare *
      *              *-------------------------------------------------*
           if        rr-mod-rsd           not  > w-exp-mod-rsd-num
                     go to tdo-ric-sel-300.
           move      "Modalita' riscossione da ricercare errato         
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
           go to     tdo-ric-sel-999.
      ...
      *                  *---------------------------------------------*
           move      spaces               to   rr-dpz-cli-loc         .
      *                  *---------------------------------------------*
      *                  * Modalita' riscossione da ricercare          *
      *                  *---------------------------------------------*
           move      zero                 to   rr-mod-rsd             .
      *                  *---------------------------------------------*
      *                  * Codice ns. cassa, banca o c/c postale       *
      *                  *---------------------------------------------*
           move      spaces               to   rr-cod-cbp             .
      ...
      *                      *-----------------------------------------*
      *                      * Se non esiste una variabile di i.p.c.   *
      *                      * relativa alla modalita' riscossione :   *
      *                      * no preparazione default                 *
      *                      *-----------------------------------------*
           if        w-ipc-mod-rsd-snx    not  = "S"
                     go to nor-ric-sel-460.
      *                      *-----------------------------------------*
      *                      * Se la variabile di i.p.c. ha un valore  *
      *                      * non ammesso : no preparazione default   *
      *                      *-----------------------------------------*
           if        w-ipc-mod-rsd-val    <    01 or
                     w-ipc-mod-rsd-val    >    04
                     go to nor-ric-sel-460.
      *                      *-----------------------------------------*
      *                      * Preparazione default                    *
      *                      *-----------------------------------------*
           move      w-ipc-mod-rsd-val    to   rr-mod-rsd             .
       nor-ric-sel-460.
      *                  *---------------------------------------------*
      *                  * Codice ns. cassa, banca o c/c postale       *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       qry-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Selezione su modalita' riscossione              *
      *              *-------------------------------------------------*
           if        rr-mod-rsd           not  = zero
                     go to qry-sel-rec-210.
           if        rf-rsd-mod-rsd       =    01 or
                     rf-rsd-mod-rsd       =    02 or
                     rf-rsd-mod-rsd       =    03 or
                     rf-rsd-mod-rsd       =    04
                     go to qry-sel-rec-300
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-210.
           if        rr-mod-rsd           =    rf-rsd-mod-rsd
                     go to qry-sel-rec-300
           else      move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-300.
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-rsd-cbp-rsd       not  = rr-cod-cbp
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      22                   to   v-pos                  .
           if        rf-rsd-mod-rsd       =    01 and
                     rf-rsd-tip-rsd       =    01
                     move  "Per Contanti          "
                                          to   v-alf
           else if   rf-rsd-mod-rsd       =    01 and
                     rf-rsd-tip-rsd       =    02
                     move  "Acconto per Contanti  "
                                          to   v-alf
           else if   rf-rsd-mod-rsd       =    02 and
                     rf-rsd-tip-rsd       =    01
                     move  "Con Assegno           "
                                          to   v-alf
           else if   rf-rsd-mod-rsd       =    02 and
                     rf-rsd-tip-rsd       =    02
                     move  "Acconto con Assegno   "
                                          to   v-alf
           else if   rf-rsd-mod-rsd       =    03 and
                     rf-rsd-tip-rsd       =    01
                     move  "Per Bonifico Bancario "
                                          to   v-alf
           else if   rf-rsd-mod-rsd       =    03 and
                     rf-rsd-tip-rsd       =    02
                     move  "Acconto per Bonifico  "
                                          to   v-alf
           else if   rf-rsd-mod-rsd       =    04 and
                     rf-rsd-tip-rsd       =    01
                     move  "Per C/C Postale       "
                                          to   v-alf
           else if   rf-rsd-mod-rsd       =    04 and
                     rf-rsd-tip-rsd       =    02
                     move  "Acconto in C/C Postale"
                                          to   v-alf
           else      move  spaces         to   v-alf                  .
           move      "+"                  to   v-edm                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "   Numero   Data Reg.   Tipo riscossione        Im
      -              "porto     Numero e Data Docum."
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
