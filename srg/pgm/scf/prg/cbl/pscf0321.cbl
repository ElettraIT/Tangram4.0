      ...
      *                                   Fase:    scf032              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 22/09/93    *
      *                       Ultima revisione:    NdK del 30/11/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma scf032 : *
      *                                                                *
      *                    Stampa tipi operazione scadenze fornitori   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "LISTA TIPI OPERAZIONE SCADENZE FORNITORI"       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           ...
           05  rr-cod-min                 pic  9(04)                  .
           05  rr-cod-max                 pic  9(04)                  .
           05  rr-des-min                 pic  x(30)                  .
           05  rr-des-max                 pic  x(30)                  .
           05  rr-mne-min                 pic  x(04)                  .
           05  rr-mne-max                 pic  x(04)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-yop-cod-top         .
           move      "pgm/scf/fls/ioc/obj/iofyop"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-yop-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-mne-min           to   rf-yop-cod-mne         .
           move      zero                 to   rf-yop-cod-top         .
           move      "pgm/scf/fls/ioc/obj/iofyop"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun tipo operazione fra i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [yop]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/scf/fls/ioc/obj/iofyop"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rr-tip-ord           =    "C"
                     ...
                     go to prn-tst-max-600.
       prn-tst-max-200.
      *              *-------------------------------------------------*
      *              * Se ordinamento per codice                       *
      *              *-------------------------------------------------*
           if        rf-yop-cod-top       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub      .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-yop-cod-top       <    rr-cod-min or
                     rf-yop-cod-top       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-yop-des-key       <    rr-des-min or
                     rf-yop-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-yop-cod-mne       <    rr-mne-min or
                     rf-yop-cod-mne       >    rr-mne-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Test sul tipo di operazione         *
      *                          *-------------------------------------*
           if        rf-yop-cod-top       =    0001 or
                     rf-yop-cod-top       =    0002 or
                     rf-yop-cod-top       =    0003 or
                     rf-yop-cod-top       =    0011 or
                     rf-yop-cod-top       =    0022 or
                     rf-yop-cod-top       =    0033 or
                     rf-yop-cod-top       =    0111 or
                     rf-yop-cod-top       =    0222 or
                     rf-yop-cod-top       =    0333 or
                     rf-yop-cod-top       =    0444 or
                     rf-yop-cod-top       =    1101 or
                     rf-yop-cod-top       =    1102 or
                     rf-yop-cod-top       =    1103 or
                     rf-yop-cod-top       =    1104 or
                     rf-yop-cod-top       =    1105 or
                     rf-yop-cod-top       =    1106 or
                     rf-yop-cod-top       =    1107 or
                     rf-yop-cod-top       =    1108 or
                     rf-yop-cod-top       =    1109 or
                     rf-yop-cod-top       =    1110 or
                     rf-yop-cod-top       =    1111 or
                     rf-yop-cod-top       =    1127 or
                     rf-yop-cod-top       =    1161 or
                     rf-yop-cod-top       =    1200 or
                     rf-yop-cod-top       =    1610 or
                     rf-yop-cod-top       =    1620 or
                     rf-yop-cod-top       =    1630 or
                     rf-yop-cod-top       =    1640 or
                     rf-yop-cod-top       =    1830 or
                     rf-yop-cod-top       =    1831 or
                     rf-yop-cod-top       =    1840 or
                     rf-yop-cod-top       =    1850
                     go to prn-liv-det-320
           else      go to prn-liv-det-322.
       prn-liv-det-320.
      *                          *-------------------------------------*
      *                          * Se codice previsto dal tipo opera-  *
      *                          * zione                               *
      *                          *-------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                              *---------------------------------*
      *                              * A trattamento sottoconto        *
      *                              *---------------------------------*
           go to     prn-liv-det-400.
       prn-liv-det-322.
      *                          *-------------------------------------*
      *                          * Se codice non previsto dal tipo     *
      *                          * operazione                          *
      *                          *-------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
      ...
      *                          * Test sul tipo di operazione         *
      *                          *-------------------------------------*
           if        rf-yop-cau-cge       =    zero
                     go to prn-liv-det-422.
           if        rf-yop-cod-top       =    1101 or
                     rf-yop-cod-top       =    1102 or
                     rf-yop-cod-top       =    1103 or
                     rf-yop-cod-top       =    1104 or
                     rf-yop-cod-top       =    1105 or
      ...
      *                              *---------------------------------*
           ...
           move      rf-yop-stc-cge       to   w-edt-cod-pdc-cod      .
      ...
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Editing Codice contropartita    *
      *                              *---------------------------------*
           move      w-prs-liv-pdc        to   w-edt-cod-pdc-liv      .
           move      rf-yop-ctp-cge       to   w-edt-cod-pdc-cod      .
           move      "B"                  to   w-edt-cod-pdc-edm      .
           perform   edt-pdc-adx-000      thru edt-pdc-adx-999        .
      *                              *---------------------------------*
      *                              * Stampa sottoconto               *
      ...
      *              *-------------------------------------------------*
           move      "TIPI OPERAZIONE PER GESTIONE SCADENZE FORNITORI"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Mnem.  Codice                     Descrizione     
      -              "                 Cau   Sottoconto  Contropart."
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
