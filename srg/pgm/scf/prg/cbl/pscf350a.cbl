      ...
      *                       Ultima revisione:    NdK del 17/03/19    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Indicatore regime fiscale particolare       *
      *                                                                *
      *================================================================*
           ...
           05  w-exp-cts-snx.
               ...
               10  w-exp-cts-snx-tbl.
                   15  filler             pic  x(40) value
                            "Tutti i documenti                       ".
                   15  filler             pic  x(40) value
                            "solo quelli gia' Contrassegnati         ".
                   15  filler             pic  x(40) value
                            "solo quelli Da contrassegnare           ".
      *        *-------------------------------------------------------*
      *        * Work per : Regime fiscale                             *
      *        *-------------------------------------------------------*
           05  w-exp-flg-rfp.
               10  w-exp-flg-rfp-num      pic  9(02)       value 02   .
      ...
      *                  * Regime fiscale                              *
      *                  *---------------------------------------------*
           move      w-rig-flg-rfp        to   w-lin-imm-flg-rfp      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *
           if        w-rig-flg-rfp        =    spaces
                     move  1              to   v-num
           else if   w-rig-flg-rfp        =    "R"
                     move  2              to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-num                =    1
                     move  spaces         to   w-rig-flg-rfp
           else if   v-num                =    2
                     move  "R"            to   w-rig-flg-rfp
           else      move  spaces         to   w-rig-flg-rfp          .
       acc-flg-rfp-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-mgi-tip-iva       not  = "5"
                     go to stp-srt-inp-200.
       stp-srt-inp-420.
      *                  *---------------------------------------------*
      *                  * Selezione su regime fiscale                 *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test su si/no da contrassegnare         *
      *                      *-----------------------------------------*
      ...
      *                          * Se contrassegnati                   *
      *                          *-------------------------------------*
           if        rf-mgi-flg-rfp       =    spaces and
                     rf-mgi-flg-rfp       not  = "R"
                     go to stp-srt-inp-200
           else      go to stp-srt-inp-440.
       stp-srt-inp-426.
      *                          *-------------------------------------*
      *                          * Se da contrassegnare                *
      *                          *-------------------------------------*
           if        rf-mgi-flg-rfp       not  = spaces
                     go to stp-srt-inp-200
           else      go to stp-srt-inp-440.
       stp-srt-inp-440.
      *                  *---------------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      rf-mgi-cod-arc       to   srt-cod-fnt            .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-mgi-flg-rfp       to   w-rig-flg-rfp          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Aggiornamento Regime fiscale                *
      *                  *---------------------------------------------*
           move      w-rig-flg-rfp        to   rf-mgi-flg-rfp         .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [mgi]                         *
      *                  *---------------------------------------------*
