      ...
      *                                   Fase:    scf421              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 09/11/18    *
      *                       Ultima revisione:    NdK del 28/09/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su distinte archivi XML      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " INTERROGAZIONE SU DISTINTE FATTURE XML "       .
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-010.
      *              *-------------------------------------------------*
      *              * Determinazione data iniziale: 90 giorni prima   *
      *              * della data attuale                              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-nrg-dat-dtd    to   rf-fdx-ide-dat         .
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-fdx-num-dst       to   w-rot-l01-num-dst      .
       qry-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-fdx-num-dst       to   w-buf-l01-num-dst      .
           move      rf-fdx-dat-reg       to   w-buf-l01-dat-reg      .
      ...
      *
           if        w-buf-l01-ctr-esi    =    zero
                     ...
                     move  w-buf-l01-edt-esi
                                          to   w-all-str-cat (6)
                     move  "SCARTATO"     to   w-all-str-cat (7)
           else      move  "-"            to   w-all-str-cat (5)
                     move  w-buf-l01-edt-esi
                                          to   w-all-str-cat (6)
                     move  "SCARTATI"     to   w-all-str-cat (7)      .
      *
      ...
      *              *-------------------------------------------------*
           ...
           else if   rf-fdx-flg-apr       not  = spaces
