      ...
      *                                                                *
      *                    - Stampa conferma a Fornitore di avvenuto   *
      *                      Bonifico (nazionale o estero)             *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-stp.
      *        *-------------------------------------------------------*
      *        * Anagrafica ns. istituto di credito                    *
      *        *-------------------------------------------------------*
           05  w-sta-ana-nsi-dis          pic  x(40)                  .
           05  w-sta-ana-nsi-den          pic  x(40)                  .
           05  w-sta-ana-nsi-via          pic  x(40)                  .
           05  w-sta-ana-nsi-loc          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Anagrafica banca beneficiario                         *
      *        *-------------------------------------------------------*
           05  w-sta-ana-ben-dis          pic  x(40)                  .
           05  w-sta-ana-ben-den          pic  x(40)                  .
           05  w-sta-ana-ben-via          pic  x(40)                  .
           05  w-sta-ana-ben-loc          pic  x(40)                  .
      ...
      *                  * Note in stampa                              *
      *                  *---------------------------------------------*
           perform   acc-not-stp-000      thru acc-not-stp-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      21                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Annotazione per la stampa  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ric-sel-999.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-not-stp-999.
       acc-not-stp-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-txt                to   rr-not-stp             .
       acc-not-stp-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun Bonifico Bancario da stampare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-050.
      *              *-------------------------------------------------*
      *              * Selezione sul tipo valuta                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se bonifici                                 *
      *                  *---------------------------------------------*
           if        w-key-tip-ope        =    4735 and
                     rf-sfp-tvl-pgf       =    01
                     go to prn-sel-rec-100.
      *                  *---------------------------------------------*
      *                  * Se bonifici estero                          *
      *                  *---------------------------------------------*
           if        w-key-tip-ope        =    4736 and
                     rf-sfp-tvl-pgf       =    02
                     go to prn-sel-rec-100.
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-sfp-cod-fnt       to   w-rot-l02-cod-fnt      .
           move      rf-sfp-dpz-fnt       to   w-rot-l02-dpz-fnt      .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Con la presente Vi informiamo di aver provveduto a
      -              "l pagamento dell'importo sottoindicato presso: "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-140.
      ...
      *                      *-----------------------------------------*
      ...
      -              "      ---------------------------------------- "
       ...
       prn-ini-lr1-200.
      *                  *---------------------------------------------*
      *                  * Lettura anagrafica banca beneficiario       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Bufferizzazione anagrafica banca beneficia- *
      *                  * rio                                         *
      *                  *---------------------------------------------*
           move      w-let-arc-axi-den    to   w-sta-ana-ben-dis      .
           move      w-let-arc-axs-den    to   w-sta-ana-ben-den      .
           move      w-let-arc-axs-via    to   w-sta-ana-ben-via      .
           move      w-let-arc-axs-loc    to   w-sta-ana-ben-loc      .
       prn-ini-lr1-250.
      *                  *---------------------------------------------*
      *                  * Lettura archivio [cbp]                      *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-let-arc-cbp-ccb    to   rr-cod-cbp-ccc         .
      *                  *---------------------------------------------*
      *                  * Lettura anagrafica ns. istituto di credito  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           perform   let-arc-axs-000      thru let-arc-axs-999        .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione anagrafica ns. istituto di  *
      *                  * credito                                     *
      *                  *---------------------------------------------*
           move      w-let-arc-axi-den    to   w-sta-ana-nsi-dis      .
           move      w-let-arc-axs-den    to   w-sta-ana-nsi-den      .
           move      w-let-arc-axs-via    to   w-sta-ana-nsi-via      .
           move      w-let-arc-axs-loc    to   w-sta-ana-nsi-loc      .
       prn-ini-lr1-300.
      *                  *---------------------------------------------*
      *                  * Stampa                                      *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rf-sfp-tvl-pgf       not  = 02
                     go to prn-ini-lr1-305.
      *                      *-----------------------------------------*
      *                      * Stampa per bonifico su estero           *
      *                      *-----------------------------------------*
           perform   prn-ini-lr1-bef-000  thru prn-ini-lr1-bef-999    .
      *                      *-----------------------------------------*
      *                      * A stampa valuta                         *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      005                  to   p-pos                  .
           move      rf-sfp-abi-pgf       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Denominazione banca beneficiario        *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      011                  to   p-pos                  .
           move      w-sta-ana-ben-dis    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Denominazione ns. istituto di credito   *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      057                  to   p-pos                  .
           move      w-sta-ana-nsi-dis    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-320.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      005                  to   p-pos                  .
           move      rf-sfp-cab-pgf       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Denominazione sportello beneficiario    *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      011                  to   p-pos                  .
           move      w-sta-ana-ben-den    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Denominazione sportello ns. istituto    *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      057                  to   p-pos                  .
           move      w-sta-ana-nsi-den    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-330.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Localita' sportello beneficiario        *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      011                  to   p-pos                  .
           move      w-sta-ana-ben-loc    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Indirizzo sportello ns. istituto        *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      057                  to   p-pos                  .
           move      w-sta-ana-nsi-via    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-340.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      011                  to   p-pos                  .
           move      rf-sfp-ccc-pgf       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Localita' sportello ns. istituto        *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      057                  to   p-pos                  .
           move      w-sta-ana-nsi-loc    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-500.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Valuta fissa per il beneficiario :"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *    * Ciclo Report Program : Inizio 1. livello di rottura       *
      *    *                                                           *
      *    * Subroutine di stampa Banca estera                         *
      *    *-----------------------------------------------------------*
       prn-ini-lr1-bef-000.
      *              *-------------------------------------------------*
      *              * Lettura record [bef]                            *
      ...
      *                  * Test se da stampare                         *
      *                  *---------------------------------------------*
           if        w-let-arc-bef-swf    =    spaces
                     go to prn-ini-lr1-bef-900.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-let-arc-bef-swf    to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione comodo per linee residue       *
      *                  *---------------------------------------------*
           if        w-prn-tot-scf        =    w-prn-imp-pgf
                     move  5              to   w-prn-lin-res
           else      move  10             to   w-prn-lin-res          .
      *                  *---------------------------------------------*
      *                  * Test se righe residue sufficienti           *
      *                  *---------------------------------------------*
           if        p-res                >    w-prn-lin-res
      ...
      *                      *-----------------------------------------*
           ...
           move      w-rot-l02-cod-fnt    to   d-con-arc-cod-arc      .
           move      w-rot-l02-dpz-fnt    to   d-con-arc-dpz-arc      .
           move      "FAX"                to   d-con-arc-tip-sel      .
           move      01                   to   d-con-arc-num-edr      .
           perform   con-arc-tip-cll-000  thru con-arc-tip-cll-999    .
      *                      *-----------------------------------------*
      *                      * Test se numero determinato              *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-sfs-num-ddr       to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           if        rf-sfs-tip-ddr       =    11
                     subtract rf-sfs-imp-scf
                                          from w-prn-tot-scf
           else      add      rf-sfs-imp-scf
                                          to   w-prn-tot-scf          .
      *                  *---------------------------------------------*
      ...
      *                  * Tipo stampa : ristampa                      *
      *                  *---------------------------------------------*
           if        rf-sfp-fcs-tre       <    99
                     add  1               to   rf-sfp-fcs-tre         .
           go to     prn-liv-det-550.
       prn-liv-det-550.
      *                  *---------------------------------------------*
      *                  * Update record [sfp]                         *
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bef-cod-swf       to   w-let-arc-bef-swf      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-bef-600.
           ...
           move      spaces               to   w-let-arc-bef-swf      .
       let-arc-bef-999.
           exit.
