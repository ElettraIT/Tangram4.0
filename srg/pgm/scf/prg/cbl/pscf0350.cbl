      ...
      *    *===========================================================*
      *    * Work-area per selezioni sul record [yop]                  *
      *    *-----------------------------------------------------------*
       01  w-sel-rec-yop.
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-let.
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [yop]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-yop.
               10  w-let-arc-yop-flg      pic  x(01)                  .
               10  w-let-arc-yop-cod      pic  9(04)                  .
               10  w-let-arc-yop-des      pic  x(50)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-tpm-tip-ope-max          pic  9(03)   value 037      .
      *        *-------------------------------------------------------*
      ...
      *            * Elementi tabella                                  *
      *            *---------------------------------------------------*
               10  w-tpm-tip-ope-ele occurs 037.
      *                *-----------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-min        to   w-let-arc-yop-cod      .
           perform   let-arc-yop-000      thru let-arc-yop-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione tipo operazione  *
      *                  *---------------------------------------------*
           move      w-let-arc-yop-des    to   w-tes-cod-min-des      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-yop-ope      .
           move      w-tes-cod-max        to   w-cod-mne-yop-cod      .
           move      06                   to   w-cod-mne-yop-lin      .
           move      30                   to   w-cod-mne-yop-pos      .
      ...
      *                  * Lettura codice tipo operazione              *
      *                  *---------------------------------------------*
           move      w-tes-cod-max        to   w-let-arc-yop-cod      .
           perform   let-arc-yop-000      thru let-arc-yop-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione tipo operazione  *
      *                  *---------------------------------------------*
           move      w-let-arc-yop-des    to   w-tes-cod-max-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione tipo operazione *
      *                  *---------------------------------------------*
           perform   vis-cod-max-des-000  thru vis-cod-max-des-999    .
      ...
      *                  *---------------------------------------------*
           if        w-rig-cod-top        =    0001 or
                     w-rig-cod-top        =    0002 or
                     w-rig-cod-top        =    0003 or
                     w-rig-cod-top        =    0011 or
                     w-rig-cod-top        =    0022 or
                     w-rig-cod-top        =    0033 or
                     w-rig-cod-top        =    0111 or
                     w-rig-cod-top        =    0222 or
                     w-rig-cod-top        =    0333 or
                     w-rig-cod-top        =    0444 or
                     w-rig-cod-top        =    1101 or
                     w-rig-cod-top        =    1102 or
                     w-rig-cod-top        =    1103 or
                     w-rig-cod-top        =    1104 or
                     w-rig-cod-top        =    1105 or
                     w-rig-cod-top        =    1106 or
                     w-rig-cod-top        =    1107 or
                     w-rig-cod-top        =    1108 or
                     w-rig-cod-top        =    1109 or
                     w-rig-cod-top        =    1110 or
                     w-rig-cod-top        =    1111 or
                     w-rig-cod-top        =    1127 or
                     w-rig-cod-top        =    1161 or
                     w-rig-cod-top        =    1200 or
                     w-rig-cod-top        =    1610 or
                     w-rig-cod-top        =    1620 or
                     w-rig-cod-top        =    1630 or
                     w-rig-cod-top        =    1640 or
                     w-rig-cod-top        =    1830 or
                     w-rig-cod-top        =    1831 or
                     w-rig-cod-top        =    1840 or
                     w-rig-cod-top        =    1850
                     go to vis-lin-cor-485
           else      go to vis-lin-cor-490.
       vis-lin-cor-485.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           if        w-rig-cod-top        =    1610 or
                     ...
                     w-rig-cod-top        =    1840 or
                     w-rig-cod-top        =    1850
                     go to vis-lin-cor-525
           else      go to vis-lin-cor-530.
       vis-lin-cor-525.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-rig-cod-top        =    0001 or
                     ...
                     w-rig-cod-top        =    0333 or
                     w-rig-cod-top        =    0444
                     go to pmt-rix-cau-050
           else if   w-rig-cod-top        =    1101 or
                     w-rig-cod-top        =    1102 or
                     w-rig-cod-top        =    1103 or
                     w-rig-cod-top        =    1104 or
                     w-rig-cod-top        =    1105 or
           ...
           else if   w-rig-cod-top        =    1161
                     go to pmt-rix-cau-120
           else if   w-rig-cod-top        =    1200
                     go to pmt-rix-cau-140
           else if   w-rig-cod-top        =    1610 or
                     w-rig-cod-top        =    1620 or
                     w-rig-cod-top        =    1630 or
                     w-rig-cod-top        =    1640
                     go to pmt-rix-cau-200
           else if   w-rig-cod-top        =    1830 or
                     w-rig-cod-top        =    1831 or
                     w-rig-cod-top        =    1840 or
                     w-rig-cod-top        =    1850
      ...
      *                  *---------------------------------------------*
           move      "AC"                 to   w-cod-mne-yop-ope      .
           move      w-rig-cod-top        to   w-cod-mne-yop-cod      .
           move      17                   to   w-cod-mne-yop-lin      .
           move      25                   to   w-cod-mne-yop-pos      .
      ...
      *                  *---------------------------------------------*
           if        w-rig-cod-top        =    0001 or
                     ...
                     w-rig-cod-top        =    1840 or
                     w-rig-cod-top        =    1850
                     go to acc-rig-cau-050
           else      go to acc-rig-cau-999.
       acc-rig-cau-050.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-rig-cod-top        =    0001 or
                     ...
                     w-rig-cod-top        =    0333 or
                     w-rig-cod-top        =    0444
                     go to acc-rig-cau-510
           else      go to acc-rig-cau-550.
       acc-rig-cau-510.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-rig-cod-top        =    0001 or
                     w-rig-cod-top        =    0002
                     go to acc-rig-cau-512
           else if   w-rig-cod-top        =    0003
                     go to acc-rig-cau-514
           else if   w-rig-cod-top        =    0011 or
                     w-rig-cod-top        =    0022
                     go to acc-rig-cau-516
           else if   w-rig-cod-top        =    0033
                     go to acc-rig-cau-518
           else if   w-rig-cod-top        =    0111 or
                     w-rig-cod-top        =    0222 or
                     w-rig-cod-top        =    0333
                     go to acc-rig-cau-520
           else if   w-rig-cod-top        =    0444
                     go to acc-rig-cau-522.
       acc-rig-cau-512.
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-cau-cge        =    zero
                     go to acc-rig-cau-630
           else      go to acc-rig-cau-680.
       acc-rig-cau-630.
      *                  *---------------------------------------------*
      ...
      *                      * sottoconto contabile                    *
      *                      *-----------------------------------------*
           if        w-rig-cod-top        not  < 1101 and
                     w-rig-cod-top        not  > 1111
                     go to acc-rig-cau-635
           else if   w-rig-cod-top        =    1161
                     go to acc-rig-cau-635
           else if   w-rig-cod-top        =    1610 or
                     w-rig-cod-top        =    1620 or
                     ...
                     w-rig-cod-top        =    1850
                     go to acc-rig-cau-635
           else      go to acc-rig-cau-645.
       acc-rig-cau-635.
      *                      *-----------------------------------------*
      *                      * Test se sottoconto contabile gia' nor-  *
      *                      * malizzato                               *
      *                      *-----------------------------------------*
           if        w-rig-stc-cge        =    zero
                     go to acc-rig-cau-645.
       acc-rig-cau-640.
      *                      *-----------------------------------------*
      *                      * Normalizzazione sottoconto              *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-rig-cod-top        =    1610 or
                     ...
                     w-rig-cod-top        =    1840 or
                     w-rig-cod-top        =    1850
                     go to acc-rig-cau-650
           else      go to acc-rig-cau-660.
       acc-rig-cau-650.
      *                      *-----------------------------------------*
      *                      * Test se contropartita contabile gia'    *
      *                      * normalizzata                            *
      *                      *-----------------------------------------*
           if        w-rig-ctp-cge        =    zero
                     go to acc-rig-cau-660.
       acc-rig-cau-655.
      *                      *-----------------------------------------*
      *                      * Normalizzazione contropartita           *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-rig-cod-top        =    1101 or
                     ...
                     w-rig-cod-top        =    1840 or
                     w-rig-cod-top        =    1850
                     go to acc-rig-stc-050
           else      go to acc-rig-stc-999.
       acc-rig-stc-050.
      *                  *---------------------------------------------*
      *                  * Visualizzazione prompt specifico            *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-rig-cod-top        =    1610 or
                     ...
                     w-rig-cod-top        =    1840 or
                     w-rig-cod-top        =    1850
                     go to acc-rig-ctp-050
           else      go to acc-rig-ctp-999.
       acc-rig-ctp-050.
      *                  *---------------------------------------------*
      *                  * Visualizzazione prompt specifico            *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-min        to   rf-yop-cod-top         .
           move      "pgm/scf/fls/ioc/obj/iofyop"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Ordinamento per Codice                      *
      *                  *---------------------------------------------*
           if        rf-yop-cod-top       >    w-tes-cod-max
                     go to car-fil-rap-900.
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   sel-rec-yop-000      thru sel-rec-yop-999        .
      *                  *---------------------------------------------*
      *                  * Test su flag di selezione                   *
      *                  *---------------------------------------------*
           if        w-sel-rec-yop-flg    not  = spaces
                     go to car-fil-rap-200.
       car-fil-rap-500.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       car-fil-rap-600.
      *              *-------------------------------------------------*
      *              * Riciclo a Read Next su file [yop]               *
      *              *-------------------------------------------------*
           go to     car-fil-rap-200.
       car-fil-rap-900.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Selezioni sul record [yop]                                *
      *    *-----------------------------------------------------------*
       sel-rec-yop-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di selezione               *
      *              *-------------------------------------------------*
           move      spaces               to   w-sel-rec-yop-flg      .
       sel-rec-yop-010.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cau-cge        =    zero
                     go to sel-rec-yop-200.
           if        rf-yop-cau-cge       not  = w-tes-cau-cge
                     go to sel-rec-yop-900.
       sel-rec-yop-200.
      *                  *---------------------------------------------*
      *                  * Sottoconto contabile                        *
      *                  *---------------------------------------------*
           if        w-tes-stc-cge        =    zero
                     go to sel-rec-yop-300.
           if        rf-yop-stc-cge       not  = w-tes-stc-cge
                     go to sel-rec-yop-900.
       sel-rec-yop-300.
      *                  *---------------------------------------------*
      *                  * Contropartita contabile                     *
      *                  *---------------------------------------------*
           if        w-tes-ctp-cge        =    zero
                     go to sel-rec-yop-800.
           if        rf-yop-ctp-cge       not  = w-tes-ctp-cge
                     go to sel-rec-yop-900.
       sel-rec-yop-800.
      *                  *---------------------------------------------*
      *                  * Uscita per selezione superata               *
      *                  *---------------------------------------------*
           go to     sel-rec-yop-999.
       sel-rec-yop-900.
      *              *-------------------------------------------------*
      ...
      *                          * ne                                  *
      *                          *-------------------------------------*
           move      rf-yop-cod-top       to   w-rig-cod-top          .
           move      rf-yop-des-top       to   w-rig-cod-top-des      .
      *                          *-------------------------------------*
      *                          * Codice mnemonico                    *
      *                          *-------------------------------------*
           move      rf-yop-cod-mne       to   w-rig-cod-mne          .
      *                          *-------------------------------------*
      *                          * Causale contabile                   *
      *                          *-------------------------------------*
           move      rf-yop-cau-cge       to   w-rig-cau-cge          .
      *                          *-------------------------------------*
      *                          * Sottoconto contabile                *
      *                          *-------------------------------------*
           move      rf-yop-stc-cge       to   w-rig-stc-cge          .
      *                          *-------------------------------------*
      *                          * Contropartita contabile             *
      *                          *-------------------------------------*
           move      rf-yop-ctp-cge       to   w-rig-ctp-cge          .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Lettura, con lock, del record [yop]             *
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODTOP    "         to   f-key                  .
           move      w-rig-cod-top        to   rf-yop-cod-top         .
           move      "pgm/scf/fls/ioc/obj/iofyop"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Causale contabile                   *
      *                          *-------------------------------------*
           move      w-rig-cau-cge        to   rf-yop-cau-cge         .
      *                          *-------------------------------------*
      *                          * Sottoconto contabile                *
      *                          *-------------------------------------*
           move      w-rig-stc-cge        to   rf-yop-stc-cge         .
      *                          *-------------------------------------*
      *                          * Contropartita contabile             *
      *                          *-------------------------------------*
           move      w-rig-ctp-cge        to   rf-yop-ctp-cge         .
      *                          *-------------------------------------*
      *                          * Codice mnemonico                    *
      *                          *-------------------------------------*
           move      w-rig-cod-mne        to   rf-yop-cod-mne         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-yop-flg      .
      *              *-------------------------------------------------*
      *              * Test se codice a zero                           *
      *              *-------------------------------------------------*
           if        w-let-arc-yop-cod    =    zero
                     go to let-arc-yop-500.
      *              *-------------------------------------------------*
      *              * Lettura per codice                              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODTOP    "         to   f-key                  .
           move      w-let-arc-yop-cod    to   rf-yop-cod-top         .
           move      "pgm/scf/fls/ioc/obj/iofyop"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-yop                 .
           if        f-sts                not  = e-not-err
                     go to let-arc-yop-400.
       let-arc-yop-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-yop-des-top       to   w-let-arc-yop-des      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     let-arc-yop-999.
       let-arc-yop-400.
      *              *-------------------------------------------------*
      *              * Azioni per record non trovato                   *
      *              *-------------------------------------------------*
           move      "#"                  to   w-let-arc-yop-flg      .
           move      all   "."            to   w-let-arc-yop-des      .
           go to     let-arc-yop-600.
       let-arc-yop-500.
      *              *-------------------------------------------------*
      *              * Normalizzazione work area                       *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-yop-des      .
       let-arc-yop-600.
       let-arc-yop-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-tpm-tip-ope-cod
                    (w-cix-ctr-001)       to   rf-yop-cod-top         .
      *                  *---------------------------------------------*
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      "IG"                 to   s-ope                  .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/scf/prg/obj/pscf0352"                       .
       cnc-rlt-sup-999.
           exit.
