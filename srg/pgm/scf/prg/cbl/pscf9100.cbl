      ...
      *                                   Fase:    scf910              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 13/01/97    *
      *                       Ultima revisione:    NdK del 27/08/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Pulizia files di appoggio a 'scf800'        *
      *                                                                *
      *                    Utilizzo di 't_xml_for_pul' per pulizia     *
      *                    delle tabelle di appoggio MySQL             *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "PULIZIA ARCHIVI DI APPOGGIO FATT. 'XML' "       .
      ...
      *        * liti i documenti.                                     *
      *        *                                                       *
      *        * Inizialmente viene propxfta la data di fine eserci-   *
      ...
      *    *-----------------------------------------------------------*
       01  f-xxx.
           05  f-xxx-nam                  pic  x(04)   value "xft "   .
      ...
      *        *-------------------------------------------------------*
      *        * Work per pulizia tabelle MySQL                        *
      *        *-------------------------------------------------------*
           05  w-det-pul-xml.
               10  w-det-pul-xml-azi      pic  x(04)                  .
               10  w-det-pul-xml-dat      pic  x(10)                  .
               10  w-det-pul-xml-saa      pic  9(03)                  .
               10  w-det-pul-xml-mes      pic  9(02)                  .
               10  w-det-pul-xml-gio      pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
      *              * Comando di pulizia delle tabelle di appoggio    *
      *              * MySQL                                           *
      *              *-------------------------------------------------*
           perform   pul-rou-pri-xml-000  thru pul-rou-pri-xml-999    .
       pul-rou-pri-999.
           exit.
      ...
      *    * Pulizie : Routine principale                              *
      *    *                                                           *
      *    * Subroutine di pulizia delle tabelle di appoggio MySQL     *
      *    *-----------------------------------------------------------*
       pul-rou-pri-xml-000.
      *              *-------------------------------------------------*
      ...
      *                  * Codice azienda                              *
      *                  *---------------------------------------------*
           move      s-azi                to   w-det-pul-xml-azi      .
       pul-rou-pri-xml-200.
      *              *-------------------------------------------------*
      *              * Preparazione Data pulizia                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione valore in uscita            *
      *                  *---------------------------------------------*
           move      spaces               to   w-det-pul-xml-dat      .
      *                  *---------------------------------------------*
      *                  * Preparazione data documento                 *
      *                  *---------------------------------------------*
           move      rr-dat-pul           to   s-dat                  .
           move      s-saa                to   w-det-pul-xml-saa      .
           move      s-mes                to   w-det-pul-xml-mes      .
           move      s-gio                to   w-det-pul-xml-gio      .
      *                  *---------------------------------------------*
      *                  * Editing anno                                *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           ...
           move      spaces               to   v-sgn                  .
           move      "9"                  to   v-edm                  .
           move      w-det-pul-xml-saa    to   v-num                  .
           add       1900                 to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "9"                  to   v-edm                  .
           move      w-det-pul-xml-mes    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "9"                  to   v-edm                  .
           move      w-det-pul-xml-gio    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-all-str-alf        to   w-det-pul-xml-dat      .
       pul-rou-pri-xml-300.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pmt-dat-pul-000.
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Pulizia documenti con data di caricamento fino al 
      -              ".................:"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
       ...
       pul-let-seq-200.
      *              *-------------------------------------------------*
      *              * Incremento contatore records [xft] letti        *
      *              *-------------------------------------------------*
      ...
      *              * tare                                            *
      *              *-------------------------------------------------*
           if        rf-xft-dat-car       >    rr-dat-pul
                     go to pul-sel-rec-800.
       pul-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Se il movimento non e' chiuso e' da riportare   *
      *              *-------------------------------------------------*
       pul-sel-rec-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [xft] scritti  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "#"                  to   w-cnt-pul-flg-sub      .
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [xft] elimina- *
      *                  * ti                                          *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione contatore records [xfr]     *
      *                  * scritti                                     *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       pul-put-app-100.
      *                  *---------------------------------------------*
      *                  * Lettura sequenziale record [xfr]            *
      *                  *---------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/scf/fls/ioc/obj/iofxfr"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           if        rf-xfr-nom-xml       not  = rf-xft-nom-xml
                     go to pul-put-app-200.
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [xfr] scritti  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-xfr                 .
      *                  *---------------------------------------------*
      *                  * Riciclo su lettura sequenziale record [xfr] *
      *                  *---------------------------------------------*
           go to     pul-put-app-100.
       pul-put-app-200.
      *              *-------------------------------------------------*
      *              * Test su contatore records [xfr] scritti : se a  *
      *              * zero si esce                                    *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "NOMXML    "         to   f-key                  .
           move      rf-xft-nom-xml       to   rf-xfx-nom-xml         .
      ...
      *                      *-----------------------------------------*
       ...
       pul-put-app-400.
      *                  *---------------------------------------------*
      *                  * Lettura sequenziale record [xfx]            *
      *                  *---------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/scf/fls/ioc/obj/iofxfx"
                                          to   s-pat                  .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-xfx-nom-xml       not  = rf-xft-nom-xml
                     go to pul-put-app-600.
      *                  *---------------------------------------------*
      *                  * Put record in file di appoggio              *
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-xfx                 .
      *                  *---------------------------------------------*
      *                  * Riciclo su lettura sequenziale record [xfx] *
      *                  *---------------------------------------------*
