      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma scf202   *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-stp.
      *        *-------------------------------------------------------*
      *        * Work per rottura a livello 1                          *
      *        *-------------------------------------------------------*
           05  w-stp-ini-lr1.
      *            *---------------------------------------------------*
      *            * Posizione per stampa stringa alfabetica allineata *
      *            * a destra                                          *
      *            *---------------------------------------------------*
               10  w-stp-ini-lr1-pos      pic  9(03)                  .
      ...
      *              * Se ordinamento per codice                       *
      *              *-------------------------------------------------*
           if        rf-bef-cod-bef       >    rr-cod-max or
                     rf-bef-cod-bef       <    rr-cod-min
                     go to prn-tst-max-900.
      ...
      *              * Se ordinamento per descrizione                  *
      *              *-------------------------------------------------*
           if        rf-bef-des-key       >    rr-des-max or
                     rf-bef-des-key       <    rr-des-min
                     go to prn-tst-max-900.
           go to     prn-tst-max-999.
       prn-tst-max-600.
      *              *-------------------------------------------------*
      *              * Se ordinamento per mnemonico                    *
      *              *-------------------------------------------------*
           if        rf-bef-mne-bef       >    rr-mne-max or
                     rf-bef-mne-bef       <    rr-mne-min
                     go to prn-tst-max-900.
           go to     prn-tst-max-999.
       prn-tst-max-800.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-bef-cod-dcf       to   w-rot-l01-cod-dcf      .
           move      rf-bef-dpz-dcf       to   w-rot-l01-dpz-dcf      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rot-l01-cod-dcf    to   w-let-arc-dcf-cod      .
           move      w-rot-l01-dpz-dcf    to   w-let-arc-dcf-dpz      .
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      058                  to   p-pos                  .
           move      w-let-arc-dcf-rag    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      ...
      *                      *-----------------------------------------*
           if        w-rot-l01-dpz-dcf    =    spaces
                     go to prn-ini-lr1-200.
      *                      *-----------------------------------------*
      *                      * Preparazione posizione giustificata a   *
      *                      * destra                                  *
      *                      *-----------------------------------------*
           move      zero                 to   w-stp-ini-lr1-pos      .
           inspect   w-rot-l01-dpz-dcf
                                      tallying w-stp-ini-lr1-pos
                                          for  trailing spaces        .
      *                      *-----------------------------------------*
      *                      * Stampa                                  *
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      051                  to   p-pos                  .
           add       w-stp-ini-lr1-pos    to   p-pos                  .
           move      w-rot-l01-dpz-dcf    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr1-200.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      058                  to   p-pos                  .
           move      w-let-arc-dcf-via    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      058                  to   p-pos                  .
           move      w-let-arc-dcf-loc    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      ...
      *                  *---------------------------------------------*
           perform   int-liv-det-000      thru int-liv-det-999        .
       prn-ini-lr1-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "ELENCO BANCHE ESTERE FORNITORI"
      ...
      *    *===========================================================*
      *    * Intestazione a livello dettaglio                          *
      *    *-----------------------------------------------------------*
       int-liv-det-000.
      *              *-------------------------------------------------*
      *              * Interlinea                                      *
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Sottolinetura fincatura dettaglio               *
      *              *-------------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      132                  to   p-car                  .
