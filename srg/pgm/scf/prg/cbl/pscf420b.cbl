      ...
      *                                   Fase:    scf420              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 13/06/19    *
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Numero progressivo nella distinta                 *
      *            *---------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-fdx-cod-arc       to   rf-dcf-cod-fnt         .
           move      rf-fdx-dpz-arc       to   rf-dcf-dpz-fnt         .
           move      "pgm/dcf/fls/ioc/obj/iofdcf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "/"                  to   w-all-str-del          .
           perform   all-str-ext-000      thru all-str-ext-999        .
           move      w-all-str-cat (6)    to   w-det-ext-nam-fil      .
      *
