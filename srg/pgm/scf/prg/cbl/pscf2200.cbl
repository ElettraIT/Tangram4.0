      ...
      *                                   Fase:    scf220              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 16/03/04    *
      *                       Ultima revisione:    NdK del 14/11/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione anagrafica di controllo acquisti   *
      *                    fornitori                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    ANAGRAFICA DI CONTROLLO ACQUISTI    "       .
      ...
      *            *---------------------------------------------------*
      *            * Fido massimo concesso dal fornitore               *
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Ordine massimo concesso dal fornitore             *
      *            *---------------------------------------------------*
               10  w-tes-max-orf          pic  9(13)                  .
      *            *---------------------------------------------------*
      *            * Data di assegnazione                              *
      *            *---------------------------------------------------*
               10  w-tes-dat-orf          pic  9(07)                  .
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      05                   to   w-cod-mne-fnt-vln      .
           move      41                   to   w-cod-mne-fnt-vps      .
           move      06                   to   w-cod-mne-fnt-lln      .
      ...
      *                  * Massimo ordine                              *
      *                  *---------------------------------------------*
           perform   acc-max-orf-000      thru acc-max-orf-999        .
           if        v-key                =    "NXSC"
      ...
      *                  * Data riferimento                            *
      *                  *---------------------------------------------*
           perform   acc-dat-orf-000      thru acc-dat-orf-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  * Massimo ordine                              *
      *                  *---------------------------------------------*
           perform   vis-max-orf-000      thru vis-max-orf-999        .
      *                  *---------------------------------------------*
      *                  * Data riferimento                            *
      *                  *---------------------------------------------*
           perform   vis-dat-orf-000      thru vis-dat-orf-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     vis-tes-reg-999.
      ...
      *                  * Massimo ordine                              *
      *                  *---------------------------------------------*
           perform   pmt-max-orf-000      thru pmt-max-orf-999        .
      *                  *---------------------------------------------*
      *                  * Data riferimento                            *
      *                  *---------------------------------------------*
           perform   pmt-dat-orf-000      thru pmt-dat-orf-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     pmt-tes-reg-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Massimo ordine                   *
      *    *-----------------------------------------------------------*
       pmt-max-orf-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Valore massimo per ordine  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-max-orf-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data di riferimento              *
      *    *-----------------------------------------------------------*
       pmt-dat-orf-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Massimo ordine                       *
      *    *-----------------------------------------------------------*
       acc-max-orf-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-max-orf-100.
       acc-max-orf-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Massimo ordine                    *
      *    *-----------------------------------------------------------*
       vis-max-orf-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data riferimento                     *
      *    *-----------------------------------------------------------*
       acc-dat-orf-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-dat-orf (1)    not  = zero
                     go to acc-dat-orf-100.
           if        w-tes-max-orf (1)    =    zero
                     go to acc-dat-orf-100.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Data riferimento                  *
      *    *-----------------------------------------------------------*
       vis-dat-orf-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           ...
           move      zero                 to   w-tes-max-orf (1)      .
           move      zero                 to   w-tes-dat-orf (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-fnt        to   rf-fff-cod-fnt         .
           move      "pgm/scf/fls/ioc/obj/ioffff"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * cord [fff]                              *
      *                      *-----------------------------------------*
           move      rf-fff-ide-dat       to   w-tes-ide-dat (1)      .
           move      rf-fff-ide-ute       to   w-tes-ide-ute (1)      .
           move      rf-fff-ide-fas       to   w-tes-ide-fas (1)      .
           move      rf-fff-max-fid       to   w-tes-max-fid (1)      .
           move      rf-fff-dat-fid       to   w-tes-dat-fid (1)      .
           move      rf-fff-max-orf       to   w-tes-max-orf (1)      .
           move      rf-fff-dat-orf       to   w-tes-dat-orf (1)      .
           move      rf-fff-alx-exp       to   w-tes-alx-exp (1)      .
       rou-let-reg-200.
      *                      *-----------------------------------------*
      ...
      *                      * Write record [fff]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-fff-000      thru wrt-rec-fff-999        .
      ...
      *                      * Rewrite record [fff]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-fff-000      thru rew-rec-fff-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [fff]                             *
      *              *-------------------------------------------------*
           perform   del-rec-fff-000      thru del-rec-fff-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [fff]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-fff-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-fff-ide-dat         .
           move      s-ute                to   rf-fff-ide-ute         .
           move      s-fas                to   rf-fff-ide-fas         .
           move      w-tes-cod-fnt        to   rf-fff-cod-fnt         .
           move      w-tes-max-fid (1)    to   rf-fff-max-fid         .
           move      w-tes-dat-fid (1)    to   rf-fff-dat-fid         .
           move      w-tes-max-orf (1)    to   rf-fff-max-orf         .
           move      w-tes-dat-orf (1)    to   rf-fff-dat-orf         .
           move      w-tes-alx-exp (1)    to   rf-fff-alx-exp         .
       cmp-rec-fff-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [fff]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-fff-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-fff-000      thru cmp-rec-fff-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
      *              * Test se codice fornitori a zero                 *
      *              *-------------------------------------------------*
