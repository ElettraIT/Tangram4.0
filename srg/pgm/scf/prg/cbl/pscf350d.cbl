      ...
      *                                                                *
      *                    Gestione codice fornitore documenti 'xml'   *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "GESTIONE CODICE FORNITORE DOC. RICEVUTI "       .
           ...
           05  w-exp-abb-snx.
               ...
               10  w-exp-abb-snx-tbl.
                   15  filler             pic  x(40) value
                            "solo quelli Senza codice fornitore      ".
                   15  filler             pic  x(40) value
                            "solo quelli Con codice fornitore        ".
                   15  filler             pic  x(40) value
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-fnt-rag    to   w-sav-rag-fnt          .
       acc-fnt-rig-100.
      *              *-------------------------------------------------*
      *              * Ripristino valore precedente                    *
      *              *-------------------------------------------------*
           move      w-sav-rag-fnt        to   w-rig-cod-fnt-rag      .
       acc-fnt-rig-125.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-cod-fnt          .
       acc-cod-fbd-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se codice a zero: messaggio di avviso       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        w-rig-cod-fnt        not  = zero
                     go to acc-cod-fbd-420.
      *                      *-----------------------------------------*
      *                      * Messaggio                               *
      *                      *-----------------------------------------*
           move      "Inserire un codice fornitore !                    
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                      *-----------------------------------------*
      *                      * Oltre                                   *
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   w-let-arc-dcf-dpz      .
           perform   let-arc-dcf-000      thru let-arc-dcf-999        .
           move      w-let-arc-dcf-rag    to   w-rig-cod-fnt-rnw      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione                             *
      *                  *---------------------------------------------*
           perform   vis-cod-fbd-rag-000  thru vis-cod-fbd-rag-999    .
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-fnt        to   w-let-arc-fnt-cod      .
           perform   let-arc-fnt-000      thru let-arc-fnt-999        .
      *                  *---------------------------------------------*
      *                  * Test su partita Iva                         *
      *                  *---------------------------------------------*
           if        w-let-arc-fnt-piv    =    rf-xft-idf-ftf
                                              (01 : 11)
                     go to acc-cod-fbd-600.
      *                  *---------------------------------------------*
      *                  * Messaggio                                   *
      *                  *---------------------------------------------*
           move      "La Partita Iva non sembra coincidere !            
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
       acc-cod-fbd-600.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       vis-cod-fbd-rag-000.
           ...
           move      19                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-fnt-rnw    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-fbd-rag-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      spaces               to   w-rig-cod-fnt-rnw      .
      ...
      *                  *---------------------------------------------*
      *                  * Aggiornamento codice fornitore              *
      *                  *---------------------------------------------*
           move      w-rig-cod-fnt        to   rf-xft-cod-fnt         .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [xft]                         *
      *                  *---------------------------------------------*
