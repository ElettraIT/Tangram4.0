      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase scf600, nella sua globalita', esegue i tipi di inter-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * AFFLER      Lista e riepilogo situazione scadenze fornitori    *
      *             per fornitore                                      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "ANALISI SCADENZE FORNITORI PER FORNITORE"       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'scf600'           *
      *              *-------------------------------------------------*
           perform   fas-scf-600-000      thru fas-scf-600-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *
           move      "Lista e riepilogo situazione scadenze fornitore   
      -              " AFFLER     pscf600a  "
                                          to   w-tin-ele-wci          .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-scf-600-300
           else if   v-key                =    "PRSC"
                     go to fas-scf-600-400
           else if   v-key                =    "NXSC"
                     go to fas-scf-600-450
           else if   v-key                =    "DOWN"
                     go to fas-scf-600-500
           else if   v-key                =    "EXIT"
                     go to fas-scf-600-250
           else      go to fas-scf-600-200.
       fas-scf-600-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-scf-600-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-scf-600-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-scf-600-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-scf-600-350
           else      go to fas-scf-600-322.
       fas-scf-600-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-scf-600-630
           else if   v-key                =    "PRSC"
                     go to fas-scf-600-600
           else if   v-key                =    "NXSC"
                     go to fas-scf-600-610
           else if   v-key                =    "UP  "
                     go to fas-scf-600-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-scf-600-650
           else if   v-key                =    "EXIT"
                     go to fas-scf-600-660
           else      go to fas-scf-600-570.
       fas-scf-600-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-scf-600-626
           else      go to fas-scf-600-628.
       fas-scf-600-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-scf-600-636
           else      go to fas-scf-600-638.
       fas-scf-600-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-scf-600-725
           else      go to fas-scf-600-750.
       fas-scf-600-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
