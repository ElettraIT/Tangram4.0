      ...
      *                                   Fase:    scf720              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/02/97    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pscf7201:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-sts-doc.
               10  w-exp-sts-doc-num      pic  9(02)       value 03   .
               10  w-exp-sts-doc-lun      pic  9(02)       value 40   .
               10  w-exp-sts-doc-tbl.
                   15  filler             pic  x(40) value
                            "Tutti i documenti                       ".
                   15  filler             pic  x(40) value
                            "Solo quelli da pagare                   ".
                   15  filler             pic  x(40) value
                            "Solo quelli pagati                      ".
      ...
      *                  *---------------------------------------------*
           perform   acc-ddo-ini-000      thru acc-ddo-ini-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           perform   acc-ddo-fin-000      thru acc-ddo-fin-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Status documenti                            *
      *                  *---------------------------------------------*
           perform   acc-sts-doc-000      thru acc-sts-doc-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * Data scadenza iniziale                          *
      *              *-------------------------------------------------*
           perform   pmt-ddo-ini-000      thru pmt-ddo-ini-999        .
      *              *-------------------------------------------------*
      *              * Data scadenza finale                            *
      *              *-------------------------------------------------*
           perform   pmt-ddo-fin-000      thru pmt-ddo-fin-999        .
      *              *-------------------------------------------------*
      *              * Tipi documento                                  *
      *              *-------------------------------------------------*
      ...
      *              * Status documenti                                *
      *              *-------------------------------------------------*
           perform   pmt-sts-doc-000      thru pmt-sts-doc-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Data documento iniziale       *
      *    *-----------------------------------------------------------*
       pmt-ddo-ini-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Data documento finale         *
      *    *-----------------------------------------------------------*
       pmt-ddo-fin-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Tipi documento                *
      *    *-----------------------------------------------------------*
       pmt-tip-doc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      16                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipi documento da stampare :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tip-doc-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Status documenti              *
      *    *-----------------------------------------------------------*
       pmt-sts-doc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Data documento iniziale    *
      *    *-----------------------------------------------------------*
       acc-ddo-ini-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-ddo-ini-999.
       acc-ddo-ini-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-ddo-ini             .
       acc-ddo-ini-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-ddo-ini-100.
       acc-ddo-ini-999.
           exit.

      *    *===========================================================*
      *    * Accettazione campo selezione : Data documento finale      *
      *    *-----------------------------------------------------------*
       acc-ddo-fin-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-ddo-fin-999.
       acc-ddo-fin-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-ddo-fin             .
       acc-ddo-fin-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Status documenti           *
      *    *-----------------------------------------------------------*
       acc-sts-doc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sts-doc-lun    to   v-car                  .
           move      w-exp-sts-doc-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      w-exp-sts-doc-tbl    to   v-txt                  .
           move      19                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-sts-doc-999.
       acc-sts-doc-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-sts-doc             .
       acc-sts-doc-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        rr-ddo-ini           not  > rr-ddo-fin
                     go to tdo-ric-sel-800.
           move      "Data documento finale inferiore a quella iniziale 
      -              "!"                  to   w-box-msg-err-msg      .
      ...
      *              *-------------------------------------------------*
           if        rr-tip-doc           =    spaces
                     move  "XXX"          to   rr-tip-doc             .
      *              *-------------------------------------------------*
      *              * Status documenti                                *
      *              *-------------------------------------------------*
           if        rr-sts-doc           =    zero
                     move  01             to   rr-sts-doc             .
       reg-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Data scadenza iniziale e finale                 *
      *              *-------------------------------------------------*
           if        rr-ddo-fin           not  = zero
                     go to reg-ric-sel-999.
           if        rr-ddo-ini           =    zero
                     move 9999999         to   rr-ddo-fin
           else      move rr-ddo-ini      to   rr-ddo-fin             .
       reg-ric-sel-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      zero                 to   rr-ddo-ini             .
           move      zero                 to   rr-ddo-fin             .
           move      "XXX"                to   rr-tip-doc             .
           move      zero                 to   rr-sts-doc             .
       nor-ric-sel-999.
           exit.
