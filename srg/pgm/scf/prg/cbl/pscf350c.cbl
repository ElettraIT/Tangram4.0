      ...
      *                       Ultima revisione:    NdK del 19/03/19    *
      *                    ------------------------------------------- *
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "GESTIONE DATA DI ACQUISIZIONE DOCUMENTI "       .
      ...
      *            *---------------------------------------------------*
      *            * Si/no solo contrassegnati                         *
      *            *---------------------------------------------------*
               10  w-tes-cts-snx          pic  9(02)                  .
      *            *---------------------------------------------------*
      ...
      *        * Data acquisizione                                     *
      *        *-------------------------------------------------------*
           05  w-rig-dat-acq              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Data registrazione                                    *
      *        *-------------------------------------------------------*
           05  w-rig-dat-reg              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Totale documento                                      *
      *        *-------------------------------------------------------*
           05  w-rig-tot-doc              pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Un intero record [mgi]                                *
      *        *-------------------------------------------------------*
           05  w-rig-rec-mgi.
      ...
      *        *-------------------------------------------------------*
           05  w-exp-cts-snx.
               10  w-exp-cts-snx-num      pic  9(02)       value 03   .
               10  w-exp-cts-snx-lun      pic  9(02)       value 40   .
               10  w-exp-cts-snx-tbl.
                   15  filler             pic  x(40) value
                            "Tutti i documenti                       ".
                   15  filler             pic  x(40) value
                            "solo quelli Senza data di acquisizione  ".
                   15  filler             pic  x(40) value
                            "solo quelli Con la data di acquisizione ".
      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [mgi]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-mgi.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-mgi-reg      pic  9(07)                  .
               10  w-cmp-rec-mgi-prt      pic  9(07)                  .
      ...
      *                  * Si/no da abbinare                           *
      *                  *---------------------------------------------*
           perform   acc-cts-snx-000      thru acc-cts-snx-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Si/no da abbinare                               *
      *              *-------------------------------------------------*
           perform   vis-cts-snx-000      thru vis-cts-snx-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Si/no da abbinare                           *
      *                  *---------------------------------------------*
           perform   pmt-cts-snx-000      thru pmt-cts-snx-999        .
       pmt-key-reg-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           perform   fnd-arc-mgi-000      thru fnd-arc-mgi-999        .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-cts-snx-lun    to   v-car                  .
           move      w-exp-cts-snx-num    to   v-ldt                  .
           move      "TSC#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-cts-snx-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      11                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-tes-cts-snx        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cts-snx-999.
       acc-cts-snx-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cts-snx          .
       acc-cts-snx-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cts-snx        not  = 01 and
                     w-tes-cts-snx        not  = 02 and
                     w-tes-cts-snx        not  = 03
                     go to acc-cts-snx-100.
       acc-cts-snx-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Accettazione Data acquisizione              *
      *                  *---------------------------------------------*
      ...
      *                  * Data acquisizione                           *
      *                  *---------------------------------------------*
           if        w-rig-dat-acq        =    zero
                     move  "*"            to   w-lin-imm-snx-daq
           else      move  spaces         to   w-lin-imm-snx-daq      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Editing Numero documento                    *
      *                  *---------------------------------------------*
           move      rf-mgi-num-doc       to   w-lin-imm-num-doc      .
       vis-lin-cor-540.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   vis-dat-acq-000      thru vis-dat-acq-999        .
      *              *-------------------------------------------------*
      ...
      *              * Data di acquisizione                            *
      *              *-------------------------------------------------*
           perform   pmt-dat-acq-000      thru pmt-dat-acq-999        .
      *              *-------------------------------------------------*
      *              * Data di registrazione                           *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice fornitore dogana          *
      *    *-----------------------------------------------------------*
       pmt-fnt-rig-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data acquisizione                *
      *    *-----------------------------------------------------------*
       pmt-dat-acq-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data registrazione               *
      *    *-----------------------------------------------------------*
       pmt-dat-reg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data di acquisizione                 *
      *    *-----------------------------------------------------------*
       acc-dat-acq-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Data di acquisizione              *
      *    *-----------------------------------------------------------*
       vis-dat-acq-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Data di registrazione             *
      *    *-----------------------------------------------------------*
       vis-dat-reg-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           if        rf-zcc-tip-doc       =    "F"
                     move  "Fattura nr."  to   w-all-str-cat (1)
           else if   rf-zcc-tip-doc          =    "C"
                     move  "Nota Credito nr."
                                          to   w-all-str-cat (1)
           else if   rf-zcc-tip-doc          =    "D"
                     move  "Nota Debito nr."
                                          to   w-all-str-cat (1)
           else      move  "Nr."          to   w-all-str-cat (1)      .
      *                  *---------------------------------------------*
      *                  * Assemblaggio                                *
      *                  *---------------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      rf-mgi-num-doc       to   w-all-str-cat (2)      .
      ...
      *                  * Data documento minima                       *
      *                  *                                             *
      *                  * N.B.: solo registrazioni dal 2019 in poi    *
      *                  *---------------------------------------------*
           if        w-tes-dat-min        not  = zero
                     go to cnt-tdo-key-800.
           move      1190101              to   w-tes-dat-min          .
       cnt-tdo-key-800.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-dat-acq          .
           move      zero                 to   w-rig-dat-reg          .
      ...
      *                  *---------------------------------------------*
      ...
      -              " esecuzione ---               "
       ...
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Start su [mgi] per data registrazione           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATDOC    "         to   f-key                  .
           move      "F"                  to   rf-mgi-tip-rec         .
           move      w-tes-dat-min        to   rf-mgi-dat-reg         .
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-mgi-dat-reg       >    w-tes-dat-min
                     go to stp-srt-inp-900.
           go to     stp-srt-inp-400.
       stp-srt-inp-340.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-mgi-dat-reg       >    w-tes-dat-max
                     go to stp-srt-inp-900.
           go to     stp-srt-inp-400.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Test su data di acquisizione            *
      *                      *-----------------------------------------*
           go to     stp-srt-inp-422
                     stp-srt-inp-424
                     stp-srt-inp-426
                     depending            on   w-tes-cts-snx          .
       stp-srt-inp-422.
      *                          *-------------------------------------*
      *                          * Se tutti                            *
      *                          *-------------------------------------*
       ...
       stp-srt-inp-424.
      *                          *-------------------------------------*
      *                          * Se senza data di acquisizione       *
      *                          *-------------------------------------*
           if        rf-mgi-dat-acq       not  = zero
                     go to stp-srt-inp-200
           else      go to stp-srt-inp-440.
       stp-srt-inp-426.
      *                          *-------------------------------------*
      *                          * Se con data di acquisizione         *
      *                          *-------------------------------------*
           if        rf-mgi-dat-acq       =    zero
                     go to stp-srt-inp-200
           else      go to stp-srt-inp-440.
       stp-srt-inp-440.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-mgi-cod-arc       not  = w-tes-cod-fnt
                     go to stp-srt-inp-200.
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      rf-mgi-cod-fbd       to   srt-cod-fnt            .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-mgi-dat-reg       to   srt-dat-doc            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      * Fornitore                               *
      *                      *-----------------------------------------*
           move      rf-mgi-cod-arc       to   w-rig-cod-fnt          .
      *                      *-----------------------------------------*
      ...
      *                      * Dati record                             *
      *                      *-----------------------------------------*
           move      rf-mgi               to   w-rig-rec-mgi          .
           move      rf-mgi-dat-acq       to   w-rig-dat-acq          .
      *
           if        rf-mgi-dat-acq       not  numeric
                     move  zero           to   w-rig-dat-acq          .
      *
           move      rf-mgi-dat-reg       to   w-rig-dat-reg          .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-rig-rec-mgi        to   rf-mgi                 .
           move      rf-mgi-dat-reg       to   w-cmp-rec-mgi-reg      .
           move      rf-mgi-num-prt       to   w-cmp-rec-mgi-prt      .
       sca-fil-rap-500.
      *              *-------------------------------------------------*
      *              * Aggiornamento documenti                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Ottenimento record [mgi]                    *
      *                  *---------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "DATPRT    "         to   f-key                  .
           move      w-cmp-rec-mgi-reg    to   rf-mgi-dat-reg         .
           move      w-cmp-rec-mgi-prt    to   rf-mgi-num-prt         .
           move      "pgm/cge/fls/ioc/obj/iofmgi"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
      *                  * Aggiornamento data di acquisizione          *
      *                  *---------------------------------------------*
           move      w-rig-dat-acq        to   rf-mgi-dat-acq         .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [mgi]                         *
      *                  *---------------------------------------------*
