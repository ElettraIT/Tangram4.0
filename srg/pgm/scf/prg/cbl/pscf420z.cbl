      ...
      *                                   Fase:    scf420              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/11/18    *
      ...
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/scf/mov/scf420[sec-att]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
      ...
      *                  *---------------------------------------------*
           ...
           move      w-all-str-cat (7)    to   w-all-str-cat (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Compressione documenti in corso ..."
                                          to   v-alf                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-fdx-dat-inv         .
      *              *-------------------------------------------------*
      *              * Aggiornamento ora invio                         *
      *              *-------------------------------------------------*
           move      s-ora                to   rf-fdx-ora-inv         .
           multiply  100                  by   rf-fdx-ora-inv         .
           add       s-min                to   rf-fdx-ora-inv         .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-fdx-prt-doc       to   rf-sff-num-ftf         .
           move      "pgm/scf/fls/ioc/obj/iofsff"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-sff-drg-cge       to   rf-mgi-dat-reg         .
           move      rf-sff-npr-cge       to   rf-mgi-num-prt         .
           move      "pgm/cge/fls/ioc/obj/iofmgi"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
