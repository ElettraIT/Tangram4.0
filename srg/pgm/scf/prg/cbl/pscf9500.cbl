      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione movimenti per scadenze passive     *
      *                    senza aggiornamenti contabili               *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * Questo programma prepara una variabile globale di i.p.c., con  *
      * nome variabile 'scf300-sub-pgm', e poi richiama e cancella il  *
      * programma 'pscf3000', che riconosce la variabile globale e     *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " MOV. SCADENZE PASS. SENZA AGGIORNAMENTO"       .
      ...
      *    *-----------------------------------------------------------*
       fas-scf-300-000.
      *              *-------------------------------------------------*
      *              * Scrittura variabile di i.p.c. 'scf300-sub-pgm'  *
      *              *-------------------------------------------------*
           move      "PV"                 to   s-ope                  .
