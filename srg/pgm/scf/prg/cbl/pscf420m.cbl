      ...
      *                                   Fase:    scf420              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 11/06/19    *
      *                       Ultima revisione:    NdK del 14/11/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione overlay per il programma scf420  *
      *                                                                *
      *                    Manutenzione distinta di invio              *
      *                                                                *
      *================================================================*
      ...
      *            *---------------------------------------------------*
      *            * Protocollo Iva in chiave                          *
      *            *---------------------------------------------------*
               10  srt-prt-key            pic  9(07)                  .
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " GESTIONE DISTINTA INVIO DOC. FORNITORI "       .
      ...
      *        *-------------------------------------------------------*
      *        * Tipo documento per la fattura elettronica             *
      *        *-------------------------------------------------------*
           05  w-rig-tdo-fel              pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Si/no esito negativo                                  *
      *        *-------------------------------------------------------*
           05  w-rig-snx-esi              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Codice SDI                                            *
      *        *-------------------------------------------------------*
           05  w-rig-cod-sdi              pic  x(07)                  .
      *        *-------------------------------------------------------*
      *        * Indirizzo mail                                        *
      *        *-------------------------------------------------------*
           05  w-rig-ind-eml              pic  x(80)                  .
           05  w-rig-ind-eml-tip          pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Flag di avvenuta preparazione                         *
      *        *-------------------------------------------------------*
           05  w-rig-flg-apr              pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-rag-fnt  pic  x(34)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-tdo-fel  pic  x(04)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-snx-sdi  pic  x(01)                  .
                   15  w-lin-imm-snx-ddi  pic  x(01)                  .
                   15  w-lin-imm-flg-sts  pic  x(01)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-num-doc  pic  x(10)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-snx-blv  pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tdo-fel.
               10  w-exp-tdo-fel-num      pic  9(02)       value 04   .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-snx-inv.
               10  w-exp-snx-inv-num      pic  9(02)       value 02   .
               10  w-exp-snx-inv-lun      pic  9(02)       value 02   .
               10  w-exp-snx-inv-tbl.
                   15  filler             pic  x(02)       value "Si" .
                   15  filler             pic  x(02)       value "No" .
      *        *-------------------------------------------------------*
      *        * Work per : Si/no esito negativo                       *
      *        *-------------------------------------------------------*
           05  w-exp-snx-esi.
               10  w-exp-snx-esi-num      pic  9(02)       value 02   .
               10  w-exp-snx-esi-lun      pic  9(02)       value 02   .
               10  w-exp-snx-esi-tbl.
                   15  filler             pic  x(02)       value "No" .
                   15  filler             pic  x(02)       value "Si" .
      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [fdx]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-fdx.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-fdx-prt      pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Progressivo                                       *
      *            *---------------------------------------------------*
               10  w-cmp-rec-fdx-prg      pic  9(05)                  .
      ...
      *                  * Si/no esito negativo                        *
      *                  *---------------------------------------------*
           perform   acc-snx-esi-000      thru acc-snx-esi-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  *---------------------------------------------*
       ...
       acc-cor-reg-400.
      *                  *---------------------------------------------*
      *                  * Indirizzo mail o SDI                        *
      *                  *---------------------------------------------*
           perform   acc-sdi-eml-000      thru acc-sdi-eml-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Assemblaggio eventuale con dipendenza   *
      *                      *-----------------------------------------*
           move      34                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      w-rig-dpz-fnt        to   w-all-str-cat (1)      .
      *
           if        w-rig-dpz-fnt        = spaces
                     move  spaces         to   w-all-str-cat (2)
           else      move  "-"            to   w-all-str-cat (2)      .
      *
           move      w-rig-cod-fnt-rag    to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      w-all-str-alf        to   w-lin-imm-rag-fnt      .
      *                  *---------------------------------------------*
      *                  * Tipo documento 'sdi'                        *
      *                  *---------------------------------------------*
           move      w-rig-tdo-fel        to   w-lin-imm-tdo-fel      .
       vis-lin-cor-490.
      *                  *---------------------------------------------*
      *                  * Si/no scarto da SDI                         *
      *                  *---------------------------------------------*
           if        w-rig-snx-esi        =    "S"
                     move  "#"            to   w-lin-imm-snx-sdi
           else      move  spaces         to   w-lin-imm-snx-sdi      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Si/no documento da inviare                  *
      *                  *---------------------------------------------*
           if        w-rig-snx-inv        =    "N"
                     move  "n"            to   w-lin-imm-snx-ddi
           else      move  spaces         to   w-lin-imm-snx-ddi      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Status                                      *
      *                  *---------------------------------------------*
           if        rf-fdx-flg-apr       not  = spaces
                     move  "X"            to   w-lin-imm-flg-sts      .
           if        rf-fdx-dat-inv       not  = zero
                     move  ">"            to   w-lin-imm-flg-sts      .
       vis-lin-cor-520.
      *                  *---------------------------------------------*
      *                  * Numero documento                            *
      *                  *---------------------------------------------*
           move      rf-fdx-num-doc       to   w-lin-imm-num-doc      .
       vis-lin-cor-550.
      *                  *---------------------------------------------*
      ...
      *
           if        w-cnt-acc-flg-sws    =    "D"
                     ...
                     move  10             to   v-pos
           else if   w-cnt-acc-flg-sws    =    "R"
                     move  31             to   v-pos
           else      move  65             to   v-pos                  .
      *
           if        w-cnt-acc-flg-sws    =    spaces
                     move  "--"           to   v-alf
           else      move  "\/"           to   v-alf                  .
      *
           call      "swd/mod/prg/obj/mvideo"
      ...
      *              * Si/no esito negativo                            *
      *              *-------------------------------------------------*
           perform   vis-snx-esi-000      thru vis-snx-esi-999        .
      *              *-------------------------------------------------*
      *              * Tipo documento 'sdi'                            *
      *              *-------------------------------------------------*
      ...
      *              * Status documento                                *
      *              *-------------------------------------------------*
           perform   vis-sts-doc-000      thru vis-sts-doc-999        .
      *              *-------------------------------------------------*
      *              * Indirizzo mail o SDI                            *
      *              *-------------------------------------------------*
           perform   vis-sdi-eml-000      thru vis-sdi-eml-999        .
           perform   vis-ind-eml-tip-000  thru vis-ind-eml-tip-999    .
      *              *-------------------------------------------------*
      *              * Estremi documento                               *
      *              *-------------------------------------------------*
      ...
      *              * Si/no esito negativo                            *
      *              *-------------------------------------------------*
           perform   pmt-snx-esi-000      thru pmt-snx-esi-999        .
      *              *-------------------------------------------------*
      *              * Tipo documento 'sdi'                            *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no esito negativo             *
      *    *-----------------------------------------------------------*
       pmt-snx-esi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Tipo documento 'sdi'             *
      *    *-----------------------------------------------------------*
       pmt-tdo-fel-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *
           move      w-lin-pri-lin-vid    to   w-cod-mne-dcf-lin      .
           add       w-lin-num-lin-vis    to   w-cod-mne-dcf-lin      .
           add       1                    to   w-cod-mne-dcf-lin      .
      *
      ...
      *    *===========================================================*
      *    * Accettazione : Si/no esito negativo                       *
      *    *-----------------------------------------------------------*
       acc-snx-esi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-esi-lun    to   v-car                  .
           move      w-exp-snx-esi-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-snx-esi-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
      *
      ...
      *
           move      22                   to   v-pos                  .
      *
           if        w-rig-snx-esi        =    spaces
                     move  01             to   v-num
           else if   w-rig-snx-esi        =    "N"
                     move  01             to   v-num
           else if   w-rig-snx-esi        =    "S"
                     move  02             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-snx-esi-999.
       acc-snx-esi-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   w-rig-snx-esi
           else if   v-num                =    02
                     move  "S"            to   w-rig-snx-esi
           else      move  spaces         to   w-rig-snx-esi          .
       acc-snx-esi-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-rig-flg
                             ...
                             go to acc-snx-esi-100.
       acc-snx-esi-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione : Si/no esito negativo                    *
      *    *-----------------------------------------------------------*
       vis-snx-esi-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-fnd-tdo-fel-tdo    to   w-rig-tdo-fel          .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-rig-tdo-fel        to   w-ctl-tdo-fel-tdo      .
      ...
      *
           if        w-rig-tdo-fel        =    "TD16"
                     move  1              to   v-num
           else if   w-rig-tdo-fel        =    "TD17"
                     move  2              to   v-num
           else if   w-rig-tdo-fel        =    "TD18"
                     move  3              to   v-num
           else if   w-rig-tdo-fel        =    "TD19"
                     move  4              to   v-num
           else      move  zero           to   v-num                  .
      *
           call      "swd/mod/prg/obj/mvideo"
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-inv-lun    to   v-car                  .
           move      w-exp-snx-inv-num    to   v-ldt                  .
           move      "SN#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-snx-inv-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
      *
      ...
      *    *-----------------------------------------------------------*
       vis-sts-doc-000.
      *              *-------------------------------------------------*
      *              * Determinazione status documento                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su Flag di avvenuta preparazione       *
      *                  *---------------------------------------------*
           if        w-rig-flg-apr        not  = spaces
                     move  "{XML}"        to   w-all-str-cat (2)
      ...
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      rf-fdx-dat-inv       to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           if        rf-fdx-dat-inv       not  = zero
                     move  "- invio:"     to   w-all-str-cat (3)
      ...
      *                  * Test su Flag di avvenuta preparazione       *
      *                  *---------------------------------------------*
           if        w-rig-snx-inv        not  = "S"
                     move  "- ANN. INVIO!"
                                          to   w-all-str-cat (5)
           else      move  spaces         to   w-all-str-cat (5)      .
      *                  *---------------------------------------------*
      *                  * Test su Flag di esito dell'invio            *
      *                  *---------------------------------------------*
           if        w-rig-snx-esi        not  = "N"
                     move  "- SCARTATO!"  to   w-all-str-cat (6)
           else      move  spaces         to   w-all-str-cat (6)      .
       vis-sts-doc-200.
      *              *-------------------------------------------------*
      *              * Assemblaggio                                    *
      *              *-------------------------------------------------*
           ...
           move      "Status:"            to   w-all-str-cat (1)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione                                 *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice destinatario o indirizzo mail *
      *    *-----------------------------------------------------------*
       acc-sdi-eml-000.
      *              *-------------------------------------------------*
      *              * Campo attualmente inibito                       *
      *              *-------------------------------------------------*
           go to     acc-sdi-eml-999.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione dei valori rilevati      *
      *              *-------------------------------------------------*
           if        w-rig-ind-eml        not  = spaces
                     perform  acc-ind-eml-000
                                          thru acc-ind-eml-999
           else      perform  acc-cod-sdi-000
                                          thru acc-cod-sdi-999        .
       acc-sdi-eml-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Codice destinatario o indirizzo   *
      *    *                         mail                              *
      *    *-----------------------------------------------------------*
       vis-sdi-eml-000.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione dei valori rilevati      *
      *              *-------------------------------------------------*
           if        w-rig-cod-sdi        not  = spaces
                     perform  vis-cod-sdi-000
                                          thru vis-cod-sdi-999
           else      perform  vis-ind-eml-000
                                          thru vis-ind-eml-999        .
       vis-sdi-eml-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           inspect   w-rig-ind-eml  tallying   w-wrk-ctr-001
                                          for  all "@"                .
           if        w-wrk-ctr-001        =    1
                     go to acc-ind-eml-460
           else if   w-wrk-ctr-001        =    0
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Indirizzo mail, tipo              *
      *    *-----------------------------------------------------------*
       vis-ind-eml-tip-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *
           move      78                   to   v-pos                  .
           move      w-rig-ind-eml-tip    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-ind-eml-tip-999.
           exit.
      ...
      *                      * Test                                    *
      *                      *-----------------------------------------*
           move      w-rig-cod-sdi        to   w-all-str-alf          .
           move      07                   to   w-all-str-lun          .
           perform   all-str-ble-000      thru all-str-ble-999        .
           if        w-all-str-flg        =    spaces
                     go to acc-cod-sdi-600.
      *                      *-----------------------------------------*
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
           move      "Codice SDI non corretto formalmente (contiene spaz
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice SDI                        *
      *    *-----------------------------------------------------------*
       vis-cod-sdi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      03                   to   w-all-str-num          .
           move      rf-fdx-tmo-doc       to   w-all-str-cat (1)      .
           move      rf-fdx-num-doc       to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Editing protocollo SCF                      *
      *                  *---------------------------------------------*
           move      rf-fdx-prt-doc       to   w-wrk-nft-int          .
           move      w-wrk-nfi-saa        to   w-wrk-nfa-saa          .
           move      w-wrk-nfi-npg        to   w-wrk-nfa-npg          .
      *
           move      "ED"                 to   v-ope                  .
           move      "P"                  to   v-tip                  .
           move      06                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      "(scf:"              to   w-all-str-cat (1)      .
           move      "- iva :"            to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      02                   to   w-all-str-num          .
           move      w-all-str-alf        to   w-all-str-cat (1)      .
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-100.
      *              *-------------------------------------------------*
      *              * Test su tipo documento 'sdi'                    *
      *              *-------------------------------------------------*
           if        w-rig-tdo-fel        not  = spaces
                     go to cnt-tdo-rig-800.
           move      "Manca il tipo documento 'TDxx' per la fattura elet
      -              "tronica"            to   w-err-box-err-msg      .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      spaces               to   w-rig-snx-esi          .
           move      spaces               to   w-rig-cod-sdi          .
           move      spaces               to   w-rig-ind-eml          .
           move      spaces               to   w-rig-ind-eml-tip      .
           move      spaces               to   w-rig-flg-apr          .
           move      spaces               to   w-rig-tdo-fel          .
           move      spaces               to   w-rig-rec-fdx          .
       nor-nok-rig-999.
           exit.
      ...
      *                  *---------------------------------------------*
______*    if        w-det-sts-dst-flg    not  = spaces
______*              move  "V"            to   w-cnt-mfu-tip-fun
______*              go to rou-let-reg-999.
      *                  *---------------------------------------------*
      *                  * Modifica                                    *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [fdx]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/scf/fls/ioc/obj/ioffdx"
                                          to   s-pat                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-fdx-dat-doc       to   srt-dat-key            .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-fdx-cod-arc       to   srt-cod-key            .
      *                      *-----------------------------------------*
      *                      * Oltre                                   *
      *                      *-----------------------------------------*
           go to     stp-srt-inp-680.
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-fdx-dpz-arc       to   w-let-arc-dcf-dpz      .
           perform   let-arc-dcf-000      thru let-arc-dcf-999        .
      *
           move      w-let-arc-dcf-rag    to   srt-rag-key            .
           move      zero                 to   srt-prt-key            .
           move      rf-fdx-dat-doc       to   srt-dat-key            .
           move      zero                 to   srt-cod-key            .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       stp-srt-inp-640.
      *                      *-----------------------------------------*
      *                      * Ordinamento per Protocollo Iva          *
      *                      *-----------------------------------------*
           move      spaces               to   srt-rag-key            .
           move      rf-fdx-prt-iva       to   srt-prt-key            .
           move      zero                 to   srt-dat-key            .
           move      zero                 to   srt-cod-key            .
      *                      *-----------------------------------------*
      *                      * Oltre                                   *
      ...
      *                  * Record [fdx]                                *
      *                  *---------------------------------------------*
           move      rf-fdx               to   w-rig-rec-fdx          .
           move      rf-fdx-cod-arc       to   w-rig-cod-fnt          .
           move      rf-fdx-dpz-arc       to   w-rig-dpz-fnt          .
      *
           if        rf-fdx-flg-ain       =    spaces
                     move  "S"            to   w-rig-snx-inv
           else      move  "N"            to   w-rig-snx-inv          .
      *
           if        rf-fdx-flg-esi       =    spaces
                     move  "N"            to   w-rig-snx-esi
           else      move  "S"            to   w-rig-snx-esi          .
      *
           move      rf-fdx-cod-sdi       to   w-rig-cod-sdi          .
           move      rf-fdx-eml-ind       to   w-rig-ind-eml          .
           move      rf-fdx-tip-con       to   w-rig-ind-eml-tip      .
           move      rf-fdx-flg-apr       to   w-rig-flg-apr          .
           move      rf-fdx-tdo-fel       to   w-rig-tdo-fel          .
      *                  *---------------------------------------------*
      *                  * Record [sff]                                *
      *                  *---------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-rig-cod-fnt        to   w-let-arc-dcf-cod      .
      ...
      *                      *-----------------------------------------*
           if        rf-fdx-dat-inv       not  = zero
                     move  "#"            to   w-det-sts-dst-flg
           else      move  spaces         to   w-det-sts-dst-flg      .
       car-fil-rap-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-rig-snx-inv        not  = "N"
                     move  spaces         to   rf-fdx-flg-ain
           else      move  "#"            to   rf-fdx-flg-ain         .
      *              *-------------------------------------------------*
      *              * Aggiornamento tipo documento elettronico        *
      *              *-------------------------------------------------*
           move      w-rig-tdo-fel        to   rf-fdx-tdo-fel         .
      *              *-------------------------------------------------*
      *              * Aggiornamento flag di esito negativo            *
      *              *-------------------------------------------------*
           if        w-rig-snx-esi        =    "N"
                     move  spaces         to   rf-fdx-flg-esi
           else      move  "#"            to   rf-fdx-flg-esi         .
      *              *-------------------------------------------------*
      *              * Aggiornamento indirizzo mail                    *
      *              *-------------------------------------------------*
           if        w-rig-ind-eml        not  = spaces
                     move  w-rig-ind-eml  to   rf-fdx-eml-ind         .
      *              *-------------------------------------------------*
      *              * Aggiornamento codice SDI                        *
      *              *-------------------------------------------------*
           if        w-rig-cod-sdi        not  = spaces
                     move  w-rig-cod-sdi  to   rf-fdx-cod-sdi         .
      *              *-------------------------------------------------*
      *              * Update record [fdx]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/scf/prg/obj/pscf4202"                       .
       cnc-rlt-sup-999.
           exit.
