      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pscf0321:        *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-yop-cod      .
           move      13                   to   w-cod-mne-yop-lin      .
           move      19                   to   w-cod-mne-yop-pos      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-yop-ope      .
           move      rr-cod-max           to   w-cod-mne-yop-cod      .
           move      13                   to   w-cod-mne-yop-lin      .
           move      51                   to   w-cod-mne-yop-pos      .
           move      zero                 to   w-cod-mne-yop-dln      .
           move      zero                 to   w-cod-mne-yop-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
