      ...
      *                                   Fase:    scf310              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 15/10/02    *
      *                       Ultima revisione:    NdK del 15/10/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pscf3101:        *
      *                                                                *
      *                    Controllo incrociato tra saldi desunti da:  *
      *                      - Contabilita'                            *
      *                      - Gestione portafoglio passivo            *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Literal di note sul programma                   *
      *              *-------------------------------------------------*
           perform   pmt-lit-not-000      thru pmt-lit-not-999        .
       pmt-ric-sel-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione prompts per Literal di note sul programma *
      *    *-----------------------------------------------------------*
       pmt-lit-not-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Per ogni fornitore questo programma mette a confro
      -              "nto:                          "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       - Il saldo che si desume dall'analisi dello
      ...
      *
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "e produce uno stampato che evidenzia eventuali dis
      -              "cordanze tra i due dati.      "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      13                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Lo stampato evidenziera' solamente i fornitori per
      -              " i quali c'e' una discordanza,"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *
           ...
           move      16                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       - Identificazione del fornitore            
      -              "                              "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      17                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       - Saldo desunto dalla contabilita'         
      -              "                              "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       - Saldo desunto dalla gestione del portafog
      -              "lio passivo                   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       - Differenza tra i due saldi               
      -              "                              "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
