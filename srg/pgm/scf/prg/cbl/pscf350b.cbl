      ...
      *                       Ultima revisione:    NdK del 03/04/18    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Abbinamento fornitore reale bolle doganali  *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "ABBINAMENTO FORNITORE REALE BOLLE DOGANA"       .
      ...
      *        *-------------------------------------------------------*
      *        * Codice fornitore dogana                               *
      *        *-------------------------------------------------------*
           05  w-rig-cod-dog              pic  9(07)                  .
           05  w-rig-cod-dog-rag          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Codice fornitore                                      *
      *        *-------------------------------------------------------*
           05  w-rig-cod-fbd              pic  9(07)                  .
           05  w-rig-cod-fbd-rag          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Totale documento                                      *
      *        *-------------------------------------------------------*
           ...
           05  w-exp-abb-snx.
               ...
               10  w-exp-abb-snx-tbl.
                   15  filler             pic  x(40) value
                            "Tutti i documenti                       ".
                   15  filler             pic  x(40) value
                            "solo quelli gia' Abbinati               ".
                   15  filler             pic  x(40) value
                            "solo quelli Da abbinare                 ".
      ...
      *                  *---------------------------------------------*
      *                  * Accettazione Codice fornitore dogana        *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Accettazione Codice fornitore reale         *
      *                  *---------------------------------------------*
           perform   acc-cod-fbd-000      thru acc-cod-fbd-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-fbd-rag    to   w-lin-imm-rag-fnt      .
       vis-lin-cor-490.
      *                  *---------------------------------------------*
      *                  * Si/no abbinato                              *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   vis-cod-fbd-000      thru vis-cod-fbd-999        .
           perform   vis-cod-fbd-rag-000  thru vis-cod-fbd-rag-999    .
      *              *-------------------------------------------------*
      *              * Estremi documento                               *
      *              *-------------------------------------------------*
      ...
      *              * Codice fornitore reale                          *
      *              *-------------------------------------------------*
           perform   pmt-cod-fbd-000      thru pmt-cod-fbd-999        .
      *              *-------------------------------------------------*
      *              * Estremi documento                               *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice fornitore reale           *
      *    *-----------------------------------------------------------*
       pmt-cod-fbd-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-fbd        to   w-sav-cod-fnt          .
       acc-fnt-rig-100.
      *              *-------------------------------------------------*
      *              * Ripristino valore precedente                    *
      *              *-------------------------------------------------*
           move      w-sav-cod-fnt        to   w-rig-cod-fbd          .
       acc-fnt-rig-125.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "AC"                 to   w-cod-mne-dcf-ope      .
           move      w-rig-cod-dog        to   w-cod-mne-dcf-cod      .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-rig-cod-fbd        =    zero
                     go to acc-fnt-rig-320.
      *                  *---------------------------------------------*
      *                  * Box di espansione                           *
      *                  *---------------------------------------------*
           move      w-rig-cod-dog        to   w-rou-exp-ana-cod      .
      ...
      *    *-----------------------------------------------------------*
       vis-fnt-rig-rag-000.
           ...
           move      18                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-dog-rag    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-fnt-rig-rag-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione campo : Fornitore reale                      *
      *    *-----------------------------------------------------------*
       acc-cod-fbd-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-dcf-ope      .
           move      w-rig-cod-fbd        to   w-cod-mne-dcf-cod      .
       ...
       acc-cod-fbd-110.
           perform   cod-mne-dcf-cll-000  thru cod-mne-dcf-cll-999    .
           if        w-cod-mne-dcf-ope    =    "F+"
                     go to acc-cod-fbd-115.
           if        w-cod-mne-dcf-ope    =    "AC"
                     go to acc-cod-fbd-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-fbd-115.
           perform   cod-mne-dcf-foi-000  thru cod-mne-dcf-foi-999    .
           go to     acc-cod-fbd-110.
       acc-cod-fbd-120.
           move      w-cod-mne-dcf-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-cod-fbd-999.
       acc-cod-fbd-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-cod-fbd          .
       acc-cod-fbd-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura archivio [dcf]                      *
      *                  *---------------------------------------------*
           move      w-rig-cod-fbd        to   w-let-arc-dcf-fnt      .
           move      spaces               to   w-let-arc-dcf-dpz      .
           perform   let-arc-dcf-000      thru let-arc-dcf-999        .
           move      w-let-arc-dcf-rag    to   w-rig-cod-fbd-rag      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione                             *
      *                  *---------------------------------------------*
           perform   vis-cod-fbd-rag-000  thru vis-cod-fbd-rag-999    .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice fornitore reale                  *
      *    *-----------------------------------------------------------*
       vis-cod-fbd-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Fornitore reale, ragione sociale        *
      *    *-----------------------------------------------------------*
       vis-cod-fbd-rag-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      19                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-fbd-rag    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-fbd-rag-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      zero                 to   w-rig-cod-dog          .
           move      spaces               to   w-rig-cod-dog-rag      .
           move      zero                 to   w-rig-cod-fbd          .
           move      spaces               to   w-rig-cod-fbd-rag      .
      ...
      *                      * Fornitore Dogana                        *
      *                      *-----------------------------------------*
           move      w-tes-cod-fnt        to   w-rig-cod-dog          .
           move      w-tes-cod-fnt-rag    to   w-rig-cod-dog-rag      .
      *                      *-----------------------------------------*
      ...
      *
           if        rf-mgi-cod-fbd       not  numeric
                     move  zero           to   rf-mgi-cod-fbd         .
      *
           move      rf-mgi-cod-fbd       to   w-rig-cod-fbd          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Aggiornamento fornitore reale               *
      *                  *---------------------------------------------*
           move      w-rig-cod-fbd        to   rf-mgi-cod-fbd         .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [mgi]                         *
      *                  *---------------------------------------------*
