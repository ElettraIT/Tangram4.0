      ...
      *                                   Fase:    scf960              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/03/06    *
      *                       Ultima revisione:    NdK del 05/01/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Storno forzato scadenze fornitori aperte    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STORNO FORZATO SCADENZE FORNITORI APERTE"       .
      ...
      *              *-------------------------------------------------*
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Fino alla data di scadenza :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "N.B.: Il programma pone a stato di 'stornata' tutt
      -              "e le scadenze fornitori ancora"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "      aperte ad oggi, cioe' non ancora pagate.    
      -              "                              "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Selezione ulteriore su data scadenza se     *
      *                  * 'a vista'                                   *
      *                  *---------------------------------------------*
           if        rf-sfs-dts-scf       >    zero
                     go to stp-srt-inp-320.
           if        rf-sfs-dtr-rgs       >    rr-dat-max
      ...
      *                  *---------------------------------------------*
      *                  * Test se scadenza fornitore aperta           *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Visualizzazione contatore scadenze da stornare  *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      07                   to   v-car                  .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessuna scadenza fornitore da stornare !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Storno scadenza fornitore aperta                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-num-scf          to   rf-sfs-num-scf         .
           move      "pgm/scf/fls/ioc/obj/iofsfs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *
           ...
           else      move  rf-sfs-dts-scf to   v-dat                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "Scadenza - N.:"     to   w-all-str-cat (1)      .
           move      rf-sfs-num-scf
                    (6 : 6)               to   w-all-str-cat (2)      .
           move      "al"                 to   w-all-str-cat (3)      .
           move      v-edt                to   w-all-str-cat (4)      .
           move      "- STORNATA"         to   w-all-str-cat (5)      .
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-sfs                 .
      *              *-------------------------------------------------*
      *              * Incremento contatore records stornati           *
      *              *-------------------------------------------------*
           add       1                    to   w-prn-ctr-rcn          .
      *              *-------------------------------------------------*
      *              * Visualizzazione numero scadenze stornate        *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      07                   to   v-car                  .
