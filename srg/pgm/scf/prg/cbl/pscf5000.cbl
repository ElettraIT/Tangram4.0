      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pscf5001:        *
      *                                                                *
      *                    Lista scadenze fornitori per data           *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Si/No anche scadenze bloccate                         *
      *        *-------------------------------------------------------*
           05  rr-snx-scb                 pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Codice nostra banca                                   *
      *        *-------------------------------------------------------*
           05  rr-cod-cbp                 pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Codice nostra banca, descrizione                      *
      *        *-------------------------------------------------------*
           05  rr-cod-cbp-des             pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Tipi ordinamento fornitori                            *
      *        *                                                       *
      *        * - 01 : per Ragione sociale                            *
      *        * - 02 : per Priorita' di pagamento                     *
      *        *-------------------------------------------------------*
           05  rr-tip-ord                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Si/No emissione archivio                              *
      *        *                                                       *
      *        * - 01 : No                                             *
      *        * - 02 : Si, con stampa                                 *
      *        * - 03 : Si, senza stampa                               *
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Tipordinamento fornitori                   *
      *        *-------------------------------------------------------*
           05  w-exp-tip-ord.
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-650.
      *                  *---------------------------------------------*
      *                  * Si/No scadenze bloccate                     *
      *                  *---------------------------------------------*
           perform   acc-snx-scb-000      thru acc-snx-scb-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
                     go to acc-ric-sel-400.
      ...
      *              * Si/No scadenze bloccate                         *
      *              *-------------------------------------------------*
           perform   pmt-snx-scb-000      thru pmt-snx-scb-999        .
      *              *-------------------------------------------------*
      *              * Prompt codice nostra banca                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Visualizzazione descrizione nostra banca        *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Si/No scadenze bloccate       *
      *    *-----------------------------------------------------------*
       pmt-snx-scb-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-cod-cbp-000.
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su nostra banca  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-cod-cbp-999.
      ...
      *    *-----------------------------------------------------------*
       pmt-tip-ord-000.
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Ordinamento dei fornitori  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tip-ord-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Si/No emissione archivio      *
      *    *-----------------------------------------------------------*
       pmt-snx-exp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/No tipo scadenza da includere     *
      *    *-----------------------------------------------------------*
       acc-snx-tsc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Si/No tipo scadenza da includere  *
      *    *-----------------------------------------------------------*
       vis-snx-tsc-000.
      *              *-------------------------------------------------*
      *              * Ciclo                                           *
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/No scadenze a vista               *
      *    *-----------------------------------------------------------*
       acc-snx-scv-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Si/No scadenze bloccate    *
      *    *-----------------------------------------------------------*
       acc-snx-scb-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-scb-999.
       acc-snx-scb-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "S"            to   rr-snx-scb
           else if   v-num                =    02
                     move  "N"            to   rr-snx-scb
           else      move  spaces         to   rr-snx-scb             .
       acc-snx-scb-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/No emissione archivio             *
      *    *-----------------------------------------------------------*
       acc-snx-exp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
