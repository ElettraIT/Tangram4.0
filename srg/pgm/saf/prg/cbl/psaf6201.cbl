      ...
      *                       Ultima revisione:    NdK del 07/01/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psaf6201:       *
      *                                                                *
      *                    Stampa statistica di acquisto su fatturato  *
      *                    per classe statistica prodotto - fornitore  *
      *                                                                *
      *================================================================*
      ...
      *                *-----------------------------------------------*
      *                * Tipo record                                   *
      *                *   01 : Totale per classe statistica prodotto  *
      *                *   02 : Totale per fornitore                   *
      *                *-----------------------------------------------*
                   15  kk0-tip-rec        pic  9(02)                  .
      *                *-----------------------------------------------*
      *                * Codice numerico classe statistica prodotto    *
      *                *-----------------------------------------------*
                   15  kk0-cod-csp        pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Codice fornitore                              *
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Subchiave 1 : Per classe statistica prodotto      *
      *            *---------------------------------------------------*
               10  srt-k01.
      *                *-----------------------------------------------*
      *                * Valore ABC                                    *
      *                *                                               *
      *                * Solo per tipo ordinamento classe :            *
      *                *                                               *
      ...
      *                *-----------------------------------------------*
      *                * Flag di codice classe diverso da zero ma non  *
      *                * trovato in archivio codici classi statistiche *
      *                *                                               *
      *                *   - 1 : Esistente                             *
      *                *   - 5 : Non esistente                         *
      *                *   - 9 : Codice a zero                         *
      ...
      *                * - ABC crescente sul fatturato                 *
      *                * - ABC crescente sulla quantita'               *
      *                * - Per descrizione classe                      *
      *                * - Per mnemonico classe                        *
      *                *-----------------------------------------------*
                   15  srt-k01-flg-eon    pic  9(01)                  .
      *                *-----------------------------------------------*
      *                * Descrizione classe statistica prodotto        *
      *                *                                               *
      *                * Solo per tipo ordinamento classe :            *
      *                *                                               *
      *                * - ABC decrescente sul fatturato               *
      ...
      *                *-----------------------------------------------*
      *                * Mnemonico per classe statistica prodotto      *
      *                *                                               *
      *                * Solo per tipo ordinamento classe :            *
      *                *                                               *
      *                * - Per mnemonico                               *
      *                *-----------------------------------------------*
                   15  srt-k01-mne-csp    pic  x(05)                  .
      *                *-----------------------------------------------*
      *                * Flag di codice classe statistica a zero o di- *
      *                * verso da zero                                 *
      *                *                                               *
      ...
      *                *-----------------------------------------------*
      *                * Numero di sequenza per la classe statistica   *
      *                * prodotto                                      *
      *                *                                               *
      *                * Solo per tipo ordinamento classe :            *
      *                *                                               *
      *                * - Per numero di sequenza                      *
      *                *-----------------------------------------------*
                   15  srt-k01-nsq-csp    pic  9(07)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica prodotto             *
      *                *                                               *
      *                * Per tutti i tipi ordinamento classe           *
      *                *-----------------------------------------------*
                   15  srt-k01-cod-csp    pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Subchiave 2 : Per fornitore                       *
      *            *---------------------------------------------------*
               10  srt-k02.
      *                *-----------------------------------------------*
      *                * Valore ABC                                    *
      ...
      *            *---------------------------------------------------*
               10  srt-cod-csp.
      *                *-----------------------------------------------*
      *                * Codice classe statistica, codice              *
      *                *-----------------------------------------------*
                   15  srt-cod-csp-cod    pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica, descrizione         *
      *                *-----------------------------------------------*
                   15  srt-cod-csp-des    pic  x(40)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica, mnemonico           *
      *                *-----------------------------------------------*
                   15  srt-cod-csp-mne    pic  x(05)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica, numero di sequenza  *
      *                *-----------------------------------------------*
                   15  srt-cod-csp-nsq    pic  9(07)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica, flag di esistenza   *
      *                *-----------------------------------------------*
                   15  srt-cod-csp-flg    pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice fornitore                                  *
      *            *---------------------------------------------------*
               10  srt-cod-fnt.
      ...
      *                *-----------------------------------------------*
      *                * Codice prodotto, codice statistico 1          *
      *                *-----------------------------------------------*
                   15  srt-cod-pro-s01    pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Codice prodotto, codice statistico 2          *
      *                *-----------------------------------------------*
                   15  srt-cod-pro-s02    pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Codice prodotto, codice statistico 3          *
      *                *-----------------------------------------------*
                   15  srt-cod-pro-s03    pic  9(05)                  .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  srt-val-abc.
      *                *-----------------------------------------------*
      *                * Valore ABC per la classe statistica prodotto  *
      *                *-----------------------------------------------*
                   15  srt-val-abc-csp    pic s9(13)v9(03)            .
      *                *-----------------------------------------------*
      *                * Valore ABC per il fornitore nell'ambito della *
      *                * classe statistica prodotto                    *
      *                *-----------------------------------------------*
                   15  srt-val-abc-fnt    pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "ACQUISTATO PER CLASSE PROD. - FORNITORE "       .
      ...
      *        *-------------------------------------------------------*
      *        * Tipo classe statistica prodotto selezionata           *
      *        *  - 01 : Codice statistico 1                           *
      *        *  - 02 : Codice statistico 2                           *
      *        *  - 03 : Codice statistico 3                           *
      *        *  - 11 : Classe merceologica                           *
      *        *-------------------------------------------------------*
           05  rr-tcs-pro                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Codice classe statistica prodotto selezionata         *
      *        *  - Se codice zero : Tutte le classi                   *
      *        *-------------------------------------------------------*
           05  rr-cod-csp                 pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice classe statistica prodotto selezionata, de-    *
      *        * scrizione                                             *
      *        *  - Se codice zero : 'Tutte le classi'                 *
      *        *-------------------------------------------------------*
           05  rr-cod-csp-des             pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Tipo di dettaglio di stampa                           *
      *        *  - 01 : Solo il totale per ogni fornitore             *
      *        *  - 02 : Con lista documenti emessi per ogni fornitore *
      *        *-------------------------------------------------------*
           05  rr-tip-dts                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Tipo di ordinamento per la classe statistica prodotto *
      ...
      *        *  - 07 : Ordinamento per mnemonico classe              *
      *        *  - 08 : Ordinamento per numero di sequenza classe     *
      *        *                                                       *
      *        * Nota : L'opzione 08 e' ammessa solamente se il tipo   *
      *        *        di classe statistica selezionata corrisponde   *
      *        *        a 11, ovvero per classe merceologica prodotto  *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-let.
      *        *-------------------------------------------------------*
      *        * Work per Let su classificatori statistici prodotto    *
      *        *-------------------------------------------------------*
           05  w-let-arc-csp.
               10  w-let-arc-csp-tip      pic  9(02)     value zero   .
               10  w-let-arc-csp-cod      pic  9(05)     value zero   .
               10  w-let-arc-csp-flg      pic  x(01)     value spaces .
               10  w-let-arc-csp-des      pic  x(40)     value spaces .
               10  w-let-arc-csp-mne      pic  x(05)     value spaces .
               10  w-let-arc-csp-nsq      pic  9(07)     value zero   .
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [zp1]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-zp1.
               10  w-let-arc-zp1-cod      pic  9(05)     value zero   .
               ...
               10  w-let-arc-zp1-nsq      pic  9(07)     value zero   .
               10  w-let-arc-zp1-exc      pic  9(05)     value zero   .
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [zps], tipo record 01        *
      *        *-------------------------------------------------------*
           05  w-let-arc-s01.
               10  w-let-arc-s01-cod      pic  9(05)     value zero   .
               10  w-let-arc-s01-flg      pic  x(01)     value spaces .
               10  w-let-arc-s01-des      pic  x(20)     value spaces .
               10  w-let-arc-s01-mne      pic  x(05)     value spaces .
               10  w-let-arc-s01-exc      pic  9(05)     value zero   .
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [zps], tipo record 02        *
      *        *-------------------------------------------------------*
           05  w-let-arc-s02.
               10  w-let-arc-s02-cod      pic  9(05)     value zero   .
               10  w-let-arc-s02-flg      pic  x(01)     value spaces .
               10  w-let-arc-s02-des      pic  x(20)     value spaces .
               10  w-let-arc-s02-mne      pic  x(05)     value spaces .
               10  w-let-arc-s02-exc      pic  9(05)     value zero   .
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [zps], tipo record 03        *
      *        *-------------------------------------------------------*
           05  w-let-arc-s03.
               10  w-let-arc-s03-cod      pic  9(05)     value zero   .
               10  w-let-arc-s03-flg      pic  x(01)     value spaces .
               10  w-let-arc-s03-des      pic  x(20)     value spaces .
               10  w-let-arc-s03-mne      pic  x(05)     value spaces .
               10  w-let-arc-s03-exc      pic  9(05)     value zero   .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-rot-l02.
      *            *---------------------------------------------------*
      *            * Codice numerico della classe statistica prodotto  *
      *            *---------------------------------------------------*
               10  w-rot-l02-cod-csp      pic  9(05)                  .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-liv-fnt-flg-umi      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore dell' unita' di misura memorizzata         *
      *            *---------------------------------------------------*
               10  w-liv-fnt-val-umi      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Flag di numero decimali memorizzati               *
      *            *---------------------------------------------------*
               10  w-liv-fnt-flg-dec      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore del numero decimali memorizzati            *
      *            *---------------------------------------------------*
               10  w-liv-fnt-val-dec      pic  9(01)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' 1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-fnt-qta-p1r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-liv-fnt-qta-p2r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-liv-fnt-qta-p3r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      ...
      *            * Codice numerico della classe statistica prodotto  *
      *            *---------------------------------------------------*
               10  w-liv-csp-cod-csp      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice mnemonico per la classe                    *
      *            *---------------------------------------------------*
               10  w-liv-csp-mne-csp      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Descrizione per la classe                         *
      *            *---------------------------------------------------*
               10  w-liv-csp-des-csp      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Numero di dequenza per la classe                  *
      *            *---------------------------------------------------*
               10  w-liv-csp-nsq-csp      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Flag di unita' di misura memorizzata              *
      *            *---------------------------------------------------*
               10  w-liv-csp-flg-umi      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore dell' unita' di misura memorizzata         *
      *            *---------------------------------------------------*
               10  w-liv-csp-val-umi      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Flag di numero decimali memorizzati               *
      *            *---------------------------------------------------*
               10  w-liv-csp-flg-dec      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore del numero decimali memorizzati            *
      *            *---------------------------------------------------*
               10  w-liv-csp-val-dec      pic  9(01)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' 1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csp-qta-p1r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale fatturato 1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csp-tot-p1r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' 2. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csp-qta-p2r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale fatturato 2. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csp-tot-p2r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Totale quantita' 3. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csp-qta-p3r      pic s9(13)v9(03)            .
      *            *---------------------------------------------------*
      *            * Totale fatturato 3. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csp-tot-p3r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Numero fornitori trattati per la classe           *
      *            *---------------------------------------------------*
               10  w-liv-csp-num-fnt      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *            *---------------------------------------------------*
      *            * Numero di classi statistiche prodotto trattate in *
      *            * totale                                            *
      *            *---------------------------------------------------*
               10  w-liv-gen-num-csp      pic  9(11)                  .
      *            *---------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Work per personalizzazione 'pgm/saf/[snx-tqn]'            *
      *    *-----------------------------------------------------------*
       01  w-prs-saf-tqn.
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Work per selezione su record [fft] in esame               *
      *    *-----------------------------------------------------------*
       01  w-sel-fft.
      *        *-------------------------------------------------------*
      *        * Flag di uscita                                        *
      ...
      *        *-------------------------------------------------------*
           05  w-sel-fft-flg-exi          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Contatore di comodo su dipendenze selezionate         *
      *        *-------------------------------------------------------*
           05  w-sel-fft-ctr-dpz          pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Codice fornitore                                      *
      *        *-------------------------------------------------------*
           05  w-sel-fft-cod-fnt          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice dipendenza per il fornitore                    *
      *        *-------------------------------------------------------*
           05  w-sel-fft-dpz-fnt          pic  x(04)                  .
      *        *-------------------------------------------------------*
      *        * Mnemonico per il fornitore                            *
      *        *-------------------------------------------------------*
           05  w-sel-fft-mne-fnt          pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Ragione sociale per il fornitore                      *
      *        *-------------------------------------------------------*
           05  w-sel-fft-rag-fnt          pic  x(40)                  .

      *    *===========================================================*
      *    * Work per selezione su record [ffr] in esame               *
      *    *-----------------------------------------------------------*
       01  w-sel-ffr.
      *        *-------------------------------------------------------*
      *        * Flag di uscita                                        *
      ...
      *        *   - #      : Selezione non superata                   *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-flg-exi          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Codice prodotto numerico                              *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-num-pro          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice prodotto alfanumerico                          *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-alf-pro          pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione prodotto                                  *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-des-pro          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Unita' di misura di vendita per il prodotto           *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-umi-pro          pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Numero decimali quantita' per il prodotto             *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-dec-pro          pic  9(01)                  .
      *        *-------------------------------------------------------*
      *        * Classe merceologica del prodotto                      *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-cla-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Gruppo merceologico del prodotto                      *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-gru-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Sottogruppo merceologico del prodotto                 *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-sgr-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice statistico 1 del prodotto                      *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-s01-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice statistico 2 del prodotto                      *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-s02-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice statistico 3 del prodotto                      *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-s03-pro          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Classe statistica, codice numerico                    *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-cod-csp          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Classe statistica, descrizione                        *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-des-csp          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Classe statistica, mnemonico                          *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-mne-csp          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Classe statistica, numero di sequenza                 *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-nsq-csp          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Classe statistica, flag di esistenza                  *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-flg-csp          pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           perform   prs-saf-tqn-000      thru prs-saf-tqn-999        .
      *              *-------------------------------------------------*
      *              * Lettura della personalizzazione per il tratta-  *
      ...
      *                      * Parametri letti in area di lavoro       *
      *                      *-----------------------------------------*
           move      s-alf                to   w-prs-saf-tqn          .
      *                      *-----------------------------------------*
      *                      * A regolarizzazione parametri            *
      *                      *-----------------------------------------*
           go to     prs-saf-tqn-700.
       prs-saf-tqn-500.
      *              *-------------------------------------------------*
      *              * Personalizzazione per tutte le fasi gestionali  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-prs-saf-tqn-snx    not  = "N"
                     move  "S"            to   w-prs-saf-tqn-snx      .
       prs-saf-tqn-800.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prs-saf-tqn-999.
       prs-saf-tqn-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      i-ide-fas            to   w-mod-ffo-ffr-fas      .
           perform   mod-ffo-ffr-opn-000  thru mod-ffo-ffr-opn-999    .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      i-ide-fas            to   w-mod-not-saf-fas      .
           move      rr                   to   w-mod-not-saf-war      .
           if        rr-num-pdr           =    11 or
                     rr-num-pdr           =    12
                     move  01             to   w-mod-not-saf-npr
           else      move  rr-num-pdr     to   w-mod-not-saf-npr      .
           perform   mod-not-saf-opn-000  thru mod-not-saf-opn-999    .
      *              *-------------------------------------------------*
      *              * [zp1]                                           *
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
      ...
      *              * fatturato da Righe Documenti                    *
      *              *-------------------------------------------------*
           perform   mod-ffo-ffr-cls-000  thru mod-ffo-ffr-cls-999    .
      *              *-------------------------------------------------*
      *              * Close modulo per la determinazione del valore   *
      *              * della voce 'Note' da esporre sulle statistiche  *
      *              * di vendita sul fatturato da Testate Documenti   *
      *              *-------------------------------------------------*
           perform   mod-not-saf-cls-000  thru mod-not-saf-cls-999    .
      *              *-------------------------------------------------*
      *              * [zp1]                                           *
      *              *-------------------------------------------------*
           move      "CL"                 to   f-ope                  .
      ...
      *                  * vio [ffr]                                   *
      *                  *---------------------------------------------*
           perform   fil-ffr-ing-000      thru fil-ffr-ing-999        .
       stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Lettura sequenziale archivio [ffr]          *
      *                  *---------------------------------------------*
           perform   fil-ffr-get-000      thru fil-ffr-get-999        .
      *                  *---------------------------------------------*
      *                  * Se fine file : ad uscita                    *
      *                  *---------------------------------------------*
           if        w-mod-ffo-ffr-flg    not  = spaces
                     go to stp-srt-inp-250.
      *                  *---------------------------------------------*
      *                  * Se quantita' e fatturato sono entrambi a    *
      *                  * zero : si ignora il record                  *
      *                  *---------------------------------------------*
           if        w-mod-ffo-ffr-qta    =    zero and
                     w-mod-ffo-ffr-val    =    zero
      ...
      *                  * ra il record                                *
      *                  *---------------------------------------------*
           if        w-mod-ffo-ffr-pon    not  = "P" and
                     w-mod-ffo-ffr-pon    not  = "N"
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      ...
      *                  * cord                                        *
      *                  *---------------------------------------------*
           if        w-mod-ffo-ffr-sn1    not  = "S" and
                     w-mod-ffo-ffr-sn2    not  = "S" and
                     w-mod-ffo-ffr-sn3    not  = "S"
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Selezione sul record [fft] in esame         *
      *                  *---------------------------------------------*
           perform   sel-fft-rec-000      thru sel-fft-rec-999        .
      *                  *---------------------------------------------*
      *                  * Se selezione non superata : si  ignora il   *
      *                  * record                                      *
      *                  *---------------------------------------------*
           if        w-sel-fft-flg-exi    not  = spaces
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Selezione sul record [ffr] in esame         *
      *                  *---------------------------------------------*
           perform   sel-ffr-rec-000      thru sel-ffr-rec-999        .
      *                  *---------------------------------------------*
      *                  * Se selezione non superata : si  ignora il   *
      *                  * record                                      *
      *                  *---------------------------------------------*
           if        w-sel-ffr-flg-exi    not  = spaces
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Inizializzazione lettura sequenziale archivio [ffr]       *
      *    *-----------------------------------------------------------*
       fil-ffr-ing-000.
      *              *-------------------------------------------------*
      *              * Richiamo funzione 'GS' del modulo 'mffoffr0'    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione                                *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-num-pdr           =    11 or
                     rr-num-pdr           =    12
                     move  02             to   w-mod-ffo-ffr-npr
           else if   rr-num-pdr           =    21 or
                     rr-num-pdr           =    22
                     move  01             to   w-mod-ffo-ffr-npr
           else      move  rr-num-pdr     to   w-mod-ffo-ffr-npr      .
      *                      *-----------------------------------------*
      *                      * Tipo calcolo voce 'Costo del Fatturato' *
      *                      *-----------------------------------------*
           if        rr-num-pdr           =    21
                     move  "P"            to   w-mod-ffo-ffr-ccf
           else if   rr-num-pdr           =    22
                     move  "U"            to   w-mod-ffo-ffr-ccf
           else      move  spaces         to   w-mod-ffo-ffr-ccf      .
      *                      *-----------------------------------------*
      *                      * 1. periodo, data min                    *
      *                      *-----------------------------------------*
           move      rr-p1d-min           to   w-mod-ffo-ffr-p1i      .
      *                      *-----------------------------------------*
      *                      * 1. periodo, data max                    *
      *                      *-----------------------------------------*
           move      rr-p1d-max           to   w-mod-ffo-ffr-p1f      .
      *                      *-----------------------------------------*
      *                      * 2. periodo, data min                    *
      *                      *-----------------------------------------*
           move      rr-p2d-min           to   w-mod-ffo-ffr-p2i      .
      *                      *-----------------------------------------*
      *                      * 2. periodo, data max                    *
      *                      *-----------------------------------------*
           move      rr-p2d-max           to   w-mod-ffo-ffr-p2f      .
      *                      *-----------------------------------------*
      *                      * 3. periodo, data min                    *
      *                      *-----------------------------------------*
           move      rr-p3d-min           to   w-mod-ffo-ffr-p3i      .
      *                      *-----------------------------------------*
      *                      * 3. periodo, data max                    *
      *                      *-----------------------------------------*
           move      rr-p3d-max           to   w-mod-ffo-ffr-p3f      .
      *                  *---------------------------------------------*
      *                  * Chiamata modulo                             *
      *                  *---------------------------------------------*
           perform   mod-ffo-ffr-gts-000  thru mod-ffo-ffr-gts-999    .
       fil-ffr-ing-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       fil-ffr-get-000.
      *              *-------------------------------------------------*
      *              * Richiamo funzione 'GT' del modulo 'mffoffr0'    *
      *              *-------------------------------------------------*
           perform   mod-ffo-ffr-get-000  thru mod-ffo-ffr-get-999    .
       fil-ffr-get-999.
           exit.

      *    *===========================================================*
      *    * Selezioni su record [fft] in esame                        *
      *    *-----------------------------------------------------------*
       sel-fft-rec-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-dpz-inu           not  = zero
                     go to sel-fft-rec-010
           else if   rr-dpz-ctr-dpz       =    rr-dpz-ctr-sel
                     go to sel-fft-rec-015
           else      go to sel-fft-rec-020.
       sel-fft-rec-010.
      *                  *---------------------------------------------*
      *                  * Se una sola dipendenza selezionata          *
      *                  *---------------------------------------------*
           if        rf-fft-cod-dpz       =    rr-dpz-inu
                     go to sel-fft-rec-100
           else      go to sel-fft-rec-900.
       sel-fft-rec-015.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-sel-fft-ctr-dpz      .
       sel-fft-rec-025.
           add       1                    to   w-sel-fft-ctr-dpz      .
           if        w-sel-fft-ctr-dpz    >    rr-dpz-ctr-sel
                     go to sel-fft-rec-900.
           if        rf-fft-cod-dpz       =    rr-dpz-ele-cod
                                              (w-sel-fft-ctr-dpz)
                     go to sel-fft-rec-100
           else      go to sel-fft-rec-025.
       sel-fft-rec-100.
      *              *-------------------------------------------------*
      ...
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           move      rf-fft-cod-arc       to   w-let-fnt-dcf-fnt      .
           move      rf-fft-dpz-arc       to   w-let-fnt-dcf-dpz      .
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-fnt    to   w-sel-fft-cod-fnt      .
      *                      *-----------------------------------------*
      *                      * Codice dipendenza per il fornitore      *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-dpz    to   w-sel-fft-dpz-fnt      .
      *                      *-----------------------------------------*
      *                      * Ragione sociale per il fornitore        *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-rag    to   w-sel-fft-rag-fnt      .
      *                      *-----------------------------------------*
      *                      * Mnemonico per il fornitore              *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-mne    to   w-sel-fft-mne-fnt      .
       sel-fft-rec-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      spaces               to   w-sel-fft-flg-exi      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     sel-fft-rec-999.
       sel-fft-rec-900.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Selezioni su record [ffr] in esame                        *
      *    *-----------------------------------------------------------*
       sel-ffr-rec-000.
      *              *-------------------------------------------------*
      ...
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           move      rf-ffr-num-mag       to   w-let-arc-dcp-cod      .
      ...
      *                      * Codice prodotto numerico                *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-cod    to   w-sel-ffr-num-pro      .
      *                      *-----------------------------------------*
      *                      * Codice prodotto alfanumerico            *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-alf    to   w-sel-ffr-alf-pro      .
      *                      *-----------------------------------------*
      *                      * Descrizione prodotto                    *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-des    to   w-sel-ffr-des-pro      .
      *                      *-----------------------------------------*
      *                      * Unita' di misura di vendita per il pro- *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-umi    to   w-sel-ffr-umi-pro      .
      *                      *-----------------------------------------*
      *                      * Numero decimali quantita' per il pro-   *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-dec    to   w-sel-ffr-dec-pro      .
      *                      *-----------------------------------------*
      *                      * Classe merceologica del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-cla    to   w-sel-ffr-cla-pro      .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-gru    to   w-sel-ffr-gru-pro      .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico del prodotto   *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-sgr    to   w-sel-ffr-sgr-pro      .
      *                      *-----------------------------------------*
      *                      * Codice statistico 1 del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-s01    to   w-sel-ffr-s01-pro      .
      *                      *-----------------------------------------*
      *                      * Codice statistico 2 del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-s02    to   w-sel-ffr-s02-pro      .
      *                      *-----------------------------------------*
      *                      * Codice statistico 3 del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-s03    to   w-sel-ffr-s03-pro      .
       sel-ffr-rec-200.
      *              *-------------------------------------------------*
      *              * Lettura classe statistica                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           if        rr-tcs-pro           =    01
                     move  01             to   w-let-arc-csp-tip
                     move  w-let-arc-dcp-s01
                                          to   w-let-arc-csp-cod
           else if   rr-tcs-pro           =    02
                     move  02             to   w-let-arc-csp-tip
                     move  w-let-arc-dcp-s02
                                          to   w-let-arc-csp-cod
           else if   rr-tcs-pro           =    03
                     move  03             to   w-let-arc-csp-tip
                     move  w-let-arc-dcp-s03
                                          to   w-let-arc-csp-cod
           else      move  11             to   w-let-arc-csp-tip
                     move  w-let-arc-dcp-cla
                                          to   w-let-arc-csp-cod      .
           perform   let-arc-csp-000      thru let-arc-csp-999        .
      *                  *---------------------------------------------*
      *                  * Dati letti in area di comodo                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Classe statistica, codice numerico      *
      *                      *-----------------------------------------*
           move      w-let-arc-csp-cod    to   w-sel-ffr-cod-csp      .
      *                      *-----------------------------------------*
      *                      * Classe statistica, descrizione          *
      *                      *-----------------------------------------*
           move      w-let-arc-csp-des    to   w-sel-ffr-des-csp      .
      *                      *-----------------------------------------*
      *                      * Classe statistica, mnemonico            *
      *                      *-----------------------------------------*
           move      w-let-arc-csp-mne    to   w-sel-ffr-mne-csp      .
      *                      *-----------------------------------------*
      *                      * Classe statistica, numero di sequenza   *
      *                      *-----------------------------------------*
           move      w-let-arc-csp-nsq    to   w-sel-ffr-nsq-csp      .
      *                      *-----------------------------------------*
      *                      * Classe statistica, flag di esistenza    *
      *                      *-----------------------------------------*
           move      w-let-arc-csp-flg    to   w-sel-ffr-flg-csp      .
       sel-ffr-rec-300.
      *              *-------------------------------------------------*
      *              * Selezione su classe statistica prodotto         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se una sola classe statistica prodotto da   *
      *                  * selezionare e la classe statistica prodot-  *
      *                  * to non corrisponde a quella da seleziona-   *
      *                  * re : uscita per selezione non superata      *
      *                  *---------------------------------------------*
           if        rr-cod-csp           not  = zero   and
                     w-sel-ffr-cod-csp    not  = rr-cod-csp
                     go to sel-ffr-rec-900.
       sel-ffr-rec-400.
      *              *-------------------------------------------------*
      *              * Uscita per selezione superata                   *
      *              *-------------------------------------------------*
      ...
      *                  * Flag di uscita a : selezione superata       *
      *                  *---------------------------------------------*
           move      spaces               to   w-sel-ffr-flg-exi      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     sel-ffr-rec-999.
       sel-ffr-rec-900.
      *              *-------------------------------------------------*
      *              * Uscita per selezione non superata               *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       cmp-srt-rec-200.
      *                  *---------------------------------------------*
      *                  * Subchiave 1 : Per classe statistica prodot- *
      *                  *               to                            *
      *                  *---------------------------------------------*
       cmp-srt-rec-210.
      *                      *-----------------------------------------*
      ...
      *                          * zione                               *
      *                          *-------------------------------------*
           if        w-sel-ffr-des-csp    not  = spaces
                     move  1              to   srt-k01-flg-eon
           else      move  5              to   srt-k01-flg-eon        .
       cmp-srt-rec-220.
      *                      *-----------------------------------------*
      *                      * Descrizione per la classe statistica    *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-des-csp    to   srt-k01-des-csp        .
       cmp-srt-rec-225.
      *                      *-----------------------------------------*
      *                      * Mnemonico per la classe statistica      *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Solo se tipo ordinamento prodotto : *
      *                          *  - Per mnemonico classe             *
      *                          * altrimenti forzato a spaces         *
      *                          *-------------------------------------*
           if        rr-tor-csp           not  = 07
                     move  spaces         to   srt-k01-mne-csp
                     go to cmp-srt-rec-230.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-mne-csp    to   srt-k01-mne-csp        .
       cmp-srt-rec-230.
      *                      *-----------------------------------------*
      *                      * Flag di codice classe statistica a zero *
      *                      * o diverso da zero                       *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Solo se tipo ordinamento classe :   *
      ...
      *                          *-------------------------------------*
       ...
       cmp-srt-rec-235.
      *                      *-----------------------------------------*
      *                      * Numero di sequenza per la classe stati- *
      *                      * stica prodotto                          *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Solo se tipo ordinamento classe :   *
      ...
      *                          * altrimenti forzato a zero           *
      *                          *-------------------------------------*
           if        rr-tor-csp           not  = 08
                     move  zero           to   srt-k01-nsq-csp
                     go to cmp-srt-rec-240.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-nsq-csp    to   srt-k01-mne-csp        .
       cmp-srt-rec-240.
      *                      *-----------------------------------------*
      *                      * Codice classe statistica prodotto       *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-cod-csp    to   srt-k01-cod-csp        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per fornitore                 *
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rr-tor-fnt           not  = 01 and
                     ...
                     rr-tor-fnt           not  = 04 and
                     rr-tor-fnt           not  = 05 and
                     rr-tor-fnt           not  = 07
      ...
      *                          * sociale                             *
      *                          *-------------------------------------*
           if        w-sel-fft-rag-fnt    not  = spaces
      ...
      *                          *-------------------------------------*
           if        rr-tor-fnt           not  = 01 and
                     ...
                     rr-tor-fnt           not  = 04 and
                     rr-tor-fnt           not  = 05
                     move  spaces         to   srt-k02-rag-fnt
                     go to cmp-srt-rec-325.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fft-rag-fnt    to   srt-k02-rag-fnt        .
       cmp-srt-rec-325.
      *                      *-----------------------------------------*
      *                      * Mnemonico per il fornitore              *
      *                      *-----------------------------------------*
      ...
      *                          * altrimenti forzato a spaces         *
      *                          *-------------------------------------*
           if        rr-tor-fnt           not  = 07
                     move  spaces         to   srt-k02-mne-fnt
                     go to cmp-srt-rec-330.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fft-mne-fnt    to   srt-k02-mne-fnt        .
       cmp-srt-rec-330.
      *                      *-----------------------------------------*
      *                      * Flag di codice a zero o diverso da zero *
      *                      *-----------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-sel-fft-cod-fnt    to   srt-k02-cod-fnt        .
       cmp-srt-rec-340.
      *                      *-----------------------------------------*
      *                      * Codice dipendenza per il fornitore      *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-prs-saf-fnt-rgd    =    "S"
                     move  w-sel-fft-dpz-fnt
                                          to   srt-k02-dpz-fnt
           else      move  spaces         to   srt-k02-dpz-fnt        .
       cmp-srt-rec-400.
      *                  *---------------------------------------------*
      *                  * Subchiave 3 : Per documento                 *
      *                  *---------------------------------------------*
      ...
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-fft-dat-doc       to   srt-k03-dat-doc        .
       cmp-srt-rec-410.
      *                      *-----------------------------------------*
      *                      * Tipo documento                          *
      *                      *-----------------------------------------*
           if        rf-fft-tip-doc       =    01
                     move  "FT"           to   srt-k03-tip-doc
           else if   rf-fft-tip-doc       =    02
                     move  "ND"           to   srt-k03-tip-doc
           else if   rf-fft-tip-doc       =    03
                     move  "NC"           to   srt-k03-tip-doc
           else      move  "FT"           to   srt-k03-tip-doc        .
       cmp-srt-rec-415.
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      rf-fft-num-doc       to   srt-k03-num-doc        .
       cmp-srt-rec-800.
      *              *-------------------------------------------------*
      *              * Area dati                                       *
      *              *-------------------------------------------------*
      ...
      *                      * Codice numerico                         *
      *                      *-----------------------------------------*
           move      w-sel-ffr-cod-csp    to   srt-cod-csp-cod        .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      *                      *-----------------------------------------*
           move      w-sel-ffr-des-csp    to   srt-cod-csp-des        .
      *                      *-----------------------------------------*
      *                      * Mnemonico                               *
      *                      *-----------------------------------------*
           move      w-sel-ffr-mne-csp    to   srt-cod-csp-mne        .
      *                      *-----------------------------------------*
      *                      * Numero di sequenza                      *
      *                      *-----------------------------------------*
           move      w-sel-ffr-nsq-csp    to   srt-cod-csp-nsq        .
      *                      *-----------------------------------------*
      *                      * Flag di esistenza                       *
      *                      *-----------------------------------------*
           move      w-sel-ffr-flg-csp    to   srt-cod-csp-flg        .
       cmp-srt-rec-850.
      *                  *---------------------------------------------*
      *                  * Fornitore                                   *
      *                  *---------------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-sel-fft-cod-fnt    to   srt-cod-fnt-cod        .
      *                      *-----------------------------------------*
      *                      * Codice dipendenza del fornitore         *
      *                      *-----------------------------------------*
           move      w-sel-fft-dpz-fnt    to   srt-cod-fnt-dpz        .
      *                      *-----------------------------------------*
      *                      * Mnemonico del fornitore                 *
      *                      *-----------------------------------------*
           move      w-sel-fft-mne-fnt    to   srt-cod-fnt-mne        .
      *                      *-----------------------------------------*
      *                      * Ragione sociale del fornitore           *
      *                      *-----------------------------------------*
           move      w-sel-fft-rag-fnt    to   srt-cod-fnt-rag        .
       cmp-srt-rec-875.
      *                  *---------------------------------------------*
      *                  * Codice prodotto                             *
      *                  *---------------------------------------------*
      ...
      *                      * Codice numerico del prodotto            *
      *                      *-----------------------------------------*
           move      w-sel-ffr-num-pro    to   srt-cod-pro-cod        .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico del prodotto        *
      *                      *-----------------------------------------*
           move      w-sel-ffr-alf-pro    to   srt-cod-pro-alf        .
      *                      *-----------------------------------------*
      *                      * Descrizione del prodotto                *
      *                      *-----------------------------------------*
           move      w-sel-ffr-des-pro    to   srt-cod-pro-des        .
      *                      *-----------------------------------------*
      *                      * Unita' di misura del prodotto           *
      *                      *-----------------------------------------*
           move      w-sel-ffr-umi-pro    to   srt-cod-pro-umi        .
      *                      *-----------------------------------------*
      *                      * Numero decimali del prodotto            *
      *                      *-----------------------------------------*
           move      w-sel-ffr-dec-pro    to   srt-cod-pro-dec        .
      *                      *-----------------------------------------*
      *                      * Classe merceologica                     *
      *                      *-----------------------------------------*
           move      w-sel-ffr-cla-pro    to   srt-cod-pro-cla        .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico                     *
      *                      *-----------------------------------------*
           move      w-sel-ffr-gru-pro    to   srt-cod-pro-gru        .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico                *
      *                      *-----------------------------------------*
           move      w-sel-ffr-sgr-pro    to   srt-cod-pro-sgr        .
      *                      *-----------------------------------------*
      *                      * Codice statistico 1                     *
      *                      *-----------------------------------------*
           move      w-sel-ffr-s01-pro    to   srt-cod-pro-s01        .
      *                      *-----------------------------------------*
      *                      * Codice statistico 2                     *
      *                      *-----------------------------------------*
           move      w-sel-ffr-s02-pro    to   srt-cod-pro-s02        .
      *                      *-----------------------------------------*
      *                      * Codice statistico 3                     *
      *                      *-----------------------------------------*
           move      w-sel-ffr-s03-pro    to   srt-cod-pro-s03        .
       cmp-srt-rec-900.
      *                  *---------------------------------------------*
      *                  * Estremi del documento                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rf-fft-tip-doc       =    01
                     move  "FT"           to   srt-est-doc-tdo
           else if   rf-fft-tip-doc       =    02
                     move  "ND"           to   srt-est-doc-tdo
           else if   rf-fft-tip-doc       =    03
                     move  "NC"           to   srt-est-doc-tdo
           else      move  "FT"           to   srt-est-doc-tdo        .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-fft-dat-doc       to   srt-est-doc-ddo        .
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      rf-fft-num-doc       to   srt-est-doc-ndo        .
      *                      *-----------------------------------------*
      ...
      *                          * 'mnotsaf0' per la funzione di de-   *
      ...
      *                              * dettaglio                       *
      *                              *---------------------------------*
           move      00                   to   w-mod-not-saf-tdd      .
      *                              *---------------------------------*
      *                              * Numero di caratteri disponibili *
      *                              *---------------------------------*
           move      w-stp-clc-not-lun    to   w-mod-not-saf-ncd      .
      *                              *---------------------------------*
      *                              * 1. quantita'                    *
      *                              *---------------------------------*
           move      w-mod-ffo-ffr-qta    to   w-mod-not-saf-q01      .
      *                              *---------------------------------*
      *                              * 1. fatturato                    *
      *                              *---------------------------------*
           move      w-mod-ffo-ffr-val    to   w-mod-not-saf-f01      .
      *                              *---------------------------------*
      *                              * 2. quantita'                    *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-saf-q02      .
      *                              *---------------------------------*
      *                              * 2. fatturato                    *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-saf-f02      .
      *                              *---------------------------------*
      *                              * 1. % di variazione              *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-saf-p01      .
      *                              *---------------------------------*
      *                              * 3. quantita'                    *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-saf-q03      .
      *                              *---------------------------------*
      *                              * 3. fatturato                    *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-saf-f03      .
      *                              *---------------------------------*
      *                              * 2. % di variazione              *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-saf-p02      .
      *                              *---------------------------------*
      *                              * Tipo documento                  *
      *                              *---------------------------------*
           move      rf-fft-tip-doc       to   w-mod-not-saf-tdo      .
      *                              *---------------------------------*
      *                              * Data documento                  *
      *                              *---------------------------------*
           move      rf-fft-dat-doc       to   w-mod-not-saf-ddo      .
      *                              *---------------------------------*
      *                              * Numero documento                *
      *                              *---------------------------------*
           move      rf-fft-num-doc       to   w-mod-not-saf-ndo      .
      *                          *-------------------------------------*
      *                          * Richiamo effettivo del modulo       *
      *                          *-------------------------------------*
           perform   mod-not-saf-dvn-000  thru mod-not-saf-dvn-999    .
      *                          *-------------------------------------*
      *                          * Memorizzazione risultato            *
      *                          *-------------------------------------*
           move      w-mod-not-saf-not    to   srt-est-doc-not        .
       cmp-srt-rec-925.
      *                  *---------------------------------------------*
      *                  * Valori statistici                           *
      *                  *---------------------------------------------*
      ...
      *                      * Quantita' fatturata                     *
      *                      *-----------------------------------------*
           move      w-mod-ffo-ffr-qta    to   srt-val-sta-qta        .
      *                      *-----------------------------------------*
      *                      * Importo fatturato                       *
      *                      *-----------------------------------------*
           move      w-mod-ffo-ffr-val    to   srt-val-sta-val        .
      *                      *-----------------------------------------*
      *                      * Incidenza sulla statistica              *
      *                      *-----------------------------------------*
           move      w-mod-ffo-ffr-pon    to   srt-val-sta-pon        .
      *                      *-----------------------------------------*
      *                      * Incidenza sul 1. periodo di riferimento *
      *                      *-----------------------------------------*
           move      w-mod-ffo-ffr-sn1    to   srt-val-sta-sn1        .
      *                      *-----------------------------------------*
      *                      * Incidenza sul 2. periodo di riferimento *
      *                      *-----------------------------------------*
           move      w-mod-ffo-ffr-sn2    to   srt-val-sta-sn2        .
      *                      *-----------------------------------------*
      *                      * Incidenza sul 3. periodo di riferimento *
      *                      *-----------------------------------------*
           move      w-mod-ffo-ffr-sn3    to   srt-val-sta-sn3        .
       cmp-srt-rec-950.
      *                  *---------------------------------------------*
      *                  * Valori ABC                                  *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Valore ABC per la classe statistica del *
      *                      * prodotto                                *
      *                      *-----------------------------------------*
           move      zero                 to   srt-val-abc-csp        .
      *                      *-----------------------------------------*
      *                      * Valore ABC per il fornitore nell'ambito *
      *                      * della classe statica del prodotto       *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Solo se tipo ordinamento per classe stati-  *
      *                  * stica prodotto :                            *
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-cod-csp-cod      to   kk0-cod-csp            .
           move      zero                 to   kk0-cod-fnt            .
           move      spaces               to   kk0-dpz-fnt            .
      ...
      *                  *---------------------------------------------*
      *                  * Solo se tipo ordinamento per fornitori :    *
      *                  *   - 01 : ABC decrescente sul fatturato      *
      *                  *   - 02 : ABC decrescente sulla quantita'    *
      *                  *   - 03 : ABC crescente sul fatturato        *
      *                  *   - 04 : ABC crescente sulla quantita'      *
      ...
      *    *-----------------------------------------------------------*
       agg-abc-sqz-000.
      *              *-------------------------------------------------*
      *              * Valore ABC per classe statistica prodotto       *
      *              *-------------------------------------------------*
       agg-abc-sqz-025.
      *                  *---------------------------------------------*
      *                  * Se la statistica e' sul nuovo fatturato o   *
      ...
      *                          *-------------------------------------*
           move      srt-k01-val-abc      to   srt-val-abc-csp        .
       agg-abc-sqz-150.
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione in area specifica    *
      *                          *-------------------------------------*
           move      srt-k02-val-abc      to   srt-val-abc-fnt        .
       agg-abc-sqz-650.
      *                      *-----------------------------------------*
      *                      * Eventuale aggiornamento del flag per    *
      *                      * record da non selezionare               *
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice numerico della classe statistica     *
      *                  * prodotto                                    *
      *                  *---------------------------------------------*
           move      srt-cod-csp-cod      to   w-rot-l02-cod-csp      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  * tate in totale                              *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-gen-num-csp      .
      *                  *---------------------------------------------*
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-qta-p1r    to   w-mod-not-saf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-tot-p1r    to   w-mod-not-saf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-qta-p2r    to   w-mod-not-saf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-tot-p2r    to   w-mod-not-saf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-saf-p01      .
      *                      *-----------------------------------------*
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-qta-p3r    to   w-mod-not-saf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-gen-tot-p3r    to   w-mod-not-saf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-saf-p02      .
      *                      *-----------------------------------------*
      *                      * Tipo documento                          *
      *                      *-----------------------------------------*
           move      spaces               to   w-mod-not-saf-tdo      .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      zero                 to   w-mod-not-saf-ddo      .
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      zero                 to   w-mod-not-saf-ndo      .
      *                  *---------------------------------------------*
      *                  * Richiamo effettivo del modulo               *
      *                  *---------------------------------------------*
           perform   mod-not-saf-dvn-000  thru mod-not-saf-dvn-999    .
      ...
      *              *-------------------------------------------------*
      ...
      -              "      "             to   w-stp-sta-tot-lit      .
           ...
           move      w-mod-not-saf-not    to   w-stp-sta-tot-not      .
       prn-fin-cic-200.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda se le personalizzazioni    *
      *              * indicano un salto pagina oppure no ad inizio    *
      ...
      *              *-------------------------------------------------*
      *              * Inizializzazione work area per livello di rot-  *
      *              * tura per classe statistica prodotto             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice numerico della classe statistica del *
      *                  * prodotto                                    *
      *                  *---------------------------------------------*
           move      srt-cod-csp-cod      to   w-liv-csp-cod-csp      .
      *                  *---------------------------------------------*
      *                  * Mnemonico per la classe statistica prodotto *
      *                  *---------------------------------------------*
           move      srt-cod-csp-mne      to   w-liv-csp-mne-csp      .
      *                  *---------------------------------------------*
      *                  * Descrizione per la classe statistica pro-   *
      *                  * dotto                                       *
      *                  *---------------------------------------------*
           move      srt-cod-csp-des      to   w-liv-csp-des-csp      .
      *                  *---------------------------------------------*
      *                  * Numero di dequenza per la classe statistica *
      *                  * prodotto                                    *
      *                  *---------------------------------------------*
           move      srt-cod-csp-nsq      to   w-liv-csp-nsq-csp      .
      *                  *---------------------------------------------*
      *                  * Flag di unita' di misura memorizzata        *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-csp-flg-umi      .
      *                  *---------------------------------------------*
      *                  * Valore dell' unita' di misura memorizzata   *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-csp-val-umi      .
      *                  *---------------------------------------------*
      *                  * Flag di numero decimali memorizzati         *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-csp-flg-dec      .
      *                  *---------------------------------------------*
      *                  * Valore del numero decimali memorizzati      *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-val-dec      .
      *                  *---------------------------------------------*
      *                  * Totale quantita' 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-qta-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-tot-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale quantita' 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-qta-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-tot-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale quantita' 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-qta-p3r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-tot-p3r      .
      *                  *---------------------------------------------*
      *                  * Numero di fornitori trattati per la classe  *
      *                  * statistica del prodotto                     *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-num-fnt      .
      *                  *---------------------------------------------*
      *                  * Numero classi statistiche prodotto trattate *
      *                  * in totale                                   *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-gen-num-csp      .
       prn-ini-lr2-200.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda se le personalizzazioni    *
      *              * indicano un salto pagina oppure no ad inizio    *
      ...
      *                      *-----------------------------------------*
           move      w-liv-csp-cod-csp    to   w-stp-sub-cod-num      .
      *                      *-----------------------------------------*
      *                      * Valore del codice, alfanumerico         *
      *                      *-----------------------------------------*
           move      w-liv-csp-mne-csp    to   w-stp-sub-cod-alf      .
      *                      *-----------------------------------------*
      *                      * Descrizione per il codice               *
      *                      *-----------------------------------------*
           move      w-liv-csp-des-csp    to   w-stp-sub-cod-des      .
       prn-ini-lr2-550.
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tpc-pdv           =    02
                     move  w-liv-csp-qta-p1r
                                          to   w-stp-clc-pdv-v01
                     move  w-liv-csp-qta-p2r
                                          to   w-stp-clc-pdv-v02
                     move  w-liv-csp-qta-p3r
                                          to   w-stp-clc-pdv-v03
           else      move  w-liv-csp-tot-p1r
                                          to   w-stp-clc-pdv-v01
                     move  w-liv-csp-tot-p2r
                                          to   w-stp-clc-pdv-v02
                     move  w-liv-csp-tot-p3r
                                          to   w-stp-clc-pdv-v03      .
           perform   stp-clc-pdv-000      thru stp-clc-pdv-999        .
       prn-fin-lr2-125.
      *              *-------------------------------------------------*
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-qta-p1r    to   w-mod-not-saf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-tot-p1r    to   w-mod-not-saf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-qta-p2r    to   w-mod-not-saf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-tot-p2r    to   w-mod-not-saf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-saf-p01      .
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-qta-p3r    to   w-mod-not-saf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-csp-tot-p3r    to   w-mod-not-saf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-saf-p02      .
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr2-420.
      *                  *---------------------------------------------*
      *                  * Stampa totale classe statistica prodotto    *
      *                  *---------------------------------------------*
       prn-fin-lr2-425.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       prn-fin-lr2-426.
           ...
           else      go to prn-fin-lr2-435.
       prn-fin-lr2-431.
           move      "Totale classe statistica prodotto :               
      -              "      "             to   w-stp-sta-tot-lit      .
      ...
      -              "      "             to   w-stp-sta-tot-lit      .
           go to     prn-fin-lr2-440.
       prn-fin-lr2-435.
           move      "Totale classe merceologica prodotto :             
      -              "      "             to   w-stp-sta-tot-lit      .
           go to     prn-fin-lr2-440.
       prn-fin-lr2-440.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-prs-saf-tqn-snx    =    "N"
                     if    w-liv-csp-flg-umi
                                          =    "N"
                           move  "N"      to   w-stp-sta-tot-snq
                     else  move  "S"      to   w-stp-sta-tot-snq
           else      move  "S"            to   w-stp-sta-tot-snq      .
           move      w-liv-csp-val-dec    to   w-stp-sta-tot-dec      .
           move      w-liv-csp-val-umi    to   w-stp-sta-tot-umi      .
           move      w-liv-csp-qta-p1r    to   w-stp-sta-tot-q01      .
           move      w-liv-csp-tot-p1r    to   w-stp-sta-tot-f01      .
           move      w-liv-csp-qta-p2r    to   w-stp-sta-tot-q02      .
           move      w-liv-csp-tot-p2r    to   w-stp-sta-tot-f02      .
           move      w-liv-csp-qta-p3r    to   w-stp-sta-tot-q03      .
           move      w-liv-csp-tot-p3r    to   w-stp-sta-tot-f03      .
           move      w-stp-clc-pdv-p01    to   w-stp-sta-tot-p01      .
           move      w-stp-clc-pdv-p02    to   w-stp-sta-tot-p02      .
           move      w-mod-not-saf-not    to   w-stp-sta-tot-not      .
       prn-fin-lr2-450.
      ...
      *                  * Flag di unita' di misura memorizzata        *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-fnt-flg-umi      .
      *                  *---------------------------------------------*
      *                  * Valore dell' unita' di misura memorizzata   *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-fnt-val-umi      .
      *                  *---------------------------------------------*
      *                  * Flag di numero decimali memorizzati         *
      *                  *---------------------------------------------*
           move      spaces               to   w-liv-fnt-flg-dec      .
      *                  *---------------------------------------------*
      *                  * Valore del numero decimali memorizzati      *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fnt-val-dec      .
      *                  *---------------------------------------------*
      *                  * Totale quantita' 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fnt-qta-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 1. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * Totale quantita' 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fnt-qta-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 2. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *                  * Totale quantita' 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fnt-qta-p3r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 3. periodo di riferimento  *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tpc-pdv           =    02
                     move  w-liv-fnt-qta-p1r
                                          to   w-stp-clc-pdv-v01
                     move  w-liv-fnt-qta-p2r
                                          to   w-stp-clc-pdv-v02
                     move  w-liv-fnt-qta-p3r
                                          to   w-stp-clc-pdv-v03
           else      move  w-liv-fnt-tot-p1r
                                          to   w-stp-clc-pdv-v01
                     move  w-liv-fnt-tot-p2r
                                          to   w-stp-clc-pdv-v02
                     move  w-liv-fnt-tot-p3r
                                          to   w-stp-clc-pdv-v03      .
           perform   stp-clc-pdv-000      thru stp-clc-pdv-999        .
       prn-fin-lr1-125.
      *              *-------------------------------------------------*
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-qta-p1r    to   w-mod-not-saf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-tot-p1r    to   w-mod-not-saf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-qta-p2r    to   w-mod-not-saf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-tot-p2r    to   w-mod-not-saf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-saf-p01      .
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-qta-p3r    to   w-mod-not-saf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-fnt-tot-p3r    to   w-mod-not-saf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-saf-p02      .
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-lr1-300.
      *              *-------------------------------------------------*
      *              * Se tipo dettaglio stampa 01 : solo il totale    *
      *              * per ogni fornitore                              *
      *              *-------------------------------------------------*
       prn-fin-lr1-310.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr1-330.
      *                  *---------------------------------------------*
      *                  * Subroutine per la stampa codice fornitore   *
      ...
      *                      *-----------------------------------------*
           ...
           move      w-liv-fnt-val-umi    to   w-stp-sta-qfp-umi      .
           move      w-liv-fnt-val-dec    to   w-stp-sta-qfp-dec      .
           move      w-liv-fnt-qta-p1r    to   w-stp-sta-qfp-q01      .
           move      w-liv-fnt-tot-p1r    to   w-stp-sta-qfp-f01      .
           move      w-liv-fnt-qta-p2r    to   w-stp-sta-qfp-q02      .
           move      w-liv-fnt-tot-p2r    to   w-stp-sta-qfp-f02      .
           move      w-liv-fnt-qta-p3r    to   w-stp-sta-qfp-q03      .
           move      w-liv-fnt-tot-p3r    to   w-stp-sta-qfp-f03      .
           move      w-stp-clc-pdv-p01    to   w-stp-sta-qfp-p01      .
           move      w-stp-clc-pdv-p02    to   w-stp-sta-qfp-p02      .
           move      w-mod-not-saf-not    to   w-stp-sta-qfp-not      .
       prn-fin-lr1-342.
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr1-400.
      *              *-------------------------------------------------*
      *              * Se tipo dettaglio stampa 02, con anche il det-  *
      *              * taglio documenti                                *
      *              *-------------------------------------------------*
       prn-fin-lr1-420.
      *                  *---------------------------------------------*
      ...
      *                      * Preparazione altri parametri            *
      *                      *-----------------------------------------*
           move      "S"                  to   w-stp-sta-tot-snq      .
           move      w-liv-fnt-val-dec    to   w-stp-sta-tot-dec      .
           move      w-liv-fnt-val-umi    to   w-stp-sta-tot-umi      .
           move      w-liv-fnt-qta-p1r    to   w-stp-sta-tot-q01      .
           move      w-liv-fnt-tot-p1r    to   w-stp-sta-tot-f01      .
           move      w-liv-fnt-qta-p2r    to   w-stp-sta-tot-q02      .
           move      w-liv-fnt-tot-p2r    to   w-stp-sta-tot-f02      .
           move      w-liv-fnt-qta-p3r    to   w-stp-sta-tot-q03      .
      ...
      *                  *---------------------------------------------*
           if        w-liv-gen-flg-umi    =    spaces
                     ...
                     move  spaces         to   w-liv-gen-val-umi      .
      *                  *---------------------------------------------*
      *                  * Per livello classe statistica prodotto      *
      *                  *---------------------------------------------*
           if        w-liv-csp-flg-umi    =    spaces
                     move  "S"            to   w-liv-csp-flg-umi
                     move  srt-cod-pro-umi
                                          to   w-liv-csp-val-umi
           else if   w-liv-csp-val-umi    not  = srt-cod-pro-umi
                     move  "N"            to   w-liv-csp-flg-umi
                     move  spaces         to   w-liv-csp-val-umi      .
      *                  *---------------------------------------------*
      *                  * Per livello fornitore                       *
      *                  *---------------------------------------------*
           if        w-liv-fnt-flg-umi    =    spaces
                     move  "S"            to   w-liv-fnt-flg-umi
                     move  srt-cod-pro-umi
                                          to   w-liv-fnt-val-umi
           else if   w-liv-fnt-val-umi    not  = srt-cod-pro-umi
                     move  "N"            to   w-liv-fnt-flg-umi
                     move  spaces         to   w-liv-fnt-val-umi      .
       prn-liv-det-150.
      *              *-------------------------------------------------*
      ...
      *                  * Per livello classe statistica prodotto      *
      *                  *---------------------------------------------*
           if        w-liv-csp-flg-dec    =    spaces
                     move  "#"            to   w-liv-csp-flg-dec
                     move  srt-cod-pro-dec
                                          to   w-liv-csp-val-dec
           else if   w-liv-csp-val-dec    not  = srt-cod-pro-dec
                     move  9              to   w-liv-csp-val-dec      .
      *                  *---------------------------------------------*
      *                  * Per livello fornitore                       *
      *                  *---------------------------------------------*
           if        w-liv-fnt-flg-dec    =    spaces
                     move  "#"            to   w-liv-fnt-flg-dec
                     move  srt-cod-pro-dec
                                          to   w-liv-fnt-val-dec
           else if   w-liv-fnt-val-dec    not  = srt-cod-pro-dec
                     move  9              to   w-liv-fnt-val-dec      .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-250.
      *              *-------------------------------------------------*
      *              * Accumuli per livello classe statistica prodotto *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Totali 1. periodo di riferimento            *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn1      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-csp-qta-p1r
                           add      srt-val-sta-val
                                          to   w-liv-csp-tot-p1r
                     else  subtract srt-val-sta-qta
                                          from w-liv-csp-qta-p1r
                           subtract srt-val-sta-val
                                          from w-liv-csp-tot-p1r      .
      *                  *---------------------------------------------*
      *                  * Totali 2. periodo di riferimento            *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn2      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-csp-qta-p2r
                           add      srt-val-sta-val
                                          to   w-liv-csp-tot-p2r
                     else  subtract srt-val-sta-qta
                                          from w-liv-csp-qta-p2r
                           subtract srt-val-sta-val
                                          from w-liv-csp-tot-p2r      .
      *                  *---------------------------------------------*
      *                  * Totali 3. periodo di riferimento            *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn3      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-csp-qta-p3r
                           add      srt-val-sta-val
                                          to   w-liv-csp-tot-p3r
                     else  subtract srt-val-sta-qta
                                          from w-liv-csp-qta-p3r
                           subtract srt-val-sta-val
                                          from w-liv-csp-tot-p3r      .
       prn-liv-det-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn1      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-fnt-qta-p1r
                           add      srt-val-sta-val
                                          to   w-liv-fnt-tot-p1r
                     else  subtract srt-val-sta-qta
                                          from w-liv-fnt-qta-p1r
                           subtract srt-val-sta-val
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn2      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-fnt-qta-p2r
                           add      srt-val-sta-val
                                          to   w-liv-fnt-tot-p2r
                     else  subtract srt-val-sta-qta
                                          from w-liv-fnt-qta-p2r
                           subtract srt-val-sta-val
      ...
      *                  *---------------------------------------------*
           if        srt-val-sta-sn3      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-qta
                                          to   w-liv-fnt-qta-p3r
                           add      srt-val-sta-val
                                          to   w-liv-fnt-tot-p3r
                     else  subtract srt-val-sta-qta
                                          from w-liv-fnt-qta-p3r
                           subtract srt-val-sta-val
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-500.
      *              *-------------------------------------------------*
      *              * Se tipo dettaglio stampa 01, con solo il totale *
      *              * per fornitore                                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      ...
      *                  *---------------------------------------------*
           ...
           else      go to stp-int-pag-034.
       stp-int-pag-031.
           move      "PER 1. CODICE STATISTICO PRODOTTO - FORNITORE     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-032.
           move      "PER 2. CODICE STATISTICO PRODOTTO - FORNITORE     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-033.
           move      "PER 3. CODICE STATISTICO PRODOTTO - FORNITORE     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-034.
           move      "PER CLASSE MERCEOLOGICA PRODOTTO - FORNITORE      
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
      ...
      *                      *-----------------------------------------*
           ...
           else      go to stp-sub-int-435.
       stp-sub-int-431.
           move      "Vendite di prodotti non classificati con il 1. cod
      -              "ice statistico        "
                                          to   w-stp-sub-ads-asx      .
           go to     stp-sub-int-440.
       stp-sub-int-432.
           move      "Vendite di prodotti non classificati con il 2. cod
      -              "ice statistico        "
                                          to   w-stp-sub-ads-asx      .
           go to     stp-sub-int-440.
       stp-sub-int-433.
           move      "Vendite di prodotti non classificati con il 3. cod
      -              "ice statistico        "
                                          to   w-stp-sub-ads-asx      .
           go to     stp-sub-int-440.
       stp-sub-int-435.
           move      "Vendite di prodotti non classificati per classe me
      -              "rceologica            "
                                          to   w-stp-sub-ads-asx      .
           go to     stp-sub-int-440.
       stp-sub-int-440.
      ...
      *    *===========================================================*
      *    * Routine di lettura classificatori statistici prodotto     *
      *    *-----------------------------------------------------------*
       let-arc-csp-000.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo di classificatore *
      *              * statistico prodotto da leggere                  *
      *              *-------------------------------------------------*
           if        w-let-arc-csp-tip    =    01
                     go to let-arc-csp-100
           else if   w-let-arc-csp-tip    =    02
                     go to let-arc-csp-200
           else if   w-let-arc-csp-tip    =    03
                     go to let-arc-csp-300
           else      go to let-arc-csp-500.
       let-arc-csp-100.
      *              *-------------------------------------------------*
      *              * Se codice statistico 1                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura archivio [zps] tipo record 01       *
      *                  *---------------------------------------------*
           move      w-let-arc-csp-cod    to   w-let-arc-s01-cod      .
           perform   let-arc-s01-000      thru let-arc-s01-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione valori                       *
      *                  *---------------------------------------------*
           move      w-let-arc-s01-flg    to   w-let-arc-csp-flg      .
           move      w-let-arc-s01-des    to   w-let-arc-csp-des      .
           move      w-let-arc-s01-mne    to   w-let-arc-csp-mne      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione numero di sequenza          *
      *                  *---------------------------------------------*
           move      zero                 to   w-let-arc-csp-nsq      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     let-arc-csp-999.
       let-arc-csp-200.
      *              *-------------------------------------------------*
      *              * Se codice statistico 2                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura archivio [zps] tipo record 02       *
      *                  *---------------------------------------------*
           move      w-let-arc-csp-cod    to   w-let-arc-s02-cod      .
           perform   let-arc-s02-000      thru let-arc-s02-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione valori                       *
      *                  *---------------------------------------------*
           move      w-let-arc-s02-flg    to   w-let-arc-csp-flg      .
           move      w-let-arc-s02-des    to   w-let-arc-csp-des      .
           move      w-let-arc-s02-mne    to   w-let-arc-csp-mne      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione numero di sequenza          *
      *                  *---------------------------------------------*
           move      zero                 to   w-let-arc-csp-nsq      .
      ...
      *                  *---------------------------------------------*
       ...
       let-arc-csp-300.
      *              *-------------------------------------------------*
      *              * Se codice statistico 3                          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura archivio [zps] tipo record 03       *
      *                  *---------------------------------------------*
           move      w-let-arc-csp-cod    to   w-let-arc-s03-cod      .
           perform   let-arc-s03-000      thru let-arc-s03-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione valori                       *
      *                  *---------------------------------------------*
           move      w-let-arc-s03-flg    to   w-let-arc-csp-flg      .
           move      w-let-arc-s03-des    to   w-let-arc-csp-des      .
           move      w-let-arc-s03-mne    to   w-let-arc-csp-mne      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione numero di sequenza          *
      *                  *---------------------------------------------*
           move      zero                 to   w-let-arc-csp-nsq      .
      ...
      *                  *---------------------------------------------*
       ...
       let-arc-csp-500.
      *              *-------------------------------------------------*
      *              * Se codice classe merceologica                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura archivio [zp1]                      *
      *                  *---------------------------------------------*
           move      w-let-arc-csp-cod    to   w-let-arc-zp1-cod      .
           perform   let-arc-zp1-000      thru let-arc-zp1-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione valori                       *
      *                  *---------------------------------------------*
           move      w-let-arc-zp1-flg    to   w-let-arc-csp-flg      .
           move      w-let-arc-zp1-des    to   w-let-arc-csp-des      .
           move      w-let-arc-zp1-mne    to   w-let-arc-csp-mne      .
           move      w-let-arc-zp1-nsq    to   w-let-arc-csp-nsq      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     let-arc-csp-999.
      ...
      *              *-------------------------------------------------*
           if        w-let-arc-zp1-cod    =    w-let-arc-zp1-exc
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-let-arc-zp1-cod    not  = zero
                     go to let-arc-zp1-200.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      zero                 to   w-let-arc-zp1-nsq      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-zp1-900.
       let-arc-zp1-200.
      *              *-------------------------------------------------*
      *              * Lettura da archivio [zp1]                       *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      w-let-arc-zp1-cod    to   rf-zp1-cod-cla         .
           move      "pgm/dcp/fls/ioc/obj/iofzp1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-zp1-300.
      *              *-------------------------------------------------*
      *              * Se record esistente in archivio [zp1]           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Flag di uscita a spaces                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-zp1-sqz-num       to   w-let-arc-zp1-nsq      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-zp1-900.
       let-arc-zp1-400.
      *              *-------------------------------------------------*
      *              * Se record non esistente in archivio [zp1]       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Flag di uscita a '#'                        *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-let-arc-zp1-cod    to   w-let-arc-zp1-exc      .
       let-arc-zp1-999.
           exit.

      *    *===========================================================*
      *    * Routine di lettura archivio [zps], tipo record 01         *
      *    *-----------------------------------------------------------*
       let-arc-s01-000.
      *              *-------------------------------------------------*
      *              * Test se codice pari al valore precedente        *
      *              *-------------------------------------------------*
           if        w-let-arc-s01-cod    =    w-let-arc-s01-exc
                     go to let-arc-s01-900.
       let-arc-s01-100.
      *              *-------------------------------------------------*
      *              * Se codice a zero                                *
      *              *-------------------------------------------------*
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-let-arc-s01-cod    not  = zero
                     go to let-arc-s01-200.
      *                  *---------------------------------------------*
      *                  * Flag di uscita a spaces                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   w-let-arc-s01-mne      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-s01-900.
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-s01-300.
      *              *-------------------------------------------------*
      *              * Se record esistente in archivio [zps]           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Flag di uscita a spaces                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-zps-mne-cls       to   w-let-arc-s01-mne      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-s01-900.
       let-arc-s01-400.
      *              *-------------------------------------------------*
      *              * Se record non esistente in archivio [zps]       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Flag di uscita a '#'                        *
      *                  *---------------------------------------------*
      ...
      *              * Codice numerico letto su valore precedente      *
      *              *-------------------------------------------------*
           move      w-let-arc-s01-cod    to   w-let-arc-s01-exc      .
       let-arc-s01-999.
           exit.

      *    *===========================================================*
      *    * Routine di lettura archivio [zps], tipo record 02         *
      *    *-----------------------------------------------------------*
       let-arc-s02-000.
      *              *-------------------------------------------------*
      *              * Test se codice pari al valore precedente        *
      *              *-------------------------------------------------*
           if        w-let-arc-s02-cod    =    w-let-arc-s02-exc
                     go to let-arc-s02-900.
       let-arc-s02-100.
      *              *-------------------------------------------------*
      *              * Se codice a zero                                *
      *              *-------------------------------------------------*
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-let-arc-s02-cod    not  = zero
                     go to let-arc-s02-200.
      *                  *---------------------------------------------*
      *                  * Flag di uscita a spaces                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   w-let-arc-s02-mne      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-s02-900.
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-zps-mne-cls       to   w-let-arc-s02-mne      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-s02-900.
      ...
      *              * Codice numerico letto su valore precedente      *
      *              *-------------------------------------------------*
           move      w-let-arc-s02-cod    to   w-let-arc-s02-exc      .
       let-arc-s02-999.
           exit.

      *    *===========================================================*
      *    * Routine di lettura archivio [zps], tipo record 03         *
      *    *-----------------------------------------------------------*
       let-arc-s03-000.
      *              *-------------------------------------------------*
      *              * Test se codice pari al valore precedente        *
      *              *-------------------------------------------------*
           if        w-let-arc-s03-cod    =    w-let-arc-s03-exc
                     go to let-arc-s03-900.
       let-arc-s03-100.
      *              *-------------------------------------------------*
      *              * Se codice a zero                                *
      *              *-------------------------------------------------*
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-let-arc-s03-cod    not  = zero
                     go to let-arc-s03-200.
      *                  *---------------------------------------------*
      *                  * Flag di uscita a spaces                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   w-let-arc-s03-mne      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-s03-900.
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-zps-mne-cls       to   w-let-arc-s03-mne      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-s03-900.
      ...
      *              * Codice numerico letto su valore precedente      *
      *              *-------------------------------------------------*
           move      w-let-arc-s03-cod    to   w-let-arc-s03-exc      .
       let-arc-s03-999.
           exit.
      ...
      *    * fatturato da Righe Documenti                              *
      *    *-----------------------------------------------------------*
           copy      "pgm/saf/prg/cpy/mffoffr0.mds"                   .
      ...
      *    *-----------------------------------------------------------*
           copy      "pgm/saf/prg/cpy/mnotsaf0.mds"                   .
