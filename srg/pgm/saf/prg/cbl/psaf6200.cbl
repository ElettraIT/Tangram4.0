      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psaf6201:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "Solo il totale per ogni fornitore                 ".
                   15  filler             pic  x(50) value
                  "Con la lista documenti emessi per ogni fornitore  ".
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt : Tipo di ordinamento per fornitori                *
      *    *-----------------------------------------------------------*
       pmt-tor-fnt-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-202.
           ...
           move      "Tipo di ordinamento per fornitori errato !        
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-300.
      *              *-------------------------------------------------*
