      ...
      *                                   Fase:    saf830              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 12/08/04    *
      *                       Ultima revisione:    NdK del 08/03/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psaf8301:        *
      *                                                                *
      *                    Stampa statistica di acquisto sul fatturato *
      *                    per classificazione statistica fornitore    *
      *                    generico                                    *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FATTURATO X CLASSE STATISTICA FORNITORE "       .
      ...
      *        *-------------------------------------------------------*
      *        * Tipo classe statistica selezionata                    *
      *        *  - 01 : Zona                                          *
      *        *  - 02 : Categoria                                     *
      *        *  - 03 : Codice statistico libero                      *
      *        *-------------------------------------------------------*
           05  rr-tcs-fnt                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Codice classe statistica selezionata                  *
      *        *  - Se codice 00000 : Tutti i codici                   *
      *        *-------------------------------------------------------*
           05  rr-ccs-fnt                 pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice classe statistica selezionata, descrizione     *
      *        *  - Se codice 00000 : 'Tutti i codici      '           *
      *        *-------------------------------------------------------*
           05  rr-ccs-fnt-des             pic  x(25)                  .
      *        *-------------------------------------------------------*
      *        * Tipo di dettaglio di stampa                           *
      *        *  - 01 : Solo totale per codice classe statistica      *
      *        *  - 02 : Con anche il totale per ogni fornitore        *
      *        *  - 03 : Con la lista documenti emessi per fornitore   *
      *        *-------------------------------------------------------*
           05  rr-tip-dts                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Tipo di ordinamento per classe statistica fornitore   *
      ...
      *        *                                                       *
      *        * Non significativo se codice classe statistica         *
      *        * diversa da zero, ovvero un solo codice                *
      *        *-------------------------------------------------------*
           05  rr-tor-csf                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-yst.
               ...
               10  w-let-arc-yst-des      pic  x(25)                  .
               10  w-let-arc-yst-mne      pic  x(05)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Tipo classe statistica fornitore                      *
      *        *-------------------------------------------------------*
           05  w-sav-tcs-fnt              pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo classe statistica fornitore           *
      *        *-------------------------------------------------------*
           05  w-exp-tcs-fnt.
               10  w-exp-tcs-fnt-num      pic  9(02)       value 3    .
               10  w-exp-tcs-fnt-lun      pic  9(02)       value 30   .
               10  w-exp-tcs-fnt-tbl.
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-t03.
                  ...
                  "Con la lista documenti emessi per ogni fornitore  ".
      *        *-------------------------------------------------------*
      *        * Work per : Tipo ordinamento classe statistica         *
      *        *-------------------------------------------------------*
           05  w-exp-tor-csf.
               10  w-exp-tor-csf-num      pic  9(02)       value 5    .
               10  w-exp-tor-csf-lun      pic  9(02)       value 50   .
               10  w-exp-tor-csf-tbl.
                   15  filler             pic  x(50)                  .
                   15  filler             pic  x(50)                  .
                   15  filler             pic  x(50)                  .
                   15  filler             pic  x(50)                  .
                   15  filler             pic  x(50)                  .
               10  w-exp-tor-csf-t00.
                   15  filler             pic  x(50) value
      ...
      *                  * Tipo classe statistica fornitore            *
      *                  *---------------------------------------------*
           perform   acc-tcs-fnt-000      thru acc-tcs-fnt-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
       acc-ric-sel-150.
      *                  *---------------------------------------------*
      *                  * Codice classe statistica fornitore          *
      *                  *---------------------------------------------*
           perform   acc-ccs-fnt-000      thru acc-ccs-fnt-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * ca fornitore                                *
      *                  *---------------------------------------------*
           perform   acc-tor-csf-000      thru acc-tor-csf-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * Tipo classe statistica fornitore                *
      *              *-------------------------------------------------*
           perform   pmt-tcs-fnt-000      thru pmt-tcs-fnt-999        .
      *              *-------------------------------------------------*
      *              * Codice classe statistica fornitore              *
      *              *-------------------------------------------------*
           perform   pmt-ccs-fnt-000      thru pmt-ccs-fnt-999        .
      *              *-------------------------------------------------*
      *              * Tipo di dettaglio di stampa                     *
      *              *-------------------------------------------------*
      ...
      *              * fornitore                                       *
      *              *-------------------------------------------------*
           perform   pmt-tor-csf-000      thru pmt-tor-csf-999        .
      *              *-------------------------------------------------*
      *              * Tipo di ordinamento per fornitori               *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Prompt : Tipo classe statistica fornitore                 *
      *    *-----------------------------------------------------------*
       pmt-tcs-fnt-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Classe statistica fornitore:"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tcs-fnt-999.
      ...
      *    *===========================================================*
      *    * Prompt : Codice classe statistica fornitore               *
      *    *-----------------------------------------------------------*
       pmt-ccs-fnt-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           if        rr-tcs-fnt           =    01
                     move  "Codice zona                :"
                                          to   v-alf
           else if   rr-tcs-fnt           =    02
                     move  "Codice categoria           :"
                                          to   v-alf
           else if   rr-tcs-fnt           =    03
      ...
      *    *===========================================================*
      *    * Accettazione : Tipo classe statistica fornitori           *
      *    *-----------------------------------------------------------*
       acc-tcs-fnt-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      rr-tcs-fnt           to   w-sav-tcs-fnt          .
       acc-tcs-fnt-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tcs-fnt-lun    to   v-car                  .
           move      w-exp-tcs-fnt-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      05                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-tcs-fnt-tbl    to   v-txt                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      rr-tcs-fnt           to   v-num                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-tcs-fnt-999.
       acc-tcs-fnt-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-tcs-fnt             .
       acc-tcs-fnt-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tcs-fnt           =    zero           or
                     rr-tcs-fnt           >    w-exp-tcs-fnt-num
                     go to acc-tcs-fnt-100.
       acc-tcs-fnt-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tcs-fnt           =    w-sav-tcs-fnt
                     go to acc-tcs-fnt-800.
       acc-tcs-fnt-650.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      zero                 to   rr-ccs-fnt             .
           perform   vis-ccs-fnt-000      thru vis-ccs-fnt-999        .
       acc-tcs-fnt-665.
      *                      *-----------------------------------------*
      *                      * Codice classe statistica, descrizione   *
      *                      *-----------------------------------------*
           move      spaces               to   rr-ccs-fnt-des         .
           perform   vis-ccs-fnt-des-000  thru vis-ccs-fnt-des-999    .
       acc-tcs-fnt-670.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           perform   vis-tor-csf-000      thru vis-tor-csf-999        .
       acc-tcs-fnt-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Codice classe statistica fornitori         *
      *    *-----------------------------------------------------------*
       acc-ccs-fnt-000.
      *              *-------------------------------------------------*
      *              * Test preliminari                                *
      ...
      *              *-------------------------------------------------*
           if        rr-tcs-fnt           =    01
                     go to acc-ccs-fnt-100
           else if   rr-tcs-fnt           =    02
                     go to acc-ccs-fnt-200
           else if   rr-tcs-fnt           =    03
                     go to acc-ccs-fnt-300
           else      go to acc-ccs-fnt-999.
       acc-ccs-fnt-100.
      *              *-------------------------------------------------*
      *              * Se classe statistica 01 : Zona                  *
      *              *-------------------------------------------------*
           perform   acc-ccs-fnt-zon-000  thru acc-ccs-fnt-zon-999    .
           go to     acc-ccs-fnt-999.
       acc-ccs-fnt-200.
      *              *-------------------------------------------------*
      *              * Se classe statistica 02 : Categoria             *
      *              *-------------------------------------------------*
           perform   acc-ccs-fnt-cat-000  thru acc-ccs-fnt-cat-999    .
           go to     acc-ccs-fnt-999.
       acc-ccs-fnt-300.
      *              *-------------------------------------------------*
      *              * Se classe statistica 03 : Codice statistico     *
      *              *-------------------------------------------------*
           perform   acc-ccs-fnt-stt-000  thru acc-ccs-fnt-stt-999    .
           go to     acc-ccs-fnt-999.
       acc-ccs-fnt-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-ccs-fnt           to   w-cmn-yst-001-cod      .
           move      07                   to   w-cmn-yst-001-lin      .
           move      30                   to   w-cmn-yst-001-pos      .
           move      07                   to   w-cmn-yst-001-dln      .
           move      41                   to   w-cmn-yst-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
       ...
       acc-ccs-fnt-zon-110.
           ...
           if        w-cmn-yst-001-ope    =    "F+"
                     go to acc-ccs-fnt-zon-115.
           if        w-cmn-yst-001-ope    =    "AC"
                     go to acc-ccs-fnt-zon-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-ccs-fnt-zon-115.
           perform   cmn-yst-001-foi-000  thru cmn-yst-001-foi-999    .
           go to     acc-ccs-fnt-zon-110.
       acc-ccs-fnt-zon-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-ccs-fnt-zon-999.
       acc-ccs-fnt-zon-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-ccs-fnt             .
       acc-ccs-fnt-zon-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-ccs-fnt           to   w-let-arc-yst-cod      .
      ...
      *                  *---------------------------------------------*
           if        rr-ccs-fnt           =    zero
                     go to acc-ccs-fnt-zon-650.
           move      zero                 to   rr-tor-csf             .
           perform   vis-tor-csf-000      thru vis-tor-csf-999        .
       acc-ccs-fnt-zon-650.
      *                  *---------------------------------------------*
      *                  * Fine dipendenze dall'impostazione           *
      *                  *---------------------------------------------*
           go to     acc-ccs-fnt-zon-800.
       acc-ccs-fnt-zon-800.
      *              *-------------------------------------------------*
      *              * Se Do                                           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-ccs-fnt           to   w-cmn-yst-002-cod      .
           move      07                   to   w-cmn-yst-002-lin      .
           move      30                   to   w-cmn-yst-002-pos      .
           move      07                   to   w-cmn-yst-002-dln      .
           move      41                   to   w-cmn-yst-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-ccs-fnt-cat-110.
           ...
           if        w-cmn-yst-002-ope    =    "F+"
                     go to acc-ccs-fnt-cat-115.
           if        w-cmn-yst-002-ope    =    "AC"
                     go to acc-ccs-fnt-cat-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-ccs-fnt-cat-115.
           perform   cmn-yst-002-foi-000  thru cmn-yst-002-foi-999    .
           go to     acc-ccs-fnt-cat-110.
       acc-ccs-fnt-cat-120.
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-ccs-fnt           to   w-cmn-yst-003-cod      .
           move      07                   to   w-cmn-yst-003-lin      .
           move      30                   to   w-cmn-yst-003-pos      .
           move      07                   to   w-cmn-yst-003-dln      .
           move      41                   to   w-cmn-yst-003-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
       ...
       acc-ccs-fnt-stt-110.
           ...
           if        w-cmn-yst-003-ope    =    "F+"
                     go to acc-ccs-fnt-stt-115.
           if        w-cmn-yst-003-ope    =    "AC"
                     go to acc-ccs-fnt-stt-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-ccs-fnt-stt-115.
           perform   cmn-yst-003-foi-000  thru cmn-yst-003-foi-999    .
           go to     acc-ccs-fnt-stt-110.
       acc-ccs-fnt-stt-120.
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice classe statistica fornitori      *
      *    *-----------------------------------------------------------*
       vis-ccs-fnt-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice classe statistica fornitori, de- *
      *    *                   scrizione                               *
      *    *-----------------------------------------------------------*
       vis-ccs-fnt-des-000.
           move      "DS"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           if        rr-gen-grf           not  = "S"
                     go to acc-tor-csf-025.
      *                  *---------------------------------------------*
      *                  * Ordinamento ABC decrescente                 *
      *                  *---------------------------------------------*
           move      01                   to   rr-tor-csf             .
           perform   vis-tor-csf-000      thru vis-tor-csf-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     acc-tor-csf-999.
       acc-tor-csf-025.
      *                  *---------------------------------------------*
      *                  * Se impostato un codice classificazione sta- *
      *                  * tistica fornitori diverso da zero : no ac-  *
      *                  * cettazione                                  *
      *                  *---------------------------------------------*
           if        rr-ccs-fnt           =    zero
                     go to acc-tor-csf-050
           else      go to acc-tor-csf-999.
       acc-tor-csf-050.
      *                  *---------------------------------------------*
      *                  * Preparazione tabella per accettazione campo *
      *                  * espanso in funzione del tipo di classe sta- *
      ...
      *                  *---------------------------------------------*
           if        rr-tcs-fnt           =    01
                     move  w-exp-tor-csf-t01
                                          to   w-exp-tor-csf-tbl
           else if   rr-tcs-fnt           =    02
                     move  w-exp-tor-csf-t02
                                          to   w-exp-tor-csf-tbl
           else if   rr-tcs-fnt           =    03
                     move  w-exp-tor-csf-t03
                                          to   w-exp-tor-csf-tbl
           else      move  w-exp-tor-csf-t00
                                          to   w-exp-tor-csf-tbl      .
       acc-tor-csf-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tor-csf-lun    to   v-car                  .
           move      w-exp-tor-csf-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      11                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-tor-csf-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      rr-tor-csf           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  * Che sia un valore consentito                *
      *                  *---------------------------------------------*
           if        rr-tor-csf           =    zero           or
                     rr-tor-csf           >    w-exp-tor-csf-num
                     go to acc-tor-csf-100.
       acc-tor-csf-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-050.
      *              *-------------------------------------------------*
      *              * Controllo : Tipo classe statistica fornitore    *
      *              *-------------------------------------------------*
       tdo-ric-sel-051.
           if        rr-tcs-fnt           not  = zero
      ...
      *              *             statistica fornitore                *
      *              *-------------------------------------------------*
       tdo-ric-sel-201.
           if        rr-ccs-fnt           not  = zero
                     go to tdo-ric-sel-250.
           if        rr-tor-csf           not  = zero
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-yst-mne-cls       to   w-let-arc-yst-mne      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   w-let-arc-yst-mne      .
           go to     let-arc-yst-999.
       let-arc-yst-500.
      *              *-------------------------------------------------*
