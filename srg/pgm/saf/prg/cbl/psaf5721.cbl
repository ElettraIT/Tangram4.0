      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psaf5721:       *
      *                                                                *
      ...
      *            *---------------------------------------------------*
               10  srt-k01.
      *                *-----------------------------------------------*
      *                * Numero progressivo record [dpm] letto da fil- *
      *                * tro di ordinamento e selezione prodotti [dpm] *
      *                *-----------------------------------------------*
                   15  srt-k01-ctr-dpm    pic  9(08)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-stp-srt-inp.
      *        *-------------------------------------------------------*
      *        * Contatore records [dpm] letti da filtro di selezione  *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-sel-fft-mne-arc          pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Ragione sociale per il fornitore                      *
      *        *-------------------------------------------------------*
           05  w-sel-fft-rag-arc          pic  x(40)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-sel-ffr-alf-mag          pic  x(14)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione prodotto                                  *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-des-mag          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Unita' di misura di vendita per il prodotto           *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-umi-mag          pic  x(03)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-sel-ffr-cla-map          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Gruppo merceologico del prodotto                      *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-gru-map          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Sottogruppo merceologico del prodotto                 *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-sgr-map          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Tipo di prodotto                                      *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-tip-pro          pic  9(02)                  .
      ...
      *            * Codice numerico del prodotto                      *
      *            *---------------------------------------------------*
               10  w-stp-ced-map-num      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Codice alfanumerico del prodotto                  *
      *            *---------------------------------------------------*
               10  w-stp-ced-map-alf      pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Descrizione del prodotto                          *
      *            *---------------------------------------------------*
               10  w-stp-ced-map-des      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Area editata di comodo                            *
      *            *---------------------------------------------------*
               10  w-stp-ced-map-e40      pic  x(40)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Inizializzazione contatore records [dpm] letti  *
      ...
      *              *-------------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-300.
      *              *-------------------------------------------------*
      *              * Incremento contatore records [dpm] letti da     *
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-150.
      *              *-------------------------------------------------*
      *              * Ciclo di scansione file [ffr] per un solo pro-  *
      *              * dotto                                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Inizializzazione lettura sequenziale archi- *
      *                  * vio [ffr] per un solo prodotto              *
      *                  *---------------------------------------------*
           perform   fil-ffr-ing-000      thru fil-ffr-ing-999        .
       stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Lettura sequenziale archivio [ffr] per un   *
      *                  * solo prodotto                               *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       fil-ffr-ing-000.
      *              *-------------------------------------------------*
      *              * Richiamo funzione 'CS' del modulo 'mffoffr0'    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione                                *
      *                  *---------------------------------------------*
      ...
      *                      * Tipo voce di magazzino                  *
      *                      *-----------------------------------------*
           move      03                   to   w-mod-ffo-ffr-tmg      .
      *                      *-----------------------------------------*
      *                      * Codice prodotto                         *
      *                      *-----------------------------------------*
           move      rf-dpm-num-map       to   w-mod-ffo-ffr-pro      .
      *                      *-----------------------------------------*
      *                      * Numero periodi di riferimento           *
      *                      *-----------------------------------------*
           if        rr-num-pdr           =    11 or
      ...
      *                      *-----------------------------------------*
           if        rr-num-pdr           =    21   or
                     rr-num-pdr           =    22
                     move  rr-dat-val     to   w-mod-ffo-ffr-p2i      .
      *                      *-----------------------------------------*
      *                      * 2. periodo, data max                    *
      *                      *-----------------------------------------*
      ...
      *                  * Chiamata modulo                             *
      *                  *---------------------------------------------*
           perform   mod-ffo-ffr-cds-000  thru mod-ffo-ffr-cds-999    .
       fil-ffr-ing-999.
           exit.

      *    *===========================================================*
      *    * Lettura sequenziale archivio [ffr] per un solo codice     *
      *    * prodotto                                                  *
      *    *-----------------------------------------------------------*
       fil-ffr-get-000.
      *              *-------------------------------------------------*
      *              * Richiamo funzione 'CG' del modulo 'mffoffr0'    *
      *              *-------------------------------------------------*
           perform   mod-ffo-ffr-cdg-000  thru mod-ffo-ffr-cdg-999    .
       fil-ffr-get-999.
           exit.
      ...
      *                      * Ragione sociale per il fornitore        *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-rag    to   w-sel-fft-rag-arc      .
      *                      *-----------------------------------------*
      *                      * Mnemonico per il fornitore              *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-mne    to   w-sel-fft-mne-arc      .
       sel-fft-rec-200.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       sel-ffr-rec-000.
      *              *-------------------------------------------------*
      *              * Forzatura tipo voce di magazzino                *
      *              *-------------------------------------------------*
           move      03                   to   w-sel-ffr-tip-mag      .
      *              *-------------------------------------------------*
      *              * Test su tipo voce di magazzino                  *
      *              *-------------------------------------------------*
           if        rf-ffr-tip-mag       =    w-sel-ffr-tip-mag
                     go to sel-ffr-rec-050
           else      go to sel-ffr-rec-900.
       sel-ffr-rec-050.
      *              *-------------------------------------------------*
      *              * Bufferizzazione anagrafica [dpm]                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Dati letti in area di comodo                *
      *                  *---------------------------------------------*
      ...
      *                      * Codice prodotto numerico                *
      *                      *-----------------------------------------*
           move      rf-dpm-num-map       to   w-sel-ffr-num-mag      .
      *                      *-----------------------------------------*
      *                      * Codice prodotto alfanumerico            *
      *                      *-----------------------------------------*
           move      rf-dpm-alf-map       to   w-sel-ffr-alf-mag      .
      *                      *-----------------------------------------*
      *                      * Descrizione prodotto                    *
      *                      *-----------------------------------------*
           move      rf-dpm-des-map       to   w-sel-ffr-des-mag      .
      *                      *-----------------------------------------*
      *                      * Unita' di misura di vendita per il pro- *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      rf-dpm-umi-prd       to   w-sel-ffr-umi-mag      .
      *                      *-----------------------------------------*
      *                      * Numero decimali quantita' per il pro-   *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      rf-dpm-dec-qta       to   w-sel-ffr-dec-pro      .
      *                      *-----------------------------------------*
      *                      * Classe merceologica del prodotto        *
      *                      *-----------------------------------------*
           move      rf-dpm-cla-map       to   w-sel-ffr-cla-map      .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico del prodotto        *
      *                      *-----------------------------------------*
           move      rf-dpm-gru-map       to   w-sel-ffr-gru-map      .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico del prodotto   *
      *                      *-----------------------------------------*
           move      rf-dpm-sgr-map       to   w-sel-ffr-sgr-map      .
      *                      *-----------------------------------------*
      *                      * Tipo di prodotto                        *
      *                      *-----------------------------------------*
           move      rf-dpm-tip-map       to   w-sel-ffr-tip-pro      .
       sel-ffr-rec-300.
      *              *-------------------------------------------------*
      ...
      *                  * dal filtro di selezione prodotti [dpm]      *
      *                  *---------------------------------------------*
           go to     sel-ffr-rec-400.
       sel-ffr-rec-400.
      *              *-------------------------------------------------*
      *              * Uscita per selezione superata                   *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       cmp-srt-rec-210.
      *                      *-----------------------------------------*
      *                      * Numero progressivo record [dpm] letto   *
      *                      * da filtro di selezione                  *
      *                      *-----------------------------------------*
           move      w-stp-srt-inp-ctr    to   srt-k01-ctr-dpm        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per documento                 *
      *                  *---------------------------------------------*
      ...
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-fft-dat-doc       to   srt-k02-dat-doc        .
       cmp-srt-rec-310.
      *                      *-----------------------------------------*
      *                      * Tipo documento                          *
      *                      *-----------------------------------------*
           move      rf-fft-cod-tmf       to   srt-k02-tip-doc        .
       cmp-srt-rec-315.
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      rf-fft-num-doc       to   srt-k02-num-doc        .
       cmp-srt-rec-800.
      *              *-------------------------------------------------*
      *              * Area dati                                       *
      *              *-------------------------------------------------*
      ...
      *                      * Codice numerico del prodotto            *
      *                      *-----------------------------------------*
           move      w-sel-ffr-num-mag    to   srt-cod-map-num        .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico del prodotto        *
      *                      *-----------------------------------------*
           move      w-sel-ffr-alf-mag    to   srt-cod-map-alf        .
      *                      *-----------------------------------------*
      *                      * Descrizione del prodotto                *
      *                      *-----------------------------------------*
           move      w-sel-ffr-des-mag    to   srt-cod-map-des        .
      *                      *-----------------------------------------*
      *                      * Unita' di misura del prodotto           *
      *                      *-----------------------------------------*
           move      w-sel-ffr-umi-mag    to   srt-cod-map-umi        .
      *                      *-----------------------------------------*
      *                      * Numero decimali del prodotto            *
      *                      *-----------------------------------------*
           move      w-sel-ffr-dec-pro    to   srt-cod-map-dec        .
      *                      *-----------------------------------------*
      *                      * Classe merceologica                     *
      *                      *-----------------------------------------*
           move      w-sel-ffr-cla-map    to   srt-cod-map-cla        .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico                     *
      *                      *-----------------------------------------*
           move      w-sel-ffr-gru-map    to   srt-cod-map-gru        .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico                *
      *                      *-----------------------------------------*
           move      w-sel-ffr-sgr-map    to   srt-cod-map-sgr        .
      *                      *-----------------------------------------*
      *                      * Tipo di prodotto                        *
      *                      *-----------------------------------------*
           move      w-sel-ffr-tip-pro    to   srt-cod-map-tip        .
       cmp-srt-rec-850.
      *                  *---------------------------------------------*
      *                  * Cliente                                     *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-sel-fft-mne-arc    to   srt-cod-fnt-mne        .
      *                      *-----------------------------------------*
      *                      * Ragione sociale del fornitore           *
      *                      *-----------------------------------------*
           move      w-sel-fft-rag-arc    to   srt-cod-fnt-rag        .
       cmp-srt-rec-875.
      *                  *---------------------------------------------*
      *                  * Estremi del documento                       *
      *                  *---------------------------------------------*
      ...
      *                      * Costo del fatturato                     *
      *                      *-----------------------------------------*
           move      w-mod-ffo-ffr-cos    to   srt-val-sta-cos        .
      *                      *-----------------------------------------*
      *                      * Incidenza sulla statistica              *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tip-ord-tip-ord    =    03 or
                     w-tip-ord-tip-ord    =    04 or
                     w-tip-ord-tip-ord    =    05
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-cod-map-cla      to   kk0-cod-cla            .
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-cod-map-cla      to   kk0-cod-cla            .
           move      srt-cod-map-gru      to   kk0-cod-gru            .
           move      zero                 to   kk0-cod-sgr            .
           move      zero                 to   kk0-num-pro            .
           read      kk0    invalid key
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-cod-map-cla      to   kk0-cod-cla            .
           move      srt-cod-map-gru      to   kk0-cod-gru            .
           move      srt-cod-map-sgr      to   kk0-cod-sgr            .
           move      zero                 to   kk0-num-pro            .
           read      kk0    invalid key
      ...
      *                  *---------------------------------------------*
           ...
           move      zero                 to   kk0-cod-gru            .
           move      zero                 to   kk0-cod-sgr            .
           move      srt-cod-map-num      to   kk0-num-pro            .
           read      kk0    invalid key
      ...
      *                  *---------------------------------------------*
           move      srt-cod-map-cla      to   w-rot-l04-cod-cla      .
      *                  *---------------------------------------------*
      *                  * Composizione area per rottura gruppo        *
      *                  *---------------------------------------------*
           move      srt-cod-map-gru      to   w-rot-l03-cod-gru      .
      *                  *---------------------------------------------*
      *                  * Composizione area per rottura sottogruppo   *
      *                  *---------------------------------------------*
           move      srt-cod-map-sgr      to   w-rot-l02-cod-sgr      .
      *                  *---------------------------------------------*
      *                  * Oltre                                       *
      *                  *---------------------------------------------*
      ...
      *              * Codice numerico del prodotto                    *
      *              *-------------------------------------------------*
           move      srt-cod-map-num      to   w-rot-l01-num-pro      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
       ...
       prn-ini-cic-600.
      *              *-------------------------------------------------*
      *              * Se ordinamento per Codice, Descrizione, Sinn.   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Intestazione foglio                         *
      *                  *---------------------------------------------*
      ...
      *                  * Lettura dati classe                         *
      *                  *---------------------------------------------*
           move      w-rot-l04-cod-cla    to   w-let-arc-zm1-cla      .
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-cla-qta-p1r    to   w-mod-not-saf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-cla-tot-p1r    to   w-mod-not-saf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-cla-qta-p2r    to   w-mod-not-saf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-cla-tot-p2r    to   w-mod-not-saf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-saf-p01      .
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-cla-qta-p3r    to   w-mod-not-saf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-cla-tot-p3r    to   w-mod-not-saf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-saf-p02      .
      ...
      *                  * Lettura dati gruppo                         *
      *                  *---------------------------------------------*
           move      w-rot-l04-cod-cla    to   w-let-arc-zm2-cla      .
           move      w-rot-l03-cod-gru    to   w-let-arc-zm2-gru      .
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-gru-qta-p1r    to   w-mod-not-saf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-gru-tot-p1r    to   w-mod-not-saf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-gru-qta-p2r    to   w-mod-not-saf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-gru-tot-p2r    to   w-mod-not-saf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-saf-p01      .
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-gru-qta-p3r    to   w-mod-not-saf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-gru-tot-p3r    to   w-mod-not-saf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-saf-p02      .
      ...
      *                  *---------------------------------------------*
           move      w-rot-l04-cod-cla    to   w-let-arc-zm3-cla      .
           move      w-rot-l03-cod-gru    to   w-let-arc-zm3-gru      .
           move      w-rot-l02-cod-sgr    to   w-let-arc-zm3-sgr      .
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-sgr-qta-p1r    to   w-mod-not-saf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-sgr-tot-p1r    to   w-mod-not-saf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-sgr-qta-p2r    to   w-mod-not-saf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-sgr-tot-p2r    to   w-mod-not-saf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-saf-p01      .
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-sgr-qta-p3r    to   w-mod-not-saf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-sgr-tot-p3r    to   w-mod-not-saf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-saf-p02      .
      ...
      *                  * Codice numerico del prodotto                *
      *                  *---------------------------------------------*
           move      srt-cod-map-num      to   w-liv-pro-num-pro      .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico del prodotto            *
      *                  *---------------------------------------------*
           move      srt-cod-map-alf      to   w-liv-pro-alf-pro      .
      *                  *---------------------------------------------*
      *                  * Descrizione per il prodotto                 *
      *                  *---------------------------------------------*
           move      srt-cod-map-des      to   w-liv-pro-des-pro      .
      *                  *---------------------------------------------*
      *                  * Flag di unita' di misura memorizzata        *
      *                  *---------------------------------------------*
      ...
      *                      * 1. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-qta-p1r    to   w-mod-not-saf-q01      .
      *                      *-----------------------------------------*
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-tot-p1r    to   w-mod-not-saf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-qta-p2r    to   w-mod-not-saf-q02      .
      *                      *-----------------------------------------*
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-tot-p2r    to   w-mod-not-saf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-saf-p01      .
      ...
      *                      * 3. quantita'                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-qta-p3r    to   w-mod-not-saf-q03      .
      *                      *-----------------------------------------*
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-pro-tot-p3r    to   w-mod-not-saf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-saf-p02      .
      ...
      *                          * Codice numerico del prodotto        *
      *                          *-------------------------------------*
           move      w-liv-pro-num-pro    to   w-stp-ced-map-num      .
      *                          *-------------------------------------*
      *                          * Codice alfanumerico del prodotto    *
      *                          *-------------------------------------*
           move      w-liv-pro-alf-pro    to   w-stp-ced-map-alf      .
      *                          *-------------------------------------*
      *                          * Descrizione del prodotto            *
      *                          *-------------------------------------*
           move      w-liv-pro-des-pro    to   w-stp-ced-map-des      .
       prn-fin-lr1-332.
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   stp-ced-map-000      thru stp-ced-map-999        .
       prn-fin-lr1-340.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-liv-gen-flg-umi    =    spaces
                     ...
                     move  srt-cod-map-umi
                                          to   w-liv-gen-val-umi
           else if   w-liv-gen-val-umi    not  = srt-cod-map-umi
      ...
      *                  *---------------------------------------------*
           ...
           else if   w-liv-cla-val-umi    not  = srt-cod-map-umi
      ...
      *                  *---------------------------------------------*
           ...
           else if   w-liv-gru-val-umi    not  = srt-cod-map-umi
      ...
      *                  *---------------------------------------------*
           ...
           else if   w-liv-sgr-val-umi    not  = srt-cod-map-umi
      ...
      *                  *---------------------------------------------*
           ...
           else if   w-liv-pro-val-umi    not  = srt-cod-map-umi
      ...
      *                  *---------------------------------------------*
           if        w-liv-gen-flg-dec    =    spaces
                     ...
                     move  srt-cod-map-dec
                                          to   w-liv-gen-val-dec
           else if   w-liv-gen-val-dec    not  = srt-cod-map-dec
      ...
      *                  *---------------------------------------------*
           ...
           else if   w-liv-cla-val-dec    not  = srt-cod-map-dec
      ...
      *                  *---------------------------------------------*
           ...
           else if   w-liv-gru-val-dec    not  = srt-cod-map-dec
      ...
      *                  *---------------------------------------------*
           ...
           else if   w-liv-sgr-val-dec    not  = srt-cod-map-dec
      ...
      *                  *---------------------------------------------*
           ...
           else if   w-liv-pro-val-dec    not  = srt-cod-map-dec
      ...
      *                          *-------------------------------------*
           move      srt-cod-map-dec      to   w-stp-sta-qfe-dec      .
      *                          *-------------------------------------*
      *                          * Unita' di misura per quantita'      *
      *                          *-------------------------------------*
           move      srt-cod-map-umi      to   w-stp-sta-qfe-umi      .
      *                          *-------------------------------------*
      *                          * Quantita' fatturata                 *
      *                          *-------------------------------------*
      ...
      *                  * lineato a sinistra                          *
      *                  *---------------------------------------------*
           move      "PER SELEZIONE SU MATERIE PRIME                    
      -              "                              "
      ...
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-ced-map-num : Codice numerico prodotto          *
      *    *                                                           *
      *    *   - w-stp-ced-map-alf : Codice alfanumerico prodotto      *
      *    *                                                           *
      *    *   - w-stp-ced-map-des : Descrizione del prodotto          *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       stp-ced-map-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-stp-ced-map-alf    =    spaces
                     go to stp-ced-map-150.
       stp-ced-map-100.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      w-stp-ced-map-alf    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-ced-map-110.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<"                  to   p-edm                  .
           move      w-stp-ced-map-num    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                          *-------------------------------------*
      *                          * Composizione area editata           *
      *                          *-------------------------------------*
           move      spaces               to   w-stp-ced-map-e40      .
           string    "(Cod. "   delimited by   size
                     p-edt      delimited by   spaces
                     ")"        delimited by   size
                                          into w-stp-ced-map-e40      .
       stp-ced-map-160.
      *                      *-----------------------------------------*
      *                      * Stampa                                  *
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      w-stp-ced-map-e40    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-ced-map-165.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-stp-ced-map-des    =    spaces
                     go to stp-ced-map-450.
       stp-ced-map-400.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      017                  to   p-pos                  .
           move      w-stp-ced-map-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-ced-map-410.
      *                      *-----------------------------------------*
      ...
      *    *                                                           *
      *    *   - w-stp-sta-qfe-ndo : Numero documento                  *
      *    *                                                           *
