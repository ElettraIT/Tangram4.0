      ...
      *                       Ultima revisione:    NdK del 01/10/09    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psaf2801:        *
      *                                                                *
      *                    Stampa statistica di acquisto sul fatturato *
      *                    per fornitore - materiale vario             *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FATTURATO PER FORNIT. - MATERIALE VARIO "       .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "Solo il totale per ogni materiale                 ".
                   15  filler             pic  x(50) value
                  "Con la lista documenti emessi per ogni materiale  ".
                   15  filler             pic  x(50)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tor-pro.
               ...
               10  w-exp-tor-pro-tbl.
                  ...
                  "Ordinamento ABC crescente sulla quantita'         ".
                   15  filler             pic  x(50) value
                  "Ordinamento per codice materiale vario            ".
                   15  filler             pic  x(50) value
                  "Ordinamento per descrizione materiale vario       ".
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       pmt-fso-mtv-000.
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Filtro selezione materiali :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-fso-mtv-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      10                   to   w-cod-zos-mtv-lin      .
           move      30                   to   w-cod-zos-mtv-pos      .
           move      10                   to   w-cod-zos-mtv-dln      .
      ...
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        rr-fso-mtv           <    10000000 or
                     rr-fso-mtv           >    19999999
                     go to acc-fso-mtv-650.
      *                      *-----------------------------------------*
      ...
      *    *                   zione su anagrafica materiali [mtv]     *
      *    *-----------------------------------------------------------*
       vis-des-fso-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * materiali [mtv] indica la selezione di un   *
      *                  * solo materiale : no accettazione            *
      *                  *---------------------------------------------*
           if        rr-fso-mtv           not  < 10000000 and
                     rr-fso-mtv           not  > 19999999
