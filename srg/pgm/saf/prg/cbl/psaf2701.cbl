      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psaf2701:       *
      *                                                                *
      ...
      *                *-----------------------------------------------*
      *                * Codice numerico per la materia prima          *
      *                *-----------------------------------------------*
      ...
      *                * Valore ABC                                    *
      *                *                                               *
      *                * Solo per tipo ordinamento materia prima :     *
      *                *                                               *
      *                * - ABC decrescente sul fatturato               *
      *                * - ABC decrescente sulla quantita'             *
      *                * - ABC crescente sul fatturato                 *
      ...
      *                * non trovato in archivio materie prime         *
      *                *                                               *
      *                *   - 1 : Esistente                             *
      *                *   - 5 : Non esistente                         *
      *                *   - 9 : Codice a zero                         *
      *                *                                               *
      *                * Per tutti i tipi ordinamento materia prima    *
      *                *-----------------------------------------------*
                   15  srt-k02-flg-eon    pic  9(01)                  .
      *                *-----------------------------------------------*
      *                * Descrizione per la materia prima              *
      *                *                                               *
      *                * Solo per tipo ordinamento materia prima :     *
      *                *                                               *
      *                * - ABC decrescente sul fatturato               *
      ...
      *                * Per tutti i tipi ordinamento materia prima    *
      *                *-----------------------------------------------*
                   15  srt-k02-alf-pro    pic  x(14)                  .
      *                *-----------------------------------------------*
      *                * Codice numerico materia prima                 *
      *                *                                               *
      *                * Per tutti i tipi ordinamento materia prima    *
      *                *-----------------------------------------------*
                   15  srt-k02-num-pro    pic  9(07)                  .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  srt-cod-pro.
      *                *-----------------------------------------------*
      *                * Codice materia prima, codice numerico         *
      *                *-----------------------------------------------*
                   15  srt-cod-pro-cod    pic  9(07)                  .
      *                *-----------------------------------------------*
      *                * Codice materia prima, codice alfanumerico     *
      *                *-----------------------------------------------*
      ...
      *                *-----------------------------------------------*
      *                * Codice materia prima, numero decimali quant.  *
      *                *-----------------------------------------------*
      ...
      *                *-----------------------------------------------*
      *                * Valore ABC per la materia prima nell'ambito   *
      *                * del fornitore                                 *
      *                *-----------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Numero documenti trattati per la materia prima    *
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Numero materie prime trattate per il fornitore    *
      *            *---------------------------------------------------*
               10  w-liv-fnt-num-pro      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *        *-------------------------------------------------------*
      *        * Unita' di misura di acquisto per la materia prima     *
      *        *-------------------------------------------------------*
           05  w-sel-ffr-umi-pro          pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Numero decimali quantita' per la materia prima        *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per stampa del codice materia prima, della   *
      *        * sua descrizione                                       *
      *        *-------------------------------------------------------*
           05  w-stp-ced-pro.
      *            *---------------------------------------------------*
      ...
      *              * 'Fatturato' sulle statistiche di acquisto sul   *
      ...
      *              * di acquisto sul fatturato da Testate Documenti  *
      *              *-------------------------------------------------*
      ...
      *              * dotti [dpm] indica la selezione di un solo co-  *
      *              * dice materia prima, ed il codice materia prima  *
      *              * della riga in esame non corrisponde a quello da *
      *              * selezionare : uscita per selezione non superata *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-fso-dpm           <    10000000 or
                     rr-fso-dpm           >    19999999
                     go to sel-ffr-rec-100.
      *                  *---------------------------------------------*
      *                  * Test su codice materia prima                *
      *                  *---------------------------------------------*
           subtract  10000000             from rr-fso-dpm
                                        giving w-sel-ffr-num-pro      .
           if        rf-ffr-num-mag       =    w-sel-ffr-num-pro
                     go to sel-ffr-rec-100
           else      go to sel-ffr-rec-900.
       sel-ffr-rec-100.
      *              *-------------------------------------------------*
      ...
      *                      * Codice materia prima numerico           *
      *                      *-----------------------------------------*
           move      w-let-arc-dpm-cod    to   w-sel-ffr-num-pro      .
      *                      *-----------------------------------------*
      *                      * Codice materia prima alfanumerico       *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Unita' di misura di acquisto per pro-   *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
      ...
      *              * Se il filtro di selezione sull'anagrafica pro-  *
      *              * dotti [dpm] indica la selezione di un solo co-  *
      *              * dice materia prima non si eseguono ulteriori    *
      *              * selezioni                                       *
      *              *-------------------------------------------------*
           if        rr-fso-dpm           not  < 10000000 and
                     rr-fso-dpm           not  > 19999999
                     go to sel-ffr-rec-500.
       sel-ffr-rec-300.
      *              *-------------------------------------------------*
      *              * Se record [dpm] non esistente : selezione non   *
      *              * superata                                        *
      *              *-------------------------------------------------*
      ...
      *              * lezione su anagrafica materie prime [dpm], e    *
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-sel-fft-cod-fnt    to   srt-k01-cod-fnt        .
       cmp-srt-rec-240.
      *                      *-----------------------------------------*
      *                      * Codice dipendenza del fornitore         *
      *                      *-----------------------------------------*
      ...
      *                      * ma non trovato in archivio materie pr.  *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Se codice a zero : si forza '9'     *
      *                          *-------------------------------------*
            if       w-sel-ffr-num-pro    =    zero
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Solo se tipo ordinamento materia :  *
      *                          *  - ABC decrescente sul fatturato    *
      *                          *  - ABC decrescente sulla quantita'  *
      *                          *  - ABC crescente sul fatturato      *
      *                          *  - ABC crescente sulla quantita'    *
      ...
      *                          *-------------------------------------*
           if        rr-tor-pro           not  = 01 and
                     ...
                     rr-tor-pro           not  = 06
                     move  spaces         to   srt-k02-des-pro
                     go to cmp-srt-rec-325.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-des-pro    to   srt-k02-des-pro        .
       cmp-srt-rec-325.
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-alf-pro    to   srt-k02-alf-pro        .
       cmp-srt-rec-335.
      *                      *-----------------------------------------*
      *                      * Codice numerico materia prima           *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-num-pro    to   srt-k02-num-pro        .
       cmp-srt-rec-400.
      *                  *---------------------------------------------*
      *                  * Subchiave 3 : Per documento                 *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Valore ABC per il materia prima nel-    *
      *                      * l'ambito del fornitore                  *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       agg-abc-kk0-500.
      *              *-------------------------------------------------*
      *              * Valore ABC per codice materia prima             *
      *              *-------------------------------------------------*
       agg-abc-kk0-525.
      *                  *---------------------------------------------*
      *                  * Se la statistica e' sul nuovo fatturato o   *
      ...
      *                  *---------------------------------------------*
      *                  * Solo se tipo ordinamento per materie p. :   *
      *                  *   - 01 : ABC decrescente sul fatturato      *
      *                  *   - 02 : ABC decrescente sulla quantita'    *
      *                  *   - 03 : ABC crescente sul fatturato        *
      *                  *   - 04 : ABC crescente sulla quantita'      *
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-cic-050.
      *              *-------------------------------------------------*
      *              * Se non sono state trattati almeno due fornito-  *
      *              * ri : uscita senza alcuna azione                 *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Numero materie p. trattate per il fornitore *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fnt-num-pro      .
      *                  *---------------------------------------------*
      *                  * Numero di fornitori trattati in totale      *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Numero documenti trattati per materia prima *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-pro-num-doc      .
      *                  *---------------------------------------------*
      *                  * Numero materie p. trattate per il fornitore *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-fnt-num-pro      .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr1-330.
      *                  *---------------------------------------------*
      *                  * Subroutine per la stampa del codice materia *
      *                  * prima, della sua descrizione                *
      *                  *---------------------------------------------*
       prn-fin-lr1-331.
      *                      *-----------------------------------------*
      *                      * Preparazione                            *
      ...
      *                  *---------------------------------------------*
           if        w-cnt-prn-flg-int    not  = spaces
                     go to prn-fin-lr1-999.
      *                  *---------------------------------------------*
      *                  * A stampa totale materia prima, senza ese-   *
      *                  * guire una interlinea di separazione         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-300.
      *              *-------------------------------------------------*
      *              * Accumuli per livello materia prima              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Totali 1. periodo di riferimento            *
      *                  *---------------------------------------------*
      ...
      *                  * mento trattato per materia prima oppure no  *
      *                  *---------------------------------------------*
      ...
      *                      * materia prima, della sua descrizione    *
      *                      *-----------------------------------------*
       prn-liv-det-651.
      *                          *-------------------------------------*
      *                          * Preparazione                        *
      ...
      *                  * materia prima, bensi' uno successivo        *
      *                  *---------------------------------------------*
       prn-liv-det-680.
      *                      *-----------------------------------------*
      *                      * Test se linee residue sufficienti       *
      ...
      *                  * lineato a sinistra                          *
      *                  *---------------------------------------------*
           move      "PER FORNITORE - MATERIA PRIMA                     
      -              "                              "
      ...
      *              * sta documenti emessi per ogni materia prima     *
      *              *-------------------------------------------------*
       stp-fnc-vrt-605.
      *                  *---------------------------------------------*
      *                  * Test se numero linee residue sufficienti    *
      ...
      *              * lista documenti emessi per ogni materia prima   *
      *              *-------------------------------------------------*
       stp-fds-tot-605.
      *                  *---------------------------------------------*
      *                  * Titolo di sinistra                          *
      ...
      *    *===========================================================*
      *    * Subroutine per la stampa del codice materia prima, della  *
      *    * sua descrizione                                           *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-ced-pro-num : Codice numerico materia prima     *
      *    *                                                           *
      *    *   - w-stp-ced-pro-alf : Codice alfanumerico materia prima *
      *    *                                                           *
      *    *   - w-stp-ced-pro-des : Descrizione materia prima         *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       stp-ced-pro-000.
      *              *-------------------------------------------------*
      ...
      *                  * alfanumerico del materia prima              *
      *                  *---------------------------------------------*
           if        w-stp-ced-pro-alf    =    spaces
                     go to stp-ced-pro-150.
       stp-ced-pro-100.
      *                  *---------------------------------------------*
      *                  * Se codice alfanumerico materia prima diver- *
      *                  * so da spaces                                *
      *                  *---------------------------------------------*
       stp-ced-pro-105.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       stp-ced-pro-150.
      *                  *---------------------------------------------*
      *                  * Se codice alfanumerico materia prima pari a *
      *                  * spaces                                      *
      *                  *---------------------------------------------*
       stp-ced-pro-155.
      *                      *-----------------------------------------*
      *                      * Costruzione area editata di comodo con  *
      *                      * il codice numerico della materia prima  *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      ...
      *                  * scrizione della materia prima               *
      *                  *---------------------------------------------*
           if        w-stp-ced-pro-des    =    spaces
                     go to stp-ced-pro-450.
       stp-ced-pro-400.
      *                  *---------------------------------------------*
      *                  * Se descrizione materia prima diversa da     *
      *                  * spaces                                      *
      *                  *---------------------------------------------*
       stp-ced-pro-405.
      *                      *-----------------------------------------*
      ...
      *                      * rico materia prima e' gia' stato stam-  *
      *                      * pato oppure no                          *
      *                      *-----------------------------------------*
           if        w-stp-ced-pro-alf    =    spaces
       ...
       stp-ced-pro-465.
      *                      *-----------------------------------------*
      *                      * Se il codice numerico materia prima e'  *
      *                      * gia' stato stampato                     *
      *                      *-----------------------------------------*
       stp-ced-pro-470.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
       ...
       stp-ced-pro-480.
      *                      *-----------------------------------------*
      *                      * Se il codice numerico materia prima non *
      *                      * e' ancora stato stampato                *
      *                      *-----------------------------------------*
       stp-ced-pro-485.
      *                          *-------------------------------------*
      *                          * Costruzione area editata di comodo  *
      *                          * con il codice numerico materia pr.  *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Editing codice numerico         *
      *                              *---------------------------------*
      ...
      *    * Fatturato, e Estremi del documento                        *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
