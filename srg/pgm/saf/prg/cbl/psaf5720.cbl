      ...
      *                                   Fase:    saf572              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 15/04/09    *
      *                       Ultima revisione:    NdK del 07/04/17    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psaf5721:        *
      *                                                                *
      *                    Stampa statistica di acquisto sul fatturato *
      *                    per materia prima con filtro di selezione.  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  FATTURATO PER SELEZIONE MATERIE PRIME "       .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-dts.
               ...
               10  w-exp-tip-dts-tbl.
                  ...
                  "Solo il totale per materia prima                  ".
                   15  filler             pic  x(50) value
                  "Con la lista documenti emessi per materia prima   ".
      *        *-------------------------------------------------------*
