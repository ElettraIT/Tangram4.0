      ...
      *                                   Fase:    saf260              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 11/09/06    *
      *                       Ultima revisione:    NdK del 11/09/06    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psaf2601:       *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per fornitore - classe statistica prodotto  *
      *                                                                *
      *================================================================*
      ...
      *                *   02 : Totale per classe statistica prodotto  *
      *                *-----------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Subchiave 2 : Per classe statistica prodotto      *
      *            *                                                   *
      *            * Per tutti i tipi di dettaglio stampa              *
      *            *---------------------------------------------------*
               10  srt-k02.
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " FATTURATO FORNITORE - CLASSE PRODOTTO  "       .
      ...
      *        *                                                       *
      *        *  - 01 : Solo il totale per ogni classe                *
      *        *  - 02 : Con la lista documenti emessi per ogni classe *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Tipo di ordinamento per classe statistica             *
      *        *                                                       *
      *        *  - 01 : Ordinamento ABC decrescente sul fatturato     *
      *        *  - 02 : Ordinamento ABC decrescente sulla quantita'   *
      *        *  - 03 : Ordinamento ABC crescente sul fatturato       *
      ...
      *            *---------------------------------------------------*
      *            * Numero documenti trattati per la classe           *
      *            *---------------------------------------------------*
               10  w-liv-csp-num-doc      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Fornitore                                             *
      *        *-------------------------------------------------------*
           05  w-liv-fnt.
      ...
      *            *---------------------------------------------------*
      *            * Numero classi trattati per il fornitore           *
      *            *---------------------------------------------------*
               10  w-liv-fnt-num-csp      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *        * Codice fornitore                                      *
      *        *-------------------------------------------------------*
           05  w-sel-fft-cod-arc          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice dipendenza per il fornitore                    *
      *        *-------------------------------------------------------*
           05  w-sel-fft-dpz-arc          pic  x(04)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per stampa del codice classe statistica pro- *
      *        * dotto, del mnemonico della classe, della descrizione  *
      *        * della classe                                          *
      *        *-------------------------------------------------------*
           05  w-stp-cmd-csp.
      *            *---------------------------------------------------*
      *            * Codice numerico della classe statistica prodotto  *
      *            *---------------------------------------------------*
               10  w-stp-cmd-csp-cod      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Mnemonico per la classe                           *
      *            *---------------------------------------------------*
               10  w-stp-cmd-csp-mne      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Descrizione per la classe                         *
      *            *---------------------------------------------------*
               10  w-stp-cmd-csp-des      pic  x(40)                  .
      *        *-------------------------------------------------------*
      ...
      *              * mento del codice fornitore in statistiche sul   *
      *              * fatturato                                       *
      *              *-------------------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-fnt    to   w-sel-fft-cod-arc      .
      *                      *-----------------------------------------*
      *                      * Codice dipendenza per il fornitore      *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-dpz    to   w-sel-fft-dpz-arc      .
      *                      *-----------------------------------------*
      *                      * Ragione sociale per il fornitore        *
      *                      *-----------------------------------------*
      ...
      *                      * Codice prodotto numerico                *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-cod    to   w-sel-ffr-num-mag      .
      *                      *-----------------------------------------*
      *                      * Codice prodotto alfanumerico            *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fft-rag-fnt    to   srt-k01-rag-fnt        .
       cmp-srt-rec-225.
      *                      *-----------------------------------------*
      *                      * Mnemonico fornitore                     *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fft-mne-fnt    to   srt-k01-mne-fnt        .
       cmp-srt-rec-230.
      *                      *-----------------------------------------*
      *                      * Flag di codice a zero o diverso da zero *
      *                      *-----------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-sel-fft-cod-arc    to   srt-k01-cod-fnt        .
       cmp-srt-rec-240.
      *                      *-----------------------------------------*
      *                      * Codice dipendenza del fornitore         *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-prs-saf-fnt-rgd    =    "S"
                     move  w-sel-fft-dpz-arc
                                          to   srt-k01-dpz-fnt
           else      move  spaces         to   srt-k01-dpz-fnt        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per classe statistica prodot- *
      *                  *               to                            *
      *                  *---------------------------------------------*
       cmp-srt-rec-310.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rr-tor-csp           not  = 01 and
                     ...
                     rr-tor-csp           not  = 04 and
                     rr-tor-csp           not  = 05
                     move  spaces         to   srt-k02-des-csp
                     go to cmp-srt-rec-325.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-des-csp    to   srt-k02-des-csp        .
       cmp-srt-rec-325.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rr-tor-csp           not  = 07
                     move  spaces         to   srt-k02-mne-csp
                     go to cmp-srt-rec-330.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-mne-csp    to   srt-k02-mne-csp        .
       cmp-srt-rec-330.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rr-tor-csp           not  = 08
                     move  zero           to   srt-k02-nsq-csp
                     go to cmp-srt-rec-340.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-nsq-csp    to   srt-k02-mne-csp        .
       cmp-srt-rec-340.
      *                      *-----------------------------------------*
      *                      * Codice classe statistica prodotto       *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-cod-csp    to   srt-k02-cod-csp        .
       cmp-srt-rec-400.
      *                  *---------------------------------------------*
      *                  * Subchiave 3 : Per documento                 *
      *                  *---------------------------------------------*
      ...
      *                      * Tipo documento                          *
      *                      *-----------------------------------------*
           move      rf-fft-cod-tmf       to   srt-k03-tip-doc        .
       cmp-srt-rec-415.
      *                      *-----------------------------------------*
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-sel-fft-cod-arc    to   srt-cod-fnt-cod        .
      *                      *-----------------------------------------*
      *                      * Codice dipendenza del fornitore         *
      *                      *-----------------------------------------*
           move      w-sel-fft-dpz-arc    to   srt-cod-fnt-dpz        .
      *                      *-----------------------------------------*
      *                      * Mnemonico del fornitore                 *
      *                      *-----------------------------------------*
      ...
      *                      * Codice numerico del prodotto            *
      *                      *-----------------------------------------*
           move      w-sel-ffr-num-mag    to   srt-cod-pro-cod        .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico del prodotto        *
      *                      *-----------------------------------------*
      ...
      *                      * Tipo documento                          *
      *                      *-----------------------------------------*
           move      rf-fft-cod-tmf       to   srt-est-doc-tdo        .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
      ...
      *                      * prodotto nell'ambito del fornitore      *
      *                      *-----------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       agg-abc-kk0-000.
      *              *-------------------------------------------------*
      *              * Valore ABC per il fornitore e la sua dipendenza *
      *              *-------------------------------------------------*
       agg-abc-kk0-025.
      *                  *---------------------------------------------*
      ...
      *                          * Memorizzazione in area specifica    *
      *                          *-------------------------------------*
           move      srt-k02-val-abc      to   srt-val-abc-csp        .
       agg-abc-sqz-650.
      *                      *-----------------------------------------*
      *                      * Eventuale aggiornamento del flag per    *
      *                      * record da non selezionare               *
      ...
      *                  * prodotto                                    *
      *                  *---------------------------------------------*
           move      srt-cod-csp-cod      to   w-rot-l01-cod-csp      .
      *              *-------------------------------------------------*
      *              * 2. livello di rottura                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice fornitore                            *
      *                  *---------------------------------------------*
           move      srt-cod-fnt-cod      to   w-rot-l02-cod-fnt      .
      *                  *---------------------------------------------*
      *                  * Codice dipendenza del fornitore             *
      *                  *---------------------------------------------*
           if        w-prs-saf-fnt-rgd    =    "S"
                     move  srt-cod-fnt-dpz
                                          to   w-rot-l02-dpz-fnt
           else      move  spaces         to   w-rot-l02-dpz-fnt      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  * Numero classi trattati per il fornitore     *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fnt-num-csp      .
      *                  *---------------------------------------------*
      *                  * Numero di fornitori trattati in totale      *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-liv-fnt-cod-fnt    to   w-stp-sub-cod-num      .
      *                      *-----------------------------------------*
      *                      * Valore del codice, alfanumerico         *
      *                      *-----------------------------------------*
           move      w-liv-fnt-mne-fnt    to   w-stp-sub-cod-alf      .
      *                      *-----------------------------------------*
      *                      * Valore appendice al codice              *
      *                      *-----------------------------------------*
           move      w-liv-fnt-dpz-fnt    to   w-stp-sub-app-cod      .
      *                      *-----------------------------------------*
      *                      * Descrizione per il codice               *
      *                      *-----------------------------------------*
           move      w-liv-fnt-rag-fnt    to   w-stp-sub-cod-des      .
       prn-ini-lr2-550.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csp-num-doc      .
      *                  *---------------------------------------------*
      *                  * Numero classi trattate per il fornitore     *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-fnt-num-csp      .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              * per ogni classe statistica prodotto             *
      *              *-------------------------------------------------*
       prn-fin-lr1-310.
      *                  *---------------------------------------------*
      *                  * Test se linee residue sufficienti           *
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr1-330.
      *                  *---------------------------------------------*
      *                  * Subroutine per la stampa del codice classe  *
      *                  * statistica prodotto, del mnemonico della    *
      *                  * classe, della descrizione della classe      *
      *                  *---------------------------------------------*
       prn-fin-lr1-331.
      *                      *-----------------------------------------*
      *                      * Preparazione                            *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Codice numerico della classe sta-   *
      *                          * tistica                             *
      *                          *-------------------------------------*
           move      w-liv-csp-cod-csp    to   w-stp-cmd-csp-cod      .
      *                          *-------------------------------------*
      *                          * Mnemonico per la classe             *
      *                          *-------------------------------------*
           move      w-liv-csp-mne-csp    to   w-stp-cmd-csp-mne      .
      *                          *-------------------------------------*
      *                          * Descrizione per la classe           *
      *                          *-------------------------------------*
           move      w-liv-csp-des-csp    to   w-stp-cmd-csp-des      .
       prn-fin-lr1-332.
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   stp-cmd-csp-000      thru stp-cmd-csp-999        .
       prn-fin-lr1-340.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-liv-csp-val-umi    to   w-stp-sta-qfp-umi      .
           move      w-liv-csp-val-dec    to   w-stp-sta-qfp-dec      .
           move      w-liv-csp-qta-p1r    to   w-stp-sta-qfp-q01      .
           move      w-liv-csp-tot-p1r    to   w-stp-sta-qfp-f01      .
           move      w-liv-csp-qta-p2r    to   w-stp-sta-qfp-q02      .
           move      w-liv-csp-tot-p2r    to   w-stp-sta-qfp-f02      .
           move      w-liv-csp-qta-p3r    to   w-stp-sta-qfp-q03      .
           move      w-liv-csp-tot-p3r    to   w-stp-sta-qfp-f03      .
      ...
      *                  *---------------------------------------------*
           if        w-cnt-prn-flg-int    not  = spaces
                     go to prn-fin-lr1-999.
      *                  *---------------------------------------------*
      *                  * A stampa totale classe statistica prodotto, *
      *                  * senza eseguire una interlinea di separazio- *
      *                  * ne                                          *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       prn-fin-lr1-450.
           if        rr-tcs-pro           =    01
                     go to prn-fin-lr1-451
           else if   rr-tcs-pro           =    02
                     go to prn-fin-lr1-452
           else if   rr-tcs-pro           =    03
                     go to prn-fin-lr1-453
           else      go to prn-fin-lr1-455.
       prn-fin-lr1-451.
           move      "Totale classe  :                                  
      -              "      "             to   w-stp-sta-tot-lit      .
           go to     prn-fin-lr1-460.
       prn-fin-lr1-452.
           move      "Totale classe  :                                  
      -              "      "             to   w-stp-sta-tot-lit      .
           go to     prn-fin-lr1-460.
      ...
      *              * per classe statistica prodotto                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *                  * mento trattato per la classe statistica del *
      *                  * prodotto, oppure no                         *
      *                  *---------------------------------------------*
           if        w-liv-csp-num-doc    =    1
                     go to prn-liv-det-620
           else      go to prn-liv-det-670.
       prn-liv-det-620.
      *                  *---------------------------------------------*
      *                  * Se e' il primo documento trattato per la    *
      *                  * classe statistica del prodotto              *
      *                  *---------------------------------------------*
       prn-liv-det-630.
      *                      *-----------------------------------------*
      *                      * Test se linee residue sufficienti       *
      ...
      *                      * della classe statistica del prodotto,   *
      *                      * del mnemonico della classe , e della    *
      ...
      *                  * la classe statistica del prodotto, bensi'   *
      *                  * uno successivo                              *
      *                  *---------------------------------------------*
       prn-liv-det-680.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           else if   rr-tcs-pro           =    11
                     go to stp-int-pag-034.
       stp-int-pag-031.
           move      "PER FORNITORE - 1. CODICE STATISTICO PRODOTTO     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-032.
           move      "PER FORNITORE - 2. CODICE STATISTICO PRODOTTO     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-033.
           move      "PER FORNITORE - 3. CODICE STATISTICO PRODOTTO     
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-034.
           move      "PER FORNITORE - CLASSE MERCEOLOGICA PRODOTTO      
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
      ...
      *                      *-----------------------------------------*
           move      "Vendite non attribuite ad alcun fornitore         
      -              "                      "
      ...
      *                          *-------------------------------------*
           if        rr-tcs-pro           =    01 or
                     rr-tcs-pro           =    02 or
                     rr-tcs-pro           =    03
                     move  "Classe statistica                           
      -                    "            "
                                          to   w-stp-fnc-tit-asx
           else      move  "Classe merceologica                         
      -                    "            "
                                          to   w-stp-fnc-tit-asx      .
      *                          *-------------------------------------*
      *                          * Continuazione                       *
      ...
      *              * sta documenti emessi per ogni classe statistica *
      *              *-------------------------------------------------*
       stp-fnc-vrt-605.
      *                  *---------------------------------------------*
      *                  * Test se numero linee residue sufficienti    *
      ...
      *    *===========================================================*
      *    * Subroutine per la stampa del codice classe statistica,    *
      *    * del mnemonico della classe, e della descrizione           *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-cmd-csp-cod : Codice numerico della classe      *
      *    *                                                           *
      *    *   - w-stp-cmd-csp-mne : Mnemonico per la classe           *
      *    *                                                           *
      *    *   - w-stp-cmd-csp-des : Descrizione per la classe         *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       stp-cmd-csp-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-stp-cmd-csp-cod    =    zero
                     go to stp-cmd-csp-300
           else      go to stp-cmd-csp-600.
       stp-cmd-csp-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      002                  to   p-pos                  .
           move      w-stp-cmd-csp-cod    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cmd-csp-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      009                  to   p-pos                  .
           move      w-stp-cmd-csp-mne    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cmd-csp-750.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      016                  to   p-pos                  .
           move      w-stp-cmd-csp-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cmd-csp-800.
      *                  *---------------------------------------------*
      ...
      *    * acquisto sul fatturato                                    *
      *    *-----------------------------------------------------------*
       mod-not-saf-opn-000.
           move      "pgm/saf/prg/obj/mnotsaf0"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           move      s-pat                to   w-mod-not-saf-pth      .
           move      "OP"                 to   w-mod-not-saf-ope      .
           perform   mod-not-saf-cll-000  thru mod-not-saf-cll-999    .
       mod-not-saf-opn-999.
           exit.
       mod-not-saf-cls-000.
           move      "CL"                 to   w-mod-not-saf-ope      .
           perform   mod-not-saf-cll-000  thru mod-not-saf-cll-999    .
           cancel    w-mod-not-saf-pth                                .
       mod-not-saf-cls-999.
           exit.
       mod-not-saf-dvn-000.
           move      "VN"                 to   w-mod-not-saf-ope      .
           perform   mod-not-saf-cll-000  thru mod-not-saf-cll-999    .
       mod-not-saf-dvn-999.
           exit.
       mod-not-saf-cll-000.
           call      w-mod-not-saf-pth   using w-mod-not-saf
                                               rf-fft
                                               rf-ffr                 .
       mod-not-saf-cll-999.
           exit.
