      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psaf8301:       *
      *                                                                *
      ...
      *                *-----------------------------------------------*
      *                * Tipo record                                   *
      *                *   01 : Totale per classificatore statistico   *
      *                *   02 : Totale per fornitore                   *
      *                *-----------------------------------------------*
                   15  kk0-tip-rec        pic  9(02)                  .
      *                *-----------------------------------------------*
      *                * Codice classificatore statistico fornitori    *
      *                *-----------------------------------------------*
                   15  kk0-cod-csf        pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Codice fornitore                              *
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Subchiave 1 : Per classe statistica fornitore     *
      *            *                                                   *
      ...
      *                *-----------------------------------------------*
                   15  srt-cod-csf-cod    pic  9(05)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica, mnemonico           *
      *                *-----------------------------------------------*
                   15  srt-cod-csf-mne    pic  x(05)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica, descrizione         *
      *                *-----------------------------------------------*
                   15  srt-cod-csf-des    pic  x(25)                  .
      *                *-----------------------------------------------*
      *                * Codice classe statistica fornitore, flag di   *
      *                * esistenza                                     *
      *                *-----------------------------------------------*
                   15  srt-cod-csf-flg    pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice fornitore                                  *
      *            *---------------------------------------------------*
               10  srt-cod-fnt.
      ...
      *            *---------------------------------------------------*
               10  srt-val-abc.
      *                *-----------------------------------------------*
      *                * Valore ABC per la classe statistica           *
      *                *-----------------------------------------------*
                   15  srt-val-abc-csf    pic s9(13)                  .
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Tipo classe statistica fornitore selezionata          *
      *        *  - 01 : Zona                                          *
      *        *  - 02 : Categoria                                     *
      ...
      *        *-------------------------------------------------------*
      *        * Codice classe statistica fornitore selezionata        *
      ...
      *        *  - 03 : Con la lista documenti emessi                 *
      *        *-------------------------------------------------------*
           05  rr-tip-dts                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Tipo di ordinamento per la classe statistica fornitore*
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-yst.
               10  w-let-arc-yst-flg      pic  x(01)     value spaces .
               10  w-let-arc-yst-tip      pic  9(02)     value zero   .
               10  w-let-arc-yst-cod      pic  9(05)     value zero   .
               10  w-let-arc-yst-des      pic  x(25)     value spaces .
               10  w-let-arc-yst-mne      pic  x(05)     value spaces .
               10  w-let-arc-yst-ext      pic  9(02)     value zero   .
               10  w-let-arc-yst-exc      pic  9(05)     value zero   .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-let-fnt-dcf.
               ...
               10  w-let-fnt-dcf-zon      pic  9(05)     value zero   .
               10  w-let-fnt-dcf-cat      pic  9(05)     value zero   .
               10  w-let-fnt-dcf-stt      pic  9(05)     value zero   .
      ...
      *        *-------------------------------------------------------*
      *        * Codice classe statistica per il fornitore             *
      *        *-------------------------------------------------------*
           05  w-liv-csf.
      *            *---------------------------------------------------*
      *            * Codice classe statistica                          *
      *            *---------------------------------------------------*
               10  w-liv-csf-cod-csf      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Descrizione per la classe statistica              *
      *            *---------------------------------------------------*
               10  w-liv-csf-des-csf      pic  x(25)                  .
      *            *---------------------------------------------------*
      *            * Mnemonico per la classe statistica                *
      *            *---------------------------------------------------*
               10  w-liv-csf-mne-csf      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Flag di esistenza per la classe statistica        *
      *            *---------------------------------------------------*
               10  w-liv-csf-flg-csf      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Totale fatturato 1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csf-tot-p1r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Totale fatturato 2. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csf-tot-p2r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Totale fatturato 3. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-csf-tot-p3r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Numero fornitori trattati per classe statistica   *
      *            *---------------------------------------------------*
               10  w-liv-csf-num-fnt      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Castelletto per max 36 valori (grafico)           *
      *            *---------------------------------------------------*
               10  w-liv-csf-cst-max      pic  9(02)     value 36     .
               10  w-liv-csf-cst-ctr      pic  9(02)                  .
               10  w-liv-csf-cst-ct1      pic  9(02)                  .
               10  w-liv-csf-cst-ct2      pic  9(02)                  .
               10  w-liv-csf-cst-ct3      pic  9(02)                  .
               10  w-liv-csf-cst-cst occurs 36.
      *                *-----------------------------------------------*
      *                * Descrizione classificatore                    *
      *                *-----------------------------------------------*
                   15  w-liv-csf-cst-des  pic  x(40)                  .
      *                *-----------------------------------------------*
      *                * Totale fatturato                              *
      *                *-----------------------------------------------*
                   15  w-liv-csf-cst-val  pic s9(13)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *        * Codice fornitore                                      *
      *        *-------------------------------------------------------*
           05  w-sel-sff-cod-arc          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Codice dipendenza per il fornitore                    *
      *        *-------------------------------------------------------*
           05  w-sel-sff-dpz-arc          pic  x(04)                  .
      *        *-------------------------------------------------------*
      *        * Mnemonico per il fornitore                            *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Codice zona per il fornitore                          *
      *        *-------------------------------------------------------*
           05  w-sel-sff-zon-fnt          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice categoria per il fornitore                     *
      *        *-------------------------------------------------------*
           05  w-sel-sff-cat-fnt          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice statistico per il fornitore                    *
      *        *-------------------------------------------------------*
           05  w-sel-sff-stt-fnt          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice tipo classe statistica fornitore               *
      *        *-------------------------------------------------------*
           05  w-sel-sff-cod-csf          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Mnemonico tipo classe statistica fornitore            *
      *        *-------------------------------------------------------*
           05  w-sel-sff-mne-csf          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione tipo classe statistica fornitore          *
      *        *-------------------------------------------------------*
           05  w-sel-sff-des-csf          pic  x(25)                  .
      *        *-------------------------------------------------------*
      *        * Flag di tipo classe statistica fornitore esistente    *
      *        *-------------------------------------------------------*
           05  w-sel-sff-flg-csf          pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per stampa del codice classe statistica,     *
      *        * del mnemonico della classe, della descrizione della   *
      *        * classe                                                *
      *        *-------------------------------------------------------*
           05  w-stp-cmd-csf.
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-stp-cmd-csf-cod      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Mnemonico per la classe                           *
      *            *---------------------------------------------------*
               10  w-stp-cmd-csf-mne      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Descrizione per la classe                         *
      *            *---------------------------------------------------*
               10  w-stp-cmd-csf-des      pic  x(25)                  .
      *        *-------------------------------------------------------*
      *        * Sub-work per stampa del codice fornitore e ragione    *
      *        * sociale                                               *
      *        *-------------------------------------------------------*
           05  w-stp-ccl-rsc.
      *            *---------------------------------------------------*
      ...
      *              * mento del codice fornitore nelle statistiche su *
      *              * fatturato                                       *
      *              *-------------------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-fnt    to   w-sel-sff-cod-arc      .
      *                      *-----------------------------------------*
      *                      * Codice dipendenza per il fornitore      *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-dpz    to   w-sel-sff-dpz-arc      .
      *                      *-----------------------------------------*
      *                      * Ragione sociale per il fornitore        *
      *                      *-----------------------------------------*
      ...
      *                      * Codice zona per il fornitore            *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-zon    to   w-sel-sff-zon-fnt      .
      *                      *-----------------------------------------*
      *                      * Codice categoria per il fornitore       *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-cat    to   w-sel-sff-cat-fnt      .
      *                      *-----------------------------------------*
      *                      * Codice statistico per il fornitore      *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-stt    to   w-sel-sff-stt-fnt      .
       sel-sff-rec-200.
      *              *-------------------------------------------------*
      *              * Selezione su codice classe statistica fornitore *
      *              *-------------------------------------------------*
       sel-sff-rec-225.
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda del tipo di classe     *
      *                  * statistica fornitore selezionata            *
      *                  *---------------------------------------------*
           if        rr-tcs-fnt           =    01
                     go to sel-sff-rec-250
           else if   rr-tcs-fnt           =    02
                     go to sel-sff-rec-275
           else if   rr-tcs-fnt           =    03
                     go to sel-sff-rec-300.
       sel-sff-rec-250.
      *                  *---------------------------------------------*
      *                  * Se tipo di classe statistica fornitore : 01 *
      *                  * zona                                        *
      *                  *---------------------------------------------*
       sel-sff-rec-255.
      *                      *-----------------------------------------*
      *                      * Se un solo codice da selezionare, e il  *
      *                      * codice associato al fornitore non cor-  *
      *                      * risponde a quello da selezionare :      *
      *                      * uscitata per selezione non superata     *
      *                      *-----------------------------------------*
           if        rr-ccs-fnt           not  = zero          and
                     rr-ccs-fnt           not  = w-sel-sff-zon-fnt
                     go to sel-sff-rec-900.
       sel-sff-rec-260.
      *                      *-----------------------------------------*
      *                      * Lettura [yst] per la zona               *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Lettura                             *
      *                          *-------------------------------------*
           move      01                   to   w-let-arc-yst-tip      .
           move      w-sel-sff-zon-fnt    to   w-let-arc-yst-cod      .
      ...
      *                              * Codice zona                     *
      *                              *---------------------------------*
           move      w-let-arc-yst-cod    to   w-sel-sff-cod-csf      .
      *                              *---------------------------------*
      *                              * Descrizione zona                *
      *                              *---------------------------------*
           move      w-let-arc-yst-des    to   w-sel-sff-des-csf      .
      *                              *---------------------------------*
      *                              * Mnemonico zona                  *
      *                              *---------------------------------*
           move      w-let-arc-yst-mne    to   w-sel-sff-mne-csf      .
      *                              *---------------------------------*
      *                              * Flag di zona esistente          *
      *                              *---------------------------------*
           move      w-let-arc-yst-flg    to   w-sel-sff-flg-csf      .
       sel-sff-rec-265.
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
           go to     sel-sff-rec-400.
       sel-sff-rec-275.
      *                  *---------------------------------------------*
      *                  * Se tipo di classe statistica fornitore : 02 *
      *                  * categoria                                   *
      *                  *---------------------------------------------*
       sel-sff-rec-280.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-ccs-fnt           not  = zero          and
                     rr-ccs-fnt           not  = w-sel-sff-cat-fnt
                     go to sel-sff-rec-900.
       sel-sff-rec-285.
      *                      *-----------------------------------------*
      *                      * Lettura [yst] per la categoria          *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Lettura                             *
      *                          *-------------------------------------*
           move      02                   to   w-let-arc-yst-tip      .
           move      w-sel-sff-cat-fnt    to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                          *-------------------------------------*
      *                          * Dati letti in area di comodo        *
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       sel-sff-rec-300.
      *                  *---------------------------------------------*
      *                  * Se tipo di classe statistica fornitore : 03 *
      *                  * codice statistico                           *
      *                  *---------------------------------------------*
       sel-sff-rec-305.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-ccs-fnt           not  = zero          and
                     rr-ccs-fnt           not  = w-sel-sff-stt-fnt
                     go to sel-sff-rec-900.
       sel-sff-rec-310.
      *                      *-----------------------------------------*
      *                      * Lettura [yst] per il codice statistico  *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Lettura                             *
      *                          *-------------------------------------*
           move      03                   to   w-let-arc-yst-tip      .
           move      w-sel-sff-stt-fnt    to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                          *-------------------------------------*
      *                          * Dati letti in area di comodo        *
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
       cmp-srt-rec-200.
      *                  *---------------------------------------------*
      *                  * Subchiave 1 : Per classe statistica         *
      *                  *---------------------------------------------*
       cmp-srt-rec-210.
      *                      *-----------------------------------------*
      *                      * Valore ABC                              *
      ...
      *                          *-------------------------------------*
           if        rr-tor-csf           not  = 01 and
                     rr-tor-csf           not  = 02 and
                     rr-tor-csf           not  = 03 and
                     rr-tor-csf           not  = 05
      ...
      *                          *-------------------------------------*
           if        rr-tor-csf           not  = 01 and
                     rr-tor-csf           not  = 02 and
                     rr-tor-csf           not  = 03
                     move  spaces         to   srt-k01-des-csf
                     go to cmp-srt-rec-225.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-sff-des-csf    to   srt-k01-des-csf        .
       cmp-srt-rec-225.
      *                      *-----------------------------------------*
      *                      * Mnemonico per classe statistica         *
      *                      *-----------------------------------------*
      ...
      *                          * altrimenti forzato a spaces         *
      *                          *-------------------------------------*
           if        rr-tor-csf           not  = 05
                     move  spaces         to   srt-k01-mne-csf
                     go to cmp-srt-rec-230.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-sff-mne-csf    to   srt-k01-mne-csf        .
       cmp-srt-rec-230.
      *                      *-----------------------------------------*
      *                      * Flag di codice a zero o diverso da zero *
      *                      *-----------------------------------------*
      ...
      *                      * Codice classe statistica                *
      *                      *-----------------------------------------*
           move      w-sel-sff-cod-csf    to   srt-k01-cod-csf        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per fornitore                 *
      *                  *---------------------------------------------*
      ...
      *                      * Solo per i tipi di dettaglio stampa :   *
      *                      *                                         *
      *                      *  - Con anche il totale per fornitore    *
      ...
      *                      *-----------------------------------------*
           if        rr-tip-dts           not  = 02 and
                     ...
                     move  zero           to   srt-k02-cod-fnt
                     move  spaces         to   srt-k02-dpz-fnt
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-sff-rag-fnt    to   srt-k02-rag-fnt        .
       cmp-srt-rec-325.
      *                      *-----------------------------------------*
      *                      * Mnemonico per il fornitore              *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-sff-mne-fnt    to   srt-k02-mne-fnt        .
       cmp-srt-rec-330.
      *                      *-----------------------------------------*
      *                      * Flag di codice a zero o diverso da zero *
      *                      *-----------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-sel-sff-cod-arc    to   srt-k02-cod-fnt        .
       cmp-srt-rec-340.
      *                      *-----------------------------------------*
      *                      * Codice dipendenza per il fornitore      *
      *                      *-----------------------------------------*
      ...
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-sff-ddo-ftf       to   srt-k03-dat-doc        .
       cmp-srt-rec-410.
      *                      *-----------------------------------------*
      *                      * Tipo documento                          *
      *                      *-----------------------------------------*
      ...
      *                      * Numero documento                        *
      *                      *-----------------------------------------*
           move      rf-sff-ndo-ftf       to   srt-k03-num-doc        .
       cmp-srt-rec-800.
      *              *-------------------------------------------------*
      *              * Area dati                                       *
      *              *-------------------------------------------------*
      ...
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      w-sel-sff-cod-csf    to   srt-cod-csf-cod        .
      *                      *-----------------------------------------*
      *                      * Mnemonico                               *
      *                      *-----------------------------------------*
           move      w-sel-sff-mne-csf    to   srt-cod-csf-mne        .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      *                      *-----------------------------------------*
           move      w-sel-sff-des-csf    to   srt-cod-csf-des        .
      *                      *-----------------------------------------*
      *                      * Flag di esistenza                       *
      *                      *-----------------------------------------*
           move      w-sel-sff-flg-csf    to   srt-cod-csf-flg        .
       cmp-srt-rec-850.
      *                  *---------------------------------------------*
      *                  * fornitore                                   *
      *                  *---------------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-sel-sff-cod-arc    to   srt-cod-fnt-cod        .
      *                      *-----------------------------------------*
      *                      * Codice dipendenza del fornitore         *
      *                      *-----------------------------------------*
           move      w-sel-sff-dpz-arc    to   srt-cod-fnt-dpz        .
      *                      *-----------------------------------------*
      *                      * Mnemonico del fornitore                 *
      *                      *-----------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       agg-abc-kk0-000.
      *              *-------------------------------------------------*
      *              * Valore ABC per classe statistica fornitore      *
      *              *-------------------------------------------------*
       agg-abc-kk0-025.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-cod-csf-cod      to   kk0-cod-csf            .
      ...
      *                          *-------------------------------------*
           move      srt-k01-val-abc      to   srt-val-abc-csf        .
       agg-abc-sqz-150.
      *                      *-----------------------------------------*
      ...
      *                  * Codice classe statistica fornitore          *
      *                  *---------------------------------------------*
           move      srt-cod-csf-cod      to   w-rot-l02-cod-csf      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-gen-num-csf      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      zero                 to   w-liv-csf-cst-ctr      .
       prn-ini-cic-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Inizializzazione work area per livello di rot-  *
      *              * tura per codice classe statistica fornitore     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice classe statistica                    *
      *                  *---------------------------------------------*
           move      srt-cod-csf-cod      to   w-liv-csf-cod-csf      .
      *                  *---------------------------------------------*
      *                  * Descrizione per la classe statistica        *
      *                  *---------------------------------------------*
           move      srt-cod-csf-des      to   w-liv-csf-des-csf      .
      *                  *---------------------------------------------*
      *                  * Mnemonico per la classe statistica          *
      *                  *---------------------------------------------*
           move      srt-cod-csf-mne      to   w-liv-csf-mne-csf      .
      *                  *---------------------------------------------*
      *                  * Flag di esistenza per la classe statistica  *
      *                  *---------------------------------------------*
           move      srt-cod-csf-flg      to   w-liv-csf-flg-csf      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csf-tot-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csf-tot-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csf-tot-p3r      .
      *                  *---------------------------------------------*
      *                  * Numero di fornitore trattati per la classe  *
      *                  * statistica                                  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-csf-num-fnt      .
      *                  *---------------------------------------------*
      *                  * Numero di classi statistiche trattate       *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-gen-num-csf      .
       prn-ini-lr2-200.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo dettaglio stampa  *
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-liv-csf-cod-csf    to   w-stp-sub-cod-num      .
      *                          *-------------------------------------*
      *                          * Valore del codice, alfanumerico     *
      *                          *-------------------------------------*
           move      w-liv-csf-mne-csf    to   w-stp-sub-cod-alf      .
      *                          *-------------------------------------*
      *                          * Descrizione per il codice           *
      *                          *-------------------------------------*
           move      w-liv-csf-des-csf    to   w-stp-sub-cod-des      .
       prn-ini-lr2-550.
      *                      *-----------------------------------------*
      ...
      *              * Determinazione % di variazione                  *
      *              *-------------------------------------------------*
           move      w-liv-csf-tot-p1r    to   w-stp-clc-pdv-v01      .
           move      w-liv-csf-tot-p2r    to   w-stp-clc-pdv-v02      .
           move      w-liv-csf-tot-p3r    to   w-stp-clc-pdv-v03      .
           perform   stp-clc-pdv-000      thru stp-clc-pdv-999        .
       prn-fin-lr2-125.
      *              *-------------------------------------------------*
      *              * Determinazione valore del campo 'Note' per il   *
      ...
      *                          * Codice classe statistica fornitore  *
      *                          *-------------------------------------*
           move      w-liv-csf-cod-csf    to   w-stp-cmd-csf-cod      .
      *                          *-------------------------------------*
      *                          * Mnemonico classe                    *
      *                          *-------------------------------------*
           move      w-liv-csf-mne-csf    to   w-stp-cmd-csf-mne      .
      *                          *-------------------------------------*
      *                          * Descrizione classe                  *
      *                          *-------------------------------------*
           move      w-liv-csf-des-csf    to   w-stp-cmd-csf-des      .
       prn-fin-lr2-332.
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   stp-cmd-csf-000      thru stp-cmd-csf-999        .
       prn-fin-lr2-340.
      *                  *---------------------------------------------*
      ...
      *                      * Preparazione                            *
      *                      *-----------------------------------------*
           move      w-liv-csf-tot-p1r    to   w-stp-sta-fep-f01      .
           move      w-liv-csf-tot-p2r    to   w-stp-sta-fep-f02      .
           move      w-liv-csf-tot-p3r    to   w-stp-sta-fep-f03      .
      ...
      *                      *-----------------------------------------*
           add       1                    to   w-liv-csf-cst-ctr      .
      *                      *-----------------------------------------*
      *                      * Test se superato l'ultimo elemento      *
      *                      *-----------------------------------------*
           if        w-liv-csf-cst-ctr    >    w-liv-csf-cst-max
                     move  w-liv-csf-cst-max
                                          to   w-liv-csf-cst-ctr
                     move  "(ALTRE)"      to   w-liv-csf-cst-des
                                              (w-liv-csf-cst-max)
                     add   w-liv-csf-tot-p1r
                                          to   w-liv-csf-cst-val
                                              (w-liv-csf-cst-max)
                     go to prn-fin-lr2-390.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      w-liv-csf-des-csf    to   w-liv-csf-cst-des
                                              (w-liv-csf-cst-ctr)     .
           if        w-liv-csf-des-csf    =    spaces
                     move  "(Non Classificati)"
                                          to   w-liv-csf-cst-des
                                              (w-liv-csf-cst-ctr)     .
      *
           move      w-liv-csf-tot-p1r    to   w-liv-csf-cst-val
                                              (w-liv-csf-cst-ctr)     .
       prn-fin-lr2-390.
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      ...
      *                      *-----------------------------------------*
           move      w-liv-csf-tot-p1r    to   w-stp-sta-tot-f01      .
           move      w-liv-csf-tot-p2r    to   w-stp-sta-tot-f02      .
           move      w-liv-csf-tot-p3r    to   w-stp-sta-tot-f03      .
           move      w-stp-clc-pdv-p01    to   w-stp-sta-tot-p01      .
           move      spaces               to   w-stp-sta-tot-not      .
           move      w-stp-clc-pdv-p02    to   w-stp-sta-tot-p02      .
       prn-fin-lr2-450.
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-150.
      *              *-------------------------------------------------*
      *              * Accumuli per livello classe statistica per il   *
      *              * fornitore                                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Totale fatturato 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn1      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-val
                                          to   w-liv-csf-tot-p1r
                     else  subtract srt-val-sta-val
                                          from w-liv-csf-tot-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn2      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-val
                                          to   w-liv-csf-tot-p2r
                     else  subtract srt-val-sta-val
                                          from w-liv-csf-tot-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn3      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-val
                                          to   w-liv-csf-tot-p3r
                     else  subtract srt-val-sta-val
                                          from w-liv-csf-tot-p3r      .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-031.
           move      "PER ZONA DI APPARTENENZA DEI FORNITORI            
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-032.
           move      "PER CATEGORIA DI fornitore                        
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-033.
           move      "PER CLASSIFICAZIONE STATISTICA DEI FORNITORI      
      -              "                              "
                                          to   w-stp-int-ti2-stp      .
           go to     stp-int-pag-050.
       stp-int-pag-050.
      ...
      *                          * Literal fisso                       *
      *                          *-------------------------------------*
           move      "Fornitori non classificati per zona               
      -              "                      "
      ...
      *                          * Literal fisso                       *
      *                          *-------------------------------------*
           move      "Fornitori non classificati per categoria          
      -              "                      "
                                          to   w-stp-sub-ads-asx      .
      *                          *-------------------------------------*
      *                          * Continuazione                       *
      ...
      *                          * Literal fisso                       *
      *                          *-------------------------------------*
           move      "Fornitori non classificati per codice statistico  
      -              "                      "
                                          to   w-stp-sub-ads-asx      .
      *                          *-------------------------------------*
      *                          * Continuazione                       *
      ...
      *                          * classe statistica fornitore sele-   *
      *                          * zionata                             *
      *                          *-------------------------------------*
           if        rr-tcs-fnt           =    01
      ...
      *                      *  - 02 : Con anche totale per fornitore  *
      ...
      *              *   - 01 : Solo totale per codice classe stati-   *
      *              *          stica                                  *
      *              *   - 02 : Con anche il totale per ogni fornitore *
      *              *-------------------------------------------------*
       stp-fds-tot-405.
      ...
      *    * della descrizione, della classe statistica del fornitore  *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-cmd-csf-cod : Codice numerico della classe      *
      *    *                                                           *
      *    *   - w-stp-cmd-csf-mne : Mnemonico per la classe           *
      *    *                                                           *
      *    *   - w-stp-cmd-csf-des : Descrizione per la classe         *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       stp-cmd-csf-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-stp-cmd-csf-cod    =    zero
                     go to stp-cmd-csf-300
           else      go to stp-cmd-csf-600.
       stp-cmd-csf-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      009                  to   p-pos                  .
           move      w-stp-cmd-csf-cod    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cmd-csf-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      016                  to   p-pos                  .
           move      w-stp-cmd-csf-mne    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cmd-csf-750.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      023                  to   p-pos                  .
           move      w-stp-cmd-csf-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cmd-csf-800.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-let-arc-yst-tip    =    w-let-arc-yst-ext and
                     w-let-arc-yst-cod    =    w-let-arc-yst-exc
      ...
      *              *-------------------------------------------------*
           move      w-let-arc-yst-tip    to   w-let-arc-yst-ext      .
           move      w-let-arc-yst-cod    to   w-let-arc-yst-exc      .
       let-arc-yst-999.
           exit.
      ...
      *                  * Codice zona                                 *
      *                  *---------------------------------------------*
           move      zero                 to   w-let-fnt-dcf-zon      .
      *                  *---------------------------------------------*
      *                  * Codice categoria                            *
      *                  *---------------------------------------------*
           move      zero                 to   w-let-fnt-dcf-cat      .
      *                  *---------------------------------------------*
      *                  * Codice statistico                           *
      *                  *---------------------------------------------*
           move      zero                 to   w-let-fnt-dcf-stt      .
       let-fnt-dcf-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        f-sts                =    e-not-err
                     move  rf-dcf-cod-zon to   w-let-fnt-dcf-zon
                     move  rf-dcf-cod-cat to   w-let-fnt-dcf-cat
                     move  rf-dcf-cod-stt to   w-let-fnt-dcf-stt      .
       let-fnt-dcf-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-liv-csf-cst-ctr    to   m-gen-grf-num-prd      .
      *
           if        rr-tcs-fnt           =    01
                     move  "Statistica per Zona         "
                                          to   m-gen-grf-tit-grf
           else if   rr-tcs-fnt           =    02
                     move  "Statistica per Categoria    "
                                          to   m-gen-grf-tit-grf
           else if   rr-tcs-fnt           =    03
                     move  "Statistica per Codice libero"
                                          to   m-gen-grf-tit-grf
           else      move  "Statistica di acquisto      "
                                          to   m-gen-grf-tit-grf      .
      *
           move      "saf830"             to   m-gen-grf-fil-nam      .
       exe-sqz-grf-200.
      *              *-------------------------------------------------*
      ...
      *              * Ciclo dati                                      *
      *              *-------------------------------------------------*
           move      zero                 to   w-liv-csf-cst-ct1      .
           move      1                    to   w-liv-csf-cst-ct2      .
           move      zero                 to   w-liv-csf-cst-ct3      .
       exe-sqz-grf-500.
           add       1                    to   w-liv-csf-cst-ct1      .
           add       1                    to   w-liv-csf-cst-ct3      .
           if        w-liv-csf-cst-ct1    >    36
                     go to exe-sqz-grf-800.
           if        w-liv-csf-cst-ct3    >    12
                     add   1              to   w-liv-csf-cst-ct2
                     move  1              to   w-liv-csf-cst-ct3      .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione                             *
      *                  *---------------------------------------------*
           move      w-liv-csf-cst-des
                    (w-liv-csf-cst-ct1)   to   m-gen-grf-mes-des
                                              (w-liv-csf-cst-ct2,
                                               w-liv-csf-cst-ct3)     .
           move      w-liv-csf-cst-val
                    (w-liv-csf-cst-ct1)   to   m-gen-grf-mes-val
                                              (w-liv-csf-cst-ct2,
                                               w-liv-csf-cst-ct3)     .
       exe-sqz-grf-600.
      *                  *---------------------------------------------*
