      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psaf5701:       *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per materia prima - fornitore.              *
      *                                                                *
      *                    (FORSE MAI UTILIZZATO)                )     *
      *                                                                *
      *================================================================*
      ...
      *                *-----------------------------------------------*
      *                * Flag di codice prodotto diverso da zero ma    *
      ...
      *                *                                               *
      *                * Solo per tipo ordinamento prodotti :          *
      *                *                                               *
      *                * - ABC decrescente sul fatturato               *
      *                * - ABC decrescente sulla quantita'             *
      *                * - ABC crescente sul fatturato                 *
      ...
      *                * - Per descrizione prodotto                    *
      *                *-----------------------------------------------*
                   15  srt-k01-des-pro    pic  x(40)                  .
      *                *-----------------------------------------------*
      *                * Flag di codice prodotto a zero o diverso da   *
      *                * zero                                          *
      *                *                                               *
      ...
      *                *-----------------------------------------------*
                   15  srt-k01-alf-pro    pic  x(14)                  .
      *                *-----------------------------------------------*
      *                * Codice numerico prodotto                      *
      *                *                                               *
      *                * Per tutti i tipi ordinamento prodotto         *
      *                *-----------------------------------------------*
                   15  srt-k01-num-pro    pic  9(07)                  .
      *            *---------------------------------------------------*
      ...
      *                *-----------------------------------------------*
      *                * Valore ABC per il fornitore nell'ambito del   *
      *                * prodotto                                      *
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-dpm.
               10  w-let-arc-dpm-cod      pic  9(07)     value zero   .
               ...
               10  w-let-arc-dpm-umi      pic  x(03)     value spaces .
               10  w-let-arc-dpm-dec      pic  9(01)     value zero   .
               10  w-let-arc-dpm-cla      pic  9(05)     value zero   .
               10  w-let-arc-dpm-gru      pic  9(05)     value zero   .
               10  w-let-arc-dpm-sgr      pic  9(05)     value zero   .
               10  w-let-arc-dpm-tip      pic  9(02)     value zero   .
               10  w-let-arc-dpm-exc      pic  9(07)     value zero   .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Numero fornitori trattati per il prodotto         *
      *            *---------------------------------------------------*
               10  w-liv-pro-num-fnt      pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           move      rf-ffr-num-mag       to   w-let-arc-dpm-cod      .
      ...
      *                      * Codice prodotto numerico                *
      *                      *-----------------------------------------*
           move      w-let-arc-dpm-cod    to   w-sel-ffr-num-mag      .
      *                      *-----------------------------------------*
      *                      * Codice prodotto alfanumerico            *
      *                      *-----------------------------------------*
           move      w-let-arc-dpm-alf    to   w-sel-ffr-alf-pro      .
      *                      *-----------------------------------------*
      *                      * Descrizione prodotto                    *
      *                      *-----------------------------------------*
           move      w-let-arc-dpm-des    to   w-sel-ffr-des-pro      .
      *                      *-----------------------------------------*
      *                      * Unita' di misura di vendita per il pro- *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      w-let-arc-dpm-umi    to   w-sel-ffr-umi-pro      .
      *                      *-----------------------------------------*
      *                      * Numero decimali quantita' per il pro-   *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      w-let-arc-dpm-dec    to   w-sel-ffr-dec-pro      .
      *                      *-----------------------------------------*
      *                      * Classe merceologica del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dpm-cla    to   w-sel-ffr-cla-pro      .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico del prodotto        *
      *                      *-----------------------------------------*
           move      w-let-arc-dpm-gru    to   w-sel-ffr-gru-pro      .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico del prodotto   *
      *                      *-----------------------------------------*
           move      w-let-arc-dpm-sgr    to   w-sel-ffr-sgr-pro      .
       sel-ffr-rec-300.
      *              *-------------------------------------------------*
      ...
      *                  * un solo prodotto oppure tutti i prodotti    *
      *                  *---------------------------------------------*
           if        rr-num-pro           =    zero
                     go to sel-ffr-rec-375.
       sel-ffr-rec-350.
      *                  *---------------------------------------------*
      *                  * Se e' stato richiesto un solo prodotto      *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se il prodotto in esame corrisponde a   *
      *                      * quello richiesto si esce per selezione  *
      *                      * superata, altrimenti si esce per sele-  *
      *                      * zione non superata                      *
      *                      *-----------------------------------------*
           if        w-sel-ffr-num-mag    =    rr-num-pro
                     go to sel-ffr-rec-400
           else      go to sel-ffr-rec-900.
       sel-ffr-rec-375.
      *                  *---------------------------------------------*
      *                  * Se sono stati richiesti tutti i prodotti    *
      *                  *---------------------------------------------*
       sel-ffr-rec-400.
      *              *-------------------------------------------------*
      *              * Uscita per selezione superata                   *
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Solo se tipo ordinamento prodotti : *
      *                          *  - ABC decrescente sul fatturato    *
      *                          *  - ABC decrescente sulla quantita'  *
      *                          *  - ABC crescente sul fatturato      *
      *                          *  - ABC crescente sulla quantita'    *
      ...
      *                          * zione                               *
      *                          *-------------------------------------*
           if        w-sel-ffr-des-pro    not  = spaces
      ...
      *                          *-------------------------------------*
           if        rr-tor-pro           not  = 01 and
                     ...
                     rr-tor-pro           not  = 04 and
                     rr-tor-pro           not  = 05
                     move  spaces         to   srt-k01-des-pro
                     go to cmp-srt-rec-225.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-des-pro    to   srt-k01-des-pro        .
       cmp-srt-rec-225.
      *                      *-----------------------------------------*
      *                      * Flag di codice prodotto a zero o diver- *
      *                      * so da zero                              *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Solo se tipo ordinamento prodotti : *
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-alf-pro    to   srt-k01-alf-pro        .
       cmp-srt-rec-235.
      *                      *-----------------------------------------*
      *                      * Codice numerico del prodotto            *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-ffr-num-mag    to   srt-k01-num-pro        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per fornitore                 *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Solo se tipo ordinamento per prodotto :     *
      ...
      *                          *-------------------------------------*
           move      srt-k01-val-abc      to   srt-val-abc-pro        .
       agg-abc-sqz-150.
      *                      *-----------------------------------------*
      ...
      *                  * Codice numerico del prodotto                *
      *                  *---------------------------------------------*
           move      srt-cod-pro-num      to   w-rot-l02-num-pro      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  * Numero fornitori trattati per il prodotto   *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-pro-num-fnt      .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-liv-pro-num-pro    to   w-stp-sub-cod-num      .
      *                      *-----------------------------------------*
      *                      * Valore del codice, alfanumerico         *
      *                      *-----------------------------------------*
           move      w-liv-pro-alf-pro    to   w-stp-sub-cod-alf      .
      *                      *-----------------------------------------*
      *                      * Descrizione per il codice               *
      *                      *-----------------------------------------*
           move      w-liv-pro-des-pro    to   w-stp-sub-cod-des      .
       prn-ini-lr2-550.
      *                      *-----------------------------------------*
      ...
      *                  * lineato a sinistra                          *
      *                  *---------------------------------------------*
           move      "PER MATERIA PRIMA - FORNITORE                     
      -              "                              "
      ...
      *                      *-----------------------------------------*
           move      "Vendite di prodotti con codice a zero             
      -              "                      "
      ...
      *                              *---------------------------------*
           go to     stp-sub-int-650.
       stp-sub-int-625.
      *                          *-------------------------------------*
      *                          * Se codice alfanumerico a spaces     *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   x-tip                  .
           move      14                   to   x-car                  .
           move      w-liv-pro-alf-pro    to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Codice fornitore                            *
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   x-tip                  .
           move      03                   to   x-car                  .
           move      w-liv-pro-val-umi    to   x-alf                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
       exe-gen-fil-fnt-500.
      *              *-------------------------------------------------*
      ...
      *                  * Editing                                     *
      *                  *---------------------------------------------*
           move      w-liv-pro-val-dec    to   w-stp-edt-qta-dec      .
           move      w-liv-pro-qta-p1r    to   w-stp-edt-qta-qta      .
           perform   stp-edt-qta-000      thru stp-edt-qta-999        .
      *                  *---------------------------------------------*
      *                  * In campo di uscita                          *
      *                  *---------------------------------------------*
      ...
      *                  * Editing                                     *
      *                  *---------------------------------------------*
           move      w-liv-pro-tot-p1r    to   w-stp-edt-fat-fat      .
           perform   stp-edt-fat-000      thru stp-edt-fat-999        .
      *                  *---------------------------------------------*
      *                  * In campo di uscita                          *
      *                  *---------------------------------------------*
      ...
      *                  * Editing                                     *
      *                  *---------------------------------------------*
           move      srt-cod-pro-dec      to   w-stp-edt-qta-dec      .
           move      srt-val-sta-qta      to   w-stp-edt-qta-qta      .
           perform   stp-edt-qta-000      thru stp-edt-qta-999        .
      *                  *---------------------------------------------*
      *                  * In campo di uscita                          *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-let-arc-dpm-cod    =    w-let-arc-dpm-exc
      ...
      *                  *---------------------------------------------*
           ...
           move      zero                 to   w-let-arc-dpm-dec      .
           move      zero                 to   w-let-arc-dpm-cla      .
           move      zero                 to   w-let-arc-dpm-gru      .
           move      zero                 to   w-let-arc-dpm-sgr      .
           move      zero                 to   w-let-arc-dpm-tip      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-dpm-900.
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-dpm-dec-qta       to   w-let-arc-dpm-dec      .
           move      rf-dpm-cla-map       to   w-let-arc-dpm-cla      .
           move      rf-dpm-gru-map       to   w-let-arc-dpm-gru      .
           move      rf-dpm-sgr-map       to   w-let-arc-dpm-sgr      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-dpm-900.
      ...
      *              *-------------------------------------------------*
           move      w-let-arc-dpm-cod    to   w-let-arc-dpm-exc      .
       let-arc-dpm-999.
           exit.
