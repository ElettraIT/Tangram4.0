      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psaf8701:       *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Subchiave 1 : Per forma pagamento                 *
      *            *                                                   *
      ...
      *                * Valore ABC                                    *
      *                *                                               *
      *                * Solo per tipo ordinamento forma pagamento  :  *
      *                *                                               *
      *                * - ABC decrescente                             *
      *                * - ABC crescente                               *
      *                *                                               *
      ...
      *                *-----------------------------------------------*
      *                * Descrizione per forma pagamento               *
      *                *                                               *
      *                * Solo per tipo ordinamento forma pagamento  :  *
      *                *                                               *
      *                * - ABC decrescente                             *
      ...
      *                * - Per descrizione                             *
      *                *-----------------------------------------------*
                   15  srt-k01-des-fop    pic  x(25)                  .
      *                *-----------------------------------------------*
      *                * Mnemonico per forma pagamento                 *
      *                *                                               *
      *                * Solo per tipo ordinamento forma pagamento  :  *
      *                *                                               *
      *                * - Per mnemonico                               *
      *                *-----------------------------------------------*
                   15  srt-k01-mne-fop    pic  x(05)                  .
      *                *-----------------------------------------------*
      ...
      *                * Codice forma pagamento                        *
      *                *                                               *
      *                * Per tutti i tipi ordinamento forma pagamento  *
      *                *-----------------------------------------------*
                   15  srt-k01-cod-fop    pic  9(07)                  .
      *            *---------------------------------------------------*
      ...
      *            * - Con la lista documenti emessi per fornitore     *
      *            *---------------------------------------------------*
               10  srt-k02.
      *                *-----------------------------------------------*
      *                * Valore ABC                                    *
      ...
      *            *---------------------------------------------------*
               10  srt-cod-fop.
      *                *-----------------------------------------------*
      *                * Codice forma pagamento, codice                *
      *                *-----------------------------------------------*
                   15  srt-cod-fop-cod    pic  9(07)                  .
      *                *-----------------------------------------------*
      *                * Codice forma pagamento, mnemonico             *
      *                *-----------------------------------------------*
                   15  srt-cod-fop-mne    pic  x(10)                  .
      *                *-----------------------------------------------*
      *                * Codice forma pagamento, descrizione           *
      *                *-----------------------------------------------*
                   15  srt-cod-fop-des    pic  x(40)                  .
      *                *-----------------------------------------------*
      *                * Codice forma pagamento, flag di esistenza     *
      *                *-----------------------------------------------*
                   15  srt-cod-fop-flg    pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice fornitore                                  *
      *            *---------------------------------------------------*
               10  srt-cod-fnt.
      ...
      *            *---------------------------------------------------*
               10  srt-val-abc.
      *                *-----------------------------------------------*
      *                * Valore ABC per la forma pagamento             *
      *                *-----------------------------------------------*
                   15  srt-val-abc-fop    pic s9(13)                  .
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-yfp.
               10  w-let-arc-yfp-flg      pic  x(01)     value spaces .
               10  w-let-arc-yfp-cod      pic  9(07)     value zero   .
               10  w-let-arc-yfp-des      pic  x(40)     value spaces .
               10  w-let-arc-yfp-mne      pic  x(10)     value spaces .
               10  w-let-arc-yfp-exc      pic  9(07)     value zero   .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-rot-l02.
      *            *---------------------------------------------------*
      *            * Codice forma pagamento fornitore                  *
      *            *---------------------------------------------------*
               10  w-rot-l02-cod-fop      pic  9(05)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Codice forma pagamento  per il fornitore              *
      *        *-------------------------------------------------------*
           05  w-liv-fop.
      *            *---------------------------------------------------*
      *            * Codice forma pagamento                            *
      *            *---------------------------------------------------*
               10  w-liv-fop-cod-fop      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Descrizione per la forma pagamento                *
      *            *---------------------------------------------------*
               10  w-liv-fop-des-fop      pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Mnemonico per la forma pagamento                  *
      *            *---------------------------------------------------*
               10  w-liv-fop-mne-fop      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Flag di esistenza per la forma pagamento          *
      *            *---------------------------------------------------*
               10  w-liv-fop-flg-fop      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Totale fatturato 1. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-fop-tot-p1r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Totale fatturato 2. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-fop-tot-p2r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Totale fatturato 3. periodo di riferimento        *
      *            *---------------------------------------------------*
               10  w-liv-fop-tot-p3r      pic s9(13)                  .
      *            *---------------------------------------------------*
      *            * Numero fornitori trattati per la forma pagamento  *
      *            *---------------------------------------------------*
               10  w-liv-fop-num-fnt      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Castelletto per max 36 valori (grafico)           *
      *            *---------------------------------------------------*
               10  w-liv-fop-cst-max      pic  9(02)     value 36     .
               10  w-liv-fop-cst-ctr      pic  9(02)                  .
               10  w-liv-fop-cst-ct1      pic  9(02)                  .
               10  w-liv-fop-cst-ct2      pic  9(02)                  .
               10  w-liv-fop-cst-ct3      pic  9(02)                  .
               10  w-liv-fop-cst-cst occurs 36.
      *                *-----------------------------------------------*
      *                * Descrizione                                   *
      *                *-----------------------------------------------*
                   15  w-liv-fop-cst-des  pic  x(40)                  .
      *                *-----------------------------------------------*
      *                * Totale fatturato                              *
      *                *-----------------------------------------------*
                   15  w-liv-fop-cst-val  pic s9(13)                  .
      *        *-------------------------------------------------------*
      *        * Totale generale                                       *
      *        *-------------------------------------------------------*
           05  w-liv-gen.
      ...
      *        * Codice forma pagamento                                *
      *        *-------------------------------------------------------*
           05  w-sel-sff-cod-fop          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Mnemonico forma pagamento                             *
      *        *-------------------------------------------------------*
           05  w-sel-sff-mne-fop          pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione forma pagamento                           *
      *        *-------------------------------------------------------*
           05  w-sel-sff-des-fop          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Flag di forma pagamento esistente                     *
      *        *-------------------------------------------------------*
           05  w-sel-sff-flg-fop          pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per stampa del codice forma pagamento forni- *
      *        * tore, del mnemonico della classe, della descrizione   *
      *        * della classe                                          *
      *        *-------------------------------------------------------*
           05  w-stp-cmd-fop.
      *            *---------------------------------------------------*
      *            * Codice numerico della forma pagamento             *
      *            *---------------------------------------------------*
               10  w-stp-cmd-fop-cod      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Mnemonico per la forma pagamento                  *
      *            *---------------------------------------------------*
               10  w-stp-cmd-fop-mne      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Descrizione per la forma pagamento                *
      *            *---------------------------------------------------*
               10  w-stp-cmd-fop-des      pic  x(25)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Sub-work per scansione scadenze                       *
      *        *-------------------------------------------------------*
           05  w-stp-sfs-cst.
      *            *---------------------------------------------------*
      *            * Comodo per numero scadenza                        *
      *            *---------------------------------------------------*
               10  w-stp-sfs-num-scd      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Contatore di comodo                               *
      *            *---------------------------------------------------*
               10  w-stp-sfs-ctr-001      pic  9(03)                  .
      ...
      *                  * 'w-mod-scf-sff' e 'w-not-scf-sff' e 'rr'    *
      *                  *---------------------------------------------*
      ...
      *                      * Codice forma pagamento                  *
      *                      *-----------------------------------------*
           move      rf-sff-cod-fop       to   w-sel-sff-cod-fop      .
       sel-sff-rec-200.
      *              *-------------------------------------------------*
      *              * Selezione su codice forma pagamento fornitore   *
      *              *-------------------------------------------------*
           if        rr-cod-fop           not  = zero          and
                     rr-cod-fop           not  = w-sel-sff-cod-fop
      ...
      *                          * Lettura                             *
      *                          *-------------------------------------*
           move      w-sel-sff-cod-fop    to   w-let-arc-yfp-cod      .
      ...
      *                              * Codice                          *
      *                              *---------------------------------*
           move      w-let-arc-yfp-cod    to   w-sel-sff-cod-fop      .
      *                              *---------------------------------*
      *                              * Descrizione                     *
      *                              *---------------------------------*
           move      w-let-arc-yfp-des    to   w-sel-sff-des-fop      .
      *                              *---------------------------------*
      *                              * Mnemonico                       *
      *                              *---------------------------------*
           move      w-let-arc-yfp-mne    to   w-sel-sff-mne-fop      .
      *                              *---------------------------------*
      *                              * Flag di codice esistente        *
      *                              *---------------------------------*
           move      w-let-arc-yfp-flg    to   w-sel-sff-flg-fop      .
       sel-sff-rec-265.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-sel-sff-cod-fop    =    zero
                     go to sel-sff-rec-400.
           if        rr-tip-scd           =    01
                     go to sel-sff-rec-400.
           if        rr-cod-fop           not  = zero
                     go to sel-sff-rec-400.
           if        rf-sff-npr-scf       =    zero
                     go to sel-sff-rec-400.
       sel-sff-rec-300.
      *                          *-------------------------------------*
      *                          * Scansione scadenze documento        *
      *                          *-------------------------------------*
           move      rf-sff-npr-scf       to   w-stp-sfs-num-scd      .
           subtract  1                    from w-stp-sfs-num-scd      .
      *                          *-------------------------------------*
      *                          * Ciclo di scansione scadenze         *
      *                          *-------------------------------------*
           move      zero                 to   w-stp-sfs-ctr-001      .
       sel-sff-rec-320.
           add       1                    to   w-stp-sfs-ctr-001      .
      *
           if        w-stp-sfs-ctr-001    >    rf-sff-nrg-scf
                     go to sel-sff-rec-900.
           if        w-stp-sfs-ctr-001    >    96
                     go to sel-sff-rec-900.
      *                          *-------------------------------------*
      *                          * Incremento work numero scadenza     *
      *                          *-------------------------------------*
           add       1                    to   w-stp-sfs-num-scd      .
      *                          *-------------------------------------*
      *                          * Lettura record [sfs]                *
      *                          *-------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMSCF    "         to   f-key                  .
           move      w-stp-sfs-num-scd    to   rf-sfs-num-scf         .
           move      "pgm/scf/fls/ioc/obj/iofsfs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                              *---------------------------------*
           if        f-sts                not  = e-not-err
                     go to sel-sff-rec-320.
       sel-sff-rec-340.
      *                          *-------------------------------------*
      *                          * Test se tipo scadenza compreso tra  *
      *                          * quelli richiesti                    *
      *                          *-------------------------------------*
           if        rf-sfs-tip-scf       =    01   and
                     rr-snx-tsc (01)      =    "S"
                     go to sel-sff-rec-400
      ...
      *              *-------------------------------------------------*
       cmp-srt-rec-200.
      *                  *---------------------------------------------*
      *                  * Subchiave 1 : Per forma pagamento fornitore *
      *                  *---------------------------------------------*
       cmp-srt-rec-210.
      *                      *-----------------------------------------*
      *                      * Valore ABC                              *
      ...
      *                          *-------------------------------------*
           if        rr-tor-fop           not  = 01 and
                     rr-tor-fop           not  = 02 and
                     rr-tor-fop           not  = 03 and
                     rr-tor-fop           not  = 05
      ...
      *                          *-------------------------------------*
           if        rr-tor-fop           not  = 01 and
                     rr-tor-fop           not  = 02 and
                     rr-tor-fop           not  = 03
                     move  spaces         to   srt-k01-des-fop
                     go to cmp-srt-rec-225.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-sff-des-fop    to   srt-k01-des-fop        .
       cmp-srt-rec-225.
      *                      *-----------------------------------------*
      *                      * Mnemonico per forma pagamento           *
      *                      *-----------------------------------------*
      ...
      *                          * altrimenti forzato a spaces         *
      *                          *-------------------------------------*
           if        rr-tor-fop           not  = 05
                     move  spaces         to   srt-k01-mne-fop
                     go to cmp-srt-rec-230.
      *                          *-------------------------------------*
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-sff-mne-fop    to   srt-k01-mne-fop        .
       cmp-srt-rec-230.
      *                      *-----------------------------------------*
      *                      * Flag di codice a zero o diverso da zero *
      *                      *-----------------------------------------*
      ...
      *                      * Codice forma pagamento                  *
      *                      *-----------------------------------------*
           move      w-sel-sff-cod-fop    to   srt-k01-cod-fop        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per fornitore                 *
      *                  *---------------------------------------------*
      ...
      *                      * Solo per i tipi di dettaglio stampa :   *
      *                      *                                         *
      *                      *  - Con anche il totale per ogni forni-  *
      *                      *    tore                                 *
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-sel-sff-cod-fnt    to   srt-k02-cod-fnt        .
       cmp-srt-rec-340.
      *                      *-----------------------------------------*
      *                      * Codice dipendenza per il fornitore      *
      *                      *-----------------------------------------*
      ...
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      w-sel-sff-cod-fop    to   srt-cod-fop-cod        .
      *                      *-----------------------------------------*
      *                      * Mnemonico                               *
      *                      *-----------------------------------------*
           move      w-sel-sff-mne-fop    to   srt-cod-fop-mne        .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      *                      *-----------------------------------------*
           move      w-sel-sff-des-fop    to   srt-cod-fop-des        .
      *                      *-----------------------------------------*
      *                      * Flag di esistenza                       *
      *                      *-----------------------------------------*
           move      w-sel-sff-flg-fop    to   srt-cod-fop-flg        .
       cmp-srt-rec-850.
      *                  *---------------------------------------------*
      *                  * Fornitore                                   *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       agg-abc-kk0-000.
      *              *-------------------------------------------------*
      *              * Valore ABC per forma pagamento fornitore        *
      *              *-------------------------------------------------*
       agg-abc-kk0-025.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Solo se tipo ordinamento per la pagamento   *
      *                  * sconto fornitori :                          *
      *                  *   - 01 : Ordinamento ABC decrescente        *
      *                  *   - 02 : Ordinamento ABC crescente          *
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-cod-fop-cod      to   kk0-cod-fop            .
      ...
      *                      *-----------------------------------------*
       ...
       agg-abc-kk0-500.
      *              *-------------------------------------------------*
      *              * Valore ABC per codice fornitori e dipendenza    *
      *              *-------------------------------------------------*
       agg-abc-kk0-525.
      *                  *---------------------------------------------*
      *                  * Se la statistica e' sul nuovo fatturato o   *
      ...
      *                          *-------------------------------------*
           move      srt-k01-val-abc      to   srt-val-abc-fop        .
       agg-abc-sqz-150.
      *                      *-----------------------------------------*
      ...
      *                  * Codice forma pagamento fornitore            *
      *                  *---------------------------------------------*
           move      srt-cod-fop-cod      to   w-rot-l02-cod-fop      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-gen-num-fop      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      zero                 to   w-liv-fop-cst-ctr      .
       prn-ini-cic-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Inizializzazione work area per livello di rot-  *
      *              * tura per codice forma pagamento                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice forma pagamento                      *
      *                  *---------------------------------------------*
           move      srt-cod-fop-cod      to   w-liv-fop-cod-fop      .
      *                  *---------------------------------------------*
      *                  * Descrizione per la forma pagamento          *
      *                  *---------------------------------------------*
           move      srt-cod-fop-des      to   w-liv-fop-des-fop      .
      *                  *---------------------------------------------*
      *                  * Mnemonico per la forma pagamento            *
      *                  *---------------------------------------------*
           move      srt-cod-fop-mne      to   w-liv-fop-mne-fop      .
      *                  *---------------------------------------------*
      *                  * Flag di esistenza per la forma pagamento    *
      *                  *---------------------------------------------*
           move      srt-cod-fop-flg      to   w-liv-fop-flg-fop      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fop-tot-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fop-tot-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fop-tot-p3r      .
      *                  *---------------------------------------------*
      *                  * Numero di fornitori trattati                *
      *                  *---------------------------------------------*
           move      zero                 to   w-liv-fop-num-fnt      .
      *                  *---------------------------------------------*
      *                  * Numero di categorie sconto trattate         *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-gen-num-fop      .
       prn-ini-lr2-200.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo dettaglio stampa  *
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-liv-fop-cod-fop    to   w-stp-sub-cod-num      .
      *                          *-------------------------------------*
      *                          * Valore del codice, alfanumerico     *
      *                          *-------------------------------------*
           move      spaces               to   w-stp-sub-cod-alf      .
      *                          *-------------------------------------*
      *                          * Descrizione per il codice           *
      *                          *-------------------------------------*
           move      w-liv-fop-des-fop    to   w-stp-sub-cod-des      .
       prn-ini-lr2-550.
      *                      *-----------------------------------------*
      ...
      *              * Determinazione % di variazione                  *
      *              *-------------------------------------------------*
           move      w-liv-fop-tot-p1r    to   w-stp-clc-pdv-v01      .
           move      w-liv-fop-tot-p2r    to   w-stp-clc-pdv-v02      .
           move      w-liv-fop-tot-p3r    to   w-stp-clc-pdv-v03      .
           perform   stp-clc-pdv-000      thru stp-clc-pdv-999        .
       prn-fin-lr2-125.
      *              *-------------------------------------------------*
      *              * Determinazione valore del campo 'Note' per il   *
      *              * totale codice forma pagamento                   *
      *              *-------------------------------------------------*
       prn-fin-lr2-200.
      *              *-------------------------------------------------*
      *              * Deviazione a seconda del tipo dettaglio stampa  *
      ...
      *                          * Codice forma pagamento fornitore    *
      *                          *-------------------------------------*
           move      w-liv-fop-cod-fop    to   w-stp-cmd-fop-cod      .
      *                          *-------------------------------------*
      *                          * Mnemonico forma pagamento           *
      *                          *-------------------------------------*
           move      w-liv-fop-mne-fop    to   w-stp-cmd-fop-mne      .
      *                          *-------------------------------------*
      *                          * Descrizione forma pagamento         *
      *                          *-------------------------------------*
           move      w-liv-fop-des-fop    to   w-stp-cmd-fop-des      .
       prn-fin-lr2-332.
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
           perform   stp-cmd-fop-000      thru stp-cmd-fop-999        .
       prn-fin-lr2-340.
      *                  *---------------------------------------------*
      ...
      *                      * Preparazione                            *
      *                      *-----------------------------------------*
           move      w-liv-fop-tot-p1r    to   w-stp-sta-fep-f01      .
           move      w-liv-fop-tot-p2r    to   w-stp-sta-fep-f02      .
           move      w-liv-fop-tot-p3r    to   w-stp-sta-fep-f03      .
      ...
      *                      *-----------------------------------------*
           add       1                    to   w-liv-fop-cst-ctr      .
      *                      *-----------------------------------------*
      *                      * Test se superato l'ultimo elemento      *
      *                      *-----------------------------------------*
           if        w-liv-fop-cst-ctr    >    w-liv-fop-cst-max
                     move  w-liv-fop-cst-max
                                          to   w-liv-fop-cst-ctr
                     move  "(ALTRE)"      to   w-liv-fop-cst-des
                                              (w-liv-fop-cst-max)
                     add   w-liv-fop-tot-p1r
                                          to   w-liv-fop-cst-val
                                              (w-liv-fop-cst-max)
                     go to prn-fin-lr2-390.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      w-liv-fop-des-fop    to   w-liv-fop-cst-des
                                              (w-liv-fop-cst-ctr)     .
           if        w-liv-fop-des-fop    =    spaces
                     move  "(Non Classificati)"
                                          to   w-liv-fop-cst-des
                                              (w-liv-fop-cst-ctr)     .
      *
           move      w-liv-fop-tot-p1r    to   w-liv-fop-cst-val
                                              (w-liv-fop-cst-ctr)     .
       prn-fin-lr2-390.
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      ...
      *                  *---------------------------------------------*
       ...
       prn-fin-lr2-420.
      *                  *---------------------------------------------*
      *                  * Stampa totale forma pagamento               *
      *                  *---------------------------------------------*
       prn-fin-lr2-430.
      *                      *-----------------------------------------*
      *                      * Preparazione literal per il totale      *
      *                      *-----------------------------------------*
           move      "Totale forma pagamento  :                         
      -              "      "             to   w-stp-sta-tot-lit      .
      ...
      *                      *-----------------------------------------*
           move      w-liv-fop-tot-p1r    to   w-stp-sta-tot-f01      .
           move      w-liv-fop-tot-p2r    to   w-stp-sta-tot-f02      .
           move      w-liv-fop-tot-p3r    to   w-stp-sta-tot-f03      .
           move      w-stp-clc-pdv-p01    to   w-stp-sta-tot-p01      .
           move      spaces               to   w-stp-sta-tot-not      .
           move      w-stp-clc-pdv-p02    to   w-stp-sta-tot-p02      .
       prn-fin-lr2-450.
      ...
      *                  *---------------------------------------------*
      *                  * Numero di fornitori trattati per pagamento  *
      *                  *---------------------------------------------*
           add       1                    to   w-liv-fop-num-fnt      .
       prn-ini-lr1-200.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-150.
      *              *-------------------------------------------------*
      *              * Accumuli per livello forma pagamento  per il    *
      *              * fornitore                                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Totale fatturato 1. periodo di riferimento  *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn1      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-val
                                          to   w-liv-fop-tot-p1r
                     else  subtract srt-val-sta-val
                                          from w-liv-fop-tot-p1r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 2. periodo di riferimento  *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn2      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-val
                                          to   w-liv-fop-tot-p2r
                     else  subtract srt-val-sta-val
                                          from w-liv-fop-tot-p2r      .
      *                  *---------------------------------------------*
      *                  * Totale fatturato 3. periodo di riferimento  *
      *                  *---------------------------------------------*
           if        srt-val-sta-sn3      =    "S"
                     if    srt-val-sta-pon
                                          not  = "N"
                           add      srt-val-sta-val
                                          to   w-liv-fop-tot-p3r
                     else  subtract srt-val-sta-val
                                          from w-liv-fop-tot-p3r      .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      ...
      *                      * Literal                                 *
      *                      *-----------------------------------------*
           move      "Fornitori non classificati per forma di pagamento 
      -              "                      "
      ...
      *              *   - 01 : Solo totale per codice pagamento       *
      *              *   - 02 : Con anche il totale per ogni fornitore *
      *              *-------------------------------------------------*
       stp-fds-tot-405.
      *                  *---------------------------------------------*
      ...
      *    * della descrizione, della forma di pagamento               *
      *    *                                                           *
      *    * - Parametri in input                                      *
      *    *                                                           *
      *    *   - w-stp-cmd-fop-cod : Codice numerico                   *
      *    *                                                           *
      *    *   - w-stp-cmd-fop-mne : Mnemonico                         *
      *    *                                                           *
      *    *   - w-stp-cmd-fop-des : Descrizione                       *
      *    *                                                           *
      *    *-----------------------------------------------------------*
       stp-cmd-fop-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-stp-cmd-fop-cod    =    zero
                     go to stp-cmd-fop-300
           else      go to stp-cmd-fop-600.
       stp-cmd-fop-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      w-stp-cmd-fop-cod    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cmd-fop-700.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      010                  to   p-pos                  .
           move      w-stp-cmd-fop-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cmd-fop-800.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-let-arc-yfp-cod    =    w-let-arc-yfp-exc
      ...
      *              *-------------------------------------------------*
           move      w-let-arc-yfp-cod    to   w-let-arc-yfp-exc      .
       let-arc-yfp-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-liv-fop-cst-ctr    to   m-gen-grf-num-prd      .
           move      "Statistica di acquisto - Forma pagamento"
                                          to   m-gen-grf-tit-grf      .
           move      "saf870"             to   m-gen-grf-fil-nam      .
       exe-sqz-grf-200.
      *              *-------------------------------------------------*
      ...
      *              * Ciclo dati                                      *
      *              *-------------------------------------------------*
           move      zero                 to   w-liv-fop-cst-ct1      .
           move      1                    to   w-liv-fop-cst-ct2      .
           move      zero                 to   w-liv-fop-cst-ct3      .
       exe-sqz-grf-500.
           add       1                    to   w-liv-fop-cst-ct1      .
           add       1                    to   w-liv-fop-cst-ct3      .
           if        w-liv-fop-cst-ct1    >    36
                     go to exe-sqz-grf-800.
           if        w-liv-fop-cst-ct3    >    12
                     add   1              to   w-liv-fop-cst-ct2
                     move  1              to   w-liv-fop-cst-ct3      .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione                             *
      *                  *---------------------------------------------*
           move      w-liv-fop-cst-des
                    (w-liv-fop-cst-ct1)   to   m-gen-grf-mes-des
                                              (w-liv-fop-cst-ct2,
                                               w-liv-fop-cst-ct3)     .
           move      w-liv-fop-cst-val
                    (w-liv-fop-cst-ct1)   to   m-gen-grf-mes-val
                                              (w-liv-fop-cst-ct2,
                                               w-liv-fop-cst-ct3)     .
       exe-sqz-grf-600.
      *                  *---------------------------------------------*
