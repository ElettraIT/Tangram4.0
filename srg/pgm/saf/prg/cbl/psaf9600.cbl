      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase saf960, nella sua globalita', esegue i tipi di gene-   *
      ...
      * SAF830      Statistica per classificazione Fornitore           *
      * SAF870      Statistica per forma di pagamento                  *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'saf960'           *
      *              *-------------------------------------------------*
           perform   fas-saf-960-000      thru fas-saf-960-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *                  * saf830                                      *
      *                  *---------------------------------------------*
           move      "Statistica per classificazione Fornitore  (saf830)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "SAF830    "         to   w-tin-ele-wci-alf      .
           move      "pgm/saf/prg/obj/psaf8300                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * saf870                                      *
      *                  *---------------------------------------------*
           move      "Statistica per forma di Pagamento         (saf870)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "SAF870    "         to   w-tin-ele-wci-alf      .
           move      "pgm/saf/prg/obj/psaf8700                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-saf-960-300
           else if   v-key                =    "PRSC"
                     go to fas-saf-960-400
           else if   v-key                =    "NXSC"
                     go to fas-saf-960-450
           else if   v-key                =    "DOWN"
                     go to fas-saf-960-500
           else if   v-key                =    "EXIT"
                     go to fas-saf-960-250
           else      go to fas-saf-960-200.
       fas-saf-960-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-saf-960-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-saf-960-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-saf-960-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-saf-960-350
           else      go to fas-saf-960-322.
       fas-saf-960-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-saf-960-630
           else if   v-key                =    "PRSC"
                     go to fas-saf-960-600
           else if   v-key                =    "NXSC"
                     go to fas-saf-960-610
           else if   v-key                =    "UP  "
                     go to fas-saf-960-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-saf-960-650
           else if   v-key                =    "EXIT"
                     go to fas-saf-960-660
           else      go to fas-saf-960-570.
       fas-saf-960-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-saf-960-626
           else      go to fas-saf-960-628.
       fas-saf-960-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-saf-960-636
           else      go to fas-saf-960-638.
       fas-saf-960-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-saf-960-725
           else      go to fas-saf-960-750.
       fas-saf-960-725.
      *              *-------------------------------------------------*
