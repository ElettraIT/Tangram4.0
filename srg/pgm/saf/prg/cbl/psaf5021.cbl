      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psaf5021:       *
      *                                                                *
      ...
      *                      * Tipo voce di magazzino                  *
      *                      *-----------------------------------------*
           move      01                   to   w-mod-ffo-ffr-tmg      .
      *                      *-----------------------------------------*
      *                      * Codice prodotto                         *
      *                      *-----------------------------------------*
           move      rf-dcp-num-pro       to   w-mod-ffo-ffr-pro      .
      *                      *-----------------------------------------*
      *                      * Numero periodi di riferimento           *
      *                      *-----------------------------------------*
           if        rr-num-pdr           =    11 or
      ...
      *                      * Codice prodotto numerico                *
      *                      *-----------------------------------------*
           move      rf-dcp-num-pro       to   w-sel-ffr-num-mag      .
      *                      *-----------------------------------------*
      *                      * Codice prodotto alfanumerico            *
      *                      *-----------------------------------------*
           move      rf-dcp-alf-pro       to   w-sel-ffr-alf-mag      .
      *                      *-----------------------------------------*
      *                      * Descrizione prodotto                    *
      *                      *-----------------------------------------*
           move      rf-dcp-des-pro       to   w-sel-ffr-des-mag      .
      *                      *-----------------------------------------*
      *                      * Unita' di misura di vendita per il pro- *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      rf-dcp-umi-ven       to   w-sel-ffr-umi-mag      .
      *                      *-----------------------------------------*
      *                      * Numero decimali quantita' per il pro-   *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      rf-dcp-dec-qta       to   w-sel-ffr-dec-pro      .
      *                      *-----------------------------------------*
      *                      * Classe merceologica del prodotto        *
      *                      *-----------------------------------------*
           move      rf-dcp-cla-pro       to   w-sel-ffr-cla-pro      .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico del prodotto        *
      *                      *-----------------------------------------*
           move      rf-dcp-gru-pro       to   w-sel-ffr-gru-pro      .
      *                      *-----------------------------------------*
      *                      * Sottogruppo merceologico del prodotto   *
      *                      *-----------------------------------------*
           move      rf-dcp-sgr-pro       to   w-sel-ffr-sgr-pro      .
      *                      *-----------------------------------------*
      *                      * Tipo di prodotto                        *
      *                      *-----------------------------------------*
           move      rf-dcp-tip-pro       to   w-sel-ffr-tip-pro      .
       sel-ffr-rec-300.
      *              *-------------------------------------------------*
      ...
      *                      * Codice numerico del prodotto            *
      *                      *-----------------------------------------*
           move      w-sel-ffr-num-mag    to   srt-cod-pro-num        .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico del prodotto        *
      *                      *-----------------------------------------*
           move      w-sel-ffr-alf-mag    to   srt-cod-pro-alf        .
      *                      *-----------------------------------------*
      *                      * Descrizione del prodotto                *
      *                      *-----------------------------------------*
           move      w-sel-ffr-des-mag    to   srt-cod-pro-des        .
      *                      *-----------------------------------------*
      *                      * Unita' di misura del prodotto           *
      *                      *-----------------------------------------*
           move      w-sel-ffr-umi-mag    to   srt-cod-pro-umi        .
      *                      *-----------------------------------------*
      ...
      *                      * Tipo di prodotto                        *
      *                      *-----------------------------------------*
           move      w-sel-ffr-tip-pro    to   srt-cod-pro-tip        .
       cmp-srt-rec-850.
      *                  *---------------------------------------------*
      *                  * Cliente                                     *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "STATISTICA SUL FATTURATO DI ACQUISTO              
      -              "                              "
