      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psaf2801:       *
      *                                                                *
      ...
      *                *-----------------------------------------------*
      *                * Codice prodotto, unita' di misura di acquisto *
      *                *-----------------------------------------------*
      ...
      *                *-----------------------------------------------*
      *                * Valore ABC per il prodotto nell'ambito del    *
      *                * fornitore                                     *
      *                *-----------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-mtv.
               10  w-let-arc-mtv-cod      pic  9(07)     value zero   .
               10  w-let-arc-mtv-flg      pic  x(01)     value spaces .
               10  w-let-arc-mtv-alf      pic  x(14)     value spaces .
               10  w-let-arc-mtv-des      pic  x(40)     value spaces .
               10  w-let-arc-mtv-umi      pic  x(03)     value spaces .
               10  w-let-arc-mtv-dec      pic  9(01)     value zero   .
               10  w-let-arc-mtv-exc      pic  9(07)     value zero   .
      ...
      *            *---------------------------------------------------*
      *            * Numero prodotti trattati per il fornitore         *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Unita' di misura di acquisto per il prodotto          *
      *        *-------------------------------------------------------*
      ...
      *              * dotti [mtv] indica la selezione di un solo co-  *
      ...
      *                  *---------------------------------------------*
           subtract  10000000             from rr-fso-mtv
       ...
       sel-ffr-rec-100.
      *              *-------------------------------------------------*
      *              * Lettura anagrafica [mtv]                        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura                                     *
      *                  *---------------------------------------------*
           move      rf-ffr-num-mag       to   w-let-arc-mtv-cod      .
      ...
      *                      * Codice prodotto numerico                *
      *                      *-----------------------------------------*
           move      w-let-arc-mtv-cod    to   w-sel-ffr-num-pro      .
      *                      *-----------------------------------------*
      *                      * Codice prodotto alfanumerico            *
      *                      *-----------------------------------------*
           move      w-let-arc-mtv-alf    to   w-sel-ffr-alf-pro      .
      *                      *-----------------------------------------*
      *                      * Descrizione prodotto                    *
      *                      *-----------------------------------------*
           move      w-let-arc-mtv-des    to   w-sel-ffr-des-pro      .
      *                      *-----------------------------------------*
      *                      * Unita' di misura di acquisto per pro-   *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      w-let-arc-mtv-umi    to   w-sel-ffr-umi-pro      .
      *                      *-----------------------------------------*
      *                      * Numero decimali quantita' per il pro-   *
      *                      * dotto                                   *
      *                      *-----------------------------------------*
           move      w-let-arc-mtv-dec    to   w-sel-ffr-dec-pro      .
       sel-ffr-rec-200.
      *              *-------------------------------------------------*
      *              * Se il filtro di selezione sull'anagrafica pro-  *
      *              * dotti [mtv] indica la selezione di un solo co-  *
      ...
      *              *-------------------------------------------------*
       ...
       sel-ffr-rec-300.
      *              *-------------------------------------------------*
      *              * Se record [mtv] non esistente : selezione non   *
      *              * superata                                        *
      *              *-------------------------------------------------*
      ...
      *              * lezione su anagrafica prodotti [mtv], e devia-  *
      ...
      *                      * prodotto, della sua descrizione         *
      *                      *-----------------------------------------*
       prn-liv-det-651.
      *                          *-------------------------------------*
      *                          * Preparazione                        *
      ...
      *              * sta documenti emessi per ogni prodotto          *
      *              *-------------------------------------------------*
       stp-fnc-vrt-605.
      *                  *---------------------------------------------*
      *                  * Test se numero linee residue sufficienti    *
      ...
      *              *-------------------------------------------------*
           if        w-let-arc-mtv-cod    =    w-let-arc-mtv-exc
                     go to let-arc-mtv-900.
       let-arc-mtv-100.
      *              *-------------------------------------------------*
      *              * Se codice a zero                                *
      *              *-------------------------------------------------*
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-let-arc-mtv-cod    not  = zero
                     go to let-arc-mtv-200.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      zero                 to   w-let-arc-mtv-dec      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-mtv-900.
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-mtv-300.
      *              *-------------------------------------------------*
      *              * Se record esistente in archivio [mtv]           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Flag di uscita a spaces                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-mtv-dec-qta       to   w-let-arc-mtv-dec      .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     let-arc-mtv-900.
       let-arc-mtv-400.
      *              *-------------------------------------------------*
      *              * Se record non esistente in archivio [mtv]       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Flag di uscita a '#'                        *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-let-arc-mtv-cod    to   w-let-arc-mtv-exc      .
       let-arc-mtv-999.
           exit.
