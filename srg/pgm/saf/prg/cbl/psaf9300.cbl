      ...
      *                                   Fase:    saf930              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 26/11/04    *
      *                       Ultima revisione:    NdK del 14/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione esclusione documenti dalle         *
      *                    statistiche                                 *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  ESCLUSIONE DOCUMENTI DA STATISTICHE   "       .
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice fornit. commerciale     *
      *    *-----------------------------------------------------------*
           ...
           05  w-exp-snx-sos.
               ...
               10  w-exp-snx-sos-tbl.
                   15  filler             pic  x(40) value
                            "Tutti i documenti                       ".
                   15  filler             pic  x(40) value
                            "solo quelli gia' Esclusi                ".
      *        *-------------------------------------------------------*
      *        * Work per : No/Si esclusione da statistiche            *
      *        *-------------------------------------------------------*
           05  w-exp-saf-snx.
               10  w-exp-saf-snx-num      pic  9(02)       value 2    .
               10  w-exp-saf-snx-lun      pic  9(02)       value 02   .
               10  w-exp-saf-snx-tbl.
      ...
      *    *-----------------------------------------------------------*
       01  w-fnd.
      *        *-------------------------------------------------------*
      *        * Work per Find su archivio [sff]                       *
      *        *-------------------------------------------------------*
           05  w-fnd-arc-sff.
               10  w-fnd-arc-sff-sel      pic  x(01)                  .
               10  w-fnd-arc-sff-sns      pic  x(01)                  .
               10  w-fnd-arc-sff-fnt      pic  9(07)                  .
               10  w-fnd-arc-sff-dpf      pic  x(04)                  .
               10  w-fnd-arc-sff-tip      pic  9(02)                  .
               10  w-fnd-arc-sff-tpv      pic  9(02)                  .
               10  w-fnd-arc-sff-vlt      pic  x(03)                  .
               10  w-fnd-arc-sff-num      pic  9(11)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [sff]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-sff.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-sff-prt      pic  9(11)                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per : Si/no solo esclusi          *
      *    *-----------------------------------------------------------*
       pmt-snx-sos-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           if        w-tes-cod-fnt        =    zero
                     move  "Tutti"        to   w-tes-cod-fnt-rag
      ...
      *                  *---------------------------------------------*
      *                  * Find su archivio [sff]                      *
      *                  *---------------------------------------------*
           move      "N"                  to   w-fnd-arc-sff-sns      .
           move      w-tes-cod-fnt        to   w-fnd-arc-sff-fnt      .
           move      spaces               to   w-fnd-arc-sff-dpf      .
           move      zero                 to   w-fnd-arc-sff-tip      .
           move      zero                 to   w-fnd-arc-sff-tpv      .
           move      spaces               to   w-fnd-arc-sff-vlt      .
           perform   fnd-arc-sff-000      thru fnd-arc-sff-999        .
      ...
      *    *===========================================================*
      *    * Accettazione : Si/no solo esclusi                         *
      *    *-----------------------------------------------------------*
       acc-snx-sos-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-saf-snx        not  = 01 and
                     w-tes-saf-snx        not  = 02
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/no solo esclusi                      *
      *    *-----------------------------------------------------------*
       vis-snx-sos-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *                  * Esclusione da statistiche                   *
      *                  *---------------------------------------------*
           perform   acc-saf-snx-000      thru acc-saf-snx-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  *---------------------------------------------*
       ...
       vis-lin-cor-490.
      *                  *---------------------------------------------*
      *                  * Si/no esclusione da statistiche             *
      *                  *---------------------------------------------*
           if        w-rig-saf-snx        =    spaces
                     move  spaces         to   w-lin-imm-snx-saf
           else      move  "*"            to   w-lin-imm-snx-saf      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Editing Numero documento                    *
      *                  *---------------------------------------------*
           move      rf-sff-ndo-ftf       to   w-lin-imm-num-doc      .
       vis-lin-cor-540.
      *                  *---------------------------------------------*
      ...
      *              * Esclusione da statistiche                       *
      *              *-------------------------------------------------*
           perform   vis-saf-snx-000      thru vis-saf-snx-999        .
      *              *-------------------------------------------------*
      *              * Estremi documento                               *
      *              *-------------------------------------------------*
      ...
      *              * Esclusione da statistiche                       *
      *              *-------------------------------------------------*
           perform   pmt-saf-snx-000      thru pmt-saf-snx-999        .
      *              *-------------------------------------------------*
      *              * Estremi documento                               *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Esclusione da statistiche        *
      *    *-----------------------------------------------------------*
       pmt-saf-snx-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Esclusione da statistiche            *
      *    *-----------------------------------------------------------*
       acc-saf-snx-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-saf-snx-lun    to   v-car                  .
           move      w-exp-saf-snx-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      19                   to   v-lin                  .
           move      22                   to   v-pos                  .
           move      w-exp-saf-snx-tbl    to   v-txt                  .
      *
           if        w-rig-saf-snx        =    spaces
                     move  1              to   v-num
           else if   w-rig-saf-snx        =    "#"
                     move  2              to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-saf-snx-999.
       acc-saf-snx-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    1
                     move  spaces         to   w-rig-saf-snx
           else if   v-num                =    2
                     move  "#"            to   w-rig-saf-snx
           else      move  spaces         to   w-rig-saf-snx          .
       acc-saf-snx-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *
           if        rf-sff-tip-ftf       =    01
                     ...
                     move  "N.Ad."        to   w-all-str-cat (1)
           else if   rf-sff-tip-ftf       =    03
                     move  "N.Ac."        to   w-all-str-cat (1)
           else      move  "?"            to   w-all-str-cat (1)      .
      *
           move      rf-sff-ndo-ftf       to   w-all-str-cat (2)      .
      ...
      *                  *---------------------------------------------*
      ...
      -              " esecuzione ---               "
       ...
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Start su [sff] per data registrazione           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "IDEDOC    "         to   f-key                  .
           move      w-tes-dat-min        to   rf-sff-ddo-ftf         .
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-sff-ddo-ftf       >    w-tes-dat-min
      ...
      *                  *---------------------------------------------*
           if        rf-sff-ddo-ftf       >    w-tes-dat-max
                     go to stp-srt-inp-900.
           go to     stp-srt-inp-400.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-420.
      *                  *---------------------------------------------*
      *                  * Selezione su esclusione                     *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test si si/no solo esclusi              *
      *                      *-----------------------------------------*
           if        w-tes-saf-snx        not  = 02
                     go to stp-srt-inp-440.
           if        rf-sff-flg-nbx (1)   =    spaces
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-sff-cod-fnt       not  = w-tes-cod-fnt
                     go to stp-srt-inp-200.
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      ...
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-sff-ddo-ftf       to   srt-dat-doc            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-sff               to   w-rig-rec-sff          .
           move      rf-sff-cod-fnt       to   w-rig-cod-fnt          .
           move      rf-sff-dpz-fnt       to   w-rig-dpz-fnt          .
           move      rf-sff-flg-nbx (1)   to   w-rig-saf-snx          .
      *                      *-----------------------------------------*
      ...
      *                      * Valuta                                  *
      *                      *-----------------------------------------*
           move      rf-sff-sgl-vlt       to   w-rig-sgl-vlt          .
           move      rf-sff-dec-vlt       to   w-rig-dec-vlt          .
       car-fil-rap-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-rig-rec-sff        to   rf-sff                 .
           move      rf-sff-num-ftf       to   w-cmp-rec-sff-prt      .
       sca-fil-rap-500.
      *              *-------------------------------------------------*
      *              * Aggiornamento documenti                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Ottenimento record [sff]                    *
      *                  *---------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMFTF    "         to   f-key                  .
           move      w-cmp-rec-sff-prt    to   rf-sff-num-ftf         .
           move      "pgm/scf/fls/ioc/obj/iofsff"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        w-rig-saf-snx        =    rf-sff-flg-nbx (1)
      ...
      *                  *---------------------------------------------*
      *                  * Aggiornamento esclusione da statistiche     *
      *                  *---------------------------------------------*
           move      w-rig-saf-snx        to   rf-sff-flg-nbx (1)     .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [sff]                         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-fnd-arc-sff-fnt    =    zero
                     go to fnd-arc-sff-075.
      *                  *---------------------------------------------*
      *                  * Scrittura effettiva                         *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
           ...
           move      w-fnd-arc-sff-fnt    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
       fnd-arc-sff-075.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-fnd-arc-sff-dpf    =    spaces
                     go to fnd-arc-sff-100.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      04                   to   s-car                  .
           move      w-fnd-arc-sff-dpf    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
       fnd-arc-sff-100.
      *              *-------------------------------------------------*
      *              * Scrittura variabile di i.p.c. 'tip-ftf' per il  *
      *              * livello successivo per il tipo fattura fornito- *
      *              * re                                              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * cessive                                     *
      *                  *---------------------------------------------*
           if        w-fnd-arc-sff-tip    <    01 or
                     w-fnd-arc-sff-tip    >    03
                     go to fnd-arc-sff-150.
      *                  *---------------------------------------------*
      *                  * Scrittura effettiva                         *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
           ...
           move      zero                 to   s-dec                  .
           move      spaces               to   s-sgn                  .
           move      w-fnd-arc-sff-tip    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
       fnd-arc-sff-125.
      *              *-------------------------------------------------*
      *              * Scrittura variabile di i.p.c. 'tpv-ftf' per il  *
      *              * livello successivo per il tipo provenienza fat- *
      *              * tura fornitore                                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se valore non ammesso : no scritture suc-   *
      *                  * cessive                                     *
      *                  *---------------------------------------------*
           if        w-fnd-arc-sff-tpv    <    01 or
                     w-fnd-arc-sff-tpv    >    04
                     go to fnd-arc-sff-150.
      *                  *---------------------------------------------*
      *                  * Scrittura effettiva                         *
      *                  *---------------------------------------------*
           ...
           move      zero                 to   s-dec                  .
           move      spaces               to   s-sgn                  .
           move      w-fnd-arc-sff-tpv    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
       fnd-arc-sff-150.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se il tipo provenienza non lo prevede : no  *
      *                  * scrittura                                   *
      *                  *---------------------------------------------*
           if        w-fnd-arc-sff-tpv    not  = 02 and
                     w-fnd-arc-sff-tpv    not  = 03
                     go to fnd-arc-sff-200.
      *                  *---------------------------------------------*
      *                  * Se valore a spaces : no scrittura           *
      *                  *---------------------------------------------*
           if        w-fnd-arc-sff-vlt    =    spaces
                     go to fnd-arc-sff-200.
      *                  *---------------------------------------------*
      *                  * Scrittura effettiva                         *
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      03                   to   s-car                  .
           move      w-fnd-arc-sff-vlt    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
       fnd-arc-sff-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-fnd-arc-sff-sns    not  = "S"
                     go to fnd-arc-sff-300.
      *                  *---------------------------------------------*
      *                  * Scrittura effettiva                         *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *                  *---------------------------------------------*
           if        w-fnd-arc-sff-sns    not  = "S"
                     go to fnd-arc-sff-999.
      *                  *---------------------------------------------*
      *                  * Lettura variabile di i.p.c. 'num-ftf' dal   *
      ...
      *                  *---------------------------------------------*
           if        s-ves                =    spaces
                     go to fnd-arc-sff-325
           else      go to fnd-arc-sff-350.
       fnd-arc-sff-325.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      spaces               to   w-fnd-arc-sff-sel      .
      *                      *-----------------------------------------*
      *                      * Numero scadenza selezionata             *
      *                      *-----------------------------------------*
           move      s-num                to   w-fnd-arc-sff-num      .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     fnd-arc-sff-999.
      ...
      *    *===========================================================*
      *    * Routine per Expand anagrafica commerciale fornit. in riga *
      *    *-----------------------------------------------------------*
       rou-exp-ana-000.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione codice fornit. commerciale *
      *    *-----------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/saf/prg/obj/psaf9302"                       .
       cnc-rlt-sup-999.
           exit.
