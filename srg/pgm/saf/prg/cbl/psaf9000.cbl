      ...
      *                       Ultima revisione:    NdK del 18/11/20    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Generazione archivi esportabili da stampe   *
      *                    statistiche sul fatturato di acquisto       *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase saf900, nella sua globalita', esegue i tipi di gene-   *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * saf200      Statistica per Fornitore merce                     *
      * saf250      Statistica per Fornitore merce - prodotto          *
      * saf570      Statistica per Materia Prima - Fornitore           *
      * saf800      Statistica per fornitore generico                  *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'saf900'           *
      *              *-------------------------------------------------*
           perform   fas-saf-900-000      thru fas-saf-900-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *                  * saf200                                      *
      *                  *---------------------------------------------*
           move      "Statistica per fornitore merce            (saf200)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "saf200    "         to   w-tin-ele-wci-alf      .
           move      "pgm/saf/prg/obj/psaf2000                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * saf250                                      *
      *                  *---------------------------------------------*
           move      "Statistica per fornitore - Prodotto       (saf250)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "saf250    "         to   w-tin-ele-wci-alf      .
           move      "pgm/saf/prg/obj/psaf2500                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * saf570                                      *
      *                  *---------------------------------------------*
           move      "Statistica per materia prima - fornitore  (saf570)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "saf570    "         to   w-tin-ele-wci-alf      .
           move      "pgm/saf/prg/obj/psaf5700                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                  *---------------------------------------------*
      *                  * saf800                                      *
      *                  *---------------------------------------------*
           move      "Statistica per fornitore generico         (saf800)
      -              ""                   to   w-tin-ele-wci-des      .
           move      spaces               to   w-tin-ele-wci-ast      .
           move      "saf800    "         to   w-tin-ele-wci-alf      .
           move      "pgm/saf/prg/obj/psaf8000                "
                                          to   w-tin-ele-wci-ovy      .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-saf-900-300
           else if   v-key                =    "PRSC"
                     go to fas-saf-900-400
           else if   v-key                =    "NXSC"
                     go to fas-saf-900-450
           else if   v-key                =    "DOWN"
                     go to fas-saf-900-500
           else if   v-key                =    "EXIT"
                     go to fas-saf-900-250
           else      go to fas-saf-900-200.
       fas-saf-900-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-saf-900-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-saf-900-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-saf-900-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-saf-900-350
           else      go to fas-saf-900-322.
       fas-saf-900-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-saf-900-630
           else if   v-key                =    "PRSC"
                     go to fas-saf-900-600
           else if   v-key                =    "NXSC"
                     go to fas-saf-900-610
           else if   v-key                =    "UP  "
                     go to fas-saf-900-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-saf-900-650
           else if   v-key                =    "EXIT"
                     go to fas-saf-900-660
           else      go to fas-saf-900-570.
       fas-saf-900-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-saf-900-626
           else      go to fas-saf-900-628.
       fas-saf-900-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-saf-900-636
           else      go to fas-saf-900-638.
       fas-saf-900-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-saf-900-725
           else      go to fas-saf-900-750.
       fas-saf-900-725.
      *              *-------------------------------------------------*
