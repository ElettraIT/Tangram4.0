      ...
      *                       Ultima revisione:    NdK del 10/05/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma psaf5701:        *
      *                                                                *
      *                    Stampa statistica di vendita sul fatturato  *
      *                    per materia prima - fornitore.              *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "FATTURATO PER MATERIA PRIMA - FORNITORE "       .
      ...
      *        *-------------------------------------------------------*
           05  w-let-arc-dpm.
               10  w-let-arc-dpm-num      pic  9(07)     value zero   .
               10  w-let-arc-dpm-flg      pic  x(01)     value spaces .
               10  w-let-arc-dpm-alf      pic  x(14)     value spaces .
               10  w-let-arc-dpm-des      pic  x(40)     value spaces .
               10  w-let-arc-dpm-exn      pic  9(07)     value zero   .
      ...
      *    *-----------------------------------------------------------*
       pmt-tor-pro-000.
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Ordinamento materie prime  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-tor-pro-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-num-pro           to   w-cod-cod-dpm-num      .
           move      rr-alf-pro           to   w-cod-cod-dpm-alf      .
           move      04                   to   w-cod-cod-dpm-lin      .
           move      26                   to   w-cod-cod-dpm-pos      .
           move      04                   to   w-cod-cod-dpm-dln      .
      ...
      *                  *---------------------------------------------*
           move      rr-num-pro           to   w-let-arc-dpm-num      .
      ...
      *                  *---------------------------------------------*
           if        rr-num-pro           =    zero
                     ...
                     move  "Tutte le materie prime                  "
                                          to   rr-num-pro-des
           else      move  w-let-arc-dpm-alf
                                          to   rr-alf-pro
                     move  w-let-arc-dpm-des
                                          to   rr-num-pro-des         .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-let-arc-dpm-num    =    w-let-arc-dpm-exn
                     go to let-arc-dpm-900.
       let-arc-dpm-100.
      *              *-------------------------------------------------*
      *              * Se codice a zero                                *
      *              *-------------------------------------------------*
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-let-arc-dpm-num    not  = zero
                     go to let-arc-dpm-200.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       let-arc-dpm-300.
      *              *-------------------------------------------------*
      *              * Se record esistente in archivio [dpm]           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Flag di uscita a spaces                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       let-arc-dpm-400.
      *              *-------------------------------------------------*
      *              * Se record non esistente in archivio [dpm]       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Flag di uscita a '#'                        *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-let-arc-dpm-num    to   w-let-arc-dpm-exn      .
       let-arc-dpm-999.
           exit.
