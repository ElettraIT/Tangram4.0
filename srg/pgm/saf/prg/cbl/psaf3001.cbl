      ...
      *                       Ultima revisione:    NdK del 01/07/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione per il programma psaf3001:       *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           move      i-ide-fas            to   w-mod-ffo-fft-fas      .
           perform   mod-ffo-fft-opn-000  thru mod-ffo-fft-opn-999    .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   mod-ffo-fft-cls-000  thru mod-ffo-fft-cls-999    .
      *              *-------------------------------------------------*
      ...
      *                  * vio [fft]                                   *
      *                  *---------------------------------------------*
           perform   fil-fft-ing-000      thru fil-fft-ing-999        .
       stp-srt-inp-200.
      *                  *---------------------------------------------*
      *                  * Lettura sequenziale archivio [fft]          *
      *                  *---------------------------------------------*
           perform   fil-fft-get-000      thru fil-fft-get-999        .
      *                  *---------------------------------------------*
      *                  * Se fine file : ad uscita                    *
      *                  *---------------------------------------------*
           if        w-mod-ffo-fft-flg    not  = spaces
      ...
      *                  * si ignora il record                         *
      *                  *---------------------------------------------*
           if        w-mod-ffo-fft-pon    not  = "P" and
                     w-mod-ffo-fft-pon    not  = "N"
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      ...
      *                  * ra il record                                *
      *                  *---------------------------------------------*
           if        w-mod-ffo-fft-sn1    not  = "S" and
                     w-mod-ffo-fft-sn2    not  = "S" and
                     w-mod-ffo-fft-sn3    not  = "S"
                     go to stp-srt-inp-200.
      *                  *---------------------------------------------*
      ...
      *                  * [fft], dall'area 'w-sel-fft', dalle aree    *
      *                  * 'w-mod-ffo-fft' e 'w-not-ffo-fft' e 'rr'    *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       fil-fft-ing-000.
      *              *-------------------------------------------------*
      *              * Richiamo funzione 'GS' del modulo 'mffofft0'    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione                                *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-num-pdr           =    11 or
                     rr-num-pdr           =    12
                     move  02             to   w-mod-ffo-fft-npr
           else      move  rr-num-pdr     to   w-mod-ffo-fft-npr      .
      *                      *-----------------------------------------*
      *                      * 1. periodo, data min                    *
      *                      *-----------------------------------------*
           move      rr-p1d-min           to   w-mod-ffo-fft-p1i      .
      *                      *-----------------------------------------*
      *                      * 1. periodo, data max                    *
      *                      *-----------------------------------------*
           move      rr-p1d-max           to   w-mod-ffo-fft-p1f      .
      *                      *-----------------------------------------*
      *                      * 2. periodo, data min                    *
      *                      *-----------------------------------------*
           move      rr-p2d-min           to   w-mod-ffo-fft-p2i      .
      *                      *-----------------------------------------*
      *                      * 2. periodo, data max                    *
      *                      *-----------------------------------------*
           move      rr-p2d-max           to   w-mod-ffo-fft-p2f      .
      *                      *-----------------------------------------*
      *                      * 3. periodo, data min                    *
      *                      *-----------------------------------------*
           move      rr-p3d-min           to   w-mod-ffo-fft-p3i      .
      *                      *-----------------------------------------*
      *                      * 3. periodo, data max                    *
      *                      *-----------------------------------------*
           move      rr-p3d-max           to   w-mod-ffo-fft-p3f      .
      *                  *---------------------------------------------*
      *                  * Chiamata modulo                             *
      *                  *---------------------------------------------*
           perform   mod-ffo-fft-gts-000  thru mod-ffo-fft-gts-999    .
       fil-fft-ing-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       fil-fft-get-000.
      *              *-------------------------------------------------*
      *              * Richiamo funzione 'GT' del modulo 'mffofft0'    *
      *              *-------------------------------------------------*
           perform   mod-ffo-fft-get-000  thru mod-ffo-fft-get-999    .
       fil-fft-get-999.
           exit.
      ...
      *                      * Codice zona per il fornitore            *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-zon    to   w-sel-fft-zon-fnt      .
      *                      *-----------------------------------------*
      *                      * Codice categoria per il fornitore       *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-cat    to   w-sel-fft-cat-fnt      .
      *                      *-----------------------------------------*
      *                      * Codice statistico per il fornitore      *
      *                      *-----------------------------------------*
           move      w-let-fnt-dcf-stt    to   w-sel-fft-stt-fnt      .
       sel-fft-rec-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tcs-fnt           =    01
                     go to sel-fft-rec-250
           else if   rr-tcs-fnt           =    02
                     go to sel-fft-rec-275
           else if   rr-tcs-fnt           =    03
                     go to sel-fft-rec-300.
       sel-fft-rec-250.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-ccs-fnt           not  = zero          and
                     rr-ccs-fnt           not  = w-sel-fft-zon-fnt
                     go to sel-fft-rec-900.
       sel-fft-rec-260.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-sel-fft-zon-fnt    to   w-let-arc-yst-cod      .
      ...
      *                              * Codice zona                     *
      *                              *---------------------------------*
           move      w-let-arc-yst-cod    to   w-sel-fft-cod-csf      .
      *                              *---------------------------------*
      *                              * Descrizione zona                *
      *                              *---------------------------------*
           move      w-let-arc-yst-des    to   w-sel-fft-des-csf      .
      *                              *---------------------------------*
      *                              * Mnemonico zona                  *
      *                              *---------------------------------*
           move      w-let-arc-yst-mne    to   w-sel-fft-mne-csf      .
      *                              *---------------------------------*
      *                              * Flag di zona esistente          *
      *                              *---------------------------------*
           move      w-let-arc-yst-flg    to   w-sel-fft-flg-csf      .
       sel-fft-rec-265.
      *                      *-----------------------------------------*
      *                      * Continuazione                           *
      *                      *-----------------------------------------*
           go to     sel-fft-rec-400.
       sel-fft-rec-275.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-ccs-fnt           not  = zero          and
                     rr-ccs-fnt           not  = w-sel-fft-cat-fnt
                     go to sel-fft-rec-900.
       sel-fft-rec-285.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-sel-fft-cat-fnt    to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                          *-------------------------------------*
      *                          * Dati letti in area di comodo        *
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-ccs-fnt           not  = zero          and
                     rr-ccs-fnt           not  = w-sel-fft-stt-fnt
                     go to sel-fft-rec-900.
       sel-fft-rec-310.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-sel-fft-stt-fnt    to   w-let-arc-yst-cod      .
           perform   let-arc-yst-000      thru let-arc-yst-999        .
      *                          *-------------------------------------*
      *                          * Dati letti in area di comodo        *
      *                          *-------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fft-des-csf    to   srt-k01-des-csf        .
       cmp-srt-rec-225.
      *                      *-----------------------------------------*
      *                      * Mnemonico per classe statistica         *
      *                      *-----------------------------------------*
      ...
      *                          * Memorizzazione                      *
      *                          *-------------------------------------*
           move      w-sel-fft-mne-csf    to   srt-k01-mne-csf        .
       cmp-srt-rec-230.
      *                      *-----------------------------------------*
      *                      * Flag di codice a zero o diverso da zero *
      *                      *-----------------------------------------*
      ...
      *                      * Codice classe statistica                *
      *                      *-----------------------------------------*
           move      w-sel-fft-cod-csf    to   srt-k01-cod-csf        .
       cmp-srt-rec-300.
      *                  *---------------------------------------------*
      *                  * Subchiave 2 : Per fornitore                 *
      *                  *---------------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      w-sel-fft-cod-arc    to   srt-k02-cod-fnt        .
       cmp-srt-rec-340.
      *                      *-----------------------------------------*
      *                      * Codice dipendenza per il fornitore      *
      *                      *-----------------------------------------*
      ...
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           move      w-sel-fft-cod-csf    to   srt-cod-csf-cod        .
      *                      *-----------------------------------------*
      *                      * Mnemonico                               *
      *                      *-----------------------------------------*
           move      w-sel-fft-mne-csf    to   srt-cod-csf-mne        .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      *                      *-----------------------------------------*
           move      w-sel-fft-des-csf    to   srt-cod-csf-des        .
      *                      *-----------------------------------------*
      *                      * Flag di esistenza                       *
      *                      *-----------------------------------------*
           move      w-sel-fft-flg-csf    to   srt-cod-csf-flg        .
       cmp-srt-rec-850.
      *                  *---------------------------------------------*
      *                  * fornitore                                   *
      *                  *---------------------------------------------*
      ...
      *                              * 1. quantita'                    *
      *                              *---------------------------------*
           move      zero                 to   w-mod-not-saf-q01      .
      *                              *---------------------------------*
      *                              * 1. fatturato                    *
      *                              *---------------------------------*
           move      w-mod-ffo-fft-val    to   w-mod-not-saf-f01      .
      *                              *---------------------------------*
      *                              * 2. quantita'                    *
      *                              *---------------------------------*
      ...
      *                      * Importo fatturato                       *
      *                      *-----------------------------------------*
           move      w-mod-ffo-fft-val    to   srt-val-sta-val        .
      *                      *-----------------------------------------*
      *                      * Incidenza sulla statistica              *
      *                      *-----------------------------------------*
           move      w-mod-ffo-fft-pon    to   srt-val-sta-pon        .
      *                      *-----------------------------------------*
      *                      * Incidenza sul 1. periodo di riferimento *
      *                      *-----------------------------------------*
           move      w-mod-ffo-fft-sn1    to   srt-val-sta-sn1        .
      *                      *-----------------------------------------*
      *                      * Incidenza sul 2. periodo di riferimento *
      *                      *-----------------------------------------*
           move      w-mod-ffo-fft-sn2    to   srt-val-sta-sn2        .
      *                      *-----------------------------------------*
      *                      * Incidenza sul 3. periodo di riferimento *
      *                      *-----------------------------------------*
           move      w-mod-ffo-fft-sn3    to   srt-val-sta-sn3        .
       cmp-srt-rec-925.
      *                  *---------------------------------------------*
      *                  * Valori ABC                                  *
      *                  *---------------------------------------------*
      ...
      *                      * 1. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-csf-tot-p1r    to   w-mod-not-saf-f01      .
      *                      *-----------------------------------------*
      *                      * 2. quantita'                            *
      *                      *-----------------------------------------*
           move      zero                 to   w-mod-not-saf-q02      .
      ...
      *                      * 2. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-csf-tot-p2r    to   w-mod-not-saf-f02      .
      *                      *-----------------------------------------*
      *                      * 1. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p01    to   w-mod-not-saf-p01      .
      ...
      *                      * 3. fatturato                            *
      *                      *-----------------------------------------*
           move      w-liv-csf-tot-p3r    to   w-mod-not-saf-f03      .
      *                      *-----------------------------------------*
      *                      * 2. % di variazione                      *
      *                      *-----------------------------------------*
           move      w-stp-clc-pdv-p02    to   w-mod-not-saf-p02      .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-mod-not-saf-not    to   w-stp-sta-fep-not      .
       prn-fin-lr2-342.
      *                      *-----------------------------------------*
      *                      * Esecuzione                              *
      *                      *-----------------------------------------*
      ...
      *    * fatturato da Testata Documenti                            *
      *    *-----------------------------------------------------------*
           copy      "pgm/saf/prg/cpy/mffofft0.mds"                   .
