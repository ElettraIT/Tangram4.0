      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella centri di costo            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-cdc          pic  9(05)                  .
               10  w-tes-cod-cdc-aut      pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               ...
               10  w-tes-des-cdc          pic  x(40)                  .
               10  w-tes-tip-cdc          pic  9(02)                  .
               10  w-tes-alx-exp.
      ...
      *        *-------------------------------------------------------*
           05  w-enc-cdc-val-max          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Valore pre incremento                                 *
      *        *-------------------------------------------------------*
           05  w-enc-cdc-val-pre          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Valore post incremento                                *
      *        *-------------------------------------------------------*
           05  w-enc-cdc-val-pos          pic  9(05)                  .
      ...
      *              *-------------------------------------------------*
      *              * Open modulo accettazione codice centro di costo *
      *              *-------------------------------------------------*
           perform   cod-mne-cdc-opn-000  thru cod-mne-cdc-opn-999    .
       pre-exe-pgm-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       pos-exe-pgm-000.
      *              *-------------------------------------------------*
      *              * Close modulo accettazione codice centro di c.   *
      *              *-------------------------------------------------*
           perform   cod-mne-cdc-cls-000  thru cod-mne-cdc-cls-999    .
       pos-exe-pgm-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice centro di costo        *
      *    *-----------------------------------------------------------*
       pmt-cod-cdc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice centro di costo        *
      *    *-----------------------------------------------------------*
       acc-cod-cdc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cdc        to   w-cod-mne-cdc-cod      .
           move      04                   to   w-cod-mne-cdc-lin      .
           move      30                   to   w-cod-mne-cdc-pos      .
           move      07                   to   w-cod-mne-cdc-dln      .
           move      30                   to   w-cod-mne-cdc-dps      .
           move      "<B"                 to   v-edm                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "INSR"               to   v-pfk (04)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   cod-mne-cdc-cll-000  thru cod-mne-cdc-cll-999    .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
           perform   cod-mne-cdc-foi-000  thru cod-mne-cdc-foi-999    .
       acc-cod-cdc-110.
           perform   cod-mne-cdc-cll-000  thru cod-mne-cdc-cll-999    .
           if        w-cod-mne-cdc-ope    =    "F+"
                     go to acc-cod-cdc-115.
           if        w-cod-mne-cdc-ope    =    "AC"
                     go to acc-cod-cdc-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-cdc-115.
           perform   cod-mne-cdc-foi-000  thru cod-mne-cdc-foi-999    .
           go to     acc-cod-cdc-110.
       acc-cod-cdc-120.
           move      w-cod-mne-cdc-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-cdc        =    zero
                     go to acc-cod-cdc-420
           else      go to acc-cod-cdc-600.
       acc-cod-cdc-420.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice centro di costo     *
      *    *-----------------------------------------------------------*
       vis-cod-cdc-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           perform   acc-des-cdc-000      thru acc-des-cdc-999        .
           if        v-key                =    "NXSC"
      ...
      *              * Descrizione centro di costo                     *
      *              *-------------------------------------------------*
           perform   vis-des-cdc-000      thru vis-des-cdc-999        .
      *              *-------------------------------------------------*
      *              * Codice mnemonico                                *
      *              *-------------------------------------------------*
      ...
      *              * Descrizione centro di costo                     *
      *              *-------------------------------------------------*
           perform   pmt-des-cdc-000      thru pmt-des-cdc-999        .
      *              *-------------------------------------------------*
      *              * Codice mnemonico                                *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione centro di costo      *
      *    *-----------------------------------------------------------*
       pmt-des-cdc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      07                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Descrizione del centro di  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione centro di costo  *
      *    *-----------------------------------------------------------*
       acc-des-cdc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-cdc (1)    =    spaces
                     go to acc-des-cdc-100.
       acc-des-cdc-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * l'ordinamento                               *
      *                  *---------------------------------------------*
           move      w-tes-des-cdc (1)    to   w-all-str-alf          .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione centro di c.  *
      *    *-----------------------------------------------------------*
       vis-des-cdc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       cnt-tdo-nok-120.
      *                  *---------------------------------------------*
      *                  * Controllo su descrizione centro di costo    *
      *                  *---------------------------------------------*
           if        w-tes-des-cdc (1)    not  = spaces
                     go to cnt-tdo-nok-500.
           move      "Manca la descrizione del centro di costo !      "
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           move      zero                 to   w-tes-cod-cdc          .
           move      spaces               to   w-tes-cod-cdc-aut      .
       nor-key-reg-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cdc        to   rf-cdc-cod-cdc         .
           move      "pgm/cdc/fls/ioc/obj/iofcdc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [cdc]                        *
      *                          *-------------------------------------*
           move      rf-cdc-ide-dat       to   w-tes-ide-dat (1)      .
           move      rf-cdc-ide-ute       to   w-tes-ide-ute (1)      .
           move      rf-cdc-ide-fas       to   w-tes-ide-fas (1)      .
           move      rf-cdc-des-cdc       to   w-tes-des-cdc (1)      .
           move      rf-cdc-des-key       to   w-tes-des-key (1)      .
           move      rf-cdc-cod-mne       to   w-tes-cod-mne (1)      .
           move      rf-cdc-tip-cdc       to   w-tes-tip-cdc (1)      .
           move      rf-cdc-alx-exp       to   w-tes-alx-exp (1)      .
       rou-let-reg-800.
      *                      *-----------------------------------------*
      ...
      *                      * Write record [cdc]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-cdc-000      thru wrt-rec-cdc-999        .
      ...
      *                      * Rewrite record [cdc]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-cdc-000      thru rew-rec-cdc-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [cdc]                             *
      *              *-------------------------------------------------*
           perform   del-rec-cdc-000      thru del-rec-cdc-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [cdc]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-cdc-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-cdc-ide-dat         .
           move      s-ute                to   rf-cdc-ide-ute         .
           move      s-fas                to   rf-cdc-ide-fas         .
           move      w-tes-cod-mne (1)    to   rf-cdc-cod-mne         .
           move      w-tes-des-key (1)    to   rf-cdc-des-key         .
           move      w-tes-des-cdc (1)    to   rf-cdc-des-cdc         .
           move      w-tes-tip-cdc (1)    to   rf-cdc-tip-cdc         .
           move      w-tes-alx-exp (1)    to   rf-cdc-alx-exp         .
       cmp-rec-cdc-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [cdc]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-cdc-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-cdc-000      thru cmp-rec-cdc-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [cdc]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "cdc "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           move      s-num                to   w-enc-cdc-val-pre      .
      *                  *---------------------------------------------*
      *                  * Incremento del valore                       *
      *                  *---------------------------------------------*
           move      w-enc-cdc-val-pre    to   w-enc-cdc-val-pos      .
           add       1                    to   w-enc-cdc-val-pos      .
       att-cod-aut-500.
      *                  *---------------------------------------------*
      *                  * Se l'incremento porta a zero si forza il    *
      *                  * valore a 1                                  *
      *                  *---------------------------------------------*
           if        w-enc-cdc-val-pos    =    zero
                     move  1              to   w-enc-cdc-val-pos      .
      *                  *---------------------------------------------*
      *                  * Se raggiunto il massimo valore impostabile  *
      *                  * si ricicla da 1                             *
      *                  *---------------------------------------------*
           if        w-enc-cdc-val-pos    >    w-enc-cdc-val-max
                     move  1              to   w-enc-cdc-val-pos      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCDC    "         to   f-key                  .
           move      w-enc-cdc-val-pos    to   rf-cdc-cod-cdc         .
           move      "pgm/cdc/fls/ioc/obj/iofcdc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      "Eu"                 to   s-ope                  .
           move      "cdc "               to   s-nam                  .
           move      w-enc-cdc-val-pos    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "Eu"                 to   s-ope                  .
           move      "cdc "               to   s-nam                  .
           move      w-enc-cdc-val-pre    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                      *-----------------------------------------*
      *                      * Se errori ripete l'intera operazione di *
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione del codice centro di costo *
      *    *-----------------------------------------------------------*
           copy      "pgm/cdc/prg/cpy/acmncdc0.acs"                   .
