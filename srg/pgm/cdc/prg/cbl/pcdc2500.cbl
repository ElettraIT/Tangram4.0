      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione legame tra Sottoconti e Centri di  *
      *                    Costo                                       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "LEGAME TRA SOTTOCONTI E CENTRI DI COSTO "       .
      ...
      *        *-------------------------------------------------------*
           05  w-rig-val-aep     occurs 2.
               ...
               10  w-rig-cod-cdc          pic  9(07)                  .
               10  w-rig-cod-cdc-des      pic  x(40)                  .
               10  w-rig-snx-ccs          pic  x(01)                  .
               10  w-rig-per-ccs          pic  9(03)v9(02) comp-3     .
               10  w-rig-com-ccs          pic  x(40)                  .
               10  w-rig-alx-exp.
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-des-cdc  pic  x(40)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-per-ccs  pic  x(05)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-com-ccs  pic  x(17)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Si/no pertinenza                           *
      *        *-------------------------------------------------------*
           05  w-exp-snx-ccs.
               10  w-exp-snx-ccs-num      pic  9(02)       value 02   .
               10  w-exp-snx-ccs-lun      pic  9(02)       value 02   .
               10  w-exp-snx-ccs-tbl.
      ...
      *    *-----------------------------------------------------------*
       cnc-sub-cat-000.
           cancel    "pgm/cdc/prg/obj/pcdc2502"                       .
       cnc-sub-cat-999.
           exit.
      ...
      *                  * Si/no pertinenza                            *
      *                  *---------------------------------------------*
           perform   acc-snx-ccs-000      thru acc-snx-ccs-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * % pertinenza                                *
      *                  *---------------------------------------------*
           perform   acc-per-ccs-000      thru acc-per-ccs-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Note                                        *
      *                  *---------------------------------------------*
           perform   acc-com-ccs-000      thru acc-com-ccs-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                      *-----------------------------------------*
      *                      * Decrizione Centro di Costo              *
      *                      *-----------------------------------------*
           move      w-rig-cod-cdc-des (1)
                                          to   w-lin-imm-des-cdc      .
      *                      *-----------------------------------------*
      *                      * Editing % di pertinenza                 *
      *                      *-----------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      03                   to   v-car                  .
           ...
           move      spaces               to   v-sgn                  .
           move      "B"                  to   v-edm                  .
           move      w-rig-per-ccs (1)    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-per-ccs      .
      *                      *-----------------------------------------*
      *                      * Note                                    *
      *                      *-----------------------------------------*
           move      w-rig-com-ccs (1)    to   w-lin-imm-com-ccs      .
      *
           if        w-rig-snx-ccs (1)    =    "N"
                     move  "(Non pertinente)"
                                          to   w-lin-imm-com-ccs      .
       vis-lin-cor-800.
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "N.R.         Codice e descrizione Centro di Costo 
      -              "        %          Note       "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
           ...
           perform   vis-cod-cdc-des-000  thru vis-cod-cdc-des-999    .
      *              *-------------------------------------------------*
      *              * Si/no pertinenza                                *
      *              *-------------------------------------------------*
           perform   vis-snx-ccs-000      thru vis-snx-ccs-999        .
      *              *-------------------------------------------------*
      *              * % pertinenza                                    *
      *              *-------------------------------------------------*
           perform   vis-per-ccs-000      thru vis-per-ccs-999        .
      *              *-------------------------------------------------*
      *              * Note                                            *
      *              *-------------------------------------------------*
           perform   vis-com-ccs-000      thru vis-com-ccs-999        .
       vis-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione I campo riga corpo : Codice Centro di Costo  *
      *    *-----------------------------------------------------------*
       acc-cod-cdc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-cdc (1)    to   w-sav-cod-cdc          .
       acc-cod-cdc-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-sav-cod-cdc        to   w-rig-cod-cdc (1)      .
      *                  *---------------------------------------------*
      *                  * Parametri generici                          *
      *                  *---------------------------------------------*
           move      "AC"                 to   w-cod-mne-cdc-ope      .
           move      w-rig-cod-cdc (1)    to   w-cod-mne-cdc-cod      .
           move      19                   to   w-cod-mne-cdc-lin      .
           move      23                   to   w-cod-mne-cdc-pos      .
           move      19                   to   w-cod-mne-cdc-dln      .
           move      41                   to   w-cod-mne-cdc-dps      .
           move      "<B"                 to   v-edm                  .
      *                  *---------------------------------------------*
      *                  * Tasti funzione                              *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces
                     go to acc-cod-cdc-400.
       acc-cod-cdc-250.
      *              *-------------------------------------------------*
      *              * Se Slct                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "SLCT"
                     go to acc-cod-cdc-300
           else      go to acc-cod-cdc-350.
       acc-cod-cdc-300.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-cod-cdc-310.
           ...
           if        w-cnt-wrk-ctr-001   =    zero
                     go to acc-cod-cdc-320.
           if        w-cnt-slc-rap-chr
                    (w-cnt-wrk-ctr-001)   <    "0"   or
                     w-cnt-slc-rap-chr
                    (w-cnt-wrk-ctr-001)   >    "9"
                     go to acc-cod-cdc-310.
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-cdc-flg    =    spaces
                     go to acc-cod-cdc-450.
           go to     acc-cod-cdc-100.
       acc-cod-cdc-450.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice Centro di Costo            *
      *    *-----------------------------------------------------------*
       vis-cod-cdc-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no pertinenza                     *
      *    *-----------------------------------------------------------*
       acc-snx-ccs-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-ccs-lun    to   v-car                  .
           move      w-exp-snx-ccs-num    to   v-ldt                  .
           move      "SN#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-snx-ccs-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      20                   to   v-lin                  .
           move      23                   to   v-pos                  .
      *
           if        w-rig-snx-ccs (1)    =    "S"
                     move  01             to   v-num
           else if   w-rig-snx-ccs (1)    =    "N"
                     move  02             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-snx-ccs-999.
       acc-snx-ccs-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "S"            to   w-rig-snx-ccs (1)
           else if   v-num                =    02
                     move  "N"            to   w-rig-snx-ccs (1)
           else      move  spaces         to   w-rig-snx-ccs (1)      .
       acc-snx-ccs-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se normalizzazione campi successivi    *
      *                  *---------------------------------------------*
           if        w-rig-snx-ccs (1)    =    "S"
                     go to acc-snx-ccs-800.
      *                  *---------------------------------------------*
      *                  * Normalizzazione campi successivi            *
      *                  *---------------------------------------------*
           move      zero                 to   w-rig-per-ccs (1)      .
           move      spaces               to   w-rig-com-ccs (1)      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione campi successivi            *
      *                  *---------------------------------------------*
           perform   vis-per-ccs-000      thru vis-per-ccs-999        .
           perform   vis-com-ccs-000      thru vis-com-ccs-999        .
       acc-snx-ccs-800.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-rig-flg
                             ...
                             go to acc-snx-ccs-100.
       acc-snx-ccs-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Si/no pertinenza                  *
      *    *-----------------------------------------------------------*
       vis-snx-ccs-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : % di pertinenza                      *
      *    *-----------------------------------------------------------*
       acc-per-ccs-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-rig-flg
                             ...
                             go to acc-per-ccs-100.
       acc-per-ccs-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : % di pertinenza                   *
      *    *-----------------------------------------------------------*
       vis-per-ccs-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-200.
      *              *-------------------------------------------------*
      *              * Routine di controllo che lo stesso Centro di    *
      *              * Costo non compaia piu' di una volta             *
      *              *-------------------------------------------------*
           move      w-rig-cod-cdc (1)    to   w-ctl-cod-dop-cod      .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      spaces               to   w-rig-snx-ccs (1)      .
           move      zero                 to   w-rig-per-ccs (1)      .
           move      spaces               to   w-rig-com-ccs (1)      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Precablaggio delle righe con i Centri di    *
      *                  * Costo                                       *
      *                  *---------------------------------------------*
           perform   car-fil-def-000      thru car-fil-def-999        .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Esecuzione caricamento file relative di appoggio con      *
      *    * default                                                   *
      *    *-----------------------------------------------------------*
       car-fil-def-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-cix-ctr-prg        to   w-rig-num-prg (1)      .
           move      rf-cdc-cod-cdc       to   w-rig-cod-cdc (1)      .
           move      spaces               to   rf-ccs                 .
           move      "S"                  to   w-rig-snx-ccs (1)      .
           move      zero                 to   w-rig-per-ccs (1)      .
           move      spaces               to   w-rig-com-ccs (1)      .
           move      rf-cdc-des-cdc       to   w-rig-cod-cdc-des (1)  .
       car-fil-def-600.
       car-fil-def-700.
      *                  *---------------------------------------------*
      *                  * Valori precedenti                           *
      ...
      *                  *---------------------------------------------*
       ...
       car-fil-def-800.
      *                  *---------------------------------------------*
      *                  * Riciclo a lettura record [cdc]              *
      *                  *---------------------------------------------*
           go to     car-fil-def-200.
       car-fil-def-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     car-fil-def-999.
       car-fil-def-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-tes-cod-pdc        to   rf-ccs-cod-pdc         .
      ...
      *              *-------------------------------------------------*
           if        rf-ccs-cod-pdc       not  = w-tes-cod-pdc
                     go to stp-srt-inp-999.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [ccs]                      *
      *              *-------------------------------------------------*
       stp-srt-inp-600.
      *              *-------------------------------------------------*
      *              * Aggiornamento progressivo righe                 *
      ...
      *                      *-----------------------------------------*
           move      rf-ccs-num-prg       to   srt-key-prg            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Codice Centro di Costo                  *
      *                      *-----------------------------------------*
           move      rf-ccs-cod-cdc       to   srt-cod-cdc            .
      *                      *-----------------------------------------*
      *                      * Progressivo righe nuovo                 *
      *                      *-----------------------------------------*
      ...
      *                      * Progressivo righe precedente            *
      *                      *-----------------------------------------*
           move      rf-ccs-num-prg       to   srt-old-prg            .
      *                      *-----------------------------------------*
      *                      * Intero record                           *
      *                      *-----------------------------------------*
           move      rf-ccs               to   srt-rec-ccs            .
       stp-srt-inp-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-cod-cdc          to   w-rig-cod-cdc (1)      .
           move      srt-rec-ccs          to   rf-ccs                 .
           move      rf-ccs-snx-ccs       to   w-rig-snx-ccs (1)      .
           move      rf-ccs-per-ccs       to   w-rig-per-ccs (1)      .
           move      rf-ccs-com-ccs       to   w-rig-com-ccs (1)      .
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-all-str-alf        to   w-rig-cod-cdc-des (1)  .
      *
      ...
      *              * Delete [ccs]                                    *
      *              *-------------------------------------------------*
           perform   del-rec-ccs-000      thru del-rec-ccs-999        .
      *              *-------------------------------------------------*
      ...
      *                      * Write record [ccs]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-ccs-000      thru wrt-rec-ccs-999        .
      *                      *-----------------------------------------*
      ...
      *                      * Rewrite record [ccs]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-ccs-000      thru rew-rec-ccs-999        .
       scr-mov-fil-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-pdc        to   rf-ccs-cod-pdc         .
           move      w-rig-cod-cdc (1)    to   rf-ccs-cod-cdc         .
           move      w-cix-ctr-prg        to   rf-ccs-num-prg         .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
           move      "IG"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-ccs-ide-dat         .
           move      s-ute                to   rf-ccs-ide-ute         .
           move      s-fas                to   rf-ccs-ide-fas         .
           move      w-rig-snx-ccs (1)    to   rf-ccs-snx-ccs         .
           move      w-rig-per-ccs (1)    to   rf-ccs-per-ccs         .
           move      w-rig-com-ccs (1)    to   rf-ccs-com-ccs         .
           move      spaces               to   rf-ccs-alx-exp         .
       cmp-rec-ccs-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record righe [ccs]                              *
      *    *-----------------------------------------------------------*
       wrt-rec-ccs-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-ccs-000      thru cmp-rec-ccs-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Cancellazione record righe [ccs]                          *
      *    *-----------------------------------------------------------*
       del-rec-ccs-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-tes-cod-pdc        to   rf-ccs-cod-pdc         .
           move      w-rig-cod-cdc (2)    to   rf-ccs-cod-cdc         .
           move      w-rig-num-prg (2)    to   rf-ccs-num-prg         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           if        w-ctl-cod-dop-cod    =    w-rig-cod-cdc (1)
