      ...
      *    *===========================================================*
      *    * Record logico file [ram]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/rda/fls/rec/rfram"                          .

      ******************************************************************
       Procedure Division                using f rf-ram               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-ram                 .
           move      zero                 to   rf-ram-ide-dat         .
           move      spaces               to   rf-ram-ide-ute         .
           move      spaces               to   rf-ram-ide-fas         .
           move      zero                 to   rf-ram-num-prt         .
           move      zero                 to   rf-ram-dat-reg         .
           move      spaces               to   rf-ram-cod-tmo         .
           move      zero                 to   rf-ram-dat-doc         .
           move      spaces               to   rf-ram-num-doc         .
           move      zero                 to   rf-ram-cod-fnt         .
           move      spaces               to   rf-ram-dpz-fnt         .
           move      zero                 to   rf-ram-snx-prf         .
           move      zero                 to   rf-ram-snx-tpv         .
           move      zero                 to   rf-ram-cod-cau         .
           move      zero                 to   rf-ram-per-cau         .
           move      zero                 to   rf-ram-pim-cau         .
           move      zero                 to   rf-ram-cod-tcb         .
           move      zero                 to   rf-ram-per-tcb         .
           move      zero                 to   rf-ram-pim-tcb         .
           move      zero                 to   rf-ram-cod-trb         .
           move      zero                 to   rf-ram-per-trb         .
           move      zero                 to   rf-ram-pim-trb         .
           move      zero                 to   rf-ram-tot-ibl         .
           move      zero                 to   rf-ram-tot-irt         .
           move      zero                 to   rf-ram-tot-rmb         .
           move      zero                 to   rf-ram-tot-pvn         .
           move      zero                 to   rf-ram-dat-pag         .
           move      zero                 to   rf-ram-dat-vrs         .
           move      zero                 to   rf-ram-tip-vrs         .
           move      spaces               to   rf-ram-num-vrs         .
           move      spaces               to   rf-ram-ann-mov         .
           move      spaces               to   rf-ram-flg-ela         .
           move      spaces               to   rf-ram-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-ram-ide-ute       to   fil-ide-ute            .
           move      rf-ram-ide-fas       to   fil-ide-fas            .
           move      rf-ram-dpz-fnt       to   fil-dpz-fnt            .
           move      rf-ram-snx-prf       to   fil-snx-prf            .
           move      rf-ram-snx-tpv       to   fil-snx-tpv            .
           move      rf-ram-cod-cau       to   fil-cod-cau            .
           move      rf-ram-per-cau       to   fil-per-cau            .
           move      rf-ram-pim-cau       to   fil-pim-cau            .
           move      rf-ram-cod-tcb       to   fil-cod-tcb            .
           move      rf-ram-per-tcb       to   fil-per-tcb            .
           move      rf-ram-pim-tcb       to   fil-pim-tcb            .
           move      rf-ram-cod-trb       to   fil-cod-trb            .
           move      rf-ram-per-trb       to   fil-per-trb            .
           move      rf-ram-pim-trb       to   fil-pim-trb            .
           move      rf-ram-tot-ibl       to   fil-tot-ibl            .
           move      rf-ram-tot-irt       to   fil-tot-irt            .
           move      rf-ram-tot-rmb       to   fil-tot-rmb            .
           move      rf-ram-tot-pvn       to   fil-tot-pvn            .
           move      rf-ram-dat-vrs       to   fil-dat-vrs            .
           move      rf-ram-tip-vrs       to   fil-tip-vrs            .
           move      rf-ram-num-vrs       to   fil-num-vrs            .
           move      rf-ram-ann-mov       to   fil-ann-mov            .
           move      rf-ram-flg-ela       to   fil-flg-ela            .
           move      rf-ram-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-ram-num-prt       to   fil-num-prt            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-ram-ide-dat       to   fil-ide-dat            .
           move      rf-ram-dat-reg       to   fil-dat-reg            .
           move      rf-ram-num-prt       to   fil-num-prt-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-ram-dat-doc       to   fil-dat-doc            .
           move      rf-ram-num-doc       to   fil-num-doc            .
           move      rf-ram-cod-tmo       to   fil-cod-tmo            .
           move      rf-ram-num-prt       to   fil-num-prt-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-ram-cod-fnt       to   fil-cod-fnt            .
           move      rf-ram-dat-doc       to   fil-dat-doc-4          .
           move      rf-ram-cod-tmo       to   fil-cod-tmo-4          .
           move      rf-ram-num-prt       to   fil-num-prt-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-ram-cod-fnt       to   fil-cod-fnt-5          .
           move      rf-ram-dat-pag       to   fil-dat-pag            .
           move      rf-ram-dat-doc       to   fil-dat-doc-5          .
           move      rf-ram-cod-tmo       to   fil-cod-tmo-5          .
           move      rf-ram-num-prt       to   fil-num-prt-5          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-ram                 .
           move      fil-ide-dat          to   rf-ram-ide-dat         .
           move      fil-ide-ute          to   rf-ram-ide-ute         .
           move      fil-ide-fas          to   rf-ram-ide-fas         .
           move      fil-num-prt          to   rf-ram-num-prt         .
           move      fil-dat-reg          to   rf-ram-dat-reg         .
           move      fil-cod-tmo          to   rf-ram-cod-tmo         .
           move      fil-dat-doc          to   rf-ram-dat-doc         .
           move      fil-num-doc          to   rf-ram-num-doc         .
           move      fil-cod-fnt          to   rf-ram-cod-fnt         .
           move      fil-dpz-fnt          to   rf-ram-dpz-fnt         .
           move      fil-snx-prf          to   rf-ram-snx-prf         .
           move      fil-snx-tpv          to   rf-ram-snx-tpv         .
           move      fil-cod-cau          to   rf-ram-cod-cau         .
           move      fil-per-cau          to   rf-ram-per-cau         .
           move      fil-pim-cau          to   rf-ram-pim-cau         .
           move      fil-cod-tcb          to   rf-ram-cod-tcb         .
           move      fil-per-tcb          to   rf-ram-per-tcb         .
           move      fil-pim-tcb          to   rf-ram-pim-tcb         .
           move      fil-cod-trb          to   rf-ram-cod-trb         .
           move      fil-per-trb          to   rf-ram-per-trb         .
           move      fil-pim-trb          to   rf-ram-pim-trb         .
           move      fil-tot-ibl          to   rf-ram-tot-ibl         .
           move      fil-tot-irt          to   rf-ram-tot-irt         .
           move      fil-tot-rmb          to   rf-ram-tot-rmb         .
           move      fil-tot-pvn          to   rf-ram-tot-pvn         .
           move      fil-dat-pag          to   rf-ram-dat-pag         .
           move      fil-dat-vrs          to   rf-ram-dat-vrs         .
           move      fil-tip-vrs          to   rf-ram-tip-vrs         .
           move      fil-num-vrs          to   rf-ram-num-vrs         .
           move      fil-ann-mov          to   rf-ram-ann-mov         .
           move      fil-flg-ela          to   rf-ram-flg-ela         .
           move      fil-alx-exp          to   rf-ram-alx-exp         .
       dec-fis-log-999.
           exit.
