      ...
      *                                   Fase:    rda302              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 16/01/94    *
      *                       Ultima revisione:    NdK del 24/07/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma prda3021:        *
      *                                                                *
      *                    Stampa di controllo movimenti registrati    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " STAMPA DI CONTROLLO MOVIMENTI RITENUTA "       .
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Controllo su data min                           *
      *              *-------------------------------------------------*
           if        rr-dat-min           not  = zero
                     go to tdo-ric-sel-200.
           move      "ME"                 to   v-ope                  .
           move      "La data minima non puo' mancare !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo su data max                           *
      *              *-------------------------------------------------*
           if        rr-dat-max           not  = zero
                     go to tdo-ric-sel-300.
           move      "ME"                 to   v-ope                  .
           move      "La data massima non puo' mancare !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
       ...
       tdo-ric-sel-300.
      *              *-------------------------------------------------*
      *              * Controllo su data min - max                     *
      *              *-------------------------------------------------*
           if        rr-dat-max           not  < rr-dat-min
                     go to tdo-ric-sel-999.
           move      "ME"                 to   v-ope                  .
           move      "La data massima minore della minima !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
