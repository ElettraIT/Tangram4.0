      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma rda302   *
      *                                                                *
      ...
      *                          *-------------------------------------*
           ...
           move      rf-ram-cod-fnt       to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      046                  to   p-pos                  .
           move      w-rot-l01-cod-fnt    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
...
______*    add       w-tot-fnt-wib        to   w-tot-fnt-amc          .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-int-pag-sta-dmi      .
      *                  *---------------------------------------------*
      *                  * Editing della data massima                  *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "D"                  to   p-tip                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-int-pag-sta-dma      .
      *                  *---------------------------------------------*
      *                  * Preparazione titolo                         *
      *                  *---------------------------------------------*
           move      spaces               to   w-cnt-tit-des-tit      .
           string    "DOCUMENTI CON DATA DAL "
                                delimited by size
                     w-int-pag-sta-dmi
                                delimited by spaces
