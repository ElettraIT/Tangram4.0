      ...
      *                                   Fase:    rda900              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 25/03/03    *
      *                       Ultima revisione:    NdK del 18/07/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Pulizia movimenti ritenuta d'acconto        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "PULIZIA REGISTRAZIONI RITENUTA D'ACCONTO"       .
      ...
      *    *-----------------------------------------------------------*
       pmt-dat-pul-000.
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Pulizia registrazioni con data documento fino al .
      -              ".................:"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      23                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "[PF4] - Per interrompere l'esecuzione             
      -              "                              "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Start su archivio [ram]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
      ...
      *                  *---------------------------------------------*
       ...
       pul-let-seq-200.
      *              *-------------------------------------------------*
      *              * Incremento contatore records [ram] letti        *
      *              *-------------------------------------------------*
      ...
      *              * per le pulizie, il record e' sicuramente da     *
      *              * riportare                                       *
      *              *-------------------------------------------------*
           if        rf-ram-dat-doc       >    rr-dat-pul
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [ram] scritti  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "#"                  to   w-cnt-pul-flg-sub      .
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [ram] elimina- *
      *                  * ti                                          *
      *                  *---------------------------------------------*
