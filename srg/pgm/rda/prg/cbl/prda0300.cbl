      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella causali ritenuta d'acconto *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   TABELLA CAUSALI RITENUTA D'ACCONTO   "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cau        to   w-cod-mne-zcr-cod      .
           move      04                   to   w-cod-mne-zcr-lin      .
           move      30                   to   w-cod-mne-zcr-pos      .
           move      07                   to   w-cod-mne-zcr-dln      .
           move      30                   to   w-cod-mne-zcr-dps      .
           move      "<B"                 to   v-edm                  .
      ...
      *                  * % ritenuta                                  *
      *                  *---------------------------------------------*
           perform   acc-per-cau-000      thru acc-per-cau-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * % ritenuta                                      *
      *              *-------------------------------------------------*
           perform   vis-per-cau-000      thru vis-per-cau-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     vis-tes-reg-999.
      ...
      *              * % ritenuta                                      *
      *              *-------------------------------------------------*
           perform   pmt-per-cau-000      thru pmt-per-cau-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     pmt-tes-reg-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      "Manca la descrizione della causale         !    "
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cau        to   rf-zcr-cod-cau         .
           move      "pgm/rda/fls/ioc/obj/iofzcr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zcr]                        *
      *                          *-------------------------------------*
           move      rf-zcr-ide-dat       to   w-tes-ide-dat (1)      .
           move      rf-zcr-ide-ute       to   w-tes-ide-ute (1)      .
           move      rf-zcr-ide-fas       to   w-tes-ide-fas (1)      .
           move      rf-zcr-des-cau       to   w-tes-des-cau (1)      .
           move      rf-zcr-des-key       to   w-tes-des-key (1)      .
           move      rf-zcr-cod-mne       to   w-tes-cod-mne (1)      .
           move      rf-zcr-per-cau       to   w-tes-per-cau (1)      .
           move      rf-zcr-pim-cau       to   w-tes-pim-cau (1)      .
           move      rf-zcr-alx-exp       to   w-tes-alx-exp (1)      .
       rou-let-reg-800.
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zcr]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zcr-000      thru wrt-rec-zcr-999        .
      ...
      *                      * Rewrite record [zcr]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zcr-000      thru rew-rec-zcr-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zcr]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zcr-000      thru del-rec-zcr-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zcr]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zcr-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-zcr-ide-dat         .
           move      s-ute                to   rf-zcr-ide-ute         .
           move      s-fas                to   rf-zcr-ide-fas         .
           move      w-tes-cod-mne (1)    to   rf-zcr-cod-mne         .
           move      w-tes-des-key (1)    to   rf-zcr-des-key         .
           move      w-tes-des-cau (1)    to   rf-zcr-des-cau         .
           move      w-tes-per-cau (1)    to   rf-zcr-per-cau         .
           move      w-tes-pim-cau (1)    to   rf-zcr-pim-cau         .
           move      w-tes-alx-exp (1)    to   rf-zcr-alx-exp         .
       cmp-rec-zcr-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zcr]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zcr-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zcr-000      thru cmp-rec-zcr-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
