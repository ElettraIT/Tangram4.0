      ...
      ******************************************************************
       Procedure Division                using f rf-cli               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           ...
           move      zero                 to   rf-cli-ide-dat         .
           move      spaces               to   rf-cli-ide-ute         .
           move      spaces               to   rf-cli-ide-fas         .
           ...
           move      spaces               to   rf-cli-cod-naz         .
           move      zero                 to   rf-cli-cod-cmn         .
           move      zero                 to   rf-cli-cod-fzn         .
           move      zero                 to   rf-cli-cod-lct         .
           move      spaces               to   rf-cli-num-tel         .
           move      spaces               to   rf-cli-num-fax         .
           move      spaces               to   rf-cli-num-tlx         .
           move      spaces               to   rf-cli-nom-int         .
           move      zero                 to   rf-cli-cod-iva         .
           move      zero                 to   rf-cli-prt-iva         .
           move      spaces               to   rf-cli-cod-fis         .
           move      spaces               to   rf-cli-snx-a13         .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-cli-ide-ute       to   fil-ide-ute            .
           move      rf-cli-ide-fas       to   fil-ide-fas            .
           move      rf-cli-rag-soc       to   fil-rag-soc            .
           move      rf-cli-via-cli       to   fil-via-cli            .
           move      rf-cli-loc-cli       to   fil-loc-cli            .
           move      rf-cli-cod-naz       to   fil-cod-naz            .
           move      rf-cli-cod-cmn       to   fil-cod-cmn            .
           move      rf-cli-cod-fzn       to   fil-cod-fzn            .
           move      rf-cli-cod-lct       to   fil-cod-lct            .
           move      rf-cli-num-tel       to   fil-num-tel            .
           move      rf-cli-num-fax       to   fil-num-fax            .
           move      rf-cli-num-tlx       to   fil-num-tlx            .
           move      rf-cli-nom-int       to   fil-nom-int            .
           move      rf-cli-cod-iva       to   fil-cod-iva            .
           move      rf-cli-snx-a13       to   fil-snx-a13            .
           move      rf-cli-cod-cge       to   fil-cod-cge            .
           move      rf-cli-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cli-cod-cli       to   fil-cod-cli            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cli-ide-dat       to   fil-ide-dat            .
           move      rf-cli-cod-cli       to   fil-cod-cli-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cli-rag-key       to   fil-rag-key            .
           move      rf-cli-cod-cli       to   fil-cod-cli-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cli-cod-mne       to   fil-cod-mne            .
           move      rf-cli-cod-cli       to   fil-cod-cli-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cli-prt-iva       to   fil-prt-iva            .
           move      rf-cli-cod-cli       to   fil-cod-cli-5          .
           go to     cmp-key-fis-999.
       cmp-key-fis-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cli-cod-fis       to   fil-cod-fis            .
           move      rf-cli-cod-cli       to   fil-cod-cli-6          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-cli                 .
           move      fil-ide-dat          to   rf-cli-ide-dat         .
           move      fil-ide-ute          to   rf-cli-ide-ute         .
           move      fil-ide-fas          to   rf-cli-ide-fas         .
           move      fil-cod-cli          to   rf-cli-cod-cli         .
           move      fil-cod-mne          to   rf-cli-cod-mne         .
           move      fil-rag-key          to   rf-cli-rag-key         .
           move      fil-rag-soc          to   rf-cli-rag-soc         .
           move      fil-via-cli          to   rf-cli-via-cli         .
           move      fil-loc-cli          to   rf-cli-loc-cli         .
           move      fil-cod-naz          to   rf-cli-cod-naz         .
           move      fil-cod-cmn          to   rf-cli-cod-cmn         .
           move      fil-cod-fzn          to   rf-cli-cod-fzn         .
           move      fil-cod-lct          to   rf-cli-cod-lct         .
           move      fil-num-tel          to   rf-cli-num-tel         .
           move      fil-num-fax          to   rf-cli-num-fax         .
           move      fil-num-tlx          to   rf-cli-num-tlx         .
           move      fil-nom-int          to   rf-cli-nom-int         .
           move      fil-cod-iva          to   rf-cli-cod-iva         .
           move      fil-prt-iva          to   rf-cli-prt-iva         .
           move      fil-cod-fis          to   rf-cli-cod-fis         .
           move      fil-snx-a13          to   rf-cli-snx-a13         .
           move      fil-cod-cge          to   rf-cli-cod-cge         .
           move      fil-alx-exp          to   rf-cli-alx-exp         .
       dec-fis-log-999.
           exit.
