      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su tabella classi cespiti    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CLASSI DI CESPITI O CATEGORIE DI BENI "       .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zc1]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/cge/fls/ioc/obj/iofzc1"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      10                   to   v-pos                  .
           move      rf-zc1-des-cla       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zc1-cod-cla       to   w-mpn-cod-cla          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-zc1-pdc-cla       to   w-edt-cod-pdc-cod      .
      ...
      *
           if        rf-zc1-per-amr       not  numeric
                     move  zero           to   v-num
           else      move  rf-zc1-per-amr to   v-num                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-cla'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
