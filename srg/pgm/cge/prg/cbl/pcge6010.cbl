      ...
      *                       Ultima revisione:    NdK del 02/11/03    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazioni movimenti gestione cespiti   *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase cge601, nella sua globalita', esegue i tipi di inter-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * CSPANA      Ricerca cespiti per dati anagrafici                *
      *                                                                *
      * CSPPDC      Ricerca cespiti per codice sottoconto              *
      *                                                                *
      * CSPFNT      Ricerca cespiti acquistati da un fornitore         *
      *                                                                *
      * CSPCLI      Ricerca cespiti venduti ad un cliente              *
      *                                                                *
      * CSPDAT      Ricerca cespiti per data movimenti                 *
      *                                                                *
      * REGCCF      Ricerca registrazioni contabili relative ad un     *
      *             fornitore                                          *
      *                                                                *
      * REGCCC      Ricerca registrazioni contabili relative ad un     *
      *             cliente                                            *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'cge601'           *
      *              *-------------------------------------------------*
           perform   fas-cge-601-000      thru fas-cge-601-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Ricerca cespiti per dati anagrafici               
      -              " CSPANA     pcge601a  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Ricerca cespiti per codice sottoconto             
      -              " CSPPDC     pcge601e  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Ricerca cespiti acquistati da un fornitore             
      -              " CSPFNT     pcge601b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Ricerca cespiti venduti ad un cliente                    
      -              " CSPCLI     pcge601c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Ricerca cespiti per data                          
      -              " CSPDAT     pcge601d  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-cge-601-300
           else if   v-key                =    "PRSC"
                     go to fas-cge-601-400
           else if   v-key                =    "NXSC"
                     go to fas-cge-601-450
           else if   v-key                =    "DOWN"
                     go to fas-cge-601-500
           else if   v-key                =    "EXIT"
                     go to fas-cge-601-250
           else      go to fas-cge-601-200.
       fas-cge-601-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-cge-601-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-cge-601-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-cge-601-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-cge-601-350
           else      go to fas-cge-601-322.
       fas-cge-601-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-cge-601-630
           else if   v-key                =    "PRSC"
                     go to fas-cge-601-600
           else if   v-key                =    "NXSC"
                     go to fas-cge-601-610
           else if   v-key                =    "UP  "
                     go to fas-cge-601-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-cge-601-650
           else if   v-key                =    "EXIT"
                     go to fas-cge-601-660
           else      go to fas-cge-601-570.
       fas-cge-601-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-cge-601-626
           else      go to fas-cge-601-628.
       fas-cge-601-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-cge-601-636
           else      go to fas-cge-601-638.
       fas-cge-601-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-cge-601-725
           else      go to fas-cge-601-750.
       fas-cge-601-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
