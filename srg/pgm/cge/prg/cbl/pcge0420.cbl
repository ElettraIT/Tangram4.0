      ...
      *                       Ultima revisione:    NdK del 21/05/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge0421:        *
      *                                                                *
      *                    Stampa titoli di esenzione iva              *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Prompt 'Selezione su archivio titoli di e-  *
      *                  * senzione:'                                  *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      07                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su archivio titoli di esenzione:"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      13                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Legenda codici : da   1 a  99 - % imponibili"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      14                   to   v-lin                  .
           move      18                   to   v-pos                  .
           move      "da 301 a 399 - Non imponibili"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      17                   to   v-lin                  .
           move      18                   to   v-pos                  .
           move      "da 601 a 698 - Fuori campo iva"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-fnd-cod-iva-cod    to   rr-cod-min             .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice min                        *
      *    *-----------------------------------------------------------*
       vis-cod-min-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-fnd-cod-iva-cod    to   rr-cod-max             .
      *                  *---------------------------------------------*
      *                  * Visualizza codice selezionato               *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-cod-max           not  = zero
                     if     rr-cod-max    not  > 300 or
                            rr-cod-max    not  < 700
                            go to acc-cod-max-100.
      *
           if        rr-cod-max           not  = zero and
                     rr-cod-max           <    rr-cod-min
                     go to acc-cod-max-100.
       acc-cod-max-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice max                        *
      *    *-----------------------------------------------------------*
       vis-cod-max-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
