      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella natura operzione Iva       *
      *                                                                *
      *                    ___ DA SOSTITUIRE CON 'scf080' ___          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " TABELLA CODICI NATURA DELL'OPERAZIONE  "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-nop          pic  x(80)                  .
               10  w-tes-des-key          pic  x(80)                  .
               10  w-tes-com-nop          pic  x(80)                  .
               10  w-tes-alx-exp.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice natura operazione      *
      *    *-----------------------------------------------------------*
       pmt-cod-nop-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice natura operazione      *
      *    *-----------------------------------------------------------*
       acc-cod-nop-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-nop        to   w-cod-des-zno-cod      .
           move      04                   to   w-cod-des-zno-lin      .
           move      30                   to   w-cod-des-zno-pos      .
           move      07                   to   w-cod-des-zno-dln      .
           move      30                   to   w-cod-des-zno-dps      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice natura operazione   *
      *    *-----------------------------------------------------------*
       vis-cod-nop-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  * Descrizione                                 *
      *                  *---------------------------------------------*
           perform   acc-des-nop-000      thru acc-des-nop-999        .
           if        v-key                =    "NXSC"
      ...
      *                  * Commento                                    *
      *                  *---------------------------------------------*
           perform   acc-com-nop-000      thru acc-com-nop-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Descrizione                                     *
      *              *-------------------------------------------------*
           perform   vis-des-nop-000      thru vis-des-nop-999        .
      *              *-------------------------------------------------*
      *              * Commento                                        *
      *              *-------------------------------------------------*
           perform   vis-com-nop-000      thru vis-com-nop-999        .
           go to     vis-tes-reg-999.
       vis-tes-reg-999.
           exit.
      ...
      *              * Descrizione                                     *
      *              *-------------------------------------------------*
           perform   pmt-des-nop-000      thru pmt-des-nop-999        .
      *              *-------------------------------------------------*
      *              * Commento                                        *
      *              *-------------------------------------------------*
           perform   pmt-com-nop-000      thru pmt-com-nop-999        .
           go to     pmt-tes-reg-999.
       pmt-tes-reg-999.
           exit.
      ...
      *                  * l'ordinamento                               *
      *                  *---------------------------------------------*
           move      w-tes-des-nop (1)    to   w-all-str-alf          .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-nop (1)      .
           move      spaces               to   w-tes-des-key (1)      .
           move      spaces               to   w-tes-com-nop (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-nop        to   rf-zno-cod-nop         .
           move      "pgm/cge/fls/ioc/obj/iofzno"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zno]                        *
      *                          *-------------------------------------*
           move      rf-zno-des-nop       to   w-tes-des-nop (1)      .
           move      rf-zno-des-key       to   w-tes-des-key (1)      .
           move      rf-zno-com-nop       to   w-tes-com-nop (1)      .
           move      rf-zno-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zno]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zno-000      thru wrt-rec-zno-999        .
      ...
      *                      * Rewrite record [zno]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zno-000      thru rew-rec-zno-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zno]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zno-000      thru del-rec-zno-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zno]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zno-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-nop (1)    to   rf-zno-des-nop         .
           move      w-tes-des-key (1)    to   rf-zno-des-key         .
           move      w-tes-com-nop (1)    to   rf-zno-com-nop         .
           move      w-tes-alx-exp (1)    to   rf-zno-alx-exp         .
       cmp-rec-zno-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zno]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zno-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zno-000      thru cmp-rec-zno-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
