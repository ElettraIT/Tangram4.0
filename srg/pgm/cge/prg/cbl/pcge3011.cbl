      ...
      *                    programma cge3010:                          *
      *                                                                *
      *                    Lista movimenti di contabilita' generale    *
      *                                                                *
      *================================================================*
...
______*    perform   dic-fin-pgm-000      thru dic-fin-pgm-999        .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Titolo : 'LISTA MOVIMENTI DI GENERALE'          *
      *              *-------------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      27                   to   v-car                  .
           move      v-lnr                to   v-lin                  .
           move      27                   to   v-pos                  .
           move      "LISTA MOVIMENTI DI GENERALE"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *                                                 *
      *              * Solo Dare / Avere Cliente                       *
      *              *-------------------------------------------------*
           if        rf-mgt-tip-iva       not  = "1"   and
                     rf-mgt-tip-iva       not  = "2"
                     go to dca-con-ael-cli-900.
      *              *-------------------------------------------------*
      ...
      *              * Test sul tipo di movimento Iva                  *
      *              *                                                 *
      *              * Solo Dare / Avere Fornitore                     *
      *              *-------------------------------------------------*
           if        rf-mgt-tip-iva       not  = "4"   and
                     rf-mgt-tip-iva       not  = "5"
                     go to dca-con-ael-fnt-900.
      *              *-------------------------------------------------*
      *              * Test se presenti altri elementi                 *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      w-dca-rig-cau (1)    to   w-all-str-cat (1)      .
           move      "-"                  to   w-all-str-cat (2)      .
           move      v-edt                to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
