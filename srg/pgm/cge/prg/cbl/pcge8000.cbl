      ...
      *                                   Fase:    cge800              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 20/01/10    *
      *                       Ultima revisione:    NdK del 22/11/21    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione ciclo di bilancio                  *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase cge800, nella sua globalita', esegue i tipi di manu-   *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * APEBIL      Apertura ciclo di bilancio                         *
      *                                                                *
      * STABIL      Stampa bilancio annuale                            *
      *                                                                *
      * STAMRB      Stampa dei soli movimenti di rettifica al bilancio *
      *                                                                *
      * GENMCH      Generazione automatica movimenti di chiusura       *
      *                                                                *
      * DICFPB      Dichiarazione di fine periodo bilanci              *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Link-area comune per programmi della serie pcge8000       *
      *    *-----------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'cge800'           *
      *              *-------------------------------------------------*
           perform   fas-cge-800-000      thru fas-cge-800-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Lettura delle personalizzazioni relative al mese di       *
      *    * chiusura bilancio                                         *
      *    *-----------------------------------------------------------*
       prs-mes-chi-000.
      *              *-------------------------------------------------*
      *              * Lettura personalizzazione mese di chiusura bi-  *
      *              * lancio                                          *
      *              *-------------------------------------------------*
           move      "P:"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
      *                   *--------------------------------------------*
      *                   * Apertura ciclo di bilancio                 *
      *                   *--------------------------------------------*
           move      "Apertura ciclo di bilancio                        
      -              " APEBIL     pcge800a  "
                                          to   w-tmn-ele-wci          .
      ...
      *                   *--------------------------------------------*
           move      "Stampa bilancio annuale                           
      -              " STABIL     pcge800b  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                   *--------------------------------------------*
      *                   * Stampa dei soli movimenti di rettifica     *
      *                   *--------------------------------------------*
           move      "Stampa dei soli movimenti di rettifica al bilancio
      -              " STAMRB     pcge800c  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                   *--------------------------------------------*
      *                   * Generazione automatica movimenti chiusura  *
      *                   *--------------------------------------------*
           move      "Generazione automatica movimenti di chiusura      
      -              " GENMCH     pcge800d  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *                   *--------------------------------------------*
      *                   * Dichiarazione di fine periodo bilanci      *
      *                   *--------------------------------------------*
           move      "Dichiarazione di fine periodo bilanci             
      -              " DICFPB     pcge800e  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      *              *-------------------------------------------------*
       ...
       fas-cge-800-200.
      *              *-------------------------------------------------*
      *              * Visualizzazione status ciclo di bilancio        *
      *              *-------------------------------------------------*
           perform   vis-sts-cdb-000      thru vis-sts-cdb-999        .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-cge-800-300
           else if   v-key                =    "PRSC"
                     go to fas-cge-800-400
           else if   v-key                =    "NXSC"
                     go to fas-cge-800-450
           else if   v-key                =    "DOWN"
                     go to fas-cge-800-500
           else if   v-key                =    "EXIT"
                     go to fas-cge-800-250
           else      go to fas-cge-800-200.
       fas-cge-800-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-man        =    zero
                     go to fas-cge-800-330.
           move      zero                 to   w-tmn-ele-inx          .
       fas-cge-800-322.
           add       1                    to   w-tmn-ele-inx          .
           if        w-tmn-ele-inx        >    w-tmn-ele-num
                     go to fas-cge-800-340.
           if        w-tmn-num-tmn
                    (w-tmn-ele-inx)       =    w-key-num-man
                     go to fas-cge-800-350
           else      go to fas-cge-800-322.
       fas-cge-800-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-cge-800-630
           else if   v-key                =    "PRSC"
                     go to fas-cge-800-600
           else if   v-key                =    "NXSC"
                     go to fas-cge-800-610
           else if   v-key                =    "UP  "
                     go to fas-cge-800-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-cge-800-650
           else if   v-key                =    "EXIT"
                     go to fas-cge-800-660
           else      go to fas-cge-800-570.
       fas-cge-800-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-cge-800-626
           else      go to fas-cge-800-628.
       fas-cge-800-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-cge-800-636
           else      go to fas-cge-800-638.
       fas-cge-800-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-cge-800-725
           else      go to fas-cge-800-750.
       fas-cge-800-725.
      *              *-------------------------------------------------*
      ...
      *
           if        rn-dat-bil-flg-bil   =    spaces
                     move  "Ciclo chiuso - esercizio :"
                                          to   w-all-str-cat (1)
           else if   rn-dat-bil-flg-bil   =    "#"
                     move  "In progresso - esercizio :"
                                          to   w-all-str-cat (1)
           else if   rn-dat-bil-flg-bil   =    "G"
                     move  "Aperto, generati movimenti :"
                                          to   w-all-str-cat (1)      .
      *
           move      "-> [Apertura:"      to   w-all-str-cat (3)      .
           move      "- Chiusura:"        to   w-all-str-cat (5)      .
