      ...
      *                       Ultima revisione:    NdK del 11/02/16    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge7801:        *
      *                                                                *
      ...
      *                  *---------------------------------------------*
           move      w-ref-giv-ven-cod    to   rr-num-cod             .
           move      w-ref-giv-ven-des    to   rr-num-des             .
       pre-exe-pgm-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rn-giv-ven-dat-stp   to   w-wrk-ult-dat          .
           move      rn-giv-ven-ult-num   to   w-wrk-ult-num          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-prs-mul-giv-snx    not  = "S"  or
                     w-prs-mul-giv-max    not  >    zero
      ...
      *              * Numero giornale iva vendite                     *
      *              *-------------------------------------------------*
______*    perform   pmt-num-num-000      thru pmt-num-num-999        .
      *              *-------------------------------------------------*
      *              * Tipo stampa                                     *
      *              *-------------------------------------------------*
______*    perform   pmt-tip-stp-000      thru pmt-tip-stp-999        .
      *              *-------------------------------------------------*
      *              * Data inizio                                     *
      *              *-------------------------------------------------*
      ...
      *              * Stampa riepilogo finale                         *
      *              *-------------------------------------------------*
______*    perform   pmt-rie-fin-000      thru pmt-rie-fin-999        .
      *              *-------------------------------------------------*
      *              * Si/no carta vidimata                            *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Numero giornale iva vendite   *
      *    *-----------------------------------------------------------*
       pmt-num-num-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Numero giornale iva vendite   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-num-num-999.
      ...
      *    *-----------------------------------------------------------*
       pmt-dat-ini-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Dalla data lettera iniziale   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-dat-ini-999.
      ...
      *                  * per le vendite                              *
      *                  *---------------------------------------------*
           if        rr-num-num           >    w-prs-mul-giv-max
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-102.
           if        w-prs-mul-giv-max    not  < rr-num-num
                     go to tdo-ric-sel-150.
           move      "Numero giornale iva errato !                      
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
      ...
      *              * movimenti iva vendite,  stampato nell'ultima    *
