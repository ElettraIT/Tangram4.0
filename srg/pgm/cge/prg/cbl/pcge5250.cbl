      ...
      *                                   Fase:    cge525              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 05/05/11    *
      *                       Ultima revisione:    NdK del 15/02/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge5251:        *
      *                                                                *
      *                    Stampa partitari fornitori ad uso interno   *
      *                                                                *
      *                    ------------------------------------------- *
      *                                                                *
      *                    File di esportazione :                      *
      *                                                                *
      *                    /abd/asc/UTENTE/exp/AZI_cge525.csv          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA PARTITARI FORNITORI - USO INTERNO"       .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per : Si/no esportazione          *
      *    *-----------------------------------------------------------*
       pmt-snx-exp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per : Data per la stampa          *
      *    *-----------------------------------------------------------*
       pmt-dat-stp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data per la stampa                   *
      *    *-----------------------------------------------------------*
       acc-dat-stp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *
           move      "ME"                 to   v-ope                  .
           move      "La data massima non puo' essere inferiore
      -              " a quella minima !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
