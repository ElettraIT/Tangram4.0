      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge3101:        *
      *                                                                *
      *                    Stampa giornale di contabilita'             *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-prs.
      *        *-------------------------------------------------------*
      *        * Per Si/No stampa data effettiva di stampa             *
      *        *-------------------------------------------------------*
           05  w-prs-snx-dse.
      *            *---------------------------------------------------*
      *            * Per Si/No stampa data effettiva di stampa         *
      *            *---------------------------------------------------*
               10  w-prs-snx-dse-snx      pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-wrk.
      *        *-------------------------------------------------------*
      *        * Work per bufferizzazione data ultima stampa           *
      *        *-------------------------------------------------------*
           ...
           05  w-exp-tip-stp.
               ...
               10  w-exp-tip-stp-tbl.
                   ...
                   15  filler             pic  x(20) value
                            "Ristampa            "                    .
      *        *-------------------------------------------------------*
      *        * Work per : Esposizione data effettiva di stampa       *
      *        *-------------------------------------------------------*
           05  w-exp-snx-dse.
               10  w-exp-snx-dse-num      pic  9(02)       value 02   .
               10  w-exp-snx-dse-lun      pic  9(02)       value 02   .
               10  w-exp-snx-dse-tbl.
                   15  filler             pic  x(02) value "No"       .
                   15  filler             pic  x(02) value "Si"       .
      *        *-------------------------------------------------------*
      *        * Work per : Si/no stampa protocollo                    *
      *        *-------------------------------------------------------*
           05  w-exp-snx-spt.
               10  w-exp-snx-spt-num      pic  9(02)       value 2    .
               10  w-exp-snx-spt-lun      pic  9(02)       value 02   .
               10  w-exp-snx-spt-tbl.
                   15  filler             pic  x(02)       value "No" .
                   15  filler             pic  x(02)       value "Si" .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Lettura file numerazioni giornale di contabi-   *
      *              * lita'                                           *
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           ...
           move      rn-gio-con-dat-stp   to   w-wrk-ult-dat          .
           move      "CL"                 to   f-ope                  .
           move      "pgm/cge/num/ioc/obj/ingiocon"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
       ...
       pre-exe-pgm-400.
      *              *-------------------------------------------------*
      *              * Lettura personalizzazione per stampa data di    *
      *              * stampa effettiva                                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "P:"                 to   s-ope                  .
           move      "pgm/cge/mov/cge310[snx-dts]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-prs-snx-dse
           else      move  spaces         to   w-prs-snx-dse          .
      *                  *---------------------------------------------*
      *                  * Normalizzazione personalizzazione           *
      *                  *---------------------------------------------*
           if        w-prs-snx-dse-snx    not  = "N" and
                     w-prs-snx-dse-snx    not  = "S" and
                     w-prs-snx-dse-snx    not  = "R"
                     move  "N"            to   w-prs-snx-dse-snx      .
       pre-exe-pgm-500.
      *              *-------------------------------------------------*
      *              * Lettura referenze                               *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-400.
      *                  *---------------------------------------------*
      *                  * Esposizione data di stampa effettiva        *
      *                  *---------------------------------------------*
           perform   acc-snx-dse-000      thru acc-snx-dse-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
       ...
       acc-ric-sel-500.
      *                  *---------------------------------------------*
      *                  * Esposizione protocollo interno              *
      *                  *---------------------------------------------*
           perform   acc-snx-spt-000      thru acc-snx-spt-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
       ...
       pmt-ric-sel-300.
      *              *-------------------------------------------------*
      *              * 'Esposizione data di stampa'                    *
      *              *-------------------------------------------------*
           if        w-prs-snx-dse-snx    not  = "R"
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Esposizione data effettiva di :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "          stampa del giornale  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ric-sel-400.
      *              *-------------------------------------------------*
      *              * Si/no stampa protocollo interno                 *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      31                   to   v-car                  .
           move      14                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Stampa del protocollo interno :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "N.B.: Il programma, in esecuzione definitiva, pone
      -              " la data di registrazione     "
           ...
           move      21                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "      finale come data da cui far partire le pross
      -              "ime registrazioni contabili.  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ric-sel-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      18                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-ref-gio-con-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Esposizione data di stampa effettiva *
      *    *-----------------------------------------------------------*
       acc-snx-dse-000.
      *              *-------------------------------------------------*
      *              * Preparazioni pre-accettazione                   *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-dse-lun    to   v-car                  .
           move      w-exp-snx-dse-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      11                   to   v-lin                  .
           move      33                   to   v-pos                  .
           move      w-exp-snx-dse-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        rr-snx-dse           =    "N"
                     move  01             to   v-num
           else if   rr-snx-dse           =    "S"
                     move  02             to   v-num
           else      move  zero           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   rr-snx-dse
           else if   v-num                =    02
                     move  "S"            to   rr-snx-dse
           else      move  spaces         to   rr-snx-dse             .
       acc-snx-dse-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Controllo che esista un valore              *
      *                  *---------------------------------------------*
           if        rr-snx-dse           =    spaces
                     go to acc-snx-dse-100.
       acc-snx-dse-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Esposizione protocollo interno       *
      *    *-----------------------------------------------------------*
       acc-snx-spt-000.
      *              *-------------------------------------------------*
      *              * Preparazioni pre-accettazione                   *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-spt-lun    to   v-car                  .
           move      w-exp-snx-spt-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      14                   to   v-lin                  .
           move      33                   to   v-pos                  .
           move      w-exp-snx-spt-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        rr-snx-spt           =    "N"
                     move  01             to   v-num
           else if   rr-snx-spt           =    "S"
                     move  02             to   v-num
           else      move  zero           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-spt-999.
       acc-snx-spt-300.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   rr-snx-spt
           else if   v-num                =    02
                     move  "S"            to   rr-snx-spt
           else      move  spaces         to   rr-snx-spt             .
       acc-snx-spt-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Controllo che esista un valore              *
      *                  *---------------------------------------------*
           if        rr-snx-spt           =    spaces
                     go to acc-snx-spt-100.
       acc-snx-spt-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              * Esposizione data di stampa effettiva            *
      *              *-------------------------------------------------*
           if        w-prs-snx-dse-snx    =    "N"
                     go to reg-ric-sel-100
           else if   w-prs-snx-dse-snx    =    "S"
                     go to reg-ric-sel-200
           else      go to reg-ric-sel-300.
       reg-ric-sel-100.
           move      "N"                  to   rr-snx-dse             .
           move      zero                 to   rr-dat-sef             .
       ...
       reg-ric-sel-200.
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rr-dat-sef             .
           go to     reg-ric-sel-400.
       reg-ric-sel-300.
           if        rr-snx-dse           =    "S"
                     go to reg-ric-sel-200
           else      go to reg-ric-sel-100.
       reg-ric-sel-400.
      *              *-------------------------------------------------*
      *              * Esposizione protocollo interno                  *
      *              *-------------------------------------------------*
