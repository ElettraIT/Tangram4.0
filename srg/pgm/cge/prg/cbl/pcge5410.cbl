      ...
      *                                   Fase:    cge541              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 07/02/90    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su partite aperte fornitore  *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   INTERROGAZIONE SU PARTITE FORNITORI  "       .
      ...
      *    *-----------------------------------------------------------*
       z-qry-ini-cic-000.
      *              *-------------------------------------------------*
      *              * Azzeramento saldo fornitore                     *
      *              *-------------------------------------------------*
           move      zero                 to   w-wrk-sdo-fnt          .
       z-qry-ini-cic-999.
           exit.
      ...
      *              *-------------------------------------------------*
           add       w-par-sdo-par        to   w-wrk-sdo-fnt          .
      *              *-------------------------------------------------*
      *              * Test su linee residue                           *
      *              *-------------------------------------------------*
           if        v-res                >    zero
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Titolo centrale 'PARTITE FORNITORE'         *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      17                   to   v-car                  .
           move      v-lnr                to   v-lin                  .
           move      32                   to   v-pos                  .
           move      "PARTITE FORNITORE"  to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      ...
      *                  *---------------------------------------------*
           move      v-cnt                to   w-mpn                  .
      *                  *---------------------------------------------*
      *                  * Put variabile di ipc:'select codfnt'        *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
