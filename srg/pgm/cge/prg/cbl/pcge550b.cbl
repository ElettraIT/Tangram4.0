      ...
      *            *---------------------------------------------------*
               ...
               10  w-tes-tip-utz          pic  9(02)                  .
               10  w-tes-num-tel          pic  x(20)                  .
               10  w-tes-num-fax          pic  x(20)                  .
               10  w-tes-num-ce1          pic  x(20)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipi utenza                                *
      *        *-------------------------------------------------------*
           05  w-exp-tip-utz.
               10  w-exp-tip-utz-num      pic  9(02)       value 7    .
               10  w-exp-tip-utz-lun      pic  9(02)       value 20   .
               10  w-exp-tip-utz-tbl.
      ...
      *                  * Tipi utenza                                 *
      *                  *---------------------------------------------*
           perform   acc-tip-utz-000      thru acc-tip-utz-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *                  * Cellulare                                   *
      *                  *---------------------------------------------*
           perform   acc-num-ce1-000      thru acc-num-ce1-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Tipi utenza                                     *
      *              *-------------------------------------------------*
           perform   vis-tip-utz-000      thru vis-tip-utz-999        .
      *              *-------------------------------------------------*
      *              * Telefono                                        *
      *              *-------------------------------------------------*
      ...
      *              * Cellulare                                       *
      *              *-------------------------------------------------*
           perform   vis-num-ce1-000      thru vis-num-ce1-999        .
      *              *-------------------------------------------------*
      *              * Interlocutore                                   *
      *              *-------------------------------------------------*
      ...
      *                  * Tipi utenza                                 *
      *                  *---------------------------------------------*
           perform   pmt-tip-utz-000      thru pmt-tip-utz-999        .
      *                  *---------------------------------------------*
      *                  * Telefono                                    *
      *                  *---------------------------------------------*
      ...
      *                  * Cellulare                                   *
      *                  *---------------------------------------------*
           perform   pmt-num-ce1-000      thru pmt-num-ce1-999        .
      *                  *---------------------------------------------*
      *                  * Interlocutore                               *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Tipi utenza                      *
      *    *-----------------------------------------------------------*
       pmt-tip-utz-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Tipi utenza                          *
      *    *-----------------------------------------------------------*
       acc-tip-utz-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tip-utz-lun    to   v-car                  .
           move      w-exp-tip-utz-num    to   v-ldt                  .
           move      "NTFCEDW#"           to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      12                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-tip-utz-tbl    to   v-txt                  .
           move      w-tes-tip-utz        to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-tip-utz-999.
       acc-tip-utz-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-tip-utz          .
       acc-tip-utz-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Tipi utenza                       *
      *    *-----------------------------------------------------------*
       vis-tip-utz-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-num-ce1-999.
       acc-num-ce1-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-num-ce1          .
       acc-num-ce1-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Data aggiornamento                          *
      *                  *---------------------------------------------*
           perform   acc-dat-agg-000      thru acc-dat-agg-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *              * Data aggiornamento                              *
      *              *-------------------------------------------------*
           perform   vis-dat-agg-000      thru vis-dat-agg-999        .
       vis-rig-cor-999.
           exit.
      ...
      *                  * Data aggiornamento                          *
      *                  *---------------------------------------------*
           perform   pmt-dat-agg-000      thru pmt-dat-agg-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data aggiornamento               *
      *    *-----------------------------------------------------------*
       pmt-dat-agg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data aggiornamento                   *
      *    *-----------------------------------------------------------*
       acc-dat-agg-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-dat-agg-999.
       acc-dat-agg-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   w-rig-dat-agg          .
       acc-dat-agg-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                      * Test se selezione da eseguire           *
      *                      *-----------------------------------------*
           if        w-tes-num-ce1        =    spaces
                     go to sel-rec-fnt-600.
      *                      *-----------------------------------------*
      *                      * Determinazione                          *
      *                      *-----------------------------------------*
           move      "DT"                 to   d-con-arc-tip-ope      .
      ...
      *                      *-----------------------------------------*
           if        w-tes-tip-utz        =    01
                     go to sel-rec-adc-300.
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
           if        w-tes-tip-utz        =    02    and
                     rf-adc-tip-con       =    "TEL"
                     go to sel-rec-adc-300.
           if        w-tes-tip-utz        =    03    and
                     rf-adc-tip-con       =    "FAX"
                     go to sel-rec-adc-300.
           if        w-tes-tip-utz        =    04    and
                     rf-adc-tip-con       =    "CEL"
                     go to sel-rec-adc-300.
           if        w-tes-tip-utz        =    05    and
                     rf-adc-tip-con       =    "EML"
                     go to sel-rec-adc-300.
           if        w-tes-tip-utz        =    06    and
                     rf-adc-tip-con       =    "EML"
                     go to sel-rec-adc-300.
           if        w-tes-tip-utz        =    07    and
                     rf-adc-tip-con       =    "WWW"
                     go to sel-rec-adc-300.
      *                      *-----------------------------------------*
      *                      * Selezione non superata                  *
      ...
      *                  * E-mail per documenti                        *
      *                  *---------------------------------------------*
           if        w-tes-tip-utz        not  = 06
                     go to sel-rec-adc-350.
           if        rf-adc-int-con
                    (01 : 01)             not  = "<"
                     go to sel-rec-adc-900.
           if        rf-adc-int-con
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-adc-tip-con       not  = "CEL"
                     go to sel-rec-adc-900.
           if        rf-adc-num-con       not  = w-tes-num-ce1
                     go to sel-rec-adc-900
           else      go to sel-rec-adc-800.
       sel-rec-adc-600.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-fnt-cod-fnt       to   rf-adc-cod-arc         .
      ...
      *                  * Test sulla chiave                           *
      *                  *---------------------------------------------*
           if        rf-adc-tip-arc       not  = 01             or
                     rf-adc-cod-arc       not  = rf-fnt-cod-fnt or
                     rf-adc-dpz-arc       not  = spaces
                     go to car-eff-rig-900.
       car-eff-rig-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-adc-dat-agg       to   w-rig-dat-agg          .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-rig-dat-agg        to   rf-adc-dat-agg         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Routine per Expand anagrafica fornitore in riga           *
      *    *-----------------------------------------------------------*
       rou-exp-ana-000.
      *              *-------------------------------------------------*
      *              * Salvataggio immagine video                      *
