      ...
      *                                   Fase:    cge525              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 08/12/91    *
      *                       Ultima revisione:    NdK del 15/02/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma cge525 : *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-wrk-num-doc              pic  x(10)                  .
           05  w-wrk-prt-iva              pic  x(10)                  .
           05  w-wrk-num-ct1              pic  9(02)                  .
           05  w-wrk-num-ct2              pic  9(02)                  .
           05  w-wrk-num-ct3              pic  9(02)                  .
           05  w-wrk-num-ct4              pic  9(02)                  .
           05  w-wrk-num-ct5              pic  9(02)                  .
           05  w-wrk-num-ct6              pic  9(02)                  .
           05  w-wrk-num-ct7              pic  9(02)                  .
           05  w-wrk-num-ct8              pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-sad.
      *        *-------------------------------------------------------*
      *        * Codice archivio di cui si vuole ottenere il saldo     *
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-fnt-cod-fnt       not  = rr-cod-fnt
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-mgr                 .
      *                      *-----------------------------------------*
      *                      * Se Start errata : a scheda saldi        *
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
      ...
      *                  *---------------------------------------------*
           move      rf-fnt-cod-fnt       to   w-sad-cod-fnt          .
      ...
      *              *-------------------------------------------------*
           move      w-rot-l01-cod-fnt    to   w-par-cod-prt          .
      ...
      *              *-------------------------------------------------*
           move      "F"                  to   w-det-cpt-mgr-tco      .
           move      srt-cod-fnt          to   w-det-cpt-mgr-cco      .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Protocollo IVA e numero documento           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Numero documento in campo di comodo     *
      *                      *-----------------------------------------*
           move      rf-mgr-num-doc       to   w-wrk-num-doc          .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-wrk-prt-iva          .
      *                      *-----------------------------------------*
      *                      * Assemblaggio                            *
      *                      *-----------------------------------------*
           move      10                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      w-wrk-prt-iva        to   w-all-str-cat (1)      .
      *
           if        rf-mgt-prt-iva       =    zero
                     move  spaces         to   w-all-str-cat (2)
           else      move  "-"            to   w-all-str-cat (2)      .
      *
           move      w-wrk-num-doc        to   w-all-str-cat (3)      .
      ...
      *                  *---------------------------------------------*
           if        rf-mgr-tip-iva       =    "5"
                     add      rf-mgr-imp-mov
                                          to   w-par-prg-fat
           else if   rf-mgr-tip-iva       =    "E"
                     add      rf-mgr-imp-mov
                                          to   w-par-prg-fat
           else if   rf-mgr-tip-iva       =    "4"
                     subtract rf-mgr-imp-mov
                                          from w-par-prg-fat
           else if   rf-mgr-tip-iva       =    "D"
                     subtract rf-mgr-imp-mov
                                          from w-par-prg-fat          .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "B"                  to   x-edm                  .
           move      w-rot-l01-cod-fnt    to   x-num                  .
           call      "swd/mod/prg/obj/mxport"
                                         using x                      .
      *                  *---------------------------------------------*
      *                  * Ragione sociale fornitore                   *
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "|Data reg|Data doc Prot-Num  |        Causale     
      -              "   | Data e Nr. Riferim.|        Dare      |      
      -              "Avere       |    Progressivo   |"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *              *-------------------------------------------------*
           move      w-par-cod-prt        to   w-sad-cod-fnt          .
           perform   det-sdo-ini-000      thru det-sdo-ini-999        .
      *              *-------------------------------------------------*
      *              * Saldo di apertura                               *
      *              *-------------------------------------------------*
      ...
      *                  * cizio                                       *
      *                  *---------------------------------------------*
           if        w-sad-ann-ese        not  = rn-dat-bil-ese-bil
                     go to  det-sdo-ini-900.
      *                  *---------------------------------------------*
      ...
      *    *         - w-sad-cod-fnt : codice archivio di cui si vuole *
      *    *                           ottenere il saldo               *
