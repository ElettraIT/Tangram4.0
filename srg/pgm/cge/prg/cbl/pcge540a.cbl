      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione overlay per programma pcge5400   *
      *                                                                *
      *                    Pareggiamento manuale partite fornitori     *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       cnc-sub-cat-000.
           cancel    "pgm/cge/prg/obj/pcge5402"                       .
       cnc-sub-cat-999.
           exit.
      ...
      *                      *-----------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
           if        w-tes-sdo-fnt (1)    >    9999999999 or
                     w-tes-sdo-fnt (1)    <   -9999999999
                     move  13             to   v-car
           else      move  11             to   v-car                  .
           move      c-dec                to   v-dec                  .
           move      "S"                  to   v-sgn                  .
      ...
      *                  *---------------------------------------------*
      *                  * Espansione su partita fornitore             *
      *                  *---------------------------------------------*
           perform   esp-par-fnt-000      thru esp-par-fnt-999        .
      *                  *---------------------------------------------*
      *                  * Reimpostazione                              *
      *                  *---------------------------------------------*
           go to     acc-sel-par-100.
      ...
      *                  * Messaggio                                   *
      *                  *---------------------------------------------*
           move      "Non e' stata selzionata alcuna partita !          
      ...
      *    *===========================================================*
      *    * Caricamento catena partite fornitore                      *
      *    *-----------------------------------------------------------*
       car-cat-par-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di uscita                  *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-fnt        to   rf-mgr-cod-arc         .
      ...
      *              *-------------------------------------------------*
           if        rf-mgr-tip-arc       not  = "F"           or
                     rf-mgr-cod-arc       not  = w-tes-cod-fnt
                     go to car-cat-par-300.
      *              *-------------------------------------------------*
      ...
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Nessuna partita da pareggiare per il fornitore    
      -              "               "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                  *---------------------------------------------*
      *                  * Flag di uscita ad errore                    *
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se area rottura partita ancora normalizzata *
      *                  * uscita                                      *
      *                  *---------------------------------------------*
           if        w-car-cat-par-rnr    =    spaces and
                     w-car-cat-par-rdr    =    zero
      ...
      *                      *-----------------------------------------*
           if        rf-mgr-tip-arc       not  = "F"            or
                     rf-mgr-cod-arc       not  = w-tes-cod-fnt  or
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     go to esp-par-fnt-999.
       esp-par-fnt-100.
      *              *-------------------------------------------------*
      *              * Scrittura variabile di i.p.c. 'select codfnt'   *
      *              * per il livello successivo per il codice fornit. *
