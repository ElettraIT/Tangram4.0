      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge7101:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-ref-giv-acq.
               10  w-ref-giv-acq-cod      pic  x(06)                  .
               10  filler                 pic  x(01)                  .
               10  w-ref-giv-acq-des      pic  x(40)                  .
               10  filler                 pic  x(03)                  .
      ...
      *                  * Codice e titolo per la stampa registro      *
      *                  *---------------------------------------------*
           perform   ref-giv-acq-000      thru ref-giv-acq-999        .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione valori letti                *
      *                  *---------------------------------------------*
           move      w-ref-giv-acq-cod    to   rr-num-cod             .
           move      w-ref-giv-acq-des    to   rr-num-des             .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "R:"                 to   s-ope                  .
           move      "pgm/cge/iva[giv-acq]"
                                          to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move  s-alf          to   w-ref-giv-acq
           else      move  spaces         to   w-ref-giv-acq          .
      *              *-------------------------------------------------*
      *              * Normalizzazione referenza                       *
      *              *-------------------------------------------------*
           if        w-ref-giv-acq-cod    =    spaces
                     move  "givacq"       to   w-ref-giv-acq-cod      .
           if        w-ref-giv-acq-des    =    spaces
                     move  "REGISTRO DEGLI ACQUISTI"
                                          to   w-ref-giv-acq-des      .
       ref-giv-acq-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     ref-giv-acq-999.
       ref-giv-acq-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Stampa di peova o definitiva  *
      *    *-----------------------------------------------------------*
       pmt-tip-stp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-152.
           ...
           move      "Tipo stampa, di prova o definitiva, errato !      
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
