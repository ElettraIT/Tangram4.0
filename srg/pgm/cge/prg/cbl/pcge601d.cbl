      ...
      *              *-------------------------------------------------*
           ...
           move      rr-dem-min           to   rf-cer-dat-mov         .
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-cer-cod-csp       to   w-rot-l01-cod-csp      .
       qry-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-cer-dat-mov       to   w-rip-str-cer-dat      .
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "DATCSP    "         to   f-key                  .
           move      w-rip-str-cer-dat    to   rf-cer-dat-mov         .
