      ...
      *                       Ultima revisione:    NdK del 11/06/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [fnt]            *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  INTERROGAZIONE ANAGRAFICA FORNITORI  "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-rip-str.
      *        *-------------------------------------------------------*
      *        * Work-area per ripristino Start su [fnt]               *
      *        *-------------------------------------------------------*
           05  w-rip-str-fnt.
      *            *---------------------------------------------------*
      *            * Flag di End-of-file                               *
      *            *---------------------------------------------------*
               10  w-rip-str-fnt-eof      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Parametri di Start                                *
      *            *---------------------------------------------------*
               10  w-rip-str-fnt-cod      pic  9(07)                  .
               10  w-rip-str-fnt-rag      pic  x(40)                  .
               10  w-rip-str-fnt-mne      pic  x(10)                  .
               10  w-rip-str-fnt-piv      pic  9(11)                  .
               10  w-rip-str-fnt-cfi      pic  x(16)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-buf.
           ...
           05  w-buf-via-fnt              pic  x(40)                  .
           05  w-buf-loc-fnt              pic  x(40)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp-rec.
           05  w-exp-rec-fnt-lin          pic  9(02) value 15         .
           05  w-exp-rec-fnt-ctr          pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-rip-str-fnt-eof      .
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo ordinamento     *
      *              *-------------------------------------------------*
           if        rr-tip-ord           =    "C"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cfi-min           to   rf-fnt-cod-fis         .
           move      zero                 to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           if        rf-fnt-cod-fis       <    rr-cfi-min or
                     rf-fnt-cod-fis       >    rr-cfi-max
                     go to qry-sel-rec-900.
       qry-sel-rec-800.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-fnt-rag-soc       to   w-rot-l01-rag-soc      .
       qry-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      w-buf-cod-fnt        to   w-mpn-cod-fnt          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-buf-via-fnt        =    spaces  and
                     w-buf-loc-fnt        =    spaces
                     move  1              to   w-buf-lin-res
           else if   w-buf-via-fnt        =    spaces
                     move  2              to   w-buf-lin-res
           else if   w-buf-loc-fnt        =    spaces
                     move  2              to   w-buf-lin-res
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-fnt-cod-fnt       to   w-buf-cod-fnt          .
           move      rf-fnt-rag-soc       to   w-buf-rag-soc          .
           move      rf-fnt-via-fnt       to   w-buf-via-fnt          .
           move      rf-fnt-loc-fnt       to   w-buf-loc-fnt          .
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "EXPD"
                     go to qry-trt-fun-999.
      *                  *---------------------------------------------*
      *                  * Routine per Expand su record [fnt]          *
      *                  *---------------------------------------------*
           perform   exp-rec-fnt-000      thru exp-rec-fnt-999        .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       exp-rec-fnt-000.
      *              *-------------------------------------------------*
      *              * Salvataggio parametri per Start su [fnt]        *
      *              *-------------------------------------------------*
           if        w-rip-str-fnt-eof    not  = spaces
                     go to exp-rec-fnt-100.
           move      rf-fnt-cod-fnt       to   w-rip-str-fnt-cod      .
           move      rf-fnt-rag-key       to   w-rip-str-fnt-rag      .
           move      rf-fnt-cod-mne       to   w-rip-str-fnt-mne      .
           move      rf-fnt-prt-iva       to   w-rip-str-fnt-piv      .
           move      rf-fnt-cod-fis       to   w-rip-str-fnt-cfi      .
       exp-rec-fnt-100.
      *              *-------------------------------------------------*
      *              * Video in 'OFF'                                  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per Sottoconto contabile             *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      22                   to   v-car                  .
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per Codice esenzione iva             *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      22                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "CODFNT    "         to   f-key                  .
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-cod-fnt        to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura codice sottoconto                   *
      *                  *---------------------------------------------*
           move      rf-fnt-cod-cge       to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
      *                  *---------------------------------------------*
      *                  * Lettura codice esenzione iva                *
      *                  *---------------------------------------------*
           move      rf-fnt-cod-iva       to   w-let-arc-zci-cod      .
      ...
      *                      *-----------------------------------------*
           if        rf-fnt-cod-cge       =    zero
                     go to exp-rec-fnt-720.
      *                      *-----------------------------------------*
      *                      * Codice sottoconto                       *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      rf-fnt-cod-cge       to   w-edt-cod-pdc-cod      .
      ...
      *                      *-----------------------------------------*
       ...
       exp-rec-fnt-720.
      *                  *---------------------------------------------*
      *                  * Codice di esenzione iva                     *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se a zero : soggetto                    *
      *                      *-----------------------------------------*
           if        rf-fnt-cod-iva       not  = zero
                     go to exp-rec-fnt-725.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      15                   to   v-car                  .
           move      14                   to   v-lin                  .
           move      26                   to   v-pos                  .
           move      "Soggetto Iva   "    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           go to     exp-rec-fnt-730.
       exp-rec-fnt-725.
      *                      *-----------------------------------------*
      *                      * Codice di esenzione                     *
      *                      *-----------------------------------------*
      ...
      *                      * Ciclo 1..3                              *
      *                      *-----------------------------------------*
           move      zero                 to   w-exp-rec-fnt-ctr      .
       exp-rec-dcc-735.
           add       1                    to   w-exp-rec-fnt-ctr      .
           if        w-exp-rec-fnt-ctr    >    03 or
                     w-exp-rec-fnt-ctr    >    d-con-arc-num-ele
      ...
      *                      *-----------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      03                   to   v-car                  .
           move      w-exp-rec-fnt-lin    to   v-lin                  .
           add       w-exp-rec-fnt-ctr    to   v-lin                  .
           move      03                   to   v-pos                  .
      *
           if        d-con-arc-tip-con
                    (w-exp-rec-fnt-ctr)   =    "SEP"
                     move  all "-"        to   v-alf
      ...
      *
           ...
           move      rf-fnt-ide-ute       to   w-all-str-cat (2)      .
      ...
      *
           move      03                   to   w-all-str-num          .
           move      w-all-str-alf        to   w-all-str-cat (1)      .
           move      rf-fnt-ide-fas       to   w-all-str-cat (2)      .
           move      "]"                  to   w-all-str-cat (3)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
      *                      *-----------------------------------------*
      *                      * Visualizzazione                         *
      ...
      *                  *---------------------------------------------*
           if        w-rip-str-fnt-eof    not  = spaces
                     go to exp-rec-fnt-999.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo di Start    *
      *                  * attualmente attivo                          *
      *                  *---------------------------------------------*
           if        rr-tip-ord           =    "C"
                     go to exp-rec-fnt-910
           else if   rr-tip-ord           =    "R"
                     go to exp-rec-fnt-920
           else if   rr-tip-ord           =    "M"
                     go to exp-rec-fnt-930
           else if   rr-tip-ord           =    "P"
                     go to exp-rec-fnt-940
           else if   rr-tip-ord           =    "F"
                     go to exp-rec-fnt-950.
       exp-rec-fnt-910.
      *                  *---------------------------------------------*
      *                  * Se start per codice                         *
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODFNT    "         to   f-key                  .
           move      w-rip-str-fnt-cod    to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-fnt                 .
           if        f-sts                not  = e-not-err
                     go to exp-rec-fnt-990.
           go to     exp-rec-fnt-980.
       exp-rec-fnt-920.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "RAGKEY    "         to   f-key                  .
           move      w-rip-str-fnt-rag    to   rf-fnt-rag-key         .
           move      w-rip-str-fnt-cod    to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODMNE    "         to   f-key                  .
           move      w-rip-str-fnt-mne    to   rf-fnt-cod-mne         .
           move      w-rip-str-fnt-cod    to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "PRTIVA    "         to   f-key                  .
           move      w-rip-str-fnt-piv    to   rf-fnt-prt-iva         .
           move      w-rip-str-fnt-cod    to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODFIS    "         to   f-key                  .
           move      w-rip-str-fnt-cfi    to   rf-fnt-cod-fis         .
           move      w-rip-str-fnt-cod    to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
