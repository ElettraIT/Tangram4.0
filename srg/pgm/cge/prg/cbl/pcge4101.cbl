      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma cge410   *
      *                    Stampa anagrafica clienti  su etichette     *
      *                    (monocolonna 3,6 x 10)                      *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
           if        rf-cli-prt-iva       =    zero
                     go to  prn-sel-rec-999.
           move      rf-cli-prt-iva       to   w-ctl-prt-iva-piv      .
