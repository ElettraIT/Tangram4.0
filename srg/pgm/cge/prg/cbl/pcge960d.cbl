      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa archivio [mgi] per Nazione           *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "    STAMPA MOVIMENTI IVA PER NAZIONE    "       .
           ...
           05  w-exp-tip-rec.
               ...
               10  w-exp-tip-rec-tbl.
                   ...
                   15  filler             pic  x(20) value
                            "Fornitori           "                    .
      *        *-------------------------------------------------------*
      *        * Work per : Selezione su nazioni                       *
      *        *-------------------------------------------------------*
           05  w-exp-sel-naz.
               10  w-exp-sel-naz-num      pic  9(02)       value 04   .
               10  w-exp-sel-naz-lun      pic  9(02)       value 20   .
               10  w-exp-sel-naz-tbl.
                   15  filler             pic  x(20) value
                            "Tutte le nazioni    "                    .
                   15  filler             pic  x(20) value
                            "solo Italia         "                    .
      ...
      *        *-------------------------------------------------------*
      *        * Work per totali nazione                               *
      *        *-------------------------------------------------------*
           05  w-tot-naz.
      *            *---------------------------------------------------*
      *            * Totale imponibile                                 *
      *            *---------------------------------------------------*
               10  w-tot-naz-tot-ibl      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * Totale imposta                                    *
      *            *---------------------------------------------------*
               10  w-tot-naz-tot-imp      pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Work per totali archivio                              *
      *        *-------------------------------------------------------*
           05  w-tot-arc.
      *            *---------------------------------------------------*
      *            * Totale imponibile                                 *
      *            *---------------------------------------------------*
               10  w-tot-arc-tot-ibl      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * Totale imposta                                    *
      *            *---------------------------------------------------*
               10  w-tot-arc-tot-imp      pic s9(11)                  .
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-550.
      *                  *---------------------------------------------*
      *                  * Selezione su nazioni                        *
      *                  *---------------------------------------------*
           perform   acc-sel-naz-000      thru acc-sel-naz-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tipo di nazione :" 
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Selezione su nazioni                 *
      *    *-----------------------------------------------------------*
       acc-sel-naz-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-naz-lun    to   v-car                  .
           move      w-exp-sel-naz-num    to   v-ldt                  .
           move      "TICE#"              to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-sel-naz-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      20                   to   v-lin                  .
           move      32                   to   v-pos                  .
           move      rr-sel-naz           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-sel-naz-999.
       acc-sel-naz-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-sel-naz             .
       acc-sel-naz-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-mgi-tip-rec       not  = rr-tip-rec
      ...
      *                      *-----------------------------------------*
           if        rr-tip-rec           =    "C"
                     move  rf-mgi-cod-arc to   w-let-arc-cli-cod
                     perform   let-arc-cli-000
                                          thru let-arc-cli-999
           else      move  rf-mgi-cod-arc to   w-let-arc-fnt-cod
                     perform   let-arc-fnt-000
                                          thru let-arc-fnt-999        .
      *
           if        rr-tip-rec           =    "C"
                     move  w-let-arc-cli-naz
                                          to   w-stp-srt-inp-naz
           else      move  w-let-arc-fnt-naz
                                          to   w-stp-srt-inp-naz      .
      *                      *-----------------------------------------*
      *                      * Test se tutte le nazioni                *
      *                      *-----------------------------------------*
           if        rr-sel-naz           =    01
      ...
      *                      * Solo Italia                             *
      *                      *-----------------------------------------*
           if        rr-sel-naz           not  = 02
                     go to stp-srt-inp-520.
           if        w-stp-srt-inp-naz    =    "IT "
                     go to stp-srt-inp-600
      ...
      *                      * Lettura tabella                         *
      *                      *-----------------------------------------*
           move      w-stp-srt-inp-naz    to   w-let-arc-gxn-cod      .
           perform   let-arc-gxn-000      thru let-arc-gxn-999        .
      *                      *-----------------------------------------*
      *                      * Selezione                               *
      *                      *-----------------------------------------*
           if        rr-sel-naz           =    03  and
                     w-let-arc-gxn-cee    =    "S"
                     go to stp-srt-inp-600.
           if        rr-sel-naz           =    04  and
                     w-let-arc-gxn-cee    =    "N"
                     go to stp-srt-inp-600.
           go to     stp-srt-inp-200.
       stp-srt-inp-600.
      ...
      *                  * Chiave                                      *
      *                  *---------------------------------------------*
           move      w-stp-srt-inp-naz    to   srt-cod-naz            .
           move      rf-mgi-cod-iva
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
      *              *-------------------------------------------------*
      *              * Livello 4 - Codice nazione                      *
      *              *-------------------------------------------------*
           if        srt-cod-naz          =    spaces
                     move  "(?)"          to   w-rot-l04-cod-naz
           else      move  srt-cod-naz    to   w-rot-l04-cod-naz      .
      *              *-------------------------------------------------*
      *              * Livello 3 - Codice Iva                          *
      *              *-------------------------------------------------*
           move      srt-cod-iva          to   w-rot-l03-cod-iva      .
      *              *-------------------------------------------------*
      *              * Livello 2 - Tipo record e codice archivio       *
      *              *-------------------------------------------------*
           move      srt-tip-rec          to   w-rot-l02-tip-rec      .
           move      srt-cod-arc          to   w-rot-l02-cod-arc      .
      *              *-------------------------------------------------*
      *              * Livello 1 - Mese e anno                         *
      *              *-------------------------------------------------*
      ...
      *              * Normalizzazione totali                          *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-naz-tot-ibl      .
           move      zero                 to   w-tot-naz-tot-imp      .
       prn-ini-lr4-100.
      *              *-------------------------------------------------*
      *              * Stampa intestazione nazione                     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      014                  to   p-pos                  .
           move      w-rot-l04-cod-naz    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Descrizione nazione                         *
      *                  *---------------------------------------------*
           move      w-rot-l04-cod-naz    to   w-let-arc-gxn-cod      .
           perform   let-arc-gxn-000      thru let-arc-gxn-999        .
      *
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       prn-fin-lr4-100.
      *              *-------------------------------------------------*
      *              * Stampa totali nazione                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se righe residue sufficienti           *
      *                  *---------------------------------------------*
           if        p-res                >    2
                     go to prn-fin-lr4-200.
      *                  *---------------------------------------------*
      *                  * Reintestazione                              *
      *                  *---------------------------------------------*
           perform   int-pag-sta-000      thru int-pag-sta-999        .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      077                  to   p-pos                  .
           move      w-tot-naz-tot-ibl    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Imposta                                 *
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      100                  to   p-pos                  .
           move      w-tot-naz-tot-imp    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-lr4-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      014                  to   p-pos                  .
           move      w-rot-l03-cod-iva    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Lettura tabella codici iva                  *
      *                  *---------------------------------------------*
           move      w-rot-l03-cod-iva    to   w-let-arc-zci-cod      .
           perform   let-arc-zci-000      thru let-arc-zci-999        .
      *                  *---------------------------------------------*
      *                  * Test su codice aliquota                     *
      *                  *---------------------------------------------*
           if        w-rot-l03-cod-iva    >    700   and
                     w-rot-l03-cod-iva    <    799
                     move  "Non detraibile"
                                          to   w-let-arc-zci-des      .
      *
           if        w-rot-l03-cod-iva    >    900   and
                     w-rot-l03-cod-iva    <    999
                     move  "Sola IVA      "
                                          to   w-let-arc-zci-des      .
      *                  *---------------------------------------------*
      ...
      *              * Normalizzazione totali                          *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-arc-tot-ibl      .
           move      zero                 to   w-tot-arc-tot-imp      .
       prn-ini-lr2-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-rot-l02-cod-arc    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Prompt 'codice archivio'                *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      15                   to   p-car                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      077                  to   p-pos                  .
           move      w-tot-arc-tot-ibl    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Imposta                                 *
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      100                  to   p-pos                  .
           move      w-tot-arc-tot-imp    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-lr2-999.
           exit.
      ...
      *
           add       srt-ibl-iva          to   w-tot-naz-tot-ibl      .
           add       srt-imp-iva          to   w-tot-naz-tot-imp      .
      *
           add       srt-ibl-iva          to   w-tot-arc-tot-ibl      .
           add       srt-imp-iva          to   w-tot-arc-tot-imp      .
      *
      ...
      *
           subtract  srt-ibl-iva          from w-tot-naz-tot-ibl      .
           subtract  srt-imp-iva          from w-tot-naz-tot-imp      .
      *
           subtract  srt-ibl-iva          from w-tot-arc-tot-ibl      .
           subtract  srt-imp-iva          from w-tot-arc-tot-imp      .
      *
