      ...
      *================================================================*
      *                                                                *
      * Gestione file relative di supporto per programma pcge9000      *
      *                                                                *
      * ============================================================== *
      * Tipi operazione                                                *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  fil-rec.
      *        *-------------------------------------------------------*
      *        * Area dati in grado di ospitare l'area riga del pro-   *
      *        * gramma chiamante                                      *
      *        *-------------------------------------------------------*
           05  fil-dat.
               10  filler occurs 150      pic  x(01)                  .
      ...
      *    *===========================================================*
      *    * Cache memory per i primi  200 elementi                    *
      *    *-----------------------------------------------------------*
       01  w-chm.
      *        *-------------------------------------------------------*
      *        * Numero di elementi nella cache memory                 *
      *        *-------------------------------------------------------*
           05  w-chm-nel                  pic  9(04)       value  200 .
      *        *-------------------------------------------------------*
      *        * Elementi                                              *
      *        *-------------------------------------------------------*
           05  w-chm-tbl occurs  200.
      *            *---------------------------------------------------*
      *            * Elemento, in grado di ospitare l'area riga del    *
      *            * programma chiamante                               *
      *            *---------------------------------------------------*
               10  w-chm-ele.
                   15  filler occurs 150  pic  x(01)                  .
      ...
      *    * porto, con buffer in grado di ospitare l'area riga del    *
      *    * programma chiamante                                       *
      *    *-----------------------------------------------------------*
       01  w-rlt-sup.
