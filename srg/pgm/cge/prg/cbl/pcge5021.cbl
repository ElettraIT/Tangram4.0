      ...
      *                       Ultima revisione:    NdK del 10/09/07    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma cge502   *
      *                    Stampa anagrafica fornitori                 *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Buffer per record 'rf-fnt' precedente                 *
      *        *-------------------------------------------------------*
           05  w-cpi-dop-rec-pre.
               10  filler  occurs 1048    pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Buffer per partita iva record 'rf-fnt' precedente     *
      *        *-------------------------------------------------------*
           05  w-cpi-dop-piv-pre.
               10  filler                 pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Buffer per record 'rf-fnt' attuale                    *
      *        *-------------------------------------------------------*
           05  w-cpi-dop-rec-att.
               10  filler  occurs 1048    pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Buffer per partita iva record 'rf-fnt' attuale        *
      *        *-------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-pti-min           to   rf-fnt-prt-iva         .
           move      zero                 to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           if        rf-fnt-cod-fnt       <    rr-cod-min or
                     ...
                     rf-fnt-rag-key       >    rr-rag-max or
                     rf-fnt-cod-mne       <    rr-mne-min or
                     rf-fnt-cod-mne       >    rr-mne-max or
                     rf-fnt-prt-iva       <    rr-pti-min or
      ...
      *                  * Controllo formale                           *
      *                  *---------------------------------------------*
           move      rf-fnt-prt-iva       to   w-cnt-piv-piv          .
       ...
       prn-sel-rec-600.
      *              *-------------------------------------------------*
      *              * Solo fornitori con partita iva doppia           *
      *              *-------------------------------------------------*
       prn-sel-rec-610.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-fnt-prt-iva       =    zero
                     go to  prn-sel-rec-900.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione record 'rf-fnt' attuale     *
      *                  *---------------------------------------------*
           move      rf-fnt               to   w-cpi-dop-rec-att      .
      *                  *---------------------------------------------*
      *                  * Bufferizzazione partita iva relativa al re- *
      *                  * cord 'rf-fnt' attuale                       *
      *                  *---------------------------------------------*
           move      rf-fnt-prt-iva       to   w-cpi-dop-piv-att      .
       prn-sel-rec-620.
      *                  *---------------------------------------------*
      *                  * Se status a 00                              *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Bufferizzazione record 'rf-fnt' attuale *
      *                      * in 'rf-fnt' precedente                  *
      *                      *-----------------------------------------*
           move      w-cpi-dop-rec-att    to   w-cpi-dop-rec-pre      .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione partita iva relativa al *
      *                      * record 'rf-fnt' attuale in partita iva  *
      *                      * relativa al record 'rf-fnt' precedente  *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Bufferizzazione record 'rf-fnt' at- *
      *                          * tuale in 'rf-fnt' precedente        *
      *                          *-------------------------------------*
           move      w-cpi-dop-rec-att    to   w-cpi-dop-rec-pre      .
      *                          *-------------------------------------*
      *                          * Bufferizzazione partita iva relati- *
      *                          * va al record 'rf-fnt' attuale in    *
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se status a 02 si prepara in 'rf-fnt' il    *
      ...
      *                  *---------------------------------------------*
      *                  * Si prepara in 'rf-fnt' il record attuale    *
      *                  *---------------------------------------------*
           move      w-cpi-dop-rec-att    to   rf-fnt                 .
      *                  *---------------------------------------------*
      *                  * A stampa                                    *
      *                  *---------------------------------------------*
           go to     prn-liv-det-400.
      ...
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      rf-fnt-rag-soc       to   w-stp-t01-col-002
                                              (w-stp-t01-cco-002)     .
       prn-liv-det-p01-290.
      *                      *-----------------------------------------*
      *                      * Fine colonna 2                          *
      ...
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      rf-fnt-loc-fnt       to   w-stp-t01-col-003
                                              (w-stp-t01-cco-003)     .
       prn-liv-det-p01-320.
      *                      *-----------------------------------------*
      *                      * Indirizzo                               *
      ...
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      rf-fnt-via-fnt       to   w-stp-t01-col-003
                                              (w-stp-t01-cco-003)     .
       prn-liv-det-p01-390.
      *                      *-----------------------------------------*
      *                      * Fine colonna 3                          *
      ...
      *                          * In area di stampa                   *
      *                          *-------------------------------------*
           move      rf-fnt-cod-mne       to   w-stp-t01-col-004
                                              (w-stp-t01-cco-004)     .
      *                          *-------------------------------------*
      *                          * A fine colonna                      *
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "ELENCO FORNITORI"   to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
