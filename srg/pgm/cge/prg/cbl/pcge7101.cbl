      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione richieste del programma pcge7100 *
      *                                                                *
      ...
      *                  *---------------------------------------------*
           if        rr-tip-stp           not  = "D"
                     go to prn-fin-cic-300.
      *                  *---------------------------------------------*
      *                  * Aggiornamento file numerazioni [cgeiva]     *
      *                  *---------------------------------------------*
      ...
      *              * stampa giornale e' a 'S' o 'T'; se si' si salta *
      *              * il dettaglio                                    *
      *              *-------------------------------------------------*
           if        rf-mgi-flg-gio       =    "S" or
                     rf-mgi-flg-gio       =    "T"
      ...
      *    *===========================================================*
      *    * Aggiornamento file numerazioni [givacq]                   *
      *    *-----------------------------------------------------------*
       agg-fil-num-000.
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rr-num-num           to   rn-giv-acq-cod-num     .
           move      rr-dat-fin           to   rn-giv-acq-dat-stp     .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rf-zcc-tip-moi       =    "6"
                     add   1              to   rf-ali-num-dog
           else      add   1              to   rf-ali-num-doc         .
      *                          *-------------------------------------*
      ...
      *                              * Se bolle doganali               *
      *                              *---------------------------------*
           if        rf-zcc-tip-moi       not  = "6"
                     go to agg-fil-ali-420.
           add       w-wrk-cst-ibl
                    (w-wrk-ctr-001)       to   rf-ali-ibl-dog         .
           add       w-wrk-cst-imp
                    (w-wrk-ctr-001)       to   rf-ali-iva-dog         .
           go to     agg-fil-ali-440.
       agg-fil-ali-420.
      *                              *---------------------------------*
      *                              * Se non bolle doganali           *
      *                              *---------------------------------*
           add       w-wrk-cst-ibl
      ...
      *              *-------------------------------------------------*
       ...
       agg-fil-ivp-200.
      *              *-------------------------------------------------*
      *              * Aggiornamento progressivi acquisti              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Composizione chiave                         *
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           add       w-wrk-cst-ibl
                    (w-wrk-ctr-001)       to   rf-ivp-ibl-acq         .
           add       w-wrk-cst-imp
                    (w-wrk-ctr-001)       to   rf-ivp-imp-acq         .
      *                          *-------------------------------------*
      *                          * Aggiornamento record file           *
      *                          *-------------------------------------*
           move      "UP"                 to   f-ope                  .
