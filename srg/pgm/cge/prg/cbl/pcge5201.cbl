      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione richieste del programma pcge5200 *
      *                                                                *
      ...
      *              * Composizione chiave                             *
      *              *-------------------------------------------------*
           move      rr-fnt-min           to   rf-fnt-cod-fnt         .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-fnt-cod-fnt       to   w-par-cod-prt          .
           move      rf-fnt-rag-soc       to   w-par-des-prt          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        rr-fnt-min           not  = zero
                     go to  z-esr-fin-cic-100.
           if        rr-fnt-max           =    9999999
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rn-par-fnt             .
           move      spaces               to   rn-par-fnt-flg-avs     .
           move      "FP"                 to   f-ope                  .
           move      "pgm/cge/num/ioc/obj/inparfnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "Data reg.  Data e Nr. docum.   Prot.Iva   Descrizi
      -              "one dell'operazione              Data e Nr. Riferi
      -              "m.               Dare      Avere"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *                  *---------------------------------------------*
      ...
      -              "anno dare      Progr. anno avere"
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Sottolineatura fincatura per totali piede   *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *    *         - w-sad-cod-fnt : codice fornitore di cui si vuo- *
      *    *                           leottenere il saldo             *
