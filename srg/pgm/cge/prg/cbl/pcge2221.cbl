      ...
      *                                   Fase:    cge222              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 22/07/96    *
      *                       Ultima revisione:    NdK del 16/10/01    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma cge222   *
      *                                                                *
      *                    Stampa classificatori di bilancio           *
      *                                                                *
      *================================================================*
      ...
      *            * Tipo classificatore                               *
      *            *---------------------------------------------------*
               10  w-rot-l02-tip-cdb      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * 1. livello di rottura                                 *
      *        *-------------------------------------------------------*
           05  w-rot-l01.
      *            *---------------------------------------------------*
      *            * Mastro classificatore                             *
      *            *---------------------------------------------------*
               10  w-rot-l01-mas-cdb      pic  9(02)                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Start su archivio [cdb]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "CODCDB    "         to   f-key                  .
           move      spaces               to   rf-cdb-tip-cdb         .
           move      zero                 to   rf-cdb-cod-cdb         .
           move      "pgm/cge/fls/ioc/obj/iofcdb"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun classificatore entro i limiti assegnati !"
                                          to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [cdb]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/cge/fls/ioc/obj/iofcdb"
                                          to   s-pat                  .
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-cdb-tip-cdb       to   w-rot-l02-tip-cdb      .
           move      rf-cdb-cod-cdb (1 : 2)
                                          to   w-rot-l01-mas-cdb      .
       prn-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           if        w-rot-l02-tip-cdb    =    "A"
                     move  "Attivita'                     "
                                          to   p-alf
           else if   w-rot-l02-tip-cdb    =    "P"
                     move  "Passivita' o Capitale Netto   "
                                          to   p-alf
           else if   w-rot-l02-tip-cdb    =    "O"
                     move  "Conti d'ordine                "
                                          to   p-alf
           else if   w-rot-l02-tip-cdb    =    "C"
                     move  "Costi                         "
                                          to   p-alf
           else if   w-rot-l02-tip-cdb    =    "R"
                     move  "Ricavi                        "
                                          to   p-alf
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      11                   to   p-pos                  .
           move      w-rot-l02-tip-cdb    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Codice                                  *
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      12                   to   p-pos                  .
           move      w-rot-l01-mas-cdb    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Descrizione                             *
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Riclassificatore conto economico        *
      *                      *-----------------------------------------*
           if        rf-cdb-cod-rcl       =    zero
                     go to prn-liv-det-999.
           move      "PF"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      02                   to   p-car                  .
      ...
      *                  *---------------------------------------------*
           move      "VP"                 to   p-ope                  .
           subtract  09                   from p-sel-efc-sel
                                        giving p-lin                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "Codici di riclassificazione del       "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "- 04 : Costi e proventi di gestione   "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "- 05 : Oneri e proventi extra-gestione"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
