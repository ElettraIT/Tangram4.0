      ...
      *                       Ultima revisione:    NdK del 08/08/17    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge0321:        *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-zcc-cod      .
           move      14                   to   w-cod-mne-zcc-lin      .
           move      19                   to   w-cod-mne-zcc-pos      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zcc-ope      .
           move      rr-cod-max           to   w-cod-mne-zcc-cod      .
           move      14                   to   w-cod-mne-zcc-lin      .
           move      51                   to   w-cod-mne-zcc-pos      .
           move      zero                 to   w-cod-mne-zcc-dln      .
           move      zero                 to   w-cod-mne-zcc-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
