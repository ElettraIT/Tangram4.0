      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa archivio [mgi] per Regione           *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "    STAMPA MOVIMENTI IVA PER REGIONE    "       .
      ...
      *        *-------------------------------------------------------*
      *        * Work per totali regione                               *
      *        *-------------------------------------------------------*
           05  w-tot-rgn.
      *            *---------------------------------------------------*
      *            * Totale imponibile                                 *
      *            *---------------------------------------------------*
               10  w-tot-rgn-tot-ibl      pic s9(11)                  .
      *            *---------------------------------------------------*
      *            * Totale imposta                                    *
      *            *---------------------------------------------------*
               10  w-tot-rgn-tot-imp      pic s9(11)                  .
      *        *-------------------------------------------------------*
      ...
      *
           if        rr-tip-rec           =    "C" and
                     w-let-arc-cli-naz    not  = "IT "
                     move  "EST"          to   srt-cod-rgn
                     go to stp-srt-inp-620.
      *
           if        rr-tip-rec           =    "F" and
                     w-let-arc-fnt-naz    not  = "IT "
                     move  "EST"          to   srt-cod-rgn
                     go to stp-srt-inp-620.
      *
           if        rr-tip-rec           =    "C"
                     move  w-let-arc-cli-cmn
                                          to   w-let-arc-gxc-cod
           else      move  w-let-arc-fnt-cmn
                                          to   w-let-arc-gxc-cod      .
      *                          *-------------------------------------*
      ...
      *                          * Codice regione                      *
      *                          *-------------------------------------*
           move      w-let-arc-gxp-rgn    to   srt-cod-rgn            .
       stp-srt-inp-620.
      *                      *-----------------------------------------*
      *                      * Altri dati per la chiave                *
      *                      *-----------------------------------------*
           move      rf-mgi-cod-iva
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
      *              *-------------------------------------------------*
      *              * Livello 4 - Codice regione                      *
      *              *-------------------------------------------------*
           if        srt-cod-rgn          =    spaces
                     move  "(?)"          to   w-rot-l04-cod-rgn
           else      move  srt-cod-rgn    to   w-rot-l04-cod-rgn      .
      *              *-------------------------------------------------*
      *              * Livello 3 - Codice Iva                          *
      *              *-------------------------------------------------*
           move      srt-cod-iva          to   w-rot-l03-cod-iva      .
      *              *-------------------------------------------------*
      *              * Livello 2 - Tipo record                         *
      *              *-------------------------------------------------*
      ...
      *              * Normalizzazione totali                          *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-rgn-tot-ibl      .
           move      zero                 to   w-tot-rgn-tot-imp      .
       prn-ini-lr4-100.
      *              *-------------------------------------------------*
      *              * Stampa intestazione regione                     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      014                  to   p-pos                  .
           move      w-rot-l04-cod-rgn    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Descrizione regione                         *
      *                  *---------------------------------------------*
           move      w-rot-l04-cod-rgn    to   w-let-arc-gxr-cod      .
           perform   let-arc-gxr-000      thru let-arc-gxr-999        .
      *
           if        w-rot-l04-cod-rgn    =    "EST"
                     move  "(Stato estero)"
                                          to   w-let-arc-gxr-des      .
      *
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      25                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      019                  to   p-pos                  .
           move      w-let-arc-gxr-des    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-ini-lr4-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      077                  to   p-pos                  .
           move      w-tot-rgn-tot-ibl    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Imposta                                 *
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      100                  to   p-pos                  .
           move      w-tot-rgn-tot-imp    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-fin-lr4-999.
           exit.
      ...
      *
           add       srt-ibl-iva          to   w-tot-rgn-tot-ibl      .
           add       srt-imp-iva          to   w-tot-rgn-tot-imp      .
      *
      ...
      *
           subtract  srt-ibl-iva          from w-tot-rgn-tot-ibl      .
           subtract  srt-imp-iva          from w-tot-rgn-tot-imp      .
      *
