      ...
      *                       Ultima revisione:    NdK del 14/02/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma cge9670  *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      "NS"                 to   s-ope                  .
           move      zero                 to   s-dat                  .
           move      rr-ann-ivp           to   s-ann                  .
           move      01                   to   s-mes                  .
           move      01                   to   s-gio                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-saa                to   w-str-sec-ann          .
      *              *-------------------------------------------------*
      *              * Start per chiave 'ANNMESALI'                    *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "ANNMESALI "         to   f-key                  .
           move      w-str-sec-ann        to   rf-ivp-ann-ivp         .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Test su anno di competenza                      *
      *              *-------------------------------------------------*
           if        rf-ivp-ann-ivp       not  = w-str-sec-ann
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      15                   to   p-pos                  .
           move      rf-ivp-cod-iva       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Imponibile documenti (acquisti)         *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      11                   to   p-car                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      26                   to   p-pos                  .
           move      rf-ivp-ibl-acq       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Imposta documenti (acquisti)            *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      11                   to   p-car                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      44                   to   p-pos                  .
           move      rf-ivp-imp-acq       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Imponibile documenti (vendite)          *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      11                   to   p-car                  .
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Imponibile documenti (corrispettivi)    *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      11                   to   p-car                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      98                   to   p-pos                  .
           move      rf-ivp-ibl-cor       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Imposta documenti (corrispettivi)       *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      11                   to   p-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      01                   to   p-pos                  .
           move      "Anno   Mese   Aliquota      Imponibile         Imp
      -              "osta          Imponibile         Imposta          
      -              "Imponibile         Imposta"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
