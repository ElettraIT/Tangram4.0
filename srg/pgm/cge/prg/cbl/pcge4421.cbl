      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione richieste del programma pcge4420 *
      *                                                                *
      *                    Stampa estratti conto clienti a partite     *
      *                                                                *
      *================================================================*
      ...
      *            * - se tipo ordinamento : R => rf-cli-rag-key       *
      *            * - se tipo ordinamento : M => rf-cli-cod-mne       *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-tot-cli.
               10  w-tot-cli-tot          pic s9(13)                  .

      *    *===========================================================*
      *    * Work-area per routine int-pag-sta-000/999                 *
      *    *-----------------------------------------------------------*
       01  w-int-pag-sta.
           05  w-int-pag-sta-cli          pic  9(07)                  .
      ...
      *                  *---------------------------------------------*
           if        rr-tip-ord           =    "C"
                     ...
                     move  rf-cli-rag-key to   srt-key-ord
           else if   rr-tip-ord           =    "M"
                     move  rf-cli-cod-mne to   srt-key-ord
      ...
      *              *-------------------------------------------------*
      *              * Determinazione codice e ragione sociale cliente *
      *              * per intestazione pagina                         *
      *              *-------------------------------------------------*
           move      srt-cod-cli          to   w-int-pag-sta-cli      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "ARCRIF"             to   f-key                  .
           move      "C"                  to   rf-mgr-tip-arc         .
           move      srt-cod-cli          to   rf-mgr-cod-arc         .
      ...
      *              *-------------------------------------------------*
           if        rf-mgr-tip-arc       not  = "C"         or
                     rf-mgr-cod-arc       not  = srt-cod-cli or
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           string    "ESTRATTO CONTO CLIENTE AL "
                                delimited by size
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      37                   to   p-pos                  .
           move      w-int-pag-sta-cli    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Ragione sociale                             *
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "           Data reg.  Data e Nr. documento   Descr
