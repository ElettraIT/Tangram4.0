      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-via-fnt          pic  x(40)                  .
               10  w-rig-loc-fnt          pic  x(40)                  .
               10  w-rig-naz-fnt          pic  x(03)                  .
               10  w-rig-naz-fnt-des      pic  x(20)                  .
               10  w-rig-cmn-fnt          pic  9(05)                  .
               10  w-rig-cmn-fnt-des      pic  x(30)                  .
               10  w-rig-cmn-fnt-prv      pic  x(02)                  .
               10  w-rig-fzn-fnt          pic  9(03)                  .
               10  w-rig-fzn-fnt-des      pic  x(30)                  .
               10  w-rig-lct-fnt          pic  9(03)                  .
               10  w-rig-lct-fnt-des      pic  x(30)                  .
           05  w-rig-002.
      ...
      *                  * Editing Cap                                 *
      *                  *---------------------------------------------*
           move      w-rig-loc-fnt        to   w-lin-imm-cap-avp      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-naz-fnt        to   w-ind-cec-geo-naz      .
           move      w-rig-via-fnt        to   w-ind-cec-geo-ind      .
           move      16                   to   w-ind-cec-geo-lin      .
           move      22                   to   w-ind-cec-geo-pos      .
           move      w-rig-loc-fnt        to   w-ind-cec-geo-cec      .
           move      w-rig-cmn-fnt        to   w-ind-cec-geo-cmn      .
           move      w-rig-cmn-fnt-des    to   w-ind-cec-geo-dco      .
           move      w-rig-cmn-fnt-prv    to   w-ind-cec-geo-prv      .
           move      w-rig-fzn-fnt        to   w-ind-cec-geo-fzn      .
           move      w-rig-fzn-fnt-des    to   w-ind-cec-geo-dfr      .
           move      w-rig-lct-fnt        to   w-ind-cec-geo-lct      .
           move      w-rig-lct-fnt-des    to   w-ind-cec-geo-dlo      .
           move      spaces               to   v-edm                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "INSR"               to   v-pfk (04)             .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-ind-cec-geo-ind    to   w-rig-via-fnt          .
      *              *-------------------------------------------------*
      ...
      *                  * C.a.p. e citta'                             *
      *                  *---------------------------------------------*
           move      w-ind-cec-geo-cec    to   w-rig-loc-fnt          .
           perform   vis-loc-fnt-000      thru vis-loc-fnt-999        .
      *                  *---------------------------------------------*
      *                  * Comune                                      *
      *                  *---------------------------------------------*
           move      w-ind-cec-geo-cmn    to   w-rig-cmn-fnt          .
           move      w-ind-cec-geo-dco    to   w-rig-cmn-fnt-des      .
           move      w-ind-cec-geo-prv    to   w-rig-cmn-fnt-prv      .
           perform   vis-rig-cmn-000      thru vis-rig-cmn-999        .
           perform   vis-rig-cmn-des-000  thru vis-rig-cmn-des-999    .
           perform   vis-rig-cmn-prv-000  thru vis-rig-cmn-prv-999    .
      *                  *---------------------------------------------*
      *                  * Frazione                                    *
      *                  *---------------------------------------------*
           move      w-ind-cec-geo-fzn    to   w-rig-fzn-fnt          .
           move      w-ind-cec-geo-dfr    to   w-rig-fzn-fnt-des      .
           perform   vis-rig-fzn-000      thru vis-rig-fzn-999        .
           perform   vis-rig-fzn-des-000  thru vis-rig-fzn-des-999    .
      *                  *---------------------------------------------*
      *                  * Localita'                                   *
      *                  *---------------------------------------------*
           move      w-ind-cec-geo-lct    to   w-rig-lct-fnt          .
           move      w-ind-cec-geo-dlo    to   w-rig-lct-fnt-des      .
           perform   vis-rig-lct-000      thru vis-rig-lct-999        .
           perform   vis-rig-lct-des-000  thru vis-rig-lct-des-999    .
       acc-via-fnt-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-naz-fnt        to   w-cap-cit-geo-naz      .
           move      w-rig-loc-fnt        to   w-cap-cit-geo-cec      .
           move      17                   to   w-cap-cit-geo-lin      .
           move      22                   to   w-cap-cit-geo-pos      .
           move      w-rig-cmn-fnt        to   w-cap-cit-geo-cmn      .
           move      w-rig-cmn-fnt-des    to   w-cap-cit-geo-dco      .
           move      w-rig-cmn-fnt-prv    to   w-cap-cit-geo-prv      .
           move      w-rig-fzn-fnt        to   w-cap-cit-geo-fzn      .
           move      w-rig-fzn-fnt-des    to   w-cap-cit-geo-dfr      .
           move      w-rig-lct-fnt        to   w-cap-cit-geo-lct      .
           move      w-rig-lct-fnt-des    to   w-cap-cit-geo-dlo      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cap-cit-geo-cec    to   w-rig-loc-fnt          .
      *              *-------------------------------------------------*
      *              * Altri valori se automatismo eseguito            *
      *              *-------------------------------------------------*
      ...
      *                  * Comune                                      *
      *                  *---------------------------------------------*
           move      w-cap-cit-geo-cmn    to   w-rig-cmn-fnt          .
           move      w-cap-cit-geo-dco    to   w-rig-cmn-fnt-des      .
           move      w-cap-cit-geo-prv    to   w-rig-cmn-fnt-prv      .
           perform   vis-rig-cmn-000      thru vis-rig-cmn-999        .
           perform   vis-rig-cmn-des-000  thru vis-rig-cmn-des-999    .
           perform   vis-rig-cmn-prv-000  thru vis-rig-cmn-prv-999    .
      *                  *---------------------------------------------*
      *                  * Frazione                                    *
      *                  *---------------------------------------------*
           move      w-cap-cit-geo-fzn    to   w-rig-fzn-fnt          .
           move      w-cap-cit-geo-dfr    to   w-rig-fzn-fnt-des      .
           perform   vis-rig-fzn-000      thru vis-rig-fzn-999        .
           perform   vis-rig-fzn-des-000  thru vis-rig-fzn-des-999    .
      *                  *---------------------------------------------*
      *                  * Localita'                                   *
      *                  *---------------------------------------------*
           move      w-cap-cit-geo-lct    to   w-rig-lct-fnt          .
           move      w-cap-cit-geo-dlo    to   w-rig-lct-fnt-des      .
           perform   vis-rig-lct-000      thru vis-rig-lct-999        .
           perform   vis-rig-lct-des-000  thru vis-rig-lct-des-999    .
       acc-loc-fnt-400.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       vis-rig-naz-des-000.
           ...
           move      18                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      w-rig-naz-fnt-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-naz-des-999.
           exit.
      ...
      *                  * Test se campo da accettare                  *
      *                  *---------------------------------------------*
           if        w-rig-naz-fnt        not  = "IT "
                     go to acc-rig-cmn-999.
       acc-rig-cmn-050.
      *                  *---------------------------------------------*
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-cmn-fnt        to   w-sav-cod-cmn          .
       acc-rig-cmn-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-com-geo-ope      .
           move      w-rig-cmn-fnt        to   w-cod-com-geo-cmn      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cod-com-geo-cmn    to   w-rig-cmn-fnt          .
       acc-rig-cmn-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "C"                  to   w-let-arc-gxc-tip      .
           move      w-rig-cmn-fnt        to   w-let-arc-gxc-cmn      .
           move      zero                 to   w-let-arc-gxc-fzn      .
           move      zero                 to   w-let-arc-gxc-lct      .
           perform   let-arc-gxc-000      thru let-arc-gxc-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati letti                   *
      *                  *---------------------------------------------*
           move      w-let-arc-gxc-des    to   w-rig-cmn-fnt-des      .
           move      w-let-arc-gxc-prv    to   w-rig-cmn-fnt-prv      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-cmn-des-000  thru vis-rig-cmn-des-999    .
      ...
      *                  * Test se valore cambiato oppure no           *
      *                  *---------------------------------------------*
           if        w-rig-cmn-fnt        =    w-sav-cod-cmn
      ...
      *                          * Frazione                            *
      *                          *-------------------------------------*
           if        w-rig-fzn-fnt        =    zero
                     go to acc-rig-cmn-654.
           move      zero                 to   w-rig-fzn-fnt          .
           move      spaces               to   w-rig-fzn-fnt-des      .
           perform   vis-rig-fzn-000      thru vis-rig-fzn-999        .
           perform   vis-rig-fzn-des-000  thru vis-rig-fzn-des-999    .
       acc-rig-cmn-654.
      *                          *-------------------------------------*
      *                          * Localita'                           *
      *                          *-------------------------------------*
           if        w-rig-lct-fnt        =    zero
                     go to acc-rig-cmn-656.
           move      zero                 to   w-rig-lct-fnt          .
           move      spaces               to   w-rig-lct-fnt-des      .
           perform   vis-rig-lct-000      thru vis-rig-lct-999        .
           perform   vis-rig-lct-des-000  thru vis-rig-lct-des-999    .
       acc-rig-cmn-656.
      *                      *-----------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       vis-rig-cmn-des-000.
           ...
           move      19                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      w-rig-cmn-fnt-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-cmn-des-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       vis-rig-cmn-prv-000.
           ...
           move      19                   to   v-lin                  .
           move      69                   to   v-pos                  .
           move      w-rig-cmn-fnt-prv    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-cmn-prv-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           if        w-rig-cmn-fnt        =    zero
                     go to acc-rig-fzn-999.
       acc-rig-fzn-050.
      *                  *---------------------------------------------*
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      w-rig-fzn-fnt        to   w-sav-cod-fzn          .
       acc-rig-fzn-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-fra-geo-ope      .
           move      w-rig-cmn-fnt        to   w-cod-fra-geo-cmn      .
           move      w-rig-fzn-fnt        to   w-cod-fra-geo-fzn      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cod-fra-geo-fzn    to   w-rig-fzn-fnt          .
       acc-rig-fzn-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "F"                  to   w-let-arc-gxc-tip      .
           move      w-rig-cmn-fnt        to   w-let-arc-gxc-cmn      .
           move      w-rig-fzn-fnt        to   w-let-arc-gxc-fzn      .
           move      zero                 to   w-let-arc-gxc-lct      .
           perform   let-arc-gxc-000      thru let-arc-gxc-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati letti                   *
      *                  *---------------------------------------------*
           move      w-let-arc-gxc-des    to   w-rig-fzn-fnt-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-fzn-des-000  thru vis-rig-fzn-des-999    .
      ...
      *                  * Test se valore cambiato oppure no           *
      *                  *---------------------------------------------*
           if        w-rig-fzn-fnt        =    w-sav-cod-fzn
      ...
      *    *-----------------------------------------------------------*
       vis-rig-fzn-des-000.
           ...
           move      20                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      w-rig-fzn-fnt-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-fzn-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-loc-geo-ope      .
           move      w-rig-cmn-fnt        to   w-cod-loc-geo-cmn      .
           move      w-rig-fzn-fnt        to   w-cod-loc-geo-fzn      .
           move      w-rig-lct-fnt        to   w-cod-loc-geo-lct      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      w-cod-loc-geo-lct    to   w-rig-lct-fnt          .
       acc-rig-lct-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-cmn-fnt        to   w-let-arc-gxc-cmn      .
           move      w-rig-fzn-fnt        to   w-let-arc-gxc-fzn      .
           move      w-rig-lct-fnt        to   w-let-arc-gxc-lct      .
           perform   let-arc-gxc-000      thru let-arc-gxc-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione dati letti                   *
      *                  *---------------------------------------------*
           move      w-let-arc-gxc-des    to   w-rig-lct-fnt-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rig-lct-des-000  thru vis-rig-lct-des-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-lct-des-000.
           ...
           move      21                   to   v-lin                  .
           move      36                   to   v-pos                  .
           move      w-rig-lct-fnt-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-lct-des-999.
           exit.
      ...
      *                      * Codice comune                           *
      *                      *-----------------------------------------*
           if        w-rig-naz-fnt        =    spaces
                     move  zero           to   w-rig-cmn-fnt          .
      *                      *-----------------------------------------*
      *                      * Codice frazione                         *
      *                      *-----------------------------------------*
           if        w-rig-cmn-fnt        =    zero
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-rig-via-fnt          .
           move      spaces               to   w-rig-loc-fnt          .
           move      spaces               to   w-rig-naz-fnt          .
           move      spaces               to   w-rig-naz-fnt-des      .
           move      zero                 to   w-rig-cmn-fnt          .
           move      spaces               to   w-rig-cmn-fnt-des      .
           move      spaces               to   w-rig-cmn-fnt-prv      .
           move      zero                 to   w-rig-fzn-fnt          .
           move      spaces               to   w-rig-fzn-fnt-des      .
           move      zero                 to   w-rig-lct-fnt          .
           move      spaces               to   w-rig-lct-fnt-des      .
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-fnt-cod-naz       not  = w-tes-cod-naz
      ...
      *                      *-----------------------------------------*
           move      rf-fnt-loc-fnt       to   w-sel-rec-fnt-cap      .
           if        w-sel-rec-fnt-cap    not  = w-tes-cap-avp
                     go to sel-rec-fnt-900.
       sel-rec-fnt-300.
      *                  *---------------------------------------------*
      *                  * Codice comune                               *
      *                  *---------------------------------------------*
           ...
           if        rf-fnt-cod-cmn       not  = w-tes-cod-cmn
                     go to sel-rec-fnt-900.
       sel-rec-fnt-400.
      *                  *---------------------------------------------*
      *                  * Codice frazione                             *
      *                  *---------------------------------------------*
           ...
           if        rf-fnt-cod-fzn       not  = w-tes-cod-fzn
                     go to sel-rec-fnt-900.
       sel-rec-fnt-500.
      *                  *---------------------------------------------*
      *                  * Codice localita'                            *
      *                  *---------------------------------------------*
           if        w-tes-cod-lct        =    zero
                     go to sel-rec-fnt-800.
           if        rf-fnt-cod-lct       not  = w-tes-cod-lct
                     go to sel-rec-fnt-900.
       sel-rec-fnt-800.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-fnt-via-fnt       to   w-rig-via-fnt          .
           move      rf-fnt-loc-fnt       to   w-rig-loc-fnt          .
           move      rf-fnt-cod-naz       to   w-rig-naz-fnt          .
           move      rf-fnt-cod-cmn       to   w-rig-cmn-fnt          .
           move      rf-fnt-cod-fzn       to   w-rig-fzn-fnt          .
           move      rf-fnt-cod-lct       to   w-rig-lct-fnt          .
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-rig-naz-fnt        to   w-let-arc-gxn-cod      .
           perform   let-arc-gxn-000      thru let-arc-gxn-999        .
           move      w-let-arc-gxn-des    to   w-rig-naz-fnt-des      .
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-rig-via-fnt        to   rf-fnt-via-fnt         .
           move      w-rig-loc-fnt        to   rf-fnt-loc-fnt         .
           move      w-rig-naz-fnt        to   rf-fnt-cod-naz         .
           move      w-rig-cmn-fnt        to   rf-fnt-cod-cmn         .
           move      w-rig-fzn-fnt        to   rf-fnt-cod-fzn         .
           move      w-rig-lct-fnt        to   rf-fnt-cod-lct         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
