      ...
      *            *---------------------------------------------------*
               10  srt-rec-mgi.
                   15  filler occurs 1536 pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "CONTROLLO PROGRESSIONE FATTURE ACQUISTO "       .
      ...
      *        *-------------------------------------------------------*
           05  w-det-cnf-rec.
      *            *---------------------------------------------------*
      *            * Giornale Iva di comodo                            *
      *            *---------------------------------------------------*
               10  w-det-cnf-rec-gio      pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Protocollo Iva di comodo                          *
      *            *---------------------------------------------------*
               10  w-det-cnf-rec-prt      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Data registrazione di comodo                      *
      *            *---------------------------------------------------*
               10  w-det-cnf-rec-dat      pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-det-cnf-rec-gio      .          
           move      zero                 to   w-det-cnf-rec-prt      .          
           move      zero                 to   w-det-cnf-rec-dat      .          
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      ...
      *                  * Protocollo Iva                              *
      *                  *---------------------------------------------*
           move      rf-mgi-prt-iva       to   srt-prt-iva            .
      *                  *---------------------------------------------*
      *                  * Un intero record [mgi]                      *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Test su progressione protocollo Iva             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se codice numerazione cambiato         *
      *                  *---------------------------------------------*
           if        rf-mgi-cod-num       not  = w-det-cnf-rec-gio
                     move  rf-mgi-cod-num to   w-det-cnf-rec-gio
                     move  rf-mgi-prt-iva to   w-det-cnf-rec-prt
                     move  rf-mgi-dat-reg to   w-det-cnf-rec-dat
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *                  *---------------------------------------------*
      *                  * Test se protocollo Iva di comodo a zero     *
      *                  *---------------------------------------------*
           if        w-det-cnf-rec-prt    =    zero
                     move  rf-mgi-prt-iva to   w-det-cnf-rec-prt
                     move  rf-mgi-dat-reg to   w-det-cnf-rec-dat
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *                  *---------------------------------------------*
      *                  * Incremento protocollo Iva di comodo         *
      *                  *---------------------------------------------*
           add       1                    to   w-det-cnf-rec-prt      .
      *                  *---------------------------------------------*
      *                  * Confronto con protocollo Iva di comodo      *
      *                  *---------------------------------------------*
           if        rf-mgi-prt-iva       =    w-det-cnf-rec-prt
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *                  *---------------------------------------------*
      *                  * Confronto con data registrazione di comodo  *
      *                  *---------------------------------------------*
           if        rf-mgi-dat-reg       <    w-det-cnf-rec-dat
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "DOCUMENTI CON INCONGRUENZE DI PROGRESSIONE"
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "Data reg  Pr. cge    Data doc  Numero doc  Codice 
      -              "              Note            "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
