      ...
      *                                   Fase:    cge210              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 01/10/90    *
      *                       Ultima revisione:    NdK del 14/11/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella Sezioni per bilancio       *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice sezione                *
      *    *-----------------------------------------------------------*
       pmt-cod-sez-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice sezione                *
      *    *-----------------------------------------------------------*
       acc-cod-sez-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice sezione             *
      *    *-----------------------------------------------------------*
       vis-cod-sez-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  * Descrizione                                 *
      *                  *---------------------------------------------*
           perform   acc-des-sez-000      thru acc-des-sez-999        .
      ...
      *              * Descrizione                                     *
      *              *-------------------------------------------------*
           perform   pmt-des-sez-000      thru pmt-des-sez-999        .
       pmt-tes-reg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-des-sez (1)      .
       nor-nok-tes-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-sez        to   rf-zsz-cod-sez         .
           move      "pgm/cge/fls/ioc/obj/iofzsz"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zsz]                        *
      *                          *-------------------------------------*
           move      rf-zsz-des-sez       to   w-tes-des-sez (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zsz]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zsz-000      thru wrt-rec-zsz-999        .
      ...
      *                      * Rewrite record [zsz]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zsz-000      thru rew-rec-zsz-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zsz]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zsz-000      thru del-rec-zsz-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zsz]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zsz-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-sez (1)    to   rf-zsz-des-sez         .
       cmp-rec-zsz-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zsz]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zsz-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zsz-000      thru cmp-rec-zsz-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
