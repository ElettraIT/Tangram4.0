      ...
      *    *-----------------------------------------------------------*
       01  w-sad.
      *        *-------------------------------------------------------*
      *        * Codice fornitore di cui si vuole ottenere il saldo    *
      *        *-------------------------------------------------------*
           05  w-sad-cod-fnt              pic  9(07)                  .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rr-cod-arc           to   w-sad-cod-fnt          .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Titolo : 'PARTITARIO MOVIMENTI FORNITORE'       *
      *              *-------------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      v-lnr                to   v-lin                  .
           move      26                   to   v-pos                  .
           move      "PARTITARIO MOVIMENTI FORNITORE"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "F"                  to   rf-mgs-tip-rec         .
           move      w-sad-cod-fnt        to   rf-mgs-cod-con         .
      *                      *-----------------------------------------*
      *                      * Lettura file [mgs]                      *
      *                      *-----------------------------------------*
           move      "RD"                 to   f-ope                  .
      ...
      *    *         - w-sad-cod-fnt : codice fornitore di cui si vuole*
      *    *                           ottenere il saldo               *
      ...
      *                  *---------------------------------------------*
           move      "F"                  to   rf-mgr-tip-arc         .
           move      w-sad-cod-fnt        to   rf-mgr-cod-arc         .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-mgr-tip-arc        not  = "F"           or
                     rf-mgr-cod-arc        not  = w-sad-cod-fnt
                     go to  det-sdo-dat-900.
      *                  *---------------------------------------------*
      *                  * Data registrazione                          *
      *                  *---------------------------------------------*
