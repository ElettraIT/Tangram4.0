      ...
      *                       Ultima revisione:    NdK del 20/01/10    *
      *                    ------------------------------------------- *
      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase cge450, nella sua globalita', esegue i tipi di manu-   *
      ...
      *                                                                *
      * MANNTI      Manutenzione Numeri di utenza, interlocutori       *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'cge450'           *
      *              *-------------------------------------------------*
           perform   fas-cge-450-000      thru fas-cge-450-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Personalizzazione relativa al record cli-   *
      *                  * ente                                        *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Lettura delle personalizzazioni relative al record cli-   *
      *    * ente                                                      *
      *    *-----------------------------------------------------------*
       prs-rec-cli-000.
      *              *-------------------------------------------------*
      ...
      *
           move      "Numeri di utenza e interlocutori                  
      -              " MANNTI     pcge450b  "
                                          to   w-tmn-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-cge-450-300
           else if   v-key                =    "PRSC"
                     go to fas-cge-450-400
           else if   v-key                =    "NXSC"
                     go to fas-cge-450-450
           else if   v-key                =    "DOWN"
                     go to fas-cge-450-500
           else if   v-key                =    "EXIT"
                     go to fas-cge-450-250
           else      go to fas-cge-450-200.
       fas-cge-450-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-man        =    zero
                     go to fas-cge-450-330.
           move      zero                 to   w-tmn-ele-inx          .
       fas-cge-450-322.
           add       1                    to   w-tmn-ele-inx          .
           if        w-tmn-ele-inx        >    w-tmn-ele-num
                     go to fas-cge-450-340.
           if        w-tmn-num-tmn
                    (w-tmn-ele-inx)       =    w-key-num-man
                     go to fas-cge-450-350
           else      go to fas-cge-450-322.
       fas-cge-450-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-cge-450-630
           else if   v-key                =    "PRSC"
                     go to fas-cge-450-600
           else if   v-key                =    "NXSC"
                     go to fas-cge-450-610
           else if   v-key                =    "UP  "
                     go to fas-cge-450-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-cge-450-650
           else if   v-key                =    "EXIT"
                     go to fas-cge-450-660
           else      go to fas-cge-450-570.
       fas-cge-450-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-cge-450-626
           else      go to fas-cge-450-628.
       fas-cge-450-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-cge-450-636
           else      go to fas-cge-450-638.
       fas-cge-450-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-cge-450-725
           else      go to fas-cge-450-750.
       fas-cge-450-725.
      *              *-------------------------------------------------*
