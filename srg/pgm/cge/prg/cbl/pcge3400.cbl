      ...
      *                                   Fase:    cge340              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/02/95    *
      *                       Ultima revisione:    NdK del 18/09/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge3401:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-stp.
               ...
               10  w-exp-tip-stp-tbl.
                   ...
                   15  filler             pic  x(48) value
                    "Esportazione dati di bilancio su archivio       ".
      *        *-------------------------------------------------------*
      ...
      *                  * Si/No rettifiche extracontabili             *
      *                  *---------------------------------------------*
           perform   acc-snx-rec-000      thru acc-snx-rec-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Data bilancio infrannuale  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      12                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "La stampa deve tener conto :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *
           ...
           move      14                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " extracontabili registrate  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Si/No rettifiche extra-    *
      *    *                                contabili                  *
      *    *-----------------------------------------------------------*
       acc-snx-rec-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-rec-999.
       acc-snx-rec-300.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-snx-rec             .
       acc-snx-rec-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
