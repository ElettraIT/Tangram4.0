      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma cge032   *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           ...
           05  rr-cod-min                 pic  9(03)                  .
           05  rr-cod-max                 pic  9(03)                  .
           05  rr-mne-min                 pic  x(03)                  .
           05  rr-mne-max                 pic  x(03)                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zcc-cod-cau         .
           move      "pgm/cge/fls/ioc/obj/iofzcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-zcc-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-mne-min           to   rf-zcc-mne-cau         .
           move      zero                 to   rf-zcc-cod-cau         .
           move      "pgm/cge/fls/ioc/obj/iofzcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zcc]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/cge/fls/ioc/obj/iofzcc"
                                          to   s-pat                  .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zcc-cod-cau       <    rr-cod-min or
                     rf-zcc-cod-cau       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zcc-des-key       <    rr-des-min or
                     rf-zcc-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zcc-mne-cau       <    rr-mne-min or
                     rf-zcc-mne-cau       >    rr-mne-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *
           if        rf-zcc-snx-bil       =    "S"
                     move  "Movimento di rettifica al bilancio     "
                                          to   p-alf
           else if   rf-zcc-snx-bil       =    "X"
                     move  "Movimento di chiusura/apertura bilancio"
                                          to   p-alf
           else if   rf-zcc-tip-moi       =    "0"
                     move  "[non Iva]"    to   p-alf
           else if   rf-zcc-tip-moi       =    "1"
                     move  "Dare clienti italiani o esteri non CEE  "
                                          to   p-alf
           else if   rf-zcc-tip-moi       =    "2"
                     move  "Avere clienti italiani o esteri non CEE "
                                          to   p-alf
           else if   rf-zcc-tip-moi       =    "3"
                     move  "Corrispettivi                           "
                                          to   p-alf
           else if   rf-zcc-tip-moi       =    "4"
                     move  "Dare fornitori italiani                 "
                                          to   p-alf
           else if   rf-zcc-tip-moi       =    "5"
                     move  "Avere fornitori italiani                "
                                          to   p-alf
           else if   rf-zcc-tip-moi       =    "6"
                     move  "Bolla doganale                          "
                                          to   p-alf
           else if   rf-zcc-tip-moi       =    "A"
                     move  "Dare clienti esteri in ambito CEE       "
                                          to   p-alf
           else if   rf-zcc-tip-moi       =    "B"
                     move  "Avere clienti esteri in ambito CEE      "
                                          to   p-alf
           else if   rf-zcc-tip-moi       =    "D"
                     move  "Dare fornitori CEE o Reverse Charge     "
                                          to   p-alf
           else if   rf-zcc-tip-moi       =    "E"
                     move  "Avere fornitori CEE o Reverse Charge    "
                                          to   p-alf
      ...
      *                  *---------------------------------------------*
           ...
           move      83                   to   p-pos                  .
      *
           if        rf-zcc-tip-doc       =    spaces
                     move  spaces         to   p-alf
           else if   rf-zcc-tip-doc       =    "F"
                     move  "Fattura             "
                                          to   p-alf
           else if   rf-zcc-tip-doc       =    "M"
                     move  "Fattura CEE merce   "
                                          to   p-alf
           else if   rf-zcc-tip-doc       =    "S"
                     move  "Fattura CEE servizi "
                                          to   p-alf
           else if   rf-zcc-tip-doc       =    "D"
                     move  "Nota di debito      "
                                          to   p-alf
           else if   rf-zcc-tip-doc       =    "C"
                     move  "Nota di credito     "
                                          to   p-alf
           else      move  zero           to   p-alf                  .
      *
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-999.
