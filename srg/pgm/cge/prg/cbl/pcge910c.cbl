      ...
      *                       Ultima revisione:    NdK del 28/03/25    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Controllo incrociato tra saldi desunti da:  *
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     " CONTROLLO INCROCIATO SALDI / MOVIMENTI "       .
      ...
      *              *-------------------------------------------------*
      *              * Lettura personalizzazione per mese di chiusura  *
      *              * esercizio                                       *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Lettura personalizzazione per mese di chiusura esercizio  *
      *    *-----------------------------------------------------------*
       prs-mes-chi-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   stp-srt-inp-pdc-000  thru  stp-srt-inp-pdc-999   .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-cli-520.
           add       1                    to   w-det-dif-cge-ctr      .
           if        w-det-dif-cge-ctr    >    24
                     go to stp-srt-inp-cli-800.
      *                  *---------------------------------------------*
      *                  * Determinazione differenze                   *
      *                  *---------------------------------------------*
           perform   det-dif-cge-000      thru det-dif-cge-999        .
           if        w-det-dif-cge-flg    =    spaces
                     go to stp-srt-inp-cli-750.
       stp-srt-inp-cli-600.
      *              *-------------------------------------------------*
      *              * Composizione record di sort                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       stp-srt-inp-fnt-520.
           add       1                    to   w-det-dif-cge-ctr      .
           if        w-det-dif-cge-ctr    >    24
                     go to stp-srt-inp-fnt-800.
      *                  *---------------------------------------------*
      *                  * Determinazione differenze                   *
      *                  *---------------------------------------------*
           perform   det-dif-cge-000      thru det-dif-cge-999        .
           if        w-det-dif-cge-flg    =    spaces
                     go to stp-srt-inp-fnt-750.
       stp-srt-inp-fnt-600.
      *              *-------------------------------------------------*
      *              * Composizione record di sort                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-prs-mes-chi        =    12
                     perform det-sdo-cge-std-000
                                          thru det-sdo-cge-std-999
           else      perform det-sdo-cge-nst-000
                                          thru det-sdo-cge-nst-999    .
       det-sdo-cge-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-sdo-cge-ese    to   rf-mgs-ann-ese         .
      ...
      *              *-------------------------------------------------*
           move      rr-ann-ese           to   w-det-sdo-cge-ese      .
           perform   det-sdo-cge-nor-000  thru det-sdo-cge-nor-999    .
       det-sdo-cge-std-400.
      *              *-------------------------------------------------*
      *              * Bufferizzazione                                 *
      *              *-------------------------------------------------*
       ...
       det-sdo-cge-std-420.
           add       1                    to   w-det-sdo-cge-ctr      .
           if        w-det-sdo-cge-ctr    >    12
                     go to  det-sdo-cge-std-900.
           if        w-det-sdo-cge-ctr    <    rr-mes-ini
                     go to  det-sdo-cge-std-420.
      ...
      *    * Preparazione saldo da contabilita'                        *
      *    *                                                           *
      *    * Esercizi con chiusura NON a fine anno                     *
      *    *-----------------------------------------------------------*
       det-sdo-cge-nst-000.
      *              *-------------------------------------------------*
      *              * In base al mese di chiusura si determina        *
      *              * l'indicatore relativo alla I scheda saldi da    *
      *              * leggere                                         *
      *              *-------------------------------------------------*
           move      12                   to   w-det-sdo-cge-inx      .
           subtract  w-prs-mes-chi        from w-det-sdo-cge-inx      .
       det-sdo-cge-nst-100.
      *              *-------------------------------------------------*
      *              * Normalizzazione e lettura I scheda              *
      *              *-------------------------------------------------*
           move      rr-ann-ese           to   w-det-sdo-cge-ese      .
           subtract  1                    from w-det-sdo-cge-ese      .
           perform   det-sdo-cge-nor-000  thru det-sdo-cge-nor-999    .
       det-sdo-cge-nst-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione                                 *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-sdo-cge-ctr      .
       det-sdo-cge-nst-220.
           add       1                    to   w-det-sdo-cge-inx      .
           add       1                    to   w-det-sdo-cge-ctr      .
           if        w-det-sdo-cge-ctr    >    12 or
                     w-det-sdo-cge-inx    >    12
                     go to  det-sdo-cge-nst-300.
           if        w-det-sdo-cge-ctr    <    rr-mes-ini
                     go to  det-sdo-cge-nst-220.
           if        w-det-sdo-cge-ctr    >    rr-mes-fin
                     go to  det-sdo-cge-nst-300.
           move      rf-mgs-dar-mes
                    (w-det-sdo-cge-inx)   to   w-det-sdo-cge-dar
                                              (w-det-sdo-cge-ctr)     .
           move      rf-mgs-ave-mes
                    (w-det-sdo-cge-inx)   to   w-det-sdo-cge-ave
                                              (w-det-sdo-cge-ctr)     .
           go to     det-sdo-cge-nst-220.
       det-sdo-cge-nst-300.
      *              *-------------------------------------------------*
      *              * Normalizzazione e lettura II scheda             *
      *              *-------------------------------------------------*
           move      rr-ann-ese           to   w-det-sdo-cge-ese      .
           perform   det-sdo-cge-nor-000  thru det-sdo-cge-nor-999    .
       det-sdo-cge-nst-400.
      ...
      *              * Bufferizzazione                                 *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-sdo-cge-inx      .
           subtract  1                    from w-det-sdo-cge-ctr      .
       det-sdo-cge-nst-420.
           add       1                    to   w-det-sdo-cge-ctr      .
           add       1                    to   w-det-sdo-cge-inx      .
           if        w-det-sdo-cge-ctr    >    12 or
                     w-det-sdo-cge-inx    >    w-prs-mes-chi
                     go to  det-sdo-cge-nst-900.
           if        w-det-sdo-cge-inx    <    rr-mes-ini
                     go to  det-sdo-cge-nst-420.
           if        w-det-sdo-cge-inx    >    rr-mes-fin
                     go to  det-sdo-cge-nst-900.
           move      rf-mgs-dar-mes
                    (w-det-sdo-cge-inx)   to   w-det-sdo-cge-dar
                                              (w-det-sdo-cge-ctr)     .
      ...
      *                  *---------------------------------------------*
           subtract  12                   from w-det-dif-cge-ctr
                                        giving w-det-dif-cge-in1      .
      *
           subtract  12                   from w-det-dif-cge-ctr
                                        giving w-det-dif-cge-in2      .
      *
      ...
      *              *-------------------------------------------------*
           move      "CONTROLLO INCROCIATO TRA SALDI CONTABILI E RIGHE M
      -              "OVIMENTI DI PRIMA NOTA"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      " T              Codice e descrizione conto        
