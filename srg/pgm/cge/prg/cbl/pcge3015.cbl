      ...
      *                       Ultima revisione:    NdK del 15/05/03    *
      *                    ------------------------------------------- *
      ...
      *              *-------------------------------------------------*
           move      rr-cod-arc           to   w-sad-cod-cli          .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Titolo : 'PARTITARIO MOVIMENTI CLIENTE'         *
      *              *-------------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      v-lnr                to   v-lin                  .
           move      27                   to   v-pos                  .
           move      "PARTITARIO MOVIMENTI CLIENTE"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se il bilancio dell'esercizio relativo alla *
      *                  * data richiesta non e' stato ancora chiuso : *
      *                  * stesso funzionamento come per data non di   *
      *                  * fine esercizio                              *
      *                  *---------------------------------------------*
