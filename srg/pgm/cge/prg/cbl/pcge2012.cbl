      ...
      *                                   Fase:    cge201              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 15/10/90    *
      *                       Ultima revisione:    NdK del 30/04/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su tabella [cgecon]          *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-ipc.
      *        *-------------------------------------------------------*
      *        * Variabili di i.p.c. globali                           *
      *        *-------------------------------------------------------*
           05  w-ipc-glo.
      *            *---------------------------------------------------*
      *            * Per si/no Save/restore                            *
      *            *---------------------------------------------------*
               10  w-ipc-glo-sav-rst      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Variabili di i.p.c. da livello precedente             *
      *        *-------------------------------------------------------*
           05  w-ipc-dlp.
      *            *---------------------------------------------------*
      *            * Per si/no Tasto Slct ammesso                      *
      *            *---------------------------------------------------*
               10  w-ipc-dlp-snx-slc      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Per codice mastro/conto/sottoconto                *
      *            *---------------------------------------------------*
               10  w-ipc-dlp-cod-pdc      pic  9(07)                  .
               10  w-ipc-dlp-cod-pdr redefines
                   w-ipc-dlp-cod-pdc.
                   15  w-ipc-dlp-cod-mas  pic  9(02)                  .
                   15  w-ipc-dlp-cod-con  pic  9(02)                  .
                   15  w-ipc-dlp-cod-stc  pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Variabili di i.p.c. per livello precedente            *
      *        *-------------------------------------------------------*
           05  w-ipc-plp.
      *            *---------------------------------------------------*
      *            * Per codice mastro/conto/sottoconto                *
      *            *---------------------------------------------------*
               10  w-ipc-plp-cod-pdc      pic  9(07)                  .
               10  w-ipc-plp-cod-pdr redefines
                   w-ipc-plp-cod-pdc.
                   15  w-ipc-plp-cod-mas  pic  9(02)                  .
                   15  w-ipc-plp-cod-con  pic  9(02)                  .
                   15  w-ipc-plp-cod-stc  pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Variabili di i.p.c. per livello successivo            *
      *        *-------------------------------------------------------*
           05  w-ipc-pls.
      *            *---------------------------------------------------*
      *            * Per codice mastro/conto/sottoconto                *
      *            *---------------------------------------------------*
               10  w-ipc-pls-cod-pdc      pic  9(07)                  .
               10  w-ipc-pls-cod-pdr redefines
                   w-ipc-pls-cod-pdc.
                   15  w-ipc-pls-cod-mas  pic  9(02)                  .
                   15  w-ipc-pls-cod-con  pic  9(02)                  .
                   15  w-ipc-pls-cod-stc  pic  9(03)                  .
      *        *-------------------------------------------------------*
      *        * Variabili di i.p.c. da livello successivo             *
      *        *-------------------------------------------------------*
           05  w-ipc-dls.
      *            *---------------------------------------------------*
      *            * Per codice mastro/conto/sottoconto                *
      *            *---------------------------------------------------*
               10  w-ipc-dls-cod-pdc      pic  9(07)                  .
               10  w-ipc-dls-cod-pdr redefines
                   w-ipc-dls-cod-pdc.
                   15  w-ipc-dls-cod-mas  pic  9(02)                  .
                   15  w-ipc-dls-cod-con  pic  9(02)                  .
                   15  w-ipc-dls-cod-stc  pic  9(03)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-mpn.
           ...
           05  w-mpn-cod-pdr redefines
               w-mpn-cod-pdc.
               10  w-mpn-cod-mas          pic  9(02)                  .
               10  w-mpn-cod-con          pic  9(02)                  .
               10  w-mpn-cod-stc          pic  9(03)                  .

      *    *===========================================================*
      *    * Work per descrizioni                                      *
      *    *-----------------------------------------------------------*
       01  w-des.
      *        *-------------------------------------------------------*
      *        * Descrizione per codice mastro                         *
      *        *-------------------------------------------------------*
           05  w-des-cod-mas              pic  x(40)                  .
      ...
      *    *-----------------------------------------------------------*
       dic-ini-pgm-000.
      *              *-------------------------------------------------*
      *              * Lettura della variabile di i.p.c. globale per   *
      *              * determinare se e' necessario il Save iniziale   *
      *              * dell' immagine del video                        *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
           move      "sav-rst"            to   s-var                  .
           move      "G"                  to   s-dop                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces and
                     s-alf                =    "N"
                     move  spaces         to   w-ipc-glo-sav-rst
           else      move  "S"            to   w-ipc-glo-sav-rst      .
      *              *-------------------------------------------------*
      *              * Sigla funzione                                  *
      *              *-------------------------------------------------*
           move      "P+"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
      *              * Flag di save video in funzione della variabile  *
      *              * di i.p.c. 'sav-rst'                             *
      *              *-------------------------------------------------*
           move      w-ipc-glo-sav-rst    to   s-svv                  .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Determinazione variabile di i.p.c. da livello   *
      *              * precedente per determinazione ammissibilita'    *
      *              * tasto Slct                                      *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
           ...
           if        s-ves                =    spaces and
                     s-alf                =    "SLCT"
                     move   "S"           to   w-ipc-dlp-snx-slc
           else      move   "N"           to   w-ipc-dlp-snx-slc      .
      *              *-------------------------------------------------*
      *              * Determinazione variabile di i.p.c. da livello   *
      *              * precedente per codice mastro                    *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     move   s-num         to   w-ipc-dlp-cod-pdc
           else      move   zero          to   w-ipc-dlp-cod-pdc      .
      *              *-------------------------------------------------*
      *              * Se non esiste codice mastro passato da livello  *
      *              * precedente : uscita                             *
      *              *-------------------------------------------------*
           if        w-prs-liv-pdc        =    2
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura tabella [zma] per la descrizione del    *
      *              * mastro                                          *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODMAS    "         to   f-key                  .
           move      w-ipc-dlp-cod-mas    to   rf-zma-cod-mas         .
           move      "pgm/cge/fls/ioc/obj/iofzma"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           ...
           move      rf-zma-des-mas       to   w-des-cod-mas          .
      *              *-------------------------------------------------*
      *              * Start su tabella [zcn]                          *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           ...
           string    "Nessun conto memorizzato per il mastro "
                                delimited by   size
                     w-ipc-dlp-cod-mas
                                delimited by   size
                     " !"       delimited by   size
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zcn]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/cge/fls/ioc/obj/iofzcn"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Test su codice mastro                           *
      *              *-------------------------------------------------*
           if        w-prs-liv-pdc        not  = 3
                     go to qry-tst-max-999.
           if        rf-zcn-cod-mas       not  = w-ipc-dlp-cod-mas
                     move   "#"           to   w-cnt-qry-flg-sub      .
       qry-tst-max-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-zcn-cod-mas       to   w-mpn-cod-mas          .
           move      rf-zcn-cod-con       to   w-mpn-cod-con          .
           move      zero                 to   w-mpn-cod-stc          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *                  *---------------------------------------------*
      *                  * Scrittura della variabile di i.p.c. per li- *
      *                  * vello precedente "cod-pdc" per elemento se- *
      *                  * lezionato                                   *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
           move      "cod-pdc"            to   s-var                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Preparazione della variabile di i.p.c.      *
      *                  * "cod-mas" per codice categoria di default   *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
           ...
           move      zero                 to   s-dec                  .
           move      spaces               to   s-sgn                  .
           move      w-ipc-dlp-cod-mas    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Preparazione della variabile di i.p.c.  *
      *                      * globale 'sav-rst' a 'N' per segnalare   *
      *                      * che non e' necessario il Save iniziale  *
      *                      * dell'immagine video                     *
      *                      *-----------------------------------------*
           move      "PV"                 to   s-ope                  .
           move      "sav-rst"            to   s-var                  .
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                          *-------------------------------------*
      *                          * Abilitazione tasto Slct             *
      *                          *-------------------------------------*
           if        w-ipc-dlp-snx-slc    not  = "S"
                     go to qry-trt-fun-720.
           move      "PV"                 to   s-ope                  .
           move      "fkselect"           to   s-var                  .
           move      "+"                  to   s-dop                  .
           move      "A"                  to   s-tip                  .
      ...
      *                          * per livello successivo "cod-pdc"    *
      *                          * per codice categoria/classe         *
      *                          *-------------------------------------*
           move      "PV"                 to   s-ope                  .
           move      "cod-pdc"            to   s-var                  .
           move      "+"                  to   s-dop                  .
      ...
      *                          *-------------------------------------*
           ...
           cancel    s-pat                                            .
      *                          *-------------------------------------*
      *                          * Lettura variabile da livello suc-   *
      *                          * cessivo "cod-pdc" per determinare   *
      *                          * se e' avvenuta una selezione        *
      *                          *-------------------------------------*
           move      "CV"                 to   s-ope                  .
           move      "cod-pdc"            to   s-var                  .
           move      "+"                  to   s-dop                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                =    spaces
                     go to qry-trt-fun-740
           else      go to qry-trt-fun-999.
       qry-trt-fun-740.
      *                          *-------------------------------------*
      *                          * Se selezione avvenuta               *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Scrittura della variabile di    *
      *                              * i.p.c. per il livello prece-    *
      *                              * dente "cod-pdc" per elemento    *
      *                              * selezionato                     *
      *                              *---------------------------------*
           move      "PV"                 to   s-ope                  .
           move      "cod-pdc"            to   s-var                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      13                   to   v-pos                  .
           move      w-ipc-dlp-cod-mas    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
