      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge4421:        *
      *                                                                *
      *                    Stampa estratti conto clienti               *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
      *        * Ragione sociale cliente minima e massima              *
      *        *-------------------------------------------------------*
           05  rr-rag-min                 pic  x(20)                  .
           05  rr-rag-max                 pic  x(20)                  .
      *        *-------------------------------------------------------*
      *        * Mnemonico cliente minimo e massimo                    *
      *        *-------------------------------------------------------*
           05  rr-mne-min                 pic  x(10)                  .
           05  rr-mne-max                 pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Partita iva cliente minima e massima                  *
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      *              * Prompt 'Selezione su archivio clienti'          *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      31                   to   v-car                  .
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su archivio clienti :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
