      ...
      *                       Ultima revisione:    NdK del 25/04/20    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge7601:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Prompts per periodo dichiarazione               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Periodo dichiarazione  dal :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *                  * Determinazione                              *
      *                  *---------------------------------------------*
           move      rr-dat-ini           to   w-det-lit-tpr-din      .
           move      rr-dat-fin           to   w-det-lit-tpr-dfi      .
           perform   det-lit-tpr-000      thru det-lit-tpr-999        .
           move      w-det-lit-tpr-lit    to   rr-prd-tpr-lit         .
           move      w-det-lit-tpr-tpr    to   rr-prd-tpr             .
      *                  *---------------------------------------------*
      *                  * Visualizzazione literal                     *
      *                  *---------------------------------------------*
           perform   vis-lit-tpr-000      thru vis-lit-tpr-999        .
      *                  *---------------------------------------------*
      *                  * Controlli su periodo determinato            *
      *                  *---------------------------------------------*
           if        rr-prd-tpr-rng       =    "T"
      ...
      *                  * Messaggio di errore                         *
      *                  *---------------------------------------------*
           move      "Il periodo di riferimento dovrebbe essere un trime
      -              "stre!          "    to   w-err-box-err-msg      .
           perform   box-msg-err-000      thru box-msg-err-999        .
      *                  *---------------------------------------------*
      *                  * Si prosegue comunque                        *
      *                  *---------------------------------------------*
______*    if        v-key                =    "UP  "
______*              go to acc-dat-fin-600
           go to     acc-dat-fin-600.
       acc-dat-fin-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Literal periodo                   *
      *    *-----------------------------------------------------------*
       vis-lit-tpr-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
