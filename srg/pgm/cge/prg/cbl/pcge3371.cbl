      ...
      *                                   Fase:    pcge337             *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 06/11/90    *
      *                       Versione attuale:    NdK del 07/08/98    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma cge337   *
      *                                                                *
      *                    Rettifiche extra contabili al bilancio      *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Work-area per totali saldo rettifiche                     *
      *    *-----------------------------------------------------------*
       01  w-tot.
           05  w-tot-dat-ele              pic  9(09)                  .
           05  w-tot-dat-ret              pic s9(13)                  .
           05  w-tot-sal-ret              pic s9(13)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-dat-ini           to   rf-rdb-dat-reg         .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [rdb]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/cge/fls/ioc/obj/iofrdb"
                                          to   s-pat                  .
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      rf-rdb-dat-reg       to   w-rot-l01-dat-reg      .
       prn-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-dat-ele          .
           move      zero                 to   w-tot-sal-ret          .
       prn-ini-cic-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Stampa trattini se saldo = o > di zero  *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      18                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           if        w-tot-sal-ret        <     zero
                     move 116             to   p-pos                  
           else      move 097             to   p-pos                  .
           move      "-----------------"       
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      077                  to   p-pos                  .
           move      "Saldo totale     :" to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Stampa  saldo rettifiche                *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      13                   to   p-car                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Inizializzazione area per totale per data       *
      *              *-------------------------------------------------*
           add       1                    to   w-tot-dat-ele          .
           move      zero                 to   w-tot-dat-ret          .
      *              *-------------------------------------------------*
      *              * Intestazione foglio                             *
      *              *-------------------------------------------------*
           perform   int-pag-sta-000      thru int-pag-sta-999        .
      ...
      *                      *-----------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      077                  to   p-pos                  .
           move      "Saldo rettifiche :" to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Stampa  saldo rettifiche                *
      ...
      *                          *-------------------------------------*
           ...
           move      rf-rdb-cod-pdc       to   w-edt-cod-pdc-cod      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-rdb-cod-pdc       to   rf-pdc-cod-pdc         .
           move      "pgm/cge/fls/ioc/obj/iofpdc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Stampa commento alla rettifica              *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      40                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      055                  to   p-pos                  .
           move      rf-rdb-com-rig       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Stampa importo rettifica                *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "V"                  to   p-tip                  .
           move      13                   to   p-car                  .
           ...
           if        rf-rdb-dar-ave        =   "D"
                     ...
                     add rf-rdb-imp-mov
                                          to   w-tot-dat-ret
           else      move 115             to   p-pos                   
                     subtract rf-rdb-imp-mov
                                          from w-tot-sal-ret
                     subtract rf-rdb-imp-mov
                                          from w-tot-dat-ret          .
           move      "G"                  to   p-edm                  .
           move      rf-rdb-imp-mov       to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-999.
           exit.
      ...
      *                      *-----------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "D"                  to   p-tip                  .
           move      rf-rdb-dat-reg       to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           if        p-edt                =    spaces
                     move  "(data-zero)"  to   p-edt                  .
      *                      *-----------------------------------------*
      *                      * Composizione                            *
      *                      *-----------------------------------------*
           move      spaces               to   w-cnt-tit-des-tit      .
           string    "RETTIFICHE EXTRA-CONTABILI DEL "
                                delimited by   size
                     p-edt
                                delimited by   spaces
      ...
      *                  *---------------------------------------------*
      *                  * 1. linea per fincatura stampato             *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Literal   Conto e Descrizione           *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      31                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      010                  to   p-pos                  
           move      "Codice e descrizione sottoconto"       
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * 2. linea per fincatura stampato             *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Interlinea                              *
      *                      *-----------------------------------------*
