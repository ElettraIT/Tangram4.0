      ...
      *                       Ultima revisione:    NdK del 20/03/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [mpu]            *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " INTERROGAZIONE SU MODELLI DI PAGAMENTO "       .
      ...
      *        *-------------------------------------------------------*
           05  w-wrk-sdo.
               10  w-wrk-sdo-con          pic s9(13)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per salvataggi rotture                         *
      *        *-------------------------------------------------------*
           05  w-wrk-l01.
               10  w-wrk-l01-ute          pic  x(08)                  .
               10  w-wrk-l01-fas          pic  x(06)                  .
               10  w-wrk-l01-dat          pic  9(07)                  .
               10  w-wrk-l01-pre          pic  9(07)                  .
               10  w-wrk-l01-cpb          pic  x(10)                  .
               10  w-wrk-l01-zzz          pic  9(07)                  .
               10  w-wrk-l01-snx          pic  x(01)                  .
               10  w-wrk-l01-stp          pic  x(01)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-rip-str.
      *        *-------------------------------------------------------*
      *        * Work-area per ripristino Start su [mpu]               *
      *        *-------------------------------------------------------*
           05  w-rip-str-mpu.
      *            *---------------------------------------------------*
      *            * Flag di End-of-file                               *
      *            *---------------------------------------------------*
               10  w-rip-str-mpu-eof      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Parametri di Start                                *
      *            *---------------------------------------------------*
               10  w-rip-str-mpu-prt      pic  9(09)                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Prompt per campo selezione : Data reg. iniziale *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Prompt per campo selezione : Data reg. finale   *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-rip-str-mpu-eof      .
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start per data iniziale registrazione           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATREG    "         to   f-key                  .
           move      rr-dat-min           to   rf-mpu-dat-reg         .
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun modello entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [mpu]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/cge/fls/ioc/obj/iofmpu"
                                          to   s-pat                  .
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-mpu-num-prt       to   w-rot-l01-num-prt      .
       qry-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione area per saldo                  *
      *              *-------------------------------------------------*
           move      zero                 to   w-wrk-sdo-con          .
           move      zero                 to   w-wrk-l01-zzz          .
           move      spaces               to   w-wrk-l01-snx          .
           move      spaces               to   w-wrk-l01-stp          .
           move      rf-mpu-ide-ute       to   w-wrk-l01-ute          .
           move      rf-mpu-ide-fas       to   w-wrk-l01-fas          .
           move      rf-mpu-ide-dat       to   w-wrk-l01-dat          .
           move      rf-mpu-flg-stp       to   w-wrk-l01-stp          .
      *
           if        rf-mpu-tip-sez       =    "P    "
                     move  rf-mpu-ele-sez
                          (91 : 07)       to   w-wrk-l01-pre          .
      *
           if        rf-mpu-tip-sez       =    "P    "
                     move  rf-mpu-ele-sez
                          (01 : 10)       to   w-wrk-l01-cpb
           else      move  "n.d.      "   to   w-wrk-l01-cpb          .
       qry-ini-lr1-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      w-rot-l01-num-prt    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Data                                        *
      *                  *---------------------------------------------*
           ...
           move      "D"                  to   v-tip                  .
           move      "+"                  to   v-edm                  .
           move      rf-mpu-num-prt       to   w-mpn-num-prt          .
           move      w-mpn                to   v-cnt                  .
           move      v-lnr                to   v-lin                  .
           move      12                   to   v-pos                  .
           move      w-wrk-l01-pre        to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-ini-lr1-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      50                   to   v-pos                  .
      *
           if        w-wrk-l01-stp        not  = spaces and
                     w-wrk-l01-zzz        >    zero     and
                     w-wrk-l01-snx        =    "S"
                     move "Stampato e Registrato "
                                          to   v-alf
           else if   w-wrk-l01-stp        not  = spaces and
                     w-wrk-l01-zzz        >    zero     and
                     w-wrk-l01-snx        =    "N"
                     move "Stampato e Chiuso     "
                                          to   v-alf
           else if   w-wrk-l01-zzz        >    zero     and
                     w-wrk-l01-snx        =    "N"
                     move "Chiuso                "
                                          to   v-alf
           else if   w-wrk-l01-zzz        >    zero     and
                     ...
                     move "Registrato            "
                                          to   v-alf
           else if   w-wrk-l01-stp        not  = spaces
                     move "Stampato              "
                                          to   v-alf
           else      move "Compilato             "
                                          to   v-alf                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      73                   to   v-pos                  .
      *
           if        w-wrk-l01-zzz        >    zero
                     move  w-wrk-l01-zzz  to   v-dat
           else      move  w-wrk-l01-dat  to   v-dat                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-fin-lr1-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento saldo modello                     *
      *              *-------------------------------------------------*
           add       rf-mpu-imp-deb       to   w-wrk-sdo-con          .
           subtract  rf-mpu-imp-cre       from w-wrk-sdo-con          .
      *              *-------------------------------------------------*
      *              * Aggiornamento eventuale data chiusura           *
      *              *-------------------------------------------------*
           if        rf-mpu-tip-sez       =    "C    "
                     move  rf-mpu-ele-sez
                          (01 : 07)       to   w-wrk-l01-zzz
                     move  rf-mpu-ele-sez
                          (08 : 01)       to   w-wrk-l01-snx          .
       qry-liv-det-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      20                   to   v-pos                  .
           move      " INTERROGAZIONE SU MODELLI DI PAGAMENTO "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "  Numero   Present.  Totale modello     Banca     
      -              "            Stato             "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
