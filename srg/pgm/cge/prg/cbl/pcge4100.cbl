      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge4101:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA ANAGRAFICA CLIENTI PER ETICHETTE "       .
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Stampa nome interlocutore                  *
      *        *-------------------------------------------------------*
           05  w-exp-snx-int.
      ...
      *              *-------------------------------------------------*
      ...
      -              " quella minima!"    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-500.
      *              *-------------------------------------------------*
      *              * Controllo su stampa nome interlocutore          *
      *              *-------------------------------------------------*
       tdo-ric-sel-502.
           if        rr-snx-int           not  = zero
                     go to tdo-ric-sel-504.
           move      "Manca la scelta di stampa nome interlocutore !    
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-504.
           if        rr-snx-int           not  > w-exp-snx-int-num
                     go to tdo-ric-sel-800.
           move      "Scelta di stampa nome interlocutore errata !      
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-800.
      *              *-------------------------------------------------*
