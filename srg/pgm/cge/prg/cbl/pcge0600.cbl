      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella classi di cespiti          *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "TABELLA CLASSI CESPITI / CATEGORIE BENI "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               ...
               10  w-tes-des-cla          pic  x(40)                  .
               10  w-tes-pdc-cla          pic  9(07)                  .
               10  w-tes-pdc-cla-des      pic  x(40)                  .
               10  w-tes-per-amr          pic  9(03)v9(02)            .
               10  w-tes-alx-exp.
                   15  filler occurs 75   pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cla        to   w-cod-mne-zc1-cod      .
           move      04                   to   w-cod-mne-zc1-lin      .
           move      30                   to   w-cod-mne-zc1-pos      .
           move      07                   to   w-cod-mne-zc1-dln      .
           move      30                   to   w-cod-mne-zc1-dps      .
           move      "<B"                 to   v-edm                  .
      ...
      *                  * Descrizione classe                          *
      *                  *---------------------------------------------*
           perform   acc-des-cla-000      thru acc-des-cla-999        .
           if        v-key                =    "NXSC"
      ...
      *                  * Sottoconto                                  *
      *                  *---------------------------------------------*
           perform   acc-pdc-cla-000      thru acc-pdc-cla-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Sottoconto                                      *
      *              *-------------------------------------------------*
           perform   vis-pdc-cla-000      thru vis-pdc-cla-999        .
           perform   vis-pdc-cla-des-000  thru vis-pdc-cla-des-999    .
      *              *-------------------------------------------------*
      *              * % ammortamento                                  *
      *              *-------------------------------------------------*
      ...
      *              * Descrizione classe                              *
      *              *-------------------------------------------------*
           perform   pmt-des-cla-000      thru pmt-des-cla-999        .
      *              *-------------------------------------------------*
      *              * Codice mnemonico                                *
      *              *-------------------------------------------------*
      ...
      *              * Sottoconto                                      *
      *              *-------------------------------------------------*
           perform   pmt-pdc-cla-000      thru pmt-pdc-cla-999        .
      *              *-------------------------------------------------*
      *              * % ammortamento                                  *
      *              *-------------------------------------------------*
           perform   pmt-per-amr-000      thru pmt-per-amr-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     pmt-tes-reg-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione classe               *
      *    *-----------------------------------------------------------*
       pmt-des-cla-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : % ammortamento                   *
      *    *-----------------------------------------------------------*
       pmt-per-amr-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descrizione classe           *
      *    *-----------------------------------------------------------*
       acc-des-cla-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-cla (1)    =    spaces
                     go to acc-des-cla-100.
       acc-des-cla-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * l'ordinamento                               *
      *                  *---------------------------------------------*
           move      w-tes-des-cla (1)    to   w-all-str-alf          .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-pdc-cla (1)    to   w-cod-mne-pdc-cod      .
       ...
       acc-pdc-cla-110.
           ...
           if        w-cod-mne-pdc-ope    =    "F+"
                     go to acc-pdc-cla-115.
           if        w-cod-mne-pdc-ope    =    "AC"
                     go to acc-pdc-cla-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-pdc-cla-115.
           perform   cod-mne-pdc-foi-000  thru cod-mne-pdc-foi-999    .
           go to     acc-pdc-cla-110.
       acc-pdc-cla-120.
      ...
      *                  *---------------------------------------------*
           move      w-tes-pdc-cla (1)    to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-tes-pdc-cla-des (1)  .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-pdc-cla (1)    to   w-edt-cod-pdc-cod      .
      ...
      *              *-------------------------------------------------*
       cnt-tdo-nok-120.
      *                  *---------------------------------------------*
      *                  * Controllo su descrizione classe             *
      *                  *---------------------------------------------*
           if        w-tes-des-cla (1)    not  = spaces
                     go to cnt-tdo-nok-500.
           move      "Manca la descrizione della classe          !    "
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           ...
           move      spaces               to   w-tes-des-cla (1)      .
           move      spaces               to   w-tes-des-key (1)      .
           move      spaces               to   w-tes-cod-mne (1)      .
           move      zero                 to   w-tes-pdc-cla (1)      .
           move      spaces               to   w-tes-pdc-cla-des (1)  .
           move      zero                 to   w-tes-per-amr (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cla        to   rf-zc1-cod-cla         .
           move      "pgm/cge/fls/ioc/obj/iofzc1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [zc1]                        *
      *                          *-------------------------------------*
           move      rf-zc1-ide-dat       to   w-tes-ide-dat (1)      .
           move      rf-zc1-ide-ute       to   w-tes-ide-ute (1)      .
           move      rf-zc1-ide-fas       to   w-tes-ide-fas (1)      .
           move      rf-zc1-des-cla       to   w-tes-des-cla (1)      .
           move      rf-zc1-des-key       to   w-tes-des-key (1)      .
           move      rf-zc1-cod-mne       to   w-tes-cod-mne (1)      .
           move      rf-zc1-pdc-cla       to   w-tes-pdc-cla (1)      .
           move      rf-zc1-per-amr       to   w-tes-per-amr (1)      .
      *
           if        rf-zc1-per-amr       not  numeric
                     move  zero           to   w-tes-per-amr (1)      .
      *
           move      rf-zc1-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      ...
      *                      * Write record [zc1]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zc1-000      thru wrt-rec-zc1-999        .
      ...
      *                      * Rewrite record [zc1]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zc1-000      thru rew-rec-zc1-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zc1]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zc1-000      thru del-rec-zc1-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zc1]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zc1-000.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-zc1-ide-dat         .
           move      s-ute                to   rf-zc1-ide-ute         .
           move      s-fas                to   rf-zc1-ide-fas         .
           move      w-tes-cod-mne (1)    to   rf-zc1-cod-mne         .
           move      w-tes-des-key (1)    to   rf-zc1-des-key         .
           move      w-tes-des-cla (1)    to   rf-zc1-des-cla         .
           move      w-tes-pdc-cla (1)    to   rf-zc1-pdc-cla         .
           move      w-tes-per-amr (1)    to   rf-zc1-per-amr         .
           move      w-tes-alx-exp (1)    to   rf-zc1-alx-exp         .
       cmp-rec-zc1-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zc1]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zc1-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zc1-000      thru cmp-rec-zc1-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
