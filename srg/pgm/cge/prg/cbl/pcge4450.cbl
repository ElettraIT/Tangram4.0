      ...
      *                       Ultima revisione:    NdK del 18/07/13    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge4451:        *
      *                                                                *
      ...
      *              *-------------------------------------------------*
      *              * Messaggio di programma obsoleto                 *
      *              *-------------------------------------------------*
           move      "ME"                 to   v-ope                  .
           move      "Programma obsoleto: si consiglia di utilizzare l'a
      -              "rea 'gepslc'."      to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pre-exe-pgm-999.
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Data estratti conto        *
      *    *-----------------------------------------------------------*
       acc-dat-stp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
