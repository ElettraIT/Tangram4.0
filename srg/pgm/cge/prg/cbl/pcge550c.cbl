      ...
      *                                                                *
      *                    Manutenzione Dati per la contabilita'       *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "   DATI FORNITORI PER LA CONTABILITA'   "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-cod-fnt-naz      pic  x(03)                  .
               10  w-rig-prt-iva          pic  9(11)                  .
               10  w-rig-cod-fis          pic  x(16)                  .
               10  w-rig-cod-cge          pic  9(07)                  .
               10  w-rig-cod-cge-sav      pic  9(07)                  .
               10  w-rig-cod-cge-des      pic  x(40)                  .
               10  w-rig-snx-a13          pic  x(01)                  .
      ...
      *                *-----------------------------------------------*
                   ...
                   15  w-lin-imm-rag-fnt.
                       20  w-lin-imm-rag-rag
                                          pic  x(40)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-inl-piv  pic  x(11)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-inl-pdc  pic  x(09)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-lpt-cod-cge-lin          pic  9(03)    value 014     .
           05  w-lpt-cod-cge-pos          pic  9(03)    value 030     .

      *    *===========================================================*
      *    * Work-area per selezioni sul record [fnt]                  *
      *    *-----------------------------------------------------------*
       01  w-sel-rec-fnt.
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Si/no solo esclusi per selezione           *
      *        *-------------------------------------------------------*
           05  w-exp-sel-a13.
               10  w-exp-sel-a13-num      pic  9(02)       value 03   .
               10  w-exp-sel-a13-lun      pic  9(02)       value 40   .
               10  w-exp-sel-a13-tbl.
                   15  filler             pic  x(40) value
                            "Tutti i fornitori                       ".
                   15  filler             pic  x(40) value
                            "solo quelli Esclusi                     ".
                   15  filler             pic  x(40) value
                            "solo quelli Da escludere                ".
      *        *-------------------------------------------------------*
      *        * Work per : Si/no solo esclusi                         *
      *        *-------------------------------------------------------*
           05  w-exp-snx-a13.
               10  w-exp-snx-a13-num      pic  9(02)       value 02   .
               10  w-exp-snx-a13-lun      pic  9(02)       value 40   .
               10  w-exp-snx-a13-tbl.
                   15  filler             pic  x(40) value
                            "Va in elenco                            ".
                   15  filler             pic  x(40) value
                            "Non va in elenco                        ".
      ...
      *              *-------------------------------------------------*
      *              * Lettura referenza sottoconto contabile          *
      *              *-------------------------------------------------*
           perform   ref-stc-fnt-000      thru ref-stc-fnt-999        .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-key-reg-500.
      *                  *---------------------------------------------*
      *                  * Selezione esclusione da elenco Iva          *
      *                  *---------------------------------------------*
           perform   acc-sel-a13-000      thru acc-sel-a13-999        .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-key-reg-999.
           if        v-key                =    "UP  "
      ...
      *              * Selezione esclusione da elenco Iva              *
      *              *-------------------------------------------------*
           perform   vis-sel-a13-000      thru vis-sel-a13-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Selezione esclusione da elenco Iva          *
      *                  *---------------------------------------------*
           perform   pmt-sel-a13-000      thru pmt-sel-a13-999        .
       pmt-key-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Esclusione da elenco             *
      *    *-----------------------------------------------------------*
       pmt-sel-a13-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-min        to   w-cod-mne-fnt-cod      .
           move      05                   to   w-cod-mne-fnt-lin      .
           move      33                   to   w-cod-mne-fnt-pos      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-fnt-ope      .
           move      w-tes-cod-max        to   w-cod-mne-fnt-cod      .
           move      06                   to   w-cod-mne-fnt-lin      .
           move      33                   to   w-cod-mne-fnt-pos      .
           move      zero                 to   w-cod-mne-fnt-rln      .
           move      zero                 to   w-cod-mne-fnt-rps      .
           move      zero                 to   w-cod-mne-fnt-vln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cge        to   w-cod-mne-pdc-cod      .
           move      w-lpt-cod-cge-lin    to   w-cod-mne-pdc-lin      .
           move      w-lpt-cod-cge-pos    to   w-cod-mne-pdc-pos      .
           move      w-lpt-cod-cge-lin    to   w-cod-mne-pdc-dln      .
           move      w-lpt-cod-cge-pos    to   w-cod-mne-pdc-dps      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cod-cge          .
       acc-cod-cge-300.
      *              *-------------------------------------------------*
      *              * Se Pf1                                          *
      *              *-------------------------------------------------*
           if        v-key                not  = "[1] "
                     go to acc-cod-cge-400.
      *                  *---------------------------------------------*
      *                  * Subroutine di accettazione valore sostitu-  *
      *                  * tivo                                        *
      *                  *---------------------------------------------*
           perform   acc-cod-cge-sos-000  thru acc-cod-cge-sos-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-cge-999.
      *                  *---------------------------------------------*
      *                  * Visualizzazione sostituzione effettuata     *
      *                  *---------------------------------------------*
           perform   vis-cod-cge-sos-000  thru vis-cod-cge-sos-999    .
      *                  *---------------------------------------------*
      *                  * Se sostituzione non effettuata ma impostati *
      *                  * valori : rivisualizzazione valori impostati *
      *                  *---------------------------------------------*
           if        w-tes-cod-cge-sns    not  = zero
                     go to acc-cod-cge-800.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-cge        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-tes-cod-cge-des      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cge        to   w-edt-cod-pdc-cod      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      09                   to   v-car                  .
           move      w-lpt-cod-cge-lin    to   v-lin                  .
           move      w-lpt-cod-cge-pos    to   v-pos                  .
      ...
      *    *-----------------------------------------------------------*
       vis-des-cge-000.
           ...
           move      w-lpt-cod-cge-pos    to   v-pos                  .
           add       11                   to   v-pos                  .
           move      w-tes-cod-cge-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-des-cge-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      zero                 to   w-tes-cod-cge-sns      .
      *                  *---------------------------------------------*
      *                  * Salvataggio immagine video                  *
      *                  *---------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-lpt-cod-cge-lin    to   v-lto                  .
           add       1                    to   v-lto                  .
           move      w-lpt-cod-cge-pos    to   v-pto                  .
           add       50                   to   v-pto                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       acc-cod-cge-sos-010.
      ...
      *                  *---------------------------------------------*
           perform   vis-cod-cge-so1-000  thru vis-cod-cge-so1-999    .
      *                  *---------------------------------------------*
      *                  * Visualizzazione valore sostitutivo          *
      *                  *---------------------------------------------*
           perform   vis-cod-cge-so2-000  thru vis-cod-cge-so2-999    .
       acc-cod-cge-sos-200.
      *              *-------------------------------------------------*
      *              * Accettazioni                                    *
      *              *-------------------------------------------------*
      ...
      *                  * Valore da sostituire                        *
      *                  *---------------------------------------------*
           perform   acc-cod-cge-so1-000  thru acc-cod-cge-so1-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-cge-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-cge-sos-600.
           if        v-key                =    "DOWN"
                     go to acc-cod-cge-sos-600.
      ...
      *                  * Valore sostitutivo                          *
      *                  *---------------------------------------------*
           perform   acc-cod-cge-so2-000  thru acc-cod-cge-so2-999    .
           if        w-cnt-tus-acc-key    not  = spaces
                     go to acc-cod-cge-sos-600.
           if        v-key                =    "UP  "
                     go to acc-cod-cge-sos-200.
       acc-cod-cge-sos-600.
      *              *-------------------------------------------------*
      ...
      *                  * le impostazioni                             *
      *                  *---------------------------------------------*
           if        w-tes-cod-cge        =    zero  and
                     w-tes-cge-sos        =    zero
                     go to acc-cod-cge-sos-800.
      *                  *---------------------------------------------*
      *                  * Che i valori non siano uguali               *
      *                  *---------------------------------------------*
           if        w-tes-cod-cge        not  = w-tes-cge-sos
                     go to acc-cod-cge-sos-800.
      *                      *-----------------------------------------*
      *                      * Normalizzazione valore sostitutivo      *
      *                      *-----------------------------------------*
           move      zero                 to   w-tes-cge-sos          .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-cge        not  = zero or
                     w-tes-cge-sos        not  = zero
                     move  1              to   w-tes-cod-cge-sns      .
       acc-cod-cge-sos-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tes-cod-cge-sns    =    zero
                     go to vis-cod-cge-sos-100
           else      go to vis-cod-cge-sos-500.
       vis-cod-cge-sos-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-prs-liv-pdc        to   w-edt-cod-pdc-liv      .
           move      w-tes-cge-sos        to   w-edt-cod-pdc-cod      .
           move      "B"                  to   w-edt-cod-pdc-edm      .
           perform   edt-pdc-asx-000      thru edt-pdc-asx-999        .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       acc-cod-cge-so1-110.
           perform   cod-mne-pdc-cll-000  thru cod-mne-pdc-cll-999    .
           if        w-cod-mne-pdc-ope    =    "F+"
                     go to acc-cod-cge-so1-115.
           if        w-cod-mne-pdc-ope    =    "AC"
                     go to acc-cod-cge-so1-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-cge-so1-115.
           perform   cod-mne-pdc-foi-000  thru cod-mne-pdc-foi-999    .
           go to     acc-cod-cge-so1-110.
       acc-cod-cge-so1-120.
           move      w-cod-mne-pdc-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-pdc-ope      .
           move      w-prs-liv-pdc        to   w-cod-mne-pdc-liv      .
           move      w-tes-cge-sos        to   w-cod-mne-pdc-cod      .
           move      w-lpt-cod-cge-lin    to   w-cod-mne-pdc-lin      .
           move      w-lpt-cod-cge-pos    to   w-cod-mne-pdc-pos      .
       ...
       acc-cod-cge-so2-110.
           perform   cod-mne-pdc-cll-000  thru cod-mne-pdc-cll-999    .
           if        w-cod-mne-pdc-ope    =    "F+"
                     go to acc-cod-cge-so2-115.
           if        w-cod-mne-pdc-ope    =    "AC"
                     go to acc-cod-cge-so2-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-cge-so2-115.
           perform   cod-mne-pdc-foi-000  thru cod-mne-pdc-foi-999    .
           go to     acc-cod-cge-so2-110.
       acc-cod-cge-so2-120.
           move      w-cod-mne-pdc-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-cge-so2-999.
       acc-cod-cge-so2-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cge-sos          .
       acc-cod-cge-so2-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice di esenzione IVA              *
      *    *-----------------------------------------------------------*
       acc-cod-iva-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           move      w-let-arc-zci-des    to   w-tes-cod-iva-des      .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Codice di esenzione IVA           *
      *    *-----------------------------------------------------------*
       vis-cod-iva-000.
      *              *-------------------------------------------------*
      *              * Editing preliminare                             *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Descrizione codice IVA            *
      *    *-----------------------------------------------------------*
       vis-des-iva-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Selezione esclusione da elenco Iva         *
      *    *-----------------------------------------------------------*
       acc-sel-a13-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-a13-lun    to   v-car                  .
           move      w-exp-sel-a13-num    to   v-ldt                  .
           move      "TED#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-sel-a13-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      18                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-tes-sel-a13        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-sel-a13-999.
       acc-sel-a13-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-sel-a13          .
       acc-sel-a13-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Selezione esclusione da elenco Iva      *
      *    *-----------------------------------------------------------*
       vis-sel-a13-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *                  * Codice fiscale                              *
      *                  *---------------------------------------------*
           perform   acc-rig-fis-000      thru acc-rig-fis-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Sottoconto contabile                        *
      *                  *---------------------------------------------*
           perform   acc-rig-cge-000      thru acc-rig-cge-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Codice esenzione iva                        *
      *                  *---------------------------------------------*
           perform   acc-rig-cei-000      thru acc-rig-cei-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
       ...
       acc-cor-reg-500.
      *                  *---------------------------------------------*
      *                  * Esclusione da elenco Iva                    *
      *                  *---------------------------------------------*
           perform   acc-rig-a13-000      thru acc-rig-a13-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "9B"                 to   v-edm                  .
           move      w-rig-prt-iva        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-inl-piv      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Editing Sottoconto contabile                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Editing con appoggio a sinistra         *
      *                      *-----------------------------------------*
           move      w-prs-liv-pdc        to   w-edt-cod-pdc-liv      .
           move      w-rig-cod-cge        to   w-edt-cod-pdc-cod      .
           move      "B"                  to   w-edt-cod-pdc-edm      .
           perform   edt-pdc-asx-000      thru edt-pdc-asx-999        .
           move      w-edt-cod-pdc-edt    to   w-lin-imm-inl-pdc      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              * Codice fiscale                                  *
      *              *-------------------------------------------------*
           perform   vis-rig-fis-000      thru vis-rig-fis-999        .
      *              *-------------------------------------------------*
      *              * Sottoconto contabile                            *
      *              *-------------------------------------------------*
           perform   vis-rig-cge-000      thru vis-rig-cge-999        .
           perform   vis-rig-cge-des-000  thru vis-rig-cge-des-999    .
      *              *-------------------------------------------------*
      *              * Codice esenzione iva                            *
      *              *-------------------------------------------------*
           perform   vis-rig-cei-000      thru vis-rig-cei-999        .
           perform   vis-rig-cei-des-000  thru vis-rig-cei-des-999    .
      *              *-------------------------------------------------*
      *              * Esclusione da elenco Iva                        *
      *              *-------------------------------------------------*
           perform   vis-rig-a13-000      thru vis-rig-a13-999        .
       vis-rig-cor-999.
           exit.
      ...
      *                  * Codice fiscale                              *
      *                  *---------------------------------------------*
           perform   pmt-rig-fis-000      thru pmt-rig-fis-999        .
      *                  *---------------------------------------------*
      *                  * Sottoconto contabile                        *
      *                  *---------------------------------------------*
           perform   pmt-rig-cge-000      thru pmt-rig-cge-999        .
      *                  *---------------------------------------------*
      *                  * Codice esenzione iva                        *
      *                  *---------------------------------------------*
           perform   pmt-rig-cei-000      thru pmt-rig-cei-999        .
      *                  *---------------------------------------------*
      *                  * Esclusione da elenco Iva                    *
      *                  *---------------------------------------------*
           perform   pmt-rig-a13-000      thru pmt-rig-a13-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Codice esenzione iva             *
      *    *-----------------------------------------------------------*
       pmt-rig-cei-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Esclusione da elenco Iva         *
      *    *-----------------------------------------------------------*
       pmt-rig-a13-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      "AC"                 to   w-cod-mne-fnt-ope      .
           move      w-rig-cod-fnt        to   w-cod-mne-fnt-cod      .
           move      16                   to   w-cod-mne-fnt-lin      .
           move      22                   to   w-cod-mne-fnt-pos      .
           move      zero                 to   w-cod-mne-fnt-rln      .
           move      zero                 to   w-cod-mne-fnt-rps      .
           move      zero                 to   w-cod-mne-fnt-vln      .
           move      zero                 to   w-cod-mne-fnt-vps      .
      ...
      *                  *---------------------------------------------*
           if        w-rig-cod-fnt-naz    not  = "IT "
                     go to acc-rig-iva-999.
      *                  *---------------------------------------------*
      *                  * Salvataggio partita iva e codice fiscale    *
      *                  *---------------------------------------------*
           move      w-rig-prt-iva        to   w-sav-prt-iva          .
           move      w-rig-cod-fis        to   w-sav-cod-fis          .
      *                  *---------------------------------------------*
      *                  * Partita iva in rappresentazione alfanumeri- *
      *                  * ca                                          *
      *                  *---------------------------------------------*
           move      w-rig-prt-iva        to   w-ctl-prt-iva-num      .
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-fnt        to   w-ctl-dup-piv-fnt      .
           move      w-rig-prt-iva        to   w-ctl-dup-piv-piv      .
      ...
      *                          *-------------------------------------*
           move      spaces               to   w-piv-cfi-cfi-alf      .
           if        w-rig-prt-iva        =    zero
                     go to acc-rig-iva-606.
           move      w-rig-prt-iva        to   w-piv-cfi-cfi-11n      .
       acc-rig-iva-606.
           move      w-piv-cfi-cfi-alf    to   w-rig-cod-fis          .
       acc-rig-iva-609.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-fis-999.
      *              *-------------------------------------------------*
      *              * Valore impostato                                *
      *              *-------------------------------------------------*
           move      v-alf                to   w-rig-cod-fis          .
       acc-rig-fis-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-cod-fis        =    w-sav-cod-fis
                     go to acc-rig-fis-600.
      *                  *---------------------------------------------*
      *                  * Se il codice fiscale e' pari alla partita   *
      *                  * iva non si esegue il controllo              *
      *                  *---------------------------------------------*
           move      w-rig-cod-fis        to   w-piv-cfi-cfi-alf      .
           if        w-piv-cfi-cfi-11n    =    w-rig-prt-iva     and
      ...
      *                      *-----------------------------------------*
           move      w-rig-cod-fis        to   w-ctl-cod-fis-cof      .
      ...
      *                      *-----------------------------------------*
           if        w-exp-err-cfi-sce    =    01
                     go to acc-rig-fis-100
           else      go to acc-rig-fis-500.
       acc-rig-fis-500.
      *                  *---------------------------------------------*
      *                  * Controllo che il codice fiscale non sia gia'*
      *                  * stato assegnato ad un altro fornitore       *
      *                  *---------------------------------------------*
           move      w-rig-cod-fnt        to   w-ctl-dup-cfi-fnt      .
           move      w-rig-cod-fis        to   w-ctl-dup-cfi-cfi      .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Sottoconto contabile                 *
      *    *-----------------------------------------------------------*
       acc-rig-cge-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se il sottoconto non e' modificabile si     *
      *                  * omette l'impostazione, a meno che il valore *
      *                  * attuale non sia a zero                      *
      *                  *---------------------------------------------*
           if        w-rig-cod-cge        =    zero
                     go to acc-rig-cge-050.
           if        w-prs-rec-fnt-msc    =    "N"
                     go to acc-rig-cge-999.
       acc-rig-cge-050.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-rig-cod-cge        not  = zero   and
                     w-rig-cod-cge-des    not  = spaces
                     go to acc-rig-cge-080.
      *                      *-----------------------------------------*
      *                      * Se valore gia' diverso da zero non si   *
      *                      * prepara alcun default                   *
      *                      *-----------------------------------------*
           if        w-rig-cod-cge        not  = zero
                     go to acc-rig-cge-100.
      *                      *-----------------------------------------*
      *                      * Preparazione del valore di default      *
      *                      *-----------------------------------------*
           move      w-ref-stc-fnt        to   w-rig-cod-cge          .
      *                      *-----------------------------------------*
      *                      * Preparazione della descrizione relativa *
      *                      * al valore di default                    *
      *                      *-----------------------------------------*
           move      w-rig-cod-cge        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-rig-cod-cge-des      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-pdc-ope      .
           move      w-prs-liv-pdc        to   w-cod-mne-pdc-liv      .
           move      w-rig-cod-cge        to   w-cod-mne-pdc-cod      .
       ...
       acc-rig-cge-110.
           perform   cod-mne-pdc-cll-000  thru cod-mne-pdc-cll-999    .
           if        w-cod-mne-pdc-ope    =    "F+"
                     go to acc-rig-cge-115.
           if        w-cod-mne-pdc-ope    =    "AC"
                     go to acc-rig-cge-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-cge-115.
           perform   cod-mne-pdc-foi-000  thru cod-mne-pdc-foi-999    .
           go to     acc-rig-cge-110.
       acc-rig-cge-120.
           move      w-cod-mne-pdc-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Sottoconto contabile              *
      *    *-----------------------------------------------------------*
       vis-rig-cge-000.
      *              *-------------------------------------------------*
      *              * Editing con appoggio a sinistra                 *
      ...
      *    *-----------------------------------------------------------*
       vis-rig-cge-des-000.
           ...
           move      19                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-cge-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-cge-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       acc-rig-cei-110.
           perform   cod-mne-zci-cll-000  thru cod-mne-zci-cll-999    .
           if        w-cod-mne-zci-ope    =    "F+"
                     go to acc-rig-cei-115.
           if        w-cod-mne-zci-ope    =    "AC"
                     go to acc-rig-cei-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-cei-115.
           perform   cod-mne-zci-foi-000  thru cod-mne-zci-foi-999    .
           go to     acc-rig-cei-110.
       acc-rig-cei-120.
      *              *-------------------------------------------------*
      *              * Editing valore impostato                        *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Esclusione da elenco Iva             *
      *    *-----------------------------------------------------------*
       acc-rig-a13-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-a13-lun    to   v-car                  .
           move      w-exp-snx-a13-num    to   v-ldt                  .
           move      "VN#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      21                   to   v-lin                  .
           move      22                   to   v-pos                  .
           move      w-exp-snx-a13-tbl    to   v-txt                  .
      *
           if        w-rig-snx-a13        =    "S"
                     move  1              to   v-num
           else if   w-rig-snx-a13        =    "N"
                     move  2              to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-a13-999.
       acc-rig-a13-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    1
                     move  "S"            to   w-rig-snx-a13
           else if   v-num                =    2
                     move  "N"            to   w-rig-snx-a13
           else      move  spaces         to   w-rig-snx-a13          .
       acc-rig-a13-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-rig-flg
                             ...
                             go to acc-rig-a13-100.
       acc-rig-a13-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Esclusione da elenco Iva          *
      *    *-----------------------------------------------------------*
       vis-rig-a13-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-rig-cod-cge-sav    =    zero
                     go to cnt-tdo-rig-400.
           if        w-rig-cod-cge        =    w-rig-cod-cge-sav
                     go to cnt-tdo-rig-400.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tes-prt-iva          .
           move      spaces               to   w-tes-cod-fis          .
           move      zero                 to   w-tes-cod-cge          .
           move      zero                 to   w-tes-cod-cge-sns      .
           move      spaces               to   w-tes-cod-cge-des      .
           move      zero                 to   w-tes-sel-a13          .
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      spaces               to   w-rig-cod-fnt-naz      .
           move      zero                 to   w-rig-prt-iva          .
           move      spaces               to   w-rig-cod-fis          .
           move      zero                 to   w-rig-cod-cge          .
           move      zero                 to   w-rig-cod-cge-sav      .
           move      spaces               to   w-rig-cod-cge-des      .
           move      spaces               to   w-rig-snx-a13          .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-rag-min        to   rf-fnt-rag-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-min        to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Ordinamento per Ragione sociale             *
      *                  *---------------------------------------------*
           if        rf-fnt-rag-key       >    w-tes-rag-max
                     go to car-fil-rap-900.
      *                      *-----------------------------------------*
      ...
      *                  * Ordinamento per Codice                      *
      *                  *---------------------------------------------*
           if        rf-fnt-cod-fnt       >    w-tes-cod-max
                     go to car-fil-rap-900.
      *                      *-----------------------------------------*
      *                      * A selezioni sul record                  *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   sel-rec-fnt-000      thru sel-rec-fnt-999        .
      *                  *---------------------------------------------*
      *                  * Test su flag di selezione                   *
      *                  *---------------------------------------------*
           if        w-sel-rec-fnt-flg    not  = spaces
                     go to car-fil-rap-200.
       car-fil-rap-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-sel-rec-fnt-flg      .
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      *              *-------------------------------------------------*
       sel-rec-fnt-100.
      ...
      *                  * Partita Iva                                 *
      *                  *---------------------------------------------*
           if        w-tes-prt-iva        =    zero
                     go to sel-rec-fnt-200.
           if        rf-fnt-prt-iva       not  = w-tes-prt-iva
                     go to sel-rec-fnt-900.
       sel-rec-fnt-200.
      *                  *---------------------------------------------*
      *                  * Codice fiscale                              *
      *                  *---------------------------------------------*
           if        w-tes-cod-fis        =    spaces
                     go to sel-rec-fnt-300.
           if        rf-fnt-cod-fis       not  = w-tes-cod-fis
                     go to sel-rec-fnt-900.
       sel-rec-fnt-300.
      *                  *---------------------------------------------*
      *                  * Sottoconto contabile                        *
      *                  *---------------------------------------------*
           if        w-tes-cod-cge        =    zero
                     go to sel-rec-fnt-400.
           if        rf-fnt-cod-cge       not  = w-tes-cod-cge
                     go to sel-rec-fnt-900.
       sel-rec-fnt-400.
      *                  *---------------------------------------------*
      *                  * Si/No allegato iva                          *
      *                  *---------------------------------------------*
           if        w-tes-sel-a13        =    1
                     go to sel-rec-fnt-500.
           if        w-tes-sel-a13        =    2 and
                     rf-fnt-snx-a13       not  = "N"
                     go to sel-rec-fnt-900.
           if        w-tes-sel-a13        =    3 and
                     rf-fnt-snx-a13       not  = "S"
                     go to sel-rec-fnt-900.
       sel-rec-fnt-500.
      *                  *---------------------------------------------*
      *                  * Codice esenzione iva                        *
      *                  *---------------------------------------------*
           if        w-tes-cod-iva        =    zero
                     go to sel-rec-fnt-800.
           if        rf-fnt-cod-iva       not  = w-tes-cod-iva
                     go to sel-rec-fnt-900.
       sel-rec-fnt-800.
      *                  *---------------------------------------------*
      *                  * Uscita per selezione superata               *
      *                  *---------------------------------------------*
           go to     sel-rec-fnt-999.
       sel-rec-fnt-900.
      *              *-------------------------------------------------*
      ...
      *                      * record [fnt]                            *
      *                      *-----------------------------------------*
           move      rf-fnt-cod-fnt       to   w-rig-cod-fnt          .
           move      rf-fnt-rag-soc       to   w-rig-cod-fnt-rag      .
           move      rf-fnt-cod-naz       to   w-rig-cod-fnt-naz      .
           move      rf-fnt-cod-iva       to   w-rig-cod-iva          .
           move      rf-fnt-prt-iva       to   w-rig-prt-iva          .
           move      rf-fnt-cod-fis       to   w-rig-cod-fis          .
           move      rf-fnt-snx-a13       to   w-rig-snx-a13          .
           move      rf-fnt-cod-cge       to   w-rig-cod-cge          .
           move      rf-fnt-cod-cge       to   w-rig-cod-cge-sav      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Valori dipendenti dal codice iva    *
      *                          *-------------------------------------*
           move      w-rig-cod-iva        to   w-let-arc-zci-cod      .
           perform   let-arc-zci-000      thru let-arc-zci-999        .
           move      w-let-arc-zci-des    to   w-rig-cod-iva-des      .
      *                          *-------------------------------------*
      *                          * Valori dipendenti dal codice sotto- *
      *                          * conto contabile                     *
      *                          *-------------------------------------*
           move      w-rig-cod-cge        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cge-sos        to   w-rig-cod-cge          .
       car-eff-rig-sos-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       sca-fil-rap-190.
      *              *-------------------------------------------------*
      *              * Lettura, con lock, del record [fnt]             *
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODFNT    "         to   f-key                  .
           move      w-rig-cod-fnt        to   rf-fnt-cod-fnt         .
           move      "pgm/cge/fls/ioc/obj/ioffnt"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      w-rig-cod-iva        to   rf-fnt-cod-iva         .
           move      w-rig-prt-iva        to   rf-fnt-prt-iva         .
           move      w-rig-cod-fis        to   rf-fnt-cod-fis         .
           move      w-rig-snx-a13        to   rf-fnt-snx-a13         .
           move      w-rig-cod-cge        to   rf-fnt-cod-cge         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Routine per Expand anagrafica contabile fornitore         *
      *    *-----------------------------------------------------------*
       rou-exp-ana-000.
      *              *-------------------------------------------------*
      *              * Salvataggio immagine video                      *
      ...
      *              *-------------------------------------------------*
           ...
           move      10                   to   v-lin                  .
           move      17                   to   v-pos                  .
           move      "Il numero fornitori selezionati e' maggiore di "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-fnt-cod-fnt       to   w-ctl-dup-piv-clt      .
       ctl-dup-piv-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-fnt-cod-fnt       to   w-ctl-dup-cfi-clt      .
       ctl-dup-cfi-500.
      *              *-------------------------------------------------*
      *              * Riciclo a record [fnt] successivo               *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione codice fornitore contabile *
      *    *-----------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/cge/prg/obj/pcge5502"                       .
       cnc-rlt-sup-999.
           exit.
