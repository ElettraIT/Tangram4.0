      ...
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione natura operazione       *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-des-zno-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zno-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-zno-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-zno-cod : natura operazione    *
      *                                                                *
      *                       w-cod-des-zno-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-zno-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-zno-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-zno-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zno-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-zno-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zno-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-zno-cod : natura operazione    *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-zno.
           05  w-aux-cde-zno-nli          pic  9(02)                  .
           05  w-aux-cde-zno-crb          pic  9(02)                  .
           05  w-aux-cde-zno-cpb          pic  9(02)                  .
           05  w-aux-cde-zno-cpa          pic  9(02)                  .
           05  w-aux-cde-zno-bix          pic  9(02)                  .
           05  w-aux-cde-zno-buf
                               occurs 30.
               10  w-aux-cde-zno-bco      pic  x(05)                  .
               10  w-aux-cde-zno-bde      pic  x(40)                  .
           05  w-aux-cde-zno-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-zno-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-zno-lt2      pic  9(01)                  .
           05  w-aux-cde-zno-dup          pic  x(20)                  .
           05  w-aux-cde-zno-dmx.
               10  w-aux-cde-zno-dch
                               occurs 20  pic  x(01)                  .
           05  w-aux-cde-zno-c01          pic  9(02)                  .
           05  w-aux-cde-zno-c02          pic  9(02)                  .
           05  w-aux-cde-zno-c03          pic  9(02)                  .
           05  w-aux-cde-zno-c04          pic  9(02)                  .
           05  w-aux-cde-zno-c05          pic  9(02)                  .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-zno
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zno-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-zno-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-zno-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-zno-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-zno-ope    =    "A+" or
                     w-cod-des-zno-ope    =    "I+" or
                     w-cod-des-zno-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-zno-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Codice natura operazione di default         *
      *                  *---------------------------------------------*
           move      w-cod-des-zno-cod    to   w-cod-des-zno-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-zno-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-zno-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-zno-s90    to   v-ufk                  .
           move      w-cod-des-zno-lin    to   v-lin                  .
           move      w-cod-des-zno-pos    to   v-pos                  .
           move      w-cod-des-zno-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-zno-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zno-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-zno-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-zno-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-zno-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-zno-cod    to   w-cod-des-zno-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-zno-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-zno-dln    =    zero or
                     w-cod-des-zno-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-zno-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      20                   to   v-car                  .
           move      w-cod-des-zno-dln    to   v-lin                  .
           move      w-cod-des-zno-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-zno-dln    to   v-lin                  .
           move      w-cod-des-zno-dps    to   v-pos                  .
           move      w-aux-cde-zno-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-zno-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-zno-dup    to   w-aux-cde-zno-dmx      .
           move      20                   to   w-aux-cde-zno-c01      .
       aco-680.
           if        w-aux-cde-zno-c01    >    zero
                     if    w-aux-cde-zno-dch
                          (w-aux-cde-zno-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-zno-dch
                                              (w-aux-cde-zno-c01)
                           subtract 1     from w-aux-cde-zno-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-zno-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-zno-dup    to   rf-zno-des-key         .
           move      spaces               to   rf-zno-cod-nop         .
           move      "pgm/cge/fls/ioc/obj/iofzno"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-zno-des-key       >    w-aux-cde-zno-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-zno-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-zno-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      rf-zno-cod-nop       to   w-aux-cde-zno-bco
                                              (w-aux-cde-zno-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione                     *
      *                              *---------------------------------*
           move      rf-zno-des-nop       to   w-aux-cde-zno-bde
                                              (w-aux-cde-zno-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-zno-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-zno-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-zno-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      20                   to   s-car                  .
           move      w-aux-cde-zno-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-zno-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-zno-bco
                    (w-aux-cde-zno-bix)   to   w-cod-des-zno-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-zno-crb    to   w-aux-cde-zno-cpb      .
           subtract  1                    from w-aux-cde-zno-cpb      .
           divide    6                    into w-aux-cde-zno-cpb      .
           add       1                    to   w-aux-cde-zno-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-zno-c01      .
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      08                   to   v-lin                  .
           move      17                   to   v-pos                  .
           move      "  Selezionare la natura operazione desiderata  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                              * di indice (w-aux-cde-zno-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-zno-c01    to   w-aux-cde-zno-nli      .
       aco-865.
           if        w-aux-cde-zno-nli    >    6
                     subtract  6          from w-aux-cde-zno-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-zno-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-zno-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-zno-c01    <    w-aux-cde-zno-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-zno-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-zno-cpa    <    w-aux-cde-zno-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-zno-nli    to   v-lin                  .
           move      24                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-zno-c01    to   w-aux-cde-zno-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-zno-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-zno-cpa    to   w-aux-cde-zno-c01      .
           multiply  6                    by   w-aux-cde-zno-c01      .
           subtract  5                    from w-aux-cde-zno-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-zno-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-zno-c01    to   w-aux-cde-zno-c02      .
           add       5                    to   w-aux-cde-zno-c02      .
           divide    6                    into w-aux-cde-zno-c02      .
           move      w-aux-cde-zno-c02    to   w-aux-cde-zno-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-zno-c02      .
           multiply  6                    by   w-aux-cde-zno-c02      .
           add       1                    to   w-aux-cde-zno-c02      .
           add       5
                     w-aux-cde-zno-c02  giving w-aux-cde-zno-c03      .
           move      w-aux-cde-zno-c03    to   w-aux-cde-zno-c04      .
           if        w-aux-cde-zno-c03    >    w-aux-cde-zno-crb
                     move  w-aux-cde-zno-crb
                                          to   w-aux-cde-zno-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-zno-c05      .
       aco-951.
      *                                  *-----------------------------*
      *                                  * Visualizzazione elemento    *
      *                                  *-----------------------------*
      *                                      *-------------------------*
      *                                      * Codice natura operaz.   *
      *                                      *-------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      05                   to   v-car                  .
           move      w-aux-cde-zno-c05    to   v-lin                  .
           move      19                   to   v-pos                  .
           move      w-aux-cde-zno-bco
                    (w-aux-cde-zno-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      *                                      * Descrizione             *
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-zno-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-zno-c02    not  > w-aux-cde-zno-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-zno-c02    >    w-aux-cde-zno-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-zno-cpa    to   w-aux-cde-zno-lt1      .
           move      w-aux-cde-zno-cpb    to   w-aux-cde-zno-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-zno-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
