      ...
      *                       Ultima revisione:    NdK del 05/01/10    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *              Input  : w-cod-mne-cli-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-mne-cli-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-mne-cli-ope : "AC"                 *
      *                                                                *
      *                       w-cod-mne-cli-cod : codice cliente       *
      *                                                                *
      *                       w-cod-mne-cli-lin : linea codice         *
      *                                                                *
      *                       w-cod-mne-cli-pos : posizione codice     *
      *                                                                *
      *                       w-cod-mne-cli-rln : linea ragione soc.   *
      *                                                                *
      *                       w-cod-mne-cli-rps : posizione rag. soc.  *
      *                                                                *
      *                       w-cod-mne-cli-vln : linea indirizzo      *
      *                                                                *
      *                       w-cod-mne-cli-vps : posizione indirizzo  *
      *                                                                *
      *                       w-cod-mne-cli-lln : linea localita'      *
      *                                                                *
      *                       w-cod-mne-cli-lps : posizione localita'  *
      *                                                                *
      *                                                                *
      *              Output : w-cod-mne-cli-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-mne-cli-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-mne-cli-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-mne-cli-cod : codice cliente       *
      ...
      ******************************************************************
       Procedure Division                using w-cod-mne-cli
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-mne-cli-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-mne-cli-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-mne-cli-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-mne-cli-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-mne-cli-ope    =    "A+" or
                     w-cod-mne-cli-ope    =    "I+" or
                     w-cod-mne-cli-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-mne-cli-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      w-cod-mne-cli-cod    to   w-cod-mne-cli-num      .
           move      v-edm                to   w-cod-mne-cli-edm      .
           move      v-ufk                to   w-cod-mne-cli-ufk      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-mne-cli-edm    to   v-edm                  .
           move      w-cod-mne-cli-num    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-edt                to   w-cod-mne-cli-alf      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-mne-cli-ufk    to   v-ufk                  .
           move      w-cod-mne-cli-lin    to   v-lin                  .
           move      w-cod-mne-cli-pos    to   v-pos                  .
           move      w-cod-mne-cli-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-mne-cli-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      v-alf                to   w-cod-mne-cli-alf      .
      *              *-------------------------------------------------*
      *              * Test se Exit o Delt                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-cod-mne-cli-num    to   w-cod-mne-cli-cod      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-num                to   w-cod-mne-cli-num      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-cod-mne-cli-alf    =    spaces
                     move  zero           to   w-cod-mne-cli-num
                     go to aco-075.
           if        w-cod-mne-cli-cha (1)
                                          =    spaces
                     go to aco-025.
      ...
      *                  *---------------------------------------------*
           move      w-cod-mne-cli-alf    to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
       ...
       aco-190.
           ...
           if        w-cod-mne-cli-cha
                    ...
                    (w-aux-mne-cli-c01)   >    "9"
                     go to aco-225.
           multiply  10                   by   w-cod-mne-cli-num      .
           move      w-cod-mne-cli-cha
                    (w-aux-mne-cli-c01)   to   w-cod-mne-cli-chn (10) .
           go to     aco-190.
       aco-200.
      *              *-------------------------------------------------*
      ...
      *                  * merico : uscita                             *
      *                  *---------------------------------------------*
           if        v-edt                =    w-cod-mne-cli-alf
                     go to aco-075
      *                  *---------------------------------------------*
      *                  * Altrimenti : rivisualizzazione              *
      *                  *---------------------------------------------*
           else      move  v-edt          to   w-cod-mne-cli-alf
                     go to aco-050.
       aco-225.
      *              *-------------------------------------------------*
      ...
      *                  * gione sociale                               *
      *                  *---------------------------------------------*
           if        w-cod-mne-cli-alf    =    "-" and
                     w-cod-mne-cli-rln    not  = zero
                     go to aco-500.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-cod-mne-cli-alf    to   rf-cli-cod-mne         .
      ...
      *                      * caratteri                               *
      *                      *-----------------------------------------*
           move      rf-cli-cod-mne       to   w-aux-mne-cli-m10      .
      *                      *-----------------------------------------*
      *                      * Test se oltre il max                    *
      *                      *-----------------------------------------*
           if        w-aux-mne-cli-m10    not  = w-cod-mne-cli-alf
                     go to aco-250.
      *                      *-----------------------------------------*
      ...
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      rf-cli-cod-cli       to   w-aux-mne-cli-cbu
                                              (w-aux-mne-cli-crb)     .
           move      rf-cli-cod-mne       to   w-aux-mne-cli-mbu
                                              (w-aux-mne-cli-crb)     .
           move      rf-cli-rag-soc       to   w-aux-mne-cli-rbu
                                              (w-aux-mne-cli-crb)     .
           move      rf-cli-via-cli       to   w-aux-mne-cli-vbu
                                              (w-aux-mne-cli-crb)     .
           move      rf-cli-loc-cli       to   w-aux-mne-cli-lbu
                                              (w-aux-mne-cli-crb)     .
           move      rf-cli-prt-iva       to   w-aux-mne-cli-pbu
                                              (w-aux-mne-cli-crb)     .
      *                      *-----------------------------------------*
      *                      * Riciclo a lettura                       *
      *                      *-----------------------------------------*
      ...
      *                      * non trovato                             *
      *                      *-----------------------------------------*
           if        w-cod-mne-cli-rln    =    zero
                     go to aco-276.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
           move      w-cod-mne-cli-rln    to   v-lin                  .
           move      w-cod-mne-cli-rps    to   v-pos                  .
           move      all   "."            to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-276.
           if        w-cod-mne-cli-vln    =    zero
                     go to aco-277.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
           move      w-cod-mne-cli-vln    to   v-lin                  .
           move      w-cod-mne-cli-vps    to   v-pos                  .
           move      spaces               to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-277.
           if        w-cod-mne-cli-lln    =    zero
                     go to aco-278.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
           move      w-cod-mne-cli-lln    to   v-lin                  .
           move      w-cod-mne-cli-lps    to   v-pos                  .
           move      spaces               to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-278.
      ...
      *                      *-----------------------------------------*
           ...
           move      05                   to   v-lin                  .
           move      23                   to   v-pos                  .
           move      " Selezionare il cliente desiderato "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *                      *-----------------------------------------*
       ...
       aco-382.
           ...
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      w-aux-mne-cli-cbu
                    (w-aux-mne-cli-c01)   to   w-cod-mne-cli-num      .
           go to     aco-200.
       aco-384.
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      10                   to   s-car                  .
           move      w-cod-mne-cli-alf    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           go to     aco-125.
       aco-500.
      ...
      *                      *-----------------------------------------*
           if        w-aux-mne-cli-tpf    =    "P"
                     if    rf-cli-prt-iva =    w-aux-mne-cli-p00
                           go to  aco-625
                     else  go to  aco-250.
           if        w-aux-mne-cli-tpf    =    "F"
                     if    rf-cli-cod-fis =    w-aux-mne-cli-f00
                           go to  aco-625
                     else  go to  aco-250.
           if        rf-cli-rag-key       >    w-aux-mne-cli-rmx
                     go to aco-250.
       aco-625.
      *                      *-----------------------------------------*
      *                      * Incremento numero records nel buffer    *
