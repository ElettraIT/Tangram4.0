      ...
      *                                   Fase:    cge978              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/11/10    *
      *                       Ultima revisione:    NdK del 17/11/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge9781:        *
      *                                                                *
      *                    Stampa di controllo saldi iniziali          *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "C"            to   rr-tip-cnt
           else if   v-num                =    02
                     move  "F"            to   rr-tip-cnt
           else      move  spaces         to   rr-tip-cnt             .
       acc-tip-cnt-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-tip-cnt           =    spaces
