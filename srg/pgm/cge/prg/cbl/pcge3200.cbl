      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge3201:        *
      *                                                                *
           ...
           05  w-exp-tip-stp.
               ...
               10  w-exp-tip-stp-tbl.
                   ...
                   15  filler             pic  x(20) value
                            "Definitiva          "                    .
      *        *-------------------------------------------------------*
      *        * Work per : Si/no stampa data                          *
      *        *-------------------------------------------------------*
           05  w-exp-snx-std.
               10  w-exp-snx-std-num      pic  9(02)       value 3    .
               10  w-exp-snx-std-lun      pic  9(02)       value 20   .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rn-dat-bil             .
      *              *-------------------------------------------------*
      *              * Lettura dati relativi partitari contabilita'    *
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
      ...
      *              * stampa definitiva                               *
      *              *-------------------------------------------------*
           if        rn-par-gen-dat-fin   not  = zero
      ...
      *                          *-------------------------------------*
           move      "ME"                 to   v-ope                  .
           move      "Nessuna registrazione di contabilita' generale da 
      -              "stampare; il programma pertanto"
                                          to   v-nt1                  .
           move      "non puo' essere eseguito"
                                          to   v-nt2                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                          *-------------------------------------*
      ...
      *                      * uscita                                  *
      *                      *-----------------------------------------*
           if        rn-par-gen-flg-avs   not  = spaces
                     go to  pre-exe-pgm-999.
      *                      *-----------------------------------------*
      *                      * Controllo data                          *
      *                      *-----------------------------------------*
           move      rn-par-gen-dat-fin   to   s-dat                  .
           move      "CD"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-sts                =    spaces
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice sottoconto min                *
      *    *-----------------------------------------------------------*
       acc-pdc-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice sottoconto min, descrizione      *
      *    *-----------------------------------------------------------*
       vis-pdc-min-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice sottoconto max                *
      *    *-----------------------------------------------------------*
       acc-pdc-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice sottoconto max, descrizione      *
      *    *-----------------------------------------------------------*
       vis-pdc-max-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Si/no stampa data          *
      *    *-----------------------------------------------------------*
       acc-snx-std-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                  *---------------------------------------------*
      *                  * Preparazione default data di stampa         *
      *                  *---------------------------------------------*
           if        rr-snx-std           =    "N"
                     move  zero           to   rr-dat-stp
           else if   rr-snx-std           =    "S"
                     move  s-dat          to   rr-dat-stp             .
      *                  *---------------------------------------------*
      *                  * Visualizzazione data di stampa              *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Data di stampa             *
      *    *-----------------------------------------------------------*
       acc-dat-stp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-350.
           if        rr-dat-stp           not  < rr-dat-min
                     go to tdo-ric-sel-800.
           move      "Controllare la data da esporre in stampa!         
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-800.
      *              *-------------------------------------------------*
      ...
      *                  * Preparazione date                           *
      *                  *---------------------------------------------*
           move      rr-dat-min           to   rn-par-gen-dat-ini     .
           move      rr-dat-max           to   rn-par-gen-dat-fin     .
           move      "#"                  to   rn-par-gen-flg-avs     .
      *                  *---------------------------------------------*
      *                  * Update                                      *
      *                  *---------------------------------------------*
           move      "FP"                 to   f-ope                  .
