      ...
      *            *---------------------------------------------------*
               10  w-ipc-dat-dtm-snx      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore della variabile di i.p.c. relativa alla    *
      *            * data                                              *
      *            *---------------------------------------------------*
               10  w-ipc-dat-dtm-val      pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
      *              * Lettura della variabile eventuale di i.p.c. per *
      *              * la data ricerca minima                          *
      *              *-------------------------------------------------*
           perform   ipc-dat-dtm-000      thru ipc-dat-dtm-999        .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to ipc-dat-dtm-200
           else      go to ipc-dat-dtm-400.
       ipc-dat-dtm-200.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
      ...
      *                  * Segnale di variabile esistente              *
      *                  *---------------------------------------------*
           move      "S"                  to   w-ipc-dat-dtm-snx      .
      *                  *---------------------------------------------*
      *                  * Valore della variabile                      *
      *                  *---------------------------------------------*
           move      s-dat                to   w-ipc-dat-dtm-val      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ipc-dat-dtm-999.
       ipc-dat-dtm-400.
      *              *-------------------------------------------------*
      *              * Se variabile non esistente                      *
      *              *-------------------------------------------------*
      ...
      *                  * Segnale di variabile non esistente          *
      *                  *---------------------------------------------*
           move      "N"                  to   w-ipc-dat-dtm-snx      .
      *                  *---------------------------------------------*
      *                  * Valore della variabile a zero               *
      *                  *---------------------------------------------*
           move      zero                 to   w-ipc-dat-dtm-val      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ipc-dat-dtm-999.
      ...
      *    *-----------------------------------------------------------*
      ...
      -              " le registrazioni contabili   "
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       relative al fornitore di tipo 'Avere forint
      -              "ori'.                         "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  * Eventuale default                           *
      *                  *---------------------------------------------*
           if        w-ipc-dat-dtm-val    =    zero
                     go to acc-dtm-min-100.
           move      w-ipc-dat-dtm-val    to   rr-dtm-min             .
       acc-dtm-min-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "  Data    N.docum.  Prt.Iva    Codice e descrizion
      -              "e causale    Importo movimento"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       stp-int-pag-400.
