      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Manutenzione codici tributo per gestione    *
      *                    modello F24                                 *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "MANUTENZIONE TRIBUTI/CAUSALI MODELLO F24"       .
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           05  w-rig-001.
               ...
               10  w-rig-cod-tpu          pic  x(05)                  .
               10  w-rig-cod-tpu-des      pic  x(50)                  .
               10  w-rig-tip-sez          pic  9(02)                  .
               10  w-rig-mod-utl          pic  x(01)                  .
               10  w-rig-snx-att          pic  x(01)                  .
               10  w-rig-stc-deb          pic  9(07)                  .
               10  w-rig-stc-deb-des      pic  x(40)                  .
               10  w-rig-stc-cre          pic  9(07)                  .
               10  w-rig-stc-cre-des      pic  x(40)                  .
           05  w-rig-002.
      ...
      *                *-----------------------------------------------*
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-cod-tpu  pic  x(04)                  .
                   15  w-lin-imm-snx-att  pic  x(01)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-des-tpu  pic  x(40)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-tip-sez  pic  x(03)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-stc-deb  pic  x(09)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-stc-cre  pic  x(09)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo sezione per le selezioni              *
      *        *-------------------------------------------------------*
           05  w-exp-sel-sez.
               10  w-exp-sel-sez-num      pic  9(02)       value 07   .
               10  w-exp-sel-sez-lun      pic  9(02)       value 40   .
               10  w-exp-sel-sez-tbl.
      ...
      *        *-------------------------------------------------------*
           05  w-exp-mod-utl.
               ...
               10  w-exp-mod-utl-lun      pic  9(02)       value 30   .
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Salvataggio per codice tributo o causale              *
      *        *-------------------------------------------------------*
           05  w-sav-cod-tpu              pic  x(05)                  .

      *    *===========================================================*
      *    * Work-area per selezioni sul record [zpu]                  *
      *    *-----------------------------------------------------------*
       01  w-sel-rec-zpu.
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-sel-rec-zpu-flg          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per selezione su sezione                       *
      *        *-------------------------------------------------------*
           05  w-sel-rec-zpu-sez          pic  9(02)                  .
      ...
      *    *===========================================================*
      *    * Work per Let su archivio [zpu]                            *
      *    *-----------------------------------------------------------*
           copy      "pgm/cge/prg/cpy/larczpu0.ltw"                   .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Sezione                          *
      *    *-----------------------------------------------------------*
       pmt-tip-sez-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-min        to   w-cod-des-zpu-cod      .
           move      05                   to   w-cod-des-zpu-lin      .
           move      30                   to   w-cod-des-zpu-pos      .
           move      05                   to   w-cod-des-zpu-dln      .
           move      36                   to   w-cod-des-zpu-dps      .
           move      "<B"                 to   v-edm                  .
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-min        to   w-let-arc-zpu-cod      .
           perform   let-arc-zpu-000      thru let-arc-zpu-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione tipo operazione  *
      *                  *---------------------------------------------*
           move      w-let-arc-zpu-des    to   w-tes-cod-min-des      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-zpu-ope      .
           move      w-tes-cod-max        to   w-cod-des-zpu-cod      .
           move      06                   to   w-cod-des-zpu-lin      .
           move      30                   to   w-cod-des-zpu-pos      .
           move      06                   to   w-cod-des-zpu-dln      .
           move      36                   to   w-cod-des-zpu-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *                  * Lettura codice tipo operazione              *
      *                  *---------------------------------------------*
           move      w-tes-cod-max        to   w-let-arc-zpu-cod      .
           perform   let-arc-zpu-000      thru let-arc-zpu-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione tipo operazione  *
      *                  *---------------------------------------------*
           move      w-let-arc-zpu-des    to   w-tes-cod-max-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione tipo operazione *
      *                  *---------------------------------------------*
           perform   vis-cod-max-des-000  thru vis-cod-max-des-999    .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-sez-lun    to   v-car                  .
           move      w-exp-sel-sez-num    to   v-ldt                  .
           move      spaces               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      11                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-sel-sez-tbl    to   v-txt                  .
           move      w-tes-tip-sez        to   v-num                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-stc-deb        to   w-cod-mne-pdc-cod      .
      ...
      *                  *---------------------------------------------*
           move      w-tes-stc-deb        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-tes-stc-deb-des      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-stc-deb        to   w-edt-cod-pdc-cod      .
      ...
      *    *-----------------------------------------------------------*
       vis-stc-deb-des-000.
           ...
           move      14                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-stc-deb-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-stc-deb-des-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-pdc-ope      .
           move      w-prs-liv-pdc        to   w-cod-mne-pdc-liv      .
           move      w-tes-stc-cre        to   w-cod-mne-pdc-cod      .
      ...
      *                  * Lettura archivio piano dei conti            *
      *                  *---------------------------------------------*
           move      w-tes-stc-cre        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-tes-stc-cre-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione sottoconto      *
      *                  *---------------------------------------------*
           perform   vis-stc-cre-des-000  thru vis-stc-cre-des-999    .
      ...
      *              *-------------------------------------------------*
           move      w-prs-liv-pdc        to   w-edt-cod-pdc-liv      .
           move      w-tes-stc-cre        to   w-edt-cod-pdc-cod      .
           move      "B"                  to   w-edt-cod-pdc-edm      .
           perform   edt-pdc-asx-000      thru edt-pdc-asx-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione                                 *
      ...
      *    *-----------------------------------------------------------*
       vis-stc-cre-des-000.
           ...
           move      17                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-tes-stc-cre-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-stc-cre-des-999.
           exit.
      ...
      *                  *---------------------------------------------*
      *                  * Accettazione Codice tributo o causale       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   acc-rig-utl-000      thru acc-rig-utl-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Si/no attivo                                *
      *                  *---------------------------------------------*
           perform   acc-rig-att-000      thru acc-rig-att-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Sottoconto per debito                       *
      *                  *---------------------------------------------*
           perform   acc-rig-deb-000      thru acc-rig-deb-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  * Sottoconto per credito                      *
      *                  *---------------------------------------------*
           perform   acc-rig-cre-000      thru acc-rig-cre-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-tpu        to   w-lin-imm-cod-tpu      .
      *                  *---------------------------------------------*
      *                  * Si/no codice attivo                         *
      *                  *---------------------------------------------*
           if        w-rig-snx-att        =    "N"
                     move  "*"            to   w-lin-imm-snx-att
           else      move  spaces         to   w-lin-imm-snx-att      .
       vis-lin-cor-460.
      *                  *---------------------------------------------*
      *                  * Descrizione tipo operazione                 *
      *                  *---------------------------------------------*
           move      w-rig-cod-tpu-des    to   w-lin-imm-des-tpu      .
       vis-lin-cor-480.
      *                  *---------------------------------------------*
      *                  * Sezione                                     *
      *                  *---------------------------------------------*
           if        w-rig-tip-sez        =    01
                     move  "ERAR"         to   w-lin-imm-tip-sez
           else if   w-rig-tip-sez        =    02
                     move  "INPS"         to   w-lin-imm-tip-sez
           else if   w-rig-tip-sez        =    03
                     move  "REG."         to   w-lin-imm-tip-sez
           else if   w-rig-tip-sez        =    04
                     move  "IMU "         to   w-lin-imm-tip-sez
           else if   w-rig-tip-sez        =    05
                     move  "INA."         to   w-lin-imm-tip-sez
           else if   w-rig-tip-sez        =    06
                     move  "EN.P"         to   w-lin-imm-tip-sez
           else      move  spaces         to   w-lin-imm-tip-sez      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      *                  * Sottoconto per debito                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-prs-liv-pdc        to   w-edt-cod-pdc-liv      .
           move      w-rig-stc-deb        to   w-edt-cod-pdc-cod      .
           move      "B"                  to   w-edt-cod-pdc-edm      .
           perform   edt-pdc-adx-000      thru edt-pdc-adx-999        .
           move      w-edt-cod-pdc-edt    to   w-lin-imm-stc-deb      .
       vis-lin-cor-520.
      *                  *---------------------------------------------*
      *                  * Sottoconto per credito                      *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-prs-liv-pdc        to   w-edt-cod-pdc-liv      .
           move      w-rig-stc-cre        to   w-edt-cod-pdc-cod      .
           move      "B"                  to   w-edt-cod-pdc-edm      .
           perform   edt-pdc-adx-000      thru edt-pdc-adx-999        .
           move      w-edt-cod-pdc-edt    to   w-lin-imm-stc-cre      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.               Codice e descrizione          
      -              "     Sez. S.Debito   S.Credito"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           perform   vis-cod-tpu-des-000  thru vis-cod-tpu-des-999    .
      *              *-------------------------------------------------*
      *              * Sezione                                         *
      *              *-------------------------------------------------*
      ...
      *              * Modalita' di utilizzo                           *
      *              *-------------------------------------------------*
           perform   vis-rig-utl-000      thru vis-rig-utl-999        .
      *              *-------------------------------------------------*
      *              * Si/no attivo                                    *
      *              *-------------------------------------------------*
           perform   vis-rig-att-000      thru vis-rig-att-999        .
      *              *-------------------------------------------------*
      *              * Sottoconto contabile                            *
      *              *-------------------------------------------------*
           perform   vis-rig-deb-000      thru vis-rig-deb-999        .
           perform   vis-rig-deb-des-000  thru vis-rig-deb-des-999    .
      *              *-------------------------------------------------*
      *              * Contropartita contabile                         *
      *              *-------------------------------------------------*
           perform   vis-rig-cre-000      thru vis-rig-cre-999        .
           perform   vis-rig-cre-des-000  thru vis-rig-cre-des-999    .
       vis-rig-cor-999.
           exit.
      ...
      *                  * Modalita' di utilizzo                       *
      *                  *---------------------------------------------*
           perform   pmt-rig-utl-000      thru pmt-rig-utl-999        .
      *                  *---------------------------------------------*
      *                  * Si/no attivo                                *
      *                  *---------------------------------------------*
           perform   pmt-rig-att-000      thru pmt-rig-att-999        .
      *                  *---------------------------------------------*
      *                  * Sottoconto contabile                        *
      *                  *---------------------------------------------*
           perform   pmt-rig-deb-000      thru pmt-rig-deb-999        .
      *                  *---------------------------------------------*
      *                  * Contropartita contabile                     *
      *                  *---------------------------------------------*
           perform   pmt-rig-cre-000      thru pmt-rig-cre-999        .
       pmt-rig-cor-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione prompt : Codice tributo o causale         *
      *    *-----------------------------------------------------------*
       pmt-cod-tpu-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Si/no attivo                     *
      *    *-----------------------------------------------------------*
       pmt-rig-att-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-tpu        to   w-sav-cod-tpu          .
       acc-cod-tpu-100.
      *              *-------------------------------------------------*
      *              * Ripristino valore precedente                    *
      *              *-------------------------------------------------*
           move      w-sav-cod-tpu        to   w-rig-cod-tpu          .
       acc-cod-tpu-125.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "AC"                 to   w-cod-des-zpu-ope      .
           move      w-rig-cod-tpu        to   w-cod-des-zpu-cod      .
           move      17                   to   w-cod-des-zpu-lin      .
           move      25                   to   w-cod-des-zpu-pos      .
           move      zero                 to   w-cod-des-zpu-dln      .
           move      zero                 to   w-cod-des-zpu-dps      .
           move      "<B"                 to   v-edm                  .
      *                  *---------------------------------------------*
      *                  * Tasti funzione                              *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-cod-tpu-152.
           perform   cod-des-zpu-cll-000  thru cod-des-zpu-cll-999    .
           if        w-cod-des-zpu-ope    =    "F+"
                     go to acc-cod-tpu-154.
           if        w-cod-des-zpu-ope    =    "AC"
                     go to acc-cod-tpu-156.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-tpu-154.
           perform   cod-des-zpu-foi-000  thru cod-des-zpu-foi-999    .
           go to     acc-cod-tpu-152.
       acc-cod-tpu-156.
           move      w-cod-des-zpu-cod    to   v-alf                  .
       acc-cod-tpu-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces
                     go to acc-cod-tpu-400.
       acc-cod-tpu-250.
      *              *-------------------------------------------------*
      *              * Se Slct                                         *
      *              *-------------------------------------------------*
           if        v-key                not  = "SLCT"
                     go to acc-cod-tpu-300.
       acc-cod-tpu-255.
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice tributo o causale, descrizione   *
      *    *-----------------------------------------------------------*
       vis-cod-tpu-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      17                   to   v-lin                  .
           move      31                   to   v-pos                  .
           move      w-rig-cod-tpu-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-tpu-des-999.
           exit.
      ...
      *
           if        w-rig-mod-utl        =    "D"
                     move  01             to   v-num
           else if   w-rig-mod-utl        =    "R"
                     move  02             to   v-num
           else if   w-rig-mod-utl        =    "E"
                     move  03             to   v-num
           else if   w-rig-mod-utl        =    "C"
                     move  04             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-utl-999.
       acc-rig-utl-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "D"            to   w-rig-mod-utl
           else if   v-num                =    02
                     move  "R"            to   w-rig-mod-utl
           else if   v-num                =    03
                     move  "E"            to   w-rig-mod-utl
           else if   v-num                =    04
                     move  "C"            to   w-rig-mod-utl
           else      move  spaces         to   w-rig-mod-utl          .
       acc-rig-utl-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *
           if        w-rig-snx-att        =    "S"    or
                     w-rig-snx-att        =    spaces
                     move  01             to   v-num
           else if   w-rig-snx-att        =    "N"
                     move  02             to   v-num
           else      move  zero           to   v-num                  .
      *
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-att-999.
       acc-rig-att-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "S"            to   w-rig-snx-att
           else if   v-num                =    02
                     move  "N"            to   w-rig-snx-att
           else      move  spaces         to   w-rig-snx-att          .
       acc-rig-att-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-pdc-ope      .
           move      w-prs-liv-pdc        to   w-cod-mne-pdc-liv      .
           move      w-rig-stc-deb        to   w-cod-mne-pdc-cod      .
       ...
       acc-rig-deb-110.
           perform   cod-mne-pdc-cll-000  thru cod-mne-pdc-cll-999    .
           if        w-cod-mne-pdc-ope    =    "F+"
                     go to acc-rig-deb-115.
           if        w-cod-mne-pdc-ope    =    "AC"
                     go to acc-rig-deb-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-deb-115.
           perform   cod-mne-pdc-foi-000  thru cod-mne-pdc-foi-999    .
           go to     acc-rig-deb-110.
       acc-rig-deb-120.
           move      w-cod-mne-pdc-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-deb-999.
       acc-rig-deb-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-stc-deb          .
       acc-rig-deb-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura archivio piano dei conti            *
      *                  *---------------------------------------------*
           move      w-rig-stc-deb        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-rig-stc-deb-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione sottoconto      *
      *                  *---------------------------------------------*
           perform   vis-rig-deb-des-000  thru vis-rig-deb-des-999    .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-pdc-ope      .
           move      w-prs-liv-pdc        to   w-cod-mne-pdc-liv      .
           move      w-rig-stc-cre        to   w-cod-mne-pdc-cod      .
       ...
       acc-rig-cre-110.
           perform   cod-mne-pdc-cll-000  thru cod-mne-pdc-cll-999    .
           if        w-cod-mne-pdc-ope    =    "F+"
                     go to acc-rig-cre-115.
           if        w-cod-mne-pdc-ope    =    "AC"
                     go to acc-rig-cre-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-cre-115.
           perform   cod-mne-pdc-foi-000  thru cod-mne-pdc-foi-999    .
           go to     acc-rig-cre-110.
       acc-rig-cre-120.
           move      w-cod-mne-pdc-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-rig-cre-999.
       acc-rig-cre-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-stc-cre          .
       acc-rig-cre-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura archivio piano dei conti            *
      *                  *---------------------------------------------*
           move      w-rig-stc-cre        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-rig-stc-cre-des      .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione sottoconto      *
      *                  *---------------------------------------------*
           perform   vis-rig-cre-des-000  thru vis-rig-cre-des-999    .
      ...
      *    *-----------------------------------------------------------*
       vis-rig-cre-des-000.
           ...
           move      21                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-stc-cre-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-cre-des-999.
           exit.
      ...
      *                      * Ordinamento per Codice                  *
      *                      *-----------------------------------------*
           if        w-tes-cod-min        =    spaces and
                     w-tes-cod-max        =    spaces
                     move   all "z"       to   w-tes-cod-max
           else if   w-tes-cod-min        not  = spaces and
                     w-tes-cod-max        =    spaces
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-101.
           if        w-rig-cod-tpu        =    zero
                     go to cnt-tdo-rig-150.
           if        w-rig-cod-tpu        =    0600 or
                     w-rig-cod-tpu        =    0620
                     go to cnt-tdo-rig-150.
           if        w-rig-cod-tpu        not  < 0101 and
                     w-rig-cod-tpu        not  > 0111
                     go to cnt-tdo-rig-105
           else if   w-rig-cod-tpu        not  < 0301 and
                     w-rig-cod-tpu        not  > 0304
                     go to cnt-tdo-rig-105
           else if   w-rig-cod-tpu        =    0161
                     go to cnt-tdo-rig-105
           else      go to cnt-tdo-rig-150.
       cnt-tdo-rig-105.
           if        w-rig-stc-deb        =    zero
                     go to cnt-tdo-rig-150.
           if        w-rig-stc-deb        not  = zero
                     go to cnt-tdo-rig-150.
           if        w-rig-cod-tpu        not  < 0301 and
                     w-rig-cod-tpu        not  > 0304
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-tes-cod-min          .
           move      spaces               to   w-tes-cod-min-des      .
           move      spaces               to   w-tes-cod-max          .
           move      spaces               to   w-tes-cod-max-des      .
      *              *-------------------------------------------------*
      *              * Normalizzazione selettori sui dati              *
      *              *-------------------------------------------------*
           move      zero                 to   w-tes-tip-sez          .
           move      zero                 to   w-tes-stc-deb          .
           move      spaces               to   w-tes-stc-deb-des      .
           move      zero                 to   w-tes-stc-cre          .
           move      spaces               to   w-tes-stc-cre-des      .
       nor-key-reg-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   w-rig-cod-tpu          .
           move      spaces               to   w-rig-cod-tpu-des      .
      *              *-------------------------------------------------*
      *              * Normalizzazione dati da modificare              *
      *              *-------------------------------------------------*
           move      zero                 to   w-rig-tip-sez          .
           move      spaces               to   w-rig-mod-utl          .
           move      spaces               to   w-rig-snx-att          .
           move      zero                 to   w-rig-stc-deb          .
           move      spaces               to   w-rig-stc-deb-des      .
           move      zero                 to   w-rig-stc-cre          .
           move      spaces               to   w-rig-stc-cre-des      .
       nor-nok-rig-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "CODTPU    "         to   f-key                  .
           move      w-tes-cod-min        to   rf-zpu-cod-tpu         .
           move      "pgm/cge/fls/ioc/obj/iofzpu"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Ordinamento per Codice                      *
      *                  *---------------------------------------------*
           if        rf-zpu-cod-tpu       >    w-tes-cod-max
                     go to car-fil-rap-900.
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   sel-rec-zpu-000      thru sel-rec-zpu-999        .
      *                  *---------------------------------------------*
      *                  * Test su flag di selezione                   *
      *                  *---------------------------------------------*
           if        w-sel-rec-zpu-flg    not  = spaces
                     go to car-fil-rap-200.
       car-fil-rap-500.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       car-fil-rap-600.
      *              *-------------------------------------------------*
      *              * Riciclo a Read Next su file [zpu]               *
      *              *-------------------------------------------------*
           go to     car-fil-rap-200.
       car-fil-rap-900.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Selezioni sul record [zpu]                                *
      *    *-----------------------------------------------------------*
       sel-rec-zpu-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di selezione               *
      *              *-------------------------------------------------*
           move      spaces               to   w-sel-rec-zpu-flg      .
       sel-rec-zpu-010.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-tip-sez        =    01
                     go to sel-rec-zpu-200.
      *
           subtract  1                    from w-tes-tip-sez
                                        giving w-sel-rec-zpu-sez      .
      *
           if        rf-zpu-tip-sez       not  = w-sel-rec-zpu-sez
                     go to sel-rec-zpu-900.
       sel-rec-zpu-200.
      *                  *---------------------------------------------*
      *                  * Sottoconto per debito                       *
      *                  *---------------------------------------------*
           if        w-tes-stc-deb        =    zero
                     go to sel-rec-zpu-300.
           if        rf-zpu-stc-deb       not  = w-tes-stc-deb
                     go to sel-rec-zpu-900.
       sel-rec-zpu-300.
      *                  *---------------------------------------------*
      *                  * Sottoconto per credito                      *
      *                  *---------------------------------------------*
           if        w-tes-stc-cre        =    zero
                     go to sel-rec-zpu-800.
           if        rf-zpu-stc-cre       not  = w-tes-stc-cre
                     go to sel-rec-zpu-900.
       sel-rec-zpu-800.
      *                  *---------------------------------------------*
      *                  * Uscita per selezione superata               *
      *                  *---------------------------------------------*
           go to     sel-rec-zpu-999.
       sel-rec-zpu-900.
      *              *-------------------------------------------------*
      ...
      *                          * ne                                  *
      *                          *-------------------------------------*
           move      rf-zpu-cod-tpu       to   w-rig-cod-tpu          .
           move      rf-zpu-des-tpu       to   w-rig-cod-tpu-des      .
      *                          *-------------------------------------*
      *                          * Sezione                             *
      *                          *-------------------------------------*
           move      rf-zpu-tip-sez       to   w-rig-tip-sez          .
      *                          *-------------------------------------*
      *                          * Modalita' di utilizzo               *
      *                          *-------------------------------------*
           move      rf-zpu-mod-utl       to   w-rig-mod-utl          .
      *                          *-------------------------------------*
      *                          * Si/no attivo                        *
      *                          *-------------------------------------*
           move      rf-zpu-snx-att       to   w-rig-snx-att          .
      *                          *-------------------------------------*
      *                          * Sottoconto contabile                *
      *                          *-------------------------------------*
           move      rf-zpu-stc-deb       to   w-rig-stc-deb          .
      *                          *-------------------------------------*
      *                          * Contropartita contabile             *
      *                          *-------------------------------------*
           move      rf-zpu-stc-cre       to   w-rig-stc-cre          .
      *                      *-----------------------------------------*
      *                      * Valori determinati indirettamente da    *
      *                      * record [zpu]                            *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Descrizione sottoconto per debito   *
      *                          *-------------------------------------*
           move      w-rig-stc-deb        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-rig-stc-deb-des      .
      *                          *-------------------------------------*
      *                          * Descrizione sottoconto per credito  *
      *                          *-------------------------------------*
           move      w-rig-stc-cre        to   w-let-arc-pdc-cod      .
           perform   let-arc-pdc-000      thru let-arc-pdc-999        .
           move      w-let-arc-pdc-des    to   w-rig-stc-cre-des      .
      ...
      *              *-------------------------------------------------*
      *              * Lettura, con lock, del record [zpu]             *
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODTPU    "         to   f-key                  .
           move      w-rig-cod-tpu        to   rf-zpu-cod-tpu         .
           move      "pgm/cge/fls/ioc/obj/iofzpu"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Sezione                             *
      *                          *-------------------------------------*
           move      w-rig-tip-sez        to   rf-zpu-tip-sez         .
      *                          *-------------------------------------*
      *                          * Modalita' di utilizzo               *
      *                          *-------------------------------------*
           move      w-rig-mod-utl        to   rf-zpu-mod-utl         .
      *                          *-------------------------------------*
      *                          * Si/no attivo                        *
      *                          *-------------------------------------*
           move      w-rig-snx-att        to   rf-zpu-snx-att         .
      *                          *-------------------------------------*
      *                          * Sottoconto contabile                *
      *                          *-------------------------------------*
           move      w-rig-stc-deb        to   rf-zpu-stc-deb         .
      *                          *-------------------------------------*
      *                          * Contropartita contabile             *
      *                          *-------------------------------------*
           move      w-rig-stc-cre        to   rf-zpu-stc-cre         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [zpu]                         *
      *    *-----------------------------------------------------------*
           copy      "pgm/cge/prg/cpy/larczpu0.lts"                   .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/cge/prg/obj/pcge0852"                       .
       cnc-rlt-sup-999.
           exit.
