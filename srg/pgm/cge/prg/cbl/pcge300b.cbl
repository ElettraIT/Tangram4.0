      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per Det partite aperte fornitore                 *
      *        *-------------------------------------------------------*
           05  w-det-pap-fnt.
               10  w-det-pap-fnt-cod      pic  9(07)                  .
               10  w-det-pap-fnt-flg      pic  x(01)                  .
               10  w-det-pap-fnt-msg      pic  x(76)                  .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       pre-exe-pgm-400.
      *                  *---------------------------------------------*
      *                  * Determinazione partite aperte fornitore     *
      *                  *---------------------------------------------*
           move      w-lnk-cod-cof        to   w-det-pap-fnt-cod      .
           perform   det-pap-fnt-000      thru det-pap-fnt-999        .
           if        w-det-pap-fnt-flg    =    spaces
                     go to pre-exe-pgm-500.
      *                      *-----------------------------------------*
      *                      * Messaggio di errore                     *
      *                      *-----------------------------------------*
           move      "ME"                 to   v-ope                  .
           move      w-det-pap-fnt-msg    to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      *                      * Uscita con errore                       *
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-det-pap-fnt-flg      .
      *              *-------------------------------------------------*
      *              * Flag di primo passaggio                         *
      *              *-------------------------------------------------*
           move      "#"                  to   w-par-flg-uno          .
      *              *-------------------------------------------------*
      *              * Inizializzazione saldo fornitore                *
      *              *-------------------------------------------------*
           move      zero                 to   w-par-sdo-fnt          .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-det-pap-fnt-cod    to   rf-mgr-cod-arc         .
      *                  *---------------------------------------------*
      *                  * Operazione di 'Start'                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "Attenzione : nessuna partita aperta per il fornito
      -              "re !"               to   w-det-pap-fnt-msg      .
      *                      *-----------------------------------------*
      *                      * Uscita con segnale di errore            *
      *                      *-----------------------------------------*
           move      "#"                  to   w-det-pap-fnt-flg      .
           go to     det-pap-fnt-999.
       det-pap-fnt-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to  det-pap-fnt-800.
      *              *-------------------------------------------------*
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-mgr-tip-arc       not  = "F"            or
                     rf-mgr-cod-arc       not  = w-det-pap-fnt-cod
                     go to  det-pap-fnt-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rf-mgr-dat-rif       =    w-par-rot-dat and
                     ...
                     go to  det-pap-fnt-500.
      *                  *---------------------------------------------*
      *                  * Fine partita precedente                     *
      *                  *---------------------------------------------*
           perform   det-pap-fnt-910      thru det-pap-fnt-919        .
           if        w-par-num-ele        not  > w-par-max-ele
                     go to  det-pap-fnt-400.
       det-pap-fnt-350.
      *                      *-----------------------------------------*
      *                      * Se esubero numero partite per fornitore *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Composizione messaggio              *
      *                          *-------------------------------------*
           move      "Attenzione : fornitore con partite aperte oltre ii
      -              " massimo consentito !"
                                          to   w-det-pap-fnt-msg      .
      *                          *-------------------------------------*
      *                          * Uscita con segnale di errore        *
      *                          *-------------------------------------*
           move      "#"                  to   w-det-pap-fnt-flg      .
      ...
      *                  *---------------------------------------------*
           perform   det-pap-fnt-900      thru det-pap-fnt-909        .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-par-num-ele        >    w-par-max-ele
                     go to  det-pap-fnt-350.
      *              *-------------------------------------------------*
      *              * Test se esiste almeno una partita per il forni- *
      *              * tore                                            *
      *              *-------------------------------------------------*
           if        w-par-num-ele        =    zero
                     go to  det-pap-fnt-200.
           go to     det-pap-fnt-999.
       det-pap-fnt-900.
      *              *-------------------------------------------------*
      ...
      *                  * 901esimo                                    *
      *                  *---------------------------------------------*
           if        rf-mgr-tip-iva       =    "4" or
                     rf-mgr-tip-iva       =    "D"
                     move   "NCR"         to   w-par-tip-doc (901)
           else if   rf-mgr-tip-iva       =    "5" or
                     rf-mgr-tip-iva       =    "E"
                     move   "FAT"         to   w-par-tip-doc (901)
           else if   rf-mgr-tip-iva       =    "6"
                     move   "BDO"         to   w-par-tip-doc (901)
      ...
      *                  *---------------------------------------------*
           add       w-par-res-par (901)  to   w-par-sdo-fnt          .
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       det-res-ope-000.
           subtract  w-det-res-ope-par    from w-det-res-ope-ris
