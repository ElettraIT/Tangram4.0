      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge4201:        *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rn-dat-bil             .
      *              *-------------------------------------------------*
      *              * Lettura dati relativi partitari clienti         *
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
      ...
      *              * stampa definitiva                               *
      *              *-------------------------------------------------*
           if        rn-par-cli-dat-fin   not  = zero
      ...
      *                          *-------------------------------------*
           move      "ME"                 to   v-ope                  .
           move      "Nessuna registrazione di contabilita' clienti da s
      -              "tampare; il programma pertanto"
                                          to   v-nt1                  .
      ...
      *                      * uscita                                  *
      *                      *-----------------------------------------*
           if        rn-par-cli-flg-avs   not  = spaces
                     go to  pre-exe-pgm-999.
      *                      *-----------------------------------------*
      *                      * Controllo data                          *
      *                      *-----------------------------------------*
           move      rn-par-cli-dat-fin   to   s-dat                  .
           move      "CD"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-sts                =    spaces
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cli-min           to   w-cod-mne-cli-cod      .
           move      11                   to   w-cod-mne-cli-lin      .
           move      29                   to   w-cod-mne-cli-pos      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-cli-ope      .
           move      rr-cli-max           to   w-cod-mne-cli-cod      .
           move      11                   to   w-cod-mne-cli-lin      .
           move      65                   to   w-cod-mne-cli-pos      .
           move      zero                 to   w-cod-mne-cli-rln      .
           move      zero                 to   w-cod-mne-cli-rps      .
           move      zero                 to   w-cod-mne-cli-vln      .
           move      zero                 to   w-cod-mne-cli-vps      .
      ...
      *              *-------------------------------------------------*
           ...
           if        rr-cli-max           not  < rr-cli-min
                     go to tdo-ric-sel-800.
           move      "Il codice cliente finale non puo' essere inferiore
      ...
      *              * Codice min e max                                *
      *              *-------------------------------------------------*
           if        rr-cli-min           =    zero and
                     rr-cli-max           =    zero
                     move   9999999       to   rr-cli-max
           else if   rr-cli-min           not  = zero and
                     rr-cli-max           =    zero
                     move  rr-cli-min     to   rr-cli-max             .
       reg-ric-sel-300.
      ...
      *                  * Preparazione date                           *
      *                  *---------------------------------------------*
           move      rr-dat-min           to   rn-par-cli-dat-ini     .
           move      rr-dat-max           to   rn-par-cli-dat-fin     .
           move      "#"                  to   rn-par-cli-flg-avs     .
      *                  *---------------------------------------------*
      *                  * Update                                      *
      *                  *---------------------------------------------*
           move      "FP"                 to   f-ope                  .
