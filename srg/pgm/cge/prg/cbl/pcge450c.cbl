      ...
      *    *-----------------------------------------------------------*
       01  w-des-tit-pgm-ovy              pic  x(40)       value
                     "    DATI CLIENTI PER LA CONTABILITA'    "       .
      ...
      *              *-------------------------------------------------*
           perform   ref-stc-cli-000      thru ref-stc-cli-999        .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-cli        to   w-ctl-dup-piv-cli      .
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-cli        to   w-ctl-dup-cfi-cli      .
      ...
      *                      *-----------------------------------------*
           move      w-ref-stc-cli        to   w-rig-cod-cge          .
      *                      *-----------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      spaces               to   w-rig-cod-cli-naz      .
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-cli-prt-iva       not  = w-tes-prt-iva
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-cli-cod-fis       not  = w-tes-cod-fis
                     go to sel-rec-cli-900.
       sel-rec-cli-300.
      *                  *---------------------------------------------*
      *                  * Sottoconto contabile                        *
      *                  *---------------------------------------------*
           if        w-tes-cod-cge-sns    =    zero and
                     w-tes-cod-cge        =    zero
                     go to sel-rec-cli-400.
           if        rf-cli-cod-cge       not  = w-tes-cod-cge
                     go to sel-rec-cli-900.
       sel-rec-cli-400.
      *                  *---------------------------------------------*
      *                  * Si/No allegato iva                          *
      *                  *---------------------------------------------*
           ...
           if        w-tes-sel-a13        =    2 and
                     rf-cli-snx-a13       not  = "N"
                     go to sel-rec-cli-900.
           if        w-tes-sel-a13        =    3 and
                     rf-cli-snx-a13       not  = "S"
                     go to sel-rec-cli-900.
       sel-rec-cli-500.
      *                  *---------------------------------------------*
      *                  * Codice esenzione iva                        *
      *                  *---------------------------------------------*
           ...
           if        rf-cli-cod-iva       not  = w-tes-cod-iva
                     go to sel-rec-cli-900.
       sel-rec-cli-800.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-cli-cod-naz       to   w-rig-cod-cli-naz      .
           move      rf-cli-cod-iva       to   w-rig-cod-iva          .
           move      rf-cli-prt-iva       to   w-rig-prt-iva          .
           move      rf-cli-cod-fis       to   w-rig-cod-fis          .
           move      rf-cli-snx-a13       to   w-rig-snx-a13          .
           move      rf-cli-cod-cge       to   w-rig-cod-cge          .
           move      rf-cli-cod-cge       to   w-rig-cod-cge-sav      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-rig-cod-iva        to   rf-cli-cod-iva         .
           move      w-rig-prt-iva        to   rf-cli-prt-iva         .
           move      w-rig-cod-fis        to   rf-cli-cod-fis         .
           move      w-rig-snx-a13        to   rf-cli-snx-a13         .
           move      w-rig-cod-cge        to   rf-cli-cod-cge         .
       sca-fil-rap-350.
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
