      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su singola partita cliente   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    INTERROGAZIONE SU PARTITA CLIENTE   "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   OK                     .
           perform   fnd-rif-cli-000      thru fnd-rif-cli-999        .
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Tasto funzione "FIND" su riferimenti clienti              *
      *    *                                                           *
      ...
      *              *-------------------------------------------------*
           move      "P?"                 to   s-ope                  .
           move      "pcge4410"           to   s-pro                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     move   "R"           to   OK
                     go to  fnd-rif-cli-999.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       z-qry-tst-max-000.
           if        rf-mgr-tip-arc       not  = "C"        or
                     rf-mgr-cod-arc       not  = rr-cod-cli or
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Titolo centrale 'PARTITA CLIENTE'           *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      15                   to   v-car                  .
