      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampe di controllo per la Primanota        *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase cge910, nella sua globalita', esegue i tipi di stampa  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * PRGNUM      Progressione numerica fatture di acquisto pcge910a *
      * ESIMOV      Esistenza movimenti a fronte documenti    pcge910b *
      * CNTSMV      Controllo incrociato saldi - movimenti    pcge910c *
      * REGZOP      Registrazioni zoppe                       pcge910d *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  STAMPE DI CONTROLLO PER LA PRIMANOTA  "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'cge910'           *
      *              *-------------------------------------------------*
           perform   fas-cge-910-000      thru fas-cge-910-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Progressione numerica fatture di acquisto         
      -              " PRGNUM     pcge910a  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Esistenza movimenti a fronte documenti            
      -              " ESIMOV     pcge910b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Controllo incrociato saldi - movimenti            
      -              " CNTSMV     pcge910c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-cge-910-300
           else if   v-key                =    "PRSC"
                     go to fas-cge-910-400
           else if   v-key                =    "NXSC"
                     go to fas-cge-910-450
           else if   v-key                =    "DOWN"
                     go to fas-cge-910-500
           else if   v-key                =    "EXIT"
                     go to fas-cge-910-250
           else      go to fas-cge-910-200.
       fas-cge-910-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-cge-910-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-cge-910-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-cge-910-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-cge-910-350
           else      go to fas-cge-910-322.
       fas-cge-910-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-cge-910-630
           else if   v-key                =    "PRSC"
                     go to fas-cge-910-600
           else if   v-key                =    "NXSC"
                     go to fas-cge-910-610
           else if   v-key                =    "UP  "
                     go to fas-cge-910-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-cge-910-650
           else if   v-key                =    "EXIT"
                     go to fas-cge-910-660
           else      go to fas-cge-910-570.
       fas-cge-910-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-cge-910-626
           else      go to fas-cge-910-628.
       fas-cge-910-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-cge-910-636
           else      go to fas-cge-910-638.
       fas-cge-910-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-cge-910-725
           else      go to fas-cge-910-750.
       fas-cge-910-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
