      ...
      *                       Ultima revisione:    NdK del 10/03/16    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento file [mgi] per il ripristino  *
      *                    del flag di stampa giornale Iva Acquisti    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " PULIZIA INDICATORE STAMPA GIORNALE IVA "       .
      ...
      *        * Tipo registro                                         *
      *        *                                                       *
      *        *  - 01 : Giornale iva vendite                          *
      *        *  - 02 : Giornale iva acquisti                         *
      *        *  - 03 : Giornale iva corrispettivi                    *
      *        *-------------------------------------------------------*
           05  rr-tip-rgi                 pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Numero giornale iva                                   *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Tipo registro                              *
      *        *-------------------------------------------------------*
           05  w-exp-tip-rgi.
               10  w-exp-tip-rgi-num      pic  9(02)       value 3    .
               10  w-exp-tip-rgi-lun      pic  9(02)       value 40   .
               10  w-exp-tip-rgi-tbl.
      ...
      *                  * Tipo stampa                                 *
      *                  *---------------------------------------------*
           perform   acc-tip-rgi-000      thru acc-tip-rgi-999        .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Tipo registro                        *
      *    *-----------------------------------------------------------*
       acc-tip-rgi-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-tip-rgi-lun    to   v-car                  .
           move      w-exp-tip-rgi-num    to   v-ldt                  .
           move      "VAC#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      05                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-tip-rgi-tbl    to   v-txt                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      rr-tip-rgi           to   v-num                  .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-tip-rgi-999.
       acc-tip-rgi-300.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-tip-rgi             .
       acc-tip-rgi-400.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Numero giornale                      *
      *    *-----------------------------------------------------------*
       acc-num-num-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *
      ...
      -              " a quella minima !" to   w-err-box-err-msg      .
      *
           go to     tdo-ric-sel-900.
       tdo-ric-sel-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-dat-min           to   rf-mgi-dat-reg         .
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-100.
      *              *-------------------------------------------------*
      *              * Test su tipo registro                           *
      *              *-------------------------------------------------*
           go to     prn-sel-rec-110
                     prn-sel-rec-120
                     prn-sel-rec-130
                     depending            on   rr-tip-rgi             .
       prn-sel-rec-110.
      *              *-------------------------------------------------*
      *              * Vendite (Clienti)                               *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Aggiornamento flag di stampa libro giornale     *
      *              *-------------------------------------------------*
