      ...
      *                       Ultima revisione:    NdK del 27/03/14    *
      *                    ------------------------------------------- *
      ...
      *                    programma cge3010:                          *
      *                                                                *
      *                    Interrogazione per data immissione/ultima   *
      *                    modifica                                    *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-reg.
      *        *-------------------------------------------------------*
      *        * Data immissione     in corso di trattamento           *
      *        *-------------------------------------------------------*
           05  w-reg-dat-imm              pic  9(07) value zero       .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-flg-tes              pic  x(01)                  .
           05  w-mpn-dat-reg              pic  9(07)                  .
           05  w-mpn-num-prt              pic  9(07)                  .
           05  w-mpn-num-prg              pic  9(05)                  .

      *    *===========================================================*
      *    * Work-area per sottoprogramma espansione registrazione     *
      *    *-----------------------------------------------------------*
       01  w-exp.
           05  w-exp-dat-reg              pic  9(07)                  .
           05  w-exp-num-prt              pic  9(07)                  .
           05  w-exp-num-prg              pic  9(05)                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-mgt                 .
      *              *-------------------------------------------------*
      *              * Se errore di start uscita con segnale di fine   *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rr-sel-cau           =    zero
                     go to  qry-let-seq-325.
           if        rf-mgt-cod-cau       not  = rr-sel-cau
                     go to  qry-let-seq-200.
       qry-let-seq-325.
      *                      *-----------------------------------------*
      *                      * Selezione su codice utente              *
      *                      *-----------------------------------------*
           if        rr-sel-ute           =    spaces
                     go to  qry-let-seq-330.
           if        rr-sel-ute           not  = rf-mgt-ide-ute
                     go to  qry-let-seq-200.
       qry-let-seq-330.
      *                      *-----------------------------------------*
      *                      * Selezione su codice fase                *
      *                      *-----------------------------------------*
           if        rr-sel-fas           =    spaces
                     go to  qry-let-seq-350.
           if        rr-sel-fas           not  = rf-mgt-ide-fas
                     go to  qry-let-seq-200.
       qry-let-seq-350.
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
      *                          * Preparazione riga 1 per confronto   *
      *                          *                                     *
      *                          * Normalizzazione valore impostato in *
      *                          * formato privo di spaces e caratteri *
      *                          * diversi da A..Z - 0..9              *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
      *                          * Preparazione stringa per confronto  *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
      *                          * Se c'e' stato un match : selezione  *
      *                          * superata                            *
      *                          *-------------------------------------*
       ...
       qry-let-seq-352.
      *                          *-------------------------------------*
      *                          * Preparazione riga 2 per confronto   *
      *                          *                                     *
      *                          * Normalizzazione valore impostato in *
      *                          * formato privo di spaces e caratteri *
      *                          * diversi da A..Z - 0..9              *
      ...
      *                          *-------------------------------------*
       ...
       qry-let-seq-354.
      *                          *-------------------------------------*
      *                          * Preparazione riga 3 per confronto   *
      *                          *                                     *
      *                          * Normalizzazione valore impostato in *
      *                          * formato privo di spaces e caratteri *
      *                          * diversi da A..Z - 0..9              *
      ...
      *                          *-------------------------------------*
       ...
       qry-let-seq-356.
      *                          *-------------------------------------*
      *                          * Preparazione riga 4 per confronto   *
      *                          *                                     *
      *                          * Normalizzazione valore impostato in *
      *                          * formato privo di spaces e caratteri *
      *                          * diversi da A..Z - 0..9              *
      ...
      *                          *-------------------------------------*
       ...
       qry-let-seq-360.
      *                  *---------------------------------------------*
      *                  * Se nessun confronto superato : riciclo      *
      *                  *---------------------------------------------*
           go to     qry-let-seq-200.
       qry-let-seq-400.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-mgt-dat-reg       to   w-reg-dat-imm          .
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-mgr                 .
      *                  *---------------------------------------------*
      *                  * Se errore di start si ricicla a leggere il  *
      *                  * successivo [mgt]                            *
      *                  *---------------------------------------------*
           if        f-sts                =    e-not-err
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-int      .
      *              *-------------------------------------------------*
      *              * Se tipo visualizzazione 'T' : intestazione pa-  *
      *              * gina                                            *
      *              *-------------------------------------------------*
           if        rr-tip-vis           =    "T"
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se c'e' sbilancio                      *
      *                  *---------------------------------------------*
           if        w-wrk-prg-dar        =    w-wrk-prg-ave
                     go to  qry-fin-cic-024.
       qry-fin-cic-022.
      *                  *---------------------------------------------*
      *                  * Se c'e' sbilancio                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se non ci sono almeno 4 linee residue : *
      *                      * reintestazione                          *
      *                      *-----------------------------------------*
           if        v-res                <    4
                     go to  qry-fin-cic-050
           else      go to  qry-fin-cic-100.
       qry-fin-cic-024.
      *                  *---------------------------------------------*
      *                  * Se non c'e' sbilancio                       *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se non ci sono almeno 3 linee residue : *
      *                      * reintestazione                          *
      *                      *-----------------------------------------*
           if        v-res                <    3
                     go to  qry-fin-cic-050
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Esclusione dei trattini di separazione      *
      *                  *---------------------------------------------*
           go to     qry-fin-cic-200.
       qry-fin-cic-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "G"                  to   v-edm                  .
           move      v-lnr                to   v-lin                  .
           subtract  w-wrk-prg-ave        from w-wrk-prg-dar
                                        giving v-num                  .
           if        v-num                >    zero
                     move   64            to   v-pos
      ...
      *              *-------------------------------------------------*
       ...
       qry-ini-lr1-010.
      *              *-------------------------------------------------*
      *              * Se tipo visualizzazione 'T' : si esce           *
      *              *-------------------------------------------------*
           if        rr-tip-vis           =    "T"
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      22                   to   v-pos                  .
           move      rf-mgt-rig-cau (1)   to   v-alf                  .
      *                      *-----------------------------------------*
      *                      * Mark-Point                              *
      *                      *-----------------------------------------*
           move      "+"                  to   v-edm                  .
           move      "#"                  to   w-mpn-flg-tes          .
      ...
      *                      *-----------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      22                   to   v-pos                  .
           move      rf-mgt-rig-cau (I)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                          *-------------------------------------*
      *                          * Interlinea                          *
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se archivio di generale                     *
      *                  *---------------------------------------------*
           if        rf-mgr-tip-arc       not  = "G"
      ...
      *                      *-----------------------------------------*
       ...
       qry-liv-det-120.
      *                  *---------------------------------------------*
      *                  * Editing codice cliente o fornitore          *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      07                   to   v-car                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-pdc-des-pdc       to   w-wrk-des-arc          .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-cli-rag-soc       to   w-wrk-des-arc          .
           go to     qry-liv-det-260.
       qry-liv-det-240.
      *                      *-----------------------------------------*
      *                      * Se fornitore                            *
      *                      *-----------------------------------------*
           ...
           move      rf-fnt-rag-soc       to   w-wrk-des-arc          .
       qry-liv-det-260.
      *                  *---------------------------------------------*
      *                  * Visualizzazione                             *
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      12                   to   v-pos                  .
           move      w-wrk-des-arc        to   v-alf                  .
      *                      *-----------------------------------------*
      *                      * Mark-Point                              *
      *                      *-----------------------------------------*
           move      "+"                  to   v-edm                  .
           move      spaces               to   w-mpn-flg-tes          .
           move      rf-mgr-dat-reg       to   w-mpn-dat-reg          .
           move      rf-mgr-num-prt       to   w-mpn-num-prt          .
           move      rf-mgr-num-prg       to   w-mpn-num-prg          .
           move      w-mpn                to   v-cnt                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Titolo : 'LISTA REGISTRAZIONI PER DATA'         *
      *              *-------------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "LISTA REGISTRAZIONI PER DATA IMMISSIONE "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      ...
      -              "---------- --------- ---------"
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Interlinea vuota tranne a pagina 1          *
      *                  *---------------------------------------------*
           if        v-pag                =    1
                     go to int-pag-sta-999.
           move      "LF"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
      *                  * Test su flag di visualizzazione testata     *
      *                  *---------------------------------------------*
           if        w-mpn-flg-tes        =    spaces
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-mgr-num-prg       to   w-sav-num-prg          .
      *              *-------------------------------------------------*
      *              * Aggiornamento area per trattamento funzione     *
      *              *-------------------------------------------------*
           move      w-mpn-dat-reg        to   w-exp-dat-reg          .
           move      w-mpn-num-prt        to   w-exp-num-prt          .
           move      w-mpn-num-prg        to   w-exp-num-prg          .
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           if        f-sts                not  = e-not-err
                     ...
                     go to  qry-trt-fun-999.
      *                      *-----------------------------------------*
      *                      * Ripristino 'Start' su [mgt]             *
      *                      *-----------------------------------------*
           move      w-sav-dat-reg        to   rf-mgt-dat-reg         .
           move      w-sav-num-prt        to   rf-mgt-num-prt         .
           move      "SK"                 to   f-ope                  .
           move      "EQ"                 to   f-cfr                  .
           move      "DATREG"             to   f-key                  .
           move      "pgm/cge/fls/ioc/obj/iofmgt"
      ...
      *    *-----------------------------------------------------------*
       dca-con-ael-000.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione tipo di movimento Iva    *
      *              *-------------------------------------------------*
           if        rf-mgt-tip-iva       =    "1" or
                     rf-mgt-tip-iva       =    "2" or
                     rf-mgt-tip-iva       =    "A" or
                     rf-mgt-tip-iva       =    "B"
                     perform dca-con-ael-cli-000
                                          thru dca-con-ael-cli-999
           else if   rf-mgt-tip-iva       =    "4" or
                     rf-mgt-tip-iva       =    "5" or
                     rf-mgt-tip-iva       =    "D" or
                     rf-mgt-tip-iva       =    "E"
                     perform dca-con-ael-fnt-000
                                          thru dca-con-ael-fnt-999
           else      go to dca-con-ael-900.
       dca-con-ael-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-all-str-alf        to   rf-mgt-rig-cau (1)     .
       dca-con-ael-cli-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     dca-con-ael-cli-999.
       dca-con-ael-cli-999.
           exit.
      ...
      *
           move      w-all-str-alf        to   w-all-str-cat (1)      .
           move      rf-mgt-num-doc       to   w-all-str-cat (2)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
      *
           move      40                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
      ...
      *                  *---------------------------------------------*
       ...
       dca-con-ael-fnt-500.
      *              *-------------------------------------------------*
      *              * Concatenazione con protocollo Iva               *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      rf-mgt-rig-cau (1)   to   w-all-str-cat (1)      .
           move      "-"                  to   w-all-str-cat (2)      .
           move      v-edt                to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
