      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampe movimenti IVA                        *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase cge960, nella sua globalita', esegue i tipi di stampa  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * IVAMOV      movimenti Iva                             pcge960a *
      * IVAALI      per Aliquota                              pcge960b *
      * IVAREG      per Regione                               pcge960c *
      * IVANAZ      per Nazione                               pcge960d *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'cge960'           *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Elenco movimenti Iva                              
      -              " IVAMOV     pcge960a  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Elenco movimenti Iva - per Aliquota               
      -              " IVAALI     pcge960b  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Elenco movimenti Iva - per Regione                
      -              " IVAREG     pcge960c  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
           move      "Elenco movimenti Iva - per Nazione                
      -              " IVANAZ     pcge960d  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-200.
