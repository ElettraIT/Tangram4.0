      ...
      *                    programma cge3010:                          *
      *                                                                *
      *                    Interrogazione per data registrazione       *
      *                                                                *
      *================================================================*
      ...
      *              * Test su importo                                 *
      *              *-------------------------------------------------*
           if        rf-mgr-imp-mov       <    rr-sel-imi or
                     rf-mgr-imp-mov       >    rr-sel-ima
                     move   "#"           to   w-cnt-qry-flg-sub
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-mgt-dat-reg       to   w-rot-l01-dat-reg      .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      27                   to   v-pos                  .
           move      "LISTA REGISTRAZIONI PER DATA"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
