      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase cge610, nella sua globalita', esegue i tipi di stampa  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * SRCCAT      Stampa registro cespiti per categoria              *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'cge610'           *
      *              *-------------------------------------------------*
           perform   fas-cge-610-000      thru fas-cge-610-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "Stampa registro cespiti per categoria             
      -              " SRCCAT     pcge610a  "
                                          to   w-tin-ele-wci          .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-cge-610-300
           else if   v-key                =    "PRSC"
                     go to fas-cge-610-400
           else if   v-key                =    "NXSC"
                     go to fas-cge-610-450
           else if   v-key                =    "DOWN"
                     go to fas-cge-610-500
           else if   v-key                =    "EXIT"
                     go to fas-cge-610-250
           else      go to fas-cge-610-200.
       fas-cge-610-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-cge-610-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-cge-610-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-cge-610-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-cge-610-350
           else      go to fas-cge-610-322.
       fas-cge-610-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-cge-610-630
           else if   v-key                =    "PRSC"
                     go to fas-cge-610-600
           else if   v-key                =    "NXSC"
                     go to fas-cge-610-610
           else if   v-key                =    "UP  "
                     go to fas-cge-610-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-cge-610-650
           else if   v-key                =    "EXIT"
                     go to fas-cge-610-660
           else      go to fas-cge-610-570.
       fas-cge-610-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-cge-610-626
           else      go to fas-cge-610-628.
       fas-cge-610-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-cge-610-636
           else      go to fas-cge-610-638.
       fas-cge-610-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-cge-610-725
           else      go to fas-cge-610-750.
       fas-cge-610-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
