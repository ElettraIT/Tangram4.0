      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione richieste del programma pcge5300 *
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Literal 'Saldo fornitori selezionati al'        *
      *              *-------------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      30                   to   p-car                  .
           move      p-lnr                to   p-lin                  .
           move      11                   to   p-pos                  .
           move      "Saldo fornitori selezionati al"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Se ultimo record fornitori da stampare devono   *
      *              * esserci almeno 4 linee residue                  *
      *              *-------------------------------------------------*
           if        w-cch-flg-end        not  = spaces
                     if     p-res         >    4
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           string    "SITUAZIONE CONTABILE FORNITORI AL "
                                delimited by size
      ...
      *    *===========================================================*
      *    * Routine di determinazione saldo alla data fornitore       *
      *    *-----------------------------------------------------------*
       det-sdo-dat-000.
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      rf-fnt-cod-fnt       to   rf-mgs-cod-con         .
      *                          *-------------------------------------*
      *                          * Lettura file [mgs]                  *
      *                          *-------------------------------------*
           move      "RD"                 to   f-ope                  .
