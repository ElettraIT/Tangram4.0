      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su archivio [pdc]            *
      *                                                                *
      *                    Piano dei conti                             *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
      *              * Determinazione variabile di i.p.c. da livello   *
      *              * precedente per codice categoria/classe          *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
      *              * Se non esiste codice mastro e conto passato da  *
      *              * livello precedente : uscita                     *
      *              *-------------------------------------------------*
           if        w-prs-liv-pdc        =    3
       ...
       pre-exe-pgm-800.
           if        w-ipc-dlp-cod-mas    =    zero or
                     w-ipc-dlp-cod-con    =    zero
                     move   "#"           to   w-cnt-pre-exe-pgm
                     go to  pre-exe-pgm-999.
       pre-exe-pgm-900.
      *              *-------------------------------------------------*
      *              * Preparazione parametri per interrogazione       *
      *              *-------------------------------------------------*
           move      w-ipc-dlp-cod-mas    to   rr-mas-max             .
           move      w-ipc-dlp-cod-con    to   rr-con-max             .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-ipc-dlp-cod-pdc    to   rf-pdc-cod-pdc         .
           move      "pgm/cge/fls/ioc/obj/iofpdc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           ...
           string    "Nessun sottoconto memorizzato per il conto "
                                delimited by   size
                     w-ipc-dlp-cod-con
                                delimited by   size
                     " !"       delimited by   size
      ...
      *              *-------------------------------------------------*
           ...
           if        w-mcs-cod-mas        not  = rr-mas-max or
                     w-mcs-cod-con        not  = rr-con-max or
                     w-mcs-cod-stc        >    rr-stc-max
                     move   "#"           to   w-cnt-qry-flg-sub      .
       qry-tst-max-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-cod-pdc        to   w-ipc-plp-cod-pdc      .
           move      w-ipc-plp-cod-pdc    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                  *---------------------------------------------*
      ...
      *                  * "cod-mas" per codice mastro di default      *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *                  *---------------------------------------------*
      *                  * Preparazione della variabile di i.p.c.      *
      *                  * "cod-con" per codice classe di default      *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
           ...
           move      zero                 to   s-dec                  .
           move      spaces               to   s-sgn                  .
           move      w-ipc-dlp-cod-con    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      13                   to   v-pos                  .
           move      w-ipc-dlp-cod-con    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Lettura tabella [zcn]                       *
      *                  *---------------------------------------------*
           ...
           move      w-ipc-dlp-cod-mas    to   rf-zcn-cod-mas         .
           move      w-ipc-dlp-cod-con    to   rf-zcn-cod-con         .
           move      "pgm/cge/fls/ioc/obj/iofzcn"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
