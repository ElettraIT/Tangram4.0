      ...
      *                       Ultima revisione:    NdK del 11/11/03    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  w-ipc-cod-cli.
      *            *---------------------------------------------------*
      *            * Si/No variabile di i.p.c. relativa al cliente     *
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
      ...
      -              " le registrazioni contabili   "
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       relative al cliente di tipo 'dare clienti'.
      -              "                              "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "  Data      N.docum.        Codice e descrizione c
      -              "ausale       Importo movimento"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       stp-int-pag-400.
