      ...
      *                                   Fase:    cge042              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 31/01/94    *
      *                       Ultima revisione:    NdK del 17/03/20    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma cge042   *
      *                                                                *
      *                    Stampa tabella codici iva                   *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zci-cod-iva         .
           move      "pgm/cge/fls/ioc/obj/iofzci"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      "N"                  to   p-tip                  .
           move      03                   to   p-car                  .
           move      rf-zci-dec-ali       to   p-dec                  .
           move      spaces               to   p-sgn                  .
           move      "BD"                 to   p-edm                  .
           move      p-lnr                to   p-lin                  .
           move      03                   to   p-pos                  .
      *
           if        rf-zci-dec-ali       >    zero
      ...
      *
           ...
           else      move rf-zci-cod-nop  to   p-alf                  .
      *
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       prn-liv-det-500.
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "| Cod.|   Descrizione   |         Commento ad uso 
      -              "interno         | Natura op. |"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
