      ...
      *                       Ultima revisione:    NdK del 23/02/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcge7401:        *
      *                                                                *
      ...
      *                          *-------------------------------------*
           move      "Non sarebbe ancora possibile stampare la dichiaraz
      -              "ione annuale.  "    to   w-err-box-err-msg      .
      *                          *-------------------------------------*
