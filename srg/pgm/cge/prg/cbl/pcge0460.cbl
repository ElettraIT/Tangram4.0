      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella natura operazione    *
      *                                                                *
      *                    N.B.: attualmente non implementare le sele- *
      *                          zioni                                 *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    INTERROGAZIONE NATURA OPERAZIONE    "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           ...
           05  rr-des-min                 pic  x(80)                  .
           05  rr-des-max                 pic  x(80)                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      08                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella conti merce"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-des-zno-cod      .
           move      12                   to   w-cod-des-zno-lin      .
           move      30                   to   w-cod-des-zno-pos      .
           move      zero                 to   w-cod-des-zno-dln      .
           move      zero                 to   w-cod-des-zno-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-zno-ope      .
           move      rr-cod-max           to   w-cod-des-zno-cod      .
           move      12                   to   w-cod-des-zno-lin      .
           move      52                   to   w-cod-des-zno-pos      .
           move      zero                 to   w-cod-des-zno-dln      .
           move      zero                 to   w-cod-des-zno-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zno-cod-nop         .
           move      "pgm/cge/fls/ioc/obj/iofzno"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-zno-des-key         .
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessuna natura operazione trovata !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zno]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/cge/fls/ioc/obj/iofzno"
                                          to   s-pat                  .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zno-cod-nop       <    rr-cod-min or
                     rf-zno-cod-nop       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zno-des-key       <    rr-des-min or
                     rf-zno-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *              * Natura operazione                               *
      *              *-------------------------------------------------*
           move      rf-zno-cod-nop       to   w-rot-l01-cod-nop      .
       qry-cmp-rot-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      10                   to   v-pos                  .
           move      rf-zno-des-nop       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zno-cod-nop       to   w-mpn-cod-nop          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-nop'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      23                   to   v-pos                  .
           move      "CODICI NATURA DELL'OPERAZIONE IVA"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
