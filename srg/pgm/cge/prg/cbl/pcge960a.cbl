      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa archivio [mgi]                       *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           ...
           05  rr-ibl-min                 pic s9(11)                  .
           05  rr-ibl-max                 pic s9(11)                  .
      ...
      *                  * Imponibile minimo                           *
      *                  *---------------------------------------------*
           perform   acc-ibl-min-000      thru acc-ibl-min-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Imponibile massimo                          *
      *                  *---------------------------------------------*
           perform   acc-ibl-max-000      thru acc-ibl-max-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      zero                 to   rr-ibl-min             .
           move      zero                 to   rr-ibl-max             .
       nor-ric-sel-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "(C) : Clienti  -  (F) : Fornitori  -  (V) : Corris
      -              "pettivi  -  ( ) : Tutti"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   rr-tip-rec             .
       acc-tip-rec-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           perform   vis-lit-rec-000      thru vis-lit-rec-999        .
           if        rr-tip-rec           not  = "C" and
                     rr-tip-rec           not  = "F" and
                     rr-tip-rec           not  = "V" and
                     rr-tip-rec           not  = spaces
      ...
      *    *===========================================================*
      *    * Visualizzazione literal per tipo ordinamento              *
      *    *-----------------------------------------------------------*
       vis-lit-rec-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           if        rr-tip-rec           =    spaces
                     move  "Tutti        "  
                                          to   v-alf
           else if   rr-tip-rec           =    "C"
                     move  "Clienti      "     
                                          to   v-alf
           else if   rr-tip-rec           =    "F"
                     move  "Fornitori    " 
                                          to   v-alf
           else if   rr-tip-rec           =    "V"
                     move  "Corrispettivi"   
                                          to   v-alf
      ...
      *    *===========================================================*
      *    * Accettazione campo : Imponibile minimo                    *
      *    *-----------------------------------------------------------*
       acc-ibl-min-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-ibl-min-999.
       acc-ibl-min-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-ibl-min             .
       acc-ibl-min-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-ibl-min-100.
       acc-ibl-min-999.
           exit.

      *    *===========================================================*
      *    * Accettazione campo : Imponibile massimo                   *
      *    *-----------------------------------------------------------*
       acc-ibl-max-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-ibl-max-999.
       acc-ibl-max-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-ibl-max             .
       acc-ibl-max-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      ...
      -              "ice minimo !"       to   v-not                  .
       ...
       tdo-ric-sel-200.
      *                  *---------------------------------------------*
      *                  * Controllo su imponibile minimo e massimo    *
      *                  *---------------------------------------------*
           if        rr-ibl-max           =    zero
                     go to tdo-ric-sel-999.
           if        rr-ibl-max           not  < rr-ibl-min
                     go to tdo-ric-sel-999.
           move      "ME"                 to   v-ope                  .
           move      "L'imponibile massimo non puo' essere inferiore al 
      -              " minimo !"          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "#"                  to   w-cnt-tdo-ric-flg      .
      ...
      *                  *---------------------------------------------*
       ...
       reg-ric-sel-200.
      *                  *---------------------------------------------*
      *                  * Regolarizzazione imponibile min - max       *
      *                  *---------------------------------------------*
           if        rr-ibl-max           not  = zero
                     go to reg-ric-sel-999.
           if        rr-ibl-min           =    zero
                     move  99999999999    to   rr-ibl-max
           else      move  rr-ibl-min     to   rr-ibl-max             .
       reg-ric-sel-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-300.
      *              *-------------------------------------------------*
      *              * Selezione su imponibile                         *
      *              *-------------------------------------------------*
           if        rf-mgi-ibl-iva (1)   =    zero
                     go to prn-sel-rec-310.
           if        rf-mgi-ibl-iva (1)   <    rr-ibl-min or
                     rf-mgi-ibl-iva (1)   >    rr-ibl-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-310.
           if        rf-mgi-ibl-iva (2)   =    zero
                     go to prn-sel-rec-320.
           if        rf-mgi-ibl-iva (2)   <    rr-ibl-min or
                     rf-mgi-ibl-iva (2)   >    rr-ibl-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-320.
           if        rf-mgi-ibl-iva (3)   =    zero
                     go to prn-sel-rec-330.
           if        rf-mgi-ibl-iva (3)   <    rr-ibl-min or
                     rf-mgi-ibl-iva (3)   >    rr-ibl-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-330.
           if        rf-mgi-ibl-iva (4)   =    zero
                     go to prn-sel-rec-340.
           if        rf-mgi-ibl-iva (4)   <    rr-ibl-min or
                     rf-mgi-ibl-iva (4)   >    rr-ibl-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-340.
           if        rf-mgi-ibl-iva (5)   =    zero
                     go to prn-sel-rec-350.
           if        rf-mgi-ibl-iva (5)   <    rr-ibl-min or
                     rf-mgi-ibl-iva (5)   >    rr-ibl-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-350.
           if        rf-mgi-ibl-iva (6)   =    zero
                     go to prn-sel-rec-999.
           if        rf-mgi-ibl-iva (6)   <    rr-ibl-min or
                     rf-mgi-ibl-iva (6)   >    rr-ibl-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-200.
           ...
           if        I                    >    6
                     go to prn-liv-det-999.
      *                      *-----------------------------------------*
      *                      * Se alla prima riga : nessun controllo   *
      *                      *-----------------------------------------*
           if        I                    <    2
                     go to prn-liv-det-255.
           move      I                    to   J                      .
           add       1                    to   J                      .
           if        J                    not > 6 
                     go to prn-liv-det-240.
           if        rf-mgi-ibl-iva (I)   =    zero
                     go to prn-liv-det-999
           else      go to prn-liv-det-250.
       prn-liv-det-240.
           if        rf-mgi-ibl-iva (I)   =    zero and
                     rf-mgi-ibl-iva (J)   =    zero
                     go to prn-liv-det-999.
       prn-liv-det-250.
      *                          *-------------------------------------*
      *                          * Interlinea                          *
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      76                   to   p-pos                  .
           move      rf-mgi-ibl-iva (I)   to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                          *-------------------------------------*
      *                          * Codice IVA                          *
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      92                   to   p-pos                  .
           move      rf-mgi-cod-iva (I)   to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                          *-------------------------------------*
      *                          * Imposta                             *
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      98                   to   p-pos                  .
           move      rf-mgi-imp-iva (I)   to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Se al primo giro : totale documento     *
      *                      *-----------------------------------------*
           if        I                    >    1
