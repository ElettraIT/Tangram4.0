      ...
      *                       Ultima revisione:    NdK del 06/02/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma ffo012   *
      *                                                                *
      *                    Stampa tipi movimento per fatture fornitori *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA TIPI MOVIMENTO FATTURE FORNITORI "       .
      ...
      *                  *---------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "CODTMF    "         to   f-key                  .
           move      rr-cod-min           to   rf-yff-cod-tmf         .
           move      "pgm/ffo/fls/ioc/obj/iofyff"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-yff-des-key         .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [yff]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/ffo/fls/ioc/obj/iofyff"
                                          to   s-pat                  .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-yff-cod-tmf       <    rr-cod-min or
                     rf-yff-cod-tmf       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-yff-des-key       <    rr-des-min or
                     rf-yff-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      39                   to   p-pos                  .
      *
           if        rf-yff-tip-doc       =    01
                     move  "FT"           to   p-alf
           else if   rf-yff-tip-doc       =    02
                     move  "ND"           to   p-alf
           else if   rf-yff-tip-doc       =    03
                     move  "NC"           to   p-alf
           else      move  ".."           to   p-alf                  .
      *
           call      "swd/mod/prg/obj/mprint"
      ...
      *                  *---------------------------------------------*
           ...
           move      43                   to   p-pos                  .
      *
           if        rf-yff-tpv-doc       =    01
                     move  "NAZ"          to   p-alf
           else if   rf-yff-tpv-doc       =    02
                     move  "CEE"          to   p-alf
           else if   rf-yff-tpv-doc       =    03
                     move  "EST"          to   p-alf
           else if   rf-yff-tpv-doc       =    04
                     move  "DOG"          to   p-alf
           else      move  "..."          to   p-alf                  .
      *
           call      "swd/mod/prg/obj/mprint"
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      63                   to   p-pos                  .
           move      rf-yff-def-tmf       to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Tipo riga di default                        *
      *                  *---------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      05                   to   p-car                  .
      ...
      *              *-------------------------------------------------*
           move      "TIPI MOVIMENTO PER FATTURE FORNITORI"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "| Cod.|         Descrizione          |Td|Prov.|R|g
      -              "i|Cau| Mag.|a fr.| TR  |MS|RC|"
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
