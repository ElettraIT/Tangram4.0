      ...
      *================================================================*
      *                                                                *
      *          Gestione catena mov 2 per programma pffo3000          *
      *                                                                *
      * ============================================================== *
      * Tipi operazione                                                *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-pnt-max-ele              pic  9(05) value 900        .
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Cache memory per i primi 40 elementi                      *
      *    *-----------------------------------------------------------*
       01  w-chm.
      *        *-------------------------------------------------------*
      *        * Numero di elementi nella cache memory                 *
      *        *-------------------------------------------------------*
           05  w-chm-max                  pic  9(02)       value 40   .
      *        *-------------------------------------------------------*
      *        * Elementi                                              *
      *        *-------------------------------------------------------*
           05  w-chm-tbl occurs 40.
      *            *---------------------------------------------------*
