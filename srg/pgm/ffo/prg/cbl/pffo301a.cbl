      ...
      *                       Ultima revisione:    NdK del 07/04/25    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazioni su fatture fornitori         *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
      *        * Per tipo movimento fattura fornitore                  *
      *        *-------------------------------------------------------*
           05  w-ipc-cod-tmf.
      *            *---------------------------------------------------*
      *            * Si/No variabile di i.p.c. relativa                *
      *            *---------------------------------------------------*
               10  w-ipc-cod-tmf-snx      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore della variabile di i.p.c. relativa         *
      *            *---------------------------------------------------*
               10  w-ipc-cod-tmf-val      pic  x(05)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  rr-cod-tmf                 pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Tipo movimento da ricercare, descrizione              *
      *        *-------------------------------------------------------*
           05  rr-cod-tmf-des             pic  x(30)                  .
      *        *-------------------------------------------------------*
      *        * Tipo movimento da ricercare, provenienza              *
      *        *                                                       *
      *        * - 01 : Nazionale                                      *
      *        * - 02 : CEE                                            *
      *        * - 03 : Estero                                         *
      *        * - 04 : Dogana                                         *
      *        *-------------------------------------------------------*
           05  rr-cod-tmf-tpv             pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Sigla valuta, se provenienza da ricercare CEE o Este- *
      *        * ro                                                    *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [yff]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-yff.
               10  w-let-arc-yff-flg      pic  x(01)                  .
               10  w-let-arc-yff-cod      pic  x(05)                  .
               10  w-let-arc-yff-dpz      pic  9(02)                  .
               10  w-let-arc-yff-des      pic  x(30)                  .
               10  w-let-arc-yff-tpv      pic  9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Tipo movimento per fatture fornitori                  *
      *        *-------------------------------------------------------*
           05  w-sav-cod-tmf              pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Tipo movimento per fatture fornitori, tipo provenien- *
      *        * za                                                    *
      *        *-------------------------------------------------------*
           05  w-sav-cod-tmf-tpv          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Sigla valuta                                          *
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Link-area per espansione su righe fatture fornitore       *
      *    *-----------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-qry-liv-det.
           05  w-qry-liv-det-imp          pic s9(11)                  .
      ...
      *              *-------------------------------------------------*
      *              * Lettura della variabile eventuale di i.p.c. per *
      *              * il tipo movimento fattura                       *
      *              *-------------------------------------------------*
           perform   ipc-cod-tmf-000      thru ipc-cod-tmf-999        .
      *              *-------------------------------------------------*
      *              * Lettura della variabile eventuale di i.p.c. per *
      ...
      *    *-----------------------------------------------------------*
       ipc-cod-tmf-000.
      *              *-------------------------------------------------*
      *              * Estrazione della variabile 'cod-tmf' dal livel- *
      *              * lo di profondita' precedente o dallo stesso li- *
      *              * vello di profondita' applicativa a seconda se   *
      *              * il sottoprogramma e' stato richiamato dal main  *
      *              * oppure da un sottoprogramma dello stesso livel- *
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to ipc-cod-tmf-200
           else      go to ipc-cod-tmf-400.
       ipc-cod-tmf-200.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
      ...
      *                  * Segnale di variabile esistente              *
      *                  *---------------------------------------------*
           move      "S"                  to   w-ipc-cod-tmf-snx      .
      *                  *---------------------------------------------*
      *                  * Valore della variabile                      *
      *                  *---------------------------------------------*
           move      s-alf                to   w-ipc-cod-tmf-val      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ipc-cod-tmf-999.
       ipc-cod-tmf-400.
      *              *-------------------------------------------------*
      *              * Se variabile non esistente                      *
      *              *-------------------------------------------------*
      ...
      *                  * Segnale di variabile non esistente          *
      *                  *---------------------------------------------*
           move      "N"                  to   w-ipc-cod-tmf-snx      .
      *                  *---------------------------------------------*
      *                  * Valore della variabile a zero               *
      *                  *---------------------------------------------*
           move      spaces               to   w-ipc-cod-tmf-val      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ipc-cod-tmf-999.
      ...
      *              *-------------------------------------------------*
           perform   esp-rig-ffr-opn-000  thru esp-rig-ffr-opn-999    .
      *              *-------------------------------------------------*
      *              * Open file [fft]                                 *
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           perform   esp-rig-ffr-cls-000  thru esp-rig-ffr-cls-999    .
      *              *-------------------------------------------------*
      *              * Close file [fft]                                *
      *              *-------------------------------------------------*
           move      "CL"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
       int-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Start su [fft] per fornitore                    *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DPZARCDAT "         to   f-key                  .
           move      rr-dpz-inu           to   rf-fft-cod-dpz         .
           move      "F"                  to   rf-fft-tip-arc         .
           move      rr-cod-fnt           to   rf-fft-cod-arc         .
           move      rr-dtr-min           to   rf-fft-dat-reg         .
      ...
      *                  *---------------------------------------------*
           if        rf-fft-cod-dpz       not  = rr-dpz-inu or
                     rf-fft-tip-arc       not  = "F"        or
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-fft-dpz-arc       not  = rr-dpz-fnt
                     go to int-srt-inp-200.
       int-srt-inp-420.
      *                  *---------------------------------------------*
      *                  * Su tipo movimento da ricercare              *
      *                  *---------------------------------------------*
           if        rr-cod-tmf           =    spaces
                     go to int-srt-inp-430.
           if        rf-fft-cod-tmf       not  = rr-cod-tmf
                     go to int-srt-inp-200.
       int-srt-inp-430.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-fft-num-doc       not  = rr-num-doc
                     go to int-srt-inp-200.
       int-srt-inp-440.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-fft-dat-doc       not  = rr-dat-doc
                     go to int-srt-inp-200.
       int-srt-inp-450.
      *                  *---------------------------------------------*
      *                  * Selezione su sigla valuta documento         *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da effettuare                   *
      *                      *-----------------------------------------*
           if        rr-cod-tmf-tpv       =    02 or
                     rr-cod-tmf-tpv       =    03
                     go to int-srt-inp-455
           else      go to int-srt-inp-460.
       int-srt-inp-455.
      *                      *-----------------------------------------*
      *                      * Test di selezione                       *
      *                      *-----------------------------------------*
           if        rf-fft-sgl-vpf       not  = rr-sgl-vlt or
                     rf-fft-dec-vpf       not  = rr-dec-vlt or
                     rf-fft-tdc-vpf       not  = rr-tdc-vlt
                     go to int-srt-inp-200.
       int-srt-inp-460.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Deviazione a seconda che la sigla valu- *
      *                      * ta documento sia pari o meno a quella   *
      *                      * base                                    *
      *                      *-----------------------------------------*
           if        rf-fft-sgl-vpf       =    c-sgl
                     go to int-srt-inp-462
           else      go to int-srt-inp-464.
       int-srt-inp-462.
      *                      *-----------------------------------------*
      *                      * Se sigla valuta pari a quella base      *
      *                      *-----------------------------------------*
           if        rf-fft-imp-doc       =    rr-imp-doc
                     go to int-srt-inp-500
           else      go to int-srt-inp-200.
       int-srt-inp-464.
      *                      *-----------------------------------------*
      *                      * Se sigla valuta diversa da quella base  *
      *                      *-----------------------------------------*
           if        rf-fft-iiv-doc       =    rr-imp-doc
                     go to int-srt-inp-500
           else      go to int-srt-inp-200.
       int-srt-inp-500.
      *              *-------------------------------------------------*
      ...
      *                      * Numero protocollo                       *
      *                      *-----------------------------------------*
           move      rf-fft-num-prt       to   srt-num-prt            .
      *                      *-----------------------------------------*
      *                      * Imponibile documento                    *
      *                      *-----------------------------------------*
           if        rf-fft-sgl-vpf       not  = c-sgl
                     move  rf-fft-iiv-doc to   srt-tot-doc
           else      move  rf-fft-imp-doc to   srt-tot-doc            .
           if        rf-fft-tip-doc       =    03
                     multiply -1          by   srt-tot-doc            .
      *                      *-----------------------------------------*
      *                      * Righe documento                         *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-fft-cod-tmf       to   srt-tip-doc            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
      ...
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      rf-fft-num-prt       to   srt-prt-key            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
      ...
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      rf-fft-dat-reg       to   srt-dat-reg            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
      ...
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      rf-fft-num-doc       to   srt-num-doc            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
      ...
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      rf-fft-dat-doc       to   srt-dat-doc            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
      ...
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      rf-fft-dpz-arc       to   srt-dpz-arc            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
      ...
      *                  *---------------------------------------------*
           if        rf-fft-sgl-vpf       not  = c-sgl
                     move  rf-fft-iiv-doc to   srt-tot-key
           else      move  rf-fft-imp-doc to   srt-tot-key            .
           if        rf-fft-tip-doc       =    03
                     multiply -1          by   srt-tot-key            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-350.
      *                  *---------------------------------------------*
      *                  * Sigla valuta per documenti da ricercare     *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts e valori di default per richieste *
      *    * di selezione                                              *
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
      *              *-------------------------------------------------*
      ...
      *              * Tipo movimento da ricercare                     *
      *              *-------------------------------------------------*
           perform   pmt-cod-tmf-000      thru pmt-cod-tmf-999        .
      ...
      *    *===========================================================*
      *    * Prompt per : Codice dipendenza del fornitore              *
      *    *-----------------------------------------------------------*
       pmt-dpz-fnt-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt per : Data registrazione minima da ricercare       *
      *    *-----------------------------------------------------------*
       pmt-dtr-min-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt per : Tipo movimento da ricercare                  *
      *    *-----------------------------------------------------------*
       pmt-cod-tmf-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Prompt per : Sigla valuta documenti da ricercare          *
      *    *-----------------------------------------------------------*
       pmt-sgl-vlt-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       pmt-imp-doc-000.
      *              *-------------------------------------------------*
      *              * Deviazione in funzione del tipo provenienza do- *
      *              * cumento da ricercare                            *
      *              *-------------------------------------------------*
           if        rr-cod-tmf-tpv       =    02 or
                     rr-cod-tmf-tpv       =    03
      ...
      *                          * Test se da eseguire                 *
      *                          *-------------------------------------*
           if        rr-cod-tmf-tpv       not  = 02 and
                     rr-cod-tmf-tpv       not  = 03
                     go to acc-cod-fnt-800.
      ...
      *                  * Salvataggio valore precedente               *
      *                  *---------------------------------------------*
           move      rr-cod-tmf           to   w-sav-cod-tmf          .
           move      rr-cod-tmf-tpv       to   w-sav-cod-tmf-tpv      .
       acc-cod-tmf-100.
      *              *-------------------------------------------------*
      *              * Visualizzazione note operative                  *
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Impostare un codice tipo movimento per fatture for
      -              "nitori, oppure Return per     "
                                          to   v-nt1                  .
           move      "selezionarli tutti.                               
      -              "                              "
                                          to   v-nt2                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-tmf           to   w-cod-des-yff-cod      .
           move      15                   to   w-cod-des-yff-lin      .
           move      30                   to   w-cod-des-yff-pos      .
           move      15                   to   w-cod-des-yff-dln      .
           move      37                   to   w-cod-des-yff-dps      .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "INSR"               to   v-pfk (04)             .
      ...
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   rr-cod-tmf             .
       acc-cod-tmf-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Lettura archivio [yff]                      *
      *                  *---------------------------------------------*
           move      rr-cod-tmf           to   w-let-arc-yff-cod      .
           move      zero                 to   w-let-arc-yff-dpz      .
           perform   let-arc-yff-000      thru let-arc-yff-999        .
           move      w-let-arc-yff-des    to   rr-cod-tmf-des         .
           move      w-let-arc-yff-tpv    to   rr-cod-tmf-tpv         .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se tipo provenienza attuale come prece- *
      *                      * dente : oltre                           *
      *                      *-----------------------------------------*
           if        rr-cod-tmf-tpv       =    w-sav-cod-tmf-tpv
                     go to acc-cod-tmf-800.
      *                      *-----------------------------------------*
      *                      * Visualizzazione prompt per sigla valuta *
      *                      *-----------------------------------------*
           perform   pmt-sgl-vlt-000      thru pmt-sgl-vlt-999        .
      *                      *-----------------------------------------*
      *                      * Visualizzazione prompt importo da ri-   *
      *                      * cercare                                 *
      *                      *-----------------------------------------*
           perform   pmt-imp-doc-000      thru pmt-imp-doc-999        .
      *                      *-----------------------------------------*
      *                      * Se tipo provenienza precedente : CEE o  *
      *                      * Estero                                  *
      *                      *-----------------------------------------*
           if        w-sav-cod-tmf-tpv    =    02 or
                     w-sav-cod-tmf-tpv    =    03
                     go to acc-cod-tmf-620
           else      go to acc-cod-tmf-700.
       acc-cod-tmf-620.
      *                          *-------------------------------------*
      *                          * Normalizzazione sigla valuta        *
      *                          *-------------------------------------*
           if        rr-sgl-vlt           not  = spaces
       ...
       acc-cod-tmf-700.
      *                      *-----------------------------------------*
      *                      * Se tipo provenienza attuale : CEE o E-  *
      *                      * stero                                   *
      *                      *-----------------------------------------*
           if        rr-cod-tmf-tpv       =    02 or
                     rr-cod-tmf-tpv       =    03
                     go to acc-cod-tmf-720
           else      go to acc-cod-tmf-800.
       acc-cod-tmf-720.
      *                          *-------------------------------------*
      *                          * Preparazione default sigla valuta   *
      *                          *-------------------------------------*
           if        rr-sgl-vlt           not  = spaces
                     go to acc-cod-tmf-800.
           move      "C"                  to   w-let-arc-dcf-tle      .
      ...
      *    *===========================================================*
      *    * Accettazione : Importo documento fornitore da ricercare   *
      *    *-----------------------------------------------------------*
       acc-imp-doc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Importo documento fornitore da ricerca- *
      *    * re                                                        *
      *    *-----------------------------------------------------------*
       vis-imp-doc-000.
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   rr-cod-tmf             .
           move      spaces               to   rr-cod-tmf-des         .
           move      zero                 to   rr-cod-tmf-tpv         .
           move      spaces               to   rr-sgl-vlt             .
           move      zero                 to   rr-dec-vlt             .
           move      spaces               to   rr-tdc-vlt             .
      ...
      *                      *-----------------------------------------*
      *                      * Se non esiste una variabile di i.p.c.   *
      *                      * relativa al tipo movimento : no prepa-  *
      *                      * razione default                         *
      *                      *-----------------------------------------*
           if        w-ipc-cod-tmf-snx    not  = "S"
                     go to nor-ric-sel-600.
      *                      *-----------------------------------------*
      *                      * Se la variabile di i.p.c. ha un valore  *
      *                      * a spaces : no preparazione default      *
      *                      *-----------------------------------------*
           if        w-ipc-cod-tmf-val    =    spaces
                     go to nor-ric-sel-600.
      *                      *-----------------------------------------*
      *                      * Lettura archivio [yff]                  *
      *                      *-----------------------------------------*
           move      w-ipc-cod-tmf-val    to   w-let-arc-yff-cod      .
           move      zero                 to   w-let-arc-yff-dpz      .
           perform   let-arc-yff-000      thru let-arc-yff-999        .
           move      w-let-arc-yff-des    to   rr-cod-tmf-des         .
           move      w-let-arc-yff-tpv    to   rr-cod-tmf-tpv         .
      ...
      *                      *-----------------------------------------*
           if        w-ipc-sgl-vlt-snx    not  = "S"
                     go to nor-ric-sel-620.
      *                      *-----------------------------------------*
      *                      * Se il tipo provenienza documento non    *
      *                      * ammette sigla valuta : no preparazione  *
      *                      * default                                 *
      *                      *-----------------------------------------*
           if        rr-cod-tmf-tpv       not  = 02 and
                     rr-cod-tmf-tpv       not  = 03
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-fft-sgl-vpf       to   w-tot-gen-vlt          .
           move      rf-fft-dec-vpf       to   w-tot-gen-ndv          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      srt-num-prt          to   rf-fft-num-prt         .
           move      "pgm/ffo/fls/ioc/obj/ioffft"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
       ...
       qry-liv-det-020.
      *              *-------------------------------------------------*
      *              * Determinazione work per importo documento       *
      *              *-------------------------------------------------*
           if        rf-fft-sgl-vpf       not  = c-sgl
                     move  rf-fft-iiv-doc to   w-qry-liv-det-imp
           else      move  rf-fft-imp-doc to   w-qry-liv-det-imp      .
           if        rf-fft-tip-doc       =    03
                     multiply -1          by   w-qry-liv-det-imp      .
       qry-liv-det-030.
      *              *-------------------------------------------------*
      ...
      *                  * Totale                                      *
      *                  *---------------------------------------------*
           add       w-qry-liv-det-imp    to   w-tot-gen-tot          .
      *                  *---------------------------------------------*
      *                  * Sigla valuta                                *
      *                  *---------------------------------------------*
           if        rf-fft-sgl-vpf       not  = w-tot-gen-vlt
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Preparazione work per stampa            *
      *                      *-----------------------------------------*
           move      rf-fft-num-prt       to   w-num-prt-ext          .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      20                   to   v-pos                  .
           move      rf-fft-dat-reg       to   v-dat                  .
           move      "+"                  to   v-edm                  .
           move      rf-fft-dat-reg       to   w-mpn-dat-reg          .
           move      rf-fft-cod-tmf       to   w-mpn-cod-tmf          .
           move      rf-fft-num-prt       to   w-mpn-num-prt          .
           move      rf-fft-dat-doc       to   w-mpn-dat-doc          .
           move      rf-fft-num-doc       to   w-mpn-num-doc          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-fft-num-doc       to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-fft-sgl-vpf       =    c-sgl
                     move  spaces         to   v-alf
           else      move  rf-fft-sgl-vpf to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Importo documento                           *
      *                  *---------------------------------------------*
           ...
           move      "V"                  to   v-tip                  .
           move      11                   to   v-car                  .
           move      rf-fft-dec-vpf       to   v-dec                  .
           move      "S"                  to   v-sgn                  .
           move      "G"                  to   v-edm                  .
           move      v-lnr                to   v-lin                  .
           move      61                   to   v-pos                  .
           move      w-qry-liv-det-imp    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-cnt                to   w-mpn                  .
      *                  *---------------------------------------------*
      *                  * Scrittura della variabile 'cod-tmf' per il  *
      ...
      *                      *-----------------------------------------*
           move      v-cnt                to   w-mpn                  .
           move      w-mpn-num-prt        to   w-esp-rig-ffr-prt      .
           move      w-mpn-dat-reg        to   w-esp-rig-ffr-drg      .
           move      w-mpn-cod-tmf        to   w-esp-rig-ffr-tmo      .
           move      w-mpn-num-doc        to   w-esp-rig-ffr-ndo      .
           move      w-mpn-dat-doc        to   w-esp-rig-ffr-ddo      .
           move      spaces               to   w-esp-rig-ffr-pro      .
      *                      *-----------------------------------------*
      *                      * Chiamata del modulo                     *
      *                      *-----------------------------------------*
           perform   esp-rig-ffr-esp-000  thru esp-rig-ffr-esp-999    .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     qry-trt-fun-999.
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [yff]                         *
      *    *-----------------------------------------------------------*
       let-arc-yff-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione marker di uscita                *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-yff-flg      .
      *              *-------------------------------------------------*
      *              * Test se codice a spazi                          *
      *              *-------------------------------------------------*
           if        w-let-arc-yff-cod    =    spaces
                     go to let-arc-yff-500.
      *              *-------------------------------------------------*
      *              * Lettura per codice                              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODTMF"             to   f-key                  .
           move      w-let-arc-yff-cod    to   rf-yff-cod-tmf         .
           move      w-let-arc-yff-dpz    to   rf-yff-cod-dpz         .
           move      "pgm/ffo/fls/ioc/obj/iofyff"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-yff                 .
           if        f-sts                not  = e-not-err
                     go to let-arc-yff-400.
       let-arc-yff-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-yff-des-tmf       to   w-let-arc-yff-des      .
           move      rf-yff-tpv-doc       to   w-let-arc-yff-tpv      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     let-arc-yff-999.
       let-arc-yff-400.
      *              *-------------------------------------------------*
      *              * Azioni per record non trovato                   *
      *              *-------------------------------------------------*
           move      "#"                  to   w-let-arc-yff-flg      .
           move      all   "."            to   w-let-arc-yff-des      .
           go to     let-arc-yff-600.
       let-arc-yff-500.
      *              *-------------------------------------------------*
      *              * Normalizzazione work area                       *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-yff-des      .
       let-arc-yff-600.
           move      zero                 to   w-let-arc-yff-tpv      .
       let-arc-yff-999.
           exit.
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione tipo movimento per fattura *
      *    * fornitori                                                 *
      *    *-----------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
           copy      "pgm/ffo/prg/cpy/pffo301x.pgs"                   .
