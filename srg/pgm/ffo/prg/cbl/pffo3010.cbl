      ...
      *                                   Fase:    ffo301              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 22/09/94    *
      *                       Ultima revisione:    NdK del 31/03/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ricerca fatture fornitori                   *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase ffo301, nella sua globalita', esegue i tipi di inter-  *
      ...
      * INTDDR      Ricerca documenti per data registrazione      301d *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   INTERROGAZIONI SU FATTURE FORNITORI  "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'ffo301'           *
      *              *-------------------------------------------------*
           perform   fas-ffo-301-000      thru fas-ffo-301-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Esecuzione ciclo per la fase 'ffo300'                     *
      *    *-----------------------------------------------------------*
       fas-ffo-301-000.
      *              *-------------------------------------------------*
      *              * Video in Off                                    *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-ffo-301-300
           else if   v-key                =    "PRSC"
                     go to fas-ffo-301-400
           else if   v-key                =    "NXSC"
                     go to fas-ffo-301-450
           else if   v-key                =    "DOWN"
                     go to fas-ffo-301-500
           else if   v-key                =    "EXIT"
                     go to fas-ffo-301-250
           else      go to fas-ffo-301-200.
       fas-ffo-301-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-ffo-301-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-ffo-301-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-ffo-301-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-ffo-301-350
           else      go to fas-ffo-301-322.
       fas-ffo-301-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-ffo-301-630
           else if   v-key                =    "PRSC"
                     go to fas-ffo-301-600
           else if   v-key                =    "NXSC"
                     go to fas-ffo-301-610
           else if   v-key                =    "UP  "
                     go to fas-ffo-301-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-ffo-301-650
           else if   v-key                =    "EXIT"
                     go to fas-ffo-301-660
           else      go to fas-ffo-301-570.
       fas-ffo-301-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-ffo-301-626
           else      go to fas-ffo-301-628.
       fas-ffo-301-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-ffo-301-636
           else      go to fas-ffo-301-638.
       fas-ffo-301-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-ffo-301-725
           else      go to fas-ffo-301-750.
       fas-ffo-301-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
