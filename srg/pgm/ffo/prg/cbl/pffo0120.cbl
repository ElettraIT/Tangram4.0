      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pffo0121:        *
      *                                                                *
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice tipo movimento per fat- *
      *    * ture fornitori                                            *
      *    *-----------------------------------------------------------*
      ...
      *              * fattura fornitore                               *
      *              *-------------------------------------------------*
           perform   cod-des-yff-opn-000  thru cod-des-yff-opn-999    .
       rou-opn-fls-999.
           exit.
      ...
      *              * fattura fornitore                               *
      *              *-------------------------------------------------*
           perform   cod-des-yff-cls-000  thru cod-des-yff-cls-999    .
       rou-cls-fls-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-des-yff-cod      .
           move      13                   to   w-cod-des-yff-lin      .
           move      19                   to   w-cod-des-yff-pos      .
           move      zero                 to   w-cod-des-yff-dln      .
           move      zero                 to   w-cod-des-yff-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           ...
           if        w-cnt-sts-imp-ric    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
           perform   cod-des-yff-cll-000  thru cod-des-yff-cll-999    .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
           perform   cod-des-yff-foi-000  thru cod-des-yff-foi-999    .
       acc-cod-min-110.
           perform   cod-des-yff-cll-000  thru cod-des-yff-cll-999    .
           if        w-cod-des-yff-ope    =    "F+"
                     go to acc-cod-min-115.
           if        w-cod-des-yff-ope    =    "AC"
       ...
       acc-cod-min-120.
           move      w-cod-des-yff-cod    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-des-yff-ope      .
           move      rr-cod-max           to   w-cod-des-yff-cod      .
           move      13                   to   w-cod-des-yff-lin      .
           move      51                   to   w-cod-des-yff-pos      .
           move      zero                 to   w-cod-des-yff-dln      .
           move      zero                 to   w-cod-des-yff-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *    *-----------------------------------------------------------*
           copy      "pgm/ffo/prg/cpy/acdeyff0.acs"                   .
