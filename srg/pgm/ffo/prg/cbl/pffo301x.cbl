      ...
      *                                   Fase:                        *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/09/94    *
      *                       Ultima revisione:    NdK del 19/06/18    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo di espansione fatture fornitore per  *
      ...
      *                                                                *
      *              Input  : w-esp-rig-ffr-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-esp-rig-ffr-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "ES"  Espansione                                               *
      *                                                                *
      *              Input  : w-esp-rig-ffr-ope : "ES"                 *
      *                                                                *
      *                       w-esp-rig-ffr-prt : protocollo           *
      *                       w-esp-rig-ffr-num : numero documento     *
      *                       w-esp-rig-ffr-dat : data documento       *
      *                       w-esp-rig-ffr-tmo : tipo documento       *
      *                       w-esp-rig-ffr-pro : codice alfanumerico  *
      *                                           prodotto (opzionale) *
      *                                                                *
      *              Output : nessuno                                  *
      *                                                                *
      ...
      *             tuata una interrogazione sulle righe [ffr]         *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-let.
      *        *-------------------------------------------------------*
      *        * Work per Let su archivio [ffx]                        *
      *        *-------------------------------------------------------*
           05  w-let-arc-ffx.
               10  w-let-arc-ffx-flg      pic  x(01)                  .
               10  w-let-arc-ffx-prt      pic  9(11)                  .
               10  w-let-arc-ffx-prg      pic  9(05)                  .
               10  w-let-arc-ffx-trc      pic  9(02)                  .
               10  w-let-arc-ffx-des.
                   15  w-let-arc-ffx-drg occurs 10
                                          pic  x(40)                  .
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-wrk-qta-cfr              pic s9(10)v9(03)            .
      ...
      *    *-----------------------------------------------------------*
       01  w-aux.
      *        *-------------------------------------------------------*
      *        * Work per espansione record righe fatture fornitore    *
      *        *-------------------------------------------------------*
           05  w-aux-rec-ffr.
               10  w-aux-rec-ffr-rtr      pic  x(01)                  .
               10  w-aux-rec-ffr-c01      pic  9(05)                  .
               10  w-aux-rec-ffr-c02      pic  9(03)                  .
               10  w-aux-rec-ffr-c03      pic  9(05)                  .
               10  w-aux-rec-ffr-c04      pic  9(05)                  .
               10  w-aux-rec-ffr-c05      pic  9(05)                  .
               10  w-aux-rec-ffr-c06      pic  9(05)                  .
               10  w-aux-rec-ffr-cix      pic  9(03)                  .
               10  w-aux-rec-ffr-nli      pic  9(05)                  .
               10  w-aux-rec-ffr-crb      pic  9(05)                  .
               10  w-aux-rec-ffr-max      pic  9(05) value 999        .
               10  w-aux-rec-ffr-cpb      pic  9(05)                  .
               10  w-aux-rec-ffr-cpa      pic  9(05)                  .
               10  w-aux-rec-ffr-lt1      pic  x(03)                  .
               10  w-aux-rec-ffr-lt2      pic  x(03)                  .
               10  w-aux-rec-ffr-ltp      pic  x(17)                  .
               10  w-aux-rec-ffr-buf
                               occurs 999.
                   15  w-aux-rec-ffr-prt  pic  9(11)       comp-3     .
                   15  w-aux-rec-ffr-prg  pic  9(05)       comp-3     .
                   15  w-aux-rec-ffr-alf  pic  x(14)                  .
      ...
      *    *-----------------------------------------------------------*
           copy      "pgm/ffo/prg/cpy/pffo301x.pgl"                   .
      ...
      ******************************************************************
       Procedure Division                using w-esp-rig-ffr
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-esp-rig-ffr-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-esp-rig-ffr-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-esp-rig-ffr-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-esp-rig-ffr-ope    =    "ES"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-esp-rig-ffr-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-aux-rec-ffr-crb      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-esp-rig-ffr-prt    to   rf-ffr-num-prt         .
      ...
      *              *-------------------------------------------------*
           if        rf-ffr-num-prt       not  = w-esp-rig-ffr-prt
                     go to esp-500.
       esp-320.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           add       1                    to   w-aux-rec-ffr-crb      .
      *              *-------------------------------------------------*
      *              * Test se buffer oltre il numero previsto         *
      *              *-------------------------------------------------*
           if        w-aux-rec-ffr-crb    >    w-aux-rec-ffr-max
                     go to esp-500.
       esp-410.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-ffr-qta-acq       to   w-edt-qta-inc-qta      .
           move      rf-ffr-dec-qta       to   w-edt-qta-inc-dec      .
           perform   edt-qta-inc-000      thru edt-qta-inc-999        .
       esp-420.
      *              *-------------------------------------------------*
      ...
      *                  * Numero protocollo                           *
      *                  *---------------------------------------------*
           move      rf-ffr-num-prt       to   w-aux-rec-ffr-prt
                                              (w-aux-rec-ffr-crb)     .
      *                  *---------------------------------------------*
      *                  * Numero progressivo                          *
      *                  *---------------------------------------------*
           move      rf-ffr-num-prg       to   w-aux-rec-ffr-prg
                                              (w-aux-rec-ffr-crb)     .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico  prodotto               *
      *                  *---------------------------------------------*
           if        rf-ffr-tip-rig       =    "P    "
                     move  rf-ffr-alf-mag to   w-aux-rec-ffr-alf
                                              (w-aux-rec-ffr-crb)
           else      move  spaces         to   w-aux-rec-ffr-alf
                                              (w-aux-rec-ffr-crb)     .
       esp-430.
      *              *-------------------------------------------------*
      *              * Riciclo a lettura                               *
      ...
      *              * valore                                          *
      *              *-------------------------------------------------*
           if        w-aux-rec-ffr-crb    =    zero
                     go to esp-999.
      *                  *---------------------------------------------*
      *                  * Determinazione numero pagine nel buffer     *
      *                  *---------------------------------------------*
           move      w-aux-rec-ffr-crb    to   w-aux-rec-ffr-cpb      .
           subtract  1                    from w-aux-rec-ffr-cpb      .
           divide    6                    into w-aux-rec-ffr-cpb      .
           add       1                    to   w-aux-rec-ffr-cpb      .
      *                  *---------------------------------------------*
      *                  * Inizializzazione numero record nel buffer   *
      *                  * attualmente trattato                        *
      *                  *---------------------------------------------*
           move      1                    to   w-aux-rec-ffr-c01      .
       esp-520.
      *              *-------------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      "<"                  to   v-edm                  .
           move      w-esp-rig-ffr-prt    to   w-wrk-num-prt          .
      ...
      *                          *-------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      w-esp-rig-ffr-drg    to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                          *-------------------------------------*
      *                          * String                              *
      ...
      *              *-------------------------------------------------*
           move      w-aux-rec-ffr-c01    to   w-aux-rec-ffr-nli      .
       esp-555.
           if        w-aux-rec-ffr-nli    >    6
                     subtract  6          from w-aux-rec-ffr-nli
                     go to esp-555.
      *                  *---------------------------------------------*
      *                  * Incremento numero linea a video per posi-   *
      *                  * zionamento verticale                        *
      *                  *---------------------------------------------*
           add       09                   to   w-aux-rec-ffr-nli      .
       esp-560.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-esp-rig-ffr-pro    to   w-wrk-fnd-pro-alf      .
      *                      *-----------------------------------------*
      *                      * A 'find'                                *
      *                      *-----------------------------------------*
           go to     esp-620.
      ...
      *                  *---------------------------------------------*
           ...
           if        w-aux-rec-ffr-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-rec-ffr-c01    <    w-aux-rec-ffr-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           if        w-aux-rec-ffr-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-rec-ffr-cpa    <    w-aux-rec-ffr-cpb
           ...
           move      w-aux-rec-ffr-nli    to   v-lin                  .
           move      21                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       esp-580.
      ...
      *                  *---------------------------------------------*
           subtract  1                    from w-aux-rec-ffr-c01      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           subtract  1                    from w-aux-rec-ffr-cpa      .
      *                  *---------------------------------------------*
      *                  * A trattamento contatore per le pagine       *
      *                  *---------------------------------------------*
           go to     esp-596.
      ...
      *              *-------------------------------------------------*
           move      w-aux-rec-ffr-cpa    to   w-aux-rec-ffr-c01      .
           multiply  6                    by   w-aux-rec-ffr-c01      .
           subtract  5                    from w-aux-rec-ffr-c01      .
           go to     esp-590.
       esp-598.
      *              *-------------------------------------------------*
      *              * Se Back                                         *
      *              *-------------------------------------------------*
           move      1                    to   w-aux-rec-ffr-cpa      .
           go to     esp-596.
       esp-600.
      *              *-------------------------------------------------*
      *              * Se Tab                                          *
      *              *-------------------------------------------------*
           move      w-aux-rec-ffr-cpb    to   w-aux-rec-ffr-cpa      .
           go to     esp-596.
       esp-602.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      ...
      *                  * Incremento deviatore per il 'find'          *
      *                  *---------------------------------------------*
           if        w-esp-rig-ffr-pro    not  = spaces
                     add   1              to   w-cnt-swc-fnd-pro      .
      *                  *---------------------------------------------*
      *                  * Test su esito accettazione                  *
      *                  *---------------------------------------------*
           if        w-aux-rec-ffr-cix    =    zero
                     go to esp-575.
      *                  *---------------------------------------------*
      *                  * Posizionamento alla pagina contenente la    *
      *                  * riga trovata                                *
      *                  *---------------------------------------------*
           move      w-aux-rec-ffr-cix    to   w-aux-rec-ffr-c01      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-aux-rec-ffr-c01    to   w-aux-rec-ffr-c02      .
           add       5                    to   w-aux-rec-ffr-c02      .
           divide    6                    into w-aux-rec-ffr-c02      .
           move      w-aux-rec-ffr-c02    to   w-aux-rec-ffr-cpa      .
           subtract  1                    from w-aux-rec-ffr-c02      .
           multiply  6                    by   w-aux-rec-ffr-c02      .
           add       1                    to   w-aux-rec-ffr-c02      .
           add       5
                     w-aux-rec-ffr-c02  giving w-aux-rec-ffr-c03      .
           move      w-aux-rec-ffr-c03    to   w-aux-rec-ffr-c04      .
           if        w-aux-rec-ffr-c03    >    w-aux-rec-ffr-crb
                     move  w-aux-rec-ffr-crb
                                          to   w-aux-rec-ffr-c03      .
      *                  *---------------------------------------------*
      *                  * Posizionamento iniziale                     *
      *                  *---------------------------------------------*
           move      10                   to   w-aux-rec-ffr-c05      .
       esp-951.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-aux-rec-ffr-prt
                    (w-aux-rec-ffr-c02)   to   rf-ffr-num-prt         .
           move      w-aux-rec-ffr-prg
                    (w-aux-rec-ffr-c02)   to   rf-ffr-num-prg         .
           move      "pgm/ffo/fls/ioc/obj/iofffr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      w-aux-rec-ffr-c02    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                      *-----------------------------------------*
           move      rf-ffr-tip-rig       to   w-ctl-tip-rig-tri      .
      *                      *-----------------------------------------*
      *                      * Codice prodotto                         *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      ...
      *
           if        w-ctl-tip-rig-chr (1)
                     ...
                     move  rf-ffr-alf-mag to   w-all-str-cat (2)
      ...
      *                          *-------------------------------------*
           move      rf-ffr-des-rig       to   w-lin-imm-des-rig      .
      *                              *---------------------------------*
      *                              * Proseguimento                   *
      *                              *---------------------------------*
           go to     esp-960.
      ...
      *                          *-------------------------------------*
           move      rf-ffr-num-prt       to   w-let-arc-ffx-prt      .
           move      rf-ffr-num-prg       to   w-let-arc-ffx-prg      .
           move      11                   to   w-let-arc-ffx-trc      .
           perform   let-arc-ffx-000      thru let-arc-ffx-999        .
           move      w-let-arc-ffx-des    to   w-lin-imm-des-rig      .
      *                              *---------------------------------*
      *                              * Proseguimento                   *
      *                              *---------------------------------*
           go to     esp-960.
      ...
      *                              *---------------------------------*
           move      rf-ffr-num-mag       to   w-let-dcp-pdx-cod      .
           move      spaces               to   w-let-dcp-pdx-tar      .
           move      zero                 to   w-let-dcp-pdx-arc      .
           move      rf-ffr-cod-lng       to   w-let-dcp-pdx-lng      .
      ...
      *                              *---------------------------------*
           ...
           move      rf-ffr-cod-lng       to   w-let-arc-dcp-lng      .
      ...
      *
           if        rf-ffr-snx-tum       =    "P"
                     move  rf-ffr-qta-acq to   w-edt-qta-inc-qta
           else if   rf-ffr-snx-tum       =    "S"
                     move  rf-ffr-qta-acq to   w-edt-qta-inc-qta
           else      move  rf-ffr-qta-fda to   w-edt-qta-inc-qta      .
      *
           if        rf-ffr-snx-tum       =    "P"
                     move  rf-ffr-dec-qta to   w-edt-qta-inc-dec
           else if   rf-ffr-snx-tum       =    "S"
                     move  rf-ffr-nde-tum to   w-edt-qta-inc-dec
           else      move  rf-ffr-dec-qta to   w-edt-qta-inc-dec      .
      *
      ...
      *                      *-----------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
           if        rf-ffr-imp-rig       >    9999999999 or
                     rf-ffr-imp-rig       <   -9999999999
                     move  11             to   v-car
           else      move  09             to   v-car                  .
           move      rf-ffr-dec-vpf       to   v-dec                  .
           move      "S"                  to   v-sgn                  .
           if        rf-ffr-imp-rig       >    9999999999 or
                     rf-ffr-imp-rig       <   -9999999999
                     move  "B"            to   v-edm
           else      move  "GB"           to   v-edm                  .
           move      rf-ffr-imp-rig       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      78                   to   v-car                  .
           move      w-aux-rec-ffr-c05    to   v-lin                  .
           move      02                   to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           add       1                    to   w-aux-rec-ffr-c02      .
           add       1                    to   w-aux-rec-ffr-c05      .
           if        w-aux-rec-ffr-c02    not  > w-aux-rec-ffr-c03
                     go to esp-951.
       esp-970.
           if        w-aux-rec-ffr-c02    >    w-aux-rec-ffr-c04
                     go to esp-980.
           if        w-aux-rec-ffr-crb    not  > 6
                     go to esp-980.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-aux-rec-ffr-cpa    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-aux-rec-ffr-lt1      .
      *                      *-----------------------------------------*
      *                      * Editing 'di pagine'                     *
      *                      *-----------------------------------------*
           move      "ED"                 to   v-ope                  .
           ...
           move      spaces               to   v-sgn                  .
           move      "<B"                 to   v-edm                  .
           move      w-aux-rec-ffr-cpb    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-aux-rec-ffr-lt2      .
      *                      *-----------------------------------------*
      *                      * String                                  *
      *                      *-----------------------------------------*
           move      spaces               to   w-aux-rec-ffr-ltp      .
      ...
      *                      *-----------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      03                   to   v-pos                  .
           move      w-aux-rec-ffr-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       esp-989.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      "NUMPRT    "         to   f-key                  .
           move      w-aux-rec-ffr-prt
                    (w-aux-rec-ffr-c01)   to   rf-ffr-num-prt         .
           move      w-aux-rec-ffr-prg
                    (w-aux-rec-ffr-c01)   to   rf-ffr-num-prg         .
           move      "pgm/ffo/fls/ioc/obj/iofffr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "<"                  to   v-edm                  .
           move      w-aux-rec-ffr-c01    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *
           if        rf-ffr-snx-tum       =    "P"
                     move  rf-ffr-dec-qta to   v-dec
           else if   rf-ffr-snx-tum       =    "S"
                     move  rf-ffr-nde-tum to   v-dec
           else      move  rf-ffr-dec-qta to   v-dec                  .
      *
           move      "S"                  to   v-sgn                  .
           move      "<BG"                to   v-edm                  .
           move      11                   to   v-lin                  .
      ...
      *
           if        rf-ffr-snx-tum       =    "P"
                     move  rf-ffr-qta-acq to   v-num
           else if   rf-ffr-snx-tum       =    "S"
                     move  rf-ffr-qta-fda to   v-num
           else      move  rf-ffr-qta-fda to   v-num                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       esp-rig-510.
      ...
      *                      * Test se da visualizzare                 *
      *                      *-----------------------------------------*
           if        rf-ffr-snx-tum       not  = "S" and
                     rf-ffr-snx-tum       not  = "P"
                     go to esp-rig-520.
      *                      *-----------------------------------------*
      *                      * Visualizzazione                         *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        rf-ffr-snx-tum       =    "P"
                     move  rf-ffr-qta-fda to   w-wrk-qta-cfr
           else      move  rf-ffr-qta-acq to   w-wrk-qta-cfr          .
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           if        rf-ffr-snx-tum       =    "P"
                     move  rf-ffr-umf-tum to   w-wrk-umi-sec
           else      move  rf-ffr-umi-acq to   w-wrk-umi-sec          .
      *                              *---------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      09                   to   v-car                  .
           move      rf-ffr-dec-vpf       to   v-dec                  .
           add       rf-ffr-dec-prz       to   v-dec                  .
           move      spaces               to   v-sgn                  .
           move      "<BG"                to   v-edm                  .
           move      12                   to   v-lin                  .
           move      23                   to   v-pos                  .
           move      rf-ffr-prz-acq       to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Legame valutario                            *
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-ffr-ctp-acq       to   w-edt-cod-pdc-cod      .
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-let-arc-ffx-trc      .
           perform   let-arc-ffx-000      thru let-arc-ffx-999        .
           move      w-let-arc-ffx-des    to   w-wrk-des-rig          .
      *                  *---------------------------------------------*
      ...
      *
           if        w-ctl-tip-rig-chr (1)
                     ...
                     move  w-ctl-tip-rig-aoc
                                          to   v-alf
           else      move  rf-ffr-alf-mag to   v-alf                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-pro-999.
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [ffx]                         *
      *    *-----------------------------------------------------------*
       let-arc-ffx-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione marker di uscita                *
      *              *-------------------------------------------------*
           move      spaces               to   w-let-arc-ffx-flg      .
      *              *-------------------------------------------------*
      *              * Test se codici nulli                            *
      *              *-------------------------------------------------*
           if        w-let-arc-ffx-prt    =    zero   or
                     w-let-arc-ffx-prg    =    zero   or
                     w-let-arc-ffx-trc    =    zero
                     go to let-arc-ffx-500.
      *              *-------------------------------------------------*
      *              * Lettura per codice                              *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-let-arc-ffx-prt    to   rf-ffx-num-prt         .
           move      w-let-arc-ffx-prg    to   rf-ffx-num-prg         .
           move      w-let-arc-ffx-trc    to   rf-ffx-tip-rec         .
           move      "pgm/ffo/fls/ioc/obj/iofffx"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-ffx                 .
           if        f-sts                not  = e-not-err
                     go to let-arc-ffx-400.
       let-arc-ffx-200.
      *              *-------------------------------------------------*
      *              * Bufferizzazione valori                          *
      *              *-------------------------------------------------*
           move      rf-ffx-des-400       to   w-let-arc-ffx-des      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     let-arc-ffx-999.
       let-arc-ffx-400.
      *              *-------------------------------------------------*
      *              * Azioni per record non trovato                   *
      *              *-------------------------------------------------*
           move      "#"                  to   w-let-arc-ffx-flg      .
           move      spaces               to   w-let-arc-ffx-des      .
           move      all   "."            to   w-let-arc-ffx-drg (1)  .
           go to     let-arc-ffx-999.
       let-arc-ffx-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-aux-rec-ffr-cix      .
      *              *-------------------------------------------------*
      *              * Salvataggio immagine video                      *
      *              *-------------------------------------------------*
           move      "SV"                 to   v-ope                  .
      ...
      *              * Inizio scansione                                *
      *              *-------------------------------------------------*
           move      w-aux-rec-ffr-c01    to   w-aux-rec-ffr-c06      .
           move      zero                 to   w-aux-rec-ffr-cix      .
       esp-fnd-ric-200.
      *              *-------------------------------------------------*
      *              * Test max                                        *
      *              *-------------------------------------------------*
           add       1                    to   w-aux-rec-ffr-c06      .
           if        w-aux-rec-ffr-c06    >    w-aux-rec-ffr-crb or
                     w-aux-rec-ffr-c06    >    w-aux-rec-ffr-max
                     go to esp-fnd-ric-900.
      *              *-------------------------------------------------*
      *              * Test di confronto                               *
      *              *-------------------------------------------------*
           if        w-wrk-fnd-pro-alf    =    w-aux-rec-ffr-alf
                                              (w-aux-rec-ffr-c06)
                     move  w-aux-rec-ffr-c06
                                          to   w-aux-rec-ffr-cix
                     go to esp-fnd-ric-900.
       esp-fnd-ric-600.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
