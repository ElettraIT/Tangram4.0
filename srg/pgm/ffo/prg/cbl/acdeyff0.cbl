      ...
      *                                   Fase:                        *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 13/09/94    *
      ...
      *                                                                *
      *              Input  : w-cod-des-yff-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-yff-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-yff-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-yff-cod : codice tipo movim.   *
      *                                                                *
      *                       w-cod-des-yff-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-yff-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-yff-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-yff-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-yff-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-yff-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-yff-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-yff-cod : codice tipo movim.   *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-tmb.
           05  w-aux-cde-tmb-nli          pic  9(02)                  .
           05  w-aux-cde-tmb-crb          pic  9(02)                  .
           05  w-aux-cde-tmb-cpb          pic  9(02)                  .
           05  w-aux-cde-tmb-cpa          pic  9(02)                  .
           05  w-aux-cde-tmb-bix          pic  9(02)                  .
           05  w-aux-cde-tmb-buf
                               occurs 30.
               10  w-aux-cde-tmb-bco      pic  x(05)                  .
               10  w-aux-cde-tmb-bde      pic  x(30)                  .
           05  w-aux-cde-tmb-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-tmb-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-tmb-lt2      pic  9(01)                  .
           05  w-aux-cde-tmb-dup          pic  x(30)                  .
           05  w-aux-cde-tmb-dmx.
               10  w-aux-cde-tmb-dch
                               occurs 30  pic  x(01)                  .
           05  w-aux-cde-tmb-c01          pic  9(02)                  .
           05  w-aux-cde-tmb-c02          pic  9(02)                  .
           05  w-aux-cde-tmb-c03          pic  9(02)                  .
           05  w-aux-cde-tmb-c04          pic  9(02)                  .
           05  w-aux-cde-tmb-c05          pic  9(02)                  .
      ...
      *    *===========================================================*
      *    * Link-area per accettazione tipo movimento fattura forni-  *
      *    * tore                                                      *
      *    *-----------------------------------------------------------*
           copy      "pgm/ffo/prg/cpy/acdeyff0.acl"                   .
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-yff
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-yff-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-yff-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-yff-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-yff-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-yff-ope    =    "A+" or
                     w-cod-des-yff-ope    =    "I+" or
                     w-cod-des-yff-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-yff-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-cod-des-yff-cod    to   w-cod-des-yff-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-yff-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-yff-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-yff-s90    to   v-ufk                  .
           move      w-cod-des-yff-lin    to   v-lin                  .
           move      w-cod-des-yff-pos    to   v-pos                  .
           move      w-cod-des-yff-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-yff-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-yff-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-yff-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-yff-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-yff-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-yff-cod    to   w-cod-des-yff-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-yff-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-yff-dln    =    zero or
                     w-cod-des-yff-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-tmb-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      w-cod-des-yff-dln    to   v-lin                  .
           move      w-cod-des-yff-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-yff-dln    to   v-lin                  .
           move      w-cod-des-yff-dps    to   v-pos                  .
           move      w-aux-cde-tmb-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-tmb-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-tmb-dup    to   w-aux-cde-tmb-dmx      .
           move      30                   to   w-aux-cde-tmb-c01      .
       aco-680.
           if        w-aux-cde-tmb-c01    >    zero
                     if    w-aux-cde-tmb-dch
                          (w-aux-cde-tmb-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-tmb-dch
                                              (w-aux-cde-tmb-c01)
                           subtract 1     from w-aux-cde-tmb-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-tmb-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-tmb-dup    to   rf-yff-des-key         .
           move      spaces               to   rf-yff-cod-tmf         .
           move      zero                 to   rf-yff-cod-dpz         .
           move      "pgm/ffo/fls/ioc/obj/iofyff"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-yff-des-key       >    w-aux-cde-tmb-dmx
                     go to aco-800.
      *                          *-------------------------------------*
      *                          * Selezione sul record : solo records *
      *                          * con codice dipendenza a zero        *
      *                          *-------------------------------------*
           if        rf-yff-cod-dpz       not  = zero
                     go to aco-710.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-tmb-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-tmb-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      rf-yff-cod-tmf       to   w-aux-cde-tmb-bco
                                              (w-aux-cde-tmb-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione tipo movimento      *
      *                              *---------------------------------*
           move      rf-yff-des-tmf       to   w-aux-cde-tmb-bde
                                              (w-aux-cde-tmb-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-tmb-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-tmb-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-tmb-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      30                   to   s-car                  .
           move      w-aux-cde-tmb-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-tmb-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-tmb-bco
                    (w-aux-cde-tmb-bix)   to   w-cod-des-yff-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-tmb-crb    to   w-aux-cde-tmb-cpb      .
           subtract  1                    from w-aux-cde-tmb-cpb      .
           divide    6                    into w-aux-cde-tmb-cpb      .
           add       1                    to   w-aux-cde-tmb-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-tmb-c01      .
      *                              *---------------------------------*
      ...
      *                              * di indice (w-aux-cde-tmb-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-tmb-c01    to   w-aux-cde-tmb-nli      .
       aco-865.
           if        w-aux-cde-tmb-nli    >    6
                     subtract  6          from w-aux-cde-tmb-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-tmb-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-tmb-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-tmb-c01    <    w-aux-cde-tmb-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-tmb-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-tmb-cpa    <    w-aux-cde-tmb-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-tmb-nli    to   v-lin                  .
           move      30                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-tmb-c01    to   w-aux-cde-tmb-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-tmb-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-tmb-cpa    to   w-aux-cde-tmb-c01      .
           multiply  6                    by   w-aux-cde-tmb-c01      .
           subtract  5                    from w-aux-cde-tmb-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-tmb-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-tmb-c01    to   w-aux-cde-tmb-c02      .
           add       5                    to   w-aux-cde-tmb-c02      .
           divide    6                    into w-aux-cde-tmb-c02      .
           move      w-aux-cde-tmb-c02    to   w-aux-cde-tmb-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-tmb-c02      .
           multiply  6                    by   w-aux-cde-tmb-c02      .
           add       1                    to   w-aux-cde-tmb-c02      .
           add       5
                     w-aux-cde-tmb-c02  giving w-aux-cde-tmb-c03      .
           move      w-aux-cde-tmb-c03    to   w-aux-cde-tmb-c04      .
           if        w-aux-cde-tmb-c03    >    w-aux-cde-tmb-crb
                     move  w-aux-cde-tmb-crb
                                          to   w-aux-cde-tmb-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-tmb-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      05                   to   v-car                  .
           move      w-aux-cde-tmb-c05    to   v-lin                  .
           move      23                   to   v-pos                  .
           move      w-aux-cde-tmb-bco
                    (w-aux-cde-tmb-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-tmb-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-tmb-c02    not  > w-aux-cde-tmb-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-tmb-c02    >    w-aux-cde-tmb-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-tmb-cpa    to   w-aux-cde-tmb-lt1      .
           move      w-aux-cde-tmb-cpb    to   w-aux-cde-tmb-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-tmb-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
