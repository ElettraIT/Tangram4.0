      ...
      *    *-----------------------------------------------------------*
       01  w-rip-str.
      *        *-------------------------------------------------------*
      *        * Work-area per ripristino Start su [ffr] per Expand    *
      *        *-------------------------------------------------------*
           05  w-rip-str-ffr.
      *            *---------------------------------------------------*
      *            * Flag di End-of-file                               *
      *            *---------------------------------------------------*
               10  w-rip-str-ffr-eof      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Parametri di Start                                *
      *            *---------------------------------------------------*
               10  w-rip-str-ffr-dpz      pic  9(02)                  .
               10  w-rip-str-ffr-tip      pic  9(02)                  .
               10  w-rip-str-ffr-pro      pic  9(07)                  .
               10  w-rip-str-ffr-dat      pic  9(07)                  .
               10  w-rip-str-ffr-num      pic  9(11)                  .
               10  w-rip-str-ffr-prt      pic  9(09)                  .
               10  w-rip-str-ffr-prg      pic  9(05)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      10                   to   w-cod-des-yff-lin      .
           move      30                   to   w-cod-des-yff-pos      .
           move      10                   to   w-cod-des-yff-dln      .
           move      41                   to   w-cod-des-yff-dps      .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
           move      "INSR"               to   v-pfk (04)             .
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su [ffr] per materia prima                *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "MAGDAT    "         to   f-key                  .
           move      rr-dpz-inu           to   rf-ffr-cod-dpz         .
           move      03                   to   rf-ffr-tip-mag         .
           move      rr-cod-map           to   rf-ffr-num-mag         .
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-ffr-num-mag       not  = rr-cod-map
                     go to qry-tst-max-900.
       qry-tst-max-200.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-ffr-dat-reg       to   w-mpn-dat-reg          .
           move      rf-ffr-cod-tmf       to   w-mpn-cod-tmf          .
           move      rf-ffr-num-prt       to   w-mpn-num-prt          .
           move      rf-ffr-dat-doc       to   w-mpn-dat-doc          .
           move      rf-ffr-num-doc       to   w-mpn-num-doc          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-ffr-num-doc       to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
       ...
       int-pag-sta-200.
      *              *-------------------------------------------------*
      *              * Sub-intestazione per materia prima              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Salvataggio parametri per Start su [ffr]    *
      *                  *---------------------------------------------*
           if        w-rip-str-ffr-eof    not  = spaces
                     go to qry-trt-fun-320.
           move      rf-ffr-cod-dpz       to   w-rip-str-ffr-dpz      .
           move      rf-ffr-tip-mag       to   w-rip-str-ffr-tip      .
           move      rf-ffr-num-mag       to   w-rip-str-ffr-pro      .
           move      rf-ffr-dat-reg       to   w-rip-str-ffr-dat      .
           move      rf-ffr-num-prt       to   w-rip-str-ffr-prt      .
           move      rf-ffr-num-prg       to   w-rip-str-ffr-prg      .
       qry-trt-fun-320.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "MAGDAT    "         to   f-key                  .
           move      w-rip-str-ffr-dpz    to   rf-ffr-cod-dpz         .
           move      w-rip-str-ffr-tip    to   rf-ffr-tip-mag         .
           move      w-rip-str-ffr-pro    to   rf-ffr-num-mag         .
           move      w-rip-str-ffr-dat    to   rf-ffr-dat-reg         .
           move      w-rip-str-ffr-prt    to   rf-ffr-num-prt         .
           move      w-rip-str-ffr-prg    to   rf-ffr-num-prg         .
           move      "pgm/ffo/fls/ioc/obj/iofffr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *===========================================================*
      *    * Subroutines per l'accettazione tipo movimento per fatture *
      *    * fornitori                                                 *
      *    *-----------------------------------------------------------*
