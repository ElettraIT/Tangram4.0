      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tipi movimento per fatture   *
      *                    fornitori                                   *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  TIPI MOVIMENTO PER FATTURE FORNITORI  "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      30                   to   v-pos                  .
           move      rf-yff-des-tmf       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-yff-cod-tmf       to   w-mpn-cod-tmf          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *
           if        rf-yff-flg-mos       =    "M"
                     move "(Merce)   "    to   v-alf
           else if   rf-yff-flg-mos       =    "S"
                     move "(Servizi) "    to   v-alf
           else      move  spaces         to   v-alf                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Eventuale Regime fiscale                    *
      *                  *---------------------------------------------*
           if        rf-yff-flg-rfp       not  = "R"
                     go to qry-liv-det-999.
      *
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-tmf'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
