      ...
      *================================================================*
      *                                                                *
      *          Gestione catena mov 3 per programma pffo3000          *
      *                                                                *
      * ============================================================== *
      * Tipi operazione                                                *
      *                                                                *
      ...
      *                                                                *
      *             Input  : w-cat-rg3-ope = "OP"                      *
      *                                                                *
      *             Output : nessuno                                   *
      *                                                                *
      * "CL" - Close, fine utilizzo gestione catena                    *
      *                                                                *
      *             Input  : w-cat-rg3-ope = "CL"                      *
      *                                                                *
      *             Output : nessuno                                   *
      *                                                                *
      * "BE" - Begin, inizio nuova catena                              *
      *                                                                *
      *             Input  : w-cat-rg3-ope = "BE"                      *
      *                                                                *
      *             Output : w-cat-rg3-cur = zero                      *
      *                      w-cat-rg3-max = zero                      *
      *                      w-cat-rg3-prg = zero                      *
      *                      w-cat-rg3-app = spaces                    *
      *                      w-cat-rg3-ins = #                         *
      *                      w-cat-rg3-new = spaces                    *
      *                      w-cat-rg3-lst = spaces                    *
      *                                                                *
      * "PT" - Put Record, inserimento record pieno a fine catena      *
      *                                                                *
      *             Input  : w-cat-rg3-ope = "PT"                      *
      *                      w-cat-rg3-prg = numero progressivo da at- *
      *                                      tribuire al record da     *
      *                                      aggiungere in coda        *
      *                      w-cat-rg3-buf = buffer dati               *
      *                                                                *
      *             Output : w-cat-rg3-exs = return status code        *
      *                      w-cat-rg3-cur = numero d'ordine del re-   *
      *                                      cord corrente aggiunto    *
      *                      w-cat-rg3-max = aumentato di 1            *
      *                      w-cat-rg3-prg = numero progressivo attri- *
      *                                      buito al record corrente  *
      *                                      aggiunto                  *
      *                      w-cat-rg3-app = spaces oppure #           *
      *                      w-cat-rg3-ins = spaces oppure #           *
      *                      w-cat-rg3-new = spaces                    *
      *                      w-cat-rg3-lst = #                         *
      *                                                                *
      * "UP" - Update, aggiornamento record in catena                  *
      *                                                                *
      *             Input  : w-cat-rg3-ope = "UP"                      *
      *                      w-cat-rg3-num = numero d'ordine del re-   *
      *                                      cord da aggiornare        *
      *                      w-cat-rg3-buf = buffer dati               *
      *                                                                *
      *             Output : w-cat-rg3-exs = return status code        *
      *                      w-cat-rg3-cur = invariato                 *
      *                      w-cat-rg3-max = invariato                 *
      *                      w-cat-rg3-prg = invariato                 *
      *                      w-cat-rg3-app = invariato                 *
      *                      w-cat-rg3-ins = invariato                 *
      *                      w-cat-rg3-new = invariato                 *
      *                      w-cat-rg3-lst = invariato                 *
      *                                                                *
      * "ST" - Start, posizionamento su catena                         *
      *                                                                *
      *             Input  : w-cat-rg3-ope = "ST"                      *
      *                      w-cat-rg3-num = numero d'ordine del re-   *
      ...
      *                                                                *
      *             Input  : w-cat-rg3-ope = "RN"                      *
      *                                                                *
      *             Output : w-cat-rg3-exs = return status code        *
      *                      w-cat-rg3-cur = numero d'ordine del re-   *
      *                                      cord corrente letto       *
      *                      w-cat-rg3-max = invariato                 *
      *                      w-cat-rg3-prg = numero progressivo del    *
      *                                      record corrente letto     *
      *                      w-cat-rg3-app = invariato                 *
      *                      w-cat-rg3-ins = spaces oppure #           *
      *                      w-cat-rg3-new = spaces                    *
      *                      w-cat-rg3-lst = spaces oppure #           *
      *                      w-cat-rg3-buf = buffer dati               *
      *                                                                *
      * "RD" - Read, lettura casuale della catena                      *
      *                                                                *
      *             Input  : w-cat-rg3-ope = "RD"                      *
      *                      w-cat-rg3-num = numero d'ordine del re-   *
      *                                      cord da leggere           *
      *                                                                *
      *             Output : w-cat-rg3-exs = return status code        *
      ...
      *                                      lo rimosso                *
      *                      w-cat-rg3-max = diminuito di 1            *
      *                      w-cat-rg3-prg = numero progressivo del    *
      *                                      record successivo a       *
      *                                      quello rimosso            *
      *                      w-cat-rg3-app = spaces oppure #           *
      *                      w-cat-rg3-ins = spaces oppure #           *
      *                      w-cat-rg3-new = spaces oppure #           *
      *                      w-cat-rg3-lst = spaces oppure #           *
      *                      w-cat-rg3-buf = buffer dati relativo ad   *
      *                                      elemento successivo  al   *
      *                                      rimosso                   *
      *                                                                *
      * "LR" - Last Removed, ultimo record rimosso della catena        *
      *                                                                *
      *             Input  : w-cat-rg3-ope = "LR"                      *
      *                                                                *
      *             Output : w-cat-rg3-exs = return status code        *
      *                      w-cat-rg3-buf = buffer dati               *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  fil-rec.
      *        *-------------------------------------------------------*
      *        * Area dati in grado di ospitare l'area w-rg3 del pro-  *
      *        * gramma chiamante                                      *
      *        *-------------------------------------------------------*
           05  fil-dat.
      ...
      *        *-------------------------------------------------------*
           05  w-pnt-max-ele              pic  9(05) value 96         .
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Cache memory per i primi 96 elementi                      *
      *    *-----------------------------------------------------------*
       01  w-chm.
      *        *-------------------------------------------------------*
      *        * Numero di elementi nella cache memory                 *
      *        *-------------------------------------------------------*
           05  w-chm-max                  pic  9(02)       value 96   .
      *        *-------------------------------------------------------*
      *        * Elementi                                              *
      *        *-------------------------------------------------------*
           05  w-chm-tbl occurs 96.
      *            *---------------------------------------------------*
      *            * Elemento in grado di ospitare l'area w-rg3 del    *
      *            * programma chiamante                               *
      *            *---------------------------------------------------*
               10  w-chm-ele.
      ...
      *    *===========================================================*
      *    * Area di comunicazione per gestione catena mov 2           *
      *    *-----------------------------------------------------------*
       01  w-cat-rg3.
      *        *-------------------------------------------------------*
      *        * Tipo operazione                                       *
      *        *-------------------------------------------------------*
           05  w-cat-rg3-ope              pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Return status code                                    *
      *        * - Spaces : operazione eseguita                        *
      *        * - #      : errore di esecuzione                       *
      *        *-------------------------------------------------------*
           05  w-cat-rg3-exs              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Numero d'ordine del record interessato                *
      *        *-------------------------------------------------------*
           05  w-cat-rg3-num              pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Numero d'ordine del record corrente                   *
      *        *-------------------------------------------------------*
           05  w-cat-rg3-cur              pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Numero riga progressivo record corrente               *
      *        *-------------------------------------------------------*
           05  w-cat-rg3-prg              pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Numero d'ordine dell'ultimo record                    *
      *        *-------------------------------------------------------*
           05  w-cat-rg3-max              pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Flag di append possibile                              *
      *        *-------------------------------------------------------*
           05  w-cat-rg3-app              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Flag di inserimento possibile                         *
      *        *-------------------------------------------------------*
           05  w-cat-rg3-ins              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Flag di record New                                    *
      *        *-------------------------------------------------------*
           05  w-cat-rg3-new              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Flag di record Last                                   *
      *        *-------------------------------------------------------*
           05  w-cat-rg3-lst              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Buffer dati, in grado di ospitare l'area w-rg3 del    *
      *        * programma chiamante                                   *
      *        *-------------------------------------------------------*
           05  w-cat-rg3-buf.
               10  filler occurs 1024     pic  x(01)                  .
      ...
      ******************************************************************
       Procedure Division                using w-cat-rg3              .
      ******************************************************************
      ...
      *                  * Update                                      *
      *                  *---------------------------------------------*
           else if   w-cat-rg3-ope        =    "UP"
                     perform upd-000      thru upd-999
      *                  *---------------------------------------------*
      *                  * Read Next                                   *
      *                  *---------------------------------------------*
           else if   w-cat-rg3-ope        =    "RN"
                     perform rnx-000      thru rnx-999
      *                  *---------------------------------------------*
      *                  * Read                                        *
      *                  *---------------------------------------------*
           else if   w-cat-rg3-ope        =    "RD"
                     perform rea-000      thru rea-999
      *                  *---------------------------------------------*
      *                  * Append Record                               *
      *                  *---------------------------------------------*
           else if   w-cat-rg3-ope        =    "AP"
                     perform app-000      thru app-999
      *                  *---------------------------------------------*
      *                  * Start                                       *
      *                  *---------------------------------------------*
           else if   w-cat-rg3-ope        =    "ST"
                     perform str-000      thru str-999
      *                  *---------------------------------------------*
      *                  * Last Removed                                *
      *                  *---------------------------------------------*
           else if   w-cat-rg3-ope        =    "LR"
                     perform lrm-000      thru lrm-999
      *                  *---------------------------------------------*
      *                  * Insert Record                               *
      *                  *---------------------------------------------*
           else if   w-cat-rg3-ope        =    "IN"
                     perform ins-000      thru ins-999
      *                  *---------------------------------------------*
      *                  * Remove Record                               *
      *                  *---------------------------------------------*
           else if   w-cat-rg3-ope        =    "RM"
                     perform rmv-000      thru rmv-999
      *                  *---------------------------------------------*
      *                  * Begin                                       *
      *                  *---------------------------------------------*
           else if   w-cat-rg3-ope        =    "BE"
                     perform beg-000      thru beg-999
      *                  *---------------------------------------------*
      *                  * Open                                        *
      *                  *---------------------------------------------*
           else if   w-cat-rg3-ope        =    "OP"
                     perform opn-000      thru opn-999
      *                  *---------------------------------------------*
      *                  * Close                                       *
      *                  *---------------------------------------------*
           else if   w-cat-rg3-ope        =    "CL"
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-cat-rg3-cur          .
      *              *-------------------------------------------------*
      *              * Numero d'ordine dell'ultimo record a zero       *
      *              *-------------------------------------------------*
           move      zero                 to   w-cat-rg3-max          .
      *              *-------------------------------------------------*
      ...
      *              * Flag di append possibile                        *
      *              *-------------------------------------------------*
           move      spaces               to   w-cat-rg3-app          .
      *              *-------------------------------------------------*
      *              * Flag di inserimento non possibile               *
      *              *-------------------------------------------------*
           move      "#"                  to   w-cat-rg3-ins          .
      *              *-------------------------------------------------*
      *              * Flag di record New : No                         *
      *              *-------------------------------------------------*
           move      spaces               to   w-cat-rg3-new          .
      *              *-------------------------------------------------*
      *              * Flag di record Last : No                        *
      *              *-------------------------------------------------*
           move      spaces               to   w-cat-rg3-lst          .
       beg-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cat-rg3-num        =    zero       or
                     w-cat-rg3-num        >    w-cat-rg3-max
                     go to upd-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      1                    to   w-cat-rg3-cur          .
       upd-200.
      *              *-------------------------------------------------*
      *              * Test se trovato elemento di destinazione        *
      *              *-------------------------------------------------*
           if        w-cat-rg3-cur        =    w-cat-rg3-num
                     go to upd-600.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-pnt-num-prg
                    (w-wrk-rec-num)       to   w-cat-rg3-prg          .
      *                  *---------------------------------------------*
      ...
      *              * Test se trovato elemento di destinazione        *
      *              *-------------------------------------------------*
           if        w-wrk-str-ord        =    w-cat-rg3-num
                     go to str-999.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-wrk-str-ord        to   w-cat-rg3-cur          .
      *              *-------------------------------------------------*
      *              * Aggiornamento record number start-pointer       *
      *              *-------------------------------------------------*
           move      w-pnt-nxt-ele
      ...
      *                  *---------------------------------------------*
           move      w-cat-rg3-prg        to   w-pnt-num-prg
                                              (w-pnt-num-ele)         .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-cat-rg3-prg        to   w-prg-rig-max          .
      *                  *---------------------------------------------*
      *                  * Incremento numero d'ordine ultimo record    *
      *                  *---------------------------------------------*
           add       1                    to   w-cat-rg3-max          .
      ...
      *                  *---------------------------------------------*
           move      w-cat-rg3-max        to   w-cat-rg3-cur          .
      *                  *---------------------------------------------*
      *                  * Spostamento record in area file             *
      *                  *---------------------------------------------*
           move      w-cat-rg3-buf        to   fil-rec                .
      ...
      *              * Test se trovato elemento di destinazione        *
      *              *-------------------------------------------------*
           if        w-wrk-ord-rmv        =    w-cat-rg3-num
                     go to rmv-600.
      *              *-------------------------------------------------*
      *              * Allineamento su elemento successivo della cate- *
      *              * na                                              *
      ...
      *              *-------------------------------------------------*
           move      w-pnt-ele-new
                    (w-wrk-rec-num)       to  w-cat-rg3-new           .
      *              *-------------------------------------------------*
      *              * Se record New si ritorna un buffer a spaces     *
      *              *-------------------------------------------------*
           if        w-cat-rg3-new        not  = spaces
                     move  spaces         to   w-cat-rg3-buf
                     go to let-999.
      *              *-------------------------------------------------*
      ...
      *              * Numero progressivo per inserimento              *
      *              *-------------------------------------------------*
           if        w-cat-rg3-max        not  < w-pnt-max-ele
      ...
      *              *-------------------------------------------------*
           if        w-prg-rig-app        =    zero
                     move  "#"            to   w-cat-rg3-app
           else      move  spaces         to   w-cat-rg3-app          .
      *              *-------------------------------------------------*
      *              * Flag di inserimento                             *
      *              *-------------------------------------------------*
           if        w-prg-rig-ins        =    zero
                     move  "#"            to   w-cat-rg3-ins
           else      move  spaces         to   w-cat-rg3-ins          .
      *              *-------------------------------------------------*
      *              * Flag di record Last                             *
      *              *-------------------------------------------------*
           if        w-cat-rg3-cur        =    w-cat-rg3-max
                     move  "#"            to   w-cat-rg3-lst
           else      move  spaces         to   w-cat-rg3-lst          .
       dpf-999.
           exit.
