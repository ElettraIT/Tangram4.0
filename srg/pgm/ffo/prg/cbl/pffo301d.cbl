      ...
      *                       Ultima revisione:    NdK del 11/11/21    *
      *                    ------------------------------------------- *
      ...
      *    *-----------------------------------------------------------*
       pmt-dat-doc-000.
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su estremi del documento fornitore :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      08                   to   w-cod-des-yff-lin      .
           move      30                   to   w-cod-des-yff-pos      .
           move      08                   to   w-cod-des-yff-dln      .
      ...
      *    *===========================================================*
      *    * Accettazione : Sigla valuta documenti da ricercare        *
      *    *-----------------------------------------------------------*
       acc-sgl-vlt-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Sigla valuta documenti da ricercare     *
      *    *-----------------------------------------------------------*
       vis-sgl-vlt-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-tmf           to   rf-fft-cod-tmf         .
      ...
      *              *-------------------------------------------------*
       ...
       qry-tst-max-200.
      *              *-------------------------------------------------*
      *              * Se oltre data registrazione max : superamento   *
      *              *-------------------------------------------------*
           if        rr-dtr-max           =    zero
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        rf-fft-cod-tmf       =    rr-cod-tmf
                     go to qry-sel-rec-300
           else      go to qry-sel-rec-900.
       qry-sel-rec-300.
      *              *-------------------------------------------------*
      *              * Selezione su sigla valuta documento da ricerca- *
      *              * re                                              *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       qry-sel-rec-600.
      *              *-------------------------------------------------*
      *              * Selezione su importo documento fornitore da ri- *
      *              * cercare                                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se da effettuare                       *
      ...
      *                  *---------------------------------------------*
      *                  * Deviazione a seconda che la sigla valuta    *
      *                  * documento sia pari o meno quella base       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-fft-cod-arc       to   w-let-arc-dcf-cod      .
           move      rf-fft-dpz-arc       to   w-let-arc-dcf-dpz      .
