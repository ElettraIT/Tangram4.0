      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su [ffr] per prodotto                     *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "MAGDAT    "         to   f-key                  .
           move      rr-dpz-inu           to   rf-ffr-cod-dpz         .
           move      01                   to   rf-ffr-tip-mag         .
           move      rr-cod-pro           to   rf-ffr-num-mag         .
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-ffr-num-mag       not  = rr-cod-pro
                     go to qry-tst-max-900.
       qry-tst-max-200.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rr-alf-pro           to   w-esp-rig-ffr-pro      .
      *                      *-----------------------------------------*
      *                      * Chiamata del modulo                     *
      *                      *-----------------------------------------*
