      ...
      *                  * pro-forma                                   *
      *                  *---------------------------------------------*
           if        rf-fft-tip-doc       =    04
                     go to stp-srt-inp-fft-200.
       stp-srt-inp-fft-500.
      *              *-------------------------------------------------*
      *              * Ciclo di scansione righe documento              *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-ffr-000  thru stp-srt-inp-ffr-999    .
       stp-srt-inp-fft-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-ffr-tip-rig
                    (01 : 01)             =    "C"
                     go to stp-srt-inp-ffr-200.
      *                  *---------------------------------------------*
      *                  * Test se presente riferimento a bolla        *
      *                  *---------------------------------------------*
           if        rf-ffr-bfo-prt       =    zero
                     go to stp-srt-inp-ffr-200.
       stp-srt-inp-ffr-500.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-ffr-num-prt       to   srt-prt-dsr            .
           move      rf-ffr-num-prg       to   srt-prg-dsr            .
           move      21                   to   srt-tip-dtr            .
           move      rf-ffr-bfo-prt       to   srt-prt-dtr            .
           move      rf-ffr-bfo-prg       to   srt-prg-dtr            .
      *                  *---------------------------------------------*
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
       stp-srt-inp-ffr-700.
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-ffr-800.
      *                  *---------------------------------------------*
      *                  * Riciclo a record [ffr] successivo           *
      *                  *---------------------------------------------*
           go to     stp-srt-inp-ffr-200.
       stp-srt-inp-ffr-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "DATSYS    "         to   f-key                  .
           move      rr-dat-rif           to   rf-bft-ide-dat         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-bfr-num-prt       to   srt-prt-dsr            .
           move      rf-bfr-num-prg       to   srt-prg-dsr            .
           move      01                   to   srt-tip-dtr            .
           move      rf-bfr-orf-prt       to   srt-prt-dtr            .
           move      rf-bfr-orf-prg       to   srt-prg-dtr            .
      *                  *---------------------------------------------*
      *                  * Rilascio record al sort                     *
      *                  *---------------------------------------------*
           release   srt-rec                                          .
      ...
      *              * Aggiornamento [ida]                             *
      *              *-------------------------------------------------*
           perform   upd-rec-ida-000      thru upd-rec-ida-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-tip-dsr          to   rf-ida-tip-dsr         .
           move      srt-prt-dsr          to   rf-ida-prt-dsr         .
           move      srt-prg-dsr          to   rf-ida-prg-dsr         .
           move      srt-tip-dtr          to   rf-ida-tip-dtr         .
           move      srt-prt-dtr          to   rf-ida-prt-dtr         .
           move      srt-prg-dtr          to   rf-ida-prg-dtr         .
           move      "pgm/ffo/fls/ioc/obj/iofida"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                =    e-not-err
                     go to upd-rec-ida-300.
       upd-rec-ida-200.
      *              *-------------------------------------------------*
      *              * Se record [ida] non esistente                   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Write record [ida] normalizzato             *
      *                  *---------------------------------------------*
           perform   wrt-rec-ida-000      thru wrt-rec-ida-999        .
      *                  *---------------------------------------------*
      *                  * Ripetizione lettura                         *
      *                  *---------------------------------------------*
           go to     upd-rec-ida-100.
       upd-rec-ida-300.
      *              *-------------------------------------------------*
      *              * Se record [ida] esistente                       *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Update record                               *
      *                  *---------------------------------------------*
      ...
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     upd-rec-ida-999.
       upd-rec-ida-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [ida]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-ida-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-ida-000      thru cmp-rec-ida-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      rr-dat-rif           to   rf-ida-ide-dat         .
           move      srt-tip-dsr          to   rf-ida-tip-dsr         .
           move      srt-prt-dsr          to   rf-ida-prt-dsr         .
           move      srt-prg-dsr          to   rf-ida-prg-dsr         .
           move      srt-tip-dtr          to   rf-ida-tip-dtr         .
