      ...
      *    *===========================================================*
      *    * Record logico file [zv1]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/mtv/fls/rec/rfzv1"                          .

      ******************************************************************
       Procedure Division                using f rf-zv1               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-zv1                 .
           move      zero                 to   rf-zv1-cod-cla         .
           move      spaces               to   rf-zv1-des-cla         .
           move      spaces               to   rf-zv1-mne-cla         .
           move      spaces               to   rf-zv1-des-key         .
           move      zero                 to   rf-zv1-sqz-num         .
           move      zero                 to   rf-zv1-ult-sud         .
           move      spaces               to   rf-zv1-umi-def         .
           move      zero                 to   rf-zv1-ult-cod         .
           move      spaces               to   rf-zv1-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-zv1-des-cla       to   fil-des-cla            .
           move      rf-zv1-ult-sud       to   fil-ult-sud            .
           move      rf-zv1-umi-def       to   fil-umi-def            .
           move      rf-zv1-ult-cod       to   fil-ult-cod            .
           move      rf-zv1-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zv1-cod-cla       to   fil-cod-cla            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zv1-des-key       to   fil-des-key            .
           move      rf-zv1-cod-cla       to   fil-cod-cla-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zv1-mne-cla       to   fil-mne-cla            .
           move      rf-zv1-cod-cla       to   fil-cod-cla-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zv1-sqz-num       to   fil-sqz-num            .
           move      rf-zv1-cod-cla       to   fil-cod-cla-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-zv1                 .
           move      fil-cod-cla          to   rf-zv1-cod-cla         .
           move      fil-des-cla          to   rf-zv1-des-cla         .
           move      fil-mne-cla          to   rf-zv1-mne-cla         .
           move      fil-des-key          to   rf-zv1-des-key         .
           move      fil-sqz-num          to   rf-zv1-sqz-num         .
           move      fil-ult-sud          to   rf-zv1-ult-sud         .
           move      fil-umi-def          to   rf-zv1-umi-def         .
           move      fil-ult-cod          to   rf-zv1-ult-cod         .
           move      fil-alx-exp          to   rf-zv1-alx-exp         .
       dec-fis-log-999.
           exit.
