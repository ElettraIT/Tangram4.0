      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmtv1721:        *
      *                    Stampa codici statistici 1 materie varie    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA CODICI STATISTICI 1 MATERIALI V. "       .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella codici statistici 1"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zvs-001-cod      .
           move      14                   to   w-cmn-zvs-001-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zvs-001-ope      .
           move      rr-cod-max           to   w-cmn-zvs-001-cod      .
           move      14                   to   w-cmn-zvs-001-lin      .
           move      52                   to   w-cmn-zvs-001-pos      .
           move      zero                 to   w-cmn-zvs-001-dln      .
           move      zero                 to   w-cmn-zvs-001-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
