      ...
      *                                                                *
      *              Input  : w-cod-mne-zv2-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-mne-zv2-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-mne-zv2-ope : "AC"                 *
      *                                                                *
      *                       w-cod-mne-zv2-cla : codice classe        *
      *                                                                *
      *                       w-cod-mne-zv2-dcl : descr. classe        *
      *                                                                *
      *                       w-cod-mne-zv2-gru : codice gruppo        *
      *                                                                *
      *                       w-cod-mne-zv2-lin : linea codice         *
      *                                                                *
      *                       w-cod-mne-zv2-pos : posizione codice     *
      *                                                                *
      *                       w-cod-mne-zv2-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-mne-zv2-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-mne-zv2-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-mne-zv2-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-mne-zv2-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-mne-zv2-cla : codice classe        *
      ...
      *                       w-cod-mne-zv2-gru : codice gruppo        *
      *                                                                *
      *                       w-cod-mne-zv2-sgr : codice sottogruppo   *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "I+"  Continuazione accettazione dopo esecuzione "Insr"        *
      *                                                                *
      *              Input  : w-cod-mne-zv2-ope : "I+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-mne-zv2-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice gruppo materie varie    *
      *    *-----------------------------------------------------------*
      ...
      ******************************************************************
       Procedure Division                using w-cod-mne-zv2
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-mne-zv2-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-mne-zv2-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-mne-zv2-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-mne-zv2-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-mne-zv2-ope    =    "A+" or
                     w-cod-mne-zv2-ope    =    "I+" or
                     w-cod-mne-zv2-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-mne-zv2-ope      .
       tcm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      w-cod-mne-zv2-gru    to   w-cod-mne-zv2-num      .
           move      v-edm                to   w-cod-mne-zv2-edm      .
           move      v-ufk                to   w-cod-mne-zv2-ufk      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-mne-zv2-edm    to   v-edm                  .
           move      w-cod-mne-zv2-num    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-edt                to   w-cod-mne-zv2-alf      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-mne-zv2-ufk    to   v-ufk                  .
           move      w-cod-mne-zv2-lin    to   v-lin                  .
           move      w-cod-mne-zv2-pos    to   v-pos                  .
           move      w-cod-mne-zv2-alf    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-mne-zv2-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      v-alf                to   w-cod-mne-zv2-alf      .
      *              *-------------------------------------------------*
      *              * Test se Exit o Delt                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-cod-mne-zv2-num    to   w-cod-mne-zv2-gru      .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-num                to   w-cod-mne-zv2-num      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           if        s-ves                not  = spaces
                     move  zero           to   s-num                  .
           move      s-num                to   w-cod-mne-zv2-sgr      .
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-cod-mne-zv2-alf    =    spaces
                     move  zero           to   w-cod-mne-zv2-num
                     go to aco-075.
           if        w-cod-mne-zv2-cha (1)
                                          =    spaces
                     go to aco-025.
      ...
      *              *-------------------------------------------------*
       ...
       aco-181.
           ...
           if        w-cod-mne-zv2-cha
                    ...
                    (w-aux-mne-gru-c01)   >    "9"
                     go to aco-225.
           multiply  10                   by   w-cod-mne-zv2-num      .
           move      w-cod-mne-zv2-cha
                    (w-aux-mne-gru-c01)   to   w-cod-mne-zv2-chn (05) .
           go to     aco-181.
       aco-200.
      *              *-------------------------------------------------*
      ...
      *                  * merico : uscita                             *
      *                  *---------------------------------------------*
           if        v-edt                =    w-cod-mne-zv2-alf
                     go to aco-075
      *                  *---------------------------------------------*
      *                  * Altrimenti : rivisualizzazione              *
      *                  *---------------------------------------------*
           else      move  v-edt          to   w-cod-mne-zv2-alf
                     go to aco-050.
       aco-225.
      *              *-------------------------------------------------*
      ...
      *                  * scrizione                                   *
      *                  *---------------------------------------------*
           if        w-cod-mne-zv2-alf    =    "-" and
                     w-cod-mne-zv2-dln    not  = zero
                     go to aco-500.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-cod-mne-zv2-cla    to   rf-zv2-cod-cla         .
           move      w-cod-mne-zv2-alf    to   rf-zv2-mne-gru         .
      ...
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     go to aco-250.
           if        rf-zv2-cod-cla       not  = w-cod-mne-zv2-cla
                     go to aco-250.
      *                      *-----------------------------------------*
      *                      * Mnemonico letto in area di lavoro di 5  *
      *                      * caratteri                               *
      *                      *-----------------------------------------*
           move      rf-zv2-mne-gru       to   w-aux-mne-gru-m05      .
      *                      *-----------------------------------------*
      *                      * Test se oltre il max                    *
      *                      *-----------------------------------------*
           if        w-aux-mne-gru-m05    not  = w-cod-mne-zv2-alf
                     go to aco-250.
      *                      *-----------------------------------------*
      ...
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      rf-zv2-cod-gru       to   w-aux-mne-gru-cbu
                                              (w-aux-mne-gru-crb)     .
           move      rf-zv2-mne-gru       to   w-aux-mne-gru-mbu
                                              (w-aux-mne-gru-crb)     .
           move      rf-zv2-des-gru       to   w-aux-mne-gru-dbu
                                              (w-aux-mne-gru-crb)     .
      *                      *-----------------------------------------*
      *                      * Riciclo a lettura                       *
      *                      *-----------------------------------------*
      ...
      *                      * non trovato                             *
      *                      *-----------------------------------------*
           if        w-cod-mne-zv2-dln    =    zero
                     go to aco-278.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
           move      w-cod-mne-zv2-dln    to   v-lin                  .
           move      w-cod-mne-zv2-dps    to   v-pos                  .
           move      all   "."            to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-278.
      ...
      *                      *-----------------------------------------*
       ...
       aco-382.
           ...
           move      w-aux-mne-gru-cbu
                    (w-aux-mne-gru-c01)   to   w-cod-mne-zv2-num      .
           go to     aco-200.
       aco-384.
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      05                   to   s-car                  .
           move      w-cod-mne-zv2-alf    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      "PV"                 to   s-ope                  .
           ...
           move      w-cod-mne-zv2-cla    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           go to     aco-125.
       aco-500.
      ...
      *                      *-----------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-cod-mne-zv2-cla    to   rf-zv2-cod-cla         .
           move      w-aux-mne-gru-dup    to   rf-zv2-des-key         .
           move      zero                 to   rf-zv2-cod-gru         .
           move      "pgm/mtv/fls/ioc/obj/iofzv2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                      * Test se oltre il max                    *
      *                      *-----------------------------------------*
           if        rf-zv2-des-key       >    w-aux-mne-gru-rmx
                     go to aco-250.
      *                      *-----------------------------------------*
      *                      * Incremento numero records nel buffer    *
      *                      *-----------------------------------------*
