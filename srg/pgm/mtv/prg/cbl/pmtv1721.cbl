      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma mtv172   *
      *                                                                *
      *                    Stampa codice statistico 1 materie varie    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA CODICE STATISTICO 1 MATERIALI V. "       .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zvs-tip-cls         .
           move      rr-cod-min           to   rf-zvs-cod-cls         .
           move      "pgm/mtv/fls/ioc/obj/iofzvs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zvs-tip-cls         .
           move      rr-des-min           to   rf-zvs-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-tip-cls           to   rf-zvs-tip-cls         .
           move      rr-mne-min           to   rf-zvs-mne-cls         .
           move      zero                 to   rf-zvs-cod-cls         .
           move      "pgm/mtv/fls/ioc/obj/iofzvs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun codice statistico 1 entro i limiti assegnat
      -              "i !"                to   m-msg                  .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zvs]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/mtv/fls/ioc/obj/iofzvs"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-zvs-tip-cls       not  = rr-tip-cls
                     move  "#"            to   w-cnt-prn-flg-sub
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zvs-cod-cls       <    rr-cod-min or
                     rf-zvs-cod-cls       >    rr-cod-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zvs-des-key       <    rr-des-min or
                     rf-zvs-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zvs-mne-cls       <    rr-mne-min or
                     rf-zvs-mne-cls       >    rr-mne-max
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "CODICE STATISTICO 1 MATERIALI VARI"
