      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione tabella codice statistico 1 per    *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " GESTIONE TABELLA 1. CODICE STATISTICO  "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-cls          pic  9(05)                  .
               10  w-tes-cod-cls-aut      pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-mne-cls          pic  x(05)                  .
               10  w-tes-des-key          pic  x(20)                  .
               10  w-tes-des-cls          pic  x(20)                  .
               10  w-tes-alx-exp.
      ...
      *                  * Codice statistico 1                         *
      *                  *---------------------------------------------*
           perform   acc-cod-cls-000      thru acc-cod-cls-999        .
      ...
      *              * Codice statistico 1                             *
      *              *-------------------------------------------------*
           perform   vis-cod-cls-000      thru vis-cod-cls-999        .
       vis-key-reg-999.
           exit.
      ...
      *              * Codice statistico 1                             *
      *              *-------------------------------------------------*
           perform   pmt-cod-cls-000      thru pmt-cod-cls-999        .
      *              *-------------------------------------------------*
      *              * Linea di trattini                               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Codice statistico 1           *
      *    *-----------------------------------------------------------*
       pmt-cod-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Codice statistico 1           *
      *    *-----------------------------------------------------------*
       acc-cod-cls-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cls        to   w-cmn-zvs-001-cod      .
           move      04                   to   w-cmn-zvs-001-lin      .
           move      30                   to   w-cmn-zvs-001-pos      .
           move      07                   to   w-cmn-zvs-001-dln      .
           move      30                   to   w-cmn-zvs-001-dps      .
           move      "<B"                 to   v-edm                  .
       ...
       acc-cod-cls-110.
           ...
           if        w-cmn-zvs-001-ope    =    "F+"
                     go to acc-cod-cls-115.
           if        w-cmn-zvs-001-ope    =    "AC"
                     go to acc-cod-cls-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-cls-115.
           perform   cmn-zvs-001-foi-000  thru cmn-zvs-001-foi-999    .
           go to     acc-cod-cls-110.
       acc-cod-cls-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-cls-999.
       acc-cod-cls-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-cod-cls          .
       acc-cod-cls-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-cod-cls        =    zero
                     go to acc-cod-cls-410
           else      go to acc-cod-cls-450.
       acc-cod-cls-410.
      *                  *---------------------------------------------*
      ...
      *                      * zione                                   *
      *                      *-----------------------------------------*
           move      w-enc-cod-val-pos    to   w-tes-cod-cls          .
      *                      *-----------------------------------------*
      *                      * Segnale di attribuzione codice eseguita *
      *                      * automaticamente                         *
      *                      *-----------------------------------------*
           move      "#"                  to   w-tes-cod-cls-aut      .
      *                      *-----------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Codice statistico 1        *
      *    *-----------------------------------------------------------*
       vis-cod-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Descrizione codice statistico 1             *
      *                  *---------------------------------------------*
           perform   acc-des-cls-000      thru acc-des-cls-999        .
           if        v-key                =    "NXSC"
       ...
       acc-tes-reg-110.
      *                  *---------------------------------------------*
      *                  * Mnemonico codice statistico 1               *
      *                  *---------------------------------------------*
           perform   acc-mne-cls-000      thru acc-mne-cls-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Descrizione codice statistico 1                 *
      *              *-------------------------------------------------*
           perform   vis-des-cls-000      thru vis-des-cls-999        .
      *              *-------------------------------------------------*
      *              * Mnemonico codice statistico 1                   *
      *              *-------------------------------------------------*
           perform   vis-mne-cls-000      thru vis-mne-cls-999        .
           go to     vis-tes-reg-999.
       vis-tes-reg-200.
       vis-tes-reg-999.
           exit.
      ...
      *              * Descrizione codice statistico 1                 *
      *              *-------------------------------------------------*
           perform   pmt-des-cls-000      thru pmt-des-cls-999        .
      *              *-------------------------------------------------*
      *              * Mnemonico codice statistico 1                   *
      *              *-------------------------------------------------*
           perform   pmt-mne-cls-000      thru pmt-mne-cls-999        .
           go to     pmt-tes-reg-999.
       pmt-tes-reg-200.
       pmt-tes-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Descrizione codice statistico 1  *
      *    *-----------------------------------------------------------*
       pmt-des-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Mnemonico codice statistico 1    *
      *    *-----------------------------------------------------------*
       pmt-mne-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Descriz. cod. statistico 1   *
      *    *-----------------------------------------------------------*
       acc-des-cls-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-cls (1)    not  = spaces
                     go to acc-des-cls-450.
           if        v-key                =    "UP  "
                     go to acc-des-cls-600
           else      go to acc-des-cls-100.
       acc-des-cls-450.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-des-cls (1)    to   w-all-str-alf          .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Descr. cod. statistico 1  *
      *    *-----------------------------------------------------------*
       vis-des-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Mnemonico cod. statistico 1  *
      *    *-----------------------------------------------------------*
       acc-mne-cls-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Mnemon. cod. statistico 1 *
      *    *-----------------------------------------------------------*
       vis-mne-cls-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "Manca la descrizione per il codice statistico     
      -              "      "             to   w-err-box-err-msg      .
      ...
      *    *-----------------------------------------------------------*
       nor-key-reg-000.
           move      zero                 to   w-tes-cod-cls          .
           move      spaces               to   w-tes-cod-cls-aut      .
       nor-key-reg-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-mne-cls (1)      .
           move      spaces               to   w-tes-des-key (1)      .
           move      spaces               to   w-tes-des-cls (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cls        to   rf-zvs-cod-cls         .
           move      "pgm/mtv/fls/ioc/obj/iofzvs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-zvs-mne-cls       to   w-tes-mne-cls (1)      .
           move      rf-zvs-des-key       to   w-tes-des-key (1)      .
           move      rf-zvs-des-cls       to   w-tes-des-cls (1)      .
           move      rf-zvs-alx-exp       to   w-tes-alx-exp (1)      .
      *                      *-----------------------------------------*
      ...
      *                      * Write record [zvs]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zvs-000      thru wrt-rec-zvs-999        .
      ...
      *                      * Rewrite record [zvs]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zvs-000      thru rew-rec-zvs-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [zvs]                             *
      *              *-------------------------------------------------*
           perform   del-rec-zvs-000      thru del-rec-zvs-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [zvs]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-zvs-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-mne-cls (1)    to   rf-zvs-mne-cls         .
           move      w-tes-des-key (1)    to   rf-zvs-des-key         .
           move      w-tes-des-cls (1)    to   rf-zvs-des-cls         .
           move      w-tes-alx-exp (1)    to   rf-zvs-alx-exp         .
       cmp-rec-zvs-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zvs]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zvs-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zvs-000      thru cmp-rec-zvs-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       att-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zvs] parte 01    *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zvs1"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           ...
           move      "CODCLS    "         to   f-key                  .
           move      01                   to   rf-zvs-tip-cls         .
           move      w-enc-cod-val-pos    to   rf-zvs-cod-cls         .
           move      "pgm/mtv/fls/ioc/obj/iofzvs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *-----------------------------------------------------------*
       rip-cod-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zvs]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zvs1"               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
