      ...
      *                    di ordinamento e selezione per file [mtv]   *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : f-ope  : "TO"                            *
      *                       f-key  : codice del filtro [mtv]         *
      *                                                                *
      *                                                                *
      *              Output : f-sts  : "01" : Per classe, gruppo, sot- *
      *                                       togruppo, codice mate-   *
      *                                       riale vario              *
      *                                "02" : Per classe, gruppo, sot- *
      *                                       togruppo, descr. mate-   *
      *                                       riale vario              *
      *                                "03" : Per codice materiale v.  *
      *                                "04" : Per descrizione mat. v.  *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *    *===========================================================*
      *    * Work file per uscita da sort di [mtv]                     *
      *    *-----------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
      *            * Codice materia varia alfanumerico min-max         *
      *            *---------------------------------------------------*
               10  w-let-flt-alf-min      pic  x(14)                  .
               10  w-let-flt-alf-max      pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Descrizione materia varia, uppercase, min-max     *
      *            *---------------------------------------------------*
      ...
      *            * Tipo materia varia                                *
      *            *---------------------------------------------------*
               10  w-let-flt-tip-mtv      pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Unita' di misura materia varia                    *
      *            *---------------------------------------------------*
               10  w-let-flt-umi-gst      pic  x(03)                  .
      *            *---------------------------------------------------*
      *            * Codice statistico 1 materia varia                 *
      *            *---------------------------------------------------*
               10  w-let-flt-cod-s01      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice statistico 2 materia varia                 *
      *            *---------------------------------------------------*
               10  w-let-flt-cod-s02      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Codice statistico 3 materia varia                 *
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   let-cod-flt-000      thru let-cod-flt-999        .
      *              *-------------------------------------------------*
      *              * Ordinamento e selezione [mtv] su filtro         *
      *              *-------------------------------------------------*
      ...
      *    * dell'area libera per il filtro 'mtv'                      *
      *    *-----------------------------------------------------------*
       nor-zos-mtv-000.
      *              *-------------------------------------------------*
      ...
      *              *                        gruppo, codice m.v.      *
      *              *-------------------------------------------------*
           move      01                   to   w-zos-mtv-tip-ord      .
      *              *-------------------------------------------------*
      *              * Classe merceologica min-max                     *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-mtv-cla-min      .
           move      99999                to   w-zos-mtv-cla-max      .
      *              *-------------------------------------------------*
      *              * Gruppo merceologico min-max                     *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-mtv-gru-min      .
           move      99999                to   w-zos-mtv-gru-max      .
      *              *-------------------------------------------------*
      *              * Sottogruppo merceologico min-max                *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-mtv-sgr-min      .
           move      99999                to   w-zos-mtv-sgr-max      .
      *              *-------------------------------------------------*
      *              * Codice materia varia alfanumerico min e max     *
      *              *-------------------------------------------------*
           move      spaces               to   w-zos-mtv-alf-min      .
           move      all   "z"            to   w-zos-mtv-alf-max      .
      *              *-------------------------------------------------*
      *              * Descrizione materia varia uppercase min-max     *
      *              *-------------------------------------------------*
           move      spaces               to   w-zos-mtv-des-min      .
           move      all   "z"            to   w-zos-mtv-des-max      .
      *              *-------------------------------------------------*
      *              * Tipo materia varia                              *
      *              *-------------------------------------------------*
      ...
      *              * Codice statistico 1 materia varia               *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-mtv-cod-s01      .
      *              *-------------------------------------------------*
      *              * Codice statistico 2 materia varia               *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-mtv-cod-s02      .
      *              *-------------------------------------------------*
      *              * Codice statistico 3 materia varia               *
      *              *-------------------------------------------------*
           move      00000                to   w-zos-mtv-cod-s03      .
       nor-zos-mtv-999.
           exit.
      ...
      *                      * 'mtv'                                   *
      *                      *-----------------------------------------*
           perform   nor-zos-mtv-000      thru nor-zos-mtv-999        .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-zos-mtv-tip-ord    <    01 or
                     w-zos-mtv-tip-ord    >    04
                     go to let-cod-flt-150.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-zos-mtv-tip-ord    to   w-let-flt-tip-ord      .
       let-cod-flt-350.
      *                  *---------------------------------------------*
      ...
      *                          * Codice classe min                   *
      *                          *-------------------------------------*
           move      w-zos-mtv-cla-min    to   w-let-flt-cla-min      .
      *                          *-------------------------------------*
      *                          * Codice classe max                   *
      *                          *-------------------------------------*
           move      w-zos-mtv-cla-max    to   w-let-flt-cla-max      .
      *                          *-------------------------------------*
      ...
      *                          * Codice gruppo min                   *
      *                          *-------------------------------------*
           move      w-zos-mtv-gru-min    to   w-let-flt-gru-min      .
      *                          *-------------------------------------*
      *                          * Codice gruppo max                   *
      *                          *-------------------------------------*
           move      w-zos-mtv-gru-max    to   w-let-flt-gru-max      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-zos-mtv-sgr-min    to   w-let-flt-sgr-min      .
      *                          *-------------------------------------*
      *                          * Codice sottogruppo max              *
      *                          *-------------------------------------*
           move      w-zos-mtv-sgr-max    to   w-let-flt-sgr-max      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      w-let-flt-cla-min    to   rf-zv1-cod-cla         .
           move      "pgm/mtv/fls/ioc/obj/iofzv1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-zv1                 .
           if        f-sts                not  = e-not-err
                     move  zero           to   rf-zv1-sqz-num         .
           move      rf-zv1-sqz-num       to   w-let-flt-nsc-min      .
           move      rf-zv1-sqz-num       to   w-let-flt-nsc-max      .
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      w-let-flt-cla-min    to   rf-zv2-cod-cla         .
           move      w-let-flt-gru-min    to   rf-zv2-cod-gru         .
           move      "pgm/mtv/fls/ioc/obj/iofzv2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat               using f
                                               rf-zv2                 .
           if        f-sts                not  = e-not-err
                     move  zero           to   rf-zv2-sqz-num         .
           move      rf-zv2-sqz-num       to   w-let-flt-nsg-min      .
           move      rf-zv2-sqz-num       to   w-let-flt-nsg-max      .
      *                              *---------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      w-let-flt-cla-min    to   rf-zv3-cod-cla         .
           move      w-let-flt-gru-min    to   rf-zv3-cod-gru         .
           move      w-let-flt-sgr-min    to   rf-zv3-cod-sgr         .
           move      "pgm/mtv/fls/ioc/obj/iofzv3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           ...
           move      rf-zv3-sqz-num       to   w-let-flt-nss-min      .
           move      rf-zv3-sqz-num       to   w-let-flt-nss-max      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      w-let-flt-cla-min    to   rf-zv3-cod-cla         .
           move      w-let-flt-gru-min    to   rf-zv3-cod-gru         .
           move      w-let-flt-sgr-max    to   rf-zv3-cod-sgr         .
           move      "pgm/mtv/fls/ioc/obj/iofzv3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                              *---------------------------------*
           ...
           move      "CODGRU    "         to   f-key                  .
           move      w-let-flt-cla-min    to   rf-zv2-cod-cla         .
           move      w-let-flt-gru-max    to   rf-zv2-cod-gru         .
           move      "pgm/mtv/fls/ioc/obj/iofzv2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
           ...
           move      "RK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      w-let-flt-cla-max    to   rf-zv1-cod-cla         .
           move      "pgm/mtv/fls/ioc/obj/iofzv1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
       ...
       let-cod-flt-500.
      *                  *---------------------------------------------*
      *                  * Codice m.v. min : semplice spostamento      *
      *                  *---------------------------------------------*
           move      w-zos-mtv-alf-min    to   w-let-flt-alf-min      .
       let-cod-flt-510.
      *                  *---------------------------------------------*
      *                  * Codice m.v. max : semplice spostamento      *
      *                  *---------------------------------------------*
           move      w-zos-mtv-alf-max    to   w-let-flt-alf-max      .
       let-cod-flt-520.
      *                  *---------------------------------------------*
      *                  * Codice m.v. min-max                         *
      *                  *---------------------------------------------*
       ...
       let-cod-flt-530.
      *                  *---------------------------------------------*
      *                  * Descrizione m.v. min : semplice spostamento *
      *                  *---------------------------------------------*
           move      w-zos-mtv-des-min    to   w-let-flt-des-min      .
       let-cod-flt-540.
      *                  *---------------------------------------------*
      *                  * Descrizione m.v. max : semplice spostamento *
      *                  *---------------------------------------------*
           move      w-zos-mtv-des-max    to   w-let-flt-des-max      .
       let-cod-flt-550.
      *                  *---------------------------------------------*
      *                  * Descrizione materia varia min-max           *
      *                  *---------------------------------------------*
       ...
       let-cod-flt-560.
      *                  *---------------------------------------------*
      *                  * Tipo materia varia : semplice spostamento   *
      *                  *---------------------------------------------*
           move      w-zos-mtv-tip-mtv    to   w-let-flt-tip-mtv      .
       let-cod-flt-590.
      *                  *---------------------------------------------*
      *                  * Unita' di misura m.v. : semplice spostamen- *
      *                  * to                                          *
      *                  *---------------------------------------------*
           move      w-zos-mtv-umi-gst    to   w-let-flt-umi-gst      .
       let-cod-flt-600.
      *                  *---------------------------------------------*
      *                  * Codice statistico 1 m.v. : semplice sposta- *
      *                  * mento                                       *
      *                  *---------------------------------------------*
           move      w-zos-mtv-cod-s01    to   w-let-flt-cod-s01      .
       let-cod-flt-610.
      *                  *---------------------------------------------*
      *                  * Codice statistico 2 m.v. : semplice sposta- *
      *                  * mento                                       *
      *                  *---------------------------------------------*
           move      w-zos-mtv-cod-s02    to   w-let-flt-cod-s02      .
       let-cod-flt-620.
      *                  *---------------------------------------------*
      *                  * Codice statistico 3 m.v. : semplice sposta- *
      *                  * mento                                       *
      *                  *---------------------------------------------*
           move      w-zos-mtv-cod-s03    to   w-let-flt-cod-s03      .
       let-cod-flt-630.
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       let-cod-flt-740.
      *                  *---------------------------------------------*
      *                  * Se tipo di codice anagrafico : [mtv]        *
      *                  *---------------------------------------------*
       let-cod-flt-742.
      *                      *-----------------------------------------*
      *                      * Lettura codice materiale vario          *
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMMTV    "         to   f-key                  .
           move      w-let-flt-cod-cco    to   rf-mtv-num-mtv of
                                               rf-mtv                 .
           move      "pgm/mtv/fls/ioc/obj/iofmtv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
           ...
           call      s-pat               using f
                                               rf-mtv                 .
           if        f-sts                not  = e-not-err
                     move  spaces         to   rf-mtv-alf-mtv of
                                               rf-mtv                 .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      99999                to   w-zos-mtv-sgr-max      .
      *                      *-----------------------------------------*
      *                      * Codice materia varia alfanumerico min   *
      *                      * e max                                   *
      *                      *-----------------------------------------*
           move      rf-mtv-alf-mtv of
                     rf-mtv               to   w-zos-mtv-alf-min      .
           move      rf-mtv-alf-mtv of
                     rf-mtv               to   w-zos-mtv-alf-max      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       let-cod-flt-760.
      *                  *---------------------------------------------*
      *                  * Se tipo di codice anagrafico : [zv1]        *
      *                  *---------------------------------------------*
       let-cod-flt-762.
      *                      *-----------------------------------------*
      *                      * Lettura codice [zv1]                    *
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      w-let-flt-cod-cco    to   rf-zv1-cod-cla         .
           move      "pgm/mtv/fls/ioc/obj/iofzv1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Classe merceologica min e max           *
      *                      *-----------------------------------------*
           move      rf-zv1-cod-cla       to   w-zos-mtv-cla-min      .
           move      rf-zv1-cod-cla       to   w-zos-mtv-cla-max      .
      *                      *-----------------------------------------*
      *                      * Gruppo merceologico min e max           *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-mtv-gru-min      .
      ...
      *                      *-----------------------------------------*
           ...
           move      99999                to   w-zos-mtv-sgr-max      .
      *                      *-----------------------------------------*
      *                      * Codice materiale vario alfanumerico min *
      *                      * e max                                   *
      *                      *-----------------------------------------*
           move      spaces               to   w-zos-mtv-alf-min      .
           move      all   "Z"            to   w-zos-mtv-alf-max      .
      ...
      *                      *-----------------------------------------*
           move      spaces               to   w-zos-mtv-umi-gst      .
      *                      *-----------------------------------------*
      *                      * Codice statistico 1 materiale vario     *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-mtv-cod-s01      .
      *                      *-----------------------------------------*
      *                      * Codice statistico 2 materiale vario     *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-mtv-cod-s02      .
      *                      *-----------------------------------------*
      *                      * Codice statistico 3 materiale vario     *
      *                      *-----------------------------------------*
           move      zero                 to   w-zos-mtv-cod-s03      .
       let-cod-flt-766.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-let-flt-alf-max    <    w-let-flt-alf-min
                     go to ord-sel-flt-999.
      *                  *---------------------------------------------*
      *                  * Test su descrizione della materia varia     *
      *                  * min-max                                     *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ord-sel-flt-055.
      *                  *---------------------------------------------*
      *                  * Se il codice alfanumerico della m.v. min    *
      *                  * e' diverso dal codice alfanumerico dela     *
      *                  * m.v. max non si puo' avere questa certezza  *
      ...
      *                  *---------------------------------------------*
      *                  * Se il codice alfanumerico della m.v. min e' *
      *                  * a spaces ed anche il codice alfanumerico    *
      *                  * della m.v. max e' a spaces non si puo' a-   *
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Start per codice alfanumerico su [mtv]  *
      *                      *-----------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "ALFMTV    "         to   f-key                  .
           move      w-let-flt-alf-min    to   rf-mtv-alf-mtv of
                                               rf-mtv                 .
           move      zero                 to   rf-mtv-num-mtv of
                                               rf-mtv                 .
           move      "pgm/mtv/fls/ioc/obj/iofmtv"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
       ...
       ord-sel-flt-530.
      *              *-------------------------------------------------*
      *              * Se tipo ordinamento : 03 : Codice m.v.          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Esecuzione                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       ord-sel-flt-540.
      *              *-------------------------------------------------*
      *              * Se tipo ordinamento : 04 : Descrizione m.v.     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Esecuzione                                  *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Ordinamento e selezione [mtv]     Tipo ordinamento  01    *
      *    *                                                           *
      *    * Classe, gruppo, sottogruppo, codice materia varia         *
      *    *-----------------------------------------------------------*
       ord-sel-001-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       ord-sel-001-100.
      *              *-------------------------------------------------*
      *              * Start su [zv1] per numero di sequenza           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      w-let-flt-nsc-min    to   rf-zv1-sqz-num         .
      ...
      *              *-------------------------------------------------*
           if        rf-zv1-sqz-num       >    w-let-flt-nsc-max
                     go to ord-sel-001-900.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-zv3                 .
      *                  *---------------------------------------------*
      *                  * A trattamento materia varia                 *
      *                  *---------------------------------------------*
           go to     ord-sel-001-275.
       ord-sel-001-150.
      *              *-------------------------------------------------*
      *              * Start su [zv2] per numero di sequenza           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      rf-zv1-cod-cla       to   rf-zv2-cod-cla         .
           move      w-let-flt-nsg-min    to   rf-zv2-sqz-num         .
      ...
      *              *-------------------------------------------------*
           if        rf-zv2-cod-cla       not  = rf-zv1-cod-cla
                     go to ord-sel-001-125.
           if        rf-zv2-sqz-num       >    w-let-flt-nsg-max
                     go to ord-sel-001-125.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       ord-sel-001-200.
      *              *-------------------------------------------------*
      *              * Start su [zv3] per numero di sequenza           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      rf-zv1-cod-cla       to   rf-zv3-cod-cla         .
           move      rf-zv2-cod-gru       to   rf-zv3-cod-gru         .
           move      w-let-flt-nss-min    to   rf-zv3-sqz-num         .
      ...
      *              *-------------------------------------------------*
           if        rf-zv3-cod-cla       not  = rf-zv1-cod-cla
                     go to ord-sel-001-175.
           if        rf-zv3-cod-gru       not  = rf-zv2-cod-gru
                     go to ord-sel-001-175.
           if        rf-zv3-sqz-num       >    w-let-flt-nss-max
                     go to ord-sel-001-175.
      *              *-------------------------------------------------*
      *              * A trattamento materia varia                     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rf-zv1-ult-sud       not  = 02
                     go to ord-sel-001-125
           else if   rf-zv2-ult-sud       not  = 02
                     go to ord-sel-001-175
           else      go to ord-sel-001-225.
       ord-sel-001-275.
      *              *-------------------------------------------------*
      *              * Start su [mtv] per Classe, gruppo, sottogruppo  *
      *              *                  e codice materia varia         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "CGSALF    "         to   f-key                  .
           move      rf-zv1-cod-cla       to   rf-mtv-cla-mtv of
                                               rf-mtv                 .
           if        rf-zv1-ult-sud       not  = 02
                     move  zero           to   rf-mtv-gru-mtv of
                                               rf-mtv
                     move  zero           to   rf-mtv-sgr-mtv of
                                               rf-mtv
                     go to ord-sel-001-280.
           move      rf-zv2-cod-gru       to   rf-mtv-gru-mtv of
                                               rf-mtv                 .
           if        rf-zv2-ult-sud       not  = 02
                     move  zero           to   rf-mtv-sgr-mtv of
                                               rf-mtv
                     go to ord-sel-001-280.
           move      rf-zv3-cod-sgr       to   rf-mtv-sgr-mtv of
                                               rf-mtv                 .
       ord-sel-001-280.
           move      w-let-flt-alf-min    to   rf-mtv-alf-mtv of
                                               rf-mtv                 .
      ...
      *              *-------------------------------------------------*
           if        rf-mtv-cla-mtv of
                     rf-mtv               not  = rf-zv1-cod-cla
                     go to ord-sel-001-250.
           if        rf-zv1-ult-sud       not  = 02
                     go to ord-sel-001-327.
           if        rf-mtv-gru-mtv of
                     rf-mtv               not  = rf-zv2-cod-gru
                     go to ord-sel-001-250.
           if        rf-zv2-ult-sud       not  =  02
                     go to ord-sel-001-327.
           if        rf-mtv-sgr-mtv of
                     rf-mtv               not  = rf-zv3-cod-sgr
                     go to ord-sel-001-250.
       ord-sel-001-327.
           if        rf-mtv-alf-mtv of
                     rf-mtv               >    w-let-flt-alf-max
                     go to ord-sel-001-250.
       ord-sel-001-400.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Ordinamento e selezione [mtv]     Tipo ordinamento  02    *
      *    *                                                           *
      *    * Classe, gruppo, sottogruppo, descrizione materia varia    *
      *    *-----------------------------------------------------------*
       ord-sel-002-000.
      *              *-------------------------------------------------*
      *              * Open output file [ttt]                          *
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-zv3-cod-sgr       to   rf-mtv-sgr-mtv of
                                               rf-mtv                 .
       ord-sel-002-280.
           move      w-let-flt-des-min    to   rf-mtv-des-key of
                                               rf-mtv                 .
           move      zero                 to   rf-mtv-num-mtv of
                                               rf-mtv                 .
           move      "pgm/mtv/fls/ioc/obj/iofmtv"
      ...
      *              *-------------------------------------------------*
           ...
           if        rf-mtv-sgr-mtv of
                     ...
                     go to ord-sel-002-250.
       ord-sel-002-327.
           if        rf-mtv-des-key of
                     rf-mtv               >    w-let-flt-des-max
                     go to ord-sel-002-250.
       ord-sel-002-400.
      *              *-------------------------------------------------*
      *              * Selezione, mediante il filtro, del record let-  *
      ...
      *    *===========================================================*
      *    * Ordinamento e selezione [mtv]     Tipo ordinamento  03    *
      *    *                                                           *
      ...
      *              *-------------------------------------------------*
       ...
       ord-sel-003-100.
      *              *-------------------------------------------------*
      *              * Start su [mtv] per codice alfanumerico          *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
           move      "ALFMTV    "         to   f-key                  .
      ...
      *    *===========================================================*
      *    * Ordinamento e selezione [mtv]     Tipo ordinamento  04    *
      *    *                                                           *
      ...
      *              *-------------------------------------------------*
       ...
       ord-sel-004-100.
      *              *-------------------------------------------------*
      *              * Start su [mtv] per descrizione in uppercase     *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "GT"                 to   f-cfr                  .
      ...
      *    *===========================================================*
      *    * Selezione, mediante il filtro, del record in 'rf-mtv'     *
      *    *-----------------------------------------------------------*
       sel-rec-flt-000.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      rf-mtv-cla-mtv of
                     rf-mtv               to   rf-zv1-cod-cla         .
           move      "pgm/mtv/fls/ioc/obj/iofzv1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           if        rf-zv1-sqz-num       <    w-let-flt-nsc-min or
                     rf-zv1-sqz-num       >    w-let-flt-nsc-max
      ...
      *                      *-----------------------------------------*
           ...
           move      "CODGRU    "         to   f-key                  .
           move      rf-mtv-cla-mtv of
                     rf-mtv               to   rf-zv2-cod-cla         .
           move      rf-mtv-gru-mtv of
                     rf-mtv               to   rf-zv2-cod-gru         .
           move      "pgm/mtv/fls/ioc/obj/iofzv2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * selezione si considera fallita          *
      *                      *-----------------------------------------*
           if        rf-zv2-sqz-num       <    w-let-flt-nsg-min or
                     rf-zv2-sqz-num       >    w-let-flt-nsg-max
                     go to sel-rec-flt-900.
       sel-rec-flt-075.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "CODSGR    "         to   f-key                  .
           move      rf-mtv-cla-mtv of
                     rf-mtv               to   rf-zv3-cod-cla         .
           move      rf-mtv-gru-mtv of
                     rf-mtv               to   rf-zv3-cod-gru         .
           move      rf-mtv-sgr-mtv of
                     rf-mtv               to   rf-zv3-cod-sgr         .
           move      "pgm/mtv/fls/ioc/obj/iofzv3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * lita                                    *
      *                      *-----------------------------------------*
           if        rf-zv3-sqz-num       <    w-let-flt-nss-min or
                     rf-zv3-sqz-num       >    w-let-flt-nss-max
                     go to sel-rec-flt-900.
       sel-rec-flt-150.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-mtv-des-key of
                     rf-mtv               <    w-let-flt-des-min or
                     rf-mtv-des-key of
                     rf-mtv               >    w-let-flt-des-max
                     go to sel-rec-flt-900.
       sel-rec-flt-250.
      *              *-------------------------------------------------*
      *              * Selezione su tipo materia varia                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se tipo m.v. a zero : no selezione          *
      *                  *---------------------------------------------*
           if        w-let-flt-tip-mtv    =    zero
                     go to sel-rec-flt-300.
      *                  *---------------------------------------------*
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-mtv-tip-mtv of
                     rf-mtv               not  = w-let-flt-tip-mtv
                     go to sel-rec-flt-900.
       sel-rec-flt-300.
      *              *-------------------------------------------------*
      *              * Selezione su unita' di misura materia varia     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se unita' di misura a Spaces : no selezione *
      *                  *---------------------------------------------*
           if        w-let-flt-umi-gst    =    spaces
                     go to sel-rec-flt-450.
      *                  *---------------------------------------------*
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-mtv-umi-gst of
                     rf-mtv               not  = w-let-flt-umi-gst
                     go to sel-rec-flt-900.
       sel-rec-flt-450.
      *              *-------------------------------------------------*
      *              * Selezione su codice statistico 1 materia varia  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-mtv-cod-s01 of
                     rf-mtv               not  = w-let-flt-cod-s01
                     go to sel-rec-flt-900.
       sel-rec-flt-500.
      *              *-------------------------------------------------*
      *              * Selezione su codice statistico 2 materia varia  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-mtv-cod-s02 of
                     rf-mtv               not  = w-let-flt-cod-s02
                     go to sel-rec-flt-900.
       sel-rec-flt-550.
      *              *-------------------------------------------------*
      *              * Selezione su codice statistico 3 materia varia  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-mtv-cod-s03 of
                     rf-mtv               not  = w-let-flt-cod-s03
                     go to sel-rec-flt-900.
       sel-rec-flt-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-mtv-cla-mtv of
                     rf-mtv               <    w-let-flt-cla-min or
                     rf-mtv-cla-mtv of
                     rf-mtv               >    w-let-flt-cla-max
      ...
      *                  *---------------------------------------------*
           if        rf-mtv-gru-mtv of
                     rf-mtv               <    w-let-flt-gru-min or
                     rf-mtv-gru-mtv of
                     rf-mtv               >    w-let-flt-gru-max
                     go to sel-rec-sel-900.
       sel-rec-sel-100.
      *                  *---------------------------------------------*
      *                  * Selezione su sottogruppo                    *
      *                  *---------------------------------------------*
           if        rf-mtv-sgr-mtv of
                     rf-mtv               <    w-let-flt-sgr-min or
                     rf-mtv-sgr-mtv of
                     rf-mtv               >    w-let-flt-sgr-max
                     go to sel-rec-sel-900.
       sel-rec-sel-150.
      *              *-------------------------------------------------*
      *              * Selezione su codice alfanumerico min-max        *
      ...
      *                      *-----------------------------------------*
           if        rf-mtv-num-mtv of
                     rf-mtv               =    w-let-flt-cod-cco
                     go to sel-rec-sel-800
