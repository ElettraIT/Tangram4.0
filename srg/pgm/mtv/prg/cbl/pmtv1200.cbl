      ...
      *                     - Gruppi                                   *
      *                     - Sottogruppi                              *
      *                    per classificazioni gerarchiche materie     *
      *                                                      varie     *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-err.
      *        *-------------------------------------------------------*
      *        * Work per Err su controlli in impostazioni             *
      *        *-------------------------------------------------------*
           05  w-err-cnt-acc.
               10  w-err-cnt-acc-msg      pic  x(56)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-enc-cod.
      *        *-------------------------------------------------------*
      *        * Per codice classe materia varia                       *
      *        *-------------------------------------------------------*
           05  w-enc-cod-cla.
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
      *        * Per codice gruppo materia varia                       *
      *        *-------------------------------------------------------*
           05  w-enc-cod-gru.
      *            *---------------------------------------------------*
      *            * Codice classe                                     *
      ...
      *        *-------------------------------------------------------*
      *        * Per codice sottogruppo materia varia                  *
      *        *-------------------------------------------------------*
           05  w-enc-cod-sgr.
      *            *---------------------------------------------------*
      *            * Codice classe                                     *
      ...
      *                          *-------------------------------------*
           move      w-tes-cod-cla        to   w-let-arc-zv1-cla      .
      ...
      *                          *-------------------------------------*
           move      w-let-arc-zv1-mne    to   w-tes-cod-cla-mne      .
           move      w-let-arc-zv1-des    to   w-tes-cod-cla-des      .
           move      w-let-arc-zv1-sud    to   w-tes-cod-cla-sud      .
           move      w-let-arc-zv1-umi    to   w-tes-cod-cla-umi      .
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cla        to   w-cod-mne-zv1-cla      .
           move      zero                 to   w-cod-mne-zv1-gru      .
           move      zero                 to   w-cod-mne-zv1-sgr      .
           move      05                   to   w-cod-mne-zv1-lin      .
           move      30                   to   w-cod-mne-zv1-pos      .
           if        w-tes-tip-ele        =    01
                     move  09             to   w-cod-mne-zv1-dln
                     move  30             to   w-cod-mne-zv1-dps
           else      move  05             to   w-cod-mne-zv1-dln
                     move  39             to   w-cod-mne-zv1-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
      ...
      *                                  *-----------------------------*
      ...
      -              "      "             to   w-err-cnt-acc-msg      .
           perform   err-cnt-acc-000      thru err-cnt-acc-999        .
      *                                  *-----------------------------*
      *                                  * A reimpostazione            *
      *                                  *-----------------------------*
           go to     acc-cod-cla-100.
      ...
      *                          *-------------------------------------*
           move      w-tes-cod-cla        to   w-let-arc-zv2-cla      .
           move      w-tes-cod-gru        to   w-let-arc-zv2-gru      .
      ...
      *                          * - Unita' di misura da proporre      *
      *                          *-------------------------------------*
           move      w-let-arc-zv2-mne    to   w-tes-cod-gru-mne      .
           move      w-let-arc-zv2-des    to   w-tes-cod-gru-des      .
           move      w-let-arc-zv2-sud    to   w-tes-cod-gru-sud      .
           move      w-let-arc-zv2-umi    to   w-tes-cod-gru-umi      .
      *                          *-------------------------------------*
      *                          * Visualizzazione codice              *
      *                          *-------------------------------------*
           perform   vis-cod-gru-000      thru vis-cod-gru-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cla        to   w-cod-mne-zv2-cla      .
           move      w-tes-cod-cla-des    to   w-cod-mne-zv2-dcl      .
           move      w-tes-cod-gru        to   w-cod-mne-zv2-gru      .
           move      zero                 to   w-cod-mne-zv2-sgr      .
           move      06                   to   w-cod-mne-zv2-lin      .
           move      30                   to   w-cod-mne-zv2-pos      .
           if        w-tes-tip-ele        =    02
                     move  09             to   w-cod-mne-zv2-dln
                     move  30             to   w-cod-mne-zv2-dps
           else      move  06             to   w-cod-mne-zv2-dln
                     move  39             to   w-cod-mne-zv2-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *                          *-------------------------------------*
           move      w-tes-cod-cla        to   w-let-arc-zv3-cla      .
           move      w-tes-cod-gru        to   w-let-arc-zv3-gru      .
           move      w-tes-cod-sgr        to   w-let-arc-zv3-sgr      .
      ...
      *                          * - Unita' di misura da proporre      *
      *                          *-------------------------------------*
           move      w-let-arc-zv3-mne    to   w-tes-cod-sgr-mne      .
           move      w-let-arc-zv3-des    to   w-tes-cod-sgr-des      .
           move      w-let-arc-zv3-sud    to   w-tes-cod-sgr-sud      .
           move      w-let-arc-zv3-umi    to   w-tes-cod-sgr-umi      .
      *                          *-------------------------------------*
      *                          * Visualizzazione codice              *
      *                          *-------------------------------------*
           perform   vis-cod-sgr-000      thru vis-cod-sgr-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-cla        to   w-cod-mne-zv3-cla      .
           move      w-tes-cod-cla-des    to   w-cod-mne-zv3-dcl      .
           move      w-tes-cod-gru        to   w-cod-mne-zv3-gru      .
           move      w-tes-cod-gru-des    to   w-cod-mne-zv3-dgr      .
           move      w-tes-cod-sgr        to   w-cod-mne-zv3-sgr      .
           move      07                   to   w-cod-mne-zv3-lin      .
           move      30                   to   w-cod-mne-zv3-pos      .
           move      09                   to   w-cod-mne-zv3-dln      .
           move      30                   to   w-cod-mne-zv3-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "FIND"               to   v-pfk (03)             .
      ...
      *                      *-----------------------------------------*
           ...
           move      17                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Unita' di misura da proporre per i materiali   :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "           vari appartenenti a questa classe    "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "           vari appartenenti a questo gruppo    "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "      vari appartenenti a questo sottogruppo    "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                      *-----------------------------------------*
      ...
      *                  * Test che il valore sia accettabile          *
      *                  *---------------------------------------------*
           if        w-tes-ult-sud (1)    >    w-exp-tip-ele-num
                     go to acc-tip-ele-100.
       acc-ult-sud-450.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-cla        to   rf-zv1-cod-cla         .
           move      "pgm/mtv/fls/ioc/obj/iofzv1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Valori diretti                      *
      *                          *-------------------------------------*
           move      rf-zv1-des-cla       to   w-tes-des-cgs (1)      .
           move      rf-zv1-des-key       to   w-tes-des-key (1)      .
           move      rf-zv1-mne-cla       to   w-tes-mne-cgs (1)      .
           move      rf-zv1-sqz-num       to   w-tes-sqz-num (1)      .
           move      rf-zv1-ult-sud       to   w-tes-ult-sud (1)      .
           move      rf-zv1-umi-def       to   w-tes-umi-def (1)      .
           move      rf-zv1-ult-cod       to   w-tes-ult-cod (1)      .
           move      rf-zv1-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      *                          * Valori indiretti                    *
      *                          *-------------------------------------*
           move      w-tes-umi-def (1)    to   w-let-arc-zum-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-cla        to   rf-zv2-cod-cla         .
           move      w-tes-cod-gru        to   rf-zv2-cod-gru         .
           move      "pgm/mtv/fls/ioc/obj/iofzv2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Valori diretti                      *
      *                          *-------------------------------------*
           move      rf-zv2-des-gru       to   w-tes-des-cgs (1)      .
           move      rf-zv2-des-key       to   w-tes-des-key (1)      .
           move      rf-zv2-mne-gru       to   w-tes-mne-cgs (1)      .
           move      rf-zv2-sqz-num       to   w-tes-sqz-num (1)      .
           move      rf-zv2-ult-sud       to   w-tes-ult-sud (1)      .
           move      rf-zv2-umi-def       to   w-tes-umi-def (1)      .
           move      rf-zv2-ult-cod       to   w-tes-ult-cod (1)      .
           move      rf-zv2-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      *                          * Valori indiretti                    *
      *                          *-------------------------------------*
           move      w-tes-umi-def (1)    to   w-let-arc-zum-cod      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-cod-cla        to   rf-zv3-cod-cla         .
           move      w-tes-cod-gru        to   rf-zv3-cod-gru         .
           move      w-tes-cod-sgr        to   rf-zv3-cod-sgr         .
           move      "pgm/mtv/fls/ioc/obj/iofzv3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * Valori diretti                      *
      *                          *-------------------------------------*
           move      rf-zv3-des-sgr       to   w-tes-des-cgs (1)      .
           move      rf-zv3-des-key       to   w-tes-des-key (1)      .
           move      rf-zv3-mne-sgr       to   w-tes-mne-cgs (1)      .
           move      rf-zv3-sqz-num       to   w-tes-sqz-num (1)      .
           move      rf-zv3-ult-sud       to   w-tes-ult-sud (1)      .
           move      rf-zv3-umi-def       to   w-tes-umi-def (1)      .
           move      rf-zv3-ult-cod       to   w-tes-ult-cod (1)      .
           move      rf-zv3-alx-exp       to   w-tes-alx-exp (1)      .
      *                          *-------------------------------------*
      *                          * Valori indiretti                    *
      *                          *-------------------------------------*
           move      w-tes-umi-def (1)    to   w-let-arc-zum-cod      .
      ...
      *                      * Write record [zv1]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zv1-000      thru wrt-rec-zv1-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
      ...
      *                      * Rewrite record [zv1]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zv1-000      thru rew-rec-zv1-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Write record [zv2]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zv2-000      thru wrt-rec-zv2-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Rewrite record [zv2]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zv2-000      thru rew-rec-zv2-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Write record [zv3]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-zv3-000      thru wrt-rec-zv3-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                      * Rewrite record [zv3]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-zv3-000      thru rew-rec-zv3-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
           go to     scr-mov-fil-999.
      ...
      *                  * Delete record [zv1]                         *
      *                  *---------------------------------------------*
           perform   del-rec-zv1-000      thru del-rec-zv1-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *                  * Delete record [zv2]                         *
      *                  *---------------------------------------------*
           perform   del-rec-zv2-000      thru del-rec-zv2-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     del-mov-fil-999.
      ...
      *                  * Delete record [zv3]                         *
      *                  *---------------------------------------------*
           perform   del-rec-zv3-000      thru del-rec-zv3-999        .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     del-mov-fil-999.
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-cgs (1)    to   rf-zv1-des-cla         .
           move      w-tes-mne-cgs (1)    to   rf-zv1-mne-cla         .
           move      w-tes-des-key (1)    to   rf-zv1-des-key         .
           move      w-tes-sqz-num (1)    to   rf-zv1-sqz-num         .
           move      w-tes-ult-sud (1)    to   rf-zv1-ult-sud         .
           move      w-tes-umi-def (1)    to   rf-zv1-umi-def         .
           move      w-tes-ult-cod (1)    to   rf-zv1-ult-cod         .
           move      w-tes-alx-exp (1)    to   rf-zv1-alx-exp         .
       cmp-rec-zv1-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zv1]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zv1-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zv1-000      thru cmp-rec-zv1-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-cgs (1)    to   rf-zv2-des-gru         .
           move      w-tes-mne-cgs (1)    to   rf-zv2-mne-gru         .
           move      w-tes-des-key (1)    to   rf-zv2-des-key         .
           move      w-tes-sqz-num (1)    to   rf-zv2-sqz-num         .
           move      w-tes-ult-sud (1)    to   rf-zv2-ult-sud         .
           move      w-tes-umi-def (1)    to   rf-zv2-umi-def         .
           move      w-tes-ult-cod (1)    to   rf-zv2-ult-cod         .
           move      w-tes-alx-exp (1)    to   rf-zv2-alx-exp         .
       cmp-rec-zv2-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zv2]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zv2-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zv2-000      thru cmp-rec-zv2-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-cgs (1)    to   rf-zv3-des-sgr         .
           move      w-tes-mne-cgs (1)    to   rf-zv3-mne-sgr         .
           move      w-tes-des-key (1)    to   rf-zv3-des-key         .
           move      w-tes-sqz-num (1)    to   rf-zv3-sqz-num         .
           move      w-tes-ult-sud (1)    to   rf-zv3-ult-sud         .
           move      w-tes-umi-def (1)    to   rf-zv3-umi-def         .
           move      w-tes-ult-cod (1)    to   rf-zv3-ult-cod         .
           move      w-tes-alx-exp (1)    to   rf-zv3-alx-exp         .
       cmp-rec-zv3-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [zv3]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-zv3-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-zv3-000      thru cmp-rec-zv3-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Emissione box di errore su controlli in accettazioni      *
      *    *-----------------------------------------------------------*
       err-cnt-acc-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      13                   to   v-lin                  .
           move      11                   to   v-pos                  .
           move      w-err-cnt-acc-msg    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       att-cla-aut-000.
      *              *-------------------------------------------------*
      *              * Lettura codice automatico per [zv1]             *
      *              *-------------------------------------------------*
           move      "Eg"                 to   s-ope                  .
           move      "zv1 "               to   s-nam                  .
           call      "swd/mod/prg/obj/msegrt"
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      w-enc-cod-cla-pos    to   rf-zv1-cod-cla         .
           move      "pgm/mtv/fls/ioc/obj/iofzv1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODCLA    "         to   f-key                  .
           move      w-enc-cod-gru-cla    to   rf-zv1-cod-cla         .
           move      "pgm/mtv/fls/ioc/obj/iofzv1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       att-gru-aut-250.
           ...
           move      "RK"                 to   f-ope                  .
           move      "CODGRU    "         to   f-key                  .
           move      w-enc-cod-gru-cla    to   rf-zv2-cod-cla         .
           move      w-enc-cod-gru-pos    to   rf-zv2-cod-gru         .
           move      "pgm/mtv/fls/ioc/obj/iofzv2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Memorizzazione del valore pre incremento    *
      *                  *---------------------------------------------*
           move      rf-zv1-ult-cod       to   w-enc-cod-gru-pre      .
      *                  *---------------------------------------------*
      *                  * Incremento del valore                       *
      *                  *---------------------------------------------*
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-gru-pos    to   rf-zv1-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/mtv/fls/ioc/obj/iofzv1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * re post incremento                          *
      *                  *---------------------------------------------*
           if        rf-zv1-ult-cod       =    w-enc-cod-gru-pos
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-gru-pre    to   rf-zv1-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/mtv/fls/ioc/obj/iofzv1"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "CODGRU    "         to   f-key                  .
           move      w-enc-cod-sgr-cla    to   rf-zv2-cod-cla         .
           move      w-enc-cod-sgr-gru    to   rf-zv2-cod-gru         .
           move      "pgm/mtv/fls/ioc/obj/iofzv2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       att-sgr-aut-250.
           ...
           move      "RK"                 to   f-ope                  .
           move      "CODSGR    "         to   f-key                  .
           move      w-enc-cod-sgr-cla    to   rf-zv3-cod-cla         .
           move      w-enc-cod-sgr-gru    to   rf-zv3-cod-gru         .
           move      w-enc-cod-sgr-pos    to   rf-zv3-cod-sgr         .
           move      "pgm/mtv/fls/ioc/obj/iofzv3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Memorizzazione del valore pre incremento    *
      *                  *---------------------------------------------*
           move      rf-zv2-ult-cod       to   w-enc-cod-sgr-pre      .
      *                  *---------------------------------------------*
      *                  * Incremento del valore                       *
      *                  *---------------------------------------------*
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-sgr-pos    to   rf-zv2-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/mtv/fls/ioc/obj/iofzv2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * re post incremento                          *
      *                  *---------------------------------------------*
           if        rf-zv2-ult-cod       =    w-enc-cod-sgr-pos
      ...
      *                      * codice utilizzato                       *
      *                      *-----------------------------------------*
           move      w-enc-cod-sgr-pre    to   rf-zv2-ult-cod         .
           move      "UP"                 to   f-ope                  .
           move      "pgm/mtv/fls/ioc/obj/iofzv2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODGRU    "         to   f-key                  .
           move      w-det-gru-cla-cla    to   rf-zv2-cod-cla         .
      ...
      *              *-------------------------------------------------*
           if        rf-zv2-cod-cla       not  = w-det-gru-cla-cla
                     go to det-gru-cla-900.
       det-gru-cla-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "CODSGR    "         to   f-key                  .
           move      w-det-sgr-gru-cla    to   rf-zv3-cod-cla         .
           move      w-det-sgr-gru-gru    to   rf-zv3-cod-gru         .
      ...
      *              * Max su gruppi della classe                      *
      *              *-------------------------------------------------*
           if        rf-zv3-cod-cla       not  = w-det-sgr-gru-cla or
                     rf-zv3-cod-gru       not  = w-det-sgr-gru-gru
                     go to det-sgr-gru-900.
       det-sgr-gru-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-ctl-uni-nrs-nrs    to   rf-zv1-sqz-num         .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-zv1-sqz-num       not  = w-ctl-uni-nrs-nrs
                     go to ctl-uni-nrs-600.
      *                  *---------------------------------------------*
      *                  * Se codice classe letto diverso da quello    *
      *                  * passato incremento il contatore             *
      *                  *---------------------------------------------*
           if        rf-zv1-cod-cla       not  = w-ctl-uni-nrs-cla
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      w-ctl-uni-nrs-cla    to   rf-zv2-cod-cla         .
           move      w-ctl-uni-nrs-nrs    to   rf-zv2-sqz-num         .
           move      zero                 to   rf-zv2-cod-gru         .
           move      "pgm/mtv/fls/ioc/obj/iofzv2"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-zv2-cod-cla       not  = w-ctl-uni-nrs-cla or
                     rf-zv2-sqz-num       not  = w-ctl-uni-nrs-nrs
                     go to ctl-uni-nrs-600.
      *                  *---------------------------------------------*
      *                  * Se codice gruppo letto diverso da quello    *
      *                  * passato incremento il contatore             *
      *                  *---------------------------------------------*
           if        rf-zv2-cod-gru       not  = w-ctl-uni-nrs-gru
                     add   1              to   w-ctl-uni-nrs-ctr      .
      *                  *---------------------------------------------*
      *                  * Riciclo in lettura                          *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "SQZNUM    "         to   f-key                  .
           move      w-ctl-uni-nrs-cla    to   rf-zv3-cod-cla         .
           move      w-ctl-uni-nrs-gru    to   rf-zv3-cod-gru         .
           move      w-ctl-uni-nrs-nrs    to   rf-zv3-sqz-num         .
           move      zero                 to   rf-zv3-cod-sgr         .
           move      "pgm/mtv/fls/ioc/obj/iofzv3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-zv3-cod-cla       not  = w-ctl-uni-nrs-cla or
                     rf-zv3-cod-gru       not  = w-ctl-uni-nrs-gru or
                     rf-zv3-sqz-num       not  = w-ctl-uni-nrs-nrs
                     go to ctl-uni-nrs-600.
      *                  *---------------------------------------------*
      *                  * Se codice sottogruppo letto diverso da quel-*
      *                  * lo passato incremento il contatore          *
      *                  *---------------------------------------------*
           if        rf-zv3-cod-sgr       not  = w-ctl-uni-nrs-sgr
                     add   1              to   w-ctl-uni-nrs-ctr      .
      *                  *---------------------------------------------*
      *                  * Riciclo in lettura                          *
      *                  *---------------------------------------------*
