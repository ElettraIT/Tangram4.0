      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pmtv1821:        *
      *                    Stampa codici statistici 2 materie varie    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA CODICI STATISTICI 2 MATERIALI V. "       .
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
           ...
           move      09                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Selezione su tabella codici statistici 2"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cmn-zvs-002-cod      .
           move      14                   to   w-cmn-zvs-002-lin      .
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cmn-zvs-002-ope      .
           move      rr-cod-max           to   w-cmn-zvs-002-cod      .
           move      14                   to   w-cmn-zvs-002-lin      .
           move      52                   to   w-cmn-zvs-002-pos      .
           move      zero                 to   w-cmn-zvs-002-dln      .
           move      zero                 to   w-cmn-zvs-002-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-mne-max           to   w-pad-zzz-alf          .
           perform   pad-alf-zzz-000      thru pad-alf-zzz-999        .
           move      w-pad-zzz-alf        to   rr-mne-max             .
      *              *-------------------------------------------------*
      *              * Forzatura del tipo classificatore a : 02        *
      *              *-------------------------------------------------*
           move      02                   to   rr-tip-cls             .
       reg-ric-sel-999.
           exit.
