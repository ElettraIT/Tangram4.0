      ...
      * ============================================================== *
      *                                                                *
      * Descrizione pgm:   Modulo accettazione codice materia varia    *
      *                                                                *
      * ============================================================== *
      *                                                                *
      * Tipi operazione :                                              *
      ...
      *                                                                *
      *              Input  : w-cod-cod-mtv-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-mtv-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-cod-mtv-ope : "AC"                 *
      *                                                                *
      *                       w-cod-cod-mtv-tac : Tipo accettazione    *
      *                                           - N : Numerico       *
      *                                           - A : Alfanumerico   *
      *                                           - S : Sinonimo       *
      *                                           - L : Libera, alfa-  *
      ...
      *                                                 controllata    *
      *                                                                *
      *                       w-cod-cod-mtv-num : Codice numerico      *
      *                                             Solo se tipo ac-   *
      *                                             cettazione 'N' o   *
      *                                             tipo acc.  'A'     *
      *                                                                *
      *                       w-cod-cod-mtv-alf : Codice alfanumerico  *
      *                                             Inutile se tipo    *
      *                                             accettazione 'N'   *
      *                                                                *
      *                       w-cod-cod-mtv-lin : linea a video        *
      *                                                                *
      *                       w-cod-cod-mtv-pos : posizione a video    *
      *                                                                *
      *                       w-cod-cod-mtv-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-cod-mtv-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-mtv-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-cod-mtv-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-cod-mtv-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-cod-mtv-num : Codice numerico      *
      ...
      *            * - N : Codice materia varia numerico               *
      *            * - A : Codice materia varia alfanumerico           *
      *            * - S : Sinonimo                                    *
      ...
      *        * Tipo di ricerca                                       *
      *        * - S : Su sinonimo                                     *
      *        * - D : Su descrizione materia varia                    *
      *        *-------------------------------------------------------*
      ...
      *                *-----------------------------------------------*
      *                * Codice numerico della materia varia           *
      *                *-----------------------------------------------*
                   15  w-buf-cod-num      pic  9(07)                  .
      *                *-----------------------------------------------*
      *                * Codice alfanumerico della materia varia       *
      *                *-----------------------------------------------*
                   15  w-buf-cod-alf      pic  x(14)                  .
      *                *-----------------------------------------------*
      *                * Codice sinonimo della materia varia           *
      *                *-----------------------------------------------*
                   15  w-buf-cod-sin      pic  x(13)                  .
      *                *-----------------------------------------------*
      *                * Descrizione della materia varia               *
      *                *-----------------------------------------------*
                   15  w-buf-des-mtv      pic  x(40)                  .
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice magazzino 'mtv'         *
      *    *-----------------------------------------------------------*
      ...
      ******************************************************************
       Procedure Division                using w-cod-cod-mtv
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-cod-mtv-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-cod-mtv-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-cod-mtv-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-cod-mtv-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-cod-mtv-ope    =    "A+" or
                     w-cod-cod-mtv-ope    =    "I+" or
                     w-cod-cod-mtv-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-cod-mtv-ope      .
       tcm-999.
           exit.
      ...
      *                  * Codice numerico                             *
      *                  *---------------------------------------------*
           if        w-cod-cod-mtv-tac    =    "N" or
                     w-cod-cod-mtv-tac    =    "A"
                     move  w-cod-cod-mtv-num
                                          to   w-cod-cod-mtv-s01
           else      move  zero           to   w-cod-cod-mtv-s01      .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico                         *
      *                  *---------------------------------------------*
           if        w-cod-cod-mtv-tac    =    "N"
                     move  spaces         to   w-cod-cod-mtv-s02
           else      move  w-cod-cod-mtv-alf
                                          to   w-cod-cod-mtv-s02      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing v-edm                   *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-cod-mtv-s70      .
      *                  *---------------------------------------------*
      *                  * User function-keys eventualmente epurate    *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-cod-mtv-s90      .
       acc-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-cod-cod-mtv-s01    to   w-edt-num-cod          .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-cod-mtv-s90    to   v-ufk                  .
           move      w-cod-cod-mtv-lin    to   v-lin                  .
           move      w-cod-cod-mtv-pos    to   v-pos                  .
           move      w-edt-num-edt        to   v-alf                  .
      *                  *---------------------------------------------*
      *                  * Tipo operazione a : continuazione           *
      *                  *---------------------------------------------*
           move      "A+"                 to   w-cod-cod-mtv-ope      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     acc-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-cod-mtv-lin    to   v-lin                  .
           move      w-cod-cod-mtv-pos    to   v-pos                  .
           move      w-cod-cod-mtv-s02    to   v-alf                  .
      *                  *---------------------------------------------*
      *                  * Tipo operazione a : continuazione           *
      *                  *---------------------------------------------*
           move      "A+"                 to   w-cod-cod-mtv-ope      .
      ...
      *              *-------------------------------------------------*
           if        w-cod-cod-mtv-ope    =    "A+"
                     go to aco-300
           else if   w-cod-cod-mtv-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                          * ta numerica                         *
      *                          *-------------------------------------*
           move      s-num                to   w-cod-cod-mtv-num      .
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      w-cod-cod-mtv-num    to   w-edt-num-cod          .
           perform   edn-000              thru edn-999                .
      *                          *-------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Lettura del record 'mtv' relativo   *
      ...
      *                              *---------------------------------*
       ...
       aco-260.
      *                          *-------------------------------------*
      *                          * Se record 'mtv' esistente           *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      *                              * Deviazione in funzione del tipo *
      *                              * di accettazione                 *
      *                              *---------------------------------*
           if        w-cod-cod-mtv-tac    =    "A"
                     go to aco-280.
       aco-270.
      *                              *---------------------------------*
      ...
      *                                  * uscita                      *
      *                                  *-----------------------------*
           move      rf-mtv-num-mtv       to   w-cod-cod-mtv-num      .
      *                                  *-----------------------------*
      *                                  * Valore alfanumerico conte-  *
      *                                  * nuto nel record in area di  *
      *                                  * uscita                      *
      *                                  *-----------------------------*
           move      rf-mtv-alf-mtv       to   w-cod-cod-mtv-alf      .
      *                                  *-----------------------------*
      ...
      *                          * ta numerica                         *
      *                          *-------------------------------------*
           move      w-man-x14-num        to   w-cod-cod-mtv-num      .
      *                          *-------------------------------------*
      *                          * Area di uscita alfanumerica a spa-  *
      *                          * ces                                 *
      *                          *-------------------------------------*
      ...
      *                          * ta alfanumerica                     *
      *                          *-------------------------------------*
           move      w-man-x14-alf        to   w-cod-cod-mtv-alf      .
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
       ...
       aco-460.
      *                          *-------------------------------------*
      *                          * Se trovato il record 'mtv' cercato  *
      *                          *-------------------------------------*
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           move      w-man-x14-alf        to   w-cod-cod-mtv-alf      .
      *                              *---------------------------------*
      *                              * Codice materia varia numerico   *
      *                              * contenuto in record 'mtv' in    *
      ...
      *                                  *-----------------------------*
       ...
       aco-480.
      *                          *-------------------------------------*
      *                          * Se record 'mtv' relativo al codice  *
      ...
      *                              * per la descrizione              *
      *                              *---------------------------------*
           if        w-cod-cod-mtv-dln    =    zero
                     go to aco-482.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      40                   to   v-car                  .
           move      spaces               to   v-edm                  .
           move      w-cod-cod-mtv-dln    to   v-lin                  .
           move      w-cod-cod-mtv-dps    to   v-pos                  .
           move      all   "."            to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-482.
      ...
      *                      * vato                                    *
      *                      *-----------------------------------------*
           if        w-cod-cod-mtv-dln    =    zero or
                     w-cod-cod-mtv-dps    =    zero
                     go to aco-340.
       aco-545.
      *                      *-----------------------------------------*
      ...
      *                              *---------------------------------*
           move      w-cod-cod-mtv-s01    to   w-cod-cod-mtv-num      .
           move      w-cod-cod-mtv-s02    to   w-cod-cod-mtv-alf      .
      *                              *---------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-mtv-num-mtv       to   w-buf-cod-num
                                              (w-buf-ctr-rec)         .
      *                          *-------------------------------------*
      *                          * Codice alfanumerico della materia   *
      *                          * varia                               *
      *                          *-------------------------------------*
      ...
      *                          * Descrizione della materia varia     *
      *                          *-------------------------------------*
           move      rf-mtv-des-mtv       to   w-buf-des-mtv
                                              (w-buf-ctr-rec)         .
       aco-635.
      *                      *-----------------------------------------*
      *                      * Riciclo a Read Next                     *
      ...
      *                                  *-----------------------------*
           move      w-buf-cod-num
                    (w-buf-ctr-ibx)       to   w-cod-cod-mtv-num      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           move      w-buf-cod-alf
                    (w-buf-ctr-ibx)       to   w-cod-cod-mtv-alf      .
      *                                  *-----------------------------*
      *                                  * Visualizzazione del valore  *
      *                                  * alfanumerico                *
      *                                  *-----------------------------*
      ...
      *                              *---------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      05                   to   v-pos                  .
           move      "            Selezionare il codice materiale vario 
      -              "desiderato            "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      ...
      *              *-------------------------------------------------*
       vpg-125.
      *                  *---------------------------------------------*
      *                  * Codice materia varia alfanumerico           *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      14                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
       ...
       sac-200.
      *              *-------------------------------------------------*
      *              * Test se codice materia varia numerico           *
      *              *-------------------------------------------------*
       ...
       sac-300.
      *              *-------------------------------------------------*
      *              * Test se codice materia varia alfanumerico       *
      *              *-------------------------------------------------*
