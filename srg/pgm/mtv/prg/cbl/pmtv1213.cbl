      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione Sottogruppi materie varie    *
      *                                                                *
      *================================================================*
      ...
      *    *===========================================================*
      *    * Link-area per accettazione codice sottogruppo mat. varie  *
      *    *-----------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-cla           to   w-cod-mne-zv3-cla      .
           move      rr-des-cla           to   w-cod-mne-zv3-dcl      .
           move      rr-cod-gru           to   w-cod-mne-zv3-gru      .
           move      rr-des-gru           to   w-cod-mne-zv3-dgr      .
           move      rr-cod-min           to   w-cod-mne-zv3-sgr      .
           move      19                   to   w-cod-mne-zv3-lin      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-gru           to   w-cod-mne-zv3-gru      .
           move      rr-des-gru           to   w-cod-mne-zv3-dgr      .
           move      rr-cod-max           to   w-cod-mne-zv3-sgr      .
           move      19                   to   w-cod-mne-zv3-lin      .
           move      52                   to   w-cod-mne-zv3-pos      .
           move      zero                 to   w-cod-mne-zv3-dln      .
           move      zero                 to   w-cod-mne-zv3-dps      .
           move      "<B"                 to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
       ...
       acc-cod-max-120.
           move      w-cod-mne-zv3-cla    to   v-num                  .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zv3-cod-cla         .
           move      rr-cod-gru           to   rf-zv3-cod-gru         .
           move      rr-cod-min           to   rf-zv3-cod-sgr         .
           move      "pgm/mtv/fls/ioc/obj/iofzv3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zv3-cod-cla         .
           move      rr-cod-gru           to   rf-zv3-cod-gru         .
           move      rr-des-min           to   rf-zv3-des-key         .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zv3-cod-cla         .
           move      rr-cod-gru           to   rf-zv3-cod-gru         .
           move      rr-mne-min           to   rf-zv3-mne-sgr         .
           move      zero                 to   rf-zv3-cod-sgr         .
           move      "pgm/mtv/fls/ioc/obj/iofzv3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-cla           to   rf-zv3-cod-cla         .
           move      rr-cod-gru           to   rf-zv3-cod-gru         .
           move      rr-sqz-min           to   rf-zv3-sqz-num         .
           move      zero                 to   rf-zv3-cod-sgr         .
           move      "pgm/mtv/fls/ioc/obj/iofzv3"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zv3]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/mtv/fls/ioc/obj/iofzv3"
                                          to   s-pat                  .
      ...
      *              * Se ordinamento per codice                       *
      *              *-------------------------------------------------*
           if        rf-zv3-cod-cla       not  = rr-cod-cla
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           if        rf-zv3-cod-gru       not  = rr-cod-gru
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           if        rf-zv3-cod-sgr       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           go to     qry-tst-max-999.
       qry-tst-max-400.
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zv3-cod-sgr       <    rr-cod-min or
                     rf-zv3-cod-sgr       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zv3-des-key       <    rr-des-min or
                     rf-zv3-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su mnemonico                          *
      *              *-------------------------------------------------*
           if        rf-zv3-mne-sgr       <    rr-mne-min or
                     rf-zv3-mne-sgr       >    rr-mne-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su numero di sequenza                 *
      *              *-------------------------------------------------*
           if        rf-zv3-sqz-num       <    rr-sqz-min or
                     rf-zv3-sqz-num       >    rr-sqz-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      "+"                  to   v-edm                  .
           move      rf-zv3-cod-sgr       to   w-mpn-cod-sgr          .
           move      rf-zv3-des-sgr       to   w-mpn-des-sgr          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
