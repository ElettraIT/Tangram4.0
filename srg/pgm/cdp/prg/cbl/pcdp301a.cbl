      ...
      *                                                                *
      *                    Ricerca commesse intestate ad un cliente    *
      *                                                                *
      *                    ___ COMPLETARE CON SELEZ ORDINE CLIENTE ___ *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
      *              * Prompt status commesse                          *
      *              *-------------------------------------------------*
           perform   pmt-sts-cdp-000      thru pmt-sts-cdp-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione status commesse                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su [cdp] per cliente                      *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DPZDSZ    "         to   f-key                  .
           move      rr-dpz-inu           to   rf-cdp-cod-dpz         .
           move      02                   to   rf-cdp-dsz-prd         .
           move      rr-cod-cli           to   rf-cdp-dsz-cod         .
      ...
      *              *-------------------------------------------------*
           if        rf-cdp-dsz-prd       not  = 02
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           if        rf-cdp-dsz-cod       not  = rr-cod-cli
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
       qry-tst-max-200.
      *              *-------------------------------------------------*
      *              * Se oltre data registrazione massima : superam.  *
      *              *-------------------------------------------------*
           if        rr-dem-max           =    zero
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Determinazione status commesse              *
      *                  *---------------------------------------------*
