      ...
      *                                   Fase:    cdp330              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 29/10/92    *
      *                       Ultima revisione:    NdK del 14/10/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pcdp3301:        *
      *                                                                *
      *                    Stampa commesse di produzione per respon-   *
      *                    sabile                                      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " COMMESSE DI PRODUZIONE PER RESPONSABILE"       .
      ...
      *        * Codice responsabile                                   *
      *        *-------------------------------------------------------*
           05  rr-cod-rsp                 pic  x(03)                  .
           05  rr-cod-rsp-des             pic  x(20)                  .
      *        *-------------------------------------------------------*
      *        * Data produzione prevista min - max                    *
      *        *-------------------------------------------------------*
           05  rr-dpp-min                 pic  9(07)                  .
           05  rr-dpp-max                 pic  9(07)                  .
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Status commesse                            *
      *        *-------------------------------------------------------*
           05  w-exp-sts-cdp.
               10  w-exp-sts-cdp-num      pic  9(02)       value 03   .
               10  w-exp-sts-cdp-lun      pic  9(02)       value 25   .
               10  w-exp-sts-cdp-tbl.
                   15  filler             pic  x(25) value
                            "Solo quelle da evadere   "               .
                   15  filler             pic  x(25) value
                            "Solo quelli gia' evase   "               .
                   15  filler             pic  x(25) value
                            "Tutte                    "               .
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-200.
      *                  *---------------------------------------------*
      *                  * Data produzione prevista minima             *
      *                  *---------------------------------------------*
           perform   acc-dpp-min-000      thru acc-dpp-min-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
       ...
       acc-ric-sel-300.
      *                  *---------------------------------------------*
      *                  * Data produzione prevista massima            *
      *                  *---------------------------------------------*
           perform   acc-dpp-max-000      thru acc-dpp-max-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-rsp           to   w-cod-cod-yrc-cod      .
           move      05                   to   w-cod-cod-yrc-lin      .
      ...
      *                  *---------------------------------------------*
           perform   vis-cod-rsp-des-000  thru vis-cod-rsp-des-999    .
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Data produzione prevista   *
      *    * minima                                                    *
      *    *-----------------------------------------------------------*
       acc-dpp-min-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-dpp-min-999.
       acc-dpp-min-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-dpp-min             .
       acc-dpp-min-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-dpp-max-999.
       acc-dpp-max-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-dpp-max             .
       acc-dpp-max-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *                  *---------------------------------------------*
      *                  * Test su data produzione prevista minima e   *
      *                  * massima                                     *
      *                  *---------------------------------------------*
           if        rr-dpp-min           =    zero or
                     rr-dpp-max           =    zero
                     go to tdo-ric-sel-120.
           if        rr-dpp-min           not  > rr-dpp-max
                     go to tdo-ric-sel-120.
           move      "Data produzione iniziale maggiore di quella finale
      ...
      *              * Data produzione prevista massima                *
      *              *-------------------------------------------------*
           if        rr-dpp-max           not  = zero
                     go to reg-ric-sel-100.
           if        rr-dpp-min           =    zero
                     move  9999999        to   rr-dpp-max
           else      move  rr-dpp-min     to   rr-dpp-max             .
       reg-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Status commesse                                 *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           move      spaces               to   rr-cod-rsp             .
           move      spaces               to   rr-cod-rsp-des         .
           move      zero                 to   rr-dpp-min             .
           move      zero                 to   rr-dpp-max             .
