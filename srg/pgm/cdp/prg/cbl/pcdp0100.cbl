      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione Tipi movimento per gestione com-   *
      *                                                                *
      *                    messe di produzione                         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " TIPI MOVIMENTO COMMESSE DI PRODUZIONE  "       .
      ...
      *        *-------------------------------------------------------*
           05  w-tes-val-key.
               10  w-tes-cod-tcp          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Valori attuali e precedenti                           *
      *        *-------------------------------------------------------*
           05  w-tes-val-aep occurs 2.
               10  w-tes-des-key          pic  x(30)                  .
               10  w-tes-des-tcp          pic  x(30)                  .
               10  w-tes-pwd-tcp          pic  x(08)                  .
               10  w-tes-rsp-tcp          pic  x(03)                  .
               10  w-tes-rsp-tcp-des      pic  x(20)                  .
      ...
      *    *===========================================================*
      *    * Link-area per accettazione tipo movimento commesse produz.*
      *    *-----------------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   acc-cod-tcp-000      thru acc-cod-tcp-999        .
      ...
      *              * Codice tipo movimento                           *
      *              *-------------------------------------------------*
           perform   vis-cod-tcp-000      thru vis-cod-tcp-999        .
       vis-key-reg-999.
           exit.
      ...
      *              * Codice tipo movimento                           *
      *              *-------------------------------------------------*
           perform   pmt-cod-tcp-000      thru pmt-cod-tcp-999        .
      *              *-------------------------------------------------*
      *              * Linea di trattini                               *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-tcp        to   w-cod-des-ycp-cod      .
           move      04                   to   w-cod-des-ycp-lin      .
           move      30                   to   w-cod-des-ycp-pos      .
           move      07                   to   w-cod-des-ycp-dln      .
           move      30                   to   w-cod-des-ycp-dps      .
       ...
       acc-cod-tcp-110.
           ...
           if        w-cod-des-ycp-ope    =    "F+"
                     go to acc-cod-tcp-115.
           if        w-cod-des-ycp-ope    =    "AC"
                     go to acc-cod-tcp-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-tcp-115.
           perform   cod-des-ycp-foi-000  thru cod-des-ycp-foi-999    .
           go to     acc-cod-tcp-110.
       acc-cod-tcp-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-cod-tcp-999.
       acc-cod-tcp-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-cod-tcp          .
       acc-cod-tcp-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   acc-des-tcp-000      thru acc-des-tcp-999        .
           if        v-key                =    "NXSC"
      ...
      *                  *---------------------------------------------*
           perform   acc-pwd-tcp-000      thru acc-pwd-tcp-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Descrizione tipo movimento                      *
      *              *-------------------------------------------------*
           perform   vis-des-tcp-000      thru vis-des-tcp-999        .
      *              *-------------------------------------------------*
      *              * Descrizione per la stampa                       *
      *              *-------------------------------------------------*
      ...
      *              * Password per il movimento                       *
      *              *-------------------------------------------------*
           perform   vis-pwd-tcp-000      thru vis-pwd-tcp-999        .
      *              *-------------------------------------------------*
      *              * Validita' per le dipendenze                     *
      *              *-------------------------------------------------*
      ...
      *              * Descrizione tipo movimento                      *
      *              *-------------------------------------------------*
           perform   pmt-des-tcp-000      thru pmt-des-tcp-999        .
      *              *-------------------------------------------------*
      *              * Descrizione per la stampa                       *
      *              *-------------------------------------------------*
      ...
      *              * Password per il movimento                       *
      *              *-------------------------------------------------*
           perform   pmt-pwd-tcp-000      thru pmt-pwd-tcp-999        .
      *              *-------------------------------------------------*
      *              * Validita' per le dipendenze                     *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Responsabile commesse            *
      *    *-----------------------------------------------------------*
       pmt-rsp-tcp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           if        w-tes-des-tcp (1)    =    spaces
                     go to acc-des-tcp-100.
       acc-des-tcp-450.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-des-tcp (1)    to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-tes-des-tcp (1)    to   w-tes-des-stp (1)      .
       acc-des-stp-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Codice responsabile          *
      *    *-----------------------------------------------------------*
       acc-rsp-tcp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-rsp-tcp (1)    to   w-cod-cod-yrc-cod      .
           move      17                   to   w-cod-cod-yrc-lin      .
      ...
      *                  * Lettura tabella                             *
      *                  *---------------------------------------------*
           move      w-tes-rsp-tcp (1)    to   w-let-arc-yrc-cod      .
           perform   let-arc-yrc-000      thru let-arc-yrc-999        .
      *                  *---------------------------------------------*
      *                  * Memorizzazione descrizione                  *
      *                  *---------------------------------------------*
           move      w-let-arc-yrc-des    to   w-tes-rsp-tcp-des (1)  .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-rsp-tcp-des-000  thru vis-rsp-tcp-des-999    .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Codice responsabile       *
      *    *-----------------------------------------------------------*
       vis-rsp-tcp-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Descrizione responsabile  *
      *    *-----------------------------------------------------------*
       vis-rsp-tcp-des-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           if        w-tes-rsp-tcp (1)    not  = spaces
                     go to cnt-tdo-nok-300.
           move      "Manca il responsabile commesse                  "
                                          to   w-err-box-err-msg      .
           go to     cnt-tdo-nok-900.
       cnt-tdo-nok-300.
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           ...
           move      spaces               to   w-tes-des-tcp (1)      .
           move      spaces               to   w-tes-pwd-tcp (1)      .
           move      spaces               to   w-tes-rsp-tcp (1)      .
           move      spaces               to   w-tes-rsp-tcp-des (1)  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-cod-tcp        to   rf-ycp-cod-tcp         .
           move      "pgm/cdp/fls/ioc/obj/iofycp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          * record [ycp]                        *
      *                          *-------------------------------------*
           move      rf-ycp-des-key       to   w-tes-des-key (1)      .
           move      rf-ycp-des-tcp       to   w-tes-des-tcp (1)      .
           move      rf-ycp-pwd-tcp       to   w-tes-pwd-tcp (1)      .
           move      rf-ycp-rsp-tcp       to   w-tes-rsp-tcp (1)      .
           move      rf-ycp-vld-dpz       to   w-tes-vld-dpz (1)      .
           move      rf-ycp-cod-dpz       to   w-tes-cod-dpz (1)      .
           move      rf-ycp-org-doc       to   w-tes-org-doc (1)      .
           move      rf-ycp-prv-doc       to   w-tes-prv-doc (1)      .
           move      rf-ycp-sgl-num       to   w-tes-sgl-num (1)      .
           move      rf-ycp-des-stp       to   w-tes-des-stp (1)      .
           move      rf-ycp-alx-exp       to   w-tes-alx-exp (1)      .
      *                              *---------------------------------*
      *                              * Lettura archivio [ada]          *
      *                              *---------------------------------*
           move      w-tes-cod-dpz (1)    to   w-let-arc-ada-cod      .
      ...
      *                      * Write record [ycp]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-ycp-000      thru wrt-rec-ycp-999        .
      ...
      *                      * Rewrite record [ycp]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-ycp-000      thru rew-rec-ycp-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [ycp]                             *
      *              *-------------------------------------------------*
           perform   del-rec-ycp-000      thru del-rec-ycp-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [ycp]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-ycp-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-des-key (1)    to   rf-ycp-des-key         .
           move      w-tes-des-tcp (1)    to   rf-ycp-des-tcp         .
           move      w-tes-pwd-tcp (1)    to   rf-ycp-pwd-tcp         .
           move      w-tes-rsp-tcp (1)    to   rf-ycp-rsp-tcp         .
           move      w-tes-vld-dpz (1)    to   rf-ycp-vld-dpz         .
           move      w-tes-cod-dpz (1)    to   rf-ycp-cod-dpz         .
           move      w-tes-org-doc (1)    to   rf-ycp-org-doc         .
           move      w-tes-prv-doc (1)    to   rf-ycp-prv-doc         .
           move      w-tes-sgl-num (1)    to   rf-ycp-sgl-num         .
           move      w-tes-des-stp (1)    to   rf-ycp-des-stp         .
           move      w-tes-alx-exp (1)    to   rf-ycp-alx-exp         .
       cmp-rec-ycp-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [ycp]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-ycp-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-ycp-000      thru cmp-rec-ycp-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
