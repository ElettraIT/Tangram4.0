      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma cdp330   *
      *                                                                *
      ...
      *                  *---------------------------------------------*
           ...
           move      w-let-arc-ycp-rsp    to   w-stp-srt-inp-rsp      .
      *                  *---------------------------------------------*
      *                  * Selezione su responsabile commessa          *
      *                  *---------------------------------------------*
           if        rr-cod-rsp           =    spaces
                     go to stp-srt-inp-440.
           if        w-let-arc-ycp-rsp    not  = rr-cod-rsp
      ...
      *              *-------------------------------------------------*
       stp-srt-inp-500.
      *              *-------------------------------------------------*
      *              * Determinazione descrizione responsabile         *
      *              *-------------------------------------------------*
           move      w-stp-srt-inp-rsp    to   w-let-arc-yrc-cod      .
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      w-let-arc-yrc-des    to   srt-des-rsp            .
           move      w-stp-srt-inp-rsp    to   srt-cod-rsp            .
      ...
      *    *-----------------------------------------------------------*
       prn-cmp-rot-000.
           move      srt-cod-rsp          to   w-rot-l01-cod-rsp      .
       prn-cmp-rot-999.
           exit.
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Fincatura per livello dettaglio             *
      *                  *---------------------------------------------*
