      ...
      *    *-----------------------------------------------------------*
           select  optional  fil   assign to disk           f-fil-pat
                   ...
                   alternate record key   is fil-k11
      ...
      *    *-----------------------------------------------------------*
           select  optional  pul   assign to disk           f-pul-pat
                   ...
                   alternate record key   is pul-k11
      ...
      *            *---------------------------------------------------*
               10  fil-k10.
                   15  fil-cod-dpz-10     pic  9(02)                  .
                   15  fil-tip-mag        pic  9(02)                  .
                   15  fil-num-mag        pic  9(07)       comp-3     .
                   15  fil-dat-doc-10     pic  9(07)       comp-3     .
                   15  fil-num-doc-10     pic  9(11)       comp-3     .
                   15  fil-num-prt-10     pic  9(11)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 11 : CCHMAG                         *
      *            *---------------------------------------------------*
               10  fil-k11.
                   15  fil-flg-cch-11     pic  x(01)                  .
                   15  fil-cod-dpz-11     pic  9(02)                  .
                   15  fil-tip-mag-11     pic  9(02)                  .
                   15  fil-num-mag-11     pic  9(07)       comp-3     .
                   15  fil-num-prt-11     pic  9(11)       comp-3     .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  fil-dat.
               ...
               10  fil-qta-dap            pic s9(10)v9(03) comp-3     .
      ...
      *            *---------------------------------------------------*
               10  pul-k10.
                   15  pul-cod-dpz-10     pic  9(02)                  .
                   15  pul-tip-mag        pic  9(02)                  .
                   15  pul-num-mag        pic  9(07)       comp-3     .
                   15  pul-dat-doc-10     pic  9(07)       comp-3     .
                   15  pul-num-doc-10     pic  9(11)       comp-3     .
                   15  pul-num-prt-10     pic  9(11)       comp-3     .
      *            *---------------------------------------------------*
      *            * Chiave numero 11 : CCHMAG                         *
      *            *---------------------------------------------------*
               10  pul-k11.
                   15  pul-flg-cch-11     pic  x(01)                  .
                   15  pul-cod-dpz-11     pic  9(02)                  .
                   15  pul-tip-mag-11     pic  9(02)                  .
                   15  pul-num-mag-11     pic  9(07)       comp-3     .
                   15  pul-num-prt-11     pic  9(11)       comp-3     .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  pul-dat.
               ...
               10  pul-qta-dap            pic s9(10)v9(03) comp-3     .
      ...
      *    *===========================================================*
      *    * Record logico file [cdp]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/cdp/fls/rec/rfcdp"                          .

      ******************************************************************
       Procedure Division                using f rf-cdp               .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
       ...
       str-976.
      *                     *------------------------------------------*
      *                     * Start not less chiave indice 11          *
      *                     *------------------------------------------*
           start     fil    key not less
                            fil-k11
                            invalid key
       ...
       str-977.
      *                     *------------------------------------------*
      *                     * Start greater  chiave indice 11          *
      *                     *------------------------------------------*
           start     fil    key greater
                            fil-k11
                            invalid key
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           ...
           move      zero                 to   rf-cdp-ide-dat         .
           move      spaces               to   rf-cdp-ide-ute         .
           move      spaces               to   rf-cdp-ide-fas         .
           move      zero                 to   rf-cdp-num-prt         .
           move      spaces               to   rf-cdp-tmo-cdp         .
           move      zero                 to   rf-cdp-cod-dpz         .
           move      zero                 to   rf-cdp-dat-doc         .
           move      zero                 to   rf-cdp-num-doc         .
           move      zero                 to   rf-cdp-scl-ann         .
           move      spaces               to   rf-cdp-sgl-num         .
           move      zero                 to   rf-cdp-dsz-prd         .
           move      zero                 to   rf-cdp-dsz-cod         .
           move      spaces               to   rf-cdp-dsz-dpz         .
           move      zero                 to   rf-cdp-esz-prd         .
           move      zero                 to   rf-cdp-esz-cod         .
           move      spaces               to   rf-cdp-esz-dpz         .
           move      zero                 to   rf-cdp-dat-cns         .
           move      spaces               to   rf-cdp-pri-prd         .
           ...
           move      zero                 to   rf-cdp-tip-mag         .
           move      zero                 to   rf-cdp-num-mag         .
           move      spaces               to   rf-cdp-alf-mag         .
           move      spaces               to   rf-cdp-sgl-vrn         .
           move      spaces               to   rf-cdp-umi-prd         .
           move      zero                 to   rf-cdp-dec-qta         .
           move      zero                 to   rf-cdp-qta-dap         .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-cdp-ide-ute       to   fil-ide-ute            .
           move      rf-cdp-ide-fas       to   fil-ide-fas            .
           move      rf-cdp-dsz-dpz       to   fil-dsz-dpz            .
           move      rf-cdp-esz-dpz       to   fil-esz-dpz            .
           move      rf-cdp-dat-cns       to   fil-dat-cns            .
           move      rf-cdp-pri-prd       to   fil-pri-prd            .
           move      rf-cdp-com-int       to   fil-com-int            .
           move      rf-cdp-voc-des (1)   to   fil-voc-des (1)        .
           move      rf-cdp-voc-des (2)   to   fil-voc-des (2)        .
           move      rf-cdp-voc-des (3)   to   fil-voc-des (3)        .
           move      rf-cdp-voc-des (4)   to   fil-voc-des (4)        .
           move      rf-cdp-voc-des (5)   to   fil-voc-des (5)        .
           move      rf-cdp-voc-des (6)   to   fil-voc-des (6)        .
           move      rf-cdp-alf-mag       to   fil-alf-mag            .
           move      rf-cdp-sgl-vrn       to   fil-sgl-vrn            .
           move      rf-cdp-umi-prd       to   fil-umi-prd            .
           move      rf-cdp-dec-qta       to   fil-dec-qta            .
           move      rf-cdp-qta-dap       to   fil-qta-dap            .
           move      rf-cdp-cod-dsl       to   fil-cod-dsl            .
           move      rf-cdp-snx-2qt       to   fil-snx-2qt            .
           move      rf-cdp-dec-2qt       to   fil-dec-2qt            .
           move      rf-cdp-qta-a02       to   fil-qta-a02            .
           move      rf-cdp-snx-3qt       to   fil-snx-3qt            .
           move      rf-cdp-dec-3qt       to   fil-dec-3qt            .
           move      rf-cdp-qta-a03       to   fil-qta-a03            .
           move      rf-cdp-ctr-stp       to   fil-ctr-stp            .
           move      rf-cdp-sdc-ccs       to   fil-sdc-ccs            .
           move      rf-cdp-flg-ela       to   fil-flg-ela            .
           move      rf-cdp-flg-pul       to   fil-flg-pul            .
           move      rf-cdp-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cdp-num-prt       to   fil-num-prt            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cdp-ide-dat       to   fil-ide-dat            .
           move      rf-cdp-dat-doc       to   fil-dat-doc            .
           move      rf-cdp-num-prt       to   fil-num-prt-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cdp-dat-doc       to   fil-dat-doc-3          .
           move      rf-cdp-cod-dpz       to   fil-cod-dpz            .
           move      rf-cdp-num-doc       to   fil-num-doc            .
           move      rf-cdp-tmo-cdp       to   fil-tmo-cdp            .
           move      rf-cdp-num-prt       to   fil-num-prt-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cdp-scl-ann       to   fil-scl-ann            .
           move      rf-cdp-cod-dpz       to   fil-cod-dpz-4          .
           move      rf-cdp-sgl-num       to   fil-sgl-num            .
           move      rf-cdp-num-doc       to   fil-num-doc-4          .
           move      rf-cdp-num-prt       to   fil-num-prt-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cdp-cod-dpz       to   fil-cod-dpz-5          .
           move      rf-cdp-tmo-cdp       to   fil-tmo-cdp-5          .
           move      rf-cdp-num-doc       to   fil-num-doc-5          .
           move      rf-cdp-num-prt       to   fil-num-prt-5          .
           go to     cmp-key-fis-999.
       cmp-key-fis-600.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cdp-cod-dpz       to   fil-cod-dpz-6          .
           move      rf-cdp-dsz-prd       to   fil-dsz-prd            .
           move      rf-cdp-dsz-cod       to   fil-dsz-cod            .
           move      rf-cdp-dat-doc       to   fil-dat-doc-6          .
           move      rf-cdp-num-doc       to   fil-num-doc-6          .
           move      rf-cdp-num-prt       to   fil-num-prt-6          .
           go to     cmp-key-fis-999.
       cmp-key-fis-700.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cdp-cod-dpz       to   fil-cod-dpz-7          .
           move      rf-cdp-esz-prd       to   fil-esz-prd            .
           move      rf-cdp-esz-cod       to   fil-esz-cod            .
           move      rf-cdp-dat-doc       to   fil-dat-doc-7          .
           move      rf-cdp-num-doc       to   fil-num-doc-7          .
           move      rf-cdp-num-prt       to   fil-num-prt-7          .
           go to     cmp-key-fis-999.
       cmp-key-fis-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cdp-cod-dpz       to   fil-cod-dpz-8          .
           move      rf-cdp-tmo-cdp       to   fil-tmo-cdp-8          .
           move      rf-cdp-dat-doc       to   fil-dat-doc-8          .
           move      rf-cdp-num-doc       to   fil-num-doc-8          .
           move      rf-cdp-num-prt       to   fil-num-prt-8          .
           go to     cmp-key-fis-999.
       cmp-key-fis-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cdp-flg-cch       to   fil-flg-cch            .
           move      rf-cdp-cod-dpz       to   fil-cod-dpz-9          .
           move      rf-cdp-num-prt       to   fil-num-prt-9          .
           go to     cmp-key-fis-999.
       cmp-key-fis-950.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-cdp-cod-dpz       to   fil-cod-dpz-10         .
           move      rf-cdp-tip-mag       to   fil-tip-mag            .
           move      rf-cdp-num-mag       to   fil-num-mag            .
           move      rf-cdp-dat-doc       to   fil-dat-doc-10         .
           move      rf-cdp-num-doc       to   fil-num-doc-10         .
           move      rf-cdp-num-prt       to   fil-num-prt-10         .
           go to     cmp-key-fis-999.
       cmp-key-fis-975.
      *              *-------------------------------------------------*
      *              * Composizione chiave indice 11                   *
      *              *-------------------------------------------------*
           move      spaces               to   fil-k11                .
           move      rf-cdp-flg-cch       to   fil-flg-cch-11         .
           move      rf-cdp-cod-dpz       to   fil-cod-dpz-11         .
           move      rf-cdp-tip-mag       to   fil-tip-mag-11         .
           move      rf-cdp-num-mag       to   fil-num-mag-11         .
           move      rf-cdp-num-prt       to   fil-num-prt-11         .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-cdp                 .
           move      fil-ide-dat          to   rf-cdp-ide-dat         .
           move      fil-ide-ute          to   rf-cdp-ide-ute         .
           move      fil-ide-fas          to   rf-cdp-ide-fas         .
           move      fil-num-prt          to   rf-cdp-num-prt         .
           move      fil-tmo-cdp          to   rf-cdp-tmo-cdp         .
           move      fil-cod-dpz          to   rf-cdp-cod-dpz         .
           move      fil-dat-doc          to   rf-cdp-dat-doc         .
           move      fil-num-doc          to   rf-cdp-num-doc         .
           move      fil-scl-ann          to   rf-cdp-scl-ann         .
           move      fil-sgl-num          to   rf-cdp-sgl-num         .
           move      fil-dsz-prd          to   rf-cdp-dsz-prd         .
           move      fil-dsz-cod          to   rf-cdp-dsz-cod         .
           move      fil-dsz-dpz          to   rf-cdp-dsz-dpz         .
           move      fil-esz-prd          to   rf-cdp-esz-prd         .
           move      fil-esz-cod          to   rf-cdp-esz-cod         .
           move      fil-esz-dpz          to   rf-cdp-esz-dpz         .
           move      fil-dat-cns          to   rf-cdp-dat-cns         .
           move      fil-pri-prd          to   rf-cdp-pri-prd         .
           move      fil-com-int          to   rf-cdp-com-int         .
           move      fil-voc-des (1)      to   rf-cdp-voc-des (1)     .
           move      fil-voc-des (2)      to   rf-cdp-voc-des (2)     .
           move      fil-voc-des (3)      to   rf-cdp-voc-des (3)     .
           move      fil-voc-des (4)      to   rf-cdp-voc-des (4)     .
           move      fil-voc-des (5)      to   rf-cdp-voc-des (5)     .
           move      fil-voc-des (6)      to   rf-cdp-voc-des (6)     .
           move      fil-tip-mag          to   rf-cdp-tip-mag         .
           move      fil-num-mag          to   rf-cdp-num-mag         .
           move      fil-alf-mag          to   rf-cdp-alf-mag         .
           move      fil-sgl-vrn          to   rf-cdp-sgl-vrn         .
           move      fil-umi-prd          to   rf-cdp-umi-prd         .
           move      fil-dec-qta          to   rf-cdp-dec-qta         .
           move      fil-qta-dap          to   rf-cdp-qta-dap         .
           move      fil-cod-dsl          to   rf-cdp-cod-dsl         .
           move      fil-snx-2qt          to   rf-cdp-snx-2qt         .
           move      fil-dec-2qt          to   rf-cdp-dec-2qt         .
           move      fil-qta-a02          to   rf-cdp-qta-a02         .
           move      fil-snx-3qt          to   rf-cdp-snx-3qt         .
           move      fil-dec-3qt          to   rf-cdp-dec-3qt         .
           move      fil-qta-a03          to   rf-cdp-qta-a03         .
           move      fil-ctr-stp          to   rf-cdp-ctr-stp         .
           move      fil-sdc-ccs          to   rf-cdp-sdc-ccs         .
           move      fil-flg-cch          to   rf-cdp-flg-cch         .
           move      fil-flg-ela          to   rf-cdp-flg-ela         .
           move      fil-flg-pul          to   rf-cdp-flg-pul         .
           move      fil-alx-exp          to   rf-cdp-alx-exp         .
       dec-fis-log-999.
           exit.
