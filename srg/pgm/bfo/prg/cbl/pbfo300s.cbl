      ...
      *                                                 fornitore      *
      *                                                                *
      *                    PROMEMORIA : Implementare alcuni tipi di    *
      *                                 ordinamento e ordinamento da   *
      *                                 pbfo3100 (w-inp-mst-tor)       *
      *                                                                *
      *================================================================*
      ...
      *                *-----------------------------------------------*
                   15  w-stp-rig-des-der.
                       20  w-stp-rig-des-rgd occurs 10
                                          pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Area di comodo per la stampa delle interlinee     *
      *            * aggiuntive                                        *
      *            *---------------------------------------------------*
               10  w-stp-int-agg.
      *                *-----------------------------------------------*
      ...
      *                        *---------------------------------------*
                           25  filler     pic  x(13)                  .
      *                    *-------------------------------------------*
      *                    * Ridefinizione di tipo '21'                *
      *                    *-------------------------------------------*
                       20  w-rig-key-alf-21  redefines
                           w-rig-key-alf.
      *                        *---------------------------------------*
      ...
      *                        *---------------------------------------*
                           25  filler     pic  x(35)                  .
      *                    *-------------------------------------------*
      *                    * Ridefinizione di tipo '22'                *
      *                    *-------------------------------------------*
                       20  w-rig-key-alf-22  redefines
                           w-rig-key-alf.
      *                        *---------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Personalizzazione si/no documento in attesa di  *
      *              * verifica                                        *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Descrizione relativa alla riga in esame *
      *                      * in area di comodo                       *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se riferimenti all'ordine fornito- *
      *                      * re esistenti                            *
      *                      *-----------------------------------------*
           if        rf-bfr-orf-prt       =    zero or
                     rf-bfr-orf-prg       =    zero
      ...
      *                      *-----------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      rf-bfr-orf-prt       to   rf-ofr-num-prt         .
           move      rf-bfr-orf-prg       to   rf-ofr-num-prg         .
           move      "pgm/orf/fls/ioc/obj/iofofr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * avere modificato il record [bfr] in     *
      ...
      *                          *-------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-cor-doc-200.
      *                      *-----------------------------------------*
      *                      * Aggiustamento quantita' da ricevere con *
      *                      * quantita' ricevuta                      *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Test su eventuale personalizzazione *
      *                          *-------------------------------------*
           if        w-prs-snx-dav        =    "S" and
                     rf-bfr-flg-nbx (1)   not  = spaces
                     go to stp-cor-doc-620.
      *                          *-------------------------------------*
      *                          * Agiustamento                        *
      *                          *-------------------------------------*
           add       rf-bfr-qta-acq       to   d-qev-rof-qta-dri      .
       stp-cor-doc-620.
      *                      *-----------------------------------------*
      *                      * Stampa quantita' da ricevere            *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           if        d-qev-rof-qta-dri    >    99999 or
                     d-qev-rof-qta-dri    <   -99999
                     move  06             to   p-car
           ...
           add       w-stp-rig-ctr-rcs    to   p-lin                  .
           move      074                  to   p-pos                  .
           move      d-qev-rof-qta-dri    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cor-doc-650.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-cor-doc-700.
      *                  *---------------------------------------------*
      *                  * Eventuale stampa del codice prodotto per il *
      *                  * Fornitore                                   *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *              *                                                 *
      *              * N.B.: ordinamenti 'bfo310' da implementare      *
      *              *                                                 *
      *              * N.B.: alcuni ordinamenti da implementare        *
      *              *-------------------------------------------------*
           if        w-prs-sbf-orr        =    00
                     go to stp-cor-doc-obk-005
           else if   w-prs-sbf-orr        =    13
                     go to stp-cor-doc-obk-130
           else if   w-prs-sbf-orr        =    21
                     go to stp-cor-doc-obk-210
           else if   w-prs-sbf-orr        =    22
                     go to stp-cor-doc-obk-220
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-bfr-cod-dpz       to   d-prm-ubi-cod-dpz      .
           move      rf-bfr-tip-mag       to   d-prm-ubi-tip-mag      .
      ...
      *                      * Bufferizzazione codice prodotto         *
      *                      *-----------------------------------------*
           move      rf-bfr-alf-mag       to   w-rig-key-cap-13
                                              (w-rig-num-ele)         .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione progressivo riga        *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-cor-doc-obk-210.
      *              *-------------------------------------------------*
      *              * Se ordinamento per codice prodotto fornitore    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione chiave di ordinamento          *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-rig-buf-bfo-wtp    =    "P"
                     go to stp-cor-doc-obk-212.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione codice prodotto forni-  *
      *                      * tore                                    *
      *                      *-----------------------------------------*
           move      all "z"              to   w-rig-key-cod-21
                                              (w-rig-num-ele)         .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione progressivo riga        *
      *                      *-----------------------------------------*
           move      rf-bfr-num-prg       to   w-rig-key-prg-21
                                              (w-rig-num-ele)         .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
      ...
      *                      * tore                                    *
      *                      *-----------------------------------------*
           move      rf-bfr-cop-sfn       to   w-rig-key-cod-21
                                              (w-rig-num-ele)         .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione progressivo riga        *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-cor-doc-obk-220.
      *              *-------------------------------------------------*
      *              * Se ordinamento per codice casa produttrice      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Preparazione chiave di ordinamento          *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-rig-buf-bfo-wtp    =    "P"
                     go to stp-cor-doc-obk-222.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione codice prodotto forni-  *
      *                      * tore                                    *
      *                      *-----------------------------------------*
           move      all "z"              to   w-rig-key-cod-22
                                              (w-rig-num-ele)         .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione progressivo riga        *
      *                      *-----------------------------------------*
           move      rf-bfr-num-prg       to   w-rig-key-prg-22
                                              (w-rig-num-ele)         .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
       ...
       stp-cor-doc-obk-222.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione codice casa produttrice *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           move      rf-aaq-cdp-pdt       to   w-rig-key-cod-22
                                              (w-rig-num-ele)         .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione progressivo riga        *
      *                      *-----------------------------------------*
      ...
      *                  * Test su valore personalizzazione            *
      *                  *---------------------------------------------*
           if        w-prs-sbf-nia        =    zero
                     go to stp-cor-doc-rdd-900.
      *                  *---------------------------------------------*
      *                  * Ciclo di stampa                             *
      *                  *---------------------------------------------*
           move      zero                 to   w-stp-int-agg-ctr      .
       stp-cor-doc-rdd-820.
           add       1                    to   w-stp-int-agg-ctr      .
           if        w-stp-int-agg-ctr    >    w-prs-sbf-nia
                     go to stp-cor-doc-rdd-900.
      *                  *---------------------------------------------*
      *                  * Incremento numero riga corpo in corso di    *
      *                  * stampa                                      *
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      rf-bft-cod-arc       to   rf-dfx-cod-fnt         .
           move      rf-bft-dpz-arc       to   rf-dfx-dpz-fnt         .
      ...
      *                  *---------------------------------------------*
           if        rf-dfx-cod-fnt       not  = rf-bft-cod-arc
                     go to stp-cor-doc-ann-900.
      *                  *---------------------------------------------*
      *                  * Test su codice dipendenza fornitore         *
      *                  *---------------------------------------------*
           if        rf-dfx-dpz-fnt       not  = rf-bft-dpz-arc
                     go to stp-cor-doc-ann-900.
       stp-cor-doc-ann-040.
      *              *-------------------------------------------------*
      *              * Selezioni su [dfx]                              *
      ...
      *                  *---------------------------------------------*
           if        rf-dfx-cod-prg       not  = "pbfo3000"
      ...
      *                  * Riciclo                                     *
      *                  *---------------------------------------------*
           go to     stp-cor-doc-ann-400.
       stp-cor-doc-ann-800.
      *              *-------------------------------------------------*
      *              * Stampa ultima riga di trattini                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento numero riga corpo in corso di    *
      *                  * stampa                                      *
      ...
      *                      * Riferimenti ordine                      *
      *                      *-----------------------------------------*
           move      "Ns.ordine"          to   w-rou-stp-pmt-alf      .
      ...
      *                      * Quantita' residua                       *
      *                      *-----------------------------------------*
           move      "Da ricevere"        to   w-rou-stp-pmt-alf      .
           move      11                   to   w-rou-stp-pmt-car      .
           move      15                   to   w-rou-stp-pmt-lin      .
           move      074                  to   w-rou-stp-pmt-pos      .
      *                          *-------------------------------------*
      *                          * Correttivo per pagine successive    *
      *                          * alla prima                          *
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       det-des-rig-010.
      *              *-------------------------------------------------*
      *              * Lettura preliminare estensione in file [bfx]    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        rf-bfr-tip-mag       =    01
                     if    rf-pdx-tip-rec not  = 13
                           go to det-des-rig-680
                     else  go to det-des-rig-670
           else if   rf-bfr-tip-mag       =    03
                     if    rf-pdx-tip-rec not  = 33
                           go to det-des-rig-680
                     else  go to det-des-rig-670
           else if   rf-bfr-tip-mag       =    04
                     if    rf-pdx-tip-rec not  = 43
                           go to det-des-rig-680
                     else  go to det-des-rig-670.
       det-des-rig-670.
           if        rf-pdx-cod-arc       not  = rf-bfr-cod-arc or
                     rf-pdx-cod-lng       not  = spaces         or
                     rf-pdx-cod-num       not  = rf-bfr-num-mag or
                     rf-pdx-for-mat       not  = rf-bfr-fda-pif
                     go to det-des-rig-680.
      *                          *-------------------------------------*
