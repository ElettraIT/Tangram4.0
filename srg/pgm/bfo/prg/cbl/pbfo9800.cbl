      ...
      *                                   Fase:    bfo980              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 23/05/05    *
      *                       Ultima revisione:    001 del 09/04/25    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Manutenzione spunti carichi fornitori       *
      *                                                                *
      *================================================================*
      ...
      *            * Quantita' rilevata                                *
      *            *---------------------------------------------------*
               10  srt-qta-ril            pic s9(10)v9(03)            .
      *            *---------------------------------------------------*
      *            * Quantita' riga                                    *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "MANUTENZIONE SPUNTE DOCUMENTI DI CARICO "       .
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-rig-cod-arc-rag          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Codice prodotto                                       *
      *        *-------------------------------------------------------*
           05  w-rig-num-pro              pic  9(07)                  .
           05  w-rig-alf-pro              pic  x(14)                  .
           05  w-rig-alf-pro-des          pic  x(40)                  .
      *        *-------------------------------------------------------*
      *        * Quantita' rilevata                                    *
      *        *-------------------------------------------------------*
           05  w-rig-qta-ril              pic s9(10)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Quantita' riga                                        *
      *        *-------------------------------------------------------*
           05  w-rig-qta-acq              pic s9(10)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Flag di spunta                                        *
      *        *-------------------------------------------------------*
           05  w-rig-flg-spn              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Codice responsabile di magazzino                      *
      *        *-------------------------------------------------------*
      ...
      *        * Riferimenti di magazzino                              *
      *        *-------------------------------------------------------*
           05  w-rig-prt-mag              pic  9(11)                  .
           05  w-rig-drg-mag              pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Riferimenti interni                                   *
      *        *-------------------------------------------------------*
           05  w-rig-num-prt              pic  9(11)                  .
           05  w-rig-num-prr              pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Annotazioni                                           *
      *        *-------------------------------------------------------*
           05  w-rig-ann-spn              pic  x(80)                  .
      ...
      *                *-----------------------------------------------*
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-cod-arc  pic  x(07)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-dpz-arc  pic  x(04)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-alf-mag  pic  x(14)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-qta-ril  pic  x(08)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-qta-rig  pic  x(08)                  .
                   15  w-lin-imm-flg-dif  pic  x(01)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-flg-spn  pic  x(01)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-cod-rsp  pic  x(05)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-prt-mag  pic  x(06)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-drg-mag  pic  x(08)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-sav.
      *        *-------------------------------------------------------*
      *        * Salvataggio per codice archivio                       *
      *        *-------------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Si/no solo inevasi                         *
      *        *-------------------------------------------------------*
           05  w-exp-snx-ine.
               10  w-exp-snx-ine-num      pic  9(02)       value 02   .
               10  w-exp-snx-ine-lun      pic  9(02)       value 40   .
               10  w-exp-snx-ine-tbl.
                   15  filler             pic  x(40) value
                            "Solo inevasi                            ".
                   15  filler             pic  x(40) value
                            "Tutte le righe ordine                   ".
      ...
      *        *-------------------------------------------------------*
           05  w-det-sel-bfs.
               10  w-det-sel-bfs-inc      pic  9(11)                  .
               10  w-det-sel-bfs-sdo      pic  x(01)                  .
      ...
      *    *===========================================================*
      *    * Work per routine di Expand anagrafica archivio            *
      *    *-----------------------------------------------------------*
       01  w-rou-exp-ana.
      *        *-------------------------------------------------------*
      *        * Codice archivio                                       *
      ...
      *              * Protocollo                                      *
      *              *-------------------------------------------------*
           perform   vis-prt-bfo-000      thru vis-prt-bfo-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Protocollo                                  *
      *                  *---------------------------------------------*
           perform   pmt-prt-bfo-000      thru pmt-prt-bfo-999        .
       pmt-key-reg-999.
           exit.
      ...
      *                  * Quantita' rilevata                          *
      *                  *---------------------------------------------*
           perform   acc-qta-ril-000      thru acc-qta-ril-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * Annotazioni                                 *
      *                  *---------------------------------------------*
           perform   acc-ann-spn-000      thru acc-ann-spn-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
                     go to acc-cor-reg-900.
           if        v-key                =    "UP  "
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-cod-arc      .
       vis-lin-cor-460.
      *                  *---------------------------------------------*
      *                  * Codice dipendenza archivio                  *
      *                  *---------------------------------------------*
           move      w-rig-dpz-arc        to   w-lin-imm-dpz-arc      .
       vis-lin-cor-480.
      *                  *---------------------------------------------*
      *                  * Codice prodotto                             *
      *                  *---------------------------------------------*
           move      w-rig-alf-pro        to   w-lin-imm-alf-mag      .
       vis-lin-cor-490.
      *                  *---------------------------------------------*
      ...
      *
           ...
           move      w-all-str-alf        to   w-lin-imm-qta-ril      .
      *                  *---------------------------------------------*
      *                  * Editing quantita' riga                      *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      06                   to   v-car                  .
      ...
      *
           ...
           move      08                   to   w-all-str-lun          .
           perform   all-str-adx-000      thru all-str-adx-999        .
           move      w-all-str-alf        to   w-lin-imm-qta-rig      .
      *                  *---------------------------------------------*
      *                  * Flag di differenza tra le quantita'         *
      *                  *---------------------------------------------*
           if        w-rig-qta-ril        not  = w-rig-qta-acq
                     move  "*"            to   w-lin-imm-flg-dif
           else      move  spaces         to   w-lin-imm-flg-dif      .
      *                  *---------------------------------------------*
      *                  * Flag di spunta                              *
      *                  *---------------------------------------------*
           move      w-rig-flg-spn        to   w-lin-imm-flg-spn      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   v-sgn                  .
           move      "B"                  to   v-edm                  .
           move      w-rig-cod-rsm        to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-cod-rsp      .
       vis-lin-cor-520.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-prt-mag      .
      *                  *---------------------------------------------*
      *                  * Editing Data registrazione di magazzino     *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
           move      w-rig-drg-mag        to   v-dat                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-drg-mag      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.    Fornitore      Prodotto          Quantita
      -              "'     F Resp.  Rif. magazzino "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           perform   vis-rig-dpa-000      thru vis-rig-dpa-999        .
      ...
      *              * Quantita' spunta                                *
      *              *-------------------------------------------------*
           perform   vis-qta-ril-000      thru vis-qta-ril-999        .
      *              *-------------------------------------------------*
      *              * Flag di spunta                                  *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   vis-rif-mag-000      thru vis-rif-mag-999        .
      *              *-------------------------------------------------*
      *              * Riferimenti interni                             *
      *              *-------------------------------------------------*
           perform   vis-rif-int-000      thru vis-rif-int-999        .
      *              *-------------------------------------------------*
      *              * Annotazioni                                     *
      *              *-------------------------------------------------*
           perform   vis-ann-spn-000      thru vis-ann-spn-999        .
       vis-rig-cor-999.
           exit.
      ...
      *              * Quantita' spunta                                *
      *              *-------------------------------------------------*
           perform   pmt-qta-ril-000      thru pmt-qta-ril-999        .
      *              *-------------------------------------------------*
      *              * Flag di spunta                                  *
      *              *-------------------------------------------------*
      ...
      *              * Responsabile                                    *
      *              *-------------------------------------------------*
           perform   pmt-cod-rsm-000      thru pmt-cod-rsm-999        .
      *              *-------------------------------------------------*
      *              * Magazzino                                       *
      *              *-------------------------------------------------*
           perform   pmt-rif-mag-000      thru pmt-rif-mag-999        .
      *              *-------------------------------------------------*
      *              * Riferimenti interni                             *
      *              *-------------------------------------------------*
           perform   pmt-rif-int-000      thru pmt-rif-int-999        .
      *              *-------------------------------------------------*
      *              * Annotazioni                                     *
      *              *-------------------------------------------------*
           perform   pmt-ann-spn-000      thru pmt-ann-spn-999        .
       pmt-rig-cor-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Prodotto                         *
      *    *-----------------------------------------------------------*
       pmt-alf-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Quantita' spunta                 *
      *    *-----------------------------------------------------------*
       pmt-qta-ril-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Flag di spunta                   *
      *    *-----------------------------------------------------------*
       pmt-flg-spn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Responsabile                     *
      *    *-----------------------------------------------------------*
       pmt-cod-rsm-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Riferimenti di magazzino         *
      *    *-----------------------------------------------------------*
       pmt-rif-mag-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Riferimenti interni              *
      *    *-----------------------------------------------------------*
       pmt-rif-int-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione 1. campo riga corpo : Codice archivio        *
      *    *-----------------------------------------------------------*
       acc-rig-arc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      w-sav-cod-arc        to   w-rig-cod-arc          .
       acc-rig-arc-125.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       acc-rig-arc-152.
           ...
           if        w-cod-mne-dcf-ope    =    "F+"
                     go to acc-rig-arc-154.
           if        w-cod-mne-dcf-ope    =    "AC"
                     go to acc-rig-arc-156.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-rig-arc-154.
           perform   cod-mne-dcf-foi-000  thru cod-mne-dcf-foi-999    .
           go to     acc-rig-arc-152.
       acc-rig-arc-156.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces
                     go to acc-rig-arc-400.
       acc-rig-arc-250.
      *              *-------------------------------------------------*
      *              * Se Slct                                         *
      *              *-------------------------------------------------*
           if        v-key                not  = "SLCT"
                     go to acc-rig-arc-300.
       acc-rig-arc-255.
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                not  = "EXPD"
                     go to acc-rig-arc-320.
           if        w-rig-cod-arc        =    zero
                     go to acc-rig-arc-320.
      *                  *---------------------------------------------*
      *                  * Box di espansione                           *
      *                  *---------------------------------------------*
           move      w-rig-cod-arc        to   w-rou-exp-ana-cod      .
           move      w-rig-dpz-arc        to   w-rou-exp-ana-dpz      .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice dipendenza archivio              *
      *    *-----------------------------------------------------------*
       vis-rig-dpa-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione : Codice archivio, ragione sociale        *
      *    *-----------------------------------------------------------*
       vis-rig-arc-rag-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           ...
           move      16                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-arc-rag    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-rig-arc-rag-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione campo : Quantita' rilevata                   *
      *    *-----------------------------------------------------------*
       acc-qta-ril-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-qta-ril-999.
      *              *-------------------------------------------------*
      *              * Valore impostato                                *
      *              *-------------------------------------------------*
           move      v-num                to   w-rig-qta-ril          .
       acc-qta-ril-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Flag di spunta                       *
      *    *-----------------------------------------------------------*
       acc-flg-spn-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Flag di spunta                          *
      *    *-----------------------------------------------------------*
       vis-flg-spn-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-cod-rsm        to   w-cod-mne-zrm-cod      .
           move      19                   to   w-cod-mne-zrm-lin      .
           move      22                   to   w-cod-mne-zrm-pos      .
           move      19                   to   w-cod-mne-zrm-dln      .
      ...
      *    *-----------------------------------------------------------*
       vis-cod-rsm-des-000.
           ...
           move      19                   to   v-lin                  .
           move      41                   to   v-pos                  .
           move      w-rig-cod-rsm-des    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       vis-cod-rsm-des-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione : Riferimenti magazzino                   *
      *    *-----------------------------------------------------------*
       vis-rif-mag-000.
      *              *-------------------------------------------------*
      *              * Editing protocollo di magazzino                 *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Riferimenti interni                     *
      *    *-----------------------------------------------------------*
       vis-rif-int-000.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-nok-rig-000.
           ...
           move      spaces               to   w-rig-cod-arc-rag      .
           move      zero                 to   w-rig-num-pro          .
           move      spaces               to   w-rig-alf-pro          .
           move      spaces               to   w-rig-alf-pro-des      .
           move      zero                 to   w-rig-qta-ril          .
           move      zero                 to   w-rig-qta-acq          .
           move      spaces               to   w-rig-flg-spn          .
           move      zero                 to   w-rig-cod-rsm          .
           move      spaces               to   w-rig-cod-rsm-des      .
           move      zero                 to   w-rig-prt-mag          .
           move      zero                 to   w-rig-drg-mag          .
           move      zero                 to   w-rig-num-prt          .
           move      zero                 to   w-rig-num-prr          .
       nor-nok-rig-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      w-tes-prt-bfo        to   w-wrk-nos-acc          .
      *
      ...
      *
           ...
           move      w-wrk-nos-int        to   w-tes-prt-bfo          .
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Start su [bfs]                                  *
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-tes-prt-bfo        to   rf-bfs-num-prt         .
      ...
      *                  *---------------------------------------------*
           if        rf-bfs-num-prt       not  = w-tes-prt-bfo
                     go to stp-srt-inp-900.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Selezioni su [bfs]                              *
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      rf-bfs-num-prt       to   rf-bfr-num-prt         .
           move      rf-bfs-num-prg       to   rf-bfr-num-prg         .
           move      "pgm/bfo/fls/ioc/obj/iofbfr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Data spunta                             *
      *                      *-----------------------------------------*
           move      rf-bfs-ide-dat       to   srt-ide-dat            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      * Quantita' rilevata                      *
      *                      *-----------------------------------------*
           move      rf-bfs-qta-ril       to   srt-qta-ril            .
      *                      *-----------------------------------------*
      *                      * Quantita' riga                          *
      *                      *-----------------------------------------*
      ...
      *                      * Flag di spunta                          *
      *                      *-----------------------------------------*
           move      rf-bfs-flg-spn       to   srt-flg-spn            .
      *                      *-----------------------------------------*
      *                      * Codice responsabile di magazzino        *
      *                      *-----------------------------------------*
           move      rf-bfs-cod-rsm       to   srt-cod-rsm            .
      *                      *-----------------------------------------*
      *                      * Riferimenti di magazzino                *
      *                      *-----------------------------------------*
           move      rf-bfs-prt-mag       to   srt-prt-mag            .
           move      rf-bfs-drg-mag       to   srt-drg-mag            .
      *                      *-----------------------------------------*
      *                      * Riferimenti interni                     *
      *                      *-----------------------------------------*
      ...
      *                      * Annotazioni                             *
      *                      *-----------------------------------------*
           move      rf-bfs-ann-spn       to   srt-ann-spn            .
       stp-srt-inp-800.
      *              *-------------------------------------------------*
      ...
      *                  * Valori diretti                              *
      *                  *---------------------------------------------*
           move      srt-cod-arc          to   w-rig-cod-arc          .
           move      srt-dpz-arc          to   w-rig-dpz-arc          .
           move      srt-num-pro          to   w-rig-num-pro          .
           move      srt-alf-pro          to   w-rig-alf-pro          .
           move      srt-qta-ril          to   w-rig-qta-ril          .
           move      srt-qta-acq          to   w-rig-qta-acq          .
           move      srt-flg-spn          to   w-rig-flg-spn          .
           move      srt-cod-rsm          to   w-rig-cod-rsm          .
           move      srt-prt-mag          to   w-rig-prt-mag          .
           move      srt-drg-mag          to   w-rig-drg-mag          .
           move      srt-num-prt          to   w-rig-num-prt          .
           move      srt-num-prg          to   w-rig-num-prg          .
           move      srt-num-prr          to   w-rig-num-prr          .
           move      srt-ann-spn          to   w-rig-ann-spn          .
       car-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Valori indiretti                            *
      *                  *---------------------------------------------*
      ...
      *                      * Anagrafica archivio                     *
      *                      *-----------------------------------------*
           move      w-rig-cod-arc        to   w-let-arc-dcf-fnt      .
           move      w-rig-dpz-arc        to   w-let-arc-dcf-dpz      .
           perform   let-arc-dcf-000      thru let-arc-dcf-999        .
           move      w-let-arc-dcf-rag    to   w-rig-cod-arc-rag      .
      *                      *-----------------------------------------*
      *                      * Lettura archivio [dcp]                  *
      *                      *-----------------------------------------*
           move      w-rig-num-pro        to   w-let-arc-dcp-num      .
           perform   let-arc-dcp-000      thru let-arc-dcp-999        .
           move      w-let-arc-dcp-des    to   w-rig-alf-pro-des      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-rig-num-prt        to   rf-bfs-num-prt         .
           move      w-rig-num-prg        to   rf-bfs-num-prg         .
           move      w-rig-num-prr        to   rf-bfs-num-prr         .
           move      "pgm/bfo/fls/ioc/obj/iofbfs"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Aggiornamento                               *
      *                  *---------------------------------------------*
           move      w-rig-qta-ril        to   rf-bfs-qta-ril         .
           move      w-rig-flg-spn        to   rf-bfs-flg-spn         .
           move      w-rig-cod-rsm        to   rf-bfs-cod-rsm         .
           move      w-rig-ann-spn        to   rf-bfs-ann-spn         .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [bfs]                         *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-liv                not  = zero
                     go to  fnd-arc-bfs-999.
      *              *-------------------------------------------------*
      *              * Richiamo programma di interrogazione            *
      *              *-------------------------------------------------*
           move      "pgm/bfo/prg/obj/porf3010"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat                                            .
      ...
      *    *===========================================================*
      *    * Routine per Expand anagrafica commerciale archivio        *
      *    *-----------------------------------------------------------*
       rou-exp-ana-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Anagrafica commerciale archivio             *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODFNT"             to   f-key                  .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/bfo/prg/obj/pbfo9802"                       .
       cnc-rlt-sup-999.
           exit.
