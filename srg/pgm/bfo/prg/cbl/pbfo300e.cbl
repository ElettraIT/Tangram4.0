      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Duplicazione righe da altra bolla di        *
      *                    entrata                                     *
      *                                                                *
      *                    Richiamata in bfo300 da funzione 'PF3'      *
      *                                                                *
      *================================================================*
      *                                                                *
      * Tipi operazione                                                *
      ...
      *                 l-dup-rdb-tmo-bfo = codice tipo movimento bol- *
      ...
      *        *-------------------------------------------------------*
           05  w-brb-tbl.
               10  w-brb-sng-ele occurs 999.
                   ...
                   15  w-brb-qta-bfo      pic s9(06)v9(03) comp-3     .
                   15  w-brb-qta-dup      pic s9(06)v9(03) comp-3     .
                   15  w-brb-flg-idr      pic  x(01)                  .
                   15  w-brb-flg-ids      pic  x(01)                  .
                   15  w-brb-flg-fzs      pic  x(01)                  .
                   15  w-brb-qta-res      pic s9(06)v9(03) comp-3     .
      ...
      *        *-------------------------------------------------------*
           05  l-dup-rdb-tmo-bfo          pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Flag di trattamento bolla di acquisto                 *
      *        *-------------------------------------------------------*
           05  l-dup-rdb-flg-bfo          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Flag di function-key Tab in corso                     *
      *        *-------------------------------------------------------*
           05  l-dup-rdb-fky-tab          pic  x(01)                  .
