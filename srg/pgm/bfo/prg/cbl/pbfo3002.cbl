      ...
      *            *---------------------------------------------------*
               10  w-chm-ele.
                   15  filler occurs 5120 pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           call      "swd/mod/prg/obj/miosts"
                                         using w-fil                  .
      *              *-------------------------------------------------*
      *              * Spostamento cobfo-file-status in area per defi- *
      ...
      *                  *---------------------------------------------*
           open      i-o   fil                                        .
      *                  *---------------------------------------------*
      *                  * Test se file temporaneo 'lockato'           *
      *                  *---------------------------------------------*
           if        e-sts                not  = e-use-err
                     go to opn-800.
      *                  *---------------------------------------------*
      *                  * Attesa di 1 secondo                         *
      *                  *---------------------------------------------*
