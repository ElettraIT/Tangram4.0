      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pbfo3301:        *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Si/No righe di commento                    *
      *        *-------------------------------------------------------*
           05  w-exp-snx-rdc.
               10  w-exp-snx-rdc-num      pic  9(02)       value 02   .
               10  w-exp-snx-rdc-lun      pic  9(02)       value 02   .
               10  w-exp-snx-rdc-tbl.
      ...
      *                  * Si/No righe di commento                     *
      *                  *---------------------------------------------*
           perform   acc-snx-rdc-000      thru acc-snx-rdc-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
                     go to acc-ric-sel-100.
      ...
      *              * Si/no righe di commento                         *
      *              *-------------------------------------------------*
           perform   pmt-snx-rdc-000      thru pmt-snx-rdc-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Prompt si/no righe di commento                            *
      *    *-----------------------------------------------------------*
       pmt-snx-rdc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione : Si/No righe di commento                    *
      *    *-----------------------------------------------------------*
       acc-snx-rdc-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        rr-snx-rdc           =    spaces
                     move  "N"            to   rr-snx-rdc             .
       acc-snx-rdc-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-rdc-lun    to   v-car                  .
           move      w-exp-snx-rdc-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      "NS#"                to   v-msk                  .
           move      w-exp-snx-rdc-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      16                   to   v-lin                  .
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  "S"            to   rr-snx-rdc
           else      move  spaces         to   rr-snx-rdc             .
       acc-snx-rdc-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        rr-snx-rdc           not  = spaces
                     go to acc-snx-rdc-500.
           if        v-key                =    "UP  "
                     go to acc-snx-rdc-600
           else      go to acc-snx-rdc-100.
       acc-snx-rdc-500.
      *                  *---------------------------------------------*
      *                  * Test se valore ammesso                      *
      *                  *---------------------------------------------*
           if        rr-snx-rdc           not  = "S" and
                     rr-snx-rdc           not  = "N"
                     go to acc-snx-rdc-100.
       acc-snx-rdc-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
