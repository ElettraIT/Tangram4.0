      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tipi movimento per bolle     *
      *                    fornitori                                   *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [ybf]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/bfo/fls/ioc/obj/iofybf"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      30                   to   v-pos                  .
           move      rf-ybf-des-tmb       to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-ybf-cod-tmb       to   w-mpn-cod-tmb          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "   TIPI MOVIMENTO PER BOLLE FORNITORI   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
