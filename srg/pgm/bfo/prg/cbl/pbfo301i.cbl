      ...
      *                    (previa personalizzazione)                  *
      *                                                                *
      *                    Ricerca documenti per contrassegno collo    *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       pmt-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Prompt codice contrassegno                      *
      *              *-------------------------------------------------*
           perform   pmt-cod-cts-000      thru pmt-cod-cts-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione codice contrassegno             *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione : Codice contrassegno                        *
      *    *-----------------------------------------------------------*
       acc-cod-cts-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione : Contrassegno da ricercare               *
      *    *-----------------------------------------------------------*
       vis-cod-cts-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Controllo su contrassegno                       *
      *              *-------------------------------------------------*
           if        rr-cod-cts           not  = spaces
                     go to tdo-ric-sel-200.
           move      "Manca il contrassegno                             
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-cts           to   rf-bfk-cts-prc         .
      ...
      *              *-------------------------------------------------*
       ...
       qry-tst-max-100.
      *              *-------------------------------------------------*
      *              * Se fine contrassegno : superamento              *
      *              *-------------------------------------------------*
           if        rf-bfk-cts-prc       not  = rr-cod-cts
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfk-num-prt       to   rf-bfr-num-prt         .
           move      rf-bfk-num-prg       to   rf-bfr-num-prg         .
           move      "pgm/bfo/fls/ioc/obj/iofbfr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       int-pag-sta-200.
      *              *-------------------------------------------------*
      *              * Sub-intestazione per il contrassegno            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Literal per codice contrassegno             *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      20                   to   v-car                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-bfr-alf-mag       to   w-esp-rig-bfr-pro      .
      *                      *-----------------------------------------*
      *                      * Chiamata del modulo                     *
      *                      *-----------------------------------------*
