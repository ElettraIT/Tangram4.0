      ...
      *                       Ultima revisione:    NdK del 28/01/03    *
      *                    ------------------------------------------- *
      ...
      *                  *---------------------------------------------*
           move      rf-bft-cod-arc       to   srt-arc-key            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
      ...
      *
           inspect   v-alf           replacing all "/" by   ","       .
           inspect   v-alf           replacing all "V" by   ","       .
           inspect   v-alf           replacing all "L" by   ","       .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      rf-bft-dat-reg       to   srt-dat-key            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
      ...
      *                      *-----------------------------------------*
           move      rf-bft-num-prt       to   w-num-prt-ext          .
      ...
      *                  *---------------------------------------------*
       ...
       stp-int-pag-200.
      *              *-------------------------------------------------*
      *              * Sub-intestazione per il tipo movimento          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Sottolineatura fincatura per tipo movimento *
      *                  *---------------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      80                   to   v-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "       Codice e descrizione archivio            Nu
      -              "mero   Data reg  Protoc.    R "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       stp-int-pag-400.
