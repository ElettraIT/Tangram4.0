      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Update bolle di acquisto - righe            *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   Update righe documenti di acquisto   "       .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Numero progressivo riga       *
      *    *-----------------------------------------------------------*
       pmt-num-prg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo chiave : Numero progressivo riga       *
      *    *-----------------------------------------------------------*
       acc-num-prg-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo chiave : Numero progressivo riga    *
      *    *-----------------------------------------------------------*
       vis-num-prg-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
      ...
      *                  * Protocollo ordine                           *
      *                  *---------------------------------------------*
           perform   acc-orf-prt-000      thru acc-orf-prt-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *                  *---------------------------------------------*
           perform   acc-orf-prg-000      thru acc-orf-prg-999        .
           if        v-key                =    "NXSC"
                     move  "+"            to   w-cnt-tus-acc-tes      .
           if        w-cnt-tus-acc-tes    not  = spaces
                     go to acc-tes-reg-999.
      ...
      *              * Protocollo ordine                               *
      *              *-------------------------------------------------*
           perform   vis-orf-prt-000      thru vis-orf-prt-999        .
      *              *-------------------------------------------------*
      *              * Progressivo riga ordine                         *
      *              *-------------------------------------------------*
           perform   vis-orf-prg-000      thru vis-orf-prg-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     vis-tes-reg-999.
      ...
      *              * Protocollo ordine                               *
      *              *-------------------------------------------------*
           perform   pmt-orf-prt-000      thru pmt-orf-prt-999        .
      *              *-------------------------------------------------*
      *              * Progressivo riga ordine                         *
      *              *-------------------------------------------------*
           perform   pmt-orf-prg-000      thru pmt-orf-prg-999        .
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     pmt-tes-reg-999.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Progressivo riga ordine       *
      *    *-----------------------------------------------------------*
       pmt-orf-prg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           move      rf-bfr-num-prt       to   w-acc-num-prt          .
           move      rf-bfr-num-prg       to   w-acc-num-prg          .
      *              *-------------------------------------------------*
      *              * Lettura archivio [bfr]                          *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-acc-num-prt        to   rf-bfr-num-prt         .
           move      w-acc-num-prg        to   rf-bfr-num-prg         .
           move      "pgm/bfo/fls/ioc/obj/iofbfr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Rewrite record [bfr]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-bfr-000      thru rew-rec-bfr-999        .
       scr-mov-fil-999.
           exit.
