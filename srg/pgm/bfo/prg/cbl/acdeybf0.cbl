      ...
      *                                   Fase:                        *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 29/01/92    *
      ...
      *                                                                *
      *              Input  : w-cod-des-ybf-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-ybf-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-ybf-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-ybf-cod : codice tipo movim.   *
      *                                                                *
      *                       w-cod-des-ybf-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-ybf-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-ybf-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-ybf-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-ybf-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-ybf-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-ybf-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-ybf-cod : codice tipo movim.   *
      ...
      *    *===========================================================*
      *    * Link-area per accettazione tipo movimento bolla fornitore *
      *    *-----------------------------------------------------------*
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-ybf
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-ybf-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-ybf-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-ybf-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-ybf-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-ybf-ope    =    "A+" or
                     w-cod-des-ybf-ope    =    "I+" or
                     w-cod-des-ybf-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-ybf-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-cod-des-ybf-cod    to   w-cod-des-ybf-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-ybf-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-ybf-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-ybf-s90    to   v-ufk                  .
           move      w-cod-des-ybf-lin    to   v-lin                  .
           move      w-cod-des-ybf-pos    to   v-pos                  .
           move      w-cod-des-ybf-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-ybf-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-ybf-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-ybf-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-ybf-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-ybf-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-ybf-cod    to   w-cod-des-ybf-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-ybf-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-ybf-dln    =    zero or
                     w-cod-des-ybf-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      w-cod-des-ybf-dln    to   v-lin                  .
           move      w-cod-des-ybf-dps    to   v-pos                  .
      ...
      *                          *-------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-tmb-dup    to   rf-ybf-des-key         .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-ybf-des-key       >    w-aux-cde-tmb-dmx
                     go to aco-800.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      rf-ybf-cod-tmb       to   w-aux-cde-tmb-bco
                                              (w-aux-cde-tmb-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione tipo movimento      *
      *                              *---------------------------------*
           move      rf-ybf-des-tmb       to   w-aux-cde-tmb-bde
                                              (w-aux-cde-tmb-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      w-aux-cde-tmb-bco
                    (w-aux-cde-tmb-bix)   to   w-cod-des-ybf-cod      .
      *                              *---------------------------------*
