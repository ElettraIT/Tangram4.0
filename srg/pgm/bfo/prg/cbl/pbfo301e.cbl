      ...
      *                                                                *
      *                    Ricerca documenti in attesa di fattura      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-int-srt-inp-rnp          pic  9(11)                  .
      *        *-------------------------------------------------------*
      *        * Flag di documento da saltare                          *
      *        *-------------------------------------------------------*
           05  w-int-srt-inp-fds          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Flag di documento fatturato                           *
      *        *-------------------------------------------------------*
           05  w-int-srt-inp-fdf          pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per totale documento in valuta base            *
      *        *-------------------------------------------------------*
           05  w-int-srt-inp-tdo          pic s9(11)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per totale documento in valuta                 *
      *        *-------------------------------------------------------*
           05  w-int-srt-inp-tdv          pic s9(11)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      16                   to   w-cod-des-ybf-lin      .
           move      30                   to   w-cod-des-ybf-pos      .
           move      16                   to   w-cod-des-ybf-dln      .
      ...
      *    *-----------------------------------------------------------*
       int-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Inizializzazione numero protocollo in esame     *
      *              *-------------------------------------------------*
           move      zero                 to   w-int-srt-inp-rnp      .
      *              *-------------------------------------------------*
      *              * Start su file [bfr]                             *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Deviazione a seconda che sia a zero o   *
      *                      * no                                      *
      *                      *-----------------------------------------*
           if        rr-dtr-max           =    zero
                     go to int-srt-inp-112
           else      go to int-srt-inp-114.
       int-srt-inp-112.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       int-srt-inp-150.
      *                  *---------------------------------------------*
      *                  * Test su tipo movimento da ricercare         *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-num-doc           =    spaces
                     go to int-srt-inp-170.
           if        rf-bfr-num-doc       =    rr-num-doc
                     go to int-srt-inp-170
           else      go to int-srt-inp-100.
       int-srt-inp-170.
      *                  *---------------------------------------------*
      *                  * Test su data documento da ricercare         *
      *                  *---------------------------------------------*
           if        rr-dat-doc           =    zero
      ...
      *              *-------------------------------------------------*
           if        rf-bfr-num-prt       =    w-int-srt-inp-rnp
                     go to int-srt-inp-300.
      *                  *---------------------------------------------*
      *                  * Fine documento precedente                   *
      *                  *---------------------------------------------*
           perform   int-srt-inp-800      thru int-srt-inp-899        .
      *                  *---------------------------------------------*
      *                  * Aggiornamento numero protocollo in esame    *
      *                  *---------------------------------------------*
           move      rf-bfr-num-prt       to   w-int-srt-inp-rnp      .
      *                  *---------------------------------------------*
      *                  * Inizio documento attuale                    *
      *                  *---------------------------------------------*
           perform   int-srt-inp-700      thru int-srt-inp-799        .
       int-srt-inp-300.
      *              *-------------------------------------------------*
      *              * Se flag di documento da saltare attivo : rici-  *
      *              * clo                                             *
      *              *-------------------------------------------------*
           if        w-int-srt-inp-fds    not  = spaces
                     go to int-srt-inp-100.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       int-srt-inp-400.
      *              *-------------------------------------------------*
      *              * Normalizzazione flag di documento fatturato     *
      *              *-------------------------------------------------*
           if        w-int-srt-inp-fdf    not  =  spaces
                     move  spaces         to   w-int-srt-inp-fdf      .
      *              *-------------------------------------------------*
      ...
      *                      * ta base                                 *
      *                      *-----------------------------------------*
           add       rf-bfr-imp-rig       to   w-int-srt-inp-tdo      .
      ...
      *                      * ta                                      *
      *                      *-----------------------------------------*
           add       rf-bfr-imp-rig       to   w-int-srt-inp-tdv      .
      *                      *-----------------------------------------*
      *                      * Determinazione importo riga in valuta   *
      *                      * base                                    *
      *                      *-----------------------------------------*
      ...
      *                      * ta base                                 *
      *                      *-----------------------------------------*
           add       w-cvs-vlt-avb        to   w-int-srt-inp-tdo      .
           go to     int-srt-inp-450.
       int-srt-inp-450.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       int-srt-inp-700.
      *              *=================================================*
      *              * Sub-routine interna per inizio documento        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione flag di documento da salta- *
      *                  * re                                          *
      *                  *---------------------------------------------*
           move      spaces               to   w-int-srt-inp-fds      .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      s-pat               using f
                                               rf-bft                 .
      *                      *-----------------------------------------*
      *                      * Se record non trovato : attivazione     *
      *                      * flag di documento da saltare            *
      *                      *-----------------------------------------*
           if        f-sts                not  = e-not-err
                     move  "#"            to   w-int-srt-inp-fds      .
      *                  *---------------------------------------------*
      *                  * Test su tipo movimento per fatturazione     *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se test non superato : attivazione flag *
      *                      * di documento da saltare                 *
      *                      *-----------------------------------------*
           if        rf-bft-int-ftr       not  = 02
                     move  "#"            to   w-int-srt-inp-fds      .
      *              *-------------------------------------------------*
      *              * Inizializzazione totali documento               *
      *              *-------------------------------------------------*
           move      zero                 to   w-int-srt-inp-tdo      .
           move      zero                 to   w-int-srt-inp-tdv      .
      *              *-------------------------------------------------*
      *              * Inizializzazione flag di documento fatturato    *
      *              *-------------------------------------------------*
           move      "#"                  to   w-int-srt-inp-fdf      .
       int-srt-inp-799.
           exit.
       int-srt-inp-800.
      *              *=================================================*
      *              * Sub-routine interna per fine documento          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se primo documento incontrato : uscita      *
      *                  *---------------------------------------------*
           if        w-int-srt-inp-rnp    =    zero
                     go to int-srt-inp-899.
      *                  *---------------------------------------------*
      *                  * Se flag di documento da saltare attivo : u- *
      *                  * scita                                       *
      *                  *---------------------------------------------*
           if        w-int-srt-inp-fds    not  = spaces
                     go to int-srt-inp-899.
      *                  *---------------------------------------------*
      *                  * Se flag di documento fatturato attivo : u-  *
      *                  * scita                                       *
      *                  *---------------------------------------------*
           if        w-int-srt-inp-fdf    not  = spaces
                     go to int-srt-inp-899.
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-bft-cod-tmb       to   srt-cod-tmb            .
           move      rf-bft-sgl-vpf       to   srt-sgl-vpf            .
           move      rf-bft-dec-vpf       to   srt-dec-vpf            .
           move      w-int-srt-inp-tdo    to   srt-tot-doc            .
           move      w-int-srt-inp-tdv    to   srt-tiv-doc            .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-cnt-qry-flg-int    not  = spaces
                     go to qry-fin-cic-999.
      *                      *-----------------------------------------*
      *                      * A stampa valore totale generale         *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-int      .
      *              *-------------------------------------------------*
      *              * Normalizzazione totali per fornitore            *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Azzeramento totale documenti stampati per for-  *
      *              * nitore                                          *
      *              *-------------------------------------------------*
           move      zero                 to   w-tot-doc-stp          .
      *              *-------------------------------------------------*
      *              * Aggiornamento totale fornitori stampati         *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       qry-ini-lr1-100.
      *                  *---------------------------------------------*
      *                  * Se e' il primo fornitore si salta comunque  *
      ...
      *                      *-----------------------------------------*
           if        w-cnt-qry-flg-int    not  = spaces
                     go to qry-fin-lr1-999.
      *                      *-----------------------------------------*
      *                      * A stampa valore totale fornitore        *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-int      .
      *              *-------------------------------------------------*
      *              * Incremento numero documenti stampati per forni- *
      *              * tore                                            *
      *              *-------------------------------------------------*
           if        w-tot-doc-stp        <    99999
                     add  1               to   w-tot-doc-stp          .
      *              *-------------------------------------------------*
      *              * Aggiornamento sigla valuta fornitore            *
      *              *-------------------------------------------------*
           if        srt-sgl-vpf          not  = w-tot-fnt-vlt
                     move  spaces         to   w-tot-fnt-vlt          .
      *              *-------------------------------------------------*
      *              * Aggiornamento totale fornitore                  *
      *              *-------------------------------------------------*
           add       srt-tot-doc          to   w-tot-fnt-tot          .
           add       srt-tiv-doc          to   w-tot-fnt-tiv          .
      *              *-------------------------------------------------*
      *              * Test se numero linee residue sufficienti        *
      *              *-------------------------------------------------*
           if        v-res                >    1
      ...
      *                      *-----------------------------------------*
           move      srt-dpz-fnt          to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Deviazione a seconda se documento in    *
      *                      * valuta base o no                        *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
           if        srt-tot-doc          >    999999999 or
                     srt-tot-doc          <   -999999999
                     move  11             to   v-car
      ...
      *                          *-------------------------------------*
           move      "PF"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
           if        srt-tiv-doc          >    999999999 or
                     srt-tiv-doc          <   -999999999
                     move  11             to   v-car
           else      move  09             to   v-car                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Assemblaggio e allineamento a destra        *
      *                  *---------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      w-stp-val-tot-pmt    to   w-all-str-cat (1)      .
      ...
      *
           ...
           move      ")"                  to   w-all-str-cat (2)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   w-stp-val-tot-vvb      .
      *                  *---------------------------------------------*
      *                  * Editing totale in valuta                    *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "V"                  to   v-tip                  .
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Assemblaggio e allineamento  destra         *
      *                  *---------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      05                   to   w-all-str-num          .
           move      w-stp-val-tot-pmt    to   w-all-str-cat (1)      .
           move      w-stp-val-tot-vvb    to   w-all-str-cat (2)      .
           move      ":"                  to   w-all-str-cat (3)      .
           move      w-stp-val-tot-vlt    to   w-all-str-cat (4)      .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "     Fornitore     Tipo  Data reg. Protoc.    Nume
      -              "ro     Data       Importo     "                
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
