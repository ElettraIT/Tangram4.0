      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pbfo3021:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "STAMPA ELENCO DOCUMENTI DI ENTRATA MERCE"       .
           ...
           05  w-exp-tip-arc.
               ...
               10  w-exp-tip-arc-tbl-r redefines
                   ...
                   15  w-exp-tip-arc-ele occurs 05
                                          pic  x(10)                  .
      *        *-------------------------------------------------------*
      *        * Work per : Si/no controllo protocolli di magazzino    *
      *        *-------------------------------------------------------*
           05  w-exp-snx-cpm.
               10  w-exp-snx-cpm-num      pic  9(02)       value 2    .
               10  w-exp-snx-cpm-lun      pic  9(02)       value 02   .
               10  w-exp-snx-cpm-tbl.
                   15  filler             pic  x(02) value "No"       .
                   15  filler             pic  x(02) value "Si"       .
      *        *-------------------------------------------------------*
      *        * Work per : Si/no controllo spunte                     *
      *        *-------------------------------------------------------*
           05  w-exp-snx-csp.
      ...
      *                  * Si/no controllo protocolli di magazzino     *
      *                  *---------------------------------------------*
           perform   acc-snx-cpm-000      thru acc-snx-cpm-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      15                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Controllo su protocolli di :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *              *-------------------------------------------------*
           ...
           move      13                   to   w-cod-mne-dcf-lin      .
           move      30                   to   w-cod-mne-dcf-pos      .
           move      13                   to   w-cod-mne-dcf-rln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      13                   to   w-cod-mne-dcc-lin      .
           move      30                   to   w-cod-mne-dcc-pos      .
           move      13                   to   w-cod-mne-dcc-rln      .
      ...
      *              *-------------------------------------------------*
           ...
           move      13                   to   w-cod-cod-dpz-lin      .
           move      30                   to   w-cod-cod-dpz-pos      .
           move      13                   to   w-cod-cod-dpz-dln      .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no controllo protocolli           *
      *    *-----------------------------------------------------------*
       acc-snx-cpm-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-cpm-lun    to   v-car                  .
           move      w-exp-snx-cpm-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      15                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-cpm-tbl    to   v-txt                  .
      *
           if        rr-snx-cpm           =    "N"
                     move  01             to   v-num
           else if   rr-snx-cpm           =    "S"
                     move  02             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-cpm-999.
       acc-snx-cpm-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   rr-snx-cpm
           else if   v-num                =    02
                     move  "S"            to   rr-snx-cpm
           else      move   spaces        to   rr-snx-cpm             .
       acc-snx-cpm-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-snx-cpm           =    spaces
                     go to acc-snx-cpm-100.
       acc-snx-cpm-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/no controllo protocolli              *
      *    *-----------------------------------------------------------*
       vis-snx-cpm-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/no controllo spunte               *
      *    *-----------------------------------------------------------*
       acc-snx-csp-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   rr-snx-csp
           else if   v-num                =    02
                     move  "S"            to   rr-snx-csp
           else      move   spaces        to   rr-snx-csp             .
       acc-snx-csp-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-snx-csp           =    spaces
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/no controllo spunte                  *
      *    *-----------------------------------------------------------*
       vis-snx-csp-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      zero                 to   rr-cod-arc             .
           move      spaces               to   rr-cod-arc-des         .
           move      spaces               to   rr-snx-cpm             .
           move      spaces               to   rr-snx-csp             .
       nor-ric-sel-999.
           exit.
