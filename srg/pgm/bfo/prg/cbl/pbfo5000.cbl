      ...
      *                       Ultima revisione:    NdK del 26/05/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma di stampa bfo500 *
      *                    Stampa distinte di invio                    *
      *                                                                *
      *                    Le overlay eseguono le seguenti funzioni :  *
      *                    ------------------------------------------  *
      *                    pbfo5000 - Main                             *
      *                    pbfo500a - Creazione Distinta di invio      *
      *                    pbfo500b - Stampa Distinta                  *
      *                    pbfo500m - Manutenzione distinta            *
      *                    pbfo500c - Verifica spunte documenti        *
      *                    pbfo500f - Stampa documenti della distinta  *
      *                    pbfo500e - Cancellazione Distinta           *
      *                                                                *
      *================================================================*
      ...
      *        * ELETTRA                                               *
      *        *-------------------------------------------------------*
           05  w-def-tmo-bfo              pic  x(05) value "BFO  "    .
      *        *-------------------------------------------------------*
      *        * Codice fornitore                                      *
      *        *                                                       *
      *        * ELETTRA                                               *
      *        *-------------------------------------------------------*
           05  w-def-cod-fnt              pic  9(07) value 0003239    .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-ope.
               10  w-exp-tip-ope-num      pic  9(02)       value 6    .
               10  w-exp-tip-ope-lun      pic  9(02)       value 42   .
               10  w-exp-tip-ope-tbl.
                   15  filler             pic  x(42) value
                      "1. Creazione distinta documenti fornitori "    .
                   15  filler             pic  x(42) value
                      "2. Stampa distinta                        "    .
                   15  filler             pic  x(42) value
                      "3. Manutenzione distinta                  "    .
                   15  filler             pic  x(42) value
                      "4. Verifica spunte documenti              "    .
                   15  filler             pic  x(42) value
                      "5. Stampa documenti della distinta        "    .
                   15  filler             pic  x(42) value
                      "6. Eliminazione distinta                  "    .
      *        *-------------------------------------------------------*
      *        * Work per : Selezione su documenti                     *
      *        *-------------------------------------------------------*
           05  w-exp-sel-doc.
               10  w-exp-sel-doc-num      pic  9(02)       value 3    .
               10  w-exp-sel-doc-lun      pic  9(02)       value 40   .
               10  w-exp-sel-doc-tbl.
                   15  filler             pic  x(40) value
                            "solo documenti Verificati               ".
                   15  filler             pic  x(40) value
                            "solo documenti Da verificare            ".
                   15  filler             pic  x(40) value
                            "Tutti i documenti                       ".
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tip-ope           =    01
                     move  "pgm/bfo/prg/obj/pbfo500a                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    02
                     move  "pgm/bfo/prg/obj/pbfo500b                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    03
                     move  "pgm/bfo/prg/obj/pbfo500m                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    04
                     move  "pgm/bfo/prg/obj/pbfo500c                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    05
                     move  "pgm/bfo/prg/obj/pbfo500f                "
                                          to   i-exe-pat
           else if   rr-tip-ope           =    06
                     move  "pgm/bfo/prg/obj/pbfo500e                "
                                          to   i-exe-pat              .
           call      i-exe-pat                                        .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   acc-tmo-bfo-000      thru acc-tmo-bfo-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Nickname distinta                           *
      *                  *---------------------------------------------*
           perform   acc-nik-nam-000      thru acc-nik-nam-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
       ...
       acc-ric-sel-600.
      *                  *---------------------------------------------*
      *                  * Selezioni su documenti per la stampa        *
      *                  *---------------------------------------------*
           perform   acc-sel-doc-000      thru acc-sel-doc-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           perform   vis-tmo-bfo-000      thru vis-tmo-bfo-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione tipo movimento da stampare,     *
      *              * descrizione                                     *
      *              *-------------------------------------------------*
           perform   vis-tmo-bfo-des-000  thru vis-tmo-bfo-des-999    .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      18                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Nickname distinta          :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Selezione su documenti                          *
      *              *-------------------------------------------------*
           perform   pmt-sel-doc-000      thru pmt-sel-doc-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Selezione su documenti        *
      *    *-----------------------------------------------------------*
       pmt-sel-doc-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-tip-ope           =    05
                     go to pmt-sel-doc-200.
       pmt-sel-doc-100.
      *              *-------------------------------------------------*
      *              * Normalizzazione prompt                          *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
      ...
      *                      *-----------------------------------------*
      *                      * Valore non ammesso, a meno che non si   *
      *                      * sia in Up                               *
      *                      *-----------------------------------------*
           if        v-key                =    "UP  "
                     go to acc-num-dst-600
           else      go to acc-num-dst-100.
       acc-num-dst-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-tip-ope           not  = 01
                     go to acc-tmo-bfo-999.
      *                  *---------------------------------------------*
      *                  * Eventuale default                           *
      *                  *---------------------------------------------*
           if        rr-tip-mov           not  = spaces
                     go to acc-tmo-bfo-100.
           move      w-def-tmo-bfo        to   rr-tip-mov             .
       acc-tmo-bfo-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           ...
           move      11                   to   w-cod-des-ybf-lin      .
           move      30                   to   w-cod-des-ybf-pos      .
           move      11                   to   w-cod-des-ybf-dln      .
       ...
       acc-tmo-bfo-110.
           ...
           if        w-cod-des-ybf-ope    =    "F+"
                     go to acc-tmo-bfo-115.
           if        w-cod-des-ybf-ope    =    "AC"
                     go to acc-tmo-bfo-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-tmo-bfo-115.
           perform   cod-des-ybf-foi-000  thru cod-des-ybf-foi-999    .
           go to     acc-tmo-bfo-110.
       acc-tmo-bfo-120.
      ...
      *                  *---------------------------------------------*
           if        rr-cod-fnt           not  = zero
                     go to acc-cod-fnt-050.
           move      w-def-cod-fnt        to   rr-cod-fnt             .
       acc-cod-fnt-050.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Nickname distinta                    *
      *    *-----------------------------------------------------------*
       acc-nik-nam-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        rr-nik-nam           not  = spaces
                     go to acc-nik-nam-600.
           if        v-key                =    "UP  "
                     go to acc-nik-nam-600
           else      go to acc-nik-nam-100.
       acc-nik-nam-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  * Test se campo da accettare                  *
      *                  *---------------------------------------------*
           if        rr-tip-ope           not  = 05
                     go to acc-sel-doc-999.
       acc-sel-doc-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sel-doc-lun    to   v-car                  .
           move      w-exp-sel-doc-num    to   v-ldt                  .
           move      "VDT#"               to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      20                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-sel-doc-tbl    to   v-txt                  .
           move      rr-sel-doc           to   v-num                  .
           move      "DOWN"               to   v-pfk (02)             .
           if        w-cnt-sts-imp-ric    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      ...
      *                  * Se zero : reimpostazione                    *
      *                  *---------------------------------------------*
           if        rr-sel-doc           not  = zero
                     go to acc-sel-doc-600.
           if        v-key                =    "UP  "
                     go to acc-sel-doc-600
           else      go to acc-sel-doc-100.
       acc-sel-doc-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Test su numero distinta a zero              *
      *                  *---------------------------------------------*
           if        rr-num-dst           not  = zero
      ...
      *                  *---------------------------------------------*
           if        w-let-arc-dst-flg    =    spaces
                     go to tdo-ric-sel-100.
           move      "Numero distinta non trovato!                      
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              "               "    to   w-err-box-err-msg      .
       ...
       tdo-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Controllo su nickname distinta                  *
      *              *-------------------------------------------------*
           if        rr-tip-ope           not  = 01
                     go to tdo-ric-sel-300.
           if        rr-nik-nam           not  = spaces
                     go to tdo-ric-sel-300.
           move      "Assegnare un Nickname alla distinta !             
      -              "               "    to   w-err-box-err-msg      .
           go to     tdo-ric-sel-900.
       tdo-ric-sel-300.
       tdo-ric-sel-800.
      ...
      *              *-------------------------------------------------*
      *              * Regolarizzazione selezione su documenti         *
      *              *-------------------------------------------------*
           if        rr-sel-doc           =    zero
                     move  03             to   rr-sel-doc             .
       reg-ric-sel-999.
           exit.
      ...
      *
           ...
           move      zero                 to   rr-prt-max             .
      *
           move      spaces               to   rr-nik-nam             .
           move      zero                 to   rr-sel-doc             .
       nor-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Routine di lettura archivio [bfe]                         *
      *    *-----------------------------------------------------------*
       let-arc-dst-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-let-arc-dst-prt    to   rf-bfe-num-dst         .
           move      "pgm/bfo/fls/ioc/obj/iofbfe"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
       ...
       let-arc-dst-300.
      *              *-------------------------------------------------*
      *              * Max su [bfe], se non superato : ad uscita       *
      *              *-------------------------------------------------*
           if        rf-bfe-num-dst       not  = w-let-arc-dst-prt
                     go to let-arc-dst-900.
       let-arc-dst-400.
      *              *-------------------------------------------------*
      *              * Preparazione flag di uscita                     *
