      ...
      *                                   Fase:    bfo990              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 25/08/95    *
      *                       Ultima revisione:    NdK del 13/09/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Update bolle di acquisto                    *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  Update testata documenti di acquisto  "       .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Data registrazione           *
      *    *-----------------------------------------------------------*
       acc-dat-reg-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo testata : Data registrazione        *
      *    *-----------------------------------------------------------*
       vis-dat-reg-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
      *              * Salvataggio valori per la lettura               *
      *              *-------------------------------------------------*
           move      rf-bft-num-prt       to   w-acc-num-prt          .
      *              *-------------------------------------------------*
      *              * Lettura archivio [bft]                          *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
      ...
      *                      * Rewrite record [bft]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-bft-000      thru rew-rec-bft-999        .
       scr-mov-fil-999.
           exit.
