      ...
      *                                                                *
      *                    Manutenzione distinta documenti di entrata  *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [bfe]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-bfe.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-bfe-prt      pic  9(09)                  .
      *            *---------------------------------------------------*
      *            * Progressivo                                       *
      *            *---------------------------------------------------*
               10  w-cmp-rec-bfe-prg      pic  9(05)                  .
      ...
      *                  *---------------------------------------------*
           move      rf-bfe-num-doc       to   w-lin-imm-num-doc      .
       vis-lin-cor-540.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-bfe-num-doc       to   w-all-str-alf          .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-bfe-tmo-doc       to   w-all-str-cat (1)      .
      ...
      *                  *---------------------------------------------*
       ...
       stp-srt-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [bfe]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/bfo/fls/ioc/obj/iofbfe"
                                          to   s-pat                  .
      ...
      *                      * Data documento                          *
      *                      *-----------------------------------------*
           move      rf-bfe-dat-doc       to   srt-dat-doc            .
      *                      *-----------------------------------------*
      *                      * Protocollo documento                    *
      *                      *-----------------------------------------*
      ...
      *                      * Codice fornitore                        *
      *                      *-----------------------------------------*
           move      rf-bfe-cod-arc       to   srt-cod-fnt            .
      *                  *---------------------------------------------*
      *                  * Record [bfe]                                *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                  * Record [bfe]                                *
      *                  *---------------------------------------------*
           move      rf-bfe               to   w-rig-rec-bfe          .
           move      rf-bfe-cod-arc       to   w-rig-cod-fnt          .
           move      rf-bfe-dpz-arc       to   w-rig-dpz-fnt          .
      *
           if        rf-bfe-flg-ain       =    spaces
                     move  "S"            to   w-rig-snx-inv
           else      move  "N"            to   w-rig-snx-inv          .
      *
______*    move      rf-bfe-eml-ind       to   w-rig-ind-eml          .
      *
______*    if        rf-bfe-eml-ind       =    spaces
______*              move  "N"            to   w-rig-snx-inv          .
      *                  *---------------------------------------------*
      *                  * Valori indiretti                            *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      * Determinazione status distinta          *
      *                      *-----------------------------------------*
______*    if        rf-bfe-dat-inv       not  = zero
______*              move  "#"            to   w-det-sts-dst-flg
______*    else      move  spaces         to   w-det-sts-dst-flg      .
       car-fil-rap-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           else      move  "#"            to   rf-bfe-flg-ain         .
      *              *-------------------------------------------------*
      *              * Aggiornamento indirizzo mail                    *
      *              *-------------------------------------------------*
______*    if        w-rig-ind-eml        not  = spaces
______*              move  w-rig-ind-eml  to   rf-bfe-eml-ind         .
      *              *-------------------------------------------------*
      *              * Update record [bfe]                             *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "pgm/bfo/prg/obj/pbfo5002"                       .
       cnc-rlt-sup-999.
           exit.
