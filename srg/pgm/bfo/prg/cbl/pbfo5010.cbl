      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  INTERROGAZIONE SU DISTINTE DOCUMENTI  "       .
      ...
      *            * Nickname                                          *
      *            *---------------------------------------------------*
               10  w-buf-l01-nik-nam      pic  x(05)                  .
      *            *---------------------------------------------------*
      *            * Numero documenti                                  *
      *            *---------------------------------------------------*
               10  w-buf-l01-ctr-ele      pic  9(05)                  .
               10  w-buf-l01-ctr-spn      pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Status distinta                                   *
      *            *---------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       qry-str-ini-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [bfe]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATSYS    "         to   f-key                  .
           move      w-det-nrg-dat-dtd    to   rf-bfe-ide-dat         .
      ...
      *    *-----------------------------------------------------------*
       qry-cmp-rot-000.
           move      rf-bfe-num-dst       to   w-rot-l01-num-dst      .
       qry-cmp-rot-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-bfe-num-dst       to   w-buf-l01-num-dst      .
           move      rf-bfe-dat-reg       to   w-buf-l01-dat-reg      .
           move      rf-bfe-nik-nam       to   w-buf-l01-nik-nam      .
           move      zero                 to   w-buf-l01-ctr-ele      .
           move      zero                 to   w-buf-l01-ctr-spn      .
       qry-ini-lr1-999.
           exit.
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      27                   to   v-pos                  .
           move      w-buf-l01-nik-nam    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Editing eventuali documenti spuntati        *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      05                   to   v-car                  .
           ...
           move      w-buf-l01-ctr-spn    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Assemblaggio                                *
      ...
      *
           if        rf-bfe-flg-apr       not  = spaces
                     add  1               to   w-buf-l01-ctr-spn      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "  INTERROGAZIONE SU DISTINTE DOCUMENTI  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
