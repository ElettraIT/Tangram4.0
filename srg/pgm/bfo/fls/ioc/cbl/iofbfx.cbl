      ...
      *    *===========================================================*
      *    * Record logico file [bfx]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/bfo/fls/rec/rfbfx"                          .

      ******************************************************************
       Procedure Division                using f rf-bfx               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-bfx                 .
           move      zero                 to   rf-bfx-num-prt         .
           move      zero                 to   rf-bfx-num-prg         .
           move      zero                 to   rf-bfx-tip-rec         .
           move      spaces               to   rf-bfx-des-400         .
       nor-rec-log-999.
           exit.
      ...
      *                  *---------------------------------------------*
           if        rf-bfx-tip-rec       =    01
                     go to cmp-log-fis-110
           else if   rf-bfx-tip-rec       =    11
      ...
      *                  * Tipo record : 01                            *
      *                  *---------------------------------------------*
           move      rf-bfx-rec-001       to   fil-rec-001            .
           go to     cmp-log-fis-999.
       cmp-log-fis-120.
      *                  *---------------------------------------------*
      *                  * Tipo record : 11                            *
      *                  *---------------------------------------------*
           move      rf-bfx-des-400       to   fil-des-400            .
           go to     cmp-log-fis-999.
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfx-num-prt       to   fil-num-prt            .
           move      rf-bfx-num-prg       to   fil-num-prg            .
           move      rf-bfx-tip-rec       to   fil-tip-rec            .
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-bfx                 .
           move      fil-num-prt          to   rf-bfx-num-prt         .
           move      fil-num-prg          to   rf-bfx-num-prg         .
           move      fil-tip-rec          to   rf-bfx-tip-rec         .
       dec-fis-log-100.
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo record      *
      *                  *---------------------------------------------*
      ...
      *                  * Tipo record : 01                            *
      *                  *---------------------------------------------*
           move      fil-rec-001          to   rf-bfx-rec-001         .
           go to     dec-fis-log-999.
       dec-fis-log-120.
      *                  *---------------------------------------------*
      *                  * Tipo record : 11                            *
      *                  *---------------------------------------------*
           move      fil-des-400          to   rf-bfx-des-400         .
           go to     dec-fis-log-999.
       dec-fis-log-999.
           exit.
