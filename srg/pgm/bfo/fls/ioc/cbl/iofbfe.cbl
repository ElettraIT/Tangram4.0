      ...
      *    *===========================================================*
      *    * Record logico file [bfe]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/bfo/fls/rec/rfbfe"                          .

      ******************************************************************
       Procedure Division                using f rf-bfe               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-bfe                 .
           move      zero                 to   rf-bfe-ide-dat         .
           move      spaces               to   rf-bfe-ide-ute         .
           move      spaces               to   rf-bfe-ide-fas         .
           move      zero                 to   rf-bfe-num-dst         .
           move      zero                 to   rf-bfe-num-prg         .
           move      zero                 to   rf-bfe-dat-reg         .
           move      spaces               to   rf-bfe-tip-arc         .
           move      zero                 to   rf-bfe-cod-arc         .
           move      spaces               to   rf-bfe-dpz-arc         .
           move      spaces               to   rf-bfe-nik-nam         .
           move      spaces               to   rf-bfe-tmo-doc         .
           move      zero                 to   rf-bfe-dat-doc         .
           move      spaces               to   rf-bfe-num-doc         .
           move      zero                 to   rf-bfe-prt-doc         .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-bfe-ide-ute       to   fil-ide-ute            .
           move      rf-bfe-ide-fas       to   fil-ide-fas            .
           move      rf-bfe-dpz-arc       to   fil-dpz-arc            .
           move      rf-bfe-nik-nam       to   fil-nik-nam            .
           move      rf-bfe-tmo-doc       to   fil-tmo-doc            .
           move      rf-bfe-dat-doc       to   fil-dat-doc            .
           move      rf-bfe-num-doc       to   fil-num-doc            .
           move      rf-bfe-flg-apr       to   fil-flg-apr            .
           move      rf-bfe-flg-ain       to   fil-flg-ain            .
           move      rf-bfe-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfe-num-dst       to   fil-num-dst            .
           move      rf-bfe-num-prg       to   fil-num-prg            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfe-ide-dat       to   fil-ide-dat            .
           move      rf-bfe-num-dst       to   fil-num-dst-2          .
           move      rf-bfe-num-prg       to   fil-num-prg-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfe-tip-arc       to   fil-tip-arc            .
           move      rf-bfe-cod-arc       to   fil-cod-arc            .
           move      rf-bfe-dat-reg       to   fil-dat-reg            .
           move      rf-bfe-num-dst       to   fil-num-dst-3          .
           move      rf-bfe-num-prg       to   fil-num-prg-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfe-prt-doc       to   fil-prt-doc            .
           move      rf-bfe-num-dst       to   fil-num-dst-4          .
           move      rf-bfe-num-prg       to   fil-num-prg-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-bfe                 .
           move      fil-ide-dat          to   rf-bfe-ide-dat         .
           move      fil-ide-ute          to   rf-bfe-ide-ute         .
           move      fil-ide-fas          to   rf-bfe-ide-fas         .
           move      fil-num-dst          to   rf-bfe-num-dst         .
           move      fil-num-prg          to   rf-bfe-num-prg         .
           move      fil-dat-reg          to   rf-bfe-dat-reg         .
           move      fil-tip-arc          to   rf-bfe-tip-arc         .
           move      fil-cod-arc          to   rf-bfe-cod-arc         .
           move      fil-dpz-arc          to   rf-bfe-dpz-arc         .
           move      fil-nik-nam          to   rf-bfe-nik-nam         .
           move      fil-tmo-doc          to   rf-bfe-tmo-doc         .
           move      fil-dat-doc          to   rf-bfe-dat-doc         .
           move      fil-num-doc          to   rf-bfe-num-doc         .
           move      fil-prt-doc          to   rf-bfe-prt-doc         .
           move      fil-flg-apr          to   rf-bfe-flg-apr         .
           move      fil-flg-ain          to   rf-bfe-flg-ain         .
           move      fil-alx-exp          to   rf-bfe-alx-exp         .
       dec-fis-log-999.
           exit.
