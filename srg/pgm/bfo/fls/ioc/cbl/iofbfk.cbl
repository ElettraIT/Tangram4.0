      ...
      *    *===========================================================*
      *    * Record logico file [bfk]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/bfo/fls/rec/rfbfk"                          .

      ******************************************************************
       Procedure Division                using f rf-bfk               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-bfk                 .
           move      zero                 to   rf-bfk-num-prt         .
           move      zero                 to   rf-bfk-num-prg         .
           move      zero                 to   rf-bfk-num-prc         .
           move      spaces               to   rf-bfk-cts-prc         .
           move      zero                 to   rf-bfk-qta-prc         .
           move      zero                 to   rf-bfk-num-mag         .
           move      spaces               to   rf-bfk-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   z-key                  .
           move      rf-bfk-qta-prc       to   fil-qta-prc            .
           move      rf-bfk-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfk-num-prt       to   fil-num-prt            .
           move      rf-bfk-num-prg       to   fil-num-prg            .
           move      rf-bfk-num-prc       to   fil-num-prc            .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfk-num-prt       to   fil-num-prt-2          .
           move      rf-bfk-num-prc       to   fil-num-prc-2          .
           move      rf-bfk-num-prg       to   fil-num-prg-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfk-cts-prc       to   fil-cts-prc            .
           move      rf-bfk-num-prt       to   fil-num-prt-3          .
           move      rf-bfk-num-prc       to   fil-num-prc-3          .
           move      rf-bfk-num-prg       to   fil-num-prg-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfk-num-mag       to   fil-num-mag            .
           move      rf-bfk-cts-prc       to   fil-cts-prc-4          .
           move      rf-bfk-num-prt       to   fil-num-prt-4          .
           move      rf-bfk-num-prc       to   fil-num-prc-4          .
           move      rf-bfk-num-prg       to   fil-num-prg-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-bfk                 .
           move      fil-num-prt          to   rf-bfk-num-prt         .
           move      fil-num-prg          to   rf-bfk-num-prg         .
           move      fil-num-prc          to   rf-bfk-num-prc         .
           move      fil-cts-prc          to   rf-bfk-cts-prc         .
           move      fil-qta-prc          to   rf-bfk-qta-prc         .
           move      fil-num-mag          to   rf-bfk-num-mag         .
           move      fil-alx-exp          to   rf-bfk-alx-exp         .
       dec-fis-log-999.
           exit.
