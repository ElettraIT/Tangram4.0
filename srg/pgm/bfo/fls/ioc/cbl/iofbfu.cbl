      ...
      *    *===========================================================*
      *    * Record logico file [bfu]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/bfo/fls/rec/rfbfu"                          .

      ******************************************************************
       Procedure Division                using f rf-bfu               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-bfu                 .
           move      zero                 to   rf-bfu-num-prt         .
           move      zero                 to   rf-bfu-num-pro         .
           move      spaces               to   rf-bfu-cod-ubi         .
           move      zero                 to   rf-bfu-qta-ubi         .
           move      zero                 to   rf-bfu-prt-mag         .
           move      zero                 to   rf-bfu-drg-mag         .
           move      spaces               to   rf-bfu-alx-exp         .
       nor-rec-log-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      rf-bfu-num-prt       to   fil-num-prt            .
           move      rf-bfu-num-pro       to   fil-num-pro            .
           move      rf-bfu-cod-ubi       to   fil-cod-ubi            .
           move      rf-bfu-qta-ubi       to   fil-qta-ubi            .
           move      rf-bfu-prt-mag       to   fil-prt-mag            .
           move      rf-bfu-drg-mag       to   fil-drg-mag            .
           move      rf-bfu-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfu-num-prt       to   fil-num-prt-1          .
           move      rf-bfu-num-pro       to   fil-num-pro-1          .
           move      rf-bfu-cod-ubi       to   fil-cod-ubi-1          .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfu-num-pro       to   fil-num-pro-2          .
           move      rf-bfu-num-prt       to   fil-num-prt-2          .
           move      rf-bfu-cod-ubi       to   fil-cod-ubi-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-bfu-cod-ubi       to   fil-cod-ubi-3          .
           move      rf-bfu-num-pro       to   fil-num-pro-3          .
           move      rf-bfu-num-prt       to   fil-num-prt-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-bfu                 .
           move      fil-num-prt          to   rf-bfu-num-prt         .
           move      fil-num-pro          to   rf-bfu-num-pro         .
           move      fil-cod-ubi          to   rf-bfu-cod-ubi         .
           move      fil-qta-ubi          to   rf-bfu-qta-ubi         .
           move      fil-prt-mag          to   rf-bfu-prt-mag         .
           move      fil-drg-mag          to   rf-bfu-drg-mag         .
           move      fil-alx-exp          to   rf-bfu-alx-exp         .
       dec-fis-log-999.
           exit.
