      ...
      *            *---------------------------------------------------*
      *            * Chiave numero 04 : DATRSM                         *
      *            *---------------------------------------------------*
               10  fil-k04.
                   15  fil-ide-dat-4      pic  9(07)       comp-3     .
                   15  fil-cod-rsm-4      pic  9(05)       comp-3     .
      ...
      *        *-------------------------------------------------------*
           05  fil-dat.
               ...
               10  fil-num-dst            pic  9(11)       comp-3     .
      ...
      *            *---------------------------------------------------*
               10  pul-k04.
                   15  pul-ide-dat-4      pic  9(07)       comp-3     .
                   15  pul-cod-rsm-4      pic  9(05)       comp-3     .
      ...
      *        *-------------------------------------------------------*
           05  pul-dat.
               ...
               10  pul-num-dst            pic  9(11)       comp-3     .
      ...
      *    *===========================================================*
      *    * Record logico file [osd]                                  *
      *    *-----------------------------------------------------------*
           copy      "pgm/ods/fls/rec/rfosd"                          .

      ******************************************************************
       Procedure Division                using f rf-osd               .
      ******************************************************************
      ...
      *    *-----------------------------------------------------------*
       nor-rec-log-000.
           move      spaces               to   rf-osd                 .
           move      zero                 to   rf-osd-num-prt         .
           move      zero                 to   rf-osd-num-prg         .
           move      zero                 to   rf-osd-num-dst         .
           move      zero                 to   rf-osd-num-pro         .
           move      zero                 to   rf-osd-ide-dat         .
           move      zero                 to   rf-osd-cod-rsm         .
      ...
      *              *-------------------------------------------------*
           move      rf-osd-num-prt       to   fil-num-prt            .
           move      rf-osd-num-prg       to   fil-num-prg            .
           move      rf-osd-num-dst       to   fil-num-dst            .
           move      rf-osd-num-pro       to   fil-num-pro            .
           move      rf-osd-ide-dat       to   fil-ide-dat            .
           move      rf-osd-cod-rsm       to   fil-cod-rsm            .
           move      rf-osd-alx-exp       to   fil-alx-exp            .
       cmp-log-fis-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-osd-num-prt       to   fil-num-prt-1          .
           move      rf-osd-num-prg       to   fil-num-prg-1          .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-osd-num-dst       to   fil-num-dst-2          .
           move      rf-osd-num-prt       to   fil-num-prt-2          .
           move      rf-osd-num-prg       to   fil-num-prg-2          .
           go to     cmp-key-fis-999.
       cmp-key-fis-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-osd-num-pro       to   fil-num-pro-3          .
           move      rf-osd-num-dst       to   fil-num-dst-3          .
           move      rf-osd-num-prt       to   fil-num-prt-3          .
           move      rf-osd-num-prg       to   fil-num-prg-3          .
           go to     cmp-key-fis-999.
       cmp-key-fis-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-osd-ide-dat       to   fil-ide-dat-4          .
           move      rf-osd-cod-rsm       to   fil-cod-rsm-4          .
           move      rf-osd-num-prt       to   fil-num-prt-4          .
           move      rf-osd-num-prg       to   fil-num-prg-4          .
           go to     cmp-key-fis-999.
       cmp-key-fis-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       dec-fis-log-000.
           move      spaces               to   rf-osd                 .
           move      fil-num-prt          to   rf-osd-num-prt         .
           move      fil-num-prg          to   rf-osd-num-prg         .
           move      fil-num-dst          to   rf-osd-num-dst         .
           move      fil-num-pro          to   rf-osd-num-pro         .
           move      fil-ide-dat          to   rf-osd-ide-dat         .
           move      fil-cod-rsm          to   rf-osd-cod-rsm         .
           move      fil-alx-exp          to   rf-osd-alx-exp         .
       dec-fis-log-999.
           exit.
