      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Cancellazione distinta ordini di spedizione *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "CANCELLAZIONE DISTINTA ORDINI SPEDIZIONE"       .
      ...
      *        *-------------------------------------------------------*
           05  w-wrk-buf.
               10  w-wrk-buf-ele  occurs 99.
                   15  w-wrk-buf-prt      pic  9(11)                  .
                   15  w-wrk-buf-rag      pic  x(15)                  .
               10  w-wrk-buf-max          pic  9(03) value 99         .
               10  w-wrk-buf-ctr          pic  9(03)                  .
               10  w-wrk-buf-c01          pic  9(03)                  .
               10  w-wrk-rot-prt          pic  9(11)                  .
      ...
      *                  * Numero ordine                               *
      *                  *---------------------------------------------*
           perform   acc-prt-ost-000      thru acc-prt-ost-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Se a zero, vengono eliminati dalla distinta tutti 
      -              "gli ordini della lista"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       acc-prt-ost-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-prt-ost-999.
       acc-prt-ost-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-prt-ost             .
       acc-prt-ost-300.
      *              *-------------------------------------------------*
      *              * Se Find                                         *
      *              *-------------------------------------------------*
           if        v-key                not  = "FIND"
                     go to acc-prt-ost-400.
      *                  *---------------------------------------------*
      *                  * Box di espansione per elenco protocolli     *
      *                  *---------------------------------------------*
           perform   box-exp-prt-000      thru box-exp-prt-999        .
      *                  *---------------------------------------------*
      *                  * A reimpostazione                            *
      *                  *---------------------------------------------*
           go to     acc-prt-ost-100.
       acc-prt-ost-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rr-prt-ost           to   w-wrk-nos-acc          .
      *
      ...
      *
           ...
           move      w-wrk-nos-int        to   rr-prt-ost             .
       reg-ric-sel-200.
      *              *-------------------------------------------------*
      *              * Si/No cancellazione spunte                      *
      *              *-------------------------------------------------*
      ...
      *              * Scansione [osd]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-osd-000  thru stp-srt-inp-osd-999    .
      *              *-------------------------------------------------*
      *              * Scansione [hdr]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-hdr-000  thru stp-srt-inp-hdr-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-prt-dst           to   rf-osd-num-dst         .
      ...
      *                  * Test su protocollo distinta                 *
      *                  *---------------------------------------------*
           if        rf-osd-num-dst       not  = rr-prt-dst
                     go to stp-srt-inp-osd-900.
       stp-srt-inp-osd-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-prt-ost           =    zero
                     go to stp-srt-inp-osd-600.
           if        rf-osd-num-prt       not  = rr-prt-ost
                     go to stp-srt-inp-osd-200.
       stp-srt-inp-osd-600.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      "osd"                to   srt-tip-rec            .
           move      rf-osd-num-prt       to   srt-num-key            .
           move      rf-osd-num-prg       to   srt-prg-key            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-prt-dst           to   rf-hdr-num-dst         .
      ...
      *                  * Test su protocollo distinta                 *
      *                  *---------------------------------------------*
           if        rf-hdr-num-dst       not  = rr-prt-dst
                     go to stp-srt-inp-hdr-900.
       stp-srt-inp-hdr-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record                            *
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      "hdr"                to   srt-tip-rec            .
           move      rf-hdr-num-dst       to   srt-num-key            .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-hdr-num-dst       to   srt-num-dst            .
           move      rf-hdr-num-pro       to   srt-num-pro            .
           move      rf-hdr-cod-ubi       to   srt-cod-ubi            .
       stp-srt-inp-hdr-700.
      *              *-------------------------------------------------*
      *              * Rilascio del record al Sort                     *
      *              *-------------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-hdr-200.
       stp-srt-inp-hdr-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-hdr-999.
       stp-srt-inp-hdr-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Cancellazione record [osd]                      *
      *              *-------------------------------------------------*
           perform   del-rec-osd-000      thru del-rec-osd-999        .
      *              *-------------------------------------------------*
      *              * Cancellazione record [hdr]                      *
      *              *-------------------------------------------------*
           perform   del-rec-hdr-000      thru del-rec-hdr-999        .
      *              *-------------------------------------------------*
      *              * Cancellazione spunte                            *
      *              *-------------------------------------------------*
           perform   agg-rec-osr-000      thru agg-rec-osr-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              * Test su tipo record                             *
      *              *-------------------------------------------------*
           if        srt-tip-rec          not  = "osd"
                     go to del-rec-osd-999.
       del-rec-osd-100.
      *              *-------------------------------------------------*
      *              * Composizione chiave primaria                    *
      *              *-------------------------------------------------*
           move      srt-num-prt          to   rf-osd-num-prt         .
           move      srt-num-prg          to   rf-osd-num-prg         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           if        rr-snx-cgm           not  = 02
                     go to del-rec-hdr-999.
      *              *-------------------------------------------------*
      *              * Test su tipo record                             *
      *              *-------------------------------------------------*
           if        srt-tip-rec          not  = "hdr"
                     go to del-rec-hdr-999.
       del-rec-hdr-100.
      *              *-------------------------------------------------*
      *              * Composizione chiave primaria                    *
      *              *-------------------------------------------------*
           move      srt-num-dst          to   rf-hdr-num-dst         .
           move      srt-num-pro          to   rf-hdr-num-pro         .
           move      srt-cod-ubi          to   rf-hdr-cod-ubi         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      srt-num-prt          to   rf-osr-num-prt         .
           move      srt-num-prg          to   rf-osr-num-prg         .
           move      "pgm/ods/fls/ioc/obj/iofosr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-hdr-drg-mag       to   l-mag-300-dat-reg      .
           move      rf-hdr-prt-mag       to   l-mag-300-num-prt      .
      ...
      *    *===========================================================*
      *    * Box per expand protocolli distinta                        *
      *    *-----------------------------------------------------------*
       box-exp-prt-000.
      *              *-------------------------------------------------*
      *              * Caricamento preliminare protocolli              *
      *              *-------------------------------------------------*
           perform   box-exp-prt-osd-000  thru box-exp-prt-osd-999    .
       box-exp-prt-030.
      *              *-------------------------------------------------*
      *              * Test preliminare                                *
      *              *-------------------------------------------------*
           if        w-wrk-buf-ctr        not  > zero
                     go to box-exp-prt-900.
       box-exp-prt-050.
      *              *-------------------------------------------------*
      ...
      *                  * Inizio ciclo                                *
      *                  *---------------------------------------------*
           move      zero                 to   w-wrk-buf-c01          .
       box-exp-prt-200.
           add       1                    to   w-wrk-buf-c01          .
           if        w-wrk-buf-c01        >    w-wrk-buf-ctr
                     go to box-exp-prt-800.
           if        w-wrk-buf-c01        >    w-wrk-buf-max
                     go to box-exp-prt-800.
      *                  *---------------------------------------------*
      ...
      *
           move      10                   to   v-lin                  .
           add       w-wrk-buf-c01        to   v-lin                  .
      *
           move      24                   to   v-pos                  .
      *
           move      w-wrk-buf-prt
                    (w-wrk-buf-c01)       to   w-vis-big-prt-num      .
      ...
      *    * Box per expand protocolli distinta                        *
      *    *                                                           *
      *    * Subroutine di lettura protocolli distinta                 *
      *    *-----------------------------------------------------------*
       box-exp-prt-osd-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      zero                 to   w-wrk-rot-prt          .
           move      zero                 to   w-wrk-buf-ctr          .
       box-exp-prt-osd-100.
      *              *-------------------------------------------------*
      *              * Start su [osd]                                  *
      *              *-------------------------------------------------*
      ...
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-wrk-rot-prt        =    zero
                     go to box-exp-prt-osd-420.
           if        w-wrk-rot-prt        =    rf-osd-num-prt
                     go to box-exp-prt-osd-600.
       box-exp-prt-osd-420.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione elemento in castelletto     *
      *                  *---------------------------------------------*
           add       1                    to   w-wrk-buf-ctr          .
           move      rf-osd-num-prt       to   w-wrk-buf-prt
                                              (w-wrk-buf-ctr)         .
           move      rf-osd-num-prt       to   w-wrk-rot-prt          .
      *                  *---------------------------------------------*
      *                  * Normalizzazione [ost]                       *
      *                  *---------------------------------------------*
           move      "NO"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-dcc                 .
           move      rf-dcc-rag-soc       to   w-wrk-buf-rag
                                              (w-wrk-buf-ctr)         .
      *                  *---------------------------------------------*
      *                  * A riciclo                                   *
      *                  *---------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     box-exp-prt-osd-200.
       box-exp-prt-osd-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     box-exp-prt-osd-999.
       box-exp-prt-osd-999.
           exit.
