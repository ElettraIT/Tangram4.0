      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma ods340   *
      *                                                                *
      *                    Ordini di spedizione inevasi per prodotto   *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-dcp-num-pro       to   rf-osr-num-pro         .
      ...
      *              *-------------------------------------------------*
           if        rf-osr-cod-dpz       not  = rr-dpz-inu     or
                     ...
                     rf-osr-num-pro       not  = rf-dcp-num-pro
                     go to stp-srt-inp-100.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se quantita' ancora da spedire a zero : *
      *                      * riciclo                                 *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-osr-cod-tms       to   srt-tip-doc            .
      ...
      *                  *---------------------------------------------*
           ...
           if        w-tot-pro-gsp        =    zero and
                     w-tot-pro-ven        =    zero and
                     w-tot-pro-dsp        =    zero
                     go to prn-fin-lr2-999.
      *                  *---------------------------------------------*
      *                  * Test se righe residue sufficienti           *
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Totale quantita' in ordini spedizione   *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           if        w-tot-pro-ven        >    99999 or
                     w-tot-pro-ven        <   -99999
                     move  06             to   p-car
      ...
      *              *-------------------------------------------------*
           ...
           add       srt-qta-ven          to   w-tot-pro-ven          .
           add       srt-qta-dsp          to   w-tot-pro-dsp          .
       prn-liv-det-050.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Test se riferimenti gia' stampati       *
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "ORDINI DI SPEDIZIONE INEVASI PER PRODOTTO"
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      001                  to   p-pos                  .
           move      "  Ordine di spedizione     Ns. Conferma           
      -              "                 Cliente                       Da 
