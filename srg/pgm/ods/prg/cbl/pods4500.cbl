      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           ...
           05  w-rig-qta-dsp              pic s9(10)v9(03)            .
      ...
      *            *---------------------------------------------------*
               10  w-lin-imm-scr redefines
                   ...
                   15  w-lin-imm-qta-dev  pic  x(12)                  .
                   15  w-lin-imm-brv-002  pic  x(01)                  .
                   15  w-lin-imm-qta-ass  pic  x(12)                  .
                   15  w-lin-imm-brv-003  pic  x(01)                  .
                   15  w-lin-imm-qta-dsp.
                       20  filler         pic  x(01)                  .
                       20  w-lin-imm-qta-ds6
                                          pic  x(11)                  .
                   15  filler             pic  x(01)                  .
      ...
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           if        w-rig-qta-dsp        >    999999 or
                     w-rig-qta-dsp        <   -999999
                     move  08             to   v-car
           ...
           else      move  v-edt          to   w-lin-imm-qta-ds6      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
      *                          * Normalizzazione importo riscosso    *
      *                          *-------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       fnd-arc-orc-150.
      *              *-------------------------------------------------*
      *              * Scrittura variabile di i.p.c. 'sts-orc' per il  *
      *              * livello successivo per il tipo status ordine    *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Se valore non ammesso : no scrittura        *
      *                  *---------------------------------------------*
           if        w-fnd-arc-orc-tip    <    01 or
                     w-fnd-arc-orc-tip    >    04
                     go to fnd-arc-orc-300.
      *                  *---------------------------------------------*
      *                  * Scrittura effettiva                         *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
           ...
           move      zero                 to   s-dec                  .
           move      spaces               to   s-sgn                  .
           move      w-fnd-arc-orc-tip    to   s-num                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
       fnd-arc-orc-200.
      *              *-------------------------------------------------*
