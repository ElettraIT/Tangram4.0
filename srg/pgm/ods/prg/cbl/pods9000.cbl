      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Pulizia ordini di spedizione chiusi         *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  PULIZIA ORDINI DI SPEDIZIONE CHIUSI   "       .
      ...
      *    *-----------------------------------------------------------*
       01  f-xxx.
           05  f-xxx-nam                  pic  x(04)   value "ost "   .
      ...
      *                  *---------------------------------------------*
       ...
       pul-let-seq-200.
      *              *-------------------------------------------------*
      *              * Incremento contatore records [ost] letti        *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [ost] scritti  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "#"                  to   w-cnt-pul-flg-sub      .
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [ost] elimina- *
      *                  * ti                                          *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione contatore records [osr]     *
      *                  * scritti                                     *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-osr-num-prt       not  = rf-ost-num-prt
                     go to pul-put-app-200.
      *                  *---------------------------------------------*
      *                  * Incremento contatore records [osr] scritti  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       pul-put-app-200.
      *              *-------------------------------------------------*
      *              * Test su contatore records [osr] scritti : se a  *
      *              * zero si esce                                    *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       pul-put-app-400.
      *                  *---------------------------------------------*
      *                  * Lettura sequenziale record [osx]            *
      *                  *---------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/ods/fls/ioc/obj/iofosx"
                                          to   s-pat                  .
      ...
      *                  * Test sul massimo                            *
      *                  *---------------------------------------------*
           if        rf-osx-num-prt       not  = rf-ost-num-prt
                     go to pul-put-app-600.
      *                  *---------------------------------------------*
      *                  * Put record in file di appoggio              *
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-osx                 .
      *                  *---------------------------------------------*
      *                  * Riciclo su lettura sequenziale record [osx] *
      *                  *---------------------------------------------*
