      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Aggiornamento files [ost]-[osr] :           *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   AGGIORNAMENTO ORDINI DI SPEDIZIONE   "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-emi-min           to   rf-ost-dat-doc         .
      ...
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      "Nessuna riga ordine di spedizione aggiornata!"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
      *
      ...
      *                          * Test se diverso                     *
      *                          *-------------------------------------*
           if        rf-osr-cod-iva       =    rf-dcp-cod-iva
                     go to prn-liv-det-820.
      *                          *-------------------------------------*
      *                          * Aggiornamento                       *
      *                          *-------------------------------------*
           move      rf-dcp-cod-iva       to   rf-osr-cod-iva         .
       prn-liv-det-800.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-osr                 .
      *                  *---------------------------------------------*
      *                  * Riciclo a lettura [osr] successivo          *
      *                  *---------------------------------------------*
