      ...
      *                      *-----------------------------------------*
           ...
           move      w-stp-int-ndo-prg    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
       stp-cor-doc-600.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Deviazione ion funzione della persona-  *
      *                      * lizzazione di stampa                    *
      *                      *-----------------------------------------*
           if        w-prs-sos-tvn        =    00
                     go to stp-cor-doc-710
           else if   w-prs-sos-tvn        =    01
                     go to stp-cor-doc-720.
       stp-cor-doc-710.
      *                      *-----------------------------------------*
      *                      * Tipo visualizzazione : Nessuna          *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Oltre                               *
      *                          *-------------------------------------*
      ...
      *                      * Bufferizzazione ubicazione              *
      *                      *-----------------------------------------*
           move      d-prm-ubi-ubi-lit    to   w-rig-key-ubi-13
                                              (w-rig-num-ele)         .
      *                      *-----------------------------------------*
      *                      * Bufferizzazione codice prodotto         *
      *                      *-----------------------------------------*
      ...
      *                      * Note in riga                            *
      *                      *-----------------------------------------*
           move      "Note"               to   w-rou-stp-pmt-alf      .
           move      04                   to   w-rou-stp-pmt-car      .
           move      26                   to   w-rou-stp-pmt-lin      .
           move      119                  to   w-rou-stp-pmt-pos      .
      *                          *-------------------------------------*
      *                          * Correttivo per pagine successive    *
      *                          * alla prima                          *
      *                          *-------------------------------------*
