      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione tabella annotazioni per gli  *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   ANNOTAZIONI IN ORDINI DI SPEDIZIONE  "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-min           to   w-cod-mne-zsa-cod      .
           move      12                   to   w-cod-mne-zsa-lin      .
       ...
       acc-cod-min-120.
           move      w-cod-mne-zsa-cod    to   v-alf                  .
       acc-cod-min-150.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   w-cod-mne-zsa-ope      .
           move      rr-cod-max           to   w-cod-mne-zsa-cod      .
           move      12                   to   w-cod-mne-zsa-lin      .
           move      52                   to   w-cod-mne-zsa-pos      .
           move      zero                 to   w-cod-mne-zsa-dln      .
           move      zero                 to   w-cod-mne-zsa-dps      .
           move      spaces               to   v-edm                  .
           move      "UP  "               to   v-pfk (01)             .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-cod-min           to   rf-zsa-cod-aps         .
           move      "pgm/ods/fls/ioc/obj/iofzsa"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rr-des-min           to   rf-zsa-des-key         .
           move      spaces               to   rf-zsa-cod-aps         .
           move      "pgm/ods/fls/ioc/obj/iofzsa"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [zsa]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/ods/fls/ioc/obj/iofzsa"
                                          to   s-pat                  .
      ...
      *              * Selezione su codice                             *
      *              *-------------------------------------------------*
           if        rf-zsa-cod-aps       <    rr-cod-min or
                     rf-zsa-cod-aps       >    rr-cod-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
      *              *-------------------------------------------------*
      *              * Selezione su descrizione                        *
      *              *-------------------------------------------------*
           if        rf-zsa-des-key       <    rr-des-min or
                     rf-zsa-des-key       >    rr-des-max
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-sel-rec-999.
       qry-sel-rec-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        rf-zsa-rig-aps (2)   =    spaces
                     move   1             to   w-wrk-res-des
           else if   rf-zsa-rig-aps (3)   =    spaces
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      22                   to   v-pos                  .
           move      rf-zsa-rig-aps (1)   to   v-alf                  .
           move      "+"                  to   v-edm                  .
           move      rf-zsa-cod-aps       to   w-mpn-cod-aps          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      22                   to   v-pos                  .
           move      rf-zsa-rig-aps (2)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           if        rf-zsa-rig-aps (3)   =    spaces
                     go to qry-liv-det-999.
      *                  *---------------------------------------------*
      *                  * Interlinea                                  *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      22                   to   v-pos                  .
           move      rf-zsa-rig-aps (3)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'cod-aps'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "   ANNOTAZIONI IN ORDINI DI SPEDIZIONE  "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
