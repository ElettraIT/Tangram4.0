      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampa ordini di spedizione                 *
      *                                                                *
      *================================================================*
      ...
      *        *                                                       *
      *        * - 1 : quello di Inserimento o predefinito             *
      *        * - 2 : per Codice prodotto                             *
      *        * - 3 : per Descrizione prodotto                        *
      *        * - 4 : per Ubicazione                                  *
      *        *-------------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-ors.
               10  w-exp-tip-ors-num      pic  9(02)       value 4    .
               10  w-exp-tip-ors-lun      pic  9(02)       value 40   .
               10  w-exp-tip-ors-tbl.
                   15  filler             pic  x(40) value
                            "quello di Inserimento o predefinito     ".
                   15  filler             pic  x(40) value
                            "per Codice prodotto                     ".
                   15  filler             pic  x(40) value
      ...
      *            * Parametri di Start                                *
      *            *---------------------------------------------------*
               10  w-rip-str-ost-dpz      pic  9(02)                  .
               10  w-rip-str-ost-ddo      pic  9(07)                  .
      ...
      *              * Bufferizzazioni                                 *
      *              *-------------------------------------------------*
           move      rf-zsc-cod-tos       to   w-tmo-cod-tmo          .
           move      rf-zsc-des-tos       to   w-tmo-des-tmo          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      08                   to   w-cod-des-zsc-lin      .
           move      30                   to   w-cod-des-zsc-pos      .
           move      08                   to   w-cod-des-zsc-dln      .
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-tip-mov           =    spaces
                     move  "Tutti               "
                                          to   rr-tip-mov-des
           else      move  w-let-arc-zsc-des
                                          to   rr-tip-mov-des         .
           move      w-let-arc-zsc-vld    to   rr-tip-mov-vld         .
           move      w-let-arc-zsc-dpz    to   rr-tip-mov-dpz         .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-dpz           to   rf-ost-cod-dpz         .
      ...
      *              * Test su codice dipendenza                       *
      *              *-------------------------------------------------*
           if        rf-ost-cod-dpz       not  = rr-cod-dpz
      ...
      *                  * Selezione                                   *
      *                  *---------------------------------------------*
           if        rf-ost-dpz-arc       <    rr-dpz-min or
                     rf-ost-dpz-arc       >    rr-dpz-max
                     go to prn-sel-rec-900.
       prn-sel-rec-300.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      ...
      *              *-------------------------------------------------*
           move      rf-ost-dat-doc       to   w-rip-str-ost-ddo      .
           move      rf-ost-cod-dpz       to   w-rip-str-ost-dpz      .
      ...
      *                  *---------------------------------------------*
           ...
           move      "GT"                 to   f-cfr                  .
           move      "DATDOC    "         to   f-key                  .
           move      w-rip-str-ost-dpz    to   rf-ost-cod-dpz         .
           move      w-rip-str-ost-ddo    to   rf-ost-dat-doc         .
           move      w-rip-str-ost-prt    to   rf-ost-num-prt         .
           move      "pgm/ods/fls/ioc/obj/iofost"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
