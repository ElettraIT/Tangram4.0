      ...
      *                                   Fase:    ods501              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 24/03/22    *
      *                       Ultima revisione:    NdK del 24/03/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Interrogazione su colli Packing-list        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "COLLI PACKING LIST ORDINE DI SPEDIZIONE "       .
      ...
      *                * Protocollo ordine                             *
      *                *-----------------------------------------------*
                   15  w-ipc-dlp-prc-prt  pic  9(11)                  .

      *    *===========================================================*
      *    * Work-area per ridefinizione contenuto del mark-point      *
      *    *-----------------------------------------------------------*
       01  w-mpn.
           05  w-mpn-num-prc              pic  9(05)                  .
      ...
      *              *-------------------------------------------------*
           perform   ipc-dlp-prc-000      thru ipc-dlp-prc-999        .
       pre-exe-pgm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-ipc-dlp-prc-prt      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           if        s-ves                not  = spaces
                     go to ipc-dlp-prc-999.
           move      s-num                to   w-ipc-dlp-prc-prt      .
       ipc-dlp-prc-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-ipc-dlp-prc-prt    to   rr-num-prt             .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-num-prt           to   rf-osk-num-prt         .
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun collo entro i limiti assegnati!"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-sub      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [osk]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/ods/fls/ioc/obj/iofosk"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-osk-num-prt       not  = rr-num-prt
                     move  "#"            to   w-cnt-qry-flg-sub
      ...
      *                  *---------------------------------------------*
           ...
           move      10                   to   v-car                  .
           move      "+"                  to   v-edm                  .
           move      rf-osk-num-prc       to   w-mpn-num-prc          .
           move      w-mpn                to   v-cnt                  .
           move      v-lnr                to   v-lin                  .
           move      33                   to   v-pos                  .
           move      rf-osk-cts-prc       to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Peso lordo                                  *
      ...
      *              *-------------------------------------------------*
           ...
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Put della variabile di i.p.c.: 'num-prc'    *
      *                  *---------------------------------------------*
           move      "PV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "COLLI PACKING LIST ORDINE DI SPEDIZIONE"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
