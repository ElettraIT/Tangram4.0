      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma ods330   *
      *                                                                *
      *                    Lista ordini di spedizione per cliente      *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      "C"                  to   rf-osr-tip-arc         .
           move      rr-cod-cli           to   rf-osr-cod-arc         .
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-dpz-cli           =    "*    "
                     go to stp-srt-inp-150.
           if        rf-osr-dpz-arc       not  = rr-dpz-cli
      ...
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
           move      rf-osr-cod-arc       to   srt-cod-cli            .
      *                      *-----------------------------------------*
      *                      * Codice dipendenza cliente               *
      *                      *-----------------------------------------*
           move      rf-osr-dpz-arc       to   srt-dpz-cli            .
      *                      *-----------------------------------------*
      *                      * Data ordine di spedizione               *
      *                      *-----------------------------------------*
      ...
      *
           string    "ORDINI DI SPEDIZIONE PER CLIENTE"
                                delimited by   size
