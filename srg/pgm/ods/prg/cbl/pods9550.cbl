      ...
      *                                   Fase:    ods955              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 21/11/12    *
      *                       Ultima revisione:    NdK del 07/06/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Chiusura forzata ordini di spedizione       *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "  CHIUSURA FORZATA ORDINI DI SPEDIZIONE "       .
      ...
      *        *-------------------------------------------------------*
           05  rr-dat-ods                 pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Tipo movimento                                        *
      *        *-------------------------------------------------------*
           05  rr-cod-tms                 pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Tipo movimento, descrizione                           *
      *        *-------------------------------------------------------*
           05  rr-cod-tms-des             pic  x(30)                  .
      ...
      *                  *---------------------------------------------*
           perform   acc-dat-ods-000      thru acc-dat-ods-999        .
      ...
      *                  *---------------------------------------------*
           perform   acc-cod-tms-000      thru acc-cod-tms-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           move      zero                 to   rr-dat-ods             .
           move      spaces               to   rr-cod-tms             .
           move      spaces               to   rr-cod-tms-des         .
       nor-ric-sel-999.
           exit.
      ...
      *              *-------------------------------------------------*
           ...
           move      19                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "N.B.: Il programma pone a stato di 'chiuso' tutti 
      -              "gli ordini, righe comprese,   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      "DS"                 to   v-ope                  .
           ...
           move      20                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "      anche se inevasi o parzialmente evasi, emess
      -              "i fino alla data indicata.    "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       pmt-ric-sel-999.
      ...
      *                  *---------------------------------------------*
           if        rr-dat-ods           not  = zero
                     go to acc-dat-ods-100.
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           if        s-sts                not  =    spaces
                     ...
                     go to acc-dat-ods-040.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione valore di default       *
      *                      *-----------------------------------------*
           move      s-dat                to   rr-dat-ods             .
       acc-dat-ods-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-dat-ods-999.
       acc-dat-ods-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-dat-ods             .
       acc-dat-ods-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-tms           to   w-cod-des-zsc-cod      .
           move      07                   to   w-cod-des-zsc-lin      .
           move      30                   to   w-cod-des-zsc-pos      .
           move      07                   to   w-cod-des-zsc-dln      .
       ...
       acc-cod-tms-110.
           ...
           if        w-cod-des-zsc-ope    =    "F+"
                     go to acc-cod-tms-115.
           if        w-cod-des-zsc-ope    =    "AC"
                     go to acc-cod-tms-120.
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
       acc-cod-tms-115.
           perform   cod-des-zsc-foi-000  thru cod-des-zsc-foi-999    .
           go to     acc-cod-tms-110.
       acc-cod-tms-120.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-cod-tms-999.
       acc-cod-tms-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   rr-cod-tms             .
       acc-cod-tms-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rr-cod-tms           to   w-let-arc-zsc-cod      .
           perform   let-arc-zsc-000      thru let-arc-zsc-999        .
           move      w-let-arc-zsc-des    to   rr-cod-tms-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cod-tms-des-000  thru vis-cod-tms-des-999    .
      *                  *---------------------------------------------*
      *                  * Se codice errato : reimpostazione           *
      *                  *---------------------------------------------*
           if        w-let-arc-zsc-flg    not  = spaces
                     go to acc-cod-tms-100.
      *                  *---------------------------------------------*
      *                  * Se valore a spazi : visualizzazione literal *
      *                  * 'Tutti' al posto del codice movimento       *
      *                  *---------------------------------------------*
           if        rr-cod-tms           not  = spaces
                     go to acc-cod-tms-600.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      05                   to   v-car                  .
           move      07                   to   v-lin                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Ordini da chiudere         :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Prompt per ordini chiusi                    *
      *                  *---------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      28                   to   v-car                  .
      ...
      *              *-------------------------------------------------*
           if        rf-ost-dat-doc       >    rr-dat-ods
                     go to stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Selezione su tipo movimento                     *
      *              *-------------------------------------------------*
           if        rr-cod-tms           =    spaces
                     go to stp-srt-inp-150.
           if        rf-ost-cod-tms       not  = rr-cod-tms
                     go to stp-srt-inp-100.
       stp-srt-inp-150.
      *              *-------------------------------------------------*
      *              * Start su file [osr]                             *
      ...
      *              *-------------------------------------------------*
           move      rf-ost-num-prt       to   srt-prt-ods            .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Visualizzazione numero ordini da chiudere       *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      07                   to   v-car                  .
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      *              * Riciclo su lettura sequenziale record [ost]     *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-100.
       stp-srt-inp-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       prn-nes-ela-000.
           move      "WR"                 to   m-ope                  .
           move      "Nessun ordine di spedizione da chiudere !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       prn-nes-ela-999.
      ...
      *                  *---------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "NUMPRT    "         to   f-key                  .
           move      srt-prt-ods          to   rf-osr-num-prt         .
           move      zero                 to   rf-osr-num-prg         .
           move      "pgm/ods/fls/ioc/obj/iofosr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *                  *---------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      srt-prt-ods          to   rf-ost-num-prt         .
           move      "pgm/ods/fls/ioc/obj/iofost"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      "Ordine di spedizione :"
                                          to   w-all-str-cat (1)      .
           move      rf-ost-cod-tms       to   w-all-str-cat (2)      .
           move      "- N."               to   w-all-str-cat (3)      .
           move      rf-ost-num-prt
                    (6 : 6)               to   w-all-str-cat (4)      .
           move      "del"                to   w-all-str-cat (5)      .
           move      v-edt                to   w-all-str-cat (6)      .
           move      "- CHIUSO"           to   w-all-str-cat (7)      .
      ...
      *              *-------------------------------------------------*
      *              * Visualizzazione numero ordini chiusi            *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
           move      07                   to   v-car                  .
