      ...
      *                                                                *
      *              Input  : w-cod-des-zsc-ope : "C?"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zsc-ope : spaces = Si          *
      *                                           "C?"   = No          *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      ...
      *                                                                *
      *              Input  : w-cod-des-zsc-ope : "AC"                 *
      *                                                                *
      *                       w-cod-des-zsc-cod : codice tipo movim.   *
      *                                                                *
      *                       w-cod-des-zsc-lin : linea codice         *
      *                                                                *
      *                       w-cod-des-zsc-pos : posizione codice     *
      *                                                                *
      *                       w-cod-des-zsc-dln : linea descrizione    *
      *                                                                *
      *                       w-cod-des-zsc-dps : posizione descriz.   *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zsc-ope : "A+"                 *
      *                                                                *
      *       -------------------------------------------------------- *
      *                                                                *
      * "A+"  Continuazione accettazione                               *
      *                                                                *
      *              Input  : w-cod-des-zsc-ope : "A+"                 *
      *                                                                *
      *                                                                *
      *              Output : w-cod-des-zsc-ope : "A+" = continuare    *
      *                                           "F+" = eseguire Find *
      *                                           "AC" = completata    *
      *                                                                *
      *                       w-cod-des-zsc-cod : codice tipo movim.   *
      ...
      *    *-----------------------------------------------------------*
       01  w-aux-cde-tos.
           05  w-aux-cde-tos-nli          pic  9(02)                  .
           05  w-aux-cde-tos-crb          pic  9(02)                  .
           05  w-aux-cde-tos-cpb          pic  9(02)                  .
           05  w-aux-cde-tos-cpa          pic  9(02)                  .
           05  w-aux-cde-tos-bix          pic  9(02)                  .
           05  w-aux-cde-tos-buf
                               occurs 30.
               10  w-aux-cde-tos-bco      pic  x(05)                  .
               10  w-aux-cde-tos-bde      pic  x(30)                  .
           05  w-aux-cde-tos-ltp.
               10  filler                 pic  x(07) value "Pagina "  .
               10  w-aux-cde-tos-lt1      pic  9(01)                  .
               10  filler                 pic  x(04) value " di "     .
               10  w-aux-cde-tos-lt2      pic  9(01)                  .
           05  w-aux-cde-tos-dup          pic  x(30)                  .
           05  w-aux-cde-tos-dmx.
               10  w-aux-cde-tos-dch
                               occurs 30  pic  x(01)                  .
           05  w-aux-cde-tos-c01          pic  9(02)                  .
           05  w-aux-cde-tos-c02          pic  9(02)                  .
           05  w-aux-cde-tos-c03          pic  9(02)                  .
           05  w-aux-cde-tos-c04          pic  9(02)                  .
           05  w-aux-cde-tos-c05          pic  9(02)                  .
      ...
      *    *===========================================================*
      *    * Link-area per accettazione tipo movimento ordini di spe-  *
      *    * dizione                                                   *
      *    *-----------------------------------------------------------*
      ...
      ******************************************************************
       Procedure Division                using w-cod-des-zsc
                                               v
                                               s                      .
      ******************************************************************
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zsc-ope    =    "OP"
                     perform   opn-000    thru opn-999
           else if   w-cod-des-zsc-ope    =    "CL"
                     perform   cls-000    thru cls-999
           else if   w-cod-des-zsc-ope    =    "C?"
                     perform   tcm-000    thru tcm-999
           else if   w-cod-des-zsc-ope    =    "AC"
                     perform   acc-000    thru acc-999
           else if   w-cod-des-zsc-ope    =    "A+" or
                     w-cod-des-zsc-ope    =    "I+" or
                     w-cod-des-zsc-ope    =    "F+"
      ...
      *              *-------------------------------------------------*
           if        w-cnt-ctr-opn        =    zero
                     move  spaces         to   w-cod-des-zsc-ope      .
       tcm-999.
           exit.
      ...
      *                  *---------------------------------------------*
           move      w-cod-des-zsc-cod    to   w-cod-des-zsc-s01      .
      *                  *---------------------------------------------*
      *                  * Maschera di editing                         *
      *                  *---------------------------------------------*
           move      v-edm                to   w-cod-des-zsc-s80      .
      *                  *---------------------------------------------*
      *                  * User function keys                          *
      *                  *---------------------------------------------*
           move      v-ufk                to   w-cod-des-zsc-s90      .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-cod-des-zsc-s90    to   v-ufk                  .
           move      w-cod-des-zsc-lin    to   v-lin                  .
           move      w-cod-des-zsc-pos    to   v-pos                  .
           move      w-cod-des-zsc-cod    to   v-alf                  .
      *              *-------------------------------------------------*
      *              * Tipo operazione a : continuazione               *
      *              *-------------------------------------------------*
           move      "A+"                 to   w-cod-des-zsc-ope      .
       acc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-cod-des-zsc-ope    =    "A+"
                     go to aco-400
           else if   w-cod-des-zsc-ope    =    "F+"
                     go to aco-200.
       aco-100.
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      s-alf                to   w-cod-des-zsc-cod      .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      v-alf                to   w-cod-des-zsc-cod      .
      *                  *---------------------------------------------*
      *                  * Valore impostato in area di comodo          *
      *                  *---------------------------------------------*
           move      w-cod-des-zsc-cod    to   w-cod-des-zsc-alf      .
      *                  *---------------------------------------------*
      *                  * Test se blanks embedded, e se si a reimpo-  *
      *                  * stazione                                    *
      *                  *---------------------------------------------*
           move      w-cod-des-zsc-alf    to   w-ble-str              .
      ...
      *                      * ne                                      *
      *                      *-----------------------------------------*
           if        w-cod-des-zsc-dln    =    zero or
                     w-cod-des-zsc-dps    =    zero
                     go to aco-150.
       aco-620.
      *                  *---------------------------------------------*
      ...
      *                  * zione                                       *
      *                  *---------------------------------------------*
           move      spaces               to   w-aux-cde-tos-dup      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      30                   to   v-car                  .
           move      w-cod-des-zsc-dln    to   v-lin                  .
           move      w-cod-des-zsc-dps    to   v-pos                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-cod-des-zsc-dln    to   v-lin                  .
           move      w-cod-des-zsc-dps    to   v-pos                  .
           move      w-aux-cde-tos-dup    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
           move      v-alf                to   w-aux-cde-tos-dup      .
       aco-640.
      *                  *---------------------------------------------*
      *                  * Se Up                                       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      w-aux-cde-tos-dup    to   w-aux-cde-tos-dmx      .
           move      30                   to   w-aux-cde-tos-c01      .
       aco-680.
           if        w-aux-cde-tos-c01    >    zero
                     if    w-aux-cde-tos-dch
                          (w-aux-cde-tos-c01)
                                          =    spaces
                           move     "z"   to   w-aux-cde-tos-dch
                                              (w-aux-cde-tos-c01)
                           subtract 1     from w-aux-cde-tos-c01
                           go to aco-680.
       aco-700.
      *                      *-----------------------------------------*
      ...
      *                          * buffer                              *
      *                          *-------------------------------------*
           move      zero                 to   w-aux-cde-tos-crb      .
      *                          *-------------------------------------*
      *                          * Start                               *
      *                          *-------------------------------------*
           move      "SK"                 to   f-ope                  .
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-aux-cde-tos-dup    to   rf-zsc-des-key         .
      ...
      *                          * Test sul max                        *
      *                          *-------------------------------------*
           if        rf-zsc-des-key       >    w-aux-cde-tos-dmx
                     go to aco-800.
       aco-740.
      *                          *-------------------------------------*
      ...
      *                          * fer                                 *
      *                          *-------------------------------------*
           add       1                    to   w-aux-cde-tos-crb      .
      *                          *-------------------------------------*
      *                          * Se oltre il massimo : come per fine *
      *                          * file                                *
      *                          *-------------------------------------*
           if        w-aux-cde-tos-crb    >    30
                     go to aco-800.
       aco-750.
      *                          *-------------------------------------*
      ...
      *                              *---------------------------------*
           move      rf-zsc-cod-tos       to   w-aux-cde-tos-bco
                                              (w-aux-cde-tos-crb)     .
      *                              *---------------------------------*
      *                              * Descrizione tipo movimento      *
      *                              *---------------------------------*
           move      rf-zsc-des-tos       to   w-aux-cde-tos-bde
                                              (w-aux-cde-tos-crb)     .
       aco-760.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-aux-cde-tos-crb    =    zero
                     go to aco-810
           else  if  w-aux-cde-tos-crb    >    30
                     go to aco-820
           else  if  w-aux-cde-tos-crb    =    1
                     go to aco-830
           else      go to aco-850.
       aco-810.
      *                          *-------------------------------------*
      ...
      *                                  *-----------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      30                   to   s-car                  .
           move      w-aux-cde-tos-dup    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                              *---------------------------------*
      ...
      *                              * elemento del buffer             *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-tos-bix      .
       aco-840.
      *                              *---------------------------------*
      *                              * Valore selezionato in uscita    *
      *                              *---------------------------------*
           move      w-aux-cde-tos-bco
                    (w-aux-cde-tos-bix)   to   w-cod-des-zsc-cod      .
      *                              *---------------------------------*
      ...
      *                              * nel buffer                      *
      *                              *---------------------------------*
           move      w-aux-cde-tos-crb    to   w-aux-cde-tos-cpb      .
           subtract  1                    from w-aux-cde-tos-cpb      .
           divide    6                    into w-aux-cde-tos-cpb      .
           add       1                    to   w-aux-cde-tos-cpb      .
      *                              *---------------------------------*
      *                              * Inizializzazione numero record  *
      *                              * nel buffer attualmente trattato *
      *                              *---------------------------------*
           move      1                    to   w-aux-cde-tos-c01      .
      *                              *---------------------------------*
      ...
      *                              * di indice (w-aux-cde-tos-c01)   *
      *                              *---------------------------------*
           move      w-aux-cde-tos-c01    to   w-aux-cde-tos-nli      .
       aco-865.
           if        w-aux-cde-tos-nli    >    6
                     subtract  6          from w-aux-cde-tos-nli
                     go to aco-865.
           add       09                   to   w-aux-cde-tos-nli      .
       aco-870.
      *                              *---------------------------------*
      ...
      *                              *---------------------------------*
           ...
           if        w-aux-cde-tos-c01    >    1
                     move  "UP  "         to   v-pfk (01)             .
           if        w-aux-cde-tos-c01    <    w-aux-cde-tos-crb
                     move  "DOWN"         to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           if        w-aux-cde-tos-cpa    >    1
                     move  "PRSC"         to   v-pfk (07)             .
           if        w-aux-cde-tos-cpa    <    w-aux-cde-tos-cpb
                     move  "NXSC"         to   v-pfk (08)             .
           move      "SLCT"               to   v-pfk (10)             .
           move      "EXIT"               to   v-pfk (20)             .
           move      w-aux-cde-tos-nli    to   v-lin                  .
           move      30                   to   v-pos                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                              *---------------------------------*
      ...
      *                                  * nato                        *
      *                                  *-----------------------------*
           move      w-aux-cde-tos-c01    to   w-aux-cde-tos-bix      .
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-tos-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      *                                  *-----------------------------*
           move      w-aux-cde-tos-cpa    to   w-aux-cde-tos-c01      .
           multiply  6                    by   w-aux-cde-tos-c01      .
           subtract  5                    from w-aux-cde-tos-c01      .
      *                                  *-----------------------------*
      ...
      *                                  * video attualmente trattata  *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-tos-cpa      .
      *                                  *-----------------------------*
      *                                  * Ricalcolo indice primo ele- *
      *                                  * mento della pagina video    *
      *                                  * attualmente trattata        *
      ...
      *                                  *-----------------------------*
           move      w-aux-cde-tos-c01    to   w-aux-cde-tos-c02      .
           add       5                    to   w-aux-cde-tos-c02      .
           divide    6                    into w-aux-cde-tos-c02      .
           move      w-aux-cde-tos-c02    to   w-aux-cde-tos-cpa      .
      *                                  *-----------------------------*
      ...
      *                                  * trattata                    *
      *                                  *-----------------------------*
           subtract  1                    from w-aux-cde-tos-c02      .
           multiply  6                    by   w-aux-cde-tos-c02      .
           add       1                    to   w-aux-cde-tos-c02      .
           add       5
                     w-aux-cde-tos-c02  giving w-aux-cde-tos-c03      .
           move      w-aux-cde-tos-c03    to   w-aux-cde-tos-c04      .
           if        w-aux-cde-tos-c03    >    w-aux-cde-tos-crb
                     move  w-aux-cde-tos-crb
                                          to   w-aux-cde-tos-c03      .
      *                                  *-----------------------------*
      *                                  * Inizializzazione indice per *
      *                                  * numero linea a video rela-  *
      *                                  * tiva al primo elemento      *
      *                                  *-----------------------------*
           move      10                   to   w-aux-cde-tos-c05      .
       aco-951.
      *                                  *-----------------------------*
      ...
      *                                      *-------------------------*
           ...
           move      "A"                  to   v-tip                  .
           move      05                   to   v-car                  .
           move      w-aux-cde-tos-c05    to   v-lin                  .
           move      23                   to   v-pos                  .
           move      w-aux-cde-tos-bco
                    (w-aux-cde-tos-c02)   to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *                                      *-------------------------*
      ...
      *                                  * video                       *
      *                                  *-----------------------------*
           add       1                    to   w-aux-cde-tos-c05      .
      *                                  *-----------------------------*
      *                                  * Se non si e' oltre l'ultimo *
      *                                  * elemento reale si ricicla   *
      *                                  *-----------------------------*
           if        w-aux-cde-tos-c02    not  > w-aux-cde-tos-c03
                     go to aco-951.
       aco-952.
      *                                  *-----------------------------*
      ...
      *                                  *-----------------------------*
           if        w-aux-cde-tos-c02    >    w-aux-cde-tos-c04
                     go to aco-955.
      *                                  *-----------------------------*
      ...
      *                                  * pagine totali               *
      *                                  *-----------------------------*
           move      w-aux-cde-tos-cpa    to   w-aux-cde-tos-lt1      .
           move      w-aux-cde-tos-cpb    to   w-aux-cde-tos-lt2      .
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      13                   to   v-car                  .
           move      17                   to   v-lin                  .
           move      35                   to   v-pos                  .
           move      w-aux-cde-tos-ltp    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
       aco-959.
           exit.
