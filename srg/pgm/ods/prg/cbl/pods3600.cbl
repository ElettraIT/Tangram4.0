      ...
      *                       Ultima revisione:    NdK del 11/07/12    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Stampe etichette segnacolli a fronte ordini *
      *                    di spedizione clienti                       *
      *                                                                *
      *                    Main                                        *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase ods360, nella sua globalita', esegue i tipi di stampa  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * ETICLI      Stampa etichette segnacolli clienti       pods360a *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'ods360'           *
      *              *-------------------------------------------------*
           perform   fas-ods-360-000      thru fas-ods-360-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-ods-360-300
           else if   v-key                =    "PRSC"
                     go to fas-ods-360-400
           else if   v-key                =    "NXSC"
                     go to fas-ods-360-450
           else if   v-key                =    "DOWN"
                     go to fas-ods-360-500
           else if   v-key                =    "EXIT"
                     go to fas-ods-360-250
           else      go to fas-ods-360-200.
       fas-ods-360-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-ods-360-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-ods-360-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-nes
                     go to fas-ods-360-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-ods-360-350
           else      go to fas-ods-360-322.
       fas-ods-360-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-ods-360-630
           else if   v-key                =    "PRSC"
                     go to fas-ods-360-600
           else if   v-key                =    "NXSC"
                     go to fas-ods-360-610
           else if   v-key                =    "UP  "
                     go to fas-ods-360-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-ods-360-650
           else if   v-key                =    "EXIT"
                     go to fas-ods-360-660
           else      go to fas-ods-360-570.
       fas-ods-360-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-ods-360-626
           else      go to fas-ods-360-628.
       fas-ods-360-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-ods-360-636
           else      go to fas-ods-360-638.
       fas-ods-360-636.
      *                          *-------------------------------------*
