      ...
      *        *-------------------------------------------------------*
      *        * Per status ordini di spedizione                       *
      *        *-------------------------------------------------------*
           05  w-ipc-sts-ods.
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-ipc-sts-ods-snx      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Valore della variabile di i.p.c. relativa allo    *
      *            * status ordini di spedizione                       *
      *            *---------------------------------------------------*
               10  w-ipc-sts-ods-val      pic  9(02)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per Det status riga ordine di spedizione         *
      *        *-------------------------------------------------------*
           05  w-det-sts-ror.
      *            *---------------------------------------------------*
      *            * Status riga ordine di spedizione                  *
      *            *                                                   *
      *            * - 01 : Chiusa                                     *
      *            * - 02 : Inevasa                                    *
      *            * - 03 : Evasa                                      *
      ...
      *            *---------------------------------------------------*
               10  w-det-sts-ror-wtr.
                   15  w-det-sts-ror-wtp  pic  x(01)                  .
                   15  w-det-sts-ror-wtf  pic  x(01)                  .
                   15  filler             pic  x(03)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Status ordini di spedizione                *
      *        *-------------------------------------------------------*
           05  w-exp-sts-ods.
      ...
      *    *-----------------------------------------------------------*
       01  w-rip-str.
      *        *-------------------------------------------------------*
      *        * Work-area per ripristino Start su [osr] per Expand    *
      *        *-------------------------------------------------------*
           05  w-rip-str-osr.
      *            *---------------------------------------------------*
      *            * Flag di End-of-file                               *
      *            *---------------------------------------------------*
               10  w-rip-str-osr-eof      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Parametri di Start                                *
      *            *---------------------------------------------------*
               10  w-rip-str-osr-dpz      pic  9(02)                  .
               10  w-rip-str-osr-tip      pic  9(02)                  .
               10  w-rip-str-osr-pro      pic  9(07)                  .
               10  w-rip-str-osr-dat      pic  9(07)                  .
               10  w-rip-str-osr-prt      pic  9(11)                  .
               10  w-rip-str-osr-prg      pic  9(05)                  .
      ...
      *              *-------------------------------------------------*
      *              * Lettura della variabile eventuale di i.p.c. per *
      *              * lo status ordini di spedizione                  *
      *              *-------------------------------------------------*
           perform   ipc-sts-ods-000      thru ipc-sts-ods-999        .
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       ipc-sts-ods-000.
      *              *-------------------------------------------------*
      *              * Estrazione della variabile 'sts-ods' dal livelo *
      *              * di profondita' precedente                       *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to ipc-sts-ods-200
           else      go to ipc-sts-ods-400.
       ipc-sts-ods-200.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
      ...
      *                  * Segnale di variabile esistente              *
      *                  *---------------------------------------------*
           move      "S"                  to   w-ipc-sts-ods-snx      .
      *                  *---------------------------------------------*
      *                  * Valore della variabile                      *
      *                  *---------------------------------------------*
           move      s-num                to   w-ipc-sts-ods-val      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ipc-sts-ods-999.
       ipc-sts-ods-400.
      *              *-------------------------------------------------*
      *              * Se variabile non esistente                      *
      *              *-------------------------------------------------*
      ...
      *                  * Segnale di variabile non esistente          *
      *                  *---------------------------------------------*
           move      "N"                  to   w-ipc-sts-ods-snx      .
      *                  *---------------------------------------------*
      *                  * Valore della variabile a zero               *
      *                  *---------------------------------------------*
           move      zero                 to   w-ipc-sts-ods-val      .
      *                  *---------------------------------------------*
      *                  * Uscita                                      *
      *                  *---------------------------------------------*
           go to     ipc-sts-ods-999.
      ...
      *                          * di spedizione pari al valore letto  *
      *                          *-------------------------------------*
           if        w-ipc-sts-ods-snx    =    "S" and
                     w-ipc-sts-ods-val    not  = zero
                     move  w-ipc-sts-ods-val
                                          to   rr-sts-ods
                     go to pre-tip-fun-200.
      *                          *-------------------------------------*
      *                          * Altrimenti : status ordini di       *
      *                          * spedizione normalizzato a 01        *
      *                          *-------------------------------------*
           move      01                   to   rr-sts-ods             .
       pre-tip-fun-200.
      *                  *---------------------------------------------*
      *                  * Preparazione tipo funzionamento             *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Prompt status ordini di spedizione              *
      *              *-------------------------------------------------*
           perform   pmt-sts-ods-000      thru pmt-sts-ods-999        .
      *              *-------------------------------------------------*
      *              * Visualizzazione status ordini di spedizione     *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Status ordini di spedizione          *
      *    *-----------------------------------------------------------*
       acc-sts-ods-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Status ordini di spedizione       *
      *    *-----------------------------------------------------------*
       vis-sts-ods-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       reg-ric-sel-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione status ordini di spedizione     *
      *              *-------------------------------------------------*
           if        rr-sts-ods           =    zero
                     move  01             to   rr-sts-ods             .
       reg-ric-sel-999.
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-pro           to   rf-osr-num-pro         .
           move      rr-dem-min           to   rf-osr-dat-doc         .
      ...
      *              *-------------------------------------------------*
       ...
       qry-let-seq-100.
      *              *-------------------------------------------------*
      *              * Next su [osr] per data registrazione            *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "pgm/ods/fls/ioc/obj/iofosr"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           if        rf-osr-cod-dpz       not  = rr-dpz-inu
                     move  "#"            to   w-cnt-qry-flg-sub
      ...
      *              *-------------------------------------------------*
           if        rf-osr-tip-mag       not  = 01
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
           if        rf-osr-num-pro       not  = rr-cod-pro
                     move  "#"            to   w-cnt-qry-flg-sub
                     go to qry-tst-max-999.
       qry-tst-max-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      08                   to   v-pos                  .
           move      rf-osr-dat-doc       to   v-dat                  .
           move      "+"                  to   v-edm                  .
           move      rf-osr-dat-doc       to   w-mpn-dat-doc          .
           move      rf-osr-cod-tms       to   w-mpn-cod-tms          .
           move      rf-osr-num-prt       to   w-mpn-num-prt          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      18                   to   v-pos                  .
           move      rf-osr-num-prt       to   w-wrk-num-prt          .
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-osr-cod-arc       to   rf-dcc-cod-cli         .
           move      rf-osr-dpz-arc       to   rf-dcc-dpz-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipo     Data   Protocollo     Quantita'          
      -              "    Annotazioni               "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *                  *---------------------------------------------*
           move      spaces               to   v-key                  .
      *                  *---------------------------------------------*
      *                  * Salvataggio parametri per Start su [osr]    *
      *                  *---------------------------------------------*
           if        w-rip-str-osr-eof    not  = spaces
                     go to qry-trt-fun-320.
           move      rf-osr-cod-dpz       to   w-rip-str-osr-dpz      .
           move      rf-osr-tip-mag       to   w-rip-str-osr-tip      .
           move      rf-osr-num-pro       to   w-rip-str-osr-pro      .
           move      rf-osr-dat-doc       to   w-rip-str-osr-dat      .
           move      rf-osr-num-prt       to   w-rip-str-osr-prt      .
           move      rf-osr-num-prg       to   w-rip-str-osr-prg      .
       qry-trt-fun-320.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      rr-alf-pro           to   w-esp-rig-osr-pro      .
      *                      *-----------------------------------------*
      *                      * Chiamata del modulo                     *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "MAGDAT    "         to   f-key                  .
           move      w-rip-str-osr-dpz    to   rf-osr-cod-dpz         .
           move      w-rip-str-osr-tip    to   rf-osr-tip-mag         .
           move      w-rip-str-osr-pro    to   rf-osr-num-pro         .
           move      w-rip-str-osr-dat    to   rf-osr-dat-doc         .
           move      w-rip-str-osr-prt    to   rf-osr-num-prt         .
           move      w-rip-str-osr-prg    to   rf-osr-num-prg         .
           move      "pgm/ods/fls/ioc/obj/iofosr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *    *===========================================================*
      *    * Determinazione status riga ordine di spedizione           *
      *    *-----------------------------------------------------------*
       det-sts-ror-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-det-sts-ror-wtp    =    "A"
                     go to det-sts-ror-320
           else      go to det-sts-ror-340.
       det-sts-ror-320.
      *              *-------------------------------------------------*
