      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pods3201:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-tms-ctr-ele              pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Codice tipo ordine di default                         *
      *        *-------------------------------------------------------*
           05  w-tms-cod-tmo              pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Descrizione tipo ordine di default                    *
      *        *-------------------------------------------------------*
           05  w-tms-des-tmo              pic  x(30)                  .
      *        *-------------------------------------------------------*
      *        * Contatore di numerazioni                              *
      *        *-------------------------------------------------------*
           05  w-tms-ctr-num              pic  9(05)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-sts-ods.
               10  w-exp-sts-ods-num      pic  9(02)       value 03   .
               10  w-exp-sts-ods-lun      pic  9(02)       value 25   .
      ...
      *              * faults                                          *
      *              *-------------------------------------------------*
           perform   pre-tbl-tms-000      thru pre-tbl-tms-999        .
       pre-exe-pgm-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-tms-ctr-ele          .
           move      spaces               to   w-tms-cod-tmo          .
           move      spaces               to   w-tms-des-tmo          .
           move      zero                 to   w-tms-ctr-num          .
       pre-tbl-tms-100.
      *              *-------------------------------------------------*
      *              * Open file [zsc]                                 *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           add       1                    to   w-tms-ctr-ele          .
      *              *-------------------------------------------------*
      *              * Bufferizzazioni per tipo ordine                 *
      *              *-------------------------------------------------*
           move      rf-zsc-cod-tos       to   w-tms-cod-tmo          .
           move      rf-zsc-des-tos       to   w-tms-des-tmo          .
       pre-tbl-tms-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-tms-ctr-num        =    zero
                     move  1              to   w-tms-ctr-num
                     go to pre-tbl-tms-500.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           add       1                    to   w-tms-ctr-num          .
       pre-tbl-tms-500.
      *              *-------------------------------------------------*
      *              * Riciclo a riga successiva                       *
      *              *-------------------------------------------------*
           go to     pre-tbl-tms-200.
       pre-tbl-tms-900.
      *              *-------------------------------------------------*
      *              * Close file [zsc]                                *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      05                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Tipo ordine di spedizione  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-tms-ctr-ele        not  = 1
                     go to acc-tip-mov-100.
           if        w-tms-cod-tmo        =    spaces
                     go to acc-tip-mov-100.
           move      w-tms-cod-tmo        to   rr-tip-mov             .
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Stato ordini di spedizione *
      *    *-----------------------------------------------------------*
       acc-sts-ods-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * si sia in Up                                *
      *                  *---------------------------------------------*
           if        rr-sts-ods           not  = zero
                     go to acc-sts-ods-600.
           if        v-key                =    "UP  "
                     go to acc-sts-ods-600.
