      ...
      *                                   Fase:    ods600              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 27/05/22    *
      *                       Ultima revisione:    NdK del 27/05/22    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione DDT in versione "light" per l'uso  *
      *                    da parte del magazzino                      *
      *                                                                *
      * -------------------------------------------------------------- *
      *                                                                *
      * Questo programma prepara una variabile globale di i.p.c., con  *
      * nome variabile 'bol300-sub-pgm', e poi richiama e cancella il  *
      * programma 'pbol3000', che riconosce la variabile globale ed    *
      ...
      *                *  - CM     : Il programma e' eseguito come     *
      *                *             sottoprogramma per la gestione    *
      *                *             della consegna dal magazzino      *
      *                *-----------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   fas-ods-600-000      thru fas-ods-600-999        .
       main-999.
           exit      program                                          .
      ...
      *    *-----------------------------------------------------------*
       fas-ods-600-000.
      *              *-------------------------------------------------*
      *              * Scrittura variabile di i.p.c. 'bol300-sub-pgm'  *
      *              *-------------------------------------------------*
           move      "PV"                 to   s-ope                  .
           move      "bol300-sub-pgm"     to   s-var                  .
           move      "G"                  to   s-dop                  .
           move      "A"                  to   s-tip                  .
           move      80                   to   s-car                  .
           ...
           move      "CM"                 to   w-ipc-sub-pgm-ind      .
           move      w-ipc-sub-pgm-val    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *              *-------------------------------------------------*
      *              * Richiamo del programma di bollettazione         *
      *              *-------------------------------------------------*
           move      "pgm/bol/prg/obj/pbol3000"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
           call      s-pat                                            .
      *              *-------------------------------------------------*
      *              * Cancellazione del programma di bollettazione    *
      *              *-------------------------------------------------*
           move      "pgm/bol/prg/obj/pbol3000"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
