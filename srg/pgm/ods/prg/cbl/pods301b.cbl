      ...
      *            *---------------------------------------------------*
      *            * Status documento in chiave                        *
      *            *---------------------------------------------------*
               10  srt-sts-key            pic  x(02)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-exp.
      *        *-------------------------------------------------------*
      *        * Work per : Status ordine di spedizione                *
      *        *-------------------------------------------------------*
           05  w-exp-sts-ods.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-rou-opn-fls      .
      *              *-------------------------------------------------*
      *              * Open modulo di espansione righe ordine di spe-  *
      *              * dizione                                         *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       rou-cls-fls-000.
      *              *-------------------------------------------------*
      *              * Close modulo di espansione righe ordine di spe- *
      *              * dizione                                         *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       int-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Start su [ost] per data registrazione           *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
      ...
      *                      *-----------------------------------------*
           if        d-sts-ods-sts-ord    =    01
                     move  "CH"           to   srt-sts-ord
           else if   d-sts-ods-sts-ord    =    02
                     move  "PE"           to   srt-sts-ord
           else if   d-sts-ods-sts-ord    =    03
                     move  "EV"           to   srt-sts-ord
           else if   d-sts-ods-sts-ord    =    04
                     move  "IN"           to   srt-sts-ord            .
       int-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       int-srt-inp-key-200.
      *              *-------------------------------------------------*
      *              * 2. per protocollo ordine                        *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      rf-ost-num-prt       to   srt-prt-key            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
       int-srt-inp-key-300.
      *              *-------------------------------------------------*
      *              * 3. per status documento                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           if        d-sts-ods-sts-ord    =    01
                     move  "CH"           to   srt-sts-key
           else if   d-sts-ods-sts-ord    =    02
                     move  "PE"           to   srt-sts-key
           else if   d-sts-ods-sts-ord    =    03
                     move  "EV"           to   srt-sts-key
           else if   d-sts-ods-sts-ord    =    04
                     move  "IN"           to   srt-sts-key            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
       int-srt-inp-key-400.
      *              *-------------------------------------------------*
      *              * 4. per codice cliente                           *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      rf-ost-cod-arc       to   srt-arc-key            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
       int-srt-inp-key-500.
      *              *-------------------------------------------------*
      *              * 5. per ragione sociale cliente                  *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Completamento chiave                        *
      *                  *---------------------------------------------*
           move      rf-dcc-rag-soc       to   srt-rag-key            .
      *                  *---------------------------------------------*
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     int-srt-inp-key-900.
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-200.
      *                  *---------------------------------------------*
      *                  * Stato degli ordini di spedizione            *
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Subroutines per l'espansione righe ordine di spedizione   *
      *    *-----------------------------------------------------------*
