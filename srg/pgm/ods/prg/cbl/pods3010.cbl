      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase ods301, nella sua globalita', esegue i tipi di inter-  *
      ...
      * INTDIF      Ricerca documenti intestati ad un fornitore   301f *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " INTERROGAZIONI SU ORDINI DI SPEDIZIONE "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'ods301'           *
      *              *-------------------------------------------------*
           perform   fas-ods-301-000      thru fas-ods-301-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Esecuzione ciclo per la fase 'ods300'                     *
      *    *-----------------------------------------------------------*
       fas-ods-301-000.
      *              *-------------------------------------------------*
      *              * Video in Off                                    *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-ods-301-300
           else if   v-key                =    "PRSC"
                     go to fas-ods-301-400
           else if   v-key                =    "NXSC"
                     go to fas-ods-301-450
           else if   v-key                =    "DOWN"
                     go to fas-ods-301-500
           else if   v-key                =    "EXIT"
                     go to fas-ods-301-250
           else      go to fas-ods-301-200.
       fas-ods-301-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-ods-301-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-ods-301-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-ods-301-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-ods-301-350
           else      go to fas-ods-301-322.
       fas-ods-301-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-ods-301-630
           else if   v-key                =    "PRSC"
                     go to fas-ods-301-600
           else if   v-key                =    "NXSC"
                     go to fas-ods-301-610
           else if   v-key                =    "UP  "
                     go to fas-ods-301-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-ods-301-650
           else if   v-key                =    "EXIT"
                     go to fas-ods-301-660
           else      go to fas-ods-301-570.
       fas-ods-301-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-ods-301-626
           else      go to fas-ods-301-628.
       fas-ods-301-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-ods-301-636
           else      go to fas-ods-301-638.
       fas-ods-301-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-ods-301-725
           else      go to fas-ods-301-750.
       fas-ods-301-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
