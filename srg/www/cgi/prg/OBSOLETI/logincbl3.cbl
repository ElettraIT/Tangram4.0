...
______*    perform   ext-prm-000          thru ext-prm-999            .
      ...
      *              *-------------------------------------------------*
           ...
           display   "<HTML>"                                         .
           display   "<HEAD>"                                         .
           display   "<TITLE>TANGRAM 5.0</TITLE>"                     .
           display   "</HEAD>"                                        .
      *              *-------------------------------------------------*
      *              * Css                                             *
      *              *-------------------------------------------------*
      ...
      *
______*    display   " OnLoad = 'document.login.usr.focus();alert(window
______*              ".name);document.login.sss.value = window.name;'>".
      *
      *              *-------------------------------------------------*
      *              * Modulo                                          *
      *              *-------------------------------------------------*
           ...
           display   " NAME   = 'login'"                              .
           display   " ACTION = ''"                                   .
______*    display   " ACTION = '/cgi-bin/maincss0'"             .
           display   " METHOD = 'POST'"                               .
...
______*              """; window.location.reload();'/>"
      ...
      *
      ...
      -              "er=0 class=mainline>"                           .
           display   "<tr>"                                           .
      *
           display   "<th colspan=2>MENU' PRINCIPALE</th>"            .
           display   "</tr>"                                          .
           display   "<tr>"                                           .
           display   "<td class=row1 align=right>"                    .
           display   "<span class=gen>Codice comando</span>"          .
           display   "</td>"                                          .
      ...
      *
           display   "<tr>"                                           .
           display   "<td class=catBottom align=left colspan=2>"      .
           display   "<input class=mainoption type=button value='ge'>".
           display   "<span class=gen>Dati generali</span>"           .
           display   "</td>"                                          .
           display   "</tr>"                                          .
      *
           display   "<tr>"                                           .
           display   "<td class=catBottom align=left colspan=2>"      .
           display   "<input class=mainoption type=button value='am'>".
           display   "<span class=gen>Amministrazione</span>"         .
           display   "</td>"                                          .
           display   "</tr>"                                          .
      *
           display   "<tr>"                                           .
           display   "<td class=catBottom align=left colspan=2>"      .
           display   "<input class=mainoption type=button value='ve'>".
           display   "<span class=gen>Vendite</span>"                 .
           display   "</td>"                                          .
           display   "</tr>"                                          .
      *
           display   "<tr>"                                           .
           display   "<td class=catBottom align=left colspan=2>"      .
           display   "<input class=mainoption type=button value='ac'>".
           display   "<span class=gen>Acquisti</span>"                .
           display   "</td>"                                          .
           display   "</tr>"                                          .
      *
           display   "<tr>"                                           .
           display   "<td class=catBottom align=left colspan=2>"      .
           display   "<input class=mainoption type=button value='gm'>".
           display   "<span class=gen>Gestione materiali</span>"      .
           display   "</td>"                                          .
           display   "</tr>"                                          .
      *
           display   "<tr>"                                           .
           display   "<td class=catBottom align=left colspan=2>"      .
           display   "<input class=mainoption type=button value='pr'>".
           display   "<span class=gen>Produzione</span>"              .
           display   "</td>"                                          .
           display   "</tr>"                                          .
      *
           display   "<!-------------------------------->"            .
           ...
           display   "<input class=mainoption type=submit value=OK>"  .
           display   "</td>"                                          .
           display   "</tr>"                                          .
      *
