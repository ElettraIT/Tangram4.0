      ...
      *                       Ultima revisione:    NdK del 21/01/24    *
      *                    ------------------------------------------- *
      ...
      *              * Modulo                                          *
      *              *-------------------------------------------------*
           display   "<form name='bfo_003' id='bfo_003' method='post' ac
      -              "tion='/cgi-bin/elebfoB3'>"                      .
       exe-cph-lv0-300.
      *              *-------------------------------------------------*
      *              * Allineamento                                    *
      *              *-------------------------------------------------*
...
______     go to exe-cph-lv1-601.
      ...
      *                  * Messaggio                                   *
      *                  *---------------------------------------------*
           move      "FORNITORE 'ABB'! (Provvisoriamente gestibile)"
                                          to   w-exe-err-msg          .
           move      "msg_red"            to   w-exe-cla-msg          .
           perform   err-msg-htm-000      thru err-msg-htm-999        .
      *                  *---------------------------------------------*
      *                  * ATTUALMENTE PASSA (Mario 08/01/24 - 18:00)  *
      *                  *---------------------------------------------*
           go to     exe-cph-lv1-700.
      *                  *---------------------------------------------*
      *                  * A chiusura HTML                             *
