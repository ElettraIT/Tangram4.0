      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Documenti di carico - HTML                  *
      *                                                                *
      *                    ELETTRA                                     *
      *                                                                *
      *                    ___ OBSOLETO ___                            *
      ...
      *              *-------------------------------------------------*
______*    move      rf-bft-num-doc       to   w-exe-num-bfo          .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "nr."                to   w-all-str-cat (7)      .
           move      rf-bft-num-doc       to   w-all-str-cat (8)      .
      ...
      *                  * Literal per Colli                           *
      *                  *---------------------------------------------*
______*    move      "TD"                 to   h-ope                  .
______*    move      "th"                 to   h-sub                  .
______*    move      "CTN"                to   h-alf                  .
______*    move      "1"                  to   h-col                  .
______*    move      "C"                  to   h-all                  .
______*    move      "S"                  to   h-wdt                  .
______*    move      "B"                  to   h-stl                  .
...
______*                                  using h                      .
      ...
      *              *-------------------------------------------------*
______*    perform   wrt-mov-mag-000      thru wrt-mov-mag-999        .
       stp-cor-doc-mag-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
______*    move      "TD"                 to   h-ope                  .
______*    move      "td"                 to   h-sub                  .
______*    move      w-exe-rig-sco        to   h-alf                  .
______*    move      "1"                  to   h-col                  .
______*    move      "L"                  to   h-all                  .
______*    move      "S"                  to   h-wdt                  .
______*    move      "B"                  to   h-stl                  .
______*    call      "swd/mod/prg/obj/mhtml0"
______*                                  using h                      .
...
______*    display   "</td>"                                          .
      ...
      *              * Prompt                                          *
      *              *-------------------------------------------------*
           display   "<h1> Protocollo documento </h1>"                    .
      *
           move      spaces               to   w-exe-str-dsp          .
      *
