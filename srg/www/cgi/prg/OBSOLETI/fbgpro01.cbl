      ...
      *                       Ultima revisione:    NdK del 28/06/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Lista prodotti per Browser Internet - FBG   *
      *                                                                *
      *                   (Ricavato da zttpro01)                       *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           display   "<hr>"                                           .
           display   "<center>"                                       .
           display   "<A HREF=../index.html><img src='../icons/FORALBERG
      -              "-logo.gif' WIDTH=30%></A>"                      .
           display   "</center>"                                      .
           display   "<body text=#000000>"                            .
      *              *-------------------------------------------------*
      *              * Modulo                                          *
      *              *-------------------------------------------------*
           display   "<FORM NAME=ins METHOD=POST ACTION=/cgi-bin/fbgpro0
      -              "1>"                                             .
      *              *-------------------------------------------------*
      *              * Area di input                                   *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           display   "<hr>"                                           .
           display   "<address>"                                      .
           display   "<font size=2>Copyright (C) - dKb 2003 2004"     .
           display   "</address>"                                     .
           display   "</body>"                                        .
           display   "</html>"                                        .
       emi-pie-999.
