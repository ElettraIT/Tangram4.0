      ...
      *                                                                *
      *                    Accesso a fotocamera ___ PROVE              *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           move      "OP"                 to   f-ope                  .
           move      "ele/bfo/fls/ioc/obj/iofhbr"
                                          to   s-pat                  .
...
______     go to exe-cph-lv1-049.
      ...
      *              *-------------------------------------------------*
           ...
           display   "<br>"                                           .
           display   "Da spuntare   = " w-cix-ctr-rig-das             .
           display   "<br>"                                           .
           display   "Spuntate      = " w-cix-ctr-rig-spu             .
           display   "<br>"                                           .
       exe-cph-lv1-049.
      ...
      *              *-------------------------------------------------*
      ...
      -              "le=''>"                                         .                                 .
           display   "</div>"                                         .
      *              *-------------------------------------------------*
      *              * Box di dialogo per fotocamera                   *
      *              *-------------------------------------------------*
______*    display   "<div id='dialog_img' name='dialog_img' title=''>".                                 .
______*    display   "</div>"                                         .
      *              *-------------------------------------------------*
      *              * Chiusura allineamento centrato                  *
      *              *-------------------------------------------------*
...
______     go to exe-cph-lv1-601.
      ...
      *              *-------------------------------------------------*
           ...
           else      display   "<div id='msg' class='acq'>"           .
           display   "<h1>"                                           .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-let-arc-zrm-des    to   w-all-str-cat (5)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
       exe-cph-lv1-mok-600.
      *              *-------------------------------------------------*
      *              * Messaggio                                       *
      ...
      *              * Foto                                            *
      *              *-------------------------------------------------*
           perform   exe-cph-lv1-img-000  thru exe-cph-lv1-img-999    .
       exe-cph-lv1-rig-800.
      *              *-------------------------------------------------*
      *              * Chiusura riga                                   *
      *              *-------------------------------------------------*
...
______     go to     exe-cph-lv2-799.
      ...
      *              *-------------------------------------------------*
           ...
           display   "Protocollo    = " w-slc-num-bft-prt             .
           display   "<br>"                                           .
           display   "Progressivo 1 = " w-det-qta-pro-prg (1)         .
           display   "<br>"                                           .
           display   "Quantita 1    = " w-det-qta-pro-qta (1)         .
           display   "<br>"                                           .
           display   "Progressivo 2 = " w-det-qta-pro-prg (2)         .
           display   "<br>"                                           .
           display   "Quantita 2    = " w-det-qta-pro-qta (2)         .
           display   "<br>"                                           .
           display   "Progressivo 3 = " w-det-qta-pro-prg (3)         .
           display   "<br>"                                           .
           display   "Quantita 3    = " w-det-qta-pro-qta (3)         .
           display   "<br>"                                           .
           display   "<br>"                                           .
           display   "Quantita tot  = " w-exe-qta-tot                 .
           display   "<br>"                                           .
           display   "Quantita ppu  = " w-exe-qta-ppu                 .
           display   "<br>"                                           .
       exe-cph-lv2-799.
...
______*    add       rf-osr-qta-a03       to   w-exe-qta-spn          .
      ...
      *              *-------------------------------------------------*
       ...
       exe-cph-lv2-qpu-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [hbr]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "PRTPRO    "         to   f-key                  .
           move      w-slc-num-bft-prt    to   rf-hbr-num-prt         .
           move      w-exe-num-pro        to   rf-hbr-num-pro         .
      ...
      *                  *---------------------------------------------*
       ...
       exe-cph-lv2-qpu-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [hbr]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "ele/bfo/fls/ioc/obj/iofhbr"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           if        rf-hbr-num-prt       not  = w-slc-num-bft-prt
                     go to exe-cph-lv2-qpu-900.
       exe-cph-lv2-qpu-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *                  * Test su codice prodotto                     *
      *                  *---------------------------------------------*
           if        rf-hbr-num-pro       not  = w-exe-num-pro
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-hbr-qta-ubi       to   w-det-qta-ubi-qta
                                              (w-det-qta-ubi-inx)     .
           move      rf-hbr-cod-ubi       to   w-det-qta-ubi-ubi
                                              (w-det-qta-ubi-inx)     .
      *              *-------------------------------------------------*
      *              * Cumulo totale quantita'                         *
      *              *-------------------------------------------------*
           add       rf-hbr-qta-ubi       to   w-exe-qta-ppu          .
       exe-cph-lv2-qpu-800.
      *              *-------------------------------------------------*
      *              * Riciclo a record successivo                     *
      *              *-------------------------------------------------*
      ...
      *                  * Eventuale evidenziazione                    *
      *                  *---------------------------------------------*
______*    if        rf-hds-num-pro       =    w-exe-num-pro
...
______*              display  " class='spn' "                         .
      ...
      *                  *---------------------------------------------*
           if        rf-hbr-num-pro       =    zero
                     go to exe-cph-agg-mag-700.      
           if        rf-hbr-qta-ubi       =    zero
                     go to exe-cph-agg-mag-700.      
           if        rf-hbr-cod-ubi       =    spaces
                     go to exe-cph-agg-mag-700.      
      *                  *---------------------------------------------*
      *                  * Normalizzazione [dcp]                       *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRO"             to   f-key                  .
           move      rf-hbr-num-pro       to   rf-dcp-num-pro         .
           move      "pgm/dcp/fls/ioc/obj/iofdcp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-hbr-num-pro       to   l-mag-300-num-mag      .
           ...
           move      rf-hbr-qta-ubi       to   l-mag-300-qta-mov      .
           move      w-exe-dsl-mag        to   l-mag-300-cod-dsl      .
           move      rf-hbr-cod-ubi       to   l-mag-300-cod-dsd      .
           perform   mdl-agg-mag-cll-000  thru mdl-agg-mag-cll-999    .
       exe-cph-agg-mag-700.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      ...
      *                  *---------------------------------------------*
           move      w-exe-prt-mag        to   rf-hbr-prt-mag         .
           move      w-exe-drg-mag        to   rf-hbr-drg-mag         .
      *                  *---------------------------------------------*
      *                  * Put record                                  *
      *                  *---------------------------------------------*
           move      "PT"                 to   f-ope                  .
...
______     go to upd-rec-bfs-001.
      ...
      *              *-------------------------------------------------*
           ...
           display   "Protocollo     = " rf-bfs-num-prt               .
           display   "<br>"                                           .
           display   "Progressivo    = " rf-bfs-num-prg               .
           display   "<br>"                                           .
           display   "Quantita' ril  = " rf-bfs-qta-ril               .
           display   "<br>"                                           .
           display   "Flag di spunta = " rf-bfs-flg-spn               .
           display   "<br>"                                           .
           display   "Responsanbile  = " rf-bfs-cod-rsm               .
           display   "<br>"                                           .
           display   "<br>"                                           .
           display   "Quantita' ass  = " w-det-qta-pro-qas            .
           display   "<br>"                                           .
