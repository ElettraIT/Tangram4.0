      ...
      *                       Ultima revisione:    NdK del 07/07/23    *
      *                    ------------------------------------------- *
      ...
      *                    ELETTRA                                     *
      *                                                                *
      *                    ___ TEST DI 'dataTables': NON FUNZIA ___    *
      *                                                                *
      *================================================================*
...
______*                                  using h                      .
      ...
      *                  *---------------------------------------------*
           ...
           display   "<table id='mxport' class='display nowrap' style='w
      -              "idth:100%'>"                                    .
      
      
______*    display   "<table class='bordotab' id='rig' name='rig' width=
______*              "100%>"                                          .
      *                  *---------------------------------------------*
      *                  * Apertura riga                               *
      *                  *---------------------------------------------*
...
______*    perform   stp-cor-doc-rbc-000  thru stp-cor-doc-rbc-999    .
      ...
      *              *-------------------------------------------------*
           perform   int-pag-sta-pdv-000  thru int-pag-sta-pdv-999    .
      *              *-------------------------------------------------*
      *              * Chiusura riga                                   *
      *              *-------------------------------------------------*
           move      "ET"                 to   h-ope                  .
...
______*    else      move  spaces         to   w-all-str-cat (2)      .
      ...
      *              *-------------------------------------------------*
           ...
           display   "<img src='../icons/gomma.png' width='30'>"      .
           display   "</button>"                                      .
           display   "</td>"                                          .
      *              *-------------------------------------------------*
      *              * Chiusura cella                                  *
