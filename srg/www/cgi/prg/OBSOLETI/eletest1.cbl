      ...
      *                       Ultima revisione:    NdK del 31/05/23    *
      *                    ------------------------------------------- *
      ...
      *              *-------------------------------------------------*
           ...
           display   "<td id='cel_alf' name='cel_alf' class='td_nb'>" .
           display   "<b>"                                            .
           display   srt-alf-pro                                      .
           display   "</b>"                                           .
           display   "</td>"                                          .

           go to stp-cor-doc-rig-200.
...
______*    display   "</td>"                                          .
      ...
      *              *-------------------------------------------------*
      *              * PER PROVE BOX DI DIALOGO                        *
      *              * ___                                             *
      *              *-------------------------------------------------*
           display   "<div id='dialog' name='dialog' title='Modif. quant
      -              "it&agrave'>"                                    .
           display   "</div>"                                         .
...
______*              go to det-tbl-rsm-200.
      ...
      *                  * superato                                    *
      *                  *---------------------------------------------*
           if        rf-bft-flg-nbx (1)   not  = spaces
