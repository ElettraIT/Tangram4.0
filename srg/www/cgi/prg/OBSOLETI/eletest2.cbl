      ...
      *                       Ultima revisione:    NdK del 24/05/23    *
      *                    ------------------------------------------- *
      ...
      *              *-------------------------------------------------*
______*    display   "<link rel='stylesheet' type='text/css' href='../cs
______*              "s/ele.css'>"                                    .
      ...
      *              *-------------------------------------------------*
           display   "<script src=""../jsc_ele/eletest2.js""></script>".
      ...
      *              * Apertura cella                                  *
      *              *-------------------------------------------------*
           display   "<td id='cel_pro' name='cel_pro' align=center class
      -              "='td_nb'>"                                      .
       emi-tes-pro-200.
      *              *-------------------------------------------------*
      *              * Prompt                                          *
      ...
      *              * Prompt codice                                   *
      *              *-------------------------------------------------*
           display   "<td class='td_nb'> Codice per il produttore </td> 
      -              ""                                               .
      *              *-------------------------------------------------*
      *              * Codice                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           display   "<div id='des_pro' name='des_pro'>"              .
      ...
      *              *-------------------------------------------------*
           ...
           display   "<td align='center'> - </td>"                    .
           display   "<td colspan=2 align='center'> PRIMO LOTTO</td>" .
      *              *-------------------------------------------------*
      *              * Chiusura riga                                   *
      *              *-------------------------------------------------*
           move      "ET"                 to   h-ope                  .
      ...
      *              * Prompt                                          *
      *              *-------------------------------------------------*
           display   "<td class='prompt'> Giacenza fisica </td>"      .
      *              *-------------------------------------------------*
      *              * Editing                                         *
      *              *-------------------------------------------------*
           move      "ED"                 to   v-ope                  .
      ...
      *              * Celle vuote                                     *
      *              *-------------------------------------------------*
           display   "<td colspan='3' class='td_nb'>&nbsp;</td>"      .
      *              *-------------------------------------------------*
      *              * Chiusura riga                                   *
      *              *-------------------------------------------------*
           move      "ET"                 to   h-ope                  .
      ...
      *              * Prompt                                          *
      *              *-------------------------------------------------*
           display   "<td class='prompt'> In spedizione </td>"        .
      *              *-------------------------------------------------*
      *              * Editing                                         *
      *              *-------------------------------------------------*
           move      "ED"                 to   v-ope                  .
      ...
      *              * Celle vuote                                     *
      *              *-------------------------------------------------*
           display   "<td colspan='2' class='td_nb'>&nbsp;</td>"      .
      *              *-------------------------------------------------*
      *              * Chiusura riga                                   *
      *              *-------------------------------------------------*
           move      "ET"                 to   h-ope                  .
      ...
      *              * Prompt                                          *
      *              *-------------------------------------------------*
           display   "<td class='prompt'> In ordine da clienti </td>" .
      *              *-------------------------------------------------*
      *              * Editing                                         *
      *              *-------------------------------------------------*
           move      "ED"                 to   v-ope                  .
      ...
      *              * Prompt                                          *
      *              *-------------------------------------------------*
           display   "<td class='prompt'> In ordine a fornitori </td>".
      *              *-------------------------------------------------*
      *              * Editing                                         *
      *              *-------------------------------------------------*
           move      "ED"                 to   v-ope                  .
      ...
      *              * Prompt                                          *
      *              *-------------------------------------------------*
           display   "<td class='prompt'> Disponibile </td>"          .
      *              *-------------------------------------------------*
      *              * Determinazione                                  *
      *              *-------------------------------------------------*
      ...
      *              * Prompt                                          *
      *              *-------------------------------------------------*
           display   "<td class='prompt'> Presso terzi </td>"         .
      *              *-------------------------------------------------*
      *              * Editing                                         *
      *              *-------------------------------------------------*
           move      "ED"                 to   v-ope                  .
      ...
      *              * Prompt                                          *
      *              *-------------------------------------------------*
           display   "<td class='prompt'> Ubicazione </td>"           .
      *              *-------------------------------------------------*
      *              * Valore                                          *
      *              *-------------------------------------------------*
           display   "<td colspan='4'><b>"                            .
...
______*    perform   emi-htm-bck-000      thru emi-htm-bck-999        .
      ...
      *              *-------------------------------------------------*
           ...
           display   "<a href='elebfo11'>"                            .
           display   "<button type='button' "                         .
           display   "class='mnu_btn'>"                               .
           display   "<img src='../icons/ABB_logo.png' width='70'>"   .
           display   "</button>"                                      .
           display   "</a>"                                           .
           display   "</td>"                                          .

           display   "<td class='td_nb'>"                             .
           display   "<a href='eleubi01'>"                            .
           display   "<button type='button' "                         .
           display   "class='mnu_btn'>"                               .
           display   "<img src='../icons/ubicazioni2.png' width='90'>".
           display   "</button>"                                      .
           display   "</a>"                                           .
           display   "</td>"                                          .
      ...
      *              *-------------------------------------------------*
      *              * Bottone 'back' di prova                         *
      *              *-------------------------------------------------*
______*    display   "<button onclick='history.back()' "              .
______*    display   "class='mnu_btn'>"                               .
______*    display   "<h1> PAGINA PRECEDENTE</h1>"                    .
______*    display   "</button>"                                      .
