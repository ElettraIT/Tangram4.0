      ...
      *                       Ultima revisione:    NdK del 18/05/23    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Inserimento barcode per Browser - ELETTRA   *
      *                                                                *
      *                    ___ NON UTILIZZATO ___                      *
      *                                                                *
      *                    ___ NON FUNZIONA   ___                      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           ...
           05  w-exe-klb-pro              pic  x(14)                  .
           05  w-exe-num-pro              pic  x(07)                  .
           05  w-exe-cnv-pro              pic  9(07)                  .
           05  w-exe-inx-klb              pic  9(01)                  .
      ...
      *                  *---------------------------------------------*
           move      "CV"                 to   v-ope                  .
           move      07                   to   v-car                  .
           move      w-exe-num-pro        to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-num                to   w-exe-cnv-pro          .
      ...
      *              * Modulo                                          *
      *              *-------------------------------------------------*
           display   "<form name='bar_001' id='bar_001' method='post' ac
      -              "tion='/cgi-bin/elebar01'>"                      .
      ...
      *                  * Prompt                                      *
      *                  *---------------------------------------------*
           display   "<td width='25%'> Barcode del prodotto </td>"    .
      *                  *---------------------------------------------*
      *                  * Valore                                      *
      *                  *---------------------------------------------*
           display   "<td colspan='2'><b>"                            .
           display   w-exe-klb-pro                                    .
           display   "</b>"                                           .
           display   "</td>"                                          .
      *                  *---------------------------------------------*
      *                  * Accettazione Barcode                        *
      *                  *---------------------------------------------*
           move      1                    to   w-exe-inx-klb          .
           perform   emi-cor-klb-000      thru emi-cor-klb-999        .
      *                  *---------------------------------------------*
      *                  * Chiusura riga                               *
      *                  *---------------------------------------------*
           move      "ET"                 to   h-ope                  .
       ...
       emi-cor-400.
      *              *-------------------------------------------------*
      *              * Trattamento Barcode 2                           *
      *              * ATTUALMENTE NON GESTITO                         *
      *              *-------------------------------------------------*
       emi-cor-500.
      *              *-------------------------------------------------*
      *              * Trattamento Barcode 3                           *
      *              * ATTUALMENTE NON GESTITO                         *
      *              *-------------------------------------------------*
       emi-cor-600.
       emi-cor-900.
      ...
      *    * Emissione corpo documento                                 *
      *    *                                                           *
      *    * Subroutine di accettazione generica barcode               *
      *    *-----------------------------------------------------------*
       emi-cor-klb-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
______*    if        w-det-num-pro-num    =    zero
...
______*    else      move  spaces         to   w-all-str-cat (1)      .
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-exe-str-dsp          .
      *
           string    "<input type='text' id='acc_ba"
                                delimited by   size
                     w-exe-inx-ubc
                                delimited by   size
                     "' name='acc_ba"
