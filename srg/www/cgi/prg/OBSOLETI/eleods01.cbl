      ...
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
______*    go to     exe-cph-lv1-new-900.
      ...
      *                  *---------------------------------------------*
           ...
           perform   det-dst-hds-000      thru det-dst-hds-999        .
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-exe-cnv-dst        to   rf-hds-num-dst         .
      ...
      *                  *---------------------------------------------*
           if        rf-hds-num-dst       not  = w-exe-cnv-dst
                     go to  exe-cph-lv1-vis-800.
       exe-cph-lv1-vis-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        w-exe-rot-prt        =    rf-hds-num-prt
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-hds-num-prt       to   w-exe-buf-prt
                                              (w-exe-buf-ctr)         .
           move      rf-hds-num-prt       to   w-exe-rot-prt          .
      *                  *---------------------------------------------*
      *                  * A riciclo                                   *
      *                  *---------------------------------------------*
           go to     exe-cph-lv1-vis-600.
      ...
      *                  * Lettura descrizione responsabile            *
      *                  *---------------------------------------------*
           move      rf-ost-pvf-ime       to   w-let-arc-zrm-cod      .
           perform   let-arc-zrm-000      thru let-arc-zrm-999        .
      *                  *---------------------------------------------*
      *                  * Visualizzazione                             *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       exe-cph-lv1-ele-700.
      *              *-------------------------------------------------*
      *              * ___ EVENTUALE BOTTONE TRASH ___                 *
      *              * ___ DA IMPLEMENTARE ??? ___                     *
      *              *-------------------------------------------------*
           go to     exe-cph-lv1-ele-800.
      ...
      *                  *---------------------------------------------*
       ...
       exe-cph-lv2-inp-200.
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [hds]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "ele/ods/fls/ioc/obj/iofhds"
                                          to   s-pat                  .
      ...
      *                      *-----------------------------------------*
           if        rf-hds-num-pro       =    w-exe-num-pro
      ...
      *                      * Protocollo                              *
      *                      *-----------------------------------------*
           move      rf-hds-num-prt       to   srt-num-prt            .
      *                      *-----------------------------------------*
      *                      * Progressivo                             *
      *                      *-----------------------------------------*
           move      rf-hds-num-prg       to   srt-num-prg            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      rf-hds-num-prt       to   w-det-rig-spn-prt      .
           perform   det-rig-spn-000      thru det-rig-spn-999        .
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-det-dst-num-prt    to   rf-hds-num-prt         .
           move      zero                 to   rf-hds-num-prg         .
           move      "ele/ods/fls/ioc/obj/iofhds"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-hds-num-prt       not  = w-det-dst-num-prt
                     go to det-dst-hds-900.
       det-dst-hds-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *              *-------------------------------------------------*
           move      rf-hds-num-dst       to   w-det-dst-num-dst      .
       det-dst-hds-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     det-dst-hds-999.
       det-dst-hds-999.
           exit.
      ...
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      rf-osr-num-prt       to   rf-hds-num-prt         .
           move      rf-osr-num-prg       to   rf-hds-num-prg         .
           move      w-exe-cnv-dst        to   rf-hds-num-dst         .
           move      rf-osr-num-pro       to   rf-hds-num-pro         .
           move      w-exe-dat-exe        to   rf-hds-ide-dat         .
           move      w-exe-cnv-rsm        to   rf-hds-cod-rsm         .
