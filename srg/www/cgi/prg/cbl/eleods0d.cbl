      ...
      *                                   Fase:    eleods              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 21/07/23    *
      *                       Ultima revisione:    NdK del 04/10/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ordine di spedizione HTML con barcode,      *
      *                    visualizzazione check list ordini           *
      *                                                                *
      *                    ELETTRA                                     *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           perform   exe-cph-cor-000      thru exe-cph-cor-999        .
      *              *-------------------------------------------------*
      *              * Chiusura html                                   *
      *              *-------------------------------------------------*
      ...
      *              * Apertura tabella                                *
      *              *-------------------------------------------------*
           display   "<table class='bordotab' align='center' width=100%>
      -              ""                                               .
       exe-cph-cor-050.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      ...
      *                  *---------------------------------------------*
           if        w-exe-rot-prt        =    zero
                     go to exe-cph-cor-520.
      *                  *---------------------------------------------*
      *                  * Test se elemento uguale                     *
      *                  *---------------------------------------------*
           if        w-exe-rot-prt        =    rf-osd-num-prt
                     go to exe-cph-cor-800.
       exe-cph-cor-520.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       exe-cph-cor-600.
      *              *-------------------------------------------------*
      *              * Emissione riga elenco                           *
      *              *-------------------------------------------------*
           perform   exe-cph-cor-rig-000  thru exe-cph-cor-rig-999    .
       exe-cph-cor-800.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     exe-cph-cor-200.
       exe-cph-cor-900.
      *              *-------------------------------------------------*
      *              * Chiusura tabella                                *
      *              *-------------------------------------------------*
      ...
      *    * Emissione corpo documento                                 *
      *    *                                                           *
      *    * Subroutine per emissione riga documento                   *
      *    *-----------------------------------------------------------*
       exe-cph-cor-rig-000.
      *              *-------------------------------------------------*
      *              * Apertura riga                                   *
      ...
      *              *-------------------------------------------------*
       ...
       exe-cph-cor-rig-300.
      *              *-------------------------------------------------*
      *              * Determinazione contatori righe                  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           display   "<td align='left'>"                              .
      *                  *---------------------------------------------*
      *                  * Lettura testata ordine di spedizione        *
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
